...
| `delegate` | A complete spec is better executed by one implementer. | Luna / Max for execution work, or Terra / High for routine work; root verifies. |
| `audit` | Complex-task final scrutiny matters more than delegation. | Root implements; a fresh read-only Sol / High reviews. |
