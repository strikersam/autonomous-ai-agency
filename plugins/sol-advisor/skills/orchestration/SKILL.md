...
declared route: none for solo; Luna / Max for execution delegation, Terra / High for
routine delegation, fresh Sol / High for complex-task audit; and the selected
implementer plus fresh Sol reviewer for full. Public metadata
...
- `delegate`: select Luna / Max for execution work, or Terra / High for
  routine work. Use audit or full with fresh Sol / High review for complex tasks. The selected
...
Auxiliary work must substitute for root work, not duplicate it. A Luna or Terra result may
justify escalation to fresh Sol / High review only when it reveals newly observed
complexity, risk, wide blast radius, or misclassification. A corrected Luna attempt is reserved
