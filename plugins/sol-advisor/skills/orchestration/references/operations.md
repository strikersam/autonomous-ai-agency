...
|---|---|---|---|
| sol_advisor_luna_implementer | gpt-5.6-luna | max | Delegate/full execution implementation |
| sol_advisor_terra_implementer | gpt-5.6-terra | high | Delegate/full routine implementation |
| sol_advisor_sol_reviewer | gpt-5.6-sol | high | Audit/full complex-task review; requests read-only sandbox |
...
Luna / Max is the execution lane. Terra / High is selected for routine work.
Complex tasks escalate to audit or full with a fresh Sol / High reviewer. A Luna or
Terra result may justify a declared Sol / High complex-task review escalation only
when it shows newly observed risk. One corrected Luna attempt is reserved for a
specification error and is not a prerequisite for Sol review.
...
Accepted routing is Luna / max for execution delegate/full implementation, Terra /
high for routine delegate/full implementation, and Sol / high for complex audit/full
review.
