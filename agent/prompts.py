    ...
    return [
        {
            ...
            "content": (
                ...
                "LOCAL WORKSPACE (write — surgical edits only):\n"
                "- search_replace_file(path, search_string, replacement_string): Replace exactly one occurrence\n"
                "  of search_string in path with replacement_string. Fails if the string is absent or\n"
                "  appears more than once — read the file first to confirm the exact text. Use this instead\n"
                "  of write_file for targeted line-level changes to avoid rewriting the whole file.\n"
