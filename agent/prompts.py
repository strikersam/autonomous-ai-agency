    ...
    return [
        {
            ...
            "content": (
                ...
                "FILE EDITING (targeted edits — prefer these over writing entire files):\n"
                "- edit_file(path, old_string, new_string): Replace one exact occurrence of old_string with new_string.\n"
                "  Use this for targeted edits. Include enough context lines so old_string is unique.\n"
                "  Returns {diff, error}. If error is non-empty the file was NOT changed — fix old_string and retry.\n"
