...
| 11 | SEO audit: one-click CTO-level PDF report from UI (issue #533 follow-up) | `IN_PROGRESS` | `claude/cool-davinci-494siy` | services/seo_report_pdf.py (cover/exec-summary/methodology/pillar deep-dives/WSJF roadmap/worst-pages appendices), GET .../export?fmt=pdf, CompanyScreen "📄 Generate PDF Report" button, reportlab dep, new tests in test_seo_report_pdf.py + TestRevenueModelHelpers; pytest -x green. PR pending. | 2026-06-13 |
