...
## Corpus Check
- 1502 files · ~2,175,877 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 30432 nodes · 56843 edges · 1283 communities (1120 shown, 115 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 3331 edges (avg confidence: 0.92)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6e62e203`
...
## Communities (1283 total, 115 thin omitted)

### Community 0 - "backend/server.py"
Cohesion: 0.02
Nodes (305): admin_seed(), AgentStatusEntry, AgentStatusResponse, AgentToolCallEntry, ApiKeyCreate, auth_me(), AuthorizeReposBody, auto_recommend_skills() (+297 more)

### Community 1 - "company_api.py"
Cohesion: 0.04
Nodes (100): ephemeral_ttl_hours(), Async read of the ephemeral TTL (hours) straight from the DB., backend/ceo_router.py — observability and manual control for the CEO. Surfaces…, Reject non-admin callers for routes that spend provider budget. Delegates to…, _require_admin(), account_lifecycle(), AccountLifecycleResponse, auto_recommend_skills() (+92 more)

### Community 2 - "CompanyGraphService"
Cohesion: 0.03
Nodes (43): BusinessCategory, requires_db, CompanyGraphService, Company, SpecialistFamily, SystemType, Workflow, Get a company by ID. Args: company_id: Company ID Returns: Company instance or… (+35 more)

### Community 3 - "proxy.py"
Cohesion: 0.03
Nodes (159): get_sam(), middleware, admin_control(), admin_login(), admin_logout(), admin_status(), AdminControlBody, AdminLoginBody (+151 more)

### Community 4 - "TaskSpec"
Cohesion: 0.03
Nodes (134): kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, AiderAdapter, Any, TaskResult, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Run aider non-interactively via `--message` flag., Adapter for Aider — TIER 3 specialized git-aware code editor. (+126 more)
...
### Community 6 - "Task"
Cohesion: 0.04
Nodes (67): Full task/issue document., Task, _gate_outward_facing_enabled(), _is_brain_connection_error(), _is_outward_facing(), Any, BaseException, TaskSpec (+59 more)

### Community 7 - "test_llm_router_strategies.py"
Cohesion: 0.06
Nodes (59): HealthConfig, Strategy selection and degradation behaviour., Circuit breaker + health tracking thresholds., RoutingConfig, HealthTracker, _Outcome, ProviderHealth, Any (+51 more)

### Community 8 - "test_provider_router.py"
Cohesion: 0.06
...
Cohesion: 0.03
Nodes (92): get_budget(), The process-wide budget tracker., get_cache(), packages/llm/cache.py — layered caching. Five independent layers, each with its…, The process-wide cache manager., text_key(), failover_chat_completion_via_router(), openai_body_from_response() (+84 more)

### Community 17 - "types.py"
Cohesion: 0.04
Nodes (70): packages/llm — the multi-provider LLM routing layer. Every LLM call in this…, packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, classify_error(), LLMProvider, OpenAICompatible, ABC, Any, AsyncClient (+62 more)

### Community 18 - "_fixture"
Cohesion: 0.01
Nodes (114): parse_event_stream(), Reduce a ``--mode json`` NDJSON stream to a :class:`ParsedRun`. Kept a module-…, base_url(), mobile_page(), proxy_url(), Config, pytest_configure(), conftest.py — pytest fixtures and configuration for the E2E test suite.… (+106 more)
...
Cohesion: 0.04
Nodes (79): _egress_policy_reason(), agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Return why governance policy blocks *host*, or None. Runs strictly *after* the…, _action_matches(), _as_list(), Decision, get_policy_engine(), GroupPolicy (+71 more)

### Community 22 - "Any"
Cohesion: 0.05
Nodes (32): Any, Path, Governance seam: judge the call, run it, audit the outcome. Deliberately a thin…, Append an event to the durable session log if a store is wired in., Summarise a long history and compact it. Asks the planner model to write a…, Send chat messages and return the assistant's text output. If an…, Call-time resolver for an agent role model id. Delegates to…, Parse an LLM tool-call response, tolerating common malformations. Handles: 1.… (+24 more)
...
### Community 25 - "AgentJobManager"
Cohesion: 0.03
Nodes (57): AgentJob, AgentJobManager, make_isolated_workspace(), _now(), Any, Path, agent/job_manager.py — Async agent job lifecycle manager. Manages agent jobs…, Run a job using the provided runner and update the job's lifecycle, progress,… (+49 more)

### Community 26 - "SQLiteStore"
Cohesion: 0.03
Nodes (44): Find a website by its URL., A company website with detected systems and stack inference., Website, Add a website to a company. Args: company_id: Company ID url: Website URL…, Create a new company in SQLite., Update a company in SQLite., Delete a company and all associated data from SQLite., List companies from SQLite. (+36 more)

### Community 27 - "test_failover_client_shared.py"
Cohesion: 0.06
...
### Community 29 - "rbac.py"
Cohesion: 0.05
Nodes (46): compute_savings(), compute_time_series(), get_savings(), get_usage(), get_user_savings(), _period_start(), Any, BaseModel (+38 more)

### Community 30 - "MongoDBStore"
Cohesion: 0.03
Nodes (60): KnowledgeItem, Find knowledge items matching any of the given tags., Structured knowledge about the company, systems, or processes., MongoDBStore, Any, ObjectId, Prepare a Pydantic model for SQLite storage., Prepare a SQLite row for Pydantic model. (+52 more)

### Community 31 - "failover_client.py"
Cohesion: 0.04
Nodes (62): _auto_disable(), _describe_registry(), _disabled_ids(), _is_billing_refusal(), _is_ollama(), _key_pool(), _log_exhaustion(), _looks_unknown_model() (+54 more)

### Community 32 - "CompanyGraphStore"
Cohesion: 0.03
Nodes (102): get_company_graph(), patch, Update a company's metadata. Accepts partial updates for company fields…, Get the complete Company Graph for a company. Returns the company's graph with…, Scan a repository for technology stack and systems., scan_repo_endpoint(), update_company(), ApprovalPolicy (+94 more)

### Community 33 - "test_llm_router_resilience.py"
Cohesion: 0.04
...
### Community 36 - "validate_policy_text"
Cohesion: 0.06
...
Cohesion: 0.04
Nodes (98): Agency, AgentRole, get_agency(), _parse_ceo_directives(), str, CEO-coordinated multi-agent agency for continuous codebase management. The CEO…, set_agency(), DetectedIssue (+90 more)

### Community 38 - "AuditLog"
Cohesion: 0.04
Nodes (51): Called by APScheduler when a cron fires. Dispatches to the orchestrator. This…, Resolve the JWT signing secret, with a *stable* fallback. Bug fix: the previous…, _resolve_jwt_secret(), _scheduler_on_fire(), AuditEvent, AuditLog, _luhn_ok(), Any (+43 more)

### Community 39 - "SeoAuditEngine"
Cohesion: 0.05
Nodes (38): Run a full SEO/GEO/AIO audit against a website and persist the evidence., run_seo_audit(), field_validator, A single occurrence of a check firing on a specific URL., Aggregated report row - Screaming Frog CSV compatible., Site-level facts discovered during the crawl., Request to run an SEO/GEO/AIO audit against a website., SeoAuditRequest (+30 more)
...
Cohesion: 0.06
Nodes (32): BaseModel, Response shape of ``GET /api/render/ops/status``. Declared here rather than in…, RenderOpsStatus, One deploy, normalised from whatever shape the tool returned., RenderDeploy, Any, Polls Render for platform-level failures and files them as issues., Snapshot for ``/api/render/ops/status`` and the dashboard. ``self_heal_ready``… (+24 more)
...
Cohesion: 0.05
Nodes (80): PreflightIssue, PreflightReport, Any, BaseModel, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, Translate technical preflight issues into a conversational assistant reply., translate_error_to_conversational(), AcceptedJob (+72 more)

### Community 44 - "MCPClient"
Cohesion: 0.04
Nodes (31): MCPClient, Any, RuntimeError, Prefer structured data; fall back to text when unavailable., Thin async MCP client with open/close circuit breaker. Thread-safe only within…, Full URL of the JSON-RPC endpoint this client posts to., Build the request headers shared by ``_rpc`` and ``notify``. ``Accept`` lists…, Propagate the calling agent's identity across the process boundary. The MCP… (+23 more)
...
### Community 48 - "RenderFinding"
Cohesion: 0.04
Nodes (59): get_mcp_client(), Return the module-level MCPClient. Reads MCP_SERVER_BASE_URL at call time (not…, _internal_configured(), list_specs(), MCPServerSpec, _not_dialable(), _playwright_configured(), _playwright_spec() (+51 more)

### Community 49 - "test_bedrock_provider.py"
Cohesion: 0.06
...
### Community 53 - "services/background.py"
Cohesion: 0.04
Nodes (90): _dispatch_async(), _ErrorCaptureHandler, get_log_monitor(), LogMonitor, _note_recurrence(), Any, LogRecord, agent/log_monitor.py — Application Log Monitor Captures ERROR/CRITICAL log… (+82 more)

### Community 54 - "delegate_seo_findings"
Cohesion: 0.10
...
Cohesion: 0.03
Nodes (92): CEOResult, _merge_changed_files(), Reset the singleton (test helper)., Aggregated output from a multi-specialist execution., Post-hoc independent re-check when a completed task touched a risky module.…, Collect changed_files across all specialists into a single de-duped list., reset_ceo_dispatcher(), get_ceo_fallback_stats() (+84 more)

### Community 57 - "get_task_store"
Cohesion: 0.04
Nodes (88): _purge_backlog_core(), quick_notes_submit(), _QuickNoteBody, Shared purge implementation for the admin endpoint and the boot hook., Submit a quick-note URL or instruction from the dashboard FAB., _blocked_retire_age_sec(), _heal_blocked_backlog(), _heal_brain_failover() (+80 more)

### Community 58 - "Specialist"
Cohesion: 0.04
Nodes (38): SpecialistFamily, Find all specialists of a specific family., Find specialists that can handle a task with given capabilities., A specialist agent that can be provisioned for company-specific tasks., Check if this specialist can handle a task with given capabilities., Specialist, Create a new specialist., Get a specialist by ID. (+30 more)

### Community 59 - "agent/workspace.py"
Cohesion: 0.05
...
### Community 60 - "activation_api.py"
Cohesion: 0.09
...
### Community 67 - "seo_portfolio_bridge.py"
Cohesion: 0.05
...
Cohesion: 0.08
Nodes (20): _get_director(), _normalized_provider_type(), ProviderAttempt, ProviderRouter, Any, Try all models for one provider. Returns ProviderResult on success, None on…, Parse a 429/503 ``Retry-After`` header → seconds, or None. Accepts either…, Return the process TrafficDirector, or None if it is unavailable. (+12 more)

### Community 69 - "WebsiteScanner"
Cohesion: 0.02
Nodes (119): Scan a website for technology stack and systems. This performs a comprehensive…, scan_website_endpoint(), DetectedSystem, Evidence, OnboardingProgress, Result of a website scan with detected systems and stack inference., Evidence supporting a system detection., Tracks the onboarding progress for a company. (+111 more)
...
### Community 75 - "test_ai_insights.py"
Cohesion: 0.05
...
### Community 82 - "TestModelRegistryUpdates"
Cohesion: 0.13
...
Cohesion: 0.03
Nodes (116): classify_domain(), agent/workflow.py — Persisted workflow state machine. Implements the Autonomous…, Return the best-matching domain for a task title+description., packages/ai/self_heal.py — automatic brain self-healing. When the active brain…, Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., tasks — Task/issue management system. Provides a lightweight task/issue tracker…, Enum (+108 more)
...
### Community 89 - "test_llm_router_e2e.py"
Cohesion: 0.14
...
### Community 90 - "PrimeAgentAdapter"
Cohesion: 0.04
...
### Community 91 - "_resolve_brain_provider"
Cohesion: 0.05
...
### Community 99 - "probe_model_liveness"
Cohesion: 0.14
...
Cohesion: 0.05
Nodes (31): _norm_title(), PortfolioIntelligence, Assembles a PortfolioManager from live signals with WSJF scoring., Sweep all signals and return a populated, de-duplicated PortfolioManager., PortfolioManager, Manages a portfolio of initiatives with WSJF prioritisation and roadmapping., Remove an initiative from the portfolio., Number of initiatives in the portfolio. (+23 more)

### Community 105 - "get_workflow_orchestrator"
Cohesion: 0.07
Nodes (28): get_workflow_orchestrator(), Return the shared WorkflowOrchestrator singleton., Reset the singleton (test helper)., reset_orchestrator(), skipif, Singleton lifecycle and phase registration., End-to-end execution through the golden path., With auto_approve=True, execution runs through all phases. (+20 more)

### Community 106 - "AnthropicProvider"
Cohesion: 0.04
...
### Community 108 - "test_web_reach.py"
Cohesion: 0.08
...
### Community 111 - "configuration-reference.md"
Cohesion: 0.08
...
### Community 115 - "resolve_e2b_config"
Cohesion: 0.05
...
### Community 116 - "test_colibri_brain_shim.py"
Cohesion: 0.08
...
### Community 123 - "test_startup_warmup.py"
Cohesion: 0.05
...
### Community 124 - "Platform Guide — the full tour"
Cohesion: 0.03
Nodes (59): 1. Clone and install, 2026-06-16, 2026-06-25, 2026-06-26, 2026-07-04, 2026-07-05, 2026-07-09, 2. Configure (+51 more)

### Community 125 - "clear_cooldowns"
Cohesion: 0.06
Nodes (46): clear_cooldowns(), get_dead_models(), _is_model_dead(), is_provider_on_cooldown(), mark_provider_failed(), Snapshot of active dead-model entries {provider_id/model: expiry_ts}. Also…, Put provider_id on cooldown for *cooldown_seconds* (default:…, Return True if provider_id is currently on cooldown. (+38 more)
...
### Community 128 - "test_sam_livekit.py"
Cohesion: 0.04
...
### Community 134 - "NotificationDispatcher"
Cohesion: 0.05
...
### Community 139 - "test_ephemeral_reaper.py"
Cohesion: 0.10
...
### Community 147 - "RepowiseIntelligence"
Cohesion: 0.04
...
### Community 158 - "_FakeCommandResult"
Cohesion: 0.14
...
### Community 160 - "LLMRouter"
Cohesion: 0.04
Nodes (69): Attempt, count, Read the environment variables named in ``env_names`` into a key list. Order is…, resolve_keys(), LLMRouter, Any, AsyncClient, BaseException (+61 more)

### Community 161 - "tasks/api.py"
Cohesion: 0.12
...
### Community 162 - "test_trend_watcher.py"
Cohesion: 0.07
...
### Community 165 - "TestHarnessAdapter"
Cohesion: 0.05
...
### Community 170 - "render_ops.py"
Cohesion: 0.10
Nodes (21): _latest_metric_value(), _note_recurrence(), _parse_timestamp(), datetime, services/render_ops.py — autonomous Render debugging + environment monitoring.…, Parse an RFC3339 timestamp from Render, tolerating a trailing ``Z``., Pull the most recent numeric sample out of a ``get_metrics`` payload. Render…, Run one full scan and return every finding, filed or not. Never raises: a… (+13 more)

### Community 171 - "persist_plan_spec"
Cohesion: 0.07
...
### Community 172 - "TestEstimateTokensForMessages"
Cohesion: 0.05
...
### Community 175 - "PatternConsolidation"
Cohesion: 0.08
...
### Community 178 - "test_daily_2026_07_27.py"
Cohesion: 0.07
...
### Community 181 - "Usage"
Cohesion: 0.06
Nodes (38): AlertHandler, BudgetTracker, Counter, _Dimensions, _month(), Any, packages/llm/budget.py — token and cost accounting with spend alerts. Tracks…, Register a callback fired when a spend threshold is crossed. (+30 more)

### Community 182 - "Company"
Cohesion: 0.06
...
### Community 184 - "test_pr923_fixes.py"
Cohesion: 0.06
...
### Community 185 - "StreamingDeltaReconstructor"
Cohesion: 0.07
...
### Community 188 - "test_telegram_freebuff.py"
Cohesion: 0.07
...
### Community 191 - "OllamaCircuitBreaker"
Cohesion: 0.08
...
### Community 192 - "test_runtime_governance.py"
Cohesion: 0.07
Nodes (61): Feed LLM token/cost spend into the governance session budget. Kept separate…, Charge sub-agent nesting depth and enforce the ``max_depth`` ceiling. Isolates…, events_from_identity(), Extract the identity-derived audit fields from an AgentIdentity. Kept here…, get_gate(), governance_enabled(), True when the governance layer should run at all. A single global off switch…, Best-effort identity for an ``AgentRunner``-like object. Wiring governance into… (+53 more)
...
### Community 197 - "test_classify_dependabot_update.py"
Cohesion: 0.07
...
### Community 199 - "ExecutionRequest"
Cohesion: 0.06
Nodes (53): get_ceo_dispatcher(), Return the shared CEODispatcher singleton., BoundContext, ClassifyOutput, ExecutionRequest, ExecutionResult, _get_ceo_dispatcher(), JudgeVerdict (+45 more)

### Community 200 - "_get_provider_policy"
Cohesion: 0.07
...
### Community 201 - "ProvidersScreen.jsx"
Cohesion: 0.06
...
### Community 202 - "TrafficDirector"
Cohesion: 0.04
Nodes (56): provider_max_parallel(), provider_max_rpm(), provider_max_tpm(), _provider_positive_float(), provider_weight(), Shared parse/validate for the numeric per-provider traffic budgets. Returns…, Return the operator-configured requests/min cap for *provider*, or None if…, Return the operator-configured tokens/min cap for *provider*. Reads… (+48 more)

### Community 203 - "ApprovalStore"
Cohesion: 0.07
...
### Community 213 - "resolve_active_brain"
Cohesion: 0.09
...
### Community 217 - "test_process_quick_note_workflow.py"
Cohesion: 0.06
...
### Community 219 - "emit_chat_observation"
Cohesion: 0.09
...
### Community 224 - "WorkspaceTools"
Cohesion: 0.04
Nodes (52): Register the built-in agent tools that are always available., _register_builtin_tools(), Path, tools.py — WorkspaceTools: read/write/search and diff application (risky…, Precise string replacement — F1 roadmap item (Codebuff/Claude Code-style edit).…, Return a previously saved memory value, or an empty string if absent., Persist a key/value pair to the user's profile store., Return the first *lines* lines of a file. Just-in-time retrieval: the executor… (+44 more)

### Community 225 - "v4_api.py"
Cohesion: 0.10
...
### Community 229 - "test_llm_router_tpm.py"
Cohesion: 0.07
Nodes (41): estimate_tokens(), FitResult, message_tokens(), prune(), Any, packages/llm/context.py — keeping conversations inside the context window. The…, Truncate oversized tool results and drop exact duplicate turns. Tool results…, Keep system messages, the first turn, and the newest turns that fit. Returns… (+33 more)

### Community 230 - "resolve_component_model"
Cohesion: 0.03
...
### Community 235 - "test_slop_gate.py"
Cohesion: 0.07
...
### Community 242 - "test_brain_patch_service_token.py"
Cohesion: 0.18
...
### Community 249 - "test_one_model_catalogue.py"
Cohesion: 0.17
...
### Community 253 - "test_control_plane_api.py"
Cohesion: 0.06
...
### Community 256 - "test_verification_strategies.py"
Cohesion: 0.11
...
### Community 258 - "test_governance_api.py"
Cohesion: 0.06
...
### Community 261 - "REWRITE_PLAN.md — Phased Migration Strategy"
Cohesion: 0.06
...
### Community 264 - "get_skill_bindings"
Cohesion: 0.08
Nodes (31): _execute_skill_impl(), _get_portfolio_manager(), get_skill_bindings(), Any, Live Graphify executor — queries the codebase knowledge graph. Order of…, Live council reviewer — deterministic, rules-based multi-perspective review…, Get the singleton SkillBindings instance., Recommend skills based on detected systems and provisioned specialists. With no… (+23 more)

### Community 265 - "test_implement_agent_routing.py"
Cohesion: 0.07
...
### Community 266 - "test_persistent_memory.py"
Cohesion: 0.06
...
### Community 267 - "test_telegram_mutating_commands.py"
Cohesion: 0.08
...
### Community 269 - "report_to_markdown"
Cohesion: 0.10
...
### Community 270 - "call_llm"
Cohesion: 0.04
Nodes (58): _agent_provider_failure_response(), _agent_timeout_fallback_response(), _append_agent_session_message(), _build_auto_skill_guidance(), _build_provider_router(), _builtin_provider_records(), call_llm(), _chat_provider_policy() (+50 more)
...
### Community 272 - "RateLimitTracker"
Cohesion: 0.16
...
### Community 274 - "test_all_providers_discovery.py"
Cohesion: 0.17
...
### Community 280 - "ProviderConfig"
Cohesion: 0.07
Nodes (36): is_commercial_provider(), provider_access_tier(), _provider_field(), provider_sort_key(), ProviderConfig, Tests that verify the exact provider priority ordering., When INCLUDE_LOCAL_FALLBACK=true and no cloud keys are set, local Ollama must…, ollama-local must NOT appear when NVIDIA_API_KEY is set and… (+28 more)
...
### Community 288 - "test_llm_router_disabled.py"
Cohesion: 0.09
...
### Community 289 - "test_kimi_bridge_server.py"
Cohesion: 0.05
...
### Community 297 - "brain_failover.py"
Cohesion: 0.12
...
### Community 299 - "OrchestratorCheckpointStore"
Cohesion: 0.12
...
### Community 302 - "test_nvidia_model_discovery.py"
Cohesion: 0.06
...
### Community 303 - "test_workspace_isolation.py"
Cohesion: 0.16
...
### Community 309 - "LlmProviderConfig"
Cohesion: 0.15
...
### Community 311 - "Quick-Note GitHub Issues Processing - Session Summary"
Cohesion: 0.06
...
### Community 312 - "autonomous_fix.py"
Cohesion: 0.10
...
### Community 313 - "tests/conftest.py"
Cohesion: 0.05
...
### Community 315 - "test_rate_limiter.py"
Cohesion: 0.22
...
### Community 319 - "test_autonomy_gate.py"
Cohesion: 0.12
...
### Community 320 - "openclaw_gateway.py"
Cohesion: 0.15
...
### Community 321 - "test_force_cleanup_conditional_delete.py"
Cohesion: 0.10
...
### Community 323 - "ProjectScaffolder"
Cohesion: 0.13
...
### Community 328 - "ensure_self_company"
Cohesion: 0.09
...
### Community 329 - "test_claude_setup_audit.py"
Cohesion: 0.16
...
### Community 332 - "test_provider_state_durability.py"
Cohesion: 0.12
...
### Community 335 - "test_purge_backlog.py"
Cohesion: 0.09
...
### Community 341 - "webui/router.py"
Cohesion: 0.09
Nodes (31): get_brain_preference(), invalidate_brain_cache(), Clear the cached brain so the next read re-resolves. Called from…, Return the operator's brain provider preference. Values: - ``"nvidia"`` —…, When BrainConfig.updated_at is empty (never applied), the resolver falls…, test_resolve_active_brain_falls_through_when_db_unset(), Any, Path (+23 more)
...
### Community 344 - "test_telegram_service_webhook.py"
Cohesion: 0.18
...
### Community 353 - "get_scheduler"
Cohesion: 0.13
Nodes (25): autonomy_tick(), Execute ONE pending task synchronously. Called by the cron workflow every 2…, get_scheduler(), create_schedule(), delete_schedule(), get_schedule(), get_schedule_runs(), list_schedules() (+17 more)
...
### Community 357 - "test_colibri_provider.py"
Cohesion: 0.12
...
### Community 362 - "_captured_request_headers"
Cohesion: 0.13
...
### Community 363 - "TestNoNvidiaFallbackIsRetired"
Cohesion: 0.22
...
### Community 364 - "test_phase6_workflow.py"
Cohesion: 0.13
...
### Community 370 - "control_registry.py"
Cohesion: 0.14
...
### Community 373 - "test_telegram_auto_approve.py"
Cohesion: 0.21
...
### Community 374 - "test_brain_migration_writes_a_live_model.py"
Cohesion: 0.10
...
### Community 380 - "AGENTS.md — Codebase Map & Operations Reference"
Cohesion: 0.15
...
### Community 381 - "agile_sprints.py"
Cohesion: 0.14
...
### Community 386 - "test_connector_registry.py"
Cohesion: 0.12
...
### Community 387 - "NIMConnectionPool"
Cohesion: 0.11
...
### Community 389 - "skill_bindings.py"
Cohesion: 0.09
...
### Community 390 - "TemporalContextGraph"
Cohesion: 0.10
...
### Community 391 - "test_telegram_approval_e2e.py"
Cohesion: 0.12
...
### Community 398 - "Local AI Stack with Docker"
Cohesion: 0.08
...
### Community 403 - "test_agent_free_brain.py"
Cohesion: 0.05
...
### Community 409 - "Native operations"
Cohesion: 0.09
...
### Community 410 - "test_memory_guard.py"
Cohesion: 0.13
...
### Community 414 - "test_skill_registry.py"
Cohesion: 0.13
...
### Community 419 - "_resolve_user_github_token"
Cohesion: 0.12
...
### Community 431 - "SyntheticDataPipeline"
Cohesion: 0.13
...
### Community 432 - "test_task_source_id_race.py"
Cohesion: 0.13
...
### Community 434 - "test_cerebras_catalogue.py"
Cohesion: 0.13
...
### Community 435 - "test_monitor_lib.py"
Cohesion: 0.11
...
### Community 437 - "test_mostly_failed_steps.py"
Cohesion: 0.12
...
### Community 440 - "HarnessEnrichment"
Cohesion: 0.14
...
### Community 447 - "implement_agent.py"
Cohesion: 0.12
...
### Community 449 - "test_phase4_runtime_resilience.py"
Cohesion: 0.15
...
### Community 450 - "OrchestratorSupervisor"
Cohesion: 0.10
Nodes (15): get_orchestrator_queue(), get_orchestrator_supervisor(), OrchestratorSupervisor, Any, services/orchestrator_supervisor.py — Deterministic Supervisor Issue #522: A…, Emit an alert to the activity feed and log., Deterministic supervisor for the orchestrator. Runs as a background coroutine.…, start_orchestrator_supervisor() (+7 more)

### Community 451 - "_process_task_callback"
Cohesion: 0.28
...
### Community 454 - "test_ceo_router.py"
Cohesion: 0.13
...
### Community 456 - "test_telegram_diag_endpoint.py"
Cohesion: 0.09
...
### Community 460 - "DirectChatDoctor"
Cohesion: 0.47
...
### Community 461 - "PersistentMemoryStore"
Cohesion: 0.22
...
### Community 463 - "TestStreamableHTTPTransport"
Cohesion: 0.13
...
### Community 464 - "test_dashboard_cache.py"
Cohesion: 0.13
...
### Community 465 - "V3 API Migration Plan — LLM Relay Platform"
Cohesion: 0.10
...
### Community 466 - "test_chat_mode_regressions.py"
Cohesion: 0.18
...
### Community 467 - "system_instruction"
Cohesion: 0.16
...
### Community 469 - "services/seo_audit.py"
Cohesion: 0.11
...
### Community 471 - "run_trend_analysis"
Cohesion: 0.18
...
### Community 472 - "test_unit5_ui_provider_surface.py"
Cohesion: 0.10
...
### Community 479 - "test_render_mcp.py"
Cohesion: 0.06
...
### Community 483 - "Docker AI Governance Audit — Final Report"
Cohesion: 0.10
...
### Community 484 - "1. Capability-by-capability"
Cohesion: 0.10
...
### Community 486 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 491 - "TestTheGatewayRegistryOffersOnlyLiveModels"
Cohesion: 0.27
...
### Community 496 - "PriorityTaskQueue"
Cohesion: 0.15
...
### Community 502 - "test_tasks_cache_ttl_env.py"
Cohesion: 0.21
...
### Community 506 - "_extract_tech_relevance"
Cohesion: 0.17
...
### Community 519 - "is_anthropic_base_url"
Cohesion: 0.12
...
### Community 520 - "Delegation Plan (agent-ready work packages)"
Cohesion: 0.11
...
### Community 527 - "test_gh_brain_failover.py"
Cohesion: 0.11
...
### Community 530 - "validate_session_id"
Cohesion: 0.16
...
### Community 534 - "Comprehensive Skill Index (By Category)"
Cohesion: 0.11
...
### Community 535 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 536 - "Component Map"
Cohesion: 0.11
...
### Community 538 - "Architecture Overview — local-llm-server"
Cohesion: 0.11
...
### Community 539 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
...
### Community 547 - "TestStopSlopChecker"
Cohesion: 0.11
...
### Community 554 - "cowork_session.py"
Cohesion: 0.15
...
### Community 559 - "_check_storage_health"
Cohesion: 0.13
...
### Community 570 - "test_activation_api.py"
Cohesion: 0.21
...
### Community 571 - "TestAListingFailureDoesNotVetoTheAnswer"
Cohesion: 0.17
...
### Community 573 - "test_health_endpoints.py"
Cohesion: 0.17
...
### Community 574 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 575 - "test_openclaw_endpoints.py"
Cohesion: 0.12
...
### Community 586 - "Nothing is blocked on an agent. Two things need a human."
Cohesion: 0.12
...
### Community 587 - "Contributing to local-llm-server"
Cohesion: 0.12
...
### Community 588 - "refresh_agent_built_proof.py"
Cohesion: 0.20
...
### Community 589 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 592 - "test_agent_chat_integration.py"
Cohesion: 0.23
...
### Community 594 - "test_brain_config_api.py"
Cohesion: 0.12
...
### Community 600 - "weekly_digest.py"
Cohesion: 0.13
...
### Community 608 - "test_migrate_local_brain_env.py"
Cohesion: 0.38
...
### Community 609 - "test_phase5_doctor.py"
Cohesion: 0.12
...
### Community 610 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 611 - "test_refresh_agent_built_proof.py"
Cohesion: 0.12
...
### Community 612 - "test_self_heal.py"
Cohesion: 0.11
...
### Community 626 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 630 - "test_daily_2026_07_24.py"
Cohesion: 0.20
...
### Community 638 - "test_daily_automation_2026_07_11.py"
Cohesion: 0.15
...
### Community 641 - "test_scanner_live.py"
Cohesion: 0.23
...
### Community 642 - "DailyDigestAggregatorTests"
Cohesion: 0.19
...
### Community 644 - "migrate_local_brain_env.py"
Cohesion: 0.19
...
### Community 649 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 653 - "Checks Performed"
Cohesion: 0.14
...
### Community 654 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 663 - "Main proxy (`proxy.py`)"
Cohesion: 0.14
...
### Community 664 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 666 - "Render MCP — autonomous platform debugging and environment monitoring"
Cohesion: 0.14
...
### Community 667 - "Runbook: Auto-Resume After Cooldown / Interruption"
Cohesion: 0.14
...
### Community 668 - "SEO / GEO / AIO Audit Engine"
Cohesion: 0.14
...
### Community 669 - "Traffic Distribution Across Providers"
Cohesion: 0.08
...
### Community 671 - "_probe_failure_reason"
Cohesion: 0.19
...
### Community 673 - "test_p0_roadmap_b3_b4_b5.py"
Cohesion: 0.20
...
### Community 674 - "SeoCheckDefinition"
Cohesion: 0.09
...
### Community 675 - "ProbeResult"
Cohesion: 0.15
Nodes (13): ProbeResult, BaseModel, Outcome of a single (provider, model) liveness probe., A model that 410s must be rejected with 422 + a probe report., A model that probes 200 OK must be persisted., If the chosen provider's key is missing, the probe short-circuits → 422., A partial PATCH only probes the changed role — not every role., POST /admin/api/policy/brain/test fires a probe but does NOT save. (+5 more)
...
### Community 677 - "get_failover_manager"
Cohesion: 0.08
...
### Community 678 - "test_openclaw_gateway.py"
Cohesion: 0.14
...
### Community 679 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 680 - "test_tasks_awaiting_approval_api.py"
Cohesion: 0.37
...
### Community 682 - "test_task_brain_preflight.py"
Cohesion: 0.31
...
### Community 698 - "platform_controls_router.py"
Cohesion: 0.29
...
### Community 701 - "Skill: platform-setup — Autonomous Agency Bootstrap"
Cohesion: 0.15
...
### Community 702 - "Device compatibility and model picks"
Cohesion: 0.15
...
### Community 703 - "Autonomy Uplift — Living Roadmap & Detailed Implementation Specs"
Cohesion: 0.15
...
### Community 704 - "OpenClaw — iOS Control of the Agency (Single-Service Free-Tier Deploy)"
Cohesion: 0.15
...
### Community 706 - "ApplyReviewAgent"
Cohesion: 0.22
...
### Community 709 - "2. Critical Bugs & Exact Detection Signatures"
Cohesion: 0.18
...
### Community 710 - "_parse_reset_epoch"
Cohesion: 0.33
...
### Community 712 - "brain_liveness.py"
Cohesion: 0.22
...
### Community 718 - "TestAgentRunnerSafety"
Cohesion: 0.19
...
### Community 719 - "TestModelCostTableUpdates"
Cohesion: 0.26
...
### Community 720 - "TestMCPClientStructuredOutput"
Cohesion: 0.15
...
### Community 721 - "TestDecisionsBotLinks"
Cohesion: 0.17
...
### Community 734 - "Skill: system-prompt-audit"
Cohesion: 0.17
...
### Community 735 - "Skill: task-alive-updates"
Cohesion: 0.17
...
### Community 742 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 744 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 745 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 746 - "Workspace Isolation Architecture"
Cohesion: 0.17
...
### Community 748 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 749 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 750 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 751 - "GovernanceScreen.jsx"
Cohesion: 0.18
...
### Community 756 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 759 - "test_agile_api.py"
Cohesion: 0.17
...
### Community 760 - "test_app_settings.py"
Cohesion: 0.21
...
### Community 761 - "test_brain_default_consistency.py"
Cohesion: 0.24
...
### Community 762 - "TestAnthropicWorkspaceIdCapture"
Cohesion: 0.33
...
### Community 763 - "test_e2b_data_flow.py"
Cohesion: 0.05
Nodes (48): agent/mcp_client.py — Async MCP client for the mcp-server Docker container.…, maybe_attach_e2b(), services/e2b_sandbox.py — E2B Firecracker micro-VM sandbox session. Implements…, Open an E2B session and attach it as ``runner._mcp``. Single wiring line for…, fake_sandbox(), _FakeAsyncSandboxClass, _FakeCmdResult, _FakeCommands (+40 more)

### Community 764 - "TestAnthropicPayloadStructuredOutput"
Cohesion: 0.29
...
### Community 767 - "_redact_for_notification"
Cohesion: 0.24
...
### Community 782 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 783 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 784 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 785 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 786 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 787 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 790 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 791 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 792 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 793 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 794 - "What to clean up"
Cohesion: 0.18
...
### Community 795 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 799 - "test_cost_attribution.py"
Cohesion: 0.20
...
### Community 806 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 807 - "test_event_log.py"
Cohesion: 0.45
...
### Community 808 - "test_nvidia_default_model.py"
Cohesion: 0.24
...
### Community 809 - "openclaw_reverse_proxy"
Cohesion: 0.22
...
### Community 812 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 813 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 814 - "admin_local_brain_router.py"
Cohesion: 0.22
...
### Community 815 - "connectors_api.py"
Cohesion: 0.22
...
### Community 817 - "_normalize_tool_choice"
Cohesion: 0.31
...
### Community 818 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 819 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 820 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 821 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 822 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 823 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 824 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 829 - "Issue #1427: quick-note:https://github.com/bingreeky/JIT"
Cohesion: 0.20
...
### Community 830 - "LLM Router — configuration guide"
Cohesion: 0.20
...
### Community 831 - "LLM Router — provider guide"
Cohesion: 0.20
...
### Community 832 - "CI Troubleshooting Runbook"
Cohesion: 0.20
...
### Community 835 - "enrich_quick_note_issues.py"
Cohesion: 0.36
...
### Community 837 - "test_catalogue_probe.py"
Cohesion: 0.20
...
### Community 839 - "TestPoliciesGovernanceStableClaim"
Cohesion: 0.25
...
### Community 840 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 841 - "test_model_catalog_guard.py"
Cohesion: 0.29
...
### Community 848 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 870 - "_get_current_user"
Cohesion: 0.25
...
### Community 871 - "_build_direct_chat_schedule_suggestion"
Cohesion: 0.32
...
### Community 873 - "capture_screens.py"
Cohesion: 0.33
...
### Community 874 - "_start_ceo_agency"
Cohesion: 0.31
...
### Community 877 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 878 - "test_changelog_parity_guard.py"
Cohesion: 0.22
...
### Community 880 - "TestPolicyAuthoringUiStableClaim"
Cohesion: 0.22
...
### Community 881 - "TestTheCopiesMayNotDriftFurther"
Cohesion: 0.36
Nodes (4): A frozen record of the divergence found on 2026-08-28. Reconciling these eleven…, These two are the ones this work reconciled, and each was reconciled because…, A shrinking divergence is progress, but the list must be trimmed to match or it…, TestTheCopiesMayNotDriftFurther

### Community 882 - "TestPaidPolicyDurability"
Cohesion: 0.22
...
### Community 883 - "test_scanner_deps_parity.py"
Cohesion: 0.31
...
### Community 884 - "test_serve_spa_prefixes.py"
Cohesion: 0.31
...
### Community 894 - "quality_checker.py"
Cohesion: 0.32
...
### Community 896 - "TestOneIdCanBelongToSeveralProviders"
Cohesion: 0.39
...
### Community 904 - "ADR 001: Self-Hosted OpenAI-Compatible Proxy"
Cohesion: 0.25
Nodes (7): ADR 001: Self-Hosted OpenAI-Compatible Proxy, Consequences, Context, Decision, Negative, Neutral, Positive

### Community 905 - "ADR 002: Dynamic Model Routing with Task Classification"
Cohesion: 0.25
...
### Community 910 - "_load_local_metrics_since"
Cohesion: 0.43
...
### Community 942 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 943 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 944 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 945 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 946 - "Continual Harness (`agent/harness_spec.py`)"
Cohesion: 0.25
...
### Community 947 - "Prime Agent Runtime"
Cohesion: 0.25
...
### Community 950 - "security_fix_agent.py"
Cohesion: 0.46
...
### Community 955 - "crispy_burn_in.py"
Cohesion: 0.36
...
### Community 962 - "test_compose_and_coordinate_api.py"
Cohesion: 0.36
...
### Community 984 - "AI Engineering Insights Skill"
Cohesion: 0.29
...
### Community 997 - "Changelog"
Cohesion: 0.29
Nodes (7): Added, Changed, Changelog, Fixed, Maintenance, Removed, Security

### Community 998 - "claude-mem Plugin — Persistent Memory for All Sessions"
Cohesion: 0.29
...
### Community 999 - "Implementation plan + TO-DO (check off as you go)"
Cohesion: 0.29
...
### Community 1022 - "InitiativeProgress"
Cohesion: 0.33
...
### Community 1023 - "openclaw_mobile_ui"
Cohesion: 0.33
...
### Community 1038 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 1039 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 1040 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 1042 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 1043 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 1046 - "resolve_hermes_base_url"
Cohesion: 0.47
...
### Community 1059 - "test_log_monitor_storm_guard.py"
Cohesion: 0.48
...
### Community 1061 - "TestDisabledProvidersAreNotFalselyReportedUnreachable"
Cohesion: 0.33
...
### Community 1063 - "agent/output_filter.py"
Cohesion: 0.33
...
### Community 1083 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 1084 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 1094 - "_add_colibri_shim_changelog_entry.py"
Cohesion: 0.50
...
### Community 1095 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1096 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1097 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 1098 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 1099 - "setup_colibri.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1100 - "setup_colibri.sh script"
Cohesion: 0.70
Nodes (4): setup_colibri.sh script, fail(), ok(), warn()

### Community 1101 - "status_colibri_server.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1102 - "Startup Issues"
Cohesion: 0.33
...
### Community 1114 - "worker/index.js"
Cohesion: 0.60
Nodes (4): fetch(), needsProxy(), PROXY_PREFIXES, scheduled()

### Community 1115 - "TestCEOAgencySystem"
Cohesion: 0.33
...
### Community 1145 - "test_no_exception_detail_leaks.py"
Cohesion: 0.50
...
### Community 1146 - "Network and Tunnel Issues"
Cohesion: 0.40
...
### Community 1147 - "github"
Cohesion: 0.50
Nodes (3): github, enabled, silent

### Community 1149 - "reset_cache"
Cohesion: 0.40
...
### Community 1173 - "TestModelRoleSeparation"
Cohesion: 0.40
...
### Community 1275 - "Claude Code Specific Issues"
Cohesion: 0.50
...
### Community 1278 - "portfolio_refresh.py"
Cohesion: 0.67
Nodes (3): _load(), main(), Scheduled portfolio intelligence sweep. Run by `.github/workflows/portfolio-…

### Community 1280 - "test_the_reserve_is_bounded_when_read_from_the_environment"
Cohesion: 0.67
...
- **3527 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3522 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 13444 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **115 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `_fixture()` connect `_fixture` to `clear_override`, `cost_tracker.py`, `TestNormalizeResponseFormat`, `TaskSpec`, `Task`, `test_llm_router_strategies.py`, `test_provider_router.py`, `ClaudeCodeAdapter`, `BrainConfig`, `test_operational_incidents.py`, `test_llm_router_queue_cache.py`, `test_gh_brain_failover.py`, `llm/router.py`, `TaskWorkflowService`, `E2BSandboxSession`, `PolicyEngine`, `SelfHealingAgent`, `AgentJobManager`, `test_failover_client_shared.py`, `test_llm_router_resilience.py`, `test_company_api.py`, `validate_policy_text`, `ImprovementLoop`, `test_telegram_webhook.py`, `SeoAuditEngine`, `test_model_router.py`, `WorkflowRun`, `direct_chat.py`, `MCPClient`, `test_unit8_model_catalog.py`, `BrainWatchdog`, `test_knowledge_sync.py`, `services/background.py`, `AgentSwarm`, `test_openclaw_endpoints.py`, `ChatHistoryStore`, `WebsiteScanner`, `TokenBudget`, `test_ai_insights.py`, `ResearchTask`, `SQLiteStore`, `TaskStatus`, `TestClient`, `config.py`, `reset_kv_state`, `e2e/test_browser.py`, `test_llm_router_e2e.py`, `ArtifactStore`, `test_autonomy_status.py`, `_resolve_brain_provider`, `CEOSupervisor`, `test_local_brain_state.py`, `_resolve_push_token`, `test_phase5_doctor.py`, `PrimeAgentAdapter`, `test_procedural_memory.py`, `BackgroundAgent`, `test_refresh_agent_built_proof.py`, `seo_api.py`, `claim`, `get_workflow_orchestrator`, `OutputFilter`, `test_sam_voice.py`, `resolve_e2b_config`, `test_colibri_brain_shim.py`, `test_startup_warmup.py`, `reset_cache`, `clear_cooldowns`, `test_sam_livekit.py`, `KeyStore`, `NotificationDispatcher`, `test_context_rulebook.py`, `test_ephemeral_reaper.py`, `run_task`, `UserRole`, `test_new_features_e2e.py`, `test_issue_intake.py`, `FreeBuffAgent`, `_step`, `SeoCheckDefinition`, `test_trend_watcher.py`, `get_failover_manager`, `TestHarnessAdapter`, `test_openclaw_gateway.py`, `test_agent_tool_governance.py`, `WorkflowRun`, `test_task_brain_preflight.py`, `persist_plan_spec`, `TestEstimateTokensForMessages`, `test_response_cache.py`, `test_daily_2026_07_27.py`, `Usage`, `test_e2b_task_wiring.py`, `test_telegram_freebuff.py`, `OllamaCircuitBreaker`, `_job_text`, `_Budget`, `analyze_page`, `TrafficDirector`, `test_features_api.py`, `TestAgentRunnerSafety`, `TrendWatcher`, `test_video_transcript.py`, `test_portfolio_intake.py`, `rate_limiter.py`, `resolve_active_brain`, `SchedulerStore`, `WorkflowBuildRequest`, `test_process_quick_note_workflow.py`, `test_llm_router_tpm.py`, `resolve_component_model`, `TestClient`, `test_brain_patch_service_token.py`, `test_agile_api.py`, `test_app_settings.py`, `ContextPruner`, `test_e2b_data_flow.py`, `test_control_plane_api.py`, `test_task_clarification.py`, `test_implement_agent_routing.py`, `test_persistent_memory.py`, `SecurityScanner`, `test_platform_controls.py`, `test_llm_router_disabled.py`, `test_kimi_bridge_server.py`, `OrchestratorCheckpointStore`, `OrchestratorQueue`, `test_nvidia_model_discovery.py`, `FailoverResult`, `tests/conftest.py`, `test_mcp_governance.py`, `session_retro.py`, `test_catalogue_probe.py`, `TestMongoGate`, `test_scheduler_hydration_bounded.py`, `test_provider_state_durability.py`, `test_purge_backlog.py`, `test_telegram_service_webhook.py`, `test_regression.py`, `test_agent_scripts_share_one_model_list.py`, `test_crispy_burn_in.py`, `test_provider_enable_disable.py`, `test_skill_registry_boot_refresh.py`, `isolated_telegram_config`, `_start_ceo_agency`, `TestSwarmRoleRouting`, `test_telegram_auto_approve.py`, `_undeclared`, `test_service_token.py`, `test_harness_spec.py`, `test_agent_free_brain.py`, `test_agency_fix.py`, `_Recorder`, `test_webui_provider_priority.py`, `_resolve_user_github_token`, `api_keys_for`, `test_monitor_lib.py`, `test_v4_api.py`, `TestTheWorkflowIsSafeAndReadOnly`, `test_ping.py`, `test_ceo_router.py`, `test_runtimes_health_endpoint.py`, `test_telegram_diag_endpoint.py`, `TestFeaturesAPI`, `test_dashboard_cache.py`, `client`, `test_voice_pipeline.py`, `test_doctor_coding_brain.py`?**
  _High betweenness centrality (0.098) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `test_governance_api.py`, `proxy.py`, `TaskSpec`, `call_llm`, `E2BSandboxSession`, `test_agent_free_brain.py`, `PolicyEngine`, `Any`, `AgentJobManager`, `test_failover_client_shared.py`, `ContextManager`, `FreeBuffAgent`, `ReactScratchpad`, `agency.py`, `MultiAgentSwarm`, `TestAgentRunnerExecution`, `get_failover_manager`, `test_empirical_verify.py`, `InternalAgentAdapter`, `test_agent_tool_governance.py`, `WorkflowRun`, `direct_chat.py`, `MCPClient`, `CEODispatcher`, `StuckDetector`, `UserMemoryStore`, `AgentSessionStore`, `test_runtime_governance.py`, `ExecutionRequest`, `TokenBudget`, `TestAgentRunnerSafety`, `test_agent_chat_integration.py`, `LocalWorkspace`, `WorkspaceTools`, `BackgroundAgent`, `PortfolioManager`, `GitHubTools`, `loop.py`, `AdaptiveHalter`, `ContextPruner`, `test_daily_automation_2026_07_11.py`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `Task` connect `Task` to `backend/server.py`, `company_api.py`, `test_sam_livekit.py`, `test_trend_scoping.py`, `BrainConfig`, `TaskWorkflowService`, `_fixture`, `test_issue_intake.py`, `tasks/api.py`, `test_tasks_awaiting_approval_api.py`, `test_task_brain_preflight.py`, `test_task_source_id_race.py`, `delegate_seo_findings`, `get_task_store`, `test_e2b_task_wiring.py`, `test_phase4_runtime_resilience.py`, `ensure_self_company`, `WorkflowEngine`, `test_purge_backlog.py`, `test_portfolio_intake.py`, `TaskStatus`, `seo_api.py`, `v4_api.py`, `test_phase6_workflow.py`, `test_schedule_growth_invariants.py`, `._coerce_ts`, `TaskDispatcher`?**
