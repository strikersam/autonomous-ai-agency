# Graph Report - local-llm-server  (2026-07-31)

## Corpus Check
- 1352 files · ~1,888,604 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 26254 nodes · 52925 edges · 1138 communities (1025 shown, 113 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 5763 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `224b01cb`
...
## Communities (1138 total, 113 thin omitted)

### Community 0 - "backend/server.py"
Cohesion: 0.01
Nodes (415): agent/skill_registry.py — Dynamic Skill Registry & Recommender Fetches skill…, set_skill_registry(), get_harness_adapter(), admin_seed(), _agent_provider_failure_response(), _agent_timeout_fallback_response(), _append_agent_session_message(), auth_me() (+407 more)

### Community 1 - "AgentSessionStore"
Cohesion: 0.04
Nodes (154): Agency, CEO-coordinated multi-agent agency for continuous codebase management. The CEO…, AgentJobRequest, AgentJobSnapshot, BaseModel, Complete point-in-time view of a job, safe to serialise as API response., Convenience: the canonical text response, whether success or failure., Validated input for creating a new agent job. Passed from the API handler into… (+146 more)

### Community 2 - "FreeBuffAgent"
Cohesion: 0.04
Nodes (164): BackgroundTask, BrowserSession, Async Playwright browser session. Usage:: session = BrowserSession() await…, True if Playwright is installed and ready to use., CommitAttribution, CommitTracker, Path, agent/commit_tracker.py — AI Commit Attribution Tags git commits with metadata… (+156 more)

### Community 3 - "AgentRunner"
Cohesion: 0.02
Nodes (161): get_enrichment(), agent/harness_enrichment.py — Automatic Harness Enrichment for Agent Prompts…, Agent subsystem — planner / executor / verifier loop., AgentPhaseError, AgentRunner, _check_extra_kwargs(), _enforce_signature(), _nvidia_api_key() (+153 more)

### Community 4 - "proxy.py"
Cohesion: 0.02
Nodes (191): get_agency(), set_agency(), Any, Return recent commits with agent attribution trailers parsed out., free_nvidia_models(), Return the curated list of free NVIDIA NIM models FreeBuff may use., List the free NVIDIA NIM models a user may pick (e.g. via Telegram)., True when *model* is in the curated free NVIDIA NIM set. (+183 more)

### Community 5 - "WebsiteScanner"
Cohesion: 0.02
Nodes (124): DetectedSystem, Evidence, Evidence supporting a system detection., A business system detected on a company's website or in their stack., Get the most confident evidence description., Inferred technology stack from website/repo analysis., StackInference, main() (+116 more)
...
### Community 7 - "BackgroundAgent"
Cohesion: 0.02
Nodes (94): BackgroundAgent, _now(), Any, agent/background.py — Background Agent An always-on worker thread that…, Enqueue *task* for processing. Returns the task (with task_id set)., Convenience: create a task and submit it in one call., Real handler — dispatches through AgentRunner when available. HARDENED (PR…, Always-on worker that drains a task queue on a daemon thread. GATE: Golden Path… (+86 more)

### Community 8 - "company_api.py"
Cohesion: 0.03
Nodes (137): ephemeral_ttl_hours(), Async read of the ephemeral TTL (hours) straight from the DB., account_lifecycle(), auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint(), generate_onboarding_questions() (+129 more)

### Community 9 - "LLMRequest"
Cohesion: 0.04
Nodes (81): ProviderConfig, One configured endpoint. ``kind`` selects the adapter: ``openai`` (any OpenAI-…, AnthropicProvider, Any, AsyncClient, packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, Accept both OpenAI and native Anthropic tool declarations., Adapter for ``POST /v1/messages``. (+73 more)

### Community 10 - "test_runtimes.py"
Cohesion: 0.03
Nodes (55): AiderAdapter, Any, Adapter for Aider — TIER 3 specialized git-aware code editor., GooseAdapter, Any, Adapter for Goose — TIER 2 general-purpose local runtime., HermesAdapter, Adapter for Hermes Agent — FIRST CLASS autonomous runtime. (+47 more)
...
Cohesion: 0.03
Nodes (108): _load(), main(), int, get_budget(), The process-wide budget tracker., get_cache(), The process-wide cache manager., failover_chat_completion_via_router() (+100 more)

### Community 13 - "direct_chat.py"
Cohesion: 0.03
Nodes (112): PreflightIssue, PreflightReport, Any, BaseModel, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, Translate technical preflight issues into a conversational assistant reply., translate_error_to_conversational(), ResumeRequest (+104 more)

### Community 14 - "api.js"
Cohesion: 0.02
Nodes (39): approveTaskCheckpoint(), approveTaskExecution(), autoRecommendCompanySkills(), createMcpServer(), createSprint(), delegateSeoFindings(), deleteCompany(), deleteMcpServer() (+31 more)

### Community 15 - "BrainConfig"
Cohesion: 0.03
Nodes (97): BrainConfig, BrainConfigStore, default_brain_config(), get_brain_config(), invalidate_brain_config_cache(), BaseModel, Build a ``BrainConfig`` from a Mongo doc, dropping Mongo's ``_id``., Convenience wrapper used by the agent loop + brain resolver. (+89 more)

### Community 16 - "test_llm_router_queue_cache.py"
Cohesion: 0.03
Nodes (84): payload_key(), Exact-match cache key over the fields that change the answer. Routing…, build_summariser(), chunk_document(), ContextManager, estimate_tokens(), FitResult, message_tokens() (+76 more)

### Community 17 - "test_llm_router_strategies.py"
Cohesion: 0.04
Nodes (94): count, HealthConfig, Strategy selection and degradation behaviour., Circuit breaker + health tracking thresholds., RoutingConfig, HealthTracker, _Outcome, Health and circuit-breaker state for every provider. (+86 more)

### Community 18 - "services/background.py"
Cohesion: 0.04
Nodes (92): _dispatch_async(), _ErrorCaptureHandler, get_log_monitor(), LogMonitor, _note_recurrence(), Any, LogRecord, agent/log_monitor.py — Application Log Monitor Captures ERROR/CRITICAL log… (+84 more)
...
### Community 20 - "SQLiteStore"
Cohesion: 0.02
Nodes (54): Delete a company and all its associated data., Delete a company and all associated data from SQLite., Count total companies in SQLite., Reconstruct a Website from a SQLite row, preferring the full JSON blob (which…, Count total companies in the store., Create a new website in SQLite. The full model is stored in ``data`` so scan…, Get a website by ID from SQLite., Update a website in SQLite. When ``company_id`` is omitted the existing company… (+46 more)

### Community 21 - "skill_bindings.py"
Cohesion: 0.03
...
### Community 22 - "TrafficDirector"
Cohesion: 0.04
Nodes (60): provider_max_parallel(), provider_max_rpm(), provider_max_tpm(), _provider_positive_float(), provider_weight(), Shared parse/validate for the numeric per-provider traffic budgets. Returns…, Return the operator-configured requests/min cap for *provider*, or None if…, Return the operator-configured tokens/min cap for *provider*. Reads… (+52 more)
...
Cohesion: 0.04
Nodes (99): classify_task(), _extract_recent_text(), Any, Task classification from request context. Classifies an incoming request into a…, Concatenate plain text from the last *last_n* messages., Return the most likely task category for this request. Args: messages: OpenAI-…, Reset the singleton and clear the cached model map (test helper)., reset_router() (+91 more)

### Community 25 - "ScheduledJob"
Cohesion: 0.03
Nodes (54): _now(), Any, agent/scheduler.py — Scheduled Agent Jobs Cron-based job scheduler. Each job…, Register a new job. Returns the created :class:`ScheduledJob`.…, Fire a job immediately (webhook / manual trigger)., Remove a job. Returns *True* if it existed., Update the display name of a job., Enable or disable a job without deleting it. (+46 more)

### Community 26 - "TaskWorkflowService"
Cohesion: 0.04
Nodes (73): Set the global agent store instance (e.g., with MongoDB on startup)., set_agent_store(), Any, Task, TaskResult, TaskSpec, TaskStatus, Best-effort label of who will run this task once approved. Returns… (+65 more)
...
Cohesion: 0.04
Nodes (89): get_ceo_dispatcher(), _merge_changed_files(), Return the shared CEODispatcher singleton., Reset the singleton (test helper)., Collect changed_files across all specialists into a single de-duped list., reset_ceo_dispatcher(), ClassifyOutput, get_ceo_fallback_stats() (+81 more)

### Community 29 - "TaskStore"
Cohesion: 0.04
Nodes (75): Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., tasks — Task/issue management system. Provides a lightweight task/issue tracker…, Enum, str, tasks/models.py — Pydantic models for the task/issue system., Comment or reply on a task., TaskComment (+67 more)
...
### Community 31 - "PortfolioManager"
Cohesion: 0.03
Nodes (47): CapacityAllocation, Initiative, InitiativeProgress, PortfolioManager, PortfolioMetrics, Enum, Agentic Portfolio Management — initiative prioritisation, capacity allocation,…, Percentage of linked sprint points completed. (+39 more)

### Community 32 - "config.py"
Cohesion: 0.04
Nodes (70): AgentPolicy, _apply_env_overrides(), _apply_key_env(), _build(), _coerce(), config_dir(), _env_key_names(), expand_env() (+62 more)

### Community 33 - "ImprovementLoop"
Cohesion: 0.05
Nodes (62): _parse_ceo_directives(), DetectedIssue, ImprovementLoop, ImprovementLoopState, _now(), Any, Path, agent/improvement_loop.py — Continuous Improvement Engine Background scanner… (+54 more)
...
Cohesion: 0.04
Nodes (73): _brain_provider_status(), get_catalog_models_route(), Return the mirrored model catalog (advisory-only). Flag-gated by…, Return per-provider metadata for the GET endpoint. Iterates every provider in…, all_provider_ids(), provider_key_present(), Return every provider id recognised by the brain config system. Iterates the…, True when the env var for *provider*'s key is set (or it's Ollama). (+65 more)

### Community 36 - "ProviderConfig"
Cohesion: 0.04
Nodes (76): _acquire_provider_probe(), extract_openai_text(), _get_director(), is_commercial_provider(), _normalize_nvidia_base_url(), _openai_url(), provider_access_tier(), _provider_field() (+68 more)

### Community 37 - "KeyPool"
Cohesion: 0.04
Nodes (47): provider_api_keys(), Every API key configured for *provider*, primary first. Reads ``base_env`` then…, api_keys_for(), _digest(), KeyPool, _KeyState, _PoolState, Per-provider API key rotation — the one lever that adds capacity. Every other… (+39 more)

### Community 38 - "failover_chat_completion"
Cohesion: 0.06
Nodes (87): failover_chat_completion(), FailoverResult, _log_recovery(), A successful completion plus the accounting its callers need., Report a successful failover at INFO — recovery is not an incident. Everything…, Run one chat completion across the brain-failover chain. Tries each healthy…, _free_tier(), _hit_ids() (+79 more)

### Community 39 - "get_improvement_loop"
Cohesion: 0.04
Nodes (71): get_improvement_loop(), IssueCategory, IssueSeverity, Enum, str, FailureCategory, HealingEvent, HealState (+63 more)
...
### Community 42 - "fmtErr"
Cohesion: 0.05
Nodes (59): createQuickNote(), createTask(), fmtErr(), getActivity(), getCostAttribution(), getDecisionLog(), getDueSoonTasks(), getSavings() (+51 more)

### Community 43 - "SpecialistService"
Cohesion: 0.04
...
### Community 44 - "SelfHealingAgent"
Cohesion: 0.04
Nodes (62): heal_signature(), Translate external failure signals into improvement tasks and verify the fix…, Launch the background sweeper that resolves quiet verifying heals., Record that an error with *signature* was just seen again. Called by the…, Signal that the fix for *signature* has been applied/merged. Transitions the…, Same as :meth:`mark_fix_landed` but keyed by event/issue id (the id the…, Resolve any verifying heal whose quiet window has elapsed. Returns the number…, Handle a recurrence during verification: retry or escalate. Caller must hold… (+54 more)

### Community 45 - "TokenBudget"
Cohesion: 0.04
Nodes (39): BudgetUsage, Any, agent/token_budget.py — Per-Session Token Spend Caps Track token usage per…, Raise :class:`BudgetExceededError` if the session has exceeded its cap., Reset usage counters for *session_id* (cap is preserved)., Reset token counters for all sessions (caps preserved). Called at the start of…, Reset all budgets if the UTC calendar day has changed since last reset. Safe to…, Generate a token savings analytics report. Returns per-session statistics and… (+31 more)

### Community 46 - "brain_config.py"
Cohesion: 0.04
...
Cohesion: 0.06
Nodes (58): _can_read(), _can_write(), create_secret(), _decrypt(), delete_secret(), _encrypt(), _get_master_key(), get_secret_metadata() (+50 more)

### Community 48 - "BrainWatchdog"
Cohesion: 0.04
Nodes (59): get_brain_config_store(), Return the process-wide ``BrainConfigStore`` singleton., Any, packages/ai/self_heal.py — automatic brain self-healing. When the active brain…, Background tick that runs self_heal_brain_and_unblock_tasks(). Called from the…, One-shot self-healing pass. 1. Checks if the active brain provider is in a…, self_heal_brain_and_unblock_tasks(), _self_heal_tick() (+51 more)
...
### Community 51 - "test_loop_registry.py"
Cohesion: 0.05
...
Cohesion: 0.05
Nodes (41): Execute work through the 11-phase golden path., Called by APScheduler when a cron fires. Dispatches to the orchestrator., _scheduler_on_fire(), workflow_orchestrator_execute(), ExecutionRequest, get_workflow_orchestrator(), Return the shared WorkflowOrchestrator singleton., Reset the singleton (test helper). (+33 more)

### Community 53 - "test_knowledge_sync.py"
Cohesion: 0.06
...
### Community 55 - "E2BSandboxSession"
Cohesion: 0.06
Nodes (58): E2BSandboxSession, _inject_token(), maybe_attach_e2b(), Kill the sandbox. Idempotent; never raises (best-effort cleanup)., Seed the sandbox from a host worktree by packing tracked files. Creates a tar…, Extract changed files from the sandbox back to the host worktree. After the…, Open an E2B session and attach it as ``runner._mcp``. Single wiring line for…, Return ``(authed_url, clean_url)`` for a GitHub repo URL. (+50 more)

### Community 56 - "TaskDispatcher"
Cohesion: 0.04
Nodes (46): cleanup_stale_jobs(), _is_stale(), Any, packages/scheduler/cleanup.py — schedule deduplication + stale removal.…, Remove a job from the store. Returns True on success, False on failure. Logs…, Check if a created_at timestamp is older than ttl_seconds. Handles multiple…, Remove stale run-once + stuck agency jobs from the durable store. Args: store:…, _safe_remove() (+38 more)

### Community 57 - "RepowiseIntelligence"
Cohesion: 0.05
...
Cohesion: 0.04
Nodes (59): brain_providers(), Every configured provider with its health AND its on/off state. Powers the…, Turn a provider on or off. Manual re-enable clears an auto-disable. Auto-…, set_brain_provider_enabled(), auto_disable_provider(), describe_disabled_reason(), _disabled_from_mongo(), _disabled_from_sqlite() (+51 more)

### Community 59 - "TestSelfHealingInfrastructureClassification"
Cohesion: 0.05
Nodes (29): filter_safe_tools(), get_tool_annotations(), Typed representation of MCP tool annotations (spec 2025-11-05 §5.6.1). All…, Return True only when the tool is definitively read-only and non-destructive.…, Extract ``ToolAnnotations`` for a named tool from a ``list_tools()`` result.…, Return tools where ``readOnlyHint`` is True and ``destructiveHint`` is not…, ToolAnnotations, E2: Return a corrective hint for each failure category. (+21 more)

### Community 60 - "FeatureMatrix"
Cohesion: 0.05
...
### Community 63 - "probe_model_liveness"
Cohesion: 0.04
Nodes (53): provider_base_url(), Return the OpenAI-compatible base URL for *provider* (env- and UI-aware)., _describe_http_status(), probe_model_liveness(), _probe_ollama(), _probe_openai_compat(), ProbeResult, BaseModel (+45 more)

### Community 64 - "WorkspaceTools"
Cohesion: 0.05
Nodes (39): repowise.py — RepowiseIntelligence: context packing and dependency analysis., Path, tools.py — WorkspaceTools: read/write/search and diff application (risky…, Return a previously saved memory value, or an empty string if absent., Persist a key/value pair to the user's profile store., Return the first *lines* lines of a file. Just-in-time retrieval: the executor…, Return a lightweight index of files with line counts and sizes. This is the…, Delegate to RepowiseIntelligence for a natural-language codebase question. (+31 more)

### Community 65 - "WorkspaceManager"
Cohesion: 0.06
Nodes (42): _get_workspace_lock(), get_workspace_manager(), _hash_component(), _iso_now(), _iso_offset_hours(), _load_workspace(), _parse_iso(), BaseModel (+34 more)

### Community 66 - "portfolio_intelligence.py"
Cohesion: 0.05
Nodes (59): _bullets(), generate_backlog_retro(), generate_sprint_retro(), generate_standup(), plan_next_sprint(), Agentic Agile — autonomous ceremonies (standup, retro, sprint planning). Where…, Render a :class:`Retrospective` as a markdown section., Derive retro notes for ``sprint`` from its current metrics. Records… (+51 more)

### Community 67 - "AgentProfile"
Cohesion: 0.05
...
Cohesion: 0.04
Nodes (35): BusinessCategory, CompanyGraphService, Company, SpecialistFamily, SystemType, Workflow, Get a company by ID. Args: company_id: Company ID Returns: Company instance or…, Update a company. Args: company_id: Company ID **kwargs: Fields to update… (+27 more)
...
### Community 71 - "ai/router.py"
Cohesion: 0.05
Nodes (55): clear_cooldowns(), _dead_model_key(), get_dead_models(), _is_model_dead(), is_provider_on_cooldown(), _mark_model_dead(), mark_provider_failed(), provider_router.py — auto-generated module docstring (user-research skill scan). (+47 more)
...
### Community 73 - "Task"
Cohesion: 0.06
Nodes (42): Full task/issue document., Task, PUBLIC_URL-anchored dashboard deep link for the task detail. Returns empty…, Best-effort Telegram heads-up that a task is parked awaiting approval. Inline…, _coordinator(), asyncio, fixture, Pre-execution approval gate tests (Autonomy Charter Gate Matrix / P0). A… (+34 more)

### Community 74 - "TestClient"
Cohesion: 0.10
Nodes (30): bare_repo(), _call(), _data(), git_config_env(), _is_error(), mcp_workspace_root(), fixture, Path (+22 more)

### Community 75 - "test_ceo_supervision.py"
Cohesion: 0.06
Nodes (61): _harvest_changed_files(), Extract the files a runtime touched. Returns ``(files, reported)``. Adapters…, services/ceo_ledger.py — durable record of what the CEO is driving to closure.…, A subtask's full history: what it is, and every attempt at it., Drop the singleton (test helper)., reset_ceo_ledger(), SubtaskRecord, asyncio (+53 more)

### Community 76 - "DashboardScreen.jsx"
Cohesion: 0.04
Nodes (34): addTaskComment(), clarifyTask(), escalateTask(), fetchVelocity(), followUpTask(), updateTask(), BarChart(), Charts (+26 more)

### Community 77 - "test_repo_connection.py"
Cohesion: 0.07
...
### Community 79 - "_resolve_brain_provider"
Cohesion: 0.04
...
Cohesion: 0.05
Nodes (40): AgencyCycleResult, AgentDirective, AgentRole, _build_ceo_prompt(), _build_quick_note_instruction(), _close_github_issue(), _collect_recent_git_context(), _fetch_github_quick_notes() (+32 more)

### Community 81 - "test_user_research_skill.py"
Cohesion: 0.07
...
### Community 82 - "LLMRouter"
Cohesion: 0.06
Nodes (34): Attempt, text_key(), Read the environment variables named in ``env_names`` into a key list. Order is…, resolve_keys(), LLMRouter, Any, AsyncClient, BaseException (+26 more)
...
### Community 84 - "resolve_e2b_config"
Cohesion: 0.05
...
### Community 86 - "_StubProvider"
Cohesion: 0.07
Nodes (34): _disable_unless_key_serves_other_models(), _looks_unknown_model(), _models_to_try(), True when the provider rejected the model id itself, not the request., Order the models to attempt on *provider*, correcting a stale catalogue. Cache-…, Auto-disable *provider*, unless its key demonstrably serves other models. "No…, attempted(), Return every model of *provider_id* tried so far by a failed round. (+26 more)

### Community 87 - "ChatPage.js"
Cohesion: 0.06
...
### Community 88 - "Artifact"
Cohesion: 0.07
Nodes (37): AgentRole, When coder == reviewer model, swarm should log a warning., _fake_artifact(), tests/test_workflow_models.py — Unit tests for workflow/models.py., TestApprovalGate, TestCheckRun, TestSlice, workflow/artifact_store.py — Durable artifact persistence. Artifacts are stored… (+29 more)

### Community 89 - "AgileSprint"
Cohesion: 0.05
...
### Community 91 - "App.js"
Cohesion: 0.05
Nodes (36): completeSetup(), createSecret(), detectHardwareForSetup(), detectModelsForSetup(), getMe(), getPublicPath(), getSetupState(), logout() (+28 more)
...
### Community 93 - "failover_client.py"
Cohesion: 0.05
Nodes (46): _auto_disable(), _Budget, _build_request(), _describe_registry(), _is_billing_refusal(), _is_ollama(), _key_pool(), _log_exhaustion() (+38 more)
...
### Community 96 - "StreamingDeltaReconstructor"
Cohesion: 0.06
...
### Community 98 - "test_integration_c4_c5_c6_d3.py"
Cohesion: 0.06
...
Cohesion: 0.07
Nodes (54): _heal_task_duplicates(), Backfill source_id on legacy ceo_direct tasks, then dedup by source_id. Two…, _capability_tags(), create_task_from_oldest_open_issue(), intake_issue(), _issue_labels(), issue_source_id(), map_issue_to_task() (+46 more)

### Community 100 - "run_tests"
Cohesion: 0.07
...
Cohesion: 0.08
Nodes (23): Request to remediate auto-fixable findings in a local code repository., One concrete remediation performed (or proposed) by the fixer., SeoFixAction, SeoFixRequest, _humanize_filename(), BeautifulSoup, Path, services/seo_fixer.py - Repo-Aware SEO Auto-Fixer When a company has a code… (+15 more)

### Community 107 - "TaskIn"
Cohesion: 0.05
...
Cohesion: 0.06
Nodes (27): get_mcp_client(), MCPClient, Any, RuntimeError, agent/mcp_client.py — Async MCP client for the mcp-server Docker container.…, Prefer structured data; fall back to text when unavailable., Thin async MCP client with open/close circuit breaker. Thread-safe only within…, Perform MCP handshake. Optional — tools/call works without it. (+19 more)

### Community 112 - "ReactScratchpad"
Cohesion: 0.06
...
### Community 113 - "test_context_rulebook.py"
Cohesion: 0.06
Nodes (54): Module, stmt, _bound_names(), _good_result(), _guard_statements(), _load(), fixture, ModuleType (+46 more)

### Community 114 - "telegram_bot.py"
Cohesion: 0.07
Nodes (55): Return a Markdown-v1-safe preview string under ``max_chars``. Used by the…, sanitize_paste_for_preview(), _admin_headers(), _answer_callback(), _api_headers(), _check_rate_limit(), cmd_control(), cmd_cost() (+47 more)
...
### Community 120 - "PatternConsolidation"
Cohesion: 0.07
...
Cohesion: 0.06
Nodes (43): delegate_seo_findings(), _expire_stale_pending_report(), export_seo_audit(), get_seo_audit(), list_seo_audits(), BaseModel, get, post (+35 more)

### Community 122 - "SeoAuditRequest"
Cohesion: 0.05
Nodes (30): field_validator, Request to run an SEO/GEO/AIO audit against a website., SeoAuditRequest, _count_syllables(), estimate_pixel_width(), flesch_reading_ease(), normalize_url(), Approximate SERP rendering width of ``text`` in pixels. (+22 more)

### Community 123 - "ceo_dispatcher.py"
Cohesion: 0.06
Nodes (40): _complexity_rank(), _decompose_into_subtasks(), _offload(), Any, Semaphore, services/ceo_dispatcher.py — Real CEO delegation layer. The CEO splits a…, Run a synchronous ledger call without blocking the event loop. ``CEOLedger`` is…, Build an agent.coordinator.TaskSpec from a CEO SpecialistTask. (+32 more)

### Community 124 - "test_kimi_bridge_server.py"
Cohesion: 0.06
...
### Community 125 - "_ts_to_float"
Cohesion: 0.06
Nodes (38): Any, Task, TaskStatus, Create a task. Deduplicates by source_id if set (Charter G3). If a task with…, Fetch a task by ID. If owner_id is set, enforces ownership., Return the task previously created for an external ``source_id`` (e.g.…, Normalise a timestamp value to a float Unix epoch. Handles: - float / int…, List tasks for a specific user with optional filters. ``include_system``… (+30 more)
...
### Community 127 - "Usage"
Cohesion: 0.07
Nodes (28): AlertHandler, BudgetTracker, Counter, _Dimensions, _month(), Any, packages/llm/budget.py — token and cost accounting with spend alerts. Tracks…, Register a callback fired when a spend threshold is crossed. (+20 more)
...
### Community 129 - "MetricsRegistry"
Cohesion: 0.07
Nodes (24): _Counter, _escape(), _Gauge, _Histogram, _labels(), MetricsRegistry, Any, packages/llm/metrics.py — Prometheus metrics without the client library. The… (+16 more)
...
### Community 132 - "OrchestratorSupervisor"
Cohesion: 0.06
Nodes (29): Return orchestrator queue depth, active runs, and supervisor state (#522)., #522 + #505: Reliability startup — schedule hydration, orchestrator restore,…, _startup_reliability_hooks(), workflow_orchestrator_status(), codeql_count(), dependabot_count(), main(), Any (+21 more)

### Community 133 - "test_telegram_freebuff.py"
Cohesion: 0.07
...
### Community 136 - "PortfolioIntelligence"
Cohesion: 0.08
...
### Community 139 - "ProvidersScreen.jsx"
Cohesion: 0.06
Nodes (35): createProvider(), deleteProvider(), getBrainConfig(), getBrainProviders(), getLocalBrainState(), getProviderPolicy(), listProviders(), patchBrainConfig() (+27 more)

### Community 140 - "ToolRegistry"
Cohesion: 0.08
...
### Community 142 - "AGENTS.md — Source of Truth for All AI Agents"
Cohesion: 0.04
Nodes (49): 1. Language & Runtime, 2. Async, 3. Data Models, 4. Logging, 5. Error Handling, 6. Security, 7. Comments, 8. File Size (+41 more)

### Community 143 - "get_store"
Cohesion: 0.06
Nodes (37): all_settings(), _as_bool(), _as_int(), ephemeral_ttl_hours_cached(), get_setting(), _maybe_schedule_refresh(), onboarding_gate_enabled(), onboarding_gate_enabled_cached() (+29 more)
...
### Community 146 - "test_slop_gate.py"
Cohesion: 0.07
...
### Community 147 - "test_e2b_data_flow.py"
Cohesion: 0.07
...
### Community 148 - "test_e2b_task_wiring.py"
Cohesion: 0.08
...
### Community 150 - "test_agent_free_brain.py"
Cohesion: 0.05
...
### Community 152 - "OllamaCircuitBreaker"
Cohesion: 0.08
...
### Community 155 - "cache.py"
Cohesion: 0.07
Nodes (27): Test hook — clear all usage accounting., reset(), CacheManager, cosine_similarity(), _Entry, LRUCache, Any, T (+19 more)

### Community 156 - "SetupChecker"
Cohesion: 0.07
...
### Community 157 - "PromptCacheManager"
Cohesion: 0.06
...
### Community 159 - "activation_api.py"
Cohesion: 0.09
...
### Community 162 - "TestRecordUsageAndStats"
Cohesion: 0.05
Nodes (19): _build_cost_table(), cost_for_tokens(), get_stats(), _load_env_overrides(), Any, Per-model cost attribution for the LLM provider router. Maintains in-memory…, Return the USD cost for (prompt_tokens, completion_tokens) on *model*. Returns…, Record token usage for *model* (fire-and-forget, never raises). ``tag`` is a… (+11 more)
...
### Community 166 - "test_portfolio_intake.py"
Cohesion: 0.08
...
### Community 167 - "OnboardingScreen.jsx"
Cohesion: 0.06
...
### Community 168 - "v3_auth.py"
Cohesion: 0.08
Nodes (42): _get_admin_email(), _get_admin_name(), _get_admin_secret(), login(), LoginRequest, LoginResponse, BaseModel, get (+34 more)

### Community 169 - "ProviderRouter"
Cohesion: 0.08
Nodes (21): _exponential_backoff_cooldown(), _normalized_provider_type(), _notify_watchdog(), ProviderAttempt, ProviderRouter, Any, Response, Try all models for one provider. Returns ProviderResult on success, None on… (+13 more)

### Community 170 - "Part A — CodeRabbit review fixes for this PR (do first, small)"
Cohesion: 0.05
...
### Community 171 - "Docker Agent Runtimes Setup"
Cohesion: 0.05
...
### Community 172 - "anthropic_compat.py"
Cohesion: 0.09
...
### Community 173 - "test_self_heal_v2.py"
Cohesion: 0.08
Nodes (41): Reset the singleton (for tests)., reset_failover_manager(), _heal_brain_failover(), _heal_stuck_tasks(), _heal_telegram(), _heal_timestamps(), Any, services/self_heal.py — Autonomous self-healing for the agency. Runs periodic… (+33 more)

### Community 174 - "FeatureUnavailableError"
Cohesion: 0.07
Nodes (23): AgentJob, _now(), Any, Run a job using the provided runner and update the job's lifecycle, progress,…, Serialize the AgentJob to a JSON-serializable dictionary for external clients.…, Any, Resolve *relative* inside source dir and reject traversal/symlink escapes., WorkspaceEscapeError (+15 more)

### Community 175 - "emit_chat_observation"
Cohesion: 0.09
...
### Community 176 - "Persistent Memory System"
Cohesion: 0.05
...
### Community 177 - "resolve_component_model"
Cohesion: 0.06
...
### Community 178 - "CEODispatcher"
Cohesion: 0.10
Nodes (36): CEODispatcher, CEOResult, Aggregated output from a multi-specialist execution., Real CEO delegation: wake runtimes, fan out, and merge results., Attempt, One delegation of one subtask to one tier., What one sweep observed and did. Returned for tests and diagnostics., SweepReport (+28 more)

### Community 179 - "NIMConnectionPool"
Cohesion: 0.07
...
### Community 180 - "test_bedrock_provider.py"
Cohesion: 0.08
...
### Community 181 - "test_crispy_workflow.py"
Cohesion: 0.07
Nodes (23): _make_engine(), fixture, tests/test_crispy_workflow.py — CRISPY workflow engine hardening tests. Tests…, Provide isolated DB + artifact + workspace paths., Create a WorkflowEngine with isolated storage., TestAbortOnFailure, TestPhaseSequence, TestPhaseSequenceError (+15 more)

### Community 182 - "test_sam_livekit.py"
Cohesion: 0.06
Nodes (33): _normalize_dockerfile(), tests/test_sam_livekit.py — SAM realtime voice (LiveKit) integration. Covers: -…, SAM_LLM_* env vars must override the NVIDIA defaults (Hermes/proxy routing)., Under TESTING the in-process worker must never be eligible to start., OPT-IN: defaulting to on OOM-killed the 512MB Render instance at boot…, start_in_process must be a safe no-op in the test environment (conftest sets…, Flag on but LiveKit env absent → logged no-op, never raises., Parse a Dockerfile into a list of active instruction lines. Strips comment… (+25 more)

### Community 183 - "Provider"
Cohesion: 0.07
...
### Community 184 - "DashboardLayout.js"
Cohesion: 0.09
...
### Community 186 - "validate_outbound_url"
Cohesion: 0.10
Nodes (29): test_git_ref_rejects_empty(), test_git_ref_rejects_flag_injection(), test_git_ref_rejects_shell_metacharacters(), test_git_ref_rejects_traversal(), test_git_ref_valid(), test_git_scheme_allows_ssh(), test_http_scheme_rejects_ssh(), test_https_public_host_allowed() (+21 more)

### Community 187 - "v4_api.py"
Cohesion: 0.10
...
### Community 190 - "test_workspace_isolation.py"
Cohesion: 0.19
...
### Community 195 - "TestEstimateTokensForMessages"
Cohesion: 0.07
...
### Community 199 - "chat_handlers.py"
Cohesion: 0.10
...
### Community 201 - "test_brain_availability_doctor.py"
Cohesion: 0.11
Nodes (31): brain_availability_summary(), Non-secret answer to "can the brain answer a request right now?". Three callers…, _env_flag(), _env_int(), services/ceo_supervisor.py — the CEO's 24x7 babysitting loop. Delegation alone…, Read a bounded int, clamping out-of-range values rather than raising., Bounds for the unattended supervision loop., SupervisorConfig (+23 more)

### Community 202 - "test_persistent_memory.py"
Cohesion: 0.06
...
### Community 203 - "test_p0_roadmap_b1_c2_a3.py"
Cohesion: 0.09
...
Cohesion: 0.06
Nodes (35): [5.0.0], Added, Added, Added, Added, Added, Added, Added (+27 more)

### Community 208 - "[Unreleased]"
Cohesion: 0.06
Nodes (35): [5.0.0], Added, Added, Added, Added, Added, Added, Added (+27 more)

### Community 209 - "output_filter.py"
Cohesion: 0.07
...
### Community 210 - "REWRITE_PLAN.md — Phased Migration Strategy"
Cohesion: 0.06
...
### Community 211 - "GoalRecord"
Cohesion: 0.10
Nodes (18): _backend(), CEOLedger, GoalRecord, _now(), Any, One piece of work the CEO has taken ownership of. ``state`` is the supervisor's…, Return ``(done, total)`` subtask counts., Durable store for :class:`GoalRecord`s. Every method is best-effort and never… (+10 more)

### Community 212 - "run_regression"
Cohesion: 0.11
...
### Community 213 - "test_all_providers_discovery.py"
Cohesion: 0.16
...
### Community 215 - "test_anthropic_router.py"
Cohesion: 0.09
...
Cohesion: 0.08
Nodes (25): WorkflowEngine, Contract: WorkflowEngine cannot skip the gate state machine., Create a run and manually place it in awaiting_approval., Contract: Cannot approve a run in 'pending' state., Contract: Can approve a run in 'awaiting_approval' state., Contract: Rejecting a run marks it as failed., _make_engine(), _make_run() (+17 more)

### Community 217 - "test_sam_voice.py"
Cohesion: 0.07
Nodes (32): get_sam(), agent/sam.py — SAM Voice Agent (System Autonomy Manager) SAM is the voice-…, asyncio, tests/test_sam_voice.py — Integration tests for SAM voice agent. Tests the SAM…, Same session_id must return the same session., SAM's system prompt must address the user as Commander., SAM's system prompt must instruct concise responses., _build_context must return a dict with expected keys. (+24 more)

### Community 218 - "agent_runtime.py"
Cohesion: 0.11
...
### Community 219 - "ENGINEERING_STANDARDS.md — Coding, Security & Testing Standards"
Cohesion: 0.06
...
### Community 220 - "context_rules.py"
Cohesion: 0.11
...
### Community 223 - "test_llm_router_e2e.py"
Cohesion: 0.15
Nodes (33): _ok(), fixture, parametrize, End-to-end routing against mock providers (ADR-008). These are the tests that…, A router wired to three mock providers, with all singletons isolated., Two keys on alpha means a 429 costs a key, not the provider., The NVIDIA 410 incident, as a regression test (CLAUDE.md §7)., A 422 is the request's fault — trying five providers just adds latency. (+25 more)

### Community 224 - "ContextManager"
Cohesion: 0.10
...
### Community 225 - "MCPUnavailableError"
Cohesion: 0.12
...
### Community 229 - "system_instruction"
Cohesion: 0.10
Nodes (8): Return a plain-English JSON instruction for a ``response_format`` dict. Returns…, system_instruction(), system_instruction() uses stronger language when strict: true., TestSystemInstructionStrictMode, _payload(), Tests for packages/ai/structured_output.py and its integration with the…, TestAnthropicPayloadStructuredOutput, TestSystemInstruction

### Community 230 - ".execute"
Cohesion: 0.07
...
### Community 231 - "test_brain_failover.py"
Cohesion: 0.10
Nodes (32): _clean_env(), _make_manager(), fixture, tests/test_brain_failover.py — Universal multi-provider brain failover tests.…, Strip all provider API keys and isolate the operator-state store.…, Status snapshot doesn't leak API keys., Make a fresh manager (bypasses the singleton for isolation)., No API keys set → no providers in the registry. (+24 more)

### Community 232 - "test_output_filter.py"
Cohesion: 0.06
Nodes (32): _enable_filter(), fixture, tests/test_output_filter.py — Unit tests for output_filter.py Verifies token…, pytest output with many passing tests should be compressed., pytest output with failures should preserve failure details., Deep Python traceback should collapse intermediate frames., Large curl output should be truncated with head/tail., When disabled, output should pass through (truncated to max_chars). (+24 more)

### Community 233 - "test_microagents.py"
Cohesion: 0.15
...
### Community 234 - "Security Analysis — local-llm-server"
Cohesion: 0.06
...
### Community 235 - "Langfuse Observability Guide"
Cohesion: 0.06
...
### Community 241 - "report_to_markdown"
Cohesion: 0.11
...
### Community 242 - "test_background_services.py"
Cohesion: 0.10
...
### Community 248 - "High-Agency Frontend Skill"
Cohesion: 0.06
Nodes (30): 10. FINAL PRE-FLIGHT CHECK, 1. ACTIVE BASELINE CONFIGURATION, 2. DEFAULT ARCHITECTURE & CONVENTIONS, 3. DESIGN ENGINEERING DIRECTIVES (Bias Correction), 4. CREATIVE PROACTIVITY (Anti-Slop Implementation), 5. PERFORMANCE GUARDRAILS, 6. TECHNICAL REFERENCE (Dial Definitions), 7. AI TELLS (Forbidden Patterns) (+22 more)

### Community 249 - "Quick-Note GitHub Issues Processing - Session Summary"
Cohesion: 0.06
...
### Community 253 - "tests/test_browser.py"
Cohesion: 0.10
...
### Community 255 - "tests/conftest.py"
Cohesion: 0.10
...
### Community 256 - "test_colibri_provider.py"
Cohesion: 0.12
...
### Community 259 - "SteeringInjector"
Cohesion: 0.11
...
### Community 260 - "test_claude_setup_audit.py"
Cohesion: 0.16
...
### Community 262 - "test_ceo_router.py"
Cohesion: 0.14
Nodes (28): Install (or clear) the singleton — used by startup wiring and tests., Drop the singleton (test helper)., reset_ceo_supervisor(), set_ceo_supervisor(), ledger(), _make_app(), FastAPI, fixture (+20 more)

### Community 263 - "CompanyAgencyService"
Cohesion: 0.09
...
### Community 264 - "test_crispy_burn_in.py"
Cohesion: 0.07
...
### Community 265 - "test_internal_agent_did_work.py"
Cohesion: 0.12
...
### Community 267 - "test_skill_registry_boot_refresh.py"
Cohesion: 0.12
...
### Community 270 - "test_backend_server_features.py"
Cohesion: 0.08
...
### Community 271 - "model_discovery.py"
Cohesion: 0.09
...
### Community 274 - "test_phase5_doctor.py"
Cohesion: 0.08
Nodes (21): Request, FastAPI dependency: require any authenticated user., require_authenticated(), client(), _coding_brain_check(), fixture, tests/test_doctor_coding_brain.py Surfaces the North Mini Code coding-brain…, With NORTH_MINI_CODE_DEFAULT off, the check warns and says so. (+13 more)

### Community 275 - "Settings"
Cohesion: 0.07
Nodes (17): _get_settings(), Typed configuration loaded from environment variables., Validated `reasoning_effort` for Ollama thinking models, or ``""``. Returns one…, UNIT 8: when True, the catalog is mirrored to the DB + the ``GET…, When True, router-configured providers join the mirrored catalog., When True, ship-code task types (portfolio_initiative / issue / quick_note) get…, When True (default), the agency's coding loop + Hermes prefer Cohere's ``north-…, Settings (+9 more)
...
### Community 279 - "TestBrainFailoverModelUpdates"
Cohesion: 0.12
...
### Community 282 - "llm_providers.py"
Cohesion: 0.17
...
### Community 283 - "Deploy: FreeBuff Telegram bot (24×7)"
Cohesion: 0.07
...
### Community 284 - "Claude Code + Qwen Local Setup"
Cohesion: 0.07
...
### Community 285 - "generate_context.py"
Cohesion: 0.12
...
### Community 287 - "test_phase4_runtime_resilience.py"
Cohesion: 0.11
...
### Community 292 - "test_terminal.py"
Cohesion: 0.10
...
### Community 293 - "Performance Analysis — local-llm-server"
Cohesion: 0.08
...
### Community 294 - "LLM Router — troubleshooting"
Cohesion: 0.08
...
### Community 295 - "AgentsScreen.jsx"
Cohesion: 0.13
...
### Community 302 - "test_telegram_approval_gate.py"
Cohesion: 0.10
...
### Community 304 - "test_telegram_approval_e2e.py"
Cohesion: 0.12
...
### Community 314 - "Session Handoff — 2026-06-15"
Cohesion: 0.08
...
### Community 315 - "TASK 4 — End-to-end approval-gate test"
Cohesion: 0.08
...
### Community 317 - "test_north_mini_code.py"
Cohesion: 0.08
...
### Community 319 - "_InMemoryBackend"
Cohesion: 0.11
...
### Community 320 - "TemporalContextGraph"
Cohesion: 0.12
...
### Community 321 - "test_agency_fix.py"
Cohesion: 0.08
...
### Community 322 - "TestClassifyPlainText"
Cohesion: 0.08
...
### Community 323 - "test_webui_provider_priority.py"
Cohesion: 0.19
Nodes (24): _bootstrap(), fixture, Path, ProviderManager, WorkspaceManager, tests/test_webui_provider_priority.py — Priority + reorder + brain-policy…, The /policy/brain endpoint must return the resolved brain + the paid policy…, The /providers/role-tags endpoint surfaces brain/sub/fallback roles consistent… (+16 more)
...
### Community 326 - "Local AI Stack with Docker"
Cohesion: 0.08
...
### Community 327 - "Implementation Prompt: Rich TaskBoard + Agile Sprint Integration"
Cohesion: 0.08
...
### Community 328 - "Telegram Bot Setup"
Cohesion: 0.08
...
### Community 329 - "video_transcript.py"
Cohesion: 0.12
...
### Community 333 - "schedules/api.py"
Cohesion: 0.13
...
### Community 335 - "TestSchedulerStore"
Cohesion: 0.08
...
### Community 337 - "test_workspace_security.py"
Cohesion: 0.10
...
### Community 339 - "test_dashboard_cache.py"
Cohesion: 0.14
...
### Community 340 - "Configuration Reference"
Cohesion: 0.09
...
### Community 341 - "The fifteen strategies"
Cohesion: 0.09
...
### Community 342 - "SchedulesPage.js"
Cohesion: 0.12
...
### Community 346 - ".start_onboarding"
Cohesion: 0.09
Nodes (12): Workflow, Detect the Git provider from a repository URL. Args: repo_url: Repository URL…, Start the onboarding process for a company. Args: company_id: Company ID…, Schedule a fire-and-forget background task, keeping a strong reference.…, Force-refresh the dynamic skill registry and log tech-stack recommendations.…, Activate a company's 24x7 agency runtimes in the background. Runs after…, Scan a website and save the results. Args: company_id: Company ID url: Website…, Scan a repository and save the results. Args: company_id: Company ID url:… (+4 more)

### Community 347 - "test_all_features.py"
Cohesion: 0.09
Nodes (9): TestActivation, TestActivity, TestApiKeys, TestCompany, TestOnboarding, TestSecrets, TestSetup, TestTasks (+1 more)

### Community 348 - "test_daily_2026_07_31.py"
Cohesion: 0.22
Nodes (9): _make_anthropic(), Daily automation tests — 2026-07-31. Research: Anthropic's prompt caching…, _req(), _restore(), TestAnthropicBetaHeader, TestAnthropicCacheControlSystem, TestAnthropicCacheControlTools, TestAnthropicCacheDisabled (+1 more)
...
Cohesion: 0.15
Nodes (19): Initialize the service. Args: store: Optional CompanyGraphStore instance. If…, _as_aware_utc(), datetime, services/ephemeral_reaper.py — destroy expired ephemeral companies. The…, Treat naive datetimes as UTC so comparisons never raise., Delete all expired ephemeral companies. Returns the number deleted. A company…, reap_expired_companies(), _company() (+11 more)
...
### Community 361 - "test_task_brain_preflight.py"
Cohesion: 0.17
Nodes (19): _is_brain_connection_error(), BaseException, True if *exc* looks like an LLM-brain/endpoint connectivity failure. Such…, fixture, svc(), _coordinator(), has_brain(), no_brain() (+11 more)

### Community 362 - "test_portfolio_intelligence.py"
Cohesion: 0.10
...
### Community 363 - "analyze_quantitative"
Cohesion: 0.17
...
### Community 365 - "openclaw_gateway.py"
Cohesion: 0.15
...
### Community 366 - "V3 API Migration Plan — LLM Relay Platform"
Cohesion: 0.10
...
### Community 367 - "test_chat_mode_regressions.py"
Cohesion: 0.18
...
### Community 369 - "test_freebuff_bot.py"
Cohesion: 0.11
...
### Community 370 - "test_local_controller.py"
Cohesion: 0.17
...
### Community 371 - "test_unit5_ui_provider_surface.py"
Cohesion: 0.10
...
### Community 372 - "test_voice_pipeline.py"
Cohesion: 0.13
...
### Community 373 - "providers.py"
Cohesion: 0.20
Nodes (10): invalidate_brain_cache(), _normalize_base_url(), _now(), ProviderRecord, ProviderSecret, Any, BaseModel, Reorder the provider priority list. ``provider_ids`` is the desired ordering… (+2 more)

### Community 374 - "MemoryCategory"
Cohesion: 0.16
...
### Community 375 - "PersistentMemoryStore"
Cohesion: 0.24
...
### Community 379 - "Skill: modularity-review"
Cohesion: 0.10
Nodes (19): Acceptance Checks, Applying to This Repo, Further Reading, Modularity Findings Template, Part A: Reviewing Existing Code for Modularity Problems, Part B: Designing New Modular Boundaries, Skill: modularity-review, Step 1 — Map the dependency graph (+11 more)

### Community 380 - "crispy_client.py"
Cohesion: 0.14
Nodes (18): cmd_approve(), cmd_artifacts(), cmd_build(), cmd_events(), cmd_reject(), cmd_status(), cmd_watch(), _get() (+10 more)

### Community 381 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 384 - "is_anthropic_base_url"
Cohesion: 0.12
...
### Community 386 - "DecisionsStoreTests"
Cohesion: 0.11
...
### Community 388 - "SyntheticDataPipeline"
Cohesion: 0.17
...
### Community 389 - "ApprovalCheckpoint"
Cohesion: 0.14
...
### Community 390 - "test_brain_patch_service_token.py"
Cohesion: 0.16
...
### Community 396 - "Skill: fabric-patterns"
Cohesion: 0.11
...
### Community 397 - "Analysis & Synthesis Instructions"
Cohesion: 0.11
Nodes (18): 1. Define the Atmosphere, 2. Map the Color Palette, 3. Establish Typography Rules, 4. Define the Hero Section, 5. Describe Component Stylings, 6. Define Layout Principles, 7. Define Responsive Rules, 8. Encode Motion Philosophy (+10 more)

### Community 398 - "Production Readiness Assessment — local-llm-server"
Cohesion: 0.11
...
### Community 399 - "Skill: fabric-patterns"
Cohesion: 0.11
Nodes (18): 1. Ensure Pattern Directory Exists, 2. List Available Patterns, 3. Retrieve a Pattern, 4. Apply a Pattern with Variables, 5. Stitch Patterns Together, 6. Create New Patterns, Acceptance Checks, Directory Structure (+10 more)

### Community 400 - "db/__init__.py"
Cohesion: 0.15
...
### Community 401 - "Admin Dashboard Guide"
Cohesion: 0.11
...
### Community 402 - "Implementation Plan"
Cohesion: 0.11
...
### Community 405 - "TestRouterIntegration"
Cohesion: 0.18
Nodes (11): Clear director state and the cached strategy warnings (tests only)., reset(), _clean_director(), anyio, fixture, Reset the process singleton around every test., The behaviour this whole change exists for: once the first free provider has…, No strategy and no budgets configured — behaviour is unchanged. (+3 more)

### Community 406 - "Delegation Plan (agent-ready work packages)"
Cohesion: 0.11
...
### Community 407 - "._execute_with_fallback"
Cohesion: 0.15
...
### Community 410 - "test_company_api.py"
Cohesion: 0.11
...
### Community 411 - "test_fabric_patterns.py"
Cohesion: 0.11
...
### Community 412 - "trend_analysis.py"
Cohesion: 0.19
Nodes (11): Tests for trend_analysis.py — last30days-style window over TrendWatcher (issue…, TestRunTrendAnalysis, TestWindow, BaseModel, trend_analysis.py — last30days-style trend analysis (issue #493). Adapts the…, True if the ISO-ish published date falls within the last N days.…, Write trends/trend_summary.md (and a dated copy); return the path., TrendItem (+3 more)

### Community 413 - "validate_session_id"
Cohesion: 0.16
...
### Community 416 - "HarnessEnrichment"
Cohesion: 0.17
...
### Community 417 - "Comprehensive Skill Index (By Category)"
Cohesion: 0.11
...
### Community 418 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 419 - "Component Map"
Cohesion: 0.11
...
### Community 420 - "Agent State — colibri GLM-5.2 deployment (resumable)"
Cohesion: 0.11
...
### Community 421 - "Architecture Overview — local-llm-server"
Cohesion: 0.11
...
### Community 422 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
...
### Community 423 - "Platform Guide — the full tour"
Cohesion: 0.11
...
### Community 425 - "Part A — Health Report"
Cohesion: 0.11
...
### Community 430 - "sync_readme_gallery.py"
Cohesion: 0.22
...
### Community 431 - "test_skill_executors_live.py"
Cohesion: 0.16
...
### Community 433 - "test_openclaw_endpoints.py"
Cohesion: 0.11
...
### Community 434 - "test_provider_policy.py"
Cohesion: 0.14
...
### Community 435 - "TestStopSlopChecker"
Cohesion: 0.11
...
### Community 436 - "test_task_service_failed_comment.py"
Cohesion: 0.18
...
### Community 437 - "handle_workflow_ide_chat"
Cohesion: 0.18
...
### Community 439 - "._fetch_flat_skill_file"
Cohesion: 0.21
...
### Community 441 - "SKILL: Industrial Brutalism & Tactical Telemetry UI"
Cohesion: 0.12
...
### Community 442 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 443 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 444 - "test_admin_local_brain_router.py"
Cohesion: 0.18
...
### Community 445 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 446 - "Section-by-Section Acceptance Criteria"
Cohesion: 0.12
...
### Community 447 - "issue_new_api_key"
Cohesion: 0.21
Nodes (13): issue_new_api_key(), Generate a new plaintext API key, persist hash + metadata, return (plain_key,…, main(), main(), _make_store(), fixture, Security regression tests for key_store: hashing, constant-time compare, rate…, _reset_rate_state() (+5 more)

### Community 448 - "kimi_bridge_provider_config"
Cohesion: 0.18
...
### Community 449 - ".execute"
Cohesion: 0.12
Nodes (14): _best_cloud_primary_base(), _nvidia_provider_chain(), ProviderConfig, TaskResult, TaskSpec, Execute a TaskSpec using the internal AgentRunner and convert the agent's…, Create an isolated execution context for a single task. Tries ``git worktree…, Build Nvidia NIM provider config from env. Empty list when key is absent. (+6 more)

### Community 450 - "agent_readiness_audit.py"
Cohesion: 0.21
...
### Community 453 - "test_telegram_auto_approve.py"
Cohesion: 0.20
...
### Community 455 - "_resolve_push_token"
Cohesion: 0.15
...
### Community 456 - "test_activation_api.py"
Cohesion: 0.21
...
### Community 457 - "test_autonomy_status.py"
Cohesion: 0.12
...
### Community 458 - "test_brain_failover_413.py"
Cohesion: 0.13
Nodes (9): _clean_env(), _FakeAsyncClient, _FakeResponse, fixture, Regression test: HTTP 413 (Payload Too Large) must fail over to the next…, Returns 413 for every call to a Groq URL, success for anything else., Groq (will 413) + Cerebras (will succeed) both configured, NVIDIA deliberately…, test_413_fails_over_to_next_provider_after_one_attempt() (+1 more)

### Community 459 - "test_health_endpoints.py"
Cohesion: 0.17
...
### Community 460 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 461 - "test_local_brain_state.py"
Cohesion: 0.12
...
### Community 466 - "admin_gui.py"
Cohesion: 0.16
Nodes (13): Browser admin UI for login, service control, key management, and diagnostics., Update or append a KEY=value line in the .env file., register_admin_gui(), _save_env_var(), filter_output(), get_output_filter(), get_savings_summary(), agent/output_filter.py — LLM Output Compression & Token Savings Inspired by… (+5 more)

### Community 467 - "get_tool_registry"
Cohesion: 0.17
Nodes (9): get_tool_registry(), Return the module-level ToolRegistry singleton. On first call, registers built-…, auto_register(), Any, field_validator, Register the four user-research tools with a ``ToolRegistry``. Each tool wraps…, Register the user research tools into the module-level singleton registry.…, register_user_research_tools() (+1 more)

### Community 468 - "hermes_prompt.py"
Cohesion: 0.19
...
### Community 469 - "make_isolated_workspace"
Cohesion: 0.21
...
### Community 470 - "MemoryMiddleware"
Cohesion: 0.17
...
### Community 471 - "AIToolMetrics"
Cohesion: 0.13
Nodes (12): AIToolMetrics, Per-tool quality metrics: which AI tools actually deliver value? Tracks…, Fraction of suggestions accepted for the given tool., Average response latency in ms for the given tool., Output tokens per input token (higher = more verbose responses). Useful for…, Tools ranked by acceptance rate (highest first)., test_tool_metrics_acceptance_rate(), test_tool_metrics_acceptance_rate_unknown_tool() (+4 more)

### Community 472 - "PerformanceAnalytics"
Cohesion: 0.14
...
### Community 474 - "Skill: repowise-intelligence"
Cohesion: 0.12
...
### Community 475 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
...
### Community 476 - "admin_digest_router.py"
Cohesion: 0.20
...
### Community 477 - "_valid_login_state"
Cohesion: 0.24
...
### Community 478 - "Skill: repowise-intelligence"
Cohesion: 0.12
Nodes (15): 1. Graph Intelligence (Dependency Graph), 2. Git Intelligence, 3. Documentation Intelligence, 4. Decision Intelligence, Acceptance Checks, Directory Structure, Example Usage, Implementation Approach (+7 more)

### Community 479 - "The 10-Step Workflow"
Cohesion: 0.12
...
### Community 480 - "Contributing to local-llm-server"
Cohesion: 0.12
...
### Community 481 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 482 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 483 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
...
### Community 484 - "implement_agent.py"
Cohesion: 0.16
...
### Community 490 - "ManagedAgentDreams"
Cohesion: 0.22
...
### Community 491 - "_process_task_callback"
Cohesion: 0.28
...
### Community 492 - "e2e/test_browser.py"
Cohesion: 0.21
...
### Community 493 - "test_dockerfile_ships_root_modules.py"
Cohesion: 0.17
...
### Community 494 - "test_frontend_deployment_guards.py"
Cohesion: 0.20
...
### Community 495 - "test_glm52_brain.py"
Cohesion: 0.12
...
### Community 496 - "test_langfuse_agency_wide.py"
Cohesion: 0.12
...
### Community 498 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 499 - "test_telegram_service_webhook.py"
Cohesion: 0.21
Nodes (10): _FakeResponse, _make_task(), SimpleNamespace, Regression tests for telegram_service.NotificationDispatcher._notify_webhook.…, Regression: _notify_webhook used to define _send() but never call it., Drain any daemon threads spawned by the dispatcher (webhook/telegram). Snapshot…, Ensure _notify_webhook redacts secrets/PII before sending the webhook payload.…, TestNotifyWebhookActuallyFires (+2 more)

### Community 500 - "TestCheckKwargs"
Cohesion: 0.18
...
### Community 502 - "CollaborationContext"
Cohesion: 0.19
...
### Community 503 - "Skill: agent-harness"
Cohesion: 0.13
...
### Community 504 - "Skill: checkpoint-strategy"
Cohesion: 0.13
...
### Community 506 - "Skill: local-ai-query"
Cohesion: 0.13
...
### Community 507 - "Skill: parallel-agents"
Cohesion: 0.13
...
### Community 508 - "Skill: parallel-worktrees"
Cohesion: 0.13
...
### Community 509 - "Design System: Taste Standard"
Cohesion: 0.13
...
### Community 512 - "Skill: user-research"
Cohesion: 0.13
...
### Community 513 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 514 - "Attention Mechanisms Internals"
Cohesion: 0.13
...
### Community 515 - "AdminSessionStore"
Cohesion: 0.18
Nodes (4): AdminSession, AdminSessionStore, _is_truthy(), WindowsCredentialAuthenticator

### Community 516 - "_MemCollection"
Cohesion: 0.15
Nodes (6): _MemCollection, _MemDB, fixture, tests/test_scheduler_store.py — Tests for durable scheduler store (#505)., _MemCollection.count_documents returns doc count., _MemCollection.delete_many removes docs matching updated_at < cutoff.

### Community 517 - "_push_down_where"
Cohesion: 0.14
...
### Community 518 - "router/health.py"
Cohesion: 0.20
...
### Community 519 - "DockerAgentAdapter"
Cohesion: 0.17
...
### Community 520 - "TestDecisionsBotLinks"
Cohesion: 0.17
...
### Community 521 - "DecisionsStore"
Cohesion: 0.30
Nodes (3): DecisionsStore, Any, Connection

### Community 522 - "clear_wizard_state_cache"
Cohesion: 0.21
...
### Community 525 - "DailyDigestAggregatorTests"
Cohesion: 0.21
...
### Community 527 - "test_openclaw_gateway.py"
Cohesion: 0.13
...
### Community 528 - "TestOrchestratorQueue"
Cohesion: 0.13
Nodes (6): fixture, enqueue_and_wait() callers DO await the future, so failures must still raise…, Drain loop must handle dequeue from empty queue gracefully., enqueue() (fire-and-forget) is used by the supervisor and restore path, whose…, FIFO queue lifecycle, concurrency, and edge cases., TestOrchestratorQueue
...
### Community 530 - "test_telegram_task_callback.py"
Cohesion: 0.19
...
### Community 533 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 537 - "Checks Performed"
Cohesion: 0.14
...
### Community 538 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 541 - "Skill: perplexity — Web Research via Perplexity API"
Cohesion: 0.14
...
### Community 542 - "Instructions"
Cohesion: 0.14
Nodes (13): 1 — Tests green, 2 — Changelog updated, 3 — Determine the version bump, 4 — Update changelog, 5 — Commit the changelog update, 6 — Tag the release, 7 — Verify CI on the tag, 8 — Post-release (+5 more)

### Community 543 - "Instructions"
Cohesion: 0.14
Nodes (13): Acceptance Checks, `admin_auth.py` checklist, `agent/tools.py` checklist, Escalation, Instructions, `key_store.py` checklist, `proxy.py` auth middleware checklist, Risky Modules in This Repo (+5 more)

### Community 544 - "Quick-Note Issues Processing Summary"
Cohesion: 0.14
...
### Community 545 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 547 - "Runbook: Auto-Resume After Cooldown / Interruption"
Cohesion: 0.14
...
### Community 551 - "overrides"
Cohesion: 0.14
Nodes (14): @tootallnate/once, overrides, bfj, css-select, http-proxy-agent, jsonpath, nth-check, postcss (+6 more)

### Community 552 - "mcp_server/server.py"
Cohesion: 0.25
Nodes (13): _check_auth(), _err(), _handle_tool(), health(), mcp_dispatch(), _ok(), Any, get (+5 more)

### Community 553 - "RateLimitTracker"
Cohesion: 0.19
Nodes (6): RateLimitTracker, Sleep if remaining quota for *provider_id* is critically low. Returns the…, Snapshot of all tracked provider quotas. Safe to call from any context., In-memory tracker for per-provider rate-limit state., TestClear, TestGetStats

### Community 554 - "ai/registry.py"
Cohesion: 0.21
...
### Community 557 - "test_critical_flows.py"
Cohesion: 0.29
...
### Community 558 - "test_regression.py"
Cohesion: 0.14
...
### Community 560 - "test_doctor_service_token_check.py"
Cohesion: 0.21
...
### Community 561 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 564 - ".compress"
Cohesion: 0.22
Nodes (8): _estimate_tokens(), Strategy, Drop the oldest non-system messages until under the token threshold., Remove exact-duplicate and near-empty messages., Return a (possibly shorter) copy of *messages* using *strategy*. ``inspect``…, Return token usage stats without modifying *messages*., Return *True* when estimated token count exceeds the threshold., ContextMessage

### Community 565 - "_TFIDFIndex"
Cohesion: 0.18
...
### Community 566 - "build_report"
Cohesion: 0.17
Nodes (8): build_report(), datetime, How many distinct tools each user has touched., Event counts grouped by ToolKind., Assemble the executive-summary report., Number of unique users with at least one event on the given day., Unique users in the 7 days ending at `end` (default: now)., Count distinct sessions per user. A session ends when there's a gap of more…

### Community 567 - "SyncAgent"
Cohesion: 0.19
...
### Community 569 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 572 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 573 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 576 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
...
### Community 577 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 578 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 580 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 581 - "admin_update_task_router.py"
Cohesion: 0.22
...
### Community 583 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
Nodes (12): Acceptance Checks, Claude's query protocol (use this instead of Read tool for exploration):, Graph Artifacts — What to Commit, How to Use the Graph (Token Savings Protocol), Installation (one-time per machine), Instead of reading raw files:, Key commands:, Relationship to repowise-intelligence Skill (+4 more)

### Community 584 - "Skill: platform-setup — Autonomous Agency Bootstrap"
Cohesion: 0.15
...
### Community 585 - "Workspace Isolation Architecture"
Cohesion: 0.15
...
### Community 586 - "Device compatibility and model picks"
Cohesion: 0.15
...
### Community 587 - "LLM Router — configuration guide"
Cohesion: 0.15
Nodes (13): Budgets, Bulkhead sizing, cache.yaml, Environment variables, health.yaml, keys.yaml, LLM Router — configuration guide, models.yaml (+5 more)

### Community 588 - "Autonomy Uplift — Living Roadmap & Detailed Implementation Specs"
Cohesion: 0.15
...
### Community 589 - "OpenClaw — iOS Control of the Agency (Single-Service Free-Tier Deploy)"
Cohesion: 0.15
...
### Community 591 - "_is_bedrock_model_id"
Cohesion: 0.27
...
### Community 592 - "ProviderHealth"
Cohesion: 0.33
Nodes (3): ProviderHealth, Any, Rolling health for one provider.

### Community 593 - "SchedulerStore"
Cohesion: 0.21
Nodes (6): Any, Delete a persisted job., Delete jobs older than *retention_days* (default from env…, Durable store for AgentScheduler jobs. Delegates to the shared DB (MongoDB or…, Persist a scheduled job (create or update)., SchedulerStore
...
### Community 597 - "scan_repo_with_user_research.py"
Cohesion: 0.22
...
### Community 599 - "test_agile_api.py"
Cohesion: 0.15
...
### Community 600 - "test_app_settings.py"
Cohesion: 0.19
...
### Community 601 - "TestModelCostTableUpdates"
Cohesion: 0.26
...
### Community 602 - "TestMCPClientStructuredOutput"
Cohesion: 0.31
...
### Community 603 - "test_deploy_trigger_covers_image.py"
Cohesion: 0.21
...
### Community 605 - "TestRuntimeControl"
Cohesion: 0.15
...
### Community 606 - "TestKillSwitchDurability"
Cohesion: 0.15
...
### Community 607 - "test_task_clarification.py"
Cohesion: 0.15
Nodes (4): auth_headers(), fixture, Tests for needs_clarification status and /api/tasks/{id}/clarify endpoint., Get auth headers for an admin user.

### Community 608 - "WorkspaceManifest"
Cohesion: 0.17
...
### Community 615 - "Skill: system-prompt-audit"
Cohesion: 0.17
...
### Community 616 - "Skill: task-alive-updates"
Cohesion: 0.17
...
### Community 620 - "14. Standing Instructions — Universal Agent Discipline"
Cohesion: 0.17
...
### Community 621 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 624 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 626 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 627 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 628 - "Quantization Internals"
Cohesion: 0.17
...
### Community 629 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 630 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 631 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 633 - "TestRequireAdmin"
Cohesion: 0.29
...
### Community 635 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 636 - "TestAuthAndTaskCreation"
Cohesion: 0.17
...
### Community 637 - "test_skill_registry.py"
Cohesion: 0.20
...
### Community 640 - "_extractive_compress"
Cohesion: 0.18
...
Cohesion: 0.29
Nodes (10): EngagementMetrics, Track adoption and engagement across the engineering org. DX report key…, Tests for agents.ai_insights — AI-Assisted Engineering metrics., test_build_report_assembles_all_sections(), test_engagement_dau_counts_unique_users(), test_engagement_dau_zero_when_no_events(), test_engagement_record_appends(), test_engagement_sessions_split_on_gap() (+2 more)

### Community 643 - "cowork_session.py"
Cohesion: 0.24
...
### Community 645 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 648 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 649 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 651 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 654 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 655 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 656 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 657 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 658 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 659 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 660 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 661 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 663 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 664 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 665 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 666 - "CI Troubleshooting Runbook"
Cohesion: 0.18
...
### Community 667 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 668 - "What to clean up"
Cohesion: 0.18
...
### Community 669 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 670 - "test_bedrock_live.py"
Cohesion: 0.25
...
### Community 675 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 676 - "test_event_log.py"
Cohesion: 0.45
...
### Community 677 - "test_tasks_awaiting_approval_api.py"
Cohesion: 0.40
...
### Community 679 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 680 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 681 - "CLAUDE.md — Master Architect Operating Manual"
Cohesion: 0.20
...
### Community 682 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 683 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 684 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 685 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 686 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 687 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 688 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 689 - "Agent Readiness Report"
Cohesion: 0.20
...
### Community 691 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 692 - "LLM Router — provider guide"
Cohesion: 0.20
...
### Community 696 - "local_brain_provider_config"
Cohesion: 0.29
...
### Community 697 - "TestModelsEndpointAliases"
Cohesion: 0.31
...
### Community 698 - "build_tech_db.py"
Cohesion: 0.40
...
### Community 701 - "_start_ceo_agency"
Cohesion: 0.27
...
### Community 704 - "TestExtendedThinkingRouting"
Cohesion: 0.20
...
### Community 705 - "TestZeroAttemptDiagnostics"
Cohesion: 0.29
...
### Community 708 - "test_quick_note_engine.py"
Cohesion: 0.22
...
### Community 713 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 714 - "TestPreCompiledPatterns"
Cohesion: 0.22
...
### Community 716 - "Skill: changelog-enforcer"
Cohesion: 0.22
...
### Community 717 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 719 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 720 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 721 - "Skill: changelog-enforcer"
Cohesion: 0.22
Nodes (8): Acceptance Checks, Changelog Location, Entry Format, Examples, Hook Behaviour, Instructions, Skill: changelog-enforcer, When to Use

### Community 722 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
Nodes (8): Branch, Components, Purpose, Quick Start, Session Roles, Skill: cowork-session (Claude Cowork), Testing, When to Use

### Community 723 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 725 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 726 - "Main proxy (`proxy.py`)"
Cohesion: 0.22
...
### Community 727 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 728 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 729 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 730 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 731 - "Release Procedure"
Cohesion: 0.22
...
### Community 732 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 741 - "enrich_quick_note_issues.py"
Cohesion: 0.42
...
### Community 742 - ".on_task_complete"
Cohesion: 0.25
Nodes (5): Any, Callback for BackgroundAgent.on_task_complete. Dispatches task result…, Dispatch the daily review digest to every authorized chat_id. Mirrors…, POST task result to configured webhook URL. Both ``error`` and ``result`` are…, task_id()

### Community 743 - "e2e/conftest.py"
Cohesion: 0.28
...
### Community 746 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 748 - "test_changelog_parity_guard.py"
Cohesion: 0.22
...
### Community 751 - "TestChatFallbackAndApproval"
Cohesion: 0.22
...
### Community 753 - "TestGithubSignalHardening"
Cohesion: 0.22
...
### Community 754 - "TestPaidPolicyDurability"
Cohesion: 0.22
...
### Community 756 - "test_runtimes_health_endpoint.py"
Cohesion: 0.22
...
### Community 757 - "test_scanner_deps_parity.py"
Cohesion: 0.31
...
### Community 758 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.22
...
### Community 760 - "navigation_metrics.py"
Cohesion: 0.32
...
### Community 766 - "ContributorState"
Cohesion: 0.25
...
### Community 767 - "quality_checker.py"
Cohesion: 0.32
...
### Community 779 - "AGENTS.md — AI Agent Configuration for local-llm-server"
Cohesion: 0.25
...
### Community 780 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 781 - "ceo-micromanagement.md"
Cohesion: 0.25
Nodes (4): P0 behavior change, Readiness contract, Runtime model, Runtime types

### Community 782 - "Feature Maturity / Support Matrix"
Cohesion: 0.25
...
### Community 785 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.25
...
### Community 786 - "Issue #362: Nvidia repo setup"
Cohesion: 0.25
...
### Community 787 - "Issue #364: quick-note:https://www.marktechpost.com/2026/06/01/meet-memory-os-a-6-layer-open-source-memory-stack-built-on-top-of-hermes-agent/"
Cohesion: 0.25
...
### Community 788 - "Issue #378: quick-note:https://www.marktechpost.com/2026/06/02/tinyfish-launches-bigset-an-open-source-multi-agent-system-that-builds-structured-live-datasets-from-plain-english-descriptions/"
Cohesion: 0.25
...
### Community 789 - "Issue #379: quick-note:https://searchengineland.com/schema-markup-optimize-agentic-web-479080"
Cohesion: 0.25
...
### Community 790 - "Issue #380: quick-note:https://cursor.com/blog/cloud-agent-lessons"
Cohesion: 0.25
...
### Community 791 - "Issue #381: quick-note:https://www.xda-developers.com/claude-code-with-opus-48-is-expensive-but-i-made-it-efficient-with-my-local-ai-workflow/"
Cohesion: 0.25
...
### Community 792 - "Issue #382: quick-note:https://claude.com/blog/how-coderabbit-used-claude-to-build-an-agent-orchestration-system"
Cohesion: 0.25
...
### Community 793 - "Issue #383: quick-note:https://www.marktechpost.com/2026/05/29/hexo-labs-open-sources-sia-a-self-improving-agent-that-updates-both-the-harness-and-the-model-weights/"
Cohesion: 0.25
...
### Community 794 - "Issue #416: feat: Self-hosted Codebuff (freebuff) on free NVIDIA models + Telegram bot phone control"
Cohesion: 0.25
...
### Community 795 - "Issue #485: [Trend Digest] Week of 2026-06-08"
Cohesion: 0.25
...
### Community 796 - "Issue #488: quick-note:https://github.com/cookiy-ai/user-research-skill"
Cohesion: 0.25
...
### Community 797 - "Issue #491: Implement whatever is necessary from https://github.com/BehiSecc/awesome-claude-skills"
Cohesion: 0.25
...
### Community 798 - "Issue #493: Use the https://github.com/mvanhorn/last30days-skill skill to get the trend updated"
Cohesion: 0.25
...
### Community 799 - "Issue #495: Read https://www.anthropic.com/news/claude-fable-5-mythos-5 and understand if mythos or fable can be added to the repo"
Cohesion: 0.25
...
### Community 800 - "Issue #504: EPIC: Autonomy hardening — live-verified defects 2026-06-10"
Cohesion: 0.25
...
### Community 801 - "Issue #581: Sprint tracker: pending work after brand rename + mobile-first pass"
Cohesion: 0.25
...
### Community 803 - "Issue #657: quick-note:https://github.com/earendil-works/pi"
Cohesion: 0.25
...
### Community 804 - "Issue #659: quick-note:https://github.com/nex-agi/Nex-N2"
Cohesion: 0.25
...
### Community 805 - "Issue #660: quick-note:https://github.com/getsentry/sentry-for-ai"
Cohesion: 0.25
...
### Community 806 - "Issue #661: quick-note:https://github.com/XiaomiMiMo/MiMo-Code"
Cohesion: 0.25
...
### Community 807 - "Issue #664: quick-note:https://github.com/Grominet95/jarvis-OS"
Cohesion: 0.25
...
### Community 808 - "Issue #666: quick-note:https://github.com/porokka/jarvis-os"
Cohesion: 0.25
...
### Community 809 - "Issue #670: quick-note:https://github.com/perplexityai/bumblebee"
Cohesion: 0.25
...
### Community 810 - "Issue #672: quick-note:https://github.com/Chachamaru127/claude-code-harness"
Cohesion: 0.25
...
### Community 811 - "Issue #676: quick-note:https://github.com/WeiboAI/VibeThinker"
Cohesion: 0.25
...
### Community 812 - "Issue #820: quick-note:https://github.com/cobusgreyling/loop-engineering"
Cohesion: 0.25
...
### Community 813 - "Positional Encoding Internals"
Cohesion: 0.25
...
### Community 815 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 816 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 817 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 818 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 821 - "_get_current_user"
Cohesion: 0.29
...
Cohesion: 0.25
Nodes (6): get_tracker(), _ProviderQuota, Response, Proactive rate-limit throttling for LLM providers — two complementary layers.…, Parse x-ratelimit-* headers and update per-provider quota state. Safe to call…, Return the process-singleton RateLimitTracker.

### Community 823 - "bus.py"
Cohesion: 0.32
...
### Community 824 - "capture_screens.py"
Cohesion: 0.39
...
### Community 827 - "crispy_burn_in.py"
Cohesion: 0.36
...
### Community 828 - "run_patched_colibri.py"
Cohesion: 0.36
...
### Community 829 - "CircuitState"
Cohesion: 0.46
Nodes (7): ProviderHealth, Circuit-breaker state for a provider., CircuitState, Regression guard: a rate-limit cooldown must survive, on every route.…, TestNimPoolCountsRateLimitsAsFailures, TestRecoveryDoesNotFabricateSuccess, TestRouterBypassSkipsRateLimited

### Community 830 - "SessionMemory"
Cohesion: 0.25
...
### Community 832 - "test_compose_and_coordinate_api.py"
Cohesion: 0.36
...
### Community 834 - "TestProviderRouter"
Cohesion: 0.25
...
### Community 835 - "test_local_brain_router_smoke.py"
Cohesion: 0.25
...
### Community 837 - "test_provider_models_db_outage.py"
Cohesion: 0.25
...
### Community 839 - "test_seo_audit_pending_expiry.py"
Cohesion: 0.43
...
### Community 843 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 844 - ".discover_directory"
Cohesion: 0.29
...
### Community 851 - "4. Current Architecture (As-Is)"
Cohesion: 0.29
...
### Community 852 - "AI Engineering Insights Skill"
Cohesion: 0.29
...
### Community 862 - "ADR-006: Strangler Fig migration with backward-compat shims"
Cohesion: 0.29
Nodes (6): ADR-006: Strangler Fig migration with backward-compat shims, Consequences, Context, Decision, Examples, Migration path

### Community 863 - "claude-mem Plugin — Persistent Memory for All Sessions"
Cohesion: 0.29
...
### Community 864 - "Implementation plan + TO-DO (check off as you go)"
Cohesion: 0.29
...
### Community 873 - "scheduler/store.py"
Cohesion: 0.29
Nodes (3): _MemDeleteResult, services/scheduler_store.py — Durable scheduler persistence. Issue #505:…, _MemDeleteResult supports explicit count for batch deletes.
...
### Community 875 - "check_changelog_parity.py"
Cohesion: 0.43
...
### Community 876 - "e2e_smoke.py"
Cohesion: 0.57
Nodes (5): _chat(), check(), _health(), _models(), _req()

### Community 877 - "task_runner.py"
Cohesion: 0.33
...
### Community 879 - "test_daily_2026_06_14.py"
Cohesion: 0.38
...
### Community 880 - "TestSupportMatrixDocsSync"
Cohesion: 0.29
...
### Community 881 - "TestGithubTokenSQLiteRegression"
Cohesion: 0.38
...
### Community 883 - "test_log_monitor_storm_guard.py"
Cohesion: 0.48
...
### Community 904 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 905 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 906 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 907 - "The full agent capability roster"
Cohesion: 0.33
...
### Community 908 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 909 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 910 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 927 - "test_generate_context_standing_instructions.py"
Cohesion: 0.40
...
### Community 949 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 950 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 951 - "Runtime troubleshooting"
Cohesion: 0.40
Nodes (4): Agent mode timeout, Missing binary / task harness, Runtime troubleshooting, Workspace validation failures

### Community 952 - "knowledgeGraphTab.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 953 - "loginFlowNoTimeout.test.js"
Cohesion: 0.40
Nodes (4): apiSource, { describe, test, expect }, fs, path

### Community 954 - "test_company_stale_id_recovery.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 955 - "worker_no_cache.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, workerSource

### Community 956 - "scripts/agile_ceremonies.py"
Cohesion: 0.70
...
### Community 958 - "Prompt Library Changelog"
Cohesion: 0.40
...
### Community 960 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 961 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 962 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 963 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 964 - "setup_colibri.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 965 - "setup_colibri.sh script"
Cohesion: 0.70
Nodes (4): setup_colibri.sh script, fail(), ok(), warn()

### Community 966 - "status_colibri_server.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 967 - "CircuitBreakerOpenError"
Cohesion: 0.50
...
### Community 971 - "test_agent_runtime_wrapper.py"
Cohesion: 0.70
...
### Community 973 - "TestDirectChatAgentModeSplit"
Cohesion: 0.40
Nodes (3): When agent_mode is False, no AgentJob should be created at the job manager…, When agent_mode is True, an AgentJob should be created in the job manager. This…, TestDirectChatAgentModeSplit

### Community 974 - "worker/index.js"
Cohesion: 0.70
Nodes (4): fetch(), needsProxy(), PROXY_PREFIXES, scheduled()

### Community 976 - "recovery.py"
Cohesion: 0.67
Nodes (3): detect_secrets(), main(), Recover CHANGELOG.md from a Git merge conflict in its [Unreleased] block. Pre-…

### Community 977 - "10. Testing Constitution"
Cohesion: 0.50
Nodes (4): 10. Testing Constitution, Test rules, Test structure, Testing Expectations

### Community 978 - "5. AI Provider Architecture"
Cohesion: 0.50
Nodes (4): 5. AI Provider Architecture, Current state, Fallback chain, Provider interface contract

### Community 979 - "aider_config.sh"
Cohesion: 0.50
Nodes (3): OPENAI_API_BASE, OPENAI_API_KEY, aider_config.sh script

### Community 982 - "Issue → Context → Draft PR automation"
Cohesion: 0.50
Nodes (4): Backfilling existing issues, Free-first model routing, Issue → Context → Draft PR automation, The workflows

### Community 983 - "The 24x7 agency — your agents never go idle"
Cohesion: 0.50
...
### Community 1002 - "test_no_exception_detail_leaks.py"
Cohesion: 0.50
...
### Community 1003 - "test_skills_route_order.py"
Cohesion: 0.67
...
### Community 1004 - "_inline_threads"
Cohesion: 0.50
Nodes (4): _clear_telegram_env(), _inline_threads(), fixture, Run NotificationDispatcher's background-thread sends synchronously.

### Community 1005 - "github"
Cohesion: 0.50
Nodes (3): github, enabled, silent

### Community 1006 - "10. CI/CD Standards"
Cohesion: 0.67
Nodes (3): 10. CI/CD Standards, Deployment, Pipeline (22 checks)

### Community 1007 - "11. Rewrite Strategy"
Cohesion: 0.67
Nodes (3): 11. Rewrite Strategy, Phased approach, Rules

### Community 1008 - "3. Repository Constitution"
Cohesion: 0.67
...
### Community 1038 - "test_mint_token_rejects_missing_args"
Cohesion: 0.67
Nodes (3): parametrize, Empty key/secret/identity/room must raise ValueError., test_mint_token_rejects_missing_args()

## Knowledge Gaps
- **3339 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `aider_config.sh script`, `OPENAI_API_BASE` (+3334 more)
...
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `AgentSessionStore`, `FreeBuffAgent`, `diagnostics.py`, `proxy.py`, `BackgroundAgent`, `TaskSpec`, `direct_chat.py`, `test_agent_free_brain.py`, `Workspace`, `AdaptiveHalter`, `WorkflowRun`, `test_ceo_dispatcher.py`, `LocalWorkspace`, `test_empirical_verify.py`, `failover_chat_completion`, `TokenBudget`, `CEODispatcher`, `workflow_orchestrator.py`, `ExecutionRequest`, `MultiAgentSwarm`, `ContextPruner`, `WorkspaceTools`, `.execute`, `TestZeroAttemptDiagnostics`, `_resolve_push_token`, `test_brain_failover_413.py`, `GitHubTools`, `agency.py`, `failover_client.py`, `ContextManager`, `MCPUnavailableError`, `E2BAdapter`, `_StubManager`, `MCPClient`, `ReactScratchpad`, `TestMCPServer`, `StuckDetector`, `ceo_dispatcher.py`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderRouter` to `backend/server.py`, `AgentSessionStore`, `is_anthropic_base_url`, `test_colibri_provider.py`, `direct_chat.py`, `ChatResponse`, `TestRouterIntegration`, `TrafficDirector`, `test_bedrock_live.py`, `resolve_active_brain`, `ProviderConfig`, `failover_chat_completion`, `test_bedrock_provider.py`, `CircuitState`, `kimi_bridge_provider_config`, `ai/router.py`, `_is_bedrock_model_id`, `test_all_providers_discovery.py`, `test_anthropic_router.py`, `failover_client.py`, `system_instruction`, `TestOpenAiToBedrockConverse`, `TestBrainFailoverBackoff`, `TestActiveStrategy`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `PortfolioManager` connect `PortfolioManager` to `portfolio_intelligence.py`, `BackgroundAgent`, `PortfolioIntelligence`, `TestRoutes`, `skill_bindings.py`, `AgileManager`?**
