# Graph Report - local-llm-server  (2026-08-04)

## Corpus Check
- 1371 files · ~1,933,078 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 26920 nodes · 54498 edges · 1170 communities (1039 shown, 131 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 6056 edges (avg confidence: 0.54)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9423023e`
...
## Communities (1170 total, 131 thin omitted)

### Community 0 - "ExecutionRequest"
Cohesion: 0.01
Nodes (227): Called by APScheduler when a cron fires. Dispatches to the orchestrator., _scheduler_on_fire(), get_orchestrator_checkpoint_store(), _NoopDB, OrchestratorCheckpointStore, Any, services/orchestrator_checkpoint.py — Durable step-level checkpointing Issue…, Restore in-flight runs at startup. Called during backend bootstrap. Returns a… (+219 more)

### Community 1 - "backend/server.py"
Cohesion: 0.02
Nodes (272): admin_seed(), _agent_timeout_fallback_response(), auth_me(), auto_recommend_skills(), _build_agent_status_snapshot(), _build_agent_stream_event(), _build_auto_skill_guidance(), _build_direct_chat_schedule_suggestion() (+264 more)

### Community 2 - "AgentScheduler"
Cohesion: 0.04
Nodes (160): Agency, CEO-coordinated multi-agent agency for continuous codebase management. The CEO…, AgentJobRequest, AgentJobSnapshot, BaseModel, Complete point-in-time view of a job, safe to serialise as API response., Convenience: the canonical text response, whether success or failure., Validated input for creating a new agent job. Passed from the API handler into… (+152 more)

### Community 3 - "FreeBuffAgent"
Cohesion: 0.03
Nodes (177): BackgroundAgent, BackgroundTask, _now(), Any, agent/background.py — Background Agent An always-on worker thread that…, Enqueue *task* for processing. Returns the task (with task_id set)., Convenience: create a task and submit it in one call., Real handler — dispatches through AgentRunner when available. HARDENED (PR… (+169 more)

### Community 4 - "AgentRunner"
Cohesion: 0.02
Nodes (164): AgentDirective, AgentRole, str, get_enrichment(), AgentPhaseError, AgentRunner, _check_extra_kwargs(), _enforce_signature() (+156 more)

### Community 5 - "company_api.py"
Cohesion: 0.04
Nodes (157): AccountLifecycleResponse, _DoctorCheck, _DoctorReport, get_public_doctor_report(), OnboardingAnswersRequest, OnboardingProgressResponse, OnboardingQuestionsRequest, BaseModel (+149 more)

### Community 6 - "proxy.py"
Cohesion: 0.02
Nodes (181): Any, Return recent commits with agent attribution trailers parsed out., free_nvidia_models(), Return the curated list of free NVIDIA NIM models FreeBuff may use., True when *model* is in the curated free NVIDIA NIM set., get_skill_registry_safe(), Return the global SkillRegistry if set, else None. Used by onboarding and other…, middleware (+173 more)

### Community 7 - "LLMRequest"
Cohesion: 0.03
Nodes (132): ProviderConfig, One configured endpoint. ``kind`` selects the adapter: ``openai`` (any OpenAI-…, AnthropicProvider, Any, AsyncClient, packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, Translate OpenAI-shaped messages into Anthropic's system/turn split., OpenAI carries a tool result as role="tool" with a tool_call_id; Anthropic… (+124 more)

### Community 8 - "AgentSessionStore"
Cohesion: 0.03
Nodes (138): PreflightIssue, Any, BaseModel, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, Translate technical preflight issues into a conversational assistant reply., translate_error_to_conversational(), Agent subsystem — planner / executor / verifier loop., AgentEvent (+130 more)

### Community 9 - "test_runtimes.py"
Cohesion: 0.03
Nodes (66): AiderAdapter, Any, Adapter for Aider — TIER 3 specialized git-aware code editor., GooseAdapter, Any, Adapter for Goose — TIER 2 general-purpose local runtime., HermesAdapter, Adapter for Hermes Agent — FIRST CLASS autonomous runtime. (+58 more)

### Community 10 - "ProviderCircuit"
Cohesion: 0.03
Nodes (75): ProviderHealth, Circuit-breaker state for a provider., _deep_merge(), get_guardrails(), GuardrailEngine, GuardResult, Any, Configurable safety rail engine for LLM inputs and outputs. Supports: -… (+67 more)

### Community 11 - "TaskSpec"
Cohesion: 0.03
Nodes (110): kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, TaskResult, TaskSpec, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Run aider non-interactively via `--message` flag., ClaudeCodeAdapter, json_safe() (+102 more)

### Community 12 - "PortfolioManager"
Cohesion: 0.03
Nodes (74): Lifecycle status of a sprint., SprintStatus, Initiative, InitiativeStatus, PortfolioIntelligence, Assembles a PortfolioManager from live signals with WSJF scoring., PortfolioManager, Manages a portfolio of initiatives with WSJF prioritisation and roadmapping. (+66 more)

### Community 13 - "test_llm_router_queue_cache.py"
Cohesion: 0.03
Nodes (96): build_summariser(), chunk_document(), ContextManager, estimate_tokens(), FitResult, message_tokens(), prune(), Any (+88 more)

### Community 14 - "ProviderConfig"
Cohesion: 0.04
Nodes (89): _acquire_provider_probe(), extract_openai_text(), _get_director(), is_commercial_provider(), _normalize_nvidia_base_url(), _normalized_provider_type(), _openai_url(), provider_access_tier() (+81 more)

### Community 15 - "MongoDBStore"
Cohesion: 0.03
...
Cohesion: 0.03
Nodes (92): _load(), main(), int, openai_body_from_response(), Any, packages/llm/compat.py — backwards-compatible bridges to the legacy call paths.…, Whether the compat bridges should delegate to ``LLMRouter``. Reads the flag on…, Translate an OpenAI-shaped chat payload into an ``LLMRequest``. Unknown keys… (+84 more)
...
Cohesion: 0.03
Nodes (95): BrainConfig, BrainConfigStore, default_brain_config(), get_brain_config(), invalidate_brain_config_cache(), provider_base_url(), _provider_env_value(), provider_key_rotation_enabled() (+87 more)
...
### Community 21 - "test_llm_router_resilience.py"
Cohesion: 0.03
Nodes (68): HealthConfig, Backoff policy for retryable failures., Circuit breaker + health tracking thresholds., RetryConfig, BreakerState, HealthTracker, _Outcome, ProviderHealth (+60 more)
...
### Community 23 - "test_model_router.py"
Cohesion: 0.04
...
### Community 25 - "seo_api.py"
Cohesion: 0.03
Nodes (101): account_lifecycle(), auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint(), generate_onboarding_questions(), get_company(), get_company_access() (+93 more)

### Community 26 - "FeatureMatrix"
Cohesion: 0.04
...
Cohesion: 0.04
Nodes (90): BrainResolution, get_active_brain_sync(), get_brain_preference(), get_provider_role_tags(), _host_is_openai_compatible(), invalidate_brain_cache(), _norm(), _pick_from_records() (+82 more)

### Community 32 - "SecretRecord"
Cohesion: 0.06
...
Cohesion: 0.05
Nodes (58): agents/store.py — Persistent store for user-defined agent configurations.…, Set the global agent store instance (e.g., with MongoDB on startup)., set_agent_store(), ApprovalCheckpoint, Human approval gate in a task's execution., _is_brain_connection_error(), Any, BaseException (+50 more)

### Community 36 - "test_llm_router_strategies.py"
Cohesion: 0.06
...
### Community 37 - "get_company_graph_store"
Cohesion: 0.04
Nodes (69): Synchronize the Company Graph. Re-scans all websites and repositories, updates…, sync_company_graph(), autonomy_status(), Public autonomy readiness probe — no authentication required. A live deploy…, Fire-and-forget self-bootstrap; never blocks or crashes startup., _schedule_self_bootstrap(), CompanyAgencyService, get_company_agency_service() (+61 more)
...
### Community 39 - "E2BSandboxSession"
Cohesion: 0.05
...
### Community 40 - "test_repo_connection.py"
Cohesion: 0.05
Nodes (63): DeliveryPolicy, How code lands on a repo's default branch (detected, GitHub-only for now). The…, A company's connection to a code repository (GitHub-only this pass). URL-only…, RepoConnection, attach_repo_connection(), build_repo_connection(), decide_merge(), detect_delivery_policy() (+55 more)
...
### Community 43 - "ai/router.py"
Cohesion: 0.04
Nodes (67): clear_cooldowns(), _dead_model_key(), _exponential_backoff_cooldown(), get_dead_models(), _is_model_dead(), is_provider_on_cooldown(), _mark_model_dead(), mark_provider_failed() (+59 more)

### Community 44 - "Task"
Cohesion: 0.05
Nodes (58): Full task/issue document., Task, PUBLIC_URL-anchored dashboard deep link for the task detail. Returns empty…, Best-effort Telegram heads-up that a task is parked awaiting approval. Inline…, _escape_md_v1(), Escape Telegram Markdown-v1 reserved chars in free-text fields. Markdown-v1…, asyncio, fixture (+50 more)

### Community 45 - "SelfHealingAgent"
Cohesion: 0.05
Nodes (53): heal_signature(), HealingEvent, _now(), Any, agent/self_healing.py — Self-Healing Agent (closed-loop, Autonomy Charter G2)…, Translate external failure signals into improvement tasks and verify the fix…, Launch the background sweeper that resolves quiet verifying heals., Called when a CI workflow fails. (+45 more)

### Community 46 - "WebsiteScanner"
Cohesion: 0.04
Nodes (56): Scan a website for technology stack and systems. This performs a comprehensive…, scan_website_endpoint(), main(), Returns (url, ok, summary)., _scan_one(), _is_safe_url(), _looks_like_bot_challenge(), Any (+48 more)
...
### Community 48 - "AutonomyTracker"
Cohesion: 0.04
Nodes (43): AutonomyCounter, AutonomySnapshot, AutonomyTracker, get_tracker(), Any, agent/kpi.py — Autonomy KPIs: evidence capture and metrics tracking. Tracks key…, Return a point-in-time snapshot of all KPIs., Reset all counters (test helper). (+35 more)
...
### Community 50 - "skill_bindings.py"
Cohesion: 0.04
Nodes (52): Status of a user story within a sprint., StoryStatus, HarnessAdapter, HarnessSpec, Any, agents/harness_adapter.py — ECC Cross-Harness Adapter Normalises API…, Adapt harness-native requests to the local-llm-server internal format. Each…, Detect which harness sent this request from headers. Check order: explicit… (+44 more)
...
Cohesion: 0.06
Nodes (44): analyze_qualitative(), auto_register(), _classify_sentiment(), _extract_keywords(), plan_research(), Any, BaseModel, field_validator (+36 more)

### Community 55 - "rbac.py"
Cohesion: 0.05
...
### Community 68 - "failover_client.py"
Cohesion: 0.04
...
### Community 70 - "brain_failover.py"
Cohesion: 0.05
...
Cohesion: 0.05
Nodes (60): quick_notes_submit(), Submit a quick-note URL or instruction from the dashboard FAB., Path, Start RuntimeManager, TaskDispatcher, SCHEDULER, and self-bootstrap. Returns a…, start_background_services(), Reset the singleton (for tests)., reset_failover_manager(), Hand the 'connect & verify the repo' work to the agency's own agents. The task… (+52 more)

### Community 77 - "test_model_catalog.py"
Cohesion: 0.05
...
### Community 81 - "SeoFixer"
Cohesion: 0.07
Nodes (29): BaseModel, Options for turning an audit's delegation plan into real agent tasks., SeoDelegationCreateRequest, SeoDelegationCreateResult, Request to remediate auto-fixable findings in a local code repository., One concrete remediation performed (or proposed) by the fixer., Result of a fixer run., SeoFixAction (+21 more)
...
### Community 89 - "CLAUDE.md — Master Architect Operating Manual"
Cohesion: 0.03
...
### Community 96 - "LLMRouter"
Cohesion: 0.06
Nodes (31): Attempt, Read the environment variables named in ``env_names`` into a key list. Order is…, resolve_keys(), LLMRouter, Any, AsyncClient, BaseException, ProviderConfig (+23 more)
...
### Community 99 - "StreamingDeltaReconstructor"
Cohesion: 0.06
...
### Community 101 - "anthropic_compat.py"
Cohesion: 0.06
...
### Community 102 - "probe_model_liveness"
Cohesion: 0.05
...
### Community 103 - "test_integration_c4_c5_c6_d3.py"
Cohesion: 0.06
...
Cohesion: 0.08
Nodes (30): PreflightReport, AgentJob, make_isolated_workspace(), Path, Create an isolated workspace directory under *root*. This is the legacy path…, _workspace_component(), Any, WorkspaceEscapeError (+22 more)
...
Cohesion: 0.04
Nodes (43): _keepalive_self_ping(), lifespan(), _maybe_boot_purge(), merge_pr_route(), _purge_summary_clean(), Return orchestrator queue depth, active runs, and supervisor state (#522)., Run the FreeBuff Telegram bot, restarting it on unexpected exit., Ping our own public URL so a free-tier web service doesn't sleep. Render free… (+35 more)

### Community 114 - "test_context_rulebook.py"
Cohesion: 0.06
Nodes (54): Module, stmt, _bound_names(), _good_result(), _guard_statements(), _load(), fixture, ModuleType (+46 more)

### Community 115 - "test_issue_intake.py"
Cohesion: 0.07
...
### Community 121 - "test_bedrock_provider.py"
Cohesion: 0.06
...
### Community 126 - "PatternConsolidation"
Cohesion: 0.07
...
### Community 127 - "cache.py"
Cohesion: 0.06
Nodes (35): Test hook — clear all usage accounting., reset(), CacheManager, cosine_similarity(), _Entry, get_cache(), LRUCache, payload_key() (+27 more)

### Community 128 - "test_kimi_bridge_server.py"
Cohesion: 0.06
...
### Community 131 - "TestPayloadNormalisation"
Cohesion: 0.06
...
### Community 133 - "telegram_bot.py"
Cohesion: 0.08
Nodes (51): get_decisions_store(), Process-wide DecisionsStore singleton (resettable via db_path arg)., Return a Markdown-v1-safe preview string under ``max_chars``. Used by the…, sanitize_paste_for_preview(), _admin_headers(), _api_headers(), _check_rate_limit(), cmd_control() (+43 more)

### Community 134 - "settings.py"
Cohesion: 0.07
Nodes (26): Cerebras provider adapter — free, fast LLM (qwen-3-coder-480b)., GroqProvider, Provider, Groq provider adapter — free, fast LLM (deepseek-r1-distill-llama-70b)., NvidiaProvider, Provider, NVIDIA NIM provider adapter — wraps the existing provider_router logic. This is…, NVIDIA NIM — free LLM provider (meta/llama-3.3-70b-instruct). (+18 more)
...
### Community 140 - "AGENTS.md — Source of Truth for All AI Agents"
Cohesion: 0.04
...
### Community 142 - "get_feature_matrix"
Cohesion: 0.06
...
### Community 143 - "test_seo_audit.py"
Cohesion: 0.07
...
### Community 144 - "test_trend_scoping.py"
Cohesion: 0.10
...
### Community 151 - "test_e2b_data_flow.py"
Cohesion: 0.07
...
### Community 152 - "tests/conftest.py"
Cohesion: 0.06
...
### Community 156 - "validate_outbound_url"
Cohesion: 0.09
...
### Community 163 - "test_agent_free_brain.py"
Cohesion: 0.05
...
Cohesion: 0.05
Nodes (26): _env_int(), _get_settings(), Read an int env var, falling back to *default* on a missing/bad value. Never…, ``RENDER_SERVICE_IDS`` split into a clean list (empty when unset)., True when there is both an API key and an endpoint to reach., When True, the Render ops loop runs. On by default. Also requires…, When True, mutating Render MCP tools may be called. Default False., Validated `reasoning_effort` for Ollama thinking models, or ``""``. Returns one… (+18 more)
...
### Community 167 - "test_portfolio_intake.py"
Cohesion: 0.08
...
### Community 168 - "CEOSupervisor"
Cohesion: 0.07
Nodes (27): backend/ceo_router.py — observability and manual control for the CEO. Surfaces…, Reject non-admin callers for routes that spend provider budget. Delegates to…, _require_admin(), get_ceo_dispatcher(), Return the shared CEODispatcher singleton., get_ceo_ledger(), Return the shared :class:`CEOLedger`, constructing it on first use., CEOSupervisor (+19 more)

### Community 169 - "_get_provider_policy"
Cohesion: 0.06
...
Cohesion: 0.07
Nodes (35): _Circuit, _enabled(), _failure_threshold(), OllamaCircuitBreaker, Record a successful response; close the circuit., Record a 5xx error; open the circuit after threshold is reached., Reset circuit state (used in tests and admin operations)., Return the current state string (CLOSED/OPEN/HALF_OPEN). (+27 more)

### Community 174 - "SkillBindings"
Cohesion: 0.07
...
### Community 175 - "agency.py"
Cohesion: 0.06
Nodes (39): _build_quick_note_instruction(), _close_github_issue(), _collect_recent_git_context(), _fetch_github_quick_notes(), get_agency(), _gh_repo(), _gh_token(), Enum (+31 more)

### Community 176 - "portfolio_api.py"
Cohesion: 0.09
...
### Community 177 - "Part A — CodeRabbit review fixes for this PR (do first, small)"
Cohesion: 0.05
...
### Community 178 - "Docker Agent Runtimes Setup"
Cohesion: 0.05
...
### Community 179 - "TasksPage.js"
Cohesion: 0.06
Nodes (31): addTaskComment(), clarifyTask(), escalateTask(), fetchVelocity(), followUpTask(), updateTask(), C, COLS (+23 more)

### Community 180 - "ceo_dispatcher.py"
Cohesion: 0.06
Nodes (39): _complexity_rank(), _decompose_into_subtasks(), _merge_changed_files(), _offload(), services/ceo_dispatcher.py — Real CEO delegation layer. The CEO splits a…, Run a synchronous ledger call without blocking the event loop. ``CEOLedger`` is…, Reset the singleton (test helper)., Decompose a request into 2-3 sub-tasks for specialist fan-out. Default… (+31 more)

### Community 181 - "get_failover_manager"
Cohesion: 0.06
...
### Community 183 - "resolve_component_model"
Cohesion: 0.06
...
### Community 188 - "job_manager.py"
Cohesion: 0.07
Nodes (18): agent/job_manager.py — Async agent job lifecycle manager. Manages agent jobs…, Any, Structured, actionable preflight validation issue., Preflight result returned before a runtime task starts., Return a health snapshot. Must not raise; return available=False instead., Return runtime-specific dependency declarations for preflight., Return a best-effort tool availability report for diagnostics., Ensure the requested workspace exists and is writable. (+10 more)

### Community 189 - "RewardScorer"
Cohesion: 0.08
...
### Community 190 - "portfolio_intelligence.py"
Cohesion: 0.09
...
### Community 191 - "TestEstimateTokensForMessages"
Cohesion: 0.06
...
### Community 195 - "facade.py"
Cohesion: 0.08
Nodes (35): create_access_token(), create_refresh_token(), github_callback(), github_repo_callback(), google_callback(), create_access_token(), create_refresh_token(), get_current_user() (+27 more)
...
### Community 202 - "test_verification_strategies.py"
Cohesion: 0.11
...
### Community 211 - "FilterResult"
Cohesion: 0.10
Nodes (19): filter_output(), FilterResult, OutputFilter, Any, agent/output_filter.py — LLM Output Compression & Token Savings Inspired by…, Filter and compress command outputs to reduce LLM token consumption. Provides…, Compact git status output — keep only changed file paths., Compact git log — one line per commit. (+11 more)
...
### Community 214 - "test_ceo_router.py"
Cohesion: 0.10
...
### Community 215 - "output_filter.py"
Cohesion: 0.07
...
### Community 216 - "REWRITE_PLAN.md — Phased Migration Strategy"
Cohesion: 0.06
...
### Community 219 - "test_all_providers_discovery.py"
Cohesion: 0.16
...
### Community 220 - "test_llm_router_e2e.py"
Cohesion: 0.14
...
### Community 222 - "CEOLedger"
Cohesion: 0.10
Nodes (17): _backend(), CEOLedger, _now(), Any, services/ceo_ledger.py — durable record of what the CEO is driving to closure.…, Return ``(done, total)`` subtask counts., Durable store for :class:`GoalRecord`s. Every method is best-effort and never…, Persist *goal*, stamping ``updated_at``. (+9 more)
...
### Community 224 - "analyze_quantitative"
Cohesion: 0.10
...
### Community 226 - "agent_runtime.py"
Cohesion: 0.11
...
### Community 227 - "ENGINEERING_STANDARDS.md — Coding, Security & Testing Standards"
Cohesion: 0.06
...
### Community 241 - "OrchestratorQueue"
Cohesion: 0.07
...
### Community 242 - "test_output_filter.py"
Cohesion: 0.06
...
### Community 243 - "test_microagents.py"
Cohesion: 0.15
...
### Community 244 - "agents/agile_ceremonies.py"
Cohesion: 0.09
Nodes (25): _bullets(), generate_sprint_retro(), generate_standup(), plan_next_sprint(), Agentic Agile — autonomous ceremonies (standup, retro, sprint planning). Where…, Render a :class:`Retrospective` as a markdown section., Derive retro notes for ``sprint`` from its current metrics. Records…, The result of allocating portfolio capacity into a new sprint. (+17 more)
...
### Community 246 - "emit_chat_observation"
Cohesion: 0.12
...
### Community 247 - "Langfuse Observability Guide"
Cohesion: 0.06
...
### Community 249 - "test_failover_silent_exhaustion.py"
Cohesion: 0.10
...
### Community 256 - "test_unit7_catalog_propagation.py"
Cohesion: 0.07
...
### Community 257 - "High-Agency Frontend Skill"
Cohesion: 0.06
Nodes (30): 10. FINAL PRE-FLIGHT CHECK, 1. ACTIVE BASELINE CONFIGURATION, 2. DEFAULT ARCHITECTURE & CONVENTIONS, 3. DESIGN ENGINEERING DIRECTIVES (Bias Correction), 4. CREATIVE PROACTIVITY (Anti-Slop Implementation), 5. PERFORMANCE GUARDRAILS, 6. TECHNICAL REFERENCE (Dial Definitions), 7. AI TELLS (Forbidden Patterns) (+22 more)

### Community 258 - "Quick-Note GitHub Issues Processing - Session Summary"
Cohesion: 0.06
...
### Community 261 - "test_sam_voice.py"
Cohesion: 0.07
...
### Community 262 - "tests/test_browser.py"
Cohesion: 0.10
...
### Community 263 - "all_provider_ids"
Cohesion: 0.07
Nodes (24): _brain_provider_status(), Return per-provider metadata for the GET endpoint. Iterates every provider in…, Return the discovered model list for *provider_id*, or ``[]`` if unknown., _served_models(), all_provider_ids(), _provider_ids_from_literal(), Return every provider id recognised by the brain config system. Iterates the…, Return the provider ids allowed by the ``BrainProvider`` Literal. Reads the… (+16 more)

### Community 264 - "test_colibri_provider.py"
Cohesion: 0.12
...
### Community 267 - "test_autonomy_gate.py"
Cohesion: 0.11
...
### Community 268 - "MCPUnavailableError"
Cohesion: 0.15
...
### Community 269 - "llm_providers.py"
Cohesion: 0.15
...
### Community 272 - "test_pr923_fixes.py"
Cohesion: 0.09
...
### Community 273 - "SteeringInjector"
Cohesion: 0.11
...
### Community 274 - "test_claude_setup_audit.py"
Cohesion: 0.16
...
### Community 275 - ".start_onboarding"
Cohesion: 0.07
...
### Community 276 - "test_crispy_burn_in.py"
Cohesion: 0.07
...
### Community 277 - "test_internal_agent_did_work.py"
Cohesion: 0.12
...
### Community 279 - "test_schedule_growth_invariants.py"
Cohesion: 0.09
...
### Community 284 - "SetupWizardPage.js"
Cohesion: 0.10
...
### Community 291 - "TestBrainFailoverModelUpdates"
Cohesion: 0.12
...
### Community 300 - "_FakePersistence"
Cohesion: 0.13
...
### Community 304 - "Performance Analysis — local-llm-server"
Cohesion: 0.08
...
### Community 305 - "_resolve_user_github_token"
Cohesion: 0.13
...
### Community 306 - "LLM Router — troubleshooting"
Cohesion: 0.08
...
### Community 307 - "AgentsScreen.jsx"
Cohesion: 0.13
...
### Community 309 - "test_rate_limiter.py"
Cohesion: 0.12
...
### Community 312 - "test_telegram_approval_gate.py"
Cohesion: 0.10
...
### Community 321 - "test_freebuff_bot.py"
Cohesion: 0.10
Nodes (19): List the free NVIDIA NIM models a user may pick (e.g. via Telegram)., _embedded(), _fb_models(), _fb_run(), Return the free model list (embedded or via proxy)., Execute a FreeBuff task (embedded or via proxy). Shape: {result: {...}}., fixture, Tests for the always-on FreeBuff Telegram bot: embedded vs HTTP dispatch. (+11 more)
...
### Community 329 - "test_north_mini_code.py"
Cohesion: 0.08
...
### Community 331 - "_InMemoryBackend"
Cohesion: 0.11
...
### Community 332 - "TemporalContextGraph"
Cohesion: 0.12
...
### Community 334 - "test_daily_automation_2026_08_03.py"
Cohesion: 0.11
...
### Community 335 - "TestClassifyPlainText"
Cohesion: 0.08
...
### Community 337 - "TestStreamableHTTPTransport"
Cohesion: 0.13
...
### Community 338 - "telegram_service.py"
Cohesion: 0.13
...
### Community 340 - "Local AI Stack with Docker"
Cohesion: 0.08
...
### Community 341 - "Configuration Reference"
Cohesion: 0.08
...
### Community 342 - "Implementation Prompt: Rich TaskBoard + Agile Sprint Integration"
Cohesion: 0.08
...
### Community 343 - "Telegram Bot Setup"
Cohesion: 0.08
...
### Community 344 - "video_transcript.py"
Cohesion: 0.12
...
### Community 348 - "._run_supervised"
Cohesion: 0.13
Nodes (14): Any, Semaphore, Build an agent.coordinator.TaskSpec from a CEO SpecialistTask., Settle the ledger goal once the fan-out has finished. A goal is closed only on…, Run sub-tasks through RuntimeManager so each one is actually routed to the…, Run sub-tasks via RuntimeManager with per-sub-task provider_preference.…, Run one sub-task, judge the result, and escalate it if it is slop. The loop is…, Dispatch one attempt of *st* to its runtime and normalise the result. (+6 more)

### Community 349 - "test_monitor_lib.py"
Cohesion: 0.11
...
### Community 351 - "test_workspace_security.py"
Cohesion: 0.10
...
### Community 357 - "test_all_features.py"
Cohesion: 0.09
...
### Community 359 - "test_mostly_failed_steps.py"
Cohesion: 0.12
...
### Community 360 - ".run_cycle"
Cohesion: 0.15
Nodes (8): AgencyCycleResult, _build_ceo_prompt(), _now_str(), Any, Capture the FastAPI main event loop so the CEO thread can dispatch run_cycle()…, Generate directives for each onboarded company. The CEO examines each company's…, Close exhausted quick-note issues; dispatch Dev directives for open ones., Call the configured provider stack to perform CEO strategic assessment.

### Community 361 - "classify_direct_chat_intent"
Cohesion: 0.13
...
### Community 371 - "PriorityTaskQueue"
Cohesion: 0.13
...
### Community 374 - "V3 API Migration Plan — LLM Relay Platform"
Cohesion: 0.10
...
### Community 375 - "SchedulesPage.js"
Cohesion: 0.13
...
### Community 377 - "test_issue_triage.py"
Cohesion: 0.17
...
### Community 379 - "test_onboarding_provisioning.py"
Cohesion: 0.14
...
### Community 382 - "HarnessEnrichment"
Cohesion: 0.15
...
### Community 384 - "test_permissions.py"
Cohesion: 0.15
...
### Community 385 - "PersistentMemoryStore"
Cohesion: 0.24
...
### Community 387 - "Design Audit"
Cohesion: 0.10
Nodes (19): Code Quality, Color and Surfaces, Component Patterns, Content, Design Audit, Fix Priority, How This Works, Iconography (+11 more)

### Community 388 - "Findings"
Cohesion: 0.10
...
### Community 389 - "TestNormalizeResponseFormat"
Cohesion: 0.10
...
### Community 390 - "Skill: modularity-review"
Cohesion: 0.10
Nodes (19): Acceptance Checks, Applying to This Repo, Further Reading, Modularity Findings Template, Part A: Reviewing Existing Code for Modularity Problems, Part B: Designing New Modular Boundaries, Skill: modularity-review, Step 1 — Map the dependency graph (+11 more)

### Community 391 - "crispy_client.py"
Cohesion: 0.14
Nodes (18): cmd_approve(), cmd_artifacts(), cmd_build(), cmd_events(), cmd_reject(), cmd_status(), cmd_watch(), _get() (+10 more)

### Community 392 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 396 - "._scan_github_repo"
Cohesion: 0.10
...
### Community 397 - "_process_task_callback"
Cohesion: 0.20
...
### Community 398 - "test_brain_patch_service_token.py"
Cohesion: 0.16
...
### Community 399 - "test_tasks_cache_ttl_env.py"
Cohesion: 0.21
...
### Community 400 - "test_workflow_models.py"
Cohesion: 0.13
...
### Community 404 - "_extract_tech_relevance"
Cohesion: 0.17
...
### Community 407 - "Analysis & Synthesis Instructions"
Cohesion: 0.11
Nodes (18): 1. Define the Atmosphere, 2. Map the Color Palette, 3. Establish Typography Rules, 4. Define the Hero Section, 5. Describe Component Stylings, 6. Define Layout Principles, 7. Define Responsive Rules, 8. Encode Motion Philosophy (+10 more)

### Community 408 - "Production Readiness Assessment — local-llm-server"
Cohesion: 0.11
...
### Community 409 - "Skill: fabric-patterns"
Cohesion: 0.11
Nodes (18): 1. Ensure Pattern Directory Exists, 2. List Available Patterns, 3. Retrieve a Pattern, 4. Apply a Pattern with Variables, 5. Stitch Patterns Together, 6. Create New Patterns, Acceptance Checks, Directory Structure (+10 more)
...
### Community 411 - "Admin Dashboard Guide"
Cohesion: 0.11
...
### Community 412 - "Implementation Plan"
Cohesion: 0.11
...
### Community 418 - "Delegation Plan (agent-ready work packages)"
Cohesion: 0.11
...
### Community 421 - "test_company_api.py"
Cohesion: 0.11
...
### Community 422 - "TestSelfHealingInfrastructureClassification"
Cohesion: 0.19
...
### Community 423 - "test_fabric_patterns.py"
Cohesion: 0.11
...
### Community 424 - "test_sam_livekit.py"
Cohesion: 0.11
...
### Community 425 - "test_schedule_persistence.py"
Cohesion: 0.17
...
### Community 428 - "sam_livekit_worker.py"
Cohesion: 0.17
...
### Community 429 - "ErrorInterceptorMiddleware"
Cohesion: 0.18
...
### Community 432 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 433 - "Component Map"
Cohesion: 0.11
...
### Community 434 - "Agent State — colibri GLM-5.2 deployment (resumable)"
Cohesion: 0.11
...
### Community 435 - "Architecture Overview — local-llm-server"
Cohesion: 0.11
...
### Community 436 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
...
### Community 437 - "Platform Guide — the full tour"
Cohesion: 0.11
...
### Community 439 - "Part A — Health Report"
Cohesion: 0.11
...
### Community 442 - "._execute_with_fallback"
Cohesion: 0.16
...
### Community 446 - "test_task_brain_preflight.py"
Cohesion: 0.24
...
### Community 454 - "SKILL: Industrial Brutalism & Tactical Telemetry UI"
Cohesion: 0.12
...
### Community 455 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 456 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 457 - "test_admin_local_brain_router.py"
Cohesion: 0.18
...
### Community 458 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 461 - "kimi_bridge_provider_config"
Cohesion: 0.18
...
### Community 463 - "agent_readiness_audit.py"
Cohesion: 0.21
...
### Community 468 - "test_autonomy_status.py"
Cohesion: 0.12
...
### Community 469 - "test_brain_failover_413.py"
Cohesion: 0.13
...
### Community 470 - "test_health_endpoints.py"
Cohesion: 0.17
...
### Community 471 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 472 - "test_local_brain_state.py"
Cohesion: 0.12
...
### Community 475 - "test_schedule_backlog_drain.py"
Cohesion: 0.15
...
### Community 476 - "test_telegram_diag_endpoint.py"
Cohesion: 0.12
...
### Community 477 - "hermes_prompt.py"
Cohesion: 0.19
...
### Community 478 - "MemoryMiddleware"
Cohesion: 0.17
...
### Community 480 - "Skill: repowise-intelligence"
Cohesion: 0.12
...
### Community 481 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
...
### Community 495 - "ManagedAgentDreams"
Cohesion: 0.22
...
### Community 496 - "e2e/test_browser.py"
Cohesion: 0.21
...
### Community 497 - "DailyDigestAggregatorTests"
Cohesion: 0.19
...
### Community 498 - "test_dockerfile_ships_root_modules.py"
Cohesion: 0.17
...
### Community 499 - "test_frontend_deployment_guards.py"
Cohesion: 0.20
...
### Community 500 - "test_glm52_brain.py"
Cohesion: 0.12
...
### Community 501 - "test_langfuse_agency_wide.py"
Cohesion: 0.12
...
### Community 503 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 504 - "test_task_pre_execution_gate.py"
Cohesion: 0.25
...
### Community 505 - "test_telegram_service_webhook.py"
Cohesion: 0.21
...
### Community 520 - "Attention Mechanisms Internals"
Cohesion: 0.13
...
### Community 524 - "DockerAgentAdapter"
Cohesion: 0.17
...
### Community 525 - "AdminDigestRouterAuthTests"
Cohesion: 0.23
...
### Community 526 - "clear_wizard_state_cache"
Cohesion: 0.21
...
### Community 529 - "DecisionsStoreTests"
Cohesion: 0.13
...
### Community 530 - "test_dockerfile_ships_config_dir.py"
Cohesion: 0.14
...
### Community 532 - "test_openclaw_gateway.py"
Cohesion: 0.13
...
### Community 533 - "test_scanner_live.py"
Cohesion: 0.23
...
### Community 534 - "test_telegram_task_callback.py"
Cohesion: 0.19
...
### Community 538 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 542 - "Checks Performed"
Cohesion: 0.14
...
### Community 543 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 546 - "admin_digest_router.py"
Cohesion: 0.23
...
### Community 547 - "Skill: branch-cleanup"
Cohesion: 0.14
...
### Community 548 - "Skill: perplexity — Web Research via Perplexity API"
Cohesion: 0.14
...
### Community 551 - "Quick-Note Issues Processing Summary"
Cohesion: 0.14
...
### Community 552 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 554 - "Runbook: Auto-Resume After Cooldown / Interruption"
Cohesion: 0.14
...
### Community 555 - "SEO / GEO / AIO Audit Engine"
Cohesion: 0.14
...
### Community 556 - "Traffic Distribution Across Providers"
Cohesion: 0.14
...
### Community 561 - "asyncio"
Cohesion: 0.14
Nodes (7): requires_db, asyncio, Test that storage service can be initialized., Test company CRUD operations - skipped as requires specific config., Test that scanner service can be initialized., Test that specialist service can be initialized., End-to-end against the real Mongo (CI service): the exact handler sequence…

### Community 562 - "_RedisBackend"
Cohesion: 0.22
...
### Community 564 - "test_critical_flows.py"
Cohesion: 0.29
...
### Community 565 - "test_regression.py"
Cohesion: 0.14
...
### Community 566 - "test_autonomy_pipeline_regressions.py"
Cohesion: 0.15
...
### Community 568 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 573 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 576 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 577 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 580 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
...
### Community 581 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 582 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 584 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 585 - "admin_update_task_router.py"
Cohesion: 0.22
...
### Community 588 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
Nodes (12): Acceptance Checks, Claude's query protocol (use this instead of Read tool for exploration):, Graph Artifacts — What to Commit, How to Use the Graph (Token Savings Protocol), Installation (one-time per machine), Instead of reading raw files:, Key commands:, Relationship to repowise-intelligence Skill (+4 more)

### Community 589 - "Skill: platform-setup — Autonomous Agency Bootstrap"
Cohesion: 0.15
...
### Community 590 - "Workspace Isolation Architecture"
Cohesion: 0.15
...
### Community 591 - "Device compatibility and model picks"
Cohesion: 0.15
...
### Community 592 - "Autonomy Uplift — Living Roadmap & Detailed Implementation Specs"
Cohesion: 0.15
...
### Community 593 - "OpenClaw — iOS Control of the Agency (Single-Service Free-Tier Deploy)"
Cohesion: 0.15
...
### Community 596 - "Agent Transparency Report"
Cohesion: 0.15
...
### Community 597 - "update_provider_policy"
Cohesion: 0.19
...
### Community 599 - ".get_specialists_by_family"
Cohesion: 0.15
...
### Community 603 - "TestDecisionsBotLinks"
Cohesion: 0.21
...
### Community 604 - "test_deploy_trigger_covers_image.py"
Cohesion: 0.21
...
### Community 609 - "WorkspaceManifest"
Cohesion: 0.17
...
### Community 611 - "skill_registry.py"
Cohesion: 0.17
...
### Community 617 - "Skill: system-prompt-audit"
Cohesion: 0.17
...
### Community 618 - "Skill: task-alive-updates"
Cohesion: 0.17
...
### Community 622 - "_ensure_tasks_source_id_unique_index"
Cohesion: 0.26
...
### Community 624 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 627 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 629 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 630 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 631 - "Quantization Internals"
Cohesion: 0.17
...
### Community 632 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 633 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 634 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 635 - "Render MCP — autonomous platform debugging and environment monitoring"
Cohesion: 0.17
...
### Community 637 - "test_p0_roadmap_a4_a5_b2.py"
Cohesion: 0.26
...
### Community 638 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 640 - "test_skill_registry.py"
Cohesion: 0.20
...
### Community 641 - "TestAnthropicPayloadStructuredOutput"
Cohesion: 0.29
...
### Community 642 - "validate_job_id"
Cohesion: 0.18
Nodes (4): parametrize, TestPathTraversalPrevention, Validate and return a job ID, or raise InvalidJobIdError., validate_job_id()

### Community 643 - "config_store.py"
Cohesion: 0.30
Nodes (7): _atomic_write_json(), default_store_paths(), get_data_dir(), JsonStorePaths, _now(), Any, Path
...
### Community 646 - "_extractive_compress"
Cohesion: 0.18
...
### Community 648 - "cowork_session.py"
Cohesion: 0.24
...
### Community 650 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 653 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 654 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 656 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 659 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 660 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 661 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 662 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 663 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 664 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 665 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 666 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 668 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 669 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 670 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 671 - "CI Troubleshooting Runbook"
Cohesion: 0.18
...
### Community 672 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 673 - "What to clean up"
Cohesion: 0.18
...
### Community 674 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 675 - "test_bedrock_live.py"
Cohesion: 0.25
...
### Community 678 - ".get_company_graph"
Cohesion: 0.20
Nodes (6): Workflow, Get the company graph for a company. Args: company_id: Company ID…, Compute the completeness score (0.0–1.0) for a company's graph. Loads the graph…, Update a company graph. Args: graph: CompanyGraph instance to update Returns:…, Calculate the completeness score for a company graph. Args: graph: CompanyGraph…, Add a workflow to a company's graph. Args: company_id: Company ID name: Name of…
...
### Community 681 - "_FakeCommandResult"
Cohesion: 0.22
Nodes (3): _FakeCommandResult, _FakeCommands, _FakeFiles

### Community 682 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 683 - "test_event_log.py"
Cohesion: 0.45
...
### Community 684 - "test_google_provider_models.py"
Cohesion: 0.18
...
### Community 685 - "get_livekit_config"
Cohesion: 0.18
...
### Community 688 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 689 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 701 - "LLM Router — configuration guide"
Cohesion: 0.20
...
### Community 702 - "LLM Router — provider guide"
Cohesion: 0.20
...
### Community 706 - "local_brain_provider_config"
Cohesion: 0.29
...
### Community 707 - "TestModelsEndpointAliases"
Cohesion: 0.31
...
### Community 717 - "test_provider_state_durability.py"
Cohesion: 0.20
...
### Community 718 - "test_quick_note_engine.py"
Cohesion: 0.22
...
### Community 719 - "_FakePersistence"
Cohesion: 0.20
...
### Community 725 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 727 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 728 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 730 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
Nodes (8): Branch, Components, Purpose, Quick Start, Session Roles, Skill: cowork-session (Claude Cowork), Testing, When to Use

### Community 731 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 733 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 734 - "Main proxy (`proxy.py`)"
Cohesion: 0.22
...
### Community 735 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 736 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 737 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 738 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 739 - "Release Procedure"
Cohesion: 0.22
...
### Community 740 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 749 - "cleanup_stale_jobs"
Cohesion: 0.31
...
### Community 750 - "enrich_quick_note_issues.py"
Cohesion: 0.42
...
### Community 751 - "_status_snapshot"
Cohesion: 0.31
...
### Community 752 - ".on_task_complete"
Cohesion: 0.25
...
### Community 756 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 763 - "TestGithubSignalHardening"
Cohesion: 0.22
...
### Community 770 - "TestRevenuePortfolio"
Cohesion: 0.22
...
### Community 778 - "ContributorState"
Cohesion: 0.25
...
### Community 779 - "quality_checker.py"
Cohesion: 0.32
...
### Community 781 - "TestParseToolCalls"
Cohesion: 0.39
...
### Community 789 - "GitHub Branch Protection Settings"
Cohesion: 0.25
...
### Community 793 - "AGENTS.md — AI Agent Configuration for local-llm-server"
Cohesion: 0.25
...
### Community 794 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 795 - "ceo-micromanagement.md"
Cohesion: 0.25
Nodes (4): P0 behavior change, Readiness contract, Runtime model, Runtime types

### Community 796 - "Feature Maturity / Support Matrix"
Cohesion: 0.25
...
### Community 799 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.25
...
### Community 800 - "Issue #362: Nvidia repo setup"
Cohesion: 0.25
...
### Community 801 - "Issue #364: quick-note:https://www.marktechpost.com/2026/06/01/meet-memory-os-a-6-layer-open-source-memory-stack-built-on-top-of-hermes-agent/"
Cohesion: 0.25
...
### Community 802 - "Issue #378: quick-note:https://www.marktechpost.com/2026/06/02/tinyfish-launches-bigset-an-open-source-multi-agent-system-that-builds-structured-live-datasets-from-plain-english-descriptions/"
Cohesion: 0.25
...
### Community 803 - "Issue #379: quick-note:https://searchengineland.com/schema-markup-optimize-agentic-web-479080"
Cohesion: 0.25
...
### Community 804 - "Issue #380: quick-note:https://cursor.com/blog/cloud-agent-lessons"
Cohesion: 0.25
...
### Community 805 - "Issue #381: quick-note:https://www.xda-developers.com/claude-code-with-opus-48-is-expensive-but-i-made-it-efficient-with-my-local-ai-workflow/"
Cohesion: 0.25
...
### Community 806 - "Issue #382: quick-note:https://claude.com/blog/how-coderabbit-used-claude-to-build-an-agent-orchestration-system"
Cohesion: 0.25
...
### Community 807 - "Issue #383: quick-note:https://www.marktechpost.com/2026/05/29/hexo-labs-open-sources-sia-a-self-improving-agent-that-updates-both-the-harness-and-the-model-weights/"
Cohesion: 0.25
...
### Community 808 - "Issue #416: feat: Self-hosted Codebuff (freebuff) on free NVIDIA models + Telegram bot phone control"
Cohesion: 0.25
...
### Community 809 - "Issue #485: [Trend Digest] Week of 2026-06-08"
Cohesion: 0.25
...
### Community 810 - "Issue #488: quick-note:https://github.com/cookiy-ai/user-research-skill"
Cohesion: 0.25
...
### Community 811 - "Issue #491: Implement whatever is necessary from https://github.com/BehiSecc/awesome-claude-skills"
Cohesion: 0.25
...
### Community 812 - "Issue #493: Use the https://github.com/mvanhorn/last30days-skill skill to get the trend updated"
Cohesion: 0.25
...
### Community 813 - "Issue #495: Read https://www.anthropic.com/news/claude-fable-5-mythos-5 and understand if mythos or fable can be added to the repo"
Cohesion: 0.25
...
### Community 814 - "Issue #504: EPIC: Autonomy hardening — live-verified defects 2026-06-10"
Cohesion: 0.25
...
### Community 815 - "Issue #581: Sprint tracker: pending work after brand rename + mobile-first pass"
Cohesion: 0.25
...
### Community 817 - "Issue #657: quick-note:https://github.com/earendil-works/pi"
Cohesion: 0.25
...
### Community 818 - "Issue #659: quick-note:https://github.com/nex-agi/Nex-N2"
Cohesion: 0.25
...
### Community 819 - "Issue #660: quick-note:https://github.com/getsentry/sentry-for-ai"
Cohesion: 0.25
...
### Community 820 - "Issue #661: quick-note:https://github.com/XiaomiMiMo/MiMo-Code"
Cohesion: 0.25
...
### Community 821 - "Issue #664: quick-note:https://github.com/Grominet95/jarvis-OS"
Cohesion: 0.25
...
### Community 822 - "Issue #666: quick-note:https://github.com/porokka/jarvis-os"
Cohesion: 0.25
...
### Community 823 - "Issue #670: quick-note:https://github.com/perplexityai/bumblebee"
Cohesion: 0.25
...
### Community 824 - "Issue #672: quick-note:https://github.com/Chachamaru127/claude-code-harness"
Cohesion: 0.25
...
### Community 825 - "Issue #676: quick-note:https://github.com/WeiboAI/VibeThinker"
Cohesion: 0.25
...
### Community 826 - "Issue #820: quick-note:https://github.com/cobusgreyling/loop-engineering"
Cohesion: 0.25
...
### Community 827 - "Positional Encoding Internals"
Cohesion: 0.25
...
### Community 829 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 830 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 831 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 832 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 835 - "_get_current_user"
Cohesion: 0.29
...
### Community 838 - "capture_screens.py"
Cohesion: 0.39
...
### Community 841 - "crispy_burn_in.py"
Cohesion: 0.36
...
### Community 842 - "run_patched_colibri.py"
Cohesion: 0.36
...
### Community 845 - "test_compose_and_coordinate_api.py"
Cohesion: 0.36
...
### Community 847 - "TestProviderRouter"
Cohesion: 0.25
...
### Community 848 - "test_local_brain_router_smoke.py"
Cohesion: 0.25
...
### Community 850 - "test_provider_models_db_outage.py"
Cohesion: 0.25
...
### Community 854 - "test_seo_audit_pending_expiry.py"
Cohesion: 0.43
...
### Community 856 - "test_serve_spa_prefixes.py"
Cohesion: 0.36
...
### Community 858 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 859 - ".discover_directory"
Cohesion: 0.29
...
### Community 866 - "AI Engineering Insights Skill"
Cohesion: 0.29
...
### Community 876 - "ADR-006: Strangler Fig migration with backward-compat shims"
Cohesion: 0.29
Nodes (6): ADR-006: Strangler Fig migration with backward-compat shims, Consequences, Context, Decision, Examples, Migration path

### Community 877 - "claude-mem Plugin — Persistent Memory for All Sessions"
Cohesion: 0.29
...
### Community 878 - "Implementation plan + TO-DO (check off as you go)"
Cohesion: 0.29
...
### Community 889 - "check_changelog_parity.py"
Cohesion: 0.43
...
### Community 890 - "e2e_smoke.py"
Cohesion: 0.57
Nodes (5): _chat(), check(), _health(), _models(), _req()

### Community 891 - "BackgroundServices"
Cohesion: 0.38
...
### Community 894 - "test_daily_2026_06_14.py"
Cohesion: 0.38
...
### Community 895 - "TestSupportMatrixDocsSync"
Cohesion: 0.29
...
### Community 896 - "TestGithubTokenSQLiteRegression"
Cohesion: 0.38
...
### Community 898 - "test_log_monitor_storm_guard.py"
Cohesion: 0.48
...
### Community 903 - "openclaw_mobile_ui"
Cohesion: 0.33
...
### Community 918 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 919 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 920 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 921 - "The full agent capability roster"
Cohesion: 0.33
...
### Community 922 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 923 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 924 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 931 - "apply_phase1_changes.py"
Cohesion: 0.33
...
### Community 944 - "_normalize_dockerfile"
Cohesion: 0.33
...
### Community 974 - "Prompt Library Changelog"
Cohesion: 0.40
...
### Community 978 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 979 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 980 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 981 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 982 - "setup_colibri.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 983 - "setup_colibri.sh script"
Cohesion: 0.70
Nodes (4): setup_colibri.sh script, fail(), ok(), warn()

### Community 984 - "status_colibri_server.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 986 - "TestMobileNavigation"
Cohesion: 0.40
Nodes (3): Mobile-specific: hamburger menu, responsive layout., Verify key pages load in mobile viewport., TestMobileNavigation

### Community 987 - "test_v5_screens_smoke.py"
Cohesion: 0.50
...
### Community 988 - "test_agent_runtime_wrapper.py"
Cohesion: 0.70
...
### Community 989 - "patched_agent_runner"
Cohesion: 0.40
Nodes (5): _clean_e2b_env(), patched_agent_runner(), patched_async_sandbox(), fixture, Patch AgentRunner inside runtimes.adapters.e2b so execute() can run without…

### Community 991 - "worker/index.js"
Cohesion: 0.70
...
### Community 1021 - "test_no_exception_detail_leaks.py"
Cohesion: 0.50
...
### Community 1022 - "test_skills_route_order.py"
Cohesion: 0.67
...
### Community 1023 - "_inline_threads"
Cohesion: 0.50
...
### Community 1057 - "test_direct_adapter_does_not_bypass"
Cohesion: 0.67
...
### Community 1058 - "test_mint_token_rejects_missing_args"
Cohesion: 0.67
...
- **Why does `AgentRunner` connect `AgentRunner` to `ExecutionRequest`, `backend/server.py`, `AgentScheduler`, `FreeBuffAgent`, `proxy.py`, `AgentSessionStore`, `TaskSpec`, `MCPUnavailableError`, `PortfolioManager`, `test_ceo_supervision.py`, `test_agent_free_brain.py`, `E2BSandboxSession`, `failover_chat_completion`, `test_empirical_verify.py`, `LocalWorkspace`, `AutonomyTracker`, `ceo_dispatcher.py`, `MultiAgentSwarm`, `KeyPool`, `RewardScorer`, `WorkspaceTools`, `ContextPruner`, `TokenBudget`, `TestZeroAttemptDiagnostics`, `MCPClient`, `.execute`, `GitHubTools`, `test_brain_failover_413.py`, `Workspace`, `test_backend_server_features.py`, `AdaptiveHalter`, `ContextManager`, `ReactScratchpad`, `TestMCPServer`, `_StubManager`, `StuckDetector`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `AgentSessionStore` connect `AgentSessionStore` to `ExecutionRequest`, `backend/server.py`, `AgentScheduler`, `FreeBuffAgent`, `AgentRunner`, `test_memory.py`, `proxy.py`, `IssueCategory`, `FeatureMaturity`, `test_event_log.py`, `diagnostics.py`, `job_manager.py`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `AgentScheduler` connect `AgentScheduler` to `backend/server.py`, `FreeBuffAgent`, `proxy.py`, `test_schedule_growth_invariants.py`, `Any`, `services/background.py`, `TaskWorkflowService`, `test_schedule_persistence.py`, `_FakePersistence`, `test_autonomy_pipeline_regressions.py`, `SchedulerStore`, `TestSchedulerStore`, `get_scheduler`, `get_task_store`, `_FakePersistence`, `test_schedule_backlog_drain.py`, `ScheduledJob`, `BackgroundServices`, `test_purge_backlog.py`?**
