...
## Communities (1300 total, 118 thin omitted)

### Community 0 - "backend/server.py"
Cohesion: 0.02
Nodes (231): _agent_provider_failure_response(), _agent_timeout_fallback_response(), AgentStatusEntry, AgentStatusResponse, AgentToolCallEntry, ApiKeyCreate, _append_agent_session_message(), auth_me() (+223 more)

### Community 1 - "LLMRequest"
Cohesion: 0.02
Nodes (143): ProviderConfig, One configured endpoint. ``kind`` selects the adapter: ``openai`` (any OpenAI-…, packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, LLMProvider, OpenAICompatible, ABC, Any, AsyncClient (+135 more)

### Community 2 - "company_api.py"
Cohesion: 0.02
Nodes (173): ephemeral_ttl_hours(), Async read of the ephemeral TTL (hours) straight from the DB., account_lifecycle(), AccountLifecycleResponse, auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint() (+165 more)

### Community 3 - "proxy.py"
Cohesion: 0.03
Nodes (161): Describes a single worker's task and constraints., WorkerSpec, AgentRunRequest, middleware, admin_control(), admin_login(), admin_logout(), admin_status() (+153 more)

### Community 4 - "TaskSpec"
Cohesion: 0.04
Nodes (94): kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, AiderAdapter, Any, TaskResult, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Run aider non-interactively via `--message` flag., Adapter for Aider — TIER 3 specialized git-aware code editor. (+86 more)

### Community 5 - "llm/router.py"
Cohesion: 0.03
Nodes (120): _load(), main(), Scheduled portfolio intelligence sweep. Run by `.github/workflows/portfolio-…, int, FailoverResult, A successful completion plus the accounting its callers need., get_budget(), The process-wide budget tracker. (+112 more)

### Community 6 - "test_llm_router_queue_cache.py"
Cohesion: 0.02
Nodes (113): Test hook — clear all usage accounting., reset(), CacheManager, cosine_similarity(), _Entry, LRUCache, payload_key(), Any (+105 more)
...
### Community 8 - "SpecialistService"
Cohesion: 0.03
Nodes (66): Result of a website scan with detected systems and stack inference., Inferred technology stack from website/repo analysis., StackInference, WebsiteScanResult, OnboardingService, Workflow, Detect the Git provider from a repository URL. Args: repo_url: Repository URL…, Start the onboarding process for a company. Args: company_id: Company ID… (+58 more)
...
### Community 11 - "AgentJobManager"
Cohesion: 0.02
Nodes (84): PreflightIssue, PreflightReport, BaseModel, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, AgentJob, AgentJobManager, heartbeat(), make_isolated_workspace() (+76 more)

### Community 12 - "test_operational_incidents.py"
Cohesion: 0.02
Nodes (129): _diagnose_and_file(), _file_incident(), _format_incident(), gather_render_evidence(), get_operational_incident_tracker(), _iso_from_monotonic(), normalise(), note_phase_end() (+121 more)

### Community 13 - "TaskWorkflowService"
Cohesion: 0.04
Nodes (60): AgentDefinition, AgentStore, Any, field_validator, CRUD store for AgentDefinition objects. Uses MongoDB when a `db` client is…, Return an agent by ID. If *owner_id* is provided, enforces that the agent…, Delete an agent. Returns True on success, False if not found/unauthorised., Return all agents owned by *owner_id*, optionally including public agents. (+52 more)

### Community 14 - "ExecutionRequest"
Cohesion: 0.02
Nodes (147): get_ceo_dispatcher(), Return the shared CEODispatcher singleton., Reset the singleton (test helper)., reset_ceo_dispatcher(), BoundContext, ClassifyOutput, ExecutionRequest, ExecutionResult (+139 more)

### Community 15 - "test_governance_sandbox.py"
Cohesion: 0.04
Nodes (74): build_docker_run_argv(), detect_backend(), DockerBackend, E2BBackend, load_profiles(), LocalBackend, Any, Path (+66 more)

### Community 16 - "AgentRunner"
Cohesion: 0.03
Nodes (64): AgentRunner, Any, Path, Governance seam: judge the call, run it, audit the outcome. Deliberately a thin…, Append an event to the durable session log if a store is wired in., Summarise a long history and compact it. Asks the planner model to write a…, Send chat messages and return the assistant's text output. If an…, Call-time resolver for an agent role model id. Delegates to… (+56 more)

### Community 17 - "SelfHealingAgent"
Cohesion: 0.03
Nodes (81): FailureCategory, heal_signature(), HealingEvent, HealState, _now(), Any, Enum, str (+73 more)

### Community 18 - "agents/api.py"
Cohesion: 0.13
...
### Community 19 - "PolicyEngine"
Cohesion: 0.04
Nodes (84): _egress_policy_reason(), Return why governance policy blocks *host*, or None. Runs strictly *after* the…, _action_matches(), _as_list(), Decision, GroupPolicy, _host_matches(), Mode (+76 more)
...
### Community 21 - "test_e2b_task_wiring.py"
Cohesion: 0.07
...
### Community 22 - "BackgroundAgent"
Cohesion: 0.06
Nodes (43): BackgroundAgent, heartbeat(), BackgroundTask, _now(), Any, agent/background.py — Background Agent An always-on worker thread that…, Enqueue *task* for processing. Returns the task (with task_id set)., Convenience: create a task and submit it in one call. (+35 more)
...
### Community 26 - "loop.py"
Cohesion: 0.03
Nodes (73): get_enrichment(), agent/harness_enrichment.py — Automatic Harness Enrichment for Agent Prompts…, Return the enrichment instance for a workspace. Keyed by workspace root rather…, Agent subsystem — planner / executor / verifier loop., _check_extra_kwargs(), _enforce_signature(), loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., Raise TypeError if fn's signature drifts from the locked contract (Pydantic… (+65 more)

### Community 27 - "E2BSandboxSession"
Cohesion: 0.04
...
### Community 28 - "test_unit8_model_catalog.py"
Cohesion: 0.03
Nodes (82): _brain_provider_status(), get_catalog_models_route(), Return the mirrored model catalog (advisory-only). Flag-gated by…, Force a catalog mirror rebuild + persist (admin only). Rebuilds the catalog…, Return per-provider metadata for the GET endpoint. Iterates every provider in…, sync_catalog_route(), all_provider_ids(), _provider_ids_from_literal() (+74 more)

### Community 29 - "config.py"
Cohesion: 0.04
Nodes (76): AgentPolicy, _apply_env_overrides(), _apply_key_env(), _build(), _coerce(), config_dir(), _env_key_names(), expand_env() (+68 more)

### Community 30 - "resolve_active_brain"
Cohesion: 0.05
Nodes (61): BrainResolution, get_active_brain_sync(), get_provider_role_tags(), _host_is_openai_compatible(), _norm(), _pick_from_records(), _build(), _prio() (+53 more)

### Community 31 - "test_user_research_skill.py"
Cohesion: 0.05
Nodes (46): analyze_quantitative(), _classify_sentiment(), _extract_keywords(), plan_research(), Any, BaseModel, field_validator, QualQuote (+38 more)
...
### Community 33 - "clear_cooldowns"
Cohesion: 0.07
Nodes (34): clear_cooldowns(), get_dead_models(), is_provider_on_cooldown(), mark_provider_failed(), Snapshot of active dead-model entries {provider_id/model: expiry_ts}. Also…, Put provider_id on cooldown for *cooldown_seconds* (default:…, Return True if provider_id is currently on cooldown., Clear all cooldown entries (useful for testing). Delegates to… (+26 more)
...
### Community 36 - "audit"
Cohesion: 0.05
Nodes (39): audit(), get_audit_log(), get_user_role(), has_permission(), is_admin(), is_power_user_or_above(), mask_dict(), _mask() (+31 more)

### Community 37 - "Task"
Cohesion: 0.03
Nodes (82): Full task/issue document., Task, _gate_outward_facing_enabled(), _is_brain_connection_error(), _is_outward_facing(), Any, BaseException, TaskSpec (+74 more)

### Community 38 - "test_llm_router_resilience.py"
Cohesion: 0.03
Nodes (72): Backoff policy for retryable failures., RetryConfig, BreakerState, Enum, str, packages/llm/health.py — provider health tracking and circuit breaking. Two…, Test hook — clear all health state., reset() (+64 more)

### Community 39 - "SQLiteStore"
Cohesion: 0.02
Nodes (102): KnowledgeItem, Find a repository by its URL., Find knowledge items matching any of the given tags., Structured knowledge about the company, systems, or processes., A company repository with detected technologies and metadata., Extract the owner from the full name., Extract the repository name from the full name., Repo (+94 more)

### Community 40 - "get_workflow_orchestrator"
Cohesion: 0.04
Nodes (41): Called by APScheduler when a cron fires. Dispatches to the orchestrator. This…, _scheduler_on_fire(), OrchestratorSupervisor, Any, Emit an alert to the activity feed and log., Deterministic supervisor for the orchestrator. Runs as a background coroutine.…, stop_orchestrator_supervisor(), get_workflow_orchestrator() (+33 more)

### Community 41 - "Specialist"
Cohesion: 0.05
Nodes (26): SpecialistFamily, Find all specialists of a specific family., Find specialists that can handle a task with given capabilities., A specialist agent that can be provisioned for company-specific tasks., Check if this specialist can handle a task with given capabilities., Specialist, SpecialistFamily, SystemType (+18 more)
...
### Community 43 - "services/seo_audit.py"
Cohesion: 0.05
...
### Community 44 - "test_ephemeral_reaper.py"
Cohesion: 0.11
...
### Community 45 - "test_orchestrator_merge_decision.py"
Cohesion: 0.22
...
Cohesion: 0.03
Nodes (30): requires_db, CompanyGraphStore, Delete a company and all its associated data., List companies with optional filtering., Count total companies in the store., Create a new company graph., Get the complete company graph for a company., Update a company graph. (+22 more)
...
### Community 51 - "get_registry"
Cohesion: 0.05
Nodes (32): get_registry(), Return model registry, extended with ROUTER_EXTRA_MODELS env entries.…, Daily automation tests — 2026-08-16. Covers three improvements landed this…, Stub out modules that require full stack deps to allow unit-testing pure logic.…, claude-opus-5 must be in the built-in alias map so routing resolves it., _stub_heavy_imports(), TestClaude5RegistryEntries, test_bedrock_haiku_4_5_in_registry() (+24 more)
...
### Community 53 - "WebsiteScanner"
Cohesion: 0.03
Nodes (83): DetectedSystem, Evidence, Evidence supporting a system detection., A business system detected on a company's website or in their stack., Get the most confident evidence description., main(), Post-deploy verification for the website scanner against the LIVE internet.…, Returns (url, ok, summary). (+75 more)
...
Cohesion: 0.03
Nodes (98): _enrich_runtimes(), get_decision_log(), get_policy(), get_runtime(), list_runtimes(), _load_rich_policy(), PolicyUpdateBody, Any (+90 more)

### Community 56 - "test_loop_registry.py"
Cohesion: 0.09
Nodes (45): audit_drift(), _cmd_audit(), DriftReport, _grade(), load_registry(), load_registry_sync(), loop_readiness(), LoopRegistry (+37 more)

### Community 57 - "AnthropicProvider"
Cohesion: 0.05
...
### Community 58 - "RuntimeCapabilityRegistry"
Cohesion: 0.04
Nodes (38): Raised when a runtime fails readiness validation before execution starts., RuntimePreflightError, Return the single best adapter for *task_type*. If *preferred_runtime_id* is…, Maintains the catalogue of registered adapters and answers 'which runtimes can…, Return all adapters that can handle *task_type*, ordered by tier., RuntimeCapabilityRegistry, _audit_dispatch(), _blocked_result() (+30 more)

### Community 59 - "_is_ephemeral_user"
Cohesion: 0.27
...
Cohesion: 0.04
Nodes (40): CerebrasProvider, Cerebras provider adapter — free, fast LLM (qwen-3-coder-480b)., GroqProvider, Groq provider adapter — free, fast LLM (deepseek-r1-distill-llama-70b)., NvidiaProvider, NVIDIA NIM provider adapter — wraps the existing provider_router logic. This is…, NVIDIA NIM — free LLM provider (meta/llama-3.3-70b-instruct)., OllamaProvider (+32 more)
...
### Community 65 - "validate_outbound_url"
Cohesion: 0.14
...
### Community 67 - "activation_api.py"
Cohesion: 0.08
...
### Community 68 - "test_web_reach.py"
Cohesion: 0.05
...
### Community 69 - "test_phase6_workflow.py"
Cohesion: 0.13
...
### Community 72 - "test_agent_tool_governance.py"
Cohesion: 0.07
...
Cohesion: 0.04
Nodes (55): _acquire_provider_probe(), extract_openai_text(), _normalize_nvidia_base_url(), _openai_url(), Try to acquire a distributed probe lock for *provider_id*. Returns True if this…, Release the probe lock for *provider_id*., Normalize NVIDIA base URLs to avoid double /v1 when openai_compat_url appends…, _release_provider_probe() (+47 more)

### Community 77 - "setup/api.py"
Cohesion: 0.05
Nodes (75): is_user_onboarding_allowed(), Return True if this user may run the onboarding wizard. Resolution order: 1. If…, clear_wizard_state_cache(), complete_wizard(), _delete_wizard_state(), detect_configured_providers(), detect_hardware_for_wizard(), detect_models_for_wizard() (+67 more)

### Community 78 - "enforcement.py"
Cohesion: 0.05
Nodes (43): BudgetExceeded, classify(), evaluate_call(), guard_tool_call(), GuardResult, _host_of(), _is_write_tool(), _more_restrictive() (+35 more)

### Community 79 - "test_startup_warmup.py"
Cohesion: 0.04
...
### Community 82 - "test_sam_voice.py"
Cohesion: 0.06
...
### Community 83 - "Artifact"
Cohesion: 0.07
Nodes (37): AgentRole, Run a pre-gate or report phase through the correct agent. Enforces permission…, Execute a slice via the Coder agent (write-permitted)., Review a slice via the Reviewer agent (different model from Coder). This is the…, Return a copy of *routing* with the profile's model injected for its role., When coder == reviewer model, swarm should log a warning., tests/test_workflow_models.py — Unit tests for workflow/models.py., TestCheckRun (+29 more)

### Community 84 - "AgentSwarm"
Cohesion: 0.06
Nodes (38): agents/__init__.py — CRISPY multi-agent coding system., AgentProfile, _catalog_defaults(), _catalog_provider(), _get_defaults(), load_all_profiles(), make_architect_profile(), make_coder_profile() (+30 more)

### Community 85 - "ResearchTask"
Cohesion: 0.06
...
### Community 91 - "test_governance_enforcement.py"
Cohesion: 0.04
...
Cohesion: 0.10
Nodes (45): _governance_check(), Evaluate a runtime dispatch against policy; audit it either way. Returns…, _decision(), _engine(), Any, RoutingDecision, TaskResult, TaskSpec (+37 more)

### Community 95 - "CEODispatcher"
Cohesion: 0.04
Nodes (68): CEODispatcher, CEOResult, _complexity_rank(), _decompose_into_subtasks(), _merge_changed_files(), _offload(), Any, Semaphore (+60 more)
...
### Community 97 - "test_knowledge_sync.py"
Cohesion: 0.07
...
### Community 100 - "LLMRouter"
Cohesion: 0.05
Nodes (37): Attempt, auto_disable(), describe(), disabled_provider_ids(), packages/llm/disabled.py — bridge to the durable provider on/off switch. The…, Provider ids currently switched off. Empty when the store is unreachable., Persist a provider as disabled, through the store that already owns it., The operator-facing reason string for an unfixable status. (+29 more)

### Community 101 - "run_task"
Cohesion: 0.05
...
### Community 103 - "test_governance_api.py"
Cohesion: 0.10
...
Cohesion: 0.06
Nodes (68): get_decisions_store(), Process-wide DecisionsStore singleton (resettable via db_path arg)., Return a Markdown-v1-safe preview string under ``max_chars``. Used by the…, sanitize_paste_for_preview(), _admin_headers(), _answer_callback(), _api_headers(), _check_rate_limit() (+60 more)

### Community 105 - "FeatureMatrix"
Cohesion: 0.05
...
### Community 106 - "models/seo_audit.py"
Cohesion: 0.11
...
### Community 108 - "seo_portfolio_bridge.py"
Cohesion: 0.06
Nodes (44): CapacityAllocation, Enum, Agentic Portfolio Management — initiative prioritisation, capacity allocation,…, Result of fitting initiatives into a fixed capacity by WSJF priority., Total job size of initiatives that fit within capacity., Unused capacity after committing the selected initiatives., Fraction of capacity consumed (0.0–1.0)., Roadmap placement for an initiative (Now/Next/Later planning). (+36 more)

### Community 109 - "ProvidersScreen.jsx"
Cohesion: 0.04
...
### Community 111 - "resolve_e2b_config"
Cohesion: 0.05
...
### Community 113 - "test_trend_watcher.py"
Cohesion: 0.06
...
### Community 117 - "ToolRegistry"
Cohesion: 0.05
Nodes (28): _infer_parameters_from_func(), Any, Path, Register a tool definition., Decorator to register a function as an agent tool. Usage::…, Remove a tool from the registry. Returns True if removed., Look up a tool by name., Return all registered tools. (+20 more)

### Community 118 - "ensure_self_company"
Cohesion: 0.03
Nodes (63): autonomy_status(), Public autonomy readiness probe — no authentication required. A live deploy…, Fire-and-forget self-bootstrap; never blocks or crashes startup., _schedule_self_bootstrap(), CompanyAgencyService, get_company_agency_service(), _is_runtime_available_sync(), _pick_available_runtime() (+55 more)

### Community 119 - "test_sam_livekit.py"
Cohesion: 0.06
Nodes (33): auth_headers(), livekit_env(), no_livekit_env(), tests/test_sam_livekit.py — SAM realtime voice (LiveKit) integration. Covers: -…, SAM_LLM_* env vars must override the NVIDIA defaults (Hermes/proxy routing)., Under TESTING the in-process worker must never be eligible to start., OPT-IN: defaulting to on OOM-killed the 512MB Render instance at boot…, start_in_process must be a safe no-op in the test environment (conftest sets… (+25 more)

### Community 120 - "Company"
Cohesion: 0.05
...
### Community 127 - "ProviderConfig"
Cohesion: 0.04
Nodes (70): Record token usage for *model* (fire-and-forget, never raises). ``tag`` is a…, record_usage(), _dead_model_key(), _exponential_backoff_cooldown(), _get_director(), is_commercial_provider(), _is_model_dead(), _mark_model_dead() (+62 more)

### Community 128 - "register_webui"
Cohesion: 0.10
Nodes (29): allow_paid_brain(), get_brain_preference(), True only when the operator explicitly opted into a paid (Anthropic) brain.…, Return the operator's brain provider preference. Values: - ``"nvidia"`` —…, Operator can set BRAIN_PREFERENCE=colibri without it being rejected., test_get_brain_preference_accepts_colibri(), _admin_out(), register_webui() (+21 more)
...
### Community 130 - "pr_approval_gate.py"
Cohesion: 0.06
...
Cohesion: 0.06
Nodes (45): generate_backlog_retro(), generate_standup(), Derive a retrospective from the task tracker when no sprint is active. DONE /…, Build a :class:`StandupReport` from ``.claude/state/active-tasks.md``. Reads…, InitiativeStatus, _bug_scores(), _clean(), _default_repo() (+37 more)
...
### Community 148 - "test_trend_scoping.py"
Cohesion: 0.08
Nodes (50): _run(), Issue title: the failure mode plus how hard it is recurring., _company_attr(), company_stack_tags(), extract_stack_tags(), fan_out_trend(), fan_out_trends(), is_code_change_trend() (+42 more)

### Community 149 - "V5App.jsx"
Cohesion: 0.06
Nodes (32): API, getActivity(), HubTabs(), Spinner(), ActivationGate(), activityToAlert(), AlertsBell(), priorityConfig (+24 more)

### Community 150 - "TestHarnessAdapter"
Cohesion: 0.05
...
### Community 153 - "test_kimi_bridge_server.py"
Cohesion: 0.05
...
### Community 155 - "test_sqlite_store.py"
Cohesion: 0.06
...
### Community 157 - ".update_intelligence"
Cohesion: 0.11
...
### Community 158 - "failover_client.py"
Cohesion: 0.05
Nodes (51): _auto_disable(), _describe_registry(), _disable_unless_key_serves_other_models(), _disabled_ids(), _is_billing_refusal(), _is_ollama(), _key_pool(), _log_exhaustion() (+43 more)

### Community 159 - "AgentScheduler"
Cohesion: 0.06
...
### Community 160 - "ChatHistoryStore"
Cohesion: 0.07
...
### Community 162 - "test_p0_roadmap_b1_c2_a3.py"
Cohesion: 0.07
Nodes (21): _inject_tool_results_as_messages(), Inject tool call results as follow-up messages for multi-turn execution. When…, _nvidia_api_key(), BaseModel, Score a response against a prompt using the Nemotron reward model. Returns a…, Call the NVIDIA NIM reward endpoint and return the score. The Nemotron reward…, Parse the reward score from the model's JSON response., Result of a single reward model scoring operation. (+13 more)

### Community 163 - "FreeBuffAgent"
Cohesion: 0.07
...
### Community 166 - "TestAdapterMetadata"
Cohesion: 0.05
...
### Community 167 - "test_webui_provider_priority.py"
Cohesion: 0.15
...
### Community 170 - "test_failover_silent_exhaustion.py"
Cohesion: 0.06
...
### Community 171 - "test_ceo_router.py"
Cohesion: 0.05
Nodes (46): Attempt, _backend(), CEOLedger, GoalRecord, _now(), Any, services/ceo_ledger.py — durable record of what the CEO is driving to closure.…, One delegation of one subtask to one tier. (+38 more)

### Community 172 - "mcp_registry.py"
Cohesion: 0.10
...
### Community 173 - "test_slop_gate.py"
Cohesion: 0.07
...
### Community 176 - "ContextWindowManager"
Cohesion: 0.08
...
### Community 177 - "_mock_provider_records"
Cohesion: 0.13
...
### Community 178 - "test_telegram_freebuff.py"
Cohesion: 0.07
...
### Community 180 - "test_e2b_data_flow.py"
Cohesion: 0.06
...
### Community 183 - "_get_provider_policy"
Cohesion: 0.07
...
### Community 184 - "configuration-reference.md"
Cohesion: 0.06
...
Cohesion: 0.06
Nodes (18): CommercialFallbackRequiredError, ProviderFallbackError, RuntimeError, Parse a 429/503 ``Retry-After`` header → seconds, or None. Accepts either…, Translate an OpenAI chat/completions payload to Bedrock Converse format., Translate a Bedrock Converse API response to OpenAI chat.completion format., gh_brain_failover(), Regression test for the auto-PR scripts' brain failover. On 2026-09-06 the… (+10 more)

### Community 188 - "test_process_quick_note_workflow.py"
Cohesion: 0.05
Nodes (27): _full_suite_jobs(), job(), parametrize, Tests for ``.github/workflows/process-quick-note.yml``. Two defects, one…, No issue to pick up means the retry handler never runs, so the job must not go…, Order matters: the label bump and issue reopen must complete before the job…, The invariant, stated once for the whole repo. Adding the service to two…, Guards the guard: a regex that matches nothing would pass silently. (+19 more)
...
### Community 190 - "test_daily_2026_07_27.py"
Cohesion: 0.07
...
### Community 197 - "OllamaCircuitBreaker"
Cohesion: 0.08
...
### Community 198 - "PromptCacheManager"
Cohesion: 0.06
...
### Community 200 - "_fixture"
Cohesion: 0.02
Nodes (112): base_url(), mobile_page(), proxy_url(), Config, pytest_configure(), conftest.py — pytest fixtures and configuration for the E2E test suite.…, A browser page pre-configured for mobile viewport (390×844 — iPhone 14)., _clean_env() (+104 more)
...
### Community 203 - "WorkspaceTools"
Cohesion: 0.04
Nodes (46): Register the built-in agent tools that are always available., _register_builtin_tools(), Path, tools.py — WorkspaceTools: read/write/search and diff application (risky…, Precise string replacement — F1 roadmap item (Codebuff/Claude Code-style edit).…, Return the first *lines* lines of a file. Just-in-time retrieval: the executor…, Return a lightweight index of files with line counts and sizes. This is the…, Delegate to RepowiseIntelligence for a natural-language codebase question. (+38 more)
...
### Community 207 - "resolve_component_model"
Cohesion: 0.06
...
### Community 208 - "test_llm_router_disabled.py"
Cohesion: 0.11
Nodes (33): _billing_signals(), is_unfixable(), The one list of "you have no money" phrases, borrowed not copied. Lazy because…, Whether this failure needs a human rather than a retry. Two shapes qualify. A…, auto_disable_provider(), disabled_providers(), Return ``{provider_id: reason}`` for every disabled provider. Mongo is…, Enable or disable *provider_id*, persisted across restarts and deploys. Written… (+25 more)
...
### Community 212 - "get_store"
Cohesion: 0.04
Nodes (44): get_store(), _LazyModuleProxy, db — storage abstraction layer (V2.0 Phase 5: real code moved to…, Loads the real module on first attribute access, then replaces itself., Return the active store singleton, creating it on first call., Reset the store singleton (used in tests). Also resets the motor client…, # IMPORTANT: keep these imports LAZY (inside __getattr__) so that a Mongo-only, reset_store() (+36 more)

### Community 213 - "ApprovalStore"
Cohesion: 0.06
Nodes (37): ApprovalRequest, ApprovalStatus, ApprovalStore, Any, Enum, str, packages/governance/approvals.py — human-in-the-loop for high-risk actions. The…, Bounded, in-process store of approval requests. Uses a :class:`threading.Lock`… (+29 more)
...
### Community 218 - "test_dashboard_cache.py"
Cohesion: 0.10
...
### Community 221 - "get_feature_matrix"
Cohesion: 0.08
...
### Community 223 - "TestRecordUsageAndStats"
Cohesion: 0.05
...
### Community 224 - "WorkflowRun"
Cohesion: 0.07
Nodes (30): engine(), WorkflowEngine, _fake_artifact(), _make_engine(), tests/test_crispy_workflow.py — CRISPY workflow engine hardening tests. Tests…, Provide isolated DB + artifact + workspace paths., Create a WorkflowEngine with isolated storage., TestAbortOnFailure (+22 more)

### Community 225 - "test_schedule_backlog_drain.py"
Cohesion: 0.09
...
### Community 228 - "emit_chat_observation"
Cohesion: 0.10
...
### Community 230 - "autonomous_fix.py"
Cohesion: 0.08
...
### Community 235 - "OrchestratorQueue"
Cohesion: 0.13
...
### Community 236 - "Kept Rules — the 44 that survive the audit"
Cohesion: 0.05
...
### Community 241 - "get_failover_manager"
Cohesion: 0.07
...
### Community 244 - "test_agent_free_brain.py"
Cohesion: 0.07
Nodes (19): is_anthropic_model(), True when *model* names a paid Anthropic/Bedrock-Claude model. Covers native…, _opus_model(), Return an Opus model ID iff the operator explicitly opted into a paid brain.…, _FakeAsyncClient, _FakeResponse, _free_env(), Free-brain policy regression tests for the agent runtime (issue #656).… (+11 more)

### Community 245 - "distributed.py"
Cohesion: 0.07
...
### Community 248 - "test_one_model_catalogue.py"
Cohesion: 0.10
...
### Community 249 - "test_purge_backlog.py"
Cohesion: 0.07
...
### Community 251 - "LlmProviderConfig"
Cohesion: 0.13
...
### Community 252 - "TestEstimateTokensForMessages"
Cohesion: 0.06
...
### Community 253 - "test_pr923_fixes.py"
Cohesion: 0.07
...
### Community 257 - "test_telegram_webhook.py"
Cohesion: 0.06
...
### Community 258 - "PatternConsolidation"
Cohesion: 0.08
...
### Community 259 - "system_instruction"
Cohesion: 0.09
...
### Community 260 - "test_control_plane_api.py"
Cohesion: 0.06
...
### Community 262 - "test_telegram_approval_gate.py"
Cohesion: 0.08
...
### Community 263 - "TestCatalogFable51"
Cohesion: 0.09
...
### Community 269 - "tests/conftest.py"
Cohesion: 0.05
...
### Community 270 - "TestNormalizeResponseFormat"
Cohesion: 0.08
...
### Community 271 - "get_skill_bindings"
Cohesion: 0.11
...
### Community 274 - "Autonomous AI Agency"
Cohesion: 0.05
...
Cohesion: 0.15
Nodes (20): Execute work through the 11-phase golden path., Return the caller's GitHub token from EITHER place it can be stored. A token…, _resolve_user_github_token(), workflow_orchestrator_execute(), _FakeCollection, _FakeDB, patch_db(), _apply() (+12 more)

### Community 280 - "chat_handlers.py"
Cohesion: 0.10
...
### Community 281 - "REWRITE_PLAN.md — Phased Migration Strategy"
Cohesion: 0.06
...
### Community 284 - "test_implement_agent_routing.py"
Cohesion: 0.07
...
### Community 285 - "test_persistent_memory.py"
Cohesion: 0.06
...
### Community 289 - "test_mcp_governance.py"
Cohesion: 0.09
...
### Community 291 - "local_controller.py"
Cohesion: 0.12
...
### Community 296 - "test_output_filter.py"
Cohesion: 0.06
...
### Community 302 - "model_discovery.py"
Cohesion: 0.07
Nodes (30): Return the discovered model list for *provider_id*, or ``[]`` if unknown., _served_models(), cached_models(), dead_models(), discover_models(), _fresh_entry(), mark_dead(), _models_url() (+22 more)

### Community 303 - "test_rate_limiter.py"
Cohesion: 0.09
...
### Community 307 - "test_live_server.py"
Cohesion: 0.22
...
### Community 308 - "_routing_candidates"
Cohesion: 0.09
...
### Community 309 - "test_provider_enable_disable.py"
Cohesion: 0.07
...
### Community 314 - "ResourceWatchdog"
Cohesion: 0.10
...
### Community 317 - "test_connector_registry.py"
Cohesion: 0.08
...
### Community 318 - "test_provider_render_env.py"
Cohesion: 0.09
...
### Community 319 - "skill_bindings.py"
Cohesion: 0.09
...
### Community 320 - "test_microagents.py"
Cohesion: 0.15
...
### Community 321 - "Security Analysis — local-llm-server"
Cohesion: 0.06
...
### Community 323 - "Langfuse Observability Guide"
Cohesion: 0.06
...
### Community 327 - "test_telegram_mutating_commands.py"
Cohesion: 0.09
...
### Community 328 - "test_workspace_isolation.py"
Cohesion: 0.17
...
### Community 334 - "test_platform_controls.py"
Cohesion: 0.05
Nodes (40): apply_overrides(), Write *overrides* into ``os.environ`` and refresh dependent caches. Keys that…, Re-read every ``settings`` attribute from the updated environment. Re-runs…, _refresh_settings_singleton(), all_controls(), is_controllable(), Every control in the catalogue, in display order., True when *key* may be overridden from the dashboard. The allow-list is what… (+32 more)

### Community 335 - "switch_brain.py"
Cohesion: 0.15
Nodes (30): detect_ollama_models(), dim(), fail(), get_auth_headers(), get_brain_config(), get_ngrok_tunnel_url(), header(), info() (+22 more)

### Community 336 - "cost_insights.py"
Cohesion: 0.11
Nodes (26): compute_savings(), compute_time_series(), get_savings(), get_usage(), get_user_savings(), _period_start(), Any, BaseModel (+18 more)

### Community 337 - "analyze_page"
Cohesion: 0.13
...
### Community 340 - "test_daily_2026_06_04.py"
Cohesion: 0.10
...
### Community 341 - "test_skill_registry_boot_refresh.py"
Cohesion: 0.11
...
### Community 342 - "test_autonomy_gate.py"
Cohesion: 0.13
...
### Community 343 - "test_vision_routing.py"
Cohesion: 0.12
...
### Community 344 - "output_filter.py"
Cohesion: 0.07
...
### Community 345 - "test_scheduler_hydration_bounded.py"
Cohesion: 0.09
...
### Community 346 - "test_brain_availability_doctor.py"
Cohesion: 0.10
...
### Community 348 - "OrchestratorCheckpointStore"
Cohesion: 0.09
...
### Community 350 - "NotificationDispatcher"
Cohesion: 0.09
...
### Community 352 - "test_brain_priority_scanner.py"
Cohesion: 0.08
...
### Community 353 - "test_force_cleanup_conditional_delete.py"
Cohesion: 0.10
...
### Community 354 - "get_tool_registry"
Cohesion: 0.09
Nodes (19): browse_page(), Open *url* in a real browser, return its rendered text, and close. Fail-soft:…, get_tool_registry(), Return the module-level ToolRegistry singleton. On first call, registers built-…, Register the interactive-browser capability (agent/browser.py). Unlike…, Register the Web Reach capability (agent/web_reach.py): zero-key internet…, _register_browser_tools(), _browse_page_tool() (+11 more)

### Community 355 - "CommitTracker"
Cohesion: 0.14
...
### Community 356 - "test_rag_context.py"
Cohesion: 0.12
...
### Community 357 - "ProjectScaffolder"
Cohesion: 0.13
...
### Community 360 - "control_registry.py"
Cohesion: 0.10
...
### Community 361 - "SteeringInjector"
Cohesion: 0.11
...
### Community 364 - "isolated_telegram_config"
Cohesion: 0.10
...
### Community 369 - "Python Dependencies (`requirements.txt`)"
Cohesion: 0.07
...
### Community 370 - "Technical Debt Register — local-llm-server"
Cohesion: 0.07
...
### Community 373 - "test_colibri_brain_shim.py"
Cohesion: 0.05
...
### Community 375 - "test_north_mini_code.py"
Cohesion: 0.09
...
### Community 379 - "test_agent_scripts_share_one_model_list.py"
Cohesion: 0.10
...
### Community 380 - "test_crispy_burn_in.py"
Cohesion: 0.07
...
### Community 386 - "asyncio"
Cohesion: 0.07
Nodes (21): asyncio, Test Company Graph services., Test that storage service can be initialized., Test company CRUD operations - skipped as requires specific config., Test scanner service., Test that scanner service can be initialized., Test specialist service., Test that specialist service can be initialized. (+13 more)
...
### Community 390 - "LLM Router — troubleshooting"
Cohesion: 0.08
...
### Community 391 - "test_agent_chat_integration.py"
Cohesion: 0.13
...
### Community 395 - "brain_failover.py"
Cohesion: 0.11
...
### Community 397 - "test_brain_migration_writes_a_live_model.py"
Cohesion: 0.10
...
### Community 398 - "test_daily_automation_2026_08_03.py"
Cohesion: 0.11
...
### Community 404 - "_ensure_tasks_source_id_unique_index"
Cohesion: 0.11
...
### Community 406 - "TASK 4 — End-to-end approval-gate test"
Cohesion: 0.08
...
### Community 407 - "video_transcript.py"
Cohesion: 0.11
...
### Community 411 - "TemporalContextGraph"
Cohesion: 0.10
...
### Community 412 - "test_freebuff_bot.py"
Cohesion: 0.11
...
### Community 413 - "test_telegram_approval_e2e.py"
Cohesion: 0.12
...
### Community 415 - "lifespan"
Cohesion: 0.05
Nodes (35): _keepalive_self_ping(), lifespan(), _deferred_startup_cleanup(), _maybe_boot_purge(), _purge_summary_clean(), Return orchestrator queue depth, active runs, and supervisor state (#522)., Run the FreeBuff Telegram bot, restarting it on unexpected exit., Ping our own public URL so a free-tier web service doesn't sleep. Render free… (+27 more)

### Community 416 - "TestClassifyPlainText"
Cohesion: 0.08
...
### Community 417 - "test_service_token.py"
Cohesion: 0.08
...
### Community 418 - "test_telegram_diag_endpoint.py"
Cohesion: 0.08
...
### Community 420 - "sam_livekit_worker.py"
Cohesion: 0.12
Nodes (24): get_sam(), LiveKitConfig, voice/livekit_config.py — LiveKit configuration (config module). Centralizes…, Resolved LiveKit + speech-provider configuration., True when the LiveKit room transport itself is usable., _build_llm(), _build_stt(), _build_tts() (+16 more)

### Community 421 - "LocalWorkspace"
Cohesion: 0.10
Nodes (31): get_repo(), _get_token(), _get_user(), init_workspace(), list_branches(), list_prs(), list_repos(), LocalWorkspace (+23 more)

### Community 422 - "LessonStore"
Cohesion: 0.16
...
### Community 424 - "control_overrides.py"
Cohesion: 0.08
Nodes (44): _actor(), build_platform_controls_router(), _admin(), list_controls(), reset_control(), update_controls(), ControlUpdateBody, APIRouter (+36 more)
...
### Community 426 - "Implementation Prompt: Rich TaskBoard + Agile Sprint Integration"
Cohesion: 0.08
...
### Community 427 - "Telegram Bot Setup"
Cohesion: 0.08
...
### Community 431 - "Native operations"
Cohesion: 0.09
...
### Community 433 - "get_scheduler"
Cohesion: 0.07
Nodes (39): get_agency(), set_agency(), _autonomy_bg_cycle(), autonomy_tick(), legacy_scheduler_delete(), legacy_scheduler_get(), Background CEO cycle + task dispatch. Runs fire-and-forget., Execute ONE pending task synchronously. Called by the cron workflow every 2… (+31 more)

### Community 434 - "WindowsServiceManager"
Cohesion: 0.17
...
### Community 436 - "test_all_features.py"
Cohesion: 0.08
...
### Community 439 - "DirectChatDoctor"
Cohesion: 0.47
...
### Community 441 - "_status_snapshot"
Cohesion: 0.15
...
### Community 442 - "openclaw_str_e_fix.py"
Cohesion: 0.15
...
### Community 443 - "Agent Governance Guide"
Cohesion: 0.09
...
### Community 444 - "The fifteen strategies"
Cohesion: 0.09
...
### Community 445 - "SetupWizardPage.js"
Cohesion: 0.13
...
### Community 448 - "SeoCheckDefinition"
Cohesion: 0.12
...
### Community 450 - "timedelta"
Cohesion: 0.14
Nodes (24): PR throughput per cohort over the last `days` days., Count distinct sessions per user. A session ends when there's a gap of more…, aggregate_last_24h(), build_daily_digest(), compute_cutoff(), format_digest_markdown(), _md_escape(), _now_utc() (+16 more)
...
### Community 454 - "SyntheticDataPipeline"
Cohesion: 0.13
...
### Community 455 - "_process_task_callback"
Cohesion: 0.20
...
### Community 457 - "test_cerebras_catalogue.py"
Cohesion: 0.13
...
### Community 459 - "test_mostly_failed_steps.py"
Cohesion: 0.12
...
### Community 461 - "test_issue_triage.py"
Cohesion: 0.14
...
### Community 463 - "HarnessEnrichment"
Cohesion: 0.15
...
### Community 464 - "classify_direct_chat_intent"
Cohesion: 0.13
...
### Community 466 - "AdaptivePermissions"
Cohesion: 0.18
...
### Community 468 - "test_prompt_injection_boundary.py"
Cohesion: 0.17
...
### Community 469 - "CoworkSession"
Cohesion: 0.07
Nodes (12): CoworkSession, Any, A shared AI coding session with multiple human contributors. Manages turn-…, Request editing control. Returns True if granted. Grant rules: - Host can…, Release control if the active editor is idle > 30s., Apply context updates from a contributor. Only the active editor can modify…, Background agent that periodically syncs session state across contributors.…, Run one sync tick across all sessions. Actions taken: - Kick idle active… (+4 more)

### Community 470 - "LocalBrainStore"
Cohesion: 0.16
...
### Community 473 - "_resolve_push_token"
Cohesion: 0.31
...
### Community 475 - "TestLegacyRouterCacheTTL"
Cohesion: 0.13
...
### Community 476 - "test_anthropic_refusal_fallback.py"
Cohesion: 0.19
...
### Community 479 - "PersistentMemoryStore"
Cohesion: 0.22
...
### Community 483 - "TestAddConversationCacheBreakpoints"
Cohesion: 0.15
...
### Community 484 - "test_local_controller.py"
Cohesion: 0.14
...
### Community 485 - "test_openclaw_str_e_fix.py"
Cohesion: 0.10
...
### Community 486 - "test_provider_state_durability.py"
Cohesion: 0.10
...
### Community 487 - "run_trend_analysis"
Cohesion: 0.18
...
### Community 488 - "test_unit5_ui_provider_surface.py"
Cohesion: 0.10
...
### Community 489 - "test_voice_pipeline.py"
Cohesion: 0.13
...
### Community 497 - "Docker AI Governance Audit — Final Report"
Cohesion: 0.10
...
### Community 498 - "1. Capability-by-capability"
Cohesion: 0.10
...
### Community 500 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 506 - "context_plan_gate.py"
Cohesion: 0.15
...
### Community 510 - "test_portfolio_intelligence.py"
Cohesion: 0.05
...
### Community 515 - "_extract_tech_relevance"
Cohesion: 0.17
...
### Community 517 - "ClaudeCodeAdapter"
Cohesion: 0.19
...
### Community 519 - "Skill: fabric-patterns"
Cohesion: 0.11
...
### Community 520 - "Analysis & Synthesis Instructions"
Cohesion: 0.11
Nodes (18): 1. Define the Atmosphere, 2. Map the Color Palette, 3. Establish Typography Rules, 4. Define the Hero Section, 5. Describe Component Stylings, 6. Define Layout Principles, 7. Define Responsive Rules, 8. Encode Motion Philosophy (+10 more)

### Community 521 - "Production Readiness Assessment — local-llm-server"
Cohesion: 0.11
...
### Community 530 - "TestRouterIntegration"
Cohesion: 0.21
...
### Community 531 - "weekly_digest.py"
Cohesion: 0.13
...
### Community 532 - "Delegation Plan (agent-ready work packages)"
Cohesion: 0.11
...
### Community 534 - "parse_event_stream"
Cohesion: 0.10
...
### Community 535 - "RuntimeHealthService"
Cohesion: 0.10
...
### Community 538 - "test_autonomy_pipeline_regressions.py"
Cohesion: 0.11
...
### Community 539 - "test_autonomy_status.py"
Cohesion: 0.11
...
### Community 540 - "test_brain_patch_service_token.py"
Cohesion: 0.18
...
### Community 541 - "TestMCPToolsListCache"
Cohesion: 0.15
...
### Community 542 - "TestSelfHealingInfrastructureClassification"
Cohesion: 0.19
...
### Community 543 - "test_fabric_patterns.py"
Cohesion: 0.11
...
### Community 544 - "test_llm_router_tpm.py"
Cohesion: 0.10
Nodes (31): classify_error(), Turn an HTTP failure into a typed error with the narrowest blame scope. The…, parametrize, A 404 on the wrong URL is a config bug, not a missing model., test_404_without_a_model_hint_is_permanent(), test_permanent_errors_are_never_retried(), test_transient_errors_carry_the_right_scope(), _big_request() (+23 more)

### Community 545 - "TestRoutes"
Cohesion: 0.16
...
### Community 546 - "test_repowise_intelligence.py"
Cohesion: 0.10
...
### Community 547 - "validate_session_id"
Cohesion: 0.16
...
### Community 548 - "handle_workflow_ide_chat"
Cohesion: 0.17
...
### Community 549 - "ErrorInterceptorMiddleware"
Cohesion: 0.18
...
### Community 551 - "agents/agile_ceremonies.py"
Cohesion: 0.08
...
### Community 559 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
...
### Community 561 - "Part A — Health Report"
Cohesion: 0.11
...
### Community 562 - "WorkflowScreen.jsx"
Cohesion: 0.14
...
### Community 569 - "test_company_api.py"
Cohesion: 0.11
...
### Community 570 - "test_daily_automation_2026_07_11.py"
Cohesion: 0.14
...
### Community 571 - "test_monitor_lib.py"
Cohesion: 0.15
...
### Community 572 - "test_phase5_doctor.py"
Cohesion: 0.11
...
### Community 573 - "TestStopSlopChecker"
Cohesion: 0.11
...
### Community 574 - "resolve_free_nvidia_brain"
Cohesion: 0.12
...
### Community 575 - "test_provider_failover_integration.py"
Cohesion: 0.15
...
### Community 576 - "test_harness_spec.py"
Cohesion: 0.16
...
### Community 581 - "SKILL: Industrial Brutalism & Tactical Telemetry UI"
Cohesion: 0.12
...
### Community 582 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 583 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 584 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 587 - "provider_max_rpm"
Cohesion: 0.13
...
### Community 588 - "TaskInput"
Cohesion: 0.14
Nodes (11): build_task_specs(), TaskSpec, Convert TaskInput list to TaskSpec list for MultiAgentSwarm., Task definition for /agent/coordinate requests., TaskInput, test_build_task_specs(), test_build_task_specs_with_type_alias(), test_task_input_aliases() (+3 more)

### Community 589 - "kimi_bridge_provider_config"
Cohesion: 0.18
...
### Community 594 - "e2e/test_browser.py"
Cohesion: 0.19
...
### Community 595 - "test_frontend_deployment_guards.py"
Cohesion: 0.18
...
### Community 596 - "test_health_endpoints.py"
Cohesion: 0.17
...
### Community 597 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 598 - "test_openclaw_endpoints.py"
Cohesion: 0.12
...
### Community 600 - "test_skill_registry.py"
Cohesion: 0.13
...
### Community 601 - "test_schedule_persistence.py"
Cohesion: 0.16
...
### Community 602 - "hermes_prompt.py"
Cohesion: 0.19
...
### Community 606 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
...
### Community 607 - "_valid_login_state"
Cohesion: 0.24
...
### Community 608 - "Skill: repowise-intelligence"
Cohesion: 0.12
Nodes (15): 1. Graph Intelligence (Dependency Graph), 2. Git Intelligence, 3. Documentation Intelligence, 4. Decision Intelligence, Acceptance Checks, Directory Structure, Example Usage, Implementation Approach (+7 more)
...
### Community 610 - "Nothing is blocked on an agent. Two things need a human."
Cohesion: 0.12
...
### Community 611 - "Contributing to local-llm-server"
Cohesion: 0.12
...
### Community 612 - "refresh_agent_built_proof.py"
Cohesion: 0.20
...
### Community 613 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 614 - "Feature Maturity / Support Matrix"
Cohesion: 0.12
...
### Community 615 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 616 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
...
### Community 621 - "test_telegram_auto_approve.py"
Cohesion: 0.21
...
### Community 622 - "ManagedAgentDreams"
Cohesion: 0.22
...
### Community 625 - "test_brain_failover_413.py"
Cohesion: 0.13
...
### Community 626 - "TestCatalogClaude5Models"
Cohesion: 0.10
...
### Community 629 - "test_langfuse_agency_wide.py"
Cohesion: 0.10
...
### Community 630 - "test_local_brain_state.py"
Cohesion: 0.12
...
### Community 633 - "test_nvidia_default_model.py"
Cohesion: 0.17
...
### Community 635 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 636 - "test_refresh_agent_built_proof.py"
Cohesion: 0.12
...
### Community 651 - "Skill: user-research"
Cohesion: 0.13
...
### Community 652 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 653 - "Attention Mechanisms Internals"
Cohesion: 0.13
...
### Community 658 - "test_critical_flows.py"
Cohesion: 0.26
...
Cohesion: 0.11
Nodes (5): DecisionsStoreTests, _fresh_store(), Smoke: create() returns a fresh dec_<hex8> per call (no error surfaces from…, tests/test_decisions_store.py — Coverage for the generic decision store. Each…, Backdates the older row via raw SQLite UPDATE so it falls outside the cutoff…
...
### Community 662 - "test_daemon_restart_reprobes_http_port_only"
Cohesion: 0.13
...
### Community 663 - "test_scanner_live.py"
Cohesion: 0.23
...
### Community 665 - "test_tasks_awaiting_approval_api.py"
Cohesion: 0.33
...
### Community 668 - "test_agent_coordinate.py"
Cohesion: 0.23
...
### Community 671 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 675 - "Checks Performed"
Cohesion: 0.14
...
### Community 676 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 677 - "admin_digest_router.py"
Cohesion: 0.22
...
### Community 678 - "Skill: branch-cleanup"
Cohesion: 0.14
...
### Community 679 - "Skill: perplexity — Web Research via Perplexity API"
Cohesion: 0.14
...
### Community 682 - "Quick-Note Issues Processing Summary"
Cohesion: 0.14
...
### Community 683 - "Main proxy (`proxy.py`)"
Cohesion: 0.14
...
### Community 684 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 686 - "Render MCP — autonomous platform debugging and environment monitoring"
Cohesion: 0.14
...
### Community 687 - "Runbook: Auto-Resume After Cooldown / Interruption"
Cohesion: 0.14
...
### Community 688 - "SEO / GEO / AIO Audit Engine"
Cohesion: 0.14
...
### Community 689 - "Traffic Distribution Across Providers"
Cohesion: 0.14
...
### Community 692 - "_parse_reset_epoch"
Cohesion: 0.21
...
### Community 693 - "extract_failures"
Cohesion: 0.21
...
### Community 694 - "test_p0_roadmap_b3_b4_b5.py"
Cohesion: 0.21
...
### Community 695 - "test_wrapper_falls_back_to_installed_model"
Cohesion: 0.19
...
### Community 696 - "TestAnthropicToolListCaching"
Cohesion: 0.34
...
### Community 697 - "test_changelog_check_workflow.py"
Cohesion: 0.21
...
### Community 698 - "TestMCPClientStructuredOutput"
Cohesion: 0.27
...
### Community 702 - "test_openclaw_gateway.py"
Cohesion: 0.14
...
### Community 703 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 704 - "analyze_qualitative"
Cohesion: 0.22
...
### Community 705 - "AGENTS.md — Codebase Map & Operations Reference"
Cohesion: 0.15
...
### Community 708 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 711 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 712 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 715 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
...
### Community 716 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 717 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 719 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 720 - "admin_update_task_router.py"
Cohesion: 0.22
...
### Community 722 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
Nodes (12): Acceptance Checks, Claude's query protocol (use this instead of Read tool for exploration):, Graph Artifacts — What to Commit, How to Use the Graph (Token Savings Protocol), Installation (one-time per machine), Instead of reading raw files:, Key commands:, Relationship to repowise-intelligence Skill (+4 more)

### Community 723 - "Skill: platform-setup — Autonomous Agency Bootstrap"
Cohesion: 0.15
...
### Community 724 - "Device compatibility and model picks"
Cohesion: 0.15
...
### Community 725 - "Autonomy Uplift — Living Roadmap & Detailed Implementation Specs"
Cohesion: 0.15
...
### Community 726 - "OpenClaw — iOS Control of the Agency (Single-Service Free-Tier Deploy)"
Cohesion: 0.15
...
### Community 728 - "ApplyReviewAgent"
Cohesion: 0.22
...
### Community 731 - "traffic_director.py"
Cohesion: 0.11
...
### Community 735 - "Agent Transparency Report"
Cohesion: 0.15
...
### Community 744 - "test_omniroute_provider.py"
Cohesion: 0.12
...
### Community 745 - "TestKillSwitchDurability"
Cohesion: 0.15
...
### Community 746 - "test_providers_live_e2e.py"
Cohesion: 0.24
...
### Community 749 - "test_swarm_concurrency.py"
Cohesion: 0.15
...
### Community 751 - "skill_registry.py"
Cohesion: 0.17
...
### Community 757 - "Skill: system-prompt-audit"
Cohesion: 0.17
...
### Community 758 - "Skill: task-alive-updates"
Cohesion: 0.17
...
### Community 761 - "build_admin_local_brain_router"
Cohesion: 0.24
...
### Community 762 - "connectors_api.py"
Cohesion: 0.21
...
### Community 766 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 768 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 769 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 770 - "Workspace Isolation Architecture"
Cohesion: 0.17
...
### Community 771 - "Quantization Internals"
Cohesion: 0.17
...
### Community 772 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 773 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 774 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 776 - "verify_service_token"
Cohesion: 0.22
...
### Community 778 - "install-agents.sh"
Cohesion: 0.39
...
### Community 779 - "check_container_posture.py"
Cohesion: 0.26
...
### Community 780 - "test_pytest_failure_parser.py"
Cohesion: 0.23
...
### Community 781 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 782 - "scan_repo_with_user_research.py"
Cohesion: 0.22
...
### Community 785 - "test_agile_api.py"
Cohesion: 0.17
...
### Community 786 - "test_app_settings.py"
Cohesion: 0.21
...
### Community 787 - "test_brain_default_consistency.py"
Cohesion: 0.24
...
### Community 789 - "TestDisabledProvidersAreNotFalselyReportedUnreachable"
Cohesion: 0.18
...
### Community 790 - "TestModelRegistryUpdates"
Cohesion: 0.14
...
### Community 791 - "record_event"
Cohesion: 0.24
Nodes (8): events_from_identity(), Any, Convenience: build and record an event in one call., Extract the identity-derived audit fields from an AgentIdentity. Kept here…, record_event(), Provision a sandbox for *identity* under *profile_name*., Run *command* inside a sandbox, auditing the call. The command is audited but…, Tear down a sandbox. Idempotent and never raises.

### Community 792 - "TestDeprecationWarnings"
Cohesion: 0.17
...
### Community 797 - "_extractive_compress"
Cohesion: 0.18
...
### Community 798 - "telegram_service.py"
Cohesion: 0.23
Nodes (6): service_manager.py — Telegram & Notification Integration Extension Extends the…, # NOTE: do NOT re-escape here — services.daily_digest.format_digest_markdown, Best-effort secret/email/IP redaction for outbound Telegram/webhook messages., _redact_for_notification(), Regression tests for telegram_service.NotificationDispatcher._notify_webhook.…, TestRedactForNotification

### Community 799 - "coordinate.py"
Cohesion: 0.24
...
### Community 802 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 805 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 806 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 808 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 811 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 812 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 813 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 814 - "2. Critical Bugs & Exact Detection Signatures"
Cohesion: 0.18
...
### Community 815 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 816 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 817 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 818 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 819 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 821 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 822 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 823 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 824 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 825 - "What to clean up"
Cohesion: 0.18
...
### Community 826 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 827 - "test_bedrock_live.py"
Cohesion: 0.25
...
### Community 828 - "build_tech_db.py"
Cohesion: 0.35
...
### Community 829 - "migrate_local_brain_env.py"
Cohesion: 0.25
...
### Community 831 - "RepowiseIntelligence"
Cohesion: 0.33
Nodes (5): Path, Compute cyclomatic complexity for Python files. Returns 0 for non-Python files…, Workhorse tool for packing content and metrics of target files., Get dependencies from our built intelligence., RepowiseIntelligence

### Community 832 - "test_conftest_hermetic_env.py"
Cohesion: 0.18
...
### Community 834 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 836 - "TestZeroAttemptDiagnostics"
Cohesion: 0.25
...
### Community 837 - "test_google_provider_models.py"
Cohesion: 0.18
...
### Community 838 - "TestNoNvidiaFallbackIsRetired"
Cohesion: 0.22
...
### Community 842 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 843 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 844 - "_normalize_tool_choice"
Cohesion: 0.31
...
### Community 845 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 846 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 847 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 848 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 849 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 850 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 851 - "DirectChatSession"
Cohesion: 0.15
...
### Community 852 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 853 - "Agent Readiness Report"
Cohesion: 0.20
...
### Community 855 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 856 - "Competitor Analysis — Autonomous AI Agency"
Cohesion: 0.20
...
### Community 857 - "Issue #1427: quick-note:https://github.com/bingreeky/JIT"
Cohesion: 0.20
...
### Community 858 - "LLM Router — configuration guide"
Cohesion: 0.20
...
### Community 860 - "CI Troubleshooting Runbook"
Cohesion: 0.20
...
### Community 861 - "capture_screens.py"
Cohesion: 0.29
...
### Community 862 - "._notify_approval_gate"
Cohesion: 0.20
...
### Community 863 - "enrich_quick_note_issues.py"
Cohesion: 0.36
...
### Community 864 - "_start_ceo_agency"
Cohesion: 0.27
...
### Community 866 - "TestPoliciesGovernanceStableClaim"
Cohesion: 0.25
...
### Community 868 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 880 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 881 - "Skill: changelog-enforcer"
Cohesion: 0.22
...
### Community 882 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 884 - "_get_current_user"
Cohesion: 0.25
...
### Community 885 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 886 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 887 - "Skill: changelog-enforcer"
Cohesion: 0.22
Nodes (8): Acceptance Checks, Changelog Location, Entry Format, Examples, Hook Behaviour, Instructions, Skill: changelog-enforcer, When to Use

### Community 888 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
Nodes (8): Branch, Components, Purpose, Quick Start, Session Roles, Skill: cowork-session (Claude Cowork), Testing, When to Use

### Community 889 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 890 - "Active Task Tracker"
Cohesion: 0.22
...
### Community 892 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 893 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 894 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 896 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 897 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 898 - "Platform Controls"
Cohesion: 0.22
...
### Community 899 - "Release Procedure"
Cohesion: 0.22
...
### Community 900 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 907 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 909 - "test_probe_base_url_override_hits_the_typed_url"
Cohesion: 0.22
...
### Community 910 - ".test_every_request_carries_a_real_user_agent"
Cohesion: 0.22
...
### Community 911 - "test_delegate_propagates_runtime_errors"
Cohesion: 0.25
...
### Community 912 - "test_changelog_parity_guard.py"
Cohesion: 0.22
...
### Community 913 - "TestPolicyAuthoringUiStableClaim"
Cohesion: 0.22
...
### Community 914 - "test_daemon_picks_colibri_8081_when_only_it_listening"
Cohesion: 0.22
...
### Community 916 - "TestPaidPolicyDurability"
Cohesion: 0.22
...
### Community 917 - "test_scanner_deps_parity.py"
Cohesion: 0.31
...
### Community 918 - "test_serve_spa_prefixes.py"
Cohesion: 0.31
...
### Community 925 - "commercial_equivalent.py"
Cohesion: 0.50
...
### Community 929 - "TestReviewRegressions"
Cohesion: 0.25
...
### Community 940 - "Agent Autonomy Roadmap"
Cohesion: 0.25
...
### Community 941 - "AGENTS.md — AI Agent Configuration for local-llm-server"
Cohesion: 0.25
...
### Community 942 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 943 - "ceo-micromanagement.md"
Cohesion: 0.25
...
### Community 975 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 976 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 977 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 978 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 979 - "Prime Agent Runtime"
Cohesion: 0.25
...
### Community 981 - "security_fix_agent.py"
Cohesion: 0.46
...
### Community 982 - "test_mcp_protocol_version.py"
Cohesion: 0.25
...
### Community 991 - "TestItIsNotBuiltForOneVendor"
Cohesion: 0.25
...
### Community 992 - "test_doctor_coding_brain.py"
Cohesion: 0.32
...
### Community 993 - "test_generate_context_standing_instructions.py"
Cohesion: 0.32
...
### Community 994 - "test_local_brain_router_smoke.py"
Cohesion: 0.25
...
### Community 996 - "test_provider_models_db_outage.py"
Cohesion: 0.25
...
### Community 997 - "test_runtimes_health_endpoint.py"
Cohesion: 0.25
...
### Community 998 - "TestOneIdCanBelongToSeveralProviders"
Cohesion: 0.39
...
### Community 999 - "test_nuclear_cleanup_targets_the_schedule_collection"
Cohesion: 0.25
...
### Community 1001 - "classify_domain"
Cohesion: 0.29
...
### Community 1002 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.25
...
### Community 1004 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 1013 - "._run_git_command"
Cohesion: 0.33
Nodes (3): Build git intelligence: hotspots, ownership, co-change pairs., Run a git command and return stdout as string., Extract architectural decisions from git history and inline comments.

### Community 1014 - "ModelRegistry"
Cohesion: 0.29
...
### Community 1018 - "AI Engineering Insights Skill"
Cohesion: 0.29
...
### Community 1019 - "Skill: hybrid-reasoning (Hybrid AI)"
Cohesion: 0.29
Nodes (6): Branch, Components, Purpose, Quick Start, Skill: hybrid-reasoning (Hybrid AI), Testing

### Community 1020 - "Karpathy Guidelines Skill"
Cohesion: 0.29
...
### Community 1032 - "claude-mem Plugin — Persistent Memory for All Sessions"
Cohesion: 0.29
...
### Community 1033 - "Implementation plan + TO-DO (check off as you go)"
Cohesion: 0.29
...
### Community 1036 - "Cloudflare = the real working app"
Cohesion: 0.29
...
### Community 1043 - "check_changelog_parity.py"
Cohesion: 0.43
...
### Community 1044 - "check_doc_images.py"
Cohesion: 0.48
...
### Community 1046 - "test_daily_2026_06_14.py"
Cohesion: 0.38
...
### Community 1047 - "._get_last_commit"
Cohesion: 0.33
...
### Community 1049 - "provider_api_keys"
Cohesion: 0.33
Nodes (6): provider_api_keys(), _provider_env_value(), provider_key_rotation_enabled(), Read a per-provider env var, tolerating dashes in the provider id. Provider ids…, True when the operator has explicitly opted *this provider* into using more…, Every API key configured for *provider*, primary first. Reads ``base_env`` then…

### Community 1050 - "_normalize_dockerfile"
Cohesion: 0.33
...
### Community 1051 - "TestReasonsAreActionable"
Cohesion: 0.29
...
### Community 1052 - "TestProvidersScreen"
Cohesion: 0.43
...
### Community 1058 - "InitiativeProgress"
Cohesion: 0.33
...
### Community 1059 - "openclaw_mobile_ui"
Cohesion: 0.33
...
### Community 1074 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 1075 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 1076 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 1077 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 1078 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 1079 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 1083 - "apply_phase1_changes.py"
Cohesion: 0.33
...
### Community 1093 - "TestCli"
Cohesion: 0.47
Nodes (4): parametrize, Path, The workflow branches on the verdict file, so that contract matters., TestCli

### Community 1094 - "test_autonomous_agency_e2e.py"
Cohesion: 0.13
Nodes (11): is_legacy_mode(), True when parallel execution paths are allowed (with warnings)., End-to-end tests for the autonomous AI agency system (issue #467). These tests…, Verify AgentRunner has _execute_step for ReAct execution loop., Verify _BYPASS context var is used for internal agent execution., Tests for direct chat agent execution beyond planning., Verify ChatSendRequest supports agent mode execution., Verify WorkspaceTools provides filesystem operations for agents. (+3 more)

### Community 1096 - "TestWorkflowIntegration"
Cohesion: 0.33
...
### Community 1121 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 1122 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 1132 - "_add_colibri_shim_changelog_entry.py"
Cohesion: 0.50
...
### Community 1133 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1134 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1135 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 1136 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 1137 - "setup_colibri.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1138 - "setup_colibri.sh script"
Cohesion: 0.70
Nodes (4): setup_colibri.sh script, fail(), ok(), warn()

### Community 1139 - "status_colibri_server.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1140 - "start_tunnel.py"
Cohesion: 0.50
...
### Community 1144 - "nvidia_live_test.py"
Cohesion: 0.40
...
### Community 1149 - "TestModelRoleSeparation"
Cohesion: 0.40
...
### Community 1180 - "test_no_exception_detail_leaks.py"
Cohesion: 0.50
...
### Community 1181 - "test_skills_route_order.py"
Cohesion: 0.67
...
### Community 1184 - "github"
Cohesion: 0.50
Nodes (3): github, enabled, silent

### Community 1187 - "HTTPException"
Cohesion: 0.03
Nodes (120): admin_seed(), clear_cost_attribution(), clear_response_cache(), create_access_token(), create_api_key(), create_github_pr(), create_provider(), create_wiki_page() (+112 more)

### Community 1212 - "test_the_reserve_is_bounded_when_read_from_the_environment"
Cohesion: 0.67
...
- **3527 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3522 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 14274 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **118 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `_fixture()` connect `_fixture` to `ClaudeCodeAdapter`, `llm/router.py`, `test_llm_router_queue_cache.py`, `SpecialistService`, `test_llm_router_strategies.py`, `brain_config.py`, `cost_tracker.py`, `test_operational_incidents.py`, `TaskWorkflowService`, `AgentRunner`, `SelfHealingAgent`, `PolicyEngine`, `client`, `BackgroundAgent`, `test_e2b_task_wiring.py`, `parse_event_stream`, `ImprovementLoop`, `loop.py`, `test_autonomy_status.py`, `test_brain_patch_service_token.py`, `E2BSandboxSession`, `resolve_active_brain`, `config.py`, `test_llm_router_tpm.py`, `clear_cooldowns`, `services/background.py`, `test_unit8_model_catalog.py`, `Task`, `test_llm_router_resilience.py`, `test_ai_insights.py`, `get_workflow_orchestrator`, `test_failover_client_shared.py`, `test_ephemeral_reaper.py`, `test_orchestrator_merge_decision.py`, `PrimeAgentAdapter`, `UserRole`, `test_model_router.py`, `test_company_api.py`, `test_monitor_lib.py`, `test_phase5_doctor.py`, `test_provider_failover_integration.py`, `test_harness_spec.py`, `test_agent_tool_governance.py`, `test_catalogue_probe.py`, `TokenBudget`, `test_provider_router.py`, `test_startup_warmup.py`, `e2e/test_browser.py`, `test_sam_voice.py`, `AgentSwarm`, `ResearchTask`, `test_openclaw_endpoints.py`, `TestClient`, `test_procedural_memory.py`, `claim`, `test_knowledge_sync.py`, `run_task`, `models/seo_audit.py`, `test_telegram_auto_approve.py`, `resolve_e2b_config`, `test_brain_failover_413.py`, `test_trend_watcher.py`, `test_langfuse_agency_wide.py`, `test_local_brain_state.py`, `test_sam_livekit.py`, `TestChatHistoryStore`, `test_refresh_agent_built_proof.py`, `persist_plan_spec`, `test_context_rulebook.py`, `test_issue_intake.py`, `test_new_features_e2e.py`, `ArtifactStore`, `test_llm_router_e2e.py`, `TestHarnessAdapter`, `E2BAdapter`, `test_kimi_bridge_server.py`, `SeoAuditEngine`, `ChatHistoryStore`, `_step`, `quick_note.py`, `test_webui_provider_priority.py`, `_mock_provider_records`, `test_telegram_freebuff.py`, `test_e2b_data_flow.py`, `MCPClient`, `test_changelog_check_workflow.py`, `KeyPool`, `_Response`, `KeyStore`, `test_process_quick_note_workflow.py`, `test_daily_2026_07_27.py`, `test_openclaw_gateway.py`, `SchedulerStore`, `OllamaCircuitBreaker`, `_job_text`, `test_video_transcript.py`, `test_portfolio_intake.py`, `test_llm_router_disabled.py`, `ApprovalStore`, `test_features_api.py`, `TrendWatcher`, `test_dashboard_cache.py`, `_Budget`, `traffic_director.py`, `get_feature_matrix`, `nvidia_models.py`, `WorkflowRun`, `TaskStatus`, `WorkflowBuildRequest`, `test_agent_free_brain.py`, `test_purge_backlog.py`, `TestEstimateTokensForMessages`, `TestClient`, `test_telegram_webhook.py`, `test_control_plane_api.py`, `test_telegram_approval_gate.py`, `ContextPruner`, `tests/conftest.py`, `TestNormalizeResponseFormat`, `get_skill_bindings`, `api_keys_for`, `test_agile_api.py`, `test_app_settings.py`, `_resolve_user_github_token`, `test_task_clarification.py`, `CEOSupervisor`, `test_persistent_memory.py`, `SecurityScanner`, `test_mcp_governance.py`, `test_nvidia_model_discovery.py`, `test_output_filter.py`, `model_discovery.py`, `test_rate_limiter.py`, `test_provider_enable_disable.py`, `TestCountTokensEndpoint`, `test_platform_controls.py`, `analyze_page`, `session_retro.py`, `test_agency_fix.py`, `test_skill_registry_boot_refresh.py`, `test_vision_routing.py`, `test_scheduler_hydration_bounded.py`, `test_brain_availability_doctor.py`, `OrchestratorCheckpointStore`, `NotificationDispatcher`, `_make_task`, `_start_ceo_agency`, `TestMongoGate`, `isolated_telegram_config`, `test_colibri_brain_shim.py`, `test_regression.py`, `test_agent_scripts_share_one_model_list.py`, `test_crispy_burn_in.py`, `_Recorder`, `ai/watchdog.py`, `TestSwarmRoleRouting`, `_undeclared`, `test_freebuff_bot.py`, `test_service_token.py`, `test_telegram_diag_endpoint.py`, `test_v4_api.py`, `_client`, `test_mcp_protocol_version.py`, `_resolve_push_token`, `TestTheWorkflowIsSafeAndReadOnly`, `test_doctor_coding_brain.py`, `test_ping.py`, `test_runtimes_health_endpoint.py`, `test_provider_state_durability.py`, `test_voice_pipeline.py`, `test_task_store_fails_loud_in_production.py`, `captured`, `SQLiteStore`?**
  _High betweenness centrality (0.123) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `proxy.py`, `TaskSpec`, `test_agent_chat_integration.py`, `AdaptiveHalter`, `ContextPruner`, `ExecutionRequest`, `coordinator.py`, `UserMemoryStore`, `PolicyEngine`, `GitHubTools`, `BackgroundAgent`, `MultiAgentSwarm`, `E2BAdapter`, `Agency`, `loop.py`, `E2BSandboxSession`, `ReactScratchpad`, `TestDeprecationWarnings`, `FreeBuffAgent`, `LocalWorkspace`, `test_failover_client_shared.py`, `test_agent_runner.py`, `MCPClient`, `ContextManager`, `test_daily_automation_2026_07_11.py`, `test_empirical_verify.py`, `test_autonomous_agency_e2e.py`, `test_agent_tool_governance.py`, `StuckDetector`, `TokenBudget`, `WorkspaceTools`, `direct_chat.py`, `CEODispatcher`, `test_governance_api.py`, `InternalAgentAdapter`, `test_brain_failover_413.py`, `test_agent_free_brain.py`, `TestAgentLoopMCPIntegration`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderRouter` to `backend/server.py`, `system_instruction`, `TrafficDirector`, `TestRouterIntegration`, `test_implement_agent_routing.py`, `failover_client.py`, `clear_cooldowns`, `test_all_providers_discovery.py`, `implement_agent.py`, `test_chat_mode_regressions.py`, `test_bedrock_live.py`, `_Response`, `settings.py`, `test_provider_failover_integration.py`, `direct_chat.py`, `test_provider_router.py`, `kimi_bridge_provider_config`, `TestLegacyRouterCacheTTL`, `test_anthropic_refusal_fallback.py`, `_payload`, `TestAnthropicPayloadStructuredOutput`, `test_colibri_brain_shim.py`, `TestLegacyRouterServerFallback`, `ProviderConfig`?**
