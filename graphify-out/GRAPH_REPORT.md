...
## Corpus Check
- 1502 files · ~2,175,549 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 30432 nodes · 56842 edges · 1270 communities (1114 shown, 108 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 3331 edges (avg confidence: 0.92)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7779d153`
...
## Communities (1270 total, 108 thin omitted)

### Community 0 - "WebsiteScanner"
Cohesion: 0.02
...
Cohesion: 0.02
Nodes (102): parse_event_stream(), Reduce a ``--mode json`` NDJSON stream to a :class:`ParsedRun`. Kept a module-…, base_url(), mobile_page(), proxy_url(), Config, pytest_configure(), conftest.py — pytest fixtures and configuration for the E2E test suite.… (+94 more)

### Community 11 - "PolicyEngine"
Cohesion: 0.04
Nodes (77): _egress_policy_reason(), agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Return why governance policy blocks *host*, or None. Runs strictly *after* the…, _action_matches(), _as_list(), Decision, GroupPolicy, _host_matches() (+69 more)
...
### Community 13 - "test_scanner_live.py"
Cohesion: 0.23
...
### Community 17 - "RuntimeCapabilityRegistry"
Cohesion: 0.04
...
Cohesion: 0.05
Nodes (49): Agent subsystem — planner / executor / verifier loop., AgentEvent, AgentRunRequest, AgentSession, AgentSessionCreateRequest, AgentSessionMessage, AgentStep, _known_tool_names() (+41 more)
...
### Community 24 - "Task"
Cohesion: 0.03
Nodes (83): Task, Full task/issue document., Task, _is_brain_connection_error(), _is_outward_facing(), Any, BaseException, One-line human explanation of why this task needs human approval. Reads risk… (+75 more)

### Community 25 - "SelfHealingAgent"
Cohesion: 0.04
Nodes (67): heal_signature(), HealingEvent, HealState, _now(), Any, str, Translate external failure signals into improvement tasks and verify the fix…, Launch the background sweeper that resolves quiet verifying heals. (+59 more)

### Community 26 - "ScheduledJob"
Cohesion: 0.05
...
### Community 29 - "get_self_healing_agent"
Cohesion: 0.06
...
Cohesion: 0.01
Nodes (329): admin_seed(), _agent_provider_failure_response(), _agent_timeout_fallback_response(), AgentStatusEntry, AgentStatusResponse, AgentToolCallEntry, ApiKeyCreate, _append_agent_session_message() (+321 more)
...
Cohesion: 0.02
Nodes (136): _brain_provider_status(), get_brain_policy_route(), Return per-provider metadata for the GET endpoint. Iterates every provider in…, Return the discovered model list for *provider_id*, or ``[]`` if unknown., Return the active brain config + per-provider key-present flags. The response…, _served_models(), _active_primary_provider(), BrainConfig (+128 more)

### Community 40 - "test_workflow_orchestrator_scoping.py"
Cohesion: 0.17
...
Cohesion: 0.04
Nodes (85): Any, Translate technical preflight issues into a conversational assistant reply., translate_error_to_conversational(), classify_direct_chat_intent(), _contains_keyword(), detect_intent(), intent.py — Intent classification for direct chat (answer_only, execute_now,…, Return True if content contains any execution or analysis keyword. (+77 more)

### Community 46 - "enforcement.py"
Cohesion: 0.06
Nodes (44): _load(), mcp_server/governance.py — governance adapter for the MCP HTTP surface. Closes…, Import the governance layer once, recording why if it is absent., Convenience: build and record an event in one call., record_event(), BudgetExceeded, classify(), evaluate_call() (+36 more)

### Community 47 - "tasks/service.py"
Cohesion: 0.05
Nodes (45): AgentDefinition, AgentStore, Any, field_validator, agents/store.py — Persistent store for user-defined agent configurations.…, CRUD store for AgentDefinition objects. Uses MongoDB when a `db` client is…, Return an agent by ID. If *owner_id* is provided, enforces that the agent…, Delete an agent. Returns True on success, False if not found/unauthorised. (+37 more)

### Community 48 - "test_provider_router.py"
Cohesion: 0.06
...
Cohesion: 0.04
Nodes (90): packages/ai/self_heal.py — automatic brain self-healing. When the active brain…, Creates tasks from scheduler and playbook runs using one workflow., TaskAutomationService, Enum, str, TaskPriority, TaskStatus, Record the human decision on a task's **pre-execution** approval gate. A… (+82 more)
...
Cohesion: 0.04
Nodes (52): all_settings(), _as_bool(), _as_int(), ephemeral_ttl_hours(), ephemeral_ttl_hours_cached(), get_setting(), _maybe_schedule_refresh(), onboarding_gate_enabled() (+44 more)
...
### Community 57 - "AgentRunner"
Cohesion: 0.04
Nodes (48): AgentRunner, Any, Path, Governance seam: judge the call, run it, audit the outcome. Deliberately a thin…, Append an event to the durable session log if a store is wired in., Summarise a long history and compact it. Asks the planner model to write a…, Send chat messages and return the assistant's text output. If an…, Call-time resolver for an agent role model id. Delegates to… (+40 more)
...
Cohesion: 0.06
Nodes (33): BaseModel, Response shape of ``GET /api/render/ops/status``. Declared here rather than in…, RenderOpsStatus, One deploy, normalised from whatever shape the tool returned., RenderDeploy, Polls Render for platform-level failures and files them as issues., Snapshot for ``/api/render/ops/status`` and the dashboard. ``self_heal_ready``…, Map service ID → human name, degrading to the ID when unavailable. (+25 more)
...
Cohesion: 0.04
Nodes (61): PreflightIssue, PreflightReport, BaseModel, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, AgentJob, AgentJobManager, make_isolated_workspace(), _now() (+53 more)
...
### Community 78 - "test_render_mcp.py"
Cohesion: 0.03
...
Cohesion: 0.05
Nodes (66): Feed LLM token/cost spend into the governance session budget. Kept separate…, Charge sub-agent nesting depth and enforce the ``max_depth`` ceiling. Isolates…, events_from_identity(), Extract the identity-derived audit fields from an AgentIdentity. Kept here…, get_gate(), governance_enabled(), True when the governance layer should run at all. A single global off switch…, Best-effort identity for an ``AgentRunner``-like object. Wiring governance into… (+58 more)

### Community 117 - "get_task_store"
Cohesion: 0.05
Nodes (64): _purge_backlog_core(), quick_notes_submit(), _QuickNoteBody, Shared purge implementation for the admin endpoint and the boot hook., Submit a quick-note URL or instruction from the dashboard FAB., _blocked_retire_age_sec(), _heal_blocked_backlog(), _heal_brain_failover() (+56 more)
...
### Community 121 - "render_router.py"
Cohesion: 0.14
...
### Community 131 - "test_llm_router_tpm.py"
Cohesion: 0.07
...
### Community 133 - "delegate_seo_findings"
Cohesion: 0.10
...
### Community 141 - ".scan"
Cohesion: 0.19
Nodes (9): _parse_timestamp(), datetime, Parse an RFC3339 timestamp from Render, tolerating a trailing ``Z``., Run one full scan and return every finding, filed or not. Never raises: a…, Flag a failed latest deploy, or one that has been building too long., Flag an error-log spike in the lookback window., Flag memory usage sitting near the plan's limit., _rfc3339() (+1 more)
...
### Community 164 - "test_portfolio_intake.py"
Cohesion: 0.08
...
### Community 166 - "ExecutionRequest"
Cohesion: 0.05
Nodes (73): BoundContext, ClassifyOutput, ExecutionRequest, ExecutionResult, get_workflow_orchestrator(), JudgeVerdict, MonitorOutput, _orchestrator_bypass() (+65 more)
...
### Community 169 - "test_llm_router_disabled.py"
Cohesion: 0.09
...
Cohesion: 0.04
Nodes (77): generate_standup(), Build a :class:`StandupReport` from ``.claude/state/active-tasks.md``. Reads…, add_initiative(), AllocationOut, BoardOut, get_board(), get_service(), InitiativeIn (+69 more)
...
### Community 195 - "test_colibri_brain_shim.py"
Cohesion: 0.08
...
Cohesion: 0.11
Nodes (27): observability_diag_public(), PUBLIC diagnostic endpoint for Langfuse — no auth required. Returns exactly…, _base_url(), _department_trace_tags(), emit_agency_observation(), emit_chat_observation(), _emit_langfuse_http_sync(), _emit_sdk() (+19 more)
...
Cohesion: 0.08
Nodes (34): build_review_context(), _gh(), main(), Aggregate all review feedback for the PR into a single context string., _fetch_models_json(), _is_chat_model(), live_model_ids(), _rank_key() (+26 more)
...
### Community 222 - "BrainFailoverManager"
Cohesion: 0.09
...
### Community 224 - "provider_max_rpm"
Cohesion: 0.10
...
Cohesion: 0.09
Nodes (28): _make_engine(), tests/test_crispy_workflow.py — CRISPY workflow engine hardening tests. Tests…, Provide isolated DB + artifact + workspace paths., Create a WorkflowEngine with isolated storage., TestAbortOnFailure, TestPhaseSequence, TestPhaseSequenceError, TestWorkspaceIsolation (+20 more)
...
### Community 235 - "tests/conftest.py"
Cohesion: 0.08
...
### Community 236 - "openclaw_gateway.py"
Cohesion: 0.15
...
### Community 268 - "test_output_filter.py"
Cohesion: 0.06
...
### Community 269 - "test_ephemeral_reaper.py"
Cohesion: 0.10
...
Cohesion: 0.04
Nodes (53): _get_portfolio_manager(), get_skill_bindings(), Any, BaseModel, Enum, str, services/skill_bindings.py — Runtime Skill Bindings for Specialist Agents Wires…, A runtime-callable skill that specialists can execute through the workflow… (+45 more)
...
### Community 298 - "RuntimeHealthService"
Cohesion: 0.10
...
Cohesion: 0.06
Nodes (22): Initiative, Create and register a new initiative, returning it., Add a pre-built Initiative (e.g. from the intelligence layer)., Look up an initiative by ID., A portfolio initiative (epic) prioritised via WSJF. WSJF (Weighted Shortest Job…, Aggregate cost of delay (CoD) used as the WSJF numerator., Weighted Shortest Job First score — higher schedules sooner., Associate an agile sprint that delivers part of this initiative. (+14 more)
...
### Community 336 - "ensure_self_company"
Cohesion: 0.09
...
### Community 366 - "test_phase4_runtime_resilience.py"
Cohesion: 0.15
...
### Community 393 - "SeoCheckDefinition"
Cohesion: 0.09
...
### Community 427 - "TestModelRegistryUpdates"
Cohesion: 0.13
...
### Community 441 - "test_webui_provider_priority.py"
Cohesion: 0.21
...
### Community 450 - "services/background.py"
Cohesion: 0.04
Nodes (76): get_skill_registry_safe(), Return the global SkillRegistry if set, else None. Used by onboarding and other…, get_trend_watcher(), _await_hermes_ready(), BackgroundServices, _env_float(), _env_on(), _hydrate_scheduler_bounded() (+68 more)

### Community 451 - "traffic_director.py"
Cohesion: 0.13
...
### Community 495 - "is_anthropic_base_url"
Cohesion: 0.12
...
### Community 511 - "services/seo_audit.py"
Cohesion: 0.11
...
### Community 524 - "test_brain_config_api.py"
Cohesion: 0.12
...
### Community 528 - "AgentJobSnapshot"
Cohesion: 0.18
...
### Community 540 - "test_self_heal.py"
Cohesion: 0.11
...
### Community 549 - "TestAgentRunnerPublicPlanMethod"
Cohesion: 0.22
...
### Community 558 - "test_gh_brain_failover.py"
Cohesion: 0.11
...
### Community 564 - "cowork_session.py"
Cohesion: 0.15
...
### Community 592 - "test_agent_free_brain.py"
Cohesion: 0.05
...
### Community 604 - "test_daily_2026_07_24.py"
Cohesion: 0.20
...
### Community 644 - "_is_bedrock_model_id"
Cohesion: 0.27
...
### Community 667 - "get_failover_manager"
Cohesion: 0.08
...
### Community 670 - "_probe_failure_reason"
Cohesion: 0.19
...
### Community 675 - "test_tasks_reconciler_todo_requeue.py"
Cohesion: 0.20
...
### Community 679 - "test_doctor_service_token_check.py"
Cohesion: 0.23
...
### Community 681 - "TestAnthropicWorkspaceIdCapture"
Cohesion: 0.33
...
### Community 735 - "brain_liveness.py"
Cohesion: 0.22
...
### Community 760 - "TestModelsEndpointAliases"
Cohesion: 0.31
...
### Community 766 - "_redact_for_notification"
Cohesion: 0.24
...
### Community 767 - "TestNoNvidiaFallbackIsRetired"
Cohesion: 0.22
...
### Community 798 - "company_api.py"
Cohesion: 0.04
Nodes (98): backend/ceo_router.py — observability and manual control for the CEO. Surfaces…, Reject non-admin callers for routes that spend provider budget. Delegates to…, _require_admin(), account_lifecycle(), AccountLifecycleResponse, auto_recommend_skills(), cancel_onboarding(), create_company() (+90 more)

### Community 799 - "TestParsing"
Cohesion: 0.22
...
### Community 806 - "openclaw_reverse_proxy"
Cohesion: 0.22
...
### Community 839 - "TestPolicyAuthoringUiStableClaim"
Cohesion: 0.22
...
### Community 842 - "TestPaidPolicyDurability"
Cohesion: 0.22
...
### Community 871 - "commercial_equivalent.py"
Cohesion: 0.50
...
### Community 874 - "TestPoliciesGovernanceStableClaim"
Cohesion: 0.25
...
### Community 878 - "TestOneIdCanBelongToSeveralProviders"
Cohesion: 0.39
...
### Community 886 - "platform_controls_router.py"
Cohesion: 0.29
...
### Community 890 - "_load_local_metrics_since"
Cohesion: 0.43
...
### Community 891 - "Workspace Issues"
Cohesion: 0.29
...
### Community 956 - "test_doctor_coding_brain.py"
Cohesion: 0.38
...
### Community 972 - "test_server_autonomy_and_index_fixes.py"
Cohesion: 0.29
...
### Community 1025 - "Agent API Issues"
Cohesion: 0.40
...
### Community 1031 - "Network and Tunnel Issues"
Cohesion: 0.40
...
### Community 1052 - "TestAgentRunnerExecution"
Cohesion: 0.33
...
### Community 1055 - "test_activity_logs.py"
Cohesion: 0.67
...
### Community 1068 - "_InMemoryErrorLogHandler"
Cohesion: 0.50
...
### Community 1070 - "_scheduler_on_fire"
Cohesion: 0.50
...
### Community 1093 - "TestModelRoleSeparation"
Cohesion: 0.40
...
### Community 1094 - "Claude Code Specific Issues"
Cohesion: 0.50
...
### Community 1095 - "Langfuse Issues"
Cohesion: 0.50
...
### Community 1100 - "Runtime & Onboarding Issues"
Cohesion: 0.50
...
- **Why does `_fixture()` connect `_fixture` to `WebsiteScanner`, `TaskSpec`, `test_brain_patch_service_token.py`, `test_llm_router_strategies.py`, `_Recorder`, `_FakeSandbox`, `test_llm_router_queue_cache.py`, `PolicyEngine`, `test_operational_incidents.py`, `ImprovementLoop`, `test_ai_insights.py`, `BrainWatchdog`, `test_llm_router_resilience.py`, `config.py`, `llm/router.py`, `Task`, `SelfHealingAgent`, `test_failover_client_shared.py`, `test_company_api.py`, `get_self_healing_agent`, `test_telegram_service_webhook.py`, `UserRole`, `test_telegram_webhook.py`, `test_unit8_model_catalog.py`, `test_llm_router_e2e.py`, `test_model_router.py`, `brain_config.py`, `test_workflow_orchestrator_scoping.py`, `SeoAuditEngine`, `direct_chat.py`, `test_gh_brain_failover.py`, `tasks/service.py`, `test_provider_router.py`, `TaskStatus`, `validate_policy_text`, `CEOLedger`, `ChatHistoryStore`, `test_openclaw_endpoints.py`, `PrimeAgentAdapter`, `E2BSandboxSession`, `AgentJobManager`, `TokenBudget`, `Agency`, `ResearchTask`, `KeyStore`, `TestClient`, `test_agent_free_brain.py`, `SQLiteStore`, `test_startup_warmup.py`, `test_procedural_memory.py`, `test_telegram_auto_approve.py`, `e2e/test_browser.py`, `resolve_e2b_config`, `test_autonomy_status.py`, `WorkflowBuildRequest`, `FreeBuffAgent`, `TestHarnessAdapter`, `test_local_brain_state.py`, `test_phase5_doctor.py`, `test_knowledge_sync.py`, `test_refresh_agent_built_proof.py`, `test_sam_livekit.py`, `cost_tracker.py`, `SchedulerStore`, `get_task_store`, `test_context_rulebook.py`, `run_task`, `FailoverResult`, `test_llm_router_tpm.py`, `test_issue_intake.py`, `test_agent_tool_governance.py`, `test_new_features_e2e.py`, `_step`, `ArtifactStore`, `test_trend_watcher.py`, `claim`, `get_failover_manager`, `NotificationDispatcher`, `persist_plan_spec`, `test_response_cache.py`, `MCPClient`, `test_openclaw_gateway.py`, `TestSwarmRoleRouting`, `test_portfolio_intake.py`, `test_doctor_service_token_check.py`, `test_task_service_failed_comment.py`, `test_llm_router_disabled.py`, `test_daily_2026_07_27.py`, `test_tasks_reconciler_todo_requeue.py`, `test_telegram_freebuff.py`, `clear_cooldowns`, `OllamaCircuitBreaker`, `_job_text`, `_Budget`, `test_colibri_brain_shim.py`, `test_features_api.py`, `test_task_brain_preflight.py`, `test_video_transcript.py`, `TrendWatcher`, `test_process_quick_note_workflow.py`, `TestRouterIntegration`, `AgentSwarm`, `WorkflowRun`, `WorkflowRun`, `TestEstimateTokensForMessages`, `TestClient`, `tests/conftest.py`, `Usage`, `ContextPruner`, `test_agile_api.py`, `test_app_settings.py`, `api_keys_for`, `test_control_plane_api.py`, `test_persistent_memory.py`, `SecurityScanner`, `test_output_filter.py`, `test_ephemeral_reaper.py`, `test_platform_controls.py`, `resolve_active_brain`, `test_rate_limiter.py`, `test_task_clarification.py`, `test_kimi_bridge_server.py`, `test_sam_voice.py`, `test_nvidia_model_discovery.py`, `_resolve_user_github_token`, `reset_cache`, `TestNormalizeResponseFormat`, `test_mcp_governance.py`, `test_provider_state_durability.py`, `OrchestratorCheckpointStore`, `session_retro.py`, `_resolve_push_token`, `test_catalogue_probe.py`, `analyze_page`, `_resolve_brain_provider`, `TestMongoGate`, `seo_api.py`, `OrchestratorQueue`, `test_purge_backlog.py`, `_FakeFiles`, `test_regression.py`, `test_agent_scripts_share_one_model_list.py`, `test_crispy_burn_in.py`, `test_implement_agent_routing.py`, `test_skill_registry_boot_refresh.py`, `isolated_telegram_config`, `test_scheduler_hydration_bounded.py`, `test_provider_enable_disable.py`, `_undeclared`, `test_dashboard_cache.py`, `SeoCheckDefinition`, `test_service_token.py`, `test_harness_spec.py`, `CEOSupervisor`, `test_agency_fix.py`, `test_monitor_lib.py`, `test_v4_api.py`, `test_webui_provider_priority.py`, `test_doctor_coding_brain.py`, `TestTheWorkflowIsSafeAndReadOnly`, `services/background.py`, `traffic_director.py`, `test_ping.py`, `test_runtimes_health_endpoint.py`, `test_telegram_diag_endpoint.py`, `clear_override`, `test_task_store_fails_loud_in_production.py`, `reset_kv_state`, `get_registry`, `test_voice_pipeline.py`, `ClaudeCodeAdapter`, `client`, `TestFeaturesAPI`?**
  _High betweenness centrality (0.098) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `TaskSpec`, `proxy.py`, `test_agent_runner.py`, `loop.py`, `ReactScratchpad`, `PolicyEngine`, `test_agent_tool_governance.py`, `AgentSessionStore`, `ContextManager`, `test_governance_api.py`, `get_failover_manager`, `test_failover_client_shared.py`, `TestAgentRunnerExecution`, `TestAgentRunnerSafety`, `CEODispatcher`, `MultiAgentSwarm`, `backend/server.py`, `test_empirical_verify.py`, `TestAgentRunnerPublicPlanMethod`, `ExecutionRequest`, `MCPClient`, `direct_chat.py`, `StuckDetector`, `Initiative`, `test_daily_automation_2026_07_11.py`, `WorkspaceTools`, `_resolve_push_token`, `E2BSandboxSession`, `AgentJobManager`, `TokenBudget`, `Agency`, `test_agent_chat_integration.py`, `test_agent_free_brain.py`, `LocalWorkspace`, `FreeBuffAgent`, `InternalAgentAdapter`, `WorkflowBuildRequest`, `WorkflowRun`, `UserMemoryStore`, `GitHubTools`, `AdaptiveHalter`, `ContextPruner`, `test_runtime_governance.py`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `Task` connect `Task` to `delegate_seo_findings`, `test_issue_intake.py`, `_fixture`, `test_schedule_growth_invariants.py`, `test_trend_scoping.py`, `company_api.py`, `backend/server.py`, `test_portfolio_intake.py`, `test_tasks_reconciler_todo_requeue.py`, `test_task_service_failed_comment.py`, `brain_config.py`, `tasks/service.py`, `test_task_source_id_race.py`, `TaskStatus`, `tasks/models.py`, `_ts_to_float`, `TaskDispatcher`, `test_task_brain_preflight.py`, `seo_api.py`, `ensure_self_company`, `v4_api.py`, `test_purge_backlog.py`, `tasks/api.py`, `test_sam_livekit.py`, `test_phase4_runtime_resilience.py`, `test_phase6_workflow.py`, `get_task_store`?**
