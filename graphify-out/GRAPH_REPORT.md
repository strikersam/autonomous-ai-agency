...
## Corpus Check
- 1512 files · ~2,189,163 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 54 file(s) not represented in the graph (top: (none) 16, .bat 5, .css 5)

## Summary
- 30640 nodes · 57186 edges · 1279 communities (1112 shown, 119 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 3338 edges (avg confidence: 0.92)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8e95e527`
...
## Communities (1279 total, 119 thin omitted)

### Community 0 - "HTTPException"
Cohesion: 0.03
Nodes (126): admin_seed(), call_llm(), chat_send(), clear_cost_attribution(), clear_response_cache(), create_access_token(), create_api_key(), create_github_pr() (+118 more)

### Community 1 - "LLMRequest"
Cohesion: 0.03
Nodes (110): ProviderConfig, One configured endpoint. ``kind`` selects the adapter: ``openai`` (any OpenAI-…, OpenAICompatible, Any, AsyncClient, Perform one completion. Raises ``PermanentError``/``TransientError``., Cheap liveness probe. Never raises — returns a status dict., Build auth headers according to the configured auth style. (+102 more)

### Community 2 - "TaskSpec"
Cohesion: 0.04
Nodes (102): agent/job_manager.py — Async agent job lifecycle manager. Manages agent jobs…, kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, AiderAdapter, TaskResult, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Run aider non-interactively via `--message` flag., Adapter for Aider — TIER 3 specialized git-aware code editor. (+94 more)

### Community 3 - "proxy.py"
Cohesion: 0.03
Nodes (169): Describes a single worker's task and constraints., WorkerSpec, get_sam(), middleware, admin_control(), admin_create_key(), admin_create_user(), admin_delete_user() (+161 more)
...
Cohesion: 0.03
Nodes (114): Attempt, int, payload_key(), packages/llm/cache.py — layered caching. Five independent layers, each with its…, Exact-match cache key over the fields that change the answer. Routing…, text_key(), openai_body_from_response(), Any (+106 more)
...
Cohesion: 0.02
Nodes (118): CacheManager, cosine_similarity(), _Entry, LRUCache, Any, T, Live (unexpired) entries — used by the semantic layer's scan., Cosine similarity between two vectors, 0.0 when either is degenerate. (+110 more)
...
Cohesion: 0.05
Nodes (71): DetectedIssue, ImprovementLoop, ImprovementLoopState, IssueCategory, IssueSeverity, _now(), Any, Enum (+63 more)
...
Cohesion: 0.04
Nodes (80): BrainConfig, BrainConfigPatch, BrainConfigStore, default_brain_config(), get_brain_config_store(), provider_base_url(), BaseModel, Read the persisted config from Mongo (primary) or sqlite (mirror). Falls back… (+72 more)
...
Cohesion: 0.05
Nodes (37): BaseModel, field_validator, A single occurrence of a check firing on a specific URL., Aggregated report row - Screaming Frog CSV compatible., Site-level facts discovered during the crawl., Request to run an SEO/GEO/AIO audit against a website., SeoAuditRequest, SeoIssueInstance (+29 more)

### Community 25 - "loop.py"
Cohesion: 0.03
Nodes (109): loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., # NOTE: "ollama_base" is kept for backwards compatibility; this runner only…, _egress_policy_reason(), agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Return why governance policy blocks *host*, or None. Runs strictly *after* the…, _load(), Import the governance layer once, recording why if it is absent., governance_enabled() (+101 more)
...
### Community 27 - "TestAddConversationCacheBreakpoints"
Cohesion: 0.06
...
Cohesion: 0.03
Nodes (70): Backoff policy for retryable failures., RetryConfig, BreakerState, str, _digest(), get_ring(), KeyRing, KeyState (+62 more)

### Community 31 - "AgentSessionStore"
Cohesion: 0.05
Nodes (59): Agent subsystem — planner / executor / verifier loop., AgentEvent, AgentPlan, AgentRunRequest, AgentSession, AgentSessionCreateRequest, AgentSessionMessage, AgentStep (+51 more)
...
### Community 33 - "OnboardingService"
Cohesion: 0.04
Nodes (63): Evidence, OnboardingProgress, Evidence supporting a system detection., Tracks the onboarding progress for a company., Result of a repository scan with detected stack and systems., Inferred technology stack from website/repo analysis., RepoScanResult, StackInference (+55 more)
...
Cohesion: 0.03
Nodes (63): DetectedSystem, A business system detected on a company's website or in their stack., Get the most confident evidence description., Create a new company in SQLite., Get a company by ID from SQLite., Update a company in SQLite., Delete a company and all associated data from SQLite., List companies from SQLite. (+55 more)
...
Cohesion: 0.05
Nodes (62): ApprovalCheckpoint, ApprovalRequest, ClarifyRequest, _coerce_ts(), CommentAddRequest, ExecutionLogEntry, Any, BaseModel (+54 more)
...
### Community 61 - "enforcement.py"
Cohesion: 0.05
Nodes (47): Feed LLM token/cost spend into the governance session budget. Kept separate…, Charge sub-agent nesting depth and enforce the ``max_depth`` ceiling. Isolates…, cost_for_tokens(), Return the USD cost for (prompt_tokens, completion_tokens) on *model*. Returns…, BudgetExceeded, classify(), evaluate_call(), guard_tool_call() (+39 more)

### Community 62 - "TaskStatus"
Cohesion: 0.03
Nodes (127): autonomy_tick(), quick_notes_submit(), _QuickNoteBody, Execute ONE pending task synchronously. Called by the cron workflow every 2…, Submit a quick-note URL or instruction from the dashboard FAB., packages/ai/self_heal.py — automatic brain self-healing. When the active brain…, Helpers that turn scheduler and playbook activity into real tasks., Creates tasks from scheduler and playbook runs using one workflow. (+119 more)
...
Cohesion: 0.04
Nodes (64): Record token usage for *model* (fire-and-forget, never raises). ``tag`` is a…, record_usage(), clear_cooldowns(), _dead_model_key(), get_dead_models(), _is_model_dead(), is_provider_on_cooldown(), _mark_model_dead() (+56 more)

### Community 79 - "settings.py"
Cohesion: 0.04
Nodes (52): build_governance_router(), Any, APIRouter, backend/governance_router.py — read and operate the governance layer. Mounted…, Reject non-admin callers. Mirrors the RBAC check used elsewhere in this backend…, _require_admin(), packages.config — single source of truth for all configuration. Every module…, packages/config/settings.py — typed configuration. This is the ONLY module in… (+44 more)
...
### Community 82 - "test_provider_router.py"
Cohesion: 0.05
...
Cohesion: 0.03
Nodes (117): AgentPhaseError, AgentRunner, _check_extra_kwargs(), _enforce_signature(), Any, Exception, Path, Raise TypeError if fn's signature drifts from the locked contract (Pydantic… (+109 more)
...
### Community 108 - "test_self_heal_v2.py"
Cohesion: 0.05
Nodes (71): Reset the singleton (for tests)., reset_failover_manager(), _blocked_retire_age_sec(), _heal_blocked_backlog(), _heal_brain_failover(), _heal_purge_backlog(), _heal_stuck_tasks(), _heal_task_duplicates() (+63 more)
...
Cohesion: 0.07
Nodes (30): models/seo_audit.py - SEO / GEO / AIO Audit Contracts Typed Pydantic models for…, Snapshot of one crawled page with the on-page facts the checks used., Lightweight listing entry for past audits., Static definition of a single audit check (catalog entry)., SeoAuditSummary, SeoCheckDefinition, SeoPageAudit, _count_syllables() (+22 more)
...
Cohesion: 0.07
Nodes (26): build_tool_calling_router(), Return a router limited to providers that pass ``tools`` through intact. The…, CommercialFallbackRequiredError, _exponential_backoff_cooldown(), _get_director(), is_commercial_provider(), _normalized_provider_type(), _ollama_reasoning_effort() (+18 more)
...
Cohesion: 0.08
Nodes (26): _enabled(), get_available_models(), invalidate_cache(), is_model_available(), Ollama model availability check with TTL cache. Keeps a short-lived cache of…, Force the next call to re-probe Ollama (useful in tests)., Return True if *model* is in the Ollama tag list (or health checks off).…, Return the set of model names currently present in Ollama. Returns an empty set… (+18 more)
...
Cohesion: 0.03
Nodes (67): get_skill(), list_skills(), List all available skills with optional filtering. Returns the skill catalog…, Get a single skill by its ID., SpecialistFamily, Find all specialists of a specific family., Find specialists that can handle a task with given capabilities., A specialist agent that can be provisioned for company-specific tasks. (+59 more)
...
### Community 134 - "TaskPriority"
Cohesion: 0.06
Nodes (60): _capability_tags(), create_task_from_oldest_open_issue(), intake_issue(), _issue_labels(), issue_source_id(), map_issue_to_task(), Any, Task (+52 more)
...
Cohesion: 0.09
Nodes (48): _blocked_result(), _governance_check(), Any, TaskResult, Build the failed TaskResult returned when policy denies a dispatch. A result…, Evaluate a runtime dispatch against policy; audit it either way. Returns…, Full record of a routing decision — audit-trail entry., Attempt paid escalation through ProviderManager. Routes the task to the first… (+40 more)

### Community 144 - "test_runtimes.py"
Cohesion: 0.04
...
Cohesion: 0.05
Nodes (33): get_tool_registry(), Any, Path, Register a tool definition., Decorator to register a function as an agent tool. Usage::…, Remove a tool from the registry. Returns True if removed., Look up a tool by name., Return all registered tools. (+25 more)
...
### Community 150 - "test_kimi_bridge_server.py"
Cohesion: 0.05
...
Cohesion: 0.03
Nodes (89): allow_paid_brain(), BrainResolution, get_brain_config(), Convenience wrapper used by the agent loop + brain resolver., get_active_brain_sync(), get_provider_role_tags(), _host_is_openai_compatible(), invalidate_brain_cache() (+81 more)

### Community 157 - "telegram_bot.py"
Cohesion: 0.07
Nodes (58): Return a Markdown-v1-safe preview string under ``max_chars``. Used by the…, sanitize_paste_for_preview(), _admin_headers(), _answer_callback(), _api_headers(), _check_rate_limit(), cmd_control(), cmd_cost() (+50 more)
...
### Community 160 - "._log_event"
Cohesion: 0.09
Nodes (22): _extract_slices_from_plan(), Path, PhaseType, WorkflowRun, Append an event to the workflow event log., Create a new WorkflowRun and begin pre-gate phase execution. The run is…, Return current WorkflowRun snapshot or None., Approve the plan — lifts the ApprovalGate and resumes execution. Raises… (+14 more)

### Community 161 - "TestHarnessAdapter"
Cohesion: 0.08
Nodes (8): get_harness_adapter(), harness_catalog(), Return the full ECC harness catalog with capabilities. Public — no auth…, tests/test_harness_adapter.py — Tests for ECC cross-harness adapter., Harness detection, normalization, and registration., Harness session tracking and metrics., TestHarnessAdapter, TestHarnessRegistry

### Community 162 - "AnthropicProvider"
Cohesion: 0.04
...
### Community 165 - "test_skill_executors_live.py"
Cohesion: 0.16
...
### Community 166 - "test_p0_roadmap_b1_c2_a3.py"
Cohesion: 0.06
...
### Community 173 - "resolve_component_model"
Cohesion: 0.06
...
Cohesion: 0.06
Nodes (40): E2BAdapter, Any, TaskResult, Declare ``E2B_API_KEY`` as a required env dependency. The base ``preflight``…, Execute a task inside a fresh E2B sandbox. Flow: 1. Open an…, Run ``pytest`` inside the sandbox. Returns ``(output, passed)``.…, Runtime adapter that executes tasks inside an E2B sandbox. Activation:…, Available iff config resolves AND the SDK is importable. Never raises — a… (+32 more)

### Community 186 - "test_process_quick_note_workflow.py"
Cohesion: 0.05
...
### Community 192 - "_register_builtin_tools"
Cohesion: 0.07
Nodes (26): browse_page(), Open *url* in a real browser, return its rendered text, and close. Fail-soft:…, Register the built-in agent tools that are always available., Register the interactive-browser capability (agent/browser.py). Unlike…, Register the current-time capability (agent/time_tool.py)., Register the Web Reach capability (agent/web_reach.py): zero-key internet…, _register_browser_tools(), _browse_page_tool() (+18 more)
...
Cohesion: 0.05
Nodes (49): build_seo_roadmap(), delegate_seo_findings(), _expire_stale_pending_report(), export_seo_audit(), get_seo_audit(), list_seo_audits(), plan_seo_sprint(), BaseModel (+41 more)
...
### Community 222 - "provider_max_rpm"
Cohesion: 0.07
...
Cohesion: 0.10
Nodes (22): AgentRole, _fake_artifact(), TestSlice, Artifact, A durable, phase-produced document (markdown or JSON)., An independently deliverable unit of work within the execute phase. Each slice…, Return the first artifact matching *name*, or None., Return the Slice with *slice_id*, or None. (+14 more)

### Community 225 - "gateway.py"
Cohesion: 0.03
Nodes (70): AlertHandler, BudgetTracker, Counter, _Dimensions, get_budget(), _month(), Any, packages/llm/budget.py — token and cost accounting with spend alerts. Tracks… (+62 more)
...
### Community 227 - "test_webui_provider_priority.py"
Cohesion: 0.06
...
Cohesion: 0.07
Nodes (47): get_approval_store(), Replace the process-wide gate. Tests only., reset_gate(), _client(), parametrize, TestClient, Tests for the governance HTTP surface and the AgentRunner integration. The…, Policy is a git-reviewed file. An HTTP mutation route would make "who changed… (+39 more)
...
Cohesion: 0.08
Nodes (26): dead_models(), discover_models(), _fresh_entry(), mark_dead(), _models_url(), _parse_ids(), Any, Ask a provider which models the configured API key may actually use.… (+18 more)
...
### Community 323 - "test_direct_chat_evolution.py"
Cohesion: 0.12
...
Cohesion: 0.11
Nodes (15): packages/config/mcp_protocol.py — single source of truth for the MCP handshake…, _captured_request_headers(), _fake_post(), _make_client(), Any, tests/test_mcp_routing_headers.py — MCP 2026-07-28 Mcp-Method / Mcp-Name…, tools/call requests must include Mcp-Name; other methods must not., Run client.call_tool() and capture the request headers. (+7 more)
...
### Community 372 - "OrchestratorSupervisor"
Cohesion: 0.21
...
### Community 396 - "self_heal_brain_and_unblock_tasks"
Cohesion: 0.10
...
### Community 419 - "build_tool_prompt"
Cohesion: 0.15
...
### Community 434 - ".on_task_complete"
Cohesion: 0.18
...
### Community 462 - "TestAdapterMetadata"
Cohesion: 0.05
...
### Community 518 - "tests/conftest.py"
Cohesion: 0.04
Nodes (66): _get_current_user_thunk(), _get_optional_user_thunk(), Request, get_current_user(), get_optional_user(), Get user if authenticated, otherwise return None (for public endpoints)., Item, app_client() (+58 more)

### Community 519 - "operational_incidents.py"
Cohesion: 0.13
...
### Community 526 - "test_schedule_persistence.py"
Cohesion: 0.15
...
### Community 544 - "test_brain_failover_413.py"
Cohesion: 0.13
...
### Community 551 - "test_contract_enforcement.py"
Cohesion: 0.17
...
### Community 569 - "AdminDigestRouterAuthTests"
Cohesion: 0.20
...
### Community 601 - "OperationalIncidentTracker"
Cohesion: 0.12
...
### Community 610 - "render_router.py"
Cohesion: 0.14
...
### Community 612 - "test_daily_automation_2026_07_09.py"
Cohesion: 0.16
...
### Community 641 - "test_setup_api.py"
Cohesion: 0.23
...
### Community 665 - "provider_key_present"
Cohesion: 0.20
Nodes (10): _brain_provider_status(), get_brain_policy_route(), Return per-provider metadata for the GET endpoint. Iterates every provider in…, Return the discovered model list for *provider_id*, or ``[]`` if unknown., Return the active brain config + per-provider key-present flags. The response…, _served_models(), provider_key_present(), True when the env var for *provider*'s key is set (or it's Ollama). (+2 more)
...
### Community 743 - "test_agent_free_brain.py"
Cohesion: 0.10
...
### Community 744 - "test_telegram_task_callback.py"
Cohesion: 0.12
...
### Community 755 - "agent/output_filter.py"
Cohesion: 0.32
...
### Community 756 - "_execute_skill_impl"
Cohesion: 0.13
...
### Community 762 - "TestTheGatewayRegistryOffersOnlyLiveModels"
Cohesion: 0.22
...
### Community 797 - "Workspace Isolation Architecture"
Cohesion: 0.17
...
### Community 820 - "TestCompanyGraphModels"
Cohesion: 0.17
...
### Community 827 - "require_authenticated"
Cohesion: 0.13
Nodes (15): FastAPI dependency: require any authenticated user., require_authenticated(), client(), _coding_brain_check(), tests/test_doctor_coding_brain.py Surfaces the North Mini Code coding-brain…, With NORTH_MINI_CODE_DEFAULT off, the check warns and says so., test_coding_brain_check_reflects_flag_off(), test_doctor_includes_coding_brain_check() (+7 more)
...
### Community 837 - "open_phase_report"
Cohesion: 0.10
...
### Community 874 - "portfolio_refresh.py"
Cohesion: 0.67
...
### Community 963 - "test_seo_audit_pending_expiry.py"
Cohesion: 0.43
...
Cohesion: 0.05
Nodes (50): provider_access_tier(), _provider_field(), provider_sort_key(), ProviderConfig, Infer an access tier from *hostname*, longest matching suffix winning. Returns…, _tier_from_hostname(), local_brain_enabled(), local_brain_provider_config() (+42 more)
...
### Community 1021 - "_check_storage_health"
Cohesion: 0.12
...
### Community 1086 - "_clean_director"
Cohesion: 0.50
...
### Community 1111 - "test_autonomous_agency_e2e.py"
Cohesion: 0.10
...
### Community 1116 - "test_v4_reliability_regression.py"
Cohesion: 0.07
Nodes (21): Fail preflight when the provider extension is configured but missing. Without…, Any, Structured, actionable preflight validation issue., Preflight result returned before a runtime task starts., Return a health snapshot. Must not raise; return available=False instead., Return runtime-specific dependency declarations for preflight., Return a best-effort tool availability report for diagnostics., Ensure the requested workspace exists and is writable. (+13 more)
...
Cohesion: 0.02
Nodes (222): _agent_timeout_fallback_response(), AgentStatusEntry, AgentStatusResponse, AgentToolCallEntry, ApiKeyCreate, auth_me(), AuthorizeReposBody, auto_recommend_skills() (+214 more)
...
### Community 1154 - "_redact_for_notification"
Cohesion: 0.24
...
### Community 1231 - "test_log_monitor_storm_guard.py"
Cohesion: 0.48
...
### Community 1299 - "gather_render_evidence"
Cohesion: 0.50
...
## Knowledge Gaps
- **3536 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3531 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 13531 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **119 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `_fixture()` connect `_fixture` to `TaskSpec`, `tests/conftest.py`, `llm/router.py`, `test_llm_router_queue_cache.py`, `E2BSandboxSession`, `AgentJobManager`, `test_gh_brain_failover.py`, `test_llm_router_strategies.py`, `Task`, `ImprovementLoop`, `test_model_router.py`, `BrainConfig`, `SelfHealingAgent`, `SeoAuditEngine`, `loop.py`, `WorkflowRun`, `test_llm_router_resilience.py`, `test_brain_failover_413.py`, `test_company_api.py`, `FreeBuffAgent`, `BrainWatchdog`, `OnboardingService`, `test_failover_client_shared.py`, `_mock_provider_records`, `PrimeAgentAdapter`, `test_telegram_service_webhook.py`, `Agency`, `test_e2b_data_flow.py`, `test_telegram_webhook.py`, `test_unit8_model_catalog.py`, `MCPClient`, `UserRole`, `AgentSwarm`, `services/background.py`, `routed`, `TaskStatus`, `enforcement.py`, `AgentDefinition`, `ChatHistoryStore`, `test_openclaw_endpoints.py`, `_clean_director`, `ResearchTask`, `ai/router.py`, `settings.py`, `test_provider_router.py`, `resolve_e2b_config`, `config.py`, `TestClient`, `test_ai_insights.py`, `OperationalIncidentTracker`, `sam`, `test_procedural_memory.py`, `SQLiteStore`, `claim`, `backend/server.py`, `e2e/test_browser.py`, `_resolve_push_token`, `test_autonomy_status.py`, `OutputFilter`, `test_startup_warmup.py`, `test_daily_automation_2026_07_09.py`, `test_local_brain_state.py`, `test_refresh_agent_built_proof.py`, `test_tasks_reconciler_todo_requeue.py`, `test_knowledge_sync.py`, `run_task`, `test_context_rulebook.py`, `Specialist`, `ArtifactStore`, `TaskPriority`, `KeyStore`, `test_new_features_e2e.py`, `test_kimi_bridge_server.py`, `_step`, `BackgroundAgent`, `resolve_active_brain`, `test_telegram_freebuff.py`, `test_trend_watcher.py`, `TestHarnessAdapter`, `test_rate_limiter.py`, `test_changelog_check_workflow.py`, `test_openclaw_gateway.py`, `persist_plan_spec`, `TestEstimateTokensForMessages`, `test_daily_2026_07_27.py`, `test_ceo_router.py`, `E2BAdapter`, `test_process_quick_note_workflow.py`, `OllamaCircuitBreaker`, `_job_text`, `_Budget`, `_start_ceo_agency`, `timedelta`, `test_agent_tool_governance.py`, `test_features_api.py`, `TestAgentRunnerSafety`, `parse_event_stream`, `TrendWatcher`, `test_provider_state_durability.py`, `test_video_transcript.py`, `NotificationDispatcher`, `WorkflowRun`, `test_sam_livekit.py`, `SchedulerStore`, `CEOLedger`, `gateway.py`, `test_webui_provider_priority.py`, `test_portfolio_intake.py`, `test_agent_free_brain.py`, `test_telegram_task_callback.py`, `test_agile_api.py`, `test_app_settings.py`, `get_scheduler`, `TestClient`, `test_task_clarification.py`, `ContextPruner`, `test_colibri_brain_shim.py`, `nvidia_models.py`, `test_persistent_memory.py`, `SecurityScanner`, `test_llm_router_e2e.py`, `_clean_phases`, `analyze_page`, `model_discovery.py`, `test_platform_controls.py`, `test_mcp_governance.py`, `test_sam_voice.py`, `OrchestratorQueue`, `test_nvidia_model_discovery.py`, `test_task_service_failed_comment.py`, `test_catalogue_probe.py`, `require_authenticated`, `SeoFixRequest`, `session_retro.py`, `test_purge_backlog.py`, `test_direct_chat_evolution.py`, `_resolve_user_github_token`, `test_scheduler_hydration_bounded.py`, `test_regression.py`, `test_agent_scripts_share_one_model_list.py`, `test_crispy_burn_in.py`, `test_provider_enable_disable.py`, `test_skill_registry_boot_refresh.py`, `capture_screens.py`, `isolated_telegram_config`, `TestMongoGate`, `test_phase5_doctor.py`, `test_telegram_auto_approve.py`, `TestSwarmRoleRouting`, `_undeclared`, `test_service_token.py`, `test_harness_spec.py`, `test_agency_fix.py`, `_Recorder`, `test_dashboard_cache.py`, `get_registry`, `OrchestratorCheckpointStore`, `test_monitor_lib.py`, `TestTheWorkflowIsSafeAndReadOnly`, `test_v4_api.py`, `test_ping.py`, `api_keys_for`, `test_telegram_diag_endpoint.py`, `TestFeaturesAPI`, `ProviderConfig`, `test_voice_pipeline.py`, `client`, `clear_override`, `cost_tracker.py`, `TestNormalizeResponseFormat`?**
  _High betweenness centrality (0.107) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `TaskSpec`, `proxy.py`, `test_governance_api.py`, `E2BSandboxSession`, `AgentJobManager`, `AdaptiveHalter`, `ReactScratchpad`, `loop.py`, `BackgroundAgent`, `WorkflowRun`, `ContextManager`, `test_empirical_verify.py`, `AgentSessionStore`, `test_brain_failover_413.py`, `FreeBuffAgent`, `test_failover_client_shared.py`, `MultiAgentSwarm`, `Agency`, `MCPClient`, `StuckDetector`, `direct_chat.py`, `E2BAdapter`, `TestAgentLoopMCPIntegration`, `enforcement.py`, `test_daily_automation_2026_07_11.py`, `TokenBudget`, `UserMemoryStore`, `CEODispatcher`, `test_agent_tool_governance.py`, `TestAgentRunnerSafety`, `LocalWorkspace`, `test_agent_chat_integration.py`, `test_autonomous_agency_e2e.py`, `backend/server.py`, `_resolve_push_token`, `TestAgentRunnerExecution`, `test_daily_automation_2026_07_09.py`, `test_agent_free_brain.py`, `WorkspaceTools`, `test_backend_server_features.py`, `InternalAgentAdapter`, `GitHubTools`, `ContextPruner`, `workflow_orchestrator.py`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderRouter` to `test_all_providers_discovery.py`, `implement_agent.py`, `TrafficDirector`, `test_bedrock_live.py`, `failover_client.py`, `TestOpenAiToBedrockConverse`, `test_bedrock_provider.py`, `kimi_bridge_provider_config`, `direct_chat.py`, `TestLegacyRouterCacheTTL`, `test_anthropic_refusal_fallback.py`, `system_instruction`, `ai/router.py`, `TestRouterIntegration`, `test_provider_router.py`, `TestLegacyRouterServerFallback`, `_payload`, `backend/server.py`, `ProviderConfig`, `NvidiaProvider`, `TestAnthropicPayloadStructuredOutput`, `test_colibri_brain_shim.py`?**
