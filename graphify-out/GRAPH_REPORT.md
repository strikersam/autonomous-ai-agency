...
## Corpus Check
- 1487 files · ~2,162,903 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 30206 nodes · 55925 edges · 1300 communities (1127 shown, 118 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 2731 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5dcc314c`
...
Cohesion: 0.03
Nodes (127): int, get_budget(), packages/llm/budget.py — token and cost accounting with spend alerts. Tracks…, The process-wide budget tracker., failover_chat_completion_via_router(), openai_body_from_response(), Any, packages/llm/compat.py — backwards-compatible bridges to the legacy call paths.… (+119 more)

### Community 2 - "WorkflowRun"
Cohesion: 0.04
...
Cohesion: 0.02
Nodes (239): _get_current_user_thunk(), _get_optional_user_thunk(), Request, admin_seed(), _agent_timeout_fallback_response(), AgentStatusEntry, AgentStatusResponse, AgentToolCallEntry (+231 more)
...
Cohesion: 0.04
Nodes (74): agent/job_manager.py — Async agent job lifecycle manager. Manages agent jobs…, kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, TaskResult, TaskSpec, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Run aider non-interactively via `--message` flag., runtimes/adapters/claude_code.py — Claude Code CLI adapter (FIRST CLASS).… (+66 more)

### Community 8 - "PolicyEngine"
Cohesion: 0.04
Nodes (92): _egress_policy_reason(), agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Return why governance policy blocks *host*, or None. Runs strictly *after* the…, _load(), Import the governance layer once, recording why if it is absent., governance_enabled(), True when the governance layer should run at all. A single global off switch…, _action_matches() (+84 more)
...
### Community 12 - "CEODispatcher"
Cohesion: 0.04
Nodes (69): CEODispatcher, CEOResult, _complexity_rank(), _decompose_into_subtasks(), _offload(), Any, Semaphore, services/ceo_dispatcher.py — Real CEO delegation layer. The CEO splits a… (+61 more)

### Community 13 - "brain_config.py"
Cohesion: 0.03
Nodes (107): Call-time resolver for an agent role model id. Delegates to…, _resolve_role_model(), _active_primary_provider(), BrainConfig, BrainConfigPatch, BrainConfigStore, default_brain_config(), get_brain_config() (+99 more)

### Community 14 - "Task"
Cohesion: 0.03
Nodes (112): AgentDefinition, A user-defined agent configuration stored in the database., Hand the 'connect & verify the repo' work to the agency's own agents. The task…, _seed_connect_task(), ApprovalCheckpoint, Full task/issue document., Human approval gate in a task's execution., Task (+104 more)
...
### Community 22 - "company_api.py"
Cohesion: 0.02
Nodes (172): account_lifecycle(), AccountLifecycleResponse, auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint(), _DoctorCheck, _DoctorReport (+164 more)

### Community 23 - "Any"
Cohesion: 0.05
Nodes (29): _check_extra_kwargs(), _enforce_signature(), Any, Path, Raise TypeError if fn's signature drifts from the locked contract (Pydantic…, Raise TypeError on unknown kwarg (runtime extra='forbid' for non-Pydantic…, Append an event to the durable session log if a store is wired in., Summarise a long history and compact it. Asks the planner model to write a… (+21 more)
...
Cohesion: 0.01
Nodes (109): BusinessCategory, Company, CompanyGraph, SystemType, Get the index of a phase in the workflow., The core company entity - root of the Company Graph., The complete Company Graph - canonical core model for the Autonomous AI Agency.…, Find a website by its URL. (+101 more)
...
Cohesion: 0.02
Nodes (102): parse_event_stream(), Reduce a ``--mode json`` NDJSON stream to a :class:`ParsedRun`. Kept a module-…, Reset the singleton (for tests)., reset_failover_manager(), base_url(), mobile_page(), proxy_url(), Config (+94 more)

### Community 32 - "ImprovementLoop"
Cohesion: 0.05
Nodes (70): AgentRole, _parse_ceo_directives(), str, DetectedIssue, ImprovementLoop, ImprovementLoopState, IssueCategory, IssueSeverity (+62 more)
...
### Community 41 - "enforcement.py"
Cohesion: 0.06
Nodes (41): Governance seam: judge the call, run it, audit the outcome. Deliberately a thin…, BudgetExceeded, classify(), evaluate_call(), get_gate(), guard_tool_call(), GuardResult, _host_of() (+33 more)

### Community 42 - "AgentRunner"
Cohesion: 0.04
Nodes (84): AgentPhaseError, AgentRunner, Exception, Return True when no file is touched by more than one step., Raised when a named agent phase (planning, verification, etc.) fails., GATE: Golden Path steps #7-12 — the primary agent execution loop. This is the…, Set a per-session token spend cap (★3 rollout token budget). When *cap* > 0 the…, Record token spend for *session_id* and enforce the budget cap. Logs a warning… (+76 more)
...
Cohesion: 0.08
Nodes (47): BrainResolution, get_active_brain_sync(), get_provider_role_tags(), _host_is_openai_compatible(), invalidate_brain_cache(), _norm(), _pick_from_records(), Any (+39 more)

### Community 45 - "Artifact"
Cohesion: 0.06
Nodes (44): AgentRole, agents/swarm.py — AgentSwarm: routes workflow phases to the correct agent. The…, When coder == reviewer model, swarm should log a warning., tests/test_workflow_models.py — Unit tests for workflow/models.py., TestApprovalGate, TestCheckRun, TestSlice, workflow/artifact_store.py — Durable artifact persistence. Artifacts are stored… (+36 more)
...
Cohesion: 0.05
Nodes (43): build_ceo_router(), Any, APIRouter, backend/ceo_router.py — observability and manual control for the CEO. Surfaces…, Reject non-admin callers for routes that spend provider budget. Delegates to…, _require_admin(), get_ceo_dispatcher(), Return the shared CEODispatcher singleton. (+35 more)

### Community 49 - "SeoFixer"
Cohesion: 0.08
...
Cohesion: 0.07
Nodes (35): ExecutionRequest, get_workflow_orchestrator(), Return the shared WorkflowOrchestrator singleton., Reset the singleton (test helper)., Canonical request to execute work through the golden path. This is the ONLY…, reset_orchestrator(), tests/test_orchestrator_failover.py — Provider failover, brain resolution,…, tests/test_orchestrator_queue.py — Tests for async FIFO run queue (#522). (+27 more)

### Community 52 - "test_direct_chat_evolution.py"
Cohesion: 0.10
...
Cohesion: 0.19
Nodes (16): _get_workspace_lock(), get_workspace_manager(), _hash_component(), _load_workspace(), BaseModel, Lock, Path, agent/workspace.py — Isolated workspace lifecycle management. Every agent… (+8 more)
...
### Community 62 - "_run_agent_loop"
Cohesion: 0.29
Nodes (8): _append_agent_session_message(), ProviderConfig, _run_agent_loop(), anyio, Verify _run_agent_loop calls AgentRunner.run and returns the summary., Verify _run_agent_loop handles AgentRunner exceptions gracefully., test_run_agent_loop_failure(), test_run_agent_loop_success()

### Community 63 - "loop.py"
Cohesion: 0.13
Nodes (24): loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., Condense a tool result down to what belongs in an audit row. A tool result can…, # NOTE: "ollama_base" is kept for backwards compatibility; this runner only…, _summarise_tool_result(), build_compaction_prompt(), build_execution_prompt(), build_planning_prompt(), build_tool_prompt() (+16 more)
...
### Community 66 - "BackgroundServices"
Cohesion: 0.38
...
Cohesion: 0.06
Nodes (69): _harvest_changed_files(), Extract the files a runtime touched. Returns ``(files, reported)``. Adapters…, A subtask's full history: what it is, and every attempt at it., SubtaskRecord, str, Implementer tiers, ordered cheapest-and-narrowest to most-capable. A subtask…, Tier, _goal() (+61 more)
...
Cohesion: 0.05
Nodes (48): _auto_disable(), _build_request(), _describe_registry(), _disabled_ids(), _is_billing_refusal(), _is_ollama(), _key_pool(), _log_exhaustion() (+40 more)
...
Cohesion: 0.06
Nodes (62): delegate_seo_findings(), Create real agent tasks from the audit's delegation plan. Each work package…, packages/ai/self_heal.py — automatic brain self-healing. When the active brain…, get_failover_manager(), Return the singleton BrainFailoverManager., _blocked_retire_age_sec(), _heal_blocked_backlog(), _heal_brain_failover() (+54 more)
...
### Community 96 - "test_vision_routing.py"
Cohesion: 0.12
...
### Community 100 - "OnboardingScreen.jsx"
Cohesion: 0.05
...
### Community 119 - "lifespan"
Cohesion: 0.05
Nodes (49): all_settings(), _as_bool(), _as_int(), ephemeral_ttl_hours(), ephemeral_ttl_hours_cached(), get_setting(), _maybe_schedule_refresh(), onboarding_gate_enabled() (+41 more)
...
Cohesion: 0.02
Nodes (129): Test hook — clear all usage accounting., reset(), CacheManager, cosine_similarity(), _Entry, get_cache(), LRUCache, payload_key() (+121 more)
...
### Community 148 - "spec_store.py"
Cohesion: 0.20
Nodes (17): build_spec_router(), Any, APIRouter, backend/spec_router.py — review/approve persisted plan specifications. Surfaces…, await_spec_approval(), _db(), _flag(), get_spec() (+9 more)
...
Cohesion: 0.05
Nodes (59): _build_provider_router(), _builtin_provider_records(), _chat_provider_policy(), _fallback_local_provider_record(), _get_provider_policy(), get_provider_policy_route(), _in_container(), _list_configured_provider_records() (+51 more)
...
### Community 170 - "_build_default_manager"
Cohesion: 0.07
...
### Community 173 - "tasks/service.py"
Cohesion: 0.03
...
### Community 180 - "test_one_model_catalogue.py"
Cohesion: 0.14
...
Cohesion: 0.04
Nodes (54): Backoff policy for retryable failures., RetryConfig, BreakerState, Enum, str, packages/llm/health.py — provider health tracking and circuit breaking. Two…, Test hook — clear all health state., reset() (+46 more)
...
### Community 191 - "validate_outbound_url"
Cohesion: 0.14
...
### Community 197 - "nvidia_models.py"
Cohesion: 0.07
...
### Community 200 - "test_crispy_workflow.py"
Cohesion: 0.07
...
### Community 217 - "TaskStore"
Cohesion: 0.05
Nodes (56): Any, Task, TaskStatus, Fail loud in production if no persistent storage is configured. Telegram…, Create a task. Deduplicates by source_id if set (Charter G3). If a task with…, Fetch a task by ID. If owner_id is set, enforces ownership., Return the task previously created for an external ``source_id`` (e.g.…, List tasks for a specific user with optional filters. ``include_system``… (+48 more)
...
### Community 219 - "OperationalIncidentTracker"
Cohesion: 0.12
...
### Community 222 - "test_agent_tool_governance.py"
Cohesion: 0.11
...
### Community 230 - "test_phase6_workflow.py"
Cohesion: 0.16
...
### Community 271 - "test_webui_provider_priority.py"
Cohesion: 0.21
...
### Community 273 - "test_kimi_bridge_server.py"
Cohesion: 0.05
...
### Community 274 - "sync/service.py"
Cohesion: 0.10
Nodes (37): Any, Request, FastAPI dependency: require Power User or Admin role. Raises 403 otherwise., FastAPI dependency: require any authenticated user., require_authenticated(), require_power_user(), sync/ — Syncthing-style workspace synchronisation service., add_peer() (+29 more)
...
### Community 277 - "TestCatalogFable51"
Cohesion: 0.09
...
Cohesion: 0.07
Nodes (40): _anthropic_headers(), _anthropic_payload(), _anthropic_response_text(), _auth_headers(), chat_completion_text(), list_openai_models(), LlmProviderConfig, normalize_base_url() (+32 more)

### Community 294 - "facade.py"
Cohesion: 0.05
Nodes (53): get_local_brain_state(), HeartbeatBody, post_local_brain_heartbeat(), post_local_brain_toggle(), Any, BaseModel, get, post (+45 more)
...
### Community 298 - "get_company_graph_store"
Cohesion: 0.03
Nodes (89): get_agent_store(), Run a full SEO/GEO/AIO audit against a website and persist the evidence., run_seo_audit(), autonomy_status(), Public autonomy readiness probe — no authentication required. A live deploy…, CompanyAgencyService, get_company_agency_service(), _is_runtime_available_sync() (+81 more)
...
### Community 300 - "test_brain_availability_doctor.py"
Cohesion: 0.13
...
### Community 303 - "openclaw_gateway.py"
Cohesion: 0.09
...
### Community 304 - "_resolve_brain_provider"
Cohesion: 0.06
...
### Community 312 - "test_freebuff_bot.py"
Cohesion: 0.11
...
### Community 317 - "_resolve_user_github_token"
Cohesion: 0.11
...
### Community 328 - "test_provider_render_env.py"
Cohesion: 0.09
...
### Community 338 - "test_telegram_task_callback.py"
Cohesion: 0.12
...
### Community 340 - "_mock_provider_records"
Cohesion: 0.15
...
### Community 351 - "skill_bindings.py"
Cohesion: 0.05
...
### Community 359 - "test_phase4_runtime_resilience.py"
Cohesion: 0.11
...
Cohesion: 0.08
Nodes (40): build_seo_roadmap(), _expire_stale_pending_report(), get_seo_audit(), list_seo_audits(), plan_seo_sprint(), BaseModel, get, post (+32 more)

### Community 376 - "dependencies"
Cohesion: 0.08
Nodes (25): axios, fast-uri, dependencies, axios, fast-uri, livekit-client, lucide-react, react (+17 more)

### Community 377 - "test_claude_code_adapter.py"
Cohesion: 0.14
...
Cohesion: 0.05
Nodes (33): AgentPolicy, get_config(), LLMConfig, ModelConfig, Capability and pricing metadata for one model id., Per-agent routing overrides (ADR-008 §"named profiles")., The fully-resolved routing configuration., Return the process-wide configuration, loading it on first use. (+25 more)
...
### Community 392 - "test_agent_readiness_audit.py"
Cohesion: 0.18
...
### Community 403 - "test_issue_triage.py"
Cohesion: 0.17
...
### Community 408 - "test_sam_livekit.py"
Cohesion: 0.05
...
### Community 417 - "test_connector_registry.py"
Cohesion: 0.12
...
### Community 433 - "AgentSessionStore"
Cohesion: 0.07
...
### Community 437 - "test_feature_matrix.py"
Cohesion: 0.12
...
### Community 440 - "DecisionsStoreTests"
Cohesion: 0.11
...
### Community 441 - "AgentStore"
Cohesion: 0.07
Nodes (24): AgentCreateRequest, AgentStore, AgentUpdateRequest, Any, BaseModel, field_validator, agents/store.py — Persistent store for user-defined agent configurations.…, CRUD store for AgentDefinition objects. Uses MongoDB when a `db` client is… (+16 more)

### Community 442 - "SeoAuditReport"
Cohesion: 0.16
...
### Community 448 - "operational_incidents.py"
Cohesion: 0.08
Nodes (40): _diagnose_and_file(), _file_incident(), _format_incident(), gather_render_evidence(), get_operational_incident_tracker(), _iso_from_monotonic(), _now(), open_phase_report() (+32 more)
...
### Community 459 - "persist_plan_spec"
Cohesion: 0.16
Nodes (17): persist_plan_spec(), plan_to_markdown(), Render a plan as a reviewable markdown spec (goal, steps, files, verification)., Persist a plan as a spec artifact. Returns the stored doc, or None., Tests for services/spec_store.py and the /api/specs review endpoints., Regression: previously persist_plan_spec() swallowed insert_one() failures into…, When approval isn't required, persistence stays best-effort — a storage hiccup…, AGENTS.md: never log sensitive values, including email addresses.… (+9 more)
...
### Community 462 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 487 - "test_telegram_service_webhook.py"
Cohesion: 0.18
...
### Community 519 - "all_provider_ids"
Cohesion: 0.08
Nodes (22): _brain_provider_status(), Return per-provider metadata for the GET endpoint. Iterates every provider in…, all_provider_ids(), _provider_ids_from_literal(), Return every provider id recognised by the brain config system. Iterates the…, Return the provider ids allowed by the ``BrainProvider`` Literal. Reads the…, test_all_provider_ids_returns_literal_args(), tests/test_unit5_ui_provider_surface.py — UNIT 5 regression tests. Verifies… (+14 more)
...
### Community 521 - "TaskHarnessAdapter"
Cohesion: 0.08
...
### Community 522 - "E2BSandboxSession"
Cohesion: 0.04
...
Cohesion: 0.13
Nodes (10): _iso_now(), _iso_offset_hours(), Enum, str, Resolve *relative* within *ws*.source and reject traversal/symlink escapes.…, Update *ws* status and persist the manifest., Update last_heartbeat timestamp and persist., Remove and recreate the tmp directory for *ws*. (+2 more)

### Community 528 - "AuditLog"
Cohesion: 0.04
Nodes (43): Called by APScheduler when a cron fires. Dispatches to the orchestrator. This…, Resolve the JWT signing secret, with a *stable* fallback. Bug fix: the previous…, _resolve_jwt_secret(), _scheduler_on_fire(), AuditEvent, AuditLog, packages/governance/audit.py — the evidence trail for every governed action.…, Redact secret-shaped substrings, then truncate. (+35 more)
...
### Community 544 - "DailyDigestAggregatorTests"
Cohesion: 0.19
...
### Community 545 - "DockerAgentAdapter"
Cohesion: 0.17
...
### Community 548 - "AdminDigestRouterAuthTests"
Cohesion: 0.22
...
### Community 556 - "agents/agile_ceremonies.py"
Cohesion: 0.08
...
### Community 557 - "test_ai_insights.py"
Cohesion: 0.20
...
### Community 558 - "is_anthropic_base_url"
Cohesion: 0.18
...
### Community 564 - "KnowledgeScreen.jsx"
Cohesion: 0.13
...
### Community 569 - "TestAgentRunnerSafety"
Cohesion: 0.19
...
### Community 635 - "SeoCheckDefinition"
Cohesion: 0.11
...
### Community 636 - ".on_task_complete"
Cohesion: 0.16
...
### Community 664 - "self_heal_brain_and_unblock_tasks"
Cohesion: 0.10
...
### Community 666 - "cowork_session.py"
Cohesion: 0.15
...
### Community 672 - "redact_connection_url"
Cohesion: 0.17
...
### Community 674 - "WorkspaceManager"
Cohesion: 0.19
...
### Community 675 - "platform_controls_router.py"
Cohesion: 0.10
...
### Community 679 - "TestRecordUsageAndStats"
Cohesion: 0.05
...
### Community 695 - "test_task_brain_preflight.py"
Cohesion: 0.18
Nodes (15): _is_brain_connection_error(), BaseException, True if *exc* looks like an LLM-brain/endpoint connectivity failure. Such…, Re-queue a task that couldn't run because no runtime/brain was available.…, _coordinator(), asyncio, BaseException, Brain-availability preflight tests (graceful degradation). When NO LLM brain is… (+7 more)
...
### Community 706 - "_resolve_push_token"
Cohesion: 0.17
...
### Community 707 - "test_provider_state_durability.py"
Cohesion: 0.17
...
Cohesion: 0.18
Nodes (5): Acquire the exclusive async lock for *ws*. Raises :exc:`WorkspaceLockError` if…, _read_manifest(), WorkspaceLockError, WorkspaceManifestError, WorkspaceNotFoundError
...
### Community 714 - "_is_ephemeral_user"
Cohesion: 0.27
...
### Community 718 - "Workspace Isolation Architecture"
Cohesion: 0.17
...
### Community 719 - "AgentsScreen.jsx"
Cohesion: 0.18
...
### Community 757 - "TestCompanyGraphModels"
Cohesion: 0.17
...
### Community 795 - "provider_base_url"
Cohesion: 0.09
...
### Community 805 - "test_event_log.py"
Cohesion: 0.45
...
### Community 809 - "mint_access_token"
Cohesion: 0.18
...
### Community 815 - "test_doctor_service_token_check.py"
Cohesion: 0.23
...
### Community 831 - "WorkspaceError"
Cohesion: 0.22
Nodes (6): Any, Exception, Resolve *relative* inside source dir and reject traversal/symlink escapes., Base class for all workspace errors., WorkspaceError, WorkspaceEscapeError

### Community 832 - "test_control_plane_api.py"
Cohesion: 0.06
...
### Community 838 - "workflow_orchestrator.py"
Cohesion: 0.08
...
### Community 839 - "TestAgentRunnerExecution"
Cohesion: 0.33
...
### Community 873 - "make_isolated_workspace"
Cohesion: 0.33
...
### Community 874 - "_redact_for_notification"
Cohesion: 0.24
...
### Community 882 - "TestNoNvidiaFallbackIsRetired"
Cohesion: 0.22
...
### Community 908 - "_parse_tool_calls_from_response"
Cohesion: 0.39
...
### Community 953 - "connectors_api.py"
Cohesion: 0.22
...
### Community 960 - "TestModelsEndpointAliases"
Cohesion: 0.31
...
### Community 1012 - "_extract_pytest_failure"
Cohesion: 0.42
...
Cohesion: 0.03
Nodes (109): get_improvement_loop(), _dispatch_async(), _ErrorCaptureHandler, get_log_monitor(), LogMonitor, _note_recurrence(), Any, LogRecord (+101 more)
...
### Community 1023 - "TestPaidPolicyDurability"
Cohesion: 0.22
...
### Community 1057 - "TestExtendedThinkingRouting"
Cohesion: 0.20
...
### Community 1063 - "Continual Harness (`agent/harness_spec.py`)"
Cohesion: 0.25
...
### Community 1113 - "._resolve_merge_decision"
Cohesion: 0.25
...
### Community 1114 - "_get_current_user"
Cohesion: 0.25
...
### Community 1132 - "apply_overrides"
Cohesion: 0.22
...
### Community 1133 - "TestPolicyAuthoringUiStableClaim"
Cohesion: 0.22
...
### Community 1163 - "classify_domain"
Cohesion: 0.29
...
### Community 1166 - "TestOneIdCanBelongToSeveralProviders"
Cohesion: 0.39
...
### Community 1268 - "test_log_monitor_storm_guard.py"
Cohesion: 0.48
...
## Knowledge Gaps
- **3492 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3487 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 13316 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **118 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `_fixture()` connect `_fixture` to `test_brain_patch_service_token.py`, `test_ceo_router.py`, `WorkflowRun`, `ProviderConfig`, `PolicyEngine`, `E2BSandboxSession`, `test_tasks_awaiting_approval_api.py`, `brain_config.py`, `Task`, `test_llm_router_strategies.py`, `AuditLog`, `tests/conftest.py`, `SelfHealingAgent`, `company_api.py`, `AgentJobManager`, `test_company_api.py`, `test_unit8_model_catalog.py`, `ImprovementLoop`, `test_failover_client_shared.py`, `test_catalogue_probe.py`, `services/seo_audit.py`, `PrimeAgentAdapter`, `resolve_active_brain`, `CEOSupervisor`, `SeoFixer`, `ExecutionRequest`, `test_direct_chat_evolution.py`, `test_model_router.py`, `provider_max_rpm`, `test_openclaw_endpoints.py`, `TestAgentRunnerSafety`, `test_task_service_failed_comment.py`, `clear_cooldowns`, `settings.py`, `ChatHistoryStore`, `ArtifactStore`, `SQLiteStore`, `test_telegram_auto_approve.py`, `ResearchTask`, `TestClient`, `test_autonomy_status.py`, `test_procedural_memory.py`, `test_local_brain_state.py`, `test_phase5_doctor.py`, `test_agent_free_brain.py`, `test_refresh_agent_built_proof.py`, `test_startup_warmup.py`, `test_telegram_diag_endpoint.py`, `test_vision_routing.py`, `TokenBudget`, `resolve_e2b_config`, `run_task`, `cost_tracker.py`, `BackgroundAgent`, `UserRole`, `test_context_rulebook.py`, `e2e/test_browser.py`, `test_provider_router.py`, `.on_task_complete`, `BrainWatchdog`, `KeyStore`, `test_issue_intake.py`, `test_llm_router_queue_cache.py`, `_step`, `_clean_phases`, `claim`, `MCPClient`, `config.py`, `ProviderRouter`, `test_openclaw_gateway.py`, `platform_controls_router.py`, `test_telegram_freebuff.py`, `NotificationDispatcher`, `OllamaCircuitBreaker`, `test_telegram_webhook.py`, `_job_text`, `test_features_api.py`, `test_new_features_e2e.py`, `test_task_brain_preflight.py`, `test_video_transcript.py`, `test_process_quick_note_workflow.py`, `_Budget`, `_resolve_push_token`, `test_provider_state_durability.py`, `nvidia_models.py`, `test_crispy_workflow.py`, `TrendWatcher`, `test_portfolio_intake.py`, `test_trend_watcher.py`, `TestClient`, `OperationalIncidentTracker`, `TestSwarmRoleRouting`, `test_agent_tool_governance.py`, `ContextPruner`, `TestEstimateTokensForMessages`, `AgentSwarm`, `test_agile_api.py`, `UsageEvent`, `test_app_settings.py`, `WorkflowBuildRequest`, `test_persistent_memory.py`, `SecurityScanner`, `FakeCollection`, `test_task_clarification.py`, `model_discovery.py`, `test_llm_router_e2e.py`, `OutputFilter`, `test_platform_controls.py`, `test_rate_limiter.py`, `sam`, `test_webui_provider_priority.py`, `test_kimi_bridge_server.py`, `test_sam_voice.py`, `Agency`, `OrchestratorQueue`, `test_nvidia_model_discovery.py`, `brain_failover.py`, `test_e2b_adapter.py`, `session_retro.py`, `Specialist`, `get_company_graph_store`, `test_mcp_governance.py`, `test_purge_backlog.py`, `test_doctor_service_token_check.py`, `test_colibri_brain_shim.py`, `test_provider_enable_disable.py`, `analyze_page`, `test_freebuff_bot.py`, `_resolve_user_github_token`, `test_control_plane_api.py`, `capture_screens.py`, `test_agent_scripts_share_one_model_list.py`, `test_crispy_burn_in.py`, `test_skill_registry_boot_refresh.py`, `test_telegram_task_callback.py`, `_mock_provider_records`, `get_feature_matrix`, `isolated_telegram_config`, `test_scheduler_hydration_bounded.py`, `test_dashboard_cache.py`, `_undeclared`, `test_claude_code_adapter.py`, `test_service_token.py`, `test_harness_spec.py`, `test_regression.py`, `test_agency_fix.py`, `test_sam_livekit.py`, `TestHarnessAdapter`, `test_monitor_lib.py`, `test_v4_api.py`, `AgentStore`, `SchedulerStore`, `test_knowledge_sync.py`, `test_ping.py`, `test_runtimes_health_endpoint.py`, `TestNormalizeResponseFormat`, `KeyPool`, `TestMongoGate`, `test_task_store_fails_loud_in_production.py`, `_Recorder`, `test_telegram_service_webhook.py`, `test_voice_pipeline.py`, `client`, `TestTheWorkflowIsSafeAndReadOnly`, `test_doctor_coding_brain.py`, `services/background.py`?**
  _High betweenness centrality (0.083) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `WorkflowRun`, `ReactScratchpad`, `backend/server.py`, `proxy.py`, `AgentPlan`, `ContextManager`, `PolicyEngine`, `TaskSpec`, `E2BSandboxSession`, `test_autonomous_agency_e2e.py`, `CEODispatcher`, `test_governance_sandbox.py`, `test_governance_api.py`, `UserMemoryStore`, `MCPClient`, `Any`, `Agency`, `AgentJobManager`, `_fixture`, `test_failover_client_shared.py`, `test_e2b_adapter.py`, `.execute`, `MultiAgentSwarm`, `test_empirical_verify.py`, `enforcement.py`, `FreeBuffAgent`, `LocalWorkspace`, `AgentSessionStore`, `WorkspaceTools`, `TestAgentRunnerSafety`, `direct_chat.py`, `_run_agent_loop`, `loop.py`, `TestAgentLoopMCPIntegration`, `_resolve_push_token`, `workflow_orchestrator.py`, `TestAgentRunnerExecution`, `StuckDetector`, `test_agent_free_brain.py`, `test_agent_tool_governance.py`, `AdaptiveHalter`, `ContextPruner`, `TokenBudget`, `InternalAgentAdapter`, `GitHubTools`, `BackgroundAgent`, `test_daily_automation_2026_07_11.py`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderRouter` to `ProviderConfig`, `backend/server.py`, `TestLegacyRouterServerFallback`, `test_bedrock_provider.py`, `test_bedrock_live.py`, `TestRouterIntegration`, `Provider`, `_get_provider_policy`, `is_anthropic_base_url`, `test_colibri_brain_shim.py`, `TestLegacyRouterCacheTTL`, `direct_chat.py`, `clear_cooldowns`, `ai/router.py`, `test_anthropic_refusal_fallback.py`, `failover_client.py`, `TrafficDirector`, `system_instruction`, `NvidiaProvider`, `TestAnthropicPayloadStructuredOutput`, `test_all_providers_discovery.py`, `test_provider_router.py`, `_payload`, `implement_agent.py`?**
