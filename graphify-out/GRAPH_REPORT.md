...
## Corpus Check
- 1467 files · ~2,137,402 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 29901 nodes · 55426 edges · 1274 communities (1107 shown, 112 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 2709 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e092f040`
...
## Communities (1274 total, 112 thin omitted)

### Community 0 - "backend/server.py"
Cohesion: 0.02
Nodes (207): _agent_timeout_fallback_response(), AgentStatusEntry, AgentStatusResponse, AgentToolCallEntry, ApiKeyCreate, auth_me(), AuthorizeReposBody, auto_recommend_skills() (+199 more)

### Community 1 - "LLMRequest"
Cohesion: 0.03
Nodes (105): ProviderConfig, One configured endpoint. ``kind`` selects the adapter: ``openai`` (any OpenAI-…, build_provider(), ProviderConfig, Normalise a configured ``kind`` to an adapter key., Instantiate the adapter for one provider config. Unknown kinds fall back to the…, resolve_kind(), LLMRequest (+97 more)

### Community 2 - "CompanyGraphService"
Cohesion: 0.03
Nodes (40): BusinessCategory, A company website with detected systems and stack inference., Website, CompanyGraphService, Company, SpecialistFamily, SystemType, Workflow (+32 more)

### Community 3 - "models/company_graph.py"
Cohesion: 0.03
Nodes (115): ApprovalPolicy, BusinessSystem, CompanyCreateRequest, CompanyGraphSnapshot, CompanyUpdateRequest, Connector, DetectedSystem, Evidence (+107 more)
...
Cohesion: 0.03
Nodes (93): int, cosine_similarity(), payload_key(), Exact-match cache key over the fields that change the answer. Routing…, Cosine similarity between two vectors, 0.0 when either is degenerate., build_summariser(), chunk_document(), ContextManager (+85 more)
...
Cohesion: 0.03
Nodes (81): _brain_provider_status(), get_catalog_models_route(), Return the mirrored model catalog (advisory-only). Flag-gated by…, Force a catalog mirror rebuild + persist (admin only). Rebuilds the catalog…, Return per-provider metadata for the GET endpoint. Iterates every provider in…, sync_catalog_route(), all_provider_ids(), _provider_ids_from_literal() (+73 more)
...
### Community 24 - "test_render_mcp.py"
Cohesion: 0.04
...
### Community 28 - "PolicyDecision"
Cohesion: 0.06
Nodes (24): GuardResult, Any, Per-session consumption counters and their ceilings. Ceilings come from the…, Return the name of the first exhausted session-wide limit, or None. Only covers…, Return a reason string if *tool* has hit its per-tool session cap. Checks only…, The outcome of guarding one action., A message safe to hand back to the model as a tool result. Names the rule so…, Evaluate, gate, and (if required) hold for approval. Returns a… (+16 more)

### Community 29 - "PolicyEngine"
Cohesion: 0.03
Nodes (92): _egress_policy_reason(), agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Return why governance policy blocks *host*, or None. Runs strictly *after* the…, AgentIdentity, _coerce_text(), new_session_id(), Any, packages/governance/identity.py — who is acting, and under what mandate. Docker… (+84 more)
...
### Community 31 - "_check_storage_health"
Cohesion: 0.12
...
### Community 35 - "Task"
Cohesion: 0.05
Nodes (60): Full task/issue document., Task, Best-effort Telegram heads-up that a task is parked awaiting approval. Inline…, asyncio, A reject + human Retry starts a NEW approval cycle → fresh notification., A gated task parked while IN_PROGRESS must not be treated as stranded., test_gate_notifies_only_on_first_park(), test_gate_renotifies_after_reject_and_retry() (+52 more)

### Community 36 - "Specialist"
Cohesion: 0.04
Nodes (54): A specialist agent that can be provisioned for company-specific tasks., Check if this specialist can handle a task with given capabilities., Specialist, build_matrix(), _families(), main(), Any, Map family -> sorted list of test files that mention it (quoted token). (+46 more)

### Community 37 - "TaskStore"
Cohesion: 0.03
Nodes (112): packages/ai/self_heal.py — automatic brain self-healing. When the active brain…, Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., tasks — Task/issue management system. Provides a lightweight task/issue tracker…, Enum, str, tasks/models.py — Pydantic models for the task/issue system., Comment or reply on a task. (+104 more)
...
Cohesion: 0.04
Nodes (79): Recursively strip secrets from an arbitrary argument structure. Fails…, scrub(), BudgetTracker, classify(), GovernanceGate, _host_of(), Extract a hostname from a URL, or return a bare host unchanged., Holds live session budgets, bounded so it cannot leak. Sessions end without… (+71 more)
...
Cohesion: 0.03
Nodes (78): Resolve the JWT signing secret, with a *stable* fallback. Bug fix: the previous…, _resolve_jwt_secret(), Replace the process-wide store. Tests only., reset_approval_store(), AuditEvent, AuditLog, packages/governance/audit.py — the evidence trail for every governed action.…, Redact secret-shaped substrings, then truncate. (+70 more)
...
Cohesion: 0.03
Nodes (85): loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., Governance seam: judge the call, run it, audit the outcome. Deliberately a thin…, Condense a tool result down to what belongs in an audit row. A tool result can…, # NOTE: "ollama_base" is kept for backwards compatibility; this runner only…, Feed LLM token/cost spend into the governance session budget. Kept separate…, Charge sub-agent nesting depth and enforce the ``max_depth`` ceiling. Isolates…, _summarise_tool_result(), build_governance_router() (+77 more)

### Community 49 - "test_ceo_supervision.py"
Cohesion: 0.06
Nodes (70): _harvest_changed_files(), Extract the files a runtime touched. Returns ``(files, reported)``. Adapters…, A subtask's full history: what it is, and every attempt at it., SubtaskRecord, str, Implementer tiers, ordered cheapest-and-narrowest to most-capable. A subtask…, Tier, _goal() (+62 more)
...
### Community 60 - "llm/router.py"
Cohesion: 0.02
Nodes (155): get_budget(), packages/llm/budget.py — token and cost accounting with spend alerts. Tracks…, The process-wide budget tracker., Test hook — clear all usage accounting., reset(), get_cache(), packages/llm/cache.py — layered caching. Five independent layers, each with its…, The process-wide cache manager. (+147 more)

### Community 61 - "AgentSwarm"
Cohesion: 0.03
Nodes (70): agents/__init__.py — CRISPY multi-agent coding system., AgentProfile, _catalog_defaults(), _catalog_provider(), _get_defaults(), load_all_profiles(), make_architect_profile(), make_coder_profile() (+62 more)
...
### Community 63 - "test_webui_provider_priority.py"
Cohesion: 0.21
...
### Community 66 - "model_router.py"
Cohesion: 0.07
Nodes (27): Dynamic model router package. Public API:: from router import get_router,…, _build_builtin_model_map(), _default_model(), _default_reasoning_model(), _get_model_map(), ModelRouter, _nvidia_key_present(), Any (+19 more)
...
### Community 71 - "test_provider_router.py"
Cohesion: 0.06
...
### Community 85 - "TestAdapterMetadata"
Cohesion: 0.04
...
Cohesion: 0.07
Nodes (30): _classify_sentiment(), _extract_keywords(), plan_research(), Any, BaseModel, field_validator, QualQuote, QualTheme (+22 more)
...
### Community 101 - "Usage"
Cohesion: 0.04
Nodes (62): packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, classify_error(), LLMProvider, OpenAICompatible, ABC, Any, AsyncClient, ProviderConfig (+54 more)

### Community 102 - "get_self_healing_agent"
Cohesion: 0.07
...
### Community 115 - "services/background.py"
Cohesion: 0.05
Nodes (58): get_trend_watcher(), set_trend_watcher(), _await_hermes_ready(), BackgroundServices, _env_float(), _env_on(), _hydrate_scheduler_bounded(), Any (+50 more)
...
Cohesion: 0.06
Nodes (60): Reset the singleton (for tests)., reset_failover_manager(), Hand the 'connect & verify the repo' work to the agency's own agents. The task…, _seed_connect_task(), _blocked_retire_age_sec(), _heal_blocked_backlog(), _heal_brain_failover(), _heal_purge_backlog() (+52 more)
...
Cohesion: 0.06
Nodes (50): clear_cooldowns(), get_dead_models(), _is_model_dead(), is_provider_on_cooldown(), mark_provider_failed(), ProviderFallbackError, Snapshot of active dead-model entries {provider_id/model: expiry_ts}. Also…, Put provider_id on cooldown for *cooldown_seconds* (default:… (+42 more)
...
### Community 152 - "test_ceo_router.py"
Cohesion: 0.07
...
Cohesion: 0.06
Nodes (46): _auto_disable(), _disable_unless_key_serves_other_models(), _disabled_ids(), FailoverResult, _is_billing_refusal(), _is_ollama(), _key_pool(), _log_recovery() (+38 more)
...
Cohesion: 0.07
Nodes (42): cmd_freebuff(), _model_keyboard(), _parse_callback(), _parse_user_ids(), _process_callback(), Start a FreeBuff flow: fetch free models and present a picker keyboard., Handle an inline-button press for the FreeBuff accept/reject/model flow., Extract numeric Telegram user IDs from a raw env value, tolerantly. Accepts… (+34 more)
...
### Community 188 - "test_p0_roadmap_b1_c2_a3.py"
Cohesion: 0.06
...
### Community 212 - "workflow_orchestrator.py"
Cohesion: 0.09
...
### Community 215 - "SQLiteStore"
Cohesion: 0.03
Nodes (48): KnowledgeItem, Structured knowledge about the company, systems, or processes., A company repository with detected technologies and metadata., Extract the owner from the full name., Extract the repository name from the full name., Repo, Company, Create a new company in SQLite. (+40 more)
...
Cohesion: 0.08
Nodes (53): _blocked_result(), _governance_check(), Any, TaskResult, TaskSpec, Build the failed TaskResult returned when policy denies a dispatch. A result…, Evaluate a runtime dispatch against policy; audit it either way. Returns…, Full record of a routing decision — audit-trail entry. (+45 more)
...
### Community 228 - "workflow/api.py"
Cohesion: 0.06
Nodes (41): Run verification commands via the Verifier agent. The Verifier is execution-…, _make_engine(), tests/test_crispy_workflow.py — CRISPY workflow engine hardening tests. Tests…, Create a WorkflowEngine with isolated storage., TestAbortOnFailure, TestPhaseSequence, TestPhaseSequenceError, TestWorkspaceIsolation (+33 more)
...
### Community 230 - "test_ephemeral_reaper.py"
Cohesion: 0.11
...
### Community 238 - "test_phase4_runtime_resilience.py"
Cohesion: 0.06
...
### Community 240 - "TestAuthAndTaskOwnership"
Cohesion: 0.06
...
### Community 243 - "get_company_graph_store"
Cohesion: 0.05
...
### Community 246 - "test_brain_availability_doctor.py"
Cohesion: 0.11
...
Cohesion: 0.05
Nodes (56): BrainFailoverManager, get_failover_manager(), ProviderHealth, ProviderInfo, Enum, Record a successful call — resets the circuit breaker., Permit one probe call without claiming the provider succeeded. This is the…, Seconds until the soonest cooling provider is probeable again. ``None`` when no… (+48 more)
...
### Community 260 - "test_anthropic_router.py"
Cohesion: 0.09
...
### Community 264 - "CompanyGraphStore"
Cohesion: 0.03
...
### Community 273 - "skill_bindings.py"
Cohesion: 0.05
...
### Community 291 - "OnboardingScreen.jsx"
Cohesion: 0.07
...
### Community 294 - "WorkspaceManager"
Cohesion: 0.10
...
### Community 298 - "OperationalIncident"
Cohesion: 0.13
...
### Community 314 - "brain_failover.py"
Cohesion: 0.07
Nodes (48): brain_providers(), Every configured provider with its health AND its on/off state. Powers the…, _describe_registry(), _log_exhaustion(), Explain a zero-attempt outcome, from the module that owns provider state. "no…, The one and only error-level log in the dispatch path. Emitted solely when the…, auto_disable_provider(), brain_availability_summary() (+40 more)
...
### Community 316 - "test_e2b_data_flow.py"
Cohesion: 0.07
...
### Community 321 - "_resolve_user_github_token"
Cohesion: 0.12
Nodes (25): _DoctorCheck, _DoctorReport, get_doctor_diagnostics(), get_doctor_report(), get_public_doctor(), Consolidated system health report: preflight checks + runtime health. Returns a…, Public Doctor endpoint — no authentication required. Returns system-level…, Authenticated Doctor endpoint — full diagnostics. Returns all system-level… (+17 more)

### Community 322 - "model_discovery.py"
Cohesion: 0.13
...
### Community 325 - "test_provider_state_durability.py"
Cohesion: 0.04
...
### Community 326 - "resolve_component_model"
Cohesion: 0.07
...
### Community 343 - "ai/router.py"
Cohesion: 0.06
Nodes (35): _dead_model_key(), _exponential_backoff_cooldown(), is_anthropic_base_url(), _mark_model_dead(), _notify_watchdog(), _ollama_reasoning_effort(), provider_router.py — auto-generated module docstring (user-research skill scan)., Notify the brain watchdog of a provider call outcome (fire-and-forget).… (+27 more)
...
### Community 356 - "test_phase6_workflow.py"
Cohesion: 0.16
...
### Community 362 - "platform_controls_router.py"
Cohesion: 0.10
...
### Community 364 - "seo_report_pdf.py"
Cohesion: 0.24
...
### Community 377 - "open_phase_report"
Cohesion: 0.10
...
### Community 391 - "mint_access_token"
Cohesion: 0.14
...
### Community 396 - "TestStreamableHTTPTransport"
Cohesion: 0.13
...
### Community 397 - "analyze_quantitative"
Cohesion: 0.09
...
### Community 427 - "TestRouterIntegration"
Cohesion: 0.31
...
### Community 448 - "test_memory_guard.py"
Cohesion: 0.13
...
### Community 455 - "WorkspaceManager"
Cohesion: 0.11
...
### Community 498 - "capability_registry.py"
Cohesion: 0.16
...
### Community 501 - "PerformanceAnalytics"
Cohesion: 0.12
...
### Community 517 - "TestSelfHealingInfrastructureClassification"
Cohesion: 0.19
...
### Community 519 - "_mock_provider_records"
Cohesion: 0.14
...
### Community 520 - "test_repowise_intelligence.py"
Cohesion: 0.11
...
### Community 523 - "test_sam_livekit.py"
Cohesion: 0.05
...
### Community 528 - "test_autonomous_agency_e2e.py"
Cohesion: 0.10
...
### Community 534 - "render_router.py"
Cohesion: 0.14
...
### Community 545 - "test_agent_tools.py"
Cohesion: 0.22
Nodes (15): Path, Trailing spaces on lines must not block the edit., Replacing with empty string removes the matched text., test_edit_file_delete_old_string(), test_edit_file_exact_match(), test_edit_file_missing_file_returns_error(), test_edit_file_old_string_not_found_returns_error(), test_edit_file_rejects_path_traversal() (+7 more)
...
### Community 552 - "test_direct_chat_async.py"
Cohesion: 0.15
...
### Community 553 - "cowork_session.py"
Cohesion: 0.15
...
### Community 600 - "get_ceo_dispatcher"
Cohesion: 0.11
...
### Community 604 - "DailyDigestAggregatorTests"
Cohesion: 0.19
...
### Community 609 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 612 - "get_tool_registry"
Cohesion: 0.18
...
### Community 638 - "self_heal_brain_and_unblock_tasks"
Cohesion: 0.09
...
### Community 639 - "TestGetCurrentTimeTool"
Cohesion: 0.43
...
### Community 644 - "test_freebuff_bot.py"
Cohesion: 0.11
...
### Community 647 - "test_ai_insights.py"
Cohesion: 0.20
...
### Community 678 - "TestMCPToolsListCache"
Cohesion: 0.19
...
### Community 683 - "test_tasks_awaiting_approval_api.py"
Cohesion: 0.16
...
Cohesion: 0.16
Nodes (7): client(), asyncio, tests/test_telegram_webhook.py — inbound Telegram webhook receiver. The webhook…, The secret must go in the POST body, never the URL (URLs get logged)., test_process_webhook_update_never_raises(), test_process_webhook_update_routes_callback_and_message(), test_register_webhook_posts_secret_in_body_not_url()
...
### Community 686 - "test_prompt_injection_boundary.py"
Cohesion: 0.15
...
### Community 714 - "_is_bedrock_model_id"
Cohesion: 0.27
...
### Community 715 - "HTTPException"
Cohesion: 0.03
Nodes (117): _get_current_user_thunk(), _get_optional_user_thunk(), Request, admin_seed(), call_llm(), clear_cost_attribution(), clear_response_cache(), create_access_token() (+109 more)
...
### Community 724 - "TestMCPClientStructuredOutput"
Cohesion: 0.31
...
### Community 731 - "test_issue_triage.py"
Cohesion: 0.17
...
### Community 734 - "test_kimi_bridge_server.py"
Cohesion: 0.12
...
### Community 772 - "TestAddConversationCacheBreakpoints"
Cohesion: 0.18
...
### Community 773 - "test_providers_live_e2e.py"
Cohesion: 0.27
...
### Community 813 - "flesch_reading_ease"
Cohesion: 0.22
...
### Community 818 - "test_event_log.py"
Cohesion: 0.45
...
### Community 819 - "provider_base_url"
Cohesion: 0.09
...
### Community 820 - "analyze_qualitative"
Cohesion: 0.22
...
### Community 828 - "test_orchestrator_merge_decision.py"
Cohesion: 0.30
Nodes (11): _company(), _FakeStore, Company, Tests for the G5 RepoConnection/DeliveryPolicy wiring into the orchestrator…, test_record_consent_noop_for_non_gate_decision(), test_record_consent_noop_without_decision(), test_record_consent_persists_for_first_merge(), test_resolve_direct_push_after_consent() (+3 more)
...
### Community 844 - "summarise_phases"
Cohesion: 0.15
...
### Community 849 - "TestTheGatewayRegistryOffersOnlyLiveModels"
Cohesion: 0.22
...
### Community 859 - "CircuitState"
Cohesion: 0.24
Nodes (3): CircuitState, Reduce probe frequency for runtimes that have never come online., TestCircuitState

### Community 860 - "Slice"
Cohesion: 0.10
Nodes (10): When coder == reviewer model, swarm should log a warning., WorkflowRun, TestSlice, TestWorkflowRun, _extract_slices_from_plan(), Extract slice definitions from a plan.md artifact. Looks for sections matching:…, Any, An independently deliverable unit of work within the execute phase. Each slice… (+2 more)
...
### Community 886 - "TestTheProducersAndTheParserCannotDrift"
Cohesion: 0.25
...
### Community 887 - "_get_current_user"
Cohesion: 0.25
...
### Community 893 - "DirectChatDoctor"
Cohesion: 0.32
...
### Community 901 - "agent/output_filter.py"
Cohesion: 0.33
...
### Community 907 - "_parse_tool_calls_from_response"
Cohesion: 0.39
...
### Community 920 - "Feature Maturity / Support Matrix"
Cohesion: 0.25
...
### Community 970 - "test_server_autonomy_and_index_fixes.py"
Cohesion: 0.29
...
### Community 974 - "openclaw_mobile_ui"
Cohesion: 0.33
...
### Community 1017 - "TestDirectChatNonBlocking"
Cohesion: 0.40
...
### Community 1059 - "resolve_hermes_base_url"
Cohesion: 0.47
...
### Community 1073 - "TestAgentRunnerExecution"
Cohesion: 0.33
...
### Community 1114 - "parse_pytest_failures.py"
Cohesion: 0.50
...
### Community 1131 - "operational_incidents.py"
Cohesion: 0.13
...
### Community 1132 - "verify_pr_exists"
Cohesion: 0.50
...
- **Why does `_fixture()` connect `_fixture` to `TestTheWorkflowIsSafeAndReadOnly`, `test_doctor_coding_brain.py`, `test_brain_patch_service_token.py`, `models/company_graph.py`, `_mock_provider_records`, `test_llm_router_queue_cache.py`, `test_llm_router_strategies.py`, `ImprovementLoop`, `TaskWorkflowService`, `test_unit8_model_catalog.py`, `test_model_router.py`, `config.py`, `SelfHealingAgent`, `test_llm_router_resilience.py`, `PolicyDecision`, `PolicyEngine`, `BrainWatchdog`, `test_company_api.py`, `test_langfuse_agency_wide.py`, `TaskStore`, `test_failover_client_shared.py`, `Task`, `services/seo_audit.py`, `UserRole`, `test_agent_tool_governance.py`, `test_catalogue_probe.py`, `resolve_active_brain`, `test_knowledge_sync.py`, `AgentJobManager`, `PrimeAgentAdapter`, `ChatHistoryStore`, `Agency`, `test_openclaw_endpoints.py`, `llm/router.py`, `AgentSwarm`, `test_task_service_failed_comment.py`, `test_webui_provider_priority.py`, `ResearchTask`, `test_provider_router.py`, `TestClient`, `test_procedural_memory.py`, `get_scheduler`, `SQLiteStore`, `test_startup_warmup.py`, `test_telegram_auto_approve.py`, `TokenBudget`, `get_ceo_dispatcher`, `test_autonomy_status.py`, `test_brain_failover_413.py`, `SeoFixer`, `test_local_brain_state.py`, `test_phase5_doctor.py`, `test_refresh_agent_built_proof.py`, `TestHarnessAdapter`, `get_self_healing_agent`, `test_e2b_adapter.py`, `operational_incidents.py`, `cost_tracker.py`, `services/background.py`, `test_sam_voice.py`, `test_context_rulebook.py`, `ArtifactStore`, `_client`, `KeyStore`, `run_task`, `test_trend_scoping.py`, `e2e/test_browser.py`, `get_task_store`, `_step`, `BackgroundAgent`, `test_issue_intake.py`, `test_trend_watcher.py`, `clear_cooldowns`, `claim`, `test_ceo_router.py`, `persist_plan_spec`, `TestEstimateTokensForMessages`, `MCPClient`, `test_daily_2026_07_27.py`, `FeatureMaturity`, `test_openclaw_gateway.py`, `KeyPool`, `test_tasks_awaiting_approval_api.py`, `test_telegram_webhook.py`, `NotificationDispatcher`, `TestSwarmRoleRouting`, `OllamaCircuitBreaker`, `_job_text`, `TestRuntimeControl`, `test_new_features_e2e.py`, `test_features_api.py`, `test_video_transcript.py`, `TrendWatcher`, `test_agent_free_brain.py`, `_Budget`, `test_process_quick_note_workflow.py`, `test_portfolio_intake.py`, `ScheduledJob`, `TestAgentRunnerSafety`, `test_doctor_service_token_check.py`, `test_skill_registry_boot_refresh.py`, `test_kimi_bridge_server.py`, `TestClient`, `test_ephemeral_reaper.py`, `TestAuthAndTaskOwnership`, `ContextPruner`, `provider_max_rpm`, `test_brain_availability_doctor.py`, `test_brain_failover.py`, `parse_event_stream`, `test_agile_api.py`, `test_app_settings.py`, `test_persistent_memory.py`, `SecurityScanner`, `WorkflowBuildRequest`, `test_llm_router_e2e.py`, `test_task_clarification.py`, `OutputFilter`, `test_platform_controls.py`, `test_rate_limiter.py`, `OrchestratorQueue`, `TestNormalizeResponseFormat`, `session_retro.py`, `test_purge_backlog.py`, `analyze_page`, `test_e2b_data_flow.py`, `_resolve_user_github_token`, `model_discovery.py`, `test_provider_state_durability.py`, `capture_screens.py`, `get_registry`, `test_agent_scripts_share_one_model_list.py`, `test_crispy_burn_in.py`, `test_nvidia_model_discovery.py`, `isolated_telegram_config`, `test_scheduler_hydration_bounded.py`, `platform_controls_router.py`, `CacheManager`, `test_provider_enable_disable.py`, `_undeclared`, `test_direct_chat_evolution.py`, `test_claude_code_adapter.py`, `test_service_token.py`, `test_harness_spec.py`, `test_telegram_service_webhook.py`, `test_regression.py`, `test_agency_fix.py`, `.record`, `test_dashboard_cache.py`, `OrchestratorCheckpointStore`, `_get`, `test_monitor_lib.py`, `test_v4_api.py`, `test_telegram_diag_endpoint.py`, `apply_review.py`, `test_ping.py`, `test_runtimes_health_endpoint.py`, `_FakeSandbox`, `test_task_store_fails_loud_in_production.py`, `UsageEvent`, `test_voice_pipeline.py`, `client`?**
  _High betweenness centrality (0.099) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `proxy.py`, `ReactScratchpad`, `TaskSpec`, `BackgroundAgent`, `FreeBuffAgent`, `test_autonomous_agency_e2e.py`, `ContextManager`, `test_backend_server_features.py`, `WorkflowRun`, `E2BSandboxSession`, `PolicyEngine`, `MCPClient`, `test_failover_client_shared.py`, `StuckDetector`, `test_agent_tool_governance.py`, `AgentSessionStore`, `loop.py`, `TestAgentRunnerExecution`, `test_empirical_verify.py`, `LocalWorkspace`, `MultiAgentSwarm`, `AgentJobManager`, `test_daily_automation_2026_07_11.py`, `WorkspaceTools`, `test_agent_free_brain.py`, `TestAgentLoopMCPIntegration`, `test_agent_chat_integration.py`, `InternalAgentAdapter`, `TestAgentRunnerSafety`, `AgentPlan`, `workflow_orchestrator.py`, `TokenBudget`, `UserMemoryStore`, `get_ceo_dispatcher`, `test_brain_failover_413.py`, `test_agent_runner.py`, `test_governance_api.py`, `CEODispatcher`, `direct_chat.py`, `test_e2b_adapter.py`, `AdaptiveHalter`, `ContextPruner`, `GitHubTools`, `TestGetCurrentTimeTool`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `Task` connect `Task` to `backend/server.py`, `test_task_source_id_race.py`, `test_sam_livekit.py`, `TaskWorkflowService`, `workflow.py`, `tasks/api.py`, `test_issue_intake.py`, `seo_api.py`, `._coerce_ts`, `test_schedule_growth_invariants.py`, `TaskStore`, `test_tasks_awaiting_approval_api.py`, `test_purge_backlog.py`, `test_task_service_failed_comment.py`, `_make_task`, `test_portfolio_intake.py`, `v4_api.py`, `test_phase6_workflow.py`, `company_api.py`, `test_phase4_runtime_resilience.py`, `test_e2b_task_wiring.py`, `get_company_graph_store`, `test_trend_scoping.py`, `get_task_store`?**
