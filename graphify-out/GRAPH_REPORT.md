...
## Corpus Check
- 1501 files · ~2,173,920 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 30403 nodes · 56310 edges · 1299 communities (1134 shown, 109 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 2734 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d7794afa`
...
2. `AgentRunner` - 192 edges
3. `Task` - 161 edges
4. `ProviderRouter` - 138 edges
5. `TaskStore` - 128 edges
6. `LLMRequest` - 124 edges
...
## Communities (1299 total, 109 thin omitted)

### Community 0 - "get"
Cohesion: 0.02
Nodes (92): auth_me(), auto_recommend_skills(), _check_storage_health(), cost_attribution_stats(), discover_remote_skills(), doctor_health(), get_catalog_models_route(), get_public_kpis() (+84 more)

### Community 1 - "LLMRequest"
Cohesion: 0.04
Nodes (104): ProviderConfig, One configured endpoint. ``kind`` selects the adapter: ``openai`` (any OpenAI-…, OpenAICompatible, Adapter for any endpoint speaking the OpenAI chat-completions shape. Adding a…, build_provider(), ProviderConfig, Normalise a configured ``kind`` to an adapter key., Instantiate the adapter for one provider config. Unknown kinds fall back to the… (+96 more)

### Community 2 - "CompanyGraphStore"
Cohesion: 0.02
Nodes (67): BusinessCategory, A company website with detected systems and stack inference., A company repository with detected technologies and metadata., Extract the owner from the full name., Extract the repository name from the full name., Repo, Website, requires_db (+59 more)

### Community 3 - "test_cost_aware_routing_eval.py"
Cohesion: 0.06
...
Cohesion: 0.02
Nodes (89): KnowledgeItem, Structured knowledge about the company, systems, or processes., MongoDBStore, Any, Company, ObjectId, Prepare a Pydantic model for SQLite storage., Prepare a SQLite row for Pydantic model. (+81 more)
...
Cohesion: 0.03
Nodes (110): AgentPhaseError, AgentRunner, _check_extra_kwargs(), _enforce_signature(), Any, Exception, Path, Raise TypeError if fn's signature drifts from the locked contract (Pydantic… (+102 more)

### Community 8 - "test_llm_router_queue_cache.py"
Cohesion: 0.02
...
### Community 10 - "test_llm_router_strategies.py"
Cohesion: 0.03
...
Cohesion: 0.03
Nodes (120): Agency, AgentRole, get_agency(), _parse_ceo_directives(), str, CEO-coordinated multi-agent agency for continuous codebase management. The CEO…, set_agency(), DetectedIssue (+112 more)

### Community 12 - "TaskWorkflowService"
Cohesion: 0.06
Nodes (44): Task, Creates tasks from scheduler and playbook runs using one workflow., TaskAutomationService, ApprovalCheckpoint, Human approval gate in a task's execution., Task, TaskStatus, Record the human decision on a task's **pre-execution** approval gate. A… (+36 more)
...
### Community 14 - "test_model_router.py"
Cohesion: 0.05
...
### Community 17 - "validate_outbound_url"
Cohesion: 0.14
...
### Community 20 - "RuntimeCapabilityRegistry"
Cohesion: 0.08
...
Cohesion: 0.05
Nodes (106): services/ceo_dispatcher.py — Real CEO delegation layer. The CEO splits a…, Split the request into briefed, tier-assigned specialist sub-tasks. Returns the…, _runtime_id_for_role(), build_subtask_brief(), _coerce_subtasks(), decompose(), _env_flag(), _env_int() (+98 more)

### Community 22 - "ExecutionRequest"
Cohesion: 0.02
Nodes (149): Execute work through the 11-phase golden path., Return orchestrator queue depth, active runs, and supervisor state (#522)., Called by APScheduler when a cron fires. Dispatches to the orchestrator. This…, _scheduler_on_fire(), workflow_orchestrator_execute(), workflow_orchestrator_status(), get_orchestrator_checkpoint_store(), get_orchestrator_queue() (+141 more)

### Community 23 - "E2BSandboxSession"
Cohesion: 0.03
Nodes (104): MCPUnavailableError, agent/mcp_client.py — Async MCP client for the mcp-server Docker container.…, Raised when the MCP server is unreachable or the circuit is open., packages/integrations/render_mcp.py — Render platform access over MCP. The…, Drop the cached singleton. Used by tests and after a config change., reset_render_mcp(), TaskResult, TaskSpec (+96 more)

### Community 24 - "RenderMCPClient"
Cohesion: 0.06
...
Cohesion: 0.03
Nodes (71): _complexity_rank(), _decompose_into_subtasks(), _merge_changed_files(), Reset the singleton (test helper)., Decompose a request into 2-3 sub-tasks for specialist fan-out. Default…, Collect changed_files across all specialists into a single de-duped list., reset_ceo_dispatcher(), _should_fan_out() (+63 more)

### Community 26 - "BrainConfig"
Cohesion: 0.03
...
### Community 28 - "loop.py"
Cohesion: 0.03
Nodes (95): loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., Governance seam: judge the call, run it, audit the outcome. Deliberately a thin…, Condense a tool result down to what belongs in an audit row. A tool result can…, # NOTE: "ollama_base" is kept for backwards compatibility; this runner only…, Charge sub-agent nesting depth and enforce the ``max_depth`` ceiling. Isolates…, _summarise_tool_result(), _egress_policy_reason(), agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives… (+87 more)

### Community 29 - "enforcement.py"
Cohesion: 0.05
Nodes (47): Feed LLM token/cost spend into the governance session budget. Kept separate…, cost_for_tokens(), Return the USD cost for (prompt_tokens, completion_tokens) on *model*. Returns…, ApprovalStatus, str, BudgetExceeded, classify(), evaluate_call() (+39 more)
...
### Community 32 - "AnthropicProvider"
Cohesion: 0.04
...
### Community 34 - "resolve_active_brain"
Cohesion: 0.07
Nodes (51): BrainResolution, get_active_brain_sync(), get_brain_preference(), get_provider_role_tags(), _host_is_openai_compatible(), invalidate_brain_cache(), _norm(), _pick_from_records() (+43 more)

### Community 35 - "Task"
Cohesion: 0.04
Nodes (63): Full task/issue document., Task, One-line human explanation of why this task needs human approval. Reads risk…, Best-effort label of who will run this task once approved. Returns…, PUBLIC_URL-anchored dashboard deep link for the task detail. Returns empty…, Best-effort Telegram heads-up that a task is parked awaiting approval. Inline…, asyncio, A reject + human Retry starts a NEW approval cycle → fresh notification. (+55 more)

### Community 36 - "models/company_graph.py"
Cohesion: 0.02
Nodes (113): patch, Update a company's metadata. Accepts partial updates for company fields…, update_company(), ApprovalPolicy, BusinessSystem, CompanyCreateRequest, CompanyGraphResponse, CompanyGraphSnapshot (+105 more)

### Community 37 - "TaskStore"
Cohesion: 0.03
Nodes (103): Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., tasks — Task/issue management system. Provides a lightweight task/issue tracker…, Enum, str, tasks/models.py — Pydantic models for the task/issue system., Comment or reply on a task., TaskComment (+95 more)
...
### Community 44 - "test_agent_tool_governance.py"
Cohesion: 0.07
...
### Community 48 - "validate_policy_text"
Cohesion: 0.05
...
Cohesion: 0.04
Nodes (106): CEODispatcher, CEOResult, _harvest_changed_files(), _offload(), Any, Semaphore, Run a synchronous ledger call without blocking the event loop. ``CEOLedger`` is…, Extract the files a runtime touched. Returns ``(files, reported)``. Adapters… (+98 more)
...
### Community 51 - "test_knowledge_sync.py"
Cohesion: 0.08
...
### Community 52 - "BrainWatchdog"
Cohesion: 0.03
Nodes (61): _brain_provider_status(), get_brain_policy_route(), Return per-provider metadata for the GET endpoint. Iterates every provider in…, Return the discovered model list for *provider_id*, or ``[]`` if unknown., Return the active brain config + per-provider key-present flags. The response…, _served_models(), provider_api_key(), provider_key_present() (+53 more)
...
### Community 54 - "AgentJobManager"
Cohesion: 0.06
Nodes (27): AgentJob, AgentJobManager, _now(), Any, Run a job using the provided runner and update the job's lifecycle, progress,…, Serialize the AgentJob to a JSON-serializable dictionary for external clients.…, runner(), AgentJobManager method signature enforcement. (+19 more)

### Community 55 - "scrub"
Cohesion: 0.07
Nodes (25): _luhn_ok(), Any, packages/governance/audit.py — the evidence trail for every governed action.…, True when ``digits`` (bare, no separators) satisfies the Luhn checksum., Redact SSNs and Luhn-valid payment-card numbers from a string. Runs after the…, Recursively strip secrets from an arbitrary argument structure. Fails…, Redact secret-shaped substrings, then truncate., Return the most recent events, newest first, optionally filtered. (+17 more)

### Community 56 - "ChatHistoryStore"
Cohesion: 0.04
...
### Community 59 - "seo_portfolio_bridge.py"
Cohesion: 0.06
...
### Community 63 - "resolve_component_model"
Cohesion: 0.07
...
### Community 67 - "portfolio_intelligence.py"
Cohesion: 0.07
...
### Community 70 - "start_background_services"
Cohesion: 0.05
Nodes (35): _keepalive_self_ping(), lifespan(), _maybe_boot_purge(), _purge_backlog_core(), _purge_summary_clean(), Run the FreeBuff Telegram bot, restarting it on unexpected exit., Ping our own public URL so a free-tier web service doesn't sleep. Render free…, Start the Telegram bot (and keep-alive) inside the web process when enabled.… (+27 more)

### Community 71 - "ProviderRouter"
Cohesion: 0.05
Nodes (73): _acquire_provider_probe(), extract_openai_text(), _normalize_nvidia_base_url(), _openai_url(), ProviderFallbackError, ProviderRouter, Try to acquire a distributed probe lock for *provider_id*. Returns True if this…, Release the probe lock for *provider_id*. (+65 more)

### Community 72 - "sync/service.py"
Cohesion: 0.11
...
### Community 75 - "test_repo_connection.py"
Cohesion: 0.06
...
### Community 76 - "test_procedural_memory.py"
Cohesion: 0.05
...
### Community 79 - "test_brain_config_api.py"
Cohesion: 0.05
...
### Community 82 - "agent/workspace.py"
Cohesion: 0.06
...
### Community 83 - "test_workflow_models.py"
Cohesion: 0.13
...
### Community 84 - "test_startup_warmup.py"
Cohesion: 0.05
...
Cohesion: 0.08
Nodes (50): get_decisions_store(), Process-wide DecisionsStore singleton (resettable via db_path arg)., Return a Markdown-v1-safe preview string under ``max_chars``. Used by the…, sanitize_paste_for_preview(), _admin_headers(), _api_headers(), _check_rate_limit(), cmd_control() (+42 more)

### Community 88 - "TokenBudget"
Cohesion: 0.05
...
### Community 90 - "test_governance_api.py"
Cohesion: 0.06
...
### Community 91 - "OnboardingScreen.jsx"
Cohesion: 0.05
...
Cohesion: 0.05
Nodes (45): provider_access_tier(), _provider_field(), provider_sort_key(), ProviderConfig, local_brain_enabled(), local_brain_provider_config(), local_brain_status(), ProviderConfig (+37 more)
...
### Community 98 - "test_user_research_skill.py"
Cohesion: 0.05
...
### Community 101 - "llm/router.py"
Cohesion: 0.03
Nodes (125): int, get_budget(), packages/llm/budget.py — token and cost accounting with spend alerts. Tracks…, The process-wide budget tracker., get_cache(), The process-wide cache manager., failover_chat_completion_via_router(), openai_body_from_response() (+117 more)

### Community 102 - "services/background.py"
Cohesion: 0.04
...
### Community 103 - "TestCatalogFable51"
Cohesion: 0.09
...
### Community 104 - "RenderOpsMonitor"
Cohesion: 0.05
...
### Community 105 - "Platform Guide — the full tour"
Cohesion: 0.04
...
### Community 106 - "test_e2b_adapter.py"
Cohesion: 0.07
...
### Community 109 - "ai/router.py"
Cohesion: 0.07
Nodes (26): _dead_model_key(), _exponential_backoff_cooldown(), _get_director(), is_commercial_provider(), _mark_model_dead(), _normalized_provider_type(), _notify_watchdog(), ProviderResult (+18 more)
...
### Community 121 - "test_trend_scoping.py"
Cohesion: 0.10
...
Cohesion: 0.06
Nodes (45): Browser admin UI for login, service control, key management, and diagnostics., Update or append a KEY=value line in the .env file., register_admin_gui(), _save_env_var(), get_output_filter(), get_savings_summary(), Get or create the singleton OutputFilter instance., Get token savings summary. (+37 more)

### Community 123 - "HermesAdapter"
Cohesion: 0.05
Nodes (46): _active_primary_provider(), is_north_mini_code_default(), True when the ``NORTH_MINI_CODE_DEFAULT`` flag is on (default ON). Reads the…, Best-effort read of the active brain's primary provider (or ``None``)., Resolve the model id to force for a code-execution run, or ``None``. Returns…, resolve_coding_model_preference(), HermesAdapter, Any (+38 more)

### Community 124 - "AgentScheduler"
Cohesion: 0.06
...
### Community 125 - "get_task_store"
Cohesion: 0.06
Nodes (66): quick_notes_submit(), _QuickNoteBody, Submit a quick-note URL or instruction from the dashboard FAB., Reset the singleton (for tests)., reset_failover_manager(), _blocked_retire_age_sec(), _heal_blocked_backlog(), _heal_brain_failover() (+58 more)
...
### Community 131 - "RepowiseIntelligence"
Cohesion: 0.06
...
### Community 134 - "test_mcp_registry.py"
Cohesion: 0.05
...
### Community 140 - "brain_failover.py"
Cohesion: 0.05
Nodes (47): auto_disable_provider(), _disabled_from_mongo(), _disabled_from_sqlite(), disabled_providers(), _is_paid_allowed_db(), _kv_connect(), _kv_path(), _mongo_db() (+39 more)

### Community 141 - "BackgroundAgent"
Cohesion: 0.06
...
### Community 144 - "test_issue_intake.py"
Cohesion: 0.08
...
### Community 146 - "emit_chat_observation"
Cohesion: 0.09
...
### Community 147 - "test_web_reach.py"
Cohesion: 0.08
Nodes (44): _load_script_module(), Any, ModuleType, Dynamically load a pure-stdlib helper module from .github/scripts/. Returns…, Zero-key internet access: pages, YouTube transcripts, search, RSS. Every public…, Read a web page as plain text, following the same fallback chain (direct ->…, GET *url*, re-validating every redirect hop against ``unsafe_target_reason`` —…, httpx-only fallback used when the .github/scripts helpers can't be loaded (e.g.… (+36 more)

### Community 148 - "test_backend_server_features.py"
Cohesion: 0.05
Nodes (37): _append_agent_session_message(), _build_auto_skill_guidance(), _build_provider_router(), _builtin_provider_records(), _chat_provider_policy(), _fallback_local_provider_record(), _in_container(), _list_configured_provider_records() (+29 more)

### Community 149 - "useSafeData"
Cohesion: 0.05
...
### Community 150 - "clear_cooldowns"
Cohesion: 0.10
Nodes (29): clear_cooldowns(), get_dead_models(), _is_model_dead(), is_provider_on_cooldown(), mark_provider_failed(), Snapshot of active dead-model entries {provider_id/model: expiry_ts}. Also…, Put provider_id on cooldown for *cooldown_seconds* (default:…, Return True if provider_id is currently on cooldown. (+21 more)
...
### Community 152 - "TestAuthAndTaskOwnership"
Cohesion: 0.17
...
### Community 155 - "TestEstimateTokensForMessages"
Cohesion: 0.05
...
### Community 156 - "test_response_cache.py"
Cohesion: 0.10
...
### Community 157 - "ContextWindowManager"
Cohesion: 0.08
...
Cohesion: 0.06
Nodes (58): _make_engine(), tests/test_crispy_workflow.py — CRISPY workflow engine hardening tests. Tests…, Create a WorkflowEngine with isolated storage., TestAbortOnFailure, TestPhaseSequence, TestWorkspaceIsolation, approve(), build() (+50 more)

### Community 159 - "MCPClient"
Cohesion: 0.04
...
### Community 160 - "TaskBoardScreen.jsx"
Cohesion: 0.05
...
### Community 161 - "test_schedule_growth_invariants.py"
Cohesion: 0.05
...
### Community 162 - "skill_bindings.py"
Cohesion: 0.09
...
### Community 168 - "failover_client.py"
Cohesion: 0.05
...
### Community 172 - "pr_approval_gate.py"
Cohesion: 0.08
...
Cohesion: 0.05
Nodes (38): _file_issue(), _latest_metric_value(), _note_recurrence(), _parse_timestamp(), Any, datetime, services/render_ops.py — autonomous Render debugging + environment monitoring.…, Parse an RFC3339 timestamp from Render, tolerating a trailing ``Z``. (+30 more)

### Community 174 - "test_telegram_freebuff.py"
Cohesion: 0.07
...
### Community 177 - "configuration-reference.md"
Cohesion: 0.09
...
### Community 178 - "ProvidersScreen.jsx"
Cohesion: 0.05
...
### Community 179 - "test_slop_gate.py"
Cohesion: 0.07
Nodes (43): _extract_mentioned_paths(), Extract plausible file paths from issue text., Read existing files for codebase context (max 8000 chars total)., _read_grounding_files(), tool_write_file(), diff_is_sloppy(), is_destructive_overwrite(), is_doc_only_boilerplate() (+35 more)

### Community 180 - "OllamaCircuitBreaker"
Cohesion: 0.08
...
### Community 190 - "test_classify_dependabot_update.py"
Cohesion: 0.08
...
### Community 200 - "test_agent_free_brain.py"
Cohesion: 0.05
...
### Community 202 - "TestRecordUsageAndStats"
Cohesion: 0.05
...
### Community 203 - "test_process_quick_note_workflow.py"
Cohesion: 0.06
...
### Community 205 - "Agent Readiness Report"
Cohesion: 0.20
...
### Community 206 - "_get_provider_policy"
Cohesion: 0.07
...
### Community 210 - "InternalAgentAdapter"
Cohesion: 0.07
...
### Community 211 - "test_brain_availability_doctor.py"
Cohesion: 0.05
Nodes (55): brain_availability_summary(), Non-secret answer to "can the brain answer a request right now?". Three callers…, Attempt, _backend(), CEOLedger, GoalRecord, _now(), Any (+47 more)

### Community 212 - "RuntimeManager"
Cohesion: 0.08
...
### Community 214 - "test_operational_incidents.py"
Cohesion: 0.03
Nodes (76): _note_phase_end(), _note_phase_start(), Open a tracked phase, returning the token that closes it. Never raises., Close the tracked phase *token* opened above. Never raises., normalise(), note_phase_end(), note_phase_start(), Record that *phase* began; returns the token that ends it. Called from… (+68 more)

### Community 215 - "asyncio"
Cohesion: 0.07
...
### Community 219 - "PortfolioManager"
Cohesion: 0.05
...
Cohesion: 0.11
Nodes (29): auto_disable(), _billing_signals(), describe(), disabled_provider_ids(), is_unfixable(), packages/llm/disabled.py — bridge to the durable provider on/off switch. The…, Provider ids currently switched off. Empty when the store is unreachable., Persist a provider as disabled, through the store that already owns it. (+21 more)
...
### Community 222 - "test_runtime_governance.py"
Cohesion: 0.06
Nodes (59): _blocked_result(), _governance_check(), Any, TaskResult, TaskSpec, Build the failed TaskResult returned when policy denies a dispatch. A result…, Evaluate a runtime dispatch against policy; audit it either way. Returns…, Full record of a routing decision — audit-trail entry. (+51 more)
...
### Community 226 - "chat_handlers.py"
Cohesion: 0.09
...
### Community 229 - "test_portfolio_intelligence.py"
Cohesion: 0.10
...
### Community 232 - "get_failover_manager"
Cohesion: 0.07
...
### Community 233 - "test_daily_2026_06_04.py"
Cohesion: 0.08
...
### Community 234 - "system_instruction"
Cohesion: 0.16
...
### Community 239 - "test_e2b_task_wiring.py"
Cohesion: 0.08
...
### Community 240 - "test_provider_render_env.py"
Cohesion: 0.09
...
### Community 244 - "provider_max_rpm"
Cohesion: 0.29
...
### Community 246 - "test_ceo_router.py"
Cohesion: 0.04
Nodes (62): build_ceo_router(), Any, APIRouter, backend/ceo_router.py — observability and manual control for the CEO. Surfaces…, Reject non-admin callers for routes that spend provider budget. Delegates to…, _require_admin(), get_ceo_dispatcher(), Return the shared CEODispatcher singleton. (+54 more)

### Community 247 - "test_brain_failover.py"
Cohesion: 0.09
Nodes (37): ProviderHealth, Enum, Circuit-breaker state for a provider., _clean_env(), _make_manager(), tests/test_brain_failover.py — Universal multi-provider brain failover tests.…, Guards the three tests below from pinning a retired id again: if the fixture…, Strip all provider API keys and isolate the operator-state store.… (+29 more)

### Community 248 - "GitHubTools"
Cohesion: 0.12
...
### Community 252 - "[Unreleased]"
Cohesion: 0.05
Nodes (38): Added, Added, Added, Added, Added, Added, Added, Added (+30 more)

### Community 253 - "Screens"
Cohesion: 0.06
...
### Community 256 - "test_all_providers_discovery.py"
Cohesion: 0.16
...
### Community 259 - "BrainFailoverManager"
Cohesion: 0.10
...
### Community 261 - "WorkflowBuildRequest"
Cohesion: 0.09
...
### Community 262 - "test_llm_router_e2e.py"
Cohesion: 0.06
...
### Community 270 - "test_platform_controls.py"
Cohesion: 0.08
...
### Community 271 - "_build_default_manager"
Cohesion: 0.06
...
Cohesion: 0.23
Nodes (31): check(), main(), ok(), Any, Client, Returns access token for subsequent tests., Direct-mode chat. Passes even if no LLM backend is running (error message…, Company-graph lifecycle against the live server (no mocks). Regression coverage… (+23 more)
...
### Community 284 - "RateLimitTracker"
Cohesion: 0.16
...
### Community 285 - "test_connector_registry.py"
Cohesion: 0.12
...
### Community 286 - "WorkspaceManager"
Cohesion: 0.10
...
### Community 287 - "test_microagents.py"
Cohesion: 0.15
...
### Community 293 - "report_to_markdown"
Cohesion: 0.11
...
### Community 295 - "OrchestratorQueue"
Cohesion: 0.07
...
### Community 298 - "get_scheduler"
Cohesion: 0.05
Nodes (39): get_sam(), agent/sam.py — SAM Voice Agent (System Autonomy Manager) SAM is the voice-…, _get_backend_sam(), legacy_scheduler_delete(), legacy_scheduler_get(), Lazy-init the SAM agent for the backend deployment., Get SAM's current status., sam_status_backend() (+31 more)

### Community 299 - "SkillLibrary"
Cohesion: 0.11
...
### Community 304 - "test_failover_silent_exhaustion.py"
Cohesion: 0.10
...
### Community 305 - "TaskHarnessAdapter"
Cohesion: 0.08
...
### Community 306 - "session_retro.py"
Cohesion: 0.13
...
### Community 307 - "test_purge_backlog.py"
Cohesion: 0.09
...
### Community 308 - "test_autonomy_gate.py"
Cohesion: 0.12
...
### Community 311 - "output_filter.py"
Cohesion: 0.07
...
### Community 312 - "test_colibri_brain_shim.py"
Cohesion: 0.08
...
### Community 314 - "test_direct_chat_async.py"
Cohesion: 0.15
...
### Community 316 - "test_phase6_workflow.py"
Cohesion: 0.16
...
### Community 317 - "test_force_cleanup_conditional_delete.py"
Cohesion: 0.10
...
### Community 318 - "test_one_model_catalogue.py"
Cohesion: 0.09
...
### Community 319 - "test_rag_context.py"
Cohesion: 0.12
...
### Community 320 - "ProjectScaffolder"
Cohesion: 0.13
...
### Community 321 - "get_skill_registry_safe"
Cohesion: 0.11
Nodes (27): get_skill_registry_safe(), Return the global SkillRegistry if set, else None. Used by onboarding and other…, _DoctorCheck, _DoctorReport, get_doctor_diagnostics(), get_doctor_report(), get_public_doctor(), Consolidated system health report: preflight checks + runtime health. Returns a… (+19 more)

### Community 322 - "is_anthropic_base_url"
Cohesion: 0.18
...
### Community 323 - "SteeringInjector"
Cohesion: 0.11
...
### Community 324 - "test_claude_setup_audit.py"
Cohesion: 0.16
...
### Community 326 - "test_phase4_runtime_resilience.py"
Cohesion: 0.14
...
### Community 328 - "test_mcp_governance.py"
Cohesion: 0.12
...
### Community 330 - "Python Dependencies (`requirements.txt`)"
Cohesion: 0.07
...
### Community 331 - "Technical Debt Register — local-llm-server"
Cohesion: 0.07
...
### Community 334 - "autonomous_fix.py"
Cohesion: 0.11
Nodes (22): _decline(), _extract_pytest_failure(), _fetch_failure_context(), _list_target_prs(), main(), _post_comment(), _pr_head(), _prior_attempt_count() (+14 more)

### Community 335 - "TrafficDirector"
Cohesion: 0.04
Nodes (53): provider_max_parallel(), provider_max_tpm(), _provider_positive_float(), provider_weight(), Shared parse/validate for the numeric per-provider traffic budgets. Returns…, Return the operator-configured tokens/min cap for *provider*. Reads…, Return the operator-configured share weight for *provider*. Reads…, Return the operator-configured in-flight request cap for *provider*. Reads… (+45 more)
...
### Community 337 - "test_memory_guard.py"
Cohesion: 0.13
...
### Community 340 - "test_agent_scripts_share_one_model_list.py"
Cohesion: 0.10
...
### Community 341 - "test_crispy_burn_in.py"
Cohesion: 0.07
...
### Community 342 - "test_implement_agent_routing.py"
Cohesion: 0.07
...
### Community 352 - "test_webui_provider_priority.py"
Cohesion: 0.24
...
### Community 353 - "isolated_telegram_config"
Cohesion: 0.11
...
### Community 355 - "test_nvidia_default_model.py"
Cohesion: 0.17
...
### Community 357 - "test_scheduler_hydration_bounded.py"
Cohesion: 0.09
...
### Community 362 - "TestSelfHealingInfrastructureClassification"
Cohesion: 0.19
...
### Community 363 - "LLM Router — troubleshooting"
Cohesion: 0.08
...
### Community 366 - "control_registry.py"
Cohesion: 0.14
...
### Community 369 - "test_telegram_approval_e2e.py"
Cohesion: 0.11
Nodes (26): admin_jwt(), _approve_execution_via_rest(), _delete_task(), _extract_admin_token(), _login_admin(), _looks_like_admin_token(), _open_dashboard(), _poll_task_execution_approved() (+18 more)

### Community 370 - "test_brain_migration_writes_a_live_model.py"
Cohesion: 0.10
...
### Community 371 - "test_daily_automation_2026_08_03.py"
Cohesion: 0.11
...
### Community 372 - "test_provider_enable_disable.py"
Cohesion: 0.10
...
### Community 373 - "test_telegram_mutating_commands.py"
Cohesion: 0.08
...
### Community 376 - "test_direct_chat_evolution.py"
Cohesion: 0.12
...
### Community 377 - "test_kimi_bridge_server.py"
Cohesion: 0.12
...
### Community 385 - "test_north_mini_code.py"
Cohesion: 0.09
...
### Community 386 - "test_claude_code_adapter.py"
Cohesion: 0.14
...
### Community 388 - "TemporalContextGraph"
Cohesion: 0.10
...
### Community 391 - "test_sam_livekit.py"
Cohesion: 0.05
...
### Community 396 - "model_discovery.py"
Cohesion: 0.12
...
### Community 397 - "scan_repo_with_user_research.py"
Cohesion: 0.22
...
### Community 399 - "Local AI Stack with Docker"
Cohesion: 0.08
...
### Community 400 - "Traffic Distribution Across Providers"
Cohesion: 0.14
...
### Community 401 - "Implementation Prompt: Rich TaskBoard + Agile Sprint Integration"
Cohesion: 0.08
...
### Community 402 - "Telegram Bot Setup"
Cohesion: 0.08
...
### Community 408 - "Native operations"
Cohesion: 0.09
...
### Community 409 - "_process_task_callback"
Cohesion: 0.16
...
### Community 410 - "test_telegram_service_webhook.py"
Cohesion: 0.18
...
### Community 411 - "test_regression.py"
Cohesion: 0.12
...
### Community 412 - "test_agency_fix.py"
Cohesion: 0.08
...
### Community 413 - "TestBrainConfigUpdates"
Cohesion: 0.22
...
### Community 417 - "_status_snapshot"
Cohesion: 0.15
...
### Community 419 - "Agent Governance Guide"
Cohesion: 0.09
...
### Community 420 - "The fifteen strategies"
Cohesion: 0.09
...
### Community 425 - "WindowsServiceManager"
Cohesion: 0.18
...
### Community 426 - "OrchestratorCheckpointStore"
Cohesion: 0.10
...
### Community 427 - "platform_controls_router.py"
Cohesion: 0.10
...
### Community 428 - "SyntheticDataPipeline"
Cohesion: 0.13
...
### Community 431 - "test_cerebras_catalogue.py"
Cohesion: 0.13
...
### Community 432 - "test_monitor_lib.py"
Cohesion: 0.11
...
### Community 444 - "weekly_digest.py"
Cohesion: 0.13
...
### Community 448 - "test_freebuff_bot.py"
Cohesion: 0.12
...
### Community 449 - "TestLegacyRouterCacheTTL"
Cohesion: 0.13
...
### Community 450 - "test_anthropic_refusal_fallback.py"
Cohesion: 0.19
...
### Community 451 - "test_telegram_diag_endpoint.py"
Cohesion: 0.09
...
### Community 452 - "test_prompt_injection_boundary.py"
Cohesion: 0.17
...
### Community 458 - "nvidia_models.py"
Cohesion: 0.09
...
### Community 459 - "SeoCheckDefinition"
Cohesion: 0.11
...
### Community 463 - "router/health.py"
Cohesion: 0.20
...
### Community 469 - "PersistentMemoryStore"
Cohesion: 0.24
...
### Community 475 - "2. Container hardening"
Cohesion: 0.17
...
### Community 489 - "PriorityTaskQueue"
Cohesion: 0.15
...
### Community 501 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 503 - "Skill: fabric-patterns"
Cohesion: 0.11
...
### Community 504 - "Analysis & Synthesis Instructions"
Cohesion: 0.11
Nodes (18): 1. Define the Atmosphere, 2. Map the Color Palette, 3. Establish Typography Rules, 4. Define the Hero Section, 5. Describe Component Stylings, 6. Define Layout Principles, 7. Define Responsive Rules, 8. Encode Motion Philosophy (+10 more)

### Community 505 - "Production Readiness Assessment — local-llm-server"
Cohesion: 0.11
...
### Community 510 - "Delegation Plan (agent-ready work packages)"
Cohesion: 0.11
...
### Community 511 - "test_p0_roadmap_a4_a5_b2.py"
Cohesion: 0.15
...
### Community 514 - "run_bot"
Cohesion: 0.11
Nodes (20): _configure(), _default(), main(), Set an env var only when the operator hasn't already provided one., get_webhook_info(), _poller_disabled(), Any, Call a Telegram Bot API method and return the parsed JSON (best-effort).… (+12 more)

### Community 515 - "test_task_source_id_race.py"
Cohesion: 0.17
...
### Community 516 - "test_brain_patch_service_token.py"
Cohesion: 0.18
...
### Community 517 - "test_repowise_intelligence.py"
Cohesion: 0.11
...
### Community 518 - "test_fabric_patterns.py"
Cohesion: 0.11
...
### Community 519 - "test_orchestrator_merge_decision.py"
Cohesion: 0.24
...
### Community 520 - "test_ai_insights.py"
Cohesion: 0.05
...
### Community 521 - "test_schedule_persistence.py"
Cohesion: 0.15
...
### Community 523 - "sam_livekit_worker.py"
Cohesion: 0.13
...
### Community 524 - "ErrorInterceptorMiddleware"
Cohesion: 0.19
...
### Community 525 - "test_daily_2026_07_24.py"
Cohesion: 0.20
...
### Community 527 - "TestAnthropicWorkspaceIdCapture"
Cohesion: 0.33
...
### Community 528 - "agile_sprints.py"
Cohesion: 0.14
...
### Community 531 - "Comprehensive Skill Index (By Category)"
Cohesion: 0.11
...
### Community 532 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 533 - "Component Map"
Cohesion: 0.11
...
### Community 534 - "test_render_mcp.py"
Cohesion: 0.07
...
### Community 535 - "test_minimax_bug_fixes.py"
Cohesion: 0.13
...
### Community 546 - "test_company_api.py"
Cohesion: 0.11
...
### Community 548 - "TestStopSlopChecker"
Cohesion: 0.11
...
### Community 549 - "handle_workflow_ide_chat"
Cohesion: 0.18
...
### Community 553 - "test_issue_triage.py"
Cohesion: 0.16
...
### Community 557 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 558 - "Section-by-Section Acceptance Criteria"
Cohesion: 0.12
...
### Community 559 - "settings.py"
Cohesion: 0.07
Nodes (29): Cerebras provider adapter — free, fast LLM (qwen-3-coder-480b)., Groq provider adapter — free, fast LLM (deepseek-r1-distill-llama-70b)., NVIDIA NIM provider adapter — wraps the existing provider_router logic. This is…, Ollama provider adapter — local LLM inference., packages.ai — provider abstraction, model registry, and failover manager., ProviderManager, Provider, packages/ai/manager.py — ProviderManager. Single entry point for all LLM calls.… (+21 more)

### Community 560 - "AgentDefinition"
Cohesion: 0.05
Nodes (33): AgentDefinition, AgentStore, Any, field_validator, agents/store.py — Persistent store for user-defined agent configurations.…, CRUD store for AgentDefinition objects. Uses MongoDB when a `db` client is…, Return an agent by ID. If *owner_id* is provided, enforces that the agent…, Delete an agent. Returns True on success, False if not found/unauthorised. (+25 more)

### Community 561 - "kimi_bridge_provider_config"
Cohesion: 0.18
...
### Community 562 - "agent_readiness_audit.py"
Cohesion: 0.21
...
### Community 565 - "TestAListingFailureDoesNotVetoTheAnswer"
Cohesion: 0.17
...
### Community 567 - "test_frontend_deployment_guards.py"
Cohesion: 0.18
...
### Community 568 - "test_health_endpoints.py"
Cohesion: 0.17
...
### Community 569 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 570 - "test_openclaw_endpoints.py"
Cohesion: 0.12
...
### Community 572 - "test_skill_registry.py"
Cohesion: 0.13
...
### Community 573 - "test_task_service_failed_comment.py"
Cohesion: 0.18
...
### Community 574 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 582 - "_valid_login_state"
Cohesion: 0.24
...
### Community 587 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 588 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 594 - "TestAdapterMetadata"
Cohesion: 0.06
...
### Community 598 - "test_telegram_auto_approve.py"
Cohesion: 0.23
...
### Community 599 - "ManagedAgentDreams"
Cohesion: 0.22
...
### Community 600 - "_resolve_push_token"
Cohesion: 0.31
...
### Community 601 - "test_agency_workflows_carry_the_failover_chain.py"
Cohesion: 0.18
...
### Community 602 - "test_autonomy_status.py"
Cohesion: 0.12
...
### Community 603 - "test_brain_failover_413.py"
Cohesion: 0.13
...
### Community 604 - "test_gh_brain_failover.py"
Cohesion: 0.11
...
### Community 606 - "test_local_brain_state.py"
Cohesion: 0.12
...
### Community 607 - "test_model_catalog_guard.py"
Cohesion: 0.29
...
### Community 608 - "test_phase5_doctor.py"
Cohesion: 0.12
...
### Community 612 - "register_user_research_tools"
Cohesion: 0.29
...
### Community 613 - "test_contract_enforcement.py"
Cohesion: 0.17
...
### Community 616 - "Skill: agent-harness"
Cohesion: 0.13
...
### Community 617 - "Skill: checkpoint-strategy"
Cohesion: 0.13
...
### Community 619 - "Skill: local-ai-query"
Cohesion: 0.13
...
### Community 620 - "Skill: parallel-agents"
Cohesion: 0.13
...
### Community 621 - "Skill: parallel-worktrees"
Cohesion: 0.13
...
### Community 622 - "Design System: Taste Standard"
Cohesion: 0.13
...
### Community 625 - "Skill: user-research"
Cohesion: 0.13
...
### Community 626 - "Nothing is blocked on an agent. Two things need a human."
Cohesion: 0.12
...
### Community 627 - "CompanyGraph"
Cohesion: 0.04
Nodes (28): DirectChatSession, Direct chat session with Company Graph context binding., Bind a company to this chat session and load its Company Graph., Bind a repository to this chat session., Get the bound Company Graph., Get enriched context including Company Graph data., CompanyGraph, SpecialistFamily (+20 more)
...
### Community 634 - "DockerAgentAdapter"
Cohesion: 0.17
...
### Community 635 - "AdminDigestRouterAuthTests"
Cohesion: 0.22
...
### Community 636 - "clear_wizard_state_cache"
Cohesion: 0.21
...
### Community 637 - "e2e/test_browser.py"
Cohesion: 0.23
...
### Community 640 - "TestModelRegistryUpdates"
Cohesion: 0.14
...
### Community 641 - "DecisionsStoreTests"
Cohesion: 0.13
...
### Community 644 - "WorkflowScreen.jsx"
Cohesion: 0.14
...
### Community 650 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 654 - "Checks Performed"
Cohesion: 0.14
...
### Community 655 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 656 - "admin_digest_router.py"
Cohesion: 0.22
...
### Community 657 - "Skill: branch-cleanup"
Cohesion: 0.14
...
### Community 658 - "Skill: perplexity — Web Research via Perplexity API"
Cohesion: 0.14
...
### Community 661 - "Quick-Note Issues Processing Summary"
Cohesion: 0.14
...
### Community 673 - "test_scanner_live.py"
Cohesion: 0.23
...
### Community 675 - ".on_task_complete"
Cohesion: 0.18
...
### Community 676 - "test_critical_flows.py"
Cohesion: 0.29
...
### Community 680 - "test_openclaw_gateway.py"
Cohesion: 0.14
...
### Community 682 - "TestMCPClientStructuredOutput"
Cohesion: 0.31
...
### Community 683 - "test_workspace_tools.py"
Cohesion: 0.29
...
### Community 684 - "test_telegram_webhook.py"
Cohesion: 0.14
...
### Community 685 - "TestRouterIntegration"
Cohesion: 0.31
...
### Community 688 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 691 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 692 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 695 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
...
### Community 696 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 697 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 699 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 704 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
Nodes (12): Acceptance Checks, Claude's query protocol (use this instead of Read tool for exploration):, Graph Artifacts — What to Commit, How to Use the Graph (Token Savings Protocol), Installation (one-time per machine), Instead of reading raw files:, Key commands:, Relationship to repowise-intelligence Skill (+4 more)

### Community 705 - "Skill: platform-setup — Autonomous Agency Bootstrap"
Cohesion: 0.15
...
### Community 706 - "Device compatibility and model picks"
Cohesion: 0.15
...
### Community 707 - "Autonomy Uplift — Living Roadmap & Detailed Implementation Specs"
Cohesion: 0.15
...
### Community 708 - "OpenClaw — iOS Control of the Agency (Single-Service Free-Tier Deploy)"
Cohesion: 0.15
...
### Community 711 - "test_llm_router_tpm.py"
Cohesion: 0.20
...
### Community 713 - "OperationalIncidentTracker"
Cohesion: 0.12
...
### Community 715 - "backend/server.py"
Cohesion: 0.02
Nodes (220): admin_seed(), _agent_timeout_fallback_response(), AgentStatusEntry, AgentStatusResponse, AgentToolCallEntry, ApiKeyCreate, AuthorizeReposBody, BrainTestRequest (+212 more)

### Community 716 - "Summary"
Cohesion: 0.15
...
### Community 717 - "Agent Transparency Report"
Cohesion: 0.15
...
### Community 718 - "update_provider_policy"
Cohesion: 0.19
...
### Community 720 - "_InMemoryBackend"
Cohesion: 0.11
...
### Community 722 - "TestAgentRunnerSafety"
Cohesion: 0.19
...
### Community 725 - "TestDecisionsBotLinks"
Cohesion: 0.21
...
### Community 727 - "Agent Runtime Setup"
Cohesion: 0.12
...
### Community 728 - "TestKillSwitchDurability"
Cohesion: 0.15
...
### Community 729 - "test_quick_note_engine.py"
Cohesion: 0.17
...
### Community 730 - "test_skill_registry_boot_refresh.py"
Cohesion: 0.12
...
### Community 731 - "AgentsScreen.jsx"
Cohesion: 0.18
...
### Community 733 - "WorkspaceManifest"
Cohesion: 0.17
...
### Community 734 - "_is_bedrock_model_id"
Cohesion: 0.27
...
### Community 737 - "AGENTS.md — Codebase Map & Operations Reference"
Cohesion: 0.15
...
### Community 746 - "company_api.py"
Cohesion: 0.04
Nodes (99): ephemeral_ttl_hours(), Async read of the ephemeral TTL (hours) straight from the DB., account_lifecycle(), AccountLifecycleResponse, auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint() (+91 more)

### Community 747 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 750 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 752 - "Main proxy (`proxy.py`)"
Cohesion: 0.14
...
### Community 753 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 754 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 755 - "Workspace Isolation Architecture"
Cohesion: 0.15
...
### Community 757 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 758 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 759 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 763 - "verify_service_token"
Cohesion: 0.22
...
### Community 764 - "install-agents.sh"
Cohesion: 0.39
...
### Community 765 - "check_container_posture.py"
Cohesion: 0.26
...
### Community 766 - "test_pytest_failure_parser.py"
Cohesion: 0.23
...
### Community 767 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 768 - "test_admin_local_brain_router.py"
Cohesion: 0.29
...
### Community 769 - "test_agile_api.py"
Cohesion: 0.17
...
### Community 770 - "test_app_settings.py"
Cohesion: 0.21
...
### Community 771 - "test_brain_default_consistency.py"
Cohesion: 0.24
...
### Community 772 - "FeatureUnavailableError"
Cohesion: 0.15
...
### Community 773 - "test_seo_audit.py"
Cohesion: 0.07
...
### Community 774 - "test_task_clarification.py"
Cohesion: 0.17
...
### Community 775 - "RuntimeHealthService"
Cohesion: 0.09
...
### Community 779 - "_extractive_compress"
Cohesion: 0.18
...
### Community 780 - "test_log_monitor_storm_guard.py"
Cohesion: 0.48
...
### Community 781 - "test_tasks_awaiting_approval_api.py"
Cohesion: 0.37
...
### Community 789 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 792 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 793 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 794 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 795 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 796 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 797 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 798 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 799 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 801 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 802 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 803 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 805 - "What to clean up"
Cohesion: 0.18
...
### Community 806 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 809 - "test_bedrock_live.py"
Cohesion: 0.25
...
### Community 813 - "InitiativeProgress"
Cohesion: 0.33
...
### Community 816 - "test_conftest_hermetic_env.py"
Cohesion: 0.18
...
### Community 817 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 819 - "brain_config.py"
Cohesion: 0.05
Nodes (44): get_brain_config_store(), provider_base_url(), _provider_env_value(), _provider_ids_from_literal(), provider_key_rotation_enabled(), services/brain_config_store.py — DB-persisted, UI-switchable "brain" config.…, Return the process-wide ``BrainConfigStore`` singleton., Force a cache refresh (used by tests + the GET /admin/api/policy/brain… (+36 more)

### Community 820 - "TestRequireAdmin"
Cohesion: 0.29
Nodes (3): Return a FastAPI dependency that checks for a specific permission., require_permission(), TestRequireAdmin

### Community 822 - "SavingsTracker"
Cohesion: 0.14
...
### Community 825 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 826 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 827 - "admin_local_brain_router.py"
Cohesion: 0.22
...
### Community 829 - "_normalize_tool_choice"
Cohesion: 0.31
...
### Community 830 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 831 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 832 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 833 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 834 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 835 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 836 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 838 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 839 - "LLM Router — configuration guide"
Cohesion: 0.20
...
### Community 840 - "LLM Router — provider guide"
Cohesion: 0.20
...
### Community 841 - "CI Troubleshooting Runbook"
Cohesion: 0.18
...
### Community 844 - "test_telegram_task_callback.py"
Cohesion: 0.26
...
### Community 852 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 854 - "test_nvidia_model_discovery.py"
Cohesion: 0.06
...
### Community 857 - "_InMemoryErrorLogHandler"
Cohesion: 0.50
Nodes (3): _ensure_error_log_capture(), _InMemoryErrorLogHandler, LogRecord

### Community 858 - "TestAnthropicPayloadStructuredOutput"
Cohesion: 0.29
...
### Community 864 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 868 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 869 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 870 - "Skill: changelog-enforcer"
Cohesion: 0.22
Nodes (8): Acceptance Checks, Changelog Location, Entry Format, Examples, Hook Behaviour, Instructions, Skill: changelog-enforcer, When to Use

### Community 871 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
Nodes (8): Branch, Components, Purpose, Quick Start, Session Roles, Skill: cowork-session (Claude Cowork), Testing, When to Use

### Community 872 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 873 - "Active Task Tracker"
Cohesion: 0.22
...
### Community 875 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 876 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 877 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 878 - "Issue #1356: quick-note:https://searchengineland.com/turn-seo-backlog-into-roadmap-485713"
Cohesion: 0.22
...
### Community 879 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 880 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 881 - "Platform Controls"
Cohesion: 0.22
...
### Community 882 - "Release Procedure"
Cohesion: 0.22
...
### Community 883 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 887 - "Competitor Analysis — Autonomous AI Agency"
Cohesion: 0.20
...
### Community 888 - "Issue #1427: quick-note:https://github.com/bingreeky/JIT"
Cohesion: 0.20
...
### Community 890 - "enrich_quick_note_issues.py"
Cohesion: 0.42
...
### Community 891 - "_redact_for_notification"
Cohesion: 0.24
...
### Community 892 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 894 - "test_changelog_parity_guard.py"
Cohesion: 0.22
...
### Community 896 - "test_workflow_api_mount.py"
Cohesion: 0.20
...
### Community 897 - "test_scanner_deps_parity.py"
Cohesion: 0.31
...
### Community 905 - "quality_checker.py"
Cohesion: 0.32
...
### Community 907 - "governance/README.md"
Cohesion: 0.22
...
### Community 913 - "Skill: memory-consolidation (Dream Memory)"
Cohesion: 0.25
...
### Community 918 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 923 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.25
...
### Community 924 - "Issue #362: Nvidia repo setup"
Cohesion: 0.25
...
### Community 925 - "Issue #364: quick-note:https://www.marktechpost.com/2026/06/01/meet-memory-os-a-6-layer-open-source-memory-stack-built-on-top-of-hermes-agent/"
Cohesion: 0.25
...
### Community 926 - "Issue #378: quick-note:https://www.marktechpost.com/2026/06/02/tinyfish-launches-bigset-an-open-source-multi-agent-system-that-builds-structured-live-datasets-from-plain-english-descriptions/"
Cohesion: 0.25
...
### Community 927 - "Issue #379: quick-note:https://searchengineland.com/schema-markup-optimize-agentic-web-479080"
Cohesion: 0.25
...
### Community 928 - "Issue #380: quick-note:https://cursor.com/blog/cloud-agent-lessons"
Cohesion: 0.25
...
### Community 929 - "Issue #381: quick-note:https://www.xda-developers.com/claude-code-with-opus-48-is-expensive-but-i-made-it-efficient-with-my-local-ai-workflow/"
Cohesion: 0.25
...
### Community 930 - "Issue #382: quick-note:https://claude.com/blog/how-coderabbit-used-claude-to-build-an-agent-orchestration-system"
Cohesion: 0.25
...
### Community 931 - "Issue #383: quick-note:https://www.marktechpost.com/2026/05/29/hexo-labs-open-sources-sia-a-self-improving-agent-that-updates-both-the-harness-and-the-model-weights/"
Cohesion: 0.25
...
### Community 932 - "Issue #416: feat: Self-hosted Codebuff (freebuff) on free NVIDIA models + Telegram bot phone control"
Cohesion: 0.25
...
### Community 933 - "Issue #485: [Trend Digest] Week of 2026-06-08"
Cohesion: 0.25
...
### Community 934 - "Issue #488: quick-note:https://github.com/cookiy-ai/user-research-skill"
Cohesion: 0.25
...
### Community 935 - "Issue #491: Implement whatever is necessary from https://github.com/BehiSecc/awesome-claude-skills"
Cohesion: 0.25
...
### Community 936 - "Issue #493: Use the https://github.com/mvanhorn/last30days-skill skill to get the trend updated"
Cohesion: 0.25
...
### Community 937 - "Issue #495: Read https://www.anthropic.com/news/claude-fable-5-mythos-5 and understand if mythos or fable can be added to the repo"
Cohesion: 0.25
...
### Community 938 - "Issue #504: EPIC: Autonomy hardening — live-verified defects 2026-06-10"
Cohesion: 0.25
...
### Community 939 - "Issue #581: Sprint tracker: pending work after brand rename + mobile-first pass"
Cohesion: 0.25
...
### Community 941 - "Issue #657: quick-note:https://github.com/earendil-works/pi"
Cohesion: 0.25
...
### Community 942 - "Issue #659: quick-note:https://github.com/nex-agi/Nex-N2"
Cohesion: 0.25
...
### Community 943 - "Issue #660: quick-note:https://github.com/getsentry/sentry-for-ai"
Cohesion: 0.25
...
### Community 944 - "Issue #661: quick-note:https://github.com/XiaomiMiMo/MiMo-Code"
Cohesion: 0.25
...
### Community 945 - "Issue #664: quick-note:https://github.com/Grominet95/jarvis-OS"
Cohesion: 0.25
...
### Community 946 - "Issue #666: quick-note:https://github.com/porokka/jarvis-os"
Cohesion: 0.25
...
### Community 947 - "Issue #670: quick-note:https://github.com/perplexityai/bumblebee"
Cohesion: 0.25
...
### Community 948 - "Issue #672: quick-note:https://github.com/Chachamaru127/claude-code-harness"
Cohesion: 0.25
...
### Community 949 - "Issue #676: quick-note:https://github.com/WeiboAI/VibeThinker"
Cohesion: 0.25
...
### Community 950 - "Issue #820: quick-note:https://github.com/cobusgreyling/loop-engineering"
Cohesion: 0.25
...
### Community 951 - "Positional Encoding Internals"
Cohesion: 0.25
...
### Community 952 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 953 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 954 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 955 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 956 - "Continual Harness (`agent/harness_spec.py`)"
Cohesion: 0.25
...
### Community 957 - "Prime Agent Runtime"
Cohesion: 0.25
...
### Community 963 - "run_patched_colibri.py"
Cohesion: 0.36
...
### Community 965 - "TestItIsNotBuiltForOneVendor"
Cohesion: 0.25
...
### Community 966 - "test_compose_and_coordinate_api.py"
Cohesion: 0.36
...
### Community 969 - "_start_ceo_agency"
Cohesion: 0.31
...
### Community 970 - "TestGithubSignalHardening"
Cohesion: 0.22
...
### Community 972 - "test_provider_models_db_outage.py"
Cohesion: 0.25
...
### Community 973 - "test_runtimes_health_endpoint.py"
Cohesion: 0.25
...
### Community 977 - "test_serve_spa_prefixes.py"
Cohesion: 0.36
...
### Community 978 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.25
...
### Community 980 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 983 - "TestPaidPolicyDurability"
Cohesion: 0.22
...
### Community 992 - "Changelog"
Cohesion: 0.29
Nodes (7): Added, Changed, Changelog, Fixed, Maintenance, Removed, Security

### Community 993 - "AI Engineering Insights Skill"
Cohesion: 0.29
...
### Community 1007 - "claude-mem Plugin — Persistent Memory for All Sessions"
Cohesion: 0.29
...
### Community 1008 - "Implementation plan + TO-DO (check off as you go)"
Cohesion: 0.29
...
### Community 1011 - "Cloudflare = the real working app"
Cohesion: 0.29
...
### Community 1020 - "e2e_smoke.py"
Cohesion: 0.57
Nodes (5): _chat(), check(), _health(), _models(), _req()

### Community 1021 - "task_runner.py"
Cohesion: 0.33
...
### Community 1026 - "apply_overrides"
Cohesion: 0.22
...
### Community 1027 - "test_doctor_coding_brain.py"
Cohesion: 0.38
...
### Community 1029 - "TestGithubTokenSQLiteRegression"
Cohesion: 0.38
...
### Community 1030 - "TestReasonsAreActionable"
Cohesion: 0.29
...
### Community 1031 - "TestProvidersScreen"
Cohesion: 0.43
...
### Community 1032 - "CapacityAllocation"
Cohesion: 0.25
...
### Community 1033 - "Agent Autonomy Roadmap"
Cohesion: 0.25
...
### Community 1037 - "4. Troubleshooting"
Cohesion: 0.25
...
### Community 1052 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 1053 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 1054 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 1055 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 1056 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 1057 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 1059 - "test_seo_audit_pending_expiry.py"
Cohesion: 0.43
...
### Community 1061 - "._resolve_merge_decision"
Cohesion: 0.25
...
### Community 1062 - "apply_phase1_changes.py"
Cohesion: 0.33
...
### Community 1073 - "TestPoliciesGovernanceStableClaim"
Cohesion: 0.25
...
### Community 1074 - "TestDirectChatAgentExecution"
Cohesion: 0.33
...
### Community 1075 - "test_catalogue_probe.py"
Cohesion: 0.20
...
### Community 1077 - "test_hermes_server.py"
Cohesion: 0.25
...
### Community 1078 - "TestOneIdCanBelongToSeveralProviders"
Cohesion: 0.39
...
### Community 1079 - "TestRunCoroSync"
Cohesion: 0.29
...
### Community 1081 - "classify_domain"
Cohesion: 0.29
...
### Community 1092 - "Issue #230 — DUPLICATE"
Cohesion: 0.40
Nodes (4): Actions Taken, Issue #230 — DUPLICATE, References, Resolution

### Community 1094 - "Agent job lifecycle"
Cohesion: 0.40
...
### Community 1097 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 1098 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 1109 - "_add_colibri_shim_changelog_entry.py"
Cohesion: 0.50
...
### Community 1110 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1111 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1112 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 1113 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 1114 - "TestAgentRunnerExecution"
Cohesion: 0.33
...
### Community 1122 - "test_agent_runtime_wrapper.py"
Cohesion: 0.70
...
### Community 1126 - "TestTheProbeIdentifiesItself"
Cohesion: 0.40
...
### Community 1127 - "Threat Model — Autonomous Agent Execution"
Cohesion: 0.29
...
### Community 1128 - "TestModelRoleSeparation"
Cohesion: 0.40
...
### Community 1143 - "scripts"
Cohesion: 0.50
Nodes (4): scripts, build, start, test

### Community 1144 - "TestPolicyAuthoringUiStableClaim"
Cohesion: 0.29
...
### Community 1164 - "DirectChatDoctor"
Cohesion: 0.47
...
### Community 1185 - "Feature Support Matrix"
Cohesion: 0.33
Nodes (6): Admin API, Config Overrides, Feature Matrix, Feature Support Matrix, Gating Behavior, Maturity Tiers

### Community 1186 - "TestDisabledProvidersAreNotFalselyReportedUnreachable"
Cohesion: 0.33
...
### Community 1190 - "feature-implementer.md"
Cohesion: 0.40
Nodes (4): Before you edit, Prove it, Report back, While you edit

### Community 1244 - ".get_bound_skills"
Cohesion: 0.40
...
### Community 1291 - "TestTelegramNotifications"
Cohesion: 0.40
...
### Community 1293 - "verify_pr_exists"
Cohesion: 0.50
...
### Community 1294 - "codebase-explorer.md"
Cohesion: 0.50
Nodes (3): Hard constraints, Method, Output

### Community 1295 - "docs-auditor.md"
Cohesion: 0.50
Nodes (3): Hard constraints, Output, What to check

### Community 1296 - "risk-reviewer.md"
Cohesion: 0.50
Nodes (3): Output, Rules of evidence, What you weigh

### Community 1297 - "verification-reviewer.md"
Cohesion: 0.50
Nodes (3): Output, Rules of evidence, What you evaluate

### Community 1298 - "test_direct_adapter_does_not_bypass"
Cohesion: 0.67
...
## Knowledge Gaps
- **3505 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3500 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 13385 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **109 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `_fixture()` connect `_fixture` to `TestTheWorkflowIsSafeAndReadOnly`, `test_doctor_coding_brain.py`, `test_brain_patch_service_token.py`, `test_orchestrator_merge_decision.py`, `test_ai_insights.py`, `test_llm_router_queue_cache.py`, `test_llm_router_strategies.py`, `ImprovementLoop`, `TaskWorkflowService`, `test_unit8_model_catalog.py`, `test_model_router.py`, `config.py`, `SelfHealingAgent`, `ExecutionRequest`, `E2BSandboxSession`, `test_llm_router_resilience.py`, `loop.py`, `enforcement.py`, `WebsiteScanner`, `resolve_active_brain`, `test_company_api.py`, `test_langfuse_agency_wide.py`, `TaskStore`, `test_failover_client_shared.py`, `Task`, `services/seo_audit.py`, `UserRole`, `test_agent_tool_governance.py`, `validate_policy_text`, `AgentDefinition`, `test_catalogue_probe.py`, `test_knowledge_sync.py`, `PrimeAgentAdapter`, `AgentJobManager`, `ChatHistoryStore`, `test_openclaw_endpoints.py`, `AgentSwarm`, `test_task_service_failed_comment.py`, `ResearchTask`, `ProviderRouter`, `test_procedural_memory.py`, `TaskExecutionCoordinator`, `SQLiteStore`, `test_telegram_auto_approve.py`, `TokenBudget`, `_resolve_push_token`, `test_autonomy_status.py`, `test_brain_failover_413.py`, `test_gh_brain_failover.py`, `models/seo_audit.py`, `test_local_brain_state.py`, `_FakeFiles`, `test_phase5_doctor.py`, `test_refresh_agent_built_proof.py`, `TestHarnessAdapter`, `services/background.py`, `cost_tracker.py`, `test_sam_voice.py`, `test_context_rulebook.py`, `ArtifactStore`, `KeyStore`, `HermesAdapter`, `e2e/test_browser.py`, `get_task_store`, `TestFeaturesAPI`, `_step`, `brain_failover.py`, `BackgroundAgent`, `test_trend_watcher.py`, `emit_chat_observation`, `clear_cooldowns`, `claim`, `TestAuthAndTaskOwnership`, `persist_plan_spec`, `TestEstimateTokensForMessages`, `test_response_cache.py`, `MCPClient`, `test_openclaw_gateway.py`, `KeyPool`, `test_telegram_webhook.py`, `NotificationDispatcher`, `TestSwarmRoleRouting`, `OllamaCircuitBreaker`, `_job_text`, `TestRuntimeControl`, `facade.py`, `test_new_features_e2e.py`, `test_features_api.py`, `test_video_transcript.py`, `TrendWatcher`, `test_llm_router_tpm.py`, `test_agent_free_brain.py`, `_Budget`, `OperationalIncidentTracker`, `test_process_quick_note_workflow.py`, `test_portfolio_intake.py`, `TestAgentRunnerSafety`, `test_brain_availability_doctor.py`, `test_operational_incidents.py`, `test_skill_registry_boot_refresh.py`, `test_llm_router_disabled.py`, `TestClient`, `timedelta`, `ContextPruner`, `test_ceo_router.py`, `test_brain_failover.py`, `parse_event_stream`, `test_agile_api.py`, `test_app_settings.py`, `test_persistent_memory.py`, `SecurityScanner`, `WorkflowBuildRequest`, `test_llm_router_e2e.py`, `test_task_clarification.py`, `OutputFilter`, `test_platform_controls.py`, `OrchestratorQueue`, `get_scheduler`, `TestNormalizeResponseFormat`, `session_retro.py`, `brain_config.py`, `test_purge_backlog.py`, `analyze_page`, `get_skill_registry_safe`, `TestMongoGate`, `test_telegram_task_callback.py`, `capture_screens.py`, `TrafficDirector`, `test_agent_scripts_share_one_model_list.py`, `test_crispy_burn_in.py`, `test_implement_agent_routing.py`, `test_nvidia_model_discovery.py`, `isolated_telegram_config`, `test_scheduler_hydration_bounded.py`, `test_telegram_approval_e2e.py`, `test_provider_enable_disable.py`, `_undeclared`, `test_direct_chat_evolution.py`, `test_kimi_bridge_server.py`, `rate_limiter.py`, `test_claude_code_adapter.py`, `test_sam_livekit.py`, `test_service_token.py`, `test_harness_spec.py`, `model_discovery.py`, `test_telegram_service_webhook.py`, `test_regression.py`, `test_agency_fix.py`, `test_dashboard_cache.py`, `OrchestratorCheckpointStore`, `platform_controls_router.py`, `_get`, `test_monitor_lib.py`, `test_v4_api.py`, `test_telegram_diag_endpoint.py`, `_Recorder`, `_start_ceo_agency`, `test_ping.py`, `SchedulerStore`, `test_runtimes_health_endpoint.py`, `_Recorder`, `test_task_store_fails_loud_in_production.py`, `test_voice_pipeline.py`, `client`?**
  _High betweenness centrality (0.108) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `proxy.py`, `ReactScratchpad`, `TaskSpec`, `BackgroundAgent`, `FreeBuffAgent`, `ContextManager`, `test_backend_server_features.py`, `test_ceo_micromanager.py`, `E2BSandboxSession`, `.execute`, `ExecutionRequest`, `loop.py`, `enforcement.py`, `MCPClient`, `test_failover_client_shared.py`, `StuckDetector`, `test_agent_tool_governance.py`, `AgentSessionStore`, `test_ceo_supervision.py`, `test_empirical_verify.py`, `LocalWorkspace`, `MultiAgentSwarm`, `AgentJobManager`, `test_daily_automation_2026_07_11.py`, `WorkspaceTools`, `agency.py`, `test_agent_free_brain.py`, `backend/server.py`, `test_agent_chat_integration.py`, `InternalAgentAdapter`, `TestAgentRunnerSafety`, `AgentPlan`, `TokenBudget`, `UserMemoryStore`, `TestAgentRunnerExecution`, `test_brain_failover_413.py`, `test_governance_api.py`, `direct_chat.py`, `test_e2b_adapter.py`, `TestGetCurrentTimeTool`, `AdaptiveHalter`, `ContextPruner`, `GitHubTools`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderRouter` to `test_all_providers_discovery.py`, `_payload`, `implement_agent.py`, `test_backend_server_features.py`, `test_chat_mode_regressions.py`, `clear_cooldowns`, `failover_client.py`, `test_bedrock_live.py`, `TestRouterIntegration`, `settings.py`, `kimi_bridge_provider_config`, `test_colibri_brain_shim.py`, `TestLegacyRouterCacheTTL`, `is_anthropic_base_url`, `test_anthropic_refusal_fallback.py`, `backend/server.py`, `TrafficDirector`, `test_bedrock_provider.py`, `test_implement_agent_routing.py`, `TestAnthropicPayloadStructuredOutput`, `ProviderConfig`, `direct_chat.py`, `TestLegacyRouterServerFallback`, `ai/router.py`, `NvidiaProvider`?**
