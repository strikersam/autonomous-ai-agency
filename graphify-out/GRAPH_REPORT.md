# Graph Report - pr1502  (2026-09-14)

## Corpus Check
- 1510 files · ~2,189,827 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 55 file(s) not represented in the graph (top: (none) 17, .bat 5, .css 5)

## Summary
- 31854 nodes · 59172 edges · 1316 communities (1136 shown, 131 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 3970 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `795e6632`
...
## Communities (1316 total, 131 thin omitted)

### Community 0 - "backend/server.py"
Cohesion: 0.02
Nodes (276): admin_seed(), AgentStatusEntry, AgentStatusResponse, AgentToolCallEntry, ApiKeyCreate, auth_me(), AuthorizeReposBody, auto_recommend_skills() (+268 more)

### Community 1 - "LLMRequest"
Cohesion: 0.02
Nodes (145): ProviderConfig, One configured endpoint. ``kind`` selects the adapter: ``openai`` (any OpenAI-…, packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, classify_error(), LLMProvider, OpenAICompatible, ABC, Any (+137 more)

### Community 2 - "CompanyGraphStore"
Cohesion: 0.02
Nodes (108): Synchronize the Company Graph. Re-scans all websites and repositories, updates…, Scan a repository for technology stack and systems., scan_repo_endpoint(), sync_company_graph(), BusinessSystem, CompanyGraph, KnowledgeItem, OnboardingProgress (+100 more)

### Community 3 - "proxy.py"
Cohesion: 0.03
Nodes (174): middleware, admin_control(), admin_create_key(), admin_create_user(), admin_delete_user(), admin_list_users(), admin_login(), admin_logout() (+166 more)

### Community 4 - "TaskSpec"
Cohesion: 0.04
Nodes (105): kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, AiderAdapter, TaskResult, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Run aider non-interactively via `--message` flag., Adapter for Aider — TIER 3 specialized git-aware code editor., ClaudeCodeAdapter (+97 more)

### Community 5 - "llm/router.py"
Cohesion: 0.03
Nodes (137): int, get_budget(), packages/llm/budget.py — token and cost accounting with spend alerts. Tracks…, The process-wide budget tracker., Test hook — clear all usage accounting., reset(), get_cache(), payload_key() (+129 more)

### Community 6 - "test_llm_router_queue_cache.py"
Cohesion: 0.02
Nodes (104): CacheManager, cosine_similarity(), _Entry, LRUCache, Any, T, Live (unexpired) entries — used by the semantic layer's scan., Cosine similarity between two vectors, 0.0 when either is degenerate. (+96 more)
...
Cohesion: 0.03
Nodes (113): ephemeral_ttl_hours(), Async read of the ephemeral TTL (hours) straight from the DB., create_company(), get_company(), get_company_graph(), patch, Company Graph API Router Provides all endpoints for managing companies, their…, # NOTE: store.list_companies returns a plain List[Company] (no grand-total), (+105 more)
...
Cohesion: 0.03
Nodes (109): _migrate_brain_to_safe_default(), _active_primary_provider(), BrainConfig, BrainConfigPatch, BrainConfigStore, default_brain_config(), get_brain_config(), get_brain_config_store() (+101 more)
...
Cohesion: 0.04
Nodes (90): autonomy_tick(), Execute ONE pending task synchronously. Called by the cron workflow every 2…, Helpers that turn scheduler and playbook activity into real tasks., Creates tasks from scheduler and playbook runs using one workflow., TaskAutomationService, TaskStatus, Record the human decision on a task's **pre-execution** approval gate. A…, Re-run a task. Permissive across every non-active state so the dashboard Retry… (+82 more)

### Community 14 - "test_ceo_dispatcher.py"
Cohesion: 0.03
Nodes (110): _merge_changed_files(), Collect changed_files across all specialists into a single de-duped list., BoundContext, ClassifyOutput, ExecutionResult, get_ceo_fallback_stats(), JudgeVerdict, MonitorOutput (+102 more)

### Community 15 - "test_governance_sandbox.py"
Cohesion: 0.03
Nodes (83): Charge sub-agent nesting depth and enforce the ``max_depth`` ceiling. Isolates…, events_from_identity(), Any, Convenience: build and record an event in one call., Extract the identity-derived audit fields from an AgentIdentity. Kept here…, record_event(), build_docker_run_argv(), detect_backend() (+75 more)

### Community 16 - "AgentRunner"
Cohesion: 0.03
Nodes (68): AgentRunner, Any, Path, Governance seam: judge the call, run it, audit the outcome. Deliberately a thin…, Append an event to the durable session log if a store is wired in., Summarise a long history and compact it. Asks the planner model to write a…, Send chat messages and return the assistant's text output. If an…, Call-time resolver for an agent role model id. Delegates to… (+60 more)

### Community 17 - "SelfHealingAgent"
Cohesion: 0.03
Nodes (76): FailureCategory, heal_signature(), HealingEvent, HealState, _now(), Any, Enum, str (+68 more)

### Community 18 - "AgentDefinition"
Cohesion: 0.03
Nodes (88): _apply_activity_status(), create_agent(), delete_agent(), get_agent(), _get_user(), list_agents(), list_runtime_agents(), Any (+80 more)
...
Cohesion: 0.03
Nodes (87): Background dispatcher for task execution., tasks — Task/issue management system. Provides a lightweight task/issue tracker…, ApprovalCheckpoint, ApprovalRequest, _coerce_ts(), CommentAddRequest, ExecutionApprovalRequest, ExecutionLogEntry (+79 more)

### Community 22 - "BackgroundAgent"
Cohesion: 0.03
Nodes (59): BackgroundAgent, heartbeat(), BackgroundTask, _now(), Any, agent/background.py — Background Agent An always-on worker thread that…, Enqueue *task* for processing. Returns the task (with task_id set)., Convenience: create a task and submit it in one call. (+51 more)

### Community 23 - "MultiAgentSwarm"
Cohesion: 0.04
Nodes (70): AgentConfig, build_agent_specs(), build_swarm(), build_task_specs(), coordinate_v2(), CoordinateRequestV2, CoordinateResponse, Any (+62 more)
...
Cohesion: 0.04
Nodes (71): DetectedIssue, get_improvement_loop(), ImprovementLoop, ImprovementLoopState, IssueCategory, IssueSeverity, _now(), Any (+63 more)

### Community 26 - "loop.py"
Cohesion: 0.04
Nodes (61): Agent subsystem — planner / executor / verifier loop., _check_extra_kwargs(), _enforce_signature(), _note_phase_end(), _note_phase_start(), loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., Raise TypeError if fn's signature drifts from the locked contract (Pydantic…, Raise TypeError on unknown kwarg (runtime extra='forbid' for non-Pydantic… (+53 more)
...
Cohesion: 0.03
Nodes (86): _brain_provider_status(), get_catalog_models_route(), Return the mirrored model catalog (advisory-only). Flag-gated by…, Force a catalog mirror rebuild + persist (admin only). Rebuilds the catalog…, Return per-provider metadata for the GET endpoint. Iterates every provider in…, Return the discovered model list for *provider_id*, or ``[]`` if unknown., _served_models(), sync_catalog_route() (+78 more)

### Community 29 - "config.py"
Cohesion: 0.03
Nodes (78): AgentPolicy, _apply_env_overrides(), _apply_key_env(), _build(), _coerce(), config_dir(), _env_key_names(), expand_env() (+70 more)

### Community 30 - "resolve_active_brain"
Cohesion: 0.03
Nodes (96): allow_paid_brain(), BrainResolution, provider_api_key(), Return the live API key for *provider* (env-only — never persisted)., get_active_brain_sync(), get_brain_preference(), get_provider_role_tags(), _host_is_openai_compatible() (+88 more)
...
### Community 33 - "ai/router.py"
Cohesion: 0.04
Nodes (70): clear_cooldowns(), CommercialFallbackRequiredError, _dead_model_key(), _exponential_backoff_cooldown(), get_dead_models(), _get_director(), _is_model_dead(), is_provider_on_cooldown() (+62 more)
...
Cohesion: 0.04
Nodes (86): lifespan(), _deferred_startup_cleanup(), _maybe_boot_purge(), _purge_backlog_core(), quick_notes_submit(), _QuickNoteBody, The task store the background services should use, wiring it if needed.…, Shared purge implementation for the admin endpoint and the boot hook. (+78 more)

### Community 36 - "get_user_role"
Cohesion: 0.04
Nodes (57): compute_savings(), compute_time_series(), get_savings(), get_usage(), get_user_savings(), _period_start(), Any, BaseModel (+49 more)

### Community 37 - "Task"
Cohesion: 0.04
Nodes (53): Task, Full task/issue document., Task, _is_brain_connection_error(), _is_outward_facing(), Any, BaseException, TaskSpec (+45 more)
...
Cohesion: 0.04
Nodes (48): Called by APScheduler when a cron fires. Dispatches to the orchestrator. This…, _scheduler_on_fire(), get_orchestrator_supervisor(), OrchestratorSupervisor, Any, services/orchestrator_supervisor.py — Deterministic Supervisor Issue #522: A…, Emit an alert to the activity feed and log., Deterministic supervisor for the orchestrator. Runs as a background coroutine.… (+40 more)

### Community 41 - "Specialist"
Cohesion: 0.03
Nodes (53): SpecialistFamily, Find all specialists of a specific family., Find specialists that can handle a task with given capabilities., Request to provision a specialist for a company., A specialist agent that can be provisioned for company-specific tasks., Check if this specialist can handle a task with given capabilities., Specialist, SpecialistProvisionRequest (+45 more)
...
### Community 44 - "_fixture"
Cohesion: 0.02
Nodes (72): _clear_discovered_models(), _clear_response_cache(), _isolate_brain_data_layer(), _isolate_operator_provider_state(), MonkeyPatch, Path, Default all tests to legacy workflow mode (Phase 2 compatibility). Only patches…, Session-wide autouse: stub out any DB reads that go through… (+64 more)

### Community 45 - "WorkflowRun"
Cohesion: 0.04
...
### Community 48 - "SQLiteStore"
Cohesion: 0.03
Nodes (46): Create a new company in SQLite., Update a company in SQLite., Delete a company and all associated data from SQLite., List companies from SQLite., Count total companies in SQLite., Reconstruct a Website from a SQLite row, preferring the full JSON blob (which…, Create a new website in SQLite. The full model is stored in ``data`` so scan…, Get a website by ID from SQLite. (+38 more)
...
Cohesion: 0.04
Nodes (55): main(), Post-deploy verification for the website scanner against the LIVE internet.…, Returns (url, ok, summary)., _scan_one(), _is_safe_url(), _looks_like_bot_challenge(), BeautifulSoup, True if the HTML is an anti-bot/CAPTCHA interstitial rather than content. Used… (+47 more)
...
### Community 58 - "test_runtimes.py"
Cohesion: 0.05
Nodes (27): CircuitState, runtimes/health.py — RuntimeHealthService. Periodically polls all registered…, Reduce probe frequency for runtimes that have never come online., Return the single best adapter for *task_type*. If *preferred_runtime_id* is…, Maintains the catalogue of registered adapters and answers 'which runtimes can…, Return all adapters that can handle *task_type*, ordered by tier., RuntimeCapabilityRegistry, Admin-configurable routing policy. Defaults are conservative (local-first, no… (+19 more)

### Community 59 - "get_company_access"
Cohesion: 0.04
Nodes (77): account_lifecycle(), AccountLifecycleResponse, auto_recommend_skills(), cancel_onboarding(), delete_company_endpoint(), _DoctorCheck, _DoctorReport, generate_onboarding_questions() (+69 more)
...
Cohesion: 0.06
Nodes (69): activate_instance(), ActivateRequest, ActivateResponse, activation_audit_log(), ActivationStatusResponse, _append_audit(), AuditLogEntry, change_user_role() (+61 more)

### Community 68 - "test_web_reach.py"
Cohesion: 0.06
Nodes (45): _load_script_module(), Any, ModuleType, agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Dynamically load a pure-stdlib helper module from .github/scripts/. Returns…, Zero-key internet access: pages, YouTube transcripts, search, RSS. Every public…, Read a web page as plain text, following the same fallback chain (direct ->…, GET *url*, re-validating every redirect hop against ``unsafe_target_reason`` —… (+37 more)

### Community 69 - "test_phase6_workflow.py"
Cohesion: 0.06
Nodes (56): _append_transition(), classify_domain(), BaseModel, Enum, str, agent/workflow.py — Persisted workflow state machine. Implements the Autonomous…, Drives a Task through the execution state machine with persistence. Usage::…, Advance task through the full phase sequence. Resumes from… (+48 more)
...
Cohesion: 0.07
Nodes (65): audit(), Append an audit log entry. Never logs raw secrets — only secret IDs / masked…, complete_wizard(), _delete_wizard_state(), detect_configured_providers(), detect_hardware_for_wizard(), detect_models_for_wizard(), _detect_ollama_models() (+57 more)

### Community 78 - "enforcement.py"
Cohesion: 0.04
Nodes (52): _do_run_agent_job(), _run_agent_job(), wait_for_resume(), BudgetExceeded, classify(), evaluate_call(), governance_enabled(), guard_tool_call() (+44 more)

### Community 79 - "test_startup_warmup.py"
Cohesion: 0.04
Nodes (56): _bootstrap_within_budget(), _create_bootstrap_indexes(), ensure_bootstrap(), Await one warm-up step, deferring it to the background if it overruns.…, Create every boot index concurrently rather than one round-trip at a time.…, Idempotent bootstrap for indexes + seeded admin/providers. FastAPI startup…, Auto-detect the best available Ollama model and update ollama-local in the DB.…, Run bootstrap without letting it hold a request open indefinitely. Returns… (+48 more)
...
Cohesion: 0.06
Nodes (41): AgentRole, agents/swarm.py — AgentSwarm: routes workflow phases to the correct agent. The…, Run a pre-gate or report phase through the correct agent. Enforces permission…, Execute a slice via the Coder agent (write-permitted)., Review a slice via the Reviewer agent (different model from Coder). This is the…, Run verification commands via the Verifier agent. The Verifier is execution-…, Return a copy of *routing* with the profile's model injected for its role., When coder == reviewer model, swarm should log a warning. (+33 more)
...
Cohesion: 0.07
Nodes (55): _audit_dispatch(), _blocked_result(), _governance_check(), Any, TaskResult, Build the failed TaskResult returned when policy denies a dispatch. A result…, Evaluate a runtime dispatch against policy; audit it either way. Returns…, Full record of a routing decision — audit-trail entry. (+47 more)

### Community 95 - "CEODispatcher"
Cohesion: 0.06
Nodes (44): CEODispatcher, CEOResult, _complexity_rank(), _decompose_into_subtasks(), _offload(), Any, Semaphore, services/ceo_dispatcher.py — Real CEO delegation layer. The CEO splits a… (+36 more)
...
Cohesion: 0.04
Nodes (33): _env_github_token(), _norm_title(), PortfolioIntelligence, Path, Assembles a PortfolioManager from live signals with WSJF scoring., Sweep all signals and return a populated, de-duplicated PortfolioManager., PortfolioManager, Manages a portfolio of initiatives with WSJF prioritisation and roadmapping. (+25 more)

### Community 100 - "LLMRouter"
Cohesion: 0.06
Nodes (33): Attempt, Read the environment variables named in ``env_names`` into a key list. Order is…, resolve_keys(), LLMRouter, run(), Any, AsyncClient, BaseException (+25 more)
...
Cohesion: 0.05
Nodes (55): AuditEvent, One governed action, fully described. Field order follows the…, One-line JSON, suitable for a SIEM shipper tailing the log., Replace the process-wide gate. Tests only., reset_gate(), _client(), parametrize, TestClient (+47 more)
...
Cohesion: 0.06
Nodes (38): Roadmap placement for an initiative (Now/Next/Later planning)., RoadmapHorizon, build_seo_roadmap(), delegation_plan_to_initiatives(), delegation_task_to_initiative(), plan_seo_sprint(), SEO-to-Portfolio Bridge — Convert SEO audit findings into portfolio…, Result of laying SEO initiatives onto a Now/Next/Later roadmap. (+30 more)
...
Cohesion: 0.06
Nodes (37): get_trend_watcher(), agent/trend_watcher.py — Internet-connected AI trend intelligence. Fetches from…, set_trend_watcher(), _FakeClient, _FakeResp, asyncio, Tests for agent/trend_watcher.py, Ensure expanded keyword set covers key new categories. (+29 more)
...
Cohesion: 0.05
Nodes (45): autonomy_status(), Public autonomy readiness probe — no authentication required. A live deploy…, Fire-and-forget self-bootstrap; never blocks or crashes startup., _schedule_self_bootstrap(), get_onboarding_service(), Get the singleton Onboarding service instance. Returns: The singleton…, _count_specialists(), _create_company_directly() (+37 more)
...
Cohesion: 0.06
Nodes (47): Any, Path, run_command(), _safe_allowlist(), validate_command(), _admin_out(), AdminCommandBody, _anthropic_chat_payload() (+39 more)
...
### Community 135 - "test_schedule_growth_invariants.py"
Cohesion: 0.04
...
### Community 136 - "probe_model_liveness"
Cohesion: 0.05
...
### Community 157 - "RepowiseIntelligence"
Cohesion: 0.07
...
### Community 170 - "BrainFailoverExhausted"
Cohesion: 0.06
...
### Community 172 - "call_llm"
Cohesion: 0.05
Nodes (48): _agent_provider_failure_response(), _agent_timeout_fallback_response(), _append_agent_session_message(), _build_auto_skill_guidance(), _build_direct_chat_schedule_suggestion(), _build_direct_chat_tags(), _build_direct_chat_task_suggestion(), _build_provider_router() (+40 more)
...
### Community 177 - "_resolve_brain_provider"
Cohesion: 0.06
...
### Community 183 - "resolve_provider_for"
Cohesion: 0.06
...
Cohesion: 0.08
Nodes (31): Backward-compatibility shim — use scripts/generate_api_key.py instead. This…, _check_rate_limit(), default_keys_path(), issue_new_api_key(), KeyRecord, KeyStore, load_key_store(), Exception (+23 more)
...
Cohesion: 0.06
Nodes (21): _normalized_provider_type(), _ollama_reasoning_effort(), Any, Parse a 429/503 ``Retry-After`` header → seconds, or None. Accepts either…, Translate an OpenAI chat/completions payload to Bedrock Converse format., Translate a Bedrock Converse API response to OpenAI chat.completion format., Return the configured ``OLLAMA_REASONING_EFFORT`` (``high``/``medium``/…, Return *payload* with ``reasoning_effort`` added for Ollama thinking models.… (+13 more)
...
### Community 200 - "TestRuntimeControl"
Cohesion: 0.04
...
Cohesion: 0.09
Nodes (44): Any, Translate technical preflight issues into a conversational assistant reply., translate_error_to_conversational(), DirectChatState, str, AgentEventModel, AgentJobModel, AgentStatusResponse (+36 more)
...
Cohesion: 0.05
Nodes (43): invalidate_brain_config_cache(), Clear the singleton's cache (used by tests + brain_policy invalidation)., Convenience: resolve all four role models for a component. Returns a dict with…, resolve_component_role_models(), invalidate() clears the cache so the next get re-reads from storage., test_invalidate_forces_reread(), tests/test_unit6_resolve_component_model.py — UNIT 6 regression tests. Verifies…, When the DB cache is fresh AND provider matches the active primary, the DB-… (+35 more)
...
### Community 214 - "scrub"
Cohesion: 0.07
Nodes (28): _luhn_ok(), packages/governance/audit.py — the evidence trail for every governed action.…, True when ``digits`` (bare, no separators) satisfies the Luhn checksum., Redact SSNs and Luhn-valid payment-card numbers from a string. Runs after the…, Recursively strip secrets from an arbitrary argument structure. Fails…, Redact secret-shaped substrings, then truncate., _redact_pii(), _card() (+20 more)
...
### Community 221 - "FeatureMaturity"
Cohesion: 0.08
Nodes (32): check_feature(), get_feature(), list_features(), Any, get, post, features/api.py — Admin API for the feature support matrix. Exposes: GET…, Return the full support matrix with summary. (+24 more)
...
Cohesion: 0.08
Nodes (20): _make_engine(), Create a WorkflowEngine with isolated storage., TestAbortOnFailure, _test(), _tracking_run_single(), TestPhaseSequence, WorkflowRun, TestWorkflowRun (+12 more)
...
### Community 231 - "_ts_to_float"
Cohesion: 0.07
Nodes (32): Any, Fail loud in production if no persistent storage is configured. Telegram…, List tasks for a specific user with optional filters. ``include_system``…, Admin-only: list all tasks across all users. ``include_log`` mirrors…, Return BLOCKED tasks that are candidates for auto-retry., Return a shallow copy of ``doc`` without the heavy list fields. The Mongo path…, Return tasks due within the next N hours (any user)., Return tasks parked at the pre-execution approval gate (any user). A task is… (+24 more)
...
### Community 264 - "TestAuthAndTaskOwnership"
Cohesion: 0.06
...
### Community 306 - "test_unit7_catalog_propagation.py"
Cohesion: 0.06
...
### Community 333 - "traffic_director.py"
Cohesion: 0.09
Nodes (22): provider_max_parallel(), provider_max_tpm(), Return the operator-configured tokens/min cap for *provider*. Reads…, Return the operator-configured in-flight request cap for *provider*. Reads…, Return the configured traffic-distribution strategy (lower-cased). Reads…, routing_strategy(), active_strategy(), _ProviderUsage (+14 more)
...
### Community 347 - "test_ceo_router.py"
Cohesion: 0.13
...
### Community 354 - "_register_builtin_tools"
Cohesion: 0.08
Nodes (17): browse_page(), Open *url* in a real browser, return its rendered text, and close. Fail-soft:…, Register the built-in agent tools that are always available., Register the interactive-browser capability (agent/browser.py). Unlike…, Register the Web Reach capability (agent/web_reach.py): zero-key internet…, _register_browser_tools(), _browse_page_tool(), _register_builtin_tools() (+9 more)
...
### Community 373 - "test_colibri_provider.py"
Cohesion: 0.13
Nodes (26): colibri_enabled(), colibri_provider_config(), colibri_status(), ProviderConfig, providers/colibri.py — Free local GLM-5.2 brain served by JustVugg/colibri.…, Return True iff the operator opted in via ``COLIBRI_ENABLED=true``., Cheap status snapshot for tests + admin UI., Return the ``ProviderConfig`` for the local colibri server, or ``None`` when… (+18 more)
...
Cohesion: 0.10
Nodes (16): _embedded(), _embedded_run(), _fb_plan(), _fb_run(), _freebuff_max_steps(), Generate a read-only plan (embedded or via proxy). Shape: {model, plan}., Execute a FreeBuff task (embedded or via proxy). Shape: {result: {...}}., Run FreeBuffAgent in-process against a fresh clone, committing + opening a PR.… (+8 more)
...
### Community 415 - "test_backend_runtime_bootstrap.py"
Cohesion: 0.09
...
### Community 424 - "build_platform_controls_router"
Cohesion: 0.15
...
### Community 428 - "test_feature_matrix.py"
Cohesion: 0.10
Nodes (7): FeatureUnavailableError, Exception, Raised when code attempts to use a feature that is disabled or unavailable., tests/test_feature_matrix.py — Feature maturity / support matrix tests. Covers:…, TestEnforcement, TestSingleton, TestWorkspaceSecurityRegressions
...
### Community 432 - "test_phase4_runtime_resilience.py"
Cohesion: 0.13
...
### Community 433 - "schedules/api.py"
Cohesion: 0.13
...
### Community 439 - "PreflightReport"
Cohesion: 0.15
Nodes (17): DirectChatDoctor, PreflightIssue, PreflightReport, BaseModel, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, asyncio, When git is missing and no GitHub token is present, the doctor should report…, test_missing_git_and_token() (+9 more)

### Community 440 - "refine"
Cohesion: 0.17
...
### Community 461 - "get_tool_registry"
Cohesion: 0.11
...
### Community 473 - "get_ceo_dispatcher"
Cohesion: 0.11
...
### Community 531 - "control_overrides.py"
Cohesion: 0.14
...
### Community 550 - "verify_pr_exists"
Cohesion: 0.19
...
### Community 551 - "agile_sprints.py"
Cohesion: 0.14
...
### Community 557 - "test_minimax_bug_fixes.py"
Cohesion: 0.13
...
### Community 567 - "test_agent_tools.py"
Cohesion: 0.19
...
### Community 574 - "test_task_pre_execution_gate.py"
Cohesion: 0.24
...
### Community 575 - "test_workflow_orchestrator_scoping.py"
Cohesion: 0.18
...
### Community 599 - "test_portfolio_intelligence.py"
Cohesion: 0.14
...
### Community 601 - "test_task_service_failed_comment.py"
Cohesion: 0.18
...
### Community 637 - "test_tasks_reconciler_todo_requeue.py"
Cohesion: 0.20
...
### Community 704 - "CheckRun"
Cohesion: 0.23
Nodes (7): tests/test_workflow_models.py — Unit tests for workflow/models.py., TestApprovalGate, TestCheckRun, ApprovalGate, CheckRun, Hard approval gate between plan and execution. The workflow engine sets…, Structured, execution-based verification result. Verifier agents produce ONLY…
...
### Community 748 - "test_task_brain_preflight.py"
Cohesion: 0.31
...
### Community 749 - "test_telegram_task_callback.py"
Cohesion: 0.23
...
### Community 782 - "flesch_reading_ease"
Cohesion: 0.20
...
### Community 783 - "._run_phase_with_timeout"
Cohesion: 0.17
Nodes (8): Phase, Enum, Exception, The 11 canonical phases of the Agency Core golden path., Run a phase with timeout, retries, and provider provenance tracking (#522).…, True when this error class is worth retrying (transient)., Singleton lifecycle and phase registration., TestWorkflowOrchestratorSingleton
...
### Community 791 - "TestAnthropicWorkspaceIdCapture"
Cohesion: 0.33
...
### Community 798 - "schemas.py"
Cohesion: 0.29
Nodes (10): AcceptedJob, AgentJobEnvelope, CompletedJob, FailedJob, BaseModel, Enum, schemas.py — Shared Pydantic schemas for agent requests and responses., RunningJob (+2 more)

### Community 799 - "ai_insights.py"
Cohesion: 0.20
...
### Community 831 - "test_agent_readiness_audit.py"
Cohesion: 0.18
...
### Community 862 - "local_brain_provider_config"
Cohesion: 0.29
...
### Community 867 - "TestAgentRunnerPublicPlanMethod"
Cohesion: 0.20
...
### Community 929 - "_start_in_web_bot_tasks"
Cohesion: 0.29
...
### Community 1006 - "test_workspace_tools.py"
Cohesion: 0.29
...
### Community 1013 - "_load_local_metrics_since"
Cohesion: 0.43
...
### Community 1057 - "agent/output_filter.py"
Cohesion: 0.33
...
### Community 1094 - "TestAgentRunnerExecution"
Cohesion: 0.33
...
### Community 1095 - "TestDirectChatAgentExecution"
Cohesion: 0.33
...
### Community 1097 - "TestCEOAgencySystem"
Cohesion: 0.33
...
### Community 1131 - "check_rate_limit"
Cohesion: 0.60
...
### Community 1145 - "TestFailoverRegistryBaseUrls"
Cohesion: 0.40
...
### Community 1148 - "TestDirectChatNonBlocking"
Cohesion: 0.40
...
### Community 1166 - "portfolio_refresh.py"
Cohesion: 0.67
...
- **3527 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3522 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 14269 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **131 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `_fixture()` connect `_fixture` to `TaskSpec`, `llm/router.py`, `test_llm_router_queue_cache.py`, `company_api.py`, `test_llm_router_strategies.py`, `cost_tracker.py`, `test_operational_incidents.py`, `TaskStatus`, `AgentRunner`, `SelfHealingAgent`, `AgentDefinition`, `PolicyEngine`, `client`, `BackgroundAgent`, `tasks/service.py`, `Agency`, `TestFeaturesAPI`, `ImprovementLoop`, `test_autonomy_status.py`, `test_brain_patch_service_token.py`, `E2BSandboxSession`, `resolve_active_brain`, `routed`, `build_governance_router`, `ai/router.py`, `services/background.py`, `config.py`, `router_factory`, `get_task_store`, `test_llm_router_resilience.py`, `Task`, `Specialist`, `test_failover_client_shared.py`, `services/seo_audit.py`, `WorkflowRun`, `PrimeAgentAdapter`, `UserRole`, `test_company_api.py`, `test_monitor_lib.py`, `test_phase5_doctor.py`, `test_task_pre_execution_gate.py`, `reset_kv_state`, `test_agent_tool_governance.py`, `test_catalogue_probe.py`, `TokenBudget`, `test_provider_router.py`, `test_startup_warmup.py`, `e2e/test_browser.py`, `test_sam_voice.py`, `AgentSwarm`, `ResearchTask`, `test_openclaw_endpoints.py`, `TestClient`, `test_task_service_failed_comment.py`, `test_procedural_memory.py`, `claim`, `test_knowledge_sync.py`, `run_task`, `SeoFixer`, `test_telegram_auto_approve.py`, `test_brain_failover_413.py`, `test_trend_watcher.py`, `test_local_brain_state.py`, `test_sam_livekit.py`, `model_router.py`, `TestChatHistoryStore`, `controls_app`, `test_refresh_agent_built_proof.py`, `test_tasks_reconciler_todo_requeue.py`, `parse_event_stream`, `persist_plan_spec`, `test_context_rulebook.py`, `TaskPriority`, `test_new_features_e2e.py`, `ArtifactStore`, `test_llm_router_e2e.py`, `test_unit8_model_catalog.py`, `test_trend_scoping.py`, `TestHarnessAdapter`, `test_kimi_bridge_server.py`, `ChatHistoryStore`, `_step`, `test_webui_provider_priority.py`, `CEOLedger`, `_resolve_brain_provider`, `test_e2b_data_flow.py`, `MCPClient`, `test_changelog_check_workflow.py`, `KeyStore`, `_Response`, `test_process_quick_note_workflow.py`, `test_daily_2026_07_27.py`, `test_openclaw_gateway.py`, `SchedulerStore`, `OllamaCircuitBreaker`, `_job_text`, `TestRuntimeControl`, `test_video_transcript.py`, `test_portfolio_intake.py`, `test_llm_router_disabled.py`, `test_features_api.py`, `TrendWatcher`, `_Budget`, `nvidia_models.py`, `WorkflowBuildRequest`, `OrchestratorQueue`, `test_task_brain_preflight.py`, `test_telegram_task_callback.py`, `test_agent_free_brain.py`, `test_purge_backlog.py`, `TestEstimateTokensForMessages`, `TestClient`, `test_telegram_webhook.py`, `test_control_plane_api.py`, `test_telegram_approval_gate.py`, `TestAuthAndTaskOwnership`, `ContextPruner`, `tests/conftest.py`, `TestNormalizeResponseFormat`, `api_keys_for`, `test_agile_api.py`, `test_app_settings.py`, `test_brain_failover.py`, `_resolve_user_github_token`, `test_task_clarification.py`, `test_persistent_memory.py`, `SecurityScanner`, `test_nvidia_model_discovery.py`, `OutputFilter`, `model_discovery.py`, `test_rate_limiter.py`, `test_provider_enable_disable.py`, `TestCountTokensEndpoint`, `traffic_director.py`, `test_platform_controls.py`, `analyze_page`, `session_retro.py`, `test_agency_fix.py`, `test_skill_registry_boot_refresh.py`, `test_scheduler_hydration_bounded.py`, `test_ceo_router.py`, `OrchestratorCheckpointStore`, `NotificationDispatcher`, `_redact_for_notification`, `_start_ceo_agency`, `TestMongoGate`, `_Recorder`, `isolated_telegram_config`, `._check_permissions`, `test_regression.py`, `test_agent_scripts_share_one_model_list.py`, `test_crispy_burn_in.py`, `_Recorder`, `ai/watchdog.py`, `_undeclared`, `test_service_token.py`, `test_telegram_diag_endpoint.py`, `test_harness_spec.py`, `test_v4_api.py`, `get_ceo_dispatcher`, `test_direct_chat_evolution.py`, `TestTheWorkflowIsSafeAndReadOnly`, `test_doctor_coding_brain.py`, `test_ping.py`, `test_runtimes_health_endpoint.py`, `test_provider_state_durability.py`, `test_voice_pipeline.py`, `test_task_store_fails_loud_in_production.py`, `captured`, `UsageEvent`, `SQLiteStore`?**
  _High betweenness centrality (0.108) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `proxy.py`, `TaskSpec`, `test_agent_chat_integration.py`, `AdaptiveHalter`, `ContextPruner`, `test_ceo_dispatcher.py`, `test_governance_sandbox.py`, `UserMemoryStore`, `PolicyEngine`, `GitHubTools`, `BackgroundAgent`, `MultiAgentSwarm`, `E2BAdapter`, `Agency`, `loop.py`, `E2BSandboxSession`, `ReactScratchpad`, `AgentPlan`, `BrainFailoverExhausted`, `test_failover_client_shared.py`, `call_llm`, `WorkflowRun`, `test_agent_runner.py`, `MCPClient`, `ContextManager`, `test_daily_automation_2026_07_11.py`, `test_empirical_verify.py`, `TestAgentRunnerExecution`, `test_agent_tool_governance.py`, `StuckDetector`, `TokenBudget`, `WorkspaceTools`, `direct_chat.py`, `LocalWorkspace`, `enforcement.py`, `get_ceo_dispatcher`, `CEODispatcher`, `PortfolioManager`, `TestAgentRunnerPublicPlanMethod`, `test_governance_api.py`, `InternalAgentAdapter`, `test_brain_failover_413.py`, `test_agent_free_brain.py`, `TestAgentLoopMCPIntegration`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderRouter` to `backend/server.py`, `system_instruction`, `TrafficDirector`, `TestOpenAiToBedrockConverse`, `get_director`, `test_implement_agent_routing.py`, `failover_client.py`, `resolve_active_brain`, `ai/router.py`, `test_all_providers_discovery.py`, `call_llm`, `implement_agent.py`, `test_chat_mode_regressions.py`, `test_bedrock_live.py`, `_Response`, `settings.py`, `direct_chat.py`, `test_provider_router.py`, `kimi_bridge_provider_config`, `NvidiaProvider`, `TestLegacyRouterCacheTTL`, `test_anthropic_refusal_fallback.py`, `_payload`, `TestAnthropicPayloadStructuredOutput`, `test_colibri_provider.py`, `TestLegacyRouterServerFallback`, `ProviderConfig`?**
