# Graph Report - local-llm-server  (2026-08-20)

## Corpus Check
- 1439 files · ~2,069,118 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 28615 nodes · 53467 edges · 1222 communities (1107 shown, 115 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 2624 edges (avg confidence: 0.91)
...
## Communities (1222 total, 115 thin omitted)

### Community 0 - "backend/server.py"
Cohesion: 0.01
Nodes (323): get_sam(), agent/sam.py — SAM Voice Agent (System Autonomy Manager) SAM is the voice-…, _build_payload_or_500(), Returns a DigestPayload (or raises HTTPException(503/500))., _get_current_user_thunk(), _get_optional_user_thunk(), Request, admin_seed() (+315 more)

### Community 1 - "brain_config.py"
Cohesion: 0.02
Nodes (175): _brain_provider_status(), Return per-provider metadata for the GET endpoint. Iterates every provider in…, Return the discovered model list for *provider_id*, or ``[]`` if unknown., _served_models(), emit_agency_observation(), Record an agency platform operation in Langfuse. Unlike…, BrainConfig, BrainConfigPatch (+167 more)

### Community 2 - "company_api.py"
Cohesion: 0.02
Nodes (165): auto_recommend_skills(), cancel_onboarding(), delete_company_endpoint(), _DoctorCheck, _DoctorReport, generate_onboarding_questions(), get_company(), get_company_access() (+157 more)

### Community 3 - "llm/router.py"
Cohesion: 0.03
Nodes (128): int, get_budget(), packages/llm/budget.py — token and cost accounting with spend alerts. Tracks…, The process-wide budget tracker., get_cache(), The process-wide cache manager., failover_chat_completion_via_router(), openai_body_from_response() (+120 more)

### Community 4 - "CompanyGraphStore"
Cohesion: 0.02
Nodes (121): get_onboarding_progress(), Get the current onboarding progress for a company. Returns the onboarding…, autonomy_status(), Public autonomy readiness probe — no authentication required. A live deploy…, CompanyGraphSnapshot, OnboardingProgress, A point-in-time snapshot of a Company Graph for history and rollback., Tracks the onboarding progress for a company. (+113 more)

### Community 5 - "MongoDBStore"
Cohesion: 0.02
Nodes (88): KnowledgeItem, Structured knowledge about the company, systems, or processes., MongoDBStore, Any, Company, ObjectId, Prepare a Pydantic model for SQLite storage., Prepare a SQLite row for Pydantic model. (+80 more)

### Community 6 - "proxy.py"
Cohesion: 0.03
Nodes (161): get_skill_registry_safe(), Return the global SkillRegistry if set, else None. Used by onboarding and other…, middleware, admin_control(), admin_login(), admin_logout(), admin_status(), AdminControlBody (+153 more)
...
Cohesion: 0.03
Nodes (108): AgentPhaseError, AgentRunner, Any, Exception, Path, Governance seam: judge the call, run it, audit the outcome. Deliberately a thin…, Append an event to the durable session log if a store is wired in., Summarise a long history and compact it. Asks the planner model to write a… (+100 more)

### Community 9 - "TaskWorkflowService"
Cohesion: 0.03
...
Cohesion: 0.02
Nodes (120): _diagnose_and_file(), _format_incident(), gather_render_evidence(), _iso_from_monotonic(), normalise(), note_phase_end(), note_phase_start(), _now() (+112 more)

### Community 11 - "resolve_identity"
Cohesion: 0.03
Nodes (104): _egress_policy_reason(), agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Return why governance policy blocks *host*, or None. Runs strictly *after* the…, _load(), Import the governance layer once, recording why if it is absent., governance_enabled(), True when the governance layer should run at all. A single global off switch…, AgentIdentity (+96 more)

### Community 12 - "TaskSpec"
Cohesion: 0.04
Nodes (77): agent/job_manager.py — Async agent job lifecycle manager. Manages agent jobs…, kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, TaskResult, TaskSpec, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Run aider non-interactively via `--message` flag., runtimes/adapters/claude_code.py — Claude Code CLI adapter (FIRST CLASS).… (+69 more)
...
Cohesion: 0.04
Nodes (101): count, HealthConfig, Strategy selection and degradation behaviour., Circuit breaker + health tracking thresholds., RoutingConfig, HealthTracker, _Outcome, packages/llm/health.py — provider health tracking and circuit breaking. Two… (+93 more)

### Community 15 - "_fixture"
Cohesion: 0.02
Nodes (101): app_client(), _clear_discovered_models(), _clear_response_cache(), client(), _isolate_brain_data_layer(), _isolate_operator_provider_state(), non_admin_client(), MonkeyPatch (+93 more)

### Community 16 - "test_governance_sandbox.py"
Cohesion: 0.03
Nodes (83): events_from_identity(), Any, Convenience: build and record an event in one call., Extract the identity-derived audit fields from an AgentIdentity. Kept here…, record_event(), build_docker_run_argv(), detect_backend(), DockerBackend (+75 more)

### Community 17 - "TaskStore"
Cohesion: 0.03
Nodes (92): Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., tasks — Task/issue management system. Provides a lightweight task/issue tracker…, Enum, str, tasks/models.py — Pydantic models for the task/issue system., Comment or reply on a task., TaskComment (+84 more)

### Community 18 - "ImprovementLoop"
Cohesion: 0.04
Nodes (85): DetectedIssue, ImprovementLoop, ImprovementLoopState, IssueCategory, IssueSeverity, _now(), Any, Enum (+77 more)

### Community 19 - "E2BSandboxSession"
Cohesion: 0.04
Nodes (75): MCPUnavailableError, agent/mcp_client.py — Async MCP client for the mcp-server Docker container.…, Raised when the MCP server is unreachable or the circuit is open., TaskResult, TaskSpec, Execute a task inside a fresh E2B sandbox. Flow: 1. Open an…, Run ``pytest`` inside the sandbox. Returns ``(output, passed)``.…, E2BSandboxSession (+67 more)
...
### Community 21 - "V5App.jsx"
Cohesion: 0.03
Nodes (58): API, changeUserRole(), createApiKey(), deleteApiKey(), fetchVelocity(), setUserOnboarding(), useSafeData(), ActivationGate() (+50 more)

### Community 22 - "LLMRequest"
Cohesion: 0.04
...
### Community 23 - "test_runtimes.py"
Cohesion: 0.04
Nodes (45): Raised when a runtime fails readiness validation before execution starts., RuntimePreflightError, runtimes/health.py — RuntimeHealthService. Periodically polls all registered…, _build_default_manager(), Any, RoutingDecision, TaskResult, TaskSpec (+37 more)
...
### Community 26 - "get_user_role"
Cohesion: 0.04
Nodes (55): compute_savings(), compute_time_series(), get_savings(), get_usage(), get_user_savings(), _period_start(), Any, BaseModel (+47 more)

### Community 27 - "Agency"
Cohesion: 0.04
Nodes (68): Agency, AgencyCycleResult, AgentDirective, AgentRole, _build_ceo_prompt(), _build_quick_note_instruction(), _close_github_issue(), _collect_recent_git_context() (+60 more)
...
### Community 29 - "test_llm_router_resilience.py"
Cohesion: 0.03
...
Cohesion: 0.05
Nodes (34): One deploy, normalised from whatever shape the tool returned., RenderDeploy, Polls Render for platform-level failures and files them as issues., Snapshot for ``/api/render/ops/status`` and the dashboard. ``self_heal_ready``…, True when a filed finding will actually be scheduled as a fix. Detection and…, RenderOpsMonitor, _self_heal_ready(), _client() (+26 more)

### Community 33 - "AgentSwarm"
Cohesion: 0.05
Nodes (54): AgentRole, AgentSwarm, agents/swarm.py — AgentSwarm: routes workflow phases to the correct agent. The…, Return the agent role responsible for *phase*., Return the AgentProfile for the agent driving *phase*., Run a pre-gate or report phase through the correct agent. Enforces permission…, Execute a slice via the Coder agent (write-permitted)., Review a slice via the Reviewer agent (different model from Coder). This is the… (+46 more)

### Community 34 - "Task"
Cohesion: 0.05
Nodes (60): Full task/issue document., Task, Best-effort Telegram heads-up that a task is parked awaiting approval. Inline…, Tests for task follow-up / rerun with conversation carry-over. Before this,…, The runtime reads context['conversation']; prior comments must be carried as…, test_build_spec_exposes_conversation_for_runtime(), test_follow_up_empty_message_rejected(), test_follow_up_requeues_done_task() (+52 more)

### Community 35 - "PrimeAgentAdapter"
Cohesion: 0.04
...
### Community 36 - "test_model_router.py"
Cohesion: 0.05
...
### Community 37 - "get_runtime_manager"
Cohesion: 0.04
...
Cohesion: 0.03
Nodes (43): BusinessCategory, Find a repository by its URL., A company repository with detected technologies and metadata., Extract the owner from the full name., Extract the repository name from the full name., Repo, CompanyGraphService, Company (+35 more)

### Community 39 - "ExecutionRequest"
Cohesion: 0.04
Nodes (46): ExecutionRequest, Exception, Approve a run paused at the ApprovalGate. The caller must re-invoke…, Inject additional instructions into an in-flight run (no state change). Backs…, Determine domain and task type from the request text., Generate a structured execution plan. Uses the LLM if available; falls back to…, Select the best specialist(s) for the classified domain., Run doctor checks before execution. (+38 more)

### Community 40 - "SeoAuditEngine"
Cohesion: 0.05
Nodes (45): BaseModel, field_validator, A single occurrence of a check firing on a specific URL., Snapshot of one crawled page with the on-page facts the checks used., Aggregated report row - Screaming Frog CSV compatible., Site-level facts discovered during the crawl., Request to run an SEO/GEO/AIO audit against a website., SeoAuditRequest (+37 more)
...
### Community 42 - "RepowiseIntelligence"
Cohesion: 0.04
Nodes (49): Any, Path, repowise.py — RepowiseIntelligence: context packing and dependency analysis., Build symbol-level dependency graph for Python files., Build git intelligence: hotspots, ownership, co-change pairs., Run a git command and return stdout as string., Compute cyclomatic complexity for Python files. Returns 0 for non-Python files…, Extract docstrings and store as documentation. (+41 more)

### Community 43 - "setup/api.py"
Cohesion: 0.06
...
### Community 45 - "agent/workspace.py"
Cohesion: 0.05
...
### Community 46 - "ProviderConfig"
Cohesion: 0.05
Nodes (69): extract_openai_text(), is_commercial_provider(), _normalize_nvidia_base_url(), _openai_url(), provider_access_tier(), _provider_field(), provider_sort_key(), ProviderConfig (+61 more)
...
### Community 48 - "test_governance_enforcement.py"
Cohesion: 0.05
Nodes (65): AuditEvent, packages/governance/audit.py — the evidence trail for every governed action.…, Redact secret-shaped substrings, then truncate., One governed action, fully described. Field order follows the…, One-line JSON, suitable for a SIEM shipper tailing the log., Recursively strip secrets from an arbitrary argument structure. Fails…, scrub(), _scrub_inner() (+57 more)

### Community 49 - "test_llm_router_gateway.py"
Cohesion: 0.04
Nodes (41): get_tracker(), The process-wide health tracker., _Counter, _escape(), _Gauge, get_metrics(), _Histogram, _labels() (+33 more)

### Community 50 - "test_ceo_supervision.py"
Cohesion: 0.06
...
### Community 51 - "WorkspaceTools"
Cohesion: 0.05
Nodes (49): Register the built-in agent tools that are always available., _register_builtin_tools(), Path, Precise string replacement — F1 roadmap item (Codebuff/Claude Code-style edit).…, Return a previously saved memory value, or an empty string if absent., Persist a key/value pair to the user's profile store., Return the first *lines* lines of a file. Just-in-time retrieval: the executor…, Return a lightweight index of files with line counts and sizes. This is the… (+41 more)

### Community 52 - "services/background.py"
Cohesion: 0.05
Nodes (64): get_improvement_loop(), get_trend_watcher(), agent/trend_watcher.py — Internet-connected AI trend intelligence. Fetches from…, set_trend_watcher(), _await_hermes_ready(), BackgroundServices, _env_float(), _env_on() (+56 more)

### Community 53 - "ChatPage.js"
Cohesion: 0.04
...
### Community 56 - "test_mcp_registry.py"
Cohesion: 0.05
Nodes (47): get_mcp_client(), Return the module-level MCPClient. Reads MCP_SERVER_BASE_URL at call time (not…, _internal_configured(), list_specs(), MCPServerSpec, _not_dialable(), _playwright_configured(), _probe_http() (+39 more)

### Community 57 - "ArtifactStore"
Cohesion: 0.05
...
### Community 60 - "DashboardLayout.js"
Cohesion: 0.05
...
### Community 62 - "test_webui_provider_priority.py"
Cohesion: 0.08
...
### Community 63 - "_StubProvider"
Cohesion: 0.06
Nodes (41): _disable_unless_key_serves_other_models(), _looks_unknown_model(), _models_to_try(), True when the provider rejected the model id itself, not the request. Some…, Order the models to attempt on *provider*, correcting a stale catalogue. Cache-…, Auto-disable *provider*, unless its key demonstrably serves other models. "No…, attempted(), Remember which of *provider_id*'s models a failed round already sent. The… (+33 more)

### Community 64 - "TokenBudget"
Cohesion: 0.05
...
Cohesion: 0.05
Nodes (35): CerebrasProvider, Provider, Cerebras provider adapter — free, fast LLM (qwen-3-coder-480b)., Groq provider adapter — free, fast LLM (deepseek-r1-distill-llama-70b)., NvidiaProvider, Provider, NVIDIA NIM provider adapter — wraps the existing provider_router logic. This is…, NVIDIA NIM — free LLM provider (meta/llama-3.3-70b-instruct). (+27 more)

### Community 66 - "WebsiteScanner"
Cohesion: 0.05
Nodes (52): main(), Returns (url, ok, summary)., _scan_one(), _is_safe_url(), _looks_like_bot_challenge(), BeautifulSoup, True if the HTML is an anti-bot/CAPTCHA interstitial rather than content. Used…, Advanced Scanner for detecting technology stack and systems from websites.… (+44 more)

### Community 67 - "start_background_services"
Cohesion: 0.04
Nodes (55): _as_bool(), _as_int(), ephemeral_ttl_hours(), ephemeral_ttl_hours_cached(), get_setting(), _maybe_schedule_refresh(), onboarding_gate_enabled(), onboarding_gate_enabled_cached() (+47 more)

### Community 68 - "ai/router.py"
Cohesion: 0.05
Nodes (45): _acquire_provider_probe(), _dead_model_key(), _mark_model_dead(), _notify_watchdog(), _ollama_reasoning_effort(), provider_router.py — auto-generated module docstring (user-research skill scan)., Notify the brain watchdog of a provider call outcome (fire-and-forget).…, # NOTE: 429 and 410 are handled specially in _try_one_provider (immediate (+37 more)

### Community 69 - "test_agent_tool_governance.py"
Cohesion: 0.05
...
Cohesion: 0.04
Nodes (56): _normalize_dockerfile(), parametrize, tests/test_sam_livekit.py — SAM realtime voice (LiveKit) integration. Covers: -…, Empty key/secret/identity/room must raise ValueError., SAM_LLM_* env vars must override the NVIDIA defaults (Hermes/proxy routing)., Under TESTING the in-process worker must never be eligible to start., OPT-IN: defaulting to on OOM-killed the 512MB Render instance at boot…, start_in_process must be a safe no-op in the test environment (conftest sets… (+48 more)

### Community 71 - "BackgroundAgent"
Cohesion: 0.06
...
Cohesion: 0.05
Nodes (30): get_tool_registry(), Any, Path, Register a tool definition., Decorator to register a function as an agent tool. Usage::…, Remove a tool from the registry. Returns True if removed., Look up a tool by name., Return all registered tools. (+22 more)

### Community 76 - "AgentJobManager"
Cohesion: 0.05
...
Cohesion: 0.06
Nodes (37): analyze_qualitative(), _classify_sentiment(), _extract_keywords(), plan_research(), Any, BaseModel, field_validator, QualAnalysis (+29 more)
...
### Community 83 - "test_runtime_governance.py"
Cohesion: 0.07
Nodes (54): _audit_dispatch(), _blocked_result(), _governance_check(), _governance_identity(), Any, TaskResult, TaskSpec, Evaluate a runtime dispatch against policy; audit it either way. Returns… (+46 more)

### Community 84 - "test_procedural_memory.py"
Cohesion: 0.05
...
### Community 85 - "TasksPage.js"
Cohesion: 0.05
Nodes (49): addTaskComment(), approveTaskCheckpoint(), approveTaskExecution(), clarifyTask(), createQuickNote(), createSprint(), createTask(), escalateTask() (+41 more)
...
### Community 88 - "ControlPlanePage.js"
Cohesion: 0.06
Nodes (41): getActivity(), getCostAttribution(), getDecisionLog(), getDueSoonTasks(), getSavings(), getStats(), getTaskCounts(), getUsage() (+33 more)

### Community 89 - "model_router.py"
Cohesion: 0.06
Nodes (36): get_local_model(), Return the local Ollama model name for a given Anthropic model name. ..…, Dynamic model router package. Public API:: from router import get_router,…, _build_builtin_model_map(), _default_model(), get_router(), ModelRouter, _nvidia_key_present() (+28 more)

### Community 90 - "tasks/api.py"
Cohesion: 0.11
...
### Community 91 - "TestAdapterMetadata"
Cohesion: 0.05
Nodes (27): Resolve the base URL of the agency's own Hermes server. Precedence:…, resolve_hermes_base_url(), GooseAdapter, Any, Adapter for Goose — TIER 2 general-purpose local runtime., HermesAdapter, Any, AsyncClient (+19 more)
...
### Community 95 - "get_task_store"
Cohesion: 0.06
Nodes (58): Reset the singleton (for tests)., reset_failover_manager(), _blocked_retire_age_sec(), _heal_blocked_backlog(), _heal_brain_failover(), _heal_purge_backlog(), _heal_stuck_tasks(), _heal_task_duplicates() (+50 more)
...
### Community 98 - "get_self_healing_agent"
Cohesion: 0.06
Nodes (49): _dispatch_async(), _ErrorCaptureHandler, get_log_monitor(), LogMonitor, _note_recurrence(), Any, LogRecord, agent/log_monitor.py — Application Log Monitor Captures ERROR/CRITICAL log… (+41 more)
...
### Community 100 - "anthropic_compat.py"
Cohesion: 0.06
...
### Community 103 - "probe_model_liveness"
Cohesion: 0.05
...
### Community 105 - "test_sqlite_store.py"
Cohesion: 0.06
...
### Community 106 - "AgentPlan"
Cohesion: 0.06
Nodes (47): PreflightReport, Agent subsystem — planner / executor / verifier loop., AgentEvent, AgentPlan, AgentRunRequest, AgentSession, AgentSessionCreateRequest, AgentSessionMessage (+39 more)

### Community 107 - "test_governance_api.py"
Cohesion: 0.06
Nodes (54): build_governance_router(), Any, APIRouter, backend/governance_router.py — read and operate the governance layer. Mounted…, Reject non-admin callers. Mirrors the RBAC check used elsewhere in this backend…, _require_admin(), get_approval_store(), Replace the process-wide gate. Tests only. (+46 more)

### Community 108 - "get_workflow_orchestrator"
Cohesion: 0.06
Nodes (32): Called by APScheduler when a cron fires. Dispatches to the orchestrator. This…, _scheduler_on_fire(), get_workflow_orchestrator(), Return the shared WorkflowOrchestrator singleton., Reset the singleton (test helper)., reset_orchestrator(), The old sync callback called the deprecated ``asyncio.get_event_loop()`` from…, test_scheduler_on_fire_is_a_coroutine() (+24 more)
...
### Community 111 - "enforcement.py"
Cohesion: 0.05
Nodes (42): BudgetExceeded, classify(), evaluate_call(), get_gate(), guard_tool_call(), GuardResult, _host_of(), _is_write_tool() (+34 more)
...
### Community 114 - "TestBrainFailoverModelUpdates"
Cohesion: 0.06
...
### Community 115 - "AgentSessionStore"
Cohesion: 0.07
...
### Community 120 - "WebReach"
Cohesion: 0.08
Nodes (43): Register the Web Reach capability (agent/web_reach.py): zero-key internet…, _register_web_reach_tools(), get_web_reach(), _load_script_module(), Any, ModuleType, Response, Dynamically load a pure-stdlib helper module from .github/scripts/. Returns… (+35 more)

### Community 121 - "seo_api.py"
Cohesion: 0.07
Nodes (45): export_seo_audit(), get_seo_audit(), list_seo_audits(), BaseModel, get, SEO / GEO / AIO Audit API Router Endpoints for the world-class SEO audit engine…, Return the full SEO/GEO/AIO check catalog. Static metadata only, but gated…, List stored audits for this company (most recent first). (+37 more)

### Community 122 - "test_startup_warmup.py"
Cohesion: 0.05
...
### Community 123 - "test_failover_client_shared.py"
Cohesion: 0.11
...
### Community 129 - "test_phase4_runtime_resilience.py"
Cohesion: 0.06
...
### Community 130 - "test_issue_intake.py"
Cohesion: 0.08
...
Cohesion: 0.04
Nodes (29): _env_int(), _get_settings(), Read an int env var, falling back to *default* on a missing/bad value. Never…, When True, the governance layer evaluates and audits agent actions. This is…, Typed configuration loaded from environment variables., When True, approval-gated actions self-approve. Local dev only., ``RENDER_SERVICE_IDS`` split into a clean list (empty when unset)., True when there is both an API key and an endpoint to reach. (+21 more)

### Community 133 - "portfolio_intelligence.py"
Cohesion: 0.07
...
### Community 137 - "LLMRouter"
Cohesion: 0.07
Nodes (26): Attempt, describe(), The operator-facing reason string for an unfixable status., Read the environment variables named in ``env_names`` into a key list. Order is…, resolve_keys(), LLMRouter, Any, AsyncClient (+18 more)

### Community 138 - "diagnostics.py"
Cohesion: 0.07
...
### Community 139 - "test_p0_roadmap_b1_c2_a3.py"
Cohesion: 0.06
...
### Community 140 - "test_backend_server_features.py"
Cohesion: 0.05
Nodes (35): _append_agent_session_message(), _build_auto_skill_guidance(), _build_provider_router(), _builtin_provider_records(), _chat_provider_policy(), _fallback_local_provider_record(), _in_container(), _list_configured_provider_records() (+27 more)
...
### Community 142 - "ProvidersScreen.jsx"
Cohesion: 0.06
...
### Community 143 - "test_e2b_adapter.py"
Cohesion: 0.07
...
### Community 144 - "ContextWindowManager"
Cohesion: 0.08
...
### Community 146 - "PatternConsolidation"
Cohesion: 0.08
...
### Community 149 - "test_daily_2026_07_27.py"
Cohesion: 0.07
...
### Community 155 - "StreamingDeltaReconstructor"
Cohesion: 0.07
...
### Community 158 - "test_telegram_freebuff.py"
Cohesion: 0.07
...
### Community 160 - "HarnessRegistry"
Cohesion: 0.06
Nodes (26): get_harness_adapter(), harness_active(), harness_catalog(), Return orchestrator queue depth, active runs, and supervisor state (#522)., #522 + #505: Reliability startup — schedule hydration, orchestrator restore,…, Return the full ECC harness catalog with capabilities. Public — no auth…, Return the currently active ECC harnesses with session metrics. Authenticated —…, _startup_reliability_hooks() (+18 more)

### Community 161 - "PortfolioManager"
Cohesion: 0.06
...
### Community 163 - "PromptCacheManager"
Cohesion: 0.06
...
### Community 164 - "test_e2b_task_wiring.py"
Cohesion: 0.08
...
### Community 168 - "test_ceo_router.py"
Cohesion: 0.08
...
### Community 169 - "test_render_mcp.py"
Cohesion: 0.07
...
### Community 170 - "resolve_active_brain"
Cohesion: 0.09
Nodes (43): BrainResolution, get_active_brain_sync(), get_provider_role_tags(), _host_is_openai_compatible(), _norm(), _pick_from_records(), Any, Shared free-brain policy helpers (issue #656). Single source of truth for "is… (+35 more)

### Community 171 - "failover_client.py"
Cohesion: 0.06
Nodes (40): _auto_disable(), _describe_registry(), _disabled_ids(), FailoverResult, _is_billing_refusal(), _is_ollama(), _key_pool(), _log_exhaustion() (+32 more)

### Community 172 - "analyze_page"
Cohesion: 0.08
...
### Community 173 - "skill_bindings.py"
Cohesion: 0.07
Nodes (33): Run an audit from synchronous code, loop-safe. Used by the skill-bindings…, run_audit_sync(), _execute_skill_impl(), _get_portfolio_manager(), Any, BaseModel, Enum, str (+25 more)

### Community 174 - "facade.py"
Cohesion: 0.07
...
### Community 176 - "ProviderRouter"
Cohesion: 0.08
Nodes (26): _exponential_backoff_cooldown(), _get_director(), _normalized_provider_type(), ProviderAttempt, ProviderRouter, Any, Response, Try all models for one provider. Returns ProviderResult on success, None on… (+18 more)

### Community 177 - "ApprovalStore"
Cohesion: 0.07
...
### Community 178 - "AnthropicProvider"
Cohesion: 0.09
...
### Community 183 - "portfolio_api.py"
Cohesion: 0.08
...
### Community 184 - "Part A — CodeRabbit review fixes for this PR (do first, small)"
Cohesion: 0.05
...
### Community 185 - "Docker Agent Runtimes Setup"
Cohesion: 0.05
...
### Community 186 - "FeatureMaturity"
Cohesion: 0.08
Nodes (26): __init__.py — Feature flag/matrix package., FeatureMaturity, get_feature_matrix(), Enum, str, features/matrix.py — Feature maturity tiers and support matrix. Single source…, Feature maturity classification., Return the global FeatureMatrix singleton. (+18 more)

### Community 187 - "BrainWatchdog"
Cohesion: 0.07
...
### Community 190 - "test_bedrock_provider.py"
Cohesion: 0.08
...
### Community 194 - "Persistent Memory System"
Cohesion: 0.05
...
### Community 199 - "test_provider_state_durability.py"
Cohesion: 0.05
...
### Community 204 - "test_daily_2026_06_04.py"
Cohesion: 0.08
...
### Community 209 - "models/seo_audit.py"
Cohesion: 0.10
...
### Community 210 - "emit_chat_observation"
Cohesion: 0.10
...
### Community 212 - "InternalAgentAdapter"
Cohesion: 0.06
...
### Community 218 - "CompanyGraph"
Cohesion: 0.06
Nodes (24): detect_company_id(), DirectChatSession, handle_chat_message_with_context(), Direct chat session with Company Graph context binding., Bind a company to this chat session and load its Company Graph., Bind a repository to this chat session., Get the bound Company Graph., Get enriched context including Company Graph data. (+16 more)
...
### Community 220 - "get_registry"
Cohesion: 0.06
Nodes (27): get_registry(), Return model registry, extended with ROUTER_EXTRA_MODELS env entries.…, test_bedrock_haiku_4_5_in_registry(), test_bedrock_opus_48_in_registry(), test_bedrock_opus_4_6_v1_in_registry(), test_bedrock_opus_4_7_in_registry(), test_bedrock_sonnet_4_6_in_registry(), test_claude_haiku_45_in_registry() (+19 more)

### Community 221 - "WorkflowRun"
Cohesion: 0.10
...
### Community 223 - "test_crispy_workflow.py"
Cohesion: 0.08
...
### Community 224 - "get_failover_manager"
Cohesion: 0.07
...
### Community 225 - "test_response_cache.py"
Cohesion: 0.16
...
### Community 226 - "test_pr923_fixes.py"
Cohesion: 0.07
...
### Community 231 - "webui/router.py"
Cohesion: 0.08
Nodes (35): invalidate_brain_cache(), Clear the cached brain so the next read re-resolves. Called from…, A DB-stored BrainConfig wins over provider records + env (except…, When BrainConfig.updated_at is empty (never applied), the resolver falls…, AGENT_LLM_BASE_URL (the operator kill-switch) wins over a DB-stored config., test_env_override_still_wins_over_db_brain_config(), test_resolve_active_brain_falls_through_when_db_unset(), test_resolve_active_brain_honours_db_brain_config() (+27 more)

### Community 232 - "sync/service.py"
Cohesion: 0.11
...
### Community 233 - "test_control_plane_api.py"
Cohesion: 0.06
...
### Community 235 - "test_brain_availability_doctor.py"
Cohesion: 0.11
...
### Community 237 - "NotificationDispatcher"
Cohesion: 0.08
...
### Community 241 - "analyze_quantitative"
Cohesion: 0.10
...
### Community 242 - "test_verification_strategies.py"
Cohesion: 0.11
...
### Community 243 - "BrainFailoverExhausted"
Cohesion: 0.09
...
### Community 245 - "REWRITE_PLAN.md — Phased Migration Strategy"
Cohesion: 0.06
...
### Community 247 - "test_brain_failover.py"
Cohesion: 0.10
...
### Community 248 - "test_all_providers_discovery.py"
Cohesion: 0.16
...
### Community 249 - "test_persistent_memory.py"
Cohesion: 0.06
...
### Community 251 - "configuration-reference.md"
Cohesion: 0.08
...
### Community 252 - "OrchestratorSupervisor"
Cohesion: 0.09
Nodes (17): codeql_count(), dependabot_count(), main(), Any, _repo_parts(), _request(), OrchestratorSupervisor, Any (+9 more)

### Community 253 - "model_discovery.py"
Cohesion: 0.08
...
### Community 254 - "test_anthropic_router.py"
Cohesion: 0.09
...
### Community 256 - "test_llm_router_e2e.py"
Cohesion: 0.14
...
### Community 259 - "agent_runtime.py"
Cohesion: 0.10
...
### Community 260 - "context_rules.py"
Cohesion: 0.11
...
### Community 261 - "test_platform_controls.py"
Cohesion: 0.08
...
### Community 263 - "local_controller.py"
Cohesion: 0.12
...
### Community 264 - "test_live_server.py"
Cohesion: 0.22
...
### Community 265 - "ContextCompressor"
Cohesion: 0.11
...
### Community 267 - "loop.py"
Cohesion: 0.08
Nodes (23): _check_extra_kwargs(), _enforce_signature(), _note_phase_end(), _note_phase_start(), loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., Raise TypeError if fn's signature drifts from the locked contract (Pydantic…, Raise TypeError on unknown kwarg (runtime extra='forbid' for non-Pydantic…, # NOTE: "ollama_base" is kept for backwards compatibility; this runner only… (+15 more)

### Community 268 - "SparkProvider"
Cohesion: 0.07
...
### Community 271 - "test_colibri_brain_shim.py"
Cohesion: 0.08
...
### Community 273 - "RateLimitTracker"
Cohesion: 0.10
...
### Community 276 - "test_iteration_6_features.py"
Cohesion: 0.06
Nodes (19): Test iteration 6 features: - POST /api/tasks/ auto-assigns an available agent…, POST /api/tasks/ without agent_id should attempt auto-assignment if agents exist, Test chat fallback behavior with commercial provider approval, Get authentication token for admin user, POST /api/chat/send endpoint should exist and accept requests, Verify ChatMessage model accepts allow_commercial_fallback_once field, Return True if we can open a TCP connection to the backend server., Test agent auto-assignment in task creation (+11 more)
...
### Community 280 - "Langfuse Observability Guide"
Cohesion: 0.06
...
### Community 282 - "Specialist"
Cohesion: 0.07
Nodes (17): SpecialistFamily, Find all specialists of a specific family., A specialist agent that can be provisioned for company-specific tasks., Check if this specialist can handle a task with given capabilities., Specialist, Create a new specialist., Get a specialist by ID., List specialists with optional filtering. (+9 more)

### Community 283 - "TestDiagCommand"
Cohesion: 0.09
...
### Community 284 - "test_workspace_isolation.py"
Cohesion: 0.16
...
### Community 289 - "LlmProviderConfig"
Cohesion: 0.16
...
### Community 293 - "TaskHarnessAdapter"
Cohesion: 0.08
...
### Community 295 - "test_purge_backlog.py"
Cohesion: 0.09
...
### Community 296 - "agile_sprints.py"
Cohesion: 0.08
...
### Community 301 - "output_filter.py"
Cohesion: 0.07
...
### Community 302 - "test_colibri_provider.py"
Cohesion: 0.12
...
### Community 303 - "TestDetectedSystemPersistence"
Cohesion: 0.07
...
### Community 307 - "test_force_cleanup_conditional_delete.py"
Cohesion: 0.10
...
### Community 308 - "test_telegram_mutating_commands.py"
Cohesion: 0.07
...
### Community 311 - "ProjectScaffolder"
Cohesion: 0.13
...
### Community 313 - "_resolve_user_github_token"
Cohesion: 0.12
...
### Community 314 - "SteeringInjector"
Cohesion: 0.11
...
### Community 315 - "RuntimeHealthService"
Cohesion: 0.09
...
### Community 316 - "test_claude_setup_audit.py"
Cohesion: 0.16
...
### Community 317 - "test_internal_agent_did_work.py"
Cohesion: 0.12
...
### Community 319 - "Python Dependencies (`requirements.txt`)"
Cohesion: 0.07
...
### Community 320 - "Technical Debt Register — local-llm-server"
Cohesion: 0.07
...
### Community 321 - "chat_handlers.py"
Cohesion: 0.15
...
### Community 328 - "get_skill_bindings"
Cohesion: 0.10
...
### Community 329 - "test_crispy_burn_in.py"
Cohesion: 0.07
...
### Community 330 - "test_provider_enable_disable.py"
Cohesion: 0.09
...
### Community 331 - "test_skill_registry_boot_refresh.py"
Cohesion: 0.12
...
### Community 337 - "Claude Code + Qwen Local Setup"
Cohesion: 0.07
...
### Community 338 - "SettingsPage.js"
Cohesion: 0.15
Nodes (25): authorizeGithubRepos(), createGithubPR(), deleteGithubToken(), getGithubStatus, getGithubTree(), getPlatformInfo(), githubStatus(), healthCheck() (+17 more)

### Community 339 - "AgentsScreen.jsx"
Cohesion: 0.11
Nodes (23): createAgent(), deleteAgent(), updateAgent(), AgentCard(), AgentForm(), AgentsPage(), cls(), normalizeAgent() (+15 more)

### Community 340 - "generate_context.py"
Cohesion: 0.12
...
### Community 341 - "test_agent_free_brain.py"
Cohesion: 0.08
Nodes (19): allow_paid_brain(), is_anthropic_model(), True only when the operator explicitly opted into a paid (Anthropic) brain.…, True when *model* names a paid Anthropic/Bedrock-Claude model. Covers native…, _opus_model(), Return an Opus model ID iff the operator explicitly opted into a paid brain.…, _FakeAsyncClient, _FakeResponse (+11 more)

### Community 342 - "traffic_director.py"
Cohesion: 0.11
...
### Community 344 - "isolated_telegram_config"
Cohesion: 0.11
...
### Community 350 - "test_tasks_awaiting_approval_api.py"
Cohesion: 0.16
...
### Community 351 - "[Unreleased]"
Cohesion: 0.08
Nodes (26): Added, Added, Added, Added, Added, Added, Added, Added (+18 more)

### Community 352 - "LLM Router — troubleshooting"
Cohesion: 0.08
...
### Community 353 - "autonomous_agent.py"
Cohesion: 0.09
Nodes (23): _extract_mentioned_paths(), Pick the auto-PR model from the recommended free-cloud chain by key. Mirrors…, Extract plausible file paths from issue text., Read existing files for codebase context (max 8000 chars total)., _read_grounding_files(), _select_brain(), diff_is_sloppy(), is_doc_only_boilerplate() (+15 more)
...
### Community 358 - "test_task_clarification.py"
Cohesion: 0.08
Nodes (10): Any, Callback for BackgroundAgent.on_task_complete. Dispatches task result…, Send notification to configured Telegram chat IDs., Dispatch the daily review digest to every authorized chat_id. Mirrors…, POST task result to configured webhook URL. Both ``error`` and ``result`` are…, Send an ad-hoc notification through all channels., auth_headers(), Tests for needs_clarification status and /api/tasks/{id}/clarify endpoint. (+2 more)

### Community 359 - "test_telegram_approval_e2e.py"
Cohesion: 0.12
...
### Community 365 - "Session Handoff — 2026-06-15"
Cohesion: 0.08
...
### Community 366 - "TASK 4 — End-to-end approval-gate test"
Cohesion: 0.08
...
### Community 367 - "test_north_mini_code.py"
Cohesion: 0.08
...
### Community 368 - "api_keys_for"
Cohesion: 0.12
Nodes (11): api_keys_for(), All keys configured for *provider_id*, primary first. Thin delegate to…, parametrize, Tests for packages/ai/key_pool.py — per-provider API key rotation. Rotation is…, Sibling keys must be ignored until the operator explicitly opts in. Several…, Rotation is off by default; these tests exercise the enabled path., A typo'd `_4` must not silently promote itself into the `_2` slot — the…, The same key twice is one budget, not two. Counting it twice would advertise… (+3 more)

### Community 369 - "test_claude_code_adapter.py"
Cohesion: 0.14
...
### Community 370 - "CompanyAgencyService"
Cohesion: 0.11
...
### Community 371 - "TemporalContextGraph"
Cohesion: 0.10
...
### Community 373 - "test_daily_automation_2026_08_03.py"
Cohesion: 0.11
...
### Community 374 - "TestClassifyPlainText"
Cohesion: 0.08
...
### Community 375 - "test_phase6_workflow.py"
Cohesion: 0.16
...
### Community 376 - "test_service_token.py"
Cohesion: 0.08
...
### Community 382 - "Local AI Stack with Docker"
Cohesion: 0.08
...
### Community 384 - "Implementation Prompt: Rich TaskBoard + Agile Sprint Integration"
Cohesion: 0.08
...
### Community 385 - "Telegram Bot Setup"
Cohesion: 0.08
...
### Community 386 - "video_transcript.py"
Cohesion: 0.12
...
### Community 387 - "control_overrides.py"
Cohesion: 0.12
...
### Community 391 - "test_agency_fix.py"
Cohesion: 0.08
...
### Community 392 - "test_skill_registry.py"
Cohesion: 0.09
...
### Community 395 - "_status_snapshot"
Cohesion: 0.15
...
### Community 396 - "Agent Governance Guide"
Cohesion: 0.09
...
### Community 397 - "The fifteen strategies"
Cohesion: 0.09
...
### Community 400 - "SeoCheckDefinition"
Cohesion: 0.11
...
### Community 402 - "WindowsServiceManager"
Cohesion: 0.18
...
### Community 403 - "OrchestratorCheckpointStore"
Cohesion: 0.13
...
### Community 404 - "SyntheticDataPipeline"
Cohesion: 0.13
...
### Community 408 - "test_mostly_failed_steps.py"
Cohesion: 0.12
...
### Community 411 - "HarnessEnrichment"
Cohesion: 0.14
...
### Community 412 - "classify_direct_chat_intent"
Cohesion: 0.13
...
### Community 414 - "AdaptivePermissions"
Cohesion: 0.18
...
### Community 418 - "test_slop_gate.py"
Cohesion: 0.14
Nodes (21): is_destructive_overwrite(), looks_like_secret_file(), Return (rejected, reason) when *new_text* destroys an existing file. Two…, Return (rejected, reason) when *path*/*content* is a secrets-shaped file. The…, tests/test_slop_gate.py — the auto-PR slop-gate. Guards the exact failure that…, Credential-named keys trigger even when other top-level values are non-scalar., The #833 case: '{}' written over a substantial file., test_bare_dotenv_rejected() (+13 more)

### Community 419 - "Harness"
Cohesion: 0.14
...
### Community 420 - "get_ceo_dispatcher"
Cohesion: 0.11
...
### Community 421 - "reap_expired_companies"
Cohesion: 0.15
...
### Community 422 - "TestResolveBrainProvider"
Cohesion: 0.09
...
### Community 423 - "test_portfolio_intelligence.py"
Cohesion: 0.10
...
### Community 426 - "_is_admin"
Cohesion: 0.10
Nodes (19): backend/ceo_router.py — observability and manual control for the CEO. Surfaces…, Reject non-admin callers for routes that spend provider budget. Delegates to…, _require_admin(), create_company(), get_optional_company_access(), _is_admin(), Extract a consistent user_id from the user dict. Works across all auth methods:…, Check if a user has admin role. Works for both social_auth users (role in… (+11 more)

### Community 427 - "_ensure_tasks_source_id_unique_index"
Cohesion: 0.14
...
### Community 428 - "test_dashboard_cache.py"
Cohesion: 0.15
...
### Community 429 - "V3 API Migration Plan — LLM Relay Platform"
Cohesion: 0.10
...
### Community 432 - "test_chat_mode_regressions.py"
Cohesion: 0.18
...
### Community 433 - "system_instruction"
Cohesion: 0.16
...
### Community 438 - "test_issue_triage.py"
Cohesion: 0.17
...
### Community 440 - "test_freebuff_bot.py"
Cohesion: 0.12
...
### Community 441 - "test_local_controller.py"
Cohesion: 0.17
...
### Community 442 - "run_trend_analysis"
Cohesion: 0.18
...
### Community 443 - "test_unit5_ui_provider_surface.py"
Cohesion: 0.10
...
### Community 444 - "DirectChatDoctor"
Cohesion: 0.16
...
### Community 446 - "PersistentMemoryStore"
Cohesion: 0.24
...
### Community 448 - "Skill: modularity-review"
Cohesion: 0.10
...
### Community 449 - "Design Audit"
Cohesion: 0.10
Nodes (19): Code Quality, Color and Surfaces, Component Patterns, Content, Design Audit, Fix Priority, How This Works, Iconography (+11 more)

### Community 450 - "Findings"
Cohesion: 0.10
...
### Community 455 - "Docker AI Governance Audit — Final Report"
Cohesion: 0.10
...
### Community 456 - "1. Capability-by-capability"
Cohesion: 0.10
...
### Community 458 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 460 - "ControlsScreen.jsx"
Cohesion: 0.15
...
### Community 463 - "key_pool.py"
Cohesion: 0.12
Nodes (14): _digest(), get_pool(), _KeyState, _PoolState, Per-provider API key rotation — the one lever that adds capacity. Every other…, Return the next usable key, or None when every key is cooling. With one key…, Cool a single key after a 429 from it. Honours the provider's own ``Retry-…, True when every key in the pool is resting. This is the signal that the… (+6 more)

### Community 464 - ".chat_completion"
Cohesion: 0.16
Nodes (6): CommercialFallbackRequiredError, _is_bedrock_model_id(), ProviderFallbackError, RuntimeError, Return True if model_id is an AWS Bedrock model or inference profile ID., TestIsBedrockModelId

### Community 465 - "compilerOptions"
Cohesion: 0.10
Nodes (19): DOM, DOM.Iterable, ES2022, src, vite/client, compilerOptions, isolatedModules, jsx (+11 more)

### Community 466 - "DecisionsStoreTests"
Cohesion: 0.11
...
### Community 467 - "test_kimi_bridge_server.py"
Cohesion: 0.12
...
### Community 472 - "test_tasks_cache_ttl_env.py"
Cohesion: 0.21
...
### Community 473 - "test_voice_pipeline.py"
Cohesion: 0.14
...
### Community 478 - "PerformanceAnalytics"
Cohesion: 0.12
...
### Community 480 - "Skill: fabric-patterns"
Cohesion: 0.11
...
### Community 481 - "Analysis & Synthesis Instructions"
Cohesion: 0.11
Nodes (18): 1. Define the Atmosphere, 2. Map the Color Palette, 3. Establish Typography Rules, 4. Define the Hero Section, 5. Describe Component Stylings, 6. Define Layout Principles, 7. Define Responsive Rules, 8. Encode Motion Philosophy (+10 more)

### Community 482 - "Production Readiness Assessment — local-llm-server"
Cohesion: 0.11
...
### Community 483 - "TestNormalizeResponseFormat"
Cohesion: 0.11
...
### Community 484 - "Skill: fabric-patterns"
Cohesion: 0.11
Nodes (18): 1. Ensure Pattern Directory Exists, 2. List Available Patterns, 3. Retrieve a Pattern, 4. Apply a Pattern with Variables, 5. Stitch Patterns Together, 6. Create New Patterns, Acceptance Checks, Directory Structure (+10 more)

### Community 485 - "db/__init__.py"
Cohesion: 0.14
...
### Community 486 - "Admin Dashboard Guide"
Cohesion: 0.11
...
### Community 487 - "Implementation Plan"
Cohesion: 0.11
...
### Community 491 - "parse_event_stream"
Cohesion: 0.15
...
### Community 493 - "test_task_source_id_race.py"
Cohesion: 0.17
...
### Community 494 - "test_brain_patch_service_token.py"
Cohesion: 0.18
...
### Community 495 - "TestSelfHealingInfrastructureClassification"
Cohesion: 0.19
...
### Community 496 - "test_fabric_patterns.py"
Cohesion: 0.11
...
### Community 497 - "test_free_tier_uses_the_reserve_when_no_paid_provider_is_selectable"
Cohesion: 0.16
...
### Community 498 - "test_schedule_persistence.py"
Cohesion: 0.15
...
### Community 499 - "validate_session_id"
Cohesion: 0.16
...
### Community 500 - "ErrorInterceptorMiddleware"
Cohesion: 0.18
...
### Community 504 - "Comprehensive Skill Index (By Category)"
Cohesion: 0.11
...
### Community 505 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 506 - "Component Map"
Cohesion: 0.11
...
### Community 507 - "test_minimax_bug_fixes.py"
Cohesion: 0.13
...
### Community 508 - "Agent State — colibri GLM-5.2 deployment (resumable)"
Cohesion: 0.11
...
### Community 509 - "Architecture Overview — local-llm-server"
Cohesion: 0.11
...
### Community 511 - "Platform Guide — the full tour"
Cohesion: 0.11
...
### Community 513 - "Part A — Health Report"
Cohesion: 0.11
...
### Community 515 - "scripts/doctor.py"
Cohesion: 0.29
...
### Community 525 - "test_self_heal.py"
Cohesion: 0.11
...
### Community 526 - "test_telegram_service_webhook.py"
Cohesion: 0.18
...
### Community 538 - "resolve_free_nvidia_brain"
Cohesion: 0.13
...
### Community 539 - "provider_max_rpm"
Cohesion: 0.17
...
### Community 540 - "redact_connection_url"
Cohesion: 0.17
...
### Community 541 - "kimi_bridge_provider_config"
Cohesion: 0.18
...
### Community 542 - "agent_readiness_audit.py"
Cohesion: 0.21
...
### Community 545 - "test_activation_api.py"
Cohesion: 0.21
...
### Community 547 - "test_health_endpoints.py"
Cohesion: 0.17
...
### Community 548 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 549 - "test_openclaw_endpoints.py"
Cohesion: 0.12
...
### Community 551 - "test_task_service_failed_comment.py"
Cohesion: 0.18
...
### Community 553 - "make_isolated_workspace"
Cohesion: 0.21
Nodes (7): make_isolated_workspace(), Path, Create an isolated workspace directory under *root*. This is the legacy path…, _workspace_component(), Path, TestMakeIsolatedWorkspace, TestWorkspaceSecurityRegressions
...
### Community 557 - "Skill: repowise-intelligence"
Cohesion: 0.12
...
### Community 558 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
...
### Community 559 - "_is_ephemeral_user"
Cohesion: 0.19
Nodes (15): account_lifecycle(), AccountLifecycleResponse, _is_ephemeral_user(), True when this user's companies should be temporary (reaped after TTL).…, Best-effort auth provider for a user dict. social_auth users carry an explicit…, Lifecycle/ephemerality status for the current user's agencies. Drives the…, Return whether the current user's agencies are ephemeral + when they expire.…, _resolve_provider() (+7 more)

### Community 560 - "clear_override"
Cohesion: 0.15
Nodes (16): build_platform_controls_router(), APIRouter, Build the router, bound to the app's auth dependency. Takes…, clear_override(), Persist the full override set., Validate, persist, and apply *updates*. A value equal to the environment/code…, Drop the override for *key*, reverting it to the environment default., Read the stored overrides, propagating a storage failure. Read-modify-write… (+8 more)
...
### Community 564 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 565 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 575 - "test_telegram_auto_approve.py"
Cohesion: 0.21
...
### Community 576 - "ManagedAgentDreams"
Cohesion: 0.22
...
### Community 577 - "_process_task_callback"
Cohesion: 0.28
...
### Community 578 - "test_autonomy_status.py"
Cohesion: 0.12
...
### Community 579 - "DailyDigestAggregatorTests"
Cohesion: 0.19
...
### Community 580 - "test_dockerfile_ships_root_modules.py"
Cohesion: 0.17
...
### Community 581 - "test_frontend_deployment_guards.py"
Cohesion: 0.20
...
### Community 582 - "test_glm52_brain.py"
Cohesion: 0.12
...
### Community 583 - "test_langfuse_agency_wide.py"
Cohesion: 0.12
...
### Community 584 - "test_llm_router_tpm.py"
Cohesion: 0.20
...
### Community 585 - "test_local_brain_state.py"
Cohesion: 0.12
...
### Community 587 - "test_phase5_doctor.py"
Cohesion: 0.12
...
### Community 588 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 589 - "test_telegram_diag_endpoint.py"
Cohesion: 0.12
...
### Community 593 - "CollaborationContext"
Cohesion: 0.17
...
### Community 594 - "Skill: agent-harness"
Cohesion: 0.13
...
### Community 595 - "Skill: checkpoint-strategy"
Cohesion: 0.13
...
### Community 597 - "Skill: local-ai-query"
Cohesion: 0.13
...
### Community 598 - "Skill: parallel-agents"
Cohesion: 0.13
...
### Community 599 - "Skill: parallel-worktrees"
Cohesion: 0.13
...
### Community 600 - "Design System: Taste Standard"
Cohesion: 0.13
...
### Community 602 - "run_seo_audit"
Cohesion: 0.18
Nodes (14): _expire_stale_pending_report(), post, Run a full SEO/GEO/AIO audit against a website and persist the evidence., Auto-fail a pending SEO audit stub that is older than…, run_seo_audit(), Store a report in the bounded in-memory registry., save_report(), _pending_started() (+6 more)

### Community 603 - "Skill: user-research"
Cohesion: 0.13
...
### Community 604 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 605 - "Attention Mechanisms Internals"
Cohesion: 0.13
...
### Community 606 - "FeatureUnavailableError"
Cohesion: 0.17
...
### Community 609 - "_push_down_where"
Cohesion: 0.14
...
### Community 611 - "DockerAgentAdapter"
Cohesion: 0.17
...
### Community 612 - "TestDecisionsBotLinks"
Cohesion: 0.17
...
### Community 613 - "DecisionsStore"
Cohesion: 0.30
Nodes (3): DecisionsStore, Any, Connection

### Community 614 - "clear_wizard_state_cache"
Cohesion: 0.21
...
### Community 615 - "telegram_service.py"
Cohesion: 0.16
...
### Community 616 - "e2e/test_browser.py"
Cohesion: 0.23
...
### Community 618 - "test_dockerfile_ships_config_dir.py"
Cohesion: 0.14
...
### Community 620 - "test_provider_failover_integration.py"
Cohesion: 0.17
...
### Community 623 - "test_ai_insights.py"
Cohesion: 0.20
...
### Community 626 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 630 - "Checks Performed"
Cohesion: 0.14
...
### Community 631 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 632 - "Skill: branch-cleanup"
Cohesion: 0.14
...
### Community 633 - "Skill: perplexity — Web Research via Perplexity API"
Cohesion: 0.14
...
### Community 635 - "Instructions"
Cohesion: 0.14
Nodes (13): Acceptance Checks, `admin_auth.py` checklist, `agent/tools.py` checklist, Escalation, Instructions, `key_store.py` checklist, `proxy.py` auth middleware checklist, Risky Modules in This Repo (+5 more)

### Community 636 - "Quick-Note Issues Processing Summary"
Cohesion: 0.14
...
### Community 637 - "[5.0.0]"
Cohesion: 0.14
Nodes (13): [5.0.0], Added, Added, Changed, Changed, Changelog, Fixed, Fixed (+5 more)

### Community 638 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 640 - "Render MCP — autonomous platform debugging and environment monitoring"
Cohesion: 0.14
...
### Community 641 - "Runbook: Auto-Resume After Cooldown / Interruption"
Cohesion: 0.14
...
### Community 642 - "SEO / GEO / AIO Audit Engine"
Cohesion: 0.14
...
### Community 650 - "test_openclaw_gateway.py"
Cohesion: 0.14
...
### Community 651 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 653 - "test_telegram_task_callback.py"
Cohesion: 0.20
...
### Community 656 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 659 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 660 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 663 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
...
### Community 664 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 665 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 667 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 681 - "update_provider_policy"
Cohesion: 0.19
...
### Community 683 - "_InMemoryBackend"
Cohesion: 0.18
...
### Community 684 - "TestAgentRunnerSafety"
Cohesion: 0.19
...
### Community 685 - "TestModelCostTableUpdates"
Cohesion: 0.26
...
### Community 686 - "TestMCPClientStructuredOutput"
Cohesion: 0.31
...
### Community 687 - "test_deploy_trigger_covers_image.py"
Cohesion: 0.21
...
### Community 688 - "test_doctor_service_token_check.py"
Cohesion: 0.23
...
### Community 689 - "TestRuntimeControl"
Cohesion: 0.15
...
### Community 691 - "test_task_brain_preflight.py"
Cohesion: 0.31
...
### Community 702 - "Skill: system-prompt-audit"
Cohesion: 0.17
...
### Community 703 - "Skill: task-alive-updates"
Cohesion: 0.17
...
### Community 706 - "admin_digest_router.py"
Cohesion: 0.24
Nodes (11): _check_secret(), _expected_secret(), preview_digest_endpoint(), Any, get, post, Dry-run: same auth, returns the would-be markdown body but does NOT dispatch to…, Mount this router on a FastAPI app. Idempotent. (+3 more)

### Community 707 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 710 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 712 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 713 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 715 - "Quantization Internals"
Cohesion: 0.17
...
### Community 716 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 717 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 718 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 720 - "ProviderHealth"
Cohesion: 0.35
Nodes (3): ProviderHealth, Any, Rolling health for one provider.

### Community 721 - "check_container_posture.py"
Cohesion: 0.26
...
### Community 722 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 723 - "test_admin_local_brain_router.py"
Cohesion: 0.29
...
### Community 724 - "test_agile_api.py"
Cohesion: 0.17
...
### Community 725 - "test_app_settings.py"
Cohesion: 0.21
...
### Community 726 - "TestAuthAndTaskOwnership"
Cohesion: 0.17
...
### Community 728 - "TestAnthropicPayloadStructuredOutput"
Cohesion: 0.29
...
### Community 731 - "_extractive_compress"
Cohesion: 0.18
...
### Community 735 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 738 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 739 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 741 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 744 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 745 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 746 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 747 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 748 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 749 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 750 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 751 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 753 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 754 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 755 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 756 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 757 - "What to clean up"
Cohesion: 0.18
...
### Community 758 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 761 - "response_cache.py"
Cohesion: 0.20
...
### Community 766 - "test_agent_readiness_audit.py"
Cohesion: 0.18
...
### Community 767 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 768 - "test_event_log.py"
Cohesion: 0.45
...
### Community 769 - "test_google_provider_models.py"
Cohesion: 0.18
...
### Community 773 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 774 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 777 - "_normalize_tool_choice"
Cohesion: 0.31
...
### Community 778 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 779 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 780 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 781 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 782 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 783 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 784 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 786 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 787 - "LLM Router — configuration guide"
Cohesion: 0.20
...
### Community 788 - "LLM Router — provider guide"
Cohesion: 0.20
...
### Community 789 - "CI Troubleshooting Runbook"
Cohesion: 0.20
...
### Community 790 - "_fake_fetch_module"
Cohesion: 0.36
...
### Community 793 - "local_brain_provider_config"
Cohesion: 0.29
...
### Community 794 - "TestModelsEndpointAliases"
Cohesion: 0.31
...
### Community 795 - "OpenHandsAdapter"
Cohesion: 0.24
...
### Community 796 - "build_tech_db.py"
Cohesion: 0.40
...
### Community 799 - "._notify_approval_gate"
Cohesion: 0.22
...
### Community 800 - "_redact_for_notification"
Cohesion: 0.24
...
### Community 801 - "TestExtendedThinkingRouting"
Cohesion: 0.20
...
### Community 802 - "TestZeroAttemptDiagnostics"
Cohesion: 0.29
...
### Community 803 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 804 - "test_quick_note_engine.py"
Cohesion: 0.22
...
### Community 805 - "test_version_consistency.py"
Cohesion: 0.20
...
### Community 810 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 812 - "Skill: changelog-enforcer"
Cohesion: 0.22
...
### Community 813 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 815 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 816 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 817 - "Skill: changelog-enforcer"
Cohesion: 0.22
Nodes (8): Acceptance Checks, Changelog Location, Entry Format, Examples, Hook Behaviour, Instructions, Skill: changelog-enforcer, When to Use

### Community 818 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
Nodes (8): Branch, Components, Purpose, Quick Start, Session Roles, Skill: cowork-session (Claude Cowork), Testing, When to Use

### Community 819 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 820 - "Active Task Tracker"
Cohesion: 0.22
...
### Community 822 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 823 - "Main proxy (`proxy.py`)"
Cohesion: 0.22
...
### Community 824 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 825 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 826 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 827 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 828 - "Platform Controls"
Cohesion: 0.22
...
### Community 829 - "Release Procedure"
Cohesion: 0.22
...
### Community 830 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 836 - "enrich_quick_note_issues.py"
Cohesion: 0.42
...
### Community 837 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 838 - "test_changelog_parity_guard.py"
Cohesion: 0.22
...
### Community 840 - "TestGithubSignalHardening"
Cohesion: 0.22
...
### Community 841 - "test_scanner_deps_parity.py"
Cohesion: 0.31
...
### Community 846 - "agent/output_filter.py"
Cohesion: 0.32
...
### Community 851 - "quality_checker.py"
Cohesion: 0.32
...
### Community 853 - "_build_direct_chat_schedule_suggestion"
Cohesion: 0.32
...
### Community 854 - "get_catalog"
Cohesion: 0.25
Nodes (8): get_catalog_models_route(), Return the mirrored model catalog (advisory-only). Flag-gated by…, get_catalog(), get_model_catalog_store(), is_catalog_enabled(), Return the process-wide ModelCatalogStore singleton., Convenience wrapper used by the GET /api/catalog/models endpoint., Check the runtime flag (default OFF). When False, the ``GET…

### Community 855 - "_parse_tool_calls_from_response"
Cohesion: 0.39
...
### Community 866 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 867 - "ceo-micromanagement.md"
Cohesion: 0.25
Nodes (4): P0 behavior change, Readiness contract, Runtime model, Runtime types

### Community 868 - "Feature Maturity / Support Matrix"
Cohesion: 0.25
...
### Community 871 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.25
...
### Community 872 - "Issue #362: Nvidia repo setup"
Cohesion: 0.25
...
### Community 873 - "Issue #364: quick-note:https://www.marktechpost.com/2026/06/01/meet-memory-os-a-6-layer-open-source-memory-stack-built-on-top-of-hermes-agent/"
Cohesion: 0.25
...
### Community 874 - "Issue #378: quick-note:https://www.marktechpost.com/2026/06/02/tinyfish-launches-bigset-an-open-source-multi-agent-system-that-builds-structured-live-datasets-from-plain-english-descriptions/"
Cohesion: 0.25
...
### Community 875 - "Issue #379: quick-note:https://searchengineland.com/schema-markup-optimize-agentic-web-479080"
Cohesion: 0.25
...
### Community 876 - "Issue #380: quick-note:https://cursor.com/blog/cloud-agent-lessons"
Cohesion: 0.25
...
### Community 877 - "Issue #381: quick-note:https://www.xda-developers.com/claude-code-with-opus-48-is-expensive-but-i-made-it-efficient-with-my-local-ai-workflow/"
Cohesion: 0.25
...
### Community 878 - "Issue #382: quick-note:https://claude.com/blog/how-coderabbit-used-claude-to-build-an-agent-orchestration-system"
Cohesion: 0.25
...
### Community 879 - "Issue #383: quick-note:https://www.marktechpost.com/2026/05/29/hexo-labs-open-sources-sia-a-self-improving-agent-that-updates-both-the-harness-and-the-model-weights/"
Cohesion: 0.25
...
### Community 880 - "Issue #416: feat: Self-hosted Codebuff (freebuff) on free NVIDIA models + Telegram bot phone control"
Cohesion: 0.25
...
### Community 881 - "Issue #485: [Trend Digest] Week of 2026-06-08"
Cohesion: 0.25
...
### Community 882 - "Issue #488: quick-note:https://github.com/cookiy-ai/user-research-skill"
Cohesion: 0.25
...
### Community 883 - "Issue #491: Implement whatever is necessary from https://github.com/BehiSecc/awesome-claude-skills"
Cohesion: 0.25
...
### Community 884 - "Issue #493: Use the https://github.com/mvanhorn/last30days-skill skill to get the trend updated"
Cohesion: 0.25
...
### Community 885 - "Issue #495: Read https://www.anthropic.com/news/claude-fable-5-mythos-5 and understand if mythos or fable can be added to the repo"
Cohesion: 0.25
...
### Community 886 - "Issue #504: EPIC: Autonomy hardening — live-verified defects 2026-06-10"
Cohesion: 0.25
...
### Community 887 - "Issue #581: Sprint tracker: pending work after brand rename + mobile-first pass"
Cohesion: 0.25
...
### Community 889 - "Issue #657: quick-note:https://github.com/earendil-works/pi"
Cohesion: 0.25
...
### Community 890 - "Issue #659: quick-note:https://github.com/nex-agi/Nex-N2"
Cohesion: 0.25
...
### Community 891 - "Issue #660: quick-note:https://github.com/getsentry/sentry-for-ai"
Cohesion: 0.25
...
### Community 892 - "Issue #661: quick-note:https://github.com/XiaomiMiMo/MiMo-Code"
Cohesion: 0.25
...
### Community 893 - "Issue #664: quick-note:https://github.com/Grominet95/jarvis-OS"
Cohesion: 0.25
...
### Community 894 - "Issue #666: quick-note:https://github.com/porokka/jarvis-os"
Cohesion: 0.25
...
### Community 895 - "Issue #670: quick-note:https://github.com/perplexityai/bumblebee"
Cohesion: 0.25
...
### Community 896 - "Issue #672: quick-note:https://github.com/Chachamaru127/claude-code-harness"
Cohesion: 0.25
...
### Community 897 - "Issue #676: quick-note:https://github.com/WeiboAI/VibeThinker"
Cohesion: 0.25
...
### Community 898 - "Issue #820: quick-note:https://github.com/cobusgreyling/loop-engineering"
Cohesion: 0.25
...
### Community 899 - "Positional Encoding Internals"
Cohesion: 0.25
...
### Community 901 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 902 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 903 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 904 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 905 - "Prime Agent Runtime"
Cohesion: 0.25
...
### Community 909 - "run_patched_colibri.py"
Cohesion: 0.36
...
### Community 912 - "test_compose_and_coordinate_api.py"
Cohesion: 0.36
...
### Community 913 - "test_generate_context_standing_instructions.py"
Cohesion: 0.32
...
### Community 914 - "test_local_brain_router_smoke.py"
Cohesion: 0.25
...
### Community 918 - "test_provider_models_db_outage.py"
Cohesion: 0.25
...
### Community 919 - "test_runtimes_health_endpoint.py"
Cohesion: 0.25
...
### Community 922 - "test_serve_spa_prefixes.py"
Cohesion: 0.36
...
### Community 923 - "test_server_autonomy_and_index_fixes.py"
Cohesion: 0.29
...
### Community 924 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.25
...
### Community 926 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 936 - "AI Engineering Insights Skill"
Cohesion: 0.29
...
### Community 949 - "Implementation plan + TO-DO (check off as you go)"
Cohesion: 0.29
...
### Community 954 - "Model and Response Issues"
Cohesion: 0.29
...
### Community 962 - "e2e_smoke.py"
Cohesion: 0.57
Nodes (5): _chat(), check(), _health(), _models(), _req()

### Community 963 - "task_runner.py"
Cohesion: 0.33
...
### Community 966 - "test_daily_2026_06_14.py"
Cohesion: 0.38
...
### Community 967 - "TestSupportMatrixDocsSync"
Cohesion: 0.29
...
### Community 969 - "test_domain_specialists.py"
Cohesion: 0.29
...
### Community 970 - "TestGithubTokenSQLiteRegression"
Cohesion: 0.38
...
### Community 971 - "TestProvidersScreen"
Cohesion: 0.43
...
### Community 988 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 989 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 990 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 991 - "The full agent capability roster"
Cohesion: 0.33
...
### Community 992 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 993 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 994 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 996 - "apply_phase1_changes.py"
Cohesion: 0.33
...
### Community 1008 - "TestExhaustedPoolDoesNotReusePrimary"
Cohesion: 0.33
...
### Community 1025 - "Who is this for?"
Cohesion: 0.40
...
### Community 1026 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 1027 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 1029 - "knowledgeGraphTab.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 1030 - "loginFlowNoTimeout.test.js"
Cohesion: 0.40
Nodes (4): apiSource, { describe, test, expect }, fs, path

### Community 1031 - "test_company_stale_id_recovery.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 1032 - "worker_no_cache.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, workerSource

### Community 1033 - "scripts/agile_ceremonies.py"
Cohesion: 0.60
Nodes (4): _load(), main(), ModuleType, _write_summary()

### Community 1034 - "governance/__init__.py"
Cohesion: 0.40
Nodes (3): __getattr__(), Any, packages/governance — agent identity, policy, approvals, audit, sandboxes. The…

### Community 1035 - "Prompt Library Changelog"
Cohesion: 0.40
Nodes (4): Added, Format, Prompt Library Changelog, [Unreleased]

### Community 1036 - "_add_colibri_shim_changelog_entry.py"
Cohesion: 0.50
...
### Community 1037 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1038 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1039 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 1040 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 1041 - "setup_colibri.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1042 - "setup_colibri.sh script"
Cohesion: 0.70
Nodes (4): setup_colibri.sh script, fail(), ok(), warn()

### Community 1043 - "status_colibri_server.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1045 - "TestMobileNavigation"
Cohesion: 0.40
Nodes (3): Mobile-specific: hamburger menu, responsive layout., Verify key pages load in mobile viewport., TestMobileNavigation

### Community 1046 - "test_v5_screens_smoke.py"
Cohesion: 0.50
...
### Community 1047 - "test_agent_runtime_wrapper.py"
Cohesion: 0.70
...
### Community 1048 - "TestTelegramNotifications"
Cohesion: 0.40
...
### Community 1050 - "TestModelRoleSeparation"
Cohesion: 0.40
...
### Community 1052 - "worker/index.js"
Cohesion: 0.60
Nodes (4): fetch(), needsProxy(), PROXY_PREFIXES, scheduled()

### Community 1054 - "verify_pr_exists"
Cohesion: 0.50
...
### Community 1064 - "Privacy, security, and cost"
Cohesion: 0.50
...
### Community 1069 - "pytest_collection_modifyitems"
Cohesion: 0.50
Nodes (4): Item, Config, pytest_collection_modifyitems(), pytest_configure()

### Community 1071 - "_clean_director"
Cohesion: 0.50
...
### Community 1072 - "stop_colibri_server.ps1"
Cohesion: 0.83
Nodes (3): Fail(), Ok(), W()
...
### Community 1087 - "test_no_exception_detail_leaks.py"
Cohesion: 0.50
...
### Community 1088 - "test_skills_route_order.py"
Cohesion: 0.67
...
### Community 1089 - "github"
Cohesion: 0.50
Nodes (3): github, enabled, silent

### Community 1094 - "Configuration reference"
Cohesion: 0.67
Nodes (3): Configuration reference, Provider priority chain, Running the brain on local Ollama (via a tunnel)

### Community 1115 - "test_the_reserve_is_bounded_when_read_from_the_environment"
Cohesion: 0.67
...
- **Why does `_fixture()` connect `_fixture` to `brain_config.py`, `company_api.py`, `llm/router.py`, `test_llm_router_queue_cache.py`, `TaskWorkflowService`, `test_operational_incidents.py`, `test_company_api.py`, `resolve_identity`, `test_llm_router_strategies.py`, `test_telegram_service_webhook.py`, `TaskStore`, `ImprovementLoop`, `E2BSandboxSession`, `cost_tracker.py`, `SelfHealingAgent`, `config.py`, `Agency`, `test_llm_router_resilience.py`, `MCPClient`, `Task`, `PrimeAgentAdapter`, `test_model_router.py`, `test_openclaw_endpoints.py`, `ExecutionRequest`, `SeoAuditEngine`, `UserRole`, `test_task_service_failed_comment.py`, `_clean_director`, `clear_override`, `test_llm_router_gateway.py`, `test_unit8_model_catalog.py`, `services/background.py`, `ChatHistoryStore`, `ArtifactStore`, `KeyStore`, `AgentProfile`, `sam`, `SQLiteStore`, `test_webui_provider_priority.py`, `_StubProvider`, `TokenBudget`, `test_telegram_auto_approve.py`, `test_autonomy_status.py`, `ai/router.py`, `test_agent_tool_governance.py`, `BackgroundAgent`, `test_llm_router_tpm.py`, `test_local_brain_state.py`, `ResearchTask`, `test_phase5_doctor.py`, `AgentJobManager`, `test_telegram_diag_endpoint.py`, `brain_failover.py`, `TestClient`, `test_procedural_memory.py`, `model_router.py`, `get_task_store`, `get_self_healing_agent`, `test_knowledge_sync.py`, `e2e/test_browser.py`, `AgentPlan`, `test_provider_failover_integration.py`, `get_workflow_orchestrator`, `run_task`, `test_context_rulebook.py`, `test_startup_warmup.py`, `test_failover_client_shared.py`, `test_issue_intake.py`, `test_trend_scoping.py`, `TestHarnessAdapter`, `test_openclaw_gateway.py`, `persist_plan_spec`, `test_telegram_task_callback.py`, `test_e2b_adapter.py`, `test_daily_2026_07_27.py`, `clear_cooldowns`, `test_new_features_e2e.py`, `HarnessRegistry`, `_Budget`, `test_ceo_router.py`, `TestAgentRunnerSafety`, `analyze_page`, `test_doctor_service_token_check.py`, `TestRuntimeControl`, `test_features_api.py`, `test_task_brain_preflight.py`, `test_video_transcript.py`, `TrendWatcher`, `FeatureMaturity`, `BrainWatchdog`, `SchedulerStore`, `test_portfolio_intake.py`, `OllamaCircuitBreaker`, `test_provider_state_durability.py`, `test_e2b_data_flow.py`, `test_trend_watcher.py`, `models/seo_audit.py`, `test_agile_api.py`, `test_app_settings.py`, `TestAuthAndTaskOwnership`, `TestEstimateTokensForMessages`, `TestClient`, `ContextPruner`, `test_control_plane_api.py`, `test_brain_availability_doctor.py`, `OrchestratorQueue`, `NotificationDispatcher`, `test_brain_failover.py`, `test_persistent_memory.py`, `SecurityScanner`, `WorkflowBuildRequest`, `test_llm_router_e2e.py`, `OutputFilter`, `test_platform_controls.py`, `._check_permissions`, `loop.py`, `test_rate_limiter.py`, `test_iteration_6_features.py`, `test_sam_voice.py`, `test_purge_backlog.py`, `test_telegram_mutating_commands.py`, `_resolve_user_github_token`, `test_crispy_burn_in.py`, `test_provider_enable_disable.py`, `test_skill_registry_boot_refresh.py`, `isolated_telegram_config`, `test_scheduler_hydration_bounded.py`, `test_tasks_awaiting_approval_api.py`, `test_task_clarification.py`, `api_keys_for`, `test_claude_code_adapter.py`, `_get`, `test_service_token.py`, `test_harness_spec.py`, `test_regression.py`, `test_agency_fix.py`, `OrchestratorCheckpointStore`, `test_ping.py`, `test_monitor_lib.py`, `test_runtimes_health_endpoint.py`, `test_v4_api.py`, `test_task_store_fails_loud_in_production.py`, `UsageEvent`, `get_ceo_dispatcher`, `reap_expired_companies`, `test_dashboard_cache.py`, `allow_paid`, `client`, `test_doctor_coding_brain.py`, `key_pool.py`, `test_kimi_bridge_server.py`, `test_voice_pipeline.py`, `TestNormalizeResponseFormat`, `parse_event_stream`, `test_brain_patch_service_token.py`?**
  _High betweenness centrality (0.117) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `ReactScratchpad`, `proxy.py`, `ContextManager`, `loop.py`, `test_backend_server_features.py`, `TaskSpec`, `test_e2b_adapter.py`, `E2BSandboxSession`, `test_agent_loop_delegates_to_the_shared_client`, `TestAgentLoopMCPIntegration`, `LocalWorkspace`, `Agency`, `workflow_orchestrator.py`, `StuckDetector`, `MultiAgentSwarm`, `AdaptiveHalter`, `MCPClient`, `test_daily_automation_2026_07_11.py`, `get_ceo_dispatcher`, `ExecutionRequest`, `TestAgentRunnerSafety`, `WorkspaceTools`, `TokenBudget`, `test_agent_tool_governance.py`, `BackgroundAgent`, `FreeBuffAgent`, `AgentJobManager`, `UserMemoryStore`, `InternalAgentAdapter`, `test_agent_free_brain.py`, `direct_chat.py`, `ContextPruner`, `AgentPlan`, `test_governance_api.py`, `TestAgentRunnerExecution`, `GitHubTools`, `AgentSessionStore`, `BrainFailoverExhausted`, `CEODispatcher`, `test_failover_client_shared.py`, `test_empirical_verify.py`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `get_tool_registry()` connect `ToolRegistry` to `SpecEntry`, `test_agent_tool_governance.py`, `AgentRunner`, `AgentPlan`, `loop.py`, `test_p0_roadmap_b1_c2_a3.py`, `test_user_research_skill.py`, `WorkspaceTools`, `HarnessEnrichment`?**
...
- **Should `backend/server.py` be split into smaller, more focused modules?**
  _Cohesion score 0.014675169687476692 - nodes in this community are weakly interconnected._