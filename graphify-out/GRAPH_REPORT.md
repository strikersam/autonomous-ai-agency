# Graph Report - autonomous-ai-agency  (2026-09-21)

## Corpus Check
- 1529 files · ~2,229,576 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 54 file(s) not represented in the graph (top: (none) 16, .bat 5, .css 5)

## Summary
- 32341 nodes · 60108 edges · 1351 communities (1170 shown, 134 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 4012 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b8e064dd`
...
## Communities (1351 total, 134 thin omitted)

### Community 0 - "backend/server.py"
Cohesion: 0.02
Nodes (274): admin_seed(), AgentStatusEntry, AgentStatusResponse, AgentToolCallEntry, ApiKeyCreate, auth_me(), AuthorizeReposBody, auto_recommend_skills() (+266 more)

### Community 1 - "TaskStore"
Cohesion: 0.04
Nodes (80): tasks — Task/issue management system. Provides a lightweight task/issue tracker…, Enum, str, TaskPriority, _priority_rank(), Any, tasks/store.py — MongoDB-backed task store. Falls back to in-memory storage…, Fail loud in production if no persistent storage is configured. Telegram… (+72 more)

### Community 2 - "llm/router.py"
Cohesion: 0.02
Nodes (179): get_budget(), packages/llm/budget.py — token and cost accounting with spend alerts. Tracks…, The process-wide budget tracker., Test hook — clear all usage accounting., reset(), get_cache(), packages/llm/cache.py — layered caching. Five independent layers, each with its…, The process-wide cache manager. (+171 more)

### Community 3 - "Specialist"
Cohesion: 0.03
Nodes (47): SpecialistFamily, Find all specialists of a specific family., Find specialists that can handle a task with given capabilities., A specialist agent that can be provisioned for company-specific tasks., Check if this specialist can handle a task with given capabilities., Specialist, SpecialistFamily, SystemType (+39 more)

### Community 4 - "proxy.py"
Cohesion: 0.02
Nodes (178): Describes a single worker's task and constraints., WorkerSpec, get_skill_registry_safe(), Return the global SkillRegistry if set, else None. Used by onboarding and other…, middleware, admin_control(), admin_create_key(), admin_create_user() (+170 more)
...
### Community 6 - "api.js"
Cohesion: 0.01
Nodes (33): approveGovernanceRequest(), createMcpServer(), createQuickNote(), createTask(), deleteMcpServer(), deleteModel(), denyGovernanceRequest(), downloadSeoExport() (+25 more)

### Community 7 - "_fixture"
Cohesion: 0.02
Nodes (77): base_url(), mobile_page(), proxy_url(), Config, pytest_configure(), conftest.py — pytest fixtures and configuration for the E2E test suite.…, A browser page pre-configured for mobile viewport (390×844 — iPhone 14)., setup_database_moks() (+69 more)

### Community 8 - "brain_config.py"
Cohesion: 0.03
Nodes (107): _active_primary_provider(), BrainConfig, BrainConfigPatch, BrainConfigStore, default_brain_config(), is_north_mini_code_default(), provider_api_key(), provider_api_keys() (+99 more)

### Community 9 - "company_api.py"
Cohesion: 0.02
Nodes (198): account_lifecycle(), AccountLifecycleResponse, auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint(), _DoctorCheck, _DoctorReport (+190 more)

### Community 10 - "PolicyEngine"
Cohesion: 0.04
Nodes (83): _egress_policy_reason(), agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Return why governance policy blocks *host*, or None. Runs strictly *after* the…, _action_matches(), _as_list(), Decision, GroupPolicy, _host_matches() (+75 more)

### Community 11 - "LLMRequest"
Cohesion: 0.02
Nodes (167): ProviderConfig, One configured endpoint. ``kind`` selects the adapter: ``openai`` (any OpenAI-…, AnthropicProvider, Any, AsyncClient, packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, Translate OpenAI-shaped messages into Anthropic's system/turn split., OpenAI carries a tool result as role="tool" with a tool_call_id; Anthropic… (+159 more)
...
Cohesion: 0.02
Nodes (103): AlertHandler, BudgetTracker, Counter, _Dimensions, _month(), Any, Register a callback fired when a spend threshold is crossed., Fold a new key into "other" once the dimension is at its cap. (+95 more)

### Community 14 - "Task"
Cohesion: 0.03
Nodes (90): Task, Full task/issue document., Update the updated_at timestamp., Task, _gate_outward_facing_enabled(), _is_brain_connection_error(), _is_outward_facing(), Any (+82 more)

### Community 15 - "TaskSpec"
Cohesion: 0.04
Nodes (99): Resolve the model id for a component's role on a provider. Parameters…, resolve_component_model(), kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, AiderAdapter, TaskResult, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Run aider non-interactively via `--message` flag. (+91 more)
...
### Community 17 - "register_webui"
Cohesion: 0.06
Nodes (55): allow_paid_brain(), get_brain_preference(), invalidate_brain_cache(), Clear the cached brain so the next read re-resolves. Called from…, True only when the operator explicitly opted into a paid (Anthropic) brain.…, Return the operator's brain provider preference. Values: - ``"nvidia"`` —…, Any, Path (+47 more)
...
### Community 19 - "Any"
Cohesion: 0.04
Nodes (33): _check_extra_kwargs(), _enforce_signature(), _nvidia_api_key(), Any, Path, Raise TypeError if fn's signature drifts from the locked contract (Pydantic…, Raise TypeError on unknown kwarg (runtime extra='forbid' for non-Pydantic…, Governance seam: judge the call, run it, audit the outcome. Deliberately a thin… (+25 more)

### Community 20 - "test_ceo_micromanager.py"
Cohesion: 0.04
...
### Community 21 - "Agency"
Cohesion: 0.04
Nodes (87): Agency, AgencyCycleResult, AgentDirective, AgentRole, _build_ceo_prompt(), _build_quick_note_instruction(), _close_github_issue(), _collect_recent_git_context() (+79 more)

### Community 22 - "E2BSandboxSession"
Cohesion: 0.04
Nodes (71): MCPUnavailableError, Raised when the MCP server is unreachable or the circuit is open., E2BSandboxSession, _inject_token(), maybe_attach_e2b(), Any, Create the sandbox. Raises :class:`MCPUnavailableError` on failure., Kill the sandbox. Idempotent; never raises (best-effort cleanup). (+63 more)

### Community 23 - "test_failover_client_shared.py"
Cohesion: 0.06
...
### Community 28 - "AgentSessionStore"
Cohesion: 0.05
Nodes (43): Agent subsystem — planner / executor / verifier loop., AgentEvent, AgentRunRequest, AgentSession, AgentSessionCreateRequest, AgentSessionMessage, _known_tool_names(), Any (+35 more)

### Community 29 - "test_hermes_server.py"
Cohesion: 0.18
...
### Community 30 - "test_llm_router_resilience.py"
Cohesion: 0.04
Nodes (65): Backoff policy for retryable failures., RetryConfig, BreakerState, Enum, str, _digest(), KeyRing, KeyState (+57 more)

### Community 31 - "_scanner"
Cohesion: 0.03
...
### Community 33 - "openclaw_mobile_ui"
Cohesion: 0.33
...
### Community 34 - "WebsiteScanner"
Cohesion: 0.03
Nodes (77): Evidence, Evidence supporting a system detection., main(), Post-deploy verification for the website scanner against the LIVE internet.…, Returns (url, ok, summary)., _scan_one(), _content_contains_domain(), _hostname_contains() (+69 more)

### Community 35 - "test_brain_failover.py"
Cohesion: 0.10
...
### Community 36 - "test_ceo_dispatcher.py"
Cohesion: 0.02
Nodes (140): CEOResult, _complexity_rank(), _decompose_into_subtasks(), get_ceo_dispatcher(), _merge_changed_files(), Return the shared CEODispatcher singleton., Reset the singleton (test helper)., Aggregated output from a multi-specialist execution. (+132 more)

### Community 37 - "AgentSwarm"
Cohesion: 0.05
Nodes (58): AgentRole, agents/__init__.py — CRISPY multi-agent coding system., AgentProfile, _catalog_defaults(), _catalog_provider(), _get_defaults(), load_all_profiles(), make_architect_profile() (+50 more)

### Community 38 - "test_unit8_model_catalog.py"
Cohesion: 0.04
Nodes (70): CatalogActiveBrain, CatalogMirror, CatalogProviderEntry, get_catalog(), get_model_catalog_store(), _include_router_providers(), invalidate_catalog_cache(), is_catalog_enabled() (+62 more)
...
### Community 40 - "seo_portfolio_bridge.py"
Cohesion: 0.05
Nodes (47): CapacityAllocation, InitiativeStatus, Enum, Agentic Portfolio Management — initiative prioritisation, capacity allocation,…, Result of fitting initiatives into a fixed capacity by WSJF priority., Total job size of initiatives that fit within capacity., Unused capacity after committing the selected initiatives., Fraction of capacity consumed (0.0–1.0). (+39 more)

### Community 41 - "V5App.jsx"
Cohesion: 0.03
Nodes (53): API, deleteGithubToken(), getAccountLifecycle(), getLoops(), githubStatus(), listGithubRepos(), AppShell(), MOBILE_PRIMARY (+45 more)

### Community 42 - "AgentJobManager"
Cohesion: 0.04
Nodes (38): AgentJob, AgentJobManager, heartbeat(), _now(), Any, Run a job using the provided runner and update the job's lifecycle, progress,…, Serialize the AgentJob to a JSON-serializable dictionary for external clients.…, AgentJobManager method signature enforcement. (+30 more)

### Community 43 - "test_mcp_registry.py"
Cohesion: 0.06
Nodes (29): Measure one server. Never raises — a probe failure is a status, not an error., Measure every declared server concurrently and return dashboard rows. Probes…, status_all(), _status_for(), _noop_async(), Any, asyncio, tests/test_mcp_registry.py — the single MCP catalogue and the screen it backs.… (+21 more)

### Community 44 - "FeatureMatrix"
Cohesion: 0.04
Nodes (23): FeatureMatrix, Central support matrix — single source of truth. Loads the canonical feature…, Return True if the feature is enabled and not disabled., Return a warning string for beta/experimental features, or None., Render the matrix as a Markdown table for docs., The feature matrix can produce a markdown table for docs., Every config flag referenced in the matrix should be documented., The matrix should cover the key areas from the spec. (+15 more)
...
### Community 46 - "direct_chat.py"
Cohesion: 0.06
Nodes (66): Any, Translate technical preflight issues into a conversational assistant reply., translate_error_to_conversational(), AcceptedJob, AgentJobEnvelope, CompletedJob, DirectChatState, FailedJob (+58 more)

### Community 47 - "get_user_role"
Cohesion: 0.05
Nodes (45): compute_savings(), compute_time_series(), get_savings(), get_usage(), get_user_savings(), _period_start(), Any, BaseModel (+37 more)

### Community 48 - "CompanyGraphStore"
Cohesion: 0.03
...
### Community 49 - "test_ceo_supervision.py"
Cohesion: 0.03
Nodes (100): CEODispatcher, _harvest_changed_files(), _offload(), Any, Run a synchronous ledger call without blocking the event loop. ``CEOLedger`` is…, Extract the files a runtime touched. Returns ``(files, reported)``. Adapters…, Build an agent.coordinator.TaskSpec from a CEO SpecialistTask., Real CEO delegation: wake runtimes, fan out, and merge results. (+92 more)

### Community 50 - "AgentRunner"
Cohesion: 0.03
Nodes (95): AgentPhaseError, AgentRunner, Exception, Return True when no file is touched by more than one step., Raised when a named agent phase (planning, verification, etc.) fails., GATE: Golden Path steps #7-12 — the primary agent execution loop. This is the…, Set a per-session token spend cap (★3 rollout token budget). When *cap* > 0 the…, Record token spend for *session_id* and enforce the budget cap. Logs a warning… (+87 more)
...
Cohesion: 0.03
Nodes (51): browse_page(), Open *url* in a real browser, return its rendered text, and close. Fail-soft:…, get_tool_registry(), _infer_parameters_from_func(), Any, Path, Register a tool definition., Decorator to register a function as an agent tool. Usage::… (+43 more)

### Community 53 - "get_runtime_manager"
Cohesion: 0.04
Nodes (84): e2b_status(), _enrich_runtimes(), get_decision_log(), get_policy(), get_runtime(), list_runtimes(), _load_rich_policy(), PolicyUpdateBody (+76 more)

### Community 54 - "MetricsRegistry"
Cohesion: 0.07
...
### Community 55 - "telegram_bot.py"
Cohesion: 0.07
Nodes (50): Convenience: resolve all four role models for a component. Returns a dict with…, resolve_component_role_models(), _admin_headers(), _api_headers(), _check_rate_limit(), cmd_control(), cmd_keylist(), cmd_merge() (+42 more)

### Community 56 - "validate_policy_text"
Cohesion: 0.05
Nodes (35): propose_policy(), validate_policy(), _audit_proposal(), _baseline_loosened(), _baseline_patterns(), diff_policy(), _GitHub, parse_policy_text() (+27 more)

### Community 57 - "ExecutionRequest"
Cohesion: 0.03
Nodes (58): OrchestratorSupervisor, Any, Emit an alert to the activity feed and log., Deterministic supervisor for the orchestrator. Runs as a background coroutine.…, stop_orchestrator_supervisor(), ExecutionRequest, Reset the singleton (test helper)., Canonical request to execute work through the golden path. This is the ONLY… (+50 more)

### Community 58 - "services/seo_audit.py"
Cohesion: 0.05
Nodes (60): BaseModel, field_validator, models/seo_audit.py - SEO / GEO / AIO Audit Contracts Typed Pydantic models for…, A single occurrence of a check firing on a specific URL., Snapshot of one crawled page with the on-page facts the checks used., Aggregated report row - Screaming Frog CSV compatible., Site-level facts discovered during the crawl., An agent-delegable remediation work package derived from the findings. Findings… (+52 more)

### Community 59 - "LLMRouter"
Cohesion: 0.07
Nodes (29): Attempt, Read the environment variables named in ``env_names`` into a key list. Order is…, resolve_keys(), LLMRouter, run(), Any, AsyncClient, BaseException (+21 more)

### Community 60 - "TestAddConversationCacheBreakpoints"
Cohesion: 0.06
Nodes (27): _breakpoint_at(), _make_provider(), _make_provider_1h(), _make_request(), _msgs(), tests/test_anthropic_conversation_caching.py — Rolling conversation cache…, Fewer than stable_back+1 messages → no breakpoint added., Exactly stable_back+1 messages → breakpoint IS added. (+19 more)

### Community 61 - "test_one_model_catalogue.py"
Cohesion: 0.09
Nodes (18): _hardcoded_candidates(), parametrize, Model ids belong in a catalogue, not in Python. Four files in this repo each…, A frozen record of the divergence found on 2026-08-28. Reconciling these eleven…, These two are the ones this work reconciled, and each was reconciled because…, A shrinking divergence is progress, but the list must be trimmed to match or it…, ``config/llm/models.yaml`` drives capability filtering. An entry for a retired…, A sixth model source, found on 2026-08-28 while verifying a fix.… (+10 more)

### Community 63 - "test_governance_api.py"
Cohesion: 0.09
...
### Community 64 - "test_web_reach.py"
Cohesion: 0.04
Nodes (71): _domain_list_reason(), _domain_matches(), _load_script_module(), _parse_domain_list(), Any, ModuleType, Return True if *host* is *pattern* or a subdomain of it., Split a comma-separated env var into a normalised domain list. (+63 more)

### Community 65 - "BrainWatchdog"
Cohesion: 0.04
Nodes (63): emit_agency_observation(), Record an agency platform operation in Langfuse. Unlike…, provider_key_present(), True when the env var for *provider*'s key is set (or it's Ollama)., Any, packages/ai/self_heal.py — automatic brain self-healing. When the active brain…, Background tick that runs self_heal_brain_and_unblock_tasks(). Called from the…, One-shot self-healing pass. 1. Checks if the active brain provider is in a… (+55 more)
...
### Community 67 - "test_startup_warmup.py"
Cohesion: 0.04
Nodes (62): _bootstrap_within_budget(), _create_bootstrap_indexes(), ensure_bootstrap(), Await one warm-up step, deferring it to the background if it overruns.…, The task store the background services should use, wiring it if needed.…, Point the feature stores at the shared database connection. Deliberately…, Create every boot index concurrently rather than one round-trip at a time.…, Idempotent bootstrap for indexes + seeded admin/providers. FastAPI startup… (+54 more)

### Community 68 - "WorkflowRun"
Cohesion: 0.03
Nodes (57): MergeDecision, _NoopStore, Any, Exception, Approve a run paused at the ApprovalGate. The caller must re-invoke…, Inject additional instructions into an in-flight run (no state change). Backs…, Push a Telegram approval-gate notification when a run pauses (Charter G1).…, G5: resolve how a run should land from the company's DeliveryPolicy. Returns… (+49 more)
...
### Community 74 - "failover_client.py"
Cohesion: 0.05
...
### Community 76 - "test_portfolio_intake.py"
Cohesion: 0.08
...
### Community 77 - "test_ceo_router.py"
Cohesion: 0.04
Nodes (70): build_ceo_router(), ceo_status(), get_goal(), list_goals(), redrive_goal(), run_sweep(), Any, APIRouter (+62 more)
...
Cohesion: 0.03
Nodes (86): get_sam(), agent/sam.py — SAM Voice Agent (System Autonomy Manager) SAM is the voice-…, _purge_backlog_core(), quick_notes_submit(), _QuickNoteBody, Shared purge implementation for the admin endpoint and the boot hook., Submit a quick-note URL or instruction from the dashboard FAB., Hand the 'connect & verify the repo' work to the agency's own agents. The task… (+78 more)
...
### Community 82 - "test_runtime_governance.py"
Cohesion: 0.08
Nodes (52): _blocked_result(), _governance_check(), _governance_identity(), Any, TaskResult, Build the failed TaskResult returned when policy denies a dispatch. A result…, Evaluate a runtime dispatch against policy; audit it either way. Returns…, Resolve the acting identity for a runtime dispatch. Identity comes from… (+44 more)

### Community 83 - "setup/api.py"
Cohesion: 0.07
...
### Community 86 - "test_provider_router.py"
Cohesion: 0.04
Nodes (50): _normalize_nvidia_base_url(), _openai_url(), Normalize NVIDIA base URLs to avoid double /v1 when openai_compat_url appends…, _nvidia_provider_chain(), ProviderConfig, Build Nvidia NIM provider config from env. Empty list when key is absent., Registry base URLs must produce routes the provider actually serves., brain_failover must not drift from the catalog's base URLs. (+42 more)
...
### Community 91 - "test_knowledge_sync.py"
Cohesion: 0.07
...
Cohesion: 0.04
Nodes (41): consultExecutives(), createCompany(), delegateSeoFindings(), getCompany(), getOnboardingProgress(), getSeoAudit(), listExecutives(), listSeoAudits() (+33 more)

### Community 96 - "test_model_catalog.py"
Cohesion: 0.05
...
### Community 97 - "load_config"
Cohesion: 0.05
Nodes (48): _build(), _coerce(), expand_env(), _fields_of(), _load_cache(), load_config(), _load_models(), _load_providers() (+40 more)

### Community 98 - "ArtifactStore"
Cohesion: 0.05
Nodes (33): TestSwarmRoleRouting, Path, tests/test_artifact_store.py — Unit tests for workflow/artifact_store.py., Verify artifacts that are stored as JSON (e.g., CheckRun results)., Writing the same (run_id, name) twice should update, not duplicate., store(), TestArtifactStoreDeletion, TestArtifactStoreJSONArtifact (+25 more)

### Community 99 - "resolve_provider_for"
Cohesion: 0.06
...
### Community 103 - "clear_cooldowns"
Cohesion: 0.10
Nodes (19): clear_cooldowns(), is_provider_on_cooldown(), mark_provider_failed(), Put provider_id on cooldown for *cooldown_seconds* (default:…, Return True if provider_id is currently on cooldown., Clear all cooldown entries (useful for testing). Delegates to…, clear_all_locks(), Clear all probe-lock entries (for test teardown). Companion to… (+11 more)

### Community 104 - "RenderMCPClient"
Cohesion: 0.04
Nodes (40): _as_list(), _coerce_payload(), Any, RuntimeError, packages/integrations/render_mcp.py — Render platform access over MCP. The…, Return tool output as Python data. MCP tool results arrive either as…, Normalise a tool payload into a list of dicts. Upstream tools variously return…, Unwrap a nested envelope such as ``{"service": {...}}`` when present. (+32 more)

### Community 105 - "RequestQueue"
Cohesion: 0.04
Nodes (39): int, Bulkhead, Deduplicator, Any, Semaphore, T, packages/llm/queue.py — admission control, concurrency, and bulkheads. Three…, Collapse concurrent identical calls onto a single execution. (+31 more)

### Community 106 - "NotificationDispatcher"
Cohesion: 0.09
...
### Community 111 - "test_integration_c4_c5_c6_d3.py"
Cohesion: 0.06
...
### Community 116 - "RenderOpsMonitor"
Cohesion: 0.06
...
### Community 117 - "test_response_cache.py"
Cohesion: 0.10
...
Cohesion: 0.04
Nodes (36): packages.config — single source of truth for all configuration. Every module…, _env_int(), _get_settings(), packages/config/settings.py — typed configuration. This is the ONLY module in…, Read an int env var, falling back to *default* on a missing/bad value. Never…, Typed configuration loaded from environment variables., When True, the governance layer evaluates and audits agent actions. This is…, When True, approval-gated actions self-approve. Local dev only. (+28 more)

### Community 119 - "test_trend_scoping.py"
Cohesion: 0.08
...
### Community 120 - "StreamingDeltaReconstructor"
Cohesion: 0.05
...
### Community 121 - "pr_approval_gate.py"
Cohesion: 0.06
...
### Community 125 - "test_prompt_injection_boundary.py"
Cohesion: 0.15
...
### Community 127 - "PortfolioManager"
Cohesion: 0.05
...
### Community 128 - "persist_plan_spec"
Cohesion: 0.06
...
### Community 131 - "test_schedule_growth_invariants.py"
Cohesion: 0.04
...
### Community 133 - "WorkflowBuildRequest"
Cohesion: 0.10
Nodes (18): engine(), WorkflowEngine, Contract: WorkflowEngine cannot skip the gate state machine., Contract: No code path may advance past awaiting_approval unless gate.status ==…, Create a run and manually place it in awaiting_approval., Contract: Cannot approve a run in 'pending' state., Contract: Can approve a run in 'awaiting_approval' state., Contract: Rejecting a run marks it as failed. (+10 more)

### Community 134 - "test_llm_router_e2e.py"
Cohesion: 0.09
...
### Community 135 - "portfolio_intelligence.py"
Cohesion: 0.06
...
### Community 136 - "resolve_active_brain"
Cohesion: 0.05
...
### Community 138 - "ProviderConfig"
Cohesion: 0.03
Nodes (93): _acquire_provider_probe(), _dead_model_key(), _exponential_backoff_cooldown(), get_dead_models(), _get_director(), is_anthropic_base_url(), is_commercial_provider(), _is_model_dead() (+85 more)

### Community 139 - "_env_float"
Cohesion: 0.10
...
### Community 140 - "test_self_heal_v2.py"
Cohesion: 0.07
...
### Community 146 - "test_minimax_bug_fixes.py"
Cohesion: 0.12
...
### Community 148 - "WorkflowRun"
Cohesion: 0.05
Nodes (38): _fake_artifact(), _make_engine(), tests/test_crispy_workflow.py — CRISPY workflow engine hardening tests. Tests…, Create a WorkflowEngine with isolated storage., TestAbortOnFailure, _test(), _tracking_run_single(), TestPhaseSequence (+30 more)

### Community 149 - "app.py"
Cohesion: 0.09
...
### Community 150 - "test_bedrock_provider.py"
Cohesion: 0.07
Nodes (23): _is_bedrock_model_id(), Return True if model_id is an AWS Bedrock model or inference profile ID., _bedrock_api_response(), _bedrock_provider(), _mock_boto3(), Any, asyncio, ProviderConfig (+15 more)
...
### Community 153 - "RepowiseIntelligence"
Cohesion: 0.05
...
### Community 154 - "tests/conftest.py"
Cohesion: 0.07
Nodes (31): Item, app_client(), _clear_discovered_models(), _clear_response_cache(), client(), _isolate_brain_data_layer(), _isolate_operator_provider_state(), non_admin_client() (+23 more)

### Community 155 - "run_task"
Cohesion: 0.06
...
### Community 157 - "ChatHistoryStore"
Cohesion: 0.07
...
### Community 161 - "seo_api.py"
Cohesion: 0.05
Nodes (62): build_seo_roadmap(), delegate_seo_findings(), _expire_stale_pending_report(), export_seo_audit(), get_seo_audit(), list_seo_audits(), plan_seo_sprint(), BaseModel (+54 more)

### Community 162 - "ApprovalStore"
Cohesion: 0.07
...
### Community 163 - "test_telegram_freebuff.py"
Cohesion: 0.07
...
### Community 164 - "test_webui_provider_priority.py"
Cohesion: 0.10
...
### Community 167 - "TestHarnessAdapter"
Cohesion: 0.05
...
### Community 169 - "TestEstimateTokensForMessages"
Cohesion: 0.06
...
### Community 171 - "test_agent_tool_governance.py"
Cohesion: 0.04
Nodes (68): Replace the process-wide store. Tests only., reset_approval_store(), AuditEvent, AuditLog, One governed action, fully described. Field order follows the…, One-line JSON, suitable for a SIEM shipper tailing the log., Bounded in-memory ring buffer plus a structured log stream. The ring buffer…, Store and emit *event*. Never raises. (+60 more)

### Community 172 - "tasks/models.py"
Cohesion: 0.04
...
### Community 175 - "Company"
Cohesion: 0.06
Nodes (20): BusinessCategory, Company, Any, field_validator, The core company entity - root of the Company Graph., Coerce unrecognised system_type values to 'custom' so the model never crashes…, Company, Get a company by ID. Args: company_id: Company ID Returns: Company instance or… (+12 more)

### Community 176 - "test_failover_silent_exhaustion.py"
Cohesion: 0.06
...
### Community 179 - "services/background.py"
Cohesion: 0.07
Nodes (48): get_improvement_loop(), get_self_healing_agent(), get_trend_watcher(), agent/trend_watcher.py — Internet-connected AI trend intelligence. Fetches from…, set_trend_watcher(), _await_hermes_ready(), BackgroundServices, _env_float() (+40 more)
...
### Community 182 - "test_portfolio_intelligence.py"
Cohesion: 0.05
...
### Community 184 - "PatternConsolidation"
Cohesion: 0.08
...
### Community 185 - "test_slop_gate.py"
Cohesion: 0.07
...
### Community 186 - "ProviderRouter"
Cohesion: 0.05
Nodes (31): ProviderRouter, Any, RuntimeError, Parse a 429/503 ``Retry-After`` header → seconds, or None. Accepts either…, Translate an OpenAI chat/completions payload to Bedrock Converse format., Translate a Bedrock Converse API response to OpenAI chat.completion format., Priority-ordered LLM provider fallback with health checks and retries., main() (+23 more)

### Community 187 - "E2BAdapter"
Cohesion: 0.06
Nodes (38): E2BAdapter, Any, TaskResult, Declare ``E2B_API_KEY`` as a required env dependency. The base ``preflight``…, Execute a task inside a fresh E2B sandbox. Flow: 1. Open an…, Run ``pytest`` inside the sandbox. Returns ``(output, passed)``.…, Runtime adapter that executes tasks inside an E2B sandbox. Activation:…, _FakeAsyncSandboxClass (+30 more)

### Community 188 - "GoalRecord"
Cohesion: 0.07
...
### Community 192 - "ProvidersScreen.jsx"
Cohesion: 0.05
Nodes (30): createProvider(), deleteProvider(), getBrainProviders(), getLocalBrainState(), getProviderPolicy(), getRenderHealth(), getRenderOpsStatus(), postLocalBrainToggle() (+22 more)

### Community 193 - "anthropic_compat.py"
Cohesion: 0.09
...
### Community 200 - "run_audit"
Cohesion: 0.12
Nodes (19): _build_curl_cffi_fetcher(), get(), get_text(), head(), _sess(), _build_pdf(), findings_block(), hr() (+11 more)
...
### Community 207 - "test_unit6_resolve_component_model.py"
Cohesion: 0.05
...
### Community 208 - "test_classify_dependabot_update.py"
Cohesion: 0.07
...
### Community 209 - "WorkspaceManifest"
Cohesion: 0.08
...
### Community 210 - "test_executive_advisory.py"
Cohesion: 0.09
...
### Community 216 - "DirectChatSession"
Cohesion: 0.15
...
### Community 217 - "Part A — CodeRabbit review fixes for this PR (do first, small)"
Cohesion: 0.05
...
### Community 218 - "Docker Agent Runtimes Setup"
Cohesion: 0.05
...
### Community 219 - "TaskBoardScreen.jsx"
Cohesion: 0.06
...
### Community 221 - "test_schedule_backlog_drain.py"
Cohesion: 0.09
...
### Community 222 - "Persistent Memory System"
Cohesion: 0.05
...
### Community 225 - "TestRuntimeControl"
Cohesion: 0.05
...
### Community 226 - "LlmProviderConfig"
Cohesion: 0.13
...
### Community 230 - "[Unreleased]"
Cohesion: 0.05
Nodes (41): Added, Added, Added, Added, Added, Added, Added, Added (+33 more)

### Community 231 - "sync/service.py"
Cohesion: 0.14
...
### Community 234 - "skill_bindings.py"
Cohesion: 0.04
Nodes (58): ConsolidationPhase, MemoryKind, Enum, str, Dream Memory Consolidation — pattern consolidation across AI sessions. Inspired…, What kind of memory artifact this is., Current phase of the consolidation lifecycle., Enum (+50 more)

### Community 235 - "brain_availability_summary"
Cohesion: 0.06
Nodes (41): brain_failover_status(), brain_providers(), _openclaw_instructions(), openclaw_reverse_proxy(), openclaw_status(), openclaw_websocket(), api_route, websocket (+33 more)

### Community 236 - "gsap.min.js"
Cohesion: 0.06
...
### Community 239 - "test_scheduler_hydration_bounded.py"
Cohesion: 0.09
...
### Community 240 - "TestRecordUsageAndStats"
Cohesion: 0.05
...
Cohesion: 0.07
Nodes (24): auth_headers(), FakeTaskStore, MonkeyPatch, Task, tests/test_purge_backlog.py — 2026-07-03 crash-loop remediation. Covers: - POST…, The per-minute tick must requeue at most ONE blocked task, keep its…, Drive _maybe_boot_purge with fakes; return (purged, marker_writes). ``core``…, A failed purge must NOT record the nonce — it retries next boot. (+16 more)

### Community 242 - "mcp_registry.py"
Cohesion: 0.09
...
### Community 243 - "get_brain_config"
Cohesion: 0.05
Nodes (33): _brain_provider_status(), get_brain_policy_route(), _keepalive_self_ping(), lifespan(), _deferred_startup_cleanup(), _migrate_brain_to_safe_default(), Run the FreeBuff Telegram bot, restarting it on unexpected exit., Ping our own public URL so a free-tier web service doesn't sleep. Render free… (+25 more)
...
### Community 245 - "test_colibri_brain_shim.py"
Cohesion: 0.08
Nodes (30): parametrize, Regression test for the colibri env-shim in brain_policy.resolve_active_brain.…, `rstrip('/')` + re-append `/v1` must be idempotent across URL variants., Default to glm-5.2 when COLIBRI_MODEL/AGENT_LLM_MODEL both unset., AGENT_LLM_MODEL override wins when COLIBRI_MODEL is unset., BRAIN_PREFERENCE=colibri without COLIBRI_URL must log a loud warning., The `elif pref == "colibri": pass` records-bypass keeps a stale DB record…, Bypass-guard: BRAIN_PREFERENCE=colibri skips resolve_free_nvidia_brain entirely. (+22 more)
...
### Community 250 - "CompanyAgencyService"
Cohesion: 0.11
...
### Community 254 - "test_telegram_webhook.py"
Cohesion: 0.06
...
### Community 256 - "system_instruction"
Cohesion: 0.09
...
### Community 258 - "test_ephemeral_reaper.py"
Cohesion: 0.10
...
### Community 259 - "OrchestratorQueue"
Cohesion: 0.13
...
### Community 265 - "KnowledgeScreen.jsx"
Cohesion: 0.06
Nodes (28): autoRecommendCompanySkills(), createWikiPage(), deleteCompany(), deleteSource(), discoverRemoteSkills(), getCompanyGraph(), ingestSource(), listCompanies() (+20 more)

### Community 266 - "fmtErr"
Cohesion: 0.09
Nodes (21): fmtErr(), getDefaultBackendUrl(), getMe(), login(), logout(), App(), AppRoutes(), ProtectedRoute() (+13 more)

### Community 267 - "nvidia_models.py"
Cohesion: 0.08
...
### Community 269 - "local_brain_provider_config"
Cohesion: 0.29
...
Cohesion: 0.05
Nodes (52): _describe_http_status(), probe_model_liveness(), _probe_ollama(), _probe_openai_compat(), ProbeResult, BaseModel, services/brain_liveness.py — Provider liveness prober for the brain switcher.…, Probe an OpenAI-compatible provider (Cerebras / Groq / NIM / Z.ai / Aerolink). (+44 more)
...
Cohesion: 0.08
Nodes (37): free_nvidia_models(), FreeBuffAgent, Return the curated list of free NVIDIA NIM models FreeBuff may use., Codebuff-style coding agent pinned to free NVIDIA NIM models. FreeBuff is a…, List the free NVIDIA NIM models a user may pick (e.g. via Telegram)., True when *model* is in the curated free NVIDIA NIM set., is_rate_limit_exempt(), _rate_limit_exempt_key_ids() (+29 more)
...
### Community 276 - "call_llm"
Cohesion: 0.03
Nodes (59): _agent_timeout_fallback_response(), _append_agent_session_message(), _build_auto_skill_guidance(), _build_direct_chat_schedule_suggestion(), _build_direct_chat_tags(), _build_direct_chat_task_suggestion(), _build_provider_router(), _builtin_provider_records() (+51 more)

### Community 277 - "test_rate_limiter.py"
Cohesion: 0.20
...
### Community 281 - "test_persistent_memory.py"
Cohesion: 0.06
...
### Community 282 - "test_provider_enable_disable.py"
Cohesion: 0.07
...
### Community 283 - "test_sam_voice.py"
Cohesion: 0.06
...
### Community 284 - "AgentPlan"
Cohesion: 0.04
Nodes (39): DirectChatDoctor, PreflightIssue, PreflightReport, BaseModel, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, AgentPlan, AgentStep, test_agent_mode_queues_async_job() (+31 more)

### Community 285 - "test_operational_incidents.py"
Cohesion: 0.06
Nodes (31): Find agent phases that started but never finished.…, summarise_phases(), Recurring operational failures must diagnose and file themselves. The gap these…, The reported scenario, end to end: four real timeouts, one incident., Two timeouts an hour apart are not a pattern., Even many *distinct* failure modes cannot produce unbounded incidents. The…, `record` runs inside a logging.Handler — it must swallow everything., `_timed_phase` (#1218) brackets each call; a start with no end is the hang. (+23 more)

### Community 286 - "SecurityScanner"
Cohesion: 0.11
...
### Community 290 - "local_controller.py"
Cohesion: 0.12
...
### Community 291 - "test_brain_availability_doctor.py"
Cohesion: 0.10
...
### Community 294 - "test_nvidia_model_discovery.py"
Cohesion: 0.06
...
### Community 297 - "_resolve_user_github_token"
Cohesion: 0.09
...
### Community 299 - "Configuration Reference"
Cohesion: 0.06
...
### Community 304 - "test_v4_reliability.py"
Cohesion: 0.04
Nodes (39): make_isolated_workspace(), Path, agent/job_manager.py — Async agent job lifecycle manager. Manages agent jobs…, Create an isolated workspace directory under *root*. This is the legacy path…, _workspace_component(), Fail preflight when the provider extension is configured but missing. Without…, Any, Structured, actionable preflight validation issue. (+31 more)

### Community 305 - "test_live_server.py"
Cohesion: 0.22
...
### Community 306 - "_routing_candidates"
Cohesion: 0.09
...
### Community 307 - "ContextCompressor"
Cohesion: 0.11
...
### Community 310 - "ResourceWatchdog"
Cohesion: 0.10
...
### Community 313 - "RateLimitTracker"
Cohesion: 0.16
...
### Community 314 - "test_connector_registry.py"
Cohesion: 0.09
...
### Community 315 - "test_provider_render_env.py"
Cohesion: 0.09
...
### Community 318 - "Security Analysis — local-llm-server"
Cohesion: 0.06
...
### Community 324 - "OrchestratorCheckpointStore"
Cohesion: 0.12
...
### Community 325 - "test_telegram_mutating_commands.py"
Cohesion: 0.09
...
### Community 326 - "test_workspace_isolation.py"
Cohesion: 0.17
...
### Community 327 - "operational_incidents.py"
Cohesion: 0.11
Nodes (28): _diagnose_and_file(), _file_incident(), _format_incident(), gather_render_evidence(), get_operational_incident_tracker(), OperationalIncident, _phase_section(), Any (+20 more)

### Community 328 - "SkillLibrary"
Cohesion: 0.11
...
### Community 331 - "High-Agency Frontend Skill"
Cohesion: 0.06
Nodes (30): 10. FINAL PRE-FLIGHT CHECK, 1. ACTIVE BASELINE CONFIGURATION, 2. DEFAULT ARCHITECTURE & CONVENTIONS, 3. DESIGN ENGINEERING DIRECTIVES (Bias Correction), 4. CREATIVE PROACTIVITY (Anti-Slop Implementation), 5. PERFORMANCE GUARDRAILS, 6. TECHNICAL REFERENCE (Dial Definitions), 7. AI TELLS (Forbidden Patterns) (+22 more)

### Community 332 - "facade.py"
Cohesion: 0.07
...
### Community 335 - "test_platform_controls.py"
Cohesion: 0.09
...
### Community 337 - "session_retro.py"
Cohesion: 0.13
...
### Community 338 - "test_agency_fix.py"
Cohesion: 0.06
...
### Community 343 - "output_filter.py"
Cohesion: 0.07
...
### Community 345 - "analyze_page"
Cohesion: 0.12
Nodes (12): analyze_page(), fire(), BeautifulSoup, Run every page-scoped check against one HTML document (no network). Returns a…, _visible_text(), codes(), parametrize, TestBadPage (+4 more)
...
### Community 348 - "test_autonomy_gate.py"
Cohesion: 0.13
...
### Community 352 - "loop.py"
Cohesion: 0.05
Nodes (72): loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., # NOTE: "ollama_base" is kept for backwards compatibility; this runner only…, Charge sub-agent nesting depth and enforce the ``max_depth`` ceiling. Isolates…, build_governance_router(), approve(), _decide(), deny(), destroy_sandbox() (+64 more)

### Community 353 - "generate_context.py"
Cohesion: 0.12
...
### Community 354 - "test_phase5_doctor.py"
Cohesion: 0.11
...
### Community 355 - "control_registry.py"
Cohesion: 0.12
...
### Community 356 - "SteeringInjector"
Cohesion: 0.11
...
### Community 357 - "parse_event_stream"
Cohesion: 0.15
...
### Community 358 - "test_claude_setup_audit.py"
Cohesion: 0.16
...
Cohesion: 0.11
Nodes (19): Background dispatcher for task execution., Re-queue BLOCKED tasks that have cooled down and are ready for retry., Polls for queued task work and executes it through the coordinator. Crash…, Re-queue tasks stranded by a prior crash or hard-kill., TaskDispatcher, _make_task(), asyncio, Task (+11 more)
...
### Community 370 - "SetupWizardPage.js"
Cohesion: 0.10
...
### Community 371 - "ProviderConsole.jsx"
Cohesion: 0.08
...
### Community 377 - "test_regression.py"
Cohesion: 0.10
...
### Community 381 - "test_executive_advisory_api.py"
Cohesion: 0.11
Nodes (19): AdviceResult, ExecOpinion, One executive's answer to the question., The full advisory response: per-executive opinions plus the synthesis., _make_app(), _fake_get_current_user(), FastAPI, tests/test_executive_advisory_api.py — auth and behaviour for… (+11 more)

### Community 382 - "SprintMetrics"
Cohesion: 0.10
...
### Community 383 - "build_render_router"
Cohesion: 0.14
...
### Community 384 - "Deploy: FreeBuff Telegram bot (24×7)"
Cohesion: 0.07
...
### Community 385 - "Claude Code + Qwen Local Setup"
Cohesion: 0.07
...
### Community 387 - "test_nvidia_default_model.py"
Cohesion: 0.17
...
### Community 389 - "executive_advisory_api.py"
Cohesion: 0.11
...
### Community 390 - "run_trend_analysis"
Cohesion: 0.18
...
### Community 392 - "get_current_user"
Cohesion: 0.10
Nodes (24): _get_current_user_thunk(), _get_optional_user_thunk(), Request, get_current_user(), get_optional_user(), Get user if authenticated, otherwise return None (for public endpoints)., client(), _coding_brain_check() (+16 more)

### Community 393 - "Performance Analysis — local-llm-server"
Cohesion: 0.08
...
### Community 394 - "LLM Router — troubleshooting"
Cohesion: 0.08
...
### Community 397 - "test_agent_free_brain.py"
Cohesion: 0.05
...
### Community 401 - "test_brain_migration_writes_a_live_model.py"
Cohesion: 0.10
...
### Community 402 - "test_daily_automation_2026_08_03.py"
Cohesion: 0.11
...
### Community 405 - "TestStreamableHTTPTransport"
Cohesion: 0.12
...
### Community 406 - "test_dashboard_cache.py"
Cohesion: 0.06
Nodes (32): _cached(), _check_storage_health(), cost_attribution_stats(), doctor_health(), _fast_count(), get_active_provider(), get_activity(), get_stats() (+24 more)

### Community 407 - "1. The Rules"
Cohesion: 0.08
...
### Community 409 - "Session Handoff — 2026-06-15"
Cohesion: 0.08
...
### Community 410 - "TASK 4 — End-to-end approval-gate test"
Cohesion: 0.08
...
### Community 412 - "SeoCheckDefinition"
Cohesion: 0.11
...
### Community 413 - "test_north_mini_code.py"
Cohesion: 0.10
...
### Community 418 - "test_memory_guard.py"
Cohesion: 0.13
...
### Community 419 - "NIMConnectionPool"
Cohesion: 0.11
...
### Community 420 - "TemporalContextGraph"
Cohesion: 0.10
...
### Community 421 - "test_telegram_approval_e2e.py"
Cohesion: 0.12
...
### Community 422 - "test_activation_api.py"
Cohesion: 0.13
...
### Community 423 - "TestClassifyPlainText"
Cohesion: 0.08
...
### Community 424 - "ensure_self_company"
Cohesion: 0.06
Nodes (36): autonomy_status(), Public autonomy readiness probe — no authentication required. A live deploy…, _count_specialists(), _create_company_directly(), ensure_self_company(), _find_self_company(), _find_stale_self_companies(), _list_companies_safe() (+28 more)

### Community 425 - "test_service_token.py"
Cohesion: 0.08
...
### Community 426 - "test_telegram_diag_endpoint.py"
Cohesion: 0.08
...
### Community 430 - "OperationalIncidentTracker"
Cohesion: 0.09
Nodes (18): _iso_from_monotonic(), OperationalIncidentTracker, Count operational failures; diagnose and file the ones that persist. Every…, Start with no tracked signatures and no filing history., Note one operational failure. Returns True when it filed an incident. Called…, Reconcile the admission granted in ``_may_file`` with what happened. Admission…, Live counters, for the diagnostics endpoint and tests., Drop all state. Used by tests. (+10 more)

### Community 431 - "Findings"
Cohesion: 0.08
...
### Community 432 - "build_platform_controls_router"
Cohesion: 0.15
...
### Community 433 - "Local AI Stack with Docker"
Cohesion: 0.08
...
### Community 438 - "Native operations"
Cohesion: 0.09
...
### Community 440 - "WindowsServiceManager"
Cohesion: 0.17
...
### Community 441 - "test_task_source_id_race.py"
Cohesion: 0.12
...
### Community 443 - "test_onboarding_provisioning.py"
Cohesion: 0.12
Nodes (23): Result of a website scan with detected systems and stack inference., Inferred technology stack from website/repo analysis., StackInference, WebsiteScanResult, Scan a Git repository and detect its technology stack. Args: repo_url: URL of…, Detect the Git provider from a repository URL. Args: repo_url: Repository URL…, Infer stack from repository URL (basic detection). Args: repo_url: Repository…, _ds() (+15 more)
...
Cohesion: 0.18
Nodes (21): Browser admin UI for login, service control, key management, and diagnostics., Update or append a KEY=value line in the .env file., register_admin_gui(), dashboard(), diag_langfuse(), _guest_redirect(), login_page(), login_submit() (+13 more)
...
### Community 447 - "TestSelfHealingInfrastructureClassification"
Cohesion: 0.19
...
### Community 448 - "_status_snapshot"
Cohesion: 0.15
...
### Community 449 - "openclaw_str_e_fix.py"
Cohesion: 0.15
...
### Community 450 - "Agent Governance Guide"
Cohesion: 0.09
...
### Community 451 - "The fifteen strategies"
Cohesion: 0.09
...
### Community 457 - "DecisionsStore"
Cohesion: 0.30
Nodes (3): DecisionsStore, Any, Connection

### Community 458 - "ProviderCircuit"
Cohesion: 0.13
...
### Community 459 - "SyntheticDataPipeline"
Cohesion: 0.13
...
### Community 460 - "telegram_service.py"
Cohesion: 0.12
...
### Community 462 - "test_cerebras_catalogue.py"
Cohesion: 0.13
...
### Community 463 - "compare_runtimes.py"
Cohesion: 0.06
...
### Community 467 - "HarnessEnrichment"
Cohesion: 0.14
...
### Community 468 - "open_phase_report"
Cohesion: 0.15
...
### Community 470 - "AdaptivePermissions"
Cohesion: 0.18
...
### Community 471 - ".on_task_complete"
Cohesion: 0.11
...
### Community 476 - "ClaudeCodeAdapter"
Cohesion: 0.20
...
### Community 479 - "PriorityTaskQueue"
Cohesion: 0.14
...
### Community 480 - "TestLegacyRouterCacheTTL"
Cohesion: 0.13
...
### Community 481 - "test_anthropic_refusal_fallback.py"
Cohesion: 0.19
...
### Community 482 - "test_kimi_bridge_server.py"
Cohesion: 0.12
...
### Community 485 - ".__init__"
Cohesion: 0.20
Nodes (4): Acquire the exclusive async lock for *ws*. Raises :exc:`WorkspaceLockError` if…, WorkspaceLockError, WorkspaceManifestError, WorkspaceNotFoundError

### Community 486 - "V3 API Migration Plan — LLM Relay Platform"
Cohesion: 0.10
...
Cohesion: 0.27
Nodes (8): _configure(), _default(), main(), Entry point for the always-on FreeBuff Telegram bot (Render worker / Docker).…, Set an env var only when the operator hasn't already provided one., run_bot(), TELEGRAM_POLLER_DISABLED=true makes run_bot() idle WITHOUT long-polling…, test_run_bot_skips_polling_when_disabled()

### Community 490 - "_process_task_callback"
Cohesion: 0.13
...
### Community 492 - "SQLiteStore"
Cohesion: 0.03
Nodes (65): DetectedSystem, A business system detected on a company's website or in their stack., Get the most confident evidence description., Create a new company in SQLite., Get a company by ID from SQLite., Update a company in SQLite., Delete a company and all associated data from SQLite., List companies from SQLite. (+57 more)

### Community 493 - "test_local_controller.py"
Cohesion: 0.14
...
### Community 494 - "test_openclaw_str_e_fix.py"
Cohesion: 0.10
...
### Community 495 - "all_provider_ids"
Cohesion: 0.05
Nodes (35): all_provider_ids(), get_provider_tier(), _provider_ids_from_literal(), Return the tier (``free`` / ``paid`` / ``local``) for *provider*. Returns…, Return every provider id recognised by the brain config system. Iterates the…, Return the provider ids allowed by the ``BrainProvider`` Literal. Reads the…, test_all_provider_ids_returns_literal_args(), test_get_provider_tier_known() (+27 more)

### Community 496 - "test_voice_pipeline.py"
Cohesion: 0.13
...
### Community 504 - "Docker AI Governance Audit — Final Report"
Cohesion: 0.10
...
### Community 505 - "1. Capability-by-capability"
Cohesion: 0.10
...
### Community 508 - "ControlsScreen.jsx"
Cohesion: 0.15
...
Cohesion: 0.09
Nodes (26): build_matrix(), _families(), main(), Any, scripts/generate_specialist_skill_matrix.py — Specialist × Skill matrix.…, Map family -> sorted list of test files that mention it (quoted token)., Return one row per family, derived entirely from code., render_markdown() (+18 more)

### Community 513 - "Provider"
Cohesion: 0.05
Nodes (37): Ollama provider adapter — local LLM inference., packages.ai — provider abstraction, model registry, and failover manager., ProviderManager, Any, packages/ai/manager.py — ProviderManager. Single entry point for all LLM calls.…, Coordinates provider selection, failover, and health., Return providers sorted by priority (lowest = highest priority)., Send a chat request with automatic failover. Retry policy: 1. If ``model`` is… (+29 more)
...
### Community 518 - "TestBrainFailoverModelUpdates"
Cohesion: 0.18
...
### Community 520 - "test_tasks_cache_ttl_env.py"
Cohesion: 0.21
...
### Community 523 - "SamAgent"
Cohesion: 0.15
Nodes (11): Any, SAM voice agent — the voice-controlled interface to the agency., Process a voice command and return SAM's spoken response. Args: text: The…, Public snapshot of live agency state (used by the LiveKit worker tools)., Gather live agency state for SAM's situational awareness., Call the NVIDIA NIM LLM (free tier) for SAM's response., Rule-based fallback when the LLM is unavailable., SamAgent (+3 more)

### Community 524 - "scheduler.py"
Cohesion: 0.13
...
### Community 525 - "_extract_tech_relevance"
Cohesion: 0.17
...
### Community 529 - "Skill: fabric-patterns"
Cohesion: 0.11
...
### Community 530 - "Analysis & Synthesis Instructions"
Cohesion: 0.11
Nodes (18): 1. Define the Atmosphere, 2. Map the Color Palette, 3. Establish Typography Rules, 4. Define the Hero Section, 5. Describe Component Stylings, 6. Define Layout Principles, 7. Define Responsive Rules, 8. Encode Motion Philosophy (+10 more)

### Community 531 - "Production Readiness Assessment — local-llm-server"
Cohesion: 0.11
...
### Community 533 - "Skill: fabric-patterns"
Cohesion: 0.11
Nodes (18): 1. Ensure Pattern Directory Exists, 2. List Available Patterns, 3. Retrieve a Pattern, 4. Apply a Pattern with Variables, 5. Stitch Patterns Together, 6. Create New Patterns, Acceptance Checks, Directory Structure (+10 more)
...
### Community 536 - "Admin Dashboard Guide"
Cohesion: 0.11
...
### Community 537 - "Implementation Plan"
Cohesion: 0.11
...
### Community 539 - "TestOrchestratorQueue"
Cohesion: 0.13
...
### Community 540 - "scripts/doctor.py"
Cohesion: 0.27
Nodes (17): NamedTuple, Check, check_core_deps(), check_env(), check_git(), check_mongo(), check_node(), check_ollama() (+9 more)

### Community 541 - "audit"
Cohesion: 0.11
Nodes (15): audit(), get_audit_log(), Any, Request, FastAPI dependency: require any authenticated user., Append an audit log entry. Never logs raw secrets — only secret IDs / masked…, Return recent audit log entries, newest first. Supports filtering by user_id,…, require_authenticated() (+7 more)

### Community 542 - "control_overrides.py"
Cohesion: 0.09
...
### Community 543 - "Delegation Plan (agent-ready work packages)"
Cohesion: 0.11
...
### Community 547 - "test_autonomy_pipeline_regressions.py"
Cohesion: 0.11
...
### Community 548 - "test_autonomy_status.py"
Cohesion: 0.11
...
### Community 549 - "test_brain_patch_service_token.py"
Cohesion: 0.18
...
### Community 550 - "TestMCPToolsListCache"
Cohesion: 0.15
...
### Community 551 - "test_fabric_patterns.py"
Cohesion: 0.11
...
### Community 552 - "test_freebuff_bot.py"
Cohesion: 0.12
...
### Community 554 - "test_task_pre_execution_gate.py"
Cohesion: 0.24
...
### Community 556 - "validate_session_id"
Cohesion: 0.16
...
### Community 557 - "handle_workflow_ide_chat"
Cohesion: 0.17
...
### Community 558 - "ErrorInterceptorMiddleware"
Cohesion: 0.18
...
### Community 559 - "agent/workspace.py"
Cohesion: 0.23
Nodes (15): _get_workspace_lock(), get_workspace_manager(), _load_workspace(), BaseModel, Enum, Lock, Path, str (+7 more)
...
### Community 561 - "agile_sprints.py"
Cohesion: 0.14
...
### Community 563 - "Comprehensive Skill Index (By Category)"
Cohesion: 0.11
...
### Community 564 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 565 - "Component Map"
Cohesion: 0.11
...
### Community 567 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
...
### Community 568 - "Platform Guide — the full tour"
Cohesion: 0.11
...
### Community 570 - "Part A — Health Report"
Cohesion: 0.11
...
### Community 573 - "router/health.py"
Cohesion: 0.16
...
### Community 580 - "test_company_api.py"
Cohesion: 0.11
...
### Community 581 - "test_daily_automation_2026_07_11.py"
Cohesion: 0.14
...
### Community 582 - "test_monitor_lib.py"
Cohesion: 0.15
...
### Community 583 - "TestStopSlopChecker"
Cohesion: 0.11
...
### Community 588 - "WorkspaceManager"
Cohesion: 0.19
...
### Community 589 - "cowork_session.py"
Cohesion: 0.15
...
### Community 590 - "SKILL: Industrial Brutalism & Tactical Telemetry UI"
Cohesion: 0.12
...
### Community 591 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 592 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 593 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 596 - "test_brain_failover_413.py"
Cohesion: 0.13
...
### Community 598 - "kimi_bridge_provider_config"
Cohesion: 0.18
...
### Community 604 - "test_frontend_deployment_guards.py"
Cohesion: 0.18
...
### Community 605 - "test_health_endpoints.py"
Cohesion: 0.17
...
### Community 606 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 607 - "test_openclaw_endpoints.py"
Cohesion: 0.12
...
### Community 608 - "test_skill_registry.py"
Cohesion: 0.13
...
### Community 610 - "TestRouterIntegration"
Cohesion: 0.21
...
### Community 611 - "test_tasks_reconciler_todo_requeue.py"
Cohesion: 0.20
...
### Community 612 - "hermes_prompt.py"
Cohesion: 0.19
...
### Community 613 - "MemoryMiddleware"
Cohesion: 0.17
...
### Community 615 - "Skill: repowise-intelligence"
Cohesion: 0.12
...
### Community 616 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
...
### Community 619 - "The 10-Step Workflow"
Cohesion: 0.12
...
### Community 620 - "Contributing to local-llm-server"
Cohesion: 0.12
...
### Community 621 - "refresh_agent_built_proof.py"
Cohesion: 0.20
...
### Community 622 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 623 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 625 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
...
### Community 626 - "ChatResponse"
Cohesion: 0.06
Nodes (14): CerebrasProvider, Cerebras provider adapter — free, fast LLM (qwen-3-coder-480b)., GroqProvider, Groq provider adapter — free, fast LLM (deepseek-r1-distill-llama-70b)., NvidiaProvider, NVIDIA NIM provider adapter — wraps the existing provider_router logic. This is…, NVIDIA NIM — free LLM provider (meta/llama-3.3-70b-instruct)., OllamaProvider (+6 more)

### Community 627 - "GeminiProvider"
Cohesion: 0.30
...
### Community 633 - "telegram_inbound_handlers.py"
Cohesion: 0.07
Nodes (44): get_decisions_store(), Process-wide DecisionsStore singleton (resettable via db_path arg)., classify_plain_text(), is_sensitive(), services/inbound_router.py Helpers for the Telegram inbound router. Three small…, True when the message exceeds the delivered-character budget. Uses…, Write ``text`` to a deterministic paste file and return its path. Writes under…, Return a Markdown-v1-safe preview string under ``max_chars``. Used by the… (+36 more)
...
### Community 635 - "weekly_digest.py"
Cohesion: 0.13
...
### Community 636 - "test_setup_api.py"
Cohesion: 0.21
...
### Community 637 - "test_agency_workflows_carry_the_failover_chain.py"
Cohesion: 0.18
...
### Community 638 - "test_scanner_live.py"
Cohesion: 0.23
...
### Community 640 - "test_langfuse_agency_wide.py"
Cohesion: 0.11
...
### Community 641 - "test_local_brain_state.py"
Cohesion: 0.12
...
### Community 645 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 646 - "test_refresh_agent_built_proof.py"
Cohesion: 0.12
...
### Community 650 - "CollaborationContext"
Cohesion: 0.17
...
### Community 651 - "Skill: agent-harness"
Cohesion: 0.13
...
### Community 652 - "Skill: checkpoint-strategy"
Cohesion: 0.13
...
### Community 654 - "Skill: local-ai-query"
Cohesion: 0.13
...
### Community 655 - "Skill: parallel-agents"
Cohesion: 0.13
...
### Community 656 - "Skill: parallel-worktrees"
Cohesion: 0.13
...
### Community 657 - "Design System: Taste Standard"
Cohesion: 0.13
...
### Community 659 - "test_new_features_e2e.py"
Cohesion: 0.26
...
### Community 661 - "Skill: user-research"
Cohesion: 0.13
...
### Community 662 - "Separate hosted dashboard backend (`backend/server.py`)"
Cohesion: 0.13
...
### Community 663 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 664 - "Attention Mechanisms Internals"
Cohesion: 0.13
...
### Community 665 - "_push_down_where"
Cohesion: 0.14
...
### Community 668 - "test_critical_flows.py"
Cohesion: 0.26
...
### Community 671 - "TestBrainConfigUpdates"
Cohesion: 0.22
...
### Community 672 - "DecisionsStoreTests"
Cohesion: 0.13
...
### Community 673 - "test_dockerfile_ships_config_dir.py"
Cohesion: 0.14
...
### Community 674 - "test_daemon_restart_reprobes_http_port_only"
Cohesion: 0.13
...
### Community 675 - "classify_direct_chat_intent"
Cohesion: 0.23
...
### Community 680 - "test_telegram_task_callback.py"
Cohesion: 0.23
Nodes (11): _parked_task(), asyncio, Task, Telegram inline-button callbacks for the task pre-execution gate. Regression:…, A non-admin tapping Approve must get a modal (show_alert), not silence.…, store(), test_approve_button_approves_and_requeues(), test_callback_parser_routes_task_prefix() (+3 more)

### Community 681 - "test_ai_insights.py"
Cohesion: 0.20
...
### Community 684 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 688 - "Checks Performed"
Cohesion: 0.14
...
### Community 689 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 690 - "get_workflow_orchestrator"
Cohesion: 0.06
Nodes (44): _build_payload_or_500(), _check_secret(), _expected_secret(), preview_digest_endpoint(), Any, get, post, Dry-run: same auth, returns the would-be markdown body but does NOT dispatch to… (+36 more)

### Community 691 - "Skill: branch-cleanup"
Cohesion: 0.14
...
### Community 692 - "Skill: perplexity — Web Research via Perplexity API"
Cohesion: 0.14
...
### Community 695 - "Quick-Note Issues Processing Summary"
Cohesion: 0.14
...
### Community 696 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 698 - "Render MCP — autonomous platform debugging and environment monitoring"
Cohesion: 0.14
...
### Community 699 - "Runbook: Auto-Resume After Cooldown / Interruption"
Cohesion: 0.14
...
### Community 700 - "SEO / GEO / AIO Audit Engine"
Cohesion: 0.14
...
### Community 701 - "Traffic Distribution Across Providers"
Cohesion: 0.14
...
### Community 703 - "_is_ephemeral_user"
Cohesion: 0.27
...
### Community 706 - "_parse_reset_epoch"
Cohesion: 0.33
...
### Community 707 - "flesch_reading_ease"
Cohesion: 0.20
...
### Community 708 - "extract_failures"
Cohesion: 0.21
...
### Community 709 - "test_p0_roadmap_b3_b4_b5.py"
Cohesion: 0.21
...
### Community 710 - "TestAuthAndTaskCreation"
Cohesion: 0.17
...
### Community 712 - "test_wrapper_falls_back_to_installed_model"
Cohesion: 0.19
...
### Community 713 - "TestAnthropicToolListCaching"
Cohesion: 0.34
...
### Community 714 - "test_changelog_check_workflow.py"
Cohesion: 0.21
...
### Community 716 - "_StubManager"
Cohesion: 0.14
Nodes (3): _apply(), Minimal stand-in for BrainFailoverManager., _StubManager

### Community 717 - ".test_set_github_token_sqlite_string_id_does_not_500"
Cohesion: 0.16
...
### Community 720 - "test_openclaw_gateway.py"
Cohesion: 0.14
...
### Community 721 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 723 - "AGENTS.md — Codebase Map & Operations Reference"
Cohesion: 0.15
...
### Community 748 - "ApplyReviewAgent"
Cohesion: 0.22
...
### Community 750 - "test_daily_digest.py"
Cohesion: 0.24
Nodes (8): Test-only: clears the cached singleton so the next get_decisions_store() builds…, reset_decisions_store_singleton(), _fresh_stores(), Any, tests/test_daily_digest.py — Coverage for the daily review aggregator and…, _tmp_db_path(), _fresh_store(), tests/test_decisions_store.py — Coverage for the generic decision store. Each…

### Community 752 - "_Budget"
Cohesion: 0.15
...
### Community 753 - "TestNoNvidiaFallbackIsRetired"
Cohesion: 0.22
...
### Community 754 - "_start_ceo_agency"
Cohesion: 0.27
...
### Community 755 - "TestPoliciesGovernanceStableClaim"
Cohesion: 0.20
...
### Community 757 - "Agent Transparency Report"
Cohesion: 0.15
...
### Community 758 - "_get_provider_policy"
Cohesion: 0.21
...
### Community 761 - "test_compose_and_coordinate_api.py"
Cohesion: 0.21
...
### Community 762 - "TestModelCostTableUpdates"
Cohesion: 0.26
...
### Community 763 - "TestDecisionsBotLinks"
Cohesion: 0.17
...
### Community 765 - "TestKillSwitchDurability"
Cohesion: 0.15
...
### Community 766 - "test_providers_live_e2e.py"
Cohesion: 0.24
...
### Community 769 - "skill_registry.py"
Cohesion: 0.17
...
### Community 771 - "test_autonomous_agency_e2e.py"
Cohesion: 0.09
...
### Community 780 - "build_admin_local_brain_router"
Cohesion: 0.24
...
### Community 781 - "connectors_api.py"
Cohesion: 0.21
...
### Community 785 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 787 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 788 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 790 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 791 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 792 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 796 - "TestPolicyAuthoringUiStableClaim"
Cohesion: 0.22
...
### Community 797 - "install-agents.sh"
Cohesion: 0.39
...
### Community 798 - "check_container_posture.py"
Cohesion: 0.26
...
### Community 799 - "test_pytest_failure_parser.py"
Cohesion: 0.23
...
### Community 801 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 804 - "test_agile_api.py"
Cohesion: 0.17
...
### Community 805 - "test_app_settings.py"
Cohesion: 0.21
...
### Community 806 - "test_brain_default_consistency.py"
Cohesion: 0.24
...
### Community 809 - "test_gh_brain_failover.py"
Cohesion: 0.17
...
### Community 810 - "test_provider_state_durability.py"
Cohesion: 0.09
...
### Community 818 - "_extractive_compress"
Cohesion: 0.18
...
### Community 822 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 825 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 826 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 828 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 831 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 832 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 833 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 834 - "2. Critical Bugs & Exact Detection Signatures"
Cohesion: 0.18
...
### Community 835 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 837 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 838 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 839 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 841 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 842 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 843 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 844 - "CI Troubleshooting Runbook"
Cohesion: 0.18
...
### Community 845 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 846 - "What to clean up"
Cohesion: 0.18
...
### Community 847 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 848 - "test_bedrock_live.py"
Cohesion: 0.25
...
### Community 849 - "_parse_tool_calls_from_response"
Cohesion: 0.43
...
### Community 850 - "test_daily_automation_2026_07_09.py"
Cohesion: 0.25
...
### Community 851 - "build_tech_db.py"
Cohesion: 0.35
...
### Community 852 - "migrate_local_brain_env.py"
Cohesion: 0.25
...
### Community 853 - "test_conftest_hermetic_env.py"
Cohesion: 0.18
...
### Community 854 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 855 - "test_event_log.py"
Cohesion: 0.45
...
### Community 856 - "TestZeroAttemptDiagnostics"
Cohesion: 0.25
...
### Community 857 - "test_google_provider_models.py"
Cohesion: 0.18
...
### Community 859 - "TestOneIdCanBelongToSeveralProviders"
Cohesion: 0.39
...
### Community 864 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 865 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 868 - "_normalize_tool_choice"
Cohesion: 0.31
...
### Community 869 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 875 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 878 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 879 - "Competitor Analysis — Autonomous AI Agency"
Cohesion: 0.20
...
### Community 880 - "Issue #1427: quick-note:https://github.com/bingreeky/JIT"
Cohesion: 0.20
...
### Community 881 - "LLM Router — configuration guide"
Cohesion: 0.20
...
### Community 882 - "LLM Router — provider guide"
Cohesion: 0.20
...
### Community 883 - "One command (recommended)"
Cohesion: 0.20
...
### Community 884 - "ENGINEERING_STANDARDS.md — Patterns & Reference"
Cohesion: 0.20
...
### Community 888 - "RuntimeManager"
Cohesion: 0.05
Nodes (21): CircuitState, Return the last-known health for *runtime_id* (may be stale)., Return True if the runtime is available (not circuit-open)., Return health snapshots for all known runtimes., Force an immediate health check of all runtimes and return results., Attempt to start a dead runtime subprocess before re-probing. Uses the local…, Reduce probe frequency for runtimes that have never come online., Async health polling service for all registered runtimes. (+13 more)

### Community 889 - "enrich_quick_note_issues.py"
Cohesion: 0.36
...
### Community 891 - "TestDisabledProvidersAreNotFalselyReportedUnreachable"
Cohesion: 0.22
...
### Community 892 - "TestTheWorkflowIsSafeAndReadOnly"
Cohesion: 0.20
...
### Community 893 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 898 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.25
...
### Community 900 - "test_workflow_api_mount.py"
Cohesion: 0.20
...
### Community 906 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 909 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 912 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 913 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 915 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
Nodes (8): Branch, Components, Purpose, Quick Start, Session Roles, Skill: cowork-session (Claude Cowork), Testing, When to Use

### Community 916 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 917 - "Active Task Tracker"
Cohesion: 0.22
...
### Community 919 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 920 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 921 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 923 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 924 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 925 - "Release Procedure"
Cohesion: 0.22
...
### Community 926 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 929 - "_get_current_user"
Cohesion: 0.25
...
### Community 930 - "_control_state"
Cohesion: 0.33
Nodes (7): _control_state(), effective_value(), The value *spec* currently resolves to, following override → env → default., Where the effective value came from: ``override``, ``environment``, or…, One control's spec plus its current value, source, and dependency state., value_source(), test_effective_value_follows_override_then_env_then_default()
...
### Community 938 - "test_probe_base_url_override_hits_the_typed_url"
Cohesion: 0.22
...
### Community 939 - ".test_every_request_carries_a_real_user_agent"
Cohesion: 0.22
...
### Community 940 - "test_changelog_parity_guard.py"
Cohesion: 0.22
...
### Community 941 - "test_daemon_picks_colibri_8081_when_only_it_listening"
Cohesion: 0.22
...
### Community 943 - "test_process_quick_note_workflow.py"
Cohesion: 0.25
...
### Community 944 - "TestEveryFullSuiteJobHasMongo"
Cohesion: 0.22
...
### Community 945 - "TestPaidPolicyDurability"
Cohesion: 0.22
...
### Community 946 - "test_scanner_deps_parity.py"
Cohesion: 0.31
...
### Community 947 - "test_serve_spa_prefixes.py"
Cohesion: 0.31
...
### Community 956 - ".transition"
Cohesion: 0.33
Nodes (4): _iso_now(), _iso_offset_hours(), Update *ws* status and persist the manifest., Update last_heartbeat timestamp and persist.

### Community 957 - "quality_checker.py"
Cohesion: 0.32
...
### Community 959 - "TestAgentRunnerExecution"
Cohesion: 0.33
...
### Community 970 - "AGENTS.md — AI Agent Configuration for local-llm-server"
Cohesion: 0.25
...
### Community 971 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 972 - "ceo-micromanagement.md"
Cohesion: 0.25
Nodes (4): P0 behavior change, Readiness contract, Runtime model, Runtime types

### Community 973 - "Feature Maturity / Support Matrix"
Cohesion: 0.25
...
### Community 976 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.25
...
### Community 991 - "Issue #504: EPIC: Autonomy hardening — live-verified defects 2026-06-10"
Cohesion: 0.25
...
### Community 1004 - "Positional Encoding Internals"
Cohesion: 0.25
...
### Community 1005 - "Platform Controls"
Cohesion: 0.25
...
### Community 1007 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 1008 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 1009 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 1010 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 1015 - "security_fix_agent.py"
Cohesion: 0.46
...
### Community 1020 - "crispy_burn_in.py"
Cohesion: 0.36
...
### Community 1025 - "TestItIsNotBuiltForOneVendor"
Cohesion: 0.25
...
### Community 1027 - "test_local_brain_router_smoke.py"
Cohesion: 0.25
...
### Community 1028 - "test_mcp_protocol_version.py"
Cohesion: 0.25
...
### Community 1030 - "test_provider_models_db_outage.py"
Cohesion: 0.25
...
### Community 1031 - "RuntimeHealth"
Cohesion: 0.07
Nodes (19): Check whether Docker is available and report the adapter's runtime health.…, Available iff config resolves AND the SDK is importable. Never raises — a…, Health status snapshot for a runtime., Return a health snapshot. Must not raise; return available=False instead., RuntimeHealth, Some runtimes awake, some sleeping — both reported correctly., test_wake_all_sleeping_runtimes_mixed_state(), _poll() (+11 more)

### Community 1032 - "test_nuclear_cleanup_targets_the_schedule_collection"
Cohesion: 0.25
...
### Community 1036 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 1051 - "Skill: hybrid-reasoning (Hybrid AI)"
Cohesion: 0.29
Nodes (6): Branch, Components, Purpose, Quick Start, Skill: hybrid-reasoning (Hybrid AI), Testing

### Community 1052 - "Karpathy Guidelines Skill"
Cohesion: 0.29
...
### Community 1065 - "Implementation plan + TO-DO (check off as you go)"
Cohesion: 0.29
...
### Community 1078 - "check_changelog_parity.py"
Cohesion: 0.43
...
### Community 1079 - "check_doc_images.py"
Cohesion: 0.48
...
### Community 1082 - "test_daily_2026_06_14.py"
Cohesion: 0.38
...
### Community 1084 - "TestReasonsAreActionable"
Cohesion: 0.29
...
### Community 1085 - "TestProvidersScreen"
Cohesion: 0.43
...
### Community 1086 - "TestMongoService"
Cohesion: 0.29
...
### Community 1092 - "InitiativeProgress"
Cohesion: 0.33
...
### Community 1093 - "Music Cues: happy-beats-business-moves-vol-1-by-ende-dot-app"
Cohesion: 0.33
...
### Community 1108 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 1109 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 1110 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 1111 - "The full agent capability roster"
Cohesion: 0.33
...
### Community 1112 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 1113 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 1114 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 1120 - "apply_phase1_changes.py"
Cohesion: 0.33
...
### Community 1157 - "Who is this for?"
Cohesion: 0.40
...
### Community 1159 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 1160 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 1161 - "Runtime troubleshooting"
Cohesion: 0.40
Nodes (4): Agent mode timeout, Missing binary / task harness, Runtime troubleshooting, Workspace validation failures

### Community 1165 - "knowledgeGraphTab.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 1166 - "loginFlowNoTimeout.test.js"
Cohesion: 0.40
Nodes (4): apiSource, { describe, test, expect }, fs, path

### Community 1167 - "test_company_stale_id_recovery.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 1168 - "worker_no_cache.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, workerSource

### Community 1169 - "model_discovery.py"
Cohesion: 0.12
Nodes (20): cached_models(), dead_models(), discover_models(), _fresh_entry(), _models_url(), _parse_ids(), Any, Ask a provider which models the configured API key may actually use.… (+12 more)

### Community 1171 - "governance/__init__.py"
Cohesion: 0.40
Nodes (3): __getattr__(), Any, packages/governance — agent identity, policy, approvals, audit, sandboxes. The…

### Community 1172 - "inspect-agent-runtime.sh"
Cohesion: 0.60
Nodes (3): fail(), inspect-agent-runtime.sh script, usage()

### Community 1173 - "Prompt Library Changelog"
Cohesion: 0.40
Nodes (4): Added, Format, Prompt Library Changelog, [Unreleased]

### Community 1174 - "Proof"
Cohesion: 0.40
...
### Community 1175 - "_add_colibri_shim_changelog_entry.py"
Cohesion: 0.50
...
### Community 1176 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1177 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1178 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 1179 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 1180 - "setup_colibri.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1181 - "setup_colibri.sh script"
Cohesion: 0.70
Nodes (4): setup_colibri.sh script, fail(), ok(), warn()

### Community 1182 - "status_colibri_server.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1184 - "start_tunnel.py"
Cohesion: 0.50
...
### Community 1188 - "nvidia_live_test.py"
Cohesion: 0.40
...
### Community 1191 - "test_a_failed_filing_releases_the_cooldown_so_the_next_recurrence_retries"
Cohesion: 0.40
...
### Community 1194 - "TestGhIsNotReAuthenticated"
Cohesion: 0.40
...
### Community 1237 - "test_no_exception_detail_leaks.py"
Cohesion: 0.50
...
### Community 1238 - "test_a_scheduled_diagnosis_is_held_until_it_completes"
Cohesion: 0.67
...
### Community 1240 - "test_skills_route_order.py"
Cohesion: 0.67
...
### Community 1243 - "github"
Cohesion: 0.50
Nodes (3): github, enabled, silent

### Community 1250 - "Configuration reference"
Cohesion: 0.67
Nodes (3): Configuration reference, Provider priority chain, Running the brain on local Ollama (via a tunnel)

### Community 1272 - "test_the_reserve_is_bounded_when_read_from_the_environment"
Cohesion: 0.67
...
- **Why does `_fixture()` connect `_fixture` to `TaskStore`, `llm/router.py`, `test_mcp_protocol_version.py`, `test_ping.py`, `RuntimeHealth`, `brain_config.py`, `_inline_threads`, `PolicyEngine`, `captured`, `test_llm_router_strategies.py`, `test_llm_router_queue_cache.py`, `Task`, `UsageEvent`, `test_model_router.py`, `Agency`, `E2BSandboxSession`, `test_failover_client_shared.py`, `TaskStatus`, `LogMonitor`, `test_brain_failover.py`, `test_autonomy_status.py`, `AgentSwarm`, `test_brain_patch_service_token.py`, `ImprovementLoop`, `test_unit8_model_catalog.py`, `test_task_pre_execution_gate.py`, `direct_chat.py`, `AgentRunner`, `UserRole`, `validate_policy_text`, `client`, `ExecutionRequest`, `services/seo_audit.py`, `BrainWatchdog`, `test_startup_warmup.py`, `test_company_api.py`, `WorkflowRun`, `test_monitor_lib.py`, `SelfHealingAgent`, `test_portfolio_intake.py`, `test_ceo_router.py`, `get_task_store`, `ResearchTask`, `PrimeAgentAdapter`, `cost_tracker.py`, `test_brain_failover_413.py`, `BackgroundAgent`, `test_provider_router.py`, `TestClient`, `test_procedural_memory.py`, `e2e/test_browser.py`, `test_knowledge_sync.py`, `test_openclaw_endpoints.py`, `load_config`, `ArtifactStore`, `test_tasks_reconciler_todo_requeue.py`, `KeyPool`, `clear_cooldowns`, `NotificationDispatcher`, `test_catalogue_probe.py`, `resolve_e2b_config`, `SQLiteStore`, `test_response_cache.py`, `test_trend_scoping.py`, `telegram_inbound_handlers.py`, `test_langfuse_agency_wide.py`, `test_local_brain_state.py`, `test_context_rulebook.py`, `persist_plan_spec`, `TestChatHistoryStore`, `WorkflowBuildRequest`, `test_llm_router_e2e.py`, `test_refresh_agent_built_proof.py`, `ProviderConfig`, `test_issue_intake.py`, `test_trend_watcher.py`, `model_discovery.py`, `test_new_features_e2e.py`, `FeatureMaturity`, `tests/conftest.py`, `run_task`, `test_task_service_failed_comment.py`, `ChatHistoryStore`, `_step`, `quick_note.py`, `test_webui_provider_priority.py`, `TestHarnessAdapter`, `controls_app`, `TestEstimateTokensForMessages`, `claim`, `test_agent_tool_governance.py`, `tasks/models.py`, `MCPClient`, `KeyStore`, `_clean_phases`, `test_telegram_task_callback.py`, `services/background.py`, `test_e2b_data_flow.py`, `test_daily_2026_07_27.py`, `TestAuthAndTaskCreation`, `OllamaCircuitBreaker`, `SchedulerStore`, `test_changelog_check_workflow.py`, `_job_text`, `test_video_transcript.py`, `_run_analyze`, `test_openclaw_gateway.py`, `test_features_api.py`, `TrendWatcher`, `TestRuntimeControl`, `rate_limiter.py`, `SeoFixer`, `TestCountTokensEndpoint`, `_Budget`, `test_purge_backlog.py`, `_start_ceo_agency`, `test_scheduler_hydration_bounded.py`, `_Recorder`, `filed`, `TestClient`, `test_telegram_webhook.py`, `test_control_plane_api.py`, `ContextPruner`, `test_persistent_memory.py`, `test_provider_enable_disable.py`, `test_sam_voice.py`, `SecurityScanner`, `test_brain_availability_doctor.py`, `test_agile_api.py`, `test_app_settings.py`, `test_nvidia_model_discovery.py`, `OutputFilter`, `_resolve_user_github_token`, `test_provider_state_durability.py`, `test_gh_brain_failover.py`, `test_spa_trailing_slash_redirect.py`, `test_task_clarification.py`, `TrafficDirector`, `OrchestratorCheckpointStore`, `TestNormalizeResponseFormat`, `test_platform_controls.py`, `session_retro.py`, `test_agency_fix.py`, `test_daily_automation_2026_07_09.py`, `test_skill_registry_boot_refresh.py`, `analyze_page`, `_redact_for_notification`, `test_phase5_doctor.py`, `parse_event_stream`, `isolated_telegram_config`, `test_regression.py`, `test_agent_scripts_share_one_model_list.py`, `test_crispy_burn_in.py`, `TestTheWorkflowIsSafeAndReadOnly`, `test_executive_advisory_api.py`, `TestMongoGate`, `test_task_store_fails_loud_in_production.py`, `_Recorder`, `get_current_user`, `test_agent_free_brain.py`, `_undeclared`, `get_registry`, `TestTeamSummary`, `routed`, `test_service_token.py`, `test_telegram_diag_endpoint.py`, `test_harness_spec.py`, `OperationalIncidentTracker`, `test_process_quick_note_workflow.py`, `test_onboarding_provisioning.py`, `test_v4_api.py`, `.on_task_complete`, `ClaudeCodeAdapter`, `_resolve_push_token`, `test_kimi_bridge_server.py`, `router_factory`, `test_voice_pipeline.py`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `test_autonomous_agency_e2e.py`, `proxy.py`, `AdaptiveHalter`, `ContextPruner`, `PolicyEngine`, `test_agent_chat_integration.py`, `test_agent_free_brain.py`, `TaskSpec`, `MultiAgentSwarm`, `UserMemoryStore`, `Any`, `FreeBuffAgent`, `call_llm`, `E2BSandboxSession`, `test_failover_client_shared.py`, `ReactScratchpad`, `test_ceo_micromanager.py`, `Agency`, `AgentPlan`, `AgentSessionStore`, `InternalAgentAdapter`, `test_ceo_dispatcher.py`, `test_agent_tool_governance.py`, `MCPClient`, `direct_chat.py`, `TestAgentLoopMCPIntegration`, `test_ceo_supervision.py`, `ContextManager`, `E2BAdapter`, `TestAgentRunnerExecution`, `test_governance_api.py`, `WorkflowRun`, `test_daily_automation_2026_07_11.py`, `TokenBudget`, `StuckDetector`, `WorkspaceTools`, `test_daily_automation_2026_07_09.py`, `test_brain_failover_413.py`, `BackgroundAgent`, `test_empirical_verify.py`, `loop.py`, `LocalWorkspace`, `GitHubTools`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderRouter` to `backend/server.py`, `system_instruction`, `TestAnthropicPayloadStructuredOutput`, `ProviderConfig`, `call_llm`, `test_bedrock_provider.py`, `test_all_providers_discovery.py`, `TestLegacyRouterServerFallback`, `direct_chat.py`, `TrafficDirector`, `TestOpenAiToBedrockConverse`, `implement_agent.py`, `failover_client.py`, `test_bedrock_live.py`, `test_chat_mode_regressions.py`, `test_provider_router.py`, `kimi_bridge_provider_config`, `test_colibri_provider.py`, `_payload`, `TestLegacyRouterCacheTTL`, `test_anthropic_refusal_fallback.py`, `TestRouterIntegration`, `clear_cooldowns`, `ChatResponse`, `test_colibri_brain_shim.py`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Are the 260 inferred relationships involving `HTTPException` (e.g. with `activate_instance()` and `change_user_role()`) actually correct?**
  _`HTTPException` has 260 INFERRED edges - model-reasoned connections that need verification._
