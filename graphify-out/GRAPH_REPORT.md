...
## Corpus Check
- 1446 files · ~2,082,233 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 28764 nodes · 57928 edges · 1203 communities (1057 shown, 146 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 6356 edges (avg confidence: 0.54)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cda5fa30`
...
1. `AgentRunner` - 305 edges
2. `_fixture()` - 290 edges
3. `AgentSessionStore` - 185 edges
4. `AgentScheduler` - 167 edges
5. `Task` - 159 edges
6. `ProviderRouter` - 153 edges
7. `ProviderConfig` - 152 edges
...
## Communities (1203 total, 146 thin omitted)

### Community 0 - "ExecutionRequest"
Cohesion: 0.04
Nodes (53): OrchestratorSupervisor, Any, Emit an alert to the activity feed and log., Deterministic supervisor for the orchestrator. Runs as a background coroutine.…, stop_orchestrator_supervisor(), ExecutionRequest, get_workflow_orchestrator(), Return the shared WorkflowOrchestrator singleton. (+45 more)

### Community 1 - "AgentPlan"
Cohesion: 0.05
Nodes (58): AgentDirective, Agent subsystem — planner / executor / verifier loop., AgentPhaseError, Exception, Raised when a named agent phase (planning, verification, etc.) fails., AgentEvent, AgentPlan, AgentSession (+50 more)

### Community 2 - "ProviderConfig"
Cohesion: 0.04
Nodes (145): AgentJobRequest, AgentJobSnapshot, Complete point-in-time view of a job, safe to serialise as API response., Convenience: the canonical text response, whether success or failure., Validated input for creating a new agent job. Passed from the API handler into…, DirectChatDoctor, AgentJobManager, QuickNoteQueue (+137 more)

### Community 3 - "backend/server.py"
Cohesion: 0.01
Nodes (458): get_agency(), set_agency(), get_sam(), agent/sam.py — SAM Voice Agent (System Autonomy Manager) SAM is the voice-…, get_harness_adapter(), Warm the in-process cache from the DB. Best-effort; never raises. Reads…, Persist a setting and refresh the in-process cache., refresh_cache() (+450 more)

### Community 4 - "CompanyGraphStore"
Cohesion: 0.03
Nodes (156): AccountLifecycleResponse, _DoctorCheck, _DoctorReport, OnboardingAnswersRequest, OnboardingProgressResponse, OnboardingQuestionsRequest, BaseModel, Request to generate AI-tailored onboarding questions. (+148 more)
...
Cohesion: 0.05
Nodes (38): Attempt, ChatRequest, ProviderToggle, BaseModel, OpenAI-compatible chat request, plus this router's extensions., StrategyUpdate, Read the environment variables named in ``env_names`` into a key list. Order is…, resolve_keys() (+30 more)

### Community 7 - "AgentRunner"
Cohesion: 0.04
Nodes (52): AgentRunner, _nvidia_api_key(), Any, Path, Governance seam: judge the call, run it, audit the outcome. Deliberately a thin…, Append an event to the durable session log if a store is wired in., Summarise a long history and compact it. Asks the planner model to write a…, Send chat messages and return the assistant's text output. If an… (+44 more)

### Community 8 - "Agency"
Cohesion: 0.06
Nodes (123): Agency, CEO-coordinated multi-agent agency for continuous codebase management. The CEO…, BackgroundAgent, BackgroundTask, _now(), Any, agent/background.py — Background Agent An always-on worker thread that…, Enqueue *task* for processing. Returns the task (with task_id set). (+115 more)

### Community 9 - "MCPUnavailableError"
Cohesion: 0.03
Nodes (104): MCPUnavailableError, agent/mcp_client.py — Async MCP client for the mcp-server Docker container.…, Raised when the MCP server is unreachable or the circuit is open., E2BSandboxSession, _inject_token(), maybe_attach_e2b(), Any, Create the sandbox. Raises :class:`MCPUnavailableError` on failure. (+96 more)

### Community 10 - "test_llm_router_queue_cache.py"
Cohesion: 0.02
Nodes (106): cosine_similarity(), payload_key(), Exact-match cache key over the fields that change the answer. Routing…, Cosine similarity between two vectors, 0.0 when either is degenerate., build_summariser(), chunk_document(), ContextManager, estimate_tokens() (+98 more)

### Community 11 - "Task"
Cohesion: 0.03
Nodes (118): ApprovalCheckpoint, Full task/issue document., Human approval gate in a task's execution., Task, _gate_outward_facing_enabled(), _is_brain_connection_error(), _is_outward_facing(), Any (+110 more)
...
Cohesion: 0.03
Nodes (102): PreflightIssue, Any, BaseModel, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, Translate technical preflight issues into a conversational assistant reply., translate_error_to_conversational(), ResumeRequest, AcceptedJob (+94 more)
...
Cohesion: 0.01
Nodes (141): parse_event_stream(), Reduce a ``--mode json`` NDJSON stream to a :class:`ParsedRun`. Kept a module-…, app_client(), _clear_discovered_models(), _clear_response_cache(), client(), _isolate_brain_data_layer(), _isolate_operator_provider_state() (+133 more)
...
### Community 20 - "workflow_orchestrator.py"
Cohesion: 0.04
...
Cohesion: 0.04
Nodes (69): BrainConfig, BrainConfigStore, default_brain_config(), provider_base_url(), _provider_env_value(), _provider_ids_from_literal(), provider_key_rotation_enabled(), BaseModel (+61 more)

### Community 22 - "test_agent_runner.py"
Cohesion: 0.06
Nodes (52): _make_runner(), MonkeyPatch, Path, The agent LLM call must use the BrainConfig budget, not a hardcoded 16384.…, Regression: a planning timeout must not surface as an empty "planning: ".…, Reproduce the exact error from the screenshot: slices present, goal absent., End-to-end: model returns CRISPY-style slices, plan should still execute., spawn_subagent creates a child AgentRunner and returns a condensed result. (+44 more)
...
Cohesion: 0.05
Nodes (50): heal_signature(), HealingEvent, _now(), Any, Translate external failure signals into improvement tasks and verify the fix…, Launch the background sweeper that resolves quiet verifying heals., Called when a CI workflow fails., Called when a GitHub issue with a bug label is opened. (+42 more)

### Community 25 - "SpecialistService"
Cohesion: 0.04
Nodes (52): Any, SpecialistFamily, SystemType, Auto-provision specialists based on detected system types. Args: company_id:…, Deprovision (delete) a specialist. Args: specialist_id: Specialist ID Returns:…, Enable a specialist. Args: specialist_id: Specialist ID Returns: Updated…, Disable a specialist. Args: specialist_id: Specialist ID reason: Reason for…, Get specialists that can handle a task with given capabilities. Args:… (+44 more)

### Community 26 - "diagnostics.py"
Cohesion: 0.05
Nodes (57): _check_background_liveness(), _check_ci_parity(), _check_company_graph(), _check_disk(), _check_event_log_integrity(), _check_feature_matrix(), _check_github_readiness(), _check_ollama() (+49 more)
...
### Community 29 - "test_ceo_router.py"
Cohesion: 0.04
...
Cohesion: 0.04
Nodes (103): ProviderConfig, One configured endpoint. ``kind`` selects the adapter: ``openai`` (any OpenAI-…, build_provider(), ProviderConfig, Normalise a configured ``kind`` to an adapter key., Instantiate the adapter for one provider config. Unknown kinds fall back to the…, resolve_kind(), LLMRequest (+95 more)
...
### Community 32 - "test_runtime_governance.py"
Cohesion: 0.05
Nodes (62): Return the last-known health for *runtime_id* (may be stale)., Return True if the runtime is available (not circuit-open)., Return health snapshots for all known runtimes., Force an immediate health check of all runtimes and return results., Attempt to start a dead runtime subprocess before re-probing. Uses the local…, Async health polling service for all registered runtimes., Start the background polling loop with an immediate initial check., RuntimeHealthService (+54 more)

### Community 33 - "test_unit8_model_catalog.py"
Cohesion: 0.03
Nodes (82): all_provider_ids(), provider_key_present(), Resolve the model id for a component's role on a provider. Parameters…, Return every provider id recognised by the brain config system. Iterates the…, True when the env var for *provider*'s key is set (or it's Ollama)., resolve_component_model(), CatalogActiveBrain, CatalogMirror (+74 more)
...
Cohesion: 0.04
Nodes (62): analyze_qualitative(), analyze_quantitative(), auto_register(), _classify_sentiment(), _extract_keywords(), plan_research(), Any, BaseModel (+54 more)

### Community 36 - "MCPClient"
Cohesion: 0.04
Nodes (32): MCPClient, Any, RuntimeError, Thin async MCP client with open/close circuit breaker. Thread-safe only within…, Full URL of the JSON-RPC endpoint this client posts to., Build the request headers shared by ``_rpc`` and ``notify``. ``Accept`` lists…, Propagate the calling agent's identity across the process boundary. The MCP…, Attach the agent identity whose actions this client executes. (+24 more)

### Community 37 - "TestRevenuePortfolio"
Cohesion: 0.22
...
Cohesion: 0.05
Nodes (42): BaseModel, Response shape of ``GET /api/render/ops/status``. Declared here rather than in…, RenderOpsStatus, RuntimeError, One deploy, normalised from whatever shape the tool returned., Typed facade over the Render MCP server's tools. Every method returns plain…, True when there is both an API key and an endpoint to reach., Return the most recent deploy, or ``None`` when there are none. (+34 more)

### Community 39 - "test_llm_router_resilience.py"
Cohesion: 0.03
Nodes (63): Backoff policy for retryable failures., RetryConfig, _digest(), KeyRing, KeyState, packages/llm/keys.py — multi-key rotation with per-key health. A provider may…, Per-provider round-robin key selection with cooldowns., Return the next healthy key and its index. Returns ``(None, -1)`` when every… (+55 more)

### Community 40 - "ImprovementLoop"
Cohesion: 0.08
Nodes (30): DetectedIssue, ImprovementLoop, ImprovementLoopState, _now(), Any, Path, agent/improvement_loop.py — Continuous Improvement Engine Background scanner…, Background scanner and task dispatcher for continuous codebase improvement.… (+22 more)
...
Cohesion: 0.04
Nodes (24): Typed configuration loaded from environment variables., When True, the governance layer evaluates and audits agent actions. This is…, When True, approval-gated actions self-approve. Local dev only., ``RENDER_SERVICE_IDS`` split into a clean list (empty when unset)., True when there is both an API key and an endpoint to reach., When True, the Render ops loop runs. On by default. Also requires…, When True, mutating Render MCP tools may be called. Default False., When True, agents may drive a real browser (agent/browser.py). (+16 more)
...
Cohesion: 0.06
Nodes (62): allow_paid_brain(), BrainResolution, get_active_brain_sync(), get_brain_preference(), get_provider_role_tags(), _host_is_openai_compatible(), invalidate_brain_cache(), _norm() (+54 more)

### Community 45 - "test_governance_enforcement.py"
Cohesion: 0.06
Nodes (60): classify(), GovernanceGate, The one seam through which governed actions pass., Return the ``(surface, action)`` a tool call really represents. The *action* is…, AgentIdentity, _coerce_text(), new_session_id(), Any (+52 more)

### Community 46 - "KeyPool"
Cohesion: 0.03
Nodes (51): provider_api_keys(), Every API key configured for *provider*, primary first. Reads ``base_env`` then…, _build_request(), Return ``(url, headers, is_anthropic_native)`` for *provider*. Anthropic's…, api_keys_for(), _digest(), KeyPool, _KeyState (+43 more)

### Community 47 - "test_freebuff.py"
Cohesion: 0.07
...
### Community 52 - "webui/router.py"
Cohesion: 0.04
Nodes (90): test_git_ref_rejects_empty(), test_git_ref_rejects_flag_injection(), test_git_ref_rejects_shell_metacharacters(), test_git_ref_rejects_traversal(), test_git_ref_valid(), test_git_scheme_allows_ssh(), test_http_scheme_rejects_ssh(), test_https_public_host_allowed() (+82 more)

### Community 53 - "LLMProvider"
Cohesion: 0.05
Nodes (49): packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, classify_error(), LLMProvider, OpenAICompatible, ABC, Any, AsyncClient, ProviderConfig (+41 more)
...
### Community 56 - "enforcement.py"
Cohesion: 0.05
Nodes (42): BudgetExceeded, BudgetTracker, evaluate_call(), get_gate(), guard_tool_call(), GuardResult, _host_of(), _is_write_tool() (+34 more)
...
### Community 59 - "test_agent_tool_governance.py"
Cohesion: 0.09
...
### Community 62 - "WorkflowOrchestrator"
Cohesion: 0.03
Nodes (100): CEOResult, Reset the singleton (test helper)., Aggregated output from a multi-specialist execution., reset_ceo_dispatcher(), ClassifyOutput, get_ceo_fallback_stats(), PlanOutput, Determine domain and task type from the request text. (+92 more)
...
Cohesion: 0.03
Nodes (54): API, getAccountLifecycle(), getMe(), login(), logout(), App(), AppRoutes(), ProtectedRoute() (+46 more)

### Community 66 - "ControlPlanePage.js"
Cohesion: 0.06
Nodes (43): getActivity(), getCostAttribution(), getDecisionLog(), getDueSoonTasks(), getSavings(), getStats(), getTaskCounts(), getUsage() (+35 more)

### Community 67 - "test_governance_api.py"
Cohesion: 0.06
Nodes (57): build_governance_router(), Any, APIRouter, backend/governance_router.py — read and operate the governance layer. Mounted…, Reject non-admin callers. Mirrors the RBAC check used elsewhere in this backend…, _require_admin(), get_approval_store(), Replace the process-wide gate. Tests only. (+49 more)

### Community 68 - "._coerce_ts"
Cohesion: 0.18
...
Cohesion: 0.04
Nodes (57): get_mcp_client(), Return the module-level MCPClient. Reads MCP_SERVER_BASE_URL at call time (not…, _internal_configured(), list_specs(), MCPServerSpec, _not_dialable(), _playwright_configured(), _playwright_spec() (+49 more)

### Community 70 - "test_ceo_supervision.py"
Cohesion: 0.03
Nodes (115): CEODispatcher, _complexity_rank(), _decompose_into_subtasks(), _harvest_changed_files(), _merge_changed_files(), _offload(), Any, Semaphore (+107 more)
...
### Community 74 - "test_task_source_id_race.py"
Cohesion: 0.17
...
### Community 75 - "test_minimax_bug_fixes.py"
Cohesion: 0.12
...
### Community 80 - "AnthropicProvider"
Cohesion: 0.09
...
Cohesion: 0.02
Nodes (144): AgentRole, str, AutonomyTracker, Reset all counters (test helper)., Singleton tracker for autonomy KPIs. Usage:: from agent.kpi import get_tracker…, AgileManager, Lifecycle status of a sprint., Manages multiple agile sprints with velocity tracking. (+136 more)

### Community 87 - "TestClient"
Cohesion: 0.10
Nodes (29): bare_repo(), _call(), _data(), git_config_env(), _is_error(), mcp_workspace_root(), Path, skipif (+21 more)

### Community 88 - "test_web_reach.py"
Cohesion: 0.07
Nodes (52): Register the Web Reach capability (agent/web_reach.py): zero-key internet…, _register_web_reach_tools(), _egress_policy_reason(), get_web_reach(), _load_script_module(), Any, ModuleType, Response (+44 more)
...
### Community 92 - "test_telegram_approval_gate.py"
Cohesion: 0.08
Nodes (25): Path, Start the Telegram bot. Returns True if started successfully., Signal the bot to stop and wait for graceful shutdown., Run the Telegram bot long-poll loop (inline, not subprocess)., Run the bot with stop-event awareness., Manages the Telegram bot as a managed service alongside ollama/proxy/tunnel.…, TelegramBotManager, _clear_telegram_env() (+17 more)
...
Cohesion: 0.04
Nodes (61): agents/store.py — Persistent store for user-defined agent configurations.…, Set the global agent store instance (e.g., with MongoDB on startup)., set_agent_store(), Await one warm-up step, deferring it to the background if it overruns.…, The task store the background services should use, wiring it if needed.…, Point the feature stores at the shared database connection. Deliberately…, _task_store_for_background(), _warmup_step() (+53 more)
...
Cohesion: 0.07
Nodes (58): get_decisions_store(), Process-wide DecisionsStore singleton (resettable via db_path arg)., Return a Markdown-v1-safe preview string under ``max_chars``. Used by the…, sanitize_paste_for_preview(), _admin_headers(), _answer_callback(), _api_headers(), _check_rate_limit() (+50 more)

### Community 105 - "AgileSprint"
Cohesion: 0.03
Nodes (29): AgileSprint, An agile sprint containing user stories., Add a user story to the sprint., Remove a user story from the sprint., Total story points in the sprint., Completed story points., Return completed points history for burndown chart., Number of stories in the sprint. (+21 more)

### Community 106 - "skill_bindings.py"
Cohesion: 0.06
Nodes (43): Status of a user story within a sprint., StoryStatus, MemoryKind, What kind of memory artifact this is., Return tasks whose dependencies are all satisfied., Number of tasks in the workflow., Number of completed tasks., Number of failed tasks. (+35 more)
...
### Community 108 - "SQLiteStore"
Cohesion: 0.03
Nodes (43): Delete a company and all associated data from SQLite., Count total companies in SQLite., Reconstruct a Website from a SQLite row, preferring the full JSON blob (which…, Create a new website in SQLite. The full model is stored in ``data`` so scan…, Get a website by ID from SQLite., Update a website in SQLite. When ``company_id`` is omitted the existing company…, Delete a website from SQLite., List websites from SQLite. (+35 more)
...
### Community 110 - "StreamingDeltaReconstructor"
Cohesion: 0.06
...
### Community 120 - "ChatPage.js"
Cohesion: 0.06
Nodes (51): cancelAgentChatJob(), chatSend(), deleteSession(), getAgentChatJob(), getSession(), listProviderModels(), listProviders(), listSessions() (+43 more)

### Community 121 - "ProvidersScreen.jsx"
Cohesion: 0.06
...
### Community 124 - "KnowledgeScreen.jsx"
Cohesion: 0.05
Nodes (35): changeUserRole(), createApiKey(), deleteApiKey(), getCompanyGraph(), setUserOnboarding(), useSafeData(), AdminOnboardingPanel(), AdminScreen() (+27 more)

### Community 125 - "test_context_rulebook.py"
Cohesion: 0.06
...
Cohesion: 0.04
Nodes (53): packages/ai/self_heal.py — automatic brain self-healing. When the active brain…, BrainWatchdog, _classify_failure_cause(), get_watchdog(), _is_provider_actually_available(), Any, services/brain_watchdog.py — Brain health watchdog. Monitors the active brain…, Reset failure counter for a provider after a successful call. (+45 more)

### Community 128 - "sync/service.py"
Cohesion: 0.11
...
### Community 133 - "RenderFinding"
Cohesion: 0.06
Nodes (35): IssueSeverity, _file_issue(), _latest_metric_value(), _note_recurrence(), _parse_timestamp(), Any, datetime, services/render_ops.py — autonomous Render debugging + environment monitoring.… (+27 more)
...
### Community 146 - "control_registry.py"
Cohesion: 0.10
...
### Community 148 - "AuditLog"
Cohesion: 0.05
Nodes (47): Replace the process-wide store. Tests only., reset_approval_store(), AuditEvent, AuditLog, Any, packages/governance/audit.py — the evidence trail for every governed action.…, Redact secret-shaped substrings, then truncate., One governed action, fully described. Field order follows the… (+39 more)
...
### Community 153 - "test_agency.py"
Cohesion: 0.12
Nodes (34): _parse_ceo_directives(), set_improvement_loop(), SupervisorState, agency(), asyncio, Path, Tests for agent/agency.py, With no issues, CEO should report nominal. (+26 more)
...
### Community 161 - "telegram_service.py"
Cohesion: 0.13
...
### Community 168 - "test_mcp_governance.py"
Cohesion: 0.11
...
### Community 171 - "loop.py"
Cohesion: 0.07
Nodes (34): get_tool_registry(), Return the module-level ToolRegistry singleton. On first call, registers built-…, agent/harness_enrichment.py — Automatic Harness Enrichment for Agent Prompts…, _check_extra_kwargs(), _enforce_signature(), _note_phase_end(), _note_phase_start(), loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures. (+26 more)
...
### Community 173 - "test_video_transcript.py"
Cohesion: 0.05
...
Cohesion: 0.06
Nodes (63): quick_notes_submit(), Submit a quick-note URL or instruction from the dashboard FAB., Reset the singleton (for tests)., reset_failover_manager(), _blocked_retire_age_sec(), _heal_blocked_backlog(), _heal_brain_failover(), _heal_purge_backlog() (+55 more)
...
### Community 181 - "ContextCompressor"
Cohesion: 0.11
...
Cohesion: 0.06
Nodes (44): brain_providers(), openclaw_websocket(), websocket, Every configured provider with its health AND its on/off state. Powers the…, WebSocket endpoint for iOS / mobile web UI pairing + command routing., describe_disabled_reason(), get_failover_manager(), ProviderHealth (+36 more)
...
### Community 186 - "ResourceWatchdog"
Cohesion: 0.10
...
### Community 190 - "test_backend_runtime_bootstrap.py"
Cohesion: 0.11
...
### Community 193 - "ContextWindowManager"
Cohesion: 0.09
...
### Community 195 - "provider_max_rpm"
Cohesion: 0.09
...
### Community 199 - "getBackendUrl"
Cohesion: 0.13
Nodes (23): getAccessToken(), getApiUrl(), getAuthHeaders(), getBackendUrl(), getDefaultBackendUrl(), ActivityEventRow(), AGENT_COLORS, AgentActivityFeed() (+15 more)

### Community 200 - "OrchestratorQueue"
Cohesion: 0.07
...
### Community 203 - "AgentScheduler"
Cohesion: 0.01
Nodes (161): _backend(), _json_default(), Any, agent/schedule_store.py — durable persistence for scheduled agent jobs. Fixes…, Return all persisted schedule docs (for boot rehydration)., Persist (insert or update) a single schedule by job_id., Delete a persisted schedule., Atomically delete a run-once row only while it is still unfired. Closes the… (+153 more)
...
Cohesion: 0.09
Nodes (30): createWikiPage(), deleteModel(), deleteSource(), deleteWikiPage(), getSource(), getWikiPage(), ingestSource(), lintWiki() (+22 more)
...
### Community 210 - "llm_providers.py"
Cohesion: 0.17
...
### Community 211 - "TestSchedulerStore"
Cohesion: 0.09
...
### Community 214 - "operational_incidents.py"
Cohesion: 0.11
...
Cohesion: 0.04
Nodes (27): FeatureEntry, FeatureMatrix, Any, BaseModel, One entry in the support matrix., Central support matrix — single source of truth. Loads the canonical feature…, Return the feature entry if available, or raise FeatureUnavailableError., Return True if the feature is enabled and not disabled. (+19 more)
...
### Community 218 - "test_unit6_resolve_component_model.py"
Cohesion: 0.05
...
### Community 220 - "SchedulesPage.js"
Cohesion: 0.13
...
### Community 224 - "test_all_providers_discovery.py"
Cohesion: 0.16
...
### Community 225 - "test_persistent_memory.py"
Cohesion: 0.06
...
### Community 228 - "ProjectScaffolder"
Cohesion: 0.13
...
### Community 232 - "agent_runtime.py"
Cohesion: 0.10
...
### Community 233 - "TestRenderMCPSidecarService"
Cohesion: 0.16
...
### Community 235 - "context_rules.py"
Cohesion: 0.11
...
### Community 240 - "AgentsScreen.jsx"
Cohesion: 0.11
...
### Community 243 - "test_provider_enable_disable.py"
Cohesion: 0.09
...
### Community 244 - "chat_handlers.py"
Cohesion: 0.10
...
### Community 247 - "RateLimitTracker"
Cohesion: 0.10
...
### Community 248 - "PerformanceAnalytics"
Cohesion: 0.12
...
### Community 250 - "SeoCheckDefinition"
Cohesion: 0.09
...
### Community 251 - "test_kimi_bridge_server.py"
Cohesion: 0.06
...
### Community 254 - "WorkspaceManager"
Cohesion: 0.06
...
### Community 259 - "Langfuse Observability Guide"
Cohesion: 0.06
...
### Community 265 - "TestAnthropicToolListCaching"
Cohesion: 0.34
...
### Community 272 - "CircuitBreakerOpenError"
Cohesion: 0.14
...
### Community 276 - "get_tracker"
Cohesion: 0.09
Nodes (18): AutonomyCounter, AutonomySnapshot, get_tracker(), Any, agent/kpi.py — Autonomy KPIs: evidence capture and metrics tracking. Tracks key…, Return a point-in-time snapshot of all KPIs., Return the shared AutonomyTracker singleton (lazy-init)., Reset the singleton (test helper). (+10 more)

### Community 277 - "autonomous_fix.py"
Cohesion: 0.14
...
### Community 284 - "test_phase6_workflow.py"
Cohesion: 0.04
...
Cohesion: 0.06
Nodes (29): browse_page(), BrowserAction, _not_started(), PageState, Any, agent/browser.py — Browser Automation Controls a real browser via Playwright so…, Evaluate a JavaScript expression in the page context., Return a summary of the current page state. (+21 more)
...
### Community 287 - "test_telegram_mutating_commands.py"
Cohesion: 0.08
...
### Community 289 - "test_rag_context.py"
Cohesion: 0.12
...
### Community 290 - "test_telegram_service_webhook.py"
Cohesion: 0.11
...
### Community 295 - "test_p0_roadmap_a4_a5_b2.py"
Cohesion: 0.12
...
### Community 298 - "SteeringInjector"
Cohesion: 0.11
...
### Community 299 - "cowork_session.py"
Cohesion: 0.15
...
### Community 302 - "test_internal_agent_did_work.py"
Cohesion: 0.12
...
### Community 304 - "test_skill_registry_boot_refresh.py"
Cohesion: 0.12
...
### Community 305 - "Python Dependencies (`requirements.txt`)"
Cohesion: 0.07
...
### Community 306 - "Technical Debt Register — local-llm-server"
Cohesion: 0.07
...
### Community 308 - "test_schedule_growth_invariants.py"
Cohesion: 0.15
Nodes (14): asyncio, Workstream D — Never again: dedup + growth invariants. These tests enforce…, Stale unfired run-once jobs (run_count==0, old created_at) must be deleted. The…, TASK_DISPATCH_CONCURRENCY=1 must prevent concurrent task execution. The…, Verify that the incident-fix test suite is present and importable., The /api/health endpoint (or /api/autonomy/status) must report schedule_count…, Distinct directives sharing a generic title must get distinct schedule names;…, Agency directive dispatch must use deterministic schedule names. The 2026-07-03… (+6 more)

### Community 309 - "llm/router.py"
Cohesion: 0.03
Nodes (94): _load(), main(), int, get_budget(), The process-wide budget tracker., get_cache(), packages/llm/cache.py — layered caching. Five independent layers, each with its…, The process-wide cache manager. (+86 more)
...
### Community 311 - "services/seo_audit.py"
Cohesion: 0.06
...
### Community 315 - "test_shared_state.py"
Cohesion: 0.17
...
### Community 319 - "Claude Code + Qwen Local Setup"
Cohesion: 0.07
...
### Community 325 - "WorkflowBuildRequest"
Cohesion: 0.11
...
### Community 340 - "test_activation_api.py"
Cohesion: 0.21
...
### Community 341 - "OperationalIncidentTracker"
Cohesion: 0.09
...
### Community 342 - "test_brain_resolution.py"
Cohesion: 0.12
Nodes (21): Synchronous call-time resolver for an agent role model id. Precedence (highest…, resolve_role_model_sync(), _clean_env(), tests/test_brain_resolution.py — call-time resolver precedence tests. Pins the…, With no DB cache, the env var is the next source., With no DB, no env, no requested → the safe default wins., ``NVIDIA_DEFAULT_MODEL`` is honoured as a fallback env var for…, The plan's core requirement: a DB Apply is visible on the next call. Simulates:… (+13 more)
...
Cohesion: 0.12
Nodes (24): Return the caller's GitHub token from EITHER place it can be stored. A token…, _resolve_user_github_token(), _FakeCollection, _FakeDB, patch_db(), asyncio, The doctor must find a GitHub token wherever the connect flow stored it.…, A diagnostics lookup must never turn into a 500. (+16 more)
...
### Community 354 - "timedelta"
Cohesion: 0.07
Nodes (30): Return True if a fetched oauth_states doc is a valid, unexpired login state., _valid_login_state(), demo_agent_tracking(), datetime, Temporal context graph inspired by Graphiti…, Get history of an entity between two times, Get current state of an entity (most recent fact), Query facts with pattern matching (+22 more)

### Community 355 - "test_daily_automation_2026_08_03.py"
Cohesion: 0.11
...
### Community 356 - "TestClassifyPlainText"
Cohesion: 0.08
...
### Community 357 - "test_service_token.py"
Cohesion: 0.08
...
Cohesion: 0.12
Nodes (20): _get_provider_policy(), Read the durable provider policy from DB, falling back to a safe default.…, Resolve the LLM endpoint for a named surface (task/chat/ceo/sdlc/…). Honours…, resolve_provider_for(), asyncio, Phase 3 regression test: paid providers are NEVER auto-selected when…, The .github/scripts/provider_policy.py module must export allow_paid() or…, Anthropic provider priorities must be <= -50 so free cloud providers are always… (+12 more)
...
### Community 364 - "Telegram Bot Setup"
Cohesion: 0.08
...
### Community 365 - "TaskDispatcher"
Cohesion: 0.10
Nodes (21): Re-queue BLOCKED tasks that have cooled down and are ready for retry., Polls for queued task work and executes it through the coordinator. Crash…, Re-queue tasks stranded by a prior crash or hard-kill., TaskDispatcher, _make_task(), asyncio, Task, TaskStatus (+13 more)

### Community 366 - "HarnessRegistry"
Cohesion: 0.16
...
### Community 367 - "DailyDigestAggregatorTests"
Cohesion: 0.19
...
### Community 369 - "test_ai_insights.py"
Cohesion: 0.20
...
### Community 371 - "test_regression.py"
Cohesion: 0.12
...
### Community 376 - "open_phase_report"
Cohesion: 0.13
...
### Community 378 - "The fifteen strategies"
Cohesion: 0.09
...
### Community 385 - "test_monitor_lib.py"
Cohesion: 0.11
...
### Community 387 - "test_mostly_failed_steps.py"
Cohesion: 0.12
...
### Community 397 - "V3 API Migration Plan — LLM Relay Platform"
Cohesion: 0.10
...
### Community 400 - "TestRenderRouter"
Cohesion: 0.13
...
### Community 408 - "test_unit5_ui_provider_surface.py"
Cohesion: 0.10
...
### Community 411 - "test_provider_state_durability.py"
Cohesion: 0.13
...
### Community 412 - "PersistentMemoryStore"
Cohesion: 0.24
...
### Community 413 - "AGENTS.md — Codebase Map & Operations Reference"
Cohesion: 0.17
...
### Community 422 - "Docker AI Governance Audit — Final Report"
Cohesion: 0.10
...
### Community 423 - "1. Capability-by-capability"
Cohesion: 0.10
...
### Community 425 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 426 - "ControlsScreen.jsx"
Cohesion: 0.15
...
### Community 429 - "clear_wizard_state_cache"
Cohesion: 0.21
...
### Community 432 - "TestNormalizeResponseFormat"
Cohesion: 0.11
...
### Community 437 - "TestSelfHealingInfrastructureClassification"
Cohesion: 0.19
...
### Community 439 - "test_voice_pipeline.py"
Cohesion: 0.14
...
### Community 442 - "propose_entries"
Cohesion: 0.32
Nodes (5): propose_entries(), Turn qualifying lessons into candidate entries. A lesson qualifies only when it…, _lesson(), The core guarantee: no citation, no entry., TestProposal
...
### Community 446 - "Skill: fabric-patterns"
Cohesion: 0.11
...
### Community 447 - "Analysis & Synthesis Instructions"
Cohesion: 0.11
Nodes (18): 1. Define the Atmosphere, 2. Map the Color Palette, 3. Establish Typography Rules, 4. Define the Hero Section, 5. Describe Component Stylings, 6. Define Layout Principles, 7. Define Responsive Rules, 8. Encode Motion Philosophy (+10 more)

### Community 448 - "Production Readiness Assessment — local-llm-server"
Cohesion: 0.11
...
### Community 449 - "refresh_agent_built_proof.py"
Cohesion: 0.20
...
### Community 452 - "Admin Dashboard Guide"
Cohesion: 0.11
...
### Community 453 - "Implementation Plan"
Cohesion: 0.11
...
### Community 454 - "WorkspaceTools"
Cohesion: 0.04
Nodes (52): Register the built-in agent tools that are always available., Register the interactive-browser capability (agent/browser.py). Unlike…, _register_browser_tools(), _register_builtin_tools(), repowise.py — RepowiseIntelligence: context packing and dependency analysis., Path, tools.py — WorkspaceTools: read/write/search and diff application (risky…, Precise string replacement — F1 roadmap item (Codebuff/Claude Code-style edit).… (+44 more)

### Community 455 - "SamConversation"
Cohesion: 0.19
Nodes (6): Any, Process a voice command and return SAM's spoken response. Args: text: The…, Call the NVIDIA NIM LLM (free tier) for SAM's response., Rule-based fallback when the LLM is unavailable., A single voice conversation session with SAM., SamConversation
...
### Community 458 - "build_workflow.py"
Cohesion: 0.33
...
### Community 460 - "test_provider_policy.py"
Cohesion: 0.14
...
### Community 461 - "test_doctor_service_token_check.py"
Cohesion: 0.23
...
### Community 464 - "DockerAgentAdapter"
Cohesion: 0.17
...
### Community 466 - "ErrorInterceptorMiddleware"
Cohesion: 0.18
...
### Community 467 - "FeatureMaturity"
Cohesion: 0.07
Nodes (30): check_feature(), get_feature(), list_features(), Any, get, post, features/api.py — Admin API for the feature support matrix. Exposes: GET…, Return the full support matrix with summary. (+22 more)
...
### Community 470 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 471 - "Component Map"
Cohesion: 0.11
...
### Community 472 - "Agent State — colibri GLM-5.2 deployment (resumable)"
Cohesion: 0.11
...
### Community 476 - "Part A — Health Report"
Cohesion: 0.11
...
### Community 477 - "test_providers_live_e2e.py"
Cohesion: 0.27
...
Cohesion: 0.08
Nodes (31): get_skill_bindings(), Live Graphify executor — queries the codebase knowledge graph. Order of…, Live council reviewer — deterministic, rules-based multi-perspective review…, Get the singleton SkillBindings instance., _run_council_review(), _run_graphify(), parametrize, tests/test_docs_consistency.py — structural defense against narrative drift.… (+23 more)
...
### Community 486 - "test_company_api.py"
Cohesion: 0.11
...
### Community 487 - "TestStopSlopChecker"
Cohesion: 0.11
...
### Community 488 - "handle_workflow_ide_chat"
Cohesion: 0.18
...
### Community 492 - "test_phase4_runtime_resilience.py"
Cohesion: 0.11
...
### Community 494 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 495 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 496 - "test_admin_local_brain_router.py"
Cohesion: 0.18
...
### Community 497 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 499 - "Section-by-Section Acceptance Criteria"
Cohesion: 0.12
...
### Community 502 - "test_refresh_agent_built_proof.py"
Cohesion: 0.12
...
### Community 504 - "agent_readiness_audit.py"
Cohesion: 0.21
...
### Community 511 - "test_health_endpoints.py"
Cohesion: 0.17
...
### Community 512 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 513 - "test_openclaw_endpoints.py"
Cohesion: 0.12
...
### Community 516 - "test_event_log.py"
Cohesion: 0.45
...
### Community 517 - "hermes_prompt.py"
Cohesion: 0.19
...
### Community 518 - "MemoryMiddleware"
Cohesion: 0.17
...
### Community 519 - "._fetch_flat_skill_file"
Cohesion: 0.18
...
### Community 522 - "Skill: repowise-intelligence"
Cohesion: 0.12
...
### Community 523 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
...
Cohesion: 0.03
Nodes (153): Any, Return recent commits with agent attribution trailers parsed out., get_skill_registry_safe(), Return the global SkillRegistry if set, else None. Used by onboarding and other…, check_ollama_async(), list_available_fixes(), Attempt a named one-click fix., Return all available one-click fixes. (+145 more)

### Community 525 - "Skill: repowise-intelligence"
Cohesion: 0.12
Nodes (15): 1. Graph Intelligence (Dependency Graph), 2. Git Intelligence, 3. Documentation Intelligence, 4. Decision Intelligence, Acceptance Checks, Directory Structure, Example Usage, Implementation Approach (+7 more)

### Community 526 - "The 10-Step Workflow"
Cohesion: 0.12
...
### Community 527 - "Contributing to local-llm-server"
Cohesion: 0.12
...
### Community 528 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 529 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 530 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
...
### Community 531 - "implement_agent.py"
Cohesion: 0.16
...
### Community 536 - "ManagedAgentDreams"
Cohesion: 0.22
...
### Community 542 - "test_frontend_deployment_guards.py"
Cohesion: 0.20
...
### Community 543 - "test_glm52_brain.py"
Cohesion: 0.12
...
### Community 544 - "test_local_brain_state.py"
Cohesion: 0.12
...
### Community 553 - "DecisionsStoreTests"
Cohesion: 0.11
...
### Community 555 - "Skill: checkpoint-strategy"
Cohesion: 0.13
...
### Community 557 - "Skill: local-ai-query"
Cohesion: 0.13
...
### Community 558 - "Skill: parallel-agents"
Cohesion: 0.13
...
### Community 559 - "Skill: parallel-worktrees"
Cohesion: 0.13
...
### Community 560 - "Design System: Taste Standard"
Cohesion: 0.13
...
### Community 563 - "Skill: user-research"
Cohesion: 0.13
...
### Community 564 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 567 - "test_agent_chat_integration.py"
Cohesion: 0.23
...
### Community 569 - "_push_down_where"
Cohesion: 0.14
...
### Community 570 - "test_p0_roadmap_b3_b4_b5.py"
Cohesion: 0.16
...
### Community 572 - "test_brain_failover_413.py"
Cohesion: 0.13
...
### Community 579 - "test_google_provider_models.py"
Cohesion: 0.18
...
### Community 581 - "TestKillSwitchDurability"
Cohesion: 0.15
...
### Community 584 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 588 - "Checks Performed"
Cohesion: 0.14
...
### Community 589 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 590 - "monitor_colibri.py"
Cohesion: 0.24
...
### Community 591 - "admin_digest_router.py"
Cohesion: 0.22
...
### Community 592 - "Skill: branch-cleanup"
Cohesion: 0.14
...
### Community 593 - "Skill: perplexity — Web Research via Perplexity API"
Cohesion: 0.14
...
### Community 596 - "Quick-Note Issues Processing Summary"
Cohesion: 0.14
...
### Community 597 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 599 - "Render MCP — autonomous platform debugging and environment monitoring"
Cohesion: 0.14
...
### Community 600 - "Runbook: Auto-Resume After Cooldown / Interruption"
Cohesion: 0.14
...
### Community 601 - "SEO / GEO / AIO Audit Engine"
Cohesion: 0.14
...
### Community 611 - "_status_snapshot"
Cohesion: 0.31
...
### Community 612 - "test_openclaw_gateway.py"
Cohesion: 0.14
...
### Community 613 - "TestGetCurrentTimeTool"
Cohesion: 0.16
...
### Community 614 - "services/background.py"
Cohesion: 0.05
Nodes (52): get_improvement_loop(), get_trend_watcher(), agent/trend_watcher.py — Internet-connected AI trend intelligence. Fetches from…, set_trend_watcher(), _await_hermes_ready(), BackgroundServices, _env_float(), _env_on() (+44 more)
...
### Community 616 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 619 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 620 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 623 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
...
### Community 624 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 625 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 627 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 631 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
Nodes (12): Acceptance Checks, Claude's query protocol (use this instead of Read tool for exploration):, Graph Artifacts — What to Commit, How to Use the Graph (Token Savings Protocol), Installation (one-time per machine), Instead of reading raw files:, Key commands:, Relationship to repowise-intelligence Skill (+4 more)

### Community 632 - "Skill: platform-setup — Autonomous Agency Bootstrap"
Cohesion: 0.15
...
### Community 633 - "Device compatibility and model picks"
Cohesion: 0.15
...
### Community 634 - "Autonomy Uplift — Living Roadmap & Detailed Implementation Specs"
Cohesion: 0.15
...
### Community 635 - "OpenClaw — iOS Control of the Agency (Single-Service Free-Tier Deploy)"
Cohesion: 0.15
...
### Community 638 - "TestPaidPolicyDurability"
Cohesion: 0.22
...
### Community 640 - "Agent Transparency Report"
Cohesion: 0.15
...
### Community 641 - "update_provider_policy"
Cohesion: 0.19
...
### Community 644 - "_InMemoryBackend"
Cohesion: 0.18
...
### Community 645 - "TestModelCostTableUpdates"
Cohesion: 0.26
...
### Community 646 - "test_deploy_trigger_covers_image.py"
Cohesion: 0.21
...
### Community 658 - "Skill: system-prompt-audit"
Cohesion: 0.17
...
### Community 659 - "Skill: task-alive-updates"
Cohesion: 0.17
...
### Community 663 - "_FakePersistence"
Cohesion: 0.20
...
### Community 666 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 669 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 671 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 672 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 673 - "Quantization Internals"
Cohesion: 0.17
...
### Community 674 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 675 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 676 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 680 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 681 - "test_agile_api.py"
Cohesion: 0.17
...
### Community 682 - "test_app_settings.py"
Cohesion: 0.21
...
### Community 684 - "test_contract_enforcement.py"
Cohesion: 0.13
...
### Community 686 - "TestAnthropicPayloadStructuredOutput"
Cohesion: 0.29
...
### Community 691 - "_extractive_compress"
Cohesion: 0.18
...
### Community 693 - "TestNormalizeToolChoice"
Cohesion: 0.31
...
### Community 695 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 698 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 699 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 701 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 704 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 705 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 706 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 707 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 708 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 709 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 710 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 711 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 713 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 714 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 715 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 716 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 717 - "What to clean up"
Cohesion: 0.18
...
### Community 718 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 719 - "test_bedrock_live.py"
Cohesion: 0.25
...
### Community 731 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 732 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 735 - "set_brain_config"
Cohesion: 0.17
Nodes (12): Convenience wrapper used by the admin API endpoints., set_brain_config(), A PATCH persists + the next get returns the applied config., A partial PATCH only touches the supplied fields; others stay., The new UI field persists through a PATCH and is served on the next get., set_brain_config writes to both Mongo AND the sqlite mirror., test_patch_merges_partial_update(), test_patch_round_trips_request_timeout_sec() (+4 more)
...
### Community 737 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 738 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 739 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 740 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 741 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 742 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 744 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 745 - "LLM Router — configuration guide"
Cohesion: 0.20
...
### Community 746 - "LLM Router — provider guide"
Cohesion: 0.20
...
### Community 747 - "CI Troubleshooting Runbook"
Cohesion: 0.20
...
### Community 750 - "is_provider_on_cooldown"
Cohesion: 0.29
Nodes (6): is_provider_on_cooldown(), mark_provider_failed(), Put provider_id on cooldown for *cooldown_seconds* (default:…, Return True if provider_id is currently on cooldown., A provider on cooldown should not be permanently pinned — cooldowns expire., TestProviderCooldown
...
Cohesion: 0.21
Nodes (11): _configure(), _default(), main(), Set an env var only when the operator hasn't already provided one., _poller_disabled(), Call a Telegram Bot API method and return the parsed JSON (best-effort)., True when TELEGRAM_POLLER_DISABLED is set to a truthy value. Centralised so the…, run_bot() (+3 more)
...
### Community 756 - "TestRouterIntegration"
Cohesion: 0.31
...
### Community 759 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 761 - "test_permissions.py"
Cohesion: 0.15
...
### Community 767 - "get_self_healing_agent"
Cohesion: 0.06
...
### Community 771 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 773 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 774 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 775 - "Skill: changelog-enforcer"
Cohesion: 0.22
Nodes (8): Acceptance Checks, Changelog Location, Entry Format, Examples, Hook Behaviour, Instructions, Skill: changelog-enforcer, When to Use

### Community 776 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
Nodes (8): Branch, Components, Purpose, Quick Start, Session Roles, Skill: cowork-session (Claude Cowork), Testing, When to Use

### Community 777 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 779 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 780 - "Main proxy (`proxy.py`)"
Cohesion: 0.22
...
### Community 781 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 782 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 783 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 784 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 785 - "Platform Controls"
Cohesion: 0.22
...
### Community 786 - "Release Procedure"
Cohesion: 0.22
...
### Community 787 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
Cohesion: 0.04
Nodes (44): CerebrasProvider, Provider, Cerebras provider adapter — free, fast LLM (qwen-3-coder-480b)., GroqProvider, Provider, Groq provider adapter — free, fast LLM (deepseek-r1-distill-llama-70b)., NvidiaProvider, Provider (+36 more)
...
### Community 799 - "scripts/agile_ceremonies.py"
Cohesion: 0.60
Nodes (4): _load(), main(), ModuleType, _write_summary()

### Community 800 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 801 - "test_changelog_parity_guard.py"
Cohesion: 0.22
...
### Community 803 - "TestActiveStrategy"
Cohesion: 0.29
...
### Community 826 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 827 - "ceo-micromanagement.md"
Cohesion: 0.25
Nodes (4): P0 behavior change, Readiness contract, Runtime model, Runtime types

### Community 828 - "TestExtendedThinkingRouting"
Cohesion: 0.20
...
### Community 830 - "467 Skill Inventory — load / wire / test status"
Cohesion: 0.25
...
### Community 831 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.25
...
### Community 832 - "Issue #362: Nvidia repo setup"
Cohesion: 0.25
...
### Community 833 - "Issue #364: quick-note:https://www.marktechpost.com/2026/06/01/meet-memory-os-a-6-layer-open-source-memory-stack-built-on-top-of-hermes-agent/"
Cohesion: 0.25
...
### Community 834 - "Issue #378: quick-note:https://www.marktechpost.com/2026/06/02/tinyfish-launches-bigset-an-open-source-multi-agent-system-that-builds-structured-live-datasets-from-plain-english-descriptions/"
Cohesion: 0.25
...
### Community 835 - "Issue #379: quick-note:https://searchengineland.com/schema-markup-optimize-agentic-web-479080"
Cohesion: 0.25
...
### Community 836 - "Issue #380: quick-note:https://cursor.com/blog/cloud-agent-lessons"
Cohesion: 0.25
...
### Community 837 - "Issue #381: quick-note:https://www.xda-developers.com/claude-code-with-opus-48-is-expensive-but-i-made-it-efficient-with-my-local-ai-workflow/"
Cohesion: 0.25
...
### Community 838 - "Issue #382: quick-note:https://claude.com/blog/how-coderabbit-used-claude-to-build-an-agent-orchestration-system"
Cohesion: 0.25
...
### Community 839 - "Issue #383: quick-note:https://www.marktechpost.com/2026/05/29/hexo-labs-open-sources-sia-a-self-improving-agent-that-updates-both-the-harness-and-the-model-weights/"
Cohesion: 0.25
...
### Community 840 - "Issue #416: feat: Self-hosted Codebuff (freebuff) on free NVIDIA models + Telegram bot phone control"
Cohesion: 0.25
...
### Community 841 - "Issue #485: [Trend Digest] Week of 2026-06-08"
Cohesion: 0.25
...
### Community 842 - "Issue #488: quick-note:https://github.com/cookiy-ai/user-research-skill"
Cohesion: 0.25
...
### Community 843 - "Issue #491: Implement whatever is necessary from https://github.com/BehiSecc/awesome-claude-skills"
Cohesion: 0.25
...
### Community 844 - "Issue #493: Use the https://github.com/mvanhorn/last30days-skill skill to get the trend updated"
Cohesion: 0.25
...
### Community 845 - "Issue #495: Read https://www.anthropic.com/news/claude-fable-5-mythos-5 and understand if mythos or fable can be added to the repo"
Cohesion: 0.25
...
### Community 846 - "Issue #504: EPIC: Autonomy hardening — live-verified defects 2026-06-10"
Cohesion: 0.25
...
### Community 847 - "Issue #581: Sprint tracker: pending work after brand rename + mobile-first pass"
Cohesion: 0.25
...
### Community 849 - "Issue #657: quick-note:https://github.com/earendil-works/pi"
Cohesion: 0.25
...
### Community 850 - "Issue #659: quick-note:https://github.com/nex-agi/Nex-N2"
Cohesion: 0.25
...
### Community 851 - "Issue #660: quick-note:https://github.com/getsentry/sentry-for-ai"
Cohesion: 0.25
...
### Community 852 - "Issue #661: quick-note:https://github.com/XiaomiMiMo/MiMo-Code"
Cohesion: 0.25
...
### Community 853 - "Issue #664: quick-note:https://github.com/Grominet95/jarvis-OS"
Cohesion: 0.25
...
### Community 854 - "Issue #666: quick-note:https://github.com/porokka/jarvis-os"
Cohesion: 0.25
...
### Community 855 - "Issue #670: quick-note:https://github.com/perplexityai/bumblebee"
Cohesion: 0.25
...
### Community 856 - "Issue #672: quick-note:https://github.com/Chachamaru127/claude-code-harness"
Cohesion: 0.25
...
### Community 857 - "Issue #676: quick-note:https://github.com/WeiboAI/VibeThinker"
Cohesion: 0.25
...
### Community 858 - "Issue #820: quick-note:https://github.com/cobusgreyling/loop-engineering"
Cohesion: 0.25
...
### Community 859 - "Positional Encoding Internals"
Cohesion: 0.25
...
### Community 860 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 861 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 862 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 863 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 866 - "PULL_REQUEST_TEMPLATE.md"
Cohesion: 0.25
...
### Community 872 - "run_patched_colibri.py"
Cohesion: 0.36
...
### Community 874 - "cleanup_stale_jobs"
Cohesion: 0.31
...
### Community 875 - "test_compose_and_coordinate_api.py"
Cohesion: 0.36
...
### Community 879 - "webui/commands.py"
Cohesion: 0.47
...
### Community 881 - "test_runtimes_health_endpoint.py"
Cohesion: 0.25
...
### Community 883 - "_FakeSQLiteStore"
Cohesion: 0.22
Nodes (5): _FakeSQLiteStore, parametrize, Simulates a SQLite-style store with load_all/upsert/remove., Duplicate-named rows must collapse to newest on BOTH backends. Regression for…, test_nuclear_cleanup_dedup_both_backends()

### Community 884 - "refine"
Cohesion: 0.14
Nodes (17): _flag(), _known_entry_texts(), _one_line(), Any, Path, agent/harness_spec.py — the Continual Harness: a persistent, cited spec.…, Absolute path of the harness spec for a workspace., Recorded lessons as ``{signature: {acceptable text, ...}}``. The citation binds… (+9 more)
...
### Community 889 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 890 - "test_crispy_workflow.py"
Cohesion: 0.08
Nodes (22): _make_engine(), tests/test_crispy_workflow.py — CRISPY workflow engine hardening tests. Tests…, Provide isolated DB + artifact + workspace paths., Create a WorkflowEngine with isolated storage., TestAbortOnFailure, TestPhaseSequence, TestPhaseSequenceError, TestWorkspaceIsolation (+14 more)
...
### Community 893 - "summarise.sh"
Cohesion: 0.48
Nodes (5): bottom(), divider(), row(), summarise.sh script, top()

### Community 894 - "updater.py"
Cohesion: 0.43
...
### Community 897 - "AI Engineering Insights Skill"
Cohesion: 0.29
...
### Community 904 - "Skill: SuperClaude Slash Commands"
Cohesion: 0.29
Nodes (6): Key Classes, Purpose, Related Issues, Skill: SuperClaude Slash Commands, Testing, Usage

### Community 905 - "Skill: SuperClaude Workflow Engine"
Cohesion: 0.29
...
### Community 907 - "test_harness_spec.py"
Cohesion: 0.13
Nodes (12): get_enrichment(), Return the enrichment instance for a workspace. Keyed by workspace root rather…, dict, set, _AllSignatures, _AnyText, tests/test_harness_spec.py — the Continual Harness spec. Covers the property…, refine() cannot cite what the store does not return. (+4 more)

### Community 908 - "ADR-006: Strangler Fig migration with backward-compat shims"
Cohesion: 0.29
Nodes (6): ADR-006: Strangler Fig migration with backward-compat shims, Consequences, Context, Decision, Examples, Migration path

### Community 909 - "claude-mem Plugin — Persistent Memory for All Sessions"
Cohesion: 0.29
...
### Community 910 - "Implementation plan + TO-DO (check off as you go)"
Cohesion: 0.29
...
### Community 913 - "Cloudflare = the real working app"
Cohesion: 0.29
...
### Community 917 - "Continual Harness (`agent/harness_spec.py`)"
Cohesion: 0.25
...
### Community 920 - "PRD — README Marketing Refresh"
Cohesion: 0.29
...
### Community 921 - "check_changelog_parity.py"
Cohesion: 0.43
...
### Community 922 - "e2e_smoke.py"
Cohesion: 0.57
Nodes (5): _chat(), check(), _health(), _models(), _req()

### Community 923 - "task_runner.py"
Cohesion: 0.33
...
### Community 926 - "test_daily_2026_06_14.py"
Cohesion: 0.38
...
### Community 930 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.25
...
### Community 935 - "test_direct_adapter_does_not_bypass"
Cohesion: 0.67
...
### Community 939 - "test_doctor_coding_brain.py"
Cohesion: 0.38
...
### Community 956 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 957 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 958 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 959 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 960 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 961 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 964 - "TestSupportMatrixDocsSync"
Cohesion: 0.29
...
### Community 976 - "build_block"
Cohesion: 0.19
Nodes (8): build_block(), _int_env(), Compact prompt block of standing instructions, or '' when there are none.…, Golden rule: a workspace that never opted in gets identical prompts., A workspace is often a third-party repo — its spec file is untrusted. Without…, A known signature must not license arbitrary text., The attack the signature check alone did not stop. A workspace with a…, TestCitationBinding

### Community 977 - "_auth_headers"
Cohesion: 0.73
...
### Community 1000 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 1001 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 1007 - "loginFlowNoTimeout.test.js"
Cohesion: 0.40
Nodes (4): apiSource, { describe, test, expect }, fs, path

### Community 1008 - "test_company_stale_id_recovery.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 1009 - "worker_no_cache.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, workerSource

### Community 1010 - "workflow_engine.py"
Cohesion: 0.50
...
### Community 1014 - "_add_colibri_shim_changelog_entry.py"
Cohesion: 0.50
...
### Community 1015 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1016 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1017 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 1018 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 1019 - "setup_colibri.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1020 - "setup_colibri.sh script"
Cohesion: 0.70
Nodes (4): setup_colibri.sh script, fail(), ok(), warn()

### Community 1021 - "status_colibri_server.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1023 - "TestMobileNavigation"
Cohesion: 0.40
Nodes (3): Mobile-specific: hamburger menu, responsive layout., Verify key pages load in mobile viewport., TestMobileNavigation

### Community 1024 - "test_v5_screens_smoke.py"
Cohesion: 0.50
...
### Community 1025 - "test_agent_runtime_wrapper.py"
Cohesion: 0.70
...
### Community 1027 - "worker/index.js"
Cohesion: 0.60
...
### Community 1033 - ".execute"
Cohesion: 0.50
Nodes (3): RoutingDecision, TaskResult, TaskSpec

### Community 1034 - "aider_config.sh"
Cohesion: 0.50
Nodes (3): OPENAI_API_BASE, OPENAI_API_KEY, aider_config.sh script

### Community 1037 - "providers.yaml"
Cohesion: 0.50
Nodes (4): Bulkhead sizing, Per-minute token budgets, providers.yaml, Tiers

### Community 1038 - "Credential Rotation Runbook"
Cohesion: 0.50
Nodes (3): Credential Rotation Runbook, Guardrails already in place, What to rotate (owner action, ~10 minutes)

### Community 1039 - "Runbook: `make doctor`"
Cohesion: 0.50
Nodes (3): Roadmap, Runbook: `make doctor`, What it checks and why

### Community 1042 - "ProviderRouter"
Cohesion: 0.02
Nodes (189): get_tracker(), Return the process-singleton RateLimitTracker., _acquire_provider_probe(), clear_cooldowns(), _dead_model_key(), _exponential_backoff_cooldown(), extract_openai_text(), get_dead_models() (+181 more)

### Community 1045 - "render"
Cohesion: 0.50
...
### Community 1049 - "stop_colibri_server.ps1"
Cohesion: 0.83
Nodes (3): Fail(), Ok(), W()
...
### Community 1099 - "test_the_reserve_is_bounded_when_read_from_the_environment"
Cohesion: 0.67
...
- **Why does `_fixture()` connect `_fixture` to `ExecutionRequest`, `AgentPlan`, `test_openclaw_endpoints.py`, `_clean_director`, `MCPUnavailableError`, `test_llm_router_queue_cache.py`, `Task`, `ProviderRouter`, `brain_config.py`, `SelfHealingAgent`, `SpecialistService`, `test_autonomy_status.py`, `diagnostics.py`, `GoalRecord`, `test_ceo_router.py`, `config.py`, `test_local_brain_state.py`, `test_unit8_model_catalog.py`, `TestChatHistoryStore`, `MCPClient`, `._check_permissions`, `test_phase5_doctor.py`, `test_llm_router_resilience.py`, `ImprovementLoop`, `test_telegram_diag_endpoint.py`, `ModelRouter`, `resolve_active_brain`, `KeyPool`, `test_llm_router_strategies.py`, `SecretRecord`, `allow_paid`, `test_failover_client_shared.py`, `enforcement.py`, `test_model_router.py`, `test_agent_tool_governance.py`, `test_brain_failover_413.py`, `test_knowledge_sync.py`, `e2e/test_browser.py`, `WorkflowRun`, `PolicyEngine`, `PrimeAgentAdapter`, `TestMongoGate`, `AgentSwarm`, `test_e2b_task_wiring.py`, `sam_with_mocks`, `ResearchTask`, `resolve_e2b_config`, `FailureCategory`, `TestClient`, `test_telegram_approval_gate.py`, `ProceduralMemoryStore`, `KeyStore`, `Usage`, `test_startup_warmup.py`, `test_openclaw_gateway.py`, `TestGetCurrentTimeTool`, `services/background.py`, `OllamaCircuitBreaker`, `test_colibri_brain_shim.py`, `test_llm_router_e2e.py`, `seo_api.py`, `test_new_features_e2e.py`, `test_context_rulebook.py`, `ArtifactStore`, `BrainWatchdog`, `_Budget`, `test_trend_scoping.py`, `SeoAuditRequest`, `test_agent_free_brain.py`, `ChatHistoryStore`, `CacheManager`, `persist_plan_spec`, `test_trend_watcher.py`, `AuditLog`, `test_issue_intake.py`, `test_agency.py`, `test_telegram_freebuff.py`, `IssueCategory`, `E2BAdapter`, `test_mcp_governance.py`, `test_agile_api.py`, `test_app_settings.py`, `test_tasks_awaiting_approval_api.py`, `test_features_api.py`, `test_video_transcript.py`, `TaskStore`, `test_task_clarification.py`, `test_platform_controls.py`, `get_task_store`, `TestHarnessAdapter`, `TrendWatcher`, `test_portfolio_intake.py`, `TaskIn`, `OrchestratorQueue`, `AgentScheduler`, `TestEstimateTokensForMessages`, `TestClient`, `ContextPruner`, `cost_tracker.py`, `test_persistent_memory.py`, `SecurityScanner`, `test_provider_enable_disable.py`, `test_rate_limiter.py`, `SeoCheckDefinition`, `test_kimi_bridge_server.py`, `UsageEvent`, `get_self_healing_agent`, `reap_expired_companies`, `brain_failover.py`, `ClaudeCodeAdapter`, `test_purge_backlog.py`, `test_telegram_service_webhook.py`, `sam`, `test_skill_registry_boot_refresh.py`, `llm/router.py`, `services/seo_audit.py`, `test_crispy_burn_in.py`, `test_shared_state.py`, `isolated_telegram_config`, `WorkflowBuildRequest`, `test_scheduler_hydration_bounded.py`, `test_sam_livekit.py`, `test_telegram_auto_approve.py`, `OperationalIncidentTracker`, `test_brain_resolution.py`, `test_freebuff_bot.py`, `_resolve_user_github_token`, `capture_screens.py`, `test_service_token.py`, `test_ping.py`, `test_runtimes_health_endpoint.py`, `test_regression.py`, `test_agency_fix.py`, `TestHarnessRegistry`, `test_crispy_workflow.py`, `test_monitor_lib.py`, `test_v4_api.py`, `test_harness_spec.py`, `_enable_filter`, `test_provider_state_durability.py`, `client`, `test_dashboard_cache.py`, `test_task_store_fails_loud_in_production.py`, `test_doctor_coding_brain.py`, `TestNormalizeResponseFormat`, `test_voice_pipeline.py`, `model_discovery.py`, `test_doctor_service_token_check.py`, `FeatureMaturity`, `_MemDB`, `test_brain_patch_service_token.py`, `_resolve_push_token`, `test_company_api.py`, `_clean_phases`, `test_refresh_agent_built_proof.py`, `SQLiteStore`?**
  _High betweenness centrality (0.103) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `ExecutionRequest`, `AgentPlan`, `ProviderConfig`, `backend/server.py`, `test_empirical_verify.py`, `LocalWorkspace`, `Agency`, `MCPUnavailableError`, `test_agent_free_brain.py`, `proxy.py`, `AgentSessionStore`, `TaskSpec`, `Workspace`, `workflow_orchestrator.py`, `test_agent_runner.py`, `.execute`, `diagnostics.py`, `TestMCPServer`, `test_daily_automation_2026_07_11.py`, `E2BAdapter`, `_StubManager`, `MCPClient`, `loop.py`, `KeyPool`, `test_backend_server_features.py`, `test_agent_chat_integration.py`, `test_failover_client_shared.py`, `test_agent_tool_governance.py`, `WorkflowRun`, `test_brain_failover_413.py`, `WorkflowOrchestrator`, `test_governance_api.py`, `WorkspaceTools`, `test_ceo_supervision.py`, `TokenBudget`, `PortfolioManager`, `ContextPruner`, `GitHubTools`, `AdaptiveHalter`, `TestGetCurrentTimeTool`, `ContextManager`, `StuckDetector`, `TestZeroAttemptDiagnostics`, `ReactScratchpad`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderRouter` to `ProviderConfig`, `backend/server.py`, `AgentSessionStore`, `system_instruction`, `settings.py`, `TestActiveStrategy`, `test_bedrock_provider.py`, `TrafficDirector`, `TestAnthropicPayloadStructuredOutput`, `get_failover_manager`, `model_discovery.py`, `test_bedrock_live.py`, `test_model_catalog.py`, `test_all_providers_discovery.py`, `test_colibri_brain_shim.py`, `test_anthropic_router.py`, `TestRouterIntegration`, `_P`, `failover_client.py`, `_Budget`?**
...
- **Are the 81 inferred relationships involving `AgentScheduler` (e.g. with `AgentStatusEntry` and `AgentStatusResponse`) actually correct?**
  _`AgentScheduler` has 81 INFERRED edges - model-reasoned connections that need verification._