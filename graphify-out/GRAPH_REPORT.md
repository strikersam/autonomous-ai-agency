...
## Corpus Check
- 1440 files · ~2,084,529 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 29252 nodes · 54265 edges · 1235 communities (1120 shown, 115 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 2671 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a86e6ae7`
...
## Communities (1235 total, 115 thin omitted)
...
### Community 33 - "TaskExecutionCoordinator"
Cohesion: 0.03
...
### Community 39 - "Task"
Cohesion: 0.03
Nodes (114): Hand the 'connect & verify the repo' work to the agency's own agents. The task…, _seed_connect_task(), ApprovalCheckpoint, _coerce_ts(), ExecutionLogEntry, Any, field_validator, Full task/issue document. (+106 more)
...
### Community 400 - "local_brain_provider_config"
Cohesion: 0.29
...
Cohesion: 0.02
Nodes (156): classify_domain(), agent/workflow.py — Persisted workflow state machine. Implements the Autonomous…, Return the best-matching domain for a task title+description., packages/ai/self_heal.py — automatic brain self-healing. When the active brain…, Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., tasks — Task/issue management system. Provides a lightweight task/issue tracker…, Enum (+148 more)
...
- **Why does `TaskStore` connect `TaskStore` to `TaskExecutionCoordinator`, `test_issue_intake.py`, `services/background.py`, `get_task_store`, `backend/server.py`, `InternalAgentAdapter`, `TaskDispatcher`, `Task`, `test_sqlite_store.py`, `test_trend_scoping.py`, `test_portfolio_intake.py`, `Agency`, `test_task_source_id_race.py`, `tasks/api.py`?**
