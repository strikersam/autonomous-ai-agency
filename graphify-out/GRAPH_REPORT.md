...
## Corpus Check
- 1437 files · ~2,079,041 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 29174 nodes · 54156 edges · 1234 communities (1117 shown, 117 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 2672 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fdc83521`
...
## Communities (1234 total, 117 thin omitted)

### Community 0 - "MongoDBStore"
Cohesion: 0.02
Nodes (87): KnowledgeItem, Structured knowledge about the company, systems, or processes., MongoDBStore, Any, Company, ObjectId, Prepare a Pydantic model for SQLite storage., Prepare a SQLite row for Pydantic model. (+79 more)

### Community 1 - "proxy.py"
Cohesion: 0.03
Nodes (173): get_skill_registry_safe(), Return the global SkillRegistry if set, else None. Used by onboarding and other…, middleware, AdminIdentity, admin_control(), admin_create_key(), admin_create_user(), admin_delete_user() (+165 more)
...
Cohesion: 0.02
Nodes (105): Test hook — clear all usage accounting., reset(), CacheManager, cosine_similarity(), _Entry, LRUCache, payload_key(), Any (+97 more)

### Community 6 - "test_crispy_workflow.py"
Cohesion: 0.07
...
### Community 8 - "._resolve_merge_decision"
Cohesion: 0.40
...
Cohesion: 0.04
Nodes (87): agent/job_manager.py — Async agent job lifecycle manager. Manages agent jobs…, kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, TaskResult, TaskSpec, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Run aider non-interactively via `--message` flag., runtimes/adapters/claude_code.py — Claude Code CLI adapter (FIRST CLASS).… (+79 more)
...
Cohesion: 0.03
Nodes (124): Call-time resolver for an agent role model id. Delegates to…, _resolve_role_model(), _active_primary_provider(), BrainConfig, BrainConfigPatch, BrainConfigStore, default_brain_config(), get_brain_config() (+116 more)

### Community 12 - "LLMRequest"
Cohesion: 0.03
Nodes (92): Attempt, Read the environment variables named in ``env_names`` into a key list. Order is…, resolve_keys(), LLMRouter, Any, AsyncClient, BaseException, ProviderConfig (+84 more)
...
Cohesion: 0.05
Nodes (40): build_governance_router(), Any, APIRouter, backend/governance_router.py — read and operate the governance layer. Mounted…, Reject non-admin callers. Mirrors the RBAC check used elsewhere in this backend…, _require_admin(), _audit_proposal(), _baseline_loosened() (+32 more)
...
Cohesion: 0.03
Nodes (99): _egress_policy_reason(), agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Return why governance policy blocks *host*, or None. Runs strictly *after* the…, AgentIdentity, _coerce_text(), new_session_id(), Any, packages/governance/identity.py — who is acting, and under what mandate. Docker… (+91 more)

### Community 18 - "CEODispatcher"
Cohesion: 0.06
Nodes (48): CEODispatcher, CEOResult, _complexity_rank(), _decompose_into_subtasks(), _offload(), Any, Semaphore, services/ceo_dispatcher.py — Real CEO delegation layer. The CEO splits a… (+40 more)
...
### Community 21 - "test_llm_router_providers.py"
Cohesion: 0.03
Nodes (109): int, failover_chat_completion_via_router(), packages/llm/compat.py — backwards-compatible bridges to the legacy call paths.…, Router-backed implementation of ``packages.ai.failover_client``'s entry point.…, ProviderConfig, One configured endpoint. ``kind`` selects the adapter: ``openai`` (any OpenAI-…, packages/llm — the multi-provider LLM routing layer. Every LLM call in this…, packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic… (+101 more)
...
### Community 23 - "Task"
Cohesion: 0.05
Nodes (52): Full task/issue document., Task, Best-effort Telegram heads-up that a task is parked awaiting approval. Inline…, _coordinator(), asyncio, Pre-execution approval gate tests (Autonomy Charter Gate Matrix / P0). A…, Records whether execute() was ever reached; raises so we never need a full fake…, _RecordingRuntimeManager (+44 more)
...
Cohesion: 0.04
Nodes (45): _accumulate_usage(), _assistant_messages(), _child_env(), _iter_events(), _kill_and_reap(), _message_text(), PrimeAgentAdapter, Any (+37 more)
...
Cohesion: 0.03
Nodes (93): _merge_changed_files(), Reset the singleton (test helper)., Collect changed_files across all specialists into a single de-duped list., reset_ceo_dispatcher(), get_ceo_fallback_stats(), PlanOutput, PLAN phase: structured execution plan., SELECT_SPECIALIST phase: which specialist(s) handle this work. (+85 more)
...
### Community 29 - "test_llm_router_disabled.py"
Cohesion: 0.09
...
Cohesion: 0.02
Nodes (164): AccountLifecycleResponse, auto_recommend_skills(), cancel_onboarding(), delete_company_endpoint(), _DoctorCheck, _DoctorReport, generate_onboarding_questions(), get_company() (+156 more)

### Community 32 - "TelegramBotManager"
Cohesion: 0.12
...
### Community 35 - "governance/audit.py"
Cohesion: 0.07
...
Cohesion: 0.04
Nodes (75): get_catalog_models_route(), Return the mirrored model catalog (advisory-only). Flag-gated by…, all_provider_ids(), _provider_ids_from_literal(), Return every provider id recognised by the brain config system. Iterates the…, Return the provider ids allowed by the ``BrainProvider`` Literal. Reads the…, CatalogActiveBrain, CatalogMirror (+67 more)
...
Cohesion: 0.05
Nodes (69): DetectedIssue, get_improvement_loop(), ImprovementLoop, ImprovementLoopState, IssueCategory, IssueSeverity, _now(), Any (+61 more)
...
Cohesion: 0.03
Nodes (110): AgentPhaseError, AgentRunner, _check_extra_kwargs(), _enforce_signature(), _note_phase_end(), _note_phase_start(), Any, Exception (+102 more)
...
Cohesion: 0.05
Nodes (71): _enrich_runtimes(), get_decision_log(), get_policy(), get_runtime(), list_runtimes(), PolicyUpdateBody, Any, BaseModel (+63 more)

### Community 55 - "AgentJobManager"
Cohesion: 0.05
Nodes (35): AgentJob, AgentJobManager, make_isolated_workspace(), _now(), Any, Path, Run a job using the provided runner and update the job's lifecycle, progress,…, Create an isolated workspace directory under *root*. This is the legacy path… (+27 more)
...
### Community 57 - "_get_run_or_404"
Cohesion: 0.11
Nodes (37): approve(), build(), cancel(), _engine(), get_agent_team(), get_artifact_content(), get_events(), get_run() (+29 more)
...
Cohesion: 0.05
Nodes (42): delegate_seo_findings(), _expire_stale_pending_report(), get_seo_audit(), BaseModel, get, post, SEO / GEO / AIO Audit API Router Endpoints for the world-class SEO audit engine…, Return the full SEO/GEO/AIO check catalog. Static metadata only, but gated… (+34 more)

### Community 69 - "get_task_store"
Cohesion: 0.06
Nodes (62): quick_notes_submit(), _QuickNoteBody, Submit a quick-note URL or instruction from the dashboard FAB., packages/ai/self_heal.py — automatic brain self-healing. When the active brain…, Hand the 'connect & verify the repo' work to the agency's own agents. The task…, _seed_connect_task(), _blocked_retire_age_sec(), _heal_blocked_backlog() (+54 more)
...
Cohesion: 0.02
Nodes (118): _format_incident(), _iso_from_monotonic(), normalise(), note_phase_end(), note_phase_start(), _now(), open_phase_report(), OperationalIncident (+110 more)
...
Cohesion: 0.06
Nodes (55): list_seo_audits(), List stored audits for this company (most recent first)., BaseModel, field_validator, models/seo_audit.py - SEO / GEO / AIO Audit Contracts Typed Pydantic models for…, A single occurrence of a check firing on a specific URL., Snapshot of one crawled page with the on-page facts the checks used., Aggregated report row - Screaming Frog CSV compatible. (+47 more)

### Community 75 - "loop.py"
Cohesion: 0.06
Nodes (51): PreflightReport, Agent subsystem — planner / executor / verifier loop., loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., # NOTE: "ollama_base" is kept for backwards compatibility; this runner only…, AgentEvent, AgentPlan, AgentRunRequest, AgentSession (+43 more)
...
Cohesion: 0.05
Nodes (47): _auto_disable(), _describe_registry(), _disabled_ids(), FailoverResult, _is_billing_refusal(), _is_ollama(), _key_pool(), _log_exhaustion() (+39 more)
...
Cohesion: 0.06
Nodes (36): analyze_qualitative(), analyze_quantitative(), _classify_sentiment(), _extract_keywords(), BaseModel, QualAnalysis, QualQuote, QualTheme (+28 more)
...
### Community 103 - "RequestQueue"
Cohesion: 0.09
Nodes (20): T, Execute ``factory``, or await an identical call already running. Returns…, One job waiting for a concurrency slot, ordered by (priority, arrival)., Bounded priority queue with concurrency limits and backpressure. Admission is…, Run ``job`` under the queue's concurrency limit. Raises ``QueueFull``…, Wait for a slot, yielding to higher-priority work already queued., Give the slot to the best waiting job, or return it to the pool., RequestQueue (+12 more)
...
Cohesion: 0.05
Nodes (52): _bootstrap_within_budget(), _create_bootstrap_indexes(), ensure_bootstrap(), Await one warm-up step, deferring it to the background if it overruns.…, The task store the background services should use, wiring it if needed.…, Create every boot index concurrently rather than one round-trip at a time.…, Idempotent bootstrap for indexes + seeded admin/providers. FastAPI startup…, Run bootstrap without letting it hold a request open indefinitely. Returns… (+44 more)
...
Cohesion: 0.08
Nodes (21): Request to remediate auto-fixable findings in a local code repository., One concrete remediation performed (or proposed) by the fixer., SeoFixAction, SeoFixRequest, _humanize_filename(), BeautifulSoup, Path, services/seo_fixer.py - Repo-Aware SEO Auto-Fixer When a company has a code… (+13 more)
...
Cohesion: 0.06
Nodes (54): asyncio, tests/test_sqlite_store.py — Unit tests for the SQLite storage adapter. These…, The exact query shape backend/server.py's provider "Set default" uses: clear…, Unfiltered count uses the SELECT COUNT(*) fast path and must match the number…, estimated_document_count mirrors an unfiltered count_documents., db['tasks'] must work like db.tasks (motor exposes both)., TaskStore(db=SQLiteStore) must not raise 'not subscriptable'. This is the exact…, Regression: GET /api/mcp/servers 500'd in sqlite mode because 'mcp_servers' was… (+46 more)

### Community 110 - "KeyStore"
Cohesion: 0.06
Nodes (39): Browser admin UI for login, service control, key management, and diagnostics., Update or append a KEY=value line in the .env file., register_admin_gui(), _save_env_var(), get_output_filter(), get_savings_summary(), Get or create the singleton OutputFilter instance., Get token savings summary. (+31 more)
...
Cohesion: 0.06
Nodes (31): browse_page(), BrowserAction, BrowserSession, _not_started(), PageState, Any, agent/browser.py — Browser Automation Controls a real browser via Playwright so…, True if browser automation is enabled and Playwright is importable. (+23 more)
...
Cohesion: 0.10
Nodes (28): free_nvidia_models(), FreeBuffAgent, _nvidia_api_key(), Return the curated list of free NVIDIA NIM models FreeBuff may use., Codebuff-style coding agent pinned to free NVIDIA NIM models. FreeBuff is a…, List the free NVIDIA NIM models a user may pick (e.g. via Telegram)., True when *model* is in the curated free NVIDIA NIM set., Coerce *requested* to a free NVIDIA model. Returns *requested* when it is… (+20 more)

### Community 123 - "activation_api.py"
Cohesion: 0.10
...
Cohesion: 0.07
Nodes (55): Return a Markdown-v1-safe preview string under ``max_chars``. Used by the…, sanitize_paste_for_preview(), _admin_headers(), _api_headers(), _check_rate_limit(), cmd_control(), cmd_cost(), cmd_keylist() (+47 more)
...
Cohesion: 0.05
Nodes (34): Any, Path, Register a tool definition., Decorator to register a function as an agent tool. Usage::…, Remove a tool from the registry. Returns True if removed., Look up a tool by name., Return all registered tools., Find tools that advertise a specific capability. (+26 more)
...
### Community 143 - "get_current_user"
Cohesion: 0.15
...
### Community 145 - "test_autonomous_agency_e2e.py"
Cohesion: 0.08
...
Cohesion: 0.05
Nodes (31): Return the single best adapter for *task_type*. If *preferred_runtime_id* is…, Maintains the catalogue of registered adapters and answers 'which runtimes can…, Return all adapters that can handle *task_type*, ordered by tier., RuntimeCapabilityRegistry, _audit_dispatch(), _blocked_result(), Any, TaskResult (+23 more)
...
Cohesion: 0.06
Nodes (40): E2BAdapter, Any, TaskResult, TaskSpec, Declare ``E2B_API_KEY`` as a required env dependency. The base ``preflight``…, Execute a task inside a fresh E2B sandbox. Flow: 1. Open an…, Run ``pytest`` inside the sandbox. Returns ``(output, passed)``.…, Runtime adapter that executes tasks inside an E2B sandbox. Activation:… (+32 more)
...
### Community 177 - "_resolve_user_id"
Cohesion: 0.12
Nodes (24): ephemeral_ttl_hours(), Async read of the ephemeral TTL (hours) straight from the DB., account_lifecycle(), create_company(), get_optional_company_access(), _is_ephemeral_user(), list_companies(), Company (+16 more)

### Community 178 - "_get_provider_policy"
Cohesion: 0.07
Nodes (42): _get_provider_policy(), ProviderPolicyUpdate, Read the durable provider policy from DB, falling back to a safe default.…, Editable subset of the durable provider policy (paid-provider kill switch)., Persist the durable provider policy and return the new state. Also writes to…, seed_default_providers(), _set_provider_policy(), Resolve the LLM endpoint for a named surface (task/chat/ceo/sdlc/…). Honours… (+34 more)

### Community 179 - "RuntimeManager"
Cohesion: 0.08
...
### Community 181 - "tests/conftest.py"
Cohesion: 0.08
...
### Community 189 - "ProviderConfig"
Cohesion: 0.06
Nodes (44): is_commercial_provider(), provider_access_tier(), _provider_field(), provider_sort_key(), ProviderConfig, local_brain_enabled(), local_brain_provider_config(), local_brain_status() (+36 more)
...
Cohesion: 0.06
Nodes (37): Called by APScheduler when a cron fires. Dispatches to the orchestrator. This…, _scheduler_on_fire(), ExecutionRequest, get_workflow_orchestrator(), Return the shared WorkflowOrchestrator singleton., Reset the singleton (test helper)., Canonical request to execute work through the golden path. This is the ONLY…, reset_orchestrator() (+29 more)

### Community 195 - "resolve_active_brain"
Cohesion: 0.05
Nodes (63): allow_paid_brain(), BrainResolution, provider_api_key(), Return the live API key for *provider* (env-only — never persisted)., get_active_brain_sync(), get_provider_role_tags(), _host_is_openai_compatible(), _norm() (+55 more)
...
### Community 201 - "TestStreamableHTTPTransport"
Cohesion: 0.13
...
Cohesion: 0.07
Nodes (34): AgentSessionStore, _now(), Connection, Path, Row, Safe getter for sqlite3.Row — Row supports index access but not .get()., Create a session with a caller-supplied session_id (useful for tests and…, SQLite-backed session store. Sessions and their message history are persisted… (+26 more)
...
### Community 208 - "TestAdapterMetadata"
Cohesion: 0.04
Nodes (31): AiderAdapter, Any, Adapter for Aider — TIER 3 specialized git-aware code editor., OpenCodeAdapter, Any, TaskResult, TaskSpec, Execute via OpenCode CLI: `opencode run --json <instruction>`. (+23 more)
...
Cohesion: 0.09
Nodes (35): fetch_research_alerts(), Best-effort fetch of trend alerts. Returns [] if offline or unavailable., map_initiative_to_task(), materialize_committed(), _portfolio_materialize_enabled(), portfolio_source_id(), Any, Task (+27 more)
...
Cohesion: 0.10
Nodes (27): openclaw_command(), openclaw_reverse_proxy(), openclaw_websocket(), api_route, websocket, WebSocket endpoint for iOS / mobile web UI pairing + command routing., HTTP command endpoint — same as the WebSocket command path but over POST. More…, Catch-all for /openclaw/* — returns gateway info (the WS endpoint is at… (+19 more)
...
Cohesion: 0.07
Nodes (22): _get_director(), ProviderAttempt, ProviderRouter, Any, Response, Try all models for one provider. Returns ProviderResult on success, None on…, Parse a 429/503 ``Retry-After`` header → seconds, or None. Accepts either…, Return the process TrafficDirector, or None if it is unavailable. (+14 more)
...
Cohesion: 0.07
Nodes (26): _best_cloud_primary_base(), InternalAgentAdapter, TaskResult, TaskSpec, Built-in agent loop — Nvidia NIM primary, Ollama fallback., Return runtime dependencies required by this adapter. Returns:…, Determine availability of the internal agent runtime. Checks cloud providers in…, Execute a TaskSpec using the internal AgentRunner and convert the agent's… (+18 more)
...
Cohesion: 0.05
Nodes (40): Any, One-shot self-healing pass. 1. Checks if the active brain provider is in a…, self_heal_brain_and_unblock_tasks(), BrainWatchdog, _classify_failure_cause(), get_watchdog(), _is_provider_actually_available(), Any (+32 more)

### Community 244 - "test_phase4_runtime_resilience.py"
Cohesion: 0.11
...
### Community 246 - "CompanyGraphSnapshot"
Cohesion: 0.20
Nodes (6): CompanyGraphSnapshot, A point-in-time snapshot of a Company Graph for history and rollback., Create a company graph snapshot (No-op shim for SQLite)., List snapshots for a company graph (No-op shim for SQLite)., Create a snapshot of a company graph., List snapshots for a company graph.
...
### Community 262 - "test_agent_tool_governance.py"
Cohesion: 0.04
Nodes (74): ApprovalRequest, ApprovalStatus, ApprovalStore, Any, Enum, str, packages/governance/approvals.py — human-in-the-loop for high-risk actions. The…, Bounded, in-process store of approval requests. Uses a :class:`threading.Lock`… (+66 more)
...
Cohesion: 0.06
Nodes (47): filter_output(), FilterResult, OutputFilter, agent/output_filter.py — LLM Output Compression & Token Savings Inspired by…, Filter and compress command outputs to reduce LLM token consumption. Provides…, Compact git status output — keep only changed file paths., Compact git log — one line per commit., Compact git diff — keep file headers, collapse hunks. (+39 more)
...
Cohesion: 0.13
Nodes (30): ProviderHealth, Circuit-breaker state for a provider., _make_manager(), tests/test_brain_failover.py — Universal multi-provider brain failover tests.…, Status snapshot doesn't leak API keys., Make a fresh manager (bypasses the singleton for isolation)., No API keys set → no providers in the registry., test_429_exponential_backoff() (+22 more)
...
Cohesion: 0.09
Nodes (33): create_refresh_token(), N5 dual-auth dependency: accept EITHER a user session OR a service token. Used…, _user_or_service_token(), create_access_token(), create_refresh_token(), get_current_user(), get_optional_user(), github_exchange_code() (+25 more)
...
Cohesion: 0.07
Nodes (30): build_render_router(), Any, APIRouter, BaseModel, Exception, backend/render_router.py — Render platform view for operators and agents.…, Reject anyone who is not the agency admin., Map an MCP transport failure onto 503 rather than a 500. The distinction… (+22 more)
...
Cohesion: 0.05
Nodes (50): Feed LLM token/cost spend into the governance session budget. Kept separate…, Charge sub-agent nesting depth and enforce the ``max_depth`` ceiling. Isolates…, _load(), mcp_server/governance.py — governance adapter for the MCP HTTP surface. Closes…, Write the audit row for a completed (or blocked) MCP tool call., Import the governance layer once, recording why if it is absent., record(), events_from_identity() (+42 more)
...
### Community 320 - "plan_research"
Cohesion: 0.09
Nodes (21): plan_research(), Any, field_validator, Compute the minimum sample size for a proportion estimate. Uses the standard…, Produce a structured research plan. The four Plan inputs that are typically…, The output of the **Plan** capability. A structured research plan that a…, ResearchPlan, _sample_size_for_proportion() (+13 more)
...
### Community 322 - "ApprovalGate"
Cohesion: 0.12
Nodes (12): engine(), WorkflowEngine, Contract: WorkflowEngine cannot skip the gate state machine., Contract: No code path may advance past awaiting_approval unless gate.status ==…, Create a run and manually place it in awaiting_approval., Contract: Cannot approve a run in 'pending' state., Contract: Can approve a run in 'awaiting_approval' state., Contract: Rejecting a run marks it as failed. (+4 more)
...
### Community 324 - "_mock_provider_records"
Cohesion: 0.14
...
### Community 325 - "test_repowise_intelligence.py"
Cohesion: 0.11
...
### Community 352 - "test_agent_tools.py"
Cohesion: 0.19
...
### Community 353 - "reap_expired_companies"
Cohesion: 0.14
...
Cohesion: 0.05
Nodes (40): legacy_scheduler_delete(), get_scheduler(), agent/scheduler.py — Scheduled Agent Jobs Cron-based job scheduler. Each job…, set_scheduler(), create_schedule(), delete_schedule(), get_schedule(), get_schedule_runs() (+32 more)
...
Cohesion: 0.08
Nodes (18): PR throughput per cohort over the last `days` days., Count distinct sessions per user. A session ends when there's a gap of more…, demo_agent_tracking(), datetime, Temporal context graph inspired by Graphiti…, Get history of an entity between two times, Get current state of an entity (most recent fact), Query facts with pattern matching (+10 more)
...
### Community 416 - "tools.py"
Cohesion: 0.14
Nodes (7): repowise.py — RepowiseIntelligence: context packing and dependency analysis., tools.py — WorkspaceTools: read/write/search and diff application (risky…, tools(), Test that the new tools are exposed and return strings., Test that WorkspaceTools initializes correctly., test_tools_expose_new_methods(), test_workspace_tools_initialization()
...
Cohesion: 0.04
Nodes (64): Backoff policy for retryable failures., RetryConfig, _digest(), get_ring(), KeyRing, KeyState, packages/llm/keys.py — multi-key rotation with per-key health. A provider may…, Per-provider round-robin key selection with cooldowns. (+56 more)
...
### Community 428 - "DailyDigestAggregatorTests"
Cohesion: 0.19
...
### Community 437 - "get_tool_registry"
Cohesion: 0.18
Nodes (9): get_tool_registry(), Return the module-level ToolRegistry singleton. On first call, registers built-…, auto_register(), Register the four user-research tools with a ``ToolRegistry``. Each tool wraps…, Register the user research tools into the module-level singleton registry.…, register_user_research_tools(), Registering + advertising a tool must be enough; no third edit here.…, test_registry_tools_parse_without_being_listed_statically() (+1 more)
...
### Community 439 - "weekly_digest.py"
Cohesion: 0.13
...
### Community 471 - "test_self_heal.py"
Cohesion: 0.12
...
Cohesion: 0.24
Nodes (5): db — storage abstraction layer (V2.0 Phase 5: real code moved to…, # IMPORTANT: keep these imports LAZY (inside __getattr__) so that a Mongo-only, MongoStore, db/mongo_store.py — MongoDB store backed by Motor (existing implementation).…, Thin wrapper that exposes the Motor database as collection attributes.…
...
### Community 490 - "telegram_service.py"
Cohesion: 0.16
...
### Community 492 - "DirectChatSession"
Cohesion: 0.14
...
### Community 493 - "test_ai_insights.py"
Cohesion: 0.05
...
Cohesion: 0.25
Nodes (7): 0. The NVIDIA default model was a retired id — fixed, one item left open, 1. Render is suspended for billing — this is the big one, 2. PR #1336 needs a human decision, If you pick this up next, Next Action, Nothing is blocked on an agent. Two things need a human., Running unattended, no action needed
...
### Community 524 - "kimi_bridge_provider_config"
Cohesion: 0.18
...
### Community 529 - "test_tasks_awaiting_approval_api.py"
Cohesion: 0.37
...
### Community 537 - "get_failover_manager"
Cohesion: 0.08
...
### Community 544 - "_fixture"
Cohesion: 0.02
Nodes (105): parse_event_stream(), Reduce a ``--mode json`` NDJSON stream to a :class:`ParsedRun`. Kept a module-…, base_url(), mobile_page(), proxy_url(), Config, pytest_configure(), conftest.py — pytest fixtures and configuration for the E2E test suite.… (+97 more)
...
### Community 560 - "test_telegram_task_callback.py"
Cohesion: 0.13
Nodes (13): _Captured, Load telegram_bot fresh in each test, with env vars reset., telegram_bot(), _parked_task(), asyncio, Task, Telegram inline-button callbacks for the task pre-execution gate. Regression:…, _Recorder (+5 more)
...
### Community 578 - "TestCatalogClaude5Models"
Cohesion: 0.10
...
### Community 604 - "WorkspaceManager"
Cohesion: 0.21
...
Cohesion: 0.02
Nodes (103): BusinessCategory, CompanyGraph, SystemType, Get the index of a phase in the workflow., The complete Company Graph - canonical core model for the Autonomous AI Agency.…, Find a website by its URL., Find a repository by its URL., Find all systems of a specific type. (+95 more)
...
### Community 611 - "flesch_reading_ease"
Cohesion: 0.20
...
Cohesion: 0.06
Nodes (28): livenim, Resolve the free NVIDIA NIM brain from env, or ``None`` if unconfigured.…, resolve_free_nvidia_brain(), _FakeAsyncClient, _FakeResponse, _free_env(), Free-brain policy regression tests for the agent runtime (issue #656).…, The core #656 regression: an Anthropic-shaped model must NOT hit… (+20 more)
...
Cohesion: 0.09
Nodes (31): get_brain_preference(), Return the operator's brain provider preference. Values: - ``"nvidia"`` —…, Operator can set BRAIN_PREFERENCE=colibri without it being rejected., test_get_brain_preference_accepts_colibri(), Any, Path, run_command(), _safe_allowlist() (+23 more)
...
### Community 669 - "RuntimeHealthService"
Cohesion: 0.09
...
### Community 695 - "_get_current_user"
Cohesion: 0.25
...
### Community 726 - "TestPoliciesGovernanceStableClaim"
Cohesion: 0.20
...
Cohesion: 0.04
Nodes (56): put, Update an agent. Only the owner or an admin may update., update_agent(), compute_savings(), compute_time_series(), get_savings(), get_usage(), get_user_savings() (+48 more)
...
### Community 763 - "_start_ceo_agency"
Cohesion: 0.31
...
### Community 787 - "test_e2b_data_flow.py"
Cohesion: 0.07
...
### Community 826 - "report_to_markdown"
Cohesion: 0.11
...
### Community 827 - "provider_key_present"
Cohesion: 0.25
...
Cohesion: 0.03
Nodes (91): Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., tasks — Task/issue management system. Provides a lightweight task/issue tracker…, ApprovalCheckpoint, Enum, str, tasks/models.py — Pydantic models for the task/issue system., Comment or reply on a task. (+83 more)
...
### Community 907 - "_looks_unknown_model"
Cohesion: 0.20
...
### Community 911 - "test_seo_audit_pending_expiry.py"
Cohesion: 0.43
...
### Community 916 - "test_server_autonomy_and_index_fixes.py"
Cohesion: 0.29
...
Cohesion: 0.09
Nodes (14): _nvidia_default(), parametrize, The platform-wide NVIDIA default must not be a retired model.…, ``(path, model_id)`` for every literal used as the env-var fallback., A regex that silently matched nothing would pass every assertion., ``PROVIDER_CANDIDATES['nvidia']`` is tried in order, so a dead entry is a…, Planner/executor/verifier fall back to a literal when no ``AGENT_*_MODEL`` is…, The literal fallback used when NVIDIA_DEFAULT_MODEL is unset. (+6 more)
...
### Community 961 - "TaskStore"
Cohesion: 0.04
Nodes (74): AgentDefinition, AgentStore, Any, field_validator, agents/store.py — Persistent store for user-defined agent configurations.…, CRUD store for AgentDefinition objects. Uses MongoDB when a `db` client is…, Return an agent by ID. If *owner_id* is provided, enforces that the agent…, Delete an agent. Returns True on success, False if not found/unauthorised. (+66 more)
...
### Community 998 - "TaskWorkflowService"
Cohesion: 0.04
Nodes (56): _gate_outward_facing_enabled(), _is_brain_connection_error(), _is_outward_facing(), Any, BaseException, Task, TaskResult, TaskSpec (+48 more)

### Community 999 - "backend/server.py"
Cohesion: 0.02
Nodes (208): get_harness_adapter(), AgentStatusEntry, AgentStatusResponse, AgentToolCallEntry, ApiKeyCreate, auth_me(), AuthorizeReposBody, auto_recommend_skills() (+200 more)
...
### Community 1197 - "call_llm"
Cohesion: 0.04
Nodes (56): _agent_provider_failure_response(), _agent_timeout_fallback_response(), _append_agent_session_message(), _build_auto_skill_guidance(), _build_provider_router(), _builtin_provider_records(), call_llm(), _chat_error_detail_text() (+48 more)

### Community 1198 - "llm/router.py"
Cohesion: 0.04
Nodes (69): get_cache(), The process-wide cache manager., openai_body_from_response(), Any, Whether the compat bridges should delegate to ``LLMRouter``. Reads the flag on…, Translate an OpenAI-shaped chat payload into an ``LLMRequest``. Unknown keys…, Render an ``LLMResponse`` as an OpenAI chat-completions body. Used by the…, request_from_openai_payload() (+61 more)
...
### Community 1207 - "_InMemoryErrorLogHandler"
Cohesion: 0.50
...
### Community 1219 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.25
...
### Community 1221 - "TestGetCurrentTimeTool"
Cohesion: 0.43
...
### Community 1224 - "TestWorkflowIntegration"
Cohesion: 0.33
...
- **Why does `_fixture()` connect `_fixture` to `test_provider_router.py`, `services/background.py`, `test_llm_router_queue_cache.py`, `test_crispy_workflow.py`, `test_company_api.py`, `brain_config.py`, `PolicyEngine`, `reset_kv_state`, `SelfHealingAgent`, `test_colibri_brain_shim.py`, `Task`, `Agency`, `get_failover_manager`, `PrimeAgentAdapter`, `test_provider_state_durability.py`, `CEOLedger`, `ai/router.py`, `test_llm_router_disabled.py`, `company_api.py`, `test_monitor_lib.py`, `AuditLog`, `test_openclaw_endpoints.py`, `test_unit8_model_catalog.py`, `ImprovementLoop`, `test_model_router.py`, `test_llm_router_strategies.py`, `_resolve_push_token`, `test_failover_client_shared.py`, `test_implement_agent_routing.py`, `test_ceo_router.py`, `test_telegram_task_callback.py`, `test_process_quick_note_workflow.py`, `AgentJobManager`, `SQLiteStore`, `ChatHistoryStore`, `E2BSandboxSession`, `test_telegram_auto_approve.py`, `test_autonomy_status.py`, `test_freebuff_bot.py`, `seo_api.py`, `test_local_brain_state.py`, `NotificationDispatcher`, `test_operational_incidents.py`, `test_phase5_doctor.py`, `test_refresh_agent_built_proof.py`, `loop.py`, `services/seo_audit.py`, `config.py`, `test_telegram_diag_endpoint.py`, `ResearchTask`, `failover_client.py`, `TestClient`, `resolve_e2b_config`, `test_procedural_memory.py`, `e2e/test_browser.py`, `TokenBudget`, `UserRole`, `RequestQueue`, `test_knowledge_sync.py`, `SchedulerStore`, `test_startup_warmup.py`, `SeoFixer`, `KeyStore`, `claim`, `test_context_rulebook.py`, `test_agent_free_brain.py`, `ArtifactStore`, `run_task`, `test_webui_provider_priority.py`, `test_openclaw_gateway.py`, `._check_permissions`, `test_kimi_bridge_server.py`, `provider_max_rpm`, `get_registry`, `get_current_user`, `test_autonomous_agency_e2e.py`, `test_telegram_freebuff.py`, `TestHarnessAdapter`, `MCPClient`, `test_new_features_e2e.py`, `persist_plan_spec`, `TestEstimateTokensForMessages`, `test_e2b_adapter.py`, `_Budget`, `KeyPool`, `llm/router.py`, `test_task_clarification.py`, `test_e2b_task_wiring.py`, `test_doctor_coding_brain.py`, `tests/conftest.py`, `OllamaCircuitBreaker`, `analyze_page`, `_clear_cache`, `sam`, `test_features_api.py`, `test_video_transcript.py`, `ExecutionRequest`, `resolve_active_brain`, `test_task_store_fails_loud_in_production.py`, `TrendWatcher`, `test_agile_api.py`, `test_app_settings.py`, `test_agent_scripts_share_one_model_list.py`, `test_portfolio_intake.py`, `test_trend_watcher.py`, `AgentSwarm`, `test_nvidia_model_discovery.py`, `api_keys_for`, `TestClient`, `ContextPruner`, `BrainWatchdog`, `WorkflowRun`, `test_daily_2026_07_27.py`, `_start_ceo_agency`, `TestSwarmRoleRouting`, `test_persistent_memory.py`, `SecurityScanner`, `test_agent_tool_governance.py`, `test_crispy_run_history.py`, `test_llm_router_e2e.py`, `OutputFilter`, `test_platform_controls.py`, `test_e2b_data_flow.py`, `test_scheduler_hydration_bounded.py`, `_resolve_user_github_token`, `test_rate_limiter.py`, `test_mcp_governance.py`, `test_sam_voice.py`, `OrchestratorQueue`, `test_purge_backlog.py`, `enforcement.py`, `ApprovalGate`, `_mock_provider_records`, `session_retro.py`, `test_crispy_burn_in.py`, `test_provider_enable_disable.py`, `test_skill_registry_boot_refresh.py`, `reap_expired_companies`, `isolated_telegram_config`, `get_scheduler`, `test_claude_code_adapter.py`, `test_service_token.py`, `test_brain_patch_service_token.py`, `test_harness_spec.py`, `test_ping.py`, `test_telegram_service_webhook.py`, `test_dashboard_cache.py`, `control_overrides.py`, `test_regression.py`, `test_agency_fix.py`, `tools.py`, `test_v4_api.py`, `apply_review.py`, `client`, `TaskStore`, `TestMongoGate`, `test_voice_pipeline.py`, `_job_text`, `cost_tracker.py`, `TestNormalizeResponseFormat`, `TestFeaturesAPI`, `TaskWorkflowService`, `test_runtimes_health_endpoint.py`, `test_ai_insights.py`, `test_sam_livekit.py`?**
  _High betweenness centrality (0.118) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `test_agent_free_brain.py`, `proxy.py`, `test_agent_tool_governance.py`, `TaskSpec`, `ReactScratchpad`, `PolicyEngine`, `CEODispatcher`, `test_autonomous_agency_e2e.py`, `ContextManager`, `Agency`, `get_failover_manager`, `MCPClient`, `test_e2b_adapter.py`, `MultiAgentSwarm`, `_resolve_push_token`, `test_failover_client_shared.py`, `StuckDetector`, `call_llm`, `WorkspaceTools`, `test_governance_api.py`, `workflow_orchestrator.py`, `AgentJobManager`, `E2BSandboxSession`, `enforcement.py`, `TestAgentRunnerExecution`, `test_empirical_verify.py`, `TestGetCurrentTimeTool`, `loop.py`, `AgentSessionStore`, `UserMemoryStore`, `TokenBudget`, `LocalWorkspace`, `backend/server.py`, `InternalAgentAdapter`, `GitHubTools`, `AdaptiveHalter`, `ContextPruner`, `direct_chat.py`, `test_daily_automation_2026_07_11.py`, `WorkflowRun`, `FreeBuffAgent`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `WorkspaceManager` connect `WorkspaceManager` to `.list_workspaces`, `_safe_resolve`, `.test_concurrent_create_same_session`, `TaskSpec`, `.get_workspace`, `test_workspace_isolation.py`, `_hash_component`, `diagnostics.py`, `dry_clone_repo`, `WorkspaceMetrics`, `validate_job_id`, `WorkspaceManifest`, `validate_session_id`?**
