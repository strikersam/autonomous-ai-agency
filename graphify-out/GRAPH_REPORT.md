# Graph Report - local-llm-server  (2026-09-01)

## Corpus Check
- 1462 files · ~2,123,761 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 29766 nodes · 55187 edges · 1284 communities (1106 shown, 123 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 2699 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3a807863`
...
## Communities (1284 total, 123 thin omitted)

### Community 0 - "backend/server.py"
Cohesion: 0.02
Nodes (257): admin_seed(), _agent_timeout_fallback_response(), AgentStatusEntry, AgentStatusResponse, AgentToolCallEntry, ApiKeyCreate, auth_me(), AuthorizeReposBody (+249 more)

### Community 1 - "company_api.py"
Cohesion: 0.02
Nodes (131): create_company(), delete_company_endpoint(), get_company_graph(), _get_current_user_thunk(), _get_optional_user_thunk(), provision_specialist(), delete, patch (+123 more)

### Community 2 - "TaskSpec"
Cohesion: 0.03
Nodes (116): kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, TaskResult, TaskSpec, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Run aider non-interactively via `--message` flag., runtimes/adapters/claude_code.py — Claude Code CLI adapter (FIRST CLASS).…, runtimes/adapters/docker_agent.py — Docker-based agent runtime adapter. Spawns… (+108 more)

### Community 3 - "proxy.py"
Cohesion: 0.03
Nodes (158): get_sam(), middleware, admin_control(), admin_login(), admin_logout(), admin_status(), AdminControlBody, AdminLoginBody (+150 more)

### Community 4 - "WebsiteScanner"
Cohesion: 0.02
Nodes (118): DetectedSystem, Evidence, OnboardingProgress, Result of a website scan with detected systems and stack inference., Evidence supporting a system detection., Tracks the onboarding progress for a company., Result of a repository scan with detected stack and systems., A business system detected on a company's website or in their stack. (+110 more)

### Community 5 - "llm/router.py"
Cohesion: 0.02
Nodes (124): _load(), main(), int, get_cache(), payload_key(), Exact-match cache key over the fields that change the answer. Routing…, The process-wide cache manager., failover_chat_completion_via_router() (+116 more)

### Community 6 - "TaskStore"
Cohesion: 0.03
Nodes (118): packages/ai/self_heal.py — automatic brain self-healing. When the active brain…, Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., tasks — Task/issue management system. Provides a lightweight task/issue tracker…, Enum, str, tasks/models.py — Pydantic models for the task/issue system., Comment or reply on a task. (+110 more)
...
Cohesion: 0.02
Nodes (96): HealthConfig, Backoff policy for retryable failures., Circuit breaker + health tracking thresholds., RetryConfig, BreakerState, HealthTracker, _Outcome, ProviderHealth (+88 more)

### Community 9 - "resolve_identity"
Cohesion: 0.03
Nodes (107): _egress_policy_reason(), agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Return why governance policy blocks *host*, or None. Runs strictly *after* the…, guard(), _load(), mcp_server/governance.py — governance adapter for the MCP HTTP surface. Closes…, Evaluate *tool* before it runs. Returns ``(allowed, message, decision)``.…, Import the governance layer once, recording why if it is absent. (+99 more)

### Community 10 - "AnthropicProvider"
Cohesion: 0.04
Nodes (68): AnthropicProvider, Any, AsyncClient, packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, Translate OpenAI-shaped messages into Anthropic's system/turn split., OpenAI carries a tool result as role="tool" with a tool_call_id; Anthropic…, OpenAI puts a tool call alongside the assistant's text; Anthropic needs…, Return the cache_control block appropriate for this provider's TTL setting.… (+60 more)

### Community 11 - "TaskWorkflowService"
Cohesion: 0.03
...
Cohesion: 0.03
Nodes (114): Call-time resolver for an agent role model id. Delegates to…, _resolve_role_model(), _active_primary_provider(), BrainConfig, BrainConfigPatch, BrainConfigStore, default_brain_config(), get_brain_config() (+106 more)

### Community 13 - "AgentSessionStore"
Cohesion: 0.03
Nodes (84): PreflightIssue, PreflightReport, BaseModel, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, Agent subsystem — planner / executor / verifier loop., AgentEvent, AgentPlan, AgentRunRequest (+76 more)

### Community 14 - "seo_api.py"
Cohesion: 0.03
Nodes (121): account_lifecycle(), AccountLifecycleResponse, auto_recommend_skills(), cancel_onboarding(), _DoctorCheck, _DoctorReport, generate_onboarding_questions(), get_company() (+113 more)
...
Cohesion: 0.05
Nodes (76): Agency, AgentRole, get_agency(), _parse_ceo_directives(), str, CEO-coordinated multi-agent agency for continuous codebase management. The CEO…, set_agency(), DetectedIssue (+68 more)
...
### Community 25 - "test_user_research_skill.py"
Cohesion: 0.04
...
### Community 28 - "SpecialistService"
Cohesion: 0.03
Nodes (58): get_skill(), list_skills(), List all available skills with optional filtering. Returns the skill catalog…, Get a single skill by its ID., build_matrix(), _families(), main(), Any (+50 more)
...
### Community 30 - "AgentRunner"
Cohesion: 0.04
Nodes (49): AgentRunner, _check_extra_kwargs(), _enforce_signature(), Any, Path, Raise TypeError if fn's signature drifts from the locked contract (Pydantic…, Raise TypeError on unknown kwarg (runtime extra='forbid' for non-Pydantic…, Governance seam: judge the call, run it, audit the outcome. Deliberately a thin… (+41 more)

### Community 31 - "test_ceo_dispatcher.py"
Cohesion: 0.03
Nodes (85): _decompose_into_subtasks(), get_ceo_dispatcher(), _merge_changed_files(), Return the shared CEODispatcher singleton., Reset the singleton (test helper)., Decompose a request into 2-3 sub-tasks for specialist fan-out. Default…, Collect changed_files across all specialists into a single de-duped list., reset_ceo_dispatcher() (+77 more)

### Community 32 - "services/seo_audit.py"
Cohesion: 0.05
Nodes (60): BaseModel, field_validator, models/seo_audit.py - SEO / GEO / AIO Audit Contracts Typed Pydantic models for…, A single occurrence of a check firing on a specific URL., Snapshot of one crawled page with the on-page facts the checks used., Aggregated report row - Screaming Frog CSV compatible., Site-level facts discovered during the crawl., Static definition of a single audit check (catalog entry). (+52 more)
...
### Community 38 - "get_task_store"
Cohesion: 0.04
Nodes (80): quick_notes_submit(), _QuickNoteBody, The task store the background services should use, wiring it if needed.…, Point the feature stores at the shared database connection. Deliberately…, Submit a quick-note URL or instruction from the dashboard FAB., _task_store_for_background(), _wire_feature_stores(), get_failover_manager() (+72 more)
...
### Community 40 - "test_governance_enforcement.py"
Cohesion: 0.04
Nodes (73): Recursively strip secrets from an arbitrary argument structure. Fails…, scrub(), BudgetTracker, classify(), GovernanceGate, _host_of(), Extract a hostname from a URL, or return a bare host unchanged., Per-session consumption counters and their ceilings. Ceilings come from the… (+65 more)

### Community 41 - "test_llm_router_strategies.py"
Cohesion: 0.06
Nodes (76): count, Strategy selection and degradation behaviour., RoutingConfig, adaptive(), automatic_failover(), Candidate, context_length_optimized(), cost_optimized() (+68 more)
...
### Community 43 - "test_agent_tool_governance.py"
Cohesion: 0.04
...
### Community 44 - "InternalAgentAdapter"
Cohesion: 0.03
Nodes (64): _best_cloud_primary_base(), InternalAgentAdapter, TaskResult, TaskSpec, Built-in agent loop — Nvidia NIM primary, Ollama fallback., Return runtime dependencies required by this adapter. Returns:…, Determine availability of the internal agent runtime. Checks cloud providers in…, Execute a TaskSpec using the internal AgentRunner and convert the agent's… (+56 more)
...
Cohesion: 0.03
Nodes (38): requires_db, Initialize the service. Args: store: Optional CompanyGraphStore instance. If…, CompanyGraphStore, Delete a company and all its associated data., List companies with optional filtering., Count total companies in the store., Create a new company graph., Get the complete company graph for a company. (+30 more)
...
### Community 51 - "seo_portfolio_bridge.py"
Cohesion: 0.05
...
### Community 52 - "activation_api.py"
Cohesion: 0.05
...
### Community 54 - "test_ceo_supervision.py"
Cohesion: 0.06
...
### Community 60 - "services/background.py"
Cohesion: 0.05
Nodes (63): get_improvement_loop(), get_skill_registry_safe(), Return the global SkillRegistry if set, else None. Used by onboarding and other…, get_trend_watcher(), agent/trend_watcher.py — Internet-connected AI trend intelligence. Fetches from…, set_trend_watcher(), build_ceo_router(), Any (+55 more)

### Community 61 - "RuntimeCapabilityRegistry"
Cohesion: 0.05
...
### Community 66 - "AgentJobManager"
Cohesion: 0.05
Nodes (33): AgentJob, AgentJobManager, make_isolated_workspace(), _now(), Any, Path, agent/job_manager.py — Async agent job lifecycle manager. Manages agent jobs…, Run a job using the provided runner and update the job's lifecycle, progress,… (+25 more)

### Community 67 - "HybridSystem"
Cohesion: 0.05
...
### Community 72 - "_resolve_brain_provider"
Cohesion: 0.05
...
### Community 77 - "test_procedural_memory.py"
Cohesion: 0.05
...
### Community 78 - "Artifact"
Cohesion: 0.06
Nodes (40): AgentRole, When coder == reviewer model, swarm should log a warning., _fake_artifact(), tests/test_crispy_workflow.py — CRISPY workflow engine hardening tests. Tests…, TestPhaseSequenceError, tests/test_workflow_models.py — Unit tests for workflow/models.py., TestCheckRun, TestSlice (+32 more)
...
### Community 80 - "resolve_e2b_config"
Cohesion: 0.05
...
### Community 85 - "test_llm_router_e2e.py"
Cohesion: 0.06
Nodes (51): get_tracker(), The process-wide health tracker., get_metrics(), The process-wide metrics registry., _ok(), parametrize, End-to-end routing against mock providers (ADR-008). These are the tests that…, A router wired to three mock providers, with all singletons isolated. (+43 more)

### Community 86 - "TestAdapterMetadata"
Cohesion: 0.05
Nodes (24): AiderAdapter, Any, Adapter for Aider — TIER 3 specialized git-aware code editor., OpenCodeAdapter, Any, TaskResult, TaskSpec, Execute via OpenCode CLI: `opencode run --json <instruction>`. (+16 more)
...
### Community 89 - "probe_model_liveness"
Cohesion: 0.05
Nodes (45): provider_base_url(), Return the OpenAI-compatible base URL for *provider* (env- and UI-aware)., _describe_http_status(), _is_dns_failure(), _probe_failure_reason(), probe_model_liveness(), _probe_ollama(), _probe_openai_compat() (+37 more)

### Community 90 - "test_agent_runner.py"
Cohesion: 0.05
...
Cohesion: 0.07
Nodes (44): CEODispatcher, CEOResult, _complexity_rank(), _offload(), Any, Semaphore, services/ceo_dispatcher.py — Real CEO delegation layer. The CEO splits a…, Run a synchronous ledger call without blocking the event loop. ``CEOLedger`` is… (+36 more)
...
### Community 95 - "TestExtendedCacheTTL"
Cohesion: 0.06
...
### Community 97 - "configuration-reference.md"
Cohesion: 0.05
Nodes (31): Agent Readiness Report, Build System — 100/100, Dev Environment — 100/100, Documentation — 100/100, Observability — 100/100, Security — 100/100, Style And Validation — 100/100, Task Discovery — 100/100 (+23 more)

### Community 98 - "clear_cooldowns"
Cohesion: 0.06
...
### Community 99 - "test_knowledge_sync.py"
Cohesion: 0.08
...
### Community 108 - "get_self_healing_agent"
Cohesion: 0.07
...
Cohesion: 0.06
Nodes (40): Charge sub-agent nesting depth and enforce the ``max_depth`` ceiling. Isolates…, events_from_identity(), Any, Convenience: build and record an event in one call., Extract the identity-derived audit fields from an AgentIdentity. Kept here…, record_event(), BudgetExceeded, evaluate_call() (+32 more)
...
### Community 118 - "portfolio_intelligence.py"
Cohesion: 0.06
...
### Community 120 - "TestHarnessAdapter"
Cohesion: 0.05
...
### Community 124 - "test_llm_router_tpm.py"
Cohesion: 0.06
Nodes (46): build_summariser(), estimate_tokens(), FitResult, message_tokens(), prune(), Any, packages/llm/context.py — keeping conversations inside the context window. The…, Truncate oversized tool results and drop exact duplicate turns. Tool results… (+38 more)

### Community 125 - "render_ops.py"
Cohesion: 0.05
...
### Community 129 - "failover_client.py"
Cohesion: 0.06
...
### Community 134 - "test_provider_router.py"
Cohesion: 0.06
...
### Community 135 - "test_brain_failover.py"
Cohesion: 0.07
...
Cohesion: 0.08
Nodes (28): Any, Connection, Path, PhaseType, WorkflowRun, CRISPY workflow engine — phase sequencer + gate controller. GATE: Golden Path…, Return the AgentSwarm singleton if available, else None., Append an event to the workflow event log. (+20 more)

### Community 139 - "AutonomyTracker"
Cohesion: 0.05
...
Cohesion: 0.07
Nodes (48): get_approval_store(), Replace the process-wide gate. Tests only., reset_gate(), _client(), parametrize, TestClient, Tests for the governance HTTP surface and the AgentRunner integration. The…, The tool that makes turning on enforcement safe. (+40 more)

### Community 145 - "test_trend_scoping.py"
Cohesion: 0.10
...
### Community 146 - "PortfolioManager"
Cohesion: 0.05
...
### Community 149 - "test_schedule_growth_invariants.py"
Cohesion: 0.05
...
### Community 154 - "test_response_cache.py"
Cohesion: 0.12
...
### Community 158 - "_get_provider_policy"
Cohesion: 0.06
...
### Community 165 - "ProvidersScreen.jsx"
Cohesion: 0.05
...
### Community 166 - "probe_catalogues.py"
Cohesion: 0.07
Nodes (31): _auth_headers(), _chat_targets(), _dump_matching(), _kind(), list_models(), _list_or_report(), main(), _parse_args() (+23 more)

### Community 167 - "resolve_active_brain"
Cohesion: 0.09
Nodes (45): BrainResolution, provider_api_key(), Return the live API key for *provider* (env-only — never persisted)., get_active_brain_sync(), get_brain_preference(), get_provider_role_tags(), _host_is_openai_compatible(), _norm() (+37 more)

### Community 168 - "KeyPool"
Cohesion: 0.06
...
### Community 170 - "test_runtime_governance.py"
Cohesion: 0.11
...
### Community 174 - "TaskBoardScreen.jsx"
Cohesion: 0.05
...
### Community 180 - "TestAuthAndTaskOwnership"
Cohesion: 0.05
...
### Community 186 - "test_portfolio_intake.py"
Cohesion: 0.08
...
### Community 191 - "TestBrainFailoverModelUpdates"
Cohesion: 0.08
...
### Community 194 - "test_video_transcript.py"
Cohesion: 0.05
...
### Community 201 - "WorkflowBuildRequest"
Cohesion: 0.07
...
### Community 205 - "Persistent Memory System"
Cohesion: 0.05
...
### Community 213 - "fmtErr"
Cohesion: 0.07
Nodes (26): chatSend(), fmtErr(), getAgentChatJob(), getDefaultBackendUrl(), getMe(), getSession(), listSessions(), login() (+18 more)

### Community 214 - "ai/router.py"
Cohesion: 0.07
Nodes (37): _dead_model_key(), _exponential_backoff_cooldown(), _mark_model_dead(), _notify_watchdog(), provider_router.py — auto-generated module docstring (user-research skill scan)., Notify the brain watchdog of a provider call outcome (fire-and-forget).…, # NOTE: 429 and 410 are handled specially in _try_one_provider (immediate, Compute exponential backoff cooldown for repeated 429 failures. Each… (+29 more)
...
### Community 223 - "TestEstimateTokensForMessages"
Cohesion: 0.06
...
### Community 224 - "TrafficDirector"
Cohesion: 0.08
Nodes (17): get_director(), _ProviderUsage, Sliding-window usage counters for one provider., In-process traffic distribution and budget accounting for providers., Drop request/token events that have fallen out of the window., Count a request that is about to be sent to *provider_id*. Called immediately…, Record the outcome of a request started with ``record_start``. Must be called…, Count a request that was routed away from *provider_id* (diagnostics). (+9 more)

### Community 225 - "AdminIdentity"
Cohesion: 0.07
...
### Community 231 - "system_instruction"
Cohesion: 0.09
...
### Community 238 - "test_operational_incidents.py"
Cohesion: 0.06
...
### Community 242 - "test_control_plane_api.py"
Cohesion: 0.06
...
### Community 247 - "test_verification_strategies.py"
Cohesion: 0.11
...
### Community 248 - "ensure_self_company"
Cohesion: 0.10
Nodes (34): autonomy_status(), Public autonomy readiness probe — no authentication required. A live deploy…, get_company_agency_service(), Get the singleton CompanyAgency service instance., _count_specialists(), _create_company_directly(), ensure_self_company(), _find_self_company() (+26 more)
...
### Community 250 - "test_daily_2026_06_04.py"
Cohesion: 0.09
...
### Community 255 - "test_all_providers_discovery.py"
Cohesion: 0.16
...
### Community 258 - "test_unit7_catalog_propagation.py"
Cohesion: 0.06
...
### Community 259 - "report_to_markdown"
Cohesion: 0.10
...
### Community 266 - "agent_runtime.py"
Cohesion: 0.10
...
### Community 270 - "local_controller.py"
Cohesion: 0.12
...
### Community 271 - "NotificationDispatcher"
Cohesion: 0.09
...
### Community 277 - "LlmProviderConfig"
Cohesion: 0.15
...
### Community 280 - "RateLimitTracker"
Cohesion: 0.10
...
### Community 286 - "local_brain_router.py"
Cohesion: 0.10
Nodes (30): get_local_brain_state(), HeartbeatBody, post_local_brain_heartbeat(), post_local_brain_toggle(), Any, BaseModel, get, post (+22 more)

### Community 287 - "OrchestratorSupervisor"
Cohesion: 0.10
...
### Community 289 - "Langfuse Observability Guide"
Cohesion: 0.06
...
### Community 291 - "webui/router.py"
Cohesion: 0.09
Nodes (30): allow_paid_brain(), True only when the operator explicitly opted into a paid (Anthropic) brain.…, test_allow_paid_brain_default_false(), Any, Path, run_command(), _safe_allowlist(), validate_command() (+22 more)
...
### Community 294 - "OrchestratorCheckpointStore"
Cohesion: 0.09
...
### Community 307 - "test_failover_silent_exhaustion.py"
Cohesion: 0.11
...
### Community 309 - "CompanyAgencyService"
Cohesion: 0.09
...
### Community 311 - "test_colibri_brain_shim.py"
Cohesion: 0.08
...
### Community 313 - "test_autonomy_gate.py"
Cohesion: 0.12
...
### Community 314 - "openclaw_gateway.py"
Cohesion: 0.09
...
### Community 316 - "output_filter.py"
Cohesion: 0.07
...
### Community 319 - "RuntimeHealthService"
Cohesion: 0.09
...
### Community 324 - "test_force_cleanup_conditional_delete.py"
Cohesion: 0.10
...
### Community 330 - "control_registry.py"
Cohesion: 0.12
...
### Community 331 - "SteeringInjector"
Cohesion: 0.11
...
### Community 333 - "test_brain_config_api.py"
Cohesion: 0.08
Nodes (24): _catalogue_candidates(), _catalogue_role_preset(), _catalogue_safe_default(), tests/test_brain_config_api.py — admin endpoint contract tests. Pins the…, The role preset the catalogue defines, not a literal copy of it. Two tests here…, The rotation as the catalogue defines it, after the YAML override.…, Reiterates the security contract: no key value ever appears in the response., A model that 410s must be rejected with 422 + a probe report. (+16 more)
...
### Community 336 - "Python Dependencies (`requirements.txt`)"
Cohesion: 0.07
...
### Community 337 - "Technical Debt Register — local-llm-server"
Cohesion: 0.07
...
### Community 338 - "_require_admin"
Cohesion: 0.07
Nodes (28): BrainTestRequest, clear_cost_attribution(), clear_response_cache(), get_brain_policy_route(), legacy_scheduler_toggle(), LegacyScheduleToggleRequest, patch_brain_policy_route(), purge_backlog() (+20 more)

### Community 339 - "get_scheduler"
Cohesion: 0.12
Nodes (26): legacy_scheduler_create(), legacy_scheduler_delete(), LegacyScheduleJobRequest, get_scheduler(), create_schedule(), delete_schedule(), get_schedule(), get_schedule_runs() (+18 more)

### Community 340 - "FeatureEntry"
Cohesion: 0.08
...
### Community 341 - "SetupWizardPage.js"
Cohesion: 0.10
...
### Community 355 - "test_anthropic_refusal_fallback.py"
Cohesion: 0.15
...
### Community 356 - "_captured_request_headers"
Cohesion: 0.13
...
### Community 357 - "test_phase6_workflow.py"
Cohesion: 0.15
...
### Community 358 - "test_scheduler_hydration_bounded.py"
Cohesion: 0.09
...
### Community 359 - "validate_outbound_url"
Cohesion: 0.14
...
### Community 364 - "LLM Router — troubleshooting"
Cohesion: 0.08
...
### Community 366 - "control_overrides.py"
Cohesion: 0.11
...
### Community 371 - "test_provider_enable_disable.py"
Cohesion: 0.10
...
### Community 372 - "test_telegram_mutating_commands.py"
Cohesion: 0.08
...
### Community 375 - "open_phase_report"
Cohesion: 0.10
...
### Community 377 - "WorkspaceManager"
Cohesion: 0.11
...
### Community 379 - "test_dashboard_cache.py"
Cohesion: 0.12
...
### Community 389 - "test_claude_code_adapter.py"
Cohesion: 0.14
...
### Community 391 - "_InMemoryBackend"
Cohesion: 0.11
...
### Community 394 - "TestDetectedSystemPersistence"
Cohesion: 0.09
...
### Community 397 - "test_service_token.py"
Cohesion: 0.08
...
### Community 399 - "WorkspaceManager"
Cohesion: 0.19
...
### Community 403 - "operational_incidents.py"
Cohesion: 0.12
...
### Community 406 - "test_autonomous_agency_e2e.py"
Cohesion: 0.09
...
### Community 414 - "Native operations"
Cohesion: 0.09
...
### Community 418 - "test_webui_provider_priority.py"
Cohesion: 0.21
...
### Community 421 - "platform_controls_router.py"
Cohesion: 0.11
...
### Community 427 - "provider_max_rpm"
Cohesion: 0.13
...
### Community 429 - "WindowsServiceManager"
Cohesion: 0.18
...
### Community 430 - "SyntheticDataPipeline"
Cohesion: 0.13
...
### Community 431 - "test_all_features.py"
Cohesion: 0.09
...
### Community 461 - "self_heal_brain_and_unblock_tasks"
Cohesion: 0.10
...
### Community 464 - "test_issue_triage.py"
Cohesion: 0.17
...
### Community 465 - "test_agent_free_brain.py"
Cohesion: 0.10
...
### Community 467 - "run_trend_analysis"
Cohesion: 0.18
...
### Community 468 - "test_unit5_ui_provider_surface.py"
Cohesion: 0.10
...
### Community 470 - "PersistentMemoryStore"
Cohesion: 0.24
...
### Community 472 - "Design Audit"
Cohesion: 0.10
Nodes (19): Code Quality, Color and Surfaces, Component Patterns, Content, Design Audit, Fix Priority, How This Works, Iconography (+11 more)

### Community 473 - "Findings"
Cohesion: 0.10
...
### Community 477 - "Docker AI Governance Audit — Final Report"
Cohesion: 0.10
...
### Community 478 - "1. Capability-by-capability"
Cohesion: 0.10
...
### Community 480 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 488 - "reap_expired_companies"
Cohesion: 0.16
...
### Community 491 - "PriorityTaskQueue"
Cohesion: 0.15
...
### Community 492 - "test_freebuff_bot.py"
Cohesion: 0.12
...
### Community 496 - "test_tasks_cache_ttl_env.py"
Cohesion: 0.21
...
### Community 497 - "test_voice_pipeline.py"
Cohesion: 0.14
...
### Community 512 - "resolve_free_nvidia_brain"
Cohesion: 0.12
...
### Community 517 - "test_task_source_id_race.py"
Cohesion: 0.17
...
### Community 518 - "TelegramBotManager"
Cohesion: 0.12
...
### Community 522 - "test_one_model_catalogue.py"
Cohesion: 0.14
...
### Community 523 - "validate_session_id"
Cohesion: 0.16
...
### Community 532 - "test_minimax_bug_fixes.py"
Cohesion: 0.13
...
### Community 537 - "FeatureUnavailableError"
Cohesion: 0.12
...
### Community 539 - "Delegation Plan (agent-ready work packages)"
Cohesion: 0.11
...
### Community 547 - "test_telegram_service_webhook.py"
Cohesion: 0.18
...
### Community 549 - "test_contract_enforcement.py"
Cohesion: 0.17
...
### Community 559 - "SkillsScreen.jsx"
Cohesion: 0.12
...
### Community 560 - "autonomous_fix.py"
Cohesion: 0.20
...
### Community 566 - "test_activation_api.py"
Cohesion: 0.21
...
### Community 567 - "TestAListingFailureDoesNotVetoTheAnswer"
Cohesion: 0.17
...
### Community 568 - "test_daily_automation_2026_07_11.py"
Cohesion: 0.15
...
### Community 576 - "hermes_prompt.py"
Cohesion: 0.19
...
### Community 578 - "MemoryMiddleware"
Cohesion: 0.17
...
### Community 581 - "Skill: repowise-intelligence"
Cohesion: 0.12
...
### Community 584 - "Skill: repowise-intelligence"
Cohesion: 0.12
Nodes (15): 1. Graph Intelligence (Dependency Graph), 2. Git Intelligence, 3. Documentation Intelligence, 4. Decision Intelligence, Acceptance Checks, Directory Structure, Example Usage, Implementation Approach (+7 more)
...
### Community 601 - "_process_task_callback"
Cohesion: 0.28
...
### Community 602 - "test_agency_workflows_carry_the_failover_chain.py"
Cohesion: 0.18
...
### Community 603 - "test_autonomy_status.py"
Cohesion: 0.12
...
### Community 604 - "test_brain_failover_413.py"
Cohesion: 0.13
...
### Community 605 - "DailyDigestAggregatorTests"
Cohesion: 0.19
...
### Community 606 - "test_dockerfile_ships_root_modules.py"
Cohesion: 0.17
...
### Community 607 - "test_langfuse_agency_wide.py"
Cohesion: 0.12
...
### Community 610 - "test_nvidia_default_model.py"
Cohesion: 0.17
...
### Community 613 - "test_telegram_diag_endpoint.py"
Cohesion: 0.12
...
### Community 625 - "_check_storage_health"
Cohesion: 0.13
...
### Community 637 - "DecisionsStore"
Cohesion: 0.30
Nodes (3): DecisionsStore, Any, Connection

### Community 638 - "clear_wizard_state_cache"
Cohesion: 0.21
...
### Community 639 - "e2e/test_browser.py"
Cohesion: 0.23
...
### Community 642 - "test_scanner_live.py"
Cohesion: 0.23
...
### Community 643 - "test_tasks_awaiting_approval_api.py"
Cohesion: 0.33
...
### Community 659 - "Nothing is blocked on an agent. Two things need a human."
Cohesion: 0.14
...
### Community 668 - "nvidia_models.py"
Cohesion: 0.20
...
### Community 670 - "_parse_reset_epoch"
Cohesion: 0.21
...
### Community 671 - "is_anthropic_base_url"
Cohesion: 0.18
...
### Community 674 - "telegram_service.py"
Cohesion: 0.16
...
### Community 675 - "test_critical_flows.py"
Cohesion: 0.29
...
### Community 676 - "TestAnthropicToolListCaching"
Cohesion: 0.34
...
### Community 677 - "test_autonomy_pipeline_regressions.py"
Cohesion: 0.15
...
### Community 681 - "test_openclaw_gateway.py"
Cohesion: 0.14
...
### Community 682 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 711 - "_is_bedrock_model_id"
Cohesion: 0.27
...
### Community 712 - "test_llm_router_compat.py"
Cohesion: 0.22
...
### Community 714 - "Agent Transparency Report"
Cohesion: 0.15
...
### Community 715 - "update_provider_policy"
Cohesion: 0.19
...
### Community 718 - "TestModelCostTableUpdates"
Cohesion: 0.26
...
### Community 719 - "TestMCPClientStructuredOutput"
Cohesion: 0.31
...
### Community 720 - "test_deploy_trigger_covers_image.py"
Cohesion: 0.21
...
### Community 721 - "TestRuntimeControl"
Cohesion: 0.15
...
### Community 722 - "TestTheGatewayRegistryOffersOnlyLiveModels"
Cohesion: 0.22
...
### Community 725 - "test_quick_note_engine.py"
Cohesion: 0.17
...
### Community 726 - "TestRouterIntegration"
Cohesion: 0.31
...
### Community 727 - "WorkspaceManifest"
Cohesion: 0.17
...
### Community 728 - "skill_registry.py"
Cohesion: 0.17
...
### Community 730 - "AGENTS.md — Codebase Map & Operations Reference"
Cohesion: 0.17
...
### Community 735 - "Skill: system-prompt-audit"
Cohesion: 0.17
...
### Community 736 - "Skill: task-alive-updates"
Cohesion: 0.17
...
### Community 739 - "_is_ephemeral_user"
Cohesion: 0.27
...
### Community 740 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 743 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 745 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 746 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 747 - "Workspace Isolation Architecture"
Cohesion: 0.17
...
### Community 748 - "Quantization Internals"
Cohesion: 0.17
...
### Community 749 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 750 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 751 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 755 - "install-agents.sh"
Cohesion: 0.39
...
### Community 756 - "check_container_posture.py"
Cohesion: 0.26
...
### Community 757 - "test_pytest_failure_parser.py"
Cohesion: 0.23
...
### Community 758 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 759 - "test_admin_local_brain_router.py"
Cohesion: 0.29
...
### Community 763 - "TestAnthropicWorkspaceIdCapture"
Cohesion: 0.33
...
### Community 764 - "TestAuthAndTaskCreation"
Cohesion: 0.17
...
### Community 765 - "test_task_clarification.py"
Cohesion: 0.17
...
### Community 772 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 775 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 776 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 778 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 781 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 782 - "Main proxy (`proxy.py`)"
Cohesion: 0.18
...
### Community 783 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 784 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 785 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 786 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 787 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 788 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 792 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 793 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 804 - "test_agent_readiness_audit.py"
Cohesion: 0.18
...
### Community 806 - "TestBackgroundAgentDispatch"
Cohesion: 0.24
...
### Community 807 - "TestAgentRunnerSafety"
Cohesion: 0.24
...
### Community 808 - "_FakeCommandResult"
Cohesion: 0.22
...
### Community 812 - "TestNoNvidiaFallbackIsRetired"
Cohesion: 0.22
...
### Community 818 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 819 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 820 - "admin_local_brain_router.py"
Cohesion: 0.22
...
### Community 822 - "_normalize_tool_choice"
Cohesion: 0.31
...
### Community 823 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 824 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 825 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 826 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 827 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 828 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 829 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 831 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 832 - "LLM Router — configuration guide"
Cohesion: 0.20
...
### Community 833 - "LLM Router — provider guide"
Cohesion: 0.20
...
### Community 837 - "build_tech_db.py"
Cohesion: 0.40
...
### Community 840 - "flesch_reading_ease"
Cohesion: 0.24
...
### Community 841 - "TestExtendedThinkingRouting"
Cohesion: 0.20
...
### Community 844 - "TestPoliciesGovernanceStableClaim"
Cohesion: 0.20
...
### Community 853 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 855 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 857 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 858 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 859 - "Skill: changelog-enforcer"
Cohesion: 0.22
Nodes (8): Acceptance Checks, Changelog Location, Entry Format, Examples, Hook Behaviour, Instructions, Skill: changelog-enforcer, When to Use

### Community 860 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
Nodes (8): Branch, Components, Purpose, Quick Start, Session Roles, Skill: cowork-session (Claude Cowork), Testing, When to Use

### Community 861 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 864 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 865 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 866 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 867 - "Issue #1356: quick-note:https://searchengineland.com/turn-seo-backlog-into-roadmap-485713"
Cohesion: 0.22
...
### Community 868 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 869 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 870 - "Platform Controls"
Cohesion: 0.22
...
### Community 871 - "Release Procedure"
Cohesion: 0.22
...
### Community 872 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 874 - "frontend/package.json"
Cohesion: 0.22
Nodes (8): jest, moduleNameMapper, ^react-router$, ^react-router-dom$, name, private, proxy, version

### Community 875 - "TestTheProducersAndTheParserCannotDrift"
Cohesion: 0.25
...
### Community 881 - "enrich_quick_note_issues.py"
Cohesion: 0.42
...
### Community 883 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 885 - "test_changelog_parity_guard.py"
Cohesion: 0.22
...
### Community 887 - "TestPolicyAuthoringUiStableClaim"
Cohesion: 0.22
...
### Community 890 - "TestRevenuePortfolio"
Cohesion: 0.22
...
### Community 894 - "agent/output_filter.py"
Cohesion: 0.32
...
### Community 901 - "_parse_tool_calls_from_response"
Cohesion: 0.39
...
### Community 912 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 913 - "ceo-micromanagement.md"
Cohesion: 0.25
Nodes (4): P0 behavior change, Readiness contract, Runtime model, Runtime types

### Community 914 - "Feature Maturity / Support Matrix"
Cohesion: 0.25
...
### Community 917 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.25
...
### Community 918 - "Issue #362: Nvidia repo setup"
Cohesion: 0.25
...
### Community 919 - "Issue #364: quick-note:https://www.marktechpost.com/2026/06/01/meet-memory-os-a-6-layer-open-source-memory-stack-built-on-top-of-hermes-agent/"
Cohesion: 0.25
...
### Community 920 - "Issue #378: quick-note:https://www.marktechpost.com/2026/06/02/tinyfish-launches-bigset-an-open-source-multi-agent-system-that-builds-structured-live-datasets-from-plain-english-descriptions/"
Cohesion: 0.25
...
### Community 921 - "Issue #379: quick-note:https://searchengineland.com/schema-markup-optimize-agentic-web-479080"
Cohesion: 0.25
...
### Community 922 - "Issue #380: quick-note:https://cursor.com/blog/cloud-agent-lessons"
Cohesion: 0.25
...
### Community 923 - "Issue #381: quick-note:https://www.xda-developers.com/claude-code-with-opus-48-is-expensive-but-i-made-it-efficient-with-my-local-ai-workflow/"
Cohesion: 0.25
...
### Community 924 - "Issue #382: quick-note:https://claude.com/blog/how-coderabbit-used-claude-to-build-an-agent-orchestration-system"
Cohesion: 0.25
...
### Community 925 - "Issue #383: quick-note:https://www.marktechpost.com/2026/05/29/hexo-labs-open-sources-sia-a-self-improving-agent-that-updates-both-the-harness-and-the-model-weights/"
Cohesion: 0.25
...
### Community 926 - "Issue #416: feat: Self-hosted Codebuff (freebuff) on free NVIDIA models + Telegram bot phone control"
Cohesion: 0.25
...
### Community 927 - "Issue #485: [Trend Digest] Week of 2026-06-08"
Cohesion: 0.25
...
### Community 928 - "Issue #488: quick-note:https://github.com/cookiy-ai/user-research-skill"
Cohesion: 0.25
...
### Community 929 - "Issue #491: Implement whatever is necessary from https://github.com/BehiSecc/awesome-claude-skills"
Cohesion: 0.25
...
### Community 930 - "Issue #493: Use the https://github.com/mvanhorn/last30days-skill skill to get the trend updated"
Cohesion: 0.25
...
### Community 931 - "Issue #495: Read https://www.anthropic.com/news/claude-fable-5-mythos-5 and understand if mythos or fable can be added to the repo"
Cohesion: 0.25
...
### Community 932 - "Issue #504: EPIC: Autonomy hardening — live-verified defects 2026-06-10"
Cohesion: 0.25
...
### Community 933 - "Issue #581: Sprint tracker: pending work after brand rename + mobile-first pass"
Cohesion: 0.25
...
### Community 935 - "Issue #657: quick-note:https://github.com/earendil-works/pi"
Cohesion: 0.25
...
### Community 936 - "Issue #659: quick-note:https://github.com/nex-agi/Nex-N2"
Cohesion: 0.25
...
### Community 937 - "Issue #660: quick-note:https://github.com/getsentry/sentry-for-ai"
Cohesion: 0.25
...
### Community 938 - "Issue #661: quick-note:https://github.com/XiaomiMiMo/MiMo-Code"
Cohesion: 0.25
...
### Community 939 - "Issue #664: quick-note:https://github.com/Grominet95/jarvis-OS"
Cohesion: 0.25
...
### Community 940 - "Issue #666: quick-note:https://github.com/porokka/jarvis-os"
Cohesion: 0.25
...
### Community 941 - "Issue #670: quick-note:https://github.com/perplexityai/bumblebee"
Cohesion: 0.25
...
### Community 942 - "Issue #672: quick-note:https://github.com/Chachamaru127/claude-code-harness"
Cohesion: 0.25
...
### Community 943 - "Issue #676: quick-note:https://github.com/WeiboAI/VibeThinker"
Cohesion: 0.25
...
### Community 944 - "Issue #820: quick-note:https://github.com/cobusgreyling/loop-engineering"
Cohesion: 0.25
...
### Community 945 - "Positional Encoding Internals"
Cohesion: 0.25
...
### Community 946 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 947 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 948 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 949 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 957 - "run_patched_colibri.py"
Cohesion: 0.36
...
### Community 967 - "test_provider_models_db_outage.py"
Cohesion: 0.25
...
### Community 968 - "test_runtimes_health_endpoint.py"
Cohesion: 0.25
...
### Community 971 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.25
...
### Community 1012 - "check_changelog_parity.py"
Cohesion: 0.43
...
### Community 1013 - "e2e_smoke.py"
Cohesion: 0.57
Nodes (5): _chat(), check(), _health(), _models(), _req()

### Community 1014 - "task_runner.py"
Cohesion: 0.33
...
### Community 1018 - "test_daily_2026_06_14.py"
Cohesion: 0.38
...
### Community 1019 - "TestSupportMatrixDocsSync"
Cohesion: 0.29
...
### Community 1023 - "TestGithubTokenSQLiteRegression"
Cohesion: 0.38
...
### Community 1031 - "openclaw_mobile_ui"
Cohesion: 0.33
...
### Community 1052 - "StatusPill.jsx"
Cohesion: 0.47
Nodes (5): C, STATUS_META, StatusPill(), TONE_BG(), TONE_BORDER()

### Community 1053 - "resolve_hermes_base_url"
Cohesion: 0.47
...
### Community 1055 - "apply_phase1_changes.py"
Cohesion: 0.33
...
### Community 1057 - "check_doc_images.py"
Cohesion: 0.60
...
### Community 1066 - "TestAgentRunnerExecution"
Cohesion: 0.33
...
### Community 1068 - "TestCEOAgencySystem"
Cohesion: 0.33
...
### Community 1069 - "test_catalogue_probe.py"
Cohesion: 0.33
...
### Community 1100 - "_add_colibri_shim_changelog_entry.py"
Cohesion: 0.50
...
### Community 1101 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1102 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1103 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 1104 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 1105 - "parse_pytest_failures.py"
Cohesion: 0.50
...
### Community 1113 - "test_agent_runtime_wrapper.py"
Cohesion: 0.70
...
### Community 1114 - "TestNoKeyEverReachesTheLog"
Cohesion: 0.40
...
### Community 1115 - "TestTheProbeIdentifiesItself"
Cohesion: 0.40
...
### Community 1116 - "TestModelRoleSeparation"
Cohesion: 0.40
...
### Community 1121 - "verify_pr_exists"
Cohesion: 0.50
...
### Community 1123 - "brain_providers"
Cohesion: 0.50
...
### Community 1136 - "stop_colibri_server.ps1"
Cohesion: 0.83
Nodes (3): Fail(), Ok(), W()

### Community 1138 - "start_server.sh"
Cohesion: 0.50
Nodes (3): OLLAMA_HOST, OLLAMA_MODELS, start_server.sh script

### Community 1139 - "check_services"
Cohesion: 0.67
...
### Community 1149 - "test_no_exception_detail_leaks.py"
Cohesion: 0.50
...
### Community 1150 - "test_skills_route_order.py"
Cohesion: 0.67
...
## Knowledge Gaps
- **3453 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3448 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 13121 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **123 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `_fixture()` connect `_fixture` to `parse_event_stream`, `WebsiteScanner`, `llm/router.py`, `TaskStore`, `test_brain_patch_service_token.py`, `test_llm_router_resilience.py`, `resolve_identity`, `TaskWorkflowService`, `AgentSessionStore`, `test_model_router.py`, `config.py`, `SelfHealingAgent`, `ImprovementLoop`, `E2BSandboxSession`, `Task`, `test_unit8_model_catalog.py`, `services/seo_audit.py`, `test_company_api.py`, `WorkflowRun`, `settings.py`, `PrimeAgentAdapter`, `get_task_store`, `test_failover_client_shared.py`, `test_telegram_service_webhook.py`, `UserRole`, `test_agent_tool_governance.py`, `test_catalogue_probe.py`, `test_sam_livekit.py`, `ChatHistoryStore`, `services/background.py`, `test_openclaw_endpoints.py`, `TokenBudget`, `test_task_service_failed_comment.py`, `brain_failover.py`, `AgentJobManager`, `ResearchTask`, `ExecutionRequest`, `model_router.py`, `_resolve_brain_provider`, `TestClient`, `test_ai_insights.py`, `test_procedural_memory.py`, `claim`, `SQLiteStore`, `KeyStore`, `test_llm_router_e2e.py`, `test_telegram_auto_approve.py`, `_resolve_push_token`, `test_autonomy_status.py`, `test_brain_failover_413.py`, `test_local_brain_state.py`, `_clean_phases`, `clear_cooldowns`, `test_knowledge_sync.py`, `test_phase5_doctor.py`, `test_refresh_agent_built_proof.py`, `test_startup_warmup.py`, `test_telegram_diag_endpoint.py`, `get_self_healing_agent`, `BrainWatchdog`, `ScheduledJob`, `cost_tracker.py`, `TestHarnessAdapter`, `test_context_rulebook.py`, `ProviderConfig`, `test_llm_router_tpm.py`, `sam`, `ArtifactStore`, `facade.py`, `run_task`, `e2e/test_browser.py`, `test_tasks_awaiting_approval_api.py`, `test_provider_router.py`, `test_brain_failover.py`, `test_issue_intake.py`, `_step`, `test_trend_scoping.py`, `persist_plan_spec`, `MCPClient`, `test_daily_2026_07_27.py`, `test_openclaw_gateway.py`, `AgentSwarm`, `OllamaCircuitBreaker`, `_job_text`, `TestAuthAndTaskOwnership`, `CEOLedger`, `test_portfolio_intake.py`, `test_new_features_e2e.py`, `test_features_api.py`, `test_video_transcript.py`, `test_e2b_data_flow.py`, `TrendWatcher`, `_Budget`, `test_llm_router_compat.py`, `WorkflowBuildRequest`, `test_process_quick_note_workflow.py`, `cache.py`, `TestRuntimeControl`, `test_provider_state_durability.py`, `test_trend_watcher.py`, `AgentProfile`, `TestEstimateTokensForMessages`, `TestClient`, `BackgroundAgent`, `test_ceo_router.py`, `ContextPruner`, `test_control_plane_api.py`, `test_agile_api.py`, `test_app_settings.py`, `TestAuthAndTaskCreation`, `test_task_clarification.py`, `test_persistent_memory.py`, `SecurityScanner`, `api_keys_for`, `OutputFilter`, `test_platform_controls.py`, `NotificationDispatcher`, `test_rate_limiter.py`, `test_sam_voice.py`, `OrchestratorCheckpointStore`, `OrchestratorQueue`, `test_nvidia_model_discovery.py`, `_resolve_user_github_token`, `TestNormalizeResponseFormat`, `session_retro.py`, `test_purge_backlog.py`, `analyze_page`, `capture_screens.py`, `SeoFixRequest`, `TestMongoGate`, `test_agent_scripts_share_one_model_list.py`, `test_crispy_burn_in.py`, `test_skill_registry_boot_refresh.py`, `isolated_telegram_config`, `test_scheduler_hydration_bounded.py`, `_start_ceo_agency`, `test_provider_enable_disable.py`, `_undeclared`, `test_dashboard_cache.py`, `traffic_director.py`, `test_claude_code_adapter.py`, `_get`, `test_service_token.py`, `test_harness_spec.py`, `test_regression.py`, `test_agency_fix.py`, `test_webui_provider_priority.py`, `platform_controls_router.py`, `test_monitor_lib.py`, `test_v4_api.py`, `.record`, `test_ping.py`, `model_discovery.py`, `test_runtimes_health_endpoint.py`, `allow_paid`, `test_task_store_fails_loud_in_production.py`, `test_agent_free_brain.py`, `reap_expired_companies`, `test_kimi_bridge_server.py`, `test_voice_pipeline.py`, `client`, `TestTheWorkflowIsSafeAndReadOnly`, `test_doctor_coding_brain.py`, `TestFeaturesAPI`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `TaskSpec`, `proxy.py`, `FreeBuffAgent`, `resolve_identity`, `AutonomyTracker`, `ReactScratchpad`, `AgentSessionStore`, `test_governance_api.py`, `ContextManager`, `E2BSandboxSession`, `test_autonomous_agency_e2e.py`, `test_backend_server_features.py`, `MCPClient`, `MultiAgentSwarm`, `WorkflowRun`, `test_failover_client_shared.py`, `TestAgentRunnerSafety`, `test_empirical_verify.py`, `TestAgentRunnerExecution`, `test_agent_tool_governance.py`, `loop.py`, `StuckDetector`, `InternalAgentAdapter`, `WorkspaceTools`, `LocalWorkspace`, `test_daily_automation_2026_07_11.py`, `TokenBudget`, `AgentJobManager`, `TestAgentLoopMCPIntegration`, `UserMemoryStore`, `test_agent_chat_integration.py`, `test_agent_free_brain.py`, `_resolve_push_token`, `test_agent_runner.py`, `test_brain_failover_413.py`, `CEODispatcher`, `workflow_orchestrator.py`, `direct_chat.py`, `AdaptiveHalter`, `ContextPruner`, `agency.py`, `enforcement.py`, `GitHubTools`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderRouter` to `backend/server.py`, `implement_agent.py`, `failover_client.py`, `test_provider_router.py`, `test_anthropic_router.py`, `AnthropicProvider`, `test_backend_server_features.py`, `is_anthropic_base_url`, `test_bedrock_live.py`, `test_colibri_brain_shim.py`, `test_colibri_provider.py`, `TestAnthropicPayloadStructuredOutput`, `test_bedrock_provider.py`, `ai/router.py`, `TestRouterIntegration`, `TrafficDirector`, `clear_cooldowns`, `test_anthropic_refusal_fallback.py`, `system_instruction`, `direct_chat.py`, `NvidiaProvider`, `TestOpenAiToBedrockConverse`, `Provider`, `ProviderConfig`, `test_all_providers_discovery.py`?**
...
- **Are the 65 inferred relationships involving `ProviderRouter` (e.g. with `_build_provider_router()` and `NvidiaProvider`) actually correct?**
  _`ProviderRouter` has 65 INFERRED edges - model-reasoned connections that need verification._
