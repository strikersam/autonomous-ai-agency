# Graph Report - pr1485  (2026-09-14)

## Corpus Check
- 1507 files · ~2,185,458 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 30557 nodes · 57037 edges · 1288 communities (1133 shown, 107 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 3331 edges (avg confidence: 0.92)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e1acd9db`
...
## Communities (1288 total, 107 thin omitted)

### Community 0 - "backend/server.py"
Cohesion: 0.02
Nodes (220): get_sam(), agent/sam.py — SAM Voice Agent (System Autonomy Manager) SAM is the voice-…, _agent_provider_failure_response(), _agent_timeout_fallback_response(), AgentStatusEntry, AgentStatusResponse, AgentToolCallEntry, ApiKeyCreate (+212 more)
...
Cohesion: 0.03
Nodes (169): check_ollama_async(), Async Ollama reachability check — non-blocking for FastAPI handlers., middleware, admin_control(), admin_create_key(), admin_create_user(), admin_delete_user(), admin_list_users() (+161 more)

### Community 3 - "SQLiteStore"
Cohesion: 0.02
Nodes (90): KnowledgeItem, Structured knowledge about the company, systems, or processes., MongoDBStore, Any, ObjectId, Prepare a Pydantic model for SQLite storage., Prepare a SQLite row for Pydantic model., Create a new company in SQLite. (+82 more)

### Community 4 - "TaskSpec"
Cohesion: 0.04
Nodes (97): kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, AiderAdapter, Any, TaskResult, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Run aider non-interactively via `--message` flag., Adapter for Aider — TIER 3 specialized git-aware code editor. (+89 more)

### Community 5 - "test_llm_router_queue_cache.py"
Cohesion: 0.02
Nodes (110): int, CacheManager, cosine_similarity(), _Entry, LRUCache, Any, T, Live (unexpired) entries — used by the semantic layer's scan. (+102 more)
...
Cohesion: 0.03
Nodes (97): AgentDefinition, AgentStore, Any, field_validator, agents/store.py — Persistent store for user-defined agent configurations.…, CRUD store for AgentDefinition objects. Uses MongoDB when a `db` client is…, Return an agent by ID. If *owner_id* is provided, enforces that the agent…, Delete an agent. Returns True on success, False if not found/unauthorised. (+89 more)

### Community 8 - "RuntimeAdapter"
Cohesion: 0.03
Nodes (92): governance_enabled(), True when the governance layer should run at all. A single global off switch…, Abstract base class every runtime adapter must implement. Subclasses must set…, Execute a task and return the result. Must handle its own timeout…, Stream output tokens/lines. Default implementation runs execute() and yields…, Called once when the runtime is registered. Override to start a subprocess,…, Called when the runtime is being unregistered or the server is shutting down.…, Clean up any runtime-owned workspace resources after execution. (+84 more)

### Community 9 - "AgentJobManager"
Cohesion: 0.03
Nodes (73): PreflightIssue, PreflightReport, BaseModel, AgentJob, AgentJobManager, make_isolated_workspace(), _now(), Any (+65 more)

### Community 10 - "types.py"
Cohesion: 0.03
Nodes (84): packages/llm — the multi-provider LLM routing layer. Every LLM call in this…, packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, classify_error(), LLMProvider, OpenAICompatible, ABC, Any, AsyncClient (+76 more)

### Community 11 - "ImprovementLoop"
Cohesion: 0.04
Nodes (103): DetectedIssue, get_improvement_loop(), ImprovementLoop, ImprovementLoopState, IssueCategory, IssueSeverity, _now(), Any (+95 more)

### Community 12 - "gateway.py"
Cohesion: 0.03
Nodes (98): AlertHandler, FailoverResult, A successful completion plus the accounting its callers need., BudgetTracker, Counter, _Dimensions, get_budget(), _month() (+90 more)
...
### Community 14 - "CompanyGraphStore"
Cohesion: 0.02
...
Cohesion: 0.03
Nodes (107): ProviderConfig, One configured endpoint. ``kind`` selects the adapter: ``openai`` (any OpenAI-…, build_provider(), Normalise a configured ``kind`` to an adapter key., Instantiate the adapter for one provider config. Unknown kinds fall back to the…, resolve_kind(), LLMRequest, Cheap character-based token estimate (~4 chars/token). Deliberately dependency-… (+99 more)

### Community 16 - "HTTPException"
Cohesion: 0.04
...
Cohesion: 0.04
Nodes (104): _merge_changed_files(), Collect changed_files across all specialists into a single de-duped list., BoundContext, ClassifyOutput, ExecutionResult, get_ceo_fallback_stats(), JudgeVerdict, MonitorOutput (+96 more)
...
### Community 19 - "BrainConfig"
Cohesion: 0.03
Nodes (102): BrainConfig, BrainConfigPatch, BrainConfigStore, default_brain_config(), get_brain_config(), get_brain_config_store(), invalidate_brain_config_cache(), BaseModel (+94 more)

### Community 20 - "E2BAdapter"
Cohesion: 0.03
Nodes (93): E2BAdapter, Any, TaskResult, runtimes/adapters/e2b.py — E2B Firecracker micro-VM runtime adapter. Routes…, Declare ``E2B_API_KEY`` as a required env dependency. The base ``preflight``…, Execute a task inside a fresh E2B sandbox. Flow: 1. Open an…, Run ``pytest`` inside the sandbox. Returns ``(output, passed)``.…, Runtime adapter that executes tasks inside an E2B sandbox. Activation:… (+85 more)

### Community 21 - "Task"
Cohesion: 0.04
Nodes (71): Task, Full task/issue document., Task, _gate_outward_facing_enabled(), _is_outward_facing(), Any, TaskSpec, One-line human explanation of why this task needs human approval. Reads risk… (+63 more)
...
### Community 25 - "E2BSandboxSession"
Cohesion: 0.04
...
### Community 30 - "enforcement.py"
Cohesion: 0.03
Nodes (77): Charge sub-agent nesting depth and enforce the ``max_depth`` ceiling. Isolates…, guard(), identity_from_headers(), _load(), Any, mcp_server/governance.py — governance adapter for the MCP HTTP surface. Closes…, Build an AgentIdentity from the caller's ``X-Agent-*`` headers. Absent headers…, Evaluate *tool* before it runs. Returns ``(allowed, message, decision)``.… (+69 more)
...
### Community 32 - "services/background.py"
Cohesion: 0.04
Nodes (78): _dispatch_async(), _ErrorCaptureHandler, get_log_monitor(), LogMonitor, _note_recurrence(), Any, LogRecord, agent/log_monitor.py — Application Log Monitor Captures ERROR/CRITICAL log… (+70 more)
...
Cohesion: 0.04
Nodes (73): _apply_env_overrides(), _apply_key_env(), _build(), _coerce(), config_dir(), _env_key_names(), expand_env(), _fields_of() (+65 more)

### Community 35 - "loop.py"
Cohesion: 0.05
Nodes (55): Agent subsystem — planner / executor / verifier loop., loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., # NOTE: "ollama_base" is kept for backwards compatibility; this runner only…, AgentEvent, AgentPlan, AgentRunRequest, AgentSession, AgentSessionCreateRequest (+47 more)
...
Cohesion: 0.04
Nodes (65): _acquire_provider_probe(), _dead_model_key(), _exponential_backoff_cooldown(), _get_director(), is_commercial_provider(), _mark_model_dead(), _normalized_provider_type(), _notify_watchdog() (+57 more)
...
### Community 41 - "llm/router.py"
Cohesion: 0.04
Nodes (52): Attempt, Test hook — clear all usage accounting., reset(), payload_key(), packages/llm/cache.py — layered caching. Five independent layers, each with its…, Exact-match cache key over the fields that change the answer. Routing…, Test hook — drop every cache layer., reset() (+44 more)
...
Cohesion: 0.04
Nodes (63): Backoff policy for retryable failures., RetryConfig, BreakerState, Enum, str, _digest(), get_ring(), KeyRing (+55 more)
...
Cohesion: 0.04
Nodes (68): _brain_provider_status(), Return per-provider metadata for the GET endpoint. Iterates every provider in…, all_provider_ids(), provider_key_present(), Return every provider id recognised by the brain config system. Iterates the…, True when the env var for *provider*'s key is set (or it's Ollama)., CatalogActiveBrain, CatalogMirror (+60 more)

### Community 47 - "test_model_router.py"
Cohesion: 0.05
...
### Community 58 - "get_company_graph_store"
Cohesion: 0.04
Nodes (62): get_optional_company_access(), Verify user has access to a company (if authenticated). Admins bypass ownership…, autonomy_status(), Public autonomy readiness probe — no authentication required. A live deploy…, Fire-and-forget self-bootstrap; never blocks or crashes startup., _schedule_self_bootstrap(), CompanyAgencyService, get_company_agency_service() (+54 more)

### Community 59 - "validate_policy_text"
Cohesion: 0.05
Nodes (42): build_governance_router(), Any, APIRouter, backend/governance_router.py — read and operate the governance layer. Mounted…, Reject non-admin callers. Mirrors the RBAC check used elsewhere in this backend…, _require_admin(), _audit_proposal(), _baseline_loosened() (+34 more)
...
Cohesion: 0.06
Nodes (50): _load_rich_policy(), Return the persisted rich UI policy (pools + policy + triggers), or {}., test_git_ref_rejects_empty(), test_git_ref_rejects_flag_injection(), test_git_ref_rejects_shell_metacharacters(), test_git_ref_rejects_traversal(), test_git_ref_valid(), test_git_scheme_allows_ssh() (+42 more)

### Community 66 - "RepowiseIntelligence"
Cohesion: 0.05
...
### Community 68 - "brain_config.py"
Cohesion: 0.05
Nodes (71): _build_base_url_env_from_yaml(), _build_candidates_from_yaml(), _build_default_base_url_from_yaml(), _build_display_names_from_yaml(), _build_key_env_from_yaml(), _build_presets_from_yaml(), _build_tier_from_yaml(), get_provider_candidates() (+63 more)

### Community 69 - "BrainWatchdog"
Cohesion: 0.04
...
### Community 73 - "Any"
Cohesion: 0.04
Nodes (42): _check_extra_kwargs(), _enforce_signature(), Any, Raise TypeError if fn's signature drifts from the locked contract (Pydantic…, Raise TypeError on unknown kwarg (runtime extra='forbid' for non-Pydantic…, Governance seam: judge the call, run it, audit the outcome. Deliberately a thin…, Append an event to the durable session log if a store is wired in., Summarise a long history and compact it. Asks the planner model to write a… (+34 more)
...
### Community 85 - "test_runtimes.py"
Cohesion: 0.06
Nodes (22): CircuitState, Reduce probe frequency for runtimes that have never come online., Return the single best adapter for *task_type*. If *preferred_runtime_id* is…, Maintains the catalogue of registered adapters and answers 'which runtimes can…, Return all adapters that can handle *task_type*, ordered by tier., RuntimeCapabilityRegistry, Admin-configurable routing policy. Defaults are conservative (local-first, no…, RoutingPolicy (+14 more)

### Community 86 - "_resolve_brain_provider"
Cohesion: 0.05
...
### Community 91 - "PrimeAgentAdapter"
Cohesion: 0.05
...
### Community 93 - "get_task_store"
Cohesion: 0.06
Nodes (62): _purge_backlog_core(), Shared purge implementation for the admin endpoint and the boot hook., Hand the 'connect & verify the repo' work to the agency's own agents. The task…, _seed_connect_task(), _blocked_retire_age_sec(), _heal_blocked_backlog(), _heal_brain_failover(), _heal_purge_backlog() (+54 more)

### Community 94 - "App.js"
Cohesion: 0.05
Nodes (32): getAccountLifecycle(), getDefaultBackendUrl(), getMe(), login(), logout(), App(), AppRoutes(), ProtectedRoute() (+24 more)

### Community 95 - "FetchResult"
Cohesion: 0.06
...
### Community 96 - "test_brain_config_api.py"
Cohesion: 0.05
Nodes (51): provider_base_url(), Return the OpenAI-compatible base URL for *provider* (env- and UI-aware)., _describe_http_status(), probe_model_liveness(), _probe_ollama(), _probe_openai_compat(), ProbeResult, BaseModel (+43 more)

### Community 97 - "RenderOpsMonitor"
Cohesion: 0.07
Nodes (23): Polls Render for platform-level failures and files them as issues., RenderOpsMonitor, _client(), _FakeRender, asyncio, Regression: the admin routes and the ops loop share this singleton. Without the…, A handshake that raised must be retried, not remembered as done., Minimal RenderMCPClient stand-in for the ops monitor. (+15 more)

### Community 98 - "AgentJobRequest"
Cohesion: 0.05
...
### Community 102 - "test_agent_tool_governance.py"
Cohesion: 0.06
...
### Community 104 - "test_web_reach.py"
Cohesion: 0.07
Nodes (48): get_web_reach(), _load_script_module(), Any, ModuleType, agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Dynamically load a pure-stdlib helper module from .github/scripts/. Returns…, Zero-key internet access: pages, YouTube transcripts, search, RSS. Every public…, Read a web page as plain text, following the same fallback chain (direct ->… (+40 more)
...
### Community 109 - "system_instruction"
Cohesion: 0.06
...
### Community 113 - "TestAdapterMetadata"
Cohesion: 0.05
Nodes (24): _env_float(), HermesAdapter, Any, AsyncClient, Read a float env var, falling back to *default* on unset/garbage., Adapter for Hermes Agent — FIRST CLASS autonomous runtime., Any, Adapter for a compatible external task harness. (+16 more)
...
### Community 115 - "test_knowledge_sync.py"
Cohesion: 0.08
...
### Community 117 - "test_colibri_brain_shim.py"
Cohesion: 0.06
...
### Community 120 - "test_sam_livekit.py"
Cohesion: 0.05
...
### Community 129 - "portfolio_intelligence.py"
Cohesion: 0.06
...
### Community 131 - "TestHarnessAdapter"
Cohesion: 0.05
...
### Community 134 - "test_trend_watcher.py"
Cohesion: 0.06
...
### Community 137 - "webui/router.py"
Cohesion: 0.07
Nodes (41): get_brain_preference(), Return the operator's brain provider preference. Values: - ``"nvidia"`` —…, Operator can set BRAIN_PREFERENCE=colibri without it being rejected., test_get_brain_preference_accepts_colibri(), Any, Path, run_command(), _safe_allowlist() (+33 more)

### Community 138 - "test_webui_provider_priority.py"
Cohesion: 0.07
Nodes (32): AdminAuthManager, AdminIdentity, AdminSession, AdminSessionStore, _is_truthy(), admin_auth.py — auto-generated module docstring (user-research skill scan)., WindowsCredentialAuthenticator, test_admin_api_login_status_and_control() (+24 more)

### Community 139 - "test_governance_api.py"
Cohesion: 0.06
Nodes (49): get_approval_store(), AuditEvent, One governed action, fully described. Field order follows the…, One-line JSON, suitable for a SIEM shipper tailing the log., Replace the process-wide gate. Tests only., reset_gate(), _client(), parametrize (+41 more)

### Community 140 - "InferenceCache"
Cohesion: 0.05
...
### Community 142 - "test_trend_scoping.py"
Cohesion: 0.09
...
### Community 143 - "settings.py"
Cohesion: 0.06
Nodes (28): Cerebras provider adapter — free, fast LLM (qwen-3-coder-480b)., GroqProvider, Groq provider adapter — free, fast LLM (deepseek-r1-distill-llama-70b)., NVIDIA NIM provider adapter — wraps the existing provider_router logic. This is…, Ollama provider adapter — local LLM inference., packages.ai — provider abstraction, model registry, and failover manager., ProviderManager, packages/ai/manager.py — ProviderManager. Single entry point for all LLM calls.… (+20 more)
...
### Community 157 - "resolve_active_brain"
Cohesion: 0.08
...
### Community 161 - "tasks/store.py"
Cohesion: 0.06
Nodes (40): _priority_rank(), Any, tasks/store.py — MongoDB-backed task store. Falls back to in-memory storage…, Fail loud in production if no persistent storage is configured. Telegram…, List tasks for a specific user with optional filters. ``include_system``…, Admin-only: list all tasks across all users. ``include_log`` mirrors…, Return tasks queued for agent execution, highest-priority first. Ordered by…, Return BLOCKED tasks that are candidates for auto-retry. (+32 more)
...
### Community 164 - "test_provider_router.py"
Cohesion: 0.06
Nodes (46): extract_openai_text(), _normalize_nvidia_base_url(), _openai_url(), Normalize NVIDIA base URLs to avoid double /v1 when openai_compat_url appends…, _nvidia_provider_chain(), ProviderConfig, Build Nvidia NIM provider config from env. Empty list when key is absent., _clear_probe_locks() (+38 more)

### Community 165 - "test_response_cache.py"
Cohesion: 0.12
...
### Community 170 - "PatternConsolidation"
Cohesion: 0.08
...
Cohesion: 0.06
Nodes (42): _auto_disable(), _describe_registry(), _disabled_ids(), _is_billing_refusal(), _is_ollama(), _key_pool(), _log_exhaustion(), _log_recovery() (+34 more)
...
### Community 187 - "_get_provider_policy"
Cohesion: 0.07
...
### Community 193 - "TestRuntimeControl"
Cohesion: 0.04
...
### Community 195 - "test_ceo_router.py"
Cohesion: 0.08
...
### Community 201 - "provider_max_rpm"
Cohesion: 0.07
...
### Community 206 - "test_operational_incidents.py"
Cohesion: 0.06
...
### Community 207 - "portfolio_api.py"
Cohesion: 0.08
...
### Community 213 - "emit_chat_observation"
Cohesion: 0.09
...
### Community 225 - "WorkflowBuildRequest"
Cohesion: 0.08
...
### Community 238 - "configuration-reference.md"
Cohesion: 0.07
...
### Community 246 - "get_failover_manager"
Cohesion: 0.07
...
### Community 252 - "test_llm_router_disabled.py"
Cohesion: 0.10
...
### Community 255 - "InternalAgentAdapter"
Cohesion: 0.07
...
### Community 257 - "TaskDispatcher"
Cohesion: 0.09
Nodes (23): Background dispatcher for task execution., Re-queue BLOCKED tasks that have cooled down and are ready for retry., Polls for queued task work and executes it through the coordinator. Crash…, Re-queue tasks stranded by a prior crash or hard-kill., TaskDispatcher, _make_task(), asyncio, Task (+15 more)
...
### Community 291 - "test_tasks_awaiting_approval_api.py"
Cohesion: 0.12
Nodes (30): quick_notes_submit(), _QuickNoteBody, Submit a quick-note URL or instruction from the dashboard FAB., Path, Start RuntimeManager, TaskDispatcher, SCHEDULER, and self-bootstrap. Returns a…, start_background_services(), Set the global task store instance (e.g., during app startup with MongoDB)., set_task_store() (+22 more)
...
### Community 293 - "test_provider_render_env.py"
Cohesion: 0.09
...
### Community 294 - "report_to_markdown"
Cohesion: 0.10
...
### Community 296 - "skill_bindings.py"
Cohesion: 0.09
...
### Community 297 - "test_sam_voice.py"
Cohesion: 0.07
...
Cohesion: 0.10
Nodes (25): get_skill(), Get a single skill by its ID., build_matrix(), _families(), main(), Any, scripts/generate_specialist_skill_matrix.py — Specialist × Skill matrix.…, Map family -> sorted list of test files that mention it (quoted token). (+17 more)
...
### Community 306 - "OrchestratorCheckpointStore"
Cohesion: 0.09
...
### Community 307 - "OrchestratorQueue"
Cohesion: 0.07
...
### Community 310 - "test_one_model_catalogue.py"
Cohesion: 0.09
...
### Community 312 - "test_workspace_isolation.py"
Cohesion: 0.16
...
### Community 316 - "High-Agency Frontend Skill"
Cohesion: 0.06
Nodes (30): 10. FINAL PRE-FLIGHT CHECK, 1. ACTIVE BASELINE CONFIGURATION, 2. DEFAULT ARCHITECTURE & CONVENTIONS, 3. DESIGN ENGINEERING DIRECTIVES (Bias Correction), 4. CREATIVE PROACTIVITY (Anti-Slop Implementation), 5. PERFORMANCE GUARDRAILS, 6. TECHNICAL REFERENCE (Dial Definitions), 7. AI TELLS (Forbidden Patterns) (+22 more)

### Community 317 - "facade.py"
Cohesion: 0.09
...
### Community 318 - "Quick-Note GitHub Issues Processing - Session Summary"
Cohesion: 0.06
...
### Community 319 - "test_failover_silent_exhaustion.py"
Cohesion: 0.11
...
### Community 320 - "test_rate_limiter.py"
Cohesion: 0.10
...
### Community 321 - "test_mcp_governance.py"
Cohesion: 0.12
...
### Community 323 - "test_autonomy_gate.py"
Cohesion: 0.12
...
### Community 324 - "output_filter.py"
Cohesion: 0.07
...
### Community 334 - "test_purge_backlog.py"
Cohesion: 0.09
...
### Community 338 - "test_backend_server_features.py"
Cohesion: 0.08
...
### Community 344 - "brain_failover.py"
Cohesion: 0.11
...
### Community 349 - "test_provider_enable_disable.py"
Cohesion: 0.09
...
### Community 354 - "tests/conftest.py"
Cohesion: 0.10
...
### Community 361 - "reset_failover_manager"
Cohesion: 0.08
...
### Community 363 - "isolated_telegram_config"
Cohesion: 0.11
...
### Community 369 - "model_discovery.py"
Cohesion: 0.10
...
### Community 383 - "test_connector_registry.py"
Cohesion: 0.12
...
### Community 385 - "NIMConnectionPool"
Cohesion: 0.11
...
### Community 386 - "_InMemoryBackend"
Cohesion: 0.11
...
Cohesion: 0.12
Nodes (21): _execute_skill_impl(), _get_portfolio_manager(), Any, Live Graphify executor — queries the codebase knowledge graph. Order of…, Live council reviewer — deterministic, rules-based multi-perspective review…, Recommend skills based on detected systems and provisioned specialists. With no…, Execute a skill by ID and update its execution counters., Lazily build and cache the shared PortfolioManager. (+13 more)
...
### Community 389 - "test_telegram_approval_e2e.py"
Cohesion: 0.12
...
### Community 391 - "test_phase6_workflow.py"
Cohesion: 0.16
...
### Community 396 - "operational_incidents.py"
Cohesion: 0.09
Nodes (23): _diagnose_and_file(), gather_render_evidence(), get_operational_incident_tracker(), _iso_from_monotonic(), agent/operational_incidents.py — recurring operational failures, auto-…, Drop all open-phase state. Used by tests., Pull recent Render logs and summarise them for the issue body. This is the…, Attach evidence to *incident*, then hand it to the existing intake. The filing… (+15 more)
...
### Community 398 - "OrchestratorSupervisor"
Cohesion: 0.12
...
### Community 407 - "test_agent_free_brain.py"
Cohesion: 0.09
...
### Community 408 - "test_tokenin_provider.py"
Cohesion: 0.09
Nodes (17): get_provider_tier(), Return the tier (``free`` / ``paid`` / ``local``) for *provider*. Returns…, test_get_provider_tier_known(), test_get_provider_tier_unknown_returns_unknown(), tests/test_omniroute_provider.py — OmniRoute self-hosted gateway wiring.…, Without an explicit base URL it points at the local default, never blank., One provider, one model — OmniRoute does its own internal fan-out., Promoted to the preferred free provider, but NVIDIA stays the floor. OmniRoute… (+9 more)

### Community 409 - "control_overrides.py"
Cohesion: 0.12
...
### Community 411 - "Native operations"
Cohesion: 0.09
...
### Community 413 - "test_all_features.py"
Cohesion: 0.08
...
### Community 414 - "test_agency_fix.py"
Cohesion: 0.08
...
### Community 422 - "_resolve_user_github_token"
Cohesion: 0.16
...
### Community 452 - "test_portfolio_intelligence.py"
Cohesion: 0.10
...
### Community 467 - "Skill: modularity-review"
Cohesion: 0.10
...
### Community 472 - "4. Troubleshooting"
Cohesion: 0.10
...
### Community 473 - "Docker AI Governance Audit — Final Report"
Cohesion: 0.10
...
### Community 474 - "1. Capability-by-capability"
Cohesion: 0.10
...
### Community 476 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 480 - "is_anthropic_base_url"
Cohesion: 0.12
...
### Community 485 - "PriorityTaskQueue"
Cohesion: 0.15
...
### Community 488 - "TestBrainFailoverModelUpdates"
Cohesion: 0.18
...
### Community 501 - "render_router.py"
Cohesion: 0.13
...
### Community 511 - "resolve_free_nvidia_brain"
Cohesion: 0.12
...
### Community 513 - "test_north_mini_code.py"
Cohesion: 0.11
...
### Community 524 - "test_schedule_persistence.py"
Cohesion: 0.15
...
### Community 526 - "OperationalIncidentTracker"
Cohesion: 0.13
...
### Community 530 - "agile_sprints.py"
Cohesion: 0.14
...
### Community 534 - "test_minimax_bug_fixes.py"
Cohesion: 0.13
...
### Community 538 - "Platform Guide — the full tour"
Cohesion: 0.11
...
### Community 545 - "_process_task_callback"
Cohesion: 0.23
...
### Community 550 - "test_telegram_webhook.py"
Cohesion: 0.14
...
### Community 551 - "handle_workflow_ide_chat"
Cohesion: 0.18
...
### Community 555 - "cowork_session.py"
Cohesion: 0.15
...
### Community 556 - "SKILL: Industrial Brutalism & Tactical Telemetry UI"
Cohesion: 0.12
...
### Community 557 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 558 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 559 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 571 - "test_task_brain_preflight.py"
Cohesion: 0.21
...
### Community 572 - "test_activation_api.py"
Cohesion: 0.21
...
### Community 573 - "TestAListingFailureDoesNotVetoTheAnswer"
Cohesion: 0.17
...
### Community 574 - "test_daily_automation_2026_07_11.py"
Cohesion: 0.15
...
### Community 576 - "test_health_endpoints.py"
Cohesion: 0.17
...
### Community 577 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 578 - "test_openclaw_endpoints.py"
Cohesion: 0.12
...
### Community 581 - "test_task_service_failed_comment.py"
Cohesion: 0.18
...
### Community 584 - "MemoryMiddleware"
Cohesion: 0.17
...
### Community 586 - "Skill: repowise-intelligence"
Cohesion: 0.12
...
### Community 588 - "_valid_login_state"
Cohesion: 0.24
...
### Community 590 - "The 10-Step Workflow"
Cohesion: 0.12
...
### Community 591 - "Nothing is blocked on an agent. Two things need a human."
Cohesion: 0.12
...
### Community 592 - "Contributing to local-llm-server"
Cohesion: 0.12
...
### Community 593 - "refresh_agent_built_proof.py"
Cohesion: 0.20
...
### Community 594 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 595 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 596 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
...
### Community 597 - "test_agent_chat_integration.py"
Cohesion: 0.23
...
### Community 604 - "_resolve_push_token"
Cohesion: 0.17
...
### Community 606 - "test_agency_workflows_carry_the_failover_chain.py"
Cohesion: 0.18
...
### Community 607 - "test_autonomy_status.py"
Cohesion: 0.12
...
### Community 610 - "test_langfuse_agency_wide.py"
Cohesion: 0.12
...
### Community 611 - "test_local_brain_state.py"
Cohesion: 0.12
...
### Community 614 - "test_nvidia_default_model.py"
Cohesion: 0.17
...
### Community 616 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 617 - "test_refresh_agent_built_proof.py"
Cohesion: 0.12
...
### Community 618 - "test_tasks_reconciler_todo_requeue.py"
Cohesion: 0.20
...
### Community 631 - "Skill: user-research"
Cohesion: 0.13
...
### Community 632 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 633 - "Attention Mechanisms Internals"
Cohesion: 0.13
...
### Community 635 - "_push_down_where"
Cohesion: 0.14
...
### Community 637 - "router/health.py"
Cohesion: 0.20
...
### Community 645 - "migrate_local_brain_env.py"
Cohesion: 0.19
...
### Community 657 - "mint_access_token"
Cohesion: 0.14
...
### Community 658 - "Skill: branch-cleanup"
Cohesion: 0.14
...
### Community 659 - "Skill: perplexity — Web Research via Perplexity API"
Cohesion: 0.14
...
### Community 662 - "Quick-Note Issues Processing Summary"
Cohesion: 0.14
...
### Community 675 - "test_changelog_check_workflow.py"
Cohesion: 0.21
...
### Community 678 - "AGENTS.md — Codebase Map & Operations Reference"
Cohesion: 0.15
...
### Community 679 - "CollaborationContext"
Cohesion: 0.21
...
### Community 681 - "PortfolioIntelligence"
Cohesion: 0.17
...
### Community 698 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
Nodes (12): Acceptance Checks, Claude's query protocol (use this instead of Read tool for exploration):, Graph Artifacts — What to Commit, How to Use the Graph (Token Savings Protocol), Installation (one-time per machine), Instead of reading raw files:, Key commands:, Relationship to repowise-intelligence Skill (+4 more)

### Community 699 - "Skill: platform-setup — Autonomous Agency Bootstrap"
Cohesion: 0.15
...
### Community 700 - "Device compatibility and model picks"
Cohesion: 0.15
...
### Community 701 - "Autonomy Uplift — Living Roadmap & Detailed Implementation Specs"
Cohesion: 0.15
...
### Community 702 - "OpenClaw — iOS Control of the Agency (Single-Service Free-Tier Deploy)"
Cohesion: 0.15
...
### Community 712 - "update_provider_policy"
Cohesion: 0.19
...
### Community 720 - "TestRouterIntegration"
Cohesion: 0.31
...
### Community 722 - "skill_registry.py"
Cohesion: 0.17
...
### Community 728 - "Skill: system-prompt-audit"
Cohesion: 0.17
...
### Community 729 - "Skill: task-alive-updates"
Cohesion: 0.17
...
### Community 732 - "_is_ephemeral_user"
Cohesion: 0.27
...
### Community 733 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 736 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 738 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 739 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 740 - "Quantization Internals"
Cohesion: 0.17
...
### Community 741 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 742 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 743 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 755 - "TestAuthAndTaskOwnership"
Cohesion: 0.17
...
### Community 756 - "TestAnthropicPayloadStructuredOutput"
Cohesion: 0.29
...
### Community 762 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 765 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 766 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 768 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 771 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 772 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 773 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 774 - "2. Critical Bugs & Exact Detection Signatures"
Cohesion: 0.18
...
### Community 775 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 776 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 777 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 778 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 779 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 781 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 782 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 783 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 784 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 785 - "What to clean up"
Cohesion: 0.18
...
### Community 786 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 793 - "build_tech_db.py"
Cohesion: 0.35
...
### Community 795 - "._run_phase_with_timeout"
Cohesion: 0.18
...
### Community 798 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 799 - "test_event_log.py"
Cohesion: 0.45
...
### Community 800 - "test_google_provider_models.py"
Cohesion: 0.18
...
### Community 801 - "TestNoNvidiaFallbackIsRetired"
Cohesion: 0.22
...
### Community 825 - "enrich_quick_note_issues.py"
Cohesion: 0.36
...
### Community 827 - "flesch_reading_ease"
Cohesion: 0.24
...
### Community 828 - "test_catalogue_probe.py"
Cohesion: 0.20
...
### Community 834 - "test_workflow_api_mount.py"
Cohesion: 0.20
...
### Community 843 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 864 - "_extract_pytest_failure"
Cohesion: 0.42
...
### Community 865 - "_get_current_user"
Cohesion: 0.25
...
### Community 869 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 870 - "test_changelog_parity_guard.py"
Cohesion: 0.22
...
### Community 872 - "TestPolicyAuthoringUiStableClaim"
Cohesion: 0.22
...
### Community 874 - "TestGithubSignalHardening"
Cohesion: 0.22
...
### Community 900 - "Feature Maturity / Support Matrix"
Cohesion: 0.25
...
### Community 947 - "crispy_burn_in.py"
Cohesion: 0.36
...
### Community 949 - "run_patched_colibri.py"
Cohesion: 0.36
...
### Community 955 - "TestItIsNotBuiltForOneVendor"
Cohesion: 0.25
...
### Community 956 - "test_compose_and_coordinate_api.py"
Cohesion: 0.36
...
### Community 957 - "TestPoliciesGovernanceStableClaim"
Cohesion: 0.25
...
### Community 960 - "TestOneIdCanBelongToSeveralProviders"
Cohesion: 0.39
...
### Community 964 - "test_runtimes_health_endpoint.py"
Cohesion: 0.25
...
### Community 965 - "test_seo_audit_pending_expiry.py"
Cohesion: 0.43
...
### Community 967 - "test_server_autonomy_and_index_fixes.py"
Cohesion: 0.29
...
### Community 971 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 1003 - "Workspace Issues"
Cohesion: 0.29
...
### Community 1004 - "Model and Response Issues"
Cohesion: 0.29
...
### Community 1018 - "TestSupportMatrixDocsSync"
Cohesion: 0.29
...
### Community 1019 - "test_doctor_coding_brain.py"
Cohesion: 0.38
...
### Community 1020 - "TestGithubTokenSQLiteRegression"
Cohesion: 0.38
...
### Community 1021 - "test_log_monitor_storm_guard.py"
Cohesion: 0.48
...
### Community 1022 - "TestReasonsAreActionable"
Cohesion: 0.29
...
### Community 1023 - "TestProvidersScreen"
Cohesion: 0.43
...
### Community 1029 - "openclaw_mobile_ui"
Cohesion: 0.33
...
### Community 1044 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 1045 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 1046 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 1047 - "The full agent capability roster"
Cohesion: 0.33
...
### Community 1048 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 1049 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 1050 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 1068 - "TestDisabledProvidersAreNotFalselyReportedUnreachable"
Cohesion: 0.33
...
### Community 1088 - "Who is this for?"
Cohesion: 0.40
...
### Community 1089 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 1090 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 1093 - "Agent API Issues"
Cohesion: 0.40
...
### Community 1094 - "Network and Tunnel Issues"
Cohesion: 0.40
...
### Community 1122 - "verify_pr_exists"
Cohesion: 0.50
...
### Community 1140 - "Claude Code Specific Issues"
Cohesion: 0.50
...
### Community 1146 - "_clean_director"
Cohesion: 0.50
...
### Community 1166 - "JWTUserStateMiddleware"
Cohesion: 0.67
...
### Community 1170 - "Configuration reference"
Cohesion: 0.67
Nodes (3): Configuration reference, Provider priority chain, Running the brain on local Ollama (via a tunnel)

### Community 1193 - "test_the_reserve_is_bounded_when_read_from_the_environment"
Cohesion: 0.67
...
- **3532 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3527 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 13480 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **107 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `_fixture()` connect `_fixture` to `company_api.py`, `TaskSpec`, `parse_event_stream`, `test_llm_router_queue_cache.py`, `TaskStatus`, `test_brain_patch_service_token.py`, `AgentJobManager`, `types.py`, `test_gh_brain_failover.py`, `ImprovementLoop`, `gateway.py`, `test_llm_router_strategies.py`, `OperationalIncidentTracker`, `Task`, `E2BSandboxSession`, `PolicyEngine`, `SelfHealingAgent`, `enforcement.py`, `NotificationDispatcher`, `services/background.py`, `MCPClient`, `test_company_api.py`, `config.py`, `test_task_pre_execution_gate.py`, `SeoAuditEngine`, `test_failover_client_shared.py`, `_process_task_callback`, `test_telegram_task_callback.py`, `llm/router.py`, `test_telegram_webhook.py`, `test_llm_router_resilience.py`, `Agency`, `WorkflowRun`, `test_unit8_model_catalog.py`, `test_model_router.py`, `ExecutionRequest`, `UserRole`, `direct_chat.py`, `validate_policy_text`, `test_task_brain_preflight.py`, `tasks/api.py`, `test_openclaw_endpoints.py`, `test_task_service_failed_comment.py`, `test_brain_availability_doctor.py`, `ChatHistoryStore`, `ResearchTask`, `_resolve_brain_provider`, `TestClient`, `test_ai_insights.py`, `SQLiteStore`, `test_telegram_auto_approve.py`, `PrimeAgentAdapter`, `_resolve_push_token`, `e2e/test_browser.py`, `test_procedural_memory.py`, `test_autonomy_status.py`, `get_task_store`, `get_registry`, `test_local_brain_state.py`, `test_startup_warmup.py`, `test_agent_tool_governance.py`, `test_phase5_doctor.py`, `test_refresh_agent_built_proof.py`, `test_tasks_reconciler_todo_requeue.py`, `clear_cooldowns`, `test_knowledge_sync.py`, `run_task`, `cost_tracker.py`, `_clean_director`, `BackgroundAgent`, `SeoFixer`, `KeyStore`, `TestHarnessAdapter`, `test_context_rulebook.py`, `ArtifactStore`, `test_trend_watcher.py`, `sam`, `test_webui_provider_priority.py`, `test_trend_scoping.py`, `test_new_features_e2e.py`, `test_issue_intake.py`, `_step`, `.run`, `resolve_active_brain`, `claim`, `test_changelog_check_workflow.py`, `TestEstimateTokensForMessages`, `test_openclaw_gateway.py`, `test_provider_router.py`, `test_telegram_freebuff.py`, `test_daily_2026_07_27.py`, `FeatureMaturity`, `test_process_quick_note_workflow.py`, `AgentSwarm`, `OllamaCircuitBreaker`, `_job_text`, `TestRuntimeControl`, `_Budget`, `test_ceo_router.py`, `test_features_api.py`, `test_video_transcript.py`, `SchedulerStore`, `nvidia_models.py`, `test_portfolio_intake.py`, `timedelta`, `WorkflowBuildRequest`, `test_e2b_data_flow.py`, `AgentProfile`, `test_agile_api.py`, `test_app_settings.py`, `TestClient`, `TestAuthAndTaskOwnership`, `test_task_clarification.py`, `ContextPruner`, `test_llm_router_disabled.py`, `test_control_plane_api.py`, `test_implement_agent_routing.py`, `test_persistent_memory.py`, `SecurityScanner`, `api_keys_for`, `test_llm_router_e2e.py`, `OutputFilter`, `capture_screens.py`, `test_platform_controls.py`, `analyze_page`, `test_tasks_awaiting_approval_api.py`, `test_sam_voice.py`, `OrchestratorCheckpointStore`, `OrchestratorQueue`, `test_nvidia_model_discovery.py`, `test_catalogue_probe.py`, `TestMongoGate`, `test_rate_limiter.py`, `test_scheduler_hydration_bounded.py`, `test_regression.py`, `test_agent_scripts_share_one_model_list.py`, `test_crispy_burn_in.py`, `test_provider_enable_disable.py`, `test_skill_registry_boot_refresh.py`, `ai/watchdog.py`, `tests/conftest.py`, `_start_ceo_agency`, `reset_failover_manager`, `isolated_telegram_config`, `model_discovery.py`, `_undeclared`, `test_service_token.py`, `test_harness_spec.py`, `operational_incidents.py`, `test_agent_free_brain.py`, `test_freebuff_bot.py`, `test_agency_fix.py`, `_Recorder`, `_resolve_user_github_token`, `test_monitor_lib.py`, `test_v4_api.py`, `TestTheWorkflowIsSafeAndReadOnly`, `test_ping.py`, `test_runtimes_health_endpoint.py`, `test_telegram_diag_endpoint.py`, `test_task_store_fails_loud_in_production.py`, `test_provider_state_durability.py`, `test_kimi_bridge_server.py`, `test_voice_pipeline.py`, `clear_override`, `client`, `test_dashboard_cache.py`, `TestNormalizeResponseFormat`, `test_doctor_coding_brain.py`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `proxy.py`, `TaskSpec`, `AgentJobManager`, `test_governance_api.py`, `test_ceo_dispatcher.py`, `E2BAdapter`, `ReactScratchpad`, `test_agent_free_brain.py`, `E2BSandboxSession`, `PolicyEngine`, `.run`, `enforcement.py`, `test_empirical_verify.py`, `MCPClient`, `loop.py`, `MultiAgentSwarm`, `test_failover_client_shared.py`, `AdaptiveHalter`, `TestAgentRunnerExecution`, `Agency`, `WorkflowRun`, `WorkspaceTools`, `direct_chat.py`, `StuckDetector`, `test_daily_automation_2026_07_11.py`, `Any`, `CEODispatcher`, `LocalWorkspace`, `TokenBudget`, `test_agent_chat_integration.py`, `_resolve_push_token`, `UserMemoryStore`, `FreeBuffAgent`, `test_agent_tool_governance.py`, `ContextManager`, `reset_failover_manager`, `GitHubTools`, `ContextPruner`, `BackgroundAgent`, `InternalAgentAdapter`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderRouter` to `backend/server.py`, `test_implement_agent_routing.py`, `settings.py`, `test_all_providers_discovery.py`, `implement_agent.py`, `test_bedrock_live.py`, `NvidiaProvider`, `test_tokenin_provider.py`, `test_provider_router.py`, `ProviderConfig`, `failover_client.py`, `kimi_bridge_provider_config`, `direct_chat.py`, `TestFromEnvBedrock`, `TestLegacyRouterCacheTTL`, `test_anthropic_refusal_fallback.py`, `TestRouterIntegration`, `TrafficDirector`, `_payload`, `TestLegacyRouterServerFallback`, `is_anthropic_base_url`, `test_chat_mode_regressions.py`, `clear_cooldowns`, `TestAnthropicPayloadStructuredOutput`, `test_colibri_brain_shim.py`?**
