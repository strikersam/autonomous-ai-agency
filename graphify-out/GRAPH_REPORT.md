# Graph Report - pr1311  (2026-08-21)

## Corpus Check
- 1444 files · ~2,076,599 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 28727 nodes · 53656 edges · 1217 communities (1099 shown, 118 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 2637 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d580240a`
...
## Communities (1217 total, 118 thin omitted)

### Community 0 - "backend/server.py"
Cohesion: 0.02
Nodes (284): backend/ceo_router.py — observability and manual control for the CEO. Surfaces…, Reject non-admin callers for routes that spend provider budget. Delegates to…, _require_admin(), _is_admin(), Check if a user has admin role. Works for both social_auth users (role in…, backend/platform_controls_router.py — admin API for the platform controls.…, admin_seed(), _agent_timeout_fallback_response() (+276 more)

### Community 1 - "company_api.py"
Cohesion: 0.02
Nodes (184): ephemeral_ttl_hours(), Async read of the ephemeral TTL (hours) straight from the DB., account_lifecycle(), AccountLifecycleResponse, auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint() (+176 more)

### Community 2 - "CompanyGraphService"
Cohesion: 0.02
Nodes (111): BusinessCategory, CompanyGraph, SpecialistFamily, SystemType, Get the index of a phase in the workflow., The complete Company Graph - canonical core model for the Autonomous AI Agency.…, Find a website by its URL., Find a repository by its URL. (+103 more)

### Community 3 - "MongoDBStore"
Cohesion: 0.02
Nodes (95): CompanyGraphSnapshot, KnowledgeItem, A point-in-time snapshot of a Company Graph for history and rollback., Structured knowledge about the company, systems, or processes., A company repository with detected technologies and metadata., Extract the owner from the full name., Extract the repository name from the full name., Repo (+87 more)
...
Cohesion: 0.02
Nodes (112): int, CacheManager, cosine_similarity(), _Entry, LRUCache, payload_key(), Any, T (+104 more)

### Community 6 - "types.py"
Cohesion: 0.03
Nodes (88): packages/llm — the multi-provider LLM routing layer. Every LLM call in this…, AnthropicProvider, Any, AsyncClient, packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, Translate OpenAI-shaped messages into Anthropic's system/turn split., OpenAI carries a tool result as role="tool" with a tool_call_id; Anthropic…, OpenAI puts a tool call alongside the assistant's text; Anthropic needs… (+80 more)

### Community 7 - "ExecutionRequest"
Cohesion: 0.03
Nodes (92): Execute work through the 11-phase golden path., Return orchestrator queue depth, active runs, and supervisor state (#522)., Called by APScheduler when a cron fires. Dispatches to the orchestrator. This…, _scheduler_on_fire(), workflow_orchestrator_execute(), workflow_orchestrator_status(), _NoopDB, Fallback in-memory store when no DB is available. (+84 more)
...
### Community 9 - "WorkflowRun"
Cohesion: 0.03
Nodes (89): DirectChatDoctor, get_orchestrator_queue(), ClassifyOutput, get_ceo_fallback_stats(), MergeDecision, _NoopStore, PlanOutput, Any (+81 more)
...
Cohesion: 0.03
Nodes (92): get_budget(), The process-wide budget tracker., get_cache(), packages/llm/cache.py — layered caching. Five independent layers, each with its…, The process-wide cache manager., text_key(), openai_body_from_response(), Any (+84 more)

### Community 14 - "_fixture"
Cohesion: 0.02
Nodes (104): app_client(), _clear_discovered_models(), _clear_response_cache(), client(), _isolate_brain_data_layer(), _isolate_operator_provider_state(), non_admin_client(), MonkeyPatch (+96 more)

### Community 15 - "E2BSandboxSession"
Cohesion: 0.04
Nodes (91): MCPUnavailableError, Raised when the MCP server is unreachable or the circuit is open., E2BSandboxSession, _inject_token(), maybe_attach_e2b(), Any, services/e2b_sandbox.py — E2B Firecracker micro-VM sandbox session. Implements…, Create the sandbox. Raises :class:`MCPUnavailableError` on failure. (+83 more)

### Community 16 - "test_ceo_dispatcher.py"
Cohesion: 0.02
Nodes (102): CEOResult, _complexity_rank(), _decompose_into_subtasks(), get_ceo_dispatcher(), _merge_changed_files(), _offload(), Any, Semaphore (+94 more)
...
Cohesion: 0.04
Nodes (81): events_from_identity(), Convenience: build and record an event in one call., Extract the identity-derived audit fields from an AgentIdentity. Kept here…, record_event(), build_docker_run_argv(), detect_backend(), DockerBackend, E2BBackend (+73 more)

### Community 19 - "test_model_router.py"
Cohesion: 0.03
Nodes (105): classify_task(), _extract_recent_text(), Any, Task classification from request context. Classifies an incoming request into a…, Concatenate plain text from the last *last_n* messages., Return the most likely task category for this request. Args: messages: OpenAI-…, Reset the singleton and clear the cached model map (test helper)., reset_router() (+97 more)
...
Cohesion: 0.03
Nodes (86): _is_duplicate_key_error(), _priority_rank(), Any, Exception, Task, TaskStatus, tasks/store.py — MongoDB-backed task store. Falls back to in-memory storage…, Fail loud in production if no persistent storage is configured. Telegram… (+78 more)

### Community 23 - "ProviderConfig"
Cohesion: 0.04
Nodes (92): _acquire_provider_probe(), CommercialFallbackRequiredError, extract_openai_text(), _get_director(), is_commercial_provider(), _normalize_nvidia_base_url(), _normalized_provider_type(), _ollama_reasoning_effort() (+84 more)

### Community 24 - "LLMRequest"
Cohesion: 0.04
Nodes (96): ProviderConfig, One configured endpoint. ``kind`` selects the adapter: ``openai`` (any OpenAI-…, build_provider(), ProviderConfig, Normalise a configured ``kind`` to an adapter key., Instantiate the adapter for one provider config. Unknown kinds fall back to the…, resolve_kind(), LLMRequest (+88 more)

### Community 25 - "Task"
Cohesion: 0.04
Nodes (73): Hand the 'connect & verify the repo' work to the agency's own agents. The task…, _seed_connect_task(), Helpers that turn scheduler and playbook activity into real tasks., Full task/issue document., Update the updated_at timestamp., Task, Domain services for task workflow and runtime-backed execution., Owns lifecycle transitions, comment semantics, and approval rules. (+65 more)

### Community 26 - "test_render_mcp.py"
Cohesion: 0.04
Nodes (56): agent/mcp_client.py — Async MCP client for the mcp-server Docker container.…, build_render_router(), Any, APIRouter, Exception, backend/render_router.py — Render platform view for operators and agents.…, Reject anyone who is not the agency admin., Map an MCP transport failure onto 503 rather than a 500. The distinction… (+48 more)

### Community 27 - "AgentSwarm"
Cohesion: 0.04
...
### Community 34 - "test_agent_tool_governance.py"
Cohesion: 0.04
Nodes (77): Replace the process-wide store. Tests only., reset_approval_store(), AuditEvent, AuditLog, Any, packages/governance/audit.py — the evidence trail for every governed action.…, Redact secret-shaped substrings, then truncate., One governed action, fully described. Field order follows the… (+69 more)
...
Cohesion: 0.04
Nodes (87): Call-time resolver for an agent role model id. Delegates to…, _resolve_role_model(), allow_paid_brain(), BrainResolution, BrainConfigPatch, get_brain_config(), invalidate_brain_config_cache(), Convenience wrapper used by the agent loop + brain resolver. (+79 more)

### Community 37 - "PolicyEngine"
Cohesion: 0.05
Nodes (70): _action_matches(), _as_list(), Decision, GroupPolicy, _host_matches(), Mode, _normalise_path(), _path_matches() (+62 more)
...
### Community 39 - "Agency"
Cohesion: 0.06
Nodes (64): Agency, AgencyCycleResult, AgentDirective, AgentRole, _build_ceo_prompt(), _build_quick_note_instruction(), _close_github_issue(), _collect_recent_git_context() (+56 more)

### Community 40 - "test_unit8_model_catalog.py"
Cohesion: 0.04
Nodes (71): all_provider_ids(), Return every provider id recognised by the brain config system. Iterates the…, CatalogActiveBrain, CatalogMirror, CatalogProviderEntry, get_catalog(), get_model_catalog_store(), _include_router_providers() (+63 more)
...
### Community 43 - "tasks/models.py"
Cohesion: 0.04
Nodes (72): tasks — Task/issue management system. Provides a lightweight task/issue tracker…, ApprovalCheckpoint, ApprovalRequest, ClarifyRequest, _coerce_ts(), CommentAddRequest, ExecutionApprovalRequest, ExecutionLogEntry (+64 more)

### Community 44 - "BrainConfig"
Cohesion: 0.04
Nodes (70): BrainConfig, BrainConfigStore, default_brain_config(), provider_base_url(), BaseModel, Persist *cfg* to Mongo (primary) and sqlite (mirror). Either backend failing is…, Build a ``BrainConfig`` from a Mongo doc, dropping Mongo's ``_id``., Synchronous call-time resolver for an agent role model id. Precedence (highest… (+62 more)

### Community 45 - "test_governance_enforcement.py"
Cohesion: 0.04
Nodes (75): Recursively strip secrets from an arbitrary argument structure. Fails…, scrub(), BudgetTracker, GovernanceGate, Holds live session budgets, bounded so it cannot leak. Sessions end without…, The one seam through which governed actions pass., AgentIdentity, _coerce_text() (+67 more)

### Community 46 - "brain_config.py"
Cohesion: 0.04
Nodes (81): _build_base_url_env_from_yaml(), _build_candidates_from_yaml(), _build_default_base_url_from_yaml(), _build_display_names_from_yaml(), _build_key_env_from_yaml(), _build_presets_from_yaml(), _build_tier_from_yaml(), get_provider_candidates() (+73 more)

### Community 47 - "WebsiteScanner"
Cohesion: 0.04
...
### Community 49 - "test_sam_livekit.py"
Cohesion: 0.04
Nodes (66): get_sam(), agent/sam.py — SAM Voice Agent (System Autonomy Manager) SAM is the voice-…, _get_backend_sam(), Lazy-init the SAM agent for the backend deployment., Get SAM's current status., Report whether the SAM realtime voice (LiveKit) transport is configured., sam_livekit_status_backend(), sam_status_backend() (+58 more)

### Community 50 - "AgentJobManager"
Cohesion: 0.05
...
### Community 51 - "test_ceo_router.py"
Cohesion: 0.05
Nodes (59): build_ceo_router(), Any, APIRouter, CEOSupervisor, _env_flag(), _env_int(), get_ceo_supervisor(), Any (+51 more)

### Community 52 - "TestAdapterMetadata"
Cohesion: 0.03
Nodes (36): AiderAdapter, Any, Adapter for Aider — TIER 3 specialized git-aware code editor., _env_float(), HermesAdapter, Any, AsyncClient, Response (+28 more)
...
### Community 55 - "TaskExecutionCoordinator"
Cohesion: 0.04
Nodes (46): _gate_outward_facing_enabled(), _is_brain_connection_error(), _is_outward_facing(), Any, BaseException, Task, TaskResult, TaskSpec (+38 more)
...
### Community 58 - "test_runtime_governance.py"
Cohesion: 0.06
Nodes (62): _egress_policy_reason(), Return why governance policy blocks *host*, or None. Runs strictly *after* the…, _load(), Import the governance layer once, recording why if it is absent., governance_enabled(), True when the governance layer should run at all. A single global off switch…, get_policy_engine(), Return the process-wide policy engine, loading it on first use. One engine per… (+54 more)

### Community 59 - "rbac.py"
Cohesion: 0.05
Nodes (46): compute_savings(), compute_time_series(), get_savings(), get_usage(), get_user_savings(), _period_start(), Any, BaseModel (+38 more)

### Community 60 - "FetchResult"
Cohesion: 0.05
...
### Community 65 - "DashboardLayout.js"
Cohesion: 0.06
...
### Community 68 - "test_mcp_registry.py"
Cohesion: 0.06
Nodes (45): get_mcp_client(), Return the module-level MCPClient. Reads MCP_SERVER_BASE_URL at call time (not…, _internal_configured(), list_specs(), MCPServerSpec, _not_dialable(), _playwright_configured(), _probe_http() (+37 more)
...
Cohesion: 0.05
Nodes (52): brain_availability_summary(), Non-secret answer to "can the brain answer a request right now?". Three callers…, Attempt, _backend(), CEOLedger, _now(), Any, services/ceo_ledger.py — durable record of what the CEO is driving to closure.… (+44 more)
...
### Community 73 - "ensure_self_company"
Cohesion: 0.04
Nodes (53): CompanyAgencyService, get_company_agency_service(), _is_runtime_available_sync(), _pick_available_runtime(), Any, SpecialistFamily, services/company_agency.py — Company Agency Orchestration Service After…, Orchestrates specialist activation, runtime startup, and 24x7 scheduling for a… (+45 more)
...
### Community 77 - "seo_api.py"
Cohesion: 0.06
Nodes (62): _expire_stale_pending_report(), export_seo_audit(), get_seo_audit(), list_seo_audits(), BaseModel, get, post, SEO / GEO / AIO Audit API Router Endpoints for the world-class SEO audit engine… (+54 more)
...
### Community 79 - "CompanyGraphStore"
Cohesion: 0.03
Nodes (32): requires_db, CompanyGraphStore, Delete a company and all its associated data., List companies with optional filtering., Count total companies in the store., Create a new company graph., Get the complete company graph for a company., Update a company graph. (+24 more)

### Community 80 - "enforcement.py"
Cohesion: 0.05
Nodes (49): build_governance_router(), Any, APIRouter, backend/governance_router.py — read and operate the governance layer. Mounted…, Reject non-admin callers. Mirrors the RBAC check used elsewhere in this backend…, _require_admin(), get_approval_store(), BudgetExceeded (+41 more)

### Community 81 - "SeoAuditEngine"
Cohesion: 0.06
Nodes (35): field_validator, A single occurrence of a check firing on a specific URL., Aggregated report row - Screaming Frog CSV compatible., Site-level facts discovered during the crawl., Request to run an SEO/GEO/AIO audit against a website., SeoAuditRequest, SeoIssueInstance, SeoIssueReportRow (+27 more)

### Community 82 - "TestClient"
Cohesion: 0.10
Nodes (29): bare_repo(), _call(), _data(), git_config_env(), _is_error(), mcp_workspace_root(), Path, skipif (+21 more)

### Community 83 - "test_startup_warmup.py"
Cohesion: 0.04
...
### Community 85 - "AgentPlan"
Cohesion: 0.06
Nodes (50): PreflightIssue, PreflightReport, BaseModel, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, Agent subsystem — planner / executor / verifier loop., AgentEvent, AgentPlan, AgentRunRequest (+42 more)
...
### Community 87 - "InternalAgentAdapter"
Cohesion: 0.04
Nodes (41): _best_cloud_primary_base(), InternalAgentAdapter, TaskResult, TaskSpec, Built-in agent loop — Nvidia NIM primary, Ollama fallback., Return runtime dependencies required by this adapter. Returns:…, Determine availability of the internal agent runtime. Checks cloud providers in…, Execute a TaskSpec using the internal AgentRunner and convert the agent's… (+33 more)
...
### Community 90 - "get_task_store"
Cohesion: 0.04
Nodes (54): _fetch_github_quick_notes(), _gh_repo(), _gh_token(), Return the GitHub repo in 'owner/name' format. Priority: 1. GITHUB_REPOSITORY…, Return ALL open GitHub issues for this repo (not just 'quick-note' labelled).…, delegate_seo_findings(), Create real agent tasks from the audit's delegation plan. Each work package…, _autonomy_bg_cycle() (+46 more)

### Community 91 - "WebReach"
Cohesion: 0.07
Nodes (48): Register the built-in agent tools that are always available., Register the Web Reach capability (agent/web_reach.py): zero-key internet…, _register_builtin_tools(), _register_web_reach_tools(), get_web_reach(), _load_script_module(), Any, ModuleType (+40 more)

### Community 92 - "AgileSprint"
Cohesion: 0.05
...
### Community 93 - "brain_failover.py"
Cohesion: 0.06
Nodes (59): auto_disable(), _billing_signals(), disabled_provider_ids(), is_unfixable(), packages/llm/disabled.py — bridge to the durable provider on/off switch. The…, Provider ids currently switched off. Empty when the store is unreachable., Persist a provider as disabled, through the store that already owns it., The one list of "you have no money" phrases, borrowed not copied. Lazy because… (+51 more)

### Community 94 - "FinancialMetrics"
Cohesion: 0.06
...
### Community 99 - "test_user_research_skill.py"
Cohesion: 0.06
...
### Community 104 - "probe_model_liveness"
Cohesion: 0.05
...
Cohesion: 0.06
Nodes (57): _apply_env_overrides(), _apply_key_env(), _build(), _coerce(), config_dir(), _env_key_names(), expand_env(), _fields_of() (+49 more)

### Community 106 - "test_colibri_brain_shim.py"
Cohesion: 0.06
...
### Community 110 - "diagnostics.py"
Cohesion: 0.06
Nodes (51): _check_background_liveness(), _check_ci_parity(), _check_company_graph(), _check_disk(), _check_event_log_integrity(), _check_feature_matrix(), _check_github_readiness(), _check_ollama() (+43 more)
...
### Community 114 - "AgentSessionStore"
Cohesion: 0.07
...
### Community 126 - "RepowiseIntelligence"
Cohesion: 0.06
...
### Community 129 - "runtimes/manager.py"
Cohesion: 0.06
...
### Community 133 - "test_self_heal_v2.py"
Cohesion: 0.07
Nodes (51): Reset the singleton (for tests)., reset_failover_manager(), _blocked_retire_age_sec(), _heal_blocked_backlog(), _heal_brain_failover(), _heal_purge_backlog(), _heal_stuck_tasks(), _heal_telegram() (+43 more)
...
### Community 136 - "test_governance_api.py"
Cohesion: 0.07
Nodes (49): get_audit_log(), Return the process-wide audit log, created on first use., Replace the process-wide gate. Tests only., reset_gate(), _client(), parametrize, TestClient, Tests for the governance HTTP surface and the AgentRunner integration. The… (+41 more)

### Community 137 - "test_autonomous_agency_e2e.py"
Cohesion: 0.08
...
Cohesion: 0.07
Nodes (28): Attempt, describe(), The operator-facing reason string for an unfixable status., Read the environment variables named in ``env_names`` into a key list. Order is…, resolve_keys(), LLMRouter, Any, AsyncClient (+20 more)
...
### Community 146 - "persist_plan_spec"
Cohesion: 0.07
...
### Community 148 - "ProvidersScreen.jsx"
Cohesion: 0.06
...
### Community 149 - "TestEstimateTokensForMessages"
Cohesion: 0.05
...
### Community 151 - "test_control_plane_api.py"
Cohesion: 0.05
...
### Community 158 - "test_schedule_growth_invariants.py"
Cohesion: 0.05
...
### Community 163 - "[Unreleased]"
Cohesion: 0.04
Nodes (46): [5.0.0], Added, Added, Added, Added, Added, Added, Added (+38 more)

### Community 164 - "[Unreleased]"
Cohesion: 0.04
Nodes (46): [5.0.0], Added, Added, Added, Added, Added, Added, Added (+38 more)

### Community 165 - "Workspace"
Cohesion: 0.07
...
Cohesion: 0.06
Nodes (44): _auto_disable(), _describe_registry(), _disable_unless_key_serves_other_models(), _disabled_ids(), _is_billing_refusal(), _is_ollama(), _key_pool(), _log_exhaustion() (+36 more)
...
### Community 168 - "StreamingDeltaReconstructor"
Cohesion: 0.07
...
### Community 170 - "test_telegram_freebuff.py"
Cohesion: 0.07
...
### Community 171 - "control_overrides.py"
Cohesion: 0.07
...
### Community 174 - "test_daily_2026_06_04.py"
Cohesion: 0.07
...
### Community 175 - "OllamaCircuitBreaker"
Cohesion: 0.08
...
### Community 178 - "activation_api.py"
Cohesion: 0.09
...
### Community 189 - "anthropic_compat.py"
Cohesion: 0.09
...
Cohesion: 0.08
Nodes (23): _exponential_backoff_cooldown(), _notify_watchdog(), ProviderAttempt, ProviderRouter, Any, Response, Try all models for one provider. Returns ProviderResult on success, None on…, Notify the brain watchdog of a provider call outcome (fire-and-forget).… (+15 more)
...
### Community 194 - "NotificationDispatcher"
Cohesion: 0.07
...
### Community 197 - "get_failover_manager"
Cohesion: 0.06
...
### Community 198 - "test_dashboard_cache.py"
Cohesion: 0.06
...
### Community 203 - "test_bedrock_provider.py"
Cohesion: 0.08
...
### Community 204 - "test_operational_incidents.py"
Cohesion: 0.05
...
### Community 206 - "Kept Rules — the 44 that survive the audit"
Cohesion: 0.05
...
### Community 207 - "compare_runtimes.py"
Cohesion: 0.07
...
### Community 220 - "AgentDefinition"
Cohesion: 0.09
Nodes (21): AgentDefinition, AgentStore, Any, field_validator, CRUD store for AgentDefinition objects. Uses MongoDB when a `db` client is…, Return an agent by ID. If *owner_id* is provided, enforces that the agent…, Delete an agent. Returns True on success, False if not found/unauthorised., Return all agents owned by *owner_id*, optionally including public agents. (+13 more)

### Community 221 - "Workflow"
Cohesion: 0.06
...
### Community 222 - "chat_handlers.py"
Cohesion: 0.10
...
### Community 227 - "analyze_quantitative"
Cohesion: 0.09
...
### Community 229 - "test_pr923_fixes.py"
Cohesion: 0.07
...
### Community 240 - "test_verification_strategies.py"
Cohesion: 0.11
...
### Community 241 - "agents/agile_ceremonies.py"
Cohesion: 0.08
...
### Community 242 - "audit"
Cohesion: 0.08
Nodes (17): audit(), get_audit_log(), is_admin(), is_power_user_or_above(), Any, Return a short human-readable badge label for display in the UI., Append an audit log entry. Never logs raw secrets — only secret IDs / masked…, Return recent audit log entries, newest first. Supports filtering by user_id,… (+9 more)

### Community 243 - "REWRITE_PLAN.md — Phased Migration Strategy"
Cohesion: 0.06
...
### Community 245 - "report_to_markdown"
Cohesion: 0.08
...
### Community 256 - "test_anthropic_router.py"
Cohesion: 0.09
...
### Community 258 - "test_llm_router_e2e.py"
Cohesion: 0.14
...
### Community 267 - "test_live_server.py"
Cohesion: 0.22
...
### Community 268 - "test_telegram_mutating_commands.py"
Cohesion: 0.06
Nodes (21): _Captured, _make_mock_response(), tests/test_telegram_mutating_commands.py — N5 acceptance: /setbrain + /merge.…, Build a mock httpx.Response., A successful /setbrain call must: 1. send the X-Service-Token header 2. PATCH…, When the backend's liveness probe fails (HTTP 422), the bot reply must surface…, 503 = backend doesn't have SERVICE_TOKEN set. The bot reply must tell the…, A successful /merge call returns the merge SHA + actor attribution so the… (+13 more)
...
### Community 275 - "test_rate_limiter.py"
Cohesion: 0.09
...
### Community 276 - "RateLimitTracker"
Cohesion: 0.10
...
### Community 278 - "test_iteration_6_features.py"
Cohesion: 0.06
...
### Community 280 - "test_microagents.py"
Cohesion: 0.15
...
### Community 283 - "Langfuse Observability Guide"
Cohesion: 0.06
...
### Community 285 - "BrainFailoverManager"
Cohesion: 0.09
...
### Community 286 - "OrchestratorQueue"
Cohesion: 0.07
...
### Community 289 - "test_workspace_isolation.py"
Cohesion: 0.16
...
### Community 290 - "operational_incidents.py"
Cohesion: 0.11
...
### Community 296 - "TestNormalizeResponseFormat"
Cohesion: 0.08
...
### Community 298 - "get_skill_bindings"
Cohesion: 0.10
...
### Community 299 - "test_failover_silent_exhaustion.py"
Cohesion: 0.11
...
### Community 302 - "test_portfolio_intelligence.py"
Cohesion: 0.07
...
### Community 303 - "test_purge_backlog.py"
Cohesion: 0.09
...
### Community 304 - "test_autonomy_gate.py"
Cohesion: 0.12
...
### Community 309 - "test_force_cleanup_conditional_delete.py"
Cohesion: 0.10
...
### Community 315 - "control_registry.py"
Cohesion: 0.12
...
### Community 316 - "SteeringInjector"
Cohesion: 0.11
...
### Community 317 - "RuntimeHealthService"
Cohesion: 0.09
...
### Community 318 - "test_claude_setup_audit.py"
Cohesion: 0.16
...
### Community 319 - "test_internal_agent_did_work.py"
Cohesion: 0.12
...
### Community 320 - "test_p0_roadmap_b1_c2_a3.py"
Cohesion: 0.11
Nodes (13): _infer_parameters_from_func(), Infer a basic JSON Schema from a function's signature., _inject_tool_results_as_messages(), _normalize_tool_choice(), _parse_tool_calls_from_response(), Parse OpenAI tool_calls from a model response. Handles: - Direct JSON…, Normalize the ``tool_choice`` parameter for the upstream backend. OpenAI…, Inject tool call results as follow-up messages for multi-turn execution. When… (+5 more)
...
### Community 322 - "Python Dependencies (`requirements.txt`)"
Cohesion: 0.07
...
### Community 323 - "Technical Debt Register — local-llm-server"
Cohesion: 0.07
...
Cohesion: 0.16
Nodes (11): One concrete remediation performed (or proposed) by the fixer., SeoFixAction, _humanize_filename(), BeautifulSoup, Path, services/seo_fixer.py - Repo-Aware SEO Auto-Fixer When a company has a code…, Derive readable alt text from an image path: 'img/hero-banner_2.jpg' -> 'Hero…, Applies (or proposes) automatic SEO remediations inside a repo checkout. (+3 more)

### Community 326 - "TrafficDirector"
Cohesion: 0.11
...
### Community 336 - "SetupWizardPage.js"
Cohesion: 0.11
...
### Community 339 - "test_north_mini_code.py"
Cohesion: 0.08
...
### Community 340 - "traffic_director.py"
Cohesion: 0.11
...
### Community 343 - "isolated_telegram_config"
Cohesion: 0.11
...
### Community 345 - "validate_outbound_url"
Cohesion: 0.14
...
### Community 348 - "TestMCPClientStructuredOutput"
Cohesion: 0.13
...
### Community 349 - "VoiceCommandInterface"
Cohesion: 0.14
...
### Community 350 - "Performance Analysis — local-llm-server"
Cohesion: 0.08
...
### Community 351 - "LLM Router — troubleshooting"
Cohesion: 0.08
...
### Community 353 - "seo_report_pdf.py"
Cohesion: 0.21
...
### Community 354 - "output_filter.py"
Cohesion: 0.08
...
### Community 355 - "model_discovery.py"
Cohesion: 0.11
...
### Community 369 - "autonomous_fix.py"
Cohesion: 0.14
...
### Community 371 - "has_image_content"
Cohesion: 0.12
...
### Community 372 - "test_claude_code_adapter.py"
Cohesion: 0.14
...
### Community 373 - "_InMemoryBackend"
Cohesion: 0.11
...
### Community 393 - "TestDetectedSystemPersistence"
Cohesion: 0.09
...
### Community 398 - "_ensure_tasks_source_id_unique_index"
Cohesion: 0.13
Nodes (22): _agent_provider_failure_response(), _ensure_tasks_source_id_unique_index(), _is_index_options_conflict(), Exception, True when *exc* is Mongo refusing to redefine an existing index. Mongo raises…, Add a unique **partial** index on tasks.source_id — isolated from the main…, Fall back to a direct LLM call when the agent loop cannot reach any provider.…, _heal_task_duplicates() (+14 more)
...
### Community 405 - "reap_expired_companies"
Cohesion: 0.14
...
### Community 406 - "SyntheticDataPipeline"
Cohesion: 0.13
...
### Community 407 - "test_all_features.py"
Cohesion: 0.09
...
### Community 414 - "HarnessEnrichment"
Cohesion: 0.14
...
### Community 415 - "classify_direct_chat_intent"
Cohesion: 0.13
...
### Community 417 - "AdaptivePermissions"
Cohesion: 0.18
...
### Community 421 - "test_provider_410_per_model.py"
Cohesion: 0.14
...
### Community 427 - "V3 API Migration Plan — LLM Relay Platform"
Cohesion: 0.10
...
### Community 428 - "PortfolioScreen.jsx"
Cohesion: 0.10
...
### Community 430 - "system_instruction"
Cohesion: 0.16
...
### Community 433 - "test_agent_free_brain.py"
Cohesion: 0.10
...
### Community 443 - "test_minimax_bug_fixes.py"
Cohesion: 0.12
...
### Community 447 - "Docker AI Governance Audit — Final Report"
Cohesion: 0.10
...
### Community 448 - "1. Capability-by-capability"
Cohesion: 0.10
...
### Community 450 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 454 - "test_kimi_bridge_server.py"
Cohesion: 0.12
...
### Community 457 - "test_freebuff_bot.py"
Cohesion: 0.12
...
### Community 461 - "test_tasks_cache_ttl_env.py"
Cohesion: 0.21
...
### Community 462 - "test_voice_pipeline.py"
Cohesion: 0.14
...
### Community 465 - "open_phase_report"
Cohesion: 0.14
...
### Community 468 - "PerformanceAnalytics"
Cohesion: 0.12
...
### Community 470 - "Skill: fabric-patterns"
Cohesion: 0.11
...
### Community 471 - "Analysis & Synthesis Instructions"
Cohesion: 0.11
Nodes (18): 1. Define the Atmosphere, 2. Map the Color Palette, 3. Establish Typography Rules, 4. Define the Hero Section, 5. Describe Component Stylings, 6. Define Layout Principles, 7. Define Responsive Rules, 8. Encode Motion Philosophy (+10 more)

### Community 472 - "Production Readiness Assessment — local-llm-server"
Cohesion: 0.11
...
### Community 475 - "Admin Dashboard Guide"
Cohesion: 0.11
...
### Community 476 - "Implementation Plan"
Cohesion: 0.11
...
### Community 479 - "test_p0_roadmap_a4_a5_b2.py"
Cohesion: 0.15
...
### Community 482 - "TestSelfHealingInfrastructureClassification"
Cohesion: 0.19
...
### Community 483 - "test_fabric_patterns.py"
Cohesion: 0.11
...
### Community 484 - "test_repowise_intelligence.py"
Cohesion: 0.11
...
### Community 485 - "test_schedule_persistence.py"
Cohesion: 0.15
...
### Community 486 - "validate_session_id"
Cohesion: 0.16
...
### Community 488 - "get_tool_registry"
Cohesion: 0.14
...
### Community 489 - "ErrorInterceptorMiddleware"
Cohesion: 0.18
...
### Community 502 - "sync_readme_gallery.py"
Cohesion: 0.22
...
### Community 503 - "test_p0_roadmap_b3_b4_b5.py"
Cohesion: 0.16
...
### Community 508 - "TestStopSlopChecker"
Cohesion: 0.11
...
### Community 510 - "test_telegram_service_webhook.py"
Cohesion: 0.18
...
### Community 511 - "handle_workflow_ide_chat"
Cohesion: 0.18
...
### Community 514 - "cowork_session.py"
Cohesion: 0.15
...
### Community 515 - "SKILL: Industrial Brutalism & Tactical Telemetry UI"
Cohesion: 0.12
...
### Community 516 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 517 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 518 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 520 - "Section-by-Section Acceptance Criteria"
Cohesion: 0.12
...
### Community 524 - "provider_max_rpm"
Cohesion: 0.17
...
### Community 525 - "redact_connection_url"
Cohesion: 0.17
...
### Community 526 - "kimi_bridge_provider_config"
Cohesion: 0.18
...
### Community 527 - "parse_event_stream"
Cohesion: 0.17
...
### Community 528 - "agent_readiness_audit.py"
Cohesion: 0.21
...
### Community 531 - "test_daily_automation_2026_07_11.py"
Cohesion: 0.15
...
### Community 532 - "test_health_endpoints.py"
Cohesion: 0.17
...
### Community 533 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 534 - "test_monitor_lib.py"
Cohesion: 0.16
...
### Community 535 - "test_openclaw_endpoints.py"
Cohesion: 0.12
...
### Community 537 - "test_skill_registry.py"
Cohesion: 0.13
...
### Community 538 - "test_task_service_failed_comment.py"
Cohesion: 0.18
...
### Community 539 - "hermes_prompt.py"
Cohesion: 0.19
...
### Community 541 - "MemoryMiddleware"
Cohesion: 0.17
...
### Community 545 - "Skill: repowise-intelligence"
Cohesion: 0.12
...
### Community 546 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
...
### Community 550 - "refresh_agent_built_proof.py"
Cohesion: 0.20
...
### Community 552 - "Feature Maturity / Support Matrix"
Cohesion: 0.12
...
### Community 553 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 554 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
...
### Community 555 - "implement_agent.py"
Cohesion: 0.16
...
### Community 561 - "test_telegram_auto_approve.py"
Cohesion: 0.21
...
### Community 562 - "ManagedAgentDreams"
Cohesion: 0.22
...
### Community 563 - "_process_task_callback"
Cohesion: 0.28
...
### Community 565 - "test_brain_failover_413.py"
Cohesion: 0.13
...
### Community 566 - "DailyDigestAggregatorTests"
Cohesion: 0.19
...
### Community 567 - "test_dockerfile_ships_root_modules.py"
Cohesion: 0.17
...
### Community 569 - "test_glm52_brain.py"
Cohesion: 0.12
...
### Community 571 - "test_llm_router_tpm.py"
Cohesion: 0.20
...
### Community 572 - "test_local_brain_state.py"
Cohesion: 0.12
...
### Community 574 - "test_phase5_doctor.py"
Cohesion: 0.12
...
### Community 575 - "test_provider_state_durability.py"
Cohesion: 0.14
...
### Community 576 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 577 - "test_refresh_agent_built_proof.py"
Cohesion: 0.12
...
### Community 578 - "test_tasks_reconciler_todo_requeue.py"
Cohesion: 0.20
Nodes (15): _make_task(), asyncio, Task, TaskStatus, Tests: reconciler handles TODO tasks with pending_agent_run=False. Covers the…, A TODO task with pending_agent_run=False must be re-queued by the reconciler., A TODO task with pending_agent_run=True does NOT need reconciliation., A DONE task is never touched by the reconciler regardless of pending flag. (+7 more)

### Community 579 - "test_telegram_diag_endpoint.py"
Cohesion: 0.12
...
### Community 583 - "CollaborationContext"
Cohesion: 0.17
...
### Community 584 - "Skill: agent-harness"
Cohesion: 0.13
...
### Community 585 - "Skill: checkpoint-strategy"
Cohesion: 0.13
...
### Community 587 - "Skill: local-ai-query"
Cohesion: 0.13
...
### Community 588 - "Skill: parallel-agents"
Cohesion: 0.13
...
### Community 589 - "Skill: parallel-worktrees"
Cohesion: 0.13
...
### Community 590 - "Design System: Taste Standard"
Cohesion: 0.13
...
### Community 592 - "Skill: user-research"
Cohesion: 0.13
...
### Community 593 - "DirectChatSession"
Cohesion: 0.14
...
### Community 594 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 598 - "_push_down_where"
Cohesion: 0.14
...
### Community 599 - "router/health.py"
Cohesion: 0.20
...
### Community 600 - "AdminDigestRouterAuthTests"
Cohesion: 0.22
...
### Community 601 - "clear_wizard_state_cache"
Cohesion: 0.21
...
### Community 602 - "e2e/test_browser.py"
Cohesion: 0.23
...
### Community 604 - "DecisionsStoreTests"
Cohesion: 0.13
...
### Community 605 - "test_dockerfile_ships_config_dir.py"
Cohesion: 0.14
...
### Community 609 - "test_ai_insights.py"
Cohesion: 0.20
...
### Community 612 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 616 - "Checks Performed"
Cohesion: 0.14
...
### Community 617 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 618 - "monitor_colibri.py"
Cohesion: 0.24
...
### Community 619 - "admin_digest_router.py"
Cohesion: 0.22
...
### Community 620 - "Skill: branch-cleanup"
Cohesion: 0.14
...
### Community 621 - "Skill: perplexity — Web Research via Perplexity API"
Cohesion: 0.14
...
### Community 624 - "Quick-Note Issues Processing Summary"
Cohesion: 0.14
...
### Community 625 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 627 - "Render MCP — autonomous platform debugging and environment monitoring"
Cohesion: 0.14
...
### Community 628 - "Runbook: Auto-Resume After Cooldown / Interruption"
Cohesion: 0.14
...
### Community 629 - "SEO / GEO / AIO Audit Engine"
Cohesion: 0.14
...
### Community 633 - "_parse_reset_epoch"
Cohesion: 0.21
...
### Community 635 - "TestSeoApiSurface"
Cohesion: 0.16
...
### Community 638 - ".on_task_complete"
Cohesion: 0.16
...
### Community 640 - "TestAnthropicToolListCaching"
Cohesion: 0.34
...
### Community 641 - "test_ceo_direct_dedup.py"
Cohesion: 0.25
...
### Community 644 - "test_openclaw_gateway.py"
Cohesion: 0.14
...
### Community 645 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 650 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 653 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 654 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 657 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
...
### Community 658 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 659 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 661 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 663 - "admin_update_task_router.py"
Cohesion: 0.22
...
### Community 672 - "_is_bedrock_model_id"
Cohesion: 0.27
...
### Community 674 - "Agent Transparency Report"
Cohesion: 0.15
...
### Community 675 - "update_provider_policy"
Cohesion: 0.19
...
### Community 677 - "TestAgentRunnerSafety"
Cohesion: 0.19
...
### Community 678 - "TestModelCostTableUpdates"
Cohesion: 0.26
...
### Community 679 - "TestDecisionsBotLinks"
Cohesion: 0.21
...
### Community 680 - "test_deploy_trigger_covers_image.py"
Cohesion: 0.21
...
### Community 681 - "test_doctor_service_token_check.py"
Cohesion: 0.23
...
### Community 682 - "TestRuntimeControl"
Cohesion: 0.15
...
### Community 683 - "TestKillSwitchDurability"
Cohesion: 0.15
...
### Community 684 - "test_task_brain_preflight.py"
Cohesion: 0.31
...
### Community 687 - "WorkspaceManifest"
Cohesion: 0.17
...
### Community 688 - "skill_registry.py"
Cohesion: 0.17
...
### Community 695 - "Skill: system-prompt-audit"
Cohesion: 0.17
...
### Community 696 - "Skill: task-alive-updates"
Cohesion: 0.17
...
### Community 699 - "_is_ephemeral_user"
Cohesion: 0.27
...
### Community 700 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 703 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 705 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 706 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 707 - "Workspace Isolation Architecture"
Cohesion: 0.17
...
### Community 708 - "Quantization Internals"
Cohesion: 0.17
...
### Community 709 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 710 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 711 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 713 - "check_container_posture.py"
Cohesion: 0.26
...
### Community 714 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 715 - "test_admin_local_brain_router.py"
Cohesion: 0.29
...
### Community 716 - "test_agile_api.py"
Cohesion: 0.17
...
### Community 717 - "test_app_settings.py"
Cohesion: 0.21
...
### Community 720 - "TestAnthropicPayloadStructuredOutput"
Cohesion: 0.29
...
### Community 721 - "test_task_clarification.py"
Cohesion: 0.17
...
### Community 724 - "_extractive_compress"
Cohesion: 0.18
...
### Community 734 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 737 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 738 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 739 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 740 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 741 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 742 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 743 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 744 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 746 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 747 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 748 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 749 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 750 - "What to clean up"
Cohesion: 0.18
...
### Community 751 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 758 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 759 - "test_event_log.py"
Cohesion: 0.45
...
### Community 760 - "test_google_provider_models.py"
Cohesion: 0.18
...
### Community 765 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 766 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 767 - "admin_local_brain_router.py"
Cohesion: 0.22
...
### Community 768 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 769 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 770 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 771 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 772 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 773 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 774 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 776 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 777 - "LLM Router — configuration guide"
Cohesion: 0.20
...
### Community 778 - "LLM Router — provider guide"
Cohesion: 0.20
...
### Community 779 - "CI Troubleshooting Runbook"
Cohesion: 0.20
...
### Community 785 - "local_brain_provider_config"
Cohesion: 0.29
...
### Community 786 - "build_tech_db.py"
Cohesion: 0.40
...
### Community 790 - "_redact_for_notification"
Cohesion: 0.24
...
### Community 797 - "test_telegram_task_callback.py"
Cohesion: 0.31
Nodes (9): _parked_task(), asyncio, Task, Telegram inline-button callbacks for the task pre-execution gate. Regression:…, store(), test_approve_button_approves_and_requeues(), test_callback_parser_routes_task_prefix(), test_reject_button_moves_task_to_wont_do() (+1 more)
...
### Community 824 - "ENGINEERING_STANDARDS.md — Patterns & Reference"
Cohesion: 0.22
...
### Community 828 - "_status_snapshot"
Cohesion: 0.31
...
### Community 829 - "_start_ceo_agency"
Cohesion: 0.31
...
### Community 840 - "agent/output_filter.py"
Cohesion: 0.32
...
### Community 844 - "quality_checker.py"
Cohesion: 0.32
...
### Community 860 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.25
...
### Community 861 - "Issue #362: Nvidia repo setup"
Cohesion: 0.25
...
### Community 862 - "Issue #364: quick-note:https://www.marktechpost.com/2026/06/01/meet-memory-os-a-6-layer-open-source-memory-stack-built-on-top-of-hermes-agent/"
Cohesion: 0.25
...
### Community 863 - "Issue #378: quick-note:https://www.marktechpost.com/2026/06/02/tinyfish-launches-bigset-an-open-source-multi-agent-system-that-builds-structured-live-datasets-from-plain-english-descriptions/"
Cohesion: 0.25
...
### Community 864 - "Issue #379: quick-note:https://searchengineland.com/schema-markup-optimize-agentic-web-479080"
Cohesion: 0.25
...
### Community 865 - "Issue #380: quick-note:https://cursor.com/blog/cloud-agent-lessons"
Cohesion: 0.25
...
### Community 866 - "Issue #381: quick-note:https://www.xda-developers.com/claude-code-with-opus-48-is-expensive-but-i-made-it-efficient-with-my-local-ai-workflow/"
Cohesion: 0.25
...
### Community 867 - "Issue #382: quick-note:https://claude.com/blog/how-coderabbit-used-claude-to-build-an-agent-orchestration-system"
Cohesion: 0.25
...
### Community 868 - "Issue #383: quick-note:https://www.marktechpost.com/2026/05/29/hexo-labs-open-sources-sia-a-self-improving-agent-that-updates-both-the-harness-and-the-model-weights/"
Cohesion: 0.25
...
### Community 869 - "Issue #416: feat: Self-hosted Codebuff (freebuff) on free NVIDIA models + Telegram bot phone control"
Cohesion: 0.25
...
### Community 870 - "Issue #485: [Trend Digest] Week of 2026-06-08"
Cohesion: 0.25
...
### Community 871 - "Issue #488: quick-note:https://github.com/cookiy-ai/user-research-skill"
Cohesion: 0.25
...
### Community 872 - "Issue #491: Implement whatever is necessary from https://github.com/BehiSecc/awesome-claude-skills"
Cohesion: 0.25
...
### Community 873 - "Issue #493: Use the https://github.com/mvanhorn/last30days-skill skill to get the trend updated"
Cohesion: 0.25
...
### Community 874 - "Issue #495: Read https://www.anthropic.com/news/claude-fable-5-mythos-5 and understand if mythos or fable can be added to the repo"
Cohesion: 0.25
...
### Community 875 - "Issue #504: EPIC: Autonomy hardening — live-verified defects 2026-06-10"
Cohesion: 0.25
...
### Community 876 - "Issue #581: Sprint tracker: pending work after brand rename + mobile-first pass"
Cohesion: 0.25
...
### Community 878 - "Issue #657: quick-note:https://github.com/earendil-works/pi"
Cohesion: 0.25
...
### Community 879 - "Issue #659: quick-note:https://github.com/nex-agi/Nex-N2"
Cohesion: 0.25
...
### Community 880 - "Issue #660: quick-note:https://github.com/getsentry/sentry-for-ai"
Cohesion: 0.25
...
### Community 881 - "Issue #661: quick-note:https://github.com/XiaomiMiMo/MiMo-Code"
Cohesion: 0.25
...
### Community 882 - "Issue #664: quick-note:https://github.com/Grominet95/jarvis-OS"
Cohesion: 0.25
...
### Community 883 - "Issue #666: quick-note:https://github.com/porokka/jarvis-os"
Cohesion: 0.25
...
### Community 884 - "Issue #670: quick-note:https://github.com/perplexityai/bumblebee"
Cohesion: 0.25
...
### Community 885 - "Issue #672: quick-note:https://github.com/Chachamaru127/claude-code-harness"
Cohesion: 0.25
...
### Community 886 - "Issue #676: quick-note:https://github.com/WeiboAI/VibeThinker"
Cohesion: 0.25
...
### Community 887 - "Issue #820: quick-note:https://github.com/cobusgreyling/loop-engineering"
Cohesion: 0.25
...
### Community 888 - "Positional Encoding Internals"
Cohesion: 0.25
...
### Community 890 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 891 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 892 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 893 - "Prime Agent Runtime"
Cohesion: 0.25
...
### Community 898 - "run_patched_colibri.py"
Cohesion: 0.36
...
### Community 902 - "test_compose_and_coordinate_api.py"
Cohesion: 0.36
...
### Community 903 - "test_generate_context_standing_instructions.py"
Cohesion: 0.32
...
### Community 904 - "test_local_brain_router_smoke.py"
Cohesion: 0.25
...
### Community 908 - "test_provider_models_db_outage.py"
Cohesion: 0.25
...
### Community 909 - "test_runtimes_health_endpoint.py"
Cohesion: 0.25
...
### Community 911 - "test_serve_spa_prefixes.py"
Cohesion: 0.36
...
### Community 912 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.25
...
### Community 914 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 939 - "Workspace Issues"
Cohesion: 0.29
...
### Community 940 - "Model and Response Issues"
Cohesion: 0.29
...
### Community 948 - "e2e_smoke.py"
Cohesion: 0.57
Nodes (5): _chat(), check(), _health(), _models(), _req()

### Community 949 - "task_runner.py"
Cohesion: 0.33
...
### Community 954 - "test_doctor_coding_brain.py"
Cohesion: 0.38
...
### Community 956 - "TestReasonsAreActionable"
Cohesion: 0.29
...
### Community 957 - "TestProvidersScreen"
Cohesion: 0.43
...
### Community 961 - "openclaw_mobile_ui"
Cohesion: 0.33
...
### Community 976 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 977 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 978 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 979 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 980 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 981 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 985 - "apply_phase1_changes.py"
Cohesion: 0.33
...
### Community 992 - "setup-claude-code.sh script"
Cohesion: 0.60
Nodes (5): log_error(), log_info(), log_success(), print_header(), setup-claude-code.sh script

### Community 996 - "TestAgentRunnerExecution"
Cohesion: 0.33
...
### Community 997 - "TestDirectChatAgentExecution"
Cohesion: 0.33
...
### Community 998 - "TestCEOAgencySystem"
Cohesion: 0.33
...
### Community 1017 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 1018 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 1021 - "Agent API Issues"
Cohesion: 0.40
...
### Community 1022 - "Network and Tunnel Issues"
Cohesion: 0.40
...
### Community 1023 - "knowledgeGraphTab.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 1024 - "loginFlowNoTimeout.test.js"
Cohesion: 0.40
Nodes (4): apiSource, { describe, test, expect }, fs, path

### Community 1025 - "test_company_stale_id_recovery.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 1026 - "worker_no_cache.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, workerSource

### Community 1027 - "scripts/agile_ceremonies.py"
Cohesion: 0.60
Nodes (4): _load(), main(), ModuleType, _write_summary()

### Community 1028 - "governance/__init__.py"
Cohesion: 0.40
Nodes (3): __getattr__(), Any, packages/governance — agent identity, policy, approvals, audit, sandboxes. The…

### Community 1029 - "Prompt Library Changelog"
Cohesion: 0.40
Nodes (4): Added, Format, Prompt Library Changelog, [Unreleased]

### Community 1030 - "_add_colibri_shim_changelog_entry.py"
Cohesion: 0.50
...
### Community 1031 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1032 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1033 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 1034 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 1035 - "setup_colibri.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1036 - "setup_colibri.sh script"
Cohesion: 0.70
Nodes (4): setup_colibri.sh script, fail(), ok(), warn()

### Community 1037 - "status_colibri_server.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1039 - "TestMobileNavigation"
Cohesion: 0.40
Nodes (3): Mobile-specific: hamburger menu, responsive layout., Verify key pages load in mobile viewport., TestMobileNavigation

### Community 1040 - "test_v5_screens_smoke.py"
Cohesion: 0.50
...
### Community 1041 - "test_agent_runtime_wrapper.py"
Cohesion: 0.70
...
### Community 1042 - "TestFailoverRegistryBaseUrls"
Cohesion: 0.40
...
### Community 1043 - "TestTelegramNotifications"
Cohesion: 0.40
...
### Community 1044 - "TestModelRoleSeparation"
Cohesion: 0.40
...
### Community 1045 - "worker/index.js"
Cohesion: 0.60
Nodes (4): fetch(), needsProxy(), PROXY_PREFIXES, scheduled()

### Community 1047 - "_clean_phases"
Cohesion: 0.50
...
### Community 1060 - "Claude Code Specific Issues"
Cohesion: 0.50
...
### Community 1063 - "render"
Cohesion: 0.50
Nodes (3): RENDER_API_KEY, docker, render

### Community 1064 - "scripts"
Cohesion: 0.50
Nodes (4): scripts, build, start, test

### Community 1066 - "_clean_director"
Cohesion: 0.50
...
### Community 1081 - "test_no_exception_detail_leaks.py"
Cohesion: 0.50
...
### Community 1082 - "test_skills_route_order.py"
Cohesion: 0.67
...
### Community 1110 - "test_the_reserve_is_bounded_when_read_from_the_environment"
Cohesion: 0.67
...
- **Why does `_fixture()` connect `_fixture` to `company_api.py`, `test_llm_router_queue_cache.py`, `cost_tracker.py`, `WorkflowRun`, `test_llm_router_strategies.py`, `llm/router.py`, `E2BSandboxSession`, `parse_event_stream`, `ImprovementLoop`, `test_model_router.py`, `SelfHealingAgent`, `test_monitor_lib.py`, `test_openclaw_endpoints.py`, `_clean_phases`, `ProviderConfig`, `TaskStore`, `AgentSwarm`, `Task`, `test_task_service_failed_comment.py`, `services/background.py`, `BrainWatchdog`, `test_failover_client_shared.py`, `test_agent_tool_governance.py`, `PolicyEngine`, `test_llm_router_resilience.py`, `Agency`, `test_unit8_model_catalog.py`, `PrimeAgentAdapter`, `MCPClient`, `tasks/models.py`, `SQLiteStore`, `_clean_director`, `test_telegram_auto_approve.py`, `AgentJobManager`, `test_ceo_router.py`, `test_autonomy_status.py`, `test_brain_failover_413.py`, `test_knowledge_sync.py`, `sam`, `TaskExecutionCoordinator`, `test_llm_router_tpm.py`, `test_local_brain_state.py`, `ChatHistoryStore`, `test_phase5_doctor.py`, `test_provider_state_durability.py`, `test_refresh_agent_built_proof.py`, `test_telegram_diag_endpoint.py`, `test_brain_availability_doctor.py`, `TokenBudget`, `ResearchTask`, `_resolve_brain_provider`, `SeoAuditEngine`, `TestClient`, `test_startup_warmup.py`, `AgentPlan`, `test_procedural_memory.py`, `e2e/test_browser.py`, `brain_failover.py`, `KeyPool`, `run_task`, `config.py`, `test_context_rulebook.py`, `ArtifactStore`, `.on_task_complete`, `TestHarnessAdapter`, `KeyStore`, `test_openclaw_gateway.py`, `UserRole`, `test_self_heal_v2.py`, `test_autonomous_agency_e2e.py`, `emit_chat_observation`, `BudgetTracker`, `analyze_page`, `claim`, `persist_plan_spec`, `FeatureMaturity`, `TestEstimateTokensForMessages`, `test_new_features_e2e.py`, `test_control_plane_api.py`, `_Budget`, `test_daily_2026_07_27.py`, `TestAgentRunnerSafety`, `test_doctor_service_token_check.py`, `TestRuntimeControl`, `test_task_brain_preflight.py`, `OllamaCircuitBreaker`, `test_features_api.py`, `test_video_transcript.py`, `clear_cooldowns`, `test_platform_controls.py`, `NotificationDispatcher`, `test_dashboard_cache.py`, `SchedulerStore`, `test_agile_api.py`, `test_app_settings.py`, `TrendWatcher`, `TestAuthAndTaskOwnership`, `test_portfolio_intake.py`, `test_task_clarification.py`, `test_trend_watcher.py`, `HarnessRegistry`, `AgentDefinition`, `allow_paid`, `TestClient`, `ContextPruner`, `test_brain_failover.py`, `test_issue_intake.py`, `test_persistent_memory.py`, `SecurityScanner`, `WorkflowBuildRequest`, `test_llm_router_e2e.py`, `OutputFilter`, `test_telegram_mutating_commands.py`, `capture_screens.py`, `test_rate_limiter.py`, `_resolve_push_token`, `test_iteration_6_features.py`, `test_sam_voice.py`, `TestMongoGate`, `test_telegram_task_callback.py`, `OrchestratorQueue`, `TestNormalizeResponseFormat`, `test_mcp_governance.py`, `test_purge_backlog.py`, `_resolve_user_github_token`, `SeoFixRequest`, `_start_ceo_agency`, `TestSwarmRoleRouting`, `test_crispy_burn_in.py`, `test_provider_enable_disable.py`, `test_skill_registry_boot_refresh.py`, `isolated_telegram_config`, `test_scheduler_hydration_bounded.py`, `model_discovery.py`, `.record`, `api_keys_for`, `test_claude_code_adapter.py`, `test_service_token.py`, `test_harness_spec.py`, `test_regression.py`, `test_agency_fix.py`, `test_ping.py`, `test_webui_provider_priority.py`, `test_runtimes_health_endpoint.py`, `test_task_store_fails_loud_in_production.py`, `UsageEvent`, `reap_expired_companies`, `test_v4_api.py`, `test_provider_410_per_model.py`, `test_agent_free_brain.py`, `_FakeSandbox`, `client`, `test_doctor_coding_brain.py`, `test_kimi_bridge_server.py`, `test_voice_pipeline.py`, `reset_kv_state`, `test_brain_patch_service_token.py`, `OrchestratorCheckpointStore`, `test_company_api.py`, `test_task_pre_execution_gate.py`, `test_telegram_service_webhook.py`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `proxy.py`, `ReactScratchpad`, `ExecutionRequest`, `test_governance_api.py`, `WorkflowRun`, `TaskSpec`, `test_autonomous_agency_e2e.py`, `TestAgentLoopMCPIntegration`, `ContextManager`, `E2BSandboxSession`, `test_ceo_dispatcher.py`, `test_backend_server_features.py`, `test_daily_automation_2026_07_11.py`, `test_ceo_supervision.py`, `LocalWorkspace`, `test_failover_client_shared.py`, `test_agent_tool_governance.py`, `MultiAgentSwarm`, `StuckDetector`, `UserMemoryStore`, `TestAgentRunnerSafety`, `Agency`, `test_e2b_adapter.py`, `MCPClient`, `test_agent_free_brain.py`, `AgentJobManager`, `test_brain_failover_413.py`, `WorkspaceTools`, `TokenBudget`, `AgentPlan`, `InternalAgentAdapter`, `.execute`, `direct_chat.py`, `TestAgentRunnerExecution`, `ContextPruner`, `GitHubTools`, `diagnostics.py`, `AgentSessionStore`, `test_empirical_verify.py`, `AdaptiveHalter`, `FreeBuffAgent`, `loop.py`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `get_skill_bindings()` connect `get_skill_bindings` to `company_api.py`, `CompanyGraphService`, `SpecEntry`, `ExecutionRequest`, `AgentRunner`, `WorkflowRun`, `skill_bindings.py`, `FeatureMaturity`, `SkillBindings`, `TestSeoApiSurface`, `loop.py`, `HarnessEnrichment`?**
...
- **Should `backend/server.py` be split into smaller, more focused modules?**
  _Cohesion score 0.017180891964628988 - nodes in this community are weakly interconnected._