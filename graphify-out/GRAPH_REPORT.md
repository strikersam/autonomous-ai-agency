...
## Corpus Check
- 1425 files · ~2,043,633 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 28366 nodes · 57941 edges · 1180 communities (1060 shown, 120 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 6298 edges (avg confidence: 0.54)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fda0826a`
...
## Communities (1180 total, 120 thin omitted)

### Community 0 - "backend/server.py"
Cohesion: 0.02
Nodes (265): backend/ceo_router.py — observability and manual control for the CEO. Surfaces…, Reject non-admin callers for routes that spend provider budget. Delegates to…, _require_admin(), _is_admin(), Check if a user has admin role. Works for both social_auth users (role in…, admin_seed(), _agent_timeout_fallback_response(), auth_me() (+257 more)

### Community 1 - "ai/router.py"
Cohesion: 0.02
Nodes (149): _acquire_provider_probe(), clear_cooldowns(), _dead_model_key(), _exponential_backoff_cooldown(), get_dead_models(), _get_director(), is_commercial_provider(), _is_model_dead() (+141 more)

### Community 2 - "company_api.py"
Cohesion: 0.03
Nodes (188): AccountLifecycleResponse, _DoctorCheck, _DoctorReport, get_onboarding_progress(), get_public_doctor_report(), OnboardingAnswersRequest, OnboardingProgressResponse, OnboardingQuestionsRequest (+180 more)

### Community 3 - "proxy.py"
Cohesion: 0.02
Nodes (184): Any, Return recent commits with agent attribution trailers parsed out., free_nvidia_models(), Return the curated list of free NVIDIA NIM models FreeBuff may use., True when *model* is in the curated free NVIDIA NIM set., get_sam(), agent/sam.py — SAM Voice Agent (System Autonomy Manager) SAM is the voice-…, middleware (+176 more)

### Community 4 - "test_ceo_dispatcher.py"
Cohesion: 0.03
Nodes (110): CEODispatcher, CEOResult, _complexity_rank(), _decompose_into_subtasks(), _merge_changed_files(), _offload(), Any, Semaphore (+102 more)

### Community 5 - "HermesAdapter"
Cohesion: 0.05
...
Cohesion: 0.06
Nodes (45): BrainFailoverManager, Any, Permit one probe call without claiming the provider succeeded. This is the…, Seconds until the soonest cooling provider is probeable again. ``None`` when no…, Record a provider failure — opens the circuit breaker on threshold., Maximum number of provider attempts before giving up., Return a full health snapshot for observability., Manages multi-provider brain failover with circuit breakers. Thread-safe.… (+37 more)

### Community 7 - "Specialist"
Cohesion: 0.03
...
Cohesion: 0.04
Nodes (56): AiderAdapter, Any, Adapter for Aider — TIER 3 specialized git-aware code editor., GooseAdapter, Any, Adapter for Goose — TIER 2 general-purpose local runtime., JCodeAdapter, Adapter for jcode — TIER 2 high-performance Rust coding agent. (+48 more)

### Community 11 - "TestRuntimeControl"
Cohesion: 0.04
...
Cohesion: 0.03
Nodes (114): agent/job_manager.py — Async agent job lifecycle manager. Manages agent jobs…, kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, TaskResult, TaskSpec, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Run aider non-interactively via `--message` flag., runtimes/adapters/claude_code.py — Claude Code CLI adapter (FIRST CLASS).… (+106 more)

### Community 14 - "test_colibri_provider.py"
Cohesion: 0.12
...
Cohesion: 0.02
Nodes (138): ephemeral_ttl_hours(), Async read of the ephemeral TTL (hours) straight from the DB., account_lifecycle(), auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint(), generate_onboarding_questions() (+130 more)
...
### Community 23 - "TaskDispatcher"
Cohesion: 0.04
Nodes (41): AgencyCycleResult, AgentDirective, Any, Capture the FastAPI main event loop so the CEO thread can dispatch run_cycle()…, Generate directives for each onboarded company. The CEO examines each company's…, Call the configured provider stack to perform CEO strategic assessment., Re-queue BLOCKED tasks that have cooled down and are ready for retry., Polls for queued task work and executes it through the coordinator. Crash… (+33 more)

### Community 24 - "test_e2b_data_flow.py"
Cohesion: 0.07
...
### Community 26 - "._get_connection"
Cohesion: 0.04
Nodes (23): Delete a company and all its associated data., Delete a company and all associated data from SQLite., Count total companies in SQLite., Create a new website in SQLite. The full model is stored in ``data`` so scan…, Update a website in SQLite. When ``company_id`` is omitted the existing company…, Count total companies in the store., Delete a website from SQLite., Create a new repository in SQLite. (+15 more)
...
Cohesion: 0.03
Nodes (83): all_provider_ids(), _provider_ids_from_literal(), Resolve the model id for a component's role on a provider. Parameters…, Return every provider id recognised by the brain config system. Iterates the…, Return the provider ids allowed by the ``BrainProvider`` Literal. Reads the…, resolve_component_model(), CatalogActiveBrain, CatalogMirror (+75 more)
...
### Community 33 - "Task"
Cohesion: 0.05
Nodes (59): Full task/issue document., Task, PUBLIC_URL-anchored dashboard deep link for the task detail. Returns empty…, Best-effort Telegram heads-up that a task is parked awaiting approval. Inline…, _coordinator(), asyncio, BaseException, Brain-availability preflight tests (graceful degradation). When NO LLM brain is… (+51 more)
...
Cohesion: 0.04
Nodes (66): BrainConfig, BrainConfigStore, default_brain_config(), provider_api_keys(), provider_base_url(), _provider_env_value(), provider_key_rotation_enabled(), BaseModel (+58 more)
...
Cohesion: 0.04
Nodes (47): _provider_keys(), Every configured key for *provider*, primary first. Returns an empty list when…, api_keys_for(), _digest(), KeyPool, _KeyState, _PoolState, Per-provider API key rotation — the one lever that adds capacity. Every other… (+39 more)
...
### Community 40 - "AutonomyTracker"
Cohesion: 0.02
Nodes (96): Browser admin UI for login, service control, key management, and diagnostics., Update or append a KEY=value line in the .env file., register_admin_gui(), _save_env_var(), AutonomyCounter, AutonomySnapshot, AutonomyTracker, get_tracker() (+88 more)
...
Cohesion: 0.01
Nodes (236): AgentRole, str, AgentPhaseError, AgentRunner, _check_extra_kwargs(), _enforce_signature(), _note_phase_end(), _note_phase_start() (+228 more)
...
Cohesion: 0.05
Nodes (53): build_ceo_router(), Any, APIRouter, get_ceo_dispatcher(), Return the shared CEODispatcher singleton., get_ceo_ledger(), Return the shared :class:`CEOLedger`, constructing it on first use., CEOSupervisor (+45 more)
...
### Community 55 - "test_task_dispatcher.py"
Cohesion: 0.31
...
Cohesion: 0.06
Nodes (69): Any, Translate technical preflight issues into a conversational assistant reply., translate_error_to_conversational(), ResumeRequest, AcceptedJob, AgentJobEnvelope, CompletedJob, DirectChatState (+61 more)

### Community 57 - "ControlPlanePage.js"
Cohesion: 0.06
Nodes (43): getActivity(), getCostAttribution(), getDecisionLog(), getDueSoonTasks(), getSavings(), getStats(), getUsage(), healthCheck() (+35 more)
...
Cohesion: 0.05
Nodes (46): _auto_disable(), _Budget, _describe_registry(), _disabled_ids(), _is_billing_refusal(), _is_ollama(), _key_pool(), _log_exhaustion() (+38 more)

### Community 65 - "test_llm_router_disabled.py"
Cohesion: 0.09
...
### Community 69 - "test_workflow_models.py"
Cohesion: 0.13
...
### Community 79 - "portfolio_intelligence.py"
Cohesion: 0.09
...
Cohesion: 0.06
Nodes (31): _infer_parameters_from_func(), Any, Path, Register a tool definition., Decorator to register a function as an agent tool. Usage::…, Remove a tool from the registry. Returns True if removed., Look up a tool by name., Return all registered tools. (+23 more)
...
Cohesion: 0.05
Nodes (37): _brain_provider_status(), Return per-provider metadata for the GET endpoint. Iterates every provider in…, Return the discovered model list for *provider_id*, or ``[]`` if unknown., _served_models(), provider_key_present(), True when the env var for *provider*'s key is set (or it's Ollama)., BrainWatchdog, _is_provider_actually_available() (+29 more)
...
### Community 128 - "TaskWorkflowService"
Cohesion: 0.04
Nodes (64): Set the global agent store instance (e.g., with MongoDB on startup)., set_agent_store(), _is_brain_connection_error(), Any, BaseException, Task, TaskResult, TaskSpec (+56 more)
...
Cohesion: 0.04
Nodes (83): BrainResolution, get_brain_config(), get_brain_config_store(), invalidate_brain_config_cache(), Return the process-wide ``BrainConfigStore`` singleton., Convenience wrapper used by the agent loop + brain resolver., Convenience wrapper used by the admin API endpoints., Clear the singleton's cache (used by tests + brain_policy invalidation). (+75 more)
...
Cohesion: 0.05
Nodes (39): createProvider(), deleteModel(), deleteProvider(), getBrainConfig(), getBrainProviders(), getLocalBrainState(), getProviderPolicy(), listModels() (+31 more)
...
### Community 159 - "test_llm_router_strategies.py"
Cohesion: 0.15
...
Cohesion: 0.08
Nodes (10): FeatureMatrix, Central support matrix — single source of truth. Loads the canonical feature…, Render the matrix as a Markdown table for docs., TestConfigOverrides, TestRegistryLoads, TestAdminVisibility, TestClassification, TestDisabledFeatures (+2 more)
...
Cohesion: 0.06
Nodes (75): _harvest_changed_files(), Extract the files a runtime touched. Returns ``(files, reported)``. Adapters…, Record the goal and its sub-tasks in the ledger before any work runs. Writing…, A single sub-task delegated to a specialist., SpecialistTask, Attempt, One delegation of one subtask to one tier., A subtask's full history: what it is, and every attempt at it. (+67 more)
...
### Community 184 - "test_unit6_resolve_component_model.py"
Cohesion: 0.05
...
Cohesion: 0.03
Nodes (77): main(), Returns (url, ok, summary)., _scan_one(), _is_blocked_host(), _is_safe_url(), _looks_like_bot_challenge(), BeautifulSoup, True if the HTML is an anti-bot/CAPTCHA interstitial rather than content. Used… (+69 more)
...
### Community 204 - "timedelta"
Cohesion: 0.18
Nodes (20): PR throughput per cohort over the last `days` days., aggregate_last_24h(), build_daily_digest(), compute_cutoff(), format_digest_markdown(), _md_escape(), _now_utc(), Any (+12 more)
...
Cohesion: 0.04
Nodes (52): get_agency(), set_agency(), _autonomy_bg_cycle(), autonomy_tick(), legacy_scheduler_create(), legacy_scheduler_delete(), Background CEO cycle + task dispatch. Runs fire-and-forget., Execute ONE pending task synchronously. Called by the cron workflow every 2… (+44 more)
...
### Community 240 - "test_colibri_brain_shim.py"
Cohesion: 0.08
...
### Community 249 - "get_feature_matrix"
Cohesion: 0.12
...
### Community 259 - "brain_failover.py"
Cohesion: 0.12
...
### Community 271 - "SeoCheckDefinition"
Cohesion: 0.11
...
### Community 276 - "classify_direct_chat_intent"
Cohesion: 0.13
...
### Community 282 - "reap_expired_companies"
Cohesion: 0.16
...
### Community 290 - "TestRenderMCPSidecarService"
Cohesion: 0.16
...
### Community 305 - "TestOrchestratorEndpointScoping"
Cohesion: 0.17
...
### Community 338 - "analyze_qualitative"
Cohesion: 0.12
...
### Community 378 - "ExecutionRequest"
Cohesion: 0.02
Nodes (149): Called by APScheduler when a cron fires. Dispatches to the orchestrator., _scheduler_on_fire(), get_orchestrator_checkpoint_store(), _NoopDB, OrchestratorCheckpointStore, services/orchestrator_checkpoint.py — Durable step-level checkpointing Issue…, Fallback in-memory store when no DB is available., Persist orchestrator runs so they survive restarts. (+141 more)
...
### Community 383 - "DashboardLayout.js"
Cohesion: 0.07
Nodes (35): createWikiPage(), deleteSource(), deleteWikiPage(), getCompanyGraph(), getSource(), getWikiPage(), ingestSource(), lintWiki() (+27 more)
...
### Community 387 - "CircuitBreakerOpenError"
Cohesion: 0.13
...
### Community 390 - "ProviderConsole.jsx"
Cohesion: 0.11
...
### Community 402 - "parse_event_stream"
Cohesion: 0.15
...
### Community 415 - "TestRenderRouter"
Cohesion: 0.14
...
### Community 425 - "test_agent_readiness_audit.py"
Cohesion: 0.18
...
### Community 430 - "_FakePersistence"
Cohesion: 0.13
...
Cohesion: 0.05
Nodes (60): detect_secrets(), main(), Recover CHANGELOG.md from a Git merge conflict in its [Unreleased] block. Pre-…, Replace the process-wide store. Tests only., reset_approval_store(), AuditLog, Bounded in-memory ring buffer plus a structured log stream. The ring buffer…, Store and emit *event*. Never raises. (+52 more)
...
### Community 452 - "test_telegram_service_webhook.py"
Cohesion: 0.13
...
### Community 458 - "test_onboarding_provisioning.py"
Cohesion: 0.18
...
### Community 478 - "test_shared_state.py"
Cohesion: 0.17
...
### Community 495 - "self_heal_brain_and_unblock_tasks"
Cohesion: 0.09
...
### Community 509 - "._scan_github_repo"
Cohesion: 0.12
...
### Community 536 - "AgentSessionStore"
Cohesion: 0.02
Nodes (124): PreflightIssue, PreflightReport, BaseModel, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, Agent subsystem — planner / executor / verifier loop., AgentJob, make_isolated_workspace(), _now() (+116 more)
...
### Community 548 - "test_brain_failover_413.py"
Cohesion: 0.13
...
### Community 577 - "ApprovalCheckpoint"
Cohesion: 0.14
...
### Community 588 - "test_p0_roadmap_b3_b4_b5.py"
Cohesion: 0.22
Nodes (8): _deep_merge(), Deep merge two dicts. Override values take precedence., CircuitState, get_nim_pool(), Enum, Return the module-level NIMConnectionPool singleton., asyncio, TestDeepMerge
...
### Community 626 - "14. Standing Instructions — Universal Agent Discipline"
Cohesion: 0.17
...
### Community 668 - "test_docs_consistency.py"
Cohesion: 0.17
...
### Community 704 - "test_providers_live_e2e.py"
Cohesion: 0.27
...
### Community 738 - "test_google_provider_models.py"
Cohesion: 0.18
...
### Community 768 - "Coding Standards"
Cohesion: 0.22
...
### Community 773 - "_status_snapshot"
Cohesion: 0.31
...
### Community 776 - "FakeScheduleCollection"
Cohesion: 0.25
...
### Community 790 - "get_tool_registry"
Cohesion: 0.29
...
Cohesion: 0.08
Nodes (21): Beta, Config Overrides, Disabled (demoted per issue #467 Section I), Enforcement, Experimental, Feature Maturity / Support Matrix, Maturity Tiers, Stable Core (+13 more)
...
Cohesion: 0.04
Nodes (71): Enum, packages/governance/approvals.py — human-in-the-loop for high-risk actions. The…, AuditEvent, Any, packages/governance/audit.py — the evidence trail for every governed action.…, Redact secret-shaped substrings, then truncate., One governed action, fully described. Field order follows the…, One-line JSON, suitable for a SIEM shipper tailing the log. (+63 more)
...
### Community 862 - "_load_local_metrics_since"
Cohesion: 0.43
...
### Community 865 - "TestSupportMatrixDocsSync"
Cohesion: 0.29
...
### Community 873 - "test_doctor_coding_brain.py"
Cohesion: 0.38
...
### Community 908 - "TestActiveStrategy"
Cohesion: 0.29
...
### Community 953 - "PR Review Checklist"
Cohesion: 0.33
...
### Community 970 - "resolve_hermes_base_url"
Cohesion: 0.47
...
### Community 995 - "PhaseSequenceError"
Cohesion: 0.33
...
### Community 1023 - "Monitoring Standards"
Cohesion: 0.50
...
### Community 1027 - "test_activity_logs.py"
Cohesion: 0.67
...
### Community 1175 - "test_schedule_backlog_drain.py"
Cohesion: 0.15
...
## Knowledge Gaps
- **3506 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3501 more)
...
- **Why does `_fixture()` connect `_fixture` to `ai/router.py`, `test_brain_failover.py`, `test_scheduler_hydration_bounded.py`, `llm/router.py`, `TestRuntimeControl`, `LLMRouter`, `test_llm_router_tpm.py`, `SeoAuditRequest`, `OrchestratorQueue`, `AgentSessionStore`, `test_e2b_data_flow.py`, `test_telegram_approval_gate.py`, `config.py`, `test_unit8_model_catalog.py`, `test_llm_router_resilience.py`, `Task`, `test_openclaw_gateway.py`, `brain_config.py`, `test_brain_failover_413.py`, `_enable_filter`, `KeyPool`, `webui/router.py`, `AutonomyTracker`, `test_portfolio_intake.py`, `failover_chat_completion`, `SecretRecord`, `test_sam_livekit.py`, `test_model_router.py`, `test_new_features_e2e.py`, `MCPUnavailableError`, `test_knowledge_sync.py`, `test_ceo_router.py`, `test_operational_incidents.py`, `SelfHealingAgent`, `ToolAnnotations`, `direct_chat.py`, `test_ai_insights.py`, `ResearchTask`, `failover_client.py`, `test_llm_router_disabled.py`, `TestClient`, `test_task_clarification.py`, `GovernanceGate`, `test_sam_voice.py`, `test_self_heal_v2.py`, `SeoFixer`, `ImprovementLoop`, `TaskIn`, `test_context_rulebook.py`, `test_agile_api.py`, `test_app_settings.py`, `ArtifactStore`, `services/background.py`, `analyze_page`, `KeyStore`, `TestHarnessAdapter`, `BrainWatchdog`, `ChatHistoryStore`, `TaskWorkflowService`, `SQLiteStore`, `ModelRouter`, `resolve_active_brain`, `_start_ceo_agency`, `PrimeAgentAdapter`, `persist_plan_spec`, `test_trend_watcher.py`, `_resolve_brain_provider`, `TaskStore`, `test_llm_router_queue_cache.py`, `OllamaCircuitBreaker`, `TrendWatcher`, `test_features_api.py`, `test_video_transcript.py`, `resolve_identity`, `ProceduralMemoryStore`, `test_agent_free_brain.py`, `_resolve_push_token`, `SchedulerStore`, `TestClient`, `ContextPruner`, `AgentSwarm`, `TestEstimateTokensForMessages`, `TestSwarmRoleRouting`, `test_issue_intake.py`, `test_persistent_memory.py`, `provider_max_rpm`, `SecurityScanner`, `test_provider_state_durability.py`, `test_startup_warmup.py`, `get_scheduler`, `test_llm_router_e2e.py`, `GoalRecord`, `WorkflowBuildRequest`, `test_colibri_brain_shim.py`, `chat_handlers.py`, `model_discovery.py`, `client`, `IssueCategory`, `test_purge_backlog.py`, `test_telegram_mutating_commands.py`, `test_ping.py`, `TestMongoGate`, `test_runtimes_health_endpoint.py`, `test_task_store_fails_loud_in_production.py`, `reap_expired_companies`, `test_crispy_burn_in.py`, `test_provider_enable_disable.py`, `test_skill_registry_boot_refresh.py`, `test_rate_limiter.py`, `test_platform_controls.py`, `test_kimi_bridge_server.py`, `isolated_telegram_config`, `test_e2b_task_wiring.py`, `TestOrchestratorEndpointScoping`, `test_telegram_auto_approve.py`, `_resolve_user_github_token`, `test_telegram_approval_e2e.py`, `test_service_token.py`, `test_agency_fix.py`, `ClaudeCodeAdapter`, `test_monitor_lib.py`, `test_v4_api.py`, `test_dashboard_cache.py`, `test_doctor_coding_brain.py`, `cost_tracker.py`, `allow_paid`, `ExecutionRequest`, `TestFeaturesAPI`, `test_voice_pipeline.py`, `facade.py`, `parse_event_stream`, `test_brain_patch_service_token.py`, `test_company_api.py`, `test_agent_tool_governance.py`, `test_telegram_service_webhook.py`, `test_openclaw_endpoints.py`, `test_onboarding_provisioning.py`, `test_task_service_failed_comment.py`, `test_harness_spec.py`, `reset_kv_state`, `test_langfuse_agency_wide.py`, `test_shared_state.py`, `test_autonomy_status.py`, `test_local_brain_state.py`, `TestChatHistoryStore`, `test_phase5_doctor.py`, `test_telegram_diag_endpoint.py`, `e2e/test_browser.py`?**
  _High betweenness centrality (0.099) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `ai/router.py`, `proxy.py`, `test_ceo_dispatcher.py`, `Specialist`, `StuckDetector`, `AgentScheduler`, `test_backend_server_features.py`, `test_empirical_verify.py`, `TaskSpec`, `test_ceo_micromanager.py`, `AgentSessionStore`, `TestWorkspace`, `AdaptiveHalter`, `test_brain_failover_413.py`, `test_ceo_supervision.py`, `AutonomyTracker`, `failover_chat_completion`, `MCPUnavailableError`, `LocalWorkspace`, `direct_chat.py`, `test_agent_free_brain.py`, `FreeBuffAgent`, `MCPClient`, `test_agent_tool_governance.py`, `ContextPruner`, `ContextManager`, `GitHubTools`, `MultiAgentSwarm`, `FailoverResult`, `test_governance_api.py`, `TokenBudget`, `WorkspaceTools`, `ExecutionRequest`, `_build_request`, `ReactScratchpad`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `TaskStore` connect `TaskStore` to `backend/server.py`, `TaskWorkflowService`, `Task`, `test_phase4_runtime_resilience.py`, `test_sqlite_store.py`, `test_portfolio_intake.py`, `test_trend_scoping.py`, `AgentRunner`, `test_task_source_id_race.py`, `test_startup_warmup.py`, `services/background.py`, `test_tasks_awaiting_approval_api.py`, `test_issue_intake.py`, `test_self_heal_v2.py`, `_fixture`, `tasks/api.py`, `_ts_to_float`?**
