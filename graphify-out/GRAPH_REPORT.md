# Graph Report - local-llm-server  (2026-08-08)

## Corpus Check
- 1401 files · ~2,002,168 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 28009 nodes · 56791 edges · 1187 communities (1069 shown, 118 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 6186 edges (avg confidence: 0.54)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f9fa13e3`
...
## Communities (1187 total, 118 thin omitted)

### Community 0 - "AgentSessionStore"
Cohesion: 0.03
Nodes (198): Agency, get_agency(), CEO-coordinated multi-agent agency for continuous codebase management. The CEO…, set_agency(), AgentJobRequest, AgentJobSnapshot, BaseModel, Complete point-in-time view of a job, safe to serialise as API response. (+190 more)

### Community 1 - "FreeBuffAgent"
Cohesion: 0.03
Nodes (200): BackgroundAgent, BackgroundTask, _now(), Any, agent/background.py — Background Agent An always-on worker thread that…, Enqueue *task* for processing. Returns the task (with task_id set)., Convenience: create a task and submit it in one call., Real handler — dispatches through AgentRunner when available. HARDENED (PR… (+192 more)

### Community 2 - "AgentRunner"
Cohesion: 0.02
Nodes (177): get_tool_registry(), Return the module-level ToolRegistry singleton. On first call, registers built-…, get_enrichment(), agent/harness_enrichment.py — Automatic Harness Enrichment for Agent Prompts…, AgentPhaseError, AgentRunner, _check_extra_kwargs(), _enforce_signature() (+169 more)

### Community 3 - "proxy.py"
Cohesion: 0.02
Nodes (195): Browser admin UI for login, service control, key management, and diagnostics., Update or append a KEY=value line in the .env file., register_admin_gui(), _save_env_var(), Any, Return recent commits with agent attribution trailers parsed out., free_nvidia_models(), Return the curated list of free NVIDIA NIM models FreeBuff may use. (+187 more)

### Community 4 - "WebsiteScanner"
Cohesion: 0.02
Nodes (132): DetectedSystem, Evidence, Evidence supporting a system detection., A business system detected on a company's website or in their stack., Get the most confident evidence description., main(), Returns (url, ok, summary)., _scan_one() (+124 more)

### Community 5 - "backend/server.py"
Cohesion: 0.02
Nodes (185): admin_seed(), _agent_timeout_fallback_response(), auth_me(), auto_recommend_skills(), _build_agent_status_snapshot(), _build_agent_stream_event(), _build_direct_chat_schedule_suggestion(), _build_direct_chat_tags() (+177 more)

### Community 6 - "direct_chat.py"
Cohesion: 0.02
Nodes (149): AgentRole, str, PreflightIssue, Any, BaseModel, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, Translate technical preflight issues into a conversational assistant reply., translate_error_to_conversational() (+141 more)

### Community 7 - "test_ceo_dispatcher.py"
Cohesion: 0.04
Nodes (123): BoundContext, ClassifyOutput, emit_deprecation(), ExecutionResult, get_ceo_fallback_stats(), JudgeVerdict, MonitorOutput, _orchestrator_bypass() (+115 more)
...
Cohesion: 0.02
Nodes (80): AutonomyCounter, AutonomySnapshot, AutonomyTracker, get_tracker(), Any, agent/kpi.py — Autonomy KPIs: evidence capture and metrics tracking. Tracks key…, Return a point-in-time snapshot of all KPIs., Reset all counters (test helper). (+72 more)

### Community 10 - "test_llm_router_queue_cache.py"
Cohesion: 0.02
Nodes (109): Test hook — clear all usage accounting., reset(), CacheManager, cosine_similarity(), _Entry, get_cache(), LRUCache, payload_key() (+101 more)

### Community 11 - "WorkflowOrchestrator"
Cohesion: 0.02
Nodes (84): check_kwargs(), Any, agent/contract_enforcement.py — Runtime signature locking (J) Provides…, # NOTE: limit has a default so it is accepted; owner_id is keyword-only., Raise TypeError on unknown kwarg (runtime extra='forbid'). Args: kwargs: The…, # NOTE: limit is NOT locked — it is a legitimate optional param that does not, _NoopStore, Any (+76 more)

### Community 12 - "company_api.py"
Cohesion: 0.03
Nodes (126): ephemeral_ttl_hours(), Async read of the ephemeral TTL (hours) straight from the DB., account_lifecycle(), auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint(), generate_onboarding_questions() (+118 more)

### Community 13 - "test_operational_incidents.py"
Cohesion: 0.02
Nodes (123): _diagnose_and_file(), _file_incident(), _format_incident(), gather_render_evidence(), get_operational_incident_tracker(), _iso_from_monotonic(), normalise(), note_phase_end() (+115 more)

### Community 14 - "llm/router.py"
Cohesion: 0.03
Nodes (92): _load(), main(), int, failover_chat_completion_via_router(), openai_body_from_response(), Any, packages/llm/compat.py — backwards-compatible bridges to the legacy call paths.…, Router-backed implementation of ``packages.ai.failover_client``'s entry point.… (+84 more)

### Community 15 - "test_runtimes.py"
Cohesion: 0.04
Nodes (49): AiderAdapter, Any, Adapter for Aider — TIER 3 specialized git-aware code editor., GooseAdapter, Any, Adapter for Goose — TIER 2 general-purpose local runtime., HermesAdapter, Adapter for Hermes Agent — FIRST CLASS autonomous runtime. (+41 more)

### Community 16 - "api.js"
Cohesion: 0.02
Nodes (47): approveGovernanceRequest(), approveTaskCheckpoint(), approveTaskExecution(), autoRecommendCompanySkills(), createMcpServer(), createSprint(), delegateSeoFindings(), deleteCompany() (+39 more)

### Community 17 - "webui/router.py"
Cohesion: 0.04
Nodes (94): test_git_ref_rejects_empty(), test_git_ref_rejects_flag_injection(), test_git_ref_rejects_shell_metacharacters(), test_git_ref_rejects_traversal(), test_git_ref_valid(), test_git_scheme_allows_ssh(), test_http_scheme_rejects_ssh(), test_https_public_host_allowed() (+86 more)

### Community 18 - "tasks/service.py"
Cohesion: 0.04
...
### Community 19 - "CompanyGraph"
Cohesion: 0.03
Nodes (66): BusinessCategory, Get the bound Company Graph., CompanyGraph, CompanyGraphSnapshot, SystemType, The complete Company Graph - canonical core model for the Autonomous AI Agency.…, Find a website by its URL., Find a repository by its URL. (+58 more)

### Community 20 - "WorkflowRun"
Cohesion: 0.03
Nodes (59): OrchestratorSupervisor, Any, Emit an alert to the activity feed and log., Deterministic supervisor for the orchestrator. Runs as a background coroutine.…, stop_orchestrator_supervisor(), get_workflow_orchestrator(), Persist first-merge consent once an operator approves a ``telegram_gate``. No-…, Generate a structured execution plan. Uses the LLM if available; falls back to… (+51 more)

### Community 21 - "CompanyGraphStore"
Cohesion: 0.07
Nodes (100): AccountLifecycleResponse, _DoctorCheck, _DoctorReport, OnboardingAnswersRequest, OnboardingProgressResponse, OnboardingQuestionsRequest, BaseModel, Request to generate AI-tailored onboarding questions. (+92 more)
...
Cohesion: 0.04
Nodes (67): packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, classify_error(), LLMProvider, OpenAICompatible, ABC, Any, AsyncClient, ProviderConfig (+59 more)

### Community 25 - "skill_bindings.py"
Cohesion: 0.03
Nodes (79): Status of a user story within a sprint., StoryStatus, HarnessAdapter, HarnessSpec, Any, agents/harness_adapter.py — ECC Cross-Harness Adapter Normalises API…, Adapt harness-native requests to the local-llm-server internal format. Each…, Detect which harness sent this request from headers. Check order: explicit… (+71 more)
...
### Community 27 - "LLMRequest"
Cohesion: 0.04
Nodes (101): ProviderConfig, One configured endpoint. ``kind`` selects the adapter: ``openai`` (any OpenAI-…, build_provider(), ProviderConfig, Normalise a configured ``kind`` to an adapter key., Instantiate the adapter for one provider config. Unknown kinds fall back to the…, resolve_kind(), LLMRequest (+93 more)

### Community 28 - "SelfHealingAgent"
Cohesion: 0.04
Nodes (78): get_self_healing_agent(), heal_signature(), HealingEvent, _now(), Any, agent/self_healing.py — Self-Healing Agent (closed-loop, Autonomy Charter G2)…, Translate external failure signals into improvement tasks and verify the fix…, Launch the background sweeper that resolves quiet verifying heals. (+70 more)

### Community 29 - "resolve_active_brain"
Cohesion: 0.03
Nodes (104): BrainResolution, Convenience wrapper used by the admin API endpoints., set_brain_config(), get_active_brain_sync(), get_brain_preference(), get_provider_role_tags(), _host_is_openai_compatible(), invalidate_brain_cache() (+96 more)
...
Cohesion: 0.04
Nodes (100): classify_task(), _extract_recent_text(), Any, Task classification from request context. Classifies an incoming request into a…, Concatenate plain text from the last *last_n* messages., Return the most likely task category for this request. Args: messages: OpenAI-…, Reset the singleton and clear the cached model map (test helper)., reset_router() (+92 more)
...
### Community 33 - "Initiative"
Cohesion: 0.03
Nodes (76): _bullets(), generate_backlog_retro(), generate_sprint_retro(), generate_standup(), plan_next_sprint(), Agentic Agile — autonomous ceremonies (standup, retro, sprint planning). Where…, Render a :class:`Retrospective` as a markdown section., Derive retro notes for ``sprint`` from its current metrics. Records… (+68 more)

### Community 34 - "FeatureMatrix"
Cohesion: 0.04
...
### Community 35 - "ImprovementLoop"
Cohesion: 0.05
Nodes (70): _parse_ceo_directives(), DetectedIssue, ImprovementLoop, ImprovementLoopState, _now(), Any, Path, agent/improvement_loop.py — Continuous Improvement Engine Background scanner… (+62 more)

### Community 36 - "test_ceo_supervision.py"
Cohesion: 0.05
Nodes (91): CEODispatcher, CEOResult, _harvest_changed_files(), Extract the files a runtime touched. Returns ``(files, reported)``. Adapters…, Aggregated output from a multi-specialist execution., Real CEO delegation: wake runtimes, fan out, and merge results., Attempt, One delegation of one subtask to one tier. (+83 more)

### Community 37 - "BrainWatchdog"
Cohesion: 0.03
Nodes (75): _brain_provider_status(), get_brain_policy_route(), Return per-provider metadata for the GET endpoint. Iterates every provider in…, Return the discovered model list for *provider_id*, or ``[]`` if unknown., Return the active brain config + per-provider key-present flags. The response…, Called by Cloudflare Cron every minute. Protected by CRON_SECRET header., scheduler_tick(), _served_models() (+67 more)

### Community 38 - "test_runtime_governance.py"
Cohesion: 0.04
Nodes (79): _action_matches(), Decision, get_policy_engine(), GroupPolicy, _host_matches(), Mode, _normalise_path(), _path_matches() (+71 more)
...
### Community 40 - "HTTPException"
Cohesion: 0.04
Nodes (94): cancel_chat_agent_job(), clear_cost_attribution(), clear_response_cache(), create_api_key(), create_github_pr(), create_provider(), create_wiki_page(), delete_api_key() (+86 more)

### Community 41 - "brain_config.py"
Cohesion: 0.04
Nodes (77): BrainConfig, BrainConfigStore, default_brain_config(), provider_api_key(), provider_base_url(), _provider_env_value(), provider_key_rotation_enabled(), BaseModel (+69 more)

### Community 42 - "test_unit8_model_catalog.py"
Cohesion: 0.04
Nodes (74): all_provider_ids(), _provider_ids_from_literal(), Return every provider id recognised by the brain config system. Iterates the…, Return the provider ids allowed by the ``BrainProvider`` Literal. Reads the…, CatalogActiveBrain, CatalogMirror, CatalogProviderEntry, get_catalog() (+66 more)
...
### Community 44 - "KeyPool"
Cohesion: 0.04
Nodes (46): provider_api_keys(), Every API key configured for *provider*, primary first. Reads ``base_env`` then…, api_keys_for(), _digest(), KeyPool, _KeyState, _PoolState, Per-provider API key rotation — the one lever that adds capacity. Every other… (+38 more)

### Community 45 - "ControlPlanePage.js"
Cohesion: 0.04
...
Cohesion: 0.06
Nodes (84): failover_chat_completion(), FailoverResult, _log_recovery(), A successful completion plus the accounting its callers need., Report a successful failover at INFO — recovery is not an incident. Everything…, Run one chat completion across the brain-failover chain. Tries each healthy…, _free_tier(), _hit_ids() (+76 more)

### Community 47 - "E2BSandboxSession"
Cohesion: 0.05
Nodes (66): TaskResult, TaskSpec, Execute a task inside a fresh E2B sandbox. Flow: 1. Open an…, Run ``pytest`` inside the sandbox. Returns ``(output, passed)``.…, E2BSandboxSession, _inject_token(), maybe_attach_e2b(), Kill the sandbox. Idempotent; never raises (best-effort cleanup). (+58 more)

### Community 48 - "Specialist"
Cohesion: 0.04
Nodes (48): SpecialistFamily, Find all specialists of a specific family., Find specialists that can handle a task with given capabilities., A specialist agent that can be provisioned for company-specific tasks., Check if this specialist can handle a task with given capabilities., Specialist, Get a specialist by ID., Create a new specialist in SQLite. (+40 more)

### Community 49 - "TaskWorkflowService"
Cohesion: 0.05
Nodes (59): Set the global agent store instance (e.g., with MongoDB on startup)., set_agent_store(), _is_brain_connection_error(), Any, BaseException, Task, TaskResult, TaskSpec (+51 more)
...
### Community 52 - "test_user_research_skill.py"
Cohesion: 0.06
...
### Community 53 - "tasks/models.py"
Cohesion: 0.05
Nodes (58): Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., tasks — Task/issue management system. Provides a lightweight task/issue tracker…, ApprovalCheckpoint, Enum, str, tasks/models.py — Pydantic models for the task/issue system., Comment or reply on a task. (+50 more)
...
Cohesion: 0.03
Nodes (39): Delete a company and all its associated data., Delete a company and all associated data from SQLite., Count total companies in SQLite., Reconstruct a Website from a SQLite row, preferring the full JSON blob (which…, Create a new website in SQLite. The full model is stored in ``data`` so scan…, Get a website by ID from SQLite., Update a website in SQLite. When ``company_id`` is omitted the existing company…, Count total companies in the store. (+31 more)

### Community 56 - "test_provider_router.py"
Cohesion: 0.04
Nodes (62): extract_openai_text(), is_anthropic_base_url(), _normalize_nvidia_base_url(), _openai_url(), True when ``base_url`` points at Anthropic's native Messages API. Anthropic's…, Normalize NVIDIA base URLs to avoid double /v1 when openai_compat_url appends…, _best_cloud_primary_base(), _nvidia_provider_chain() (+54 more)
...
### Community 58 - "test_knowledge_sync.py"
Cohesion: 0.06
...
### Community 62 - "agency.py"
Cohesion: 0.04
Nodes (47): AgencyCycleResult, AgentDirective, _build_ceo_prompt(), _build_quick_note_instruction(), _close_github_issue(), _collect_recent_git_context(), _fetch_github_quick_notes(), _gh_repo() (+39 more)

### Community 63 - "GoalRecord"
Cohesion: 0.05
Nodes (52): _backend(), CEOLedger, GoalRecord, _now(), Any, services/ceo_ledger.py — durable record of what the CEO is driving to closure.…, One piece of work the CEO has taken ownership of. ``state`` is the supervisor's…, Return ``(done, total)`` subtask counts. (+44 more)

### Community 64 - "workflow/api.py"
Cohesion: 0.06
...
Cohesion: 0.04
Nodes (40): repowise.py — RepowiseIntelligence: context packing and dependency analysis., Path, tools.py — WorkspaceTools: read/write/search and diff application (risky…, Surgical search-and-replace on a single file (F1: Codebuff-style diff). Fails…, Return a previously saved memory value, or an empty string if absent., Persist a key/value pair to the user's profile store., Return the first *lines* lines of a file. Just-in-time retrieval: the executor…, Return a lightweight index of files with line counts and sizes. This is the… (+32 more)
...
### Community 69 - "PolicyEngine"
Cohesion: 0.04
Nodes (52): Return the stable ``agent:<slug>`` id for a human agent name. Deterministic and…, slugify_agent(), _as_list(), PolicyEngine, Any, Path, Coerce a YAML scalar-or-list field into a list of strings. Operators write…, Evaluates governed actions against a layered policy document. Thread-safe for… (+44 more)

### Community 70 - "TaskStore"
Cohesion: 0.05
Nodes (60): Point the feature stores at the shared database connection. Deliberately…, _wire_feature_stores(), Any, Task, TaskStatus, Create a task. Deduplicates by source_id if set (Charter G3). If a task with…, Fetch a task by ID. If owner_id is set, enforces ownership., Return the task previously created for an external ``source_id`` (e.g.… (+52 more)
...
### Community 72 - "get_scheduler"
Cohesion: 0.04
Nodes (46): legacy_scheduler_create(), legacy_scheduler_delete(), legacy_scheduler_get(), legacy_scheduler_trigger(), get_scheduler(), agent/scheduler.py — Scheduled Agent Jobs Cron-based job scheduler. Each job…, set_scheduler(), create_schedule() (+38 more)

### Community 73 - "enforcement.py"
Cohesion: 0.05
Nodes (48): events_from_identity(), Extract the identity-derived audit fields from an AgentIdentity. Kept here…, BudgetExceeded, BudgetTracker, classify(), evaluate_call(), guard_tool_call(), GuardResult (+40 more)
...
### Community 77 - "ToolRegistry"
Cohesion: 0.06
Nodes (30): Any, Path, Register a tool definition., Decorator to register a function as an agent tool. Usage::…, Remove a tool from the registry. Returns True if removed., Look up a tool by name., Return all registered tools., Find tools that advertise a specific capability. (+22 more)

### Community 78 - "TokenBudget"
Cohesion: 0.05
...
Cohesion: 0.04
Nodes (47): createProvider(), deleteModel(), deleteProvider(), getBrainConfig(), getLocalBrainState(), getProviderPolicy(), listModels(), patchBrainConfig() (+39 more)

### Community 81 - "resolve_e2b_config"
Cohesion: 0.05
...
### Community 82 - "claim"
Cohesion: 0.05
Nodes (36): claim(), clear_all_locks(), cooldown_clear(), cooldown_get(), cooldown_set(), _get_backend(), incr_window(), Shared-state abstraction — in-memory (default) and Redis backends. Provides… (+28 more)

### Community 83 - "TestClient"
Cohesion: 0.10
Nodes (30): bare_repo(), _call(), _data(), git_config_env(), _is_error(), mcp_workspace_root(), fixture, Path (+22 more)

### Community 84 - "agent/workspace.py"
Cohesion: 0.06
...
### Community 85 - "test_model_catalog.py"
Cohesion: 0.05
...
### Community 86 - "brain_failover.py"
Cohesion: 0.06
...
### Community 90 - "test_bedrock_provider.py"
Cohesion: 0.05
...
### Community 91 - "Task"
Cohesion: 0.05
Nodes (47): _coerce_ts(), ExecutionLogEntry, Any, field_validator, Full task/issue document., Update the updated_at timestamp., Coerce ISO-8601 datetime strings (from DB) to float timestamps., Single entry in a task's execution log. (+39 more)
...
Cohesion: 0.05
Nodes (25): _overlap_score(), ProceduralMemoryStore, ProceduralRecord, Any, agent/procedural_memory.py — Skill/Procedural Memory for the agent loop (★4).…, Store a successful step pattern and return its record id. Duplicate step…, Return up to *limit* stored patterns relevant to *query*. Relevance is scored…, Return all stored records (for admin/debug). (+17 more)

### Community 94 - "Artifact"
Cohesion: 0.06
...
### Community 96 - "facade.py"
Cohesion: 0.05
Nodes (58): create_access_token(), create_refresh_token(), github_callback(), github_login(), github_repo_access(), github_repo_callback(), google_callback(), google_login() (+50 more)
...
### Community 99 - "ceo_dispatcher.py"
Cohesion: 0.05
Nodes (47): _complexity_rank(), _decompose_into_subtasks(), _merge_changed_files(), _offload(), Any, Semaphore, services/ceo_dispatcher.py — Real CEO delegation layer. The CEO splits a…, Run a synchronous ledger call without blocking the event loop. ``CEOLedger`` is… (+39 more)
...
### Community 101 - "WebReach"
Cohesion: 0.08
Nodes (43): _egress_policy_reason(), _load_script_module(), Any, ModuleType, Response, agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Dynamically load a pure-stdlib helper module from .github/scripts/. Returns…, Zero-key internet access: pages, YouTube transcripts, search, RSS. Every public… (+35 more)

### Community 102 - "services/background.py"
Cohesion: 0.06
Nodes (52): get_improvement_loop(), Any, Public snapshot of live agency state (used by the LiveKit worker tools)., Gather live agency state for SAM's situational awareness., get_trend_watcher(), set_trend_watcher(), _await_hermes_ready(), BackgroundServices (+44 more)

### Community 103 - "FinancialMetrics"
Cohesion: 0.06
...
### Community 105 - "CLAUDE.md — Master Architect Operating Manual"
Cohesion: 0.03
Nodes (61): 0. The Golden Rule, 10. CI/CD Standards, 10. Testing Constitution, 11. Rewrite Strategy, 12. Changelog Rule, 13. Autonomous Development Policy, 14.10 Fake Competence — the 10 Patterns, 14.11 Final Gate — run on every answer before sending (+53 more)

### Community 106 - "FeatureMaturity"
Cohesion: 0.05
Nodes (42): check_feature(), get_feature(), list_features(), Any, get, post, features/api.py — Admin API for the feature support matrix. Exposes: GET…, Return the full support matrix with summary. (+34 more)

### Community 107 - "LogWatcher"
Cohesion: 0.05
...
### Community 112 - "StreamingDeltaReconstructor"
Cohesion: 0.06
...
### Community 113 - "get_task_store"
Cohesion: 0.06
Nodes (54): Reset the singleton (for tests)., reset_failover_manager(), Hand the 'connect & verify the repo' work to the agency's own agents. The task…, _seed_connect_task(), _heal_brain_failover(), _heal_stuck_tasks(), _heal_task_duplicates(), _heal_telegram() (+46 more)

### Community 114 - "run_tests"
Cohesion: 0.07
...
### Community 116 - "FeatureUnavailableError"
Cohesion: 0.08
Nodes (32): PreflightReport, AgentJob, make_isolated_workspace(), Path, Create an isolated workspace directory under *root*. This is the legacy path…, _workspace_component(), Create, open, and lifecycle-manage per-job isolated workspaces. All workspaces…, Resolve *relative* within *ws*.source and reject traversal/symlink escapes.… (+24 more)

### Community 117 - "services/seo_audit.py"
Cohesion: 0.07
...
### Community 120 - "test_sqlite_store.py"
Cohesion: 0.06
...
### Community 131 - "probe_model_liveness"
Cohesion: 0.05
...
### Community 136 - "test_startup_warmup.py"
Cohesion: 0.05
...
### Community 138 - "telegram_bot.py"
Cohesion: 0.07
Nodes (55): Convenience: resolve all four role models for a component. Returns a dict with…, resolve_component_role_models(), Return a Markdown-v1-safe preview string under ``max_chars``. Used by the…, sanitize_paste_for_preview(), _admin_headers(), _answer_callback(), _api_headers(), _check_rate_limit() (+47 more)

### Community 139 - "ai/router.py"
Cohesion: 0.06
Nodes (45): _acquire_provider_probe(), _dead_model_key(), _exponential_backoff_cooldown(), _get_director(), is_commercial_provider(), _mark_model_dead(), _normalized_provider_type(), _notify_watchdog() (+37 more)

### Community 140 - "test_kimi_bridge_server.py"
Cohesion: 0.06
...
### Community 142 - "test_render_mcp.py"
Cohesion: 0.06
Nodes (29): build_render_router(), Any, APIRouter, Exception, backend/render_router.py — Render platform view for operators and agents.…, Reject anyone who is not the agency admin., Map an MCP transport failure onto 503 rather than a 500. The distinction…, _require_admin() (+21 more)

### Community 143 - "App.js"
Cohesion: 0.06
Nodes (32): getAccountLifecycle(), getMe(), getSetupState(), login(), logout(), App(), AppRoutes(), ProtectedRoute() (+24 more)

### Community 144 - "ChatHistoryStore"
Cohesion: 0.07
...
### Community 145 - "WorkspaceManager"
Cohesion: 0.05
...
### Community 146 - "failover_client.py"
Cohesion: 0.06
...
### Community 147 - "test_mcp_governance.py"
Cohesion: 0.07
...
### Community 151 - "tests/conftest.py"
Cohesion: 0.06
...
Cohesion: 0.07
Nodes (46): build_governance_router(), Any, APIRouter, backend/governance_router.py — read and operate the governance layer. Mounted…, Reject non-admin callers. Mirrors the RBAC check used elsewhere in this backend…, _require_admin(), get_approval_store(), get_gate() (+38 more)

### Community 153 - "persist_plan_spec"
Cohesion: 0.07
...
### Community 154 - "test_seo_audit.py"
Cohesion: 0.07
...
### Community 155 - "test_response_cache.py"
Cohesion: 0.12
...
### Community 156 - "IssueCategory"
Cohesion: 0.08
Nodes (44): IssueCategory, IssueSeverity, Enum, str, agent/trend_watcher.py — Internet-connected AI trend intelligence. Fetches from…, _file_issue(), get_render_ops_monitor(), services/render_ops.py — autonomous Render debugging + environment monitoring.… (+36 more)

### Community 157 - "PatternConsolidation"
Cohesion: 0.09
...
### Community 158 - "LLMRouter"
Cohesion: 0.07
Nodes (27): Attempt, text_key(), describe(), The operator-facing reason string for an unfixable status., Read the environment variables named in ``env_names`` into a key list. Order is…, resolve_keys(), LLMRouter, Any (+19 more)

### Community 159 - "test_slop_gate.py"
Cohesion: 0.07
...
### Community 160 - "TestEstimateTokensForMessages"
Cohesion: 0.05
Nodes (17): _normalize_anthropic_output_format(), Translate Anthropic ``output_format`` into an Ollama ``format`` field. Modifies…, fixture, Daily automation tests — 2026-05-15 Covers three features implemented in this…, Integration tests for POST /v1/messages/count_tokens., Unit tests for extended thinking detection in handle_anthropic_messages., When thinking.type == enabled, routing should use agent_plan endpoint type., No thinking param → normal chat routing, not forced to reasoning. (+9 more)

### Community 161 - "test_unit6_resolve_component_model.py"
Cohesion: 0.05
Nodes (46): invalidate_brain_config_cache(), Clear the singleton's cache (used by tests + brain_policy invalidation)., Clear the in-process cache. Called by the admin API after a successful PATCH…, A PATCH persists + the next get returns the applied config., invalidate() clears the cache so the next get re-reads from storage., set_brain_config writes to both Mongo AND the sqlite mirror., test_invalidate_forces_reread(), test_set_then_get_round_trips() (+38 more)
...
### Community 164 - "LogMonitor"
Cohesion: 0.07
Nodes (37): _dispatch_async(), _ErrorCaptureHandler, get_log_monitor(), LogMonitor, _note_recurrence(), Any, LogRecord, agent/log_monitor.py — Application Log Monitor Captures ERROR/CRITICAL log… (+29 more)
...
### Community 167 - "OllamaCircuitBreaker"
Cohesion: 0.08
...
### Community 170 - "activation_api.py"
Cohesion: 0.09
...
### Community 171 - "brain_availability_summary"
Cohesion: 0.06
Nodes (45): brain_failover_status(), brain_providers(), get_public_doctor(), openclaw_command(), _openclaw_instructions(), openclaw_reverse_proxy(), openclaw_status(), openclaw_websocket() (+37 more)

### Community 172 - "SeoAuditRequest"
Cohesion: 0.05
...
### Community 173 - "test_governance_enforcement.py"
Cohesion: 0.09
Nodes (42): Recursively strip secrets from an arbitrary argument structure. Fails…, scrub(), GovernanceGate, The one seam through which governed actions pass., AgentIdentity, new_session_id(), Any, packages/governance/identity.py — who is acting, and under what mandate. Docker… (+34 more)
...
### Community 177 - "test_quick_note.py"
Cohesion: 0.08
...
Cohesion: 0.05
Nodes (24): When True, the governance layer evaluates and audits agent actions. This is…, Typed configuration loaded from environment variables., When True, approval-gated actions self-approve. Local dev only., ``RENDER_SERVICE_IDS`` split into a clean list (empty when unset)., True when there is both an API key and an endpoint to reach., When True, the Render ops loop runs. On by default. Also requires…, When True, mutating Render MCP tools may be called. Default False., Validated `reasoning_effort` for Ollama thinking models, or ``""``. Returns one… (+16 more)

### Community 186 - "ApprovalStore"
Cohesion: 0.07
...
### Community 187 - "test_e2b_data_flow.py"
Cohesion: 0.08
...
### Community 188 - "OrchestratorQueue"
Cohesion: 0.06
...
### Community 191 - "OnboardingScreen.jsx"
Cohesion: 0.06
...
### Community 194 - "test_loop_registry.py"
Cohesion: 0.10
...
### Community 196 - "AuditLog"
Cohesion: 0.07
Nodes (29): detect_secrets(), main(), Recover CHANGELOG.md from a Git merge conflict in its [Unreleased] block. Pre-…, AuditEvent, AuditLog, Any, packages/governance/audit.py — the evidence trail for every governed action.…, Redact secret-shaped substrings, then truncate. (+21 more)

### Community 197 - "_get_provider_policy"
Cohesion: 0.06
...
### Community 200 - "NIMConnectionPool"
Cohesion: 0.07
...
### Community 201 - "AGENTS.md — Source of Truth for All AI Agents"
Cohesion: 0.05
...
### Community 202 - "ContextWindowManager"
Cohesion: 0.09
...
### Community 207 - "test_workspace_isolation.py"
Cohesion: 0.19
...
### Community 212 - "RewardScorer"
Cohesion: 0.05
Nodes (33): _infer_parameters_from_func(), Infer a basic JSON Schema from a function's signature., _inject_tool_results_as_messages(), _normalize_tool_choice(), _parse_tool_calls_from_response(), Parse OpenAI tool_calls from a model response. Handles: - Direct JSON…, Normalize the ``tool_choice`` parameter for the upstream backend. OpenAI…, Inject tool call results as follow-up messages for multi-turn execution. When… (+25 more)

### Community 213 - "test_trend_watcher.py"
Cohesion: 0.09
...
### Community 217 - "test_integration_c4_c5_c6_d3.py"
Cohesion: 0.05
...
### Community 220 - "test_persistent_memory.py"
Cohesion: 0.06
...
### Community 223 - "test_verification_strategies.py"
Cohesion: 0.12
...
### Community 226 - "REWRITE_PLAN.md — Phased Migration Strategy"
Cohesion: 0.06
...
### Community 229 - "_runner"
Cohesion: 0.09
Nodes (36): _drive(), _enforce(), governance_on(), _observations(), Any, fixture, MonkeyPatch, Path (+28 more)
...
### Community 231 - "test_llm_router_e2e.py"
Cohesion: 0.14
...
### Community 232 - "report_to_markdown"
Cohesion: 0.10
...
### Community 233 - "test_anthropic_router.py"
Cohesion: 0.09
...
### Community 234 - "agent_runtime.py"
Cohesion: 0.11
...
### Community 235 - "ENGINEERING_STANDARDS.md — Coding, Security & Testing Standards"
Cohesion: 0.06
...
### Community 236 - "context_rules.py"
Cohesion: 0.11
...
### Community 239 - "test_live_server.py"
Cohesion: 0.22
...
### Community 240 - "test_brain_failover.py"
Cohesion: 0.10
...
### Community 242 - "MCPUnavailableError"
Cohesion: 0.12
...
### Community 247 - "AnthropicProvider"
Cohesion: 0.12
...
### Community 257 - "test_purge_backlog.py"
Cohesion: 0.09
...
### Community 258 - "test_telegram_mutating_commands.py"
Cohesion: 0.06
...
### Community 261 - "test_unit7_catalog_propagation.py"
Cohesion: 0.07
...
### Community 262 - "High-Agency Frontend Skill"
Cohesion: 0.06
Nodes (30): 10. FINAL PRE-FLIGHT CHECK, 1. ACTIVE BASELINE CONFIGURATION, 2. DEFAULT ARCHITECTURE & CONVENTIONS, 3. DESIGN ENGINEERING DIRECTIVES (Bias Correction), 4. CREATIVE PROACTIVITY (Anti-Slop Implementation), 5. PERFORMANCE GUARDRAILS, 6. TECHNICAL REFERENCE (Dial Definitions), 7. AI TELLS (Forbidden Patterns) (+22 more)

### Community 263 - "llm_providers.py"
Cohesion: 0.14
...
### Community 264 - "Quick-Note GitHub Issues Processing - Session Summary"
Cohesion: 0.06
...
### Community 267 - "tests/test_browser.py"
Cohesion: 0.10
...
### Community 268 - "test_colibri_provider.py"
Cohesion: 0.12
...
### Community 271 - "test_telegram_approval_gate.py"
Cohesion: 0.09
Nodes (21): Path, Signal the bot to stop and wait for graceful shutdown., Run the Telegram bot long-poll loop (inline, not subprocess)., Run the bot with stop-event awareness., Manages the Telegram bot as a managed service alongside ollama/proxy/tunnel.…, TelegramBotManager, _clear_telegram_env(), _FakeResponse (+13 more)
...
### Community 273 - "test_rag_context.py"
Cohesion: 0.12
...
### Community 274 - "analyze_qualitative"
Cohesion: 0.12
...
### Community 275 - "test_ceo_router.py"
Cohesion: 0.13
Nodes (27): build_ceo_router(), Any, APIRouter, backend/ceo_router.py — observability and manual control for the CEO. Surfaces…, Reject non-admin callers for routes that spend provider budget. Delegates to…, _require_admin(), _make_app(), FastAPI (+19 more)

### Community 276 - "test_pr923_fixes.py"
Cohesion: 0.09
...
### Community 277 - "SteeringInjector"
Cohesion: 0.11
...
### Community 278 - "RuntimeReadinessReport"
Cohesion: 0.10
Nodes (14): Any, Structured, actionable preflight validation issue., Preflight result returned before a runtime task starts., Return runtime-specific dependency declarations for preflight., Return a best-effort tool availability report for diagnostics., Ensure the requested workspace exists and is writable., Validate task-specific prerequisites beyond runtime dependencies., Run runtime preflight validation before execution starts. (+6 more)

### Community 279 - "test_phase4_runtime_resilience.py"
Cohesion: 0.10
...
### Community 280 - "test_claude_setup_audit.py"
Cohesion: 0.16
...
### Community 281 - "CompanyAgencyService"
Cohesion: 0.09
...
### Community 286 - "Python Dependencies (`requirements.txt`)"
Cohesion: 0.07
...
### Community 287 - "Technical Debt Register — local-llm-server"
Cohesion: 0.07
...
### Community 288 - "chat_handlers.py"
Cohesion: 0.15
...
### Community 290 - "test_phase5_doctor.py"
Cohesion: 0.08
...
### Community 291 - "RuntimeHealthService"
Cohesion: 0.10
...
### Community 295 - "isolated_telegram_config"
Cohesion: 0.11
...
### Community 296 - "WorkflowBuildRequest"
Cohesion: 0.11
...
### Community 297 - "TestBrainFailoverModelUpdates"
Cohesion: 0.12
...
### Community 300 - "Deploy: FreeBuff Telegram bot (24×7)"
Cohesion: 0.07
...
### Community 301 - "Claude Code + Qwen Local Setup"
Cohesion: 0.07
...
### Community 302 - "Configuration Reference"
Cohesion: 0.07
...
### Community 303 - "SetupWizardPage.js"
Cohesion: 0.11
...
### Community 306 - "test_failover_silent_exhaustion.py"
Cohesion: 0.11
...
### Community 307 - "_FakePersistence"
Cohesion: 0.13
...
### Community 310 - "Performance Analysis — local-llm-server"
Cohesion: 0.08
...
### Community 311 - "_resolve_user_github_token"
Cohesion: 0.13
...
### Community 312 - "LLM Router — troubleshooting"
Cohesion: 0.08
...
### Community 313 - "test_rate_limiter.py"
Cohesion: 0.12
...
### Community 317 - "_status_snapshot"
Cohesion: 0.31
...
### Community 320 - "test_telegram_approval_e2e.py"
Cohesion: 0.12
...
### Community 322 - "TestSchedulerStore"
Cohesion: 0.08
...
### Community 323 - "test_service_token.py"
Cohesion: 0.08
...
### Community 331 - "Session Handoff — 2026-06-15"
Cohesion: 0.08
...
### Community 332 - "TASK 4 — End-to-end approval-gate test"
Cohesion: 0.08
...
### Community 334 - "test_north_mini_code.py"
Cohesion: 0.08
...
### Community 335 - "ClaudeCodeAdapter"
Cohesion: 0.15
...
### Community 337 - "_InMemoryBackend"
Cohesion: 0.11
...
### Community 338 - "TemporalContextGraph"
Cohesion: 0.12
...
### Community 339 - "NotificationDispatcher"
Cohesion: 0.14
Nodes (18): NotificationDispatcher, Routes background task results to configured notification channels. Currently…, test_send_approval_gate_redacts_goal_and_steps(), test_send_approval_gate_returns_false_without_config(), test_send_approval_gate_sends_message_with_approve_reject_keyboard(), test_send_approval_gate_sends_to_all_configured_chats(), _FakeResponse, _make_task() (+10 more)

### Community 340 - "test_agency_fix.py"
Cohesion: 0.08
...
### Community 341 - "test_daily_automation_2026_08_03.py"
Cohesion: 0.11
...
### Community 342 - "TestClassifyPlainText"
Cohesion: 0.08
...
### Community 343 - "TestStreamableHTTPTransport"
Cohesion: 0.13
...
### Community 345 - "Local AI Stack with Docker"
Cohesion: 0.08
...
### Community 346 - "Implementation Prompt: Rich TaskBoard + Agile Sprint Integration"
Cohesion: 0.08
...
### Community 347 - "Telegram Bot Setup"
Cohesion: 0.08
...
### Community 353 - "OrchestratorCheckpointStore"
Cohesion: 0.12
...
### Community 356 - "test_workspace_security.py"
Cohesion: 0.10
...
### Community 357 - "monitor_colibri.py"
Cohesion: 0.24
...
### Community 358 - "Agent Governance Guide"
Cohesion: 0.09
...
### Community 359 - "The fifteen strategies"
Cohesion: 0.09
...
### Community 360 - "SchedulesPage.js"
Cohesion: 0.12
...
### Community 364 - "test_freebuff_bot.py"
Cohesion: 0.10
...
### Community 367 - "test_mostly_failed_steps.py"
Cohesion: 0.12
...
### Community 368 - "classify_direct_chat_intent"
Cohesion: 0.13
...
### Community 375 - "PriorityTaskQueue"
Cohesion: 0.13
...
### Community 376 - "test_portfolio_intelligence.py"
Cohesion: 0.10
...
### Community 378 - "V3 API Migration Plan — LLM Relay Platform"
Cohesion: 0.10
...
### Community 379 - "system_instruction"
Cohesion: 0.16
...
### Community 380 - "test_issue_triage.py"
Cohesion: 0.17
...
### Community 381 - "weekly_digest.py"
Cohesion: 0.13
...
### Community 383 - "TestSearchReplaceFile"
Cohesion: 0.21
Nodes (6): Path, Verify that _dispatch_tool_unguarded routes search_replace_file., Minimal AgentRunner with a real WorkspaceTools over tmp_path., Unit tests for WorkspaceTools.search_replace_file (F1)., TestSearchReplaceFile, TestSearchReplaceFileDispatch

### Community 384 - "test_local_controller.py"
Cohesion: 0.17
...
### Community 385 - "test_unit5_ui_provider_surface.py"
Cohesion: 0.10
...
### Community 386 - "test_voice_pipeline.py"
Cohesion: 0.13
...
### Community 388 - "PersistentMemoryStore"
Cohesion: 0.24
...
### Community 389 - "Skill: modularity-review"
Cohesion: 0.10
...
### Community 390 - "Design Audit"
Cohesion: 0.10
Nodes (19): Code Quality, Color and Surfaces, Component Patterns, Content, Design Audit, Fix Priority, How This Works, Iconography (+11 more)

### Community 391 - "Findings"
Cohesion: 0.10
...
### Community 393 - "TestNormalizeResponseFormat"
Cohesion: 0.10
...
### Community 398 - "Docker AI Governance Audit — Final Report"
Cohesion: 0.10
...
### Community 399 - "1. Capability-by-capability"
Cohesion: 0.10
...
### Community 401 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 404 - "output_filter.py"
Cohesion: 0.10
...
### Community 406 - "DecisionsStoreTests"
Cohesion: 0.11
...
### Community 409 - "test_brain_patch_service_token.py"
Cohesion: 0.16
...
### Community 410 - "test_tasks_cache_ttl_env.py"
Cohesion: 0.21
...
### Community 411 - "test_workflow_models.py"
Cohesion: 0.13
...
### Community 415 - "_extract_tech_relevance"
Cohesion: 0.17
...
### Community 424 - "TestRouterIntegration"
Cohesion: 0.18
...
### Community 427 - "Delegation Plan (agent-ready work packages)"
Cohesion: 0.11
...
### Community 428 - "build_workflow.py"
Cohesion: 0.33
...
### Community 430 - "test_company_api.py"
Cohesion: 0.11
...
### Community 431 - "test_fabric_patterns.py"
Cohesion: 0.11
...
### Community 432 - "test_repowise_intelligence.py"
Cohesion: 0.11
...
### Community 433 - "test_sam_livekit.py"
Cohesion: 0.11
...
### Community 434 - "test_sam_voice.py"
Cohesion: 0.12
...
### Community 435 - "test_schedule_persistence.py"
Cohesion: 0.17
...
### Community 436 - "trend_analysis.py"
Cohesion: 0.19
...
### Community 437 - "validate_session_id"
Cohesion: 0.16
...
### Community 438 - "sam_livekit_worker.py"
Cohesion: 0.17
...
### Community 439 - "ErrorInterceptorMiddleware"
Cohesion: 0.18
...
### Community 442 - ".update_intelligence"
Cohesion: 0.11
...
### Community 443 - "CapacityAllocation"
Cohesion: 0.11
...
### Community 444 - "Comprehensive Skill Index (By Category)"
Cohesion: 0.11
...
### Community 445 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 446 - "Component Map"
Cohesion: 0.11
...
### Community 447 - "Agent State — colibri GLM-5.2 deployment (resumable)"
Cohesion: 0.11
...
### Community 448 - "Architecture Overview — local-llm-server"
Cohesion: 0.11
...
### Community 449 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
...
### Community 450 - "Platform Guide — the full tour"
Cohesion: 0.11
...
### Community 452 - "Part A — Health Report"
Cohesion: 0.11
...
### Community 455 - "_Budget"
Cohesion: 0.11
Nodes (10): _Budget, Shared attempt + wall-clock budget for one logical completion. Bounds the whole…, True when free/local providers have used everything but the reserve. Only the…, Drop every cached list and attempt record. For tests, and for an explicit…, reset_cache(), _clear_cache(), disabled(), fixture (+2 more)

### Community 456 - "SQLiteStore"
Cohesion: 0.16
...
### Community 459 - "sync_readme_gallery.py"
Cohesion: 0.22
...
### Community 460 - "test_skill_executors_live.py"
Cohesion: 0.16
...
### Community 464 - "test_openclaw_endpoints.py"
Cohesion: 0.11
...
### Community 465 - "TestStopSlopChecker"
Cohesion: 0.11
...
### Community 467 - "handle_workflow_ide_chat"
Cohesion: 0.18
...
### Community 470 - "._fetch_flat_skill_file"
Cohesion: 0.21
...
### Community 475 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 476 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 477 - "test_admin_local_brain_router.py"
Cohesion: 0.18
...
### Community 478 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 479 - "Section-by-Section Acceptance Criteria"
Cohesion: 0.12
...
### Community 481 - "KnowledgeScreen.jsx"
Cohesion: 0.15
...
### Community 483 - "redact_connection_url"
Cohesion: 0.17
...
### Community 484 - "kimi_bridge_provider_config"
Cohesion: 0.18
...
### Community 485 - "agent_readiness_audit.py"
Cohesion: 0.21
...
### Community 489 - "test_activation_api.py"
Cohesion: 0.21
...
### Community 490 - "test_autonomy_status.py"
Cohesion: 0.12
...
### Community 491 - "test_brain_failover_413.py"
Cohesion: 0.13
...
### Community 492 - "test_health_endpoints.py"
Cohesion: 0.17
...
### Community 493 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 494 - "test_local_brain_state.py"
Cohesion: 0.12
...
### Community 497 - "test_schedule_backlog_drain.py"
Cohesion: 0.15
...
### Community 498 - "test_telegram_diag_endpoint.py"
Cohesion: 0.12
...
### Community 499 - "hermes_prompt.py"
Cohesion: 0.19
...
### Community 500 - "load_registry_sync"
Cohesion: 0.15
...
### Community 501 - "MemoryMiddleware"
Cohesion: 0.17
...
### Community 503 - "Skill: repowise-intelligence"
Cohesion: 0.12
...
### Community 504 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
...
### Community 505 - "admin_digest_router.py"
Cohesion: 0.20
...
### Community 506 - "_valid_login_state"
Cohesion: 0.24
...
### Community 507 - "Skill: repowise-intelligence"
Cohesion: 0.12
Nodes (15): 1. Graph Intelligence (Dependency Graph), 2. Git Intelligence, 3. Documentation Intelligence, 4. Decision Intelligence, Acceptance Checks, Directory Structure, Example Usage, Implementation Approach (+7 more)

### Community 508 - "The 10-Step Workflow"
Cohesion: 0.12
...
### Community 509 - "Contributing to local-llm-server"
Cohesion: 0.12
...
### Community 510 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 511 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 512 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
...
### Community 513 - "implement_agent.py"
Cohesion: 0.16
...
### Community 518 - "ManagedAgentDreams"
Cohesion: 0.22
...
### Community 519 - "telegram_service.py"
Cohesion: 0.15
...
### Community 520 - "e2e/test_browser.py"
Cohesion: 0.21
...
### Community 522 - "test_dockerfile_ships_root_modules.py"
Cohesion: 0.17
...
### Community 523 - "test_frontend_deployment_guards.py"
Cohesion: 0.20
...
### Community 524 - "test_glm52_brain.py"
Cohesion: 0.12
...
### Community 525 - "test_langfuse_agency_wide.py"
Cohesion: 0.12
...
### Community 527 - "test_task_pre_execution_gate.py"
Cohesion: 0.25
...
### Community 543 - "model_discovery.py"
Cohesion: 0.20
Nodes (14): cached_models(), discover_models(), _fresh_entry(), _models_url(), _parse_ids(), Any, Ask a provider which models the configured API key may actually use.…, Return the cached list for *provider_id* without any network call. The… (+6 more)

### Community 544 - "test_daily_2026_07_24.py"
Cohesion: 0.20
...
### Community 547 - "router/health.py"
Cohesion: 0.20
...
### Community 548 - "DockerAgentAdapter"
Cohesion: 0.17
...
### Community 549 - "AdminDigestRouterAuthTests"
Cohesion: 0.23
...
### Community 550 - "TestDecisionsBotLinks"
Cohesion: 0.17
...
### Community 551 - "DecisionsStore"
Cohesion: 0.30
Nodes (3): DecisionsStore, Any, Connection

### Community 552 - "clear_wizard_state_cache"
Cohesion: 0.21
...
### Community 553 - ".on_task_complete"
Cohesion: 0.16
Nodes (7): Any, Start the Telegram bot. Returns True if started successfully., Callback for BackgroundAgent.on_task_complete. Dispatches task result…, Send notification to configured Telegram chat IDs., Dispatch the daily review digest to every authorized chat_id. Mirrors…, POST task result to configured webhook URL. Both ``error`` and ``result`` are…, Send an ad-hoc notification through all channels.

### Community 555 - "test_dockerfile_ships_config_dir.py"
Cohesion: 0.14
...
### Community 557 - "test_openclaw_gateway.py"
Cohesion: 0.13
...
### Community 558 - "test_scanner_live.py"
Cohesion: 0.23
...
### Community 559 - "test_task_self_repo_auto_commit.py"
Cohesion: 0.17
...
### Community 564 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 568 - "Checks Performed"
Cohesion: 0.14
...
### Community 569 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 570 - "test_new_features_e2e.py"
Cohesion: 0.29
...
### Community 584 - "RateLimitTracker"
Cohesion: 0.19
...
### Community 587 - "test_regression.py"
Cohesion: 0.14
...
### Community 588 - "test_autonomy_pipeline_regressions.py"
Cohesion: 0.15
...
### Community 590 - "TestAnthropicToolListCaching"
Cohesion: 0.34
Nodes (3): AnthropicProvider.build_payload caches the tool list when prompt_caching=True…, input_schema passthrough — native Anthropic tools should not be wrapped again., TestAnthropicToolListCaching
...
### Community 596 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 599 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 600 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 603 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
...
### Community 604 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 605 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 607 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 608 - "admin_update_task_router.py"
Cohesion: 0.22
...
### Community 612 - "Workspace Isolation Architecture"
Cohesion: 0.15
...
### Community 613 - "Device compatibility and model picks"
Cohesion: 0.15
...
### Community 614 - "Autonomy Uplift — Living Roadmap & Detailed Implementation Specs"
Cohesion: 0.15
...
### Community 615 - "OpenClaw — iOS Control of the Agency (Single-Service Free-Tier Deploy)"
Cohesion: 0.15
...
### Community 618 - "Agent Transparency Report"
Cohesion: 0.15
...
### Community 619 - "update_provider_policy"
Cohesion: 0.19
...
### Community 621 - "test_agile_api.py"
Cohesion: 0.15
...
### Community 622 - "test_app_settings.py"
Cohesion: 0.19
...
### Community 626 - "TestKillSwitchDurability"
Cohesion: 0.15
...
### Community 629 - "WorkspaceManifest"
Cohesion: 0.17
...
### Community 644 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 647 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 650 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 651 - "Quantization Internals"
Cohesion: 0.17
...
### Community 652 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 653 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 654 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 655 - "Render MCP — autonomous platform debugging and environment monitoring"
Cohesion: 0.17
...
### Community 658 - "test_p0_roadmap_a4_a5_b2.py"
Cohesion: 0.26
...
### Community 659 - "check_container_posture.py"
Cohesion: 0.26
...
### Community 660 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 661 - "TestAuthAndTaskCreation"
Cohesion: 0.17
...
### Community 667 - "_extractive_compress"
Cohesion: 0.18
...
### Community 669 - "RepowiseIntelligence"
Cohesion: 0.33
...
### Community 671 - "cowork_session.py"
Cohesion: 0.24
...
### Community 673 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 676 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 677 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 679 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 682 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 683 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 684 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 685 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 686 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 687 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 688 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 689 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 691 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 692 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 693 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 694 - "CI Troubleshooting Runbook"
Cohesion: 0.18
...
### Community 695 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 696 - "What to clean up"
Cohesion: 0.18
...
### Community 697 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 703 - "test_scanner_ssl_cert.py"
Cohesion: 0.25
...
### Community 704 - "_resolve_push_token"
Cohesion: 0.27
...
### Community 706 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 707 - "test_event_log.py"
Cohesion: 0.45
...
### Community 708 - "test_google_provider_models.py"
Cohesion: 0.18
...
### Community 709 - "get_livekit_config"
Cohesion: 0.18
...
### Community 712 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 713 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 715 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 716 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 717 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 718 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 719 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 720 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 721 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 722 - "Agent Readiness Report"
Cohesion: 0.20
...
### Community 724 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 725 - "LLM Router — configuration guide"
Cohesion: 0.20
...
### Community 726 - "LLM Router — provider guide"
Cohesion: 0.20
...
### Community 729 - "resolve_component_model"
Cohesion: 0.20
Nodes (8): Resolve the model id for a component's role on a provider. Parameters…, resolve_component_model(), Any, Resolve the default executor model via the catalog (UNIT 7). Was hardcoded to…, _resolve_default_executor_model(), Any, Resolve the default executor model via the catalog (UNIT 7). Was hardcoded to…, _resolve_default_executor_model()

### Community 730 - "_parse_reset_epoch"
Cohesion: 0.33
...
### Community 731 - "local_brain_provider_config"
Cohesion: 0.29
...
### Community 732 - "TestModelsEndpointAliases"
Cohesion: 0.31
...
### Community 733 - "build_tech_db.py"
Cohesion: 0.40
...
### Community 735 - "_start_ceo_agency"
Cohesion: 0.27
...
### Community 737 - "TestZeroAttemptDiagnostics"
Cohesion: 0.29
...
### Community 738 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 740 - "test_provider_state_durability.py"
Cohesion: 0.20
...
### Community 742 - "test_task_dispatcher.py"
Cohesion: 0.31
Nodes (5): _BlockingCoordinator, _PendingStore, asyncio, Task, test_dispatcher_executes_pending_tasks_concurrently()

### Community 745 - "permissions.py"
Cohesion: 0.28
Nodes (5): PermissionAssessment, Any, agent/permissions.py — Adaptive Permission Classifier Reads the session…, Convenience helper — True when the inferred level is read_write or full_access., Analyse *messages* and return a :class:`PermissionAssessment`.

### Community 746 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 750 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 752 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 753 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 754 - "Skill: changelog-enforcer"
Cohesion: 0.22
Nodes (8): Acceptance Checks, Changelog Location, Entry Format, Examples, Hook Behaviour, Instructions, Skill: changelog-enforcer, When to Use

### Community 755 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
Nodes (8): Branch, Components, Purpose, Quick Start, Session Roles, Skill: cowork-session (Claude Cowork), Testing, When to Use

### Community 756 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 758 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 760 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 761 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 762 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 763 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 764 - "Release Procedure"
Cohesion: 0.22
...
### Community 765 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 780 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 781 - "test_changelog_parity_guard.py"
Cohesion: 0.22
...
### Community 783 - "TestAgentAutoAssignment"
Cohesion: 0.25
...
### Community 784 - "TestChatFallbackAndApproval"
Cohesion: 0.22
...
### Community 789 - "TestPaidPolicyDurability"
Cohesion: 0.22
...
### Community 797 - "._run_git_command"
Cohesion: 0.25
...
### Community 801 - "ContributorState"
Cohesion: 0.25
...
### Community 866 - "test_compose_and_coordinate_api.py"
Cohesion: 0.36
...
### Community 867 - "fixture"
Cohesion: 0.25
Nodes (5): fixture, Test provider router behavior, GET /api/providers should return list of configured providers, GET /runtimes/policy should return current routing policy, TestProviderRouter

### Community 868 - "test_local_brain_router_smoke.py"
Cohesion: 0.25
...
### Community 870 - "test_provider_models_db_outage.py"
Cohesion: 0.25
...
### Community 879 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 885 - "AI Engineering Insights Skill"
Cohesion: 0.29
...
### Community 895 - "ADR-006: Strangler Fig migration with backward-compat shims"
Cohesion: 0.29
Nodes (6): ADR-006: Strangler Fig migration with backward-compat shims, Consequences, Context, Decision, Examples, Migration path

### Community 896 - "claude-mem Plugin — Persistent Memory for All Sessions"
Cohesion: 0.29
...
### Community 897 - "Implementation plan + TO-DO (check off as you go)"
Cohesion: 0.29
...
### Community 902 - "Workspace Issues"
Cohesion: 0.29
...
### Community 903 - "Model and Response Issues"
Cohesion: 0.29
...
### Community 910 - "check_changelog_parity.py"
Cohesion: 0.43
...
### Community 911 - "e2e_smoke.py"
Cohesion: 0.57
Nodes (5): _chat(), check(), _health(), _models(), _req()

### Community 912 - "task_runner.py"
Cohesion: 0.33
...
### Community 914 - "test_daily_2026_06_14.py"
Cohesion: 0.38
...
### Community 915 - "TestSupportMatrixDocsSync"
Cohesion: 0.29
...
### Community 916 - "TestGithubTokenSQLiteRegression"
Cohesion: 0.38
...
### Community 921 - "._get_last_commit"
Cohesion: 0.33
...
### Community 923 - "autonomy_status"
Cohesion: 0.40
Nodes (6): autonomy_status(), Public autonomy readiness probe — no authentication required. A live deploy…, _find_self_company(), _list_companies_safe(), List companies, skipping any that fail to deserialize. A previous deploy wrote…, Return the existing self company (matched by domain), or None.

### Community 924 - "openclaw_mobile_ui"
Cohesion: 0.33
...
### Community 939 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 940 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 941 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 942 - "The full agent capability roster"
Cohesion: 0.33
...
### Community 943 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 944 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 945 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 949 - "resolve_hermes_base_url"
Cohesion: 0.47
...
### Community 966 - "test_runtime_registration_scope.py"
Cohesion: 0.33
...
### Community 967 - "_normalize_dockerfile"
Cohesion: 0.33
...
### Community 986 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 987 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 990 - "Agent API Issues"
Cohesion: 0.40
...
### Community 991 - "Network and Tunnel Issues"
Cohesion: 0.40
...
### Community 992 - "knowledgeGraphTab.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 993 - "loginFlowNoTimeout.test.js"
Cohesion: 0.40
Nodes (4): apiSource, { describe, test, expect }, fs, path

### Community 994 - "test_company_stale_id_recovery.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 995 - "worker_no_cache.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, workerSource

### Community 996 - "scripts/agile_ceremonies.py"
Cohesion: 0.70
...
### Community 1003 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1004 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1005 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 1006 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 1007 - "run_freebuff_bot.py"
Cohesion: 0.60
Nodes (4): _configure(), _default(), main(), Set an env var only when the operator hasn't already provided one.

### Community 1008 - "setup_colibri.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1009 - "setup_colibri.sh script"
Cohesion: 0.70
Nodes (4): setup_colibri.sh script, fail(), ok(), warn()

### Community 1010 - "status_colibri_server.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1011 - "CircuitBreakerOpenError"
Cohesion: 0.50
...
### Community 1015 - "test_agent_runtime_wrapper.py"
Cohesion: 0.70
...
### Community 1016 - "reset_provider_cooldowns"
Cohesion: 0.40
Nodes (5): _clear_probe_locks(), fixture, Release any stray probe locks between tests so a crashed test never gates the…, Clear module-level cooldown + probe-lock state before every test so tests don't…, reset_provider_cooldowns()

### Community 1018 - "TestRuntimePreflight"
Cohesion: 0.40
Nodes (3): When task-harness is required but not present, preflight should return a…, Every preflight report must have runtime_id, ready, summary., TestRuntimePreflight

### Community 1019 - "worker/index.js"
Cohesion: 0.70
Nodes (4): fetch(), needsProxy(), PROXY_PREFIXES, scheduled()

### Community 1020 - "test_activity_logs.py"
Cohesion: 0.67
Nodes (3): clear_error_log_buffer(), _auth_headers(), test_activity_endpoint_includes_recent_error_logs()

### Community 1021 - "aider_config.sh"
Cohesion: 0.50
Nodes (3): OPENAI_API_BASE, OPENAI_API_KEY, aider_config.sh script

### Community 1024 - "providers.yaml"
Cohesion: 0.50
Nodes (4): Bulkhead sizing, Per-minute token budgets, providers.yaml, Tiers

### Community 1025 - "Issue → Context → Draft PR automation"
Cohesion: 0.50
Nodes (4): Backfilling existing issues, Free-first model routing, Issue → Context → Draft PR automation, The workflows

### Community 1026 - "The 24x7 agency — your agents never go idle"
Cohesion: 0.50
...
### Community 1032 - "Claude Code Specific Issues"
Cohesion: 0.50
...
### Community 1050 - "test_no_exception_detail_leaks.py"
Cohesion: 0.50
...
### Community 1051 - "test_skills_route_order.py"
Cohesion: 0.67
...
### Community 1057 - "Configuration reference"
Cohesion: 0.67
Nodes (3): Configuration reference, Provider priority chain, Running the brain on local Ollama (via a tunnel)

### Community 1081 - "test_the_reserve_is_bounded_when_read_from_the_environment"
Cohesion: 0.67
...
### Community 1082 - "_enable_filter"
Cohesion: 0.67
Nodes (3): _enable_filter(), fixture, Ensure filter is enabled for all tests.

### Community 1083 - "test_mint_token_rejects_missing_args"
Cohesion: 0.67
...
- **Why does `AgentRunner` connect `AgentRunner` to `AgentSessionStore`, `FreeBuffAgent`, `proxy.py`, `StuckDetector`, `backend/server.py`, `direct_chat.py`, `test_ceo_dispatcher.py`, `PortfolioManager`, `WorkflowOrchestrator`, `_StubManager`, `tasks/service.py`, `E2BAdapter`, `WorkflowRun`, `test_governance_api.py`, `LLMRequest`, `test_ceo_supervision.py`, `Workspace`, `failover_chat_completion`, `E2BSandboxSession`, `MCPClient`, `test_agent_free_brain.py`, `LocalWorkspace`, `test_provider_router.py`, `MultiAgentSwarm`, `test_empirical_verify.py`, `WorkspaceTools`, `_build_request`, `TokenBudget`, `TestAnthropicToolListCaching`, `ContextPruner`, `GitHubTools`, `test_backend_server_features.py`, `TestZeroAttemptDiagnostics`, `ceo_dispatcher.py`, `AdaptiveHalter`, `_runner`, `test_brain_failover_413.py`, `ContextManager`, `MCPUnavailableError`, `ReactScratchpad`, `TestSearchReplaceFile`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `AgentSessionStore` to `backend/server.py`, `direct_chat.py`, `ai/router.py`, `test_colibri_provider.py`, `TestBrainFailoverBackoff`, `probe_live_providers.py`, `failover_client.py`, `TrafficDirector`, `TestAnthropicPayloadStructuredOutput`, `resolve_active_brain`, `TestRouterIntegration`, `failover_chat_completion`, `test_provider_router.py`, `test_bedrock_live.py`, `_Budget`, `settings.py`, `clear_cooldowns`, `test_bedrock_provider.py`, `test_chat_mode_regressions.py`, `NvidiaProvider`, `kimi_bridge_provider_config`, `test_all_providers_discovery.py`, `test_anthropic_router.py`, `AnthropicProvider`, `system_instruction`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `ProviderConfig` connect `AgentSessionStore` to `backend/server.py`, `ai/router.py`, `test_colibri_provider.py`, `TestBrainFailoverBackoff`, `failover_client.py`, `tasks/service.py`, `TrafficDirector`, `RuntimeReadinessReport`, `model_discovery.py`, `TestRouterIntegration`, `failover_chat_completion`, `test_provider_router.py`, `_Budget`, `_build_request`, `settings.py`, `clear_cooldowns`, `test_bedrock_provider.py`, `local_brain_provider_config`, `test_chat_mode_regressions.py`, `NvidiaProvider`, `kimi_bridge_provider_config`, `test_anthropic_router.py`, `TestRuntimePreflight`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Are the 165 inferred relationships involving `AgentRunner` (e.g. with `AgentCoordinator` and `AgentSpec`) actually correct?**
  _`AgentRunner` has 165 INFERRED edges - model-reasoned connections that need verification._
