# Graph Report - local-llm-server  (2026-08-01)

## Corpus Check
- 1363 files · ~1,912,964 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 26658 nodes · 53990 edges · 1165 communities (1041 shown, 124 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 6048 edges (avg confidence: 0.54)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `688be899`
...
## Communities (1165 total, 124 thin omitted)

### Community 0 - "Task"
Cohesion: 0.02
Nodes (215): Set the global agent store instance (e.g., with MongoDB on startup)., set_agent_store(), The task store the background services should use, wiring it if needed.…, Point the feature stores at the shared database connection. Deliberately…, _task_store_for_background(), _wire_feature_stores(), Hand the 'connect & verify the repo' work to the agency's own agents. The task…, _seed_connect_task() (+207 more)

### Community 1 - "ProviderConfig"
Cohesion: 0.03
Nodes (179): Agency, CEO-coordinated multi-agent agency for continuous codebase management. The CEO…, AgentJobRequest, AgentJobSnapshot, BaseModel, Complete point-in-time view of a job, safe to serialise as API response., Convenience: the canonical text response, whether success or failure., Validated input for creating a new agent job. Passed from the API handler into… (+171 more)

### Community 2 - "backend/server.py"
Cohesion: 0.02
Nodes (258): backend/ceo_router.py — observability and manual control for the CEO. Surfaces…, Reject non-admin callers for routes that spend provider budget. Delegates to…, _require_admin(), get_optional_company_access(), _is_admin(), Company, Check if a user has admin role. Works for both social_auth users (role in…, Verify user has access to a company (if authenticated). Admins bypass ownership… (+250 more)

### Community 3 - "TaskSpec"
Cohesion: 0.02
Nodes (150): agent/job_manager.py — Async agent job lifecycle manager. Manages agent jobs…, kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, TaskResult, TaskSpec, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Run aider non-interactively via `--message` flag., ClaudeCodeAdapter (+142 more)

### Community 4 - "ai/router.py"
Cohesion: 0.02
Nodes (163): _acquire_provider_probe(), clear_cooldowns(), _dead_model_key(), _exponential_backoff_cooldown(), get_dead_models(), _get_director(), is_anthropic_base_url(), is_commercial_provider() (+155 more)

### Community 5 - "FreeBuffAgent"
Cohesion: 0.05
Nodes (161): BackgroundAgent, BackgroundTask, _now(), Any, agent/background.py — Background Agent An always-on worker thread that…, Enqueue *task* for processing. Returns the task (with task_id set)., Convenience: create a task and submit it in one call., Real handler — dispatches through AgentRunner when available. HARDENED (PR… (+153 more)

### Community 6 - "proxy.py"
Cohesion: 0.02
Nodes (186): Any, Return recent commits with agent attribution trailers parsed out., free_nvidia_models(), Return the curated list of free NVIDIA NIM models FreeBuff may use., True when *model* is in the curated free NVIDIA NIM set., get_sam(), agent/sam.py — SAM Voice Agent (System Autonomy Manager) SAM is the voice-…, _estimate_tokens_for_messages() (+178 more)

### Community 7 - "test_runtimes.py"
Cohesion: 0.02
Nodes (77): RoutingDecision, AiderAdapter, Any, Adapter for Aider — TIER 3 specialized git-aware code editor., GooseAdapter, Any, Adapter for Goose — TIER 2 general-purpose local runtime., HermesAdapter (+69 more)

### Community 8 - "CompanyGraphStore"
Cohesion: 0.04
Nodes (139): AccountLifecycleResponse, _DoctorCheck, _DoctorReport, OnboardingAnswersRequest, OnboardingProgressResponse, OnboardingQuestionsRequest, BaseModel, Request to generate AI-tailored onboarding questions. (+131 more)

### Community 9 - "company_api.py"
Cohesion: 0.02
Nodes (148): ephemeral_ttl_hours(), Async read of the ephemeral TTL (hours) straight from the DB., account_lifecycle(), auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint(), generate_onboarding_questions() (+140 more)

### Community 10 - "LLMRequest"
Cohesion: 0.04
Nodes (97): ProviderConfig, One configured endpoint. ``kind`` selects the adapter: ``openai`` (any OpenAI-…, AnthropicProvider, Any, AsyncClient, packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, Accept both OpenAI and native Anthropic tool declarations., Adapter for ``POST /v1/messages``. (+89 more)

### Community 11 - "llm/router.py"
Cohesion: 0.03
Nodes (111): _load(), main(), int, get_budget(), The process-wide budget tracker., get_cache(), The process-wide cache manager., failover_chat_completion_via_router() (+103 more)

### Community 12 - "SQLiteStore"
Cohesion: 0.02
Nodes (68): DetectedSystem, A business system detected on a company's website or in their stack., Get the most confident evidence description., requires_db, Delete a company and all its associated data., Get a company by ID from SQLite., Delete a company and all associated data from SQLite., List companies from SQLite. (+60 more)

### Community 13 - "test_ceo_dispatcher.py"
Cohesion: 0.04
Nodes (115): BoundContext, ClassifyOutput, ExecutionResult, get_ceo_fallback_stats(), JudgeVerdict, MonitorOutput, _orchestrator_bypass(), PersistOutput (+107 more)
...
### Community 15 - "test_unit8_model_catalog.py"
Cohesion: 0.02
Nodes (112): Resolve the model id for a component's role on a provider. Parameters…, Convenience: resolve all four role models for a component. Returns a dict with…, resolve_component_model(), resolve_component_role_models(), CatalogActiveBrain, CatalogMirror, CatalogProviderEntry, _include_router_providers() (+104 more)

### Community 16 - "brain_config.py"
Cohesion: 0.03
Nodes (105): BrainConfig, BrainConfigStore, default_brain_config(), get_brain_config(), get_brain_config_store(), invalidate_brain_config_cache(), provider_base_url(), _provider_env_value() (+97 more)
...
Cohesion: 0.03
Nodes (74): Test hook — clear all usage accounting., reset(), CacheManager, cosine_similarity(), _Entry, LRUCache, payload_key(), Any (+66 more)

### Community 19 - "test_model_router.py"
Cohesion: 0.03
Nodes (101): classify_task(), _extract_recent_text(), Any, Task classification from request context. Classifies an incoming request into a…, Concatenate plain text from the last *last_n* messages., Return the most likely task category for this request. Args: messages: OpenAI-…, Reset the singleton and clear the cached model map (test helper)., reset_router() (+93 more)
...
### Community 21 - "MongoDBStore"
Cohesion: 0.04
Nodes (52): MongoDBStore, Any, Company, ObjectId, Prepare a Pydantic model for SQLite storage., Prepare a SQLite row for Pydantic model., Create a new company in SQLite., Update a company in SQLite. (+44 more)

### Community 22 - "direct_chat.py"
Cohesion: 0.04
Nodes (89): PreflightIssue, Any, BaseModel, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, Translate technical preflight issues into a conversational assistant reply., translate_error_to_conversational(), ResumeRequest, AcceptedJob (+81 more)
...
### Community 24 - "test_llm_router_resilience.py"
Cohesion: 0.03
...
### Community 28 - "test_phase6_workflow.py"
Cohesion: 0.04
...
Cohesion: 0.04
Nodes (70): TaskResult, TaskSpec, Execute a task inside a fresh E2B sandbox. Flow: 1. Open an…, Run ``pytest`` inside the sandbox. Returns ``(output, passed)``.…, E2BSandboxSession, _inject_token(), maybe_attach_e2b(), Kill the sandbox. Idempotent; never raises (best-effort cleanup). (+62 more)

### Community 32 - "webui/router.py"
Cohesion: 0.05
Nodes (63): test_git_ref_rejects_empty(), test_git_ref_rejects_flag_injection(), test_git_ref_rejects_shell_metacharacters(), test_git_ref_rejects_traversal(), test_git_ref_valid(), test_git_scheme_allows_ssh(), test_http_scheme_rejects_ssh(), test_https_public_host_allowed() (+55 more)

### Community 33 - "AgentSessionStore"
Cohesion: 0.05
Nodes (54): Agent subsystem — planner / executor / verifier loop., AgentEvent, AgentSession, AgentSessionMessage, Any, BaseModel, field_validator, models.py — Pydantic models for agent I/O contracts. (+46 more)

### Community 34 - "AgentRunner"
Cohesion: 0.04
Nodes (77): AgentRunner, GATE: Golden Path steps #7-12 — the primary agent execution loop. This is the…, Return True when no file is touched by more than one step., Set a per-session token spend cap (★3 rollout token budget). When *cap* > 0 the…, Record token spend for *session_id* and enforce the budget cap. Logs a warning…, The core #656 regression: an Anthropic-shaped model must NOT hit…, Free policy + Anthropic-shaped model + NO NVIDIA key → refuse loudly, never…, A non-Anthropic (NVIDIA) model is unaffected — it uses the configured provider… (+69 more)

### Community 35 - "KeyPool"
Cohesion: 0.04
...
Cohesion: 0.04
Nodes (80): livenim, allow_paid_brain(), BrainResolution, get_active_brain_sync(), get_brain_preference(), get_provider_role_tags(), _host_is_openai_compatible(), invalidate_brain_cache() (+72 more)

### Community 37 - "runtimes/api.py"
Cohesion: 0.05
Nodes (77): Available iff config resolves AND the SDK is importable. Never raises — a…, e2b_status(), _enrich_runtimes(), get_decision_log(), get_policy(), get_runtime(), list_runtimes(), _load_rich_policy() (+69 more)

### Community 38 - "Artifact"
Cohesion: 0.04
Nodes (48): get_tracker(), Return the shared AutonomyTracker singleton (lazy-init)., Verify KPI tracker is collected., tests/test_contracts_agency.py — Contract tests for agency core autonomy…, _fake_artifact(), _make_engine(), fixture, tests/test_crispy_workflow.py — CRISPY workflow engine hardening tests. Tests… (+40 more)

### Community 39 - "AgileManager"
Cohesion: 0.05
Nodes (59): AgileManager, Manages multiple agile sprints with velocity tracking., Predict next sprint velocity from historical data., Number of managed sprints., add_initiative(), AllocationOut, BoardOut, get_board() (+51 more)

### Community 40 - "failover_chat_completion"
Cohesion: 0.06
...
### Community 44 - "get_company_graph_store"
Cohesion: 0.04
...
### Community 45 - "RenderOpsMonitor"
Cohesion: 0.06
Nodes (30): One deploy, normalised from whatever shape the tool returned., Typed facade over the Render MCP server's tools. Every method returns plain…, True when there is both an API key and an endpoint to reach., List a service's deploy history, newest first as Render returns it., Fetch one deploy by ID., Return the most recent deploy, or ``None`` when there are none., Build a ``RenderDeploy`` from an upstream deploy object., RenderDeploy (+22 more)

### Community 46 - "NotificationDispatcher"
Cohesion: 0.04
Nodes (51): NotificationDispatcher, Any, Path, Start the Telegram bot. Returns True if started successfully., Signal the bot to stop and wait for graceful shutdown., Run the Telegram bot long-poll loop (inline, not subprocess)., Run the bot with stop-event awareness., Routes background task results to configured notification channels. Currently… (+43 more)
...
Cohesion: 0.04
Nodes (57): _brain_provider_status(), Return per-provider metadata for the GET endpoint. Iterates every provider in…, provider_key_present(), True when the env var for *provider*'s key is set (or it's Ollama)., Any, packages/ai/self_heal.py — automatic brain self-healing. When the active brain…, One-shot self-healing pass. 1. Checks if the active brain provider is in a…, self_heal_brain_and_unblock_tasks() (+49 more)

### Community 49 - "Evidence"
Cohesion: 0.04
Nodes (47): Evidence, Evidence supporting a system detection., _is_blocked_host(), Cheap (no-DNS) SSRF check for headless-browser subrequests. A rendered page's…, _ds(), _models(), _profiles(), asyncio (+39 more)

### Community 50 - "failover_client.py"
Cohesion: 0.04
Nodes (62): _auto_disable(), _Budget, _build_request(), _describe_registry(), _disable_unless_key_serves_other_models(), _disabled_ids(), FailoverResult, _is_billing_refusal() (+54 more)

### Community 51 - "test_sam_livekit.py"
Cohesion: 0.04
...
### Community 52 - "Initiative"
Cohesion: 0.04
Nodes (57): _bullets(), generate_backlog_retro(), generate_sprint_retro(), generate_standup(), Agentic Agile — autonomous ceremonies (standup, retro, sprint planning). Where…, Render a :class:`Retrospective` as a markdown section., Derive retro notes for ``sprint`` from its current metrics. Records…, Derive a retrospective from the task tracker when no sprint is active. DONE /… (+49 more)

### Community 53 - "test_ceo_supervision.py"
Cohesion: 0.06
Nodes (68): _harvest_changed_files(), Extract the files a runtime touched. Returns ``(files, reported)``. Adapters…, Attempt, One delegation of one subtask to one tier., A subtask's full history: what it is, and every attempt at it., SubtaskRecord, What one sweep observed and did. Returned for tests and diagnostics., SweepReport (+60 more)

### Community 54 - "SelfHealingAgent"
Cohesion: 0.05
...
### Community 63 - "fmtErr"
Cohesion: 0.06
Nodes (48): fmtErr(), getActivity(), getCostAttribution(), getDecisionLog(), getDueSoonTasks(), getSavings(), getStats(), getUsage() (+40 more)

### Community 64 - "ModelRouter"
Cohesion: 0.05
Nodes (37): Dynamic model router package. Public API:: from router import get_router,…, _build_builtin_model_map(), _default_model(), get_router(), ModelRouter, _nvidia_key_present(), Any, Dynamic model router. Central routing logic for all chat and agent requests.… (+29 more)

### Community 65 - "_resolve_brain_provider"
Cohesion: 0.04
...
### Community 70 - "test_model_catalog.py"
Cohesion: 0.05
...
Cohesion: 0.05
Nodes (30): plan_next_sprint(), The result of allocating portfolio capacity into a new sprint., Allocate ``capacity`` of WSJF-ranked initiatives into a new sprint. Creates one…, A daily standup digest derived from the task tracker. ``sprint_health`` is…, SprintPlan, StandupReport, AgileSprint, An agile sprint containing user stories. (+22 more)

### Community 75 - "ExecutionRequest"
Cohesion: 0.06
Nodes (36): Called by APScheduler when a cron fires. Dispatches to the orchestrator., _scheduler_on_fire(), ExecutionRequest, get_workflow_orchestrator(), Return the shared WorkflowOrchestrator singleton., Reset the singleton (test helper)., Canonical request to execute work through the golden path. This is the ONLY…, reset_orchestrator() (+28 more)

### Community 76 - "test_repo_connection.py"
Cohesion: 0.07
...
### Community 79 - "test_bedrock_provider.py"
Cohesion: 0.05
...
### Community 80 - "test_colibri_brain_shim.py"
Cohesion: 0.05
...
### Community 84 - "TaskDispatcher"
Cohesion: 0.05
Nodes (51): _env_flag(), Read a boolean env var. Accepts 'true'/'1'/'yes' (case-insensitive)., Path, Start RuntimeManager, TaskDispatcher, SCHEDULER, and self-bootstrap. Returns a…, start_background_services(), Re-queue BLOCKED tasks that have cooled down and are ready for retry., Polls for queued task work and executes it through the coordinator. Crash…, Re-queue tasks stranded by a prior crash or hard-kill. (+43 more)

### Community 85 - "skill_bindings.py"
Cohesion: 0.05
Nodes (45): Status of a user story within a sprint., StoryStatus, MemoryKind, What kind of memory artifact this is., Enum, SuperClaude Workflow Engine — Workflow, Task, and topological DAG execution.…, Return tasks whose dependencies are all satisfied., Number of tasks in the workflow. (+37 more)

### Community 86 - "PortfolioManager"
Cohesion: 0.04
Nodes (30): CapacityAllocation, PortfolioManager, Result of fitting initiatives into a fixed capacity by WSJF priority., Total job size of initiatives that fit within capacity., Unused capacity after committing the selected initiatives., Fraction of capacity consumed (0.0–1.0)., Manages a portfolio of initiatives with WSJF prioritisation and roadmapping., Create and register a new initiative, returning it. (+22 more)

### Community 87 - "RenderFinding"
Cohesion: 0.05
...
### Community 92 - "test_knowledge_sync.py"
Cohesion: 0.08
...
Cohesion: 0.08
Nodes (35): analyze_qualitative(), _classify_sentiment(), _extract_keywords(), BaseModel, QualAnalysis, QualQuote, QualTheme, QuantAnalysis (+27 more)

### Community 100 - "get_store"
Cohesion: 0.05
...
### Community 101 - "seo_api.py"
Cohesion: 0.05
Nodes (47): delegate_seo_findings(), _expire_stale_pending_report(), export_seo_audit(), get_seo_audit(), list_seo_audits(), BaseModel, get, post (+39 more)

### Community 102 - "test_issue_intake.py"
Cohesion: 0.07
Nodes (54): autonomy_tick(), Execute ONE pending task synchronously. Called by the cron workflow every 2…, _capability_tags(), create_task_from_oldest_open_issue(), intake_issue(), _issue_labels(), issue_source_id(), map_issue_to_task() (+46 more)
...
Cohesion: 0.05
Nodes (29): ``RENDER_SERVICE_IDS`` split into a clean list (empty when unset)., True when there is both an API key and an endpoint to reach., When True, the Render ops loop runs. On by default. Also requires…, When True, mutating Render MCP tools may be called. Default False., Validated `reasoning_effort` for Ollama thinking models, or ``""``. Returns one…, UNIT 8: when True, the catalog is mirrored to the DB + the ``GET…, When True, router-configured providers join the mirrored catalog., Typed configuration loaded from environment variables. (+21 more)
...
### Community 108 - "CoworkSession"
Cohesion: 0.06
Nodes (19): ContributorState, CoworkSession, Enum, str, Claude Cowork — shared AI coding sessions with real-time sync. Enables multiple…, A shared AI coding session with multiple human contributors. Manages turn-…, Request editing control. Returns True if granted. Grant rules: - Host can…, Role within a cowork session. (+11 more)

### Community 109 - "V5App.jsx"
Cohesion: 0.05
...
### Community 117 - "SpecialistService"
Cohesion: 0.06
...
Cohesion: 0.08
Nodes (29): PreflightReport, AgentJob, make_isolated_workspace(), Path, Create an isolated workspace directory under *root*. This is the legacy path…, _workspace_component(), Any, WorkspaceEscapeError (+21 more)

### Community 119 - "TestHarnessAdapter"
Cohesion: 0.05
...
### Community 120 - "DashboardLayout.js"
Cohesion: 0.07
Nodes (41): createAgent(), createWikiPage(), deleteAgent(), deleteModel(), deleteSource(), deleteWikiPage(), getSource(), getWikiPage() (+33 more)
...
### Community 127 - "ChatHistoryStore"
Cohesion: 0.07
...
### Community 130 - "ChatSendRequest"
Cohesion: 0.06
Nodes (40): Enum, Agentic Agile — Sprint management with velocity tracking and burndown. Issue:…, Lifecycle status of a sprint., Qualitative health signal derived from sprint metrics., SprintHealth, SprintStatus, ChatSendRequest, Send chat message request. (+32 more)

### Community 131 - "TaskIn"
Cohesion: 0.06
Nodes (39): _active_primary_provider(), is_north_mini_code_default(), True when the ``NORTH_MINI_CODE_DEFAULT`` flag is on (default ON). Reads the…, Best-effort read of the active brain's primary provider (or ``None``)., Resolve the model id to force for a code-execution run, or ``None``. Returns…, resolve_coding_model_preference(), _check_auth(), health() (+31 more)

### Community 132 - "GoalRecord"
Cohesion: 0.07
Nodes (32): Record the goal and its sub-tasks in the ledger before any work runs. Writing…, _backend(), CEOLedger, get_ceo_ledger(), GoalRecord, _now(), Any, services/ceo_ledger.py — durable record of what the CEO is driving to closure.… (+24 more)
...
### Community 135 - "tests/conftest.py"
Cohesion: 0.06
...
### Community 136 - "persist_plan_spec"
Cohesion: 0.07
...
### Community 137 - "TasksPage.js"
Cohesion: 0.05
Nodes (38): addTaskComment(), clarifyTask(), createQuickNote(), createTask(), escalateTask(), fetchVelocity(), followUpTask(), getTask() (+30 more)

### Community 138 - "ProvidersScreen.jsx"
Cohesion: 0.06
...
### Community 140 - "test_schedule_growth_invariants.py"
Cohesion: 0.05
...
### Community 143 - "PatternConsolidation"
Cohesion: 0.08
...
### Community 147 - "test_trend_scoping.py"
Cohesion: 0.11
...
### Community 150 - "TestPayloadNormalisation"
Cohesion: 0.07
Nodes (24): _as_list(), _coerce_payload(), Any, packages/integrations/render_mcp.py — Render platform access over MCP. The…, Return tool output as Python data. MCP tool results arrive either as…, Normalise a tool payload into a list of dicts. Upstream tools variously return…, Unwrap a nested envelope such as ``{"service": {...}}`` when present., Run the MCP handshake once per client instance. Streamable-HTTP servers create… (+16 more)

### Community 151 - "MetricsRegistry"
Cohesion: 0.08
...
### Community 156 - "LLMRouter"
Cohesion: 0.08
Nodes (24): Attempt, text_key(), Read the environment variables named in ``env_names`` into a key list. Order is…, resolve_keys(), LLMRouter, Any, AsyncClient, BaseException (+16 more)

### Community 157 - "get_feature_matrix"
Cohesion: 0.07
...
### Community 159 - "PromptCacheManager"
Cohesion: 0.06
...
### Community 164 - "anthropic_compat.py"
Cohesion: 0.08
...
### Community 167 - "brain_failover.py"
Cohesion: 0.07
Nodes (43): brain_failover_status(), brain_providers(), Return the brain failover health snapshot. Shows every configured provider, its…, Every configured provider with its health AND its on/off state. Powers the…, brain_availability_summary(), describe_disabled_reason(), _disabled_from_mongo(), _disabled_from_sqlite() (+35 more)

### Community 168 - "OnboardingScreen.jsx"
Cohesion: 0.06
...
### Community 169 - "v3_auth.py"
Cohesion: 0.08
Nodes (42): _get_admin_email(), _get_admin_name(), _get_admin_secret(), login(), LoginRequest, LoginResponse, BaseModel, get (+34 more)

### Community 170 - "ScheduledJob"
Cohesion: 0.08
Nodes (20): _now(), Any, Register a new job. Returns the created :class:`ScheduledJob`.…, Fire a job immediately (webhook / manual trigger)., Remove a job. Returns *True* if it existed., Update the display name of a job., Enable or disable a job without deleting it., Capture the FastAPI main event loop so APScheduler's background thread can… (+12 more)

### Community 171 - "test_self_heal_v2.py"
Cohesion: 0.08
...
### Community 176 - "Docker Agent Runtimes Setup"
Cohesion: 0.05
...
### Community 177 - "emit_chat_observation"
Cohesion: 0.09
...
### Community 178 - "test_portfolio_intake.py"
Cohesion: 0.08
Nodes (35): Weighted Shortest Job First score — higher schedules sooner., map_initiative_to_task(), materialize_committed(), _portfolio_materialize_enabled(), portfolio_source_id(), Any, Task, Content-derived stable id for a portfolio initiative. Initiative UUIDs… (+27 more)

### Community 179 - "test_startup_warmup.py"
Cohesion: 0.06
Nodes (39): Await one warm-up step, deferring it to the background if it overruns.…, _warmup_step(), NoReturn, _isolate_warmup_overflow(), asyncio, fixture, RuntimeError, Regression tests for the bounded startup warm-up and login bootstrap. Uvicorn… (+31 more)

### Community 180 - "Persistent Memory System"
Cohesion: 0.05
...
### Community 185 - "test_control_plane_api.py"
Cohesion: 0.07
Nodes (19): agent/scheduler.py — Scheduled Agent Jobs Cron-based job scheduler. Each job…, set_scheduler(), _FakeStore, mock_runtime_manager(), fixture, tests/test_control_plane_api.py — Tests for Control Plane API endpoints. Covers…, In-memory store stub for hydrate() tests — isolates from real DB., Stale run-once jobs (run_count > 0) must be skipped during hydration. (+11 more)

### Community 186 - "test_seo_audit.py"
Cohesion: 0.08
...
Cohesion: 0.05
Nodes (37): [5.0.0], Added, Added, Added, Added, Added, Added, Added (+29 more)

### Community 197 - "[Unreleased]"
Cohesion: 0.05
Nodes (37): [5.0.0], Added, Added, Added, Added, Added, Added, Added (+29 more)

### Community 198 - "TestEstimateTokensForMessages"
Cohesion: 0.07
...
### Community 199 - "test_pr923_fixes.py"
Cohesion: 0.07
...
### Community 202 - "SeoAuditRequest"
Cohesion: 0.07
Nodes (16): field_validator, Request to run an SEO/GEO/AIO audit against a website., SeoAuditRequest, mock_report(), _mock_site_handler(), fixture, Request, Response (+8 more)

### Community 203 - "test_phase5_doctor.py"
Cohesion: 0.06
Nodes (29): Request, FastAPI dependency: require any authenticated user., require_authenticated(), client(), _coding_brain_check(), fixture, tests/test_doctor_coding_brain.py Surfaces the North Mini Code coding-brain…, With NORTH_MINI_CODE_DEFAULT off, the check warns and says so. (+21 more)

### Community 204 - "_Collection"
Cohesion: 0.11
...
### Community 205 - "CEOSupervisor"
Cohesion: 0.08
Nodes (22): get_ceo_dispatcher(), Return the shared CEODispatcher singleton., Reset the singleton (test helper)., reset_ceo_dispatcher(), CEOSupervisor, get_ceo_supervisor(), Any, Sweeps the CEO ledger and drives open goals to closure. (+14 more)
...
### Community 210 - "test_verification_strategies.py"
Cohesion: 0.12
...
### Community 211 - "test_rate_limiter.py"
Cohesion: 0.08
...
### Community 212 - "REWRITE_PLAN.md — Phased Migration Strategy"
Cohesion: 0.06
...
### Community 213 - "NIMConnectionPool"
Cohesion: 0.08
...
### Community 215 - "test_all_providers_discovery.py"
Cohesion: 0.16
...
Cohesion: 0.08
Nodes (26): Contract: WorkflowEngine cannot skip the gate state machine., Contract: No code path may advance past awaiting_approval unless gate.status ==…, Create a run and manually place it in awaiting_approval., Contract: Cannot approve a run in 'pending' state., Contract: Can approve a run in 'awaiting_approval' state., Contract: Rejecting a run marks it as failed., TestApprovalGateMandatory, _make_engine() (+18 more)

### Community 217 - "test_llm_router_e2e.py"
Cohesion: 0.14
...
### Community 219 - "StuckDetector"
Cohesion: 0.11
Nodes (26): Path, Run real validation (byte-compile + scoped pytest) on this step's changes. Opt-…, Any, Stuck detection for the agent tool loop — adapted from OpenHands. OpenHands…, Canonical identity of one observation, ignoring incidental fields., Consecutive repetitions required before a pattern counts as stuck., Detects repeating patterns in a step's observation history., Return a human-readable reason when the loop looks stuck, else None. (+18 more)

### Community 220 - "get_doctor_diagnostics"
Cohesion: 0.07
Nodes (28): _check_storage_health(), doctor_health(), get_doctor_diagnostics(), health(), Path, Authenticated Doctor endpoint — full diagnostics. Returns all system-level…, N5 dual-auth dependency: accept EITHER a user session OR a service token. Used…, Check if the storage backend is reachable. Works with BOTH MongoDB and SQLite:… (+20 more)

### Community 221 - "test_brain_availability_doctor.py"
Cohesion: 0.11
Nodes (29): _env_flag(), _env_int(), services/ceo_supervisor.py — the CEO's 24x7 babysitting loop. Delegation alone…, Read a bounded int, clamping out-of-range values rather than raising., Bounds for the unattended supervision loop., SupervisorConfig, _doctor(), _P (+21 more)

### Community 222 - "test_anthropic_router.py"
Cohesion: 0.09
...
### Community 223 - "test_backend_server_features.py"
Cohesion: 0.07
...
### Community 224 - "agent_runtime.py"
Cohesion: 0.11
...
### Community 225 - "ENGINEERING_STANDARDS.md — Coding, Security & Testing Standards"
Cohesion: 0.06
...
### Community 226 - "context_rules.py"
Cohesion: 0.11
...
### Community 227 - "OrchestratorSupervisor"
Cohesion: 0.10
Nodes (17): codeql_count(), dependabot_count(), main(), Any, _repo_parts(), _request(), get_orchestrator_supervisor(), OrchestratorSupervisor (+9 more)

### Community 228 - "test_llm_router_disabled.py"
Cohesion: 0.10
Nodes (32): auto_disable(), _billing_signals(), describe(), disabled_provider_ids(), is_unfixable(), packages/llm/disabled.py — bridge to the durable provider on/off switch. The…, Provider ids currently switched off. Empty when the store is unreachable., Persist a provider as disabled, through the store that already owns it. (+24 more)

### Community 229 - "local_controller.py"
Cohesion: 0.12
...
### Community 230 - "test_live_server.py"
Cohesion: 0.22
...
### Community 236 - "test_ceo_router.py"
Cohesion: 0.11
...
### Community 237 - "test_dashboard_cache.py"
Cohesion: 0.09
Nodes (28): _cached(), cost_attribution_stats(), _fast_count(), get_activity(), _get_activity_impl(), get_stats(), legacy_scheduler_list(), _produce_scheduler_jobs() (+20 more)
...
### Community 240 - "test_daily_2026_06_04.py"
Cohesion: 0.10
...
### Community 242 - "test_microagents.py"
Cohesion: 0.15
...
### Community 243 - "Security Analysis — local-llm-server"
Cohesion: 0.06
...
### Community 244 - "Langfuse Observability Guide"
Cohesion: 0.06
...
### Community 246 - "test_failover_silent_exhaustion.py"
Cohesion: 0.10
...
### Community 250 - "session_retro.py"
Cohesion: 0.13
...
### Community 254 - "test_freebuff_bot.py"
Cohesion: 0.08
...
### Community 259 - "Quick-Note GitHub Issues Processing - Session Summary"
Cohesion: 0.06
...
### Community 263 - "TestRecordUsageAndStats"
Cohesion: 0.06
...
### Community 264 - "tests/test_browser.py"
Cohesion: 0.10
...
### Community 266 - "openclaw_gateway.py"
Cohesion: 0.09
...
### Community 267 - "TrafficDirector"
Cohesion: 0.10
Nodes (11): In-process traffic distribution and budget accounting for providers., Count a request that is about to be sent to *provider_id*. Called immediately…, Record the outcome of a request started with ``record_start``. Must be called…, Count a request that was routed away from *provider_id* (diagnostics)., EWMA latency in ms; never-sampled providers sort first. Returning -1.0 for an…, Clear all counters (tests only)., TrafficDirector, `int(0.5)` is 0, and a cap of 0 makes `in_flight >= cap` true at zero in-flight… (+3 more)

### Community 268 - "switch_brain.py"
Cohesion: 0.16
Nodes (29): detect_ollama_models(), dim(), fail(), get_auth_headers(), get_brain_config(), get_ngrok_tunnel_url(), header(), info() (+21 more)

### Community 269 - "RewardScorer"
Cohesion: 0.10
...
### Community 271 - "test_autonomy_gate.py"
Cohesion: 0.11
...
### Community 272 - "test_p0_roadmap_b1_c2_a3.py"
Cohesion: 0.11
Nodes (15): _infer_parameters_from_func(), Infer a basic JSON Schema from a function's signature., _inject_tool_results_as_messages(), _normalize_tool_choice(), Normalize the ``tool_choice`` parameter for the upstream backend. OpenAI…, Inject tool call results as follow-up messages for multi-turn execution. When…, BaseModel, Result of a single reward model scoring operation. (+7 more)
...
### Community 274 - "test_unit7_catalog_propagation.py"
Cohesion: 0.07
Nodes (28): _nvidia_defaults(), _default_reasoning_model(), Resolve the default planner (reasoning) model via the catalog (UNIT 7)., tests/test_unit7_catalog_propagation.py — UNIT 7 regression tests. Verifies…, ``_get_defaults()`` must consult the catalog first; the hardcoded…, When NVIDIA key is set, ``_catalog_defaults()`` returns the catalog's nvidia…, ``_get_defaults()`` returns the catalog-derived defaults (not the hardcoded…, ``jcode.py`` must NOT have the stale hardcoded ``meta/llama-3.3-70b-instruct``… (+20 more)

### Community 275 - "SteeringInjector"
Cohesion: 0.11
...
### Community 276 - "test_claude_setup_audit.py"
Cohesion: 0.16
...
### Community 277 - "test_crispy_burn_in.py"
Cohesion: 0.07
...
### Community 278 - "test_internal_agent_did_work.py"
Cohesion: 0.12
...
### Community 279 - "test_provider_enable_disable.py"
Cohesion: 0.09
...
### Community 280 - "test_skill_registry_boot_refresh.py"
Cohesion: 0.12
...
### Community 281 - "Python Dependencies (`requirements.txt`)"
Cohesion: 0.07
...
### Community 282 - "Technical Debt Register — local-llm-server"
Cohesion: 0.07
...
### Community 283 - "_require_admin"
Cohesion: 0.07
Nodes (28): clear_response_cache(), get_brain_policy_route(), get_catalog_models_route(), purge_backlog(), _purge_backlog_core(), Raise 403 unless *user* has the admin role. Reuses…, Shared purge implementation for the admin endpoint and the boot hook., Erase the schedule backlog and poisoned tasks (admin only). (+20 more)

### Community 284 - "get_scheduler"
Cohesion: 0.12
Nodes (26): legacy_scheduler_create(), legacy_scheduler_delete(), legacy_scheduler_get(), get_scheduler(), create_schedule(), delete_schedule(), get_schedule(), get_schedule_runs() (+18 more)

### Community 285 - "chat_handlers.py"
Cohesion: 0.15
...
### Community 288 - "RuntimeHealthService"
Cohesion: 0.10
...
### Community 289 - "BrainFailoverManager"
Cohesion: 0.10
...
### Community 291 - "get_skill_bindings"
Cohesion: 0.10
...
### Community 292 - "isolated_telegram_config"
Cohesion: 0.11
...
### Community 293 - "TestSchedulerStore"
Cohesion: 0.07
...
### Community 295 - "test_watchdog.py"
Cohesion: 0.09
...
Cohesion: 0.10
Nodes (16): Return orchestrator queue depth, active runs, and supervisor state (#522)., #522 + #505: Reliability startup — schedule hydration, orchestrator restore,…, _startup_reliability_hooks(), workflow_orchestrator_status(), get_orchestrator_queue(), OrchestratorQueue, Any, _QueueEntry (+8 more)

### Community 298 - "Deploy: FreeBuff Telegram bot (24×7)"
Cohesion: 0.07
...
### Community 299 - "Claude Code + Qwen Local Setup"
Cohesion: 0.07
...
### Community 300 - "generate_context.py"
Cohesion: 0.12
...
### Community 301 - "test_north_mini_code.py"
Cohesion: 0.08
...
### Community 305 - "Performance Analysis — local-llm-server"
Cohesion: 0.08
...
### Community 307 - "model_discovery.py"
Cohesion: 0.10
Nodes (23): Return the discovered model list for *provider_id*, or ``[]`` if unknown., _served_models(), cached_models(), discover_models(), _fresh_entry(), _models_url(), _parse_ids(), Any (+15 more)

### Community 308 - "LLM Router — troubleshooting"
Cohesion: 0.08
...
### Community 314 - "test_telegram_approval_e2e.py"
Cohesion: 0.12
...
### Community 316 - "test_service_token.py"
Cohesion: 0.08
...
### Community 326 - "Session Handoff — 2026-06-15"
Cohesion: 0.08
...
### Community 327 - "TASK 4 — End-to-end approval-gate test"
Cohesion: 0.08
...
### Community 330 - "TemporalContextGraph"
Cohesion: 0.12
...
### Community 331 - "test_agency_fix.py"
Cohesion: 0.08
...
### Community 332 - "TestClassifyPlainText"
Cohesion: 0.08
...
### Community 334 - "telegram_service.py"
Cohesion: 0.13
Nodes (19): Build a *self-contained, actionable* escalation message. The previous message…, service_manager.py — Telegram & Notification Integration Extension Extends the…, True when outbound Telegram sends must be suppressed. Tests must never page a…, # NOTE: do NOT re-escape here — services.daily_digest.format_digest_markdown, _telegram_sends_suppressed(), _event(), The self-heal escalation Telegram message must be self-contained & actionable.…, test_code_fences_stripped_for_telegram_markdown() (+11 more)
...
### Community 336 - "Local AI Stack with Docker"
Cohesion: 0.08
...
### Community 343 - "test_monitor_lib.py"
Cohesion: 0.11
...
### Community 344 - "test_output_filter.py"
Cohesion: 0.08
...
### Community 347 - "test_workspace_security.py"
Cohesion: 0.10
...
### Community 348 - "The fifteen strategies"
Cohesion: 0.09
...
### Community 352 - "WindowsServiceManager"
Cohesion: 0.18
...
### Community 358 - "classify_direct_chat_intent"
Cohesion: 0.13
...
### Community 366 - "test_portfolio_intelligence.py"
Cohesion: 0.10
...
### Community 367 - "HarnessEnrichment"
Cohesion: 0.15
...
### Community 369 - "V3 API Migration Plan — LLM Relay Platform"
Cohesion: 0.10
...
### Community 373 - "test_issue_triage.py"
Cohesion: 0.17
...
### Community 375 - "test_local_controller.py"
Cohesion: 0.17
...
### Community 376 - "test_unit5_ui_provider_surface.py"
Cohesion: 0.10
...
### Community 377 - "test_voice_pipeline.py"
Cohesion: 0.13
...
### Community 379 - "test_permissions.py"
Cohesion: 0.15
...
### Community 381 - "Skill: modularity-review"
Cohesion: 0.10
...
### Community 384 - "TestNormalizeResponseFormat"
Cohesion: 0.10
...
### Community 385 - "Skill: modularity-review"
Cohesion: 0.10
Nodes (19): Acceptance Checks, Applying to This Repo, Further Reading, Modularity Findings Template, Part A: Reviewing Existing Code for Modularity Problems, Part B: Designing New Modular Boundaries, Skill: modularity-review, Step 1 — Map the dependency graph (+11 more)

### Community 386 - "crispy_client.py"
Cohesion: 0.14
Nodes (18): cmd_approve(), cmd_artifacts(), cmd_build(), cmd_events(), cmd_reject(), cmd_status(), cmd_watch(), _get() (+10 more)

### Community 387 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 390 - "output_filter.py"
Cohesion: 0.10
...
### Community 392 - "DecisionsStoreTests"
Cohesion: 0.11
...
### Community 396 - "test_chat_mode_regressions.py"
Cohesion: 0.19
...
### Community 397 - "test_tasks_cache_ttl_env.py"
Cohesion: 0.21
...
### Community 399 - "test_contract_enforcement.py"
Cohesion: 0.15
...
### Community 401 - "CollaborationContext"
Cohesion: 0.15
Nodes (5): CollaborationContext, Any, Apply context updates from a contributor. Only the active editor can modify…, Shared context blob propagated to all session participants. Carries the active…, TestCollaborationContext

### Community 402 - "HarnessAdapter"
Cohesion: 0.12
...
### Community 403 - "Skill: fabric-patterns"
Cohesion: 0.11
...
### Community 404 - "Analysis & Synthesis Instructions"
Cohesion: 0.11
Nodes (18): 1. Define the Atmosphere, 2. Map the Color Palette, 3. Establish Typography Rules, 4. Define the Hero Section, 5. Describe Component Stylings, 6. Define Layout Principles, 7. Define Responsive Rules, 8. Encode Motion Philosophy (+10 more)

### Community 405 - "Production Readiness Assessment — local-llm-server"
Cohesion: 0.11
...
### Community 406 - "Skill: fabric-patterns"
Cohesion: 0.11
Nodes (18): 1. Ensure Pattern Directory Exists, 2. List Available Patterns, 3. Retrieve a Pattern, 4. Apply a Pattern with Variables, 5. Stitch Patterns Together, 6. Create New Patterns, Acceptance Checks, Directory Structure (+10 more)

### Community 407 - "db/__init__.py"
Cohesion: 0.15
...
### Community 408 - "Admin Dashboard Guide"
Cohesion: 0.11
...
### Community 409 - "Implementation Plan"
Cohesion: 0.11
...
### Community 411 - "ProviderConsole.jsx"
Cohesion: 0.11
...
### Community 413 - "Delegation Plan (agent-ready work packages)"
Cohesion: 0.11
...
### Community 417 - "test_task_source_id_race.py"
Cohesion: 0.17
...
### Community 418 - "test_company_api.py"
Cohesion: 0.11
...
### Community 419 - "TestSelfHealingInfrastructureClassification"
Cohesion: 0.19
...
### Community 421 - "test_fabric_patterns.py"
Cohesion: 0.11
...
### Community 422 - "test_repowise_intelligence.py"
Cohesion: 0.11
...
### Community 423 - "test_sam_voice.py"
Cohesion: 0.12
...
### Community 424 - "test_schedule_persistence.py"
Cohesion: 0.17
...
### Community 425 - "test_scheduler.py"
Cohesion: 0.11
...
### Community 427 - "validate_session_id"
Cohesion: 0.16
...
### Community 428 - "ErrorInterceptorMiddleware"
Cohesion: 0.18
...
### Community 431 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
...
### Community 433 - "Agent State — colibri GLM-5.2 deployment (resumable)"
Cohesion: 0.11
...
### Community 434 - "Architecture Overview — local-llm-server"
Cohesion: 0.11
...
### Community 435 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
...
### Community 436 - "Platform Guide — the full tour"
Cohesion: 0.11
...
### Community 438 - "Part A — Health Report"
Cohesion: 0.11
...
### Community 444 - "sync_readme_gallery.py"
Cohesion: 0.22
...
### Community 445 - "shared_state.py"
Cohesion: 0.18
Nodes (12): clear_all_locks(), cooldown_clear(), cooldown_get(), cooldown_set(), _get_backend(), Shared-state abstraction — in-memory (default) and Redis backends. Provides…, Put a key on cooldown for *ttl* seconds., Return True if *key* is still within its cooldown window. (+4 more)

### Community 446 - "LocalLLMSetup"
Cohesion: 0.16
...
### Community 447 - "test_openclaw_endpoints.py"
Cohesion: 0.11
...
### Community 448 - "TestStopSlopChecker"
Cohesion: 0.11
...
### Community 449 - "test_task_service_failed_comment.py"
Cohesion: 0.18
...
### Community 450 - "handle_workflow_ide_chat"
Cohesion: 0.18
...
### Community 452 - "._fetch_flat_skill_file"
Cohesion: 0.21
...
### Community 457 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 458 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 459 - "test_admin_local_brain_router.py"
Cohesion: 0.18
...
### Community 461 - "Section-by-Section Acceptance Criteria"
Cohesion: 0.12
...
### Community 462 - "issue_new_api_key"
Cohesion: 0.21
...
### Community 463 - "traffic_director.py"
Cohesion: 0.17
Nodes (12): Return the configured traffic-distribution strategy (lower-cased). Reads…, routing_strategy(), active_strategy(), provider_id_of(), Any, Adaptive traffic distribution across LLM providers. The router…, Return the configured strategy name, falling back to ``priority``. An…, Extract a provider id from a ProviderConfig dataclass or a plain dict. (+4 more)

### Community 464 - "agent_readiness_audit.py"
Cohesion: 0.21
...
### Community 469 - "_resolve_push_token"
Cohesion: 0.15
...
### Community 472 - "test_autonomy_status.py"
Cohesion: 0.12
...
### Community 473 - "test_daily_automation_2026_07_11.py"
Cohesion: 0.15
...
### Community 474 - "test_health_endpoints.py"
Cohesion: 0.17
...
### Community 475 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 476 - "test_local_brain_state.py"
Cohesion: 0.12
...
### Community 479 - "test_telegram_diag_endpoint.py"
Cohesion: 0.12
...
### Community 481 - "hermes_prompt.py"
Cohesion: 0.19
...
### Community 482 - "MemoryMiddleware"
Cohesion: 0.17
...
### Community 484 - "Skill: repowise-intelligence"
Cohesion: 0.12
...
### Community 485 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
...
### Community 486 - "admin_digest_router.py"
Cohesion: 0.20
...
### Community 487 - "_valid_login_state"
Cohesion: 0.24
...
### Community 488 - "Skill: repowise-intelligence"
Cohesion: 0.12
Nodes (15): 1. Graph Intelligence (Dependency Graph), 2. Git Intelligence, 3. Documentation Intelligence, 4. Decision Intelligence, Acceptance Checks, Directory Structure, Example Usage, Implementation Approach (+7 more)

### Community 489 - "The 10-Step Workflow"
Cohesion: 0.12
...
### Community 490 - "Contributing to local-llm-server"
Cohesion: 0.12
...
### Community 491 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 492 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 493 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
...
### Community 494 - "implement_agent.py"
Cohesion: 0.16
...
### Community 496 - "test_agent_chat_integration.py"
Cohesion: 0.23
...
### Community 498 - "._execute_with_fallback"
Cohesion: 0.18
Nodes (9): TaskResult, TaskSpec, Selects a runtime for the given task, executes the task (including readiness…, Selects an available runtime for the given task type, preferring a specified…, Execute the given task spec on the primary runtime, attempt configured fallback…, Attempt paid escalation through ProviderManager. Routes the task to the first…, Return the last *limit* routing decisions (newest first)., Full record of a routing decision — audit-trail entry. (+1 more)

### Community 499 - "fabric_cli.py"
Cohesion: 0.29
Nodes (15): cmd_apply(), cmd_list(), cmd_new(), cmd_save(), cmd_show(), cmd_stitch(), _ensure_patterns_dir(), main() (+7 more)

### Community 500 - "sync_ngrok.py"
Cohesion: 0.26
Nodes (14): detect_ngrok_url(), dim(), fail(), header(), info(), main(), ok(), patch_platform_brain_via_switch_brain() (+6 more)

### Community 501 - "GuardResult"
Cohesion: 0.16
...
### Community 502 - "ManagedAgentDreams"
Cohesion: 0.22
...
### Community 503 - "e2e/test_browser.py"
Cohesion: 0.21
...
### Community 504 - "test_dockerfile_ships_root_modules.py"
Cohesion: 0.17
...
### Community 505 - "test_frontend_deployment_guards.py"
Cohesion: 0.20
...
### Community 506 - "test_glm52_brain.py"
Cohesion: 0.12
...
### Community 508 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 510 - "plan_research"
Cohesion: 0.19
Nodes (5): plan_research(), Compute the minimum sample size for a proportion estimate. Uses the standard…, Produce a structured research plan. The four Plan inputs that are typically…, _sample_size_for_proportion(), TestPlanResearch

### Community 511 - "Skill: agent-harness"
Cohesion: 0.13
...
### Community 512 - "Skill: checkpoint-strategy"
Cohesion: 0.13
...
### Community 514 - "Skill: local-ai-query"
Cohesion: 0.13
...
### Community 515 - "Skill: parallel-agents"
Cohesion: 0.13
...
### Community 516 - "Skill: parallel-worktrees"
Cohesion: 0.13
...
### Community 517 - "Design System: Taste Standard"
Cohesion: 0.13
...
### Community 520 - "Skill: user-research"
Cohesion: 0.13
...
### Community 521 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 522 - "Attention Mechanisms Internals"
Cohesion: 0.13
...
### Community 523 - "test_daily_2026_07_24.py"
Cohesion: 0.20
...
### Community 526 - "router/health.py"
Cohesion: 0.20
...
### Community 527 - "DockerAgentAdapter"
Cohesion: 0.17
...
### Community 528 - "TestDecisionsBotLinks"
Cohesion: 0.17
...
### Community 529 - "DecisionsStore"
Cohesion: 0.30
Nodes (3): DecisionsStore, Any, Connection

### Community 530 - "TestAgentRunnerSafety"
Cohesion: 0.16
Nodes (11): background_agent(), engine(), fixture, Path, WorkflowEngine, Contract: AgentRunner._local_safety_check must catch hardcoded secrets and…, Contract: Auth code with hardcoded SECRET_KEY triggers a safety issue. The…, Contract: Clean code without secrets passes safety check. (+3 more)
...
### Community 533 - "test_openclaw_gateway.py"
Cohesion: 0.13
...
### Community 534 - "TestOrchestratorQueue"
Cohesion: 0.13
...
### Community 535 - "test_scanner_live.py"
Cohesion: 0.23
...
### Community 537 - "analyze_quantitative"
Cohesion: 0.22
Nodes (5): analyze_quantitative(), Any, field_validator, Compute descriptive statistics for a numeric series. Args: source: Where the…, TestAnalyzeQuantitative

### Community 538 - "StopSlopChecker"
Cohesion: 0.14
...
### Community 540 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 544 - "Checks Performed"
Cohesion: 0.14
...
### Community 545 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 548 - "Skill: branch-cleanup"
Cohesion: 0.14
...
### Community 549 - "Skill: perplexity — Web Research via Perplexity API"
Cohesion: 0.14
...
### Community 552 - "Quick-Note Issues Processing Summary"
Cohesion: 0.14
...
### Community 553 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 555 - "Runbook: Auto-Resume After Cooldown / Interruption"
Cohesion: 0.14
...
### Community 556 - "SEO / GEO / AIO Audit Engine"
Cohesion: 0.14
...
### Community 557 - "Traffic Distribution Across Providers"
Cohesion: 0.14
...
### Community 566 - "test_critical_flows.py"
Cohesion: 0.29
...
### Community 567 - "test_regression.py"
Cohesion: 0.14
...
### Community 569 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 572 - "get_agency"
Cohesion: 0.21
Nodes (12): get_agency(), set_agency(), Start the 24×7 CEO agency loop that *proactively* generates work. Without this…, _start_ceo_agency(), test_singleton(), fixture, tests/test_ceo_agency_startup.py — the CEO loop must actually be started. Root…, A failure constructing/starting the CEO must not crash app startup. (+4 more)

### Community 573 - "get_tool_registry"
Cohesion: 0.22
Nodes (7): get_tool_registry(), Return the module-level ToolRegistry singleton. On first call, registers built-…, auto_register(), Register the four user-research tools with a ``ToolRegistry``. Each tool wraps…, Register the user research tools into the module-level singleton registry.…, register_user_research_tools(), TestRegistration

### Community 574 - "_TFIDFIndex"
Cohesion: 0.18
...
### Community 578 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 581 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 582 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 585 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
...
### Community 586 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 587 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 589 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 590 - "admin_update_task_router.py"
Cohesion: 0.22
...
### Community 593 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
Nodes (12): Acceptance Checks, Claude's query protocol (use this instead of Read tool for exploration):, Graph Artifacts — What to Commit, How to Use the Graph (Token Savings Protocol), Installation (one-time per machine), Instead of reading raw files:, Key commands:, Relationship to repowise-intelligence Skill (+4 more)

### Community 594 - "Skill: platform-setup — Autonomous Agency Bootstrap"
Cohesion: 0.15
...
### Community 595 - "Workspace Isolation Architecture"
Cohesion: 0.15
...
### Community 596 - "Device compatibility and model picks"
Cohesion: 0.15
...
### Community 597 - "Autonomy Uplift — Living Roadmap & Detailed Implementation Specs"
Cohesion: 0.15
...
### Community 598 - "OpenClaw — iOS Control of the Agency (Single-Service Free-Tier Deploy)"
Cohesion: 0.15
...
### Community 601 - "Agent Transparency Report"
Cohesion: 0.15
...
### Community 602 - "update_provider_policy"
Cohesion: 0.19
...
### Community 603 - "scan_repo_with_user_research.py"
Cohesion: 0.22
...
### Community 607 - "test_setup_api.py"
Cohesion: 0.23
...
### Community 608 - "test_agile_api.py"
Cohesion: 0.15
...
### Community 609 - "test_app_settings.py"
Cohesion: 0.19
...
### Community 610 - "TestModelCostTableUpdates"
Cohesion: 0.26
...
### Community 611 - "test_deploy_trigger_covers_image.py"
Cohesion: 0.21
...
### Community 612 - "TestRuntimeControl"
Cohesion: 0.15
...
### Community 613 - "TestKillSwitchDurability"
Cohesion: 0.15
...
### Community 614 - "WorkspaceManifest"
Cohesion: 0.17
...
### Community 616 - "skill_registry.py"
Cohesion: 0.17
...
### Community 622 - "Skill: system-prompt-audit"
Cohesion: 0.17
...
### Community 623 - "Skill: task-alive-updates"
Cohesion: 0.17
...
### Community 628 - "14. Standing Instructions — Universal Agent Discipline"
Cohesion: 0.17
...
### Community 629 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 632 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 634 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 635 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 636 - "Quantization Internals"
Cohesion: 0.17
...
### Community 637 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 638 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 639 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 643 - "test_p0_roadmap_a4_a5_b2.py"
Cohesion: 0.26
...
### Community 644 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 645 - "TestAuthAndTaskCreation"
Cohesion: 0.17
...
### Community 646 - "test_providers_live_e2e.py"
Cohesion: 0.27
...
### Community 647 - "test_skill_registry.py"
Cohesion: 0.20
...
### Community 648 - "TestAnthropicPayloadStructuredOutput"
Cohesion: 0.29
...
### Community 652 - "_extractive_compress"
Cohesion: 0.18
...
### Community 655 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 658 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 659 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 661 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 664 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 665 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 666 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 667 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 668 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 669 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 670 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 671 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 673 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 674 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 675 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 676 - "CI Troubleshooting Runbook"
Cohesion: 0.18
...
### Community 677 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 678 - "What to clean up"
Cohesion: 0.18
...
### Community 679 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 680 - "test_bedrock_live.py"
Cohesion: 0.25
...
### Community 683 - "test_scanner_ssl_cert.py"
Cohesion: 0.25
...
### Community 685 - "TestBackgroundAgentDispatch"
Cohesion: 0.24
...
### Community 688 - "test_event_log.py"
Cohesion: 0.45
...
### Community 689 - "test_google_provider_models.py"
Cohesion: 0.18
...
### Community 690 - "test_tasks_awaiting_approval_api.py"
Cohesion: 0.40
...
### Community 693 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 694 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 695 - "CLAUDE.md — Master Architect Operating Manual"
Cohesion: 0.20
...
### Community 696 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 697 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 698 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 699 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 700 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 701 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 702 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 703 - "Agent Readiness Report"
Cohesion: 0.20
...
### Community 705 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 706 - "LLM Router — configuration guide"
Cohesion: 0.20
...
### Community 707 - "LLM Router — provider guide"
Cohesion: 0.20
...
### Community 717 - "test_bootstrap_source_id_index.py"
Cohesion: 0.27
...
### Community 718 - "TestExtendedThinkingRouting"
Cohesion: 0.20
...
### Community 719 - "TestZeroAttemptDiagnostics"
Cohesion: 0.29
...
### Community 720 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 721 - "test_provider_state_durability.py"
Cohesion: 0.20
...
### Community 722 - "test_quick_note_engine.py"
Cohesion: 0.22
...
### Community 726 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 730 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 732 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 733 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 734 - "Skill: changelog-enforcer"
Cohesion: 0.22
Nodes (8): Acceptance Checks, Changelog Location, Entry Format, Examples, Hook Behaviour, Instructions, Skill: changelog-enforcer, When to Use

### Community 735 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
Nodes (8): Branch, Components, Purpose, Quick Start, Session Roles, Skill: cowork-session (Claude Cowork), Testing, When to Use

### Community 736 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 738 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 739 - "Main proxy (`proxy.py`)"
Cohesion: 0.22
...
### Community 740 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 741 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 742 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 743 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 744 - "Release Procedure"
Cohesion: 0.22
...
### Community 745 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 753 - "enrich_quick_note_issues.py"
Cohesion: 0.42
...
### Community 754 - "_status_snapshot"
Cohesion: 0.31
...
### Community 756 - "test_shared_state.py"
Cohesion: 0.31
...
### Community 760 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 761 - "test_changelog_parity_guard.py"
Cohesion: 0.22
...
### Community 764 - "TestChatFallbackAndApproval"
Cohesion: 0.22
...
### Community 767 - "TestGithubSignalHardening"
Cohesion: 0.22
...
### Community 769 - "TestPaidPolicyDurability"
Cohesion: 0.22
...
### Community 770 - "test_scanner_deps_parity.py"
Cohesion: 0.31
...
### Community 771 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.22
...
### Community 773 - "navigation_metrics.py"
Cohesion: 0.32
...
### Community 777 - "quality_checker.py"
Cohesion: 0.32
...
### Community 779 - "_build_direct_chat_schedule_suggestion"
Cohesion: 0.32
...
### Community 780 - "TestParseToolCalls"
Cohesion: 0.39
...
### Community 791 - "AGENTS.md — AI Agent Configuration for local-llm-server"
Cohesion: 0.25
...
### Community 792 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 793 - "ceo-micromanagement.md"
Cohesion: 0.25
Nodes (4): P0 behavior change, Readiness contract, Runtime model, Runtime types

### Community 794 - "Feature Maturity / Support Matrix"
Cohesion: 0.25
...
### Community 797 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.25
...
### Community 798 - "Issue #362: Nvidia repo setup"
Cohesion: 0.25
...
### Community 799 - "Issue #364: quick-note:https://www.marktechpost.com/2026/06/01/meet-memory-os-a-6-layer-open-source-memory-stack-built-on-top-of-hermes-agent/"
Cohesion: 0.25
...
### Community 800 - "Issue #378: quick-note:https://www.marktechpost.com/2026/06/02/tinyfish-launches-bigset-an-open-source-multi-agent-system-that-builds-structured-live-datasets-from-plain-english-descriptions/"
Cohesion: 0.25
...
### Community 801 - "Issue #379: quick-note:https://searchengineland.com/schema-markup-optimize-agentic-web-479080"
Cohesion: 0.25
...
### Community 802 - "Issue #380: quick-note:https://cursor.com/blog/cloud-agent-lessons"
Cohesion: 0.25
...
### Community 803 - "Issue #381: quick-note:https://www.xda-developers.com/claude-code-with-opus-48-is-expensive-but-i-made-it-efficient-with-my-local-ai-workflow/"
Cohesion: 0.25
...
### Community 804 - "Issue #382: quick-note:https://claude.com/blog/how-coderabbit-used-claude-to-build-an-agent-orchestration-system"
Cohesion: 0.25
...
### Community 805 - "Issue #383: quick-note:https://www.marktechpost.com/2026/05/29/hexo-labs-open-sources-sia-a-self-improving-agent-that-updates-both-the-harness-and-the-model-weights/"
Cohesion: 0.25
...
### Community 806 - "Issue #416: feat: Self-hosted Codebuff (freebuff) on free NVIDIA models + Telegram bot phone control"
Cohesion: 0.25
...
### Community 807 - "Issue #485: [Trend Digest] Week of 2026-06-08"
Cohesion: 0.25
...
### Community 808 - "Issue #488: quick-note:https://github.com/cookiy-ai/user-research-skill"
Cohesion: 0.25
...
### Community 809 - "Issue #491: Implement whatever is necessary from https://github.com/BehiSecc/awesome-claude-skills"
Cohesion: 0.25
...
### Community 810 - "Issue #493: Use the https://github.com/mvanhorn/last30days-skill skill to get the trend updated"
Cohesion: 0.25
...
### Community 811 - "Issue #495: Read https://www.anthropic.com/news/claude-fable-5-mythos-5 and understand if mythos or fable can be added to the repo"
Cohesion: 0.25
...
### Community 812 - "Issue #504: EPIC: Autonomy hardening — live-verified defects 2026-06-10"
Cohesion: 0.25
...
### Community 813 - "Issue #581: Sprint tracker: pending work after brand rename + mobile-first pass"
Cohesion: 0.25
...
### Community 815 - "Issue #657: quick-note:https://github.com/earendil-works/pi"
Cohesion: 0.25
...
### Community 816 - "Issue #659: quick-note:https://github.com/nex-agi/Nex-N2"
Cohesion: 0.25
...
### Community 817 - "Issue #660: quick-note:https://github.com/getsentry/sentry-for-ai"
Cohesion: 0.25
...
### Community 818 - "Issue #661: quick-note:https://github.com/XiaomiMiMo/MiMo-Code"
Cohesion: 0.25
...
### Community 819 - "Issue #664: quick-note:https://github.com/Grominet95/jarvis-OS"
Cohesion: 0.25
...
### Community 820 - "Issue #666: quick-note:https://github.com/porokka/jarvis-os"
Cohesion: 0.25
...
### Community 821 - "Issue #670: quick-note:https://github.com/perplexityai/bumblebee"
Cohesion: 0.25
...
### Community 822 - "Issue #672: quick-note:https://github.com/Chachamaru127/claude-code-harness"
Cohesion: 0.25
...
### Community 823 - "Issue #676: quick-note:https://github.com/WeiboAI/VibeThinker"
Cohesion: 0.25
...
### Community 824 - "Issue #820: quick-note:https://github.com/cobusgreyling/loop-engineering"
Cohesion: 0.25
...
### Community 825 - "Positional Encoding Internals"
Cohesion: 0.25
...
### Community 827 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 828 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 829 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 830 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 833 - "_get_current_user"
Cohesion: 0.29
...
### Community 835 - "capture_screens.py"
Cohesion: 0.39
...
### Community 838 - "crispy_burn_in.py"
Cohesion: 0.36
...
### Community 839 - "run_patched_colibri.py"
Cohesion: 0.36
...
### Community 842 - "test_agent_tools.py"
Cohesion: 0.43
...
### Community 843 - "test_compose_and_coordinate_api.py"
Cohesion: 0.36
...
### Community 845 - "TestProviderRouter"
Cohesion: 0.25
...
### Community 846 - "test_local_brain_router_smoke.py"
Cohesion: 0.25
...
### Community 848 - "test_provider_models_db_outage.py"
Cohesion: 0.25
...
### Community 852 - "test_serve_spa_prefixes.py"
Cohesion: 0.36
...
### Community 854 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 855 - ".discover_directory"
Cohesion: 0.29
...
### Community 862 - "4. Current Architecture (As-Is)"
Cohesion: 0.29
...
### Community 863 - "AI Engineering Insights Skill"
Cohesion: 0.29
...
### Community 873 - "ADR-006: Strangler Fig migration with backward-compat shims"
Cohesion: 0.29
Nodes (6): ADR-006: Strangler Fig migration with backward-compat shims, Consequences, Context, Decision, Examples, Migration path

### Community 874 - "claude-mem Plugin — Persistent Memory for All Sessions"
Cohesion: 0.29
...
### Community 875 - "Implementation plan + TO-DO (check off as you go)"
Cohesion: 0.29
...
### Community 889 - "test_daily_2026_06_14.py"
Cohesion: 0.38
...
### Community 890 - "TestSupportMatrixDocsSync"
Cohesion: 0.29
...
### Community 891 - "TestGithubTokenSQLiteRegression"
Cohesion: 0.38
...
### Community 893 - "test_log_monitor_storm_guard.py"
Cohesion: 0.48
...
### Community 899 - "memory_consolidation.py"
Cohesion: 0.40
...
### Community 900 - "openclaw_mobile_ui"
Cohesion: 0.33
...
### Community 901 - ".create_company"
Cohesion: 0.40
Nodes (4): BusinessCategory, Company, List companies with optional filtering. Args: owner_id: Filter by owner ID…, Create a new company (idempotent — returns existing if domain matches). Checks…

### Community 902 - "/fix-bug — Bug Fix Agent"
Cohesion: 0.33
Nodes (5): Escalation, /fix-bug — Bug Fix Agent, Process, Rules, Usage

### Community 903 - "Command: /plan"
Cohesion: 0.33
Nodes (5): Command: /plan, References, Usage, What It Does, When to Use

### Community 904 - "pre-commit"
Cohesion: 0.60
Nodes (5): pre-commit script, _error(), _head(), _info(), _warn()

### Community 905 - "Skill: browserbase-fetch — Lightweight Web Fetch"
Cohesion: 0.33
...
### Community 916 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 917 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 918 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 919 - "The full agent capability roster"
Cohesion: 0.33
...
### Community 920 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 921 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 922 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 927 - "apply_phase1_changes.py"
Cohesion: 0.33
...
### Community 934 - "setup-claude-code.sh script"
Cohesion: 0.60
Nodes (5): log_error(), log_info(), log_success(), print_header(), setup-claude-code.sh script

### Community 937 - "test_generate_context_standing_instructions.py"
Cohesion: 0.40
...
### Community 958 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 959 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 960 - "Runtime troubleshooting"
Cohesion: 0.40
Nodes (4): Agent mode timeout, Missing binary / task harness, Runtime troubleshooting, Workspace validation failures

### Community 961 - "knowledgeGraphTab.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 962 - "loginFlowNoTimeout.test.js"
Cohesion: 0.40
Nodes (4): apiSource, { describe, test, expect }, fs, path

### Community 963 - "test_company_stale_id_recovery.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 964 - "worker_no_cache.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, workerSource

### Community 965 - "scripts/agile_ceremonies.py"
Cohesion: 0.70
...
### Community 967 - "Prompt Library Changelog"
Cohesion: 0.40
...
### Community 969 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 970 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 971 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 972 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 973 - "setup_colibri.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 974 - "setup_colibri.sh script"
Cohesion: 0.70
Nodes (4): setup_colibri.sh script, fail(), ok(), warn()

### Community 975 - "status_colibri_server.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 977 - "TestMobileNavigation"
Cohesion: 0.40
Nodes (3): Mobile-specific: hamburger menu, responsive layout., Verify key pages load in mobile viewport., TestMobileNavigation

### Community 978 - "test_v5_screens_smoke.py"
Cohesion: 0.50
...
### Community 979 - "test_agent_runtime_wrapper.py"
Cohesion: 0.70
...
### Community 1012 - "test_no_exception_detail_leaks.py"
Cohesion: 0.50
...
### Community 1013 - "test_skills_route_order.py"
Cohesion: 0.67
...
- **Why does `AgentRunner` connect `AgentRunner` to `ReactScratchpad`, `ProviderConfig`, `backend/server.py`, `ChatSendRequest`, `FreeBuffAgent`, `proxy.py`, `TaskSpec`, `ai/router.py`, `test_ceo_dispatcher.py`, `MCPUnavailableError`, `TestAgentRunnerSafety`, `direct_chat.py`, `WorkflowRun`, `E2BSandboxSession`, `AgentSessionStore`, `resolve_active_brain`, `Artifact`, `failover_chat_completion`, `MCPClient`, `MultiAgentSwarm`, `TestBackgroundAgentDispatch`, `test_empirical_verify.py`, `LocalWorkspace`, `failover_client.py`, `CEODispatcher`, `TestWorkspace`, `AgentPlan`, `ContextPruner`, `AutonomyTracker`, `TokenBudget`, `ExecutionRequest`, `_FakeAsyncClient`, `GitHubTools`, `TestZeroAttemptDiagnostics`, `_resolve_push_token`, `WorkflowBuildRequest`, `test_daily_automation_2026_07_11.py`, `loop.py`, `StuckDetector`, `._execute_step`, `test_backend_server_features.py`, `AdaptiveHalter`, `ContextManager`, `test_agent_chat_integration.py`, `diagnostics.py`, `_StubManager`, `WorkspaceTools`?**
  _High betweenness centrality (0.069) - this node is a cross-community bridge._
- **Why does `TaskStore` connect `Task` to `test_task_source_id_race.py`, `backend/server.py`, `test_issue_intake.py`, `test_self_heal_v2.py`, `BrainWatchdog`, `test_sqlite_store.py`, `test_portfolio_intake.py`, `test_tasks_awaiting_approval_api.py`, `TaskDispatcher`, `test_trend_scoping.py`, `tasks/api.py`, `services/background.py`, `test_phase6_workflow.py`, `AgentPlan`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `get_agent_bus()` connect `AgentMessageBus` to `loop.py`, `test_p0_roadmap_a4_a5_b2.py`, `._execute_step`?**
