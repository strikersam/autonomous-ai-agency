# Graph Report - local-llm-server  (2026-09-22)

## Corpus Check
- 1531 files · ~2,230,723 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 54 file(s) not represented in the graph (top: (none) 16, .bat 5, .css 5)

## Summary
- 32366 nodes · 59683 edges · 1343 communities (1173 shown, 170 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 3755 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `46fc96ac`
...
## Communities (1343 total, 170 thin omitted)

### Community 0 - "backend/server.py"
Cohesion: 0.02
Nodes (196): admin_seed(), AgentStatusEntry, AgentStatusResponse, AgentToolCallEntry, ApiKeyCreate, AuthorizeReposBody, BrainTestRequest, _build_agent_status_snapshot() (+188 more)

### Community 1 - "test_ceo_dispatcher.py"
Cohesion: 0.03
Nodes (102): CEOResult, _complexity_rank(), _decompose_into_subtasks(), _merge_changed_files(), Reset the singleton (test helper)., Aggregated output from a multi-specialist execution., Decompose a request into 2-3 sub-tasks for specialist fan-out. Default…, Build a single-task sub-task list (low-complexity fast path). (+94 more)

### Community 2 - "test_provider_router.py"
Cohesion: 0.05
...
Cohesion: 0.02
Nodes (181): account_lifecycle(), AccountLifecycleResponse, auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint(), _DoctorCheck, _DoctorReport (+173 more)

### Community 4 - "brain_config.py"
Cohesion: 0.02
Nodes (131): Call-time resolver for an agent role model id. Delegates to…, _resolve_role_model(), _brain_provider_status(), _migrate_brain_to_safe_default(), Return per-provider metadata for the GET endpoint. Iterates every provider in…, Return the discovered model list for *provider_id*, or ``[]`` if unknown., _served_models(), _active_primary_provider() (+123 more)

### Community 5 - "build_llm_router"
Cohesion: 0.05
Nodes (55): Catalog entries for router-configured providers missing from the YAML. Never…, get_budget(), The process-wide budget tracker., get_cache(), The process-wide cache manager., gateway_enabled(), get_config(), Return the process-wide configuration, loading it on first use. (+47 more)

### Community 6 - "test_portfolio_intake.py"
Cohesion: 0.07
Nodes (38): Issue title: the failure mode plus how hard it is recurring., fetch_research_alerts(), Best-effort fetch of trend alerts. Returns [] if offline or unavailable., Weighted Shortest Job First score — higher schedules sooner., map_initiative_to_task(), materialize_committed(), _wsjf(), _portfolio_materialize_enabled() (+30 more)

### Community 7 - "_hostname_matches"
Cohesion: 0.15
Nodes (11): _content_contains_domain(), _hostname_contains(), _hostname_matches(), Scan a Git repository and detect its technology stack. Args: repo_url: URL of…, Detect the Git provider from a repository URL. Args: repo_url: Repository URL…, Check if a URL or hostname exactly matches or is a subdomain of any domain.…, Infer stack from repository URL (basic detection). Args: repo_url: Repository…, Check if URL hostname exactly matches or is a subdomain of any domain. Uses… (+3 more)

### Community 8 - "telegram_bot.py"
Cohesion: 0.06
Nodes (57): all_provider_ids(), _provider_ids_from_literal(), Return every provider id recognised by the brain config system. Iterates the…, Return the provider ids allowed by the ``BrainProvider`` Literal. Reads the…, Return a Markdown-v1-safe preview string under ``max_chars``. Used by the…, sanitize_paste_for_preview(), _admin_headers(), _api_headers() (+49 more)

### Community 9 - "test_ceo_supervision.py"
Cohesion: 0.05
Nodes (73): _harvest_changed_files(), Extract the files a runtime touched. Returns ``(files, reported)``. Adapters…, Record the goal and its sub-tasks in the ledger before any work runs. Writing…, A single sub-task delegated to a specialist., SpecialistTask, A subtask's full history: what it is, and every attempt at it., SubtaskRecord, str (+65 more)

### Community 10 - "RuntimeHealth"
Cohesion: 0.03
Nodes (91): kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, AiderAdapter, Any, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Adapter for Aider — TIER 3 specialized git-aware code editor., runtimes/adapters/claude_code.py — Claude Code CLI adapter (FIRST CLASS).…, DockerAgentAdapter (+83 more)
...
Cohesion: 0.03
Nodes (51): AgentJob, AgentJobManager, heartbeat(), make_isolated_workspace(), _now(), Any, Path, agent/job_manager.py — Async agent job lifecycle manager. Manages agent jobs… (+43 more)
...
Cohesion: 0.04
Nodes (49): Run aider non-interactively via `--message` flag., Execute a task inside a fresh E2B sandbox. Flow: 1. Open an…, _best_cloud_primary_base(), _nvidia_provider_chain(), Execute a TaskSpec using the internal AgentRunner and convert the agent's…, Build Nvidia NIM provider config from env. Empty list when key is absent., Return the highest-priority available cloud LLM base URL. Tries free cloud…, OpenCodeAdapter (+41 more)
...
### Community 17 - "test_llm_router_strategies.py"
Cohesion: 0.03
...
Cohesion: 0.03
Nodes (118): ProviderConfig, One configured endpoint. ``kind`` selects the adapter: ``openai`` (any OpenAI-…, LLMProvider, OpenAICompatible, ABC, Any, AsyncClient, Every provider adapter implements exactly this. (+110 more)

### Community 19 - "failover_client.py"
Cohesion: 0.06
...
Cohesion: 0.03
Nodes (112): _load(), main(), Scheduled portfolio intelligence sweep. Run by `.github/workflows/portfolio-…, int, failover_chat_completion_via_router(), Any, packages/llm/compat.py — backwards-compatible bridges to the legacy call paths.…, Router-backed implementation of ``packages.ai.failover_client``'s entry point.… (+104 more)

### Community 21 - "test_platform_controls.py"
Cohesion: 0.03
...
Cohesion: 0.04
Nodes (57): apply_from_db(), Load the stored overrides and apply them. Called once at startup., _await_hermes_ready(), _env_on(), Any, Path, services/background.py — shared background-service startup. Both the FastAPI…, Await the refresh and log the outcome; swallow every failure. (+49 more)

### Community 23 - "test_governance_sandbox.py"
Cohesion: 0.03
Nodes (81): events_from_identity(), Extract the identity-derived audit fields from an AgentIdentity. Kept here…, build_docker_run_argv(), detect_backend(), DockerBackend, E2BBackend, load_profiles(), LocalBackend (+73 more)

### Community 24 - "test_operational_incidents.py"
Cohesion: 0.02
...
### Community 25 - "LLMRouter"
Cohesion: 0.04
Nodes (39): get_limiter(), The process-wide distributed rate limiter., Read the environment variables named in ``env_names`` into a key list. Order is…, resolve_keys(), Whether sleeping ``delay`` still leaves time for the attempt after it., Wall-clock and attempt ceiling shared by every attempt in one request. Without…, RetryBudget, LLMRouter (+31 more)

### Community 26 - "SQLiteStore"
Cohesion: 0.03
Nodes (82): DetectedSystem, A business system detected on a company's website or in their stack., Get the most confident evidence description., Inferred technology stack from website/repo analysis., StackInference, Prepare a Pydantic model for SQLite storage., Prepare a SQLite row for Pydantic model., Create a new company in SQLite. (+74 more)

### Community 27 - "test_ceo_micromanager.py"
Cohesion: 0.04
Nodes (103): Semaphore, services/ceo_dispatcher.py — Real CEO delegation layer. The CEO splits a…, Split the request into briefed, tier-assigned specialist sub-tasks. Returns the…, Run one sub-task, judge the result, and escalate it if it is slop. The loop is…, build_subtask_brief(), _coerce_subtasks(), decompose(), _env_flag() (+95 more)

### Community 28 - "test_loop_registry.py"
Cohesion: 0.05
Nodes (64): audit_drift(), _cmd_audit(), DriftReport, _grade(), load_registry(), load_registry_sync(), loop_readiness(), LoopRegistry (+56 more)

### Community 29 - "TestRuntimeControl"
Cohesion: 0.04
...
### Community 30 - "_start_ceo_agency"
Cohesion: 0.27
...
Cohesion: 0.03
Nodes (44): SpecialistFamily, Find all specialists of a specific family., Find specialists that can handle a task with given capabilities., A specialist agent that can be provisioned for company-specific tasks., Check if this specialist can handle a task with given capabilities., Specialist, Get a specialist by ID., Create a new specialist. (+36 more)

### Community 33 - "test_runtimes.py"
Cohesion: 0.03
Nodes (40): Run ``pytest`` inside the sandbox. Returns ``(output, passed)``.…, runtimes/health.py — RuntimeHealthService. Periodically polls all registered…, Any, runtimes/manager.py — RuntimeManager., Return health status for all registered runtimes., Return routing decision audit log (newest first)., Actively wake every sleeping/circuit-open runtime. The default health service…, True if the runtime is healthy enough for the router to select it. (+32 more)

### Community 34 - "Settings"
Cohesion: 0.02
Nodes (92): CatalogActiveBrain, CatalogMirror, CatalogProviderEntry, _include_router_providers(), invalidate_catalog_cache(), ModelCatalogStore, Any, BaseModel (+84 more)

### Community 35 - "TaskStatus"
Cohesion: 0.03
Nodes (126): Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., tasks — Task/issue management system. Provides a lightweight task/issue tracker…, _coerce_ts(), Enum, str, tasks/models.py — Pydantic models for the task/issue system., Coerce ISO-8601 datetime strings (from DB) to float timestamps. (+118 more)
...
### Community 38 - "test_failover_client_shared.py"
Cohesion: 0.06
...
### Community 40 - "Task"
Cohesion: 0.03
Nodes (82): Full task/issue document., Task, _gate_outward_facing_enabled(), _is_brain_connection_error(), _is_outward_facing(), Any, BaseException, One-line human explanation of why this task needs human approval. Reads risk… (+74 more)

### Community 41 - "E2BSandboxSession"
Cohesion: 0.04
Nodes (70): MCPUnavailableError, RuntimeError, agent/mcp_client.py — Async MCP client for the mcp-server Docker container.…, Raised when the MCP server is unreachable or the circuit is open., E2BSandboxSession, _inject_token(), maybe_attach_e2b(), Any (+62 more)

### Community 42 - "UserRole"
Cohesion: 0.06
Nodes (58): UserRole, _can_read(), _can_write(), create_secret(), _decrypt(), delete_secret(), _encrypt(), _get_master_key() (+50 more)

### Community 43 - "test_model_router.py"
Cohesion: 0.03
...
### Community 44 - "get_improvement_loop"
Cohesion: 0.05
Nodes (66): get_improvement_loop(), _dispatch_async(), _run(), _ErrorCaptureHandler, get_log_monitor(), LogMonitor, _note_recurrence(), Any (+58 more)

### Community 45 - "test_ceo_router.py"
Cohesion: 0.04
Nodes (72): build_ceo_router(), ceo_status(), get_goal(), list_goals(), redrive_goal(), run_sweep(), Any, APIRouter (+64 more)

### Community 46 - "PolicyEngine"
Cohesion: 0.04
Nodes (77): _action_matches(), _as_list(), Decision, GroupPolicy, _host_matches(), Mode, _normalise_path(), _path_matches() (+69 more)

### Community 47 - "test_phase6_workflow.py"
Cohesion: 0.04
...
### Community 50 - "Render MCP — autonomous platform debugging and environment monitoring"
Cohesion: 0.14
...
### Community 55 - "brain_liveness.py"
Cohesion: 0.10
Nodes (18): _is_dns_failure(), _probe_failure_reason(), _probe_ollama(), BaseException, services/brain_liveness.py — Provider liveness prober for the brain switcher.…, Turn a probe exception into an operator-actionable one-line reason. A dead…, True when *exc* (or anything it wraps) is a name-resolution failure., Probe local Ollama via GET /api/tags (cheap) then a 5-token completion. (+10 more)

### Community 56 - "test_agent_tool_governance.py"
Cohesion: 0.07
Nodes (50): Replace the process-wide store. Tests only., reset_approval_store(), Replace the process-wide audit log. Tests only., reset_audit_log(), Replace the process-wide engine. Tests only., reset_policy_engine(), _drive(), _enforce() (+42 more)

### Community 57 - "test_mcp_registry.py"
Cohesion: 0.05
Nodes (32): Measure one server. Never raises — a probe failure is a status, not an error., Measure every declared server concurrently and return dashboard rows. Probes…, status_all(), _status_for(), _noop_async(), Any, asyncio, tests/test_mcp_registry.py — the single MCP catalogue and the screen it backs.… (+24 more)

### Community 58 - "validate_policy_text"
Cohesion: 0.05
Nodes (37): _audit_proposal(), _baseline_loosened(), _baseline_patterns(), diff_policy(), _GitHub, parse_policy_text(), _pr_body(), _proposal_branch_name() (+29 more)

### Community 59 - "CompanyGraphStore"
Cohesion: 0.02
Nodes (73): BusinessCategory, KnowledgeItem, Find a repository by its URL., Structured knowledge about the company, systems, or processes., A company website with detected systems and stack inference., A company repository with detected technologies and metadata., Extract the owner from the full name., Extract the repository name from the full name. (+65 more)

### Community 60 - "test_slop_gate.py"
Cohesion: 0.07
...
### Community 61 - "test_minimax_bug_fixes.py"
Cohesion: 0.13
...
### Community 64 - "redact_connection_url"
Cohesion: 0.17
...
Cohesion: 0.07
Nodes (34): plan_next_sprint(), The result of allocating portfolio capacity into a new sprint., Allocate ``capacity`` of WSJF-ranked initiatives into a new sprint. Creates one…, SprintPlan, Roadmap placement for an initiative (Now/Next/Later planning)., RoadmapHorizon, build_seo_roadmap(), delegation_plan_to_initiatives() (+26 more)

### Community 66 - "setup/api.py"
Cohesion: 0.05
Nodes (75): audit(), Append an audit log entry. Never logs raw secrets — only secret IDs / masked…, clear_wizard_state_cache(), complete_wizard(), _delete_wizard_state(), detect_configured_providers(), detect_hardware_for_wizard(), detect_models_for_wizard() (+67 more)

### Community 67 - "MongoDBStore"
Cohesion: 0.04
Nodes (43): MongoDBStore, Any, ObjectId, MongoDB implementation of the Company Graph store. Uses Motor (async MongoDB…, Get or create the MongoDB database connection., Convert string ID to ObjectId., Convert ObjectId to string., Prepare a Pydantic model for MongoDB storage. (+35 more)

### Community 68 - "agent/workspace.py"
Cohesion: 0.06
Nodes (39): _get_workspace_lock(), _hash_component(), _iso_now(), _iso_offset_hours(), _load_workspace(), Any, BaseModel, Enum (+31 more)

### Community 69 - "PortfolioManager"
Cohesion: 0.05
Nodes (29): CapacityAllocation, PortfolioManager, PortfolioMetrics, Result of fitting initiatives into a fixed capacity by WSJF priority., Total job size of initiatives that fit within capacity., Unused capacity after committing the selected initiatives., Fraction of capacity consumed (0.0–1.0)., Aggregate metrics across the whole portfolio. (+21 more)

### Community 70 - "enforcement.py"
Cohesion: 0.06
Nodes (44): _do_run_agent_job(), _run_agent_job(), wait_for_resume(), BudgetExceeded, classify(), evaluate_call(), guard_tool_call(), GuardResult (+36 more)

### Community 71 - "RenderOpsMonitor"
Cohesion: 0.08
Nodes (25): BaseModel, Response shape of ``GET /api/render/ops/status``. Declared here rather than in…, RenderOpsStatus, One deploy, normalised from whatever shape the tool returned., RenderDeploy, Polls Render for platform-level failures and files them as issues., RenderOpsMonitor, _FakeRender (+17 more)

### Community 72 - "get_runtime_manager"
Cohesion: 0.05
...
### Community 74 - "Agency"
Cohesion: 0.03
Nodes (114): Agency, AgencyCycleResult, AgentDirective, AgentRole, _build_ceo_prompt(), _build_quick_note_instruction(), _close_github_issue(), _collect_recent_git_context() (+106 more)

### Community 75 - "services/seo_audit.py"
Cohesion: 0.05
Nodes (50): field_validator, A single occurrence of a check firing on a specific URL., Site-level facts discovered during the crawl., Request to run an SEO/GEO/AIO audit against a website., SeoAuditRequest, SeoIssueInstance, SeoSiteFindings, _count_syllables() (+42 more)
...
### Community 79 - "RepowiseIntelligence"
Cohesion: 0.06
...
### Community 80 - "test_force_cleanup_conditional_delete.py"
Cohesion: 0.10
...
### Community 81 - "portfolio_intelligence.py"
Cohesion: 0.06
...
### Community 84 - "get_task_store"
Cohesion: 0.05
Nodes (66): _purge_backlog_core(), quick_notes_submit(), _QuickNoteBody, Shared purge implementation for the admin endpoint and the boot hook., Submit a quick-note URL or instruction from the dashboard FAB., Reset the singleton (for tests)., reset_failover_manager(), _blocked_retire_age_sec() (+58 more)

### Community 85 - "provider_max_rpm"
Cohesion: 0.09
...
### Community 86 - "test_render_mcp.py"
Cohesion: 0.08
...
### Community 87 - "Agent Governance Guide"
Cohesion: 0.09
...
### Community 90 - "ModelRouter"
Cohesion: 0.06
Nodes (27): ModelRouter, Any, Central model router. Create one instance (use ``get_router()``). ``route()``…, Decide which Ollama model to use for this request. Args: requested_model: Model…, Return *model* if it is available in Ollama, else the first available fallback.…, Full record of a routing decision — both what was chosen and why. Fields:…, Build an ordered list of alternative models to try if *primary* fails., Flat dict suitable for Langfuse observation metadata. (+19 more)

### Community 91 - "LlmProviderConfig"
Cohesion: 0.13
...
### Community 93 - "models/seo_audit.py"
Cohesion: 0.11
Nodes (19): Root directory under which repo fixes are allowed to operate., Run the repo-aware auto-fixer against this company's workspace checkout.…, run_seo_fixes(), _workspace_root(), FsPath, models/seo_audit.py - SEO / GEO / AIO Audit Contracts Typed Pydantic models for…, Request to remediate auto-fixable findings in a local code repository., Result of a fixer run. (+11 more)

### Community 94 - "test_runtime_governance.py"
Cohesion: 0.11
...
### Community 98 - "test_all_providers_discovery.py"
Cohesion: 0.17
...
### Community 102 - "_autonomy_bg_cycle"
Cohesion: 0.12
Nodes (17): _autonomy_bg_cycle(), autonomy_status(), Background CEO cycle + task dispatch. Runs fire-and-forget., Public autonomy readiness probe — no authentication required. A live deploy…, _find_self_company(), _list_companies_safe(), List companies, skipping any that fail to deserialize. A previous deploy wrote…, Return the existing self company (matched by domain), or None. (+9 more)

### Community 103 - "test_north_mini_code.py"
Cohesion: 0.10
...
### Community 105 - "resolve_e2b_config"
Cohesion: 0.05
...
### Community 108 - "PersistentMemoryStore"
Cohesion: 0.07
...
### Community 109 - "test_sam_voice.py"
Cohesion: 0.07
...
### Community 110 - "TestRecordUsageAndStats"
Cohesion: 0.05
...
### Community 111 - "OnboardingScreen.jsx"
Cohesion: 0.04
...
### Community 112 - "test_provider_state_durability.py"
Cohesion: 0.09
...
Cohesion: 0.04
Nodes (81): PreflightIssue, PreflightReport, Any, BaseModel, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, Translate technical preflight issues into a conversational assistant reply., translate_error_to_conversational(), AcceptedJob (+73 more)

### Community 115 - "V5App.jsx"
Cohesion: 0.05
Nodes (36): API, getAccountLifecycle(), getDefaultBackendUrl(), getMe(), login(), logout(), App(), AppRoutes() (+28 more)

### Community 116 - "test_bedrock_provider.py"
Cohesion: 0.07
...
### Community 117 - "test_control_plane_api.py"
Cohesion: 0.06
...
### Community 118 - "test_sam_livekit.py"
Cohesion: 0.04
Nodes (67): auth_headers(), livekit_env(), no_livekit_env(), _normalize_dockerfile(), parametrize, tests/test_sam_livekit.py — SAM realtime voice (LiveKit) integration. Covers: -…, Empty key/secret/identity/room must raise ValueError., SAM_LLM_* env vars must override the NVIDIA defaults (Hermes/proxy routing). (+59 more)

### Community 119 - "TokenBudget"
Cohesion: 0.05
...
### Community 120 - "REWRITE_PLAN.md — Phased Migration Strategy"
Cohesion: 0.06
...
### Community 125 - "AgentRunner"
Cohesion: 0.03
Nodes (78): AgentRunner, _run(), _check_extra_kwargs(), _enforce_signature(), Any, Raise TypeError if fn's signature drifts from the locked contract (Pydantic…, Raise TypeError on unknown kwarg (runtime extra='forbid' for non-Pydantic…, Governance seam: judge the call, run it, audit the outcome. Deliberately a thin… (+70 more)

### Community 126 - "test_integration_c4_c5_c6_d3.py"
Cohesion: 0.06
...
### Community 127 - "TestAddConversationCacheBreakpoints"
Cohesion: 0.05
...
### Community 128 - "test_telegram_approval_e2e.py"
Cohesion: 0.12
...
### Community 135 - "Company"
Cohesion: 0.07
Nodes (15): Company, Any, field_validator, The core company entity - root of the Company Graph., Coerce unrecognised system_type values to 'custom' so the model never crashes…, Test Company Graph Pydantic models., Test that all Company Graph models can be imported., Test Company model creation. (+7 more)

### Community 136 - "AdaptiveHalter"
Cohesion: 0.08
...
### Community 138 - "SeoCheckDefinition"
Cohesion: 0.11
...
### Community 140 - "ChatHistoryStore"
Cohesion: 0.07
...
### Community 142 - "test_sqlite_store.py"
Cohesion: 0.06
...
### Community 144 - "PatternConsolidation"
Cohesion: 0.10
...
### Community 149 - "test_brain_failover.py"
Cohesion: 0.10
...
### Community 150 - "test_llm_router_e2e.py"
Cohesion: 0.09
...
### Community 151 - "test_trend_watcher.py"
Cohesion: 0.06
...
### Community 154 - "test_web_reach.py"
Cohesion: 0.05
...
### Community 155 - "1. Capability-by-capability"
Cohesion: 0.10
...
### Community 158 - "ProviderRouter"
Cohesion: 0.05
Nodes (32): _exponential_backoff_cooldown(), _notify_watchdog(), _ollama_reasoning_effort(), ProviderAttempt, ProviderRouter, Any, Try all models for one provider. Returns ProviderResult on success, None on…, Notify the brain watchdog of a provider call outcome (fire-and-forget).… (+24 more)

### Community 159 - "gsap.min.js"
Cohesion: 0.06
Nodes (15): ia(), ie(), ja(), Mc(), Nd(), oa(), Oc(), Od() (+7 more)

### Community 160 - "Configuration Reference"
Cohesion: 0.06
...
### Community 163 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 165 - "test_autonomous_agency_e2e.py"
Cohesion: 0.03
Nodes (64): BackgroundAgent, heartbeat(), BackgroundTask, _now(), Any, agent/background.py — Background Agent An always-on worker thread that…, Enqueue *task* for processing. Returns the task (with task_id set)., Convenience: create a task and submit it in one call. (+56 more)

### Community 166 - "BrowserSession"
Cohesion: 0.05
...
### Community 167 - "test_trend_scoping.py"
Cohesion: 0.10
...
### Community 169 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
Cohesion: 0.09
Nodes (38): BaseModel, Aggregated report row - Screaming Frog CSV compatible., An agent-delegable remediation work package derived from the findings. Findings…, Complete result of one audit run., SeoAuditReport, SeoDelegationTask, SeoIssueReportRow, Paragraph (+30 more)
...
### Community 174 - "AnthropicProvider"
Cohesion: 0.07
Nodes (28): openai_body_from_response(), Render an ``LLMResponse`` as an OpenAI chat-completions body. Used by the…, AnthropicProvider, Any, AsyncClient, Translate OpenAI-shaped messages into Anthropic's system/turn split., OpenAI carries a tool result as role="tool" with a tool_call_id; Anthropic…, OpenAI puts a tool call alongside the assistant's text; Anthropic needs… (+20 more)

### Community 175 - "TestEstimateTokensForMessages"
Cohesion: 0.05
...
### Community 177 - "run_task"
Cohesion: 0.06
Nodes (35): Resolve the model id to force for a code-execution run, or ``None``. Returns…, resolve_coding_model_preference(), _check_auth(), health(), Any, BaseModel, get, post (+27 more)

### Community 178 - "test_issue_intake.py"
Cohesion: 0.07
Nodes (49): autonomy_tick(), Execute ONE pending task synchronously. Called by the cron workflow every 2…, _capability_tags(), create_task_from_oldest_open_issue(), intake_issue(), _issue_labels(), issue_source_id(), map_issue_to_task() (+41 more)

### Community 179 - "WorkflowBuildRequest"
Cohesion: 0.08
Nodes (29): engine(), Contract: WorkflowEngine cannot skip the gate state machine., Contract: No code path may advance past awaiting_approval unless gate.status ==…, Create a run and manually place it in awaiting_approval., Contract: Cannot approve a run in 'pending' state., Contract: Can approve a run in 'awaiting_approval' state., Contract: Rejecting a run marks it as failed., TestApprovalGateMandatory (+21 more)

### Community 180 - "anthropic_compat.py"
Cohesion: 0.08
...
### Community 181 - "test_response_cache.py"
Cohesion: 0.12
...
### Community 183 - "ContextWindowManager"
Cohesion: 0.08
...
### Community 188 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 189 - "test_executive_advisory.py"
Cohesion: 0.09
...
### Community 190 - "Platform Guide — the full tour"
Cohesion: 0.03
Nodes (59): 1. Clone and install, 2026-06-16, 2026-06-25, 2026-06-26, 2026-07-04, 2026-07-05, 2026-07-09, 2. Configure (+51 more)

### Community 191 - "BrainFailoverExhausted"
Cohesion: 0.06
Nodes (26): BrainFailoverExhausted, RuntimeError, Every provider in the failover chain failed — the terminal error. Carries the…, Paid-tier providers admitted to the chain and not yet attempted. Empty when the…, _untried_paid(), _FM, _P, Regression tests for a chain that fails silently. From a real incident:… (+18 more)

### Community 192 - "test_governance_api.py"
Cohesion: 0.04
Nodes (72): AuditEvent, AuditLog, get_audit_log(), Any, packages/governance/audit.py — the evidence trail for every governed action.…, Redact SSNs and Luhn-valid payment-card numbers from a string. Runs after the…, Redact secret-shaped substrings, then truncate., One governed action, fully described. Field order follows the… (+64 more)
...
### Community 195 - "register_webui"
Cohesion: 0.03
Nodes (82): allow_paid_brain(), get_brain_preference(), True only when the operator explicitly opted into a paid (Anthropic) brain.…, Return the operator's brain provider preference. Values: - ``"nvidia"`` —…, test_allow_paid_brain_default_false(), test_allow_paid_brain_opt_in(), clean_env(), parametrize (+74 more)

### Community 196 - "FeatureMaturity"
Cohesion: 0.08
Nodes (33): check_feature(), get_feature(), list_features(), Any, get, post, features/api.py — Admin API for the feature support matrix. Exposes: GET…, Return the full support matrix with summary. (+25 more)

### Community 197 - "sync/service.py"
Cohesion: 0.05
Nodes (48): FastAPI dependency: require Power User or Admin role. Raises 403 otherwise., require_power_user(), sync/ — Syncthing-style workspace synchronisation service., add_peer(), get_folder_index(), get_sync_file(), get_sync_service(), list_conflicts() (+40 more)

### Community 198 - "SetupChecker"
Cohesion: 0.06
...
### Community 201 - "workflow_orchestrator.py"
Cohesion: 0.08
Nodes (37): BoundContext, ExecutionResult, _get_ceo_dispatcher(), JudgeVerdict, MonitorOutput, _orchestrator_bypass(), PersistOutput, Phase (+29 more)

### Community 202 - "emit_chat_observation"
Cohesion: 0.10
Nodes (31): CommercialEquivalent, estimate_commercial_equivalent_usd(), get_prices(), _load_from_env(), _parse_mapping(), Any, Map each local Ollama model name to a commercial API reference price (USD per…, _base_url() (+23 more)

### Community 203 - "monitor_lib.py"
Cohesion: 0.17
...
### Community 204 - "resolve_component_model"
Cohesion: 0.06
Nodes (43): Resolve the model id for a component's role on a provider. Parameters…, Convenience: resolve all four role models for a component. Returns a dict with…, resolve_component_model(), resolve_component_role_models(), tests/test_unit6_resolve_component_model.py — UNIT 6 regression tests. Verifies…, When the DB cache is fresh AND provider matches the active primary, the DB-…, When the DB primary differs from the requested provider, the catalog preset for…, When `provider` is None, the DB primary's saved model wins. (+35 more)
...
### Community 206 - "OllamaCircuitBreaker"
Cohesion: 0.08
...
### Community 210 - "test_daily_2026_07_27.py"
Cohesion: 0.07
...
### Community 212 - "loop.py"
Cohesion: 0.08
Nodes (36): _note_phase_end(), _note_phase_start(), loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., # NOTE: "ollama_base" is kept for backwards compatibility; this runner only…, Log start/elapsed for one phase of the plan/execute/verify loop. A task that…, Open a tracked phase, returning the token that closes it. Never raises., Close the tracked phase *token* opened above. Never raises., _timed_phase() (+28 more)

### Community 213 - "test_audit.py"
Cohesion: 0.07
...
### Community 214 - "OrchestratorQueue"
Cohesion: 0.13
...
### Community 216 - "test_classify_dependabot_update.py"
Cohesion: 0.07
...
### Community 217 - "compare_runtimes.py"
Cohesion: 0.06
...
### Community 218 - "chat_handlers.py"
Cohesion: 0.08
...
### Community 219 - "settings.py"
Cohesion: 0.06
Nodes (26): CerebrasProvider, Cerebras provider adapter — free, fast LLM (qwen-3-coder-480b)., GroqProvider, Groq provider adapter — free, fast LLM (deepseek-r1-distill-llama-70b)., NVIDIA NIM provider adapter — wraps the existing provider_router logic. This is…, OllamaProvider, Ollama provider adapter — local LLM inference., packages.ai — provider abstraction, model registry, and failover manager. (+18 more)

### Community 220 - "test_governance_enforcement.py"
Cohesion: 0.03
Nodes (87): ApprovalRequest, ApprovalStatus, ApprovalStore, Any, Enum, str, packages/governance/approvals.py — human-in-the-loop for high-risk actions. The…, Bounded, in-process store of approval requests. Uses a :class:`threading.Lock`… (+79 more)

### Community 221 - "test_telegram_approval_gate.py"
Cohesion: 0.07
...
### Community 226 - "portfolio_api.py"
Cohesion: 0.08
...
### Community 227 - "TaskBoardScreen.jsx"
Cohesion: 0.06
...
### Community 228 - "TestAuthAndTaskOwnership"
Cohesion: 0.05
...
### Community 229 - "Persistent Memory System"
Cohesion: 0.05
...
### Community 230 - "unsafe_target_reason"
Cohesion: 0.12
...
### Community 231 - "_get_provider_policy"
Cohesion: 0.07
Nodes (38): _get_provider_policy(), get_provider_policy_route(), Read the durable provider policy from DB, falling back to a safe default.…, Return the provider policy (paid-provider kill switch state)., seed_default_providers(), asyncio, tests/test_provider_policy.py — Unit tests for the paid-provider kill switch.…, ProviderPolicyUpdate defaults allow_paid to False. (+30 more)

### Community 232 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 234 - "WorkflowRun"
Cohesion: 0.08
Nodes (22): _fake_artifact(), _make_engine(), tests/test_crispy_workflow.py — CRISPY workflow engine hardening tests. Tests…, Create a WorkflowEngine with isolated storage., TestAbortOnFailure, _test(), _tracking_run_single(), TestPhaseSequence (+14 more)

### Community 235 - "RewardScorer"
Cohesion: 0.07
...
### Community 236 - "test_verification_strategies.py"
Cohesion: 0.09
...
### Community 237 - "distributed.py"
Cohesion: 0.08
Nodes (18): DistributedRateLimiter, get_persistent_queue(), _LocalBucket, PersistedRequest, PersistentQueue, Any, packages/llm/distributed.py — cross-instance coordination. Two facilities that…, True once a Redis connection has actually been established. (+10 more)

### Community 238 - "Initiative"
Cohesion: 0.06
Nodes (21): Initiative, Create and register a new initiative, returning it., Add a pre-built Initiative (e.g. from the intelligence layer)., Look up an initiative by ID., A portfolio initiative (epic) prioritised via WSJF. WSJF (Weighted Shortest Job…, Aggregate cost of delay (CoD) used as the WSJF numerator., Associate an agile sprint that delivers part of this initiative., Tests for the Initiative dataclass and WSJF maths. (+13 more)

### Community 239 - "ProviderConfig"
Cohesion: 0.05
Nodes (55): _acquire_provider_probe(), CommercialFallbackRequiredError, _dead_model_key(), _get_director(), is_commercial_provider(), _mark_model_dead(), _normalized_provider_type(), provider_access_tier() (+47 more)

### Community 240 - "test_schedule_growth_invariants.py"
Cohesion: 0.04
...
### Community 241 - "Kept Rules — the 44 that survive the audit"
Cohesion: 0.05
...
### Community 242 - "test_brain_availability_doctor.py"
Cohesion: 0.10
...
### Community 244 - "test_llm_router_disabled.py"
Cohesion: 0.09
...
### Community 247 - "test_telegram_webhook.py"
Cohesion: 0.06
...
### Community 250 - "TestCatalogFable51"
Cohesion: 0.09
...
### Community 251 - "test_local_controller.py"
Cohesion: 0.14
...
### Community 257 - "seo_api.py"
Cohesion: 0.05
Nodes (67): build_seo_roadmap(), delegate_seo_findings(), _expire_stale_pending_report(), export_seo_audit(), get_seo_audit(), list_seo_audits(), plan_seo_sprint(), BaseModel (+59 more)

### Community 258 - "test_pr923_fixes.py"
Cohesion: 0.07
...
### Community 259 - "test_purge_backlog.py"
Cohesion: 0.07
...
### Community 262 - "test_backend_server_features.py"
Cohesion: 0.06
...
### Community 263 - "test_rate_limiter.py"
Cohesion: 0.08
...
### Community 265 - "test_persistent_memory.py"
Cohesion: 0.06
...
### Community 266 - "test_provider_enable_disable.py"
Cohesion: 0.07
...
### Community 270 - "InternalAgentAdapter"
Cohesion: 0.08
Nodes (20): InternalAgentAdapter, Built-in agent loop — Nvidia NIM primary, Ollama fallback., Return runtime dependencies required by this adapter. Returns:…, Determine availability of the internal agent runtime. Checks cloud providers in…, Create an isolated execution context for a single task. Tries ``git worktree…, Clean up the worktree or temp copy created by ``_create_worktree``., InternalAgentAdapter should construct without error., InternalAgentAdapter.execute() must NOT pass provider_chain= to AgentRunner.… (+12 more)

### Community 271 - "ProvidersScreen.jsx"
Cohesion: 0.06
...
### Community 272 - "BrainWatchdog"
Cohesion: 0.04
Nodes (53): emit_agency_observation(), Record an agency platform operation in Langfuse. Unlike…, Any, packages/ai/self_heal.py — automatic brain self-healing. When the active brain…, Background tick that runs self_heal_brain_and_unblock_tasks(). Called from the…, One-shot self-healing pass. 1. Checks if the active brain provider is in a…, self_heal_brain_and_unblock_tasks(), _self_heal_tick() (+45 more)

### Community 273 - "AgentDefinition"
Cohesion: 0.03
Nodes (88): AgentDefinition, AgentStore, get_agent_store(), Any, field_validator, agents/store.py — Persistent store for user-defined agent configurations.…, CRUD store for AgentDefinition objects. Uses MongoDB when a `db` client is…, Return an agent by ID. If *owner_id* is provided, enforces that the agent… (+80 more)

### Community 274 - "TestClient"
Cohesion: 0.07
...
### Community 275 - "test_nvidia_model_discovery.py"
Cohesion: 0.06
...
### Community 277 - "AgentScheduler"
Cohesion: 0.07
Nodes (30): AgentScheduler, _now(), Register, list, trigger, and delete cron-scheduled agent jobs. Usage:: sched =…, Register a new job. Returns the created :class:`ScheduledJob`.…, Fire a job immediately (webhook / manual trigger)., Remove a job. Returns *True* if it existed., Update the display name of a job., Enable or disable a job without deleting it. (+22 more)

### Community 278 - "test_connector_registry.py"
Cohesion: 0.09
...
### Community 279 - "_extract_pytest_failure"
Cohesion: 0.42
...
### Community 282 - "NIMConnectionPool"
Cohesion: 0.09
...
### Community 284 - "._log_event"
Cohesion: 0.11
Nodes (19): _extract_slices_from_plan(), PhaseType, Append an event to the workflow event log., Create a new WorkflowRun and begin pre-gate phase execution. The run is…, Return current WorkflowRun snapshot or None., Approve the plan — lifts the ApprovalGate and resumes execution. Raises…, Reject the plan — marks run as failed., Cancel a non-terminal run. (+11 more)
...
### Community 286 - "ContextCompressor"
Cohesion: 0.11
...
### Community 287 - "test_kimi_bridge_provider.py"
Cohesion: 0.20
...
Cohesion: 0.11
Nodes (13): Snapshot of one crawled page with the on-page facts the checks used., SeoPageAudit, analyze_page(), BeautifulSoup, Run every page-scoped check against one HTML document (no network). Returns a…, _visible_text(), codes(), parametrize (+5 more)

### Community 293 - "call_llm"
Cohesion: 0.07
Nodes (37): _agent_timeout_fallback_response(), _build_direct_chat_schedule_suggestion(), _build_direct_chat_tags(), _build_direct_chat_task_suggestion(), _build_provider_router(), _builtin_provider_records(), call_llm(), _chat_error_detail_text() (+29 more)
...
### Community 296 - "test_colibri_provider.py"
Cohesion: 0.13
...
### Community 298 - "test_microagents.py"
Cohesion: 0.15
...
### Community 305 - "test_telegram_mutating_commands.py"
Cohesion: 0.09
...
### Community 307 - "Traffic Distribution Across Providers"
Cohesion: 0.14
...
Cohesion: 0.13
Nodes (29): _apply_activity_status(), create_agent(), delete_agent(), get_agent(), _get_user(), list_agents(), list_runtime_agents(), Any (+21 more)

### Community 311 - "High-Agency Frontend Skill"
Cohesion: 0.06
Nodes (30): 10. FINAL PRE-FLIGHT CHECK, 1. ACTIVE BASELINE CONFIGURATION, 2. DEFAULT ARCHITECTURE & CONVENTIONS, 3. DESIGN ENGINEERING DIRECTIVES (Bias Correction), 4. CREATIVE PROACTIVITY (Anti-Slop Implementation), 5. PERFORMANCE GUARDRAILS, 6. TECHNICAL REFERENCE (Dial Definitions), 7. AI TELLS (Forbidden Patterns) (+22 more)

### Community 312 - "build_render_router"
Cohesion: 0.12
...
### Community 314 - "RateLimitTracker"
Cohesion: 0.10
...
### Community 315 - "test_chat_mode_regressions.py"
Cohesion: 0.11
...
### Community 317 - "test_repo_connection.py"
Cohesion: 0.06
...
### Community 318 - "test_log_monitor_storm_guard.py"
Cohesion: 0.48
...
### Community 319 - "test_agency_fix.py"
Cohesion: 0.06
...
### Community 327 - "local_controller.py"
Cohesion: 0.11
...
### Community 330 - "_redact_for_notification"
Cohesion: 0.11
...
### Community 336 - "autonomous_fix.py"
Cohesion: 0.10
...
### Community 337 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 338 - "session_retro.py"
Cohesion: 0.13
...
### Community 340 - "test_claude_setup_audit.py"
Cohesion: 0.16
...
### Community 342 - "test_internal_agent_did_work.py"
Cohesion: 0.12
...
### Community 343 - "_captured_request_headers"
Cohesion: 0.12
...
### Community 346 - "Python Dependencies (`requirements.txt`)"
Cohesion: 0.07
...
### Community 347 - "_ensure_tasks_source_id_unique_index"
Cohesion: 0.10
...
### Community 350 - "SetupWizardPage.js"
Cohesion: 0.13
...
### Community 351 - "ProviderConsole.jsx"
Cohesion: 0.08
...
### Community 354 - "build_governance_router"
Cohesion: 0.11
Nodes (35): Charge sub-agent nesting depth and enforce the ``max_depth`` ceiling. Isolates…, build_governance_router(), approve(), _decide(), deny(), destroy_sandbox(), get_audit(), get_budget() (+27 more)
...
### Community 356 - "TestRouterIntegration"
Cohesion: 0.21
...
### Community 358 - "test_agent_scripts_share_one_model_list.py"
Cohesion: 0.10
...
### Community 360 - "test_crispy_burn_in.py"
Cohesion: 0.07
...
### Community 361 - "test_implement_agent_routing.py"
Cohesion: 0.07
...
### Community 363 - "test_executive_advisory_api.py"
Cohesion: 0.11
...
### Community 366 - "Claude Code + Qwen Local Setup"
Cohesion: 0.07
...
### Community 367 - "Docker Agent Runtimes Setup"
Cohesion: 0.05
...
### Community 368 - "generate_context.py"
Cohesion: 0.12
...
### Community 369 - "TestStreamableHTTPTransport"
Cohesion: 0.12
...
### Community 370 - "isolated_telegram_config"
Cohesion: 0.10
...
### Community 371 - "test_anthropic_refusal_fallback.py"
Cohesion: 0.19
...
### Community 372 - "test_daily_2026_06_04.py"
Cohesion: 0.09
Nodes (35): is_anthropic_model(), True when *model* names a paid Anthropic/Bedrock-Claude model. Covers native…, _opus_model(), Return an Opus model ID iff the operator explicitly opted into a paid brain.…, test_is_anthropic_model(), _content_block_to_text(), _fresh_router(), _make_tool() (+27 more)

### Community 373 - "_Recorder"
Cohesion: 0.09
...
### Community 374 - "test_scheduler_hydration_bounded.py"
Cohesion: 0.09
...
### Community 375 - "WorkspaceManager"
Cohesion: 0.06
...
### Community 376 - "executive_advisory_api.py"
Cohesion: 0.11
...
### Community 377 - "test_skill_registry.py"
Cohesion: 0.13
...
### Community 378 - "VoiceCommandInterface"
Cohesion: 0.14
...
### Community 379 - "Technical Debt Register — local-llm-server"
Cohesion: 0.07
...
### Community 381 - "test_agent_chat_integration.py"
Cohesion: 0.13
...
### Community 383 - "TemporalContextGraph"
Cohesion: 0.10
...
### Community 388 - "HarnessEnrichment"
Cohesion: 0.14
...
### Community 390 - "[Unreleased]"
Cohesion: 0.05
Nodes (42): Added, Added, Added, Added, Added, Added, Added, Added (+34 more)

### Community 391 - "Skill: user-research"
Cohesion: 0.13
...
### Community 392 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 393 - "Implementation Plan"
Cohesion: 0.11
...
### Community 394 - "Session Handoff — 2026-06-15"
Cohesion: 0.08
...
### Community 395 - "Telegram Bot Setup"
Cohesion: 0.08
...
### Community 396 - "video_transcript.py"
Cohesion: 0.11
...
### Community 399 - "test_memory_guard.py"
Cohesion: 0.12
...
### Community 400 - "test_activation_api.py"
Cohesion: 0.13
...
### Community 401 - "BrainFailoverManager"
Cohesion: 0.09
...
### Community 402 - "lifespan"
Cohesion: 0.04
Nodes (38): _keepalive_self_ping(), lifespan(), _deferred_startup_cleanup(), Run the FreeBuff Telegram bot, restarting it on unexpected exit., Ping our own public URL so a free-tier web service doesn't sleep. Render free…, Start the Telegram bot (and keep-alive) inside the web process when enabled.…, N5 dual-auth dependency: accept EITHER a user session OR a service token. Used…, _start_in_web_bot_tasks() (+30 more)
...
### Community 404 - "TestClassifyPlainText"
Cohesion: 0.08
...
### Community 405 - "test_service_token.py"
Cohesion: 0.08
...
### Community 410 - "Local AI Stack with Docker"
Cohesion: 0.08
...
### Community 412 - "LLM Router — troubleshooting"
Cohesion: 0.08
...
### Community 413 - "TASK 4 — End-to-end approval-gate test"
Cohesion: 0.08
...
### Community 416 - "get_skill_bindings"
Cohesion: 0.09
Nodes (27): get_skill_bindings(), Live Graphify executor — queries the codebase knowledge graph. Order of…, Live council reviewer — deterministic, rules-based multi-perspective review…, Get the singleton SkillBindings instance., _run_council_review(), _run_graphify(), parametrize, tests/test_docs_consistency.py — structural defense against narrative drift.… (+19 more)

### Community 417 - "ScheduledJob"
Cohesion: 0.08
...
### Community 425 - "DirectChatDoctor"
Cohesion: 0.08
Nodes (36): DirectChatDoctor, get_skill_registry_safe(), Return the global SkillRegistry if set, else None. Used by onboarding and other…, _DoctorCheck, _DoctorReport, get_doctor_diagnostics(), get_doctor_report(), get_public_doctor() (+28 more)

### Community 426 - "openclaw_str_e_fix.py"
Cohesion: 0.15
...
### Community 427 - "Workspace Isolation Architecture"
Cohesion: 0.15
...
### Community 429 - "implement_agent.py"
Cohesion: 0.12
...
### Community 430 - "test_agent_free_brain.py"
Cohesion: 0.06
...
### Community 433 - "test_cerebras_catalogue.py"
Cohesion: 0.13
...
### Community 434 - "test_mostly_failed_steps.py"
Cohesion: 0.12
...
### Community 436 - "test_p0_roadmap_a4_a5_b2.py"
Cohesion: 0.14
...
### Community 438 - "AdaptivePermissions"
Cohesion: 0.18
...
### Community 442 - "Performance Analysis — local-llm-server"
Cohesion: 0.08
...
### Community 444 - "Implementation Prompt: Rich TaskBoard + Agile Sprint Integration"
Cohesion: 0.08
...
### Community 445 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 448 - "PriorityTaskQueue"
Cohesion: 0.14
...
### Community 449 - "test_task_source_id_race.py"
Cohesion: 0.12
...
### Community 452 - "test_gh_brain_failover.py"
Cohesion: 0.10
...
### Community 453 - "resolve_active_brain"
Cohesion: 0.05
...
### Community 456 - "get_failover_manager"
Cohesion: 0.06
Nodes (41): brain_failover_status(), brain_providers(), openclaw_command(), _openclaw_instructions(), openclaw_reverse_proxy(), openclaw_status(), openclaw_websocket(), api_route (+33 more)
...
### Community 458 - "test_provider_410_per_model.py"
Cohesion: 0.15
...
### Community 459 - "TestMCPClientStructuredOutput"
Cohesion: 0.27
...
### Community 461 - "TestAdapterMetadata"
Cohesion: 0.05
Nodes (23): _env_float(), HermesAdapter, Any, AsyncClient, Submit task to Hermes via its /tasks endpoint., Read a float env var, falling back to *default* on unset/garbage., Adapter for Hermes Agent — FIRST CLASS autonomous runtime., _safe_detail() (+15 more)

### Community 462 - "_process_task_callback"
Cohesion: 0.20
...
### Community 463 - "test_brain_migration_writes_a_live_model.py"
Cohesion: 0.10
...
### Community 464 - "test_openclaw_str_e_fix.py"
Cohesion: 0.10
...
### Community 466 - "run_trend_analysis"
Cohesion: 0.18
...
### Community 468 - "register_admin_gui"
Cohesion: 0.20
...
### Community 469 - "_extract_tech_relevance"
Cohesion: 0.17
...
### Community 476 - "The fifteen strategies"
Cohesion: 0.09
...
### Community 484 - "TestHarnessAdapter"
Cohesion: 0.05
...
### Community 485 - "NotificationDispatcher"
Cohesion: 0.10
...
### Community 486 - "TestBrainFailoverModelUpdates"
Cohesion: 0.18
...
### Community 488 - "test_research_coordinator.py"
Cohesion: 0.11
...
### Community 489 - "test_tasks_cache_ttl_env.py"
Cohesion: 0.21
...
### Community 490 - "test_webui_provider_priority.py"
Cohesion: 0.10
Nodes (33): _bootstrap(), Path, tests/test_webui_provider_priority.py — Priority + reorder + brain-policy…, The /policy/brain endpoint must return the resolved brain + the paid policy…, The /providers/role-tags endpoint surfaces brain/sub/fallback roles consistent…, Reset the brain_config + brain_policy singletons before each test. V2.0 Phase 2…, _reset_brain_singletons(), test_admin_policy_brain_returns_resolution_and_paid_state() (+25 more)

### Community 491 - "TestUpdateTask"
Cohesion: 0.16
...
### Community 494 - "Skill: fabric-patterns"
Cohesion: 0.11
...
### Community 495 - "Analysis & Synthesis Instructions"
Cohesion: 0.11
Nodes (18): 1. Define the Atmosphere, 2. Map the Color Palette, 3. Establish Typography Rules, 4. Define the Hero Section, 5. Describe Component Stylings, 6. Define Layout Principles, 7. Define Responsive Rules, 8. Encode Motion Philosophy (+10 more)

### Community 496 - "Production Readiness Assessment — local-llm-server"
Cohesion: 0.11
...
### Community 497 - "test_dashboard_cache.py"
Cohesion: 0.10
Nodes (23): _cached(), cost_attribution_stats(), _fast_count(), get_activity(), _get_activity_impl(), get_stats(), legacy_scheduler_list(), _produce_scheduler_jobs() (+15 more)

### Community 498 - "Attention Mechanisms Internals"
Cohesion: 0.13
...
### Community 500 - "TestNormalizeResponseFormat"
Cohesion: 0.08
...
### Community 504 - "Admin Dashboard Guide"
Cohesion: 0.11
...
### Community 505 - "Part A — CodeRabbit review fixes for this PR (do first, small)"
Cohesion: 0.05
...
### Community 506 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 507 - "scripts/doctor.py"
Cohesion: 0.27
Nodes (17): NamedTuple, Check, check_core_deps(), check_env(), check_git(), check_mongo(), check_node(), check_ollama() (+9 more)

### Community 508 - "scrub"
Cohesion: 0.10
Nodes (15): _luhn_ok(), True when ``digits`` (bare, no separators) satisfies the Luhn checksum., Recursively strip secrets from an arbitrary argument structure. Fails…, scrub(), tests/test_governance_audit_pii.py — PII redaction in the audit scrubber.…, TestCardRedaction, TestLuhn, TestNestedAndEventIntegration (+7 more)

### Community 509 - "Delegation Plan (agent-ready work packages)"
Cohesion: 0.11
...
### Community 510 - "brain_failover.py"
Cohesion: 0.11
Nodes (29): auto_disable_provider(), _disabled_from_mongo(), _disabled_from_sqlite(), _is_paid_allowed_db(), _kv_connect(), _kv_path(), _mongo_db(), _mongo_enabled() (+21 more)

### Community 511 - "run_proxy.sh"
Cohesion: 0.11
...
### Community 512 - "ClaudeCodeAdapter"
Cohesion: 0.17
Nodes (18): ClaudeCodeAdapter, json_safe(), Any, Adapter for Claude Code CLI — FIRST CLASS autonomous coding runtime., adapter(), asyncio, Tests for runtimes/adapters/claude_code.py, setup_database_moks() (+10 more)

### Community 513 - "_iter_events"
Cohesion: 0.20
...
### Community 514 - "test_p0_roadmap_b3_b4_b5.py"
Cohesion: 0.15
...
### Community 516 - "test_autonomy_status.py"
Cohesion: 0.11
...
### Community 521 - "DecisionsStoreTests"
Cohesion: 0.13
...
### Community 522 - "_FakeCommandResult"
Cohesion: 0.22
Nodes (3): _FakeCommandResult, _FakeCommands, _FakeFiles

### Community 523 - "test_freebuff_bot.py"
Cohesion: 0.12
Nodes (8): Tests for the always-on FreeBuff Telegram bot: embedded vs HTTP dispatch., In orchestrator mode the embedded run must set the bypass so the agent runs., test_embedded_flag(), test_embedded_run_bypasses_orchestrator(), test_fb_models_http_uses_proxy(), test_fb_run_embedded_dispatches_to_embedded_run(), test_fb_run_http_calls_proxy_with_commit_and_pr(), test_max_steps_clamped()

### Community 524 - "ModelConfig"
Cohesion: 0.04
Nodes (41): AgentPolicy, LLMConfig, ModelConfig, Capability and pricing metadata for one model id., Per-agent routing overrides (ADR-008 §"named profiles")., The fully-resolved routing configuration., Re-read configuration from disk. Used by the admin API and by tests., reload_config() (+33 more)

### Community 525 - "TestRoutes"
Cohesion: 0.16
...
### Community 526 - "validate_session_id"
Cohesion: 0.16
...
### Community 528 - "handle_workflow_ide_chat"
Cohesion: 0.17
...
### Community 529 - "GoalRecord"
Cohesion: 0.06
Nodes (32): Attempt, _backend(), CEOLedger, GoalRecord, _now(), Any, services/ceo_ledger.py — durable record of what the CEO is driving to closure.…, One delegation of one subtask to one tier. (+24 more)

### Community 530 - "test_harness_spec.py"
Cohesion: 0.12
...
### Community 531 - "SEO / GEO / AIO Audit Engine"
Cohesion: 0.14
...
### Community 535 - "Architecture Overview — local-llm-server"
Cohesion: 0.11
...
### Community 537 - "RuntimeHealthService"
Cohesion: 0.10
...
### Community 538 - "CompanyAgencyService"
Cohesion: 0.09
...
### Community 540 - "Part A — Health Report"
Cohesion: 0.11
...
### Community 542 - "sync_readme_gallery.py"
Cohesion: 0.20
...
### Community 546 - "tests/conftest.py"
Cohesion: 0.11
...
### Community 547 - "test_langfuse_agency_wide.py"
Cohesion: 0.10
...
### Community 549 - "TestStopSlopChecker"
Cohesion: 0.11
...
### Community 550 - "get_workflow_orchestrator"
Cohesion: 0.04
Nodes (39): OrchestratorSupervisor, Any, Emit an alert to the activity feed and log., Deterministic supervisor for the orchestrator. Runs as a background coroutine.…, stop_orchestrator_supervisor(), get_workflow_orchestrator(), Return the shared WorkflowOrchestrator singleton., Reset the singleton (test helper). (+31 more)
...
### Community 554 - "SKILL: Industrial Brutalism & Tactical Telemetry UI"
Cohesion: 0.12
...
### Community 555 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 556 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 559 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 560 - "WorkspaceManager"
Cohesion: 0.11
...
### Community 563 - "agent_readiness_audit.py"
Cohesion: 0.21
...
### Community 569 - "TestMCPToolsListCache"
Cohesion: 0.15
...
### Community 570 - "e2e/test_browser.py"
Cohesion: 0.19
...
### Community 571 - "test_frontend_deployment_guards.py"
Cohesion: 0.18
...
### Community 572 - "test_health_endpoints.py"
Cohesion: 0.15
...
### Community 573 - "test_openclaw_endpoints.py"
Cohesion: 0.12
...
### Community 578 - "test_ai_insights.py"
Cohesion: 0.15
...
### Community 579 - "PerformanceAnalytics"
Cohesion: 0.14
...
### Community 582 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
...
### Community 583 - "_valid_login_state"
Cohesion: 0.24
...
### Community 584 - "test_daemon_restart_reprobes_http_port_only"
Cohesion: 0.13
...
### Community 585 - "The 10-Step Workflow"
Cohesion: 0.12
...
### Community 588 - "Section-by-Section Acceptance Criteria"
Cohesion: 0.12
...
### Community 589 - "WindowsServiceManager"
Cohesion: 0.17
...
### Community 595 - "ManagedAgentDreams"
Cohesion: 0.22
...
### Community 596 - "test_issue_triage.py"
Cohesion: 0.14
...
### Community 597 - "test_agency_workflows_carry_the_failover_chain.py"
Cohesion: 0.18
...
### Community 599 - "_status_snapshot"
Cohesion: 0.15
...
### Community 600 - "probe_model_liveness"
Cohesion: 0.16
...
### Community 601 - "test_dockerfile_ships_root_modules.py"
Cohesion: 0.17
...
### Community 602 - "test_local_brain_state.py"
Cohesion: 0.12
...
### Community 604 - "test_migrate_local_brain_env.py"
Cohesion: 0.38
...
### Community 605 - "TestNoNvidiaFallbackIsRetired"
Cohesion: 0.09
...
### Community 606 - "ExecutionRequest"
Cohesion: 0.03
Nodes (73): Called by APScheduler when a cron fires. Dispatches to the orchestrator. This…, _scheduler_on_fire(), ExecutionRequest, _NoopStore, Any, Exception, Approve a run paused at the ApprovalGate. The caller must re-invoke…, Inject additional instructions into an in-flight run (no state change). Backs… (+65 more)

### Community 608 - "test_refresh_agent_built_proof.py"
Cohesion: 0.12
...
### Community 614 - "EngagementMetrics"
Cohesion: 0.15
...
### Community 615 - "CollaborationContext"
Cohesion: 0.17
...
### Community 616 - "TaskWorkflowService"
Cohesion: 0.08
Nodes (24): Fan trends out to onboarded companies whose stack matches (G4). For each…, Record the human decision on a task's **pre-execution** approval gate. A…, Re-run a task. Permissive across every non-active state so the dashboard Retry…, Add a follow-up instruction to a task and re-queue it for execution. Unlike…, Owns lifecycle transitions, comment semantics, and approval rules., TaskWorkflowService, _coordinator(), asyncio (+16 more)

### Community 617 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 626 - "test_new_features_e2e.py"
Cohesion: 0.26
...
### Community 627 - "Security Analysis — local-llm-server"
Cohesion: 0.06
...
### Community 628 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 629 - "OpenClaw — iOS Control of the Agency (Single-Service Free-Tier Deploy)"
Cohesion: 0.15
...
### Community 632 - "test_voice_pipeline.py"
Cohesion: 0.13
...
### Community 633 - "Docker AI Governance Audit — Final Report"
Cohesion: 0.10
...
### Community 635 - "TestDecisionsBotLinks"
Cohesion: 0.21
...
### Community 636 - "ApprovalCheckpoint"
Cohesion: 0.16
Nodes (8): ApprovalCheckpoint, ExecutionLogEntry, Any, field_validator, Update the updated_at timestamp., Single entry in a task's execution log., Dict-compatible accessor. Log entries are serialized to/from dicts in many…, Human approval gate in a task's execution.

### Community 637 - "KnowledgeScreen.jsx"
Cohesion: 0.13
...
### Community 638 - "test_all_features.py"
Cohesion: 0.08
...
### Community 639 - "test_critical_flows.py"
Cohesion: 0.26
...
### Community 641 - "TestBrainConfigUpdates"
Cohesion: 0.22
...
### Community 642 - "test_dockerfile_ships_config_dir.py"
Cohesion: 0.14
...
### Community 643 - "WebsiteScanner"
Cohesion: 0.03
Nodes (81): Evidence, Evidence supporting a system detection., main(), Post-deploy verification for the website scanner against the LIVE internet.…, Returns (url, ok, summary)., _scan_one(), _is_safe_url(), _looks_like_bot_challenge() (+73 more)

### Community 644 - "SamAgent"
Cohesion: 0.19
Nodes (8): Any, SAM voice agent — the voice-controlled interface to the agency., Process a voice command and return SAM's spoken response. Args: text: The…, Public snapshot of live agency state (used by the LiveKit worker tools)., Gather live agency state for SAM's situational awareness., Call the NVIDIA NIM LLM (free tier) for SAM's response., Rule-based fallback when the LLM is unavailable., SamAgent
...
### Community 646 - "classify_direct_chat_intent"
Cohesion: 0.13
...
### Community 648 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 649 - "test_portfolio_intelligence.py"
Cohesion: 0.14
...
### Community 650 - "DeterministicEngine"
Cohesion: 0.21
...
### Community 654 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 660 - "admin_digest_router.py"
Cohesion: 0.22
...
### Community 662 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 663 - "Skill: perplexity — Web Research via Perplexity API"
Cohesion: 0.14
...
### Community 666 - "Quick-Note Issues Processing Summary"
Cohesion: 0.14
...
### Community 667 - "DirectChatSession"
Cohesion: 0.15
...
### Community 668 - "Separate hosted dashboard backend (`backend/server.py`)"
Cohesion: 0.13
...
### Community 669 - "Runbook: Auto-Resume After Cooldown / Interruption"
Cohesion: 0.14
...
### Community 672 - "extract_failures"
Cohesion: 0.21
...
### Community 674 - "test_agent_readiness_audit.py"
Cohesion: 0.18
...
### Community 675 - "test_kimi_bridge_server.py"
Cohesion: 0.12
...
### Community 676 - "test_wrapper_falls_back_to_installed_model"
Cohesion: 0.19
...
### Community 677 - "TestAnthropicToolListCaching"
Cohesion: 0.34
...
### Community 679 - "_StubManager"
Cohesion: 0.14
Nodes (3): _apply(), Minimal stand-in for BrainFailoverManager., _StubManager

### Community 680 - ".test_set_github_token_sqlite_string_id_does_not_500"
Cohesion: 0.16
...
### Community 684 - "test_openclaw_gateway.py"
Cohesion: 0.14
...
### Community 687 - "AGENTS.md — Codebase Map & Operations Reference"
Cohesion: 0.15
...
### Community 688 - "ResearchOrchestrator"
Cohesion: 0.16
...
### Community 690 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 693 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 694 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 698 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 699 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 700 - "Deploy: FreeBuff Telegram bot (24×7)"
Cohesion: 0.07
...
### Community 702 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 703 - "admin_update_task_router.py"
Cohesion: 0.22
...
### Community 705 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
Nodes (12): Acceptance Checks, Claude's query protocol (use this instead of Read tool for exploration):, Graph Artifacts — What to Commit, How to Use the Graph (Token Savings Protocol), Installation (one-time per machine), Instead of reading raw files:, Key commands:, Relationship to repowise-intelligence Skill (+4 more)

### Community 706 - "Skill: platform-setup — Autonomous Agency Bootstrap"
Cohesion: 0.15
...
### Community 707 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 711 - "_get_provider_policy"
Cohesion: 0.19
...
### Community 712 - "DailyDigestAggregatorTests"
Cohesion: 0.19
...
### Community 714 - "test_compose_and_coordinate_api.py"
Cohesion: 0.19
...
### Community 716 - "test_deploy_trigger_covers_image.py"
Cohesion: 0.21
...
### Community 717 - "_fixture"
Cohesion: 0.02
Nodes (91): parse_event_stream(), ParsedRun, Structured view of one ``--mode json`` event stream., Reduce a ``--mode json`` NDJSON stream to a :class:`ParsedRun`. Kept a module-…, app_client(), _clear_discovered_models(), _clear_response_cache(), client() (+83 more)

### Community 718 - "test_fabric_patterns.py"
Cohesion: 0.11
...
### Community 719 - "test_repowise_intelligence.py"
Cohesion: 0.11
...
### Community 720 - "test_providers_live_e2e.py"
Cohesion: 0.24
...
### Community 721 - "test_quick_note_engine.py"
Cohesion: 0.17
...
### Community 723 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
...
### Community 724 - "Skill: hybrid-reasoning (Hybrid AI)"
Cohesion: 0.29
...
### Community 729 - "Skill: system-prompt-audit"
Cohesion: 0.17
...
### Community 730 - "Skill: task-alive-updates"
Cohesion: 0.17
...
### Community 733 - "build_admin_local_brain_router"
Cohesion: 0.24
...
### Community 734 - "_is_ephemeral_user"
Cohesion: 0.27
...
### Community 737 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 741 - "Quantization Internals"
Cohesion: 0.17
...
### Community 742 - "Autonomy Uplift — Living Roadmap & Detailed Implementation Specs"
Cohesion: 0.15
...
### Community 743 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 744 - "test_agent_tools.py"
Cohesion: 0.19
...
### Community 751 - "test_agile_api.py"
Cohesion: 0.17
...
### Community 752 - "test_app_settings.py"
Cohesion: 0.21
...
### Community 753 - "test_brain_default_consistency.py"
Cohesion: 0.24
...
### Community 755 - "get_registry"
Cohesion: 0.11
Nodes (12): models(), get_registry(), The process-wide model registry., Test hook — rebuild the registry on next access., reset(), tests/test_daily_automation_2026_07_10.py — Daily automation tests…, Verify Llama 4 and Claude Sonnet 5 cross-provider aliases are registered., Verify new models are in the packages/ai/registry. (+4 more)

### Community 756 - "test_monitor_lib.py"
Cohesion: 0.15
...
### Community 757 - "TestOrchestratorQueue"
Cohesion: 0.13
...
### Community 764 - "_extractive_compress"
Cohesion: 0.18
...
### Community 766 - "AI Engineering Insights Skill"
Cohesion: 0.29
...
### Community 767 - "cowork_session.py"
Cohesion: 0.15
...
### Community 771 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 774 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 775 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 776 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 779 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 780 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 781 - "2. Critical Bugs & Exact Detection Signatures"
Cohesion: 0.18
...
### Community 783 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 785 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
...
### Community 786 - "CI Troubleshooting Runbook"
Cohesion: 0.18
...
### Community 788 - "test_bedrock_live.py"
Cohesion: 0.25
...
### Community 789 - "agile_sprints.py"
Cohesion: 0.14
...
### Community 790 - "_push_down_where"
Cohesion: 0.14
...
### Community 792 - "migrate_local_brain_env.py"
Cohesion: 0.25
...
### Community 794 - "test_conftest_hermetic_env.py"
Cohesion: 0.18
...
### Community 796 - "telegram_inbound_handlers.py"
Cohesion: 0.13
...
### Community 797 - "TestZeroAttemptDiagnostics"
Cohesion: 0.25
...
### Community 798 - "test_autonomy_pipeline_regressions.py"
Cohesion: 0.11
...
### Community 799 - "test_brain_config_api.py"
Cohesion: 0.12
Nodes (14): _catalogue_candidates(), _catalogue_role_preset(), _catalogue_safe_default(), tests/test_brain_config_api.py — admin endpoint contract tests. Pins the…, The role preset the catalogue defines, not a literal copy of it. Two tests here…, The rotation as the catalogue defines it, after the YAML override.…, Reiterates the security contract: no key value ever appears in the response., Pydantic Literal rejects an unknown provider before any probe fires. (+6 more)
...
### Community 804 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 805 - "Skill: repowise-intelligence"
Cohesion: 0.12
...
### Community 807 - "Brag Plan: Autonomous AI Agency (feature tour, v2)"
Cohesion: 0.20
...
### Community 808 - "Hyperframes Composition Brief: Autonomous AI Agency (feature tour, v2)"
Cohesion: 0.20
...
### Community 810 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 811 - "Skill: branch-cleanup"
Cohesion: 0.14
...
### Community 814 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 815 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 816 - "Skill: repowise-intelligence"
Cohesion: 0.12
Nodes (15): 1. Graph Intelligence (Dependency Graph), 2. Git Intelligence, 3. Documentation Intelligence, 4. Decision Intelligence, Acceptance Checks, Directory Structure, Example Usage, Implementation Approach (+7 more)

### Community 817 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 818 - "Agent Readiness Report"
Cohesion: 0.20
...
### Community 819 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 821 - "One command (recommended)"
Cohesion: 0.20
...
### Community 822 - "ENGINEERING_STANDARDS.md — Patterns & Reference"
Cohesion: 0.22
...
### Community 825 - "capture_screens.py"
Cohesion: 0.29
...
### Community 826 - "router/health.py"
Cohesion: 0.16
...
### Community 828 - "ProbeResult"
Cohesion: 0.17
Nodes (18): ProbeResult, BaseModel, Outcome of a single (provider, model) liveness probe., A model that 410s must be rejected with 422 + a probe report., A model that probes 200 OK must be persisted., If the chosen provider's key is missing, the probe short-circuits → 422., A partial PATCH only probes the changed role — not every role., POST /admin/api/policy/brain/test fires a probe but does NOT save. (+10 more)
...
### Community 830 - "_resolve_push_token"
Cohesion: 0.31
...
### Community 831 - "TestDisabledProvidersAreNotFalselyReportedUnreachable"
Cohesion: 0.22
...
### Community 832 - "TestTheWorkflowIsSafeAndReadOnly"
Cohesion: 0.20
...
### Community 834 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 835 - "test_model_catalog_guard.py"
Cohesion: 0.29
...
### Community 837 - "connectors_api.py"
Cohesion: 0.21
...
### Community 838 - "get_scheduler"
Cohesion: 0.11
Nodes (28): legacy_scheduler_get(), Called by Cloudflare Cron every minute. Protected by CRON_SECRET header., Force-dedup and clean stale schedules from the durable store. Admin-only…, scheduler_force_cleanup(), scheduler_tick(), get_scheduler(), create_schedule(), delete_schedule() (+20 more)

### Community 840 - "_check_storage_health"
Cohesion: 0.13
...
### Community 841 - "test_workflow_api_mount.py"
Cohesion: 0.20
...
### Community 846 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 849 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 852 - "workflow/models.py"
Cohesion: 0.18
Nodes (9): tests/test_workflow_models.py — Unit tests for workflow/models.py., TestApprovalGate, TestCheckRun, Trigger verification for all applied-but-unverified slices., ApprovalGate, CheckRun, workflow/models.py — CRISPY Workflow Engine data models. All public types are…, Hard approval gate between plan and execution. The workflow engine sets… (+1 more)

### Community 853 - "la"
Cohesion: 0.28
Nodes (9): Aa(), Animation(), Ca(), Da(), la(), na(), Ua(), Va() (+1 more)

### Community 854 - "Skill: changelog-enforcer"
Cohesion: 0.22
Nodes (8): Acceptance Checks, Changelog Location, Entry Format, Examples, Hook Behaviour, Instructions, Skill: changelog-enforcer, When to Use

### Community 855 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 856 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 857 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 858 - "Issue #1356: quick-note:https://searchengineland.com/turn-seo-backlog-into-roadmap-485713"
Cohesion: 0.22
...
### Community 859 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 860 - "LLM Router — provider guide"
Cohesion: 0.20
...
### Community 861 - "Release Procedure"
Cohesion: 0.22
...
### Community 862 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 863 - "_get_current_user"
Cohesion: 0.25
...
### Community 864 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 871 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 872 - ".test_every_request_carries_a_real_user_agent"
Cohesion: 0.22
...
### Community 873 - "test_changelog_parity_guard.py"
Cohesion: 0.22
...
### Community 875 - "test_process_quick_note_workflow.py"
Cohesion: 0.25
...
### Community 876 - "TestEveryFullSuiteJobHasMongo"
Cohesion: 0.22
...
### Community 879 - "test_task_clarification.py"
Cohesion: 0.17
...
### Community 883 - "ApplyReviewAgent"
Cohesion: 0.22
...
### Community 885 - "get_output_filter"
Cohesion: 0.32
...
### Community 888 - "hybrid_reasoning.py"
Cohesion: 0.36
...
### Community 889 - "quality_checker.py"
Cohesion: 0.32
...
### Community 890 - "research_coordinator.py"
Cohesion: 0.36
...
### Community 893 - "Agent: Judge (Release / QA Gate)"
Cohesion: 0.25
...
### Community 902 - "AGENTS.md — AI Agent Configuration for local-llm-server"
Cohesion: 0.25
...
### Community 939 - "_is_bedrock_model_id"
Cohesion: 0.27
...
### Community 947 - "TestItIsNotBuiltForOneVendor"
Cohesion: 0.25
...
### Community 948 - "TestKillSwitchDurability"
Cohesion: 0.15
...
### Community 949 - "test_generate_context_standing_instructions.py"
Cohesion: 0.32
...
### Community 950 - "test_local_brain_router_smoke.py"
Cohesion: 0.25
...
### Community 951 - "skill_registry.py"
Cohesion: 0.17
...
### Community 952 - "get"
Cohesion: 0.03
Nodes (79): auth_me(), auto_recommend_skills(), discover_remote_skills(), _get_backend_sam(), get_public_kpis(), get_skill(), github_login(), github_repo_access() (+71 more)

### Community 953 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 956 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 958 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 968 - "Karpathy Guidelines Skill"
Cohesion: 0.29
...
### Community 973 - "Skill: SuperClaude Slash Commands"
Cohesion: 0.29
Nodes (6): Key Classes, Purpose, Related Issues, Skill: SuperClaude Slash Commands, Testing, Usage

### Community 974 - "Skill: SuperClaude Workflow Engine"
Cohesion: 0.29
...
### Community 976 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 977 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 979 - "Platform Controls"
Cohesion: 0.25
...
### Community 981 - "Cloudflare = the real working app"
Cohesion: 0.29
...
### Community 983 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 987 - "Agent Transparency Report"
Cohesion: 0.15
...
### Community 990 - "quickstart.sh"
Cohesion: 0.52
Nodes (6): die(), ensure_env(), ok(), say(), quickstart.sh script, warn()

### Community 991 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 992 - "What to clean up"
Cohesion: 0.18
...
### Community 993 - "test_daily_2026_06_14.py"
Cohesion: 0.38
...
### Community 994 - "test_event_log.py"
Cohesion: 0.45
...
### Community 996 - "TestReasonsAreActionable"
Cohesion: 0.29
...
### Community 997 - "test_brain_failover_413.py"
Cohesion: 0.13
...
### Community 998 - "TestMongoService"
Cohesion: 0.29
...
### Community 1003 - "Runtime troubleshooting"
Cohesion: 0.40
Nodes (4): Agent mode timeout, Missing binary / task harness, Runtime troubleshooting, Workspace validation failures

### Community 1004 - "Music Cues: happy-beats-business-moves-vol-1-by-ende-dot-app"
Cohesion: 0.33
...
### Community 1018 - "test_google_provider_models.py"
Cohesion: 0.18
...
### Community 1019 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 1020 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 1021 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 1023 - "Competitor Analysis — Autonomous AI Agency"
Cohesion: 0.20
...
### Community 1024 - "StatusPill.jsx"
Cohesion: 0.47
Nodes (5): C, STATUS_META, StatusPill(), TONE_BG(), TONE_BORDER()

### Community 1025 - "Issue #1427: quick-note:https://github.com/bingreeky/JIT"
Cohesion: 0.20
...
### Community 1026 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 1027 - "LLM Router — configuration guide"
Cohesion: 0.20
...
### Community 1028 - "AgentSessionStore"
Cohesion: 0.03
Nodes (71): Agent subsystem — planner / executor / verifier loop., AgentEvent, AgentPlan, AgentRunRequest, AgentSession, AgentSessionCreateRequest, AgentSessionMessage, AgentStep (+63 more)

### Community 1029 - "apply_phase1_changes.py"
Cohesion: 0.33
...
### Community 1034 - "CEODispatcher"
Cohesion: 0.06
Nodes (33): CEODispatcher, _offload(), Any, Run a synchronous ledger call without blocking the event loop. ``CEOLedger`` is…, Build an agent.coordinator.TaskSpec from a CEO SpecialistTask., Real CEO delegation: wake runtimes, fan out, and merge results., Decompose the request, wake runtimes, run sub-tasks concurrently, merge.…, Settle the ledger goal once the fan-out has finished. A goal is closed only on… (+25 more)

### Community 1036 - "setup-claude-code.sh script"
Cohesion: 0.60
Nodes (5): log_error(), log_info(), log_success(), print_header(), setup-claude-code.sh script

### Community 1039 - "test_activity_feed.py"
Cohesion: 0.33
...
### Community 1043 - "_register_builtin_tools"
Cohesion: 0.12
Nodes (5): Register the built-in agent tools that are always available., Register the Web Reach capability (agent/web_reach.py): zero-key internet…, _register_builtin_tools(), _register_web_reach_tools(), test_capability_registry_exposes_web_reach_tools()

### Community 1044 - "test_catalogue_probe.py"
Cohesion: 0.33
...
### Community 1045 - "register_user_research_tools"
Cohesion: 0.19
...
### Community 1047 - "test_tasks_awaiting_approval_api.py"
Cohesion: 0.33
...
### Community 1048 - "TestTheAgentRunsCurrentCode"
Cohesion: 0.33
...
### Community 1051 - "Active Task Tracker"
Cohesion: 0.22
...
### Community 1070 - "test_daemon_picks_colibri_8081_when_only_it_listening"
Cohesion: 0.22
...
### Community 1071 - "TestPaidPolicyDurability"
Cohesion: 0.22
...
### Community 1080 - "_add_colibri_shim_changelog_entry.py"
Cohesion: 0.50
...
### Community 1081 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1082 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1083 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 1084 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 1085 - "setup_colibri.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1086 - "setup_colibri.sh script"
Cohesion: 0.70
Nodes (4): setup_colibri.sh script, fail(), ok(), warn()

### Community 1087 - "status_colibri_server.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1088 - "start_tunnel.py"
Cohesion: 0.50
...
### Community 1093 - "nvidia_live_test.py"
Cohesion: 0.40
...
### Community 1094 - "model_discovery.py"
Cohesion: 0.08
Nodes (28): cached_models(), dead_models(), discover_models(), _fresh_entry(), mark_dead(), _models_url(), _parse_ids(), Any (+20 more)

### Community 1096 - "test_mcp_governance.py"
Cohesion: 0.10
Nodes (27): _call(), _engine(), Governance on the MCP HTTP surface — threat-model T11. Before this,…, Same Golden Rule guarantee as the in-process gate., No UI is attached to this surface, so holding the socket would hang it., Headers are a hint, not a credential — and the baseline holds anyway. A caller…, A display name with an em-dash must not take out the tool call., An older image without packages/governance must still work. (+19 more)

### Community 1098 - "TestGhIsNotReAuthenticated"
Cohesion: 0.40
...
### Community 1099 - "TestModelRoleSeparation"
Cohesion: 0.40
...
### Community 1105 - "codebase-explorer.md"
Cohesion: 0.50
Nodes (3): Hard constraints, Method, Output

### Community 1106 - "docs-auditor.md"
Cohesion: 0.50
Nodes (3): Hard constraints, Output, What to check

### Community 1107 - "PortfolioIntelligence"
Cohesion: 0.17
...
### Community 1116 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.25
...
### Community 1117 - "_InMemoryBackend"
Cohesion: 0.18
...
### Community 1118 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 1119 - "render"
Cohesion: 0.50
Nodes (3): RENDER_API_KEY, docker, render

### Community 1120 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 1121 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 1134 - "Continual Harness (`agent/harness_spec.py`)"
Cohesion: 0.25
...
### Community 1136 - "Prime Agent Runtime"
Cohesion: 0.25
...
### Community 1137 - "test_no_exception_detail_leaks.py"
Cohesion: 0.50
...
### Community 1139 - "TestAnthropicWorkspaceIdCapture"
Cohesion: 0.33
...
### Community 1140 - "github"
Cohesion: 0.50
Nodes (3): github, enabled, silent

### Community 1146 - "test_mcp_protocol_version.py"
Cohesion: 0.25
...
### Community 1147 - "_build_curl_cffi_fetcher"
Cohesion: 0.15
Nodes (13): _build_curl_cffi_fetcher(), get(), get_text(), head(), _sess(), _build_pdf(), findings_block(), hr() (+5 more)

### Community 1156 - "test_ping.py"
Cohesion: 0.36
...
### Community 1158 - "TestPoliciesGovernanceStableClaim"
Cohesion: 0.20
...
### Community 1161 - "test_nuclear_cleanup_targets_the_schedule_collection"
Cohesion: 0.25
...
### Community 1206 - "._connect"
Cohesion: 0.22
Nodes (5): Any, Connection, Path, Return a positional slice of the event log for a run., Aggregate CRISPY run-history evidence for burn-in / promotion decisions.…

### Community 1207 - "get_catalog"
Cohesion: 0.20
Nodes (10): get_catalog_models_route(), Return the mirrored model catalog (advisory-only). Flag-gated by…, get_catalog(), get_model_catalog_store(), is_catalog_enabled(), Return the process-wide ModelCatalogStore singleton., Convenience wrapper used by the GET /api/catalog/models endpoint., Convenience wrapper used by the POST sync endpoint + background loop. (+2 more)
...
### Community 1277 - "get_orchestrator_queue"
Cohesion: 0.27
Nodes (9): Return orchestrator queue depth, active runs, and supervisor state (#522)., #522 + #505: Reliability startup — schedule hydration, orchestrator restore,…, _startup_reliability_hooks(), workflow_orchestrator_status(), get_orchestrator_queue(), start_orchestrator_queue(), get_orchestrator_supervisor(), services/orchestrator_supervisor.py — Deterministic Supervisor Issue #522: A… (+1 more)

### Community 1278 - "OutputFilter"
Cohesion: 0.24
...
### Community 1279 - "_execute_skill_impl"
Cohesion: 0.24
Nodes (7): _execute_skill_impl(), _get_portfolio_manager(), Any, Recommend skills based on detected systems and provisioned specialists. With no…, Execute a skill by ID and update its execution counters., Lazily build and cache the shared PortfolioManager., Execute a skill by delegating to the actual Python module. This is the bridge…

### Community 1280 - "Phases"
Cohesion: 0.33
...
### Community 1281 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 1282 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 1283 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 1285 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 1286 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 1292 - ".daily_active_users"
Cohesion: 0.40
...
### Community 1298 - "TestDirectChatAgentExecution"
Cohesion: 0.33
...
### Community 1299 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 1300 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 1302 - "_answer_callback"
Cohesion: 0.29
...
### Community 1303 - "sam.py"
Cohesion: 0.33
Nodes (5): get_sam(), agent/sam.py — SAM Voice Agent (System Autonomy Manager) SAM is the voice-…, get_sam() must return the same instance., test_get_sam_returns_singleton(), get_agency_status()

### Community 1304 - "test_doctor_coding_brain.py"
Cohesion: 0.32
...
### Community 1311 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.25
...
### Community 1312 - "[5.0.0]"
Cohesion: 0.29
Nodes (7): [5.0.0], Added, Changed, Fixed, Maintenance, Removed, Security

### Community 1314 - "Changelog"
Cohesion: 0.29
Nodes (7): Added, Changed, Changelog, Fixed, Maintenance, Removed, Security

### Community 1317 - "test_activity_logs.py"
Cohesion: 0.67
Nodes (3): clear_error_log_buffer(), _auth_headers(), test_activity_endpoint_includes_recent_error_logs()

### Community 1318 - "_InMemoryErrorLogHandler"
Cohesion: 0.50
Nodes (3): _ensure_error_log_capture(), _InMemoryErrorLogHandler, LogRecord

### Community 1321 - "test_the_reserve_is_bounded_when_read_from_the_environment"
Cohesion: 0.67
...
### Community 1323 - "InitiativeProgress"
Cohesion: 0.33
...
### Community 1324 - "Feature Support Matrix"
Cohesion: 0.33
Nodes (6): Admin API, Config Overrides, Feature Matrix, Feature Support Matrix, Gating Behavior, Maturity Tiers

### Community 1326 - "Next Action"
Cohesion: 0.29
Nodes (6): Current state, Next Action, Next daily run (2026-09-23), Outstanding PRs (not this session's), PR #1560 — daily-2026-09-22 catalog updates, Recently merged

### Community 1327 - ".test_missing_binary_produces_structured_validation_issue"
Cohesion: 0.33
Nodes (4): Preflight must return RuntimeReadinessReport with issues, not raise., execute(), health_check(), required_dependencies()

### Community 1329 - "_probe_openai_compat"
Cohesion: 0.50
Nodes (4): _describe_http_status(), _probe_openai_compat(), Probe an OpenAI-compatible provider (Cerebras / Groq / NIM / Z.ai / Aerolink)., Turn an HTTP status into a short, human-readable reason. The plan specifically…

### Community 1330 - "_clean_director"
Cohesion: 0.50
...
### Community 1331 - "test_probe_reports_dns_failure_end_to_end"
Cohesion: 0.50
...
## Knowledge Gaps
- **3554 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3549 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 14462 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **170 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `_fixture()` connect `_fixture` to `ClaudeCodeAdapter`, `test_provider_router.py`, `test_autonomy_status.py`, `test_brain_patch_service_token.py`, `build_llm_router`, `test_portfolio_intake.py`, `test_llm_router_queue_cache.py`, `test_llm_router_strategies.py`, `test_harness_spec.py`, `test_task_service_failed_comment.py`, `test_catalogue_probe.py`, `test_platform_controls.py`, `test_operational_incidents.py`, `SQLiteStore`, `TestRuntimeControl`, `_start_ceo_agency`, `SelfHealingAgent`, `Specialist`, `test_company_api.py`, `Settings`, `test_langfuse_agency_wide.py`, `test_phase5_doctor.py`, `TaskStatus`, `test_failover_client_shared.py`, `get_workflow_orchestrator`, `Task`, `E2BSandboxSession`, `UserRole`, `test_model_router.py`, `get_improvement_loop`, `test_ceo_router.py`, `PolicyEngine`, `KeyRing`, `test_agent_tool_governance.py`, `claim`, `e2e/test_browser.py`, `validate_policy_text`, `test_openclaw_endpoints.py`, `PrimeAgentAdapter`, `client`, `model_discovery.py`, `nvidia_models.py`, `Agency`, `services/seo_audit.py`, `router_factory`, `quick_note.py`, `test_local_brain_state.py`, `ModelRouter`, `models/seo_audit.py`, `ExecutionRequest`, `config.py`, `TestChatHistoryStore`, `test_refresh_agent_built_proof.py`, `_Recorder`, `TestClient`, `test_procedural_memory.py`, `TaskWorkflowService`, `test_knowledge_sync.py`, `test_sam_voice.py`, `test_provider_state_durability.py`, `ArtifactStore`, `test_new_features_e2e.py`, `direct_chat.py`, `test_control_plane_api.py`, `test_sam_livekit.py`, `TokenBudget`, `test_voice_pipeline.py`, `test_mcp_protocol_version.py`, `AgentRunner`, `test_startup_warmup.py`, `test_ping.py`, `ChatHistoryStore`, `persist_plan_spec`, `test_context_rulebook.py`, `test_brain_failover.py`, `test_llm_router_e2e.py`, `test_trend_watcher.py`, `KeyStore`, `test_kimi_bridge_server.py`, `_step`, `test_autonomous_agency_e2e.py`, `_is_exempt`, `test_trend_scoping.py`, `_run_analyze`, `test_openclaw_gateway.py`, `TestEstimateTokensForMessages`, `ResearchOrchestrator`, `run_task`, `test_issue_intake.py`, `WorkflowBuildRequest`, `test_e2b_data_flow.py`, `test_e2b_task_wiring.py`, `register_webui`, `OllamaCircuitBreaker`, `_job_text`, `test_video_transcript.py`, `test_daily_2026_07_27.py`, `MCPClient`, `SchedulerStore`, `test_telegram_approval_gate.py`, `test_features_api.py`, `TrendWatcher`, `TestAuthAndTaskOwnership`, `test_agile_api.py`, `test_app_settings.py`, `test_brain_availability_doctor.py`, `test_llm_router_disabled.py`, `test_monitor_lib.py`, `test_spa_trailing_slash_redirect.py`, `test_telegram_webhook.py`, `ContextPruner`, `test_purge_backlog.py`, `ai/watchdog.py`, `test_rate_limiter.py`, `test_persistent_memory.py`, `TestSwarmRoleRouting`, `test_provider_enable_disable.py`, `SecurityScanner`, `AgentDefinition`, `TestClient`, `test_nvidia_model_discovery.py`, `OutputFilter`, `test_doctor_coding_brain.py`, `telegram_inbound_handlers.py`, `test_runtimes_health_endpoint.py`, `test_task_store_fails_loud_in_production.py`, `analyze_page`, `TestFeaturesAPI`, `routed`, `clear_cooldowns`, `_clean_director`, `cost_tracker.py`, `_Budget`, `_resolve_push_token`, `test_agency_fix.py`, `TestTheWorkflowIsSafeAndReadOnly`, `test_skill_registry_boot_refresh.py`, `TestMongoGate`, `OrchestratorCheckpointStore`, `_redact_for_notification`, `session_retro.py`, `AgentSwarm`, `test_regression.py`, `test_agent_scripts_share_one_model_list.py`, `api_keys_for`, `test_crispy_burn_in.py`, `test_executive_advisory_api.py`, `test_process_quick_note_workflow.py`, `test_task_clarification.py`, `isolated_telegram_config`, `_Recorder`, `test_scheduler_hydration_bounded.py`, `_undeclared`, `test_service_token.py`, `test_telegram_diag_endpoint.py`, `DirectChatDoctor`, `test_agent_free_brain.py`, `test_v4_api.py`, `captured`, `UsageEvent`, `test_gh_brain_failover.py`, `resolve_active_brain`, `test_provider_410_per_model.py`, `SQLiteStore`, `TestHarnessAdapter`, `test_brain_failover_413.py`, `NotificationDispatcher`, `test_webui_provider_priority.py`, `TestNormalizeResponseFormat`?**
  _High betweenness centrality (0.099) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `AgentSessionStore`, `GitHubTools`, `test_backend_server_features.py`, `AdaptiveHalter`, `RuntimeHealth`, `ContextManager`, `proxy.py`, `CEODispatcher`, `InternalAgentAdapter`, `TaskSpec`, `test_ceo_micromanager.py`, `test_empirical_verify.py`, `ReactScratchpad`, `WorkspaceTools`, `test_autonomous_agency_e2e.py`, `LocalWorkspace`, `MultiAgentSwarm`, `test_failover_client_shared.py`, `E2BSandboxSession`, `PolicyEngine`, `test_agent_free_brain.py`, `StuckDetector`, `test_agent_tool_governance.py`, `BrainFailoverExhausted`, `test_agent_runner.py`, `test_governance_api.py`, `enforcement.py`, `workflow_orchestrator.py`, `Agency`, `UserMemoryStore`, `MCPClient`, `loop.py`, `ExecutionRequest`, `build_governance_router`, `test_brain_failover_413.py`, `TestAgentLoopMCPIntegration`, `RewardScorer`, `FreeBuffAgent`, `direct_chat.py`, `TokenBudget`, `ContextPruner`, `test_agent_chat_integration.py`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderRouter` to `backend/server.py`, `test_provider_router.py`, `failover_client.py`, `test_bedrock_live.py`, `test_kimi_bridge_provider.py`, `call_llm`, `test_colibri_provider.py`, `NvidiaProvider`, `implement_agent.py`, `TestOpenAiToBedrockConverse`, `TestLegacyRouterServerFallback`, `clear_cooldowns`, `TestLegacyRouterCacheTTL`, `register_webui`, `TrafficDirector`, `TestAnthropicPayloadStructuredOutput`, `test_provider_410_per_model.py`, `settings.py`, `test_all_providers_discovery.py`, `TestRouterIntegration`, `_payload`, `test_implement_agent_routing.py`, `ProviderConfig`, `direct_chat.py`, `test_anthropic_refusal_fallback.py`, `test_bedrock_provider.py`, `system_instruction`?**
