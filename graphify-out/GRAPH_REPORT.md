...
## Corpus Check
- 1475 files · ~2,154,651 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 30102 nodes · 55785 edges · 1260 communities (1083 shown, 122 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 2727 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `46aa2ecc`
...
- `test_python_parses()` --calls--> `python_parses()`  [INFERRED]
...
## Communities (1260 total, 122 thin omitted)
...
Cohesion: 0.05
Nodes (45): is_commercial_provider(), provider_access_tier(), _provider_field(), provider_sort_key(), ProviderConfig, local_brain_enabled(), local_brain_provider_config(), local_brain_status() (+37 more)
...
Cohesion: 0.04
Nodes (73): _egress_policy_reason(), agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Return why governance policy blocks *host*, or None. Runs strictly *after* the…, _action_matches(), _as_list(), Decision, GroupPolicy, _host_matches() (+65 more)
...
Cohesion: 0.03
Nodes (114): _active_primary_provider(), BrainConfig, BrainConfigPatch, BrainConfigStore, default_brain_config(), get_brain_config(), invalidate_brain_config_cache(), is_north_mini_code_default() (+106 more)

### Community 14 - "TaskWorkflowService"
Cohesion: 0.04
Nodes (68): ApprovalCheckpoint, Human approval gate in a task's execution., _gate_outward_facing_enabled(), _is_brain_connection_error(), _is_outward_facing(), Any, BaseException, Task (+60 more)
...
### Community 17 - "get"
Cohesion: 0.02
Nodes (95): auth_me(), brain_failover_status(), brain_providers(), _check_storage_health(), cost_attribution_stats(), cost_table(), discover_remote_skills(), doctor_health() (+87 more)

### Community 18 - "LLMRequest"
Cohesion: 0.02
Nodes (170): ProviderConfig, One configured endpoint. ``kind`` selects the adapter: ``openai`` (any OpenAI-…, packages/llm — the multi-provider LLM routing layer. Every LLM call in this…, AnthropicProvider, Any, AsyncClient, packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, Translate OpenAI-shaped messages into Anthropic's system/turn split. (+162 more)

### Community 19 - "_fixture"
Cohesion: 0.02
Nodes (114): parse_event_stream(), ParsedRun, Structured view of one ``--mode json`` event stream., Reduce a ``--mode json`` NDJSON stream to a :class:`ParsedRun`. Kept a module-…, Drop the cached Mongo client, backoff, and read caches (tests)., reset_kv_state(), app_client(), _clear_discovered_models() (+106 more)
...
Cohesion: 0.05
Nodes (100): Split the request into briefed, tier-assigned specialist sub-tasks. Returns the…, build_subtask_brief(), _coerce_subtasks(), decompose(), _env_flag(), _env_int(), _extract_json_object(), fallback_decomposition() (+92 more)

### Community 22 - "get_agent_store"
Cohesion: 0.04
Nodes (60): get_agent_store(), autonomy_status(), Public autonomy readiness probe — no authentication required. A live deploy…, CompanyAgencyService, get_company_agency_service(), _is_runtime_available_sync(), _pick_available_runtime(), Any (+52 more)

### Community 23 - "Task"
Cohesion: 0.04
Nodes (71): Full task/issue document., Task, One-line human explanation of why this task needs human approval. Reads risk…, Best-effort label of who will run this task once approved. Returns…, PUBLIC_URL-anchored dashboard deep link for the task detail. Returns empty…, Best-effort Telegram heads-up that a task is parked awaiting approval. Inline…, asyncio, The reconciler must not re-queue tasks parked at the pre-execution gate.… (+63 more)

### Community 24 - "AgentJob"
Cohesion: 0.21
Nodes (5): AgentJob, _now(), Any, Run a job using the provided runner and update the job's lifecycle, progress,…, Serialize the AgentJob to a JSON-serializable dictionary for external clients.…

### Community 25 - "CompanyGraphStore"
Cohesion: 0.02
Nodes (55): Company, The core company entity - root of the Company Graph., Find a repository by its URL., A company repository with detected technologies and metadata., Extract the owner from the full name., Extract the repository name from the full name., Repo, requires_db (+47 more)
...
Cohesion: 0.03
Nodes (94): PreflightIssue, PreflightReport, BaseModel, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, Agent subsystem — planner / executor / verifier loop., AgentJobManager, AgentEvent, AgentPlan (+86 more)
...
Cohesion: 0.04
Nodes (88): ApprovalStatus, ApprovalStore, get_approval_store(), Enum, str, packages/governance/approvals.py — human-in-the-loop for high-risk actions. The…, Bounded, in-process store of approval requests. Uses a :class:`threading.Lock`…, Block until *approval_id* is resolved or its TTL expires. Combines an event… (+80 more)

### Community 31 - "ImprovementLoop"
Cohesion: 0.12
Nodes (8): ImprovementLoop, _now(), Any, Path, Background scanner and task dispatcher for continuous codebase improvement.…, Run a scan immediately (blocking). Returns newly detected issues., Register + schedule a fix for an issue detected outside the scan cycle. Shared…, test_get_status_is_dict()
...
Cohesion: 0.04
Nodes (39): field_validator, Site-level facts discovered during the crawl., Request to run an SEO/GEO/AIO audit against a website., SeoAuditRequest, SeoSiteFindings, _count_syllables(), estimate_pixel_width(), flesch_reading_ease() (+31 more)

### Community 39 - "WebsiteScanner"
Cohesion: 0.03
Nodes (95): DetectedSystem, Evidence, Result of a website scan with detected systems and stack inference., Evidence supporting a system detection., A business system detected on a company's website or in their stack., Get the most confident evidence description., Inferred technology stack from website/repo analysis., StackInference (+87 more)
...
Cohesion: 0.05
Nodes (52): _load(), mcp_server/governance.py — governance adapter for the MCP HTTP surface. Closes…, Write the audit row for a completed (or blocked) MCP tool call., Import the governance layer once, recording why if it is absent., record(), events_from_identity(), Any, Convenience: build and record an event in one call. (+44 more)

### Community 42 - "AgentRunner"
Cohesion: 0.03
Nodes (94): AgentPhaseError, AgentRunner, _nvidia_api_key(), Any, Exception, Path, Governance seam: judge the call, run it, audit the outcome. Deliberately a thin…, Append an event to the durable session log if a store is wired in. (+86 more)
...
Cohesion: 0.07
Nodes (25): Root directory under which repo fixes are allowed to operate., Run the repo-aware auto-fixer against this company's workspace checkout.…, run_seo_fixes(), _workspace_root(), FsPath, Request to remediate auto-fixable findings in a local code repository., SeoFixRequest, _humanize_filename() (+17 more)
...
Cohesion: 0.04
Nodes (80): BoundContext, ClassifyOutput, ExecutionRequest, ExecutionResult, get_workflow_orchestrator(), JudgeVerdict, MonitorOutput, _orchestrator_bypass() (+72 more)

### Community 52 - "test_agent_tool_governance.py"
Cohesion: 0.05
Nodes (63): Replace the process-wide store. Tests only., reset_approval_store(), Replace the process-wide audit log. Tests only., reset_audit_log(), Load a policy document from YAML, falling back to the default. Never raises:…, Replace the process-wide engine. Tests only., reset_policy_engine(), _drive() (+55 more)
...
Cohesion: 0.05
Nodes (75): _enrich_runtimes(), get_decision_log(), get_policy(), get_runtime(), list_runtimes(), _load_rich_policy(), PolicyUpdateBody, Any (+67 more)
...
Cohesion: 0.08
Nodes (35): _check_extra_kwargs(), _enforce_signature(), _note_phase_end(), _note_phase_start(), loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., Raise TypeError if fn's signature drifts from the locked contract (Pydantic…, Raise TypeError on unknown kwarg (runtime extra='forbid' for non-Pydantic…, # NOTE: "ollama_base" is kept for backwards compatibility; this runner only… (+27 more)
...
Cohesion: 0.08
Nodes (33): clear_cooldowns(), get_dead_models(), is_provider_on_cooldown(), mark_provider_failed(), Snapshot of active dead-model entries {provider_id/model: expiry_ts}. Also…, Put provider_id on cooldown for *cooldown_seconds* (default:…, Return True if provider_id is currently on cooldown., Clear all cooldown entries (useful for testing). Delegates to… (+25 more)
...
### Community 69 - "ProviderRouter"
Cohesion: 0.07
Nodes (34): _get_director(), ProviderAttempt, ProviderFallbackError, ProviderRouter, Any, Response, RuntimeError, Try all models for one provider. Returns ProviderResult on success, None on… (+26 more)
...
Cohesion: 0.05
Nodes (70): quick_notes_submit(), _QuickNoteBody, Submit a quick-note URL or instruction from the dashboard FAB., get_failover_manager(), Return the singleton BrainFailoverManager., Reset the singleton (for tests)., reset_failover_manager(), Hand the 'connect & verify the repo' work to the agency's own agents. The task… (+62 more)
...
Cohesion: 0.07
Nodes (25): allow_paid_brain(), is_anthropic_model(), True only when the operator explicitly opted into a paid (Anthropic) brain.…, True when *model* names a paid Anthropic/Bedrock-Claude model. Covers native…, _opus_model(), Return an Opus model ID iff the operator explicitly opted into a paid brain.…, _FakeAsyncClient, _FakeResponse (+17 more)
...
Cohesion: 0.05
Nodes (55): e2b_status(), Return the E2B sandbox integration status for the ProvidersScreen badge. Does…, e2b_enabled(), E2BConfig, _env_falsy(), _env_truthy(), services/e2b_config.py — Single reader of E2B sandbox environment config.…, Return ``True`` when E2B sandboxing should be activated. **EXPERIMENTAL… (+47 more)
...
Cohesion: 0.06
Nodes (62): project_session_cost(), Project costs for a typical coding session. Args: avg_session_latency_ms: Total…, get_decisions_store(), Process-wide DecisionsStore singleton (resettable via db_path arg)., Return a Markdown-v1-safe preview string under ``max_chars``. Used by the…, sanitize_paste_for_preview(), _admin_headers(), _answer_callback() (+54 more)
...
Cohesion: 0.03
Nodes (70): _brain_provider_status(), get_brain_policy_route(), Return per-provider metadata for the GET endpoint. Iterates every provider in…, Return the discovered model list for *provider_id*, or ``[]`` if unknown., Return the active brain config + per-provider key-present flags. The response…, _served_models(), emit_agency_observation(), Record an agency platform operation in Langfuse. Unlike… (+62 more)
...
Cohesion: 0.06
Nodes (40): _check_rate_limit(), default_keys_path(), issue_new_api_key(), KeyRecord, KeyStore, load_key_store(), Exception, Path (+32 more)
...
Cohesion: 0.02
Nodes (126): int, CacheManager, cosine_similarity(), _Entry, LRUCache, payload_key(), Any, T (+118 more)

### Community 135 - "RenderFinding"
Cohesion: 0.07
...
### Community 145 - "ai/router.py"
Cohesion: 0.05
Nodes (48): _dead_model_key(), _exponential_backoff_cooldown(), _is_model_dead(), _mark_model_dead(), _normalized_provider_type(), _notify_watchdog(), _ollama_reasoning_effort(), provider_router.py — auto-generated module docstring (user-research skill scan). (+40 more)
...
Cohesion: 0.10
Nodes (45): _audit_dispatch(), _blocked_result(), _governance_check(), Build the failed TaskResult returned when policy denies a dispatch. A result…, Evaluate a runtime dispatch against policy; audit it either way. Returns…, Record one runtime-dispatch decision in the audit trail. The instruction body…, _decision(), _engine() (+37 more)
...
Cohesion: 0.07
Nodes (42): _extract_mentioned_paths(), Pick the auto-PR model from the recommended free-cloud chain by key. Mirrors…, Extract plausible file paths from issue text., Read existing files for codebase context (max 8000 chars total)., _read_grounding_files(), _select_brain(), diff_is_sloppy(), is_destructive_overwrite() (+34 more)
...
Cohesion: 0.03
Nodes (75): Backoff policy for retryable failures., RetryConfig, _digest(), KeyRing, KeyState, packages/llm/keys.py — multi-key rotation with per-key health. A provider may…, Per-provider round-robin key selection with cooldowns., Return the next healthy key and its index. Returns ``(None, -1)`` when every… (+67 more)
...
Cohesion: 0.02
Nodes (152): DetectedIssue, ImprovementLoopState, IssueCategory, IssueSeverity, Enum, str, agent/improvement_loop.py — Continuous Improvement Engine Background scanner…, Build a rich, structured GitHub issue body with actionable context. Unlike the… (+144 more)
...
Cohesion: 0.04
Nodes (53): get_sam(), agent/sam.py — SAM Voice Agent (System Autonomy Manager) SAM is the voice-…, _get_backend_sam(), legacy_scheduler_get(), Lazy-init the SAM agent for the backend deployment., Get SAM's current status., sam_status_backend(), get_store() (+45 more)
...
Cohesion: 0.05
Nodes (37): _keepalive_self_ping(), lifespan(), _maybe_boot_purge(), _purge_backlog_core(), _purge_summary_clean(), Run the FreeBuff Telegram bot, restarting it on unexpected exit., Ping our own public URL so a free-tier web service doesn't sleep. Render free…, Start the Telegram bot (and keep-alive) inside the web process when enabled.… (+29 more)

### Community 272 - "brain_failover.py"
Cohesion: 0.03
Nodes (80): BrainFailoverManager, _disabled_from_mongo(), _disabled_from_sqlite(), _is_paid_allowed_db(), _kv_connect(), _kv_path(), _mongo_db(), _mongo_enabled() (+72 more)
...
### Community 274 - "test_ceo_router.py"
Cohesion: 0.08
...
### Community 287 - "admin_gui.py"
Cohesion: 0.07
Nodes (16): Browser admin UI for login, service control, key management, and diagnostics., Update or append a KEY=value line in the .env file., register_admin_gui(), _save_env_var(), get_output_filter(), Get or create the singleton OutputFilter instance., get_cooldown_state(), Return a snapshot of active cooldowns {provider_id: expiry_unix_timestamp}. (+8 more)
...
### Community 298 - "AgentDefinition"
Cohesion: 0.08
Nodes (19): AgentCreateRequest, AgentDefinition, AgentUpdateRequest, Any, BaseModel, field_validator, agents/store.py — Persistent store for user-defined agent configurations.…, Return an agent by ID. If *owner_id* is provided, enforces that the agent… (+11 more)
...
Cohesion: 0.07
Nodes (46): get_brain_preference(), Return the operator's brain provider preference. Values: - ``"nvidia"`` —…, colibri_enabled(), colibri_provider_config(), colibri_status(), ProviderConfig, providers/colibri.py — Free local GLM-5.2 brain served by JustVugg/colibri.…, Return True iff the operator opted in via ``COLIBRI_ENABLED=true``. (+38 more)
...
Cohesion: 0.13
Nodes (19): _decline(), _extract_pytest_failure(), _fetch_failure_context(), _list_target_prs(), main(), _post_comment(), _pr_head(), _prior_attempt_count() (+11 more)
...
### Community 338 - "governance/audit.py"
Cohesion: 0.07
...
### Community 374 - "test_crispy_workflow.py"
Cohesion: 0.07
...
Cohesion: 0.04
Nodes (108): build_seo_roadmap(), delegate_seo_findings(), _expire_stale_pending_report(), export_seo_audit(), get_seo_audit(), list_seo_audits(), plan_seo_sprint(), BaseModel (+100 more)
...
Cohesion: 0.10
Nodes (28): start_in_process must be a safe no-op in the test environment (conftest sets…, Flag on but LiveKit env absent → logged no-op, never raises., test_start_in_process_noop_under_testing(), test_start_in_process_noop_when_unconfigured(), LiveKitConfig, voice/livekit_config.py — LiveKit configuration (config module). Centralizes…, Resolved LiveKit + speech-provider configuration., True when the LiveKit room transport itself is usable. (+20 more)
...
Cohesion: 0.07
Nodes (44): free_nvidia_models(), FreeBuffAgent, Return the curated list of free NVIDIA NIM models FreeBuff may use., Codebuff-style coding agent pinned to free NVIDIA NIM models. FreeBuff is a…, List the free NVIDIA NIM models a user may pick (e.g. via Telegram)., True when *model* is in the curated free NVIDIA NIM set., check_rate_limit(), _enforce_rate_limit() (+36 more)
...
Cohesion: 0.05
Nodes (45): AgentStore, CRUD store for AgentDefinition objects. Uses MongoDB when a `db` client is…, packages/security/redact.py — strip secrets out of strings before they reach a…, Strip embedded credentials from a connection URI before logging it. Covers both…, redact_connection_url(), main(), Register runtime agents in the store., register_runtimes() (+37 more)
...
### Community 446 - "services/background.py"
Cohesion: 0.05
Nodes (58): get_improvement_loop(), get_skill_registry_safe(), Return the global SkillRegistry if set, else None. Used by onboarding and other…, get_trend_watcher(), agent/trend_watcher.py — Internet-connected AI trend intelligence. Fetches from…, set_trend_watcher(), _await_hermes_ready(), BackgroundServices (+50 more)
...
### Community 466 - "weekly_digest.py"
Cohesion: 0.13
...
### Community 478 - "TelegramBotManager"
Cohesion: 0.12
...
### Community 522 - "test_workflow_orchestrator_scoping.py"
Cohesion: 0.18
...
### Community 541 - "test_daily_automation_2026_07_09.py"
Cohesion: 0.16
...
### Community 545 - "telegram_service.py"
Cohesion: 0.16
...
Cohesion: 0.19
Nodes (16): _process_task_callback(), Handle Approve/Reject inline-button presses for task execution gates. Callback…, _escape_md_v1(), Escape Telegram Markdown-v1 reserved chars in free-text fields. Markdown-v1…, _Captured, _make_fake_task(), _patch_workflow(), Robustness tests for the Telegram inline-button callback flow. (+8 more)
...
### Community 620 - "test_doctor_service_token_check.py"
Cohesion: 0.23
...
### Community 664 - "make_isolated_workspace"
Cohesion: 0.33
...
Cohesion: 0.25
Nodes (5): _load(), main(), input_schema passthrough — native Anthropic tools should not be wrapped again., AnthropicProvider.build_payload caches the tool list when prompt_caching=True…, TestAnthropicToolListCaching

### Community 671 - "mask_secret"
Cohesion: 0.25
...
### Community 672 - "test_event_log.py"
Cohesion: 0.45
...
### Community 675 - "_harvest_changed_files"
Cohesion: 0.29
...
### Community 677 - "resolve_free_nvidia_brain"
Cohesion: 0.12
...
### Community 759 - "_build_direct_chat_schedule_suggestion"
Cohesion: 0.32
...
### Community 793 - "test_server_autonomy_and_index_fixes.py"
Cohesion: 0.29
...
### Community 807 - "_known_tool_names"
Cohesion: 0.29
...
### Community 815 - "CompanyGraphService"
Cohesion: 0.03
...
Cohesion: 0.03
Nodes (90): CEOResult, _decompose_into_subtasks(), get_ceo_dispatcher(), _merge_changed_files(), Return the shared CEODispatcher singleton., Reset the singleton (test helper)., Aggregated output from a multi-specialist execution., Decompose a request into 2-3 sub-tasks for specialist fan-out. Default… (+82 more)

### Community 843 - "CEODispatcher"
Cohesion: 0.07
Nodes (36): CEODispatcher, _complexity_rank(), _offload(), Any, Semaphore, services/ceo_dispatcher.py — Real CEO delegation layer. The CEO splits a…, Run a synchronous ledger call without blocking the event loop. ``CEOLedger`` is…, Build an agent.coordinator.TaskSpec from a CEO SpecialistTask. (+28 more)
...
### Community 874 - "_scheduler_on_fire"
Cohesion: 0.50
...
### Community 875 - "pytest_collection_modifyitems"
Cohesion: 0.50
...
### Community 882 - "_get_current_user_thunk"
Cohesion: 0.67
Nodes (3): _get_current_user_thunk(), _get_optional_user_thunk(), Request

### Community 883 - "JWTUserStateMiddleware"
Cohesion: 0.67
...
- **3463 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3458 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 13262 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **122 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `_fixture()` connect `_fixture` to `test_brain_patch_service_token.py`, `CEOLedger`, `llm/router.py`, `WorkflowRun`, `PolicyEngine`, `TaskStore`, `brain_config.py`, `TaskWorkflowService`, `test_llm_router_strategies.py`, `AuditLog`, `SelfHealingAgent`, `Task`, `AgentSessionStore`, `test_company_api.py`, `test_daily_automation_2026_07_09.py`, `test_unit8_model_catalog.py`, `Agency`, `test_failover_client_shared.py`, `E2BSandboxSession`, `test_catalogue_probe.py`, `SeoAuditEngine`, `WebsiteScanner`, `PrimeAgentAdapter`, `resolve_active_brain`, `SeoFixer`, `test_agent_tool_governance.py`, `test_model_router.py`, `test_openclaw_endpoints.py`, `TestAgentRunnerSafety`, `test_task_service_failed_comment.py`, `clear_cooldowns`, `test_sam_livekit.py`, `ProviderRouter`, `ChatHistoryStore`, `ArtifactStore`, `SQLiteStore`, `test_telegram_auto_approve.py`, `ResearchTask`, `TestClient`, `test_ai_insights.py`, `test_autonomy_status.py`, `test_procedural_memory.py`, `_process_task_callback`, `test_langfuse_agency_wide.py`, `test_local_brain_state.py`, `test_phase5_doctor.py`, `test_agent_free_brain.py`, `test_refresh_agent_built_proof.py`, `test_startup_warmup.py`, `test_telegram_diag_endpoint.py`, `resolve_e2b_config`, `run_task`, `test_doctor_service_token_check.py`, `cost_tracker.py`, `BackgroundAgent`, `UserRole`, `test_context_rulebook.py`, `e2e/test_browser.py`, `test_provider_router.py`, `BrainWatchdog`, `KeyStore`, `test_issue_intake.py`, `test_llm_router_queue_cache.py`, `_step`, `TestAuthAndTaskCreation`, `test_trend_scoping.py`, `_StubProvider`, `ai/router.py`, `MCPClient`, `persist_plan_spec`, `config.py`, `rate_limiter.py`, `test_daily_2026_07_27.py`, `test_openclaw_gateway.py`, `test_telegram_freebuff.py`, `NotificationDispatcher`, `OllamaCircuitBreaker`, `test_telegram_webhook.py`, `_job_text`, `test_e2b_task_wiring.py`, `BudgetTracker`, `test_features_api.py`, `test_new_features_e2e.py`, `test_video_transcript.py`, `test_llm_router_resilience.py`, `test_process_quick_note_workflow.py`, `_Budget`, `nvidia_models.py`, `TrendWatcher`, `TestMongoGate`, `TestRuntimeControl`, `test_portfolio_intake.py`, `test_trend_watcher.py`, `test_e2b_data_flow.py`, `TestClient`, `AgentSwarm`, `test_webui_provider_priority.py`, `ContextPruner`, `test_operational_incidents.py`, `TestEstimateTokensForMessages`, `get_scheduler`, `test_implement_agent_routing.py`, `test_agile_api.py`, `test_app_settings.py`, `TestSwarmRoleRouting`, `WorkflowBuildRequest`, `test_persistent_memory.py`, `SecurityScanner`, `ModelRouter`, `test_task_clarification.py`, `test_llm_router_e2e.py`, `OutputFilter`, `test_platform_controls.py`, `brain_failover.py`, `test_kimi_bridge_server.py`, `test_ceo_router.py`, `test_sam_voice.py`, `OrchestratorQueue`, `test_nvidia_model_discovery.py`, `session_retro.py`, `TestFeaturesAPI`, `test_llm_router_disabled.py`, `test_purge_backlog.py`, `test_provider_enable_disable.py`, `OrchestratorCheckpointStore`, `analyze_page`, `DirectChatDoctor`, `_resolve_push_token`, `TrafficDirector`, `test_agent_scripts_share_one_model_list.py`, `test_crispy_burn_in.py`, `test_skill_registry_boot_refresh.py`, `_resolve_brain_provider`, `test_freebuff_bot.py`, `isolated_telegram_config`, `test_scheduler_hydration_bounded.py`, `test_dashboard_cache.py`, `_undeclared`, `test_crispy_workflow.py`, `test_claude_code_adapter.py`, `test_service_token.py`, `test_harness_spec.py`, `test_brain_failover_413.py`, `test_regression.py`, `test_agency_fix.py`, `TestHarnessAdapter`, `test_monitor_lib.py`, `test_v4_api.py`, `AgentStore`, `SchedulerStore`, `services/background.py`, `test_knowledge_sync.py`, `test_ping.py`, `test_runtimes_health_endpoint.py`, `TestNormalizeResponseFormat`, `KeyPool`, `test_task_store_fails_loud_in_production.py`, `test_provider_state_durability.py`, `_Recorder`, `test_telegram_service_webhook.py`, `test_voice_pipeline.py`, `client`, `TestTheWorkflowIsSafeAndReadOnly`, `test_doctor_coding_brain.py`, `get_self_healing_agent`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `WorkflowRun`, `ReactScratchpad`, `backend/server.py`, `proxy.py`, `ContextManager`, `PolicyEngine`, `TaskSpec`, `test_governance_api.py`, `MCPClient`, `test_brain_failover_413.py`, `AgentSessionStore`, `test_daily_automation_2026_07_09.py`, `Agency`, `StuckDetector`, `E2BSandboxSession`, `test_failover_client_shared.py`, `MultiAgentSwarm`, `test_e2b_adapter.py`, `test_empirical_verify.py`, `FreeBuffAgent`, `LocalWorkspace`, `test_agent_chat_integration.py`, `ExecutionRequest`, `test_agent_tool_governance.py`, `WorkspaceTools`, `TestAgentRunnerSafety`, `direct_chat.py`, `test_backend_server_features.py`, `loop.py`, `.execute`, `TestAgentLoopMCPIntegration`, `_resolve_push_token`, `UserMemoryStore`, `TestAgentRunnerExecution`, `CEODispatcher`, `test_agent_free_brain.py`, `AdaptiveHalter`, `ContextPruner`, `TokenBudget`, `InternalAgentAdapter`, `GitHubTools`, `BackgroundAgent`, `test_daily_automation_2026_07_11.py`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderRouter` to `ProviderConfig`, `backend/server.py`, `TestLegacyRouterServerFallback`, `test_bedrock_provider.py`, `ai/router.py`, `test_bedrock_live.py`, `TestRouterIntegration`, `settings.py`, `kimi_bridge_provider_config`, `test_model_catalog.py`, `test_colibri_brain_shim.py`, `TestLegacyRouterCacheTTL`, `direct_chat.py`, `test_backend_server_features.py`, `clear_cooldowns`, `test_anthropic_refusal_fallback.py`, `failover_client.py`, `TrafficDirector`, `system_instruction`, `NvidiaProvider`, `test_implement_agent_routing.py`, `TestAnthropicPayloadStructuredOutput`, `test_all_providers_discovery.py`, `test_provider_router.py`, `model_discovery.py`, `_payload`, `implement_agent.py`?**
