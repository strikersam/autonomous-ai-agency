# Graph Report - autonomous-ai-agency  (2026-09-13)

## Corpus Check
- 1506 files · ~2,183,307 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 30506 nodes · 56951 edges · 1291 communities (1114 shown, 129 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 3331 edges (avg confidence: 0.92)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `03584238`
...
- .cleanup_workspace
- .get_decision_log
- test_runtime_is_a_distinct_surface_from_docker
...
### Community 3 - "test_operational_incidents.py"
Cohesion: 0.02
...
### Community 4 - "TaskStore"
Cohesion: 0.03
Nodes (87): quick_notes_submit(), _QuickNoteBody, Submit a quick-note URL or instruction from the dashboard FAB., Hand the 'connect & verify the repo' work to the agency's own agents. The task…, _seed_connect_task(), Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., _brain_is_configured() (+79 more)

### Community 5 - "Task"
Cohesion: 0.03
Nodes (84): Full task/issue document., Update the updated_at timestamp., Task, _is_brain_connection_error(), _is_outward_facing(), Any, BaseException, TaskSpec (+76 more)

### Community 6 - "AgentRunner"
Cohesion: 0.04
Nodes (51): AgentRunner, _check_extra_kwargs(), _enforce_signature(), Any, Path, Raise TypeError if fn's signature drifts from the locked contract (Pydantic…, Raise TypeError on unknown kwarg (runtime extra='forbid' for non-Pydantic…, Governance seam: judge the call, run it, audit the outcome. Deliberately a thin… (+43 more)
...
Cohesion: 0.02
Nodes (115): parse_event_stream(), Reduce a ``--mode json`` NDJSON stream to a :class:`ParsedRun`. Kept a module-…, base_url(), mobile_page(), proxy_url(), Config, pytest_configure(), conftest.py — pytest fixtures and configuration for the E2E test suite.… (+107 more)

### Community 12 - "CompanyGraphService"
Cohesion: 0.03
Nodes (104): ApprovalPolicy, BusinessSystem, CompanyCreateRequest, CompanyGraph, CompanyGraphResponse, CompanyGraphSnapshot, CompanyResponse, CompanyUpdateRequest (+96 more)

### Community 13 - "BrainWatchdog"
Cohesion: 0.03
Nodes (68): _brain_provider_status(), Return per-provider metadata for the GET endpoint. Iterates every provider in…, Return the discovered model list for *provider_id*, or ``[]`` if unknown., _served_models(), get_brain_config_store(), provider_key_present(), Return the process-wide ``BrainConfigStore`` singleton., Force a cache refresh (used by tests + the GET /admin/api/policy/brain… (+60 more)

### Community 14 - "test_ceo_dispatcher.py"
Cohesion: 0.04
Nodes (75): get_ceo_dispatcher(), _merge_changed_files(), Return the shared CEODispatcher singleton., Reset the singleton (test helper)., Collect changed_files across all specialists into a single de-duped list., reset_ceo_dispatcher(), get_ceo_fallback_stats(), Increment the named counter (silently ignores unknown reasons). (+67 more)
...
### Community 18 - "AgentJobManager"
Cohesion: 0.03
Nodes (76): PreflightIssue, PreflightReport, BaseModel, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, AgentJob, AgentJobManager, make_isolated_workspace(), _now() (+68 more)

### Community 19 - "WorkflowRun"
Cohesion: 0.04
...
Cohesion: 0.02
Nodes (155): ProviderConfig, One configured endpoint. ``kind`` selects the adapter: ``openai`` (any OpenAI-…, packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, classify_error(), LLMProvider, OpenAICompatible, ABC, Any (+147 more)
...
Cohesion: 0.05
Nodes (99): Semaphore, Split the request into briefed, tier-assigned specialist sub-tasks. Returns the…, Run one sub-task, judge the result, and escalate it if it is slop. The loop is…, build_subtask_brief(), _coerce_subtasks(), decompose(), _env_flag(), _env_int() (+91 more)

### Community 24 - "AgentDefinition"
Cohesion: 0.05
...
### Community 28 - "Agency"
Cohesion: 0.04
Nodes (58): Agency, AgencyCycleResult, AgentDirective, _build_ceo_prompt(), _build_quick_note_instruction(), _close_github_issue(), _collect_recent_git_context(), _fetch_github_quick_notes() (+50 more)

### Community 29 - "TaskStatus"
Cohesion: 0.06
Nodes (54): Task, Creates tasks from scheduler and playbook runs using one workflow., TaskAutomationService, TaskStatus, Record the human decision on a task's **pre-execution** approval gate. A…, Re-run a task. Permissive across every non-active state so the dashboard Retry…, Add a follow-up instruction to a task and re-queue it for execution. Unlike…, Owns lifecycle transitions, comment semantics, and approval rules. (+46 more)

### Community 30 - "direct_chat.py"
Cohesion: 0.05
...
Cohesion: 0.03
Nodes (103): MCPUnavailableError, Raised when the MCP server is unreachable or the circuit is open., E2BSandboxSession, _inject_token(), maybe_attach_e2b(), Any, Create the sandbox. Raises :class:`MCPUnavailableError` on failure., Kill the sandbox. Idempotent; never raises (best-effort cleanup). (+95 more)
...
Cohesion: 0.03
Nodes (121): int, FailoverResult, A successful completion plus the accounting its callers need., get_budget(), packages/llm/budget.py — token and cost accounting with spend alerts. Tracks…, The process-wide budget tracker., Test hook — clear all usage accounting., reset() (+113 more)
...
### Community 36 - "SpecialistService"
Cohesion: 0.05
...
### Community 37 - "RuntimeCapabilityRegistry"
Cohesion: 0.07
...
Cohesion: 0.05
Nodes (53): CEODispatcher, CEOResult, _complexity_rank(), _decompose_into_subtasks(), _offload(), Any, services/ceo_dispatcher.py — Real CEO delegation layer. The CEO splits a…, Run a synchronous ledger call without blocking the event loop. ``CEOLedger`` is… (+45 more)

### Community 39 - "services/seo_audit.py"
Cohesion: 0.04
Nodes (56): field_validator, A single occurrence of a check firing on a specific URL., Aggregated report row - Screaming Frog CSV compatible., Site-level facts discovered during the crawl., Request to run an SEO/GEO/AIO audit against a website., SeoAuditRequest, SeoIssueInstance, SeoIssueReportRow (+48 more)
...
Cohesion: 0.04
Nodes (58): Agent subsystem — planner / executor / verifier loop., AgentEvent, AgentPlan, AgentRunRequest, AgentSession, AgentSessionCreateRequest, AgentSessionMessage, AgentStep (+50 more)
...
### Community 44 - "NotificationDispatcher"
Cohesion: 0.07
...
### Community 46 - "test_phase6_workflow.py"
Cohesion: 0.15
...
### Community 47 - "BrainConfig"
Cohesion: 0.03
Nodes (95): BrainConfig, BrainConfigPatch, BrainConfigStore, default_brain_config(), provider_base_url(), BaseModel, Read the persisted config from Mongo (primary) or sqlite (mirror). Falls back…, Persist *cfg* to Mongo (primary) and sqlite (mirror). Either backend failing is… (+87 more)

### Community 48 - "tasks/api.py"
Cohesion: 0.16
...
### Community 49 - "test_unit8_model_catalog.py"
Cohesion: 0.04
Nodes (68): Resolve the model id for a component's role on a provider. Parameters…, resolve_component_model(), CatalogActiveBrain, CatalogMirror, CatalogProviderEntry, get_catalog(), get_model_catalog_store(), _include_router_providers() (+60 more)

### Community 50 - "PolicyEngine"
Cohesion: 0.04
Nodes (79): _action_matches(), _as_list(), Decision, GroupPolicy, _host_matches(), Mode, _normalise_path(), _path_matches() (+71 more)

### Community 51 - "OnboardingService"
Cohesion: 0.04
Nodes (61): Evidence, OnboardingProgress, Result of a website scan with detected systems and stack inference., Evidence supporting a system detection., Tracks the onboarding progress for a company., Result of a repository scan with detected stack and systems., Inferred technology stack from website/repo analysis., RepoScanResult (+53 more)

### Community 52 - "services/background.py"
Cohesion: 0.06
Nodes (52): autonomy_status(), Public autonomy readiness probe — no authentication required. A live deploy…, _await_hermes_ready(), BackgroundServices, _env_on(), Any, Path, services/background.py — shared background-service startup. Both the FastAPI… (+44 more)
...
### Community 54 - "test_render_mcp.py"
Cohesion: 0.04
...
### Community 55 - "ai/router.py"
Cohesion: 0.06
Nodes (37): _dead_model_key(), _exponential_backoff_cooldown(), _get_director(), is_commercial_provider(), _mark_model_dead(), _normalized_provider_type(), _notify_watchdog(), _ollama_reasoning_effort() (+29 more)

### Community 56 - "_start_autonomy_loops"
Cohesion: 0.05
...
### Community 57 - "test_ceo_router.py"
Cohesion: 0.08
...
Cohesion: 0.05
Nodes (73): BudgetTracker, GovernanceGate, Holds live session budgets, bounded so it cannot leak. Sessions end without…, The one seam through which governed actions pass., AgentIdentity, _coerce_text(), new_session_id(), Any (+65 more)
...
### Community 61 - "get_runtime_manager"
Cohesion: 0.05
...
### Community 62 - "enforcement.py"
Cohesion: 0.04
Nodes (61): Charge sub-agent nesting depth and enforce the ``max_depth`` ceiling. Isolates…, _egress_policy_reason(), agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Return why governance policy blocks *host*, or None. Runs strictly *after* the…, build_governance_router(), Any, APIRouter, backend/governance_router.py — read and operate the governance layer. Mounted… (+53 more)
...
### Community 65 - "agent/workspace.py"
Cohesion: 0.05
...
### Community 69 - "test_user_research_skill.py"
Cohesion: 0.04
...
### Community 70 - "WebsiteScanner"
Cohesion: 0.04
Nodes (66): DetectedSystem, A business system detected on a company's website or in their stack., Get the most confident evidence description., main(), Post-deploy verification for the website scanner against the LIVE internet.…, Returns (url, ok, summary)., _scan_one(), _content_contains_domain() (+58 more)

### Community 71 - "test_ceo_supervision.py"
Cohesion: 0.06
Nodes (72): _harvest_changed_files(), Extract the files a runtime touched. Returns ``(files, reported)``. Adapters…, A subtask's full history: what it is, and every attempt at it., SubtaskRecord, Enum, str, Implementer tiers, ordered cheapest-and-narrowest to most-capable. A subtask…, Tier (+64 more)

### Community 72 - "ChatHistoryStore"
Cohesion: 0.04
...
### Community 76 - "CompanyGraphStore"
Cohesion: 0.03
Nodes (41): Find a repository by its URL., A company repository with detected technologies and metadata., Extract the owner from the full name., Extract the repository name from the full name., Repo, requires_db, Add a repository to a company. Args: company_id: Company ID url: Repository URL…, Initialize the service. Args: store: Optional CompanyGraphStore instance. If… (+33 more)
...
### Community 80 - "test_backend_server_features.py"
Cohesion: 0.06
Nodes (25): _append_agent_session_message(), _build_auto_skill_guidance(), _builtin_provider_records(), _in_container(), _mask_observations(), Path, Return a minimal set of built-in provider records without touching MongoDB.…, Truncate tool/observation content in older messages to prevent context bloat. (+17 more)

### Community 81 - "ProviderRouter"
Cohesion: 0.09
Nodes (23): ProviderRouter, Priority-ordered LLM provider fallback with health checks and retries., main(), probe_one(), Live probe — makes a tiny real API call to every configured provider. Usage (in…, _bedrock_api_response(), _bedrock_provider(), _mock_boto3() (+15 more)

### Community 82 - "test_agent_tool_governance.py"
Cohesion: 0.06
Nodes (57): One tool selection parsed from the executor model's JSON response., ToolCall, Replace the process-wide store. Tests only., reset_approval_store(), Replace the process-wide audit log. Tests only., reset_audit_log(), Replace the process-wide engine. Tests only., reset_policy_engine() (+49 more)
...
### Community 85 - "test_web_reach.py"
Cohesion: 0.08
...
### Community 87 - "test_self_heal_v2.py"
Cohesion: 0.06
...
### Community 90 - "brain_config.py"
Cohesion: 0.04
Nodes (88): all_provider_ids(), _build_base_url_env_from_yaml(), _build_candidates_from_yaml(), _build_default_base_url_from_yaml(), _build_display_names_from_yaml(), _build_key_env_from_yaml(), _build_presets_from_yaml(), _build_tier_from_yaml() (+80 more)

### Community 91 - "HybridSystem"
Cohesion: 0.05
...
### Community 94 - "failover_client.py"
Cohesion: 0.06
...
### Community 96 - "test_procedural_memory.py"
Cohesion: 0.05
...
### Community 102 - "test_llm_router_e2e.py"
Cohesion: 0.14
...
### Community 106 - "RenderOpsMonitor"
Cohesion: 0.06
...
### Community 109 - "test_agent_free_brain.py"
Cohesion: 0.09
...
### Community 113 - "resolve_active_brain"
Cohesion: 0.08
Nodes (49): BrainResolution, get_brain_config(), provider_api_key(), Convenience wrapper used by the agent loop + brain resolver., Async variant — refreshes the cache if stale before resolving. Used by code…, Return the live API key for *provider* (env-only — never persisted)., resolve_role_model(), get_active_brain_sync() (+41 more)

### Community 114 - "clear_cooldowns"
Cohesion: 0.05
Nodes (52): clear_cooldowns(), CommercialFallbackRequiredError, get_dead_models(), _is_model_dead(), is_provider_on_cooldown(), mark_provider_failed(), ProviderFallbackError, RuntimeError (+44 more)
...
### Community 119 - "Artifact"
Cohesion: 0.09
Nodes (27): AgentRole, When coder == reviewer model, swarm should log a warning., TestCheckRun, workflow/artifact_store.py — Durable artifact persistence. Artifacts are stored…, workflow/engine.py — WorkflowEngine: CRISPY phase sequencer. The engine is the…, Reset the singleton (test helper)., reset_engine(), Artifact (+19 more)

### Community 120 - "test_startup_warmup.py"
Cohesion: 0.04
...
### Community 125 - "test_sqlite_store.py"
Cohesion: 0.06
...
### Community 127 - "test_integration_c4_c5_c6_d3.py"
Cohesion: 0.06
...
### Community 131 - "_governance_identity"
Cohesion: 0.22
Nodes (6): _blocked_result(), _governance_identity(), Any, TaskResult, Build the failed TaskResult returned when policy denies a dispatch. A result…, Resolve the acting identity for a runtime dispatch. Identity comes from…

### Community 132 - "test_schedule_growth_invariants.py"
Cohesion: 0.05
...
### Community 137 - "test_trend_scoping.py"
Cohesion: 0.09
...
### Community 145 - "RepowiseIntelligence"
Cohesion: 0.06
...
### Community 147 - "models/seo_audit.py"
Cohesion: 0.09
...
### Community 148 - "OnboardingScreen.jsx"
Cohesion: 0.05
...
### Community 155 - "test_trend_watcher.py"
Cohesion: 0.07
...
### Community 156 - "PortfolioManager"
Cohesion: 0.07
...
### Community 161 - "test_p0_roadmap_b1_c2_a3.py"
Cohesion: 0.06
...
### Community 163 - "TestHarnessAdapter"
Cohesion: 0.05
...
### Community 164 - "persist_plan_spec"
Cohesion: 0.07
...
### Community 165 - "TestEstimateTokensForMessages"
Cohesion: 0.05
...
### Community 166 - "test_response_cache.py"
Cohesion: 0.10
...
### Community 174 - "test_pr923_fixes.py"
Cohesion: 0.07
...
### Community 179 - "test_agent_runner.py"
Cohesion: 0.05
Nodes (62): AgentPhaseError, Exception, Raised when a named agent phase (planning, verification, etc.) fails., _make_runner(), MonkeyPatch, Path, Regression for #1422 item 3: when the model never returns a JSON object, the…, The agent LLM call must use the BrainConfig budget, not a hardcoded 16384.… (+54 more)

### Community 180 - "test_process_quick_note_workflow.py"
Cohesion: 0.05
Nodes (26): _full_suite_jobs(), parametrize, Tests for ``.github/workflows/process-quick-note.yml``. Two defects, one…, No issue to pick up means the retry handler never runs, so the job must not go…, Order matters: the label bump and issue reopen must complete before the job…, The invariant, stated once for the whole repo. Adding the service to two…, Guards the guard: a regex that matches nothing would pass silently., A pytest that starts a moment early reproduces the very defect the service… (+18 more)

### Community 182 - "fmtErr"
Cohesion: 0.06
...
### Community 183 - "test_mcp_registry.py"
Cohesion: 0.05
...
Cohesion: 0.05
Nodes (67): tasks — Task/issue management system. Provides a lightweight task/issue tracker…, ApprovalCheckpoint, ApprovalRequest, ClarifyRequest, _coerce_ts(), CommentAddRequest, ExecutionApprovalRequest, ExecutionLogEntry (+59 more)

### Community 188 - "workflow_orchestrator.py"
Cohesion: 0.08
Nodes (46): BoundContext, ClassifyOutput, ExecutionResult, JudgeVerdict, MonitorOutput, _orchestrator_bypass(), PersistOutput, Phase (+38 more)

### Community 189 - "WorkspaceTools"
Cohesion: 0.05
Nodes (31): repowise.py — RepowiseIntelligence: context packing and dependency analysis., Path, tools.py — WorkspaceTools: read/write/search and diff application (risky…, Precise string replacement — F1 roadmap item (Codebuff/Claude Code-style edit).…, Return a previously saved memory value, or an empty string if absent., Persist a key/value pair to the user's profile store., Return the first *lines* lines of a file. Just-in-time retrieval: the executor…, Return a lightweight index of files with line counts and sizes. This is the… (+23 more)
...
### Community 192 - "test_unit6_resolve_component_model.py"
Cohesion: 0.05
...
### Community 194 - "test_colibri_brain_shim.py"
Cohesion: 0.05
...
### Community 195 - "test_classify_dependabot_update.py"
Cohesion: 0.07
...
### Community 196 - "SyntheticDataPipeline"
Cohesion: 0.13
...
### Community 198 - "ProvidersScreen.jsx"
Cohesion: 0.06
...
### Community 203 - "portfolio_api.py"
Cohesion: 0.08
...
### Community 208 - "TestRecordUsageAndStats"
Cohesion: 0.05
...
### Community 209 - "test_dashboard_cache.py"
Cohesion: 0.13
...
### Community 211 - "nvidia_models.py"
Cohesion: 0.09
...
### Community 212 - "NIMConnectionPool"
Cohesion: 0.11
...
### Community 214 - "ProviderManager"
Cohesion: 0.12
Nodes (23): _fake_user_auth(), Path, test_admin_can_create_anthropic_provider_via_webui_admin_api(), test_admin_can_create_provider_via_webui_admin_api(), test_ui_providers_and_workspaces_use_app_state(), _atomic_write_json(), default_store_paths(), JsonConfigStore (+15 more)
...
### Community 219 - "Kept Rules — the 44 that survive the audit"
Cohesion: 0.05
...
### Community 222 - "test_portfolio_intake.py"
Cohesion: 0.09
...
Cohesion: 0.07
Nodes (40): get_sam(), agent/sam.py — SAM Voice Agent (System Autonomy Manager) SAM is the voice-…, _get_backend_sam(), observability_diag_public(), Lazy-init the SAM agent for the backend deployment., Get SAM's current status., PUBLIC diagnostic endpoint for Langfuse — no auth required. Returns exactly…, sam_status_backend() (+32 more)

### Community 225 - "chat_handlers.py"
Cohesion: 0.11
Nodes (35): _apply_chat_defaults(), _apply_reasoning_budget(), _emit_safely(), _extract_exact_output(), _filter_fragment(), _filter_openai_sse_line(), handle_ollama_native_chat(), handle_openai_chat_completions() (+27 more)

### Community 226 - "test_governance_api.py"
Cohesion: 0.10
...
### Community 227 - "WorkflowBuildRequest"
Cohesion: 0.08
...
### Community 232 - "[Unreleased]"
Cohesion: 0.05
Nodes (39): Added, Added, Added, Added, Added, Added, Added, Added (+31 more)

### Community 233 - "brain_failover.py"
Cohesion: 0.05
...
### Community 236 - "render_ops.py"
Cohesion: 0.04
Nodes (48): build_render_router(), Any, APIRouter, Exception, backend/render_router.py — Render platform view for operators and agents.…, Reject anyone who is not the agency admin., Map an MCP transport failure onto 503 rather than a 500. The distinction…, _require_admin() (+40 more)
...
### Community 239 - "PatternConsolidation"
Cohesion: 0.06
...
### Community 240 - "TestCatalogFable51"
Cohesion: 0.09
...
### Community 247 - "test_daily_2026_07_27.py"
Cohesion: 0.07
...
### Community 249 - "test_verification_strategies.py"
Cohesion: 0.11
...
### Community 250 - "report_to_markdown"
Cohesion: 0.10
...
### Community 251 - "autonomous_fix.py"
Cohesion: 0.10
...
### Community 253 - "REWRITE_PLAN.md — Phased Migration Strategy"
Cohesion: 0.06
...
### Community 256 - "test_persistent_memory.py"
Cohesion: 0.06
...
### Community 258 - "agent_runtime.py"
Cohesion: 0.09
...
### Community 261 - "test_all_providers_discovery.py"
Cohesion: 0.17
...
### Community 263 - "activation_api.py"
Cohesion: 0.09
...
### Community 264 - "Configuration Reference"
Cohesion: 0.06
...
### Community 268 - "test_slop_gate.py"
Cohesion: 0.08
Nodes (37): tool_write_file(), diff_is_sloppy(), is_destructive_overwrite(), is_doc_only_boilerplate(), looks_like_secret_file(), Return (rejected, reason) when every generated file is documentation-only. PRs…, Net mass-deletion guard — an implementation shouldn't be mostly deletions., Reusable slop-gate for the autonomous PR-generating scripts. Auto-PR scripts… (+29 more)

### Community 269 - "test_platform_controls.py"
Cohesion: 0.08
...
### Community 272 - "skill_bindings.py"
Cohesion: 0.06
Nodes (41): _execute_skill_impl(), _get_portfolio_manager(), get_skill_bindings(), Any, Enum, str, services/skill_bindings.py — Runtime Skill Bindings for Specialist Agents Wires…, Live Graphify executor — queries the codebase knowledge graph. Order of… (+33 more)

### Community 273 - "test_live_server.py"
Cohesion: 0.22
...
### Community 274 - "ContextCompressor"
Cohesion: 0.11
...
### Community 277 - "ResourceWatchdog"
Cohesion: 0.10
...
### Community 279 - "test_provider_render_env.py"
Cohesion: 0.09
...
### Community 280 - "test_daily_2026_06_04.py"
Cohesion: 0.08
...
### Community 282 - "test_kimi_bridge_server.py"
Cohesion: 0.05
...
### Community 284 - "test_microagents.py"
Cohesion: 0.15
...
### Community 285 - "Security Analysis — local-llm-server"
Cohesion: 0.06
...
### Community 288 - "probe_catalogues.py"
Cohesion: 0.10
...
### Community 291 - "test_nvidia_model_discovery.py"
Cohesion: 0.06
...
### Community 292 - "test_workspace_isolation.py"
Cohesion: 0.16
...
### Community 297 - "High-Agency Frontend Skill"
Cohesion: 0.06
Nodes (30): 10. FINAL PRE-FLIGHT CHECK, 1. ACTIVE BASELINE CONFIGURATION, 2. DEFAULT ARCHITECTURE & CONVENTIONS, 3. DESIGN ENGINEERING DIRECTIVES (Bias Correction), 4. CREATIVE PROACTIVITY (Anti-Slop Implementation), 5. PERFORMANCE GUARDRAILS, 6. TECHNICAL REFERENCE (Dial Definitions), 7. AI TELLS (Forbidden Patterns) (+22 more)

### Community 298 - "LlmProviderConfig"
Cohesion: 0.15
...
### Community 300 - "Quick-Note GitHub Issues Processing - Session Summary"
Cohesion: 0.06
...
### Community 301 - "webui/router.py"
Cohesion: 0.10
Nodes (29): get_brain_preference(), Return the operator's brain provider preference. Values: - ``"nvidia"`` —…, Operator can set BRAIN_PREFERENCE=colibri without it being rejected., test_get_brain_preference_accepts_colibri(), Any, Path, run_command(), _safe_allowlist() (+21 more)

### Community 302 - "test_failover_silent_exhaustion.py"
Cohesion: 0.11
...
### Community 303 - "test_mcp_governance.py"
Cohesion: 0.11
...
### Community 305 - "CompanyAgencyService"
Cohesion: 0.09
...
### Community 307 - "test_autonomy_gate.py"
Cohesion: 0.12
...
### Community 308 - "ImprovementLoop"
Cohesion: 0.04
Nodes (93): AgentRole, _parse_ceo_directives(), str, DetectedIssue, get_improvement_loop(), ImprovementLoop, ImprovementLoopState, IssueCategory (+85 more)

### Community 309 - "agents/agile_ceremonies.py"
Cohesion: 0.08
...
### Community 315 - "CommitTracker"
Cohesion: 0.09
Nodes (32): CommitAttribution, CommitTracker, Any, Path, agent/commit_tracker.py — AI Commit Attribution Tags git commits with metadata…, Return recent commits with agent attribution trailers parsed out., Create git commits enriched with agent-session attribution trailers. Usage::…, Return ``--trailer`` arguments ready to append to a ``git commit`` call. (+24 more)
...
### Community 319 - "generate_context.py"
Cohesion: 0.12
...
### Community 324 - "OrchestratorQueue"
Cohesion: 0.07
...
### Community 325 - "test_internal_agent_did_work.py"
Cohesion: 0.12
...
### Community 326 - "test_purge_backlog.py"
Cohesion: 0.09
...
### Community 328 - "Python Dependencies (`requirements.txt`)"
Cohesion: 0.07
...
### Community 329 - "Technical Debt Register — local-llm-server"
Cohesion: 0.07
...
### Community 335 - "test_regression.py"
Cohesion: 0.10
...
### Community 336 - "test_agent_scripts_share_one_model_list.py"
Cohesion: 0.10
...
### Community 337 - "test_crispy_burn_in.py"
Cohesion: 0.07
...
### Community 338 - "test_implement_agent_routing.py"
Cohesion: 0.07
...
### Community 339 - "test_skill_registry_boot_refresh.py"
Cohesion: 0.12
...
### Community 340 - "validate_outbound_url"
Cohesion: 0.13
...
### Community 343 - "seo_api.py"
Cohesion: 0.08
Nodes (41): build_seo_roadmap(), delegate_seo_findings(), _expire_stale_pending_report(), export_seo_audit(), get_seo_audit(), list_seo_audits(), plan_seo_sprint(), BaseModel (+33 more)

### Community 344 - "Deploy: FreeBuff Telegram bot (24×7)"
Cohesion: 0.07
...
### Community 345 - "Claude Code + Qwen Local Setup"
Cohesion: 0.07
...
### Community 348 - "test_daily_2026_07_24.py"
Cohesion: 0.20
...
### Community 351 - "test_brain_failover_413.py"
Cohesion: 0.13
...
### Community 354 - "isolated_telegram_config"
Cohesion: 0.11
...
### Community 356 - "TestNoNvidiaFallbackIsRetired"
Cohesion: 0.09
...
### Community 358 - "VoiceCommandInterface"
Cohesion: 0.14
...
### Community 360 - "SeoCheckDefinition"
Cohesion: 0.10
...
### Community 361 - "_valid_login_state"
Cohesion: 0.24
...
### Community 363 - "control_registry.py"
Cohesion: 0.14
...
### Community 368 - "test_brain_migration_writes_a_live_model.py"
Cohesion: 0.10
...
### Community 369 - "test_daily_automation_2026_08_03.py"
Cohesion: 0.11
...
### Community 370 - "test_provider_enable_disable.py"
Cohesion: 0.09
...
### Community 372 - "test_webui_provider_priority.py"
Cohesion: 0.19
...
### Community 377 - "Session Handoff — 2026-06-15"
Cohesion: 0.08
...
### Community 378 - "TASK 4 — End-to-end approval-gate test"
Cohesion: 0.08
...
### Community 379 - "Company"
Cohesion: 0.07
Nodes (16): BusinessCategory, Company, Any, field_validator, The core company entity - root of the Company Graph., Coerce unrecognised system_type values to 'custom' so the model never crashes…, Company, Get a company by ID. Args: company_id: Company ID Returns: Company instance or… (+8 more)

### Community 380 - "test_connector_registry.py"
Cohesion: 0.12
...
### Community 381 - "_InMemoryBackend"
Cohesion: 0.11
...
### Community 383 - "test_telegram_approval_e2e.py"
Cohesion: 0.12
...
### Community 384 - "TestPolicyAuthoringUiStableClaim"
Cohesion: 0.22
...
### Community 388 - "WorkspaceManager"
Cohesion: 0.19
Nodes (10): get_data_dir(), _normalize_path(), _now(), Any, BaseModel, Path, WorkspaceCreate, WorkspaceManager (+2 more)
...
### Community 393 - "get_failover_manager"
Cohesion: 0.07
...
### Community 395 - "Traffic Distribution Across Providers"
Cohesion: 0.08
...
### Community 396 - "Implementation Prompt: Rich TaskBoard + Agile Sprint Integration"
Cohesion: 0.08
...
### Community 397 - "Telegram Bot Setup"
Cohesion: 0.08
...
### Community 398 - "implement_agent.py"
Cohesion: 0.12
...
### Community 401 - "control_overrides.py"
Cohesion: 0.12
...
### Community 403 - "Native operations"
Cohesion: 0.09
...
### Community 404 - "get_scheduler"
Cohesion: 0.05
Nodes (39): legacy_scheduler_delete(), get_store(), Return the active store singleton, creating it on first call., apply_from_db(), Load the stored overrides and apply them. Called once at startup., get_scheduler(), agent/scheduler.py — Scheduled Agent Jobs Cron-based job scheduler. Each job…, set_scheduler() (+31 more)
...
### Community 409 - "test_skill_registry.py"
Cohesion: 0.13
...
### Community 415 - "SetupWizardPage.js"
Cohesion: 0.13
...
### Community 418 - "test_north_mini_code.py"
Cohesion: 0.09
...
### Community 419 - "test_brain_availability_doctor.py"
Cohesion: 0.11
...
### Community 423 - "WindowsServiceManager"
Cohesion: 0.18
...
### Community 425 - "OrchestratorCheckpointStore"
Cohesion: 0.13
...
### Community 426 - "test_task_source_id_race.py"
Cohesion: 0.13
...
### Community 428 - "test_cerebras_catalogue.py"
Cohesion: 0.13
...
### Community 429 - "test_monitor_lib.py"
Cohesion: 0.11
...
### Community 431 - "test_mostly_failed_steps.py"
Cohesion: 0.12
...
### Community 433 - "HarnessEnrichment"
Cohesion: 0.14
...
### Community 435 - "AdaptivePermissions"
Cohesion: 0.18
...
### Community 442 - "TaskDispatcher"
Cohesion: 0.05
Nodes (44): _env_flag(), Read a boolean env var. Accepts 'true'/'1'/'yes' (case-insensitive)., Re-queue BLOCKED tasks that have cooled down and are ready for retry., Polls for queued task work and executes it through the coordinator. Crash…, Re-queue tasks stranded by a prior crash or hard-kill., TaskDispatcher, _make_task(), asyncio (+36 more)

### Community 443 - "get_tool_registry"
Cohesion: 0.09
...
### Community 446 - "OrchestratorSupervisor"
Cohesion: 0.11
Nodes (10): OrchestratorSupervisor, Any, Emit an alert to the activity feed and log., Deterministic supervisor for the orchestrator. Runs as a background coroutine.…, stop_orchestrator_supervisor(), SupervisorState, tests/test_orchestrator_supervisor.py — Tests for deterministic supervisor…, Supervisor startup, stall detection, and alert emission. (+2 more)
...
### Community 448 - "test_knowledge_sync.py"
Cohesion: 0.08
...
### Community 452 - "sam_livekit_worker.py"
Cohesion: 0.13
...
### Community 453 - "V3 API Migration Plan — LLM Relay Platform"
Cohesion: 0.10
...
### Community 454 - "system_instruction"
Cohesion: 0.16
...
### Community 456 - "loop.py"
Cohesion: 0.16
Nodes (20): loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., # NOTE: "ollama_base" is kept for backwards compatibility; this runner only…, build_compaction_prompt(), build_execution_prompt(), build_planning_prompt(), build_tool_prompt(), build_verification_prompt(), Any (+12 more)
...
### Community 458 - "test_provider_state_durability.py"
Cohesion: 0.17
...
### Community 459 - "run_trend_analysis"
Cohesion: 0.18
...
### Community 460 - "test_unit5_ui_provider_surface.py"
Cohesion: 0.10
...
### Community 461 - "test_agent_tools.py"
Cohesion: 0.19
...
### Community 465 - "Skill: modularity-review"
Cohesion: 0.10
...
### Community 466 - "Design Audit"
Cohesion: 0.10
Nodes (19): Code Quality, Color and Surfaces, Component Patterns, Content, Design Audit, Fix Priority, How This Works, Iconography (+11 more)

### Community 467 - "Findings"
Cohesion: 0.10
...
### Community 471 - "Docker AI Governance Audit — Final Report"
Cohesion: 0.10
...
### Community 472 - "1. Capability-by-capability"
Cohesion: 0.10
...
### Community 474 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 478 - "ProviderConfig"
Cohesion: 0.06
Nodes (37): provider_access_tier(), _provider_field(), provider_sort_key(), ProviderConfig, Regression tests for the agent loop's multi-provider failover wire format.…, The pieces the failover loop assembles for an Anthropic-native provider., TestAnthropicRequestShape, Tests that verify the exact provider priority ordering. (+29 more)

### Community 479 - "RuntimeDependency"
Cohesion: 0.11
Nodes (21): ClaudeCodeAdapter, json_safe(), Any, Adapter for Claude Code CLI — FIRST CLASS autonomous coding runtime., Declare ``E2B_API_KEY`` as a required env dependency. The base ``preflight``…, One runtime dependency that can be validated during preflight., RuntimeDependency, adapter() (+13 more)

### Community 480 - "build_workflow.py"
Cohesion: 0.30
Nodes (19): _c(), _get(), _header(), main(), _make_headers(), _phase_icon(), _post(), _print_phases() (+11 more)

### Community 481 - "context_plan_gate.py"
Cohesion: 0.15
...
### Community 483 - "_redact_for_notification"
Cohesion: 0.10
...
### Community 490 - "test_voice_pipeline.py"
Cohesion: 0.14
...
### Community 494 - "_extract_tech_relevance"
Cohesion: 0.17
...
### Community 498 - "Skill: fabric-patterns"
Cohesion: 0.11
...
### Community 499 - "Analysis & Synthesis Instructions"
Cohesion: 0.11
...
### Community 503 - "_ensure_tasks_source_id_unique_index"
Cohesion: 0.14
...
### Community 510 - "test_telegram_task_callback.py"
Cohesion: 0.12
...
### Community 519 - "TestSelfHealingInfrastructureClassification"
Cohesion: 0.19
...
### Community 520 - "test_fabric_patterns.py"
Cohesion: 0.11
...
### Community 521 - "test_gh_brain_failover.py"
Cohesion: 0.11
...
### Community 522 - "test_repowise_intelligence.py"
Cohesion: 0.11
...
### Community 526 - "test_ai_insights.py"
Cohesion: 0.05
...
### Community 534 - "Platform Guide — the full tour"
Cohesion: 0.04
...
### Community 536 - "Part A — Health Report"
Cohesion: 0.11
...
### Community 537 - "WorkflowScreen.jsx"
Cohesion: 0.14
...
### Community 541 - "test_telegram_webhook.py"
Cohesion: 0.14
...
### Community 543 - "ErrorInterceptorMiddleware"
Cohesion: 0.19
...
### Community 547 - "cowork_session.py"
Cohesion: 0.15
...
### Community 548 - "SKILL: Industrial Brutalism & Tactical Telemetry UI"
Cohesion: 0.12
...
### Community 549 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 550 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 551 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 552 - "Section-by-Section Acceptance Criteria"
Cohesion: 0.12
...
### Community 556 - "redact_connection_url"
Cohesion: 0.17
...
### Community 563 - "test_activation_api.py"
Cohesion: 0.21
...
### Community 564 - "TestAListingFailureDoesNotVetoTheAnswer"
Cohesion: 0.17
...
### Community 565 - "test_daily_automation_2026_07_11.py"
Cohesion: 0.15
...
### Community 567 - "test_health_endpoints.py"
Cohesion: 0.17
...
### Community 568 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 569 - "test_openclaw_endpoints.py"
Cohesion: 0.12
...
### Community 575 - "Skill: repowise-intelligence"
Cohesion: 0.12
...
### Community 576 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
...
### Community 581 - "refresh_agent_built_proof.py"
Cohesion: 0.20
...
### Community 582 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 583 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 584 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
...
### Community 585 - "test_compare_runtimes.py"
Cohesion: 0.12
...
### Community 586 - "RateLimitTracker"
Cohesion: 0.16
...
### Community 590 - "telegram_inbound_handlers.py"
Cohesion: 0.13
...
### Community 591 - "ManagedAgentDreams"
Cohesion: 0.22
...
### Community 592 - "e2e/test_browser.py"
Cohesion: 0.21
...
### Community 593 - "test_agency_workflows_carry_the_failover_chain.py"
Cohesion: 0.18
...
### Community 594 - "test_autonomy_status.py"
Cohesion: 0.12
...
### Community 596 - "DailyDigestAggregatorTests"
Cohesion: 0.19
...
### Community 598 - "test_langfuse_agency_wide.py"
Cohesion: 0.10
...
### Community 599 - "test_local_brain_state.py"
Cohesion: 0.12
...
### Community 601 - "test_migrate_local_brain_env.py"
Cohesion: 0.38
...
### Community 602 - "test_phase5_doctor.py"
Cohesion: 0.08
...
### Community 603 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 604 - "test_refresh_agent_built_proof.py"
Cohesion: 0.12
...
### Community 607 - "test_contract_enforcement.py"
Cohesion: 0.17
...
### Community 610 - "CollaborationContext"
Cohesion: 0.17
...
### Community 611 - "Skill: agent-harness"
Cohesion: 0.13
...
### Community 612 - "Skill: checkpoint-strategy"
Cohesion: 0.13
...
### Community 614 - "Skill: local-ai-query"
Cohesion: 0.13
...
### Community 615 - "Skill: parallel-agents"
Cohesion: 0.13
...
### Community 616 - "Skill: parallel-worktrees"
Cohesion: 0.13
...
### Community 617 - "Design System: Taste Standard"
Cohesion: 0.13
...
### Community 619 - "Skill: user-research"
Cohesion: 0.13
...
### Community 620 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 621 - "Attention Mechanisms Internals"
Cohesion: 0.13
...
### Community 624 - "router/health.py"
Cohesion: 0.20
...
### Community 627 - "DecisionsStore"
Cohesion: 0.30
Nodes (3): DecisionsStore, Any, Connection

### Community 628 - "clear_wizard_state_cache"
Cohesion: 0.21
...
### Community 631 - "TestBrainConfigUpdates"
Cohesion: 0.22
...
### Community 632 - "DecisionsStoreTests"
Cohesion: 0.11
...
### Community 633 - "test_dockerfile_ships_config_dir.py"
Cohesion: 0.14
...
### Community 634 - "test_scanner_live.py"
Cohesion: 0.23
...
### Community 641 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 645 - "Checks Performed"
Cohesion: 0.14
...
### Community 646 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 647 - "test_new_features_e2e.py"
Cohesion: 0.29
...
### Community 648 - "admin_digest_router.py"
Cohesion: 0.22
...
### Community 653 - "Quick-Note Issues Processing Summary"
Cohesion: 0.14
...
### Community 654 - "Main proxy (`proxy.py`)"
Cohesion: 0.14
...
### Community 662 - "extract_failures"
Cohesion: 0.21
...
### Community 664 - "_process_task_callback"
Cohesion: 0.18
...
### Community 665 - "TestAnthropicToolListCaching"
Cohesion: 0.34
...
### Community 666 - "test_changelog_check_workflow.py"
Cohesion: 0.21
...
### Community 668 - "test_llm_router_tpm.py"
Cohesion: 0.17
...
### Community 669 - "TestWorkspace"
Cohesion: 0.16
Nodes (4): mcp_client(), tests/test_mcp_server.py — Unit tests for the MCP server and client. Tests: -…, TestClient for the MCP FastAPI app with workspace base patched to tmp_path., TestWorkspace

### Community 670 - "test_openclaw_gateway.py"
Cohesion: 0.14
...
### Community 671 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 672 - "test_tasks_awaiting_approval_api.py"
Cohesion: 0.37
...
### Community 673 - "AGENTS.md — Codebase Map & Operations Reference"
Cohesion: 0.15
...
### Community 674 - "test_telegram_service_webhook.py"
Cohesion: 0.18
...
### Community 676 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 679 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 680 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 683 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
...
### Community 684 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 685 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 687 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 688 - "admin_update_task_router.py"
Cohesion: 0.22
...
### Community 696 - "ApplyReviewAgent"
Cohesion: 0.22
...
### Community 698 - "_is_bedrock_model_id"
Cohesion: 0.27
...
### Community 699 - "_check_storage_health"
Cohesion: 0.12
...
### Community 705 - "TestModelCostTableUpdates"
Cohesion: 0.26
...
### Community 706 - "TestMCPClientStructuredOutput"
Cohesion: 0.13
...
### Community 707 - "test_deploy_trigger_covers_image.py"
Cohesion: 0.21
...
### Community 708 - "tests/conftest.py"
Cohesion: 0.05
...
### Community 710 - "test_agent_chat_integration.py"
Cohesion: 0.23
...
### Community 713 - "TestRouterIntegration"
Cohesion: 0.31
...
### Community 725 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 728 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 730 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 731 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 733 - "Quantization Internals"
Cohesion: 0.17
...
### Community 734 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 735 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 736 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 739 - "install-agents.sh"
Cohesion: 0.39
...
### Community 740 - "TestModelsEndpointAliases"
Cohesion: 0.31
...
### Community 749 - "TestAnthropicWorkspaceIdCapture"
Cohesion: 0.33
...
### Community 751 - "test_portfolio_intelligence.py"
Cohesion: 0.10
...
### Community 752 - "TestAnthropicPayloadStructuredOutput"
Cohesion: 0.29
...
### Community 753 - "test_task_clarification.py"
Cohesion: 0.17
...
### Community 755 - "DirectChatSession"
Cohesion: 0.15
...
### Community 757 - "_extractive_compress"
Cohesion: 0.18
...
### Community 773 - "2. Critical Bugs & Exact Detection Signatures"
Cohesion: 0.18
...
### Community 774 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 775 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 776 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 777 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 778 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 780 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 781 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 782 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 783 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 784 - "What to clean up"
Cohesion: 0.18
...
### Community 785 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 789 - "distributed.py"
Cohesion: 0.11
Nodes (12): DistributedRateLimiter, get_persistent_queue(), _LocalBucket, packages/llm/distributed.py — cross-instance coordination. Two facilities that…, True once a Redis connection has actually been established., Consume capacity, waiting up to ``max_wait_sec``. Returns False when capacity…, The process-wide persistent queue., Test hook — drop both singletons. (+4 more)

### Community 790 - "test_p0_roadmap_b3_b4_b5.py"
Cohesion: 0.20
...
### Community 792 - "build_tech_db.py"
Cohesion: 0.35
...
### Community 795 - "_timed_phase"
Cohesion: 0.22
Nodes (9): _note_phase_end(), _note_phase_start(), Log start/elapsed for one phase of the plan/execute/verify loop. A task that…, Open a tracked phase, returning the token that closes it. Never raises., Close the tracked phase *token* opened above. Never raises., _timed_phase(), A phase that hangs and is eventually cancelled, or errors outright, must still…, test_timed_phase_logs_start_and_end_with_elapsed_time() (+1 more)
...
### Community 797 - "test_conftest_hermetic_env.py"
Cohesion: 0.18
...
### Community 798 - "TestAgentRunnerSafety"
Cohesion: 0.19
...
Cohesion: 0.07
Nodes (35): E2BAdapter, Any, Runtime adapter that executes tasks inside an E2B sandbox. Activation:…, _FakeAsyncSandboxClass, _FakeCommandResult, _FakeCommands, _FakeFiles, _FakeSandbox (+27 more)
...
### Community 817 - "ENGINEERING_STANDARDS.md — Patterns & Reference"
Cohesion: 0.22
...
### Community 820 - "Competitor Analysis — Autonomous AI Agency"
Cohesion: 0.20
...
### Community 821 - "Issue #1427: quick-note:https://github.com/bingreeky/JIT"
Cohesion: 0.20
...
### Community 822 - "LLM Router — configuration guide"
Cohesion: 0.20
...
### Community 824 - "CI Troubleshooting Runbook"
Cohesion: 0.20
...
### Community 827 - "_parse_reset_epoch"
Cohesion: 0.33
...
### Community 832 - "test_catalogue_probe.py"
Cohesion: 0.20
...
### Community 834 - "TestZeroAttemptDiagnostics"
Cohesion: 0.29
...
### Community 835 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 836 - "test_model_catalog_guard.py"
Cohesion: 0.29
...
### Community 851 - "_build_direct_chat_schedule_suggestion"
Cohesion: 0.32
...
### Community 852 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 853 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 855 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
Nodes (8): Branch, Components, Purpose, Quick Start, Session Roles, Skill: cowork-session (Claude Cowork), Testing, When to Use

### Community 856 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 857 - "Active Task Tracker"
Cohesion: 0.22
...
### Community 859 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 860 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 861 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 862 - "Issue #1356: quick-note:https://searchengineland.com/turn-seo-backlog-into-roadmap-485713"
Cohesion: 0.22
...
### Community 863 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 864 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 865 - "Platform Controls"
Cohesion: 0.22
...
### Community 866 - "Release Procedure"
Cohesion: 0.22
...
### Community 867 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 869 - "TestPoliciesGovernanceStableClaim"
Cohesion: 0.25
...
### Community 874 - "test_changelog_parity_guard.py"
Cohesion: 0.22
...
### Community 876 - "TestGithubSignalHardening"
Cohesion: 0.22
...
### Community 877 - "TestPaidPolicyDurability"
Cohesion: 0.22
...
### Community 879 - "test_scanner_deps_parity.py"
Cohesion: 0.31
...
### Community 880 - "test_serve_spa_prefixes.py"
Cohesion: 0.31
...
### Community 891 - "_load_local_metrics_since"
Cohesion: 0.43
...
### Community 892 - "_parse_tool_calls_from_response"
Cohesion: 0.39
...
### Community 900 - "ADR 001: Self-Hosted OpenAI-Compatible Proxy"
Cohesion: 0.25
...
### Community 903 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 907 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.25
...
### Community 908 - "Issue #362: Nvidia repo setup"
Cohesion: 0.25
...
### Community 909 - "Issue #364: quick-note:https://www.marktechpost.com/2026/06/01/meet-memory-os-a-6-layer-open-source-memory-stack-built-on-top-of-hermes-agent/"
Cohesion: 0.25
...
### Community 910 - "Issue #378: quick-note:https://www.marktechpost.com/2026/06/02/tinyfish-launches-bigset-an-open-source-multi-agent-system-that-builds-structured-live-datasets-from-plain-english-descriptions/"
Cohesion: 0.25
...
### Community 911 - "Issue #379: quick-note:https://searchengineland.com/schema-markup-optimize-agentic-web-479080"
Cohesion: 0.25
...
### Community 912 - "Issue #380: quick-note:https://cursor.com/blog/cloud-agent-lessons"
Cohesion: 0.25
...
### Community 913 - "Issue #381: quick-note:https://www.xda-developers.com/claude-code-with-opus-48-is-expensive-but-i-made-it-efficient-with-my-local-ai-workflow/"
Cohesion: 0.25
...
### Community 914 - "Issue #382: quick-note:https://claude.com/blog/how-coderabbit-used-claude-to-build-an-agent-orchestration-system"
Cohesion: 0.25
...
### Community 915 - "Issue #383: quick-note:https://www.marktechpost.com/2026/05/29/hexo-labs-open-sources-sia-a-self-improving-agent-that-updates-both-the-harness-and-the-model-weights/"
Cohesion: 0.25
...
### Community 916 - "Issue #416: feat: Self-hosted Codebuff (freebuff) on free NVIDIA models + Telegram bot phone control"
Cohesion: 0.25
...
### Community 917 - "Issue #485: [Trend Digest] Week of 2026-06-08"
Cohesion: 0.25
...
### Community 918 - "Issue #488: quick-note:https://github.com/cookiy-ai/user-research-skill"
Cohesion: 0.25
...
### Community 919 - "Issue #491: Implement whatever is necessary from https://github.com/BehiSecc/awesome-claude-skills"
Cohesion: 0.25
...
### Community 920 - "Issue #493: Use the https://github.com/mvanhorn/last30days-skill skill to get the trend updated"
Cohesion: 0.25
...
### Community 921 - "Issue #495: Read https://www.anthropic.com/news/claude-fable-5-mythos-5 and understand if mythos or fable can be added to the repo"
Cohesion: 0.25
...
### Community 922 - "Issue #504: EPIC: Autonomy hardening — live-verified defects 2026-06-10"
Cohesion: 0.25
...
### Community 923 - "Issue #581: Sprint tracker: pending work after brand rename + mobile-first pass"
Cohesion: 0.25
...
### Community 925 - "Issue #657: quick-note:https://github.com/earendil-works/pi"
Cohesion: 0.25
...
### Community 926 - "Issue #659: quick-note:https://github.com/nex-agi/Nex-N2"
Cohesion: 0.25
...
### Community 927 - "Issue #660: quick-note:https://github.com/getsentry/sentry-for-ai"
Cohesion: 0.25
...
### Community 928 - "Issue #661: quick-note:https://github.com/XiaomiMiMo/MiMo-Code"
Cohesion: 0.25
...
### Community 929 - "Issue #664: quick-note:https://github.com/Grominet95/jarvis-OS"
Cohesion: 0.25
...
### Community 930 - "Issue #666: quick-note:https://github.com/porokka/jarvis-os"
Cohesion: 0.25
...
### Community 931 - "Issue #670: quick-note:https://github.com/perplexityai/bumblebee"
Cohesion: 0.25
...
### Community 932 - "Issue #672: quick-note:https://github.com/Chachamaru127/claude-code-harness"
Cohesion: 0.25
...
### Community 933 - "Issue #676: quick-note:https://github.com/WeiboAI/VibeThinker"
Cohesion: 0.25
...
### Community 934 - "Issue #820: quick-note:https://github.com/cobusgreyling/loop-engineering"
Cohesion: 0.25
...
### Community 935 - "Positional Encoding Internals"
Cohesion: 0.25
...
### Community 937 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 938 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 939 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 940 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 941 - "Feature Maturity / Support Matrix"
Cohesion: 0.12
...
### Community 942 - "Prime Agent Runtime"
Cohesion: 0.25
...
### Community 945 - "security_fix_agent.py"
Cohesion: 0.46
...
### Community 954 - "Workspace Issues"
Cohesion: 0.29
...
### Community 956 - "TestItIsNotBuiltForOneVendor"
Cohesion: 0.25
...
### Community 957 - "test_compose_and_coordinate_api.py"
Cohesion: 0.36
...
### Community 958 - "test_generate_context_standing_instructions.py"
Cohesion: 0.32
...
### Community 959 - "test_local_brain_router_smoke.py"
Cohesion: 0.25
...
### Community 963 - "test_provider_models_db_outage.py"
Cohesion: 0.25
...
### Community 965 - "test_runtimes_health_endpoint.py"
Cohesion: 0.25
...
### Community 966 - "Model and Response Issues"
Cohesion: 0.29
...
### Community 968 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.25
...
### Community 970 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 978 - "platform_controls_router.py"
Cohesion: 0.29
...
### Community 982 - "Changelog"
Cohesion: 0.29
Nodes (7): Added, Changed, Changelog, Fixed, Maintenance, Removed, Security

### Community 983 - "AI Engineering Insights Skill"
Cohesion: 0.29
...
### Community 997 - "claude-mem Plugin — Persistent Memory for All Sessions"
Cohesion: 0.29
...
### Community 998 - "Implementation plan + TO-DO (check off as you go)"
Cohesion: 0.29
...
### Community 1002 - "Cloudflare = the real working app"
Cohesion: 0.29
...
### Community 1010 - "check_changelog_parity.py"
Cohesion: 0.43
...
### Community 1011 - "check_doc_images.py"
Cohesion: 0.48
...
### Community 1014 - "test_daily_2026_06_14.py"
Cohesion: 0.38
...
### Community 1017 - "TestGithubTokenSQLiteRegression"
Cohesion: 0.38
...
### Community 1018 - "TestWorkflowIntegration"
Cohesion: 0.33
...
### Community 1019 - "TestReasonsAreActionable"
Cohesion: 0.29
...
### Community 1020 - "TestProvidersScreen"
Cohesion: 0.43
...
### Community 1023 - "_normalize_dockerfile"
Cohesion: 0.33
...
### Community 1024 - "InitiativeProgress"
Cohesion: 0.33
...
### Community 1026 - "openclaw_mobile_ui"
Cohesion: 0.33
...
### Community 1044 - "Admin Dashboard Issues"
Cohesion: 0.40
...
### Community 1045 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 1046 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 1047 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 1063 - "TestDirectChatAgentExecution"
Cohesion: 0.33
...
### Community 1064 - "TestDisabledProvidersAreNotFalselyReportedUnreachable"
Cohesion: 0.33
...
### Community 1066 - "Agent API Issues"
Cohesion: 0.40
...
### Community 1070 - "feature-implementer.md"
Cohesion: 0.40
Nodes (4): Before you edit, Prove it, Report back, While you edit

### Community 1071 - "/arch-review — Architecture Agent"
Cohesion: 0.40
...
### Community 1084 - "Network and Tunnel Issues"
Cohesion: 0.40
...
### Community 1085 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 1086 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 1096 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1097 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1098 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 1099 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 1100 - "setup_colibri.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1101 - "setup_colibri.sh script"
Cohesion: 0.70
Nodes (4): setup_colibri.sh script, fail(), ok(), warn()

### Community 1102 - "status_colibri_server.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1103 - "start_tunnel.py"
Cohesion: 0.50
...
### Community 1107 - "nvidia_live_test.py"
Cohesion: 0.40
...
### Community 1109 - "test_agent_runtime_wrapper.py"
Cohesion: 0.70
...
### Community 1111 - "TestNoKeyEverReachesTheLog"
Cohesion: 0.40
...
### Community 1112 - "TestTheProbeIdentifiesItself"
Cohesion: 0.40
...
### Community 1114 - "TestTelegramNotifications"
Cohesion: 0.40
...
### Community 1116 - "verify_pr_exists"
Cohesion: 0.50
...
### Community 1131 - "Claude Code Specific Issues"
Cohesion: 0.50
...
### Community 1151 - "github"
Cohesion: 0.50
Nodes (3): github, enabled, silent

### Community 1153 - "JWTUserStateMiddleware"
Cohesion: 0.67
...
### Community 1157 - "test_agent_loop_nosec_suppression.py"
Cohesion: 0.50
...
### Community 1179 - "test_the_reserve_is_bounded_when_read_from_the_environment"
Cohesion: 0.67
...
### Community 1180 - "test_skills_route_order.py"
Cohesion: 0.67
...
## Knowledge Gaps
- **3530 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3525 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 13470 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **129 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `_fixture()` connect `_fixture` to `test_operational_incidents.py`, `TaskStore`, `Task`, `test_brain_patch_service_token.py`, `test_llm_router_queue_cache.py`, `test_gh_brain_failover.py`, `config.py`, `test_llm_router_strategies.py`, `BrainWatchdog`, `test_ai_insights.py`, `test_model_router.py`, `AgentJobManager`, `WorkflowRun`, `SelfHealingAgent`, `TrafficDirector`, `AgentDefinition`, `ModelRouter`, `test_company_api.py`, `Agency`, `TaskStatus`, `test_telegram_webhook.py`, `E2BSandboxSession`, `llm/router.py`, `services/seo_audit.py`, `AgentSessionStore`, `ExecutionRequest`, `test_failover_client_shared.py`, `NotificationDispatcher`, `BrainConfig`, `test_unit8_model_catalog.py`, `PolicyEngine`, `OnboardingService`, `PrimeAgentAdapter`, `_start_autonomy_loops`, `test_ceo_router.py`, `test_openclaw_endpoints.py`, `enforcement.py`, `test_sam_livekit.py`, `test_llm_router_resilience.py`, `validate_policy_text`, `ChatHistoryStore`, `SQLiteStore`, `resolve_e2b_config`, `TokenBudget`, `e2e/test_browser.py`, `telegram_inbound_handlers.py`, `test_agent_tool_governance.py`, `test_autonomy_status.py`, `test_langfuse_agency_wide.py`, `test_self_heal_v2.py`, `test_local_brain_state.py`, `test_phase5_doctor.py`, `test_refresh_agent_built_proof.py`, `ResearchTask`, `test_tasks_reconciler_todo_requeue.py`, `test_procedural_memory.py`, `test_llm_router_e2e.py`, `claim`, `KeyStore`, `test_agent_free_brain.py`, `OutputFilter`, `resolve_active_brain`, `clear_cooldowns`, `TestClient`, `test_startup_warmup.py`, `KeyPool`, `UserRole`, `ArtifactStore`, `BackgroundAgent`, `FreeBuffAgent`, `test_new_features_e2e.py`, `TaskPriority`, `test_context_rulebook.py`, `test_provider_router.py`, `models/seo_audit.py`, `_step`, `run_task`, `test_changelog_check_workflow.py`, `test_trend_watcher.py`, `test_llm_router_tpm.py`, `TestWorkspace`, `test_openclaw_gateway.py`, `test_telegram_service_webhook.py`, `TestHarnessAdapter`, `persist_plan_spec`, `TestEstimateTokensForMessages`, `test_response_cache.py`, `FeatureMaturity`, `_resolve_brain_provider`, `test_telegram_freebuff.py`, `test_process_quick_note_workflow.py`, `TestSwarmRoleRouting`, `OllamaCircuitBreaker`, `_Budget`, `_job_text`, `WorkspaceTools`, `SchedulerStore`, `test_colibri_brain_shim.py`, `tests/conftest.py`, `test_features_api.py`, `test_video_transcript.py`, `test_dashboard_cache.py`, `TrendWatcher`, `AgentSwarm`, `test_portfolio_intake.py`, `WorkflowBuildRequest`, `brain_failover.py`, `test_agile_api.py`, `test_app_settings.py`, `TestClient`, `test_task_clarification.py`, `ContextPruner`, `test_daily_2026_07_27.py`, `test_persistent_memory.py`, `_resolve_user_github_token`, `test_platform_controls.py`, `test_kimi_bridge_server.py`, `test_sam_voice.py`, `TestAgentRunnerSafety`, `E2BAdapter`, `test_nvidia_model_discovery.py`, `test_mcp_governance.py`, `session_retro.py`, `ImprovementLoop`, `analyze_page`, `rate_limiter.py`, `SecurityScanner`, `_resolve_push_token`, `test_catalogue_probe.py`, `OrchestratorQueue`, `TestMongoGate`, `test_purge_backlog.py`, `test_regression.py`, `test_agent_scripts_share_one_model_list.py`, `test_crispy_burn_in.py`, `test_skill_registry_boot_refresh.py`, `WorkflowRun`, `test_brain_failover_413.py`, `isolated_telegram_config`, `test_scheduler_hydration_bounded.py`, `SeoCheckDefinition`, `test_provider_enable_disable.py`, `test_webui_provider_priority.py`, `_undeclared`, `test_service_token.py`, `test_harness_spec.py`, `get_scheduler`, `test_agency_fix.py`, `_Recorder`, `test_brain_availability_doctor.py`, `OrchestratorCheckpointStore`, `test_monitor_lib.py`, `test_v4_api.py`, `model_discovery.py`, `TestTheWorkflowIsSafeAndReadOnly`, `test_telegram_diag_endpoint.py`, `test_knowledge_sync.py`, `test_ping.py`, `test_runtimes_health_endpoint.py`, `test_task_store_fails_loud_in_production.py`, `test_provider_state_durability.py`, `RuntimeDependency`, `test_voice_pipeline.py`, `client`, `clear_override`, `cost_tracker.py`, `TestNormalizeResponseFormat`, `test_telegram_task_callback.py`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `TaskSpec`, `proxy.py`, `BackgroundAgent`, `FreeBuffAgent`, `AgentJobManager`, `ContextManager`, `WorkflowRun`, `ReactScratchpad`, `Agency`, `TestWorkspace`, `direct_chat.py`, `E2BSandboxSession`, `E2BAdapter`, `TestAgentRunnerSafety`, `test_empirical_verify.py`, `StuckDetector`, `CEODispatcher`, `MultiAgentSwarm`, `AgentSessionStore`, `TestAgentRunnerExecution`, `test_failover_client_shared.py`, `PolicyEngine`, `test_agent_runner.py`, `test_daily_automation_2026_07_11.py`, `workflow_orchestrator.py`, `WorkspaceTools`, `enforcement.py`, `_resolve_push_token`, `TestAgentLoopMCPIntegration`, `UserMemoryStore`, `test_agent_chat_integration.py`, `loop.py`, `TestGetCurrentTimeTool`, `LocalWorkspace`, `TokenBudget`, `test_backend_server_features.py`, `test_agent_tool_governance.py`, `test_brain_failover_413.py`, `test_governance_api.py`, `InternalAgentAdapter`, `test_agent_free_brain.py`, `GitHubTools`, `AdaptiveHalter`, `ContextPruner`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderRouter` to `backend/server.py`, `test_all_providers_discovery.py`, `test_provider_router.py`, `implement_agent.py`, `test_bedrock_live.py`, `TrafficDirector`, `ChatResponse`, `direct_chat.py`, `kimi_bridge_provider_config`, `ai/router.py`, `TestLegacyRouterCacheTTL`, `test_anthropic_refusal_fallback.py`, `test_colibri_brain_shim.py`, `TestOpenAiToBedrockConverse`, `TestRouterIntegration`, `test_implement_agent_routing.py`, `_payload`, `TestLegacyRouterServerFallback`, `test_chat_mode_regressions.py`, `ProviderConfig`, `failover_client.py`, `TestAnthropicPayloadStructuredOutput`, `clear_cooldowns`?**
