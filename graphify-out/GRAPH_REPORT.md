...
## Corpus Check
- 1502 files · ~2,176,380 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 30436 nodes · 56848 edges · 1283 communities (1123 shown, 112 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 3331 edges (avg confidence: 0.92)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `89eae88d`
...
Cohesion: 0.02
Nodes (175): account_lifecycle(), AccountLifecycleResponse, auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint(), _DoctorCheck, _DoctorReport (+167 more)

### Community 2 - "TaskSpec"
Cohesion: 0.03
Nodes (112): kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, AiderAdapter, Any, TaskResult, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Run aider non-interactively via `--message` flag., Adapter for Aider — TIER 3 specialized git-aware code editor. (+104 more)

### Community 3 - "proxy.py"
Cohesion: 0.03
Nodes (169): get_sam(), check_ollama_async(), Async Ollama reachability check — non-blocking for FastAPI handlers., middleware, admin_control(), admin_create_key(), admin_create_user(), admin_delete_user() (+161 more)

### Community 4 - "ImprovementLoop"
Cohesion: 0.03
Nodes (118): Agency, AgencyCycleResult, AgentDirective, AgentRole, _build_ceo_prompt(), _build_quick_note_instruction(), _close_github_issue(), _collect_recent_git_context() (+110 more)
...
Cohesion: 0.02
Nodes (78): get_optional_company_access(), Verify user has access to a company (if authenticated). Admins bypass ownership…, Company, CompanyGraph, CompanyGraphSnapshot, SystemType, The core company entity - root of the Company Graph., The complete Company Graph - canonical core model for the Autonomous AI Agency.… (+70 more)
...
Cohesion: 0.03
Nodes (57): CircuitState, runtimes/health.py — RuntimeHealthService. Periodically polls all registered…, Return the last-known health for *runtime_id* (may be stale)., Return True if the runtime is available (not circuit-open)., Return health snapshots for all known runtimes., Force an immediate health check of all runtimes and return results., Attempt to start a dead runtime subprocess before re-probing. Uses the local…, Reduce probe frequency for runtimes that have never come online. (+49 more)

### Community 11 - "AgentJobManager"
Cohesion: 0.03
Nodes (77): PreflightIssue, PreflightReport, BaseModel, AgentJob, AgentJobManager, make_isolated_workspace(), _now(), Any (+69 more)

### Community 12 - "test_ceo_dispatcher.py"
Cohesion: 0.03
Nodes (116): _merge_changed_files(), Collect changed_files across all specialists into a single de-duped list., BoundContext, ClassifyOutput, ExecutionResult, get_ceo_fallback_stats(), JudgeVerdict, MonitorOutput (+108 more)
...
### Community 15 - "AnthropicProvider"
Cohesion: 0.04
Nodes (60): AnthropicProvider, Any, AsyncClient, packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, Translate OpenAI-shaped messages into Anthropic's system/turn split., OpenAI carries a tool result as role="tool" with a tool_call_id; Anthropic…, OpenAI puts a tool call alongside the assistant's text; Anthropic needs…, Return the cache_control block appropriate for this provider's TTL setting.… (+52 more)

### Community 16 - "services/background.py"
Cohesion: 0.03
Nodes (103): get_agency(), set_agency(), _dispatch_async(), _ErrorCaptureHandler, get_log_monitor(), LogMonitor, _note_recurrence(), Any (+95 more)
...
Cohesion: 0.03
Nodes (100): _acquire_provider_probe(), _dead_model_key(), extract_openai_text(), _get_director(), is_commercial_provider(), _mark_model_dead(), _normalize_nvidia_base_url(), _normalized_provider_type() (+92 more)

### Community 19 - "test_llm_router_queue_cache.py"
Cohesion: 0.03
Nodes (77): Test hook — clear all usage accounting., reset(), CacheManager, cosine_similarity(), _Entry, LRUCache, payload_key(), Any (+69 more)

### Community 20 - "test_operational_incidents.py"
Cohesion: 0.02
Nodes (103): _format_incident(), _iso_from_monotonic(), normalise(), note_phase_end(), note_phase_start(), _now(), open_phase_report(), OperationalIncident (+95 more)
...
Cohesion: 0.04
Nodes (71): AgentDefinition, AgentStore, Any, field_validator, CRUD store for AgentDefinition objects. Uses MongoDB when a `db` client is…, Return an agent by ID. If *owner_id* is provided, enforces that the agent…, Delete an agent. Returns True on success, False if not found/unauthorised., Return all agents owned by *owner_id*, optionally including public agents. (+63 more)
...
### Community 25 - "test_autonomous_agency_e2e.py"
Cohesion: 0.03
...
Cohesion: 0.04
Nodes (78): tasks — Task/issue management system. Provides a lightweight task/issue tracker…, str, TaskPriority, _priority_rank(), Any, tasks/store.py — MongoDB-backed task store. Falls back to in-memory storage…, Fail loud in production if no persistent storage is configured. Telegram…, List tasks for a specific user with optional filters. ``include_system``… (+70 more)
...
Cohesion: 0.02
Nodes (52): BusinessCategory, Find a website by its URL., A company website with detected systems and stack inference., Website, CompanyGraphService, Company, SpecialistFamily, SystemType (+44 more)

### Community 35 - "WorkflowRun"
Cohesion: 0.04
Nodes (54): MergeDecision, _NoopStore, Phase, Any, Enum, Exception, Approve a run paused at the ApprovalGate. The caller must re-invoke…, Inject additional instructions into an in-flight run (no state change). Backs… (+46 more)
...
### Community 38 - "direct_chat.py"
Cohesion: 0.04
Nodes (79): DirectChatDoctor, Any, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, Translate technical preflight issues into a conversational assistant reply., translate_error_to_conversational(), classify_direct_chat_intent(), _contains_keyword(), detect_intent() (+71 more)
...
Cohesion: 0.04
Nodes (77): AgentPhaseError, AgentRunner, Exception, Return True when no file is touched by more than one step., Raised when a named agent phase (planning, verification, etc.) fails., GATE: Golden Path steps #7-12 — the primary agent execution loop. This is the…, Set a per-session token spend cap (★3 rollout token budget). When *cap* > 0 the…, The core #656 regression: an Anthropic-shaped model must NOT hit… (+69 more)
...
Cohesion: 0.04
Nodes (70): livenim, allow_paid_brain(), BrainResolution, get_active_brain_sync(), get_provider_role_tags(), _host_is_openai_compatible(), is_anthropic_model(), _norm() (+62 more)
...
### Community 52 - "seo_portfolio_bridge.py"
Cohesion: 0.05
...
### Community 54 - "get_scheduler"
Cohesion: 0.04
Nodes (49): legacy_scheduler_create(), legacy_scheduler_get(), LegacyScheduleJobRequest, get_store(), Return the active store singleton, creating it on first call., apply_from_db(), Load the stored overrides and apply them. Called once at startup., get_scheduler() (+41 more)

### Community 55 - "ChatHistoryStore"
Cohesion: 0.04
...
Cohesion: 0.04
Nodes (67): _auto_disable(), _describe_registry(), _disable_unless_key_serves_other_models(), _disabled_ids(), FailoverResult, _is_billing_refusal(), _is_ollama(), _key_pool() (+59 more)
...
### Community 65 - "Any"
Cohesion: 0.04
Nodes (32): _nvidia_api_key(), Any, Governance seam: judge the call, run it, audit the outcome. Deliberately a thin…, Append an event to the durable session log if a store is wired in., Summarise a long history and compact it. Asks the planner model to write a…, Send chat messages and return the assistant's text output. If an…, Call-time resolver for an agent role model id. Delegates to…, Parse an LLM tool-call response, tolerating common malformations. Handles: 1.… (+24 more)

### Community 66 - "test_cost_aware_routing_eval.py"
Cohesion: 0.06
...
### Community 69 - "test_brain_failover.py"
Cohesion: 0.05
Nodes (53): BrainFailoverManager, get_failover_manager(), ProviderHealth, ProviderInfo, Any, Record a successful call — resets the circuit breaker., Permit one probe call without claiming the provider succeeded. This is the…, Seconds until the soonest cooling provider is probeable again. ``None`` when no… (+45 more)
...
### Community 72 - "validate_policy_text"
Cohesion: 0.06
...
### Community 73 - "PrimeAgentAdapter"
Cohesion: 0.05
...
### Community 81 - "CEODispatcher"
Cohesion: 0.06
Nodes (47): CEODispatcher, CEOResult, _complexity_rank(), _decompose_into_subtasks(), _offload(), Any, Semaphore, services/ceo_dispatcher.py — Real CEO delegation layer. The CEO splits a… (+39 more)

### Community 82 - "test_procedural_memory.py"
Cohesion: 0.05
...
### Community 86 - "test_brain_config_api.py"
Cohesion: 0.05
...
### Community 92 - "TestAddConversationCacheBreakpoints"
Cohesion: 0.06
...
### Community 101 - "test_llm_router_tpm.py"
Cohesion: 0.06
...
### Community 114 - "test_web_reach.py"
Cohesion: 0.08
...
### Community 116 - "FreeBuffAgent"
Cohesion: 0.06
Nodes (47): free_nvidia_models(), FreeBuffAgent, Return the curated list of free NVIDIA NIM models FreeBuff may use., Codebuff-style coding agent pinned to free NVIDIA NIM models. FreeBuff is a…, List the free NVIDIA NIM models a user may pick (e.g. via Telegram)., True when *model* is in the curated free NVIDIA NIM set., is_rate_limit_exempt(), _rate_limit_exempt_key_ids() (+39 more)
...
### Community 118 - "TestHarnessAdapter"
Cohesion: 0.05
...
### Community 119 - "test_backend_server_features.py"
Cohesion: 0.04
Nodes (40): backend/ceo_router.py — observability and manual control for the CEO. Surfaces…, Reject non-admin callers for routes that spend provider budget. Delegates to…, _require_admin(), _is_admin(), Check if a user has admin role. Works for both social_auth users (role in…, _actor(), ControlUpdateBody, BaseModel (+32 more)
...
### Community 126 - "test_response_cache.py"
Cohesion: 0.10
...
### Community 127 - "UserRole"
Cohesion: 0.09
Nodes (35): UserRole, _can_read(), _can_write(), _decrypt(), _encrypt(), _get_master_key(), BaseModel, str (+27 more)

### Community 128 - "brain_failover.py"
Cohesion: 0.05
Nodes (46): _disabled_from_mongo(), _disabled_from_sqlite(), _is_paid_allowed_db(), _kv_connect(), _kv_path(), _mongo_db(), _mongo_enabled(), _mongo_unavailable() (+38 more)
...
### Community 133 - "enforcement.py"
Cohesion: 0.06
Nodes (41): _load(), mcp_server/governance.py — governance adapter for the MCP HTTP surface. Closes…, Import the governance layer once, recording why if it is absent., BudgetExceeded, classify(), evaluate_call(), guard_tool_call(), GuardResult (+33 more)

### Community 134 - "portfolio_intelligence.py"
Cohesion: 0.07
...
### Community 137 - ".run"
Cohesion: 0.07
Nodes (38): Build a readable markdown report for the task comment. Includes the goal,…, build_spec_router(), Any, APIRouter, backend/spec_router.py — review/approve persisted plan specifications. Surfaces…, await_spec_approval(), _db(), _flag() (+30 more)
...
### Community 149 - "E2BAdapter"
Cohesion: 0.06
Nodes (37): E2BAdapter, Any, TaskResult, Execute a task inside a fresh E2B sandbox. Flow: 1. Open an…, Run ``pytest`` inside the sandbox. Returns ``(output, passed)``.…, Runtime adapter that executes tasks inside an E2B sandbox. Activation:…, Available iff config resolves AND the SDK is importable. Never raises — a…, _FakeAsyncSandboxClass (+29 more)
...
### Community 152 - "WorkspaceManager"
Cohesion: 0.09
...
### Community 153 - "activation_api.py"
Cohesion: 0.08
...
### Community 154 - "ProviderRouter"
Cohesion: 0.06
Nodes (25): _exponential_backoff_cooldown(), _notify_watchdog(), ProviderRouter, Try all models for one provider. Returns ProviderResult on success, None on…, Notify the brain watchdog of a provider call outcome (fire-and-forget).…, Parse a 429/503 ``Retry-After`` header → seconds, or None. Accepts either…, Translate an OpenAI chat/completions payload to Bedrock Converse format., Translate a Bedrock Converse API response to OpenAI chat.completion format. (+17 more)

### Community 155 - "ApprovalStore"
Cohesion: 0.06
...
### Community 156 - "TestAdapterMetadata"
Cohesion: 0.05
...
### Community 166 - "test_slop_gate.py"
Cohesion: 0.07
...
### Community 170 - "WorkflowBuildRequest"
Cohesion: 0.07
...
### Community 180 - "StreamingDeltaReconstructor"
Cohesion: 0.07
...
### Community 188 - "chat_handlers.py"
Cohesion: 0.09
...
### Community 190 - "test_schedule_growth_invariants.py"
Cohesion: 0.06
...
Cohesion: 0.06
Nodes (30): Declare ``E2B_API_KEY`` as a required env dependency. The base ``preflight``…, _best_cloud_primary_base(), InternalAgentAdapter, TaskResult, Internal runtime adapter that executes tasks via the built-in AgentRunner.…, Built-in agent loop — Nvidia NIM primary, Ollama fallback., Return runtime dependencies required by this adapter. Returns:…, Determine availability of the internal agent runtime. Checks cloud providers in… (+22 more)
...
### Community 195 - "TestRuntimeControl"
Cohesion: 0.04
...
### Community 196 - "test_task_self_repo_auto_commit.py"
Cohesion: 0.08
Nodes (42): agent_branch_name(), assert_agent_can_merge(), assert_agent_can_write(), AutonomyViolation, is_protected_branch(), _protected_branches(), Autonomy gate — enforce 'agents propose via PR, humans merge'. The agency can…, Raised when an agent-initiated action would exceed the propose-PR policy. (+34 more)

### Community 197 - "WorkspaceTools"
Cohesion: 0.07
...
### Community 202 - "_get_provider_policy"
Cohesion: 0.07
...
### Community 204 - "services/seo_audit.py"
Cohesion: 0.07
...
### Community 206 - "test_runtime_governance.py"
Cohesion: 0.12
...
### Community 211 - "portfolio_api.py"
Cohesion: 0.08
...
### Community 212 - "models/seo_audit.py"
Cohesion: 0.09
...
### Community 218 - "test_agent_tool_governance.py"
Cohesion: 0.09
...
### Community 219 - "TestRecordUsageAndStats"
Cohesion: 0.05
...
### Community 220 - "test_loop_registry.py"
Cohesion: 0.10
...
### Community 224 - "resolve_component_model"
Cohesion: 0.06
...
### Community 225 - "sync/service.py"
Cohesion: 0.10
Nodes (32): FastAPI dependency: require Power User or Admin role. Raises 403 otherwise., require_power_user(), add_peer(), get_folder_index(), get_sync_file(), get_sync_service(), list_conflicts(), list_peers() (+24 more)

### Community 226 - "test_portfolio_intake.py"
Cohesion: 0.09
...
### Community 228 - "test_bedrock_provider.py"
Cohesion: 0.08
...
### Community 232 - "compare_runtimes.py"
Cohesion: 0.07
...
### Community 237 - "TestAuthAndTaskOwnership"
Cohesion: 0.05
...
### Community 245 - "NotificationDispatcher"
Cohesion: 0.08
...
### Community 263 - "nvidia_models.py"
Cohesion: 0.09
...
### Community 269 - "skill_bindings.py"
Cohesion: 0.09
...
### Community 273 - "OrchestratorSupervisor"
Cohesion: 0.09
...
### Community 275 - "test_daily_2026_06_04.py"
Cohesion: 0.09
...
### Community 279 - "test_all_providers_discovery.py"
Cohesion: 0.17
...
### Community 287 - "test_platform_controls.py"
Cohesion: 0.08
...
### Community 288 - "report_to_markdown"
Cohesion: 0.10
...
### Community 296 - "test_failover_silent_exhaustion.py"
Cohesion: 0.10
...
### Community 300 - "LlmProviderConfig"
Cohesion: 0.15
...
### Community 304 - "OrchestratorCheckpointStore"
Cohesion: 0.09
...
### Community 305 - "OrchestratorQueue"
Cohesion: 0.07
...
### Community 307 - "test_nvidia_model_discovery.py"
Cohesion: 0.06
...
### Community 315 - "_resolve_user_github_token"
Cohesion: 0.11
...
### Community 316 - "Quick-Note GitHub Issues Processing - Session Summary"
Cohesion: 0.06
...
### Community 317 - "test_rate_limiter.py"
Cohesion: 0.10
...
### Community 323 - "test_rag_context.py"
Cohesion: 0.12
...
### Community 324 - "ProjectScaffolder"
Cohesion: 0.13
...
### Community 325 - "generate_context.py"
Cohesion: 0.12
...
### Community 329 - "CompanyAgencyService"
Cohesion: 0.09
...
### Community 330 - "test_internal_agent_did_work.py"
Cohesion: 0.12
...
### Community 331 - "test_mcp_governance.py"
Cohesion: 0.13
...
### Community 339 - "kimi_bridge_provider_config"
Cohesion: 0.11
...
### Community 344 - "test_regression.py"
Cohesion: 0.10
...
### Community 345 - "test_agent_scripts_share_one_model_list.py"
Cohesion: 0.10
...
### Community 346 - "test_crispy_burn_in.py"
Cohesion: 0.07
...
### Community 367 - "test_scheduler_hydration_bounded.py"
Cohesion: 0.09
...
### Community 371 - "Performance Analysis — local-llm-server"
Cohesion: 0.08
...
### Community 373 - "test_feature_maturity.py"
Cohesion: 0.10
...
### Community 380 - "test_provider_enable_disable.py"
Cohesion: 0.10
...
### Community 385 - "test_ceo_router.py"
Cohesion: 0.16
...
### Community 396 - "TemporalContextGraph"
Cohesion: 0.10
...
### Community 397 - "test_telegram_approval_e2e.py"
Cohesion: 0.12
...
### Community 407 - "test_dashboard_cache.py"
Cohesion: 0.13
...
### Community 409 - "Implementation Prompt: Rich TaskBoard + Agile Sprint Integration"
Cohesion: 0.08
...
### Community 411 - "implement_agent.py"
Cohesion: 0.12
...
### Community 423 - "_status_snapshot"
Cohesion: 0.15
...
### Community 454 - "test_portfolio_intelligence.py"
Cohesion: 0.10
...
### Community 459 - "render_router.py"
Cohesion: 0.12
...
### Community 460 - "_ensure_tasks_source_id_unique_index"
Cohesion: 0.14
...
### Community 461 - "TestNormalizeResponseFormat"
Cohesion: 0.10
...
### Community 463 - "SeoCheckDefinition"
Cohesion: 0.12
...
### Community 467 - "weekly_digest.py"
Cohesion: 0.13
...
### Community 471 - "get_tool_registry"
Cohesion: 0.13
...
### Community 491 - "get_ceo_dispatcher"
Cohesion: 0.13
...
### Community 510 - "Skill: fabric-patterns"
Cohesion: 0.11
Nodes (18): 1. Ensure Pattern Directory Exists, 2. List Available Patterns, 3. Retrieve a Pattern, 4. Apply a Pattern with Variables, 5. Stitch Patterns Together, 6. Create New Patterns, Acceptance Checks, Directory Structure (+10 more)

### Community 511 - "db/__init__.py"
Cohesion: 0.14
...
### Community 513 - "Implementation Plan"
Cohesion: 0.11
...
### Community 519 - "test_issue_triage.py"
Cohesion: 0.16
...
### Community 543 - "TestRouterIntegration"
Cohesion: 0.19
...
### Community 546 - "test_agent_tools.py"
Cohesion: 0.19
...
### Community 547 - "test_company_api.py"
Cohesion: 0.11
...
### Community 549 - "test_self_heal.py"
Cohesion: 0.11
...
### Community 550 - "test_telegram_task_callback.py"
Cohesion: 0.16
...
### Community 557 - "cowork_session.py"
Cohesion: 0.15
...
### Community 558 - "SKILL: Industrial Brutalism & Tactical Telemetry UI"
Cohesion: 0.12
...
### Community 559 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 560 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 561 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 565 - "redact_connection_url"
Cohesion: 0.17
...
### Community 584 - "load_registry_sync"
Cohesion: 0.15
...
### Community 591 - "_valid_login_state"
Cohesion: 0.24
...
### Community 594 - "Nothing is blocked on an agent. Two things need a human."
Cohesion: 0.12
...
### Community 600 - "test_agent_chat_integration.py"
Cohesion: 0.23
...
### Community 613 - "test_langfuse_agency_wide.py"
Cohesion: 0.12
...
### Community 617 - "test_phase5_doctor.py"
Cohesion: 0.12
...
### Community 618 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 619 - "test_refresh_agent_built_proof.py"
Cohesion: 0.12
...
### Community 620 - "test_tasks_reconciler_todo_requeue.py"
Cohesion: 0.20
...
### Community 624 - "CollaborationContext"
Cohesion: 0.17
...
### Community 633 - "Skill: user-research"
Cohesion: 0.13
...
### Community 634 - "DirectChatSession"
Cohesion: 0.14
...
### Community 639 - "_push_down_where"
Cohesion: 0.14
...
### Community 641 - "router/health.py"
Cohesion: 0.20
...
### Community 651 - "test_scanner_live.py"
Cohesion: 0.23
...
### Community 656 - "test_ai_insights.py"
Cohesion: 0.20
...
### Community 659 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 663 - "Checks Performed"
Cohesion: 0.14
...
### Community 664 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 665 - "test_new_features_e2e.py"
Cohesion: 0.29
...
### Community 666 - "admin_digest_router.py"
Cohesion: 0.22
...
### Community 667 - "mint_access_token"
Cohesion: 0.14
...
### Community 679 - "Traffic Distribution Across Providers"
Cohesion: 0.14
...
### Community 680 - "FeatureUnavailableError"
Cohesion: 0.15
...
### Community 683 - "is_anthropic_base_url"
Cohesion: 0.18
...
### Community 684 - "extract_failures"
Cohesion: 0.21
...
### Community 685 - "test_p0_roadmap_b3_b4_b5.py"
Cohesion: 0.20
...
### Community 688 - ".on_task_complete"
Cohesion: 0.16
...
### Community 689 - "TestAnthropicToolListCaching"
Cohesion: 0.34
...
### Community 690 - "TestMCPToolsListCache"
Cohesion: 0.19
...
### Community 691 - "test_openclaw_gateway.py"
Cohesion: 0.14
...
### Community 692 - "test_provider_state_durability.py"
Cohesion: 0.15
...
### Community 694 - "test_tasks_awaiting_approval_api.py"
Cohesion: 0.37
...
### Community 697 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 700 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 701 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 705 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 706 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 708 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 709 - "admin_update_task_router.py"
Cohesion: 0.22
...
### Community 711 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
Nodes (12): Acceptance Checks, Claude's query protocol (use this instead of Read tool for exploration):, Graph Artifacts — What to Commit, How to Use the Graph (Token Savings Protocol), Installation (one-time per machine), Instead of reading raw files:, Key commands:, Relationship to repowise-intelligence Skill (+4 more)

### Community 712 - "Skill: platform-setup — Autonomous Agency Bootstrap"
Cohesion: 0.15
...
### Community 713 - "Device compatibility and model picks"
Cohesion: 0.15
...
### Community 714 - "Autonomy Uplift — Living Roadmap & Detailed Implementation Specs"
Cohesion: 0.15
...
### Community 715 - "OpenClaw — iOS Control of the Agency (Single-Service Free-Tier Deploy)"
Cohesion: 0.15
...
### Community 717 - "ApplyReviewAgent"
Cohesion: 0.22
...
### Community 720 - "_parse_reset_epoch"
Cohesion: 0.23
...
### Community 721 - "_is_bedrock_model_id"
Cohesion: 0.27
...
### Community 723 - "Agent Transparency Report"
Cohesion: 0.15
...
### Community 724 - "update_provider_policy"
Cohesion: 0.19
...
### Community 727 - "TestAgentRunnerSafety"
Cohesion: 0.19
...
### Community 728 - "TestModelCostTableUpdates"
Cohesion: 0.26
...
### Community 729 - "TestMCPClientStructuredOutput"
Cohesion: 0.31
...
### Community 730 - "test_deploy_trigger_covers_image.py"
Cohesion: 0.21
...
### Community 731 - "TestKillSwitchDurability"
Cohesion: 0.15
...
### Community 733 - "test_task_brain_preflight.py"
Cohesion: 0.31
...
### Community 737 - "plan_next_sprint"
Cohesion: 0.17
...
### Community 746 - "_is_ephemeral_user"
Cohesion: 0.27
...
### Community 752 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 753 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 754 - "Workspace Isolation Architecture"
Cohesion: 0.17
...
### Community 756 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 757 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 758 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 759 - "GovernanceScreen.jsx"
Cohesion: 0.18
...
### Community 762 - "test_pytest_failure_parser.py"
Cohesion: 0.23
...
### Community 763 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 765 - "test_admin_local_brain_router.py"
Cohesion: 0.29
...
### Community 766 - "test_agile_api.py"
Cohesion: 0.17
...
### Community 767 - "test_app_settings.py"
Cohesion: 0.21
...
### Community 768 - "test_brain_default_consistency.py"
Cohesion: 0.24
...
### Community 806 - "capture_screens.py"
Cohesion: 0.25
...
### Community 810 - "test_conftest_hermetic_env.py"
Cohesion: 0.18
...
### Community 811 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 812 - "test_event_log.py"
Cohesion: 0.45
...
### Community 813 - "test_google_provider_models.py"
Cohesion: 0.18
...
### Community 827 - "Agent Readiness Report"
Cohesion: 0.20
...
### Community 829 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 830 - "Competitor Analysis — Autonomous AI Agency"
Cohesion: 0.20
...
### Community 831 - "Issue #1427: quick-note:https://github.com/bingreeky/JIT"
Cohesion: 0.20
...
### Community 838 - "_redact_for_notification"
Cohesion: 0.24
...
### Community 839 - "test_catalogue_probe.py"
Cohesion: 0.20
...
### Community 842 - "test_model_catalog_guard.py"
Cohesion: 0.29
...
### Community 850 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 854 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 856 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 857 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 859 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
Nodes (8): Branch, Components, Purpose, Quick Start, Session Roles, Skill: cowork-session (Claude Cowork), Testing, When to Use

### Community 860 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 863 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 864 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 865 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 866 - "Issue #1356: quick-note:https://searchengineland.com/turn-seo-backlog-into-roadmap-485713"
Cohesion: 0.22
...
### Community 867 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 868 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 869 - "Platform Controls"
Cohesion: 0.22
...
### Community 870 - "Release Procedure"
Cohesion: 0.22
...
### Community 871 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 873 - "_extract_pytest_failure"
Cohesion: 0.42
...
### Community 878 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 882 - "TestPolicyAuthoringUiStableClaim"
Cohesion: 0.22
...
### Community 886 - "test_serve_spa_prefixes.py"
Cohesion: 0.31
...
### Community 898 - "_brain_provider_status"
Cohesion: 0.25
...
### Community 908 - "Agent Autonomy Roadmap"
Cohesion: 0.25
...
### Community 909 - "AGENTS.md — AI Agent Configuration for local-llm-server"
Cohesion: 0.25
...
### Community 910 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 911 - "ceo-micromanagement.md"
Cohesion: 0.25
Nodes (4): P0 behavior change, Readiness contract, Runtime model, Runtime types

### Community 912 - "Feature Maturity / Support Matrix"
Cohesion: 0.25
...
### Community 944 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 945 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 946 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 947 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 966 - "TestPoliciesGovernanceStableClaim"
Cohesion: 0.25
...
### Community 975 - "test_server_autonomy_and_index_fixes.py"
Cohesion: 0.29
...
### Community 1016 - "check_changelog_parity.py"
Cohesion: 0.43
...
### Community 1020 - "test_daily_2026_06_14.py"
Cohesion: 0.38
...
### Community 1021 - "TestSupportMatrixDocsSync"
Cohesion: 0.29
...
### Community 1022 - "test_doctor_coding_brain.py"
Cohesion: 0.38
...
### Community 1024 - "test_log_monitor_storm_guard.py"
Cohesion: 0.48
...
### Community 1025 - "TestReasonsAreActionable"
Cohesion: 0.29
...
### Community 1026 - "TestProvidersScreen"
Cohesion: 0.43
...
### Community 1067 - "TestDirectChatAgentExecution"
Cohesion: 0.33
...
### Community 1069 - "TestCEOAgencySystem"
Cohesion: 0.33
...
### Community 1070 - "TestDisabledProvidersAreNotFalselyReportedUnreachable"
Cohesion: 0.33
...
### Community 1091 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 1092 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 1093 - "Runtime troubleshooting"
Cohesion: 0.40
...
### Community 1119 - "TestTelegramNotifications"
Cohesion: 0.40
...
### Community 1123 - "TestModelRoleSeparation"
Cohesion: 0.40
...
### Community 1124 - "worker/index.js"
Cohesion: 0.60
Nodes (4): fetch(), needsProxy(), PROXY_PREFIXES, scheduled()

### Community 1125 - "verify_pr_exists"
Cohesion: 0.50
...
### Community 1154 - "test_no_exception_detail_leaks.py"
Cohesion: 0.50
...
- **3527 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3522 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 13446 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **112 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `_fixture()` connect `_fixture` to `company_api.py`, `TaskSpec`, `ImprovementLoop`, `parse_event_stream`, `llm/router.py`, `test_brain_patch_service_token.py`, `test_llm_router_strategies.py`, `AgentJobManager`, `test_gh_brain_failover.py`, `brain_config.py`, `services/background.py`, `ProviderConfig`, `test_llm_router_queue_cache.py`, `test_operational_incidents.py`, `Task`, `SelfHealingAgent`, `TaskStatus`, `test_autonomous_agency_e2e.py`, `E2BSandboxSession`, `PolicyEngine`, `TaskStore`, `TestRouterIntegration`, `test_failover_client_shared.py`, `_process_task_callback`, `test_company_api.py`, `WorkflowRun`, `test_llm_router_resilience.py`, `test_telegram_task_callback.py`, `test_telegram_service_webhook.py`, `test_telegram_webhook.py`, `test_model_router.py`, `test_unit8_model_catalog.py`, `tasks/models.py`, `AgentSwarm`, `TokenBudget`, `KeyPool`, `ExecutionRequest`, `get_scheduler`, `ChatHistoryStore`, `get_registry`, `test_webui_provider_priority.py`, `test_openclaw_endpoints.py`, `test_task_service_failed_comment.py`, `ResearchTask`, `validate_policy_text`, `PrimeAgentAdapter`, `reset_cache`, `_resolve_brain_provider`, `TestClient`, `KeyStore`, `test_sam_voice.py`, `SeoAuditEngine`, `test_procedural_memory.py`, `BrainWatchdog`, `SQLiteStore`, `test_startup_warmup.py`, `test_telegram_auto_approve.py`, `e2e/test_browser.py`, `config.py`, `test_autonomy_status.py`, `test_llm_router_tpm.py`, `test_local_brain_state.py`, `test_knowledge_sync.py`, `test_phase5_doctor.py`, `resolve_e2b_config`, `test_refresh_agent_built_proof.py`, `test_tasks_reconciler_todo_requeue.py`, `_clean_director`, `TestHarnessAdapter`, `test_context_rulebook.py`, `ArtifactStore`, `run_task`, `test_response_cache.py`, `UserRole`, `brain_failover.py`, `test_trend_scoping.py`, `clear_cooldowns`, `.run`, `CEOSupervisor`, `test_kimi_bridge_server.py`, `test_issue_intake.py`, `_step`, `test_new_features_e2e.py`, `ProviderRouter`, `ApprovalStore`, `test_trend_watcher.py`, `claim`, `TestEstimateTokensForMessages`, `WorkflowBuildRequest`, `MCPClient`, `test_daily_2026_07_27.py`, `.on_task_complete`, `test_openclaw_gateway.py`, `test_provider_state_durability.py`, `test_process_quick_note_workflow.py`, `OllamaCircuitBreaker`, `_job_text`, `TestRuntimeControl`, `test_task_self_repo_auto_commit.py`, `services/seo_audit.py`, `_Budget`, `test_features_api.py`, `test_video_transcript.py`, `TrendWatcher`, `models/seo_audit.py`, `TestAgentRunnerSafety`, `SchedulerStore`, `test_agent_tool_governance.py`, `test_task_brain_preflight.py`, `test_portfolio_intake.py`, `test_e2b_data_flow.py`, `TestAuthAndTaskOwnership`, `test_llm_router_disabled.py`, `NotificationDispatcher`, `TestClient`, `ContextPruner`, `test_agile_api.py`, `test_app_settings.py`, `test_brain_availability_doctor.py`, `timedelta`, `test_task_clarification.py`, `test_persistent_memory.py`, `SecurityScanner`, `test_llm_router_e2e.py`, `OutputFilter`, `test_platform_controls.py`, `capture_screens.py`, `OrchestratorCheckpointStore`, `OrchestratorQueue`, `test_nvidia_model_discovery.py`, `_resolve_user_github_token`, `test_rate_limiter.py`, `analyze_page`, `test_catalogue_probe.py`, `TestMongoGate`, `test_regression.py`, `test_agent_scripts_share_one_model_list.py`, `test_crispy_burn_in.py`, `test_skill_registry_boot_refresh.py`, `tests/conftest.py`, `test_session_retro.py`, `isolated_telegram_config`, `TestSwarmRoleRouting`, `test_scheduler_hydration_bounded.py`, `test_feature_maturity.py`, `test_provider_enable_disable.py`, `_undeclared`, `test_service_token.py`, `test_harness_spec.py`, `test_dashboard_cache.py`, `test_agency_fix.py`, `_Recorder`, `test_monitor_lib.py`, `test_v4_api.py`, `TestTheWorkflowIsSafeAndReadOnly`, `test_telegram_diag_endpoint.py`, `test_ping.py`, `TestNormalizeResponseFormat`, `test_runtimes_health_endpoint.py`, `test_task_store_fails_loud_in_production.py`, `UsageEvent`, `get_ceo_dispatcher`, `test_voice_pipeline.py`, `client`, `clear_override`, `cost_tracker.py`, `test_doctor_coding_brain.py`?**
  _High betweenness centrality (0.106) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `brain_failover.py`, `TaskSpec`, `proxy.py`, `loop.py`, `ImprovementLoop`, `.run`, `AgentJobManager`, `test_ceo_dispatcher.py`, `ReactScratchpad`, `E2BAdapter`, `test_autonomous_agency_e2e.py`, `E2BSandboxSession`, `PolicyEngine`, `test_failover_client_shared.py`, `WorkflowRun`, `direct_chat.py`, `MultiAgentSwarm`, `AgentSessionStore`, `TestAgentRunnerExecution`, `test_empirical_verify.py`, `MCPClient`, `TokenBudget`, `resolve_active_brain`, `StuckDetector`, `test_daily_automation_2026_07_11.py`, `InternalAgentAdapter`, `Any`, `WorkspaceTools`, `TestAgentLoopMCPIntegration`, `CEODispatcher`, `test_backend_server_features.py`, `LocalWorkspace`, `test_agent_chat_integration.py`, `test_agent_tool_governance.py`, `TestAgentRunnerSafety`, `UserMemoryStore`, `get_ceo_dispatcher`, `ContextManager`, `FreeBuffAgent`, `GitHubTools`, `test_governance_api.py`, `AdaptiveHalter`, `ContextPruner`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `Task` connect `Task` to `backend/server.py`, `company_api.py`, `test_trend_scoping.py`, `test_issue_intake.py`, `test_phase6_workflow.py`, `TaskStatus`, `TaskStore`, `tasks/api.py`, `test_telegram_task_callback.py`, `tasks/models.py`, `test_task_source_id_race.py`, `test_tasks_awaiting_approval_api.py`, `seo_api.py`, `test_schedule_growth_invariants.py`, `test_phase4_runtime_resilience.py`, `test_task_self_repo_auto_commit.py`, `test_task_service_failed_comment.py`, `get_task_store`, `test_purge_backlog.py`, `workflow.py`, `BrainWatchdog`, `v4_api.py`, `test_task_brain_preflight.py`, `test_portfolio_intake.py`, `ensure_self_company`, `test_tasks_reconciler_todo_requeue.py`, `test_sam_livekit.py`, `TaskDispatcher`?**
