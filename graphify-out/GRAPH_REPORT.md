# Graph Report - local-llm-server  (2026-08-31)

## Corpus Check
- 1461 files · ~2,122,555 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 29738 nodes · 55122 edges · 1269 communities (1097 shown, 117 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 2698 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4afdf785`
...
Cohesion: 0.02
Nodes (103): MongoDBStore, Any, Company, ObjectId, Prepare a Pydantic model for SQLite storage., Prepare a SQLite row for Pydantic model., Create a new company in SQLite., Get a company by ID from SQLite. (+95 more)

### Community 3 - "LLMRequest"
Cohesion: 0.03
Nodes (137): ProviderConfig, One configured endpoint. ``kind`` selects the adapter: ``openai`` (any OpenAI-…, packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, LLMProvider, OpenAICompatible, ABC, Any, AsyncClient (+129 more)
...
Cohesion: 0.03
Nodes (101): agent/job_manager.py — Async agent job lifecycle manager. Manages agent jobs…, kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, runtimes/adapters/claude_code.py — Claude Code CLI adapter (FIRST CLASS).…, runtimes/adapters/docker_agent.py — Docker-based agent runtime adapter. Spawns…, E2BAdapter, Any (+93 more)

### Community 8 - "AgentRunner"
Cohesion: 0.03
Nodes (109): AgentPhaseError, AgentRunner, _check_extra_kwargs(), _enforce_signature(), _note_phase_end(), _note_phase_start(), Any, Exception (+101 more)
...
Cohesion: 0.03
Nodes (117): Call-time resolver for an agent role model id. Delegates to…, _resolve_role_model(), _active_primary_provider(), BrainConfig, BrainConfigPatch, BrainConfigStore, default_brain_config(), get_brain_config() (+109 more)

### Community 12 - "TaskStore"
Cohesion: 0.03
Nodes (97): Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., tasks — Task/issue management system. Provides a lightweight task/issue tracker…, Enum, str, tasks/models.py — Pydantic models for the task/issue system., Comment or reply on a task., TaskComment (+89 more)
...
Cohesion: 0.03
Nodes (84): Test hook — clear all usage accounting., reset(), CacheManager, cosine_similarity(), _Entry, get_cache(), LRUCache, payload_key() (+76 more)

### Community 15 - "ImprovementLoop"
Cohesion: 0.04
...
Cohesion: 0.03
Nodes (89): _load(), main(), int, FailoverResult, A successful completion plus the accounting its callers need., failover_chat_completion_via_router(), openai_body_from_response(), Any (+81 more)

### Community 17 - "test_ceo_micromanager.py"
Cohesion: 0.05
...
Cohesion: 0.03
Nodes (84): AgentPolicy, _apply_env_overrides(), _apply_key_env(), _build(), _coerce(), config_dir(), _env_key_names(), expand_env() (+76 more)

### Community 20 - "TaskWorkflowService"
Cohesion: 0.04
Nodes (72): Hand the 'connect & verify the repo' work to the agency's own agents. The task…, _seed_connect_task(), Task, Creates tasks from scheduler and playbook runs using one workflow., TaskAutomationService, ApprovalCheckpoint, Human approval gate in a task's execution., _gate_outward_facing_enabled() (+64 more)

### Community 21 - "PolicyEngine"
Cohesion: 0.04
Nodes (82): _egress_policy_reason(), agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Return why governance policy blocks *host*, or None. Runs strictly *after* the…, _action_matches(), _as_list(), Decision, GroupPolicy, _host_matches() (+74 more)

### Community 22 - "SelfHealingAgent"
Cohesion: 0.04
Nodes (68): FailureCategory, heal_signature(), HealingEvent, HealState, _now(), Any, Enum, str (+60 more)

### Community 23 - "test_user_research_skill.py"
Cohesion: 0.04
...
Cohesion: 0.03
Nodes (75): Backoff policy for retryable failures., RetryConfig, BreakerState, Enum, str, _digest(), get_ring(), KeyRing (+67 more)

### Community 26 - "Task"
Cohesion: 0.04
Nodes (69): Full task/issue document., Task, One-line human explanation of why this task needs human approval. Reads risk…, Best-effort label of who will run this task once approved. Returns…, PUBLIC_URL-anchored dashboard deep link for the task detail. Returns empty…, Best-effort Telegram heads-up that a task is parked awaiting approval. Inline…, asyncio, A reject + human Retry starts a NEW approval cycle → fresh notification. (+61 more)
...
### Community 28 - "Agency"
Cohesion: 0.04
Nodes (70): Agency, AgencyCycleResult, AgentDirective, AgentRole, _build_ceo_prompt(), _build_quick_note_instruction(), _close_github_issue(), _collect_recent_git_context() (+62 more)

### Community 29 - "resolve_active_brain"
Cohesion: 0.03
Nodes (90): BrainResolution, get_brain_config_store(), provider_api_key(), provider_key_present(), Return the process-wide ``BrainConfigStore`` singleton., Return the live API key for *provider* (env-only — never persisted)., True when the env var for *provider*'s key is set (or it's Ollama)., get_active_brain_sync() (+82 more)

### Community 30 - "ProviderRouter"
Cohesion: 0.04
Nodes (56): _get_director(), is_commercial_provider(), _normalized_provider_type(), provider_access_tier(), _provider_field(), provider_sort_key(), ProviderAttempt, ProviderConfig (+48 more)

### Community 31 - "AnthropicProvider"
Cohesion: 0.04
...
### Community 32 - "test_ceo_dispatcher.py"
Cohesion: 0.03
...
### Community 33 - "ExecutionRequest"
Cohesion: 0.04
Nodes (49): Execute work through the 11-phase golden path., Called by APScheduler when a cron fires. Dispatches to the orchestrator. This…, _scheduler_on_fire(), workflow_orchestrator_execute(), OrchestratorSupervisor, Any, Emit an alert to the activity feed and log., Deterministic supervisor for the orchestrator. Runs as a background coroutine.… (+41 more)
...
### Community 35 - "loop.py"
Cohesion: 0.04
Nodes (68): loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., Governance seam: judge the call, run it, audit the outcome. Deliberately a thin…, Condense a tool result down to what belongs in an audit row. A tool result can…, # NOTE: "ollama_base" is kept for backwards compatibility; this runner only…, Feed LLM token/cost spend into the governance session budget. Kept separate…, Charge sub-agent nesting depth and enforce the ``max_depth`` ceiling. Isolates…, _summarise_tool_result(), build_compaction_prompt() (+60 more)
...
### Community 37 - "activation_api.py"
Cohesion: 0.05
...
Cohesion: 0.06
Nodes (61): get_user_role(), Extract role from a user object (dict or Pydantic model)., UserRole, _can_read(), _can_write(), create_secret(), _decrypt(), delete_secret() (+53 more)

### Community 40 - "get_task_store"
Cohesion: 0.04
Nodes (84): quick_notes_submit(), _QuickNoteBody, Submit a quick-note URL or instruction from the dashboard FAB., Reset the singleton (for tests)., reset_failover_manager(), _blocked_retire_age_sec(), _heal_blocked_backlog(), _heal_brain_failover() (+76 more)
...
### Community 48 - "test_ceo_router.py"
Cohesion: 0.05
Nodes (58): build_ceo_router(), Any, APIRouter, Record the goal and its sub-tasks in the ledger before any work runs. Writing…, Attempt, _backend(), CEOLedger, get_ceo_ledger() (+50 more)
...
### Community 51 - "PrimeAgentAdapter"
Cohesion: 0.05
...
### Community 55 - "test_unit7_catalog_propagation.py"
Cohesion: 0.05
...
### Community 56 - "test_ceo_supervision.py"
Cohesion: 0.06
...
### Community 60 - "test_e2b_sandbox.py"
Cohesion: 0.05
...
### Community 65 - "services/background.py"
Cohesion: 0.05
Nodes (56): get_skill_registry_safe(), Return the global SkillRegistry if set, else None. Used by onboarding and other…, get_trend_watcher(), set_trend_watcher(), _await_hermes_ready(), BackgroundServices, _env_float(), _env_on() (+48 more)
...
### Community 67 - "test_webui_provider_priority.py"
Cohesion: 0.08
...
### Community 69 - "ensure_self_company"
Cohesion: 0.04
...
### Community 72 - "AgentDefinition"
Cohesion: 0.05
Nodes (39): AgentCreateRequest, AgentDefinition, AgentStore, AgentUpdateRequest, Any, BaseModel, field_validator, agents/store.py — Persistent store for user-defined agent configurations.… (+31 more)
...
### Community 75 - "brain_failover.py"
Cohesion: 0.05
...
Cohesion: 0.06
Nodes (60): build_seo_roadmap(), delegate_seo_findings(), _expire_stale_pending_report(), get_seo_audit(), list_seo_audits(), plan_seo_sprint(), BaseModel, get (+52 more)
...
### Community 97 - "test_brain_config_api.py"
Cohesion: 0.05
...
### Community 104 - "test_llm_router_tpm.py"
Cohesion: 0.06
...
### Community 108 - "CEOSupervisor"
Cohesion: 0.05
Nodes (41): get_ceo_dispatcher(), Return the shared CEODispatcher singleton., Reset the singleton (test helper)., reset_ceo_dispatcher(), CEOSupervisor, _env_flag(), _env_int(), get_ceo_supervisor() (+33 more)

### Community 109 - "skill_bindings.py"
Cohesion: 0.05
...
### Community 115 - "TestAdapterMetadata"
Cohesion: 0.05
...
### Community 120 - "test_governance_api.py"
Cohesion: 0.06
...
### Community 124 - "get_self_healing_agent"
Cohesion: 0.07
...
### Community 126 - "AgentSessionStore"
Cohesion: 0.07
...
### Community 128 - "TestHarnessAdapter"
Cohesion: 0.05
...
### Community 129 - "PatternConsolidation"
Cohesion: 0.06
...
### Community 133 - "InternalAgentAdapter"
Cohesion: 0.05
...
### Community 141 - "test_provider_router.py"
Cohesion: 0.06
...
### Community 143 - "test_phase4_runtime_resilience.py"
Cohesion: 0.06
...
### Community 149 - "timedelta"
Cohesion: 0.07
Nodes (45): create_access_token(), create_refresh_token(), google_callback(), Return True if a fetched oauth_states doc is a valid, unexpired login state., _valid_login_state(), create_access_token(), create_refresh_token(), get_current_user() (+37 more)

### Community 150 - "test_runtime_governance.py"
Cohesion: 0.10
Nodes (47): _blocked_result(), _governance_check(), Build the failed TaskResult returned when policy denies a dispatch. A result…, Evaluate a runtime dispatch against policy; audit it either way. Returns…, _decision(), _engine(), Any, RoutingDecision (+39 more)
...
### Community 153 - "portfolio_api.py"
Cohesion: 0.07
...
### Community 163 - "ContextWindowManager"
Cohesion: 0.08
...
### Community 164 - "workflow_orchestrator.py"
Cohesion: 0.09
...
### Community 169 - "WorkspaceManager"
Cohesion: 0.09
...
### Community 171 - "E2BSandboxSession"
Cohesion: 0.09
...
### Community 174 - "ProvidersScreen.jsx"
Cohesion: 0.05
...
### Community 186 - "test_render_mcp.py"
Cohesion: 0.07
...
### Community 187 - "test_slop_gate.py"
Cohesion: 0.07
...
### Community 191 - "configuration-reference.md"
Cohesion: 0.07
...
### Community 194 - "TestBrainFailoverModelUpdates"
Cohesion: 0.08
...
### Community 203 - "test_agent_free_brain.py"
Cohesion: 0.05
...
### Community 204 - "TestRecordUsageAndStats"
Cohesion: 0.05
...
### Community 205 - "test_process_quick_note_workflow.py"
Cohesion: 0.06
...
### Community 206 - "test_sam_livekit.py"
Cohesion: 0.06
...
### Community 209 - "emit_chat_observation"
Cohesion: 0.09
...
### Community 212 - "resolve_component_model"
Cohesion: 0.06
...
### Community 213 - "_build_default_manager"
Cohesion: 0.07
...
### Community 215 - "test_knowledge_sync.py"
Cohesion: 0.11
Nodes (34): _api_key(), _auth_headers(), _build_digest_markdown(), create_wiki_page(), get_knowledge_sync(), KnowledgeSync, _now_iso(), Any (+26 more)
...
### Community 220 - "compare_runtimes.py"
Cohesion: 0.07
...
### Community 221 - "test_portfolio_intake.py"
Cohesion: 0.09
...
### Community 231 - "get_failover_manager"
Cohesion: 0.07
...
### Community 232 - "test_daily_2026_06_04.py"
Cohesion: 0.08
...
### Community 235 - "test_brain_failover.py"
Cohesion: 0.09
...
### Community 244 - "test_implement_agent_routing.py"
Cohesion: 0.07
...
### Community 256 - "agent/workspace.py"
Cohesion: 0.11
...
### Community 260 - "TaskHarnessAdapter"
Cohesion: 0.07
Nodes (17): AiderAdapter, Any, TaskResult, TaskSpec, Run aider non-interactively via `--message` flag., Adapter for Aider — TIER 3 specialized git-aware code editor., Any, TaskResult (+9 more)

### Community 261 - "test_anthropic_router.py"
Cohesion: 0.09
...
### Community 266 - "report_to_markdown"
Cohesion: 0.11
...
### Community 273 - "ContextCompressor"
Cohesion: 0.11
...
### Community 276 - "ResourceWatchdog"
Cohesion: 0.10
...
### Community 297 - "LlmProviderConfig"
Cohesion: 0.16
...
### Community 298 - "TestNormalizeResponseFormat"
Cohesion: 0.08
...
### Community 299 - "Quick-Note GitHub Issues Processing - Session Summary"
Cohesion: 0.06
...
### Community 301 - "tests/conftest.py"
Cohesion: 0.08
...
### Community 302 - "session_retro.py"
Cohesion: 0.13
...
### Community 305 - "get_skill_bindings"
Cohesion: 0.11
...
### Community 306 - "output_filter.py"
Cohesion: 0.07
...
### Community 307 - "governance/audit.py"
Cohesion: 0.07
...
### Community 310 - "test_force_cleanup_conditional_delete.py"
Cohesion: 0.10
...
### Community 312 - "ProjectScaffolder"
Cohesion: 0.13
...
### Community 314 - "_resolve_user_github_token"
Cohesion: 0.12
...
### Community 315 - "get_scheduler"
Cohesion: 0.12
Nodes (27): legacy_scheduler_create(), legacy_scheduler_delete(), legacy_scheduler_get(), LegacyScheduleJobRequest, get_scheduler(), create_schedule(), delete_schedule(), get_schedule() (+19 more)

### Community 316 - "model_discovery.py"
Cohesion: 0.10
...
### Community 320 - "test_scheduler_hydration_bounded.py"
Cohesion: 0.09
...
### Community 321 - "OrchestratorQueue"
Cohesion: 0.08
...
### Community 322 - "test_internal_agent_did_work.py"
Cohesion: 0.12
...
### Community 325 - "Python Dependencies (`requirements.txt`)"
Cohesion: 0.07
...
### Community 326 - "Technical Debt Register — local-llm-server"
Cohesion: 0.07
...
### Community 327 - "test_dashboard_cache.py"
Cohesion: 0.11
Nodes (23): _cached(), cost_attribution_stats(), _fast_count(), get_active_provider(), get_stats(), legacy_scheduler_list(), _produce_scheduler_jobs(), _produce_stats() (+15 more)

### Community 328 - "FeatureEntry"
Cohesion: 0.08
...
### Community 329 - "SetupWizardPage.js"
Cohesion: 0.10
...
### Community 330 - "ProviderConsole.jsx"
Cohesion: 0.08
...
### Community 331 - "autonomous_fix.py"
Cohesion: 0.12
...
### Community 337 - "test_agent_scripts_share_one_model_list.py"
Cohesion: 0.10
...
### Community 338 - "test_crispy_burn_in.py"
Cohesion: 0.07
...
### Community 339 - "test_failover_silent_exhaustion.py"
Cohesion: 0.11
...
### Community 341 - "TestCrawl"
Cohesion: 0.07
Nodes (5): check_external_links=True HEAD-checks external targets (bounded)., Severity -> potential revenue loss via the portfolio mechanism (PR #534 review)., TestCrawl, TestDelegationPlan, TestRevenuePortfolio
...
### Community 345 - "Deploy: FreeBuff Telegram bot (24×7)"
Cohesion: 0.07
...
### Community 346 - "Claude Code + Qwen Local Setup"
Cohesion: 0.07
...
### Community 347 - "get_feature_matrix"
Cohesion: 0.11
...
### Community 348 - "traffic_director.py"
Cohesion: 0.11
...
### Community 352 - "pr_approval_gate.py"
Cohesion: 0.15
Nodes (26): _card_keyboard(), _card_text(), _dedupe_key(), default_run_sweep(), gate_enabled(), _gh_get(), _gh_token(), interval_sec() (+18 more)
...
### Community 359 - "Performance Analysis — local-llm-server"
Cohesion: 0.08
...
### Community 360 - "LLM Router — troubleshooting"
Cohesion: 0.08
...
### Community 361 - "test_phase5_doctor.py"
Cohesion: 0.08
...
### Community 362 - "control_overrides.py"
Cohesion: 0.11
...
### Community 365 - "test_telegram_approval_e2e.py"
Cohesion: 0.12
...
### Community 367 - "test_telegram_mutating_commands.py"
Cohesion: 0.08
...
### Community 375 - "generate_context.py"
Cohesion: 0.13
...
### Community 376 - "implement_agent.py"
Cohesion: 0.12
...
### Community 379 - "test_north_mini_code.py"
Cohesion: 0.08
...
### Community 382 - "TemporalContextGraph"
Cohesion: 0.10
...
### Community 386 - "test_phase6_workflow.py"
Cohesion: 0.16
...
### Community 389 - "sam_livekit_worker.py"
Cohesion: 0.13
...
### Community 392 - "TestStreamableHTTPTransport"
Cohesion: 0.13
...
### Community 394 - "Local AI Stack with Docker"
Cohesion: 0.08
...
### Community 395 - "Implementation Prompt: Rich TaskBoard + Agile Sprint Integration"
Cohesion: 0.08
...
### Community 396 - "Telegram Bot Setup"
Cohesion: 0.08
...
### Community 397 - "video_transcript.py"
Cohesion: 0.12
...
### Community 399 - "seo_report_pdf.py"
Cohesion: 0.24
...
### Community 400 - "Native operations"
Cohesion: 0.09
...
### Community 401 - "test_memory_guard.py"
Cohesion: 0.13
...
### Community 402 - "test_freebuff_bot.py"
Cohesion: 0.11
Nodes (19): _embedded(), _embedded_run(), _fb_plan(), _fb_run(), _freebuff_max_steps(), Generate a read-only plan (embedded or via proxy). Shape: {model, plan}., Execute a FreeBuff task (embedded or via proxy). Shape: {result: {...}}., Run FreeBuffAgent in-process against a fresh clone, committing + opening a PR.… (+11 more)

### Community 403 - "test_regression.py"
Cohesion: 0.12
...
### Community 404 - "test_agency_fix.py"
Cohesion: 0.08
...
### Community 408 - "_status_snapshot"
Cohesion: 0.15
...
### Community 409 - "platform_controls_router.py"
Cohesion: 0.11
...
### Community 410 - "Agent Governance Guide"
Cohesion: 0.09
...
### Community 411 - "The fifteen strategies"
Cohesion: 0.09
...
### Community 418 - "reap_expired_companies"
Cohesion: 0.14
...
### Community 420 - "SyntheticDataPipeline"
Cohesion: 0.13
...
### Community 422 - "test_cerebras_catalogue.py"
Cohesion: 0.13
...
### Community 423 - "test_monitor_lib.py"
Cohesion: 0.11
...
### Community 428 - "HarnessEnrichment"
Cohesion: 0.14
...
### Community 429 - "classify_direct_chat_intent"
Cohesion: 0.13
...
### Community 431 - "AdaptivePermissions"
Cohesion: 0.18
...
### Community 438 - "_process_task_callback"
Cohesion: 0.17
...
### Community 444 - "test_chat_mode_regressions.py"
Cohesion: 0.18
...
### Community 450 - "weekly_digest.py"
Cohesion: 0.13
...
### Community 451 - "test_local_controller.py"
Cohesion: 0.17
...
### Community 452 - "test_pr_approval_gate.py"
Cohesion: 0.14
...
### Community 464 - "Docker AI Governance Audit — Final Report"
Cohesion: 0.10
...
### Community 465 - "1. Capability-by-capability"
Cohesion: 0.10
...
### Community 467 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 474 - "DecisionsStoreTests"
Cohesion: 0.11
...
### Community 476 - "PriorityTaskQueue"
Cohesion: 0.15
...
### Community 479 - "test_langfuse_agency_wide.py"
Cohesion: 0.10
...
### Community 480 - "test_tasks_cache_ttl_env.py"
Cohesion: 0.21
...
### Community 481 - "test_voice_pipeline.py"
Cohesion: 0.14
...
### Community 484 - "test_loop_registry.py"
Cohesion: 0.21
...
### Community 492 - "_ensure_tasks_source_id_unique_index"
Cohesion: 0.16
...
### Community 498 - "test_feature_matrix.py"
Cohesion: 0.12
...
### Community 504 - "test_task_source_id_race.py"
Cohesion: 0.17
...
### Community 509 - "validate_session_id"
Cohesion: 0.16
...
### Community 510 - "ErrorInterceptorMiddleware"
Cohesion: 0.18
...
Cohesion: 0.17
Nodes (12): fetch_and_store(), Ingest a URL into the Sources database so it becomes RAG-searchable. Returns…, _FakeClient, _FakeResp, asyncio, test_create_wiki_page_409_returns_skipped(), test_create_wiki_page_success(), test_fetch_and_store_network_error() (+4 more)

### Community 512 - "safe_agency.py"
Cohesion: 0.18
...
### Community 519 - "test_minimax_bug_fixes.py"
Cohesion: 0.13
...
### Community 522 - "Platform Guide — the full tour"
Cohesion: 0.11
...
### Community 524 - "Part A — Health Report"
Cohesion: 0.11
...
### Community 528 - "sync_readme_gallery.py"
Cohesion: 0.22
...
### Community 529 - "test_p0_roadmap_b3_b4_b5.py"
Cohesion: 0.16
...
### Community 532 - "test_company_api.py"
Cohesion: 0.11
...
### Community 533 - "TestStopSlopChecker"
Cohesion: 0.11
...
### Community 535 - "test_contract_enforcement.py"
Cohesion: 0.17
...
### Community 544 - "_check_storage_health"
Cohesion: 0.12
...
### Community 546 - "Section-by-Section Acceptance Criteria"
Cohesion: 0.12
...
### Community 548 - "SkillsScreen.jsx"
Cohesion: 0.12
...
### Community 551 - "RuntimeHealthService"
Cohesion: 0.17
...
### Community 552 - "agent_readiness_audit.py"
Cohesion: 0.21
...
### Community 555 - "test_activation_api.py"
Cohesion: 0.21
...
### Community 556 - "TestAListingFailureDoesNotVetoTheAnswer"
Cohesion: 0.17
...
### Community 557 - "test_daily_automation_2026_07_11.py"
Cohesion: 0.15
...
### Community 558 - "test_frontend_deployment_guards.py"
Cohesion: 0.18
...
### Community 559 - "test_health_endpoints.py"
Cohesion: 0.17
...
### Community 560 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 561 - "test_openclaw_endpoints.py"
Cohesion: 0.12
...
### Community 562 - "test_orchestrator_merge_decision.py"
Cohesion: 0.24
...
### Community 564 - "test_skill_registry.py"
Cohesion: 0.13
...
### Community 565 - "hermes_prompt.py"
Cohesion: 0.19
...
### Community 567 - "MemoryMiddleware"
Cohesion: 0.17
...
### Community 569 - "Skill: repowise-intelligence"
Cohesion: 0.12
...
### Community 570 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
...
### Community 571 - "Skill: repowise-intelligence"
Cohesion: 0.12
Nodes (15): 1. Graph Intelligence (Dependency Graph), 2. Git Intelligence, 3. Documentation Intelligence, 4. Decision Intelligence, Acceptance Checks, Directory Structure, Example Usage, Implementation Approach (+7 more)

### Community 572 - "The 10-Step Workflow"
Cohesion: 0.12
...
### Community 573 - "Contributing to local-llm-server"
Cohesion: 0.12
...
### Community 574 - "refresh_agent_built_proof.py"
Cohesion: 0.20
...
### Community 575 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 576 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 577 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
...
### Community 586 - "ManagedAgentDreams"
Cohesion: 0.22
...
### Community 591 - "DailyDigestAggregatorTests"
Cohesion: 0.19
...
### Community 592 - "test_dockerfile_ships_root_modules.py"
Cohesion: 0.17
...
### Community 596 - "test_nvidia_default_model.py"
Cohesion: 0.17
...
### Community 603 - "CollaborationContext"
Cohesion: 0.17
...
### Community 604 - "Skill: agent-harness"
Cohesion: 0.13
...
### Community 605 - "Skill: checkpoint-strategy"
Cohesion: 0.13
...
### Community 607 - "Skill: local-ai-query"
Cohesion: 0.13
...
### Community 608 - "Skill: parallel-agents"
Cohesion: 0.13
...
### Community 609 - "Skill: parallel-worktrees"
Cohesion: 0.13
...
### Community 610 - "Design System: Taste Standard"
Cohesion: 0.13
...
### Community 612 - "Skill: user-research"
Cohesion: 0.13
...
### Community 613 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 614 - "Attention Mechanisms Internals"
Cohesion: 0.13
...
### Community 619 - "TestDecisionsBotLinks"
Cohesion: 0.17
...
### Community 623 - "e2e/test_browser.py"
Cohesion: 0.23
...
### Community 624 - "test_dockerfile_ships_config_dir.py"
Cohesion: 0.14
...
### Community 626 - "test_scanner_live.py"
Cohesion: 0.23
...
### Community 628 - "test_ai_insights.py"
Cohesion: 0.20
...
### Community 631 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 635 - "Checks Performed"
Cohesion: 0.14
...
### Community 636 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 637 - "admin_digest_router.py"
Cohesion: 0.22
...
### Community 638 - "Skill: branch-cleanup"
Cohesion: 0.14
...
### Community 639 - "Skill: perplexity — Web Research via Perplexity API"
Cohesion: 0.14
...
### Community 642 - "Nothing is blocked on an agent. Two things need a human."
Cohesion: 0.14
...
### Community 643 - "Quick-Note Issues Processing Summary"
Cohesion: 0.14
...
### Community 645 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 647 - "Render MCP — autonomous platform debugging and environment monitoring"
Cohesion: 0.14
...
### Community 648 - "Runbook: Auto-Resume After Cooldown / Interruption"
Cohesion: 0.14
...
### Community 649 - "SEO / GEO / AIO Audit Engine"
Cohesion: 0.14
...
### Community 650 - "Traffic Distribution Across Providers"
Cohesion: 0.14
...
### Community 654 - "extract_failures"
Cohesion: 0.21
...
### Community 656 - "_resolve_push_token"
Cohesion: 0.20
...
### Community 659 - "TestAnthropicToolListCaching"
Cohesion: 0.34
...
### Community 660 - "test_autonomy_pipeline_regressions.py"
Cohesion: 0.15
...
### Community 661 - "TestMCPToolsListCache"
Cohesion: 0.19
...
### Community 664 - "test_openclaw_gateway.py"
Cohesion: 0.14
...
### Community 665 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 666 - "test_tasks_awaiting_approval_api.py"
Cohesion: 0.37
...
### Community 683 - "admin_update_task_router.py"
Cohesion: 0.22
...
### Community 684 - "get_orchestrator_queue"
Cohesion: 0.21
Nodes (10): Return orchestrator queue depth, active runs, and supervisor state (#522)., #522 + #505: Reliability startup — schedule hydration, orchestrator restore,…, _startup_reliability_hooks(), workflow_orchestrator_status(), get_orchestrator_queue(), services/orchestrator_queue.py — Async FIFO run queue with concurrency…, start_orchestrator_queue(), get_orchestrator_supervisor() (+2 more)

### Community 685 - "ProviderManager"
Cohesion: 0.17
...
### Community 688 - "Skill: platform-setup — Autonomous Agency Bootstrap"
Cohesion: 0.15
...
### Community 689 - "Device compatibility and model picks"
Cohesion: 0.15
...
### Community 690 - "Autonomy Uplift — Living Roadmap & Detailed Implementation Specs"
Cohesion: 0.15
...
### Community 691 - "OpenClaw — iOS Control of the Agency (Single-Service Free-Tier Deploy)"
Cohesion: 0.15
...
### Community 694 - "ApplyReviewAgent"
Cohesion: 0.22
...
### Community 696 - "_is_bedrock_model_id"
Cohesion: 0.27
...
### Community 698 - "Agent Transparency Report"
Cohesion: 0.15
...
### Community 699 - "update_provider_policy"
Cohesion: 0.19
...
### Community 701 - "_InMemoryBackend"
Cohesion: 0.18
...
### Community 703 - "TestModelCostTableUpdates"
Cohesion: 0.26
...
### Community 704 - "TestMCPClientStructuredOutput"
Cohesion: 0.31
...
### Community 705 - "test_deploy_trigger_covers_image.py"
Cohesion: 0.21
...
### Community 706 - "test_doctor_service_token_check.py"
Cohesion: 0.23
...
### Community 707 - "TestTheGatewayRegistryOffersOnlyLiveModels"
Cohesion: 0.22
...
### Community 709 - "TestKillSwitchDurability"
Cohesion: 0.15
...
### Community 710 - "test_quick_note_engine.py"
Cohesion: 0.17
...
### Community 711 - "TestRouterIntegration"
Cohesion: 0.31
...
### Community 713 - "WorkspaceManifest"
Cohesion: 0.17
...
### Community 714 - "skill_registry.py"
Cohesion: 0.17
...
### Community 721 - "Skill: system-prompt-audit"
Cohesion: 0.17
...
### Community 722 - "Skill: task-alive-updates"
Cohesion: 0.17
...
### Community 725 - "_is_ephemeral_user"
Cohesion: 0.27
...
### Community 726 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 729 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 731 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 732 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 733 - "Workspace Isolation Architecture"
Cohesion: 0.17
...
### Community 734 - "Quantization Internals"
Cohesion: 0.17
...
### Community 735 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 736 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 737 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 741 - "check_container_posture.py"
Cohesion: 0.26
...
### Community 742 - "test_pytest_failure_parser.py"
Cohesion: 0.23
...
### Community 743 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 744 - "test_admin_local_brain_router.py"
Cohesion: 0.29
...
### Community 745 - "test_agile_api.py"
Cohesion: 0.17
...
### Community 746 - "test_app_settings.py"
Cohesion: 0.21
...
### Community 747 - "test_brain_default_consistency.py"
Cohesion: 0.24
...
### Community 748 - "TestAnthropicWorkspaceIdCapture"
Cohesion: 0.33
...
### Community 750 - "TestAnthropicPayloadStructuredOutput"
Cohesion: 0.29
...
### Community 751 - "test_task_clarification.py"
Cohesion: 0.17
...
### Community 770 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 771 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 772 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 773 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 774 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 775 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 776 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 778 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 779 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 780 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 781 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 782 - "What to clean up"
Cohesion: 0.18
...
### Community 783 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 790 - "flesch_reading_ease"
Cohesion: 0.22
...
### Community 793 - "TestBackgroundAgentDispatch"
Cohesion: 0.24
...
### Community 794 - "TestAgentRunnerSafety"
Cohesion: 0.24
...
### Community 798 - "TestNoNvidiaFallbackIsRetired"
Cohesion: 0.22
...
### Community 802 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 803 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 804 - "admin_local_brain_router.py"
Cohesion: 0.22
...
### Community 805 - "_normalize_tool_choice"
Cohesion: 0.31
...
### Community 806 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 807 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 808 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 809 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 810 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 811 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 812 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 813 - "Agent Readiness Report"
Cohesion: 0.20
...
### Community 815 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 826 - "TestPoliciesGovernanceStableClaim"
Cohesion: 0.20
...
### Community 827 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 834 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 836 - "WorkspaceEscapeError"
Cohesion: 0.22
...
### Community 837 - "Skill: changelog-enforcer"
Cohesion: 0.22
...
### Community 838 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 840 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 841 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 842 - "Skill: changelog-enforcer"
Cohesion: 0.22
Nodes (8): Acceptance Checks, Changelog Location, Entry Format, Examples, Hook Behaviour, Instructions, Skill: changelog-enforcer, When to Use

### Community 843 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
Nodes (8): Branch, Components, Purpose, Quick Start, Session Roles, Skill: cowork-session (Claude Cowork), Testing, When to Use

### Community 844 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 845 - "Active Task Tracker"
Cohesion: 0.22
...
### Community 847 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 848 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 849 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 850 - "Issue #1356: quick-note:https://searchengineland.com/turn-seo-backlog-into-roadmap-485713"
Cohesion: 0.22
...
### Community 852 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 853 - "Platform Controls"
Cohesion: 0.22
...
### Community 854 - "Release Procedure"
Cohesion: 0.22
...
### Community 855 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 857 - "frontend/package.json"
Cohesion: 0.22
...
### Community 859 - "_get_current_user"
Cohesion: 0.25
...
### Community 864 - "enrich_quick_note_issues.py"
Cohesion: 0.42
...
### Community 865 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 867 - "test_changelog_parity_guard.py"
Cohesion: 0.22
...
### Community 869 - "TestPolicyAuthoringUiStableClaim"
Cohesion: 0.22
...
### Community 870 - "TestPaidPolicyDurability"
Cohesion: 0.22
...
### Community 871 - "test_scanner_deps_parity.py"
Cohesion: 0.31
...
### Community 876 - "agent/output_filter.py"
Cohesion: 0.32
...
### Community 880 - "quality_checker.py"
Cohesion: 0.32
...
### Community 882 - "_brain_provider_status"
Cohesion: 0.25
...
### Community 893 - "AGENTS.md — AI Agent Configuration for local-llm-server"
Cohesion: 0.25
...
### Community 894 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 895 - "ceo-micromanagement.md"
Cohesion: 0.25
Nodes (4): P0 behavior change, Readiness contract, Runtime model, Runtime types

### Community 896 - "Feature Maturity / Support Matrix"
Cohesion: 0.25
...
### Community 899 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.25
...
### Community 900 - "Issue #362: Nvidia repo setup"
Cohesion: 0.25
...
### Community 901 - "Issue #364: quick-note:https://www.marktechpost.com/2026/06/01/meet-memory-os-a-6-layer-open-source-memory-stack-built-on-top-of-hermes-agent/"
Cohesion: 0.25
...
### Community 902 - "Issue #378: quick-note:https://www.marktechpost.com/2026/06/02/tinyfish-launches-bigset-an-open-source-multi-agent-system-that-builds-structured-live-datasets-from-plain-english-descriptions/"
Cohesion: 0.25
...
### Community 903 - "Issue #379: quick-note:https://searchengineland.com/schema-markup-optimize-agentic-web-479080"
Cohesion: 0.25
...
### Community 904 - "Issue #380: quick-note:https://cursor.com/blog/cloud-agent-lessons"
Cohesion: 0.25
...
### Community 905 - "Issue #381: quick-note:https://www.xda-developers.com/claude-code-with-opus-48-is-expensive-but-i-made-it-efficient-with-my-local-ai-workflow/"
Cohesion: 0.25
...
### Community 906 - "Issue #382: quick-note:https://claude.com/blog/how-coderabbit-used-claude-to-build-an-agent-orchestration-system"
Cohesion: 0.25
...
### Community 907 - "Issue #383: quick-note:https://www.marktechpost.com/2026/05/29/hexo-labs-open-sources-sia-a-self-improving-agent-that-updates-both-the-harness-and-the-model-weights/"
Cohesion: 0.25
...
### Community 908 - "Issue #416: feat: Self-hosted Codebuff (freebuff) on free NVIDIA models + Telegram bot phone control"
Cohesion: 0.25
...
### Community 909 - "Issue #485: [Trend Digest] Week of 2026-06-08"
Cohesion: 0.25
...
### Community 910 - "Issue #488: quick-note:https://github.com/cookiy-ai/user-research-skill"
Cohesion: 0.25
...
### Community 911 - "Issue #491: Implement whatever is necessary from https://github.com/BehiSecc/awesome-claude-skills"
Cohesion: 0.25
...
### Community 912 - "Issue #493: Use the https://github.com/mvanhorn/last30days-skill skill to get the trend updated"
Cohesion: 0.25
...
### Community 913 - "Issue #495: Read https://www.anthropic.com/news/claude-fable-5-mythos-5 and understand if mythos or fable can be added to the repo"
Cohesion: 0.25
...
### Community 914 - "Issue #504: EPIC: Autonomy hardening — live-verified defects 2026-06-10"
Cohesion: 0.25
...
### Community 915 - "Issue #581: Sprint tracker: pending work after brand rename + mobile-first pass"
Cohesion: 0.25
...
### Community 917 - "Issue #657: quick-note:https://github.com/earendil-works/pi"
Cohesion: 0.25
...
### Community 918 - "Issue #659: quick-note:https://github.com/nex-agi/Nex-N2"
Cohesion: 0.25
...
### Community 919 - "Issue #660: quick-note:https://github.com/getsentry/sentry-for-ai"
Cohesion: 0.25
...
### Community 920 - "Issue #661: quick-note:https://github.com/XiaomiMiMo/MiMo-Code"
Cohesion: 0.25
...
### Community 921 - "Issue #664: quick-note:https://github.com/Grominet95/jarvis-OS"
Cohesion: 0.25
...
### Community 922 - "Issue #666: quick-note:https://github.com/porokka/jarvis-os"
Cohesion: 0.25
...
### Community 923 - "Issue #670: quick-note:https://github.com/perplexityai/bumblebee"
Cohesion: 0.25
...
### Community 924 - "Issue #672: quick-note:https://github.com/Chachamaru127/claude-code-harness"
Cohesion: 0.25
...
### Community 925 - "Issue #676: quick-note:https://github.com/WeiboAI/VibeThinker"
Cohesion: 0.25
...
### Community 926 - "Issue #820: quick-note:https://github.com/cobusgreyling/loop-engineering"
Cohesion: 0.25
...
### Community 927 - "Positional Encoding Internals"
Cohesion: 0.25
...
### Community 929 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 930 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 931 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 932 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 933 - "Continual Harness (`agent/harness_spec.py`)"
Cohesion: 0.25
...
### Community 934 - "Prime Agent Runtime"
Cohesion: 0.25
...
### Community 941 - "run_patched_colibri.py"
Cohesion: 0.36
...
### Community 950 - "test_runtimes_health_endpoint.py"
Cohesion: 0.25
...
### Community 952 - "test_serve_spa_prefixes.py"
Cohesion: 0.36
...
### Community 953 - "test_server_autonomy_and_index_fixes.py"
Cohesion: 0.29
...
### Community 954 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.25
...
### Community 956 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 965 - "_load_local_metrics_since"
Cohesion: 0.43
...
### Community 969 - "Changelog"
Cohesion: 0.29
Nodes (7): Added, Changed, Changelog, Fixed, Maintenance, Removed, Security

### Community 970 - "AI Engineering Insights Skill"
Cohesion: 0.29
...
### Community 983 - "Changelog"
Cohesion: 0.29
Nodes (7): Added, Changed, Changelog, Fixed, Maintenance, Removed, Security

### Community 984 - "claude-mem Plugin — Persistent Memory for All Sessions"
Cohesion: 0.29
...
### Community 985 - "Implementation plan + TO-DO (check off as you go)"
Cohesion: 0.29
...
### Community 997 - "e2e_smoke.py"
Cohesion: 0.57
Nodes (5): _chat(), check(), _health(), _models(), _req()

### Community 998 - "task_runner.py"
Cohesion: 0.33
...
### Community 1002 - "test_daily_2026_06_14.py"
Cohesion: 0.38
...
### Community 1003 - "TestSupportMatrixDocsSync"
Cohesion: 0.29
...
### Community 1005 - "TestGithubTokenSQLiteRegression"
Cohesion: 0.38
...
### Community 1006 - "TestReasonsAreActionable"
Cohesion: 0.29
...
### Community 1007 - "TestProvidersScreen"
Cohesion: 0.43
...
### Community 1027 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 1028 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 1029 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 1030 - "The full agent capability roster"
Cohesion: 0.33
...
### Community 1031 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 1032 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 1033 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 1034 - "StatusPill.jsx"
Cohesion: 0.47
Nodes (5): C, STATUS_META, StatusPill(), TONE_BG(), TONE_BORDER()

### Community 1035 - "provider_api_keys"
Cohesion: 0.33
...
### Community 1036 - "resolve_hermes_base_url"
Cohesion: 0.47
...
### Community 1038 - "apply_phase1_changes.py"
Cohesion: 0.33
...
### Community 1050 - "TestWorkflowIntegration"
Cohesion: 0.33
...
### Community 1051 - "test_catalogue_probe.py"
Cohesion: 0.33
...
### Community 1053 - "_normalize_dockerfile"
Cohesion: 0.33
...
### Community 1070 - "Who is this for?"
Cohesion: 0.40
...
### Community 1071 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 1072 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 1089 - "setup_colibri.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1090 - "setup_colibri.sh script"
Cohesion: 0.70
Nodes (4): setup_colibri.sh script, fail(), ok(), warn()

### Community 1091 - "status_colibri_server.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()
...
### Community 1096 - "test_agent_runtime_wrapper.py"
Cohesion: 0.70
...
### Community 1097 - "TestNoKeyEverReachesTheLog"
Cohesion: 0.40
...
### Community 1098 - "TestTheProbeIdentifiesItself"
Cohesion: 0.40
...
### Community 1100 - "TestModelRoleSeparation"
Cohesion: 0.40
...
### Community 1101 - "worker/index.js"
Cohesion: 0.60
Nodes (4): fetch(), needsProxy(), PROXY_PREFIXES, scheduled()

### Community 1104 - "verify_pr_exists"
Cohesion: 0.50
...
### Community 1120 - "_clean_director"
Cohesion: 0.50
...
### Community 1134 - "test_skills_route_order.py"
Cohesion: 0.67
...
- **3452 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3447 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 13117 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **117 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `_fixture()` connect `_fixture` to `WebsiteScanner`, `TaskSpec`, `test_llm_router_strategies.py`, `brain_config.py`, `TaskStore`, `test_operational_incidents.py`, `test_llm_router_queue_cache.py`, `ImprovementLoop`, `llm/router.py`, `config.py`, `test_company_api.py`, `PolicyEngine`, `SelfHealingAgent`, `TaskWorkflowService`, `test_llm_router_resilience.py`, `Task`, `test_catalogue_probe.py`, `Agency`, `resolve_active_brain`, `NotificationDispatcher`, `cost_tracker.py`, `ExecutionRequest`, `get_user_role`, `get_task_store`, `test_unit8_model_catalog.py`, `test_failover_client_shared.py`, `test_model_router.py`, `services/seo_audit.py`, `test_ceo_router.py`, `AgentJobManager`, `settings.py`, `test_openclaw_endpoints.py`, `test_orchestrator_merge_decision.py`, `PrimeAgentAdapter`, `test_unit7_catalog_propagation.py`, `ChatHistoryStore`, `test_e2b_sandbox.py`, `test_webui_provider_priority.py`, `SQLiteStore`, `TokenBudget`, `AgentDefinition`, `brain_failover.py`, `test_autonomy_status.py`, `test_brain_failover_413.py`, `ResearchTask`, `_resolve_brain_provider`, `Artifact`, `TestClient`, `test_local_brain_state.py`, `resolve_e2b_config`, `test_procedural_memory.py`, `SeoFixer`, `test_refresh_agent_built_proof.py`, `test_telegram_diag_endpoint.py`, `test_startup_warmup.py`, `_clear_cache`, `test_agent_tool_governance.py`, `_clean_director`, `test_colibri_brain_shim.py`, `KeyStore`, `test_llm_router_tpm.py`, `model_router.py`, `CEOSupervisor`, `test_telegram_auto_approve.py`, `e2e/test_browser.py`, `clear_cooldowns`, `ScheduledJob`, `AgentPlan`, `get_self_healing_agent`, `TestHarnessAdapter`, `test_context_rulebook.py`, `KeyPool`, `ArtifactStore`, `run_task`, `test_provider_router.py`, `test_kimi_bridge_server.py`, `_resolve_push_token`, `_step`, `test_openclaw_gateway.py`, `test_telegram_freebuff.py`, `claim`, `MCPClient`, `persist_plan_spec`, `TestEstimateTokensForMessages`, `AgentSwarm`, `test_new_features_e2e.py`, `test_daily_2026_07_27.py`, `test_e2b_task_wiring.py`, `OllamaCircuitBreaker`, `_job_text`, `_Budget`, `test_doctor_service_token_check.py`, `test_features_api.py`, `test_provider_state_durability.py`, `test_video_transcript.py`, `TrendWatcher`, `test_agent_free_brain.py`, `test_process_quick_note_workflow.py`, `test_sam_livekit.py`, `apply_review.py`, `test_knowledge_sync.py`, `test_portfolio_intake.py`, `test_e2b_data_flow.py`, `test_trend_watcher.py`, `TestClient`, `BackgroundAgent`, `test_agile_api.py`, `test_app_settings.py`, `test_brain_failover.py`, `ContextPruner`, `test_task_clarification.py`, `BrainWatchdog`, `test_control_plane_api.py`, `WorkflowBuildRequest`, `test_implement_agent_routing.py`, `test_sam_voice.py`, `test_persistent_memory.py`, `SecurityScanner`, `test_llm_router_e2e.py`, `OutputFilter`, `test_platform_controls.py`, `test_rate_limiter.py`, `test_mcp_governance.py`, `test_nvidia_model_discovery.py`, `TestNormalizeResponseFormat`, `tests/conftest.py`, `session_retro.py`, `test_purge_backlog.py`, `get_skill_bindings`, `analyze_page`, `_resolve_user_github_token`, `TestMongoGate`, `test_scheduler_hydration_bounded.py`, `OrchestratorQueue`, `test_dashboard_cache.py`, `test_agent_scripts_share_one_model_list.py`, `test_crispy_burn_in.py`, `test_provider_enable_disable.py`, `test_skill_registry_boot_refresh.py`, `get_feature_matrix`, `isolated_telegram_config`, `test_phase5_doctor.py`, `_undeclared`, `test_claude_code_adapter.py`, `_get`, `test_service_token.py`, `test_harness_spec.py`, `test_freebuff_bot.py`, `test_regression.py`, `test_agency_fix.py`, `platform_controls_router.py`, `api_keys_for`, `reap_expired_companies`, `OrchestratorCheckpointStore`, `test_monitor_lib.py`, `test_v4_api.py`, `test_ping.py`, `test_runtimes_health_endpoint.py`, `test_task_store_fails_loud_in_production.py`, `UsageEvent`, `test_langfuse_agency_wide.py`, `test_voice_pipeline.py`, `client`, `TestTheWorkflowIsSafeAndReadOnly`, `test_brain_patch_service_token.py`?**
  _High betweenness centrality (0.083) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `proxy.py`, `InternalAgentAdapter`, `FreeBuffAgent`, `TaskSpec`, `_resolve_push_token`, `ContextManager`, `ReactScratchpad`, `PolicyEngine`, `TestAgentRunnerExecution`, `TestAgentRunnerSafety`, `test_empirical_verify.py`, `Agency`, `MCPClient`, `loop.py`, `workflow_orchestrator.py`, `MultiAgentSwarm`, `StuckDetector`, `test_failover_client_shared.py`, `LocalWorkspace`, `E2BSandboxSession`, `WorkflowRun`, `test_daily_automation_2026_07_11.py`, `AgentJobManager`, `UserMemoryStore`, `WorkspaceTools`, `call_llm`, `TokenBudget`, `test_agent_free_brain.py`, `test_brain_failover_413.py`, `test_agent_tool_governance.py`, `direct_chat.py`, `CEODispatcher`, `AdaptiveHalter`, `ContextPruner`, `GitHubTools`, `diagnostics.py`, `test_governance_api.py`, `AgentPlan`, `AgentSessionStore`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderRouter` to `backend/server.py`, `test_anthropic_router.py`, `test_provider_router.py`, `test_bedrock_live.py`, `model_discovery.py`, `ai/router.py`, `call_llm`, `TestRouterIntegration`, `failover_client.py`, `TrafficDirector`, `test_bedrock_provider.py`, `NvidiaProvider`, `TestOpenAiToBedrockConverse`, `test_colibri_brain_shim.py`, `direct_chat.py`, `TestAnthropicPayloadStructuredOutput`, `clear_cooldowns`, `test_implement_agent_routing.py`, `implement_agent.py`, `Provider`, `test_all_providers_discovery.py`?**
