...
## Corpus Check
- 1511 files · ~2,191,415 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 54 file(s) not represented in the graph (top: (none) 16, .bat 5, .css 5)

## Summary
- 30686 nodes · 57271 edges · 1321 communities (1149 shown, 124 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 3346 edges (avg confidence: 0.92)
...
## Communities (1321 total, 124 thin omitted)

### Community 0 - "HTTPException"
Cohesion: 0.04
Nodes (116): admin_seed(), clear_cost_attribution(), clear_response_cache(), create_access_token(), create_api_key(), create_github_pr(), create_provider(), create_wiki_page() (+108 more)
...
Cohesion: 0.03
Nodes (45): BusinessCategory, Find a website by its URL., A company website with detected systems and stack inference., Website, requires_db, CompanyGraphService, Company, SpecialistFamily (+37 more)

### Community 8 - "test_llm_router_queue_cache.py"
Cohesion: 0.02
Nodes (102): cosine_similarity(), payload_key(), Exact-match cache key over the fields that change the answer. Routing…, Cosine similarity between two vectors, 0.0 when either is degenerate., chunk_document(), ContextManager, estimate_tokens(), FitResult (+94 more)

### Community 9 - "E2BSandboxSession"
Cohesion: 0.06
Nodes (64): MCPUnavailableError, Raised when the MCP server is unreachable or the circuit is open., E2BSandboxSession, _inject_token(), maybe_attach_e2b(), Any, Create the sandbox. Raises :class:`MCPUnavailableError` on failure., Kill the sandbox. Idempotent; never raises (best-effort cleanup). (+56 more)

### Community 10 - "AgentJobManager"
Cohesion: 0.05
Nodes (35): AgentJob, AgentJobManager, make_isolated_workspace(), _now(), Any, Path, agent/job_manager.py — Async agent job lifecycle manager. Manages agent jobs…, Run a job using the provided runner and update the job's lifecycle, progress,… (+27 more)
...
### Community 13 - "Task"
Cohesion: 0.03
Nodes (92): Background dispatcher for task execution., tasks — Task/issue management system. Provides a lightweight task/issue tracker…, Full task/issue document., Task, TaskPriority, _gate_outward_facing_enabled(), _is_brain_connection_error(), _is_outward_facing() (+84 more)
...
### Community 18 - "test_render_mcp.py"
Cohesion: 0.07
...
### Community 24 - "SeoAuditEngine"
Cohesion: 0.05
Nodes (49): export_seo_audit(), Run a full SEO/GEO/AIO audit against a website and persist the evidence., Export a stored audit. - ``csv`` aggregated findings, Screaming Frog…, run_seo_audit(), field_validator, Request to run an SEO/GEO/AIO audit against a website., SeoAuditRequest, _build_curl_cffi_fetcher() (+41 more)

### Community 25 - "loop.py"
Cohesion: 0.03
Nodes (108): loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., # NOTE: "ollama_base" is kept for backwards compatibility; this runner only…, Feed LLM token/cost spend into the governance session budget. Kept separate…, Charge sub-agent nesting depth and enforce the ``max_depth`` ceiling. Isolates…, _egress_policy_reason(), Return why governance policy blocks *host*, or None. Runs strictly *after* the…, guard(), identity_from_headers() (+100 more)
...
### Community 31 - "AgentSessionStore"
Cohesion: 0.04
Nodes (77): PreflightIssue, PreflightReport, BaseModel, Agent subsystem — planner / executor / verifier loop., AgentEvent, AgentPlan, AgentRunRequest, AgentSession (+69 more)

### Community 32 - "test_model_catalog.py"
Cohesion: 0.05
...
### Community 33 - "models/company_graph.py"
Cohesion: 0.04
Nodes (82): ApprovalPolicy, BusinessSystem, CompanyCreateRequest, CompanyGraphResponse, CompanyGraphSnapshot, CompanyResponse, CompanyUpdateRequest, Connector (+74 more)
...
Cohesion: 0.05
Nodes (42): Any, Background tick that runs self_heal_brain_and_unblock_tasks(). Called from the…, One-shot self-healing pass. 1. Checks if the active brain provider is in a…, self_heal_brain_and_unblock_tasks(), _self_heal_tick(), BrainWatchdog, _classify_failure_cause(), get_watchdog() (+34 more)
...
Cohesion: 0.07
Nodes (76): BrainFailoverExhausted, failover_chat_completion(), RuntimeError, Every provider in the failover chain failed — the terminal error. Carries the…, Run one chat completion across the brain-failover chain. Tries each healthy…, _free_tier(), _hit_ids(), _many_providers() (+68 more)
...
### Community 42 - "test_e2b_data_flow.py"
Cohesion: 0.07
...
### Community 43 - "SQLiteStore"
Cohesion: 0.02
Nodes (76): CompanyGraph, DetectedSystem, KnowledgeItem, SystemType, The complete Company Graph - canonical core model for the Autonomous AI Agency.…, Find a repository by its URL., Find all systems of a specific type., Find a workflow by its name. (+68 more)
...
### Community 59 - "get_runtime_manager"
Cohesion: 0.05
...
Cohesion: 0.05
Nodes (54): Task, Helpers that turn scheduler and playbook activity into real tasks., Creates tasks from scheduler and playbook runs using one workflow., TaskAutomationService, str, TaskStatus, Record the human decision on a task's **pre-execution** approval gate. A…, Re-run a task. Permissive across every non-active state so the dashboard Retry… (+46 more)
...
### Community 77 - "ExecutionRequest"
Cohesion: 0.05
Nodes (47): Execute work through the 11-phase golden path., Called by APScheduler when a cron fires. Dispatches to the orchestrator. This…, _scheduler_on_fire(), workflow_orchestrator_execute(), get_orchestrator_supervisor(), OrchestratorSupervisor, Any, services/orchestrator_supervisor.py — Deterministic Supervisor Issue #522: A… (+39 more)

### Community 78 - "ai/router.py"
Cohesion: 0.04
Nodes (70): _append_agent_session_message(), _run_agent_loop(), Record token usage for *model* (fire-and-forget, never raises). ``tag`` is a…, record_usage(), _acquire_provider_probe(), clear_cooldowns(), CommercialFallbackRequiredError, _dead_model_key() (+62 more)

### Community 79 - "validate_policy_text"
Cohesion: 0.06
...
### Community 82 - "TestRuntimeControl"
Cohesion: 0.04
...
### Community 85 - "brain_failover.py"
Cohesion: 0.12
...
### Community 86 - "test_brain_priority_scanner.py"
Cohesion: 0.11
...
Cohesion: 0.06
Nodes (24): MockTransport, browser_backend_available(), BrowserFetcher, FetchResult, HttpxFetcher, looks_blocked(), AsyncBaseTransport, services/seo_fetch.py - pluggable page-fetch backends for the SEO audit engine.… (+16 more)
...
### Community 94 - "AgentRunner"
Cohesion: 0.04
Nodes (86): AgentPhaseError, AgentRunner, Exception, Return True when no file is touched by more than one step., Raised when a named agent phase (planning, verification, etc.) fails., GATE: Golden Path steps #7-12 — the primary agent execution loop. This is the…, Set a per-session token spend cap (★3 rollout token budget). When *cap* > 0 the…, Record token spend for *session_id* and enforce the budget cap. Logs a warning… (+78 more)
...
Cohesion: 0.05
Nodes (66): apply_from_db(), Load the stored overrides and apply them. Called once at startup., Path, Start RuntimeManager, TaskDispatcher, SCHEDULER, and self-bootstrap. Returns a…, start_background_services(), _blocked_retire_age_sec(), _heal_blocked_backlog(), _heal_brain_failover() (+58 more)
...
### Community 116 - "services/seo_audit.py"
Cohesion: 0.05
Nodes (38): A single occurrence of a check firing on a specific URL., Aggregated report row - Screaming Frog CSV compatible., Site-level facts discovered during the crawl., SeoIssueInstance, SeoIssueReportRow, SeoSiteFindings, compute_pressure(), _count_syllables() (+30 more)

### Community 117 - "ensure_self_company"
Cohesion: 0.09
...
### Community 119 - "ProviderRouter"
Cohesion: 0.06
Nodes (26): _exponential_backoff_cooldown(), _normalized_provider_type(), _notify_watchdog(), _ollama_reasoning_effort(), ProviderAttempt, ProviderRouter, Any, Try all models for one provider. Returns ProviderResult on success, None on… (+18 more)
...
### Community 123 - "test_web_reach.py"
Cohesion: 0.04
Nodes (73): _domain_list_reason(), _domain_matches(), _load_script_module(), _parse_domain_list(), Any, ModuleType, agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Return True if *host* is *pattern* or a subdomain of it. (+65 more)

### Community 124 - "ModelRouter"
Cohesion: 0.10
Nodes (18): get_local_model(), Return the local Ollama model name for a given Anthropic model name. ..…, Dynamic model router package. Public API:: from router import get_router,…, get_router(), ModelRouter, Any, Central model router. Create one instance (use ``get_router()``). ``route()``…, Decide which Ollama model to use for this request. Args: requested_model: Model… (+10 more)
...
### Community 126 - "workflow_orchestrator.py"
Cohesion: 0.07
...
### Community 128 - "PatternConsolidation"
Cohesion: 0.10
...
### Community 134 - "test_issue_intake.py"
Cohesion: 0.08
...
### Community 154 - "test_autonomous_agency_e2e.py"
Cohesion: 0.05
...
### Community 155 - "Platform Guide — the full tour"
Cohesion: 0.11
...
### Community 156 - "resolve_active_brain"
Cohesion: 0.04
Nodes (71): allow_paid_brain(), BrainResolution, get_active_brain_sync(), get_brain_preference(), get_provider_role_tags(), _host_is_openai_compatible(), is_anthropic_model(), _norm() (+63 more)

### Community 157 - "telegram_bot.py"
Cohesion: 0.07
...
### Community 162 - "LLMProvider"
Cohesion: 0.05
Nodes (53): packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, classify_error(), LLMProvider, OpenAICompatible, ABC, Any, AsyncClient, packages/llm/providers/base.py — the provider contract and the generic adapter.… (+45 more)

### Community 163 - "useSafeData"
Cohesion: 0.06
...
### Community 164 - "failover_client.py"
Cohesion: 0.05
...
### Community 165 - "skill_bindings.py"
Cohesion: 0.09
...
### Community 168 - "persist_plan_spec"
Cohesion: 0.07
...
### Community 170 - "TestEstimateTokensForMessages"
Cohesion: 0.05
...
### Community 176 - "test_schedule_growth_invariants.py"
Cohesion: 0.05
...
### Community 181 - "test_one_model_catalogue.py"
Cohesion: 0.09
...
Cohesion: 0.06
Nodes (18): Company, Any, field_validator, The core company entity - root of the Company Graph., Coerce unrecognised system_type values to 'custom' so the model never crashes…, Update a company. Args: company_id: Company ID **kwargs: Fields to update…, List companies with optional filtering., Create a new company. (+10 more)
...
### Community 192 - "test_llm_router_disabled.py"
Cohesion: 0.09
...
### Community 195 - "TaskBoardScreen.jsx"
Cohesion: 0.05
...
### Community 197 - "test_ephemeral_reaper.py"
Cohesion: 0.09
...
### Community 199 - "test_agent_tool_governance.py"
Cohesion: 0.06
Nodes (55): Replace the process-wide store. Tests only., reset_approval_store(), Replace the process-wide audit log. Tests only., reset_audit_log(), Replace the process-wide engine. Tests only., reset_policy_engine(), _drive(), _enforce() (+47 more)
...
### Community 208 - "resolve_component_model"
Cohesion: 0.03
Nodes (80): Resolve the model id for a component's role on a provider. Parameters…, Convenience: resolve all four role models for a component. Returns a dict with…, resolve_component_model(), resolve_component_role_models(), _build_builtin_model_map(), _default_model(), _default_reasoning_model(), _nvidia_key_present() (+72 more)

### Community 209 - "NotificationDispatcher"
Cohesion: 0.05
...
### Community 210 - "WorkflowBuildRequest"
Cohesion: 0.08
...
### Community 215 - "seo_api.py"
Cohesion: 0.05
Nodes (57): build_seo_roadmap(), _expire_stale_pending_report(), get_seo_audit(), list_seo_audits(), plan_seo_sprint(), BaseModel, get, post (+49 more)

### Community 216 - "facade.py"
Cohesion: 0.06
...
### Community 217 - "_get_provider_policy"
Cohesion: 0.07
...
### Community 224 - "Artifact"
Cohesion: 0.08
Nodes (25): AgentRole, tests/test_workflow_models.py — Unit tests for workflow/models.py., TestCheckRun, TestSlice, Artifact, CheckRun, Any, workflow/models.py — CRISPY Workflow Engine data models. All public types are… (+17 more)

### Community 225 - "llm/router.py"
Cohesion: 0.02
Nodes (118): _load(), main(), Scheduled portfolio intelligence sweep. Run by `.github/workflows/portfolio-…, int, get_budget(), The process-wide budget tracker., get_cache(), packages/llm/cache.py — layered caching. Five independent layers, each with its… (+110 more)
...
### Community 228 - "test_portfolio_intake.py"
Cohesion: 0.08
...
### Community 230 - "PortfolioManager"
Cohesion: 0.05
...
### Community 236 - "test_backend_server_features.py"
Cohesion: 0.08
...
### Community 240 - "test_slop_gate.py"
Cohesion: 0.07
...
### Community 246 - "openclaw_gateway.py"
Cohesion: 0.09
...
### Community 247 - "chat_handlers.py"
Cohesion: 0.11
Nodes (30): _apply_chat_defaults(), _emit_safely(), _extract_exact_output(), _filter_fragment(), _filter_openai_sse_line(), handle_ollama_native_chat(), handle_openai_chat_completions(), _inject_default_system_prompt() (+22 more)
...
### Community 254 - "test_colibri_brain_shim.py"
Cohesion: 0.06
...
### Community 260 - "nvidia_models.py"
Cohesion: 0.07
...
### Community 261 - "test_governance_api.py"
Cohesion: 0.06
...
### Community 267 - "test_implement_agent_routing.py"
Cohesion: 0.07
...
Cohesion: 0.10
Nodes (21): discover_models(), _fresh_entry(), _models_url(), _parse_ids(), Any, Ask a provider which models the configured API key may actually use.…, Return the unexpired cache entry, distinguishing "absent" from "asked and got…, Return the model ids *provider*'s key may use, or ``None`` if unknown. ``None``… (+13 more)
...
### Community 291 - "_routing_candidates"
Cohesion: 0.09
...
### Community 307 - "TestStreamableHTTPTransport"
Cohesion: 0.12
...
### Community 310 - "autonomous_fix.py"
Cohesion: 0.10
...
### Community 312 - "test_failover_silent_exhaustion.py"
Cohesion: 0.11
...
### Community 316 - "models/seo_audit.py"
Cohesion: 0.09
...
### Community 323 - "call_llm"
Cohesion: 0.08
Nodes (32): _agent_timeout_fallback_response(), _build_provider_router(), _builtin_provider_records(), call_llm(), _chat_error_detail_text(), _chat_provider_policy(), chat_send(), _compact_context() (+24 more)

### Community 324 - "CompanyAgencyService"
Cohesion: 0.09
...
### Community 341 - "ProviderConsole.jsx"
Cohesion: 0.08
...
### Community 359 - "test_nvidia_default_model.py"
Cohesion: 0.17
...
### Community 362 - "test_omniroute_provider.py"
Cohesion: 0.15
...
### Community 363 - "VoiceCommandInterface"
Cohesion: 0.14
...
### Community 367 - "test_phase5_doctor.py"
Cohesion: 0.12
...
### Community 371 - "test_telegram_auto_approve.py"
Cohesion: 0.21
...
Cohesion: 0.06
Nodes (24): mcp_server_client(), tests/test_mcp_protocol_version.py — client/server MCP handshake stay in sync.…, test_client_initialize_sends_the_constant(), _fake_post(), _catalogue_preset(), _make_mock_response(), tests/test_telegram_mutating_commands.py — N5 acceptance: /setbrain + /merge.…, Build a mock httpx.Response. (+16 more)
...
### Community 385 - "openclaw_str_e_fix.py"
Cohesion: 0.15
...
### Community 395 - "FeatureUnavailableError"
Cohesion: 0.13
...
### Community 396 - "test_self_heal.py"
Cohesion: 0.12
...
### Community 398 - "test_harness_spec.py"
Cohesion: 0.12
...
### Community 405 - "video_transcript.py"
Cohesion: 0.12
...
### Community 407 - "resolve_free_nvidia_brain"
Cohesion: 0.13
...
### Community 408 - "test_chat_mode_regressions.py"
Cohesion: 0.18
...
### Community 419 - "test_prompt_injection_boundary.py"
Cohesion: 0.15
...
### Community 427 - "test_vision_routing.py"
Cohesion: 0.12
...
### Community 431 - "OrchestratorCheckpointStore"
Cohesion: 0.10
...
### Community 449 - "compare_runtimes.py"
Cohesion: 0.07
...
### Community 500 - "Analysis & Synthesis Instructions"
Cohesion: 0.11
Nodes (18): 1. Define the Atmosphere, 2. Map the Color Palette, 3. Establish Typography Rules, 4. Define the Hero Section, 5. Describe Component Stylings, 6. Define Layout Principles, 7. Define Responsive Rules, 8. Encode Motion Philosophy (+10 more)

### Community 501 - "Production Readiness Assessment — local-llm-server"
Cohesion: 0.11
...
### Community 510 - "test_openclaw_str_e_fix.py"
Cohesion: 0.10
...
### Community 511 - "classify_direct_chat_intent"
Cohesion: 0.13
...
### Community 512 - "test_phase4_runtime_resilience.py"
Cohesion: 0.12
...
### Community 513 - "test_agent_readiness_audit.py"
Cohesion: 0.18
...
### Community 519 - "get_skill_bindings"
Cohesion: 0.13
...
### Community 526 - "sam_livekit_worker.py"
Cohesion: 0.13
...
### Community 532 - "Comprehensive Skill Index (By Category)"
Cohesion: 0.11
...
### Community 533 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 534 - "Component Map"
Cohesion: 0.11
...
### Community 541 - "agile_sprints.py"
Cohesion: 0.08
...
### Community 544 - "get_failover_manager"
Cohesion: 0.09
...
### Community 548 - "test_telegram_service_webhook.py"
Cohesion: 0.11
...
### Community 555 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 561 - "Section-by-Section Acceptance Criteria"
Cohesion: 0.12
...
### Community 565 - "kimi_bridge_provider_config"
Cohesion: 0.18
...
### Community 595 - "Feature Maturity / Support Matrix"
Cohesion: 0.25
...
### Community 596 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 597 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
...
### Community 598 - "test_agent_chat_integration.py"
Cohesion: 0.23
...
### Community 599 - "RateLimitTracker"
Cohesion: 0.16
...
### Community 605 - "ManagedAgentDreams"
Cohesion: 0.22
...
### Community 608 - "test_agency_workflows_carry_the_failover_chain.py"
Cohesion: 0.18
...
### Community 609 - "test_autonomy_status.py"
Cohesion: 0.12
...
### Community 610 - "test_webui_provider_priority.py"
Cohesion: 0.21
...
### Community 612 - "TestGetCurrentTimeTool"
Cohesion: 0.43
...
### Community 617 - "DirectChatSession"
Cohesion: 0.13
...
### Community 618 - "test_refresh_agent_built_proof.py"
Cohesion: 0.12
...
### Community 619 - "test_tasks_reconciler_todo_requeue.py"
Cohesion: 0.20
...
### Community 635 - "test_daily_2026_07_24.py"
Cohesion: 0.20
...
### Community 636 - "_push_down_where"
Cohesion: 0.14
...
### Community 637 - "ClaudeCodeAdapter"
Cohesion: 0.18
...
### Community 639 - "TestDecisionsBotLinks"
Cohesion: 0.17
...
### Community 644 - "TestNoNvidiaFallbackIsRetired"
Cohesion: 0.22
...
### Community 652 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 656 - "Checks Performed"
Cohesion: 0.14
...
### Community 657 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 659 - "admin_digest_router.py"
Cohesion: 0.22
...
### Community 665 - "_brain_provider_status"
Cohesion: 0.25
...
### Community 666 - "Main proxy (`proxy.py`)"
Cohesion: 0.14
...
### Community 667 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 669 - "Render MCP — autonomous platform debugging and environment monitoring"
Cohesion: 0.14
...
### Community 670 - "Runbook: Auto-Resume After Cooldown / Interruption"
Cohesion: 0.14
...
### Community 671 - "SEO / GEO / AIO Audit Engine"
Cohesion: 0.14
...
### Community 674 - "test_rate_limiter.py"
Cohesion: 0.22
...
### Community 675 - "extract_failures"
Cohesion: 0.21
...
### Community 676 - "test_p0_roadmap_b3_b4_b5.py"
Cohesion: 0.20
...
### Community 713 - "TestAgentRunnerSafety"
Cohesion: 0.19
...
### Community 715 - "test_deploy_trigger_covers_image.py"
Cohesion: 0.21
...
### Community 716 - "test_provider_state_durability.py"
Cohesion: 0.12
...
### Community 719 - "TestRouterIntegration"
Cohesion: 0.31
...
### Community 738 - "Quantization Internals"
Cohesion: 0.17
...
### Community 739 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 740 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 741 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 743 - "_FakeAsyncClient"
Cohesion: 0.20
Nodes (3): _FakeAsyncClient, _FakeResponse, Captures the POST url/json/headers so tests can assert the endpoint.

### Community 744 - "TaskStore"
Cohesion: 0.04
Nodes (68): quick_notes_submit(), _QuickNoteBody, Submit a quick-note URL or instruction from the dashboard FAB., Fail loud in production if no persistent storage is configured. Telegram…, Create a task. Deduplicates by source_id if set (Charter G3). If a task with…, Fetch a task by ID. If owner_id is set, enforces ownership., Return the task previously created for an external ``source_id`` (e.g.…, Return BLOCKED tasks that are candidates for auto-retry. (+60 more)
...
### Community 754 - "test_control_plane_api.py"
Cohesion: 0.06
...
### Community 757 - "TestAnthropicPayloadStructuredOutput"
Cohesion: 0.29
...
### Community 761 - "_extractive_compress"
Cohesion: 0.18
...
### Community 762 - "test_kimi_bridge_server.py"
Cohesion: 0.12
...
### Community 764 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 767 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 768 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 770 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 773 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 774 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 775 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 776 - "2. Critical Bugs & Exact Detection Signatures"
Cohesion: 0.18
...
### Community 791 - "test_bedrock_live.py"
Cohesion: 0.25
...
### Community 795 - "test_conftest_hermetic_env.py"
Cohesion: 0.18
...
### Community 796 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 797 - "PerformanceAnalytics"
Cohesion: 0.12
...
### Community 798 - "test_google_provider_models.py"
Cohesion: 0.18
...
### Community 801 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 802 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 803 - "admin_local_brain_router.py"
Cohesion: 0.22
...
### Community 804 - "connectors_api.py"
Cohesion: 0.22
...
### Community 814 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 815 - "Competitor Analysis — Autonomous AI Agency"
Cohesion: 0.20
...
### Community 816 - "Issue #1427: quick-note:https://github.com/bingreeky/JIT"
Cohesion: 0.20
...
### Community 817 - "LLM Router — configuration guide"
Cohesion: 0.20
...
### Community 818 - "LLM Router — provider guide"
Cohesion: 0.20
...
### Community 821 - "TestAnthropicWorkspaceIdCapture"
Cohesion: 0.33
...
### Community 822 - "_parse_reset_epoch"
Cohesion: 0.33
...
### Community 823 - "test_task_service_failed_comment.py"
Cohesion: 0.18
...
### Community 826 - "test_catalogue_probe.py"
Cohesion: 0.20
...
### Community 827 - "test_runtimes_health_endpoint.py"
Cohesion: 0.25
...
### Community 828 - "TestZeroAttemptDiagnostics"
Cohesion: 0.29
...
### Community 829 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 830 - "test_model_catalog_guard.py"
Cohesion: 0.29
...
### Community 832 - "_extract_pytest_failure"
Cohesion: 0.42
...
### Community 833 - "TestSupportMatrixDocsSync"
Cohesion: 0.29
...
### Community 844 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 845 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 847 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
Nodes (8): Branch, Components, Purpose, Quick Start, Session Roles, Skill: cowork-session (Claude Cowork), Testing, When to Use

### Community 848 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 849 - "Active Task Tracker"
Cohesion: 0.22
...
### Community 851 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 852 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 853 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 854 - "Issue #1356: quick-note:https://searchengineland.com/turn-seo-backlog-into-roadmap-485713"
Cohesion: 0.22
...
### Community 855 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 856 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 857 - "Platform Controls"
Cohesion: 0.22
...
### Community 858 - "Release Procedure"
Cohesion: 0.22
...
### Community 859 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 862 - "cowork_session.py"
Cohesion: 0.15
...
### Community 866 - "TestAgentRunnerExecution"
Cohesion: 0.33
...
### Community 867 - "TestWorkflowIntegration"
Cohesion: 0.33
...
### Community 868 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 872 - "DailyDigestAggregatorTests"
Cohesion: 0.19
...
### Community 885 - "test_ai_insights.py"
Cohesion: 0.20
...
### Community 889 - "migrate_local_brain_env.py"
Cohesion: 0.19
...
### Community 947 - "run_patched_colibri.py"
Cohesion: 0.36
...
### Community 953 - "TestPaidPolicyDurability"
Cohesion: 0.22
...
### Community 959 - "test_provider_models_db_outage.py"
Cohesion: 0.25
...
### Community 960 - "test_autonomy_pipeline_regressions.py"
Cohesion: 0.15
...
### Community 963 - "test_doctor_service_token_check.py"
Cohesion: 0.23
...
### Community 972 - "test_task_brain_preflight.py"
Cohesion: 0.31
...
### Community 973 - "_is_ephemeral_user"
Cohesion: 0.27
...
### Community 1000 - "ProviderConfig"
Cohesion: 0.03
Nodes (93): extract_openai_text(), is_commercial_provider(), _normalize_nvidia_base_url(), _openai_url(), provider_access_tier(), _provider_field(), provider_sort_key(), ProviderConfig (+85 more)
...
### Community 1011 - "InitiativeProgress"
Cohesion: 0.33
...
### Community 1012 - "TestMCPToolsListCache"
Cohesion: 0.19
...
### Community 1013 - "TestGithubTokenSQLiteRegression"
Cohesion: 0.38
...
### Community 1042 - "extract_refusal"
Cohesion: 0.27
...
### Community 1045 - "TestAuthAndTaskOwnership"
Cohesion: 0.17
...
### Community 1059 - "_mock_provider_records"
Cohesion: 0.14
...
### Community 1060 - "TestDisabledProvidersAreNotFalselyReportedUnreachable"
Cohesion: 0.33
...
### Community 1062 - "._resolve_merge_decision"
Cohesion: 0.40
...
### Community 1081 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 1082 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 1085 - "verify_pr_exists"
Cohesion: 0.50
...
### Community 1111 - "test_event_log.py"
Cohesion: 0.45
...
### Community 1112 - "TestNoKeyEverReachesTheLog"
Cohesion: 0.40
...
### Community 1113 - "TestTheProbeIdentifiesItself"
Cohesion: 0.40
...
### Community 1116 - "rate_limiter.py"
Cohesion: 0.20
...
### Community 1118 - "backend/server.py"
Cohesion: 0.02
Nodes (211): get_harness_adapter(), AgentStatusEntry, AgentStatusResponse, AgentToolCallEntry, ApiKeyCreate, auth_me(), AuthorizeReposBody, auto_recommend_skills() (+203 more)
...
### Community 1130 - "TestPoliciesGovernanceStableClaim"
Cohesion: 0.20
...
### Community 1134 - "TestPolicyAuthoringUiStableClaim"
Cohesion: 0.22
...
### Community 1136 - "TestGithubSignalHardening"
Cohesion: 0.22
...
### Community 1151 - "test_skills_route_order.py"
Cohesion: 0.67
...
### Community 1152 - "github"
Cohesion: 0.50
Nodes (3): github, enabled, silent

### Community 1153 - "test_process_quick_note_workflow.py"
Cohesion: 0.28
...
### Community 1179 - "CapacityAllocation"
Cohesion: 0.25
...
### Community 1180 - "test_the_reserve_is_bounded_when_read_from_the_environment"
Cohesion: 0.67
...
### Community 1182 - "Continual Harness (`agent/harness_spec.py`)"
Cohesion: 0.25
...
### Community 1189 - "TestOneIdCanBelongToSeveralProviders"
Cohesion: 0.39
...
### Community 1206 - "TestRunCoroSync"
Cohesion: 0.29
...
### Community 1220 - "_start_ceo_agency"
Cohesion: 0.31
...
### Community 1222 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.25
...
### Community 1225 - "parse_event_stream"
Cohesion: 0.15
...
### Community 1231 - "TestMongoService"
Cohesion: 0.29
...
### Community 1252 - "The full agent capability roster"
Cohesion: 0.33
...
### Community 1291 - "resolve_hermes_base_url"
Cohesion: 0.47
...
### Community 1293 - "TestTheAgentRunsCurrentCode"
Cohesion: 0.33
...
### Community 1294 - "test_runtime_registration_scope.py"
Cohesion: 0.33
...
### Community 1295 - "_normalize_dockerfile"
Cohesion: 0.33
...
### Community 1296 - "Who is this for?"
Cohesion: 0.40
...
### Community 1298 - "TestModelRoleSeparation"
Cohesion: 0.40
...
### Community 1299 - "TestInternalAgentAdapterProviderChain"
Cohesion: 0.40
...
### Community 1300 - "TestMongoIsReadyBeforeAnyPytest"
Cohesion: 0.40
...
### Community 1302 - "TestGhIsNotReAuthenticated"
Cohesion: 0.40
...
## Knowledge Gaps
- **3523 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3518 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 13537 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **124 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `_fixture()` connect `_fixture` to `test_brain_patch_service_token.py`, `test_llm_router_queue_cache.py`, `E2BSandboxSession`, `AgentJobManager`, `test_gh_brain_failover.py`, `test_llm_router_strategies.py`, `test_operational_incidents.py`, `ImprovementLoop`, `test_model_router.py`, `Task`, `SelfHealingAgent`, `TestAuthAndTaskOwnership`, `Usage`, `SeoAuditEngine`, `loop.py`, `WorkflowRun`, `test_llm_router_resilience.py`, `AgentSessionStore`, `get_failover_manager`, `test_company_api.py`, `models/company_graph.py`, `BrainWatchdog`, `_mock_provider_records`, `test_failover_client_shared.py`, `test_telegram_service_webhook.py`, `PrimeAgentAdapter`, `test_telegram_webhook.py`, `Agency`, `test_e2b_data_flow.py`, `test_unit8_model_catalog.py`, `MCPClient`, `UserRole`, `AgentSwarm`, `services/background.py`, `routed`, `PolicyDecision`, `AgentDefinition`, `TaskStatus`, `ChatHistoryStore`, `test_openclaw_endpoints.py`, `TokenBudget`, `ResearchTask`, `ai/router.py`, `validate_policy_text`, `TestRuntimeControl`, `config.py`, `TestClient`, `SQLiteStore`, `test_procedural_memory.py`, `rate_limiter.py`, `claim`, `_resolve_push_token`, `e2e/test_browser.py`, `test_autonomy_status.py`, `OutputFilter`, `test_webui_provider_priority.py`, `test_local_brain_state.py`, `test_refresh_agent_built_proof.py`, `test_tasks_reconciler_todo_requeue.py`, `get_task_store`, `_Recorder`, `test_knowledge_sync.py`, `run_task`, `FeatureMaturity`, `ClaudeCodeAdapter`, `test_context_rulebook.py`, `test_process_quick_note_workflow.py`, `ArtifactStore`, `test_issue_intake.py`, `KeyStore`, `test_trend_scoping.py`, `test_new_features_e2e.py`, `_step`, `test_autonomous_agency_e2e.py`, `test_trend_watcher.py`, `TestHarnessRegistry`, `TestHarnessAdapter`, `test_changelog_check_workflow.py`, `test_openclaw_gateway.py`, `persist_plan_spec`, `TestEstimateTokensForMessages`, `test_daily_2026_07_27.py`, `test_ceo_router.py`, `OllamaCircuitBreaker`, `_job_text`, `test_llm_router_disabled.py`, `_Budget`, `_start_ceo_agency`, `test_ephemeral_reaper.py`, `test_task_store_fails_loud_in_production.py`, `test_agent_tool_governance.py`, `UsageEvent`, `TestAgentRunnerSafety`, `test_features_api.py`, `TestTeamSummary`, `parse_event_stream`, `test_doctor_coding_brain.py`, `test_provider_state_durability.py`, `TrendWatcher`, `test_video_transcript.py`, `NotificationDispatcher`, `WorkflowBuildRequest`, `WorkflowRun`, `test_sam_livekit.py`, `TrafficDirector`, `llm/router.py`, `test_portfolio_intake.py`, `TaskStore`, `test_agile_api.py`, `test_app_settings.py`, `test_control_plane_api.py`, `_FakeSandbox`, `TestClient`, `test_kimi_bridge_server.py`, `ScheduledJob`, `ContextPruner`, `nvidia_models.py`, `reset_kv_state`, `test_persistent_memory.py`, `SecurityScanner`, `reset_cache`, `test_llm_router_e2e.py`, `analyze_page`, `test_platform_controls.py`, `test_sam_voice.py`, `OrchestratorQueue`, `test_nvidia_model_discovery.py`, `test_task_pre_execution_gate.py`, `test_task_service_failed_comment.py`, `test_catalogue_probe.py`, `CEOSupervisor`, `test_runtimes_health_endpoint.py`, `models/seo_audit.py`, `session_retro.py`, `CacheManager`, `_resolve_user_github_token`, `test_scheduler_hydration_bounded.py`, `test_regression.py`, `test_agent_scripts_share_one_model_list.py`, `test_crispy_burn_in.py`, `test_provider_enable_disable.py`, `test_skill_registry_boot_refresh.py`, `isolated_telegram_config`, `TestMongoGate`, `test_phase5_doctor.py`, `test_telegram_auto_approve.py`, `TestSwarmRoleRouting`, `test_telegram_mutating_commands.py`, `_undeclared`, `test_service_token.py`, `test_harness_spec.py`, `test_agency_fix.py`, `_Recorder`, `test_dashboard_cache.py`, `test_vision_routing.py`, `OrchestratorCheckpointStore`, `test_monitor_lib.py`, `TestTheWorkflowIsSafeAndReadOnly`, `test_v4_api.py`, `test_ping.py`, `test_doctor_service_token_check.py`, `api_keys_for`, `test_telegram_diag_endpoint.py`, `test_task_brain_preflight.py`, `ProviderConfig`, `test_langfuse_agency_wide.py`, `test_voice_pipeline.py`, `client`, `clear_override`, `cost_tracker.py`, `TestNormalizeResponseFormat`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `TaskSpec`, `proxy.py`, `test_governance_api.py`, `E2BSandboxSession`, `AgentJobManager`, `AdaptiveHalter`, `TestInternalAgentAdapterProviderChain`, `ReactScratchpad`, `loop.py`, `test_autonomous_agency_e2e.py`, `WorkflowRun`, `ContextManager`, `resolve_active_brain`, `AgentSessionStore`, `get_failover_manager`, `test_empirical_verify.py`, `FreeBuffAgent`, `test_failover_client_shared.py`, `MultiAgentSwarm`, `test_agent_loop_delegates_to_the_shared_client`, `Agency`, `MCPClient`, `StuckDetector`, `UserMemoryStore`, `direct_chat.py`, `E2BAdapter`, `TestAgentLoopMCPIntegration`, `test_daily_automation_2026_07_11.py`, `Any`, `TokenBudget`, `CEODispatcher`, `test_agent_tool_governance.py`, `TestAgentRunnerSafety`, `ai/router.py`, `LocalWorkspace`, `test_agent_chat_integration.py`, `backend/server.py`, `_resolve_push_token`, `TestAgentRunnerExecution`, `TestGetCurrentTimeTool`, `WorkspaceTools`, `.execute`, `GitHubTools`, `ContextPruner`, `workflow_orchestrator.py`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderRouter` to `test_implement_agent_routing.py`, `test_all_providers_discovery.py`, `implement_agent.py`, `test_bedrock_live.py`, `model_discovery.py`, `failover_client.py`, `test_bedrock_provider.py`, `kimi_bridge_provider_config`, `direct_chat.py`, `call_llm`, `TestLegacyRouterCacheTTL`, `test_anthropic_refusal_fallback.py`, `ai/router.py`, `TestRouterIntegration`, `TestLegacyRouterServerFallback`, `_payload`, `backend/server.py`, `TrafficDirector`, `ProviderConfig`, `NvidiaProvider`, `TestAnthropicPayloadStructuredOutput`, `settings.py`, `test_colibri_brain_shim.py`?**
