# Graph Report - autonomous-ai-agency  (2026-06-12)

## Corpus Check
- 884 files · ~1,006,578 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 16035 nodes · 34566 edges · 786 communities (692 shown, 94 thin omitted)
- Extraction: 78% EXTRACTED · 22% INFERRED · 0% AMBIGUOUS · INFERRED: 7465 edges (avg confidence: 0.52)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7466de15`
...
## Communities (786 total, 94 thin omitted)
...
Cohesion: 0.02
Nodes (219): set_scheduler(), get_harness_adapter(), _agent_provider_failure_response(), _agent_timeout_fallback_response(), _append_agent_session_message(), auto_recommend_skills(), _build_agent_stream_event(), _build_auto_skill_guidance() (+211 more)
...
Cohesion: 0.02
Nodes (177): get_skill_registry_safe(), Return the global SkillRegistry if set, else None.     Used by onboarding and ot, _estimate_tokens_for_messages(), Estimate input token count for an Anthropic-format message list.      Uses a sim, _check_background_liveness(), _check_ci_parity(), _check_company_graph(), _check_disk() (+169 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (88): AiderAdapter, Adapter for Aider — TIER 3 specialized git-aware code editor., DockerAgentAdapter, Adapter that runs agent tasks inside isolated Docker containers., GooseAdapter, Adapter for Goose — TIER 2 general-purpose local runtime., HermesAdapter, Adapter for Hermes Agent — FIRST CLASS autonomous runtime. (+80 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (81): extract_openai_text(), is_commercial_provider(), _normalize_nvidia_base_url(), _normalized_provider_type(), _openai_url(), provider_access_tier(), _provider_field(), provider_sort_key() (+73 more)

### Community 6 - "Community 6"
Cohesion: 0.07
Nodes (111): runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized).  Aider (https, Run aider non-interactively via `--message` flag., json_safe(), runtimes/adapters/claude_code.py — Claude Code CLI adapter (FIRST CLASS).  Claud, runtimes/adapters/docker_agent.py — Docker-based agent runtime adapter.  Spawns, runtimes/adapters/goose.py — Goose adapter (TIER 2).  Goose (https://github.com/, runtimes/adapters/hermes.py — Hermes Agent adapter (FIRST CLASS).  Hermes Agent, Submit task to Hermes via its /tasks endpoint. (+103 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (75): delete_company_endpoint(), Delete a company and all associated data.      Access control is handled by get_, BusinessSystem, CompanyGraphSnapshot, Find all systems of a specific type., A point-in-time snapshot of a Company Graph for history and rollback., A business system used by the company., Get the index of a phase in the workflow. (+67 more)

### Community 8 - "Community 8"
Cohesion: 0.05
Nodes (153): AdminAuthManager, AdminIdentity, AdminIdentity, Agency, CEO-coordinated multi-agent agency for continuous codebase management.      Th, BackgroundAgent, BackgroundTask, _now() (+145 more)

### Community 9 - "Community 9"
Cohesion: 0.08
Nodes (27): AgentDirective, AgentPlan, AgentStep, _fake_user(), _FakeChatResult, _FakeResponse, UserInfo, test_job_failure_structures_runtime_preflight() (+19 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (160): AgentJobRequest, AgentJobSnapshot, agent/contract.py — Typed public contract for the agent job lifecycle.  Phase, Complete point-in-time view of a job, safe to serialise as API response., Convenience: the canonical text response, whether success or failure., Validated input for creating a new agent job.      Passed from the API handler, DirectChatDoctor, PreflightIssue (+152 more)

### Community 11 - "Community 11"
Cohesion: 0.08
Nodes (16): _check_extra_kwargs(), AgentPlan, Any, UserMemoryStore, Append an event to the durable session log if a store is wired in., Summarise a long history and compact it.          Asks the planner model to writ, Send chat messages and return the assistant's text output.          If an Anthro, Lazy accessor for the SteerLM steering injector (B2). (+8 more)

### Community 12 - "Community 12"
Cohesion: 0.06
Nodes (27): get_specialist_bound_skills(), Get the skills bound to a specific specialist., CompanyAgencyService, _is_runtime_available_sync(), _pick_available_runtime(), Any, SpecialistFamily, services/company_agency.py — Company Agency Orchestration Service  After onboard (+19 more)
...
Cohesion: 0.07
Nodes (173): auto_recommend_skills(), cancel_onboarding(), _DoctorCheck, _DoctorReport, generate_onboarding_questions(), get_company(), get_company_access(), get_company_graph() (+165 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (105): DetectedSystem, Evidence, Evidence supporting a system detection., A business system detected on a company's website or in their stack., Get the most confident evidence description., Inferred technology stack from website/repo analysis., StackInference, main() (+97 more)
...
Cohesion: 0.02
Nodes (92): Status of a user story within a sprint., StoryStatus, HarnessAdapter, HarnessSpec, Any, agents/harness_adapter.py — ECC Cross-Harness Adapter  Normalises API difference, Adapt harness-native requests to the local-llm-server internal format.      Each, Detect which harness sent this request from headers.          Check order: expli (+84 more)
...
Cohesion: 0.11
Nodes (33): ApprovalCheckpoint, Human approval gate in a task's execution., agent_store(), api_client(), _FakeRuntimeManager, AgentStore, TaskStore, TaskWorkflowService (+25 more)
...
Cohesion: 0.04
Nodes (72): Path, Exception, _enrich_runtimes(), get_decision_log(), get_policy(), get_runtime(), list_runtimes(), _load_rich_policy() (+64 more)
...
Cohesion: 0.06
Nodes (31): ModelRouter, Dynamic model router package.  Public API::      from router import get_router,, _build_builtin_model_map(), _default_model(), _default_reasoning_model(), _get_model_map(), ModelRouter, _nvidia_key_present() (+23 more)
...
Cohesion: 0.06
Nodes (38): ActivityPage(), AgentPreviewRow(), C, cls(), ControlPlanePage(), DecisionPreviewRow(), formatCompactTokens(), formatCount() (+30 more)
...
Cohesion: 0.09
Nodes (28): DetectedIssue, ImprovementLoop, ImprovementLoopState, _now(), Any, Path, agent/improvement_loop.py — Continuous Improvement Engine  Background scanner, Background scanner and task dispatcher for continuous codebase improvement. (+20 more)
...
Cohesion: 0.02
Nodes (143): AgentRunner, GATE: Golden Path steps #7-12 — the primary agent execution loop.      This is t, Return True when no file is touched by more than one step., Return orchestrator queue depth, active runs, and supervisor state (#522)., workflow_orchestrator_status(), LogCaptureFixture, get_orchestrator_checkpoint_store(), get_orchestrator_queue() (+135 more)
...
Cohesion: 0.11
Nodes (22): One concrete remediation performed (or proposed) by the fixer., SeoFixAction, SeoFixRequest, _humanize_filename(), BeautifulSoup, Path, SeoFixRequest, SeoFixResult (+14 more)

### Community 62 - "Community 62"
Cohesion: 0.10
Nodes (27): get_improvement_loop(), IssueCategory, IssueSeverity, HealingEvent, _now(), Any, agent/self_healing.py — Self-Healing Agent  Translates external failure signal, Called when a GitHub issue with a bug label is opened. (+19 more)
...
Cohesion: 0.06
Nodes (29): AdminPortalPage(), apiFetch(), hdrs(), buildNavSections(), MOBILE_PRIMARY_NAV, SidebarContent(), ModelsPage(), C (+21 more)

### Community 75 - "Community 75"
Cohesion: 0.07
Nodes (48): delegate_seo_findings(), export_seo_audit(), get_seo_audit(), list_seo_audits(), SeoAuditReport, SeoAuditRequest, SeoAuditSummary, SeoCheckDefinition (+40 more)
...
Cohesion: 0.10
Nodes (31): Agent subsystem — planner / executor / verifier loop., AgentPhaseError, _enforce_signature(), _nvidia_api_key(), loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., Raised when a named agent phase (planning, verification, etc.) fails., # NOTE: "ollama_base" is kept for backwards compatibility; this runner only need, Raise TypeError if fn's signature drifts from the locked contract (Pydantic extr (+23 more)
...
Cohesion: 0.08
Nodes (34): _opus_model(), Return the best available Opus model ID, or None if Opus is not configured., _content_block_to_text(), _fresh_router(), _make_tool(), Regression tests for daily-2026-06-04 improvements.  Covers: - Claude Opus 4.8 m, redacted_thinking blocks (safety-filtered chain-of-thought) must also be strippe, Ensure effort never leaks into the forwarded OpenAI payload. (+26 more)

### Community 84 - "Community 84"
Cohesion: 0.09
Nodes (16): _count_syllables(), estimate_pixel_width(), flesch_reading_ease(), Approximate SERP rendering width of ``text`` in pixels., Flesch reading-ease score; None when there is too little text to score., Render the report rows as a Screaming Frog-compatible CSV string., Per-URL inventory CSV - one row per crawled page (Screaming Frog     'internal_a, Every individual issue occurrence as CSV - one row per (check, URL). (+8 more)
...
Cohesion: 0.03
Nodes (63): check_feature(), get_feature(), list_features(), Any, features/api.py — Admin API for the feature support matrix.  Exposes:   GET  /ad, Return the full support matrix with summary., Return a single feature entry., Check if a feature is available and return its status + any warnings. (+55 more)
...
Cohesion: 0.04
Nodes (63): PreflightReport, AgentJob, make_isolated_workspace(), _now(), Any, agent/job_manager.py — Async agent job lifecycle manager.  Manages agent jobs, Run a job using the provided runner and update the job's lifecycle, progress, re, Create an isolated workspace directory under *root*.      This is the legacy p (+55 more)
...
Cohesion: 0.09
Nodes (12): AgentJobError, AgentJobResult, Any, Structured error payload attached to a failed job., Typed result returned by a completed agent job.      The ``response`` field is, Accept a bare string (legacy runner output) or a full dict., Build a snapshot from an ``AgentJob`` dataclass instance., Tests for agent/contract.py — typed AgentJobRequest / AgentJobResult / AgentJobE (+4 more)
...
Cohesion: 0.13
Nodes (13): _infer_parameters_from_func(), Infer a basic JSON Schema from a function's signature., _inject_tool_results_as_messages(), _parse_tool_calls_from_response(), Parse OpenAI tool_calls from a model response.      Handles:     - Direct JSON t, Inject tool call results as follow-up messages for multi-turn execution.      Wh, Result of a single reward model scoring operation., RewardScore (+5 more)

### Community 110 - "Community 110"
Cohesion: 0.10
Nodes (24): _dispatch_async(), _ErrorCaptureHandler, LogMonitor, Any, LogRecord, agent/log_monitor.py — Application Log Monitor  Captures ERROR/CRITICAL log re, Fire-and-forget: schedule a self-healing task from any thread., Logging handler that forwards ERROR/CRITICAL records to LogMonitor. (+16 more)
...
Cohesion: 0.06
Nodes (19): AdminSession, AdminSessionStore, _is_truthy(), admin_auth.py — auto-generated module docstring (user-research skill scan)., WindowsCredentialAuthenticator, default_keys_path(), issue_new_api_key(), KeyRecord (+11 more)
...
Cohesion: 0.06
Nodes (48): AgencyCycleResult, _build_ceo_prompt(), _build_quick_note_instruction(), _close_github_issue(), _collect_recent_git_context(), _fetch_github_quick_notes(), get_agency(), _gh_repo() (+40 more)
...
Cohesion: 0.09
Nodes (24): Set the global agent store instance (e.g., with MongoDB on startup)., set_agent_store(), Any, Task, TaskPriority, TaskStatus, List tasks for a specific user with optional filters.          ``include_system`, Admin-only: list all tasks across all users. (+16 more)
...
Cohesion: 0.08
Nodes (36): Browser admin UI for login, service control, key management, and diagnostics., Update or append a KEY=value line in the .env file., register_admin_gui(), _save_env_var(), CommercialEquivalent, estimate_commercial_equivalent_usd(), get_prices(), _load_from_env() (+28 more)
...
Cohesion: 0.09
Nodes (22): Any, Durable schedule persistence. Mongo-backed with in-memory fallback.      All met, Return all persisted schedule docs (for boot rehydration)., Persist (insert or update) a single schedule by job_id., Delete a persisted schedule., ScheduleStore, BackgroundServices, Path (+14 more)
...
Cohesion: 0.13
Nodes (9): _now(), Safe getter for sqlite3.Row — Row supports index access but not .get()., Create a session with a caller-supplied session_id (useful for tests and determi, Merge *metadata* into the session's metadata dict (in-memory only; not persisted, Store or clear the resume payload for a paused agent job., Append one event to the session's append-only event log.          The event lo, Return a positional slice of the event log.          Mirrors the ``getEvents(f, Remove messages at the given indices from the session history.          Return (+1 more)

### Community 150 - "Community 150"
Cohesion: 0.11
Nodes (31): _build_anthropic_response(), _content_block_to_text(), _emit_safely(), _finish_reason_to_stop_reason(), get_local_model(), handle_anthropic_messages(), _messages_to_openai(), _openai_choice_to_anthropic_content() (+23 more)
...
Cohesion: 0.07
Nodes (25): quick_notes_submit(), Submit a quick-note URL or instruction from the dashboard FAB., Fire-and-forget self-bootstrap; never blocks or crashes startup., _schedule_self_bootstrap(), ensure_self_company(), _find_self_company(), Self-onboarding bootstrap.  On startup the platform registers *itself* as a comp, Return the existing self company (matched by domain), or None. (+17 more)
...
Cohesion: 0.17
Nodes (8): Task, Re-run a task. Permissive across every non-active state so the dashboard, Add a follow-up instruction to a task and re-queue it for execution.          Un, Executes tasks through the runtime layer using agent definitions., Owns lifecycle transitions, comment semantics, and approval rules., TaskExecutionCoordinator, TaskWorkflowService, test_coordinator_sets_bypass_for_sanctioned_execution()
...
Cohesion: 0.07
Nodes (26): [5.0.0] — 2026-05-24, Added, Added, Added, Added, Added, Changed, Changed (+18 more)

### Community 171 - "Community 171"
Cohesion: 0.09
Nodes (8): CompanyScreen(), GitHubScreen(), IntelligenceScreen(), TRACK_OPTIONS, trackColors, QUEUED_NOTES, QuickNotesFAB(), V5_SCREENS
...
Cohesion: 0.07
Nodes (35): FailureCategory, E2: Classify a failure from its description text.          Order matters: spec, E2: Return a corrective hint for each failure category., Classified failure types for targeted self-healing (E2)., Translate external failure signals into improvement tasks.      Usage::, SelfHealingAgent, detect_harness(), Harness (+27 more)

### Community 180 - "Community 180"
Cohesion: 0.15
Nodes (10): analyze_page(), _host_key(), is_internal(), Host normalized for internal/external comparison (www. stripped)., True when ``url`` belongs to the same site as ``root`` (www-insensitive)., Run every page-scoped check against one HTML document (no network).      Returns, codes(), TestCleanPage (+2 more)
...
Cohesion: 0.13
Nodes (21): agent/workflow.py — Persisted workflow state machine.  Implements the Agency C, Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., tasks — Task/issue management system.  Provides a lightweight task/issue tracker, ApprovalRequest, ClarifyRequest, CommentAddRequest, FollowUpRequest (+13 more)
...
Cohesion: 0.20
Nodes (12): create_company(), get_optional_company_access(), _is_admin(), list_companies(), Extract a consistent user_id from the user dict.      Works across all auth meth, Check if a user has admin role.      Works for both social_auth users (role in S, Verify user has access to a company (if authenticated).      Admins bypass owner, List companies.      - Admin users see ALL companies across the platform.     - (+4 more)
...
Cohesion: 0.08
Nodes (10): Request to run an SEO/GEO/AIO audit against a website., SeoAuditRequest, mock_report(), _mock_site_handler(), Request, Response, Severity -> potential revenue loss via the portfolio mechanism (PR #534 review)., Delegation packages must slot directly into agents/portfolio.py. (+2 more)
...
Cohesion: 0.24
Nodes (7): engine(), WorkflowEngine, Contract: No code path may advance past awaiting_approval unless     gate.status, Create a run and manually place it in awaiting_approval., Contract: Can approve a run in 'awaiting_approval' state., Contract: Rejecting a run marks it as failed., TestApprovalGateMandatory
...
## Knowledge Gaps
- **2642 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `Any`, `Ed25519PublicKey`, `Path` (+2637 more)
...
- **Why does `AgentRunner` connect `Community 58` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 131`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 146`, `Community 19`, `Community 25`, `Community 291`, `Community 46`, `Community 182`, `Community 56`, `Community 322`, `Community 460`, `Community 78`, `Community 345`, `Community 91`, `Community 92`, `Community 484`, `Community 107`, `Community 119`, `Community 127`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `AgentSessionStore` connect `Community 10` to `Community 1`, `Community 417`, `Community 3`, `Community 8`, `Community 9`, `Community 11`, `Community 107`, `Community 78`, `Community 146`, `Community 19`, `Community 149`, `Community 184`, `Community 58`, `Community 93`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `UserMemoryStore` connect `Community 10` to `Community 1`, `Community 3`, `Community 8`, `Community 11`, `Community 78`, `Community 46`, `Community 146`, `Community 19`, `Community 184`, `Community 58`, `Community 287`?**
