...
## Summary
- 30356 nodes · 56725 edges · 1269 communities (1115 shown, 106 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 3331 edges (avg confidence: 0.92)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a0277efe`
...
## Communities (1269 total, 106 thin omitted)

### Community 0 - "backend/server.py"
Cohesion: 0.02
Nodes (241): _agent_timeout_fallback_response(), AgentStatusEntry, AgentStatusResponse, AgentToolCallEntry, ApiKeyCreate, auth_me(), AuthorizeReposBody, auto_recommend_skills() (+233 more)

### Community 1 - "company_api.py"
Cohesion: 0.02
Nodes (179): auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint(), generate_onboarding_questions(), get_company(), get_company_access(), get_company_graph() (+171 more)
...
Cohesion: 0.03
Nodes (103): kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, AiderAdapter, Any, TaskResult, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Run aider non-interactively via `--message` flag., Adapter for Aider — TIER 3 specialized git-aware code editor. (+95 more)

### Community 4 - "proxy.py"
Cohesion: 0.03
Nodes (162): Describes a single worker's task and constraints., WorkerSpec, get_skill_registry_safe(), Return the global SkillRegistry if set, else None. Used by onboarding and other…, middleware, admin_control(), admin_login(), admin_logout() (+154 more)
...
### Community 6 - "ImprovementLoop"
Cohesion: 0.03
Nodes (122): AgentRole, _parse_ceo_directives(), str, DetectedIssue, get_improvement_loop(), ImprovementLoop, ImprovementLoopState, IssueCategory (+114 more)

### Community 7 - "TaskStatus"
Cohesion: 0.03
Nodes (111): Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., tasks — Task/issue management system. Provides a lightweight task/issue tracker…, Enum, str, TaskPriority, TaskStatus, Domain services for task workflow and runtime-backed execution. (+103 more)

### Community 8 - "test_runtimes.py"
Cohesion: 0.03
Nodes (64): runtimes/health.py — RuntimeHealthService. Periodically polls all registered…, _build_default_manager(), Any, runtimes/manager.py — RuntimeManager., Return health status for all registered runtimes., Return routing decision audit log (newest first)., Actively wake every sleeping/circuit-open runtime. The default health service…, True if the runtime is healthy enough for the router to select it. (+56 more)
...
### Community 10 - "test_model_router.py"
Cohesion: 0.03
...
### Community 12 - "Task"
Cohesion: 0.03
Nodes (80): Full task/issue document., Update the updated_at timestamp., Task, _gate_outward_facing_enabled(), _is_brain_connection_error(), _is_outward_facing(), Any, BaseException (+72 more)
...
Cohesion: 0.03
Nodes (113): admin_seed(), clear_cost_attribution(), clear_response_cache(), create_access_token(), create_provider(), delete_api_key(), delete_mcp_server(), delete_model() (+105 more)
...
Cohesion: 0.04
Nodes (87): Charge sub-agent nesting depth and enforce the ``max_depth`` ceiling. Isolates…, _egress_policy_reason(), agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Return why governance policy blocks *host*, or None. Runs strictly *after* the…, governance_enabled(), True when the governance layer should run at all. A single global off switch…, _action_matches(), _as_list() (+79 more)
...
Cohesion: 0.03
Nodes (63): AgentRunner, Any, Path, Governance seam: judge the call, run it, audit the outcome. Deliberately a thin…, Append an event to the durable session log if a store is wired in., Summarise a long history and compact it. Asks the planner model to write a…, Send chat messages and return the assistant's text output. If an…, Call-time resolver for an agent role model id. Delegates to… (+55 more)
...
Cohesion: 0.02
Nodes (54): Company, The core company entity - root of the Company Graph., Find a repository by its URL., A company repository with detected technologies and metadata., Extract the owner from the full name., Extract the repository name from the full name., Repo, requires_db (+46 more)
...
### Community 27 - "brain_config.py"
Cohesion: 0.04
Nodes (79): _active_primary_provider(), BrainConfig, BrainConfigStore, default_brain_config(), is_north_mini_code_default(), provider_api_keys(), provider_base_url(), _provider_env_value() (+71 more)
...
Cohesion: 0.04
Nodes (92): BrainResolution, BrainConfigPatch, get_brain_config(), invalidate_brain_config_cache(), Convenience wrapper used by the agent loop + brain resolver., Convenience wrapper used by the admin API endpoints., Clear the singleton's cache (used by tests + brain_policy invalidation)., Editable subset of ``BrainConfig`` sent by PATCH /admin/api/policy/brain. All… (+84 more)
...
Cohesion: 0.04
Nodes (62): NotificationDispatcher, Any, Path, service_manager.py — Telegram & Notification Integration Extension Extends the…, Start the Telegram bot. Returns True if started successfully., Signal the bot to stop and wait for graceful shutdown., Run the Telegram bot long-poll loop (inline, not subprocess)., Run the bot with stop-event awareness. (+54 more)

### Community 32 - "ExecutionRequest"
Cohesion: 0.04
Nodes (81): _merge_changed_files(), Collect changed_files across all specialists into a single de-duped list., ExecutionRequest, get_ceo_fallback_stats(), PlanOutput, Generate a structured execution plan. Uses the LLM if available; falls back to…, Canonical request to execute work through the golden path. This is the ONLY…, PLAN phase: structured execution plan. (+73 more)

### Community 33 - "tasks/models.py"
Cohesion: 0.04
Nodes (68): ApprovalCheckpoint, ApprovalRequest, ClarifyRequest, _coerce_ts(), CommentAddRequest, ExecutionApprovalRequest, ExecutionLogEntry, FollowUpRequest (+60 more)
...
### Community 39 - "WorkflowRun"
Cohesion: 0.04
Nodes (47): MergeDecision, _NoopStore, Any, Exception, Approve a run paused at the ApprovalGate. The caller must re-invoke…, Inject additional instructions into an in-flight run (no state change). Backs…, Push a Telegram approval-gate notification when a run pauses (Charter G1).…, G5: resolve how a run should land from the company's DeliveryPolicy. Returns… (+39 more)

### Community 40 - "test_unit8_model_catalog.py"
Cohesion: 0.04
Nodes (67): all_provider_ids(), _provider_ids_from_literal(), Return every provider id recognised by the brain config system. Iterates the…, Return the provider ids allowed by the ``BrainProvider`` Literal. Reads the…, CatalogActiveBrain, CatalogMirror, CatalogProviderEntry, _include_router_providers() (+59 more)
...
Cohesion: 0.03
Nodes (51): provision_specialist(), Provision a new specialist for a company. Creates and provisions a specialist…, Request to provision a specialist for a company., Result of provisioning a specialist., A specialist agent that can be provisioned for company-specific tasks., Check if this specialist can handle a task with given capabilities., Specialist, SpecialistProvisionRequest (+43 more)

### Community 43 - "validate_policy_text"
Cohesion: 0.04
...
### Community 44 - "get_task_store"
Cohesion: 0.04
Nodes (78): _purge_backlog_core(), quick_notes_submit(), _QuickNoteBody, The task store the background services should use, wiring it if needed.…, Shared purge implementation for the admin endpoint and the boot hook., Submit a quick-note URL or instruction from the dashboard FAB., _task_store_for_background(), apply_from_db() (+70 more)

### Community 45 - "get_workflow_orchestrator"
Cohesion: 0.05
Nodes (44): Execute work through the 11-phase golden path., Return orchestrator queue depth, active runs, and supervisor state (#522)., #522 + #505: Reliability startup — schedule hydration, orchestrator restore,…, _startup_reliability_hooks(), workflow_orchestrator_execute(), workflow_orchestrator_status(), get_orchestrator_supervisor(), OrchestratorSupervisor (+36 more)

### Community 46 - "ProviderConfig"
Cohesion: 0.05
Nodes (72): extract_openai_text(), is_commercial_provider(), _normalize_nvidia_base_url(), _openai_url(), provider_access_tier(), _provider_field(), provider_sort_key(), ProviderConfig (+64 more)

### Community 47 - "AuditLog"
Cohesion: 0.04
Nodes (56): Replace the process-wide store. Tests only., reset_approval_store(), AuditEvent, AuditLog, _luhn_ok(), Any, packages/governance/audit.py — the evidence trail for every governed action.…, True when ``digits`` (bare, no separators) satisfies the Luhn checksum. (+48 more)
...
### Community 53 - "activation_api.py"
Cohesion: 0.05
...
### Community 54 - "test_sam_livekit.py"
Cohesion: 0.04
...
Cohesion: 0.05
Nodes (42): get_tool_registry(), Return the module-level ToolRegistry singleton. On first call, registers built-…, analyze_qualitative(), auto_register(), _classify_sentiment(), _extract_keywords(), BaseModel, QualAnalysis (+34 more)

### Community 61 - "llm/router.py"
Cohesion: 0.05
...
### Community 65 - "test_agent_runner.py"
Cohesion: 0.04
...
### Community 71 - "KeyStore"
Cohesion: 0.05
Nodes (48): Browser admin UI for login, service control, key management, and diagnostics., Update or append a KEY=value line in the .env file., register_admin_gui(), _save_env_var(), get_output_filter(), get_savings_summary(), Get or create the singleton OutputFilter instance., Get token savings summary. (+40 more)
...
### Community 77 - "_resolve_brain_provider"
Cohesion: 0.05
...
### Community 80 - "loop.py"
Cohesion: 0.05
Nodes (46): Agent subsystem — planner / executor / verifier loop., _check_extra_kwargs(), _enforce_signature(), _nvidia_api_key(), loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., Raise TypeError if fn's signature drifts from the locked contract (Pydantic…, Raise TypeError on unknown kwarg (runtime extra='forbid' for non-Pydantic…, Coerce *requested* to a free NVIDIA model. Returns *requested* when it is… (+38 more)
...
### Community 91 - "test_llm_router_e2e.py"
Cohesion: 0.06
...
### Community 93 - "Agency"
Cohesion: 0.06
Nodes (41): Agency, AgencyCycleResult, AgentDirective, _build_ceo_prompt(), _build_quick_note_instruction(), _close_github_issue(), _collect_recent_git_context(), _fetch_github_quick_notes() (+33 more)
...
### Community 95 - "portfolio_intelligence.py"
Cohesion: 0.06
...
### Community 96 - "TestAddConversationCacheBreakpoints"
Cohesion: 0.06
...
Cohesion: 0.04
Nodes (34): packages.config — single source of truth for all configuration. Every module…, _env_int(), _get_settings(), packages/config/settings.py — typed configuration. This is the ONLY module in…, Read an int env var, falling back to *default* on a missing/bad value. Never…, Typed configuration loaded from environment variables., When True, the governance layer evaluates and audits agent actions. This is…, When True, approval-gated actions self-approve. Local dev only. (+26 more)
...
### Community 102 - "test_sam_voice.py"
Cohesion: 0.05
...
### Community 108 - "CompanyGraph"
Cohesion: 0.04
Nodes (35): BusinessCategory, detect_company_id(), DirectChatSession, handle_chat_message_with_context(), Direct chat session with Company Graph context binding., Bind a company to this chat session and load its Company Graph., Bind a repository to this chat session., Get the bound Company Graph. (+27 more)
...
### Community 114 - "test_v4_reliability.py"
Cohesion: 0.05
Nodes (29): agent/job_manager.py — Async agent job lifecycle manager. Manages agent jobs…, Fail preflight when the provider extension is configured but missing. Without…, Any, Structured, actionable preflight validation issue., Preflight result returned before a runtime task starts., Return a health snapshot. Must not raise; return available=False instead., Return runtime-specific dependency declarations for preflight., Return a best-effort tool availability report for diagnostics. (+21 more)
...
### Community 116 - "test_response_cache.py"
Cohesion: 0.09
...
### Community 139 - "OnboardingScreen.jsx"
Cohesion: 0.05
...
### Community 140 - "test_mcp_registry.py"
Cohesion: 0.07
...
### Community 143 - "test_issue_intake.py"
Cohesion: 0.08
...
### Community 146 - "test_render_mcp.py"
Cohesion: 0.06
...
### Community 149 - "Artifact"
Cohesion: 0.07
Nodes (28): AgentRole, _fake_artifact(), TestCheckRun, TestSlice, workflow/artifact_store.py — Durable artifact persistence. Artifacts are stored…, _extract_slices_from_plan(), Extract slice definitions from a plan.md artifact. Looks for sections matching:…, Artifact (+20 more)

### Community 150 - "ProviderRouter"
Cohesion: 0.07
Nodes (26): build_tool_calling_router(), Return a router limited to providers that pass ``tools`` through intact. The…, _normalized_provider_type(), ProviderRouter, Any, Parse a 429/503 ``Retry-After`` header → seconds, or None. Accepts either…, Translate an OpenAI chat/completions payload to Bedrock Converse format., Translate a Bedrock Converse API response to OpenAI chat.completion format. (+18 more)
...
### Community 168 - "ai/router.py"
Cohesion: 0.06
Nodes (39): _acquire_provider_probe(), CommercialFallbackRequiredError, _dead_model_key(), _exponential_backoff_cooldown(), _get_director(), _mark_model_dead(), _notify_watchdog(), _ollama_reasoning_effort() (+31 more)
...
### Community 171 - "InferenceCache"
Cohesion: 0.06
Nodes (24): CachedLLMClient, Cached LLM Client wrapper. Drop-in wrapper around any LLM API call that…, Return performance metrics for this client instance., Wraps an LLM call function with inference caching. Usage: from agent.cached_llm…, CacheEntry, CacheStats, InferenceCache, Any (+16 more)

### Community 172 - "PatternConsolidation"
Cohesion: 0.08
...
### Community 173 - "probe_catalogues.py"
Cohesion: 0.07
...
### Community 179 - "AnthropicProvider"
Cohesion: 0.09
...
### Community 189 - "chat_handlers.py"
Cohesion: 0.09
...
Cohesion: 0.08
Nodes (23): _make_engine(), tests/test_crispy_workflow.py — CRISPY workflow engine hardening tests. Tests…, Create a WorkflowEngine with isolated storage., TestAbortOnFailure, TestPhaseSequence, TestPhaseSequenceError, TestWorkspaceIsolation, WorkflowRun (+15 more)
...
### Community 199 - "TaskBoardScreen.jsx"
Cohesion: 0.06
...
### Community 200 - "test_colibri_brain_shim.py"
Cohesion: 0.08
...
### Community 205 - "provider_max_rpm"
Cohesion: 0.07
...
### Community 208 - "test_schedule_backlog_drain.py"
Cohesion: 0.08
...
### Community 214 - "Part A — CodeRabbit review fixes for this PR (do first, small)"
Cohesion: 0.05
...
### Community 215 - "Docker Agent Runtimes Setup"
Cohesion: 0.05
...
### Community 218 - "sync/service.py"
Cohesion: 0.10
Nodes (34): FastAPI dependency: require Power User or Admin role. Raises 403 otherwise., Return a FastAPI dependency that checks for a specific permission., require_permission(), require_power_user(), add_peer(), get_folder_index(), get_sync_file(), get_sync_service() (+26 more)

### Community 219 - "SchedulerStore"
Cohesion: 0.07
...
### Community 220 - "test_agent_tool_governance.py"
Cohesion: 0.08
...
### Community 222 - "test_process_quick_note_workflow.py"
Cohesion: 0.06
...
### Community 223 - "TokenBudget"
Cohesion: 0.08
Nodes (23): BudgetExceededError, Exception, agent/token_budget.py — Per-Session Token Spend Caps Track token usage per…, Raise :class:`BudgetExceededError` if the session has exceeded its cap., Raised when a token spend cap is hit., Track and enforce per-session or per-agent token budgets. Usage:: budget =…, TokenBudget, Unit-level tests for the TokenBudget state used for response headers. (+15 more)
...
### Community 229 - "TestRuntimeControl"
Cohesion: 0.05
...
### Community 230 - "WorkspaceManifest"
Cohesion: 0.08
...
### Community 234 - "compare_runtimes.py"
Cohesion: 0.07
...
### Community 235 - "test_agent_free_brain.py"
Cohesion: 0.06
...
### Community 247 - "test_portfolio_intelligence.py"
Cohesion: 0.06
...
### Community 248 - "test_schedule_growth_invariants.py"
Cohesion: 0.06
...
### Community 250 - "get_failover_manager"
Cohesion: 0.07
...
### Community 253 - "test_slop_gate.py"
Cohesion: 0.08
...
### Community 255 - "test_unit6_resolve_component_model.py"
Cohesion: 0.05
...
### Community 258 - "enforcement.py"
Cohesion: 0.08
Nodes (26): BudgetExceeded, get_gate(), guard_tool_call(), GuardResult, _host_of(), _is_write_tool(), _more_restrictive(), Any (+18 more)

### Community 259 - "test_control_plane_api.py"
Cohesion: 0.06
...
### Community 271 - "TestBrainConfigUpdates"
Cohesion: 0.09
Nodes (8): tests/test_daily_automation_2026_07_10.py — Daily automation tests…, Verify Llama 4 and Claude Sonnet 5 cross-provider aliases are registered., Verify brain_config.py changes: Google provider, updated presets., The durable property, not the id of the week. This assertion has been amended…, Verify new models are in the packages/ai/registry., TestBrainConfigUpdates, TestBrainFailoverModelAliases, TestModelRegistryUpdates

### Community 272 - "test_persistent_memory.py"
Cohesion: 0.06
...
### Community 274 - "test_backend_server_features.py"
Cohesion: 0.07
...
### Community 282 - "test_all_providers_discovery.py"
Cohesion: 0.17
...
### Community 289 - "JCodeAdapter"
Cohesion: 0.08
Nodes (15): Resolve the model id for a component's role on a provider. Parameters…, resolve_component_model(), JCodeAdapter, Any, Path, Write .jcode/mcp.json in the workspace, pointing at our proxy's MCP endpoint.…, Resolve the default executor model via the catalog (UNIT 7). Was hardcoded to…, Adapter for jcode — TIER 2 high-performance Rust coding agent. (+7 more)

### Community 290 - "test_platform_controls.py"
Cohesion: 0.08
...
### Community 291 - "test_brain_failover.py"
Cohesion: 0.11
...
### Community 293 - "ContextCompressor"
Cohesion: 0.11
...
### Community 296 - "ResourceWatchdog"
Cohesion: 0.10
...
### Community 300 - "test_failover_silent_exhaustion.py"
Cohesion: 0.10
...
### Community 301 - "report_to_markdown"
Cohesion: 0.10
...
### Community 308 - "Langfuse Observability Guide"
Cohesion: 0.06
...
### Community 310 - "test_brain_availability_doctor.py"
Cohesion: 0.13
...
### Community 311 - "OrchestratorCheckpointStore"
Cohesion: 0.09
...
### Community 319 - "LlmProviderConfig"
Cohesion: 0.16
...
### Community 322 - "test_rate_limiter.py"
Cohesion: 0.10
...
### Community 323 - "test_mcp_governance.py"
Cohesion: 0.12
...
### Community 326 - "InternalAgentAdapter"
Cohesion: 0.08
Nodes (22): _best_cloud_primary_base(), InternalAgentAdapter, TaskResult, Built-in agent loop — Nvidia NIM primary, Ollama fallback., Return runtime dependencies required by this adapter. Returns:…, Determine availability of the internal agent runtime. Checks cloud providers in…, Execute a TaskSpec using the internal AgentRunner and convert the agent's…, Create an isolated execution context for a single task. Tries ``git worktree… (+14 more)

### Community 327 - "BrainFailoverManager"
Cohesion: 0.10
...
### Community 329 - "test_force_cleanup_conditional_delete.py"
Cohesion: 0.10
...
### Community 330 - "test_autonomy_gate.py"
Cohesion: 0.13
...
### Community 331 - "test_rag_context.py"
Cohesion: 0.12
...
### Community 332 - "ProjectScaffolder"
Cohesion: 0.13
...
### Community 334 - "_is_ephemeral_user"
Cohesion: 0.09
Nodes (28): account_lifecycle(), AccountLifecycleResponse, _DoctorCheck, _DoctorReport, get_public_doctor_report(), _is_ephemeral_user(), OnboardingAnswersRequest, OnboardingQuestionsRequest (+20 more)
...
### Community 338 - "RuntimeHealthService"
Cohesion: 0.10
...
### Community 341 - "test_scheduler_hydration_bounded.py"
Cohesion: 0.09
...
### Community 343 - "test_purge_backlog.py"
Cohesion: 0.09
...
### Community 354 - "test_regression.py"
Cohesion: 0.10
...
### Community 355 - "test_agent_scripts_share_one_model_list.py"
Cohesion: 0.10
...
### Community 356 - "test_crispy_burn_in.py"
Cohesion: 0.07
...
### Community 358 - "test_provider_enable_disable.py"
Cohesion: 0.09
...
### Community 364 - "tests/conftest.py"
Cohesion: 0.10
...
### Community 365 - "Deploy: FreeBuff Telegram bot (24×7)"
Cohesion: 0.07
...
### Community 373 - "isolated_telegram_config"
Cohesion: 0.11
...
### Community 374 - "_captured_request_headers"
Cohesion: 0.13
...
### Community 375 - "test_one_model_catalogue.py"
Cohesion: 0.10
...
### Community 380 - "platform_controls_router.py"
Cohesion: 0.10
...
### Community 383 - "output_filter.py"
Cohesion: 0.08
...
### Community 384 - "control_registry.py"
Cohesion: 0.14
...
### Community 389 - "test_telegram_mutating_commands.py"
Cohesion: 0.08
...
### Community 392 - "test_direct_chat_evolution.py"
Cohesion: 0.14
...
### Community 393 - "AGENTS.md — Codebase Map & Operations Reference"
Cohesion: 0.08
...
### Community 399 - "test_north_mini_code.py"
Cohesion: 0.09
...
### Community 400 - "test_connector_registry.py"
Cohesion: 0.12
...
### Community 401 - "has_image_content"
Cohesion: 0.12
...
### Community 402 - "NIMConnectionPool"
Cohesion: 0.11
...
### Community 403 - "_InMemoryBackend"
Cohesion: 0.11
...
### Community 404 - "TemporalContextGraph"
Cohesion: 0.10
...
### Community 405 - "test_freebuff_bot.py"
Cohesion: 0.11
...
### Community 406 - "test_telegram_approval_e2e.py"
Cohesion: 0.12
...
### Community 407 - "TestClassifyPlainText"
Cohesion: 0.08
...
### Community 408 - "test_phase6_workflow.py"
Cohesion: 0.16
...
### Community 409 - "test_service_token.py"
Cohesion: 0.08
...
### Community 413 - "TestStreamableHTTPTransport"
Cohesion: 0.13
...
### Community 415 - "Local AI Stack with Docker"
Cohesion: 0.08
...
### Community 416 - "Implementation Prompt: Rich TaskBoard + Agile Sprint Integration"
Cohesion: 0.08
...
### Community 417 - "Telegram Bot Setup"
Cohesion: 0.08
...
### Community 420 - "control_overrides.py"
Cohesion: 0.12
...
### Community 422 - "Native operations"
Cohesion: 0.09
...
### Community 425 - "test_agency_fix.py"
Cohesion: 0.08
...
### Community 428 - "_status_snapshot"
Cohesion: 0.15
...
### Community 429 - "Agent Governance Guide"
Cohesion: 0.09
...
### Community 430 - "The fifteen strategies"
Cohesion: 0.09
...
### Community 431 - "SetupWizardPage.js"
Cohesion: 0.13
...
### Community 433 - "implement_agent.py"
Cohesion: 0.12
...
### Community 436 - "WindowsServiceManager"
Cohesion: 0.18
...
### Community 439 - "SyntheticDataPipeline"
Cohesion: 0.13
...
### Community 440 - "test_task_source_id_race.py"
Cohesion: 0.13
...
### Community 442 - "test_cerebras_catalogue.py"
Cohesion: 0.13
...
### Community 443 - "test_monitor_lib.py"
Cohesion: 0.11
...
### Community 445 - "test_mostly_failed_steps.py"
Cohesion: 0.12
...
### Community 447 - "HarnessEnrichment"
Cohesion: 0.14
...
### Community 448 - "classify_direct_chat_intent"
Cohesion: 0.13
...
### Community 456 - "services/seo_audit.py"
Cohesion: 0.13
...
### Community 459 - "test_anthropic_refusal_fallback.py"
Cohesion: 0.19
...
### Community 462 - "build_matrix"
Cohesion: 0.16
Nodes (17): Recommend skills relevant to the current task. Called from the tool-call loop…, build_matrix(), _families(), main(), Any, scripts/generate_specialist_skill_matrix.py — Specialist × Skill matrix.…, Map family -> sorted list of test files that mention it (quoted token)., Return one row per family, derived entirely from code. (+9 more)

### Community 463 - "open_phase_report"
Cohesion: 0.13
...
### Community 464 - "PersistentMemoryStore"
Cohesion: 0.22
...
### Community 468 - "TestNormalizeResponseFormat"
Cohesion: 0.10
...
### Community 470 - "system_instruction"
Cohesion: 0.16
...
### Community 472 - "test_autonomous_agency_e2e.py"
Cohesion: 0.10
...
### Community 474 - "test_provider_state_durability.py"
Cohesion: 0.12
...
### Community 479 - "test_prompt_injection_boundary.py"
Cohesion: 0.17
...
### Community 486 - "Docker AI Governance Audit — Final Report"
Cohesion: 0.10
...
### Community 487 - "1. Capability-by-capability"
Cohesion: 0.10
...
### Community 489 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 490 - "PortfolioScreen.jsx"
Cohesion: 0.11
...
### Community 493 - "is_anthropic_base_url"
Cohesion: 0.12
...
### Community 495 - "context_plan_gate.py"
Cohesion: 0.15
...
### Community 497 - "test_kimi_bridge_server.py"
Cohesion: 0.12
...
### Community 501 - "test_chat_mode_regressions.py"
Cohesion: 0.19
...
### Community 502 - "TestBrainFailoverModelUpdates"
Cohesion: 0.18
...
### Community 504 - "test_langfuse_agency_wide.py"
Cohesion: 0.10
...
### Community 505 - "test_tasks_cache_ttl_env.py"
Cohesion: 0.21
...
### Community 506 - "test_voice_pipeline.py"
Cohesion: 0.14
...
### Community 513 - "Skill: fabric-patterns"
Cohesion: 0.11
...
### Community 514 - "Analysis & Synthesis Instructions"
Cohesion: 0.11
Nodes (18): 1. Define the Atmosphere, 2. Map the Color Palette, 3. Establish Typography Rules, 4. Define the Hero Section, 5. Describe Component Stylings, 6. Define Layout Principles, 7. Define Responsive Rules, 8. Encode Motion Philosophy (+10 more)

### Community 515 - "Production Readiness Assessment — local-llm-server"
Cohesion: 0.11
...
### Community 521 - "test_provider_410_per_model.py"
Cohesion: 0.18
...
### Community 522 - "Delegation Plan (agent-ready work packages)"
Cohesion: 0.11
...
### Community 523 - "test_p0_roadmap_a4_a5_b2.py"
Cohesion: 0.15
...
### Community 524 - "parse_event_stream"
Cohesion: 0.15
...
### Community 529 - "test_fabric_patterns.py"
Cohesion: 0.11
...
### Community 530 - "test_gh_brain_failover.py"
Cohesion: 0.11
...
### Community 532 - "test_repowise_intelligence.py"
Cohesion: 0.11
...
### Community 533 - "test_schedule_persistence.py"
Cohesion: 0.15
...
### Community 535 - "operational_incidents.py"
Cohesion: 0.13
...
### Community 536 - "OperationalIncidentTracker"
Cohesion: 0.13
...
### Community 540 - "agile_sprints.py"
Cohesion: 0.14
...
### Community 541 - "Comprehensive Skill Index (By Category)"
Cohesion: 0.11
...
### Community 542 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 543 - "Component Map"
Cohesion: 0.11
...
### Community 544 - "test_minimax_bug_fixes.py"
Cohesion: 0.13
...
### Community 545 - "Architecture Overview — local-llm-server"
Cohesion: 0.11
...
### Community 546 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
...
### Community 552 - "test_agent_tools.py"
Cohesion: 0.19
...
### Community 555 - "test_task_pre_execution_gate.py"
Cohesion: 0.24
...
### Community 556 - "test_telegram_webhook.py"
Cohesion: 0.14
...
### Community 562 - "SKILL: Industrial Brutalism & Tactical Telemetry UI"
Cohesion: 0.12
...
### Community 563 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 564 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 565 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 572 - "kimi_bridge_provider_config"
Cohesion: 0.18
...
### Community 573 - "agent_readiness_audit.py"
Cohesion: 0.21
...
### Community 578 - "test_activation_api.py"
Cohesion: 0.21
...
### Community 579 - "TestAListingFailureDoesNotVetoTheAnswer"
Cohesion: 0.17
...
### Community 580 - "test_daily_automation_2026_07_11.py"
Cohesion: 0.15
...
### Community 582 - "test_health_endpoints.py"
Cohesion: 0.17
...
### Community 583 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 584 - "test_openclaw_endpoints.py"
Cohesion: 0.12
...
### Community 586 - "test_skill_registry.py"
Cohesion: 0.13
...
### Community 587 - "hermes_prompt.py"
Cohesion: 0.19
...
### Community 592 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
...
### Community 593 - "_valid_login_state"
Cohesion: 0.24
...
### Community 595 - "The 10-Step Workflow"
Cohesion: 0.12
...
### Community 596 - "Nothing is blocked on an agent. Two things need a human."
Cohesion: 0.12
...
### Community 599 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 600 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 601 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
...
### Community 607 - "test_telegram_auto_approve.py"
Cohesion: 0.21
...
### Community 608 - "ManagedAgentDreams"
Cohesion: 0.22
...
### Community 609 - "_resolve_push_token"
Cohesion: 0.17
...
### Community 610 - "e2e/test_browser.py"
Cohesion: 0.21
...
### Community 611 - "test_agency_workflows_carry_the_failover_chain.py"
Cohesion: 0.18
...
### Community 612 - "test_autonomy_status.py"
Cohesion: 0.12
...
### Community 613 - "test_dockerfile_ships_root_modules.py"
Cohesion: 0.17
...
### Community 614 - "test_local_brain_state.py"
Cohesion: 0.12
...
### Community 616 - "test_migrate_local_brain_env.py"
Cohesion: 0.38
...
### Community 617 - "test_nvidia_default_model.py"
Cohesion: 0.17
...
### Community 618 - "test_phase5_doctor.py"
Cohesion: 0.12
...
### Community 619 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 620 - "test_refresh_agent_built_proof.py"
Cohesion: 0.12
...
### Community 621 - "test_tasks_reconciler_todo_requeue.py"
Cohesion: 0.20
...
### Community 634 - "Skill: user-research"
Cohesion: 0.13
...
### Community 636 - "Attention Mechanisms Internals"
Cohesion: 0.13
...
### Community 638 - "_push_down_where"
Cohesion: 0.14
...
### Community 639 - "router/health.py"
Cohesion: 0.20
...
### Community 642 - "test_critical_flows.py"
Cohesion: 0.26
...
### Community 645 - "test_dockerfile_ships_config_dir.py"
Cohesion: 0.14
...
### Community 647 - "migrate_local_brain_env.py"
Cohesion: 0.19
...
### Community 651 - "analyze_quantitative"
Cohesion: 0.22
...
### Community 661 - "admin_digest_router.py"
Cohesion: 0.22
...
### Community 662 - "Skill: branch-cleanup"
Cohesion: 0.14
...
### Community 667 - "Main proxy (`proxy.py`)"
Cohesion: 0.14
...
### Community 668 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 670 - "Render MCP — autonomous platform debugging and environment monitoring"
Cohesion: 0.14
...
### Community 672 - "SEO / GEO / AIO Audit Engine"
Cohesion: 0.14
...
### Community 673 - "Traffic Distribution Across Providers"
Cohesion: 0.14
...
### Community 679 - "TestAnthropicToolListCaching"
Cohesion: 0.34
...
### Community 680 - "test_brain_failover_413.py"
Cohesion: 0.15
...
### Community 681 - "TestMCPToolsListCache"
Cohesion: 0.19
...
### Community 685 - "test_tasks_awaiting_approval_api.py"
Cohesion: 0.37
...
### Community 686 - "CollaborationContext"
Cohesion: 0.21
...
### Community 689 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 692 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 693 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 696 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
...
### Community 697 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 698 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 700 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 716 - "update_provider_policy"
Cohesion: 0.19
...
### Community 723 - "TestTheGatewayRegistryOffersOnlyLiveModels"
Cohesion: 0.22
...
### Community 738 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 741 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 743 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 744 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 745 - "Workspace Isolation Architecture"
Cohesion: 0.17
...
### Community 746 - "Quantization Internals"
Cohesion: 0.17
...
### Community 747 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 748 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 749 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 750 - "GovernanceScreen.jsx"
Cohesion: 0.18
...
### Community 755 - "_execute_skill_impl"
Cohesion: 0.20
Nodes (9): Run an audit from synchronous code, loop-safe. Used by the skill-bindings…, run_audit_sync(), _execute_skill_impl(), _get_portfolio_manager(), Any, Recommend skills based on detected systems and provisioned specialists. With no…, Execute a skill by ID and update its execution counters., Lazily build and cache the shared PortfolioManager. (+1 more)

### Community 756 - "setup_ngrok.py"
Cohesion: 0.27
...
### Community 757 - "test_admin_local_brain_router.py"
Cohesion: 0.29
...
### Community 758 - "test_agile_api.py"
Cohesion: 0.17
...
### Community 759 - "test_app_settings.py"
Cohesion: 0.21
...
### Community 760 - "test_brain_default_consistency.py"
Cohesion: 0.24
...
### Community 761 - "TestAuthAndTaskCreation"
Cohesion: 0.17
...
### Community 762 - "TestAuthAndTaskOwnership"
Cohesion: 0.17
...
### Community 763 - "TestAnthropicPayloadStructuredOutput"
Cohesion: 0.29
...
### Community 764 - "test_task_clarification.py"
Cohesion: 0.17
...
### Community 768 - "_extractive_compress"
Cohesion: 0.18
...
### Community 770 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 773 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 774 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 780 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 781 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 782 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 783 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 784 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 785 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 786 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 788 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 789 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 790 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 791 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 792 - "What to clean up"
Cohesion: 0.18
...
### Community 793 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 797 - "capture_screens.py"
Cohesion: 0.25
...
### Community 799 - "build_tech_db.py"
Cohesion: 0.35
...
### Community 802 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 803 - "test_event_log.py"
Cohesion: 0.45
...
### Community 804 - "test_google_provider_models.py"
Cohesion: 0.18
...
### Community 805 - "TestNoNvidiaFallbackIsRetired"
Cohesion: 0.22
...
### Community 807 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 808 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 809 - "admin_local_brain_router.py"
Cohesion: 0.22
...
### Community 810 - "connectors_api.py"
Cohesion: 0.22
...
### Community 811 - "_normalize_tool_choice"
Cohesion: 0.31
...
### Community 812 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 813 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 814 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 815 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 816 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 818 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 819 - "Agent Readiness Report"
Cohesion: 0.20
...
### Community 821 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 822 - "Competitor Analysis — Autonomous AI Agency"
Cohesion: 0.20
...
### Community 823 - "Issue #1427: quick-note:https://github.com/bingreeky/JIT"
Cohesion: 0.20
...
### Community 824 - "LLM Router — configuration guide"
Cohesion: 0.20
...
### Community 825 - "LLM Router — provider guide"
Cohesion: 0.20
...
### Community 826 - "CI Troubleshooting Runbook"
Cohesion: 0.20
...
### Community 831 - "test_catalogue_probe.py"
Cohesion: 0.20
...
### Community 833 - "TestPoliciesGovernanceStableClaim"
Cohesion: 0.20
...
### Community 850 - "_autonomy_bg_cycle"
Cohesion: 0.28
...
### Community 851 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 852 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 853 - "Skill: changelog-enforcer"
Cohesion: 0.22
Nodes (8): Acceptance Checks, Changelog Location, Entry Format, Examples, Hook Behaviour, Instructions, Skill: changelog-enforcer, When to Use

### Community 854 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
...
### Community 856 - "Active Task Tracker"
Cohesion: 0.22
...
### Community 858 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 859 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 860 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 861 - "Issue #1356: quick-note:https://searchengineland.com/turn-seo-backlog-into-roadmap-485713"
Cohesion: 0.22
...
### Community 862 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 863 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 864 - "Platform Controls"
Cohesion: 0.22
...
### Community 865 - "Release Procedure"
Cohesion: 0.22
...
### Community 866 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 868 - "_get_current_user"
Cohesion: 0.25
...
### Community 870 - "_hostname_matches"
Cohesion: 0.22
...
### Community 875 - "TestPolicyAuthoringUiStableClaim"
Cohesion: 0.22
...
### Community 882 - "DirectChatDoctor"
Cohesion: 0.32
...
### Community 885 - "OperationalIncident"
Cohesion: 0.36
...
### Community 890 - "quality_checker.py"
Cohesion: 0.32
...
### Community 892 - "_brain_provider_status"
Cohesion: 0.25
...
### Community 907 - "Feature Maturity / Support Matrix"
Cohesion: 0.25
...
### Community 910 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.25
...
### Community 911 - "Issue #362: Nvidia repo setup"
Cohesion: 0.25
...
### Community 912 - "Issue #364: quick-note:https://www.marktechpost.com/2026/06/01/meet-memory-os-a-6-layer-open-source-memory-stack-built-on-top-of-hermes-agent/"
Cohesion: 0.25
...
### Community 913 - "Issue #378: quick-note:https://www.marktechpost.com/2026/06/02/tinyfish-launches-bigset-an-open-source-multi-agent-system-that-builds-structured-live-datasets-from-plain-english-descriptions/"
Cohesion: 0.25
...
### Community 914 - "Issue #379: quick-note:https://searchengineland.com/schema-markup-optimize-agentic-web-479080"
Cohesion: 0.25
...
### Community 915 - "Issue #380: quick-note:https://cursor.com/blog/cloud-agent-lessons"
Cohesion: 0.25
...
### Community 916 - "Issue #381: quick-note:https://www.xda-developers.com/claude-code-with-opus-48-is-expensive-but-i-made-it-efficient-with-my-local-ai-workflow/"
Cohesion: 0.25
...
### Community 917 - "Issue #382: quick-note:https://claude.com/blog/how-coderabbit-used-claude-to-build-an-agent-orchestration-system"
Cohesion: 0.25
...
### Community 918 - "Issue #383: quick-note:https://www.marktechpost.com/2026/05/29/hexo-labs-open-sources-sia-a-self-improving-agent-that-updates-both-the-harness-and-the-model-weights/"
Cohesion: 0.25
...
### Community 919 - "Issue #416: feat: Self-hosted Codebuff (freebuff) on free NVIDIA models + Telegram bot phone control"
Cohesion: 0.25
...
### Community 920 - "Issue #485: [Trend Digest] Week of 2026-06-08"
Cohesion: 0.25
...
### Community 921 - "Issue #488: quick-note:https://github.com/cookiy-ai/user-research-skill"
Cohesion: 0.25
...
### Community 922 - "Issue #491: Implement whatever is necessary from https://github.com/BehiSecc/awesome-claude-skills"
Cohesion: 0.25
...
### Community 923 - "Issue #493: Use the https://github.com/mvanhorn/last30days-skill skill to get the trend updated"
Cohesion: 0.25
...
### Community 924 - "Issue #495: Read https://www.anthropic.com/news/claude-fable-5-mythos-5 and understand if mythos or fable can be added to the repo"
Cohesion: 0.25
...
### Community 925 - "Issue #504: EPIC: Autonomy hardening — live-verified defects 2026-06-10"
Cohesion: 0.25
...
### Community 926 - "Issue #581: Sprint tracker: pending work after brand rename + mobile-first pass"
Cohesion: 0.25
...
### Community 928 - "Issue #657: quick-note:https://github.com/earendil-works/pi"
Cohesion: 0.25
...
### Community 929 - "Issue #659: quick-note:https://github.com/nex-agi/Nex-N2"
Cohesion: 0.25
...
### Community 930 - "Issue #660: quick-note:https://github.com/getsentry/sentry-for-ai"
Cohesion: 0.25
...
### Community 931 - "Issue #661: quick-note:https://github.com/XiaomiMiMo/MiMo-Code"
Cohesion: 0.25
...
### Community 932 - "Issue #664: quick-note:https://github.com/Grominet95/jarvis-OS"
Cohesion: 0.25
...
### Community 933 - "Issue #666: quick-note:https://github.com/porokka/jarvis-os"
Cohesion: 0.25
...
### Community 934 - "Issue #670: quick-note:https://github.com/perplexityai/bumblebee"
Cohesion: 0.25
...
### Community 935 - "Issue #672: quick-note:https://github.com/Chachamaru127/claude-code-harness"
Cohesion: 0.25
...
### Community 936 - "Issue #676: quick-note:https://github.com/WeiboAI/VibeThinker"
Cohesion: 0.25
...
### Community 937 - "Issue #820: quick-note:https://github.com/cobusgreyling/loop-engineering"
Cohesion: 0.25
...
### Community 938 - "Positional Encoding Internals"
Cohesion: 0.25
...
### Community 943 - "Continual Harness (`agent/harness_spec.py`)"
Cohesion: 0.25
...
### Community 957 - "e2e/conftest.py"
Cohesion: 0.25
Nodes (7): base_url(), mobile_page(), proxy_url(), Config, pytest_configure(), conftest.py — pytest fixtures and configuration for the E2E test suite.…, A browser page pre-configured for mobile viewport (390×844 — iPhone 14).

### Community 959 - "TestItIsNotBuiltForOneVendor"
Cohesion: 0.25
...
### Community 960 - "test_compose_and_coordinate_api.py"
Cohesion: 0.36
...
### Community 961 - "test_daily_automation_2026_07_09.py"
Cohesion: 0.25
...
### Community 963 - "test_local_brain_router_smoke.py"
Cohesion: 0.25
...
### Community 966 - "test_provider_models_db_outage.py"
Cohesion: 0.25
...
### Community 967 - "test_runtimes_health_endpoint.py"
Cohesion: 0.25
...
### Community 968 - "test_seo_audit_pending_expiry.py"
Cohesion: 0.43
...
### Community 970 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.25
...
### Community 1018 - "TestGithubTokenSQLiteRegression"
Cohesion: 0.38
...
### Community 1025 - "InitiativeProgress"
Cohesion: 0.33
...
### Community 1051 - "apply_phase1_changes.py"
Cohesion: 0.33
...
### Community 1065 - "TestCEOAgencySystem"
Cohesion: 0.33
...
### Community 1068 - "TestNoHardcodedModels"
Cohesion: 0.33
...
### Community 1084 - "Agent job lifecycle"
Cohesion: 0.40
...
### Community 1087 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 1088 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 1118 - "worker/index.js"
Cohesion: 0.60
Nodes (4): fetch(), needsProxy(), PROXY_PREFIXES, scheduled()

### Community 1119 - "_clean_phases"
Cohesion: 0.50
...
### Community 1122 - "_scheduler_on_fire"
Cohesion: 0.50
...
### Community 1125 - "risk-reviewer.md"
Cohesion: 0.50
Nodes (3): Output, Rules of evidence, What you weigh

### Community 1126 - "verification-reviewer.md"
Cohesion: 0.50
...
### Community 1134 - "_clean_director"
Cohesion: 0.50
...
### Community 1135 - "stop_colibri_server.ps1"
Cohesion: 0.83
Nodes (3): Fail(), Ok(), W()

### Community 1136 - "test_nim_models.py"
Cohesion: 0.67
...
### Community 1147 - "test_skills_route_order.py"
Cohesion: 0.67
...
### Community 1148 - "github"
Cohesion: 0.50
Nodes (3): github, enabled, silent

### Community 1174 - "test_the_reserve_is_bounded_when_read_from_the_environment"
Cohesion: 0.67
...
- **Why does `_fixture()` connect `_fixture` to `company_api.py`, `test_llm_router_queue_cache.py`, `TaskSpec`, `ImprovementLoop`, `TaskStatus`, `test_llm_router_strategies.py`, `test_model_router.py`, `test_provider_410_per_model.py`, `parse_event_stream`, `Task`, `test_brain_patch_service_token.py`, `PolicyEngine`, `test_gh_brain_failover.py`, `_Recorder`, `config.py`, `TaskWorkflowService`, `services/background.py`, `E2BSandboxSession`, `OperationalIncidentTracker`, `test_llm_router_resilience.py`, `brain_config.py`, `SelfHealingAgent`, `reset_kv_state`, `NotificationDispatcher`, `tasks/models.py`, `test_failover_client_shared.py`, `BrainWatchdog`, `WorkflowRun`, `test_unit8_model_catalog.py`, `AgentSwarm`, `test_company_api.py`, `validate_policy_text`, `get_task_store`, `test_task_pre_execution_gate.py`, `test_telegram_webhook.py`, `AuditLog`, `PrimeAgentAdapter`, `test_sam_livekit.py`, `SeoAuditEngine`, `AgentJobManager`, `ChatHistoryStore`, `test_webui_provider_priority.py`, `KeyStore`, `test_openclaw_endpoints.py`, `ResearchTask`, `_resolve_brain_provider`, `TestClient`, `test_ai_insights.py`, `test_procedural_memory.py`, `test_llm_router_e2e.py`, `claim`, `Agency`, `routed`, `_clean_phases`, `SQLiteStore`, `_resolve_push_token`, `e2e/test_browser.py`, `test_telegram_auto_approve.py`, `test_autonomy_status.py`, `test_local_brain_state.py`, `test_sam_voice.py`, `test_knowledge_sync.py`, `test_phase5_doctor.py`, `test_startup_warmup.py`, `test_refresh_agent_built_proof.py`, `test_tasks_reconciler_todo_requeue.py`, `_clean_director`, `resolve_e2b_config`, `test_response_cache.py`, `BackgroundAgent`, `cost_tracker.py`, `SeoFixer`, `test_context_rulebook.py`, `ArtifactStore`, `run_task`, `UserRole`, `test_trend_scoping.py`, `test_issue_intake.py`, `test_new_features_e2e.py`, `_step`, `test_trend_watcher.py`, `TestHarnessAdapter`, `MCPClient`, `test_ceo_router.py`, `persist_plan_spec`, `TestEstimateTokensForMessages`, `test_brain_failover_413.py`, `ai/router.py`, `test_openclaw_gateway.py`, `test_daily_2026_07_27.py`, `CEOLedger`, `OllamaCircuitBreaker`, `_job_text`, `_Budget`, `test_portfolio_intake.py`, `test_features_api.py`, `test_video_transcript.py`, `test_e2b_data_flow.py`, `TrendWatcher`, `emit_chat_observation`, `clear_cooldowns`, `SchedulerStore`, `test_agent_tool_governance.py`, `test_process_quick_note_workflow.py`, `timedelta`, `TestRuntimeControl`, `test_llm_router_disabled.py`, `OrchestratorQueue`, `test_agile_api.py`, `test_app_settings.py`, `TestClient`, `TestAuthAndTaskCreation`, `TestAuthAndTaskOwnership`, `test_task_clarification.py`, `ContextPruner`, `test_control_plane_api.py`, `test_persistent_memory.py`, `SecurityScanner`, `api_keys_for`, `capture_screens.py`, `OutputFilter`, `test_platform_controls.py`, `_resolve_user_github_token`, `OrchestratorCheckpointStore`, `test_nvidia_model_discovery.py`, `test_catalogue_probe.py`, `test_rate_limiter.py`, `TestMongoGate`, `_Recorder`, `analyze_page`, `test_scheduler_hydration_bounded.py`, `test_regression.py`, `test_agent_scripts_share_one_model_list.py`, `test_crispy_burn_in.py`, `test_provider_enable_disable.py`, `TestSwarmRoleRouting`, `test_skill_registry_boot_refresh.py`, `tests/conftest.py`, `model_discovery.py`, `isolated_telegram_config`, `platform_controls_router.py`, `_undeclared`, `test_direct_chat_evolution.py`, `test_service_token.py`, `test_harness_spec.py`, `test_agency_fix.py`, `test_monitor_lib.py`, `e2e/conftest.py`, `TestTheWorkflowIsSafeAndReadOnly`, `test_v4_api.py`, `test_daily_automation_2026_07_09.py`, `test_ping.py`, `test_runtimes_health_endpoint.py`, `test_task_store_fails_loud_in_production.py`, `test_telegram_diag_endpoint.py`, `test_dashboard_cache.py`, `TestNormalizeResponseFormat`, `test_provider_state_durability.py`, `test_langfuse_agency_wide.py`, `test_kimi_bridge_server.py`, `client`, `test_doctor_coding_brain.py`, `TestFeaturesAPI`, `test_voice_pipeline.py`?**
  _High betweenness centrality (0.107) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `AdaptiveHalter`, `ContextPruner`, `backend/server.py`, `TaskSpec`, `proxy.py`, `E2BAdapter`, `workflow_orchestrator.py`, `PolicyEngine`, `ReactScratchpad`, `test_backend_server_features.py`, `E2BSandboxSession`, `test_failover_client_shared.py`, `test_empirical_verify.py`, `MCPClient`, `MultiAgentSwarm`, `ContextManager`, `WorkflowRun`, `TestAgentRunnerExecution`, `test_brain_failover_413.py`, `AgentJobManager`, `FreeBuffAgent`, `StuckDetector`, `test_agent_runner.py`, `test_daily_automation_2026_07_09.py`, `WorkspaceTools`, `test_daily_automation_2026_07_11.py`, `InternalAgentAdapter`, `TestAgentLoopMCPIntegration`, `build_matrix`, `loop.py`, `CEODispatcher`, `direct_chat.py`, `test_autonomous_agency_e2e.py`, `test_agent_tool_governance.py`, `LocalWorkspace`, `TokenBudget`, `_resolve_push_token`, `UserMemoryStore`, `test_agent_free_brain.py`, `test_governance_api.py`, `BackgroundAgent`, `AgentSessionStore`, `GitHubTools`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderRouter` to `backend/server.py`, `test_provider_410_per_model.py`, `test_bedrock_provider.py`, `test_all_providers_discovery.py`, `test_bedrock_live.py`, `ai/router.py`, `ProviderConfig`, `implement_agent.py`, `NvidiaProvider`, `kimi_bridge_provider_config`, `test_colibri_brain_shim.py`, `TestLegacyRouterCacheTTL`, `test_anthropic_refusal_fallback.py`, `direct_chat.py`, `TestRouterIntegration`, `clear_cooldowns`, `failover_client.py`, `TestLegacyRouterServerFallback`, `TrafficDirector`, `_payload`, `is_anthropic_base_url`, `TestAnthropicPayloadStructuredOutput`?**
