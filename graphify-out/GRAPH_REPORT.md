...
## Corpus Check
- 1423 files · ~2,042,057 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 28362 nodes · 57939 edges · 1190 communities (1063 shown, 127 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 6298 edges (avg confidence: 0.54)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `633a1990`
...
- config/__init__.py
- .replay
- .test_uncited_entry_is_never_injected
- test_session_reused
...
## Communities (1190 total, 127 thin omitted)

### Community 0 - "backend/server.py"
Cohesion: 0.02
Nodes (242): admin_seed(), auth_me(), auto_recommend_skills(), _build_agent_status_snapshot(), _build_agent_stream_event(), _build_auto_skill_guidance(), cancel_chat_agent_job(), _classify_complexity() (+234 more)

### Community 1 - "ProviderConfig"
Cohesion: 0.04
Nodes (83): _acquire_provider_probe(), extract_openai_text(), _get_director(), is_commercial_provider(), _normalize_nvidia_base_url(), _normalized_provider_type(), provider_access_tier(), _provider_field() (+75 more)
...
Cohesion: 0.02
Nodes (184): Any, Return recent commits with agent attribution trailers parsed out., free_nvidia_models(), Return the curated list of free NVIDIA NIM models FreeBuff may use., True when *model* is in the curated free NVIDIA NIM set., get_sam(), agent/sam.py — SAM Voice Agent (System Autonomy Manager) SAM is the voice-…, get_skill_registry_safe() (+176 more)

### Community 4 - "test_ceo_dispatcher.py"
Cohesion: 0.05
Nodes (81): CEOResult, _merge_changed_files(), Aggregated output from a multi-specialist execution., Collect changed_files across all specialists into a single de-duped list., ClassifyOutput, get_ceo_fallback_stats(), PlanOutput, CLASSIFY phase: domain and task type determination. (+73 more)

### Community 5 - "._connect"
Cohesion: 0.11
...
### Community 6 - "test_brain_failover.py"
Cohesion: 0.05
Nodes (50): _disabled_ids(), Reset every circuit breaker when they have all tripped, and re-select. Without…, The operator kill-switch set, or empty when it cannot be read., _recover_all_unhealthy(), BrainFailoverManager, Any, Permit one probe call without claiming the provider succeeded. This is the…, Seconds until the soonest cooling provider is probeable again. ``None`` when no… (+42 more)

### Community 7 - "SpecialistService"
Cohesion: 0.04
Nodes (51): build_matrix(), _families(), main(), Any, Map family -> sorted list of test files that mention it (quoted token)., Return one row per family, derived entirely from code., render_markdown(), _test_evidence_index() (+43 more)

### Community 8 - "AgentSessionStore"
Cohesion: 0.04
Nodes (178): Agency, get_agency(), CEO-coordinated multi-agent agency for continuous codebase management. The CEO…, set_agency(), AgentJobRequest, AgentJobSnapshot, BaseModel, Complete point-in-time view of a job, safe to serialise as API response. (+170 more)

### Community 9 - "llm/router.py"
Cohesion: 0.03
Nodes (99): Attempt, _load(), main(), int, Whether to delegate to ``packages.llm.router.LLMRouter`` (ADR-008 §8). Read on…, _router_enabled(), text_key(), failover_chat_completion_via_router() (+91 more)

### Community 10 - "JCodeAdapter"
Cohesion: 0.03
Nodes (47): AiderAdapter, Any, Adapter for Aider — TIER 3 specialized git-aware code editor., GooseAdapter, Any, Adapter for Goose — TIER 2 general-purpose local runtime., JCodeAdapter, Path (+39 more)

### Community 11 - "_decompose_into_subtasks"
Cohesion: 0.33
...
### Community 14 - "test_colibri_brain_shim.py"
Cohesion: 0.06
...
Cohesion: 0.03
Nodes (134): ephemeral_ttl_hours(), Async read of the ephemeral TTL (hours) straight from the DB., account_lifecycle(), auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint(), generate_onboarding_questions() (+126 more)
...
### Community 19 - "api.js"
Cohesion: 0.02
Nodes (51): approveGovernanceRequest(), approveTaskCheckpoint(), approveTaskExecution(), autoRecommendCompanySkills(), createMcpServer(), createQuickNote(), createSprint(), createTask() (+43 more)

### Community 20 - "OrchestratorQueue"
Cohesion: 0.08
...
### Community 25 - "test_telegram_approval_gate.py"
Cohesion: 0.06
Nodes (32): Path, service_manager.py — Telegram & Notification Integration Extension Extends the…, Signal the bot to stop and wait for graceful shutdown., Run the Telegram bot long-poll loop (inline, not subprocess)., Run the bot with stop-event awareness., True when outbound Telegram sends must be suppressed. Tests must never page a…, # NOTE: do NOT re-escape here — services.daily_digest.format_digest_markdown, Manages the Telegram bot as a managed service alongside ollama/proxy/tunnel.… (+24 more)

### Community 26 - "SQLiteStore"
Cohesion: 0.02
Nodes (77): Delete a company and all its associated data., Delete a company and all associated data from SQLite., Count total companies in SQLite., Reconstruct a Website from a SQLite row, preferring the full JSON blob (which…, Create a new website in SQLite. The full model is stored in ``data`` so scan…, Get a website by ID from SQLite., Update a website in SQLite. When ``company_id`` is omitted the existing company…, Count total companies in the store. (+69 more)
...
Cohesion: 0.04
Nodes (81): _apply_env_overrides(), _apply_key_env(), _build(), _coerce(), config_dir(), _env_key_names(), expand_env(), _fields_of() (+73 more)
...
### Community 33 - "Task"
Cohesion: 0.05
Nodes (58): Full task/issue document., Task, PUBLIC_URL-anchored dashboard deep link for the task detail. Returns empty…, Best-effort Telegram heads-up that a task is parked awaiting approval. Inline…, _coordinator(), asyncio, BaseException, Brain-availability preflight tests (graceful degradation). When NO LLM brain is… (+50 more)

### Community 34 - "get_runtime_manager"
Cohesion: 0.05
...
Cohesion: 0.03
Nodes (91): Call-time resolver for an agent role model id. Delegates to…, _resolve_role_model(), BrainConfig, BrainConfigStore, default_brain_config(), get_brain_config(), get_brain_config_store(), invalidate_brain_config_cache() (+83 more)
...
### Community 40 - "BackgroundAgent"
Cohesion: 0.03
Nodes (97): Browser admin UI for login, service control, key management, and diagnostics., Update or append a KEY=value line in the .env file., register_admin_gui(), _save_env_var(), BackgroundAgent, BackgroundTask, _now(), Any (+89 more)

### Community 41 - "test_portfolio_intake.py"
Cohesion: 0.09
...
Cohesion: 0.01
Nodes (213): AgentDirective, get_tool_registry(), Return the module-level ToolRegistry singleton. On first call, registers built-…, agent/harness_enrichment.py — Automatic Harness Enrichment for Agent Prompts…, Agent subsystem — planner / executor / verifier loop., AgentPhaseError, AgentRunner, _check_extra_kwargs() (+205 more)
...
Cohesion: 0.04
Nodes (94): classify_task(), _extract_recent_text(), Any, Task classification from request context. Classifies an incoming request into a…, Concatenate plain text from the last *last_n* messages., Return the most likely task category for this request. Args: messages: OpenAI-…, Dynamic model router. Central routing logic for all chat and agent requests.…, get_registry() (+86 more)

### Community 47 - "MCPUnavailableError"
Cohesion: 0.03
...
### Community 50 - "CEOSupervisor"
Cohesion: 0.06
Nodes (36): get_ceo_dispatcher(), Return the shared CEODispatcher singleton., Reset the singleton (test helper)., reset_ceo_dispatcher(), get_ceo_ledger(), Return the shared :class:`CEOLedger`, constructing it on first use., CEOSupervisor, _env_int() (+28 more)

### Community 51 - "test_operational_incidents.py"
Cohesion: 0.05
...
Cohesion: 0.06
Nodes (47): get_self_healing_agent(), HealingEvent, _now(), Any, agent/self_healing.py — Self-Healing Agent (closed-loop, Autonomy Charter G2)…, Translate external failure signals into improvement tasks and verify the fix…, Launch the background sweeper that resolves quiet verifying heals., Called when a CI workflow fails. (+39 more)

### Community 53 - "report_to_markdown"
Cohesion: 0.11
...
Cohesion: 0.04
Nodes (90): Any, Translate technical preflight issues into a conversational assistant reply., translate_error_to_conversational(), classify_direct_chat_intent(), _contains_keyword(), detect_intent(), intent.py — Intent classification for direct chat (answer_only, execute_now,…, Return True if content contains any execution or analysis keyword. (+82 more)
...
### Community 64 - "_try_provider"
Cohesion: 0.06
Nodes (29): _auto_disable(), _Budget, _build_request(), _is_billing_refusal(), _is_ollama(), _key_pool(), _parse_success(), Any (+21 more)
...
### Community 71 - "WorkspaceManager"
Cohesion: 0.11
Nodes (17): _get_workspace_lock(), get_workspace_manager(), _load_workspace(), Path, Resolve *relative* inside source dir and reject traversal/symlink escapes., Create, open, and lifecycle-manage per-job isolated workspaces. All workspaces…, Open an existing workspace from disk. Raises :exc:`WorkspaceNotFoundError` if…, Raise :exc:`WorkspaceAccessDeniedError` if *requesting_session_id* doesn't own… (+9 more)
...
### Community 76 - "test_governance_sandbox.py"
Cohesion: 0.04
...
Cohesion: 0.06
Nodes (39): Initiative, _bug_scores(), _clean(), _default_repo(), _env_github_token(), estimate_job_size(), fetch_github_signals(), initiatives_from_bug_log() (+31 more)

### Community 80 - "GovernanceGate"
Cohesion: 0.04
Nodes (69): build_governance_router(), Any, APIRouter, backend/governance_router.py — read and operate the governance layer. Mounted…, Reject non-admin callers. Mirrors the RBAC check used elsewhere in this backend…, _require_admin(), _load(), Import the governance layer once, recording why if it is absent. (+61 more)

### Community 81 - "ChatPage.js"
Cohesion: 0.07
Nodes (44): cancelAgentChatJob(), chatSend(), deleteSession(), getAgentChatJob(), getSession(), listProviderModels(), listSessions(), resumeAgentChatJob() (+36 more)

### Community 82 - "TestPayloadNormalisation"
Cohesion: 0.06
...
Cohesion: 0.14
Nodes (16): asyncio, tests/test_sam_voice.py — Integration tests for SAM voice agent. Tests the SAM…, SAM's system prompt must address the user as Commander., _build_context must return a dict with expected keys., A hung LLM call must not block SAM — it must time out and fall back., A stalled context read must not block process_command indefinitely., get_sam() must return the same instance., get_status() must return uptime and session count. (+8 more)
...
Cohesion: 0.05
Nodes (58): quick_notes_submit(), Submit a quick-note URL or instruction from the dashboard FAB., Reset the singleton (for tests)., reset_failover_manager(), _heal_brain_failover(), _heal_stuck_tasks(), _heal_task_duplicates(), _heal_telegram() (+50 more)
...
### Community 89 - "workflow_orchestrator.py"
Cohesion: 0.06
Nodes (78): CoordinateRequestV2, CoordinateResponse, BaseModel, agent/coordinate.py — Multi-Agent Coordination models, helpers, and optional…, Extended coordinate request supporting both agents+tasks and legacy workers., SwarmSummary, AgentSpec, CoordinatorResult (+70 more)
...
### Community 96 - "App.js"
Cohesion: 0.05
Nodes (36): completeSetup(), createSecret(), detectHardwareForSetup(), detectModelsForSetup(), getDefaultBackendUrl(), getMe(), getPublicPath(), getSetupState() (+28 more)
...
Cohesion: 0.04
Nodes (43): getAccountLifecycle(), AppShell(), MOBILE_MORE, MOBILE_PRIMARY, MobileBottomNav(), MobileMoreSheet(), NAV_ITEMS, ActivationGate() (+35 more)

### Community 102 - "HermesAdapter"
Cohesion: 0.03
...
Cohesion: 0.05
Nodes (37): _infer_parameters_from_func(), Any, Register a tool definition., Decorator to register a function as an agent tool. Usage::…, Remove a tool from the registry. Returns True if removed., Look up a tool by name., Return all registered tools., Find tools that advertise a specific capability. (+29 more)

### Community 110 - "services/background.py"
Cohesion: 0.07
Nodes (41): get_improvement_loop(), get_log_monitor(), Any, Public snapshot of live agency state (used by the LiveKit worker tools)., Gather live agency state for SAM's situational awareness., get_trend_watcher(), _await_hermes_ready(), BackgroundServices (+33 more)
...
### Community 114 - "Usage"
Cohesion: 0.04
Nodes (67): AnthropicProvider, Any, AsyncClient, packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, Translate OpenAI-shaped messages into Anthropic's system/turn split., OpenAI carries a tool result as role="tool" with a tool_call_id; Anthropic…, OpenAI puts a tool call alongside the assistant's text; Anthropic needs…, Anthropic's extended-thinking constraints on ``budget_tokens``: at least 1024,… (+59 more)
...
### Community 119 - ".update_intelligence"
Cohesion: 0.08
...
Cohesion: 0.03
Nodes (86): Status of a user story within a sprint., StoryStatus, HarnessAdapter, HarnessSpec, Any, agents/harness_adapter.py — ECC Cross-Harness Adapter Normalises API…, Adapt harness-native requests to the local-llm-server internal format. Each…, Detect which harness sent this request from headers. Check order: explicit… (+78 more)
...
Cohesion: 0.05
Nodes (39): Any, packages/ai/self_heal.py — automatic brain self-healing. When the active brain…, Background tick that runs self_heal_brain_and_unblock_tasks(). Called from the…, One-shot self-healing pass. 1. Checks if the active brain provider is in a…, self_heal_brain_and_unblock_tasks(), _self_heal_tick(), BrainWatchdog, get_watchdog() (+31 more)
...
### Community 128 - "TaskStore"
Cohesion: 0.04
Nodes (82): Set the global agent store instance (e.g., with MongoDB on startup)., set_agent_store(), _is_brain_connection_error(), Any, BaseException, Task, TaskResult, TaskSpec (+74 more)
...
### Community 133 - "resolve_active_brain"
Cohesion: 0.06
Nodes (60): allow_paid_brain(), BrainResolution, provider_api_key(), Return the live API key for *provider* (env-only — never persisted)., get_active_brain_sync(), get_brain_preference(), get_provider_role_tags(), _host_is_openai_compatible() (+52 more)

### Community 134 - "_start_ceo_agency"
Cohesion: 0.31
...
### Community 135 - "PrimeAgentAdapter"
Cohesion: 0.04
...
Cohesion: 0.04
Nodes (43): createProvider(), deleteProvider(), getBrainConfig(), getBrainProviders(), getLocalBrainState(), getProviderPolicy(), patchBrainConfig(), postLocalBrainToggle() (+35 more)
...
### Community 146 - "agents/agile_ceremonies.py"
Cohesion: 0.08
...
### Community 147 - "tasks/service.py"
Cohesion: 0.04
Nodes (70): Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., tasks — Task/issue management system. Provides a lightweight task/issue tracker…, ApprovalCheckpoint, Enum, str, tasks/models.py — Pydantic models for the task/issue system., Comment or reply on a task. (+62 more)

### Community 148 - "test_llm_router_queue_cache.py"
Cohesion: 0.02
Nodes (112): Test hook — clear all usage accounting., reset(), CacheManager, cosine_similarity(), _Entry, get_cache(), LRUCache, payload_key() (+104 more)
...
### Community 153 - "_fixture"
Cohesion: 0.01
Nodes (157): parse_event_stream(), ParsedRun, Structured view of one ``--mode json`` event stream., Reduce a ``--mode json`` NDJSON stream to a :class:`ParsedRun`. Kept a module-…, Drop the cached Mongo client, backoff, and read caches (tests)., reset_kv_state(), _clear_discovered_models(), _clear_response_cache() (+149 more)
...
Cohesion: 0.03
Nodes (64): __init__.py — Feature flag/matrix package., FeatureEntry, FeatureMatrix, FeatureMaturity, get_feature_matrix(), Any, BaseModel, Enum (+56 more)

### Community 165 - "DashboardLayout.js"
Cohesion: 0.06
Nodes (44): createAgent(), deleteAgent(), deleteModel(), getRoutingPolicy(), listModels(), pullModel(), refreshRuntimeHealth(), runTaskOnRuntime() (+36 more)

### Community 166 - "test_ceo_supervision.py"
Cohesion: 0.07
...
### Community 181 - "resolve_identity"
Cohesion: 0.04
...
### Community 185 - "ProceduralMemoryStore"
Cohesion: 0.05
...
### Community 186 - "resolve_free_nvidia_brain"
Cohesion: 0.13
...
### Community 188 - "WebsiteScanner"
Cohesion: 0.02
Nodes (118): DetectedSystem, Evidence, Evidence supporting a system detection., A business system detected on a company's website or in their stack., Get the most confident evidence description., main(), Returns (url, ok, summary)., _scan_one() (+110 more)
...
### Community 198 - "test_mcp_registry.py"
Cohesion: 0.05
...
### Community 201 - "test_unit7_catalog_propagation.py"
Cohesion: 0.07
...
### Community 205 - "llm_providers.py"
Cohesion: 0.15
...
### Community 212 - "tests/test_browser.py"
Cohesion: 0.10
...
### Community 213 - "test_ceo_router.py"
Cohesion: 0.11
Nodes (32): build_ceo_router(), Any, APIRouter, backend/ceo_router.py — observability and manual control for the CEO. Surfaces…, Reject non-admin callers for routes that spend provider budget. Delegates to…, _require_admin(), _env_flag(), True when the 24x7 supervisor should run in this process. Off under ``TESTING``… (+24 more)
...
### Community 225 - "test_governance_api.py"
Cohesion: 0.07
...
### Community 229 - "test_phase4_runtime_resilience.py"
Cohesion: 0.11
...
Cohesion: 0.07
Nodes (28): WorkflowEngine, Contract: WorkflowEngine cannot skip the gate state machine., Create a run and manually place it in awaiting_approval., Contract: Cannot approve a run in 'pending' state., Contract: Can approve a run in 'awaiting_approval' state., Contract: Rejecting a run marks it as failed., _make_engine(), _make_run() (+20 more)

### Community 238 - ".compress"
Cohesion: 0.22
...
### Community 240 - "test_llm_router_gateway.py"
Cohesion: 0.07
Nodes (23): gateway_enabled(), Whether the OpenAI-compatible passthrough routes accept traffic. Off by…, build_llm_router(), APIRouter, Build the ``/api/llm`` router. ``get_current_user`` is the platform's auth…, get_tracker(), The process-wide health tracker., get_metrics() (+15 more)

### Community 241 - "Agent Readiness Report"
Cohesion: 0.20
...
### Community 249 - "chat_send"
Cohesion: 0.08
Nodes (33): _agent_timeout_fallback_response(), _build_provider_router(), _builtin_provider_records(), call_llm(), _chat_error_detail_text(), _chat_provider_policy(), chat_send(), _check_storage_health() (+25 more)
...
### Community 259 - "operational_incidents.py"
Cohesion: 0.11
...
### Community 267 - "get_failover_manager"
Cohesion: 0.07
...
### Community 273 - "RenderFinding"
Cohesion: 0.06
Nodes (39): IssueCategory, IssueSeverity, Enum, str, _file_issue(), _latest_metric_value(), _note_recurrence(), _parse_timestamp() (+31 more)
...
### Community 276 - "kimi_bridge_provider_config"
Cohesion: 0.18
...
### Community 277 - "TestStreamableHTTPTransport"
Cohesion: 0.13
...
### Community 279 - "TestCircuitState"
Cohesion: 0.21
...
### Community 283 - "ProviderCircuit"
Cohesion: 0.03
Nodes (66): _deep_merge(), get_guardrails(), GuardrailEngine, GuardResult, Any, Configurable safety rail engine for LLM inputs and outputs. Supports: -…, Check user input against input safety rules. Returns a GuardResult with…, Check model output against output safety rules. Returns a GuardResult with… (+58 more)
...
### Community 290 - "test_render_mcp.py"
Cohesion: 0.08
...
### Community 293 - "test_platform_controls.py"
Cohesion: 0.08
...
### Community 300 - "test_e2b_task_wiring.py"
Cohesion: 0.08
...
### Community 305 - "ExecutionRequest"
Cohesion: 0.05
...
### Community 307 - "test_telegram_auto_approve.py"
Cohesion: 0.21
...
### Community 314 - "WorkspaceError"
Cohesion: 0.11
Nodes (12): Any, Exception, Lock, Open a workspace for resumption. Only READY or PAUSED workspaces may be…, Base class for all workspace errors., _read_manifest(), WorkspaceAccessDeniedError, WorkspaceError (+4 more)
...
### Community 326 - "platform_controls_router.py"
Cohesion: 0.11
...
### Community 327 - "PortfolioIntelligence"
Cohesion: 0.09
...
### Community 350 - "ClaudeCodeAdapter"
Cohesion: 0.14
...
### Community 351 - "verify_service_token"
Cohesion: 0.19
...
### Community 360 - "control_overrides.py"
Cohesion: 0.12
...
### Community 362 - "compare_runtimes.py"
Cohesion: 0.07
...
### Community 375 - "test_runtime_governance.py"
Cohesion: 0.05
Nodes (69): governance_enabled(), True when the governance layer should run at all. A single global off switch…, Return the last-known health for *runtime_id* (may be stale)., Return True if the runtime is available (not circuit-open)., Return health snapshots for all known runtimes., Force an immediate health check of all runtimes and return results., Async health polling service for all registered runtimes., Start the background polling loop with an immediate initial check. (+61 more)

### Community 376 - ".start_onboarding"
Cohesion: 0.11
...
Cohesion: 0.13
Nodes (10): HarnessEnrichment, invalidate_enrichment_cache(), Any, Build a compact catalog of available runtime skills. Discovers from…, Standing instructions from the Continual Harness spec. Deliberately uncached:…, Build the complete enrichment block (tools + skills). Returns empty string when…, Inject enrichment blocks into a system prompt string. Appends blocks after the…, Auto-discovers skills and tools for agent prompt injection. Usage:: enrichment… (+2 more)
...
### Community 387 - "PerformanceAnalytics"
Cohesion: 0.14
...
### Community 390 - "agent/workspace.py"
Cohesion: 0.15
Nodes (15): _hash_component(), _iso_now(), _iso_offset_hours(), _parse_iso(), BaseModel, Enum, str, agent/workspace.py — Isolated workspace lifecycle management. Every agent… (+7 more)

### Community 391 - "trend_analysis.py"
Cohesion: 0.19
...
### Community 397 - "router/health.py"
Cohesion: 0.20
...
### Community 409 - "open_phase_report"
Cohesion: 0.14
...
### Community 423 - "configuration-reference.md"
Cohesion: 0.06
Nodes (22): Architecture and operations, Documentation map, Repo hygiene, Screenshots and README sync, Start here, Configuration, Continual Harness (`agent/harness_spec.py`), Flow (+14 more)
...
### Community 430 - "test_schedule_backlog_drain.py"
Cohesion: 0.11
...
### Community 431 - "TestBrainFailoverModelUpdates"
Cohesion: 0.12
...
### Community 433 - "RepowiseIntelligence"
Cohesion: 0.09
...
### Community 448 - "test_agent_tool_governance.py"
Cohesion: 0.08
Nodes (48): Replace the process-wide audit log. Tests only., reset_audit_log(), Replace the process-wide engine. Tests only., reset_policy_engine(), _drive(), _enforce(), governance_on(), isolated_governance() (+40 more)
...
### Community 452 - "NotificationDispatcher"
Cohesion: 0.04
Nodes (66): AgentRole, str, ChatSendRequest, Send chat message request., NotificationDispatcher, Any, Start the Telegram bot. Returns True if started successfully., Routes background task results to configured notification channels. Currently… (+58 more)
...
### Community 454 - "TestSelfHealingInfrastructureClassification"
Cohesion: 0.19
...
### Community 455 - "sam_livekit_worker.py"
Cohesion: 0.17
...
### Community 458 - "rate_limiter.py"
Cohesion: 0.15
Nodes (10): get_tracker(), _ProviderQuota, Response, Proactive rate-limit throttling for LLM providers — two complementary layers.…, Parse x-ratelimit-* headers and update per-provider quota state. Safe to call…, Reset all state (primarily for tests)., Return the process-singleton RateLimitTracker., Clear all token-bucket state (tests only). Does not touch the header tracker's… (+2 more)
...
### Community 464 - "_get_provider_policy"
Cohesion: 0.06
...
### Community 471 - "control_registry.py"
Cohesion: 0.14
...
### Community 472 - "_is_bedrock_model_id"
Cohesion: 0.27
...
### Community 476 - "test_langfuse_agency_wide.py"
Cohesion: 0.14
...
### Community 478 - "tests/conftest.py"
Cohesion: 0.08
...
### Community 482 - "CircuitState"
Cohesion: 0.11
Nodes (18): ProviderHealth, Circuit-breaker state for a provider., CircuitState, anyio, parametrize, Regression guard: a rate-limit cooldown must survive, on every route.…, The anti-wedge valve must not fire for an ordinary 429 backoff — otherwise it…, The threshold must clear the widest backoff ANY registered provider can earn.… (+10 more)
...
### Community 486 - "TestChatHistoryStore"
Cohesion: 0.07
...
### Community 495 - "test_self_heal.py"
Cohesion: 0.11
...
### Community 504 - "test_mcp_governance.py"
Cohesion: 0.12
...
### Community 506 - "test_brain_availability_doctor.py"
Cohesion: 0.11
...
### Community 516 - "SpecEntry"
Cohesion: 0.12
Nodes (22): build_block(), _flag(), _int_env(), Path, agent/harness_spec.py — the Continual Harness: a persistent, cited spec.…, Absolute path of the harness spec for a workspace., Parse existing entries. Never raises — a broken file yields no entries. With…, Rewrite the spec file, preserving any non-entry (hand-written) lines. (+14 more)

### Community 517 - "test_event_log.py"
Cohesion: 0.45
...
### Community 519 - "_ensure_tasks_source_id_unique_index"
Cohesion: 0.26
...
### Community 520 - "test_scheduler_hydration_bounded.py"
Cohesion: 0.09
...
### Community 536 - "FeatureUnavailableError"
Cohesion: 0.06
Nodes (37): PreflightIssue, PreflightReport, BaseModel, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, AgentJob, make_isolated_workspace(), _now(), Any (+29 more)

### Community 537 - "RuntimeManager"
Cohesion: 0.04
Nodes (32): DockerAgentAdapter, Any, TaskResult, TaskSpec, Adapter that runs agent tasks inside isolated Docker containers., Check whether Docker is available and report the adapter's runtime health.…, _build_default_manager(), Any (+24 more)
...
### Community 548 - "local_brain_provider_config"
Cohesion: 0.29
...
### Community 574 - "test_ai_insights.py"
Cohesion: 0.29
...
### Community 582 - "test_daily_automation_2026_08_03.py"
Cohesion: 0.11
...
### Community 585 - "_valid_login_state"
Cohesion: 0.24
...
### Community 587 - "OrchestratorCheckpointStore"
Cohesion: 0.09
...
### Community 613 - "Agent Governance Guide"
Cohesion: 0.09
...
### Community 625 - "redact_connection_url"
Cohesion: 0.17
...
### Community 644 - "CLAUDE.md — Master Architect Operating Manual"
Cohesion: 0.03
...
### Community 659 - "4. Troubleshooting"
Cohesion: 0.10
...
### Community 660 - "Docker AI Governance Audit — Final Report"
Cohesion: 0.10
...
### Community 661 - "1. Capability-by-capability"
Cohesion: 0.10
...
### Community 699 - "FreeBuffAgent"
Cohesion: 0.05
Nodes (142): BrowserSession, Async Playwright browser session. Usage:: session = BrowserSession() await…, True if Playwright is installed and ready to use., CommitAttribution, CommitTracker, Path, agent/commit_tracker.py — AI Commit Attribution Tags git commits with metadata…, Create git commits enriched with agent-session attribution trailers. Usage::… (+134 more)
...
### Community 708 - "_looks_unknown_model"
Cohesion: 0.20
...
### Community 733 - "GovernanceScreen.jsx"
Cohesion: 0.20
...
### Community 738 - "TestRequireAdmin"
Cohesion: 0.33
...
### Community 764 - "failover_client.py"
Cohesion: 0.06
Nodes (38): _describe_registry(), _log_exhaustion(), _paid_reserve(), packages/ai/failover_client.py — one dispatcher for the brain-failover chain.…, Read BRAIN_PAID_RESERVE_ATTEMPTS, clamped to a range that cannot starve. ``0``…, Explain a zero-attempt outcome, from the module that owns provider state. "no…, The one and only error-level log in the dispatch path. Emitted solely when the…, cached_models() (+30 more)
...
### Community 767 - "ControlsScreen.jsx"
Cohesion: 0.16
...
### Community 774 - "DailyDigestAggregatorTests"
Cohesion: 0.19
...
### Community 775 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 779 - "get_livekit_config"
Cohesion: 0.18
...
### Community 847 - "test_governance_enforcement.py"
Cohesion: 0.03
Nodes (86): Event, publish(), packages/events/bus.py — In-process event bus. Loosely couples components via…, An event published on the bus., Subscribe to an event type., Publish an event to all subscribers., subscribe(), ApprovalRequest (+78 more)
...
### Community 855 - "test_tasks_awaiting_approval_api.py"
Cohesion: 0.40
...
### Community 858 - "._run_git_command"
Cohesion: 0.20
...
### Community 859 - "TestNormalizeToolChoice"
Cohesion: 0.31
...
### Community 860 - "check_container_posture.py"
Cohesion: 0.26
...
### Community 862 - "TestProvidersScreen"
Cohesion: 0.43
...
### Community 864 - "TestExtendedThinkingRouting"
Cohesion: 0.20
...
### Community 892 - "Platform Controls"
Cohesion: 0.22
...
### Community 895 - "cleanup_stale_jobs"
Cohesion: 0.31
...
### Community 899 - "TestGithubSignalHardening"
Cohesion: 0.22
...
### Community 902 - "_build_direct_chat_schedule_suggestion"
Cohesion: 0.32
...
### Community 905 - "openclaw_mobile_ui"
Cohesion: 0.33
...
### Community 906 - "The full agent capability roster"
Cohesion: 0.33
...
### Community 910 - "webui/commands.py"
Cohesion: 0.47
Nodes (5): Any, Path, run_command(), _safe_allowlist(), validate_command()

### Community 911 - "Prime Agent Runtime"
Cohesion: 0.25
...
### Community 912 - "TestParseToolCalls"
Cohesion: 0.39
...
### Community 913 - "Agent Autonomy Roadmap"
Cohesion: 0.25
...
### Community 934 - "test_agent_tools.py"
Cohesion: 0.43
...
### Community 937 - "start_in_process"
Cohesion: 0.25
...
### Community 953 - "_FakePersistence"
Cohesion: 0.25
...
### Community 970 - ".discover_directory"
Cohesion: 0.29
...
### Community 971 - "Workspace Issues"
Cohesion: 0.29
...
### Community 980 - "ToolCallViewer.jsx"
Cohesion: 0.33
...
### Community 992 - "OrchestratorSupervisor"
Cohesion: 0.11
...
### Community 998 - "_brain_provider_status"
Cohesion: 0.33
...
### Community 999 - "test_harness_spec.py"
Cohesion: 0.13
Nodes (12): get_enrichment(), Return the enrichment instance for a workspace. Keyed by workspace root rather…, tests/test_harness_spec.py — the Continual Harness spec. Covers the property…, refine() cannot cite what the store does not return., A single global instance would serve one workspace's spec to all of them., A known signature must not license arbitrary text., The attack the signature check alone did not stop. A workspace with a…, Treat every citation in the spec file as recorded. These tests cover block… (+4 more)
...
### Community 1009 - "governance/__init__.py"
Cohesion: 0.40
Nodes (3): __getattr__(), Any, packages/governance — agent identity, policy, approvals, audit, sandboxes. The…

### Community 1010 - "CEODispatcher"
Cohesion: 0.07
Nodes (38): CEODispatcher, _offload(), Any, Semaphore, Run a synchronous ledger call without blocking the event loop. ``CEOLedger`` is…, Build an agent.coordinator.TaskSpec from a CEO SpecialistTask., Build a single-task sub-task list (low-complexity fast path)., Real CEO delegation: wake runtimes, fan out, and merge results. (+30 more)
...
### Community 1022 - "ProviderManager"
Cohesion: 0.17
...
### Community 1024 - "_resolve_default_executor_model"
Cohesion: 0.50
...
### Community 1029 - "_normalize_dockerfile"
Cohesion: 0.33
...
### Community 1032 - "Agent API Issues"
Cohesion: 0.40
...
### Community 1033 - "Network and Tunnel Issues"
Cohesion: 0.40
...
### Community 1074 - "Claude Code Specific Issues"
Cohesion: 0.50
...
### Community 1116 - "test_skills_route_order.py"
Cohesion: 0.67
...
### Community 1125 - "test_the_reserve_is_bounded_when_read_from_the_environment"
Cohesion: 0.67
...
### Community 1126 - "test_mint_token_rejects_missing_args"
Cohesion: 0.67
Nodes (3): parametrize, Empty key/secret/identity/room must raise ValueError., test_mint_token_rejects_missing_args()

## Knowledge Gaps
- **3504 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3499 more)
...
- **Why does `_fixture()` connect `_fixture` to `ProviderConfig`, `test_brain_failover.py`, `test_scheduler_hydration_bounded.py`, `llm/router.py`, `test_llm_router_strategies.py`, `test_llm_router_tpm.py`, `SeoAuditRequest`, `OrchestratorQueue`, `FeatureUnavailableError`, `ai/router.py`, `SQLiteStore`, `test_telegram_approval_gate.py`, `config.py`, `test_unit8_model_catalog.py`, `test_llm_router_resilience.py`, `Task`, `test_openclaw_gateway.py`, `_enable_filter`, `KeyPool`, `_clean_phases`, `BackgroundAgent`, `test_portfolio_intake.py`, `failover_chat_completion`, `SecretRecord`, `AgentRunner`, `test_sam_livekit.py`, `test_new_features_e2e.py`, `MCPUnavailableError`, `test_knowledge_sync.py`, `CEOSupervisor`, `SelfHealingAgent`, `HealState`, `direct_chat.py`, `ResearchTask`, `_try_provider`, `brain_failover.py`, `TestClient`, `test_task_clarification.py`, `OrchestratorCheckpointStore`, `GovernanceGate`, `get_task_store`, `_clear_cache`, `sam`, `SeoFixer`, `ImprovementLoop`, `HermesAdapter`, `test_context_rulebook.py`, `test_agile_api.py`, `test_app_settings.py`, `ArtifactStore`, `analyze_page`, `KeyStore`, `TestHarnessAdapter`, `test_kimi_bridge_server.py`, `BrainWatchdog`, `ChatHistoryStore`, `TaskStore`, `SQLiteStore`, `ModelRouter`, `_start_ceo_agency`, `PrimeAgentAdapter`, `persist_plan_spec`, `test_trend_watcher.py`, `_resolve_brain_provider`, `tasks/service.py`, `test_llm_router_queue_cache.py`, `OllamaCircuitBreaker`, `sam_with_mocks`, `TrendWatcher`, `FeatureMatrix`, `test_features_api.py`, `test_video_transcript.py`, `resolve_identity`, `ProceduralMemoryStore`, `WebsiteScanner`, `_resolve_push_token`, `SchedulerStore`, `TestClient`, `ContextPruner`, `AgentSwarm`, `TestEstimateTokensForMessages`, `TestSwarmRoleRouting`, `test_issue_intake.py`, `test_persistent_memory.py`, `SecurityScanner`, `test_provider_state_durability.py`, `test_startup_warmup.py`, `get_scheduler`, `test_llm_router_e2e.py`, `WorkflowBuildRequest`, `test_llm_router_gateway.py`, `TrafficDirector`, `LogMonitor`, `client`, `session_retro.py`, `test_purge_backlog.py`, `UsageEvent`, `test_ping.py`, `TestMongoGate`, `test_runtimes_health_endpoint.py`, `OperationalIncidentTracker`, `test_task_store_fails_loud_in_production.py`, `test_crispy_burn_in.py`, `test_provider_enable_disable.py`, `test_skill_registry_boot_refresh.py`, `test_platform_controls.py`, `heal_signature`, `isolated_telegram_config`, `test_e2b_task_wiring.py`, `test_telegram_auto_approve.py`, `_resolve_user_github_token`, `test_telegram_approval_e2e.py`, `test_service_token.py`, `platform_controls_router.py`, `test_governance_enforcement.py`, `test_agency_fix.py`, `capture_screens.py`, `ClaudeCodeAdapter`, `test_monitor_lib.py`, `test_v4_api.py`, `test_dashboard_cache.py`, `cost_tracker.py`, `allow_paid`, `WorkflowRun`, `test_voice_pipeline.py`, `TestNormalizeResponseFormat`, `test_brain_patch_service_token.py`, `TestRouterIntegration`, `test_company_api.py`, `test_agent_tool_governance.py`, `claim`, `NotificationDispatcher`, `test_openclaw_endpoints.py`, `rate_limiter.py`, `test_task_service_failed_comment.py`, `tests/conftest.py`, `test_autonomy_status.py`, `test_local_brain_state.py`, `TestChatHistoryStore`, `test_harness_spec.py`, `test_phase5_doctor.py`, `test_telegram_diag_endpoint.py`, `test_brain_availability_doctor.py`, `e2e/test_browser.py`?**
  _High betweenness centrality (0.097) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `proxy.py`, `test_ceo_dispatcher.py`, `_StubManager`, `StuckDetector`, `AgentSessionStore`, `test_backend_server_features.py`, `test_empirical_verify.py`, `TaskSpec`, `test_ceo_micromanager.py`, `FeatureUnavailableError`, `AutonomyTracker`, `.execute`, `TestWorkspace`, `AdaptiveHalter`, `E2BAdapter`, `BackgroundAgent`, `failover_chat_completion`, `MCPUnavailableError`, `ExecutionRequest`, `LocalWorkspace`, `direct_chat.py`, `FreeBuffAgent`, `MCPClient`, `_resolve_push_token`, `test_agent_tool_governance.py`, `_try_provider`, `NotificationDispatcher`, `ContextPruner`, `resolve_e2b_config`, `ContextManager`, `GitHubTools`, `get_task_store`, `workflow_orchestrator.py`, `TestZeroAttemptDiagnostics`, `test_governance_api.py`, `TestAgentLoopMCPIntegration`, `TokenBudget`, `CEODispatcher`, `WorkspaceTools`, `WorkflowRun`, `ReactScratchpad`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `memory_store()` connect `test_persistent_memory.py` to `_fixture`, `PersistentMemoryStore`?**
