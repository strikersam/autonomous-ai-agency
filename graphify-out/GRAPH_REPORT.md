...
## Corpus Check
- 1439 files · ~2,065,602 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 28580 nodes · 53363 edges · 1207 communities (1097 shown, 110 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 3668 edges (avg confidence: 0.57)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2e98c4bd`
...
- `test_413_fails_over_to_next_provider_after_one_attempt()` --uses--> `AgentRunner`  [INFERRED]
  tests/test_brain_failover_413.py → agent/loop.py
- `test_runner_depth_starts_at_zero()` --uses--> `AgentRunner`  [INFERRED]
  tests/test_daily_automation_2026_07_11.py → agent/loop.py
...
- `test_store_falls_back_to_memory_without_mongo()` --uses--> `ScheduleStore`  [INFERRED]
  tests/test_schedule_persistence.py → agent/schedule_store.py

## Import Cycles
- None detected.

## Communities (1207 total, 110 thin omitted)

### Community 0 - "backend/server.py"
Cohesion: 0.01
Nodes (325): get_harness_adapter(), Reject non-admin callers. Mirrors the RBAC check used elsewhere in this backend…, _require_admin(), admin_seed(), _agent_provider_failure_response(), _agent_timeout_fallback_response(), AgentStatusEntry, AgentStatusResponse (+317 more)

### Community 1 - "brain_config.py"
Cohesion: 0.02
Nodes (204): autonomy_status(), _brain_provider_status(), get_brain_policy_route(), Return per-provider metadata for the GET endpoint. Iterates every provider in…, Return the discovered model list for *provider_id*, or ``[]`` if unknown., Return the active brain config + per-provider key-present flags. The response…, Public autonomy readiness probe — no authentication required. A live deploy…, _served_models() (+196 more)

### Community 2 - "TaskSpec"
Cohesion: 0.03
Nodes (122): agent/job_manager.py — Async agent job lifecycle manager. Manages agent jobs…, kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, AiderAdapter, Any, TaskResult, TaskSpec, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider… (+114 more)

### Community 3 - "resolve_identity"
Cohesion: 0.02
Nodes (166): _egress_policy_reason(), agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Return why governance policy blocks *host*, or None. Runs strictly *after* the…, guard(), _load(), mcp_server/governance.py — governance adapter for the MCP HTTP surface. Closes…, Evaluate *tool* before it runs. Returns ``(allowed, message, decision)``.…, Import the governance layer once, recording why if it is absent. (+158 more)

### Community 4 - "company_api.py"
Cohesion: 0.02
Nodes (194): ephemeral_ttl_hours(), Async read of the ephemeral TTL (hours) straight from the DB., account_lifecycle(), AccountLifecycleResponse, auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint() (+186 more)
...
### Community 6 - "test_agent_tool_governance.py"
Cohesion: 0.04
Nodes (89): AuditLog, get_audit_log(), packages/governance/audit.py — the evidence trail for every governed action.…, Redact secret-shaped substrings, then truncate., Bounded in-memory ring buffer plus a structured log stream. The ring buffer…, Store and emit *event*. Never raises., Return the most recent events, newest first, optionally filtered., Aggregate view for the dashboard and the metrics endpoint. ``would_block`` is… (+81 more)

### Community 7 - "test_llm_router_resilience.py"
Cohesion: 0.03
Nodes (98): Backoff policy for retryable failures., RetryConfig, BreakerState, Enum, str, packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, classify_error(), LLMProvider (+90 more)

### Community 8 - "E2BSandboxSession"
Cohesion: 0.04
...
### Community 9 - "test_governance_enforcement.py"
Cohesion: 0.02
Nodes (166): build_governance_router(), Any, APIRouter, backend/governance_router.py — read and operate the governance layer. Mounted…, ApprovalRequest, ApprovalStatus, ApprovalStore, get_approval_store() (+158 more)

### Community 10 - "llm/router.py"
Cohesion: 0.03
Nodes (93): int, get_budget(), packages/llm/budget.py — token and cost accounting with spend alerts. Tracks…, The process-wide budget tracker., Test hook — clear all usage accounting., reset(), CacheManager, cosine_similarity() (+85 more)

### Community 11 - "WebsiteScanner"
Cohesion: 0.03
Nodes (100): DetectedSystem, Evidence, Result of a website scan with detected systems and stack inference., Evidence supporting a system detection., Result of a repository scan with detected stack and systems., A business system detected on a company's website or in their stack., Get the most confident evidence description., Inferred technology stack from website/repo analysis. (+92 more)
...
### Community 13 - "seo_api.py"
Cohesion: 0.06
Nodes (36): delegate_seo_findings(), _expire_stale_pending_report(), export_seo_audit(), get_seo_audit(), list_seo_audits(), BaseModel, get, post (+28 more)

### Community 14 - "api.js"
Cohesion: 0.02
Nodes (44): approveGovernanceRequest(), autoRecommendCompanySkills(), createMcpServer(), delegateSeoFindings(), deleteCompany(), deleteMcpServer(), denyGovernanceRequest(), discoverLlmModels() (+36 more)

### Community 15 - "resolve_active_brain"
Cohesion: 0.03
Nodes (113): _build_provider_router(), _chat_provider_policy(), _fallback_local_provider_record(), _list_configured_provider_records(), _nvidia_nim_provider_record(), ProviderUpdate, ProviderRouter, Return a provider record for Nvidia NIM if the API key is set in env. (+105 more)
...
### Community 20 - "V5App.jsx"
Cohesion: 0.03
Nodes (67): API, changeUserRole(), createApiKey(), createQuickNote(), deleteApiKey(), fetchVelocity(), listQuickNotes(), setUserOnboarding() (+59 more)
...
Cohesion: 0.04
Nodes (67): AgentDefinition, AgentStore, Any, field_validator, agents/store.py — Persistent store for user-defined agent configurations.…, CRUD store for AgentDefinition objects. Uses MongoDB when a `db` client is…, Return an agent by ID. If *owner_id* is provided, enforces that the agent…, Delete an agent. Returns True on success, False if not found/unauthorised. (+59 more)

### Community 23 - "_fixture"
Cohesion: 0.02
Nodes (83): base_url(), mobile_page(), proxy_url(), Config, pytest_configure(), conftest.py — pytest fixtures and configuration for the E2E test suite.…, A browser page pre-configured for mobile viewport (390×844 — iPhone 14)., setup_database_moks() (+75 more)

### Community 24 - "LLMRequest"
Cohesion: 0.04
...
### Community 26 - "Task"
Cohesion: 0.04
Nodes (72): Hand the 'connect & verify the repo' work to the agency's own agents. The task…, _seed_connect_task(), Full task/issue document., Task, One-line human explanation of why this task needs human approval. Reads risk…, Best-effort label of who will run this task once approved. Returns…, PUBLIC_URL-anchored dashboard deep link for the task detail. Returns empty…, Best-effort Telegram heads-up that a task is parked awaiting approval. Inline… (+64 more)

### Community 27 - "Agency"
Cohesion: 0.05
Nodes (74): Agency, AgencyCycleResult, AgentDirective, AgentRole, _build_ceo_prompt(), _build_quick_note_instruction(), _close_github_issue(), _collect_recent_git_context() (+66 more)

### Community 28 - "test_ceo_dispatcher.py"
Cohesion: 0.03
Nodes (94): Reset the singleton (test helper)., reset_ceo_dispatcher(), ClassifyOutput, get_ceo_fallback_stats(), PlanOutput, BaseModel, CLASSIFY phase: domain and task type determination., PLAN phase: structured execution plan. (+86 more)
...
### Community 30 - "test_render_mcp.py"
Cohesion: 0.04
Nodes (52): agent/mcp_client.py — Async MCP client for the mcp-server Docker container.…, _as_list(), _coerce_payload(), Any, RuntimeError, packages/integrations/render_mcp.py — Render platform access over MCP. The…, One deploy, normalised from whatever shape the tool returned., Return tool output as Python data. MCP tool results arrive either as… (+44 more)

### Community 31 - "RuntimeCapabilityRegistry"
Cohesion: 0.03
...
### Community 32 - "types.py"
Cohesion: 0.04
Nodes (75): _load(), main(), failover_chat_completion_via_router(), openai_body_from_response(), Any, packages/llm/compat.py — backwards-compatible bridges to the legacy call paths.…, Router-backed implementation of ``packages.ai.failover_client``'s entry point.…, Whether the compat bridges should delegate to ``LLMRouter``. Reads the flag on… (+67 more)
...
### Community 34 - "SQLiteStore"
Cohesion: 0.04
Nodes (37): Delete a company and all associated data from SQLite., Count total companies in SQLite., Reconstruct a Website from a SQLite row, preferring the full JSON blob (which…, Create a new website in SQLite. The full model is stored in ``data`` so scan…, Get a website by ID from SQLite., Update a website in SQLite. When ``company_id`` is omitted the existing company…, Delete a website from SQLite., List websites from SQLite. (+29 more)

### Community 35 - "test_phase6_workflow.py"
Cohesion: 0.05
Nodes (78): add_pr_comment(), _find_existing_pr(), get_branch_sha(), get_default_branch(), _headers(), Any, agent/safe_agency.py — Safe GitHub operations for the workflow engine. All…, Create a pull request. Returns the PR object dict. If a PR already exists for… (+70 more)
...
### Community 38 - "TestAdapterMetadata"
Cohesion: 0.04
Nodes (31): _env_float(), HermesAdapter, Any, AsyncClient, Response, TaskResult, TaskSpec, Submit task to Hermes via its /tasks endpoint. (+23 more)

### Community 39 - "test_unit8_model_catalog.py"
Cohesion: 0.03
Nodes (73): get_catalog_models_route(), Return the mirrored model catalog (advisory-only). Flag-gated by…, CatalogActiveBrain, CatalogMirror, get_catalog(), get_model_catalog_store(), invalidate_catalog_cache(), is_catalog_enabled() (+65 more)

### Community 40 - "loop.py"
Cohesion: 0.04
Nodes (48): _check_extra_kwargs(), _enforce_signature(), _note_phase_end(), _note_phase_start(), Any, Path, loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., Raise TypeError if fn's signature drifts from the locked contract (Pydantic… (+40 more)

### Community 41 - "PrimeAgentAdapter"
Cohesion: 0.04
...
### Community 44 - "CompanyGraphStore"
Cohesion: 0.03
Nodes (39): Find a website by its URL., A company website with detected systems and stack inference., Website, requires_db, Add a website to a company. Args: company_id: Company ID url: Website URL…, CompanyGraphStore, Delete a company and all its associated data., List companies with optional filtering. (+31 more)

### Community 45 - "test_sam_livekit.py"
Cohesion: 0.04
Nodes (71): get_sam(), _get_backend_sam(), Lazy-init the SAM agent for the backend deployment., Report whether the SAM realtime voice (LiveKit) transport is configured., sam_livekit_status_backend(), auth_headers(), livekit_env(), no_livekit_env() (+63 more)

### Community 46 - "WorkflowRun"
Cohesion: 0.04
Nodes (40): MergeDecision, _NoopStore, Any, Exception, Approve a run paused at the ApprovalGate. The caller must re-invoke…, Inject additional instructions into an in-flight run (no state change). Backs…, Push a Telegram approval-gate notification when a run pauses (Charter G1).…, G5: resolve how a run should land from the company's DeliveryPolicy. Returns… (+32 more)

### Community 47 - "ImprovementLoop"
Cohesion: 0.06
...
### Community 50 - "failover_client.py"
Cohesion: 0.04
Nodes (69): _auto_disable(), _describe_registry(), _disable_unless_key_serves_other_models(), _disabled_ids(), FailoverResult, _is_billing_refusal(), _is_ollama(), _key_pool() (+61 more)

### Community 51 - "Specialist"
Cohesion: 0.03
...
### Community 52 - "test_model_router.py"
Cohesion: 0.05
...
### Community 54 - "FreeBuffAgent"
Cohesion: 0.04
Nodes (65): free_nvidia_models(), FreeBuffAgent, _nvidia_api_key(), Return the curated list of free NVIDIA NIM models FreeBuff may use., Codebuff-style coding agent pinned to free NVIDIA NIM models. FreeBuff is a…, List the free NVIDIA NIM models a user may pick (e.g. via Telegram)., True when *model* is in the curated free NVIDIA NIM set., Coerce *requested* to a free NVIDIA model. Returns *requested* when it is… (+57 more)

### Community 55 - "start_background_services"
Cohesion: 0.03
Nodes (63): all_settings(), _as_bool(), _as_int(), ephemeral_ttl_hours_cached(), get_setting(), _maybe_schedule_refresh(), onboarding_gate_enabled(), onboarding_gate_enabled_cached() (+55 more)
...
### Community 58 - "_ts_to_float"
Cohesion: 0.05
Nodes (75): Reset the singleton (for tests)., reset_failover_manager(), _blocked_retire_age_sec(), _heal_blocked_backlog(), _heal_brain_failover(), _heal_purge_backlog(), _heal_stuck_tasks(), _heal_task_duplicates() (+67 more)

### Community 59 - "workflow/api.py"
Cohesion: 0.06
Nodes (63): _make_engine(), tests/test_crispy_workflow.py — CRISPY workflow engine hardening tests. Tests…, Create a WorkflowEngine with isolated storage., TestAbortOnFailure, TestPhaseSequence, TestPhaseSequenceError, TestWorkspaceIsolation, approve() (+55 more)

### Community 60 - "test_knowledge_sync.py"
Cohesion: 0.06
...
### Community 61 - "test_mcp_registry.py"
Cohesion: 0.05
Nodes (48): get_mcp_client(), Return the module-level MCPClient. Reads MCP_SERVER_BASE_URL at call time (not…, _internal_configured(), list_specs(), MCPServerSpec, _not_dialable(), _playwright_configured(), _probe_http() (+40 more)

### Community 62 - "WorkspaceManager"
Cohesion: 0.06
Nodes (49): admin_auth.py — auto-generated module docstring (user-research skill scan)., test_git_ref_rejects_empty(), test_git_ref_rejects_flag_injection(), test_git_ref_rejects_shell_metacharacters(), test_git_ref_rejects_traversal(), test_git_ref_valid(), test_git_scheme_allows_ssh(), test_http_scheme_rejects_ssh() (+41 more)
...
### Community 64 - "RenderOpsMonitor"
Cohesion: 0.06
Nodes (29): BaseModel, Response shape of ``GET /api/render/ops/status``. Declared here rather than in…, RenderOpsStatus, Polls Render for platform-level failures and files them as issues., RenderOpsMonitor, _client(), _FakeInner, _FakeRender (+21 more)

### Community 65 - "ExecutionRequest"
Cohesion: 0.06
Nodes (43): Execute work through the 11-phase golden path., workflow_orchestrator_execute(), ExecutionRequest, ExecutionResult, get_workflow_orchestrator(), Return the shared WorkflowOrchestrator singleton., Reset the singleton (test helper)., Canonical request to execute work through the golden path. This is the ONLY… (+35 more)

### Community 66 - "test_backend_server_features.py"
Cohesion: 0.06
Nodes (29): _append_agent_session_message(), _build_auto_skill_guidance(), _builtin_provider_records(), _in_container(), _mask_observations(), Path, ProviderConfig, Return a minimal set of built-in provider records without touching MongoDB.… (+21 more)

### Community 67 - "test_ceo_supervision.py"
Cohesion: 0.06
...
Cohesion: 0.04
Nodes (55): cancelAgentChatJob(), chatSend(), deleteSession(), getAgentChatJob(), getSession(), listProviderModels(), listSessions(), resumeAgentChatJob() (+47 more)

### Community 71 - "AgentProfile"
Cohesion: 0.05
...
### Community 74 - "DashboardLayout.js"
Cohesion: 0.05
Nodes (41): completeSetup(), createSecret(), detectHardwareForSetup(), detectModelsForSetup(), getMe(), getPublicPath(), getSetupState(), logout() (+33 more)
...
### Community 76 - "TasksPage.js"
Cohesion: 0.04
Nodes (53): addTaskComment(), approveTaskCheckpoint(), approveTaskExecution(), clarifyTask(), createAgent(), createSprint(), createTask(), deleteAgent() (+45 more)
...
Cohesion: 0.05
Nodes (34): get_tool_registry(), Any, Path, Register a tool definition., Decorator to register a function as an agent tool. Usage::…, Remove a tool from the registry. Returns True if removed., Look up a tool by name., Return all registered tools. (+26 more)

### Community 81 - "ProvidersScreen.jsx"
Cohesion: 0.04
Nodes (46): createProvider(), deleteModel(), deleteProvider(), getBrainConfig(), getLocalBrainState(), getProviderPolicy(), getRenderHealth(), getRenderOpsStatus() (+38 more)

### Community 82 - "ControlPlanePage.js"
Cohesion: 0.06
Nodes (45): getActivity(), getCostAttribution(), getDecisionLog(), getDueSoonTasks(), getSavings(), getStats(), getTaskCounts(), getUsage() (+37 more)

### Community 83 - "services/seo_audit.py"
Cohesion: 0.06
Nodes (43): BaseModel, field_validator, models/seo_audit.py - SEO / GEO / AIO Audit Contracts Typed Pydantic models for…, A single occurrence of a check firing on a specific URL., Snapshot of one crawled page with the on-page facts the checks used., Aggregated report row - Screaming Frog CSV compatible., Site-level facts discovered during the crawl., An agent-delegable remediation work package derived from the findings. Findings… (+35 more)
...
### Community 87 - "test_repo_connection.py"
Cohesion: 0.06
...
### Community 91 - "resolve_e2b_config"
Cohesion: 0.05
...
### Community 93 - "test_control_plane_api.py"
Cohesion: 0.04
...
### Community 96 - "test_startup_warmup.py"
Cohesion: 0.05
Nodes (56): _bootstrap_within_budget(), _create_bootstrap_indexes(), ensure_bootstrap(), Await one warm-up step, deferring it to the background if it overruns.…, The task store the background services should use, wiring it if needed.…, Point the feature stores at the shared database connection. Deliberately…, Create every boot index concurrently rather than one round-trip at a time.…, Idempotent bootstrap for indexes + seeded admin/providers. FastAPI startup… (+48 more)

### Community 97 - "LogWatcher"
Cohesion: 0.05
...
### Community 98 - "CEODispatcher"
Cohesion: 0.06
Nodes (45): CEODispatcher, CEOResult, _complexity_rank(), _decompose_into_subtasks(), _merge_changed_files(), _offload(), Any, services/ceo_dispatcher.py — Real CEO delegation layer. The CEO splits a… (+37 more)
...
### Community 104 - "ProviderConfig"
Cohesion: 0.06
Nodes (48): _dead_model_key(), is_commercial_provider(), _mark_model_dead(), provider_access_tier(), _provider_field(), provider_sort_key(), ProviderConfig, provider_router.py — auto-generated module docstring (user-research skill scan). (+40 more)

### Community 105 - "test_colibri_brain_shim.py"
Cohesion: 0.06
...
### Community 108 - "test_llm_router_tpm.py"
Cohesion: 0.06
...
### Community 110 - "test_integration_c4_c5_c6_d3.py"
Cohesion: 0.06
...
### Community 111 - "test_user_research_skill.py"
Cohesion: 0.07
...
### Community 112 - "TestBrainFailoverModelUpdates"
Cohesion: 0.06
...
### Community 115 - "LLMRouter"
Cohesion: 0.08
Nodes (24): Attempt, Read the environment variables named in ``env_names`` into a key list. Order is…, resolve_keys(), LLMRouter, Any, AsyncClient, BaseException, One shared connection pool. Reconnects if it was closed. (+16 more)

### Community 116 - "fmtErr"
Cohesion: 0.07
Nodes (47): authorizeGithubRepos(), createGithubPR(), createSchedule(), deleteGithubToken(), fmtErr(), getGithubStatus, getGithubTree(), getPlatformInfo() (+39 more)

### Community 117 - "test_context_rulebook.py"
Cohesion: 0.06
Nodes (53): Module, stmt, _bound_names(), _good_result(), _guard_statements(), _load(), ModuleType, parametrize (+45 more)

### Community 118 - "AgentScheduler"
Cohesion: 0.06
...
### Community 124 - "test_trend_scoping.py"
Cohesion: 0.09
...
Cohesion: 0.04
Nodes (30): CapacityAllocation, Initiative, InitiativeProgress, PortfolioMetrics, Enum, Agentic Portfolio Management — initiative prioritisation, capacity allocation,…, Percentage of linked sprint points completed., Result of fitting initiatives into a fixed capacity by WSJF priority. (+22 more)

### Community 127 - "clear_cooldowns"
Cohesion: 0.06
Nodes (44): clear_cooldowns(), get_dead_models(), _is_model_dead(), is_provider_on_cooldown(), mark_provider_failed(), Snapshot of active dead-model entries {provider_id/model: expiry_ts}. Also…, Put provider_id on cooldown for *cooldown_seconds* (default:…, Return True if provider_id is currently on cooldown. (+36 more)

### Community 128 - "telegram_bot.py"
Cohesion: 0.08
Nodes (52): get_decisions_store(), Process-wide DecisionsStore singleton (resettable via db_path arg)., Return a Markdown-v1-safe preview string under ``max_chars``. Used by the…, sanitize_paste_for_preview(), _admin_headers(), _answer_callback(), _api_headers(), _check_rate_limit() (+44 more)

### Community 129 - "WorkflowEngine"
Cohesion: 0.08
...
### Community 131 - "test_webui_provider_priority.py"
Cohesion: 0.07
Nodes (31): AdminAuthManager, AdminIdentity, AdminSession, AdminSessionStore, _is_truthy(), WindowsCredentialAuthenticator, test_admin_api_login_status_and_control(), test_admin_api_user_crud() (+23 more)

### Community 132 - "ReactScratchpad"
Cohesion: 0.06
...
### Community 135 - "webui/router.py"
Cohesion: 0.08
Nodes (39): Any, Path, run_command(), _safe_allowlist(), validate_command(), invalidate_brain_cache(), _normalize_base_url(), _now() (+31 more)
...
### Community 138 - "portfolio_intelligence.py"
Cohesion: 0.07
...
### Community 139 - "test_ceo_router.py"
Cohesion: 0.07
...
### Community 140 - "api_keys_for"
Cohesion: 0.05
Nodes (26): _build_request(), _provider_keys(), Every configured key for *provider*, primary first. Returns an empty list when…, Return ``(url, headers, is_anthropic_native)`` for *provider*. Anthropic's…, api_keys_for(), Per-provider API key rotation — the one lever that adds capacity. Every other…, Clear pool state (tests only)., All keys configured for *provider_id*, primary first. Thin delegate to… (+18 more)

### Community 141 - "CEOLedger"
Cohesion: 0.06
...
### Community 144 - "test_p0_roadmap_b1_c2_a3.py"
Cohesion: 0.06
...
### Community 147 - "run_task"
Cohesion: 0.06
Nodes (36): _active_primary_provider(), Best-effort read of the active brain's primary provider (or ``None``)., Resolve the model id to force for a code-execution run, or ``None``. Returns…, resolve_coding_model_preference(), _check_auth(), health(), Any, BaseModel (+28 more)

### Community 148 - "test_response_cache.py"
Cohesion: 0.12
...
### Community 149 - "ContextWindowManager"
Cohesion: 0.08
...
### Community 152 - "test_slop_gate.py"
Cohesion: 0.07
...
### Community 153 - "ProviderRouter"
Cohesion: 0.08
Nodes (25): _exponential_backoff_cooldown(), _get_director(), _normalized_provider_type(), _notify_watchdog(), _ollama_reasoning_effort(), ProviderAttempt, ProviderRouter, Any (+17 more)

### Community 154 - "test_schedule_growth_invariants.py"
Cohesion: 0.05
...
### Community 156 - "emit_chat_observation"
Cohesion: 0.08
...
### Community 157 - "test_daily_2026_07_27.py"
Cohesion: 0.07
...
### Community 160 - "[Unreleased]"
Cohesion: 0.04
Nodes (46): [5.0.0], Added, Added, Added, Added, Added, Added, Added (+38 more)

### Community 161 - "[Unreleased]"
Cohesion: 0.04
Nodes (46): [5.0.0], Added, Added, Added, Added, Added, Added, Added (+38 more)

### Community 162 - "Workspace"
Cohesion: 0.07
...
### Community 165 - "StreamingDeltaReconstructor"
Cohesion: 0.07
...
### Community 166 - "test_e2b_adapter.py"
Cohesion: 0.07
...
### Community 167 - "test_telegram_freebuff.py"
Cohesion: 0.07
...
### Community 168 - "test_e2b_task_wiring.py"
Cohesion: 0.08
...
### Community 169 - "KeyStore"
Cohesion: 0.09
Nodes (29): _check_rate_limit(), default_keys_path(), issue_new_api_key(), KeyRecord, KeyStore, load_key_store(), Exception, Path (+21 more)

### Community 170 - "test_daily_2026_06_04.py"
Cohesion: 0.07
...
### Community 174 - "test_seo_audit.py"
Cohesion: 0.05
Nodes (19): compute_pressure(), _count_syllables(), estimate_pixel_width(), flesch_reading_ease(), is_internal(), loss_share_from_pressure(), normalize_url(), Map aggregate issue pressure to an at-risk revenue share via the diminishing-… (+11 more)

### Community 175 - "NotificationDispatcher"
Cohesion: 0.07
...
### Community 176 - "TestRuntimeControl"
Cohesion: 0.04
...
### Community 183 - "test_video_transcript.py"
Cohesion: 0.05
...
### Community 184 - "activation_api.py"
Cohesion: 0.10
...
### Community 186 - "portfolio_api.py"
Cohesion: 0.08
...
### Community 187 - "Part A — CodeRabbit review fixes for this PR (do first, small)"
Cohesion: 0.05
...
### Community 188 - "Docker Agent Runtimes Setup"
Cohesion: 0.05
...
Cohesion: 0.05
Nodes (20): _env_int(), _get_settings(), Read an int env var, falling back to *default* on a missing/bad value. Never…, When True, the governance layer evaluates and audits agent actions. This is…, Typed configuration loaded from environment variables., When True, approval-gated actions self-approve. Local dev only., ``RENDER_SERVICE_IDS`` split into a clean list (empty when unset)., True when there is both an API key and an endpoint to reach. (+12 more)

### Community 191 - "test_bedrock_provider.py"
Cohesion: 0.08
...
### Community 193 - "test_loop_registry.py"
Cohesion: 0.10
Nodes (34): audit_drift(), _cmd_audit(), DriftReport, _grade(), loop_readiness(), LoopRegistry, LoopSpec, main() (+26 more)

### Community 194 - "v4_api.py"
Cohesion: 0.10
Nodes (40): _get_cached_tasks(), _get_tasks_cache_lock(), _load_improvement_state(), Any, BaseModel, get, Lock, post (+32 more)

### Community 195 - "Persistent Memory System"
Cohesion: 0.05
...
### Community 198 - "configuration-reference.md"
Cohesion: 0.08
...
### Community 200 - "Kept Rules — the 44 that survive the audit"
Cohesion: 0.05
...
### Community 201 - "anthropic_compat.py"
Cohesion: 0.09
...
### Community 202 - "Company"
Cohesion: 0.08
Nodes (14): Company, Any, field_validator, The core company entity - root of the Company Graph., Coerce unrecognised system_type values to 'custom' so the model never crashes…, Test Company Graph Pydantic models., Test that all Company Graph models can be imported., Test Company model creation. (+6 more)

### Community 203 - "sync/service.py"
Cohesion: 0.10
...
### Community 204 - "compare_runtimes.py"
Cohesion: 0.07
...
### Community 205 - "test_portfolio_intake.py"
Cohesion: 0.09
...
### Community 206 - "test_trend_watcher.py"
Cohesion: 0.08
...
### Community 207 - "AgentSessionStore"
Cohesion: 0.10
...
### Community 208 - "PortfolioManager"
Cohesion: 0.07
...
### Community 209 - "OrchestratorSupervisor"
Cohesion: 0.08
...
### Community 212 - "TaskExecutionCoordinator"
Cohesion: 0.08
Nodes (27): _gate_outward_facing_enabled(), _is_brain_connection_error(), _is_outward_facing(), Any, BaseException, TaskResult, TaskSpec, Inject auto_commit + repo context for self-repo ship-code tasks. Without… (+19 more)

### Community 213 - "TestRecordUsageAndStats"
Cohesion: 0.05
...
### Community 220 - "test_llm_router_disabled.py"
Cohesion: 0.09
...
### Community 223 - "test_portfolio_intelligence.py"
Cohesion: 0.06
...
### Community 224 - "DirectChatDoctor"
Cohesion: 0.09
Nodes (32): DirectChatDoctor, _DoctorCheck, _DoctorReport, get_doctor_diagnostics(), get_doctor_report(), get_public_doctor(), Public Doctor endpoint — no authentication required. Returns system-level…, Authenticated Doctor endpoint — full diagnostics. Returns all system-level… (+24 more)

### Community 225 - "PatternConsolidation"
Cohesion: 0.10
...
### Community 226 - "get_failover_manager"
Cohesion: 0.07
Nodes (37): brain_providers(), _openclaw_instructions(), openclaw_reverse_proxy(), openclaw_status(), openclaw_websocket(), api_route, websocket, Every configured provider with its health AND its on/off state. Powers the… (+29 more)

### Community 227 - "get_skill_bindings"
Cohesion: 0.10
Nodes (26): get_skill(), list_skills(), List all available skills with optional filtering. Returns the skill catalog…, Get a single skill by its ID., Request to recommend skills based on context., Recommend skills based on provided context., recommend_skills(), SkillRecommendRequest (+18 more)

### Community 228 - "test_pr923_fixes.py"
Cohesion: 0.07
...
### Community 237 - "test_verification_strategies.py"
Cohesion: 0.11
...
### Community 238 - "agents/agile_ceremonies.py"
Cohesion: 0.08
...
### Community 239 - "REWRITE_PLAN.md — Phased Migration Strategy"
Cohesion: 0.06
...
### Community 240 - "test_background_services.py"
Cohesion: 0.08
...
### Community 242 - "test_issue_intake.py"
Cohesion: 0.12
Nodes (32): _capability_tags(), intake_issue(), _issue_labels(), issue_source_id(), map_issue_to_task(), Any, Task, tasks/issue_intake.py — Auto issue → Task intake (Autonomy Charter G3) Turns… (+24 more)

### Community 243 - "test_all_providers_discovery.py"
Cohesion: 0.16
...
### Community 244 - "test_persistent_memory.py"
Cohesion: 0.06
...
### Community 250 - "workflow_orchestrator.py"
Cohesion: 0.09
Nodes (27): BoundContext, JudgeVerdict, MonitorOutput, _orchestrator_bypass(), PersistOutput, Phase, PreflightReport, Enum (+19 more)

### Community 251 - "test_anthropic_router.py"
Cohesion: 0.09
...
### Community 252 - "test_llm_router_e2e.py"
Cohesion: 0.14
...
### Community 255 - "agent_runtime.py"
Cohesion: 0.10
...
### Community 256 - "DashboardScreen.jsx"
Cohesion: 0.07
...
### Community 258 - "test_platform_controls.py"
Cohesion: 0.08
...
### Community 259 - "local_controller.py"
Cohesion: 0.12
...
### Community 260 - "skill_bindings.py"
Cohesion: 0.09
...
### Community 261 - "test_live_server.py"
Cohesion: 0.22
...
### Community 262 - "WorkflowBuildRequest"
Cohesion: 0.09
...
### Community 263 - "ContextCompressor"
Cohesion: 0.11
...
### Community 266 - "ResourceWatchdog"
Cohesion: 0.10
...
Cohesion: 0.09
Nodes (31): create_refresh_token(), create_access_token(), create_refresh_token(), get_current_user(), get_optional_user(), github_exchange_code(), github_fetch_user(), google_exchange_code() (+23 more)

### Community 268 - "chat_handlers.py"
Cohesion: 0.12
...
### Community 270 - "RateLimitTracker"
Cohesion: 0.10
...
### Community 273 - "test_sam_voice.py"
Cohesion: 0.07
...
### Community 274 - "test_microagents.py"
Cohesion: 0.15
...
### Community 275 - "Security Analysis — local-llm-server"
Cohesion: 0.06
...
### Community 276 - "Langfuse Observability Guide"
Cohesion: 0.06
...
### Community 278 - "AnthropicProvider"
Cohesion: 0.13
...
### Community 279 - "BrainFailoverManager"
Cohesion: 0.09
...
### Community 280 - "OrchestratorQueue"
Cohesion: 0.07
...
### Community 283 - "test_workspace_isolation.py"
Cohesion: 0.16
...
### Community 288 - "High-Agency Frontend Skill"
Cohesion: 0.06
Nodes (30): 10. FINAL PRE-FLIGHT CHECK, 1. ACTIVE BASELINE CONFIGURATION, 2. DEFAULT ARCHITECTURE & CONVENTIONS, 3. DESIGN ENGINEERING DIRECTIVES (Bias Correction), 4. CREATIVE PROACTIVITY (Anti-Slop Implementation), 5. PERFORMANCE GUARDRAILS, 6. TECHNICAL REFERENCE (Dial Definitions), 7. AI TELLS (Forbidden Patterns) (+22 more)

### Community 289 - "TestNormalizeResponseFormat"
Cohesion: 0.08
...
### Community 290 - "Quick-Note GitHub Issues Processing - Session Summary"
Cohesion: 0.06
...
### Community 291 - "session_retro.py"
Cohesion: 0.13
...
### Community 292 - "test_purge_backlog.py"
Cohesion: 0.09
...
Cohesion: 0.07
Nodes (30): Agent governance — identity, policy, approvals, audit, sandboxes, Agent Models, Anthropic API Compatibility / Claude Code, Authentication and Keys, Claude Code setup, Configuration Reference, Continual Harness, Dashboard (React UI on :3000, API on :8001) (+22 more)

### Community 294 - "getBackendUrl"
Cohesion: 0.14
...
### Community 296 - "output_filter.py"
Cohesion: 0.07
...
### Community 299 - "test_telegram_mutating_commands.py"
Cohesion: 0.07
...
### Community 300 - "test_autonomy_gate.py"
Cohesion: 0.13
...
### Community 301 - "test_direct_chat_async.py"
Cohesion: 0.12
...
### Community 302 - "test_rag_context.py"
Cohesion: 0.12
...
### Community 303 - "ProjectScaffolder"
Cohesion: 0.13
...
### Community 305 - "tests/conftest.py"
Cohesion: 0.08
...
### Community 307 - "SteeringInjector"
Cohesion: 0.11
...
### Community 308 - "RuntimeHealthService"
Cohesion: 0.09
...
### Community 309 - "test_claude_setup_audit.py"
Cohesion: 0.16
...
### Community 311 - "test_brain_config_api.py"
Cohesion: 0.08
Nodes (24): _probe_ollama(), ProbeResult, BaseModel, Probe local Ollama via GET /api/tags (cheap) then a 5-token completion., Outcome of a single (provider, model) liveness probe., tests/test_brain_config_api.py — admin endpoint contract tests. Pins the…, Reiterates the security contract: no key value ever appears in the response., A model that 410s must be rejected with 422 + a probe report. (+16 more)

### Community 312 - "CompanyAgencyService"
Cohesion: 0.09
...
### Community 313 - "test_internal_agent_did_work.py"
Cohesion: 0.12
...
### Community 315 - "Python Dependencies (`requirements.txt`)"
Cohesion: 0.07
...
### Community 316 - "Technical Debt Register — local-llm-server"
Cohesion: 0.07
...
### Community 318 - "RuntimesPage.js"
Cohesion: 0.10
Nodes (20): getRoutingPolicy(), refreshRuntimeHealth(), runTaskOnRuntime(), startAllRuntimes(), startRuntime(), stopAllRuntimes(), stopRuntime(), updateRoutingPolicy() (+12 more)

### Community 319 - "TrafficDirector"
Cohesion: 0.11
...
### Community 321 - "SyntheticDataPipeline"
Cohesion: 0.12
...
### Community 322 - "test_crispy_burn_in.py"
Cohesion: 0.07
...
### Community 323 - "TestMCPServer"
Cohesion: 0.12
Nodes (7): mcp_client(), Any, tests/test_mcp_server.py — Unit tests for the MCP server and client. Tests: -…, TestClient for the MCP FastAPI app with workspace base patched to tmp_path., Ensure _dispatch_tool routes MCP-only tools correctly., TestAgentLoopMCPIntegration, TestMCPServer

### Community 324 - "test_skill_registry_boot_refresh.py"
Cohesion: 0.12
...
Cohesion: 0.11
Nodes (11): Public wrapper around _generate_plan for callers that want plan-only. Returns…, Connection, Path, Per-user key/value memory store backed by SQLite. Allows agents to persist and…, Return all stored key/value pairs for *user_id*., Delete a memory entry. Returns ``True`` if a row was removed., Persistent key/value store scoped per user. Thread-safe; uses a single SQLite…, Upsert a memory entry for *user_id*. (+3 more)

### Community 327 - "plan_research"
Cohesion: 0.11
...
### Community 329 - "Deploy: FreeBuff Telegram bot (24×7)"
Cohesion: 0.07
...
### Community 330 - "Claude Code + Qwen Local Setup"
Cohesion: 0.07
...
### Community 332 - "traffic_director.py"
Cohesion: 0.11
...
### Community 333 - "test_phase4_runtime_resilience.py"
Cohesion: 0.11
...
### Community 335 - "test_brain_availability_doctor.py"
Cohesion: 0.16
...
### Community 337 - "isolated_telegram_config"
Cohesion: 0.11
...
### Community 338 - "test_scheduler_hydration_bounded.py"
Cohesion: 0.09
...
### Community 340 - "TestMCPClientStructuredOutput"
Cohesion: 0.13
...
### Community 341 - "VoiceCommandInterface"
Cohesion: 0.14
...
### Community 342 - "Performance Analysis — local-llm-server"
Cohesion: 0.08
...
### Community 343 - "get_current_user"
Cohesion: 0.11
...
### Community 344 - "LLM Router — troubleshooting"
Cohesion: 0.08
...
### Community 348 - "brain_failover.py"
Cohesion: 0.12
...
### Community 350 - "test_telegram_approval_e2e.py"
Cohesion: 0.12
...
### Community 353 - "test_direct_chat_evolution.py"
Cohesion: 0.14
Nodes (21): PreflightIssue, PreflightReport, BaseModel, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, clean_store(), _fake_user(), Tests for direct-chat evolution: intent routing, sticky context, humanized…, Regression: AgentRunner must not be called with removed kwargs. Previous… (+13 more)

### Community 354 - "dependencies"
Cohesion: 0.08
Nodes (25): axios, fast-uri, dependencies, axios, fast-uri, livekit-client, lucide-react, react (+17 more)

### Community 355 - "1. The Rules"
Cohesion: 0.08
...
### Community 357 - "Session Handoff — 2026-06-15"
Cohesion: 0.08
...
### Community 358 - "TASK 4 — End-to-end approval-gate test"
Cohesion: 0.08
...
### Community 359 - "FeatureUnavailableError"
Cohesion: 0.10
...
### Community 361 - "test_north_mini_code.py"
Cohesion: 0.09
...
### Community 363 - "NIMConnectionPool"
Cohesion: 0.11
...
### Community 364 - "TemporalContextGraph"
Cohesion: 0.10
...
### Community 365 - "test_daily_automation_2026_08_03.py"
Cohesion: 0.11
...
### Community 366 - "TestClassifyPlainText"
Cohesion: 0.08
...
### Community 367 - "test_service_token.py"
Cohesion: 0.08
...
### Community 371 - "get_task_store"
Cohesion: 0.12
Nodes (21): agent/sam.py — SAM Voice Agent (System Autonomy Manager) SAM is the voice-…, _autonomy_bg_cycle(), _purge_backlog_core(), quick_notes_submit(), _QuickNoteBody, Shared purge implementation for the admin endpoint and the boot hook., Background CEO cycle + task dispatch. Runs fire-and-forget., Submit a quick-note URL or instruction from the dashboard FAB. (+13 more)
...
### Community 373 - "Local AI Stack with Docker"
Cohesion: 0.08
...
### Community 374 - "Implementation Prompt: Rich TaskBoard + Agile Sprint Integration"
Cohesion: 0.08
...
### Community 375 - "Telegram Bot Setup"
Cohesion: 0.08
...
### Community 376 - "video_transcript.py"
Cohesion: 0.12
...
### Community 377 - "control_overrides.py"
Cohesion: 0.12
...
### Community 379 - "test_regression.py"
Cohesion: 0.12
...
### Community 380 - "test_agency_fix.py"
Cohesion: 0.08
...
### Community 383 - "platform_controls_router.py"
Cohesion: 0.11
...
### Community 384 - "Agent Governance Guide"
Cohesion: 0.09
...
### Community 385 - "The fifteen strategies"
Cohesion: 0.09
...
### Community 389 - "WindowsServiceManager"
Cohesion: 0.18
...
### Community 390 - "OrchestratorCheckpointStore"
Cohesion: 0.13
...
### Community 396 - "HarnessEnrichment"
Cohesion: 0.14
...
### Community 397 - "classify_direct_chat_intent"
Cohesion: 0.13
...
### Community 399 - "AdaptivePermissions"
Cohesion: 0.18
...
### Community 404 - "test_minimax_bug_fixes.py"
Cohesion: 0.11
...
### Community 405 - "model_discovery.py"
Cohesion: 0.13
Nodes (19): cached_models(), discover_models(), _fresh_entry(), _models_url(), _parse_ids(), Any, Ask a provider which models the configured API key may actually use.…, Return the cached list for *provider_id* without any network call. The… (+11 more)

### Community 406 - "Harness"
Cohesion: 0.14
...
### Community 408 - "test_memory_guard.py"
Cohesion: 0.13
...
### Community 410 - "RegistrySkill"
Cohesion: 0.16
Nodes (10): AsyncClient, A skill fetched from a remote or local registry., Fetch skills from all configured GitHub registries. Returns count added., Fetch one GitHub registry and return a list of RegistrySkill objects. Handles…, Fetch a registry whose skills live in arbitrarily nested directories. Uses the…, Fetch one nested SKILL.md via raw.githubusercontent.com., Fetch a flat .md file and convert it to a RegistrySkill., RegistrySkill (+2 more)

### Community 411 - "V3 API Migration Plan — LLM Relay Platform"
Cohesion: 0.10
...
### Community 415 - "system_instruction"
Cohesion: 0.16
...
### Community 417 - "weekly_digest.py"
Cohesion: 0.13
...
### Community 418 - "test_task_clarification.py"
Cohesion: 0.10
Nodes (8): Any, Callback for BackgroundAgent.on_task_complete. Dispatches task result…, Dispatch the daily review digest to every authorized chat_id. Mirrors…, POST task result to configured webhook URL. Both ``error`` and ``result`` are…, auth_headers(), Tests for needs_clarification status and /api/tasks/{id}/clarify endpoint., Get auth headers for an admin user., task_id()

### Community 419 - "test_agent_free_brain.py"
Cohesion: 0.10
...
### Community 420 - "test_local_controller.py"
Cohesion: 0.17
...
### Community 421 - "run_trend_analysis"
Cohesion: 0.18
...
### Community 422 - "test_unit5_ui_provider_surface.py"
Cohesion: 0.10
...
### Community 424 - "PersistentMemoryStore"
Cohesion: 0.24
...
### Community 425 - "Skill: modularity-review"
Cohesion: 0.10
...
### Community 426 - "Design Audit"
Cohesion: 0.10
Nodes (19): Code Quality, Color and Surfaces, Component Patterns, Content, Design Audit, Fix Priority, How This Works, Iconography (+11 more)

### Community 427 - "Findings"
Cohesion: 0.10
...
### Community 428 - "render_router.py"
Cohesion: 0.13
...
### Community 432 - "Docker AI Governance Audit — Final Report"
Cohesion: 0.10
...
### Community 433 - "1. Capability-by-capability"
Cohesion: 0.10
...
### Community 435 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 437 - "ControlsScreen.jsx"
Cohesion: 0.15
...
### Community 441 - "test_kimi_bridge_server.py"
Cohesion: 0.12
...
### Community 442 - "PriorityTaskQueue"
Cohesion: 0.15
...
### Community 445 - "test_tasks_cache_ttl_env.py"
Cohesion: 0.21
...
### Community 446 - "test_voice_pipeline.py"
Cohesion: 0.14
...
### Community 447 - "test_workflow_models.py"
Cohesion: 0.13
...
### Community 450 - "_extract_tech_relevance"
Cohesion: 0.17
...
### Community 453 - "Skill: fabric-patterns"
Cohesion: 0.11
...
### Community 454 - "Analysis & Synthesis Instructions"
Cohesion: 0.11
Nodes (18): 1. Define the Atmosphere, 2. Map the Color Palette, 3. Establish Typography Rules, 4. Define the Hero Section, 5. Describe Component Stylings, 6. Define Layout Principles, 7. Define Responsive Rules, 8. Encode Motion Philosophy (+10 more)

### Community 455 - "Production Readiness Assessment — local-llm-server"
Cohesion: 0.11
...
### Community 456 - "test_dashboard_cache.py"
Cohesion: 0.18
...
### Community 458 - "_ensure_tasks_source_id_unique_index"
Cohesion: 0.16
...
### Community 459 - "Skill: fabric-patterns"
Cohesion: 0.11
Nodes (18): 1. Ensure Pattern Directory Exists, 2. List Available Patterns, 3. Retrieve a Pattern, 4. Apply a Pattern with Variables, 5. Stitch Patterns Together, 6. Create New Patterns, Acceptance Checks, Directory Structure (+10 more)

### Community 460 - "db/__init__.py"
Cohesion: 0.14
...
### Community 461 - "Admin Dashboard Guide"
Cohesion: 0.11
...
### Community 462 - "Implementation Plan"
Cohesion: 0.11
...
### Community 466 - "Delegation Plan (agent-ready work packages)"
Cohesion: 0.11
...
### Community 467 - "test_p0_roadmap_a4_a5_b2.py"
Cohesion: 0.15
...
### Community 468 - "parse_event_stream"
Cohesion: 0.15
...
### Community 471 - "test_brain_patch_service_token.py"
Cohesion: 0.18
...
### Community 472 - "TestSelfHealingInfrastructureClassification"
Cohesion: 0.19
...
### Community 473 - "test_fabric_patterns.py"
Cohesion: 0.11
...
### Community 474 - "_mock_provider_records"
Cohesion: 0.14
...
### Community 475 - "test_repowise_intelligence.py"
Cohesion: 0.11
...
### Community 476 - "test_schedule_persistence.py"
Cohesion: 0.15
...
### Community 477 - "validate_session_id"
Cohesion: 0.16
...
### Community 478 - "ErrorInterceptorMiddleware"
Cohesion: 0.18
...
### Community 481 - "Comprehensive Skill Index (By Category)"
Cohesion: 0.11
...
### Community 482 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 483 - "Component Map"
Cohesion: 0.11
...
### Community 484 - "Agent State — colibri GLM-5.2 deployment (resumable)"
Cohesion: 0.11
...
### Community 485 - "Architecture Overview — local-llm-server"
Cohesion: 0.11
...
### Community 486 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
...
### Community 487 - "Platform Guide — the full tour"
Cohesion: 0.11
...
### Community 489 - "Part A — Health Report"
Cohesion: 0.11
...
### Community 493 - "sync_readme_gallery.py"
Cohesion: 0.22
...
### Community 494 - "brain_liveness.py"
Cohesion: 0.16
Nodes (13): _is_dns_failure(), _probe_failure_reason(), BaseException, services/brain_liveness.py — Provider liveness prober for the brain switcher.…, Turn a probe exception into an operator-actionable one-line reason. A dead…, True when *exc* (or anything it wraps) is a name-resolution failure., asyncio, A dead provider hostname must be reported as a DNS failure, not a raw errno.… (+5 more)

### Community 495 - "DecisionsStoreTests"
Cohesion: 0.11
...
### Community 497 - "TestRouterIntegration"
Cohesion: 0.19
...
### Community 500 - "test_agent_tools.py"
Cohesion: 0.19
...
### Community 501 - "test_company_api.py"
Cohesion: 0.11
...
### Community 502 - "TestStopSlopChecker"
Cohesion: 0.11
...
### Community 503 - "test_self_heal.py"
Cohesion: 0.11
...
### Community 504 - "test_telegram_service_webhook.py"
Cohesion: 0.18
...
### Community 505 - "handle_workflow_ide_chat"
Cohesion: 0.18
...
### Community 507 - "skill_registry.py"
Cohesion: 0.13
Nodes (11): _extract_tags(), _first_paragraph(), _fmt_name(), Path, agent/skill_registry.py — Dynamic Skill Registry & Recommender Fetches skill…, Return the first non-empty, non-heading line. Skips YAML frontmatter (--- ...…, Pull hashtags and bold words from markdown as tags., set_skill_registry() (+3 more)
...
### Community 509 - "SKILL: Industrial Brutalism & Tactical Telemetry UI"
Cohesion: 0.12
...
### Community 510 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 511 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 512 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 513 - "Section-by-Section Acceptance Criteria"
Cohesion: 0.12
...
### Community 514 - "provider_max_rpm"
Cohesion: 0.17
...
### Community 515 - "redact_connection_url"
Cohesion: 0.17
...
### Community 516 - "kimi_bridge_provider_config"
Cohesion: 0.18
...
### Community 517 - "agent_readiness_audit.py"
Cohesion: 0.21
...
### Community 520 - "test_activation_api.py"
Cohesion: 0.21
...
### Community 521 - "test_daily_automation_2026_07_11.py"
Cohesion: 0.15
...
### Community 522 - "test_health_endpoints.py"
Cohesion: 0.17
...
### Community 523 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 524 - "test_openclaw_endpoints.py"
Cohesion: 0.12
...
### Community 526 - "test_skill_registry.py"
Cohesion: 0.13
...
### Community 527 - "test_task_service_failed_comment.py"
Cohesion: 0.18
...
### Community 528 - "hermes_prompt.py"
Cohesion: 0.19
...
### Community 530 - "load_registry_sync"
Cohesion: 0.15
Nodes (15): load_registry(), load_registry_sync(), Path, Load and validate the registry from YAML (synchronous; for CLI/tests)., Async loader — file read runs off the event loop (async-I/O rule)., Return repo-relative paths of workflows that run on a cron schedule., _scheduled_workflow_files(), loops_overview() (+7 more)

### Community 531 - "MemoryMiddleware"
Cohesion: 0.17
...
### Community 535 - "Skill: repowise-intelligence"
Cohesion: 0.12
...
### Community 536 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
...
### Community 537 - "_valid_login_state"
Cohesion: 0.24
...
### Community 538 - "Skill: repowise-intelligence"
Cohesion: 0.12
Nodes (15): 1. Graph Intelligence (Dependency Graph), 2. Git Intelligence, 3. Documentation Intelligence, 4. Decision Intelligence, Acceptance Checks, Directory Structure, Example Usage, Implementation Approach (+7 more)

### Community 539 - "The 10-Step Workflow"
Cohesion: 0.12
...
### Community 540 - "Contributing to local-llm-server"
Cohesion: 0.12
...
### Community 541 - "refresh_agent_built_proof.py"
Cohesion: 0.20
...
### Community 542 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 543 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 545 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
...
### Community 546 - "implement_agent.py"
Cohesion: 0.16
...
### Community 547 - "test_agent_chat_integration.py"
Cohesion: 0.23
...
### Community 554 - "test_telegram_auto_approve.py"
Cohesion: 0.21
...
### Community 555 - "ManagedAgentDreams"
Cohesion: 0.22
...
### Community 556 - "_resolve_push_token"
Cohesion: 0.17
...
### Community 557 - "_process_task_callback"
Cohesion: 0.28
...
### Community 559 - "DailyDigestAggregatorTests"
Cohesion: 0.19
...
### Community 560 - "test_dockerfile_ships_root_modules.py"
Cohesion: 0.17
...
### Community 561 - "test_frontend_deployment_guards.py"
Cohesion: 0.20
...
### Community 562 - "test_glm52_brain.py"
Cohesion: 0.12
...
### Community 563 - "test_langfuse_agency_wide.py"
Cohesion: 0.12
...
### Community 564 - "test_local_brain_state.py"
Cohesion: 0.12
...
### Community 565 - "test_orchestrator_merge_decision.py"
Cohesion: 0.27
Nodes (12): _company(), _FakeStore, Company, Tests for the G5 RepoConnection/DeliveryPolicy wiring into the orchestrator…, test_record_consent_noop_for_non_gate_decision(), test_record_consent_noop_without_decision(), test_record_consent_persists_for_first_merge(), test_resolve_direct_push_after_consent() (+4 more)
...
### Community 567 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 568 - "test_refresh_agent_built_proof.py"
Cohesion: 0.12
...
### Community 569 - "test_telegram_diag_endpoint.py"
Cohesion: 0.12
...
### Community 571 - "AgentJobSnapshot"
Cohesion: 0.23
...
### Community 574 - "CollaborationContext"
Cohesion: 0.17
...
### Community 575 - "Skill: agent-harness"
Cohesion: 0.13
...
### Community 576 - "Skill: checkpoint-strategy"
Cohesion: 0.13
...
### Community 578 - "Skill: local-ai-query"
Cohesion: 0.13
...
### Community 579 - "Skill: parallel-agents"
Cohesion: 0.13
...
### Community 580 - "Skill: parallel-worktrees"
Cohesion: 0.13
...
### Community 581 - "Design System: Taste Standard"
Cohesion: 0.13
...
### Community 583 - "Skill: user-research"
Cohesion: 0.13
...
### Community 584 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 585 - "Attention Mechanisms Internals"
Cohesion: 0.13
...
### Community 588 - "test_daily_2026_07_24.py"
Cohesion: 0.20
...
### Community 589 - "_push_down_where"
Cohesion: 0.14
...
### Community 590 - "router/health.py"
Cohesion: 0.20
...
### Community 591 - "DockerAgentAdapter"
Cohesion: 0.17
...
### Community 592 - "probe_model_liveness"
Cohesion: 0.22
...
### Community 594 - "TestDecisionsBotLinks"
Cohesion: 0.17
...
### Community 595 - "DecisionsStore"
Cohesion: 0.30
Nodes (3): DecisionsStore, Any, Connection

### Community 596 - "clear_wizard_state_cache"
Cohesion: 0.21
...
### Community 598 - "test_dockerfile_ships_config_dir.py"
Cohesion: 0.14
...
### Community 600 - "test_scanner_live.py"
Cohesion: 0.23
...
### Community 603 - "analyze_qualitative"
Cohesion: 0.25
...
### Community 606 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 610 - "Checks Performed"
Cohesion: 0.14
...
### Community 611 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 612 - "admin_digest_router.py"
Cohesion: 0.22
...
### Community 613 - "Skill: branch-cleanup"
Cohesion: 0.14
...
### Community 614 - "Skill: perplexity — Web Research via Perplexity API"
Cohesion: 0.14
...
### Community 617 - "Quick-Note Issues Processing Summary"
Cohesion: 0.14
...
### Community 618 - "DirectChatSession"
Cohesion: 0.15
...
### Community 619 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 621 - "Render MCP — autonomous platform debugging and environment monitoring"
Cohesion: 0.14
...
### Community 622 - "Runbook: Auto-Resume After Cooldown / Interruption"
Cohesion: 0.14
...
### Community 623 - "Continual Harness (`agent/harness_spec.py`)"
Cohesion: 0.13
...
### Community 624 - "SEO / GEO / AIO Audit Engine"
Cohesion: 0.14
...
### Community 625 - "Traffic Distribution Across Providers"
Cohesion: 0.14
...
### Community 629 - "ensure_self_company"
Cohesion: 0.22
Nodes (13): ensure_self_company(), _find_stale_self_companies(), Return companies that look like a previous self-bootstrap run but have a stale…, Idempotently register the platform as its own company and kick off the agency.…, _self_domain(), Tests for the self-onboarding bootstrap. The platform should register itself as…, When onboarding is 'complete' but 0 specialists exist, the bootstrap should…, When the company exists with onboarding='complete' AND has specialists, the… (+5 more)

### Community 630 - "_RedisBackend"
Cohesion: 0.22
...
### Community 632 - "test_critical_flows.py"
Cohesion: 0.29
...
### Community 633 - "TestAnthropicToolListCaching"
Cohesion: 0.34
...
### Community 634 - "test_brain_failover_413.py"
Cohesion: 0.15
...
### Community 636 - "test_openclaw_gateway.py"
Cohesion: 0.14
...
### Community 637 - "test_provider_state_durability.py"
Cohesion: 0.15
...
### Community 638 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 640 - "register_user_research_tools"
Cohesion: 0.21
...
### Community 643 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 646 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 647 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 650 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
...
### Community 651 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 652 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 654 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 659 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
Nodes (12): Acceptance Checks, Claude's query protocol (use this instead of Read tool for exploration):, Graph Artifacts — What to Commit, How to Use the Graph (Token Savings Protocol), Installation (one-time per machine), Instead of reading raw files:, Key commands:, Relationship to repowise-intelligence Skill (+4 more)

### Community 660 - "Skill: platform-setup — Autonomous Agency Bootstrap"
Cohesion: 0.15
...
### Community 661 - "Device compatibility and model picks"
Cohesion: 0.15
...
### Community 662 - "Autonomy Uplift — Living Roadmap & Detailed Implementation Specs"
Cohesion: 0.15
...
### Community 663 - "OpenClaw — iOS Control of the Agency (Single-Service Free-Tier Deploy)"
Cohesion: 0.15
...
### Community 667 - "_is_bedrock_model_id"
Cohesion: 0.27
...
### Community 669 - "Agent Transparency Report"
Cohesion: 0.15
...
### Community 670 - "update_provider_policy"
Cohesion: 0.19
...
### Community 672 - "_InMemoryBackend"
Cohesion: 0.18
...
### Community 673 - "TestAgentRunnerSafety"
Cohesion: 0.19
...
### Community 674 - "TestModelCostTableUpdates"
Cohesion: 0.26
...
### Community 675 - "test_deploy_trigger_covers_image.py"
Cohesion: 0.21
...
### Community 676 - "TestKillSwitchDurability"
Cohesion: 0.15
...
### Community 678 - "WorkspaceManifest"
Cohesion: 0.17
...
### Community 679 - "TestPreCompiledPatterns"
Cohesion: 0.22
...
### Community 681 - "AGENTS.md — Codebase Map & Operations Reference"
Cohesion: 0.17
...
### Community 686 - "Skill: system-prompt-audit"
Cohesion: 0.17
...
### Community 687 - "Skill: task-alive-updates"
Cohesion: 0.17
...
### Community 690 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 693 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 695 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 696 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 697 - "Workspace Isolation Architecture"
Cohesion: 0.17
...
### Community 698 - "Quantization Internals"
Cohesion: 0.17
...
### Community 699 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 700 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 701 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 702 - "_looks_unknown_model"
Cohesion: 0.20
...
### Community 705 - "check_container_posture.py"
Cohesion: 0.26
...
### Community 706 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 707 - "test_admin_local_brain_router.py"
Cohesion: 0.29
...
### Community 708 - "test_agile_api.py"
Cohesion: 0.17
...
### Community 709 - "test_app_settings.py"
Cohesion: 0.21
...
### Community 710 - "test_providers_live_e2e.py"
Cohesion: 0.27
...
### Community 711 - "TestAnthropicPayloadStructuredOutput"
Cohesion: 0.29
...
### Community 714 - "_extractive_compress"
Cohesion: 0.18
...
### Community 717 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 720 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 721 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 723 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 726 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 727 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 728 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 729 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 730 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 731 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 732 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 733 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 735 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 736 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 737 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 738 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 739 - "What to clean up"
Cohesion: 0.18
...
### Community 740 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 747 - "test_agent_readiness_audit.py"
Cohesion: 0.18
...
### Community 748 - "TestIsDnsFailure"
Cohesion: 0.18
Nodes (6): Exception, parametrize, httpx wraps the resolver error — the cause chain must be walked., Some stacks lose the cause and keep only the resolver text., A cyclic __cause__ must not hang the probe., TestIsDnsFailure

### Community 749 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 750 - "test_event_log.py"
Cohesion: 0.45
...
### Community 751 - "test_google_provider_models.py"
Cohesion: 0.18
...
### Community 752 - "test_tasks_awaiting_approval_api.py"
Cohesion: 0.40
...
### Community 756 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 757 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 758 - "admin_local_brain_router.py"
Cohesion: 0.22
...
### Community 760 - "_normalize_tool_choice"
Cohesion: 0.31
...
### Community 761 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 762 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 763 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 764 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 765 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 766 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 767 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 768 - "Agent Readiness Report"
Cohesion: 0.20
...
### Community 770 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 771 - "LLM Router — configuration guide"
Cohesion: 0.20
...
### Community 772 - "LLM Router — provider guide"
Cohesion: 0.20
...
### Community 773 - "CI Troubleshooting Runbook"
Cohesion: 0.20
...
### Community 775 - "build_tech_db.py"
Cohesion: 0.40
...
### Community 778 - "_redact_for_notification"
Cohesion: 0.24
...
### Community 779 - "TestExtendedThinkingRouting"
Cohesion: 0.20
...
### Community 780 - "TestZeroAttemptDiagnostics"
Cohesion: 0.29
...
### Community 781 - "TestHarnessRegistry"
Cohesion: 0.20
...
### Community 782 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 784 - "test_quick_note_engine.py"
Cohesion: 0.22
...
### Community 785 - "test_version_consistency.py"
Cohesion: 0.20
...
### Community 790 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 791 - "Skill: changelog-enforcer"
Cohesion: 0.22
...
### Community 792 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 794 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 795 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 796 - "Skill: changelog-enforcer"
Cohesion: 0.22
Nodes (8): Acceptance Checks, Changelog Location, Entry Format, Examples, Hook Behaviour, Instructions, Skill: changelog-enforcer, When to Use

### Community 797 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
Nodes (8): Branch, Components, Purpose, Quick Start, Session Roles, Skill: cowork-session (Claude Cowork), Testing, When to Use

### Community 798 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 799 - "Active Task Tracker"
Cohesion: 0.22
...
### Community 801 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 802 - "Main proxy (`proxy.py`)"
Cohesion: 0.22
...
### Community 803 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 804 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 805 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 806 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 807 - "Platform Controls"
Cohesion: 0.22
...
### Community 808 - "Release Procedure"
Cohesion: 0.22
...
### Community 809 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 811 - "ENGINEERING_STANDARDS.md — Patterns & Reference"
Cohesion: 0.22
...
### Community 817 - "enrich_quick_note_issues.py"
Cohesion: 0.42
...
### Community 818 - "_start_ceo_agency"
Cohesion: 0.31
...
### Community 820 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 821 - "test_changelog_parity_guard.py"
Cohesion: 0.22
...
### Community 823 - "TestPaidPolicyDurability"
Cohesion: 0.22
...
### Community 824 - "test_scanner_deps_parity.py"
Cohesion: 0.31
...
### Community 828 - "agent/output_filter.py"
Cohesion: 0.32
...
### Community 832 - "quality_checker.py"
Cohesion: 0.32
...
### Community 834 - "_parse_tool_calls_from_response"
Cohesion: 0.39
...
### Community 845 - "AGENTS.md — AI Agent Configuration for local-llm-server"
Cohesion: 0.25
...
### Community 846 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 847 - "ceo-micromanagement.md"
Cohesion: 0.25
Nodes (4): P0 behavior change, Readiness contract, Runtime model, Runtime types

### Community 848 - "Feature Maturity / Support Matrix"
Cohesion: 0.25
...
### Community 851 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.25
...
### Community 852 - "Issue #362: Nvidia repo setup"
Cohesion: 0.25
...
### Community 853 - "Issue #364: quick-note:https://www.marktechpost.com/2026/06/01/meet-memory-os-a-6-layer-open-source-memory-stack-built-on-top-of-hermes-agent/"
Cohesion: 0.25
...
### Community 854 - "Issue #378: quick-note:https://www.marktechpost.com/2026/06/02/tinyfish-launches-bigset-an-open-source-multi-agent-system-that-builds-structured-live-datasets-from-plain-english-descriptions/"
Cohesion: 0.25
...
### Community 855 - "Issue #379: quick-note:https://searchengineland.com/schema-markup-optimize-agentic-web-479080"
Cohesion: 0.25
...
### Community 856 - "Issue #380: quick-note:https://cursor.com/blog/cloud-agent-lessons"
Cohesion: 0.25
...
### Community 857 - "Issue #381: quick-note:https://www.xda-developers.com/claude-code-with-opus-48-is-expensive-but-i-made-it-efficient-with-my-local-ai-workflow/"
Cohesion: 0.25
...
### Community 858 - "Issue #382: quick-note:https://claude.com/blog/how-coderabbit-used-claude-to-build-an-agent-orchestration-system"
Cohesion: 0.25
...
### Community 859 - "Issue #383: quick-note:https://www.marktechpost.com/2026/05/29/hexo-labs-open-sources-sia-a-self-improving-agent-that-updates-both-the-harness-and-the-model-weights/"
Cohesion: 0.25
...
### Community 860 - "Issue #416: feat: Self-hosted Codebuff (freebuff) on free NVIDIA models + Telegram bot phone control"
Cohesion: 0.25
...
### Community 861 - "Issue #485: [Trend Digest] Week of 2026-06-08"
Cohesion: 0.25
...
### Community 862 - "Issue #488: quick-note:https://github.com/cookiy-ai/user-research-skill"
Cohesion: 0.25
...
### Community 863 - "Issue #491: Implement whatever is necessary from https://github.com/BehiSecc/awesome-claude-skills"
Cohesion: 0.25
...
### Community 864 - "Issue #493: Use the https://github.com/mvanhorn/last30days-skill skill to get the trend updated"
Cohesion: 0.25
...
### Community 865 - "Issue #495: Read https://www.anthropic.com/news/claude-fable-5-mythos-5 and understand if mythos or fable can be added to the repo"
Cohesion: 0.25
...
### Community 866 - "Issue #504: EPIC: Autonomy hardening — live-verified defects 2026-06-10"
Cohesion: 0.25
...
### Community 867 - "Issue #581: Sprint tracker: pending work after brand rename + mobile-first pass"
Cohesion: 0.25
...
### Community 869 - "Issue #657: quick-note:https://github.com/earendil-works/pi"
Cohesion: 0.25
...
### Community 870 - "Issue #659: quick-note:https://github.com/nex-agi/Nex-N2"
Cohesion: 0.25
...
### Community 871 - "Issue #660: quick-note:https://github.com/getsentry/sentry-for-ai"
Cohesion: 0.25
...
### Community 872 - "Issue #661: quick-note:https://github.com/XiaomiMiMo/MiMo-Code"
Cohesion: 0.25
...
### Community 873 - "Issue #664: quick-note:https://github.com/Grominet95/jarvis-OS"
Cohesion: 0.25
...
### Community 874 - "Issue #666: quick-note:https://github.com/porokka/jarvis-os"
Cohesion: 0.25
...
### Community 875 - "Issue #670: quick-note:https://github.com/perplexityai/bumblebee"
Cohesion: 0.25
...
### Community 876 - "Issue #672: quick-note:https://github.com/Chachamaru127/claude-code-harness"
Cohesion: 0.25
...
### Community 877 - "Issue #676: quick-note:https://github.com/WeiboAI/VibeThinker"
Cohesion: 0.25
...
### Community 878 - "Issue #820: quick-note:https://github.com/cobusgreyling/loop-engineering"
Cohesion: 0.25
...
### Community 879 - "Positional Encoding Internals"
Cohesion: 0.25
...
### Community 881 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 882 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 883 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 884 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 885 - "Prime Agent Runtime"
Cohesion: 0.25
...
### Community 889 - "capture_screens.py"
Cohesion: 0.39
...
### Community 892 - "run_patched_colibri.py"
Cohesion: 0.36
...
### Community 896 - "test_compose_and_coordinate_api.py"
Cohesion: 0.36
...
### Community 897 - "test_generate_context_standing_instructions.py"
Cohesion: 0.32
...
### Community 898 - "test_local_brain_router_smoke.py"
Cohesion: 0.25
...
### Community 900 - "test_provider_models_db_outage.py"
Cohesion: 0.25
...
### Community 901 - "test_runtimes_health_endpoint.py"
Cohesion: 0.25
...
### Community 902 - "test_seo_audit_pending_expiry.py"
Cohesion: 0.43
...
### Community 904 - "test_serve_spa_prefixes.py"
Cohesion: 0.36
...
### Community 905 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.25
...
### Community 907 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 916 - "AI Engineering Insights Skill"
Cohesion: 0.29
...
### Community 928 - "Implementation plan + TO-DO (check off as you go)"
Cohesion: 0.29
...
### Community 940 - "e2e_smoke.py"
Cohesion: 0.57
Nodes (5): _chat(), check(), _health(), _models(), _req()

### Community 941 - "task_runner.py"
Cohesion: 0.33
...
### Community 946 - "test_daily_2026_06_14.py"
Cohesion: 0.38
...
### Community 947 - "TestSupportMatrixDocsSync"
Cohesion: 0.29
...
### Community 948 - "TestGithubTokenSQLiteRegression"
Cohesion: 0.38
...
### Community 949 - "TestProvidersScreen"
Cohesion: 0.43
...
### Community 968 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 969 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 970 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 971 - "The full agent capability roster"
Cohesion: 0.33
...
### Community 972 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 973 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 974 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 976 - "resolve_hermes_base_url"
Cohesion: 0.47
...
### Community 977 - "apply_phase1_changes.py"
Cohesion: 0.33
...
### Community 988 - "TestDirectChatAgentExecution"
Cohesion: 0.33
...
### Community 989 - "TestWorkflowIntegration"
Cohesion: 0.33
...
### Community 1006 - "Who is this for?"
Cohesion: 0.40
...
### Community 1007 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 1008 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 1009 - "Runtime troubleshooting"
Cohesion: 0.40
Nodes (4): Agent mode timeout, Missing binary / task harness, Runtime troubleshooting, Workspace validation failures

### Community 1010 - "knowledgeGraphTab.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 1011 - "loginFlowNoTimeout.test.js"
Cohesion: 0.40
Nodes (4): apiSource, { describe, test, expect }, fs, path

### Community 1012 - "test_company_stale_id_recovery.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 1013 - "worker_no_cache.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, workerSource

### Community 1014 - "scripts/agile_ceremonies.py"
Cohesion: 0.60
...
### Community 1016 - "_github_login_url"
Cohesion: 0.40
...
### Community 1020 - "_add_colibri_shim_changelog_entry.py"
Cohesion: 0.50
...
### Community 1021 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1022 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1023 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 1024 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 1025 - "setup_colibri.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1026 - "setup_colibri.sh script"
Cohesion: 0.70
Nodes (4): setup_colibri.sh script, fail(), ok(), warn()

### Community 1027 - "status_colibri_server.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1029 - "TestMobileNavigation"
Cohesion: 0.40
Nodes (3): Mobile-specific: hamburger menu, responsive layout., Verify key pages load in mobile viewport., TestMobileNavigation

### Community 1030 - "test_v5_screens_smoke.py"
Cohesion: 0.50
...
### Community 1031 - "test_agent_runtime_wrapper.py"
Cohesion: 0.70
...
### Community 1032 - "TestFailoverRegistryBaseUrls"
Cohesion: 0.40
...
### Community 1033 - "TestTelegramNotifications"
Cohesion: 0.40
...
### Community 1034 - "TestDirectChatNonBlocking"
Cohesion: 0.40
...
### Community 1035 - "TestModelRoleSeparation"
Cohesion: 0.40
...
### Community 1053 - "stop_colibri_server.ps1"
Cohesion: 0.83
Nodes (3): Fail(), Ok(), W()

### Community 1054 - "_probe_openai_compat"
Cohesion: 0.50
...
### Community 1057 - "start_server.sh"
Cohesion: 0.50
Nodes (3): OLLAMA_HOST, OLLAMA_MODELS, start_server.sh script

### Community 1058 - "check_services"
Cohesion: 0.67
...
### Community 1068 - "test_no_exception_detail_leaks.py"
Cohesion: 0.50
...
### Community 1069 - "test_skills_route_order.py"
Cohesion: 0.67
...
### Community 1070 - "github"
Cohesion: 0.50
Nodes (3): github, enabled, silent

### Community 1074 - "Configuration reference"
Cohesion: 0.67
Nodes (3): Configuration reference, Provider priority chain, Running the brain on local Ollama (via a tunnel)

### Community 1096 - "test_the_reserve_is_bounded_when_read_from_the_environment"
Cohesion: 0.67
...
### Community 1198 - "test_e2b_data_flow.py"
Cohesion: 0.07
Nodes (30): fake_sandbox(), _FakeAsyncSandboxClass, _FakeCmdResult, _FakeCommands, _FakeFiles, _FakeSandbox, Any, asyncio (+22 more)

### Community 1199 - "LlmProviderConfig"
Cohesion: 0.17
Nodes (28): _anthropic_headers(), _anthropic_payload(), _anthropic_response_text(), _auth_headers(), chat_completion_text(), list_openai_models(), LlmProviderConfig, normalize_base_url() (+20 more)

### Community 1200 - "TestDetectedSystemPersistence"
Cohesion: 0.09
...
### Community 1201 - ".start_onboarding"
Cohesion: 0.09
Nodes (13): get_skill_registry_safe(), Return the global SkillRegistry if set, else None. Used by onboarding and other…, Workflow, Detect the Git provider from a repository URL. Args: repo_url: Repository URL…, Start the onboarding process for a company. Args: company_id: Company ID…, Schedule a fire-and-forget background task, keeping a strong reference.…, Force-refresh the dynamic skill registry and log tech-stack recommendations.…, Activate a company's 24x7 agency runtimes in the background. Runs after… (+5 more)

### Community 1202 - "TaskHarnessAdapter"
Cohesion: 0.12
...
### Community 1203 - "_is_ephemeral_user"
Cohesion: 0.27
...
### Community 1204 - "has_image_content"
Cohesion: 0.31
Nodes (3): has_image_content(), Return True if any message contains an image_url content part., TestHasImageContent

## Knowledge Gaps
- **3447 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3442 more)
...
- **Why does `_fixture()` connect `_fixture` to `brain_config.py`, `TaskSpec`, `resolve_identity`, `test_agent_tool_governance.py`, `E2BSandboxSession`, `test_governance_enforcement.py`, `llm/router.py`, `WebsiteScanner`, `test_openclaw_endpoints.py`, `test_operational_incidents.py`, `resolve_active_brain`, `test_llm_router_strategies.py`, `test_task_service_failed_comment.py`, `TaskStore`, `SelfHealingAgent`, `TaskWorkflowService`, `config.py`, `Task`, `Agency`, `_clean_director`, `types.py`, `services/background.py`, `test_failover_client_shared.py`, `SQLiteStore`, `test_unit8_model_catalog.py`, `PrimeAgentAdapter`, `sam`, `test_telegram_auto_approve.py`, `_resolve_push_token`, `test_sam_livekit.py`, `test_autonomy_status.py`, `ImprovementLoop`, `UserRole`, `test_local_brain_state.py`, `test_model_router.py`, `FreeBuffAgent`, `test_phase5_doctor.py`, `AgentSwarm`, `test_refresh_agent_built_proof.py`, `_ts_to_float`, `test_telegram_diag_endpoint.py`, `test_knowledge_sync.py`, `ChatHistoryStore`, `AgentProfile`, `TokenBudget`, `ResearchTask`, `services/seo_audit.py`, `TestClient`, `e2e/test_browser.py`, `test_ai_insights.py`, `ArtifactStore`, `test_procedural_memory.py`, `test_control_plane_api.py`, `test_startup_warmup.py`, `test_provider_router.py`, `ScheduledJob`, `test_llm_router_tpm.py`, `test_context_rulebook.py`, `test_brain_failover_413.py`, `TestHarnessAdapter`, `test_openclaw_gateway.py`, `test_provider_state_durability.py`, `clear_cooldowns`, `test_webui_provider_priority.py`, `_StubProvider`, `BackgroundAgent`, `test_ceo_router.py`, `api_keys_for`, `CEOLedger`, `test_new_features_e2e.py`, `claim`, `persist_plan_spec`, `FeatureMaturity`, `run_task`, `_Budget`, `test_daily_2026_07_27.py`, `TestAgentRunnerSafety`, `test_e2b_task_wiring.py`, `KeyStore`, `OllamaCircuitBreaker`, `test_e2b_data_flow.py`, `NotificationDispatcher`, `TestRuntimeControl`, `test_features_api.py`, `test_video_transcript.py`, `TrendWatcher`, `BrainWatchdog`, `test_agile_api.py`, `test_app_settings.py`, `test_portfolio_intake.py`, `test_trend_watcher.py`, `TaskExecutionCoordinator`, `TestEstimateTokensForMessages`, `test_llm_router_disabled.py`, `TestClient`, `DirectChatDoctor`, `ContextPruner`, `KeyRing`, `test_issue_intake.py`, `test_persistent_memory.py`, `SecurityScanner`, `get_registry`, `test_brain_failover.py`, `test_llm_router_e2e.py`, `OutputFilter`, `test_platform_controls.py`, `TestHarnessRegistry`, `test_rate_limiter.py`, `TestMongoGate`, `test_sam_voice.py`, `OrchestratorQueue`, `analyze_page`, `timedelta`, `TestNormalizeResponseFormat`, `session_retro.py`, `test_purge_backlog.py`, `test_telegram_mutating_commands.py`, `test_direct_chat_async.py`, `tests/conftest.py`, `_start_ceo_agency`, `TestSwarmRoleRouting`, `SeoFixRequest`, `_get`, `test_crispy_burn_in.py`, `TestMCPServer`, `test_skill_registry_boot_refresh.py`, `isolated_telegram_config`, `test_scheduler_hydration_bounded.py`, `get_current_user`, `test_provider_enable_disable.py`, `test_direct_chat_evolution.py`, `test_service_token.py`, `test_harness_spec.py`, `test_regression.py`, `test_agency_fix.py`, `platform_controls_router.py`, `test_ping.py`, `test_runtimes_health_endpoint.py`, `OrchestratorCheckpointStore`, `test_monitor_lib.py`, `test_task_store_fails_loud_in_production.py`, `test_v4_api.py`, `allow_paid`, `test_task_clarification.py`, `test_agent_free_brain.py`, `client`, `test_kimi_bridge_server.py`, `test_voice_pipeline.py`, `test_dashboard_cache.py`, `cost_tracker.py`, `parse_event_stream`, `test_brain_patch_service_token.py`, `_mock_provider_records`, `TestRouterIntegration`, `test_company_api.py`, `test_telegram_service_webhook.py`?**
  _High betweenness centrality (0.099) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `direct_chat.py`, `TaskSpec`, `ReactScratchpad`, `proxy.py`, `test_agent_tool_governance.py`, `resolve_identity`, `ContextManager`, `E2BSandboxSession`, `BackgroundAgent`, `LocalWorkspace`, `test_daily_automation_2026_07_11.py`, `test_governance_enforcement.py`, `Agency`, `StuckDetector`, `TestAgentRunnerSafety`, `test_agent_chat_integration.py`, `MultiAgentSwarm`, `test_failover_client_shared.py`, `test_e2b_adapter.py`, `test_agent_free_brain.py`, `loop.py`, `_resolve_push_token`, `test_direct_chat_async.py`, `WorkflowRun`, `WorkspaceTools`, `FreeBuffAgent`, `ExecutionRequest`, `test_backend_server_features.py`, `TestMCPServer`, `UserMemoryStore`, `TokenBudget`, `AgentSessionStore`, `AgentPlan`, `TestAgentRunnerExecution`, `CEODispatcher`, `test_provider_router.py`, `ContextPruner`, `GitHubTools`, `test_empirical_verify.py`, `AdaptiveHalter`, `test_brain_failover_413.py`, `InternalAgentAdapter`, `workflow_orchestrator.py`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `AgentScheduler` connect `AgentScheduler` to `backend/server.py`, `services/background.py`, `test_purge_backlog.py`, `proxy.py`, `ScheduledJob`, `test_force_cleanup_conditional_delete.py`, `.force_cleanup`, `test_schedule_backlog_drain.py`, `TaskWorkflowService`, `start_background_services`, `ScheduleStore`, `test_schedule_growth_invariants.py`, `test_schedule_persistence.py`, `test_control_plane_api.py`?**
...
- **Are the 105 inferred relationships involving `AgentRunner` (e.g. with `MultiAgentSwarm` and `AdaptiveHalter`) actually correct?**
  _`AgentRunner` has 105 INFERRED edges - model-reasoned connections that need verification._
...
- **Should `backend/server.py` be split into smaller, more focused modules?**
  _Cohesion score 0.014666300466904697 - nodes in this community are weakly interconnected._