# Graph Report - local-llm-server  (2026-08-21)

## Corpus Check
- 1445 files · ~2,080,731 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 28811 nodes · 53810 edges · 1192 communities (1079 shown, 113 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 2642 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c38a4d7d`
...
## Communities (1192 total, 113 thin omitted)

### Community 0 - "_fixture"
Cohesion: 0.01
Nodes (127): parse_event_stream(), ParsedRun, Structured view of one ``--mode json`` event stream., Reduce a ``--mode json`` NDJSON stream to a :class:`ParsedRun`. Kept a module-…, app_client(), _clear_discovered_models(), _clear_response_cache(), client() (+119 more)

### Community 1 - "test_operational_incidents.py"
Cohesion: 0.02
Nodes (154): DetectedIssue, IssueCategory, IssueSeverity, Enum, str, Build a rich, structured GitHub issue body with actionable context. Unlike the…, _diagnose_and_file(), _file_incident() (+146 more)
...
Cohesion: 0.02
Nodes (165): get_sam(), agent/sam.py — SAM Voice Agent (System Autonomy Manager) SAM is the voice-…, admin_seed(), _agent_timeout_fallback_response(), AgentStatusEntry, AgentStatusResponse, AgentToolCallEntry, ApiKeyCreate (+157 more)
...
Cohesion: 0.02
Nodes (130): Attempt, _load(), main(), int, FailoverResult, A successful completion plus the accounting its callers need., Catalog entries for router-configured providers missing from the YAML. Never…, get_budget() (+122 more)
...
Cohesion: 0.02
Nodes (103): CacheManager, cosine_similarity(), _Entry, LRUCache, payload_key(), Any, T, Live (unexpired) entries — used by the semantic layer's scan. (+95 more)
...
### Community 14 - "AnthropicProvider"
Cohesion: 0.04
Nodes (63): AnthropicProvider, Any, AsyncClient, packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, Translate OpenAI-shaped messages into Anthropic's system/turn split., OpenAI carries a tool result as role="tool" with a tool_call_id; Anthropic…, OpenAI puts a tool call alongside the assistant's text; Anthropic needs…, Anthropic's extended-thinking constraints on ``budget_tokens``: at least 1024,… (+55 more)

### Community 15 - "ImprovementLoop"
Cohesion: 0.04
Nodes (83): Agency, AgencyCycleResult, AgentDirective, AgentRole, _build_ceo_prompt(), _build_quick_note_instruction(), _collect_recent_git_context(), get_agency() (+75 more)
...
### Community 17 - "test_llm_router_resilience.py"
Cohesion: 0.03
Nodes (101): Backoff policy for retryable failures., RetryConfig, auto_disable(), _billing_signals(), disabled_provider_ids(), is_unfixable(), packages/llm/disabled.py — bridge to the durable provider on/off switch. The…, Provider ids currently switched off. Empty when the store is unreachable. (+93 more)

### Community 18 - "brain_config.py"
Cohesion: 0.03
Nodes (110): Call-time resolver for an agent role model id. Delegates to…, _resolve_role_model(), BrainConfig, BrainConfigPatch, BrainConfigStore, default_brain_config(), get_brain_config(), get_brain_config_store() (+102 more)

### Community 19 - "test_ceo_supervision.py"
Cohesion: 0.03
Nodes (97): _harvest_changed_files(), Extract the files a runtime touched. Returns ``(files, reported)``. Adapters…, Attempt, _backend(), CEOLedger, GoalRecord, _now(), Any (+89 more)
...
Cohesion: 0.04
Nodes (76): kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, TaskResult, TaskSpec, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Run aider non-interactively via `--message` flag., runtimes/adapters/claude_code.py — Claude Code CLI adapter (FIRST CLASS).…, runtimes/adapters/docker_agent.py — Docker-based agent runtime adapter. Spawns… (+68 more)
...
Cohesion: 0.03
Nodes (87): _apply_env_overrides(), _apply_key_env(), _build(), _coerce(), config_dir(), _env_key_names(), expand_env(), _fields_of() (+79 more)

### Community 25 - "test_runtimes.py"
Cohesion: 0.04
Nodes (51): OpenHandsAdapter, Any, TaskResult, TaskSpec, Create a conversation in OpenHands and poll for completion., Adapter for OpenHands — TIER 2 / EXPERIMENTAL coding agent. NOTE: OpenHands…, Raised when a runtime fails readiness validation before execution starts., RuntimePreflightError (+43 more)
...
### Community 27 - "Task"
Cohesion: 0.04
Nodes (77): Task, Creates tasks from scheduler and playbook runs using one workflow., TaskAutomationService, ApprovalCheckpoint, Full task/issue document., Human approval gate in a task's execution., Task, Owns lifecycle transitions, comment semantics, and approval rules. (+69 more)
...
Cohesion: 0.04
Nodes (92): Replace the process-wide store. Tests only., reset_approval_store(), AuditLog, get_audit_log(), packages/governance/audit.py — the evidence trail for every governed action.…, Redact secret-shaped substrings, then truncate., Bounded in-memory ring buffer plus a structured log stream. The ring buffer…, Store and emit *event*. Never raises. (+84 more)

### Community 32 - "WorkflowRun"
Cohesion: 0.03
...
Cohesion: 0.04
Nodes (79): _egress_policy_reason(), Return why governance policy blocks *host*, or None. Runs strictly *after* the…, _load(), Import the governance layer once, recording why if it is absent., _action_matches(), _as_list(), Decision, get_policy_engine() (+71 more)

### Community 34 - "RenderOpsMonitor"
Cohesion: 0.06
...
Cohesion: 0.03
Nodes (92): livenim, allow_paid_brain(), BrainResolution, get_active_brain_sync(), get_provider_role_tags(), _host_is_openai_compatible(), invalidate_brain_cache(), _norm() (+84 more)
...
### Community 38 - "ProviderRouter"
Cohesion: 0.04
Nodes (69): _acquire_provider_probe(), CommercialFallbackRequiredError, extract_openai_text(), _get_director(), _normalize_nvidia_base_url(), _normalized_provider_type(), _openai_url(), ProviderAttempt (+61 more)

### Community 39 - "services/background.py"
Cohesion: 0.05
...
### Community 44 - "test_governance_enforcement.py"
Cohesion: 0.04
Nodes (77): Recursively strip secrets from an arbitrary argument structure. Fails…, scrub(), BudgetTracker, GovernanceGate, Holds live session budgets, bounded so it cannot leak. Sessions end without…, The one seam through which governed actions pass., AgentIdentity, _coerce_text() (+69 more)

### Community 45 - "test_unit8_model_catalog.py"
Cohesion: 0.04
Nodes (70): _brain_provider_status(), Return per-provider metadata for the GET endpoint. Iterates every provider in…, all_provider_ids(), _provider_ids_from_literal(), provider_key_present(), Resolve the model id for a component's role on a provider. Parameters…, Return every provider id recognised by the brain config system. Iterates the…, True when the env var for *provider*'s key is set (or it's Ollama). (+62 more)
...
### Community 48 - "TaskExecutionCoordinator"
Cohesion: 0.04
Nodes (54): _gate_outward_facing_enabled(), _is_brain_connection_error(), _is_outward_facing(), Any, BaseException, Task, TaskResult, TaskSpec (+46 more)

### Community 49 - "test_failover_client_shared.py"
Cohesion: 0.07
...
### Community 51 - "test_user_research_skill.py"
Cohesion: 0.05
...
Cohesion: 0.04
Nodes (52): PreflightReport, AgentJob, AgentJobManager, make_isolated_workspace(), _now(), Any, Path, agent/job_manager.py — Async agent job lifecycle manager. Manages agent jobs… (+44 more)

### Community 61 - "test_llm_router_gateway.py"
Cohesion: 0.04
...
### Community 64 - "test_sam_livekit.py"
Cohesion: 0.04
...
### Community 68 - "test_governance_api.py"
Cohesion: 0.04
Nodes (62): build_governance_router(), Any, APIRouter, backend/governance_router.py — read and operate the governance layer. Mounted…, Reject non-admin callers. Mirrors the RBAC check used elsewhere in this backend…, _require_admin(), get_approval_store(), AuditEvent (+54 more)
...
Cohesion: 0.05
Nodes (44): _fake_artifact(), _make_engine(), tests/test_crispy_workflow.py — CRISPY workflow engine hardening tests. Tests…, Create a WorkflowEngine with isolated storage., TestAbortOnFailure, TestPhaseSequence, TestPhaseSequenceError, TestWorkspaceIsolation (+36 more)

### Community 72 - "get_task_store"
Cohesion: 0.05
...
### Community 78 - "start_background_services"
Cohesion: 0.04
...
### Community 79 - "get_scheduler"
Cohesion: 0.04
Nodes (43): autonomy_tick(), legacy_scheduler_delete(), legacy_scheduler_get(), Execute ONE pending task synchronously. Called by the cron workflow every 2…, get_scheduler(), agent/scheduler.py — Scheduled Agent Jobs Cron-based job scheduler. Each job…, set_scheduler(), create_schedule() (+35 more)
...
### Community 82 - "TestAdapterMetadata"
Cohesion: 0.04
Nodes (27): AiderAdapter, Any, Adapter for Aider — TIER 3 specialized git-aware code editor., HermesAdapter, Any, AsyncClient, Response, TaskResult (+19 more)
...
Cohesion: 0.05
Nodes (51): delegate_seo_findings(), _expire_stale_pending_report(), get_seo_audit(), list_seo_audits(), BaseModel, get, post, SEO / GEO / AIO Audit API Router Endpoints for the world-class SEO audit engine… (+43 more)
...
Cohesion: 0.04
Nodes (41): Result of provisioning a specialist., A specialist agent that can be provisioned for company-specific tasks., Check if this specialist can handle a task with given capabilities., Specialist, SpecialistProvisionResult, SystemType, Add a specialist to a company. Args: company_id: Company ID name: Specialist…, Get a specialist by ID. (+33 more)
...
### Community 91 - "test_startup_warmup.py"
Cohesion: 0.04
...
### Community 93 - "test_runtime_governance.py"
Cohesion: 0.06
Nodes (50): CircuitState, Return the last-known health for *runtime_id* (may be stale)., Return True if the runtime is available (not circuit-open)., Return health snapshots for all known runtimes., Force an immediate health check of all runtimes and return results., Attempt to start a dead runtime subprocess before re-probing. Uses the local…, Reduce probe frequency for runtimes that have never come online., Async health polling service for all registered runtimes. (+42 more)

### Community 94 - "ArtifactStore"
Cohesion: 0.06
...
Cohesion: 0.05
Nodes (45): BudgetExceeded, classify(), evaluate_call(), get_gate(), governance_enabled(), guard_tool_call(), GuardResult, _host_of() (+37 more)

### Community 103 - "KnowledgeGraph"
Cohesion: 0.05
...
### Community 108 - "probe_model_liveness"
Cohesion: 0.05
...
### Community 119 - "test_autonomous_agency_e2e.py"
Cohesion: 0.06
...
### Community 134 - "CompanyGraphService"
Cohesion: 0.03
Nodes (68): get_skill_registry_safe(), Return the global SkillRegistry if set, else None. Used by onboarding and other…, BusinessCategory, A company website with detected systems and stack inference., Website, CompanyGraphService, Company, SpecialistFamily (+60 more)

### Community 135 - "clear_cooldowns"
Cohesion: 0.06
...
### Community 136 - "test_webui_provider_priority.py"
Cohesion: 0.06
...
### Community 138 - "test_issue_intake.py"
Cohesion: 0.08
...
### Community 142 - "ProviderConfig"
Cohesion: 0.06
Nodes (43): is_commercial_provider(), provider_access_tier(), _provider_field(), provider_sort_key(), ProviderConfig, local_brain_enabled(), local_brain_provider_config(), local_brain_status() (+35 more)
...
### Community 144 - "skill_bindings.py"
Cohesion: 0.06
...
### Community 145 - "test_telegram_freebuff.py"
Cohesion: 0.07
...
### Community 146 - "test_bedrock_provider.py"
Cohesion: 0.06
...
### Community 148 - "TestHarnessAdapter"
Cohesion: 0.05
...
### Community 166 - "test_platform_controls.py"
Cohesion: 0.06
...
### Community 167 - "test_pr923_fixes.py"
Cohesion: 0.06
...
### Community 169 - "test_colibri_brain_shim.py"
Cohesion: 0.07
...
### Community 170 - "test_e2b_adapter.py"
Cohesion: 0.07
...
### Community 191 - "Part A — CodeRabbit review fixes for this PR (do first, small)"
Cohesion: 0.05
...
### Community 192 - "Docker Agent Runtimes Setup"
Cohesion: 0.05
...
Cohesion: 0.07
Nodes (40): _auto_disable(), _describe_registry(), _disabled_ids(), _is_billing_refusal(), _is_ollama(), _key_pool(), _log_exhaustion(), _log_recovery() (+32 more)
...
### Community 197 - "TestBrainFailoverModelUpdates"
Cohesion: 0.08
...
### Community 198 - "test_e2b_data_flow.py"
Cohesion: 0.07
...
### Community 202 - "get_failover_manager"
Cohesion: 0.07
...
### Community 203 - "emit_chat_observation"
Cohesion: 0.09
...
### Community 212 - "test_portfolio_intake.py"
Cohesion: 0.09
...
### Community 214 - "test_trend_watcher.py"
Cohesion: 0.08
...
### Community 216 - "control_overrides.py"
Cohesion: 0.08
...
### Community 217 - "scripts/doctor.py"
Cohesion: 0.09
...
### Community 228 - "test_schedule_growth_invariants.py"
Cohesion: 0.06
...
### Community 229 - "test_brain_failover_413.py"
Cohesion: 0.15
...
### Community 235 - "AgentDefinition"
Cohesion: 0.09
Nodes (19): AgentDefinition, AgentStore, Any, field_validator, agents/store.py — Persistent store for user-defined agent configurations.…, CRUD store for AgentDefinition objects. Uses MongoDB when a `db` client is…, Return an agent by ID. If *owner_id* is provided, enforces that the agent…, Delete an agent. Returns True on success, False if not found/unauthorised. (+11 more)

### Community 236 - "ai/router.py"
Cohesion: 0.08
Nodes (33): _dead_model_key(), _exponential_backoff_cooldown(), _mark_model_dead(), _notify_watchdog(), _ollama_reasoning_effort(), provider_router.py — auto-generated module docstring (user-research skill scan)., Notify the brain watchdog of a provider call outcome (fire-and-forget).…, # NOTE: 429 and 410 are handled specially in _try_one_provider (immediate (+25 more)

### Community 237 - "_Collection"
Cohesion: 0.11
...
### Community 238 - "WorkflowBuildRequest"
Cohesion: 0.08
...
### Community 242 - "agents/agile_ceremonies.py"
Cohesion: 0.08
...
### Community 243 - "_resolve_user_github_token"
Cohesion: 0.18
...
### Community 244 - "REWRITE_PLAN.md — Phased Migration Strategy"
Cohesion: 0.06
...
### Community 254 - "test_brain_failover.py"
Cohesion: 0.11
...
### Community 259 - "analyze_quantitative"
Cohesion: 0.10
...
### Community 260 - "report_to_markdown"
Cohesion: 0.11
...
### Community 270 - "ResourceWatchdog"
Cohesion: 0.10
...
### Community 274 - "RateLimitTracker"
Cohesion: 0.10
...
### Community 277 - "Security Analysis — local-llm-server"
Cohesion: 0.06
...
### Community 279 - "Langfuse Observability Guide"
Cohesion: 0.06
...
### Community 281 - "BrainFailoverManager"
Cohesion: 0.09
...
### Community 282 - "OrchestratorQueue"
Cohesion: 0.07
...
### Community 289 - "test_unit7_catalog_propagation.py"
Cohesion: 0.07
...
### Community 292 - "test_backend_server_features.py"
Cohesion: 0.08
...
### Community 295 - "test_failover_silent_exhaustion.py"
Cohesion: 0.11
...
### Community 297 - "control_registry.py"
Cohesion: 0.11
...
### Community 298 - "session_retro.py"
Cohesion: 0.13
...
### Community 299 - "test_portfolio_intelligence.py"
Cohesion: 0.07
...
### Community 301 - "Workspace Isolation Architecture"
Cohesion: 0.06
...
### Community 306 - "test_force_cleanup_conditional_delete.py"
Cohesion: 0.10
...
### Community 308 - "test_rag_context.py"
Cohesion: 0.12
...
### Community 309 - "ProjectScaffolder"
Cohesion: 0.13
...
### Community 312 - "SteeringInjector"
Cohesion: 0.11
...
### Community 313 - "test_claude_setup_audit.py"
Cohesion: 0.16
...
### Community 314 - "test_scheduler_hydration_bounded.py"
Cohesion: 0.09
...
### Community 315 - "CompanyAgencyService"
Cohesion: 0.09
...
### Community 316 - "test_internal_agent_did_work.py"
Cohesion: 0.12
...
Cohesion: 0.03
Nodes (62): _check_extra_kwargs(), _enforce_signature(), _note_phase_end(), _note_phase_start(), Any, Path, loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., Raise TypeError if fn's signature drifts from the locked contract (Pydantic… (+54 more)

### Community 318 - "TestMCPClientStructuredOutput"
Cohesion: 0.31
...
### Community 320 - "Python Dependencies (`requirements.txt`)"
Cohesion: 0.07
...
### Community 321 - "Technical Debt Register — local-llm-server"
Cohesion: 0.07
...
### Community 326 - "get_skill_bindings"
Cohesion: 0.10
...
### Community 328 - "test_provider_enable_disable.py"
Cohesion: 0.09
...
### Community 330 - "Slice"
Cohesion: 0.11
Nodes (12): WorkflowRun, tests/test_workflow_models.py — Unit tests for workflow/models.py., TestApprovalGate, TestSlice, TestWorkflowRun, _extract_slices_from_plan(), Extract slice definitions from a plan.md artifact. Looks for sections matching:…, ApprovalGate (+4 more)

### Community 331 - "SessionMemory"
Cohesion: 0.14
...
### Community 333 - "test_brain_priority_scanner.py"
Cohesion: 0.11
...
### Community 341 - "test_phase4_runtime_resilience.py"
Cohesion: 0.11
...
### Community 342 - "test_brain_availability_doctor.py"
Cohesion: 0.16
...
### Community 347 - "classify_direct_chat_intent"
Cohesion: 0.11
...
### Community 357 - "brain_failover.py"
Cohesion: 0.12
...
### Community 362 - "agent/workspace.py"
Cohesion: 0.14
...
### Community 365 - "tests/conftest.py"
Cohesion: 0.11
...
### Community 368 - "Session Handoff — 2026-06-15"
Cohesion: 0.08
...
### Community 369 - "TASK 4 — End-to-end approval-gate test"
Cohesion: 0.08
...
### Community 386 - "test_memory_guard.py"
Cohesion: 0.13
...
### Community 387 - "test_regression.py"
Cohesion: 0.12
...
### Community 388 - "test_agency_fix.py"
Cohesion: 0.08
...
### Community 389 - "TestDetectedSystemPersistence"
Cohesion: 0.09
...
### Community 390 - "test_skill_registry.py"
Cohesion: 0.09
...
### Community 391 - "test_telegram_mutating_commands.py"
Cohesion: 0.08
...
### Community 394 - "WorkspaceError"
Cohesion: 0.14
Nodes (11): Any, Exception, Open an existing workspace from disk. Raises :exc:`WorkspaceNotFoundError` if…, Base class for all workspace errors., _read_manifest(), _validate_id(), WorkspaceError, WorkspaceEscapeError (+3 more)
...
### Community 397 - "Agent Governance Guide"
Cohesion: 0.09
...
### Community 398 - "The fifteen strategies"
Cohesion: 0.09
...
### Community 413 - "AdaptivePermissions"
Cohesion: 0.18
...
Cohesion: 0.09
Nodes (28): _cached(), _check_storage_health(), cost_attribution_stats(), doctor_health(), _fast_count(), get_active_provider(), get_activity(), get_stats() (+20 more)
...
### Community 425 - "_ensure_tasks_source_id_unique_index"
Cohesion: 0.14
...
### Community 436 - "test_provider_state_durability.py"
Cohesion: 0.12
...
### Community 437 - "run_trend_analysis"
Cohesion: 0.18
...
### Community 438 - "test_unit5_ui_provider_surface.py"
Cohesion: 0.10
...
### Community 439 - "test_agent_tools.py"
Cohesion: 0.17
...
### Community 444 - "Design Audit"
Cohesion: 0.10
Nodes (19): Code Quality, Color and Surfaces, Component Patterns, Content, Design Audit, Fix Priority, How This Works, Iconography (+11 more)

### Community 445 - "Findings"
Cohesion: 0.10
...
### Community 446 - "test_minimax_bug_fixes.py"
Cohesion: 0.12
...
### Community 454 - "ControlsScreen.jsx"
Cohesion: 0.15
...
### Community 459 - "PriorityTaskQueue"
Cohesion: 0.15
...
### Community 463 - "test_tasks_cache_ttl_env.py"
Cohesion: 0.21
...
### Community 464 - "test_voice_pipeline.py"
Cohesion: 0.14
...
### Community 467 - "_extract_tech_relevance"
Cohesion: 0.17
...
### Community 475 - "TestNormalizeResponseFormat"
Cohesion: 0.11
...
### Community 476 - "Skill: fabric-patterns"
Cohesion: 0.11
Nodes (18): 1. Ensure Pattern Directory Exists, 2. List Available Patterns, 3. Retrieve a Pattern, 4. Apply a Pattern with Variables, 5. Stitch Patterns Together, 6. Create New Patterns, Acceptance Checks, Directory Structure (+10 more)

### Community 477 - "db/__init__.py"
Cohesion: 0.14
...
### Community 478 - "Admin Dashboard Guide"
Cohesion: 0.11
...
### Community 479 - "Implementation Plan"
Cohesion: 0.11
...
### Community 481 - "test_p0_roadmap_a4_a5_b2.py"
Cohesion: 0.15
...
### Community 483 - "test_scanner_security.py"
Cohesion: 0.15
...
### Community 484 - "test_task_source_id_race.py"
Cohesion: 0.17
...
### Community 485 - "test_brain_patch_service_token.py"
Cohesion: 0.18
...
### Community 492 - "Comprehensive Skill Index (By Category)"
Cohesion: 0.11
...
### Community 493 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 494 - "Component Map"
Cohesion: 0.11
...
### Community 495 - "render_router.py"
Cohesion: 0.14
...
### Community 497 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
...
### Community 499 - "Part A — Health Report"
Cohesion: 0.11
...
### Community 504 - "sync_readme_gallery.py"
Cohesion: 0.22
...
### Community 505 - "test_p0_roadmap_b3_b4_b5.py"
Cohesion: 0.16
...
### Community 508 - "test_company_api.py"
Cohesion: 0.11
...
### Community 509 - "TestStopSlopChecker"
Cohesion: 0.11
...
### Community 520 - "get_doctor_diagnostics"
Cohesion: 0.08
Nodes (31): _builtin_provider_records(), _DoctorCheck, _DoctorReport, get_doctor_diagnostics(), get_doctor_report(), get_public_doctor(), _in_container(), merge_pr_route() (+23 more)
...
### Community 525 - "provider_max_rpm"
Cohesion: 0.17
...
### Community 526 - "redact_connection_url"
Cohesion: 0.17
...
### Community 527 - "agent_readiness_audit.py"
Cohesion: 0.21
...
### Community 530 - "test_freebuff_bot.py"
Cohesion: 0.12
...
### Community 531 - "test_activation_api.py"
Cohesion: 0.21
...
### Community 532 - "DirectChatDoctor"
Cohesion: 0.16
...
### Community 533 - "test_health_endpoints.py"
Cohesion: 0.17
...
### Community 534 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 537 - "test_task_service_failed_comment.py"
Cohesion: 0.18
...
### Community 538 - "_autonomy_bg_cycle"
Cohesion: 0.16
...
### Community 544 - "Workspace"
Cohesion: 0.14
Nodes (6): Resolve *relative* inside source dir and reject traversal/symlink escapes., Resolve *relative* within *ws*.source and reject traversal/symlink escapes.…, Acquire the exclusive async lock for *ws*. Raises :exc:`WorkspaceLockError` if…, Remove and recreate the tmp directory for *ws*., Workspace, WorkspaceLockError

### Community 545 - "AITellIssue"
Cohesion: 0.17
...
### Community 547 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
...
### Community 548 - "_valid_login_state"
Cohesion: 0.24
...
### Community 549 - "Skill: repowise-intelligence"
Cohesion: 0.12
Nodes (15): 1. Graph Intelligence (Dependency Graph), 2. Git Intelligence, 3. Documentation Intelligence, 4. Decision Intelligence, Acceptance Checks, Directory Structure, Example Usage, Implementation Approach (+7 more)

### Community 550 - "The 10-Step Workflow"
Cohesion: 0.12
...
### Community 551 - "Contributing to local-llm-server"
Cohesion: 0.12
...
### Community 552 - "refresh_agent_built_proof.py"
Cohesion: 0.20
...
### Community 553 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 554 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 555 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
...
### Community 556 - "implement_agent.py"
Cohesion: 0.16
...
### Community 571 - "test_langfuse_agency_wide.py"
Cohesion: 0.12
...
### Community 589 - "Skill: user-research"
Cohesion: 0.13
...
### Community 590 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 591 - "Attention Mechanisms Internals"
Cohesion: 0.13
...
### Community 593 - "test_daily_2026_07_24.py"
Cohesion: 0.20
...
### Community 594 - "_push_down_where"
Cohesion: 0.14
...
### Community 595 - "router/health.py"
Cohesion: 0.20
...
### Community 596 - "DockerAgentAdapter"
Cohesion: 0.17
...
### Community 598 - "TestDecisionsBotLinks"
Cohesion: 0.17
...
### Community 599 - "DecisionsStore"
Cohesion: 0.30
Nodes (3): DecisionsStore, Any, Connection

### Community 600 - "test_telegram_auto_approve.py"
Cohesion: 0.23
...
### Community 604 - "test_dockerfile_ships_config_dir.py"
Cohesion: 0.14
...
### Community 606 - "test_scanner_live.py"
Cohesion: 0.23
...
### Community 611 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 615 - "Checks Performed"
Cohesion: 0.14
...
### Community 616 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 617 - "admin_digest_router.py"
Cohesion: 0.22
...
### Community 618 - "Skill: branch-cleanup"
Cohesion: 0.14
...
### Community 619 - "Skill: perplexity — Web Research via Perplexity API"
Cohesion: 0.14
...
### Community 622 - "Quick-Note Issues Processing Summary"
Cohesion: 0.14
...
### Community 623 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 625 - "Render MCP — autonomous platform debugging and environment monitoring"
Cohesion: 0.14
...
### Community 626 - "Runbook: Auto-Resume After Cooldown / Interruption"
Cohesion: 0.14
...
### Community 627 - "SEO / GEO / AIO Audit Engine"
Cohesion: 0.14
...
### Community 631 - "_parse_reset_epoch"
Cohesion: 0.21
...
### Community 632 - "is_anthropic_base_url"
Cohesion: 0.18
...
### Community 635 - "test_critical_flows.py"
Cohesion: 0.29
...
### Community 636 - "TestAnthropicToolListCaching"
Cohesion: 0.34
...
### Community 639 - "test_openclaw_gateway.py"
Cohesion: 0.14
...
### Community 640 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 642 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 645 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 646 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 649 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
...
### Community 650 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 651 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 653 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 655 - "admin_update_task_router.py"
Cohesion: 0.22
...
### Community 658 - "Skill: platform-setup — Autonomous Agency Bootstrap"
Cohesion: 0.15
...
### Community 659 - "Device compatibility and model picks"
Cohesion: 0.15
...
### Community 660 - "Autonomy Uplift — Living Roadmap & Detailed Implementation Specs"
Cohesion: 0.15
...
### Community 664 - "_is_bedrock_model_id"
Cohesion: 0.27
...
### Community 666 - "Agent Transparency Report"
Cohesion: 0.15
...
### Community 667 - "update_provider_policy"
Cohesion: 0.19
...
### Community 669 - "_InMemoryBackend"
Cohesion: 0.18
...
### Community 671 - "TestModelCostTableUpdates"
Cohesion: 0.26
...
### Community 672 - "test_deploy_trigger_covers_image.py"
Cohesion: 0.21
...
### Community 673 - "TestRuntimeControl"
Cohesion: 0.15
...
### Community 674 - "TestKillSwitchDurability"
Cohesion: 0.15
...
### Community 675 - "TestRouterIntegration"
Cohesion: 0.31
...
### Community 680 - "WorkspaceManager"
Cohesion: 0.21
...
### Community 690 - "sync_catalog_route"
Cohesion: 0.18
...
### Community 704 - "check_container_posture.py"
Cohesion: 0.26
...
### Community 705 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 706 - "test_admin_local_brain_router.py"
Cohesion: 0.29
...
### Community 707 - "test_agile_api.py"
Cohesion: 0.17
...
### Community 708 - "test_app_settings.py"
Cohesion: 0.21
...
### Community 709 - "TestAnthropicWorkspaceIdCapture"
Cohesion: 0.33
...
### Community 712 - "test_task_clarification.py"
Cohesion: 0.17
...
### Community 715 - "_extractive_compress"
Cohesion: 0.18
...
### Community 718 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 721 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 722 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 724 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 727 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 728 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 729 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 730 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 731 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 732 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 733 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 734 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 736 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 737 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 738 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 739 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 740 - "What to clean up"
Cohesion: 0.18
...
### Community 741 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 748 - "test_scanner_ssl_cert.py"
Cohesion: 0.25
...
### Community 750 - "test_agent_readiness_audit.py"
Cohesion: 0.18
...
### Community 752 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 753 - "test_event_log.py"
Cohesion: 0.45
...
### Community 754 - "test_google_provider_models.py"
Cohesion: 0.18
...
### Community 758 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 759 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 760 - "admin_local_brain_router.py"
Cohesion: 0.22
...
### Community 761 - "get_orchestrator_queue"
Cohesion: 0.27
...
### Community 762 - "_normalize_tool_choice"
Cohesion: 0.31
...
### Community 763 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 764 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 765 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 766 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 767 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 768 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 769 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 771 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 772 - "LLM Router — configuration guide"
Cohesion: 0.20
...
### Community 773 - "LLM Router — provider guide"
Cohesion: 0.20
...
### Community 774 - "CI Troubleshooting Runbook"
Cohesion: 0.20
...
### Community 776 - "TestModelsEndpointAliases"
Cohesion: 0.31
...
### Community 778 - "build_tech_db.py"
Cohesion: 0.40
...
### Community 781 - "_resolve_push_token"
Cohesion: 0.31
...
### Community 782 - "_redact_for_notification"
Cohesion: 0.24
...
### Community 785 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 788 - "test_quick_note_engine.py"
Cohesion: 0.22
...
### Community 792 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 793 - "Skill: changelog-enforcer"
Cohesion: 0.22
...
### Community 794 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 796 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 797 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 799 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
Nodes (8): Branch, Components, Purpose, Quick Start, Session Roles, Skill: cowork-session (Claude Cowork), Testing, When to Use

### Community 800 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 801 - "Active Task Tracker"
Cohesion: 0.22
...
### Community 803 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 804 - "Main proxy (`proxy.py`)"
Cohesion: 0.22
...
### Community 805 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 806 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 807 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 808 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 809 - "Platform Controls"
Cohesion: 0.22
...
### Community 810 - "Release Procedure"
Cohesion: 0.22
...
### Community 811 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 819 - "_start_ceo_agency"
Cohesion: 0.31
...
### Community 821 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 822 - "test_changelog_parity_guard.py"
Cohesion: 0.22
...
### Community 824 - "TestPaidPolicyDurability"
Cohesion: 0.22
...
### Community 825 - "test_scanner_deps_parity.py"
Cohesion: 0.31
...
### Community 844 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 845 - "ceo-micromanagement.md"
Cohesion: 0.25
Nodes (4): P0 behavior change, Readiness contract, Runtime model, Runtime types

### Community 846 - "Feature Maturity / Support Matrix"
Cohesion: 0.25
...
### Community 885 - "capture_screens.py"
Cohesion: 0.39
...
### Community 888 - "run_patched_colibri.py"
Cohesion: 0.36
...
### Community 891 - "test_compose_and_coordinate_api.py"
Cohesion: 0.36
...
### Community 892 - "test_generate_context_standing_instructions.py"
Cohesion: 0.32
...
### Community 893 - "test_local_brain_router_smoke.py"
Cohesion: 0.25
...
### Community 896 - "test_provider_models_db_outage.py"
Cohesion: 0.25
...
### Community 900 - "test_serve_spa_prefixes.py"
Cohesion: 0.36
...
### Community 901 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.25
...
### Community 903 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 927 - "Workspace Issues"
Cohesion: 0.29
...
### Community 928 - "Model and Response Issues"
Cohesion: 0.29
...
### Community 942 - "test_daily_2026_06_14.py"
Cohesion: 0.38
...
### Community 943 - "TestGithubTokenSQLiteRegression"
Cohesion: 0.38
...
### Community 944 - "test_log_monitor_storm_guard.py"
Cohesion: 0.48
...
### Community 945 - "TestReasonsAreActionable"
Cohesion: 0.29
...
### Community 963 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 964 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 965 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 966 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 967 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 968 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 971 - "resolve_hermes_base_url"
Cohesion: 0.47
...
### Community 972 - "apply_phase1_changes.py"
Cohesion: 0.33
...
### Community 985 - "TestCEOAgencySystem"
Cohesion: 0.33
...
### Community 1007 - "Admin Dashboard Issues"
Cohesion: 0.40
...
### Community 1008 - "Agent API Issues"
Cohesion: 0.40
...
### Community 1009 - "Network and Tunnel Issues"
Cohesion: 0.40
...
### Community 1018 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1019 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1020 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 1021 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 1022 - "setup_colibri.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1023 - "setup_colibri.sh script"
Cohesion: 0.70
Nodes (4): setup_colibri.sh script, fail(), ok(), warn()

### Community 1024 - "status_colibri_server.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1026 - "TestMobileNavigation"
Cohesion: 0.40
Nodes (3): Mobile-specific: hamburger menu, responsive layout., Verify key pages load in mobile viewport., TestMobileNavigation

### Community 1027 - "test_v5_screens_smoke.py"
Cohesion: 0.50
...
### Community 1028 - "test_agent_runtime_wrapper.py"
Cohesion: 0.70
...
### Community 1030 - "TestDirectChatNonBlocking"
Cohesion: 0.40
...
### Community 1049 - "_clean_director"
Cohesion: 0.50
...
### Community 1066 - "test_no_exception_detail_leaks.py"
Cohesion: 0.50
...
### Community 1067 - "test_skills_route_order.py"
Cohesion: 0.67
...
### Community 1093 - "test_direct_adapter_does_not_bypass"
Cohesion: 0.67
...
- **Why does `_fixture()` connect `_fixture` to `test_operational_incidents.py`, `TaskStore`, `llm/router.py`, `test_llm_router_queue_cache.py`, `test_llm_router_strategies.py`, `ImprovementLoop`, `test_llm_router_resilience.py`, `test_freebuff_bot.py`, `test_ceo_supervision.py`, `ExecutionRequest`, `test_openclaw_endpoints.py`, `config.py`, `test_task_service_failed_comment.py`, `E2BSandboxSession`, `Task`, `SelfHealingAgent`, `_clean_director`, `test_agent_tool_governance.py`, `WorkflowRun`, `PolicyEngine`, `resolve_active_brain`, `MCPClient`, `ProviderRouter`, `services/background.py`, `sam`, `services/seo_audit.py`, `test_unit8_model_catalog.py`, `test_model_router.py`, `PrimeAgentAdapter`, `SQLiteStore`, `test_failover_client_shared.py`, `TaskExecutionCoordinator`, `test_autonomy_status.py`, `BrainWatchdog`, `UserRole`, `AgentJobManager`, `test_llm_router_gateway.py`, `AgentSwarm`, `test_local_brain_state.py`, `test_refresh_agent_built_proof.py`, `test_sam_livekit.py`, `ChatHistoryStore`, `test_telegram_diag_endpoint.py`, `get_task_store`, `ResearchTask`, `get_scheduler`, `resolve_e2b_config`, `model_router.py`, `TestClient`, `test_ai_insights.py`, `test_procedural_memory.py`, `test_telegram_auto_approve.py`, `e2e/test_browser.py`, `test_startup_warmup.py`, `FeatureMaturity`, `ArtifactStore`, `TokenBudget`, `enforcement.py`, `test_knowledge_sync.py`, `run_task`, `KeyStore`, `test_trend_scoping.py`, `test_context_rulebook.py`, `KeyPool`, `test_openclaw_gateway.py`, `claim`, `CompanyGraphService`, `clear_cooldowns`, `test_kimi_bridge_server.py`, `test_issue_intake.py`, `test_new_features_e2e.py`, `BackgroundAgent`, `test_telegram_freebuff.py`, `TestHarnessAdapter`, `_Budget`, `persist_plan_spec`, `TestEstimateTokensForMessages`, `BudgetTracker`, `TestRuntimeControl`, `test_daily_2026_07_27.py`, `test_platform_controls.py`, `OllamaCircuitBreaker`, `test_ceo_router.py`, `test_features_api.py`, `test_video_transcript.py`, `TrendWatcher`, `test_agile_api.py`, `test_app_settings.py`, `NotificationDispatcher`, `test_e2b_data_flow.py`, `test_task_clarification.py`, `ScheduledJob`, `test_portfolio_intake.py`, `test_trend_watcher.py`, `control_overrides.py`, `TestClient`, `test_brain_failover_413.py`, `ContextPruner`, `AgentDefinition`, `WorkflowBuildRequest`, `_resolve_user_github_token`, `test_persistent_memory.py`, `SecurityScanner`, `test_brain_failover.py`, `test_llm_router_e2e.py`, `OutputFilter`, `_resolve_push_token`, `test_rate_limiter.py`, `TestMongoGate`, `test_sam_voice.py`, `OrchestratorQueue`, `session_retro.py`, `test_purge_backlog.py`, `analyze_page`, `_start_ceo_agency`, `TestSwarmRoleRouting`, `test_scheduler_hydration_bounded.py`, `test_crispy_burn_in.py`, `test_provider_enable_disable.py`, `test_skill_registry_boot_refresh.py`, `SeoFixRequest`, `isolated_telegram_config`, `test_phase5_doctor.py`, `tests/conftest.py`, `api_keys_for`, `test_claude_code_adapter.py`, `test_service_token.py`, `test_harness_spec.py`, `test_ping.py`, `test_runtimes_health_endpoint.py`, `test_regression.py`, `test_agency_fix.py`, `test_task_store_fails_loud_in_production.py`, `model_discovery.py`, `test_monitor_lib.py`, `test_v4_api.py`, `test_dashboard_cache.py`, `reap_expired_companies`, `client`, `allow_paid`, `test_provider_state_durability.py`, `test_voice_pipeline.py`, `reset_kv_state`, `cost_tracker.py`, `TestNormalizeResponseFormat`, `test_brain_patch_service_token.py`, `test_company_api.py`, `test_telegram_service_webhook.py`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `proxy.py`, `FreeBuffAgent`, `ReactScratchpad`, `ContextManager`, `BackgroundAgent`, `TaskSpec`, `test_ceo_dispatcher.py`, `E2BSandboxSession`, `LocalWorkspace`, `StuckDetector`, `WorkflowRun`, `test_agent_tool_governance.py`, `resolve_active_brain`, `test_backend_server_features.py`, `MCPClient`, `MultiAgentSwarm`, `direct_chat.py`, `test_e2b_adapter.py`, `WorkspaceTools`, `test_failover_client_shared.py`, `CEODispatcher`, `AgentPlan`, `AgentJobManager`, `loop.py`, `test_governance_api.py`, `TokenBudget`, `test_brain_failover_413.py`, `ContextPruner`, `GitHubTools`, `test_empirical_verify.py`, `InternalAgentAdapter`, `test_autonomous_agency_e2e.py`, `AgentSessionStore`, `AdaptiveHalter`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderRouter` to `failover_client.py`, `backend/server.py`, `TrafficDirector`, `TestRouterIntegration`, `test_bedrock_live.py`, `clear_cooldowns`, `settings.py`, `direct_chat.py`, `test_colibri_brain_shim.py`, `ai/router.py`, `is_anthropic_base_url`, `ProviderConfig`, `TestAnthropicPayloadStructuredOutput`, `test_bedrock_provider.py`, `test_all_providers_discovery.py`, `NvidiaProvider`, `test_anthropic_router.py`?**
...
- **Should `_fixture` be split into smaller, more focused modules?**
  _Cohesion score 0.01374678300169481 - nodes in this community are weakly interconnected._