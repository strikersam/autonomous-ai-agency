# Graph Report - local-llm-server  (2026-08-09)

## Corpus Check
- 1409 files · ~2,017,159 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 28075 nodes · 57279 edges · 1180 communities (1071 shown, 109 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 6228 edges (avg confidence: 0.54)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `02db31f3`
...
## Communities (1180 total, 109 thin omitted)

### Community 0 - "backend/server.py"
Cohesion: 0.01
Nodes (413): get_harness_adapter(), backend/ceo_router.py — observability and manual control for the CEO. Surfaces…, Reject non-admin callers for routes that spend provider budget. Delegates to…, _require_admin(), _is_admin(), Check if a user has admin role. Works for both social_auth users (role in…, admin_seed(), _agent_provider_failure_response() (+405 more)

### Community 1 - "ProviderConfig"
Cohesion: 0.01
Nodes (210): get_tracker(), Return the process-singleton RateLimitTracker., _acquire_provider_probe(), clear_cooldowns(), _dead_model_key(), _exponential_backoff_cooldown(), extract_openai_text(), get_dead_models() (+202 more)

### Community 2 - "brain_config.py"
Cohesion: 0.01
Nodes (213): BrainConfig, BrainConfigStore, _build_base_url_env_from_yaml(), _build_default_base_url_from_yaml(), _build_display_names_from_yaml(), _build_key_env_from_yaml(), _build_tier_from_yaml(), default_brain_config() (+205 more)

### Community 3 - "PortfolioManager"
Cohesion: 0.02
Nodes (173): AgentRole, str, generate_backlog_retro(), Derive a retrospective from the task tracker when no sprint is active. DONE /…, Lifecycle status of a sprint., SprintStatus, add_initiative(), AllocationOut (+165 more)

### Community 4 - "AgentScheduler"
Cohesion: 0.03
Nodes (156): AgentJobRequest, AgentJobSnapshot, Complete point-in-time view of a job, safe to serialise as API response., Convenience: the canonical text response, whether success or failure., Validated input for creating a new agent job. Passed from the API handler into…, DirectChatDoctor, AgentJobManager, Central registry that indexes local + remote skills and provides context-aware… (+148 more)

### Community 5 - "company_api.py"
Cohesion: 0.02
Nodes (165): ephemeral_ttl_hours(), Async read of the ephemeral TTL (hours) straight from the DB., account_lifecycle(), auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint(), generate_onboarding_questions() (+157 more)

### Community 6 - "proxy.py"
Cohesion: 0.02
Nodes (174): get_agency(), Any, Return recent commits with agent attribution trailers parsed out., get_tracker(), Return the shared AutonomyTracker singleton (lazy-init)., Start a daemon thread that processes one queued note every *interval_hours*.…, start_processor(), get_skill_registry_safe() (+166 more)

### Community 7 - "AgentRunner"
Cohesion: 0.02
Nodes (143): AgentRunner, _check_extra_kwargs(), _enforce_signature(), _note_phase_end(), _note_phase_start(), Any, Path, Raise TypeError if fn's signature drifts from the locked contract (Pydantic… (+135 more)

### Community 8 - "ExecutionRequest"
Cohesion: 0.03
Nodes (109): Called by APScheduler when a cron fires. Dispatches to the orchestrator., _scheduler_on_fire(), get_orchestrator_checkpoint_store(), _NoopDB, OrchestratorCheckpointStore, Any, services/orchestrator_checkpoint.py — Durable step-level checkpointing Issue…, Restore in-flight runs at startup. Called during backend bootstrap. Returns a… (+101 more)

### Community 9 - "TaskSpec"
Cohesion: 0.03
Nodes (109): agent/job_manager.py — Async agent job lifecycle manager. Manages agent jobs…, kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, TaskResult, TaskSpec, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Run aider non-interactively via `--message` flag., runtimes/adapters/claude_code.py — Claude Code CLI adapter (FIRST CLASS).… (+101 more)

### Community 10 - "test_runtimes.py"
Cohesion: 0.03
Nodes (63): AiderAdapter, Any, Adapter for Aider — TIER 3 specialized git-aware code editor., GooseAdapter, Any, Adapter for Goose — TIER 2 general-purpose local runtime., HermesAdapter, Adapter for Hermes Agent — FIRST CLASS autonomous runtime. (+55 more)

### Community 11 - "test_ceo_supervision.py"
Cohesion: 0.03
Nodes (126): CEODispatcher, CEOResult, _complexity_rank(), _decompose_into_subtasks(), _harvest_changed_files(), _merge_changed_files(), _offload(), Any (+118 more)

### Community 12 - "TaskDispatcher"
Cohesion: 0.02
Nodes (102): AgencyCycleResult, AgentDirective, _build_ceo_prompt(), _build_quick_note_instruction(), _close_github_issue(), _collect_recent_git_context(), _fetch_github_quick_notes(), _gh_repo() (+94 more)

### Community 13 - "CompanyGraphStore"
Cohesion: 0.06
...
Cohesion: 0.04
Nodes (73): packages/llm — the multi-provider LLM routing layer. Every LLM call in this…, AnthropicProvider, Any, AsyncClient, packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, Translate OpenAI-shaped messages into Anthropic's system/turn split., OpenAI carries a tool result as role="tool" with a tool_call_id; Anthropic…, OpenAI puts a tool call alongside the assistant's text; Anthropic needs… (+65 more)

### Community 15 - "AgentSessionStore"
Cohesion: 0.03
Nodes (95): Agent subsystem — planner / executor / verifier loop., AgentPhaseError, free_nvidia_models(), FreeBuffAgent, _nvidia_api_key(), Exception, loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., Return the curated list of free NVIDIA NIM models FreeBuff may use. (+87 more)

### Community 16 - "Agency"
Cohesion: 0.08
Nodes (103): Agency, CEO-coordinated multi-agent agency for continuous codebase management. The CEO…, BackgroundTask, BrowserSession, Async Playwright browser session. Usage:: session = BrowserSession() await…, True if Playwright is installed and ready to use., CommitAttribution, CommitTracker (+95 more)
...
Cohesion: 0.03
Nodes (83): int, Test hook — clear all usage accounting., reset(), CacheManager, cosine_similarity(), _Entry, get_cache(), LRUCache (+75 more)

### Community 19 - "WorkflowOrchestrator"
Cohesion: 0.03
Nodes (102): Reset the singleton (test helper)., reset_ceo_dispatcher(), ClassifyOutput, get_ceo_fallback_stats(), PlanOutput, Exception, Persist first-merge consent once an operator approves a ``telegram_gate``. No-…, Determine domain and task type from the request text. (+94 more)
...
### Community 21 - "BackgroundAgent"
Cohesion: 0.03
Nodes (87): BackgroundAgent, _now(), Any, agent/background.py — Background Agent An always-on worker thread that…, Enqueue *task* for processing. Returns the task (with task_id set)., Convenience: create a task and submit it in one call., Real handler — dispatches through AgentRunner when available. HARDENED (PR…, Always-on worker that drains a task queue on a daemon thread. GATE: Golden Path… (+79 more)

### Community 22 - "E2BSandboxSession"
Cohesion: 0.04
Nodes (77): MCPUnavailableError, agent/mcp_client.py — Async MCP client for the mcp-server Docker container.…, Raised when the MCP server is unreachable or the circuit is open., TaskResult, TaskSpec, Execute a task inside a fresh E2B sandbox. Flow: 1. Open an…, Run ``pytest`` inside the sandbox. Returns ``(output, passed)``.…, is_e2b_sdk_importable() (+69 more)
...
Cohesion: 0.04
Nodes (101): classify_task(), _extract_recent_text(), Any, Task classification from request context. Classifies an incoming request into a…, Concatenate plain text from the last *last_n* messages., Return the most likely task category for this request. Args: messages: OpenAI-…, _build_builtin_model_map(), Dynamic model router. Central routing logic for all chat and agent requests.… (+93 more)
...
### Community 27 - "WorkspaceManager"
Cohesion: 0.05
Nodes (81): test_git_ref_rejects_empty(), test_git_ref_rejects_flag_injection(), test_git_ref_rejects_shell_metacharacters(), test_git_ref_rejects_traversal(), test_git_ref_valid(), test_git_scheme_allows_ssh(), test_http_scheme_rejects_ssh(), test_https_public_host_allowed() (+73 more)

### Community 28 - "Specialist"
Cohesion: 0.03
Nodes (54): BusinessCategory, SpecialistFamily, Find all specialists of a specific family., Find specialists that can handle a task with given capabilities., A specialist agent that can be provisioned for company-specific tasks., Check if this specialist can handle a task with given capabilities., Specialist, CompanyGraphService (+46 more)

### Community 29 - "test_runtime_governance.py"
Cohesion: 0.04
Nodes (80): events_from_identity(), get_audit_log(), Any, packages/governance/audit.py — the evidence trail for every governed action.…, Redact secret-shaped substrings, then truncate., Return the process-wide audit log, created on first use., Convenience: build and record an event in one call., Extract the identity-derived audit fields from an AgentIdentity. Kept here… (+72 more)
...
### Community 31 - "LLMRouter"
Cohesion: 0.04
Nodes (69): Attempt, count, text_key(), Read the environment variables named in ``env_names`` into a key list. Order is…, resolve_keys(), LLMRouter, Any, AsyncClient (+61 more)
...
Cohesion: 0.04
Nodes (68): heal_signature(), HealingEvent, _now(), Any, Translate external failure signals into improvement tasks and verify the fix…, Launch the background sweeper that resolves quiet verifying heals., Called when a CI workflow fails., Called when a GitHub issue with a bug label is opened. (+60 more)

### Community 34 - "test_llm_router_resilience.py"
Cohesion: 0.03
Nodes (69): Backoff policy for retryable failures., RetryConfig, _digest(), get_ring(), KeyRing, KeyState, packages/llm/keys.py — multi-key rotation with per-key health. A provider may…, Per-provider round-robin key selection with cooldowns. (+61 more)

### Community 35 - "direct_chat.py"
Cohesion: 0.05
Nodes (85): PreflightIssue, Any, BaseModel, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, Translate technical preflight issues into a conversational assistant reply., translate_error_to_conversational(), ResumeRequest, AcceptedJob (+77 more)
...
### Community 39 - "skill_bindings.py"
Cohesion: 0.04
Nodes (63): ConsolidationPhase, MemoryKind, Enum, str, Dream Memory Consolidation — pattern consolidation across AI sessions. Inspired…, What kind of memory artifact this is., Current phase of the consolidation lifecycle., Enum (+55 more)

### Community 40 - "tasks/service.py"
Cohesion: 0.04
Nodes (73): Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., tasks — Task/issue management system. Provides a lightweight task/issue tracker…, ApprovalCheckpoint, ApprovalRequest, _coerce_ts(), CommentAddRequest, ExecutionApprovalRequest (+65 more)

### Community 41 - "TaskWorkflowService"
Cohesion: 0.05
Nodes (61): _is_brain_connection_error(), Any, BaseException, Task, TaskResult, TaskSpec, TaskStatus, Best-effort label of who will run this task once approved. Returns… (+53 more)

### Community 42 - "Task"
Cohesion: 0.04
Nodes (59): Full task/issue document., Update the updated_at timestamp., Task, PUBLIC_URL-anchored dashboard deep link for the task detail. Returns empty…, Best-effort Telegram heads-up that a task is parked awaiting approval. Inline…, Tests for task follow-up / rerun with conversation carry-over. Before this,…, The runtime reads context['conversation']; prior comments must be carried as…, test_build_spec_exposes_conversation_for_runtime() (+51 more)

### Community 43 - "Surface"
Cohesion: 0.04
Nodes (68): backend/governance_router.py — read and operate the governance layer. Mounted…, Reject non-admin callers. Mirrors the RBAC check used elsewhere in this backend…, _require_admin(), _load(), Import the governance layer once, recording why if it is absent., BudgetExceeded, classify(), evaluate_call() (+60 more)

### Community 44 - "ControlPlanePage.js"
Cohesion: 0.04
Nodes (60): createQuickNote(), createTask(), getActivity(), getCostAttribution(), getDecisionLog(), getDueSoonTasks(), getSavings(), getStats() (+52 more)

### Community 45 - "MCPClient"
Cohesion: 0.04
Nodes (34): get_mcp_client(), MCPClient, Any, RuntimeError, Thin async MCP client with open/close circuit breaker. Thread-safe only within…, Full URL of the JSON-RPC endpoint this client posts to., Build the request headers shared by ``_rpc`` and ``notify``. ``Accept`` lists…, Propagate the calling agent's identity across the process boundary. The MCP… (+26 more)

### Community 46 - "PrimeAgentAdapter"
Cohesion: 0.04
...
### Community 48 - "test_unit8_model_catalog.py"
Cohesion: 0.04
Nodes (67): CatalogActiveBrain, CatalogMirror, CatalogProviderEntry, get_catalog(), get_model_catalog_store(), _include_router_providers(), invalidate_catalog_cache(), ModelCatalogStore (+59 more)

### Community 49 - "RenderOpsMonitor"
Cohesion: 0.06
Nodes (34): RuntimeError, packages/integrations/render_mcp.py — Render platform access over MCP. The…, One deploy, normalised from whatever shape the tool returned., Typed facade over the Render MCP server's tools. Every method returns plain…, True when there is both an API key and an endpoint to reach., Return the most recent deploy, or ``None`` when there are none., Drop the cached singleton. Used by tests and after a config change., Raised when a mutating Render tool is called with writes disabled. (+26 more)
...
Cohesion: 0.06
Nodes (61): DeliveryPolicy, How code lands on a repo's default branch (detected, GitHub-only for now). The…, A company's connection to a code repository (GitHub-only this pass). URL-only…, RepoConnection, attach_repo_connection(), build_repo_connection(), decide_merge(), detect_delivery_policy() (+53 more)

### Community 56 - "SecretRecord"
Cohesion: 0.06
Nodes (57): _can_read(), _can_write(), create_secret(), _decrypt(), delete_secret(), _encrypt(), _get_master_key(), get_secret_metadata() (+49 more)

### Community 57 - "TaskStore"
Cohesion: 0.05
Nodes (61): Any, Task, TaskStatus, Create a task. Deduplicates by source_id if set (Charter G3). If a task with…, Fetch a task by ID. If owner_id is set, enforces ownership., Return the task previously created for an external ``source_id`` (e.g.…, Normalise a timestamp value to a float Unix epoch. Handles: - float / int…, List tasks for a specific user with optional filters. ``include_system``… (+53 more)
...
### Community 59 - "_fixture"
Cohesion: 0.03
Nodes (76): app_client(), _clear_discovered_models(), _clear_response_cache(), client(), _isolate_brain_data_layer(), _isolate_operator_provider_state(), non_admin_client(), MonkeyPatch (+68 more)

### Community 60 - "test_loop_registry.py"
Cohesion: 0.05
Nodes (64): audit_drift(), _cmd_audit(), DriftReport, _grade(), load_registry(), load_registry_sync(), loop_readiness(), LoopRegistry (+56 more)

### Community 61 - "test_llm_router_strategies.py"
Cohesion: 0.07
Nodes (55): HealthConfig, Strategy selection and degradation behaviour., Circuit breaker + health tracking thresholds., RoutingConfig, HealthTracker, _Outcome, ProviderHealth, Any (+47 more)

### Community 62 - "AgentProfile"
Cohesion: 0.05
...
### Community 63 - "test_ceo_router.py"
Cohesion: 0.05
Nodes (57): build_ceo_router(), Any, APIRouter, get_ceo_dispatcher(), Return the shared CEODispatcher singleton., CEOSupervisor, _env_flag(), _env_int() (+49 more)

### Community 64 - "PolicyEngine"
Cohesion: 0.04
Nodes (55): Return the stable ``agent:<slug>`` id for a human agent name. Deterministic and…, slugify_agent(), _as_list(), GroupPolicy, PolicyEngine, Any, Path, Coerce a YAML scalar-or-list field into a list of strings. Operators write… (+47 more)

### Community 65 - "test_brain_availability_doctor.py"
Cohesion: 0.05
Nodes (54): brain_availability_summary(), Non-secret answer to "can the brain answer a request right now?". Three callers…, _backend(), CEOLedger, _now(), Any, services/ceo_ledger.py — durable record of what the CEO is driving to closure.…, Return ``(done, total)`` subtask counts. (+46 more)

### Community 66 - "telegram_bot.py"
Cohesion: 0.05
Nodes (68): project_session_cost(), Project costs for a typical coding session. Args: avg_session_latency_ms: Total…, get_decisions_store(), Process-wide DecisionsStore singleton (resettable via db_path arg)., Return a Markdown-v1-safe preview string under ``max_chars``. Used by the…, sanitize_paste_for_preview(), _admin_headers(), _api_headers() (+60 more)

### Community 67 - "llm/router.py"
Cohesion: 0.05
Nodes (69): auto_disable(), _billing_signals(), describe(), disabled_provider_ids(), is_unfixable(), packages/llm/disabled.py — bridge to the durable provider on/off switch. The…, Provider ids currently switched off. Empty when the store is unreachable., Persist a provider as disabled, through the store that already owns it. (+61 more)

### Community 68 - "FeatureMatrix"
Cohesion: 0.05
Nodes (16): FeatureMatrix, Central support matrix — single source of truth. Loads the canonical feature…, Render the matrix as a Markdown table for docs., Integration test: admin endpoint returns feature matrix JSON., TestAdminVisibility, TestConfigOverrides, TestEnforcement, TestRegistryLoads (+8 more)

### Community 69 - "DashboardLayout.js"
Cohesion: 0.05
Nodes (41): completeSetup(), createSecret(), detectHardwareForSetup(), detectModelsForSetup(), getMe(), getPublicPath(), getSetupState(), login() (+33 more)
...
### Community 74 - "test_ai_insights.py"
Cohesion: 0.05
...
### Community 77 - "services/seo_audit.py"
Cohesion: 0.05
Nodes (33): Aggregated report row - Screaming Frog CSV compatible., SeoIssueReportRow, analyze_page(), compute_pressure(), _count_syllables(), estimate_pixel_width(), flesch_reading_ease(), _host_key() (+25 more)

### Community 78 - "sync/service.py"
Cohesion: 0.07
...
### Community 79 - "test_governance_enforcement.py"
Cohesion: 0.06
Nodes (59): Recursively strip secrets from an arbitrary argument structure. Fails…, scrub(), BudgetTracker, GovernanceGate, Holds live session budgets, bounded so it cannot leak. Sessions end without…, The one seam through which governed actions pass., AgentIdentity, new_session_id() (+51 more)

### Community 80 - "WebReach"
Cohesion: 0.07
Nodes (51): Decorator to register a function as an agent tool. Usage::…, Register the built-in agent tools that are always available., Register the Web Reach capability (agent/web_reach.py): zero-key internet…, _register_builtin_tools(), _register_web_reach_tools(), _egress_policy_reason(), get_web_reach(), _load_script_module() (+43 more)

### Community 81 - "RewardScorer"
Cohesion: 0.05
...
Cohesion: 0.06
Nodes (60): Replace the process-wide store. Tests only., reset_approval_store(), AuditLog, Bounded in-memory ring buffer plus a structured log stream. The ring buffer…, Aggregate view for the dashboard and the metrics endpoint. ``would_block`` is…, Replace the process-wide audit log. Tests only., reset_audit_log(), Replace the process-wide engine. Tests only. (+52 more)

### Community 85 - "test_llm_router_tpm.py"
Cohesion: 0.05
Nodes (54): build_summariser(), ContextManager, estimate_tokens(), FitResult, message_tokens(), prune(), Any, packages/llm/context.py — keeping conversations inside the context window. The… (+46 more)
...
### Community 88 - "OrchestratorSupervisor"
Cohesion: 0.05
Nodes (31): Return orchestrator queue depth, active runs, and supervisor state (#522)., workflow_orchestrator_status(), codeql_count(), dependabot_count(), main(), Any, _repo_parts(), _request() (+23 more)

### Community 89 - "test_colibri_brain_shim.py"
Cohesion: 0.05
...
Cohesion: 0.07
Nodes (48): delegate_seo_findings(), list_seo_audits(), BaseModel, get, post, SEO / GEO / AIO Audit API Router Endpoints for the world-class SEO audit engine…, Return the full SEO/GEO/AIO check catalog. Static metadata only, but gated…, List stored audits for this company (most recent first). (+40 more)

### Community 91 - "KeyStore"
Cohesion: 0.06
...
### Community 95 - "test_control_plane_api.py"
Cohesion: 0.04
Nodes (39): set_scheduler(), create_schedule(), delete_schedule(), get_schedule(), get_schedule_runs(), list_schedules(), BaseModel, delete (+31 more)
...
### Community 100 - "StreamingDeltaReconstructor"
Cohesion: 0.06
...
### Community 102 - "test_trend_scoping.py"
Cohesion: 0.08
Nodes (55): Issue title: the failure mode plus how hard it is recurring., _company_attr(), company_stack_tags(), extract_stack_tags(), fan_out_trend(), fan_out_trends(), is_code_change_trend(), map_trend_to_company_task() (+47 more)

### Community 103 - "api_keys_for"
Cohesion: 0.05
Nodes (32): provider_api_keys(), Every API key configured for *provider*, primary first. Reads ``base_env`` then…, _build_request(), Return ``(url, headers, is_anthropic_native)`` for *provider*. Anthropic's…, api_keys_for(), Per-provider API key rotation — the one lever that adds capacity. Every other…, Clear pool state (tests only)., All keys configured for *provider_id*, primary first. Thin delegate to… (+24 more)

### Community 104 - "run_tests"
Cohesion: 0.07
...
### Community 106 - "RenderFinding"
Cohesion: 0.05
Nodes (40): build_render_router(), Any, APIRouter, Exception, backend/render_router.py — Render platform view for operators and agents.…, Reject anyone who is not the agency admin., Map an MCP transport failure onto 503 rather than a 500. The distinction…, _require_admin() (+32 more)

### Community 107 - "ai_runner.py"
Cohesion: 0.07
...
### Community 110 - "ReactScratchpad"
Cohesion: 0.06
Nodes (24): Declarative configuration for a specialized sub-agent role. Each sub-agent gets…, SubAgentConfig, build_react_prompt(), parse_react_response(), Any, Parse a ReAct-format response into structured components. Intended caller:…, Structured scratchpad that accumulates across tool calls within a step. Each…, Record a reasoning step before taking action. (+16 more)

### Community 111 - "ProvidersScreen.jsx"
Cohesion: 0.05
...
### Community 116 - "ChatPage.js"
Cohesion: 0.05
Nodes (47): cancelAgentChatJob(), chatSend(), deleteSession(), getAgentChatJob(), getSession(), listProviderModels(), listSessions(), resumeAgentChatJob() (+39 more)
...
### Community 118 - "SeoAuditRequest"
Cohesion: 0.07
Nodes (33): Run a full SEO/GEO/AIO audit against a website and persist the evidence., run_seo_audit(), field_validator, A single occurrence of a check firing on a specific URL., Site-level facts discovered during the crawl., Request to run an SEO/GEO/AIO audit against a website., SeoAuditRequest, SeoIssueInstance (+25 more)

### Community 119 - "TaskIn"
Cohesion: 0.06
Nodes (38): _active_primary_provider(), Best-effort read of the active brain's primary provider (or ``None``)., Resolve the model id to force for a code-execution run, or ``None``. Returns…, resolve_coding_model_preference(), _check_auth(), health(), Any, BaseModel (+30 more)

### Community 120 - "test_model_catalog.py"
Cohesion: 0.06
Nodes (54): _build_candidates_from_yaml(), _build_presets_from_yaml(), get_provider_candidates(), get_provider_display_name(), get_provider_tier(), _load_models_yaml(), Extract the per-provider ``candidates`` failover list from the YAML., Return the ordered failover candidate list for *provider*. The first element is… (+46 more)
...
### Community 123 - "FeatureUnavailableError"
Cohesion: 0.08
...
### Community 126 - "test_governance_api.py"
Cohesion: 0.06
...
### Community 133 - "_resolve_brain_provider"
Cohesion: 0.06
Nodes (35): Resolve the LLM endpoint for agent execution (module-level, #522 failover).…, _resolve_brain_provider(), Critical failover-safety test: if every free provider's base URL is excluded…, When the ONLY configured provider is a paid one (e.g. operator set…, When only Anthropic is configured AND allow_paid=False (default), the resolver…, When AGENT_LLM_BASE_URL is set, the brain resolver must return that endpoint —…, When a free cloud provider (NVIDIA NIM, etc.) is configured, the brain resolver…, _run() (+27 more)

### Community 134 - "api.ts"
Cohesion: 0.09
...
### Community 135 - "test_sam_voice.py"
Cohesion: 0.05
Nodes (43): get_sam(), agent/sam.py — SAM Voice Agent (System Autonomy Manager) SAM is the voice-…, Process a voice command and return SAM's spoken response. Args: text: The…, Call the NVIDIA NIM LLM (free tier) for SAM's response., Rule-based fallback when the LLM is unavailable., A single voice conversation session with SAM., SamConversation, asyncio (+35 more)

### Community 136 - "test_brain_failover.py"
Cohesion: 0.06
Nodes (42): Reset the singleton (for tests)., reset_failover_manager(), _clean_env(), _FakeAsyncClient, _FakeResponse, Regression test: HTTP 413 (Payload Too Large) must fail over to the next…, Returns 413 for every call to a Groq URL, success for anything else., Groq (will 413) + Cerebras (will succeed) both configured, NVIDIA deliberately… (+34 more)
...
### Community 139 - "TrendWatcher"
Cohesion: 0.12
Nodes (18): Any, AsyncClient, Path, agent/trend_watcher.py — Internet-connected AI trend intelligence. Fetches from…, Fetches AI trend signals from many public sources and surfaces relevant ones., Fetch all sources in parallel; return new alerts sorted by relevance., Fan trends out to onboarded companies whose stack matches (G4). For each…, Dispatch high-relevance alerts to the Hermes sidecar for action. Only… (+10 more)

### Community 140 - "AgentSwarm"
Cohesion: 0.06
...
### Community 143 - "Settings"
Cohesion: 0.04
Nodes (28): _env_int(), _get_settings(), Read an int env var, falling back to *default* on a missing/bad value. Never…, When True, the governance layer evaluates and audits agent actions. This is…, Typed configuration loaded from environment variables., When True, approval-gated actions self-approve. Local dev only., ``RENDER_SERVICE_IDS`` split into a clean list (empty when unset)., True when there is both an API key and an endpoint to reach. (+20 more)

### Community 144 - "TestPayloadNormalisation"
Cohesion: 0.06
Nodes (25): _as_list(), _coerce_payload(), Any, Return tool output as Python data. MCP tool results arrive either as…, Normalise a tool payload into a list of dicts. Upstream tools variously return…, Unwrap a nested envelope such as ``{"service": {...}}`` when present., Run the MCP handshake once per client instance. Streamable-HTTP servers create…, Call a Render MCP tool and return its decoded payload. Raises… (+17 more)
...
### Community 147 - "PatternConsolidation"
Cohesion: 0.08
...
### Community 148 - "test_slop_gate.py"
Cohesion: 0.07
...
### Community 153 - "get_task_store"
Cohesion: 0.06
Nodes (42): all_settings(), _as_bool(), _as_int(), ephemeral_ttl_hours_cached(), get_setting(), _maybe_schedule_refresh(), onboarding_gate_enabled(), onboarding_gate_enabled_cached() (+34 more)

### Community 154 - "emit_chat_observation"
Cohesion: 0.08
...
### Community 157 - "test_e2b_task_wiring.py"
Cohesion: 0.08
...
### Community 159 - "OnboardingScreen.jsx"
Cohesion: 0.05
...
### Community 160 - "OllamaCircuitBreaker"
Cohesion: 0.08
...
### Community 162 - "PromptCacheManager"
Cohesion: 0.06
...
### Community 166 - "test_integration_c4_c5_c6_d3.py"
Cohesion: 0.07
...
### Community 167 - "activation_api.py"
Cohesion: 0.10
...
### Community 168 - "SeoAuditReport"
Cohesion: 0.11
Nodes (37): _expire_stale_pending_report(), get_seo_audit(), Fetch a complete stored audit report. Side-effect: an audit whose stub is still…, Auto-fail a pending SEO audit stub that is older than…, An agent-delegable remediation work package derived from the findings. Findings…, Complete result of one audit run., SeoAuditReport, SeoDelegationTask (+29 more)

### Community 169 - "[Unreleased]"
Cohesion: 0.05
Nodes (43): [5.0.0], Added, Added, Added, Added, Added, Added, Added (+35 more)

### Community 170 - "[Unreleased]"
Cohesion: 0.05
Nodes (43): [5.0.0], Added, Added, Added, Added, Added, Added, Added (+35 more)

### Community 171 - "HealthStatus"
Cohesion: 0.06
...
### Community 175 - "test_portfolio_intake.py"
Cohesion: 0.08
...
Cohesion: 0.07
Nodes (20): _digest(), KeyPool, _KeyState, _PoolState, Round-robin key selection with per-key rate-limit cooldowns., Return the next usable key, or None when every key is cooling. With one key…, Cool a single key after a 429 from it. Honours the provider's own ``Retry-…, True when every key in the pool is resting. This is the signal that the… (+12 more)

### Community 178 - "QuickNoteQueue"
Cohesion: 0.11
Nodes (30): _fetch_text(), _now(), process_note(), Any, Path, QuickNote, QuickNoteQueue, agent/quick_note.py — iPhone Quick Note integration. Persistent URL queue +… (+22 more)
...
### Community 181 - "Persistent Memory System"
Cohesion: 0.05
...
### Community 182 - "TestRuntimeControl"
Cohesion: 0.05
...
### Community 183 - "AGENTS.md — Source of Truth for All AI Agents"
Cohesion: 0.05
...
### Community 185 - "anthropic_compat.py"
Cohesion: 0.09
...
### Community 187 - "test_north_mini_code.py"
Cohesion: 0.06
...
### Community 188 - "compare_runtimes.py"
Cohesion: 0.07
...
### Community 189 - "ContextWindowManager"
Cohesion: 0.09
...
### Community 191 - "test_self_heal_v2.py"
Cohesion: 0.09
Nodes (39): _heal_brain_failover(), _heal_stuck_tasks(), _heal_task_duplicates(), _heal_telegram(), _heal_timestamps(), Any, services/self_heal.py — Autonomous self-healing for the agency. Runs periodic…, Backfill source_id on legacy ceo_direct tasks, then dedup by source_id. Two… (+31 more)

### Community 192 - "test_e2b_data_flow.py"
Cohesion: 0.08
Nodes (30): fake_sandbox(), _FakeAsyncSandboxClass, _FakeCmdResult, _FakeCommands, _FakeFiles, _FakeSandbox, Any, asyncio (+22 more)

### Community 193 - "v4_api.py"
Cohesion: 0.10
Nodes (38): _get_cached_tasks(), _get_tasks_cache_lock(), _load_improvement_state(), Any, BaseModel, get, Lock, post (+30 more)

### Community 194 - "getBackendUrl"
Cohesion: 0.10
...
### Community 195 - "TestAuthAndTaskOwnership"
Cohesion: 0.05
...
### Community 197 - "test_workspace_isolation.py"
Cohesion: 0.19
...
### Community 199 - "KnowledgeScreen.jsx"
Cohesion: 0.09
...
### Community 201 - ".execute"
Cohesion: 0.06
Nodes (24): Resolve the base URL of the agency's own Hermes server. Precedence:…, resolve_hermes_base_url(), _env_float(), Any, AsyncClient, Response, TaskResult, TaskSpec (+16 more)
...
### Community 204 - "V5App.jsx"
Cohesion: 0.05
Nodes (29): API, getLoops(), V5App, ActivationGate(), activityToAlert(), AlertsBell(), priorityConfig, _relativeTime() (+21 more)

### Community 205 - "test_daily_2026_06_04.py"
Cohesion: 0.08
...
### Community 206 - "provider_max_rpm"
Cohesion: 0.08
Nodes (28): provider_max_parallel(), provider_max_rpm(), provider_max_tpm(), _provider_positive_float(), provider_weight(), Shared parse/validate for the numeric per-provider traffic budgets. Returns…, Return the operator-configured requests/min cap for *provider*, or None if…, Return the operator-configured tokens/min cap for *provider*. Reads… (+20 more)

### Community 207 - "ServiceDaemon"
Cohesion: 0.09
Nodes (26): configure(), get_status(), health(), BaseModel, get, post, Validate configured paths., Check if proxy is running. (+18 more)

### Community 208 - "ContextPruner"
Cohesion: 0.09
...
### Community 209 - "session_retro.py"
Cohesion: 0.13
...
### Community 210 - "test_operational_incidents.py"
Cohesion: 0.06
...
### Community 214 - "test_issue_intake.py"
Cohesion: 0.12
...
### Community 215 - "test_crispy_workflow.py"
Cohesion: 0.09
Nodes (19): _fake_artifact(), _make_engine(), tests/test_crispy_workflow.py — CRISPY workflow engine hardening tests. Tests…, Create a WorkflowEngine with isolated storage., TestAbortOnFailure, TestPhaseSequence, TestPhaseSequenceError, TestWorkspaceIsolation (+11 more)
...
### Community 219 - "test_verification_strategies.py"
Cohesion: 0.12
...
### Community 222 - "RuntimeHealth"
Cohesion: 0.07
Nodes (15): Available iff config resolves AND the SDK is importable. Never raises — a…, Determine availability of the internal agent runtime. Checks cloud providers in…, TaskResult, TaskSpec, Create a conversation in OpenHands and poll for completion., Health status snapshot for a runtime., RuntimeHealth, Return the last-known health for *runtime_id* (may be stale). (+7 more)

### Community 223 - "test_background_services.py"
Cohesion: 0.08
...
### Community 224 - "NIMConnectionPool"
Cohesion: 0.08
...
### Community 225 - "test_all_providers_discovery.py"
Cohesion: 0.16
...
### Community 226 - "test_persistent_memory.py"
Cohesion: 0.06
...
### Community 232 - "test_llm_router_e2e.py"
Cohesion: 0.14
...
### Community 233 - "Artifact"
Cohesion: 0.10
Nodes (22): AgentRole, get_engine(), workflow/engine.py — WorkflowEngine: CRISPY phase sequencer. The engine is the…, Return the shared WorkflowEngine singleton (lazy-init)., Reset the singleton (test helper)., reset_engine(), workflow — CRISPY deterministic workflow engine. Lifecycle: request → context →…, Artifact (+14 more)

### Community 234 - "agents/agile_ceremonies.py"
Cohesion: 0.09
...
### Community 235 - "report_to_markdown"
Cohesion: 0.11
...
### Community 236 - "agent_runtime.py"
Cohesion: 0.11
...
### Community 237 - "ENGINEERING_STANDARDS.md — Coding, Security & Testing Standards"
Cohesion: 0.06
...
### Community 242 - "test_live_server.py"
Cohesion: 0.22
...
### Community 243 - "ContextCompressor"
Cohesion: 0.11
...
### Community 245 - "operational_incidents.py"
Cohesion: 0.10
Nodes (31): _diagnose_and_file(), _file_incident(), _format_incident(), get_operational_incident_tracker(), _iso_from_monotonic(), OperationalIncident, _phase_section(), agent/operational_incidents.py — recurring operational failures, auto-… (+23 more)

### Community 246 - "FilterResult"
Cohesion: 0.12
Nodes (20): filter_output(), FilterResult, get_output_filter(), get_savings_summary(), OutputFilter, agent/output_filter.py — LLM Output Compression & Token Savings Inspired by…, Filter and compress command outputs to reduce LLM token consumption. Provides…, Compact git status output — keep only changed file paths. (+12 more)

### Community 247 - "SparkProvider"
Cohesion: 0.07
...
### Community 248 - "chat_handlers.py"
Cohesion: 0.12
...
### Community 249 - "TaskDetailPanel.jsx"
Cohesion: 0.07
Nodes (26): addTaskComment(), clarifyTask(), escalateTask(), fetchVelocity(), followUpTask(), updateTask(), HEALTH_COLORS, HEALTH_DOTS (+18 more)

### Community 250 - "test_rate_limiter.py"
Cohesion: 0.09
Nodes (28): pace(), Proactive rate-limit throttling for LLM providers — two complementary layers.…, Reset all state (primarily for tests)., Rate limiter using virtual scheduling (GCRA-style): each caller atomically…, Block until this caller's reserved slot arrives, or *max_wait* elapses. Returns…, Proactively pace a request to *provider_id*. No-op (returns 0.0 immediately)…, Clear all token-bucket state (tests only). Does not touch the header tracker's…, reset() (+20 more)

### Community 251 - "Screens"
Cohesion: 0.06
...
### Community 253 - "test_microagents.py"
Cohesion: 0.15
...
### Community 254 - "Security Analysis — local-llm-server"
Cohesion: 0.06
...
### Community 255 - "Langfuse Observability Guide"
Cohesion: 0.06
...
### Community 260 - "run_regression"
Cohesion: 0.12
Nodes (15): Page, Tasks: create, list, view., Agents: list, view status., Chat: send message, view sessions, delete session, agent mode toggle., Runtimes: list, health, decisions, policy., Settings, Secrets, Features, Setup, GitHub, Activation., GitHub integration: status, repos., Run the full regression suite for a given viewport. (+7 more)

### Community 261 - "SpecEntry"
Cohesion: 0.12
Nodes (17): get_enrichment(), Return the enrichment instance for a workspace. Keyed by workspace root rather…, build_block(), _flag(), Rewrite the spec file, preserving any non-entry (hand-written) lines., Compact prompt block of standing instructions, or '' when there are none.…, One standing instruction plus the evidence that earned it., SpecEntry (+9 more)

### Community 262 - "StuckDetector"
Cohesion: 0.13
...
### Community 265 - "Quick-Note GitHub Issues Processing - Session Summary"
Cohesion: 0.06
...
### Community 268 - "CompanyAgencyService"
Cohesion: 0.09
...
### Community 270 - "test_mcp_governance.py"
Cohesion: 0.11
...
### Community 271 - "test_purge_backlog.py"
Cohesion: 0.09
...
### Community 272 - "tests/test_browser.py"
Cohesion: 0.10
...
### Community 277 - "test_autonomy_gate.py"
Cohesion: 0.11
...
### Community 278 - "test_rag_context.py"
Cohesion: 0.12
...
### Community 279 - "Configuration Reference"
Cohesion: 0.07
...
### Community 280 - "audit"
Cohesion: 0.09
Nodes (18): audit(), Request, FastAPI dependency: require any authenticated user., Append an audit log entry. Never logs raw secrets — only secret IDs / masked…, require_authenticated(), Tests for scripts/agent_readiness_audit.py — the 8-pillar readiness scorer., This repo ships pre-commit config, tests, docs, and the intake/retro loops…, test_main_check_flag_fails_below_threshold() (+10 more)

### Community 281 - "test_pr923_fixes.py"
Cohesion: 0.09
...
### Community 282 - "SteeringInjector"
Cohesion: 0.11
...
### Community 283 - "test_phase4_runtime_resilience.py"
Cohesion: 0.10
...
### Community 284 - "test_claude_setup_audit.py"
Cohesion: 0.16
...
### Community 285 - "brain_liveness.py"
Cohesion: 0.10
Nodes (19): _is_dns_failure(), _probe_failure_reason(), BaseException, services/brain_liveness.py — Provider liveness prober for the brain switcher.…, Turn a probe exception into an operator-actionable one-line reason. A dead…, True when *exc* (or anything it wraps) is a name-resolution failure., asyncio, Exception (+11 more)

### Community 286 - "test_brain_config_api.py"
Cohesion: 0.08
...
### Community 287 - "test_internal_agent_did_work.py"
Cohesion: 0.12
...
### Community 290 - "llm_providers.py"
Cohesion: 0.16
...
### Community 291 - "test_backend_server_features.py"
Cohesion: 0.08
...
### Community 292 - "BrainFailoverManager"
Cohesion: 0.10
...
### Community 293 - "test_crispy_burn_in.py"
Cohesion: 0.07
...
### Community 294 - "test_provider_enable_disable.py"
Cohesion: 0.09
...
### Community 295 - "TestSchedulerStore"
Cohesion: 0.07
...
### Community 296 - "test_skill_registry_boot_refresh.py"
Cohesion: 0.12
...
### Community 298 - "test_scaffolding.py"
Cohesion: 0.11
...
### Community 299 - "analyze_qualitative"
Cohesion: 0.12
...
### Community 300 - "test_watchdog.py"
Cohesion: 0.09
...
### Community 302 - "Deploy: FreeBuff Telegram bot (24×7)"
Cohesion: 0.07
...
### Community 303 - "Claude Code + Qwen Local Setup"
Cohesion: 0.07
...
### Community 304 - "Docker Agent Runtimes Setup"
Cohesion: 0.07
...
### Community 305 - "TestSelfHealingInfrastructureClassification"
Cohesion: 0.10
...
### Community 306 - "generate_context.py"
Cohesion: 0.12
...
### Community 307 - "settings.py"
Cohesion: 0.10
Nodes (16): Cerebras provider adapter — free, fast LLM (qwen-3-coder-480b)., Ollama provider adapter — local LLM inference., packages.ai — provider abstraction, model registry, and failover manager., packages/ai/manager.py — ProviderManager. Single entry point for all LLM calls.…, Provider, ABC, packages/ai/provider.py — Provider abstraction interface. Every LLM provider…, Base interface every provider must implement. Implementations live in… (+8 more)

### Community 308 - "isolated_telegram_config"
Cohesion: 0.11
...
### Community 309 - "test_failover_silent_exhaustion.py"
Cohesion: 0.11
...
### Community 310 - "_FakePersistence"
Cohesion: 0.13
Nodes (23): _every_minute_one_shot(), _FakePersistence, asyncio, A timestamp we cannot parse must not authorise a delete., An agency-directive-shaped row: cron="* * * * *", uniquely named., 2026-08-03: the 7-day fallback let a live crash loop regrow the backlog from a…, Must not delete a same-pattern row that hasn't had time to fire yet., A "0 9 * * *" run-once row legitimately waits up to ~24h for its one scheduled… (+15 more)

### Community 311 - "test_scheduler_hydration_bounded.py"
Cohesion: 0.09
...
### Community 314 - "test_terminal.py"
Cohesion: 0.10
...
### Community 315 - "Performance Analysis — local-llm-server"
Cohesion: 0.08
...
### Community 316 - "LLM Router — troubleshooting"
Cohesion: 0.08
...
### Community 317 - "all_provider_ids"
Cohesion: 0.08
...
### Community 320 - "probe_model_liveness"
Cohesion: 0.11
Nodes (19): _describe_http_status(), probe_model_liveness(), _probe_openai_compat(), Probe an OpenAI-compatible provider (Cerebras / Groq / NIM / Z.ai / Aerolink)., Turn an HTTP status into a short, human-readable reason. The plan specifically…, Probe ``(provider, model)`` for liveness. Never raises. Returns a…, _FakeAsyncClient, _FakeResponse (+11 more)
...
### Community 334 - ".provision_specialist"
Cohesion: 0.10
Nodes (14): Any, SpecialistFamily, SystemType, Auto-provision specialists based on detected system types. Args: company_id:…, Get specialists that can handle a task with given capabilities. Args:…, Get the best specialist for a task. Args: company_id: Company ID capabilities:…, Get all specialists of a specific family for a company. Args: company_id:…, List specialists with optional filtering. Args: company_id: Filter by company… (+6 more)
...
### Community 337 - "test_daily_automation_2026_08_03.py"
Cohesion: 0.11
...
### Community 338 - "TestClassifyPlainText"
Cohesion: 0.08
...
### Community 339 - "test_sam_livekit.py"
Cohesion: 0.08
...
### Community 340 - "test_service_token.py"
Cohesion: 0.08
...
### Community 343 - "Local AI Stack with Docker"
Cohesion: 0.08
...
### Community 344 - "Traffic Distribution Across Providers"
Cohesion: 0.08
...
### Community 345 - "Implementation Prompt: Rich TaskBoard + Agile Sprint Integration"
Cohesion: 0.08
...
### Community 346 - "Telegram Bot Setup"
Cohesion: 0.08
...
### Community 353 - "test_agency_fix.py"
Cohesion: 0.08
...
### Community 354 - "test_output_filter.py"
Cohesion: 0.08
...
### Community 357 - "CollaborationContext"
Cohesion: 0.12
...
### Community 358 - "monitor_colibri.py"
Cohesion: 0.24
...
### Community 359 - "get_failover_manager"
Cohesion: 0.13
Nodes (22): openclaw_websocket(), websocket, WebSocket endpoint for iOS / mobile web UI pairing + command routing., get_failover_manager(), Return the singleton BrainFailoverManager., _cmd_chat(), _cmd_freebuff(), _cmd_list_files() (+14 more)

### Community 360 - "Agent Governance Guide"
Cohesion: 0.09
...
### Community 361 - "The fifteen strategies"
Cohesion: 0.09
...
### Community 365 - "test_all_features.py"
Cohesion: 0.09
...
### Community 367 - "test_monitor_lib.py"
Cohesion: 0.11
...
### Community 369 - "test_mostly_failed_steps.py"
Cohesion: 0.12
...
### Community 375 - "test_provider_state_durability.py"
Cohesion: 0.10
Nodes (16): Drop the cached Mongo client, backoff, and read caches (tests)., reset_kv_state(), one_configured_provider(), A registry with exactly two known providers and isolated state., fake_mongo(), _FakeDb, isolated_state(), _live_mongo_url() (+8 more)

### Community 376 - "reap_expired_companies"
Cohesion: 0.15
...
### Community 377 - "PriorityTaskQueue"
Cohesion: 0.13
...
### Community 378 - "_process_task_callback"
Cohesion: 0.17
...
### Community 380 - "test_portfolio_intelligence.py"
Cohesion: 0.10
...
### Community 381 - "TestRenderMCPSidecarService"
Cohesion: 0.16
...
### Community 384 - "_resolve_user_github_token"
Cohesion: 0.18
...
### Community 385 - "V3 API Migration Plan — LLM Relay Platform"
Cohesion: 0.10
...
### Community 388 - "traffic_director.py"
Cohesion: 0.13
...
### Community 389 - "model_discovery.py"
Cohesion: 0.13
Nodes (20): cached_models(), discover_models(), _fresh_entry(), _models_url(), _parse_ids(), Any, Ask a provider which models the configured API key may actually use.…, Return the cached list for *provider_id* without any network call. The… (+12 more)
...
### Community 392 - "AuditEvent"
Cohesion: 0.10
Nodes (14): AuditEvent, One governed action, fully described. Field order follows the…, One-line JSON, suitable for a SIEM shipper tailing the log., Store and emit *event*. Never raises., Return the most recent events, newest first, optionally filtered., _truncate(), The stored object must not hold the secret at all., An unbounded audit list is a memory leak with a security justification. (+6 more)

### Community 393 - "daily_digest.py"
Cohesion: 0.23
...
### Community 394 - "IssueCategory"
Cohesion: 0.10
Nodes (31): IssueCategory, IssueSeverity, Enum, str, agent/improvement_loop.py — Continuous Improvement Engine Background scanner…, FailureCategory, HealState, Enum (+23 more)

### Community 395 - "test_local_controller.py"
Cohesion: 0.17
...
### Community 396 - "run_trend_analysis"
Cohesion: 0.19
...
### Community 398 - "test_permissions.py"
Cohesion: 0.15
...
### Community 399 - "PersistentMemoryStore"
Cohesion: 0.24
...
### Community 402 - "Design Audit"
Cohesion: 0.10
Nodes (19): Code Quality, Color and Surfaces, Component Patterns, Content, Design Audit, Fix Priority, How This Works, Iconography (+11 more)

### Community 403 - "Findings"
Cohesion: 0.10
...
### Community 407 - "Docker AI Governance Audit — Final Report"
Cohesion: 0.10
...
### Community 408 - "1. Capability-by-capability"
Cohesion: 0.10
...
### Community 410 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 417 - "test_kimi_bridge_server.py"
Cohesion: 0.12
...
### Community 418 - "test_backend_runtime_bootstrap.py"
Cohesion: 0.11
...
### Community 419 - "test_onboarding_provisioning.py"
Cohesion: 0.15
...
### Community 420 - "test_tasks_cache_ttl_env.py"
Cohesion: 0.21
...
### Community 421 - "test_voice_pipeline.py"
Cohesion: 0.14
...
### Community 424 - "_extract_tech_relevance"
Cohesion: 0.17
...
### Community 427 - "Skill: fabric-patterns"
Cohesion: 0.11
...
### Community 428 - "Analysis & Synthesis Instructions"
Cohesion: 0.11
Nodes (18): 1. Define the Atmosphere, 2. Map the Color Palette, 3. Establish Typography Rules, 4. Define the Hero Section, 5. Describe Component Stylings, 6. Define Layout Principles, 7. Define Responsive Rules, 8. Encode Motion Philosophy (+10 more)

### Community 429 - "Production Readiness Assessment — local-llm-server"
Cohesion: 0.11
...
### Community 430 - "test_dashboard_cache.py"
Cohesion: 0.18
...
### Community 431 - "TestNormalizeResponseFormat"
Cohesion: 0.11
...
### Community 432 - "Skill: fabric-patterns"
Cohesion: 0.11
Nodes (18): 1. Ensure Pattern Directory Exists, 2. List Available Patterns, 3. Retrieve a Pattern, 4. Apply a Pattern with Variables, 5. Stitch Patterns Together, 6. Create New Patterns, Acceptance Checks, Directory Structure (+10 more)

### Community 433 - "db/__init__.py"
Cohesion: 0.15
...
### Community 434 - "Admin Dashboard Guide"
Cohesion: 0.11
...
### Community 437 - "ProviderConsole.jsx"
Cohesion: 0.11
Nodes (10): ALIASES, canonicalId(), CATALOGUE, FILTERS, ADR-0008, mergeProviders(), ProviderRow(), STATE (+2 more)

### Community 438 - "Any"
Cohesion: 0.11
Nodes (12): _age_seconds(), Any, Capture the FastAPI main event loop so APScheduler's background thread can…, Attach a durable store and immediately rehydrate from it (#505). Called at…, Async variant of :meth:`attach_persistence` for callers already on an event…, The one retention policy for unfired one-shots, read from its owner.…, Durably remove one unfired run-once row and its in-memory mirror. Returns True…, Force-dedup and clean stale schedules from both the durable store and in-memory… (+4 more)

### Community 439 - "Delegation Plan (agent-ready work packages)"
Cohesion: 0.11
...
### Community 440 - "parse_event_stream"
Cohesion: 0.15
...
### Community 443 - "SyntheticDataPipeline"
Cohesion: 0.17
...
### Community 444 - "test_task_source_id_race.py"
Cohesion: 0.17
...
### Community 445 - "test_brain_patch_service_token.py"
Cohesion: 0.18
...
### Community 446 - "test_fabric_patterns.py"
Cohesion: 0.11
...
### Community 447 - "test_repowise_intelligence.py"
Cohesion: 0.11
...
### Community 448 - "test_schedule_persistence.py"
Cohesion: 0.17
...
### Community 449 - "validate_session_id"
Cohesion: 0.16
...
### Community 450 - "sam_livekit_worker.py"
Cohesion: 0.17
...
### Community 451 - "ErrorInterceptorMiddleware"
Cohesion: 0.18
...
### Community 452 - "github_tools.py"
Cohesion: 0.24
Nodes (16): get_repo(), _get_token(), _get_user(), init_workspace(), list_branches(), list_prs(), list_repos(), BaseModel (+8 more)

### Community 453 - "test_lessons.py"
Cohesion: 0.22
Nodes (15): _get_store(), Any, Failure lessons: turn failed runs into context for the next run. The supervisor…, Formatted prompt block of recent lessons, or '' when none exist., Persist a lesson for every failed step in a run. Never raises., recent_lessons_block(), record_step_failures(), _fresh_store() (+7 more)

### Community 454 - "LessonStore"
Cohesion: 0.15
...
### Community 456 - ".update_intelligence"
Cohesion: 0.11
...
### Community 457 - "Comprehensive Skill Index (By Category)"
Cohesion: 0.11
...
### Community 458 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 459 - "Component Map"
Cohesion: 0.11
...
### Community 460 - "Agent State — colibri GLM-5.2 deployment (resumable)"
Cohesion: 0.11
...
### Community 461 - "Architecture Overview — local-llm-server"
Cohesion: 0.11
...
### Community 462 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
...
### Community 463 - "Platform Guide — the full tour"
Cohesion: 0.11
...
### Community 465 - "Part A — Health Report"
Cohesion: 0.11
...
### Community 470 - "sync_readme_gallery.py"
Cohesion: 0.22
...
### Community 471 - "test_skill_executors_live.py"
Cohesion: 0.16
...
### Community 473 - "test_company_api.py"
Cohesion: 0.11
...
### Community 474 - "test_langfuse_agency_wide.py"
Cohesion: 0.11
...
### Community 475 - "TestStopSlopChecker"
Cohesion: 0.11
...
### Community 476 - "handle_workflow_ide_chat"
Cohesion: 0.18
...
### Community 478 - "_keyword_search"
Cohesion: 0.12
Nodes (15): _keyword_search(), Return ``(doc_index, cosine_score)`` pairs for the top-*k* matches., Score documents by query-term coverage with a title-match boost., Combine ranked lists with Reciprocal Rank Fusion., Return lowercase alphanumeric tokens with stop-words removed. Numeric tokens…, _rrf(), _tokenize(), test_keyword_search_empty_query() (+7 more)

### Community 479 - "TestHelpers"
Cohesion: 0.15
...
### Community 480 - "._fetch_flat_skill_file"
Cohesion: 0.21
...
### Community 481 - "SKILL: Industrial Brutalism & Tactical Telemetry UI"
Cohesion: 0.12
...
### Community 482 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 483 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 484 - "test_admin_local_brain_router.py"
Cohesion: 0.18
...
### Community 485 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 486 - "Section-by-Section Acceptance Criteria"
Cohesion: 0.12
...
### Community 488 - "redact_connection_url"
Cohesion: 0.17
...
### Community 490 - "agent_readiness_audit.py"
Cohesion: 0.21
...
### Community 494 - "test_shared_state.py"
Cohesion: 0.17
...
### Community 495 - "test_activation_api.py"
Cohesion: 0.21
...
### Community 496 - "test_health_endpoints.py"
Cohesion: 0.17
...
### Community 497 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 500 - "test_schedule_backlog_drain.py"
Cohesion: 0.15
Nodes (16): _one_shot(), Why the 2026-08-01 backlog never drained, despite a fix already existing.…, The pre-existing behaviour has to survive the new branch above it., The previous failure was invisible: four digits at INFO beside two zeroes., Adding it looks like a fix and is a worse bug. ``packages/storage/sqlite.py``…, Guard the drift that caused this: two files naming the same collection., A uniquely-named run-once row — the shape that piled up., The exact production shape: unique names, run_count 0, cleanup at zero. (+8 more)

### Community 501 - "test_task_service_failed_comment.py"
Cohesion: 0.18
...
### Community 502 - "test_tasks_reconciler_todo_requeue.py"
Cohesion: 0.18
...
### Community 503 - "hermes_prompt.py"
Cohesion: 0.19
...
### Community 504 - "MemoryMiddleware"
Cohesion: 0.17
...
### Community 506 - "Skill: repowise-intelligence"
Cohesion: 0.12
...
### Community 507 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
...
### Community 508 - "Skill: repowise-intelligence"
Cohesion: 0.12
Nodes (15): 1. Graph Intelligence (Dependency Graph), 2. Git Intelligence, 3. Documentation Intelligence, 4. Decision Intelligence, Acceptance Checks, Directory Structure, Example Usage, Implementation Approach (+7 more)

### Community 509 - "The 10-Step Workflow"
Cohesion: 0.12
...
### Community 510 - "Contributing to local-llm-server"
Cohesion: 0.12
...
### Community 511 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 512 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 513 - "Agent Runtime Setup"
Cohesion: 0.12
...
### Community 514 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
...
### Community 515 - "implement_agent.py"
Cohesion: 0.16
...
### Community 516 - "infra_cost.py"
Cohesion: 0.16
Nodes (10): _float_env(), get_infra_config(), InfraConfig, load_infra_config(), Local infrastructure cost model for true TCO analysis. This module computes the…, Estimated cost for a typical coding session and daily/monthly projections., Amortised hardware cost in USD per second of operation., Load infrastructure config from environment variables. All values have… (+2 more)

### Community 517 - "PersistentQueue"
Cohesion: 0.20
...
### Community 522 - "ManagedAgentDreams"
Cohesion: 0.22
...
### Community 524 - "test_autonomy_status.py"
Cohesion: 0.12
...
### Community 525 - "test_dockerfile_ships_root_modules.py"
Cohesion: 0.17
...
### Community 526 - "test_frontend_deployment_guards.py"
Cohesion: 0.20
...
### Community 527 - "test_glm52_brain.py"
Cohesion: 0.12
...
### Community 528 - "test_local_brain_state.py"
Cohesion: 0.12
...
### Community 530 - "test_phase5_doctor.py"
Cohesion: 0.12
...
### Community 531 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 533 - "Skill: agent-harness"
Cohesion: 0.13
...
### Community 534 - "Skill: checkpoint-strategy"
Cohesion: 0.13
...
### Community 536 - "Skill: local-ai-query"
Cohesion: 0.13
...
### Community 537 - "Skill: parallel-agents"
Cohesion: 0.13
...
### Community 538 - "Skill: parallel-worktrees"
Cohesion: 0.13
...
### Community 539 - "Design System: Taste Standard"
Cohesion: 0.13
...
### Community 542 - "Skill: user-research"
Cohesion: 0.13
...
### Community 543 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 544 - "Attention Mechanisms Internals"
Cohesion: 0.13
...
### Community 546 - "test_daily_2026_07_24.py"
Cohesion: 0.20
...
### Community 549 - "router/health.py"
Cohesion: 0.20
...
### Community 550 - "DockerAgentAdapter"
Cohesion: 0.17
...
### Community 553 - "_NoopStore"
Cohesion: 0.18
Nodes (7): _NoopStore, Any, Inject additional instructions into an in-flight run (no state change). Backs…, List recent runs. When ``owner_id`` is provided, only runs stamped with that…, No-op checkpoint store when the real one is unavailable., Persist run state for crash recovery., #522: Restore in-flight runs from checkpoint store after a restart. Returns the…

### Community 554 - "clear_wizard_state_cache"
Cohesion: 0.21
...
### Community 555 - "e2e/test_browser.py"
Cohesion: 0.23
...
### Community 557 - "test_dockerfile_ships_config_dir.py"
Cohesion: 0.14
...
### Community 559 - "test_scanner_live.py"
Cohesion: 0.23
...
### Community 560 - "OperationalIncidentTracker"
Cohesion: 0.14
Nodes (9): OperationalIncidentTracker, Count operational failures; diagnose and file the ones that persist. Every…, Start with no tracked signatures and no filing history., Reconcile the admission granted in ``_may_file`` with what happened. Admission…, Drop all state. Used by tests., Forget signatures that have gone quiet. Caller must hold the lock. A signature…, Cooldown + hourly cap. Caller must hold the lock. Reserves the slot on success.…, A tracker whose filing step is captured instead of hitting the network. (+1 more)

### Community 561 - "StopSlopChecker"
Cohesion: 0.14
...
### Community 563 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 567 - "Checks Performed"
Cohesion: 0.14
...
### Community 568 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 569 - "admin_digest_router.py"
Cohesion: 0.23
...
### Community 570 - "Skill: branch-cleanup"
Cohesion: 0.14
...
### Community 571 - "Skill: perplexity — Web Research via Perplexity API"
Cohesion: 0.14
...
### Community 574 - "Quick-Note Issues Processing Summary"
Cohesion: 0.14
...
### Community 575 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 577 - "Runbook: Auto-Resume After Cooldown / Interruption"
Cohesion: 0.14
...
### Community 578 - "SEO / GEO / AIO Audit Engine"
Cohesion: 0.14
...
### Community 583 - "TestSeoApiSurface"
Cohesion: 0.16
...
### Community 586 - "test_critical_flows.py"
Cohesion: 0.29
...
### Community 587 - "test_autonomy_pipeline_regressions.py"
Cohesion: 0.15
...
### Community 588 - "test_brain_priority_scanner.py"
Cohesion: 0.14
...
### Community 590 - "test_openclaw_gateway.py"
Cohesion: 0.14
...
### Community 591 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 592 - "TestOrchestratorEndpointScoping"
Cohesion: 0.25
...
### Community 594 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 597 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 598 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 601 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
...
### Community 602 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 603 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 605 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 611 - "Skill: platform-setup — Autonomous Agency Bootstrap"
Cohesion: 0.15
...
### Community 612 - "Device compatibility and model picks"
Cohesion: 0.15
...
### Community 613 - "Autonomy Uplift — Living Roadmap & Detailed Implementation Specs"
Cohesion: 0.15
...
### Community 614 - "OpenClaw — iOS Control of the Agency (Single-Service Free-Tier Deploy)"
Cohesion: 0.15
...
### Community 617 - "_is_bedrock_model_id"
Cohesion: 0.27
...
### Community 619 - "Agent Transparency Report"
Cohesion: 0.15
...
### Community 620 - "update_provider_policy"
Cohesion: 0.19
...
### Community 622 - "_InMemoryBackend"
Cohesion: 0.18
...
### Community 623 - "TestModelCostTableUpdates"
Cohesion: 0.26
...
### Community 624 - "TestDecisionsBotLinks"
Cohesion: 0.21
...
### Community 625 - "test_deploy_trigger_covers_image.py"
Cohesion: 0.21
...
### Community 626 - "test_doctor_service_token_check.py"
Cohesion: 0.23
...
### Community 629 - "test_telegram_task_callback.py"
Cohesion: 0.21
Nodes (9): _parked_task(), asyncio, Task, Telegram inline-button callbacks for the task pre-execution gate. Regression:…, _Recorder, store(), test_approve_button_approves_and_requeues(), test_reject_button_blocks_task() (+1 more)

### Community 630 - "TestRouterIntegration"
Cohesion: 0.31
...
### Community 632 - "WorkspaceManifest"
Cohesion: 0.17
...
### Community 634 - "skill_registry.py"
Cohesion: 0.17
...
### Community 640 - "Skill: system-prompt-audit"
Cohesion: 0.17
...
### Community 641 - "Skill: task-alive-updates"
Cohesion: 0.17
...
### Community 645 - "14. Standing Instructions — Universal Agent Discipline"
Cohesion: 0.17
...
### Community 646 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 649 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 651 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 652 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 653 - "Workspace Isolation Architecture"
Cohesion: 0.17
...
### Community 654 - "Quantization Internals"
Cohesion: 0.17
...
### Community 655 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 656 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 657 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 658 - "Render MCP — autonomous platform debugging and environment monitoring"
Cohesion: 0.17
...
### Community 661 - "test_p0_roadmap_a4_a5_b2.py"
Cohesion: 0.26
...
### Community 662 - "CircuitState"
Cohesion: 0.20
Nodes (3): CircuitState, Attempt to start a dead runtime subprocess before re-probing. Uses the local…, Reduce probe frequency for runtimes that have never come online.

### Community 663 - "check_container_posture.py"
Cohesion: 0.26
...
### Community 664 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 665 - "test_regression.py"
Cohesion: 0.17
Nodes (10): browser_login(), main(), Full desktop regression suite., Full mobile regression suite (navigation + key page loads)., Log in through the browser UI. Returns True on success., Activation: status, users., screenshot(), test_desktop_regression() (+2 more)

### Community 666 - "test_agile_api.py"
Cohesion: 0.17
...
### Community 667 - "test_app_settings.py"
Cohesion: 0.21
...
### Community 668 - "TestAuthAndTaskCreation"
Cohesion: 0.17
...
### Community 670 - "test_skill_registry.py"
Cohesion: 0.20
...
### Community 671 - "TestAnthropicPayloadStructuredOutput"
Cohesion: 0.29
...
### Community 672 - "test_task_clarification.py"
Cohesion: 0.17
...
### Community 676 - "get_render_mcp"
Cohesion: 0.18
Nodes (10): gather_render_evidence(), Any, Live counters, for the diagnostics endpoint and tests., Pull recent Render logs and summarise them for the issue body. This is the…, Run *coro* without blocking the caller, from any thread. The caller is a…, _schedule(), get_render_mcp(), Return the shared ``RenderMCPClient``. (+2 more)

### Community 677 - "_extractive_compress"
Cohesion: 0.18
...
### Community 679 - "RepowiseIntelligence"
Cohesion: 0.33
...
### Community 682 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 685 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 686 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 688 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 691 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 692 - "test_harness_spec.py"
Cohesion: 0.20
...
### Community 693 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 694 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 695 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 696 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 697 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 698 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 699 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 701 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 702 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 703 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 704 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 705 - "What to clean up"
Cohesion: 0.18
...
### Community 706 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 707 - "_status_snapshot"
Cohesion: 0.31
...
### Community 708 - "test_bedrock_live.py"
Cohesion: 0.25
...
### Community 712 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 713 - "test_event_log.py"
Cohesion: 0.45
...
### Community 714 - "test_google_provider_models.py"
Cohesion: 0.18
...
### Community 715 - "get_livekit_config"
Cohesion: 0.18
...
### Community 720 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 721 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 722 - "CLAUDE.md — Master Architect Operating Manual"
Cohesion: 0.20
...
### Community 723 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 724 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 725 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 726 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 727 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 728 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 729 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 731 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 732 - "LLM Router — configuration guide"
Cohesion: 0.20
...
### Community 733 - "LLM Router — provider guide"
Cohesion: 0.20
...
### Community 734 - "CI Troubleshooting Runbook"
Cohesion: 0.20
...
### Community 737 - "capture_screens.py"
Cohesion: 0.29
...
### Community 738 - "build_tech_db.py"
Cohesion: 0.40
...
### Community 742 - "_resolve_push_token"
Cohesion: 0.31
...
### Community 743 - "test_bootstrap_source_id_index.py"
Cohesion: 0.27
...
### Community 744 - "TestExtendedThinkingRouting"
Cohesion: 0.20
...
### Community 749 - "test_quick_note_engine.py"
Cohesion: 0.22
...
### Community 750 - "TestRevenuePortfolio"
Cohesion: 0.20
...
### Community 756 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 758 - "Coding Standards"
Cohesion: 0.22
...
### Community 762 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 763 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 764 - "Skill: changelog-enforcer"
Cohesion: 0.22
Nodes (8): Acceptance Checks, Changelog Location, Entry Format, Examples, Hook Behaviour, Instructions, Skill: changelog-enforcer, When to Use

### Community 765 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
Nodes (8): Branch, Components, Purpose, Quick Start, Session Roles, Skill: cowork-session (Claude Cowork), Testing, When to Use

### Community 766 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 768 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 769 - "Main proxy (`proxy.py`)"
Cohesion: 0.22
...
### Community 770 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 771 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 772 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 773 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 774 - "Release Procedure"
Cohesion: 0.22
...
### Community 775 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 783 - "enrich_quick_note_issues.py"
Cohesion: 0.42
...
### Community 784 - "_start_ceo_agency"
Cohesion: 0.31
...
### Community 785 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 787 - "test_changelog_parity_guard.py"
Cohesion: 0.22
...
### Community 789 - "TestGithubSignalHardening"
Cohesion: 0.22
...
### Community 792 - "test_scanner_deps_parity.py"
Cohesion: 0.31
...
### Community 794 - "navigation_metrics.py"
Cohesion: 0.32
...
### Community 796 - "._run_git_command"
Cohesion: 0.25
...
### Community 799 - "quality_checker.py"
Cohesion: 0.32
...
### Community 811 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 815 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.25
...
### Community 816 - "Issue #362: Nvidia repo setup"
Cohesion: 0.25
...
### Community 817 - "Issue #364: quick-note:https://www.marktechpost.com/2026/06/01/meet-memory-os-a-6-layer-open-source-memory-stack-built-on-top-of-hermes-agent/"
Cohesion: 0.25
...
### Community 818 - "Issue #378: quick-note:https://www.marktechpost.com/2026/06/02/tinyfish-launches-bigset-an-open-source-multi-agent-system-that-builds-structured-live-datasets-from-plain-english-descriptions/"
Cohesion: 0.25
...
### Community 819 - "Issue #379: quick-note:https://searchengineland.com/schema-markup-optimize-agentic-web-479080"
Cohesion: 0.25
...
### Community 820 - "Issue #380: quick-note:https://cursor.com/blog/cloud-agent-lessons"
Cohesion: 0.25
...
### Community 821 - "Issue #381: quick-note:https://www.xda-developers.com/claude-code-with-opus-48-is-expensive-but-i-made-it-efficient-with-my-local-ai-workflow/"
Cohesion: 0.25
...
### Community 822 - "Issue #382: quick-note:https://claude.com/blog/how-coderabbit-used-claude-to-build-an-agent-orchestration-system"
Cohesion: 0.25
...
### Community 823 - "Issue #383: quick-note:https://www.marktechpost.com/2026/05/29/hexo-labs-open-sources-sia-a-self-improving-agent-that-updates-both-the-harness-and-the-model-weights/"
Cohesion: 0.25
...
### Community 824 - "Issue #416: feat: Self-hosted Codebuff (freebuff) on free NVIDIA models + Telegram bot phone control"
Cohesion: 0.25
...
### Community 825 - "Issue #485: [Trend Digest] Week of 2026-06-08"
Cohesion: 0.25
...
### Community 826 - "Issue #488: quick-note:https://github.com/cookiy-ai/user-research-skill"
Cohesion: 0.25
...
### Community 827 - "Issue #491: Implement whatever is necessary from https://github.com/BehiSecc/awesome-claude-skills"
Cohesion: 0.25
...
### Community 828 - "Issue #493: Use the https://github.com/mvanhorn/last30days-skill skill to get the trend updated"
Cohesion: 0.25
...
### Community 829 - "Issue #495: Read https://www.anthropic.com/news/claude-fable-5-mythos-5 and understand if mythos or fable can be added to the repo"
Cohesion: 0.25
...
### Community 831 - "Issue #581: Sprint tracker: pending work after brand rename + mobile-first pass"
Cohesion: 0.25
...
### Community 833 - "Issue #657: quick-note:https://github.com/earendil-works/pi"
Cohesion: 0.25
...
### Community 834 - "Issue #659: quick-note:https://github.com/nex-agi/Nex-N2"
Cohesion: 0.25
...
### Community 835 - "Issue #660: quick-note:https://github.com/getsentry/sentry-for-ai"
Cohesion: 0.25
...
### Community 836 - "Issue #661: quick-note:https://github.com/XiaomiMiMo/MiMo-Code"
Cohesion: 0.25
...
### Community 837 - "Issue #664: quick-note:https://github.com/Grominet95/jarvis-OS"
Cohesion: 0.25
...
### Community 838 - "Issue #666: quick-note:https://github.com/porokka/jarvis-os"
Cohesion: 0.25
...
### Community 839 - "Issue #670: quick-note:https://github.com/perplexityai/bumblebee"
Cohesion: 0.25
...
### Community 840 - "Issue #672: quick-note:https://github.com/Chachamaru127/claude-code-harness"
Cohesion: 0.25
...
### Community 841 - "Issue #676: quick-note:https://github.com/WeiboAI/VibeThinker"
Cohesion: 0.25
...
### Community 842 - "Issue #820: quick-note:https://github.com/cobusgreyling/loop-engineering"
Cohesion: 0.25
...
### Community 843 - "Positional Encoding Internals"
Cohesion: 0.25
...
### Community 845 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 846 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 847 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 848 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 849 - "Continual Harness (`agent/harness_spec.py`)"
Cohesion: 0.25
...
### Community 850 - "Prime Agent Runtime"
Cohesion: 0.25
...
### Community 851 - "PULL_REQUEST_TEMPLATE.md"
Cohesion: 0.25
...
### Community 856 - "crispy_burn_in.py"
Cohesion: 0.36
...
### Community 857 - "run_patched_colibri.py"
Cohesion: 0.36
...
### Community 860 - "test_compose_and_coordinate_api.py"
Cohesion: 0.36
...
### Community 862 - "test_local_brain_router_smoke.py"
Cohesion: 0.25
...
### Community 867 - "start_in_process"
Cohesion: 0.25
...
### Community 869 - "test_serve_spa_prefixes.py"
Cohesion: 0.36
...
### Community 870 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.25
...
### Community 878 - "4. Current Architecture (As-Is)"
Cohesion: 0.29
...
### Community 879 - "AI Engineering Insights Skill"
Cohesion: 0.29
...
### Community 889 - "ADR-006: Strangler Fig migration with backward-compat shims"
Cohesion: 0.29
Nodes (6): ADR-006: Strangler Fig migration with backward-compat shims, Consequences, Context, Decision, Examples, Migration path

### Community 890 - "claude-mem Plugin — Persistent Memory for All Sessions"
Cohesion: 0.29
...
### Community 891 - "Implementation plan + TO-DO (check off as you go)"
Cohesion: 0.29
...
### Community 896 - "Workspace Issues"
Cohesion: 0.29
...
### Community 897 - "Model and Response Issues"
Cohesion: 0.29
...
### Community 904 - "check_changelog_parity.py"
Cohesion: 0.43
...
### Community 905 - "e2e_smoke.py"
Cohesion: 0.57
Nodes (5): _chat(), check(), _health(), _models(), _req()

### Community 906 - "BackgroundServices"
Cohesion: 0.38
...
### Community 910 - "test_daily_2026_06_14.py"
Cohesion: 0.38
...
### Community 911 - "TestSupportMatrixDocsSync"
Cohesion: 0.29
...
### Community 912 - "test_domain_specialists.py"
Cohesion: 0.29
...
### Community 913 - "TestGithubTokenSQLiteRegression"
Cohesion: 0.38
...
### Community 917 - "get_tool_registry"
Cohesion: 0.40
Nodes (4): get_tool_registry(), Return the module-level ToolRegistry singleton. On first call, registers built-…, auto_register(), Register the user research tools into the module-level singleton registry.…

### Community 918 - "._get_last_commit"
Cohesion: 0.33
...
### Community 933 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 934 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 935 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 936 - "The full agent capability roster"
Cohesion: 0.33
...
### Community 937 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 938 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 939 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 954 - "_normalize_dockerfile"
Cohesion: 0.33
...
### Community 974 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 975 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 978 - "Agent API Issues"
Cohesion: 0.40
...
### Community 980 - "knowledgeGraphTab.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 981 - "loginFlowNoTimeout.test.js"
Cohesion: 0.40
Nodes (4): apiSource, { describe, test, expect }, fs, path

### Community 982 - "test_company_stale_id_recovery.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 983 - "worker_no_cache.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, workerSource

### Community 984 - "scripts/agile_ceremonies.py"
Cohesion: 0.70
...
### Community 990 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 991 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 992 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 993 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 994 - "setup_colibri.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 995 - "setup_colibri.sh script"
Cohesion: 0.70
Nodes (4): setup_colibri.sh script, fail(), ok(), warn()

### Community 996 - "status_colibri_server.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 997 - "client"
Cohesion: 0.40
...
### Community 1001 - "test_agent_runtime_wrapper.py"
Cohesion: 0.70
...
### Community 1003 - "worker/index.js"
Cohesion: 0.60
Nodes (4): fetch(), needsProxy(), PROXY_PREFIXES, scheduled()

### Community 1004 - "_clean_phases"
Cohesion: 0.50
...
### Community 1021 - "Claude Code Specific Issues"
Cohesion: 0.50
...
### Community 1040 - "test_skills_route_order.py"
Cohesion: 0.67
...
### Community 1041 - "test_feature_stores_are_wired_on_demand_not_eagerly"
Cohesion: 0.50
...
- **Why does `_fixture()` connect `_fixture` to `ProviderConfig`, `brain_config.py`, `PortfolioManager`, `AgentScheduler`, `AgentRunner`, `ExecutionRequest`, `TaskDispatcher`, `test_autonomy_status.py`, `test_local_brain_state.py`, `TestChatHistoryStore`, `test_llm_router_queue_cache.py`, `test_phase5_doctor.py`, `test_telegram_diag_endpoint.py`, `BackgroundAgent`, `E2BSandboxSession`, `test_model_router.py`, `config.py`, `cost_tracker.py`, `test_llm_router_resilience.py`, `direct_chat.py`, `services/background.py`, `SelfHealingAgent`, `test_telegram_auto_approve.py`, `TaskWorkflowService`, `Task`, `e2e/test_browser.py`, `Surface`, `MCPClient`, `PrimeAgentAdapter`, `ToolAnnotations`, `OperationalIncidentTracker`, `test_unit8_model_catalog.py`, `gateway.py`, `failover_chat_completion`, `SecretRecord`, `TaskStore`, `AgentProfile`, `test_ceo_router.py`, `PolicyEngine`, `test_brain_availability_doctor.py`, `llm/router.py`, `test_ai_insights.py`, `ResearchTask`, `TestHarnessAdapter`, `test_openclaw_gateway.py`, `services/seo_audit.py`, `TestClient`, `test_agent_tool_governance.py`, `test_llm_router_tpm.py`, `ProceduralMemoryStore`, `OrchestratorSupervisor`, `test_colibri_brain_shim.py`, `seo_api.py`, `KeyStore`, `test_new_features_e2e.py`, `test_control_plane_api.py`, `FeatureMaturity`, `test_knowledge_sync.py`, `test_trend_scoping.py`, `api_keys_for`, `_Budget`, `ArtifactStore`, `_enable_filter`, `resolve_e2b_config`, `test_doctor_service_token_check.py`, `test_task_brain_preflight.py`, `test_context_rulebook.py`, `SeoAuditRequest`, `TaskIn`, `test_telegram_task_callback.py`, `ImprovementLoop`, `resolve_active_brain`, `ChatHistoryStore`, `_resolve_brain_provider`, `test_sam_voice.py`, `test_brain_failover.py`, `TrendWatcher`, `AgentSwarm`, `persist_plan_spec`, `test_telegram_approval_gate.py`, `test_agile_api.py`, `test_app_settings.py`, `TestAuthAndTaskCreation`, `test_e2b_task_wiring.py`, `emit_chat_observation`, `OllamaCircuitBreaker`, `test_task_clarification.py`, `test_features_api.py`, `test_video_transcript.py`, `test_portfolio_intake.py`, `test_harness_spec.py`, `TestRuntimeControl`, `test_agent_free_brain.py`, `test_self_heal_v2.py`, `test_e2b_data_flow.py`, `TestAuthAndTaskOwnership`, `TestEstimateTokensForMessages`, `SchedulerStore`, `TestClient`, `ContextPruner`, `session_retro.py`, `test_trend_watcher.py`, `RuntimeHealth`, `capture_screens.py`, `test_persistent_memory.py`, `SecurityScanner`, `test_startup_warmup.py`, `_resolve_push_token`, `test_llm_router_e2e.py`, `TestMongoGate`, `test_rate_limiter.py`, `test_mcp_governance.py`, `test_purge_backlog.py`, `_start_ceo_agency`, `test_telegram_mutating_commands.py`, `audit`, `test_crispy_burn_in.py`, `test_provider_enable_disable.py`, `test_skill_registry_boot_refresh.py`, `isolated_telegram_config`, `test_scheduler_hydration_bounded.py`, `test_telegram_approval_e2e.py`, `test_sam_livekit.py`, `test_service_token.py`, `TestHarnessRegistry`, `ClaudeCodeAdapter`, `test_agency_fix.py`, `test_ping.py`, `test_task_store_fails_loud_in_production.py`, `test_monitor_lib.py`, `test_v4_api.py`, `test_provider_state_durability.py`, `reap_expired_companies`, `_resolve_user_github_token`, `allow_paid`, `traffic_director.py`, `model_discovery.py`, `test_kimi_bridge_server.py`, `test_onboarding_provisioning.py`, `test_voice_pipeline.py`, `test_dashboard_cache.py`, `TestNormalizeResponseFormat`, `parse_event_stream`, `test_brain_patch_service_token.py`, `test_company_api.py`, `client`, `SQLiteStore`, `_clean_phases`, `test_shared_state.py`, `test_openclaw_endpoints.py`, `test_task_service_failed_comment.py`, `test_tasks_reconciler_todo_requeue.py`?**
  _High betweenness centrality (0.088) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `PortfolioManager`, `AgentScheduler`, `StuckDetector`, `proxy.py`, `ExecutionRequest`, `TaskSpec`, `test_brain_failover.py`, `test_ceo_supervision.py`, `TaskDispatcher`, `AgentSessionStore`, `Agency`, `AutonomyTracker`, `WorkflowOrchestrator`, `_StubManager`, `BackgroundAgent`, `E2BSandboxSession`, `Workspace`, `direct_chat.py`, `.execute`, `_NoopStore`, `MCPClient`, `failover_chat_completion`, `LocalWorkspace`, `MultiAgentSwarm`, `test_agent_free_brain.py`, `test_brain_availability_doctor.py`, `test_empirical_verify.py`, `WorkspaceTools`, `ContextPruner`, `test_agent_tool_governance.py`, `GitHubTools`, `AdaptiveHalter`, `TestAgentLoopMCPIntegration`, `api_keys_for`, `TokenBudget`, `TestZeroAttemptDiagnostics`, `ReactScratchpad`, `ContextManager`, `test_governance_api.py`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderConfig` to `backend/server.py`, `PortfolioManager`, `AgentScheduler`, `system_instruction`, `TrafficDirector`, `TestOpenAiToBedrockConverse`, `TestBrainFailoverBackoff`, `TestActiveStrategy`, `TestAnthropicPayloadStructuredOutput`, `direct_chat.py`, `HealthStatus`, `test_bedrock_live.py`, `test_colibri_brain_shim.py`, `test_all_providers_discovery.py`, `test_anthropic_router.py`, `_Budget`, `_is_bedrock_model_id`, `failover_client.py`, `TestRouterIntegration`?**
