# Graph Report - autonomous-ai-agency  (2026-08-30)

## Corpus Check
- 1460 files · ~2,120,445 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 29684 nodes · 55019 edges · 1227 communities (1062 shown, 110 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 2695 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `27bd2bf9`
...
## Communities (1227 total, 110 thin omitted)

### Community 0 - "backend/server.py"
Cohesion: 0.02
Nodes (225): backend/ceo_router.py — observability and manual control for the CEO. Surfaces…, Reject non-admin callers for routes that spend provider budget. Delegates to…, _require_admin(), _is_admin(), Check if a user has admin role. Works for both social_auth users (role in…, admin_seed(), _agent_timeout_fallback_response(), AgentStatusEntry (+217 more)

### Community 1 - "company_api.py"
Cohesion: 0.02
Nodes (155): account_lifecycle(), AccountLifecycleResponse, auto_recommend_skills(), cancel_onboarding(), create_company(), _DoctorCheck, _DoctorReport, generate_onboarding_questions() (+147 more)

### Community 2 - "proxy.py"
Cohesion: 0.03
Nodes (170): get_sam(), middleware, admin_control(), admin_create_key(), admin_create_user(), admin_delete_user(), admin_list_users(), admin_login() (+162 more)

### Community 3 - "_fixture"
Cohesion: 0.02
Nodes (108): base_url(), mobile_page(), proxy_url(), Config, pytest_configure(), conftest.py — pytest fixtures and configuration for the E2E test suite.…, A browser page pre-configured for mobile viewport (390×844 — iPhone 14)., _clean_env() (+100 more)

### Community 4 - "test_llm_router_queue_cache.py"
Cohesion: 0.02
Nodes (109): CacheManager, cosine_similarity(), _Entry, LRUCache, payload_key(), Any, T, Live (unexpired) entries — used by the semantic layer's scan. (+101 more)

### Community 5 - "TaskStore"
Cohesion: 0.03
Nodes (119): packages/ai/self_heal.py — automatic brain self-healing. When the active brain…, Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., tasks — Task/issue management system. Provides a lightweight task/issue tracker…, Enum, str, tasks/models.py — Pydantic models for the task/issue system., Comment or reply on a task. (+111 more)

### Community 6 - "llm/router.py"
Cohesion: 0.02
Nodes (111): AlertHandler, _load(), main(), ModuleType, _write_summary(), _load(), main(), int (+103 more)
...
Cohesion: 0.03
Nodes (106): AgentPhaseError, AgentRunner, _check_extra_kwargs(), _enforce_signature(), Any, Exception, Path, Raise TypeError if fn's signature drifts from the locked contract (Pydantic… (+98 more)

### Community 9 - "brain_config.py"
Cohesion: 0.03
Nodes (122): _active_primary_provider(), BrainConfig, BrainConfigPatch, BrainConfigStore, default_brain_config(), get_brain_config(), get_brain_config_store(), invalidate_brain_config_cache() (+114 more)

### Community 10 - "WebsiteScanner"
Cohesion: 0.03
Nodes (105): Scan a repository for technology stack and systems., scan_repo_endpoint(), DetectedSystem, Evidence, Result of a website scan with detected systems and stack inference., Evidence supporting a system detection., Result of a repository scan with detected stack and systems., A business system detected on a company's website or in their stack. (+97 more)

### Community 11 - "test_llm_router_resilience.py"
Cohesion: 0.03
Nodes (100): Backoff policy for retryable failures., RetryConfig, is_unfixable(), Whether this failure needs a human rather than a retry. Two shapes qualify. A…, BreakerState, Enum, str, packages/llm/health.py — provider health tracking and circuit breaking. Two… (+92 more)

### Community 12 - "test_operational_incidents.py"
Cohesion: 0.02
Nodes (118): _note_phase_end(), _note_phase_start(), Open a tracked phase, returning the token that closes it. Never raises., Close the tracked phase *token* opened above. Never raises., _format_incident(), _iso_from_monotonic(), normalise(), note_phase_end() (+110 more)
...
### Community 15 - "RenderOpsMonitor"
Cohesion: 0.03
Nodes (71): build_render_router(), Any, APIRouter, BaseModel, Exception, backend/render_router.py — Render platform view for operators and agents.…, Reject anyone who is not the agency admin., Map an MCP transport failure onto 503 rather than a 500. The distinction… (+63 more)

### Community 16 - "SelfHealingAgent"
Cohesion: 0.03
...
Cohesion: 0.03
Nodes (82): events_from_identity(), Convenience: build and record an event in one call., Extract the identity-derived audit fields from an AgentIdentity. Kept here…, record_event(), build_docker_run_argv(), detect_backend(), DockerBackend, E2BBackend (+74 more)
...
Cohesion: 0.04
Nodes (97): ProviderConfig, One configured endpoint. ``kind`` selects the adapter: ``openai`` (any OpenAI-…, LLMRequest, Cheap character-based token estimate (~4 chars/token). Deliberately dependency-…, A provider-neutral chat request. ``model`` is a *hint*: the router may…, _breakpoint_at(), _make_provider(), _make_request() (+89 more)
...
### Community 21 - "Task"
Cohesion: 0.04
Nodes (78): Hand the 'connect & verify the repo' work to the agency's own agents. The task…, _seed_connect_task(), ApprovalCheckpoint, Full task/issue document., Human approval gate in a task's execution., Task, TaskStatus, Owns lifecycle transitions, comment semantics, and approval rules. (+70 more)
...
### Community 24 - "ProviderRouter"
Cohesion: 0.04
Nodes (66): build_tool_calling_router(), Return a router limited to providers that pass ``tools`` through intact. The…, CommercialFallbackRequiredError, _get_director(), is_commercial_provider(), _normalized_provider_type(), provider_access_tier(), _provider_field() (+58 more)
...
Cohesion: 0.04
Nodes (74): MCPUnavailableError, Raised when the MCP server is unreachable or the circuit is open., E2BSandboxSession, _inject_token(), maybe_attach_e2b(), Any, services/e2b_sandbox.py — E2B Firecracker micro-VM sandbox session. Implements…, Create the sandbox. Raises :class:`MCPUnavailableError` on failure. (+66 more)

### Community 27 - "Usage"
Cohesion: 0.04
Nodes (60): packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, classify_error(), LLMProvider, OpenAICompatible, ABC, Any, AsyncClient, ProviderConfig (+52 more)

### Community 28 - "PolicyEngine"
Cohesion: 0.04
Nodes (83): Charge sub-agent nesting depth and enforce the ``max_depth`` ceiling. Isolates…, _egress_policy_reason(), agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Return why governance policy blocks *host*, or None. Runs strictly *after* the…, _load(), Import the governance layer once, recording why if it is absent., governance_enabled(), True when the governance layer should run at all. A single global off switch… (+75 more)
...
### Community 30 - "test_runtimes.py"
Cohesion: 0.04
Nodes (44): Raised when a runtime fails readiness validation before execution starts., RuntimePreflightError, Start a runtime as a local subprocess wrapper., _start_local_runtime(), CircuitState, runtimes/health.py — RuntimeHealthService. Periodically polls all registered…, Return the last-known health for *runtime_id* (may be stale)., Return True if the runtime is available (not circuit-open). (+36 more)

### Community 31 - "MongoDBStore"
Cohesion: 0.04
...
Cohesion: 0.03
Nodes (83): _brain_provider_status(), get_catalog_models_route(), Return the mirrored model catalog (advisory-only). Flag-gated by…, Return per-provider metadata for the GET endpoint. Iterates every provider in…, Return the discovered model list for *provider_id*, or ``[]`` if unknown., _served_models(), all_provider_ids(), _provider_ids_from_literal() (+75 more)
...
### Community 34 - "test_governance_enforcement.py"
Cohesion: 0.04
...
Cohesion: 0.03
Nodes (51): Delete a company and all associated data from SQLite., Count total companies in SQLite., Reconstruct a Website from a SQLite row, preferring the full JSON blob (which…, Create a new website in SQLite. The full model is stored in ``data`` so scan…, Get a website by ID from SQLite., Update a website in SQLite. When ``company_id`` is omitted the existing company…, Delete a website from SQLite., List websites from SQLite. (+43 more)

### Community 38 - "services/seo_audit.py"
Cohesion: 0.04
Nodes (53): Run a full SEO/GEO/AIO audit against a website and persist the evidence., run_seo_audit(), field_validator, A single occurrence of a check firing on a specific URL., Aggregated report row - Screaming Frog CSV compatible., Site-level facts discovered during the crawl., Request to run an SEO/GEO/AIO audit against a website., SeoAuditRequest (+45 more)

### Community 39 - "test_failover_client_shared.py"
Cohesion: 0.06
Nodes (88): failover_chat_completion(), FailoverResult, _log_recovery(), A successful completion plus the accounting its callers need., Report a successful failover at INFO — recovery is not an incident. Everything…, Run one chat completion across the brain-failover chain. Tries each healthy…, _free_tier(), _hit_ids() (+80 more)
...
### Community 41 - "test_phase6_workflow.py"
Cohesion: 0.05
...
### Community 42 - "setup/api.py"
Cohesion: 0.05
Nodes (74): is_user_onboarding_allowed(), Return True if this user may run the onboarding wizard. Resolution order: 1. If…, audit(), Append an audit log entry. Never logs raw secrets — only secret IDs / masked…, complete_wizard(), _delete_wizard_state(), detect_configured_providers(), detect_hardware_for_wizard() (+66 more)

### Community 43 - "MCPClient"
Cohesion: 0.04
...
### Community 45 - "get"
Cohesion: 0.03
Nodes (78): auth_me(), auto_recommend_skills(), brain_failover_status(), _check_storage_health(), cost_attribution_stats(), discover_remote_skills(), doctor_health(), get_brain_policy_route() (+70 more)

### Community 46 - "get_task_store"
Cohesion: 0.04
Nodes (76): autonomy_tick(), quick_notes_submit(), _QuickNoteBody, The task store the background services should use, wiring it if needed.…, Execute ONE pending task synchronously. Called by the cron workflow every 2…, Submit a quick-note URL or instruction from the dashboard FAB., _task_store_for_background(), Path (+68 more)

### Community 47 - "ExecutionRequest"
Cohesion: 0.04
Nodes (44): ExecutionRequest, Exception, Approve a run paused at the ApprovalGate. The caller must re-invoke…, Inject additional instructions into an in-flight run (no state change). Backs…, Determine domain and task type from the request text., Generate a structured execution plan. Uses the LLM if available; falls back to…, Select the best specialist(s) for the classified domain., Run doctor checks before execution. (+36 more)

### Community 48 - "seo_api.py"
Cohesion: 0.05
...
### Community 51 - "get_company_graph_store"
Cohesion: 0.04
Nodes (66): delete_company_endpoint(), delete, Delete a company and all associated data. Access control is handled by…, Synchronize the Company Graph. Re-scans all websites and repositories, updates…, sync_company_graph(), autonomy_status(), Public autonomy readiness probe — no authentication required. A live deploy…, Fire-and-forget self-bootstrap; never blocks or crashes startup. (+58 more)

### Community 52 - "CompanyGraphService"
Cohesion: 0.03
Nodes (44): BusinessCategory, Find a website by its URL., A company website with detected systems and stack inference., Website, CompanyGraphService, Company, SpecialistFamily, SystemType (+36 more)

### Community 53 - "test_ceo_supervision.py"
Cohesion: 0.06
Nodes (70): _harvest_changed_files(), Extract the files a runtime touched. Returns ``(files, reported)``. Adapters…, Attempt, services/ceo_ledger.py — durable record of what the CEO is driving to closure.…, One delegation of one subtask to one tier., A subtask's full history: what it is, and every attempt at it., SubtaskRecord, _goal() (+62 more)
...
### Community 55 - "CompanyGraphStore"
Cohesion: 0.03
...
### Community 56 - "test_brain_config_api.py"
Cohesion: 0.04
...
### Community 63 - "test_user_research_skill.py"
Cohesion: 0.05
...
Cohesion: 0.05
Nodes (34): _child_env(), _kill_and_reap(), PrimeAgentAdapter, TaskResult, TaskSpec, Terminate a subprocess and wait for it, ignoring races. ``asyncio.wait_for``…, Build the allowlisted environment for the CLI subprocess., Adapter for the Prime Agent / pi coding CLI. (+26 more)
...
### Community 67 - "ToolRegistry"
Cohesion: 0.05
Nodes (40): get_tool_registry(), _infer_parameters_from_func(), Any, Register a tool definition., Decorator to register a function as an agent tool. Usage::…, Remove a tool from the registry. Returns True if removed., Look up a tool by name., Return all registered tools. (+32 more)
...
### Community 69 - "resolve_active_brain"
Cohesion: 0.05
Nodes (61): allow_paid_brain(), BrainResolution, get_active_brain_sync(), get_provider_role_tags(), _host_is_openai_compatible(), _norm(), _pick_from_records(), Any (+53 more)

### Community 70 - "test_brain_availability_doctor.py"
Cohesion: 0.05
Nodes (52): brain_availability_summary(), Non-secret answer to "can the brain answer a request right now?". Three callers…, _backend(), CEOLedger, GoalRecord, _now(), Any, One piece of work the CEO has taken ownership of. ``state`` is the supervisor's… (+44 more)
...
### Community 75 - "test_webui_provider_priority.py"
Cohesion: 0.08
...
### Community 76 - "AgentPlan"
Cohesion: 0.05
Nodes (56): PreflightIssue, PreflightReport, BaseModel, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, Agent subsystem — planner / executor / verifier loop., AgentEvent, AgentPlan, AgentRunRequest (+48 more)
...
### Community 78 - "CEODispatcher"
Cohesion: 0.05
Nodes (53): CEODispatcher, CEOResult, _complexity_rank(), _merge_changed_files(), _offload(), Any, services/ceo_dispatcher.py — Real CEO delegation layer. The CEO splits a…, Run a synchronous ledger call without blocking the event loop. ``CEOLedger`` is… (+45 more)

### Community 79 - "LLMRouter"
Cohesion: 0.05
Nodes (37): Attempt, describe(), The operator-facing reason string for an unfixable status., Read the environment variables named in ``env_names`` into a key list. Order is…, resolve_keys(), LLMRouter, Any, AsyncClient (+29 more)

### Community 80 - "test_model_catalog.py"
Cohesion: 0.05
...
### Community 81 - "TaskExecutionCoordinator"
Cohesion: 0.05
Nodes (44): _brain_is_configured(), _gate_outward_facing_enabled(), _is_brain_connection_error(), _is_outward_facing(), Any, BaseException, Task, TaskResult (+36 more)

### Community 82 - "RenderMCPClient"
Cohesion: 0.05
Nodes (38): agent/mcp_client.py — Async MCP client for the mcp-server Docker container.…, _as_list(), _coerce_payload(), get_render_mcp(), Any, RuntimeError, packages/integrations/render_mcp.py — Render platform access over MCP. The…, Return tool output as Python data. MCP tool results arrive either as… (+30 more)
...
### Community 86 - "test_runtime_governance.py"
Cohesion: 0.07
Nodes (54): _audit_dispatch(), _blocked_result(), _governance_check(), Any, TaskResult, TaskSpec, Build the failed TaskResult returned when policy denies a dispatch. A result…, Evaluate a runtime dispatch against policy; audit it either way. Returns… (+46 more)
...
### Community 89 - "test_ai_insights.py"
Cohesion: 0.05
...
### Community 95 - "direct_chat.py"
Cohesion: 0.06
Nodes (58): Any, Translate technical preflight issues into a conversational assistant reply., translate_error_to_conversational(), AcceptedJob, AgentJobEnvelope, CompletedJob, DirectChatState, FailedJob (+50 more)

### Community 96 - "portfolio_intelligence.py"
Cohesion: 0.05
Nodes (53): _bullets(), generate_backlog_retro(), generate_standup(), Agentic Agile — autonomous ceremonies (standup, retro, sprint planning). Where…, Render a :class:`Retrospective` as a markdown section., Derive a retrospective from the task tracker when no sprint is active. DONE /…, Render the sprint plan as markdown., Render a list of strings as markdown bullets (or a placeholder). (+45 more)
...
### Community 98 - "workflow_orchestrator.py"
Cohesion: 0.07
Nodes (51): BoundContext, ClassifyOutput, ExecutionResult, JudgeVerdict, MonitorOutput, _orchestrator_bypass(), PersistOutput, Phase (+43 more)

### Community 99 - "AgentJobRequest"
Cohesion: 0.05
...
### Community 102 - "failover_client.py"
Cohesion: 0.05
...
### Community 105 - "FinancialMetrics"
Cohesion: 0.06
...
### Community 107 - "system_instruction"
Cohesion: 0.06
...
### Community 108 - "OllamaCircuitBreaker"
Cohesion: 0.06
...
### Community 111 - "Platform Guide — the full tour"
Cohesion: 0.03
...
### Community 118 - "test_startup_warmup.py"
Cohesion: 0.05
Nodes (52): _bootstrap_within_budget(), _create_bootstrap_indexes(), ensure_bootstrap(), Await one warm-up step, deferring it to the background if it overruns.…, Create every boot index concurrently rather than one round-trip at a time.…, Idempotent bootstrap for indexes + seeded admin/providers. FastAPI startup…, Auto-detect the best available Ollama model and update ollama-local in the DB.…, Run bootstrap without letting it hold a request open indefinitely. Returns… (+44 more)
...
### Community 120 - "test_e2b_adapter.py"
Cohesion: 0.05
...
### Community 121 - "InternalAgentAdapter"
Cohesion: 0.05
...
### Community 125 - "enforcement.py"
Cohesion: 0.06
Nodes (43): Governance seam: judge the call, run it, audit the outcome. Deliberately a thin…, Feed LLM token/cost spend into the governance session budget. Kept separate…, BudgetExceeded, classify(), evaluate_call(), get_gate(), guard_tool_call(), GuardResult (+35 more)
...
### Community 127 - "AgentSessionStore"
Cohesion: 0.07
...
### Community 130 - "PortfolioManager"
Cohesion: 0.05
...
### Community 136 - "test_provider_state_durability.py"
Cohesion: 0.04
...
### Community 141 - "RepowiseIntelligence"
Cohesion: 0.06
...
### Community 142 - "test_provider_router.py"
Cohesion: 0.06
...
### Community 145 - "test_kimi_bridge_server.py"
Cohesion: 0.05
...
### Community 148 - "test_web_reach.py"
Cohesion: 0.09
...
### Community 152 - "brain_failover.py"
Cohesion: 0.06
Nodes (49): brain_providers(), Every configured provider with its health AND its on/off state. Powers the…, auto_disable(), _billing_signals(), disabled_provider_ids(), packages/llm/disabled.py — bridge to the durable provider on/off switch. The…, Provider ids currently switched off. Empty when the store is unreachable., Persist a provider as disabled, through the store that already owns it. (+41 more)

### Community 153 - "get_user_role"
Cohesion: 0.07
Nodes (21): _get_github_token_for_user(), Fetch GitHub token for user from secrets store or environment., get_audit_log(), get_user_role(), has_permission(), is_admin(), is_power_user_or_above(), mask_dict() (+13 more)
...
### Community 155 - "test_issue_intake.py"
Cohesion: 0.08
...
### Community 157 - "test_bedrock_provider.py"
Cohesion: 0.06
...
### Community 161 - "get_workflow_orchestrator"
Cohesion: 0.06
Nodes (46): _build_payload_or_500(), _check_secret(), _expected_secret(), preview_digest_endpoint(), Any, get, post, Dry-run: same auth, returns the would-be markdown body but does NOT dispatch to… (+38 more)

### Community 162 - "TestEstimateTokensForMessages"
Cohesion: 0.05
...
### Community 165 - "activation_api.py"
Cohesion: 0.09
...
### Community 170 - "reset_orchestrator"
Cohesion: 0.07
Nodes (24): Reset the singleton (test helper)., reset_orchestrator(), skipif, End-to-end execution through the golden path., With auto_approve=True, execution runs through all phases., CLASSIFY correctly detects security domain., A run blocks at ApprovalGate, is approved, then finishes., BIND_CONTEXT resolves skills from SkillBindings. (+16 more)
...
### Community 174 - "test_backend_server_features.py"
Cohesion: 0.05
...
### Community 175 - "ProvidersScreen.jsx"
Cohesion: 0.05
...
### Community 178 - "StreamingDeltaReconstructor"
Cohesion: 0.07
...
### Community 180 - "test_e2b_task_wiring.py"
Cohesion: 0.08
...
### Community 183 - "AnthropicProvider"
Cohesion: 0.09
...
### Community 189 - "test_ceo_router.py"
Cohesion: 0.08
...
### Community 191 - "_get_provider_policy"
Cohesion: 0.07
...
### Community 195 - "TestBrainFailoverModelUpdates"
Cohesion: 0.08
...
### Community 210 - "report_to_markdown"
Cohesion: 0.08
...
### Community 219 - "test_trend_watcher.py"
Cohesion: 0.08
...
### Community 220 - "lifespan"
Cohesion: 0.06
Nodes (28): _keepalive_self_ping(), lifespan(), Run the FreeBuff Telegram bot, restarting it on unexpected exit., Ping our own public URL so a free-tier web service doesn't sleep. Render free…, Start the Telegram bot (and keep-alive) inside the web process when enabled.…, _start_in_web_bot_tasks(), _telegram_bot_supervisor(), _get_hashed_token() (+20 more)

### Community 221 - "test_unit6_resolve_component_model.py"
Cohesion: 0.05
...
### Community 224 - "test_portfolio_intake.py"
Cohesion: 0.09
...
### Community 233 - "test_portfolio_intelligence.py"
Cohesion: 0.06
...
### Community 235 - "get_feature_matrix"
Cohesion: 0.08
...
### Community 238 - "test_brain_failover.py"
Cohesion: 0.10
...
Cohesion: 0.09
Nodes (31): DirectChatDoctor, _DoctorCheck, _DoctorReport, get_doctor_diagnostics(), get_doctor_report(), get_public_doctor(), Public Doctor endpoint — no authentication required. Returns system-level…, Authenticated Doctor endpoint — full diagnostics. Returns all system-level… (+23 more)

### Community 242 - "sync/service.py"
Cohesion: 0.11
...
### Community 243 - "test_control_plane_api.py"
Cohesion: 0.06
...
### Community 245 - "_build_default_manager"
Cohesion: 0.08
...
### Community 246 - "OrchestratorQueue"
Cohesion: 0.07
...
### Community 247 - "WorkflowBuildRequest"
Cohesion: 0.08
...
### Community 250 - "get_tool_annotations"
Cohesion: 0.08
...
### Community 254 - "FeatureMaturity"
Cohesion: 0.07
Nodes (17): __init__.py — Feature flag/matrix package., FeatureMaturity, FeatureUnavailableError, Enum, Exception, str, features/matrix.py — Feature maturity tiers and support matrix. Single source…, Feature maturity classification. (+9 more)

### Community 255 - "Provider"
Cohesion: 0.09
...
### Community 256 - "test_daily_2026_06_04.py"
Cohesion: 0.09
...
### Community 257 - "REWRITE_PLAN.md — Phased Migration Strategy"
Cohesion: 0.06
...
### Community 259 - "test_all_providers_discovery.py"
Cohesion: 0.16
...
### Community 264 - "configuration-reference.md"
Cohesion: 0.08
...
### Community 265 - "[Unreleased]"
Cohesion: 0.06
Nodes (35): Added, Added, Added, Added, Added, Added, Added, Added (+27 more)

### Community 266 - "test_colibri_brain_shim.py"
Cohesion: 0.08
...
### Community 268 - "webui/router.py"
Cohesion: 0.09
Nodes (33): get_router(), Return the shared ``ModelRouter`` singleton., test_get_router_returns_same_instance(), Any, Path, run_command(), _safe_allowlist(), validate_command() (+25 more)

### Community 269 - "CEOSupervisor"
Cohesion: 0.09
...
### Community 270 - "test_anthropic_router.py"
Cohesion: 0.09
...
### Community 271 - "test_llm_router_e2e.py"
Cohesion: 0.14
...
### Community 274 - "agent_runtime.py"
Cohesion: 0.10
...
### Community 277 - "probe_catalogues.py"
Cohesion: 0.10
...
Cohesion: 0.08
Nodes (26): all_controls(), controls_by_group(), is_controllable(), Every control in the catalogue, in display order., True when *key* may be overridden from the dashboard. The allow-list is what…, The catalogue grouped for the dashboard, groups in display order., clean_overrides(), _python_sources() (+18 more)
...
### Community 280 - "skill_bindings.py"
Cohesion: 0.09
...
### Community 287 - "LlmProviderConfig"
Cohesion: 0.15
...
### Community 288 - "test_sam_voice.py"
Cohesion: 0.07
...
### Community 289 - "test_loop_registry.py"
Cohesion: 0.12
...
### Community 297 - "test_nvidia_model_discovery.py"
Cohesion: 0.06
...
### Community 303 - "High-Agency Frontend Skill"
Cohesion: 0.06
...
### Community 306 - "BrainFailoverExhausted"
Cohesion: 0.10
...
### Community 308 - "test_mcp_governance.py"
Cohesion: 0.11
...
### Community 309 - "test_purge_backlog.py"
Cohesion: 0.09
...
### Community 310 - "test_autonomy_gate.py"
Cohesion: 0.12
...
### Community 313 - "openclaw_gateway.py"
Cohesion: 0.09
...
### Community 315 - "output_filter.py"
Cohesion: 0.07
...
### Community 316 - "test_colibri_provider.py"
Cohesion: 0.12
...
### Community 320 - "test_force_cleanup_conditional_delete.py"
Cohesion: 0.10
...
### Community 322 - "ProjectScaffolder"
Cohesion: 0.13
...
### Community 323 - "model_discovery.py"
Cohesion: 0.10
...
### Community 325 - "SteeringInjector"
Cohesion: 0.11
...
### Community 326 - "test_claude_setup_audit.py"
Cohesion: 0.16
...
### Community 327 - "test_scheduler_hydration_bounded.py"
Cohesion: 0.09
...
### Community 332 - "get_scheduler"
Cohesion: 0.12
Nodes (26): legacy_scheduler_create(), legacy_scheduler_get(), LegacyScheduleJobRequest, get_scheduler(), create_schedule(), delete_schedule(), get_schedule(), get_schedule_runs() (+18 more)
...
### Community 338 - "control_overrides.py"
Cohesion: 0.10
Nodes (27): apply_from_db(), _as_int(), _control_state(), effective_value(), load_overrides(), _policy_updates(), Any, packages/config/control_overrides.py — DB-persisted overrides for platform… (+19 more)

### Community 339 - "RuntimeManager"
Cohesion: 0.08
...
### Community 350 - "Deploy: FreeBuff Telegram bot (24×7)"
Cohesion: 0.07
...
### Community 351 - "Claude Code + Qwen Local Setup"
Cohesion: 0.07
...
### Community 352 - "parse_event_stream"
Cohesion: 0.10
...
### Community 353 - "test_phase4_runtime_resilience.py"
Cohesion: 0.11
...
### Community 355 - "OrchestratorSupervisor"
Cohesion: 0.12
Nodes (11): get_orchestrator_supervisor(), OrchestratorSupervisor, Any, Emit an alert to the activity feed and log., Deterministic supervisor for the orchestrator. Runs as a background coroutine.…, stop_orchestrator_supervisor(), tests/test_orchestrator_supervisor.py — Tests for deterministic supervisor…, Supervisor startup, stall detection, and alert emission. (+3 more)

### Community 356 - "SkillBindings"
Cohesion: 0.10
...
### Community 357 - "isolated_telegram_config"
Cohesion: 0.11
...
### Community 364 - "test_brain_priority_scanner.py"
Cohesion: 0.10
...
### Community 365 - "LLM Router — troubleshooting"
Cohesion: 0.08
...
### Community 367 - "test_rate_limiter.py"
Cohesion: 0.11
...
### Community 368 - "test_phase5_doctor.py"
Cohesion: 0.08
...
### Community 371 - "test_telegram_approval_e2e.py"
Cohesion: 0.12
...
### Community 382 - "autonomous_fix.py"
Cohesion: 0.14
...
### Community 396 - "analyze_quantitative"
Cohesion: 0.13
...
### Community 398 - "SeoCheckDefinition"
Cohesion: 0.11
...
### Community 406 - "test_memory_guard.py"
Cohesion: 0.13
...
### Community 407 - "_process_task_callback"
Cohesion: 0.16
...
### Community 409 - "test_agency_fix.py"
Cohesion: 0.08
...
### Community 413 - "test_dashboard_cache.py"
Cohesion: 0.13
...
### Community 414 - "Agent Governance Guide"
Cohesion: 0.09
...
### Community 415 - "The fifteen strategies"
Cohesion: 0.09
...
### Community 421 - "WindowsServiceManager"
Cohesion: 0.18
...
### Community 423 - "test_all_features.py"
Cohesion: 0.09
...
### Community 434 - "AdaptivePermissions"
Cohesion: 0.18
...
### Community 441 - "reap_expired_companies"
Cohesion: 0.15
...
### Community 442 - "OrchestratorCheckpointStore"
Cohesion: 0.14
...
### Community 445 - "platform_controls_router.py"
Cohesion: 0.11
Nodes (20): _actor(), build_platform_controls_router(), ControlUpdateBody, APIRouter, BaseModel, backend/platform_controls_router.py — admin API for the platform controls.…, A stable identifier for the audit trail on each write., One or more control changes, as ``{"updates": {"KEY": value}}``. (+12 more)

### Community 446 - "_ensure_tasks_source_id_unique_index"
Cohesion: 0.14
...
### Community 447 - "V3 API Migration Plan — LLM Relay Platform"
Cohesion: 0.10
...
### Community 454 - "weekly_digest.py"
Cohesion: 0.13
...
### Community 455 - "test_local_controller.py"
Cohesion: 0.17
...
### Community 463 - "test_minimax_bug_fixes.py"
Cohesion: 0.12
...
### Community 467 - "Docker AI Governance Audit — Final Report"
Cohesion: 0.10
...
### Community 468 - "1. Capability-by-capability"
Cohesion: 0.10
...
### Community 470 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 482 - "test_tasks_cache_ttl_env.py"
Cohesion: 0.21
...
### Community 483 - "test_voice_pipeline.py"
Cohesion: 0.14
...
### Community 486 - "_extract_tech_relevance"
Cohesion: 0.17
...
### Community 489 - "Skill: fabric-patterns"
Cohesion: 0.11
...
### Community 490 - "Analysis & Synthesis Instructions"
Cohesion: 0.11
Nodes (18): 1. Define the Atmosphere, 2. Map the Color Palette, 3. Establish Typography Rules, 4. Define the Hero Section, 5. Describe Component Stylings, 6. Define Layout Principles, 7. Define Responsive Rules, 8. Encode Motion Philosophy (+10 more)

### Community 491 - "Production Readiness Assessment — local-llm-server"
Cohesion: 0.11
...
### Community 492 - "TestNormalizeResponseFormat"
Cohesion: 0.11
...
### Community 495 - "Admin Dashboard Guide"
Cohesion: 0.11
...
### Community 496 - "Implementation Plan"
Cohesion: 0.11
...
### Community 498 - "ControlsScreen.jsx"
Cohesion: 0.16
...
### Community 499 - "Delegation Plan (agent-ready work packages)"
Cohesion: 0.11
...
### Community 500 - "test_p0_roadmap_a4_a5_b2.py"
Cohesion: 0.15
...
### Community 505 - "test_brain_patch_service_token.py"
Cohesion: 0.18
...
### Community 506 - "TestSelfHealingInfrastructureClassification"
Cohesion: 0.19
...
### Community 507 - "test_fabric_patterns.py"
Cohesion: 0.11
...
### Community 508 - "test_one_model_catalogue.py"
Cohesion: 0.14
...
### Community 509 - "test_repowise_intelligence.py"
Cohesion: 0.11
...
### Community 510 - "test_schedule_persistence.py"
Cohesion: 0.15
...
### Community 511 - "validate_session_id"
Cohesion: 0.16
...
### Community 514 - "agile_sprints.py"
Cohesion: 0.14
...
### Community 516 - "Comprehensive Skill Index (By Category)"
Cohesion: 0.11
...
### Community 517 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 518 - "Component Map"
Cohesion: 0.11
...
### Community 519 - "Architecture Overview — local-llm-server"
Cohesion: 0.11
...
### Community 520 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
...
### Community 522 - "Part A — Health Report"
Cohesion: 0.11
...
### Community 529 - "test_agent_tools.py"
Cohesion: 0.19
...
### Community 530 - "TestAddConversationCacheBreakpoints"
Cohesion: 0.18
Nodes (6): Fewer than stable_back+1 messages → no breakpoint added., Exactly stable_back+1 messages → breakpoint IS added., stable_back=3 means messages[-3] gets the breakpoint., Tool-result content arrays (role=user) get cache_control on last block., Unit tests for ``_add_conversation_cache_breakpoints`` in isolation., TestAddConversationCacheBreakpoints

### Community 531 - "test_company_api.py"
Cohesion: 0.11
...
### Community 532 - "TestStopSlopChecker"
Cohesion: 0.11
...
### Community 533 - "asyncio"
Cohesion: 0.25
Nodes (5): _client(), asyncio, Regression: the admin routes and the ops loop share this singleton. Without the…, A handshake that raised must be retried, not remembered as done., TestRenderMCPClient

### Community 534 - "test_telegram_service_webhook.py"
Cohesion: 0.18
...
### Community 539 - "cowork_session.py"
Cohesion: 0.15
...
### Community 540 - "SKILL: Industrial Brutalism & Tactical Telemetry UI"
Cohesion: 0.12
...
### Community 541 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 542 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 543 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 545 - "Section-by-Section Acceptance Criteria"
Cohesion: 0.12
...
### Community 547 - "SkillsScreen.jsx"
Cohesion: 0.12
...
### Community 548 - "redact_connection_url"
Cohesion: 0.17
...
### Community 549 - "kimi_bridge_provider_config"
Cohesion: 0.18
...
### Community 550 - "agent_readiness_audit.py"
Cohesion: 0.21
...
### Community 553 - "test_freebuff_bot.py"
Cohesion: 0.12
...
### Community 554 - "test_activation_api.py"
Cohesion: 0.21
...
### Community 555 - "TestAListingFailureDoesNotVetoTheAnswer"
Cohesion: 0.17
...
### Community 556 - "test_daily_automation_2026_07_11.py"
Cohesion: 0.15
...
### Community 557 - "test_frontend_deployment_guards.py"
Cohesion: 0.18
...
### Community 558 - "test_health_endpoints.py"
Cohesion: 0.17
...
### Community 559 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 560 - "test_openclaw_endpoints.py"
Cohesion: 0.12
...
### Community 562 - "test_skill_registry.py"
Cohesion: 0.13
...
### Community 563 - "hermes_prompt.py"
Cohesion: 0.19
...
### Community 565 - "MemoryMiddleware"
Cohesion: 0.17
...
### Community 568 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
...
### Community 569 - "_valid_login_state"
Cohesion: 0.24
...
### Community 570 - "Skill: repowise-intelligence"
Cohesion: 0.12
Nodes (15): 1. Graph Intelligence (Dependency Graph), 2. Git Intelligence, 3. Documentation Intelligence, 4. Decision Intelligence, Acceptance Checks, Directory Structure, Example Usage, Implementation Approach (+7 more)

### Community 571 - "The 10-Step Workflow"
Cohesion: 0.12
...
### Community 572 - "Contributing to local-llm-server"
Cohesion: 0.12
...
### Community 573 - "refresh_agent_built_proof.py"
Cohesion: 0.20
...
### Community 574 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 575 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 582 - "_enforce_rate_limit"
Cohesion: 0.13
...
### Community 587 - "ManagedAgentDreams"
Cohesion: 0.22
...
### Community 590 - "test_brain_failover_413.py"
Cohesion: 0.13
...
### Community 592 - "DailyDigestAggregatorTests"
Cohesion: 0.19
...
### Community 593 - "test_dockerfile_ships_root_modules.py"
Cohesion: 0.17
...
### Community 594 - "test_langfuse_agency_wide.py"
Cohesion: 0.12
...
### Community 595 - "test_llm_router_tpm.py"
Cohesion: 0.20
...
### Community 596 - "test_local_brain_state.py"
Cohesion: 0.12
...
### Community 598 - "test_nvidia_default_model.py"
Cohesion: 0.17
...
### Community 599 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 600 - "test_refresh_agent_built_proof.py"
Cohesion: 0.12
...
### Community 601 - "test_self_heal.py"
Cohesion: 0.12
...
### Community 602 - "test_telegram_diag_endpoint.py"
Cohesion: 0.12
...
### Community 615 - "Skill: user-research"
Cohesion: 0.13
...
### Community 616 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 617 - "Attention Mechanisms Internals"
Cohesion: 0.13
...
### Community 620 - "DockerAgentAdapter"
Cohesion: 0.17
...
### Community 621 - "TestDecisionsBotLinks"
Cohesion: 0.17
...
### Community 622 - "DecisionsStore"
Cohesion: 0.30
Nodes (3): DecisionsStore, Any, Connection

### Community 623 - "test_telegram_auto_approve.py"
Cohesion: 0.23
...
### Community 624 - "clear_wizard_state_cache"
Cohesion: 0.21
...
### Community 625 - "e2e/test_browser.py"
Cohesion: 0.23
...
### Community 627 - "test_daily_automation_2026_07_09.py"
Cohesion: 0.16
...
### Community 628 - "test_dockerfile_ships_config_dir.py"
Cohesion: 0.14
...
### Community 630 - "test_scanner_live.py"
Cohesion: 0.23
...
### Community 635 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 639 - "Checks Performed"
Cohesion: 0.14
...
### Community 640 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 641 - "Skill: branch-cleanup"
Cohesion: 0.14
...
### Community 642 - "Skill: perplexity — Web Research via Perplexity API"
Cohesion: 0.14
...
### Community 645 - "Nothing is blocked on an agent. Two things need a human."
Cohesion: 0.14
...
### Community 646 - "Quick-Note Issues Processing Summary"
Cohesion: 0.14
...
### Community 647 - "DirectChatSession"
Cohesion: 0.15
...
### Community 648 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 650 - "Render MCP — autonomous platform debugging and environment monitoring"
Cohesion: 0.14
...
### Community 651 - "Runbook: Auto-Resume After Cooldown / Interruption"
Cohesion: 0.14
...
### Community 652 - "SEO / GEO / AIO Audit Engine"
Cohesion: 0.14
...
### Community 657 - "_resolve_push_token"
Cohesion: 0.20
...
### Community 661 - "TestAnthropicToolListCaching"
Cohesion: 0.34
...
### Community 663 - "test_openclaw_gateway.py"
Cohesion: 0.14
...
### Community 664 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 667 - "register_user_research_tools"
Cohesion: 0.21
...
### Community 670 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 673 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 674 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 677 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
...
### Community 678 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 679 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 681 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 685 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
Nodes (12): Acceptance Checks, Claude's query protocol (use this instead of Read tool for exploration):, Graph Artifacts — What to Commit, How to Use the Graph (Token Savings Protocol), Installation (one-time per machine), Instead of reading raw files:, Key commands:, Relationship to repowise-intelligence Skill (+4 more)

### Community 686 - "Skill: platform-setup — Autonomous Agency Bootstrap"
Cohesion: 0.15
...
### Community 687 - "Device compatibility and model picks"
Cohesion: 0.15
...
### Community 688 - "Autonomy Uplift — Living Roadmap & Detailed Implementation Specs"
Cohesion: 0.15
...
### Community 689 - "OpenClaw — iOS Control of the Agency (Single-Service Free-Tier Deploy)"
Cohesion: 0.15
...
### Community 692 - "ApplyReviewAgent"
Cohesion: 0.22
...
### Community 694 - "_is_bedrock_model_id"
Cohesion: 0.27
...
### Community 696 - "Agent Transparency Report"
Cohesion: 0.15
...
### Community 697 - "update_provider_policy"
Cohesion: 0.19
...
### Community 700 - "test_deploy_trigger_covers_image.py"
Cohesion: 0.21
...
### Community 701 - "TestTheGatewayRegistryOffersOnlyLiveModels"
Cohesion: 0.22
...
### Community 702 - "test_quick_note_engine.py"
Cohesion: 0.17
...
### Community 703 - "test_task_brain_preflight.py"
Cohesion: 0.31
...
### Community 704 - "TestRouterIntegration"
Cohesion: 0.31
...
### Community 706 - "WorkspaceManifest"
Cohesion: 0.17
...
### Community 707 - "skill_registry.py"
Cohesion: 0.17
...
### Community 709 - "AGENTS.md — Codebase Map & Operations Reference"
Cohesion: 0.17
...
### Community 714 - "Skill: system-prompt-audit"
Cohesion: 0.17
...
### Community 715 - "Skill: task-alive-updates"
Cohesion: 0.17
...
### Community 718 - "_is_ephemeral_user"
Cohesion: 0.27
...
### Community 719 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 722 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 724 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 725 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 726 - "Workspace Isolation Architecture"
Cohesion: 0.17
...
### Community 727 - "Quantization Internals"
Cohesion: 0.17
...
### Community 728 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 729 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 730 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 734 - "check_container_posture.py"
Cohesion: 0.26
...
### Community 735 - "test_pytest_failure_parser.py"
Cohesion: 0.23
...
### Community 736 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 737 - "test_admin_local_brain_router.py"
Cohesion: 0.29
...
### Community 738 - "test_agile_api.py"
Cohesion: 0.17
...
### Community 739 - "test_app_settings.py"
Cohesion: 0.21
...
### Community 740 - "test_brain_default_consistency.py"
Cohesion: 0.24
...
### Community 741 - "test_docs_consistency.py"
Cohesion: 0.17
...
### Community 742 - "TestAnthropicPayloadStructuredOutput"
Cohesion: 0.29
...
### Community 743 - "test_task_clarification.py"
Cohesion: 0.17
...
### Community 759 - "Main proxy (`proxy.py`)"
Cohesion: 0.18
...
### Community 760 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 761 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 762 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 763 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 764 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 765 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 766 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 768 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 769 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 770 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 771 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 772 - "What to clean up"
Cohesion: 0.18
...
### Community 773 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 781 - "TestAgentRunnerSafety"
Cohesion: 0.24
...
### Community 782 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 783 - "test_event_log.py"
Cohesion: 0.45
...
### Community 784 - "TestNoNvidiaFallbackIsRetired"
Cohesion: 0.22
...
### Community 807 - "TestModelsEndpointAliases"
Cohesion: 0.31
...
### Community 808 - "build_tech_db.py"
Cohesion: 0.40
...
### Community 811 - "._notify_approval_gate"
Cohesion: 0.22
...
### Community 813 - "TestZeroAttemptDiagnostics"
Cohesion: 0.29
...
### Community 814 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 819 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 821 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 823 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 824 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 825 - "Skill: changelog-enforcer"
Cohesion: 0.22
Nodes (8): Acceptance Checks, Changelog Location, Entry Format, Examples, Hook Behaviour, Instructions, Skill: changelog-enforcer, When to Use

### Community 826 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
Nodes (8): Branch, Components, Purpose, Quick Start, Session Roles, Skill: cowork-session (Claude Cowork), Testing, When to Use

### Community 827 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 830 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 833 - "Issue #1356: quick-note:https://searchengineland.com/turn-seo-backlog-into-roadmap-485713"
Cohesion: 0.22
...
### Community 834 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 835 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 836 - "Platform Controls"
Cohesion: 0.22
...
### Community 837 - "Release Procedure"
Cohesion: 0.22
...
### Community 838 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 840 - "frontend/package.json"
Cohesion: 0.22
Nodes (8): jest, moduleNameMapper, ^react-router$, ^react-router-dom$, name, private, proxy, version

### Community 841 - "TestTheProducersAndTheParserCannotDrift"
Cohesion: 0.25
...
### Community 842 - "_get_current_user"
Cohesion: 0.25
...
### Community 846 - "enrich_quick_note_issues.py"
Cohesion: 0.42
...
### Community 847 - "_start_ceo_agency"
Cohesion: 0.31
...
### Community 848 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 849 - "test_changelog_parity_guard.py"
Cohesion: 0.22
...
### Community 857 - "agent/output_filter.py"
Cohesion: 0.32
...
### Community 863 - "_build_direct_chat_schedule_suggestion"
Cohesion: 0.32
...
### Community 864 - "_parse_tool_calls_from_response"
Cohesion: 0.39
...
### Community 875 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 876 - "ceo-micromanagement.md"
Cohesion: 0.25
Nodes (4): P0 behavior change, Readiness contract, Runtime model, Runtime types

### Community 877 - "Feature Maturity / Support Matrix"
Cohesion: 0.25
...
### Community 880 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.25
...
### Community 881 - "Issue #362: Nvidia repo setup"
Cohesion: 0.25
...
### Community 882 - "Issue #364: quick-note:https://www.marktechpost.com/2026/06/01/meet-memory-os-a-6-layer-open-source-memory-stack-built-on-top-of-hermes-agent/"
Cohesion: 0.25
...
### Community 883 - "Issue #378: quick-note:https://www.marktechpost.com/2026/06/02/tinyfish-launches-bigset-an-open-source-multi-agent-system-that-builds-structured-live-datasets-from-plain-english-descriptions/"
Cohesion: 0.25
...
### Community 884 - "Issue #379: quick-note:https://searchengineland.com/schema-markup-optimize-agentic-web-479080"
Cohesion: 0.25
...
### Community 885 - "Issue #380: quick-note:https://cursor.com/blog/cloud-agent-lessons"
Cohesion: 0.25
...
### Community 886 - "Issue #381: quick-note:https://www.xda-developers.com/claude-code-with-opus-48-is-expensive-but-i-made-it-efficient-with-my-local-ai-workflow/"
Cohesion: 0.25
...
### Community 887 - "Issue #382: quick-note:https://claude.com/blog/how-coderabbit-used-claude-to-build-an-agent-orchestration-system"
Cohesion: 0.25
...
### Community 888 - "Issue #383: quick-note:https://www.marktechpost.com/2026/05/29/hexo-labs-open-sources-sia-a-self-improving-agent-that-updates-both-the-harness-and-the-model-weights/"
Cohesion: 0.25
...
### Community 889 - "Issue #416: feat: Self-hosted Codebuff (freebuff) on free NVIDIA models + Telegram bot phone control"
Cohesion: 0.25
...
### Community 890 - "Issue #485: [Trend Digest] Week of 2026-06-08"
Cohesion: 0.25
...
### Community 891 - "Issue #488: quick-note:https://github.com/cookiy-ai/user-research-skill"
Cohesion: 0.25
...
### Community 892 - "Issue #491: Implement whatever is necessary from https://github.com/BehiSecc/awesome-claude-skills"
Cohesion: 0.25
...
### Community 893 - "Issue #493: Use the https://github.com/mvanhorn/last30days-skill skill to get the trend updated"
Cohesion: 0.25
...
### Community 894 - "Issue #495: Read https://www.anthropic.com/news/claude-fable-5-mythos-5 and understand if mythos or fable can be added to the repo"
Cohesion: 0.25
...
### Community 895 - "Issue #504: EPIC: Autonomy hardening — live-verified defects 2026-06-10"
Cohesion: 0.25
...
### Community 896 - "Issue #581: Sprint tracker: pending work after brand rename + mobile-first pass"
Cohesion: 0.25
...
### Community 898 - "Issue #657: quick-note:https://github.com/earendil-works/pi"
Cohesion: 0.25
...
### Community 899 - "Issue #659: quick-note:https://github.com/nex-agi/Nex-N2"
Cohesion: 0.25
...
### Community 900 - "Issue #660: quick-note:https://github.com/getsentry/sentry-for-ai"
Cohesion: 0.25
...
### Community 901 - "Issue #661: quick-note:https://github.com/XiaomiMiMo/MiMo-Code"
Cohesion: 0.25
...
### Community 902 - "Issue #664: quick-note:https://github.com/Grominet95/jarvis-OS"
Cohesion: 0.25
...
### Community 903 - "Issue #666: quick-note:https://github.com/porokka/jarvis-os"
Cohesion: 0.25
...
### Community 904 - "Issue #670: quick-note:https://github.com/perplexityai/bumblebee"
Cohesion: 0.25
...
### Community 905 - "Issue #672: quick-note:https://github.com/Chachamaru127/claude-code-harness"
Cohesion: 0.25
...
### Community 906 - "Issue #676: quick-note:https://github.com/WeiboAI/VibeThinker"
Cohesion: 0.25
...
### Community 907 - "Issue #820: quick-note:https://github.com/cobusgreyling/loop-engineering"
Cohesion: 0.25
...
### Community 908 - "Positional Encoding Internals"
Cohesion: 0.25
...
### Community 909 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 910 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 911 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 912 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 913 - "Prime Agent Runtime"
Cohesion: 0.25
...
### Community 922 - "TestItIsNotBuiltForOneVendor"
Cohesion: 0.25
...
### Community 923 - "test_compose_and_coordinate_api.py"
Cohesion: 0.36
...
### Community 924 - "test_generate_context_standing_instructions.py"
Cohesion: 0.32
...
### Community 925 - "test_local_brain_router_smoke.py"
Cohesion: 0.25
...
### Community 928 - "test_provider_models_db_outage.py"
Cohesion: 0.25
...
### Community 930 - "test_runtimes_health_endpoint.py"
Cohesion: 0.25
...
### Community 933 - "test_server_autonomy_and_index_fixes.py"
Cohesion: 0.29
...
### Community 935 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 936 - ".discover_directory"
Cohesion: 0.29
...
### Community 946 - "Changelog"
Cohesion: 0.29
Nodes (7): Added, Changed, Changelog, Fixed, Maintenance, Removed, Security

### Community 947 - "AI Engineering Insights Skill"
Cohesion: 0.29
...
### Community 960 - "Changelog"
Cohesion: 0.29
Nodes (7): Added, Changed, Changelog, Fixed, Maintenance, Removed, Security

### Community 961 - "claude-mem Plugin — Persistent Memory for All Sessions"
Cohesion: 0.29
...
### Community 962 - "Implementation plan + TO-DO (check off as you go)"
Cohesion: 0.29
...
### Community 965 - "Cloudflare = the real working app"
Cohesion: 0.29
...
### Community 973 - "e2e_smoke.py"
Cohesion: 0.57
Nodes (5): _chat(), check(), _health(), _models(), _req()

### Community 974 - "BackgroundServices"
Cohesion: 0.38
...
### Community 979 - "test_daily_2026_06_14.py"
Cohesion: 0.38
...
### Community 980 - "TestSupportMatrixDocsSync"
Cohesion: 0.29
...
### Community 981 - "TestGithubTokenSQLiteRegression"
Cohesion: 0.38
...
### Community 982 - "test_log_monitor_storm_guard.py"
Cohesion: 0.48
...
### Community 983 - "TestReasonsAreActionable"
Cohesion: 0.29
...
### Community 984 - "TestProvidersScreen"
Cohesion: 0.43
...
### Community 1002 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 1003 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 1004 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 1005 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 1006 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 1007 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 1011 - "apply_phase1_changes.py"
Cohesion: 0.33
...
### Community 1023 - "TestDirectChatAgentExecution"
Cohesion: 0.33
...
### Community 1024 - "test_catalogue_probe.py"
Cohesion: 0.33
...
### Community 1043 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 1044 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 1054 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1055 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1056 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 1057 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 1066 - "test_agent_runtime_wrapper.py"
Cohesion: 0.70
...
### Community 1067 - "TestTelegramNotifications"
Cohesion: 0.40
...
### Community 1068 - "TestNoKeyEverReachesTheLog"
Cohesion: 0.40
...
### Community 1069 - "TestTheProbeIdentifiesItself"
Cohesion: 0.40
...
### Community 1096 - "test_no_exception_detail_leaks.py"
Cohesion: 0.50
...
### Community 1097 - "test_skills_route_order.py"
Cohesion: 0.67
...
### Community 1098 - "github"
Cohesion: 0.50
Nodes (3): github, enabled, silent

### Community 1123 - "test_the_reserve_is_bounded_when_read_from_the_environment"
Cohesion: 0.67
...
## Knowledge Gaps
- **3452 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3447 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 13098 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **110 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `_fixture()` connect `_fixture` to `test_catalogue_probe.py`, `test_llm_router_queue_cache.py`, `TaskStore`, `llm/router.py`, `brain_config.py`, `WebsiteScanner`, `test_llm_router_resilience.py`, `test_operational_incidents.py`, `test_llm_router_strategies.py`, `SelfHealingAgent`, `test_model_router.py`, `test_company_api.py`, `Task`, `Specialist`, `test_telegram_service_webhook.py`, `ProviderRouter`, `Agency`, `E2BSandboxSession`, `TrafficDirector`, `PolicyEngine`, `config.py`, `cost_tracker.py`, `ImprovementLoop`, `test_unit8_model_catalog.py`, `services/background.py`, `test_agent_tool_governance.py`, `services/seo_audit.py`, `test_failover_client_shared.py`, `test_freebuff_bot.py`, `MCPClient`, `ExecutionRequest`, `test_openclaw_endpoints.py`, `KeyPool`, `UserRole`, `seo_api.py`, `settings.py`, `test_unit7_catalog_propagation.py`, `PrimeAgentAdapter`, `test_sam_livekit.py`, `AgentJobManager`, `resolve_active_brain`, `test_brain_availability_doctor.py`, `ChatHistoryStore`, `sam`, `SQLiteStore`, `AgentDefinition`, `test_webui_provider_priority.py`, `AgentPlan`, `test_autonomy_status.py`, `test_brain_failover_413.py`, `TaskExecutionCoordinator`, `test_llm_router_tpm.py`, `test_local_brain_state.py`, `ResearchTask`, `model_router.py`, `Artifact`, `TestClient`, `test_ai_insights.py`, `test_refresh_agent_built_proof.py`, `test_procedural_memory.py`, `test_telegram_diag_endpoint.py`, `KeyStore`, `resolve_e2b_config`, `BrainWatchdog`, `OllamaCircuitBreaker`, `test_knowledge_sync.py`, `test_telegram_auto_approve.py`, `e2e/test_browser.py`, `test_daily_automation_2026_07_09.py`, `test_startup_warmup.py`, `ScheduledJob`, `test_e2b_adapter.py`, `TestHarnessAdapter`, `test_context_rulebook.py`, `_StubProvider`, `ArtifactStore`, `run_task`, `test_provider_state_durability.py`, `test_provider_router.py`, `test_kimi_bridge_server.py`, `_resolve_push_token`, `_step`, `BackgroundAgent`, `test_openclaw_gateway.py`, `.run`, `test_telegram_freebuff.py`, `tests/conftest.py`, `claim`, `TestEstimateTokensForMessages`, `AgentSwarm`, `test_new_features_e2e.py`, `reset_orchestrator`, `test_e2b_task_wiring.py`, `_Budget`, `_job_text`, `test_ceo_router.py`, `test_task_brain_preflight.py`, `test_features_api.py`, `test_video_transcript.py`, `TrendWatcher`, `ai/router.py`, `clear_cooldowns`, `test_e2b_data_flow.py`, `test_process_quick_note_workflow.py`, `apply_review.py`, `test_trend_watcher.py`, `WorkflowRun`, `test_portfolio_intake.py`, `test_agile_api.py`, `test_app_settings.py`, `test_agent_free_brain.py`, `test_task_clarification.py`, `TestClient`, `get_feature_matrix`, `ContextPruner`, `DirectChatDoctor`, `test_control_plane_api.py`, `OrchestratorQueue`, `WorkflowBuildRequest`, `test_persistent_memory.py`, `SecurityScanner`, `rate_limiter.py`, `test_colibri_brain_shim.py`, `test_llm_router_e2e.py`, `OutputFilter`, `test_platform_controls.py`, `NotificationDispatcher`, `test_sam_voice.py`, `test_nvidia_model_discovery.py`, `session_retro.py`, `test_mcp_governance.py`, `test_purge_backlog.py`, `analyze_page`, `test_scheduler_hydration_bounded.py`, `_start_ceo_agency`, `test_agent_scripts_share_one_model_list.py`, `test_crispy_burn_in.py`, `test_provider_enable_disable.py`, `test_skill_registry_boot_refresh.py`, `parse_event_stream`, `isolated_telegram_config`, `test_phase5_doctor.py`, `_undeclared`, `test_claude_code_adapter.py`, `test_service_token.py`, `test_harness_spec.py`, `test_regression.py`, `test_agency_fix.py`, `test_dashboard_cache.py`, `test_ping.py`, `test_runtimes_health_endpoint.py`, `test_monitor_lib.py`, `test_v4_api.py`, `reap_expired_companies`, `platform_controls_router.py`, `client`, `TestTheWorkflowIsSafeAndReadOnly`, `test_voice_pipeline.py`, `TestNormalizeResponseFormat`, `test_brain_patch_service_token.py`?**
  _High betweenness centrality (0.113) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `proxy.py`, `AdaptiveHalter`, `TaskSpec`, `TestAgentRunnerSafety`, `test_empirical_verify.py`, `_resolve_push_token`, `ReactScratchpad`, `BackgroundAgent`, `.run`, `loop.py`, `E2BSandboxSession`, `Agency`, `PolicyEngine`, `ContextManager`, `test_governance_api.py`, `TestAgentLoopMCPIntegration`, `test_agent_tool_governance.py`, `test_failover_client_shared.py`, `MultiAgentSwarm`, `MCPClient`, `test_daily_automation_2026_07_11.py`, `StuckDetector`, `LocalWorkspace`, `test_backend_server_features.py`, `ExecutionRequest`, `BrainFailoverExhausted`, `WorkspaceTools`, `AgentJobManager`, `AgentPlan`, `CEODispatcher`, `test_brain_failover_413.py`, `UserMemoryStore`, `test_e2b_adapter.py`, `direct_chat.py`, `InternalAgentAdapter`, `workflow_orchestrator.py`, `test_agent_free_brain.py`, `TokenBudget`, `ContextPruner`, `test_daily_automation_2026_07_09.py`, `GitHubTools`, `FreeBuffAgent`, `enforcement.py`, `TestAgentRunnerExecution`, `AgentSessionStore`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderRouter` to `backend/server.py`, `test_all_providers_discovery.py`, `test_bedrock_live.py`, `test_colibri_brain_shim.py`, `test_provider_router.py`, `test_anthropic_router.py`, `TrafficDirector`, `test_bedrock_provider.py`, `implement_agent.py`, `NvidiaProvider`, `kimi_bridge_provider_config`, `test_backend_server_features.py`, `test_colibri_provider.py`, `TestRouterIntegration`, `model_discovery.py`, `ai/router.py`, `clear_cooldowns`, `direct_chat.py`, `failover_client.py`, `TestAnthropicPayloadStructuredOutput`, `Provider`?**
