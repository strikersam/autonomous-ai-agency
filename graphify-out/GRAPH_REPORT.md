...
## Corpus Check
- 1434 files · ~2,071,811 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 29039 nodes · 53965 edges · 1246 communities (1131 shown, 115 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 2666 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `dd64ad4b`
...
## Communities (1246 total, 115 thin omitted)
...
Cohesion: 0.03
Nodes (161): get_skill_registry_safe(), Return the global SkillRegistry if set, else None. Used by onboarding and other…, middleware, admin_control(), admin_delete_user(), admin_login(), admin_logout(), admin_rotate_user() (+153 more)
...
### Community 8 - "Any"
Cohesion: 0.04
Nodes (35): _check_extra_kwargs(), _enforce_signature(), _note_phase_end(), _note_phase_start(), Any, Path, Raise TypeError if fn's signature drifts from the locked contract (Pydantic…, Raise TypeError on unknown kwarg (runtime extra='forbid' for non-Pydantic… (+27 more)
...
Cohesion: 0.03
Nodes (92): BrainConfig, BrainConfigPatch, BrainConfigStore, default_brain_config(), provider_base_url(), BaseModel, Persist *cfg* to Mongo (primary) and sqlite (mirror). Either backend failing is…, Build a ``BrainConfig`` from a Mongo doc, dropping Mongo's ``_id``. (+84 more)
...
Cohesion: 0.03
Nodes (126): Governance seam: judge the call, run it, audit the outcome. Deliberately a thin…, Feed LLM token/cost spend into the governance session budget. Kept separate…, _egress_policy_reason(), agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Return why governance policy blocks *host*, or None. Runs strictly *after* the…, guard(), _load(), mcp_server/governance.py — governance adapter for the MCP HTTP surface. Closes… (+118 more)

### Community 18 - "CEODispatcher"
Cohesion: 0.04
Nodes (74): CEODispatcher, CEOResult, _complexity_rank(), _decompose_into_subtasks(), get_ceo_dispatcher(), _merge_changed_files(), _offload(), Any (+66 more)
...
Cohesion: 0.03
Nodes (106): BoundContext, ClassifyOutput, ExecutionResult, get_ceo_fallback_stats(), JudgeVerdict, MonitorOutput, _orchestrator_bypass(), PersistOutput (+98 more)
...
Cohesion: 0.03
Nodes (125): ApprovalPolicy, BusinessSystem, CompanyCreateRequest, CompanyGraph, CompanyGraphResponse, CompanyGraphSnapshot, CompanyResponse, CompanyUpdateRequest (+117 more)

### Community 30 - "test_runtime_governance.py"
Cohesion: 0.07
Nodes (59): _audit_dispatch(), _blocked_result(), _governance_check(), Any, TaskResult, TaskSpec, Build the failed TaskResult returned when policy denies a dispatch. A result…, Evaluate a runtime dispatch against policy; audit it either way. Returns… (+51 more)
...
Cohesion: 0.03
Nodes (79): Resolve the JWT signing secret, with a *stable* fallback. Bug fix: the previous…, _resolve_jwt_secret(), Replace the process-wide store. Tests only., reset_approval_store(), AuditEvent, AuditLog, Any, packages/governance/audit.py — the evidence trail for every governed action.… (+71 more)

### Community 37 - "test_unit8_model_catalog.py"
Cohesion: 0.04
Nodes (73): get_catalog_models_route(), Return the mirrored model catalog (advisory-only). Flag-gated by…, all_provider_ids(), Return every provider id recognised by the brain config system. Iterates the…, CatalogActiveBrain, CatalogMirror, CatalogProviderEntry, get_catalog() (+65 more)
...
Cohesion: 0.06
Nodes (83): failover_chat_completion(), FailoverResult, _log_recovery(), A successful completion plus the accounting its callers need., Report a successful failover at INFO — recovery is not an incident. Everything…, Run one chat completion across the brain-failover chain. Tries each healthy…, _free_tier(), _hit_ids() (+75 more)
...
### Community 47 - "test_brain_availability_doctor.py"
Cohesion: 0.05
Nodes (51): brain_availability_summary(), Non-secret answer to "can the brain answer a request right now?". Three callers…, CEOSupervisor, _env_flag(), _env_int(), Any, services/ceo_supervisor.py — the CEO's 24x7 babysitting loop. Delegation alone…, What one sweep observed and did. Returned for tests and diagnostics. (+43 more)
...
Cohesion: 0.03
Nodes (95): ApprovalRequest, ApprovalStatus, ApprovalStore, Any, Enum, str, packages/governance/approvals.py — human-in-the-loop for high-risk actions. The…, Bounded, in-process store of approval requests. Uses a :class:`threading.Lock`… (+87 more)
...
Cohesion: 0.05
Nodes (50): When coder == reviewer model, swarm should log a warning., _fake_artifact(), _make_engine(), tests/test_crispy_workflow.py — CRISPY workflow engine hardening tests. Tests…, Create a WorkflowEngine with isolated storage., TestAbortOnFailure, TestPhaseSequence, TestPhaseSequenceError (+42 more)
...
Cohesion: 0.02
Nodes (111): _format_incident(), _iso_from_monotonic(), normalise(), note_phase_end(), note_phase_start(), _now(), open_phase_report(), OperationalIncident (+103 more)
...
Cohesion: 0.07
Nodes (37): Agent subsystem — planner / executor / verifier loop., AgentPlan, AgentRunRequest, AgentSession, AgentSessionCreateRequest, AgentSessionMessage, AgentStep, _known_tool_names() (+29 more)
...
Cohesion: 0.06
Nodes (46): _auto_disable(), _describe_registry(), _disabled_ids(), _is_billing_refusal(), _is_ollama(), _key_pool(), _log_exhaustion(), _looks_unknown_model() (+38 more)
...
Cohesion: 0.07
Nodes (60): Return a Markdown-v1-safe preview string under ``max_chars``. Used by the…, sanitize_paste_for_preview(), _admin_headers(), _answer_callback(), _api_headers(), _check_rate_limit(), cmd_control(), cmd_cost() (+52 more)
...
Cohesion: 0.04
Nodes (37): DockerAgentAdapter, Any, TaskResult, TaskSpec, Adapter that runs agent tasks inside isolated Docker containers., Check whether Docker is available and report the adapter's runtime health.…, Available iff config resolves AND the SDK is importable. Never raises — a…, e2b_status() (+29 more)
...
Cohesion: 0.06
Nodes (43): Record token usage for *model* (fire-and-forget, never raises). ``tag`` is a…, record_usage(), _dead_model_key(), _exponential_backoff_cooldown(), get_dead_models(), _is_model_dead(), _mark_model_dead(), _notify_watchdog() (+35 more)
...
Cohesion: 0.05
Nodes (53): main(), Returns (url, ok, summary)., _scan_one(), _is_safe_url(), _looks_like_bot_challenge(), BeautifulSoup, True if the HTML is an anti-bot/CAPTCHA interstitial rather than content. Used…, Advanced Scanner for detecting technology stack and systems from websites.… (+45 more)
...
### Community 188 - "test_iteration_6_features.py"
Cohesion: 0.05
...
### Community 207 - "make_isolated_workspace"
Cohesion: 0.33
...
### Community 231 - "Task"
Cohesion: 0.03
Nodes (86): Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., tasks — Task/issue management system. Provides a lightweight task/issue tracker…, ApprovalCheckpoint, ApprovalRequest, ClarifyRequest, _coerce_ts(), CommentAddRequest (+78 more)
...
Cohesion: 0.05
Nodes (47): get_brain_config(), get_brain_config_store(), provider_key_present(), Return the process-wide ``BrainConfigStore`` singleton., Convenience wrapper used by the agent loop + brain resolver., True when the env var for *provider*'s key is set (or it's Ollama)., Any, packages/ai/self_heal.py — automatic brain self-healing. When the active brain… (+39 more)

### Community 244 - "InternalAgentAdapter"
Cohesion: 0.06
Nodes (29): _best_cloud_primary_base(), InternalAgentAdapter, TaskResult, TaskSpec, Built-in agent loop — Nvidia NIM primary, Ollama fallback., Return runtime dependencies required by this adapter. Returns:…, Determine availability of the internal agent runtime. Checks cloud providers in…, Execute a TaskSpec using the internal AgentRunner and convert the agent's… (+21 more)
...
### Community 307 - "BackgroundServices"
Cohesion: 0.38
...
Cohesion: 0.16
Nodes (13): guard_tool_call(), GuardResult, Any, The outcome of guarding one action., A message safe to hand back to the model as a tool result. Names the rule so…, Evaluate, gate, and (if required) hold for approval. Returns a…, Create an approval request and wait for its verdict., Audit the *outcome* of an allowed action and charge its cost. Split from… (+5 more)
...
Cohesion: 0.04
Nodes (56): BreakerState, Enum, str, packages/llm/health.py — provider health tracking and circuit breaking. Two…, Test hook — clear all health state., reset(), _digest(), get_ring() (+48 more)
...
### Community 437 - "test_orchestrator_merge_decision.py"
Cohesion: 0.24
...
Cohesion: 0.03
Nodes (83): Task, Creates tasks from scheduler and playbook runs using one workflow., TaskAutomationService, Any, Task, TaskStatus, Fail loud in production if no persistent storage is configured. Telegram…, Create a task. Deduplicates by source_id if set (Charter G3). If a task with… (+75 more)
...
### Community 545 - "TestModelRegistryUpdates"
Cohesion: 0.14
...
### Community 549 - "test_colibri_brain_shim.py"
Cohesion: 0.08
...
### Community 606 - "test_task_self_repo_auto_commit.py"
Cohesion: 0.17
...
Cohesion: 0.03
Nodes (36): Find a website by its URL., A company website with detected systems and stack inference., Website, requires_db, CompanyGraphStore, Delete a company and all its associated data., List companies with optional filtering., Count total companies in the store. (+28 more)
...
### Community 723 - "test_telegram_task_callback.py"
Cohesion: 0.20
...
### Community 726 - "verify_service_token"
Cohesion: 0.22
...
### Community 759 - "TestRuntimeControl"
Cohesion: 0.15
...
Cohesion: 0.03
Nodes (91): Return orchestrator queue depth, active runs, and supervisor state (#522)., Called by APScheduler when a cron fires. Dispatches to the orchestrator. This…, _scheduler_on_fire(), workflow_orchestrator_status(), get_orchestrator_queue(), get_orchestrator_supervisor(), OrchestratorSupervisor, services/orchestrator_supervisor.py — Deterministic Supervisor Issue #522: A… (+83 more)
...
Cohesion: 0.03
Nodes (192): admin_seed(), _agent_timeout_fallback_response(), AgentStatusEntry, AgentStatusResponse, AgentToolCallEntry, ApiKeyCreate, AuthorizeReposBody, _build_agent_status_snapshot() (+184 more)
...
### Community 829 - "has_image_content"
Cohesion: 0.31
...
### Community 835 - "get_livekit_config"
Cohesion: 0.18
...
### Community 911 - "_start_ceo_agency"
Cohesion: 0.31
...
Cohesion: 0.07
Nodes (34): is_commercial_provider(), provider_access_tier(), _provider_field(), provider_sort_key(), ProviderConfig, Regression tests for the agent loop's multi-provider failover wire format.…, The pieces the failover loop assembles for an Anthropic-native provider., TestAnthropicRequestShape (+26 more)
...
### Community 1141 - "test_server_autonomy_and_index_fixes.py"
Cohesion: 0.29
...
Cohesion: 0.03
Nodes (115): _load(), main(), int, get_budget(), The process-wide budget tracker., get_cache(), packages/llm/cache.py — layered caching. Five independent layers, each with its…, The process-wide cache manager. (+107 more)
...
### Community 1201 - "Workspace Issues"
Cohesion: 0.29
...
### Community 1202 - "Model and Response Issues"
Cohesion: 0.29
...
### Community 1204 - "DirectChatDoctor"
Cohesion: 0.47
...
### Community 1214 - "_normalize_dockerfile"
Cohesion: 0.33
...
### Community 1215 - "start_in_process"
Cohesion: 0.33
...
### Community 1221 - "Admin Dashboard Issues"
Cohesion: 0.40
...
### Community 1223 - "Agent API Issues"
Cohesion: 0.40
...
### Community 1224 - "Network and Tunnel Issues"
Cohesion: 0.40
...
### Community 1235 - "Claude Code Specific Issues"
Cohesion: 0.50
...
### Community 1240 - "test_mint_token_rejects_missing_args"
Cohesion: 0.67
...
- **Why does `_fixture()` connect `_fixture` to `TaskStore`, `test_provider_router.py`, `test_llm_router_queue_cache.py`, `test_ceo_supervision.py`, `BrainConfig`, `test_company_api.py`, `test_daily_automation_2026_07_09.py`, `test_llm_router_tpm.py`, `validate_policy_text`, `resolve_identity`, `SelfHealingAgent`, `TaskWorkflowService`, `Agency`, `test_brain_failover_413.py`, `PrimeAgentAdapter`, `test_provider_state_durability.py`, `test_direct_chat_evolution.py`, `clear_cooldowns`, `models/company_graph.py`, `NotificationDispatcher`, `get_registry`, `services/background.py`, `test_agent_tool_governance.py`, `test_colibri_brain_shim.py`, `test_monitor_lib.py`, `test_openclaw_endpoints.py`, `ImprovementLoop`, `test_model_router.py`, `test_llm_router_strategies.py`, `test_ceo_router.py`, `test_failover_client_shared.py`, `test_implement_agent_routing.py`, `_resolve_push_token`, `test_process_quick_note_workflow.py`, `AgentJobManager`, `SQLiteStore`, `ChatHistoryStore`, `E2BSandboxSession`, `test_telegram_auto_approve.py`, `test_autonomy_status.py`, `get_task_store`, `test_local_brain_state.py`, `test_operational_incidents.py`, `test_phase5_doctor.py`, `test_refresh_agent_built_proof.py`, `services/seo_audit.py`, `test_telegram_diag_endpoint.py`, `config.py`, `ResearchTask`, `TestClient`, `resolve_e2b_config`, `test_procedural_memory.py`, `e2e/test_browser.py`, `UserRole`, `parse_event_stream`, `test_knowledge_sync.py`, `test_startup_warmup.py`, `.on_task_complete`, `SeoFixer`, `KeyStore`, `claim`, `test_task_store_fails_loud_in_production.py`, `test_context_rulebook.py`, `test_agent_free_brain.py`, `ArtifactStore`, `run_task`, `test_openclaw_gateway.py`, `AgentSwarm`, `test_response_cache.py`, `provider_max_rpm`, `test_doctor_service_token_check.py`, `BackgroundAgent`, `TestHarnessAdapter`, `MCPClient`, `BudgetTracker`, `test_new_features_e2e.py`, `persist_plan_spec`, `TestEstimateTokensForMessages`, `_Budget`, `ai/router.py`, `llm/router.py`, `test_e2b_task_wiring.py`, `test_doctor_coding_brain.py`, `test_e2b_data_flow.py`, `OllamaCircuitBreaker`, `analyze_page`, `test_unit8_model_catalog.py`, `test_iteration_6_features.py`, `model_discovery.py`, `test_features_api.py`, `test_video_transcript.py`, `resolve_active_brain`, `TrendWatcher`, `routed`, `test_agile_api.py`, `test_app_settings.py`, `Company`, `test_telegram_task_callback.py`, `test_portfolio_intake.py`, `OrchestratorCheckpointStore`, `test_trend_watcher.py`, `AgentProfile`, `api_keys_for`, `TestClient`, `Task`, `ContextPruner`, `BrainWatchdog`, `TestRuntimeControl`, `ExecutionRequest`, `test_task_brain_preflight.py`, `test_daily_2026_07_27.py`, `test_persistent_memory.py`, `SecurityScanner`, `WorkflowBuildRequest`, `test_llm_router_e2e.py`, `OutputFilter`, `test_platform_controls.py`, `test_scheduler_hydration_bounded.py`, `TestFeaturesAPI`, `_resolve_user_github_token`, `test_rate_limiter.py`, `TestAuthAndTaskOwnership`, `test_brain_failover.py`, `test_sam_voice.py`, `OrchestratorQueue`, `test_purge_backlog.py`, `test_kimi_bridge_server.py`, `session_retro.py`, `test_crispy_burn_in.py`, `test_provider_enable_disable.py`, `test_skill_registry_boot_refresh.py`, `isolated_telegram_config`, `get_scheduler`, `test_webui_provider_priority.py`, `test_claude_code_adapter.py`, `test_service_token.py`, `test_brain_patch_service_token.py`, `test_harness_spec.py`, `test_ping.py`, `test_telegram_service_webhook.py`, `test_runtimes_health_endpoint.py`, `test_dashboard_cache.py`, `_start_ceo_agency`, `control_overrides.py`, `test_regression.py`, `test_agency_fix.py`, `test_telegram_mutating_commands.py`, `test_llm_router_resilience.py`, `_get`, `test_v4_api.py`, `test_llm_router_disabled.py`, `client`, `test_orchestrator_merge_decision.py`, `SchedulerStore`, `TestMongoGate`, `test_voice_pipeline.py`, `_job_text`, `test_task_clarification.py`, `cost_tracker.py`, `TestNormalizeResponseFormat`, `test_task_service_failed_comment.py`, `test_ai_insights.py`, `test_sam_livekit.py`?**
  _High betweenness centrality (0.116) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `test_agent_free_brain.py`, `proxy.py`, `TestAgentLoopMCPIntegration`, `Any`, `TaskSpec`, `ReactScratchpad`, `test_daily_automation_2026_07_09.py`, `validate_policy_text`, `BrainFailoverExhausted`, `resolve_identity`, `CEODispatcher`, `BackgroundAgent`, `ContextManager`, `Agency`, `test_brain_failover_413.py`, `MCPClient`, `test_ceo_dispatcher.py`, `test_e2b_adapter.py`, `test_agent_tool_governance.py`, `MultiAgentSwarm`, `test_failover_client_shared.py`, `StuckDetector`, `loop.py`, `test_backend_server_features.py`, `WorkspaceTools`, `test_daily_automation_2026_07_11.py`, `test_governance_api.py`, `LocalWorkspace`, `AgentJobManager`, `.execute`, `E2BSandboxSession`, `TestAgentRunnerSafety`, `test_empirical_verify.py`, `test_agent_chat_integration.py`, `AgentPlan`, `UserMemoryStore`, `TokenBudget`, `TestAgentRunnerExecution`, `FreeBuffAgent`, `AdaptiveHalter`, `ContextPruner`, `direct_chat.py`, `InternalAgentAdapter`, `ExecutionRequest`, `GitHubTools`, `AgentSessionStore`, `backend/server.py`?**
