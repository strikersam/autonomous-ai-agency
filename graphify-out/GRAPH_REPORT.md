# Graph Report - autonomous-ai-agency  (2026-09-12)

## Corpus Check
- 1505 files · ~2,181,947 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 30488 nodes · 56433 edges · 1270 communities (1102 shown, 112 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 2734 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2eb07ca9`
...
## Communities (1270 total, 112 thin omitted)

### Community 0 - "HTTPException"
Cohesion: 0.03
Nodes (139): auth_me(), auto_recommend_skills(), clear_cost_attribution(), clear_response_cache(), cost_attribution_stats(), create_github_pr(), create_provider(), delete_api_key() (+131 more)
...
Cohesion: 0.02
Nodes (77): BusinessSystem, CompanyGraph, CompanyGraphSnapshot, OnboardingProgress, SystemType, Get the index of a phase in the workflow., The complete Company Graph - canonical core model for the Autonomous AI Agency.…, Find a repository by its URL. (+69 more)
...
Cohesion: 0.03
Nodes (167): Describes a single worker's task and constraints., WorkerSpec, get_sam(), get_skill_registry_safe(), Return the global SkillRegistry if set, else None. Used by onboarding and other…, middleware, admin_control(), admin_delete_user() (+159 more)
...
### Community 7 - "enforcement.py"
Cohesion: 0.04
Nodes (61): Feed LLM token/cost spend into the governance session budget. Kept separate…, Charge sub-agent nesting depth and enforce the ``max_depth`` ceiling. Isolates…, _load(), mcp_server/governance.py — governance adapter for the MCP HTTP surface. Closes…, Write the audit row for a completed (or blocked) MCP tool call., Import the governance layer once, recording why if it is absent., record(), events_from_identity() (+53 more)

### Community 8 - "test_llm_router_queue_cache.py"
Cohesion: 0.03
Nodes (84): int, Test hook — clear all usage accounting., reset(), CacheManager, cosine_similarity(), _Entry, LRUCache, payload_key() (+76 more)
...
Cohesion: 0.03
Nodes (121): agents/store.py — Persistent store for user-defined agent configurations.…, Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., tasks — Task/issue management system. Provides a lightweight task/issue tracker…, Enum, str, tasks/models.py — Pydantic models for the task/issue system., Comment or reply on a task. (+113 more)

### Community 13 - "Settings"
Cohesion: 0.02
Nodes (95): provider_key_present(), True when the env var for *provider*'s key is set (or it's Ollama)., CatalogActiveBrain, CatalogMirror, CatalogProviderEntry, _include_router_providers(), invalidate_catalog_cache(), ModelCatalogStore (+87 more)
...
Cohesion: 0.03
Nodes (117): AgentPhaseError, AgentRunner, Any, Exception, Path, Governance seam: judge the call, run it, audit the outcome. Deliberately a thin…, Append an event to the durable session log if a store is wired in., Summarise a long history and compact it. Asks the planner model to write a… (+109 more)

### Community 18 - "SelfHealingAgent"
Cohesion: 0.05
Nodes (68): get_self_healing_agent(), heal_signature(), HealingEvent, HealState, _now(), Any, str, agent/self_healing.py — Self-Healing Agent (closed-loop, Autonomy Charter G2)… (+60 more)

### Community 19 - "_fixture"
Cohesion: 0.02
Nodes (96): app_client(), _clear_discovered_models(), _clear_response_cache(), client(), _isolate_brain_data_layer(), _isolate_operator_provider_state(), non_admin_client(), MonkeyPatch (+88 more)
...
Cohesion: 0.04
Nodes (60): Backoff policy for retryable failures., RetryConfig, BreakerState, Enum, str, _digest(), KeyRing, KeyState (+52 more)

### Community 28 - "PolicyEngine"
Cohesion: 0.03
Nodes (98): _egress_policy_reason(), agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Return why governance policy blocks *host*, or None. Runs strictly *after* the…, AgentIdentity, _coerce_text(), new_session_id(), Any, packages/governance/identity.py — who is acting, and under what mandate. Docker… (+90 more)

### Community 29 - "CompanyGraphService"
Cohesion: 0.03
Nodes (43): BusinessCategory, Find a website by its URL., A company website with detected systems and stack inference., Website, CompanyGraphService, Company, SpecialistFamily, SystemType (+35 more)
...
Cohesion: 0.08
Nodes (50): allow_paid_brain(), BrainResolution, get_active_brain_sync(), get_brain_preference(), get_provider_role_tags(), _host_is_openai_compatible(), invalidate_brain_cache(), _norm() (+42 more)

### Community 35 - "Task"
Cohesion: 0.04
Nodes (77): Full task/issue document., Task, One-line human explanation of why this task needs human approval. Reads risk…, PUBLIC_URL-anchored dashboard deep link for the task detail. Returns empty…, Best-effort Telegram heads-up that a task is parked awaiting approval. Inline…, asyncio, A reject + human Retry starts a NEW approval cycle → fresh notification., A gated task parked while IN_PROGRESS must not be treated as stranded. (+69 more)

### Community 36 - "Specialist"
Cohesion: 0.03
Nodes (42): SpecialistFamily, Find all specialists of a specific family., Find specialists that can handle a task with given capabilities., A specialist agent that can be provisioned for company-specific tasks., Check if this specialist can handle a task with given capabilities., Specialist, Get a specialist by ID., Create a new specialist. (+34 more)

### Community 37 - "TaskWorkflowService"
Cohesion: 0.03
...
Cohesion: 0.06
Nodes (85): failover_chat_completion(), FailoverResult, _log_recovery(), A successful completion plus the accounting its callers need., Report a successful failover at INFO — recovery is not an incident. Everything…, Run one chat completion across the brain-failover chain. Tries each healthy…, _free_tier(), _hit_ids() (+77 more)

### Community 39 - "llm/router.py"
Cohesion: 0.04
Nodes (65): Attempt, text_key(), auto_disable(), _billing_signals(), describe(), disabled_provider_ids(), is_unfixable(), packages/llm/disabled.py — bridge to the durable provider on/off switch. The… (+57 more)

### Community 40 - "SeoAuditEngine"
Cohesion: 0.04
Nodes (45): Run a full SEO/GEO/AIO audit against a website and persist the evidence., run_seo_audit(), field_validator, A single occurrence of a check firing on a specific URL., Aggregated report row - Screaming Frog CSV compatible., Site-level facts discovered during the crawl., Request to run an SEO/GEO/AIO audit against a website., SeoAuditRequest (+37 more)
...
Cohesion: 0.05
Nodes (41): compute_savings(), compute_time_series(), get_savings(), get_usage(), get_user_savings(), _period_start(), Any, BaseModel (+33 more)
...
Cohesion: 0.04
Nodes (67): Agent subsystem — planner / executor / verifier loop., AgentEvent, AgentRunRequest, AgentSession, AgentSessionCreateRequest, AgentSessionMessage, AgentStep, _known_tool_names() (+59 more)
...
Cohesion: 0.04
Nodes (48): AgentJob, AgentJobManager, make_isolated_workspace(), _now(), Any, Path, agent/job_manager.py — Async agent job lifecycle manager. Manages agent jobs…, Run a job using the provided runner and update the job's lifecycle, progress,… (+40 more)

### Community 55 - "AuditEvent"
Cohesion: 0.05
Nodes (35): AuditEvent, _luhn_ok(), packages/governance/audit.py — the evidence trail for every governed action.…, True when ``digits`` (bare, no separators) satisfies the Luhn checksum., Redact SSNs and Luhn-valid payment-card numbers from a string. Runs after the…, Recursively strip secrets from an arbitrary argument structure. Fails…, Redact secret-shaped substrings, then truncate., One governed action, fully described. Field order follows the… (+27 more)
...
### Community 58 - "Agency"
Cohesion: 0.04
Nodes (79): Agency, AgencyCycleResult, AgentDirective, AgentRole, _build_ceo_prompt(), _build_quick_note_instruction(), _close_github_issue(), _collect_recent_git_context() (+71 more)

### Community 59 - "test_seo_portfolio_bridge.py"
Cohesion: 0.10
Nodes (25): build_seo_roadmap(), delegation_plan_to_initiatives(), delegation_task_to_initiative(), plan_seo_sprint(), Convert SEO delegation plan to a portfolio and lay it onto a Now/Next/Later…, Convert SEO delegation plan to a portfolio and allocate capacity into a sprint.…, Run the full pipeline: SEO delegation plan → Portfolio → Roadmap → (optional)…, Convert a SeoDelegationTask into a portfolio Initiative. The WSJF components… (+17 more)

### Community 60 - "models/company_graph.py"
Cohesion: 0.04
Nodes (85): ApprovalPolicy, CompanyCreateRequest, CompanyResponse, CompanyUpdateRequest, Connector, DetectedSystem, Evidence, BaseModel (+77 more)
...
Cohesion: 0.05
Nodes (58): generate_backlog_retro(), generate_standup(), plan_next_sprint(), Agentic Agile — autonomous ceremonies (standup, retro, sprint planning). Where…, Derive a retrospective from the task tracker when no sprint is active. DONE /…, The result of allocating portfolio capacity into a new sprint., Allocate ``capacity`` of WSJF-ranked initiatives into a new sprint. Creates one…, A daily standup digest derived from the task tracker. ``sprint_health`` is… (+50 more)
...
### Community 83 - "Slice"
Cohesion: 0.09
Nodes (14): tests/test_workflow_models.py — Unit tests for workflow/models.py., TestApprovalGate, TestCheckRun, TestSlice, _extract_slices_from_plan(), Extract slice definitions from a plan.md artifact. Looks for sections matching:…, ApprovalGate, CheckRun (+6 more)
...
### Community 85 - "test_render_mcp.py"
Cohesion: 0.06
...
Cohesion: 0.03
Nodes (116): get_decisions_store(), Process-wide DecisionsStore singleton (resettable via db_path arg)., Return a Markdown-v1-safe preview string under ``max_chars``. Used by the…, sanitize_paste_for_preview(), _admin_headers(), _answer_callback(), _api_headers(), _check_rate_limit() (+108 more)
...
### Community 93 - "test_llm_router_tpm.py"
Cohesion: 0.06
...
### Community 96 - "test_operational_incidents.py"
Cohesion: 0.06
...
### Community 101 - "gateway.py"
Cohesion: 0.04
Nodes (72): AlertHandler, BudgetTracker, Counter, _Dimensions, get_budget(), _month(), Any, packages/llm/budget.py — token and cost accounting with spend alerts. Tracks… (+64 more)
...
### Community 106 - "get_runtime_manager"
Cohesion: 0.03
Nodes (75): DockerAgentAdapter, Any, TaskResult, TaskSpec, Adapter that runs agent tasks inside isolated Docker containers., Check whether Docker is available and report the adapter's runtime health.…, E2BAdapter, Any (+67 more)
...
### Community 109 - "ProviderConfig"
Cohesion: 0.05
Nodes (42): _get_director(), is_commercial_provider(), _normalized_provider_type(), provider_access_tier(), _provider_field(), provider_sort_key(), ProviderConfig, Any (+34 more)

### Community 110 - "test_iteration_6_features.py"
Cohesion: 0.05
...
Cohesion: 0.06
Nodes (25): TestTeamSummary, Path, tests/test_artifact_store.py — Unit tests for workflow/artifact_store.py., Verify artifacts that are stored as JSON (e.g., CheckRun results)., Writing the same (run_id, name) twice should update, not duplicate., store(), TestArtifactStoreDeletion, TestArtifactStoreJSONArtifact (+17 more)
...
Cohesion: 0.06
Nodes (63): The task store the background services should use, wiring it if needed.…, _task_store_for_background(), Reset the singleton (for tests)., reset_failover_manager(), Hand the 'connect & verify the repo' work to the agency's own agents. The task…, _seed_connect_task(), _blocked_retire_age_sec(), _heal_blocked_backlog() (+55 more)
...
Cohesion: 0.09
Nodes (28): Any, Path, PhaseType, WorkflowRun, CRISPY workflow engine — phase sequencer + gate controller. GATE: Golden Path…, Return the AgentSwarm singleton if available, else None., Append an event to the workflow event log., Create a new WorkflowRun and begin pre-gate phase execution. The run is… (+20 more)
...
Cohesion: 0.05
Nodes (52): get_mcp_client(), agent/mcp_client.py — Async MCP client for the mcp-server Docker container.…, Return the module-level MCPClient. Reads MCP_SERVER_BASE_URL at call time (not…, _internal_configured(), list_specs(), MCPServerSpec, _not_dialable(), _playwright_configured() (+44 more)
...
Cohesion: 0.04
Nodes (63): clear_cooldowns(), CommercialFallbackRequiredError, _dead_model_key(), _exponential_backoff_cooldown(), get_dead_models(), _is_model_dead(), is_provider_on_cooldown(), _mark_model_dead() (+55 more)
...
### Community 153 - "company_api.py"
Cohesion: 0.04
Nodes (111): ephemeral_ttl_hours(), Async read of the ephemeral TTL (hours) straight from the DB., account_lifecycle(), AccountLifecycleResponse, auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint() (+103 more)
...
### Community 162 - "get_skill_bindings"
Cohesion: 0.08
Nodes (35): build_matrix(), _families(), main(), Any, Map family -> sorted list of test files that mention it (quoted token)., Return one row per family, derived entirely from code., render_markdown(), _test_evidence_index() (+27 more)
...
Cohesion: 0.05
Nodes (43): check_feature(), get_feature(), list_features(), Any, get, post, features/api.py — Admin API for the feature support matrix. Exposes: GET…, Return the full support matrix with summary. (+35 more)
...
Cohesion: 0.04
Nodes (69): Return the discovered model list for *provider_id*, or ``[]`` if unknown., _served_models(), _auto_disable(), _describe_registry(), _disable_unless_key_serves_other_models(), _disabled_ids(), _is_billing_refusal(), _is_ollama() (+61 more)
...
### Community 176 - "test_unit7_catalog_propagation.py"
Cohesion: 0.06
...
Cohesion: 0.05
Nodes (55): _get_current_user_thunk(), _get_optional_user_thunk(), Request, create_access_token(), create_refresh_token(), get_current_user(), get_optional_user(), github_login() (+47 more)
...
### Community 210 - "test_colibri_brain_shim.py"
Cohesion: 0.05
...
### Community 212 - "operational_incidents.py"
Cohesion: 0.11
Nodes (25): _diagnose_and_file(), _file_incident(), _format_incident(), gather_render_evidence(), get_operational_incident_tracker(), OperationalIncident, agent/operational_incidents.py — recurring operational failures, auto-…, One failure mode that recurred often enough to warrant diagnosis. (+17 more)

### Community 213 - "ProviderRouter"
Cohesion: 0.06
...
### Community 214 - "CompanyAgencyService"
Cohesion: 0.09
...
Cohesion: 0.08
Nodes (25): AgentRole, _fake_artifact(), _now(), workflow/artifact_store.py — Durable artifact persistence. Artifacts are stored…, Connection, workflow/engine.py — WorkflowEngine: CRISPY phase sequencer. The engine is the…, Reset the singleton (test helper)., reset_engine() (+17 more)
...
### Community 238 - "test_claude_code_adapter.py"
Cohesion: 0.14
...
### Community 243 - "RuntimeHealthService"
Cohesion: 0.14
...
### Community 298 - "PortfolioIntelligence"
Cohesion: 0.10
Nodes (16): _env_github_token(), fetch_github_signals(), fetch_research_alerts(), _norm_title(), PortfolioIntelligence, Path, Fetch open PRs and bug-labelled issues. Returns {} on any failure/no token., Run an async coroutine from sync code, safe even inside a running loop.… (+8 more)
...
### Community 304 - "BrainFailoverExhausted"
Cohesion: 0.10
...
### Community 305 - "InternalAgentAdapter"
Cohesion: 0.07
...
### Community 312 - "TestStreamableHTTPTransport"
Cohesion: 0.13
...
Cohesion: 0.07
Nodes (27): Root directory under which repo fixes are allowed to operate., Run the repo-aware auto-fixer against this company's workspace checkout.…, run_seo_fixes(), _workspace_root(), FsPath, Request to remediate auto-fixable findings in a local code repository., Result of a fixer run., SeoFixRequest (+19 more)
...
### Community 343 - "test_kimi_bridge_server.py"
Cohesion: 0.12
...
### Community 345 - "verify_service_token"
Cohesion: 0.15
...
### Community 356 - "resolve_free_nvidia_brain"
Cohesion: 0.12
...
### Community 365 - "parse_event_stream"
Cohesion: 0.15
...
### Community 376 - "test_schedule_persistence.py"
Cohesion: 0.15
...
### Community 386 - "skill_bindings.py"
Cohesion: 0.07
Nodes (31): _execute_skill_impl(), _get_portfolio_manager(), Any, BaseModel, Enum, str, services/skill_bindings.py — Runtime Skill Bindings for Specialist Agents Wires…, A runtime-callable skill that specialists can execute through the workflow… (+23 more)
...
### Community 427 - "test_task_source_id_race.py"
Cohesion: 0.17
...
### Community 444 - "redact_connection_url"
Cohesion: 0.17
...
### Community 448 - "Agent Runtime Setup"
Cohesion: 0.12
...
### Community 452 - "loop.py"
Cohesion: 0.13
Nodes (24): _check_extra_kwargs(), _enforce_signature(), loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., Raise TypeError if fn's signature drifts from the locked contract (Pydantic…, Raise TypeError on unknown kwarg (runtime extra='forbid' for non-Pydantic…, # NOTE: "ollama_base" is kept for backwards compatibility; this runner only…, build_compaction_prompt(), build_execution_prompt() (+16 more)
...
### Community 466 - "all_provider_ids"
Cohesion: 0.05
Nodes (37): _brain_provider_status(), Return per-provider metadata for the GET endpoint. Iterates every provider in…, all_provider_ids(), get_provider_tier(), _provider_ids_from_literal(), Return the tier (``free`` / ``paid`` / ``local``) for *provider*. Returns…, Return every provider id recognised by the brain config system. Iterates the…, Return the provider ids allowed by the ``BrainProvider`` Literal. Reads the… (+29 more)
...
### Community 468 - "test_brain_failover_413.py"
Cohesion: 0.13
...
### Community 492 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 523 - "test_changelog_check_workflow.py"
Cohesion: 0.21
...
### Community 525 - "seo_api.py"
Cohesion: 0.04
Nodes (62): build_seo_roadmap(), _expire_stale_pending_report(), export_seo_audit(), get_seo_audit(), list_seo_audits(), plan_seo_sprint(), BaseModel, get (+54 more)
...
### Community 534 - "DailyDigestAggregatorTests"
Cohesion: 0.19
...
### Community 536 - "Workspace Isolation Architecture"
Cohesion: 0.06
...
### Community 545 - "types.py"
Cohesion: 0.04
Nodes (74): _load(), main(), packages/llm — the multi-provider LLM routing layer. Every LLM call in this…, packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, classify_error(), LLMProvider, OpenAICompatible, ABC (+66 more)
...
### Community 553 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 560 - "router/health.py"
Cohesion: 0.20
...
Cohesion: 0.04
Nodes (30): AiderAdapter, Any, Adapter for Aider — TIER 3 specialized git-aware code editor., HermesAdapter, Any, AsyncClient, TaskResult, TaskSpec (+22 more)
...
### Community 612 - "WorkspaceManager"
Cohesion: 0.14
...
### Community 631 - "_is_bedrock_model_id"
Cohesion: 0.27
...
### Community 635 - "TestRuntimeControl"
Cohesion: 0.15
...
### Community 638 - "sync_catalog_route"
Cohesion: 0.18
...
### Community 640 - "TestBrainFailoverModelUpdates"
Cohesion: 0.08
...
### Community 646 - "OrchestratorSupervisor"
Cohesion: 0.26
...
### Community 670 - "TestMCPToolsListCache"
Cohesion: 0.19
...
### Community 678 - "TestAuthAndTaskOwnership"
Cohesion: 0.17
...
### Community 679 - "2. Critical Bugs & Exact Detection Signatures"
Cohesion: 0.18
...
### Community 681 - "TestBackgroundAgentDispatch"
Cohesion: 0.24
...
### Community 686 - "ApprovalCheckpoint"
Cohesion: 0.14
...
### Community 702 - "mint_access_token"
Cohesion: 0.18
...
### Community 713 - "test_doctor_coding_brain.py"
Cohesion: 0.38
...
Cohesion: 0.02
Nodes (167): admin_seed(), _agent_provider_failure_response(), _agent_timeout_fallback_response(), AgentStatusEntry, AgentStatusResponse, AgentToolCallEntry, ApiKeyCreate, _append_agent_session_message() (+159 more)
...
### Community 746 - "local_brain_provider_config"
Cohesion: 0.29
...
### Community 755 - "_enforce_rate_limit"
Cohesion: 0.22
...
### Community 761 - "test_doctor_service_token_check.py"
Cohesion: 0.23
...
### Community 772 - "WorkspaceEscapeError"
Cohesion: 0.22
...
### Community 775 - "_start_ceo_agency"
Cohesion: 0.31
...
### Community 780 - "TestPaidPolicyDurability"
Cohesion: 0.22
...
Cohesion: 0.09
Nodes (35): quick_notes_submit(), _QuickNoteBody, Submit a quick-note URL or instruction from the dashboard FAB., apply_from_db(), Load the stored overrides and apply them. Called once at startup., Path, Start RuntimeManager, TaskDispatcher, SCHEDULER, and self-bootstrap. Returns a…, start_background_services() (+27 more)
...
Cohesion: 0.06
Nodes (41): Execute work through the 11-phase golden path., Called by APScheduler when a cron fires. Dispatches to the orchestrator. This…, _scheduler_on_fire(), workflow_orchestrator_execute(), stop_orchestrator_supervisor(), ExecutionRequest, get_workflow_orchestrator(), Return the shared WorkflowOrchestrator singleton. (+33 more)
...
### Community 810 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.25
...
### Community 815 - "audit"
Cohesion: 0.07
Nodes (20): audit(), get_audit_log(), is_admin(), is_power_user_or_above(), Any, Request, Return a short human-readable badge label for display in the UI., FastAPI dependency: require any authenticated user. (+12 more)
...
### Community 821 - "_load_local_metrics_since"
Cohesion: 0.43
...
### Community 828 - "get_scheduler"
Cohesion: 0.04
Nodes (44): legacy_scheduler_delete(), legacy_scheduler_get(), legacy_scheduler_trigger(), Force-dedup and clean stale schedules from the durable store. Admin-only…, scheduler_force_cleanup(), get_scheduler(), agent/scheduler.py — Scheduled Agent Jobs Cron-based job scheduler. Each job…, set_scheduler() (+36 more)
...
### Community 842 - "TestPolicyAuthoringUiStableClaim"
Cohesion: 0.29
...
### Community 844 - "agent/output_filter.py"
Cohesion: 0.33
...
### Community 845 - "openclaw_mobile_ui"
Cohesion: 0.33
...
### Community 850 - "open_phase_report"
Cohesion: 0.11
Nodes (23): _note_phase_end(), _note_phase_start(), Open a tracked phase, returning the token that closes it. Never raises., Close the tracked phase *token* opened above. Never raises., note_phase_end(), note_phase_start(), open_phase_report(), Record that *phase* began; returns the token that ends it. Called from… (+15 more)
...
### Community 855 - "TestWorkflowIntegration"
Cohesion: 0.33
...
### Community 901 - "SeoToAgilePipelineResult"
Cohesion: 0.50
Nodes (3): Complete result of converting an SEO audit to portfolio + roadmap + sprint., Render the full pipeline result as markdown., SeoToAgilePipelineResult
...
### Community 969 - "resolve_hermes_base_url"
Cohesion: 0.47
...
### Community 978 - "capture_screens.py"
Cohesion: 0.29
...
### Community 1028 - "InitiativeProgress"
Cohesion: 0.33
...
### Community 1032 - "test_server_autonomy_and_index_fixes.py"
Cohesion: 0.29
...
### Community 1074 - "scripts/agile_ceremonies.py"
Cohesion: 0.60
...
### Community 1123 - "test_skills_route_order.py"
Cohesion: 0.67
...
## Knowledge Gaps
- **3512 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3507 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 13416 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **112 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `_fixture()` connect `_fixture` to `TestTheWorkflowIsSafeAndReadOnly`, `test_brain_patch_service_token.py`, `test_ai_insights.py`, `test_llm_router_queue_cache.py`, `test_llm_router_strategies.py`, `test_changelog_check_workflow.py`, `ImprovementLoop`, `TaskStore`, `test_model_router.py`, `Settings`, `config.py`, `SelfHealingAgent`, `WorkflowRun`, `E2BSandboxSession`, `PolicyEngine`, `test_company_api.py`, `Task`, `TaskWorkflowService`, `test_failover_client_shared.py`, `llm/router.py`, `SeoAuditEngine`, `UserRole`, `test_agent_tool_governance.py`, `validate_policy_text`, `test_catalogue_probe.py`, `BrainWatchdog`, `test_knowledge_sync.py`, `AgentJobManager`, `PrimeAgentAdapter`, `ChatHistoryStore`, `Agency`, `test_openclaw_endpoints.py`, `models/company_graph.py`, `AgentSwarm`, `model_router.py`, `ResearchTask`, `test_provider_router.py`, `TestClient`, `test_procedural_memory.py`, `CEOLedger`, `SQLiteStore`, `test_startup_warmup.py`, `TokenBudget`, `get_ceo_dispatcher`, `test_autonomy_status.py`, `SchedulerStore`, `test_gh_brain_failover.py`, `test_llm_router_tpm.py`, `test_local_brain_state.py`, `test_phase5_doctor.py`, `direct_chat.py`, `test_refresh_agent_built_proof.py`, `TestHarnessAdapter`, `gateway.py`, `services/background.py`, `get_runtime_manager`, `test_iteration_6_features.py`, `cost_tracker.py`, `test_sam_voice.py`, `test_context_rulebook.py`, `ArtifactStore`, `test_trend_scoping.py`, `KeyStore`, `TestRuntimeControl`, `run_task`, `e2e/test_browser.py`, `_step`, `BackgroundAgent`, `test_issue_intake.py`, `test_trend_watcher.py`, `ai/router.py`, `claim`, `persist_plan_spec`, `TestEstimateTokensForMessages`, `MCPClient`, `test_daily_2026_07_27.py`, `FeatureMaturity`, `TestAuthAndTaskOwnership`, `test_openclaw_gateway.py`, `test_telegram_webhook.py`, `TestRouterIntegration`, `NotificationDispatcher`, `OllamaCircuitBreaker`, `_job_text`, `test_e2b_data_flow.py`, `test_new_features_e2e.py`, `test_features_api.py`, `test_video_transcript.py`, `TrendWatcher`, `test_agent_free_brain.py`, `test_doctor_coding_brain.py`, `_Budget`, `test_process_quick_note_workflow.py`, `test_portfolio_intake.py`, `test_colibri_brain_shim.py`, `TestAgentRunnerSafety`, `test_provider_state_durability.py`, `test_skill_registry_boot_refresh.py`, `TestClient`, `test_claude_code_adapter.py`, `ContextPruner`, `test_ceo_router.py`, `test_brain_failover.py`, `test_doctor_service_token_check.py`, `TestMongoGate`, `test_agile_api.py`, `test_app_settings.py`, `test_persistent_memory.py`, `SecurityScanner`, `WorkflowBuildRequest`, `test_llm_router_e2e.py`, `_start_ceo_agency`, `test_task_clarification.py`, `TestSwarmRoleRouting`, `.record`, `OutputFilter`, `test_tasks_awaiting_approval_api.py`, `test_platform_controls.py`, `test_rate_limiter.py`, `OrchestratorQueue`, `ExecutionRequest`, `test_task_store_fails_loud_in_production.py`, `TestNormalizeResponseFormat`, `session_retro.py`, `test_purge_backlog.py`, `SeoFixer`, `analyze_page`, `get_scheduler`, `get_store`, `test_webui_provider_priority.py`, `test_agent_scripts_share_one_model_list.py`, `test_crispy_burn_in.py`, `test_nvidia_model_discovery.py`, `test_kimi_bridge_server.py`, `routed`, `isolated_telegram_config`, `test_scheduler_hydration_bounded.py`, `parse_event_stream`, `test_telegram_approval_e2e.py`, `test_provider_enable_disable.py`, `_undeclared`, `api_keys_for`, `_clean_phases`, `test_service_token.py`, `test_harness_spec.py`, `reset_cache`, `_mock_provider_records`, `_clean_director`, `sam`, `test_regression.py`, `test_agency_fix.py`, `_Recorder`, `test_dashboard_cache.py`, `OrchestratorCheckpointStore`, `test_monitor_lib.py`, `test_v4_api.py`, `classify_direct_chat_intent`, `test_task_service_failed_comment.py`, `test_telegram_diag_endpoint.py`, `_Recorder`, `nvidia_models.py`, `test_ping.py`, `test_runtimes_health_endpoint.py`, `capture_screens.py`, `test_brain_failover_413.py`, `test_voice_pipeline.py`, `client`?**
  _High betweenness centrality (0.102) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `proxy.py`, `enforcement.py`, `ReactScratchpad`, `TaskSpec`, `FreeBuffAgent`, `ContextManager`, `WorkflowRun`, `E2BSandboxSession`, `AutonomyTracker`, `PolicyEngine`, `MCPClient`, `CEODispatcher`, `test_failover_client_shared.py`, `StuckDetector`, `test_agent_tool_governance.py`, `AgentSessionStore`, `BrainFailoverExhausted`, `InternalAgentAdapter`, `test_empirical_verify.py`, `LocalWorkspace`, `MultiAgentSwarm`, `AgentJobManager`, `test_daily_automation_2026_07_11.py`, `WorkspaceTools`, `Agency`, `loop.py`, `test_agent_free_brain.py`, `backend/server.py`, `.execute`, `TestAgentRunnerSafety`, `test_brain_failover_413.py`, `UserMemoryStore`, `TokenBudget`, `get_ceo_dispatcher`, `test_governance_api.py`, `workflow_orchestrator.py`, `direct_chat.py`, `get_runtime_manager`, `AdaptiveHalter`, `ContextPruner`, `GitHubTools`, `TestAgentLoopMCPIntegration`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderRouter` to `test_all_providers_discovery.py`, `_payload`, `implement_agent.py`, `test_chat_mode_regressions.py`, `ai/router.py`, `failover_client.py`, `test_bedrock_live.py`, `TestOpenAiToBedrockConverse`, `TestRouterIntegration`, `settings.py`, `kimi_bridge_provider_config`, `TestLegacyRouterCacheTTL`, `is_anthropic_base_url`, `test_anthropic_refusal_fallback.py`, `test_provider_router.py`, `backend/server.py`, `test_colibri_brain_shim.py`, `test_implement_agent_routing.py`, `TestAnthropicPayloadStructuredOutput`, `direct_chat.py`, `ProviderConfig`, `TrafficDirector`?**
