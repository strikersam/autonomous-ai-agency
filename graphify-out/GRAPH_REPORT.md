...
## Communities (1340 total, 131 thin omitted)

### Community 0 - "backend/server.py"
Cohesion: 0.02
Nodes (297): admin_seed(), AgentStatusEntry, AgentStatusResponse, AgentToolCallEntry, ApiKeyCreate, auth_me(), AuthorizeReposBody, auto_recommend_skills() (+289 more)

### Community 1 - "company_api.py"
Cohesion: 0.02
Nodes (190): account_lifecycle(), AccountLifecycleResponse, auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint(), _DoctorCheck, _DoctorReport (+182 more)
...
Cohesion: 0.03
Nodes (106): _load(), main(), Scheduled portfolio intelligence sweep. Run by `.github/workflows/portfolio-…, int, get_budget(), The process-wide budget tracker., get_cache(), The process-wide cache manager. (+98 more)

### Community 4 - "proxy.py"
Cohesion: 0.03
Nodes (169): get_skill_registry_safe(), Return the global SkillRegistry if set, else None. Used by onboarding and other…, middleware, admin_control(), admin_create_key(), admin_create_user(), admin_delete_user(), admin_list_users() (+161 more)

### Community 5 - "test_ceo_dispatcher.py"
Cohesion: 0.04
Nodes (106): get_ceo_dispatcher(), _merge_changed_files(), Return the shared CEODispatcher singleton., Reset the singleton (test helper)., Collect changed_files across all specialists into a single de-duped list., reset_ceo_dispatcher(), BoundContext, ClassifyOutput (+98 more)

### Community 6 - "TaskSpec"
Cohesion: 0.03
Nodes (107): kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, AiderAdapter, TaskResult, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Run aider non-interactively via `--message` flag., Adapter for Aider — TIER 3 specialized git-aware code editor., json_safe() (+99 more)
...
Cohesion: 0.05
Nodes (67): count, HealthConfig, Strategy selection and degradation behaviour., Circuit breaker + health tracking thresholds., RoutingConfig, HealthTracker, _Outcome, ProviderHealth (+59 more)

### Community 10 - "TaskExecutionCoordinator"
Cohesion: 0.07
Nodes (36): _gate_outward_facing_enabled(), _is_brain_connection_error(), Any, BaseException, TaskSpec, One-line human explanation of why this task needs human approval. Reads risk…, Best-effort label of who will run this task once approved. Returns…, PUBLIC_URL-anchored dashboard deep link for the task detail. Returns empty… (+28 more)

### Community 11 - "BrainConfig"
Cohesion: 0.03
Nodes (97): _migrate_brain_to_safe_default(), BrainConfig, BrainConfigPatch, BrainConfigStore, default_brain_config(), get_brain_config(), get_brain_config_store(), BaseModel (+89 more)
...
### Community 13 - "test_agent_runner.py"
Cohesion: 0.04
...
### Community 14 - "Task"
Cohesion: 0.03
Nodes (105): Task, Helpers that turn scheduler and playbook activity into real tasks., Creates tasks from scheduler and playbook runs using one workflow., TaskAutomationService, ApprovalCheckpoint, Full task/issue document., Human approval gate in a task's execution., Task (+97 more)

### Community 15 - "test_ceo_micromanager.py"
Cohesion: 0.04
...
### Community 17 - "agency.py"
Cohesion: 0.05
Nodes (46): AgencyCycleResult, AgentDirective, AgentRole, _build_ceo_prompt(), _build_quick_note_instruction(), _close_github_issue(), _collect_recent_git_context(), _company_advisory_context() (+38 more)

### Community 18 - "ProviderConfig"
Cohesion: 0.05
Nodes (59): _dead_model_key(), _exponential_backoff_cooldown(), _get_director(), is_commercial_provider(), _mark_model_dead(), _normalized_provider_type(), _notify_watchdog(), _ollama_reasoning_effort() (+51 more)
...
### Community 20 - "test_user_research_skill.py"
Cohesion: 0.04
Nodes (63): analyze_qualitative(), analyze_quantitative(), _classify_sentiment(), _extract_keywords(), plan_research(), Any, BaseModel, field_validator (+55 more)

### Community 21 - "SQLiteStore"
Cohesion: 0.03
Nodes (44): Create a new company in SQLite., Update a company in SQLite., Delete a company and all associated data from SQLite., List companies from SQLite., Count total companies in SQLite., Reconstruct a Website from a SQLite row, preferring the full JSON blob (which…, Create a new website in SQLite. The full model is stored in ``data`` so scan…, Get a website by ID from SQLite. (+36 more)

### Community 22 - "WebsiteScanner"
Cohesion: 0.02
Nodes (124): DetectedSystem, Evidence, Result of a website scan with detected systems and stack inference., Evidence supporting a system detection., A business system detected on a company's website or in their stack., Get the most confident evidence description., Inferred technology stack from website/repo analysis., StackInference (+116 more)

### Community 23 - "SelfHealingAgent"
Cohesion: 0.04
Nodes (81): get_improvement_loop(), FailureCategory, get_self_healing_agent(), HealingEvent, _now(), Any, Enum, agent/self_healing.py — Self-Healing Agent (closed-loop, Autonomy Charter G2)… (+73 more)

### Community 24 - "TrafficDirector"
Cohesion: 0.08
...
### Community 25 - "PolicyEngine"
Cohesion: 0.04
Nodes (87): _egress_policy_reason(), Return why governance policy blocks *host*, or None. Runs strictly *after* the…, _action_matches(), _as_list(), Decision, GroupPolicy, _host_matches(), Mode (+79 more)

### Community 26 - "WorkflowRun"
Cohesion: 0.04
Nodes (45): MergeDecision, _NoopStore, Any, Approve a run paused at the ApprovalGate. The caller must re-invoke…, Inject additional instructions into an in-flight run (no state change). Backs…, Push a Telegram approval-gate notification when a run pauses (Charter G1).…, G5: resolve how a run should land from the company's DeliveryPolicy. Returns…, Persist first-merge consent once an operator approves a ``telegram_gate``. No-… (+37 more)

### Community 27 - "_fixture"
Cohesion: 0.01
Nodes (107): Reset the singleton (for tests)., reset_failover_manager(), base_url(), mobile_page(), proxy_url(), Config, pytest_configure(), conftest.py — pytest fixtures and configuration for the E2E test suite.… (+99 more)

### Community 28 - "MultiAgentSwarm"
Cohesion: 0.04
...
### Community 31 - "TaskStore"
Cohesion: 0.03
Nodes (85): Background dispatcher for task execution., tasks — Task/issue management system. Provides a lightweight task/issue tracker…, _coerce_ts(), Enum, str, tasks/models.py — Pydantic models for the task/issue system., Coerce ISO-8601 datetime strings (from DB) to float timestamps., Comment or reply on a task. (+77 more)

### Community 32 - "test_sam_livekit.py"
Cohesion: 0.06
...
### Community 33 - "AgentSwarm"
Cohesion: 0.06
Nodes (41): AgentRole, AgentProfile, Immutable description of a CRISPY agent role. Attributes ---------- role: The…, AgentSwarm, Path, agents/swarm.py — AgentSwarm: routes workflow phases to the correct agent. The…, Return the agent role responsible for *phase*., Return the AgentProfile for the agent driving *phase*. (+33 more)

### Community 34 - "test_web_reach.py"
Cohesion: 0.06
Nodes (55): _domain_list_reason(), _domain_matches(), _parse_domain_list(), Return True if *host* is *pattern* or a subdomain of it., Split a comma-separated env var into a normalised domain list., Return why the env-var domain policy blocks *host*, or None. Checks…, Zero-key internet access: pages, YouTube transcripts, search, RSS. Every public…, WebReach (+47 more)

### Community 35 - "_scanner"
Cohesion: 0.03
Nodes (34): _is_blocked_host(), Cheap (no-DNS) SSRF check for headless-browser subrequests. A rendered page's…, _guard(), A repeated key in a dict literal is silent: the later value wins. Found on…, TestTheCostTableHasNoDuplicateKeys, Tests for the scanner's headless-render fallback (JS-rendered / bot-protected…, The scan flow must invoke the render fallback when static detection is empty…, BuiltWith-style off-site identification: a CNAME chain that points at a known… (+26 more)
...
### Community 37 - "test_governance_enforcement.py"
Cohesion: 0.03
Nodes (92): ApprovalRequest, ApprovalStatus, ApprovalStore, Any, Enum, str, packages/governance/approvals.py — human-in-the-loop for high-risk actions. The…, Bounded, in-process store of approval requests. Uses a :class:`threading.Lock`… (+84 more)

### Community 38 - "CEOSupervisor"
Cohesion: 0.06
Nodes (42): build_ceo_router(), ceo_status(), get_goal(), list_goals(), redrive_goal(), run_sweep(), Any, APIRouter (+34 more)

### Community 39 - "get_runtime_manager"
Cohesion: 0.05
...
### Community 41 - "Agency"
Cohesion: 0.04
Nodes (95): Agency, get_agency(), CEO-coordinated multi-agent agency for continuous codebase management. The CEO…, set_agency(), DetectedIssue, ImprovementLoop, ImprovementLoopState, IssueCategory (+87 more)

### Community 42 - "test_llm_router_resilience.py"
Cohesion: 0.04
Nodes (66): Backoff policy for retryable failures., RetryConfig, BreakerState, str, _digest(), get_ring(), KeyRing, KeyState (+58 more)

### Community 43 - "enforcement.py"
Cohesion: 0.06
Nodes (43): Feed LLM token/cost spend into the governance session budget. Kept separate…, BudgetExceeded, classify(), evaluate_call(), governance_enabled(), guard_tool_call(), GuardResult, _host_of() (+35 more)
...
### Community 45 - "test_unit8_model_catalog.py"
Cohesion: 0.04
Nodes (74): all_provider_ids(), provider_key_present(), Return every provider id recognised by the brain config system. Iterates the…, True when the env var for *provider*'s key is set (or it's Ollama)., CatalogActiveBrain, CatalogMirror, CatalogProviderEntry, get_catalog() (+66 more)
...
### Community 48 - "test_agent_tool_governance.py"
Cohesion: 0.08
...
Cohesion: 0.03
Nodes (46): BusinessCategory, Find a website by its URL., A company website with detected systems and stack inference., Website, CompanyGraphService, Company, SpecialistFamily, SystemType (+38 more)
...
### Community 55 - "get_user_role"
Cohesion: 0.05
Nodes (62): get_user_role(), str, Extract role from a user object (dict or Pydantic model)., UserRole, _can_read(), _can_write(), create_secret(), _decrypt() (+54 more)
...
### Community 60 - "call_llm"
Cohesion: 0.03
Nodes (56): _agent_provider_failure_response(), _agent_timeout_fallback_response(), _append_agent_session_message(), _build_auto_skill_guidance(), _build_direct_chat_schedule_suggestion(), _build_direct_chat_tags(), _build_direct_chat_task_suggestion(), _build_provider_router() (+48 more)

### Community 61 - "KeyPool"
Cohesion: 0.04
...
Cohesion: 0.06
Nodes (41): CEODispatcher, _runner_factory(), CEOResult, _complexity_rank(), _offload(), Any, services/ceo_dispatcher.py — Real CEO delegation layer. The CEO splits a…, Run a synchronous ledger call without blocking the event loop. ``CEOLedger`` is… (+33 more)

### Community 65 - "AgentRunner"
Cohesion: 0.03
Nodes (72): AgentRunner, Path, Governance seam: judge the call, run it, audit the outcome. Deliberately a thin…, Append an event to the durable session log if a store is wired in., Summarise a long history and compact it. Asks the planner model to write a…, Send chat messages and return the assistant's text output. If an…, Call-time resolver for an agent role model id. Delegates to…, Parse an LLM tool-call response, tolerating common malformations. Handles: 1.… (+64 more)
...
### Community 68 - "loop.py"
Cohesion: 0.06
Nodes (37): Agent subsystem — planner / executor / verifier loop., loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., # NOTE: "ollama_base" is kept for backwards compatibility; this runner only…, AgentEvent, AgentRunRequest, AgentSession, AgentSessionCreateRequest, AgentSessionMessage (+29 more)
...
### Community 72 - "resolve_active_brain"
Cohesion: 0.04
...
### Community 75 - "WorkflowRun"
Cohesion: 0.06
Nodes (33): _fake_artifact(), _make_engine(), tests/test_crispy_workflow.py — CRISPY workflow engine hardening tests. Tests…, Provide isolated DB + artifact + workspace paths., Create a WorkflowEngine with isolated storage., TestAbortOnFailure, _test(), _tracking_run_single() (+25 more)

### Community 76 - "setup/api.py"
Cohesion: 0.07
...
Cohesion: 0.04
Nodes (54): _acquire_provider_probe(), _normalize_nvidia_base_url(), _openai_url(), Try to acquire a distributed probe lock for *provider_id*. Returns True if this…, Release the probe lock for *provider_id*., Normalize NVIDIA base URLs to avoid double /v1 when openai_compat_url appends…, _release_provider_probe(), _nvidia_provider_chain() (+46 more)

### Community 81 - "AgentPlan"
Cohesion: 0.04
Nodes (47): PreflightIssue, PreflightReport, BaseModel, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, AgentPlan, AgentStep, _fake_user(), _FakeChatResult (+39 more)

### Community 82 - "seo_api.py"
Cohesion: 0.07
...
### Community 84 - "build_governance_router"
Cohesion: 0.04
...
### Community 92 - "register_webui"
Cohesion: 0.06
Nodes (53): allow_paid_brain(), True only when the operator explicitly opted into a paid (Anthropic) brain.…, test_allow_paid_brain_default_false(), test_allow_paid_brain_opt_in(), Any, Path, run_command(), _safe_allowlist() (+45 more)

### Community 93 - "ProviderRouter"
Cohesion: 0.06
Nodes (24): ProviderRouter, Parse a 429/503 ``Retry-After`` header → seconds, or None. Accepts either…, Translate an OpenAI chat/completions payload to Bedrock Converse format., Translate a Bedrock Converse API response to OpenAI chat.completion format., Priority-ordered LLM provider fallback with health checks and retries., main(), probe_one(), Live probe — makes a tiny real API call to every configured provider. Usage (in… (+16 more)

### Community 94 - "test_mcp_registry.py"
Cohesion: 0.05
...
### Community 95 - "RuntimeCapabilityRegistry"
Cohesion: 0.06
Nodes (18): Return the single best adapter for *task_type*. If *preferred_runtime_id* is…, Maintains the catalogue of registered adapters and answers 'which runtimes can…, Return all adapters that can handle *task_type*, ordered by tier., RuntimeCapabilityRegistry, Admin-configurable routing policy. Defaults are conservative (local-first, no…, RoutingPolicy, TaskSpec, Tests for _start_local_runtime safety guards in runtimes/control.py. (+10 more)

### Community 96 - "ProbeResult"
Cohesion: 0.07
Nodes (34): _probe_ollama(), ProbeResult, BaseModel, Probe local Ollama via GET /api/tags (cheap) then a 5-token completion., Outcome of a single (provider, model) liveness probe., _catalogue_candidates(), _catalogue_role_preset(), _catalogue_safe_default() (+26 more)
...
### Community 102 - "PersistentMemoryStore"
Cohesion: 0.07
...
### Community 107 - "brain_config.py"
Cohesion: 0.03
Nodes (93): _active_primary_provider(), _build_base_url_env_from_yaml(), _build_candidates_from_yaml(), _build_default_base_url_from_yaml(), _build_display_names_from_yaml(), _build_key_env_from_yaml(), _build_presets_from_yaml(), _build_tier_from_yaml() (+85 more)

### Community 108 - "AnthropicProvider"
Cohesion: 0.05
...
### Community 114 - "AgentJobRequest"
Cohesion: 0.06
Nodes (24): AgentJobError, AgentJobRequest, AgentJobResult, AgentJobSnapshot, Any, BaseModel, field_validator, agent/contract.py — Typed public contract for the agent job lifecycle. Phase 1… (+16 more)
...
### Community 118 - "test_trend_scoping.py"
Cohesion: 0.09
...
### Community 119 - "failover_client.py"
Cohesion: 0.05
...
### Community 125 - "test_runtime_governance.py"
Cohesion: 0.12
Nodes (39): _governance_check(), Evaluate a runtime dispatch against policy; audit it either way. Returns…, _decision(), _engine(), Any, RoutingDecision, TaskSpec, Governance on runtime dispatch — the last coverage gap.… (+31 more)

### Community 126 - "_resolve_brain_provider"
Cohesion: 0.06
Nodes (26): Resolve the LLM endpoint for agent execution (module-level, #522 failover).…, _resolve_brain_provider(), _mock_provider_records(), tests/test_orchestrator_failover.py — Provider failover, brain resolution,…, Non-Ollama providers without an API key are skipped., Ollama-type providers don't need an API key., When _list_configured_provider_records raises, falls back to OLLAMA_BASE., When all configured providers are excluded, falls back to Ollama. (+18 more)
...
Cohesion: 0.05
Nodes (72): _purge_backlog_core(), quick_notes_submit(), _QuickNoteBody, Shared purge implementation for the admin endpoint and the boot hook., Submit a quick-note URL or instruction from the dashboard FAB., Path, Start RuntimeManager, TaskDispatcher, SCHEDULER, and self-bootstrap. Returns a…, start_background_services() (+64 more)

### Community 129 - "pr_approval_gate.py"
Cohesion: 0.06
...
### Community 131 - "test_sqlite_store.py"
Cohesion: 0.06
...
Cohesion: 0.08
Nodes (37): generate_standup(), Build a :class:`StandupReport` from ``.claude/state/active-tasks.md``. Reads…, _bug_scores(), _clean(), _default_repo(), _env_github_token(), estimate_job_size(), fetch_github_signals() (+29 more)
...
### Community 134 - "LLMRouter"
Cohesion: 0.03
Nodes (72): Attempt, describe(), The operator-facing reason string for an unfixable status., Read the environment variables named in ``env_names`` into a key list. Order is…, resolve_keys(), LLMRouter, run(), Any (+64 more)

### Community 135 - ".run"
Cohesion: 0.06
Nodes (43): build_spec_router(), approve_spec(), _decide(), get_spec_artifact(), list_spec_artifacts(), reject_spec(), Any, APIRouter (+35 more)

### Community 136 - "frontend/package.json"
Cohesion: 0.04
...
### Community 139 - "test_schedule_growth_invariants.py"
Cohesion: 0.04
...
### Community 142 - "test_response_cache.py"
Cohesion: 0.10
...
### Community 149 - "test_bedrock_provider.py"
Cohesion: 0.06
Nodes (22): _bedrock_api_response(), _bedrock_provider(), _mock_boto3(), Any, asyncio, ProviderConfig, Tests for AWS Bedrock provider support in ProviderRouter., Inject a mock boto3 module into sys.modules for the duration of the block. (+14 more)

### Community 150 - "RuntimeManager"
Cohesion: 0.04
Nodes (26): CircuitState, Return the last-known health for *runtime_id* (may be stale)., Return True if the runtime is available (not circuit-open)., Return health snapshots for all known runtimes., Force an immediate health check of all runtimes and return results., Attempt to start a dead runtime subprocess before re-probing. Uses the local…, Reduce probe frequency for runtimes that have never come online., Async health polling service for all registered runtimes. (+18 more)

### Community 151 - "test_autonomous_agency_e2e.py"
Cohesion: 0.07
...
### Community 163 - "test_webui_provider_priority.py"
Cohesion: 0.10
...
### Community 166 - "TestHarnessAdapter"
Cohesion: 0.04
...
### Community 167 - "PortfolioManager"
Cohesion: 0.05
...
### Community 168 - "ensure_self_company"
Cohesion: 0.06
...
### Community 173 - "NvidiaProvider"
Cohesion: 0.09
Nodes (6): NvidiaProvider, NVIDIA NIM — free LLM provider (meta/llama-3.3-70b-instruct)., OllamaProvider, RateLimit, Provider rate limit info., Return the provider's rate limits.

### Community 174 - "AdminIdentity"
Cohesion: 0.06
...
### Community 176 - "test_telegram_freebuff.py"
Cohesion: 0.07
...
### Community 181 - "test_slop_gate.py"
Cohesion: 0.07
...
### Community 184 - "TestSelfHealingInfrastructureClassification"
Cohesion: 0.05
...
### Community 185 - "admin_digest_router.py"
Cohesion: 0.22
...
### Community 187 - "ProvidersScreen.jsx"
Cohesion: 0.05
...
### Community 190 - "test_telegram_auto_approve.py"
Cohesion: 0.21
...
### Community 191 - "test_e2b_data_flow.py"
Cohesion: 0.06
...
### Community 193 - "activation_api.py"
Cohesion: 0.09
...
### Community 196 - "PromptCacheManager"
Cohesion: 0.06
...
### Community 199 - "test_portfolio_intake.py"
Cohesion: 0.08
...
### Community 201 - "test_dashboard_cache.py"
Cohesion: 0.06
Nodes (32): _cached(), _check_storage_health(), cost_attribution_stats(), doctor_health(), _fast_count(), get_active_provider(), get_stats(), health() (+24 more)

### Community 202 - "test_classify_dependabot_update.py"
Cohesion: 0.07
...
### Community 203 - "compare_runtimes.py"
Cohesion: 0.06
...
### Community 204 - "test_executive_advisory.py"
Cohesion: 0.09
...
### Community 205 - "FreeBuffAgent"
Cohesion: 0.05
Nodes (44): _check_extra_kwargs(), _enforce_signature(), free_nvidia_models(), FreeBuffAgent, _nvidia_api_key(), Any, Raise TypeError if fn's signature drifts from the locked contract (Pydantic…, Raise TypeError on unknown kwarg (runtime extra='forbid' for non-Pydantic… (+36 more)

### Community 206 - "ScheduleStore"
Cohesion: 0.06
...
### Community 207 - "test_unit5_ui_provider_surface.py"
Cohesion: 0.10
...
### Community 209 - "BrainFailoverExhausted"
Cohesion: 0.06
...
### Community 212 - "portfolio_api.py"
Cohesion: 0.08
...
### Community 213 - "Part A — CodeRabbit review fixes for this PR (do first, small)"
Cohesion: 0.05
...
### Community 214 - "Docker Agent Runtimes Setup"
Cohesion: 0.05
...
### Community 215 - "TaskBoardScreen.jsx"
Cohesion: 0.06
...
### Community 216 - "anthropic_compat.py"
Cohesion: 0.09
...
### Community 217 - "resolve_component_model"
Cohesion: 0.07
...
### Community 218 - "model_router.py"
Cohesion: 0.06
Nodes (39): _build_builtin_model_map(), _default_model(), _default_reasoning_model(), _nvidia_key_present(), Dynamic model router. Central routing logic for all chat and agent requests.…, Build the built-in alias table — Nvidia NIM models when key is set, local…, Resolve the default executor model via the catalog (UNIT 7). Was a hardcoded…, Resolve the default planner (reasoning) model via the catalog (UNIT 7). (+31 more)
...
### Community 222 - "get_failover_manager"
Cohesion: 0.08
...
### Community 223 - "facade.py"
Cohesion: 0.07
Nodes (39): create_refresh_token(), create_access_token(), create_refresh_token(), get_current_user(), get_optional_user(), github_exchange_code(), github_fetch_user(), google_exchange_code() (+31 more)
...
### Community 225 - "Persistent Memory System"
Cohesion: 0.05
...
### Community 226 - "test_agent_free_brain.py"
Cohesion: 0.09
...
### Community 239 - "cost_tracker.py"
Cohesion: 0.05
Nodes (21): _build_cost_table(), clear_stats(), cost_for_tokens(), get_stats(), _load_env_overrides(), Any, Per-model cost attribution for the LLM provider router. Maintains in-memory…, Parse MODEL_COST_INPUT / MODEL_COST_OUTPUT env overrides. Format:… (+13 more)

### Community 240 - "test_purge_backlog.py"
Cohesion: 0.07
Nodes (22): auth_headers(), FakeTaskStore, MonkeyPatch, Task, tests/test_purge_backlog.py — 2026-07-03 crash-loop remediation. Covers: - POST…, Drive _maybe_boot_purge with fakes; return (purged, marker_writes). ``core``…, A failed purge must NOT record the nonce — it retries next boot., A PARTIAL purge (error markers inside the summary) must not record the nonce… (+14 more)

### Community 241 - "LlmProviderConfig"
Cohesion: 0.13
...
### Community 242 - "TestEstimateTokensForMessages"
Cohesion: 0.05
...
### Community 243 - "test_governance_api.py"
Cohesion: 0.10
...
### Community 245 - "test_pr923_fixes.py"
Cohesion: 0.07
...
### Community 258 - "test_brain_availability_doctor.py"
Cohesion: 0.10
...
### Community 262 - "KnowledgeScreen.jsx"
Cohesion: 0.06
...
### Community 266 - "test_brain_failover.py"
Cohesion: 0.05
...
### Community 271 - "test_chat_mode_regressions.py"
Cohesion: 0.09
...
### Community 273 - "test_runtimes_health_endpoint.py"
Cohesion: 0.25
...
### Community 274 - "AgentDefinition"
Cohesion: 0.05
Nodes (54): AgentDefinition, AgentStore, Any, field_validator, agents/store.py — Persistent store for user-defined agent configurations.…, CRUD store for AgentDefinition objects. Uses MongoDB when a `db` client is…, Return an agent by ID. If *owner_id* is provided, enforces that the agent…, Delete an agent. Returns True on success, False if not found/unauthorised. (+46 more)
...
### Community 278 - "sam_livekit_worker.py"
Cohesion: 0.10
...
### Community 279 - "test_operational_incidents.py"
Cohesion: 0.02
...
### Community 282 - "AuditLog"
Cohesion: 0.04
Nodes (69): Replace the process-wide store. Tests only., reset_approval_store(), AuditEvent, AuditLog, get_audit_log(), packages/governance/audit.py — the evidence trail for every governed action.…, Redact SSNs and Luhn-valid payment-card numbers from a string. Runs after the…, Redact secret-shaped substrings, then truncate. (+61 more)

### Community 283 - "local_controller.py"
Cohesion: 0.12
...
### Community 285 - "test_all_providers_discovery.py"
Cohesion: 0.17
...
### Community 286 - "test_nvidia_model_discovery.py"
Cohesion: 0.06
...
### Community 289 - "test_brain_priority_scanner.py"
Cohesion: 0.09
...
### Community 290 - "Configuration Reference"
Cohesion: 0.06
...
### Community 298 - "test_provider_enable_disable.py"
Cohesion: 0.07
...
### Community 299 - "test_render_mcp.py"
Cohesion: 0.10
...
### Community 304 - "tests/conftest.py"
Cohesion: 0.05
...
### Community 306 - "get_skill_bindings"
Cohesion: 0.10
Nodes (24): get_skill(), Get a single skill by its ID., build_matrix(), _families(), main(), Any, scripts/generate_specialist_skill_matrix.py — Specialist × Skill matrix.…, Map family -> sorted list of test files that mention it (quoted token). (+16 more)

### Community 307 - "web_reach.py"
Cohesion: 0.05
Nodes (37): _load_script_module(), Any, ModuleType, agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Dynamically load a pure-stdlib helper module from .github/scripts/. Returns…, Read a web page as plain text, following the same fallback chain (direct ->…, GET *url*, re-validating every redirect hop against ``unsafe_target_reason`` —…, httpx-only fallback used when the .github/scripts helpers can't be loaded (e.g.… (+29 more)

### Community 308 - "test_provider_render_env.py"
Cohesion: 0.09
...
### Community 310 - "load_all_profiles"
Cohesion: 0.13
Nodes (20): agents/__init__.py — CRISPY multi-agent coding system., _catalog_defaults(), _catalog_provider(), _get_defaults(), load_all_profiles(), make_architect_profile(), make_coder_profile(), make_reviewer_profile() (+12 more)

### Community 311 - "test_microagents.py"
Cohesion: 0.15
...
### Community 313 - "Security Analysis — local-llm-server"
Cohesion: 0.06
...
### Community 316 - "autonomous_fix.py"
Cohesion: 0.10
...
### Community 320 - "test_telegram_mutating_commands.py"
Cohesion: 0.09
...
### Community 321 - "test_workspace_isolation.py"
Cohesion: 0.17
...
### Community 325 - "High-Agency Frontend Skill"
Cohesion: 0.06
Nodes (30): 10. FINAL PRE-FLIGHT CHECK, 1. ACTIVE BASELINE CONFIGURATION, 2. DEFAULT ARCHITECTURE & CONVENTIONS, 3. DESIGN ENGINEERING DIRECTIVES (Bias Correction), 4. CREATIVE PROACTIVITY (Anti-Slop Implementation), 5. PERFORMANCE GUARDRAILS, 6. TECHNICAL REFERENCE (Dial Definitions), 7. AI TELLS (Forbidden Patterns) (+22 more)

### Community 326 - "TestNormalizeResponseFormat"
Cohesion: 0.11
...
### Community 327 - "Quick-Note GitHub Issues Processing - Session Summary"
Cohesion: 0.06
...
### Community 329 - "test_platform_controls.py"
Cohesion: 0.09
...
### Community 332 - "test_session_retro.py"
Cohesion: 0.13
...
### Community 337 - "_ensure_tasks_source_id_unique_index"
Cohesion: 0.11
...
### Community 338 - "output_filter.py"
Cohesion: 0.07
...
### Community 339 - "control_overrides.py"
Cohesion: 0.09
...
### Community 341 - "test_colibri_provider.py"
Cohesion: 0.12
...
Cohesion: 0.05
Nodes (72): brain_providers(), Every configured provider with its health AND its on/off state. Powers the…, auto_disable(), _billing_signals(), disabled_provider_ids(), is_unfixable(), packages/llm/disabled.py — bridge to the durable provider on/off switch. The…, Provider ids currently switched off. Empty when the store is unreachable. (+64 more)

### Community 344 - "TaskDispatcher"
Cohesion: 0.08
...
### Community 346 - "test_force_cleanup_conditional_delete.py"
Cohesion: 0.10
...
### Community 347 - "test_autonomy_gate.py"
Cohesion: 0.13
...
### Community 349 - "_execute_skill_impl"
Cohesion: 0.10
...
### Community 357 - "test_claude_setup_audit.py"
Cohesion: 0.16
...
### Community 359 - "test_provider_state_durability.py"
Cohesion: 0.05
Nodes (17): fake_mongo(), _FakeCollection, _FakeDb, isolated_state(), _live_mongo_url(), Operator provider state must survive a redeploy. The per-provider kill switch…, Tests must never mutate a shared operational store., The storage layer's localhost default is a placeholder, not config. Treating it… (+9 more)

### Community 360 - "_process_task_callback"
Cohesion: 0.20
...
### Community 361 - "isolated_telegram_config"
Cohesion: 0.10
...
### Community 362 - "WorkflowBuildRequest"
Cohesion: 0.06
Nodes (38): engine(), WorkflowEngine, Contract: WorkflowEngine cannot skip the gate state machine., Contract: No code path may advance past awaiting_approval unless gate.status ==…, Create a run and manually place it in awaiting_approval., Contract: Cannot approve a run in 'pending' state., Contract: Can approve a run in 'awaiting_approval' state., Contract: Rejecting a run marks it as failed. (+30 more)
...
### Community 374 - "probe_model_liveness"
Cohesion: 0.06
Nodes (36): _describe_http_status(), _is_dns_failure(), _probe_failure_reason(), probe_model_liveness(), _probe_openai_compat(), BaseException, services/brain_liveness.py — Provider liveness prober for the brain switcher.…, Turn a probe exception into an operator-actionable one-line reason. A dead… (+28 more)
...
### Community 376 - "skill_bindings.py"
Cohesion: 0.09
...
### Community 384 - "test_doctor_coding_brain.py"
Cohesion: 0.32
...
Cohesion: 0.10
Nodes (28): build_render_router(), render_deploys(), render_health(), render_logs(), render_metrics(), render_ops_scan(), render_ops_status(), render_services() (+20 more)

### Community 386 - "Deploy: FreeBuff Telegram bot (24×7)"
Cohesion: 0.07
...
### Community 387 - "Claude Code + Qwen Local Setup"
Cohesion: 0.07
...
### Community 391 - "executive_advisory_api.py"
Cohesion: 0.11
...
### Community 392 - "get_tool_registry"
Cohesion: 0.08
Nodes (13): get_tool_registry(), Return the module-level ToolRegistry singleton. On first call, registers built-…, Register the built-in agent tools that are always available., Register the Web Reach capability (agent/web_reach.py): zero-key internet…, _register_builtin_tools(), _register_web_reach_tools(), auto_register(), Register the user research tools into the module-level singleton registry.… (+5 more)

### Community 393 - "VoiceCommandInterface"
Cohesion: 0.14
...
### Community 394 - "Performance Analysis — local-llm-server"
Cohesion: 0.08
...
### Community 395 - "LLM Router — troubleshooting"
Cohesion: 0.08
...
### Community 396 - "test_agent_chat_integration.py"
Cohesion: 0.13
...
### Community 406 - "TestStreamableHTTPTransport"
Cohesion: 0.12
...
### Community 410 - "Session Handoff — 2026-06-15"
Cohesion: 0.08
...
### Community 411 - "TASK 4 — End-to-end approval-gate test"
Cohesion: 0.08
...
### Community 412 - "implement_agent.py"
Cohesion: 0.12
...
### Community 414 - "test_agent_readiness_audit.py"
Cohesion: 0.18
...
### Community 417 - "CompanyAgencyService"
Cohesion: 0.09
...
### Community 418 - "NIMConnectionPool"
Cohesion: 0.11
...
### Community 419 - "OrchestratorCheckpointStore"
Cohesion: 0.09
...
### Community 424 - "test_service_token.py"
Cohesion: 0.08
...
### Community 425 - "test_telegram_diag_endpoint.py"
Cohesion: 0.08
...
### Community 428 - "test_harness_spec.py"
Cohesion: 0.12
...
### Community 429 - "TestTelegramNotifications"
Cohesion: 0.40
...
### Community 431 - "Local AI Stack with Docker"
Cohesion: 0.08
...
### Community 432 - "Implementation Prompt: Rich TaskBoard + Agile Sprint Integration"
Cohesion: 0.08
...
### Community 433 - "Telegram Bot Setup"
Cohesion: 0.08
...
### Community 435 - "Native operations"
Cohesion: 0.09
...
### Community 436 - "test_phase4_runtime_resilience.py"
Cohesion: 0.13
...
### Community 439 - "test_task_source_id_race.py"
Cohesion: 0.12
...
### Community 440 - "test_all_features.py"
Cohesion: 0.08
...
### Community 442 - "register_admin_gui"
Cohesion: 0.18
...
### Community 444 - "_status_snapshot"
Cohesion: 0.15
...
### Community 445 - "build_platform_controls_router"
Cohesion: 0.15
...
### Community 446 - "openclaw_str_e_fix.py"
Cohesion: 0.15
...
### Community 447 - "Agent Governance Guide"
Cohesion: 0.09
...
### Community 448 - "The fifteen strategies"
Cohesion: 0.09
...
### Community 451 - "SeoCheckDefinition"
Cohesion: 0.12
...
### Community 453 - "test_memory_guard.py"
Cohesion: 0.13
...
### Community 455 - "SyntheticDataPipeline"
Cohesion: 0.13
...
### Community 462 - "HarnessEnrichment"
Cohesion: 0.14
...
### Community 464 - "AdaptivePermissions"
Cohesion: 0.18
...
### Community 465 - "test_prompt_injection_boundary.py"
Cohesion: 0.15
...
### Community 469 - "model_discovery.py"
Cohesion: 0.12
...
### Community 471 - "TestAdapterMetadata"
Cohesion: 0.05
...
### Community 473 - "TestLegacyRouterCacheTTL"
Cohesion: 0.13
...
### Community 474 - "test_anthropic_refusal_fallback.py"
Cohesion: 0.19
...
### Community 479 - "OrchestratorSupervisor"
Cohesion: 0.11
...
### Community 480 - "traffic_director.py"
Cohesion: 0.11
...
### Community 481 - ".on_task_complete"
Cohesion: 0.11
...
### Community 482 - "test_local_controller.py"
Cohesion: 0.14
...
### Community 484 - "provider_max_rpm"
Cohesion: 0.13
...
### Community 486 - "test_voice_pipeline.py"
Cohesion: 0.13
...
### Community 489 - "Design Audit"
Cohesion: 0.10
Nodes (19): Code Quality, Color and Surfaces, Component Patterns, Content, Design Audit, Fix Priority, How This Works, Iconography (+11 more)

### Community 490 - "Findings"
Cohesion: 0.10
...
### Community 491 - "test_minimax_bug_fixes.py"
Cohesion: 0.12
...
### Community 495 - "Docker AI Governance Audit — Final Report"
Cohesion: 0.10
...
### Community 496 - "1. Capability-by-capability"
Cohesion: 0.10
...
### Community 498 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 499 - "ControlsScreen.jsx"
Cohesion: 0.15
...
### Community 503 - "ClaudeCodeAdapter"
Cohesion: 0.22
...
### Community 506 - "test_provider_410_per_model.py"
Cohesion: 0.15
Nodes (18): get_dead_models(), _is_model_dead(), Snapshot of active dead-model entries {provider_id/model: expiry_ts}. Also…, Return True if (provider, model) is on the dead list and not yet expired., _nvidia(), anyio, ProviderConfig, Regression tests: 410 Gone is a per-model condition, not per-provider.… (+10 more)
...
### Community 514 - "_extract_tech_relevance"
Cohesion: 0.17
...
### Community 527 - "Admin Dashboard Guide"
Cohesion: 0.11
...
### Community 528 - "Implementation Plan"
Cohesion: 0.11
...
### Community 530 - "scripts/doctor.py"
Cohesion: 0.27
...
### Community 533 - "parse_event_stream"
Cohesion: 0.10
...
### Community 535 - "OrchestratorQueue"
Cohesion: 0.07
...
### Community 537 - "test_self_heal_escalation_message.py"
Cohesion: 0.12
...
### Community 538 - "TestAddConversationCacheBreakpoints"
Cohesion: 0.15
...
### Community 542 - "_FakeRuntimeManager"
Cohesion: 0.11
Nodes (14): _FakeRoutingDecision, _FakeRuntimeManager, _FakeTaskResult, _patch_ceo_with_fake_runtime_manager(), Exception, Mimics RuntimeManager.execute() returning (TaskResult, RoutingDecision)., Patch the internals the CEO touches, returning a stack of mocks., Low complexity should NOT fan out — just one specialist task. (+6 more)
...
### Community 544 - "LLMProvider"
Cohesion: 0.04
Nodes (71): packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, classify_error(), LLMProvider, ABC, Any, AsyncClient, packages/llm/providers/base.py — the provider contract and the generic adapter.…, Parse ``Retry-After`` (and common vendor variants) into seconds. (+63 more)
...
### Community 553 - "Comprehensive Skill Index (By Category)"
Cohesion: 0.11
...
### Community 554 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
...
### Community 557 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
...
### Community 558 - "Platform Guide — the full tour"
Cohesion: 0.03
...
### Community 561 - "WorkflowScreen.jsx"
Cohesion: 0.14
...
### Community 568 - "test_company_api.py"
Cohesion: 0.11
...
### Community 570 - "test_langfuse_agency_wide.py"
Cohesion: 0.10
...
### Community 572 - "test_repowise_intelligence.py"
Cohesion: 0.11
...
### Community 573 - "test_phase5_doctor.py"
Cohesion: 0.11
...
### Community 574 - "TestStopSlopChecker"
Cohesion: 0.11
...
### Community 575 - "test_schedule_persistence.py"
Cohesion: 0.15
...
### Community 579 - "test_agent_tools.py"
Cohesion: 0.19
...
### Community 581 - "cowork_session.py"
Cohesion: 0.15
...
### Community 582 - "SKILL: Industrial Brutalism & Tactical Telemetry UI"
Cohesion: 0.12
...
### Community 583 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 584 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 585 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 586 - "Section-by-Section Acceptance Criteria"
Cohesion: 0.12
...
### Community 594 - "AdminDigestRouterAuthTests"
Cohesion: 0.20
...
### Community 596 - "e2e/test_browser.py"
Cohesion: 0.19
...
### Community 597 - "resolve_free_nvidia_brain"
Cohesion: 0.14
Nodes (16): livenim, Resolve the free NVIDIA NIM brain from env, or ``None`` if unconfigured.…, resolve_free_nvidia_brain(), _live_models(), The free-brain default must be an id the endpoint actually serves. Two…, The ids the catalogue currently vouches for. Derived, not frozen: a hardcoded…, Default must be one of the live NIM namespaced IDs — never the bare name., The module-level copy must not drift from the catalogue's safe default. Was… (+8 more)

### Community 598 - "test_freebuff_bot.py"
Cohesion: 0.11
...
### Community 599 - "test_frontend_deployment_guards.py"
Cohesion: 0.18
...
### Community 600 - "test_health_endpoints.py"
Cohesion: 0.17
...
### Community 601 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 602 - "test_openclaw_endpoints.py"
Cohesion: 0.12
...
### Community 603 - "test_skill_registry.py"
Cohesion: 0.13
...
### Community 604 - "TestRouterIntegration"
Cohesion: 0.21
...
### Community 605 - "hermes_prompt.py"
Cohesion: 0.19
...
### Community 606 - "MemoryMiddleware"
Cohesion: 0.17
...
### Community 607 - "verify_pr_exists"
Cohesion: 0.16
...
### Community 608 - "agent/workspace.py"
Cohesion: 0.05
...
### Community 610 - "Skill: repowise-intelligence"
Cohesion: 0.12
...
### Community 611 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
...
### Community 612 - "Skill: repowise-intelligence"
Cohesion: 0.12
Nodes (15): 1. Graph Intelligence (Dependency Graph), 2. Git Intelligence, 3. Documentation Intelligence, 4. Decision Intelligence, Acceptance Checks, Directory Structure, Example Usage, Implementation Approach (+7 more)

### Community 613 - "The 10-Step Workflow"
Cohesion: 0.12
...
### Community 614 - "Contributing to local-llm-server"
Cohesion: 0.12
...
### Community 615 - "refresh_agent_built_proof.py"
Cohesion: 0.20
...
### Community 616 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 617 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 618 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
...
### Community 619 - "RateLimitTracker"
Cohesion: 0.10
...
### Community 621 - "test_portfolio_intelligence.py"
Cohesion: 0.14
...
### Community 626 - "ManagedAgentDreams"
Cohesion: 0.22
...
### Community 628 - "test_task_brain_preflight.py"
Cohesion: 0.21
...
### Community 629 - "DailyDigestAggregatorTests"
Cohesion: 0.19
...
### Community 631 - "test_local_brain_state.py"
Cohesion: 0.12
...
### Community 633 - "test_migrate_local_brain_env.py"
Cohesion: 0.38
...
### Community 634 - "TestNoNvidiaFallbackIsRetired"
Cohesion: 0.09
...
### Community 637 - "test_refresh_agent_built_proof.py"
Cohesion: 0.12
...
### Community 638 - "test_tasks_reconciler_todo_requeue.py"
Cohesion: 0.20
...
### Community 642 - "CollaborationContext"
Cohesion: 0.17
...
### Community 653 - "Skill: user-research"
Cohesion: 0.13
...
### Community 654 - "Separate hosted dashboard backend (`backend/server.py`)"
Cohesion: 0.13
...
### Community 655 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 656 - "Attention Mechanisms Internals"
Cohesion: 0.13
...
### Community 657 - "test_rate_limiter.py"
Cohesion: 0.08
...
### Community 658 - "_push_down_where"
Cohesion: 0.14
...
### Community 660 - "TestDecisionsBotLinks"
Cohesion: 0.21
...
### Community 662 - "test_critical_flows.py"
Cohesion: 0.26
...
### Community 665 - "TestBrainConfigUpdates"
Cohesion: 0.22
...
### Community 666 - "DecisionsStoreTests"
Cohesion: 0.13
...
### Community 667 - "test_dockerfile_ships_config_dir.py"
Cohesion: 0.14
...
### Community 668 - "test_daemon_restart_reprobes_http_port_only"
Cohesion: 0.13
...
Cohesion: 0.19
Nodes (15): coordinator(), _make_result(), mock_store(), mock_workflow(), asyncio, tests/test_task_service_failed_comment.py — verify that a FAILED TaskResult…, A FAILED TaskResult without agent_comment transitions to FAILED without…, A FAILED TaskResult sets task.error_message to result.output. (+7 more)
...
### Community 673 - "classify_direct_chat_intent"
Cohesion: 0.13
...
### Community 676 - "test_ai_insights.py"
Cohesion: 0.20
...
### Community 679 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 683 - "Checks Performed"
Cohesion: 0.14
...
### Community 684 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 685 - "Skill: branch-cleanup"
Cohesion: 0.14
...
### Community 690 - "DirectChatSession"
Cohesion: 0.15
...
### Community 691 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 693 - "Render MCP — autonomous platform debugging and environment monitoring"
Cohesion: 0.14
...
### Community 694 - "Runbook: Auto-Resume After Cooldown / Interruption"
Cohesion: 0.14
...
### Community 695 - "SEO / GEO / AIO Audit Engine"
Cohesion: 0.14
...
### Community 696 - "Traffic Distribution Across Providers"
Cohesion: 0.14
...
### Community 700 - "extract_failures"
Cohesion: 0.21
...
### Community 701 - "test_p0_roadmap_b3_b4_b5.py"
Cohesion: 0.21
...
### Community 703 - "clear_wizard_state_cache"
Cohesion: 0.19
...
### Community 704 - "test_wrapper_falls_back_to_installed_model"
Cohesion: 0.19
...
### Community 706 - "test_changelog_check_workflow.py"
Cohesion: 0.21
...
### Community 707 - "TestMCPClientStructuredOutput"
Cohesion: 0.27
...
### Community 708 - "_StubManager"
Cohesion: 0.14
Nodes (3): _apply(), Minimal stand-in for BrainFailoverManager., _StubManager

### Community 709 - ".test_set_github_token_sqlite_string_id_does_not_500"
Cohesion: 0.16
...
### Community 712 - "test_openclaw_gateway.py"
Cohesion: 0.14
...
### Community 713 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 714 - "FeatureUnavailableError"
Cohesion: 0.11
...
### Community 716 - "AGENTS.md — Codebase Map & Operations Reference"
Cohesion: 0.15
...
### Community 718 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 721 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 722 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 726 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 727 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 734 - "Workspace Isolation Architecture"
Cohesion: 0.15
...
### Community 736 - "Autonomy Uplift — Living Roadmap & Detailed Implementation Specs"
Cohesion: 0.15
...
### Community 737 - "OpenClaw — iOS Control of the Agency (Single-Service Free-Tier Deploy)"
Cohesion: 0.15
...
### Community 744 - "Agent Transparency Report"
Cohesion: 0.15
...
### Community 747 - "test_compose_and_coordinate_api.py"
Cohesion: 0.21
...
### Community 748 - "TestModelCostTableUpdates"
Cohesion: 0.26
...
### Community 749 - "test_deploy_trigger_covers_image.py"
Cohesion: 0.21
...
### Community 750 - "TestKillSwitchDurability"
Cohesion: 0.15
...
### Community 751 - "test_providers_live_e2e.py"
Cohesion: 0.24
...
### Community 752 - "test_quick_note_engine.py"
Cohesion: 0.17
...
### Community 753 - "test_tasks_awaiting_approval_api.py"
Cohesion: 0.33
...
### Community 755 - "skill_registry.py"
Cohesion: 0.17
...
### Community 762 - "Skill: system-prompt-audit"
Cohesion: 0.17
...
### Community 763 - "Skill: task-alive-updates"
Cohesion: 0.17
...
### Community 766 - "build_admin_local_brain_router"
Cohesion: 0.24
...
### Community 767 - "_is_ephemeral_user"
Cohesion: 0.27
...
### Community 768 - "connectors_api.py"
Cohesion: 0.21
...
### Community 769 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 772 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 774 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 775 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 776 - "Quantization Internals"
Cohesion: 0.17
...
### Community 777 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 778 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 779 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 783 - "install-agents.sh"
Cohesion: 0.39
...
### Community 784 - "check_container_posture.py"
Cohesion: 0.26
...
### Community 785 - "test_pytest_failure_parser.py"
Cohesion: 0.23
...
### Community 786 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 787 - "is_anthropic_base_url"
Cohesion: 0.18
...
### Community 789 - "test_agile_api.py"
Cohesion: 0.17
...
### Community 790 - "test_app_settings.py"
Cohesion: 0.21
...
### Community 791 - "test_brain_default_consistency.py"
Cohesion: 0.24
...
### Community 793 - "TestModelRegistryUpdates"
Cohesion: 0.14
...
### Community 794 - "test_gh_brain_failover.py"
Cohesion: 0.17
...
### Community 801 - "_extractive_compress"
Cohesion: 0.18
...
### Community 805 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 808 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 809 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 811 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 814 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 815 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 816 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 817 - "2. Critical Bugs & Exact Detection Signatures"
Cohesion: 0.18
...
### Community 818 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 819 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 820 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 821 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 822 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 824 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 825 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 826 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 827 - "CI Troubleshooting Runbook"
Cohesion: 0.18
...
### Community 828 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 829 - "What to clean up"
Cohesion: 0.18
...
### Community 830 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 831 - "test_bedrock_live.py"
Cohesion: 0.25
...
### Community 832 - "admin_update_task_router.py"
Cohesion: 0.22
...
### Community 833 - "build_tech_db.py"
Cohesion: 0.35
...
### Community 834 - "migrate_local_brain_env.py"
Cohesion: 0.25
...
### Community 836 - "_is_bedrock_model_id"
Cohesion: 0.27
...
### Community 837 - "test_conftest_hermetic_env.py"
Cohesion: 0.18
...
### Community 838 - "_InMemoryBackend"
Cohesion: 0.18
...
### Community 839 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 840 - "test_event_log.py"
Cohesion: 0.45
...
### Community 841 - "TestZeroAttemptDiagnostics"
Cohesion: 0.25
...
### Community 842 - "provider_base_url"
Cohesion: 0.08
...
### Community 844 - "test_omniroute_provider.py"
Cohesion: 0.15
...
### Community 853 - "Brag Plan: Autonomous AI Agency (feature tour, v2)"
Cohesion: 0.20
...
### Community 854 - "Hyperframes Composition Brief: Autonomous AI Agency (feature tour, v2)"
Cohesion: 0.20
...
### Community 855 - "_normalize_tool_choice"
Cohesion: 0.31
...
### Community 856 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 857 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 858 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 859 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 860 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 861 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 862 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 865 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 866 - "Competitor Analysis — Autonomous AI Agency"
Cohesion: 0.20
...
### Community 867 - "Issue #1427: quick-note:https://github.com/bingreeky/JIT"
Cohesion: 0.20
...
### Community 868 - "LLM Router — configuration guide"
Cohesion: 0.20
...
### Community 869 - "LLM Router — provider guide"
Cohesion: 0.20
...
### Community 870 - "One command (recommended)"
Cohesion: 0.20
...
### Community 871 - "ENGINEERING_STANDARDS.md — Patterns & Reference"
Cohesion: 0.22
...
### Community 875 - "TestModelsEndpointAliases"
Cohesion: 0.31
...
### Community 876 - "enrich_quick_note_issues.py"
Cohesion: 0.36
...
### Community 878 - "_start_ceo_agency"
Cohesion: 0.27
...
### Community 880 - "_resolve_push_token"
Cohesion: 0.24
Nodes (10): Execute the plan via the selected specialist(s)., GitHub token used to push branches / open PRs during EXECUTION (#506).…, _resolve_push_token(), _clean_env(), tests/test_orchestrator_push_token.py — #506 push/PR token resolution.…, test_falls_through_gh_pat_and_github_token(), test_internal_run_uses_server_token(), test_per_user_token_always_wins() (+2 more)

### Community 881 - "TestDisabledProvidersAreNotFalselyReportedUnreachable"
Cohesion: 0.22
...
### Community 882 - "TestTheWorkflowIsSafeAndReadOnly"
Cohesion: 0.20
...
### Community 883 - "TestPoliciesGovernanceStableClaim"
Cohesion: 0.20
...
### Community 884 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 885 - "test_model_catalog_guard.py"
Cohesion: 0.29
...
### Community 889 - "_autonomy_bg_cycle"
Cohesion: 0.28
...
### Community 890 - "test_workflow_api_mount.py"
Cohesion: 0.20
...
### Community 895 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 898 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 901 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 902 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 903 - "Skill: changelog-enforcer"
Cohesion: 0.22
Nodes (8): Acceptance Checks, Changelog Location, Entry Format, Examples, Hook Behaviour, Instructions, Skill: changelog-enforcer, When to Use

### Community 904 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
Nodes (8): Branch, Components, Purpose, Quick Start, Session Roles, Skill: cowork-session (Claude Cowork), Testing, When to Use

### Community 905 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 906 - "Active Task Tracker"
Cohesion: 0.22
...
### Community 908 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 909 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 910 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 911 - "Issue #1356: quick-note:https://searchengineland.com/turn-seo-backlog-into-roadmap-485713"
Cohesion: 0.22
...
### Community 912 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 913 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 915 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 922 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 924 - ".test_every_request_carries_a_real_user_agent"
Cohesion: 0.22
...
### Community 925 - "test_changelog_parity_guard.py"
Cohesion: 0.22
...
### Community 926 - "TestPolicyAuthoringUiStableClaim"
Cohesion: 0.22
...
### Community 927 - "test_daemon_picks_colibri_8081_when_only_it_listening"
Cohesion: 0.22
...
### Community 929 - "test_process_quick_note_workflow.py"
Cohesion: 0.25
...
### Community 930 - "TestEveryFullSuiteJobHasMongo"
Cohesion: 0.22
...
### Community 931 - "._run_phase_with_timeout"
Cohesion: 0.22
...
### Community 933 - "test_scanner_deps_parity.py"
Cohesion: 0.31
...
### Community 934 - "test_serve_spa_prefixes.py"
Cohesion: 0.31
...
### Community 942 - "_answer_callback"
Cohesion: 0.29
...
### Community 944 - "quality_checker.py"
Cohesion: 0.32
...
### Community 946 - "_parse_tool_calls_from_response"
Cohesion: 0.43
...
### Community 953 - "GitHub Branch Protection Settings"
Cohesion: 0.25
...
### Community 958 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 959 - "ceo-micromanagement.md"
Cohesion: 0.25
Nodes (4): P0 behavior change, Readiness contract, Runtime model, Runtime types

### Community 960 - "Feature Maturity / Support Matrix"
Cohesion: 0.25
...
### Community 963 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.25
...
### Community 964 - "Issue #362: Nvidia repo setup"
Cohesion: 0.25
...
### Community 965 - "Issue #364: quick-note:https://www.marktechpost.com/2026/06/01/meet-memory-os-a-6-layer-open-source-memory-stack-built-on-top-of-hermes-agent/"
Cohesion: 0.25
...
### Community 966 - "Issue #378: quick-note:https://www.marktechpost.com/2026/06/02/tinyfish-launches-bigset-an-open-source-multi-agent-system-that-builds-structured-live-datasets-from-plain-english-descriptions/"
Cohesion: 0.25
...
### Community 967 - "Issue #379: quick-note:https://searchengineland.com/schema-markup-optimize-agentic-web-479080"
Cohesion: 0.25
...
### Community 968 - "Issue #380: quick-note:https://cursor.com/blog/cloud-agent-lessons"
Cohesion: 0.25
...
### Community 969 - "Issue #381: quick-note:https://www.xda-developers.com/claude-code-with-opus-48-is-expensive-but-i-made-it-efficient-with-my-local-ai-workflow/"
Cohesion: 0.25
...
### Community 970 - "Issue #382: quick-note:https://claude.com/blog/how-coderabbit-used-claude-to-build-an-agent-orchestration-system"
Cohesion: 0.25
...
### Community 971 - "Issue #383: quick-note:https://www.marktechpost.com/2026/05/29/hexo-labs-open-sources-sia-a-self-improving-agent-that-updates-both-the-harness-and-the-model-weights/"
Cohesion: 0.25
...
### Community 972 - "Issue #416: feat: Self-hosted Codebuff (freebuff) on free NVIDIA models + Telegram bot phone control"
Cohesion: 0.25
...
### Community 973 - "Issue #485: [Trend Digest] Week of 2026-06-08"
Cohesion: 0.25
...
### Community 974 - "Issue #488: quick-note:https://github.com/cookiy-ai/user-research-skill"
Cohesion: 0.25
...
### Community 975 - "Issue #491: Implement whatever is necessary from https://github.com/BehiSecc/awesome-claude-skills"
Cohesion: 0.25
...
### Community 976 - "Issue #493: Use the https://github.com/mvanhorn/last30days-skill skill to get the trend updated"
Cohesion: 0.25
...
### Community 977 - "Issue #495: Read https://www.anthropic.com/news/claude-fable-5-mythos-5 and understand if mythos or fable can be added to the repo"
Cohesion: 0.25
...
### Community 978 - "Issue #504: EPIC: Autonomy hardening — live-verified defects 2026-06-10"
Cohesion: 0.25
...
### Community 981 - "Issue #657: quick-note:https://github.com/earendil-works/pi"
Cohesion: 0.25
...
### Community 982 - "Issue #659: quick-note:https://github.com/nex-agi/Nex-N2"
Cohesion: 0.25
...
### Community 983 - "Issue #660: quick-note:https://github.com/getsentry/sentry-for-ai"
Cohesion: 0.25
...
### Community 984 - "Issue #661: quick-note:https://github.com/XiaomiMiMo/MiMo-Code"
Cohesion: 0.25
...
### Community 985 - "Issue #664: quick-note:https://github.com/Grominet95/jarvis-OS"
Cohesion: 0.25
...
### Community 986 - "Issue #666: quick-note:https://github.com/porokka/jarvis-os"
Cohesion: 0.25
...
### Community 987 - "Issue #670: quick-note:https://github.com/perplexityai/bumblebee"
Cohesion: 0.25
...
### Community 988 - "Issue #672: quick-note:https://github.com/Chachamaru127/claude-code-harness"
Cohesion: 0.25
...
### Community 989 - "Issue #676: quick-note:https://github.com/WeiboAI/VibeThinker"
Cohesion: 0.25
...
### Community 990 - "Issue #820: quick-note:https://github.com/cobusgreyling/loop-engineering"
Cohesion: 0.25
...
### Community 991 - "Positional Encoding Internals"
Cohesion: 0.25
...
### Community 992 - "Platform Controls"
Cohesion: 0.25
...
### Community 993 - "_blocked_result"
Cohesion: 0.29
Nodes (4): _blocked_result(), Any, TaskResult, Build the failed TaskResult returned when policy denies a dispatch. A result…

### Community 994 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 995 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 996 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 997 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 998 - "Continual Harness (`agent/harness_spec.py`)"
Cohesion: 0.25
...
### Community 999 - "Prime Agent Runtime"
Cohesion: 0.25
...
### Community 1009 - "TestItIsNotBuiltForOneVendor"
Cohesion: 0.25
...
### Community 1010 - "TestSupportMatrixDocsSync"
Cohesion: 0.29
...
### Community 1011 - "test_generate_context_standing_instructions.py"
Cohesion: 0.32
...
### Community 1012 - "test_local_brain_router_smoke.py"
Cohesion: 0.25
...
### Community 1013 - "test_mcp_protocol_version.py"
Cohesion: 0.25
...
### Community 1014 - "DirectChatDoctor"
Cohesion: 0.47
...
### Community 1016 - "test_provider_models_db_outage.py"
Cohesion: 0.25
...
### Community 1017 - "_decompose_into_subtasks"
Cohesion: 0.33
...
### Community 1018 - "test_nuclear_cleanup_targets_the_schedule_collection"
Cohesion: 0.25
...
### Community 1020 - "TestDirectChatAgentExecution"
Cohesion: 0.33
...
### Community 1021 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.25
...
### Community 1023 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 1027 - "classify_domain"
Cohesion: 0.29
...
### Community 1039 - "Karpathy Guidelines Skill"
Cohesion: 0.29
...
### Community 1048 - "docs/changelog.md"
Cohesion: 0.29
Nodes (6): Added, Changed, Changelog, Fixed, Maintenance, [v4.1.0]

### Community 1049 - "[5.0.0]"
Cohesion: 0.29
Nodes (7): [5.0.0], Added, Changed, Fixed, Maintenance, Removed, Security

### Community 1050 - "Changelog"
Cohesion: 0.29
Nodes (7): Added, Changed, Changelog, Fixed, Maintenance, Removed, Security

### Community 1051 - "claude-mem Plugin — Persistent Memory for All Sessions"
Cohesion: 0.29
...
### Community 1052 - "Implementation plan + TO-DO (check off as you go)"
Cohesion: 0.29
...
### Community 1055 - "_normalize_dockerfile"
Cohesion: 0.33
...
### Community 1056 - "Cloudflare = the real working app"
Cohesion: 0.29
...
### Community 1064 - "check_changelog_parity.py"
Cohesion: 0.43
...
### Community 1065 - "check_doc_images.py"
Cohesion: 0.48
...
### Community 1069 - "test_daily_2026_06_14.py"
Cohesion: 0.38
...
### Community 1070 - "TestModelRoleSeparation"
Cohesion: 0.40
...
### Community 1080 - "_brain_provider_status"
Cohesion: 0.50
Nodes (4): _brain_provider_status(), Return per-provider metadata for the GET endpoint. Iterates every provider in…, Return the discovered model list for *provider_id*, or ``[]`` if unknown., _served_models()

### Community 1081 - "InitiativeProgress"
Cohesion: 0.33
...
### Community 1082 - "openclaw_mobile_ui"
Cohesion: 0.33
...
### Community 1083 - "Music Cues: happy-beats-business-moves-vol-1-by-ende-dot-app"
Cohesion: 0.33
...
### Community 1098 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 1099 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 1100 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 1103 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 1104 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 1110 - "gen_screenshots.py"
Cohesion: 0.47
...
### Community 1112 - "parse_pytest_failures.py"
Cohesion: 0.40
...
### Community 1125 - "TestTheAgentRunsCurrentCode"
Cohesion: 0.33
...
### Community 1133 - "feature-implementer.md"
Cohesion: 0.40
Nodes (4): Before you edit, Prove it, Report back, While you edit

### Community 1134 - "/arch-review — Architecture Agent"
Cohesion: 0.40
...
### Community 1148 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 1149 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 1150 - "Runtime troubleshooting"
Cohesion: 0.40
Nodes (4): Agent mode timeout, Missing binary / task harness, Runtime troubleshooting, Workspace validation failures

### Community 1151 - "knowledgeGraphTab.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 1152 - "loginFlowNoTimeout.test.js"
Cohesion: 0.40
Nodes (4): apiSource, { describe, test, expect }, fs, path

### Community 1153 - "test_company_stale_id_recovery.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 1154 - "worker_no_cache.test.js"
Cohesion: 0.40
...
### Community 1157 - "Prompt Library Changelog"
Cohesion: 0.40
Nodes (4): Added, Format, Prompt Library Changelog, [Unreleased]

### Community 1158 - "Proof"
Cohesion: 0.40
...
### Community 1160 - "_add_colibri_shim_changelog_entry.py"
Cohesion: 0.50
...
### Community 1162 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1163 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 1164 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 1168 - "start_tunnel.py"
Cohesion: 0.50
...
### Community 1171 - "test_v5_screens_smoke.py"
Cohesion: 0.50
...
### Community 1172 - "nvidia_live_test.py"
Cohesion: 0.40
...
### Community 1178 - "TestGhIsNotReAuthenticated"
Cohesion: 0.40
...
### Community 1212 - "test_no_exception_detail_leaks.py"
Cohesion: 0.50
...
### Community 1215 - "test_skills_route_order.py"
Cohesion: 0.67
...
### Community 1219 - "github"
Cohesion: 0.50
Nodes (3): github, enabled, silent

### Community 1247 - "test_the_reserve_is_bounded_when_read_from_the_environment"
Cohesion: 0.67
...
### Community 1264 - "Next Action"
Cohesion: 0.50
Nodes (3): Carry-over items (from prior sessions), Next Action, Routine to pick up next session

## Knowledge Gaps
- **3551 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3546 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 14433 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **131 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `_fixture()` connect `_fixture` to `llm/router.py`, `UsageEvent`, `test_llm_router_queue_cache.py`, `test_llm_router_strategies.py`, `TaskExecutionCoordinator`, `BrainConfig`, `Task`, `parse_event_stream`, `WebsiteScanner`, `SelfHealingAgent`, `OrchestratorQueue`, `PolicyEngine`, `WorkflowRun`, `test_autonomy_status.py`, `test_brain_patch_service_token.py`, `E2BSandboxSession`, `TaskStore`, `LLMProvider`, `AgentSwarm`, `test_sam_livekit.py`, `test_failover_client_shared.py`, `Agency`, `test_llm_router_resilience.py`, `client`, `test_unit8_model_catalog.py`, `routed`, `test_agent_tool_governance.py`, `PrimeAgentAdapter`, `test_e2b_task_wiring.py`, `test_model_router.py`, `get_user_role`, `test_company_api.py`, `Specialist`, `test_monitor_lib.py`, `test_langfuse_agency_wide.py`, `KeyPool`, `test_phase5_doctor.py`, `AgentRunner`, `ArtifactStore`, `test_startup_warmup.py`, `resolve_active_brain`, `WorkflowRun`, `direct_chat.py`, `test_provider_router.py`, `e2e/test_browser.py`, `build_governance_router`, `test_freebuff_bot.py`, `ResearchTask`, `config.py`, `TestClient`, `test_openclaw_endpoints.py`, `test_catalogue_probe.py`, `test_procedural_memory.py`, `test_knowledge_sync.py`, `claim`, `models/seo_audit.py`, `brain_config.py`, `SQLiteStore`, `test_task_brain_preflight.py`, `test_local_brain_state.py`, `resolve_e2b_config`, `TestChatHistoryStore`, `FeatureMaturity`, `test_refresh_agent_built_proof.py`, `_resolve_brain_provider`, `test_tasks_reconciler_todo_requeue.py`, `.run`, `test_context_rulebook.py`, `test_new_features_e2e.py`, `test_llm_router_e2e.py`, `test_response_cache.py`, `test_trend_watcher.py`, `test_rate_limiter.py`, `test_autonomous_agency_e2e.py`, `controls_app`, `E2BAdapter`, `test_issue_intake.py`, `LogMonitor`, `SeoAuditEngine`, `run_task`, `test_task_service_failed_comment.py`, `ChatHistoryStore`, `_step`, `test_webui_provider_priority.py`, `TestHarnessAdapter`, `KeyStore`, `test_telegram_freebuff.py`, `MCPClient`, `TestSelfHealingInfrastructureClassification`, `test_telegram_auto_approve.py`, `test_e2b_data_flow.py`, `test_changelog_check_workflow.py`, `OllamaCircuitBreaker`, `SchedulerStore`, `_job_text`, `test_video_transcript.py`, `_run_analyze`, `test_openclaw_gateway.py`, `test_dashboard_cache.py`, `test_portfolio_intake.py`, `test_features_api.py`, `TrendWatcher`, `emit_chat_observation`, `test_agent_free_brain.py`, `_Budget`, `cost_tracker.py`, `test_purge_backlog.py`, `TestEstimateTokensForMessages`, `NotificationDispatcher`, `TestClient`, `test_telegram_webhook.py`, `test_control_plane_api.py`, `test_brain_availability_doctor.py`, `ContextPruner`, `_resolve_user_github_token`, `test_runtimes_health_endpoint.py`, `AgentDefinition`, `test_persistent_memory.py`, `test_agile_api.py`, `test_app_settings.py`, `test_operational_incidents.py`, `test_sam_voice.py`, `SecurityScanner`, `AuditLog`, `test_gh_brain_failover.py`, `test_spa_trailing_slash_redirect.py`, `test_task_clarification.py`, `test_nvidia_model_discovery.py`, `OutputFilter`, `test_provider_enable_disable.py`, `tests/conftest.py`, `get_skill_bindings`, `test_kimi_bridge_server.py`, `test_ceo_router.py`, `TestNormalizeResponseFormat`, `test_platform_controls.py`, `analyze_page`, `test_session_retro.py`, `test_agency_fix.py`, `test_skill_registry_boot_refresh.py`, `test_scheduler_hydration_bounded.py`, `brain_failover.py`, `_redact_for_notification`, `clear_cooldowns`, `test_provider_state_durability.py`, `isolated_telegram_config`, `WorkflowBuildRequest`, `_start_ceo_agency`, `_resolve_push_token`, `TestTheWorkflowIsSafeAndReadOnly`, `test_regression.py`, `test_agent_scripts_share_one_model_list.py`, `test_crispy_burn_in.py`, `test_implement_agent_routing.py`, `test_executive_advisory_api.py`, `test_doctor_coding_brain.py`, `heal_signature`, `_Recorder`, `_undeclared`, `test_process_quick_note_workflow.py`, `OrchestratorCheckpointStore`, `TestSwarmRoleRouting`, `test_service_token.py`, `test_telegram_diag_endpoint.py`, `test_harness_spec.py`, `test_v4_api.py`, `model_discovery.py`, `traffic_director.py`, `.on_task_complete`, `test_voice_pipeline.py`, `test_ping.py`, `test_mcp_protocol_version.py`, `ClaudeCodeAdapter`, `test_provider_410_per_model.py`, `test_task_store_fails_loud_in_production.py`, `captured`?**
  _High betweenness centrality (0.075) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `AdaptiveHalter`, `ContextPruner`, `proxy.py`, `.run`, `TaskSpec`, `test_ceo_dispatcher.py`, `GitHubTools`, `test_agent_chat_integration.py`, `test_agent_runner.py`, `diagnostics.py`, `agency.py`, `test_governance_sandbox.py`, `UserMemoryStore`, `test_autonomous_agency_e2e.py`, `PolicyEngine`, `E2BAdapter`, `WorkflowRun`, `MultiAgentSwarm`, `ReactScratchpad`, `E2BSandboxSession`, `_fixture`, `TestAgentLoopMCPIntegration`, `test_failover_client_shared.py`, `enforcement.py`, `ContextManager`, `test_agent_tool_governance.py`, `MCPClient`, `WorkspaceTools`, `call_llm`, `CEODispatcher`, `StuckDetector`, `loop.py`, `test_empirical_verify.py`, `LocalWorkspace`, `FreeBuffAgent`, `direct_chat.py`, `AgentPlan`, `BrainFailoverExhausted`, `test_agent_free_brain.py`, `TokenBudget`, `InternalAgentAdapter`, `_resolve_push_token`, `test_governance_api.py`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderRouter` to `backend/server.py`, `system_instruction`, `settings.py`, `test_chat_mode_regressions.py`, `ProviderConfig`, `is_anthropic_base_url`, `TestLegacyRouterServerFallback`, `test_bedrock_provider.py`, `TrafficDirector`, `implement_agent.py`, `test_all_providers_discovery.py`, `NvidiaProvider`, `call_llm`, `test_bedrock_live.py`, `resolve_active_brain`, `direct_chat.py`, `kimi_bridge_provider_config`, `test_provider_router.py`, `test_colibri_provider.py`, `TestLegacyRouterCacheTTL`, `test_anthropic_refusal_fallback.py`, `TestRouterIntegration`, `clear_cooldowns`, `_payload`, `failover_client.py`, `TestAnthropicPayloadStructuredOutput`, `test_provider_410_per_model.py`, `test_implement_agent_routing.py`?**
