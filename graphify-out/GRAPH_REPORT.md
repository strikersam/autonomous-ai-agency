...
## Corpus Check
- 1440 files · ~2,083,722 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 29252 nodes · 54265 edges · 1235 communities (1122 shown, 113 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 2671 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b0fafbab`
...
## Communities (1235 total, 113 thin omitted)

### Community 0 - "MongoDBStore"
Cohesion: 0.02
Nodes (93): CompanyGraph, KnowledgeItem, The complete Company Graph - canonical core model for the Autonomous AI Agency.…, Find knowledge items matching any of the given tags., Find connectors configured for a specific system., Structured knowledge about the company, systems, or processes., MongoDBStore, Any (+85 more)
...
Cohesion: 0.05
Nodes (66): get_improvement_loop(), _dispatch_async(), _ErrorCaptureHandler, get_log_monitor(), LogMonitor, _note_recurrence(), Any, LogRecord (+58 more)
...
Cohesion: 0.05
Nodes (48): _apply_activity_status(), create_agent(), delete_agent(), get_agent(), _get_user(), list_agents(), list_runtime_agents(), Any (+40 more)
...
### Community 39 - "Task"
Cohesion: 0.02
Nodes (139): AgentDefinition, A user-defined agent configuration stored in the database., Hand the 'connect & verify the repo' work to the agency's own agents. The task…, _seed_connect_task(), ApprovalCheckpoint, _coerce_ts(), ExecutionLogEntry, Any (+131 more)
...
Cohesion: 0.05
Nodes (68): Submit onboarding answers and create intelligent remediation tasks. Analyzes…, submit_onboarding_answers(), quick_notes_submit(), _QuickNoteBody, Submit a quick-note URL or instruction from the dashboard FAB., get_failover_manager(), Return the singleton BrainFailoverManager., Reset the singleton (for tests). (+60 more)
...
### Community 149 - "test_backend_runtime_bootstrap.py"
Cohesion: 0.11
...
### Community 186 - "_resolve_brain_provider"
Cohesion: 0.07
...
Cohesion: 0.03
Nodes (40): GooseAdapter, Any, Adapter for Goose — TIER 2 general-purpose local runtime., _env_float(), HermesAdapter, Any, AsyncClient, Response (+32 more)
...
Cohesion: 0.10
Nodes (29): agent/sam.py — SAM Voice Agent (System Autonomy Manager) SAM is the voice-…, legacy_scheduler_delete(), emit_agency_observation(), Record an agency platform operation in Langfuse. Unlike…, get_scheduler(), agent/scheduler.py — Scheduled Agent Jobs Cron-based job scheduler. Each job…, create_schedule(), delete_schedule() (+21 more)
...
Cohesion: 0.04
Nodes (67): Run a full SEO/GEO/AIO audit against a website and persist the evidence., run_seo_audit(), autonomy_status(), Public autonomy readiness probe — no authentication required. A live deploy…, Fire-and-forget self-bootstrap; never blocks or crashes startup., _schedule_self_bootstrap(), CompanyAgencyService, get_company_agency_service() (+59 more)
...
### Community 529 - "._resolve_merge_decision"
Cohesion: 0.25
...
Cohesion: 0.04
Nodes (42): ChatResponse, CerebrasProvider, Provider, Cerebras provider adapter — free, fast LLM (qwen-3-coder-480b)., GroqProvider, Provider, Groq provider adapter — free, fast LLM (deepseek-r1-distill-llama-70b)., NvidiaProvider (+34 more)
...
Cohesion: 0.02
Nodes (80): BusinessCategory, BusinessSystem, CompanyGraphSnapshot, OnboardingProgress, SystemType, Get the index of a phase in the workflow., Find a website by its URL., Find a repository by its URL. (+72 more)
...
Cohesion: 0.02
Nodes (95): Item, app_client(), _clear_discovered_models(), _clear_response_cache(), client(), _isolate_brain_data_layer(), _isolate_operator_provider_state(), non_admin_client() (+87 more)
...
Cohesion: 0.02
Nodes (144): classify_domain(), agent/workflow.py — Persisted workflow state machine. Implements the Autonomous…, Return the best-matching domain for a task title+description., packages/ai/self_heal.py — automatic brain self-healing. When the active brain…, Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., tasks — Task/issue management system. Provides a lightweight task/issue tracker…, Enum (+136 more)
...
Cohesion: 0.01
Nodes (437): get_harness_adapter(), Extract a consistent user_id from the user dict. Works across all auth methods:…, _resolve_user_id(), delegate_seo_findings(), Create real agent tasks from the audit's delegation plan. Each work package…, admin_seed(), _agent_provider_failure_response(), _agent_timeout_fallback_response() (+429 more)
...
### Community 1225 - "test_activity_logs.py"
Cohesion: 0.67
