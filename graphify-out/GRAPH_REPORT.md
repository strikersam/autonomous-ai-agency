...
## Corpus Check
- 784 files · ~882,741 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 14236 nodes · 29682 edges · 810 communities (697 shown, 113 thin omitted)
- Extraction: 78% EXTRACTED · 22% INFERRED · 0% AMBIGUOUS · INFERRED: 6476 edges (avg confidence: 0.52)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `12a39c6b`
...
1. `AgentRunner` - 207 edges
2. `AgentSessionStore` - 189 edges
3. `TaskSpec` - 168 edges
4. `RuntimeUnavailableError` - 139 edges
5. `TaskResult` - 138 edges
6. `RuntimeAdapter` - 136 edges
7. `UserMemoryStore` - 127 edges
8. `RuntimeExecutionError` - 126 edges
9. `apps` - 123 edges
10. `RuntimeCapability` - 118 edges
...
## Communities (810 total, 113 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (219): AdminAuthManager, AdminIdentity, AdminIdentity, Agency, get_agency(), CEO-coordinated multi-agent agency for continuous codebase management.      The, set_agency(), BackgroundAgent (+211 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (142): AgentJobRequest, AgentJobSnapshot, Complete point-in-time view of a job, safe to serialise as API response., Convenience: the canonical text response, whether success or failure., Validated input for creating a new agent job.      Passed from the API handler i, DirectChatDoctor, AgentJobManager, AgentScheduler (+134 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (76): AiderAdapter, Adapter for Aider — TIER 3 specialized git-aware code editor., GooseAdapter, Adapter for Goose — TIER 2 general-purpose local runtime., HermesAdapter, Adapter for Hermes Agent — FIRST CLASS autonomous runtime., JCodeAdapter, Adapter for jcode — TIER 2 high-performance Rust coding agent. (+68 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (102): MongoDBStore, Company, KnowledgeItem, ObjectId, Repo, Specialist, Website, Delete a company and all its associated data. (+94 more)

### Community 4 - "Community 4"
Cohesion: 0.07
Nodes (152): auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint(), _DoctorCheck, _DoctorReport, generate_onboarding_questions(), get_company() (+144 more)

### Community 5 - "Community 5"
Cohesion: 0.07
Nodes (116): runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized).  Aider (https, Run aider non-interactively via `--message` flag., json_safe(), runtimes/adapters/claude_code.py — Claude Code CLI adapter (FIRST CLASS).  Claud, runtimes/adapters/docker_agent.py — Docker-based agent runtime adapter.  Spawns, runtimes/adapters/goose.py — Goose adapter (TIER 2).  Goose (https://github.com/, runtimes/adapters/hermes.py — Hermes Agent adapter (FIRST CLASS).  Hermes Agent, Submit task to Hermes via its /tasks endpoint. (+108 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (91): Agent subsystem — planner / executor / verifier loop., AgentPhaseError, AgentRunner, _nvidia_api_key(), AgentPlan, AgentSessionStore, Any, Path (+83 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (56): Exception, check_feature(), get_feature(), list_features(), Any, features/api.py — Admin API for the feature support matrix.  Exposes:   GET  /ad, Return the full support matrix with summary., Return a single feature entry. (+48 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (89): BusinessCategory, CompanyGraphService, BusinessSystem, Company, CompanyGraph, CompanyGraphSnapshot, DetectedSystem, SpecialistFamily (+81 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (85): BeautifulSoup, Evidence, Evidence supporting a system detection., Inferred technology stack from website/repo analysis., StackInference, main(), Returns (url, ok, summary)., _scan_one() (+77 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (77): AgentRole, PreflightIssue, AgentEvent, AgentPlan, AgentSession, AgentSessionMessage, AgentStep, A single entry in the session's append-only event log.      Inspired by Anthropi (+69 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (101): auto_recommend_skills(), create_access_token(), create_api_key(), create_github_pr(), create_mcp_server(), create_provider(), create_refresh_token(), create_wiki_page() (+93 more)
...
Cohesion: 0.04
Nodes (62): AgileManager, Agentic Agile — Sprint management with velocity tracking and burndown.  Issue: #, Manages multiple agile sprints with velocity tracking., List all active sprints., Predict next sprint velocity from historical data., Number of managed sprints., add_initiative(), AllocationOut (+54 more)
...
Cohesion: 0.03
Nodes (47): _best_cloud_primary_base(), InternalAgentAdapter, _nvidia_provider_chain(), Built-in agent loop — Nvidia NIM primary, Ollama fallback., Return runtime dependencies required by this adapter.                  Returns:, Determine availability of the internal agent runtime.          Checks cloud prov, Execute a TaskSpec using the internal AgentRunner and convert the agent's outcom, Create an isolated execution context for a single task.          Tries ``git wor (+39 more)

### Community 17 - "Community 17"
Cohesion: 0.04
Nodes (50): ClassifyOutput, emit_deprecation(), ExecutionResult, JudgeVerdict, _orchestrator_bypass(), Phase, PreflightReport, Any (+42 more)
...
Cohesion: 0.05
Nodes (41): _get_workspace_lock(), get_workspace_manager(), _hash_component(), _iso_now(), _iso_offset_hours(), _load_workspace(), _parse_iso(), Any (+33 more)

### Community 20 - "Community 20"
Cohesion: 0.06
Nodes (43): ProviderManager, Any, Path, run_command(), _safe_allowlist(), validate_command(), _atomic_write_json(), default_store_paths() (+35 more)
...
Cohesion: 0.04
Nodes (48): get_specialist_bound_skills(), _is_admin(), list_companies(), Check if a user has admin role.      Works for both social_auth users (role in S, Get the skills bound to a specific specialist., List companies.      - Admin users see ALL companies across the platform.     -, Fetch a run, enforcing per-user ownership (admins bypass).      Returns 404 — no, _wfo_owned_run_or_404() (+40 more)

### Community 23 - "Community 23"
Cohesion: 0.05
Nodes (45): ModelRouter, Dynamic model router package.  Public API::      from router import get_router,, _build_builtin_model_map(), _default_model(), _default_reasoning_model(), ModelRouter, _nvidia_key_present(), Any (+37 more)
...
Cohesion: 0.07
Nodes (42): agent/workflow.py — Persisted workflow state machine.  Implements the Agency Cor, Set the global agent store instance (e.g., with MongoDB on startup)., set_agent_store(), Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., tasks — Task/issue management system.  Provides a lightweight task/issue tracker, ApprovalRequest, CommentAddRequest (+34 more)
...
Cohesion: 0.05
Nodes (30): BenchmarkReport, EvalHarness, EvalResult, Task, Evaluation harness – runs an agent against a Task, records the Trajectory, score, Runs agent functions against Tasks, records Trajectories and     produces EvalRe, Execute the agent on a single task and return an EvalResult., Delegate to the agent callable (sync or async). (+22 more)
...
Cohesion: 0.08
Nodes (48): _parse_ceo_directives(), ImprovementLoopState, IssueCategory, IssueSeverity, agent/improvement_loop.py — Continuous Improvement Engine  Background scanner th, set_improvement_loop(), Path, ImprovementLoop (+40 more)
...
Cohesion: 0.10
Nodes (26): Tests for workspace isolation model (Area A).  Covers:   - Unique workspace path, Two threads creating the same session/job should not corrupt state., TestConcurrency, TestCrossSessionIsolation, TestJobIdValidation, TestWorkspaceCleanup, TestWorkspaceManifest, TestWorkspaceMetrics (+18 more)

### Community 55 - "Community 55"
Cohesion: 0.08
Nodes (24): audit(), get_audit_log(), get_user_role(), is_admin(), is_power_user_or_above(), mask_dict(), mask_secret(), Any (+16 more)
...
Cohesion: 0.10
Nodes (24): Any, CheckRun, Path, Slice, WorkflowRun, Return the AgentSwarm singleton if available, else None., Append an event to the workflow event log., Create a new WorkflowRun and begin pre-gate phase execution.          The run (+16 more)
...
Cohesion: 0.08
Nodes (25): Specialist, SpecialistFamily, SystemType, Auto-provision specialists based on detected system types.                  Args, Deprovision (delete) a specialist.                  Args:             specialist, Enable a specialist.                  Args:             specialist_id: Specialis, Disable a specialist.                  Args:             specialist_id: Speciali, Get specialists that can handle a task with given capabilities. (+17 more)
...
Cohesion: 0.08
Nodes (23): Execute work through the 11-phase golden path., Approve a run paused at the ApprovalGate and resume execution., List recent workflow orchestrator runs.      Non-admin users see only their own, Get a single workflow orchestrator run by ID (owner or admin only)., workflow_orchestrator_approve(), workflow_orchestrator_execute(), workflow_orchestrator_get_run(), workflow_orchestrator_list_runs() (+15 more)
...
Cohesion: 0.11
Nodes (31): AgentCreateRequest, _apply_activity_status(), create_agent(), delete_agent(), get_agent(), _get_user(), list_agents(), list_runtime_agents() (+23 more)
...
Cohesion: 0.07
Nodes (35): TaskStatus, Task definition schema for the evaluation harness.  Inspired by OpenHarness' str, SuccessCriterion, SuccessCriterionType, TaskDifficulty, WorkspaceStatus, Lifecycle status of a sprint., Qualitative health signal derived from sprint metrics. (+27 more)
...
Cohesion: 0.09
Nodes (22): filter_output(), FilterResult, get_savings_summary(), OutputFilter, Any, agent/output_filter.py — LLM Output Compression & Token Savings  Inspired by rtk, Filter and compress command outputs to reduce LLM token consumption.      Provid, Compact git status output — keep only changed file paths. (+14 more)

### Community 83 - "Community 83"
Cohesion: 0.07
Nodes (26): claim(), cooldown_clear(), cooldown_get(), cooldown_set(), _get_backend(), incr_window(), Shared-state abstraction — in-memory (default) and Redis backends.  Provides dis, Reset the singleton (for tests). (+18 more)
...
Cohesion: 0.16
Nodes (13): Any, AsyncClient, Fetches AI trend signals from many public sources and surfaces relevant ones., Fetch all sources in parallel; return new alerts sorted by relevance., TrendAlert, TrendWatcher, _FakeResp, Path (+5 more)
...
Cohesion: 0.10
Nodes (21): AgencyCycleResult, AgentDirective, _build_ceo_prompt(), _build_quick_note_instruction(), _close_github_issue(), _collect_recent_git_context(), _fetch_github_quick_notes(), _get_api_key() (+13 more)

### Community 93 - "Community 93"
Cohesion: 0.10
Nodes (15): PreflightReport, AgentJob, make_isolated_workspace(), _now(), Any, Path, agent/job_manager.py — Async agent job lifecycle manager.  Manages agent jobs wi, Run a job using the provided runner and update the job's lifecycle, progress, re (+7 more)
...
Cohesion: 0.10
Nodes (25): _dispatch_async(), _ErrorCaptureHandler, get_log_monitor(), LogMonitor, Any, LogRecord, agent/log_monitor.py — Application Log Monitor  Captures ERROR/CRITICAL log reco, Fire-and-forget: schedule a self-healing task from any thread. (+17 more)
...
Cohesion: 0.12
Nodes (34): _admin_headers(), _answer_callback(), _api_headers(), _check_rate_limit(), cmd_control(), cmd_cost(), cmd_freebuff(), cmd_keylist() (+26 more)
...
Cohesion: 0.10
Nodes (23): AgentProfile, AgentSwarm, Any, Artifact, CheckRun, ModelRoutingConfig, Slice, Return the agent role responsible for *phase*. (+15 more)

### Community 104 - "Community 104"
Cohesion: 0.10
Nodes (21): ContextManager, Any, True when the history is long enough to warrant compaction., Replace the old portion of *history* with a single compaction note.          The, True when the harness should use head_file instead of read_file.          When a, Trim a step result so sub-agent outputs stay within ~1-2k tokens.          The A, Manages context window state for a single agent run.      The Brain (LLM) stays, Return a copy of *observations* with old tool outputs truncated.          JetBra (+13 more)
...
Cohesion: 0.07
Nodes (33): _agent_timeout_fallback_response(), _build_provider_router(), _builtin_provider_records(), call_llm(), _chat_error_detail_text(), _chat_provider_policy(), chat_send(), _compact_context() (+25 more)
...
Cohesion: 0.09
Nodes (15): Browser admin UI for login, service control, key management, and diagnostics., Update or append a KEY=value line in the .env file., register_admin_gui(), _save_env_var(), get_output_filter(), Get or create the singleton OutputFilter instance., CompletedProcess, issue_new_api_key() (+7 more)

### Community 116 - "Community 116"
Cohesion: 0.13
Nodes (9): DetectedIssue, ImprovementLoop, _now(), Any, Path, Background scanner and task dispatcher for continuous codebase improvement., Run a scan immediately (blocking). Returns newly detected issues., test_detected_issue_as_dict() (+1 more)
...
Cohesion: 0.11
Nodes (10): get_mcp_client(), MCPClient, Any, agent/mcp_client.py — Async MCP client for the mcp-server Docker container.  Tal, Perform MCP handshake. Optional — tools/call works without it., Call a tool and return the text content of the first content item., Return True if the MCP server is reachable., Return the module-level MCPClient.      Reads MCP_SERVER_BASE_URL at call time ( (+2 more)

### Community 125 - "Community 125"
Cohesion: 0.08
Nodes (11): set_scheduler(), get_public_doctor(), Public Doctor endpoint — no authentication required.      Returns system-level d, get_store(), Return the active store singleton, creating it on first call., tests/test_control_plane_api.py — Tests for Control Plane API endpoints.  Covers, scheduler(), test_set_and_get_scheduler() (+3 more)

### Community 126 - "Community 126"
Cohesion: 0.13
Nodes (20): AgentRole, ArtifactStore, Path, PhaseRunner, Artifact, ArtifactStore, CheckRun, ModelRoutingConfig (+12 more)
...
Cohesion: 0.12
Nodes (16): ArtifactStore, _now(), Any, Artifact, Connection, Path, Row, Write *content* to disk and record metadata in SQLite.          If an artifact w (+8 more)
...
Cohesion: 0.12
Nodes (26): agent_branch_name(), assert_agent_can_merge(), assert_agent_can_write(), AutonomyViolation, is_protected_branch(), _protected_branches(), Autonomy gate — enforce 'agents propose via PR, humans merge'.  The agency can w, Raised when an agent-initiated action would exceed the propose-PR policy. (+18 more)
...
Cohesion: 0.12
Nodes (25): get_scheduler(), legacy_scheduler_create(), legacy_scheduler_delete(), legacy_scheduler_get(), legacy_scheduler_list(), legacy_scheduler_toggle(), legacy_scheduler_trigger(), create_schedule() (+17 more)
...
Cohesion: 0.19
Nodes (6): Task, Add a follow-up instruction to a task and re-queue it for execution.          Un, Executes tasks through the runtime layer using agent definitions., Owns lifecycle transitions, comment semantics, and approval rules., TaskExecutionCoordinator, TaskWorkflowService

### Community 159 - "Community 159"
Cohesion: 0.12
Nodes (21): RepowiseIntelligence, Test that search_codebase returns a string., Test that get_decision_flownodes returns a string., Test that update_intelligence creates the expected intelligence files., Test that get_overview returns a dictionary., Test that get_context returns a string., Test that get_risk returns a dictionary., Test that get_why returns a string. (+13 more)
...
Cohesion: 0.12
Nodes (19): provider_access_tier(), _provider_field(), provider_sort_key(), main(), probe_one(), ProviderRouter, Tests that verify the exact provider priority ordering., When INCLUDE_LOCAL_FALLBACK=true and no cloud keys are set, local Ollama must be (+11 more)
...
Cohesion: 0.11
Nodes (12): Any, Extract docstrings and store as documentation., Provides an architecture summary, module map, and git health., Identifies frequently changed files using git history., Guesses entry points based on file names and common patterns., Basic git health metrics., Build or update all intelligence layers., Hotspot scores and potential impact analysis. (+4 more)

### Community 166 - "Community 166"
Cohesion: 0.13
Nodes (22): get_skill(), list_skills(), List all available skills with optional filtering.      Returns the skill catalo, Get a single skill by its ID., get_skill_bindings(), Live council reviewer — deterministic, rules-based multi-perspective     review, Get the singleton SkillBindings instance., Live Graphify executor — queries the codebase knowledge graph.      Order of pre (+14 more)
...
Cohesion: 0.13
Nodes (11): Polls for queued task work and executes it through the coordinator.      Crash r, Re-queue tasks stranded by a prior crash or hard-kill., TaskDispatcher, Dispatcher should track first_seen times for pending tasks., Executing a task removes it from _first_seen and logs pickup time.          Uses, TaskDispatcher calls reconcile once before the polling loop starts., test_dispatcher_reconciles_on_startup(), _BlockingCoordinator (+3 more)
...
Cohesion: 0.19
Nodes (5): _Collection, _DeleteResult, Motor-compatible async collection backed by a SQLite table.      All I/O uses pa, Minimal aggregate support: $match → $group($sum) / $sort / $limit., _UpdateResult
...
Cohesion: 0.16
Nodes (19): add_pr_comment(), _find_existing_pr(), get_branch_sha(), get_default_branch(), _headers(), Any, agent/safe_agency.py — Safe GitHub operations for the workflow engine.  All func, Create a pull request. Returns the PR object dict.      If a PR already exists f (+11 more)
...
Cohesion: 0.18
Nodes (18): _auth_headers(), chat_completion_text(), list_openai_models(), normalize_base_url(), openai_compat_url(), Any, AsyncClient, Build an OpenAI-compatible URL for a provider base URL.      Supports base URLs (+10 more)
...
Cohesion: 0.18
Nodes (11): _dispatch_async(), ErrorInterceptorMiddleware, Any, Exception, Request, Response, agent/error_interceptor.py — HTTP Error Interceptor Middleware  FastAPI/Starlett, Catch 5xx responses and auto-create fix tasks via the self-healing agent.      E (+3 more)

### Community 208 - "Community 208"
Cohesion: 0.16
Nodes (13): Document, MemoryTurn, Rough token estimate: 4 chars ≈ 1 token (minimum 1)., A single knowledge-base entry (wiki page, source document, etc.)., Run the full RAG pipeline and return a token-budget-respecting context., One turn in the conversation history., Select up to *top_k* highest-scoring turns that fit within *budget*.          Re, A document selected by retrieval, with its compressed excerpt. (+5 more)
...
Cohesion: 0.22
Nodes (4): KeyRecord, KeyStore, Thread-safe JSON-backed key store., main()
...
Cohesion: 0.12
Nodes (10): get_current_user(), get_optional_user(), Get user if authenticated, otherwise return None (for public endpoints)., tests/test_phase5_doctor.py  Phase 5: /api/doctor endpoint tests.  Coverage:   -, If RuntimeManager raises, /api/doctor still returns 200 with a warn check., If DirectChatDoctor.check_all raises, /api/doctor still returns 200., Langfuse check is always emitted (pass or warn based on env)., test_doctor_langfuse_check_present() (+2 more)

### Community 226 - "Community 226"
Cohesion: 0.15
Nodes (13): quick_notes_submit(), Submit a quick-note URL or instruction from the dashboard FAB., TaskExecutionCoordinator, TaskStore, TaskWorkflowService, TaskStore, _get_workflow_engine(), Return a lazily-created WorkflowEngine singleton. (+5 more)
...
Cohesion: 0.17
Nodes (7): _get_model_map(), Merge built-in defaults with MODEL_MAP env overrides (lazy, cached)., Tests that /v1/models exposes Claude/Anthropic alias entries., list_models_openai returns object:list with data array., list_models_openai includes alias entries with owned_by=llm-relay-alias., Each alias entry has a 'description' field showing the target., TestModelsEndpointAliases
...
Cohesion: 0.22
Nodes (13): SimpleNamespace, _client(), TestClient, Tests for activation_api — instance status, OpenAPI schema, and role route.  Reg, test_change_role_rejects_invalid_role(), test_change_role_requires_authentication(), test_change_role_returns_404_for_missing_user(), test_change_role_updates_existing_user() (+5 more)
...
Cohesion: 0.26
Nodes (6): _fmt_name(), AsyncClient, Fetch skills from all configured GitHub registries. Returns count added., Force-refresh remote skills, bypassing TTL. Returns count added., Fetch one GitHub registry and return a list of RegistrySkill objects.          H, Fetch a flat .md file and convert it to a RegistrySkill.
...
Cohesion: 0.24
Nodes (8): _apply_update(), _InsertResult, _match(), _new_id(), _now_iso(), db/sqlite_store.py — Async SQLite storage backend.  Provides a Motor-compatible, Return True if *doc* satisfies the MongoDB-style *query*.      Supports: exact m, Apply a MongoDB-style update operator dict to *doc* in place.

### Community 402 - "Community 402"
Cohesion: 0.22
Nodes (4): Connection, Top-level store — exposes collections as attributes.      Usage::          store, Create tables if they don't already exist., SQLiteStore
...
Cohesion: 0.25
Nodes (9): _build_agent_status_snapshot(), _build_agent_stream_event(), _ensure_agent_session_exists(), _extract_agent_tool_calls(), _get_agent_session_for_user(), get_agent_status(), _normalize_agent_stream_event(), stream_agent_activity() (+1 more)
...
Cohesion: 0.22
Nodes (8): Agents, Environment variables, Free model set, FreeBuff — free-NVIDIA coding agent, `/freebuff <task>`, HTTP API, Rate-limit exemption, Telegram phone control
...
Cohesion: 0.25
Nodes (7): Return ``(doc_index, cosine_score)`` pairs for the top-*k* matches., Return lowercase alphanumeric tokens with stop-words removed.      Numeric token, _tokenize(), test_tokenize_empty(), test_tokenize_lowercases(), test_tokenize_numbers_kept(), test_tokenize_removes_stop_words()

### Community 458 - "Community 458"
Cohesion: 0.25
Nodes (4): Build git intelligence: hotspots, ownership, co-change pairs., Run a git command and return stdout as string., Compute cyclomatic complexity for Python files.         Returns 0 for non-Python, Extract architectural decisions from git history and inline comments.
...
Cohesion: 0.32
Nodes (5): default_keys_path(), load_key_store(), Path, Persistent API key store: each key maps to email + department (seat) and a stabl, main()
...
Cohesion: 0.20
Nodes (4): Build symbol-level dependency graph for Python files., Mark that we have updated intelligence up to this commit., Test that WorkspaceTools initializes correctly., test_workspace_tools_initialization()
...
Cohesion: 0.20
Nodes (6): quick_notes_list(), Resume a paused agent job for *session_id*.      When the agent loop reaches a h, Trigger a remote registry refresh (fetches from GitHub registries)., List queued quick-notes., refresh_skills(), resume_agent_chat_job()
...
Cohesion: 0.50
Nodes (3): Sprint retrospective notes and follow-up action items., Whether the retrospective has any recorded content., Retrospective
...
## Knowledge Gaps
- **2888 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `SessionStart`, `Stop`, `schema_version` (+2883 more)
...
- **Why does `AgentRunner` connect `Community 6` to `Community 0`, `Community 1`, `Community 5`, `Community 104`, `Community 10`, `Community 11`, `Community 107`, `Community 366`, `Community 79`, `Community 16`, `Community 111`, `Community 18`, `Community 17`, `Community 272`, `Community 24`, `Community 153`, `Community 250`, `Community 124`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `WorkspaceManifest` connect `Community 54` to `Community 1`, `Community 452`, `Community 299`, `Community 495`, `Community 274`, `Community 531`, `Community 532`, `Community 59`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `ProviderConfig` connect `Community 1` to `Community 163`, `Community 35`, `Community 5`, `Community 164`, `Community 232`, `Community 11`, `Community 16`, `Community 145`, `Community 149`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Are the 142 inferred relationships involving `AgentRunner` (e.g. with `InternalAgentAdapter` and `AdminIdentity`) actually correct?**
  _`AgentRunner` has 142 INFERRED edges - model-reasoned connections that need verification._
- **Are the 134 inferred relationships involving `AgentSessionStore` (e.g. with `AdminIdentity` and `AgentPhaseError`) actually correct?**
  _`AgentSessionStore` has 134 INFERRED edges - model-reasoned connections that need verification._
...
- **Are the 105 inferred relationships involving `RuntimeUnavailableError` (e.g. with `AiderAdapter` and `ClaudeCodeAdapter`) actually correct?**
  _`RuntimeUnavailableError` has 105 INFERRED edges - model-reasoned connections that need verification._