# Graph Report - autonomous-ai-agency  (2026-09-19)

## Corpus Check
- 1527 files · ~2,218,969 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 54 file(s) not represented in the graph (top: (none) 16, .bat 5, .css 5)

## Summary
- 32265 nodes · 59986 edges · 1353 communities (1174 shown, 132 thin omitted)
...
- .get_repository_map
- Configuration reference
- test_hydrate_with_no_store_returns_zero
- _Decision
- TestAdminEndpoints
- .list_workspaces
- .__init__
...
## Communities (1353 total, 132 thin omitted)

### Community 0 - "company_api.py"
Cohesion: 0.02
Nodes (204): ephemeral_ttl_hours(), Async read of the ephemeral TTL (hours) straight from the DB., account_lifecycle(), AccountLifecycleResponse, auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint() (+196 more)

### Community 1 - "LLMRequest"
Cohesion: 0.03
Nodes (126): ProviderConfig, One configured endpoint. ``kind`` selects the adapter: ``openai`` (any OpenAI-…, AnthropicProvider, Any, Translate OpenAI-shaped messages into Anthropic's system/turn split., OpenAI carries a tool result as role="tool" with a tool_call_id; Anthropic…, OpenAI puts a tool call alongside the assistant's text; Anthropic needs…, Return the cache_control block appropriate for this provider's TTL setting.… (+118 more)

### Community 2 - "get_db"
Cohesion: 0.03
Nodes (101): auth_me(), auto_recommend_skills(), brain_failover_status(), brain_providers(), _check_storage_health(), cost_attribution_stats(), discover_remote_skills(), doctor_health() (+93 more)
...
Cohesion: 0.02
Nodes (134): get_budget(), packages/llm/budget.py — token and cost accounting with spend alerts. Tracks…, The process-wide budget tracker., Test hook — clear all usage accounting., reset(), get_cache(), packages/llm/cache.py — layered caching. Five independent layers, each with its…, The process-wide cache manager. (+126 more)

### Community 5 - "proxy.py"
Cohesion: 0.03
Nodes (165): Describes a single worker's task and constraints., WorkerSpec, get_skill_registry_safe(), Return the global SkillRegistry if set, else None. Used by onboarding and other…, middleware, admin_control(), admin_delete_user(), admin_login() (+157 more)

### Community 6 - "Task"
Cohesion: 0.03
Nodes (75): Task, Full task/issue document., Task, _gate_outward_facing_enabled(), _is_brain_connection_error(), _is_outward_facing(), Any, BaseException (+67 more)

### Community 7 - "ExecutionRequest"
Cohesion: 0.05
Nodes (40): Execute work through the 11-phase golden path., Called by APScheduler when a cron fires. Dispatches to the orchestrator. This…, _scheduler_on_fire(), workflow_orchestrator_execute(), get_orchestrator_supervisor(), OrchestratorSupervisor, Any, Emit an alert to the activity feed and log. (+32 more)

### Community 8 - "TaskSpec"
Cohesion: 0.03
Nodes (145): kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, AiderAdapter, TaskResult, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Run aider non-interactively via `--message` flag., Adapter for Aider — TIER 3 specialized git-aware code editor., json_safe() (+137 more)

### Community 9 - "WebsiteScanner"
Cohesion: 0.03
Nodes (72): main(), Post-deploy verification for the website scanner against the LIVE internet.…, Returns (url, ok, summary)., _scan_one(), _is_safe_url(), _looks_like_bot_challenge(), Any, BeautifulSoup (+64 more)
...
Cohesion: 0.02
Nodes (101): AlertHandler, int, BudgetTracker, Counter, _Dimensions, _month(), Any, Register a callback fired when a spend threshold is crossed. (+93 more)

### Community 12 - "brain_config.py"
Cohesion: 0.03
Nodes (108): _active_primary_provider(), BrainConfig, BrainConfigPatch, BrainConfigStore, default_brain_config(), get_brain_config(), is_north_mini_code_default(), provider_api_keys() (+100 more)

### Community 13 - "backend/server.py"
Cohesion: 0.02
Nodes (220): admin_seed(), AgentStatusEntry, AgentStatusResponse, AgentToolCallEntry, ApiKeyCreate, AuthorizeReposBody, BrainTestRequest, _build_agent_status_snapshot() (+212 more)

### Community 14 - "test_ceo_dispatcher.py"
Cohesion: 0.03
Nodes (84): CEOResult, _decompose_into_subtasks(), _merge_changed_files(), Reset the singleton (test helper)., Aggregated output from a multi-specialist execution., Decompose a request into 2-3 sub-tasks for specialist fan-out. Default…, Collect changed_files across all specialists into a single de-duped list., reset_ceo_dispatcher() (+76 more)

### Community 15 - "AgentRunner"
Cohesion: 0.04
Nodes (54): AgentRunner, _run(), Any, Path, Governance seam: judge the call, run it, audit the outcome. Deliberately a thin…, Append an event to the durable session log if a store is wired in., Summarise a long history and compact it. Asks the planner model to write a…, Send chat messages and return the assistant's text output. If an… (+46 more)
...
### Community 17 - "Specialist"
Cohesion: 0.03
Nodes (38): A specialist agent that can be provisioned for company-specific tasks., Check if this specialist can handle a task with given capabilities., Specialist, SpecialistFamily, SystemType, Add a specialist to a company. Args: company_id: Company ID name: Specialist…, Get a specialist by ID., Get all specialists of a specific family for a company. Args: company_id:… (+30 more)

### Community 18 - "TaskStatus"
Cohesion: 0.03
Nodes (113): Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., tasks — Task/issue management system. Provides a lightweight task/issue tracker…, _coerce_ts(), Enum, str, tasks/models.py — Pydantic models for the task/issue system., Coerce ISO-8601 datetime strings (from DB) to float timestamps. (+105 more)

### Community 19 - "LLMRouter"
Cohesion: 0.02
Nodes (118): Attempt, packages/llm — the multi-provider LLM routing layer. Every LLM call in this…, Read the environment variables named in ``env_names`` into a key list. Order is…, resolve_keys(), AsyncClient, packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, classify_error(), LLMProvider (+110 more)

### Community 20 - "SelfHealingAgent"
Cohesion: 0.03
Nodes (83): FailureCategory, heal_signature(), HealingEvent, HealState, _now(), Any, Enum, str (+75 more)

### Community 21 - "_fixture"
Cohesion: 0.02
Nodes (80): parse_event_stream(), ParsedRun, Structured view of one ``--mode json`` event stream., Reduce a ``--mode json`` NDJSON stream to a :class:`ParsedRun`. Kept a module-…, _clear_discovered_models(), _clear_response_cache(), _isolate_brain_data_layer(), _isolate_operator_provider_state() (+72 more)

### Community 22 - "test_web_reach.py"
Cohesion: 0.05
...
Cohesion: 0.04
Nodes (85): simulate_policy(), _load(), Import the governance layer once, recording why if it is absent., _action_matches(), _as_list(), Decision, get_policy_engine(), GroupPolicy (+77 more)

### Community 28 - "test_llm_router_resilience.py"
Cohesion: 0.03
...
### Community 30 - "CEODispatcher"
Cohesion: 0.06
Nodes (39): CEODispatcher, _runner_factory(), _complexity_rank(), _offload(), Any, services/ceo_dispatcher.py — Real CEO delegation layer. The CEO splits a…, Run a synchronous ledger call without blocking the event loop. ``CEOLedger`` is…, Build an agent.coordinator.TaskSpec from a CEO SpecialistTask. (+31 more)
...
Cohesion: 0.03
Nodes (78): Force a catalog mirror rebuild + persist (admin only). Rebuilds the catalog…, sync_catalog_route(), all_provider_ids(), _provider_ids_from_literal(), provider_key_present(), Return every provider id recognised by the brain config system. Iterates the…, True when the env var for *provider*'s key is set (or it's Ollama)., Return the provider ids allowed by the ``BrainProvider`` Literal. Reads the… (+70 more)

### Community 33 - "TaskWorkflowService"
Cohesion: 0.04
Nodes (59): AgentDefinition, AgentStore, Any, field_validator, agents/store.py — Persistent store for user-defined agent configurations.…, CRUD store for AgentDefinition objects. Uses MongoDB when a `db` client is…, Return an agent by ID. If *owner_id* is provided, enforces that the agent…, Delete an agent. Returns True on success, False if not found/unauthorised. (+51 more)
...
### Community 36 - "test_ceo_micromanager.py"
Cohesion: 0.04
...
### Community 38 - "CompanyGraphStore"
Cohesion: 0.03
Nodes (34): Find a repository by its URL., A company repository with detected technologies and metadata., Extract the owner from the full name., Extract the repository name from the full name., Repo, Add a repository to a company. Args: company_id: Company ID url: Repository URL…, Initialize the service. Args: store: Optional CompanyGraphStore instance. If…, Get a repository by ID. (+26 more)
...
### Community 40 - "AgentSessionStore"
Cohesion: 0.03
Nodes (66): Agent subsystem — planner / executor / verifier loop., AgentEvent, AgentPlan, AgentRunRequest, AgentSession, AgentSessionCreateRequest, AgentSessionMessage, AgentStep (+58 more)
...
### Community 42 - "services/seo_audit.py"
Cohesion: 0.05
...
### Community 43 - "resolve_identity"
Cohesion: 0.04
Nodes (73): list_all_approvals(), list_pending(), _do_run_agent_job(), _run_agent_job(), wait_for_resume(), get_approval_store(), BudgetExceeded, evaluate_call() (+65 more)
...
### Community 45 - "AgentJobManager"
Cohesion: 0.02
Nodes (84): PreflightIssue, PreflightReport, BaseModel, AgentJob, AgentJobManager, heartbeat(), make_isolated_workspace(), _now() (+76 more)
...
### Community 47 - "test_agent_runner.py"
Cohesion: 0.04
...
### Community 49 - "test_model_router.py"
Cohesion: 0.03
...
### Community 55 - "get_task_store"
Cohesion: 0.05
Nodes (72): quick_notes_submit(), _QuickNoteBody, Submit a quick-note URL or instruction from the dashboard FAB., get_failover_manager(), Return the singleton BrainFailoverManager., Reset the singleton (for tests)., reset_failover_manager(), _blocked_retire_age_sec() (+64 more)

### Community 56 - "TestAddConversationCacheBreakpoints"
Cohesion: 0.06
...
### Community 57 - "get_runtime_manager"
Cohesion: 0.05
...
### Community 59 - "direct_chat.py"
Cohesion: 0.04
Nodes (83): DirectChatDoctor, Any, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, Translate technical preflight issues into a conversational assistant reply., translate_error_to_conversational(), classify_direct_chat_intent(), _contains_keyword(), detect_intent() (+75 more)
...
Cohesion: 0.06
Nodes (35): Replace the process-wide store. Tests only., reset_approval_store(), AuditEvent, AuditLog, Any, One governed action, fully described. Field order follows the…, One-line JSON, suitable for a SIEM shipper tailing the log., Bounded in-memory ring buffer plus a structured log stream. The ring buffer… (+27 more)

### Community 62 - "HttpxFetcher"
Cohesion: 0.05
...
### Community 63 - "RepowiseIntelligence"
Cohesion: 0.07
...
Cohesion: 0.04
Nodes (59): _bootstrap_within_budget(), _create_bootstrap_indexes(), ensure_bootstrap(), Await one warm-up step, deferring it to the background if it overruns.…, The task store the background services should use, wiring it if needed.…, Point the feature stores at the shared database connection. Deliberately…, Create every boot index concurrently rather than one round-trip at a time.…, Idempotent bootstrap for indexes + seeded admin/providers. FastAPI startup… (+51 more)

### Community 66 - "services/background.py"
Cohesion: 0.03
Nodes (95): get_improvement_loop(), _dispatch_async(), _run(), _ErrorCaptureHandler, get_log_monitor(), LogMonitor, _note_recurrence(), Any (+87 more)

### Community 67 - "resolve_active_brain"
Cohesion: 0.03
Nodes (97): BrainResolution, provider_api_key(), Return the live API key for *provider* (env-only — never persisted)., get_active_brain_sync(), get_brain_preference(), get_provider_role_tags(), _host_is_openai_compatible(), invalidate_brain_cache() (+89 more)

### Community 68 - "BrainWatchdog"
Cohesion: 0.04
Nodes (62): _migrate_brain_to_safe_default(), get_brain_config_store(), Return the process-wide ``BrainConfigStore`` singleton., Any, packages/ai/self_heal.py — automatic brain self-healing. When the active brain…, Background tick that runs self_heal_brain_and_unblock_tasks(). Called from the…, One-shot self-healing pass. 1. Checks if the active brain provider is in a…, self_heal_brain_and_unblock_tasks() (+54 more)

### Community 69 - "telegram_bot.py"
Cohesion: 0.06
Nodes (63): get_decisions_store(), Process-wide DecisionsStore singleton (resettable via db_path arg)., Return a Markdown-v1-safe preview string under ``max_chars``. Used by the…, sanitize_paste_for_preview(), _admin_headers(), _answer_callback(), _api_headers(), _check_rate_limit() (+55 more)

### Community 70 - "WorkspaceManager"
Cohesion: 0.10
...
### Community 74 - "build_governance_router"
Cohesion: 0.04
Nodes (57): build_governance_router(), approve(), _decide(), deny(), destroy_sandbox(), get_audit(), get_budget(), get_metrics() (+49 more)
...
### Community 76 - "brain_failover.py"
Cohesion: 0.07
...
### Community 77 - "test_brain_failover.py"
Cohesion: 0.07
...
### Community 79 - "test_slop_gate.py"
Cohesion: 0.07
...
Cohesion: 0.04
Nodes (51): _normalize_nvidia_base_url(), _openai_url(), Normalize NVIDIA base URLs to avoid double /v1 when openai_compat_url appends…, Registry base URLs must produce routes the provider actually serves., brain_failover must not drift from the catalog's base URLs., TestFailoverRegistryBaseUrls, _clear_probe_locks(), anyio (+43 more)

### Community 81 - "test_agent_tool_governance.py"
Cohesion: 0.07
...
### Community 89 - "agent/workspace.py"
Cohesion: 0.05
...
### Community 92 - "test_ai_insights.py"
Cohesion: 0.05
...
### Community 93 - "test_repo_connection.py"
Cohesion: 0.06
...
### Community 94 - "test_procedural_memory.py"
Cohesion: 0.05
...
### Community 96 - "AgentJobRequest"
Cohesion: 0.06
Nodes (25): AgentJobError, AgentJobRequest, AgentJobResult, AgentJobSnapshot, Any, BaseModel, field_validator, agent/contract.py — Typed public contract for the agent job lifecycle. Phase 1… (+17 more)
...
### Community 98 - "PersistentMemoryStore"
Cohesion: 0.08
...
### Community 99 - "OnboardingScreen.jsx"
Cohesion: 0.04
...
### Community 101 - "failover_client.py"
Cohesion: 0.05
Nodes (56): _auto_disable(), _build_request(), _describe_registry(), _disable_unless_key_serves_other_models(), _disabled_ids(), FailoverResult, _is_billing_refusal(), _is_ollama() (+48 more)

### Community 102 - "config.py"
Cohesion: 0.03
Nodes (77): AgentPolicy, _apply_env_overrides(), _apply_key_env(), _build(), _coerce(), config_dir(), _env_key_names(), expand_env() (+69 more)

### Community 103 - "resolve_e2b_config"
Cohesion: 0.05
...
### Community 105 - "TestModelRoleSeparation"
Cohesion: 0.40
...
### Community 110 - "test_trend_scoping.py"
Cohesion: 0.09
...
### Community 112 - "FinancialMetrics"
Cohesion: 0.06
...
### Community 114 - "ProviderRouter"
Cohesion: 0.06
Nodes (38): _acquire_provider_probe(), _dead_model_key(), _exponential_backoff_cooldown(), _get_director(), is_commercial_provider(), _mark_model_dead(), _normalized_provider_type(), _notify_watchdog() (+30 more)

### Community 115 - "test_colibri_provider.py"
Cohesion: 0.12
...
### Community 119 - "Platform Guide — the full tour"
Cohesion: 0.11
...
### Community 120 - "register_webui"
Cohesion: 0.11
Nodes (26): allow_paid_brain(), True only when the operator explicitly opted into a paid (Anthropic) brain.…, _admin_out(), register_webui(), _admin_app_index(), _admin_app_spa(), admin_bootstrap(), admin_create_provider() (+18 more)

### Community 121 - "_StubProvider"
Cohesion: 0.08
...
### Community 124 - "workflow_orchestrator.py"
Cohesion: 0.08
Nodes (49): BoundContext, ClassifyOutput, ExecutionResult, JudgeVerdict, MonitorOutput, _orchestrator_bypass(), PersistOutput, Phase (+41 more)

### Community 125 - "AgileSprint"
Cohesion: 0.05
...
### Community 126 - "RenderOpsMonitor"
Cohesion: 0.08
...
### Community 129 - "_governance_check"
Cohesion: 0.08
Nodes (40): _blocked_result(), _governance_check(), _governance_identity(), Any, TaskResult, Build the failed TaskResult returned when policy denies a dispatch. A result…, Evaluate a runtime dispatch against policy; audit it either way. Returns…, Resolve the acting identity for a runtime dispatch. Identity comes from… (+32 more)

### Community 130 - "test_log_monitor_storm_guard.py"
Cohesion: 0.48
...
### Community 132 - "test_trend_watcher.py"
Cohesion: 0.06
Nodes (34): _FakeClient, _FakeResp, asyncio, Tests for agent/trend_watcher.py, Ensure expanded keyword set covers key new categories., A release is scored by its notes, never the old blanket 0.95 that let five…, Only the newest release is force-surfaced; older routine patch releases in the…, A routine latest release still surfaces (our niche) but is informational — not… (+26 more)
...
### Community 134 - "pr_approval_gate.py"
Cohesion: 0.06
...
### Community 136 - "test_sam_livekit.py"
Cohesion: 0.05
...
### Community 137 - "test_sqlite_store.py"
Cohesion: 0.06
...
### Community 140 - "TestHarnessAdapter"
Cohesion: 0.05
...
### Community 147 - "test_provider_state_durability.py"
Cohesion: 0.05
...
### Community 152 - "test_p0_roadmap_b1_c2_a3.py"
Cohesion: 0.06
...
### Community 155 - "TestRuntimeControl"
Cohesion: 0.04
...
### Community 156 - "_FakeCommandResult"
Cohesion: 0.12
...
### Community 160 - "ensure_self_company"
Cohesion: 0.06
...
### Community 161 - "ProviderConfig"
Cohesion: 0.05
Nodes (42): provider_access_tier(), ProviderConfig, Infer an access tier from *hostname*, longest matching suffix winning. Returns…, _tier_from_hostname(), _nvidia_provider_chain(), ProviderConfig, Build Nvidia NIM provider config from env. Empty list when key is absent., Regression tests for the agent loop's multi-provider failover wire format.… (+34 more)
...
### Community 163 - "test_runtimes_health_endpoint.py"
Cohesion: 0.25
...
### Community 166 - "test_webui_provider_priority.py"
Cohesion: 0.16
...
### Community 169 - "test_loop_registry.py"
Cohesion: 0.10
...
### Community 171 - "resolve_provider_for"
Cohesion: 0.06
...
### Community 175 - "WorkflowBuildRequest"
Cohesion: 0.09
...
### Community 182 - "ContextWindowManager"
Cohesion: 0.08
...
### Community 183 - "test_telegram_freebuff.py"
Cohesion: 0.07
...
### Community 185 - "test_portfolio_intelligence.py"
Cohesion: 0.05
...
### Community 186 - "control_overrides.py"
Cohesion: 0.08
...
### Community 188 - "get_tool_annotations"
Cohesion: 0.08
...
Cohesion: 0.06
Nodes (34): _clean_e2b_env(), fake_sandbox(), _FakeAsyncSandboxClass, _FakeCmdResult, _FakeCommands, _FakeFiles, _FakeSandbox, patched_async_sandbox() (+26 more)

### Community 194 - "activation.py"
Cohesion: 0.08
...
### Community 195 - "activation_api.py"
Cohesion: 0.09
...
### Community 196 - "test_platform_controls.py"
Cohesion: 0.05
...
### Community 201 - "test_portfolio_intake.py"
Cohesion: 0.08
...
### Community 203 - "kimi_bridge_provider_config"
Cohesion: 0.11
Nodes (24): _enabled(), kimi_bridge_provider_config(), kimi_bridge_status(), _norm_env(), ProviderConfig, Free Kimi (Moonshot) **web-bridge** provider. Why this exists ---------------…, Lightweight status used by the Providers UI / Doctor., Return a free, OpenAI-compatible ``ProviderConfig`` for the Kimi bridge.… (+16 more)
...
### Community 205 - "test_compare_runtimes.py"
Cohesion: 0.10
...
### Community 208 - "test_executive_advisory.py"
Cohesion: 0.13
...
### Community 209 - "lifespan"
Cohesion: 0.05
Nodes (30): _keepalive_self_ping(), lifespan(), _deferred_startup_cleanup(), Return orchestrator queue depth, active runs, and supervisor state (#522)., Run the FreeBuff Telegram bot, restarting it on unexpected exit., Ping our own public URL so a free-tier web service doesn't sleep. Render free…, Start the Telegram bot (and keep-alive) inside the web process when enabled.…, #522 + #505: Reliability startup — schedule hydration, orchestrator restore,… (+22 more)

### Community 210 - "test_governance_enforcement.py"
Cohesion: 0.03
Nodes (70): ApprovalRequest, ApprovalStatus, ApprovalStore, Any, Enum, str, packages/governance/approvals.py — human-in-the-loop for high-risk actions. The…, Bounded, in-process store of approval requests. Uses a :class:`threading.Lock`… (+62 more)
...
### Community 213 - "test_failover_silent_exhaustion.py"
Cohesion: 0.06
...
### Community 215 - "portfolio_intelligence.py"
Cohesion: 0.07
Nodes (45): generate_standup(), Build a :class:`StandupReport` from ``.claude/state/active-tasks.md``. Reads…, InitiativeStatus, _bug_scores(), _clean(), _default_repo(), _env_github_token(), estimate_job_size() (+37 more)

### Community 216 - "timedelta"
Cohesion: 0.08
Nodes (35): PR throughput per cohort over the last `days` days., Count distinct sessions per user. A session ends when there's a gap of more…, _as_aware_utc(), _company_alive(), _company_id_for_agent(), _env_float(), ephemeral_reaper_loop(), datetime (+27 more)
...
### Community 218 - "_resolve_user_github_token"
Cohesion: 0.09
...
### Community 221 - "TaskBoardScreen.jsx"
Cohesion: 0.06
...
### Community 223 - "test_schedule_backlog_drain.py"
Cohesion: 0.09
...
### Community 227 - "model_router.py"
Cohesion: 0.06
Nodes (34): Dynamic model router package. Public API:: from router import get_router,…, _build_builtin_model_map(), _default_model(), _default_reasoning_model(), ModelRouter, _nvidia_key_present(), Any, Dynamic model router. Central routing logic for all chat and agent requests.… (+26 more)

### Community 228 - "resolve_component_model"
Cohesion: 0.07
...
Cohesion: 0.08
Nodes (27): engine(), WorkflowEngine, _fake_artifact(), _make_engine(), tests/test_crispy_workflow.py — CRISPY workflow engine hardening tests. Tests…, Create a WorkflowEngine with isolated storage., TestAbortOnFailure, _test() (+19 more)

### Community 231 - "TrendWatcher"
Cohesion: 0.14
...
### Community 234 - "Kept Rules — the 44 that survive the audit"
Cohesion: 0.05
...
### Community 235 - "anthropic_compat.py"
Cohesion: 0.09
...
### Community 237 - "skill_bindings.py"
Cohesion: 0.03
Nodes (84): Enum, SuperClaude Workflow Engine — Workflow, Task, and topological DAG execution.…, Return tasks whose dependencies are all satisfied., Number of tasks in the workflow., Number of completed tasks., Number of failed tasks., Executes workflows using topological ordering., Register a workflow with the engine. (+76 more)

### Community 238 - "gsap.min.js"
Cohesion: 0.06
...
### Community 243 - "TestAuthAndTaskOwnership"
Cohesion: 0.05
...
### Community 247 - "test_pr923_fixes.py"
Cohesion: 0.07
...
### Community 252 - "ApprovalCheckpoint"
Cohesion: 0.17
...
### Community 253 - "test_telegram_approval_gate.py"
Cohesion: 0.08
...
### Community 255 - "test_telegram_webhook.py"
Cohesion: 0.06
...
### Community 257 - "test_unit7_catalog_propagation.py"
Cohesion: 0.06
...
### Community 258 - "test_brain_patch_service_token.py"
Cohesion: 0.18
...
### Community 259 - "openclaw_gateway.py"
Cohesion: 0.09
...
### Community 261 - "get_scheduler"
Cohesion: 0.04
Nodes (50): get_agency(), set_agency(), _autonomy_bg_cycle(), autonomy_tick(), Background CEO cycle + task dispatch. Runs fire-and-forget., Execute ONE pending task synchronously. Called by the cron workflow every 2…, get_scheduler(), agent/scheduler.py — Scheduled Agent Jobs Cron-based job scheduler. Each job… (+42 more)
...
### Community 265 - "sam_livekit_worker.py"
Cohesion: 0.11
Nodes (26): get_sam(), LiveKitConfig, voice/livekit_config.py — LiveKit configuration (config module). Centralizes…, Resolved LiveKit + speech-provider configuration., True when the LiveKit room transport itself is usable., _build_llm(), _build_stt(), _build_tts() (+18 more)

### Community 266 - "AgileManager"
Cohesion: 0.06
...
### Community 267 - "KnowledgeScreen.jsx"
Cohesion: 0.06
...
### Community 275 - "chat_handlers.py"
Cohesion: 0.11
Nodes (35): _apply_chat_defaults(), _emit_safely(), _extract_exact_output(), _filter_fragment(), _filter_openai_sse_line(), handle_ollama_native_chat(), handle_openai_chat_completions(), _single_exact_stream() (+27 more)

### Community 276 - "tests/conftest.py"
Cohesion: 0.08
Nodes (34): get_current_user(), get_optional_user(), Get user if authenticated, otherwise return None (for public endpoints)., Item, app_client(), client(), non_admin_client(), Config (+26 more)

### Community 277 - "TestSchedulerStore"
Cohesion: 0.09
...
### Community 283 - "test_operational_incidents.py"
Cohesion: 0.02
...
### Community 286 - "test_daily_2026_06_04.py"
Cohesion: 0.08
...
### Community 288 - "control_registry.py"
Cohesion: 0.10
...
### Community 291 - "test_ceo_router.py"
Cohesion: 0.09
Nodes (35): _env_flag(), _env_int(), services/ceo_supervisor.py — the CEO's 24x7 babysitting loop. Delegation alone…, Read a bounded int, clamping out-of-range values rather than raising., Install (or clear) the singleton — used by startup wiring and tests., Drop the singleton (test helper)., Bounds for the unattended supervision loop., reset_ceo_supervisor() (+27 more)
...
### Community 297 - "test_brain_priority_scanner.py"
Cohesion: 0.08
...
### Community 298 - "Configuration Reference"
Cohesion: 0.06
...
### Community 307 - "test_render_mcp.py"
Cohesion: 0.08
...
### Community 308 - "ContextCompressor"
Cohesion: 0.11
...
### Community 311 - "ResourceWatchdog"
Cohesion: 0.10
...
### Community 314 - "test_provider_render_env.py"
Cohesion: 0.09
...
### Community 316 - "BrainFailoverManager"
Cohesion: 0.09
...
Cohesion: 0.06
Nodes (43): Charge sub-agent nesting depth and enforce the ``max_depth`` ceiling. Isolates…, get_audit_log(), packages/governance/audit.py — the evidence trail for every governed action.…, Redact SSNs and Luhn-valid payment-card numbers from a string. Runs after the…, Redact secret-shaped substrings, then truncate., Return the process-wide audit log, created on first use., Convenience: build and record an event in one call., record_event() (+35 more)

### Community 318 - "test_microagents.py"
Cohesion: 0.15
...
### Community 319 - "get_store"
Cohesion: 0.11
Nodes (29): all_settings(), _as_bool(), _as_int(), ephemeral_ttl_hours_cached(), get_setting(), _maybe_schedule_refresh(), onboarding_gate_enabled(), onboarding_gate_enabled_cached() (+21 more)

### Community 320 - "Security Analysis — local-llm-server"
Cohesion: 0.06
...
### Community 321 - "call_llm"
Cohesion: 0.03
Nodes (59): agent/sam.py — SAM Voice Agent (System Autonomy Manager) SAM is the voice-…, _agent_provider_failure_response(), _agent_timeout_fallback_response(), _append_agent_session_message(), _build_auto_skill_guidance(), _build_provider_router(), _builtin_provider_records(), call_llm() (+51 more)

### Community 322 - "Langfuse Observability Guide"
Cohesion: 0.06
...
### Community 324 - "probe_catalogues.py"
Cohesion: 0.10
Nodes (30): _auth_headers(), _chat_targets(), _dump_matching(), _kind(), list_models(), _list_or_report(), main(), _parse_args() (+22 more)

### Community 325 - "_ts_to_float"
Cohesion: 0.09
Nodes (26): Return BLOCKED tasks that are candidates for auto-retry., Return tasks due within the next N hours (any user)., Return tasks parked at the pre-execution approval gate (any user). A task is…, Reset tasks that are stuck IN_PROGRESS but no longer actively executing. A task…, Normalise a timestamp value to a float Unix epoch. Handles: - float / int…, _ts_to_float(), asyncio, tests/test_reconciler_iso8601.py — regression test for the TaskDispatcher… (+18 more)

### Community 326 - "test_telegram_mutating_commands.py"
Cohesion: 0.09
...
### Community 327 - "test_workspace_isolation.py"
Cohesion: 0.17
...
### Community 332 - "High-Agency Frontend Skill"
Cohesion: 0.06
Nodes (30): 10. FINAL PRE-FLIGHT CHECK, 1. ACTIVE BASELINE CONFIGURATION, 2. DEFAULT ARCHITECTURE & CONVENTIONS, 3. DESIGN ENGINEERING DIRECTIVES (Bias Correction), 4. CREATIVE PROACTIVITY (Anti-Slop Implementation), 5. PERFORMANCE GUARDRAILS, 6. TECHNICAL REFERENCE (Dial Definitions), 7. AI TELLS (Forbidden Patterns) (+22 more)

### Community 333 - "UserMemoryStore"
Cohesion: 0.12
...
### Community 336 - "Quick-Note GitHub Issues Processing - Session Summary"
Cohesion: 0.06
...
### Community 338 - "validate_outbound_url"
Cohesion: 0.14
...
### Community 342 - "test_agency_fix.py"
Cohesion: 0.06
...
### Community 343 - "test_chat_mode_regressions.py"
Cohesion: 0.11
...
### Community 344 - "SQLiteStore"
Cohesion: 0.02
Nodes (84): BusinessCategory, Company, KnowledgeItem, The core company entity - root of the Company Graph., Structured knowledge about the company, systems, or processes., A company website with detected systems and stack inference., Website, requires_db (+76 more)

### Community 345 - "test_skill_registry_boot_refresh.py"
Cohesion: 0.11
...
### Community 346 - "test_autonomy_gate.py"
Cohesion: 0.12
...
### Community 347 - "test_phase6_workflow.py"
Cohesion: 0.13
...
Cohesion: 0.12
Nodes (18): AgentRole, workflow/artifact_store.py — Durable artifact persistence. Artifacts are stored…, Artifact, A durable, phase-produced document (markdown or JSON)., Return the first artifact matching *name*, or None., PhaseRunner, Path, PhaseType (+10 more)

### Community 349 - "_register_builtin_tools"
Cohesion: 0.09
...
### Community 350 - "InternalAgentAdapter"
Cohesion: 0.06
...
### Community 351 - "test_scheduler_hydration_bounded.py"
Cohesion: 0.08
Nodes (25): _hydrate_scheduler_bounded(), Attach durable persistence and rehydrate (#505), bounded by a budget. Without…, Any, Await ``coro`` until ``deadline`` (a loop timestamp); defer it past that.…, warmup_step(), _BrokenScheduler, _fake_schedule_store(), _FakeStore (+17 more)

### Community 352 - "OrchestratorCheckpointStore"
Cohesion: 0.13
...
### Community 353 - "telegram_service.py"
Cohesion: 0.10
Nodes (20): service_manager.py — Telegram & Notification Integration Extension Extends the…, # NOTE: do NOT re-escape here — services.daily_digest.format_digest_markdown, Best-effort secret/email/IP redaction for outbound Telegram/webhook messages., _redact_for_notification(), _FakeResponse, _make_task(), SimpleNamespace, Regression tests for telegram_service.NotificationDispatcher._notify_webhook.… (+12 more)

### Community 354 - "test_force_cleanup_conditional_delete.py"
Cohesion: 0.10
...
### Community 355 - "test_one_model_catalogue.py"
Cohesion: 0.10
...
### Community 364 - "CompanyAgencyService"
Cohesion: 0.09
...
### Community 365 - "session_retro.py"
Cohesion: 0.13
...
### Community 367 - "test_internal_agent_did_work.py"
Cohesion: 0.12
...
### Community 369 - "executive_advisory.py"
Cohesion: 0.08
...
### Community 373 - "_ensure_tasks_source_id_unique_index"
Cohesion: 0.13
...
### Community 375 - "SetupWizardPage.js"
Cohesion: 0.10
...
### Community 381 - "probe_model_liveness"
Cohesion: 0.05
...
### Community 383 - "test_task_source_id_race.py"
Cohesion: 0.12
...
### Community 384 - "test_regression.py"
Cohesion: 0.10
...
### Community 385 - "test_agent_scripts_share_one_model_list.py"
Cohesion: 0.10
...
### Community 386 - "test_crispy_burn_in.py"
Cohesion: 0.07
...
### Community 387 - "test_executive_advisory_api.py"
Cohesion: 0.11
...
### Community 388 - "test_provider_410_per_model.py"
Cohesion: 0.15
...
### Community 393 - "Deploy: FreeBuff Telegram bot (24×7)"
Cohesion: 0.07
...
### Community 394 - "Claude Code + Qwen Local Setup"
Cohesion: 0.07
...
### Community 395 - "provider_max_rpm"
Cohesion: 0.09
...
### Community 396 - "test_nvidia_default_model.py"
Cohesion: 0.17
...
### Community 398 - "executive_advisory_api.py"
Cohesion: 0.10
...
### Community 399 - "VoiceCommandInterface"
Cohesion: 0.14
...
### Community 400 - "Performance Analysis — local-llm-server"
Cohesion: 0.08
...
### Community 401 - "LLM Router — troubleshooting"
Cohesion: 0.08
...
### Community 403 - "output_filter.py"
Cohesion: 0.07
...
### Community 404 - "test_agent_free_brain.py"
Cohesion: 0.05
...
### Community 409 - "test_brain_migration_writes_a_live_model.py"
Cohesion: 0.10
...
### Community 410 - "test_daily_automation_2026_08_03.py"
Cohesion: 0.11
...
### Community 414 - "TestStreamableHTTPTransport"
Cohesion: 0.12
...
### Community 418 - "TASK 4 — End-to-end approval-gate test"
Cohesion: 0.08
...
### Community 419 - "video_transcript.py"
Cohesion: 0.11
...
### Community 421 - "test_north_mini_code.py"
Cohesion: 0.09
...
### Community 426 - "NIMConnectionPool"
Cohesion: 0.11
...
### Community 427 - "TemporalContextGraph"
Cohesion: 0.10
...
### Community 428 - "test_telegram_approval_e2e.py"
Cohesion: 0.12
...
### Community 429 - "test_activation_api.py"
Cohesion: 0.13
...
### Community 432 - "test_service_token.py"
Cohesion: 0.08
...
### Community 433 - "test_telegram_diag_endpoint.py"
Cohesion: 0.08
...
### Community 439 - "Local AI Stack with Docker"
Cohesion: 0.08
...
### Community 440 - "Implementation Prompt: Rich TaskBoard + Agile Sprint Integration"
Cohesion: 0.08
...
### Community 443 - "model_discovery.py"
Cohesion: 0.08
...
### Community 448 - "test_telegram_auto_approve.py"
Cohesion: 0.21
...
### Community 451 - "register_admin_gui"
Cohesion: 0.17
...
### Community 453 - "_status_snapshot"
Cohesion: 0.15
...
### Community 454 - "openclaw_str_e_fix.py"
Cohesion: 0.15
...
### Community 455 - "Agent Governance Guide"
Cohesion: 0.09
...
### Community 456 - "The fifteen strategies"
Cohesion: 0.09
...
### Community 458 - "implement_agent.py"
Cohesion: 0.12
...
### Community 463 - "SyntheticDataPipeline"
Cohesion: 0.13
...
### Community 464 - "test_cerebras_catalogue.py"
Cohesion: 0.13
...
### Community 466 - "test_mostly_failed_steps.py"
Cohesion: 0.12
...
### Community 468 - "compare_runtimes.py"
Cohesion: 0.16
...
### Community 470 - "HarnessEnrichment"
Cohesion: 0.14
...
### Community 472 - "TestOrchestratorProviderFailover"
Cohesion: 0.11
Nodes (10): tests/test_orchestrator_failover.py — Provider failover, brain resolution,…, End-to-end provider failover through the WorkflowOrchestrator., First provider fails → retry picks next → llm_provenance tracks the winner., The _failed_execute key in llm_provenance records the URLs that failed., A non-retryable error (e.g. ValueError) does not trigger failover., A TimeoutError is retryable and should trigger provider failover., Phases that don't use an LLM (CLASSIFY, PERSIST, etc.) don't record provenance., phase_attempts tracks the attempt count per phase through retries. (+2 more)

### Community 473 - "AdaptivePermissions"
Cohesion: 0.18
...
### Community 475 - "test_dashboard_cache.py"
Cohesion: 0.13
Nodes (17): _cached(), _fast_count(), get_activity(), legacy_scheduler_list(), _produce_scheduler_jobs(), Single-flight TTL cache. Concurrent callers wait for the first producer., Count without materialising rows — prefers estimated_document_count., _CollWithEstimate (+9 more)

### Community 476 - "AdminScreen.jsx"
Cohesion: 0.11
...
### Community 478 - "PriorityTaskQueue"
Cohesion: 0.14
...
### Community 479 - "TestLegacyRouterCacheTTL"
Cohesion: 0.13
...
### Community 480 - "test_anthropic_refusal_fallback.py"
Cohesion: 0.19
...
### Community 481 - "test_gh_brain_failover.py"
Cohesion: 0.10
...
### Community 485 - "V3 API Migration Plan — LLM Relay Platform"
Cohesion: 0.10
...
### Community 487 - "_extract_pytest_failure"
Cohesion: 0.31
...
### Community 488 - "SeoCheckDefinition"
Cohesion: 0.11
...
### Community 491 - "weekly_digest.py"
Cohesion: 0.13
...
### Community 492 - "_process_task_callback"
Cohesion: 0.20
...
### Community 493 - "NotificationDispatcher"
Cohesion: 0.09
...
### Community 494 - "autonomous_fix.py"
Cohesion: 0.15
Nodes (19): _decline(), _fetch_failure_context(), _list_target_prs(), main(), _post_comment(), _pr_head(), _prior_attempt_count(), process_pr() (+11 more)

### Community 495 - "test_local_controller.py"
Cohesion: 0.14
...
### Community 496 - "test_openclaw_str_e_fix.py"
Cohesion: 0.10
...
### Community 497 - "ClaudeCodeAdapter"
Cohesion: 0.19
...
### Community 498 - "test_unit5_ui_provider_surface.py"
Cohesion: 0.10
...
### Community 507 - "Docker AI Governance Audit — Final Report"
Cohesion: 0.10
...
### Community 508 - "1. Capability-by-capability"
Cohesion: 0.10
...
### Community 510 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 511 - "ControlsScreen.jsx"
Cohesion: 0.15
...
### Community 515 - "test_p0_roadmap_a4_a5_b2.py"
Cohesion: 0.14
...
### Community 520 - "TestBrainFailoverModelUpdates"
Cohesion: 0.18
...
### Community 525 - "get_tool_registry"
Cohesion: 0.13
Nodes (13): get_tool_registry(), Return the module-level ToolRegistry singleton. On first call, registers built-…, auto_register(), Any, field_validator, Register the four user-research tools with a ``ToolRegistry``. Each tool wraps…, Register the user research tools into the module-level singleton registry.…, register_user_research_tools() (+5 more)

### Community 526 - "test_minimax_bug_fixes.py"
Cohesion: 0.12
...
### Community 528 - "_extract_tech_relevance"
Cohesion: 0.17
...
### Community 535 - "Skill: fabric-patterns"
Cohesion: 0.11
Nodes (18): 1. Ensure Pattern Directory Exists, 2. List Available Patterns, 3. Retrieve a Pattern, 4. Apply a Pattern with Variables, 5. Stitch Patterns Together, 6. Create New Patterns, Acceptance Checks, Directory Structure (+10 more)
...
### Community 538 - "Admin Dashboard Guide"
Cohesion: 0.11
...
### Community 539 - "Implementation Plan"
Cohesion: 0.11
...
### Community 541 - "TestPolicyAuthoringUiStableClaim"
Cohesion: 0.25
...
### Community 547 - "OrchestratorQueue"
Cohesion: 0.13
...
### Community 552 - "TestMCPToolsListCache"
Cohesion: 0.15
...
### Community 554 - "test_fabric_patterns.py"
Cohesion: 0.11
...
### Community 555 - "test_freebuff_bot.py"
Cohesion: 0.09
...
### Community 556 - "test_repowise_intelligence.py"
Cohesion: 0.11
...
### Community 558 - "test_agent_tools.py"
Cohesion: 0.19
...
### Community 559 - "test_workflow_orchestrator_scoping.py"
Cohesion: 0.17
...
### Community 561 - "handle_workflow_ide_chat"
Cohesion: 0.17
...
### Community 562 - "ErrorInterceptorMiddleware"
Cohesion: 0.18
...
### Community 571 - "Part A — Health Report"
Cohesion: 0.11
...
### Community 574 - "router/health.py"
Cohesion: 0.16
...
### Community 575 - "sync_readme_gallery.py"
Cohesion: 0.22
...
### Community 581 - "test_monitor_lib.py"
Cohesion: 0.15
...
### Community 582 - "TestOrchestratorQueue"
Cohesion: 0.13
...
### Community 584 - "TestStopSlopChecker"
Cohesion: 0.11
...
### Community 585 - "test_schedule_persistence.py"
Cohesion: 0.15
...
### Community 592 - ".start_onboarding"
Cohesion: 0.12
Nodes (9): Workflow, Start the onboarding process for a company. Args: company_id: Company ID…, Schedule a fire-and-forget background task, keeping a strong reference.…, Force-refresh the dynamic skill registry and log tech-stack recommendations.…, Activate a company's 24x7 agency runtimes in the background. Runs after…, Scan a website and save the results. Args: company_id: Company ID url: Website…, Create initial workflows for a company. Args: company_id: Company ID Returns:…, Extract company name from a URL. Args: url: Website URL Returns: Extracted… (+1 more)

### Community 593 - "SKILL: Industrial Brutalism & Tactical Telemetry UI"
Cohesion: 0.12
...
### Community 594 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 595 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 598 - "Section-by-Section Acceptance Criteria"
Cohesion: 0.12
...
### Community 601 - "agent_readiness_audit.py"
Cohesion: 0.21
...
### Community 605 - "e2e/test_browser.py"
Cohesion: 0.19
...
### Community 606 - "workflow/models.py"
Cohesion: 0.21
...
### Community 607 - "test_frontend_deployment_guards.py"
Cohesion: 0.18
...
### Community 608 - "test_health_endpoints.py"
Cohesion: 0.17
...
### Community 609 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 610 - "test_openclaw_endpoints.py"
Cohesion: 0.12
...
### Community 613 - "TestRouterIntegration"
Cohesion: 0.21
...
### Community 616 - "MemoryMiddleware"
Cohesion: 0.17
...
### Community 620 - "Skill: repowise-intelligence"
Cohesion: 0.12
...
### Community 621 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
...
### Community 622 - "_valid_login_state"
Cohesion: 0.24
...
### Community 623 - "Skill: repowise-intelligence"
Cohesion: 0.12
Nodes (15): 1. Graph Intelligence (Dependency Graph), 2. Git Intelligence, 3. Documentation Intelligence, 4. Decision Intelligence, Acceptance Checks, Directory Structure, Example Usage, Implementation Approach (+7 more)

### Community 624 - "The 10-Step Workflow"
Cohesion: 0.12
...
### Community 625 - "Contributing to local-llm-server"
Cohesion: 0.12
...
### Community 626 - "refresh_agent_built_proof.py"
Cohesion: 0.20
...
### Community 627 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 628 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 629 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
...
### Community 634 - "AdminDigestRouterAuthTests"
Cohesion: 0.20
...
### Community 636 - "ManagedAgentDreams"
Cohesion: 0.22
...
### Community 660 - "Skill: user-research"
Cohesion: 0.13
...
### Community 661 - "Separate hosted dashboard backend (`backend/server.py`)"
Cohesion: 0.13
...
### Community 662 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 663 - "Attention Mechanisms Internals"
Cohesion: 0.13
...
### Community 668 - "TestBrainConfigUpdates"
Cohesion: 0.22
...
### Community 669 - "DecisionsStoreTests"
Cohesion: 0.10
...
### Community 670 - "test_dockerfile_ships_config_dir.py"
Cohesion: 0.14
...
### Community 671 - "test_daemon_restart_reprobes_http_port_only"
Cohesion: 0.13
...
### Community 672 - "TestKillSwitchDurability"
Cohesion: 0.15
...
### Community 673 - "test_task_service_failed_comment.py"
Cohesion: 0.18
...
### Community 674 - "test_tasks_awaiting_approval_api.py"
Cohesion: 0.33
...
### Community 680 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 686 - "admin_digest_router.py"
Cohesion: 0.22
...
### Community 687 - "Skill: branch-cleanup"
Cohesion: 0.14
...
### Community 688 - "Skill: perplexity — Web Research via Perplexity API"
Cohesion: 0.14
...
### Community 691 - "Quick-Note Issues Processing Summary"
Cohesion: 0.14
...
### Community 692 - "CompanyGraph"
Cohesion: 0.04
Nodes (33): detect_company_id(), detect_repo_id(), DirectChatSession, handle_chat_message_with_context(), Direct chat session with Company Graph context binding., Bind a company to this chat session and load its Company Graph., Bind a repository to this chat session., Get the bound Company Graph. (+25 more)

### Community 693 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 695 - "Render MCP — autonomous platform debugging and environment monitoring"
Cohesion: 0.14
...
### Community 696 - "Runbook: Auto-Resume After Cooldown / Interruption"
Cohesion: 0.14
...
### Community 697 - "SEO / GEO / AIO Audit Engine"
Cohesion: 0.14
...
### Community 698 - "Traffic Distribution Across Providers"
Cohesion: 0.14
...
### Community 701 - "TestNoNvidiaFallbackIsRetired"
Cohesion: 0.22
...
### Community 702 - "extract_failures"
Cohesion: 0.21
...
### Community 703 - "test_p0_roadmap_b3_b4_b5.py"
Cohesion: 0.21
...
### Community 704 - "_normalize_tool_choice"
Cohesion: 0.31
...
### Community 706 - "test_setup_api.py"
Cohesion: 0.21
...
### Community 707 - "test_wrapper_falls_back_to_installed_model"
Cohesion: 0.19
...
### Community 708 - "TestAnthropicToolListCaching"
Cohesion: 0.34
...
### Community 709 - "test_brain_failover_413.py"
Cohesion: 0.15
...
### Community 710 - "test_changelog_check_workflow.py"
Cohesion: 0.21
...
### Community 711 - "TestMCPClientStructuredOutput"
Cohesion: 0.27
...
### Community 712 - "_StubManager"
Cohesion: 0.14
Nodes (3): _apply(), Minimal stand-in for BrainFailoverManager., _StubManager

### Community 713 - ".test_set_github_token_sqlite_string_id_does_not_500"
Cohesion: 0.16
...
### Community 715 - "test_openclaw_gateway.py"
Cohesion: 0.14
...
### Community 716 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 718 - "AGENTS.md — Codebase Map & Operations Reference"
Cohesion: 0.15
...
### Community 719 - "CollaborationContext"
Cohesion: 0.21
...
### Community 722 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 725 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 726 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 730 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 731 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 733 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 734 - "admin_update_task_router.py"
Cohesion: 0.22
...
### Community 737 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
Nodes (12): Acceptance Checks, Claude's query protocol (use this instead of Read tool for exploration):, Graph Artifacts — What to Commit, How to Use the Graph (Token Savings Protocol), Installation (one-time per machine), Instead of reading raw files:, Key commands:, Relationship to repowise-intelligence Skill (+4 more)

### Community 738 - "Skill: platform-setup — Autonomous Agency Bootstrap"
Cohesion: 0.15
...
### Community 739 - "Workspace Isolation Architecture"
Cohesion: 0.15
...
### Community 740 - "Device compatibility and model picks"
Cohesion: 0.15
...
### Community 741 - "Autonomy Uplift — Living Roadmap & Detailed Implementation Specs"
Cohesion: 0.15
...
### Community 742 - "OpenClaw — iOS Control of the Agency (Single-Service Free-Tier Deploy)"
Cohesion: 0.15
...
### Community 745 - "ApplyReviewAgent"
Cohesion: 0.22
...
### Community 748 - "_is_bedrock_model_id"
Cohesion: 0.27
...
### Community 750 - "Agent Transparency Report"
Cohesion: 0.15
...
### Community 751 - "_get_provider_policy"
Cohesion: 0.21
...
### Community 752 - "_InMemoryBackend"
Cohesion: 0.18
...
### Community 755 - "TestModelCostTableUpdates"
Cohesion: 0.26
...
### Community 756 - "TestDecisionsBotLinks"
Cohesion: 0.17
...
### Community 757 - "test_deploy_trigger_covers_image.py"
Cohesion: 0.21
...
### Community 758 - "test_omniroute_provider.py"
Cohesion: 0.15
...
### Community 759 - "test_providers_live_e2e.py"
Cohesion: 0.24
...
### Community 760 - "test_quick_note_engine.py"
Cohesion: 0.17
...
### Community 761 - "TestModelsEndpointAliases"
Cohesion: 0.31
...
### Community 762 - "test_task_brain_preflight.py"
Cohesion: 0.31
...
### Community 763 - "test_telegram_task_callback.py"
Cohesion: 0.23
...
### Community 765 - "skill_registry.py"
Cohesion: 0.17
...
### Community 771 - "Skill: system-prompt-audit"
Cohesion: 0.17
...
### Community 772 - "Skill: task-alive-updates"
Cohesion: 0.17
...
### Community 775 - "build_admin_local_brain_router"
Cohesion: 0.24
...
### Community 776 - "_is_ephemeral_user"
Cohesion: 0.27
...
### Community 777 - "connectors_api.py"
Cohesion: 0.21
...
### Community 778 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 781 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 783 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 784 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 785 - "Quantization Internals"
Cohesion: 0.17
...
### Community 786 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 787 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 788 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 793 - "check_container_posture.py"
Cohesion: 0.26
...
### Community 794 - "test_pytest_failure_parser.py"
Cohesion: 0.23
...
### Community 797 - "flesch_reading_ease"
Cohesion: 0.20
...
### Community 798 - "TestExtendedThinkingRouting"
Cohesion: 0.20
...
### Community 807 - "_hostname_matches"
Cohesion: 0.28
...
### Community 813 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 816 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 817 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 819 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 822 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 823 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 824 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 825 - "2. Critical Bugs & Exact Detection Signatures"
Cohesion: 0.18
...
### Community 826 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 828 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 829 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 830 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 832 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 833 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 837 - "What to clean up"
Cohesion: 0.18
...
### Community 839 - "test_bedrock_live.py"
Cohesion: 0.25
...
### Community 843 - "test_conftest_hermetic_env.py"
Cohesion: 0.18
...
### Community 845 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 847 - "TestZeroAttemptDiagnostics"
Cohesion: 0.25
...
### Community 848 - "test_google_provider_models.py"
Cohesion: 0.18
...
### Community 854 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 855 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 856 - "Brag Plan: Autonomous AI Agency (feature tour, v2)"
Cohesion: 0.20
...
### Community 857 - "Hyperframes Composition Brief: Autonomous AI Agency (feature tour, v2)"
Cohesion: 0.20
...
### Community 858 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 859 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 860 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 861 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 862 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 863 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 864 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 865 - "Agent Readiness Report"
Cohesion: 0.20
...
### Community 867 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 868 - "Competitor Analysis — Autonomous AI Agency"
Cohesion: 0.20
...
### Community 869 - "Issue #1427: quick-note:https://github.com/bingreeky/JIT"
Cohesion: 0.20
...
### Community 870 - "LLM Router — configuration guide"
Cohesion: 0.20
...
### Community 871 - "LLM Router — provider guide"
Cohesion: 0.20
...
### Community 872 - "One command (recommended)"
Cohesion: 0.20
...
### Community 873 - "ENGINEERING_STANDARDS.md — Patterns & Reference"
Cohesion: 0.20
...
### Community 875 - "capture_screens.py"
Cohesion: 0.29
...
### Community 877 - "_start_ceo_agency"
Cohesion: 0.27
...
### Community 879 - "_resolve_push_token"
Cohesion: 0.17
...
### Community 880 - "TestDisabledProvidersAreNotFalselyReportedUnreachable"
Cohesion: 0.22
...
### Community 881 - "TestTheWorkflowIsSafeAndReadOnly"
Cohesion: 0.20
...
### Community 883 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 884 - "test_model_catalog_guard.py"
Cohesion: 0.29
...
### Community 894 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 896 - "Skill: changelog-enforcer"
Cohesion: 0.22
...
### Community 897 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 900 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 901 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 903 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
Nodes (8): Branch, Components, Purpose, Quick Start, Session Roles, Skill: cowork-session (Claude Cowork), Testing, When to Use

### Community 904 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 905 - "Active Task Tracker"
Cohesion: 0.22
...
### Community 907 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 908 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 909 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 910 - "Issue #1356: quick-note:https://searchengineland.com/turn-seo-backlog-into-roadmap-485713"
Cohesion: 0.22
...
### Community 911 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 912 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 913 - "Release Procedure"
Cohesion: 0.22
...
### Community 914 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 916 - "_get_current_user"
Cohesion: 0.25
...
### Community 923 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 924 - "test_probe_base_url_override_hits_the_typed_url"
Cohesion: 0.22
...
### Community 925 - ".test_every_request_carries_a_real_user_agent"
Cohesion: 0.22
...
### Community 926 - "test_changelog_parity_guard.py"
Cohesion: 0.22
...
### Community 931 - "test_scanner_deps_parity.py"
Cohesion: 0.31
...
### Community 932 - "test_serve_spa_prefixes.py"
Cohesion: 0.31
...
### Community 940 - "quality_checker.py"
Cohesion: 0.32
...
### Community 942 - "_brain_provider_status"
Cohesion: 0.25
...
### Community 943 - "_parse_tool_calls_from_response"
Cohesion: 0.43
...
### Community 955 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 956 - "ceo-micromanagement.md"
Cohesion: 0.25
Nodes (4): P0 behavior change, Readiness contract, Runtime model, Runtime types

### Community 957 - "Feature Maturity / Support Matrix"
Cohesion: 0.25
...
### Community 960 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.25
...
### Community 975 - "Issue #504: EPIC: Autonomy hardening — live-verified defects 2026-06-10"
Cohesion: 0.25
...
### Community 976 - "Issue #581: Sprint tracker: pending work after brand rename + mobile-first pass"
Cohesion: 0.25
...
### Community 978 - "Issue #657: quick-note:https://github.com/earendil-works/pi"
Cohesion: 0.25
...
### Community 979 - "Issue #659: quick-note:https://github.com/nex-agi/Nex-N2"
Cohesion: 0.25
...
### Community 980 - "Issue #660: quick-note:https://github.com/getsentry/sentry-for-ai"
Cohesion: 0.25
...
### Community 981 - "Issue #661: quick-note:https://github.com/XiaomiMiMo/MiMo-Code"
Cohesion: 0.25
...
### Community 982 - "Issue #664: quick-note:https://github.com/Grominet95/jarvis-OS"
Cohesion: 0.25
...
### Community 983 - "Issue #666: quick-note:https://github.com/porokka/jarvis-os"
Cohesion: 0.25
...
### Community 984 - "Issue #670: quick-note:https://github.com/perplexityai/bumblebee"
Cohesion: 0.25
...
### Community 985 - "Issue #672: quick-note:https://github.com/Chachamaru127/claude-code-harness"
Cohesion: 0.25
...
### Community 986 - "Issue #676: quick-note:https://github.com/WeiboAI/VibeThinker"
Cohesion: 0.25
...
### Community 987 - "Issue #820: quick-note:https://github.com/cobusgreyling/loop-engineering"
Cohesion: 0.25
...
### Community 988 - "Positional Encoding Internals"
Cohesion: 0.25
...
### Community 989 - "Platform Controls"
Cohesion: 0.25
...
### Community 990 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 991 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 992 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 993 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 994 - "Continual Harness (`agent/harness_spec.py`)"
Cohesion: 0.25
...
### Community 998 - "security_fix_agent.py"
Cohesion: 0.46
...
### Community 1003 - "crispy_burn_in.py"
Cohesion: 0.36
...
### Community 1008 - "test_doctor_coding_brain.py"
Cohesion: 0.32
...
### Community 1009 - "test_generate_context_standing_instructions.py"
Cohesion: 0.32
...
### Community 1010 - "test_local_brain_router_smoke.py"
Cohesion: 0.25
...
### Community 1011 - "test_mcp_protocol_version.py"
Cohesion: 0.25
...
### Community 1013 - "TestOneIdCanBelongToSeveralProviders"
Cohesion: 0.39
...
### Community 1014 - "Workspace Issues"
Cohesion: 0.29
...
### Community 1017 - "test_nuclear_cleanup_targets_the_schedule_collection"
Cohesion: 0.25
...
### Community 1019 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.25
...
### Community 1020 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 1024 - "classify_domain"
Cohesion: 0.29
...
### Community 1030 - "Changelog"
Cohesion: 0.29
Nodes (6): Added, Changed, Changelog, Fixed, Maintenance, [v4.1.0]

### Community 1031 - "[5.0.0]"
Cohesion: 0.29
Nodes (7): [5.0.0], Added, Changed, Fixed, Maintenance, Removed, Security

### Community 1032 - "Changelog"
Cohesion: 0.29
Nodes (7): Added, Changed, Changelog, Fixed, Maintenance, Removed, Security

### Community 1033 - "AI Engineering Insights Skill"
Cohesion: 0.29
...
### Community 1034 - "Skill: hybrid-reasoning (Hybrid AI)"
Cohesion: 0.29
Nodes (6): Branch, Components, Purpose, Quick Start, Skill: hybrid-reasoning (Hybrid AI), Testing

### Community 1035 - "Karpathy Guidelines Skill"
Cohesion: 0.29
...
### Community 1045 - "Implementation plan + TO-DO (check off as you go)"
Cohesion: 0.29
...
### Community 1049 - "Cost-aware routing evaluation"
Cohesion: 0.29
...
### Community 1052 - "PRD — README Marketing Refresh"
Cohesion: 0.29
...
### Community 1055 - "check_changelog_parity.py"
Cohesion: 0.43
...
### Community 1056 - "check_doc_images.py"
Cohesion: 0.48
...
### Community 1059 - "test_daily_2026_06_14.py"
Cohesion: 0.38
...
### Community 1061 - "TestSupportMatrixDocsSync"
Cohesion: 0.29
...
### Community 1062 - "TestReasonsAreActionable"
Cohesion: 0.29
...
### Community 1063 - "TestProvidersScreen"
Cohesion: 0.43
...
### Community 1065 - "TestMongoService"
Cohesion: 0.29
...
### Community 1070 - "Music Cues: happy-beats-business-moves-vol-1-by-ende-dot-app"
Cohesion: 0.33
...
### Community 1085 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 1086 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 1087 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 1088 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 1089 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 1090 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 1091 - "Feature Support Matrix"
Cohesion: 0.33
...
### Community 1095 - "apply_phase1_changes.py"
Cohesion: 0.33
...
### Community 1106 - "test_catalogue_probe.py"
Cohesion: 0.33
...
### Community 1110 - "TestTheAgentRunsCurrentCode"
Cohesion: 0.33
...
### Community 1133 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 1134 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 1144 - "_add_colibri_shim_changelog_entry.py"
Cohesion: 0.50
...
### Community 1145 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1146 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1147 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 1148 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 1149 - "setup_colibri.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1150 - "setup_colibri.sh script"
Cohesion: 0.70
Nodes (4): setup_colibri.sh script, fail(), ok(), warn()

### Community 1151 - "status_colibri_server.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1153 - "start_tunnel.py"
Cohesion: 0.50
...
### Community 1159 - "openclaw_mobile_ui"
Cohesion: 0.33
...
### Community 1160 - "The full agent capability roster"
Cohesion: 0.33
...
### Community 1164 - "fetch"
Cohesion: 0.70
Nodes (4): fetch(), needsProxy(), PROXY_PREFIXES, scheduled()

### Community 1165 - "TestAgentRunnerExecution"
Cohesion: 0.33
...
### Community 1191 - "TestDirectChatAgentExecution"
Cohesion: 0.33
...
### Community 1194 - "test_no_exception_detail_leaks.py"
Cohesion: 0.50
...
### Community 1195 - "TestNoHardcodedModels"
Cohesion: 0.33
...
### Community 1199 - "routed"
Cohesion: 0.33
Nodes (4): Tool calling is the compatibility case most likely to break silently., routed(), test_shim_preserves_tool_calls_through_the_router(), test_shim_returns_a_real_failover_result()

### Community 1201 - "github"
Cohesion: 0.50
Nodes (3): github, enabled, silent

### Community 1226 - "test_the_reserve_is_bounded_when_read_from_the_environment"
Cohesion: 0.67
...
### Community 1228 - "Who is this for?"
Cohesion: 0.40
...
### Community 1326 - "Agent API Issues"
Cohesion: 0.40
...
### Community 1327 - "Network and Tunnel Issues"
Cohesion: 0.40
...
### Community 1328 - "._resolve_merge_decision"
Cohesion: 0.40
...
### Community 1329 - ".get_bound_skills"
Cohesion: 0.40
...
### Community 1338 - "Claude Code Specific Issues"
Cohesion: 0.50
...
### Community 1341 - "_clean_director"
Cohesion: 0.50
...
- **3548 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3543 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 14398 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **132 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `_fixture()` connect `_fixture` to `company_api.py`, `llm/router.py`, `Task`, `test_llm_router_queue_cache.py`, `AgentRunner`, `TaskStatus`, `LLMRouter`, `SelfHealingAgent`, `E2BSandboxSession`, `Agency`, `PolicyEngine`, `test_llm_router_resilience.py`, `test_failover_client_shared.py`, `test_unit8_model_catalog.py`, `TaskWorkflowService`, `client`, `ImprovementLoop`, `test_autonomy_status.py`, `test_llm_router_strategies.py`, `services/seo_audit.py`, `test_freebuff_bot.py`, `KeyPool`, `test_workflow_orchestrator_scoping.py`, `test_model_router.py`, `UserRole`, `quick_note.py`, `get_task_store`, `direct_chat.py`, `AgentSwarm`, `AuditLog`, `test_startup_warmup.py`, `services/background.py`, `BrainWatchdog`, `test_company_api.py`, `test_monitor_lib.py`, `test_phase5_doctor.py`, `brain_failover.py`, `test_brain_failover.py`, `test_provider_router.py`, `test_agent_tool_governance.py`, `test_catalogue_probe.py`, `PrimeAgentAdapter`, `cost_tracker.py`, `ResearchTask`, `TestClient`, `test_ai_insights.py`, `e2e/test_browser.py`, `test_procedural_memory.py`, `test_knowledge_sync.py`, `test_openclaw_endpoints.py`, `WorkflowRun`, `run_task`, `config.py`, `ArtifactStore`, `test_trend_scoping.py`, `TokenBudget`, `SQLiteStore`, `TestFeaturesAPI`, `test_local_brain_state.py`, `test_langfuse_agency_wide.py`, `TestChatHistoryStore`, `_run_analyze`, `test_refresh_agent_built_proof.py`, `test_trend_watcher.py`, `test_sam_livekit.py`, `TestHarnessAdapter`, `persist_plan_spec`, `test_context_rulebook.py`, `test_autonomous_agency_e2e.py`, `test_new_features_e2e.py`, `test_llm_router_e2e.py`, `test_provider_state_durability.py`, `KeyStore`, `TestRuntimeControl`, `test_issue_intake.py`, `ProviderConfig`, `test_task_service_failed_comment.py`, `test_runtimes_health_endpoint.py`, `ChatHistoryStore`, `_step`, `test_webui_provider_priority.py`, `claim`, `routed`, `MCPClient`, `test_response_cache.py`, `clear_cooldowns`, `test_e2b_data_flow.py`, `test_platform_controls.py`, `test_brain_failover_413.py`, `test_changelog_check_workflow.py`, `OllamaCircuitBreaker`, `_job_text`, `test_portfolio_intake.py`, `test_video_transcript.py`, `test_openclaw_gateway.py`, `SchedulerStore`, `test_features_api.py`, `timedelta`, `_resolve_user_github_token`, `model_router.py`, `WorkflowRun`, `TrendWatcher`, `_Budget`, `TestAuthAndTaskOwnership`, `test_purge_backlog.py`, `TestEstimateTokensForMessages`, `test_task_brain_preflight.py`, `test_telegram_task_callback.py`, `test_telegram_approval_gate.py`, `TestClient`, `test_telegram_webhook.py`, `test_brain_patch_service_token.py`, `get_scheduler`, `ContextPruner`, `SeoFixer`, `tests/conftest.py`, `test_persistent_memory.py`, `test_sam_voice.py`, `test_operational_incidents.py`, `SecurityScanner`, `test_agile_api.py`, `test_app_settings.py`, `test_brain_availability_doctor.py`, `test_ceo_router.py`, `test_nvidia_model_discovery.py`, `test_task_clarification.py`, `OutputFilter`, `test_rate_limiter.py`, `test_provider_enable_disable.py`, `test_kimi_bridge_server.py`, `test_mcp_governance.py`, `_clean_director`, `TestNormalizeResponseFormat`, `analyze_page`, `test_agency_fix.py`, `test_skill_registry_boot_refresh.py`, `test_scheduler_hydration_bounded.py`, `OrchestratorCheckpointStore`, `telegram_service.py`, `captured`, `_start_ceo_agency`, `isolated_telegram_config`, `_resolve_push_token`, `session_retro.py`, `TestTheWorkflowIsSafeAndReadOnly`, `_Recorder`, `test_regression.py`, `test_agent_scripts_share_one_model_list.py`, `test_crispy_burn_in.py`, `test_executive_advisory_api.py`, `test_provider_410_per_model.py`, `_Recorder`, `test_agent_free_brain.py`, `TestSwarmRoleRouting`, `_undeclared`, `test_process_quick_note_workflow.py`, `_get`, `test_service_token.py`, `test_telegram_diag_endpoint.py`, `test_harness_spec.py`, `model_discovery.py`, `test_telegram_auto_approve.py`, `test_v4_api.py`, `TestOrchestratorProviderFailover`, `test_gh_brain_failover.py`, `NotificationDispatcher`, `test_doctor_coding_brain.py`, `ClaudeCodeAdapter`, `test_mcp_protocol_version.py`, `test_voice_pipeline.py`, `test_ping.py`, `test_task_store_fails_loud_in_production.py`?**
  _High betweenness centrality (0.081) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `FreeBuffAgent`, `proxy.py`, `AdaptiveHalter`, `ContextPruner`, `TaskSpec`, `backend/server.py`, `TestAgentRunnerExecution`, `GitHubTools`, `test_autonomous_agency_e2e.py`, `test_agent_chat_integration.py`, `test_agent_free_brain.py`, `E2BSandboxSession`, `Agency`, `PolicyEngine`, `test_failover_client_shared.py`, `CEODispatcher`, `TestAgentLoopMCPIntegration`, `diagnostics.py`, `TestAgentRunnerSafety`, `AgentSessionStore`, `resolve_identity`, `test_agent_runner.py`, `WorkspaceTools`, `MCPClient`, `test_daily_automation_2026_07_11.py`, `ContextManager`, `ReactScratchpad`, `test_governance_api.py`, `direct_chat.py`, `test_mcp_governance.py`, `call_llm`, `test_brain_failover_413.py`, `StuckDetector`, `UserMemoryStore`, `test_empirical_verify.py`, `test_agent_tool_governance.py`, `LocalWorkspace`, `loop.py`, `InternalAgentAdapter`, `WorkflowRun`, `TokenBudget`, `_resolve_push_token`, `MultiAgentSwarm`, `workflow_orchestrator.py`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderRouter` to `test_provider_410_per_model.py`, `system_instruction`, `TestLegacyRouterServerFallback`, `backend/server.py`, `test_bedrock_provider.py`, `ProviderConfig`, `settings.py`, `test_all_providers_discovery.py`, `clear_cooldowns`, `direct_chat.py`, `call_llm`, `resolve_active_brain`, `test_bedrock_live.py`, `implement_agent.py`, `kimi_bridge_provider_config`, `TestOpenAiToBedrockConverse`, `test_provider_router.py`, `TestLegacyRouterCacheTTL`, `test_anthropic_refusal_fallback.py`, `failover_client.py`, `_payload`, `TestRouterIntegration`, `test_colibri_provider.py`, `TestAnthropicPayloadStructuredOutput`, `TrafficDirector`?**
