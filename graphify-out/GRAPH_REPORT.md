...
## Corpus Check
- 1395 files · ~1,988,086 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27820 nodes · 56277 edges · 1186 communities (1067 shown, 119 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 6143 edges (avg confidence: 0.54)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `729d83a3`
...
## Communities (1186 total, 119 thin omitted)

### Community 0 - "_is_bedrock_model_id"
Cohesion: 0.27
...
Cohesion: 0.04
Nodes (160): AgentJobRequest, AgentJobSnapshot, BaseModel, Complete point-in-time view of a job, safe to serialise as API response., Convenience: the canonical text response, whether success or failure., Validated input for creating a new agent job. Passed from the API handler into…, DirectChatDoctor, AgentJobManager (+152 more)

### Community 2 - "Task"
Cohesion: 0.04
Nodes (54): ExecutionLogEntry, Any, field_validator, Full task/issue document., Update the updated_at timestamp., Single entry in a task's execution log., Dict-compatible accessor. Log entries are serialized to/from dicts in many…, Task (+46 more)

### Community 3 - "Agency"
Cohesion: 0.08
Nodes (118): Agency, CEO-coordinated multi-agent agency for continuous codebase management. The CEO…, BackgroundTask, BrowserSession, Async Playwright browser session. Usage:: session = BrowserSession() await…, True if Playwright is installed and ready to use., CommitAttribution, CommitTracker (+110 more)

### Community 4 - "WebReach"
Cohesion: 0.09
...
Cohesion: 0.01
Nodes (387): backend/ceo_router.py — observability and manual control for the CEO. Surfaces…, Reject non-admin callers for routes that spend provider budget. Delegates to…, _require_admin(), _is_admin(), Check if a user has admin role. Works for both social_auth users (role in…, admin_seed(), _agent_timeout_fallback_response(), auth_me() (+379 more)

### Community 6 - "SQLiteStore"
Cohesion: 0.02
Nodes (68): DetectedSystem, A business system detected on a company's website or in their stack., Get the most confident evidence description., requires_db, Company, Delete a company and all its associated data., Create a new company in SQLite., Get a company by ID from SQLite. (+60 more)

### Community 7 - "llm/router.py"
Cohesion: 0.03
Nodes (81): get_budget(), The process-wide budget tracker., get_cache(), packages/llm/cache.py — layered caching. Five independent layers, each with its…, The process-wide cache manager., text_key(), AgentPolicy, gateway_enabled() (+73 more)

### Community 8 - "test_runtimes.py"
Cohesion: 0.03
...
Cohesion: 0.03
Nodes (83): _load(), main(), ModuleType, _write_summary(), _load(), main(), int, cosine_similarity() (+75 more)

### Community 12 - "CompanyGraphStore"
Cohesion: 0.03
Nodes (161): AccountLifecycleResponse, _DoctorCheck, _DoctorReport, OnboardingAnswersRequest, OnboardingProgressResponse, OnboardingQuestionsRequest, BaseModel, Request to generate AI-tailored onboarding questions. (+153 more)

### Community 13 - "test_governance_sandbox.py"
Cohesion: 0.04
Nodes (74): packages/governance/identity.py — who is acting, and under what mandate. Docker…, build_docker_run_argv(), detect_backend(), DockerBackend, E2BBackend, load_profiles(), LocalBackend, Any (+66 more)

### Community 14 - "test_llm_router_compat.py"
Cohesion: 0.09
Nodes (27): openai_body_from_response(), Any, Whether the compat bridges should delegate to ``LLMRouter``. Reads the flag on…, Translate an OpenAI-shaped chat payload into an ``LLMRequest``. Unknown keys…, Render an ``LLMResponse`` as an OpenAI chat-completions body. Used by the…, request_from_openai_payload(), should_use_router(), Drop the cached config (test hook). (+19 more)
...
### Community 18 - "get_workflow_orchestrator"
Cohesion: 0.04
...
### Community 20 - "FeatureMatrix"
Cohesion: 0.04
Nodes (27): FeatureEntry, FeatureMatrix, BaseModel, One entry in the support matrix., Central support matrix — single source of truth. Loads the canonical feature…, Load canonical features and apply per-feature then bulk env overrides., Apply a config override string like 'stable', 'beta', 'disabled', 'enabled',…, Return the feature entry if available, or raise FeatureUnavailableError. (+19 more)

### Community 21 - "CEODispatcher"
Cohesion: 0.04
Nodes (63): CEODispatcher, CEOResult, _offload(), Any, Semaphore, Run a synchronous ledger call without blocking the event loop. ``CEOLedger`` is…, Build an agent.coordinator.TaskSpec from a CEO SpecialistTask., Aggregated output from a multi-specialist execution. (+55 more)

### Community 22 - "MongoDBStore"
Cohesion: 0.04
Nodes (47): MongoDBStore, Any, ObjectId, Prepare a Pydantic model for SQLite storage., Prepare a SQLite row for Pydantic model., MongoDB implementation of the Company Graph store. Uses Motor (async MongoDB…, Get or create the MongoDB database connection., Convert string ID to ObjectId. (+39 more)
...
### Community 27 - "test_telegram_approval_gate.py"
Cohesion: 0.08
...
Cohesion: 0.03
Nodes (82): _brain_provider_status(), Return per-provider metadata for the GET endpoint. Iterates every provider in…, Return the discovered model list for *provider_id*, or ``[]`` if unknown., _served_models(), all_provider_ids(), _provider_ids_from_literal(), provider_key_present(), Return every provider id recognised by the brain config system. Iterates the… (+74 more)

### Community 29 - "config.py"
Cohesion: 0.07
Nodes (52): _apply_env_overrides(), _apply_key_env(), _build(), _coerce(), config_dir(), _env_key_names(), expand_env(), _fields_of() (+44 more)

### Community 30 - "test_llm_router_tpm.py"
Cohesion: 0.05
Nodes (53): ContextManager, estimate_tokens(), FitResult, message_tokens(), prune(), Any, packages/llm/context.py — keeping conversations inside the context window. The…, Truncate oversized tool results and drop exact duplicate turns. Tool results… (+45 more)

### Community 31 - "SpecialistService"
Cohesion: 0.04
...
### Community 32 - "test_orchestrator_merge_decision.py"
Cohesion: 0.22
...
### Community 35 - "BrainWatchdog"
Cohesion: 0.03
Nodes (75): get_brain_config(), get_brain_config_store(), Return the process-wide ``BrainConfigStore`` singleton., Convenience wrapper used by the agent loop + brain resolver., Convenience wrapper used by the admin API endpoints., set_brain_config(), Any, packages/ai/self_heal.py — automatic brain self-healing. When the active brain… (+67 more)

### Community 36 - "FeatureMaturity"
Cohesion: 0.07
Nodes (32): PreflightReport, AgentJob, make_isolated_workspace(), Path, Create an isolated workspace directory under *root*. This is the legacy path…, _workspace_component(), Any, WorkspaceEscapeError (+24 more)
...
### Community 38 - "SkillBindings"
Cohesion: 0.07
Nodes (32): Any, A runtime-callable skill that specialists can execute through the workflow…, Live Graphify executor — queries the codebase knowledge graph. Order of…, Live council reviewer — deterministic, rules-based multi-perspective review…, Set the singleton SkillBindings instance (for testing)., Central registry that maps skills to specialist families and provides runtime…, List all registered skills., List skills relevant to a specialist family. (+24 more)

### Community 39 - "resolve_active_brain"
Cohesion: 0.07
Nodes (52): BrainResolution, provider_api_key(), Return the live API key for *provider* (env-only — never persisted)., get_active_brain_sync(), get_brain_preference(), get_provider_role_tags(), _host_is_openai_compatible(), _norm() (+44 more)

### Community 40 - "enforcement.py"
Cohesion: 0.06
Nodes (39): events_from_identity(), Any, Convenience: build and record an event in one call., Extract the identity-derived audit fields from an AgentIdentity. Kept here…, record_event(), classify(), evaluate_call(), guard_tool_call() (+31 more)

### Community 41 - "RenderMCPClient"
Cohesion: 0.06
...
### Community 42 - "test_operational_incidents.py"
Cohesion: 0.02
Nodes (119): _diagnose_and_file(), _file_incident(), _format_incident(), gather_render_evidence(), _iso_from_monotonic(), normalise(), note_phase_end(), note_phase_start() (+111 more)
...
Cohesion: 0.06
Nodes (36): _normalize_dockerfile(), parametrize, tests/test_sam_livekit.py — SAM realtime voice (LiveKit) integration. Covers: -…, Empty key/secret/identity/room must raise ValueError., SAM_LLM_* env vars must override the NVIDIA defaults (Hermes/proxy routing)., Under TESTING the in-process worker must never be eligible to start., OPT-IN: defaulting to on OOM-killed the 512MB Render instance at boot…, start_in_process must be a safe no-op in the test environment (conftest sets… (+28 more)

### Community 46 - "E2BSandboxSession"
Cohesion: 0.05
Nodes (70): MCPUnavailableError, Raised when the MCP server is unreachable or the circuit is open., E2BSandboxSession, _inject_token(), maybe_attach_e2b(), Any, Create the sandbox. Raises :class:`MCPUnavailableError` on failure., Kill the sandbox. Idempotent; never raises (best-effort cleanup). (+62 more)

### Community 47 - "failover_chat_completion"
Cohesion: 0.06
...
Cohesion: 0.04
Nodes (56): Return the stable ``agent:<slug>`` id for a human agent name. Deterministic and…, slugify_agent(), _as_list(), GroupPolicy, PolicyEngine, Any, Path, Coerce a YAML scalar-or-list field into a list of strings. Operators write… (+48 more)

### Community 50 - "get_feature_matrix"
Cohesion: 0.06
...
### Community 51 - "workflow/api.py"
Cohesion: 0.06
Nodes (62): _make_engine(), fixture, tests/test_crispy_workflow.py — CRISPY workflow engine hardening tests. Tests…, Provide isolated DB + artifact + workspace paths., Create a WorkflowEngine with isolated storage., TestAbortOnFailure, TestPhaseSequence, TestWorkspaceIsolation (+54 more)
...
### Community 55 - "test_e2b_task_wiring.py"
Cohesion: 0.08
...
### Community 56 - "test_response_cache.py"
Cohesion: 0.12
...
### Community 57 - "test_repowise_intelligence.py"
Cohesion: 0.11
...
### Community 58 - "TaskStore"
Cohesion: 0.05
Nodes (53): Any, Task, TaskStatus, Create a task. Deduplicates by source_id if set (Charter G3). If a task with…, Fetch a task by ID. If owner_id is set, enforces ownership., Return the task previously created for an external ``source_id`` (e.g.…, Normalise a timestamp value to a float Unix epoch. Handles: - float / int…, List tasks for a specific user with optional filters. ``include_system``… (+45 more)

### Community 59 - "test_ceo_supervision.py"
Cohesion: 0.04
Nodes (99): _harvest_changed_files(), Extract the files a runtime touched. Returns ``(files, reported)``. Adapters…, Attempt, _backend(), CEOLedger, GoalRecord, _now(), Any (+91 more)
...
### Community 62 - "test_e2b_data_flow.py"
Cohesion: 0.07
...
### Community 67 - "AgentSwarm"
Cohesion: 0.05
Nodes (36): agents/__init__.py — CRISPY multi-agent coding system., AgentProfile, _catalog_defaults(), _catalog_provider(), _get_defaults(), load_all_profiles(), make_architect_profile(), make_coder_profile() (+28 more)

### Community 68 - "AgentRunner"
Cohesion: 0.02
Nodes (119): get_enrichment(), AgentRunner, _nvidia_api_key(), Any, Path, Governance seam: judge the call, run it, audit the outcome. Deliberately a thin…, Append an event to the durable session log if a store is wired in., Summarise a long history and compact it. Asks the planner model to write a… (+111 more)

### Community 69 - "ProceduralMemoryStore"
Cohesion: 0.05
...
### Community 70 - "test_ai_insights.py"
Cohesion: 0.05
...
### Community 72 - "WorkspaceTools"
Cohesion: 0.05
Nodes (37): repowise.py — RepowiseIntelligence: context packing and dependency analysis., Path, tools.py — WorkspaceTools: read/write/search and diff application (risky…, Return the first *lines* lines of a file. Just-in-time retrieval: the executor…, Return a lightweight index of files with line counts and sizes. This is the…, Delegate to RepowiseIntelligence for a natural-language codebase question., Delegate to RepowiseIntelligence for a semantic/text codebase search., Delegate to RepowiseIntelligence to list architectural decision nodes. (+29 more)
...
Cohesion: 0.06
Nodes (33): Dynamic model router package. Public API:: from router import get_router,…, _build_builtin_model_map(), _default_model(), _get_model_map(), ModelRouter, _nvidia_key_present(), Any, Dynamic model router. Central routing logic for all chat and agent requests.… (+25 more)
...
Cohesion: 0.05
Nodes (31): get_mcp_client(), MCPClient, Any, RuntimeError, agent/mcp_client.py — Async MCP client for the mcp-server Docker container.…, Prefer structured data; fall back to text when unavailable., Thin async MCP client with open/close circuit breaker. Thread-safe only within…, Full URL of the JSON-RPC endpoint this client posts to. (+23 more)
...
### Community 82 - "test_seo_audit.py"
Cohesion: 0.06
...
### Community 87 - "tasks/service.py"
Cohesion: 0.06
Nodes (50): agent/workflow.py — Persisted workflow state machine. Implements the Autonomous…, Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., tasks — Task/issue management system. Provides a lightweight task/issue tracker…, ApprovalCheckpoint, _coerce_ts(), Enum, str (+42 more)
...
### Community 94 - "test_governance_api.py"
Cohesion: 0.06
Nodes (54): build_governance_router(), Any, APIRouter, backend/governance_router.py — read and operate the governance layer. Mounted…, Reject non-admin callers. Mirrors the RBAC check used elsewhere in this backend…, _require_admin(), get_approval_store(), get_audit_log() (+46 more)
...
Cohesion: 0.04
Nodes (50): Status of a user story within a sprint., StoryStatus, HarnessAdapter, HarnessSpec, Any, agents/harness_adapter.py — ECC Cross-Harness Adapter Normalises API…, Adapt harness-native requests to the local-llm-server internal format. Each…, Detect which harness sent this request from headers. Check order: explicit… (+42 more)
...
### Community 102 - "StreamingDeltaReconstructor"
Cohesion: 0.06
...
### Community 105 - "portfolio_intelligence.py"
Cohesion: 0.09
...
### Community 115 - "test_agent_tool_governance.py"
Cohesion: 0.11
Nodes (36): Replace the process-wide engine. Tests only., reset_policy_engine(), _drive(), _enforce(), governance_on(), isolated_governance(), _observations(), Any (+28 more)
...
Cohesion: 0.06
Nodes (56): brain_providers(), quick_notes_submit(), Every configured provider with its health AND its on/off state. Powers the…, Submit a quick-note URL or instruction from the dashboard FAB., describe_disabled_reason(), get_failover_manager(), Return the singleton BrainFailoverManager., Reset the singleton (for tests). (+48 more)
...
### Community 123 - "ImprovementLoop"
Cohesion: 0.05
Nodes (65): _parse_ceo_directives(), DetectedIssue, ImprovementLoop, ImprovementLoopState, _now(), Any, Path, agent/improvement_loop.py — Continuous Improvement Engine Background scanner… (+57 more)
...
### Community 126 - "test_kimi_bridge_server.py"
Cohesion: 0.06
...
### Community 128 - "test_quick_note.py"
Cohesion: 0.08
...
### Community 129 - "TasksPage.js"
Cohesion: 0.06
Nodes (31): addTaskComment(), clarifyTask(), escalateTask(), fetchVelocity(), followUpTask(), updateTask(), C, COLS (+23 more)

### Community 130 - "test_startup_warmup.py"
Cohesion: 0.05
Nodes (53): agents/store.py — Persistent store for user-defined agent configurations.…, Set the global agent store instance (e.g., with MongoDB on startup)., set_agent_store(), Await one warm-up step, deferring it to the background if it overruns.…, The task store the background services should use, wiring it if needed.…, Point the feature stores at the shared database connection. Deliberately…, _task_store_for_background(), _warmup_step() (+45 more)

### Community 131 - "App.js"
Cohesion: 0.05
...
### Community 132 - "brain_config.py"
Cohesion: 0.03
Nodes (93): BrainConfig, BrainConfigStore, default_brain_config(), invalidate_brain_config_cache(), provider_base_url(), _provider_env_value(), provider_key_rotation_enabled(), BaseModel (+85 more)

### Community 133 - "ChatHistoryStore"
Cohesion: 0.07
...
### Community 134 - "v4_api.py"
Cohesion: 0.10
Nodes (38): _get_cached_tasks(), _get_tasks_cache_lock(), _load_improvement_state(), Any, BaseModel, get, Lock, post (+30 more)

### Community 135 - "TaskWorkflowService"
Cohesion: 0.05
Nodes (58): Hand the 'connect & verify the repo' work to the agency's own agents. The task…, _seed_connect_task(), _is_brain_connection_error(), Any, BaseException, Task, TaskResult, TaskSpec (+50 more)
...
### Community 140 - "OrchestratorQueue"
Cohesion: 0.08
Nodes (13): OrchestratorQueue, Any, _QueueEntry, Async FIFO queue that limits concurrent orchestrator run executions.…, Enqueue a run for async execution. Returns immediately. ``fn(*args, **kwargs)``…, Enqueue a run and return a future that resolves when it completes., stop_orchestrator_queue(), fixture (+5 more)

### Community 141 - "tests/conftest.py"
Cohesion: 0.10
...
### Community 142 - "persist_plan_spec"
Cohesion: 0.07
...
### Community 144 - "provider_max_rpm"
Cohesion: 0.07
Nodes (34): provider_max_parallel(), provider_max_rpm(), provider_max_tpm(), _provider_positive_float(), provider_weight(), Shared parse/validate for the numeric per-provider traffic budgets. Returns…, Return the operator-configured requests/min cap for *provider*, or None if…, Return the operator-configured tokens/min cap for *provider*. Reads… (+26 more)

### Community 145 - "ToolRegistry"
Cohesion: 0.06
Nodes (35): get_tool_registry(), Any, Path, Register a tool definition., Decorator to register a function as an agent tool. Usage::…, Remove a tool from the registry. Returns True if removed., Look up a tool by name., Return all registered tools. (+27 more)
...
### Community 147 - "PortfolioManager"
Cohesion: 0.02
Nodes (154): AgentRole, str, AgileManager, Lifecycle status of a sprint., Manages multiple agile sprints with velocity tracking., Predict next sprint velocity from historical data., Number of managed sprints., SprintStatus (+146 more)
...
### Community 149 - "test_slop_gate.py"
Cohesion: 0.07
...
### Community 150 - "failover_client.py"
Cohesion: 0.05
...
### Community 153 - "test_unit7_catalog_propagation.py"
Cohesion: 0.06
...
### Community 154 - "LLMRouter"
Cohesion: 0.04
Nodes (66): Attempt, count, Read the environment variables named in ``env_names`` into a key list. Order is…, resolve_keys(), LLMRouter, Any, AsyncClient, BaseException (+58 more)

### Community 155 - "test_governance_enforcement.py"
Cohesion: 0.07
Nodes (47): Recursively strip secrets from an arbitrary argument structure. Fails…, scrub(), BudgetTracker, GovernanceGate, Holds live session budgets, bounded so it cannot leak. Sessions end without…, The one seam through which governed actions pass., Replace the process-wide gate. Tests only., reset_gate() (+39 more)
...
### Community 157 - "OllamaCircuitBreaker"
Cohesion: 0.08
...
Cohesion: 0.04
Nodes (54): _as_bool(), _as_int(), ephemeral_ttl_hours(), ephemeral_ttl_hours_cached(), get_setting(), _maybe_schedule_refresh(), onboarding_gate_enabled(), onboarding_gate_enabled_cached() (+46 more)

### Community 160 - "SetupChecker"
Cohesion: 0.07
...
### Community 161 - "PromptCacheManager"
Cohesion: 0.06
...
### Community 163 - "services/background.py"
Cohesion: 0.04
...
### Community 171 - "_resolve_brain_provider"
Cohesion: 0.04
...
Cohesion: 0.06
Nodes (18): _get_settings(), When True, the governance layer evaluates and audits agent actions. This is…, Typed configuration loaded from environment variables., When True, approval-gated actions self-approve. Local dev only., ``RENDER_SERVICE_IDS`` split into a clean list (empty when unset)., True when there is both an API key and an endpoint to reach., When True, the Render ops loop runs. On by default. Also requires…, When True, mutating Render MCP tools may be called. Default False. (+10 more)

### Community 173 - "Part A — CodeRabbit review fixes for this PR (do first, small)"
Cohesion: 0.05
...
### Community 174 - "Docker Agent Runtimes Setup"
Cohesion: 0.05
...
### Community 175 - "resolve_component_model"
Cohesion: 0.06
...
Cohesion: 0.09
Nodes (22): filter_output(), FilterResult, get_savings_summary(), OutputFilter, Any, agent/output_filter.py — LLM Output Compression & Token Savings Inspired by…, Filter and compress command outputs to reduce LLM token consumption. Provides…, Compact git status output — keep only changed file paths. (+14 more)
...
### Community 178 - "Persistent Memory System"
Cohesion: 0.05
...
### Community 179 - "._execute_via_cli"
Cohesion: 0.36
Nodes (4): Path, TaskResult, TaskSpec, Write .jcode/mcp.json in the workspace, pointing at our proxy's MCP endpoint.…

### Community 180 - "test_portfolio_intake.py"
Cohesion: 0.08
...
### Community 181 - "anthropic_compat.py"
Cohesion: 0.09
...
Cohesion: 0.05
Nodes (57): brain_availability_summary(), Non-secret answer to "can the brain answer a request right now?". Three callers…, get_ceo_dispatcher(), Return the shared CEODispatcher singleton., Reset the singleton (test helper)., reset_ceo_dispatcher(), CEOSupervisor, _env_flag() (+49 more)

### Community 184 - "AGENTS.md — Source of Truth for All AI Agents"
Cohesion: 0.10
Nodes (20): Agent Escalation Rules, AGENTS.md — Source of Truth for All AI Agents, Architecture Overview, Autonomous Maintenance Rules, Bug Triage Process, Codebase Map, Definition of Done, Documentation Requirements (+12 more)

### Community 185 - "proxy.py"
Cohesion: 0.02
Nodes (206): get_agency(), set_agency(), Any, Return recent commits with agent attribution trailers parsed out., Any, agent/skills.py — Skill Library Indexes and searches agent skills from local…, Full-text search across name, description, and content., Register an MCP-hosted skill pack entry. (+198 more)

### Community 186 - "test_scheduler_hydration_bounded.py"
Cohesion: 0.09
...
### Community 191 - "test_workspace_isolation.py"
Cohesion: 0.19
...
### Community 192 - "PatternConsolidation"
Cohesion: 0.06
...
### Community 193 - "TrafficDirector"
Cohesion: 0.09
Nodes (17): In-process traffic distribution and budget accounting for providers., EWMA latency in ms; never-sampled providers sort first. Returning -1.0 for an…, Clear all counters (tests only)., TrafficDirector, _ids(), _P, Tests for packages/ai/traffic_director.py — traffic distribution across…, A provider with no latency sample must be able to earn one. (+9 more)
...
### Community 203 - "TestEstimateTokensForMessages"
Cohesion: 0.05
...
### Community 204 - "agile_api.py"
Cohesion: 0.25
Nodes (18): complete_sprint(), create_sprint(), _get_mgr(), get_velocity(), list_sprints(), Any, BaseModel, get (+10 more)

### Community 205 - "ServiceDaemon"
Cohesion: 0.09
Nodes (26): configure(), get_status(), health(), BaseModel, get, post, Validate configured paths., Check if proxy is running. (+18 more)

### Community 206 - "IssueCategory"
Cohesion: 0.11
Nodes (33): IssueCategory, Enum, str, cluster_friction(), clusters_to_issues(), collect_friction_events(), FrictionCluster, FrictionEvent (+25 more)

### Community 207 - "_Collection"
Cohesion: 0.11
...
### Community 208 - "test_freebuff.py"
Cohesion: 0.09
...
### Community 210 - "Surface"
Cohesion: 0.09
Nodes (27): _egress_policy_reason(), agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Return why governance policy blocks *host*, or None. Runs strictly *after* the…, BudgetExceeded, governance_enabled(), Exception, Raised internally when a session exhausts a limit. Never escapes guard()., True when the governance layer should run at all. A single global off switch… (+19 more)
...
### Community 213 - "test_verification_strategies.py"
Cohesion: 0.12
...
### Community 215 - "test_backend_server_features.py"
Cohesion: 0.07
...
### Community 217 - "test_rate_limiter.py"
Cohesion: 0.09
...
### Community 218 - "REWRITE_PLAN.md — Phased Migration Strategy"
Cohesion: 0.06
...
### Community 219 - "test_brain_failover.py"
Cohesion: 0.10
...
### Community 221 - "test_all_providers_discovery.py"
Cohesion: 0.16
...
### Community 222 - "test_llm_router_e2e.py"
Cohesion: 0.14
...
### Community 223 - "analyze_qualitative"
Cohesion: 0.12
...
### Community 226 - "test_colibri_brain_shim.py"
Cohesion: 0.05
...
### Community 229 - "test_ceo_router.py"
Cohesion: 0.12
...
### Community 230 - "agent_runtime.py"
Cohesion: 0.11
...
### Community 231 - "ENGINEERING_STANDARDS.md — Coding, Security & Testing Standards"
Cohesion: 0.06
...
### Community 232 - "DashboardLayout.js"
Cohesion: 0.07
...
### Community 234 - "local_controller.py"
Cohesion: 0.12
...
### Community 235 - "RenderFinding"
Cohesion: 0.05
Nodes (45): IssueSeverity, build_render_router(), Any, APIRouter, Exception, backend/render_router.py — Render platform view for operators and agents.…, Reject anyone who is not the agency admin., Map an MCP transport failure onto 503 rather than a 500. The distinction… (+37 more)
...
### Community 240 - ".start_onboarding"
Cohesion: 0.11
Nodes (10): Workflow, Detect the Git provider from a repository URL. Args: repo_url: Repository URL…, Start the onboarding process for a company. Args: company_id: Company ID…, Schedule a fire-and-forget background task, keeping a strong reference.…, Force-refresh the dynamic skill registry and log tech-stack recommendations.…, Activate a company's 24x7 agency runtimes in the background. Runs after…, Scan a repository and save the results. Args: company_id: Company ID url:…, Create initial workflows for a company. Args: company_id: Company ID Returns:… (+2 more)
...
### Community 243 - "DashboardScreen.jsx"
Cohesion: 0.07
Nodes (9): BarChart(), Charts, Donut(), ExecutionTimeline(), Sparkline(), ErrorBoundary, DashboardScreen(), fmtTokens() (+1 more)

### Community 244 - "ExecutionRequest"
Cohesion: 0.02
Nodes (155): get_orchestrator_checkpoint_store(), _NoopDB, OrchestratorCheckpointStore, services/orchestrator_checkpoint.py — Durable step-level checkpointing Issue…, Fallback in-memory store when no DB is available., Persist orchestrator runs so they survive restarts., BoundContext, ClassifyOutput (+147 more)

### Community 245 - "test_microagents.py"
Cohesion: 0.15
...
### Community 246 - "Security Analysis — local-llm-server"
Cohesion: 0.06
...
### Community 247 - "admin_gui.py"
Cohesion: 0.10
Nodes (13): Browser admin UI for login, service control, key management, and diagnostics., Update or append a KEY=value line in the .env file., register_admin_gui(), _save_env_var(), get_output_filter(), Get or create the singleton OutputFilter instance., get_cooldown_state(), Return a snapshot of active cooldowns {provider_id: expiry_unix_timestamp}. (+5 more)

### Community 248 - "Langfuse Observability Guide"
Cohesion: 0.06
...
### Community 250 - "test_render_mcp.py"
Cohesion: 0.13
Nodes (15): RuntimeError, Raised when a mutating Render tool is called with writes disabled., RenderWriteBlockedError, _env(), tests/test_render_mcp.py — Render MCP integration. Covers: - MCPClient…, The Go binary hardcodes :10000 and ignores $PORT, so Render must be told., In HTTP mode the token comes from the caller's header, so nothing here is…, The mux serves /mcp only; a health check there opens an SSE stream that never… (+7 more)
...
### Community 254 - "test_purge_backlog.py"
Cohesion: 0.09
...
### Community 255 - "test_telegram_mutating_commands.py"
Cohesion: 0.06
...
### Community 256 - "test_terminal.py"
Cohesion: 0.10
...
### Community 258 - "High-Agency Frontend Skill"
Cohesion: 0.06
...
### Community 263 - "cost_tracker.py"
Cohesion: 0.07
Nodes (18): _build_cost_table(), cost_for_tokens(), get_stats(), _load_env_overrides(), Any, Per-model cost attribution for the LLM provider router. Maintains in-memory…, Return the USD cost for (prompt_tokens, completion_tokens) on *model*. Returns…, Record token usage for *model* (fire-and-forget, never raises). ``tag`` is a… (+10 more)

### Community 264 - "test_sam_voice.py"
Cohesion: 0.07
...
### Community 265 - "tests/test_browser.py"
Cohesion: 0.10
...
### Community 266 - "ContextCompressor"
Cohesion: 0.11
...
### Community 267 - "AgentSessionStore"
Cohesion: 0.03
Nodes (105): agent/harness_enrichment.py — Automatic Harness Enrichment for Agent Prompts…, Agent subsystem — planner / executor / verifier loop., AgentPhaseError, _check_extra_kwargs(), _enforce_signature(), _note_phase_end(), _note_phase_start(), Exception (+97 more)

### Community 268 - "openclaw_gateway.py"
Cohesion: 0.15
...
### Community 270 - "test_autonomy_gate.py"
Cohesion: 0.11
...
Cohesion: 0.05
Nodes (33): livenim, allow_paid_brain(), True only when the operator explicitly opted into a paid (Anthropic) brain.…, Resolve the free NVIDIA NIM brain from env, or ``None`` if unconfigured.…, resolve_free_nvidia_brain(), _FakeAsyncClient, _FakeResponse, _free_env() (+25 more)

### Community 272 - "brain_failover.py"
Cohesion: 0.05
Nodes (67): auto_disable(), _billing_signals(), describe(), disabled_provider_ids(), is_unfixable(), packages/llm/disabled.py — bridge to the durable provider on/off switch. The…, Provider ids currently switched off. Empty when the store is unreachable., Persist a provider as disabled, through the store that already owns it. (+59 more)

### Community 273 - "KeyPool"
Cohesion: 0.04
Nodes (36): _build_request(), Return ``(url, headers, is_anthropic_native)`` for *provider*. Anthropic's…, _digest(), KeyPool, _KeyState, _PoolState, Per-provider API key rotation — the one lever that adds capacity. Every other…, Round-robin key selection with per-key rate-limit cooldowns. (+28 more)

### Community 274 - "SteeringInjector"
Cohesion: 0.11
...
### Community 275 - "test_phase4_runtime_resilience.py"
Cohesion: 0.11
...
### Community 285 - "test_phase5_doctor.py"
Cohesion: 0.12
...
### Community 286 - "RuntimeHealthService"
Cohesion: 0.10
...
### Community 289 - "isolated_telegram_config"
Cohesion: 0.11
...
### Community 290 - "WorkflowBuildRequest"
Cohesion: 0.11
...
### Community 291 - "sam_livekit_worker.py"
Cohesion: 0.13
...
### Community 292 - "schedules/api.py"
Cohesion: 0.13
...
Cohesion: 0.05
Nodes (33): _now(), Any, Path, agent/memory.py — Session Memory Snapshots Persists agent session state to disk…, Persist *state* to disk under *session_id*. Returns the file path., Load a saved snapshot. Returns the state dict or *None* if absent., Return metadata for all saved snapshots (session_id, saved_at, path)., Delete a snapshot. Returns *True* if the file existed. (+25 more)

### Community 294 - "services/seo_audit.py"
Cohesion: 0.08
...
### Community 295 - "Deploy: FreeBuff Telegram bot (24×7)"
Cohesion: 0.07
...
### Community 296 - "Claude Code + Qwen Local Setup"
Cohesion: 0.07
...
### Community 297 - "generate_context.py"
Cohesion: 0.12
...
### Community 298 - "test_backend_runtime_bootstrap.py"
Cohesion: 0.11
...
### Community 299 - "NIMConnectionPool"
Cohesion: 0.12
Nodes (10): NIMConnectionPool, AsyncClient, Persistent httpx.AsyncClient pool with circuit breaker and retry logic. Manages…, Get or create the shared httpx.AsyncClient., Context manager for a pooled client session., Close the connection pool., Manually reset a provider's circuit breaker to CLOSED., Compute exponential backoff delay with jitter. (+2 more)

### Community 300 - "test_workflow_models.py"
Cohesion: 0.13
...
### Community 301 - "test_failover_silent_exhaustion.py"
Cohesion: 0.10
...
### Community 302 - "webui/frontend/package.json"
Cohesion: 0.07
Nodes (26): @types/react, @types/react-dom, typescript, vite, @vitejs/plugin-react, dependencies, react, react-dom (+18 more)

### Community 303 - "Agent Governance Guide"
Cohesion: 0.09
Nodes (22): A tool call is judged twice, Agent Governance Guide, `[]` and absent mean opposite things, API, Approvals, Architecture, Audit trail, Backends (+14 more)

### Community 304 - "test_task_clarification.py"
Cohesion: 0.13
Nodes (7): Best-effort identity for an ``AgentRunner``-like object. Wiring governance into…, resolve_identity_for_runner(), auth_headers(), fixture, Tests for needs_clarification status and /api/tasks/{id}/clarify endpoint., Get auth headers for an admin user., task_id()

### Community 305 - "test_brain_patch_service_token.py"
Cohesion: 0.16
...
### Community 306 - "Performance Analysis — local-llm-server"
Cohesion: 0.08
...
### Community 307 - "LLM Router — troubleshooting"
Cohesion: 0.08
...
### Community 308 - "AgentsScreen.jsx"
Cohesion: 0.13
...
### Community 311 - "TestHarnessAdapter"
Cohesion: 0.09
...
### Community 312 - "test_north_mini_code.py"
Cohesion: 0.08
...
### Community 315 - "test_telegram_approval_e2e.py"
Cohesion: 0.12
...
### Community 317 - "test_service_token.py"
Cohesion: 0.08
...
### Community 320 - "test_daily_automation_2026_08_03.py"
Cohesion: 0.11
...
### Community 322 - "test_rag_context.py"
Cohesion: 0.12
...
### Community 327 - "Session Handoff — 2026-06-15"
Cohesion: 0.08
...
### Community 328 - "TASK 4 — End-to-end approval-gate test"
Cohesion: 0.08
...
### Community 331 - "ClaudeCodeAdapter"
Cohesion: 0.14
...
### Community 334 - "TemporalContextGraph"
Cohesion: 0.12
...
### Community 335 - "test_agency_fix.py"
Cohesion: 0.08
...
### Community 336 - "TestClassifyPlainText"
Cohesion: 0.08
...
### Community 337 - "test_schedule_backlog_drain.py"
Cohesion: 0.10
...
### Community 340 - "_resolve_user_github_token"
Cohesion: 0.17
...
### Community 348 - "test_monitor_lib.py"
Cohesion: 0.11
...
### Community 349 - "test_output_filter.py"
Cohesion: 0.08
...
### Community 350 - "SeoCheckDefinition"
Cohesion: 0.12
...
### Community 352 - "test_workspace_security.py"
Cohesion: 0.10
...
### Community 353 - "The fifteen strategies"
Cohesion: 0.09
...
### Community 354 - "Evidence"
Cohesion: 0.04
Nodes (48): Evidence, Evidence supporting a system detection., _is_blocked_host(), Detect systems from GitHub repository data. Args: repo_data: Repository data…, Cheap (no-DNS) SSRF check for headless-browser subrequests. A rendered page's…, _ds(), _models(), _profiles() (+40 more)

### Community 355 - "ServiceManager"
Cohesion: 0.13
...
### Community 359 - "seo_report_pdf.py"
Cohesion: 0.24
...
### Community 360 - "test_all_features.py"
Cohesion: 0.09
...
### Community 362 - "test_mostly_failed_steps.py"
Cohesion: 0.12
...
### Community 363 - "classify_direct_chat_intent"
Cohesion: 0.13
...
### Community 369 - "PriorityTaskQueue"
Cohesion: 0.13
...
### Community 370 - "_process_task_callback"
Cohesion: 0.17
...
### Community 372 - "test_provider_policy.py"
Cohesion: 0.14
...
### Community 373 - "V3 API Migration Plan — LLM Relay Platform"
Cohesion: 0.10
...
### Community 374 - "SchedulesPage.js"
Cohesion: 0.13
...
### Community 377 - "test_pr923_fixes.py"
Cohesion: 0.07
...
### Community 380 - "CompanyAgencyService"
Cohesion: 0.09
...
### Community 381 - "test_local_controller.py"
Cohesion: 0.17
...
### Community 382 - "test_task_source_id_race.py"
Cohesion: 0.17
...
### Community 383 - "test_voice_pipeline.py"
Cohesion: 0.13
...
### Community 385 - "TestStreamableHTTPTransport"
Cohesion: 0.13
...
### Community 386 - "test_permissions.py"
Cohesion: 0.15
...
### Community 387 - "PersistentMemoryStore"
Cohesion: 0.24
...
### Community 392 - "_resolve_push_token"
Cohesion: 0.27
...
### Community 393 - "Skill: modularity-review"
Cohesion: 0.10
Nodes (19): Acceptance Checks, Applying to This Repo, Further Reading, Modularity Findings Template, Part A: Reviewing Existing Code for Modularity Problems, Part B: Designing New Modular Boundaries, Skill: modularity-review, Step 1 — Map the dependency graph (+11 more)

### Community 394 - "crispy_client.py"
Cohesion: 0.14
Nodes (18): cmd_approve(), cmd_artifacts(), cmd_build(), cmd_events(), cmd_reject(), cmd_status(), cmd_watch(), _get() (+10 more)

### Community 395 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 401 - "test_p0_roadmap_b3_b4_b5.py"
Cohesion: 0.21
Nodes (9): _deep_merge(), Deep merge two dicts. Override values take precedence., CircuitBreakerOpenError, get_nim_pool(), Enum, Raised when a request is blocked by an open circuit breaker., Return the module-level NIMConnectionPool singleton., TestCircuitBreakerOpenError (+1 more)

### Community 402 - "AnthropicProvider"
Cohesion: 0.12
...
### Community 403 - "test_tasks_cache_ttl_env.py"
Cohesion: 0.21
...
### Community 407 - "_extract_tech_relevance"
Cohesion: 0.17
...
### Community 408 - "Docker AI Governance Audit — Final Report"
Cohesion: 0.10
...
### Community 411 - "Analysis & Synthesis Instructions"
Cohesion: 0.11
Nodes (18): 1. Define the Atmosphere, 2. Map the Color Palette, 3. Establish Typography Rules, 4. Define the Hero Section, 5. Describe Component Stylings, 6. Define Layout Principles, 7. Define Responsive Rules, 8. Encode Motion Philosophy (+10 more)

### Community 412 - "Production Readiness Assessment — local-llm-server"
Cohesion: 0.11
...
### Community 413 - "Skill: fabric-patterns"
Cohesion: 0.11
Nodes (18): 1. Ensure Pattern Directory Exists, 2. List Available Patterns, 3. Retrieve a Pattern, 4. Apply a Pattern with Variables, 5. Stitch Patterns Together, 6. Create New Patterns, Acceptance Checks, Directory Structure (+10 more)

### Community 414 - "db/__init__.py"
Cohesion: 0.15
...
### Community 415 - "Admin Dashboard Guide"
Cohesion: 0.11
...
### Community 416 - "Implementation Plan"
Cohesion: 0.11
...
### Community 421 - "Delegation Plan (agent-ready work packages)"
Cohesion: 0.11
...
### Community 422 - "test_chat_mode_regressions.py"
Cohesion: 0.19
...
### Community 425 - "._execute_with_fallback"
Cohesion: 0.15
...
### Community 426 - "test_company_api.py"
Cohesion: 0.11
...
### Community 427 - "TestSchedulerStore"
Cohesion: 0.08
...
### Community 429 - "test_unit5_ui_provider_surface.py"
Cohesion: 0.10
...
### Community 430 - "trend_analysis.py"
Cohesion: 0.19
...
### Community 431 - "validate_session_id"
Cohesion: 0.16
...
### Community 432 - "ErrorInterceptorMiddleware"
Cohesion: 0.18
...
### Community 433 - "HarnessRegistry"
Cohesion: 0.07
Nodes (25): get_harness_adapter(), harness_active(), harness_catalog(), harness_session_close(), #522 + #505: Reliability startup — schedule hydration, orchestrator restore,…, Return the full ECC harness catalog with capabilities. Public — no auth…, Return the currently active ECC harnesses with session metrics. Authenticated —…, Close a harness session and aggregate its metrics. (+17 more)
...
### Community 435 - "Comprehensive Skill Index (By Category)"
Cohesion: 0.11
...
### Community 436 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 437 - "Component Map"
Cohesion: 0.11
...
### Community 438 - "Agent State — colibri GLM-5.2 deployment (resumable)"
Cohesion: 0.11
...
### Community 439 - "Architecture Overview — local-llm-server"
Cohesion: 0.11
...
### Community 440 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
...
### Community 441 - "Platform Guide — the full tour"
Cohesion: 0.11
...
### Community 443 - "Part A — Health Report"
Cohesion: 0.11
...
### Community 445 - "test_tasks_awaiting_approval_api.py"
Cohesion: 0.31
Nodes (12): _client(), asyncio, fixture, Task, TestClient, GET /api/tasks/awaiting-approval — dashboard surface for the pre-execution…, _seed(), task_store() (+4 more)

### Community 446 - "4. Threats"
Cohesion: 0.10
...
### Community 452 - "router/health.py"
Cohesion: 0.20
...
### Community 454 - "test_freebuff_bot.py"
Cohesion: 0.12
...
### Community 458 - "test_task_service_failed_comment.py"
Cohesion: 0.18
...
### Community 459 - "handle_workflow_ide_chat"
Cohesion: 0.18
...
### Community 460 - "TestNormalizeResponseFormat"
Cohesion: 0.10
...
### Community 463 - "SKILL: Industrial Brutalism & Tactical Telemetry UI"
Cohesion: 0.12
...
### Community 464 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 465 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 466 - "test_admin_local_brain_router.py"
Cohesion: 0.18
...
### Community 467 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 468 - "Section-by-Section Acceptance Criteria"
Cohesion: 0.12
...
### Community 470 - "agent_readiness_audit.py"
Cohesion: 0.21
...
### Community 474 - "agents/agile_ceremonies.py"
Cohesion: 0.09
Nodes (27): _bullets(), generate_backlog_retro(), generate_sprint_retro(), generate_standup(), plan_next_sprint(), Agentic Agile — autonomous ceremonies (standup, retro, sprint planning). Where…, Render a :class:`Retrospective` as a markdown section., Derive retro notes for ``sprint`` from its current metrics. Records… (+19 more)

### Community 475 - ".get_specialists_by_family"
Cohesion: 0.15
...
### Community 476 - "probe_model_liveness"
Cohesion: 0.04
...
### Community 477 - "test_activation_api.py"
Cohesion: 0.21
...
### Community 478 - "test_autonomy_status.py"
Cohesion: 0.12
...
### Community 479 - "test_health_endpoints.py"
Cohesion: 0.17
...
### Community 480 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 481 - "test_local_brain_state.py"
Cohesion: 0.12
...
### Community 484 - "test_portfolio_intelligence.py"
Cohesion: 0.10
...
### Community 485 - "test_telegram_diag_endpoint.py"
Cohesion: 0.12
...
### Community 486 - "hermes_prompt.py"
Cohesion: 0.19
...
### Community 487 - "MemoryMiddleware"
Cohesion: 0.17
...
### Community 489 - "Skill: repowise-intelligence"
Cohesion: 0.12
...
### Community 490 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
...
### Community 491 - "_valid_login_state"
Cohesion: 0.24
...
### Community 492 - "Skill: repowise-intelligence"
Cohesion: 0.12
Nodes (15): 1. Graph Intelligence (Dependency Graph), 2. Git Intelligence, 3. Documentation Intelligence, 4. Decision Intelligence, Acceptance Checks, Directory Structure, Example Usage, Implementation Approach (+7 more)

### Community 493 - "The 10-Step Workflow"
Cohesion: 0.12
...
### Community 494 - "Contributing to local-llm-server"
Cohesion: 0.12
...
### Community 495 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 496 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 497 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
...
### Community 498 - "SkillsScreen.jsx"
Cohesion: 0.12
...
### Community 499 - "implement_agent.py"
Cohesion: 0.16
...
### Community 504 - "ManagedAgentDreams"
Cohesion: 0.22
...
### Community 505 - "e2e/test_browser.py"
Cohesion: 0.21
...
### Community 507 - "test_dockerfile_ships_root_modules.py"
Cohesion: 0.17
...
### Community 508 - "test_frontend_deployment_guards.py"
Cohesion: 0.20
...
### Community 509 - "test_glm52_brain.py"
Cohesion: 0.12
...
### Community 511 - "redact_connection_url"
Cohesion: 0.17
...
### Community 513 - "CollaborationContext"
Cohesion: 0.19
...
### Community 514 - "test_brain_failover_413.py"
Cohesion: 0.13
...
### Community 515 - "Skill: agent-harness"
Cohesion: 0.13
...
### Community 516 - "Skill: checkpoint-strategy"
Cohesion: 0.13
...
### Community 518 - "Skill: local-ai-query"
Cohesion: 0.13
...
### Community 519 - "Skill: parallel-agents"
Cohesion: 0.13
...
### Community 520 - "Skill: parallel-worktrees"
Cohesion: 0.13
...
### Community 521 - "Design System: Taste Standard"
Cohesion: 0.13
...
### Community 526 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 527 - "Attention Mechanisms Internals"
Cohesion: 0.13
...
### Community 529 - "test_schedule_persistence.py"
Cohesion: 0.17
...
### Community 531 - "test_daily_2026_07_24.py"
Cohesion: 0.20
...
### Community 532 - "_push_down_where"
Cohesion: 0.14
...
### Community 534 - "Migration Notes"
Cohesion: 0.12
Nodes (16): Compose secret scoping — the largest remaining gap, Container hardening overlay, Known limitations at merge, Migration Notes, Optional hardening (operator decisions), Path to enforcement, Protect the policy file from agents, Rollback (+8 more)

### Community 535 - "TestDecisionsBotLinks"
Cohesion: 0.17
...
### Community 536 - "test_autonomy_pipeline_regressions.py"
Cohesion: 0.15
...
### Community 538 - "clear_wizard_state_cache"
Cohesion: 0.21
...
### Community 539 - "kimi_bridge_provider_config"
Cohesion: 0.18
...
### Community 541 - "test_dockerfile_ships_config_dir.py"
Cohesion: 0.14
...
### Community 543 - "test_openclaw_gateway.py"
Cohesion: 0.13
...
### Community 545 - "check_container_posture.py"
Cohesion: 0.26
...
### Community 548 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 552 - "Checks Performed"
Cohesion: 0.14
...
### Community 553 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 557 - "Skill: branch-cleanup"
Cohesion: 0.14
...
### Community 558 - "Skill: perplexity — Web Research via Perplexity API"
Cohesion: 0.14
...
### Community 561 - "Quick-Note Issues Processing Summary"
Cohesion: 0.14
...
### Community 562 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 564 - "Runbook: Auto-Resume After Cooldown / Interruption"
Cohesion: 0.14
...
### Community 565 - "SEO / GEO / AIO Audit Engine"
Cohesion: 0.14
...
### Community 566 - "Traffic Distribution Across Providers"
Cohesion: 0.14
...
### Community 570 - "test_issue_triage.py"
Cohesion: 0.17
...
### Community 572 - "_parse_reset_epoch"
Cohesion: 0.21
...
### Community 575 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 576 - "test_critical_flows.py"
Cohesion: 0.29
...
### Community 577 - "test_regression.py"
Cohesion: 0.14
...
### Community 578 - "test_langfuse_agency_wide.py"
Cohesion: 0.09
Nodes (22): tests/test_langfuse_agency_wide.py — tests for PR #961 agency-wide Langfuse.…, langfuse_obs.py must define emit_agency_observation., emit_agency_observation must be a no-op when Langfuse is not configured., tasks/service.py must call emit_agency_observation for task execution., agent/agency.py must call emit_agency_observation for CEO directives., agent/sam.py must call emit_agency_observation for voice commands., backend/server.py scheduler_tick must call emit_agency_observation., packages/ai/self_heal.py must call emit_agency_observation. (+14 more)

### Community 580 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 584 - "test_provider_policy_regression.py"
Cohesion: 0.13
...
### Community 586 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 589 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 590 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 594 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 595 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 597 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 598 - "admin_update_task_router.py"
Cohesion: 0.22
...
### Community 602 - "Skill: platform-setup — Autonomous Agency Bootstrap"
Cohesion: 0.15
...
### Community 603 - "Workspace Isolation Architecture"
Cohesion: 0.15
...
### Community 604 - "Device compatibility and model picks"
Cohesion: 0.15
...
### Community 605 - "Autonomy Uplift — Living Roadmap & Detailed Implementation Specs"
Cohesion: 0.15
...
### Community 606 - "OpenClaw — iOS Control of the Agency (Single-Service Free-Tier Deploy)"
Cohesion: 0.15
...
### Community 609 - "Agent Transparency Report"
Cohesion: 0.15
...
### Community 610 - "update_provider_policy"
Cohesion: 0.19
...
### Community 612 - "_InMemoryBackend"
Cohesion: 0.18
...
### Community 613 - "test_agile_api.py"
Cohesion: 0.15
...
### Community 614 - "test_app_settings.py"
Cohesion: 0.19
...
### Community 615 - "TestModelCostTableUpdates"
Cohesion: 0.26
...
### Community 616 - "test_deploy_trigger_covers_image.py"
Cohesion: 0.21
...
### Community 617 - "TestRuntimeControl"
Cohesion: 0.15
...
### Community 618 - "TestKillSwitchDurability"
Cohesion: 0.15
...
### Community 620 - "WorkspaceManifest"
Cohesion: 0.17
...
### Community 628 - "Skill: system-prompt-audit"
Cohesion: 0.17
...
### Community 629 - "Skill: task-alive-updates"
Cohesion: 0.17
...
### Community 634 - "CLAUDE.md — Master Architect Operating Manual"
Cohesion: 0.20
...
### Community 635 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 638 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 640 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 641 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 642 - "Quantization Internals"
Cohesion: 0.17
...
### Community 643 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 644 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 645 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 646 - "Render MCP — autonomous platform debugging and environment monitoring"
Cohesion: 0.17
...
### Community 648 - "test_p0_roadmap_a4_a5_b2.py"
Cohesion: 0.26
...
### Community 650 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 651 - "TestAuthAndTaskCreation"
Cohesion: 0.17
...
### Community 652 - "test_schedule_growth_invariants.py"
Cohesion: 0.08
Nodes (21): _FakeMongoStore, _FakeSQLiteStore, asyncio, parametrize, Workstream D — Never again: dedup + growth invariants. These tests enforce…, Simulates a Mongo-style store with find/aggregate/replace_one., Simulates a SQLite-style store with load_all/upsert/remove., Duplicate-named rows must collapse to newest on BOTH backends. Regression for… (+13 more)

### Community 653 - "TestAnthropicPayloadStructuredOutput"
Cohesion: 0.29
...
### Community 656 - "test_google_provider_models.py"
Cohesion: 0.18
...
### Community 657 - "_extractive_compress"
Cohesion: 0.18
...
### Community 659 - "cowork_session.py"
Cohesion: 0.24
...
### Community 661 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 664 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 665 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 667 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 670 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 671 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 672 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 673 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 674 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 675 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 676 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 677 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 679 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 680 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 681 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 682 - "CI Troubleshooting Runbook"
Cohesion: 0.18
...
### Community 683 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 684 - "What to clean up"
Cohesion: 0.18
...
### Community 685 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 686 - "test_bedrock_live.py"
Cohesion: 0.25
...
### Community 690 - "_ensure_tasks_source_id_unique_index"
Cohesion: 0.26
...
### Community 692 - "agent/watchdog.py"
Cohesion: 0.15
...
### Community 693 - "TestBrainConfigUpdates"
Cohesion: 0.14
...
### Community 695 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 696 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 698 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 699 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 700 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 701 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 702 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 703 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 704 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 707 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 708 - "LLM Router — configuration guide"
Cohesion: 0.20
...
### Community 709 - "LLM Router — provider guide"
Cohesion: 0.20
...
### Community 712 - "build_tech_db.py"
Cohesion: 0.40
...
### Community 716 - ".request"
Cohesion: 0.15
Nodes (8): Any, Response, RuntimeError, Make an HTTP request through the pool with circuit breaker protection. Args:…, Convenience wrapper: request with automatic retry., Get or create a circuit breaker for a provider., Return circuit breaker statistics., Return pool statistics.

### Community 718 - "TestZeroAttemptDiagnostics"
Cohesion: 0.29
...
### Community 719 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 720 - "test_provider_state_durability.py"
Cohesion: 0.20
...
### Community 723 - "TestActiveStrategy"
Cohesion: 0.29
...
### Community 728 - "Skill: changelog-enforcer"
Cohesion: 0.22
...
### Community 729 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 731 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 732 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 733 - "Skill: changelog-enforcer"
Cohesion: 0.22
Nodes (8): Acceptance Checks, Changelog Location, Entry Format, Examples, Hook Behaviour, Instructions, Skill: changelog-enforcer, When to Use

### Community 734 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
Nodes (8): Branch, Components, Purpose, Quick Start, Session Roles, Skill: cowork-session (Claude Cowork), Testing, When to Use

### Community 735 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 737 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 738 - "Main proxy (`proxy.py`)"
Cohesion: 0.22
...
### Community 739 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 740 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 741 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 742 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 743 - "Release Procedure"
Cohesion: 0.22
...
### Community 744 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 750 - "AdminDigestRouterAuthTests"
Cohesion: 0.23
...
### Community 762 - "DecisionsStore"
Cohesion: 0.30
Nodes (3): DecisionsStore, Any, Connection

### Community 763 - "test_ping.py"
Cohesion: 0.33
...
### Community 764 - "TestGithubSignalHardening"
Cohesion: 0.22
...
### Community 766 - "test_telegram_task_callback.py"
Cohesion: 0.19
...
### Community 767 - "TestPaidPolicyDurability"
Cohesion: 0.22
...
### Community 768 - "test_runtimes_health_endpoint.py"
Cohesion: 0.22
...
### Community 769 - "test_scanner_deps_parity.py"
Cohesion: 0.31
...
### Community 770 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.22
...
### Community 772 - "navigation_metrics.py"
Cohesion: 0.32
...
### Community 774 - "test_workspace_ref_path_preflight.py"
Cohesion: 0.22
...
### Community 777 - "ContributorState"
Cohesion: 0.25
...
### Community 778 - "quality_checker.py"
Cohesion: 0.32
...
### Community 790 - "AGENTS.md — AI Agent Configuration for local-llm-server"
Cohesion: 0.25
...
### Community 791 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 792 - "ceo-micromanagement.md"
Cohesion: 0.25
Nodes (4): P0 behavior change, Readiness contract, Runtime model, Runtime types

### Community 793 - "Feature Maturity / Support Matrix"
Cohesion: 0.25
...
### Community 796 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.25
...
### Community 797 - "Issue #362: Nvidia repo setup"
Cohesion: 0.25
...
### Community 798 - "Issue #364: quick-note:https://www.marktechpost.com/2026/06/01/meet-memory-os-a-6-layer-open-source-memory-stack-built-on-top-of-hermes-agent/"
Cohesion: 0.25
...
### Community 799 - "Issue #378: quick-note:https://www.marktechpost.com/2026/06/02/tinyfish-launches-bigset-an-open-source-multi-agent-system-that-builds-structured-live-datasets-from-plain-english-descriptions/"
Cohesion: 0.25
...
### Community 800 - "Issue #379: quick-note:https://searchengineland.com/schema-markup-optimize-agentic-web-479080"
Cohesion: 0.25
...
### Community 801 - "Issue #380: quick-note:https://cursor.com/blog/cloud-agent-lessons"
Cohesion: 0.25
...
### Community 802 - "Issue #381: quick-note:https://www.xda-developers.com/claude-code-with-opus-48-is-expensive-but-i-made-it-efficient-with-my-local-ai-workflow/"
Cohesion: 0.25
...
### Community 803 - "Issue #382: quick-note:https://claude.com/blog/how-coderabbit-used-claude-to-build-an-agent-orchestration-system"
Cohesion: 0.25
...
### Community 804 - "Issue #383: quick-note:https://www.marktechpost.com/2026/05/29/hexo-labs-open-sources-sia-a-self-improving-agent-that-updates-both-the-harness-and-the-model-weights/"
Cohesion: 0.25
...
### Community 805 - "Issue #416: feat: Self-hosted Codebuff (freebuff) on free NVIDIA models + Telegram bot phone control"
Cohesion: 0.25
...
### Community 806 - "Issue #485: [Trend Digest] Week of 2026-06-08"
Cohesion: 0.25
...
### Community 807 - "Issue #488: quick-note:https://github.com/cookiy-ai/user-research-skill"
Cohesion: 0.25
...
### Community 808 - "Issue #491: Implement whatever is necessary from https://github.com/BehiSecc/awesome-claude-skills"
Cohesion: 0.25
...
### Community 809 - "Issue #493: Use the https://github.com/mvanhorn/last30days-skill skill to get the trend updated"
Cohesion: 0.25
...
### Community 810 - "Issue #495: Read https://www.anthropic.com/news/claude-fable-5-mythos-5 and understand if mythos or fable can be added to the repo"
Cohesion: 0.25
...
### Community 811 - "Issue #504: EPIC: Autonomy hardening — live-verified defects 2026-06-10"
Cohesion: 0.25
...
### Community 812 - "Issue #581: Sprint tracker: pending work after brand rename + mobile-first pass"
Cohesion: 0.25
...
### Community 814 - "Issue #657: quick-note:https://github.com/earendil-works/pi"
Cohesion: 0.25
...
### Community 815 - "Issue #659: quick-note:https://github.com/nex-agi/Nex-N2"
Cohesion: 0.25
...
### Community 816 - "Issue #660: quick-note:https://github.com/getsentry/sentry-for-ai"
Cohesion: 0.25
...
### Community 817 - "Issue #661: quick-note:https://github.com/XiaomiMiMo/MiMo-Code"
Cohesion: 0.25
...
### Community 818 - "Issue #664: quick-note:https://github.com/Grominet95/jarvis-OS"
Cohesion: 0.25
...
### Community 819 - "Issue #666: quick-note:https://github.com/porokka/jarvis-os"
Cohesion: 0.25
...
### Community 820 - "Issue #670: quick-note:https://github.com/perplexityai/bumblebee"
Cohesion: 0.25
...
### Community 821 - "Issue #672: quick-note:https://github.com/Chachamaru127/claude-code-harness"
Cohesion: 0.25
...
### Community 822 - "Issue #676: quick-note:https://github.com/WeiboAI/VibeThinker"
Cohesion: 0.25
...
### Community 823 - "Issue #820: quick-note:https://github.com/cobusgreyling/loop-engineering"
Cohesion: 0.25
...
### Community 824 - "Positional Encoding Internals"
Cohesion: 0.25
...
### Community 826 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 827 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 828 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 829 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 832 - "4. Current Architecture (As-Is)"
Cohesion: 0.29
...
### Community 833 - "test_doctor_service_token_check.py"
Cohesion: 0.21
...
### Community 834 - "ApprovalStore"
Cohesion: 0.06
Nodes (34): Event, publish(), packages/events/bus.py — In-process event bus. Loosely couples components via…, An event published on the bus., Subscribe to an event type., Publish an event to all subscribers., subscribe(), ApprovalRequest (+26 more)
...
### Community 842 - "test_compose_and_coordinate_api.py"
Cohesion: 0.36
...
### Community 844 - "TestProviderRouter"
Cohesion: 0.25
...
### Community 845 - "test_local_brain_router_smoke.py"
Cohesion: 0.25
...
### Community 847 - "test_provider_models_db_outage.py"
Cohesion: 0.25
...
### Community 849 - "._run_git_command"
Cohesion: 0.25
...
### Community 850 - "test_serve_spa_prefixes.py"
Cohesion: 0.36
...
### Community 853 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 859 - "security_fix_agent.py"
Cohesion: 0.57
...
### Community 877 - "DockerAgentAdapter"
Cohesion: 0.17
...
### Community 883 - "1. What This Repo Does"
Cohesion: 0.40
...
### Community 890 - "TestGithubTokenSQLiteRegression"
Cohesion: 0.38
...
### Community 892 - "14. Standing Instructions — Universal Agent Discipline"
Cohesion: 0.17
...
### Community 894 - "test_event_log.py"
Cohesion: 0.45
...
### Community 895 - "Agent Readiness Report"
Cohesion: 0.20
...
### Community 913 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 914 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 915 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 916 - "DailyDigestAggregatorTests"
Cohesion: 0.19
...
### Community 917 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 918 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 919 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 954 - "_FakePersistence"
Cohesion: 0.20
...
### Community 955 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 956 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 957 - "Runtime troubleshooting"
Cohesion: 0.40
Nodes (4): Agent mode timeout, Missing binary / task harness, Runtime troubleshooting, Workspace validation failures

### Community 958 - "knowledgeGraphTab.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 959 - "loginFlowNoTimeout.test.js"
Cohesion: 0.40
Nodes (4): apiSource, { describe, test, expect }, fs, path

### Community 960 - "test_company_stale_id_recovery.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 961 - "worker_no_cache.test.js"
Cohesion: 0.40
...
### Community 963 - "Prompt Library Changelog"
Cohesion: 0.40
Nodes (4): Added, Format, Prompt Library Changelog, [Unreleased]

### Community 964 - "._get_last_commit"
Cohesion: 0.33
...
### Community 965 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 966 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 967 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 968 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 977 - "test_agent_runtime_wrapper.py"
Cohesion: 0.70
...
### Community 978 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 980 - "7. Scheduler Architecture"
Cohesion: 0.67
...
### Community 982 - "8. Authentication Architecture"
Cohesion: 0.67
Nodes (3): 8. Authentication Architecture, Auth dependency chain, Auth flows

### Community 984 - "AuditLog"
Cohesion: 0.07
Nodes (28): detect_secrets(), main(), Recover CHANGELOG.md from a Git merge conflict in its [Unreleased] block. Pre-…, AuditEvent, AuditLog, packages/governance/audit.py — the evidence trail for every governed action.…, Redact secret-shaped substrings, then truncate., One governed action, fully described. Field order follows the… (+20 more)

### Community 985 - "AdminSessionStore"
Cohesion: 0.18
...
### Community 1001 - "company_api.py"
Cohesion: 0.03
Nodes (126): account_lifecycle(), auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint(), generate_onboarding_questions(), get_company(), get_company_access() (+118 more)

### Community 1005 - "stop_colibri_server.ps1"
Cohesion: 0.83
Nodes (3): Fail(), Ok(), W()

### Community 1007 - "start_server.sh"
Cohesion: 0.50
Nodes (3): OLLAMA_HOST, OLLAMA_MODELS, start_server.sh script

### Community 1008 - "check_services"
Cohesion: 0.67
Nodes (3): check_services(), main(), Check if local services are running. Extends the original (proxy + Ollama)…

### Community 1013 - "test_iteration_6_features.py"
Cohesion: 0.50
...
### Community 1015 - "test_no_exception_detail_leaks.py"
Cohesion: 0.50
...
### Community 1016 - "test_skills_route_order.py"
Cohesion: 0.67
...
### Community 1030 - "test_direct_adapter_does_not_bypass"
Cohesion: 0.67
...
### Community 1055 - "_get_current_user"
Cohesion: 0.29
...
### Community 1104 - "_enable_filter"
Cohesion: 0.67
Nodes (3): _enable_filter(), fixture, Ensure filter is enabled for all tests.

### Community 1105 - "test_doctor_coding_brain.py"
Cohesion: 0.32
...
### Community 1113 - "What's New"
Cohesion: 0.29
Nodes (7): 2026-06-16, 2026-06-25, 2026-06-26, 2026-07-04, 2026-07-05, 2026-07-09, What's New

### Community 1114 - "AgentIdentity"
Cohesion: 0.33
Nodes (5): AgentIdentity, Any, Return a copy carrying extra execution context. Used when context arrives after…, Serialise for audit rows and API responses. Every field here is non-secret by…, The acting subject of a governed action. Immutable by construction so a…
...
### Community 1117 - "test_log_monitor_storm_guard.py"
Cohesion: 0.48
...
### Community 1119 - "The full agent capability roster"
Cohesion: 0.33
...
### Community 1169 - "resolve_hermes_base_url"
Cohesion: 0.47
...
### Community 1172 - "_merge_changed_files"
Cohesion: 0.33
...
## Knowledge Gaps
- **3466 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3461 more)
...
- **Why does `AgentRunner` connect `AgentRunner` to `StuckDetector`, `AgentScheduler`, `Agency`, `test_brain_failover_413.py`, `backend/server.py`, `TaskSpec`, `AgentSessionStore`, `test_agent_free_brain.py`, `test_ceo_micromanager.py`, `KeyPool`, `PortfolioManager`, `CEODispatcher`, `LocalWorkspace`, `E2BAdapter`, `UserMemoryStore`, `E2BSandboxSession`, `failover_chat_completion`, `proxy.py`, `.execute`, `test_empirical_verify.py`, `ContextPruner`, `direct_chat.py`, `WorkspaceTools`, `TokenBudget`, `TestMCPServer`, `TestZeroAttemptDiagnostics`, `MCPClient`, `GitHubTools`, `BackgroundAgent`, `test_backend_server_features.py`, `test_governance_api.py`, `DirectChatSession`, `Workspace`, `AdaptiveHalter`, `ContextManager`, `MultiAgentSwarm`, `ReactScratchpad`, `test_agent_tool_governance.py`, `ExecutionRequest`, `_StubManager`, `TestAgentLoopMCPIntegration`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `AgentSessionStore` connect `AgentSessionStore` to `DirectChatSession`, `AgentScheduler`, `Agency`, `AgentRunner`, `backend/server.py`, `direct_chat.py`, `UserMemoryStore`, `FeatureMaturity`, `test_workspace_ref_path_preflight.py`, `TaskSpec`, `IssueCategory`, `ExecutionRequest`, `proxy.py`, `test_event_log.py`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `TaskStore` connect `TaskStore` to `test_startup_warmup.py`, `Task`, `backend/server.py`, `TaskWorkflowService`, `AgentSessionStore`, `test_telegram_task_callback.py`, `test_trend_scoping.py`, `test_phase4_runtime_resilience.py`, `test_issue_intake.py`, `test_task_brain_preflight.py`, `services/background.py`, `BrainWatchdog`, `test_portfolio_intake.py`, `test_task_pre_execution_gate.py`, `test_tasks_awaiting_approval_api.py`, `tasks/service.py`, `tasks/api.py`, `TaskDispatcher`, `test_sqlite_store.py`, `get_task_store`, `test_task_source_id_race.py`?**
