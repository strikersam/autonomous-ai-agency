# Graph Report - local-llm-server  (2026-07-27)

## Corpus Check
- 1302 files · ~1,804,994 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 24667 nodes · 49944 edges · 1110 communities (969 shown, 141 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 6025 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e63923c9`
...
3. `ProviderConfig` - 157 edges
4. `TaskSpec` - 156 edges
5. `ProviderRouter` - 152 edges
6. `Task` - 151 edges
7. `AgentScheduler` - 142 edges
...
## Communities (1110 total, 141 thin omitted)

### Community 0 - "TaskSpec"
Cohesion: 0.02
Nodes (273): admin_seed(), _agent_timeout_fallback_response(), auth_me(), auto_recommend_skills(), _build_agent_status_snapshot(), _build_agent_stream_event(), _build_provider_router(), call_llm() (+265 more)

### Community 1 - "ProviderConfig"
Cohesion: 0.02
Nodes (167): _acquire_provider_probe(), clear_cooldowns(), _dead_model_key(), _exponential_backoff_cooldown(), extract_openai_text(), get_dead_models(), is_anthropic_base_url(), is_commercial_provider() (+159 more)

### Community 2 - "RuntimeHealth"
Cohesion: 0.04
Nodes (106): kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider).      Ret, AiderAdapter, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized).  Aider (https, Adapter for Aider — TIER 3 specialized git-aware code editor., runtimes/adapters/claude_code.py — Claude Code CLI adapter (FIRST CLASS).  Claud, DockerAgentAdapter, runtimes/adapters/docker_agent.py — Docker-based agent runtime adapter.  Spawns (+98 more)

### Community 3 - "PortfolioManager"
Cohesion: 0.02
Nodes (138): generate_backlog_retro(), generate_standup(), Derive a retrospective from the task tracker when no sprint is active.      DONE, Build a :class:`StandupReport` from ``.claude/state/active-tasks.md``.      Read, AgileManager, Manages multiple agile sprints with velocity tracking., Predict next sprint velocity from historical data., Number of managed sprints. (+130 more)

### Community 4 - "Agency"
Cohesion: 0.02
Nodes (150): Agency, AgencyCycleResult, AgentDirective, AgentRole, _build_ceo_prompt(), _build_quick_note_instruction(), _close_github_issue(), _collect_recent_git_context() (+142 more)

### Community 5 - "AgentRunner"
Cohesion: 0.02
Nodes (141): get_enrichment(), Agent subsystem — planner / executor / verifier loop., AgentPhaseError, AgentRunner, _check_extra_kwargs(), _enforce_signature(), _nvidia_api_key(), Any (+133 more)

### Community 6 - "ExecutionRequest"
Cohesion: 0.02
Nodes (91): Return orchestrator queue depth, active runs, and supervisor state (#522)., Called by APScheduler when a cron fires. Dispatches to the orchestrator., #522 + #505: Reliability startup — schedule hydration, orchestrator restore, que, _scheduler_on_fire(), _startup_reliability_hooks(), workflow_orchestrator_status(), get_orchestrator_queue(), services/orchestrator_queue.py — Async FIFO run queue with concurrency semaphore (+83 more)

### Community 7 - "FreeBuffAgent"
Cohesion: 0.05
Nodes (142): BackgroundAgent, BackgroundTask, _now(), Any, agent/background.py — Background Agent  An always-on worker thread that proces, Enqueue *task* for processing. Returns the task (with task_id set)., Convenience: create a task and submit it in one call., Real handler — dispatches through AgentRunner when available.          HARDENE (+134 more)

### Community 8 - "proxy.py"
Cohesion: 0.03
Nodes (160): Any, Return recent commits with agent attribution trailers parsed out., get_sam(), Attempt a named one-click fix., run_fix(), middleware, admin_control(), admin_create_key() (+152 more)

### Community 9 - "test_ceo_supervision.py"
Cohesion: 0.03
Nodes (132): Semaphore, CEODispatcher, _harvest_changed_files(), Any, Extract the files a runtime touched. Returns ``(files, reported)``.      Adapter, Build an agent.coordinator.TaskSpec from a CEO SpecialistTask., Real CEO delegation: wake runtimes, fan out, and merge results., Record the goal and its sub-tasks in the ledger before any work runs.          W (+124 more)

### Community 10 - "FeatureMatrix"
Cohesion: 0.02
Nodes (72): check_feature(), get_feature(), list_features(), Any, get, post, features/api.py — Admin API for the feature support matrix.  Exposes:   GET  /ad, Return the full support matrix with summary. (+64 more)

### Community 11 - "AgentSessionStore"
Cohesion: 0.07
Nodes (112): AgentJobRequest, AgentJobSnapshot, Complete point-in-time view of a job, safe to serialise as API response., Convenience: the canonical text response, whether success or failure., Validated input for creating a new agent job.      Passed from the API handler, DirectChatDoctor, AgentJobManager, QuickNoteQueue (+104 more)

### Community 12 - "AgentScheduler"
Cohesion: 0.02
Nodes (82): AgentScheduler, _now(), Any, agent/scheduler.py — Scheduled Agent Jobs  Cron-based job scheduler.  Each job h, Register a new job.  Returns the created :class:`ScheduledJob`.          ``run_o, Fire a job immediately (webhook / manual trigger)., Remove a job. Returns *True* if it existed., Update the display name of a job. (+74 more)

### Community 13 - "TaskStore"
Cohesion: 0.03
Nodes (110): agents/store.py — Persistent store for user-defined agent configurations.  Store, quick_notes_submit(), Submit a quick-note URL or instruction from the dashboard FAB., packages/ai/self_heal.py — automatic brain self-healing.  When the active brain, Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., tasks — Task/issue management system.  Provides a lightweight task/issue tracker, Enum (+102 more)

### Community 14 - "company_api.py"
Cohesion: 0.07
Nodes (118): AccountLifecycleResponse, _DoctorCheck, _DoctorReport, get_public_doctor_report(), OnboardingAnswersRequest, OnboardingProgressResponse, OnboardingQuestionsRequest, provision_specialist() (+110 more)

### Community 15 - "CompanyGraphStore"
Cohesion: 0.02
Nodes (67): requires_db, CompanyGraphStore, Delete a company and all its associated data., Update a company in SQLite., Delete a company and all associated data from SQLite., Count total companies in SQLite., Reconstruct a Website from a SQLite row, preferring the full JSON         blob, Count total companies in the store. (+59 more)

### Community 16 - "get_company_graph_store"
Cohesion: 0.03
Nodes (123): account_lifecycle(), auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint(), generate_onboarding_questions(), get_company(), get_company_access() (+115 more)

### Community 17 - "TaskSpec"
Cohesion: 0.04
Nodes (66): PreflightReport, AgentJob, make_isolated_workspace(), Path, Create an isolated workspace directory under *root*.      This is the legacy p, _workspace_component(), Create, open, and lifecycle-manage per-job isolated workspaces.      All works, Resolve *relative* within *ws*.source and reject traversal/symlink escapes. (+58 more)
...
### Community 19 - "brain_config.py"
Cohesion: 0.03
Nodes (95): Call-time resolver for an agent role model id.      Delegates to ``services.brai, _resolve_role_model(), BrainConfig, BrainConfigStore, default_brain_config(), get_brain_config(), get_brain_config_store(), invalidate_brain_config_cache() (+87 more)

### Community 20 - "MongoDBStore"
Cohesion: 0.04
Nodes (58): CompanyGraphSnapshot, A point-in-time snapshot of a Company Graph for history and rollback., MongoDBStore, Any, Company, ObjectId, Prepare a Pydantic model for SQLite storage., Prepare a SQLite row for Pydantic model. (+50 more)

### Community 21 - "test_ceo_dispatcher.py"
Cohesion: 0.03
Nodes (103): CEOResult, _complexity_rank(), _decompose_into_subtasks(), get_ceo_dispatcher(), _merge_changed_files(), _offload(), services/ceo_dispatcher.py — Real CEO delegation layer.  The CEO splits a comple, Run a synchronous ledger call without blocking the event loop.      ``CEOLedger` (+95 more)

### Community 22 - "test_ceo_micromanager.py"
Cohesion: 0.05
Nodes (101): Split the request into briefed, tier-assigned specialist sub-tasks.          Ret, build_subtask_brief(), _coerce_subtasks(), decompose(), _env_flag(), _env_int(), _extract_json_object(), fallback_decomposition() (+93 more)

### Community 23 - "Task"
Cohesion: 0.04
Nodes (68): Hand the 'connect & verify the repo' work to the agency's own agents.      The t, _seed_connect_task(), ApprovalCheckpoint, _coerce_ts(), ExecutionLogEntry, Any, field_validator, Full task/issue document. (+60 more)

### Community 24 - "workflow_orchestrator.py"
Cohesion: 0.05
Nodes (74): get_orchestrator_checkpoint_store(), _NoopDB, OrchestratorCheckpointStore, Any, services/orchestrator_checkpoint.py — Durable step-level checkpointing  Issue #5, Restore in-flight runs at startup.          Called during backend bootstrap.  Re, Fallback in-memory store when no DB is available., Persist orchestrator runs so they survive restarts. (+66 more)

### Community 25 - "WebsiteScanner"
Cohesion: 0.03
Nodes (69): main(), Returns (url, ok, summary)., _scan_one(), _content_contains_domain(), _hostname_contains(), _hostname_matches(), _is_safe_url(), _looks_like_bot_challenge() (+61 more)

### Community 26 - "direct_chat.py"
Cohesion: 0.05
Nodes (87): Any, Translate technical preflight issues into a conversational assistant reply., translate_error_to_conversational(), agent/job_manager.py — Async agent job lifecycle manager.  Manages agent jobs, ResumeRequest, AcceptedJob, AgentJobEnvelope, CompletedJob (+79 more)

### Community 27 - "test_unit8_model_catalog.py"
Cohesion: 0.03
Nodes (69): CatalogActiveBrain, CatalogMirror, CatalogProviderEntry, invalidate_catalog_cache(), ModelCatalogStore, Any, BaseModel, One provider's catalog entry in the mirrored document. (+61 more)

### Community 28 - "AgileSprint"
Cohesion: 0.03
Nodes (48): _bullets(), generate_sprint_retro(), plan_next_sprint(), Agentic Agile — autonomous ceremonies (standup, retro, sprint planning).  Where, Render a :class:`Retrospective` as a markdown section., Derive retro notes for ``sprint`` from its current metrics.      Records observa, The result of allocating portfolio capacity into a new sprint., Render the sprint plan as markdown. (+40 more)

### Community 29 - "Specialist"
Cohesion: 0.03
Nodes (49): BusinessCategory, SpecialistFamily, Find all specialists of a specific family., Find specialists that can handle a task with given capabilities., A specialist agent that can be provisioned for company-specific tasks., Check if this specialist can handle a task with given capabilities., Specialist, CompanyGraphService (+41 more)

### Community 30 - "test_phase6_workflow.py"
Cohesion: 0.04
Nodes (73): add_pr_comment(), _find_existing_pr(), get_branch_sha(), get_default_branch(), _headers(), Any, agent/safe_agency.py — Safe GitHub operations for the workflow engine.  All fu, Create a pull request. Returns the PR object dict.      If a PR already exists (+65 more)

### Community 31 - "SecretRecord"
Cohesion: 0.06
Nodes (60): get_user_role(), str, Extract role from a user object (dict or Pydantic model)., UserRole, _can_read(), _can_write(), create_secret(), _decrypt() (+52 more)

### Community 32 - "AutonomyTracker"
Cohesion: 0.04
Nodes (49): AutonomyCounter, AutonomySnapshot, AutonomyTracker, get_tracker(), Any, agent/kpi.py — Autonomy KPIs: evidence capture and metrics tracking.  Tracks k, Return a point-in-time snapshot of all KPIs., Reset all counters (test helper). (+41 more)

### Community 33 - "TaskWorkflowService"
Cohesion: 0.05
Nodes (58): Set the global agent store instance (e.g., with MongoDB on startup)., set_agent_store(), _is_brain_connection_error(), Any, BaseException, Task, TaskResult, TaskSpec (+50 more)

### Community 34 - "SpecialistService"
Cohesion: 0.04
Nodes (55): build_matrix(), _families(), main(), Any, Map family -> sorted list of test files that mention it (quoted token)., Return one row per family, derived entirely from code., render_markdown(), _test_evidence_index() (+47 more)

### Community 35 - "test_model_router.py"
Cohesion: 0.05
Nodes (79): classify_task(), _extract_recent_text(), Any, Task classification from request context.  Classifies an incoming request into a, Concatenate plain text from the last *last_n* messages., Return the most likely task category for this request.      Args:         messag, Reset the singleton and clear the cached model map (test helper)., reset_router() (+71 more)

### Community 36 - "brain_failover.py"
Cohesion: 0.04
Nodes (60): brain_providers(), Every configured provider with its health AND its on/off state.      Powers the, Turn a provider on or off. Manual re-enable clears an auto-disable.      Auto-di, set_brain_provider_enabled(), auto_disable_provider(), describe_disabled_reason(), _disabled_from_mongo(), _disabled_from_sqlite() (+52 more)

### Community 37 - "NotificationDispatcher"
Cohesion: 0.04
Nodes (51): NotificationDispatcher, Any, Path, Start the Telegram bot. Returns True if started successfully., Signal the bot to stop and wait for graceful shutdown., Run the Telegram bot long-poll loop (inline, not subprocess)., Run the bot with stop-event awareness., Routes background task results to configured notification channels.      Current (+43 more)

### Community 38 - "test_loop_registry.py"
Cohesion: 0.05
Nodes (64): audit_drift(), _cmd_audit(), DriftReport, _grade(), load_registry(), load_registry_sync(), loop_readiness(), LoopRegistry (+56 more)

### Community 39 - "test_knowledge_sync.py"
Cohesion: 0.06
...
### Community 40 - "setup/api.py"
Cohesion: 0.06
Nodes (68): is_user_onboarding_allowed(), Return True if this user may run the onboarding wizard.      Resolution order:, audit(), Append an audit log entry.      Never logs raw secrets — only secret IDs / maske, complete_wizard(), _delete_wizard_state(), detect_configured_providers(), detect_hardware_for_wizard() (+60 more)
...
Cohesion: 0.06
Nodes (58): E2BSandboxSession, _inject_token(), maybe_attach_e2b(), Kill the sandbox. Idempotent; never raises (best-effort cleanup)., Seed the sandbox from a host worktree by packing tracked files.          Creates, Extract changed files from the sandbox back to the host worktree.          After, Open an E2B session and attach it as ``runner._mcp``.      Single wiring line fo, Return ``(authed_url, clean_url)`` for a GitHub repo URL. (+50 more)

### Community 43 - "test_sam_livekit.py"
Cohesion: 0.04
Nodes (65): auth_headers(), livekit_env(), no_livekit_env(), _normalize_dockerfile(), fixture, parametrize, tests/test_sam_livekit.py — SAM realtime voice (LiveKit) integration.  Covers: -, Empty key/secret/identity/room must raise ValueError. (+57 more)

### Community 44 - "rbac.py"
Cohesion: 0.05
Nodes (48): compute_savings(), compute_time_series(), get_savings(), get_usage(), get_user_savings(), _period_start(), Any, BaseModel (+40 more)

### Community 45 - "DashboardLayout.js"
Cohesion: 0.04
...
### Community 46 - "BrainWatchdog"
Cohesion: 0.04
Nodes (56): Any, Background tick that runs self_heal_brain_and_unblock_tasks().      Called from, One-shot self-healing pass.      1. Checks if the active brain provider is in a, self_heal_brain_and_unblock_tasks(), _self_heal_tick(), BrainWatchdog, get_watchdog(), _is_provider_actually_available() (+48 more)

### Community 47 - "runtimes/api.py"
Cohesion: 0.05
Nodes (69): _enrich_runtimes(), get_decision_log(), get_policy(), get_runtime(), list_runtimes(), _load_rich_policy(), Any, get (+61 more)

### Community 48 - "test_response_cache.py"
Cohesion: 0.06
Nodes (71): _cache_key(), cache_stats(), clear_cache(), get_cached(), is_cacheable(), put_cached(), Any, packages/ai/response_cache.py — LRU+TTL in-memory response cache for the Provide (+63 more)

### Community 49 - "CEOSupervisor"
Cohesion: 0.05
Nodes (53): brain_availability_summary(), Non-secret answer to "can the brain answer a request right now?".      Three cal, CEOSupervisor, _env_flag(), _env_int(), get_ceo_supervisor(), Any, services/ceo_supervisor.py — the CEO's 24x7 babysitting loop.  Delegation alone (+45 more)

### Community 50 - "test_user_research_skill.py"
Cohesion: 0.06
Nodes (44): analyze_quantitative(), auto_register(), _classify_sentiment(), _extract_keywords(), plan_research(), Any, BaseModel, field_validator (+36 more)

### Community 51 - "AgentSwarm"
Cohesion: 0.06
...
### Community 53 - "test_failover_client_shared.py"
Cohesion: 0.08
Nodes (70): failover_chat_completion(), Run one chat completion across the brain-failover chain.      Tries each healthy, _free_tier(), _hit_ids(), _many_providers(), _mixed_registry(), _openai_body(), _paid() (+62 more)

### Community 54 - "FailureCategory"
Cohesion: 0.05
Nodes (38): filter_safe_tools(), get_tool_annotations(), Typed representation of MCP tool annotations (spec 2025-11-05 §5.6.1).      Al, Return True only when the tool is definitively read-only and non-destructive., Extract ``ToolAnnotations`` for a named tool from a ``list_tools()`` result., Return tools where ``readOnlyHint`` is True and ``destructiveHint`` is not True., ToolAnnotations, FailureCategory (+30 more)

### Community 55 - "SelfHealingAgent"
Cohesion: 0.05
Nodes (48): heal_signature(), HealingEvent, _now(), Any, Translate external failure signals into improvement tasks and verify the     fix, Launch the background sweeper that resolves quiet verifying heals., Called when a CI workflow fails., Called when a GitHub issue with a bug label is opened. (+40 more)

### Community 56 - "Artifact"
Cohesion: 0.06
Nodes (42): AgentRole, Return the AgentProfile for the agent driving *phase*., Run a pre-gate or report phase through the correct agent.          Enforces perm, Execute a slice via the Coder agent (write-permitted)., Review a slice via the Reviewer agent (different model from Coder).          Thi, Run verification commands via the Verifier agent.          The Verifier is execu, Return a copy of *routing* with the profile's model injected for its role., Return the AgentProfile for *role*, raising KeyError if unknown. (+34 more)
...
### Community 59 - "test_ai_insights.py"
Cohesion: 0.05
Nodes (51): AIToolMetrics, build_report(), EngagementMetrics, PerformanceAnalytics, datetime, Enum, str, AI-Assisted Engineering Insights — track AI tool usage, engagement, and performa (+43 more)

### Community 60 - "ResearchTask"
Cohesion: 0.06
...
### Community 64 - "test_model_catalog.py"
Cohesion: 0.05
...
### Community 67 - "resolve_e2b_config"
Cohesion: 0.05
Nodes (59): Available iff config resolves AND the SDK is importable.          Never raises —, e2b_status(), Return the E2B sandbox integration status for the ProvidersScreen badge.      Do, e2b_enabled(), E2BConfig, _env_falsy(), _env_truthy(), is_e2b_sdk_importable() (+51 more)

### Community 68 - "WorkspaceTools"
Cohesion: 0.05
Nodes (37): repowise.py — RepowiseIntelligence: context packing and dependency analysis., Path, tools.py — WorkspaceTools: read/write/search and diff application (risky module), Return the first *lines* lines of a file.          Just-in-time retrieval: the e, Return a lightweight index of files with line counts and sizes.          This is, Delegate to RepowiseIntelligence for a natural-language codebase question., Delegate to RepowiseIntelligence for a semantic/text codebase search., Delegate to RepowiseIntelligence to list architectural decision nodes. (+29 more)
...
### Community 70 - "test_repo_connection.py"
Cohesion: 0.07
...
### Community 71 - "test_brain_failover.py"
Cohesion: 0.05
Nodes (52): brain_failover_status(), Return the brain failover health snapshot.      Shows every configured provider,, BrainFailoverManager, get_failover_manager(), ProviderInfo, Any, Map a requested model to the provider's equivalent.          If the requested mo, Maximum number of provider attempts before giving up. (+44 more)
...
### Community 74 - "test_bedrock_provider.py"
Cohesion: 0.05
Nodes (21): _is_bedrock_model_id(), Return True if model_id is an AWS Bedrock model or inference profile ID., _bedrock_api_response(), _bedrock_provider(), _mock_boto3(), Any, asyncio, Tests for AWS Bedrock provider support in ProviderRouter. (+13 more)
...
### Community 77 - "LogWatcher"
Cohesion: 0.05
Nodes (21): _is_bedrock_model_id(), Return True if model_id is an AWS Bedrock model or inference profile ID., _bedrock_api_response(), _bedrock_provider(), _mock_boto3(), Any, asyncio, Tests for AWS Bedrock provider support in ProviderRouter. (+13 more)

### Community 78 - "Workspace"
Cohesion: 0.06
Nodes (28): _check_auth(), _err(), _handle_tool(), health(), mcp_dispatch(), _ok(), Any, get (+20 more)

### Community 79 - "test_colibri_brain_shim.py"
Cohesion: 0.05
Nodes (58): colibri_enabled(), colibri_provider_config(), colibri_status(), providers/colibri.py — Free local GLM-5.2 brain served by JustVugg/colibri.  Mir, Return True iff the operator opted in via ``COLIBRI_ENABLED=true``., Cheap status snapshot for tests + admin UI., Return the ``ProviderConfig`` for the local colibri server, or ``None`` when dis, _safe_priority() (+50 more)
...
### Community 82 - "DetectedSystem"
Cohesion: 0.05
Nodes (42): DetectedSystem, A business system detected on a company's website or in their stack., Get the most confident evidence description., OnboardingService, Workflow, Detect the Git provider from a repository URL.                  Args:, Start the onboarding process for a company.                  Args:             c, Schedule a fire-and-forget background task, keeping a strong reference. (+34 more)

### Community 83 - "SeoFixer"
Cohesion: 0.08
...
### Community 84 - "StreamingDeltaReconstructor"
Cohesion: 0.06
...
### Community 85 - "Platform Guide — the full tour"
Cohesion: 0.03
Nodes (59): 1. Clone and install, 2026-06-16, 2026-06-25, 2026-06-26, 2026-07-04, 2026-07-05, 2026-07-09, 2. Configure (+51 more)

### Community 86 - "resolve_active_brain"
Cohesion: 0.06
Nodes (57): BrainResolution, get_active_brain_sync(), get_brain_preference(), get_provider_role_tags(), _host_is_openai_compatible(), invalidate_brain_cache(), _norm(), _pick_from_records() (+49 more)

### Community 87 - "telegram_bot.py"
Cohesion: 0.07
Nodes (57): all_provider_ids(), _provider_ids_from_literal(), Return every provider id recognised by the brain config system.      Iterates th, Return the provider ids allowed by the ``BrainProvider`` Literal.      Reads the, Return a Markdown-v1-safe preview string under ``max_chars``.      Used by the p, sanitize_paste_for_preview(), _admin_headers(), _answer_callback() (+49 more)

### Community 88 - "probe_model_liveness"
Cohesion: 0.05
...
### Community 91 - "CoworkSession"
Cohesion: 0.06
Nodes (19): ContributorState, CoworkSession, Enum, str, Claude Cowork — shared AI coding sessions with real-time sync.  Enables multiple, A shared AI coding session with multiple human contributors.      Manages turn-t, Request editing control. Returns True if granted.          Grant rules:, Role within a cowork session. (+11 more)

### Community 92 - "TaskIn"
Cohesion: 0.05
Nodes (41): _active_primary_provider(), is_north_mini_code_default(), True when the ``NORTH_MINI_CODE_DEFAULT`` flag is on (default ON).      Reads th, Best-effort read of the active brain's primary provider (or ``None``)., Resolve the model id to force for a code-execution run, or ``None``.      Return, resolve_coding_model_preference(), _check_auth(), health() (+33 more)

### Community 93 - "ai_runner.py"
Cohesion: 0.07
...
### Community 94 - "test_integration_c4_c5_c6_d3.py"
Cohesion: 0.06
...
### Community 95 - "test_sqlite_store.py"
Cohesion: 0.06
Nodes (56): asyncio, tests/test_sqlite_store.py — Unit tests for the SQLite storage adapter.  These t, The exact query shape backend/server.py's provider "Set default" uses:     clear, Unfiltered count uses the SELECT COUNT(*) fast path and must match the     numbe, estimated_document_count mirrors an unfiltered count_documents., db['tasks'] must work like db.tasks (motor exposes both)., TaskStore(db=SQLiteStore) must not raise 'not subscriptable'.      This is the e, B608 guard: all collections in _COLLECTIONS must still be instantiable. (+48 more)

### Community 96 - "test_webui_provider_priority.py"
Cohesion: 0.08
Nodes (41): _bootstrap(), fixture, Path, ProviderManager, WorkspaceManager, tests/test_webui_provider_priority.py — Priority + reorder + brain-policy surfac, The /policy/brain endpoint must return the resolved brain + the paid     policy, The /providers/role-tags endpoint surfaces brain/sub/fallback roles     consiste (+33 more)

### Community 97 - "get_self_healing_agent"
Cohesion: 0.07
Nodes (46): _dispatch_async(), _ErrorCaptureHandler, get_log_monitor(), LogMonitor, _note_recurrence(), Any, LogRecord, agent/log_monitor.py — Application Log Monitor  Captures ERROR/CRITICAL log re (+38 more)

### Community 98 - "MCPClient"
Cohesion: 0.06
Nodes (27): get_mcp_client(), MCPClient, Any, RuntimeError, agent/mcp_client.py — Async MCP client for the mcp-server Docker container.  T, Prefer structured data; fall back to text when unavailable., Thin async MCP client with open/close circuit breaker.      Thread-safe only w, Perform MCP handshake. Optional — tools/call works without it. (+19 more)

### Community 99 - "services/seo_audit.py"
Cohesion: 0.08
Nodes (36): BaseModel, models/seo_audit.py - SEO / GEO / AIO Audit Contracts  Typed Pydantic models for, A single occurrence of a check firing on a specific URL., Snapshot of one crawled page with the on-page facts the checks used., Aggregated report row - Screaming Frog CSV compatible., Site-level facts discovered during the crawl., An agent-delegable remediation work package derived from the findings.      Find, Lightweight listing entry for past audits. (+28 more)

### Community 100 - "test_context_rulebook.py"
Cohesion: 0.06
Nodes (54): Module, stmt, _bound_names(), _good_result(), _guard_statements(), _load(), fixture, ModuleType (+46 more)

### Community 101 - "test_issue_intake.py"
Cohesion: 0.07
...
### Community 102 - "WorkspaceManager"
Cohesion: 0.04
...
### Community 105 - "ProvidersScreen.jsx"
Cohesion: 0.05
...
### Community 106 - "test_seo_audit.py"
Cohesion: 0.06
...
Cohesion: 0.08
Nodes (30): DetectedIssue, ImprovementLoop, ImprovementLoopState, _now(), Any, Path, Background scanner and task dispatcher for continuous codebase improvement., Run a scan immediately (blocking). Returns newly detected issues. (+22 more)

### Community 108 - "TestHarnessAdapter"
Cohesion: 0.05
Nodes (24): get_harness_adapter(), harness_active(), harness_catalog(), harness_session_close(), harness_session_start(), Return the full ECC harness catalog with capabilities.      Public — no auth req, Return the currently active ECC harnesses with session metrics.      Authenticat, Register a new harness session (called by the orchestrator on execute). (+16 more)

### Community 109 - "useSafeData"
Cohesion: 0.05
...
### Community 110 - "E2BAdapter"
Cohesion: 0.06
Nodes (42): E2BAdapter, Any, Declare ``E2B_API_KEY`` as a required env dependency.          The base ``prefli, Runtime adapter that executes tasks inside an E2B sandbox.      Activation: regi, PolicyUpdateBody, BaseModel, RunTaskBody, _clean_e2b_env() (+34 more)

### Community 111 - "test_telegram_freebuff.py"
Cohesion: 0.06
Nodes (50): cmd_freebuff(), _model_keyboard(), _parse_callback(), _parse_user_ids(), _process_callback(), Extract numeric Telegram user IDs from a raw env value, tolerantly.      Accepts, Resolve the ALLOWED/ADMIN Telegram user-ID sets.      ``TELEGRAM_CHAT_ID`` is th, Send a message with an inline keyboard (list of button rows). (+42 more)

### Community 112 - "InferenceCache"
Cohesion: 0.06
...
### Community 114 - "skill_bindings.py"
Cohesion: 0.06
...
Cohesion: 0.07
Nodes (30): _check_rate_limit(), default_keys_path(), issue_new_api_key(), KeyRecord, KeyStore, load_key_store(), Exception, Path (+22 more)

### Community 117 - "test_kimi_bridge_server.py"
Cohesion: 0.06
...
### Community 119 - "services/background.py"
Cohesion: 0.06
Nodes (46): get_improvement_loop(), get_skill_registry_safe(), Return the global SkillRegistry if set, else None.     Used by onboarding and ot, get_trend_watcher(), set_trend_watcher(), _await_hermes_ready(), BackgroundServices, _env_float() (+38 more)

### Community 120 - "ChatHistoryStore"
Cohesion: 0.07
...
### Community 122 - "AgentJobResult"
Cohesion: 0.06
Nodes (19): AgentJobError, AgentJobResult, Any, BaseModel, field_validator, agent/contract.py — Typed public contract for the agent job lifecycle.  Phase, Structured error payload attached to a failed job., Typed result returned by a completed agent job.      The ``response`` field is (+11 more)

### Community 123 - "ReactScratchpad"
Cohesion: 0.06
...
### Community 126 - "persist_plan_spec"
Cohesion: 0.07
...
### Community 128 - "test_trend_scoping.py"
Cohesion: 0.10
...
### Community 131 - "CLAUDE.md — Master Architect Operating Manual"
Cohesion: 0.04
...
### Community 132 - "test_slop_gate.py"
Cohesion: 0.07
...
### Community 133 - "failover_client.py"
Cohesion: 0.06
Nodes (43): _auto_disable(), _build_request(), _describe_registry(), _disable_unless_key_serves_other_models(), _disabled_ids(), FailoverResult, _is_billing_refusal(), _is_ollama() (+35 more)

### Community 134 - "_StubProvider"
Cohesion: 0.09
Nodes (24): _models_to_try(), Order the models to attempt on *provider*, correcting a stale catalogue.      Ca, _mock_get(), _ok(), asyncio, A stale model catalogue must not be mistaken for a dead account.  ``config/model, None means "could not find out" and must not read as "no models"., Otherwise every failed call re-asks a provider that is already down. (+16 more)

### Community 135 - "test_e2b_data_flow.py"
Cohesion: 0.07
...
### Community 136 - "test_e2b_task_wiring.py"
Cohesion: 0.08
...
### Community 139 - "test_agent_free_brain.py"
Cohesion: 0.05
Nodes (38): livenim, allow_paid_brain(), is_anthropic_model(), True only when the operator explicitly opted into a paid (Anthropic) brain., True when *model* names a paid Anthropic/Bedrock-Claude model.      Covers nativ, Resolve the free NVIDIA NIM brain from env, or ``None`` if unconfigured.      Re, resolve_free_nvidia_brain(), _opus_model() (+30 more)

### Community 140 - "test_pr923_fixes.py"
Cohesion: 0.06
Nodes (38): cleanup_stale_jobs(), _is_stale(), nuclear_cleanup(), Any, packages/scheduler/cleanup.py — schedule deduplication + stale removal.  Extract, Remove a job from the store. Returns True on success, False on failure.      Log, Directly delete ALL stale jobs from the DB collection.      More aggressive than, Check if a created_at timestamp is older than ttl_seconds.      Handles multiple (+30 more)

### Community 141 - "OllamaCircuitBreaker"
Cohesion: 0.08
...
### Community 142 - "_resolve_brain_provider"
Cohesion: 0.06
Nodes (36): Resolve the LLM endpoint for agent execution (module-level, #522 failover)., _resolve_brain_provider(), Regression tests for: brain-skip-paid, provider-priority persistence, scanner Na, Critical failover-safety test: if every free provider's base URL is     excluded, When the ONLY configured provider is a paid one (e.g. operator set     ANTHROPIC, When only Anthropic is configured AND allow_paid=False (default),     the resolv, The PUT /api/providers/{id} endpoint did not persist priority edits     because, scanner.py used to end with a bare `systems` statement at module level,     whic (+28 more)

### Community 143 - "fixture"
Cohesion: 0.05
Nodes (26): fixture, skip, Test iteration 7 features: - POST /api/tasks/ auto-assigns an available agent an, Test runtime start/stop endpoints return informational payloads in remote enviro, POST /runtimes/{id}/start should return 200 with informational payload (not 500), POST /runtimes/stop-all should return 200 with informational payload, Test that routing policy defaults allow paid fallback only with approval, GET /runtimes/policy should show never_use_paid_providers=false and require_appr (+18 more)

### Community 144 - "validate_outbound_url"
Cohesion: 0.09
Nodes (30): test_git_ref_rejects_empty(), test_git_ref_rejects_flag_injection(), test_git_ref_rejects_shell_metacharacters(), test_git_ref_rejects_traversal(), test_git_ref_valid(), test_git_scheme_allows_ssh(), test_http_scheme_rejects_ssh(), test_https_public_host_allowed() (+22 more)

### Community 145 - "workflow/api.py"
Cohesion: 0.10
Nodes (45): approve(), build(), cancel(), _engine(), get_agent_team(), get_artifact_content(), get_events(), get_run() (+37 more)

### Community 146 - "AdaptiveHalter"
Cohesion: 0.07
...
### Community 148 - "PromptCacheManager"
Cohesion: 0.06
...
### Community 149 - "test_quick_note.py"
Cohesion: 0.08
Nodes (30): _fetch_text(), _now(), process_note(), Any, Path, QuickNote, agent/quick_note.py — iPhone Quick Note integration.  Persistent URL queue + b, GET *url* and return plain text (HTML tags stripped, max *max_chars*). (+22 more)

### Community 150 - "TrendWatcher"
Cohesion: 0.13
...
### Community 152 - "SeoAuditRequest"
Cohesion: 0.06
Nodes (21): field_validator, Request to run an SEO/GEO/AIO audit against a website., SeoAuditRequest, Run an audit from synchronous code, loop-safe.      Used by the skill-bindings e, Pick the fetch backend for this run (http / browser / auto)., Execute the full audit: crawl, page checks, site checks, scoring., run_audit_sync(), mock_report() (+13 more)

### Community 153 - "test_features_api.py"
Cohesion: 0.05
...
### Community 155 - "v3_auth.py"
Cohesion: 0.08
Nodes (42): _get_admin_email(), _get_admin_name(), _get_admin_secret(), login(), LoginRequest, LoginResponse, BaseModel, get (+34 more)

### Community 156 - "test_self_heal_v2.py"
Cohesion: 0.08
Nodes (42): Reset the singleton (for tests)., reset_failover_manager(), _heal_brain_failover(), _heal_stuck_tasks(), _heal_task_duplicates(), _heal_telegram(), _heal_timestamps(), Any (+34 more)

### Community 157 - "workflow/models.py"
Cohesion: 0.07
Nodes (24): _fake_artifact(), _make_engine(), fixture, tests/test_crispy_workflow.py — CRISPY workflow engine hardening tests.  Tests f, Provide isolated DB + artifact + workspace paths., Create a WorkflowEngine with isolated storage., TestAbortOnFailure, TestPhaseSequence (+16 more)

### Community 158 - "activation_api.py"
Cohesion: 0.10
...
### Community 159 - "Part A — CodeRabbit review fixes for this PR (do first, small)"
Cohesion: 0.05
...
### Community 160 - "Docker Agent Runtimes Setup"
Cohesion: 0.05
...
### Community 161 - "OnboardingScreen.jsx"
Cohesion: 0.06
...
### Community 162 - "anthropic_compat.py"
Cohesion: 0.09
...
### Community 163 - "test_backend_server_features.py"
Cohesion: 0.06
Nodes (28): _agent_provider_failure_response(), _append_agent_session_message(), _build_auto_skill_guidance(), _builtin_provider_records(), get_doctor_diagnostics(), _mask_observations(), Exception, Path (+20 more)

### Community 164 - "emit_chat_observation"
Cohesion: 0.09
...
### Community 165 - "Persistent Memory System"
Cohesion: 0.05
...
### Community 166 - "resolve_component_model"
Cohesion: 0.06
Nodes (41): Resolve the model id for a component's role on a provider.      Parameters     -, Convenience: resolve all four role models for a component.      Returns a dict w, resolve_component_model(), resolve_component_role_models(), tests/test_unit6_resolve_component_model.py — UNIT 6 regression tests.  Verifies, When the DB cache is fresh AND provider matches the active primary,     the DB-s, When the DB primary differs from the requested provider, the catalog     preset, When `provider` is None, the DB primary's saved model wins. (+33 more)

### Community 167 - "SchedulerStore"
Cohesion: 0.08
Nodes (17): _MemCollection, _MemCursor, _MemDB, _MemDeleteResult, Any, services/scheduler_store.py — Durable scheduler persistence.  Issue #505: AgentS, Delete a persisted job., Return the total number of persisted jobs. (+9 more)

### Community 168 - ".get_workspace"
Cohesion: 0.09
...
### Community 169 - "state.py"
Cohesion: 0.08
Nodes (19): AgentEvent, AgentSession, AgentSessionMessage, models.py — Pydantic models for agent I/O contracts., A single entry in the session's append-only event log.      Inspired by Anthro, _now(), Connection, Path (+11 more)
...
### Community 171 - "IssueCategory"
Cohesion: 0.10
Nodes (36): IssueCategory, IssueSeverity, Enum, str, agent/improvement_loop.py — Continuous Improvement Engine  Background scanner th, agent/trend_watcher.py — Internet-connected AI trend intelligence.  Fetches fr, cluster_friction(), clusters_to_issues() (+28 more)

### Community 172 - "lifespan"
Cohesion: 0.06
Nodes (28): _keepalive_self_ping(), lifespan(), Run the FreeBuff Telegram bot, restarting it on unexpected exit., Ping our own public URL so a free-tier web service doesn't sleep.      Render fr, Start the Telegram bot (and keep-alive) inside the web process when enabled., _start_in_web_bot_tasks(), _telegram_bot_supervisor(), _get_hashed_token() (+20 more)

### Community 173 - "TestEstimateTokensForMessages"
Cohesion: 0.06
Nodes (13): _estimate_tokens_for_messages(), _normalize_anthropic_output_format(), Estimate input token count for an Anthropic-format message list.      Uses a sim, Translate Anthropic ``output_format`` into an Ollama ``format`` field.      Modi, fixture, Daily automation tests — 2026-05-15  Covers three features implemented in this r, Integration tests for POST /v1/messages/count_tokens., Unit tests for _normalize_anthropic_output_format. (+5 more)

### Community 174 - "TestClient"
Cohesion: 0.07
Nodes (26): backend_jwt(), proxy_client(), fixture, MonkeyPatch, TestClient, Regression test for /api/auth/me — verifies the critical endpoint on both the ba, TestClient against proxy.py:app with a known API key seeded., API-key-based /api/auth/me on proxy.py (port 8000). (+18 more)
...
### Community 176 - "test_workspace_isolation.py"
Cohesion: 0.20
Nodes (25): Tests for workspace isolation model (Area A).  Covers:   - Unique workspace path, TestConcurrency, TestCrossSessionIsolation, TestJobIdValidation, TestPathSafety, TestWorkspaceCleanup, TestWorkspaceMetrics, TestWorkspaceNotFound (+17 more)

### Community 177 - "ScheduleStore"
Cohesion: 0.07
...
### Community 181 - "RewardScorer"
Cohesion: 0.08
Nodes (20): get_reward_scorer(), _nvidia_api_key(), BaseModel, Score a response against a prompt using the Nemotron reward model.          Retu, Call the NVIDIA NIM reward endpoint and return the score.          The Nemotron, Parse the reward score from the model's JSON response., Return the module-level RewardScorer singleton., Result of a single reward model scoring operation. (+12 more)

### Community 182 - "ContextPruner"
Cohesion: 0.09
Nodes (30): ContextPruner, Any, context_pruner.py — auto-generated module docstring (user-research skill scan)., Walk messages backward, accumulating per-role char counts.          Returns (kep, Wrap evicted messages into ``<historical_memory_only>`` XML.          The XML bl, Reset the prune timer so the next call always runs the pipeline., 3-phase context window management middleware.      Phase 1 — Truncate: Strips ``, Apply 3-phase pruning if the context is over budget or cache expired.          R (+22 more)

### Community 183 - "GitHubTools"
Cohesion: 0.14
...
### Community 187 - "test_trend_watcher.py"
Cohesion: 0.09
...
### Community 189 - "DecisionsStore"
Cohesion: 0.09
Nodes (10): DecisionsStore, Any, Connection, Test-only: clears the cached singleton so the next get_decisions_store()     bui, # NOTE: ``decision_id`` is NOT a SQL FOREIGN KEY here. The bot's, reset_decisions_store_singleton(), DecisionsStoreTests, _fresh_store() (+2 more)

### Community 190 - "test_persistent_memory.py"
Cohesion: 0.06
...
### Community 193 - "SecurityScanner"
Cohesion: 0.11
Nodes (26): _now(), Any, Path, agent/security_scanner.py — Security & Vulnerability Scanner  Runs static anal, Run all available scanners and aggregate results., Run a cross-harness security audit.          Checks that the agent harness con, Return True if *name* is on PATH., Return current UTC timestamp as ISO string. (+18 more)

### Community 194 - "test_verification_strategies.py"
Cohesion: 0.12
...
### Community 199 - "test_all_providers_discovery.py"
Cohesion: 0.16
Nodes (35): _get(), asyncio, ProviderRouter, Verify every supported provider is correctly discovered, prioritised, and typed., Check if url hostname matches expected domain (exact or subdomain)., Build a ProviderRouter from_env() with only the supplied env vars active., _router(), test_anthropic_discovery() (+27 more)

### Community 200 - "[Unreleased]"
Cohesion: 0.06
Nodes (34): [5.0.0], Added, Added, Added, Added, Added, Added, Added (+26 more)

### Community 201 - "[Unreleased]"
Cohesion: 0.06
Nodes (34): [5.0.0], Added, Added, Added, Added, Added, Added, Added (+26 more)

### Community 202 - "agent_runtime.py"
Cohesion: 0.11
...
### Community 203 - "ENGINEERING_STANDARDS.md — Coding, Security & Testing Standards"
Cohesion: 0.06
...
### Community 204 - "context_rules.py"
Cohesion: 0.11
...
### Community 205 - "local_controller.py"
Cohesion: 0.12
...
### Community 206 - "test_live_server.py"
Cohesion: 0.22
...
### Community 207 - "test_anthropic_router.py"
Cohesion: 0.09
...
### Community 208 - "ContextCompressor"
Cohesion: 0.11
...
### Community 210 - "MCPUnavailableError"
Cohesion: 0.12
Nodes (14): MCPUnavailableError, Raised when the MCP server is unreachable or the circuit is open., Any, Create the sandbox. Raises :class:`MCPUnavailableError` on failure., Route an MCP-style tool call into the E2B sandbox.          Implements: ``write_, Apply new content to a file inside the sandbox, return a diff.          Mirrors, Best-effort scrub of ``token`` from ``text``., Resolve a relative path against ``SANDBOX_WORKDIR``.      Absolute paths are ret (+6 more)

### Community 211 - "SparkProvider"
Cohesion: 0.07
...
### Community 212 - "chat_handlers.py"
Cohesion: 0.12
...
### Community 216 - "test_freebuff.py"
Cohesion: 0.09
Nodes (29): free_nvidia_models(), Return the curated list of free NVIDIA NIM models FreeBuff may use., List the free NVIDIA NIM models a user may pick (e.g. via Telegram)., True when *model* is in the curated free NVIDIA NIM set., is_rate_limit_exempt(), True when this key is on the FreeBuff rate-limit exemption allowlist.        Onl, Accept both Authorization: Bearer <key> (standard) and x-api-key: <key> (Claude, verify_api_key() (+21 more)

### Community 217 - "test_microagents.py"
Cohesion: 0.15
...
### Community 218 - "Security Analysis — local-llm-server"
Cohesion: 0.06
...
### Community 219 - "Langfuse Observability Guide"
Cohesion: 0.06
...
### Community 222 - "test_background_services.py"
Cohesion: 0.10
Nodes (19): Return True when the web process should also run background services., run_background_in_web(), anyio, Unit tests for services/background.py — start_background_services wiring.  Mirro, Scheduler's on_fire handler is set to TaskAutomation.handle_scheduled_job., Calling bg.stop() twice must not raise or double-stop., RUN_BACKGROUND_IN_WEB defaults to True., start_background_services() must start the RuntimeManager. (+11 more)

### Community 223 - "SkillBindings"
Cohesion: 0.10
Nodes (21): _execute_skill_impl(), _get_agile_manager(), _get_portfolio_manager(), Any, A runtime-callable skill that specialists can execute through the workflow engin, Set the singleton SkillBindings instance (for testing)., Central registry that maps skills to specialist families and provides     runtim, List all registered skills. (+13 more)

### Community 224 - "TestDiagCommand"
Cohesion: 0.09
...
### Community 225 - "test_purge_backlog.py"
Cohesion: 0.09
Nodes (23): auth_headers(), FakeTaskStore, fixture, MonkeyPatch, Task, tests/test_purge_backlog.py — 2026-07-03 crash-loop remediation.  Covers: - POST, The per-minute tick must requeue at most ONE blocked task, keep its     auto_ret, Drive _maybe_boot_purge with fakes; return (purged, marker_writes).      ``core` (+15 more)

### Community 226 - "test_telegram_mutating_commands.py"
Cohesion: 0.06
Nodes (22): _Captured, fixture, _make_mock_response(), fixture, tests/test_telegram_mutating_commands.py — N5 acceptance: /setbrain + /merge.  T, Build a mock httpx.Response., A successful /setbrain call must:       1. send the X-Service-Token header, When the backend's liveness probe fails (HTTP 422), the bot reply must     surfa (+14 more)

### Community 227 - "StuckDetector"
Cohesion: 0.13
...
### Community 229 - "High-Agency Frontend Skill"
Cohesion: 0.06
Nodes (30): 10. FINAL PRE-FLIGHT CHECK, 1. ACTIVE BASELINE CONFIGURATION, 2. DEFAULT ARCHITECTURE & CONVENTIONS, 3. DESIGN ENGINEERING DIRECTIVES (Bias Correction), 4. CREATIVE PROACTIVITY (Anti-Slop Implementation), 5. PERFORMANCE GUARDRAILS, 6. TECHNICAL REFERENCE (Dial Definitions), 7. AI TELLS (Forbidden Patterns) (+22 more)

### Community 230 - "model_catalog.py"
Cohesion: 0.08
Nodes (26): _brain_provider_status(), get_catalog_models_route(), Return the mirrored model catalog (advisory-only).      Flag-gated by ``FREELLM_, Return per-provider metadata for the GET endpoint.      Iterates every provider, Return the discovered model list for *provider_id*, or ``[]`` if unknown., _served_models(), provider_base_url(), provider_key_present() (+18 more)

### Community 231 - "facade.py"
Cohesion: 0.09
...
### Community 232 - "Quick-Note GitHub Issues Processing - Session Summary"
Cohesion: 0.06
...
### Community 233 - "OrchestratorQueue"
Cohesion: 0.08
Nodes (13): OrchestratorQueue, Any, _QueueEntry, Async FIFO queue that limits concurrent orchestrator run executions.      ``appr, Enqueue a run for async execution.  Returns immediately.          ``fn(*args, **, Enqueue a run and return a future that resolves when it completes., stop_orchestrator_queue(), fixture (+5 more)

### Community 234 - "TestRecordUsageAndStats"
Cohesion: 0.06
Nodes (6): Tests for packages/ai/cost_tracker.py — per-model cost attribution.  Covers: - c, TestClearStats, TestCostForTokens, TestEnvOverrides, TestGetCostTable, TestRecordUsageAndStats

### Community 235 - "test_daily_2026_06_04.py"
Cohesion: 0.10
...
### Community 236 - "test_autonomy_gate.py"
Cohesion: 0.11
...
### Community 237 - "tests/test_browser.py"
Cohesion: 0.10
...
### Community 238 - "openclaw_gateway.py"
Cohesion: 0.09
Nodes (29): _openclaw_instructions(), openclaw_reverse_proxy(), openclaw_status(), openclaw_websocket(), api_route, websocket, Return the OpenClaw Gateway integration status + pairing QR data.      The gatew, Build the instructions string (separate function to avoid .format() brace issues (+21 more)

### Community 239 - "switch_brain.py"
Cohesion: 0.16
Nodes (29): detect_ollama_models(), dim(), fail(), get_auth_headers(), get_brain_config(), get_ngrok_tunnel_url(), header(), info() (+21 more)

### Community 240 - "test_direct_chat_async.py"
Cohesion: 0.12
Nodes (19): _now(), Any, Run a job using the provided runner and update the job's lifecycle, progress, re, Serialize the AgentJob to a JSON-serializable dictionary for external clients., fixture, runner(), _fake_user(), _FakeChatResult (+11 more)

### Community 241 - "ProjectScaffolder"
Cohesion: 0.14
...
### Community 244 - "SteeringInjector"
Cohesion: 0.11
...
### Community 245 - "test_claude_setup_audit.py"
Cohesion: 0.16
...
### Community 248 - "test_provider_enable_disable.py"
Cohesion: 0.09
Nodes (16): isolated_kv(), one_provider(), asyncio, fixture, parametrize, Per-provider on/off switch, with auto-disable for unfixable failures only.  Oper, The critical guard: disabling on 429 would switch off every free provider., Point the kv_store at a temp DB so tests never touch real state. (+8 more)

### Community 249 - "test_skill_registry_boot_refresh.py"
Cohesion: 0.12
Nodes (17): clean_task(), _install(), _NullDispatcher, _NullRuntimeManager, asyncio, Exception, fixture, The configured remote skill repos must be fetched without a human trigger.  ``Sk (+9 more)

### Community 250 - "Python Dependencies (`requirements.txt`)"
Cohesion: 0.07
...
### Community 251 - "Technical Debt Register — local-llm-server"
Cohesion: 0.07
...
### Community 253 - "test_phase5_doctor.py"
Cohesion: 0.08
Nodes (21): Request, FastAPI dependency: require any authenticated user., require_authenticated(), client(), _coding_brain_check(), fixture, tests/test_doctor_coding_brain.py  Surfaces the North Mini Code coding-brain sta, With NORTH_MINI_CODE_DEFAULT off, the check warns and says so. (+13 more)

### Community 254 - "CostAttributor"
Cohesion: 0.10
...
### Community 256 - "isolated_telegram_config"
Cohesion: 0.11
Nodes (12): isolated_telegram(), isolated_telegram_config(), fixture, tests/_telegram_test_utils.py  Snapshot/restore helper for ``telegram_bot`` modu, Pytest fixture alias for ``isolated_telegram_config``.      Use this in tests th, Snapshot+restore ``tb`` globals + ``TELEGRAM_POLLER_DISABLED``.      Keyword arg, tests/test_telegram_test_utils.py  Self-test suite for ``isolated_telegram_confi, The helper's ``__exit__`` runs ``if original is _MISSING: if hasattr:         de (+4 more)
...
### Community 259 - "MemoryKernel"
Cohesion: 0.11
Nodes (11): Any, agent/sam.py — SAM Voice Agent (System Autonomy Manager)  SAM is the voice-contr, Public snapshot of live agency state (used by the LiveKit worker tools)., Gather live agency state for SAM's situational awareness., Fact, get_memory_kernel(), MemoryKernel, voice/memory_kernel.py — Jarvis OS-inspired Memory Kernel.  Stores atomic facts (+3 more)

### Community 260 - "test_watchdog.py"
Cohesion: 0.09
...
### Community 262 - "llm_providers.py"
Cohesion: 0.17
...
### Community 263 - "Deploy: FreeBuff Telegram bot (24×7)"
Cohesion: 0.07
...
### Community 264 - "Claude Code + Qwen Local Setup"
Cohesion: 0.07
...
### Community 265 - "generate_context.py"
Cohesion: 0.12
...
### Community 267 - "test_phase4_runtime_resilience.py"
Cohesion: 0.11
Nodes (26): _env_flag(), Read a boolean env var. Accepts 'true'/'1'/'yes' (case-insensitive)., _make_task(), asyncio, Task, TaskStatus, tests/test_phase4_runtime_resilience.py  Phase 4: runtime resilience tests.  Cov, Tasks in TODO or DONE status are ignored by the reconciler. (+18 more)
...
### Community 271 - "app_settings.py"
Cohesion: 0.13
Nodes (25): all_settings(), _as_bool(), _as_int(), ephemeral_ttl_hours(), ephemeral_ttl_hours_cached(), get_setting(), _maybe_schedule_refresh(), onboarding_gate_enabled() (+17 more)

### Community 272 - "Performance Analysis — local-llm-server"
Cohesion: 0.08
...
### Community 273 - "test_rate_limiter.py"
Cohesion: 0.12
...
### Community 274 - "ClaudeCodeAdapter"
Cohesion: 0.14
...
### Community 277 - "test_freebuff_bot.py"
Cohesion: 0.10
Nodes (21): _embedded(), _embedded_run(), _fb_models(), _fb_plan(), _fb_run(), _freebuff_max_steps(), Return the free model list (embedded or via proxy)., Generate a read-only plan (embedded or via proxy). Shape: {model, plan}. (+13 more)

### Community 278 - "test_all_features.py"
Cohesion: 0.08
Nodes (10): TestActivation, TestActivity, TestApiKeys, TestCompany, TestDashboard, TestOnboarding, TestSecrets, TestSetup (+2 more)
...
### Community 280 - "test_telegram_approval_e2e.py"
Cohesion: 0.12
...
### Community 286 - "test_rag_context.py"
Cohesion: 0.14
...
### Community 290 - "test_ceo_router.py"
Cohesion: 0.16
Nodes (24): build_ceo_router(), Any, APIRouter, _make_app(), FastAPI, tests/test_ceo_router.py — auth and behaviour for /api/ceo/*.  Follows the isola, The happy path — the branch that actually spends provider budget., Filtering after a LIMIT silently under-reported matching goals. (+16 more)

### Community 291 - "reset_store"
Cohesion: 0.11
Nodes (23): Reset the store singleton (used in tests).      Also resets the motor client sin, reset_store(), tests/test_motor_event_loop_isolation.py — regression test for the flaky ``test_, ``reset_store()`` must clear ``db.mongo_store._client`` and ``_db``,     not jus, ``reset_store()`` must also clear the ``db._store`` wrapper (the     original be, The ``client`` fixture in conftest.py must call ``reset_store()`` before     ent, After ``reset_store()``, the next ``MongoStore._get_db()`` call must     create, test_client_fixture_calls_reset_store_before_lifespan() (+15 more)

### Community 292 - "Session Handoff — 2026-06-15"
Cohesion: 0.08
...
### Community 293 - "TASK 4 — End-to-end approval-gate test"
Cohesion: 0.08
...
### Community 294 - "Any"
Cohesion: 0.15
Nodes (3): Any, field_validator, Coerce unrecognised system_type values to 'custom' so the model never         cr

### Community 295 - "test_north_mini_code.py"
Cohesion: 0.08
...
### Community 296 - "AgentMessageBus"
Cohesion: 0.15
Nodes (9): AgentMessageBus, get_agent_bus(), Remove a subscription., Return all topics that have history., Return the module-level AgentMessageBus singleton., Pub/sub message bus for inter-agent communication.      Agents subscribe to topi, Decorator: subscribe a callback to a topic pattern.          Supports ``*`` (sin, asyncio (+1 more)

### Community 297 - "CompanyAgencyService"
Cohesion: 0.11
...
### Community 298 - "SyntheticDataPipeline"
Cohesion: 0.12
...
### Community 299 - "TemporalContextGraph"
Cohesion: 0.12
...
### Community 300 - "test_agency_fix.py"
Cohesion: 0.08
...
### Community 301 - "TestClassifyPlainText"
Cohesion: 0.08
...
### Community 302 - "Provider"
Cohesion: 0.11
Nodes (15): ABC, packages.ai — provider abstraction, model registry, and failover manager., packages/ai/manager.py — ProviderManager.  Single entry point for all LLM calls., Provider, Any, packages/ai/provider.py — Provider abstraction interface.  Every LLM provider im, Base interface every provider must implement.          Implementations live in p, Unique identifier (e.g. 'nvidia', 'cerebras'). (+7 more)

### Community 303 - "telegram_service.py"
Cohesion: 0.13
Nodes (19): Build a *self-contained, actionable* escalation message.          The previous m, service_manager.py — Telegram & Notification Integration Extension  Extends the, True when outbound Telegram sends must be suppressed.      Tests must never page, # NOTE: do NOT re-escape here — services.daily_digest.format_digest_markdown, _telegram_sends_suppressed(), _event(), The self-heal escalation Telegram message must be self-contained & actionable., test_code_fences_stripped_for_telegram_markdown() (+11 more)

### Community 304 - "synthesize_research"
Cohesion: 0.13
Nodes (15): Combine qualitative + quantitative findings into a decision-ready brief., synthesize_research(), apply_recommendations(), collect_codebase_metrics(), extract_qualitative_themes(), main(), plan_repo_scan(), Use the user research skill to scan the repo and apply recommendations.  Adapt (+7 more)

### Community 305 - "Findings"
Cohesion: 0.08
...
Cohesion: 0.15
Nodes (20): Execute work through the 11-phase golden path., Return the caller's GitHub token from EITHER place it can be stored.      A toke, _resolve_user_github_token(), workflow_orchestrator_execute(), _FakeCollection, _FakeDB, patch_db(), asyncio (+12 more)

### Community 307 - "Local AI Stack with Docker"
Cohesion: 0.08
...
### Community 308 - "Implementation Prompt: Rich TaskBoard + Agile Sprint Integration"
Cohesion: 0.08
...
### Community 309 - "Telegram Bot Setup"
Cohesion: 0.08
...
### Community 310 - "PrioritizedTask"
Cohesion: 0.12
Nodes (12): IntEnum, Queue, PrioritizedTask, Priority, Any, Start the worker pool., Submit a task to the queue.          Returns True if accepted, False if rejected, Subscribe to progress events for a specific task.          Returns an asyncio.Qu (+4 more)

### Community 311 - "test_failover_silent_exhaustion.py"
Cohesion: 0.14
Nodes (20): Paid-tier providers admitted to the chain and not yet attempted.      Empty when, _untried_paid(), _FM, _P, Regression tests for a chain that fails silently.  From a real incident: `/api/d, Reserve logic must never break the chain it is meant to protect., The incident case: providers ran, none reported a reason., The genuinely-empty chain keeps its original, correct wording. (+12 more)

### Community 312 - "admin.py"
Cohesion: 0.12
...
### Community 314 - "seo_report_pdf.py"
Cohesion: 0.24
...
### Community 315 - "schedules/api.py"
Cohesion: 0.13
Nodes (22): create_schedule(), delete_schedule(), get_schedule(), get_schedule_runs(), list_schedules(), BaseModel, delete, get (+14 more)

### Community 316 - "test_monitor_lib.py"
Cohesion: 0.11
Nodes (9): _isolate_env(), fixture, MonkeyPatch, tests/test_monitor_lib.py — unit tests for scripts/monitor_lib.py.  Covers the f, Pin all env-overridable paths to tmp_path for hermetic tests., TestAwaitReady, TestIsProcessAlive, TestSuperviseLoopGiveUp (+1 more)

### Community 317 - "test_output_filter.py"
Cohesion: 0.08
...
### Community 319 - "test_dashboard_cache.py"
Cohesion: 0.14
...
### Community 323 - "_Cursor"
Cohesion: 0.10
Nodes (7): _Cursor, _PendingCursor, Async iterator wrapping a list of dicts (already decoded from JSON)., Return a sort key that tolerates mixed float/str timestamp values.      Some cod, Return a _Cursor (evaluated lazily on first await/iteration)., A cursor that fetches its data lazily on first use., _safe_sort_key()

### Community 324 - "NIMConnectionPool"
Cohesion: 0.12
Nodes (10): NIMConnectionPool, AsyncClient, Persistent httpx.AsyncClient pool with circuit breaker and retry logic.      Man, Get or create the shared httpx.AsyncClient., Context manager for a pooled client session., Close the connection pool., Manually reset a provider's circuit breaker to CLOSED., Compute exponential backoff delay with jitter. (+2 more)

### Community 325 - "TestBrainConfigUpdates"
Cohesion: 0.14
Nodes (5): tests/test_daily_automation_2026_07_10.py — Daily automation tests (2026-07-10)., Verify brain_config.py changes: Google provider, updated presets., Verify Llama 4 and Claude Sonnet 5 cross-provider aliases are registered., TestBrainConfigUpdates, TestBrainFailoverModelAliases
...
### Community 327 - "test_mostly_failed_steps.py"
Cohesion: 0.12
...
### Community 328 - "classify_direct_chat_intent"
Cohesion: 0.13
...
### Community 331 - "Configuration Reference"
Cohesion: 0.09
...
### Community 333 - "PriorityTaskQueue"
Cohesion: 0.13
...
### Community 335 - "V3 API Migration Plan — LLM Relay Platform"
Cohesion: 0.10
...
### Community 336 - "SeoCheckDefinition"
Cohesion: 0.12
Nodes (11): Static definition of a single audit check (catalog entry)., SeoCheckDefinition, auto_fixable_checks(), _c(), get_check(), list_checks(), services/seo_checks.py - SEO / GEO / AIO Check Catalog  The authoritative catalo, Return the catalog definition for a check code (raises KeyError if unknown). (+3 more)

### Community 337 - "GuardrailEngine"
Cohesion: 0.16
...
### Community 338 - "test_issue_triage.py"
Cohesion: 0.17
...
### Community 339 - "test_local_controller.py"
Cohesion: 0.17
...
### Community 340 - "test_unit5_ui_provider_surface.py"
Cohesion: 0.10
Nodes (15): tests/test_unit5_ui_provider_surface.py — UNIT 5 regression tests.  Verifies tha, The component must call ``providerLabel(p)`` rather than indexing a     4-entry, The dropdown shows a [free]/[paid]/[local] tier tag so the operator     can tell, The <option> tag uses providerLabel(p), not PROVIDER_LABELS[]., The operator must be able to see what a key really serves.      ``candidates`` i, The GET endpoint response must list every BrainProvider Literal entry.      Befo, Providers that were filtered out before UNIT 5 are now present.      ``mistral``, A known paid provider is reported as tier=paid (was filtered before). (+7 more)

### Community 341 - "test_voice_pipeline.py"
Cohesion: 0.13
Nodes (15): asyncio, fixture, Tests: Voice pipeline — STT backend selection, TTS backend selection, memory ker, A stalled gTTS/pyttsx3 call must not hang synthesize() forever.      gTTS/pyttsx, TTS_SYNTHESIZE_TIMEOUT_SEC must override the default ceiling., gTTS/pyttsx3 must run on a dedicated executor, not the shared default.      asyn, test_memory_export_markdown(), test_memory_forget() (+7 more)

### Community 342 - "HarnessEnrichment"
Cohesion: 0.15
...
### Community 344 - "test_permissions.py"
Cohesion: 0.15
...
### Community 345 - "PersistentMemoryStore"
Cohesion: 0.24
...
### Community 346 - "Skill: modularity-review"
Cohesion: 0.10
...
### Community 349 - "test_provider_policy_regression.py"
Cohesion: 0.13
Nodes (19): seed_default_providers(), Resolve the LLM endpoint for a named surface (task/chat/ceo/sdlc/…).      Honour, resolve_provider_for(), asyncio, Phase 3 regression test: paid providers are NEVER auto-selected when allow_paid=, The .github/scripts/provider_policy.py module must export allow_paid()     or _f, Anthropic provider priorities must be <= -50 so free cloud     providers are alw, Regression: the google-gemini provider record in seed_default_providers     was (+11 more)

### Community 350 - "TestNormalizeResponseFormat"
Cohesion: 0.10
Nodes (8): _normalize_response_format(), Translate OpenAI ``response_format`` into Ollama's ``format`` field.      For *l, fixture, Payload without 'model' field should apply normalization (no '/' → local)., _normalize_response_format must not mutate the input dict., Unit tests for chat_handlers._normalize_response_format., If json_schema has no 'schema' key, don't break., TestNormalizeResponseFormat

### Community 351 - "Skill: modularity-review"
Cohesion: 0.10
Nodes (19): Acceptance Checks, Applying to This Repo, Further Reading, Modularity Findings Template, Part A: Reviewing Existing Code for Modularity Problems, Part B: Designing New Modular Boundaries, Skill: modularity-review, Step 1 — Map the dependency graph (+11 more)

### Community 352 - "crispy_client.py"
Cohesion: 0.14
Nodes (18): cmd_approve(), cmd_artifacts(), cmd_build(), cmd_events(), cmd_reject(), cmd_status(), cmd_watch(), _get() (+10 more)

### Community 353 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 359 - "test_p0_roadmap_b3_b4_b5.py"
Cohesion: 0.16
Nodes (13): _deep_merge(), Deep merge two dicts. Override values take precedence., CircuitBreakerOpenError, CircuitState, get_nim_pool(), Enum, RuntimeError, Raised when a request is blocked by an open circuit breaker. (+5 more)

### Community 360 - "test_brain_patch_service_token.py"
Cohesion: 0.16
Nodes (19): clean_store(), _clear_overrides(), _make_client_with_user(), fixture, tests/test_brain_patch_service_token.py — N5 acceptance: PATCH /admin/api/policy, N5 acceptance: no service token + no user session → 401 (not 200)., N5 regression: the existing dashboard path (no service token, non-admin     user, N5 regression: the existing admin dashboard path (no service token,     admin us (+11 more)

### Community 361 - "test_tasks_cache_ttl_env.py"
Cohesion: 0.21
...
### Community 362 - "TestOrchestratorEndpointScoping"
Cohesion: 0.16
Nodes (11): api_client(), _ollama_reachable(), _override_user(), fixture, skipif, tests/test_workflow_orchestrator_scoping.py — Phase 8 multi-tenant isolation.  R, Force backend.server.get_current_user to return ``user``., A non-admin's auto_approve=true is ignored — the run still pauses at HITL. (+3 more)

### Community 363 - "TestUpdateTask"
Cohesion: 0.16
...
### Community 364 - "_extract_tech_relevance"
Cohesion: 0.17
...
### Community 365 - "CollaborationContext"
Cohesion: 0.15
...
### Community 367 - "Skill: fabric-patterns"
Cohesion: 0.11
...
### Community 368 - "Analysis & Synthesis Instructions"
Cohesion: 0.11
Nodes (18): 1. Define the Atmosphere, 2. Map the Color Palette, 3. Establish Typography Rules, 4. Define the Hero Section, 5. Describe Component Stylings, 6. Define Layout Principles, 7. Define Responsive Rules, 8. Encode Motion Philosophy (+10 more)

### Community 369 - "Production Readiness Assessment — local-llm-server"
Cohesion: 0.11
...
### Community 370 - "Skill: fabric-patterns"
Cohesion: 0.11
Nodes (18): 1. Ensure Pattern Directory Exists, 2. List Available Patterns, 3. Retrieve a Pattern, 4. Apply a Pattern with Variables, 5. Stitch Patterns Together, 6. Create New Patterns, Acceptance Checks, Directory Structure (+10 more)

### Community 371 - "db/__init__.py"
Cohesion: 0.15
...
### Community 372 - "Admin Dashboard Guide"
Cohesion: 0.11
...
### Community 373 - "Implementation Plan"
Cohesion: 0.11
...
### Community 375 - "RateLimit"
Cohesion: 0.12
Nodes (6): CerebrasProvider, Provider, Cerebras provider adapter — free, fast LLM (qwen-3-coder-480b)., RateLimit, Provider rate limit info., Return the provider's rate limits.

### Community 376 - "Delegation Plan (agent-ready work packages)"
Cohesion: 0.11
...
### Community 377 - "build_workflow.py"
Cohesion: 0.33
Nodes (18): _c(), _get(), _header(), main(), _make_headers(), _phase_icon(), _post(), _print_phases() (+10 more)

### Community 378 - "test_task_source_id_race.py"
Cohesion: 0.17
Nodes (18): _is_duplicate_key_error(), Exception, True if *exc* is a pymongo E11000 duplicate-key error.      Checked by class nam, _FakeDuplicateKeyError, _mock_mongo_db(), asyncio, Exception, tests/test_task_source_id_race.py — TaskStore.create() concurrency safety.  Cove (+10 more)

### Community 379 - "test_company_api.py"
Cohesion: 0.11
...
### Community 380 - "TestSelfHealingInfrastructureClassification"
Cohesion: 0.19
...
### Community 382 - "test_fabric_patterns.py"
Cohesion: 0.11
...
### Community 383 - "test_repowise_intelligence.py"
Cohesion: 0.11
...
### Community 385 - "test_sam_voice.py"
Cohesion: 0.12
Nodes (18): asyncio, tests/test_sam_voice.py — Integration tests for SAM voice agent.  Tests the SAM, Same session_id must return the same session., _build_context must return a dict with expected keys., A hung LLM call must not block SAM — it must time out and fall back., A stalled context read must not block process_command indefinitely., Whitespace-only input must be treated as empty., Fallback must return operational status when LLM is down. (+10 more)

### Community 386 - "trend_analysis.py"
Cohesion: 0.19
Nodes (11): Tests for trend_analysis.py — last30days-style window over TrendWatcher (issue #, TestRunTrendAnalysis, TestWindow, BaseModel, trend_analysis.py — last30days-style trend analysis (issue #493).  Adapts the mv, True if the ISO-ish published date falls within the last N days.      Unparseabl, Write trends/trend_summary.md (and a dated copy); return the path., TrendItem (+3 more)

### Community 387 - "test_workspace_ref_path_preflight.py"
Cohesion: 0.16
Nodes (14): PreflightIssue, BaseModel, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace, asyncio, When git is missing and no GitHub token is present, the doctor should report bot, test_missing_git_and_token(), _fake_user(), _make_fake_doctor() (+6 more)

### Community 388 - "ErrorInterceptorMiddleware"
Cohesion: 0.18
...
### Community 391 - "Comprehensive Skill Index (By Category)"
Cohesion: 0.11
...
### Community 392 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 393 - "Component Map"
Cohesion: 0.11
...
### Community 394 - "Agent State — colibri GLM-5.2 deployment (resumable)"
Cohesion: 0.11
...
### Community 395 - "Architecture Overview — local-llm-server"
Cohesion: 0.11
...
### Community 396 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
...
### Community 398 - "Part A — Health Report"
Cohesion: 0.11
...
### Community 400 - "_Budget"
Cohesion: 0.11
Nodes (10): _Budget, Shared attempt + wall-clock budget for one logical completion.      Bounds the w, True when free/local providers have used everything but the reserve.          On, Drop every cached list and attempt record.      For tests, and for an explicit o, reset_cache(), _clear_cache(), disabled(), fixture (+2 more)

### Community 401 - "SQLiteStore"
Cohesion: 0.16
Nodes (10): Connection, Top-level store — exposes collections as attributes.      Usage::          store, Lazily build the pool of read-only connections (idempotent)., Yield a read connection from the pool (falls back to the writer).          On in, Create tables if they don't already exist., SQLiteStore, fixture, B608 guard: _Collection.__init__ must reject names outside _COLLECTIONS.      Pr (+2 more)

### Community 402 - "agency_fix.py"
Cohesion: 0.20
...
### Community 403 - "sync_readme_gallery.py"
Cohesion: 0.22
...
### Community 404 - "shared_state.py"
Cohesion: 0.18
Nodes (12): clear_all_locks(), cooldown_clear(), cooldown_get(), cooldown_set(), _get_backend(), Shared-state abstraction — in-memory (default) and Redis backends.  Provides dis, Put a key on cooldown for *ttl* seconds., Return True if *key* is still within its cooldown window. (+4 more)

### Community 405 - "test_skill_executors_live.py"
Cohesion: 0.16
Nodes (17): Live Graphify executor — queries the codebase knowledge graph.      Order of pre, Live council reviewer — deterministic, rules-based multi-perspective     review, _run_council_review(), _run_graphify(), parametrize, tests/test_skill_executors_live.py — live graphify + council-review executors., Broadened secret detection catches SECRET_KEY / GITHUB_TOKEN / etc.      The ass, test_council_clean_diff_is_approved() (+9 more)

### Community 406 - "LocalLLMSetup"
Cohesion: 0.16
...
### Community 409 - "test_orchestrator_merge_decision.py"
Cohesion: 0.22
Nodes (14): _company(), _FakeStore, orch(), Company, fixture, Tests for the G5 RepoConnection/DeliveryPolicy wiring into the orchestrator land, test_record_consent_noop_for_non_gate_decision(), test_record_consent_noop_without_decision() (+6 more)

### Community 410 - "TestStopSlopChecker"
Cohesion: 0.11
...
### Community 411 - "test_task_service_failed_comment.py"
Cohesion: 0.18
Nodes (17): coordinator(), _make_result(), mock_store(), mock_workflow(), asyncio, fixture, tests/test_task_service_failed_comment.py — verify that a FAILED TaskResult stil, A FAILED TaskResult without agent_comment transitions to FAILED without crashing (+9 more)

### Community 412 - "handle_workflow_ide_chat"
Cohesion: 0.18
...
### Community 414 - "._fetch_flat_skill_file"
Cohesion: 0.21
...
### Community 418 - "SKILL: Industrial Brutalism & Tactical Telemetry UI"
Cohesion: 0.12
...
### Community 419 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 420 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 421 - "test_admin_local_brain_router.py"
Cohesion: 0.18
Nodes (16): build_admin_local_brain_router(), Any, APIRouter, Construct a ready-to-mount APIRouter with the auth dependency baked in.      The, _require_admin(), _make_app(), FastAPI, tests/test_admin_local_brain_router.py — auth + toggle flow for /admin/api/local (+8 more)

### Community 422 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 172 - "ScheduleStore"
Cohesion: 0.07
Nodes (29): _backend(), _json_default(), Any, agent/schedule_store.py — durable persistence for scheduled agent jobs.  Fixes #, Return all persisted schedule docs (for boot rehydration)., Persist (insert or update) a single schedule by job_id., Delete a persisted schedule., Fallback JSON encoder for schedule docs (datetimes, sets, etc.). (+21 more)

### Community 173 - "test_backend_runtime_bootstrap.py"
Cohesion: 0.11
Nodes (9): anyio, Web lifespan delegates to start_background_services when RUN_BACKGROUND_IN_WEB=t, RUN_BACKGROUND_IN_WEB=false: lifespan starts but background services are NOT sta, _StubRuntimeManager, _StubRuntimeRegistry, _StubTask, _StubTaskDispatcher, test_backend_lifespan_skips_bg_when_flag_false() (+1 more)

### Community 174 - "v4_api.py"
Cohesion: 0.10
Nodes (38): _get_cached_tasks(), _get_tasks_cache_lock(), _load_improvement_state(), Any, BaseModel, get, Lock, post (+30 more)

### Community 175 - "getBackendUrl"
Cohesion: 0.10
Nodes (30): getAccessToken(), getApiUrl(), getAuthHeaders(), getBackendUrl(), ActivityEvent, AgentActivityFeedProps, ActivityEventRow(), AGENT_COLORS (+22 more)

### Community 176 - "ContextPruner"
Cohesion: 0.09
Nodes (30): ContextPruner, Any, context_pruner.py — auto-generated module docstring (user-research skill scan)., Walk messages backward, accumulating per-role char counts.          Returns (kep, Wrap evicted messages into ``<historical_memory_only>`` XML.          The XML bl, Reset the prune timer so the next call always runs the pipeline., 3-phase context window management middleware.      Phase 1 — Truncate: Strips ``, Apply 3-phase pruning if the context is over budget or cache expired.          R (+22 more)

### Community 177 - "IssueCategory"
Cohesion: 0.11
Nodes (35): IssueCategory, IssueSeverity, Enum, str, agent/improvement_loop.py — Continuous Improvement Engine  Background scanner th, cluster_friction(), clusters_to_issues(), collect_friction_events() (+27 more)

### Community 178 - "openclaw_gateway.py"
Cohesion: 0.09
Nodes (29): _openclaw_instructions(), openclaw_reverse_proxy(), openclaw_status(), openclaw_websocket(), api_route, websocket, Return the OpenClaw Gateway integration status + pairing QR data.      The gatew, Build the instructions string (separate function to avoid .format() brace issues (+21 more)

### Community 179 - "KnowledgeScreen.jsx"
Cohesion: 0.09
Nodes (28): createWikiPage(), deleteSource(), deleteWikiPage(), getCompanyGraph(), getSource(), getWikiPage(), ingestSource(), lintWiki() (+20 more)

### Community 180 - "TestEstimateTokensForMessages"
Cohesion: 0.06
Nodes (13): _estimate_tokens_for_messages(), _normalize_anthropic_output_format(), Estimate input token count for an Anthropic-format message list.      Uses a sim, Translate Anthropic ``output_format`` into an Ollama ``format`` field.      Modi, fixture, Daily automation tests — 2026-05-15  Covers three features implemented in this r, Integration tests for POST /v1/messages/count_tokens., Unit tests for _normalize_anthropic_output_format. (+5 more)
...
### Community 435 - "test_portfolio_intelligence.py"
Cohesion: 0.12
Nodes (5): Tests for agents/portfolio_intelligence.py — autonomous signal → initiative.  Lo, DEFAULT_REPO was hardcoded to the stale pre-rename repo name     ('strikersam/lo, TestDefaultRepoFollowUpFix, TestGithubAndResearch, TestParsing

### Community 436 - "_response"
Cohesion: 0.21
Nodes (4): asyncio, _response(), TestPreFlightCheck, TestUpdateFromResponse

### Community 437 - "test_telegram_diag_endpoint.py"
Cohesion: 0.12
...
### Community 438 - "hermes_prompt.py"
Cohesion: 0.19
...
### Community 439 - "MemoryMiddleware"
Cohesion: 0.17
...
### Community 441 - "Skill: repowise-intelligence"
Cohesion: 0.12
...
### Community 442 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
...
### Community 443 - "admin_digest_router.py"
Cohesion: 0.20
Nodes (15): _build_payload_or_500(), _check_secret(), _expected_secret(), preview_digest_endpoint(), Any, get, post, Dry-run: same auth, returns the would-be markdown body but does NOT     dispatch (+7 more)

### Community 444 - "_valid_login_state"
Cohesion: 0.24
...
### Community 445 - "Skill: repowise-intelligence"
Cohesion: 0.12
Nodes (15): 1. Graph Intelligence (Dependency Graph), 2. Git Intelligence, 3. Documentation Intelligence, 4. Decision Intelligence, Acceptance Checks, Directory Structure, Example Usage, Implementation Approach (+7 more)

### Community 446 - "The 10-Step Workflow"
Cohesion: 0.12
...
### Community 447 - "Contributing to local-llm-server"
Cohesion: 0.12
...
### Community 448 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 449 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 450 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
...
### Community 451 - "implement_agent.py"
Cohesion: 0.16
...
### Community 452 - "test_agent_chat_integration.py"
Cohesion: 0.23
...
### Community 453 - "cost_tracker.py"
Cohesion: 0.15
Nodes (15): _build_cost_table(), clear_stats(), cost_for_tokens(), get_stats(), _load_env_overrides(), Any, Per-model cost attribution for the LLM provider router.  Maintains in-memory per, Return the USD cost for (prompt_tokens, completion_tokens) on *model*.      Retu (+7 more)

### Community 454 - "test_kimi_bridge_provider.py"
Cohesion: 0.20
...
### Community 459 - "ManagedAgentDreams"
Cohesion: 0.22
...
Cohesion: 0.28
Nodes (15): _process_task_callback(), Handle Approve/Reject inline-button presses for task execution gates.      Callb, _escape_md_v1(), Escape Telegram Markdown-v1 reserved chars in free-text fields.      Markdown-v1, _make_fake_task(), _patch_workflow(), Robustness tests for the Telegram inline-button callback flow., test_approve_success_clears_spinner_and_edits_message() (+7 more)

### Community 462 - "e2e/test_browser.py"
Cohesion: 0.21
...
### Community 463 - "test_frontend_deployment_guards.py"
Cohesion: 0.20
...
### Community 464 - "test_glm52_brain.py"
Cohesion: 0.12
Nodes (30): build_ceo_router(), Any, APIRouter, Install (or clear) the singleton — used by startup wiring and tests., Drop the singleton (test helper)., reset_ceo_supervisor(), set_ceo_supervisor(), _make_app() (+22 more)

### Community 465 - "test_langfuse_agency_wide.py"
Cohesion: 0.12
...
### Community 467 - "test_task_pre_execution_gate.py"
Cohesion: 0.25
Nodes (13): _coordinator(), asyncio, fixture, Pre-execution approval gate tests (Autonomy Charter Gate Matrix / P0).  A ``requ, Records whether execute() was ever reached; raises so we never need a     full f, _RecordingRuntimeManager, store(), test_approve_execution_requeues_for_run() (+5 more)

### Community 468 - "TestWorkspacePathDerivation"
Cohesion: 0.16
...
### Community 471 - "Skill: agent-harness"
Cohesion: 0.13
...
### Community 472 - "Skill: checkpoint-strategy"
Cohesion: 0.13
...
### Community 474 - "Skill: local-ai-query"
Cohesion: 0.13
...
### Community 475 - "Skill: parallel-agents"
Cohesion: 0.13
...
### Community 476 - "Skill: parallel-worktrees"
Cohesion: 0.13
...
### Community 477 - "Design System: Taste Standard"
Cohesion: 0.13
...
### Community 479 - ".get_state"
Cohesion: 0.22
Nodes (9): _now_iso(), Any, Connection, Return the desired + last-reported state for the admin UI., Operator flips the toggle. Persists + clears any prior lease.          Returns t, Local daemon POSTs its heartbeat.          If the operator's desired_state=on AN, `now_iso`: ISO-8601 string marking the reader's "now" — pass it in to stay, Reviewer fix #f: lease must strip after heartbeats stop arriving.      Simulates (+1 more)

### Community 480 - "Skill: user-research"
Cohesion: 0.13
...
### Community 481 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 482 - "Attention Mechanisms Internals"
Cohesion: 0.13
...
### Community 198 - "seo_api.py"
Cohesion: 0.05
Nodes (63): delegate_seo_findings(), _expire_stale_pending_report(), export_seo_audit(), get_seo_audit(), list_seo_audits(), BaseModel, get, post (+55 more)

### Community 199 - "test_skill_executors_live.py"
Cohesion: 0.16
Nodes (17): Live Graphify executor — queries the codebase knowledge graph.      Order of pre, Live council reviewer — deterministic, rules-based multi-perspective     review, _run_council_review(), _run_graphify(), parametrize, tests/test_skill_executors_live.py — live graphify + council-review executors., Broadened secret detection catches SECRET_KEY / GITHUB_TOKEN / etc.      The ass, test_council_clean_diff_is_approved() (+9 more)

### Community 200 - "AgentScheduler"
Cohesion: 0.02
Nodes (82): AgentScheduler, _now(), Any, agent/scheduler.py — Scheduled Agent Jobs  Cron-based job scheduler.  Each job h, Register a new job.  Returns the created :class:`ScheduledJob`.          ``run_o, Fire a job immediately (webhook / manual trigger)., Remove a job. Returns *True* if it existed., Update the display name of a job. (+74 more)

### Community 201 - "test_backend_server_features.py"
Cohesion: 0.08
Nodes (14): _mask_observations(), Truncate tool/observation content in older messages to prevent context bloat., anyio, Tests for backend/server.py cloud model catalog, multi-agent loop, and context m, Planner and Verifier should be assigned to reasoning (DeepSeek/QwQ) models., Verify _run_agent_loop calls AgentRunner.run and returns the summary., Verify _run_agent_loop handles AgentRunner exceptions gracefully., test_agent_role_models_planner_and_verifier_are_reasoning_models() (+6 more)

### Community 202 - "[Unreleased]"
Cohesion: 0.06
Nodes (33): [5.0.0], Added, Added, Added, Added, Added, Added, Added (+25 more)

### Community 203 - "agent_runtime.py"
Cohesion: 0.11
Nodes (32): _active_cloud_provider(), _candidate_ollama_bases(), _chat(), chat_completions(), _chat_with_ollama(), _chat_with_openai_compat(), ChatRequest, ChatResponse (+24 more)

### Community 204 - "[Unreleased]"
Cohesion: 0.06
Nodes (33): [5.0.0], Added, Added, Added, Added, Added, Added, Added (+25 more)

### Community 205 - "ENGINEERING_STANDARDS.md — Coding, Security & Testing Standards"
Cohesion: 0.06
Nodes (33): 1. Coding Standards, 2. Logging Standards, 3. Security Standards, 4. Testing Standards, 5. CI/CD Standards, 6. Performance Standards, 7. Documentation Standards, Architecture docs (+25 more)

### Community 206 - "context_rules.py"
Cohesion: 0.11
Nodes (32): _check_constitution_echo(), _check_files_exist(), _check_grounding(), _check_hedges(), _check_project_identity(), _check_risk_flags(), _check_source_summary(), _check_todos() (+24 more)

### Community 207 - "local_controller.py"
Cohesion: 0.12
Nodes (32): _bin_exists(), _choose_local_brain(), _default_agency_url(), _default_machine_id_file(), _env_int(), _get_or_create_machine_id(), _http_json(), _log() (+24 more)

### Community 208 - "test_orchestrator_merge_decision.py"
Cohesion: 0.22
Nodes (14): _company(), _FakeStore, orch(), Company, fixture, Tests for the G5 RepoConnection/DeliveryPolicy wiring into the orchestrator land, test_record_consent_noop_for_non_gate_decision(), test_record_consent_noop_without_decision() (+6 more)

### Community 209 - "test_live_server.py"
Cohesion: 0.22
Nodes (32): check(), main(), ok(), Any, Client, Response, Returns access token for subsequent tests., Direct-mode chat. Passes even if no LLM backend is running (error message return (+24 more)

### Community 210 - "test_anthropic_router.py"
Cohesion: 0.09
Nodes (9): _make_anthropic_provider(), _payload(), Response, Tests for Anthropic-specific router features.  Covers: - Prompt caching (ANTHROP, TestAnthropicPayloadExtendedThinking, TestAnthropicPayloadPromptCaching, TestAnthropicToOpenAICacheUsage, TestAuthHeadersExtendedThinking (+1 more)

### Community 211 - "ContextCompressor"
Cohesion: 0.11
Nodes (24): ContextCompressor, ContextStats, _estimate_tokens(), agent/context.py — Smart Context Compression  Three strategies for keeping con, Drop the oldest non-system messages until under the token threshold., Remove exact-duplicate and near-empty messages., Compress conversation history when it approaches the token limit.      Usage::, Return a (possibly shorter) copy of *messages* using *strategy*.          ``in (+16 more)

### Community 212 - "ContextManager"
Cohesion: 0.10
Nodes (24): ContextManager, Any, True when the history is long enough to warrant compaction., Replace the old portion of *history* with a single compaction note.          T, True when the harness should use head_file instead of read_file.          When, Trim a step result so sub-agent outputs stay within ~1-2k tokens.          The, Manages context window state for a single agent run.      The Brain (LLM) stay, Return a copy of *observations* with old tool outputs truncated.          JetB (+16 more)

### Community 213 - "MCPUnavailableError"
Cohesion: 0.15
Nodes (10): MCPUnavailableError, Raised when the MCP server is unreachable or the circuit is open., Any, Create the sandbox. Raises :class:`MCPUnavailableError` on failure., Route an MCP-style tool call into the E2B sandbox.          Implements: ``write_, Apply new content to a file inside the sandbox, return a diff.          Mirrors, Resolve a relative path against ``SANDBOX_WORKDIR``.      Absolute paths are ret, _resolve_sandbox_path() (+2 more)

### Community 485 - "model_discovery.py"
Cohesion: 0.20
Nodes (14): cached_models(), discover_models(), _fresh_entry(), _models_url(), _parse_ids(), Any, Ask a provider which models the configured API key may actually use.  ``config/m, Return the cached list for *provider_id* without any network call.      The disp (+6 more)

### Community 248 - "Artifact"
Cohesion: 0.09
Nodes (26): AgentRole, When coder == reviewer model, swarm should log a warning., TestSlice, _extract_slices_from_plan(), Extract slice definitions from a plan.md artifact.      Looks for sections match, Artifact, ModelRoutingConfig, A durable, phase-produced document (markdown or JSON). (+18 more)
...
### Community 489 - "AdminDigestRouterAuthTests"
Cohesion: 0.23
...
### Community 490 - "clear_wizard_state_cache"
Cohesion: 0.21
...
### Community 493 - "test_openclaw_gateway.py"
Cohesion: 0.13
Nodes (25): _as_bool(), _as_int(), ephemeral_ttl_hours(), ephemeral_ttl_hours_cached(), get_setting(), _maybe_schedule_refresh(), onboarding_gate_enabled(), onboarding_gate_enabled_cached() (+17 more)

### Community 494 - "test_scanner_live.py"
Cohesion: 0.23
Nodes (14): LogCaptureFixture, _fake_auth(), _make_nim_providers(), AuthContext, MonkeyPatch, Path, Integration tests for /agent/chat endpoint and AGENT_RUNNER configuration.  Cove, test_agent_chat_passes_session_store_to_runner() (+6 more)

### Community 495 - "validate_session_id"
Cohesion: 0.23
Nodes (3): TestSessionIdValidation, Validate and return a session ID, or raise InvalidSessionIdError., validate_session_id()

### Community 496 - "WorkspaceManifest"
Cohesion: 0.15
Nodes (9): _now(), Any, BaseModel, WorkspaceStatusLiteral, workspace/manifest.py — Workspace manifest schema.  Each isolated workspace has, Structured manifest for an isolated workspace., Transition to a new status and update cleanup eligibility., Touch the last_heartbeat timestamp. (+1 more)

### Community 497 - "admin_gui.py"
Cohesion: 0.16
...
### Community 501 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 505 - "Checks Performed"
Cohesion: 0.14
...
### Community 506 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 509 - "Skill: branch-cleanup"
Cohesion: 0.14
...
### Community 510 - "Skill: perplexity — Web Research via Perplexity API"
Cohesion: 0.14
Nodes (16): detect_harness(), Harness, harness_context_limit(), harness_stats(), HarnessProfile, Any, Enum, Detect which AI coding tool is calling the proxy.      Checks in priority order: (+8 more)

### Community 340 - "daily_digest.py"
Cohesion: 0.23
...
### Community 341 - "PriorityTaskQueue"
Cohesion: 0.13
Nodes (8): get_task_queue(), PriorityTaskQueue, Stop the worker pool gracefully., Return queue introspection data for status endpoints., Return the module-level PriorityTaskQueue singleton., Asyncio-based priority queue with backpressure and worker pool.      Features:, Higher-priority tasks should be processed before lower-priority ones., TestPriorityTaskQueue

### Community 342 - "test_portfolio_intelligence.py"
Cohesion: 0.10
...
### Community 343 - ".update_intelligence"
Cohesion: 0.08
...
### Community 344 - "test_voice.py"
Cohesion: 0.15
Nodes (13): Any, agent/voice.py — Voice Command Interface  Hands-free agent interaction: record, Transcribe raw PCM *audio_bytes* to text., Record then transcribe in one call., Record *duration_s* seconds of audio. Returns raw PCM bytes (int16 LE, 16 kHz mo, _stub_result(), TranscriptionResult, Tests for agent/voice.py — Voice Command Interface (stub-mode tests). (+5 more)

### Community 345 - "V3 API Migration Plan — LLM Relay Platform"
Cohesion: 0.10
Nodes (20): Acceptance Checks, Approach, Auth Flow (v3 JWT-based), Backward Compatibility, Current State Analysis, Data Model Changes, Database/Storage, Files to Create/Modify (+12 more)

### Community 346 - "Traffic Distribution Across Providers"
Cohesion: 0.09
Nodes (21): Agent Autonomy Roadmap, Design constraints honored, New environment variables, Proactive rate-limit pacing (free-tier reliability), The eight gaps and what closed them, Verification performed, What was already strong (verified, no changes needed), Why this document exists (+13 more)

### Community 347 - "test_chat_mode_regressions.py"
Cohesion: 0.18
...
### Community 348 - "GuardrailEngine"
Cohesion: 0.09
Nodes (15): get_guardrails(), GuardrailEngine, GuardResult, Any, Configurable safety rail engine for LLM inputs and outputs.      Supports:     -, Check user input against input safety rules.          Returns a GuardResult with, Check model output against output safety rules.          Returns a GuardResult w, Unified check method. direction = 'input' or 'output'. (+7 more)

### Community 349 - "test_issue_triage.py"
Cohesion: 0.17
Nodes (19): _match_family(), Any, services/issue_triage.py — inbound GitHub issue triage.  Closes the intake gap l, Classify a single GitHub issue payload and return the routing decision.      Pur, Fetch unlabeled open issues, triage each, and route them.      Returns a summary, run_triage_cycle(), _severity_for(), triage_enabled() (+11 more)

### Community 350 - "test_freebuff_bot.py"
Cohesion: 0.09
Nodes (23): _embedded(), _embedded_run(), _fb_models(), _fb_plan(), _fb_run(), _freebuff_max_steps(), Return the free model list (embedded or via proxy)., Generate a read-only plan (embedded or via proxy). Shape: {model, plan}. (+15 more)

### Community 351 - "traffic_director.py"
Cohesion: 0.13
Nodes (15): provider_weight(), Return the operator-configured share weight for *provider*.      Reads ``<PROVID, Return the configured traffic-distribution strategy (lower-cased).      Reads ``, routing_strategy(), active_strategy(), provider_id_of(), Any, Adaptive traffic distribution across LLM providers.  The router (``packages/ai/r (+7 more)

### Community 352 - "test_local_controller.py"
Cohesion: 0.17
Nodes (20): _env_defaults(), _fake_http_sequence(), _fake_subprocess_run(), _import_controller(), tests/test_local_controller.py — unit tests for the local GLM-5.2 daemon.  These, The diag output must surface binary/model errors clearly., Pins the v3 fix: after the multi-port preamble probe finds colibri     serving a, Yield a list of (status, body) tuples the daemon will see in order     when it c (+12 more)

### Community 353 - "get_tool_registry"
Cohesion: 0.14
Nodes (8): get_tool_registry(), Return the module-level ToolRegistry singleton.      On first call, registers, auto_register(), Any, field_validator, Register the four user-research tools with a ``ToolRegistry``.      Each tool, Register the user research tools into the module-level singleton registry., register_user_research_tools()

### Community 354 - "run_trend_analysis"
Cohesion: 0.19
...
### Community 355 - "test_unit5_ui_provider_surface.py"
Cohesion: 0.10
Nodes (15): tests/test_unit5_ui_provider_surface.py — UNIT 5 regression tests.  Verifies tha, The component must call ``providerLabel(p)`` rather than indexing a     4-entry, The dropdown shows a [free]/[paid]/[local] tier tag so the operator     can tell, The <option> tag uses providerLabel(p), not PROVIDER_LABELS[]., The operator must be able to see what a key really serves.      ``candidates`` i, The GET endpoint response must list every BrainProvider Literal entry.      Befo, Providers that were filtered out before UNIT 5 are now present.      ``mistral``, A known paid provider is reported as tier=paid (was filtered before). (+7 more)

### Community 356 - "test_voice_pipeline.py"
Cohesion: 0.13
Nodes (15): asyncio, fixture, Tests: Voice pipeline — STT backend selection, TTS backend selection, memory ker, A stalled gTTS/pyttsx3 call must not hang synthesize() forever.      gTTS/pyttsx, TTS_SYNTHESIZE_TIMEOUT_SEC must override the default ceiling., gTTS/pyttsx3 must run on a dedicated executor, not the shared default.      asyn, test_memory_export_markdown(), test_memory_forget() (+7 more)

### Community 357 - "MemoryCategory"
Cohesion: 0.16
Nodes (14): Memory middleware for automatic context injection into AI tool requests.  This, MemoryCategory, MemoryEntry, MemoryScope, Enum, Row, str, Enhanced persistent memory system with auto-loading across AI coding tools.  T (+6 more)

### Community 358 - "test_permissions.py"
Cohesion: 0.15
Nodes (15): PermissionAssessment, Any, agent/permissions.py — Adaptive Permission Classifier  Reads the session trans, Convenience helper — True when the inferred level is read_write or full_access., Analyse *messages* and return a :class:`PermissionAssessment`., _msgs(), Tests for agent/permissions.py — Adaptive Permissions., test_assessment_as_dict() (+7 more)

### Community 359 - "PersistentMemoryStore"
Cohesion: 0.24
Nodes (19): PersistentMemoryStore, Enhanced persistent memory store with auto-loading support.          Features:, cmd_autoload(), cmd_delete(), cmd_export(), cmd_import(), cmd_list(), cmd_recall() (+11 more)

### Community 360 - "SamConversation"
Cohesion: 0.17
Nodes (9): Process a voice command and return SAM's spoken response.          Args:, Call the NVIDIA NIM LLM (free tier) for SAM's response., Rule-based fallback when the LLM is unavailable., A single voice conversation session with SAM., SamConversation, add_turn must append to history and increment command_count., History must be capped at 20 entries (10 turns)., test_conversation_add_turn() (+1 more)

### Community 361 - "Skill: modularity-review"
Cohesion: 0.10
Nodes (19): Acceptance Checks, Applying to This Repo, Further Reading, Modularity Findings Template, Part A: Reviewing Existing Code for Modularity Problems, Part B: Designing New Modular Boundaries, Skill: modularity-review, Step 1 — Map the dependency graph (+11 more)

### Community 362 - "Design Audit"
Cohesion: 0.10
Nodes (19): Code Quality, Color and Surfaces, Component Patterns, Content, Design Audit, Fix Priority, How This Works, Iconography (+11 more)
...
### Community 364 - "router/health.py"
Cohesion: 0.20
...
### Community 365 - "Skill: modularity-review"
Cohesion: 0.10
Nodes (19): Acceptance Checks, Applying to This Repo, Further Reading, Modularity Findings Template, Part A: Reviewing Existing Code for Modularity Problems, Part B: Designing New Modular Boundaries, Skill: modularity-review, Step 1 — Map the dependency graph (+11 more)

### Community 366 - "crispy_client.py"
Cohesion: 0.14
Nodes (18): cmd_approve(), cmd_artifacts(), cmd_build(), cmd_events(), cmd_reject(), cmd_status(), cmd_watch(), _get() (+10 more)

### Community 367 - "Dynamic Model Routing"
Cohesion: 0.10
Nodes (20): Architecture, Built-in Claude → local alias table, Configuring fast_response routing, Configuring model preferences, Curl example, Dynamic Model Routing, Fallback execution, Health check and availability filtering (+12 more)

### Community 368 - "PortfolioScreen.jsx"
Cohesion: 0.11
Nodes (12): getPortfolioBoard(), refreshPortfolio(), btnStyle, HEALTH, HORIZONS, PortfolioScreen(), SOURCE, STATUS_COLOR (+4 more)

### Community 369 - "infra_cost.py"
Cohesion: 0.15
Nodes (14): compute_request_cost(), _float_env(), get_infra_config(), InfraConfig, load_infra_config(), project_session_cost(), Local infrastructure cost model for true TCO analysis.  This module computes the, Compute infrastructure cost for a single request given its latency. (+6 more)

### Community 370 - "output_filter.py"
Cohesion: 0.10
Nodes (17): _filter_curl(), _filter_docker(), _filter_git(), _filter_ls(), _filter_npm(), _filter_pip(), _filter_pytest(), _filter_python() (+9 more)
...
### Community 373 - "DecisionsStoreTests"
Cohesion: 0.13
...
### Community 374 - "test_p0_roadmap_b3_b4_b5.py"
Cohesion: 0.19
Nodes (9): _deep_merge(), Deep merge two dicts. Override values take precedence., CircuitBreakerOpenError, RuntimeError, Raised when a request is blocked by an open circuit breaker., get_synthetic_pipeline(), Return the module-level SyntheticDataPipeline singleton., TestCircuitBreakerOpenError (+1 more)

### Community 375 - "validate_outbound_url"
Cohesion: 0.08
Nodes (30): test_git_ref_rejects_empty(), test_git_ref_rejects_flag_injection(), test_git_ref_rejects_shell_metacharacters(), test_git_ref_rejects_traversal(), test_git_ref_valid(), test_git_scheme_allows_ssh(), test_http_scheme_rejects_ssh(), test_https_public_host_allowed() (+22 more)

### Community 376 - "test_brain_patch_service_token.py"
Cohesion: 0.16
Nodes (19): clean_store(), _clear_overrides(), _make_client_with_user(), fixture, tests/test_brain_patch_service_token.py — N5 acceptance: PATCH /admin/api/policy, N5 acceptance: no service token + no user session → 401 (not 200)., N5 regression: the existing dashboard path (no service token, non-admin     user, N5 regression: the existing admin dashboard path (no service token,     admin us (+11 more)

### Community 377 - "test_tasks_cache_ttl_env.py"
Cohesion: 0.21
Nodes (19): MonkeyPatch, Round-trip tests for TASKS_LIST_ALL_CACHE_TTL_SEC env-var override in tasks/api., With a lowered cap, a value above the new cap falls back to default., Reload tasks.api after injecting TASKS_LIST_ALL_CACHE_TTL_SEC=value (or unset)., Values above the 1h upper bound in _safe_ttl fall back to default.      Guards t, Value equal to the 1h upper bound is honored (boundary case)., ``TASKS_MAX_CACHE_TTL_SEC`` env var overrides the cap module-level constant., _reload_tasks_api_with_env() (+11 more)

### Community 378 - "TestUpdateTask"
Cohesion: 0.16
Nodes (7): _NoopCheckpointStore, WorkflowRun, tests/test_workflow_orchestrator_update_task.py Pytest coverage for ``services.w, Stand-in for the real Mongo checkpoint store., Two consecutive updates collapse: the latest instruction wins.         This matc, _run(), TestUpdateTask

### Community 379 - "MemoryKernel"
Cohesion: 0.11
Nodes (11): Any, agent/sam.py — SAM Voice Agent (System Autonomy Manager)  SAM is the voice-contr, Public snapshot of live agency state (used by the LiveKit worker tools)., Gather live agency state for SAM's situational awareness., Fact, get_memory_kernel(), MemoryKernel, voice/memory_kernel.py — Jarvis OS-inspired Memory Kernel.  Stores atomic facts (+3 more)

### Community 380 - "Skill: fabric-patterns"
Cohesion: 0.11
Nodes (18): 1. Ensure Pattern Directory Exists, 2. List Available Patterns, 3. Retrieve a Pattern, 4. Apply a Pattern with Variables, 5. Stitch Patterns Together, 6. Create New Patterns, Acceptance Checks, Directory Structure (+10 more)

### Community 381 - "Analysis & Synthesis Instructions"
Cohesion: 0.11
Nodes (18): 1. Define the Atmosphere, 2. Map the Color Palette, 3. Establish Typography Rules, 4. Define the Hero Section, 5. Describe Component Stylings, 6. Define Layout Principles, 7. Define Responsive Rules, 8. Encode Motion Philosophy (+10 more)

### Community 382 - "Production Readiness Assessment — local-llm-server"
Cohesion: 0.11
Nodes (18): 1. Availability & Reliability, 2. Observability, 3. Deployment Architecture, 4. Configuration & Secrets, 5. Recovery & Backup, 6. Cloudflare Worker Audit, Current State, Current State (+10 more)

### Community 383 - "Skill: fabric-patterns"
Cohesion: 0.11
Nodes (18): 1. Ensure Pattern Directory Exists, 2. List Available Patterns, 3. Retrieve a Pattern, 4. Apply a Pattern with Variables, 5. Stitch Patterns Together, 6. Create New Patterns, Acceptance Checks, Directory Structure (+10 more)

### Community 384 - "db/__init__.py"
Cohesion: 0.15
Nodes (7): _LazyModuleProxy, db — storage abstraction layer (V2.0 Phase 5: real code moved to packages/storag, Loads the real module on first attribute access, then replaces itself., # IMPORTANT: keep these imports LAZY (inside __getattr__) so that a Mongo-only, MongoStore, db/mongo_store.py — MongoDB store backed by Motor (existing implementation).  Th, Thin wrapper that exposes the Motor database as collection attributes.      Dele

### Community 385 - "Admin Dashboard Guide"
Cohesion: 0.11
Nodes (19): Accessing the Dashboard, Admin API (Programmatic Access), Admin Dashboard Guide, Dashboard — healthy state, Dashboard — key created (one-time token flash), Dashboard — Langfuse diagnostic, Dashboard Layout, Login page (+11 more)

### Community 386 - "Implementation Plan"
Cohesion: 0.11
Nodes (18): (1) & partly (4): "Something went wrong" masks the real error everywhere, (2) & (3): Company creation flow / non-admin gate placement, (4): Agent provisioning "loading forever" — blocking subprocess in async path, (5): Tailored questions are hardcoded today, A0. Fix live scanner crashes on real-world sites (`services/scanner.py`) — do first, A. Fix error-message masking (`frontend/src/api.js`), Agent Prompt (paste this to start the implementation session), B. Make runtime activation non-blocking (`runtimes/control.py`, (+10 more)

### Community 387 - "Feature Guide"
Cohesion: 0.11
Nodes (19): 10. Langfuse Observability, 11. Coding Agent API, 12. Browser Admin UI, 13. Telegram Remote Control Bot, 14. Tunnel — Permanent Static URL via ngrok, 15. CORS Support, 16. Streaming Support, 17. Workspace Isolation (+11 more)

### Community 388 - "TestRouterIntegration"
Cohesion: 0.15
Nodes (13): get_director(), Return the process-singleton TrafficDirector., Clear director state and the cached strategy warnings (tests only)., reset(), _clean_director(), anyio, fixture, Reset the process singleton around every test. (+5 more)

### Community 389 - "test_agent_readiness_audit.py"
Cohesion: 0.18
...
### Community 390 - "Delegation Plan (agent-ready work packages)"
Cohesion: 0.11
Nodes (18): Delegation Plan (agent-ready work packages), Findings, http://127.0.0.1:8899/, Page Details (worst first), Pillar Scores, `seo-fix-canonicals` - Fix Canonicals findings: 1 finding type(s) across 1 URL hit(s), `seo-fix-content` - Fix Content findings: 1 finding type(s) across 1 URL hit(s), `seo-fix-geo` - Fix GEO findings: 5 finding type(s) across 5 URL hit(s) (+10 more)

### Community 391 - "build_workflow.py"
Cohesion: 0.33
Nodes (18): _c(), _get(), _header(), main(), _make_headers(), _phase_icon(), _post(), _print_phases() (+10 more)

### Community 392 - "OnboardingService"
Cohesion: 0.06
Nodes (36): OnboardingService, Workflow, Detect the Git provider from a repository URL.                  Args:, Start the onboarding process for a company.                  Args:             c, Schedule a fire-and-forget background task, keeping a strong reference., Force-refresh the dynamic skill registry and log tech-stack recommendations., Activate a company's 24x7 agency runtimes in the background.          Runs after, Get the current onboarding progress for a company.                  Args: (+28 more)

### Community 393 - "test_company_api.py"
Cohesion: 0.11
Nodes (14): client(), fixture, Tests for Company Graph API endpoints., Create a test client for the FastAPI app., Test Company Graph API endpoints., Test that the company API router is included., Test Doctor endpoint., Test the public doctor endpoint. (+6 more)

### Community 395 - "test_fabric_patterns.py"
Cohesion: 0.11
Nodes (5): MonkeyPatch, Path, Tests for scripts/fabric_cli.py and the fabric-patterns pattern engine., test_new_scaffolds_pattern(), test_save_and_show_roundtrip()

### Community 396 - "RepowiseIntelligence"
Cohesion: 0.09
...
### Community 397 - "test_sam_voice.py"
Cohesion: 0.12
Nodes (18): asyncio, tests/test_sam_voice.py — Integration tests for SAM voice agent.  Tests the SAM, Same session_id must return the same session., _build_context must return a dict with expected keys., A hung LLM call must not block SAM — it must time out and fall back., A stalled context read must not block process_command indefinitely., Whitespace-only input must be treated as empty., Fallback must return operational status when LLM is down. (+10 more)

### Community 398 - "validate_session_id"
Cohesion: 0.16
...
### Community 399 - "ErrorInterceptorMiddleware"
Cohesion: 0.18
Nodes (11): _dispatch_async(), ErrorInterceptorMiddleware, Any, BaseHTTPMiddleware, Exception, Request, Response, agent/error_interceptor.py — HTTP Error Interceptor Middleware  FastAPI/Starle (+3 more)
...
### Community 401 - "Comprehensive Skill Index (By Category)"
Cohesion: 0.11
Nodes (17): 10. Domain (Modelling, Training, Infra), 1. Planning and Implementation, 2. Code Quality, Architecture, and Audits, 3. State Management and Git Flow, 4. Memory, Knowledge, and Context Tuning, 5. Research, Browsing, and External Intel, 6. Session Lifecycle and Workflow, 7. Style and Craft Polish (UI / Docs / Tone) (+9 more)

### Community 402 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 403 - "Component Map"
Cohesion: 0.11
Nodes (17): Architecture Audit — local-llm-server, Architecture Diagram, Component Map, Layer 10 — WebUI (`webui/`), Layer 11 — Infrastructure, Layer 1 — API Proxy (`proxy.py`, 1719 lines), Layer 2 — Chat Handlers (`chat_handlers.py`, 710 lines), Layer 3 — Model Router (`router/`) (+9 more)

### Community 404 - "test_background.py"
Cohesion: 0.15
Nodes (14): _now(), agent/background.py — Background Agent  An always-on worker thread that proces, Enqueue *task* for processing. Returns the task (with task_id set)., Convenience: create a task and submit it in one call., Tests for agent/background.py — Background Agent., _task(), test_as_dict(), test_create_and_submit() (+6 more)

### Community 405 - "Agent State — colibri GLM-5.2 deployment (resumable)"
Cohesion: 0.11
Nodes (17): Agent State — colibri GLM-5.2 deployment (resumable), Audit verification (2026-07-16, this session), Context / Task, Converged action sequence (after colibri binding is fixed, someday), Done this session (commit `b03a6ba`), Findings (verified empirically), Follow-up fix during commit amend: UTF-8 BOM on setup_autostart.ps1, Option A — Pivot to a feasible MLX model (HIGHEST ROI) (+9 more)

### Community 406 - "Architecture Overview — local-llm-server"
Cohesion: 0.11
Nodes (18): `admin_auth.py` + `admin_gui.py`, `agent/`, Architecture Overview — local-llm-server, `chat_handlers.py`, Deployment, Feature Maturity Tiers, `handlers/anthropic_compat.py`, High-Level Architecture (+10 more)

### Community 407 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
Nodes (17): Context: what already works (do NOT redo), Definition of done (per task), How to verify the whole thing end-to-end (local, no external infra), P0 — Make autonomy real in production, P1 — Close the remaining product gaps, P2 — ECC harness & polish, Pending Activities — Implementation Playbook, Task 10 — ECC cross-harness adapter (currently PLANNED only) (+9 more)

### Community 408 - "Platform Guide — the full tour"
Cohesion: 0.11
...
### Community 409 - "The rules"
Cohesion: 0.11
Nodes (17): Changing these rules, How the gate behaves, Quick-Note Context Rulebook, R10 — Use the repository's real identity **[gate]**, R11 — Name a real integration point **[gate]**, R12 — Mark epistemic status at the claim **[review]**, R1 — Ground the plan in the source before planning anything **[gate]**, R2 — Say what the artifact actually is **[gate]** (+9 more)

### Community 410 - "Part A — Health Report"
Cohesion: 0.11
Nodes (17): F1 — CLAUDE.md documents an architecture that no longer exists, F2 — 15 skills have no frontmatter description, F3 — Direct `os.environ` reads outside config modules, F4 — `print()` in importable production modules, F5 — graphify hook nags every session, F6 — God files, Healthy signals, P1 — Refresh CLAUDE.md and AGENTS.md to match the real architecture (+9 more)

### Community 411 - "apply_review.py"
Cohesion: 0.19
Nodes (10): ApplyReviewAgent, build_review_context(), _gh(), main(), _openai_tools_to_anthropic(), Convert OpenAI function-calling tool schemas to Anthropic tool schemas., Return (result_text, should_stop)., Run using NVIDIA NIM (OpenAI-compatible). Called as fallback. (+2 more)

### Community 412 - "test_feature_matrix.py"
Cohesion: 0.13
Nodes (4): tests/test_feature_matrix.py — Feature maturity / support matrix tests.  Covers:, Integration test: admin endpoint returns feature matrix JSON., TestAdminVisibility, TestSingleton

### Community 413 - "SQLiteStore"
Cohesion: 0.16
Nodes (10): Connection, Top-level store — exposes collections as attributes.      Usage::          store, Lazily build the pool of read-only connections (idempotent)., Yield a read connection from the pool (falls back to the writer).          On in, Create tables if they don't already exist., SQLiteStore, fixture, B608 guard: _Collection.__init__ must reject names outside _COLLECTIONS.      Pr (+2 more)

### Community 414 - "schedules/api.py"
Cohesion: 0.13
Nodes (22): create_schedule(), delete_schedule(), get_schedule(), get_schedule_runs(), list_schedules(), BaseModel, delete, get (+14 more)

### Community 415 - "agency_fix.py"
Cohesion: 0.20
Nodes (17): apply_edits(), build_prompt(), call_llm(), collect_context(), collect_source_files(), decline_cleanly(), extract_failing_tests(), _is_blocked() (+9 more)

### Community 416 - "sync_readme_gallery.py"
Cohesion: 0.22
Nodes (15): main(), _out_dir(), Path, Generate Web UI screenshots for README/docs.  Requires:   pip install playwright, build_gallery(), GallerySection, main(), Path (+7 more)

### Community 417 - "cooldown_get"
Cohesion: 0.27
Nodes (6): cooldown_get(), cooldown_set(), Put a key on cooldown for *ttl* seconds., Return True if *key* is still within its cooldown window., TestInMemoryCooldown, TestRedisCooldown

### Community 418 - "LocalLLMSetup"
Cohesion: 0.16
Nodes (7): LocalLLMSetup, Update .env file with configuration., Check if services are already running., Start the proxy server., Scan for local models., Scan the models folder for available models., Configure which models to use for agent roles.

### Community 419 - "test_task_brain_preflight.py"
Cohesion: 0.24
Nodes (15): fixture, svc(), _coordinator(), has_brain(), no_brain(), asyncio, BaseException, fixture (+7 more)

### Community 420 - "test_monitor_lib.py"
Cohesion: 0.11
Nodes (9): _isolate_env(), fixture, MonkeyPatch, tests/test_monitor_lib.py — unit tests for scripts/monitor_lib.py.  Covers the f, Pin all env-overridable paths to tmp_path for hermetic tests., TestAwaitReady, TestIsProcessAlive, TestSuperviseLoopGiveUp (+1 more)

### Community 421 - "test_openclaw_endpoints.py"
Cohesion: 0.11
Nodes (11): client(), fixture, tests/test_openclaw_endpoints.py — OpenClaw HTTP + WebSocket endpoint tests., After pairing, ping command returns pong., Unknown command returns error., WebSocket with wrong token is rejected (connection closed)., WebSocket with correct token pairs successfully., test_websocket_pairing_accepts_correct_token() (+3 more)

### Community 422 - "TestStopSlopChecker"
Cohesion: 0.11
Nodes (10): Should detect phrases case-insensitively, Should detect throat-clearing phrases, Should return no issues for clean text, Strict mode should detect passive voice, Should detect multiple types of tells in one text, Issues should have helpful suggestions, Should detect business jargon, Should remove throat-clearing phrases (+2 more)

### Community 423 - "test_task_service_failed_comment.py"
Cohesion: 0.18
Nodes (17): coordinator(), _make_result(), mock_store(), mock_workflow(), asyncio, fixture, tests/test_task_service_failed_comment.py — verify that a FAILED TaskResult stil, A FAILED TaskResult without agent_comment transitions to FAILED without crashing (+9 more)

### Community 424 - "handle_workflow_ide_chat"
Cohesion: 0.18
Nodes (17): _extract_last_user_message(), handle_workflow_ide_chat(), _json_response(), Any, JSONResponse, Request, StreamingResponse, workflow/ide_bridge.py — OpenAI-compatible SSE bridge for IDE clients.  This mod (+9 more)

### Community 425 - "get_tracker"
Cohesion: 0.19
...
### Community 426 - "SKILL: Industrial Brutalism & Tactical Telemetry UI"
Cohesion: 0.12
Nodes (16): 1. Skill Meta, 2.1 Swiss Industrial Print, 2.2 Tactical Telemetry & CRT Terminal, 2. Visual Archetypes, 3.1 Macro-Typography (Structural Headers), 3.2 Micro-Typography (Data & Telemetry), 3.3 Textural Contrast (Artistic Disruption), 3. Typographic Architecture (+8 more)

### Community 427 - "Skill: data-quality-audit"
Cohesion: 0.12
Nodes (16): 1. Token Length Distribution, 2. Deduplication Check, 3. Tokenizer Fertility Check, 4. Special Token Consistency, 5. Language Detection (if langdetect available), 6. Content Quality Signals, Background (Why This Matters), Checks Performed (+8 more)

### Community 428 - "What "Slop" Looks Like"
Cohesion: 0.12
Nodes (16): Acceptance Checks, Category 1 — Obvious Comments, Category 2 — Phantom Abstractions, Category 3 — Defensive Checks for Impossible Cases, Category 4 — Speculative Generality, Category 5 — Verbose Variable Names, Category 6 — Unasked-For Boilerplate, Instructions (+8 more)

### Community 429 - "test_admin_local_brain_router.py"
Cohesion: 0.18
Nodes (16): build_admin_local_brain_router(), Any, APIRouter, Construct a ready-to-mount APIRouter with the auth dependency baked in.      The, _require_admin(), _make_app(), FastAPI, tests/test_admin_local_brain_router.py — auth + toggle flow for /admin/api/local (+8 more)

### Community 430 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 431 - "Section-by-Section Acceptance Criteria"
Cohesion: 0.12
...
### Community 432 - "test_doctor_service_token_check.py"
Cohesion: 0.21
Nodes (13): _authed_client(), clean_store(), _clear(), fixture, tests/test_doctor_service_token_check.py — N5 follow-up: doctor check for SERVIC, Reset brain config store + SQLITE_DB_PATH + SERVICE_TOKEN., Build a TestClient authenticated as admin (for /api/doctor/diagnostics)., When SERVICE_TOKEN is not set, the doctor endpoint must surface a 'warn'     che (+5 more)

### Community 433 - "agent_readiness_audit.py"
Cohesion: 0.21
...
### Community 434 - "test_ci.sh"
Cohesion: 0.15
Nodes (16): ADMIN_EMAIL, ADMIN_PASSWORD, API_KEYS, cleanup(), DB_NAME, fail(), LANGFUSE_HOST, LANGFUSE_PUBLIC_KEY (+8 more)

### Community 435 - "test_telegram_auto_approve.py"
Cohesion: 0.20
Nodes (16): is_sensitive(), True when *text* references a sensitive target (auth/keys/secrets/service     ma, _build_execution_request(), Any, Build a minimal ``ExecutionRequest`` for plain-text → orchestrator.execute., admin_user(), _auto_approve(), non_admin_user() (+8 more)

### Community 436 - "test_scanner_security.py"
Cohesion: 0.15
Nodes (18): _is_safe_url(), Block SSRF: reject loopback, link-local, private, and non-HTTP schemes., asyncio, Offline regression tests for the website scanner security fixes.  Covers: - SSRF, Guard against the signature DB regressing to a tiny hand-rolled stub., Curated signatures missing/pattern-less upstream must still be detected., A realistic Cloudflare-fronted page should yield a broad, correct stack., When both curl_cffi and the httpx fallback raise, the scan must report     failu (+10 more)

### Community 437 - "_resolve_push_token"
Cohesion: 0.27
Nodes (10): GitHub token used to push branches / open PRs during EXECUTION (#506).      Prec, _resolve_push_token(), _clean_env(), fixture, tests/test_orchestrator_push_token.py — #506 push/PR token resolution.  workflow, test_falls_through_gh_pat_and_github_token(), test_internal_run_uses_server_token(), test_per_user_token_always_wins() (+2 more)

### Community 438 - "test_activation_api.py"
Cohesion: 0.21
...
### Community 439 - "test_autonomy_status.py"
Cohesion: 0.12
...
### Community 440 - "test_brain_failover_413.py"
Cohesion: 0.13
Nodes (9): _clean_env(), _FakeAsyncClient, _FakeResponse, fixture, Regression test: HTTP 413 (Payload Too Large) must fail over to the next PROVIDE, Returns 413 for every call to a Groq URL, success for anything else., Groq (will 413) + Cerebras (will succeed) both configured, NVIDIA     deliberate, test_413_fails_over_to_next_provider_after_one_attempt() (+1 more)

### Community 441 - "test_health_endpoints.py"
Cohesion: 0.17
...
### Community 442 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 443 - "test_local_brain_state.py"
Cohesion: 0.12
...
Cohesion: 0.06
Nodes (29): Request, FastAPI dependency: require any authenticated user., require_authenticated(), client(), _coding_brain_check(), fixture, tests/test_doctor_coding_brain.py  Surfaces the North Mini Code coding-brain sta, With NORTH_MINI_CODE_DEFAULT off, the check warns and says so. (+21 more)

### Community 446 - "TestRoutes"
Cohesion: 0.19
Nodes (7): _install_service(), Tests for agents/portfolio_api.py — the v5 portfolio board API.  Loads the modul, A materializer exception must not break /refresh (the board still         return, Install a PortfolioService whose portfolio is fixed (no rebuild)., _seeded_manager(), TestBoardPayload, TestRoutes
...
### Community 448 - "hermes_prompt.py"
Cohesion: 0.19
Nodes (15): build_chatml_system_prompt(), format_chatml_message(), format_tool_call(), format_tool_response(), messages_to_chatml(), model_supports_chatml(), parse_tool_call_from_chatml(), Any (+7 more)

### Community 449 - "MemoryMiddleware"
Cohesion: 0.17
Nodes (10): create_memory_middleware(), MemoryMiddleware, Any, Process incoming chat request and inject memories., Extract and save learnings from model responses., Factory function to create memory middleware instance., Middleware for automatic memory loading and injection., Detect AI coding tool from request headers. (+2 more)

### Community 450 - "AITellIssue"
Cohesion: 0.17
Nodes (8): AITellIssue, Find all AI tells in text, Find throat-clearing phrases, Find emphasis crutches (weak adverbs), Find meta-commentary (text referring to itself), Find Wh-sentence starters (weak prose starters), Find basic passive voice patterns (strict mode only), Format issues as human-readable report

### Community 451 - "Skill: repowise-intelligence"
Cohesion: 0.12
Nodes (15): 1. Graph Intelligence (Dependency Graph), 2. Git Intelligence, 3. Documentation Intelligence, 4. Decision Intelligence, Acceptance Checks, Directory Structure, Example Usage, Implementation Approach (+7 more)

### Community 452 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
Nodes (15): 1. Target Repository Structure, 2. Dependency Rules, 3. Provider Architecture (Target), 4. Configuration Architecture (Target), 5. Event Bus Architecture (Target), 6. Scheduler Architecture (Target), 7. Dashboard Architecture (Target), 8. Migration Principles (+7 more)

### Community 453 - "admin_digest_router.py"
Cohesion: 0.20
Nodes (15): _build_payload_or_500(), _check_secret(), _expected_secret(), preview_digest_endpoint(), Any, get, post, Dry-run: same auth, returns the would-be markdown body but does NOT     dispatch (+7 more)

### Community 454 - "_valid_login_state"
Cohesion: 0.24
Nodes (15): Return True if a fetched oauth_states doc is a valid, unexpired login state., _valid_login_state(), _doc(), Regression tests for social-login (GitHub & Google) OAuth state handling.  Bug #, MongoDB/motor returns naive UTC datetimes. Subtracting a naive datetime     from, The login handlers must persist state via _store_login_state, not the     sessio, test_expired_state_rejected(), test_just_within_window_accepted() (+7 more)

### Community 455 - "Skill: repowise-intelligence"
Cohesion: 0.12
Nodes (15): 1. Graph Intelligence (Dependency Graph), 2. Git Intelligence, 3. Documentation Intelligence, 4. Decision Intelligence, Acceptance Checks, Directory Structure, Example Usage, Implementation Approach (+7 more)

### Community 456 - "The 10-Step Workflow"
Cohesion: 0.12
Nodes (15): Cross-Tool Compatibility, Quick Reference Card, Skill: session-planning — Mandatory Planning Workflow for All AI Agents, Step 10 — Close Out, Step 1 — Orient (free), Step 2 — Understand the Task, Step 3 — Load Relevant Skills, Step 4 — Research (if novel task) (+7 more)

### Community 457 - "Contributing to local-llm-server"
Cohesion: 0.12
Nodes (16): Architecture, Bug Reports, Changelog, Coding Standards, Commit Message Convention, Contributing to local-llm-server, Development Setup, Feature Requests (+8 more)

### Community 458 - "CEO Micro-Management"
Cohesion: 0.12
Nodes (16): A failed drive does not abandon the goal, CEO Micro-Management, Configuration reference, Escalation, and why it terminates, Five bounds, Operator surface, Tests, The 24x7 supervisor (+8 more)

### Community 459 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
Nodes (15): 467 Brutal Audit — File-by-File Status, Agent System, Backend & Services, Core Proxy & Routing, Direct Chat, Feature Matrix (spec §I — demotions needed), Frontend / Public Site (spec §H — 0% delivered), GitHub Workflows (+7 more)

### Community 460 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
Nodes (15): B.1 — Open the service's Environment tab, B.2 — Set these five keys on each service, B.3 — Sanity-check the secrets that must NOT regress, B.4 — Trigger TASK 5 keep-alive immediately, Option A — Blueprint sync (preferred), Option B — manual per-service editor, Rollback, Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2) (+7 more)

### Community 461 - "implement_agent.py"
Cohesion: 0.16
Nodes (12): main(), _openai_tools_to_anthropic(), Safely insert an entry under ## [Unreleased] without touching the rest of the fi, Convert OpenAI function-calling tool schemas to Anthropic tool schemas., Run the implementation agent loop using Claude Opus via Anthropic SDK.      Retu, _read_claude_md(), _run_anthropic_agent_loop(), _run_baseline_pytest() (+4 more)

### Community 463 - "ai/registry.py"
Cohesion: 0.21
...
### Community 464 - "_P"
Cohesion: 0.17
Nodes (9): _ids(), _P, Tests for packages/ai/traffic_director.py — traffic distribution across provider, A provider with no latency sample must be able to earn one., The safety invariant: a shuffle may not promote a paid provider         ahead of, With every provider idle a stable sort would send the whole burst to         the, No explicit weights: the provider that has spent less of its minute         shou, Minimal provider stand-in — the director only needs ``provider_id``. (+1 more)

### Community 465 - "fabric_cli.py"
Cohesion: 0.29
Nodes (15): cmd_apply(), cmd_list(), cmd_new(), cmd_save(), cmd_show(), cmd_stitch(), _ensure_patterns_dir(), main() (+7 more)

### Community 466 - "sync_ngrok.py"
Cohesion: 0.26
Nodes (14): detect_ngrok_url(), dim(), fail(), header(), info(), main(), ok(), patch_platform_brain_via_switch_brain() (+6 more)

### Community 467 - "._resolve_path"
Cohesion: 0.18
Nodes (4): Path, Return the first *lines* lines of a file.          Just-in-time retrieval: the e, Return a lightweight index of files with line counts and sizes.          This is, Resolve filepath relative to workspace_root, rejecting traversal attempts.

### Community 468 - "ManagedAgentDreams"
Cohesion: 0.22
Nodes (4): ManagedAgentDreams, Manages recording session memories and consolidating them into dreams., Tests for ManagedAgentDreams., TestManagedAgentDreams

### Community 469 - "SyntheticDataPipeline"
Cohesion: 0.08
Nodes (17): Any, Add a step result. Returns the sample if accepted, None if filtered out., Bulk-add samples from an agent session's step results.          Each step result, Return samples filtered by minimum reward score., Export samples in Alpaca JSONL format.          Returns the path to the exported, Export samples in ShareGPT JSONL format.          Returns the path to the export, Export all samples as a structured JSON array.          Returns the path to the, Return pipeline statistics. (+9 more)

### Community 470 - "_process_task_callback"
Cohesion: 0.34
Nodes (13): _process_task_callback(), Handle Approve/Reject inline-button presses for task execution gates.      Callb, _make_fake_task(), _patch_workflow(), Robustness tests for the Telegram inline-button callback flow., test_approve_success_clears_spinner_and_edits_message(), test_reject_success_clears_spinner_and_edits_message(), test_storage_init_failure_clears_spinner() (+5 more)

### Community 471 - "e2e/test_browser.py"
Cohesion: 0.21
Nodes (15): base_url(), do_login(), fail(), ok(), fixture, Page, Navigate to a page and verify it loads without errors., Verify server responds to health check before running browser tests. (+7 more)

### Community 472 - "asyncio"
Cohesion: 0.14
Nodes (7): requires_db, asyncio, Test that storage service can be initialized., Test company CRUD operations - skipped as requires specific config., Test that specialist service can be initialized., Test that onboarding service can be initialized., End-to-end against the real Mongo (CI service): the exact handler         seque

### Community 473 - "test_frontend_deployment_guards.py"
Cohesion: 0.20
Nodes (15): Step 3 runtime config must render checkboxes for each runtime., index.css must override appearance:none for checkboxes/radios., The checkbox appearance override must NOT set appearance:none (that would keep t, The checkbox appearance override must use 'auto' to request native rendering., SetupWizardPage must render <input type='checkbox'> for each provider toggle., _read(), test_api_redirects_respect_public_and_backend_paths(), test_index_css_checkbox_override_is_not_none() (+7 more)

### Community 474 - "test_glm52_brain.py"
Cohesion: 0.12
...
### Community 475 - "NotificationDispatcher"
Cohesion: 0.04
...
### Community 477 - "analyze_quantitative"
Cohesion: 0.13
...
### Community 481 - "Skill: agent-harness"
Cohesion: 0.13
Nodes (14): Architecture, Combining with Other Skills, Key Concepts, Output Format, Purpose, Safety Rules, Skill: agent-harness, Step 1 — Define the task clearly (+6 more)

### Community 482 - "Skill: checkpoint-strategy"
Cohesion: 0.13
Nodes (14): After a Loss Spike, Aggressive (Long Runs with Stable Training), Background, Checkpoint Policy Templates, Conservative (Recommended for First Runs), Integration Points, Output Format, Purpose (+6 more)

### Community 483 - "Process"
Cohesion: 0.13
Nodes (14): Anti-Patterns, Process, Purpose, Rules, Skill: debug-tracer, Step 1: Reproduce First, Step 2: Gather Evidence, Step 3: Form Hypotheses (+6 more)

### Community 484 - "Skill: local-ai-query"
Cohesion: 0.13
Nodes (14): 1. Verify Ollama is available, 2. Choose appropriate model, 3. Send query to local model, 4. Generate embeddings (for RAG), 5. List running models, Integration with ChromaDB (RAG), Limitations, Prerequisites (+6 more)

### Community 485 - "Skill: parallel-agents"
Cohesion: 0.13
Nodes (14): Combining with Other Skills, Core Concepts (from the Modal/OpenAI Agents SDK pattern), Example — parallel approach exploration, Example — parallel research, Output Format, Phase 1 — Decompose, Phase 2 — Dispatch (simulate parallelism), Phase 3 — Aggregate (+6 more)

### Community 486 - "Skill: parallel-worktrees"
Cohesion: 0.13
Nodes (14): Acceptance Checks, Common Patterns, Concept, Constraints, Instructions, Pattern A — Test main while you implement, Pattern B — Review reference during refactor, Pattern C — Hotfix without disturbing feature work (+6 more)

### Community 487 - "Design System: Taste Standard"
Cohesion: 0.13
Nodes (14): 1. Visual Theme & Atmosphere, 2. Color Palette & Roles, 3. Typography Rules, 4. Component Stylings, 5. Hero Section, 6. Layout Principles, 7. Responsive Rules, 8. Motion & Interaction (Code-Phase Intent) (+6 more)
...
### Community 489 - ".get_state"
Cohesion: 0.22
Nodes (9): _now_iso(), Any, Connection, Return the desired + last-reported state for the admin UI., Operator flips the toggle. Persists + clears any prior lease.          Returns t, Local daemon POSTs its heartbeat.          If the operator's desired_state=on AN, `now_iso`: ISO-8601 string marking the reader's "now" — pass it in to stay, Reviewer fix #f: lease must strip after heartbeats stop arriving.      Simulates (+1 more)

### Community 490 - "Skill: user-research"
Cohesion: 0.13
Nodes (14): Architecture, As a Python library, As an agent tool, Auto-Registration, Files, Purpose, Pydantic Models (extra="forbid"), Sample-Size Math (+6 more)

### Community 491 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
Nodes (14): Agency Core — Progress & Resume Log, Audit (committed), Environment constraints discovered this session, How to resume (read before doing anything), Key findings (so we don't re-investigate), Open risks / must-know before merging, Phase 0 — Stabilize & quarantine (commit `713184a`, pushed), Planned CI-parity hardening (the immediate next commit) (+6 more)

### Community 492 - "Attention Mechanisms Internals"
Cohesion: 0.13
Nodes (14): Attention Complexity, Attention Mechanisms Internals, Causal Masking, Flash Attention, Grouped Query Attention (GQA), Multi-Head Attention (MHA), Multi-Query Attention (MQA), Parameter count for MHA: (+6 more)

### Community 493 - "model_discovery.py"
Cohesion: 0.11
Nodes (21): cached_models(), discover_models(), _fresh_entry(), _models_url(), _parse_ids(), Any, Ask a provider which models the configured API key may actually use.  ``config/m, Return the cached list for *provider_id* without any network call.      The disp (+13 more)

### Community 494 - "_push_down_where"
Cohesion: 0.14
...
### Community 498 - "TestDecisionsBotLinks"
Cohesion: 0.21
...
### Community 501 - "clear_wizard_state_cache"
Cohesion: 0.21
Nodes (10): clear_wizard_state_cache(), Override the persistence collection used for wizard state.      Tests and hosted, Clear the in-memory wizard-state cache., set_wizard_state_collection(), _FakeWizardCollection, SimpleNamespace, TestClient, _setup_client() (+2 more)

### Community 502 - "._sprint"
Cohesion: 0.19
...
### Community 503 - "TestModelRegistryUpdates"
Cohesion: 0.14
...
### Community 505 - "test_openclaw_gateway.py"
Cohesion: 0.13
...
### Community 506 - "test_scanner_live.py"
Cohesion: 0.23
Nodes (14): _assert_scan_contract(), asyncio, parametrize, LIVE integration tests for the website scanner — these actually hit the real int, Representative large storefronts that commonly sit behind bot protection.     Sa, Directly exercise the BuiltWith fallback against the live builtwith.com.     bui, The invariants that must hold for any live scan, bot-protected or not., A normal, non-bot-protected site must yield real detections. This is the     pos (+6 more)

### Community 507 - "test_langfuse_agency_wide.py"
Cohesion: 0.12
Nodes (15): tests/test_langfuse_agency_wide.py — tests for PR #961 agency-wide Langfuse.  Ve, langfuse_obs.py must define emit_agency_observation., emit_agency_observation must be a no-op when Langfuse is not configured., tasks/service.py must call emit_agency_observation for task execution., agent/agency.py must call emit_agency_observation for CEO directives., backend/server.py scheduler_tick must call emit_agency_observation., packages/ai/self_heal.py must call emit_agency_observation., emit_agency_observation must accept all documented parameters. (+7 more)

### Community 508 - "WorkflowTransition"
Cohesion: 0.20
Nodes (9): _append_transition(), BaseModel, Advance task through the full phase sequence.          Resumes from ``task.wor, Execute a single phase and advance to the next., Add a workflow transition to the task's history list., WorkflowTransition, test_task_workflow_history_append(), test_workflow_transition_defaults() (+1 more)

### Community 509 - "StopSlopChecker"
Cohesion: 0.14
...
### Community 510 - "Process"
Cohesion: 0.14
Nodes (13): 1. Read and Understand the Issue, 2. Explore the Codebase, 3. Plan the Solution, 4. Implement, 5. Test, 6. Document, 7. Commit and Push, Notes (+5 more)

### Community 511 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
Nodes (13): Background (Why This Matters), Common Mistakes, Cosine with Warmup (Recommended for Pretraining), Fine-tuning vs Pretraining, Integration Points, Output Format, Peak LR Heuristics by Model Size, Purpose (+5 more)

### Community 511 - "Instructions"
Cohesion: 0.14
Nodes (13): 1 — Tests green, 2 — Changelog updated, 3 — Determine the version bump, 4 — Update changelog, 5 — Commit the changelog update, 6 — Tag the release, 7 — Verify CI on the tag, 8 — Post-release (+5 more)
...
### Community 513 - "Quick-Note Issues Processing Summary"
Cohesion: 0.14
...
### Community 514 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 516 - "Runbook: Auto-Resume After Cooldown / Interruption"
Cohesion: 0.14
...
### Community 517 - "SEO / GEO / AIO Audit Engine"
Cohesion: 0.14
...
### Community 521 - "rate_limiter.py"
Cohesion: 0.14
Nodes (11): get_tracker(), _ProviderQuota, Response, Proactive rate-limit throttling for LLM providers — two complementary layers.  *, Parse x-ratelimit-* headers and update per-provider quota state.          Safe t, Reset all state (primarily for tests)., Return the process-singleton RateLimitTracker., Clear all token-bucket state (tests only). Does not touch the header     tracker (+3 more)

### Community 522 - "RateLimitTracker"
Cohesion: 0.19
...
### Community 523 - "ai/registry.py"
Cohesion: 0.21
Nodes (13): all_models(), best_model_for(), ModelInfo, models_by_provider(), packages/ai/registry.py — Model Registry.  Centralized registry of all models ac, Register the default free-tier models., Information about a specific model., Register a model in the registry. (+5 more)

### Community 524 - "_RedisBackend"
Cohesion: 0.22
...
### Community 526 - "test_critical_flows.py"
Cohesion: 0.29
...
### Community 527 - "test_regression.py"
Cohesion: 0.14
...
### Community 528 - "TestDisabledReasonRendering"
Cohesion: 0.14
Nodes (12): browser_login(), main(), fixture, Full desktop regression suite., Full mobile regression suite (navigation + key page loads)., Log in through the browser UI. Returns True on success., Activation: status, users., regression_base_url() (+4 more)

### Community 529 - "test_task_clarification.py"
Cohesion: 0.15
...
### Community 530 - "_make_task"
Cohesion: 0.19
Nodes (14): _make_task(), asyncio, Task, TaskStatus, A TODO task with pending_agent_run=False must be re-queued by the reconciler., A TODO task with pending_agent_run=True does NOT need reconciliation., A DONE task is never touched by the reconciler regardless of pending flag., A TODO task currently in the active set must not be re-queued. (+6 more)

### Community 531 - "test_telegram_task_callback.py"
Cohesion: 0.20
Nodes (10): _parked_task(), asyncio, fixture, Task, Telegram inline-button callbacks for the task pre-execution gate.  Regression: `, _Recorder, store(), test_approve_button_approves_and_requeues() (+2 more)

### Community 532 - "validate_job_id"
Cohesion: 0.17
Nodes (4): parametrize, TestPathTraversalPrevention, Validate and return a job ID, or raise InvalidJobIdError., validate_job_id()

### Community 533 - "_TFIDFIndex"
Cohesion: 0.18
...
### Community 537 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 540 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 541 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 544 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
...
### Community 545 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 546 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 548 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 549 - "admin_update_task_router.py"
Cohesion: 0.22
...
### Community 552 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
Nodes (12): Acceptance Checks, Claude's query protocol (use this instead of Read tool for exploration):, Graph Artifacts — What to Commit, How to Use the Graph (Token Savings Protocol), Installation (one-time per machine), Instead of reading raw files:, Key commands:, Relationship to repowise-intelligence Skill (+4 more)

### Community 553 - "Skill: platform-setup — Autonomous Agency Bootstrap"
Cohesion: 0.15
...
### Community 554 - "Workspace Isolation Architecture"
Cohesion: 0.15
...
### Community 555 - "Device compatibility and model picks"
Cohesion: 0.15
...
### Community 556 - "Autonomy Uplift — Living Roadmap & Detailed Implementation Specs"
Cohesion: 0.15
...
### Community 557 - "OpenClaw — iOS Control of the Agency (Single-Service Free-Tier Deploy)"
Cohesion: 0.15
...
### Community 561 - "Agent Transparency Report"
Cohesion: 0.15
...
### Community 563 - "update_provider_policy"
Cohesion: 0.19
Nodes (12): _get_provider_policy(), ProviderPolicyUpdate, BaseModel, get, put, Read the durable provider policy, falling back to a safe default.      Returns a, Persist the provider policy and return the new state., Return the durable provider policy (single source of truth for paid-provider gat (+4 more)

### Community 564 - ".publish"
Cohesion: 0.17
...
### Community 565 - "_InMemoryBackend"
Cohesion: 0.18
...
### Community 566 - "test_agile_api.py"
Cohesion: 0.15
...
### Community 567 - "test_app_settings.py"
Cohesion: 0.19
Nodes (11): asyncio, fixture, Tests for app_settings — DB-persisted settings + onboarding-gate default.  These, Point db.get_store() at an isolated temp SQLite DB., is_user_onboarding_allowed falls back to the global default for users     with n, sqlite_store(), test_defaults_when_unset(), test_gate_default_controls_unlisted_user() (+3 more)

### Community 568 - "TestModelCostTableUpdates"
Cohesion: 0.26
...
### Community 569 - "TestMCPClientStructuredOutput"
Cohesion: 0.31
...
### Community 570 - "TestDecisionsBotLinks"
Cohesion: 0.21
Nodes (4): tests/test_decisions_bot_links.py Pytest coverage for the new ``bot_message_link, Decision prompts that exist *before* the orchestrator creates a run         (e.g, Re-sending the same Telegram message (offset rewind, bot restart         re-deli, TestDecisionsBotLinks

### Community 571 - "TestRuntimeControl"
Cohesion: 0.15
...
### Community 572 - "TestKillSwitchDurability"
Cohesion: 0.15
...
### Community 574 - "skill_registry.py"
Cohesion: 0.17
...
### Community 580 - "Skill: system-prompt-audit"
Cohesion: 0.17
...
### Community 581 - "Skill: task-alive-updates"
Cohesion: 0.17
...
### Community 584 - "LocalBrainStore"
Cohesion: 0.21
Nodes (8): BaseModel, backend/admin_local_brain_router.py — admin-session proxy for the local-brain to, _store(), ToggleBody, LocalBrainStore, backend/local_brain_store.py — DB-persisted state for the local GLM 5.2 brain., SQLite-backed store for the local GLM brain toggle + heartbeat., Same mirror file brain_config already uses. One file, fewer surprises.

### Community 585 - "_is_admin"
Cohesion: 0.18
Nodes (11): backend/ceo_router.py — observability and manual control for the CEO.  Surfaces, Reject non-admin callers for routes that spend provider budget.      Delegates t, _require_admin(), _is_admin(), Check if a user has admin role.      Works for both social_auth users (role in S, Fetch a run, enforcing per-user ownership (admins bypass).      Returns 404 — no, Approve a run paused at the ApprovalGate and resume execution., Get a single workflow orchestrator run by ID (owner or admin only). (+3 more)

### Community 586 - "_ensure_tasks_source_id_unique_index"
Cohesion: 0.26
Nodes (11): _ensure_tasks_source_id_unique_index(), Add a unique+sparse index on tasks.source_id — isolated from the     main bootst, asyncio, tests/test_bootstrap_source_id_index.py — _ensure_tasks_source_id_unique_index., A unique-index build against a collection with pre-existing     duplicate source, The proactive dedup pass must run before the index-build attempt,     so a first, If the proactive dedup pass itself fails (e.g. store not wired up     yet), the, test_dedup_failure_does_not_block_index_attempt() (+3 more)

### Community 592 - "synthesize"
Cohesion: 0.36
...
### Community 588 - "14. Standing Instructions — Universal Agent Discipline"
Cohesion: 0.17
...
### Community 589 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 590 - "Instructions"
Cohesion: 0.17
Nodes (11): Acceptance Checks, Idempotency Rules, Instructions, Skill: cooldown-resume, Step 1 — Read the checkpoint files, Step 2 — Assess the state, Step 3 — Verify changed files are correct, Step 4 — Run tests to confirm baseline (+3 more)

### Community 591 - "Instructions"
Cohesion: 0.17
Nodes (11): Acceptance Checks, Current Dependencies (quick reference), Instructions, Skill: dependency-audit, Step 1 — Evaluate the new dependency, Step 2 — Pin appropriately, Step 3 — Install and verify, Step 4 — Check for conflicts (+3 more)

### Community 592 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 594 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 595 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 596 - "Quantization Internals"
Cohesion: 0.17
...
### Community 597 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 598 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 599 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 600 - "TestRequireAdmin"
Cohesion: 0.29
Nodes (3): Return a FastAPI dependency that checks for a specific permission., require_permission(), TestRequireAdmin

### Community 601 - "test_p0_roadmap_a4_a5_b2.py"
Cohesion: 0.26
Nodes (6): get_steering_injector(), Return recommended steering labels for a given task category.      Used by the m, Return the module-level SteeringInjector singleton., steering_for_task(), TestSteeringForTask, TestSteeringSingleton

### Community 602 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 603 - "TestAuthAndTaskCreation"
Cohesion: 0.17
...
### Community 604 - "test_providers_live_e2e.py"
Cohesion: 0.27
...
### Community 605 - "test_skill_registry.py"
Cohesion: 0.20
...
### Community 612 - "_extractive_compress"
Cohesion: 0.18
...
### Community 609 - "RepowiseIntelligence"
Cohesion: 0.33
...
### Community 612 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 615 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 616 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 621 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 624 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 625 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 626 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 627 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 628 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 629 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 630 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 631 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 633 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 634 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 635 - "CI Troubleshooting Runbook"
Cohesion: 0.18
...
### Community 636 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 637 - "What to clean up"
Cohesion: 0.18
...
### Community 638 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 637 - "test_bedrock_live.py"
Cohesion: 0.25
...
### Community 638 - "provider_max_rpm"
Cohesion: 0.29
...
### Community 641 - "_resolve_push_token"
Cohesion: 0.27
Nodes (10): GitHub token used to push branches / open PRs during EXECUTION (#506).      Prec, _resolve_push_token(), _clean_env(), fixture, tests/test_orchestrator_push_token.py — #506 push/PR token resolution.  workflow, test_falls_through_gh_pat_and_github_token(), test_internal_run_uses_server_token(), test_per_user_token_always_wins() (+2 more)

### Community 642 - "setup_ngrok.py"
Cohesion: 0.31
...
### Community 643 - "test_agent_readiness_audit.py"
Cohesion: 0.18
Nodes (6): Tests for scripts/agent_readiness_audit.py — the 8-pillar readiness scorer., This repo ships pre-commit config, tests, docs, and the intake/retro     loops a, test_main_check_flag_fails_below_threshold(), test_repo_scores_reasonably_high(), test_score_documentation_all_missing_scores_zero(), test_score_testing_flags_missing_empirical_verify()

### Community 644 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 645 - "test_event_log.py"
Cohesion: 0.45
...
### Community 646 - "test_tasks_awaiting_approval_api.py"
Cohesion: 0.40
Nodes (10): _client(), asyncio, Task, TestClient, GET /api/tasks/awaiting-approval — dashboard surface for the pre-execution gate., _seed(), test_admin_sees_system_owned_gated_tasks(), test_approving_removes_task_from_awaiting_list() (+2 more)
...
### Community 648 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 649 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 650 - "TestNormalizeToolChoice"
Cohesion: 0.31
...
### Community 651 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 652 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 653 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 654 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 655 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 656 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 657 - "Agent Readiness Report"
Cohesion: 0.20
...
### Community 659 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 662 - "_parse_reset_epoch"
Cohesion: 0.33
...
### Community 663 - "build_tech_db.py"
Cohesion: 0.40
...
### Community 666 - "TestExtendedThinkingRouting"
Cohesion: 0.20
...
### Community 667 - "test_dockerfile_ships_root_modules.py"
Cohesion: 0.31
...
### Community 668 - "TestZeroAttemptDiagnostics"
Cohesion: 0.29
...
### Community 669 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 670 - "test_quick_note_engine.py"
Cohesion: 0.22
...
### Community 671 - "test_task_dispatcher.py"
Cohesion: 0.31
Nodes (5): _BlockingCoordinator, _PendingStore, asyncio, Task, test_dispatcher_executes_pending_tasks_concurrently()

### Community 673 - "WorkspaceMetrics"
Cohesion: 0.20
...
### Community 675 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 677 - "Skill: changelog-enforcer"
Cohesion: 0.22
...
### Community 678 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 680 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 681 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 682 - "Skill: changelog-enforcer"
Cohesion: 0.22
Nodes (8): Acceptance Checks, Changelog Location, Entry Format, Examples, Hook Behaviour, Instructions, Skill: changelog-enforcer, When to Use

### Community 683 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
Nodes (8): Branch, Components, Purpose, Quick Start, Session Roles, Skill: cowork-session (Claude Cowork), Testing, When to Use

### Community 684 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 685 - "Agent Autonomy Roadmap"
Cohesion: 0.22
...
### Community 686 - "Main proxy (`proxy.py`)"
Cohesion: 0.22
...
### Community 687 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 688 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 689 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 690 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 691 - "Release Procedure"
Cohesion: 0.22
...
### Community 692 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 694 - "frontend/package.json"
Cohesion: 0.22
Nodes (8): jest, moduleNameMapper, ^react-router$, ^react-router-dom$, name, private, proxy, version

### Community 695 - "AgentStatusPanel.tsx"
Cohesion: 0.25
Nodes (7): AgentStatus, AgentStatusPanelProps, AgentCard(), formatRelative(), ROLE_ICONS, STATUS_DOTS, STATUS_STYLES

### Community 696 - "AgentStatusPanel.jsx"
Cohesion: 0.25
Nodes (6): AgentCard(), formatRelative(), ROLE_ICONS, STATUS_DOTS, STATUS_STYLES, PHASE_LABELS

### Community 697 - "ToolCallViewer.tsx"
Cohesion: 0.25
Nodes (7): ToolCall, ToolCallViewerProps, getToolIcon(), STATUS_BADGES, STATUS_STYLES, TOOL_ICONS, ToolCallRow()

### Community 698 - "SkillsScreen.jsx"
Cohesion: 0.22
Nodes (5): CATEGORY_COLORS, COMMERCE_SKILLS, effortColor, effortLabel, WORKFLOW_STEPS

### Community 700 - "enrich_quick_note_issues.py"
Cohesion: 0.42
Nodes (8): _dispatch_generation(), _fetch_open_issues(), _has_context(), _headers(), _is_quick_note(), main(), Ask the bulk context workflow to generate documents for these issues., True when a context branch already exists for this issue.      Checked against b

### Community 701 - "_status_snapshot"
Cohesion: 0.31
...
### Community 703 - "test_shared_state.py"
Cohesion: 0.31
Nodes (8): Reset the singleton (for tests)., _reset_backend(), fixture, Tests for the shared-state abstraction (in-memory and Redis/fakeredis backends)., Configure the shared_state module to use fakeredis for the test., Reset the shared-state singleton before every test., _redis_backend(), _reset_state()

### Community 704 - "e2e/conftest.py"
Cohesion: 0.28
Nodes (8): base_url(), mobile_page(), proxy_url(), Config, fixture, pytest_configure(), conftest.py — pytest fixtures and configuration for the E2E test suite.  Registe, A browser page pre-configured for mobile viewport (390×844 — iPhone 14).

### Community 705 - "admin_jwt"
Cohesion: 0.25
...
### Community 706 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 707 - "test_changelog_parity_guard.py"
Cohesion: 0.22
...
### Community 710 - "TestChatFallbackAndApproval"
Cohesion: 0.22
...
### Community 713 - "TestGithubSignalHardening"
Cohesion: 0.22
...
### Community 714 - "TestPaidPolicyDurability"
Cohesion: 0.22
...
### Community 715 - "test_runtimes_health_endpoint.py"
Cohesion: 0.22
...
### Community 716 - "test_scanner_deps_parity.py"
Cohesion: 0.31
...
### Community 717 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.22
Nodes (8): fresh_store_module(), fixture, Regression: prevent silent TaskStore in-memory fallback in production.  The 'pha, Force a fresh import of tasks.store so module-level state is clean., With TESTING unset (production), TaskStore(db=None) MUST raise., With TESTING=true (CI), TaskStore(db=None) MUST allow in-memory fallback., test_task_store_allows_inmemory_when_testing(), test_task_store_raises_in_production()

### Community 718 - "stt.py"
Cohesion: 0.36
...
### Community 719 - "navigation_metrics.py"
Cohesion: 0.32
...
### Community 721 - "._run_git_command"
Cohesion: 0.25
...
### Community 724 - "quality_checker.py"
Cohesion: 0.32
...
### Community 726 - "_build_direct_chat_schedule_suggestion"
Cohesion: 0.32
...
### Community 727 - "TestParseToolCalls"
Cohesion: 0.39
...
### Community 738 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 739 - "ceo-micromanagement.md"
Cohesion: 0.25
Nodes (4): P0 behavior change, Readiness contract, Runtime model, Runtime types

### Community 740 - "Feature Maturity / Support Matrix"
Cohesion: 0.25
...
### Community 743 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.25
...
### Community 744 - "Issue #362: Nvidia repo setup"
Cohesion: 0.25
...
### Community 745 - "Issue #364: quick-note:https://www.marktechpost.com/2026/06/01/meet-memory-os-a-6-layer-open-source-memory-stack-built-on-top-of-hermes-agent/"
Cohesion: 0.25
...
### Community 746 - "Issue #378: quick-note:https://www.marktechpost.com/2026/06/02/tinyfish-launches-bigset-an-open-source-multi-agent-system-that-builds-structured-live-datasets-from-plain-english-descriptions/"
Cohesion: 0.25
...
### Community 747 - "Issue #379: quick-note:https://searchengineland.com/schema-markup-optimize-agentic-web-479080"
Cohesion: 0.25
...
### Community 748 - "Issue #380: quick-note:https://cursor.com/blog/cloud-agent-lessons"
Cohesion: 0.25
...
### Community 749 - "Issue #381: quick-note:https://www.xda-developers.com/claude-code-with-opus-48-is-expensive-but-i-made-it-efficient-with-my-local-ai-workflow/"
Cohesion: 0.25
...
### Community 750 - "Issue #382: quick-note:https://claude.com/blog/how-coderabbit-used-claude-to-build-an-agent-orchestration-system"
Cohesion: 0.25
...
### Community 751 - "Issue #383: quick-note:https://www.marktechpost.com/2026/05/29/hexo-labs-open-sources-sia-a-self-improving-agent-that-updates-both-the-harness-and-the-model-weights/"
Cohesion: 0.25
...
### Community 752 - "Issue #416: feat: Self-hosted Codebuff (freebuff) on free NVIDIA models + Telegram bot phone control"
Cohesion: 0.25
...
### Community 753 - "Issue #485: [Trend Digest] Week of 2026-06-08"
Cohesion: 0.25
...
### Community 754 - "Issue #488: quick-note:https://github.com/cookiy-ai/user-research-skill"
Cohesion: 0.25
...
### Community 755 - "Issue #491: Implement whatever is necessary from https://github.com/BehiSecc/awesome-claude-skills"
Cohesion: 0.25
...
### Community 756 - "Issue #493: Use the https://github.com/mvanhorn/last30days-skill skill to get the trend updated"
Cohesion: 0.25
...
### Community 757 - "Issue #495: Read https://www.anthropic.com/news/claude-fable-5-mythos-5 and understand if mythos or fable can be added to the repo"
Cohesion: 0.25
...
### Community 758 - "Issue #504: EPIC: Autonomy hardening — live-verified defects 2026-06-10"
Cohesion: 0.25
...
### Community 759 - "Issue #581: Sprint tracker: pending work after brand rename + mobile-first pass"
Cohesion: 0.25
...
### Community 761 - "Issue #657: quick-note:https://github.com/earendil-works/pi"
Cohesion: 0.25
...
### Community 762 - "Issue #659: quick-note:https://github.com/nex-agi/Nex-N2"
Cohesion: 0.25
...
### Community 763 - "Issue #660: quick-note:https://github.com/getsentry/sentry-for-ai"
Cohesion: 0.25
...
### Community 764 - "Issue #661: quick-note:https://github.com/XiaomiMiMo/MiMo-Code"
Cohesion: 0.25
...
### Community 765 - "Issue #664: quick-note:https://github.com/Grominet95/jarvis-OS"
Cohesion: 0.25
...
### Community 766 - "Issue #666: quick-note:https://github.com/porokka/jarvis-os"
Cohesion: 0.25
...
### Community 767 - "Issue #670: quick-note:https://github.com/perplexityai/bumblebee"
Cohesion: 0.25
...
### Community 768 - "Issue #672: quick-note:https://github.com/Chachamaru127/claude-code-harness"
Cohesion: 0.25
...
### Community 769 - "Issue #676: quick-note:https://github.com/WeiboAI/VibeThinker"
Cohesion: 0.25
...
### Community 770 - "Issue #820: quick-note:https://github.com/cobusgreyling/loop-engineering"
Cohesion: 0.25
...
### Community 771 - "Positional Encoding Internals"
Cohesion: 0.25
...
### Community 772 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 773 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 774 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 775 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 776 - "PULL_REQUEST_TEMPLATE.md"
Cohesion: 0.25
Nodes (7): Changelog, Changes, Council Review (for larger PRs), Related, Risky Module Review, Summary, Testing

### Community 777 - "fetch_url.py"
Cohesion: 0.43
Nodes (7): extract_real_url(), fetch(), main(), meaningful(), Drop site navigation chrome and repeated nav blocks from stripped text.      A f, strip_boilerplate(), strip_html()

### Community 778 - "_get_current_user"
Cohesion: 0.29
...
### Community 780 - "capture_screens.py"
Cohesion: 0.39
...
### Community 783 - "crispy_burn_in.py"
Cohesion: 0.36
...
### Community 784 - "run_patched_colibri.py"
Cohesion: 0.36
...
### Community 788 - "test_compose_and_coordinate_api.py"
Cohesion: 0.36
...
### Community 789 - "TestProviderRouter"
Cohesion: 0.25
...
### Community 790 - "test_local_brain_router_smoke.py"
Cohesion: 0.25
...
### Community 791 - "TestRunCoroSync"
Cohesion: 0.29
Nodes (5): asyncio, fetch_research_alerts used asyncio.run() to await TrendWatcher().fetch(),     wh, The exact scenario that crashed before the fix: called from         code that is, End-to-end: fetch_research_alerts() itself must not raise the         'asyncio.r, TestRunCoroSync

### Community 792 - "test_provider_models_db_outage.py"
Cohesion: 0.25
...
### Community 794 - "test_serve_spa_prefixes.py"
Cohesion: 0.36
...
### Community 797 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 798 - ".discover_directory"
Cohesion: 0.29
...
### Community 804 - "_load_local_metrics_since"
Cohesion: 0.43
...
### Community 806 - "AI Engineering Insights Skill"
Cohesion: 0.29
...
### Community 816 - "ADR-006: Strangler Fig migration with backward-compat shims"
Cohesion: 0.29
Nodes (6): ADR-006: Strangler Fig migration with backward-compat shims, Consequences, Context, Decision, Examples, Migration path

### Community 817 - "claude-mem Plugin — Persistent Memory for All Sessions"
Cohesion: 0.29
...
### Community 818 - "Implementation plan + TO-DO (check off as you go)"
Cohesion: 0.29
...
### Community 821 - "Workspace Issues"
Cohesion: 0.29
...
### Community 822 - "Model and Response Issues"
Cohesion: 0.29
...
### Community 830 - "check_changelog_parity.py"
Cohesion: 0.43
...
### Community 831 - "e2e_smoke.py"
Cohesion: 0.57
Nodes (5): _chat(), check(), _health(), _models(), _req()

### Community 832 - "task_runner.py"
Cohesion: 0.33
...
### Community 833 - "test_daily_2026_06_14.py"
Cohesion: 0.38
...
### Community 834 - "TestGithubTokenSQLiteRegression"
Cohesion: 0.38
...
### Community 838 - "._get_last_commit"
Cohesion: 0.33
...
### Community 839 - "_get_backend_sam"
Cohesion: 0.33
...
### Community 854 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 855 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 856 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 857 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 858 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 859 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 864 - ".execute"
Cohesion: 0.33
Nodes (4): TaskResult, TaskSpec, Execute a task inside a fresh E2B sandbox.          Flow:           1. Open an :, Run ``pytest`` inside the sandbox. Returns ``(output, passed)``.          ``run_

### Community 865 - ".execute"
Cohesion: 0.60
Nodes (3): TaskResult, TaskSpec, Execute via OpenCode CLI: `opencode run --json <instruction>`.

### Community 866 - ".execute"
Cohesion: 0.33
Nodes (3): TaskResult, TaskSpec, Create a conversation in OpenHands and poll for completion.

### Community 868 - "apply_phase1_changes.py"
Cohesion: 0.33
...
### Community 897 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 898 - "Runtime troubleshooting"
Cohesion: 0.40
Nodes (4): Agent mode timeout, Missing binary / task harness, Runtime troubleshooting, Workspace validation failures

### Community 899 - "knowledgeGraphTab.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 900 - "loginFlowNoTimeout.test.js"
Cohesion: 0.40
Nodes (4): apiSource, { describe, test, expect }, fs, path

### Community 901 - "test_company_stale_id_recovery.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 902 - "worker_no_cache.test.js"
Cohesion: 0.40
...
### Community 904 - "Prompt Library Changelog"
Cohesion: 0.40
Nodes (4): Added, Format, Prompt Library Changelog, [Unreleased]

### Community 906 - "_add_colibri_shim_changelog_entry.py"
Cohesion: 0.50
...
### Community 907 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 908 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 909 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 910 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 918 - "test_agent_runtime_wrapper.py"
Cohesion: 0.70
...
### Community 944 - "test_no_exception_detail_leaks.py"
Cohesion: 0.50
...
### Community 945 - "test_skills_route_order.py"
Cohesion: 0.67
...
### Community 946 - "github"
Cohesion: 0.50
Nodes (3): github, enabled, silent

### Community 973 - "_isolated_store"
Cohesion: 0.67
Nodes (3): _isolated_store(), fixture, Force a fresh BrainConfigStore singleton per test + a temp sqlite mirror.

### Community 974 - "_clean_env"
Cohesion: 0.67
Nodes (3): _clean_env(), fixture, Strip env vars that would change role resolution + reset the singleton.

### Community 977 - "test_the_reserve_is_bounded_when_read_from_the_environment"
Cohesion: 0.67
Nodes (3): parametrize, Read through the ENV, not the constant — that is where the bug lived.      ``_en, test_the_reserve_is_bounded_when_read_from_the_environment()

### Community 978 - "_enable_filter"
Cohesion: 0.67
Nodes (3): _enable_filter(), fixture, Ensure filter is enabled for all tests.

## Knowledge Gaps
- **3214 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `aider_config.sh script`, `OPENAI_API_BASE` (+3209 more)
...
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `RuntimeHealth`, `Agency`, `test_empirical_verify.py`, `ExecutionRequest`, `FreeBuffAgent`, `proxy.py`, `test_ceo_supervision.py`, `failover_client.py`, `AgentSessionStore`, `test_agent_free_brain.py`, `LocalWorkspace`, `AdaptiveHalter`, `test_ceo_dispatcher.py`, `workflow_orchestrator.py`, `direct_chat.py`, `TestZeroAttemptDiagnostics`, `AutonomyTracker`, `test_backend_server_features.py`, `MultiAgentSwarm`, `test_failover_client_shared.py`, `ContextPruner`, `GitHubTools`, `TokenBudget`, `WorkspaceTools`, `test_agent_chat_integration.py`, `_StubManager`, `.execute`, `Workspace`, `ContextManager`, `MCPUnavailableError`, `TestMCPServer`, `.execute`, `MCPClient`, `StuckDetector`, `E2BAdapter`, `test_direct_chat_async.py`, `ReactScratchpad`?**
  _High betweenness centrality (0.051) - this node is a cross-community bridge._
- **Why does `TaskSpec` connect `TaskSpec` to `backend/server.py`, `TaskWorkflowService`, `RuntimeHealth`, `TestAdapterMetadata`, `Agency`, `test_mostly_failed_steps.py`, `test_ceo_supervision.py`, `AgentSessionStore`, `TaskStore`, `E2BAdapter`, `runtimes/api.py`, `ClaudeCodeAdapter`, `test_ceo_dispatcher.py`, `workflow_orchestrator.py`, `direct_chat.py`, `TaskIn`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `AgentScheduler` connect `AgentScheduler` to `backend/server.py`, `test_purge_backlog.py`, `TaskWorkflowService`, `Agency`, `FreeBuffAgent`, `proxy.py`, `SchedulerStore`, `AgentSessionStore`, `TaskStore`, `ScheduleStore`, `services/background.py`?**
...
- **What connects `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script` to the rest of the system?**
  _3214 weakly-connected nodes found - possible documentation gaps or missing edges._
