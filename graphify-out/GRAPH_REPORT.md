# Graph Report - local-llm-server  (2026-05-29)

## Corpus Check
- 637 files · ~725,036 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 12064 nodes · 26466 edges · 634 communities (577 shown, 57 thin omitted)
- Extraction: 79% EXTRACTED · 21% INFERRED · 0% AMBIGUOUS · INFERRED: 5661 edges (avg confidence: 0.51)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `61f59cd8`
...
1. `TaskSpec` - 186 edges
2. `AgentRunner` - 184 edges
3. `AgentSessionStore` - 177 edges
4. `[5.0.0] — 2026-05-24` - 162 edges
5. `RuntimeUnavailableError` - 159 edges
6. `TaskResult` - 153 edges
7. `RuntimeAdapter` - 152 edges
...
- `str` --uses--> `ProviderRouter`  [INFERRED]
  tests/test_all_providers_discovery.py → provider_router.py
- `test_status_activated_when_gate_disabled()` --calls--> `FastAPI`  [INFERRED]
  tests/test_activation_selfservice.py → webui/router.py
- `schedules_client()` --calls--> `FastAPI`  [INFERRED]
  tests/test_control_plane_api.py → webui/router.py

## Communities (634 total, 57 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.03
Nodes (103): CompanyGraphStore, MongoDBStore, bool, Company, int, KnowledgeItem, ObjectId, Repo (+95 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (78): AiderAdapter, Adapter for Aider — TIER 3 specialized git-aware code editor., DockerAgentAdapter, Adapter that runs agent tasks inside isolated Docker containers., GooseAdapter, Adapter for Goose — TIER 2 general-purpose local runtime., HermesAdapter, Adapter for Hermes Agent — FIRST CLASS autonomous runtime. (+70 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (19): FeatureEntry, FeatureMatrix, One entry in the support matrix., Central support matrix — single source of truth.      Loads the canonical featur, tests/test_feature_matrix.py — Feature maturity / support matrix tests.  Covers:, Integration test: admin endpoint returns feature matrix JSON., Every entry in _CANONICAL_FEATURES must parse as a FeatureEntry without error., TestAdminVisibility (+11 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (164): get_scheduler(), _get_current_user_thunk(), _get_optional_user_thunk(), _agent_provider_failure_response(), _agent_timeout_fallback_response(), _append_agent_session_message(), _build_agent_status_snapshot(), _build_agent_stream_event() (+156 more)

### Community 4 - "Community 4"
Cohesion: 0.08
Nodes (106): runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized).  Aider (https, Run aider non-interactively via `--message` flag., json_safe(), runtimes/adapters/claude_code.py — Claude Code CLI adapter (FIRST CLASS).  Claud, runtimes/adapters/docker_agent.py — Docker-based agent runtime adapter.  Spawns, runtimes/adapters/goose.py — Goose adapter (TIER 2).  Goose (https://github.com/, runtimes/adapters/hermes.py — Hermes Agent adapter (FIRST CLASS).  Hermes Agent, Submit task to Hermes via its /tasks endpoint. (+98 more)

### Community 5 - "Community 5"
Cohesion: 0.11
Nodes (84): _DoctorCheck, _DoctorReport, OnboardingProgressResponse, bool, Company, int, RepoScanResult, Specialist (+76 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (139): cancel_onboarding(), create_company(), get_company(), get_company_access(), get_company_graph(), get_onboarding_progress(), get_optional_company_access(), get_public_doctor_report() (+131 more)

### Community 7 - "Community 7"
Cohesion: 0.07
Nodes (111): AgentJobRequest, AgentJobSnapshot, Complete point-in-time view of a job, safe to serialise as API response., Validated input for creating a new agent job.      Passed from the API handler i, DirectChatDoctor, Agent subsystem — planner / executor / verifier loop., AgentJobManager, AgentEvent (+103 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (47): PreflightReport, AgentJob, make_isolated_workspace(), _now(), Any, Path, str, agent/job_manager.py — Async agent job lifecycle manager.  Manages agent jobs wi (+39 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (60): PreflightIssue, Any, str, Translate technical preflight issues into a conversational assistant reply., translate_error_to_conversational(), AgentSessionStore, _now(), AgentPlan (+52 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (67): clear_cooldowns(), extract_openai_text(), get_cooldown_state(), is_commercial_provider(), is_provider_on_cooldown(), mark_provider_failed(), _openai_url(), provider_access_tier() (+59 more)

### Community 11 - "Community 11"
Cohesion: 0.05
Nodes (91): _estimate_tokens_for_messages(), Estimate input token count for an Anthropic-format message list.      Uses a sim, admin_create_key(), admin_delete_user(), admin_list_users(), admin_login(), admin_logout(), admin_rotate_user() (+83 more)

### Community 12 - "Community 12"
Cohesion: 0.06
Nodes (65): AgentPhaseError, AgentRunner, AgentPlan, AgentSessionStore, Any, bool, float, int (+57 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (16): PROVIDER_TYPES, createProvider(), deleteModel(), deleteProvider(), deleteWikiPage(), getDefaultBackendUrl(), getWikiPage(), lintWiki() (+8 more)

### Community 14 - "Community 14"
Cohesion: 0.17
Nodes (20): _get_workspace_lock(), get_workspace_manager(), _hash_component(), _load_workspace(), Path, agent/workspace.py — Isolated workspace lifecycle management.  Every agent sessi, Create and return a new workspace in READY state.          Raises :exc:`Workspac, Open an existing workspace from disk.          Raises :exc:`WorkspaceNotFoundErr (+12 more)

### Community 15 - "Community 15"
Cohesion: 0.11
Nodes (38): float, int, str, compute_request_cost(), _float_env(), get_infra_config(), InfraConfig, load_infra_config() (+30 more)
...
Cohesion: 0.06
Nodes (24): TaskStatus, bool, float, Task definition schema for the evaluation harness.  Inspired by OpenHarness' str, Score the agent's final answer.         Returns (success, score)., Returns (success: bool, score: float ∈ [0, 1]).         Raises NotImplementedErr, SuccessCriterion, SuccessCriterionType (+16 more)

### Community 18 - "Community 18"
Cohesion: 0.06
Nodes (59): _fetch_text(), _now(), process_note(), Any, int, Path, str, QuickNote (+51 more)

### Community 19 - "Community 19"
Cohesion: 0.06
Nodes (45): agents/__init__.py — CRISPY multi-agent coding system., AgentProfile, _get_defaults(), load_all_profiles(), make_architect_profile(), make_coder_profile(), make_reviewer_profile(), make_scout_profile() (+37 more)
...
Cohesion: 0.09
Nodes (52): audit(), Append an audit log entry.      Never logs raw secrets — only secret IDs / maske, UserRole, complete_wizard(), _delete_wizard_state(), detect_configured_providers(), detect_hardware_for_wizard(), detect_models_for_wizard() (+44 more)
...
Cohesion: 0.08
Nodes (32): _derive_workspace_root(), int, Path, str, First-class workspace isolation manager.      Every session/job gets its own val, Create an isolated workspace for a session and optional job.                  Cr, Check access to a remote Git repository by querying its refs using `git ls-remot, Check whether the specified ref (branch or tag name) exists in the remote Git re (+24 more)
...
Cohesion: 0.07
Nodes (24): get_audit_log(), get_user_role(), is_admin(), is_power_user_or_above(), mask_dict(), mask_secret(), rbac.py — Role-Based Access Control.  Three-tier user model:   - admin:       Fu, Extract role from a user object (dict or Pydantic model). (+16 more)

### Community 39 - "Community 39"
Cohesion: 0.09
Nodes (28): DetectedIssue, ImprovementLoop, ImprovementLoopState, _now(), Any, bool, int, Path (+20 more)

### Community 40 - "Community 40"
Cohesion: 0.05
Nodes (41): BeautifulSoup, DetectedSystem, _content_contains_domain(), _hostname_contains(), _hostname_is(), _is_safe_url(), Any, bool (+33 more)
...
Cohesion: 0.05
Nodes (18): AgentJobError, AgentJobResult, Any, str, agent/contract.py — Typed public contract for the agent job lifecycle.  Phase 1, Structured error payload attached to a failed job., Typed result returned by a completed agent job.      The ``response`` field is t, Accept a bare string (legacy runner output) or a full dict. (+10 more)

### Community 43 - "Community 43"
Cohesion: 0.11
Nodes (27): IssueCategory, agent/improvement_loop.py — Continuous Improvement Engine  Background scanner th, set_improvement_loop(), get_trend_watcher(), Any, AsyncClient, bool, float (+19 more)
...
Cohesion: 0.16
Nodes (26): Tests for workspace isolation model (Area A).  Covers:   - Unique workspace path, TestConcurrency, TestCrossSessionIsolation, TestJobIdValidation, TestWorkspaceCleanup, TestWorkspaceManifest, TestWorkspaceMetrics, TestWorkspaceNotFound (+18 more)
...
Cohesion: 0.11
Nodes (25): Any, CheckRun, Path, Slice, str, WorkflowRun, Return the AgentSwarm singleton if available, else None., Append an event to the workflow event log. (+17 more)

### Community 51 - "Community 51"
Cohesion: 0.04
Nodes (46): browserslist, development, production, axios, fast-uri, lucide-react, react-markdown, react-scripts (+38 more)
...
Cohesion: 0.06
Nodes (31): CompanyGraphService, str, Get a company by ID.                  Args:             company_id: Company ID, Update a company.                  Args:             company_id: Company ID, Delete a company and all its associated data.                  Args:, List companies with optional filtering.                  Args:             owner, Get the company graph for a company, or create one if it doesn't exist., Get the company graph for a company.                  Args:             company_ (+23 more)
...
Cohesion: 0.11
Nodes (22): Set the global agent store instance (e.g., with MongoDB on startup)., set_agent_store(), float, int, str, Task, TaskStatus, List tasks for a specific user with optional filters. (+14 more)
...
Cohesion: 0.07
Nodes (39): Agency, AgencyCycleResult, AgentDirective, AgentRole, _build_ceo_prompt(), _build_quick_note_instruction(), _close_github_issue(), _fetch_github_quick_notes() (+31 more)
...
Cohesion: 0.07
Nodes (23): _artifact_name_for(), engine(), ArtifactStore, Path, str, WorkflowEngine, WorkflowRun, tests/test_workflow_engine.py — Integration tests for WorkflowEngine.  Uses tmp_ (+15 more)
...
Cohesion: 0.08
Nodes (35): ActivityEvent, AgentActivityFeedProps, ActivityEventRow(), AGENT_COLORS, EVENT_ICONS, formatTime(), getAgentColor(), ActivityEventRow() (+27 more)

### Community 63 - "Community 63"
Cohesion: 0.11
Nodes (34): bytes, str, Ed25519PublicKey, ActivationResult, _b64url_decode(), _b64url_encode(), _decode_jwt_unverified(), _generate_token_for_owner() (+26 more)

### Community 65 - "Community 65"
Cohesion: 0.01
Nodes (162): [5.0.0] — 2026-05-24, Added, Added, Added, Added, Added, Added, Added (+154 more)
...
Cohesion: 0.06
Nodes (24): AuthCallback(), buildNavSections(), DashboardLayout(), MOBILE_PRIMARY_NAV, SidebarContent(), LoginPage(), getMe(), getSetupState() (+16 more)

### Community 73 - "Community 73"
Cohesion: 0.26
Nodes (9): _normalize_base_url(), _now(), ProviderRecord, ProviderSecret, Any, bool, str, Ensure at least one provider exists, seeded from env when empty. (+1 more)

### Community 74 - "Community 74"
Cohesion: 0.16
Nodes (27): ApprovalCheckpoint, Human approval gate in a task's execution., agent_store(), api_client(), _FakeRuntimeManager, AgentStore, TaskStore, TaskWorkflowService (+19 more)

### Community 75 - "Community 75"
Cohesion: 0.09
Nodes (36): Start all runtime containers.      Returns partial results — individual runtime, Stop all runtime containers.      Returns partial results — individual runtime f, start_all(), stop_all(), _find_agent_runtime_script(), _get_ollama_base(), _is_docker_unavailable(), Any (+28 more)
...
Cohesion: 0.07
Nodes (46): Any, bool, int, Request, str, bool, activation_required(), activate_instance() (+38 more)
...
Cohesion: 0.05
Nodes (23): LOCAL_MODELS, NVIDIA_MODELS, SetupWizardPage(), STEPS, completeSetup(), createSecret(), detectHardwareForSetup(), detectModelsForSetup() (+15 more)
...
Cohesion: 0.19
Nodes (7): bool, int, str, Return an agent by ID.          If *owner_id* is provided, enforces that the age, Delete an agent.  Returns True on success, False if not found/unauthorised., Return all agents owned by *owner_id*, optionally including public agents., Return all agents in the system (admin use only).

### Community 85 - "Community 85"
Cohesion: 0.09
Nodes (24): configure(), get_status(), Check if Ollama is running., Start the proxy server., Stop the proxy server., Get current status of all services., Serve the setup wizard UI., Configure paths and services. (+16 more)
...
Cohesion: 0.13
Nodes (29): FastAPI, ProviderManager, ProviderCreate, ProviderUpdate, _admin_out(), AdminCommandBody, Any, bool (+21 more)
...
Cohesion: 0.12
Nodes (26): get_improvement_loop(), IssueSeverity, HealingEvent, _now(), Any, str, agent/self_healing.py — Self-Healing Agent  Translates external failure signals, Translate external failure signals into improvement tasks.      Usage:: (+18 more)

### Community 92 - "Community 92"
Cohesion: 0.12
Nodes (23): Any, bool, Path, str, agent/security_scanner.py — Security & Vulnerability Scanner  Runs static analys, Run all available scanners and aggregate results., Return True if *name* is on PATH., Run security scans and return structured findings.      Usage::          scanner (+15 more)

### Community 93 - "Community 93"
Cohesion: 0.12
Nodes (19): ArtifactStore, _now(), Any, Artifact, Connection, int, Path, Row (+11 more)
...
Cohesion: 0.12
Nodes (34): _build_anthropic_response(), _content_block_to_text(), _emit_safely(), _finish_reason_to_stop_reason(), get_local_model(), handle_anthropic_messages(), _messages_to_openai(), _openai_choice_to_anthropic_content() (+26 more)

### Community 97 - "Community 97"
Cohesion: 0.16
Nodes (33): Any, bool, bytes, int, JSONResponse, Request, Response, str (+25 more)

### Community 98 - "Community 98"
Cohesion: 0.15
Nodes (33): _get(), ProviderRouter, str, Verify every supported provider is correctly discovered, prioritised, and typed., Build a ProviderRouter from_env() with only the supplied env vars active., _router(), test_anthropic_discovery(), test_anthropic_no_base_url_required() (+25 more)

### Community 99 - "Community 99"
Cohesion: 0.08
Nodes (34): get_decision_log(), get_policy(), get_runtime(), list_runtimes(), _load_rich_policy(), PolicyUpdateBody, Any, int (+26 more)

### Community 100 - "Community 100"
Cohesion: 0.13
Nodes (70): AdminIdentity, BackgroundTask, BrowserSession, Async Playwright browser session.      Usage::          session = BrowserSession, CommitAttribution, CommitTracker, agent/commit_tracker.py — AI Commit Attribution  Tags git commits with metadata, Create git commits enriched with agent-session attribution trailers.      Usage: (+62 more)
...
Cohesion: 0.15
Nodes (16): Any, bool, int, Path, str, mcp_server/workspace.py — Isolated workspace manager for the MCP server.  Each w, Run a shell command inside the workspace via an explicit shell binary., Resolve rel against root, reject path traversal. (+8 more)
...
Cohesion: 0.11
Nodes (33): AgentCreateRequest, _apply_activity_status(), create_agent(), delete_agent(), get_agent(), _get_user(), list_agents(), list_runtime_agents() (+25 more)
...
Cohesion: 0.15
Nodes (15): str, CompletedProcess, Browser admin UI for login, service control, key management, and diagnostics., Update or append a KEY=value line in the .env file., register_admin_gui(), _save_env_var(), _creationflags(), Spawn a new proxy process on Linux/Mac using the current Python interpreter. (+7 more)
...
Cohesion: 0.13
Nodes (26): Any, float, int, Request, str, compute_savings(), compute_time_series(), get_savings() (+18 more)
...
Cohesion: 0.06
Nodes (15): _normalize_anthropic_output_format(), bool, Translate Anthropic ``output_format`` into an Ollama ``format`` field.      Modi, Daily automation tests — 2026-05-15  Covers three features implemented in this r, Unit tests for extended thinking detection in handle_anthropic_messages., When thinking.type == enabled, routing should use agent_plan endpoint type., No thinking param → normal chat routing, not forced to reasoning., thinking_budget_tokens should appear in routing_meta when thinking is set. (+7 more)
...
Cohesion: 0.17
Nodes (21): _auth_headers(), chat_completion_text(), list_openai_models(), normalize_base_url(), openai_compat_url(), Any, AsyncClient, float (+13 more)
...
Cohesion: 0.17
Nodes (22): _extract_last_user_message(), handle_workflow_ide_chat(), _json_response(), Any, bool, bytes, JSONResponse, Request (+14 more)
...
Cohesion: 0.25
Nodes (27): Client, check(), main(), ok(), Returns access token for subsequent tests., Direct-mode chat. Passes even if no LLM backend is running (error message return, Poll /api/health with retries until the server is up., HTTP request with automatic retry on transient failures.      Retries on: connec (+19 more)
...
Cohesion: 0.16
Nodes (15): _dispatch_async(), ErrorInterceptorMiddleware, Any, bool, Exception, int, Request, Response (+7 more)
...
Cohesion: 0.10
Nodes (19): ❌ BLOCKED, Bug 1: CI YAML Broken Indentation (`.github/workflows/ci.yml`), Bug 2: E2E YAML Structure Destroyed (`.github/workflows/e2e.yml`), Bug 3: Dead Code in Module Docstring (`direct_chat.py`), Bug 4: `log` Used Before Definition (`direct_chat.py`), Bug 5: Invalid Escape Sequence (`scripts/bump_version.py:71`), Bug 6: Bare Except Clauses (13 occurrences), Code Review & Bug Fix Report for strikersam/local-llm-server (+11 more)
...
Cohesion: 0.06
Nodes (17): _now(), Any, bool, str, agent/scheduler.py — Scheduled Agent Jobs  Cron-based job scheduler.  Each job h, Register a new job.  Returns the created :class:`ScheduledJob`., Fire a job immediately (webhook / manual trigger)., Remove a job. Returns *True* if it existed. (+9 more)
...
Cohesion: 0.11
Nodes (4): INITIAL_KEYS, INITIAL_REQUESTS, INITIAL_USERS, roleConfig
...
Cohesion: 0.12
Nodes (9): get_feature_matrix(), Return the global FeatureMatrix singleton., Reset the singleton (useful for testing)., reset_feature_matrix(), Lightweight docs/config sync tests (Area C5).  Ensures:   - Support matrix docs, Tests for feature maturity / support matrix (Area B).  Covers:   - Matrix loads, TestConfigOverrides, TestFeatureMatrixSingleton (+1 more)
...
Cohesion: 0.16
Nodes (12): bool, int, str, issue_new_api_key(), KeyRecord, KeyStore, Generate a new plaintext API key, persist hash + metadata, return (plain_key, re, Thread-safe JSON-backed key store. (+4 more)
...
Cohesion: 0.11
Nodes (11): _iso_now(), Resolve *relative* inside source dir and reject traversal/symlink escapes., Open a workspace for resumption.          Only READY or PAUSED workspaces may be, Raise :exc:`WorkspaceAccessDeniedError` if *requesting_session_id* doesn't own *, Update *ws* status and persist the manifest., Update last_heartbeat timestamp and persist., Acquire the exclusive async lock for *ws*.          Raises :exc:`WorkspaceLockEr, Remove and recreate the tmp directory for *ws*. (+3 more)
...
Cohesion: 0.20
Nodes (6): _Collection, _DeleteResult, Connection, Motor-compatible async collection backed by a SQLite table.      All I/O uses pa, Minimal aggregate support: $match → $group($sum) / $sort / $limit., No-op — indexes are pre-created in schema init.
...
Cohesion: 0.11
Nodes (17): code:block1 (.claude/threads/), code:bash (bash .agents/skills/duplicate-thread/duplicate.sh <source-th), code:bash (bash .agents/skills/duplicate-thread/duplicate.sh plan-2025-), code:block4 (Duplicate the current thread as "alternative-auth-strategy" ), code:json ({), Files, How It Works, In a Claude prompt (+9 more)
...
Cohesion: 0.11
Nodes (3): PREVIEW_COMPANY_DATA, QUEUED_NOTES, V5App()
...
Cohesion: 0.07
Nodes (15): _getBackendUrl(), useSafeData(), AgentsScreen(), DashboardScreen(), MOCK_COST, MOCK_HEALTH, MOCK_JOBS, MOCK_SIGNALS (+7 more)

### Community 215 - "Community 215"
Cohesion: 0.12
Nodes (16): Acceptance Checks, Claude's query protocol (use this instead of Read tool for exploration):, code:bash (# Install the CLI), code:text (graphify-out/graph.json        ← persistent, queryable graph), code:text (# EXPENSIVE (reads 300-line file = ~1200 tokens)), code:text (graphify-out/GRAPH_REPORT.md   ✅ commit — portable readable ), Graph Artifacts — What to Commit, How to Use the Graph (Token Savings Protocol) (+8 more)
...
Cohesion: 0.12
Nodes (15): Agency Core — Progress & Resume Log, Audit (committed), code:bash (# 1. Clear the stale lock if present), Environment constraints discovered this session, How to resume (read before doing anything), Key findings (so we don't re-investigate), Open risks / must-know before merging, Phase 0 — Stabilize & quarantine (commit `713184a`, pushed) (+7 more)
...
Cohesion: 0.12
Nodes (6): AVAILABLE_AGENTS, CHAT_HISTORY, CHAT_PHASES, CONTEXT_CHIPS_DEFAULT, SAMPLE_RESULT, SUGGESTIONS

### Community 244 - "Community 244"
Cohesion: 0.15
Nodes (10): AgentCard(), BUILTIN_AGENT_DEFS, CEO_CYCLE, DEFAULT_AGENTS, PIPELINE_MODES, resolveAgentModel(), resolveAgentProvider(), RUNTIME_TIER_COLOR (+2 more)
...
Cohesion: 0.16
Nodes (18): create_schedule(), delete_schedule(), get_schedule(), get_schedule_runs(), list_schedules(), Request, str, schedules/api.py — Control-plane facing schedule management.  Exposes the agent (+10 more)
...
Cohesion: 0.11
Nodes (10): TestWorkspacePathDerivation, _now(), Any, bool, str, workspace/manifest.py — Workspace manifest schema.  Each isolated workspace has, Structured manifest for an isolated workspace., Transition to a new status and update cleanup eligibility. (+2 more)
...
Cohesion: 0.25
Nodes (10): _apply_update(), _InsertResult, _match(), _new_id(), _now_iso(), bool, db/sqlite_store.py — Async SQLite storage backend.  Provides a Motor-compatible, Return True if *doc* satisfies the MongoDB-style *query*.      Supports: exact m (+2 more)
...
Cohesion: 0.07
Nodes (28): Added, Added, Added, Added, Added, Added, Added, Added (+20 more)

### Community 265 - "Community 265"
Cohesion: 0.12
Nodes (4): DETECTED_SYSTEMS_DEFAULT, QUESTION_SETS, STEPS, SYSTEM_TYPE_META
...
Cohesion: 0.14
Nodes (13): Agency Core, Architecture, Cloud deployment (Render + GitHub Pages), code:block2 (┌───────────────────────────────────────────────────────────), code:bash (# Run tests — always before committing), Development, License, Roadmap (+5 more)
...
Cohesion: 0.14
Nodes (13): Ask Claude to emit a resource panel, Automated via shell (git-based), code:block1 (╔══════════════════════════════════════════════════════╗), code:block2 (When done, emit a resource-panel summary following .agents/s), code:bash (bash .agents/skills/resource-panel/summarise.sh), Fields, Files, How to Use (+5 more)
...
Cohesion: 0.15
Nodes (12): Acceptance check, Agency Core — Ruthless Architecture Audit & Migration Plan, code:block1 (┌─────────────────────────────────────────────┐), code:python (# agent/contract.py  (new, the spine)), Root causes (not symptoms), Section 1 — The Brutal Truth, Section 2 — Keep / Salvage / Replace / Remove, Section 3 — The Chosen Foundation (+4 more)
...
Cohesion: 0.15
Nodes (5): actorColors, KB_ACTIVITY, KB_DOCS, KB_SOURCES, tagColors
...
Cohesion: 0.17
Nodes (12): 1. Clone and install, 2. Configure, 3. Start the backend, 4. Start the frontend (development), 5. Connect your AI coding tools, code:bash (git clone https://github.com/strikersam/local-llm-server.git), code:bash (cp .env.example .env), code:bash (uvicorn backend.server:app --reload --port 8001) (+4 more)
...
Cohesion: 0.17
Nodes (9): client(), Tests for Company Graph API endpoints., Test Company Graph API endpoints., Test that the company API router is included., Test Doctor endpoint., Test the public doctor endpoint., Create a test client for the FastAPI app., TestCompanyAPI (+1 more)
...
Cohesion: 0.11
Nodes (16): int, agent/workflow.py — Persisted workflow state machine.  Implements the Agency Cor, ExecutionLogEntry, Any, Update the updated_at timestamp., Single entry in a task's execution log., Full task/issue document., Task (+8 more)
...
Cohesion: 0.18
Nodes (11): 1. **Implement CompanyGraphStore**, 2. **Implement Company Graph Services**, 3. **Replace Mocks with Real Implementations**, 4. **Integrate with Existing Components**, 5. **Add Tests**, code:bash (# Create services/company_graph_store.py), code:bash (# Create services/company_graph.py), code:bash (# Update backend/company_api.py) (+3 more)
...
Cohesion: 0.18
Nodes (10): code:bash (ACTIVATION_REQUIRED=false), code:bash (# Run from the repo root. Reads/creates .instance_id automat), code:bash (ACTIVATION_PUBLIC_KEY_B64="<printed-public-key>"), Option A — disable the gate (self-hosted), Option B — self-mint a signed code with your own key, Option C — request a code (downstream user), Runbook — Instance Activation, Security notes (+2 more)
...
Cohesion: 0.22
Nodes (12): SimpleNamespace, _client(), bool, TestClient, Tests for activation_api — instance status, OpenAPI schema, and role route.  Reg, test_change_role_rejects_invalid_role(), test_change_role_requires_authentication(), test_change_role_returns_404_for_missing_user() (+4 more)
...
Cohesion: 0.20
Nodes (4): str, Top-level store — exposes collections as attributes.      Usage::          store, Create tables if they don't already exist., SQLiteStore
...
Cohesion: 0.22
Nodes (8): Agency Core v5: Transformation Progress, 🚨 BLOCKERS, 📞 CONTACT, Current Blockers, 🎯 MISSION, Resolved Blockers, Security & Scanner Updates, 🎉 SUCCESS CRITERIA
...
Cohesion: 0.28
Nodes (5): CompanyGraph, Create a new company graph., Create a new company graph (No-op shim for SQLite, as it is aggregated dynamical, Update a company graph (No-op shim for SQLite)., Update a company graph.
...
Cohesion: 0.25
Nodes (7): Backend (Render), Cloudflare dashboard settings to verify, Cloudflare = the real working app, code:text (Browser ──► local-llm-server.strikersam.workers.dev), How it works, Notes, Verify after deploy
...
Cohesion: 0.25
Nodes (3): ACTIVE_JOBS, CAT_CONFIG, SMART_TEMPLATES

### Community 383 - "Community 383"
Cohesion: 0.24
Nodes (6): ActivityRow(), ErrorRow(), MOCK_ERRORS, MOCK_REQUESTS, MOCK_TRACES, relTime()

### Community 384 - "Community 384"
Cohesion: 0.29
Nodes (6): BOARD_TASKS, LIFECYCLE_STAGES, priorityColors, relTime(), TaskCard(), typeColors
...
Cohesion: 0.25
Nodes (8): code:block1 (queued → planning → executing → verifying → awaiting approva), From onboarding to autonomous work — step by step, Step 1 — Boot and activate, Step 2 — Describe your company, Step 3 — Talk to the CEO agent, Step 4 — Watch the Task Board, Step 5 — HITL approval gates, Step 6 — Schedule recurring work
...
Cohesion: 0.18
Nodes (11): TaskExecutionCoordinator, Helpers that turn scheduler and playbook activity into real tasks., float, int, str, TaskStore, Background dispatcher for task execution., Executes tasks through the runtime layer using agent definitions. (+3 more)
...
Cohesion: 0.12
Nodes (26): Any, bool, int, str, _base_url(), _department_trace_tags(), emit_chat_observation(), _emit_langfuse_http_sync() (+18 more)
...
Cohesion: 0.32
Nodes (7): code:block1 (python scripts/ai_runner.py resume), Completed this session, Completed this session (Friday maintenance sweep), NEXT ACTION — Agency Cycle Fresh Start, NEXT ACTION — Friday Maintenance Complete, Next cycle tasks, Resume command
...
Cohesion: 0.40
Nodes (5): Code Changes, code:block1 (Commits: 2), Completion, Coverage, 📈 METRICS

### Community 465 - "Community 465"
Cohesion: 0.40
Nodes (5): 🛡 CI/DevOps (P1), 📚 Documentation (P2), 🎨 Frontend (P1), ⏳ PENDING, 🧪 Testing (P1)
...
Cohesion: 0.40
Nodes (4): code:bash (make doctor                 # report (always exits 0)), Roadmap, Runbook: `make doctor`, What it checks and why
...
Cohesion: 0.50
Nodes (3): featureCards, heroElements, target
...
Cohesion: 0.50
Nodes (4): Content & knowledge agents, Engineering agents, Operations agents, The autonomous agency — what your agents can do
...
Cohesion: 0.40
Nodes (4): Path, default_keys_path(), load_key_store(), Persistent API key store: each key maps to email + department (seat) and a stabl
...
Cohesion: 0.50
Nodes (3): code:markdown (## YYYY-MM-DD — <short title>), Format, Session Learnings
...
Cohesion: 0.67
Nodes (3): code:block8 (AWS Bedrock (15) → Nvidia NIM (10) → DeepSeek (8) → Anthropi), Configuration reference, Provider priority chain
...
Cohesion: 0.36
Nodes (10): Any, float, int, str, CommercialEquivalent, estimate_commercial_equivalent_usd(), get_prices(), _load_from_env() (+2 more)
...
Cohesion: 0.04
Nodes (44): _best_cloud_primary_base(), InternalAgentAdapter, _nvidia_provider_chain(), Built-in agent loop — Nvidia NIM primary, Ollama fallback., Return runtime dependencies required by this adapter.                  Returns:, Determine availability of the internal agent runtime by preferring an NVIDIA NIM, Execute a TaskSpec using the internal AgentRunner and convert the agent's outcom, Create an isolated execution context for a single task.          Tries ``git wor (+36 more)

### Community 633 - "Community 633"
Cohesion: 0.33
Nodes (3): INITIAL_ALERTS, priorityConfig, typeIcon

## Knowledge Gaps
- **2726 isolated node(s):** `setup_autostart_macos.sh script`, `run_ollama.sh script`, `run.sh script`, `ANTHROPIC_API_KEY`, `ANTHROPIC_MODEL` (+2721 more)
...
- **Why does `AgentRunner` connect `Community 12` to `Community 321`, `Community 3`, `Community 100`, `Community 4`, `Community 7`, `Community 631`, `Community 9`, `Community 11`, `Community 77`, `Community 205`, `Community 206`, `Community 16`, `Community 17`, `Community 81`, `Community 49`, `Community 22`, `Community 23`, `Community 58`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `FastAPI` connect `Community 88` to `Community 1`, `Community 3`, `Community 6`, `Community 8`, `Community 11`, `Community 268`, `Community 143`, `Community 16`, `Community 145`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 28`, `Community 158`, `Community 36`, `Community 166`, `Community 38`, `Community 169`, `Community 41`, `Community 53`, `Community 56`, `Community 580`, `Community 74`, `Community 78`, `Community 339`, `Community 85`, `Community 342`, `Community 96`, `Community 97`, `Community 99`, `Community 100`, `Community 103`, `Community 104`, `Community 108`, `Community 121`, `Community 251`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `CompanyGraph` connect `Community 5` to `Community 0`, `Community 6`, `Community 366`, `Community 54`, `Community 22`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Are the 159 inferred relationships involving `TaskSpec` (e.g. with `AiderAdapter` and `ClaudeCodeAdapter`) actually correct?**
  _`TaskSpec` has 159 INFERRED edges - model-reasoned connections that need verification._
- **Are the 124 inferred relationships involving `AgentRunner` (e.g. with `InternalAgentAdapter` and `AdminIdentity`) actually correct?**
  _`AgentRunner` has 124 INFERRED edges - model-reasoned connections that need verification._
- **Are the 123 inferred relationships involving `AgentSessionStore` (e.g. with `AdminIdentity` and `AgentPhaseError`) actually correct?**
  _`AgentSessionStore` has 123 INFERRED edges - model-reasoned connections that need verification._
- **What connects `setup_autostart_macos.sh script`, `Qwen3-Coder Authenticated Proxy -------------------------------- Sits in front o`, `Accept both Authorization: Bearer <key> (standard) and x-api-key: <key> (Claude` to the rest of the system?**
  _4444 weakly-connected nodes found - possible documentation gaps or missing edges._