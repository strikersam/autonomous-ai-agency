# Graph Report - autonomous-ai-agency  (2026-08-29)

## Corpus Check
- 1450 files · ~2,108,771 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 29583 nodes · 54855 edges · 1271 communities (1158 shown, 113 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 2696 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `55bc7d65`
...
## Communities (1271 total, 113 thin omitted)

### Community 0 - "MongoDBStore"
Cohesion: 0.02
Nodes (101): CompanyGraph, KnowledgeItem, The complete Company Graph - canonical core model for the Autonomous AI Agency.…, Find a repository by its URL., Find a workflow by its name., Find knowledge items matching any of the given tags., Find connectors configured for a specific system., Structured knowledge about the company, systems, or processes. (+93 more)

### Community 1 - "proxy.py"
Cohesion: 0.03
Nodes (162): middleware, admin_control(), admin_create_user(), admin_delete_user(), admin_login(), admin_logout(), admin_rotate_user(), admin_status() (+154 more)
...
Cohesion: 0.02
Nodes (104): CacheManager, cosine_similarity(), _Entry, LRUCache, payload_key(), Any, T, Live (unexpired) entries — used by the semantic layer's scan. (+96 more)

### Community 6 - "WorkflowRun"
Cohesion: 0.10
Nodes (15): _make_engine(), Create a WorkflowEngine with isolated storage., TestAbortOnFailure, TestPhaseSequence, TestWorkspaceIsolation, Phase, Any, BaseModel (+7 more)

### Community 7 - "redact_connection_url"
Cohesion: 0.17
...
Cohesion: 0.04
Nodes (80): agent/job_manager.py — Async agent job lifecycle manager. Manages agent jobs…, kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, TaskResult, TaskSpec, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Run aider non-interactively via `--message` flag., runtimes/adapters/claude_code.py — Claude Code CLI adapter (FIRST CLASS).… (+72 more)
...
Cohesion: 0.03
Nodes (93): Call-time resolver for an agent role model id. Delegates to…, _resolve_role_model(), _active_primary_provider(), BrainConfig, BrainConfigStore, default_brain_config(), is_north_mini_code_default(), provider_api_keys() (+85 more)

### Community 12 - "test_llm_router_providers.py"
Cohesion: 0.04
Nodes (97): ProviderConfig, One configured endpoint. ``kind`` selects the adapter: ``openai`` (any OpenAI-…, OpenAICompatible, Adapter for any endpoint speaking the OpenAI chat-completions shape. Adding a…, build_provider(), ProviderConfig, Normalise a configured ``kind`` to an adapter key., Instantiate the adapter for one provider config. Unknown kinds fall back to the… (+89 more)

### Community 13 - "PolicyDecision"
Cohesion: 0.07
Nodes (33): classify(), evaluate_call(), guard_tool_call(), GuardResult, _host_of(), _is_write_tool(), _more_restrictive(), Any (+25 more)
...
Cohesion: 0.05
Nodes (39): build_governance_router(), Any, APIRouter, backend/governance_router.py — read and operate the governance layer. Mounted…, Reject non-admin callers. Mirrors the RBAC check used elsewhere in this backend…, _require_admin(), _audit_proposal(), _baseline_loosened() (+31 more)
...
Cohesion: 0.03
Nodes (119): Governance seam: judge the call, run it, audit the outcome. Deliberately a thin…, Feed LLM token/cost spend into the governance session budget. Kept separate…, Charge sub-agent nesting depth and enforce the ``max_depth`` ceiling. Isolates…, _egress_policy_reason(), agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Return why governance policy blocks *host*, or None. Runs strictly *after* the…, guard(), identity_from_headers() (+111 more)

### Community 18 - "CEODispatcher"
Cohesion: 0.05
Nodes (59): CEODispatcher, CEOResult, _complexity_rank(), _decompose_into_subtasks(), _merge_changed_files(), _offload(), Any, services/ceo_dispatcher.py — Real CEO delegation layer. The CEO splits a… (+51 more)
...
### Community 21 - "llm/router.py"
Cohesion: 0.03
Nodes (92): _load(), main(), int, get_budget(), The process-wide budget tracker., get_cache(), packages/llm/cache.py — layered caching. Five independent layers, each with its…, The process-wide cache manager. (+84 more)
...
Cohesion: 0.04
Nodes (71): get_ceo_fallback_stats(), PlanOutput, PLAN phase: structured execution plan., SELECT_SPECIALIST phase: which specialist(s) handle this work., Increment the named counter (silently ignores unknown reasons)., Return a snapshot of the CEO fallback counters., Zero all CEO fallback counters (useful for testing)., _record_ceo_fallback() (+63 more)

### Community 28 - "CompanyGraphService"
Cohesion: 0.03
Nodes (42): BusinessCategory, Find a website by its URL., A company website with detected systems and stack inference., Website, CompanyGraphService, Company, SpecialistFamily, SystemType (+34 more)

### Community 29 - "loop.py"
Cohesion: 0.18
Nodes (15): loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., Condense a tool result down to what belongs in an audit row. A tool result can…, # NOTE: "ollama_base" is kept for backwards compatibility; this runner only…, _summarise_tool_result(), build_compaction_prompt(), build_execution_prompt(), build_planning_prompt(), build_tool_prompt() (+7 more)

### Community 30 - "test_runtime_governance.py"
Cohesion: 0.07
Nodes (57): _blocked_result(), _governance_check(), Any, TaskResult, TaskSpec, Build the failed TaskResult returned when policy denies a dispatch. A result…, Evaluate a runtime dispatch against policy; audit it either way. Returns…, Full record of a routing decision — audit-trail entry. (+49 more)

### Community 31 - "WebsiteScanner"
Cohesion: 0.03
Nodes (75): main(), Returns (url, ok, summary)., _scan_one(), _content_contains_domain(), _hostname_contains(), _hostname_matches(), _is_safe_url(), _looks_like_bot_challenge() (+67 more)

### Community 32 - "AgentRunner"
Cohesion: 0.03
Nodes (102): AgentPhaseError, AgentRunner, _check_extra_kwargs(), _enforce_signature(), Any, Exception, Path, Raise TypeError if fn's signature drifts from the locked contract (Pydantic… (+94 more)
...
### Community 34 - "test_north_mini_code.py"
Cohesion: 0.08
Nodes (17): north_mini_code_model_for(), Return the North Mini Code model id served by *provider*, else ``None``.…, best_model_for(), Return the name of the best model for a given task category. Falls back to…, tests/test_north_mini_code.py — North Mini Code 1.0 integration. Covers the…, The switch defaults ON so North is the default post-install., The agency/Hermes execution path defaults to North via the resolver., Hermes must be able to run the agency with the full Hermes-OS capacity set —… (+9 more)

### Community 35 - "LLMRequest"
Cohesion: 0.03
Nodes (80): Attempt, Read the environment variables named in ``env_names`` into a key list. Order is…, resolve_keys(), packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, classify_error(), LLMProvider, ABC, Any (+72 more)

### Community 36 - "TaskWorkflowService"
Cohesion: 0.03
Nodes (94): AgentDefinition, AgentStore, Any, field_validator, agents/store.py — Persistent store for user-defined agent configurations.…, CRUD store for AgentDefinition objects. Uses MongoDB when a `db` client is…, Return an agent by ID. If *owner_id* is provided, enforces that the agent…, Delete an agent. Returns True on success, False if not found/unauthorised. (+86 more)

### Community 37 - "test_unit8_model_catalog.py"
Cohesion: 0.04
Nodes (73): all_provider_ids(), _provider_ids_from_literal(), provider_key_present(), Return every provider id recognised by the brain config system. Iterates the…, True when the env var for *provider*'s key is set (or it's Ollama)., Return the provider ids allowed by the ``BrainProvider`` Literal. Reads the…, CatalogActiveBrain, CatalogMirror (+65 more)
...
### Community 39 - "Task"
Cohesion: 0.04
Nodes (73): Full task/issue document., Update the updated_at timestamp., Task, One-line human explanation of why this task needs human approval. Reads risk…, Best-effort label of who will run this task once approved. Returns…, PUBLIC_URL-anchored dashboard deep link for the task detail. Returns empty…, Best-effort Telegram heads-up that a task is parked awaiting approval. Inline…, asyncio (+65 more)

### Community 40 - "ImprovementLoop"
Cohesion: 0.05
Nodes (74): Agency, get_agency(), CEO-coordinated multi-agent agency for continuous codebase management. The CEO…, set_agency(), DetectedIssue, ImprovementLoop, ImprovementLoopState, IssueCategory (+66 more)
...
### Community 47 - "get_company_graph_store"
Cohesion: 0.05
Nodes (50): get_optional_company_access(), Company, Verify user has access to a company (if authenticated). Admins bypass ownership…, autonomy_status(), Public autonomy readiness probe — no authentication required. A live deploy…, detect_company_id(), DirectChatSession, handle_chat_message_with_context() (+42 more)

### Community 48 - "BudgetTracker"
Cohesion: 0.07
...
### Community 50 - "TaskStore"
Cohesion: 0.04
Nodes (75): Any, Task, TaskStatus, Fail loud in production if no persistent storage is configured. Telegram…, Create a task. Deduplicates by source_id if set (Charter G3). If a task with…, Fetch a task by ID. If owner_id is set, enforces ownership., Return the task previously created for an external ``source_id`` (e.g.…, List tasks for a specific user with optional filters. ``include_system``… (+67 more)
...
### Community 53 - "test_iteration_6_features.py"
Cohesion: 0.05
...
Cohesion: 0.05
Nodes (69): _enrich_runtimes(), get_decision_log(), get_policy(), get_runtime(), list_runtimes(), PolicyUpdateBody, Any, BaseModel (+61 more)

### Community 55 - "AgentJobManager"
Cohesion: 0.07
Nodes (20): AgentJob, AgentJobManager, _now(), Any, Run a job using the provided runner and update the job's lifecycle, progress,…, Serialize the AgentJob to a JSON-serializable dictionary for external clients.…, AgentJobManager method signature enforcement., TestAgentJobManagerContracts (+12 more)
...
### Community 57 - "ProviderRouter"
Cohesion: 0.08
Nodes (24): _normalized_provider_type(), ProviderRouter, Any, Response, Parse a 429/503 ``Retry-After`` header → seconds, or None. Accepts either…, Translate an OpenAI chat/completions payload to Bedrock Converse format., Translate a Bedrock Converse API response to OpenAI chat.completion format., Priority-ordered LLM provider fallback with health checks and retries. (+16 more)
...
### Community 64 - "get_skill_bindings"
Cohesion: 0.08
Nodes (27): get_skill(), list_skills(), List all available skills with optional filtering. Returns the skill catalog…, Get a single skill by its ID., build_matrix(), _families(), main(), Any (+19 more)

### Community 65 - "ai/router.py"
Cohesion: 0.06
Nodes (43): Record token usage for *model* (fire-and-forget, never raises). ``tag`` is a…, record_usage(), _acquire_provider_probe(), CommercialFallbackRequiredError, _dead_model_key(), _exponential_backoff_cooldown(), _get_director(), _mark_model_dead() (+35 more)
...
Cohesion: 0.05
Nodes (69): quick_notes_submit(), _QuickNoteBody, Submit a quick-note URL or instruction from the dashboard FAB., get_failover_manager(), Return the singleton BrainFailoverManager., Reset the singleton (for tests)., reset_failover_manager(), Hand the 'connect & verify the repo' work to the agency's own agents. The task… (+61 more)

### Community 70 - "FeatureMatrix"
Cohesion: 0.07
Nodes (13): FeatureMatrix, Central support matrix — single source of truth. Loads the canonical feature…, Return True if the feature is enabled and not disabled., Return a warning string for beta/experimental features, or None., Render the matrix as a Markdown table for docs., Integration test: admin endpoint returns feature matrix JSON., TestAdminVisibility, TestConfigOverrides (+5 more)
...
Cohesion: 0.06
Nodes (51): BaseModel, field_validator, models/seo_audit.py - SEO / GEO / AIO Audit Contracts Typed Pydantic models for…, A single occurrence of a check firing on a specific URL., Snapshot of one crawled page with the on-page facts the checks used., Aggregated report row - Screaming Frog CSV compatible., Site-level facts discovered during the crawl., Lightweight listing entry for past audits. (+43 more)

### Community 75 - "test_render_mcp.py"
Cohesion: 0.07
Nodes (28): build_render_router(), Any, APIRouter, BaseModel, Exception, backend/render_router.py — Render platform view for operators and agents.…, Reject anyone who is not the agency admin., Map an MCP transport failure onto 503 rather than a 500. The distinction… (+20 more)
...
Cohesion: 0.05
Nodes (55): _auto_disable(), _describe_registry(), _disabled_ids(), FailoverResult, _is_billing_refusal(), _is_ollama(), _key_pool(), _log_exhaustion() (+47 more)
...
Cohesion: 0.03
Nodes (93): E2BAdapter, Any, Declare ``E2B_API_KEY`` as a required env dependency. The base ``preflight``…, Runtime adapter that executes tasks inside an E2B sandbox. Activation:…, Available iff config resolves AND the SDK is importable. Never raises — a…, e2b_status(), Return the E2B sandbox integration status for the ProvidersScreen badge. Does…, e2b_enabled() (+85 more)
...
### Community 87 - "RenderMCPClient"
Cohesion: 0.05
Nodes (37): _as_list(), _coerce_payload(), get_render_mcp(), Any, RuntimeError, packages/integrations/render_mcp.py — Render platform access over MCP. The…, Return tool output as Python data. MCP tool results arrive either as…, Normalise a tool payload into a list of dicts. Upstream tools variously return… (+29 more)
...
Cohesion: 0.15
Nodes (50): ApprovalRequest, BackgroundTasks, add_comment(), approve_checkpoint(), approve_execution(), clarify_task(), create_task(), _current_user() (+42 more)

### Community 96 - "SessionMemory"
Cohesion: 0.12
...
Cohesion: 0.07
Nodes (35): analyze_quantitative(), _classify_sentiment(), _extract_keywords(), BaseModel, QualAnalysis, QualQuote, QualTheme, QuantAnalysis (+27 more)
...
Cohesion: 0.08
Nodes (36): UserRole, _can_read(), _can_write(), _decrypt(), _encrypt(), _get_master_key(), BaseModel, Enum (+28 more)

### Community 103 - "TestAListingFailureDoesNotVetoTheAnswer"
Cohesion: 0.17
...
### Community 116 - "AgentSessionStore"
Cohesion: 0.07
...
### Community 119 - "activation_api.py"
Cohesion: 0.09
...
Cohesion: 0.05
Nodes (47): _describe_http_status(), probe_model_liveness(), _probe_ollama(), _probe_openai_compat(), ProbeResult, BaseModel, services/brain_liveness.py — Provider liveness prober for the brain switcher.…, Probe an OpenAI-compatible provider (Cerebras / Groq / NIM / Z.ai / Aerolink). (+39 more)
...
### Community 123 - "FeatureMaturity"
Cohesion: 0.09
Nodes (19): __init__.py — Feature flag/matrix package., FeatureMaturity, Enum, str, features/matrix.py — Feature maturity tiers and support matrix. Single source…, Feature maturity classification., parametrize, tests/test_docs_consistency.py — structural defense against narrative drift.… (+11 more)
...
### Community 127 - "test_task_source_id_race.py"
Cohesion: 0.17
...
### Community 149 - "test_backend_server_features.py"
Cohesion: 0.06
...
Cohesion: 0.08
Nodes (38): generate_backlog_retro(), generate_standup(), Derive a retrospective from the task tracker when no sprint is active. DONE /…, Build a :class:`StandupReport` from ``.claude/state/active-tasks.md``. Reads…, _bug_scores(), _clean(), _default_repo(), _env_github_token() (+30 more)
...
### Community 159 - "test_e2b_data_flow.py"
Cohesion: 0.07
...
### Community 186 - "_resolve_user_github_token"
Cohesion: 0.11
...
### Community 188 - "test_llm_router_disabled.py"
Cohesion: 0.10
...
### Community 189 - "brain_failover.py"
Cohesion: 0.09
Nodes (33): _disabled_from_mongo(), _disabled_from_sqlite(), _is_paid_allowed_db(), _kv_connect(), _kv_path(), _mongo_db(), _mongo_enabled(), _mongo_unavailable() (+25 more)

### Community 190 - "SyncService"
Cohesion: 0.11
...
### Community 195 - "BrainFailoverManager"
Cohesion: 0.09
...
### Community 201 - "OperationalIncident"
Cohesion: 0.13
...
### Community 204 - "test_direct_chat_evolution.py"
Cohesion: 0.10
Nodes (27): DirectChatDoctor, PreflightIssue, PreflightReport, BaseModel, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, asyncio, When git is missing and no GitHub token is present, the doctor should report…, test_missing_git_and_token() (+19 more)
...
### Community 207 - "test_mcp_governance.py"
Cohesion: 0.12
...
Cohesion: 0.07
Nodes (22): compare(), main(), Any, scripts/compare_runtimes.py — head-to-head runtime comparison. Answers the…, Check an operator-supplied task file before anything executes., render(), _run_one(), RunRecord (+14 more)
...
### Community 214 - "workflow_orchestrator.py"
Cohesion: 0.09
...
### Community 215 - "report_to_markdown"
Cohesion: 0.11
...
Cohesion: 0.04
Nodes (65): agents/__init__.py — CRISPY multi-agent coding system., AgentProfile, _catalog_defaults(), _catalog_provider(), _get_defaults(), load_all_profiles(), make_architect_profile(), make_coder_profile() (+57 more)
...
### Community 219 - "openclaw_gateway.py"
Cohesion: 0.09
...
### Community 222 - "kimi_bridge_provider_config"
Cohesion: 0.18
...
### Community 226 - "test_ceo_router.py"
Cohesion: 0.09
Nodes (37): build_ceo_router(), Any, APIRouter, _env_flag(), _env_int(), services/ceo_supervisor.py — the CEO's 24x7 babysitting loop. Delegation alone…, Read a bounded int, clamping out-of-range values rather than raising., Install (or clear) the singleton — used by startup wiring and tests. (+29 more)
...
### Community 229 - "get_improvement_loop"
Cohesion: 0.06
Nodes (54): get_improvement_loop(), _dispatch_async(), _ErrorCaptureHandler, get_log_monitor(), LogMonitor, _note_recurrence(), Any, LogRecord (+46 more)
...
Cohesion: 0.06
Nodes (31): _best_cloud_primary_base(), InternalAgentAdapter, TaskResult, TaskSpec, Built-in agent loop — Nvidia NIM primary, Ollama fallback., Return runtime dependencies required by this adapter. Returns:…, Determine availability of the internal agent runtime. Checks cloud providers in…, Execute a TaskSpec using the internal AgentRunner and convert the agent's… (+23 more)

### Community 232 - "test_brain_failover_413.py"
Cohesion: 0.13
...
### Community 240 - "webui/router.py"
Cohesion: 0.14
Nodes (19): _admin_out(), AdminCommandBody, _anthropic_chat_payload(), _anthropic_text(), BrainPolicyUpdate, _provider_headers(), _provider_kind(), ProviderReorderBody (+11 more)

### Community 241 - "daily_digest.py"
Cohesion: 0.08
Nodes (29): aggregate_last_24h(), build_daily_digest(), compute_cutoff(), DigestPayload, DigestSummary, format_digest_markdown(), _md_escape(), _now_utc() (+21 more)
...
Cohesion: 0.03
Nodes (79): BrainConfigPatch, get_brain_config(), get_brain_config_store(), BaseModel, Return the process-wide ``BrainConfigStore`` singleton., Convenience wrapper used by the agent loop + brain resolver., Convenience wrapper used by the admin API endpoints., Editable subset of ``BrainConfig`` sent by PATCH /admin/api/policy/brain. All… (+71 more)

### Community 244 - "test_llm_router_e2e.py"
Cohesion: 0.14
...
### Community 246 - "session_retro.py"
Cohesion: 0.13
...
### Community 251 - "get_tool_annotations"
Cohesion: 0.08
...
### Community 254 - "CompanyAgencyService"
Cohesion: 0.09
...
Cohesion: 0.08
Nodes (11): Architecture and operations, Documentation map, Repo hygiene, Screenshots and README sync, Start here, Admin API, Config Overrides, Feature Matrix (+3 more)
...
### Community 276 - "Initiative"
Cohesion: 0.07
Nodes (17): Initiative, Create and register a new initiative, returning it., Add a pre-built Initiative (e.g. from the intelligence layer)., Look up an initiative by ID., A portfolio initiative (epic) prioritised via WSJF. WSJF (Weighted Shortest Job…, Aggregate cost of delay (CoD) used as the WSJF numerator., Weighted Shortest Job First score — higher schedules sooner., Associate an agile sprint that delivers part of this initiative. (+9 more)
...
### Community 280 - "model_router.py"
Cohesion: 0.10
Nodes (21): Dynamic model router package. Public API:: from router import get_router,…, _build_builtin_model_map(), _default_model(), _default_reasoning_model(), ModelRouter, _nvidia_key_present(), Any, Dynamic model router. Central routing logic for all chat and agent requests.… (+13 more)
...
### Community 287 - "test_agent_tool_governance.py"
Cohesion: 0.04
Nodes (73): Replace the process-wide store. Tests only., reset_approval_store(), AuditEvent, AuditLog, Any, packages/governance/audit.py — the evidence trail for every governed action.…, Redact secret-shaped substrings, then truncate., One governed action, fully described. Field order follows the… (+65 more)
...
### Community 289 - "_resolve_push_token"
Cohesion: 0.17
...
### Community 295 - "mcp_dispatch"
Cohesion: 0.16
Nodes (15): Wall-clock timer for the audit row's ``duration_ms``., Timer, _check_auth(), _err(), _handle_tool(), health(), mcp_dispatch(), _ok() (+7 more)
...
### Community 307 - "seo_portfolio_bridge.py"
Cohesion: 0.05
Nodes (46): CapacityAllocation, InitiativeStatus, Enum, Agentic Portfolio Management — initiative prioritisation, capacity allocation,…, Result of fitting initiatives into a fixed capacity by WSJF priority., Total job size of initiatives that fit within capacity., Unused capacity after committing the selected initiatives., Fraction of capacity consumed (0.0–1.0). (+38 more)
...
### Community 310 - "test_skill_executors_live.py"
Cohesion: 0.16
...
### Community 317 - "test_governance_enforcement.py"
Cohesion: 0.03
Nodes (84): ApprovalRequest, ApprovalStatus, ApprovalStore, Any, Enum, str, packages/governance/approvals.py — human-in-the-loop for high-risk actions. The…, Bounded, in-process store of approval requests. Uses a :class:`threading.Lock`… (+76 more)
...
### Community 320 - "get_scheduler"
Cohesion: 0.04
Nodes (47): legacy_scheduler_get(), get_store(), Return the active store singleton, creating it on first call., apply_from_db(), Load the stored overrides and apply them. Called once at startup., get_scheduler(), agent/scheduler.py — Scheduled Agent Jobs Cron-based job scheduler. Each job…, set_scheduler() (+39 more)
...
### Community 322 - "classify_direct_chat_intent"
Cohesion: 0.13
...
### Community 324 - "WorkspaceManager"
Cohesion: 0.20
...
### Community 333 - "TestAdapterMetadata"
Cohesion: 0.04
Nodes (26): AiderAdapter, Any, Adapter for Aider — TIER 3 specialized git-aware code editor., _env_float(), HermesAdapter, Any, AsyncClient, Response (+18 more)
...
### Community 338 - "tests/conftest.py"
Cohesion: 0.10
...
### Community 345 - "OrchestratorSupervisor"
Cohesion: 0.10
Nodes (16): Return orchestrator queue depth, active runs, and supervisor state (#522)., workflow_orchestrator_status(), get_orchestrator_queue(), get_orchestrator_supervisor(), OrchestratorSupervisor, Any, services/orchestrator_supervisor.py — Deterministic Supervisor Issue #522: A…, Emit an alert to the activity feed and log. (+8 more)
...
### Community 353 - "settings.py"
Cohesion: 0.07
Nodes (31): ChatResponse, Cerebras provider adapter — free, fast LLM (qwen-3-coder-480b)., Groq provider adapter — free, fast LLM (deepseek-r1-distill-llama-70b)., NVIDIA NIM provider adapter — wraps the existing provider_router logic. This is…, Ollama provider adapter — local LLM inference., packages.ai — provider abstraction, model registry, and failover manager., ProviderManager, Any (+23 more)
...
### Community 363 - "test_issue_triage.py"
Cohesion: 0.17
...
### Community 368 - "open_phase_report"
Cohesion: 0.10
...
### Community 369 - "test_direct_chat_async.py"
Cohesion: 0.12
Nodes (20): make_isolated_workspace(), Path, Create an isolated workspace directory under *root*. This is the legacy path…, _workspace_component(), runner(), _fake_user(), _FakeChatResult, _FakeResponse (+12 more)

### Community 370 - "resolve_active_brain"
Cohesion: 0.04
Nodes (89): allow_paid_brain(), BrainResolution, provider_api_key(), Return the live API key for *provider* (env-only — never persisted)., get_active_brain_sync(), get_brain_preference(), get_provider_role_tags(), _host_is_openai_compatible() (+81 more)

### Community 371 - "test_agent_free_brain.py"
Cohesion: 0.10
...
Cohesion: 0.07
Nodes (14): AdminAuthManager, AdminIdentity, AdminSession, AdminSessionStore, _is_truthy(), admin_auth.py — auto-generated module docstring (user-research skill scan)., WindowsCredentialAuthenticator, admin_update_user() (+6 more)
...
### Community 383 - "get_feature_matrix"
Cohesion: 0.11
...
### Community 388 - "test_chat_mode_regressions.py"
Cohesion: 0.19
...
### Community 391 - "test_one_model_catalogue.py"
Cohesion: 0.09
...
### Community 392 - "TaskHarnessAdapter"
Cohesion: 0.12
Nodes (11): Any, TaskResult, TaskSpec, Adapter for a compatible external task harness., TaskHarnessAdapter, Tests for _start_local_runtime safety guards in runtimes/control.py., task_harness (no _base_url) must not spawn agent_runtime.py., If agent_runtime.py exits immediately, _base_url must NOT be set. (+3 more)
...
### Community 400 - "_plan"
Cohesion: 0.10
Nodes (14): _plan(), parametrize, Path, A plan that says "do not build this" must stop the thing that builds. On…, The real thing, reconstructed from the merged plan.…, An unreadable plan is not an approved plan., No planning pass ran at all — there is no decision to honour., A multi-line value corrupts every later key in $GITHUB_OUTPUT. (+6 more)
...
### Community 407 - "Any"
Cohesion: 0.10
Nodes (14): _as_list(), GroupPolicy, Any, Path, Coerce a YAML scalar-or-list field into a list of strings. Operators write…, The resolved rules for one policy group, after ``extends`` flattening., Reload from *path*. Returns True when the file was applied., Flatten ``extends`` chains and index rules for O(1) surface lookup. (+6 more)
...
### Community 416 - "asyncio"
Cohesion: 0.12
Nodes (13): asyncio, Test Company Graph services., Test that storage service can be initialized., Test company CRUD operations - skipped as requires specific config., Test specialist service., Test that specialist service can be initialized., Test onboarding service., Test that onboarding service can be initialized. (+5 more)
...
Cohesion: 0.03
Nodes (79): Backoff policy for retryable failures., RetryConfig, BreakerState, str, _digest(), get_ring(), KeyRing, KeyState (+71 more)
...
### Community 427 - "company_api.py"
Cohesion: 0.02
Nodes (186): account_lifecycle(), auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint(), generate_onboarding_questions(), get_company(), get_company_access() (+178 more)

### Community 428 - "TestStreamableHTTPTransport"
Cohesion: 0.13
...
### Community 431 - "test_phase4_runtime_resilience.py"
Cohesion: 0.11
...
### Community 437 - "services/background.py"
Cohesion: 0.04
Nodes (73): get_skill_registry_safe(), Return the global SkillRegistry if set, else None. Used by onboarding and other…, backend/ceo_router.py — observability and manual control for the CEO. Surfaces…, _await_hermes_ready(), BackgroundServices, _env_float(), _env_on(), _hydrate_scheduler_bounded() (+65 more)

### Community 438 - "SeoAuditReport"
Cohesion: 0.24
...
### Community 447 - "agents/agile_ceremonies.py"
Cohesion: 0.09
Nodes (25): _bullets(), generate_sprint_retro(), plan_next_sprint(), Agentic Agile — autonomous ceremonies (standup, retro, sprint planning). Where…, Render a :class:`Retrospective` as a markdown section., Derive retro notes for ``sprint`` from its current metrics. Records…, The result of allocating portfolio capacity into a new sprint., Render the sprint plan as markdown. (+17 more)
...
### Community 483 - "sam_livekit_worker.py"
Cohesion: 0.13
...
### Community 490 - "test_cerebras_catalogue.py"
Cohesion: 0.13
...
### Community 492 - "test_phase6_workflow.py"
Cohesion: 0.05
...
### Community 499 - "get"
Cohesion: 0.02
Nodes (92): auth_me(), auto_recommend_skills(), brain_failover_status(), brain_providers(), _check_storage_health(), cost_attribution_stats(), discover_remote_skills(), doctor_health() (+84 more)
...
### Community 514 - "reap_expired_companies"
Cohesion: 0.16
Nodes (18): _as_aware_utc(), _env_float(), datetime, services/ephemeral_reaper.py — destroy expired ephemeral companies. The…, Treat naive datetimes as UTC so comparisons never raise., Delete all expired ephemeral companies. Returns the number deleted. A company…, Parse a positive, finite float env var (seconds), else the default. Rejects…, reap_expired_companies() (+10 more)

### Community 515 - "AGENTS.md — Codebase Map & Operations Reference"
Cohesion: 0.17
...
Cohesion: 0.07
Nodes (27): A sample of what the agents shipped (all merged, all real), The numbers (verifiable via the GitHub API), This repository is maintained by its own agents, Why this matters if you're evaluating the platform, Delegation Plan (agent-ready work packages), Findings, http://127.0.0.1:8899/, Page Details (worst first) (+19 more)
...
### Community 524 - "get_tool_registry"
Cohesion: 0.12
Nodes (19): browse_page(), Open *url* in a real browser, return its rendered text, and close. Fail-soft:…, get_tool_registry(), Return the module-level ToolRegistry singleton. On first call, registers built-…, Register the built-in agent tools that are always available., Register the interactive-browser capability (agent/browser.py). Unlike…, Register the Web Reach capability (agent/web_reach.py): zero-key internet…, _register_browser_tools() (+11 more)
...
### Community 526 - "SeoCheckDefinition"
Cohesion: 0.12
...
### Community 529 - "tasks/models.py"
Cohesion: 0.07
Nodes (37): Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., tasks — Task/issue management system. Provides a lightweight task/issue tracker…, ApprovalCheckpoint, ApprovalRequest, ClarifyRequest, _coerce_ts(), CommentAddRequest (+29 more)
...
### Community 537 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 538 - "test_freebuff_bot.py"
Cohesion: 0.12
...
Cohesion: 0.07
Nodes (37): clear_cooldowns(), get_dead_models(), _is_model_dead(), is_provider_on_cooldown(), mark_provider_failed(), Snapshot of active dead-model entries {provider_id/model: expiry_ts}. Also…, Put provider_id on cooldown for *cooldown_seconds* (default:…, Return True if provider_id is currently on cooldown. (+29 more)
...
### Community 544 - "Feature Maturity / Support Matrix"
Cohesion: 0.12
...
### Community 545 - "JsonConfigStore"
Cohesion: 0.16
Nodes (16): _load_rich_policy(), Return the persisted rich UI policy (pools + policy + triggers), or {}., _fake_user_auth(), Path, test_admin_can_create_anthropic_provider_via_webui_admin_api(), test_admin_can_create_provider_via_webui_admin_api(), test_ui_providers_and_workspaces_use_app_state(), _atomic_write_json() (+8 more)
...
### Community 560 - "trend_watcher.py"
Cohesion: 0.14
Nodes (17): get_trend_watcher(), agent/trend_watcher.py — Internet-connected AI trend intelligence. Fetches from…, set_trend_watcher(), Tests for trend_analysis.py — last30days-style window over TrendWatcher (issue…, TestRunTrendAnalysis, TestWindow, test_singleton_round_trip(), BaseModel (+9 more)
...
### Community 568 - "DockerAgentAdapter"
Cohesion: 0.17
...
### Community 581 - "get_user_role"
Cohesion: 0.11
Nodes (27): _get_github_token_for_user(), Fetch GitHub token for user from secrets store or environment., get_user_role(), Extract role from a user object (dict or Pydantic model)., create_secret(), delete_secret(), get_secret_metadata(), get_secrets_store() (+19 more)
...
### Community 583 - "NotificationDispatcher"
Cohesion: 0.04
Nodes (55): NotificationDispatcher, Any, Path, service_manager.py — Telegram & Notification Integration Extension Extends the…, Start the Telegram bot. Returns True if started successfully., Signal the bot to stop and wait for graceful shutdown., Run the Telegram bot long-poll loop (inline, not subprocess)., Run the bot with stop-event awareness. (+47 more)
...
### Community 585 - "agent/workspace.py"
Cohesion: 0.05
...
### Community 604 - "TestAuthAndTaskOwnership"
Cohesion: 0.05
...
### Community 605 - "resolve_free_nvidia_brain"
Cohesion: 0.12
...
Cohesion: 0.03
Nodes (47): Company, CompanyGraphSnapshot, The core company entity - root of the Company Graph., A point-in-time snapshot of a Company Graph for history and rollback., requires_db, CompanyGraphStore, Delete a company and all its associated data., List companies with optional filtering. (+39 more)
...
### Community 611 - "provider_max_rpm"
Cohesion: 0.08
...
### Community 612 - "test_minimax_bug_fixes.py"
Cohesion: 0.13
...
### Community 639 - "test_daily_automation_2026_07_11.py"
Cohesion: 0.15
...
### Community 646 - "PerformanceAnalytics"
Cohesion: 0.12
...
### Community 648 - "test_tasks_reconciler_todo_requeue.py"
Cohesion: 0.18
...
### Community 650 - "TestAgentRunnerSafety"
Cohesion: 0.19
...
### Community 653 - "context_plan_gate.py"
Cohesion: 0.16
...
### Community 668 - "Slice"
Cohesion: 0.07
Nodes (19): Execute a slice via the Coder agent (write-permitted)., Review a slice via the Reviewer agent (different model from Coder). This is the…, Run verification commands via the Verifier agent. The Verifier is execution-…, Return a copy of *routing* with the profile's model injected for its role., Return the AgentProfile for *role*, raising KeyError if unknown., WorkflowRun, tests/test_workflow_models.py — Unit tests for workflow/models.py., TestApprovalGate (+11 more)

### Community 669 - "_looks_unknown_model"
Cohesion: 0.20
...
### Community 686 - "get_public_doctor_report"
Cohesion: 0.14
Nodes (15): AccountLifecycleResponse, _DoctorCheck, _DoctorReport, get_public_doctor_report(), OnboardingAnswersRequest, OnboardingQuestionsRequest, BaseModel, Request to generate AI-tailored onboarding questions. (+7 more)

### Community 687 - "test_event_log.py"
Cohesion: 0.45
...
### Community 690 - "router/health.py"
Cohesion: 0.20
...
### Community 695 - "Workspace Isolation Architecture"
Cohesion: 0.17
...
### Community 704 - "test_task_service_failed_comment.py"
Cohesion: 0.18
...
### Community 705 - "test_daily_automation_2026_07_09.py"
Cohesion: 0.16
...
### Community 724 - "_extract_pytest_failure"
Cohesion: 0.42
...
### Community 726 - "test_schedule_persistence.py"
Cohesion: 0.16
...
### Community 758 - "lifespan"
Cohesion: 0.06
Nodes (31): _keepalive_self_ping(), lifespan(), Run the FreeBuff Telegram bot, restarting it on unexpected exit., Ping our own public URL so a free-tier web service doesn't sleep. Render free…, Start the Telegram bot (and keep-alive) inside the web process when enabled.…, #522 + #505: Reliability startup — schedule hydration, orchestrator restore,…, _start_in_web_bot_tasks(), _startup_reliability_hooks() (+23 more)

### Community 759 - "analyze_qualitative"
Cohesion: 0.25
...
### Community 761 - "ExecutionRequest"
Cohesion: 0.06
...
### Community 766 - "TestPolicyAuthoringUiStableClaim"
Cohesion: 0.25
...
### Community 785 - "strategies.py"
Cohesion: 0.04
Nodes (61): count, Enum, packages/llm/health.py — provider health tracking and circuit breaking. Two…, Test hook — clear all health state., reset(), adaptive(), automatic_failover(), context_length_optimized() (+53 more)

### Community 786 - "test_ai_insights.py"
Cohesion: 0.20
...
### Community 787 - "summarise_phases"
Cohesion: 0.15
Nodes (12): Any, Live counters, for the diagnostics endpoint and tests., Find agent phases that started but never finished.…, Run *coro* without blocking the caller, from any thread. The caller is a…, _schedule(), summarise_phases(), `_timed_phase` (#1218) brackets each call; a start with no end is the hang., Phases nest, so a stuck inner call leaves its wrapper unfinished too. Ranking… (+4 more)

### Community 788 - "register_user_research_tools"
Cohesion: 0.21
Nodes (7): auto_register(), Any, field_validator, Register the four user-research tools with a ``ToolRegistry``. Each tool wraps…, Register the user research tools into the module-level singleton registry.…, register_user_research_tools(), TestRegistration
...
### Community 794 - "TestNoNvidiaFallbackIsRetired"
Cohesion: 0.22
...
### Community 795 - "Agent Autonomy Roadmap"
Cohesion: 0.25
...
Cohesion: 0.18
Nodes (11): Agent and workflow surfaces, API Surfaces and Route Map, Built-in admin and web UI, Control-plane style routers mounted in the proxy, Governance (`/api/governance/*`, admin-only), Main proxy (`proxy.py`), Ollama-compatible, OpenAI-compatible (+3 more)
...
### Community 829 - "test_task_clarification.py"
Cohesion: 0.17
...
### Community 832 - "test_brain_default_consistency.py"
Cohesion: 0.24
...
### Community 835 - "_is_bedrock_model_id"
Cohesion: 0.27
...
### Community 891 - "TestRouterIntegration"
Cohesion: 0.31
...
### Community 905 - "capture_screens.py"
Cohesion: 0.29
...
### Community 907 - "model_discovery.py"
Cohesion: 0.10
...
### Community 911 - "TestRuntimeControl"
Cohesion: 0.15
...
### Community 916 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 921 - "test_nvidia_default_model.py"
Cohesion: 0.17
...
### Community 947 - "RuntimeHealthService"
Cohesion: 0.16
...
### Community 953 - "security_fix_agent.py"
Cohesion: 0.57
...
### Community 961 - "resolve_hermes_base_url"
Cohesion: 0.47
...
### Community 962 - "TestSupportMatrixDocsSync"
Cohesion: 0.29
...
### Community 963 - "ENGINEERING_STANDARDS.md — Patterns & Reference"
Cohesion: 0.22
...
### Community 986 - "test_doctor_coding_brain.py"
Cohesion: 0.38
...
Cohesion: 0.02
Nodes (225): Reject non-admin callers for routes that spend provider budget. Delegates to…, _require_admin(), _is_admin(), Check if a user has admin role. Works for both social_auth users (role in…, admin_seed(), _agent_timeout_fallback_response(), AgentStatusEntry, AgentStatusResponse (+217 more)
...
### Community 1001 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.25
...
### Community 1025 - "test_agency_workflows_carry_the_failover_chain.py"
Cohesion: 0.18
...
### Community 1043 - "AnthropicProvider"
Cohesion: 0.06
Nodes (29): AnthropicProvider, Any, AsyncClient, Translate OpenAI-shaped messages into Anthropic's system/turn split., OpenAI carries a tool result as role="tool" with a tool_call_id; Anthropic…, OpenAI puts a tool call alongside the assistant's text; Anthropic needs…, Anthropic's extended-thinking constraints on ``budget_tokens``: at least 1024,…, Return a system-prompt instruction that enforces JSON output. Anthropic's… (+21 more)
...
### Community 1053 - "Agent Readiness Report"
Cohesion: 0.20
...
### Community 1068 - "Artifact"
Cohesion: 0.08
Nodes (28): AgentRole, Run a pre-gate or report phase through the correct agent. Enforces permission…, When coder == reviewer model, swarm should log a warning., _fake_artifact(), tests/test_crispy_workflow.py — CRISPY workflow engine hardening tests. Tests…, TestPhaseSequenceError, workflow/artifact_store.py — Durable artifact persistence. Artifacts are stored…, Artifact (+20 more)

### Community 1069 - "github"
Cohesion: 0.50
Nodes (3): github, enabled, silent

### Community 1113 - "_is_ephemeral_user"
Cohesion: 0.27
...
### Community 1141 - "apply_overrides"
Cohesion: 0.22
...
### Community 1142 - "FeatureUnavailableError"
Cohesion: 0.18
Nodes (4): FeatureUnavailableError, Exception, Raised when code attempts to use a feature that is disabled or unavailable., TestEnforcement

### Community 1195 - "flesch_reading_ease"
Cohesion: 0.20
...
### Community 1200 - "features/api.py"
Cohesion: 0.24
...
### Community 1201 - "TestGithubSignalHardening"
Cohesion: 0.22
...
### Community 1202 - "TestPaidPolicyDurability"
Cohesion: 0.22
...
### Community 1203 - "Issue #1356: quick-note:https://searchengineland.com/turn-seo-backlog-into-roadmap-485713"
Cohesion: 0.22
...
### Community 1204 - "test_google_provider_models.py"
Cohesion: 0.18
...
### Community 1205 - "._check_permissions"
Cohesion: 0.29
...
### Community 1208 - "TestPoliciesGovernanceStableClaim"
Cohesion: 0.20
...
### Community 1211 - "local_brain_provider_config"
Cohesion: 0.29
...
### Community 1212 - "_brain_provider_status"
Cohesion: 0.33
...
### Community 1214 - "_execute_skill_impl"
Cohesion: 0.13
...
### Community 1216 - "TestModelsEndpointAliases"
Cohesion: 0.31
...
### Community 1219 - "OpenHandsAdapter"
Cohesion: 0.24
...
### Community 1223 - "TestRunCoroSync"
Cohesion: 0.29
...
### Community 1230 - "Workspace Issues"
Cohesion: 0.29
...
### Community 1232 - "InitiativeProgress"
Cohesion: 0.33
...
### Community 1233 - "Model and Response Issues"
Cohesion: 0.29
...
### Community 1234 - "_build_direct_chat_schedule_suggestion"
Cohesion: 0.32
...
### Community 1235 - "TestItIsNotBuiltForOneVendor"
Cohesion: 0.25
...
### Community 1241 - "test_seo_audit_pending_expiry.py"
Cohesion: 0.43
...
### Community 1242 - "test_autonomous_agency_e2e.py"
Cohesion: 0.05
Nodes (39): AgencyCycleResult, AgentDirective, AgentRole, _build_ceo_prompt(), _build_quick_note_instruction(), _close_github_issue(), _collect_recent_git_context(), _fetch_github_quick_notes() (+31 more)

### Community 1243 - "Admin Dashboard Issues"
Cohesion: 0.40
...
### Community 1245 - "Agent API Issues"
Cohesion: 0.40
...
### Community 1246 - "Network and Tunnel Issues"
Cohesion: 0.40
...
### Community 1248 - "TestDirectChatNonBlocking"
Cohesion: 0.40
...
### Community 1249 - "operational_incidents.py"
Cohesion: 0.13
...
### Community 1256 - "Claude Code Specific Issues"
Cohesion: 0.50
...
### Community 1259 - "platform_controls_router.py"
Cohesion: 0.29
...
### Community 1260 - "test_the_reserve_is_bounded_when_read_from_the_environment"
Cohesion: 0.67
...
### Community 1263 - "TestAgentRunnerExecution"
Cohesion: 0.33
...
### Community 1264 - "TestDirectChatAgentExecution"
Cohesion: 0.33
...
### Community 1265 - "TestWorkflowIntegration"
Cohesion: 0.33
...
### Community 1266 - "test_catalogue_probe.py"
Cohesion: 0.33
...
### Community 1267 - "_normalize_dockerfile"
Cohesion: 0.33
...
### Community 1268 - "TestNoKeyEverReachesTheLog"
Cohesion: 0.40
...
### Community 1269 - "TestTheProbeIdentifiesItself"
Cohesion: 0.40
...
## Knowledge Gaps
- **3426 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3421 more)
...
- **Why does `_fixture()` connect `_fixture` to `reap_expired_companies`, `test_llm_router_queue_cache.py`, `CEOLedger`, `test_company_api.py`, `brain_config.py`, `test_langfuse_agency_wide.py`, `PolicyDecision`, `validate_policy_text`, `resolve_identity`, `SelfHealingAgent`, `llm/router.py`, `test_provider_state_durability.py`, `PrimeAgentAdapter`, `clear_cooldowns`, `test_monitor_lib.py`, `test_openclaw_endpoints.py`, `TaskWorkflowService`, `test_unit8_model_catalog.py`, `Task`, `ImprovementLoop`, `test_model_router.py`, `test_llm_router_strategies.py`, `test_failover_client_shared.py`, `BudgetTracker`, `TaskStore`, `test_process_quick_note_workflow.py`, `test_iteration_6_features.py`, `SQLiteStore`, `ChatHistoryStore`, `E2BSandboxSession`, `test_telegram_auto_approve.py`, `test_autonomy_status.py`, `ai/router.py`, `get_task_store`, `test_local_brain_state.py`, `NotificationDispatcher`, `test_phase5_doctor.py`, `test_refresh_agent_built_proof.py`, `services/seo_audit.py`, `test_telegram_diag_endpoint.py`, `config.py`, `ResearchTask`, `failover_client.py`, `TestClient`, `resolve_e2b_config`, `test_procedural_memory.py`, `TestAuthAndTaskOwnership`, `e2e/test_browser.py`, `provider_max_rpm`, `UserRole`, `SchedulerStore`, `test_knowledge_sync.py`, `test_startup_warmup.py`, `SeoFixer`, `KeyStore`, `claim`, `test_context_rulebook.py`, `ArtifactStore`, `run_task`, `test_webui_provider_priority.py`, `test_issue_intake.py`, `test_tasks_reconciler_todo_requeue.py`, `test_openclaw_gateway.py`, `TestAgentRunnerSafety`, `test_trend_scoping.py`, `BackgroundAgent`, `TestHarnessAdapter`, `MCPClient`, `_step`, `test_new_features_e2e.py`, `persist_plan_spec`, `TestEstimateTokensForMessages`, `test_e2b_data_flow.py`, `_Budget`, `TestSwarmRoleRouting`, `._check_permissions`, `OllamaCircuitBreaker`, `analyze_page`, `_resolve_user_github_token`, `TestMongoGate`, `test_llm_router_disabled.py`, `test_features_api.py`, `test_task_service_failed_comment.py`, `test_daily_automation_2026_07_09.py`, `test_video_transcript.py`, `TrendWatcher`, `WorkflowRun`, `test_direct_chat_evolution.py`, `emit_chat_observation`, `UsageEvent`, `_undeclared`, `test_agile_api.py`, `test_app_settings.py`, `test_agent_scripts_share_one_model_list.py`, `test_portfolio_intake.py`, `test_trend_watcher.py`, `AgentSwarm`, `test_nvidia_model_discovery.py`, `operational_incidents.py`, `test_ceo_router.py`, `TestClient`, `get_improvement_loop`, `test_brain_failover_413.py`, `TestTheWorkflowIsSafeAndReadOnly`, `ContextPruner`, `test_catalogue_probe.py`, `BrainWatchdog`, `test_llm_router_e2e.py`, `session_retro.py`, `ExecutionRequest`, `test_telegram_task_callback.py`, `test_persistent_memory.py`, `SecurityScanner`, `WorkflowBuildRequest`, `OutputFilter`, `test_platform_controls.py`, `strategies.py`, `test_scheduler_hydration_bounded.py`, `test_rate_limiter.py`, `test_agent_tool_governance.py`, `test_brain_failover.py`, `_resolve_push_token`, `test_sam_voice.py`, `OrchestratorCheckpointStore`, `OrchestratorQueue`, `clear_override`, `test_purge_backlog.py`, `cost_tracker.py`, `test_task_clarification.py`, `_resolve_brain_provider`, `get_scheduler`, `test_kimi_bridge_server.py`, `.record`, `tests/conftest.py`, `test_crispy_burn_in.py`, `test_provider_enable_disable.py`, `test_skill_registry_boot_refresh.py`, `isolated_telegram_config`, `test_direct_chat_async.py`, `test_agent_free_brain.py`, `test_claude_code_adapter.py`, `get_feature_matrix`, `test_service_token.py`, `test_brain_patch_service_token.py`, `test_harness_spec.py`, `test_ping.py`, `capture_screens.py`, `test_dashboard_cache.py`, `model_discovery.py`, `TestRuntimeControl`, `test_regression.py`, `test_agency_fix.py`, `test_telegram_mutating_commands.py`, `test_llm_router_resilience.py`, `_get`, `test_v4_api.py`, `company_api.py`, `apply_review.py`, `client`, `services/background.py`, `api_keys_for`, `test_voice_pipeline.py`, `_job_text`, `test_doctor_coding_brain.py`, `TestNormalizeResponseFormat`, `test_task_store_fails_loud_in_production.py`, `test_runtimes_health_endpoint.py`, `test_sam_livekit.py`?**
  _High betweenness centrality (0.099) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `proxy.py`, `UserMemoryStore`, `TaskSpec`, `TestAgentRunnerSafety`, `ReactScratchpad`, `resolve_identity`, `CEODispatcher`, `BackgroundAgent`, `test_backend_server_features.py`, `ContextManager`, `MCPClient`, `AgentPlan`, `loop.py`, `test_agent_tool_governance.py`, `_resolve_push_token`, `MultiAgentSwarm`, `test_failover_client_shared.py`, `StuckDetector`, `WorkspaceTools`, `test_governance_api.py`, `E2BSandboxSession`, `test_empirical_verify.py`, `test_daily_automation_2026_07_09.py`, `WorkflowRun`, `LocalWorkspace`, `resolve_e2b_config`, `workflow_orchestrator.py`, `test_autonomous_agency_e2e.py`, `TokenBudget`, `backend/server.py`, `InternalAgentAdapter`, `test_brain_failover_413.py`, `GitHubTools`, `AdaptiveHalter`, `ContextPruner`, `TestAgentRunnerExecution`, `direct_chat.py`, `test_direct_chat_async.py`, `test_agent_free_brain.py`, `AgentSessionStore`, `FreeBuffAgent`, `test_daily_automation_2026_07_11.py`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderRouter` to `test_all_providers_discovery.py`, `ProviderConfig`, `test_bedrock_provider.py`, `test_anthropic_router.py`, `test_colibri_provider.py`, `implement_agent.py`, `clear_cooldowns`, `TestAnthropicPayloadStructuredOutput`, `ai/router.py`, `NvidiaProvider`, `TestOpenAiToBedrockConverse`, `failover_client.py`, `kimi_bridge_provider_config`, `TrafficDirector`, `settings.py`, `backend/server.py`, `direct_chat.py`, `resolve_active_brain`, `test_bedrock_live.py`, `TestRouterIntegration`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Are the 213 inferred relationships involving `HTTPException` (e.g. with `activate_instance()` and `change_user_role()`) actually correct?**
  _`HTTPException` has 213 INFERRED edges - model-reasoned connections that need verification._
