# Graph Report - autonomous-ai-agency  (2026-09-03)

## Corpus Check
- 1469 files · ~2,142,543 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 29936 nodes · 55482 edges · 1280 communities (1113 shown, 112 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 2709 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `747ba4df`
...
1. `_fixture()` - 306 edges
2. `AgentRunner` - 191 edges
3. `Task` - 159 edges
4. `ProviderRouter` - 137 edges
5. `TaskStore` - 124 edges
6. `LLMRequest` - 120 edges
7. `ProviderConfig` - 101 edges
8. `FeatureMatrix` - 99 edges
9. `get_db()` - 89 edges
...
## Communities (1280 total, 112 thin omitted)

### Community 0 - "test_ceo_router.py"
Cohesion: 0.05
Nodes (53): build_ceo_router(), Any, APIRouter, _backend(), CEOLedger, get_ceo_ledger(), GoalRecord, _now() (+45 more)

### Community 1 - "llm/router.py"
Cohesion: 0.03
Nodes (90): _load(), main(), int, failover_chat_completion_via_router(), openai_body_from_response(), Any, packages/llm/compat.py — backwards-compatible bridges to the legacy call paths.…, Router-backed implementation of ``packages.ai.failover_client``'s entry point.… (+82 more)

### Community 2 - "ExecutionRequest"
Cohesion: 0.03
Nodes (80): Called by APScheduler when a cron fires. Dispatches to the orchestrator. This…, _scheduler_on_fire(), stop_orchestrator_supervisor(), ExecutionRequest, get_workflow_orchestrator(), Exception, Approve a run paused at the ApprovalGate. The caller must re-invoke…, Inject additional instructions into an in-flight run (no state change). Backs… (+72 more)

### Community 3 - "ProviderConfig"
Cohesion: 0.05
Nodes (64): _acquire_provider_probe(), _dead_model_key(), _exponential_backoff_cooldown(), _get_director(), is_commercial_provider(), _mark_model_dead(), _normalized_provider_type(), _notify_watchdog() (+56 more)

### Community 4 - "backend/server.py"
Cohesion: 0.02
Nodes (217): backend/ceo_router.py — observability and manual control for the CEO. Surfaces…, Reject non-admin callers for routes that spend provider budget. Delegates to…, _require_admin(), _is_admin(), Check if a user has admin role. Works for both social_auth users (role in…, admin_seed(), AgentStatusEntry, AgentStatusResponse (+209 more)

### Community 5 - "proxy.py"
Cohesion: 0.03
Nodes (178): get_skill_registry_safe(), Return the global SkillRegistry if set, else None. Used by onboarding and other…, check_ollama_async(), Attempt a named one-click fix., Async Ollama reachability check — non-blocking for FastAPI handlers., run_fix(), middleware, AdminIdentity (+170 more)

### Community 6 - "AnthropicProvider"
Cohesion: 0.04
Nodes (54): AnthropicProvider, Any, AsyncClient, packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, Translate OpenAI-shaped messages into Anthropic's system/turn split., OpenAI carries a tool result as role="tool" with a tool_call_id; Anthropic…, OpenAI puts a tool call alongside the assistant's text; Anthropic needs…, Return the cache_control block appropriate for this provider's TTL setting.… (+46 more)

### Community 7 - "TaskSpec"
Cohesion: 0.02
Nodes (123): kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, AiderAdapter, Any, TaskResult, TaskSpec, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Run aider non-interactively via `--message` flag. (+115 more)

### Community 8 - "PolicyEngine"
Cohesion: 0.04
Nodes (89): _egress_policy_reason(), agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Return why governance policy blocks *host*, or None. Runs strictly *after* the…, _action_matches(), _as_list(), Decision, GroupPolicy, _host_matches() (+81 more)
...
Cohesion: 0.02
Nodes (135): Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., tasks — Task/issue management system. Provides a lightweight task/issue tracker…, Enum, str, tasks/models.py — Pydantic models for the task/issue system., Comment or reply on a task., TaskComment (+127 more)

### Community 11 - "SQLiteStore"
Cohesion: 0.02
Nodes (121): CompanyGraph, KnowledgeItem, The complete Company Graph - canonical core model for the Autonomous AI Agency.…, Find a website by its URL., Find a repository by its URL., Find a workflow by its name., Find knowledge items matching any of the given tags., Structured knowledge about the company, systems, or processes. (+113 more)

### Community 12 - "models/company_graph.py"
Cohesion: 0.04
Nodes (90): ApprovalPolicy, BusinessSystem, CompanyCreateRequest, CompanyGraphResponse, CompanyResponse, CompanyUpdateRequest, Connector, DetectedSystem (+82 more)

### Community 13 - "brain_config.py"
Cohesion: 0.03
Nodes (113): Call-time resolver for an agent role model id. Delegates to…, _resolve_role_model(), _active_primary_provider(), BrainConfig, BrainConfigPatch, BrainConfigStore, default_brain_config(), get_brain_config() (+105 more)

### Community 14 - "TaskWorkflowService"
Cohesion: 0.03
Nodes (83): AgentCreateRequest, AgentDefinition, AgentStore, AgentUpdateRequest, Any, BaseModel, field_validator, agents/store.py — Persistent store for user-defined agent configurations.… (+75 more)

### Community 15 - "test_llm_router_strategies.py"
Cohesion: 0.05
Nodes (81): count, Strategy selection and degradation behaviour., RoutingConfig, Build and order the (provider, model) pairs that can serve ``request``., Cap the breadth of one request's search so a failure is bounded., The input ceiling this candidate will actually accept. A context window is not…, adaptive(), automatic_failover() (+73 more)
...
### Community 17 - "get_db"
Cohesion: 0.03
Nodes (101): auth_me(), auto_recommend_skills(), _check_storage_health(), cost_attribution_stats(), delete_github_token(), delete_source(), discover_remote_skills(), doctor_health() (+93 more)

### Community 18 - "LLMRequest"
Cohesion: 0.03
Nodes (110): ProviderConfig, One configured endpoint. ``kind`` selects the adapter: ``openai`` (any OpenAI-…, OpenAICompatible, Any, AsyncClient, Perform one completion. Raises ``PermanentError``/``TransientError``., Yield normalised chunks for one streaming completion., Cheap liveness probe. Never raises — returns a status dict. (+102 more)

### Community 19 - "_fixture"
Cohesion: 0.02
Nodes (85): app_client(), _clear_discovered_models(), _clear_response_cache(), client(), _isolate_brain_data_layer(), _isolate_operator_provider_state(), non_admin_client(), MonkeyPatch (+77 more)
...
Cohesion: 0.05
Nodes (105): Semaphore, services/ceo_dispatcher.py — Real CEO delegation layer. The CEO splits a…, Split the request into briefed, tier-assigned specialist sub-tasks. Returns the…, Run one sub-task, judge the result, and escalate it if it is slop. The loop is…, build_subtask_brief(), _coerce_subtasks(), decompose(), _env_flag() (+97 more)

### Community 22 - "get_agent_store"
Cohesion: 0.09
Nodes (35): get_agent_store(), autonomy_status(), Public autonomy readiness probe — no authentication required. A live deploy…, Fire-and-forget self-bootstrap; never blocks or crashes startup., _schedule_self_bootstrap(), _count_specialists(), _create_company_directly(), ensure_self_company() (+27 more)

### Community 23 - "Task"
Cohesion: 0.03
Nodes (77): _coerce_ts(), ExecutionLogEntry, Any, field_validator, Full task/issue document., Update the updated_at timestamp., Coerce ISO-8601 datetime strings (from DB) to float timestamps., Single entry in a task's execution log. (+69 more)

### Community 24 - "AgentJobManager"
Cohesion: 0.05
...
Cohesion: 0.06
Nodes (22): requires_db, asyncio, Test Company Graph services., Test that storage service can be initialized., Test company CRUD operations - skipped as requires specific config., Test specialist service., Test that specialist service can be initialized., Test onboarding service. (+14 more)

### Community 26 - "test_render_mcp.py"
Cohesion: 0.08
...
### Community 27 - "AgentSessionStore"
Cohesion: 0.05
Nodes (55): Agent subsystem — planner / executor / verifier loop., AgentEvent, AgentPlan, AgentRunRequest, AgentSession, AgentSessionCreateRequest, AgentSessionMessage, AgentStep (+47 more)

### Community 28 - "test_user_research_skill.py"
Cohesion: 0.05
Nodes (48): get_tool_registry(), Return the module-level ToolRegistry singleton. On first call, registers built-…, analyze_qualitative(), auto_register(), _classify_sentiment(), _extract_keywords(), plan_research(), Any (+40 more)

### Community 29 - "test_unit8_model_catalog.py"
Cohesion: 0.04
Nodes (74): all_provider_ids(), _provider_ids_from_literal(), provider_key_present(), Return every provider id recognised by the brain config system. Iterates the…, True when the env var for *provider*'s key is set (or it's Ollama)., Return the provider ids allowed by the ``BrainProvider`` Literal. Reads the…, CatalogActiveBrain, CatalogMirror (+66 more)

### Community 30 - "test_governance_enforcement.py"
Cohesion: 0.04
Nodes (87): BudgetTracker, classify(), GovernanceGate, _host_of(), Extract a hostname from a URL, or return a bare host unchanged., Per-session consumption counters and their ceilings. Ceilings come from the…, Return the name of the first exhausted session-wide limit, or None. Only covers…, Return a reason string if *tool* has hit its per-tool session cap. Checks only… (+79 more)

### Community 31 - "ImprovementLoop"
Cohesion: 0.06
Nodes (55): DetectedIssue, ImprovementLoop, ImprovementLoopState, IssueCategory, IssueSeverity, _now(), Any, Enum (+47 more)
...
### Community 33 - "TestExtendedCacheTTL"
Cohesion: 0.06
...
### Community 34 - "test_failover_client_shared.py"
Cohesion: 0.07
...
### Community 35 - "E2BSandboxSession"
Cohesion: 0.04
...
### Community 38 - "services/seo_audit.py"
Cohesion: 0.05
Nodes (59): _expire_stale_pending_report(), Run a full SEO/GEO/AIO audit against a website and persist the evidence., Auto-fail a pending SEO audit stub that is older than…, run_seo_audit(), BaseModel, field_validator, A single occurrence of a check firing on a specific URL., Snapshot of one crawled page with the on-page facts the checks used. (+51 more)
...
### Community 41 - "routing.py"
Cohesion: 0.05
Nodes (56): Feed LLM token/cost spend into the governance session budget. Kept separate…, Charge sub-agent nesting depth and enforce the ``max_depth`` ceiling. Isolates…, _load(), mcp_server/governance.py — governance adapter for the MCP HTTP surface. Closes…, Write the audit row for a completed (or blocked) MCP tool call., Import the governance layer once, recording why if it is absent., record(), events_from_identity() (+48 more)

### Community 42 - "AgentRunner"
Cohesion: 0.02
Nodes (124): AgentPhaseError, AgentRunner, Any, Exception, Path, Governance seam: judge the call, run it, audit the outcome. Deliberately a thin…, Append an event to the durable session log if a store is wired in., Summarise a long history and compact it. Asks the planner model to write a… (+116 more)
...
Cohesion: 0.04
Nodes (84): allow_paid_brain(), BrainResolution, provider_api_key(), Return the live API key for *provider* (env-only — never persisted)., get_active_brain_sync(), get_provider_role_tags(), _host_is_openai_compatible(), invalidate_brain_cache() (+76 more)

### Community 45 - "workflow/api.py"
Cohesion: 0.05
Nodes (47): _make_engine(), tests/test_crispy_workflow.py — CRISPY workflow engine hardening tests. Tests…, Provide isolated DB + artifact + workspace paths., Create a WorkflowEngine with isolated storage., TestAbortOnFailure, TestPhaseSequence, TestPhaseSequenceError, TestWorkspaceIsolation (+39 more)

### Community 46 - "test_model_catalog.py"
Cohesion: 0.05
...
### Community 48 - "CEOSupervisor"
Cohesion: 0.05
Nodes (43): get_ceo_dispatcher(), Return the shared CEODispatcher singleton., Reset the singleton (test helper)., reset_ceo_dispatcher(), CEOSupervisor, _env_flag(), _env_int(), get_ceo_supervisor() (+35 more)

### Community 49 - "SeoFixRequest"
Cohesion: 0.15
Nodes (11): Request to remediate auto-fixable findings in a local code repository., SeoFixRequest, services/seo_fixer.py - Repo-Aware SEO Auto-Fixer When a company has a code…, Convenience wrapper used by the API layer and skill executor., run_fixes(), Path, tests/test_seo_fixer.py - repo-aware SEO auto-fixer tests (issue #533)., repo() (+3 more)
...
### Community 51 - "TestInternalAgentAdapterProviderChain"
Cohesion: 0.40
...
### Community 52 - "test_agent_tool_governance.py"
Cohesion: 0.04
...
Cohesion: 0.05
Nodes (75): PreflightIssue, PreflightReport, Any, BaseModel, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, Translate technical preflight issues into a conversational assistant reply., translate_error_to_conversational(), AcceptedJob (+67 more)
...
### Community 61 - "TestAdapterMetadata"
Cohesion: 0.04
Nodes (29): _env_float(), HermesAdapter, Any, AsyncClient, Response, TaskResult, TaskSpec, Submit task to Hermes via its /tasks endpoint. (+21 more)

### Community 62 - "call_llm"
Cohesion: 0.03
Nodes (60): _agent_provider_failure_response(), _agent_timeout_fallback_response(), _append_agent_session_message(), _build_auto_skill_guidance(), _build_provider_router(), _builtin_provider_records(), call_llm(), _chat_error_detail_text() (+52 more)

### Community 63 - "loop.py"
Cohesion: 0.11
Nodes (27): _check_extra_kwargs(), _enforce_signature(), _nvidia_api_key(), loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., Raise TypeError if fn's signature drifts from the locked contract (Pydantic…, Raise TypeError on unknown kwarg (runtime extra='forbid' for non-Pydantic…, # NOTE: "ollama_base" is kept for backwards compatibility; this runner only…, build_compaction_prompt() (+19 more)
...
### Community 65 - "clear_cooldowns"
Cohesion: 0.06
Nodes (43): clear_cooldowns(), get_dead_models(), _is_model_dead(), is_provider_on_cooldown(), mark_provider_failed(), Snapshot of active dead-model entries {provider_id/model: expiry_ts}. Also…, Put provider_id on cooldown for *cooldown_seconds* (default:…, Return True if provider_id is currently on cooldown. (+35 more)

### Community 66 - "test_sam_livekit.py"
Cohesion: 0.05
...
Cohesion: 0.04
Nodes (96): CEODispatcher, _harvest_changed_files(), Any, Extract the files a runtime touched. Returns ``(files, reported)``. Adapters…, Build an agent.coordinator.TaskSpec from a CEO SpecialistTask., Real CEO delegation: wake runtimes, fan out, and merge results., Record the goal and its sub-tasks in the ledger before any work runs. Writing…, Settle the ledger goal once the fan-out has finished. A goal is closed only on… (+88 more)
...
### Community 73 - "failover_client.py"
Cohesion: 0.05
Nodes (50): _auto_disable(), _describe_registry(), _disabled_ids(), FailoverResult, _is_billing_refusal(), _is_ollama(), _key_pool(), _log_exhaustion() (+42 more)

### Community 74 - "ArtifactStore"
Cohesion: 0.07
...
### Community 77 - "RuntimeCapabilityRegistry"
Cohesion: 0.05
Nodes (28): Return the single best adapter for *task_type*. If *preferred_runtime_id* is…, Maintains the catalogue of registered adapters and answers 'which runtimes can…, Return all adapters that can handle *task_type*, ordered by tier., RuntimeCapabilityRegistry, TaskResult, TaskSpec, Admin-configurable routing policy. Defaults are conservative (local-first, no…, Routes a TaskSpec to the best available runtime following the configured… (+20 more)

### Community 78 - "get_task_store"
Cohesion: 0.05
...
### Community 79 - "seo_portfolio_bridge.py"
Cohesion: 0.05
...
### Community 80 - "company_api.py"
Cohesion: 0.02
Nodes (153): account_lifecycle(), AccountLifecycleResponse, auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint(), _DoctorCheck, _DoctorReport (+145 more)

### Community 81 - "HybridSystem"
Cohesion: 0.05
...
### Community 92 - "test_startup_warmup.py"
Cohesion: 0.02
Nodes (95): autonomy_tick(), _bootstrap_within_budget(), _create_bootstrap_indexes(), ensure_bootstrap(), _keepalive_self_ping(), lifespan(), Run the FreeBuff Telegram bot, restarting it on unexpected exit., Ping our own public URL so a free-tier web service doesn't sleep. Render free… (+87 more)
...
### Community 97 - "rbac.py"
Cohesion: 0.04
Nodes (46): compute_savings(), compute_time_series(), get_savings(), get_usage(), get_user_savings(), _period_start(), Any, BaseModel (+38 more)

### Community 98 - "TokenBudget"
Cohesion: 0.04
Nodes (39): BudgetExceededError, BudgetUsage, Any, Exception, agent/token_budget.py — Per-Session Token Spend Caps Track token usage per…, Raise :class:`BudgetExceededError` if the session has exceeded its cap., Reset usage counters for *session_id* (cap is preserved)., Reset token counters for all sessions (caps preserved). Called at the start of… (+31 more)
...
### Community 100 - "fmtErr"
Cohesion: 0.04
Nodes (43): chatSend(), createWikiPage(), delegateSeoFindings(), deleteCompany(), deleteSource(), fmtErr(), getAgentChatJob(), getCompany() (+35 more)
...
### Community 108 - "test_sqlite_store.py"
Cohesion: 0.06
...
Cohesion: 0.06
Nodes (32): browse_page(), BrowserAction, BrowserSession, _not_started(), PageState, Any, agent/browser.py — Browser Automation Controls a real browser via Playwright so…, True if browser automation is enabled and Playwright is importable. (+24 more)
...
### Community 120 - "test_provider_router.py"
Cohesion: 0.06
Nodes (48): extract_openai_text(), _normalize_nvidia_base_url(), _openai_url(), Normalize NVIDIA base URLs to avoid double /v1 when openai_compat_url appends…, _nvidia_provider_chain(), ProviderConfig, Build Nvidia NIM provider config from env. Empty list when key is absent., _clear_probe_locks() (+40 more)
...
### Community 127 - "KeyStore"
Cohesion: 0.04
Nodes (43): Browser admin UI for login, service control, key management, and diagnostics., Update or append a KEY=value line in the .env file., register_admin_gui(), _save_env_var(), _check_rate_limit(), default_keys_path(), issue_new_api_key(), KeyRecord (+35 more)

### Community 128 - "admin_digest_router.py"
Cohesion: 0.22
...
### Community 129 - "test_issue_intake.py"
Cohesion: 0.08
...
### Community 132 - "test_web_reach.py"
Cohesion: 0.09
...
Cohesion: 0.06
Nodes (49): _bullets(), generate_backlog_retro(), generate_standup(), plan_next_sprint(), Agentic Agile — autonomous ceremonies (standup, retro, sprint planning). Where…, Render a :class:`Retrospective` as a markdown section., Derive a retrospective from the task tracker when no sprint is active. DONE /…, The result of allocating portfolio capacity into a new sprint. (+41 more)

### Community 134 - "test_llm_router_queue_cache.py"
Cohesion: 0.02
...
### Community 135 - "render_ops.py"
Cohesion: 0.07
Nodes (28): get_render_ops_monitor(), _latest_metric_value(), _parse_timestamp(), Any, datetime, services/render_ops.py — autonomous Render debugging + environment monitoring.…, Parse an RFC3339 timestamp from Render, tolerating a trailing ``Z``., Pull the most recent numeric sample out of a ``get_metrics`` payload. Render… (+20 more)
...
### Community 139 - "PortfolioManager"
Cohesion: 0.05
...
### Community 140 - "LLMRouter"
Cohesion: 0.06
Nodes (29): Attempt, Read the environment variables named in ``env_names`` into a key list. Order is…, resolve_keys(), Whether sleeping ``delay`` still leaves time for the attempt after it., Wall-clock and attempt ceiling shared by every attempt in one request. Without…, RetryBudget, LLMRouter, Any (+21 more)

### Community 141 - "useSafeData"
Cohesion: 0.06
...
### Community 144 - "test_governance_api.py"
Cohesion: 0.09
Nodes (37): get_approval_store(), Replace the process-wide gate. Tests only., reset_gate(), _client(), parametrize, TestClient, Tests for the governance HTTP surface and the AgentRunner integration. The…, Policy is a git-reviewed file. An HTTP mutation route would make "who changed… (+29 more)
...
### Community 146 - "_get_run_or_404"
Cohesion: 0.12
Nodes (34): approve(), build(), cancel(), get_agent_team(), get_artifact_content(), get_events(), get_run(), _get_run_or_404() (+26 more)

### Community 147 - "MCPClient"
Cohesion: 0.07
...
### Community 148 - "persist_plan_spec"
Cohesion: 0.07
...
### Community 149 - "test_daily_2026_06_04.py"
Cohesion: 0.09
...
### Community 150 - "test_response_cache.py"
Cohesion: 0.12
...
### Community 153 - "TaskBoardScreen.jsx"
Cohesion: 0.05
...
### Community 155 - "test_runtime_governance.py"
Cohesion: 0.10
Nodes (47): _governance_check(), Evaluate a runtime dispatch against policy; audit it either way. Returns…, Full record of a routing decision — audit-trail entry., RoutingDecision, _decision(), _engine(), Any, RoutingDecision (+39 more)

### Community 156 - "activation.py"
Cohesion: 0.08
...
### Community 160 - "Provider"
Cohesion: 0.07
Nodes (24): CerebrasProvider, Provider, Cerebras provider adapter — free, fast LLM (qwen-3-coder-480b)., Groq provider adapter — free, fast LLM (deepseek-r1-distill-llama-70b)., NVIDIA NIM provider adapter — wraps the existing provider_router logic. This is…, Ollama provider adapter — local LLM inference., packages.ai — provider abstraction, model registry, and failover manager., packages/ai/manager.py — ProviderManager. Single entry point for all LLM calls.… (+16 more)

### Community 161 - "MetricsRegistry"
Cohesion: 0.07
...
### Community 162 - "StreamingDeltaReconstructor"
Cohesion: 0.07
...
### Community 164 - "test_telegram_freebuff.py"
Cohesion: 0.07
...
### Community 165 - "NotificationDispatcher"
Cohesion: 0.03
...
### Community 166 - "_get_provider_policy"
Cohesion: 0.07
...
Cohesion: 0.05
Nodes (28): createProvider(), deleteProvider(), getBrainProviders(), getLocalBrainState(), getProviderPolicy(), getRenderHealth(), getRenderOpsStatus(), postLocalBrainToggle() (+20 more)

### Community 168 - "OllamaCircuitBreaker"
Cohesion: 0.08
...
### Community 171 - "PromptCacheManager"
Cohesion: 0.06
...
Cohesion: 0.06
Nodes (40): AlertHandler, BudgetTracker, Counter, _Dimensions, get_budget(), _month(), Any, packages/llm/budget.py — token and cost accounting with spend alerts. Tracks… (+32 more)

### Community 175 - "test_audit.py"
Cohesion: 0.07
...
### Community 176 - "TestPoliciesGovernanceStableClaim"
Cohesion: 0.20
...
### Community 179 - "test_classify_dependabot_update.py"
Cohesion: 0.08
...
### Community 180 - "ModelConfig"
Cohesion: 0.05
Nodes (31): AgentPolicy, LLMConfig, ModelConfig, Capability and pricing metadata for one model id., Per-agent routing overrides (ADR-008 §"named profiles")., The fully-resolved routing configuration., get_registry(), ModelRegistry (+23 more)
...
### Community 185 - "portfolio_api.py"
Cohesion: 0.08
...
### Community 186 - "Part A — CodeRabbit review fixes for this PR (do first, small)"
Cohesion: 0.05
...
### Community 187 - "Docker Agent Runtimes Setup"
Cohesion: 0.05
...
Cohesion: 0.03
Nodes (85): HealthConfig, Backoff policy for retryable failures., Circuit breaker + health tracking thresholds., RetryConfig, BreakerState, HealthTracker, _Outcome, ProviderHealth (+77 more)
...
### Community 191 - "TestRecordUsageAndStats"
Cohesion: 0.05
...
### Community 192 - "test_process_quick_note_workflow.py"
Cohesion: 0.06
...
### Community 194 - "report_to_markdown"
Cohesion: 0.11
...
### Community 195 - "RuntimeHealthService"
Cohesion: 0.15
...
### Community 196 - "Persistent Memory System"
Cohesion: 0.05
...
Cohesion: 0.06
Nodes (63): _get_cached_tasks(), _get_tasks_cache_lock(), _load_improvement_state(), Any, BaseModel, get, Lock, post (+55 more)

### Community 204 - "Kept Rules — the 44 that survive the audit"
Cohesion: 0.05
...
### Community 210 - "validate_outbound_url"
Cohesion: 0.14
...
### Community 213 - "TemporalContextGraph"
Cohesion: 0.10
...
### Community 216 - "test_p0_roadmap_b1_c2_a3.py"
Cohesion: 0.06
...
### Community 220 - "test_unit7_catalog_propagation.py"
Cohesion: 0.05
...
### Community 221 - "PatternConsolidation"
Cohesion: 0.10
...
### Community 222 - "test_webui_provider_priority.py"
Cohesion: 0.21
...
### Community 225 - "NIMConnectionPool"
Cohesion: 0.08
...
### Community 228 - "test_operational_incidents.py"
Cohesion: 0.05
...
### Community 229 - "TestEstimateTokensForMessages"
Cohesion: 0.06
...
### Community 233 - "InternalAgentAdapter"
Cohesion: 0.04
Nodes (58): _best_cloud_primary_base(), InternalAgentAdapter, TaskResult, TaskSpec, Built-in agent loop — Nvidia NIM primary, Ollama fallback., Return runtime dependencies required by this adapter. Returns:…, Determine availability of the internal agent runtime. Checks cloud providers in…, Execute a TaskSpec using the internal AgentRunner and convert the agent's… (+50 more)

### Community 234 - "OrchestratorSupervisor"
Cohesion: 0.26
...
### Community 238 - "test_verification_strategies.py"
Cohesion: 0.11
...
### Community 241 - "REWRITE_PLAN.md — Phased Migration Strategy"
Cohesion: 0.06
...
Cohesion: 0.09
Nodes (23): Dynamic model router package. Public API:: from router import get_router,…, _build_builtin_model_map(), _default_model(), _default_reasoning_model(), ModelRouter, _nvidia_key_present(), Any, Dynamic model router. Central routing logic for all chat and agent requests.… (+15 more)
...
### Community 244 - "test_all_providers_discovery.py"
Cohesion: 0.16
...
### Community 246 - "test_persistent_memory.py"
Cohesion: 0.06
...
### Community 248 - "test_mostly_failed_steps.py"
Cohesion: 0.12
...
### Community 250 - "model_discovery.py"
Cohesion: 0.10
...
### Community 252 - "test_anthropic_router.py"
Cohesion: 0.09
...
### Community 253 - "test_llm_router_e2e.py"
Cohesion: 0.14
...
### Community 256 - "agent_runtime.py"
Cohesion: 0.10
...
### Community 257 - "App.js"
Cohesion: 0.09
Nodes (19): getDefaultBackendUrl(), getMe(), login(), logout(), App(), AppRoutes(), ProtectedRoute(), V5App (+11 more)

### Community 258 - "context_rules.py"
Cohesion: 0.11
...
### Community 259 - "test_platform_controls.py"
Cohesion: 0.08
...
### Community 260 - "local_controller.py"
Cohesion: 0.12
...
### Community 262 - "ContextCompressor"
Cohesion: 0.11
...
### Community 265 - "ResourceWatchdog"
Cohesion: 0.10
...
### Community 268 - "test_rate_limiter.py"
Cohesion: 0.09
...
### Community 269 - "RateLimitTracker"
Cohesion: 0.10
...
### Community 271 - "analyze_quantitative"
Cohesion: 0.10
...
### Community 272 - "test_brain_failover.py"
Cohesion: 0.10
...
### Community 275 - "test_sam_voice.py"
Cohesion: 0.07
...
### Community 277 - "operational_incidents.py"
Cohesion: 0.11
...
### Community 278 - "Security Analysis — local-llm-server"
Cohesion: 0.06
...
### Community 281 - "OnboardingScreen.jsx"
Cohesion: 0.07
Nodes (26): createCompany(), deleteGithubToken(), getOnboardingProgress(), githubStatus(), listGithubRepos(), listSpecialists(), scanRepo(), scanWebsite() (+18 more)
...
### Community 283 - "BrainFailoverManager"
Cohesion: 0.09
...
### Community 284 - "OrchestratorQueue"
Cohesion: 0.08
...
### Community 287 - "test_one_model_catalogue.py"
Cohesion: 0.14
...
### Community 288 - "test_workspace_isolation.py"
Cohesion: 0.16
...
### Community 292 - "High-Agency Frontend Skill"
Cohesion: 0.06
Nodes (30): 10. FINAL PRE-FLIGHT CHECK, 1. ACTIVE BASELINE CONFIGURATION, 2. DEFAULT ARCHITECTURE & CONVENTIONS, 3. DESIGN ENGINEERING DIRECTIVES (Bias Correction), 4. CREATIVE PROACTIVITY (Anti-Slop Implementation), 5. PERFORMANCE GUARDRAILS, 6. TECHNICAL REFERENCE (Dial Definitions), 7. AI TELLS (Forbidden Patterns) (+22 more)

### Community 293 - "LlmProviderConfig"
Cohesion: 0.16
...
Cohesion: 0.07
Nodes (31): _auth_headers(), _chat_targets(), _dump_matching(), _kind(), list_models(), _list_or_report(), main(), _parse_args() (+23 more)

### Community 297 - "Specialist"
Cohesion: 0.03
Nodes (50): SpecialistFamily, Find all specialists of a specific family., Find specialists that can handle a task with given capabilities., A specialist agent that can be provisioned for company-specific tasks., Check if this specialist can handle a task with given capabilities., Specialist, SpecialistFamily, SystemType (+42 more)

### Community 298 - "sync/service.py"
Cohesion: 0.14
...
### Community 299 - "test_mcp_governance.py"
Cohesion: 0.12
...
### Community 300 - "test_llm_router_disabled.py"
Cohesion: 0.11
...
### Community 301 - "test_purge_backlog.py"
Cohesion: 0.09
...
### Community 303 - "get_failover_manager"
Cohesion: 0.07
...
### Community 307 - "test_colibri_brain_shim.py"
Cohesion: 0.05
Nodes (60): get_brain_preference(), Return the operator's brain provider preference. Values: - ``"nvidia"`` —…, colibri_enabled(), colibri_provider_config(), colibri_status(), ProviderConfig, providers/colibri.py — Free local GLM-5.2 brain served by JustVugg/colibri.…, Return True iff the operator opted in via ``COLIBRI_ENABLED=true``. (+52 more)

### Community 308 - "switch_brain.py"
Cohesion: 0.16
...
### Community 313 - "test_force_cleanup_conditional_delete.py"
Cohesion: 0.10
...
### Community 314 - "test_autonomy_gate.py"
Cohesion: 0.12
...
### Community 315 - "test_rag_context.py"
Cohesion: 0.12
...
### Community 316 - "ProjectScaffolder"
Cohesion: 0.13
...
### Community 317 - "DirectChatDoctor"
Cohesion: 0.10
Nodes (29): DirectChatDoctor, _DoctorCheck, _DoctorReport, get_doctor_diagnostics(), get_doctor_report(), get_public_doctor(), Consolidated system health report: preflight checks + runtime health. Returns a…, Public Doctor endpoint — no authentication required. Returns system-level… (+21 more)

### Community 318 - "SteeringInjector"
Cohesion: 0.11
...
### Community 319 - "test_claude_setup_audit.py"
Cohesion: 0.16
...
### Community 320 - "test_internal_agent_did_work.py"
Cohesion: 0.12
...
### Community 323 - "Python Dependencies (`requirements.txt`)"
Cohesion: 0.07
...
### Community 324 - "Technical Debt Register — local-llm-server"
Cohesion: 0.07
...
### Community 326 - "SetupWizardPage.js"
Cohesion: 0.10
...
### Community 327 - "autonomous_fix.py"
Cohesion: 0.20
...
### Community 328 - "seo_report_pdf.py"
Cohesion: 0.24
...
### Community 329 - "DockerAgentAdapter"
Cohesion: 0.17
...
### Community 331 - "services/background.py"
Cohesion: 0.06
Nodes (24): Any, RoutingDecision, TaskResult, TaskSpec, Return health status for all registered runtimes., Return routing decision audit log (newest first)., Actively wake every sleeping/circuit-open runtime. The default health service…, True if the runtime is healthy enough for the router to select it. (+16 more)
...
### Community 334 - "test_agent_scripts_share_one_model_list.py"
Cohesion: 0.10
...
### Community 336 - "test_skill_registry_boot_refresh.py"
Cohesion: 0.12
...
### Community 340 - "test_brain_priority_scanner.py"
Cohesion: 0.10
...
### Community 341 - "Deploy: FreeBuff Telegram bot (24×7)"
Cohesion: 0.07
...
### Community 342 - "Claude Code + Qwen Local Setup"
Cohesion: 0.07
...
Cohesion: 0.08
Nodes (18): discoverLlmModels(), getLlmProviders(), getLlmStatus(), probeLlmProviders(), reloadLlmConfig(), setLlmProviderEnabled(), setLlmStrategy(), ALIASES (+10 more)

### Community 345 - "test_freebuff_bot.py"
Cohesion: 0.12
...
### Community 349 - "isolated_telegram_config"
Cohesion: 0.11
...
### Community 352 - "test_scheduler_hydration_bounded.py"
Cohesion: 0.09
...
### Community 353 - "webui/frontend/package.json"
Cohesion: 0.07
...
### Community 355 - "AdaptivePermissions"
Cohesion: 0.18
...
### Community 360 - "test_dashboard_cache.py"
Cohesion: 0.14
...
### Community 362 - "output_filter.py"
Cohesion: 0.07
...
### Community 367 - "brain_failover.py"
Cohesion: 0.11
...
### Community 368 - "test_telegram_approval_e2e.py"
Cohesion: 0.12
...
### Community 369 - "test_brain_migration_writes_a_live_model.py"
Cohesion: 0.10
...
### Community 370 - "test_daily_automation_2026_08_03.py"
Cohesion: 0.11
...
### Community 371 - "test_telegram_mutating_commands.py"
Cohesion: 0.08
...
### Community 375 - "seo_api.py"
Cohesion: 0.05
Nodes (47): get_seo_audit(), list_seo_audits(), BaseModel, get, SEO / GEO / AIO Audit API Router Endpoints for the world-class SEO audit engine…, Return the full SEO/GEO/AIO check catalog. Static metadata only, but gated…, List stored audits for this company (most recent first)., Fetch a complete stored audit report. Side-effect: an audit whose stub is still… (+39 more)

### Community 376 - "dependencies"
Cohesion: 0.08
Nodes (25): axios, fast-uri, dependencies, axios, fast-uri, livekit-client, lucide-react, react (+17 more)

### Community 377 - "get_skill_bindings"
Cohesion: 0.14
Nodes (19): build_matrix(), _families(), main(), Any, Map family -> sorted list of test files that mention it (quoted token)., Return one row per family, derived entirely from code., render_markdown(), _test_evidence_index() (+11 more)

### Community 378 - "1. The Rules"
Cohesion: 0.08
...
### Community 380 - "Session Handoff — 2026-06-15"
Cohesion: 0.08
...
### Community 381 - "TASK 4 — End-to-end approval-gate test"
Cohesion: 0.08
...
### Community 383 - "implement_agent.py"
Cohesion: 0.12
...
### Community 384 - "open_phase_report"
Cohesion: 0.10
...
### Community 387 - "TestClassifyPlainText"
Cohesion: 0.08
...
### Community 388 - "test_service_token.py"
Cohesion: 0.08
...
### Community 391 - "test_harness_spec.py"
Cohesion: 0.12
...
### Community 395 - "Local AI Stack with Docker"
Cohesion: 0.08
...
### Community 396 - "Traffic Distribution Across Providers"
Cohesion: 0.08
...
### Community 397 - "Implementation Prompt: Rich TaskBoard + Agile Sprint Integration"
Cohesion: 0.08
...
### Community 398 - "Telegram Bot Setup"
Cohesion: 0.08
...
### Community 399 - "video_transcript.py"
Cohesion: 0.12
...
### Community 400 - "control_overrides.py"
Cohesion: 0.12
...
### Community 402 - "Native operations"
Cohesion: 0.09
...
### Community 403 - "test_phase6_workflow.py"
Cohesion: 0.16
...
### Community 408 - "sam_livekit_worker.py"
Cohesion: 0.13
...
### Community 419 - "TestHarnessAdapter"
Cohesion: 0.04
...
### Community 420 - "WindowsServiceManager"
Cohesion: 0.18
...
### Community 421 - "SyntheticDataPipeline"
Cohesion: 0.13
...
### Community 422 - "test_all_features.py"
Cohesion: 0.09
...
### Community 424 - "test_cerebras_catalogue.py"
Cohesion: 0.13
...
### Community 425 - "test_monitor_lib.py"
Cohesion: 0.11
...
### Community 427 - "FreeBuffAgent"
Cohesion: 0.06
Nodes (45): free_nvidia_models(), FreeBuffAgent, Return the curated list of free NVIDIA NIM models FreeBuff may use., Codebuff-style coding agent pinned to free NVIDIA NIM models. FreeBuff is a…, List the free NVIDIA NIM models a user may pick (e.g. via Telegram)., True when *model* is in the curated free NVIDIA NIM set., Coerce *requested* to a free NVIDIA model. Returns *requested* when it is…, check_rate_limit() (+37 more)

### Community 428 - "test_v4_api.py"
Cohesion: 0.12
...
### Community 430 - "HarnessEnrichment"
Cohesion: 0.14
...
### Community 431 - "classify_direct_chat_intent"
Cohesion: 0.13
...
### Community 432 - "PerformanceAnalytics"
Cohesion: 0.12
...
### Community 433 - "test_agent_chat_integration.py"
Cohesion: 0.23
...
### Community 442 - "test_memory_guard.py"
Cohesion: 0.13
...
### Community 443 - "TestLegacyRouterCacheTTL"
Cohesion: 0.13
...
### Community 444 - "test_portfolio_intelligence.py"
Cohesion: 0.06
...
### Community 446 - "get_improvement_loop"
Cohesion: 0.15
Nodes (20): get_improvement_loop(), get_trend_watcher(), agent/trend_watcher.py — Internet-connected AI trend intelligence. Fetches from…, set_trend_watcher(), _env_float(), Bootstrap the autonomous loops that turn signals into work (the heart of the…, Parse a float env var, falling back to *default* on a bad value (never raises)., Periodically fetch trends (which fans out per-company scoped tasks, G4). Sleeps… (+12 more)

### Community 447 - "test_knowledge_sync.py"
Cohesion: 0.08
...
### Community 450 - "_ensure_tasks_source_id_unique_index"
Cohesion: 0.21
...
### Community 451 - "TestNormalizeResponseFormat"
Cohesion: 0.11
...
### Community 452 - "V3 API Migration Plan — LLM Relay Platform"
Cohesion: 0.10
...
### Community 454 - "test_chat_mode_regressions.py"
Cohesion: 0.13
...
### Community 455 - "test_anthropic_refusal_fallback.py"
Cohesion: 0.19
...
### Community 456 - "TestStreamableHTTPTransport"
Cohesion: 0.13
...
### Community 460 - "system_instruction"
Cohesion: 0.16
...
### Community 461 - "test_local_controller.py"
Cohesion: 0.17
...
### Community 462 - "test_provider_state_durability.py"
Cohesion: 0.08
Nodes (19): True when operator state is stored somewhere that survives a redeploy. False…, Drop the cached Mongo client, backoff, and read caches (tests)., reset_kv_state(), state_is_durable(), one_configured_provider(), A registry with exactly two known providers and isolated state., fake_mongo(), _FakeCollection (+11 more)

### Community 463 - "run_trend_analysis"
Cohesion: 0.18
...
### Community 466 - "TestPolicyAuthoringUiStableClaim"
Cohesion: 0.22
...
### Community 467 - "PersistentMemoryStore"
Cohesion: 0.24
...
### Community 468 - "Skill: modularity-review"
Cohesion: 0.10
...
### Community 469 - "Design Audit"
Cohesion: 0.10
Nodes (19): Code Quality, Color and Surfaces, Component Patterns, Content, Design Audit, Fix Priority, How This Works, Iconography (+11 more)

### Community 470 - "Findings"
Cohesion: 0.10
...
### Community 474 - "Docker AI Governance Audit — Final Report"
Cohesion: 0.10
...
### Community 475 - "1. Capability-by-capability"
Cohesion: 0.10
...
### Community 477 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 495 - "_extract_tech_relevance"
Cohesion: 0.17
...
### Community 499 - "Production Readiness Assessment — local-llm-server"
Cohesion: 0.11
...
### Community 503 - "Implementation Plan"
Cohesion: 0.11
...
### Community 506 - "Delegation Plan (agent-ready work packages)"
Cohesion: 0.11
...
### Community 507 - "test_p0_roadmap_a4_a5_b2.py"
Cohesion: 0.15
...
### Community 508 - "parse_event_stream"
Cohesion: 0.15
...
### Community 511 - "test_task_source_id_race.py"
Cohesion: 0.17
...
### Community 512 - "test_brain_patch_service_token.py"
Cohesion: 0.18
...
### Community 513 - "TestSelfHealingInfrastructureClassification"
Cohesion: 0.19
...
### Community 514 - "test_fabric_patterns.py"
Cohesion: 0.11
...
### Community 515 - "test_schedule_persistence.py"
Cohesion: 0.15
...
### Community 516 - "validate_session_id"
Cohesion: 0.16
...
### Community 517 - "ErrorInterceptorMiddleware"
Cohesion: 0.18
...
### Community 518 - "self_heal_brain_and_unblock_tasks"
Cohesion: 0.10
...
### Community 521 - "DailyDigestAggregatorTests"
Cohesion: 0.19
...
### Community 523 - "TestBrainFailoverModelUpdates"
Cohesion: 0.18
...
### Community 524 - "Comprehensive Skill Index (By Category)"
Cohesion: 0.11
...
### Community 525 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 526 - "Component Map"
Cohesion: 0.11
...
### Community 527 - "test_repowise_intelligence.py"
Cohesion: 0.11
...
### Community 530 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
...
### Community 536 - "test_p0_roadmap_b3_b4_b5.py"
Cohesion: 0.16
...
### Community 539 - "test_company_api.py"
Cohesion: 0.11
...
### Community 540 - "TestStopSlopChecker"
Cohesion: 0.11
...
### Community 541 - "TestAuthAndTaskOwnership"
Cohesion: 0.05
...
### Community 542 - "handle_workflow_ide_chat"
Cohesion: 0.18
...
### Community 545 - "test_ai_insights.py"
Cohesion: 0.20
...
### Community 549 - "SKILL: Industrial Brutalism & Tactical Telemetry UI"
Cohesion: 0.12
...
### Community 550 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 551 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 552 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 553 - "Section-by-Section Acceptance Criteria"
Cohesion: 0.12
...
### Community 557 - "kimi_bridge_provider_config"
Cohesion: 0.18
...
### Community 569 - "test_orchestrator_merge_decision.py"
Cohesion: 0.24
...
### Community 571 - "test_skill_registry.py"
Cohesion: 0.09
...
### Community 572 - "test_task_service_failed_comment.py"
Cohesion: 0.18
...
### Community 573 - "hermes_prompt.py"
Cohesion: 0.19
...
### Community 575 - "MemoryMiddleware"
Cohesion: 0.17
...
### Community 578 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
...
### Community 579 - "_valid_login_state"
Cohesion: 0.24
...
### Community 581 - "The 10-Step Workflow"
Cohesion: 0.12
...
### Community 584 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 585 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 586 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
...
### Community 588 - "_is_bedrock_model_id"
Cohesion: 0.27
...
### Community 594 - "_process_task_callback"
Cohesion: 0.28
...
### Community 595 - "test_agency_workflows_carry_the_failover_chain.py"
Cohesion: 0.18
...
### Community 596 - "test_autonomy_status.py"
Cohesion: 0.12
...
### Community 597 - "TestAnthropicWorkspaceIdCapture"
Cohesion: 0.33
...
### Community 598 - "TestModelCostTableUpdates"
Cohesion: 0.26
...
### Community 599 - "test_dockerfile_ships_root_modules.py"
Cohesion: 0.17
...
### Community 600 - "test_langfuse_agency_wide.py"
Cohesion: 0.10
...
### Community 601 - "test_local_brain_state.py"
Cohesion: 0.12
...
### Community 603 - "test_nvidia_default_model.py"
Cohesion: 0.17
...
### Community 605 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 606 - "test_refresh_agent_built_proof.py"
Cohesion: 0.12
...
### Community 607 - "test_telegram_diag_endpoint.py"
Cohesion: 0.09
...
### Community 611 - "CollaborationContext"
Cohesion: 0.17
...
### Community 612 - "Skill: agent-harness"
Cohesion: 0.13
...
### Community 613 - "Skill: checkpoint-strategy"
Cohesion: 0.13
...
### Community 615 - "Skill: local-ai-query"
Cohesion: 0.13
...
### Community 616 - "Skill: parallel-agents"
Cohesion: 0.13
...
### Community 617 - "Skill: parallel-worktrees"
Cohesion: 0.13
...
### Community 618 - "Design System: Taste Standard"
Cohesion: 0.13
...
### Community 622 - "Skill: user-research"
Cohesion: 0.13
...
### Community 623 - "DirectChatSession"
Cohesion: 0.13
...
### Community 624 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 625 - "Attention Mechanisms Internals"
Cohesion: 0.13
...
### Community 628 - "router/health.py"
Cohesion: 0.20
...
### Community 629 - "TestKillSwitchDurability"
Cohesion: 0.15
...
### Community 631 - "clear_wizard_state_cache"
Cohesion: 0.21
...
### Community 632 - "e2e/test_browser.py"
Cohesion: 0.23
...
### Community 635 - "test_agent_tools.py"
Cohesion: 0.19
...
### Community 636 - "DecisionsStoreTests"
Cohesion: 0.11
...
### Community 637 - "test_dockerfile_ships_config_dir.py"
Cohesion: 0.14
...
### Community 642 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 646 - "Checks Performed"
Cohesion: 0.14
...
### Community 647 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 648 - "_extract_pytest_failure"
Cohesion: 0.31
...
### Community 649 - "Skill: branch-cleanup"
Cohesion: 0.14
...
### Community 650 - "Skill: perplexity — Web Research via Perplexity API"
Cohesion: 0.14
...
### Community 653 - "Nothing is blocked on an agent. Two things need a human."
Cohesion: 0.12
...
### Community 654 - "Quick-Note Issues Processing Summary"
Cohesion: 0.14
...
### Community 655 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 657 - "Render MCP — autonomous platform debugging and environment monitoring"
Cohesion: 0.14
...
### Community 658 - "Runbook: Auto-Resume After Cooldown / Interruption"
Cohesion: 0.14
...
### Community 659 - "SEO / GEO / AIO Audit Engine"
Cohesion: 0.14
...
### Community 661 - "overrides"
Cohesion: 0.14
Nodes (14): @tootallnate/once, overrides, bfj, css-select, http-proxy-agent, jsonpath, nth-check, postcss (+6 more)

### Community 662 - "SkillsScreen.jsx"
Cohesion: 0.14
Nodes (10): autoRecommendCompanySkills(), discoverRemoteSkills(), listCompanySkills(), SkillsScreen, CATEGORY_COLORS, COMMERCE_SKILLS, effortColor, effortLabel (+2 more)

### Community 663 - "_parse_reset_epoch"
Cohesion: 0.21
...
### Community 665 - "extract_failures"
Cohesion: 0.21
...
### Community 666 - "flesch_reading_ease"
Cohesion: 0.22
...
### Community 668 - "TestRouterIntegration"
Cohesion: 0.18
...
### Community 670 - "TestAnthropicToolListCaching"
Cohesion: 0.34
...
### Community 672 - "provider_max_rpm"
Cohesion: 0.17
...
### Community 673 - "test_openclaw_gateway.py"
Cohesion: 0.14
...
### Community 674 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 675 - "redact_connection_url"
Cohesion: 0.17
...
### Community 676 - "_get_current_user"
Cohesion: 0.25
...
### Community 677 - "test_brain_default_model.py"
Cohesion: 0.14
Nodes (14): livenim, _live_models(), The free-brain default must be an id the endpoint actually serves. Two…, The ids the catalogue currently vouches for. Derived, not frozen: a hardcoded…, Default must be one of the live NIM namespaced IDs — never the bare name., The module-level copy must not drift from the catalogue's safe default. Was…, 49B is still honored as a fallback when the operator opts in via env., Live smoke test: the default model must be reachable on NIM today. Skipped… (+6 more)

### Community 678 - "check_model_catalog_consistency.py"
Cohesion: 0.22
Nodes (14): _check_cross_catalogue(), _check_prefer_models(), _check_presets(), _llm_declared(), _load(), main(), Any, Path (+6 more)

### Community 679 - "TestTheGatewayRegistryOffersOnlyLiveModels"
Cohesion: 0.22
...
### Community 680 - "test_telegram_webhook.py"
Cohesion: 0.14
...
### Community 682 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 685 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 686 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 689 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
...
### Community 690 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 691 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 693 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 706 - "Workspace Isolation Architecture"
Cohesion: 0.17
...
### Community 718 - "TestRuntimeControl"
Cohesion: 0.04
...
### Community 721 - "TestTheProducersAndTheParserCannotDrift"
Cohesion: 0.25
...
### Community 723 - "WorkspaceManifest"
Cohesion: 0.17
...
### Community 724 - "skill_registry.py"
Cohesion: 0.17
...
### Community 726 - "AGENTS.md — Codebase Map & Operations Reference"
Cohesion: 0.17
...
### Community 735 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 738 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 740 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 741 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 744 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 745 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 746 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 749 - "install-agents.sh"
Cohesion: 0.39
...
### Community 750 - "check_container_posture.py"
Cohesion: 0.26
...
### Community 751 - "test_pytest_failure_parser.py"
Cohesion: 0.23
...
### Community 752 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 753 - "test_admin_local_brain_router.py"
Cohesion: 0.29
...
### Community 754 - "test_agile_api.py"
Cohesion: 0.17
...
### Community 755 - "test_app_settings.py"
Cohesion: 0.21
...
### Community 756 - "test_brain_default_consistency.py"
Cohesion: 0.24
...
### Community 757 - "TestPaidPolicyDurability"
Cohesion: 0.22
...
### Community 759 - "nvidia_models.py"
Cohesion: 0.20
...
### Community 760 - "TestAnthropicPayloadStructuredOutput"
Cohesion: 0.29
...
### Community 761 - "test_task_clarification.py"
Cohesion: 0.17
...
### Community 763 - "TestMCPToolsListCache"
Cohesion: 0.19
...
### Community 768 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 771 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 772 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 774 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 777 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 778 - "Main proxy (`proxy.py`)"
Cohesion: 0.17
Nodes (12): Agent and workflow surfaces, API Surfaces and Route Map, Built-in admin and web UI, Control-plane style routers mounted in the proxy, Governance (`/api/governance/*`, admin-only), Main proxy (`proxy.py`), Ollama-compatible, OpenAI-compatible (+4 more)
...
### Community 795 - "test_google_provider_models.py"
Cohesion: 0.18
...
### Community 801 - "test_conftest_hermetic_env.py"
Cohesion: 0.18
...
### Community 802 - "admin_update_task_router.py"
Cohesion: 0.22
...
### Community 803 - "test_e2b_adapter.py"
Cohesion: 0.07
...
### Community 804 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 805 - "InitiativeProgress"
Cohesion: 0.33
...
### Community 807 - "TestNoNvidiaFallbackIsRetired"
Cohesion: 0.22
...
### Community 813 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 814 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 816 - "admin_local_brain_router.py"
Cohesion: 0.22
...
### Community 818 - "_normalize_tool_choice"
Cohesion: 0.16
Nodes (7): _normalize_tool_choice(), _parse_tool_calls_from_response(), Parse OpenAI tool_calls from a model response. Handles: - Direct JSON…, Normalize the ``tool_choice`` parameter for the upstream backend. OpenAI…, Cloud models (with / in name) should keep tool_choice as-is., TestNormalizeToolChoice, TestParseToolCalls

### Community 819 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 820 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 821 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 822 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 823 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 824 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 825 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 827 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 828 - "LLM Router — configuration guide"
Cohesion: 0.20
...
### Community 829 - "LLM Router — provider guide"
Cohesion: 0.20
...
### Community 830 - "CI Troubleshooting Runbook"
Cohesion: 0.20
...
### Community 833 - "capture_screens.py"
Cohesion: 0.29
...
### Community 835 - "build_tech_db.py"
Cohesion: 0.40
...
### Community 838 - "_resolve_push_token"
Cohesion: 0.31
...
### Community 841 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 842 - "test_ceo_dispatcher.py"
Cohesion: 0.03
Nodes (127): CEOResult, _decompose_into_subtasks(), _merge_changed_files(), Aggregated output from a multi-specialist execution., Decompose a request into 2-3 sub-tasks for specialist fan-out. Default…, Post-hoc independent re-check when a completed task touched a risky module.…, Collect changed_files across all specialists into a single de-duped list., BoundContext (+119 more)

### Community 843 - ".delegate"
Cohesion: 0.14
Nodes (12): _complexity_rank(), _offload(), Run a synchronous ledger call without blocking the event loop. ``CEOLedger`` is…, Build a single-task sub-task list (low-complexity fast path)., Decompose the request, wake runtimes, run sub-tasks concurrently, merge.…, Best-effort wake of any sleeping runtimes via RuntimeManager. Returns runtime…, _should_fan_out(), _single_specialist_task() (+4 more)

### Community 845 - "Slice"
Cohesion: 0.10
Nodes (9): WorkflowRun, TestSlice, TestWorkflowRun, _extract_slices_from_plan(), Extract slice definitions from a plan.md artifact. Looks for sections matching:…, Any, An independently deliverable unit of work within the execute phase. Each slice…, Return the Slice with *slice_id*, or None. (+1 more)

### Community 846 - "synthesize"
Cohesion: 0.36
...
### Community 849 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 870 - "frontend/package.json"
Cohesion: 0.22
...
### Community 877 - "enrich_quick_note_issues.py"
Cohesion: 0.42
...
### Community 879 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 880 - "test_changelog_parity_guard.py"
Cohesion: 0.22
...
### Community 893 - "quality_checker.py"
Cohesion: 0.32
...
### Community 895 - "Continual Harness (`agent/harness_spec.py`)"
Cohesion: 0.25
...
### Community 906 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 911 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.25
...
### Community 912 - "Issue #362: Nvidia repo setup"
Cohesion: 0.25
...
### Community 913 - "Issue #364: quick-note:https://www.marktechpost.com/2026/06/01/meet-memory-os-a-6-layer-open-source-memory-stack-built-on-top-of-hermes-agent/"
Cohesion: 0.25
...
### Community 914 - "Issue #378: quick-note:https://www.marktechpost.com/2026/06/02/tinyfish-launches-bigset-an-open-source-multi-agent-system-that-builds-structured-live-datasets-from-plain-english-descriptions/"
Cohesion: 0.25
...
### Community 915 - "Issue #379: quick-note:https://searchengineland.com/schema-markup-optimize-agentic-web-479080"
Cohesion: 0.25
...
### Community 916 - "Issue #380: quick-note:https://cursor.com/blog/cloud-agent-lessons"
Cohesion: 0.25
...
### Community 917 - "Issue #381: quick-note:https://www.xda-developers.com/claude-code-with-opus-48-is-expensive-but-i-made-it-efficient-with-my-local-ai-workflow/"
Cohesion: 0.25
...
### Community 918 - "Issue #382: quick-note:https://claude.com/blog/how-coderabbit-used-claude-to-build-an-agent-orchestration-system"
Cohesion: 0.25
...
### Community 919 - "Issue #383: quick-note:https://www.marktechpost.com/2026/05/29/hexo-labs-open-sources-sia-a-self-improving-agent-that-updates-both-the-harness-and-the-model-weights/"
Cohesion: 0.25
...
### Community 920 - "Issue #416: feat: Self-hosted Codebuff (freebuff) on free NVIDIA models + Telegram bot phone control"
Cohesion: 0.25
...
### Community 921 - "Issue #485: [Trend Digest] Week of 2026-06-08"
Cohesion: 0.25
...
### Community 922 - "Issue #488: quick-note:https://github.com/cookiy-ai/user-research-skill"
Cohesion: 0.25
...
### Community 923 - "Issue #491: Implement whatever is necessary from https://github.com/BehiSecc/awesome-claude-skills"
Cohesion: 0.25
...
### Community 924 - "Issue #493: Use the https://github.com/mvanhorn/last30days-skill skill to get the trend updated"
Cohesion: 0.25
...
### Community 925 - "Issue #495: Read https://www.anthropic.com/news/claude-fable-5-mythos-5 and understand if mythos or fable can be added to the repo"
Cohesion: 0.25
...
### Community 926 - "Issue #504: EPIC: Autonomy hardening — live-verified defects 2026-06-10"
Cohesion: 0.25
...
### Community 927 - "Issue #581: Sprint tracker: pending work after brand rename + mobile-first pass"
Cohesion: 0.25
...
### Community 929 - "Issue #657: quick-note:https://github.com/earendil-works/pi"
Cohesion: 0.25
...
### Community 930 - "Issue #659: quick-note:https://github.com/nex-agi/Nex-N2"
Cohesion: 0.25
...
### Community 931 - "Issue #660: quick-note:https://github.com/getsentry/sentry-for-ai"
Cohesion: 0.25
...
### Community 932 - "Issue #661: quick-note:https://github.com/XiaomiMiMo/MiMo-Code"
Cohesion: 0.25
...
### Community 933 - "Issue #664: quick-note:https://github.com/Grominet95/jarvis-OS"
Cohesion: 0.25
...
### Community 934 - "Issue #666: quick-note:https://github.com/porokka/jarvis-os"
Cohesion: 0.25
...
### Community 935 - "Issue #670: quick-note:https://github.com/perplexityai/bumblebee"
Cohesion: 0.25
...
### Community 936 - "Issue #672: quick-note:https://github.com/Chachamaru127/claude-code-harness"
Cohesion: 0.25
...
### Community 937 - "Issue #676: quick-note:https://github.com/WeiboAI/VibeThinker"
Cohesion: 0.25
...
### Community 938 - "Issue #820: quick-note:https://github.com/cobusgreyling/loop-engineering"
Cohesion: 0.25
...
### Community 939 - "Positional Encoding Internals"
Cohesion: 0.25
...
### Community 940 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 941 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 942 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 943 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 944 - "Prime Agent Runtime"
Cohesion: 0.25
...
### Community 951 - "run_patched_colibri.py"
Cohesion: 0.36
...
### Community 954 - "TestItIsNotBuiltForOneVendor"
Cohesion: 0.25
...
### Community 955 - "test_compose_and_coordinate_api.py"
Cohesion: 0.36
...
### Community 962 - "test_runtimes_health_endpoint.py"
Cohesion: 0.25
...
### Community 964 - "test_serve_spa_prefixes.py"
Cohesion: 0.36
...
### Community 965 - "TestOneIdCanBelongToSeveralProviders"
Cohesion: 0.39
...
### Community 966 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.25
...
### Community 968 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 979 - "Changelog"
Cohesion: 0.29
Nodes (7): Added, Changed, Changelog, Fixed, Maintenance, Removed, Security

### Community 980 - "AI Engineering Insights Skill"
Cohesion: 0.29
...
### Community 995 - "Implementation plan + TO-DO (check off as you go)"
Cohesion: 0.29
...
### Community 1005 - "check_changelog_parity.py"
Cohesion: 0.43
...
### Community 1006 - "e2e_smoke.py"
Cohesion: 0.57
Nodes (5): _chat(), check(), _health(), _models(), _req()

### Community 1007 - "task_runner.py"
Cohesion: 0.33
...
### Community 1009 - "classify_domain"
Cohesion: 0.29
...
### Community 1012 - "platform_controls_router.py"
Cohesion: 0.29
...
### Community 1013 - "test_doctor_coding_brain.py"
Cohesion: 0.38
...
### Community 1017 - "get_self_healing_agent"
Cohesion: 0.05
Nodes (54): _dispatch_async(), _ErrorCaptureHandler, get_log_monitor(), LogMonitor, _note_recurrence(), Any, LogRecord, agent/log_monitor.py — Application Log Monitor Captures ERROR/CRITICAL log… (+46 more)

### Community 1018 - "TestReasonsAreActionable"
Cohesion: 0.29
...
### Community 1019 - "TestProvidersScreen"
Cohesion: 0.43
...
### Community 1020 - "TestCli"
Cohesion: 0.57
Nodes (3): Path, The workflows call this as a subprocess, so the CLI contract matters., TestCli

### Community 1022 - "TestActiveStrategy"
Cohesion: 0.29
Nodes (3): parametrize, A typo must not silently pick some other distribution., TestActiveStrategy

### Community 1023 - "delegate_seo_findings"
Cohesion: 0.29
Nodes (7): build_seo_roadmap(), delegate_seo_findings(), plan_seo_sprint(), post, Create real agent tasks from the audit's delegation plan. Each work package…, Build a Now/Next/Later roadmap from the audit's delegation plan. Converts each…, Plan an agile sprint from the audit's delegation plan. Converts delegation…
...
### Community 1039 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 1040 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 1041 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 1042 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 1043 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 1044 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 1047 - "apply_phase1_changes.py"
Cohesion: 0.33
...
### Community 1050 - "gen_screenshots.py"
Cohesion: 0.47
...
### Community 1052 - "Workspace Issues"
Cohesion: 0.29
...
### Community 1054 - "setup-claude-code.sh script"
Cohesion: 0.60
Nodes (5): log_error(), log_info(), log_success(), print_header(), setup-claude-code.sh script

### Community 1057 - "test_seo_audit_pending_expiry.py"
Cohesion: 0.43
...
### Community 1060 - "test_catalogue_probe.py"
Cohesion: 0.33
...
### Community 1062 - "openclaw_mobile_ui"
Cohesion: 0.33
...
### Community 1079 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 1080 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 1081 - "Runtime troubleshooting"
Cohesion: 0.40
Nodes (4): Agent mode timeout, Missing binary / task harness, Runtime troubleshooting, Workspace validation failures

### Community 1082 - "knowledgeGraphTab.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 1083 - "loginFlowNoTimeout.test.js"
Cohesion: 0.40
Nodes (4): apiSource, { describe, test, expect }, fs, path

### Community 1084 - "test_company_stale_id_recovery.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 1085 - "worker_no_cache.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, workerSource

### Community 1086 - "scripts/agile_ceremonies.py"
Cohesion: 0.60
...
### Community 1103 - "test_agent_runtime_wrapper.py"
Cohesion: 0.70
...
### Community 1104 - "TestSupportMatrixDocsSync"
Cohesion: 0.29
...
### Community 1105 - "TestNoKeyEverReachesTheLog"
Cohesion: 0.40
...
### Community 1106 - "TestTheProbeIdentifiesItself"
Cohesion: 0.40
...
### Community 1108 - "TestModelRoleSeparation"
Cohesion: 0.40
...
### Community 1111 - "resolve_hermes_base_url"
Cohesion: 0.47
...
### Community 1112 - "recovery.py"
Cohesion: 0.67
Nodes (3): detect_secrets(), main(), Recover CHANGELOG.md from a Git merge conflict in its [Unreleased] block. Pre-…

### Community 1113 - "._calculate_completeness_score"
Cohesion: 0.33
Nodes (3): Compute the completeness score (0.0–1.0) for a company's graph. Loads the graph…, Update a company graph. Args: graph: CompanyGraph instance to update Returns:…, Calculate the completeness score for a company graph. Args: graph: CompanyGraph…

### Community 1114 - "TestDirectChatAgentExecution"
Cohesion: 0.33
...
### Community 1138 - "github"
Cohesion: 0.50
Nodes (3): github, enabled, silent

### Community 1143 - "test_llm_router_tpm.py"
Cohesion: 0.15
...
### Community 1144 - "Agent API Issues"
Cohesion: 0.40
...
### Community 1161 - "Network and Tunnel Issues"
Cohesion: 0.40
...
### Community 1266 - "verify_pr_exists"
Cohesion: 0.50
...
### Community 1269 - "run_seo_pipeline"
Cohesion: 0.50
Nodes (4): Response for the full SEO → Agile pipeline endpoint., Run the full pipeline: SEO audit → Portfolio → Roadmap → Sprint. This is the…, run_seo_pipeline(), SeoPipelineResponse

### Community 1270 - "Authentication Issues"
Cohesion: 0.50
Nodes (4): 401 Unauthorized, 403 Forbidden from remote machine, 429 Too Many Requests, Authentication Issues

### Community 1271 - "Feature Maturity Issues"
Cohesion: 0.50
...
### Community 1272 - "Claude Code Specific Issues"
Cohesion: 0.50
...
### Community 1275 - "_clean_director"
Cohesion: 0.50
...
### Community 1299 - "test_skills_route_order.py"
Cohesion: 0.67
...
### Community 1303 - "test_the_reserve_is_bounded_when_read_from_the_environment"
Cohesion: 0.67
...
## Knowledge Gaps
- **3458 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3453 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 13199 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **112 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `_fixture()` connect `_fixture` to `test_brain_patch_service_token.py`, `test_ceo_router.py`, `llm/router.py`, `ExecutionRequest`, `TaskSpec`, `PolicyEngine`, `TaskStore`, `models/company_graph.py`, `TaskWorkflowService`, `AuditLog`, `SelfHealingAgent`, `Task`, `AgentJobManager`, `test_company_api.py`, `TestAuthAndTaskOwnership`, `test_unit8_model_catalog.py`, `ImprovementLoop`, `Agency`, `test_failover_client_shared.py`, `E2BSandboxSession`, `test_catalogue_probe.py`, `services/seo_audit.py`, `UsageEvent`, `routing.py`, `PrimeAgentAdapter`, `resolve_active_brain`, `workflow/api.py`, `CEOSupervisor`, `SeoFixRequest`, `test_agent_tool_governance.py`, `test_model_router.py`, `test_openclaw_endpoints.py`, `test_orchestrator_merge_decision.py`, `direct_chat.py`, `test_task_service_failed_comment.py`, `clear_cooldowns`, `test_sam_livekit.py`, `ChatHistoryStore`, `ArtifactStore`, `SQLiteStore`, `get_task_store`, `test_telegram_auto_approve.py`, `ResearchTask`, `TestClient`, `test_autonomy_status.py`, `test_procedural_memory.py`, `test_langfuse_agency_wide.py`, `test_local_brain_state.py`, `test_phase5_doctor.py`, `test_startup_warmup.py`, `test_refresh_agent_built_proof.py`, `test_telegram_diag_endpoint.py`, `run_task`, `cost_tracker.py`, `BackgroundAgent`, `UserRole`, `test_context_rulebook.py`, `test_llm_router_tpm.py`, `e2e/test_browser.py`, `test_provider_router.py`, `BrainWatchdog`, `KeyStore`, `test_issue_intake.py`, `test_llm_router_queue_cache.py`, `_step`, `ProviderRouter`, `test_trend_scoping.py`, `_clean_phases`, `diagnostics.py`, `claim`, `MCPClient`, `persist_plan_spec`, `config.py`, `TestRouterIntegration`, `test_daily_2026_07_27.py`, `_clear_cache`, `test_openclaw_gateway.py`, `NotificationDispatcher`, `OllamaCircuitBreaker`, `test_telegram_webhook.py`, `_job_text`, `BudgetTracker`, `emit_chat_observation`, `test_features_api.py`, `test_new_features_e2e.py`, `test_video_transcript.py`, `test_llm_router_resilience.py`, `test_process_quick_note_workflow.py`, `_Budget`, `allow_paid`, `TrendWatcher`, `TestMongoGate`, `TestRuntimeControl`, `test_portfolio_intake.py`, `test_trend_watcher.py`, `test_e2b_data_flow.py`, `TestClient`, `test_webui_provider_priority.py`, `ContextPruner`, `TestEstimateTokensForMessages`, `test_control_plane_api.py`, `test_agile_api.py`, `test_app_settings.py`, `AgentSwarm`, `WorkflowBuildRequest`, `test_persistent_memory.py`, `SecurityScanner`, `test_task_clarification.py`, `_clean_director`, `test_llm_router_e2e.py`, `OutputFilter`, `test_platform_controls.py`, `test_rate_limiter.py`, `test_brain_failover.py`, `test_sam_voice.py`, `OrchestratorQueue`, `test_nvidia_model_discovery.py`, `session_retro.py`, `test_llm_router_disabled.py`, `test_purge_backlog.py`, `test_provider_enable_disable.py`, `OrchestratorCheckpointStore`, `analyze_page`, `DirectChatDoctor`, `capture_screens.py`, `_resolve_push_token`, `test_agent_scripts_share_one_model_list.py`, `test_crispy_burn_in.py`, `test_skill_registry_boot_refresh.py`, `FeatureMaturity`, `isolated_telegram_config`, `test_scheduler_hydration_bounded.py`, `clear_override`, `test_dashboard_cache.py`, `_start_ceo_agency`, `_undeclared`, `test_service_token.py`, `test_harness_spec.py`, `routed`, `test_brain_failover_413.py`, `test_regression.py`, `test_agency_fix.py`, `api_keys_for`, `TestHarnessAdapter`, `test_monitor_lib.py`, `test_v4_api.py`, `timedelta`, `SchedulerStore`, `get_improvement_loop`, `test_knowledge_sync.py`, `test_ping.py`, `test_runtimes_health_endpoint.py`, `TestNormalizeResponseFormat`, `test_task_store_fails_loud_in_production.py`, `test_provider_state_durability.py`, `test_kimi_bridge_server.py`, `.record`, `test_voice_pipeline.py`, `client`, `TestTheWorkflowIsSafeAndReadOnly`, `test_doctor_coding_brain.py`, `get_self_healing_agent`, `parse_event_stream`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `ExecutionRequest`, `ReactScratchpad`, `backend/server.py`, `proxy.py`, `ContextManager`, `PolicyEngine`, `TaskSpec`, `diagnostics.py`, `test_governance_api.py`, `MCPClient`, `test_brain_failover_413.py`, `test_ceo_micromanager.py`, `AgentJobManager`, `AgentSessionStore`, `Agency`, `StuckDetector`, `E2BSandboxSession`, `test_failover_client_shared.py`, `MultiAgentSwarm`, `test_e2b_adapter.py`, `test_empirical_verify.py`, `routing.py`, `FreeBuffAgent`, `resolve_active_brain`, `LocalWorkspace`, `test_agent_chat_integration.py`, `TestInternalAgentAdapterProviderChain`, `test_agent_tool_governance.py`, `WorkspaceTools`, `direct_chat.py`, `call_llm`, `loop.py`, `TestAgentLoopMCPIntegration`, `test_ceo_supervision.py`, `UserMemoryStore`, `test_ceo_dispatcher.py`, `AdaptiveHalter`, `ContextPruner`, `TokenBudget`, `InternalAgentAdapter`, `GitHubTools`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderRouter` to `ProviderConfig`, `backend/server.py`, `AnthropicProvider`, `TestLegacyRouterServerFallback`, `test_bedrock_live.py`, `TestRouterIntegration`, `Provider`, `kimi_bridge_provider_config`, `test_colibri_brain_shim.py`, `TestFromEnvBedrock`, `TestLegacyRouterCacheTTL`, `direct_chat.py`, `call_llm`, `clear_cooldowns`, `test_chat_mode_regressions.py`, `test_anthropic_refusal_fallback.py`, `failover_client.py`, `TrafficDirector`, `TestAnthropicPayloadStructuredOutput`, `NvidiaProvider`, `TestOpenAiToBedrockConverse`, `test_all_providers_discovery.py`, `test_provider_router.py`, `model_discovery.py`, `test_anthropic_router.py`, `implement_agent.py`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Are the 214 inferred relationships involving `HTTPException` (e.g. with `activate_instance()` and `change_user_role()`) actually correct?**
  _`HTTPException` has 214 INFERRED edges - model-reasoned connections that need verification._
...
- **Are the 66 inferred relationships involving `ProviderRouter` (e.g. with `_build_provider_router()` and `NvidiaProvider`) actually correct?**
  _`ProviderRouter` has 66 INFERRED edges - model-reasoned connections that need verification._
