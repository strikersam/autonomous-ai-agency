# Graph Report - pr1313c  (2026-08-21)

## Corpus Check
- 1444 files · ~2,079,341 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 28775 nodes · 53737 edges · 1200 communities (1090 shown, 110 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 2639 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `18e2daa2`
...
## Communities (1200 total, 110 thin omitted)

### Community 0 - "backend/server.py"
Cohesion: 0.02
Nodes (271): admin_seed(), _agent_timeout_fallback_response(), AgentStatusEntry, AgentStatusResponse, AgentToolCallEntry, ApiKeyCreate, auth_me(), AuthorizeReposBody (+263 more)

### Community 1 - "LLMRequest"
Cohesion: 0.02
Nodes (156): ProviderConfig, One configured endpoint. ``kind`` selects the adapter: ``openai`` (any OpenAI-…, AnthropicProvider, Any, AsyncClient, packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, Translate OpenAI-shaped messages into Anthropic's system/turn split., OpenAI carries a tool result as role="tool" with a tool_call_id; Anthropic… (+148 more)
...
Cohesion: 0.02
Nodes (109): base_url(), mobile_page(), proxy_url(), Config, pytest_configure(), conftest.py — pytest fixtures and configuration for the E2E test suite.…, A browser page pre-configured for mobile viewport (390×844 — iPhone 14)., _clean_env() (+101 more)

### Community 5 - "company_api.py"
Cohesion: 0.03
Nodes (148): ephemeral_ttl_hours(), Async read of the ephemeral TTL (hours) straight from the DB., account_lifecycle(), AccountLifecycleResponse, auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint() (+140 more)

### Community 6 - "WebsiteScanner"
Cohesion: 0.03
Nodes (113): ApprovalPolicy, BusinessSystem, CompanyCreateRequest, CompanyGraphResponse, CompanyGraphSnapshot, CompanyResponse, CompanyUpdateRequest, Connector (+105 more)

### Community 7 - "TaskWorkflowService"
Cohesion: 0.03
Nodes (85): AgentDefinition, AgentStore, Any, field_validator, agents/store.py — Persistent store for user-defined agent configurations.…, CRUD store for AgentDefinition objects. Uses MongoDB when a `db` client is…, Return an agent by ID. If *owner_id* is provided, enforces that the agent…, Delete an agent. Returns True on success, False if not found/unauthorised. (+77 more)
...
Cohesion: 0.03
Nodes (83): Test hook — clear all usage accounting., reset(), CacheManager, cosine_similarity(), _Entry, get_cache(), LRUCache, payload_key() (+75 more)

### Community 11 - "brain_config.py"
Cohesion: 0.03
Nodes (107): BrainConfig, BrainConfigPatch, BrainConfigStore, default_brain_config(), get_brain_config(), get_brain_config_store(), invalidate_brain_config_cache(), _provider_env_value() (+99 more)

### Community 12 - "AgentRunner"
Cohesion: 0.03
Nodes (103): AgentPhaseError, AgentRunner, Exception, Return True when no file is touched by more than one step., Raised when a named agent phase (planning, verification, etc.) fails., GATE: Golden Path steps #7-12 — the primary agent execution loop. This is the…, Set a per-session token spend cap (★3 rollout token budget). When *cap* > 0 the…, Record token spend for *session_id* and enforce the budget cap. Logs a warning… (+95 more)

### Community 13 - "test_model_router.py"
Cohesion: 0.03
...
Cohesion: 0.04
Nodes (68): Called by APScheduler when a cron fires. Dispatches to the orchestrator. This…, _scheduler_on_fire(), BoundContext, ExecutionRequest, ExecutionResult, get_workflow_orchestrator(), JudgeVerdict, MonitorOutput (+60 more)
...
Cohesion: 0.03
Nodes (67): NotificationDispatcher, Any, Path, service_manager.py — Telegram & Notification Integration Extension Extends the…, Start the Telegram bot. Returns True if started successfully., Signal the bot to stop and wait for graceful shutdown., Run the Telegram bot long-poll loop (inline, not subprocess)., Run the bot with stop-event awareness. (+59 more)

### Community 24 - "test_llm_router_resilience.py"
Cohesion: 0.03
Nodes (73): Backoff policy for retryable failures., RetryConfig, BreakerState, str, _digest(), get_ring(), KeyRing, KeyState (+65 more)

### Community 25 - "PolicyEngine"
Cohesion: 0.04
Nodes (76): _egress_policy_reason(), agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Return why governance policy blocks *host*, or None. Runs strictly *after* the…, governance_enabled(), True when the governance layer should run at all. A single global off switch…, _action_matches(), _as_list(), Decision (+68 more)

### Community 26 - "ImprovementLoop"
Cohesion: 0.05
Nodes (67): DetectedIssue, ImprovementLoop, ImprovementLoopState, IssueCategory, IssueSeverity, _now(), Any, Enum (+59 more)
...
### Community 29 - "test_webui_provider_priority.py"
Cohesion: 0.06
Nodes (59): AdminIdentity, _fake_user_auth(), Path, test_admin_can_create_anthropic_provider_via_webui_admin_api(), test_admin_can_create_provider_via_webui_admin_api(), test_ui_providers_and_workspaces_use_app_state(), _bootstrap(), Path (+51 more)

### Community 30 - "TaskStore"
Cohesion: 0.04
Nodes (74): Any, Task, TaskStatus, Fail loud in production if no persistent storage is configured. Telegram…, Create a task. Deduplicates by source_id if set (Charter G3). If a task with…, Fetch a task by ID. If owner_id is set, enforces ownership., Return the task previously created for an external ``source_id`` (e.g.…, List tasks for a specific user with optional filters. ``include_system``… (+66 more)

### Community 31 - "loop.py"
Cohesion: 0.04
Nodes (51): _check_extra_kwargs(), _enforce_signature(), _note_phase_end(), _note_phase_start(), _nvidia_api_key(), Any, Path, loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures. (+43 more)
...
### Community 37 - "workflow/api.py"
Cohesion: 0.04
Nodes (52): When coder == reviewer model, swarm should log a warning., _fake_artifact(), _make_engine(), tests/test_crispy_workflow.py — CRISPY workflow engine hardening tests. Tests…, Provide isolated DB + artifact + workspace paths., Create a WorkflowEngine with isolated storage., TestAbortOnFailure, TestPhaseSequence (+44 more)
...
Cohesion: 0.06
Nodes (62): HealthConfig, Strategy selection and degradation behaviour., Circuit breaker + health tracking thresholds., RoutingConfig, HealthTracker, _Outcome, ProviderHealth, Any (+54 more)

### Community 40 - "test_mcp_registry.py"
Cohesion: 0.05
...
### Community 45 - "test_brain_availability_doctor.py"
Cohesion: 0.05
Nodes (58): brain_availability_summary(), Non-secret answer to "can the brain answer a request right now?". Three callers…, Record the goal and its sub-tasks in the ledger before any work runs. Writing…, Attempt, _backend(), CEOLedger, get_ceo_ledger(), GoalRecord (+50 more)
...
### Community 47 - "ProviderConfig"
Cohesion: 0.05
Nodes (73): _acquire_provider_probe(), extract_openai_text(), is_commercial_provider(), _normalize_nvidia_base_url(), _openai_url(), provider_access_tier(), _provider_field(), provider_sort_key() (+65 more)
...
### Community 54 - "get_task_store"
Cohesion: 0.05
Nodes (72): quick_notes_submit(), _QuickNoteBody, Submit a quick-note URL or instruction from the dashboard FAB., Path, Start RuntimeManager, TaskDispatcher, SCHEDULER, and self-bootstrap. Returns a…, start_background_services(), get_failover_manager(), Return the singleton BrainFailoverManager. (+64 more)
...
### Community 64 - "RepowiseIntelligence"
Cohesion: 0.05
...
### Community 66 - "TestAdapterMetadata"
Cohesion: 0.04
...
### Community 69 - "services/background.py"
Cohesion: 0.05
Nodes (63): get_improvement_loop(), get_trend_watcher(), set_trend_watcher(), _await_hermes_ready(), BackgroundServices, _env_float(), _env_on(), Any (+55 more)
...
### Community 71 - "DashboardLayout.js"
Cohesion: 0.06
...
Cohesion: 0.04
Nodes (50): ProviderUpdate, Resolve the LLM endpoint for agent execution (module-level, #522 failover).…, _resolve_brain_provider(), Regression tests for: brain-skip-paid, provider-priority persistence, scanner…, Critical failover-safety test: if every free provider's base URL is excluded…, When the ONLY configured provider is a paid one (e.g. operator set…, When only Anthropic is configured AND allow_paid=False (default), the resolver…, The PUT /api/providers/{id} endpoint did not persist priority edits because the… (+42 more)

### Community 76 - "enforcement.py"
Cohesion: 0.04
Nodes (53): _load(), Import the governance layer once, recording why if it is absent., events_from_identity(), Convenience: build and record an event in one call., Extract the identity-derived audit fields from an AgentIdentity. Kept here…, record_event(), BudgetExceeded, classify() (+45 more)

### Community 77 - "BackgroundAgent"
Cohesion: 0.06
...
Cohesion: 0.04
Nodes (37): BusinessCategory, A company website with detected systems and stack inference., Website, CompanyGraphService, Company, SpecialistFamily, SystemType, Workflow (+29 more)

### Community 83 - "FeatureMatrix"
Cohesion: 0.05
...
### Community 85 - "CEODispatcher"
Cohesion: 0.06
Nodes (50): CEODispatcher, CEOResult, _complexity_rank(), _decompose_into_subtasks(), _merge_changed_files(), _offload(), Any, Semaphore (+42 more)
...
### Community 88 - "test_ai_insights.py"
Cohesion: 0.05
...
### Community 95 - "test_user_research_skill.py"
Cohesion: 0.06
...
### Community 98 - "test_llm_router_tpm.py"
Cohesion: 0.05
...
Cohesion: 0.06
Nodes (27): AgentJobError, AgentJobRequest, AgentJobResult, AgentJobSnapshot, Any, BaseModel, field_validator, agent/contract.py — Typed public contract for the agent job lifecycle. Phase 1… (+19 more)

### Community 100 - "test_sam_voice.py"
Cohesion: 0.04
...
Cohesion: 0.07
Nodes (59): get_decisions_store(), Process-wide DecisionsStore singleton (resettable via db_path arg)., _admin_headers(), _answer_callback(), _api_headers(), _check_rate_limit(), cmd_control(), cmd_cost() (+51 more)
...
Cohesion: 0.05
Nodes (37): Result of provisioning a specialist., A specialist agent that can be provisioned for company-specific tasks., Check if this specialist can handle a task with given capabilities., Specialist, SpecialistProvisionResult, Any, SpecialistFamily, SystemType (+29 more)
...
### Community 125 - "AgentSessionStore"
Cohesion: 0.07
...
### Community 137 - "test_kimi_bridge_server.py"
Cohesion: 0.05
...
### Community 139 - "test_web_reach.py"
Cohesion: 0.08
...
### Community 145 - "OnboardingService"
Cohesion: 0.06
Nodes (35): OnboardingService, Workflow, Detect the Git provider from a repository URL. Args: repo_url: Repository URL…, Start the onboarding process for a company. Args: company_id: Company ID…, Schedule a fire-and-forget background task, keeping a strong reference.…, Force-refresh the dynamic skill registry and log tech-stack recommendations.…, Activate a company's 24x7 agency runtimes in the background. Runs after…, Get the current onboarding progress for a company. Args: company_id: Company ID… (+27 more)
...
### Community 147 - "test_bedrock_provider.py"
Cohesion: 0.06
...
### Community 148 - "test_mcp_governance.py"
Cohesion: 0.07
Nodes (46): get_audit_log(), Return the process-wide audit log, created on first use., Replace the process-wide engine. Tests only., reset_policy_engine(), Minimal stand-in exposing only what the governance seam touches., The wrapper must be a pass-through in observe mode., A tool that raises must still raise — governance may not swallow errors., Per-session budgets and audit correlation both depend on this. (+38 more)
...
### Community 152 - "test_portfolio_intake.py"
Cohesion: 0.07
...
### Community 155 - "test_ceo_router.py"
Cohesion: 0.07
...
### Community 162 - "PatternConsolidation"
Cohesion: 0.08
...
### Community 163 - "OnboardingScreen.jsx"
Cohesion: 0.05
...
### Community 169 - "portfolio_intelligence.py"
Cohesion: 0.07
...
### Community 172 - "failover_client.py"
Cohesion: 0.06
...
### Community 175 - "test_platform_controls.py"
Cohesion: 0.06
...
### Community 180 - "CompanyGraph"
Cohesion: 0.05
Nodes (28): detect_company_id(), DirectChatSession, handle_chat_message_with_context(), Direct chat session with Company Graph context binding., Bind a company to this chat session and load its Company Graph., Bind a repository to this chat session., Get the bound Company Graph., Get enriched context including Company Graph data. (+20 more)

### Community 181 - "Feature Guide"
Cohesion: 0.06
...
### Community 182 - "test_agent_free_brain.py"
Cohesion: 0.05
...
### Community 190 - "resolve_active_brain"
Cohesion: 0.09
...
### Community 193 - "test_governance_api.py"
Cohesion: 0.08
Nodes (42): build_governance_router(), Any, APIRouter, backend/governance_router.py — read and operate the governance layer. Mounted…, Reject non-admin callers. Mirrors the RBAC check used elsewhere in this backend…, _require_admin(), get_approval_store(), Replace the process-wide gate. Tests only. (+34 more)

### Community 194 - "_get_provider_policy"
Cohesion: 0.07
...
### Community 195 - "strategies.py"
Cohesion: 0.08
Nodes (39): count, adaptive(), automatic_failover(), Candidate, context_length_optimized(), cost_optimized(), _counter(), fallback_chain() (+31 more)
...
### Community 201 - "control_overrides.py"
Cohesion: 0.07
...
### Community 205 - "test_runtime_governance.py"
Cohesion: 0.12
...
### Community 206 - "TestBrainFailoverModelUpdates"
Cohesion: 0.08
...
### Community 215 - "test_operational_incidents.py"
Cohesion: 0.05
...
### Community 218 - "Kept Rules — the 44 that survive the audit"
Cohesion: 0.05
...
### Community 219 - "test_daily_2026_06_04.py"
Cohesion: 0.08
...
### Community 224 - "PortfolioManager"
Cohesion: 0.07
...
### Community 228 - "test_colibri_brain_shim.py"
Cohesion: 0.09
...
### Community 229 - "TestRecordUsageAndStats"
Cohesion: 0.05
...
### Community 233 - "chat_handlers.py"
Cohesion: 0.10
...
### Community 236 - "analyze_quantitative"
Cohesion: 0.09
...
### Community 237 - "agents/agile_ceremonies.py"
Cohesion: 0.07
...
### Community 239 - "test_pr923_fixes.py"
Cohesion: 0.07
...
### Community 240 - "RuntimeCapabilityRegistry"
Cohesion: 0.10
...
### Community 245 - "get_doctor_diagnostics"
Cohesion: 0.07
Nodes (36): _build_provider_router(), _builtin_provider_records(), _chat_provider_policy(), _DoctorCheck, _DoctorReport, _fallback_local_provider_record(), get_doctor_diagnostics(), get_doctor_report() (+28 more)
...
### Community 247 - "provider_max_rpm"
Cohesion: 0.08
...
### Community 252 - "CEOSupervisor"
Cohesion: 0.08
Nodes (22): get_ceo_dispatcher(), Return the shared CEODispatcher singleton., Reset the singleton (test helper)., reset_ceo_dispatcher(), CEOSupervisor, Any, What one sweep observed and did. Returned for tests and diagnostics., Sweeps the CEO ledger and drives open goals to closure. (+14 more)
...
### Community 254 - "WorkflowBuildRequest"
Cohesion: 0.08
...
### Community 257 - "get_tool_annotations"
Cohesion: 0.08
...
### Community 260 - "provider_base_url"
Cohesion: 0.06
Nodes (28): _brain_provider_status(), get_brain_policy_route(), Return per-provider metadata for the GET endpoint. Iterates every provider in…, Return the discovered model list for *provider_id*, or ``[]`` if unknown., Return the active brain config + per-provider key-present flags. The response…, _served_models(), provider_base_url(), provider_key_present() (+20 more)
...
### Community 264 - "test_all_providers_discovery.py"
Cohesion: 0.16
...
### Community 267 - "model_discovery.py"
Cohesion: 0.08
...
### Community 268 - "test_anthropic_router.py"
Cohesion: 0.09
...
### Community 269 - "test_llm_router_e2e.py"
Cohesion: 0.14
...
### Community 272 - "OrchestratorSupervisor"
Cohesion: 0.09
...
### Community 273 - "agent_runtime.py"
Cohesion: 0.10
...
### Community 275 - "BrainFailoverExhausted"
Cohesion: 0.10
...
### Community 280 - "ContextCompressor"
Cohesion: 0.11
...
### Community 283 - "ResourceWatchdog"
Cohesion: 0.10
...
### Community 284 - "LlmProviderConfig"
Cohesion: 0.15
...
### Community 285 - "DashboardScreen.jsx"
Cohesion: 0.07
...
### Community 289 - "test_llm_router_disabled.py"
Cohesion: 0.11
...
### Community 290 - "skill_bindings.py"
Cohesion: 0.09
...
### Community 295 - "brain_failover.py"
Cohesion: 0.10
...
### Community 297 - "test_brain_failover.py"
Cohesion: 0.12
...
### Community 298 - "OrchestratorQueue"
Cohesion: 0.07
...
### Community 299 - "get_skill_bindings"
Cohesion: 0.09
...
### Community 302 - "operational_incidents.py"
Cohesion: 0.11
...
### Community 313 - "session_retro.py"
Cohesion: 0.13
...
### Community 314 - "test_portfolio_intelligence.py"
Cohesion: 0.07
...
### Community 317 - "openclaw_gateway.py"
Cohesion: 0.09
...
### Community 318 - "Workspace Isolation Architecture"
Cohesion: 0.06
...
### Community 325 - "test_autonomy_gate.py"
Cohesion: 0.13
...
### Community 329 - "control_registry.py"
Cohesion: 0.12
...
### Community 331 - "parse_event_stream"
Cohesion: 0.09
...
### Community 334 - "CompanyAgencyService"
Cohesion: 0.09
...
### Community 335 - "test_internal_agent_did_work.py"
Cohesion: 0.12
...
### Community 343 - "test_provider_enable_disable.py"
Cohesion: 0.09
...
### Community 345 - "test_direct_chat_evolution.py"
Cohesion: 0.12
...
### Community 349 - "Deploy: FreeBuff Telegram bot (24×7)"
Cohesion: 0.07
...
### Community 350 - "Claude Code + Qwen Local Setup"
Cohesion: 0.07
...
### Community 351 - "SetupWizardPage.js"
Cohesion: 0.11
...
### Community 352 - "AgentsScreen.jsx"
Cohesion: 0.11
...
### Community 354 - "test_north_mini_code.py"
Cohesion: 0.08
...
### Community 355 - "test_provider_state_durability.py"
Cohesion: 0.10
...
### Community 358 - "validate_outbound_url"
Cohesion: 0.14
...
### Community 370 - "workflow_orchestrator.py"
Cohesion: 0.10
Nodes (21): _get_ceo_dispatcher(), MergeDecision, _orchestrator_bypass(), Phase, Enum, services/workflow_orchestrator.py — Canonical Execution Backbone THE single…, G5: resolve how a run should land from the company's DeliveryPolicy. Returns…, Execute the plan via the selected specialist(s). (+13 more)
...
### Community 378 - "Session Handoff — 2026-06-15"
Cohesion: 0.08
...
### Community 379 - "TASK 4 — End-to-end approval-gate test"
Cohesion: 0.08
...
### Community 380 - "autonomous_fix.py"
Cohesion: 0.14
...
### Community 381 - "self_heal_brain_and_unblock_tasks"
Cohesion: 0.08
Nodes (24): emit_agency_observation(), Record an agency platform operation in Langfuse. Unlike…, Any, Background tick that runs self_heal_brain_and_unblock_tasks(). Called from the…, One-shot self-healing pass. 1. Checks if the active brain provider is in a…, self_heal_brain_and_unblock_tasks(), _self_heal_tick(), tests/test_self_heal.py — tests for PR #937 self-healing mechanism. No… (+16 more)

### Community 382 - "test_claude_code_adapter.py"
Cohesion: 0.14
...
### Community 383 - "_InMemoryBackend"
Cohesion: 0.11
...
### Community 394 - "Traffic Distribution Across Providers"
Cohesion: 0.08
...
### Community 401 - "test_agency_fix.py"
Cohesion: 0.08
...
### Community 402 - "TestDetectedSystemPersistence"
Cohesion: 0.09
...
### Community 403 - "test_skill_registry.py"
Cohesion: 0.09
...
### Community 404 - "test_telegram_mutating_commands.py"
Cohesion: 0.08
...
### Community 407 - "_status_snapshot"
Cohesion: 0.15
...
### Community 408 - "_resolve_user_github_token"
Cohesion: 0.16
...
### Community 409 - "Agent Governance Guide"
Cohesion: 0.09
...
### Community 410 - "The fifteen strategies"
Cohesion: 0.09
...
### Community 419 - "test_monitor_lib.py"
Cohesion: 0.11
...
### Community 424 - "HarnessEnrichment"
Cohesion: 0.14
...
### Community 426 - "AdaptivePermissions"
Cohesion: 0.18
...
### Community 434 - "reap_expired_companies"
Cohesion: 0.15
...
### Community 439 - "V3 API Migration Plan — LLM Relay Platform"
Cohesion: 0.10
...
### Community 440 - "PortfolioScreen.jsx"
Cohesion: 0.10
...
### Community 453 - "Design Audit"
Cohesion: 0.10
Nodes (19): Code Quality, Color and Surfaces, Component Patterns, Content, Design Audit, Fix Priority, How This Works, Iconography (+11 more)

### Community 454 - "Findings"
Cohesion: 0.10
...
### Community 458 - "Docker AI Governance Audit — Final Report"
Cohesion: 0.10
...
### Community 459 - "1. Capability-by-capability"
Cohesion: 0.10
...
### Community 461 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 462 - "ControlsScreen.jsx"
Cohesion: 0.15
...
### Community 468 - "PriorityTaskQueue"
Cohesion: 0.15
...
### Community 469 - "ApprovalCheckpoint"
Cohesion: 0.14
...
### Community 473 - "test_tasks_cache_ttl_env.py"
Cohesion: 0.21
...
### Community 474 - "test_voice_pipeline.py"
Cohesion: 0.14
...
### Community 478 - "_extract_tech_relevance"
Cohesion: 0.17
...
### Community 482 - "Analysis & Synthesis Instructions"
Cohesion: 0.11
Nodes (18): 1. Define the Atmosphere, 2. Map the Color Palette, 3. Establish Typography Rules, 4. Define the Hero Section, 5. Describe Component Stylings, 6. Define Layout Principles, 7. Define Responsive Rules, 8. Encode Motion Philosophy (+10 more)

### Community 483 - "Production Readiness Assessment — local-llm-server"
Cohesion: 0.11
...
### Community 485 - "Skill: fabric-patterns"
Cohesion: 0.11
Nodes (18): 1. Ensure Pattern Directory Exists, 2. List Available Patterns, 3. Retrieve a Pattern, 4. Apply a Pattern with Variables, 5. Stitch Patterns Together, 6. Create New Patterns, Acceptance Checks, Directory Structure (+10 more)

### Community 486 - "db/__init__.py"
Cohesion: 0.14
...
### Community 487 - "Admin Dashboard Guide"
Cohesion: 0.11
...
### Community 488 - "Implementation Plan"
Cohesion: 0.11
...
### Community 490 - "Delegation Plan (agent-ready work packages)"
Cohesion: 0.11
...
### Community 491 - "test_p0_roadmap_a4_a5_b2.py"
Cohesion: 0.15
...
### Community 493 - "test_scanner_security.py"
Cohesion: 0.15
...
### Community 494 - "test_task_source_id_race.py"
Cohesion: 0.17
...
### Community 501 - "Comprehensive Skill Index (By Category)"
Cohesion: 0.11
...
### Community 502 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 503 - "Component Map"
Cohesion: 0.11
...
### Community 504 - "Agent State — colibri GLM-5.2 deployment (resumable)"
Cohesion: 0.11
...
### Community 505 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
...
### Community 507 - "Part A — Health Report"
Cohesion: 0.11
...
### Community 510 - "sync_readme_gallery.py"
Cohesion: 0.22
...
### Community 511 - "test_p0_roadmap_b3_b4_b5.py"
Cohesion: 0.16
...
### Community 514 - "test_company_api.py"
Cohesion: 0.11
...
### Community 515 - "test_langfuse_agency_wide.py"
Cohesion: 0.11
...
### Community 516 - "TestStopSlopChecker"
Cohesion: 0.11
...
### Community 517 - "handle_workflow_ide_chat"
Cohesion: 0.18
...
### Community 520 - "cowork_session.py"
Cohesion: 0.15
...
### Community 521 - "SKILL: Industrial Brutalism & Tactical Telemetry UI"
Cohesion: 0.12
...
### Community 522 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 523 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 524 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 525 - "Section-by-Section Acceptance Criteria"
Cohesion: 0.12
...
### Community 527 - "FeatureUnavailableError"
Cohesion: 0.13
...
### Community 530 - "kimi_bridge_provider_config"
Cohesion: 0.18
...
### Community 531 - "agent_readiness_audit.py"
Cohesion: 0.21
...
### Community 534 - "test_activation_api.py"
Cohesion: 0.21
...
### Community 535 - "test_health_endpoints.py"
Cohesion: 0.17
...
### Community 536 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 537 - "test_openclaw_endpoints.py"
Cohesion: 0.12
...
### Community 543 - "Skill: repowise-intelligence"
Cohesion: 0.12
...
### Community 544 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
...
### Community 545 - "_valid_login_state"
Cohesion: 0.24
...
### Community 546 - "Skill: repowise-intelligence"
Cohesion: 0.12
Nodes (15): 1. Graph Intelligence (Dependency Graph), 2. Git Intelligence, 3. Documentation Intelligence, 4. Decision Intelligence, Acceptance Checks, Directory Structure, Example Usage, Implementation Approach (+7 more)

### Community 547 - "The 10-Step Workflow"
Cohesion: 0.12
...
### Community 548 - "Contributing to local-llm-server"
Cohesion: 0.12
...
### Community 549 - "refresh_agent_built_proof.py"
Cohesion: 0.20
...
### Community 550 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 551 - "Feature Maturity / Support Matrix"
Cohesion: 0.12
...
### Community 564 - "_process_task_callback"
Cohesion: 0.28
...
### Community 565 - "test_autonomy_status.py"
Cohesion: 0.12
...
### Community 566 - "test_brain_failover_413.py"
Cohesion: 0.13
...
### Community 567 - "DailyDigestAggregatorTests"
Cohesion: 0.19
...
### Community 568 - "test_dockerfile_ships_root_modules.py"
Cohesion: 0.17
...
### Community 570 - "test_glm52_brain.py"
Cohesion: 0.12
...
### Community 571 - "test_local_brain_state.py"
Cohesion: 0.12
...
### Community 575 - "test_refresh_agent_built_proof.py"
Cohesion: 0.12
...
### Community 576 - "test_telegram_diag_endpoint.py"
Cohesion: 0.12
...
### Community 580 - "CollaborationContext"
Cohesion: 0.17
...
### Community 581 - "Skill: agent-harness"
Cohesion: 0.13
...
### Community 582 - "Skill: checkpoint-strategy"
Cohesion: 0.13
...
### Community 584 - "Skill: local-ai-query"
Cohesion: 0.13
...
### Community 585 - "Skill: parallel-agents"
Cohesion: 0.13
...
### Community 586 - "Skill: parallel-worktrees"
Cohesion: 0.13
...
### Community 587 - "Design System: Taste Standard"
Cohesion: 0.13
...
### Community 589 - "_check_storage_health"
Cohesion: 0.13
...
### Community 590 - "Skill: user-research"
Cohesion: 0.13
...
### Community 591 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 594 - "router/health.py"
Cohesion: 0.20
...
### Community 595 - "DockerAgentAdapter"
Cohesion: 0.17
...
### Community 596 - "TestDecisionsBotLinks"
Cohesion: 0.17
...
### Community 601 - "test_dockerfile_ships_config_dir.py"
Cohesion: 0.14
...
### Community 603 - "test_scanner_live.py"
Cohesion: 0.23
...
### Community 614 - "Skill: branch-cleanup"
Cohesion: 0.14
...
### Community 615 - "Skill: perplexity — Web Research via Perplexity API"
Cohesion: 0.14
...
### Community 618 - "Quick-Note Issues Processing Summary"
Cohesion: 0.14
...
### Community 623 - "SEO / GEO / AIO Audit Engine"
Cohesion: 0.14
...
### Community 627 - "_parse_reset_epoch"
Cohesion: 0.21
...
### Community 633 - "test_autonomy_pipeline_regressions.py"
Cohesion: 0.15
...
### Community 635 - "TestMCPToolsListCache"
Cohesion: 0.19
...
### Community 638 - "test_openclaw_gateway.py"
Cohesion: 0.14
...
### Community 639 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 644 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 647 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 648 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 651 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
...
### Community 652 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 653 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 655 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 672 - "test_setup_api.py"
Cohesion: 0.23
...
### Community 673 - "TestModelCostTableUpdates"
Cohesion: 0.26
...
### Community 674 - "TestMCPClientStructuredOutput"
Cohesion: 0.31
...
### Community 677 - "TestRouterIntegration"
Cohesion: 0.31
...
### Community 679 - "WorkspaceManifest"
Cohesion: 0.17
...
### Community 680 - "skill_registry.py"
Cohesion: 0.17
...
### Community 687 - "Skill: system-prompt-audit"
Cohesion: 0.17
...
### Community 688 - "Skill: task-alive-updates"
Cohesion: 0.17
...
### Community 691 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 694 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 697 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 703 - "check_container_posture.py"
Cohesion: 0.26
...
### Community 704 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 705 - "test_admin_local_brain_router.py"
Cohesion: 0.29
...
### Community 706 - "test_agile_api.py"
Cohesion: 0.17
...
### Community 707 - "test_app_settings.py"
Cohesion: 0.21
...
### Community 708 - "test_task_clarification.py"
Cohesion: 0.17
...
### Community 715 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 718 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 719 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 721 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 724 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 725 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 726 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 727 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 728 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 729 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 730 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 731 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 733 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 734 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 735 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 736 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 737 - "What to clean up"
Cohesion: 0.18
...
### Community 738 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 745 - "test_scanner_ssl_cert.py"
Cohesion: 0.25
...
### Community 747 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 748 - "test_event_log.py"
Cohesion: 0.45
...
### Community 754 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 755 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 756 - "admin_local_brain_router.py"
Cohesion: 0.22
...
### Community 757 - "_normalize_tool_choice"
Cohesion: 0.31
...
### Community 758 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 759 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 760 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 761 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 762 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 763 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 764 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 766 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 767 - "Attention Mechanisms Internals"
Cohesion: 0.20
...
### Community 768 - "LLM Router — configuration guide"
Cohesion: 0.20
...
### Community 769 - "LLM Router — provider guide"
Cohesion: 0.20
...
### Community 770 - "CI Troubleshooting Runbook"
Cohesion: 0.20
...
### Community 773 - "capture_screens.py"
Cohesion: 0.29
...
### Community 774 - "build_tech_db.py"
Cohesion: 0.40
...
### Community 777 - "_execute_skill_impl"
Cohesion: 0.24
...
### Community 779 - "TestZeroAttemptDiagnostics"
Cohesion: 0.29
...
### Community 780 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 783 - "test_quick_note_engine.py"
Cohesion: 0.22
...
### Community 789 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 814 - "_get_current_user"
Cohesion: 0.25
...
### Community 816 - "enrich_quick_note_issues.py"
Cohesion: 0.42
...
### Community 817 - "_start_ceo_agency"
Cohesion: 0.31
...
### Community 818 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 819 - "test_changelog_parity_guard.py"
Cohesion: 0.22
...
### Community 821 - "TestPaidPolicyDurability"
Cohesion: 0.22
...
### Community 822 - "test_scanner_deps_parity.py"
Cohesion: 0.31
...
### Community 825 - "DirectChatDoctor"
Cohesion: 0.32
...
### Community 831 - "quality_checker.py"
Cohesion: 0.32
...
### Community 833 - "_build_direct_chat_schedule_suggestion"
Cohesion: 0.32
...
### Community 844 - "AGENTS.md — AI Agent Configuration for local-llm-server"
Cohesion: 0.25
...
### Community 845 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 849 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.25
...
### Community 850 - "Issue #362: Nvidia repo setup"
Cohesion: 0.25
...
### Community 851 - "Issue #364: quick-note:https://www.marktechpost.com/2026/06/01/meet-memory-os-a-6-layer-open-source-memory-stack-built-on-top-of-hermes-agent/"
Cohesion: 0.25
...
### Community 852 - "Issue #378: quick-note:https://www.marktechpost.com/2026/06/02/tinyfish-launches-bigset-an-open-source-multi-agent-system-that-builds-structured-live-datasets-from-plain-english-descriptions/"
Cohesion: 0.25
...
### Community 853 - "Issue #379: quick-note:https://searchengineland.com/schema-markup-optimize-agentic-web-479080"
Cohesion: 0.25
...
### Community 854 - "Issue #380: quick-note:https://cursor.com/blog/cloud-agent-lessons"
Cohesion: 0.25
...
### Community 855 - "Issue #381: quick-note:https://www.xda-developers.com/claude-code-with-opus-48-is-expensive-but-i-made-it-efficient-with-my-local-ai-workflow/"
Cohesion: 0.25
...
### Community 856 - "Issue #382: quick-note:https://claude.com/blog/how-coderabbit-used-claude-to-build-an-agent-orchestration-system"
Cohesion: 0.25
...
### Community 857 - "Issue #383: quick-note:https://www.marktechpost.com/2026/05/29/hexo-labs-open-sources-sia-a-self-improving-agent-that-updates-both-the-harness-and-the-model-weights/"
Cohesion: 0.25
...
### Community 858 - "Issue #416: feat: Self-hosted Codebuff (freebuff) on free NVIDIA models + Telegram bot phone control"
Cohesion: 0.25
...
### Community 859 - "Issue #485: [Trend Digest] Week of 2026-06-08"
Cohesion: 0.25
...
### Community 860 - "Issue #488: quick-note:https://github.com/cookiy-ai/user-research-skill"
Cohesion: 0.25
...
### Community 861 - "Issue #491: Implement whatever is necessary from https://github.com/BehiSecc/awesome-claude-skills"
Cohesion: 0.25
...
### Community 862 - "Issue #493: Use the https://github.com/mvanhorn/last30days-skill skill to get the trend updated"
Cohesion: 0.25
...
### Community 863 - "Issue #495: Read https://www.anthropic.com/news/claude-fable-5-mythos-5 and understand if mythos or fable can be added to the repo"
Cohesion: 0.25
...
### Community 864 - "Issue #504: EPIC: Autonomy hardening — live-verified defects 2026-06-10"
Cohesion: 0.25
...
### Community 865 - "Issue #581: Sprint tracker: pending work after brand rename + mobile-first pass"
Cohesion: 0.25
...
### Community 867 - "Issue #657: quick-note:https://github.com/earendil-works/pi"
Cohesion: 0.25
...
### Community 868 - "Issue #659: quick-note:https://github.com/nex-agi/Nex-N2"
Cohesion: 0.25
...
### Community 869 - "Issue #660: quick-note:https://github.com/getsentry/sentry-for-ai"
Cohesion: 0.25
...
### Community 870 - "Issue #661: quick-note:https://github.com/XiaomiMiMo/MiMo-Code"
Cohesion: 0.25
...
### Community 871 - "Issue #664: quick-note:https://github.com/Grominet95/jarvis-OS"
Cohesion: 0.25
...
### Community 872 - "Issue #666: quick-note:https://github.com/porokka/jarvis-os"
Cohesion: 0.25
...
### Community 873 - "Issue #670: quick-note:https://github.com/perplexityai/bumblebee"
Cohesion: 0.25
...
### Community 874 - "Issue #672: quick-note:https://github.com/Chachamaru127/claude-code-harness"
Cohesion: 0.25
...
### Community 875 - "Issue #676: quick-note:https://github.com/WeiboAI/VibeThinker"
Cohesion: 0.25
...
### Community 876 - "Issue #820: quick-note:https://github.com/cobusgreyling/loop-engineering"
Cohesion: 0.25
...
### Community 878 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 879 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 880 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 881 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 882 - "Prime Agent Runtime"
Cohesion: 0.25
...
### Community 883 - "PULL_REQUEST_TEMPLATE.md"
Cohesion: 0.25
...
### Community 895 - "test_provider_models_db_outage.py"
Cohesion: 0.25
...
### Community 899 - "test_server_autonomy_and_index_fixes.py"
Cohesion: 0.29
...
### Community 900 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.25
...
### Community 902 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 912 - "AI Engineering Insights Skill"
Cohesion: 0.29
...
### Community 924 - "Implementation plan + TO-DO (check off as you go)"
Cohesion: 0.29
...
### Community 927 - "Cloudflare = the real working app"
Cohesion: 0.29
...
### Community 928 - "Workspace Issues"
Cohesion: 0.29
...
### Community 929 - "Model and Response Issues"
Cohesion: 0.29
...
### Community 943 - "test_doctor_coding_brain.py"
Cohesion: 0.38
...
### Community 945 - "TestGithubTokenSQLiteRegression"
Cohesion: 0.38
...
### Community 946 - "TestReasonsAreActionable"
Cohesion: 0.29
...
### Community 947 - "TestProvidersScreen"
Cohesion: 0.43
...
### Community 973 - "resolve_hermes_base_url"
Cohesion: 0.47
...
### Community 976 - "apply_phase1_changes.py"
Cohesion: 0.33
...
### Community 987 - "TestWorkflowIntegration"
Cohesion: 0.33
...
### Community 1006 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 1007 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 1010 - "Agent API Issues"
Cohesion: 0.40
...
### Community 1011 - "Network and Tunnel Issues"
Cohesion: 0.40
...
### Community 1012 - "knowledgeGraphTab.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 1013 - "loginFlowNoTimeout.test.js"
Cohesion: 0.40
Nodes (4): apiSource, { describe, test, expect }, fs, path

### Community 1014 - "test_company_stale_id_recovery.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 1015 - "worker_no_cache.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, workerSource

### Community 1016 - "scripts/agile_ceremonies.py"
Cohesion: 0.60
...
### Community 1019 - "_add_colibri_shim_changelog_entry.py"
Cohesion: 0.50
...
### Community 1020 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1021 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1022 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 1023 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 1024 - "setup_colibri.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1025 - "setup_colibri.sh script"
Cohesion: 0.70
Nodes (4): setup_colibri.sh script, fail(), ok(), warn()

### Community 1026 - "status_colibri_server.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1028 - "TestMobileNavigation"
Cohesion: 0.40
Nodes (3): Mobile-specific: hamburger menu, responsive layout., Verify key pages load in mobile viewport., TestMobileNavigation

### Community 1029 - "test_v5_screens_smoke.py"
Cohesion: 0.50
...
### Community 1030 - "test_agent_runtime_wrapper.py"
Cohesion: 0.70
...
### Community 1031 - "TestModelRoleSeparation"
Cohesion: 0.40
...
### Community 1032 - "worker/index.js"
Cohesion: 0.60
Nodes (4): fetch(), needsProxy(), PROXY_PREFIXES, scheduled()

### Community 1034 - "_clean_phases"
Cohesion: 0.50
...
### Community 1035 - "verify_pr_exists"
Cohesion: 0.50
...
### Community 1050 - "Claude Code Specific Issues"
Cohesion: 0.50
...
### Community 1053 - "render"
Cohesion: 0.50
Nodes (3): RENDER_API_KEY, docker, render

### Community 1054 - "scripts"
Cohesion: 0.50
Nodes (4): scripts, build, start, test

### Community 1056 - "_clear_cache"
Cohesion: 0.50
...
### Community 1070 - "test_skills_route_order.py"
Cohesion: 0.67
...
### Community 1071 - "github"
Cohesion: 0.50
Nodes (3): github, enabled, silent

### Community 1072 - "JWTUserStateMiddleware"
Cohesion: 0.67
...
### Community 1095 - "test_the_reserve_is_bounded_when_read_from_the_environment"
Cohesion: 0.67
...
## Knowledge Gaps
- **3449 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3444 more)
...
- **Why does `_fixture()` connect `_fixture` to `test_company_api.py`, `TaskWorkflowService`, `test_llm_router_queue_cache.py`, `brain_config.py`, `_clean_phases`, `test_model_router.py`, `tasks/service.py`, `SelfHealingAgent`, `llm/router.py`, `E2BSandboxSession`, `test_freebuff_bot.py`, `config.py`, `NotificationDispatcher`, `test_llm_router_resilience.py`, `PolicyEngine`, `ImprovementLoop`, `test_openclaw_endpoints.py`, `Task`, `test_webui_provider_priority.py`, `TaskStore`, `_clear_cache`, `services/seo_audit.py`, `test_unit8_model_catalog.py`, `Agency`, `workflow/api.py`, `test_llm_router_strategies.py`, `test_failover_client_shared.py`, `UserRole`, `test_agent_tool_governance.py`, `test_brain_availability_doctor.py`, `SQLiteStore`, `ProviderConfig`, `WorkflowRun`, `test_knowledge_sync.py`, `test_autonomy_status.py`, `test_brain_failover_413.py`, `PrimeAgentAdapter`, `test_sam_livekit.py`, `test_local_brain_state.py`, `test_phase5_doctor.py`, `AgentJobManager`, `test_refresh_agent_built_proof.py`, `test_telegram_diag_endpoint.py`, `ChatHistoryStore`, `services/background.py`, `model_router.py`, `TokenBudget`, `_resolve_brain_provider`, `enforcement.py`, `BackgroundAgent`, `ResearchTask`, `tests/conftest.py`, `AuditLog`, `TestClient`, `e2e/test_browser.py`, `test_ai_insights.py`, `AgentProfile`, `test_telegram_auto_approve.py`, `resolve_e2b_config`, `test_procedural_memory.py`, `test_llm_router_tpm.py`, `test_sam_voice.py`, `TestHarnessAdapter`, `ExecutionRequest`, `test_startup_warmup.py`, `run_task`, `SeoFixer`, `ScheduledJob`, `KeyStore`, `get_self_healing_agent`, `test_openclaw_gateway.py`, `test_context_rulebook.py`, `ArtifactStore`, `BrainWatchdog`, `seo_api.py`, `test_kimi_bridge_server.py`, `test_new_features_e2e.py`, `test_e2b_adapter.py`, `OnboardingService`, `test_telegram_freebuff.py`, `test_mcp_governance.py`, `claim`, `MCPClient`, `test_portfolio_intake.py`, `AgentSwarm`, `_Budget`, `test_ceo_router.py`, `persist_plan_spec`, `TestEstimateTokensForMessages`, `test_platform_controls.py`, `test_e2b_task_wiring.py`, `test_agent_free_brain.py`, `clear_cooldowns`, `OllamaCircuitBreaker`, `resolve_active_brain`, `ai/router.py`, `test_agile_api.py`, `test_app_settings.py`, `test_features_api.py`, `test_task_clarification.py`, `test_video_transcript.py`, `test_e2b_data_flow.py`, `TrendWatcher`, `test_trend_watcher.py`, `test_colibri_brain_shim.py`, `allow_paid`, `TestClient`, `ContextPruner`, `api_keys_for`, `provider_max_rpm`, `test_control_plane_api.py`, `WorkflowBuildRequest`, `provider_base_url`, `capture_screens.py`, `test_persistent_memory.py`, `SecurityScanner`, `test_llm_router_e2e.py`, `TestMongoGate`, `OutputFilter`, `test_rate_limiter.py`, `test_llm_router_disabled.py`, `OrchestratorQueue`, `_start_ceo_agency`, `TestNormalizeResponseFormat`, `session_retro.py`, `test_purge_backlog.py`, `analyze_page`, `parse_event_stream`, `test_scheduler_hydration_bounded.py`, `test_crispy_burn_in.py`, `test_provider_enable_disable.py`, `test_skill_registry_boot_refresh.py`, `test_direct_chat_evolution.py`, `test_provider_state_durability.py`, `isolated_telegram_config`, `workflow_orchestrator.py`, `.record`, `test_ping.py`, `test_claude_code_adapter.py`, `test_runtimes_health_endpoint.py`, `test_service_token.py`, `test_task_store_fails_loud_in_production.py`, `test_harness_spec.py`, `test_regression.py`, `test_agency_fix.py`, `_resolve_user_github_token`, `test_monitor_lib.py`, `test_v4_api.py`, `client`, `test_dashboard_cache.py`, `test_doctor_coding_brain.py`, `TestFeaturesAPI`, `reap_expired_companies`, `test_voice_pipeline.py`, `cost_tracker.py`?**
  _High betweenness centrality (0.100) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `GitHubTools`, `backend/server.py`, `proxy.py`, `AgentPlan`, `TaskSpec`, `ReactScratchpad`, `test_e2b_adapter.py`, `BrainFailoverExhausted`, `E2BSandboxSession`, `test_mcp_governance.py`, `ExecutionRequest`, `MCPClient`, `ContextManager`, `loop.py`, `FreeBuffAgent`, `MultiAgentSwarm`, `Agency`, `LocalWorkspace`, `test_failover_client_shared.py`, `test_agent_tool_governance.py`, `StuckDetector`, `WorkflowRun`, `test_backend_server_features.py`, `WorkspaceTools`, `test_agent_free_brain.py`, `test_brain_failover_413.py`, `AgentJobManager`, `test_governance_api.py`, `TokenBudget`, `BackgroundAgent`, `.execute`, `CEODispatcher`, `UserMemoryStore`, `direct_chat.py`, `test_empirical_verify.py`, `workflow_orchestrator.py`, `AdaptiveHalter`, `ContextPruner`, `InternalAgentAdapter`, `TestAgentLoopMCPIntegration`, `AgentSessionStore`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderRouter` to `backend/server.py`, `test_all_providers_discovery.py`, `model_discovery.py`, `test_anthropic_router.py`, `TestAnthropicPayloadStructuredOutput`, `kimi_bridge_provider_config`, `test_bedrock_provider.py`, `TestRouterIntegration`, `settings.py`, `failover_client.py`, `ProviderConfig`, `clear_cooldowns`, `ai/router.py`, `TrafficDirector`, `direct_chat.py`, `test_bedrock_live.py`, `test_colibri_brain_shim.py`, `system_instruction`, `get_doctor_diagnostics`?**
...
- **Should `backend/server.py` be split into smaller, more focused modules?**
  _Cohesion score 0.018421967327076814 - nodes in this community are weakly interconnected._