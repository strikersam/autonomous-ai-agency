# Graph Report - autonomous-ai-agency  (2026-08-23)

## Corpus Check
- 1421 files · ~2,050,426 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 28717 nodes · 53475 edges · 1212 communities (1100 shown, 112 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 2659 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `477d5563`
...
## Communities (1212 total, 112 thin omitted)

### Community 0 - "company_api.py"
Cohesion: 0.02
Nodes (173): ephemeral_ttl_hours(), Async read of the ephemeral TTL (hours) straight from the DB., AccountLifecycleResponse, auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint(), _DoctorCheck (+165 more)

### Community 1 - "test_activity_logs.py"
Cohesion: 0.67
Nodes (3): clear_error_log_buffer(), _auth_headers(), test_activity_endpoint_includes_recent_error_logs()

### Community 2 - "MongoDBStore"
Cohesion: 0.02
...
Cohesion: 0.03
Nodes (165): middleware, admin_control(), admin_create_key(), admin_create_user(), admin_delete_user(), admin_list_users(), admin_login(), admin_logout() (+157 more)

### Community 4 - "_fixture"
Cohesion: 0.02
Nodes (103): base_url(), mobile_page(), proxy_url(), Config, pytest_configure(), conftest.py — pytest fixtures and configuration for the E2E test suite.…, A browser page pre-configured for mobile viewport (390×844 — iPhone 14)., _clean_env() (+95 more)

### Community 5 - "types.py"
Cohesion: 0.04
...
### Community 7 - "test_llm_router_strategies.py"
Cohesion: 0.04
...
Cohesion: 0.04
Nodes (76): agent/job_manager.py — Async agent job lifecycle manager. Manages agent jobs…, kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, TaskResult, TaskSpec, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Run aider non-interactively via `--message` flag., runtimes/adapters/claude_code.py — Claude Code CLI adapter (FIRST CLASS).… (+68 more)
...
### Community 11 - "test_llm_router_resilience.py"
Cohesion: 0.03
...
### Community 12 - "E2BSandboxSession"
Cohesion: 0.03
Nodes (99): MCPUnavailableError, Raised when the MCP server is unreachable or the circuit is open., E2BSandboxSession, _inject_token(), maybe_attach_e2b(), Any, Create the sandbox. Raises :class:`MCPUnavailableError` on failure., Kill the sandbox. Idempotent; never raises (best-effort cleanup). (+91 more)

### Community 13 - "SelfHealingAgent"
Cohesion: 0.03
Nodes (86): FailureCategory, heal_signature(), HealingEvent, HealState, _now(), Any, Enum, str (+78 more)

### Community 14 - "TaskStore"
Cohesion: 0.03
Nodes (107): agent/workflow.py — Persisted workflow state machine. Implements the Autonomous…, Task, Helpers that turn scheduler and playbook activity into real tasks., Creates tasks from scheduler and playbook runs using one workflow., TaskAutomationService, Background dispatcher for task execution., _gate_outward_facing_enabled(), _is_brain_connection_error() (+99 more)
...
Cohesion: 0.04
Nodes (104): ProviderConfig, One configured endpoint. ``kind`` selects the adapter: ``openai`` (any OpenAI-…, build_provider(), ProviderConfig, Normalise a configured ``kind`` to an adapter key., Instantiate the adapter for one provider config. Unknown kinds fall back to the…, resolve_kind(), OllamaProvider (+96 more)

### Community 17 - "test_llm_router_queue_cache.py"
Cohesion: 0.03
Nodes (96): int, cosine_similarity(), payload_key(), Exact-match cache key over the fields that change the answer. Routing…, Cosine similarity between two vectors, 0.0 when either is degenerate., build_summariser(), chunk_document(), ContextManager (+88 more)

### Community 18 - "test_model_router.py"
Cohesion: 0.05
...
Cohesion: 0.04
Nodes (91): AgentRole, _parse_ceo_directives(), str, DetectedIssue, ImprovementLoop, ImprovementLoopState, IssueCategory, IssueSeverity (+83 more)

### Community 20 - "Task"
Cohesion: 0.05
Nodes (62): Full task/issue document., Update the updated_at timestamp., Task, PUBLIC_URL-anchored dashboard deep link for the task detail. Returns empty…, Best-effort Telegram heads-up that a task is parked awaiting approval. Inline…, _coordinator(), asyncio, BaseException (+54 more)

### Community 21 - "CompanyGraphStore"
Cohesion: 0.02
Nodes (111): CompanyGraph, CompanyGraphSnapshot, SpecialistFamily, SystemType, Get the index of a phase in the workflow., The complete Company Graph - canonical core model for the Autonomous AI Agency.…, Find all systems of a specific type., Find all specialists of a specific family. (+103 more)

### Community 22 - "webui/router.py"
Cohesion: 0.04
Nodes (63): get_brain_preference(), invalidate_brain_cache(), Clear the cached brain so the next read re-resolves. Called from…, Return the operator's brain provider preference. Values: - ``"nvidia"`` —…, When BrainConfig.updated_at is empty (never applied), the resolver falls…, test_resolve_active_brain_falls_through_when_db_unset(), clean_env(), parametrize (+55 more)

### Community 23 - "llm/router.py"
Cohesion: 0.04
Nodes (84): get_cache(), packages/llm/cache.py — layered caching. Five independent layers, each with its…, The process-wide cache manager., text_key(), failover_chat_completion_via_router(), openai_body_from_response(), Any, packages/llm/compat.py — backwards-compatible bridges to the legacy call paths.… (+76 more)

### Community 24 - "backend/server.py"
Cohesion: 0.02
Nodes (235): Reject non-admin callers for routes that spend provider budget. Delegates to…, _require_admin(), _is_admin(), Check if a user has admin role. Works for both social_auth users (role in…, admin_seed(), _agent_timeout_fallback_response(), AgentStatusEntry, AgentStatusResponse (+227 more)

### Community 25 - "useSafeData"
Cohesion: 0.06
...
### Community 26 - "Agency"
Cohesion: 0.05
Nodes (50): Agency, AgencyCycleResult, AgentDirective, _build_ceo_prompt(), _build_quick_note_instruction(), _close_github_issue(), _collect_recent_git_context(), _fetch_github_quick_notes() (+42 more)
...
### Community 28 - "RenderMCPClient"
Cohesion: 0.05
Nodes (39): _as_list(), _coerce_payload(), Any, RuntimeError, packages/integrations/render_mcp.py — Render platform access over MCP. The…, One deploy, normalised from whatever shape the tool returned., Return tool output as Python data. MCP tool results arrive either as…, Normalise a tool payload into a list of dicts. Upstream tools variously return… (+31 more)

### Community 29 - "PolicyEngine"
Cohesion: 0.04
Nodes (88): _egress_policy_reason(), Return why governance policy blocks *host*, or None. Runs strictly *after* the…, _load(), Import the governance layer once, recording why if it is absent., AgentIdentity, _coerce_text(), new_session_id(), Any (+80 more)
...
Cohesion: 0.04
Nodes (69): all_provider_ids(), Return every provider id recognised by the brain config system. Iterates the…, CatalogActiveBrain, CatalogMirror, CatalogProviderEntry, get_catalog(), get_model_catalog_store(), _include_router_providers() (+61 more)

### Community 33 - "BrainConfig"
Cohesion: 0.04
Nodes (59): Call-time resolver for an agent role model id. Delegates to…, _resolve_role_model(), BrainConfig, BrainConfigStore, default_brain_config(), BaseModel, Persist *cfg* to Mongo (primary) and sqlite (mirror). Either backend failing is…, Build a ``BrainConfig`` from a Mongo doc, dropping Mongo's ``_id``. (+51 more)

### Community 34 - "test_runtime_governance.py"
Cohesion: 0.04
Nodes (72): governance_enabled(), True when the governance layer should run at all. A single global off switch…, Return the last-known health for *runtime_id* (may be stale)., Return True if the runtime is available (not circuit-open)., Return health snapshots for all known runtimes., Force an immediate health check of all runtimes and return results., Attempt to start a dead runtime subprocess before re-probing. Uses the local…, Async health polling service for all registered runtimes. (+64 more)

### Community 35 - "resolve_active_brain"
Cohesion: 0.05
Nodes (57): BrainResolution, get_active_brain_sync(), get_provider_role_tags(), _host_is_openai_compatible(), _norm(), _pick_from_records(), Any, Shared free-brain policy helpers (issue #656). Single source of truth for "is… (+49 more)
...
### Community 38 - "PrimeAgentAdapter"
Cohesion: 0.03
...
### Community 40 - "audit"
Cohesion: 0.05
Nodes (35): cost_insights.py — Per-user/workspace/time savings aggregation. Tracks: - Token…, audit(), get_audit_log(), get_user_role(), has_permission(), is_admin(), is_power_user_or_above(), mask_dict() (+27 more)

### Community 41 - "get_skill_bindings"
Cohesion: 0.10
...
Cohesion: 0.05
Nodes (68): BudgetTracker, GovernanceGate, Per-session consumption counters and their ceilings. Ceilings come from the…, Return the name of the first exhausted session-wide limit, or None. Only covers…, Return a reason string if *tool* has hit its per-tool session cap. Checks only…, Holds live session budgets, bounded so it cannot leak. Sessions end without…, The one seam through which governed actions pass., SessionBudget (+60 more)

### Community 46 - "test_loop_registry.py"
Cohesion: 0.11
Nodes (29): DriftReport, _grade(), loop_readiness(), LoopRegistry, LoopSpec, BaseModel, field_validator, agent/loop_registry.py — Loop Engineering governance layer. This module turns… (+21 more)

### Community 47 - "CEODispatcher"
Cohesion: 0.06
...
### Community 48 - "AgentJobManager"
Cohesion: 0.06
Nodes (30): AgentJob, AgentJobManager, _now(), Any, Run a job using the provided runner and update the job's lifecycle, progress,…, Serialize the AgentJob to a JSON-serializable dictionary for external clients.…, runner(), AgentJobManager method signature enforcement. (+22 more)

### Community 49 - "runtimes/api.py"
Cohesion: 0.04
...
### Community 50 - "model_router.py"
Cohesion: 0.05
Nodes (39): Dynamic model router package. Public API:: from router import get_router,…, _build_builtin_model_map(), _default_model(), _default_reasoning_model(), ModelRouter, _nvidia_key_present(), Any, Dynamic model router. Central routing logic for all chat and agent requests.… (+31 more)
...
### Community 53 - "TestAdapterMetadata"
Cohesion: 0.04
Nodes (31): AiderAdapter, Any, Adapter for Aider — TIER 3 specialized git-aware code editor., HermesAdapter, Any, AsyncClient, Response, TaskResult (+23 more)

### Community 54 - "test_ceo_dispatcher.py"
Cohesion: 0.04
Nodes (85): CEOResult, _decompose_into_subtasks(), _merge_changed_files(), Aggregated output from a multi-specialist execution., Decompose a request into 2-3 sub-tasks for specialist fan-out. Default…, Collect changed_files across all specialists into a single de-duped list., get_ceo_fallback_stats(), PlanOutput (+77 more)

### Community 55 - "test_sam_livekit.py"
Cohesion: 0.04
...
### Community 56 - "RepowiseIntelligence"
Cohesion: 0.06
...
Cohesion: 0.03
Nodes (51): ExecutionRequest, _NoopStore, Any, Exception, Approve a run paused at the ApprovalGate. The caller must re-invoke…, Inject additional instructions into an in-flight run (no state change). Backs…, Push a Telegram approval-gate notification when a run pauses (Charter G1).…, List recent runs. When ``owner_id`` is provided, only runs stamped with that… (+43 more)

### Community 58 - "test_user_research_skill.py"
Cohesion: 0.05
...
### Community 59 - "services/background.py"
Cohesion: 0.03
Nodes (100): get_improvement_loop(), _dispatch_async(), _ErrorCaptureHandler, get_log_monitor(), LogMonitor, _note_recurrence(), Any, LogRecord (+92 more)

### Community 60 - "ChatScreen.jsx"
Cohesion: 0.14
...
Cohesion: 0.03
Nodes (58): ChatResponse, CerebrasProvider, Provider, Cerebras provider adapter — free, fast LLM (qwen-3-coder-480b)., GroqProvider, Provider, Groq provider adapter — free, fast LLM (deepseek-r1-distill-llama-70b)., NvidiaProvider (+50 more)

### Community 66 - "report_to_markdown"
Cohesion: 0.10
...
### Community 67 - "reset_orchestrator"
Cohesion: 0.09
Nodes (20): Reset the singleton (test helper)., reset_orchestrator(), skipif, Singleton lifecycle and phase registration., End-to-end execution through the golden path., With auto_approve=True, execution runs through all phases., CLASSIFY correctly detects security domain., A run blocks at ApprovalGate, is approved, then finishes. (+12 more)
...
### Community 71 - "services/seo_audit.py"
Cohesion: 0.04
Nodes (59): Run a full SEO/GEO/AIO audit against a website and persist the evidence., run_seo_audit(), BaseModel, field_validator, A single occurrence of a check firing on a specific URL., Snapshot of one crawled page with the on-page facts the checks used., Aggregated report row - Screaming Frog CSV compatible., Site-level facts discovered during the crawl. (+51 more)

### Community 72 - "AgentScheduler"
Cohesion: 0.06
...
### Community 73 - "test_model_catalog.py"
Cohesion: 0.05
Nodes (65): _build_candidates_from_yaml(), _build_default_base_url_from_yaml(), _build_display_names_from_yaml(), _build_key_env_from_yaml(), _build_presets_from_yaml(), _build_tier_from_yaml(), get_provider_candidates(), get_provider_display_name() (+57 more)

### Community 74 - "AgentRunner"
Cohesion: 0.03
Nodes (107): AgentPhaseError, AgentRunner, _check_extra_kwargs(), _enforce_signature(), Any, Exception, Path, Raise TypeError if fn's signature drifts from the locked contract (Pydantic… (+99 more)
...
Cohesion: 0.05
Nodes (31): Polls Render for platform-level failures and files them as issues., Snapshot for ``/api/render/ops/status`` and the dashboard. ``self_heal_ready``…, Map service ID → human name, degrading to the ID when unavailable., True when a filed finding will actually be scheduled as a fix. Detection and…, RenderOpsMonitor, _self_heal_ready(), _client(), _FakeInner (+23 more)

### Community 80 - "get_task_store"
Cohesion: 0.05
Nodes (68): quick_notes_submit(), _QuickNoteBody, Submit a quick-note URL or instruction from the dashboard FAB., get_failover_manager(), Return the singleton BrainFailoverManager., Reset the singleton (for tests)., reset_failover_manager(), Hand the 'connect & verify the repo' work to the agency's own agents. The task… (+60 more)

### Community 81 - "test_brain_config_store.py"
Cohesion: 0.08
Nodes (39): BrainConfigPatch, get_brain_config(), invalidate_brain_config_cache(), Convenience wrapper used by the agent loop + brain resolver., Convenience wrapper used by the admin API endpoints., Clear the singleton's cache (used by tests + brain_policy invalidation)., Return ``(max_output_tokens, request_timeout_sec)`` for an agent LLM call. Same…, Editable subset of ``BrainConfig`` sent by PATCH /admin/api/policy/brain. All… (+31 more)
...
### Community 85 - "test_repo_connection.py"
Cohesion: 0.06
...
Cohesion: 0.03
Nodes (87): AgentPolicy, _apply_env_overrides(), _apply_key_env(), _build(), _coerce(), config_dir(), _env_key_names(), expand_env() (+79 more)

### Community 87 - "ArtifactStore"
Cohesion: 0.06
...
### Community 91 - "ToolRegistry"
Cohesion: 0.05
Nodes (35): get_tool_registry(), _infer_parameters_from_func(), Any, Register a tool definition., Decorator to register a function as an agent tool. Usage::…, Remove a tool from the registry. Returns True if removed., Look up a tool by name., Return all registered tools. (+27 more)
...
### Community 93 - "test_agent_tool_governance.py"
Cohesion: 0.04
...
### Community 94 - "workflow_orchestrator.py"
Cohesion: 0.09
...
### Community 95 - "loop.py"
Cohesion: 0.06
Nodes (45): Agent subsystem — planner / executor / verifier loop., _note_phase_end(), _note_phase_start(), loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., # NOTE: "ollama_base" is kept for backwards compatibility; this runner only…, Open a tracked phase, returning the token that closes it. Never raises., Close the tracked phase *token* opened above. Never raises., AgentPlan (+37 more)
...
### Community 100 - "workflow/models.py"
Cohesion: 0.05
...
### Community 101 - "KeyStore"
Cohesion: 0.10
Nodes (27): _check_rate_limit(), default_keys_path(), issue_new_api_key(), KeyRecord, KeyStore, load_key_store(), Exception, Path (+19 more)
...
### Community 105 - "SeoFixRequest"
Cohesion: 0.16
Nodes (10): Request to remediate auto-fixable findings in a local code repository., SeoFixRequest, Convenience wrapper used by the API layer and skill executor., run_fixes(), Path, tests/test_seo_fixer.py - repo-aware SEO auto-fixer tests (issue #533)., repo(), TestApply (+2 more)
...
### Community 110 - "enforcement.py"
Cohesion: 0.06
Nodes (41): events_from_identity(), Extract the identity-derived audit fields from an AgentIdentity. Kept here…, BudgetExceeded, classify(), evaluate_call(), guard_tool_call(), GuardResult, _host_of() (+33 more)
...
### Community 112 - "CompanyGraphService"
Cohesion: 0.02
...
### Community 114 - "test_integration_c4_c5_c6_d3.py"
Cohesion: 0.06
...
### Community 115 - "test_governance_api.py"
Cohesion: 0.06
Nodes (49): get_approval_store(), Replace the process-wide gate. Tests only., reset_gate(), _client(), parametrize, TestClient, Tests for the governance HTTP surface and the AgentRunner integration. The…, Policy is a git-reviewed file. An HTTP mutation route would make "who changed… (+41 more)

### Community 116 - "test_startup_warmup.py"
Cohesion: 0.05
Nodes (54): _bootstrap_within_budget(), _create_bootstrap_indexes(), ensure_bootstrap(), Await one warm-up step, deferring it to the background if it overruns.…, The task store the background services should use, wiring it if needed.…, Create every boot index concurrently rather than one round-trip at a time.…, Idempotent bootstrap for indexes + seeded admin/providers. FastAPI startup…, Auto-detect the best available Ollama model and update ollama-local in the DB.… (+46 more)

### Community 117 - "CacheManager"
Cohesion: 0.09
...
### Community 119 - "AgentSessionStore"
Cohesion: 0.06
Nodes (38): AgentEvent, AgentSessionMessage, A single entry in the session's append-only event log. Inspired by Anthropic's…, AgentSessionStore, _now(), Connection, Path, Row (+30 more)
...
### Community 122 - "test_autonomous_agency_e2e.py"
Cohesion: 0.05
...
### Community 124 - "activation_api.py"
Cohesion: 0.05
...
### Community 133 - "test_provider_router.py"
Cohesion: 0.05
...
### Community 134 - "telegram_bot.py"
Cohesion: 0.07
Nodes (58): project_session_cost(), Project costs for a typical coding session. Args: avg_session_latency_ms: Total…, Convenience: resolve all four role models for a component. Returns a dict with…, resolve_component_role_models(), get_decisions_store(), Process-wide DecisionsStore singleton (resettable via db_path arg)., Return a Markdown-v1-safe preview string under ``max_chars``. Used by the…, sanitize_paste_for_preview() (+50 more)

### Community 135 - "WorkflowEngine"
Cohesion: 0.08
...
### Community 138 - "test_kimi_bridge_server.py"
Cohesion: 0.05
...
### Community 141 - "test_web_reach.py"
Cohesion: 0.08
Nodes (46): Register the Web Reach capability (agent/web_reach.py): zero-key internet…, _register_web_reach_tools(), get_web_reach(), _load_script_module(), Any, ModuleType, Response, agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives… (+38 more)

### Community 142 - "api_keys_for"
Cohesion: 0.07
...
### Community 147 - "test_telegram_freebuff.py"
Cohesion: 0.07
...
### Community 149 - "make_isolated_workspace"
Cohesion: 0.21
...
Cohesion: 0.07
Nodes (40): InitiativeStatus, _bug_scores(), _clean(), _default_repo(), _env_github_token(), estimate_job_size(), fetch_github_signals(), initiatives_from_bug_log() (+32 more)

### Community 154 - "[Unreleased]"
Cohesion: 0.07
Nodes (29): Added, Added, Added, Added, Added, Added, Added, Added (+21 more)

### Community 155 - "[Unreleased]"
Cohesion: 0.07
Nodes (29): Added, Added, Added, Added, Added, Added, Added, Added (+21 more)

### Community 156 - "ProvidersScreen.jsx"
Cohesion: 0.05
...
### Community 157 - "TestEstimateTokensForMessages"
Cohesion: 0.05
...
### Community 159 - "ProviderConfig"
Cohesion: 0.05
Nodes (63): _dead_model_key(), is_commercial_provider(), _mark_model_dead(), provider_access_tier(), _provider_field(), provider_sort_key(), ProviderConfig, provider_router.py — auto-generated module docstring (user-research skill scan). (+55 more)

### Community 160 - "test_e2b_adapter.py"
Cohesion: 0.06
...
### Community 163 - "operational_incidents.py"
Cohesion: 0.11
...
### Community 164 - "_get_provider_policy"
Cohesion: 0.05
Nodes (55): _build_provider_router(), _builtin_provider_records(), _chat_provider_policy(), _fallback_local_provider_record(), _get_provider_policy(), get_provider_policy_route(), _list_configured_provider_records(), _nvidia_nim_provider_record() (+47 more)

### Community 165 - "GitHubScreen"
Cohesion: 0.18
...
### Community 166 - "failover_client.py"
Cohesion: 0.05
Nodes (49): _auto_disable(), _build_request(), _describe_registry(), _disabled_ids(), FailoverResult, _is_billing_refusal(), _is_ollama(), _key_pool() (+41 more)

### Community 167 - "resolve_component_model"
Cohesion: 0.06
...
### Community 168 - "test_schedule_growth_invariants.py"
Cohesion: 0.05
...
### Community 176 - "WorkflowRun"
Cohesion: 0.07
Nodes (25): get_orchestrator_supervisor(), OrchestratorSupervisor, Any, services/orchestrator_supervisor.py — Deterministic Supervisor Issue #522: A…, Emit an alert to the activity feed and log., Deterministic supervisor for the orchestrator. Runs as a background coroutine.…, start_orchestrator_supervisor(), stop_orchestrator_supervisor() (+17 more)
...
### Community 179 - "control_overrides.py"
Cohesion: 0.12
...
### Community 180 - "configuration-reference.md"
Cohesion: 0.06
Nodes (26): Beta, Config Overrides, Disabled (demoted per issue #467 Section I), Enforcement, Experimental, Feature Maturity / Support Matrix, Maturity Tiers, Stable Core (+18 more)
...
### Community 186 - "render_ops.py"
Cohesion: 0.07
Nodes (30): get_render_ops_monitor(), _latest_metric_value(), _note_recurrence(), _parse_timestamp(), Any, datetime, services/render_ops.py — autonomous Render debugging + environment monitoring.…, Parse an RFC3339 timestamp from Render, tolerating a trailing ``Z``. (+22 more)

### Community 187 - "get_savings"
Cohesion: 0.10
Nodes (25): compute_savings(), compute_time_series(), get_savings(), get_usage(), get_user_savings(), _period_start(), Any, BaseModel (+17 more)

### Community 188 - "test_features_api.py"
Cohesion: 0.05
Nodes (4): _auth_override(), client(), _fake_auth(), Integration tests for all new feature API routes in proxy.py.

### Community 189 - "test_schedule_backlog_drain.py"
Cohesion: 0.08
...
### Community 190 - "test_video_transcript.py"
Cohesion: 0.05
...
### Community 191 - "test_memory_guard.py"
Cohesion: 0.13
...
### Community 192 - "portfolio_api.py"
Cohesion: 0.08
...
### Community 193 - "Part A — CodeRabbit review fixes for this PR (do first, small)"
Cohesion: 0.05
...
### Community 194 - "Docker Agent Runtimes Setup"
Cohesion: 0.07
...
### Community 195 - "anthropic_compat.py"
Cohesion: 0.09
...
### Community 196 - "BrainWatchdog"
Cohesion: 0.03
Nodes (74): _brain_provider_status(), get_brain_policy_route(), Return per-provider metadata for the GET endpoint. Iterates every provider in…, Return the discovered model list for *provider_id*, or ``[]`` if unknown., Return the active brain config + per-provider key-present flags. The response…, _served_models(), emit_agency_observation(), Record an agency platform operation in Langfuse. Unlike… (+66 more)
...
### Community 199 - "TestBrainFailoverModelUpdates"
Cohesion: 0.08
...
### Community 203 - "Persistent Memory System"
Cohesion: 0.05
...
### Community 204 - "OnboardingScreen.jsx"
Cohesion: 0.05
...
### Community 207 - "Kept Rules — the 44 that survive the audit"
Cohesion: 0.05
...
### Community 208 - "ProviderRouter"
Cohesion: 0.06
Nodes (30): CommercialFallbackRequiredError, _exponential_backoff_cooldown(), _get_director(), _normalized_provider_type(), _notify_watchdog(), _ollama_reasoning_effort(), ProviderAttempt, ProviderRouter (+22 more)

### Community 209 - "compare_runtimes.py"
Cohesion: 0.07
...
### Community 210 - "WorkspaceManager"
Cohesion: 0.11
...
### Community 217 - "test_chat_mode_regressions.py"
Cohesion: 0.18
...
### Community 220 - "test_portfolio_intake.py"
Cohesion: 0.09
...
### Community 225 - "test_daily_2026_06_04.py"
Cohesion: 0.08
...
### Community 227 - "PatternConsolidation"
Cohesion: 0.10
...
### Community 231 - "FeatureUnavailableError"
Cohesion: 0.17
...
### Community 233 - "test_pr923_fixes.py"
Cohesion: 0.07
...
Cohesion: 0.06
Nodes (30): _best_cloud_primary_base(), InternalAgentAdapter, TaskResult, TaskSpec, Built-in agent loop — Nvidia NIM primary, Ollama fallback., Return runtime dependencies required by this adapter. Returns:…, Determine availability of the internal agent runtime. Checks cloud providers in…, Execute a TaskSpec using the internal AgentRunner and convert the agent's… (+22 more)

### Community 243 - "GitHubTools"
Cohesion: 0.13
...
### Community 244 - "mcp_client.py"
Cohesion: 0.12
Nodes (11): filter_safe_tools(), get_tool_annotations(), agent/mcp_client.py — Async MCP client for the mcp-server Docker container.…, Extract ``ToolAnnotations`` for a named tool from a ``list_tools()`` result.…, Return tools where ``readOnlyHint`` is True and ``destructiveHint`` is not…, get_tool_annotations extracts typed hints., filter_safe_tools returns only definitively safe tools., Unknown safety → excluded. (+3 more)

### Community 245 - "PlaybookLibrary"
Cohesion: 0.10
...
### Community 246 - "test_verification_strategies.py"
Cohesion: 0.11
...
### Community 248 - "DockerAgentAdapter"
Cohesion: 0.17
...
### Community 250 - "test_brain_failover.py"
Cohesion: 0.12
...
### Community 251 - "test_all_providers_discovery.py"
Cohesion: 0.16
...
### Community 252 - "test_persistent_memory.py"
Cohesion: 0.06
...
### Community 255 - "test_anthropic_router.py"
Cohesion: 0.09
...
### Community 256 - "DailyDigestAggregatorTests"
Cohesion: 0.19
...
### Community 257 - "test_llm_router_e2e.py"
Cohesion: 0.06
Nodes (48): get_tracker(), The process-wide health tracker., get_metrics(), The process-wide metrics registry., _ok(), parametrize, End-to-end routing against mock providers (ADR-008). These are the tests that…, A router wired to three mock providers, with all singletons isolated. (+40 more)

### Community 258 - "SpecEntry"
Cohesion: 0.11
...
### Community 260 - "agents/agile_ceremonies.py"
Cohesion: 0.07
Nodes (31): _bullets(), generate_backlog_retro(), generate_sprint_retro(), generate_standup(), plan_next_sprint(), Agentic Agile — autonomous ceremonies (standup, retro, sprint planning). Where…, Render a :class:`Retrospective` as a markdown section., Derive retro notes for ``sprint`` from its current metrics. Records… (+23 more)

### Community 261 - "agent_runtime.py"
Cohesion: 0.10
...
### Community 262 - "context_rules.py"
Cohesion: 0.11
...
### Community 263 - "BrainFailoverExhausted"
Cohesion: 0.10
...
### Community 265 - "_build_default_manager"
Cohesion: 0.07
...
### Community 271 - "CEOLedger"
Cohesion: 0.07
Nodes (28): Attempt, _backend(), CEOLedger, get_ceo_ledger(), GoalRecord, _now(), Any, services/ceo_ledger.py — durable record of what the CEO is driving to closure.… (+20 more)

### Community 272 - "test_operational_incidents.py"
Cohesion: 0.05
...
### Community 274 - "ResourceWatchdog"
Cohesion: 0.10
...
### Community 275 - "platform_controls_router.py"
Cohesion: 0.29
...
### Community 277 - "test_slop_gate.py"
Cohesion: 0.07
...
### Community 279 - "RateLimitTracker"
Cohesion: 0.16
...
### Community 281 - "test_microagents.py"
Cohesion: 0.15
...
### Community 282 - "Security Analysis — local-llm-server"
Cohesion: 0.06
...
### Community 283 - "Configuration Reference"
Cohesion: 0.06
...
### Community 284 - "Langfuse Observability Guide"
Cohesion: 0.06
...
### Community 288 - "BrainFailoverManager"
Cohesion: 0.09
...
### Community 289 - "OrchestratorQueue"
Cohesion: 0.07
...
### Community 291 - "test_workspace_isolation.py"
Cohesion: 0.16
...
### Community 296 - "LlmProviderConfig"
Cohesion: 0.15
...
### Community 297 - "test_backend_server_features.py"
Cohesion: 0.08
...
### Community 298 - "Quick-Note GitHub Issues Processing - Session Summary"
Cohesion: 0.06
...
### Community 300 - "test_mcp_governance.py"
Cohesion: 0.11
...
### Community 301 - "test_portfolio_intelligence.py"
Cohesion: 0.06
...
### Community 302 - "test_purge_backlog.py"
Cohesion: 0.09
...
### Community 303 - "test_autonomy_gate.py"
Cohesion: 0.13
...
### Community 305 - "test_minimax_bug_fixes.py"
Cohesion: 0.11
...
### Community 306 - "Architecture Overview — local-llm-server"
Cohesion: 0.11
...
### Community 309 - "test_colibri_provider.py"
Cohesion: 0.12
...
### Community 312 - "test_force_cleanup_conditional_delete.py"
Cohesion: 0.10
...
### Community 313 - "test_rag_context.py"
Cohesion: 0.12
...
### Community 314 - "test_sam_voice.py"
Cohesion: 0.07
...
### Community 315 - "ProjectScaffolder"
Cohesion: 0.13
...
### Community 319 - "SteeringInjector"
Cohesion: 0.11
...
### Community 320 - "test_claude_setup_audit.py"
Cohesion: 0.16
...
### Community 321 - "test_scheduler_hydration_bounded.py"
Cohesion: 0.09
...
### Community 322 - "probe_model_liveness"
Cohesion: 0.03
Nodes (79): provider_api_key(), provider_base_url(), Return the OpenAI-compatible base URL for *provider* (env- and UI-aware)., Return the live API key for *provider* (env-only — never persisted)., _describe_http_status(), _is_dns_failure(), _probe_failure_reason(), probe_model_liveness() (+71 more)

### Community 323 - "audit_drift"
Cohesion: 0.13
Nodes (20): audit_drift(), _cmd_audit(), load_registry(), load_registry_sync(), main(), Namespace, Path, Load and validate the registry from YAML (synchronous; for CLI/tests). (+12 more)
...
### Community 327 - "Python Dependencies (`requirements.txt`)"
Cohesion: 0.07
...
### Community 328 - "Technical Debt Register — local-llm-server"
Cohesion: 0.07
...
### Community 332 - "test_crispy_burn_in.py"
Cohesion: 0.07
...
### Community 333 - "test_provider_enable_disable.py"
Cohesion: 0.09
...
### Community 336 - "tasks/models.py"
Cohesion: 0.06
Nodes (49): tasks — Task/issue management system. Provides a lightweight task/issue tracker…, ApprovalCheckpoint, ApprovalRequest, ClarifyRequest, _coerce_ts(), CommentAddRequest, ExecutionApprovalRequest, ExecutionLogEntry (+41 more)

### Community 337 - "SprintMetrics"
Cohesion: 0.10
...
### Community 338 - "test_dashboard_cache.py"
Cohesion: 0.11
...
### Community 339 - "get_scheduler"
Cohesion: 0.05
Nodes (38): get_sam(), agent/sam.py — SAM Voice Agent (System Autonomy Manager) SAM is the voice-…, _get_backend_sam(), legacy_scheduler_get(), Lazy-init the SAM agent for the backend deployment., Get SAM's current status., sam_status_backend(), get_scheduler() (+30 more)

### Community 340 - "Deploy: FreeBuff Telegram bot (24×7)"
Cohesion: 0.07
...
### Community 341 - "Claude Code + Qwen Local Setup"
Cohesion: 0.07
...
### Community 342 - "brain_failover.py"
Cohesion: 0.09
...
### Community 343 - "session_retro.py"
Cohesion: 0.13
...
### Community 350 - "validate_outbound_url"
Cohesion: 0.14
...
### Community 353 - "VoiceCommandInterface"
Cohesion: 0.14
...
### Community 354 - "Performance Analysis — local-llm-server"
Cohesion: 0.08
...
### Community 355 - "test_brain_priority_scanner.py"
Cohesion: 0.10
...
### Community 356 - "LLM Router — troubleshooting"
Cohesion: 0.08
...
### Community 359 - "test_phase5_doctor.py"
Cohesion: 0.12
...
### Community 361 - "test_telegram_approval_e2e.py"
Cohesion: 0.12
...
### Community 363 - "ensure_self_company"
Cohesion: 0.09
Nodes (36): autonomy_status(), Public autonomy readiness probe — no authentication required. A live deploy…, Fire-and-forget self-bootstrap; never blocks or crashes startup., _schedule_self_bootstrap(), get_onboarding_service(), Get the singleton Onboarding service instance. Returns: The singleton…, _count_specialists(), _create_company_directly() (+28 more)

### Community 364 - "UserMemoryStore"
Cohesion: 0.12
...
### Community 367 - "Session Handoff — 2026-06-15"
Cohesion: 0.08
...
### Community 368 - "TASK 4 — End-to-end approval-gate test"
Cohesion: 0.08
...
### Community 369 - "seo_api.py"
Cohesion: 0.05
Nodes (47): delegate_seo_findings(), _expire_stale_pending_report(), get_seo_audit(), list_seo_audits(), BaseModel, get, post, SEO / GEO / AIO Audit API Router Endpoints for the world-class SEO audit engine… (+39 more)

### Community 370 - "test_north_mini_code.py"
Cohesion: 0.08
...
### Community 371 - "test_claude_code_adapter.py"
Cohesion: 0.14
...
### Community 379 - "SetupWizardPage.js"
Cohesion: 0.10
...
### Community 381 - "test_harness_spec.py"
Cohesion: 0.12
...
### Community 383 - "Local AI Stack with Docker"
Cohesion: 0.08
...
### Community 384 - "Traffic Distribution Across Providers"
Cohesion: 0.08
...
### Community 385 - "Implementation Prompt: Rich TaskBoard + Agile Sprint Integration"
Cohesion: 0.08
...
### Community 386 - "Telegram Bot Setup"
Cohesion: 0.08
...
### Community 387 - "video_transcript.py"
Cohesion: 0.12
...
### Community 389 - "open_phase_report"
Cohesion: 0.13
...
### Community 393 - "test_telegram_mutating_commands.py"
Cohesion: 0.08
...
### Community 395 - "test_webui_provider_priority.py"
Cohesion: 0.11
...
### Community 397 - "test_brain_availability_doctor.py"
Cohesion: 0.13
...
### Community 398 - "_resolve_user_github_token"
Cohesion: 0.10
Nodes (28): _DoctorCheck, _DoctorReport, get_doctor_diagnostics(), get_doctor_report(), get_public_doctor(), _in_container(), Path, Public Doctor endpoint — no authentication required. Returns system-level… (+20 more)

### Community 399 - "Agent Governance Guide"
Cohesion: 0.09
...
### Community 400 - "The fifteen strategies"
Cohesion: 0.09
...
### Community 404 - "WindowsServiceManager"
Cohesion: 0.18
...
### Community 405 - "SyntheticDataPipeline"
Cohesion: 0.13
...
### Community 409 - "test_mostly_failed_steps.py"
Cohesion: 0.12
...
### Community 412 - "TestAgentRunnerSafety"
Cohesion: 0.19
...
### Community 413 - "HarnessEnrichment"
Cohesion: 0.14
...
### Community 414 - "classify_direct_chat_intent"
Cohesion: 0.13
...
### Community 415 - "weekly_digest.py"
Cohesion: 0.13
...
### Community 416 - "AdaptivePermissions"
Cohesion: 0.18
...
### Community 422 - "OrchestratorCheckpointStore"
Cohesion: 0.10
...
### Community 424 - "register_user_research_tools"
Cohesion: 0.29
...
### Community 431 - "TestPoliciesGovernanceStableClaim"
Cohesion: 0.25
...
### Community 432 - "system_instruction"
Cohesion: 0.16
...
### Community 437 - "test_local_controller.py"
Cohesion: 0.17
...
### Community 438 - "test_provider_410_per_model.py"
Cohesion: 0.18
...
### Community 439 - "test_unit5_ui_provider_surface.py"
Cohesion: 0.10
...
### Community 441 - "PersistentMemoryStore"
Cohesion: 0.24
...
### Community 443 - "_valid_login_state"
Cohesion: 0.24
...
### Community 444 - "Skill: modularity-review"
Cohesion: 0.10
...
### Community 450 - "Docker AI Governance Audit — Final Report"
Cohesion: 0.10
...
### Community 451 - "1. Capability-by-capability"
Cohesion: 0.10
...
### Community 453 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 459 - "DecisionsStoreTests"
Cohesion: 0.11
...
### Community 461 - "PriorityTaskQueue"
Cohesion: 0.15
...
### Community 464 - "reap_expired_companies"
Cohesion: 0.16
...
### Community 466 - "test_tasks_cache_ttl_env.py"
Cohesion: 0.21
...
### Community 467 - "test_voice_pipeline.py"
Cohesion: 0.14
...
### Community 470 - "_extract_tech_relevance"
Cohesion: 0.17
...
### Community 471 - "test_repowise_intelligence.py"
Cohesion: 0.11
...
### Community 473 - "Skill: fabric-patterns"
Cohesion: 0.11
...
### Community 474 - "Analysis & Synthesis Instructions"
Cohesion: 0.11
Nodes (18): 1. Define the Atmosphere, 2. Map the Color Palette, 3. Establish Typography Rules, 4. Define the Hero Section, 5. Describe Component Stylings, 6. Define Layout Principles, 7. Define Responsive Rules, 8. Encode Motion Philosophy (+10 more)

### Community 475 - "Production Readiness Assessment — local-llm-server"
Cohesion: 0.11
...
### Community 476 - "TestNormalizeResponseFormat"
Cohesion: 0.08
...
### Community 477 - "Skill: fabric-patterns"
Cohesion: 0.11
Nodes (18): 1. Ensure Pattern Directory Exists, 2. List Available Patterns, 3. Retrieve a Pattern, 4. Apply a Pattern with Variables, 5. Stitch Patterns Together, 6. Create New Patterns, Acceptance Checks, Directory Structure (+10 more)

### Community 478 - "db/__init__.py"
Cohesion: 0.14
...
### Community 479 - "Admin Dashboard Guide"
Cohesion: 0.11
...
### Community 480 - "Implementation Plan"
Cohesion: 0.11
...
### Community 481 - "ProviderConsole.jsx"
Cohesion: 0.08
...
### Community 482 - "test_ceo_router.py"
Cohesion: 0.10
...
### Community 483 - "test_agent_readiness_audit.py"
Cohesion: 0.18
...
### Community 484 - "Delegation Plan (agent-ready work packages)"
Cohesion: 0.11
...
### Community 485 - "test_p0_roadmap_a4_a5_b2.py"
Cohesion: 0.15
...
### Community 488 - "test_brain_patch_service_token.py"
Cohesion: 0.18
...
### Community 489 - "TestSelfHealingInfrastructureClassification"
Cohesion: 0.19
...
### Community 490 - "test_fabric_patterns.py"
Cohesion: 0.11
...
### Community 491 - "validate_session_id"
Cohesion: 0.16
...
### Community 492 - "ErrorInterceptorMiddleware"
Cohesion: 0.18
...
### Community 495 - "Comprehensive Skill Index (By Category)"
Cohesion: 0.11
...
### Community 496 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 497 - "Component Map"
Cohesion: 0.11
...
### Community 499 - "Agent State — colibri GLM-5.2 deployment (resumable)"
Cohesion: 0.11
...
### Community 500 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
...
### Community 502 - "Part A — Health Report"
Cohesion: 0.11
...
### Community 506 - "test_agent_tools.py"
Cohesion: 0.19
...
### Community 508 - "sync_readme_gallery.py"
Cohesion: 0.22
...
### Community 509 - "redact_connection_url"
Cohesion: 0.17
...
### Community 510 - "test_p0_roadmap_b3_b4_b5.py"
Cohesion: 0.16
...
### Community 513 - "test_company_api.py"
Cohesion: 0.11
...
### Community 514 - "TestStopSlopChecker"
Cohesion: 0.11
...
### Community 516 - "Agent Runtime Setup"
Cohesion: 0.12
...
### Community 517 - "Changelog"
Cohesion: 0.29
Nodes (6): Added, Changed, Changelog, Fixed, Maintenance, [v4.1.0]

### Community 518 - "handle_workflow_ide_chat"
Cohesion: 0.18
...
### Community 520 - "model_discovery.py"
Cohesion: 0.10
Nodes (23): discover_models(), _fresh_entry(), _models_url(), _parse_ids(), Any, Ask a provider which models the configured API key may actually use.…, Remember which of *provider_id*'s models a failed round already sent. The…, Drop every cached list and attempt record. For tests, and for an explicit… (+15 more)

### Community 521 - "[5.0.0]"
Cohesion: 0.29
Nodes (7): [5.0.0], Added, Changed, Fixed, Maintenance, Removed, Security

### Community 522 - "_extract_tags"
Cohesion: 0.15
...
### Community 523 - "Changelog"
Cohesion: 0.29
Nodes (7): Added, Changed, Changelog, Fixed, Maintenance, Removed, Security

### Community 524 - "SKILL: Industrial Brutalism & Tactical Telemetry UI"
Cohesion: 0.12
...
### Community 525 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 526 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 527 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 528 - "get"
Cohesion: 0.02
Nodes (99): auth_me(), brain_failover_status(), brain_providers(), _check_storage_health(), cost_attribution_stats(), cost_table(), discover_remote_skills(), doctor_health() (+91 more)

### Community 529 - "Section-by-Section Acceptance Criteria"
Cohesion: 0.12
...
### Community 531 - "test_llm_router_tpm.py"
Cohesion: 0.20
...
### Community 532 - "brain_config.py"
Cohesion: 0.06
Nodes (47): _build_base_url_env_from_yaml(), _provider_env_value(), _provider_ids_from_literal(), provider_key_rotation_enabled(), provider_max_parallel(), provider_max_rpm(), provider_max_tpm(), _provider_positive_float() (+39 more)

### Community 533 - "test_daily_2026_07_24.py"
Cohesion: 0.20
...
### Community 534 - "agent_readiness_audit.py"
Cohesion: 0.21
...
### Community 538 - "test_daily_automation_2026_07_11.py"
Cohesion: 0.15
...
### Community 539 - "test_health_endpoints.py"
Cohesion: 0.17
...
### Community 540 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 541 - "test_openclaw_endpoints.py"
Cohesion: 0.12
...
### Community 543 - "hermes_prompt.py"
Cohesion: 0.19
...
### Community 545 - "MemoryMiddleware"
Cohesion: 0.17
...
### Community 548 - "Skill: repowise-intelligence"
Cohesion: 0.12
...
### Community 549 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
...
### Community 550 - "admin_digest_router.py"
Cohesion: 0.22
...
### Community 551 - "Skill: repowise-intelligence"
Cohesion: 0.12
Nodes (15): 1. Graph Intelligence (Dependency Graph), 2. Git Intelligence, 3. Documentation Intelligence, 4. Decision Intelligence, Acceptance Checks, Directory Structure, Example Usage, Implementation Approach (+7 more)

### Community 552 - "The 10-Step Workflow"
Cohesion: 0.12
...
### Community 553 - "Contributing to local-llm-server"
Cohesion: 0.12
...
### Community 554 - "refresh_agent_built_proof.py"
Cohesion: 0.20
...
### Community 555 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 556 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 557 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
...
### Community 559 - "test_phase6_workflow.py"
Cohesion: 0.14
Nodes (28): Return True if the PR exists and is open or merged; False if 404., verify_pr_exists(), _make_store(), _make_task(), asyncio, tests/test_phase6_workflow.py — Phase 6: workflow engine, safe_agency, Task…, Create a minimal Task for testing., run() must call store.update after each phase and reach DONE. (+20 more)

### Community 560 - "SQLiteStore"
Cohesion: 0.17
...
### Community 565 - "test_telegram_auto_approve.py"
Cohesion: 0.21
...
### Community 566 - "ManagedAgentDreams"
Cohesion: 0.22
...
### Community 567 - "get_ceo_dispatcher"
Cohesion: 0.11
...
### Community 568 - "_process_task_callback"
Cohesion: 0.28
...
### Community 569 - "test_autonomy_status.py"
Cohesion: 0.12
...
### Community 571 - "WorkflowBuildRequest"
Cohesion: 0.09
...
### Community 572 - "AnthropicProvider"
Cohesion: 0.09
...
### Community 575 - "test_frontend_deployment_guards.py"
Cohesion: 0.18
...
### Community 576 - "test_glm52_brain.py"
Cohesion: 0.12
...
### Community 577 - "test_langfuse_agency_wide.py"
Cohesion: 0.12
...
### Community 578 - "test_local_brain_state.py"
Cohesion: 0.12
...
### Community 580 - "TestKillSwitchDurability"
Cohesion: 0.15
...
### Community 582 - "test_refresh_agent_built_proof.py"
Cohesion: 0.12
...
### Community 583 - "test_telegram_diag_endpoint.py"
Cohesion: 0.12
...
### Community 585 - "DirectChatSession"
Cohesion: 0.15
...
### Community 588 - "CollaborationContext"
Cohesion: 0.17
...
### Community 589 - "Skill: agent-harness"
Cohesion: 0.13
...
### Community 590 - "Skill: checkpoint-strategy"
Cohesion: 0.13
...
### Community 592 - "Skill: local-ai-query"
Cohesion: 0.13
...
### Community 593 - "Skill: parallel-agents"
Cohesion: 0.13
...
### Community 594 - "Skill: parallel-worktrees"
Cohesion: 0.13
...
### Community 595 - "Design System: Taste Standard"
Cohesion: 0.13
...
### Community 597 - "Skill: user-research"
Cohesion: 0.13
...
### Community 598 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 600 - "Changelog"
Cohesion: 0.29
Nodes (7): Added, Changed, Changelog, Fixed, Maintenance, Removed, Security

### Community 601 - "implement_agent.py"
Cohesion: 0.16
...
### Community 602 - "KnowledgeScreen.jsx"
Cohesion: 0.13
...
### Community 605 - "run_trend_analysis"
Cohesion: 0.18
...
### Community 606 - "TestDecisionsBotLinks"
Cohesion: 0.17
...
### Community 607 - "DecisionsStore"
Cohesion: 0.30
Nodes (3): DecisionsStore, Any, Connection

### Community 608 - "ToolAnnotations"
Cohesion: 0.24
Nodes (6): Typed representation of MCP tool annotations (spec 2025-11-05 §5.6.1). All…, Return True only when the tool is definitively read-only and non-destructive.…, ToolAnnotations, ToolAnnotations.is_safe_to_explore reflects read-only + non-destructive., Unknown destructive status → not safe., TestToolAnnotationsIsSafeToExplore

### Community 609 - "e2e/test_browser.py"
Cohesion: 0.23
...
### Community 611 - "test_dockerfile_ships_config_dir.py"
Cohesion: 0.14
...
### Community 613 - "Workspace Isolation Architecture"
Cohesion: 0.17
...
### Community 618 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 622 - "Checks Performed"
Cohesion: 0.14
...
### Community 623 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 624 - "Skill: branch-cleanup"
Cohesion: 0.14
...
### Community 625 - "Skill: perplexity — Web Research via Perplexity API"
Cohesion: 0.14
...
### Community 628 - "Quick-Note Issues Processing Summary"
Cohesion: 0.14
...
### Community 629 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 631 - "Render MCP — autonomous platform debugging and environment monitoring"
Cohesion: 0.14
...
### Community 632 - "Runbook: Auto-Resume After Cooldown / Interruption"
Cohesion: 0.14
...
### Community 633 - "SEO / GEO / AIO Audit Engine"
Cohesion: 0.14
...
### Community 637 - "_ensure_tasks_source_id_unique_index"
Cohesion: 0.14
...
### Community 638 - "_parse_reset_epoch"
Cohesion: 0.33
...
### Community 642 - "cowork_session.py"
Cohesion: 0.15
...
### Community 646 - "test_openclaw_gateway.py"
Cohesion: 0.14
...
### Community 647 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 650 - "tests/conftest.py"
Cohesion: 0.05
...
### Community 654 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 657 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 658 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 661 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
...
### Community 662 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 663 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 665 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 667 - "admin_update_task_router.py"
Cohesion: 0.22
...
### Community 669 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
Nodes (12): Acceptance Checks, Claude's query protocol (use this instead of Read tool for exploration):, Graph Artifacts — What to Commit, How to Use the Graph (Token Savings Protocol), Installation (one-time per machine), Instead of reading raw files:, Key commands:, Relationship to repowise-intelligence Skill (+4 more)

### Community 670 - "Skill: platform-setup — Autonomous Agency Bootstrap"
Cohesion: 0.15
...
### Community 671 - "Device compatibility and model picks"
Cohesion: 0.15
...
### Community 672 - "Autonomy Uplift — Living Roadmap & Detailed Implementation Specs"
Cohesion: 0.15
...
### Community 673 - "OpenClaw — iOS Control of the Agency (Single-Service Free-Tier Deploy)"
Cohesion: 0.15
...
### Community 676 - "_is_bedrock_model_id"
Cohesion: 0.27
...
### Community 678 - "Agent Transparency Report"
Cohesion: 0.15
...
### Community 679 - "update_provider_policy"
Cohesion: 0.19
...
### Community 681 - "_InMemoryBackend"
Cohesion: 0.18
...
### Community 682 - "TestModelCostTableUpdates"
Cohesion: 0.26
...
### Community 683 - "TestMCPClientStructuredOutput"
Cohesion: 0.31
...
### Community 684 - "test_deploy_trigger_covers_image.py"
Cohesion: 0.21
...
### Community 687 - "TestRouterIntegration"
Cohesion: 0.31
...
### Community 689 - "WorkspaceManifest"
Cohesion: 0.17
...
### Community 691 - "skill_registry.py"
Cohesion: 0.17
...
### Community 693 - "AGENTS.md — Codebase Map & Operations Reference"
Cohesion: 0.17
...
### Community 698 - "Skill: system-prompt-audit"
Cohesion: 0.17
...
### Community 699 - "Skill: task-alive-updates"
Cohesion: 0.17
...
### Community 702 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 705 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 707 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 708 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 709 - "Quantization Internals"
Cohesion: 0.17
...
### Community 710 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 711 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 712 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 714 - "capture_screens.py"
Cohesion: 0.29
...
### Community 715 - "check_container_posture.py"
Cohesion: 0.26
...
### Community 716 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 717 - "test_admin_local_brain_router.py"
Cohesion: 0.29
...
### Community 718 - "test_agile_api.py"
Cohesion: 0.17
...
### Community 719 - "test_app_settings.py"
Cohesion: 0.21
...
### Community 721 - "ProviderHealth"
Cohesion: 0.35
Nodes (3): ProviderHealth, Any, Rolling health for one provider.

### Community 722 - "TestAnthropicPayloadStructuredOutput"
Cohesion: 0.29
...
### Community 723 - "test_task_clarification.py"
Cohesion: 0.17
...
### Community 727 - "_extractive_compress"
Cohesion: 0.18
...
### Community 731 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 734 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 735 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 737 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 740 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 741 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 742 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 743 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 744 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 745 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 746 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 747 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 749 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 750 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 751 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 752 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 753 - "What to clean up"
Cohesion: 0.18
...
### Community 754 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 757 - "test_bedrock_live.py"
Cohesion: 0.25
...
### Community 758 - "_get_current_user"
Cohesion: 0.25
...
### Community 764 - "TestPolicyAuthoringUiStableClaim"
Cohesion: 0.22
...
### Community 766 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 767 - "test_event_log.py"
Cohesion: 0.45
...
### Community 770 - "test_tasks_reconciler_todo_requeue.py"
Cohesion: 0.18
...
### Community 774 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 775 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 777 - "test_agent_free_brain.py"
Cohesion: 0.05
...
### Community 778 - "_normalize_tool_choice"
Cohesion: 0.31
...
### Community 779 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 780 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 781 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 782 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 783 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 784 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 785 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 787 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 788 - "LLM Router — configuration guide"
Cohesion: 0.20
...
### Community 789 - "LLM Router — provider guide"
Cohesion: 0.20
...
### Community 790 - "CI Troubleshooting Runbook"
Cohesion: 0.20
...
### Community 800 - "TestCEOAgencySystem"
Cohesion: 0.33
...
### Community 801 - "TestAnthropicToolListCaching"
Cohesion: 0.34
...
### Community 802 - "TestTelegramNotifications"
Cohesion: 0.40
...
### Community 803 - "TestZeroAttemptDiagnostics"
Cohesion: 0.29
...
### Community 809 - "test_render_mcp.py"
Cohesion: 0.08
...
### Community 814 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 815 - "Skill: changelog-enforcer"
Cohesion: 0.22
...
### Community 816 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 818 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 819 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 820 - "Skill: changelog-enforcer"
Cohesion: 0.22
Nodes (8): Acceptance Checks, Changelog Location, Entry Format, Examples, Hook Behaviour, Instructions, Skill: changelog-enforcer, When to Use

### Community 821 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
Nodes (8): Branch, Components, Purpose, Quick Start, Session Roles, Skill: cowork-session (Claude Cowork), Testing, When to Use

### Community 822 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 823 - "Active Task Tracker"
Cohesion: 0.22
...
### Community 825 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 826 - "Main proxy (`proxy.py`)"
Cohesion: 0.20
...
### Community 827 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 828 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 829 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 830 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 831 - "Platform Controls"
Cohesion: 0.22
...
### Community 832 - "Release Procedure"
Cohesion: 0.22
...
### Community 833 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 840 - "enrich_quick_note_issues.py"
Cohesion: 0.42
...
### Community 841 - "clear_wizard_state_cache"
Cohesion: 0.21
...
### Community 844 - "test_changelog_parity_guard.py"
Cohesion: 0.22
...
### Community 846 - ".on_task_complete"
Cohesion: 0.16
...
### Community 847 - "test_scanner_deps_parity.py"
Cohesion: 0.31
...
### Community 854 - "TestDirectChatAgentExecution"
Cohesion: 0.33
...
### Community 855 - "quality_checker.py"
Cohesion: 0.32
...
### Community 857 - "_is_ephemeral_user"
Cohesion: 0.23
Nodes (13): account_lifecycle(), _is_ephemeral_user(), True when this user's companies should be temporary (reaped after TTL).…, Best-effort auth provider for a user dict. social_auth users carry an explicit…, Return whether the current user's agencies are ephemeral + when they expire.…, _resolve_provider(), Tests for company lifecycle gating — who gets ephemeral vs persistent agencies.…, test_admin_local_is_persistent() (+5 more)

### Community 858 - "Agent: Implementer (Executor)"
Cohesion: 0.25
Nodes (8): Activation, Agent: Implementer (Executor), Constraints, Handoff, Preferred Model, Responsibilities, Role, Shared State

### Community 859 - "Agent: Judge (Release / QA Gate)"
Cohesion: 0.25
Nodes (7): Activation, Agent: Judge (Release / QA Gate), Enforcement, Output, Responsibilities, Role, Verdict Meanings

### Community 860 - "Agent: Planner (Architect)"
Cohesion: 0.25
Nodes (8): Activation, Agent: Planner (Architect), Failure Behaviour, Handoff, Output Format, Preferred Model, Responsibilities, Role

### Community 861 - "Skill: browserbase-browser — Real Browser Automation"
Cohesion: 0.25
...
### Community 868 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 873 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.25
...
### Community 874 - "Issue #362: Nvidia repo setup"
Cohesion: 0.25
...
### Community 875 - "Issue #364: quick-note:https://www.marktechpost.com/2026/06/01/meet-memory-os-a-6-layer-open-source-memory-stack-built-on-top-of-hermes-agent/"
Cohesion: 0.25
...
### Community 876 - "Issue #378: quick-note:https://www.marktechpost.com/2026/06/02/tinyfish-launches-bigset-an-open-source-multi-agent-system-that-builds-structured-live-datasets-from-plain-english-descriptions/"
Cohesion: 0.25
...
### Community 877 - "Issue #379: quick-note:https://searchengineland.com/schema-markup-optimize-agentic-web-479080"
Cohesion: 0.25
...
### Community 878 - "Issue #380: quick-note:https://cursor.com/blog/cloud-agent-lessons"
Cohesion: 0.25
...
### Community 879 - "Issue #381: quick-note:https://www.xda-developers.com/claude-code-with-opus-48-is-expensive-but-i-made-it-efficient-with-my-local-ai-workflow/"
Cohesion: 0.25
...
### Community 880 - "Issue #382: quick-note:https://claude.com/blog/how-coderabbit-used-claude-to-build-an-agent-orchestration-system"
Cohesion: 0.25
...
### Community 881 - "Issue #383: quick-note:https://www.marktechpost.com/2026/05/29/hexo-labs-open-sources-sia-a-self-improving-agent-that-updates-both-the-harness-and-the-model-weights/"
Cohesion: 0.25
...
### Community 882 - "Issue #416: feat: Self-hosted Codebuff (freebuff) on free NVIDIA models + Telegram bot phone control"
Cohesion: 0.25
...
### Community 883 - "Issue #485: [Trend Digest] Week of 2026-06-08"
Cohesion: 0.25
...
### Community 884 - "Issue #488: quick-note:https://github.com/cookiy-ai/user-research-skill"
Cohesion: 0.25
...
### Community 885 - "Issue #491: Implement whatever is necessary from https://github.com/BehiSecc/awesome-claude-skills"
Cohesion: 0.25
...
### Community 886 - "Issue #493: Use the https://github.com/mvanhorn/last30days-skill skill to get the trend updated"
Cohesion: 0.25
...
### Community 887 - "Issue #495: Read https://www.anthropic.com/news/claude-fable-5-mythos-5 and understand if mythos or fable can be added to the repo"
Cohesion: 0.25
...
### Community 888 - "Issue #504: EPIC: Autonomy hardening — live-verified defects 2026-06-10"
Cohesion: 0.25
...
### Community 889 - "Issue #581: Sprint tracker: pending work after brand rename + mobile-first pass"
Cohesion: 0.25
...
### Community 891 - "Issue #657: quick-note:https://github.com/earendil-works/pi"
Cohesion: 0.25
...
### Community 892 - "Issue #659: quick-note:https://github.com/nex-agi/Nex-N2"
Cohesion: 0.25
...
### Community 893 - "Issue #660: quick-note:https://github.com/getsentry/sentry-for-ai"
Cohesion: 0.25
...
### Community 894 - "Issue #661: quick-note:https://github.com/XiaomiMiMo/MiMo-Code"
Cohesion: 0.25
...
### Community 895 - "Issue #664: quick-note:https://github.com/Grominet95/jarvis-OS"
Cohesion: 0.25
...
### Community 896 - "Issue #666: quick-note:https://github.com/porokka/jarvis-os"
Cohesion: 0.25
...
### Community 897 - "Issue #670: quick-note:https://github.com/perplexityai/bumblebee"
Cohesion: 0.25
...
### Community 898 - "Issue #672: quick-note:https://github.com/Chachamaru127/claude-code-harness"
Cohesion: 0.25
...
### Community 899 - "Issue #676: quick-note:https://github.com/WeiboAI/VibeThinker"
Cohesion: 0.25
...
### Community 900 - "Issue #820: quick-note:https://github.com/cobusgreyling/loop-engineering"
Cohesion: 0.25
...
### Community 901 - "Positional Encoding Internals"
Cohesion: 0.25
...
### Community 903 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 904 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 905 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 906 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 908 - "Prime Agent Runtime"
Cohesion: 0.25
...
### Community 915 - "test_compose_and_coordinate_api.py"
Cohesion: 0.36
...
### Community 916 - "test_generate_context_standing_instructions.py"
Cohesion: 0.32
...
### Community 917 - "test_local_brain_router_smoke.py"
Cohesion: 0.25
...
### Community 920 - "test_provider_models_db_outage.py"
Cohesion: 0.25
...
### Community 921 - "test_providers_live_e2e.py"
Cohesion: 0.27
...
### Community 924 - "test_serve_spa_prefixes.py"
Cohesion: 0.36
...
### Community 926 - "test_tasks_awaiting_approval_api.py"
Cohesion: 0.37
...
### Community 928 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 931 - "_status_snapshot"
Cohesion: 0.31
...
### Community 937 - "AI Engineering Insights Skill"
Cohesion: 0.29
...
### Community 948 - "ADR-006: Strangler Fig migration with backward-compat shims"
Cohesion: 0.29
Nodes (6): ADR-006: Strangler Fig migration with backward-compat shims, Consequences, Context, Decision, Examples, Migration path

### Community 949 - "claude-mem Plugin — Persistent Memory for All Sessions"
Cohesion: 0.29
...
### Community 950 - "Implementation plan + TO-DO (check off as you go)"
Cohesion: 0.29
...
### Community 967 - "test_daily_2026_06_14.py"
Cohesion: 0.38
...
### Community 968 - "TestSupportMatrixDocsSync"
Cohesion: 0.29
...
### Community 969 - "TestGithubTokenSQLiteRegression"
Cohesion: 0.38
...
### Community 970 - "TestReasonsAreActionable"
Cohesion: 0.29
...
### Community 972 - "TestAgentRunnerExecution"
Cohesion: 0.33
...
### Community 973 - "TestWorkflowIntegration"
Cohesion: 0.33
...
### Community 991 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 992 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 993 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 994 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 995 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 996 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 997 - "_redact_for_notification"
Cohesion: 0.24
...
### Community 1000 - "WorkflowTransition"
Cohesion: 0.33
...
### Community 1001 - "apply_phase1_changes.py"
Cohesion: 0.33
...
### Community 1015 - "TestPaidPolicyDurability"
Cohesion: 0.22
...
### Community 1031 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 1032 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 1041 - "scripts/agile_ceremonies.py"
Cohesion: 0.60
...
### Community 1057 - "TestModelRoleSeparation"
Cohesion: 0.40
...
### Community 1074 - "render"
Cohesion: 0.50
Nodes (3): RENDER_API_KEY, docker, render

### Community 1075 - "scripts"
Cohesion: 0.50
Nodes (4): scripts, build, start, test

### Community 1078 - "stop_colibri_server.ps1"
Cohesion: 0.83
Nodes (3): Fail(), Ok(), W()

### Community 1079 - "test_provider_state_durability.py"
Cohesion: 0.11
...
### Community 1093 - "github"
Cohesion: 0.50
Nodes (3): github, enabled, silent

### Community 1098 - "TestDetectedSystemPersistence"
Cohesion: 0.07
...
### Community 1118 - "test_the_reserve_is_bounded_when_read_from_the_environment"
Cohesion: 0.67
...
### Community 1121 - "._resolve_merge_decision"
Cohesion: 0.25
...
## Knowledge Gaps
- **3411 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3406 more)
...
- **Why does `_fixture()` connect `_fixture` to `company_api.py`, `test_company_api.py`, `test_llm_router_strategies.py`, `model_discovery.py`, `test_llm_router_resilience.py`, `E2BSandboxSession`, `SelfHealingAgent`, `TaskStore`, `test_model_router.py`, `ImprovementLoop`, `test_llm_router_tpm.py`, `Task`, `webui/router.py`, `llm/router.py`, `Agency`, `PolicyEngine`, `AgentProfile`, `MCPClient`, `test_openclaw_endpoints.py`, `BrainConfig`, `test_unit8_model_catalog.py`, `resolve_active_brain`, `PrimeAgentAdapter`, `get_skill_bindings`, `test_failover_client_shared.py`, `UserRole`, `AgentJobManager`, `SQLiteStore`, `model_router.py`, `get_runtime_manager`, `test_telegram_auto_approve.py`, `get_ceo_dispatcher`, `test_provider_state_durability.py`, `test_autonomy_status.py`, `ExecutionRequest`, `services/background.py`, `WorkflowBuildRequest`, `ChatHistoryStore`, `test_sam_livekit.py`, `test_local_brain_state.py`, `reset_orchestrator`, `TokenBudget`, `test_refresh_agent_built_proof.py`, `services/seo_audit.py`, `test_telegram_diag_endpoint.py`, `ResearchTask`, `SchedulerStore`, `test_brain_config_store.py`, `TestClient`, `config.py`, `ArtifactStore`, `test_procedural_memory.py`, `test_agent_tool_governance.py`, `e2e/test_browser.py`, `workflow/models.py`, `KeyStore`, `TestHarnessAdapter`, `test_knowledge_sync.py`, `SeoFixRequest`, `resolve_e2b_config`, `test_startup_warmup.py`, `CacheManager`, `test_autonomous_agency_e2e.py`, `test_context_rulebook.py`, `FreeBuffAgent`, `run_task`, `rate_limiter.py`, `test_provider_router.py`, `test_openclaw_gateway.py`, `test_brain_failover_413.py`, `tests/conftest.py`, `test_kimi_bridge_server.py`, `api_keys_for`, `persist_plan_spec`, `test_telegram_freebuff.py`, `claim`, `test_issue_intake.py`, `test_new_features_e2e.py`, `TestEstimateTokensForMessages`, `clear_cooldowns`, `test_e2b_adapter.py`, `_Budget`, `test_e2b_task_wiring.py`, `OllamaCircuitBreaker`, `analyze_page`, `test_features_api.py`, `test_video_transcript.py`, `BrainWatchdog`, `test_platform_controls.py`, `NotificationDispatcher`, `capture_screens.py`, `test_agile_api.py`, `test_app_settings.py`, `_FakeFiles`, `test_task_clarification.py`, `TrendWatcher`, `.record`, `test_telegram_service_webhook.py`, `test_portfolio_intake.py`, `TestClient`, `AgentSwarm`, `FeatureMaturity`, `ContextPruner`, `BudgetTracker`, `test_persistent_memory.py`, `SecurityScanner`, `test_llm_router_e2e.py`, `test_tasks_reconciler_todo_requeue.py`, `OutputFilter`, `test_agent_free_brain.py`, `CEOLedger`, `test_orchestrator_merge_decision.py`, `OrchestratorQueue`, `cost_tracker.py`, `routed`, `test_mcp_governance.py`, `test_purge_backlog.py`, `test_sam_voice.py`, `test_scheduler_hydration_bounded.py`, `probe_model_liveness`, `_clean_phases`, `test_crispy_burn_in.py`, `test_provider_enable_disable.py`, `test_skill_registry_boot_refresh.py`, `.on_task_complete`, `tasks/models.py`, `test_dashboard_cache.py`, `get_scheduler`, `session_retro.py`, `isolated_telegram_config`, `test_phase5_doctor.py`, `test_claude_code_adapter.py`, `validate_policy_text`, `test_service_token.py`, `test_harness_spec.py`, `test_regression.py`, `test_agency_fix.py`, `_clean_director`, `sam`, `test_webui_provider_priority.py`, `_resolve_user_github_token`, `test_ping.py`, `test_monitor_lib.py`, `test_v4_api.py`, `TestAgentRunnerSafety`, `OrchestratorCheckpointStore`, `clear_override`, `test_direct_chat_evolution.py`, `test_task_store_fails_loud_in_production.py`, `test_provider_410_per_model.py`, `client`, `reap_expired_companies`, `test_voice_pipeline.py`, `TestNormalizeResponseFormat`, `test_ceo_router.py`, `TestMongoGate`, `test_brain_patch_service_token.py`, `test_ai_insights.py`, `TestSwarmRoleRouting`, `test_doctor_coding_brain.py`, `allow_paid`, `test_runtimes_health_endpoint.py`?**
  _High betweenness centrality (0.092) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `proxy.py`, `BrainFailoverExhausted`, `LocalWorkspace`, `TaskSpec`, `test_agent_free_brain.py`, `test_brain_failover_413.py`, `E2BSandboxSession`, `ReactScratchpad`, `ContextManager`, `TaskDispatcher`, `backend/server.py`, `test_daily_automation_2026_07_11.py`, `TestGetCurrentTimeTool`, `TestAgentRunnerSafety`, `PolicyEngine`, `MCPClient`, `test_e2b_adapter.py`, `MultiAgentSwarm`, `StuckDetector`, `test_backend_server_features.py`, `test_failover_client_shared.py`, `WorkspaceTools`, `CEODispatcher`, `AgentJobManager`, `get_ceo_dispatcher`, `ExecutionRequest`, `.execute`, `TokenBudget`, `TestAgentRunnerExecution`, `direct_chat.py`, `test_agent_tool_governance.py`, `workflow_orchestrator.py`, `loop.py`, `AdaptiveHalter`, `ContextPruner`, `UserMemoryStore`, `InternalAgentAdapter`, `GitHubTools`, `test_governance_api.py`, `validate_policy_text`, `AgentSessionStore`, `test_autonomous_agency_e2e.py`, `FreeBuffAgent`, `test_empirical_verify.py`?**
