...
## Communities (1302 total, 121 thin omitted)

### Community 0 - "CompanyGraphStore"
Cohesion: 0.01
Nodes (197): patch, Update a company's metadata. Accepts partial updates for company fields…, Synchronize the Company Graph. Re-scans all websites and repositories, updates…, Scan a repository for technology stack and systems., scan_repo_endpoint(), sync_company_graph(), update_company(), ApprovalPolicy (+189 more)

### Community 1 - "seo_api.py"
Cohesion: 0.02
Nodes (161): build_seo_roadmap(), delegate_seo_findings(), _expire_stale_pending_report(), export_seo_audit(), get_seo_audit(), list_seo_audits(), plan_seo_sprint(), BaseModel (+153 more)
...
Cohesion: 0.02
Nodes (98): Find a website by its URL., A company website with detected systems and stack inference., Website, Add a website to a company. Args: company_id: Company ID url: Website URL…, MongoDBStore, Any, ObjectId, Prepare a Pydantic model for SQLite storage. (+90 more)

### Community 5 - "test_llm_router_queue_cache.py"
Cohesion: 0.02
Nodes (110): Test hook — clear all usage accounting., reset(), CacheManager, cosine_similarity(), _Entry, LRUCache, payload_key(), Any (+102 more)

### Community 6 - "ExecutionRequest"
Cohesion: 0.03
Nodes (102): Execute work through the 11-phase golden path., Called by APScheduler when a cron fires. Dispatches to the orchestrator. This…, _scheduler_on_fire(), workflow_orchestrator_execute(), get_orchestrator_supervisor(), OrchestratorSupervisor, Any, services/orchestrator_supervisor.py — Deterministic Supervisor Issue #522: A… (+94 more)

### Community 7 - "proxy.py"
Cohesion: 0.03
Nodes (162): Describes a single worker's task and constraints., WorkerSpec, middleware, admin_control(), admin_delete_user(), admin_login(), admin_logout(), admin_rotate_user() (+154 more)

### Community 8 - "llm/router.py"
Cohesion: 0.03
Nodes (112): Attempt, int, FailoverResult, A successful completion plus the accounting its callers need., text_key(), failover_chat_completion_via_router(), openai_body_from_response(), Any (+104 more)
...
### Community 10 - "WebsiteScanner"
Cohesion: 0.02
Nodes (105): DetectedSystem, Evidence, Result of a website scan with detected systems and stack inference., Evidence supporting a system detection., A business system detected on a company's website or in their stack., Get the most confident evidence description., Inferred technology stack from website/repo analysis., StackInference (+97 more)

### Community 11 - "ProviderRouter"
Cohesion: 0.03
Nodes (93): build_tool_calling_router(), Return a router limited to providers that pass ``tools`` through intact. The…, CommercialFallbackRequiredError, _dead_model_key(), _exponential_backoff_cooldown(), _get_director(), is_commercial_provider(), _mark_model_dead() (+85 more)

### Community 12 - "Task"
Cohesion: 0.03
Nodes (94): classify_domain(), Return the best-matching domain for a task title+description., emit_agency_observation(), Record an agency platform operation in Langfuse. Unlike…, Full task/issue document., Task, _brain_is_configured(), _gate_outward_facing_enabled() (+86 more)

### Community 13 - "AgentJobManager"
Cohesion: 0.03
Nodes (75): AgentJob, AgentJobManager, heartbeat(), make_isolated_workspace(), _now(), Any, Path, agent/job_manager.py — Async agent job lifecycle manager. Manages agent jobs… (+67 more)

### Community 14 - "failover_client.py"
Cohesion: 0.03
Nodes (95): _auto_disable(), _describe_registry(), _disable_unless_key_serves_other_models(), _is_billing_refusal(), _is_ollama(), _key_pool(), _log_exhaustion(), _log_recovery() (+87 more)

### Community 15 - "SelfHealingAgent"
Cohesion: 0.03
Nodes (97): get_improvement_loop(), get_log_monitor(), set_log_monitor(), FailureCategory, get_self_healing_agent(), HealingEvent, _now(), Any (+89 more)
...
### Community 17 - "test_ceo_supervision.py"
Cohesion: 0.03
Nodes (98): _harvest_changed_files(), Extract the files a runtime touched. Returns ``(files, reported)``. Adapters…, Attempt, _backend(), CEOLedger, GoalRecord, _now(), Any (+90 more)

### Community 18 - "tasks/models.py"
Cohesion: 0.03
Nodes (110): agent/workflow.py — Persisted workflow state machine. Implements the Autonomous…, tasks — Task/issue management system. Provides a lightweight task/issue tracker…, _capability_tags(), create_task_from_oldest_open_issue(), intake_issue(), _issue_labels(), issue_source_id(), map_issue_to_task() (+102 more)
...
Cohesion: 0.03
Nodes (77): AgentRunner, Path, Append an event to the durable session log if a store is wired in., Summarise a long history and compact it. Asks the planner model to write a…, Send chat messages and return the assistant's text output. If an…, Call-time resolver for an agent role model id. Delegates to…, Parse an LLM tool-call response, tolerating common malformations. Handles: 1.…, Run real validation (byte-compile + scoped pytest) on this step's changes. Opt-… (+69 more)

### Community 21 - "RuntimeHealth"
Cohesion: 0.04
Nodes (80): kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, AiderAdapter, Any, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Adapter for Aider — TIER 3 specialized git-aware code editor., runtimes/adapters/docker_agent.py — Docker-based agent runtime adapter. Spawns…, E2BAdapter (+72 more)

### Community 22 - "test_runtimes.py"
Cohesion: 0.03
Nodes (50): Any, Adapter for a compatible external task harness., TaskHarnessAdapter, Start a runtime as a local subprocess wrapper., _start_local_runtime(), CircuitState, runtimes/health.py — RuntimeHealthService. Periodically polls all registered…, Return the last-known health for *runtime_id* (may be stale). (+42 more)
...
### Community 24 - "test_user_research_skill.py"
Cohesion: 0.03
Nodes (68): get_tool_registry(), Return the module-level ToolRegistry singleton. On first call, registers built-…, analyze_qualitative(), analyze_quantitative(), auto_register(), _classify_sentiment(), _extract_keywords(), plan_research() (+60 more)

### Community 25 - "loop.py"
Cohesion: 0.04
Nodes (69): get_enrichment(), agent/harness_enrichment.py — Automatic Harness Enrichment for Agent Prompts…, Return the enrichment instance for a workspace. Keyed by workspace root rather…, Agent subsystem — planner / executor / verifier loop., loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., # NOTE: "ollama_base" is kept for backwards compatibility; this runner only…, AgentEvent, AgentPlan (+61 more)

### Community 26 - "test_model_router.py"
Cohesion: 0.03
...
Cohesion: 0.03
Nodes (91): _egress_policy_reason(), Return why governance policy blocks *host*, or None. Runs strictly *after* the…, AgentIdentity, _coerce_text(), new_session_id(), Any, packages/governance/identity.py — who is acting, and under what mandate. Docker…, The acting subject of a governed action. Immutable by construction so a… (+83 more)

### Community 28 - "BrainConfig"
Cohesion: 0.03
Nodes (91): _migrate_brain_to_safe_default(), BrainConfig, BrainConfigPatch, BrainConfigStore, default_brain_config(), get_brain_config(), get_brain_config_store(), BaseModel (+83 more)
...
### Community 30 - "TaskSpec"
Cohesion: 0.04
Nodes (72): TaskResult, Run aider non-interactively via `--message` flag., ClaudeCodeAdapter, json_safe(), Any, TaskResult, runtimes/adapters/claude_code.py — Claude Code CLI adapter (FIRST CLASS).…, Adapter for Claude Code CLI — FIRST CLASS autonomous coding runtime. (+64 more)

### Community 31 - "_fixture"
Cohesion: 0.02
Nodes (89): _clear_discovered_models(), _clear_response_cache(), _isolate_brain_data_layer(), _isolate_operator_provider_state(), MonkeyPatch, Path, Default all tests to legacy workflow mode (Phase 2 compatibility). Only patches…, Session-wide autouse: stub out any DB reads that go through… (+81 more)
...
### Community 33 - "direct_chat.py"
Cohesion: 0.04
Nodes (91): DirectChatDoctor, PreflightIssue, PreflightReport, Any, BaseModel, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, Translate technical preflight issues into a conversational assistant reply., translate_error_to_conversational() (+83 more)

### Community 34 - "WorkflowOrchestrator"
Cohesion: 0.03
Nodes (56): check_kwargs(), Any, agent/contract_enforcement.py — Runtime signature locking (J) Provides…, # NOTE: limit has a default so it is accepted; owner_id is keyword-only., Raise TypeError on unknown kwarg (runtime extra='forbid'). Args: kwargs: The…, # NOTE: limit is NOT locked — it is a legitimate optional param that does not, _NoopStore, Any (+48 more)
...
Cohesion: 0.04
Nodes (69): MCPUnavailableError, agent/mcp_client.py — Async MCP client for the mcp-server Docker container.…, Raised when the MCP server is unreachable or the circuit is open., E2BSandboxSession, _inject_token(), maybe_attach_e2b(), Any, services/e2b_sandbox.py — E2B Firecracker micro-VM sandbox session. Implements… (+61 more)

### Community 37 - "ImprovementLoop"
Cohesion: 0.04
Nodes (68): DetectedIssue, ImprovementLoop, ImprovementLoopState, IssueCategory, IssueSeverity, _now(), Any, Enum (+60 more)

### Community 38 - "company_api.py"
Cohesion: 0.04
Nodes (98): ephemeral_ttl_hours(), Async read of the ephemeral TTL (hours) straight from the DB., account_lifecycle(), AccountLifecycleResponse, auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint() (+90 more)

### Community 39 - "test_failover_client_shared.py"
Cohesion: 0.05
Nodes (91): BrainFailoverExhausted, failover_chat_completion(), RuntimeError, Every provider in the failover chain failed — the terminal error. Carries the…, Run one chat completion across the brain-failover chain. Tries each healthy…, mark_dead(), Hold *model_id* out of *provider_id*'s rotation for *ttl_sec* seconds. Called…, _free_tier() (+83 more)

### Community 40 - "Agency"
Cohesion: 0.05
Nodes (73): Agency, AgencyCycleResult, AgentDirective, AgentRole, _build_ceo_prompt(), _build_quick_note_instruction(), _close_github_issue(), _collect_recent_git_context() (+65 more)

### Community 41 - "test_unit8_model_catalog.py"
Cohesion: 0.03
Nodes (82): _brain_provider_status(), get_catalog_models_route(), Return the mirrored model catalog (advisory-only). Flag-gated by…, Force a catalog mirror rebuild + persist (admin only). Rebuilds the catalog…, Return per-provider metadata for the GET endpoint. Iterates every provider in…, Return the discovered model list for *provider_id*, or ``[]`` if unknown., _served_models(), sync_catalog_route() (+74 more)
...
Cohesion: 0.03
Nodes (71): Backoff policy for retryable failures., RetryConfig, BreakerState, Enum, str, packages/llm/health.py — provider health tracking and circuit breaking. Two…, Test hook — clear all health state., reset() (+63 more)

### Community 44 - "TaskStatus"
Cohesion: 0.04
Nodes (62): AgentDefinition, Any, field_validator, A user-defined agent configuration stored in the database., Accept both ISO-8601 datetime strings (from DB) and float timestamps., Keep legacy backend fields and Control Plane UI fields aligned., autonomy_tick(), Execute ONE pending task synchronously. Called by the cron workflow every 2… (+54 more)

### Community 45 - "AuditLog"
Cohesion: 0.03
Nodes (62): Resolve the JWT signing secret, with a *stable* fallback. Bug fix: the previous…, _resolve_jwt_secret(), Replace the process-wide store. Tests only., reset_approval_store(), AuditEvent, AuditLog, _luhn_ok(), packages/governance/audit.py — the evidence trail for every governed action.… (+54 more)

### Community 46 - "test_agent_runner.py"
Cohesion: 0.03
...
### Community 47 - "test_ceo_dispatcher.py"
Cohesion: 0.04
Nodes (82): ClassifyOutput, get_ceo_fallback_stats(), PlanOutput, CLASSIFY phase: domain and task type determination., PLAN phase: structured execution plan., SELECT_SPECIALIST phase: which specialist(s) handle this work., Increment the named counter (silently ignores unknown reasons)., Return a snapshot of the CEO fallback counters. (+74 more)

### Community 48 - "build_llm_router"
Cohesion: 0.04
Nodes (76): get_budget(), The process-wide budget tracker., get_cache(), The process-wide cache manager., gateway_enabled(), get_config(), Return the process-wide configuration, loading it on first use., Whether the OpenAI-compatible passthrough routes accept traffic. Off by… (+68 more)
...
### Community 50 - "get_task_store"
Cohesion: 0.04
Nodes (84): lifespan(), _deferred_startup_cleanup(), _maybe_boot_purge(), _purge_backlog_core(), quick_notes_submit(), _QuickNoteBody, The task store the background services should use, wiring it if needed.…, Shared purge implementation for the admin endpoint and the boot hook. (+76 more)

### Community 51 - "AgentStore"
Cohesion: 0.04
Nodes (68): _apply_activity_status(), create_agent(), delete_agent(), get_agent(), _get_user(), list_agents(), list_runtime_agents(), Any (+60 more)

### Community 52 - "test_render_mcp.py"
Cohesion: 0.04
...
Cohesion: 0.05
Nodes (54): Register the Web Reach capability (agent/web_reach.py): zero-key internet…, _register_web_reach_tools(), get_web_reach(), _load_script_module(), Any, ModuleType, agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Dynamically load a pure-stdlib helper module from .github/scripts/. Returns… (+46 more)

### Community 55 - "HermesAdapter"
Cohesion: 0.03
Nodes (53): north_mini_code_model_for(), Return the North Mini Code model id served by *provider*, else ``None``.…, Resolve the model id to force for a code-execution run, or ``None``. Returns…, resolve_coding_model_preference(), HermesAdapter, Any, AsyncClient, TaskResult (+45 more)

### Community 56 - "AgentSwarm"
Cohesion: 0.05
...
### Community 58 - "CEODispatcher"
Cohesion: 0.04
Nodes (63): CEODispatcher, _runner_factory(), CEOResult, _complexity_rank(), _decompose_into_subtasks(), get_ceo_dispatcher(), _merge_changed_files(), _offload() (+55 more)

### Community 59 - "FeatureMatrix"
Cohesion: 0.04
Nodes (22): FeatureMatrix, Central support matrix — single source of truth. Loads the canonical feature…, Return True if the feature is enabled and not disabled., Return a warning string for beta/experimental features, or None., Render the matrix as a Markdown table for docs., The feature matrix can produce a markdown table for docs., Every config flag referenced in the matrix should be documented., The matrix should cover the key areas from the spec. (+14 more)

### Community 60 - "UserRole"
Cohesion: 0.06
...
Cohesion: 0.05
Nodes (60): generate_backlog_retro(), generate_standup(), plan_next_sprint(), Agentic Agile — autonomous ceremonies (standup, retro, sprint planning). Where…, Derive a retrospective from the task tracker when no sprint is active. DONE /…, The result of allocating portfolio capacity into a new sprint., Allocate ``capacity`` of WSJF-ranked initiatives into a new sprint. Creates one…, A daily standup digest derived from the task tracker. ``sprint_health`` is… (+52 more)

### Community 62 - "get"
Cohesion: 0.03
Nodes (78): auth_me(), auto_recommend_skills(), brain_failover_status(), brain_providers(), cost_attribution_stats(), discover_remote_skills(), get_brain_policy_route(), _get_github_token() (+70 more)

### Community 63 - "test_loop_registry.py"
Cohesion: 0.05
...
### Community 65 - "test_sam_livekit.py"
Cohesion: 0.04
...
### Community 66 - "get_runtime_manager"
Cohesion: 0.05
...
### Community 69 - "RepowiseIntelligence"
Cohesion: 0.05
...
Cohesion: 0.05
Nodes (32): _infer_parameters_from_func(), Any, Path, Register a tool definition., Decorator to register a function as an agent tool. Usage::…, Remove a tool from the registry. Returns True if removed., Look up a tool by name., Return all registered tools. (+24 more)
...
### Community 75 - "register_webui"
Cohesion: 0.05
Nodes (61): allow_paid_brain(), get_brain_preference(), invalidate_brain_cache(), Clear the cached brain so the next read re-resolves. Called from…, True only when the operator explicitly opted into a paid (Anthropic) brain.…, Return the operator's brain provider preference. Values: - ``"nvidia"`` —…, A DB-stored BrainConfig wins over provider records + env (except…, When BrainConfig.updated_at is empty (never applied), the resolver falls… (+53 more)

### Community 76 - "RenderOpsMonitor"
Cohesion: 0.06
...
### Community 78 - "skill_bindings.py"
Cohesion: 0.04
Nodes (51): Enum, SuperClaude Workflow Engine — Workflow, Task, and topological DAG execution.…, Return tasks whose dependencies are all satisfied., Number of tasks in the workflow., Number of completed tasks., Number of failed tasks., Executes workflows using topological ordering., Register a workflow with the engine. (+43 more)

### Community 79 - "resolve_active_brain"
Cohesion: 0.05
Nodes (57): BrainResolution, get_active_brain_sync(), get_provider_role_tags(), _host_is_openai_compatible(), _norm(), _pick_from_records(), _build(), _prio() (+49 more)
...
### Community 81 - "BackgroundAgent"
Cohesion: 0.05
Nodes (45): BackgroundAgent, heartbeat(), BackgroundTask, _now(), Any, agent/background.py — Background Agent An always-on worker thread that…, Enqueue *task* for processing. Returns the task (with task_id set)., Convenience: create a task and submit it in one call. (+37 more)

### Community 82 - "FreeBuffAgent"
Cohesion: 0.05
Nodes (49): _check_extra_kwargs(), _enforce_signature(), free_nvidia_models(), FreeBuffAgent, _nvidia_api_key(), Any, Raise TypeError if fn's signature drifts from the locked contract (Pydantic…, Raise TypeError on unknown kwarg (runtime extra='forbid' for non-Pydantic… (+41 more)

### Community 83 - "TokenBudget"
Cohesion: 0.05
...
### Community 85 - "test_slop_gate.py"
Cohesion: 0.05
...
### Community 86 - "test_governance_enforcement.py"
Cohesion: 0.06
Nodes (60): BudgetTracker, GovernanceGate, Holds live session budgets, bounded so it cannot leak. Sessions end without…, The one seam through which governed actions pass., Build an :class:`AgentIdentity` from whatever the caller knows. Total by design…, resolve_identity(), _engine(), parametrize (+52 more)

### Community 87 - "PrimeAgentAdapter"
Cohesion: 0.05
...
### Community 88 - "test_cost_aware_routing_eval.py"
Cohesion: 0.06
...
### Community 90 - "SeoFixer"
Cohesion: 0.06
Nodes (30): Root directory under which repo fixes are allowed to operate., Run the repo-aware auto-fixer against this company's workspace checkout.…, run_seo_fixes(), _workspace_root(), FsPath, Request to remediate auto-fixable findings in a local code repository., One concrete remediation performed (or proposed) by the fixer., SeoFixAction (+22 more)

### Community 91 - "ProbeResult"
Cohesion: 0.05
...
### Community 93 - "TestSelfHealingInfrastructureClassification"
Cohesion: 0.05
...
### Community 94 - "test_sam_voice.py"
Cohesion: 0.04
...
### Community 95 - "Artifact"
Cohesion: 0.06
Nodes (40): AgentRole, _tracking_run_single(), TestPhaseSequenceError, tests/test_workflow_models.py — Unit tests for workflow/models.py., TestApprovalGate, TestCheckRun, TestSlice, workflow/artifact_store.py — Durable artifact persistence. Artifacts are stored… (+32 more)

### Community 96 - "PortfolioManager"
Cohesion: 0.04
Nodes (34): _env_github_token(), fetch_github_signals(), _items(), _norm_title(), PortfolioIntelligence, Path, Fetch open PRs and bug-labelled issues. Returns {} on any failure/no token., Assembles a PortfolioManager from live signals with WSJF scoring. (+26 more)
...
### Community 99 - "test_repo_connection.py"
Cohesion: 0.06
...
### Community 103 - "test_model_catalog.py"
Cohesion: 0.05
...
### Community 106 - "TestHarnessAdapter"
Cohesion: 0.04
Nodes (31): get_harness_adapter(), harness_active(), harness_catalog(), harness_session_close(), harness_session_start(), HarnessSessionBody, HarnessSessionCloseBody, Return orchestrator queue depth, active runs, and supervisor state (#522). (+23 more)

### Community 107 - "test_startup_warmup.py"
Cohesion: 0.04
Nodes (50): _bootstrap_within_budget(), Await one warm-up step, deferring it to the background if it overruns.…, Run bootstrap without letting it hold a request open indefinitely. Returns…, _warmup_step(), defer_to_background(), Any, services/warmup.py — bounded startup warm-up steps. Extracted from…, Let an overrunning step finish out of band without leaking or warning twice. (+42 more)

### Community 108 - "FeatureMaturity"
Cohesion: 0.05
...
### Community 109 - "resolve_e2b_config"
Cohesion: 0.05
...
### Community 111 - "FinancialMetrics"
Cohesion: 0.06
...
### Community 112 - "TaskStore"
Cohesion: 0.06
Nodes (46): Set the global agent store instance (e.g., with MongoDB on startup)., set_agent_store(), Point the feature stores at the shared database connection. Deliberately…, _wire_feature_stores(), Create a task. Deduplicates by source_id if set (Charter G3). If a task with…, Fetch a task by ID. If owner_id is set, enforces ownership., Return the task previously created for an external ``source_id`` (e.g.…, Return task counts keyed by ``agent_id`` for the requested statuses. (+38 more)

### Community 113 - "ensure_self_company"
Cohesion: 0.05
Nodes (46): _autonomy_bg_cycle(), autonomy_status(), Background CEO cycle + task dispatch. Runs fire-and-forget., Public autonomy readiness probe — no authentication required. A live deploy…, Fire-and-forget self-bootstrap; never blocks or crashes startup., _schedule_self_bootstrap(), _count_specialists(), _create_company_directly() (+38 more)

### Community 114 - "ProvidersScreen.jsx"
Cohesion: 0.04
...
### Community 116 - "test_mcp_registry.py"
Cohesion: 0.06
Nodes (28): Measure one server. Never raises — a probe failure is a status, not an error., Measure every declared server concurrently and return dashboard rows. Probes…, status_all(), _status_for(), _noop_async(), Any, asyncio, tests/test_mcp_registry.py — the single MCP catalogue and the screen it backs.… (+20 more)
...
### Community 120 - "resolve_provider_for"
Cohesion: 0.05
...
### Community 123 - "_ts_to_float"
Cohesion: 0.05
Nodes (41): Background dispatcher for task execution., _coerce_ts(), ExecutionLogEntry, Any, field_validator, Update the updated_at timestamp., Coerce ISO-8601 datetime strings (from DB) to float timestamps., Single entry in a task's execution log. (+33 more)

### Community 124 - "test_procedural_memory.py"
Cohesion: 0.05
Nodes (23): _overlap_score(), ProceduralMemoryStore, ProceduralRecord, Any, agent/procedural_memory.py — Skill/Procedural Memory for the agent loop (★4).…, Store a successful step pattern and return its record id. Duplicate step…, Return up to *limit* stored patterns relevant to *query*. Relevance is scored…, Return all stored records (for admin/debug). (+15 more)

### Community 125 - "Company"
Cohesion: 0.05
...
### Community 128 - "BrowserSession"
Cohesion: 0.05
Nodes (28): BrowserAction, BrowserSession, _not_started(), PageState, Any, agent/browser.py — Browser Automation Controls a real browser via Playwright so…, True if browser automation is enabled and Playwright is importable., Which backend a start() would use: 'browserbase', 'local', or 'stub'. (+20 more)

### Community 129 - "tasks/api.py"
Cohesion: 0.12
...
### Community 131 - "StreamingDeltaReconstructor"
Cohesion: 0.05
...
### Community 132 - "pr_approval_gate.py"
Cohesion: 0.06
...
### Community 134 - "PatternConsolidation"
Cohesion: 0.06
...
### Community 141 - "test_trend_watcher.py"
Cohesion: 0.06
...
### Community 150 - "OnboardingScreen.jsx"
Cohesion: 0.05
...
### Community 153 - "test_sqlite_store.py"
Cohesion: 0.06
...
### Community 156 - "audit"
Cohesion: 0.06
Nodes (27): put, Update an agent. Only the owner or an admin may update., update_agent(), audit(), get_audit_log(), get_user_role(), is_admin(), is_power_user_or_above() (+19 more)

### Community 157 - "chat_handlers.py"
Cohesion: 0.07
Nodes (44): _apply_chat_defaults(), _apply_reasoning_budget(), _emit_safely(), _extract_exact_output(), _filter_fragment(), _filter_openai_sse_line(), handle_ollama_native_chat(), handle_openai_chat_completions() (+36 more)

### Community 158 - "AdminIdentity"
Cohesion: 0.06
Nodes (22): AdminAuthManager, AdminIdentity, AdminSession, AdminSessionStore, _is_truthy(), admin_auth.py — auto-generated module docstring (user-research skill scan)., WindowsCredentialAuthenticator, admin_update_user() (+14 more)
...
### Community 161 - "enforcement.py"
Cohesion: 0.06
Nodes (40): _do_run_agent_job(), _run_agent_job(), wait_for_resume(), BudgetExceeded, classify(), evaluate_call(), guard_tool_call(), GuardResult (+32 more)
...
### Community 165 - "test_agent_tool_governance.py"
Cohesion: 0.07
...
### Community 166 - "activation_api.py"
Cohesion: 0.09
...
### Community 167 - "test_failover_silent_exhaustion.py"
Cohesion: 0.06
...
### Community 169 - "test_telegram_freebuff.py"
Cohesion: 0.07
...
### Community 172 - "probe_catalogues.py"
Cohesion: 0.07
Nodes (32): _auth_headers(), _chat_targets(), _dump_matching(), _kind(), list_models(), _list_or_report(), main(), _parse_args() (+24 more)

### Community 173 - "test_governance_api.py"
Cohesion: 0.07
Nodes (45): get_audit_log(), Return the process-wide audit log, created on first use., Replace the process-wide gate. Tests only., reset_gate(), _client(), parametrize, TestClient, Tests for the governance HTTP surface and the AgentRunner integration. The… (+37 more)
...
### Community 175 - "LogMonitor"
Cohesion: 0.06
Nodes (36): _dispatch_async(), _run(), _ErrorCaptureHandler, LogMonitor, _note_recurrence(), Any, LogRecord, agent/log_monitor.py — Application Log Monitor Captures ERROR/CRITICAL log… (+28 more)

### Community 176 - "test_portfolio_intake.py"
Cohesion: 0.07
Nodes (38): _materialize_and_log(), Run the initiative→task materializer, logging failures loudly. Was…, Weighted Shortest Job First score — higher schedules sooner., map_initiative_to_task(), materialize_committed(), _wsjf(), _portfolio_materialize_enabled(), portfolio_source_id() (+30 more)

### Community 177 - "rbac.py"
Cohesion: 0.07
Nodes (35): compute_savings(), compute_time_series(), get_savings(), get_usage(), get_user_savings(), _period_start(), Any, BaseModel (+27 more)

### Community 178 - "TaskBoardScreen.jsx"
Cohesion: 0.05
...
### Community 182 - "reset_store"
Cohesion: 0.06
Nodes (32): _LazyModuleProxy, db — storage abstraction layer (V2.0 Phase 5: real code moved to…, Loads the real module on first attribute access, then replaces itself., Reset the store singleton (used in tests). Also resets the motor client…, # IMPORTANT: keep these imports LAZY (inside __getattr__) so that a Mongo-only, reset_store(), Reset the storage singleton (for tests)., reset_storage() (+24 more)
...
### Community 187 - "TestAuthAndTaskOwnership"
Cohesion: 0.05
...
### Community 190 - "emit_chat_observation"
Cohesion: 0.08
...
### Community 194 - "WorkspaceManifest"
Cohesion: 0.07
...
### Community 196 - "resolve_component_model"
Cohesion: 0.07
...
### Community 200 - "NotificationDispatcher"
Cohesion: 0.07
...
### Community 201 - "WorkflowRun"
Cohesion: 0.08
Nodes (20): _fake_artifact(), _make_engine(), tests/test_crispy_workflow.py — CRISPY workflow engine hardening tests. Tests…, Create a WorkflowEngine with isolated storage., TestAbortOnFailure, _test(), TestPhaseSequence, WorkflowRun (+12 more)
...
### Community 205 - "nvidia_models.py"
Cohesion: 0.07
...
Cohesion: 0.05
Nodes (33): livenim, is_anthropic_model(), True when *model* names a paid Anthropic/Bedrock-Claude model. Covers native…, Resolve the free NVIDIA NIM brain from env, or ``None`` if unconfigured.…, resolve_free_nvidia_brain(), _FakeAsyncClient, _FakeResponse, Free-brain policy regression tests for the agent runtime (issue #656).… (+25 more)

### Community 207 - "TestBrainFailoverModelUpdates"
Cohesion: 0.08
...
### Community 209 - "TestRecordUsageAndStats"
Cohesion: 0.05
...
### Community 210 - "test_schedule_backlog_drain.py"
Cohesion: 0.09
...
### Community 214 - "Persistent Memory System"
Cohesion: 0.05
...
### Community 216 - "WorkflowBuildRequest"
Cohesion: 0.07
...
Cohesion: 0.09
Nodes (36): add_initiative(), AllocationOut, BoardOut, get_board(), get_service(), InitiativeIn, InitiativeOut, materialize_portfolio() (+28 more)

### Community 219 - "LlmProviderConfig"
Cohesion: 0.12
...
### Community 221 - "Kept Rules — the 44 that survive the audit"
Cohesion: 0.05
...
### Community 225 - "test_verification_strategies.py"
Cohesion: 0.09
...
### Community 229 - "test_runtime_governance.py"
Cohesion: 0.13
Nodes (36): _governance_check(), _governance_identity(), Evaluate a runtime dispatch against policy; audit it either way. Returns…, Resolve the acting identity for a runtime dispatch. Identity comes from…, _decision(), _engine(), Any, RoutingDecision (+28 more)

### Community 230 - "_resolve_user_github_token"
Cohesion: 0.08
Nodes (32): _DoctorCheck, _DoctorReport, get_doctor_diagnostics(), get_doctor_report(), get_public_doctor(), _in_container(), Path, Consolidated system health report: preflight checks + runtime health. Returns a… (+24 more)

### Community 231 - "configuration-reference.md"
Cohesion: 0.07
...
### Community 232 - "test_pr923_fixes.py"
Cohesion: 0.07
...
### Community 236 - "test_telegram_webhook.py"
Cohesion: 0.06
...
### Community 237 - "test_seo_portfolio_bridge.py"
Cohesion: 0.09
Nodes (22): build_seo_roadmap(), delegation_plan_to_initiatives(), plan_seo_sprint(), Convert SEO delegation plan to a portfolio and lay it onto a Now/Next/Later…, Result of planning an agile sprint from SEO initiatives., Render the sprint plan as markdown., Convert SEO delegation plan to a portfolio and allocate capacity into a sprint.…, Complete result of converting an SEO audit to portfolio + roadmap + sprint. (+14 more)

### Community 238 - "system_instruction"
Cohesion: 0.09
...
### Community 239 - "test_control_plane_api.py"
Cohesion: 0.06
...
### Community 242 - "TestCatalogFable51"
Cohesion: 0.09
...
### Community 243 - "test_one_model_catalogue.py"
Cohesion: 0.08
...
### Community 247 - "test_backend_server_features.py"
Cohesion: 0.06
Nodes (19): _append_agent_session_message(), _build_auto_skill_guidance(), _run_agent_job(), _mask_observations(), Truncate tool/observation content in older messages to prevent context bloat., _run_agent_loop(), _select_auto_skills(), anyio (+11 more)
...
### Community 254 - "REWRITE_PLAN.md — Phased Migration Strategy"
Cohesion: 0.06
...
### Community 256 - "test_brain_failover.py"
Cohesion: 0.10
...
### Community 259 - "test_provider_enable_disable.py"
Cohesion: 0.07
...
### Community 260 - "test_purge_backlog.py"
Cohesion: 0.07
...
### Community 265 - "local_controller.py"
Cohesion: 0.12
...
### Community 268 - "test_nvidia_model_discovery.py"
Cohesion: 0.06
...
### Community 270 - "heal_signature"
Cohesion: 0.09
Nodes (23): heal_signature(), HealState, str, Lifecycle of a heal (Autonomy Charter G2 closed loop)., Stable signature for an error/heal, used to dedup and detect recurrence.…, Path, Regression tests for robustness bugs found in the autonomy-paths audit. - P1-3…, If the re-dispatch coroutine raises, the heal escalates instead of stranding. (+15 more)

### Community 271 - "tests/conftest.py"
Cohesion: 0.08
Nodes (32): get_current_user(), get_optional_user(), Get user if authenticated, otherwise return None (for public endpoints)., Item, app_client(), client(), non_admin_client(), Config (+24 more)

### Community 272 - "Configuration Reference"
Cohesion: 0.06
...
### Community 276 - "BrainFailoverManager"
Cohesion: 0.09
Nodes (21): _disabled_ids(), Reset every circuit breaker when they have all tripped, and re-select. Without…, The operator kill-switch set, or empty when it cannot be read., _recover_all_unhealthy(), BrainFailoverManager, ProviderInfo, Any, Return the next healthy provider, excluding any in the exclude set. Ordering:… (+13 more)
...
### Community 278 - "InternalAgentAdapter"
Cohesion: 0.07
...
### Community 280 - "_routing_candidates"
Cohesion: 0.09
...
### Community 290 - "get_skill_bindings"
Cohesion: 0.09
...
### Community 291 - "test_provider_render_env.py"
Cohesion: 0.09
...
### Community 292 - "seo_report_pdf.py"
Cohesion: 0.15
Nodes (25): Paragraph, _build_pdf(), findings_block(), hr(), S(), section(), Path, Render an executive-level PDF from the audit report dict. (+17 more)
...
### Community 294 - "test_colibri_brain_shim.py"
Cohesion: 0.08
...
### Community 301 - "test_telegram_mutating_commands.py"
Cohesion: 0.09
...
### Community 305 - "High-Agency Frontend Skill"
Cohesion: 0.06
...
### Community 308 - "provider_base_url"
Cohesion: 0.08
Nodes (20): provider_base_url(), Resolve the Ollama base URL the UI controls — DB value wins over env.…, Return the OpenAI-compatible base URL for *provider* (env- and UI-aware)., resolve_ollama_base_url(), Any, _FakeResp, tests/test_brain_ollama_base_url.py The Ollama base URL is UI-configurable and…, An Ollama probe with base_url must hit THAT url's /api/tags, not the saved one. (+12 more)

### Community 309 - "test_platform_controls.py"
Cohesion: 0.09
...
### Community 310 - "test_connector_registry.py"
Cohesion: 0.08
...
### Community 313 - "test_agency_fix.py"
Cohesion: 0.06
...
### Community 314 - "test_skill_registry_boot_refresh.py"
Cohesion: 0.11
...
### Community 315 - "test_phase6_workflow.py"
Cohesion: 0.12
...
### Community 316 - "build_render_router"
Cohesion: 0.12
...
### Community 317 - "_ensure_tasks_source_id_unique_index"
Cohesion: 0.10
...
### Community 318 - "openclaw_gateway.py"
Cohesion: 0.09
...
### Community 319 - "output_filter.py"
Cohesion: 0.07
...
### Community 320 - "brain_config.py"
Cohesion: 0.09
Nodes (26): _active_primary_provider(), is_north_mini_code_default(), provider_api_keys(), _provider_env_value(), _provider_ids_from_literal(), provider_key_rotation_enabled(), services/brain_config_store.py — DB-persisted, UI-switchable "brain" config.…, True when the ``NORTH_MINI_CODE_DEFAULT`` flag is on (default ON). Reads the… (+18 more)

### Community 321 - "test_colibri_provider.py"
Cohesion: 0.12
...
### Community 322 - "asyncio"
Cohesion: 0.07
Nodes (20): requires_db, asyncio, Test Company Graph services., Test that storage service can be initialized., Test company CRUD operations - skipped as requires specific config., Test specialist service., Test that specialist service can be initialized., Test onboarding service. (+12 more)

### Community 323 - "test_scheduler_hydration_bounded.py"
Cohesion: 0.09
...
### Community 324 - "test_brain_availability_doctor.py"
Cohesion: 0.14
...
### Community 325 - "OrchestratorCheckpointStore"
Cohesion: 0.10
...
### Community 327 - "_redact_for_notification"
Cohesion: 0.11
...
### Community 329 - "test_chat_mode_regressions.py"
Cohesion: 0.11
...
### Community 331 - "test_autonomy_gate.py"
Cohesion: 0.13
...
### Community 336 - "control_registry.py"
Cohesion: 0.12
...
### Community 338 - "test_claude_setup_audit.py"
Cohesion: 0.16
...
### Community 340 - "test_freebuff_bot.py"
Cohesion: 0.08
...
### Community 341 - "isolated_telegram_config"
Cohesion: 0.10
...
### Community 345 - "Python Dependencies (`requirements.txt`)"
Cohesion: 0.07
...
### Community 346 - "Technical Debt Register — local-llm-server"
Cohesion: 0.07
...
### Community 347 - "test_dashboard_cache.py"
Cohesion: 0.11
...
### Community 348 - "ProviderConsole.jsx"
Cohesion: 0.08
...
### Community 349 - "_build_request"
Cohesion: 0.09
Nodes (16): _build_request(), Return ``(url, headers, is_anthropic_native)`` for *provider*. Anthropic's…, is_anthropic_base_url(), True when ``base_url`` points at Anthropic's native Messages API. Anthropic's…, parametrize, Regression tests for the agent loop's multi-provider failover wire format.…, Registry base URLs must produce routes the provider actually serves., brain_failover must not drift from the catalog's base URLs. (+8 more)

### Community 350 - "webui/frontend/package.json"
Cohesion: 0.07
Nodes (26): @types/react, @types/react-dom, typescript, vite, @vitejs/plugin-react, dependencies, react, react-dom (+18 more)

### Community 351 - "keepalive.py"
Cohesion: 0.13
...
### Community 355 - "test_regression.py"
Cohesion: 0.10
...
### Community 356 - "test_agent_scripts_share_one_model_list.py"
Cohesion: 0.10
...
### Community 357 - "test_crispy_burn_in.py"
Cohesion: 0.07
...
### Community 359 - "test_webui_provider_priority.py"
Cohesion: 0.16
...
### Community 360 - "test_harness_spec.py"
Cohesion: 0.16
Nodes (17): _flag(), _int_env(), Path, agent/harness_spec.py — the Continual Harness: a persistent, cited spec.…, Absolute path of the harness spec for a workspace., Parse existing entries. Never raises — a broken file yields no entries. With…, Promote repeated lessons into the spec. Returns the entries added. No-op unless…, Merge qualifying lessons into the spec. Caller holds _REFINE_LOCK. (+9 more)

### Community 361 - "SpecEntry"
Cohesion: 0.15
Nodes (13): build_block(), Rewrite the spec file, preserving any non-entry (hand-written) lines., Compact prompt block of standing instructions, or '' when there are none.…, One standing instruction plus the evidence that earned it., SpecEntry, write_entries(), Golden rule: a workspace that never opted in gets identical prompts., The join's newlines count against HARNESS_SPEC_MAX_CHARS too. (+5 more)
...
### Community 367 - "CompanyAgencyService"
Cohesion: 0.09
...
### Community 370 - "VoiceCommandInterface"
Cohesion: 0.14
...
### Community 371 - "agile_sprints.py"
Cohesion: 0.09
...
Cohesion: 0.13
Nodes (25): all_settings(), _as_bool(), _as_int(), ephemeral_ttl_hours_cached(), get_setting(), _maybe_schedule_refresh(), onboarding_gate_enabled(), onboarding_gate_enabled_cached() (+17 more)

### Community 373 - "Performance Analysis — local-llm-server"
Cohesion: 0.08
...
### Community 377 - "TrafficDirector"
Cohesion: 0.12
Nodes (9): In-process traffic distribution and budget accounting for providers., EWMA latency in ms; never-sampled providers sort first. Returning -1.0 for an…, Clear all counters (tests only)., TrafficDirector, Tests for packages/ai/traffic_director.py — traffic distribution across…, `int(0.5)` is 0, and a cap of 0 makes `in_flight >= cap` true at zero in-flight…, `NVIDIA-NIM_MAX_RPM` is not settable in most shells; the underscore form must…, TestAccounting (+1 more)

### Community 378 - "test_llm_router_disabled.py"
Cohesion: 0.14
...
### Community 382 - "test_brain_migration_writes_a_live_model.py"
Cohesion: 0.10
...
### Community 383 - "test_daily_automation_2026_08_03.py"
Cohesion: 0.11
...
### Community 387 - "TestStreamableHTTPTransport"
Cohesion: 0.12
...
### Community 391 - "video_transcript.py"
Cohesion: 0.11
...
### Community 392 - "traffic_director.py"
Cohesion: 0.11
...
### Community 395 - "test_memory_guard.py"
Cohesion: 0.12
...
### Community 398 - "test_telegram_approval_e2e.py"
Cohesion: 0.12
...
### Community 399 - "test_activation_api.py"
Cohesion: 0.13
...
### Community 400 - "test_backend_runtime_bootstrap.py"
Cohesion: 0.09
...
### Community 403 - "test_telegram_diag_endpoint.py"
Cohesion: 0.08
...
### Community 409 - "build_platform_controls_router"
Cohesion: 0.15
...
### Community 411 - "Traffic Distribution Across Providers"
Cohesion: 0.08
...
### Community 412 - "Implementation Prompt: Rich TaskBoard + Agile Sprint Integration"
Cohesion: 0.08
...
### Community 413 - "Telegram Bot Setup"
Cohesion: 0.08
...
### Community 417 - "test_phase4_runtime_resilience.py"
Cohesion: 0.13
...
### Community 422 - "openclaw_str_e_fix.py"
Cohesion: 0.15
...
### Community 423 - "Agent Governance Guide"
Cohesion: 0.09
...
### Community 424 - "The fifteen strategies"
Cohesion: 0.09
...
### Community 425 - "SetupWizardPage.js"
Cohesion: 0.13
...
### Community 427 - "implement_agent.py"
Cohesion: 0.12
...
### Community 433 - "SyntheticDataPipeline"
Cohesion: 0.13
...
### Community 436 - "test_compare_runtimes.py"
Cohesion: 0.10
...
### Community 438 - "test_mostly_failed_steps.py"
Cohesion: 0.12
...
### Community 441 - "classify_direct_chat_intent"
Cohesion: 0.13
...
### Community 443 - "AdaptivePermissions"
Cohesion: 0.18
...
### Community 450 - "compare_runtimes.py"
Cohesion: 0.16
...
### Community 451 - "PriorityTaskQueue"
Cohesion: 0.14
...
### Community 453 - "test_anthropic_refusal_fallback.py"
Cohesion: 0.19
...
### Community 454 - "test_gh_brain_failover.py"
Cohesion: 0.10
...
### Community 456 - "HarnessEnrichment"
Cohesion: 0.15
...
### Community 457 - "PersistentMemoryStore"
Cohesion: 0.22
...
### Community 465 - "_process_task_callback"
Cohesion: 0.20
...
### Community 466 - ".on_task_complete"
Cohesion: 0.11
...
### Community 467 - "TestAddConversationCacheBreakpoints"
Cohesion: 0.15
...
### Community 468 - "test_local_controller.py"
Cohesion: 0.14
...
### Community 469 - "test_openclaw_str_e_fix.py"
Cohesion: 0.10
...
### Community 470 - "run_trend_analysis"
Cohesion: 0.18
...
### Community 471 - "test_unit5_ui_provider_surface.py"
Cohesion: 0.10
...
### Community 472 - "test_voice_pipeline.py"
Cohesion: 0.13
...
### Community 474 - "Skill: modularity-review"
Cohesion: 0.10
...
### Community 484 - "PortfolioScreen.jsx"
Cohesion: 0.11
...
### Community 490 - "test_kimi_bridge_server.py"
Cohesion: 0.12
...
### Community 491 - "test_task_source_id_race.py"
Cohesion: 0.16
...
### Community 494 - "test_fixes_reliability.py"
Cohesion: 0.10
...
### Community 497 - "test_tasks_cache_ttl_env.py"
Cohesion: 0.21
...
### Community 500 - "test_prompt_injection_boundary.py"
Cohesion: 0.18
...
### Community 502 - "_extract_tech_relevance"
Cohesion: 0.17
...
### Community 506 - "PerformanceAnalytics"
Cohesion: 0.12
...
### Community 508 - "Skill: fabric-patterns"
Cohesion: 0.11
...
### Community 509 - "Analysis & Synthesis Instructions"
Cohesion: 0.11
Nodes (18): 1. Define the Atmosphere, 2. Map the Color Palette, 3. Establish Typography Rules, 4. Define the Hero Section, 5. Describe Component Stylings, 6. Define Layout Principles, 7. Define Responsive Rules, 8. Encode Motion Philosophy (+10 more)

### Community 510 - "Production Readiness Assessment — local-llm-server"
Cohesion: 0.11
...
### Community 518 - "control_overrides.py"
Cohesion: 0.14
...
### Community 523 - "OrchestratorQueue"
Cohesion: 0.13
...
### Community 525 - "telegram_service.py"
Cohesion: 0.12
...
### Community 526 - "test_autonomy_pipeline_regressions.py"
Cohesion: 0.11
...
### Community 527 - "test_autonomy_status.py"
Cohesion: 0.11
...
### Community 529 - "TestMCPToolsListCache"
Cohesion: 0.15
...
### Community 530 - "_FakeCommandResult"
Cohesion: 0.12
...
### Community 533 - "test_provider_state_durability.py"
Cohesion: 0.14
...
### Community 534 - "validate_session_id"
Cohesion: 0.16
...
### Community 535 - "handle_workflow_ide_chat"
Cohesion: 0.17
...
### Community 536 - "_register_builtin_tools"
Cohesion: 0.12
Nodes (11): browse_page(), Open *url* in a real browser, return its rendered text, and close. Fail-soft:…, Register the built-in agent tools that are always available., Register the interactive-browser capability (agent/browser.py). Unlike…, _register_browser_tools(), _browse_page_tool(), _register_builtin_tools(), With automation disabled, browse_page returns a dict, never raises. (+3 more)

### Community 537 - "ErrorInterceptorMiddleware"
Cohesion: 0.18
...
### Community 543 - "CapacityAllocation"
Cohesion: 0.11
...
### Community 544 - "Comprehensive Skill Index (By Category)"
Cohesion: 0.11
...
### Community 545 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 546 - "Component Map"
Cohesion: 0.11
...
### Community 548 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
...
### Community 549 - "Platform Guide — the full tour"
Cohesion: 0.11
...
### Community 554 - "router/health.py"
Cohesion: 0.16
...
### Community 561 - "test_company_api.py"
Cohesion: 0.11
...
### Community 562 - "test_monitor_lib.py"
Cohesion: 0.15
...
### Community 563 - "TestOrchestratorQueue"
Cohesion: 0.13
...
### Community 564 - "test_phase5_doctor.py"
Cohesion: 0.11
...
### Community 565 - "TestStopSlopChecker"
Cohesion: 0.11
...
### Community 566 - "test_task_pre_execution_gate.py"
Cohesion: 0.24
...
### Community 571 - "cowork_session.py"
Cohesion: 0.15
...
### Community 575 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 576 - "_check_storage_health"
Cohesion: 0.12
...
### Community 578 - "Section-by-Section Acceptance Criteria"
Cohesion: 0.12
...
### Community 581 - "redact_connection_url"
Cohesion: 0.17
...
### Community 582 - "kimi_bridge_provider_config"
Cohesion: 0.18
...
### Community 583 - "test_p0_roadmap_a4_a5_b2.py"
Cohesion: 0.15
Nodes (7): Return recommended steering labels for a given task category. Used by the model…, steering_for_task(), get_agent_bus(), Return the module-level AgentMessageBus singleton., TestPriority, TestSteeringForTask, TestSteeringSingleton
...
### Community 591 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 595 - "test_task_service_failed_comment.py"
Cohesion: 0.18
...
### Community 596 - "hermes_prompt.py"
Cohesion: 0.19
...
### Community 598 - "agent/workspace.py"
Cohesion: 0.23
...
### Community 603 - "The 10-Step Workflow"
Cohesion: 0.12
...
### Community 604 - "Nothing is blocked on an agent. Two things need a human."
Cohesion: 0.12
...
### Community 612 - "AdminDigestRouterAuthTests"
Cohesion: 0.20
...
### Community 616 - "clear_wizard_state_cache"
Cohesion: 0.19
...
### Community 617 - "test_agency_workflows_carry_the_failover_chain.py"
Cohesion: 0.18
...
### Community 618 - "DailyDigestAggregatorTests"
Cohesion: 0.19
...
### Community 619 - "test_dockerfile_ships_root_modules.py"
Cohesion: 0.17
...
### Community 620 - "test_langfuse_agency_wide.py"
Cohesion: 0.12
...
### Community 624 - "test_nvidia_default_model.py"
Cohesion: 0.17
...
### Community 626 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 627 - "test_refresh_agent_built_proof.py"
Cohesion: 0.12
...
### Community 631 - "CollaborationContext"
Cohesion: 0.17
...
### Community 632 - "Skill: agent-harness"
Cohesion: 0.13
...
### Community 633 - "Skill: checkpoint-strategy"
Cohesion: 0.13
...
### Community 635 - "Skill: local-ai-query"
Cohesion: 0.13
...
### Community 636 - "Skill: parallel-agents"
Cohesion: 0.13
...
### Community 637 - "Skill: parallel-worktrees"
Cohesion: 0.13
...
### Community 638 - "Design System: Taste Standard"
Cohesion: 0.13
...
### Community 640 - "test_new_features_e2e.py"
Cohesion: 0.26
...
### Community 641 - "Skill: user-research"
Cohesion: 0.13
...
### Community 642 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 643 - "Attention Mechanisms Internals"
Cohesion: 0.13
...
### Community 646 - "DockerAgentAdapter"
Cohesion: 0.18
...
### Community 650 - "DecisionsStoreTests"
Cohesion: 0.13
...
### Community 652 - "test_daemon_restart_reprobes_http_port_only"
Cohesion: 0.13
...
### Community 653 - "test_scanner_live.py"
Cohesion: 0.23
...
### Community 655 - "propose_entries"
Cohesion: 0.20
Nodes (9): _known_entry_texts(), _one_line(), propose_entries(), Any, Recorded lessons as ``{signature: {acceptable text, ...}}``. The citation binds…, Turn qualifying lessons into candidate entries. A lesson qualifies only when it…, Collapse a value to a single trimmed line. Entries are one Markdown list item…, The core guarantee: no citation, no entry. (+1 more)

### Community 656 - "validate_job_id"
Cohesion: 0.18
...
### Community 658 - "test_ai_insights.py"
Cohesion: 0.20
...
### Community 661 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 665 - "Checks Performed"
Cohesion: 0.14
...
### Community 666 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 668 - "Skill: branch-cleanup"
Cohesion: 0.14
...
### Community 673 - "Main proxy (`proxy.py`)"
Cohesion: 0.14
...
### Community 674 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 676 - "Render MCP — autonomous platform debugging and environment monitoring"
Cohesion: 0.14
...
### Community 678 - "SEO / GEO / AIO Audit Engine"
Cohesion: 0.14
...
### Community 680 - "_parse_reset_epoch"
Cohesion: 0.21
...
### Community 681 - "extract_failures"
Cohesion: 0.21
...
### Community 682 - "test_p0_roadmap_b3_b4_b5.py"
Cohesion: 0.21
...
### Community 683 - "TestSeoApiSurface"
Cohesion: 0.16
Nodes (4): list_checks(), Return all check definitions., tests/test_seo_api.py - SEO audit API surface tests (issue #533)., TestSeoApiSurface

### Community 684 - "test_wrapper_falls_back_to_installed_model"
Cohesion: 0.19
...
### Community 685 - "TestAnthropicToolListCaching"
Cohesion: 0.34
...
### Community 686 - "test_brain_failover_413.py"
Cohesion: 0.15
...
### Community 687 - "test_changelog_check_workflow.py"
Cohesion: 0.21
...
### Community 688 - "TestMCPClientStructuredOutput"
Cohesion: 0.27
...
### Community 690 - ".test_set_github_token_sqlite_string_id_does_not_500"
Cohesion: 0.16
...
### Community 692 - "test_openclaw_gateway.py"
Cohesion: 0.14
...
### Community 693 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 700 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 703 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 704 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 708 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 709 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 711 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 712 - "admin_update_task_router.py"
Cohesion: 0.22
...
### Community 714 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
Nodes (12): Acceptance Checks, Claude's query protocol (use this instead of Read tool for exploration):, Graph Artifacts — What to Commit, How to Use the Graph (Token Savings Protocol), Installation (one-time per machine), Instead of reading raw files:, Key commands:, Relationship to repowise-intelligence Skill (+4 more)

### Community 715 - "Skill: platform-setup — Autonomous Agency Bootstrap"
Cohesion: 0.15
...
### Community 716 - "Device compatibility and model picks"
Cohesion: 0.15
...
### Community 717 - "Autonomy Uplift — Living Roadmap & Detailed Implementation Specs"
Cohesion: 0.15
...
### Community 718 - "OpenClaw — iOS Control of the Agency (Single-Service Free-Tier Deploy)"
Cohesion: 0.15
...
### Community 720 - "ApplyReviewAgent"
Cohesion: 0.22
...
### Community 723 - "_is_bedrock_model_id"
Cohesion: 0.27
...
### Community 726 - "Agent Transparency Report"
Cohesion: 0.15
...
### Community 732 - "TestDecisionsBotLinks"
Cohesion: 0.21
...
### Community 733 - "test_deploy_trigger_covers_image.py"
Cohesion: 0.21
...
### Community 734 - "TestRuntimeControl"
Cohesion: 0.15
...
### Community 735 - "TestKillSwitchDurability"
Cohesion: 0.15
...
### Community 736 - "test_providers_live_e2e.py"
Cohesion: 0.24
...
### Community 738 - "test_telegram_task_callback.py"
Cohesion: 0.23
...
### Community 739 - "skill_registry.py"
Cohesion: 0.17
...
### Community 750 - "build_admin_local_brain_router"
Cohesion: 0.24
...
### Community 751 - "connectors_api.py"
Cohesion: 0.21
...
### Community 755 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 757 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 758 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 759 - "Quantization Internals"
Cohesion: 0.17
...
### Community 760 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 761 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 762 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 767 - "install-agents.sh"
Cohesion: 0.39
...
### Community 768 - "check_container_posture.py"
Cohesion: 0.26
...
### Community 769 - "test_pytest_failure_parser.py"
Cohesion: 0.23
...
### Community 770 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 772 - "test_agile_api.py"
Cohesion: 0.17
...
### Community 773 - "test_app_settings.py"
Cohesion: 0.21
...
### Community 774 - "test_brain_default_consistency.py"
Cohesion: 0.24
...
### Community 776 - "TestDisabledProvidersAreNotFalselyReportedUnreachable"
Cohesion: 0.18
...
### Community 777 - "TestAnthropicWorkspaceIdCapture"
Cohesion: 0.33
...
### Community 778 - "TestAuthAndTaskCreation"
Cohesion: 0.17
...
### Community 780 - "test_task_clarification.py"
Cohesion: 0.17
...
### Community 788 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 791 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 792 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 794 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 797 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 798 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 799 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 800 - "2. Critical Bugs & Exact Detection Signatures"
Cohesion: 0.18
...
### Community 801 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 803 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 804 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 808 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 810 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 811 - "What to clean up"
Cohesion: 0.18
...
### Community 817 - "migrate_local_brain_env.py"
Cohesion: 0.25
...
### Community 822 - "TestZeroAttemptDiagnostics"
Cohesion: 0.25
...
### Community 823 - "TestNoNvidiaFallbackIsRetired"
Cohesion: 0.22
...
### Community 829 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 830 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 831 - "_normalize_tool_choice"
Cohesion: 0.31
...
### Community 832 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 838 - "DirectChatSession"
Cohesion: 0.20
...
### Community 847 - "capture_screens.py"
Cohesion: 0.29
...
### Community 848 - "local_brain_provider_config"
Cohesion: 0.29
...
### Community 850 - "enrich_quick_note_issues.py"
Cohesion: 0.36
...
### Community 851 - "_start_ceo_agency"
Cohesion: 0.27
...
### Community 853 - "_resolve_push_token"
Cohesion: 0.31
...
### Community 855 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 856 - "test_model_catalog_guard.py"
Cohesion: 0.29
...
### Community 867 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 868 - "Skill: changelog-enforcer"
Cohesion: 0.22
...
### Community 869 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 871 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 872 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 873 - "Skill: changelog-enforcer"
Cohesion: 0.22
Nodes (8): Acceptance Checks, Changelog Location, Entry Format, Examples, Hook Behaviour, Instructions, Skill: changelog-enforcer, When to Use

### Community 874 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
Nodes (8): Branch, Components, Purpose, Quick Start, Session Roles, Skill: cowork-session (Claude Cowork), Testing, When to Use

### Community 875 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 876 - "Active Task Tracker"
Cohesion: 0.22
...
### Community 878 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 880 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 881 - "Issue #1356: quick-note:https://searchengineland.com/turn-seo-backlog-into-roadmap-485713"
Cohesion: 0.22
...
### Community 882 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 883 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 884 - "Platform Controls"
Cohesion: 0.22
...
### Community 888 - "ENGINEERING_STANDARDS.md — Patterns & Reference"
Cohesion: 0.22
...
### Community 889 - "_get_current_user"
Cohesion: 0.25
...
### Community 891 - "test_key_pool.py"
Cohesion: 0.22
...
### Community 896 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 897 - ".test_every_request_carries_a_real_user_agent"
Cohesion: 0.22
...
### Community 898 - "test_changelog_parity_guard.py"
Cohesion: 0.22
...
### Community 899 - "TestPolicyAuthoringUiStableClaim"
Cohesion: 0.22
...
### Community 900 - "test_daemon_picks_colibri_8081_when_only_it_listening"
Cohesion: 0.22
...
### Community 904 - "TestPaidPolicyDurability"
Cohesion: 0.22
...
### Community 905 - "test_scanner_deps_parity.py"
Cohesion: 0.31
...
### Community 917 - "_build_direct_chat_schedule_suggestion"
Cohesion: 0.32
...
### Community 918 - "_start_in_web_bot_tasks"
Cohesion: 0.29
...
### Community 929 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 930 - "ceo-micromanagement.md"
Cohesion: 0.25
Nodes (4): P0 behavior change, Readiness contract, Runtime model, Runtime types

### Community 931 - "Feature Maturity / Support Matrix"
Cohesion: 0.25
...
### Community 934 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.25
...
### Community 935 - "Issue #362: Nvidia repo setup"
Cohesion: 0.25
...
### Community 936 - "Issue #364: quick-note:https://www.marktechpost.com/2026/06/01/meet-memory-os-a-6-layer-open-source-memory-stack-built-on-top-of-hermes-agent/"
Cohesion: 0.25
...
### Community 937 - "Issue #378: quick-note:https://www.marktechpost.com/2026/06/02/tinyfish-launches-bigset-an-open-source-multi-agent-system-that-builds-structured-live-datasets-from-plain-english-descriptions/"
Cohesion: 0.25
...
### Community 938 - "Issue #379: quick-note:https://searchengineland.com/schema-markup-optimize-agentic-web-479080"
Cohesion: 0.25
...
### Community 939 - "Issue #380: quick-note:https://cursor.com/blog/cloud-agent-lessons"
Cohesion: 0.25
...
### Community 940 - "Issue #381: quick-note:https://www.xda-developers.com/claude-code-with-opus-48-is-expensive-but-i-made-it-efficient-with-my-local-ai-workflow/"
Cohesion: 0.25
...
### Community 941 - "Issue #382: quick-note:https://claude.com/blog/how-coderabbit-used-claude-to-build-an-agent-orchestration-system"
Cohesion: 0.25
...
### Community 942 - "Issue #383: quick-note:https://www.marktechpost.com/2026/05/29/hexo-labs-open-sources-sia-a-self-improving-agent-that-updates-both-the-harness-and-the-model-weights/"
Cohesion: 0.25
...
### Community 943 - "Issue #416: feat: Self-hosted Codebuff (freebuff) on free NVIDIA models + Telegram bot phone control"
Cohesion: 0.25
...
### Community 944 - "Issue #485: [Trend Digest] Week of 2026-06-08"
Cohesion: 0.25
...
### Community 945 - "Issue #488: quick-note:https://github.com/cookiy-ai/user-research-skill"
Cohesion: 0.25
...
### Community 946 - "Issue #491: Implement whatever is necessary from https://github.com/BehiSecc/awesome-claude-skills"
Cohesion: 0.25
...
### Community 947 - "Issue #493: Use the https://github.com/mvanhorn/last30days-skill skill to get the trend updated"
Cohesion: 0.25
...
### Community 948 - "Issue #495: Read https://www.anthropic.com/news/claude-fable-5-mythos-5 and understand if mythos or fable can be added to the repo"
Cohesion: 0.25
...
### Community 949 - "Issue #504: EPIC: Autonomy hardening — live-verified defects 2026-06-10"
Cohesion: 0.25
...
### Community 950 - "Issue #581: Sprint tracker: pending work after brand rename + mobile-first pass"
Cohesion: 0.25
...
### Community 952 - "Issue #657: quick-note:https://github.com/earendil-works/pi"
Cohesion: 0.25
...
### Community 953 - "Issue #659: quick-note:https://github.com/nex-agi/Nex-N2"
Cohesion: 0.25
...
### Community 954 - "Issue #660: quick-note:https://github.com/getsentry/sentry-for-ai"
Cohesion: 0.25
...
### Community 955 - "Issue #661: quick-note:https://github.com/XiaomiMiMo/MiMo-Code"
Cohesion: 0.25
...
### Community 956 - "Issue #664: quick-note:https://github.com/Grominet95/jarvis-OS"
Cohesion: 0.25
...
### Community 957 - "Issue #666: quick-note:https://github.com/porokka/jarvis-os"
Cohesion: 0.25
...
### Community 958 - "Issue #670: quick-note:https://github.com/perplexityai/bumblebee"
Cohesion: 0.25
...
### Community 959 - "Issue #672: quick-note:https://github.com/Chachamaru127/claude-code-harness"
Cohesion: 0.25
...
### Community 960 - "Issue #676: quick-note:https://github.com/WeiboAI/VibeThinker"
Cohesion: 0.25
...
### Community 961 - "Issue #820: quick-note:https://github.com/cobusgreyling/loop-engineering"
Cohesion: 0.25
...
### Community 962 - "Positional Encoding Internals"
Cohesion: 0.25
...
### Community 964 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 965 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 966 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 967 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 968 - "Continual Harness (`agent/harness_spec.py`)"
Cohesion: 0.25
...
### Community 969 - "Prime Agent Runtime"
Cohesion: 0.25
...
### Community 975 - "crispy_burn_in.py"
Cohesion: 0.36
...
### Community 978 - "_answer_callback"
Cohesion: 0.29
...
### Community 981 - "TestItIsNotBuiltForOneVendor"
Cohesion: 0.25
...
### Community 982 - "test_doctor_coding_brain.py"
Cohesion: 0.32
...
### Community 983 - "test_generate_context_standing_instructions.py"
Cohesion: 0.32
...
### Community 984 - "TestReviewRegressions"
Cohesion: 0.25
Nodes (4): Regressions for defects found in review of this module., A workspace is often a third-party repo — its spec file is untrusted. Without…, verify=False is the internal path used for merging, and stays permissive., TestReviewRegressions
...
### Community 989 - "test_runtimes_health_endpoint.py"
Cohesion: 0.25
...
### Community 993 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.25
...
### Community 995 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 1008 - "Skill: hybrid-reasoning (Hybrid AI)"
Cohesion: 0.29
Nodes (6): Branch, Components, Purpose, Quick Start, Skill: hybrid-reasoning (Hybrid AI), Testing

### Community 1009 - "Karpathy Guidelines Skill"
Cohesion: 0.29
...
### Community 1022 - "Implementation plan + TO-DO (check off as you go)"
Cohesion: 0.29
...
### Community 1035 - "BackgroundServices"
Cohesion: 0.38
...
### Community 1037 - "test_daily_2026_06_14.py"
Cohesion: 0.38
...
### Community 1038 - "TestExhaustedPoolDoesNotReusePrimary"
Cohesion: 0.29
...
### Community 1039 - "TestReasonsAreActionable"
Cohesion: 0.29
...
### Community 1040 - "TestProvidersScreen"
Cohesion: 0.43
...
### Community 1042 - "TestMongoService"
Cohesion: 0.29
...
### Community 1066 - "The full agent capability roster"
Cohesion: 0.33
...
### Community 1067 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 1068 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 1069 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 1072 - "apply_phase1_changes.py"
Cohesion: 0.33
...
### Community 1083 - "test_catalogue_probe.py"
Cohesion: 0.33
...
### Community 1108 - "Who is this for?"
Cohesion: 0.40
...
### Community 1109 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 1110 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 1111 - "Runtime troubleshooting"
Cohesion: 0.40
Nodes (4): Agent mode timeout, Missing binary / task harness, Runtime troubleshooting, Workspace validation failures

### Community 1112 - "knowledgeGraphTab.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 1113 - "loginFlowNoTimeout.test.js"
Cohesion: 0.40
Nodes (4): apiSource, { describe, test, expect }, fs, path

### Community 1114 - "test_company_stale_id_recovery.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 1115 - "worker_no_cache.test.js"
Cohesion: 0.40
...
### Community 1127 - "._resolve_merge_decision"
Cohesion: 0.40
...
### Community 1128 - ".get_bound_skills"
Cohesion: 0.40
...
### Community 1129 - "start_tunnel.py"
Cohesion: 0.50
...
### Community 1133 - "nvidia_live_test.py"
Cohesion: 0.40
...
### Community 1138 - "TestGhIsNotReAuthenticated"
Cohesion: 0.40
...
### Community 1139 - "TestDirectChatNonBlocking"
Cohesion: 0.40
...
### Community 1140 - "TestModelRoleSeparation"
Cohesion: 0.40
...
### Community 1163 - "test_nim_models.py"
Cohesion: 0.67
...
- **3527 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3522 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 14276 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **121 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `_fixture()` connect `_fixture` to `CompanyGraphStore`, `seo_api.py`, `test_llm_router_queue_cache.py`, `llm/router.py`, `parse_event_stream`, `WebsiteScanner`, `client`, `Task`, `failover_client.py`, `SelfHealingAgent`, `test_autonomy_status.py`, `test_brain_patch_service_token.py`, `tasks/models.py`, `test_ceo_supervision.py`, `AgentRunner`, `test_llm_router_strategies.py`, `test_operational_incidents.py`, `test_provider_state_durability.py`, `test_model_router.py`, `PolicyEngine`, `quick_note.py`, `TaskSpec`, `config.py`, `direct_chat.py`, `WorkflowOrchestrator`, `E2BSandboxSession`, `ImprovementLoop`, `test_failover_client_shared.py`, `Agency`, `test_unit8_model_catalog.py`, `build_governance_router`, `TaskStatus`, `AuditLog`, `build_llm_router`, `test_ceo_router.py`, `test_company_api.py`, `test_monitor_lib.py`, `reset_kv_state`, `test_phase5_doctor.py`, `test_task_pre_execution_gate.py`, `HermesAdapter`, `AgentSwarm`, `test_catalogue_probe.py`, `UserRole`, `cost_tracker.py`, `test_sam_livekit.py`, `claim`, `test_provider_router.py`, `e2e/test_browser.py`, `test_openclaw_endpoints.py`, `BackgroundAgent`, `TokenBudget`, `test_task_service_failed_comment.py`, `PrimeAgentAdapter`, `ResearchTask`, `SeoFixer`, `TestSelfHealingInfrastructureClassification`, `test_sam_voice.py`, `TestClient`, `ArtifactStore`, `test_knowledge_sync.py`, `test_telegram_auto_approve.py`, `TestHarnessAdapter`, `test_startup_warmup.py`, `FeatureMaturity`, `test_local_brain_state.py`, `controls_app`, `TestChatHistoryStore`, `TaskStore`, `test_refresh_agent_built_proof.py`, `test_tasks_reconciler_todo_requeue.py`, `test_procedural_memory.py`, `test_new_features_e2e.py`, `persist_plan_spec`, `test_context_rulebook.py`, `test_llm_router_e2e.py`, `test_trend_watcher.py`, `KeyStore`, `_inline_threads`, `test_trend_scoping.py`, `ChatHistoryStore`, `_step`, `TestEstimateTokensForMessages`, `test_agent_tool_governance.py`, `MCPClient`, `test_brain_failover_413.py`, `test_changelog_check_workflow.py`, `LogMonitor`, `test_portfolio_intake.py`, `test_openclaw_gateway.py`, `test_e2b_data_flow.py`, `OllamaCircuitBreaker`, `_job_text`, `TestAuthAndTaskOwnership`, `test_video_transcript.py`, `emit_chat_observation`, `clear_cooldowns`, `SchedulerStore`, `NotificationDispatcher`, `test_features_api.py`, `nvidia_models.py`, `_Budget`, `WorkflowBuildRequest`, `TrendWatcher`, `TestRuntimeControl`, `test_telegram_task_callback.py`, `_resolve_user_github_token`, `TestClient`, `test_telegram_webhook.py`, `test_control_plane_api.py`, `ContextPruner`, `test_brain_failover.py`, `test_persistent_memory.py`, `test_provider_enable_disable.py`, `test_agile_api.py`, `test_app_settings.py`, `SecurityScanner`, `TestAuthAndTaskCreation`, `test_nvidia_model_discovery.py`, `OutputFilter`, `heal_signature`, `tests/conftest.py`, `test_task_clarification.py`, `test_rate_limiter.py`, `TestNormalizeResponseFormat`, `test_platform_controls.py`, `session_retro.py`, `test_agency_fix.py`, `test_skill_registry_boot_refresh.py`, `brain_config.py`, `test_scheduler_hydration_bounded.py`, `OrchestratorCheckpointStore`, `_redact_for_notification`, `_start_ceo_agency`, `test_freebuff_bot.py`, `isolated_telegram_config`, `_resolve_push_token`, `TestMongoGate`, `test_dashboard_cache.py`, `_Recorder`, `test_regression.py`, `test_agent_scripts_share_one_model_list.py`, `test_crispy_burn_in.py`, `test_webui_provider_priority.py`, `test_harness_spec.py`, `_Recorder`, `test_llm_router_disabled.py`, `test_key_pool.py`, `_undeclared`, `test_process_quick_note_workflow.py`, `traffic_director.py`, `test_service_token.py`, `test_telegram_diag_endpoint.py`, `api_keys_for`, `test_v4_api.py`, `test_gh_brain_failover.py`, `.on_task_complete`, `TestTheWorkflowIsSafeAndReadOnly`, `test_doctor_coding_brain.py`, `test_voice_pipeline.py`, `test_mcp_protocol_version.py`, `test_ping.py`, `test_runtimes_health_endpoint.py`, `test_task_store_fails_loud_in_production.py`, `captured`, `UsageEvent`, `SQLiteStore`, `test_kimi_bridge_server.py`?**
  _High betweenness centrality (0.109) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `TestAgentLoopMCPIntegration`, `ExecutionRequest`, `proxy.py`, `UserMemoryStore`, `RuntimeHealth`, `InternalAgentAdapter`, `loop.py`, `ReactScratchpad`, `PolicyEngine`, `ContextManager`, `TaskSpec`, `direct_chat.py`, `enforcement.py`, `MultiAgentSwarm`, `E2BSandboxSession`, `WorkflowOrchestrator`, `test_agent_tool_governance.py`, `test_failover_client_shared.py`, `MCPClient`, `test_governance_api.py`, `test_agent_runner.py`, `test_brain_failover_413.py`, `StuckDetector`, `test_empirical_verify.py`, `LocalWorkspace`, `CEODispatcher`, `WorkspaceTools`, `test_agent_free_brain.py`, `BackgroundAgent`, `FreeBuffAgent`, `TokenBudget`, `test_fixes_reliability.py`, `AdaptiveHalter`, `ContextPruner`, `test_backend_server_features.py`, `GitHubTools`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderRouter` to `backend/server.py`, `get_director`, `test_all_providers_discovery.py`, `failover_client.py`, `test_bedrock_provider.py`, `direct_chat.py`, `test_colibri_brain_shim.py`, `implement_agent.py`, `test_bedrock_live.py`, `clear_cooldowns`, `test_colibri_provider.py`, `TestLegacyRouterCacheTTL`, `test_anthropic_refusal_fallback.py`, `kimi_bridge_provider_config`, `settings.py`, `test_provider_router.py`, `_payload`, `TestAnthropicPayloadStructuredOutput`, `_build_request`, `TestLegacyRouterServerFallback`, `system_instruction`, `resolve_provider_for`, `TrafficDirector`, `NvidiaProvider`?**
