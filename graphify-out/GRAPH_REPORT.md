...
## Corpus Check
- 1308 files · ~1,819,007 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 24843 nodes · 50233 edges · 1133 communities (1001 shown, 132 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 6021 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2dda814b`
...
- .test_direct_chat_non_agent_calls_direct_path
- .test_trivial_message_forces_direct_mode
- .test_default_model_roles_are_configured_from_env
- .test_planner_executor_verifier_env_vars_documented
- .test_runtime_adapter_tier_and_capabilities

## God Nodes (most connected - your core abstractions)
1. `AgentRunner` - 298 edges
2. `AgentSessionStore` - 185 edges
3. `TaskSpec` - 156 edges
4. `ProviderConfig` - 151 edges
5. `Task` - 151 edges
6. `ProviderRouter` - 146 edges
...
## Communities (1133 total, 132 thin omitted)

### Community 0 - "TaskSpec"
Cohesion: 0.05
Nodes (122): PreflightReport, AgentJob, WorkspaceIDError, kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider).      Ret, AiderAdapter, TaskResult, TaskSpec (+114 more)

### Community 1 - "backend/server.py"
Cohesion: 0.01
Nodes (342): backend/ceo_router.py — observability and manual control for the CEO.  Surfaces, admin_seed(), _agent_timeout_fallback_response(), auth_me(), auto_recommend_skills(), brain_failover_status(), brain_providers(), _build_agent_status_snapshot() (+334 more)

### Community 2 - "ProviderConfig"
Cohesion: 0.04
Nodes (76): _acquire_provider_probe(), extract_openai_text(), is_commercial_provider(), _normalize_nvidia_base_url(), _openai_url(), provider_access_tier(), _provider_field(), provider_sort_key() (+68 more)

### Community 3 - "proxy.py"
Cohesion: 0.03
Nodes (158): Any, Return recent commits with agent attribution trailers parsed out., get_sam(), agent/sam.py — SAM Voice Agent (System Autonomy Manager)  SAM is the voice-contr, check_ollama_async(), Attempt a named one-click fix., Async Ollama reachability check — non-blocking for FastAPI handlers., run_fix() (+150 more)

### Community 4 - "FeatureMatrix"
Cohesion: 0.02
Nodes (78): check_feature(), get_feature(), list_features(), Any, get, post, features/api.py — Admin API for the feature support matrix.  Exposes:   GET  /ad, Return the full support matrix with summary. (+70 more)

### Community 5 - "PortfolioManager"
Cohesion: 0.02
Nodes (88): AgileManager, Manages multiple agile sprints with velocity tracking., List all active sprints., Predict next sprint velocity from historical data., Number of managed sprints., add_initiative(), AllocationOut, BoardOut (+80 more)

### Community 6 - "AgentRunner"
Cohesion: 0.03
Nodes (110): get_enrichment(), AgentRunner, _nvidia_api_key(), Any, Path, Append an event to the durable session log if a store is wired in., Summarise a long history and compact it.          Asks the planner model to writ, Send chat messages and return the assistant's text output.          If an Anthro (+102 more)

### Community 7 - "AgentScheduler"
Cohesion: 0.05
Nodes (136): Agency, CEO-coordinated multi-agent agency for continuous codebase management.      The, AgentJobRequest, AgentJobSnapshot, BaseModel, Complete point-in-time view of a job, safe to serialise as API response., Convenience: the canonical text response, whether success or failure., Validated input for creating a new agent job.      Passed from the API handler (+128 more)

### Community 8 - "test_unit8_model_catalog.py"
Cohesion: 0.04
Nodes (60): all_provider_ids(), Resolve the model id for a component's role on a provider.      Parameters     -, Return every provider id recognised by the brain config system.      Iterates th, resolve_component_model(), CatalogActiveBrain, CatalogMirror, CatalogProviderEntry, get_model_catalog_store() (+52 more)

### Community 9 - "SchedulerStore"
Cohesion: 0.09
Nodes (16): _MemCollection, _MemCursor, _MemDB, _MemDeleteResult, Any, services/scheduler_store.py — Durable scheduler persistence.  Issue #505: AgentS, Delete a persisted job., Return the total number of persisted jobs. (+8 more)

### Community 10 - "AgentJobManager"
Cohesion: 0.04
Nodes (34): PreflightIssue, BaseModel, AgentJobManager, make_isolated_workspace(), _now(), Any, Path, agent/job_manager.py — Async agent job lifecycle manager.  Manages agent jobs (+26 more)

### Community 11 - "company_api.py"
Cohesion: 0.05
Nodes (134): AccountLifecycleResponse, _DoctorCheck, _DoctorReport, _get_current_user_thunk(), _get_optional_user_thunk(), get_public_doctor_report(), OnboardingAnswersRequest, OnboardingProgressResponse (+126 more)

### Community 12 - "FreeBuffAgent"
Cohesion: 0.11
Nodes (91): BrowserSession, Async Playwright browser session.      Usage::          session = BrowserSes, True if Playwright is installed and ready to use., CommitAttribution, CommitTracker, Path, agent/commit_tracker.py — AI Commit Attribution  Tags git commits with metadat, Create git commits enriched with agent-session attribution trailers.      Usag (+83 more)

### Community 13 - "AgentSessionStore"
Cohesion: 0.04
Nodes (65): Agent subsystem — planner / executor / verifier loop., AgentPhaseError, _check_extra_kwargs(), _enforce_signature(), Exception, loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., Raise TypeError on unknown kwarg (runtime extra='forbid' for non-Pydantic classe, Raised when a named agent phase (planning, verification, etc.) fails. (+57 more)

### Community 14 - "DetectedSystem"
Cohesion: 0.03
Nodes (76): DetectedSystem, Evidence, Evidence supporting a system detection., A business system detected on a company's website or in their stack., Get the most confident evidence description., OnboardingService, Workflow, Detect the Git provider from a repository URL.                  Args: (+68 more)

### Community 15 - "webui/router.py"
Cohesion: 0.05
Nodes (69): _fake_user_auth(), Path, test_admin_can_create_anthropic_provider_via_webui_admin_api(), test_admin_can_create_provider_via_webui_admin_api(), test_ui_providers_and_workspaces_use_app_state(), _bootstrap(), fixture, Path (+61 more)

### Community 16 - "get_company_access"
Cohesion: 0.04
Nodes (75): Reject non-admin callers for routes that spend provider budget.      Delegates t, _require_admin(), account_lifecycle(), auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint(), generate_onboarding_questions() (+67 more)

### Community 17 - "MongoDBStore"
Cohesion: 0.04
Nodes (52): CompanyGraphSnapshot, A point-in-time snapshot of a Company Graph for history and rollback., MongoDBStore, Any, ObjectId, Prepare a Pydantic model for SQLite storage., Prepare a SQLite row for Pydantic model., Create a snapshot of a company graph. (+44 more)

### Community 18 - "TrafficDirector"
Cohesion: 0.03
Nodes (65): _provider_env_value(), provider_max_parallel(), provider_max_rpm(), provider_max_tpm(), _provider_positive_float(), provider_weight(), Read a per-provider env var, tolerating dashes in the provider id.      Provider, Shared parse/validate for the numeric per-provider traffic budgets.      Returns (+57 more)
...
Cohesion: 0.04
Nodes (68): BrainConfig, BrainConfigStore, default_brain_config(), provider_base_url(), BaseModel, Build a ``BrainConfig`` from a Mongo doc, dropping Mongo's ``_id``., Synchronous call-time resolver for an agent role model id.      Precedence (high, Resolve the Ollama base URL the UI controls — DB value wins over env.      Prece (+60 more)
...
Cohesion: 0.04
Nodes (84): agent/workflow.py — Persisted workflow state machine.  Implements the Autonomo, packages/ai/self_heal.py — automatic brain self-healing.  When the active brain, Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., tasks — Task/issue management system.  Provides a lightweight task/issue tracker, Enum, str, tasks/models.py — Pydantic models for the task/issue system. (+76 more)

### Community 24 - "test_model_router.py"
Cohesion: 0.03
Nodes (101): classify_task(), _extract_recent_text(), Any, Task classification from request context.  Classifies an incoming request into a, Concatenate plain text from the last *last_n* messages., Return the most likely task category for this request.      Args:         messag, Reset the singleton and clear the cached model map (test helper)., reset_router() (+93 more)

### Community 25 - "SelfHealingAgent"
Cohesion: 0.04
Nodes (65): heal_signature(), HealingEvent, HealState, _now(), Any, Enum, str, agent/self_healing.py — Self-Healing Agent (closed-loop, Autonomy Charter G2)  T (+57 more)

### Community 26 - "skill_bindings.py"
Cohesion: 0.03
Nodes (96): Status of a user story within a sprint., StoryStatus, HarnessAdapter, HarnessSpec, Any, agents/harness_adapter.py — ECC Cross-Harness Adapter  Normalises API difference, Adapt harness-native requests to the local-llm-server internal format.      Each, Detect which harness sent this request from headers.          Check order: expli (+88 more)

### Community 27 - "ExecutionRequest"
Cohesion: 0.05
Nodes (42): OrchestratorSupervisor, Any, Emit an alert to the activity feed and log., Deterministic supervisor for the orchestrator.      Runs as a background corouti, stop_orchestrator_supervisor(), ExecutionRequest, get_workflow_orchestrator(), Return the shared WorkflowOrchestrator singleton. (+34 more)
...
### Community 29 - "Task"
Cohesion: 0.05
Nodes (52): Full task/issue document., Task, PUBLIC_URL-anchored dashboard deep link for the task detail.          Returns em, Best-effort Telegram heads-up that a task is parked awaiting approval., _coordinator(), asyncio, fixture, Pre-execution approval gate tests (Autonomy Charter Gate Matrix / P0).  A ``requ (+44 more)
...
Cohesion: 0.10
Nodes (16): BrainWatchdog, get_watchdog(), Any, services/brain_watchdog.py — Brain health watchdog.  Monitors the active brain p, Persist the new provider in the brain config store (fire-and-forget).          U, Send a Telegram notification about the failover., Return the shared BrainWatchdog singleton., Reset the singleton (test helper). (+8 more)

### Community 32 - "SQLiteStore"
Cohesion: 0.02
Nodes (61): Find a website by its URL., A company website with detected systems and stack inference., Website, Company, Delete a company and all its associated data., Create a new company in SQLite., Get a company by ID from SQLite., Update a company in SQLite. (+53 more)

### Community 33 - "agency.py"
Cohesion: 0.10
Nodes (22): AgencyCycleResult, AgentDirective, _build_ceo_prompt(), _build_quick_note_instruction(), _close_github_issue(), _collect_recent_git_context(), _fetch_github_quick_notes(), _gh_repo() (+14 more)

### Community 34 - "SecretRecord"
Cohesion: 0.06
Nodes (63): get_user_role(), str, Extract role from a user object (dict or Pydantic model)., UserRole, _can_read(), _can_write(), create_secret(), _decrypt() (+55 more)

### Community 35 - "TaskWorkflowService"
Cohesion: 0.04
Nodes (66): _is_brain_connection_error(), Any, BaseException, Task, TaskResult, TaskSpec, TaskStatus, Best-effort label of who will run this task once approved.          Returns ``ta (+58 more)

### Community 36 - "KeyStore"
Cohesion: 0.07
Nodes (36): Browser admin UI for login, service control, key management, and diagnostics., Update or append a KEY=value line in the .env file., register_admin_gui(), _save_env_var(), get_output_filter(), Get or create the singleton OutputFilter instance., _check_rate_limit(), default_keys_path() (+28 more)

### Community 37 - "direct_chat.py"
Cohesion: 0.04
Nodes (102): Any, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace, Translate technical preflight issues into a conversational assistant reply., translate_error_to_conversational(), ResumeRequest, AcceptedJob, AgentJobEnvelope, CompletedJob (+94 more)

### Community 38 - "test_phase6_workflow.py"
Cohesion: 0.04
Nodes (72): add_pr_comment(), _find_existing_pr(), get_branch_sha(), get_default_branch(), _headers(), Any, agent/safe_agency.py — Safe GitHub operations for the workflow engine.  All fu, Create a pull request. Returns the PR object dict.      If a PR already exists (+64 more)
...
Cohesion: 0.06
Nodes (71): _harvest_changed_files(), Extract the files a runtime touched. Returns ``(files, reported)``.      Adapter, Attempt, One delegation of one subtask to one tier., A subtask's full history: what it is, and every attempt at it., SubtaskRecord, What one sweep observed and did. Returned for tests and diagnostics., SweepReport (+63 more)

### Community 41 - "NotificationDispatcher"
Cohesion: 0.06
Nodes (35): NotificationDispatcher, Any, Path, Start the Telegram bot. Returns True if started successfully., Signal the bot to stop and wait for graceful shutdown., Run the Telegram bot long-poll loop (inline, not subprocess)., Run the bot with stop-event awareness., Routes background task results to configured notification channels.      Current (+27 more)

### Community 42 - "brain_config.py"
Cohesion: 0.05
Nodes (72): _build_base_url_env_from_yaml(), _build_candidates_from_yaml(), _build_default_base_url_from_yaml(), _build_display_names_from_yaml(), _build_key_env_from_yaml(), _build_presets_from_yaml(), _build_tier_from_yaml(), get_provider_candidates() (+64 more)
...
Cohesion: 0.03
Nodes (116): E2BAdapter, Any, TaskResult, TaskSpec, Declare ``E2B_API_KEY`` as a required env dependency.          The base ``prefli, Execute a task inside a fresh E2B sandbox.          Flow:           1. Open an :, Run ``pytest`` inside the sandbox. Returns ``(output, passed)``.          ``run_, Runtime adapter that executes tasks inside an E2B sandbox.      Activation: regi (+108 more)
...
### Community 54 - "rbac.py"
Cohesion: 0.05
Nodes (47): compute_savings(), compute_time_series(), get_savings(), get_usage(), get_user_savings(), _period_start(), Any, BaseModel (+39 more)
...
Cohesion: 0.03
Nodes (136): delegate_seo_findings(), _expire_stale_pending_report(), export_seo_audit(), get_seo_audit(), list_seo_audits(), BaseModel, get, post (+128 more)

### Community 57 - "resolve_e2b_config"
Cohesion: 0.05
Nodes (57): Available iff config resolves AND the SDK is importable.          Never raises —, e2b_enabled(), E2BConfig, _env_falsy(), _env_truthy(), is_e2b_sdk_importable(), services/e2b_config.py — Single reader of E2B sandbox environment config.  Const, Return ``True`` when E2B sandboxing should be activated.      **EXPERIMENTAL gua (+49 more)

### Community 58 - "CompanyGraphService"
Cohesion: 0.04
...
Cohesion: 0.06
Nodes (45): Semaphore, CEODispatcher, _complexity_rank(), _offload(), Any, services/ceo_dispatcher.py — Real CEO delegation layer.  The CEO splits a comple, Run a synchronous ledger call without blocking the event loop.      ``CEOLedger`, Build an agent.coordinator.TaskSpec from a CEO SpecialistTask. (+37 more)
...
Cohesion: 0.09
Nodes (17): _bedrock_api_response(), _bedrock_provider(), _mock_boto3(), Any, asyncio, Tests for AWS Bedrock provider support in ProviderRouter., Inject a mock boto3 module into sys.modules for the duration of the block., Verify that Bedrock model IDs bypass non-Bedrock providers. (+9 more)

### Community 77 - "workflow_orchestrator.py"
Cohesion: 0.06
Nodes (59): get_orchestrator_checkpoint_store(), _NoopDB, OrchestratorCheckpointStore, Any, services/orchestrator_checkpoint.py — Durable step-level checkpointing  Issue #5, Restore in-flight runs at startup.          Called during backend bootstrap.  Re, Fallback in-memory store when no DB is available., Persist orchestrator runs so they survive restarts. (+51 more)
...
Cohesion: 0.07
Nodes (39): analyze_quantitative(), _extract_keywords(), plan_research(), BaseModel, QualAnalysis, QualQuote, QualTheme, QuantAnalysis (+31 more)
...
Cohesion: 0.07
Nodes (28): Run the repo-aware auto-fixer against this company's workspace checkout.      Au, Root directory under which repo fixes are allowed to operate., run_seo_fixes(), _workspace_root(), FsPath, Request to remediate auto-fixable findings in a local code repository., One concrete remediation performed (or proposed) by the fixer., SeoFixAction (+20 more)
...
Cohesion: 0.07
Nodes (36): get_skill_registry_safe(), Return the global SkillRegistry if set, else None.     Used by onboarding and ot, _await_hermes_ready(), BackgroundServices, _env_float(), _env_on(), Any, Path (+28 more)

### Community 104 - "ImprovementLoop"
Cohesion: 0.05
Nodes (63): _parse_ceo_directives(), DetectedIssue, ImprovementLoop, ImprovementLoopState, _now(), Any, Path, agent/improvement_loop.py — Continuous Improvement Engine  Background scanner th (+55 more)

### Community 105 - "get_orchestrator_queue"
Cohesion: 0.07
Nodes (24): get_harness_adapter(), harness_active(), harness_catalog(), harness_session_close(), harness_session_start(), Return orchestrator queue depth, active runs, and supervisor state (#522)., #522 + #505: Reliability startup — schedule hydration, orchestrator restore, que, Return the full ECC harness catalog with capabilities.      Public — no auth req (+16 more)
...
Cohesion: 0.06
Nodes (20): AgentJobError, AgentJobResult, Any, field_validator, agent/contract.py — Typed public contract for the agent job lifecycle.  Phase, Structured error payload attached to a failed job., Typed result returned by a completed agent job.      The ``response`` field is, Accept a bare string (legacy runner output) or a full dict. (+12 more)
...
Cohesion: 0.09
Nodes (28): _disable_unless_key_serves_other_models(), _models_to_try(), Order the models to attempt on *provider*, correcting a stale catalogue.      Ca, Auto-disable *provider*, unless its key demonstrably serves other models.      ", attempted(), Return every model of *provider_id* tried so far by a failed round., _mock_get(), _ok() (+20 more)
...
Cohesion: 0.06
Nodes (32): _auto_disable(), _Budget, _build_request(), _describe_registry(), _disabled_ids(), _is_billing_refusal(), _is_ollama(), _log_exhaustion() (+24 more)
...
### Community 145 - "clear_cooldowns"
Cohesion: 0.07
Nodes (41): clear_cooldowns(), get_dead_models(), _is_model_dead(), is_provider_on_cooldown(), mark_provider_failed(), Snapshot of active dead-model entries {provider_id/model: expiry_ts}.      Also, Put provider_id on cooldown for *cooldown_seconds* (default: PROVIDER_COOLDOWN_S, Return True if provider_id is currently on cooldown. (+33 more)
...
### Community 148 - "get_improvement_loop"
Cohesion: 0.05
Nodes (59): get_improvement_loop(), _dispatch_async(), _ErrorCaptureHandler, get_log_monitor(), LogMonitor, _note_recurrence(), Any, LogRecord (+51 more)
...
Cohesion: 0.06
Nodes (40): _get_provider_policy(), get_provider_policy_route(), Read the durable provider policy from DB, falling back to a safe default.      R, Return the provider policy (paid-provider kill switch state)., seed_default_providers(), Resolve the LLM endpoint for a named surface (task/chat/ceo/sdlc/…).      Honour, resolve_provider_for(), asyncio (+32 more)
...
Cohesion: 0.10
Nodes (40): _apply_activity_status(), create_agent(), delete_agent(), get_agent(), _get_user(), list_agents(), list_runtime_agents(), Any (+32 more)
...
Cohesion: 0.03
Nodes (76): get_agency(), set_agency(), _autonomy_bg_cycle(), autonomy_tick(), get_public_doctor(), legacy_scheduler_create(), legacy_scheduler_delete(), legacy_scheduler_get() (+68 more)
...
Cohesion: 0.10
Nodes (31): auto_disable_provider(), _disabled_from_mongo(), _disabled_from_sqlite(), _is_paid_allowed_db(), _kv_connect(), _kv_path(), _mongo_db(), _mongo_enabled() (+23 more)
...
Cohesion: 0.06
Nodes (21): Drop the cached Mongo client, backoff, and read caches (tests)., reset_kv_state(), one_configured_provider(), fixture, A registry with exactly two known providers and isolated state., fake_mongo(), isolated_state(), _live_mongo_url() (+13 more)
...
### Community 170 - "test_workflow_models.py"
Cohesion: 0.13
Nodes (8): tests/test_workflow_models.py — Unit tests for workflow/models.py., TestApprovalGate, TestCheckRun, ApprovalGate, CheckRun, Any, Hard approval gate between plan and execution.      The workflow engine sets sta, Structured, execution-based verification result.      Verifier agents produce ON

### Community 171 - "test_workspace_isolation.py"
Cohesion: 0.25
Nodes (27): Tests for workspace isolation model (Area A).  Covers:   - Unique workspace path, TestConcurrency, TestCrossSessionIsolation, TestJobIdValidation, TestPathSafety, TestWorkspaceCleanup, TestWorkspaceMetrics, TestWorkspaceNotFound (+19 more)
...
Cohesion: 0.12
Nodes (34): IssueCategory, IssueSeverity, Enum, str, cluster_friction(), clusters_to_issues(), collect_friction_events(), FrictionCluster (+26 more)

### Community 178 - "get_failover_manager"
Cohesion: 0.12
Nodes (24): openclaw_websocket(), websocket, WebSocket endpoint for iOS / mobile web UI pairing + command routing., get_failover_manager(), Return the singleton BrainFailoverManager., _cmd_chat(), _cmd_freebuff(), _cmd_list_files() (+16 more)
...
Cohesion: 0.08
Nodes (29): _backend(), CEOLedger, GoalRecord, _now(), Any, services/ceo_ledger.py — durable record of what the CEO is driving to closure., One piece of work the CEO has taken ownership of.      ``state`` is the supervis, Return ``(done, total)`` subtask counts. (+21 more)
...
Cohesion: 0.11
Nodes (32): build_ceo_router(), Any, APIRouter, Install (or clear) the singleton — used by startup wiring and tests., Drop the singleton (test helper)., reset_ceo_supervisor(), set_ceo_supervisor(), _make_app() (+24 more)

### Community 193 - "facade.py"
Cohesion: 0.06
Nodes (51): create_refresh_token(), get_current_user(), get_optional_user(), Get user if authenticated, otherwise return None (for public endpoints)., Item, create_access_token(), create_refresh_token(), get_current_user() (+43 more)
...
### Community 198 - "test_unit6_resolve_component_model.py"
Cohesion: 0.05
...
### Community 199 - "scan_repo_with_user_research.py"
Cohesion: 0.22
...
Cohesion: 0.09
Nodes (35): brain_availability_summary(), Non-secret answer to "can the brain answer a request right now?".      Three cal, _env_flag(), _env_int(), services/ceo_supervisor.py — the CEO's 24x7 babysitting loop.  Delegation alone, Read a bounded int, clamping out-of-range values rather than raising., Bounds for the unattended supervision loop., True when the 24x7 supervisor should run in this process.      Off under ``TESTI (+27 more)
...
### Community 217 - "system_instruction"
Cohesion: 0.10
...
Cohesion: 0.10
Nodes (17): ABC, Cerebras provider adapter — free, fast LLM (qwen-3-coder-480b)., Groq provider adapter — free, fast LLM (deepseek-r1-distill-llama-70b)., NVIDIA NIM provider adapter — wraps the existing provider_router logic.  This is, packages.ai — provider abstraction, model registry, and failover manager., packages/ai/manager.py — ProviderManager.  Single entry point for all LLM calls., HealthStatus, Provider (+9 more)
...
Cohesion: 0.05
Nodes (19): _build_cost_table(), cost_for_tokens(), get_stats(), _load_env_overrides(), Any, Per-model cost attribution for the LLM provider router.  Maintains in-memory per, Return the USD cost for (prompt_tokens, completion_tokens) on *model*.      Retu, Record token usage for *model* (fire-and-forget, never raises).      ``tag`` is (+11 more)
...
### Community 240 - "ProviderRouter"
Cohesion: 0.13
Nodes (13): _get_director(), ProviderAttempt, ProviderRouter, Any, Response, Try all models for one provider. Returns ProviderResult on success, None on fail, Parse a 429/503 ``Retry-After`` header → seconds, or None.          Accepts eith, Return the process TrafficDirector, or None if it is unavailable. (+5 more)

### Community 241 - "test_brain_resolver.py"
Cohesion: 0.12
Nodes (29): get_active_brain_sync(), Return the cached brain read by sync callers. None if never resolved., fixture, tests/test_brain_resolver.py — Tests for the single brain resolver.  The agency, When a free provider (NVIDIA NIM) is configured, the brain must NOT     auto-pic, When only a paid record exists AND ALLOW_PAID_BRAIN is set, the brain     picks, When a base_url is excluded (transient retry failure), the next-best     free pr, When provider records are missing AND ``NVIDIA_API_KEY`` is set,     resolve to (+21 more)
...
### Community 253 - "test_unit7_catalog_propagation.py"
Cohesion: 0.07
...
### Community 259 - "RuntimeCapabilityRegistry"
Cohesion: 0.10
Nodes (7): Return the single best adapter for *task_type*.          If *preferred_runtime_i, Maintains the catalogue of registered adapters and answers     'which runtimes c, Return all adapters that can handle *task_type*, ordered by tier., RuntimeCapabilityRegistry, task_harness (no _base_url) must not spawn agent_runtime.py., If agent_runtime.py exits immediately, _base_url must NOT be set., TestRuntimeCapabilityRegistry
...
### Community 269 - "ResourceWatchdog"
Cohesion: 0.10
...
### Community 302 - "CompanyGraphStore"
Cohesion: 0.03
Nodes (87): Synchronize the Company Graph.          Re-scans all websites and repositories,, sync_company_graph(), Fire-and-forget self-bootstrap; never blocks or crashes startup., _schedule_self_bootstrap(), CompanyAgencyService, get_company_agency_service(), _is_runtime_available_sync(), _pick_available_runtime() (+79 more)
...
Cohesion: 0.03
Nodes (88): BrainResolution, get_brain_config(), get_brain_config_store(), invalidate_brain_config_cache(), Return the process-wide ``BrainConfigStore`` singleton., Convenience wrapper used by the agent loop + brain resolver., Convenience wrapper used by the admin API endpoints., Clear the singleton's cache (used by tests + brain_policy invalidation). (+80 more)
...
### Community 319 - "TestWorkspacePathDerivation"
Cohesion: 0.16
...
### Community 335 - "weekly_digest.py"
Cohesion: 0.13
...
### Community 353 - "ApprovalCheckpoint"
Cohesion: 0.14
...
### Community 354 - "trend_watcher.py"
Cohesion: 0.14
Nodes (17): get_trend_watcher(), agent/trend_watcher.py — Internet-connected AI trend intelligence.  Fetches fr, set_trend_watcher(), Tests for trend_analysis.py — last30days-style window over TrendWatcher (issue #, TestRunTrendAnalysis, TestWindow, test_singleton_round_trip(), BaseModel (+9 more)
...
Cohesion: 0.08
Nodes (13): _normalize_response_format(), Translate OpenAI ``response_format`` into Ollama's ``format`` field.      For *l, _get_model_map(), Merge built-in defaults with MODEL_MAP env overrides (lazy, cached)., fixture, Daily automation tests — 2026-05-14  Covers three features implemented in this r, Payload without 'model' field should apply normalization (no '/' → local)., _normalize_response_format must not mutate the input dict. (+5 more)
...
### Community 392 - "test_task_source_id_race.py"
Cohesion: 0.17
...
Cohesion: 0.19
Nodes (14): N5 dual-auth dependency: accept EITHER a user session OR a service token.      U, _user_or_service_token(), _get_hashed_token(), _hash_token(), is_service_token_configured(), Request, services/service_token.py — Backend service-token authentication.  Roadmap item, True when SERVICE_TOKEN is set in the environment. Used by health     endpoints (+6 more)
...
### Community 412 - "disabled"
Cohesion: 0.22
Nodes (7): Drop every cached list and attempt record.      For tests, and for an explicit o, reset_cache(), _clear_cache(), disabled(), fixture, Discovery caches in a module global — never leak it between tests., Record auto-disable calls instead of writing operator state.
...
Cohesion: 0.12
Nodes (8): requires_db, asyncio, Test that storage service can be initialized., Test company CRUD operations - skipped as requires specific config., Test that specialist service can be initialized., Test that onboarding service can be initialized., End-to-end against the real Mongo (CI service): the exact handler         seque, get_company_graph must surface persisted detections, and         delete_company
...
### Community 417 - "claim"
Cohesion: 0.05
Nodes (36): claim(), clear_all_locks(), cooldown_clear(), cooldown_get(), cooldown_set(), _get_backend(), incr_window(), Shared-state abstraction — in-memory (default) and Redis backends.  Provides dis (+28 more)
...
Cohesion: 0.09
Nodes (30): fixture, svc(), tests/test_langfuse_agency_wide.py — tests for PR #961 agency-wide Langfuse.  Ve, langfuse_obs.py must define emit_agency_observation., emit_agency_observation must be a no-op when Langfuse is not configured., tasks/service.py must call emit_agency_observation for task execution., agent/agency.py must call emit_agency_observation for CEO directives., backend/server.py scheduler_tick must call emit_agency_observation. (+22 more)
...
### Community 432 - "self_heal_brain_and_unblock_tasks"
Cohesion: 0.12
Nodes (16): _brain_provider_status(), Return per-provider metadata for the GET endpoint.      Iterates every provider, Return the discovered model list for *provider_id*, or ``[]`` if unknown., _served_models(), provider_key_present(), True when the env var for *provider*'s key is set (or it's Ollama)., Any, Background tick that runs self_heal_brain_and_unblock_tasks().      Called from (+8 more)
...
Cohesion: 0.15
Nodes (14): _get_ceo_dispatcher(), Execute the plan via the selected specialist(s)., Verify execution results., Return the shared CEODispatcher singleton (importable for monkeypatching)., GitHub token used to push branches / open PRs during EXECUTION (#506).      Prec, _resolve_push_token(), _clean_env(), fixture (+6 more)
...
Cohesion: 0.06
Nodes (27): Architecture, Bug Reports, Changelog, Coding Standards, Commit Message Convention, Contributing to local-llm-server, Development Setup, Feature Requests (+19 more)
...
### Community 464 - "ai/router.py"
Cohesion: 0.06
Nodes (39): _dead_model_key(), _exponential_backoff_cooldown(), _mark_model_dead(), _normalized_provider_type(), _notify_watchdog(), _ollama_reasoning_effort(), provider_router.py — auto-generated module docstring (user-research skill scan)., Notify the brain watchdog of a provider call outcome (fire-and-forget).      Cal (+31 more)
...
### Community 479 - "test_self_heal.py"
Cohesion: 0.11
...
Cohesion: 0.08
Nodes (25): cached_models(), discover_models(), _fresh_entry(), _models_url(), _parse_ids(), Any, Ask a provider which models the configured API key may actually use.  ``config/m, Return the cached list for *provider_id* without any network call.      The disp (+17 more)
...
### Community 495 - "router/health.py"
Cohesion: 0.20
...
### Community 497 - "AdminDigestRouterAuthTests"
Cohesion: 0.23
...
### Community 507 - "test_telegram_task_callback.py"
Cohesion: 0.19
...
### Community 536 - "test_doctor_service_token_check.py"
Cohesion: 0.21
...
Cohesion: 0.03
Nodes (78): AgentRole, str, AgentPlan, AgentStep, Re-queue BLOCKED tasks that have cooled down and are ready for retry., Polls for queued task work and executes it through the coordinator.      Crash r, Re-queue tasks stranded by a prior crash or hard-kill., TaskDispatcher (+70 more)

### Community 578 - "get_tool_registry"
Cohesion: 0.14
...
### Community 604 - "ChatResponse"
Cohesion: 0.20
Nodes (5): OllamaProvider, Provider, Ollama provider adapter — local LLM inference., ChatResponse, Standard response from a provider chat call.
...
### Community 606 - ".execute"
Cohesion: 0.15
Nodes (11): _best_cloud_primary_base(), TaskResult, TaskSpec, Execute a TaskSpec using the internal AgentRunner and convert the agent's outcom, Create an isolated execution context for a single task.          Tries ``git wor, Clean up the worktree or temp copy created by ``_create_worktree``., Return the highest-priority available cloud LLM base URL.      Tries free cloud, When the workspace is not a git repo, falls back to a temp copy. (+3 more)
...
### Community 644 - "test_watchdog_name_normalization.py"
Cohesion: 0.14
Nodes (13): tests/test_watchdog_name_normalization.py — PR #963  Verifies the watchdog norma, _normalize_provider must strip -nim, -local, -cloud suffixes., record_failure must store counts under the normalized name., record_success must reset counts under the normalized name., _is_provider_actually_available must return False for ollama without URL., _is_provider_actually_available must return True for ollama with URL., self_heal must normalize active_provider before checking failure counts., test_is_provider_actually_available_checks_ollama_url() (+5 more)

### Community 645 - "_is_bedrock_model_id"
Cohesion: 0.27
...
### Community 666 - "Autonomous AI Agency"
Cohesion: 0.15
...
### Community 670 - "FailoverResult"
Cohesion: 0.10
Nodes (10): FailoverResult, _log_recovery(), A successful completion plus the accounting its callers need., Report a successful failover at INFO — recovery is not an incident.      Everyth, An operator whose switches reset on deploy needs to know that here., A broken registry must not turn a failed call into a crash., Minimal stand-in for BrainFailoverManager., A zero-attempt exhaustion must say WHICH of the three causes it is.      Nothing (+2 more)
...
### Community 675 - "test_task_dispatcher.py"
Cohesion: 0.31
...
### Community 711 - "_looks_unknown_model"
Cohesion: 0.22
Nodes (6): _looks_unknown_model(), True when the provider rejected the model id itself, not the request., parametrize, A malformed listing must never be read as "the key serves nothing"., TestParsing, TestUnknownModelDetection
...
### Community 781 - "rate_limiter.py"
Cohesion: 0.25
Nodes (6): get_tracker(), _ProviderQuota, Response, Proactive rate-limit throttling for LLM providers — two complementary layers.  *, Parse x-ratelimit-* headers and update per-provider quota state.          Safe t, Return the process-singleton RateLimitTracker.
...
### Community 797 - "test_seo_audit_pending_expiry.py"
Cohesion: 0.43
...
### Community 803 - ".discover_directory"
Cohesion: 0.29
...
### Community 808 - "test_scanner_ssl_cert.py"
Cohesion: 0.25
...
Cohesion: 0.04
Nodes (32): RoutingDecision, DockerAgentAdapter, Any, TaskResult, TaskSpec, Adapter that runs agent tasks inside isolated Docker containers., Check whether Docker is available and report the adapter's runtime health., _build_default_manager() (+24 more)
...
### Community 840 - "CLAUDE.md — Master Architect Operating Manual"
Cohesion: 0.20
...
### Community 846 - "Coding Standards"
Cohesion: 0.22
...
### Community 870 - "reset"
Cohesion: 0.33
Nodes (5): Reset all state (primarily for tests)., Clear all token-bucket state (tests only). Does not touch the header     tracker, reset(), fixture, _reset_buckets()
...
### Community 927 - "LoopSpec"
Cohesion: 0.29
Nodes (4): LoopSpec, field_validator, loop-cost: approximate tokens this loop spends over 30 days., A single autonomous loop in the fleet.      A *loop* is a recurring, self-iterat
...
### Community 930 - "test_activity_logs.py"
Cohesion: 0.67
...
### Community 950 - "4. Current Architecture (As-Is)"
Cohesion: 0.29
...
### Community 1040 - "10. Testing Constitution"
Cohesion: 0.50
Nodes (4): 10. Testing Constitution, Test rules, Test structure, Testing Expectations

### Community 1041 - "5. AI Provider Architecture"
Cohesion: 0.50
...
- **Why does `AgentRunner` connect `AgentRunner` to `TaskSpec`, `backend/server.py`, `proxy.py`, `test_empirical_verify.py`, `Workspace`, `test_agent_free_brain.py`, `AgentScheduler`, `AdaptiveHalter`, `failover_client.py`, `FreeBuffAgent`, `AgentSessionStore`, `LocalWorkspace`, `ExecutionRequest`, `WorkflowRun`, `FailoverResult`, `direct_chat.py`, `test_failover_client_shared.py`, `MultiAgentSwarm`, `ContextPruner`, `runtimes/api.py`, `test_ceo_dispatcher.py`, `_resolve_push_token`, `test_brain_failover_413.py`, `GitHubTools`, `TaskDispatcher`, `CEODispatcher`, `TokenBudget`, `test_backend_server_features.py`, `workflow_orchestrator.py`, `ContextManager`, `MCPUnavailableError`, `TestMCPServer`, `MCPClient`, `ReactScratchpad`, `.execute`, `StuckDetector`, `BackgroundAgent`, `WorkspaceTools`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `TaskSpec` connect `TaskSpec` to `RuntimeManager`, `backend/server.py`, `CEODispatcher`, `TaskWorkflowService`, `RuntimeCapabilityRegistry`, `direct_chat.py`, `TaskIn`, `AgentScheduler`, `test_mostly_failed_steps.py`, `AgentJobManager`, `TestAdapterMetadata`, `runtimes/api.py`, `JCodeAdapter`, `test_ceo_dispatcher.py`, `TaskStore`, `ClaudeCodeAdapter`, `RoutingDecision`, `get_scheduler`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `get_skill_bindings()` connect `Specialist` to `FeatureMatrix`, `AgentRunner`, `company_api.py`, `AgentSessionStore`, `CompanyGraphStore`, `workflow_orchestrator.py`, `get_company_access`, `HarnessEnrichment`, `skill_bindings.py`, `WorkflowRun`?**
...
- **Are the 69 inferred relationships involving `ProviderConfig` (e.g. with `AgentStatusEntry` and `AgentStatusResponse`) actually correct?**
  _`ProviderConfig` has 69 INFERRED edges - model-reasoned connections that need verification._