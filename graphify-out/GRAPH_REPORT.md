# Graph Report - local-llm-server  (2026-08-07)

## Corpus Check
- 1375 files · ~1,943,070 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 27125 nodes · 54865 edges · 1172 communities (1060 shown, 112 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 6079 edges (avg confidence: 0.54)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8623f2b8`
...
3. `AgentScheduler` - 157 edges
4. `ProviderConfig` - 152 edges
...
## Communities (1172 total, 112 thin omitted)

### Community 0 - "backend/server.py"
Cohesion: 0.01
Nodes (390): get_sam(), agent/sam.py — SAM Voice Agent (System Autonomy Manager) SAM is the voice-…, get_harness_adapter(), admin_seed(), _agent_provider_failure_response(), _agent_timeout_fallback_response(), _append_agent_session_message(), auth_me() (+382 more)

### Community 1 - "Task"
Cohesion: 0.02
Nodes (231): agent/workflow.py — Persisted workflow state machine. Implements the Autonomous…, Set the global agent store instance (e.g., with MongoDB on startup)., set_agent_store(), quick_notes_submit(), Point the feature stores at the shared database connection. Deliberately…, Submit a quick-note URL or instruction from the dashboard FAB., _wire_feature_stores(), Helpers that turn scheduler and playbook activity into real tasks. (+223 more)

### Community 2 - "ProviderConfig"
Cohesion: 0.02
Nodes (198): _acquire_provider_probe(), clear_cooldowns(), _dead_model_key(), _exponential_backoff_cooldown(), extract_openai_text(), get_dead_models(), _get_director(), is_anthropic_base_url() (+190 more)

### Community 3 - "brain_config.py"
Cohesion: 0.01
Nodes (214): _brain_provider_status(), Return per-provider metadata for the GET endpoint. Iterates every provider in…, Return the discovered model list for *provider_id*, or ``[]`` if unknown., _served_models(), _active_primary_provider(), BrainConfig, BrainConfigStore, default_brain_config() (+206 more)

### Community 4 - "PortfolioManager"
Cohesion: 0.02
Nodes (178): AgentRole, str, _bullets(), generate_backlog_retro(), generate_sprint_retro(), generate_standup(), Agentic Agile — autonomous ceremonies (standup, retro, sprint planning). Where…, Render a :class:`Retrospective` as a markdown section. (+170 more)

### Community 5 - "AgentScheduler"
Cohesion: 0.04
Nodes (148): Agency, CEO-coordinated multi-agent agency for continuous codebase management. The CEO…, AgentJobRequest, AgentJobSnapshot, BaseModel, Complete point-in-time view of a job, safe to serialise as API response., Convenience: the canonical text response, whether success or failure., Validated input for creating a new agent job. Passed from the API handler into… (+140 more)

### Community 6 - "AgentRunner"
Cohesion: 0.02
Nodes (154): get_enrichment(), AgentPhaseError, AgentRunner, _check_extra_kwargs(), _enforce_signature(), Any, Exception, Path (+146 more)

### Community 7 - "LLMRequest"
Cohesion: 0.03
...
Cohesion: 0.02
Nodes (102): BusinessCategory, Get the bound Company Graph., CompanyGraph, CompanyGraphSnapshot, SystemType, The complete Company Graph - canonical core model for the Autonomous AI Agency.…, Find a website by its URL., Find a repository by its URL. (+94 more)

### Community 9 - "proxy.py"
Cohesion: 0.03
Nodes (157): get_skill_registry_safe(), Return the global SkillRegistry if set, else None. Used by onboarding and other…, middleware, admin_control(), admin_create_key(), admin_create_user(), admin_delete_user(), admin_list_users() (+149 more)
...
Cohesion: 0.03
Nodes (105): _load(), main(), get_budget(), The process-wide budget tracker., get_cache(), packages/llm/cache.py — layered caching. Five independent layers, each with its…, The process-wide cache manager., text_key() (+97 more)

### Community 13 - "AgentJobManager"
Cohesion: 0.03
Nodes (76): PreflightIssue, PreflightReport, BaseModel, AgentJob, AgentJobManager, make_isolated_workspace(), _now(), Any (+68 more)

### Community 14 - "test_llm_router_queue_cache.py"
Cohesion: 0.03
...
### Community 15 - "Specialist"
Cohesion: 0.03
Nodes (76): get_skill(), list_skills(), List all available skills with optional filtering. Returns the skill catalog…, Get a single skill by its ID., SpecialistFamily, Find all specialists of a specific family., Find specialists that can handle a task with given capabilities., A specialist agent that can be provisioned for company-specific tasks. (+68 more)

### Community 16 - "TaskSpec"
Cohesion: 0.05
Nodes (69): kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, TaskResult, TaskSpec, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Run aider non-interactively via `--message` flag., runtimes/adapters/claude_code.py — Claude Code CLI adapter (FIRST CLASS).…, runtimes/adapters/docker_agent.py — Docker-based agent runtime adapter. Spawns… (+61 more)
...
Cohesion: 0.04
Nodes (69): AgentDirective, Agent subsystem — planner / executor / verifier loop., AgentEvent, AgentPlan, AgentSession, AgentSessionMessage, AgentStep, Any (+61 more)

### Community 19 - "TaskHarnessAdapter"
Cohesion: 0.04
Nodes (40): AiderAdapter, Any, Adapter for Aider — TIER 3 specialized git-aware code editor., GooseAdapter, Any, Adapter for Goose — TIER 2 general-purpose local runtime., OpenHandsAdapter, Any (+32 more)
...
### Community 21 - "workflow_orchestrator.py"
Cohesion: 0.05
Nodes (83): CoordinateRequestV2, CoordinateResponse, BaseModel, agent/coordinate.py — Multi-Agent Coordination models, helpers, and optional…, Extended coordinate request supporting both agents+tasks and legacy workers., SwarmSummary, AgentSpec, CoordinatorResult (+75 more)

### Community 22 - "MongoDBStore"
Cohesion: 0.04
Nodes (54): MongoDBStore, Any, Company, ObjectId, Prepare a Pydantic model for SQLite storage., Prepare a SQLite row for Pydantic model., Create a new company in SQLite., Get a company by ID from SQLite. (+46 more)

### Community 23 - "FreeBuffAgent"
Cohesion: 0.11
Nodes (90): BackgroundTask, BrowserSession, Async Playwright browser session. Usage:: session = BrowserSession() await…, True if Playwright is installed and ready to use., CommitAttribution, CommitTracker, Path, agent/commit_tracker.py — AI Commit Attribution Tags git commits with metadata… (+82 more)

### Community 24 - "test_operational_incidents.py"
Cohesion: 0.03
Nodes (92): _diagnose_and_file(), _file_incident(), _format_incident(), gather_render_evidence(), get_operational_incident_tracker(), _iso_from_monotonic(), normalise(), _now() (+84 more)
...
### Community 32 - "test_telegram_approval_gate.py"
Cohesion: 0.03
Nodes (54): Any, Path, Start the Telegram bot. Returns True if started successfully., Signal the bot to stop and wait for graceful shutdown., Run the Telegram bot long-poll loop (inline, not subprocess)., Run the bot with stop-event awareness., Callback for BackgroundAgent.on_task_complete. Dispatches task result…, Send notification to configured Telegram chat IDs. (+46 more)

### Community 33 - "services/background.py"
Cohesion: 0.04
Nodes (81): get_agency(), set_agency(), _autonomy_bg_cycle(), autonomy_status(), autonomy_tick(), Background CEO cycle + task dispatch. Runs fire-and-forget., Public autonomy readiness probe — no authentication required. A live deploy…, Execute ONE pending task synchronously. Called by the cron workflow every 2… (+73 more)

### Community 34 - "SelfHealingAgent"
Cohesion: 0.04
Nodes (57): heal_signature(), HealingEvent, HealState, _now(), Any, Enum, str, agent/self_healing.py — Self-Healing Agent (closed-loop, Autonomy Charter G2)… (+49 more)
...
Cohesion: 0.05
Nodes (66): E2BSandboxSession, _inject_token(), maybe_attach_e2b(), Kill the sandbox. Idempotent; never raises (best-effort cleanup)., Seed the sandbox from a host worktree by packing tracked files. Creates a tar…, Extract changed files from the sandbox back to the host worktree. After the…, Best-effort scrub of ``token`` from ``text``., Open an E2B session and attach it as ``runner._mcp``. Single wiring line for… (+58 more)

### Community 37 - "test_user_research_skill.py"
Cohesion: 0.06
Nodes (47): analyze_quantitative(), auto_register(), _classify_sentiment(), _extract_keywords(), plan_research(), Any, BaseModel, field_validator (+39 more)

### Community 38 - "SecretRecord"
Cohesion: 0.06
Nodes (60): str, UserRole, _can_read(), _can_write(), create_secret(), _decrypt(), delete_secret(), _encrypt() (+52 more)

### Community 39 - "test_ceo_supervision.py"
Cohesion: 0.06
Nodes (75): CEODispatcher, CEOResult, _harvest_changed_files(), Extract the files a runtime touched. Returns ``(files, reported)``. Adapters…, Aggregated output from a multi-specialist execution., Real CEO delegation: wake runtimes, fan out, and merge results., Attempt, One delegation of one subtask to one tier. (+67 more)

### Community 40 - "get_improvement_loop"
Cohesion: 0.05
...
### Community 41 - "failover_chat_completion"
Cohesion: 0.06
...
### Community 42 - "get_company_access"
Cohesion: 0.04
Nodes (79): account_lifecycle(), auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint(), generate_onboarding_questions(), get_company(), get_company_access() (+71 more)

### Community 43 - "skill_bindings.py"
Cohesion: 0.04
Nodes (54): Status of a user story within a sprint., StoryStatus, HarnessAdapter, HarnessSpec, Any, agents/harness_adapter.py — ECC Cross-Harness Adapter Normalises API…, Adapt harness-native requests to the local-llm-server internal format. Each…, Detect which harness sent this request from headers. Check order: explicit… (+46 more)
...
Cohesion: 0.04
Nodes (67): auth_headers(), livekit_env(), no_livekit_env(), _normalize_dockerfile(), fixture, parametrize, tests/test_sam_livekit.py — SAM realtime voice (LiveKit) integration. Covers: -…, Empty key/secret/identity/room must raise ValueError. (+59 more)
...
### Community 49 - "test_response_cache.py"
Cohesion: 0.06
Nodes (74): _cache_key(), cache_stats(), clear_cache(), get_cached(), is_cacheable(), put_cached(), Any, packages/ai/response_cache.py — LRU+TTL in-memory response cache for the… (+66 more)

### Community 50 - "get_runtime_manager"
Cohesion: 0.05
Nodes (57): _apply_activity_status(), create_agent(), delete_agent(), get_agent(), _get_user(), list_agents(), list_runtime_agents(), Any (+49 more)

### Community 51 - "RenderOpsMonitor"
Cohesion: 0.06
Nodes (26): One deploy, normalised from whatever shape the tool returned., Typed facade over the Render MCP server's tools. Every method returns plain…, True when there is both an API key and an endpoint to reach., Return the most recent deploy, or ``None`` when there are none., RenderDeploy, RenderMCPClient, Polls Render for platform-level failures and files them as issues., RenderOpsMonitor (+18 more)
...
### Community 53 - "runtimes/api.py"
Cohesion: 0.05
Nodes (68): _enrich_runtimes(), get_decision_log(), get_policy(), list_runtimes(), _load_rich_policy(), PolicyUpdateBody, Any, BaseModel (+60 more)

### Community 54 - "fmtErr"
Cohesion: 0.06
Nodes (49): fmtErr(), getActivity(), getCostAttribution(), getDecisionLog(), getDueSoonTasks(), getSavings(), getStats(), getUsage() (+41 more)

### Community 55 - "detector.py"
Cohesion: 0.07
...
Cohesion: 0.07
Nodes (63): Any, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, Translate technical preflight issues into a conversational assistant reply., translate_error_to_conversational(), ResumeRequest, AcceptedJob, AgentJobEnvelope, CompletedJob (+55 more)
...
Cohesion: 0.05
Nodes (65): openclaw_websocket(), websocket, WebSocket endpoint for iOS / mobile web UI pairing + command routing., get_failover_manager(), Return the singleton BrainFailoverManager., Reset the singleton (for tests)., reset_failover_manager(), _cmd_chat() (+57 more)

### Community 65 - "TokenBudget"
Cohesion: 0.05
...
### Community 68 - "AutonomyTracker"
Cohesion: 0.05
Nodes (34): AutonomyCounter, AutonomySnapshot, AutonomyTracker, get_tracker(), Any, agent/kpi.py — Autonomy KPIs: evidence capture and metrics tracking. Tracks key…, Return a point-in-time snapshot of all KPIs., Reset all counters (test helper). (+26 more)

### Community 69 - "resolve_e2b_config"
Cohesion: 0.05
...
### Community 70 - "ToolRegistry"
Cohesion: 0.06
Nodes (32): get_tool_registry(), _infer_parameters_from_func(), Any, Register a tool definition., Decorator to register a function as an agent tool. Usage::…, Remove a tool from the registry. Returns True if removed., Look up a tool by name., Return all registered tools. (+24 more)

### Community 71 - "ProceduralMemoryStore"
Cohesion: 0.05
Nodes (27): get_procedural_memory(), _overlap_score(), ProceduralMemoryStore, ProceduralRecord, Any, agent/procedural_memory.py — Skill/Procedural Memory for the agent loop (★4).…, Store a successful step pattern and return its record id. Duplicate step…, Return up to *limit* stored patterns relevant to *query*. Relevance is scored… (+19 more)
...
### Community 74 - "sync/service.py"
Cohesion: 0.07
Nodes (45): sync/ — Syncthing-style workspace synchronisation service., add_peer(), get_folder_index(), get_sync_file(), get_sync_service(), list_conflicts(), list_peers(), PeerCreateRequest (+37 more)

### Community 75 - "KeyStore"
Cohesion: 0.06
...
### Community 76 - "test_integration_c4_c5_c6_d3.py"
Cohesion: 0.05
Nodes (40): FailureCategory, E2: Classify a failure from its description text. Order matters:…, Classified failure types for targeted self-healing (E2)., get_current_trace_id(), get_tracer(), langfuse_metadata_with_trace(), _NoOpSpan, _NoOpTracer (+32 more)

### Community 77 - "AgileSprint"
Cohesion: 0.05
Nodes (28): plan_next_sprint(), The result of allocating portfolio capacity into a new sprint., Allocate ``capacity`` of WSJF-ranked initiatives into a new sprint. Creates one…, SprintPlan, AgileSprint, An agile sprint containing user stories., Add a user story to the sprint., Remove a user story from the sprint. (+20 more)

### Community 78 - "Troubleshooting"
Cohesion: 0.03
...
### Community 80 - "MCPClient"
Cohesion: 0.05
Nodes (28): MCPClient, Any, RuntimeError, Prefer structured data; fall back to text when unavailable., Thin async MCP client with open/close circuit breaker. Thread-safe only within…, Full URL of the JSON-RPC endpoint this client posts to., Build the request headers shared by ``_rpc`` and ``notify``. ``Accept`` lists…, Remember a server-issued ``Mcp-Session-Id`` for subsequent requests. (+20 more)

### Community 81 - "RenderFinding"
Cohesion: 0.05
Nodes (44): build_render_router(), Any, APIRouter, Exception, backend/render_router.py — Render platform view for operators and agents.…, Reject anyone who is not the agency admin., Map an MCP transport failure onto 503 rather than a 500. The distinction…, _require_admin() (+36 more)

### Community 82 - "ChatPage.js"
Cohesion: 0.06
...
### Community 90 - "StreamingDeltaReconstructor"
Cohesion: 0.06
...
Cohesion: 0.06
Nodes (22): AdaptiveHalter, Any, ★7 Adaptive Loop Halting — velocity-based agent run termination. Complements…, Return current halter state for logging / telemetry., Tracks step-level progress and signals when a run should halt early. The halter…, Ratio of applied steps to steps attempted (0.0–1.0). Returns 1.0 when no steps…, Record one step outcome; return a halt reason or None to continue. ``status``…, MCPToolResult (+14 more)

### Community 93 - "test_brain_failover.py"
Cohesion: 0.05
Nodes (46): BrainFailoverManager, Any, Permit one probe call without claiming the provider succeeded. This is the…, Seconds until the soonest cooling provider is probeable again. ``None`` when no…, True when a provider's cooldown window is wider than any it could legitimately…, Record a provider failure — opens the circuit breaker on threshold., Maximum number of provider attempts before giving up., Return a full health snapshot for observability. (+38 more)

### Community 94 - "run_tests"
Cohesion: 0.07
...
Cohesion: 0.06
Nodes (56): _apply_env_overrides(), _apply_key_env(), _build(), _coerce(), config_dir(), _env_key_names(), expand_env(), _fields_of() (+48 more)

### Community 97 - "E2BAdapter"
Cohesion: 0.06
...
### Community 99 - "test_sqlite_store.py"
Cohesion: 0.06
...
### Community 100 - "services/seo_audit.py"
Cohesion: 0.08
...
### Community 101 - "test_context_rulebook.py"
Cohesion: 0.06
...
### Community 104 - "TestBrainFailoverModelUpdates"
Cohesion: 0.06
...
### Community 105 - "WebReach"
Cohesion: 0.08
Nodes (43): get_web_reach(), _load_script_module(), Any, ModuleType, Response, agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Zero-key internet access: pages, YouTube transcripts, search, RSS. Every public…, Read a web page as plain text, following the same fallback chain (direct ->… (+35 more)

### Community 106 - "Command"
Cohesion: 0.06
...
### Community 107 - "ProvidersScreen.jsx"
Cohesion: 0.05
...
### Community 109 - "test_backend_server_features.py"
Cohesion: 0.06
...
### Community 112 - "TrafficDirector"
Cohesion: 0.08
Nodes (20): In-process traffic distribution and budget accounting for providers., Count a request that is about to be sent to *provider_id*. Called immediately…, Record the outcome of a request started with ``record_start``. Must be called…, Count a request that was routed away from *provider_id* (diagnostics)., EWMA latency in ms; never-sampled providers sort first. Returning -1.0 for an…, Clear all counters (tests only)., TrafficDirector, _ids() (+12 more)
...
### Community 115 - "test_trend_scoping.py"
Cohesion: 0.09
...
### Community 119 - "ChatHistoryStore"
Cohesion: 0.07
...
### Community 122 - "test_ceo_router.py"
Cohesion: 0.07
Nodes (47): build_ceo_router(), Any, APIRouter, backend/ceo_router.py — observability and manual control for the CEO. Surfaces…, Reject non-admin callers for routes that spend provider budget. Delegates to…, _require_admin(), _env_flag(), _env_int() (+39 more)

### Community 123 - "ceo_dispatcher.py"
Cohesion: 0.06
Nodes (38): _complexity_rank(), _decompose_into_subtasks(), _offload(), Any, Semaphore, services/ceo_dispatcher.py — Real CEO delegation layer. The CEO splits a…, Run a synchronous ledger call without blocking the event loop. ``CEOLedger`` is…, Build an agent.coordinator.TaskSpec from a CEO SpecialistTask. (+30 more)

### Community 124 - "._get_connection"
Cohesion: 0.04
Nodes (24): Delete a company and all its associated data., Delete a company and all associated data from SQLite., Count total companies in SQLite., Count total companies in the store., Delete a website from SQLite., Create a new repository in SQLite., Get a repository by ID from SQLite., Update a repository in SQLite. (+16 more)

### Community 125 - "TaskIn"
Cohesion: 0.06
Nodes (35): _check_auth(), health(), Any, BaseModel, get, post, services/hermes_server.py — the agency's OWN Hermes runtime server. This is…, Execute a task synchronously via the InternalAgentAdapter (our brain). Response… (+27 more)

### Community 126 - "_ts_to_float"
Cohesion: 0.06
...
### Community 127 - "test_telegram_freebuff.py"
Cohesion: 0.07
...
### Community 129 - "FeatureMatrix"
Cohesion: 0.07
Nodes (11): FeatureMatrix, Central support matrix — single source of truth. Loads the canonical feature…, tests/test_feature_matrix.py — Feature maturity / support matrix tests. Covers:…, Integration test: admin endpoint returns feature matrix JSON., TestAdminVisibility, TestConfigOverrides, TestEnforcement, TestRegistryLoads (+3 more)

### Community 130 - "persist_plan_spec"
Cohesion: 0.07
...
### Community 132 - "TaskDispatcher"
Cohesion: 0.06
Nodes (35): _env_flag(), Read a boolean env var. Accepts 'true'/'1'/'yes' (case-insensitive)., Re-queue BLOCKED tasks that have cooled down and are ready for retry., Polls for queued task work and executes it through the coordinator. Crash…, Re-queue tasks stranded by a prior crash or hard-kill., TaskDispatcher, Dispatcher should track first_seen times for pending tasks., Executing a task removes it from _first_seen and logs pickup time. Uses async… (+27 more)

### Community 133 - "test_model_catalog.py"
Cohesion: 0.07
Nodes (48): _build_candidates_from_yaml(), get_provider_candidates(), get_provider_display_name(), get_provider_tier(), _load_models_yaml(), Extract the per-provider ``candidates`` failover list from the YAML., Return the ordered failover candidate list for *provider*. The first element is…, Return the human-readable label for *provider* (fallback: the id). (+40 more)

### Community 134 - "TestPayloadNormalisation"
Cohesion: 0.06
...
### Community 139 - "settings.py"
Cohesion: 0.07
Nodes (38): Weighted Shortest Job First score — higher schedules sooner., packages.config — single source of truth for all configuration. Every module…, packages/config/settings.py — typed configuration. This is the ONLY module in…, map_initiative_to_task(), materialize_committed(), _portfolio_materialize_enabled(), portfolio_source_id(), Any (+30 more)

### Community 140 - "test_slop_gate.py"
Cohesion: 0.07
...
### Community 141 - "test_e2b_task_wiring.py"
Cohesion: 0.08
...
### Community 142 - "validate_outbound_url"
Cohesion: 0.08
...
### Community 145 - "OllamaCircuitBreaker"
Cohesion: 0.08
...
### Community 149 - "PromptCacheManager"
Cohesion: 0.06
...
### Community 151 - "test_quick_note.py"
Cohesion: 0.08
...
### Community 155 - "test_startup_warmup.py"
Cohesion: 0.06
Nodes (41): Await one warm-up step, deferring it to the background if it overruns.…, The task store the background services should use, wiring it if needed.…, _task_store_for_background(), _warmup_step(), _isolate_warmup_overflow(), asyncio, fixture, NoReturn (+33 more)

### Community 156 - "test_features_api.py"
Cohesion: 0.05
Nodes (5): _auth_override(), client(), _fake_auth(), fixture, Integration tests for all new feature API routes in proxy.py.

### Community 157 - "test_video_transcript.py"
Cohesion: 0.05
...
### Community 161 - "RuntimeManager"
Cohesion: 0.05
Nodes (26): RoutingDecision, _build_default_manager(), Any, TaskResult, TaskSpec, Return health status for all registered runtimes., Return routing decision audit log (newest first)., Actively wake every sleeping/circuit-open runtime. The default health service… (+18 more)

### Community 162 - "Task"
Cohesion: 0.07
Nodes (19): _brain_is_configured(), _is_brain_connection_error(), Any, BaseException, Task, TaskResult, TaskSpec, TaskStatus (+11 more)

### Community 163 - "test_e2b_data_flow.py"
Cohesion: 0.08
...
### Community 165 - "Part A — CodeRabbit review fixes for this PR (do first, small)"
Cohesion: 0.05
...
### Community 166 - "Docker Agent Runtimes Setup"
Cohesion: 0.05
...
### Community 170 - "Persistent Memory System"
Cohesion: 0.05
...
### Community 172 - "NIMConnectionPool"
Cohesion: 0.07
...
### Community 173 - "SkillBindings"
Cohesion: 0.07
Nodes (30): Any, Live Graphify executor — queries the codebase knowledge graph. Order of…, Live council reviewer — deterministic, rules-based multi-perspective review…, Set the singleton SkillBindings instance (for testing)., Central registry that maps skills to specialist families and provides runtime…, List all registered skills., List skills relevant to a specialist family., Search skills by name, description, or keywords. (+22 more)
...
### Community 175 - "test_unit8_model_catalog.py"
Cohesion: 0.05
Nodes (39): tests/test_unit8_model_catalog.py — UNIT 8 regression tests. Verifies that: 1.…, Setting FREELLM_API_MODEL_CATALOG_ENABLED=true enables the flag., The flag value is lowercased so 'TRUE' / 'True' also enable., Any value other than 'true' (case-insensitive) is treated as False., ``key_present`` is True when the env var is set., ``key_present`` is False when the env var is not set., Ollama is local — ``key_present`` is always True., When the brain config cache is cold, active_brain is empty. (+31 more)

### Community 176 - "AGENTS.md — Source of Truth for All AI Agents"
Cohesion: 0.05
...
### Community 177 - "anthropic_compat.py"
Cohesion: 0.09
...
Cohesion: 0.06
Nodes (27): _FakeMongoStore, _FakePersistence, _FakeSQLiteStore, asyncio, parametrize, Workstream D — Never again: dedup + growth invariants. These tests enforce…, Simulates a Mongo-style store with find/aggregate/replace_one., Simulates a SQLite-style store with load_all/upsert/remove. (+19 more)

### Community 181 - "OrchestratorSupervisor"
Cohesion: 0.09
...
### Community 182 - "TestEstimateTokensForMessages"
Cohesion: 0.06
...
### Community 183 - "test_llm_router_disabled.py"
Cohesion: 0.09
Nodes (38): auto_disable(), _billing_signals(), describe(), disabled_provider_ids(), is_unfixable(), packages/llm/disabled.py — bridge to the durable provider on/off switch. The…, Provider ids currently switched off. Empty when the store is unreachable., Persist a provider as disabled, through the store that already owns it. (+30 more)

### Community 184 - "distributed.py"
Cohesion: 0.08
...
### Community 188 - "test_workspace_isolation.py"
Cohesion: 0.19
...
### Community 193 - "test_portfolio_intelligence.py"
Cohesion: 0.06
...
### Community 195 - "AgentJobResult"
Cohesion: 0.10
Nodes (15): AgentJobError, AgentJobResult, Any, field_validator, agent/contract.py — Typed public contract for the agent job lifecycle. Phase 1…, Structured error payload attached to a failed job., Typed result returned by a completed agent job. The ``response`` field is the…, Accept a bare string (legacy runner output) or a full dict. (+7 more)

### Community 196 - "IssueCategory"
Cohesion: 0.11
Nodes (35): IssueCategory, IssueSeverity, Enum, str, agent/improvement_loop.py — Continuous Improvement Engine Background scanner…, cluster_friction(), clusters_to_issues(), collect_friction_events() (+27 more)

### Community 197 - "test_verification_strategies.py"
Cohesion: 0.11
...
### Community 199 - "ServiceDaemon"
Cohesion: 0.09
Nodes (26): configure(), get_status(), health(), BaseModel, get, post, Validate configured paths., Check if proxy is running. (+18 more)

### Community 200 - "test_brain_availability_doctor.py"
Cohesion: 0.10
Nodes (35): brain_availability_summary(), Non-secret answer to "can the brain answer a request right now?". Three callers…, Drop the singleton (test helper)., reset_ceo_ledger(), _doctor(), _P, _patch_providers(), asyncio (+27 more)

### Community 201 - "GoalRecord"
Cohesion: 0.10
Nodes (19): _backend(), CEOLedger, GoalRecord, _now(), Any, services/ceo_ledger.py — durable record of what the CEO is driving to closure.…, One piece of work the CEO has taken ownership of. ``state`` is the supervisor's…, Return ``(done, total)`` subtask counts. (+11 more)

### Community 202 - "test_trend_watcher.py"
Cohesion: 0.09
...
### Community 203 - "Settings"
Cohesion: 0.06
Nodes (18): _env_int(), _get_settings(), Read an int env var, falling back to *default* on a missing/bad value. Never…, ``RENDER_SERVICE_IDS`` split into a clean list (empty when unset)., True when there is both an API key and an endpoint to reach., When True, the Render ops loop runs. On by default. Also requires…, When True, mutating Render MCP tools may be called. Default False., Validated `reasoning_effort` for Ollama thinking models, or ``""``. Returns one… (+10 more)

### Community 204 - "ScheduledJob"
Cohesion: 0.10
Nodes (18): _now(), Any, Reconstruct a ScheduledJob from its as_dict() output., Register a new job. Returns the created :class:`ScheduledJob`.…, Fire a job immediately (webhook / manual trigger)., Update the display name of a job., Enable or disable a job without deleting it., Capture the FastAPI main event loop so APScheduler's background thread can… (+10 more)

### Community 205 - "_Collection"
Cohesion: 0.11
...
### Community 206 - "test_persistent_memory.py"
Cohesion: 0.06
...
### Community 209 - "ProjectScaffolder"
Cohesion: 0.10
...
### Community 214 - "test_background_services.py"
Cohesion: 0.08
...
### Community 216 - "test_all_providers_discovery.py"
Cohesion: 0.16
...
### Community 217 - "test_control_plane_api.py"
Cohesion: 0.07
...
### Community 218 - "test_llm_router_e2e.py"
Cohesion: 0.14
...
Cohesion: 0.08
Nodes (28): free_nvidia_models(), _nvidia_api_key(), Return the curated list of free NVIDIA NIM models FreeBuff may use., List the free NVIDIA NIM models a user may pick (e.g. via Telegram)., True when *model* is in the curated free NVIDIA NIM set., Coerce *requested* to a free NVIDIA model. Returns *requested* when it is…, is_rate_limit_exempt(), True when this key is on the FreeBuff rate-limit exemption allowlist. Only… (+20 more)

### Community 221 - "test_render_mcp.py"
Cohesion: 0.10
Nodes (21): get_mcp_client(), agent/mcp_client.py — Async MCP client for the mcp-server Docker container.…, Return the module-level MCPClient. Reads MCP_SERVER_BASE_URL at call time (not…, RuntimeError, packages/integrations/render_mcp.py — Render platform access over MCP. The…, Drop the cached singleton. Used by tests and after a config change., Raised when a mutating Render tool is called with writes disabled., RenderWriteBlockedError (+13 more)

### Community 222 - "test_daily_2026_06_04.py"
Cohesion: 0.09
...
### Community 225 - "test_anthropic_router.py"
Cohesion: 0.09
...
### Community 226 - "TaskInput"
Cohesion: 0.13
Nodes (29): AgentConfig, build_agent_specs(), build_swarm(), build_task_specs(), coordinate_v2(), Any, post, TaskSpec (+21 more)

### Community 227 - "RepowiseIntelligence"
Cohesion: 0.09
Nodes (25): Path, Build git intelligence: hotspots, ownership, co-change pairs., Compute cyclomatic complexity for Python files. Returns 0 for non-Python files…, Returns a structural overview of the repository., Workhorse tool for packing content and metrics of target files., Get dependencies from our built intelligence., RepowiseIntelligence, Test that search_codebase returns a string. (+17 more)

### Community 228 - "agent_runtime.py"
Cohesion: 0.11
...
### Community 229 - "ENGINEERING_STANDARDS.md — Coding, Security & Testing Standards"
Cohesion: 0.06
...
### Community 232 - "local_controller.py"
Cohesion: 0.12
...
### Community 233 - "test_live_server.py"
Cohesion: 0.22
...
### Community 234 - "test_colibri_brain_shim.py"
Cohesion: 0.07
Nodes (33): clean_env(), fixture, parametrize, Regression test for the colibri env-shim in brain_policy.resolve_active_brain.…, `rstrip('/')` + re-append `/v1` must be idempotent across URL variants., Default to glm-5.2 when COLIBRI_MODEL/AGENT_LLM_MODEL both unset., AGENT_LLM_MODEL override wins when COLIBRI_MODEL is unset., BRAIN_PREFERENCE=colibri without COLIBRI_URL must log a loud warning. (+25 more)

### Community 235 - "ContextCompressor"
Cohesion: 0.11
...
### Community 238 - "ResourceWatchdog"
Cohesion: 0.10
...
### Community 239 - "WorkspaceManager"
Cohesion: 0.12
Nodes (24): _get_workspace_lock(), get_workspace_manager(), _hash_component(), _iso_now(), _load_workspace(), _parse_iso(), BaseModel, Path (+16 more)
...
### Community 243 - "OrchestratorQueue"
Cohesion: 0.07
...
### Community 244 - "test_microagents.py"
Cohesion: 0.15
...
### Community 245 - "Security Analysis — local-llm-server"
Cohesion: 0.06
...
### Community 246 - "Langfuse Observability Guide"
Cohesion: 0.06
...
### Community 248 - "test_failover_silent_exhaustion.py"
Cohesion: 0.10
...
### Community 250 - "AnthropicProvider"
Cohesion: 0.12
...
### Community 253 - "test_purge_backlog.py"
Cohesion: 0.09
...
### Community 256 - "High-Agency Frontend Skill"
Cohesion: 0.06
Nodes (30): 10. FINAL PRE-FLIGHT CHECK, 1. ACTIVE BASELINE CONFIGURATION, 2. DEFAULT ARCHITECTURE & CONVENTIONS, 3. DESIGN ENGINEERING DIRECTIVES (Bias Correction), 4. CREATIVE PROACTIVITY (Anti-Slop Implementation), 5. PERFORMANCE GUARDRAILS, 6. TECHNICAL REFERENCE (Dial Definitions), 7. AI TELLS (Forbidden Patterns) (+22 more)

### Community 257 - "Quick-Note GitHub Issues Processing - Session Summary"
Cohesion: 0.06
...
### Community 260 - "resolve_active_brain"
Cohesion: 0.10
Nodes (30): BrainResolution, get_active_brain_sync(), get_brain_preference(), get_provider_role_tags(), _host_is_openai_compatible(), invalidate_brain_cache(), _norm(), _pick_from_records() (+22 more)
...
### Community 262 - "RateLimitTracker"
Cohesion: 0.11
...
### Community 263 - "analyze_page"
Cohesion: 0.12
Nodes (13): analyze_page(), _host_key(), is_internal(), BeautifulSoup, Host normalized for internal/external comparison (www. stripped)., True when ``url`` belongs to the same site as ``root`` (www-insensitive)., Run every page-scoped check against one HTML document (no network). Returns a…, _visible_text() (+5 more)

### Community 264 - "TestRecordUsageAndStats"
Cohesion: 0.06
...
### Community 265 - "test_sam_voice.py"
Cohesion: 0.07
...
### Community 266 - "tests/test_browser.py"
Cohesion: 0.10
...
### Community 268 - "ModelCatalogStore"
Cohesion: 0.11
Nodes (18): CatalogActiveBrain, CatalogMirror, CatalogProviderEntry, ModelCatalogStore, Any, BaseModel, One provider's catalog entry in the mirrored document., Snapshot of the active brain config at mirror time. (+10 more)

### Community 269 - "test_colibri_provider.py"
Cohesion: 0.12
...
### Community 270 - "RuntimeHealthService"
Cohesion: 0.09
...
### Community 273 - "MCPUnavailableError"
Cohesion: 0.15
...
### Community 275 - ".update_intelligence"
Cohesion: 0.08
...
### Community 276 - "api_keys_for"
Cohesion: 0.09
Nodes (16): provider_api_keys(), Every API key configured for *provider*, primary first. Reads ``base_env`` then…, api_keys_for(), Clear pool state (tests only)., All keys configured for *provider_id*, primary first. Thin delegate to…, reset(), _clean_pool(), fixture (+8 more)

### Community 277 - "test_pr923_fixes.py"
Cohesion: 0.09
...
### Community 279 - "test_claude_setup_audit.py"
Cohesion: 0.16
...
### Community 280 - "test_brain_config_api.py"
Cohesion: 0.08
...
### Community 281 - "CEOSupervisor"
Cohesion: 0.12
Nodes (14): CEOSupervisor, Any, Sweeps the CEO ledger and drives open goals to closure., Sweep on the configured cadence until cancelled. A failing sweep is logged and…, Inter-sweep delay, behind a method so tests can shorten it. Patching…, True when this process already has a re-drive in flight for *goal_id*., Start a re-drive of *goal*, honouring the intervention budget. Returns…, Status for the health endpoint and dashboard. (+6 more)

### Community 282 - "test_crispy_burn_in.py"
Cohesion: 0.07
...
### Community 283 - "test_internal_agent_did_work.py"
Cohesion: 0.12
...
### Community 284 - "test_provider_enable_disable.py"
Cohesion: 0.09
...
### Community 285 - "test_skill_registry_boot_refresh.py"
Cohesion: 0.12
...
### Community 291 - "SetupWizardPage.js"
Cohesion: 0.10
...
### Community 292 - "test_agent_free_brain.py"
Cohesion: 0.08
Nodes (20): allow_paid_brain(), is_anthropic_model(), True only when the operator explicitly opted into a paid (Anthropic) brain.…, True when *model* names a paid Anthropic/Bedrock-Claude model. Covers native…, _FakeAsyncClient, _FakeResponse, _free_env(), fixture (+12 more)

### Community 293 - "all_provider_ids"
Cohesion: 0.08
Nodes (22): all_provider_ids(), _provider_ids_from_literal(), Return every provider id recognised by the brain config system. Iterates the…, Return the provider ids allowed by the ``BrainProvider`` Literal. Reads the…, test_all_provider_ids_returns_literal_args(), tests/test_unit5_ui_provider_surface.py — UNIT 5 regression tests. Verifies…, The component must call ``providerLabel(p)`` rather than indexing a 4-entry…, The dropdown shows a [free]/[paid]/[local] tier tag so the operator can tell… (+14 more)

### Community 294 - "brain_failover.py"
Cohesion: 0.11
...
### Community 295 - "_get"
Cohesion: 0.09
Nodes (14): Drop the cached Mongo client, backoff, and read caches (tests)., reset_kv_state(), _get(), one_configured_provider(), fixture, Contract tests for the provider on/off endpoints. ``GET /api/brain/providers``…, Silently storing a typo'd id would leave a switch nothing can turn back on., The operator has to know WHY before deciding to switch it back on. The raw… (+6 more)

### Community 296 - "CostAttributor"
Cohesion: 0.10
...
### Community 297 - "isolated_telegram_config"
Cohesion: 0.11
...
### Community 298 - "test_brain_resolver.py"
Cohesion: 0.13
Nodes (27): fixture, tests/test_brain_resolver.py — Tests for the single brain resolver. The agency…, When a free provider (NVIDIA NIM) is configured, the brain must NOT auto-pick…, When only a paid record exists AND ALLOW_PAID_BRAIN is set, the brain picks the…, When a base_url is excluded (transient retry failure), the next-best free…, When provider records are missing AND ``NVIDIA_API_KEY`` is set, resolve to the…, When nothing is configured AND NVIDIA_API_KEY unset, fall through to local…, Operators must see provider-reorder edits immediately. invalidate_cache (called… (+19 more)

### Community 299 - "test_scheduler_hydration_bounded.py"
Cohesion: 0.09
Nodes (21): _BrokenScheduler, _fake_schedule_store(), _FakeStore, _FastScheduler, _HangingScheduler, _isolate_warmup_overflow(), asyncio, fixture (+13 more)

### Community 300 - "TestSchedulerStore"
Cohesion: 0.07
...
### Community 301 - "analyze_qualitative"
Cohesion: 0.12
...
### Community 303 - "Deploy: FreeBuff Telegram bot (24×7)"
Cohesion: 0.07
...
### Community 304 - "Claude Code + Qwen Local Setup"
Cohesion: 0.07
...
### Community 305 - "generate_context.py"
Cohesion: 0.12
...
### Community 306 - "test_chat_mode_regressions.py"
Cohesion: 0.13
...
### Community 308 - "test_freebuff_bot.py"
Cohesion: 0.09
...
### Community 309 - "_FakePersistence"
Cohesion: 0.13
...
### Community 312 - "telegram_service.py"
Cohesion: 0.12
...
### Community 313 - "test_phase6_workflow.py"
Cohesion: 0.16
...
### Community 323 - "test_telegram_approval_e2e.py"
Cohesion: 0.12
...
### Community 324 - "test_service_token.py"
Cohesion: 0.08
...
### Community 330 - "WorkspaceError"
Cohesion: 0.09
Nodes (11): Any, Exception, Lock, Open a workspace for resumption. Only READY or PAUSED workspaces may be…, Raise :exc:`WorkspaceAccessDeniedError` if *requesting_session_id* doesn't own…, Acquire the exclusive async lock for *ws*. Raises :exc:`WorkspaceLockError` if…, Base class for all workspace errors., WorkspaceAccessDeniedError (+3 more)

### Community 331 - "dependencies"
Cohesion: 0.08
Nodes (25): axios, fast-uri, dependencies, axios, fast-uri, livekit-client, lucide-react, react (+17 more)

### Community 332 - "reset_store"
Cohesion: 0.11
...
### Community 333 - "Configuration Reference"
Cohesion: 0.08
Nodes (25): Agent Models, Anthropic API Compatibility / Claude Code, Authentication and Keys, Claude Code setup, Configuration Reference, Dashboard (React UI on :3000, API on :8001), Feature Flags, Feature Maturity Overrides (+17 more)

### Community 334 - "Session Handoff — 2026-06-15"
Cohesion: 0.08
...
### Community 335 - "TASK 4 — End-to-end approval-gate test"
Cohesion: 0.08
...
### Community 336 - "get_feature_matrix"
Cohesion: 0.13
Nodes (15): __init__.py — Feature flag/matrix package., get_feature_matrix(), Enum, features/matrix.py — Feature maturity tiers and support matrix. Single source…, Return the global FeatureMatrix singleton., Reset the singleton (useful for testing)., reset_feature_matrix(), multi_agent_swarm is BETA + enabled (was DISABLED pre-fix). The CEO dispatcher… (+7 more)

### Community 337 - "Any"
Cohesion: 0.15
Nodes (3): Any, field_validator, Coerce unrecognised system_type values to 'custom' so the model never crashes…

### Community 338 - "ClaudeCodeAdapter"
Cohesion: 0.15
...
### Community 340 - "TemporalContextGraph"
Cohesion: 0.12
...
### Community 341 - "test_agency_fix.py"
Cohesion: 0.08
...
### Community 342 - "test_daily_automation_2026_08_03.py"
Cohesion: 0.11
...
### Community 343 - "TestClassifyPlainText"
Cohesion: 0.08
...
### Community 344 - "TestStreamableHTTPTransport"
Cohesion: 0.13
...
### Community 346 - "Local AI Stack with Docker"
Cohesion: 0.08
...
### Community 347 - "Implementation Prompt: Rich TaskBoard + Agile Sprint Integration"
Cohesion: 0.08
...
### Community 348 - "Telegram Bot Setup"
Cohesion: 0.08
...
### Community 349 - "video_transcript.py"
Cohesion: 0.12
...
### Community 351 - "model_discovery.py"
Cohesion: 0.11
Nodes (21): cached_models(), discover_models(), _fresh_entry(), _models_url(), _parse_ids(), Any, Ask a provider which models the configured API key may actually use.…, Return the cached list for *provider_id* without any network call. The… (+13 more)

### Community 352 - "admin.py"
Cohesion: 0.12
...
### Community 354 - "seo_report_pdf.py"
Cohesion: 0.24
...
### Community 357 - "test_output_filter.py"
Cohesion: 0.08
...
### Community 359 - "test_workspace_security.py"
Cohesion: 0.10
...
### Community 360 - "The fifteen strategies"
Cohesion: 0.09
...
### Community 364 - "RuntimeRoutingPolicyEngine"
Cohesion: 0.13
Nodes (12): Any, TaskResult, TaskSpec, Routes a TaskSpec to the best available runtime following the configured…, Selects a runtime for the given task, executes the task (including readiness…, Selects an available runtime for the given task type, preferring a specified…, Execute the given task spec on the primary runtime, attempt configured fallback…, Attempt paid escalation through ProviderManager. Routes the task to the first… (+4 more)

### Community 365 - "WindowsServiceManager"
Cohesion: 0.18
...
### Community 370 - "test_mostly_failed_steps.py"
Cohesion: 0.12
...
Cohesion: 0.09
Nodes (13): tests/test_north_mini_code.py — North Mini Code 1.0 integration. Covers the…, The switch defaults ON so North is the default post-install., The agency/Hermes execution path defaults to North via the resolver., Hermes must be able to run the agency with the full Hermes-OS capacity set —…, Only high/medium/low are honoured; anything else means 'unset'., North is cost_tier=2, so it must not become the ``best_model_for`` pick for the…, test_flag_default_is_on(), test_hermes_declares_full_capability_set() (+5 more)

### Community 372 - "classify_direct_chat_intent"
Cohesion: 0.13
...
### Community 378 - "_resolve_user_github_token"
Cohesion: 0.17
...
### Community 379 - "traffic_director.py"
Cohesion: 0.12
Nodes (17): Return the configured traffic-distribution strategy (lower-cased). Reads…, routing_strategy(), active_strategy(), provider_id_of(), Any, Adaptive traffic distribution across LLM providers. The router…, Return the configured strategy name, falling back to ``priority``. An…, Extract a provider id from a ProviderConfig dataclass or a plain dict. (+9 more)

### Community 380 - "Harness"
Cohesion: 0.14
...
### Community 381 - "PriorityTaskQueue"
Cohesion: 0.13
...
### Community 382 - "_process_task_callback"
Cohesion: 0.17
...
### Community 384 - "V3 API Migration Plan — LLM Relay Platform"
Cohesion: 0.10
...
### Community 387 - "system_instruction"
Cohesion: 0.16
...
### Community 389 - "test_llm_router_tpm.py"
Cohesion: 0.14
Nodes (20): _big_request(), _ok(), fixture, A per-minute token budget is an input ceiling, not just a sort key. Reproduces…, A conversation comfortably past the metered provider's per-minute budget.…, A 131k window behind a 4k budget is a 4k ceiling., Routing around the low ceiling beats compressing to fit it., Production's case: every reachable provider has a low ceiling. Nothing can be… (+12 more)

### Community 390 - "test_local_controller.py"
Cohesion: 0.17
...
### Community 392 - "test_voice_pipeline.py"
Cohesion: 0.13
...
### Community 397 - "Skill: modularity-review"
Cohesion: 0.10
...
### Community 398 - "Design Audit"
Cohesion: 0.10
Nodes (19): Code Quality, Color and Surfaces, Component Patterns, Content, Design Audit, Fix Priority, How This Works, Iconography (+11 more)

### Community 399 - "Findings"
Cohesion: 0.10
...
### Community 400 - "TestNormalizeResponseFormat"
Cohesion: 0.10
...
### Community 406 - "output_filter.py"
Cohesion: 0.10
...
### Community 409 - "SyntheticDataPipeline"
Cohesion: 0.17
...
### Community 411 - "test_brain_patch_service_token.py"
Cohesion: 0.16
...
### Community 412 - "test_tasks_cache_ttl_env.py"
Cohesion: 0.21
...
### Community 416 - "_extract_tech_relevance"
Cohesion: 0.17
...
### Community 419 - "Analysis & Synthesis Instructions"
Cohesion: 0.11
Nodes (18): 1. Define the Atmosphere, 2. Map the Color Palette, 3. Establish Typography Rules, 4. Define the Hero Section, 5. Describe Component Stylings, 6. Define Layout Principles, 7. Define Responsive Rules, 8. Encode Motion Philosophy (+10 more)

### Community 420 - "Production Readiness Assessment — local-llm-server"
Cohesion: 0.11
...
### Community 421 - "Skill: fabric-patterns"
Cohesion: 0.11
Nodes (18): 1. Ensure Pattern Directory Exists, 2. List Available Patterns, 3. Retrieve a Pattern, 4. Apply a Pattern with Variables, 5. Stitch Patterns Together, 6. Create New Patterns, Acceptance Checks, Directory Structure (+10 more)

### Community 422 - "db/__init__.py"
Cohesion: 0.15
...
### Community 423 - "Admin Dashboard Guide"
Cohesion: 0.11
...
### Community 424 - "Implementation Plan"
Cohesion: 0.11
...
### Community 428 - "Delegation Plan (agent-ready work packages)"
Cohesion: 0.11
...
### Community 429 - "build_workflow.py"
Cohesion: 0.33
Nodes (18): _c(), _get(), _header(), main(), _make_headers(), _phase_icon(), _post(), _print_phases() (+10 more)

### Community 430 - "test_provider_policy_regression.py"
Cohesion: 0.12
Nodes (18): Resolve the LLM endpoint for a named surface (task/chat/ceo/sdlc/…). Honours…, resolve_provider_for(), asyncio, Phase 3 regression test: paid providers are NEVER auto-selected when…, The .github/scripts/provider_policy.py module must export allow_paid() or…, Anthropic provider priorities must be <= -50 so free cloud providers are always…, Regression: the google-gemini provider record in seed_default_providers was…, The ProviderPolicyUpdate Pydantic model must default allow_paid to False. (+10 more)

### Community 431 - "test_company_api.py"
Cohesion: 0.11
...
### Community 432 - "TestSelfHealingInfrastructureClassification"
Cohesion: 0.19
...
### Community 433 - "test_fabric_patterns.py"
Cohesion: 0.11
...
### Community 439 - "Comprehensive Skill Index (By Category)"
Cohesion: 0.11
...
### Community 440 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 441 - "Component Map"
Cohesion: 0.11
...
### Community 442 - "Agent State — colibri GLM-5.2 deployment (resumable)"
Cohesion: 0.11
...
### Community 443 - "Architecture Overview — local-llm-server"
Cohesion: 0.11
...
### Community 444 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
...
### Community 445 - "Platform Guide — the full tour"
Cohesion: 0.11
...
### Community 447 - "Part A — Health Report"
Cohesion: 0.11
...
### Community 451 - "RuntimeReadinessReport"
Cohesion: 0.14
Nodes (8): Any, Structured, actionable preflight validation issue., Preflight result returned before a runtime task starts., Serialise adapter metadata (no secrets)., RuntimeReadinessReport, RuntimeValidationIssue, When runtime preflight fails, the error should be structured with code +…, RuntimePreflightError carries a structured report, not a raw string.

### Community 452 - "agency_fix.py"
Cohesion: 0.20
...
### Community 453 - "sync_readme_gallery.py"
Cohesion: 0.22
...
### Community 454 - "brain_liveness.py"
Cohesion: 0.16
...
### Community 455 - "test_shared_state.py"
Cohesion: 0.20
...
### Community 457 - "DecisionsStoreTests"
Cohesion: 0.12
...
### Community 458 - "test_task_brain_preflight.py"
Cohesion: 0.24
...
### Community 460 - "TestStopSlopChecker"
Cohesion: 0.11
...
### Community 461 - "test_task_service_failed_comment.py"
Cohesion: 0.18
...
### Community 462 - "handle_workflow_ide_chat"
Cohesion: 0.18
...
### Community 464 - "._fetch_flat_skill_file"
Cohesion: 0.21
...
### Community 466 - "Workspace"
Cohesion: 0.12
Nodes (9): _iso_offset_hours(), Enum, str, Resolve *relative* inside source dir and reject traversal/symlink escapes., Resolve *relative* within *ws*.source and reject traversal/symlink escapes.…, Update *ws* status and persist the manifest., Remove and recreate the tmp directory for *ws*., Workspace (+1 more)

### Community 467 - "SKILL: Industrial Brutalism & Tactical Telemetry UI"
Cohesion: 0.12
...
### Community 468 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 469 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 470 - "test_admin_local_brain_router.py"
Cohesion: 0.18
...
### Community 471 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 472 - "Section-by-Section Acceptance Criteria"
Cohesion: 0.12
...
### Community 473 - "resolve_free_nvidia_brain"
Cohesion: 0.13
...
### Community 474 - "Any"
Cohesion: 0.12
Nodes (17): _build_base_url_env_from_yaml(), _build_default_base_url_from_yaml(), _build_display_names_from_yaml(), _build_key_env_from_yaml(), _build_presets_from_yaml(), _build_tier_from_yaml(), Any, Extract the per-provider ``key_env`` mapping from the YAML. (+9 more)

### Community 475 - "redact_connection_url"
Cohesion: 0.17
...
### Community 476 - "kimi_bridge_provider_config"
Cohesion: 0.18
...
### Community 477 - "agent_readiness_audit.py"
Cohesion: 0.21
...
### Community 481 - "_resolve_push_token"
Cohesion: 0.15
Nodes (14): _get_ceo_dispatcher(), Execute the plan via the selected specialist(s)., Verify execution results., Return the shared CEODispatcher singleton (importable for monkeypatching)., GitHub token used to push branches / open PRs during EXECUTION (#506).…, _resolve_push_token(), _clean_env(), fixture (+6 more)

### Community 482 - "test_activation_api.py"
Cohesion: 0.21
...
### Community 483 - "test_autonomy_status.py"
Cohesion: 0.12
...
### Community 484 - "test_health_endpoints.py"
Cohesion: 0.17
...
### Community 485 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 486 - "test_local_brain_state.py"
Cohesion: 0.12
...
### Community 488 - "test_phase5_doctor.py"
Cohesion: 0.12
...
### Community 490 - "test_schedule_backlog_drain.py"
Cohesion: 0.15
...
### Community 491 - "test_telegram_diag_endpoint.py"
Cohesion: 0.12
...
### Community 492 - "hermes_prompt.py"
Cohesion: 0.19
...
### Community 493 - "MemoryMiddleware"
Cohesion: 0.17
...
### Community 494 - "tools.py"
Cohesion: 0.13
Nodes (8): repowise.py — RepowiseIntelligence: context packing and dependency analysis., tools.py — WorkspaceTools: read/write/search and diff application (risky…, fixture, tools(), Test that the new tools are exposed and return strings., Test that WorkspaceTools initializes correctly., test_tools_expose_new_methods(), test_workspace_tools_initialization()

### Community 495 - "safe_agency.py"
Cohesion: 0.22
...
### Community 497 - "Skill: repowise-intelligence"
Cohesion: 0.12
...
### Community 498 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
...
### Community 499 - "_valid_login_state"
Cohesion: 0.24
...
### Community 500 - "Skill: repowise-intelligence"
Cohesion: 0.12
Nodes (15): 1. Graph Intelligence (Dependency Graph), 2. Git Intelligence, 3. Documentation Intelligence, 4. Decision Intelligence, Acceptance Checks, Directory Structure, Example Usage, Implementation Approach (+7 more)

### Community 501 - "The 10-Step Workflow"
Cohesion: 0.12
...
### Community 502 - "Contributing to local-llm-server"
Cohesion: 0.12
...
### Community 503 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 504 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 505 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
...
### Community 506 - "SkillsScreen.jsx"
Cohesion: 0.12
...
### Community 507 - "implement_agent.py"
Cohesion: 0.16
...
### Community 515 - "test_telegram_auto_approve.py"
Cohesion: 0.22
Nodes (15): is_sensitive(), True when *text* references a sensitive target (auth/keys/secrets/service…, _build_execution_request(), Build a minimal ``ExecutionRequest`` for plain-text → orchestrator.execute.…, admin_user(), _auto_approve(), non_admin_user(), fixture (+7 more)

### Community 516 - "ManagedAgentDreams"
Cohesion: 0.22
...
### Community 517 - "_NoopDB"
Cohesion: 0.15
Nodes (8): _NoopDB, Any, Restore in-flight runs at startup. Called during backend bootstrap. Returns a…, Fallback in-memory store when no DB is available., Persist a WorkflowRun snapshot., Load a persisted run snapshot., Return checkpoints for runs that were not in a terminal state., A checkpointed run with no persisted _request can never be resumed (execute()…

### Community 518 - "e2e/test_browser.py"
Cohesion: 0.21
...
### Community 519 - "DailyDigestAggregatorTests"
Cohesion: 0.19
...
### Community 520 - "test_dockerfile_ships_root_modules.py"
Cohesion: 0.17
...
### Community 521 - "test_frontend_deployment_guards.py"
Cohesion: 0.20
...
### Community 522 - "test_glm52_brain.py"
Cohesion: 0.12
...
### Community 526 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 530 - "CollaborationContext"
Cohesion: 0.19
...
### Community 531 - "Skill: agent-harness"
Cohesion: 0.13
...
### Community 532 - "Skill: checkpoint-strategy"
Cohesion: 0.13
...
### Community 534 - "Skill: local-ai-query"
Cohesion: 0.13
...
### Community 535 - "Skill: parallel-agents"
Cohesion: 0.13
...
### Community 536 - "Skill: parallel-worktrees"
Cohesion: 0.13
...
### Community 537 - "Design System: Taste Standard"
Cohesion: 0.13
...
### Community 540 - "Skill: user-research"
Cohesion: 0.13
...
### Community 541 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 542 - "Attention Mechanisms Internals"
Cohesion: 0.13
...
### Community 543 - "FeatureMaturity"
Cohesion: 0.14
Nodes (7): FeatureMaturity, str, Feature maturity classification., Load canonical features and apply per-feature then bulk env overrides., Apply a config override string like 'stable', 'beta', 'disabled', 'enabled',…, TestAdminVisibility, TestMatrixSerialization

### Community 544 - "allow_paid"
Cohesion: 0.19
...
### Community 547 - "_push_down_where"
Cohesion: 0.14
...
### Community 552 - "probe_model_liveness"
Cohesion: 0.22
...
### Community 553 - "TestDecisionsBotLinks"
Cohesion: 0.17
...
### Community 554 - "DecisionsStore"
Cohesion: 0.30
Nodes (3): DecisionsStore, Any, Connection

### Community 555 - "clear_wizard_state_cache"
Cohesion: 0.21
...
### Community 559 - "test_openclaw_gateway.py"
Cohesion: 0.13
...
### Community 562 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 566 - "Checks Performed"
Cohesion: 0.14
...
### Community 567 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 568 - "test_new_features_e2e.py"
Cohesion: 0.29
...
### Community 570 - "model_catalog.py"
Cohesion: 0.18
Nodes (13): get_catalog_models_route(), Return the mirrored model catalog (advisory-only). Flag-gated by…, get_catalog(), get_model_catalog_store(), _include_router_providers(), is_catalog_enabled(), packages/ai/model_catalog.py — UNIT 8: free-LLM-API model catalog sync.…, Whether to publish LLM-router providers in the catalog (default OFF). The… (+5 more)

### Community 571 - "Skill: branch-cleanup"
Cohesion: 0.14
...
### Community 572 - "Skill: perplexity — Web Research via Perplexity API"
Cohesion: 0.14
...
### Community 575 - "Quick-Note Issues Processing Summary"
Cohesion: 0.14
...
### Community 576 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 578 - "Runbook: Auto-Resume After Cooldown / Interruption"
Cohesion: 0.14
...
### Community 579 - "SEO / GEO / AIO Audit Engine"
Cohesion: 0.14
...
### Community 580 - "Traffic Distribution Across Providers"
Cohesion: 0.14
...
### Community 582 - "overrides"
Cohesion: 0.14
Nodes (14): @tootallnate/once, overrides, bfj, css-select, http-proxy-agent, jsonpath, nth-check, postcss (+6 more)

### Community 583 - "mcp_server/server.py"
Cohesion: 0.25
Nodes (13): _check_auth(), _err(), _handle_tool(), health(), mcp_dispatch(), _ok(), Any, get (+5 more)

### Community 584 - "cost_tracker.py"
Cohesion: 0.16
Nodes (13): _build_cost_table(), cost_for_tokens(), get_stats(), _load_env_overrides(), Any, Per-model cost attribution for the LLM provider router. Maintains in-memory…, Return the USD cost for (prompt_tokens, completion_tokens) on *model*. Returns…, Record token usage for *model* (fire-and-forget, never raises). ``tag`` is a… (+5 more)

### Community 585 - "_parse_reset_epoch"
Cohesion: 0.21
...
### Community 589 - "test_critical_flows.py"
Cohesion: 0.29
...
### Community 590 - "test_regression.py"
Cohesion: 0.14
...
Cohesion: 0.21
Nodes (13): _authed_client(), clean_store(), _clear(), fixture, tests/test_doctor_service_token_check.py — N5 follow-up: doctor check for…, Reset brain config store + SQLITE_DB_PATH + SERVICE_TOKEN., Build a TestClient authenticated as admin (for /api/doctor/diagnostics)., When SERVICE_TOKEN is not set, the doctor endpoint must surface a 'warn' check… (+5 more)

### Community 593 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 599 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 602 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 603 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 607 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 608 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 610 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 611 - "admin_update_task_router.py"
Cohesion: 0.22
...
### Community 614 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
Nodes (12): Acceptance Checks, Claude's query protocol (use this instead of Read tool for exploration):, Graph Artifacts — What to Commit, How to Use the Graph (Token Savings Protocol), Installation (one-time per machine), Instead of reading raw files:, Key commands:, Relationship to repowise-intelligence Skill (+4 more)

### Community 615 - "Skill: platform-setup — Autonomous Agency Bootstrap"
Cohesion: 0.15
...
### Community 616 - "Workspace Isolation Architecture"
Cohesion: 0.15
...
### Community 617 - "Device compatibility and model picks"
Cohesion: 0.15
...
### Community 618 - "Autonomy Uplift — Living Roadmap & Detailed Implementation Specs"
Cohesion: 0.15
...
### Community 619 - "OpenClaw — iOS Control of the Agency (Single-Service Free-Tier Deploy)"
Cohesion: 0.15
...
### Community 622 - "_is_bedrock_model_id"
Cohesion: 0.27
...
### Community 624 - "Agent Transparency Report"
Cohesion: 0.15
...
### Community 625 - "update_provider_policy"
Cohesion: 0.19
...
### Community 627 - "_InMemoryBackend"
Cohesion: 0.18
...
### Community 628 - "test_agile_api.py"
Cohesion: 0.15
...
### Community 629 - "test_app_settings.py"
Cohesion: 0.19
...
### Community 630 - "TestModelCostTableUpdates"
Cohesion: 0.26
...
### Community 632 - "TestRuntimeControl"
Cohesion: 0.15
...
### Community 633 - "TestKillSwitchDurability"
Cohesion: 0.15
...
### Community 635 - "WorkspaceManifest"
Cohesion: 0.17
...
### Community 637 - "skill_registry.py"
Cohesion: 0.17
...
### Community 643 - "Skill: system-prompt-audit"
Cohesion: 0.17
...
### Community 644 - "Skill: task-alive-updates"
Cohesion: 0.17
...
### Community 648 - "14. Standing Instructions — Universal Agent Discipline"
Cohesion: 0.17
...
### Community 649 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 652 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 655 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 656 - "Quantization Internals"
Cohesion: 0.17
...
### Community 657 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 658 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 659 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 660 - "Render MCP — autonomous platform debugging and environment monitoring"
Cohesion: 0.17
...
### Community 662 - "test_p0_roadmap_a4_a5_b2.py"
Cohesion: 0.26
...
### Community 663 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 664 - "test_docs_consistency.py"
Cohesion: 0.17
...
### Community 665 - "TestAuthAndTaskCreation"
Cohesion: 0.17
...
### Community 666 - "test_providers_live_e2e.py"
Cohesion: 0.27
...
### Community 667 - "test_skill_registry.py"
Cohesion: 0.20
...
### Community 668 - "TestAnthropicPayloadStructuredOutput"
Cohesion: 0.29
...
### Community 671 - "_extractive_compress"
Cohesion: 0.18
...
### Community 673 - "WorkflowTransition"
Cohesion: 0.20
Nodes (9): _append_transition(), BaseModel, Advance task through the full phase sequence. Resumes from…, Execute a single phase and advance to the next., Add a workflow transition to the task's history list., WorkflowTransition, test_task_workflow_history_append(), test_workflow_transition_defaults() (+1 more)

### Community 674 - "cowork_session.py"
Cohesion: 0.24
...
### Community 676 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 679 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 680 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 682 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 685 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 686 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 687 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 688 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 689 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 690 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 691 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 692 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 694 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 695 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 696 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 697 - "CI Troubleshooting Runbook"
Cohesion: 0.18
...
### Community 698 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 699 - "What to clean up"
Cohesion: 0.18
...
### Community 700 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 702 - "test_bedrock_live.py"
Cohesion: 0.25
...
### Community 706 - "test_agent_readiness_audit.py"
Cohesion: 0.18
...
### Community 707 - "TestIsDnsFailure"
Cohesion: 0.18
...
### Community 710 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 711 - "test_google_provider_models.py"
Cohesion: 0.18
...
### Community 713 - "._run_git_command"
Cohesion: 0.20
...
### Community 715 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 716 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 717 - "TestNormalizeToolChoice"
Cohesion: 0.31
...
### Community 718 - "CLAUDE.md — Master Architect Operating Manual"
Cohesion: 0.20
...
### Community 719 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 720 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 721 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 722 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 723 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 724 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 725 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 726 - "Agent Readiness Report"
Cohesion: 0.20
...
### Community 728 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 729 - "LLM Router — configuration guide"
Cohesion: 0.20
...
### Community 730 - "LLM Router — provider guide"
Cohesion: 0.20
...
### Community 734 - "build_tech_db.py"
Cohesion: 0.40
...
### Community 738 - "test_bootstrap_source_id_index.py"
Cohesion: 0.27
...
### Community 739 - "TestExtendedThinkingRouting"
Cohesion: 0.20
...
### Community 740 - "TestZeroAttemptDiagnostics"
Cohesion: 0.29
...
### Community 741 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 743 - "test_provider_state_durability.py"
Cohesion: 0.20
...
### Community 749 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 753 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 755 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 756 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 757 - "Skill: changelog-enforcer"
Cohesion: 0.22
Nodes (8): Acceptance Checks, Changelog Location, Entry Format, Examples, Hook Behaviour, Instructions, Skill: changelog-enforcer, When to Use

### Community 758 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
Nodes (8): Branch, Components, Purpose, Quick Start, Session Roles, Skill: cowork-session (Claude Cowork), Testing, When to Use

### Community 759 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 761 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 763 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 764 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 765 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 766 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 767 - "Release Procedure"
Cohesion: 0.22
...
### Community 768 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 770 - "frontend/package.json"
Cohesion: 0.22
Nodes (8): jest, moduleNameMapper, ^react-router$, ^react-router-dom$, name, private, proxy, version

### Community 771 - "AgentStatusPanel.tsx"
Cohesion: 0.25
Nodes (7): AgentStatus, AgentStatusPanelProps, AgentCard(), formatRelative(), ROLE_ICONS, STATUS_DOTS, STATUS_STYLES

### Community 772 - "AgentStatusPanel.jsx"
Cohesion: 0.25
Nodes (6): AgentCard(), formatRelative(), ROLE_ICONS, STATUS_DOTS, STATUS_STYLES, PHASE_LABELS

### Community 773 - "ToolCallViewer.tsx"
Cohesion: 0.25
Nodes (7): ToolCall, ToolCallViewerProps, getToolIcon(), STATUS_BADGES, STATUS_STYLES, TOOL_ICONS, ToolCallRow()

### Community 774 - "invalidate_catalog_cache"
Cohesion: 0.22
Nodes (8): invalidate_catalog_cache(), Clear the in-process cache., Clear the singleton's cache (used by tests)., _base_catalog_only(), fixture, The opt-in flag adds the router's providers without losing the baseline.…, Pin the catalog to its UNIT 8 baseline of 15 providers.…, test_catalog_widens_when_router_providers_are_included()

### Community 775 - "oauth.py"
Cohesion: 0.28
...
### Community 776 - "cleanup_stale_jobs"
Cohesion: 0.31
...
### Community 777 - "enrich_quick_note_issues.py"
Cohesion: 0.42
...
### Community 785 - "TestChatFallbackAndApproval"
Cohesion: 0.22
...
### Community 790 - "TestPaidPolicyDurability"
Cohesion: 0.22
...
### Community 791 - "test_runtimes_health_endpoint.py"
Cohesion: 0.22
...
### Community 793 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.22
...
### Community 795 - "navigation_metrics.py"
Cohesion: 0.32
...
### Community 800 - "ContributorState"
Cohesion: 0.25
...
### Community 801 - "CapacityAllocation"
Cohesion: 0.25
...
### Community 802 - "quality_checker.py"
Cohesion: 0.32
...
### Community 804 - "TestParseToolCalls"
Cohesion: 0.39
...
### Community 815 - "AGENTS.md — AI Agent Configuration for local-llm-server"
Cohesion: 0.25
...
### Community 816 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 817 - "ceo-micromanagement.md"
Cohesion: 0.25
Nodes (4): P0 behavior change, Readiness contract, Runtime model, Runtime types

### Community 818 - "Feature Maturity / Support Matrix"
Cohesion: 0.25
...
### Community 821 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.25
...
### Community 822 - "Issue #362: Nvidia repo setup"
Cohesion: 0.25
...
### Community 823 - "Issue #364: quick-note:https://www.marktechpost.com/2026/06/01/meet-memory-os-a-6-layer-open-source-memory-stack-built-on-top-of-hermes-agent/"
Cohesion: 0.25
...
### Community 824 - "Issue #378: quick-note:https://www.marktechpost.com/2026/06/02/tinyfish-launches-bigset-an-open-source-multi-agent-system-that-builds-structured-live-datasets-from-plain-english-descriptions/"
Cohesion: 0.25
...
### Community 825 - "Issue #379: quick-note:https://searchengineland.com/schema-markup-optimize-agentic-web-479080"
Cohesion: 0.25
...
### Community 826 - "Issue #380: quick-note:https://cursor.com/blog/cloud-agent-lessons"
Cohesion: 0.25
...
### Community 827 - "Issue #381: quick-note:https://www.xda-developers.com/claude-code-with-opus-48-is-expensive-but-i-made-it-efficient-with-my-local-ai-workflow/"
Cohesion: 0.25
...
### Community 828 - "Issue #382: quick-note:https://claude.com/blog/how-coderabbit-used-claude-to-build-an-agent-orchestration-system"
Cohesion: 0.25
...
### Community 829 - "Issue #383: quick-note:https://www.marktechpost.com/2026/05/29/hexo-labs-open-sources-sia-a-self-improving-agent-that-updates-both-the-harness-and-the-model-weights/"
Cohesion: 0.25
...
### Community 830 - "Issue #416: feat: Self-hosted Codebuff (freebuff) on free NVIDIA models + Telegram bot phone control"
Cohesion: 0.25
...
### Community 831 - "Issue #485: [Trend Digest] Week of 2026-06-08"
Cohesion: 0.25
...
### Community 832 - "Issue #488: quick-note:https://github.com/cookiy-ai/user-research-skill"
Cohesion: 0.25
...
### Community 833 - "Issue #491: Implement whatever is necessary from https://github.com/BehiSecc/awesome-claude-skills"
Cohesion: 0.25
...
### Community 834 - "Issue #493: Use the https://github.com/mvanhorn/last30days-skill skill to get the trend updated"
Cohesion: 0.25
...
### Community 835 - "Issue #495: Read https://www.anthropic.com/news/claude-fable-5-mythos-5 and understand if mythos or fable can be added to the repo"
Cohesion: 0.25
...
### Community 836 - "Issue #504: EPIC: Autonomy hardening — live-verified defects 2026-06-10"
Cohesion: 0.25
...
### Community 837 - "Issue #581: Sprint tracker: pending work after brand rename + mobile-first pass"
Cohesion: 0.25
...
### Community 839 - "Issue #657: quick-note:https://github.com/earendil-works/pi"
Cohesion: 0.25
...
### Community 840 - "Issue #659: quick-note:https://github.com/nex-agi/Nex-N2"
Cohesion: 0.25
...
### Community 841 - "Issue #660: quick-note:https://github.com/getsentry/sentry-for-ai"
Cohesion: 0.25
...
### Community 842 - "Issue #661: quick-note:https://github.com/XiaomiMiMo/MiMo-Code"
Cohesion: 0.25
...
### Community 843 - "Issue #664: quick-note:https://github.com/Grominet95/jarvis-OS"
Cohesion: 0.25
...
### Community 844 - "Issue #666: quick-note:https://github.com/porokka/jarvis-os"
Cohesion: 0.25
...
### Community 845 - "Issue #670: quick-note:https://github.com/perplexityai/bumblebee"
Cohesion: 0.25
...
### Community 846 - "Issue #672: quick-note:https://github.com/Chachamaru127/claude-code-harness"
Cohesion: 0.25
...
### Community 847 - "Issue #676: quick-note:https://github.com/WeiboAI/VibeThinker"
Cohesion: 0.25
...
### Community 848 - "Issue #820: quick-note:https://github.com/cobusgreyling/loop-engineering"
Cohesion: 0.25
...
### Community 849 - "Positional Encoding Internals"
Cohesion: 0.25
...
### Community 851 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 852 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 853 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 854 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 857 - "_get_current_user"
Cohesion: 0.29
...
### Community 859 - "capture_screens.py"
Cohesion: 0.39
...
### Community 862 - "crispy_burn_in.py"
Cohesion: 0.36
...
### Community 863 - "run_patched_colibri.py"
Cohesion: 0.36
...
### Community 866 - "test_agent_tools.py"
Cohesion: 0.43
...
### Community 867 - "test_compose_and_coordinate_api.py"
Cohesion: 0.36
...
### Community 868 - "test_doctor_coding_brain.py"
Cohesion: 0.32
...
### Community 870 - "TestProviderRouter"
Cohesion: 0.25
...
### Community 871 - "test_local_brain_router_smoke.py"
Cohesion: 0.25
...
### Community 872 - "test_provider_models_db_outage.py"
Cohesion: 0.25
...
### Community 876 - "test_serve_spa_prefixes.py"
Cohesion: 0.36
...
### Community 878 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 879 - ".discover_directory"
Cohesion: 0.29
...
### Community 885 - "4. Current Architecture (As-Is)"
Cohesion: 0.29
...
### Community 886 - "AI Engineering Insights Skill"
Cohesion: 0.29
...
### Community 896 - "ADR-006: Strangler Fig migration with backward-compat shims"
Cohesion: 0.29
Nodes (6): ADR-006: Strangler Fig migration with backward-compat shims, Consequences, Context, Decision, Examples, Migration path

### Community 897 - "claude-mem Plugin — Persistent Memory for All Sessions"
Cohesion: 0.29
...
### Community 898 - "Implementation plan + TO-DO (check off as you go)"
Cohesion: 0.29
...
### Community 902 - "Cloudflare = the real working app"
Cohesion: 0.29
...
### Community 907 - "check_changelog_parity.py"
Cohesion: 0.43
...
### Community 908 - "e2e_smoke.py"
Cohesion: 0.57
Nodes (5): _chat(), check(), _health(), _models(), _req()

### Community 909 - "_reset_backend"
Cohesion: 0.33
...
### Community 912 - "test_daily_2026_06_14.py"
Cohesion: 0.38
...
### Community 913 - "TestSupportMatrixDocsSync"
Cohesion: 0.29
...
### Community 915 - "TestGithubTokenSQLiteRegression"
Cohesion: 0.38
...
### Community 921 - "/fix-bug — Bug Fix Agent"
Cohesion: 0.33
...
### Community 923 - "pre-commit"
Cohesion: 0.60
Nodes (5): pre-commit script, _error(), _head(), _info(), _warn()

### Community 924 - "Skill: browserbase-fetch — Lightweight Web Fetch"
Cohesion: 0.33
...
### Community 935 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 936 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 937 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 938 - "The full agent capability roster"
Cohesion: 0.33
...
### Community 939 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 940 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 941 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 976 - "Documentation map"
Cohesion: 0.40
...
### Community 986 - "Prompt Library Changelog"
Cohesion: 0.40
...
### Community 988 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 989 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 990 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 991 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 992 - "setup_colibri.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 993 - "setup_colibri.sh script"
Cohesion: 0.70
Nodes (4): setup_colibri.sh script, fail(), ok(), warn()

### Community 994 - "status_colibri_server.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 995 - "CircuitBreakerOpenError"
Cohesion: 0.50
...
### Community 999 - "test_agent_runtime_wrapper.py"
Cohesion: 0.70
...
### Community 1032 - "test_no_exception_detail_leaks.py"
Cohesion: 0.50
...
### Community 1033 - "test_skills_route_order.py"
Cohesion: 0.67
...
### Community 1067 - "test_direct_adapter_does_not_bypass"
Cohesion: 0.67
...
### Community 1068 - "_enable_filter"
Cohesion: 0.67
Nodes (3): _enable_filter(), fixture, Ensure filter is enabled for all tests.

## Knowledge Gaps
- **3369 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3364 more)
...
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `PortfolioManager`, `AgentScheduler`, `proxy.py`, `TestMCPServer`, `AgentJobManager`, `TestWorkspace`, `BackgroundAgent`, `TaskSpec`, `MCPUnavailableError`, `AgentSessionStore`, `_StubManager`, `workflow_orchestrator.py`, `FreeBuffAgent`, `WorkspaceTools`, `WorkflowRun`, `test_ceo_dispatcher.py`, `test_agent_free_brain.py`, `.execute`, `test_ceo_supervision.py`, `failover_chat_completion`, `WorkflowBuildRequest`, `LocalWorkspace`, `direct_chat.py`, `ExecutionRequest`, `failover_client.py`, `TokenBudget`, `ContextPruner`, `test_ceo_cross_verify.py`, `AutonomyTracker`, `TestAgentRunnerSafety`, `test_empirical_verify.py`, `GitHubTools`, `MCPClient`, `test_freebuff.py`, `AdaptiveHalter`, `E2BAdapter`, `_resolve_push_token`, `TestZeroAttemptDiagnostics`, `ContextManager`, `ReactScratchpad`, `ceo_dispatcher.py`, `StuckDetector`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `Task` connect `Task` to `backend/server.py`, `brain_config.py`, `TaskDispatcher`, `company_api.py`, `settings.py`, `test_e2b_task_wiring.py`, `services/background.py`, `get_company_access`, `test_sam_livekit.py`, `seo_api.py`, `test_schedule_growth_invariants.py`, `test_phase6_workflow.py`, `v4_api.py`, `test_self_heal_v2.py`, `test_task_brain_preflight.py`, `test_task_service_failed_comment.py`, `_make_task`, `tasks/api.py`, `test_issue_intake.py`, `test_trend_scoping.py`, `test_purge_backlog.py`, `_ts_to_float`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `WorkspaceManager` connect `WorkspaceManager` to `ProviderConfig`, `test_workspace_security.py`, `diagnostics.py`, `AgentJobManager`, `dry_clone_repo`, `validate_session_id`, `.get_workspace`, `WorkspaceManifest`, `test_workspace_isolation.py`, `validate_job_id`?**
