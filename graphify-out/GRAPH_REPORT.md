# Graph Report - local-llm-server  (2026-08-29)

## Corpus Check
- 1449 files · ~2,102,959 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 29537 nodes · 54787 edges · 1234 communities (1120 shown, 114 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 2695 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7459b07c`
...
## Communities (1234 total, 114 thin omitted)

### Community 0 - "backend/server.py"
Cohesion: 0.03
Nodes (194): Reject non-admin callers. Mirrors the RBAC check used elsewhere in this backend…, _require_admin(), admin_seed(), _agent_timeout_fallback_response(), AgentStatusEntry, AgentStatusResponse, AgentToolCallEntry, ApiKeyCreate (+186 more)

### Community 1 - "AgentRunner"
Cohesion: 0.02
...
### Community 2 - "WebsiteScanner"
Cohesion: 0.02
Nodes (126): Scan a website for technology stack and systems. This performs a comprehensive…, scan_website_endpoint(), DetectedSystem, Evidence, OnboardingProgress, Result of a website scan with detected systems and stack inference., Evidence supporting a system detection., Tracks the onboarding progress for a company. (+118 more)
...
Cohesion: 0.02
Nodes (102): CacheManager, _Entry, LRUCache, Any, T, packages/llm/cache.py — layered caching. Five independent layers, each with its…, Live (unexpired) entries — used by the semantic layer's scan., Owns every cache layer and the policy for what may enter them. (+94 more)

### Community 7 - "test_operational_incidents.py"
Cohesion: 0.02
Nodes (122): _diagnose_and_file(), _format_incident(), gather_render_evidence(), get_operational_incident_tracker(), _iso_from_monotonic(), normalise(), note_phase_end(), note_phase_start() (+114 more)

### Community 8 - "TaskStore"
Cohesion: 0.03
Nodes (101): agents/store.py — Persistent store for user-defined agent configurations.…, Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., tasks — Task/issue management system. Provides a lightweight task/issue tracker…, tasks/issue_intake.py — Auto issue → Task intake (Autonomy Charter G3) Turns…, ApprovalCheckpoint, Enum, str (+93 more)

### Community 9 - "models/company_graph.py"
Cohesion: 0.03
...
### Community 10 - "test_ceo_dispatcher.py"
Cohesion: 0.03
Nodes (112): CEOResult, get_ceo_dispatcher(), Return the shared CEODispatcher singleton., Reset the singleton (test helper)., Aggregated output from a multi-specialist execution., reset_ceo_dispatcher(), BoundContext, ClassifyOutput (+104 more)
...
### Community 12 - "test_governance_sandbox.py"
Cohesion: 0.03
...
### Community 15 - "Task"
Cohesion: 0.04
Nodes (80): Full task/issue document., Task, One-line human explanation of why this task needs human approval. Reads risk…, Best-effort label of who will run this task once approved. Returns…, PUBLIC_URL-anchored dashboard deep link for the task detail. Returns empty…, Best-effort Telegram heads-up that a task is parked awaiting approval. Inline…, asyncio, A reject + human Retry starts a NEW approval cycle → fresh notification. (+72 more)

### Community 16 - "Surface"
Cohesion: 0.03
Nodes (80): Governance seam: judge the call, run it, audit the outcome. Deliberately a thin…, Feed LLM token/cost spend into the governance session budget. Kept separate…, Charge sub-agent nesting depth and enforce the ``max_depth`` ceiling. Isolates…, _egress_policy_reason(), agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Return why governance policy blocks *host*, or None. Runs strictly *after* the…, build_governance_router(), Any (+72 more)
...
Cohesion: 0.04
Nodes (86): _load(), main(), int, get_budget(), The process-wide budget tracker., get_cache(), The process-wide cache manager., failover_chat_completion_via_router() (+78 more)
...
### Community 24 - "BrainConfig"
Cohesion: 0.04
Nodes (90): BrainConfig, BrainConfigPatch, BrainConfigStore, default_brain_config(), get_brain_config(), BaseModel, Persist *cfg* to Mongo (primary) and sqlite (mirror). Either backend failing is…, Build a ``BrainConfig`` from a Mongo doc, dropping Mongo's ``_id``. (+82 more)
...
### Community 26 - "get"
Cohesion: 0.02
Nodes (95): auth_me(), auto_recommend_skills(), brain_failover_status(), brain_providers(), _check_storage_health(), cost_attribution_stats(), discover_remote_skills(), doctor_health() (+87 more)

### Community 27 - "ExecutionRequest"
Cohesion: 0.04
Nodes (53): Called by APScheduler when a cron fires. Dispatches to the orchestrator. This…, _scheduler_on_fire(), OrchestratorSupervisor, Any, Emit an alert to the activity feed and log., Deterministic supervisor for the orchestrator. Runs as a background coroutine.…, stop_orchestrator_supervisor(), SupervisorState (+45 more)
...
### Community 29 - "TaskSpec"
Cohesion: 0.06
Nodes (62): kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, TaskResult, TaskSpec, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Run aider non-interactively via `--message` flag., runtimes/adapters/claude_code.py — Claude Code CLI adapter (FIRST CLASS).…, runtimes/adapters/docker_agent.py — Docker-based agent runtime adapter. Spawns… (+54 more)

### Community 30 - "_fixture"
Cohesion: 0.02
Nodes (94): app_client(), _clear_discovered_models(), _clear_response_cache(), client(), _isolate_brain_data_layer(), _isolate_operator_provider_state(), non_admin_client(), MonkeyPatch (+86 more)
...
### Community 32 - "brain_config.py"
Cohesion: 0.03
Nodes (73): provider_api_key(), provider_base_url(), _provider_env_value(), _provider_ids_from_literal(), provider_key_present(), provider_key_rotation_enabled(), services/brain_config_store.py — DB-persisted, UI-switchable "brain" config.…, # NOTE: append-only — adding a provider adds an entry above and inserts into (+65 more)

### Community 33 - "WorkflowRun"
Cohesion: 0.03
Nodes (47): MergeDecision, _NoopStore, Phase, Any, Enum, Exception, Approve a run paused at the ApprovalGate. The caller must re-invoke…, Inject additional instructions into an in-flight run (no state change). Backs… (+39 more)
...
### Community 36 - "test_unit8_model_catalog.py"
Cohesion: 0.04
...
Cohesion: 0.04
Nodes (70): _as_list(), Decision, GroupPolicy, Mode, PolicyEngine, Any, Path, str (+62 more)

### Community 39 - "LLMProvider"
Cohesion: 0.05
Nodes (44): packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, classify_error(), LLMProvider, ABC, Any, AsyncClient, ProviderConfig, Response (+36 more)
...
Cohesion: 0.06
Nodes (57): DetectedIssue, get_improvement_loop(), ImprovementLoop, ImprovementLoopState, IssueCategory, IssueSeverity, _now(), Any (+49 more)

### Community 43 - "TaskExecutionCoordinator"
Cohesion: 0.04
Nodes (46): AgentDefinition, AgentStore, Any, field_validator, CRUD store for AgentDefinition objects. Uses MongoDB when a `db` client is…, Return an agent by ID. If *owner_id* is provided, enforces that the agent…, Delete an agent. Returns True on success, False if not found/unauthorised., Return all agents owned by *owner_id*, optionally including public agents. (+38 more)

### Community 44 - "workflow/api.py"
Cohesion: 0.05
Nodes (50): Review a slice via the Reviewer agent (different model from Coder). This is the…, When coder == reviewer model, swarm should log a warning., _fake_artifact(), _make_engine(), tests/test_crispy_workflow.py — CRISPY workflow engine hardening tests. Tests…, Create a WorkflowEngine with isolated storage., TestAbortOnFailure, TestPhaseSequence (+42 more)

### Community 45 - "ToolRegistry"
Cohesion: 0.04
Nodes (45): get_tool_registry(), Any, Path, Register a tool definition., Decorator to register a function as an agent tool. Usage::…, Remove a tool from the registry. Returns True if removed., Look up a tool by name., Return all registered tools. (+37 more)
...
### Community 48 - "get_task_store"
Cohesion: 0.04
Nodes (73): quick_notes_submit(), _QuickNoteBody, Submit a quick-note URL or instruction from the dashboard FAB., Path, Start RuntimeManager, TaskDispatcher, SCHEDULER, and self-bootstrap. Returns a…, start_background_services(), Hand the 'connect & verify the repo' work to the agency's own agents. The task…, _seed_connect_task() (+65 more)
...
### Community 54 - "SpecialistService"
Cohesion: 0.04
...
### Community 56 - "seo_api.py"
Cohesion: 0.04
Nodes (65): build_seo_roadmap(), delegate_seo_findings(), _expire_stale_pending_report(), get_seo_audit(), list_seo_audits(), plan_seo_sprint(), BaseModel, get (+57 more)

### Community 57 - "TaskWorkflowService"
Cohesion: 0.05
Nodes (57): _capability_tags(), create_task_from_oldest_open_issue(), intake_issue(), _issue_labels(), issue_source_id(), map_issue_to_task(), Any, Task (+49 more)
...
### Community 59 - "SeoAuditEngine"
Cohesion: 0.05
Nodes (39): Run a full SEO/GEO/AIO audit against a website and persist the evidence., run_seo_audit(), field_validator, A single occurrence of a check firing on a specific URL., Aggregated report row - Screaming Frog CSV compatible., Site-level facts discovered during the crawl., Request to run an SEO/GEO/AIO audit against a website., SeoAuditRequest (+31 more)
...
### Community 61 - "get_company_graph_store"
Cohesion: 0.05
...
Cohesion: 0.05
Nodes (45): get_brain_config_store(), Return the process-wide ``BrainConfigStore`` singleton., Force a cache refresh (used by tests + the GET /admin/api/policy/brain…, refresh_brain_config_cache(), Any, packages/ai/self_heal.py — automatic brain self-healing. When the active brain…, Background tick that runs self_heal_brain_and_unblock_tasks(). Called from the…, One-shot self-healing pass. 1. Checks if the active brain provider is in a… (+37 more)

### Community 74 - "CompanyGraphStore"
Cohesion: 0.03
Nodes (33): requires_db, Initialize the service. Args: store: Optional CompanyGraphStore instance. If…, CompanyGraphStore, Delete a company and all its associated data., List companies with optional filtering., Count total companies in the store., Create a new company graph., Get the complete company graph for a company. (+25 more)
...
### Community 77 - "validate_policy_text"
Cohesion: 0.06
...
### Community 81 - "ProviderConfig"
Cohesion: 0.05
Nodes (48): provider_access_tier(), _provider_field(), provider_sort_key(), ProviderConfig, Infer an access tier from *hostname*, longest matching suffix winning. Returns…, _tier_from_hostname(), local_brain_enabled(), local_brain_provider_config() (+40 more)
...
Cohesion: 0.06
Nodes (35): Attempt, text_key(), Read the environment variables named in ``env_names`` into a key list. Order is…, resolve_keys(), LLMRouter, Any, AsyncClient, BaseException (+27 more)
...
### Community 86 - "resolve_e2b_config"
Cohesion: 0.05
...
### Community 99 - "test_provider_router.py"
Cohesion: 0.05
...
### Community 106 - "test_brain_failover.py"
Cohesion: 0.05
...
### Community 107 - "test_repo_connection.py"
Cohesion: 0.06
Nodes (44): attach_repo_connection(), build_repo_connection(), decide_merge(), detect_delivery_policy(), GitHubPolicyProbe, MergeDecision, parse_repo_url(), provider_of() (+36 more)
...
### Community 109 - "test_sam_livekit.py"
Cohesion: 0.05
...
### Community 116 - "test_p0_roadmap_b1_c2_a3.py"
Cohesion: 0.06
...
Cohesion: 0.07
Nodes (39): Record token usage for *model* (fire-and-forget, never raises). ``tag`` is a…, record_usage(), _acquire_provider_probe(), _dead_model_key(), _exponential_backoff_cooldown(), _get_director(), is_commercial_provider(), _mark_model_dead() (+31 more)

### Community 118 - "test_governance_api.py"
Cohesion: 0.06
...
### Community 119 - "portfolio_intelligence.py"
Cohesion: 0.06
...
### Community 125 - "failover_client.py"
Cohesion: 0.06
...
Cohesion: 0.07
Nodes (28): Snapshot of one crawled page with the on-page facts the checks used., SeoPageAudit, analyze_page(), _count_syllables(), estimate_pixel_width(), flesch_reading_ease(), _host_key(), is_internal() (+20 more)

### Community 134 - "clear_cooldowns"
Cohesion: 0.06
...
Cohesion: 0.05
Nodes (39): _append_agent_session_message(), _build_auto_skill_guidance(), _build_provider_router(), _builtin_provider_records(), _chat_provider_policy(), _fallback_local_provider_record(), _in_container(), _list_configured_provider_records() (+31 more)

### Community 138 - "AgentScheduler"
Cohesion: 0.06
...
### Community 139 - "runtimes/manager.py"
Cohesion: 0.06
Nodes (43): OpenHandsAdapter, Any, TaskResult, TaskSpec, Create a conversation in OpenHands and poll for completion., Adapter for OpenHands — TIER 2 / EXPERIMENTAL coding agent. NOTE: OpenHands…, _build_default_manager(), _env_flag() (+35 more)
...
### Community 147 - "RuntimeCapabilityRegistry"
Cohesion: 0.07
...
Cohesion: 0.07
Nodes (41): Issue title: the failure mode plus how hard it is recurring., Stable id for a trend alert (matches ``TrendWatcher._sig`` shape)., trend_id(), fetch_research_alerts(), Run an async coroutine from sync code, safe even inside a running loop.…, Best-effort fetch of trend alerts. Returns [] if offline or unavailable., _run_coro_sync(), map_initiative_to_task() (+33 more)
...
### Community 151 - "TestHarnessAdapter"
Cohesion: 0.05
...
### Community 155 - "test_mcp_registry.py"
Cohesion: 0.08
...
### Community 157 - "test_ceo_router.py"
Cohesion: 0.07
...
### Community 159 - "TestEstimateTokensForMessages"
Cohesion: 0.05
...
### Community 160 - "test_response_cache.py"
Cohesion: 0.12
...
### Community 161 - "CEODispatcher"
Cohesion: 0.08
Nodes (34): CEODispatcher, _complexity_rank(), _offload(), Any, Semaphore, services/ceo_dispatcher.py — Real CEO delegation layer. The CEO splits a…, Run a synchronous ledger call without blocking the event loop. ``CEOLedger`` is…, Build an agent.coordinator.TaskSpec from a CEO SpecialistTask. (+26 more)
...
### Community 166 - "test_schedule_growth_invariants.py"
Cohesion: 0.05
...
### Community 168 - "test_daily_2026_07_27.py"
Cohesion: 0.07
...
### Community 171 - "AgentSwarm"
Cohesion: 0.06
Nodes (17): AgentSwarm, Any, Return the agent role responsible for *phase*., Return the AgentProfile for the agent driving *phase*., Return a JSON-serialisable summary of all agent profiles., Run a pre-gate or report phase through the correct agent. Enforces permission…, Execute a slice via the Coder agent (write-permitted)., Run verification commands via the Verifier agent. The Verifier is execution-… (+9 more)
...
### Community 178 - "test_trend_scoping.py"
Cohesion: 0.11
...
### Community 179 - "test_trend_watcher.py"
Cohesion: 0.07
Nodes (27): get_trend_watcher(), agent/trend_watcher.py — Internet-connected AI trend intelligence. Fetches from…, set_trend_watcher(), _FakeClient, _FakeResp, asyncio, Tests for agent/trend_watcher.py, Ensure expanded keyword set covers key new categories. (+19 more)
...
### Community 181 - "TaskBoardScreen.jsx"
Cohesion: 0.05
...
### Community 187 - "TestRuntimeControl"
Cohesion: 0.04
...
### Community 192 - "test_agent_free_brain.py"
Cohesion: 0.05
...
### Community 193 - "resolve_component_model"
Cohesion: 0.07
...
### Community 195 - "AnthropicProvider"
Cohesion: 0.09
...
### Community 196 - "test_classify_dependabot_update.py"
Cohesion: 0.08
...
### Community 199 - "test_schedule_backlog_drain.py"
Cohesion: 0.08
...
### Community 201 - "activation_api.py"
Cohesion: 0.09
...
### Community 203 - "test_e2b_data_flow.py"
Cohesion: 0.07
...
### Community 216 - "_require_admin"
Cohesion: 0.05
Nodes (41): _brain_provider_status(), BrainTestRequest, clear_cost_attribution(), clear_response_cache(), cost_table(), get_brain_policy_route(), purge_backlog(), _purge_backlog_core() (+33 more)
...
### Community 218 - "Persistent Memory System"
Cohesion: 0.05
...
### Community 220 - "NotificationDispatcher"
Cohesion: 0.07
...
### Community 230 - "WorkflowBuildRequest"
Cohesion: 0.07
...
### Community 232 - "AgentSessionStore"
Cohesion: 0.10
...
### Community 245 - "test_portfolio_intelligence.py"
Cohesion: 0.06
...
### Community 246 - "PatternConsolidation"
Cohesion: 0.10
...
### Community 247 - "system_instruction"
Cohesion: 0.09
...
Cohesion: 0.10
Nodes (34): get_audit_log(), packages/governance/audit.py — the evidence trail for every governed action.…, Redact secret-shaped substrings, then truncate., Return the process-wide audit log, created on first use., _scrub_inner(), _scrub_text(), _truncate(), _call() (+26 more)
...
### Community 252 - "NIMConnectionPool"
Cohesion: 0.08
...
### Community 258 - "test_implement_agent_routing.py"
Cohesion: 0.07
...
### Community 262 - "output_filter.py"
Cohesion: 0.07
...
### Community 267 - "_cfg"
Cohesion: 0.09
Nodes (12): _cfg(), tests/test_daily_automation_2026_08_29.py — Daily automation tests…, Verify Sonnet 5 pricing is still $2/$10 (permanent, not introductory)., Dated alias (2026-05-01) should also have the same $2/$10 pricing., Sonnet 5 at $2 input is cheaper than the earlier Sonnet 4.6 ($3)., Verify the qwen-3-235b-a22b-instruct-2507 entry in config/llm/models.yaml., Qwen3-235B has a much larger context window than Qwen3-Coder-480B., Must be classified as free so the free-brain failover chain uses it. (+4 more)
...
### Community 270 - "[Unreleased]"
Cohesion: 0.06
Nodes (35): Added, Added, Added, Added, Added, Added, Added, Added (+27 more)

### Community 271 - "configuration-reference.md"
Cohesion: 0.08
...
### Community 274 - "test_anthropic_router.py"
Cohesion: 0.09
...
### Community 278 - "report_to_markdown"
Cohesion: 0.11
...
### Community 279 - "agent_runtime.py"
Cohesion: 0.10
...
### Community 281 - "context_rules.py"
Cohesion: 0.11
...
### Community 283 - "test_platform_controls.py"
Cohesion: 0.08
...
### Community 290 - "ResourceWatchdog"
Cohesion: 0.10
...
### Community 299 - "Security Analysis — local-llm-server"
Cohesion: 0.06
...
### Community 304 - "OrchestratorQueue"
Cohesion: 0.07
...
### Community 308 - "test_workspace_isolation.py"
Cohesion: 0.16
...
### Community 309 - "test_direct_chat_evolution.py"
Cohesion: 0.11
...
### Community 317 - "session_retro.py"
Cohesion: 0.13
...
### Community 321 - "openclaw_gateway.py"
Cohesion: 0.09
...
Cohesion: 0.10
Nodes (18): Groq provider adapter — free, fast LLM (deepseek-r1-distill-llama-70b)., NVIDIA NIM provider adapter — wraps the existing provider_router logic. This is…, Ollama provider adapter — local LLM inference., packages.ai — provider abstraction, model registry, and failover manager., packages/ai/manager.py — ProviderManager. Single entry point for all LLM calls.…, ChatResponse, Provider, ABC (+10 more)
...
### Community 328 - "test_autonomy_gate.py"
Cohesion: 0.13
...
### Community 329 - "test_direct_chat_async.py"
Cohesion: 0.12
...
### Community 332 - "SteeringInjector"
Cohesion: 0.11
...
### Community 333 - "RuntimeHealthService"
Cohesion: 0.09
...
### Community 343 - "autonomous_fix.py"
Cohesion: 0.12
...
### Community 350 - "test_failover_silent_exhaustion.py"
Cohesion: 0.11
...
### Community 356 - "Deploy: FreeBuff Telegram bot (24×7)"
Cohesion: 0.07
...
### Community 357 - "Claude Code + Qwen Local Setup"
Cohesion: 0.07
...
### Community 360 - "traffic_director.py"
Cohesion: 0.11
...
### Community 361 - "test_brain_availability_doctor.py"
Cohesion: 0.16
...
### Community 370 - "platform_controls_router.py"
Cohesion: 0.10
...
### Community 373 - "model_discovery.py"
Cohesion: 0.11
...
### Community 374 - "test_chat_mode_regressions.py"
Cohesion: 0.13
...
### Community 378 - "brain_failover.py"
Cohesion: 0.12
...
### Community 380 - "test_telegram_approval_e2e.py"
Cohesion: 0.12
...
### Community 381 - "test_daily_automation_2026_08_03.py"
Cohesion: 0.11
...
### Community 382 - "test_provider_enable_disable.py"
Cohesion: 0.10
...
### Community 393 - "generate_context.py"
Cohesion: 0.13
...
### Community 395 - "test_claude_code_adapter.py"
Cohesion: 0.14
...
### Community 412 - "test_regression.py"
Cohesion: 0.12
...
### Community 414 - "TestDetectedSystemPersistence"
Cohesion: 0.09
...
### Community 427 - "OrchestratorCheckpointStore"
Cohesion: 0.13
...
### Community 430 - "test_monitor_lib.py"
Cohesion: 0.11
...
### Community 432 - "test_mostly_failed_steps.py"
Cohesion: 0.12
...
### Community 435 - "HarnessEnrichment"
Cohesion: 0.14
...
### Community 436 - "classify_direct_chat_intent"
Cohesion: 0.13
...
### Community 437 - "AdaptivePermissions"
Cohesion: 0.18
...
### Community 445 - "reap_expired_companies"
Cohesion: 0.15
...
### Community 446 - "test_memory_guard.py"
Cohesion: 0.13
...
### Community 451 - "_ensure_tasks_source_id_unique_index"
Cohesion: 0.14
...
### Community 463 - "Design Audit"
Cohesion: 0.10
Nodes (19): Code Quality, Color and Surfaces, Component Patterns, Content, Design Audit, Fix Priority, How This Works, Iconography (+11 more)

### Community 464 - "Findings"
Cohesion: 0.10
...
### Community 465 - "test_minimax_bug_fixes.py"
Cohesion: 0.12
...
### Community 473 - "KnowledgeScreen.jsx"
Cohesion: 0.13
...
### Community 478 - "test_kimi_bridge_server.py"
Cohesion: 0.12
...
### Community 500 - "Delegation Plan (agent-ready work packages)"
Cohesion: 0.11
...
### Community 502 - "parse_event_stream"
Cohesion: 0.15
...
### Community 509 - "test_one_model_catalogue.py"
Cohesion: 0.14
...
### Community 515 - "agile_sprints.py"
Cohesion: 0.14
...
### Community 520 - "render_router.py"
Cohesion: 0.14
...
### Community 521 - "Architecture Overview — local-llm-server"
Cohesion: 0.11
...
### Community 522 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
...
### Community 525 - "FeatureUnavailableError"
Cohesion: 0.12
...
### Community 526 - "scripts/doctor.py"
Cohesion: 0.29
...
### Community 533 - "test_llm_router_tpm.py"
Cohesion: 0.17
...
### Community 535 - "test_self_heal.py"
Cohesion: 0.11
...
### Community 536 - "test_telegram_service_webhook.py"
Cohesion: 0.18
...
### Community 537 - "handle_workflow_ide_chat"
Cohesion: 0.18
...
### Community 541 - "SKILL: Industrial Brutalism & Tactical Telemetry UI"
Cohesion: 0.12
...
### Community 542 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 543 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 544 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 548 - "probe_catalogues.py"
Cohesion: 0.21
...
### Community 549 - "provider_max_rpm"
Cohesion: 0.17
...
### Community 550 - "kimi_bridge_provider_config"
Cohesion: 0.18
...
### Community 551 - "agent_readiness_audit.py"
Cohesion: 0.21
...
### Community 552 - "test_ci.sh"
Cohesion: 0.15
Nodes (16): ADMIN_EMAIL, ADMIN_PASSWORD, API_KEYS, cleanup(), DB_NAME, fail(), LANGFUSE_HOST, LANGFUSE_PUBLIC_KEY (+8 more)

### Community 553 - ".delegate"
Cohesion: 0.12
Nodes (15): _merge_changed_files(), Build a single-task sub-task list (low-complexity fast path)., Decompose the request, wake runtimes, run sub-tasks concurrently, merge.…, Post-hoc independent re-check when a completed task touched a risky module.…, Collect changed_files across all specialists into a single de-duped list., _should_fan_out(), _single_specialist_task(), The orchestrator's re-export wrapper delegates to the canonical helper. (+7 more)
...
### Community 555 - "test_tasks_awaiting_approval_api.py"
Cohesion: 0.28
...
### Community 556 - "test_activation_api.py"
Cohesion: 0.21
...
### Community 563 - "test_skill_registry.py"
Cohesion: 0.13
...
### Community 564 - "test_task_service_failed_comment.py"
Cohesion: 0.18
...
### Community 571 - "_valid_login_state"
Cohesion: 0.24
...
### Community 572 - "Skill: repowise-intelligence"
Cohesion: 0.12
Nodes (15): 1. Graph Intelligence (Dependency Graph), 2. Git Intelligence, 3. Documentation Intelligence, 4. Decision Intelligence, Acceptance Checks, Directory Structure, Example Usage, Implementation Approach (+7 more)

### Community 573 - "The 10-Step Workflow"
Cohesion: 0.12
...
### Community 574 - "Contributing to local-llm-server"
Cohesion: 0.12
...
### Community 575 - "refresh_agent_built_proof.py"
Cohesion: 0.20
...
### Community 576 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 577 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 578 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
...
### Community 580 - "HealthStatus"
Cohesion: 0.14
Nodes (6): CerebrasProvider, Provider, Cerebras provider adapter — free, fast LLM (qwen-3-coder-480b)., HealthStatus, Provider health check result., Check provider health.

### Community 581 - "NvidiaProvider"
Cohesion: 0.13
...
### Community 589 - "ManagedAgentDreams"
Cohesion: 0.22
...
### Community 590 - "_process_task_callback"
Cohesion: 0.28
...
### Community 591 - "test_agency_workflows_carry_the_failover_chain.py"
Cohesion: 0.18
...
### Community 592 - "test_autonomy_status.py"
Cohesion: 0.12
...
### Community 594 - "test_dockerfile_ships_root_modules.py"
Cohesion: 0.17
...
### Community 595 - "test_langfuse_agency_wide.py"
Cohesion: 0.12
...
### Community 600 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 601 - "test_refresh_agent_built_proof.py"
Cohesion: 0.12
...
### Community 605 - "CollaborationContext"
Cohesion: 0.17
...
### Community 606 - "Skill: agent-harness"
Cohesion: 0.13
...
### Community 607 - "Skill: checkpoint-strategy"
Cohesion: 0.13
...
### Community 609 - "Skill: local-ai-query"
Cohesion: 0.13
...
### Community 611 - "Skill: parallel-worktrees"
Cohesion: 0.13
...
### Community 612 - "Design System: Taste Standard"
Cohesion: 0.13
...
### Community 614 - "Skill: user-research"
Cohesion: 0.13
...
### Community 615 - "DirectChatSession"
Cohesion: 0.14
...
### Community 620 - "router/health.py"
Cohesion: 0.20
...
### Community 621 - "DockerAgentAdapter"
Cohesion: 0.17
...
### Community 622 - "AdminDigestRouterAuthTests"
Cohesion: 0.22
...
### Community 624 - "telegram_service.py"
Cohesion: 0.16
...
### Community 627 - "DecisionsStoreTests"
Cohesion: 0.13
...
### Community 634 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 638 - "Checks Performed"
Cohesion: 0.14
...
### Community 639 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 640 - "admin_digest_router.py"
Cohesion: 0.22
...
### Community 645 - "Quick-Note Issues Processing Summary"
Cohesion: 0.14
...
### Community 646 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 648 - "Render MCP — autonomous platform debugging and environment monitoring"
Cohesion: 0.14
...
### Community 649 - "Runbook: Auto-Resume After Cooldown / Interruption"
Cohesion: 0.14
...
### Community 650 - "SEO / GEO / AIO Audit Engine"
Cohesion: 0.14
...
### Community 654 - "_parse_reset_epoch"
Cohesion: 0.21
...
### Community 659 - ".on_task_complete"
Cohesion: 0.16
...
### Community 662 - "TestMCPToolsListCache"
Cohesion: 0.19
...
### Community 665 - "test_openclaw_gateway.py"
Cohesion: 0.14
...
### Community 666 - "test_provider_state_durability.py"
Cohesion: 0.15
...
### Community 667 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 672 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 675 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 676 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 679 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
...
### Community 680 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 681 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 683 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 688 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
Nodes (12): Acceptance Checks, Claude's query protocol (use this instead of Read tool for exploration):, Graph Artifacts — What to Commit, How to Use the Graph (Token Savings Protocol), Installation (one-time per machine), Instead of reading raw files:, Key commands:, Relationship to repowise-intelligence Skill (+4 more)

### Community 689 - "Skill: platform-setup — Autonomous Agency Bootstrap"
Cohesion: 0.15
...
### Community 690 - "Device compatibility and model picks"
Cohesion: 0.15
...
### Community 691 - "Autonomy Uplift — Living Roadmap & Detailed Implementation Specs"
Cohesion: 0.15
...
### Community 692 - "OpenClaw — iOS Control of the Agency (Single-Service Free-Tier Deploy)"
Cohesion: 0.15
...
### Community 695 - "ApplyReviewAgent"
Cohesion: 0.22
...
### Community 697 - "_is_bedrock_model_id"
Cohesion: 0.27
...
### Community 698 - "verify_service_token"
Cohesion: 0.22
...
### Community 700 - "Agent Transparency Report"
Cohesion: 0.15
...
### Community 701 - "update_provider_policy"
Cohesion: 0.19
...
### Community 703 - "_InMemoryBackend"
Cohesion: 0.18
...
### Community 704 - "TestAgentRunnerSafety"
Cohesion: 0.19
...
### Community 707 - "TestDecisionsBotLinks"
Cohesion: 0.21
...
### Community 708 - "test_deploy_trigger_covers_image.py"
Cohesion: 0.21
...
### Community 709 - "TestTheGatewayRegistryOffersOnlyLiveModels"
Cohesion: 0.22
...
### Community 710 - "TestKillSwitchDurability"
Cohesion: 0.15
...
### Community 711 - "test_quick_note_engine.py"
Cohesion: 0.17
...
### Community 712 - "TestRouterIntegration"
Cohesion: 0.31
...
### Community 714 - "WorkspaceManifest"
Cohesion: 0.17
...
### Community 718 - "plan_next_sprint"
Cohesion: 0.17
...
### Community 723 - "Skill: system-prompt-audit"
Cohesion: 0.17
...
### Community 724 - "Skill: task-alive-updates"
Cohesion: 0.17
...
### Community 732 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 733 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 735 - "Quantization Internals"
Cohesion: 0.17
...
### Community 736 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 737 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 738 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 742 - "check_container_posture.py"
Cohesion: 0.26
...
### Community 743 - "test_pytest_failure_parser.py"
Cohesion: 0.23
...
### Community 750 - "test_task_clarification.py"
Cohesion: 0.17
...
### Community 754 - "_extractive_compress"
Cohesion: 0.18
...
### Community 757 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 760 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 761 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 763 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 766 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 767 - "Nothing is blocked on an agent. Three things need a human."
Cohesion: 0.18
...
### Community 768 - "Main proxy (`proxy.py`)"
Cohesion: 0.18
...
### Community 791 - "test_event_log.py"
Cohesion: 0.45
...
### Community 792 - "test_google_provider_models.py"
Cohesion: 0.18
...
### Community 793 - "TestNoNvidiaFallbackIsRetired"
Cohesion: 0.22
...
### Community 794 - "mint_access_token"
Cohesion: 0.18
...
### Community 798 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 799 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 800 - "admin_local_brain_router.py"
Cohesion: 0.22
...
### Community 801 - "_normalize_tool_choice"
Cohesion: 0.31
...
### Community 802 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 803 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 804 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 805 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 806 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 807 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 808 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 810 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 811 - "LLM Router — configuration guide"
Cohesion: 0.20
...
### Community 812 - "LLM Router — provider guide"
Cohesion: 0.20
...
### Community 813 - "CI Troubleshooting Runbook"
Cohesion: 0.20
...
### Community 818 - "_harvest_changed_files"
Cohesion: 0.29
...
### Community 820 - "_redact_for_notification"
Cohesion: 0.24
...
### Community 823 - "TestPoliciesGovernanceStableClaim"
Cohesion: 0.20
...
### Community 861 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 865 - "TestPolicyAuthoringUiStableClaim"
Cohesion: 0.22
...
### Community 874 - "CapacityAllocation"
Cohesion: 0.25
...
### Community 875 - "quality_checker.py"
Cohesion: 0.32
...
### Community 928 - "capture_screens.py"
Cohesion: 0.39
...
### Community 931 - "run_patched_colibri.py"
Cohesion: 0.36
...
### Community 933 - "test_compose_and_coordinate_api.py"
Cohesion: 0.36
...
### Community 934 - "test_generate_context_standing_instructions.py"
Cohesion: 0.32
...
### Community 935 - "test_local_brain_router_smoke.py"
Cohesion: 0.25
...
### Community 939 - "test_provider_models_db_outage.py"
Cohesion: 0.25
...
### Community 940 - "test_runtimes_health_endpoint.py"
Cohesion: 0.25
...
### Community 942 - "test_serve_spa_prefixes.py"
Cohesion: 0.36
...
### Community 944 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.25
...
### Community 946 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 975 - "Cloudflare = the real working app"
Cohesion: 0.29
...
### Community 983 - "e2e_smoke.py"
Cohesion: 0.57
Nodes (5): _chat(), check(), _health(), _models(), _req()

### Community 984 - "BackgroundServices"
Cohesion: 0.38
...
### Community 989 - "TestSupportMatrixDocsSync"
Cohesion: 0.29
...
### Community 992 - "TestGithubTokenSQLiteRegression"
Cohesion: 0.38
...
### Community 993 - "TestReasonsAreActionable"
Cohesion: 0.29
...
### Community 994 - "TestProvidersScreen"
Cohesion: 0.43
...
### Community 1000 - "openclaw_mobile_ui"
Cohesion: 0.33
...
### Community 1015 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 1016 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 1017 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 1018 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 1019 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 1020 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 1021 - "StatusPill.jsx"
Cohesion: 0.47
Nodes (5): C, STATUS_META, StatusPill(), TONE_BG(), TONE_BORDER()

### Community 1022 - "get_control"
Cohesion: 0.33
...
### Community 1023 - "apply_phase1_changes.py"
Cohesion: 0.33
...
### Community 1030 - "setup-claude-code.sh script"
Cohesion: 0.60
...
### Community 1052 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 1053 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 1054 - "Runtime troubleshooting"
Cohesion: 0.40
Nodes (4): Agent mode timeout, Missing binary / task harness, Runtime troubleshooting, Workspace validation failures

### Community 1055 - "knowledgeGraphTab.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 1056 - "loginFlowNoTimeout.test.js"
Cohesion: 0.40
Nodes (4): apiSource, { describe, test, expect }, fs, path

### Community 1057 - "test_company_stale_id_recovery.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 1058 - "worker_no_cache.test.js"
Cohesion: 0.40
...
### Community 1063 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1064 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1065 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 1066 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 1075 - "test_agent_runtime_wrapper.py"
Cohesion: 0.70
...
### Community 1077 - "TestDirectChatNonBlocking"
Cohesion: 0.40
...
### Community 1078 - "TestModelRoleSeparation"
Cohesion: 0.40
...
### Community 1093 - "stop_colibri_server.ps1"
Cohesion: 0.83
Nodes (3): Fail(), Ok(), W()

### Community 1095 - "start_server.sh"
Cohesion: 0.50
Nodes (3): OLLAMA_HOST, OLLAMA_MODELS, start_server.sh script

### Community 1096 - "check_services"
Cohesion: 0.67
...
### Community 1105 - "test_no_exception_detail_leaks.py"
Cohesion: 0.50
...
### Community 1106 - "github"
Cohesion: 0.50
Nodes (3): github, enabled, silent

### Community 1130 - "test_the_reserve_is_bounded_when_read_from_the_environment"
Cohesion: 0.67
...
- **Why does `_fixture()` connect `_fixture` to `WebsiteScanner`, `config.py`, `test_operational_incidents.py`, `TaskStore`, `test_llm_router_strategies.py`, `test_llm_router_queue_cache.py`, `test_model_router.py`, `Task`, `llm/router.py`, `test_company_api.py`, `Agency`, `E2BSandboxSession`, `test_llm_router_resilience.py`, `test_llm_router_tpm.py`, `SelfHealingAgent`, `test_telegram_service_webhook.py`, `services/background.py`, `test_unit8_model_catalog.py`, `test_failover_client_shared.py`, `PolicyEngine`, `ImprovementLoop`, `TaskExecutionCoordinator`, `get_task_store`, `test_openclaw_endpoints.py`, `KeyPool`, `test_task_service_failed_comment.py`, `TaskWorkflowService`, `SeoAuditEngine`, `PrimeAgentAdapter`, `ChatHistoryStore`, `_clean_director`, `TokenBudget`, `SQLiteStore`, `BrainWatchdog`, `ResearchTask`, `validate_policy_text`, `_resolve_brain_provider`, `TestClient`, `test_ai_insights.py`, `test_autonomy_status.py`, `sam`, `test_procedural_memory.py`, `test_local_brain_state.py`, `test_telegram_auto_approve.py`, `test_phase5_doctor.py`, `BackgroundAgent`, `test_refresh_agent_built_proof.py`, `test_startup_warmup.py`, `test_telegram_diag_endpoint.py`, `OutputFilter`, `test_agent_tool_governance.py`, `test_provider_router.py`, `model_router.py`, `test_knowledge_sync.py`, `run_task`, `test_brain_failover.py`, `KeyStore`, `e2e/test_browser.py`, `SeoFixer`, `test_context_rulebook.py`, `UserRole`, `ArtifactStore`, `claim`, `services/seo_audit.py`, `clear_cooldowns`, `Usage`, `CEOLedger`, `_step`, `_resolve_push_token`, `.on_task_complete`, `test_portfolio_intake.py`, `TestHarnessAdapter`, `test_openclaw_gateway.py`, `test_provider_state_durability.py`, `MCPClient`, `test_ceo_router.py`, `persist_plan_spec`, `TestEstimateTokensForMessages`, `test_daily_2026_07_27.py`, `AgentSwarm`, `test_new_features_e2e.py`, `test_e2b_task_wiring.py`, `test_trend_scoping.py`, `test_trend_watcher.py`, `OllamaCircuitBreaker`, `_Budget`, `_job_text`, `TestRuntimeControl`, `TestAuthAndTaskOwnership`, `TestAgentRunnerSafety`, `test_features_api.py`, `test_video_transcript.py`, `test_e2b_data_flow.py`, `SchedulerStore`, `test_process_quick_note_workflow.py`, `_require_admin`, `apply_review.py`, `NotificationDispatcher`, `TrendWatcher`, `WorkflowBuildRequest`, `test_agile_api.py`, `test_app_settings.py`, `test_task_clarification.py`, `test_llm_router_disabled.py`, `TestClient`, `_provider`, `ContextPruner`, `test_control_plane_api.py`, `test_implement_agent_routing.py`, `test_persistent_memory.py`, `SecurityScanner`, `test_llm_router_e2e.py`, `test_platform_controls.py`, `test_rate_limiter.py`, `test_sam_voice.py`, `OrchestratorQueue`, `test_nvidia_model_discovery.py`, `test_direct_chat_evolution.py`, `_resolve_user_github_token`, `TestNormalizeResponseFormat`, `TestMongoGate`, `session_retro.py`, `test_purge_backlog.py`, `test_telegram_mutating_commands.py`, `test_direct_chat_async.py`, `test_scheduler_hydration_bounded.py`, `_get`, `test_agent_scripts_share_one_model_list.py`, `_start_ceo_agency`, `test_crispy_burn_in.py`, `test_skill_registry_boot_refresh.py`, `isolated_telegram_config`, `platform_controls_router.py`, `model_discovery.py`, `test_provider_enable_disable.py`, `_undeclared`, `test_dashboard_cache.py`, `test_claude_code_adapter.py`, `test_service_token.py`, `test_harness_spec.py`, `test_regression.py`, `test_agency_fix.py`, `test_webui_provider_priority.py`, `test_ping.py`, `OrchestratorCheckpointStore`, `test_runtimes_health_endpoint.py`, `test_monitor_lib.py`, `test_task_store_fails_loud_in_production.py`, `test_v4_api.py`, `reap_expired_companies`, `client`, `test_doctor_coding_brain.py`, `TestFeaturesAPI`, `test_kimi_bridge_server.py`, `test_voice_pipeline.py`, `parse_event_stream`, `test_brain_patch_service_token.py`?**
  _High betweenness centrality (0.112) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `FreeBuffAgent`, `proxy.py`, `direct_chat.py`, `test_backend_server_features.py`, `test_ceo_dispatcher.py`, `Surface`, `_resolve_push_token`, `E2BSandboxSession`, `Agency`, `test_empirical_verify.py`, `MCPClient`, `TaskSpec`, `ContextManager`, `CEODispatcher`, `WorkflowRun`, `MultiAgentSwarm`, `test_failover_client_shared.py`, `PolicyEngine`, `TestAgentLoopMCPIntegration`, `test_daily_automation_2026_07_11.py`, `WorkspaceTools`, `StuckDetector`, `ReactScratchpad`, `test_agent_free_brain.py`, `TestAgentRunnerSafety`, `test_agent_chat_integration.py`, `TokenBudget`, `test_direct_chat_async.py`, `AgentPlan`, `E2BAdapter`, `LocalWorkspace`, `BackgroundAgent`, `test_agent_tool_governance.py`, `UserMemoryStore`, `GitHubTools`, `AgentSessionStore`, `test_brain_failover.py`, `InternalAgentAdapter`, `test_governance_api.py`, `AdaptiveHalter`, `ContextPruner`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderRouter` to `backend/server.py`, `test_implement_agent_routing.py`, `clear_cooldowns`, `direct_chat.py`, `test_backend_server_features.py`, `test_all_providers_discovery.py`, `test_bedrock_live.py`, `test_anthropic_router.py`, `implement_agent.py`, `kimi_bridge_provider_config`, `resolve_active_brain`, `TestAnthropicPayloadStructuredOutput`, `Provider`, `test_colibri_provider.py`, `NvidiaProvider`, `TestRouterIntegration`, `ProviderConfig`, `TrafficDirector`, `test_bedrock_provider.py`, `TestOpenAiToBedrockConverse`, `test_provider_router.py`, `test_brain_failover.py`, `test_chat_mode_regressions.py`, `system_instruction`, `failover_client.py`?**
