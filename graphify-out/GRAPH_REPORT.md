...
- Findings
- facade.py
- Brag Plan: Autonomous AI Agency
- cost_tracker.py
- Skill: modularity-review
- crispy_client.py
- 4. Troubleshooting
...
## Communities (1343 total, 177 thin omitted)

### Community 0 - "backend/server.py"
Cohesion: 0.01
Nodes (286): admin_seed(), _agent_timeout_fallback_response(), AgentStatusEntry, AgentStatusResponse, AgentToolCallEntry, ApiKeyCreate, auth_me(), AuthorizeReposBody (+278 more)

### Community 1 - "test_portfolio_intake.py"
Cohesion: 0.08
Nodes (34): Weighted Shortest Job First score — higher schedules sooner., map_initiative_to_task(), materialize_committed(), _wsjf(), _portfolio_materialize_enabled(), portfolio_source_id(), Any, tasks/portfolio_intake.py — Portfolio initiative → Task materializer. Converts… (+26 more)

### Community 2 - "brain_config.py"
Cohesion: 0.03
Nodes (96): Call-time resolver for an agent role model id. Delegates to…, _resolve_role_model(), _active_primary_provider(), BrainConfig, BrainConfigStore, default_brain_config(), is_north_mini_code_default(), provider_base_url() (+88 more)

### Community 3 - "test_llm_router_queue_cache.py"
Cohesion: 0.02
Nodes (114): Test hook — clear all usage accounting., reset(), CacheManager, cosine_similarity(), _Entry, LRUCache, payload_key(), Any (+106 more)

### Community 4 - "_fixture"
Cohesion: 0.01
Nodes (120): Reset the singleton (for tests)., reset_failover_manager(), Set the global task store instance (e.g., during app startup with MongoDB)., set_task_store(), base_url(), mobile_page(), proxy_url(), Config (+112 more)

### Community 5 - "proxy.py"
Cohesion: 0.03
Nodes (147): admin_control(), admin_login(), admin_status(), AdminControlBody, AdminLoginBody, AdminUpdateKeyBody, agency_status(), agent_chat() (+139 more)
...
Cohesion: 0.02
Nodes (185): account_lifecycle(), AccountLifecycleResponse, auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint(), _DoctorCheck, _DoctorReport (+177 more)

### Community 8 - "TaskStatus"
Cohesion: 0.04
Nodes (89): packages/ai/self_heal.py — automatic brain self-healing. When the active brain…, Helpers that turn scheduler and playbook activity into real tasks., Creates tasks from scheduler and playbook runs using one workflow., TaskAutomationService, TaskStatus, Record the human decision on a task's **pre-execution** approval gate. A…, Re-run a task. Permissive across every non-active state so the dashboard Retry…, Add a follow-up instruction to a task and re-queue it for execution. Unlike… (+81 more)

### Community 9 - "TaskSpec"
Cohesion: 0.03
Nodes (95): kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, AiderAdapter, Any, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Run aider non-interactively via `--message` flag., Adapter for Aider — TIER 3 specialized git-aware code editor., json_safe() (+87 more)

### Community 10 - "test_llm_router_gateway.py"
Cohesion: 0.04
Nodes (44): health(), metrics_json(), toggle_provider(), get_tracker(), The process-wide health tracker., _Counter, _escape(), _Gauge (+36 more)

### Community 11 - "test_agent_runner.py"
Cohesion: 0.04
...
### Community 13 - "test_telegram_freebuff.py"
Cohesion: 0.07
...
### Community 14 - "llm/router.py"
Cohesion: 0.03
Nodes (136): int, get_budget(), packages/llm/budget.py — token and cost accounting with spend alerts. Tracks…, The process-wide budget tracker., get_cache(), The process-wide cache manager., failover_chat_completion_via_router(), openai_body_from_response() (+128 more)

### Community 15 - "LLMRequest"
Cohesion: 0.03
Nodes (110): ProviderConfig, One configured endpoint. ``kind`` selects the adapter: ``openai`` (any OpenAI-…, OpenAICompatible, Adapter for any endpoint speaking the OpenAI chat-completions shape. Adding a…, build_provider(), Normalise a configured ``kind`` to an adapter key., Instantiate the adapter for one provider config. Unknown kinds fall back to the…, resolve_kind() (+102 more)

### Community 16 - "test_llm_router_strategies.py"
Cohesion: 0.03
...
### Community 17 - "telegram_bot.py"
Cohesion: 0.07
Nodes (55): Convenience: resolve all four role models for a component. Returns a dict with…, resolve_component_role_models(), Return a Markdown-v1-safe preview string under ``max_chars``. Used by the…, sanitize_paste_for_preview(), _admin_headers(), _api_headers(), _check_rate_limit(), cmd_control() (+47 more)
...
Cohesion: 0.03
Nodes (129): _complexity_rank(), _decompose_into_subtasks(), _offload(), Any, Semaphore, services/ceo_dispatcher.py — Real CEO delegation layer. The CEO splits a…, Run a synchronous ledger call without blocking the event loop. ``CEOLedger`` is…, Build an agent.coordinator.TaskSpec from a CEO SpecialistTask. (+121 more)

### Community 20 - "test_render_mcp.py"
Cohesion: 0.04
Nodes (48): agent/mcp_client.py — Async MCP client for the mcp-server Docker container.…, _as_list(), _coerce_payload(), Any, RuntimeError, packages/integrations/render_mcp.py — Render platform access over MCP. The…, Return tool output as Python data. MCP tool results arrive either as…, Normalise a tool payload into a list of dicts. Upstream tools variously return… (+40 more)

### Community 21 - "test_model_router.py"
Cohesion: 0.03
...
### Community 22 - "AgentRunner"
Cohesion: 0.03
Nodes (64): AgentRunner, _run(), _check_extra_kwargs(), _enforce_signature(), Any, Raise TypeError if fn's signature drifts from the locked contract (Pydantic…, Raise TypeError on unknown kwarg (runtime extra='forbid' for non-Pydantic…, Governance seam: judge the call, run it, audit the outcome. Deliberately a thin… (+56 more)

### Community 23 - "NotificationDispatcher"
Cohesion: 0.07
...
### Community 24 - "test_slop_gate.py"
Cohesion: 0.07
...
Cohesion: 0.05
Nodes (48): analyze_qualitative(), _classify_sentiment(), _extract_keywords(), plan_research(), Any, BaseModel, field_validator, QualAnalysis (+40 more)

### Community 29 - "test_autonomous_agency_e2e.py"
Cohesion: 0.06
Nodes (37): BackgroundAgent, heartbeat(), BackgroundTask, _now(), Any, agent/background.py — Background Agent An always-on worker thread that…, Enqueue *task* for processing. Returns the task (with task_id set)., Convenience: create a task and submit it in one call. (+29 more)

### Community 30 - "Task"
Cohesion: 0.05
Nodes (47): Full task/issue document., Update the updated_at timestamp., Task, Create a task. Deduplicates by source_id if set (Charter G3). If a task with…, Fetch a task by ID. If owner_id is set, enforces ownership., Return the task previously created for an external ``source_id`` (e.g.…, asyncio, test_list_pending_orders_by_priority_then_updated_at() (+39 more)

### Community 31 - "OnboardingService"
Cohesion: 0.03
Nodes (69): Evidence, OnboardingProgress, Result of a website scan with detected systems and stack inference., Evidence supporting a system detection., Tracks the onboarding progress for a company., Result of a repository scan with detected stack and systems., Inferred technology stack from website/repo analysis., RepoScanResult (+61 more)

### Community 32 - "nvidia_models.py"
Cohesion: 0.05
...
### Community 33 - "resolve_active_brain"
Cohesion: 0.05
...
### Community 34 - "build_governance_router"
Cohesion: 0.04
Nodes (59): build_governance_router(), approve(), _decide(), deny(), destroy_sandbox(), get_audit(), get_budget(), get_metrics() (+51 more)

### Community 35 - "PolicyEngine"
Cohesion: 0.04
Nodes (87): _egress_policy_reason(), agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Return why governance policy blocks *host*, or None. Runs strictly *after* the…, governance_enabled(), True when the governance layer should run at all. A single global off switch…, _action_matches(), _as_list(), Decision (+79 more)

### Community 36 - "services/background.py"
Cohesion: 0.05
Nodes (77): get_improvement_loop(), _dispatch_async(), _ErrorCaptureHandler, get_log_monitor(), LogMonitor, _note_recurrence(), Any, LogRecord (+69 more)

### Community 37 - "test_phase6_workflow.py"
Cohesion: 0.12
Nodes (28): Return True if the PR exists and is open or merged; False if 404., verify_pr_exists(), _make_store(), _make_task(), asyncio, parametrize, tests/test_phase6_workflow.py — Phase 6: workflow engine, safe_agency, Task…, Create a minimal Task for testing. (+20 more)

### Community 38 - "skill_bindings.py"
Cohesion: 0.09
...
Cohesion: 0.02
Nodes (94): Execute work through the 11-phase golden path., Called by APScheduler when a cron fires. Dispatches to the orchestrator. This…, _scheduler_on_fire(), workflow_orchestrator_execute(), OrchestratorSupervisor, Any, Emit an alert to the activity feed and log., Deterministic supervisor for the orchestrator. Runs as a background coroutine.… (+86 more)

### Community 40 - "test_failover_client_shared.py"
Cohesion: 0.06
Nodes (91): BrainFailoverExhausted, failover_chat_completion(), FailoverResult, _log_recovery(), RuntimeError, Every provider in the failover chain failed — the terminal error. Carries the…, A successful completion plus the accounting its callers need., Report a successful failover at INFO — recovery is not an incident. Everything… (+83 more)

### Community 41 - "SQLiteStore"
Cohesion: 0.03
Nodes (60): DetectedSystem, Find a website by its URL., A business system detected on a company's website or in their stack., Get the most confident evidence description., A company website with detected systems and stack inference., Website, Prepare a SQLite row for Pydantic model., Create a new company in SQLite. (+52 more)

### Community 42 - "MongoDBStore"
Cohesion: 0.04
Nodes (49): KnowledgeItem, Find knowledge items matching any of the given tags., Structured knowledge about the company, systems, or processes., MongoDBStore, Any, ObjectId, Prepare a Pydantic model for SQLite storage., Update a knowledge item in SQLite. (+41 more)

### Community 43 - "UserRole"
Cohesion: 0.08
Nodes (37): UserRole, _can_read(), _can_write(), _decrypt(), _encrypt(), _get_master_key(), BaseModel, Enum (+29 more)

### Community 44 - "test_mcp_registry.py"
Cohesion: 0.04
Nodes (54): get_mcp_client(), Return the module-level MCPClient. Reads MCP_SERVER_BASE_URL at call time (not…, _internal_configured(), list_specs(), MCPServerSpec, _not_dialable(), _playwright_configured(), _playwright_spec() (+46 more)

### Community 45 - "test_llm_router_resilience.py"
Cohesion: 0.03
Nodes (72): Backoff policy for retryable failures., RetryConfig, BreakerState, Enum, str, _digest(), get_ring(), KeyRing (+64 more)

### Community 46 - "autonomous_fix.py"
Cohesion: 0.08
...
Cohesion: 0.04
Nodes (92): ApprovalPolicy, BusinessSystem, Company, CompanyCreateRequest, CompanyGraph, CompanyGraphSnapshot, CompanyUpdateRequest, Connector (+84 more)
...
### Community 52 - "test_orchestrator_merge_decision.py"
Cohesion: 0.24
...
### Community 53 - "AnthropicProvider"
Cohesion: 0.04
...
### Community 54 - "test_ceo_dispatcher.py"
Cohesion: 0.03
Nodes (132): CEOResult, _merge_changed_files(), Reset the singleton (test helper)., Aggregated output from a multi-specialist execution., Post-hoc independent re-check when a completed task touched a risky module.…, Collect changed_files across all specialists into a single de-duped list., reset_ceo_dispatcher(), BoundContext (+124 more)

### Community 55 - "[Unreleased]"
Cohesion: 0.05
Nodes (41): Added, Added, Added, Added, Added, Added, Added, Added (+33 more)

### Community 56 - "ProviderRouter"
Cohesion: 0.05
Nodes (28): _exponential_backoff_cooldown(), _notify_watchdog(), ProviderAttempt, ProviderRouter, Any, Try all models for one provider. Returns ProviderResult on success, None on…, Notify the brain watchdog of a provider call outcome (fire-and-forget).…, Parse a 429/503 ``Retry-After`` header → seconds, or None. Accepts either… (+20 more)
...
### Community 58 - "test_brain_failover.py"
Cohesion: 0.10
...
Cohesion: 0.04
Nodes (85): CEODispatcher, _harvest_changed_files(), Extract the files a runtime touched. Returns ``(files, reported)``. Adapters…, Real CEO delegation: wake runtimes, fan out, and merge results., Best-effort wake of any sleeping runtimes via RuntimeManager. Returns runtime…, Attempt, services/ceo_ledger.py — durable record of what the CEO is driving to closure.…, One delegation of one subtask to one tier. (+77 more)

### Community 61 - "RenderOpsMonitor"
Cohesion: 0.06
...
### Community 62 - "SeoAuditEngine"
Cohesion: 0.03
Nodes (52): field_validator, A single occurrence of a check firing on a specific URL., Aggregated report row - Screaming Frog CSV compatible., Site-level facts discovered during the crawl., Request to run an SEO/GEO/AIO audit against a website., SeoAuditRequest, SeoIssueInstance, SeoIssueReportRow (+44 more)

### Community 63 - "AgentJobManager"
Cohesion: 0.03
Nodes (71): PreflightIssue, PreflightReport, BaseModel, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, AgentJob, AgentJobManager, heartbeat(), make_isolated_workspace() (+63 more)

### Community 64 - "HarnessEnrichment"
Cohesion: 0.14
...
Cohesion: 0.04
Nodes (67): _acquire_provider_probe(), _dead_model_key(), _get_director(), is_commercial_provider(), _mark_model_dead(), _normalized_provider_type(), provider_access_tier(), _provider_field() (+59 more)

### Community 66 - "test_governance_enforcement.py"
Cohesion: 0.04
Nodes (86): ApprovalStatus, str, BudgetTracker, GovernanceGate, Per-session consumption counters and their ceilings. Ceilings come from the…, Return the name of the first exhausted session-wide limit, or None. Only covers…, Return a reason string if *tool* has hit its per-tool session cap. Checks only…, Holds live session budgets, bounded so it cannot leak. Sessions end without… (+78 more)

### Community 67 - "test_provider_router.py"
Cohesion: 0.05
Nodes (45): extract_openai_text(), _normalize_nvidia_base_url(), _openai_url(), Normalize NVIDIA base URLs to avoid double /v1 when openai_compat_url appends…, _clear_probe_locks(), anyio, A 429 (e.g. 40 rpm hit) must NOT retry the same provider — it fails over to the…, When a provider call fails (and failover succeeds), the brain watchdog's… (+37 more)

### Community 68 - "test_model_catalog.py"
Cohesion: 0.05
...
Cohesion: 0.05
Nodes (72): quick_notes_submit(), _QuickNoteBody, Submit a quick-note URL or instruction from the dashboard FAB., Path, Start RuntimeManager, TaskDispatcher, SCHEDULER, and self-bootstrap. Returns a…, Fire-and-forget self-bootstrap; never blocks or crashes startup., _schedule_self_bootstrap(), start_background_services() (+64 more)

### Community 70 - "AgentJobRequest"
Cohesion: 0.06
...
### Community 71 - "test_cost_aware_routing_eval.py"
Cohesion: 0.06
...
### Community 81 - "LlmProviderConfig"
Cohesion: 0.13
...
### Community 82 - "CompanyGraphService"
Cohesion: 0.03
Nodes (38): BusinessCategory, requires_db, CompanyGraphService, SpecialistFamily, SystemType, Get a company by ID. Args: company_id: Company ID Returns: Company instance or…, Update a company. Args: company_id: Company ID **kwargs: Fields to update…, Delete a company and all its associated data. The store only clears the… (+30 more)

### Community 83 - "PrimeAgentAdapter"
Cohesion: 0.05
Nodes (32): _child_env(), _kill_and_reap(), PrimeAgentAdapter, Terminate a subprocess and wait for it, ignoring races. ``asyncio.wait_for``…, Build the allowlisted environment for the CLI subprocess., Adapter for the Prime Agent / pi coding CLI., Return the path of the first available CLI binary, or None., Parse ``--help`` once to learn which flags this build accepts. ``prime-agent``… (+24 more)

### Community 84 - "test_ceo_router.py"
Cohesion: 0.04
...
### Community 86 - "RepowiseIntelligence"
Cohesion: 0.06
...
### Community 87 - "LLMRouter"
Cohesion: 0.07
Nodes (28): Read the environment variables named in ``env_names`` into a key list. Order is…, resolve_keys(), LLMRouter, Any, AsyncClient, BaseException, One shared connection pool. Reconnects if it was closed., Route one completion, retrying and failing over until it succeeds. (+20 more)

### Community 88 - "AgentSessionStore"
Cohesion: 0.03
Nodes (62): Agent subsystem — planner / executor / verifier loop., AgentEvent, AgentPlan, AgentRunRequest, AgentSession, AgentSessionCreateRequest, AgentSessionMessage, AgentStep (+54 more)

### Community 89 - "AgentSwarm"
Cohesion: 0.05
Nodes (57): AgentRole, AgentSwarm, Any, agents/swarm.py — AgentSwarm: routes workflow phases to the correct agent. The…, Return the agent role responsible for *phase*., Return the AgentProfile for the agent driving *phase*., Return a JSON-serialisable summary of all agent profiles., Run a pre-gate or report phase through the correct agent. Enforces permission… (+49 more)

### Community 90 - "test_unit8_model_catalog.py"
Cohesion: 0.04
Nodes (72): _brain_provider_status(), Return per-provider metadata for the GET endpoint. Iterates every provider in…, Return the discovered model list for *provider_id*, or ``[]`` if unknown., _served_models(), all_provider_ids(), _provider_ids_from_literal(), provider_key_present(), Return every provider id recognised by the brain config system. Iterates the… (+64 more)

### Community 91 - "setup/api.py"
Cohesion: 0.06
Nodes (72): is_user_onboarding_allowed(), Return True if this user may run the onboarding wizard. Resolution order: 1. If…, audit(), get_audit_log(), Append an audit log entry. Never logs raw secrets — only secret IDs / masked…, Return recent audit log entries, newest first. Supports filtering by user_id,…, clear_wizard_state_cache(), complete_wizard() (+64 more)
...
### Community 93 - "test_operational_incidents.py"
Cohesion: 0.02
...
### Community 94 - "agent/workspace.py"
Cohesion: 0.05
...
### Community 95 - "seo_portfolio_bridge.py"
Cohesion: 0.05
...
### Community 96 - "resolve_e2b_config"
Cohesion: 0.05
...
### Community 98 - "TestModelRoleSeparation"
Cohesion: 0.40
...
### Community 101 - "test_gh_brain_failover.py"
Cohesion: 0.10
Nodes (11): gh_brain_failover(), Regression test for the auto-PR scripts' brain failover. On 2026-09-06 the…, Guards the actual regression: the crash-prone single-call site is gone., An empty string is falsy — this used to be returned as a live NVIDIA candidate…, The regression itself: a 402 (or any non-2xx) must not be fatal while another…, TestAutonomousAgentUsesTheSharedFailover, TestBrainCandidates, TestCallBrainWithFailover (+3 more)

### Community 102 - "test_knowledge_sync.py"
Cohesion: 0.07
...
### Community 103 - "PersistentMemoryStore"
Cohesion: 0.08
Nodes (26): Memory middleware for automatic context injection into AI tool requests. This…, MemoryCategory, MemoryEntry, MemoryScope, PersistentMemoryStore, Any, Connection, Enum (+18 more)

### Community 104 - "TokenBudget"
Cohesion: 0.05
Nodes (32): BudgetUsage, Any, Raise :class:`BudgetExceededError` if the session has exceeded its cap., Reset usage counters for *session_id* (cap is preserved)., Reset token counters for all sessions (caps preserved). Called at the start of…, Reset all budgets if the UTC calendar day has changed since last reset. Safe to…, Generate a token savings analytics report. Returns per-session statistics and…, Track and enforce per-session or per-agent token budgets. Usage:: budget =… (+24 more)

### Community 105 - "test_brain_priority_scanner.py"
Cohesion: 0.09
...
### Community 106 - "test_provider_state_durability.py"
Cohesion: 0.17
...
Cohesion: 0.04
Nodes (87): Any, Translate technical preflight issues into a conversational assistant reply., translate_error_to_conversational(), classify_direct_chat_intent(), _contains_keyword(), detect_intent(), intent.py — Intent classification for direct chat (answer_only, execute_now,…, Return True if content contains any execution or analysis keyword. (+79 more)

### Community 108 - "PortfolioManager"
Cohesion: 0.03
Nodes (43): Initiative, InitiativeProgress, PortfolioManager, PortfolioMetrics, Delivery roll-up for a single initiative across its linked sprints., Percentage of linked sprint points completed., Aggregate metrics across the whole portfolio., Manages a portfolio of initiatives with WSJF prioritisation and roadmapping. (+35 more)
...
### Community 114 - "OnboardingScreen.jsx"
Cohesion: 0.04
...
### Community 115 - "context_rules.py"
Cohesion: 0.11
...
### Community 116 - "LogWatcher"
Cohesion: 0.08
Nodes (17): LogWatcher, Background daemon that monitors logs and creates GitHub issues for errors.…, Start the log watcher in a daemon thread., Signal the watcher to stop., Force an immediate scan. Returns any errors found (synchronous). Incremental:…, Discover log files from configuration or common paths., Main daemon loop: scan periodically., Read new content from a log file and extract error entries. Args: file_path:… (+9 more)

### Community 117 - "config.py"
Cohesion: 0.03
Nodes (80): AgentPolicy, _apply_env_overrides(), _apply_key_env(), _build(), _coerce(), config_dir(), _env_key_names(), expand_env() (+72 more)
...
### Community 121 - "test_trend_watcher.py"
Cohesion: 0.06
...
### Community 124 - "portfolio_intelligence.py"
Cohesion: 0.06
Nodes (47): generate_backlog_retro(), generate_standup(), Derive a retrospective from the task tracker when no sprint is active. DONE /…, Build a :class:`StandupReport` from ``.claude/state/active-tasks.md``. Reads…, InitiativeStatus, _bug_scores(), _clean(), _default_repo() (+39 more)

### Community 125 - "test_bedrock_provider.py"
Cohesion: 0.06
...
### Community 126 - "test_agent_tool_governance.py"
Cohesion: 0.05
...
### Community 127 - "test_one_model_catalogue.py"
Cohesion: 0.08
...
### Community 130 - "Agency"
Cohesion: 0.05
Nodes (46): Agency, AgencyCycleResult, AgentDirective, AgentRole, _build_ceo_prompt(), _build_quick_note_instruction(), _close_github_issue(), _collect_recent_git_context() (+38 more)

### Community 131 - "ArtifactStore"
Cohesion: 0.06
...
### Community 134 - "AgileSprint"
Cohesion: 0.03
Nodes (51): _bullets(), generate_sprint_retro(), plan_next_sprint(), Agentic Agile — autonomous ceremonies (standup, retro, sprint planning). Where…, Render a :class:`Retrospective` as a markdown section., Derive retro notes for ``sprint`` from its current metrics. Records…, The result of allocating portfolio capacity into a new sprint., Render the sprint plan as markdown. (+43 more)

### Community 135 - "KeyStore"
Cohesion: 0.07
Nodes (38): Backward-compatibility shim — use scripts/generate_api_key.py instead. This…, _check_rate_limit(), default_keys_path(), issue_new_api_key(), KeyRecord, KeyStore, load_key_store(), Exception (+30 more)

### Community 136 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 137 - "ChatHistoryStore"
Cohesion: 0.07
...
### Community 141 - "loop.py"
Cohesion: 0.05
Nodes (49): loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., # NOTE: "ollama_base" is kept for backwards compatibility; this runner only…, build_spec_router(), approve_spec(), _decide(), get_spec_artifact(), list_spec_artifacts(), reject_spec() (+41 more)

### Community 142 - "test_context_rulebook.py"
Cohesion: 0.06
...
### Community 147 - "GoalRecord"
Cohesion: 0.06
Nodes (27): _backend(), CEOLedger, GoalRecord, _now(), Any, One piece of work the CEO has taken ownership of. ``state`` is the supervisor's…, Return ``(done, total)`` subtask counts., Durable store for :class:`GoalRecord`s. Every method is best-effort and never… (+19 more)

### Community 148 - "E2BSandboxSession"
Cohesion: 0.04
...
### Community 149 - "CompanyGraphStore"
Cohesion: 0.03
...
### Community 150 - "test_tasks_awaiting_approval_api.py"
Cohesion: 0.33
...
### Community 151 - "WorkspaceManager"
Cohesion: 0.06
...
### Community 155 - "E2BAdapter"
Cohesion: 0.06
Nodes (39): E2BAdapter, Any, Declare ``E2B_API_KEY`` as a required env dependency. The base ``preflight``…, Execute a task inside a fresh E2B sandbox. Flow: 1. Open an…, Run ``pytest`` inside the sandbox. Returns ``(output, passed)``.…, Runtime adapter that executes tasks inside an E2B sandbox. Activation:…, _FakeAsyncSandboxClass, _FakeCommandResult (+31 more)

### Community 156 - "TaskPriority"
Cohesion: 0.08
Nodes (53): _run(), Issue title: the failure mode plus how hard it is recurring., _company_attr(), company_stack_tags(), extract_stack_tags(), fan_out_trend(), fan_out_trends(), is_code_change_trend() (+45 more)

### Community 157 - "BudgetTracker"
Cohesion: 0.08
...
### Community 159 - "frontend/package.json"
Cohesion: 0.04
...
Cohesion: 0.04
Nodes (60): Charge sub-agent nesting depth and enforce the ``max_depth`` ceiling. Isolates…, simulate_policy(), _load(), mcp_server/governance.py — governance adapter for the MCP HTTP surface. Closes…, Write the audit row for a completed (or blocked) MCP tool call., Import the governance layer once, recording why if it is absent., record(), events_from_identity() (+52 more)
...
### Community 168 - "test_e2b_data_flow.py"
Cohesion: 0.06
...
### Community 169 - "TestAdapterMetadata"
Cohesion: 0.04
Nodes (31): north_mini_code_model_for(), Return the North Mini Code model id served by *provider*, else ``None``.…, _env_float(), HermesAdapter, Any, AsyncClient, Submit task to Hermes via its /tasks endpoint., Read a float env var, falling back to *default* on unset/garbage. (+23 more)

### Community 170 - "test_schedule_backlog_drain.py"
Cohesion: 0.09
...
### Community 171 - "test_minimax_bug_fixes.py"
Cohesion: 0.13
...
### Community 175 - "Prime Agent Runtime"
Cohesion: 0.25
...
### Community 177 - "ProviderConsole.jsx"
Cohesion: 0.08
...
### Community 178 - "test_response_cache.py"
Cohesion: 0.12
...
### Community 179 - "ContextWindowManager"
Cohesion: 0.08
...
### Community 181 - "test_executive_advisory.py"
Cohesion: 0.13
...
### Community 183 - "seo_api.py"
Cohesion: 0.04
Nodes (89): build_seo_roadmap(), delegate_seo_findings(), _expire_stale_pending_report(), get_seo_audit(), list_seo_audits(), plan_seo_sprint(), BaseModel, get (+81 more)

### Community 184 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 185 - "test_failover_silent_exhaustion.py"
Cohesion: 0.06
...
### Community 187 - "tasks/models.py"
Cohesion: 0.04
Nodes (66): tasks — Task/issue management system. Provides a lightweight task/issue tracker…, ApprovalCheckpoint, ApprovalRequest, ClarifyRequest, _coerce_ts(), CommentAddRequest, ExecutionApprovalRequest, ExecutionLogEntry (+58 more)
...
### Community 190 - "activation_api.py"
Cohesion: 0.10
...
### Community 193 - "test_runtimes_health_endpoint.py"
Cohesion: 0.25
...
### Community 194 - "failover_client.py"
Cohesion: 0.06
...
### Community 195 - "test_runtime_governance.py"
Cohesion: 0.11
Nodes (42): _governance_check(), Evaluate a runtime dispatch against policy; audit it either way. Returns…, _decision(), _engine(), Any, Governance on runtime dispatch — the last coverage gap.…, `route_and_execute` callers handle failure; they do not expect a new exception…, So callers can branch without string-matching the output. Regression: an… (+34 more)
...
### Community 199 - "test_schedule_growth_invariants.py"
Cohesion: 0.04
...
### Community 201 - "test_connector_registry.py"
Cohesion: 0.09
...
### Community 202 - "DirectChatSession"
Cohesion: 0.20
Nodes (6): DirectChatSession, Direct chat session with Company Graph context binding., Bind a company to this chat session and load its Company Graph., Bind a repository to this chat session., Get the bound Company Graph., Get enriched context including Company Graph data.

### Community 203 - "test_governance_api.py"
Cohesion: 0.06
Nodes (51): get_approval_store(), AuditEvent, One governed action, fully described. Field order follows the…, One-line JSON, suitable for a SIEM shipper tailing the log., Replace the process-wide gate. Tests only., reset_gate(), _client(), parametrize (+43 more)

### Community 204 - "KeyPool"
Cohesion: 0.05
...
### Community 213 - "ScheduledJob"
Cohesion: 0.05
Nodes (25): Any, Reconstruct a ScheduledJob from its as_dict() output., Capture the FastAPI main event loop so APScheduler's background thread can…, ScheduledJob, _MemCollection, _MemCursor, _MemDB, _MemDeleteResult (+17 more)
...
### Community 217 - "emit_chat_observation"
Cohesion: 0.08
Nodes (36): Browser admin UI for login, service control, key management, and diagnostics., observability_diag_public(), PUBLIC diagnostic endpoint for Langfuse — no auth required. Returns exactly…, CommercialEquivalent, estimate_commercial_equivalent_usd(), get_prices(), _load_from_env(), _parse_mapping() (+28 more)

### Community 218 - "ApprovalStore"
Cohesion: 0.07
Nodes (24): Event, publish(), packages/events/bus.py — In-process event bus. Loosely couples components via…, An event published on the bus., Subscribe to an event type., Publish an event to all subscribers., subscribe(), ApprovalRequest (+16 more)

### Community 219 - "test_features_api.py"
Cohesion: 0.05
...
### Community 222 - "BrainConfigPatch"
Cohesion: 0.04
Nodes (51): get_brain_policy_route(), _migrate_brain_to_safe_default(), patch_brain_policy_route(), patch, Return the active brain config + per-provider key-present flags. The response…, Apply a partial brain config update. Hard constraint: every changed model id is…, Update status/tools/name on an MCP server., Manually trigger brain self-healing + unblock tasks. Admin-only endpoint. Runs… (+43 more)

### Community 223 - "portfolio_api.py"
Cohesion: 0.08
...
### Community 225 - "SeoFixer"
Cohesion: 0.06
Nodes (31): Root directory under which repo fixes are allowed to operate., Run the repo-aware auto-fixer against this company's workspace checkout.…, run_seo_fixes(), _workspace_root(), FsPath, Request to remediate auto-fixable findings in a local code repository., One concrete remediation performed (or proposed) by the fixer., Result of a fixer run. (+23 more)

### Community 226 - "reset_store"
Cohesion: 0.11
...
### Community 228 - "WorkflowBuildRequest"
Cohesion: 0.09
Nodes (25): Contract: WorkflowEngine cannot skip the gate state machine., Contract: No code path may advance past awaiting_approval unless gate.status ==…, Create a run and manually place it in awaiting_approval., Contract: Cannot approve a run in 'pending' state., Contract: Can approve a run in 'awaiting_approval' state., Contract: Rejecting a run marks it as failed., TestApprovalGateMandatory, do_approve() (+17 more)

### Community 229 - "TrendWatcher"
Cohesion: 0.15
...
### Community 230 - "chat_handlers.py"
Cohesion: 0.10
...
### Community 236 - "unsafe_target_reason"
Cohesion: 0.12
...
### Community 240 - "brain_failover.py"
Cohesion: 0.05
...
### Community 248 - "PatternConsolidation"
Cohesion: 0.08
...
### Community 250 - "CLAUDE.md — router/"
Cohesion: 0.29
Nodes (6): Adding a model, Adding a task category, CLAUDE.md — router/, Environment variables, Testing, What this package does

### Community 251 - "clear_cooldowns"
Cohesion: 0.07
Nodes (35): clear_cooldowns(), get_dead_models(), _is_model_dead(), is_provider_on_cooldown(), mark_provider_failed(), Snapshot of active dead-model entries {provider_id/model: expiry_ts}. Also…, Put provider_id on cooldown for *cooldown_seconds* (default:…, Return True if provider_id is currently on cooldown. (+27 more)

### Community 252 - "system_instruction"
Cohesion: 0.09
...
### Community 253 - "test_mcp_governance.py"
Cohesion: 0.09
...
### Community 254 - "TestCatalogFable51"
Cohesion: 0.09
...
### Community 255 - "test_local_controller.py"
Cohesion: 0.14
...
### Community 258 - "test_agent_readiness_audit.py"
Cohesion: 0.18
...
### Community 265 - "output_filter.py"
Cohesion: 0.07
...
### Community 266 - "test_rate_limiter.py"
Cohesion: 0.20
...
### Community 269 - "test_issue_intake.py"
Cohesion: 0.07
...
### Community 275 - "agent_runtime.py"
Cohesion: 0.09
...
### Community 277 - "test_all_providers_discovery.py"
Cohesion: 0.17
...
### Community 279 - "test_nvidia_model_discovery.py"
Cohesion: 0.06
...
### Community 282 - "Platform Guide — the full tour"
Cohesion: 0.11
...
### Community 283 - "test_unit6_resolve_component_model.py"
Cohesion: 0.05
Nodes (41): invalidate_brain_config_cache(), Clear the singleton's cache (used by tests + brain_policy invalidation)., invalidate() clears the cache so the next get re-reads from storage., test_invalidate_forces_reread(), tests/test_unit6_resolve_component_model.py — UNIT 6 regression tests. Verifies…, When the DB cache is fresh AND provider matches the active primary, the DB-…, When the DB primary differs from the requested provider, the catalog preset for…, When `provider` is None, the DB primary's saved model wins. (+33 more)
...
### Community 288 - "_routing_candidates"
Cohesion: 0.09
...
### Community 293 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 294 - "TaskExecutionCoordinator"
Cohesion: 0.03
Nodes (103): classify_domain(), agent/workflow.py — Persisted workflow state machine. Implements the Autonomous…, Return the best-matching domain for a task title+description., _apply_activity_status(), create_agent(), delete_agent(), get_agent(), _get_user() (+95 more)

### Community 295 - "_resolve_user_github_token"
Cohesion: 0.10
Nodes (28): get_skill_registry_safe(), Return the global SkillRegistry if set, else None. Used by onboarding and other…, _DoctorCheck, _DoctorReport, get_doctor_diagnostics(), get_doctor_report(), get_public_doctor(), Consolidated system health report: preflight checks + runtime health. Returns a… (+20 more)

### Community 296 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 300 - "test_ephemeral_reaper.py"
Cohesion: 0.09
...
### Community 301 - "test_microagents.py"
Cohesion: 0.15
...
### Community 303 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 304 - "Langfuse Observability Guide"
Cohesion: 0.06
...
### Community 306 - "resolve_component_model"
Cohesion: 0.06
Nodes (38): Resolve the model id for a component's role on a provider. Parameters…, resolve_component_model(), Dynamic model router package. Public API:: from router import get_router,…, _build_builtin_model_map(), _default_model(), _default_reasoning_model(), ModelRouter, _nvidia_key_present() (+30 more)

### Community 307 - "test_unit7_catalog_propagation.py"
Cohesion: 0.06
Nodes (37): _catalog_defaults(), _catalog_provider(), Pick the catalog provider based on which API key is configured., Resolve per-role defaults via the catalog. Returns None on import error., Resolve the NVIDIA default model via the catalog (UNIT 7). Was hardcoded to…, _resolve_nvidia_default_model(), _catalog_preset(), tests/test_unit7_catalog_propagation.py — UNIT 7 regression tests. Verifies… (+29 more)

### Community 308 - "test_brain_availability_doctor.py"
Cohesion: 0.10
...
### Community 309 - "BrainFailoverManager"
Cohesion: 0.09
...
### Community 313 - "High-Agency Frontend Skill"
Cohesion: 0.06
Nodes (30): 10. FINAL PRE-FLIGHT CHECK, 1. ACTIVE BASELINE CONFIGURATION, 2. DEFAULT ARCHITECTURE & CONVENTIONS, 3. DESIGN ENGINEERING DIRECTIVES (Bias Correction), 4. CREATIVE PROACTIVITY (Anti-Slop Implementation), 5. PERFORMANCE GUARDRAILS, 6. TECHNICAL REFERENCE (Dial Definitions), 7. AI TELLS (Forbidden Patterns) (+22 more)

### Community 314 - "TestNormalizeResponseFormat"
Cohesion: 0.08
...
### Community 317 - "RateLimitTracker"
Cohesion: 0.16
...
### Community 319 - "test_platform_controls.py"
Cohesion: 0.09
...
### Community 322 - "session_retro.py"
Cohesion: 0.13
...
### Community 324 - "test_daily_2026_06_04.py"
Cohesion: 0.09
...
### Community 325 - "test_skill_registry_boot_refresh.py"
Cohesion: 0.11
...
### Community 326 - "test_autonomy_gate.py"
Cohesion: 0.12
...
### Community 330 - "test_colibri_brain_shim.py"
Cohesion: 0.06
Nodes (38): get_brain_preference(), invalidate_brain_cache(), Clear the cached brain so the next read re-resolves. Called from…, Return the operator's brain provider preference. Values: - ``"nvidia"`` —…, When BrainConfig.updated_at is empty (never applied), the resolver falls…, test_resolve_active_brain_falls_through_when_db_unset(), clean_env(), parametrize (+30 more)

### Community 331 - "[5.0.0]"
Cohesion: 0.29
Nodes (7): [5.0.0], Added, Changed, Fixed, Maintenance, Removed, Security

### Community 332 - "control_registry.py"
Cohesion: 0.12
...
### Community 333 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 336 - "local_controller.py"
Cohesion: 0.11
...
### Community 337 - "test_scheduler_hydration_bounded.py"
Cohesion: 0.09
...
### Community 338 - "[Unreleased]"
Cohesion: 0.05
Nodes (41): Added, Added, Added, Added, Added, Added, Added, Added (+33 more)

### Community 339 - "test_force_cleanup_conditional_delete.py"
Cohesion: 0.10
...
### Community 341 - "test_rag_context.py"
Cohesion: 0.12
...
### Community 342 - "ProjectScaffolder"
Cohesion: 0.13
...
### Community 345 - "SteeringInjector"
Cohesion: 0.11
...
### Community 346 - "test_claude_setup_audit.py"
Cohesion: 0.16
...
### Community 348 - "test_control_plane_api.py"
Cohesion: 0.06
...
### Community 349 - "test_internal_agent_did_work.py"
Cohesion: 0.12
...
### Community 350 - "_captured_request_headers"
Cohesion: 0.12
...
### Community 354 - "Python Dependencies (`requirements.txt`)"
Cohesion: 0.07
...
### Community 355 - "build_render_router"
Cohesion: 0.12
...
### Community 356 - "_ensure_tasks_source_id_unique_index"
Cohesion: 0.10
...
### Community 357 - "Kept Rules — the 44 that survive the audit"
Cohesion: 0.05
...
### Community 358 - "CompanyAgencyService"
Cohesion: 0.11
...
### Community 359 - "Part A — CodeRabbit review fixes for this PR (do first, small)"
Cohesion: 0.05
...
### Community 362 - "webui/frontend/package.json"
Cohesion: 0.07
...
### Community 366 - "test_regression.py"
Cohesion: 0.10
...
### Community 367 - "test_agent_scripts_share_one_model_list.py"
Cohesion: 0.10
...
### Community 368 - "test_crispy_burn_in.py"
Cohesion: 0.07
...
### Community 369 - "test_implement_agent_routing.py"
Cohesion: 0.07
...
### Community 372 - "Technical Debt Register — local-llm-server"
Cohesion: 0.07
...
### Community 373 - "resolve_provider_for"
Cohesion: 0.04
Nodes (60): _build_provider_router(), _builtin_provider_records(), _chat_provider_policy(), _fallback_local_provider_record(), _get_provider_policy(), get_provider_policy_route(), _in_container(), _list_configured_provider_records() (+52 more)

### Community 374 - "test_daemon_restart_reprobes_http_port_only"
Cohesion: 0.13
...
### Community 375 - "Claude Code + Qwen Local Setup"
Cohesion: 0.07
...
### Community 376 - "Configuration Reference"
Cohesion: 0.06
...
### Community 379 - "isolated_telegram_config"
Cohesion: 0.10
...
### Community 380 - "test_nvidia_default_model.py"
Cohesion: 0.17
...
### Community 382 - "validate_outbound_url"
Cohesion: 0.14
...
### Community 383 - "register_webui"
Cohesion: 0.06
Nodes (51): allow_paid_brain(), True only when the operator explicitly opted into a paid (Anthropic) brain.…, Any, Path, run_command(), _safe_allowlist(), validate_command(), _admin_out() (+43 more)

### Community 384 - "executive_advisory_api.py"
Cohesion: 0.10
...
### Community 386 - "test_backend_server_features.py"
Cohesion: 0.06
Nodes (19): _append_agent_session_message(), _build_auto_skill_guidance(), _mask_observations(), Path, Truncate tool/observation content in older messages to prevent context bloat., _run_agent_loop(), _select_auto_skills(), anyio (+11 more)

### Community 387 - "VoiceCommandInterface"
Cohesion: 0.14
...
### Community 388 - "get_failover_manager"
Cohesion: 0.07
...
### Community 393 - "TemporalContextGraph"
Cohesion: 0.10
...
### Community 395 - "get_user_role"
Cohesion: 0.12
Nodes (26): _get_github_token_for_user(), Fetch GitHub token for user from secrets store or environment., get_user_role(), Extract role from a user object (dict or Pydantic model)., create_secret(), delete_secret(), get_secret_metadata(), get_secrets_store() (+18 more)

### Community 396 - "TestWorkflow"
Cohesion: 0.08
...
### Community 398 - "get_tool_registry"
Cohesion: 0.07
Nodes (18): browse_page(), Open *url* in a real browser, return its rendered text, and close. Fail-soft:…, get_tool_registry(), Return the module-level ToolRegistry singleton. On first call, registers built-…, Register the built-in agent tools that are always available., Register the interactive-browser capability (agent/browser.py). Unlike…, Register the Web Reach capability (agent/web_reach.py): zero-key internet…, _register_browser_tools() (+10 more)

### Community 399 - "Skill: user-research"
Cohesion: 0.13
...
### Community 400 - "_redact_for_notification"
Cohesion: 0.11
...
### Community 401 - "executive_advisory.py"
Cohesion: 0.08
...
### Community 403 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 407 - "Session Handoff — 2026-06-15"
Cohesion: 0.08
...
### Community 408 - "video_transcript.py"
Cohesion: 0.11
...
### Community 410 - "test_telegram_approval_e2e.py"
Cohesion: 0.12
...
### Community 411 - "test_activation_api.py"
Cohesion: 0.13
...
Cohesion: 0.06
Nodes (29): livenim, is_anthropic_model(), True when *model* names a paid Anthropic/Bedrock-Claude model. Covers native…, Resolve the free NVIDIA NIM brain from env, or ``None`` if unconfigured.…, resolve_free_nvidia_brain(), _FakeAsyncClient, _FakeResponse, _free_env() (+21 more)

### Community 413 - "lifespan"
Cohesion: 0.04
Nodes (56): all_settings(), _as_bool(), _as_int(), ephemeral_ttl_hours(), ephemeral_ttl_hours_cached(), get_setting(), _maybe_schedule_refresh(), onboarding_gate_enabled() (+48 more)

### Community 414 - "TestClassifyPlainText"
Cohesion: 0.08
...
### Community 416 - "test_telegram_diag_endpoint.py"
Cohesion: 0.08
...
### Community 418 - "WorkspaceManager"
Cohesion: 0.10
...
### Community 421 - "Active Task Tracker"
Cohesion: 0.22
...
### Community 423 - "Local AI Stack with Docker"
Cohesion: 0.08
...
### Community 424 - "LLM Router — troubleshooting"
Cohesion: 0.08
...
### Community 426 - "WindowsServiceManager"
Cohesion: 0.17
...
### Community 427 - "test_all_features.py"
Cohesion: 0.08
...
### Community 430 - "_execute_skill_impl"
Cohesion: 0.10
...
### Community 435 - "build_platform_controls_router"
Cohesion: 0.15
...
### Community 436 - "openclaw_str_e_fix.py"
Cohesion: 0.15
...
### Community 437 - "Implementation Prompt: Rich TaskBoard + Agile Sprint Integration"
Cohesion: 0.08
...
### Community 439 - "SetupWizardPage.js"
Cohesion: 0.13
...
### Community 441 - "implement_agent.py"
Cohesion: 0.12
...
### Community 443 - "TestModelRegistryUpdates"
Cohesion: 0.14
...
### Community 444 - "test_phase4_runtime_resilience.py"
Cohesion: 0.14
...
### Community 445 - "test_memory_guard.py"
Cohesion: 0.13
...
### Community 447 - "OrchestratorCheckpointStore"
Cohesion: 0.10
...
### Community 448 - "SyntheticDataPipeline"
Cohesion: 0.13
...
### Community 450 - "test_cerebras_catalogue.py"
Cohesion: 0.13
...
### Community 451 - "compare_runtimes.py"
Cohesion: 0.06
...
### Community 452 - "test_mostly_failed_steps.py"
Cohesion: 0.12
...
### Community 454 - "register_admin_gui"
Cohesion: 0.20
...
### Community 457 - "AdaptivePermissions"
Cohesion: 0.18
...
### Community 461 - "Performance Analysis — local-llm-server"
Cohesion: 0.08
...
### Community 462 - "The fifteen strategies"
Cohesion: 0.09
...
### Community 466 - "TestLegacyRouterCacheTTL"
Cohesion: 0.13
...
### Community 467 - "test_anthropic_refusal_fallback.py"
Cohesion: 0.19
...
### Community 468 - "log_watcher.py"
Cohesion: 0.11
Nodes (17): _auto_file_enabled(), ErrorFingerprint, LogEntry, log_watcher.py — Automated log monitoring agent. Watches log files, detects…, A single error entry extracted from a log file., Generates stable fingerprints for error deduplication., Create a hash from error type, file, and normalized message pattern., Process a detected error: dedup and create GitHub issue if new. (+9 more)

### Community 469 - "SamAgent"
Cohesion: 0.13
...
### Community 470 - "analyze_quantitative"
Cohesion: 0.13
...
### Community 471 - "_status_snapshot"
Cohesion: 0.15
...
### Community 472 - "test_daily_2026_07_27.py"
Cohesion: 0.07
...
### Community 474 - "V3 API Migration Plan — LLM Relay Platform"
Cohesion: 0.10
...
### Community 475 - "TestSeoApiSurface"
Cohesion: 0.14
Nodes (6): list_checks(), Return all check definitions., client(), TestClient, tests/test_seo_api.py - SEO audit API surface tests (issue #533)., TestSeoApiSurface

### Community 476 - "TestRequireAdmin"
Cohesion: 0.13
Nodes (10): Request, FastAPI dependency: require any authenticated user., require_authenticated(), client(), _coding_brain_check(), tests/test_doctor_coding_brain.py Surfaces the North Mini Code coding-brain…, With NORTH_MINI_CODE_DEFAULT off, the check warns and says so., test_coding_brain_check_reflects_flag_off() (+2 more)

### Community 477 - "_Cursor"
Cohesion: 0.10
...
### Community 478 - "sam_livekit_worker.py"
Cohesion: 0.13
...
### Community 479 - "get_scheduler"
Cohesion: 0.06
Nodes (48): get_agency(), set_agency(), _autonomy_bg_cycle(), autonomy_tick(), legacy_scheduler_delete(), legacy_scheduler_get(), legacy_scheduler_trigger(), Background CEO cycle + task dispatch. Runs fire-and-forget. (+40 more)

### Community 480 - "_process_task_callback"
Cohesion: 0.20
...
### Community 482 - "test_brain_migration_writes_a_live_model.py"
Cohesion: 0.10
...
### Community 483 - "test_prompt_injection_boundary.py"
Cohesion: 0.16
...
### Community 484 - "test_openclaw_str_e_fix.py"
Cohesion: 0.10
...
### Community 485 - "run_trend_analysis"
Cohesion: 0.18
...
### Community 490 - "_extract_tech_relevance"
Cohesion: 0.17
...
### Community 492 - "Skill: modularity-review"
Cohesion: 0.10
...
### Community 495 - "facade.py"
Cohesion: 0.04
Nodes (63): create_access_token(), create_refresh_token(), github_callback(), github_login(), github_repo_access(), github_repo_callback(), google_callback(), google_login() (+55 more)

### Community 496 - "Brag Plan: Autonomous AI Agency"
Cohesion: 0.10
Nodes (19): Audio direction, Brag Plan: Autonomous AI Agency, Duration: target 20s, Format: landscape — 1920x1080, Hook (first 2-3 seconds), Key moments (the middle), Outro / punchline, Scene 1 — Paste your URL — 3.2s (+11 more)

### Community 497 - "cost_tracker.py"
Cohesion: 0.15
...
### Community 501 - "Docker AI Governance Audit — Final Report"
Cohesion: 0.10
...
### Community 504 - "test_p0_roadmap_a4_a5_b2.py"
Cohesion: 0.14
...
### Community 507 - "TestRecordUsageAndStats"
Cohesion: 0.05
...
### Community 508 - "TestBrainFailoverModelUpdates"
Cohesion: 0.18
...
### Community 510 - "test_dashboard_cache.py"
Cohesion: 0.13
Nodes (18): _cached(), _fast_count(), legacy_scheduler_list(), _produce_scheduler_jobs(), Single-flight TTL cache. Concurrent callers wait for the first producer., Count without materialising rows — prefers estimated_document_count., _CollWithEstimate, _CollWithoutEstimate (+10 more)

### Community 511 - "FakeResp"
Cohesion: 0.13
...
### Community 512 - "test_research_coordinator.py"
Cohesion: 0.11
...
### Community 513 - "test_tasks_cache_ttl_env.py"
Cohesion: 0.21
...
### Community 514 - "test_webui_provider_priority.py"
Cohesion: 0.18
...
### Community 521 - "Skill: fabric-patterns"
Cohesion: 0.11
...
### Community 522 - "Analysis & Synthesis Instructions"
Cohesion: 0.11
...
### Community 524 - "Production Readiness Assessment — local-llm-server"
Cohesion: 0.11
...
### Community 526 - "Admin Dashboard Guide"
Cohesion: 0.11
...
### Community 531 - "test_p0_roadmap_b3_b4_b5.py"
Cohesion: 0.13
Nodes (14): _deep_merge(), Deep merge two dicts. Override values take precedence., CircuitBreakerOpenError, CircuitState, get_nim_pool(), Enum, RuntimeError, Raised when a request is blocked by an open circuit breaker. (+6 more)

### Community 532 - "LocalLLMSetup"
Cohesion: 0.15
...
### Community 533 - "test_autonomy_status.py"
Cohesion: 0.11
...
### Community 534 - "test_brain_patch_service_token.py"
Cohesion: 0.18
...
### Community 535 - "TestMCPToolsListCache"
Cohesion: 0.15
...
### Community 536 - "TestSelfHealingInfrastructureClassification"
Cohesion: 0.19
...
### Community 538 - "test_provider_failover_integration.py"
Cohesion: 0.15
...
### Community 539 - "test_voice_pipeline.py"
Cohesion: 0.13
...
### Community 540 - "validate_session_id"
Cohesion: 0.16
...
### Community 542 - "ErrorInterceptorMiddleware"
Cohesion: 0.18
...
### Community 543 - "test_harness_spec.py"
Cohesion: 0.12
...
### Community 545 - "Comprehensive Skill Index (By Category)"
Cohesion: 0.11
...
### Community 546 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 547 - "Architecture Overview — local-llm-server"
Cohesion: 0.11
...
### Community 548 - "KnowledgeScreen.jsx"
Cohesion: 0.13
...
### Community 551 - "Part A — Health Report"
Cohesion: 0.11
...
### Community 554 - "Delegation Plan (agent-ready work packages)"
Cohesion: 0.11
...
### Community 557 - "sync_readme_gallery.py"
Cohesion: 0.20
...
### Community 559 - "OrchestratorQueue"
Cohesion: 0.13
...
### Community 561 - "ClaudeCodeAdapter"
Cohesion: 0.19
...
### Community 563 - "test_company_api.py"
Cohesion: 0.11
...
### Community 564 - "TestOrchestratorQueue"
Cohesion: 0.13
...
### Community 565 - "test_phase5_doctor.py"
Cohesion: 0.11
...
### Community 566 - "TestStopSlopChecker"
Cohesion: 0.11
...
### Community 572 - "SKILL: Industrial Brutalism & Tactical Telemetry UI"
Cohesion: 0.12
...
### Community 573 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 574 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 576 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 579 - "Native operations"
Cohesion: 0.09
...
### Community 580 - "agent_readiness_audit.py"
Cohesion: 0.21
...
### Community 584 - "AdminDigestRouterAuthTests"
Cohesion: 0.20
...
Cohesion: 0.09
Nodes (15): get_guardrails(), GuardrailEngine, GuardResult, Any, Configurable safety rail engine for LLM inputs and outputs. Supports: -…, Check user input against input safety rules. Returns a GuardResult with…, Check model output against output safety rules. Returns a GuardResult with…, Unified check method. direction = 'input' or 'output'. (+7 more)

### Community 586 - "context_plan_gate.py"
Cohesion: 0.14
...
### Community 587 - "test_task_brain_preflight.py"
Cohesion: 0.21
...
### Community 589 - ".on_task_complete"
Cohesion: 0.12
...
### Community 590 - "test_frontend_deployment_guards.py"
Cohesion: 0.18
...
### Community 591 - "test_health_endpoints.py"
Cohesion: 0.15
...
### Community 592 - "test_openclaw_endpoints.py"
Cohesion: 0.12
...
### Community 593 - "test_portfolio_intelligence.py"
Cohesion: 0.14
...
### Community 596 - "WorkflowPhase"
Cohesion: 0.13
Nodes (15): _append_transition(), BaseModel, Enum, str, Advance task through the full phase sequence. Resumes from…, Execute a single phase and advance to the next., Classify domain from title+description; store on task_type., Record a plan stub (concrete planning happens inside the agent loop). (+7 more)

### Community 597 - "TestRouterIntegration"
Cohesion: 0.21
...
### Community 601 - "hermes_prompt.py"
Cohesion: 0.19
...
### Community 603 - "MemoryMiddleware"
Cohesion: 0.17
...
### Community 604 - "test_ai_insights.py"
Cohesion: 0.15
...
### Community 605 - "PerformanceAnalytics"
Cohesion: 0.14
...
### Community 608 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
...
### Community 609 - "_valid_login_state"
Cohesion: 0.24
...
### Community 610 - "Attention Mechanisms Internals"
Cohesion: 0.13
...
### Community 611 - "The 10-Step Workflow"
Cohesion: 0.12
...
### Community 612 - "Contributing to local-llm-server"
Cohesion: 0.12
...
### Community 613 - "refresh_agent_built_proof.py"
Cohesion: 0.20
...
### Community 614 - "Section-by-Section Acceptance Criteria"
Cohesion: 0.12
...
### Community 615 - "Agent Runtime Setup"
Cohesion: 0.12
...
### Community 617 - "test_autonomy_pipeline_regressions.py"
Cohesion: 0.11
...
### Community 620 - "test_freebuff_bot.py"
Cohesion: 0.11
...
### Community 622 - "test_setup_api.py"
Cohesion: 0.21
...
### Community 623 - "test_agency_workflows_carry_the_failover_chain.py"
Cohesion: 0.18
...
### Community 625 - "DailyDigestAggregatorTests"
Cohesion: 0.19
...
### Community 626 - "test_dockerfile_ships_root_modules.py"
Cohesion: 0.17
...
### Community 628 - "test_migrate_local_brain_env.py"
Cohesion: 0.38
...
### Community 631 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 632 - "test_refresh_agent_built_proof.py"
Cohesion: 0.12
...
### Community 633 - "test_sam_voice.py"
Cohesion: 0.06
...
### Community 641 - "test_repowise_intelligence.py"
Cohesion: 0.11
...
### Community 642 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 643 - "Skill: agent-harness"
Cohesion: 0.13
...
### Community 644 - "Skill: checkpoint-strategy"
Cohesion: 0.13
...
### Community 646 - "Skill: local-ai-query"
Cohesion: 0.13
...
### Community 647 - "Skill: parallel-agents"
Cohesion: 0.13
...
### Community 648 - "Skill: parallel-worktrees"
Cohesion: 0.13
...
### Community 649 - "Design System: Taste Standard"
Cohesion: 0.13
...
### Community 651 - "test_new_features_e2e.py"
Cohesion: 0.26
...
### Community 652 - "Traffic Distribution Across Providers"
Cohesion: 0.08
...
### Community 653 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 660 - "DecisionsStoreTests"
Cohesion: 0.13
...
### Community 661 - "test_dockerfile_ships_config_dir.py"
Cohesion: 0.14
...
### Community 662 - "test_omniroute_provider.py"
Cohesion: 0.12
Nodes (15): get_provider_tier(), Return the tier (``free`` / ``paid`` / ``local``) for *provider*. Returns…, test_get_provider_tier_known(), test_get_provider_tier_unknown_returns_unknown(), tests/test_omniroute_provider.py — OmniRoute self-hosted gateway wiring.…, Without an explicit base URL it points at the local default, never blank., One provider, one model — OmniRoute does its own internal fan-out., Promoted to the preferred free provider, but NVIDIA stays the floor. OmniRoute… (+7 more)

### Community 663 - "router/health.py"
Cohesion: 0.16
...
### Community 664 - "test_tasks_reconciler_todo_requeue.py"
Cohesion: 0.22
...
### Community 669 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 670 - "test_daily_automation_2026_07_11.py"
Cohesion: 0.14
...
### Community 671 - "DeterministicEngine"
Cohesion: 0.21
...
### Community 675 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 678 - "Checks Performed"
Cohesion: 0.14
...
### Community 679 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 680 - "test_monitor_lib.py"
Cohesion: 0.15
...
### Community 681 - "admin_digest_router.py"
Cohesion: 0.22
...
### Community 682 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 683 - "Skill: perplexity — Web Research via Perplexity API"
Cohesion: 0.14
...
### Community 684 - "Instructions"
Cohesion: 0.14
Nodes (13): 1 — Tests green, 2 — Changelog updated, 3 — Determine the version bump, 4 — Update changelog, 5 — Commit the changelog update, 6 — Tag the release, 7 — Verify CI on the tag, 8 — Post-release (+5 more)

### Community 685 - "Quick-Note Issues Processing Summary"
Cohesion: 0.14
...
### Community 686 - "Separate hosted dashboard backend (`backend/server.py`)"
Cohesion: 0.13
...
### Community 687 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 688 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 689 - "ProvidersScreen.jsx"
Cohesion: 0.06
...
### Community 690 - "Runbook: Auto-Resume After Cooldown / Interruption"
Cohesion: 0.14
...
### Community 693 - "_parse_reset_epoch"
Cohesion: 0.33
...
### Community 694 - "extract_failures"
Cohesion: 0.21
...
### Community 695 - "telegram_inbound_handlers.py"
Cohesion: 0.13
Nodes (24): get_decisions_store(), Process-wide DecisionsStore singleton (resettable via db_path arg)., is_sensitive(), True when *text* references a sensitive target (auth/keys/secrets/service…, _build_execution_request(), _get_decisions_store(), _get_workflow_orchestrator(), Any (+16 more)

### Community 696 - "test_wrapper_falls_back_to_installed_model"
Cohesion: 0.19
...
### Community 697 - "TestAnthropicToolListCaching"
Cohesion: 0.34
...
### Community 699 - "_StubManager"
Cohesion: 0.14
Nodes (3): _apply(), Minimal stand-in for BrainFailoverManager., _StubManager

### Community 700 - ".test_set_github_token_sqlite_string_id_does_not_500"
Cohesion: 0.16
...
### Community 702 - "test_langfuse_agency_wide.py"
Cohesion: 0.10
...
### Community 708 - "test_local_brain_state.py"
Cohesion: 0.12
...
### Community 709 - "_push_down_where"
Cohesion: 0.14
...
### Community 712 - "ResearchOrchestrator"
Cohesion: 0.16
...
### Community 714 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 717 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 718 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 721 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
...
### Community 722 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 723 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 724 - "Deploy: FreeBuff Telegram bot (24×7)"
Cohesion: 0.07
...
### Community 726 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 727 - "admin_update_task_router.py"
Cohesion: 0.22
...
### Community 729 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
Nodes (12): Acceptance Checks, Claude's query protocol (use this instead of Read tool for exploration):, Graph Artifacts — What to Commit, How to Use the Graph (Token Savings Protocol), Installation (one-time per machine), Instead of reading raw files:, Key commands:, Relationship to repowise-intelligence Skill (+4 more)

### Community 730 - "Skill: platform-setup — Autonomous Agency Bootstrap"
Cohesion: 0.15
...
### Community 731 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 732 - "Device compatibility and model picks"
Cohesion: 0.15
...
### Community 733 - "SEO / GEO / AIO Audit Engine"
Cohesion: 0.14
...
### Community 736 - "_get_provider_policy"
Cohesion: 0.19
...
### Community 737 - "_InMemoryBackend"
Cohesion: 0.18
...
### Community 739 - "test_compose_and_coordinate_api.py"
Cohesion: 0.19
...
### Community 741 - "TestModelCostTableUpdates"
Cohesion: 0.26
...
### Community 742 - "TestDecisionsBotLinks"
Cohesion: 0.21
...
### Community 743 - "test_deploy_trigger_covers_image.py"
Cohesion: 0.21
...
### Community 744 - "test_doctor_service_token_check.py"
Cohesion: 0.23
...
### Community 745 - "test_providers_live_e2e.py"
Cohesion: 0.24
...
### Community 747 - "skill_registry.py"
Cohesion: 0.17
...
### Community 759 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 763 - "Implementation Plan"
Cohesion: 0.11
...
### Community 764 - "Workspace Isolation Architecture"
Cohesion: 0.17
...
### Community 765 - "Quantization Internals"
Cohesion: 0.17
...
### Community 766 - "Autonomy Uplift — Living Roadmap & Detailed Implementation Specs"
Cohesion: 0.15
...
### Community 773 - "Render MCP — autonomous platform debugging and environment monitoring"
Cohesion: 0.14
...
### Community 775 - "test_agile_api.py"
Cohesion: 0.17
...
### Community 776 - "test_app_settings.py"
Cohesion: 0.21
...
### Community 777 - "test_brain_default_consistency.py"
Cohesion: 0.24
...
### Community 779 - "TestDisabledProvidersAreNotFalselyReportedUnreachable"
Cohesion: 0.18
...
### Community 781 - "test_task_clarification.py"
Cohesion: 0.17
...
### Community 783 - "GitHubPolicyProbe"
Cohesion: 0.19
...
### Community 786 - "_is_bedrock_model_id"
Cohesion: 0.27
...
### Community 788 - "_extractive_compress"
Cohesion: 0.18
...
### Community 790 - "AI Engineering Insights Skill"
Cohesion: 0.29
...
### Community 791 - "cowork_session.py"
Cohesion: 0.15
...
### Community 795 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 798 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 799 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 800 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 803 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 806 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 807 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 809 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 810 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
...
### Community 811 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
...
### Community 813 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 814 - "FeatureUnavailableError"
Cohesion: 0.16
...
### Community 815 - "test_bedrock_live.py"
Cohesion: 0.25
...
### Community 816 - "TestKillSwitchDurability"
Cohesion: 0.15
...
### Community 817 - "test_quick_note_engine.py"
Cohesion: 0.17
...
### Community 818 - "build_admin_local_brain_router"
Cohesion: 0.24
...
### Community 819 - "build_tech_db.py"
Cohesion: 0.35
...
### Community 820 - "migrate_local_brain_env.py"
Cohesion: 0.25
...
### Community 824 - "TestMCPClientStructuredOutput"
Cohesion: 0.27
...
### Community 825 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 826 - "TestZeroAttemptDiagnostics"
Cohesion: 0.25
...
### Community 827 - "test_google_provider_models.py"
Cohesion: 0.18
...
Cohesion: 0.18
Nodes (12): get_catalog_models_route(), Return the mirrored model catalog (advisory-only). Flag-gated by…, Force a catalog mirror rebuild + persist (admin only). Rebuilds the catalog…, sync_catalog_route(), get_catalog(), get_model_catalog_store(), is_catalog_enabled(), Return the process-wide ModelCatalogStore singleton. (+4 more)
...
### Community 830 - "test_telegram_mutating_commands.py"
Cohesion: 0.09
...
### Community 831 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 833 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 835 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 836 - "Skill: repowise-intelligence"
Cohesion: 0.12
...
### Community 839 - "Hyperframes Composition Brief: Autonomous AI Agency"
Cohesion: 0.20
Nodes (9): Audio, Creative Direction, Hyperframes Composition Brief: Autonomous AI Agency, Hyperframes Instructions, Objective, Output, Source Material, Storyboard (+1 more)

### Community 840 - "_normalize_tool_choice"
Cohesion: 0.31
...
### Community 842 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 843 - "Skill: branch-cleanup"
Cohesion: 0.14
...
### Community 847 - "Skill: repowise-intelligence"
Cohesion: 0.12
Nodes (15): 1. Graph Intelligence (Dependency Graph), 2. Git Intelligence, 3. Documentation Intelligence, 4. Decision Intelligence, Acceptance Checks, Directory Structure, Example Usage, Implementation Approach (+7 more)

### Community 848 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 849 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 850 - "Competitor Analysis — Autonomous AI Agency"
Cohesion: 0.20
...
### Community 851 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 852 - "CI Troubleshooting Runbook"
Cohesion: 0.20
...
### Community 853 - "What to clean up"
Cohesion: 0.18
...
### Community 855 - "TestCompanyGraphModels"
Cohesion: 0.17
...
### Community 856 - "capture_screens.py"
Cohesion: 0.29
...
### Community 857 - "enrich_quick_note_issues.py"
Cohesion: 0.36
...
### Community 860 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 861 - "TestPoliciesGovernanceStableClaim"
Cohesion: 0.20
...
### Community 862 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 863 - "test_model_catalog_guard.py"
Cohesion: 0.29
...
### Community 865 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 867 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 868 - "test_workflow_api_mount.py"
Cohesion: 0.20
...
### Community 870 - "WorkspaceMetrics"
Cohesion: 0.20
...
### Community 872 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 875 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 877 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 880 - "Skill: changelog-enforcer"
Cohesion: 0.22
Nodes (8): Acceptance Checks, Changelog Location, Entry Format, Examples, Hook Behaviour, Instructions, Skill: changelog-enforcer, When to Use

### Community 881 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 882 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 885 - "Release Procedure"
Cohesion: 0.22
...
### Community 886 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 887 - "rate_limiter.py"
Cohesion: 0.18
Nodes (8): get_tracker(), _ProviderQuota, Proactive rate-limit throttling for LLM providers — two complementary layers.…, Parse x-ratelimit-* headers and update per-provider quota state. Safe to call…, Return the process-singleton RateLimitTracker., Clear all token-bucket state (tests only). Does not touch the header tracker's…, reset(), _reset_buckets()

### Community 888 - "get_control"
Cohesion: 0.22
...
### Community 891 - "TestAgentRunnerSafety"
Cohesion: 0.24
...
### Community 892 - "TestNoNvidiaFallbackIsRetired"
Cohesion: 0.22
...
### Community 893 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 897 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 898 - ".test_every_request_carries_a_real_user_agent"
Cohesion: 0.22
...
### Community 900 - "Issue #1427: quick-note:https://github.com/bingreeky/JIT"
Cohesion: 0.20
...
### Community 903 - "TestEveryFullSuiteJobHasMongo"
Cohesion: 0.22
...
### Community 905 - "LLM Router — configuration guide"
Cohesion: 0.20
...
### Community 906 - "test_serve_spa_prefixes.py"
Cohesion: 0.31
...
### Community 912 - "LLM Router — provider guide"
Cohesion: 0.20
...
### Community 914 - "hybrid_reasoning.py"
Cohesion: 0.36
...
### Community 915 - "_resolve_push_token"
Cohesion: 0.31
...
### Community 916 - "quality_checker.py"
Cohesion: 0.32
...
### Community 917 - "research_coordinator.py"
Cohesion: 0.36
...
### Community 920 - "test_p0_roadmap_b1_c2_a3.py"
Cohesion: 0.10
...
### Community 921 - "Agent: Judge (Release / QA Gate)"
Cohesion: 0.25
Nodes (7): Activation, Agent: Judge (Release / QA Gate), Enforcement, Output, Responsibilities, Role, Verdict Meanings

### Community 922 - "Skill: browserbase-browser — Real Browser Automation"
Cohesion: 0.25
...
### Community 927 - "GitHub Branch Protection Settings"
Cohesion: 0.25
...
### Community 936 - "Issue #362: Nvidia repo setup"
Cohesion: 0.25
...
### Community 937 - "Issue #364: quick-note:https://www.marktechpost.com/2026/06/01/meet-memory-os-a-6-layer-open-source-memory-stack-built-on-top-of-hermes-agent/"
Cohesion: 0.25
...
### Community 938 - "Issue #378: quick-note:https://www.marktechpost.com/2026/06/02/tinyfish-launches-bigset-an-open-source-multi-agent-system-that-builds-structured-live-datasets-from-plain-english-descriptions/"
Cohesion: 0.25
...
### Community 939 - "Issue #379: quick-note:https://searchengineland.com/schema-markup-optimize-agentic-web-479080"
Cohesion: 0.25
...
### Community 940 - "Issue #380: quick-note:https://cursor.com/blog/cloud-agent-lessons"
Cohesion: 0.25
...
### Community 941 - "Issue #381: quick-note:https://www.xda-developers.com/claude-code-with-opus-48-is-expensive-but-i-made-it-efficient-with-my-local-ai-workflow/"
Cohesion: 0.25
...
### Community 942 - "Issue #382: quick-note:https://claude.com/blog/how-coderabbit-used-claude-to-build-an-agent-orchestration-system"
Cohesion: 0.25
...
### Community 943 - "Issue #383: quick-note:https://www.marktechpost.com/2026/05/29/hexo-labs-open-sources-sia-a-self-improving-agent-that-updates-both-the-harness-and-the-model-weights/"
Cohesion: 0.25
...
### Community 944 - "Issue #416: feat: Self-hosted Codebuff (freebuff) on free NVIDIA models + Telegram bot phone control"
Cohesion: 0.25
...
### Community 945 - "Issue #485: [Trend Digest] Week of 2026-06-08"
Cohesion: 0.25
...
### Community 946 - "Issue #488: quick-note:https://github.com/cookiy-ai/user-research-skill"
Cohesion: 0.25
...
### Community 947 - "Issue #491: Implement whatever is necessary from https://github.com/BehiSecc/awesome-claude-skills"
Cohesion: 0.25
...
### Community 948 - "Issue #493: Use the https://github.com/mvanhorn/last30days-skill skill to get the trend updated"
Cohesion: 0.25
...
### Community 949 - "Issue #495: Read https://www.anthropic.com/news/claude-fable-5-mythos-5 and understand if mythos or fable can be added to the repo"
Cohesion: 0.25
...
### Community 950 - "Issue #504: EPIC: Autonomy hardening — live-verified defects 2026-06-10"
Cohesion: 0.25
...
### Community 951 - "Issue #581: Sprint tracker: pending work after brand rename + mobile-first pass"
Cohesion: 0.25
...
### Community 953 - "Issue #657: quick-note:https://github.com/earendil-works/pi"
Cohesion: 0.25
...
### Community 954 - "Issue #659: quick-note:https://github.com/nex-agi/Nex-N2"
Cohesion: 0.25
...
### Community 955 - "Issue #660: quick-note:https://github.com/getsentry/sentry-for-ai"
Cohesion: 0.25
...
### Community 956 - "Issue #661: quick-note:https://github.com/XiaomiMiMo/MiMo-Code"
Cohesion: 0.25
...
### Community 957 - "Issue #664: quick-note:https://github.com/Grominet95/jarvis-OS"
Cohesion: 0.25
...
### Community 958 - "Issue #666: quick-note:https://github.com/porokka/jarvis-os"
Cohesion: 0.25
...
### Community 959 - "Issue #670: quick-note:https://github.com/perplexityai/bumblebee"
Cohesion: 0.25
...
### Community 960 - "Issue #672: quick-note:https://github.com/Chachamaru127/claude-code-harness"
Cohesion: 0.25
...
### Community 961 - "Issue #676: quick-note:https://github.com/WeiboAI/VibeThinker"
Cohesion: 0.25
...
### Community 962 - "Issue #820: quick-note:https://github.com/cobusgreyling/loop-engineering"
Cohesion: 0.25
...
### Community 964 - "Platform Controls"
Cohesion: 0.22
...
### Community 966 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 967 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 968 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 969 - "Feature Maturity / Support Matrix"
Cohesion: 0.12
...
### Community 976 - "crispy_burn_in.py"
Cohesion: 0.36
...
### Community 982 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 983 - "test_local_brain_router_smoke.py"
Cohesion: 0.25
...
### Community 984 - "test_mcp_protocol_version.py"
Cohesion: 0.25
...
### Community 987 - "_get_current_user"
Cohesion: 0.25
...
### Community 993 - "test_probe_base_url_override_hits_the_typed_url"
Cohesion: 0.22
...
### Community 998 - "test_daemon_picks_colibri_8081_when_only_it_listening"
Cohesion: 0.22
...
### Community 1000 - "Karpathy Guidelines Skill"
Cohesion: 0.29
...
### Community 1010 - "claude-mem Plugin — Persistent Memory for All Sessions"
Cohesion: 0.29
...
### Community 1013 - "Workspace Issues"
Cohesion: 0.29
...
### Community 1017 - "get_output_filter"
Cohesion: 0.32
...
### Community 1018 - "Agent Transparency Report"
Cohesion: 0.15
...
### Community 1020 - "check_doc_images.py"
Cohesion: 0.48
...
### Community 1027 - "TestPolicyAuthoringUiStableClaim"
Cohesion: 0.25
...
### Community 1028 - "TestReasonsAreActionable"
Cohesion: 0.29
...
### Community 1029 - "TestProvidersScreen"
Cohesion: 0.43
...
### Community 1030 - "TestMongoService"
Cohesion: 0.29
...
### Community 1035 - "TestActiveStrategy"
Cohesion: 0.29
Nodes (3): parametrize, A typo must not silently pick some other distribution., TestActiveStrategy

### Community 1036 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.25
...
### Community 1038 - "Music Cues: happy-beats-business-moves-vol-12-by-ende-dot-app"
Cohesion: 0.33
...
### Community 1039 - "/fix-bug — Bug Fix Agent"
Cohesion: 0.33
Nodes (5): Escalation, /fix-bug — Bug Fix Agent, Process, Rules, Usage

### Community 1040 - "Command: /plan"
Cohesion: 0.33
...
### Community 1051 - "ADR-007: Storage backend duck-typing over formal ABC"
Cohesion: 0.33
Nodes (5): ADR-007: Storage backend duck-typing over formal ABC, Consequences, Context, Decision, Rationale

### Community 1052 - "Positional Encoding Internals"
Cohesion: 0.25
...
### Community 1053 - "The full agent capability roster"
Cohesion: 0.33
...
### Community 1054 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 1055 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 1059 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 1074 - "TestWorkflowIntegration"
Cohesion: 0.33
...
### Community 1079 - "_answer_callback"
Cohesion: 0.29
...
### Community 1080 - "TestTheAgentRunsCurrentCode"
Cohesion: 0.33
...
### Community 1082 - "test_nuclear_cleanup_targets_the_schedule_collection"
Cohesion: 0.25
...
### Community 1101 - "Docker (local or any container host)"
Cohesion: 0.40
...
### Community 1106 - "governance/__init__.py"
Cohesion: 0.40
Nodes (3): __getattr__(), Any, packages/governance — agent identity, policy, approvals, audit, sandboxes. The…

### Community 1107 - "inspect-agent-runtime.sh"
Cohesion: 0.60
Nodes (3): fail(), inspect-agent-runtime.sh script, usage()

### Community 1108 - "Prompt Library Changelog"
Cohesion: 0.40
Nodes (4): Added, Format, Prompt Library Changelog, [Unreleased]

### Community 1109 - "Request"
Cohesion: 0.09
Nodes (27): middleware, admin_logout(), check_rate_limit(), _enforce_rate_limit(), _get_admin_identity_from_request(), _is_freebuff_unlimited(), ollama_api(), openai_compat() (+19 more)
...
### Community 1118 - "start_tunnel.py"
Cohesion: 0.50
...
### Community 1122 - "nvidia_live_test.py"
Cohesion: 0.40
...
### Community 1123 - "is_anthropic_base_url"
Cohesion: 0.18
...
### Community 1125 - "TestInternalAgentAdapterProviderChain"
Cohesion: 0.40
...
### Community 1129 - "TestGhIsNotReAuthenticated"
Cohesion: 0.40
...
### Community 1161 - "test_no_exception_detail_leaks.py"
Cohesion: 0.50
...
### Community 1163 - "Model and Response Issues"
Cohesion: 0.29
...
### Community 1250 - "check_changelog_parity.py"
Cohesion: 0.43
...
### Community 1251 - "test_log_monitor_storm_guard.py"
Cohesion: 0.48
...
### Community 1255 - "openclaw_mobile_ui"
Cohesion: 0.33
...
### Community 1256 - "_wfo_owned_run_or_404"
Cohesion: 0.33
...
### Community 1295 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 1296 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 1297 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 1298 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 1299 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 1301 - "resolve_hermes_base_url"
Cohesion: 0.47
...
### Community 1302 - "TestAgentRunnerExecution"
Cohesion: 0.33
...
### Community 1305 - ".daily_active_users"
Cohesion: 0.40
...
### Community 1310 - "Who is this for?"
Cohesion: 0.40
...
### Community 1311 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 1315 - "routed"
Cohesion: 0.40
Nodes (3): Tool calling is the compatibility case most likely to break silently., routed(), test_shim_preserves_tool_calls_through_the_router()

### Community 1316 - "fetch"
Cohesion: 0.60
Nodes (4): fetch(), needsProxy(), PROXY_PREFIXES, scheduled()

### Community 1320 - "providers.yaml"
Cohesion: 0.50
Nodes (4): Bulkhead sizing, Per-minute token budgets, providers.yaml, Tiers

### Community 1321 - "Issue → Context → Draft PR automation"
Cohesion: 0.50
Nodes (4): Backfilling existing issues, Free-first model routing, Issue → Context → Draft PR automation, The workflows

### Community 1322 - "The 24x7 agency — your agents never go idle"
Cohesion: 0.50
...
### Community 1326 - "Claude Code Specific Issues"
Cohesion: 0.50
...
### Community 1333 - "Configuration reference"
Cohesion: 0.67
...
- **3548 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3543 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 14406 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **177 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `_fixture()` connect `_fixture` to `test_portfolio_intake.py`, `brain_config.py`, `test_llm_router_queue_cache.py`, `test_webui_provider_priority.py`, `company_api.py`, `TaskStatus`, `test_llm_router_gateway.py`, `test_telegram_freebuff.py`, `test_llm_router_strategies.py`, `test_autonomy_status.py`, `AgentRunner`, `client`, `test_brain_patch_service_token.py`, `ImprovementLoop`, `test_model_router.py`, `test_provider_failover_integration.py`, `test_sam_livekit.py`, `NotificationDispatcher`, `Task`, `test_harness_spec.py`, `OnboardingService`, `resolve_active_brain`, `build_governance_router`, `PolicyEngine`, `services/background.py`, `nvidia_models.py`, `ExecutionRequest`, `test_failover_client_shared.py`, `UserRole`, `test_llm_router_resilience.py`, `SelfHealingAgent`, `ClaudeCodeAdapter`, `test_company_api.py`, `test_catalogue_probe.py`, `test_orchestrator_merge_decision.py`, `test_phase5_doctor.py`, `quick_note.py`, `SeoAuditEngine`, `test_provider_router.py`, `Specialist`, `BrainWatchdog`, `test_task_brain_preflight.py`, `e2e/test_browser.py`, `test_openclaw_endpoints.py`, `PrimeAgentAdapter`, `test_ceo_router.py`, `claim`, `test_unit8_model_catalog.py`, `test_operational_incidents.py`, `resolve_e2b_config`, `TestClient`, `OutputFilter`, `test_procedural_memory.py`, `test_gh_brain_failover.py`, `test_knowledge_sync.py`, `controls_app`, `TokenBudget`, `SQLiteStore`, `test_provider_state_durability.py`, `direct_chat.py`, `test_freebuff_bot.py`, `test_startup_warmup.py`, `config.py`, `TestChatHistoryStore`, `test_refresh_agent_built_proof.py`, `test_sam_voice.py`, `test_telegram_task_callback.py`, `router_factory`, `test_trend_watcher.py`, `test_agent_tool_governance.py`, `ArtifactStore`, `KeyStore`, `ChatHistoryStore`, `test_new_features_e2e.py`, `loop.py`, `test_context_rulebook.py`, `test_llm_router_e2e.py`, `FeatureMaturity`, `E2BSandboxSession`, `test_tasks_reconciler_todo_requeue.py`, `run_task`, `TrafficDirector`, `E2BAdapter`, `test_voice_pipeline.py`, `test_kimi_bridge_server.py`, `enforcement.py`, `_step`, `test_e2b_data_flow.py`, `test_monitor_lib.py`, `telegram_inbound_handlers.py`, `_is_exempt`, `test_langfuse_agency_wide.py`, `test_openclaw_gateway.py`, `test_runtimes_health_endpoint.py`, `test_local_brain_state.py`, `WorkflowRun`, `ResearchOrchestrator`, `KeyPool`, `OllamaCircuitBreaker`, `_job_text`, `test_video_transcript.py`, `ScheduledJob`, `test_features_api.py`, `MCPClient`, `SeoFixer`, `TrendWatcher`, `api_keys_for`, `test_doctor_service_token_check.py`, `TestEstimateTokensForMessages`, `brain_failover.py`, `test_telegram_webhook.py`, `AgentProfile`, `clear_cooldowns`, `test_mcp_governance.py`, `ContextPruner`, `test_purge_backlog.py`, `test_agile_api.py`, `test_app_settings.py`, `test_issue_intake.py`, `test_persistent_memory.py`, `test_provider_enable_disable.py`, `test_task_clarification.py`, `SecurityScanner`, `TestClient`, `test_nvidia_model_discovery.py`, `routed`, `TaskExecutionCoordinator`, `_resolve_user_github_token`, `test_ephemeral_reaper.py`, `resolve_component_model`, `test_brain_availability_doctor.py`, `TestNormalizeResponseFormat`, `test_platform_controls.py`, `analyze_page`, `session_retro.py`, `test_agency_fix.py`, `test_skill_registry_boot_refresh.py`, `test_colibri_brain_shim.py`, `test_scheduler_hydration_bounded.py`, `_Budget`, `_start_ceo_agency`, `test_control_plane_api.py`, `test_regression.py`, `test_agent_scripts_share_one_model_list.py`, `test_crispy_burn_in.py`, `test_implement_agent_routing.py`, `test_executive_advisory_api.py`, `rate_limiter.py`, `model_discovery.py`, `isolated_telegram_config`, `_Recorder`, `TestSwarmRoleRouting`, `test_process_quick_note_workflow.py`, `_undeclared`, `_redact_for_notification`, `_resolve_push_token`, `TestMongoGate`, `test_agent_free_brain.py`, `test_service_token.py`, `test_telegram_diag_endpoint.py`, `._check_permissions`, `OrchestratorCheckpointStore`, `test_v4_api.py`, `parse_event_stream`, `TestTheWorkflowIsSafeAndReadOnly`, `test_daily_2026_07_27.py`, `test_mcp_protocol_version.py`, `test_ping.py`, `TestSeoApiSurface`, `TestRequireAdmin`, `captured`, `UsageEvent`, `cost_tracker.py`, `TestHarnessAdapter`, `test_dashboard_cache.py`?**
  _High betweenness centrality (0.105) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `AdaptiveHalter`, `ContextPruner`, `backend/server.py`, `test_backend_server_features.py`, `_fixture`, `WorkspaceTools`, `GitHubTools`, `proxy.py`, `InternalAgentAdapter`, `TaskSpec`, `test_agent_chat_integration.py`, `test_agent_runner.py`, `TestAgentLoopMCPIntegration`, `loop.py`, `ContextManager`, `test_ceo_micromanager.py`, `E2BSandboxSession`, `TestAgentRunnerExecution`, `E2BAdapter`, `test_agent_free_brain.py`, `test_autonomous_agency_e2e.py`, `test_daily_automation_2026_07_11.py`, `PolicyEngine`, `ReactScratchpad`, `enforcement.py`, `ExecutionRequest`, `test_failover_client_shared.py`, `LocalWorkspace`, `test_ceo_dispatcher.py`, `StuckDetector`, `test_empirical_verify.py`, `test_ceo_supervision.py`, `test_governance_api.py`, `AgentSessionStore`, `FreeBuffAgent`, `MCPClient`, `TestInternalAgentAdapterProviderChain`, `MultiAgentSwarm`, `TokenBudget`, `direct_chat.py`, `UserMemoryStore`, `TestAgentRunnerSafety`, `test_agent_tool_governance.py`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `SelfHealingAgent` connect `SelfHealingAgent` to `services/background.py`, `analyze`, `TestSelfHealingInfrastructureClassification`, `telegram_service.py`, `NotificationDispatcher`, `test_daily_2026_07_27.py`, `ImprovementLoop`, `test_integration_c4_c5_c6_d3.py`?**
