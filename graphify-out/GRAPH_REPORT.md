# Graph Report - pr1314b  (2026-08-21)

## Corpus Check
- 1444 files · ~2,076,900 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 28732 nodes · 53665 edges · 1225 communities (1111 shown, 114 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 2637 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a2b42497`
...
## Communities (1225 total, 114 thin omitted)

### Community 0 - "backend/server.py"
Cohesion: 0.01
Nodes (349): _is_admin(), Check if a user has admin role. Works for both social_auth users (role in…, admin_seed(), _agent_timeout_fallback_response(), AgentStatusEntry, AgentStatusResponse, AgentToolCallEntry, ApiKeyCreate (+341 more)

### Community 1 - "company_api.py"
Cohesion: 0.02
Nodes (182): ephemeral_ttl_hours(), Async read of the ephemeral TTL (hours) straight from the DB., account_lifecycle(), AccountLifecycleResponse, auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint() (+174 more)

### Community 2 - "LLMRequest"
Cohesion: 0.03
Nodes (143): ProviderConfig, One configured endpoint. ``kind`` selects the adapter: ``openai`` (any OpenAI-…, packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, classify_error(), LLMProvider, OpenAICompatible, ABC, Any (+135 more)

### Community 3 - "_fixture"
Cohesion: 0.01
Nodes (141): app_client(), _clear_discovered_models(), _clear_response_cache(), client(), _isolate_brain_data_layer(), _isolate_operator_provider_state(), non_admin_client(), MonkeyPatch (+133 more)

### Community 4 - "llm/router.py"
Cohesion: 0.02
Nodes (128): Attempt, get_budget(), packages/llm/budget.py — token and cost accounting with spend alerts. Tracks…, The process-wide budget tracker., get_cache(), packages/llm/cache.py — layered caching. Five independent layers, each with its…, The process-wide cache manager., text_key() (+120 more)

### Community 5 - "CompanyGraphStore"
Cohesion: 0.02
Nodes (97): BusinessCategory, Company, CompanyGraph, KnowledgeItem, SystemType, The core company entity - root of the Company Graph., The complete Company Graph - canonical core model for the Autonomous AI Agency.…, Find a website by its URL. (+89 more)

### Community 6 - "proxy.py"
Cohesion: 0.03
Nodes (160): get_skill_registry_safe(), Return the global SkillRegistry if set, else None. Used by onboarding and other…, middleware, admin_control(), admin_login(), admin_logout(), admin_status(), AdminControlBody (+152 more)
...
### Community 9 - "resolve_active_brain"
Cohesion: 0.02
Nodes (110): livenim, allow_paid_brain(), BrainResolution, provider_api_key(), Return the live API key for *provider* (env-only — never persisted)., get_active_brain_sync(), get_brain_preference(), get_provider_role_tags() (+102 more)

### Community 10 - "brain_config.py"
Cohesion: 0.03
Nodes (119): Call-time resolver for an agent role model id. Delegates to…, _resolve_role_model(), BrainConfig, BrainConfigPatch, BrainConfigStore, default_brain_config(), get_brain_config(), get_brain_config_store() (+111 more)
...
Cohesion: 0.02
Nodes (105): _brain_provider_status(), get_catalog_models_route(), Return the mirrored model catalog (advisory-only). Flag-gated by…, Return per-provider metadata for the GET endpoint. Iterates every provider in…, Return the discovered model list for *provider_id*, or ``[]`` if unknown., _served_models(), all_provider_ids(), provider_base_url() (+97 more)
...
### Community 18 - "ExecutionRequest"
Cohesion: 0.04
Nodes (76): Called by APScheduler when a cron fires. Dispatches to the orchestrator. This…, _scheduler_on_fire(), get_orchestrator_supervisor(), OrchestratorSupervisor, Deterministic supervisor for the orchestrator. Runs as a background coroutine.…, stop_orchestrator_supervisor(), BoundContext, ExecutionRequest (+68 more)
...
### Community 21 - "get_user_role"
Cohesion: 0.04
Nodes (73): compute_savings(), compute_time_series(), get_savings(), get_usage(), get_user_savings(), _period_start(), Any, BaseModel (+65 more)
...
Cohesion: 0.03
Nodes (93): CEOResult, _merge_changed_files(), Aggregated output from a multi-specialist execution., Collect changed_files across all specialists into a single de-duped list., ClassifyOutput, get_ceo_fallback_stats(), PlanOutput, CLASSIFY phase: domain and task type determination. (+85 more)
...
### Community 38 - "get_company_graph_store"
Cohesion: 0.04
Nodes (74): get_optional_company_access(), Company, Verify user has access to a company (if authenticated). Admins bypass ownership…, Fire-and-forget self-bootstrap; never blocks or crashes startup., _schedule_self_bootstrap(), CompanyAgencyService, get_company_agency_service(), _is_runtime_available_sync() (+66 more)
...
### Community 41 - "get_runtime_manager"
Cohesion: 0.04
...
Cohesion: 0.05
Nodes (75): _acquire_provider_probe(), extract_openai_text(), is_commercial_provider(), _normalize_nvidia_base_url(), _openai_url(), provider_access_tier(), _provider_field(), provider_sort_key() (+67 more)

### Community 43 - "test_agent_tool_governance.py"
Cohesion: 0.04
Nodes (67): ApprovalRequest, ApprovalStatus, ApprovalStore, Any, Enum, str, packages/governance/approvals.py — human-in-the-loop for high-risk actions. The…, Bounded, in-process store of approval requests. Uses a :class:`threading.Lock`… (+59 more)

### Community 44 - "test_sam_livekit.py"
Cohesion: 0.04
Nodes (68): get_sam(), agent/sam.py — SAM Voice Agent (System Autonomy Manager) SAM is the voice-…, Report whether the SAM realtime voice (LiveKit) transport is configured., sam_livekit_status_backend(), auth_headers(), livekit_env(), no_livekit_env(), _normalize_dockerfile() (+60 more)
...
### Community 48 - "Task"
Cohesion: 0.05
Nodes (51): Hand the 'connect & verify the repo' work to the agency's own agents. The task…, _seed_connect_task(), Full task/issue document., Task, Best-effort label of who will run this task once approved. Returns…, PUBLIC_URL-anchored dashboard deep link for the task detail. Returns empty…, Best-effort Telegram heads-up that a task is parked awaiting approval. Inline…, asyncio (+43 more)

### Community 49 - "AgentPlan"
Cohesion: 0.04
Nodes (61): PreflightIssue, PreflightReport, BaseModel, Agent subsystem — planner / executor / verifier loop., AgentEvent, AgentPlan, AgentRunRequest, AgentSession (+53 more)

### Community 50 - "TestAdapterMetadata"
Cohesion: 0.04
...
### Community 51 - "_ts_to_float"
Cohesion: 0.05
Nodes (74): Reset the singleton (for tests)., reset_failover_manager(), _blocked_retire_age_sec(), _heal_blocked_backlog(), _heal_brain_failover(), _heal_purge_backlog(), _heal_stuck_tasks(), _heal_task_duplicates() (+66 more)

### Community 52 - "services/background.py"
Cohesion: 0.05
Nodes (66): get_improvement_loop(), get_trend_watcher(), agent/trend_watcher.py — Internet-connected AI trend intelligence. Fetches from…, set_trend_watcher(), _await_hermes_ready(), BackgroundServices, _env_float(), _env_on() (+58 more)
...
### Community 64 - "direct_chat.py"
Cohesion: 0.06
Nodes (65): DirectChatDoctor, Any, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, Translate technical preflight issues into a conversational assistant reply., translate_error_to_conversational(), AcceptedJob, AgentJobEnvelope, CompletedJob (+57 more)

### Community 65 - "test_autonomous_agency_e2e.py"
Cohesion: 0.05
Nodes (47): BackgroundAgent, BackgroundTask, _now(), Any, agent/background.py — Background Agent An always-on worker thread that…, Enqueue *task* for processing. Returns the task (with task_id set)., Convenience: create a task and submit it in one call., Real handler — dispatches through AgentRunner when available. HARDENED (PR… (+39 more)
...
Cohesion: 0.05
Nodes (51): Resolve the LLM endpoint for agent execution (module-level, #522 failover).…, _resolve_brain_provider(), tests/test_brain_resolver.py — Tests for the single brain resolver. The agency…, When a free provider (NVIDIA NIM) is configured, the brain must NOT auto-pick…, When only a paid record exists AND ALLOW_PAID_BRAIN is set, the brain picks the…, When a base_url is excluded (transient retry failure), the next-best free…, When provider records are missing AND ``NVIDIA_API_KEY`` is set, resolve to the…, When nothing is configured AND NVIDIA_API_KEY unset, fall through to local… (+43 more)
...
Cohesion: 0.04
Nodes (55): backend/ceo_router.py — observability and manual control for the CEO. Surfaces…, Reject non-admin callers for routes that spend provider budget. Delegates to…, _require_admin(), brain_providers(), Every configured provider with its health AND its on/off state. Powers the…, brain_availability_summary(), describe_disabled_reason(), _disabled_from_mongo() (+47 more)
...
### Community 78 - "activation_api.py"
Cohesion: 0.06
Nodes (63): activate_instance(), ActivateRequest, ActivateResponse, activation_audit_log(), ActivationStatusResponse, _append_audit(), AuditLogEntry, change_user_role() (+55 more)

### Community 79 - "FetchResult"
Cohesion: 0.05
...
### Community 91 - "AgentSessionStore"
Cohesion: 0.07
...
### Community 96 - "InternalAgentAdapter"
Cohesion: 0.04
...
### Community 97 - "test_runtime_governance.py"
Cohesion: 0.07
Nodes (50): _blocked_result(), _governance_check(), Any, TaskResult, TaskSpec, Evaluate a runtime dispatch against policy; audit it either way. Returns…, Full record of a routing decision — audit-trail entry., Selects a runtime for the given task, executes the task (including readiness… (+42 more)
...
### Community 111 - "get_task_store"
Cohesion: 0.05
Nodes (43): delegate_seo_findings(), Create real agent tasks from the audit's delegation plan. Each work package…, _keepalive_self_ping(), lifespan(), _maybe_boot_purge(), _purge_backlog_core(), _purge_summary_clean(), quick_notes_submit() (+35 more)

### Community 112 - "run_task"
Cohesion: 0.05
...
### Community 115 - "CEODispatcher"
Cohesion: 0.07
Nodes (41): CEODispatcher, _complexity_rank(), _decompose_into_subtasks(), _offload(), Any, services/ceo_dispatcher.py — Real CEO delegation layer. The CEO splits a…, Run a synchronous ledger call without blocking the event loop. ``CEOLedger`` is…, Build an agent.coordinator.TaskSpec from a CEO SpecialistTask. (+33 more)

### Community 116 - "resolve_e2b_config"
Cohesion: 0.06
...
### Community 117 - "TestBrainFailoverModelUpdates"
Cohesion: 0.06
...
Cohesion: 0.07
Nodes (54): Convenience: resolve all four role models for a component. Returns a dict with…, resolve_component_role_models(), get_decisions_store(), Process-wide DecisionsStore singleton (resettable via db_path arg)., Return a Markdown-v1-safe preview string under ``max_chars``. Used by the…, sanitize_paste_for_preview(), _admin_headers(), _api_headers() (+46 more)

### Community 123 - "settings.py"
Cohesion: 0.04
Nodes (31): packages.config — single source of truth for all configuration. Every module…, _env_int(), _get_settings(), packages/config/settings.py — typed configuration. This is the ONLY module in…, Read an int env var, falling back to *default* on a missing/bad value. Never…, When True, the governance layer evaluates and audits agent actions. This is…, Typed configuration loaded from environment variables., When True, approval-gated actions self-approve. Local dev only. (+23 more)
...
### Community 130 - "test_governance_api.py"
Cohesion: 0.06
...
### Community 131 - "test_telegram_freebuff.py"
Cohesion: 0.06
...
### Community 134 - "failover_client.py"
Cohesion: 0.06
...
### Community 141 - "test_e2b_adapter.py"
Cohesion: 0.06
...
### Community 142 - "NotificationDispatcher"
Cohesion: 0.06
...
### Community 152 - "ProvidersScreen.jsx"
Cohesion: 0.06
...
### Community 153 - "TestEstimateTokensForMessages"
Cohesion: 0.05
...
### Community 154 - "resolve_component_model"
Cohesion: 0.05
...
### Community 158 - "OnboardingScreen.jsx"
Cohesion: 0.05
...
### Community 159 - "test_schedule_growth_invariants.py"
Cohesion: 0.05
...
### Community 167 - "pr_approval_gate.py"
Cohesion: 0.08
...
### Community 169 - "test_slop_gate.py"
Cohesion: 0.07
...
### Community 170 - "OllamaCircuitBreaker"
Cohesion: 0.08
...
### Community 172 - "PromptCacheManager"
Cohesion: 0.06
...
### Community 177 - "test_ceo_router.py"
Cohesion: 0.08
...
### Community 178 - "_resolve_user_github_token"
Cohesion: 0.07
Nodes (40): _DoctorCheck, _DoctorReport, get_doctor_diagnostics(), get_doctor_report(), get_public_doctor(), _in_container(), Path, Public Doctor endpoint — no authentication required. Returns system-level… (+32 more)
...
### Community 180 - "test_seo_audit.py"
Cohesion: 0.06
...
### Community 184 - "test_video_transcript.py"
Cohesion: 0.05
...
### Community 188 - "Part A — CodeRabbit review fixes for this PR (do first, small)"
Cohesion: 0.05
...
### Community 189 - "Docker Agent Runtimes Setup"
Cohesion: 0.05
...
### Community 191 - "test_daily_2026_06_04.py"
Cohesion: 0.08
...
### Community 195 - "_get_provider_policy"
Cohesion: 0.07
...
### Community 196 - "emit_chat_observation"
Cohesion: 0.09
...
### Community 197 - "Persistent Memory System"
Cohesion: 0.05
...
### Community 201 - "test_bedrock_provider.py"
Cohesion: 0.08
...
### Community 207 - "test_portfolio_intake.py"
Cohesion: 0.09
...
### Community 210 - "configuration-reference.md"
Cohesion: 0.08
...
### Community 211 - "models/seo_audit.py"
Cohesion: 0.10
...
### Community 219 - "test_mcp_governance.py"
Cohesion: 0.09
Nodes (37): get_audit_log(), Return the process-wide audit log, created on first use., Replace the process-wide engine. Tests only., reset_policy_engine(), Per-session budgets and audit correlation both depend on this., test_dispatch_audits_the_call_with_agent_identity(), test_dispatch_reuses_one_session_id_across_calls(), _call() (+29 more)
...
### Community 222 - "analyze_quantitative"
Cohesion: 0.09
...
### Community 223 - "test_response_cache.py"
Cohesion: 0.16
...
### Community 224 - "system_instruction"
Cohesion: 0.09
...
### Community 225 - "test_pr923_fixes.py"
Cohesion: 0.07
...
### Community 238 - "REWRITE_PLAN.md — Phased Migration Strategy"
Cohesion: 0.06
...
### Community 239 - "test_background_services.py"
Cohesion: 0.08
...
### Community 240 - "skill_bindings.py"
Cohesion: 0.09
...
### Community 241 - "test_all_providers_discovery.py"
Cohesion: 0.16
...
### Community 242 - "test_persistent_memory.py"
Cohesion: 0.06
...
### Community 244 - "model_discovery.py"
Cohesion: 0.08
...
### Community 246 - "test_anthropic_router.py"
Cohesion: 0.09
...
### Community 249 - "test_llm_router_e2e.py"
Cohesion: 0.14
...
### Community 253 - "agents/agile_ceremonies.py"
Cohesion: 0.08
...
### Community 254 - "TestHarnessAdapter"
Cohesion: 0.06
Nodes (14): get_harness_adapter(), harness_catalog(), #522 + #505: Reliability startup — schedule hydration, orchestrator restore,…, Return the full ECC harness catalog with capabilities. Public — no auth…, _startup_reliability_hooks(), get_orchestrator_queue(), start_orchestrator_queue(), services/orchestrator_supervisor.py — Deterministic Supervisor Issue #522: A… (+6 more)
...
### Community 256 - "context_rules.py"
Cohesion: 0.11
...
### Community 257 - "test_platform_controls.py"
Cohesion: 0.08
...
Cohesion: 0.11
Nodes (33): ProviderHealth, Enum, Circuit-breaker state for a provider., _make_manager(), tests/test_brain_failover.py — Universal multi-provider brain failover tests.…, Status snapshot doesn't leak API keys., Make a fresh manager (bypasses the singleton for isolation)., No API keys set → no providers in the registry. (+25 more)
...
### Community 271 - "test_microagents.py"
Cohesion: 0.15
...
### Community 272 - "Security Analysis — local-llm-server"
Cohesion: 0.06
...
### Community 273 - "get_failover_manager"
Cohesion: 0.09
Nodes (31): _openclaw_instructions(), openclaw_reverse_proxy(), openclaw_status(), openclaw_websocket(), api_route, websocket, Return the OpenClaw Gateway integration status + pairing QR data. The gateway…, Build the instructions string (separate function to avoid .format() brace… (+23 more)

### Community 274 - "Langfuse Observability Guide"
Cohesion: 0.06
...
### Community 279 - "OrchestratorQueue"
Cohesion: 0.07
...
### Community 281 - "test_workspace_isolation.py"
Cohesion: 0.16
...
### Community 284 - "High-Agency Frontend Skill"
Cohesion: 0.06
...
### Community 286 - "TestNormalizeResponseFormat"
Cohesion: 0.08
...
### Community 287 - "Quick-Note GitHub Issues Processing - Session Summary"
Cohesion: 0.06
...
### Community 291 - "test_autonomy_gate.py"
Cohesion: 0.12
...
### Community 294 - "Workspace Isolation Architecture"
Cohesion: 0.06
...
### Community 295 - "Configuration Reference"
Cohesion: 0.07
...
### Community 298 - "test_failover_silent_exhaustion.py"
Cohesion: 0.11
...
### Community 301 - "test_rag_context.py"
Cohesion: 0.12
...
### Community 302 - "ProjectScaffolder"
Cohesion: 0.13
...
### Community 303 - "test_llm_router_disabled.py"
Cohesion: 0.12
Nodes (27): auto_disable(), _billing_signals(), disabled_provider_ids(), is_unfixable(), packages/llm/disabled.py — bridge to the durable provider on/off switch. The…, Provider ids currently switched off. Empty when the store is unreachable., Persist a provider as disabled, through the store that already owns it., The one list of "you have no money" phrases, borrowed not copied. Lazy because… (+19 more)

### Community 304 - "SteeringInjector"
Cohesion: 0.11
...
### Community 305 - "parse_event_stream"
Cohesion: 0.09
...
### Community 306 - "test_claude_setup_audit.py"
Cohesion: 0.16
...
### Community 307 - "test_brain_config_api.py"
Cohesion: 0.08
...
### Community 308 - "test_internal_agent_did_work.py"
Cohesion: 0.12
...
### Community 310 - "Python Dependencies (`requirements.txt`)"
Cohesion: 0.07
...
### Community 311 - "Technical Debt Register — local-llm-server"
Cohesion: 0.07
...
### Community 315 - "test_crispy_burn_in.py"
Cohesion: 0.07
...
### Community 316 - "test_provider_enable_disable.py"
Cohesion: 0.09
...
### Community 321 - "SetupWizardPage.js"
Cohesion: 0.11
...
### Community 322 - "AgentsScreen.jsx"
Cohesion: 0.11
...
### Community 324 - "test_phase4_runtime_resilience.py"
Cohesion: 0.11
...
### Community 327 - "telegram_service.py"
Cohesion: 0.09
...
### Community 328 - "isolated_telegram_config"
Cohesion: 0.11
...
### Community 329 - "test_scheduler_hydration_bounded.py"
Cohesion: 0.09
...
### Community 330 - "validate_outbound_url"
Cohesion: 0.14
...
### Community 331 - "webui/frontend/package.json"
Cohesion: 0.07
...
### Community 333 - "VoiceCommandInterface"
Cohesion: 0.14
...
### Community 334 - "Performance Analysis — local-llm-server"
Cohesion: 0.08
...
### Community 335 - "platform_controls_router.py"
Cohesion: 0.10
...
### Community 336 - "test_brain_priority_scanner.py"
Cohesion: 0.10
...
### Community 337 - "LLM Router — troubleshooting"
Cohesion: 0.08
...
### Community 340 - "test_rate_limiter.py"
Cohesion: 0.11
...
### Community 341 - "control_registry.py"
Cohesion: 0.14
...
### Community 344 - "test_telegram_approval_e2e.py"
Cohesion: 0.12
...
### Community 351 - "Session Handoff — 2026-06-15"
Cohesion: 0.08
...
### Community 352 - "TASK 4 — End-to-end approval-gate test"
Cohesion: 0.08
...
### Community 353 - "FeatureUnavailableError"
Cohesion: 0.10
...
### Community 356 - "test_claude_code_adapter.py"
Cohesion: 0.14
...
### Community 358 - "TemporalContextGraph"
Cohesion: 0.10
...
### Community 360 - "test_daily_automation_2026_08_03.py"
Cohesion: 0.11
...
### Community 361 - "TestClassifyPlainText"
Cohesion: 0.08
...
### Community 362 - "test_service_token.py"
Cohesion: 0.08
...
### Community 367 - "TestStreamableHTTPTransport"
Cohesion: 0.13
...
### Community 369 - "Local AI Stack with Docker"
Cohesion: 0.08
...
### Community 370 - "Implementation Prompt: Rich TaskBoard + Agile Sprint Integration"
Cohesion: 0.08
...
### Community 371 - "Telegram Bot Setup"
Cohesion: 0.08
...
### Community 372 - "video_transcript.py"
Cohesion: 0.12
...
### Community 373 - "control_overrides.py"
Cohesion: 0.12
...
### Community 377 - "test_agency_fix.py"
Cohesion: 0.08
...
### Community 380 - "test_webui_provider_priority.py"
Cohesion: 0.21
...
### Community 382 - "Agent Governance Guide"
Cohesion: 0.09
...
### Community 383 - "The fifteen strategies"
Cohesion: 0.09
...
### Community 390 - "SyntheticDataPipeline"
Cohesion: 0.13
...
### Community 393 - "test_monitor_lib.py"
Cohesion: 0.11
...
### Community 395 - "test_mostly_failed_steps.py"
Cohesion: 0.12
...
### Community 399 - "HarnessEnrichment"
Cohesion: 0.14
...
### Community 400 - "classify_direct_chat_intent"
Cohesion: 0.13
...
### Community 402 - "AdaptivePermissions"
Cohesion: 0.18
...
### Community 407 - "ChatResponse"
Cohesion: 0.10
Nodes (6): GroqProvider, Provider, OllamaProvider, Provider, ChatResponse, Standard response from a provider chat call.

### Community 408 - "Harness"
Cohesion: 0.14
...
### Community 409 - "get_ceo_dispatcher"
Cohesion: 0.11
...
### Community 412 - "OrchestratorCheckpointStore"
Cohesion: 0.14
...
### Community 413 - "test_portfolio_intelligence.py"
Cohesion: 0.10
...
### Community 418 - "V3 API Migration Plan — LLM Relay Platform"
Cohesion: 0.10
...
### Community 421 - "SeoCheckDefinition"
Cohesion: 0.12
...
### Community 423 - "test_chat_mode_regressions.py"
Cohesion: 0.18
...
### Community 427 - "test_local_controller.py"
Cohesion: 0.17
...
### Community 428 - "run_trend_analysis"
Cohesion: 0.18
...
### Community 430 - "PersistentMemoryStore"
Cohesion: 0.24
...
### Community 431 - "Skill: modularity-review"
Cohesion: 0.10
...
### Community 434 - "render_router.py"
Cohesion: 0.13
...
### Community 438 - "Docker AI Governance Audit — Final Report"
Cohesion: 0.10
...
### Community 439 - "1. Capability-by-capability"
Cohesion: 0.10
...
### Community 441 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 442 - "ControlsScreen.jsx"
Cohesion: 0.15
...
### Community 449 - "ApprovalCheckpoint"
Cohesion: 0.14
...
### Community 454 - "test_llm_router_tpm.py"
Cohesion: 0.15
...
### Community 455 - "test_tasks_cache_ttl_env.py"
Cohesion: 0.21
...
### Community 456 - "test_voice_pipeline.py"
Cohesion: 0.14
...
### Community 457 - "test_workflow_models.py"
Cohesion: 0.13
...
### Community 460 - "_extract_tech_relevance"
Cohesion: 0.17
...
### Community 464 - "Skill: fabric-patterns"
Cohesion: 0.11
...
### Community 465 - "Analysis & Synthesis Instructions"
Cohesion: 0.11
Nodes (18): 1. Define the Atmosphere, 2. Map the Color Palette, 3. Establish Typography Rules, 4. Define the Hero Section, 5. Describe Component Stylings, 6. Define Layout Principles, 7. Define Responsive Rules, 8. Encode Motion Philosophy (+10 more)

### Community 466 - "Production Readiness Assessment — local-llm-server"
Cohesion: 0.11
...
### Community 467 - "test_dashboard_cache.py"
Cohesion: 0.18
...
### Community 471 - "Admin Dashboard Guide"
Cohesion: 0.11
...
### Community 472 - "Implementation Plan"
Cohesion: 0.11
...
### Community 476 - "test_p0_roadmap_a4_a5_b2.py"
Cohesion: 0.15
...
### Community 478 - "test_task_source_id_race.py"
Cohesion: 0.17
...
### Community 480 - "TestSelfHealingInfrastructureClassification"
Cohesion: 0.19
...
### Community 481 - "test_fabric_patterns.py"
Cohesion: 0.11
...
### Community 482 - "test_repowise_intelligence.py"
Cohesion: 0.11
...
### Community 483 - "test_schedule_persistence.py"
Cohesion: 0.15
...
### Community 486 - "get_tool_registry"
Cohesion: 0.14
...
### Community 487 - "ErrorInterceptorMiddleware"
Cohesion: 0.18
...
### Community 490 - "Comprehensive Skill Index (By Category)"
Cohesion: 0.11
...
### Community 491 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 492 - "Component Map"
Cohesion: 0.11
...
### Community 493 - "Agent State — colibri GLM-5.2 deployment (resumable)"
Cohesion: 0.11
...
### Community 494 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
...
### Community 495 - "Platform Guide — the full tour"
Cohesion: 0.11
...
### Community 497 - "Part A — Health Report"
Cohesion: 0.11
...
### Community 501 - "sync_readme_gallery.py"
Cohesion: 0.22
...
### Community 502 - "brain_liveness.py"
Cohesion: 0.16
...
### Community 509 - "test_telegram_service_webhook.py"
Cohesion: 0.18
...
### Community 510 - "handle_workflow_ide_chat"
Cohesion: 0.18
...
### Community 513 - "cowork_session.py"
Cohesion: 0.15
...
### Community 514 - "SKILL: Industrial Brutalism & Tactical Telemetry UI"
Cohesion: 0.12
...
### Community 515 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 516 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 517 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 518 - "Section-by-Section Acceptance Criteria"
Cohesion: 0.12
...
### Community 522 - "provider_max_rpm"
Cohesion: 0.17
...
### Community 523 - "redact_connection_url"
Cohesion: 0.17
...
### Community 524 - "agent_readiness_audit.py"
Cohesion: 0.21
...
### Community 527 - "test_daily_automation_2026_07_11.py"
Cohesion: 0.15
...
### Community 528 - "test_health_endpoints.py"
Cohesion: 0.17
...
### Community 529 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 530 - "test_openclaw_endpoints.py"
Cohesion: 0.12
...
### Community 532 - "test_skill_registry.py"
Cohesion: 0.13
...
### Community 533 - "hermes_prompt.py"
Cohesion: 0.19
...
### Community 535 - "MemoryMiddleware"
Cohesion: 0.17
...
### Community 539 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
...
### Community 540 - "_valid_login_state"
Cohesion: 0.24
...
### Community 541 - "Skill: repowise-intelligence"
Cohesion: 0.12
Nodes (15): 1. Graph Intelligence (Dependency Graph), 2. Git Intelligence, 3. Documentation Intelligence, 4. Decision Intelligence, Acceptance Checks, Directory Structure, Example Usage, Implementation Approach (+7 more)

### Community 542 - "The 10-Step Workflow"
Cohesion: 0.12
...
### Community 543 - "Contributing to local-llm-server"
Cohesion: 0.12
...
### Community 544 - "refresh_agent_built_proof.py"
Cohesion: 0.20
...
### Community 545 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 546 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 547 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
...
### Community 548 - "RateLimitTracker"
Cohesion: 0.16
...
### Community 556 - "test_autonomy_status.py"
Cohesion: 0.12
...
### Community 557 - "DailyDigestAggregatorTests"
Cohesion: 0.19
...
### Community 558 - "test_dockerfile_ships_root_modules.py"
Cohesion: 0.17
...
### Community 559 - "test_frontend_deployment_guards.py"
Cohesion: 0.20
...
### Community 560 - "test_glm52_brain.py"
Cohesion: 0.12
...
### Community 561 - "test_langfuse_agency_wide.py"
Cohesion: 0.12
...
### Community 562 - "test_local_brain_state.py"
Cohesion: 0.12
...
### Community 565 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 566 - "test_refresh_agent_built_proof.py"
Cohesion: 0.12
...
### Community 567 - "test_telegram_diag_endpoint.py"
Cohesion: 0.12
...
### Community 569 - "AgentJobSnapshot"
Cohesion: 0.23
...
### Community 572 - "CollaborationContext"
Cohesion: 0.17
...
### Community 573 - "Skill: agent-harness"
Cohesion: 0.13
...
### Community 574 - "Skill: checkpoint-strategy"
Cohesion: 0.13
...
### Community 576 - "Skill: local-ai-query"
Cohesion: 0.13
...
### Community 577 - "Skill: parallel-agents"
Cohesion: 0.13
...
### Community 578 - "Skill: parallel-worktrees"
Cohesion: 0.13
...
### Community 579 - "Design System: Taste Standard"
Cohesion: 0.13
...
### Community 581 - "Skill: user-research"
Cohesion: 0.13
...
### Community 582 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 583 - "Attention Mechanisms Internals"
Cohesion: 0.13
...
### Community 586 - "test_traffic_director.py"
Cohesion: 0.16
...
### Community 587 - "_push_down_where"
Cohesion: 0.14
...
### Community 589 - "router/health.py"
Cohesion: 0.20
...
### Community 590 - "DockerAgentAdapter"
Cohesion: 0.17
...
### Community 591 - "probe_model_liveness"
Cohesion: 0.22
...
### Community 592 - "AdminDigestRouterAuthTests"
Cohesion: 0.22
...
### Community 594 - "clear_wizard_state_cache"
Cohesion: 0.21
...
### Community 597 - "DecisionsStoreTests"
Cohesion: 0.13
...
### Community 601 - "test_task_self_repo_auto_commit.py"
Cohesion: 0.17
...
### Community 613 - "admin_digest_router.py"
Cohesion: 0.22
...
### Community 614 - "_autonomy_bg_cycle"
Cohesion: 0.16
Nodes (13): _autonomy_bg_cycle(), autonomy_status(), Background CEO cycle + task dispatch. Runs fire-and-forget., Public autonomy readiness probe — no authentication required. A live deploy…, _brain_is_configured(), Best-effort, fail-open check that *some* usable LLM brain is configured.…, asyncio, tests/test_server_autonomy_and_index_fixes.py — two production regressions. 1.… (+5 more)

### Community 615 - "Skill: branch-cleanup"
Cohesion: 0.14
...
### Community 616 - "Skill: perplexity — Web Research via Perplexity API"
Cohesion: 0.14
...
### Community 619 - "Quick-Note Issues Processing Summary"
Cohesion: 0.14
...
### Community 620 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 622 - "Render MCP — autonomous platform debugging and environment monitoring"
Cohesion: 0.14
...
### Community 623 - "Runbook: Auto-Resume After Cooldown / Interruption"
Cohesion: 0.14
...
### Community 631 - "test_critical_flows.py"
Cohesion: 0.29
...
### Community 632 - "TestAnthropicToolListCaching"
Cohesion: 0.34
...
### Community 633 - "TestMCPToolsListCache"
Cohesion: 0.19
...
### Community 635 - "test_openclaw_gateway.py"
Cohesion: 0.14
...
### Community 637 - "test_tasks_awaiting_approval_api.py"
Cohesion: 0.37
...
### Community 640 - "filter_safe_tools"
Cohesion: 0.23
...
### Community 676 - "TestDecisionsBotLinks"
Cohesion: 0.21
...
### Community 677 - "test_deploy_trigger_covers_image.py"
Cohesion: 0.21
...
### Community 678 - "test_doctor_service_token_check.py"
Cohesion: 0.23
...
### Community 679 - "TestKillSwitchDurability"
Cohesion: 0.15
...
### Community 680 - "test_task_brain_preflight.py"
Cohesion: 0.31
...
### Community 681 - "TestRouterIntegration"
Cohesion: 0.31
...
### Community 683 - "WorkspaceManifest"
Cohesion: 0.17
...
### Community 684 - "skill_registry.py"
Cohesion: 0.17
...
### Community 686 - "AGENTS.md — Codebase Map & Operations Reference"
Cohesion: 0.17
...
### Community 691 - "Skill: system-prompt-audit"
Cohesion: 0.17
...
### Community 692 - "Skill: task-alive-updates"
Cohesion: 0.17
...
### Community 696 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 699 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 701 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 702 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 703 - "Quantization Internals"
Cohesion: 0.17
...
### Community 704 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 705 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 706 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 708 - "ProviderHealth"
Cohesion: 0.35
Nodes (3): ProviderHealth, Any, Rolling health for one provider.

### Community 709 - "check_container_posture.py"
Cohesion: 0.26
...
### Community 710 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 711 - "test_admin_local_brain_router.py"
Cohesion: 0.29
...
### Community 712 - "test_agile_api.py"
Cohesion: 0.17
...
### Community 713 - "test_app_settings.py"
Cohesion: 0.21
...
### Community 715 - "test_providers_live_e2e.py"
Cohesion: 0.27
...
### Community 716 - "test_task_clarification.py"
Cohesion: 0.17
...
### Community 720 - "_extractive_compress"
Cohesion: 0.18
...
### Community 724 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 727 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 728 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 730 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 733 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 734 - "DirectChatSession"
Cohesion: 0.18
...
### Community 735 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 736 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 737 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 738 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 739 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 740 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 741 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 743 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 744 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 745 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 746 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 747 - "What to clean up"
Cohesion: 0.18
...
### Community 748 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 754 - "response_cache.py"
Cohesion: 0.20
...
### Community 758 - "test_agent_readiness_audit.py"
Cohesion: 0.18
...
### Community 759 - "TestIsDnsFailure"
Cohesion: 0.18
...
### Community 760 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 761 - "test_event_log.py"
Cohesion: 0.45
...
### Community 777 - "Agent Readiness Report"
Cohesion: 0.20
...
### Community 779 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 780 - "LLM Router — configuration guide"
Cohesion: 0.20
...
### Community 781 - "LLM Router — provider guide"
Cohesion: 0.20
...
### Community 782 - "CI Troubleshooting Runbook"
Cohesion: 0.20
...
### Community 786 - "_parse_reset_epoch"
Cohesion: 0.33
...
### Community 787 - "build_tech_db.py"
Cohesion: 0.40
...
### Community 790 - "TestZeroAttemptDiagnostics"
Cohesion: 0.29
...
### Community 791 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 794 - "test_quick_note_engine.py"
Cohesion: 0.22
...
### Community 827 - "_get_current_user"
Cohesion: 0.25
...
### Community 830 - "enrich_quick_note_issues.py"
Cohesion: 0.42
...
### Community 832 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 834 - "test_changelog_parity_guard.py"
Cohesion: 0.22
...
### Community 836 - "TestGithubSignalHardening"
Cohesion: 0.22
...
### Community 837 - "TestPaidPolicyDurability"
Cohesion: 0.22
...
### Community 839 - "test_scanner_deps_parity.py"
Cohesion: 0.31
...
### Community 843 - "agent/output_filter.py"
Cohesion: 0.32
...
### Community 848 - "quality_checker.py"
Cohesion: 0.32
...
### Community 850 - "_parse_tool_calls_from_response"
Cohesion: 0.39
...
### Community 861 - "AGENTS.md — AI Agent Configuration for local-llm-server"
Cohesion: 0.25
...
### Community 862 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 863 - "ceo-micromanagement.md"
Cohesion: 0.25
Nodes (4): P0 behavior change, Readiness contract, Runtime model, Runtime types

### Community 864 - "Feature Maturity / Support Matrix"
Cohesion: 0.25
...
### Community 867 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.25
...
### Community 868 - "Issue #362: Nvidia repo setup"
Cohesion: 0.25
...
### Community 869 - "Issue #364: quick-note:https://www.marktechpost.com/2026/06/01/meet-memory-os-a-6-layer-open-source-memory-stack-built-on-top-of-hermes-agent/"
Cohesion: 0.25
...
### Community 870 - "Issue #378: quick-note:https://www.marktechpost.com/2026/06/02/tinyfish-launches-bigset-an-open-source-multi-agent-system-that-builds-structured-live-datasets-from-plain-english-descriptions/"
Cohesion: 0.25
...
### Community 871 - "Issue #379: quick-note:https://searchengineland.com/schema-markup-optimize-agentic-web-479080"
Cohesion: 0.25
...
### Community 872 - "Issue #380: quick-note:https://cursor.com/blog/cloud-agent-lessons"
Cohesion: 0.25
...
### Community 873 - "Issue #381: quick-note:https://www.xda-developers.com/claude-code-with-opus-48-is-expensive-but-i-made-it-efficient-with-my-local-ai-workflow/"
Cohesion: 0.25
...
### Community 874 - "Issue #382: quick-note:https://claude.com/blog/how-coderabbit-used-claude-to-build-an-agent-orchestration-system"
Cohesion: 0.25
...
### Community 875 - "Issue #383: quick-note:https://www.marktechpost.com/2026/05/29/hexo-labs-open-sources-sia-a-self-improving-agent-that-updates-both-the-harness-and-the-model-weights/"
Cohesion: 0.25
...
### Community 876 - "Issue #416: feat: Self-hosted Codebuff (freebuff) on free NVIDIA models + Telegram bot phone control"
Cohesion: 0.25
...
### Community 877 - "Issue #485: [Trend Digest] Week of 2026-06-08"
Cohesion: 0.25
...
### Community 878 - "Issue #488: quick-note:https://github.com/cookiy-ai/user-research-skill"
Cohesion: 0.25
...
### Community 879 - "Issue #491: Implement whatever is necessary from https://github.com/BehiSecc/awesome-claude-skills"
Cohesion: 0.25
...
### Community 880 - "Issue #493: Use the https://github.com/mvanhorn/last30days-skill skill to get the trend updated"
Cohesion: 0.25
...
### Community 881 - "Issue #495: Read https://www.anthropic.com/news/claude-fable-5-mythos-5 and understand if mythos or fable can be added to the repo"
Cohesion: 0.25
...
### Community 882 - "Issue #504: EPIC: Autonomy hardening — live-verified defects 2026-06-10"
Cohesion: 0.25
...
### Community 883 - "Issue #581: Sprint tracker: pending work after brand rename + mobile-first pass"
Cohesion: 0.25
...
### Community 885 - "Issue #657: quick-note:https://github.com/earendil-works/pi"
Cohesion: 0.25
...
### Community 886 - "Issue #659: quick-note:https://github.com/nex-agi/Nex-N2"
Cohesion: 0.25
...
### Community 887 - "Issue #660: quick-note:https://github.com/getsentry/sentry-for-ai"
Cohesion: 0.25
...
### Community 888 - "Issue #661: quick-note:https://github.com/XiaomiMiMo/MiMo-Code"
Cohesion: 0.25
...
### Community 889 - "Issue #664: quick-note:https://github.com/Grominet95/jarvis-OS"
Cohesion: 0.25
...
### Community 890 - "Issue #666: quick-note:https://github.com/porokka/jarvis-os"
Cohesion: 0.25
...
### Community 891 - "Issue #670: quick-note:https://github.com/perplexityai/bumblebee"
Cohesion: 0.25
...
### Community 892 - "Issue #672: quick-note:https://github.com/Chachamaru127/claude-code-harness"
Cohesion: 0.25
...
### Community 893 - "Issue #676: quick-note:https://github.com/WeiboAI/VibeThinker"
Cohesion: 0.25
...
### Community 894 - "Issue #820: quick-note:https://github.com/cobusgreyling/loop-engineering"
Cohesion: 0.25
...
### Community 895 - "Positional Encoding Internals"
Cohesion: 0.25
...
### Community 897 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 898 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 899 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 900 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 901 - "Continual Harness (`agent/harness_spec.py`)"
Cohesion: 0.25
...
### Community 902 - "Prime Agent Runtime"
Cohesion: 0.25
...
### Community 903 - "PULL_REQUEST_TEMPLATE.md"
Cohesion: 0.25
...
### Community 908 - "run_patched_colibri.py"
Cohesion: 0.36
...
### Community 910 - "test_compose_and_coordinate_api.py"
Cohesion: 0.36
...
### Community 911 - "test_generate_context_standing_instructions.py"
Cohesion: 0.32
...
### Community 912 - "test_local_brain_router_smoke.py"
Cohesion: 0.25
...
### Community 916 - "test_provider_models_db_outage.py"
Cohesion: 0.25
...
### Community 918 - "test_runtimes_health_endpoint.py"
Cohesion: 0.25
...
### Community 919 - "test_seo_audit_pending_expiry.py"
Cohesion: 0.43
...
### Community 921 - "test_serve_spa_prefixes.py"
Cohesion: 0.36
...
### Community 923 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 932 - "AI Engineering Insights Skill"
Cohesion: 0.29
...
### Community 944 - "Implementation plan + TO-DO (check off as you go)"
Cohesion: 0.29
...
### Community 949 - "Workspace Issues"
Cohesion: 0.29
...
### Community 950 - "Model and Response Issues"
Cohesion: 0.29
...
### Community 962 - "test_daily_2026_06_14.py"
Cohesion: 0.38
...
### Community 963 - "TestSupportMatrixDocsSync"
Cohesion: 0.29
...
### Community 964 - "test_doctor_coding_brain.py"
Cohesion: 0.38
...
### Community 965 - "TestGithubTokenSQLiteRegression"
Cohesion: 0.38
...
### Community 966 - "TestReasonsAreActionable"
Cohesion: 0.29
...
### Community 967 - "TestProvidersScreen"
Cohesion: 0.43
...
### Community 984 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 985 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 986 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 987 - "The full agent capability roster"
Cohesion: 0.33
...
### Community 988 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 989 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 990 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 995 - "is_rate_limit_exempt"
Cohesion: 0.33
...
### Community 1006 - "TestDirectChatAgentExecution"
Cohesion: 0.33
...
### Community 1007 - "TestWorkflowIntegration"
Cohesion: 0.33
...
### Community 1024 - "Who is this for?"
Cohesion: 0.40
...
### Community 1025 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 1026 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 1029 - "Agent API Issues"
Cohesion: 0.40
...
### Community 1030 - "Network and Tunnel Issues"
Cohesion: 0.40
...
### Community 1031 - "knowledgeGraphTab.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 1032 - "loginFlowNoTimeout.test.js"
Cohesion: 0.40
Nodes (4): apiSource, { describe, test, expect }, fs, path

### Community 1033 - "test_company_stale_id_recovery.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 1034 - "worker_no_cache.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, workerSource

### Community 1035 - "scripts/agile_ceremonies.py"
Cohesion: 0.60
...
### Community 1041 - "_add_colibri_shim_changelog_entry.py"
Cohesion: 0.50
...
### Community 1042 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1043 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1044 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 1045 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 1053 - "test_agent_runtime_wrapper.py"
Cohesion: 0.70
...
### Community 1054 - "TestTelegramNotifications"
Cohesion: 0.40
...
### Community 1055 - "TestModelRoleSeparation"
Cohesion: 0.40
...
### Community 1072 - "Claude Code Specific Issues"
Cohesion: 0.50
...
### Community 1075 - "render"
Cohesion: 0.50
Nodes (3): RENDER_API_KEY, docker, render

### Community 1076 - "scripts"
Cohesion: 0.50
Nodes (4): scripts, build, start, test

### Community 1077 - "stop_colibri_server.ps1"
Cohesion: 0.83
Nodes (3): Fail(), Ok(), W()

### Community 1078 - "_probe_openai_compat"
Cohesion: 0.50
...
### Community 1080 - "get_mobile_html"
Cohesion: 0.50
...
### Community 1093 - "test_skills_route_order.py"
Cohesion: 0.67
...
### Community 1094 - "github"
Cohesion: 0.50
Nodes (3): github, enabled, silent

### Community 1099 - "Configuration reference"
Cohesion: 0.67
...
- **Why does `_fixture()` connect `_fixture` to `company_api.py`, `llm/router.py`, `test_llm_router_queue_cache.py`, `resolve_active_brain`, `brain_config.py`, `test_operational_incidents.py`, `test_unit8_model_catalog.py`, `_clean_singletons`, `TaskWorkflowService`, `test_llm_router_strategies.py`, `test_openclaw_endpoints.py`, `test_model_router.py`, `TaskStore`, `ImprovementLoop`, `AgentSwarm`, `SelfHealingAgent`, `PolicyEngine`, `SQLiteStore`, `WorkflowRun`, `test_llm_router_resilience.py`, `test_failover_client_shared.py`, `E2BSandboxSession`, `SQLiteStore`, `Agency`, `ProviderConfig`, `test_agent_tool_governance.py`, `test_autonomy_status.py`, `workflow/api.py`, `test_sam_livekit.py`, `Task`, `AgentPlan`, `test_local_brain_state.py`, `services/background.py`, `test_phase5_doctor.py`, `PrimeAgentAdapter`, `test_refresh_agent_built_proof.py`, `test_telegram_diag_endpoint.py`, `AgentJobManager`, `ChatHistoryStore`, `test_autonomous_agency_e2e.py`, `sam`, `_resolve_brain_provider`, `TokenBudget`, `brain_failover.py`, `ResearchTask`, `AuditLog`, `test_traffic_director.py`, `TestClient`, `test_procedural_memory.py`, `test_telegram_auto_approve.py`, `e2e/test_browser.py`, `test_colibri_brain_shim.py`, `ArtifactStore`, `UserRole`, `KeyStore`, `KeyPool`, `ProviderRouter`, `get_self_healing_agent`, `test_knowledge_sync.py`, `FreeBuffAgent`, `run_task`, `config.py`, `ModelRouter`, `resolve_e2b_config`, `test_context_rulebook.py`, `test_openclaw_gateway.py`, `test_startup_warmup.py`, `test_telegram_freebuff.py`, `test_kimi_bridge_server.py`, `test_issue_intake.py`, `SeoAuditEngine`, `_StubProvider`, `test_e2b_adapter.py`, `NotificationDispatcher`, `test_new_features_e2e.py`, `CEOLedger`, `claim`, `MCPClient`, `persist_plan_spec`, `FeatureMaturity`, `TestEstimateTokensForMessages`, `_Budget`, `TestAgentRunnerSafety`, `test_doctor_service_token_check.py`, `test_e2b_task_wiring.py`, `test_task_brain_preflight.py`, `OllamaCircuitBreaker`, `test_ceo_router.py`, `_resolve_user_github_token`, `clear_cooldowns`, `test_seo_audit.py`, `test_features_api.py`, `test_video_transcript.py`, `TrendWatcher`, `test_e2b_data_flow.py`, `test_agile_api.py`, `test_app_settings.py`, `test_task_clarification.py`, `SchedulerStore`, `test_portfolio_intake.py`, `test_trend_watcher.py`, `loop.py`, `models/seo_audit.py`, `test_mcp_governance.py`, `TestClient`, `ContextPruner`, `rate_limiter.py`, `test_persistent_memory.py`, `SecurityScanner`, `analyze_page`, `WorkflowBuildRequest`, `test_control_plane_api.py`, `test_llm_router_e2e.py`, `test_daily_2026_07_27.py`, `OutputFilter`, `TestHarnessAdapter`, `test_platform_controls.py`, `test_sam_voice.py`, `OrchestratorQueue`, `TestMongoGate`, `TestNormalizeResponseFormat`, `test_purge_backlog.py`, `test_llm_router_disabled.py`, `parse_event_stream`, `test_crispy_burn_in.py`, `test_provider_enable_disable.py`, `test_skill_registry_boot_refresh.py`, `TestSwarmRoleRouting`, `test_session_retro.py`, `isolated_telegram_config`, `test_scheduler_hydration_bounded.py`, `platform_controls_router.py`, `test_claude_code_adapter.py`, `test_service_token.py`, `test_harness_spec.py`, `test_regression.py`, `test_agency_fix.py`, `test_webui_provider_priority.py`, `api_keys_for`, `test_monitor_lib.py`, `test_v4_api.py`, `test_ping.py`, `test_runtimes_health_endpoint.py`, `get_ceo_dispatcher`, `UsageEvent`, `allow_paid`, `_FakeSandbox`, `client`, `test_doctor_coding_brain.py`, `test_llm_router_tpm.py`, `test_voice_pipeline.py`, `test_dashboard_cache.py`, `cost_tracker.py`, `test_brain_patch_service_token.py`, `test_company_api.py`, `test_telegram_service_webhook.py`?**
  _High betweenness centrality (0.107) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `UserMemoryStore`, `backend/server.py`, `test_governance_api.py`, `proxy.py`, `ContextManager`, `resolve_active_brain`, `ReactScratchpad`, `TaskSpec`, `test_e2b_adapter.py`, `LocalWorkspace`, `test_daily_automation_2026_07_11.py`, `TestAgentLoopMCPIntegration`, `ExecutionRequest`, `MCPClient`, `get_ceo_dispatcher`, `StuckDetector`, `test_backend_server_features.py`, `WorkflowRun`, `TestAgentRunnerSafety`, `test_failover_client_shared.py`, `E2BSandboxSession`, `MultiAgentSwarm`, `test_agent_tool_governance.py`, `WorkspaceTools`, `AgentPlan`, `AgentJobManager`, `direct_chat.py`, `test_autonomous_agency_e2e.py`, `TokenBudget`, `loop.py`, `AgentSessionStore`, `InternalAgentAdapter`, `AdaptiveHalter`, `ContextPruner`, `GitHubTools`, `FreeBuffAgent`, `CEODispatcher`, `test_empirical_verify.py`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `get_skill_bindings()` connect `Specialist` to `company_api.py`, `SkillBindings`, `AgentRunner`, `HarnessEnrichment`, `skill_bindings.py`, `loop.py`, `ExecutionRequest`, `FeatureMaturity`, `SpecEntry`, `WorkflowRun`?**
...
- **Should `backend/server.py` be split into smaller, more focused modules?**
  _Cohesion score 0.013727013727013727 - nodes in this community are weakly interconnected._