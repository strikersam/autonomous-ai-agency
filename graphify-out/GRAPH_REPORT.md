...
## Corpus Check
- 1301 files · ~1,801,695 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 24584 nodes · 49782 edges · 1119 communities (1000 shown, 119 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 6001 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ce6eef88`
...
- _is_dns_failure
- TestOrchestratorCheckpointStore
...
6. `ProviderConfig` - 136 edges
7. `ProviderRouter` - 135 edges
...
## Communities (1119 total, 119 thin omitted)

### Community 0 - "backend/server.py"
Cohesion: 0.01
Nodes (389): agent/sam.py — SAM Voice Agent (System Autonomy Manager)  SAM is the voice-contr, get_harness_adapter(), admin_seed(), _agent_provider_failure_response(), _agent_timeout_fallback_response(), _append_agent_session_message(), auth_me(), auto_recommend_skills() (+381 more)

### Community 1 - "ExecutionRequest"
Cohesion: 0.02
Nodes (124): _decompose_into_subtasks(), _merge_changed_files(), Decompose a request into 2-3 sub-tasks for specialist fan-out.      Default deco, Collect changed_files across all specialists into a single de-duped list., get_ceo_fallback_stats(), PlanOutput, Any, Exception (+116 more)
...
### Community 3 - "AgentRunner"
Cohesion: 0.02
Nodes (128): AgentPhaseError, AgentRunner, _nvidia_api_key(), Any, Exception, Path, Append an event to the durable session log if a store is wired in., Summarise a long history and compact it.          Asks the planner model to writ (+120 more)

### Community 4 - "FreeBuffAgent"
Cohesion: 0.08
Nodes (109): BackgroundTask, BrowserSession, Async Playwright browser session.      Usage::          session = BrowserSes, True if Playwright is installed and ready to use., CommitAttribution, CommitTracker, Path, agent/commit_tracker.py — AI Commit Attribution  Tags git commits with metadat (+101 more)

### Community 5 - "proxy.py"
Cohesion: 0.03
Nodes (156): Any, Return recent commits with agent attribution trailers parsed out., get_sam(), middleware, admin_control(), admin_create_key(), admin_create_user(), admin_delete_user() (+148 more)

### Community 6 - "WorkspaceTools"
Cohesion: 0.05
Nodes (39): repowise.py — RepowiseIntelligence: context packing and dependency analysis., Path, tools.py — WorkspaceTools: read/write/search and diff application (risky module), Return a previously saved memory value, or an empty string if absent., Persist a key/value pair to the user's profile store., Return the first *lines* lines of a file.          Just-in-time retrieval: the e, Return a lightweight index of files with line counts and sizes.          This is, Delegate to RepowiseIntelligence for a natural-language codebase question. (+31 more)

### Community 7 - "RuntimeHealth"
Cohesion: 0.03
Nodes (114): kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider).      Ret, TaskResult, TaskSpec, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized).  Aider (https, Run aider non-interactively via `--message` flag., runtimes/adapters/claude_code.py — Claude Code CLI adapter (FIRST CLASS).  Claud, DockerAgentAdapter (+106 more)

### Community 8 - "ai/router.py"
Cohesion: 0.02
Nodes (169): get_tracker(), Return the process-singleton RateLimitTracker., _acquire_provider_probe(), clear_cooldowns(), _dead_model_key(), _exponential_backoff_cooldown(), extract_openai_text(), get_dead_models() (+161 more)

### Community 9 - "WebsiteScanner"
Cohesion: 0.03
Nodes (79): main(), Returns (url, ok, summary)., _scan_one(), _is_blocked_host(), _is_safe_url(), _looks_like_bot_challenge(), Any, BeautifulSoup (+71 more)

### Community 10 - "company_api.py"
Cohesion: 0.03
Nodes (198): AccountLifecycleResponse, _DoctorCheck, _DoctorReport, get_public_doctor_report(), OnboardingAnswersRequest, OnboardingProgressResponse, OnboardingQuestionsRequest, BaseModel (+190 more)

### Community 11 - "CompanyGraphStore"
Cohesion: 0.03
Nodes (38): Delete a company and all its associated data., Delete a company and all associated data from SQLite., Count total companies in SQLite., Count total companies in the store., Create a new website in SQLite. The full model is stored in ``data``         so, Delete a website from SQLite., Persist a detected system in SQLite (full model stored as a JSON blob)., List detected systems for a company from SQLite. (+30 more)

### Community 12 - "FeatureUnavailableError"
Cohesion: 0.03
Nodes (90): PreflightReport, AgentJob, make_isolated_workspace(), Path, Create an isolated workspace directory under *root*.      This is the legacy p, _get_workspace_lock(), get_workspace_manager(), _hash_component() (+82 more)

### Community 13 - "get_company_graph_store"
Cohesion: 0.02
Nodes (131): ephemeral_ttl_hours(), Async read of the ephemeral TTL (hours) straight from the DB., Reject non-admin callers for routes that spend provider budget.      Delegates t, _require_admin(), account_lifecycle(), auto_recommend_skills(), cancel_onboarding(), create_company() (+123 more)

### Community 14 - "test_unit8_model_catalog.py"
Cohesion: 0.03
...
### Community 15 - "brain_config.py"
Cohesion: 0.04
Nodes (71): BrainConfig, BrainConfigStore, default_brain_config(), get_brain_config_store(), provider_api_key(), provider_base_url(), BaseModel, services/brain_config_store.py — DB-persisted, UI-switchable "brain" config.  Im (+63 more)
...
### Community 17 - "test_model_router.py"
Cohesion: 0.04
...
Cohesion: 0.04
Nodes (106): _complexity_rank(), services/ceo_dispatcher.py — Real CEO delegation layer.  The CEO splits a comple, Split the request into briefed, tier-assigned specialist sub-tasks.          Ret, _should_fan_out(), build_subtask_brief(), _coerce_subtasks(), decompose(), _env_flag() (+98 more)

### Community 19 - "brain_failover.py"
Cohesion: 0.05
Nodes (47): BrainFailoverManager, ProviderInfo, Map a requested model to the provider's equivalent.          If the requested mo, Maximum number of provider attempts before giving up., Return a full health snapshot for observability., A configured LLM provider with its connection details + health state., True when the provider can accept traffic right now., Manages multi-provider brain failover with circuit breakers.      Thread-safe. S (+39 more)
...
### Community 21 - "direct_chat.py"
Cohesion: 0.08
Nodes (58): Any, Translate technical preflight issues into a conversational assistant reply., translate_error_to_conversational(), ResumeRequest, AcceptedJob, AgentJobEnvelope, CompletedJob, DirectChatState (+50 more)

### Community 22 - "skill_bindings.py"
Cohesion: 0.06
Nodes (43): Status of a user story within a sprint., StoryStatus, MemoryKind, What kind of memory artifact this is., Enum, SuperClaude Workflow Engine — Workflow, Task, and topological DAG execution.  Is, Return tasks whose dependencies are all satisfied., Number of tasks in the workflow. (+35 more)

### Community 23 - "SeoAuditRequest"
Cohesion: 0.02
Nodes (168): get_company_access(), Extract a consistent user_id from the user dict.      Works across all auth meth, Submit onboarding answers and create intelligent remediation tasks.      Analyze, Verify user has access to a company and return the company.      - Admin users b, _resolve_user_id(), submit_onboarding_answers(), delegate_seo_findings(), _expire_stale_pending_report() (+160 more)

### Community 24 - "webui/router.py"
Cohesion: 0.06
Nodes (63): _bootstrap(), fixture, Path, ProviderManager, WorkspaceManager, tests/test_webui_provider_priority.py — Priority + reorder + brain-policy surfac, The /policy/brain endpoint must return the resolved brain + the paid     policy, The /providers/role-tags endpoint surfaces brain/sub/fallback roles     consiste (+55 more)

### Community 25 - "Specialist"
Cohesion: 0.03
Nodes (59): build_matrix(), _families(), main(), Any, Map family -> sorted list of test files that mention it (quoted token)., Return one row per family, derived entirely from code., render_markdown(), _test_evidence_index() (+51 more)

### Community 26 - "CEODispatcher"
Cohesion: 0.06
Nodes (48): Semaphore, CEODispatcher, CEOResult, _offload(), Any, Run a synchronous ledger call without blocking the event loop.      ``CEOLedger`, Build an agent.coordinator.TaskSpec from a CEO SpecialistTask., Aggregated output from a multi-specialist execution. (+40 more)

### Community 27 - "tasks/service.py"
Cohesion: 0.05
Nodes (49): agents/store.py — Persistent store for user-defined agent configurations.  Store, Set the global agent store instance (e.g., with MongoDB on startup)., set_agent_store(), Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., str, TaskStatus, _get_workflow_engine() (+41 more)

### Community 28 - "TaskSpec"
Cohesion: 0.14
...
### Community 29 - "PortfolioIntelligence"
Cohesion: 0.09
...
### Community 30 - "test_ceo_supervision.py"
Cohesion: 0.06
Nodes (69): _harvest_changed_files(), Extract the files a runtime touched. Returns ``(files, reported)``.      Adapter, Attempt, One delegation of one subtask to one tier., A subtask's full history: what it is, and every attempt at it., SubtaskRecord, _goal(), asyncio (+61 more)
...
### Community 32 - "resolve_active_brain"
Cohesion: 0.03
Nodes (104): Call-time resolver for an agent role model id.      Delegates to ``services.brai, _resolve_role_model(), BrainResolution, get_brain_config(), invalidate_brain_config_cache(), Clear the singleton's cache (used by tests + brain_policy invalidation)., Convenience wrapper used by the agent loop + brain resolver., Convenience wrapper used by the admin API endpoints. (+96 more)
...
Cohesion: 0.05
Nodes (35): agents/__init__.py — CRISPY multi-agent coding system., AgentProfile, _catalog_defaults(), _catalog_provider(), _get_defaults(), load_all_profiles(), make_architect_profile(), make_coder_profile() (+27 more)

### Community 35 - "SecretRecord"
Cohesion: 0.06
Nodes (60): str, UserRole, _can_read(), _can_write(), create_secret(), _decrypt(), delete_secret(), _encrypt() (+52 more)

### Community 36 - "SelfHealingAgent"
Cohesion: 0.04
Nodes (74): heal_signature(), HealingEvent, HealState, _now(), Any, Enum, str, agent/self_healing.py — Self-Healing Agent (closed-loop, Autonomy Charter G2)  T (+66 more)

### Community 37 - "E2BSandboxSession"
Cohesion: 0.05
...
### Community 38 - "TaskStore"
Cohesion: 0.05
Nodes (53): Any, Task, TaskStatus, Create a task. Deduplicates by source_id if set (Charter G3).          If a task, Fetch a task by ID.  If owner_id is set, enforces ownership., Return the task previously created for an external ``source_id``         (e.g. `, Normalise a timestamp value to a float Unix epoch.      Handles:       - float /, List tasks for a specific user with optional filters.          ``include_system` (+45 more)

### Community 39 - "TaskWorkflowService"
Cohesion: 0.06
Nodes (36): _is_brain_connection_error(), Any, BaseException, Task, TaskResult, TaskSpec, TaskStatus, Best-effort label of who will run this task once approved.          Returns ``ta (+28 more)

### Community 40 - "BrainWatchdog"
Cohesion: 0.04
Nodes (59): provider_key_present(), True when the env var for *provider*'s key is set (or it's Ollama)., Any, packages/ai/self_heal.py — automatic brain self-healing.  When the active brain, Background tick that runs self_heal_brain_and_unblock_tasks().      Called from, One-shot self-healing pass.      1. Checks if the active brain provider is in a, self_heal_brain_and_unblock_tasks(), _self_heal_tick() (+51 more)

### Community 41 - "test_loop_registry.py"
Cohesion: 0.05
Nodes (64): audit_drift(), _cmd_audit(), DriftReport, _grade(), load_registry(), load_registry_sync(), loop_readiness(), LoopRegistry (+56 more)

### Community 42 - "test_knowledge_sync.py"
Cohesion: 0.08
...
### Community 43 - "GoalRecord"
Cohesion: 0.06
Nodes (51): _backend(), CEOLedger, GoalRecord, _now(), Any, services/ceo_ledger.py — durable record of what the CEO is driving to closure., One piece of work the CEO has taken ownership of.      ``state`` is the supervis, Return ``(done, total)`` subtask counts. (+43 more)

### Community 44 - "RuntimeReadinessReport"
Cohesion: 0.03
Nodes (70): AgentJobManager, _now(), Any, agent/job_manager.py — Async agent job lifecycle manager.  Manages agent jobs, Run a job using the provided runner and update the job's lifecycle, progress, re, Serialize the AgentJob to a JSON-serializable dictionary for external clients., _workspace_component(), get_agent_job_manager() (+62 more)

### Community 45 - "MultiAgentSwarm"
Cohesion: 0.07
...
### Community 46 - "DashboardLayout.js"
Cohesion: 0.04
...
Cohesion: 0.05
Nodes (74): Available iff config resolves AND the SDK is importable.          Never raises —, e2b_status(), _enrich_runtimes(), get_decision_log(), get_policy(), get_runtime(), list_runtimes(), _load_rich_policy() (+66 more)

### Community 48 - "MCPClient"
Cohesion: 0.05
...
### Community 49 - "test_user_research_skill.py"
Cohesion: 0.08
...
### Community 50 - "get_scheduler"
Cohesion: 0.03
Nodes (62): get_public_doctor(), Public Doctor endpoint — no authentication required.      Returns system-level d, get_store(), Return the active store singleton, creating it on first call., agent/scheduler.py — Scheduled Agent Jobs  Cron-based job scheduler.  Each job h, set_scheduler(), create_schedule(), delete_schedule() (+54 more)

### Community 51 - "test_failover_client_shared.py"
Cohesion: 0.08
...
### Community 52 - "CompanyGraphService"
Cohesion: 0.09
Nodes (16): BusinessCategory, Company, SpecialistFamily, SystemType, Get a company by ID.                  Args:             company_id: Company ID, Update a company.                  Args:             company_id: Company ID, List companies with optional filtering.                  Args:             owner, Create an initial company graph for a new company.                  Args: (+8 more)

### Community 53 - "detector.py"
Cohesion: 0.07
...
### Community 55 - "test_ai_insights.py"
Cohesion: 0.13
...
### Community 58 - "test_self_heal_v2.py"
Cohesion: 0.05
Nodes (65): Reset the singleton (for tests)., reset_failover_manager(), Hand the 'connect & verify the repo' work to the agency's own agents.      The t, _seed_connect_task(), _heal_brain_failover(), _heal_stuck_tasks(), _heal_task_duplicates(), _heal_telegram() (+57 more)

### Community 59 - "Task"
Cohesion: 0.04
Nodes (73): Full task/issue document., Update the updated_at timestamp., Task, PUBLIC_URL-anchored dashboard deep link for the task detail.          Returns em, Best-effort Telegram heads-up that a task is parked awaiting approval., _mock_gh(), parametrize, tests/test_task_self_repo_auto_commit.py — TaskExecutionCoordinator._build_spec (+65 more)

### Community 60 - "TokenBudget"
Cohesion: 0.05
...
### Community 62 - "test_model_catalog.py"
Cohesion: 0.05
...
### Community 63 - "_resolve_brain_provider"
Cohesion: 0.10
...
### Community 66 - "test_repo_connection.py"
Cohesion: 0.07
...
Cohesion: 0.05
Nodes (60): colibri_enabled(), colibri_provider_config(), colibri_status(), providers/colibri.py — Free local GLM-5.2 brain served by JustVugg/colibri.  Mir, Return True iff the operator opted in via ``COLIBRI_ENABLED=true``., Cheap status snapshot for tests + admin UI., Return the ``ProviderConfig`` for the local colibri server, or ``None`` when dis, _safe_priority() (+52 more)

### Community 77 - "workflow/models.py"
Cohesion: 0.07
Nodes (23): _fake_artifact(), _make_engine(), fixture, tests/test_crispy_workflow.py — CRISPY workflow engine hardening tests.  Tests f, Provide isolated DB + artifact + workspace paths., Create a WorkflowEngine with isolated storage., TestAbortOnFailure, TestPhaseSequence (+15 more)

### Community 78 - "AgileSprint"
Cohesion: 0.05
Nodes (25): A daily standup digest derived from the task tracker.      ``sprint_health`` is, StandupReport, AgileSprint, An agile sprint containing user stories., Add a user story to the sprint., Remove a user story from the sprint., Total story points in the sprint., Completed story points. (+17 more)

### Community 79 - "KnowledgeGraph"
Cohesion: 0.07
...
### Community 81 - "CLAUDE.md — Master Architect Operating Manual"
Cohesion: 0.17
...
Cohesion: 0.08
Nodes (24): Request to remediate auto-fixable findings in a local code repository., One concrete remediation performed (or proposed) by the fixer., SeoFixAction, SeoFixRequest, _humanize_filename(), BeautifulSoup, Path, services/seo_fixer.py - Repo-Aware SEO Auto-Fixer  When a company has a code rep (+16 more)
...
### Community 86 - "Platform Guide — the full tour"
Cohesion: 0.04
...
### Community 87 - "test_bedrock_provider.py"
Cohesion: 0.05
...
### Community 93 - "get_self_healing_agent"
Cohesion: 0.04
...
### Community 94 - "probe_model_liveness"
Cohesion: 0.05
...
### Community 95 - "telegram_bot.py"
Cohesion: 0.09
Nodes (48): all_provider_ids(), _provider_ids_from_literal(), Return every provider id recognised by the brain config system.      Iterates th, Return the provider ids allowed by the ``BrainProvider`` Literal.      Reads the, Return a Markdown-v1-safe preview string under ``max_chars``.      Used by the p, sanitize_paste_for_preview(), _admin_headers(), _api_headers() (+40 more)

### Community 96 - "ImprovementLoop"
Cohesion: 0.05
Nodes (61): _parse_ceo_directives(), DetectedIssue, ImprovementLoop, ImprovementLoopState, _now(), Any, Path, Background scanner and task dispatcher for continuous codebase improvement. (+53 more)

### Community 97 - "Command"
Cohesion: 0.06
...
### Community 98 - "PortfolioManager"
Cohesion: 0.05
Nodes (24): PortfolioManager, PortfolioMetrics, Aggregate metrics across the whole portfolio., Manages a portfolio of initiatives with WSJF prioritisation and roadmapping., Remove an initiative from the portfolio., Number of initiatives in the portfolio., Return initiatives sorted by WSJF (highest first).          Cancelled initiative, Lay the prioritised backlog onto a Now/Next/Later roadmap.          Each horizon (+16 more)

### Community 99 - "seo_api.py"
Cohesion: 0.07
Nodes (44): stmt, _good_result(), _guard_statements(), _load(), fixture, parametrize, Path, Tests for the quick-note context quality gate.  Covers three things:  1. **The r (+36 more)
...
### Community 102 - "TestHarnessAdapter"
Cohesion: 0.09
...
### Community 112 - "ChatHistoryStore"
Cohesion: 0.07
...
### Community 115 - "test_telegram_freebuff.py"
Cohesion: 0.07
...
### Community 119 - "FeatureMatrix"
Cohesion: 0.02
Nodes (60): check_feature(), get_feature(), list_features(), Any, get, post, Return the full support matrix with summary., Return a single feature entry. (+52 more)

### Community 120 - "failover_client.py"
Cohesion: 0.08
Nodes (25): _Budget, _build_request(), _disable_unless_key_serves_other_models(), FailoverResult, _is_billing_refusal(), _is_ollama(), _log_recovery(), _parse_success() (+17 more)

### Community 121 - "ModelRouter"
Cohesion: 0.05
Nodes (42): Dynamic model router package.  Public API::      from router import get_router,, _build_builtin_model_map(), _default_model(), _default_reasoning_model(), ModelRouter, _nvidia_key_present(), Any, Dynamic model router.  Central routing logic for all chat and agent requests.  E (+34 more)

### Community 122 - "tests/conftest.py"
Cohesion: 0.10
...
### Community 123 - "persist_plan_spec"
Cohesion: 0.07
...
### Community 124 - "system_instruction"
Cohesion: 0.07
...
### Community 125 - "test_trend_scoping.py"
Cohesion: 0.11
...
### Community 130 - "test_e2b_data_flow.py"
Cohesion: 0.08
...
### Community 131 - "OllamaCircuitBreaker"
Cohesion: 0.08
...
### Community 135 - "emit_chat_observation"
Cohesion: 0.09
Nodes (31): CommercialEquivalent, estimate_commercial_equivalent_usd(), get_prices(), _load_from_env(), _parse_mapping(), Any, Map each local Ollama model name to a commercial API reference price (USD per 1M, compute_request_cost() (+23 more)

### Community 136 - "SetupChecker"
Cohesion: 0.07
...
### Community 137 - "PromptCacheManager"
Cohesion: 0.06
...
### Community 138 - "activation_api.py"
Cohesion: 0.10
...
### Community 139 - "agency.py"
Cohesion: 0.06
Nodes (35): AgencyCycleResult, AgentDirective, _build_ceo_prompt(), _build_quick_note_instruction(), _close_github_issue(), _collect_recent_git_context(), _fetch_github_quick_notes(), get_agency() (+27 more)

### Community 140 - "diagnostics.py"
Cohesion: 0.02
Nodes (103): BackgroundAgent, _now(), Any, agent/background.py — Background Agent  An always-on worker thread that proces, Enqueue *task* for processing. Returns the task (with task_id set)., Convenience: create a task and submit it in one call., Real handler — dispatches through AgentRunner when available.          HARDENE, Always-on worker that drains a task queue on a daemon thread.      GATE: Golde (+95 more)

### Community 141 - "test_quick_note.py"
Cohesion: 0.10
...
### Community 147 - "get_skill_registry_safe"
Cohesion: 0.11
...
### Community 149 - "Initiative"
Cohesion: 0.04
Nodes (49): AgentRole, str, Initiative, Create and register a new initiative, returning it., Add a pre-built Initiative (e.g. from the intelligence layer)., Look up an initiative by ID., A portfolio initiative (epic) prioritised via WSJF.      WSJF (Weighted Shortest, Aggregate cost of delay (CoD) used as the WSJF numerator. (+41 more)

### Community 150 - "Part A — CodeRabbit review fixes for this PR (do first, small)"
Cohesion: 0.05
...
### Community 151 - "Docker Agent Runtimes Setup"
Cohesion: 0.05
...
### Community 152 - "OnboardingScreen.jsx"
Cohesion: 0.06
...
### Community 155 - "OrchestratorQueue"
Cohesion: 0.03
Nodes (59): Called by APScheduler when a cron fires. Dispatches to the orchestrator., #522 + #505: Reliability startup — schedule hydration, orchestrator restore, que, _scheduler_on_fire(), _startup_reliability_hooks(), get_orchestrator_queue(), OrchestratorQueue, Any, _QueueEntry (+51 more)

### Community 156 - "Persistent Memory System"
Cohesion: 0.05
...
### Community 157 - "test_portfolio_intake.py"
Cohesion: 0.08
...
### Community 158 - "anthropic_compat.py"
Cohesion: 0.09
...
### Community 159 - "test_north_mini_code.py"
Cohesion: 0.08
...
### Community 160 - "ContextWindowManager"
Cohesion: 0.09
...
### Community 166 - "test_workspace_isolation.py"
Cohesion: 0.19
...
### Community 167 - "PatternConsolidation"
Cohesion: 0.10
...
### Community 174 - "TestEstimateTokensForMessages"
Cohesion: 0.06
...
### Community 177 - "test_trend_watcher.py"
Cohesion: 0.09
...
### Community 178 - "_get_provider_policy"
Cohesion: 0.04
Nodes (53): _get_provider_policy(), Read the durable provider policy from DB, falling back to a safe default.      R, allow_paid_brain(), True only when the operator explicitly opted into a paid (Anthropic) brain., _best_cloud_primary_base(), TaskResult, TaskSpec, Execute a TaskSpec using the internal AgentRunner and convert the agent's outcom (+45 more)

### Community 179 - "ScheduledJob"
Cohesion: 0.08
...
### Community 181 - "test_issue_intake.py"
Cohesion: 0.12
...
### Community 188 - "test_verification_strategies.py"
Cohesion: 0.12
...
### Community 191 - "TaskDispatcher"
Cohesion: 0.09
Nodes (23): Re-queue BLOCKED tasks that have cooled down and are ready for retry., Polls for queued task work and executes it through the coordinator.      Crash r, Re-queue tasks stranded by a prior crash or hard-kill., TaskDispatcher, _make_task(), asyncio, Task, TaskStatus (+15 more)
...
### Community 193 - "test_all_providers_discovery.py"
Cohesion: 0.16
...
### Community 194 - "test_backend_server_features.py"
Cohesion: 0.08
...
### Community 195 - "RuntimeCapabilityRegistry"
Cohesion: 0.03
Nodes (70): AiderAdapter, Any, Adapter for Aider — TIER 3 specialized git-aware code editor., GooseAdapter, Any, Adapter for Goose — TIER 2 general-purpose local runtime., HermesAdapter, Any (+62 more)

### Community 196 - "[Unreleased]"
Cohesion: 0.06
Nodes (33): [5.0.0], Added, Added, Added, Added, Added, Added, Added (+25 more)

### Community 197 - "agent_runtime.py"
Cohesion: 0.11
...
### Community 198 - "[Unreleased]"
Cohesion: 0.06
Nodes (33): [5.0.0], Added, Added, Added, Added, Added, Added, Added (+25 more)

### Community 199 - "ENGINEERING_STANDARDS.md — Coding, Security & Testing Standards"
Cohesion: 0.06
...
### Community 200 - "local_controller.py"
Cohesion: 0.12
...
### Community 201 - "test_live_server.py"
Cohesion: 0.22
...
### Community 202 - "test_anthropic_router.py"
Cohesion: 0.09
...
### Community 204 - "MCPUnavailableError"
Cohesion: 0.15
...
### Community 206 - "chat_handlers.py"
Cohesion: 0.12
...
### Community 207 - "DashboardScreen.jsx"
Cohesion: 0.07
...
### Community 210 - "test_phase4_runtime_resilience.py"
Cohesion: 0.11
...
### Community 211 - "test_microagents.py"
Cohesion: 0.15
...
### Community 212 - "Security Analysis — local-llm-server"
Cohesion: 0.06
...
### Community 214 - "Langfuse Observability Guide"
Cohesion: 0.06
...
### Community 217 - "test_background_services.py"
Cohesion: 0.10
...
### Community 219 - "test_purge_backlog.py"
Cohesion: 0.09
...
### Community 220 - "test_telegram_mutating_commands.py"
Cohesion: 0.06
...
### Community 224 - "High-Agency Frontend Skill"
Cohesion: 0.06
Nodes (30): 10. FINAL PRE-FLIGHT CHECK, 1. ACTIVE BASELINE CONFIGURATION, 2. DEFAULT ARCHITECTURE & CONVENTIONS, 3. DESIGN ENGINEERING DIRECTIVES (Bias Correction), 4. CREATIVE PROACTIVITY (Anti-Slop Implementation), 5. PERFORMANCE GUARDRAILS, 6. TECHNICAL REFERENCE (Dial Definitions), 7. AI TELLS (Forbidden Patterns) (+22 more)

### Community 225 - "Quick-Note GitHub Issues Processing - Session Summary"
Cohesion: 0.06
...
### Community 227 - "TestRecordUsageAndStats"
Cohesion: 0.05
...
### Community 228 - "tests/test_browser.py"
Cohesion: 0.10
...
### Community 229 - "llm_providers.py"
Cohesion: 0.16
...
### Community 230 - "openclaw_gateway.py"
Cohesion: 0.09
Nodes (28): free_nvidia_models(), Return the curated list of free NVIDIA NIM models FreeBuff may use., List the free NVIDIA NIM models a user may pick (e.g. via Telegram)., True when *model* is in the curated free NVIDIA NIM set., is_rate_limit_exempt(), True when this key is on the FreeBuff rate-limit exemption allowlist.        Onl, Accept both Authorization: Bearer <key> (standard) and x-api-key: <key> (Claude, verify_api_key() (+20 more)

### Community 231 - "RuntimeManager"
Cohesion: 0.29
...
### Community 234 - "test_pr923_fixes.py"
Cohesion: 0.09
...
### Community 235 - "SteeringInjector"
Cohesion: 0.11
...
### Community 236 - "test_claude_setup_audit.py"
Cohesion: 0.16
...
### Community 237 - "CEOSupervisor"
Cohesion: 0.06
Nodes (39): get_ceo_dispatcher(), Return the shared CEODispatcher singleton., Reset the singleton (test helper)., reset_ceo_dispatcher(), CEOSupervisor, _env_flag(), _env_int(), Any (+31 more)

### Community 238 - "test_crispy_burn_in.py"
Cohesion: 0.07
...
### Community 239 - "test_internal_agent_did_work.py"
Cohesion: 0.12
...
### Community 240 - "test_provider_enable_disable.py"
Cohesion: 0.02
Nodes (114): backend/ceo_router.py — observability and manual control for the CEO.  Surfaces, brain_providers(), openclaw_websocket(), websocket, Every configured provider with its health AND its on/off state.      Powers the, WebSocket endpoint for iOS / mobile web UI pairing + command routing., _auto_disable(), _describe_registry() (+106 more)

### Community 241 - "test_skill_registry_boot_refresh.py"
Cohesion: 0.12
...
### Community 242 - "agile_sprints.py"
Cohesion: 0.09
...
### Community 243 - "Python Dependencies (`requirements.txt`)"
Cohesion: 0.07
...
### Community 244 - "Technical Debt Register — local-llm-server"
Cohesion: 0.07
...
### Community 246 - "RuntimeHealthService"
Cohesion: 0.12
...
### Community 249 - "isolated_telegram_config"
Cohesion: 0.11
...
### Community 250 - "WorkflowBuildRequest"
Cohesion: 0.11
...
### Community 252 - "TestSchedulerStore"
Cohesion: 0.07
...
### Community 254 - "test_watchdog.py"
Cohesion: 0.09
...
### Community 256 - "Deploy: FreeBuff Telegram bot (24×7)"
Cohesion: 0.07
...
### Community 257 - "Claude Code + Qwen Local Setup"
Cohesion: 0.07
...
### Community 264 - "telegram_service.py"
Cohesion: 0.15
...
### Community 266 - "Performance Analysis — local-llm-server"
Cohesion: 0.08
...
### Community 268 - "SeoAuditReport"
Cohesion: 0.13
Nodes (12): _mock_provider_records(), fixture, tests/test_orchestrator_failover.py — Provider failover, brain resolution, llm_p, End-to-end provider failover through the WorkflowOrchestrator., First provider fails → retry picks next → llm_provenance tracks the winner., The _failed_execute key in llm_provenance records the URLs that failed., A non-retryable error (e.g. ValueError) does not trigger failover., Return an AsyncMock that returns the given provider list. (+4 more)

### Community 269 - "test_rate_limiter.py"
Cohesion: 0.12
...
### Community 273 - "test_telegram_approval_gate.py"
Cohesion: 0.04
...
### Community 274 - "test_telegram_approval_e2e.py"
Cohesion: 0.12
...
### Community 275 - "test_service_token.py"
Cohesion: 0.08
...
### Community 279 - "test_rag_context.py"
Cohesion: 0.14
...
### Community 281 - "timedelta"
Cohesion: 0.14
Nodes (21): Delete all expired ephemeral companies. Returns the number deleted.      A compa, reap_expired_companies(), _company(), asyncio, fixture, Tests for services.ephemeral_reaper — destroy expired ephemeral companies.  Runs, A persistent company is never reaped even if it somehow carries an     expires_a, The new lifecycle columns persist and reload correctly. (+13 more)

### Community 282 - "test_unit7_catalog_propagation.py"
Cohesion: 0.08
...
### Community 284 - "test_ceo_router.py"
Cohesion: 0.16
...
### Community 286 - "Session Handoff — 2026-06-15"
Cohesion: 0.08
...
### Community 287 - "TASK 4 — End-to-end approval-gate test"
Cohesion: 0.08
...
### Community 288 - "get_feature_matrix"
Cohesion: 0.11
...
### Community 291 - "CompanyAgencyService"
Cohesion: 0.11
...
### Community 294 - "TemporalContextGraph"
Cohesion: 0.12
...
### Community 295 - "test_agency_fix.py"
Cohesion: 0.08
...
### Community 296 - "TestClassifyPlainText"
Cohesion: 0.08
...
### Community 298 - "synthesize_research"
Cohesion: 0.13
...
### Community 300 - "_resolve_user_github_token"
Cohesion: 0.17
...
### Community 301 - "Local AI Stack with Docker"
Cohesion: 0.08
...
### Community 302 - "Implementation Prompt: Rich TaskBoard + Agile Sprint Integration"
Cohesion: 0.08
...
### Community 303 - "Telegram Bot Setup"
Cohesion: 0.08
...
### Community 305 - "test_failover_silent_exhaustion.py"
Cohesion: 0.14
...
### Community 307 - "test_monitor_lib.py"
Cohesion: 0.11
...
### Community 308 - "test_output_filter.py"
Cohesion: 0.08
...
### Community 310 - "test_workspace_security.py"
Cohesion: 0.10
...
### Community 315 - "NIMConnectionPool"
Cohesion: 0.12
...
### Community 316 - "test_all_features.py"
Cohesion: 0.09
...
### Community 319 - "test_mostly_failed_steps.py"
Cohesion: 0.12
...
### Community 320 - "classify_direct_chat_intent"
Cohesion: 0.13
...
### Community 325 - "Configuration Reference"
Cohesion: 0.09
...
### Community 329 - "PriorityTaskQueue"
Cohesion: 0.13
...
### Community 331 - "V3 API Migration Plan — LLM Relay Platform"
Cohesion: 0.10
...
### Community 332 - "test_chat_mode_regressions.py"
Cohesion: 0.19
...
### Community 334 - "test_issue_triage.py"
Cohesion: 0.17
...
### Community 335 - "test_freebuff_bot.py"
Cohesion: 0.09
...
### Community 336 - "test_local_controller.py"
Cohesion: 0.17
...
### Community 337 - "test_unit5_ui_provider_surface.py"
Cohesion: 0.10
...
### Community 338 - "test_voice_pipeline.py"
Cohesion: 0.13
...
### Community 341 - "test_permissions.py"
Cohesion: 0.15
...
### Community 342 - "PersistentMemoryStore"
Cohesion: 0.24
...
### Community 344 - "Design Audit"
Cohesion: 0.10
Nodes (19): Code Quality, Color and Surfaces, Component Patterns, Content, Design Audit, Fix Priority, How This Works, Iconography (+11 more)

### Community 345 - "Findings"
Cohesion: 0.10
...
### Community 347 - "Skill: modularity-review"
Cohesion: 0.10
Nodes (19): Acceptance Checks, Applying to This Repo, Further Reading, Modularity Findings Template, Part A: Reviewing Existing Code for Modularity Problems, Part B: Designing New Modular Boundaries, Skill: modularity-review, Step 1 — Map the dependency graph (+11 more)

### Community 348 - "crispy_client.py"
Cohesion: 0.14
Nodes (18): cmd_approve(), cmd_artifacts(), cmd_build(), cmd_events(), cmd_reject(), cmd_status(), cmd_watch(), _get() (+10 more)

### Community 349 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 354 - "DecisionsStoreTests"
Cohesion: 0.11
...
### Community 355 - "test_p0_roadmap_b3_b4_b5.py"
Cohesion: 0.16
...
### Community 356 - "test_brain_patch_service_token.py"
Cohesion: 0.16
...
### Community 357 - "test_tasks_cache_ttl_env.py"
Cohesion: 0.21
...
### Community 358 - "TestOrchestratorEndpointScoping"
Cohesion: 0.13
...
### Community 361 - "_extract_tech_relevance"
Cohesion: 0.17
...
### Community 364 - "Skill: fabric-patterns"
Cohesion: 0.11
...
### Community 365 - "Analysis & Synthesis Instructions"
Cohesion: 0.11
Nodes (18): 1. Define the Atmosphere, 2. Map the Color Palette, 3. Establish Typography Rules, 4. Define the Hero Section, 5. Describe Component Stylings, 6. Define Layout Principles, 7. Define Responsive Rules, 8. Encode Motion Philosophy (+10 more)

### Community 366 - "Production Readiness Assessment — local-llm-server"
Cohesion: 0.11
...
### Community 368 - "Skill: fabric-patterns"
Cohesion: 0.11
Nodes (18): 1. Ensure Pattern Directory Exists, 2. List Available Patterns, 3. Retrieve a Pattern, 4. Apply a Pattern with Variables, 5. Stitch Patterns Together, 6. Create New Patterns, Acceptance Checks, Directory Structure (+10 more)

### Community 369 - "db/__init__.py"
Cohesion: 0.15
...
### Community 370 - "Admin Dashboard Guide"
Cohesion: 0.11
...
### Community 371 - "Implementation Plan"
Cohesion: 0.11
...
### Community 374 - "Delegation Plan (agent-ready work packages)"
Cohesion: 0.11
...
### Community 377 - "test_company_api.py"
Cohesion: 0.11
...
### Community 378 - "test_fabric_patterns.py"
Cohesion: 0.11
...
### Community 379 - "test_repowise_intelligence.py"
Cohesion: 0.11
...
### Community 380 - "TestAdapterMetadata"
Cohesion: 0.13
...
### Community 381 - "test_sam_livekit.py"
Cohesion: 0.04
...
### Community 382 - "test_sam_voice.py"
Cohesion: 0.12
...
### Community 383 - "test_schedule_persistence.py"
Cohesion: 0.17
...
### Community 384 - "trend_analysis.py"
Cohesion: 0.19
...
### Community 385 - "validate_session_id"
Cohesion: 0.16
...
### Community 386 - "sam_livekit_worker.py"
Cohesion: 0.14
...
### Community 387 - "ErrorInterceptorMiddleware"
Cohesion: 0.18
...
### Community 390 - "Comprehensive Skill Index (By Category)"
Cohesion: 0.11
...
### Community 391 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 392 - "Component Map"
Cohesion: 0.11
...
### Community 393 - "Agent State — colibri GLM-5.2 deployment (resumable)"
Cohesion: 0.11
...
### Community 394 - "Architecture Overview — local-llm-server"
Cohesion: 0.11
...
### Community 395 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
...
### Community 396 - "Part A — Health Report"
Cohesion: 0.11
...
### Community 398 - "generate_context.py"
Cohesion: 0.12
...
### Community 402 - "sync_readme_gallery.py"
Cohesion: 0.22
...
### Community 404 - "test_skill_executors_live.py"
Cohesion: 0.16
...
### Community 406 - "test_ceo_direct_dedup.py"
Cohesion: 0.15
Nodes (8): ConsolidationPhase, DreamMemory, Enum, str, Dream Memory Consolidation — pattern consolidation across AI sessions.  Inspired, Current phase of the consolidation lifecycle., A single memory fragment captured during AI sessions.      Memories start as raw, Memories older than 24h that haven't been consolidated are stale.
...
### Community 415 - "._fetch_flat_skill_file"
Cohesion: 0.21
...
### Community 423 - "Section-by-Section Acceptance Criteria"
Cohesion: 0.12
...
### Community 424 - "agent_readiness_audit.py"
Cohesion: 0.21
...
### Community 428 - "test_activation_api.py"
Cohesion: 0.21
...
### Community 429 - "test_autonomy_status.py"
Cohesion: 0.12
...
### Community 430 - "test_health_endpoints.py"
Cohesion: 0.17
...
### Community 432 - "test_local_brain_state.py"
Cohesion: 0.12
...
### Community 434 - "test_phase5_doctor.py"
Cohesion: 0.08
...
### Community 436 - "test_portfolio_intelligence.py"
Cohesion: 0.12
...
### Community 437 - "_response"
Cohesion: 0.21
Nodes (4): asyncio, _response(), TestPreFlightCheck, TestUpdateFromResponse

### Community 438 - "test_telegram_diag_endpoint.py"
Cohesion: 0.12
...
### Community 439 - "hermes_prompt.py"
Cohesion: 0.19
...
### Community 440 - "MemoryMiddleware"
Cohesion: 0.17
...
### Community 442 - "Skill: repowise-intelligence"
Cohesion: 0.12
...
### Community 443 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
...
### Community 444 - "admin_digest_router.py"
Cohesion: 0.20
...
### Community 445 - "_valid_login_state"
Cohesion: 0.24
...
### Community 446 - "Skill: repowise-intelligence"
Cohesion: 0.12
Nodes (15): 1. Graph Intelligence (Dependency Graph), 2. Git Intelligence, 3. Documentation Intelligence, 4. Decision Intelligence, Acceptance Checks, Directory Structure, Example Usage, Implementation Approach (+7 more)

### Community 447 - "The 10-Step Workflow"
Cohesion: 0.12
...
### Community 448 - "Contributing to local-llm-server"
Cohesion: 0.12
...
### Community 449 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 450 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 451 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
...
### Community 457 - "ManagedAgentDreams"
Cohesion: 0.22
...
### Community 459 - "_process_task_callback"
Cohesion: 0.17
...
### Community 460 - "e2e/test_browser.py"
Cohesion: 0.21
...
### Community 461 - "DailyDigestAggregatorTests"
Cohesion: 0.21
...
### Community 462 - "test_frontend_deployment_guards.py"
Cohesion: 0.20
...
### Community 463 - "test_glm52_brain.py"
Cohesion: 0.12
...
### Community 464 - "test_langfuse_agency_wide.py"
Cohesion: 0.12
...
### Community 465 - "test_task_pre_execution_gate.py"
Cohesion: 0.25
...
### Community 466 - "test_telegram_service_webhook.py"
Cohesion: 0.21
...
### Community 469 - "CollaborationContext"
Cohesion: 0.19
...
### Community 470 - "Skill: agent-harness"
Cohesion: 0.13
...
### Community 471 - "Skill: checkpoint-strategy"
Cohesion: 0.13
...
### Community 473 - "Skill: local-ai-query"
Cohesion: 0.13
...
### Community 474 - "Skill: parallel-agents"
Cohesion: 0.13
...
### Community 475 - "Skill: parallel-worktrees"
Cohesion: 0.13
...
### Community 476 - "Design System: Taste Standard"
Cohesion: 0.13
...
### Community 479 - "Skill: user-research"
Cohesion: 0.13
...
### Community 480 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 481 - "Attention Mechanisms Internals"
Cohesion: 0.13
...
### Community 483 - "implement_agent.py"
Cohesion: 0.16
...
### Community 485 - "AdminSessionStore"
Cohesion: 0.18
...
### Community 486 - "_push_down_where"
Cohesion: 0.14
...
### Community 488 - "DockerAgentAdapter"
Cohesion: 0.18
...
### Community 490 - "TestDecisionsBotLinks"
Cohesion: 0.17
...
### Community 491 - "DecisionsStore"
Cohesion: 0.30
Nodes (3): DecisionsStore, Any, Connection

### Community 492 - "clear_wizard_state_cache"
Cohesion: 0.21
...
### Community 494 - "TestModelRegistryUpdates"
Cohesion: 0.14
...
### Community 496 - "test_openclaw_gateway.py"
Cohesion: 0.13
...
### Community 497 - "test_scanner_live.py"
Cohesion: 0.23
...
### Community 498 - "test_telegram_task_callback.py"
Cohesion: 0.19
...
### Community 502 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 506 - "Checks Performed"
Cohesion: 0.14
...
### Community 507 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 510 - "Skill: branch-cleanup"
Cohesion: 0.14
...
### Community 511 - "Skill: perplexity — Web Research via Perplexity API"
Cohesion: 0.14
...
### Community 514 - "Quick-Note Issues Processing Summary"
Cohesion: 0.14
...
### Community 515 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 517 - "Runbook: Auto-Resume After Cooldown / Interruption"
Cohesion: 0.14
...
### Community 518 - "SEO / GEO / AIO Audit Engine"
Cohesion: 0.14
...
### Community 522 - "rate_limiter.py"
Cohesion: 0.17
Nodes (9): _ProviderQuota, Response, Proactive rate-limit throttling for LLM providers — two complementary layers.  *, Parse x-ratelimit-* headers and update per-provider quota state.          Safe t, Reset all state (primarily for tests)., Clear all token-bucket state (tests only). Does not touch the header     tracker, reset(), fixture (+1 more)

### Community 523 - "RateLimitTracker"
Cohesion: 0.19
...
### Community 527 - "test_critical_flows.py"
Cohesion: 0.29
...
### Community 528 - "test_autonomy_pipeline_regressions.py"
Cohesion: 0.15
...
### Community 530 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 535 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 538 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 539 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 542 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
...
### Community 543 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 544 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 546 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 547 - "admin_update_task_router.py"
Cohesion: 0.22
...
### Community 549 - "Instructions"
Cohesion: 0.15
Nodes (12): Acceptance Checks, Instructions, Role 1: Security Reviewer, Role 2: Correctness Reviewer, Role 3: Performance Reviewer, Role 4: Maintainability Reviewer, Skill: council-review, Step 1 — Gather the diff (+4 more)

### Community 550 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
Nodes (12): Acceptance Checks, Claude's query protocol (use this instead of Read tool for exploration):, Graph Artifacts — What to Commit, How to Use the Graph (Token Savings Protocol), Installation (one-time per machine), Instead of reading raw files:, Key commands:, Relationship to repowise-intelligence Skill (+4 more)

### Community 551 - "Skill: platform-setup — Autonomous Agency Bootstrap"
Cohesion: 0.15
...
### Community 552 - "Workspace Isolation Architecture"
Cohesion: 0.15
...
### Community 553 - "Device compatibility and model picks"
Cohesion: 0.15
...
### Community 554 - "Autonomy Uplift — Living Roadmap & Detailed Implementation Specs"
Cohesion: 0.15
...
### Community 555 - "OpenClaw — iOS Control of the Agency (Single-Service Free-Tier Deploy)"
Cohesion: 0.15
...
### Community 559 - "Agent Transparency Report"
Cohesion: 0.15
...
### Community 560 - "update_provider_policy"
Cohesion: 0.19
...
### Community 562 - "_InMemoryBackend"
Cohesion: 0.18
...
### Community 563 - "test_agile_api.py"
Cohesion: 0.15
...
### Community 564 - "test_app_settings.py"
Cohesion: 0.19
...
### Community 565 - "TestModelCostTableUpdates"
Cohesion: 0.26
...
### Community 566 - "TestMCPClientStructuredOutput"
Cohesion: 0.31
...
### Community 567 - "TestRuntimeControl"
Cohesion: 0.15
...
### Community 568 - "TestKillSwitchDurability"
Cohesion: 0.15
...
### Community 569 - "test_schedule_growth_invariants.py"
Cohesion: 0.12
...
### Community 570 - "test_task_clarification.py"
Cohesion: 0.15
...
### Community 571 - "test_tasks_awaiting_approval_api.py"
Cohesion: 0.31
...
### Community 572 - "WorkspaceManifest"
Cohesion: 0.17
...
### Community 575 - "skill_registry.py"
Cohesion: 0.17
...
### Community 581 - "Skill: system-prompt-audit"
Cohesion: 0.17
...
### Community 582 - "Skill: task-alive-updates"
Cohesion: 0.17
...
### Community 588 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 591 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 593 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 594 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 595 - "Quantization Internals"
Cohesion: 0.17
...
### Community 596 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 597 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 598 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 599 - "test_p0_roadmap_a4_a5_b2.py"
Cohesion: 0.26
...
### Community 600 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 601 - "test_docs_consistency.py"
Cohesion: 0.15
...
### Community 602 - "TestAuthAndTaskCreation"
Cohesion: 0.17
...
### Community 603 - "test_providers_live_e2e.py"
Cohesion: 0.27
...
### Community 604 - "test_skill_registry.py"
Cohesion: 0.20
...
### Community 607 - "_extractive_compress"
Cohesion: 0.18
...
### Community 611 - "cowork_session.py"
Cohesion: 0.24
...
### Community 613 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 616 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 617 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 619 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 622 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 623 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 624 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 625 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 626 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 627 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 628 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 629 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 631 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 632 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 633 - "CI Troubleshooting Runbook"
Cohesion: 0.18
...
### Community 634 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 635 - "What to clean up"
Cohesion: 0.18
...
### Community 636 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 638 - "test_bedrock_live.py"
Cohesion: 0.25
...
### Community 639 - "provider_max_rpm"
Cohesion: 0.29
...
Cohesion: 0.22
Nodes (11): Verify execution results., GitHub token used to push branches / open PRs during EXECUTION (#506).      Prec, _resolve_push_token(), _clean_env(), fixture, tests/test_orchestrator_push_token.py — #506 push/PR token resolution.  workflow, test_falls_through_gh_pat_and_github_token(), test_internal_run_uses_server_token() (+3 more)
...
Cohesion: 0.05
Nodes (45): get_enrichment(), agent/harness_enrichment.py — Automatic Harness Enrichment for Agent Prompts  Ev, _check_extra_kwargs(), _enforce_signature(), loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., Raise TypeError on unknown kwarg (runtime extra='forbid' for non-Pydantic classe, # NOTE: "ollama_base" is kept for backwards compatibility; this runner only need, Raise TypeError if fn's signature drifts from the locked contract (Pydantic extr (+37 more)

### Community 644 - "test_event_log.py"
Cohesion: 0.45
...
### Community 645 - "test_google_provider_models.py"
Cohesion: 0.18
...
### Community 646 - "get_livekit_config"
Cohesion: 0.29
Nodes (3): Return a FastAPI dependency that checks for a specific permission., require_permission(), TestRequireAdmin

### Community 647 - "_FakeSQLiteStore"
Cohesion: 0.26
Nodes (5): _coerce_ts(), Any, field_validator, Coerce ISO-8601 datetime strings (from DB) to float timestamps., Dict-compatible accessor.          Log entries are serialized to/from dicts in m
...
### Community 649 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 650 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 652 - "TestNormalizeToolChoice"
Cohesion: 0.09
...
### Community 653 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 654 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 655 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 656 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 657 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 658 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 659 - "Agent Readiness Report"
Cohesion: 0.20
...
### Community 661 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 664 - "_parse_reset_epoch"
Cohesion: 0.33
...
### Community 665 - "build_tech_db.py"
Cohesion: 0.40
...
### Community 670 - "_FakeAsyncClient"
Cohesion: 0.20
...
### Community 671 - "TestExtendedThinkingRouting"
Cohesion: 0.20
...
### Community 672 - "test_dockerfile_ships_root_modules.py"
Cohesion: 0.31
...
### Community 673 - "TestZeroAttemptDiagnostics"
Cohesion: 0.29
...
### Community 674 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 675 - "test_provider_state_durability.py"
Cohesion: 0.20
...
### Community 676 - "test_quick_note_engine.py"
Cohesion: 0.22
...
### Community 677 - "_FakePersistence"
Cohesion: 0.20
...
### Community 681 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 683 - "Skill: changelog-enforcer"
Cohesion: 0.22
...
### Community 684 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 686 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 687 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 688 - "Skill: changelog-enforcer"
Cohesion: 0.22
Nodes (8): Acceptance Checks, Changelog Location, Entry Format, Examples, Hook Behaviour, Instructions, Skill: changelog-enforcer, When to Use

### Community 689 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
Nodes (8): Branch, Components, Purpose, Quick Start, Session Roles, Skill: cowork-session (Claude Cowork), Testing, When to Use

### Community 690 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 691 - "Agent Autonomy Roadmap"
Cohesion: 0.22
...
### Community 692 - "Main proxy (`proxy.py`)"
Cohesion: 0.22
...
### Community 693 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 694 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 695 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 696 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 697 - "Release Procedure"
Cohesion: 0.22
...
### Community 698 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 707 - "cleanup_stale_jobs"
Cohesion: 0.31
...
### Community 708 - "enrich_quick_note_issues.py"
Cohesion: 0.42
...
### Community 709 - "_status_snapshot"
Cohesion: 0.31
...
### Community 711 - "test_shared_state.py"
Cohesion: 0.31
...
### Community 712 - ".on_task_complete"
Cohesion: 0.28
...
### Community 715 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 716 - "test_changelog_parity_guard.py"
Cohesion: 0.22
...
### Community 719 - "TestChatFallbackAndApproval"
Cohesion: 0.22
...
### Community 722 - "TestGithubSignalHardening"
Cohesion: 0.22
...
### Community 725 - "TestPaidPolicyDurability"
Cohesion: 0.22
...
### Community 726 - "test_runtimes_health_endpoint.py"
Cohesion: 0.22
...
### Community 727 - "test_scanner_deps_parity.py"
Cohesion: 0.31
...
### Community 728 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.22
...
### Community 730 - "navigation_metrics.py"
Cohesion: 0.32
...
### Community 732 - "._run_git_command"
Cohesion: 0.25
...
### Community 736 - "ContributorState"
Cohesion: 0.25
...
### Community 737 - "quality_checker.py"
Cohesion: 0.32
...
### Community 739 - "_build_direct_chat_schedule_suggestion"
Cohesion: 0.25
...
### Community 740 - "TestParseToolCalls"
Cohesion: 0.25
...
### Community 751 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 752 - "ceo-micromanagement.md"
Cohesion: 0.25
Nodes (4): P0 behavior change, Readiness contract, Runtime model, Runtime types

### Community 753 - "Feature Maturity / Support Matrix"
Cohesion: 0.25
...
### Community 756 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.25
...
### Community 757 - "Issue #362: Nvidia repo setup"
Cohesion: 0.25
...
### Community 758 - "Issue #364: quick-note:https://www.marktechpost.com/2026/06/01/meet-memory-os-a-6-layer-open-source-memory-stack-built-on-top-of-hermes-agent/"
Cohesion: 0.25
...
### Community 759 - "Issue #378: quick-note:https://www.marktechpost.com/2026/06/02/tinyfish-launches-bigset-an-open-source-multi-agent-system-that-builds-structured-live-datasets-from-plain-english-descriptions/"
Cohesion: 0.25
...
### Community 760 - "Issue #379: quick-note:https://searchengineland.com/schema-markup-optimize-agentic-web-479080"
Cohesion: 0.25
...
### Community 761 - "Issue #380: quick-note:https://cursor.com/blog/cloud-agent-lessons"
Cohesion: 0.25
...
### Community 762 - "Issue #381: quick-note:https://www.xda-developers.com/claude-code-with-opus-48-is-expensive-but-i-made-it-efficient-with-my-local-ai-workflow/"
Cohesion: 0.25
...
### Community 763 - "Issue #382: quick-note:https://claude.com/blog/how-coderabbit-used-claude-to-build-an-agent-orchestration-system"
Cohesion: 0.25
...
### Community 764 - "Issue #383: quick-note:https://www.marktechpost.com/2026/05/29/hexo-labs-open-sources-sia-a-self-improving-agent-that-updates-both-the-harness-and-the-model-weights/"
Cohesion: 0.25
...
### Community 765 - "Issue #416: feat: Self-hosted Codebuff (freebuff) on free NVIDIA models + Telegram bot phone control"
Cohesion: 0.25
...
### Community 766 - "Issue #485: [Trend Digest] Week of 2026-06-08"
Cohesion: 0.25
...
### Community 767 - "Issue #488: quick-note:https://github.com/cookiy-ai/user-research-skill"
Cohesion: 0.25
...
### Community 768 - "Issue #491: Implement whatever is necessary from https://github.com/BehiSecc/awesome-claude-skills"
Cohesion: 0.25
...
### Community 769 - "Issue #493: Use the https://github.com/mvanhorn/last30days-skill skill to get the trend updated"
Cohesion: 0.25
...
### Community 770 - "Issue #495: Read https://www.anthropic.com/news/claude-fable-5-mythos-5 and understand if mythos or fable can be added to the repo"
Cohesion: 0.25
...
### Community 771 - "Issue #504: EPIC: Autonomy hardening — live-verified defects 2026-06-10"
Cohesion: 0.25
...
### Community 772 - "Issue #581: Sprint tracker: pending work after brand rename + mobile-first pass"
Cohesion: 0.25
...
### Community 774 - "Issue #657: quick-note:https://github.com/earendil-works/pi"
Cohesion: 0.25
...
### Community 775 - "Issue #659: quick-note:https://github.com/nex-agi/Nex-N2"
Cohesion: 0.25
...
### Community 776 - "Issue #660: quick-note:https://github.com/getsentry/sentry-for-ai"
Cohesion: 0.25
...
### Community 777 - "Issue #661: quick-note:https://github.com/XiaomiMiMo/MiMo-Code"
Cohesion: 0.25
...
### Community 778 - "Issue #664: quick-note:https://github.com/Grominet95/jarvis-OS"
Cohesion: 0.25
...
### Community 779 - "Issue #666: quick-note:https://github.com/porokka/jarvis-os"
Cohesion: 0.25
...
### Community 780 - "Issue #670: quick-note:https://github.com/perplexityai/bumblebee"
Cohesion: 0.25
...
### Community 781 - "Issue #672: quick-note:https://github.com/Chachamaru127/claude-code-harness"
Cohesion: 0.25
...
### Community 782 - "Issue #676: quick-note:https://github.com/WeiboAI/VibeThinker"
Cohesion: 0.25
...
### Community 783 - "Issue #820: quick-note:https://github.com/cobusgreyling/loop-engineering"
Cohesion: 0.25
...
### Community 784 - "Positional Encoding Internals"
Cohesion: 0.25
...
### Community 785 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 786 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 787 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 788 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 792 - "capture_screens.py"
Cohesion: 0.39
...
### Community 795 - "crispy_burn_in.py"
Cohesion: 0.36
...
### Community 796 - "run_patched_colibri.py"
Cohesion: 0.36
...
### Community 798 - "test_compose_and_coordinate_api.py"
Cohesion: 0.36
...
### Community 800 - "TestAgentAutoAssignment"
Cohesion: 0.25
...
### Community 801 - "test_local_brain_router_smoke.py"
Cohesion: 0.25
...
### Community 803 - "test_provider_models_db_outage.py"
Cohesion: 0.25
...
### Community 806 - "test_seo_audit_pending_expiry.py"
Cohesion: 0.29
...
### Community 808 - "test_serve_spa_prefixes.py"
Cohesion: 0.36
...
### Community 811 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 812 - ".discover_directory"
Cohesion: 0.33
Nodes (6): _as_aware_utc(), _env_float(), datetime, services/ephemeral_reaper.py — destroy expired ephemeral companies.  The platfor, Treat naive datetimes as UTC so comparisons never raise., Parse a positive, finite float env var (seconds), else the default.      Rejects

### Community 813 - "_keyword_search"
Cohesion: 0.29
...
### Community 819 - "AI Engineering Insights Skill"
Cohesion: 0.29
...
### Community 829 - "ADR-006: Strangler Fig migration with backward-compat shims"
Cohesion: 0.29
Nodes (6): ADR-006: Strangler Fig migration with backward-compat shims, Consequences, Context, Decision, Examples, Migration path

### Community 830 - "claude-mem Plugin — Persistent Memory for All Sessions"
Cohesion: 0.29
...
### Community 831 - "Implementation plan + TO-DO (check off as you go)"
Cohesion: 0.29
...
### Community 839 - "check_changelog_parity.py"
Cohesion: 0.43
...
### Community 840 - "e2e_smoke.py"
Cohesion: 0.57
Nodes (5): _chat(), check(), _health(), _models(), _req()

### Community 841 - "task_runner.py"
Cohesion: 0.33
...
### Community 843 - "test_daily_2026_06_14.py"
Cohesion: 0.38
...
### Community 844 - "TestSupportMatrixDocsSync"
Cohesion: 0.48
...
### Community 845 - "TestDisabledFeatures"
Cohesion: 0.40
...
### Community 846 - "TestGithubTokenSQLiteRegression"
Cohesion: 0.38
...
### Community 853 - "._get_last_commit"
Cohesion: 0.33
...
### Community 854 - "openclaw_mobile_ui"
Cohesion: 0.33
...
### Community 869 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 870 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 871 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 872 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 873 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 874 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 879 - "resolve_hermes_base_url"
Cohesion: 0.47
...
### Community 883 - "apply_phase1_changes.py"
Cohesion: 0.33
...
### Community 895 - "test_runtime_registration_scope.py"
Cohesion: 0.40
...
### Community 896 - "_normalize_dockerfile"
Cohesion: 0.40
...
### Community 915 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 916 - "Runtime troubleshooting"
Cohesion: 0.40
Nodes (4): Agent mode timeout, Missing binary / task harness, Runtime troubleshooting, Workspace validation failures

### Community 917 - "knowledgeGraphTab.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 918 - "loginFlowNoTimeout.test.js"
Cohesion: 0.40
Nodes (4): apiSource, { describe, test, expect }, fs, path

### Community 919 - "test_company_stale_id_recovery.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 920 - "worker_no_cache.test.js"
Cohesion: 0.40
...
### Community 922 - "Prompt Library Changelog"
Cohesion: 0.40
...
### Community 924 - "._execute_via_cli"
Cohesion: 0.09
...
### Community 925 - "_add_colibri_shim_changelog_entry.py"
Cohesion: 0.50
...
### Community 926 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 927 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 928 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 929 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 930 - "setup_colibri.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 931 - "setup_colibri.sh script"
Cohesion: 0.70
Nodes (4): setup_colibri.sh script, fail(), ok(), warn()

### Community 932 - "status_colibri_server.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 934 - "test_v5_screens_smoke.py"
Cohesion: 0.50
...
### Community 935 - "test_agent_runtime_wrapper.py"
Cohesion: 0.70
...
### Community 961 - "test_no_exception_detail_leaks.py"
Cohesion: 0.50
...
### Community 962 - "test_skills_route_order.py"
Cohesion: 0.67
...
### Community 972 - ".write_mcp_config"
Cohesion: 0.50
...
### Community 989 - "test_the_reserve_is_bounded_when_read_from_the_environment"
Cohesion: 0.67
...
### Community 998 - "_classify_complexity"
Cohesion: 0.50
Nodes (3): RoutingDecision, TaskResult, TaskSpec

### Community 1030 - ".__init__"
Cohesion: 0.67
...
### Community 1039 - ".cleanup_workspace"
Cohesion: 0.67
Nodes (3): 8. Authentication Architecture, Auth dependency chain, Auth flows

## Knowledge Gaps
- **3212 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `aider_config.sh script`, `OPENAI_API_BASE` (+3207 more)
...
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `ExecutionRequest`, `AgentSessionStore`, `test_empirical_verify.py`, `FreeBuffAgent`, `proxy.py`, `AdaptiveHalter`, `LocalWorkspace`, `WorkspaceTools`, `RuntimeHealth`, `TestOrchestratorCheckpointStore`, `diagnostics.py`, `test_ceo_micromanager.py`, `direct_chat.py`, `Initiative`, `CEODispatcher`, `TestZeroAttemptDiagnostics`, `ContextPruner`, `RuntimeReadinessReport`, `MultiAgentSwarm`, `MCPClient`, `_get_provider_policy`, `test_failover_client_shared.py`, `test_agency.py`, `GitHubTools`, `TokenBudget`, `test_agent_chat_integration.py`, `ContextManager`, `MCPUnavailableError`, `_StubManager`, `Workspace`, `openclaw_mobile_ui`, `StuckDetector`, `ReactScratchpad`, `failover_client.py`, `TestAdapterMetadata`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `AgentSessionStore` connect `AgentSessionStore` to `backend/server.py`, `ExecutionRequest`, `AgentRunner`, `test_empirical_verify.py`, `FreeBuffAgent`, `proxy.py`, `TestOrchestratorCheckpointStore`, `test_event_log.py`, `diagnostics.py`, `FeatureUnavailableError`, `direct_chat.py`, `Initiative`, `test_orchestrator_merge_decision.py`, `RuntimeReadinessReport`, `_get_provider_policy`, `_resolve_default_executor_model`, `IssueCategory`, `test_agent_chat_integration.py`, `._connect`, `test_memory.py`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `RuntimeHealth` connect `RuntimeCapabilityRegistry` to `ExecutionRequest`, `AgentSessionStore`, `RuntimeHealth`, `RuntimeReadinessReport`, `TaskSpec`, `FeatureUnavailableError`, `runtimes/api.py`, `test_runtimes_health_endpoint.py`, `CEODispatcher`, `._execute_via_cli`?**
...
- **What connects `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script` to the rest of the system?**
  _3212 weakly-connected nodes found - possible documentation gaps or missing edges._