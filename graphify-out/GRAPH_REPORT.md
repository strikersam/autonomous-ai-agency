# Graph Report - autonomous-ai-agency  (2026-09-02)

## Corpus Check
- 1462 files · ~2,127,842 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 29787 nodes · 55221 edges · 1260 communities (1095 shown, 110 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 2703 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2ebf714c`
...
## Communities (1260 total, 110 thin omitted)
...
Cohesion: 0.02
Nodes (186): Reject non-admin callers. Mirrors the RBAC check used elsewhere in this backend…, _require_admin(), admin_seed(), AgentStatusEntry, AgentStatusResponse, AgentToolCallEntry, ApiKeyCreate, AuthorizeReposBody (+178 more)

### Community 2 - "LLMRequest"
Cohesion: 0.04
Nodes (97): ProviderConfig, One configured endpoint. ``kind`` selects the adapter: ``openai`` (any OpenAI-…, build_provider(), ProviderConfig, Normalise a configured ``kind`` to an adapter key., Instantiate the adapter for one provider config. Unknown kinds fall back to the…, resolve_kind(), LLMRequest (+89 more)

### Community 3 - "proxy.py"
Cohesion: 0.03
Nodes (164): get_skill_registry_safe(), Return the global SkillRegistry if set, else None. Used by onboarding and other…, middleware, admin_control(), admin_create_user(), admin_delete_user(), admin_login(), admin_logout() (+156 more)

### Community 4 - "test_llm_router_queue_cache.py"
Cohesion: 0.03
Nodes (91): int, cosine_similarity(), payload_key(), Exact-match cache key over the fields that change the answer. Routing…, Cosine similarity between two vectors, 0.0 when either is degenerate., build_summariser(), chunk_document(), ContextManager (+83 more)

### Community 5 - "llm/router.py"
Cohesion: 0.03
Nodes (95): get_budget(), The process-wide budget tracker., get_cache(), packages/llm/cache.py — layered caching. Five independent layers, each with its…, The process-wide cache manager., text_key(), failover_chat_completion_via_router(), openai_body_from_response() (+87 more)
...
### Community 10 - "test_e2b_sandbox.py"
Cohesion: 0.05
Nodes (58): _inject_token(), maybe_attach_e2b(), Best-effort scrub of ``token`` from ``text``., Open an E2B session and attach it as ``runner._mcp``. Single wiring line for…, Return ``(authed_url, clean_url)`` for a GitHub repo URL., _scrub_token(), GUARDRAIL: E2B_API_KEY alone (without E2B_ENABLED=true) must NOT attach. This…, E2B_ENABLED=true + key → maybe_attach_e2b attaches the session. (+50 more)
...
Cohesion: 0.04
Nodes (99): agent/job_manager.py — Async agent job lifecycle manager. Manages agent jobs…, kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, TaskResult, TaskSpec, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Run aider non-interactively via `--message` flag., runtimes/adapters/claude_code.py — Claude Code CLI adapter (FIRST CLASS).… (+91 more)

### Community 13 - "services/background.py"
Cohesion: 0.04
Nodes (75): get_trend_watcher(), set_trend_watcher(), _await_hermes_ready(), BackgroundServices, _env_float(), _env_on(), _hydrate_scheduler_bounded(), Any (+67 more)

### Community 14 - "company_api.py"
Cohesion: 0.04
Nodes (105): account_lifecycle(), AccountLifecycleResponse, auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint(), _DoctorCheck, _DoctorReport (+97 more)

### Community 15 - "BrainConfig"
Cohesion: 0.03
...
Cohesion: 0.05
Nodes (41): Find agent phases that started but never finished.…, summarise_phases(), Recurring operational failures must diagnose and file themselves. The gap these…, The reported scenario, end to end: four real timeouts, one incident., Two timeouts an hour apart are not a pattern., Even many *distinct* failure modes cannot produce unbounded incidents. The…, `record` runs inside a logging.Handler — it must swallow everything., `_timed_phase` (#1218) brackets each call; a start with no end is the hang. (+33 more)

### Community 17 - "runtimes/manager.py"
Cohesion: 0.03
Nodes (40): AiderAdapter, Any, Adapter for Aider — TIER 3 specialized git-aware code editor., GooseAdapter, Any, Adapter for Goose — TIER 2 general-purpose local runtime., HermesAdapter, Any (+32 more)

### Community 18 - "_fixture"
Cohesion: 0.02
...
### Community 19 - "ImprovementLoop"
Cohesion: 0.04
Nodes (99): Agency, AgentRole, get_agency(), _parse_ceo_directives(), str, CEO-coordinated multi-agent agency for continuous codebase management. The CEO…, set_agency(), DetectedIssue (+91 more)
...
### Community 21 - "PolicyEngine"
Cohesion: 0.04
Nodes (89): Charge sub-agent nesting depth and enforce the ``max_depth`` ceiling. Isolates…, _egress_policy_reason(), agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Return why governance policy blocks *host*, or None. Runs strictly *after* the…, governance_enabled(), True when the governance layer should run at all. A single global off switch…, _action_matches(), _as_list() (+81 more)

### Community 22 - "TaskWorkflowService"
Cohesion: 0.03
Nodes (87): AgentDefinition, AgentStore, Any, field_validator, agents/store.py — Persistent store for user-defined agent configurations.…, CRUD store for AgentDefinition objects. Uses MongoDB when a `db` client is…, Return an agent by ID. If *owner_id* is provided, enforces that the agent…, Delete an agent. Returns True on success, False if not found/unauthorised. (+79 more)

### Community 23 - "Specialist"
Cohesion: 0.05
Nodes (25): SpecialistFamily, Find all specialists of a specific family., Find specialists that can handle a task with given capabilities., A specialist agent that can be provisioned for company-specific tasks., Check if this specialist can handle a task with given capabilities., Specialist, Get a specialist by ID., Create a new specialist. (+17 more)

### Community 24 - "resolve_active_brain"
Cohesion: 0.07
Nodes (50): allow_paid_brain(), BrainResolution, get_active_brain_sync(), get_provider_role_tags(), _host_is_openai_compatible(), invalidate_brain_cache(), _norm(), _pick_from_records() (+42 more)
...
Cohesion: 0.04
Nodes (73): FailureCategory, heal_signature(), HealingEvent, HealState, _now(), Any, Enum, str (+65 more)

### Community 27 - "test_governance_sandbox.py"
Cohesion: 0.04
Nodes (75): build_docker_run_argv(), detect_backend(), DockerBackend, E2BBackend, get_sandbox_manager(), load_profiles(), LocalBackend, Any (+67 more)

### Community 28 - "SQLiteStore"
Cohesion: 0.02
Nodes (96): CompanyGraph, KnowledgeItem, The complete Company Graph - canonical core model for the Autonomous AI Agency.…, Find a workflow by its name., Find knowledge items matching any of the given tags., Find connectors configured for a specific system., Structured knowledge about the company, systems, or processes., MongoDBStore (+88 more)

### Community 29 - "test_governance_enforcement.py"
Cohesion: 0.03
Nodes (113): ApprovalRequest, ApprovalStatus, ApprovalStore, get_approval_store(), Any, Enum, str, packages/governance/approvals.py — human-in-the-loop for high-risk actions. The… (+105 more)
...
### Community 34 - "Task"
Cohesion: 0.04
Nodes (71): Full task/issue document., Task, One-line human explanation of why this task needs human approval. Reads risk…, Best-effort label of who will run this task once approved. Returns…, PUBLIC_URL-anchored dashboard deep link for the task detail. Returns empty…, Best-effort Telegram heads-up that a task is parked awaiting approval. Inline…, asyncio, A reject + human Retry starts a NEW approval cycle → fresh notification. (+63 more)

### Community 35 - "get_db"
Cohesion: 0.03
Nodes (106): auth_me(), auto_recommend_skills(), _check_storage_health(), cost_attribution_stats(), delete_github_token(), delete_source(), discover_remote_skills(), doctor_health() (+98 more)

### Community 36 - "WorkflowPhase"
Cohesion: 0.12
...
### Community 39 - "rbac.py"
Cohesion: 0.07
Nodes (34): compute_savings(), compute_time_series(), get_savings(), get_usage(), get_user_savings(), _period_start(), Any, BaseModel (+26 more)

### Community 40 - "MultiAgentSwarm"
Cohesion: 0.05
...
### Community 41 - "test_provider_router.py"
Cohesion: 0.06
Nodes (46): extract_openai_text(), _normalize_nvidia_base_url(), _openai_url(), Normalize NVIDIA base URLs to avoid double /v1 when openai_compat_url appends…, _nvidia_provider_chain(), ProviderConfig, Build Nvidia NIM provider config from env. Empty list when key is absent., anyio (+38 more)

### Community 42 - "test_agent_tool_governance.py"
Cohesion: 0.06
...
Cohesion: 0.03
Nodes (70): Backoff policy for retryable failures., RetryConfig, BreakerState, Enum, str, packages/llm/health.py — provider health tracking and circuit breaking. Two…, Test hook — clear all health state., reset() (+62 more)
...
Cohesion: 0.04
Nodes (49): repowise.py — RepowiseIntelligence: context packing and dependency analysis., Path, tools.py — WorkspaceTools: read/write/search and diff application (risky…, Precise string replacement — F1 roadmap item (Codebuff/Claude Code-style edit).…, Return the first *lines* lines of a file. Just-in-time retrieval: the executor…, Return a lightweight index of files with line counts and sizes. This is the…, Delegate to RepowiseIntelligence for a natural-language codebase question., Delegate to RepowiseIntelligence for a semantic/text codebase search. (+41 more)

### Community 50 - "AgentScheduler"
Cohesion: 0.06
...
### Community 52 - "get_runtime_manager"
Cohesion: 0.05
...
### Community 53 - "enforcement.py"
Cohesion: 0.03
Nodes (78): guard(), identity_from_headers(), _load(), Any, mcp_server/governance.py — governance adapter for the MCP HTTP surface. Closes…, Build an AgentIdentity from the caller's ``X-Agent-*`` headers. Absent headers…, Evaluate *tool* before it runs. Returns ``(allowed, message, decision)``.…, Write the audit row for a completed (or blocked) MCP tool call. (+70 more)

### Community 54 - "test_loop_registry.py"
Cohesion: 0.05
Nodes (64): audit_drift(), _cmd_audit(), DriftReport, _grade(), load_registry(), load_registry_sync(), loop_readiness(), LoopRegistry (+56 more)

### Community 55 - "Provider"
Cohesion: 0.11
Nodes (14): NVIDIA NIM provider adapter — wraps the existing provider_router logic. This is…, Ollama provider adapter — local LLM inference., packages.ai — provider abstraction, model registry, and failover manager., packages/ai/manager.py — ProviderManager. Single entry point for all LLM calls.…, Provider, ABC, packages/ai/provider.py — Provider abstraction interface. Every LLM provider…, Base interface every provider must implement. Implementations live in… (+6 more)

### Community 56 - "RenderMCPClient"
Cohesion: 0.05
Nodes (40): agent/mcp_client.py — Async MCP client for the mcp-server Docker container.…, _as_list(), _coerce_payload(), Any, RuntimeError, packages/integrations/render_mcp.py — Render platform access over MCP. The…, One deploy, normalised from whatever shape the tool returned., Return tool output as Python data. MCP tool results arrive either as… (+32 more)

### Community 57 - "AgentJobManager"
Cohesion: 0.06
...
### Community 59 - "test_knowledge_sync.py"
Cohesion: 0.06
...
Cohesion: 0.10
Nodes (28): Count distinct sessions per user. A session ends when there's a gap of more…, _as_aware_utc(), _company_alive(), _company_id_for_agent(), _env_float(), ephemeral_reaper_loop(), datetime, services/ephemeral_reaper.py — destroy expired ephemeral companies. The… (+20 more)
...
### Community 64 - "test_unit7_catalog_propagation.py"
Cohesion: 0.05
...
### Community 65 - "test_ceo_supervision.py"
Cohesion: 0.06
...
Cohesion: 0.05
Nodes (42): build_governance_router(), Any, APIRouter, backend/governance_router.py — read and operate the governance layer. Mounted…, packages.config — single source of truth for all configuration. Every module…, packages/config/settings.py — typed configuration. This is the ONLY module in…, _audit_proposal(), _baseline_loosened() (+34 more)

### Community 67 - "ArtifactStore"
Cohesion: 0.05
Nodes (28): TestSwarmRoleRouting, TestTeamSummary, Path, tests/test_artifact_store.py — Unit tests for workflow/artifact_store.py., Verify artifacts that are stored as JSON (e.g., CheckRun results)., Writing the same (run_id, name) twice should update, not duplicate., store(), TestArtifactStoreDeletion (+20 more)

### Community 68 - "ToolRegistry"
Cohesion: 0.04
...
Cohesion: 0.05
Nodes (45): AgentRole, AgentSwarm, Any, Return the agent role responsible for *phase*., Return the AgentProfile for the agent driving *phase*., Return a JSON-serialisable summary of all agent profiles., Run a pre-gate or report phase through the correct agent. Enforces permission…, Execute a slice via the Coder agent (write-permitted). (+37 more)

### Community 73 - "ExecutionRequest"
Cohesion: 0.06
Nodes (32): Called by APScheduler when a cron fires. Dispatches to the orchestrator. This…, _scheduler_on_fire(), ExecutionRequest, Issue final pass/fail verdict., Produce a human-readable summary with evidence., Persist results to Company Graph and durable storage., Log KPIs for autonomous operation tracking., Canonical request to execute work through the golden path. This is the ONLY… (+24 more)

### Community 74 - "WorkflowRun"
Cohesion: 0.11
Nodes (22): MergeDecision, G5: resolve how a run should land from the company's DeliveryPolicy. Returns…, In-flight state for a single golden-path execution., G5: how a completed run should land, derived from the company's DeliveryPolicy.…, WorkflowRun, tests/test_orchestrator_checkpoint.py — Tests for durable checkpointing (#522)., Save, load, list, delete, and restore operations., TestOrchestratorCheckpointStore (+14 more)

### Community 75 - "CEODispatcher"
Cohesion: 0.05
Nodes (55): CEODispatcher, CEOResult, _complexity_rank(), _decompose_into_subtasks(), _offload(), Any, Semaphore, services/ceo_dispatcher.py — Real CEO delegation layer. The CEO splits a… (+47 more)

### Community 76 - "get_task_store"
Cohesion: 0.05
Nodes (73): quick_notes_submit(), _QuickNoteBody, Submit a quick-note URL or instruction from the dashboard FAB., Reset the singleton (for tests)., reset_failover_manager(), Hand the 'connect & verify the repo' work to the agency's own agents. The task…, _seed_connect_task(), _blocked_retire_age_sec() (+65 more)
...
### Community 82 - "seo_portfolio_bridge.py"
Cohesion: 0.05
...
### Community 86 - "get_workflow_orchestrator"
Cohesion: 0.05
...
### Community 87 - "test_daily_automation_2026_07_11.py"
Cohesion: 0.15
...
Cohesion: 0.06
Nodes (26): Polls Render for platform-level failures and files them as issues., RenderOpsMonitor, _client(), _FakeInner, _FakeRender, Any, asyncio, Stands in for MCPClient inside RenderMCPClient. (+18 more)
...
### Community 92 - "test_llm_router_e2e.py"
Cohesion: 0.14
...
### Community 98 - "test_startup_warmup.py"
Cohesion: 0.04
...
### Community 104 - "InternalAgentAdapter"
Cohesion: 0.05
Nodes (38): _best_cloud_primary_base(), InternalAgentAdapter, TaskResult, TaskSpec, Built-in agent loop — Nvidia NIM primary, Ollama fallback., Return runtime dependencies required by this adapter. Returns:…, Determine availability of the internal agent runtime. Checks cloud providers in…, Execute a TaskSpec using the internal AgentRunner and convert the agent's… (+30 more)
...
### Community 106 - "services/seo_audit.py"
Cohesion: 0.06
Nodes (48): Run a full SEO/GEO/AIO audit against a website and persist the evidence., run_seo_audit(), field_validator, A single occurrence of a check firing on a specific URL., Aggregated report row - Screaming Frog CSV compatible., Site-level facts discovered during the crawl., Request to run an SEO/GEO/AIO audit against a website., SeoAuditRequest (+40 more)

### Community 107 - "test_workflow_models.py"
Cohesion: 0.13
...
### Community 108 - "test_sam_voice.py"
Cohesion: 0.05
...
### Community 109 - "TestHarnessAdapter"
Cohesion: 0.05
...
### Community 111 - "telegram_bot.py"
Cohesion: 0.08
Nodes (48): all_provider_ids(), _provider_ids_from_literal(), Return every provider id recognised by the brain config system. Iterates the…, Return the provider ids allowed by the ``BrainProvider`` Literal. Reads the…, Return a Markdown-v1-safe preview string under ``max_chars``. Used by the…, sanitize_paste_for_preview(), _admin_headers(), _api_headers() (+40 more)
...
Cohesion: 0.05
Nodes (65): _make_engine(), tests/test_crispy_workflow.py — CRISPY workflow engine hardening tests. Tests…, Provide isolated DB + artifact + workspace paths., Create a WorkflowEngine with isolated storage., TestAbortOnFailure, TestPhaseSequence, TestPhaseSequenceError, TestWorkspaceIsolation (+57 more)

### Community 115 - "BrowserSession"
Cohesion: 0.06
...
### Community 119 - "redact_connection_url"
Cohesion: 0.17
...
Cohesion: 0.06
Nodes (34): _acquire_provider_probe(), CommercialFallbackRequiredError, _dead_model_key(), _exponential_backoff_cooldown(), _get_director(), _mark_model_dead(), _normalized_provider_type(), _notify_watchdog() (+26 more)

### Community 125 - "UserRole"
Cohesion: 0.06
Nodes (58): UserRole, _can_read(), _can_write(), create_secret(), _decrypt(), delete_secret(), _encrypt(), _get_master_key() (+50 more)

### Community 126 - "BackgroundAgent"
Cohesion: 0.06
Nodes (44): BackgroundAgent, BackgroundTask, _now(), Any, agent/background.py — Background Agent An always-on worker thread that…, Enqueue *task* for processing. Returns the task (with task_id set)., Convenience: create a task and submit it in one call., Real handler — dispatches through AgentRunner when available. HARDENED (PR… (+36 more)
...
### Community 133 - "test_web_reach.py"
Cohesion: 0.09
...
### Community 135 - "failover_client.py"
Cohesion: 0.04
Nodes (57): _auto_disable(), _build_request(), _describe_registry(), _disable_unless_key_serves_other_models(), _disabled_ids(), _is_billing_refusal(), _is_ollama(), _key_pool() (+49 more)
...
### Community 139 - "portfolio_intelligence.py"
Cohesion: 0.06
Nodes (47): generate_backlog_retro(), generate_standup(), Agentic Agile — autonomous ceremonies (standup, retro, sprint planning). Where…, Derive a retrospective from the task tracker when no sprint is active. DONE /…, A daily standup digest derived from the task tracker. ``sprint_health`` is…, Build a :class:`StandupReport` from ``.claude/state/active-tasks.md``. Reads…, StandupReport, InitiativeStatus (+39 more)

### Community 140 - "test_render_mcp.py"
Cohesion: 0.07
...
### Community 142 - "AgentSessionStore"
Cohesion: 0.10
...
### Community 144 - "test_direct_chat_evolution.py"
Cohesion: 0.10
...
### Community 145 - "seo_api.py"
Cohesion: 0.05
Nodes (54): build_seo_roadmap(), delegate_seo_findings(), list_seo_audits(), plan_seo_sprint(), BaseModel, post, SEO / GEO / AIO Audit API Router Endpoints for the world-class SEO audit engine…, List stored audits for this company (most recent first). (+46 more)

### Community 146 - "test_runtime_governance.py"
Cohesion: 0.11
...
### Community 151 - "test_backend_server_features.py"
Cohesion: 0.06
...
### Community 164 - "get_tool_annotations"
Cohesion: 0.08
...
### Community 167 - "ProvidersScreen.jsx"
Cohesion: 0.05
...
### Community 179 - "OllamaCircuitBreaker"
Cohesion: 0.08
...
### Community 181 - "PromptCacheManager"
Cohesion: 0.06
...
### Community 186 - "test_ceo_router.py"
Cohesion: 0.07
...
### Community 189 - "_get_provider_policy"
Cohesion: 0.07
...
### Community 190 - "test_colibri_brain_shim.py"
Cohesion: 0.05
Nodes (62): get_brain_preference(), Return the operator's brain provider preference. Values: - ``"nvidia"`` —…, colibri_enabled(), colibri_provider_config(), colibri_status(), ProviderConfig, providers/colibri.py — Free local GLM-5.2 brain served by JustVugg/colibri.…, Return True iff the operator opted in via ``COLIBRI_ENABLED=true``. (+54 more)

### Community 191 - "call_llm"
Cohesion: 0.08
...
### Community 193 - "TestModelRegistryUpdates"
Cohesion: 0.14
...
### Community 197 - "activation_api.py"
Cohesion: 0.10
...
### Community 203 - "BrainWatchdog"
Cohesion: 0.05
Nodes (43): get_brain_config_store(), Return the process-wide ``BrainConfigStore`` singleton., Any, packages/ai/self_heal.py — automatic brain self-healing. When the active brain…, Background tick that runs self_heal_brain_and_unblock_tasks(). Called from the…, One-shot self-healing pass. 1. Checks if the active brain provider is in a…, self_heal_brain_and_unblock_tasks(), _self_heal_tick() (+35 more)

### Community 204 - "test_platform_controls.py"
Cohesion: 0.08
...
### Community 206 - "render_ops.py"
Cohesion: 0.08
Nodes (22): _latest_metric_value(), _parse_timestamp(), Any, datetime, services/render_ops.py — autonomous Render debugging + environment monitoring.…, Parse an RFC3339 timestamp from Render, tolerating a trailing ``Z``., Pull the most recent numeric sample out of a ``get_metrics`` payload. Render…, Snapshot for ``/api/render/ops/status`` and the dashboard. ``self_heal_ready``… (+14 more)

### Community 207 - "_resolve_brain_provider"
Cohesion: 0.06
...
### Community 214 - "resolve_component_model"
Cohesion: 0.07
...
Cohesion: 0.08
Nodes (36): Issue title: the failure mode plus how hard it is recurring., fetch_research_alerts(), Best-effort fetch of trend alerts. Returns [] if offline or unavailable., map_initiative_to_task(), materialize_committed(), _portfolio_materialize_enabled(), portfolio_source_id(), Any (+28 more)

### Community 216 - "ProviderRouter"
Cohesion: 0.07
Nodes (26): ProviderRouter, Priority-ordered LLM provider fallback with health checks and retries., main(), probe_one(), ProviderRouter, _bedrock_api_response(), _bedrock_provider(), _mock_boto3() (+18 more)

### Community 217 - "operational_incidents.py"
Cohesion: 0.11
...
### Community 218 - "Agent Readiness Report"
Cohesion: 0.20
...
### Community 219 - "get_report"
Cohesion: 0.17
Nodes (15): _expire_stale_pending_report(), get_seo_audit(), Fetch a complete stored audit report. Side-effect: an audit whose stub is still…, Auto-fail a pending SEO audit stub that is older than…, get_report(), Store a report in the bounded in-memory registry., Fetch a stored report by id., save_report() (+7 more)
...
### Community 223 - "compare_runtimes.py"
Cohesion: 0.07
...
### Community 224 - "test_trend_watcher.py"
Cohesion: 0.08
...
### Community 225 - "control_overrides.py"
Cohesion: 0.12
...
### Community 232 - "TestEstimateTokensForMessages"
Cohesion: 0.05
...
### Community 233 - "test_governance_api.py"
Cohesion: 0.05
Nodes (51): AuditEvent, packages/governance/audit.py — the evidence trail for every governed action.…, Redact secret-shaped substrings, then truncate., One governed action, fully described. Field order follows the…, One-line JSON, suitable for a SIEM shipper tailing the log., _scrub_inner(), _scrub_text(), _truncate() (+43 more)

### Community 234 - "RewardScorer"
Cohesion: 0.08
...
### Community 236 - "PatternConsolidation"
Cohesion: 0.08
...
### Community 237 - "get_failover_manager"
Cohesion: 0.07
...
### Community 238 - "test_pr923_fixes.py"
Cohesion: 0.07
...
### Community 242 - "validate_outbound_url"
Cohesion: 0.14
...
### Community 251 - "[Unreleased]"
Cohesion: 0.06
Nodes (36): Added, Added, Added, Added, Added, Added, Added, Added (+28 more)

### Community 252 - "REWRITE_PLAN.md — Phased Migration Strategy"
Cohesion: 0.06
...
### Community 253 - "test_background_services.py"
Cohesion: 0.08
...
### Community 254 - "test_all_providers_discovery.py"
Cohesion: 0.16
...
### Community 257 - "test_persistent_memory.py"
Cohesion: 0.06
...
### Community 259 - "configuration-reference.md"
Cohesion: 0.07
...
### Community 260 - "model_discovery.py"
Cohesion: 0.13
...
### Community 261 - "RateLimitTracker"
Cohesion: 0.10
...
### Community 262 - "control_registry.py"
Cohesion: 0.14
...
### Community 264 - "test_anthropic_router.py"
Cohesion: 0.09
...
### Community 270 - "types.py"
Cohesion: 0.03
Nodes (95): Attempt, packages/llm — the multi-provider LLM routing layer. Every LLM call in this…, Read the environment variables named in ``env_names`` into a key list. Order is…, resolve_keys(), packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, classify_error(), LLMProvider, OpenAICompatible (+87 more)

### Community 271 - "JCodeAdapter"
Cohesion: 0.10
Nodes (11): JCodeAdapter, Any, Path, TaskResult, TaskSpec, Write .jcode/mcp.json in the workspace, pointing at our proxy's MCP endpoint.…, Resolve the default executor model via the catalog (UNIT 7). Was hardcoded to…, Adapter for jcode — TIER 2 high-performance Rust coding agent. (+3 more)

### Community 272 - "local_controller.py"
Cohesion: 0.12
...
### Community 273 - "test_brain_failover.py"
Cohesion: 0.10
...
### Community 274 - "test_live_server.py"
Cohesion: 0.22
...
### Community 276 - "ContextCompressor"
Cohesion: 0.11
...
### Community 279 - "ResourceWatchdog"
Cohesion: 0.10
...
### Community 281 - "test_daily_2026_06_04.py"
Cohesion: 0.10
...
### Community 282 - "provider_max_rpm"
Cohesion: 0.08
...
### Community 284 - "test_kimi_bridge_server.py"
Cohesion: 0.05
...
### Community 285 - "skill_bindings.py"
Cohesion: 0.08
Nodes (33): Run an audit from synchronous code, loop-safe. Used by the skill-bindings…, run_audit_sync(), _execute_skill_impl(), _get_portfolio_manager(), Any, Enum, str, services/skill_bindings.py — Runtime Skill Bindings for Specialist Agents Wires… (+25 more)

### Community 286 - "test_microagents.py"
Cohesion: 0.15
...
### Community 288 - "Security Analysis — local-llm-server"
Cohesion: 0.06
...
### Community 292 - "test_brain_availability_doctor.py"
Cohesion: 0.11
...
### Community 294 - "OrchestratorQueue"
Cohesion: 0.07
...
### Community 296 - "test_nvidia_model_discovery.py"
Cohesion: 0.06
...
### Community 297 - "test_workspace_isolation.py"
Cohesion: 0.16
...
### Community 300 - "Initiative"
Cohesion: 0.09
Nodes (13): Initiative, Create and register a new initiative, returning it., Add a pre-built Initiative (e.g. from the intelligence layer)., Look up an initiative by ID., A portfolio initiative (epic) prioritised via WSJF. WSJF (Weighted Shortest Job…, Aggregate cost of delay (CoD) used as the WSJF numerator., Weighted Shortest Job First score — higher schedules sooner., Associate an agile sprint that delivers part of this initiative. (+5 more)

### Community 301 - "High-Agency Frontend Skill"
Cohesion: 0.06
Nodes (30): 10. FINAL PRE-FLIGHT CHECK, 1. ACTIVE BASELINE CONFIGURATION, 2. DEFAULT ARCHITECTURE & CONVENTIONS, 3. DESIGN ENGINEERING DIRECTIVES (Bias Correction), 4. CREATIVE PROACTIVITY (Anti-Slop Implementation), 5. PERFORMANCE GUARDRAILS, 6. TECHNICAL REFERENCE (Dial Definitions), 7. AI TELLS (Forbidden Patterns) (+22 more)

### Community 302 - "TestNormalizeResponseFormat"
Cohesion: 0.08
...
### Community 303 - "Quick-Note GitHub Issues Processing - Session Summary"
Cohesion: 0.06
...
### Community 304 - "test_rate_limiter.py"
Cohesion: 0.09
...
### Community 305 - "test_mcp_governance.py"
Cohesion: 0.11
...
### Community 307 - "test_portfolio_intelligence.py"
Cohesion: 0.06
...
### Community 311 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 312 - "output_filter.py"
Cohesion: 0.07
...
### Community 313 - "RuntimeHealthService"
Cohesion: 0.09
...
### Community 316 - "models/company_graph.py"
Cohesion: 0.02
Nodes (134): ApprovalPolicy, BusinessSystem, Company, CompanyCreateRequest, CompanyGraphSnapshot, CompanyUpdateRequest, Connector, DetectedSystem (+126 more)

### Community 317 - "TestRecordUsageAndStats"
Cohesion: 0.05
...
### Community 318 - "test_force_cleanup_conditional_delete.py"
Cohesion: 0.10
...
### Community 319 - "test_one_model_catalogue.py"
Cohesion: 0.14
...
### Community 320 - "test_rag_context.py"
Cohesion: 0.12
...
### Community 321 - "ProjectScaffolder"
Cohesion: 0.13
...
### Community 322 - "_resolve_user_github_token"
Cohesion: 0.12
...
### Community 323 - "lifespan"
Cohesion: 0.07
Nodes (21): _keepalive_self_ping(), lifespan(), Run the FreeBuff Telegram bot, restarting it on unexpected exit., Ping our own public URL so a free-tier web service doesn't sleep. Render free…, Start the Telegram bot (and keep-alive) inside the web process when enabled.…, #522 + #505: Reliability startup — schedule hydration, orchestrator restore,…, _start_in_web_bot_tasks(), _startup_reliability_hooks() (+13 more)

### Community 324 - "SteeringInjector"
Cohesion: 0.11
...
### Community 325 - "test_claude_setup_audit.py"
Cohesion: 0.16
...
### Community 326 - "get_company_graph_store"
Cohesion: 0.05
Nodes (60): autonomy_status(), Public autonomy readiness probe — no authentication required. A live deploy…, Fire-and-forget self-bootstrap; never blocks or crashes startup., _schedule_self_bootstrap(), CompanyAgencyService, get_company_agency_service(), _is_runtime_available_sync(), _pick_available_runtime() (+52 more)
...
### Community 329 - "Python Dependencies (`requirements.txt`)"
Cohesion: 0.07
...
### Community 330 - "Technical Debt Register — local-llm-server"
Cohesion: 0.07
...
### Community 331 - "report_to_markdown"
Cohesion: 0.11
...
### Community 333 - "SetupWizardPage.js"
Cohesion: 0.10
...
### Community 334 - "ProviderConsole.jsx"
Cohesion: 0.08
...
### Community 337 - "parse_event_stream"
Cohesion: 0.09
...
### Community 338 - "RuntimeCapabilityRegistry"
Cohesion: 0.03
Nodes (42): Any, RoutingDecision, TaskResult, TaskSpec, Return health status for all registered runtimes., Return routing decision audit log (newest first)., Actively wake every sleeping/circuit-open runtime. The default health service…, True if the runtime is healthy enough for the router to select it. (+34 more)
...
### Community 340 - "brain_failover.py"
Cohesion: 0.06
...
### Community 342 - "test_agent_scripts_share_one_model_list.py"
Cohesion: 0.10
...
### Community 343 - "test_crispy_burn_in.py"
Cohesion: 0.07
...
### Community 344 - "test_failover_silent_exhaustion.py"
Cohesion: 0.11
...
### Community 349 - "_valid_login_state"
Cohesion: 0.24
...
### Community 350 - "CompanyGraphStore"
Cohesion: 0.03
Nodes (37): Find a repository by its URL., A company repository with detected technologies and metadata., Extract the owner from the full name., Extract the repository name from the full name., Repo, requires_db, Add a repository to a company. Args: company_id: Company ID url: Repository URL…, Initialize the service. Args: store: Optional CompanyGraphStore instance. If… (+29 more)

### Community 351 - "Deploy: FreeBuff Telegram bot (24×7)"
Cohesion: 0.07
...
### Community 352 - "Claude Code + Qwen Local Setup"
Cohesion: 0.07
...
### Community 353 - "test_north_mini_code.py"
Cohesion: 0.08
...
### Community 355 - "session_retro.py"
Cohesion: 0.13
...
### Community 358 - "test_nvidia_default_model.py"
Cohesion: 0.17
...
### Community 363 - "Performance Analysis — local-llm-server"
Cohesion: 0.08
...
### Community 364 - "SeoCheckDefinition"
Cohesion: 0.11
...
### Community 365 - "ProviderConfig"
Cohesion: 0.06
Nodes (46): build_tool_calling_router(), Return a router limited to providers that pass ``tools`` through intact. The…, is_commercial_provider(), provider_access_tier(), _provider_field(), provider_sort_key(), ProviderConfig, local_brain_enabled() (+38 more)

### Community 366 - "LLM Router — troubleshooting"
Cohesion: 0.08
...
### Community 370 - "test_telegram_approval_e2e.py"
Cohesion: 0.12
...
### Community 371 - "test_brain_migration_writes_a_live_model.py"
Cohesion: 0.10
...
### Community 372 - "test_daily_automation_2026_08_03.py"
Cohesion: 0.11
...
### Community 373 - "test_provider_enable_disable.py"
Cohesion: 0.09
...
### Community 374 - "test_telegram_mutating_commands.py"
Cohesion: 0.08
...
### Community 378 - "test_dashboard_cache.py"
Cohesion: 0.13
Nodes (18): _cached(), _fast_count(), get_activity(), legacy_scheduler_list(), Single-flight TTL cache. Concurrent callers wait for the first producer., Count without materialising rows — prefers estimated_document_count., _clear_cache(), _CollWithEstimate (+10 more)

### Community 379 - "1. The Rules"
Cohesion: 0.05
...
### Community 381 - "Session Handoff — 2026-06-15"
Cohesion: 0.08
...
### Community 382 - "TASK 4 — End-to-end approval-gate test"
Cohesion: 0.08
...
### Community 383 - "generate_context.py"
Cohesion: 0.13
...
### Community 384 - "test_direct_chat_async.py"
Cohesion: 0.15
...
### Community 387 - "TemporalContextGraph"
Cohesion: 0.10
...
### Community 388 - "asyncio"
Cohesion: 0.08
Nodes (18): asyncio, Test Company Graph services., Test that storage service can be initialized., Test company CRUD operations - skipped as requires specific config., Test specialist service., Test that specialist service can be initialized., Test onboarding service., Test that onboarding service can be initialized. (+10 more)
...
### Community 390 - "TestClassifyPlainText"
Cohesion: 0.08
...
### Community 391 - "test_service_token.py"
Cohesion: 0.08
...
### Community 401 - "implement_agent.py"
Cohesion: 0.12
...
### Community 404 - "Native operations"
Cohesion: 0.09
...
### Community 406 - "test_regression.py"
Cohesion: 0.12
...
### Community 407 - "test_agency_fix.py"
Cohesion: 0.08
...
### Community 410 - "_status_snapshot"
Cohesion: 0.15
...
### Community 411 - "Agent Governance Guide"
Cohesion: 0.09
...
### Community 412 - "The fifteen strategies"
Cohesion: 0.09
...
### Community 417 - "WindowsServiceManager"
Cohesion: 0.18
...
### Community 421 - "test_cerebras_catalogue.py"
Cohesion: 0.13
...
### Community 422 - "test_monitor_lib.py"
Cohesion: 0.11
...
### Community 424 - "test_mostly_failed_steps.py"
Cohesion: 0.12
...
### Community 427 - "HarnessEnrichment"
Cohesion: 0.14
...
### Community 428 - "classify_direct_chat_intent"
Cohesion: 0.13
...
### Community 436 - "get_ceo_dispatcher"
Cohesion: 0.11
...
### Community 440 - "OrchestratorCheckpointStore"
Cohesion: 0.13
...
### Community 447 - "test_chat_mode_regressions.py"
Cohesion: 0.18
...
### Community 448 - "system_instruction"
Cohesion: 0.16
...
### Community 451 - "test_brain_failover_413.py"
Cohesion: 0.13
...
### Community 453 - "test_webui_provider_priority.py"
Cohesion: 0.21
...
### Community 454 - "test_local_controller.py"
Cohesion: 0.17
...
### Community 455 - "test_provider_state_durability.py"
Cohesion: 0.04
...
### Community 456 - "run_trend_analysis"
Cohesion: 0.18
...
### Community 457 - "test_unit5_ui_provider_surface.py"
Cohesion: 0.10
...
### Community 459 - "PersistentMemoryStore"
Cohesion: 0.24
...
### Community 460 - "Skill: modularity-review"
Cohesion: 0.10
...
### Community 461 - "Design Audit"
Cohesion: 0.10
Nodes (19): Code Quality, Color and Surfaces, Component Patterns, Content, Design Audit, Fix Priority, How This Works, Iconography (+11 more)

### Community 462 - "Findings"
Cohesion: 0.10
...
### Community 466 - "Docker AI Governance Audit — Final Report"
Cohesion: 0.10
...
### Community 467 - "1. Capability-by-capability"
Cohesion: 0.10
...
### Community 469 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 470 - "FeatureUnavailableError"
Cohesion: 0.13
...
### Community 471 - "KnowledgeScreen.jsx"
Cohesion: 0.13
...
### Community 475 - "_is_bedrock_model_id"
Cohesion: 0.27
...
### Community 484 - "test_tasks_cache_ttl_env.py"
Cohesion: 0.21
...
### Community 485 - "test_voice_pipeline.py"
Cohesion: 0.14
...
### Community 488 - "_extract_tech_relevance"
Cohesion: 0.17
...
### Community 489 - "test_ai_insights.py"
Cohesion: 0.04
...
### Community 492 - "Analysis & Synthesis Instructions"
Cohesion: 0.11
Nodes (18): 1. Define the Atmosphere, 2. Map the Color Palette, 3. Establish Typography Rules, 4. Define the Hero Section, 5. Describe Component Stylings, 6. Define Layout Principles, 7. Define Responsive Rules, 8. Encode Motion Philosophy (+10 more)

### Community 493 - "Production Readiness Assessment — local-llm-server"
Cohesion: 0.11
...
### Community 496 - "Admin Dashboard Guide"
Cohesion: 0.11
...
### Community 497 - "Implementation Plan"
Cohesion: 0.11
...
### Community 505 - "test_task_source_id_race.py"
Cohesion: 0.17
...
### Community 506 - "test_brain_patch_service_token.py"
Cohesion: 0.18
...
### Community 507 - "TestSelfHealingInfrastructureClassification"
Cohesion: 0.19
...
### Community 508 - "test_fabric_patterns.py"
Cohesion: 0.11
...
### Community 510 - "validate_session_id"
Cohesion: 0.16
...
### Community 511 - "open_phase_report"
Cohesion: 0.13
...
### Community 512 - "ErrorInterceptorMiddleware"
Cohesion: 0.18
...
### Community 514 - "model_router.py"
Cohesion: 0.06
Nodes (35): Dynamic model router package. Public API:: from router import get_router,…, _build_builtin_model_map(), _default_model(), _default_reasoning_model(), ModelRouter, _nvidia_key_present(), Any, Dynamic model router. Central routing logic for all chat and agent requests.… (+27 more)

### Community 515 - "TaskHarnessAdapter"
Cohesion: 0.12
...
### Community 516 - "test_tasks_awaiting_approval_api.py"
Cohesion: 0.37
...
### Community 517 - "Comprehensive Skill Index (By Category)"
Cohesion: 0.11
...
### Community 518 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 519 - "Component Map"
Cohesion: 0.11
...
### Community 520 - "Architecture Overview — local-llm-server"
Cohesion: 0.11
...
### Community 521 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
...
### Community 523 - "Part A — Health Report"
Cohesion: 0.11
...
### Community 530 - "test_langfuse_agency_wide.py"
Cohesion: 0.12
...
### Community 531 - "TestStopSlopChecker"
Cohesion: 0.11
...
### Community 532 - "test_self_heal.py"
Cohesion: 0.11
...
### Community 533 - "handle_workflow_ide_chat"
Cohesion: 0.18
...
### Community 541 - "Section-by-Section Acceptance Criteria"
Cohesion: 0.12
...
### Community 543 - "SkillsScreen.jsx"
Cohesion: 0.12
...
### Community 544 - "kimi_bridge_provider_config"
Cohesion: 0.18
...
### Community 545 - "agent_readiness_audit.py"
Cohesion: 0.21
...
### Community 548 - "TestAListingFailureDoesNotVetoTheAnswer"
Cohesion: 0.17
...
### Community 549 - "test_frontend_deployment_guards.py"
Cohesion: 0.18
...
### Community 550 - "test_health_endpoints.py"
Cohesion: 0.17
...
### Community 551 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 552 - "test_openclaw_endpoints.py"
Cohesion: 0.12
...
### Community 556 - "hermes_prompt.py"
Cohesion: 0.19
...
### Community 558 - "MemoryMiddleware"
Cohesion: 0.17
...
### Community 560 - "Skill: repowise-intelligence"
Cohesion: 0.12
...
### Community 561 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
...
### Community 562 - "Skill: repowise-intelligence"
Cohesion: 0.12
Nodes (15): 1. Graph Intelligence (Dependency Graph), 2. Git Intelligence, 3. Documentation Intelligence, 4. Decision Intelligence, Acceptance Checks, Directory Structure, Example Usage, Implementation Approach (+7 more)

### Community 563 - "The 10-Step Workflow"
Cohesion: 0.12
...
### Community 564 - "Contributing to local-llm-server"
Cohesion: 0.12
...
### Community 565 - "refresh_agent_built_proof.py"
Cohesion: 0.20
...
### Community 566 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 567 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 568 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
...
### Community 569 - "TestBrainFailoverModelUpdates"
Cohesion: 0.18
...
### Community 572 - "resolve_free_nvidia_brain"
Cohesion: 0.12
...
### Community 576 - "telegram_inbound_handlers.py"
Cohesion: 0.13
...
### Community 577 - "ManagedAgentDreams"
Cohesion: 0.22
...
### Community 578 - "_process_task_callback"
Cohesion: 0.17
Nodes (21): _answer_callback(), _edit_message(), _process_task_callback(), _process_wfo_callback(), Handle Approve/Reject inline-button presses for task execution gates. Callback…, Handle an inline Approve/Reject button on a WorkflowOrchestrator approval-gate…, Edit an existing message's text and (optionally) its inline keyboard. Best-…, Acknowledge a callback query so Telegram stops the button's loading spinner.… (+13 more)

### Community 579 - "test_agency_workflows_carry_the_failover_chain.py"
Cohesion: 0.18
...
### Community 580 - "test_autonomy_status.py"
Cohesion: 0.12
...
### Community 581 - "test_claude_code_adapter.py"
Cohesion: 0.14
...
### Community 582 - "test_dockerfile_ships_root_modules.py"
Cohesion: 0.17
...
### Community 583 - "test_local_brain_state.py"
Cohesion: 0.12
...
### Community 585 - "test_phase5_doctor.py"
Cohesion: 0.07
Nodes (20): Request, FastAPI dependency: require any authenticated user., require_authenticated(), client(), _coding_brain_check(), tests/test_doctor_coding_brain.py Surfaces the North Mini Code coding-brain…, With NORTH_MINI_CODE_DEFAULT off, the check warns and says so., test_coding_brain_check_reflects_flag_off() (+12 more)

### Community 586 - "TestStreamableHTTPTransport"
Cohesion: 0.13
...
### Community 587 - "test_refresh_agent_built_proof.py"
Cohesion: 0.12
...
### Community 588 - "test_telegram_diag_endpoint.py"
Cohesion: 0.12
...
### Community 592 - "CollaborationContext"
Cohesion: 0.11
...
### Community 593 - "Skill: agent-harness"
Cohesion: 0.13
...
### Community 594 - "Skill: checkpoint-strategy"
Cohesion: 0.13
...
### Community 596 - "Skill: local-ai-query"
Cohesion: 0.13
...
### Community 597 - "Skill: parallel-agents"
Cohesion: 0.13
...
### Community 598 - "Skill: parallel-worktrees"
Cohesion: 0.13
...
### Community 599 - "Design System: Taste Standard"
Cohesion: 0.13
...
### Community 601 - "Skill: user-research"
Cohesion: 0.13
...
### Community 602 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 603 - "Attention Mechanisms Internals"
Cohesion: 0.13
...
### Community 606 - "test_provider_410_per_model.py"
Cohesion: 0.18
...
### Community 607 - "_push_down_where"
Cohesion: 0.14
...
### Community 608 - "router/health.py"
Cohesion: 0.20
...
### Community 609 - "AdminDigestRouterAuthTests"
Cohesion: 0.22
...
### Community 610 - "clear_wizard_state_cache"
Cohesion: 0.21
...
### Community 614 - "DecisionsStoreTests"
Cohesion: 0.13
...
### Community 615 - "test_dockerfile_ships_config_dir.py"
Cohesion: 0.14
...
### Community 620 - "agile_sprints.py"
Cohesion: 0.16
...
### Community 623 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 627 - "Checks Performed"
Cohesion: 0.14
...
### Community 628 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 630 - "Skill: branch-cleanup"
Cohesion: 0.14
...
### Community 631 - "Skill: perplexity — Web Research via Perplexity API"
Cohesion: 0.14
...
### Community 634 - "Nothing is blocked on an agent. Two things need a human."
Cohesion: 0.13
Nodes (14): 0. NVIDIA models — resolved, with one measurement still missing, 0b. `nvidia/nemotron-3-ultra-550b-a55b` — RESOLVED, restored to the rotation, 0c. The daily `Update repo with latest details` routine needs one edit from you, 1. Render is suspended for billing — this is the big one, 2. `anthropic >=1.0.0` — resolved, and the premise was wrong, 3. The loop overrode its own recorded REJECT, inside a single pull request, 4. The backlog is at zero, and the gates that let bad work through are closed, 5. The catalogue probe was letting a refused listing veto the answering (+6 more)

### Community 635 - "Quick-Note Issues Processing Summary"
Cohesion: 0.14
...
### Community 637 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 639 - "Render MCP — autonomous platform debugging and environment monitoring"
Cohesion: 0.14
...
### Community 640 - "Runbook: Auto-Resume After Cooldown / Interruption"
Cohesion: 0.14
...
### Community 641 - "SEO / GEO / AIO Audit Engine"
Cohesion: 0.14
...
### Community 645 - "test_agent_chat_integration.py"
Cohesion: 0.23
...
### Community 646 - "_parse_reset_epoch"
Cohesion: 0.21
...
### Community 647 - "extract_failures"
Cohesion: 0.21
...
### Community 650 - "test_task_clarification.py"
Cohesion: 0.17
...
### Community 651 - "test_critical_flows.py"
Cohesion: 0.29
...
### Community 652 - "TestAnthropicToolListCaching"
Cohesion: 0.34
...
### Community 653 - "test_openclaw_gateway.py"
Cohesion: 0.14
...
### Community 654 - "test_llm_router_tpm.py"
Cohesion: 0.20
Nodes (15): _big_request(), _ok(), A per-minute token budget is an input ceiling, not just a sort key. Reproduces…, A conversation comfortably past the metered provider's per-minute budget.…, A 131k window behind a 4k budget is a 4k ceiling., Routing around the low ceiling beats compressing to fit it., Production's case: every reachable provider has a low ceiling. Nothing can be…, No compression tax on requests that already fit. (+7 more)

### Community 655 - "platform_controls_router.py"
Cohesion: 0.10
...
### Community 656 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 657 - "get_skill_bindings"
Cohesion: 0.10
...
### Community 658 - "nvidia_models.py"
Cohesion: 0.20
Nodes (13): _fetch_models_json(), _is_chat_model(), live_model_ids(), _rank_key(), rank_models(), Shared NVIDIA NIM model source for the autonomous agent scripts. This module…, The ids a caller should try, in order. Memoised: the agent loop asks once per…, Drop the memoised result. For tests. (+5 more)
...
### Community 660 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 663 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 664 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 667 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
...
### Community 668 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 669 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 671 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 675 - "Instructions"
Cohesion: 0.15
Nodes (12): Acceptance Checks, Instructions, Role 1: Security Reviewer, Role 2: Correctness Reviewer, Role 3: Performance Reviewer, Role 4: Maintainability Reviewer, Skill: council-review, Step 1 — Gather the diff (+4 more)

### Community 676 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
Nodes (12): Acceptance Checks, Claude's query protocol (use this instead of Read tool for exploration):, Graph Artifacts — What to Commit, How to Use the Graph (Token Savings Protocol), Installation (one-time per machine), Instead of reading raw files:, Key commands:, Relationship to repowise-intelligence Skill (+4 more)

### Community 677 - "Skill: platform-setup — Autonomous Agency Bootstrap"
Cohesion: 0.15
...
### Community 678 - "Device compatibility and model picks"
Cohesion: 0.15
...
### Community 679 - "Autonomy Uplift — Living Roadmap & Detailed Implementation Specs"
Cohesion: 0.15
...
### Community 683 - "apply_review.py"
Cohesion: 0.15
Nodes (12): ApplyReviewAgent, build_review_context(), _gh(), main(), _openai_tools_to_anthropic(), Convert OpenAI function-calling tool schemas to Anthropic tool schemas., Return (result_text, should_stop)., Run using NVIDIA NIM (OpenAI-compatible). Called as fallback. (+4 more)

### Community 684 - "_Budget"
Cohesion: 0.15
...
### Community 687 - "Agent Transparency Report"
Cohesion: 0.15
...
### Community 688 - "update_provider_policy"
Cohesion: 0.19
...
### Community 690 - "_InMemoryBackend"
Cohesion: 0.18
...
### Community 692 - "test_autonomy_pipeline_regressions.py"
Cohesion: 0.15
...
### Community 693 - "TestModelCostTableUpdates"
Cohesion: 0.26
...
### Community 695 - "TestDecisionsBotLinks"
Cohesion: 0.21
...
### Community 696 - "test_deploy_trigger_covers_image.py"
Cohesion: 0.21
...
### Community 697 - "tests/conftest.py"
Cohesion: 0.05
...
### Community 699 - "test_quick_note_engine.py"
Cohesion: 0.17
...
### Community 700 - "TestRouterIntegration"
Cohesion: 0.31
...
### Community 702 - "WorkspaceManifest"
Cohesion: 0.17
...
### Community 710 - "Skill: system-prompt-audit"
Cohesion: 0.17
...
### Community 711 - "Skill: task-alive-updates"
Cohesion: 0.17
...
### Community 714 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 717 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 719 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 720 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 721 - "Workspace Isolation Architecture"
Cohesion: 0.17
...
### Community 722 - "Quantization Internals"
Cohesion: 0.17
...
### Community 723 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 724 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 725 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 729 - "install-agents.sh"
Cohesion: 0.39
...
### Community 730 - "check_container_posture.py"
Cohesion: 0.26
...
### Community 731 - "test_pytest_failure_parser.py"
Cohesion: 0.23
...
### Community 732 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 733 - "test_admin_local_brain_router.py"
Cohesion: 0.29
...
### Community 734 - "test_agile_api.py"
Cohesion: 0.17
...
### Community 735 - "test_app_settings.py"
Cohesion: 0.21
...
### Community 736 - "test_brain_default_consistency.py"
Cohesion: 0.24
...
### Community 737 - "DockerAgentAdapter"
Cohesion: 0.17
...
### Community 738 - "TestCatalogClaude5Models"
Cohesion: 0.10
...
### Community 742 - "TestMCPToolsListCache"
Cohesion: 0.19
...
### Community 743 - "TestAnthropicPayloadStructuredOutput"
Cohesion: 0.29
...
### Community 747 - "_extractive_compress"
Cohesion: 0.18
...
### Community 749 - "TestTheGatewayRegistryOffersOnlyLiveModels"
Cohesion: 0.22
...
### Community 751 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 754 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 755 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 757 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 760 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 761 - "Main proxy (`proxy.py`)"
Cohesion: 0.18
...
### Community 762 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 763 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 764 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 765 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 766 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 767 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 768 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 770 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 771 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 772 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 773 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 774 - "What to clean up"
Cohesion: 0.18
...
### Community 775 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 783 - "test_conftest_hermetic_env.py"
Cohesion: 0.18
...
### Community 784 - "TestAgentRunnerSafety"
Cohesion: 0.24
...
### Community 785 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 786 - "brain_config.py"
Cohesion: 0.05
Nodes (44): _brain_provider_status(), get_brain_policy_route(), Return per-provider metadata for the GET endpoint. Iterates every provider in…, Return the active brain config + per-provider key-present flags. The response…, _active_primary_provider(), is_north_mini_code_default(), provider_api_key(), provider_base_url() (+36 more)

### Community 787 - "plan_next_sprint"
Cohesion: 0.17
...
### Community 790 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 791 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 792 - "admin_local_brain_router.py"
Cohesion: 0.22
...
### Community 793 - "flesch_reading_ease"
Cohesion: 0.20
...
### Community 794 - "_normalize_tool_choice"
Cohesion: 0.31
...
### Community 795 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 796 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 797 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 798 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 799 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 800 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 801 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 803 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 804 - "LLM Router — configuration guide"
Cohesion: 0.20
...
### Community 805 - "LLM Router — provider guide"
Cohesion: 0.20
...
### Community 806 - "CI Troubleshooting Runbook"
Cohesion: 0.20
...
### Community 814 - "test_providers_live_e2e.py"
Cohesion: 0.27
...
### Community 816 - "TestZeroAttemptDiagnostics"
Cohesion: 0.29
...
### Community 817 - "TestPoliciesGovernanceStableClaim"
Cohesion: 0.20
...
### Community 818 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 825 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 826 - "Skill: changelog-enforcer"
Cohesion: 0.22
...
### Community 827 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 829 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 830 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 832 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
Nodes (8): Branch, Components, Purpose, Quick Start, Session Roles, Skill: cowork-session (Claude Cowork), Testing, When to Use

### Community 833 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 834 - "Active Task Tracker"
Cohesion: 0.22
...
### Community 836 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 837 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 838 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 839 - "Issue #1356: quick-note:https://searchengineland.com/turn-seo-backlog-into-roadmap-485713"
Cohesion: 0.22
...
### Community 841 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 842 - "Platform Controls"
Cohesion: 0.22
...
### Community 843 - "Release Procedure"
Cohesion: 0.22
...
### Community 844 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 846 - "frontend/package.json"
Cohesion: 0.22
Nodes (8): jest, moduleNameMapper, ^react-router$, ^react-router-dom$, name, private, proxy, version

### Community 847 - "TestTheProducersAndTheParserCannotDrift"
Cohesion: 0.25
...
### Community 848 - "_get_current_user"
Cohesion: 0.25
...
### Community 849 - "enrich_quick_note_issues.py"
Cohesion: 0.42
...
### Community 850 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 852 - "test_changelog_parity_guard.py"
Cohesion: 0.22
...
### Community 854 - "TestPolicyAuthoringUiStableClaim"
Cohesion: 0.22
...
### Community 855 - "TestNoNvidiaFallbackIsRetired"
Cohesion: 0.22
...
### Community 856 - "test_scanner_deps_parity.py"
Cohesion: 0.31
...
### Community 862 - "_extract_pytest_failure"
Cohesion: 0.31
...
### Community 863 - "test_event_log.py"
Cohesion: 0.45
...
### Community 864 - "quality_checker.py"
Cohesion: 0.32
...
### Community 866 - "_parse_tool_calls_from_response"
Cohesion: 0.39
...
### Community 877 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 878 - "ceo-micromanagement.md"
Cohesion: 0.25
Nodes (4): P0 behavior change, Readiness contract, Runtime model, Runtime types

### Community 879 - "Feature Maturity / Support Matrix"
Cohesion: 0.25
...
### Community 882 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.25
...
### Community 883 - "Issue #362: Nvidia repo setup"
Cohesion: 0.25
...
### Community 884 - "Issue #364: quick-note:https://www.marktechpost.com/2026/06/01/meet-memory-os-a-6-layer-open-source-memory-stack-built-on-top-of-hermes-agent/"
Cohesion: 0.25
...
### Community 885 - "Issue #378: quick-note:https://www.marktechpost.com/2026/06/02/tinyfish-launches-bigset-an-open-source-multi-agent-system-that-builds-structured-live-datasets-from-plain-english-descriptions/"
Cohesion: 0.25
...
### Community 886 - "Issue #379: quick-note:https://searchengineland.com/schema-markup-optimize-agentic-web-479080"
Cohesion: 0.25
...
### Community 887 - "Issue #380: quick-note:https://cursor.com/blog/cloud-agent-lessons"
Cohesion: 0.25
...
### Community 888 - "Issue #381: quick-note:https://www.xda-developers.com/claude-code-with-opus-48-is-expensive-but-i-made-it-efficient-with-my-local-ai-workflow/"
Cohesion: 0.25
...
### Community 889 - "Issue #382: quick-note:https://claude.com/blog/how-coderabbit-used-claude-to-build-an-agent-orchestration-system"
Cohesion: 0.25
...
### Community 890 - "Issue #383: quick-note:https://www.marktechpost.com/2026/05/29/hexo-labs-open-sources-sia-a-self-improving-agent-that-updates-both-the-harness-and-the-model-weights/"
Cohesion: 0.25
...
### Community 891 - "Issue #416: feat: Self-hosted Codebuff (freebuff) on free NVIDIA models + Telegram bot phone control"
Cohesion: 0.25
...
### Community 892 - "Issue #485: [Trend Digest] Week of 2026-06-08"
Cohesion: 0.25
...
### Community 893 - "Issue #488: quick-note:https://github.com/cookiy-ai/user-research-skill"
Cohesion: 0.25
...
### Community 894 - "Issue #491: Implement whatever is necessary from https://github.com/BehiSecc/awesome-claude-skills"
Cohesion: 0.25
...
### Community 895 - "Issue #493: Use the https://github.com/mvanhorn/last30days-skill skill to get the trend updated"
Cohesion: 0.25
...
### Community 896 - "Issue #495: Read https://www.anthropic.com/news/claude-fable-5-mythos-5 and understand if mythos or fable can be added to the repo"
Cohesion: 0.25
...
### Community 897 - "Issue #504: EPIC: Autonomy hardening — live-verified defects 2026-06-10"
Cohesion: 0.25
...
### Community 898 - "Issue #581: Sprint tracker: pending work after brand rename + mobile-first pass"
Cohesion: 0.25
...
### Community 900 - "Issue #657: quick-note:https://github.com/earendil-works/pi"
Cohesion: 0.25
...
### Community 901 - "Issue #659: quick-note:https://github.com/nex-agi/Nex-N2"
Cohesion: 0.25
...
### Community 902 - "Issue #660: quick-note:https://github.com/getsentry/sentry-for-ai"
Cohesion: 0.25
...
### Community 903 - "Issue #661: quick-note:https://github.com/XiaomiMiMo/MiMo-Code"
Cohesion: 0.25
...
### Community 904 - "Issue #664: quick-note:https://github.com/Grominet95/jarvis-OS"
Cohesion: 0.25
...
### Community 905 - "Issue #666: quick-note:https://github.com/porokka/jarvis-os"
Cohesion: 0.25
...
### Community 906 - "Issue #670: quick-note:https://github.com/perplexityai/bumblebee"
Cohesion: 0.25
...
### Community 907 - "Issue #672: quick-note:https://github.com/Chachamaru127/claude-code-harness"
Cohesion: 0.25
...
### Community 908 - "Issue #676: quick-note:https://github.com/WeiboAI/VibeThinker"
Cohesion: 0.25
...
### Community 909 - "Issue #820: quick-note:https://github.com/cobusgreyling/loop-engineering"
Cohesion: 0.25
...
### Community 910 - "Positional Encoding Internals"
Cohesion: 0.25
...
### Community 911 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 912 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 913 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 914 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 915 - "Prime Agent Runtime"
Cohesion: 0.25
...
### Community 922 - "run_patched_colibri.py"
Cohesion: 0.36
...
### Community 924 - "TestItIsNotBuiltForOneVendor"
Cohesion: 0.25
...
### Community 925 - "test_compose_and_coordinate_api.py"
Cohesion: 0.36
...
### Community 926 - "test_generate_context_standing_instructions.py"
Cohesion: 0.32
...
### Community 927 - "test_local_brain_router_smoke.py"
Cohesion: 0.25
...
### Community 930 - "test_provider_models_db_outage.py"
Cohesion: 0.25
...
### Community 931 - "test_runtimes_health_endpoint.py"
Cohesion: 0.25
...
### Community 934 - "TestRevenuePortfolio"
Cohesion: 0.20
...
### Community 935 - "test_serve_spa_prefixes.py"
Cohesion: 0.36
...
### Community 936 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.25
...
### Community 938 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 941 - "service_token.py"
Cohesion: 0.25
...
### Community 946 - "test_minimax_bug_fixes.py"
Cohesion: 0.13
...
### Community 950 - "Changelog"
Cohesion: 0.29
Nodes (7): Added, Changed, Changelog, Fixed, Maintenance, Removed, Security

### Community 951 - "AI Engineering Insights Skill"
Cohesion: 0.29
...
### Community 965 - "claude-mem Plugin — Persistent Memory for All Sessions"
Cohesion: 0.29
...
### Community 966 - "Implementation plan + TO-DO (check off as you go)"
Cohesion: 0.29
...
### Community 969 - "Cloudflare = the real working app"
Cohesion: 0.29
...
### Community 982 - "test_daily_2026_06_14.py"
Cohesion: 0.38
...
### Community 983 - "TestSupportMatrixDocsSync"
Cohesion: 0.29
...
### Community 985 - "TestGithubTokenSQLiteRegression"
Cohesion: 0.38
...
### Community 986 - "get_self_healing_agent"
Cohesion: 0.06
Nodes (47): _dispatch_async(), _ErrorCaptureHandler, get_log_monitor(), LogMonitor, _note_recurrence(), Any, LogRecord, agent/log_monitor.py — Application Log Monitor Captures ERROR/CRITICAL log… (+39 more)

### Community 987 - "TestReasonsAreActionable"
Cohesion: 0.29
...
### Community 988 - "TestProvidersScreen"
Cohesion: 0.43
...
### Community 989 - "TestCli"
Cohesion: 0.57
Nodes (3): Path, The workflows call this as a subprocess, so the CLI contract matters., TestCli

### Community 991 - "TestActiveStrategy"
Cohesion: 0.29
Nodes (3): parametrize, A typo must not silently pick some other distribution., TestActiveStrategy

### Community 992 - "HealthStatus"
Cohesion: 0.10
Nodes (10): CerebrasProvider, Provider, Cerebras provider adapter — free, fast LLM (qwen-3-coder-480b)., GroqProvider, Provider, Groq provider adapter — free, fast LLM (deepseek-r1-distill-llama-70b)., ChatResponse, HealthStatus (+2 more)

### Community 993 - "/fix-bug — Bug Fix Agent"
Cohesion: 0.33
Nodes (5): Escalation, /fix-bug — Bug Fix Agent, Process, Rules, Usage

### Community 994 - "Command: /plan"
Cohesion: 0.33
Nodes (5): Command: /plan, References, Usage, What It Does, When to Use

### Community 995 - "pre-commit"
Cohesion: 0.60
Nodes (5): pre-commit script, _error(), _head(), _info(), _warn()

### Community 996 - "Skill: browserbase-fetch — Lightweight Web Fetch"
Cohesion: 0.33
...
### Community 1007 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 1008 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 1009 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 1010 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 1011 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 1012 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 1013 - "StatusPill.jsx"
Cohesion: 0.47
Nodes (5): C, STATUS_META, StatusPill(), TONE_BG(), TONE_BORDER()

### Community 1014 - "fetch_url.py"
Cohesion: 0.43
...
### Community 1015 - "apply_phase1_changes.py"
Cohesion: 0.33
...
### Community 1028 - "test_catalogue_probe.py"
Cohesion: 0.33
...
### Community 1047 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 1048 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 1049 - "Runtime troubleshooting"
Cohesion: 0.40
Nodes (4): Agent mode timeout, Missing binary / task harness, Runtime troubleshooting, Workspace validation failures

### Community 1050 - "knowledgeGraphTab.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 1051 - "loginFlowNoTimeout.test.js"
Cohesion: 0.40
Nodes (4): apiSource, { describe, test, expect }, fs, path

### Community 1052 - "test_company_stale_id_recovery.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 1053 - "worker_no_cache.test.js"
Cohesion: 0.40
...
### Community 1059 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1060 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1061 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 1062 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 1071 - "test_agent_runtime_wrapper.py"
Cohesion: 0.70
...
### Community 1072 - "classify_domain"
Cohesion: 0.29
...
### Community 1073 - "TestNoKeyEverReachesTheLog"
Cohesion: 0.40
...
### Community 1074 - "TestTheProbeIdentifiesItself"
Cohesion: 0.40
...
### Community 1076 - "TestModelRoleSeparation"
Cohesion: 0.40
...
### Community 1081 - "Continual Harness (`agent/harness_spec.py`)"
Cohesion: 0.25
...
### Community 1092 - "E2BSandboxSession"
Cohesion: 0.09
Nodes (21): MCPUnavailableError, Raised when the MCP server is unreachable or the circuit is open., TaskResult, TaskSpec, Execute a task inside a fresh E2B sandbox. Flow: 1. Open an…, Run ``pytest`` inside the sandbox. Returns ``(output, passed)``.…, E2BSandboxSession, Any (+13 more)

### Community 1093 - "test_domain_specialists.py"
Cohesion: 0.29
...
### Community 1107 - "test_no_exception_detail_leaks.py"
Cohesion: 0.50
...
### Community 1108 - "test_skills_route_order.py"
Cohesion: 0.67
...
### Community 1109 - "github"
Cohesion: 0.50
Nodes (3): github, enabled, silent

### Community 1114 - "openclaw_mobile_ui"
Cohesion: 0.33
...
### Community 1115 - "The full agent capability roster"
Cohesion: 0.33
...
### Community 1136 - "TestCEOAgencySystem"
Cohesion: 0.33
...
### Community 1137 - "test_the_reserve_is_bounded_when_read_from_the_environment"
Cohesion: 0.67
...
### Community 1141 - "TestDirectChatNonBlocking"
Cohesion: 0.40
...
### Community 1242 - "TestAgentRunnerExecution"
Cohesion: 0.33
...
### Community 1244 - "verify_pr_exists"
Cohesion: 0.50
...
### Community 1251 - "Privacy, security, and cost"
Cohesion: 0.50
Nodes (4): Privacy, security, and cost, Security posture, What it costs to run, Your data never leaves your server

### Community 1252 - "_InMemoryErrorLogHandler"
Cohesion: 0.50
Nodes (3): _ensure_error_log_capture(), _InMemoryErrorLogHandler, LogRecord

### Community 1253 - "_get_backend_sam"
Cohesion: 0.50
Nodes (4): _get_backend_sam(), Lazy-init the SAM agent for the backend deployment., Get SAM's current status., sam_status_backend()

### Community 1254 - "Configuration reference"
Cohesion: 0.67
Nodes (3): Configuration reference, Provider priority chain, Running the brain on local Ollama (via a tunnel)

### Community 1255 - "scheduler_tick_last"
Cohesion: 0.50
Nodes (4): Public keepalive-monitoring response for GET /api/scheduler/tick/last.…, Return the last Cloudflare Cron tick timestamp for keepalive monitoring. Public…, scheduler_tick_last(), SchedulerTickLastResponse

## Knowledge Gaps
- **3455 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3450 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 13140 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **110 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `_fixture()` connect `_fixture` to `model_router.py`, `test_catalogue_probe.py`, `llm/router.py`, `test_llm_router_queue_cache.py`, `TaskStore`, `test_e2b_sandbox.py`, `test_llm_router_strategies.py`, `TaskSpec`, `services/background.py`, `BrainConfig`, `test_company_api.py`, `ImprovementLoop`, `test_model_router.py`, `PolicyEngine`, `TaskWorkflowService`, `resolve_active_brain`, `SelfHealingAgent`, `config.py`, `WorkflowOrchestrator`, `Task`, `MCPClient`, `test_unit8_model_catalog.py`, `test_openclaw_endpoints.py`, `test_agent_tool_governance.py`, `test_freebuff_bot.py`, `test_failover_client_shared.py`, `test_llm_router_resilience.py`, `test_e2b_task_wiring.py`, `enforcement.py`, `AgentJobManager`, `test_knowledge_sync.py`, `PrimeAgentAdapter`, `SQLiteStore`, `timedelta`, `test_sam_livekit.py`, `test_unit7_catalog_propagation.py`, `telegram_inbound_handlers.py`, `settings.py`, `ArtifactStore`, `test_autonomy_status.py`, `test_claude_code_adapter.py`, `ChatHistoryStore`, `test_local_brain_state.py`, `AgentSwarm`, `test_phase5_doctor.py`, `test_refresh_agent_built_proof.py`, `get_task_store`, `test_telegram_diag_endpoint.py`, `TokenBudget`, `ResearchTask`, `TestClient`, `test_llm_router_e2e.py`, `cost_tracker.py`, `KeyStore`, `test_procedural_memory.py`, `test_provider_410_per_model.py`, `test_startup_warmup.py`, `e2e/test_browser.py`, `resolve_e2b_config`, `services/seo_audit.py`, `test_sam_voice.py`, `TestHarnessAdapter`, `workflow/api.py`, `clear_cooldowns`, `test_context_rulebook.py`, `ai/router.py`, `UserRole`, `BackgroundAgent`, `run_task`, `claim`, `FeatureMaturity`, `test_issue_intake.py`, `test_task_clarification.py`, `_step`, `test_llm_router_tpm.py`, `test_openclaw_gateway.py`, `test_direct_chat_evolution.py`, `platform_controls_router.py`, `get_skill_bindings`, `seo_api.py`, `persist_plan_spec`, `test_new_features_e2e.py`, `KeyPool`, `_Budget`, `test_telegram_freebuff.py`, `NotificationDispatcher`, `OllamaCircuitBreaker`, `_job_text`, `Usage`, `tests/conftest.py`, `test_ceo_router.py`, `test_colibri_brain_shim.py`, `test_features_api.py`, `test_video_transcript.py`, `TrendWatcher`, `BrainWatchdog`, `test_platform_controls.py`, `test_process_quick_note_workflow.py`, `test_portfolio_intake.py`, `_clean_phases`, `test_agile_api.py`, `test_app_settings.py`, `test_trend_watcher.py`, `test_e2b_data_flow.py`, `TestEstimateTokensForMessages`, `TestClient`, `ContextPruner`, `test_control_plane_api.py`, `WorkflowBuildRequest`, `test_persistent_memory.py`, `SecurityScanner`, `model_discovery.py`, `OutputFilter`, `provider_max_rpm`, `test_kimi_bridge_server.py`, `test_brain_availability_doctor.py`, `OrchestratorQueue`, `test_nvidia_model_discovery.py`, `capture_screens.py`, `TestNormalizeResponseFormat`, `test_rate_limiter.py`, `test_mcp_governance.py`, `test_purge_backlog.py`, `analyze_page`, `models/company_graph.py`, `_resolve_user_github_token`, `parse_event_stream`, `brain_failover.py`, `test_agent_scripts_share_one_model_list.py`, `test_crispy_burn_in.py`, `test_skill_registry_boot_refresh.py`, `session_retro.py`, `isolated_telegram_config`, `test_scheduler_hydration_bounded.py`, `test_provider_enable_disable.py`, `_undeclared`, `test_dashboard_cache.py`, `test_service_token.py`, `test_harness_spec.py`, `test_regression.py`, `test_agency_fix.py`, `test_ping.py`, `test_runtimes_health_endpoint.py`, `test_monitor_lib.py`, `test_task_store_fails_loud_in_production.py`, `test_v4_api.py`, `get_ceo_dispatcher`, `CacheManager`, `OrchestratorCheckpointStore`, `ScheduledJob`, `allow_paid`, `test_brain_failover_413.py`, `test_webui_provider_priority.py`, `test_provider_state_durability.py`, `client`, `TestTheWorkflowIsSafeAndReadOnly`, `get_self_healing_agent`, `.record`, `test_voice_pipeline.py`, `test_ai_insights.py`, `test_agent_free_brain.py`, `test_brain_patch_service_token.py`?**
  _High betweenness centrality (0.118) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `proxy.py`, `test_agent_chat_integration.py`, `ReactScratchpad`, `TaskSpec`, `AgentSessionStore`, `TestAgentRunnerSafety`, `test_empirical_verify.py`, `FreeBuffAgent`, `ContextManager`, `PolicyEngine`, `test_backend_server_features.py`, `WorkflowOrchestrator`, `AdaptiveHalter`, `MCPClient`, `MultiAgentSwarm`, `LocalWorkspace`, `StuckDetector`, `test_failover_client_shared.py`, `direct_chat.py`, `test_agent_tool_governance.py`, `workflow_orchestrator.py`, `WorkspaceTools`, `NotificationDispatcher`, `get_ceo_dispatcher`, `AgentJobManager`, `agency.py`, `test_brain_failover_413.py`, `E2BSandboxSession`, `CEODispatcher`, `TokenBudget`, `AgentPlan`, `test_daily_automation_2026_07_11.py`, `TestAgentRunnerExecution`, `UserMemoryStore`, `InternalAgentAdapter`, `test_governance_api.py`, `ContextPruner`, `test_agent_free_brain.py`, `GitHubTools`, `BackgroundAgent`?**
  _High betweenness centrality (0.043) - this node is a cross-community bridge._
- **Why does `get_skill_bindings()` connect `get_skill_bindings` to `FeatureMaturity`, `AgentRunner`, `SpecEntry`, `HarnessEnrichment`, `SkillBindings`, `company_api.py`, `workflow_orchestrator.py`, `models/company_graph.py`, `skill_bindings.py`, `WorkflowOrchestrator`?**
