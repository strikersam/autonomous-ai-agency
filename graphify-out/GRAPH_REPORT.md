# Graph Report - local-llm-server  (2026-08-30)

## Corpus Check
- 1451 files · ~2,111,065 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 29627 nodes · 54942 edges · 1259 communities (1144 shown, 115 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 2695 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `56246edb`
...
## Communities (1259 total, 115 thin omitted)

### Community 0 - "MongoDBStore"
Cohesion: 0.02
Nodes (96): KnowledgeItem, Find knowledge items matching any of the given tags., Structured knowledge about the company, systems, or processes., Add a knowledge item to a company. Args: company_id: Company ID title:…, Get a knowledge item by ID., Search knowledge items., Get knowledge items by tags for a company. Args: company_id: Company ID tags:…, MongoDBStore (+88 more)

### Community 1 - "company_api.py"
Cohesion: 0.02
Nodes (125): create_company(), get_company_graph(), provision_specialist(), patch, post, Company Graph API Router Provides all endpoints for managing companies, their…, Provision a new specialist for a company. Creates and provisions a specialist…, Request to recommend skills based on context. (+117 more)

### Community 2 - "proxy.py"
Cohesion: 0.03
Nodes (164): middleware, AdminIdentity, admin_control(), admin_create_key(), admin_create_user(), admin_delete_user(), admin_list_users(), admin_login() (+156 more)

### Community 3 - "resolve_identity"
Cohesion: 0.03
Nodes (130): Governance seam: judge the call, run it, audit the outcome. Deliberately a thin…, Feed LLM token/cost spend into the governance session budget. Kept separate…, Charge sub-agent nesting depth and enforce the ``max_depth`` ceiling. Isolates…, _egress_policy_reason(), agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Return why governance policy blocks *host*, or None. Runs strictly *after* the…, guard(), identity_from_headers() (+122 more)
...
Cohesion: 0.03
Nodes (105): AgentPhaseError, AgentRunner, _check_extra_kwargs(), _enforce_signature(), Any, Exception, Path, Raise TypeError if fn's signature drifts from the locked contract (Pydantic… (+97 more)

### Community 6 - "test_governance_enforcement.py"
Cohesion: 0.03
Nodes (116): AuditEvent, Any, packages/governance/audit.py — the evidence trail for every governed action.…, Redact secret-shaped substrings, then truncate., One governed action, fully described. Field order follows the…, One-line JSON, suitable for a SIEM shipper tailing the log., Return the most recent events, newest first, optionally filtered., Recursively strip secrets from an arbitrary argument structure. Fails… (+108 more)

### Community 7 - "backend/server.py"
Cohesion: 0.03
Nodes (138): _agent_timeout_fallback_response(), AgentStatusEntry, AgentStatusResponse, AgentToolCallEntry, ApiKeyCreate, AuthorizeReposBody, brain_providers(), BrainTestRequest (+130 more)

### Community 8 - "test_llm_router_strategies.py"
Cohesion: 0.03
...
### Community 10 - "TaskStore"
Cohesion: 0.03
Nodes (98): Task, Creates tasks from scheduler and playbook runs using one workflow., TaskAutomationService, Owns lifecycle transitions, comment semantics, and approval rules., TaskWorkflowService, Any, Task, TaskStatus (+90 more)

### Community 11 - "TaskSpec"
Cohesion: 0.05
Nodes (72): agent/job_manager.py — Async agent job lifecycle manager. Manages agent jobs…, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, runtimes/adapters/claude_code.py — Claude Code CLI adapter (FIRST CLASS).…, runtimes/adapters/docker_agent.py — Docker-based agent runtime adapter. Spawns…, runtimes/adapters/e2b.py — E2B Firecracker micro-VM runtime adapter. Routes…, runtimes/adapters/goose.py — Goose adapter (TIER 2). Goose…, runtimes/adapters/hermes.py — Hermes Agent adapter (FIRST CLASS). Hermes Agent…, Internal runtime adapter that executes tasks via the built-in AgentRunner.… (+64 more)

### Community 12 - "test_unit8_model_catalog.py"
Cohesion: 0.03
Nodes (102): Resolve the model id for a component's role on a provider. Parameters…, Convenience: resolve all four role models for a component. Returns a dict with…, resolve_component_model(), resolve_component_role_models(), CatalogActiveBrain, CatalogMirror, CatalogProviderEntry, _include_router_providers() (+94 more)

### Community 13 - "test_llm_router_queue_cache.py"
Cohesion: 0.03
Nodes (79): int, CacheManager, cosine_similarity(), _Entry, LRUCache, payload_key(), Any, T (+71 more)

### Community 14 - "test_governance_sandbox.py"
Cohesion: 0.04
...
### Community 16 - "llm/router.py"
Cohesion: 0.03
Nodes (90): get_budget(), The process-wide budget tracker., get_cache(), packages/llm/cache.py — layered caching. Five independent layers, each with its…, The process-wide cache manager., text_key(), failover_chat_completion_via_router(), openai_body_from_response() (+82 more)

### Community 17 - "ImprovementLoop"
Cohesion: 0.05
Nodes (79): Agency, AgentRole, get_agency(), _parse_ceo_directives(), str, CEO-coordinated multi-agent agency for continuous codebase management. The CEO…, set_agency(), DetectedIssue (+71 more)
...
### Community 19 - "services/seo_audit.py"
Cohesion: 0.04
Nodes (63): Run a full SEO/GEO/AIO audit against a website and persist the evidence., run_seo_audit(), BaseModel, field_validator, models/seo_audit.py - SEO / GEO / AIO Audit Contracts Typed Pydantic models for…, A single occurrence of a check firing on a specific URL., Snapshot of one crawled page with the on-page facts the checks used., Aggregated report row - Screaming Frog CSV compatible. (+55 more)
...
### Community 22 - "test_render_mcp.py"
Cohesion: 0.04
Nodes (52): agent/mcp_client.py — Async MCP client for the mcp-server Docker container.…, _as_list(), _coerce_payload(), Any, RuntimeError, packages/integrations/render_mcp.py — Render platform access over MCP. The…, Return tool output as Python data. MCP tool results arrive either as…, Normalise a tool payload into a list of dicts. Upstream tools variously return… (+44 more)
...
### Community 24 - "Initiative"
Cohesion: 0.03
Nodes (60): CapacityAllocation, Initiative, Enum, Agentic Portfolio Management — initiative prioritisation, capacity allocation,…, Result of fitting initiatives into a fixed capacity by WSJF priority., Total job size of initiatives that fit within capacity., Unused capacity after committing the selected initiatives., Fraction of capacity consumed (0.0–1.0). (+52 more)

### Community 25 - "get_db"
Cohesion: 0.03
Nodes (102): auth_me(), auto_recommend_skills(), brain_failover_status(), _check_storage_health(), cost_attribution_stats(), delete_github_token(), _delete_limited_chat_session(), delete_session() (+94 more)
...
Cohesion: 0.05
Nodes (72): AgentConfig, build_agent_specs(), build_swarm(), build_task_specs(), coordinate_v2(), CoordinateRequestV2, CoordinateResponse, Any (+64 more)

### Community 31 - "get_workflow_orchestrator"
Cohesion: 0.04
...
### Community 33 - "ToolRegistry"
Cohesion: 0.04
Nodes (51): get_tool_registry(), _infer_parameters_from_func(), Any, Path, Register a tool definition., Decorator to register a function as an agent tool. Usage::…, Remove a tool from the registry. Returns True if removed., Look up a tool by name. (+43 more)

### Community 34 - "test_phase6_workflow.py"
Cohesion: 0.05
...
### Community 35 - "test_llm_router_resilience.py"
Cohesion: 0.04
Nodes (63): Backoff policy for retryable failures., RetryConfig, BreakerState, Enum, str, _digest(), KeyRing, KeyState (+55 more)

### Community 36 - "test_brain_config_api.py"
Cohesion: 0.03
Nodes (67): _describe_http_status(), _is_dns_failure(), _probe_failure_reason(), probe_model_liveness(), _probe_ollama(), _probe_openai_compat(), ProbeResult, BaseException (+59 more)

### Community 37 - "WebsiteScanner"
Cohesion: 0.04
Nodes (67): Scan a website for technology stack and systems. This performs a comprehensive…, scan_website_endpoint(), Result of a website scan with detected systems and stack inference., WebsiteScanResult, main(), Returns (url, ok, summary)., _scan_one(), _content_contains_domain() (+59 more)

### Community 38 - "ExecutionRequest"
Cohesion: 0.05
Nodes (65): BoundContext, ClassifyOutput, ExecutionRequest, ExecutionResult, _get_ceo_dispatcher(), JudgeVerdict, MonitorOutput, _orchestrator_bypass() (+57 more)
...
### Community 40 - "Task"
Cohesion: 0.05
Nodes (51): _coerce_ts(), ExecutionLogEntry, Any, field_validator, Full task/issue document., Update the updated_at timestamp., Coerce ISO-8601 datetime strings (from DB) to float timestamps., Single entry in a task's execution log. (+43 more)

### Community 41 - "brain_config.py"
Cohesion: 0.04
Nodes (80): Call-time resolver for an agent role model id. Delegates to…, _resolve_role_model(), BrainConfigPatch, default_brain_config(), get_brain_config(), get_brain_config_store(), invalidate_brain_config_cache(), provider_api_keys() (+72 more)

### Community 42 - "validate_policy_text"
Cohesion: 0.04
...
### Community 44 - "test_model_router.py"
Cohesion: 0.05
...
### Community 45 - "HTTPException"
Cohesion: 0.04
Nodes (82): admin_seed(), clear_response_cache(), create_api_key(), create_github_pr(), create_provider(), create_wiki_page(), delete_api_key(), delete_mcp_server() (+74 more)
...
Cohesion: 0.04
Nodes (49): repowise.py — RepowiseIntelligence: context packing and dependency analysis., Path, tools.py — WorkspaceTools: read/write/search and diff application (risky…, Precise string replacement — F1 roadmap item (Codebuff/Claude Code-style edit).…, Return a previously saved memory value, or an empty string if absent., Persist a key/value pair to the user's profile store., Return the first *lines* lines of a file. Just-in-time retrieval: the executor…, Return a lightweight index of files with line counts and sizes. This is the… (+41 more)

### Community 49 - "test_mcp_registry.py"
Cohesion: 0.05
...
### Community 52 - "test_ceo_dispatcher.py"
Cohesion: 0.04
Nodes (73): CEOResult, Aggregated output from a multi-specialist execution., get_ceo_fallback_stats(), Increment the named counter (silently ignores unknown reasons)., Return a snapshot of the CEO fallback counters., Zero all CEO fallback counters (useful for testing)., _record_ceo_fallback(), reset_ceo_fallback_stats() (+65 more)

### Community 53 - "test_ceo_supervision.py"
Cohesion: 0.06
Nodes (70): _harvest_changed_files(), Extract the files a runtime touched. Returns ``(files, reported)``. Adapters…, A subtask's full history: what it is, and every attempt at it., SubtaskRecord, Bounds for the unattended supervision loop., SupervisorConfig, _goal(), asyncio (+62 more)
...
### Community 55 - "test_loop_registry.py"
Cohesion: 0.05
Nodes (64): audit_drift(), _cmd_audit(), DriftReport, _grade(), load_registry(), load_registry_sync(), loop_readiness(), LoopRegistry (+56 more)

### Community 56 - "get_company_graph_store"
Cohesion: 0.04
Nodes (64): autonomy_status(), Public autonomy readiness probe — no authentication required. A live deploy…, Fire-and-forget self-bootstrap; never blocks or crashes startup., _schedule_self_bootstrap(), CompanyAgencyService, get_company_agency_service(), _is_runtime_available_sync(), _pick_available_runtime() (+56 more)

### Community 57 - "ai/router.py"
Cohesion: 0.04
Nodes (66): Record token usage for *model* (fire-and-forget, never raises). ``tag`` is a…, record_usage(), clear_cooldowns(), _dead_model_key(), _exponential_backoff_cooldown(), get_dead_models(), _is_model_dead(), is_provider_on_cooldown() (+58 more)

### Community 58 - "TestAdapterMetadata"
Cohesion: 0.04
Nodes (34): kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, AiderAdapter, Any, TaskResult, TaskSpec, Run aider non-interactively via `--message` flag., Adapter for Aider — TIER 3 specialized git-aware code editor. (+26 more)

### Community 59 - "PrimeAgentAdapter"
Cohesion: 0.05
...
### Community 60 - "test_unit7_catalog_propagation.py"
Cohesion: 0.05
...
### Community 61 - "get_company_access"
Cohesion: 0.04
Nodes (74): account_lifecycle(), AccountLifecycleResponse, auto_recommend_skills(), cancel_onboarding(), delete_company_endpoint(), _DoctorCheck, _DoctorReport, generate_onboarding_questions() (+66 more)
...
### Community 64 - "AgentDefinition"
Cohesion: 0.05
Nodes (54): _apply_activity_status(), create_agent(), delete_agent(), get_agent(), _get_user(), list_agents(), list_runtime_agents(), Any (+46 more)
...
### Community 66 - "TaskExecutionCoordinator"
Cohesion: 0.05
...
### Community 68 - "portfolio_intelligence.py"
Cohesion: 0.05
Nodes (63): _bullets(), generate_backlog_retro(), generate_sprint_retro(), generate_standup(), plan_next_sprint(), Agentic Agile — autonomous ceremonies (standup, retro, sprint planning). Where…, Render a :class:`Retrospective` as a markdown section., Derive retro notes for ``sprint`` from its current metrics. Records… (+55 more)

### Community 69 - "get_task_store"
Cohesion: 0.05
Nodes (68): quick_notes_submit(), _QuickNoteBody, The task store the background services should use, wiring it if needed.…, Submit a quick-note URL or instruction from the dashboard FAB., _task_store_for_background(), get_failover_manager(), Return the singleton BrainFailoverManager., Reset the singleton (for tests). (+60 more)

### Community 70 - "CompanyGraphStore"
Cohesion: 0.03
...
### Community 72 - "AgileSprint"
Cohesion: 0.04
Nodes (27): AgileSprint, An agile sprint containing user stories., Add a user story to the sprint., Remove a user story from the sprint., Total story points in the sprint., Completed story points., Return completed points history for burndown chart., Number of stories in the sprint. (+19 more)

### Community 73 - "tasks/service.py"
Cohesion: 0.05
Nodes (56): Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., tasks — Task/issue management system. Provides a lightweight task/issue tracker…, ApprovalCheckpoint, Enum, str, tasks/models.py — Pydantic models for the task/issue system., Comment or reply on a task. (+48 more)
...
### Community 85 - "DetectedSystem"
Cohesion: 0.04
Nodes (49): DetectedSystem, Evidence, Evidence supporting a system detection., A business system detected on a company's website or in their stack., Get the most confident evidence description., Inferred technology stack from website/repo analysis., StackInference, datetime (+41 more)
...
### Community 88 - "test_procedural_memory.py"
Cohesion: 0.05
...
### Community 89 - "seo_api.py"
Cohesion: 0.05
Nodes (52): build_seo_roadmap(), delegate_seo_findings(), export_seo_audit(), list_seo_audits(), plan_seo_sprint(), BaseModel, get, post (+44 more)

### Community 90 - "test_provider_router.py"
Cohesion: 0.05
Nodes (60): _acquire_provider_probe(), extract_openai_text(), is_commercial_provider(), _normalize_nvidia_base_url(), _openai_url(), Try to acquire a distributed probe lock for *provider_id*. Returns True if this…, Release the probe lock for *provider_id*., Normalize NVIDIA base URLs to avoid double /v1 when openai_compat_url appends… (+52 more)

### Community 91 - "test_agent_tool_governance.py"
Cohesion: 0.06
Nodes (55): Replace the process-wide store. Tests only., reset_approval_store(), AuditLog, Bounded in-memory ring buffer plus a structured log stream. The ring buffer…, Store and emit *event*. Never raises., Aggregate view for the dashboard and the metrics endpoint. ``would_block`` is…, Replace the process-wide audit log. Tests only., reset_audit_log() (+47 more)
...
### Community 96 - "AgentJobManager"
Cohesion: 0.06
Nodes (31): AgentJob, AgentJobManager, _now(), Any, Run a job using the provided runner and update the job's lifecycle, progress,…, Serialize the AgentJob to a JSON-serializable dictionary for external clients.…, runner(), AgentJobManager method signature enforcement. (+23 more)

### Community 97 - "ScheduledJob"
Cohesion: 0.05
...
### Community 98 - "skill_bindings.py"
Cohesion: 0.05
Nodes (50): _execute_skill_impl(), _get_agile_manager(), _get_portfolio_manager(), Any, BaseModel, Enum, str, services/skill_bindings.py — Runtime Skill Bindings for Specialist Agents Wires… (+42 more)

### Community 99 - "PortfolioManager"
Cohesion: 0.04
Nodes (32): InitiativeProgress, PortfolioManager, PortfolioMetrics, Delivery roll-up for a single initiative across its linked sprints., Percentage of linked sprint points completed., Aggregate metrics across the whole portfolio., Manages a portfolio of initiatives with WSJF prioritisation and roadmapping., Remove an initiative from the portfolio. (+24 more)
...
### Community 101 - "workflow/models.py"
Cohesion: 0.05
...
### Community 107 - "test_web_reach.py"
Cohesion: 0.07
Nodes (47): _load_script_module(), Any, ModuleType, Response, Dynamically load a pure-stdlib helper module from .github/scripts/. Returns…, Zero-key internet access: pages, YouTube transcripts, search, RSS. Every public…, Read a web page as plain text, following the same fallback chain (direct ->…, GET *url*, re-validating every redirect hop against ``unsafe_target_reason`` —… (+39 more)
...
Cohesion: 0.06
Nodes (44): CEODispatcher, _complexity_rank(), _decompose_into_subtasks(), _merge_changed_files(), _offload(), Any, Semaphore, services/ceo_dispatcher.py — Real CEO delegation layer. The CEO splits a… (+36 more)
...
### Community 115 - "test_colibri_brain_shim.py"
Cohesion: 0.06
...
### Community 116 - "WorkflowOrchestrator"
Cohesion: 0.05
Nodes (29): _NoopStore, Any, Exception, Approve a run paused at the ApprovalGate. The caller must re-invoke…, Inject additional instructions into an in-flight run (no state change). Backs…, Push a Telegram approval-gate notification when a run pauses (Charter G1).…, List recent runs. When ``owner_id`` is provided, only runs stamped with that…, No-op checkpoint store when the real one is unavailable. (+21 more)
...
### Community 123 - "BrainConfig"
Cohesion: 0.05
Nodes (44): _brain_provider_status(), Return per-provider metadata for the GET endpoint. Iterates every provider in…, BrainConfig, BrainConfigStore, provider_base_url(), BaseModel, Persist *cfg* to Mongo (primary) and sqlite (mirror). Either backend failing is…, Build a ``BrainConfig`` from a Mongo doc, dropping Mongo's ``_id``. (+36 more)

### Community 124 - "start_background_services"
Cohesion: 0.04
Nodes (43): _create_bootstrap_indexes(), ensure_bootstrap(), _keepalive_self_ping(), lifespan(), Run the FreeBuff Telegram bot, restarting it on unexpected exit., Ping our own public URL so a free-tier web service doesn't sleep. Render free…, Start the Telegram bot (and keep-alive) inside the web process when enabled.…, #522 + #505: Reliability startup — schedule hydration, orchestrator restore,… (+35 more)
...
### Community 126 - "test_llm_router_tpm.py"
Cohesion: 0.06
...
### Community 128 - "test_integration_c4_c5_c6_d3.py"
Cohesion: 0.06
...
### Community 129 - "CEOSupervisor"
Cohesion: 0.05
Nodes (40): build_ceo_router(), Any, APIRouter, backend/ceo_router.py — observability and manual control for the CEO. Surfaces…, Reject non-admin callers for routes that spend provider budget. Delegates to…, _require_admin(), get_ceo_dispatcher(), Return the shared CEODispatcher singleton. (+32 more)

### Community 130 - "ProviderConfig"
Cohesion: 0.06
Nodes (43): provider_access_tier(), _provider_field(), provider_sort_key(), ProviderConfig, Infer an access tier from *hostname*, longest matching suffix winning. Returns…, _tier_from_hostname(), local_brain_enabled(), local_brain_provider_config() (+35 more)

### Community 131 - "_scanner"
Cohesion: 0.06
...
### Community 132 - "activation_api.py"
Cohesion: 0.07
Nodes (55): activate_instance(), ActivateRequest, ActivateResponse, activation_audit_log(), activation_status(), ActivationStatusResponse, _append_audit(), AuditLogEntry (+47 more)

### Community 133 - "agency.py"
Cohesion: 0.06
Nodes (36): AgencyCycleResult, AgentDirective, _build_ceo_prompt(), _build_quick_note_instruction(), _close_github_issue(), _collect_recent_git_context(), _fetch_github_quick_notes(), _gh_repo() (+28 more)

### Community 134 - "AgentPlan"
Cohesion: 0.07
Nodes (45): PreflightReport, Agent subsystem — planner / executor / verifier loop., AgentEvent, AgentPlan, AgentRunRequest, AgentSession, AgentSessionCreateRequest, AgentSessionMessage (+37 more)

### Community 135 - "FreeBuffAgent"
Cohesion: 0.06
...
### Community 138 - "PatternConsolidation"
Cohesion: 0.06
...
Cohesion: 0.06
Nodes (30): _digest(), get_pool(), KeyPool, _KeyState, _PoolState, Per-provider API key rotation — the one lever that adds capacity. Every other…, Round-robin key selection with per-key rate-limit cooldowns., Return the next usable key, or None when every key is cooling. With one key… (+22 more)

### Community 142 - "resolve_active_brain"
Cohesion: 0.07
Nodes (53): BrainResolution, provider_api_key(), Return the live API key for *provider* (env-only — never persisted)., get_active_brain_sync(), get_brain_preference(), get_provider_role_tags(), _host_is_openai_compatible(), invalidate_brain_cache() (+45 more)
...
### Community 147 - "TestRuntimeControl"
Cohesion: 0.04
...
### Community 150 - "test_startup_warmup.py"
Cohesion: 0.05
Nodes (48): _bootstrap_within_budget(), Await one warm-up step, deferring it to the background if it overruns.…, Run bootstrap without letting it hold a request open indefinitely. Returns…, _warmup_step(), _hydrate_scheduler_bounded(), Attach durable persistence and rehydrate (#505), bounded by a budget. Without…, defer_to_background(), Any (+40 more)

### Community 151 - "test_governance_api.py"
Cohesion: 0.06
...
### Community 160 - "RuntimeCapabilityRegistry"
Cohesion: 0.07
...
### Community 163 - "portfolio_api.py"
Cohesion: 0.07
...
### Community 165 - "test_schedule_growth_invariants.py"
Cohesion: 0.05
Nodes (35): cleanup_stale_jobs(), _is_stale(), Any, packages/scheduler/cleanup.py — schedule deduplication + stale removal.…, Remove a job from the store. Returns True on success, False on failure. Logs…, Check if a created_at timestamp is older than ttl_seconds. Handles multiple…, Remove stale run-once + stuck agency jobs from the durable store. Args: store:…, _safe_remove() (+27 more)
...
### Community 167 - "failover_client.py"
Cohesion: 0.06
Nodes (46): _auto_disable(), _describe_registry(), _disabled_ids(), FailoverResult, _is_billing_refusal(), _is_ollama(), _key_pool(), _log_exhaustion() (+38 more)
...
### Community 169 - "test_e2b_adapter.py"
Cohesion: 0.07
Nodes (36): E2BAdapter, Any, Declare ``E2B_API_KEY`` as a required env dependency. The base ``preflight``…, Runtime adapter that executes tasks inside an E2B sandbox. Activation:…, _clean_e2b_env(), _FakeAsyncSandboxClass, _FakeCommandResult, _FakeCommands (+28 more)
...
### Community 175 - "webui/router.py"
Cohesion: 0.09
Nodes (31): _admin_out(), AdminCommandBody, _anthropic_chat_payload(), _anthropic_text(), BrainPolicyUpdate, _provider_headers(), _provider_kind(), ProviderReorderBody (+23 more)

### Community 176 - "test_daily_2026_07_27.py"
Cohesion: 0.07
...
### Community 178 - "AgentSessionStore"
Cohesion: 0.08
Nodes (21): AgentSessionStore, _now(), Connection, Path, Row, Safe getter for sqlite3.Row — Row supports index access but not .get()., Create a session with a caller-supplied session_id (useful for tests and…, SQLite-backed session store. Sessions and their message history are persisted… (+13 more)

### Community 179 - "ProvidersScreen.jsx"
Cohesion: 0.05
...
### Community 182 - "pr_approval_gate.py"
Cohesion: 0.08
...
### Community 184 - "facade.py"
Cohesion: 0.06
Nodes (41): _get_current_user_thunk(), _get_optional_user_thunk(), Request, create_refresh_token(), get_current_user(), get_optional_user(), google_callback(), Get user if authenticated, otherwise return None (for public endpoints). (+33 more)

### Community 185 - "_resolve_user_github_token"
Cohesion: 0.07
Nodes (41): _DoctorCheck, _DoctorReport, get_doctor_diagnostics(), get_doctor_report(), get_public_doctor(), Public Doctor endpoint — no authentication required. Returns system-level…, Authenticated Doctor endpoint — full diagnostics. Returns all system-level…, Execute work through the 11-phase golden path. (+33 more)

### Community 186 - "TaskBoardScreen.jsx"
Cohesion: 0.05
...
### Community 187 - "AnthropicProvider"
Cohesion: 0.09
Nodes (22): AnthropicProvider, Any, AsyncClient, Translate OpenAI-shaped messages into Anthropic's system/turn split., OpenAI carries a tool result as role="tool" with a tool_call_id; Anthropic…, OpenAI puts a tool call alongside the assistant's text; Anthropic needs…, Add a rolling cache_control breakpoint to the most-recent stable message. In a…, Anthropic's extended-thinking constraints on ``budget_tokens``: at least 1024,… (+14 more)
...
### Community 190 - "_build_default_manager"
Cohesion: 0.06
...
### Community 191 - "PromptCacheManager"
Cohesion: 0.06
...
### Community 193 - "test_e2b_task_wiring.py"
Cohesion: 0.08
...
Cohesion: 0.07
Nodes (41): _extract_mentioned_paths(), Pick the auto-PR model from the recommended free-cloud chain by key. Mirrors…, Extract plausible file paths from issue text., Read existing files for codebase context (max 8000 chars total)., _read_grounding_files(), _select_brain(), diff_is_sloppy(), is_destructive_overwrite() (+33 more)

### Community 196 - "ScheduleStore"
Cohesion: 0.07
...
### Community 197 - "test_portfolio_intake.py"
Cohesion: 0.08
Nodes (36): fetch_research_alerts(), Best-effort fetch of trend alerts. Returns [] if offline or unavailable., map_initiative_to_task(), materialize_committed(), _portfolio_materialize_enabled(), portfolio_source_id(), Any, Task (+28 more)

### Community 198 - "LLMRouter"
Cohesion: 0.08
Nodes (23): Attempt, Read the environment variables named in ``env_names`` into a key list. Order is…, resolve_keys(), LLMRouter, Any, AsyncClient, BaseException, One shared connection pool. Reconnects if it was closed. (+15 more)

### Community 199 - "ApprovalStore"
Cohesion: 0.07
...
### Community 203 - "test_schedule_backlog_drain.py"
Cohesion: 0.08
...
### Community 204 - "test_video_transcript.py"
Cohesion: 0.05
...
### Community 207 - "Part A — CodeRabbit review fixes for this PR (do first, small)"
Cohesion: 0.05
...
### Community 208 - "Docker Agent Runtimes Setup"
Cohesion: 0.05
...
### Community 209 - "test_agent_free_brain.py"
Cohesion: 0.05
...
### Community 211 - "ProviderRouter"
Cohesion: 0.09
Nodes (19): _get_director(), _normalized_provider_type(), ProviderRouter, Any, Response, Try all models for one provider. Returns ProviderResult on success, None on…, Parse a 429/503 ``Retry-After`` header → seconds, or None. Accepts either…, Return the process TrafficDirector, or None if it is unavailable. (+11 more)

### Community 212 - "render_ops.py"
Cohesion: 0.07
...
### Community 214 - "TestRecordUsageAndStats"
Cohesion: 0.05
...
### Community 215 - "test_process_quick_note_workflow.py"
Cohesion: 0.06
...
Cohesion: 0.12
Nodes (35): _expire_stale_pending_report(), get_seo_audit(), Fetch a complete stored audit report. Side-effect: an audit whose stub is still…, Auto-fail a pending SEO audit stub that is older than…, Complete result of one audit run., SeoAuditReport, Paragraph, Store a report in the bounded in-memory registry. (+27 more)
...
### Community 223 - "report_to_markdown"
Cohesion: 0.07
Nodes (27): _build_curl_cffi_fetcher(), _build_pdf(), main(), _parse_args(), Namespace, Path, Render an executive-level PDF from the audit report dict., Run the full audit and write output files. Returns exit code. (+19 more)

### Community 224 - "v4_api.py"
Cohesion: 0.10
Nodes (40): _get_cached_tasks(), _get_tasks_cache_lock(), _load_improvement_state(), Any, BaseModel, get, Lock, post (+32 more)

### Community 225 - "Kept Rules — the 44 that survive the audit"
Cohesion: 0.05
...
### Community 228 - "compare_runtimes.py"
Cohesion: 0.07
...
### Community 230 - "test_trend_watcher.py"
Cohesion: 0.08
...
### Community 231 - "activation.py"
Cohesion: 0.09
Nodes (36): activation_required(), ActivationResult, _b64url_decode(), _b64url_encode(), _decode_jwt_unverified(), _generate_token_for_owner(), get_or_create_instance_id(), load_activation() (+28 more)
...
### Community 239 - "test_backend_server_features.py"
Cohesion: 0.06
Nodes (25): _append_agent_session_message(), _builtin_provider_records(), _in_container(), _mask_observations(), Path, ProviderConfig, Return a minimal set of built-in provider records without touching MongoDB.…, Truncate tool/observation content in older messages to prevent context bloat. (+17 more)

### Community 240 - "TestEstimateTokensForMessages"
Cohesion: 0.06
...
### Community 241 - "test_llm_router_disabled.py"
Cohesion: 0.09
...
### Community 242 - "InternalAgentAdapter"
Cohesion: 0.06
Nodes (27): InternalAgentAdapter, Built-in agent loop — Nvidia NIM primary, Ollama fallback., Return runtime dependencies required by this adapter. Returns:…, Determine availability of the internal agent runtime. Checks cloud providers in…, Create an isolated execution context for a single task. Tries ``git worktree…, Clean up the worktree or temp copy created by ``_create_worktree``., FakeTask, End-to-end tests for the autonomous AI agency system (issue #467). These tests… (+19 more)

### Community 243 - "RewardScorer"
Cohesion: 0.08
...
### Community 249 - "NIMConnectionPool"
Cohesion: 0.08
...
### Community 254 - "test_brain_availability_doctor.py"
Cohesion: 0.11
...
### Community 255 - "WorkflowBuildRequest"
Cohesion: 0.08
...
### Community 256 - "test_implement_agent_routing.py"
Cohesion: 0.07
...
### Community 258 - "test_verification_strategies.py"
Cohesion: 0.11
...
### Community 259 - "output_filter.py"
Cohesion: 0.07
...
### Community 262 - "test_brain_failover.py"
Cohesion: 0.10
...
### Community 263 - "test_all_providers_discovery.py"
Cohesion: 0.16
...
### Community 264 - "TestAddConversationCacheBreakpoints"
Cohesion: 0.11
Nodes (17): _breakpoint_at(), _make_provider(), _make_request(), _msgs(), tests/test_anthropic_conversation_caching.py — Rolling conversation cache…, Fewer than stable_back+1 messages → no breakpoint added., Exactly stable_back+1 messages → breakpoint IS added., stable_back=3 means messages[-3] gets the breakpoint. (+9 more)
...
### Community 266 - "test_operational_incidents.py"
Cohesion: 0.07
...
### Community 268 - "[Unreleased]"
Cohesion: 0.06
Nodes (35): Added, Added, Added, Added, Added, Added, Added, Added (+27 more)

### Community 269 - "[Unreleased]"
Cohesion: 0.06
Nodes (35): Added, Added, Added, Added, Added, Added, Added, Added (+27 more)

### Community 270 - "Screens"
Cohesion: 0.06
...
### Community 271 - "test_anthropic_router.py"
Cohesion: 0.09
...
### Community 272 - "test_control_plane_api.py"
Cohesion: 0.06
...
### Community 273 - "test_llm_router_e2e.py"
Cohesion: 0.14
...
### Community 278 - "test_platform_controls.py"
Cohesion: 0.08
...
### Community 279 - "local_controller.py"
Cohesion: 0.12
...
### Community 280 - "test_live_server.py"
Cohesion: 0.22
...
### Community 295 - "BrainFailoverManager"
Cohesion: 0.09
...
### Community 296 - "OrchestratorQueue"
Cohesion: 0.07
...
### Community 299 - "test_one_model_catalogue.py"
Cohesion: 0.09
...
### Community 300 - "test_telegram_mutating_commands.py"
Cohesion: 0.06
Nodes (22): _Captured, _catalogue_preset(), _make_mock_response(), tests/test_telegram_mutating_commands.py — N5 acceptance: /setbrain + /merge.…, Build a mock httpx.Response., A successful /setbrain call must: 1. send the X-Service-Token header 2. PATCH…, When the backend's liveness probe fails (HTTP 422), the bot reply must surface…, 503 = backend doesn't have SERVICE_TOKEN set. The bot reply must tell the… (+14 more)
...
### Community 304 - "High-Agency Frontend Skill"
Cohesion: 0.06
Nodes (30): 10. FINAL PRE-FLIGHT CHECK, 1. ACTIVE BASELINE CONFIGURATION, 2. DEFAULT ARCHITECTURE & CONVENTIONS, 3. DESIGN ENGINEERING DIRECTIVES (Bias Correction), 4. CREATIVE PROACTIVITY (Anti-Slop Implementation), 5. PERFORMANCE GUARDRAILS, 6. TECHNICAL REFERENCE (Dial Definitions), 7. AI TELLS (Forbidden Patterns) (+22 more)

### Community 305 - "LlmProviderConfig"
Cohesion: 0.16
...
### Community 306 - "Quick-Note GitHub Issues Processing - Session Summary"
Cohesion: 0.06
...
### Community 309 - "test_mcp_governance.py"
Cohesion: 0.12
...
### Community 310 - "session_retro.py"
Cohesion: 0.13
...
### Community 311 - "test_purge_backlog.py"
Cohesion: 0.09
...
### Community 315 - "test_force_cleanup_conditional_delete.py"
Cohesion: 0.10
...
### Community 317 - "test_rag_context.py"
Cohesion: 0.12
...
### Community 318 - "test_sam_voice.py"
Cohesion: 0.07
...
### Community 319 - "ProjectScaffolder"
Cohesion: 0.13
...
### Community 320 - "timedelta"
Cohesion: 0.11
Nodes (24): PR throughput per cohort over the last `days` days., Count distinct sessions per user. A session ends when there's a gap of more…, _as_aware_utc(), _env_float(), ephemeral_reaper_loop(), datetime, services/ephemeral_reaper.py — destroy expired ephemeral companies. The…, Run the reaper forever on a fixed cadence. Never raises out of the loop. (+16 more)

### Community 321 - "SteeringInjector"
Cohesion: 0.11
...
### Community 322 - "RuntimeHealthService"
Cohesion: 0.09
...
### Community 324 - "test_internal_agent_did_work.py"
Cohesion: 0.12
...
### Community 326 - "Python Dependencies (`requirements.txt`)"
Cohesion: 0.07
...
### Community 327 - "Technical Debt Register — local-llm-server"
Cohesion: 0.07
...
### Community 328 - "SetupWizardPage.js"
Cohesion: 0.10
...
### Community 329 - "ProviderConsole.jsx"
Cohesion: 0.08
...
### Community 330 - "autonomous_fix.py"
Cohesion: 0.12
...
### Community 331 - "get_skill_bindings"
Cohesion: 0.12
Nodes (22): build_matrix(), _families(), main(), Any, Map family -> sorted list of test files that mention it (quoted token)., Return one row per family, derived entirely from code., render_markdown(), _test_evidence_index() (+14 more)

### Community 332 - "TrafficDirector"
Cohesion: 0.11
...
### Community 336 - "brain_failover.py"
Cohesion: 0.11
...
### Community 337 - "test_ceo_router.py"
Cohesion: 0.14
...
### Community 347 - "configuration-reference.md"
Cohesion: 0.11
...
### Community 348 - "Deploy: FreeBuff Telegram bot (24×7)"
Cohesion: 0.07
...
### Community 349 - "Claude Code + Qwen Local Setup"
Cohesion: 0.07
...
### Community 350 - "traffic_director.py"
Cohesion: 0.11
...
### Community 351 - "test_chat_mode_regressions.py"
Cohesion: 0.13
...
### Community 353 - "test_scheduler_hydration_bounded.py"
Cohesion: 0.09
...
### Community 354 - "validate_outbound_url"
Cohesion: 0.14
...
### Community 355 - "webui/frontend/package.json"
Cohesion: 0.07
...
### Community 357 - "VoiceCommandInterface"
Cohesion: 0.14
...
### Community 358 - "Performance Analysis — local-llm-server"
Cohesion: 0.08
...
### Community 359 - "platform_controls_router.py"
Cohesion: 0.10
...
### Community 361 - "LLM Router — troubleshooting"
Cohesion: 0.08
...
### Community 367 - "test_telegram_approval_e2e.py"
Cohesion: 0.12
...
### Community 368 - "test_daily_automation_2026_08_03.py"
Cohesion: 0.11
...
### Community 371 - "open_phase_report"
Cohesion: 0.10
...
### Community 372 - "agent/workspace.py"
Cohesion: 0.14
Nodes (20): _get_workspace_lock(), get_workspace_manager(), _hash_component(), _iso_now(), _iso_offset_hours(), _load_workspace(), BaseModel, Enum (+12 more)

### Community 373 - "dependencies"
Cohesion: 0.08
Nodes (25): axios, fast-uri, dependencies, axios, fast-uri, livekit-client, lucide-react, react (+17 more)

### Community 374 - "1. The Rules"
Cohesion: 0.08
...
### Community 377 - "TASK 4 — End-to-end approval-gate test"
Cohesion: 0.08
...
### Community 378 - "generate_context.py"
Cohesion: 0.13
...
### Community 379 - "implement_agent.py"
Cohesion: 0.12
...
### Community 381 - "test_claude_code_adapter.py"
Cohesion: 0.14
...
### Community 385 - "TestClassifyPlainText"
Cohesion: 0.08
...
### Community 386 - "test_service_token.py"
Cohesion: 0.08
...
### Community 388 - "test_harness_spec.py"
Cohesion: 0.12
...
### Community 389 - "app_settings.py"
Cohesion: 0.14
Nodes (23): all_settings(), _as_bool(), _as_int(), ephemeral_ttl_hours(), ephemeral_ttl_hours_cached(), get_setting(), _maybe_schedule_refresh(), onboarding_gate_enabled() (+15 more)

### Community 390 - "Findings"
Cohesion: 0.08
...
### Community 391 - "Local AI Stack with Docker"
Cohesion: 0.08
...
### Community 392 - "Traffic Distribution Across Providers"
Cohesion: 0.08
...
### Community 393 - "Implementation Prompt: Rich TaskBoard + Agile Sprint Integration"
Cohesion: 0.08
...
### Community 394 - "Telegram Bot Setup"
Cohesion: 0.08
...
### Community 395 - "video_transcript.py"
Cohesion: 0.12
...
### Community 396 - "control_overrides.py"
Cohesion: 0.12
...
### Community 399 - "test_agency_fix.py"
Cohesion: 0.08
...
### Community 400 - "TestModelRegistryUpdates"
Cohesion: 0.14
Nodes (5): tests/test_daily_automation_2026_07_10.py — Daily automation tests…, Verify Llama 4 and Claude Sonnet 5 cross-provider aliases are registered., Verify new models are in the packages/ai/registry., TestBrainFailoverModelAliases, TestModelRegistryUpdates

### Community 401 - "test_v3_auth.py"
Cohesion: 0.19
...
### Community 402 - "test_webui_provider_priority.py"
Cohesion: 0.21
...
### Community 404 - "WorkspaceError"
Cohesion: 0.13
Nodes (12): Any, Exception, Open an existing workspace from disk. Raises :exc:`WorkspaceNotFoundError` if…, Base class for all workspace errors., _read_manifest(), _validate_id(), WorkspaceError, WorkspaceEscapeError (+4 more)

### Community 405 - "_status_snapshot"
Cohesion: 0.15
...
### Community 406 - "model_discovery.py"
Cohesion: 0.11
Nodes (22): Return the discovered model list for *provider_id*, or ``[]`` if unknown., _served_models(), cached_models(), discover_models(), _fresh_entry(), _models_url(), _parse_ids(), Any (+14 more)

### Community 407 - "Agent Governance Guide"
Cohesion: 0.09
...
### Community 408 - "The fifteen strategies"
Cohesion: 0.09
...
### Community 414 - "test_phase4_runtime_resilience.py"
Cohesion: 0.14
...
### Community 415 - "WindowsServiceManager"
Cohesion: 0.18
...
### Community 416 - "SyntheticDataPipeline"
Cohesion: 0.13
...
### Community 417 - "test_freebuff_bot.py"
Cohesion: 0.11
...
### Community 420 - "test_cerebras_catalogue.py"
Cohesion: 0.13
...
### Community 421 - "test_monitor_lib.py"
Cohesion: 0.11
...
### Community 423 - "test_mostly_failed_steps.py"
Cohesion: 0.12
...
### Community 426 - "HarnessEnrichment"
Cohesion: 0.14
...
### Community 427 - "classify_direct_chat_intent"
Cohesion: 0.13
...
### Community 428 - "AdaptivePermissions"
Cohesion: 0.18
...
### Community 431 - "test_dashboard_cache.py"
Cohesion: 0.14
Nodes (17): _cached(), _fast_count(), get_activity(), legacy_scheduler_list(), _produce_scheduler_jobs(), Single-flight TTL cache. Concurrent callers wait for the first producer., Count without materialising rows — prefers estimated_document_count., _clear_cache() (+9 more)

### Community 432 - "AdminScreen.jsx"
Cohesion: 0.11
...
### Community 435 - "OrchestratorCheckpointStore"
Cohesion: 0.14
...
### Community 443 - "V3 API Migration Plan — LLM Relay Platform"
Cohesion: 0.10
...
### Community 450 - "test_local_controller.py"
Cohesion: 0.17
...
### Community 451 - "test_provider_state_durability.py"
Cohesion: 0.12
...
### Community 452 - "run_trend_analysis"
Cohesion: 0.18
...
### Community 453 - "test_unit5_ui_provider_surface.py"
Cohesion: 0.10
...
### Community 454 - "DirectChatDoctor"
Cohesion: 0.16
...
### Community 456 - "OperationalIncident"
Cohesion: 0.13
...
### Community 458 - "Skill: modularity-review"
Cohesion: 0.10
...
### Community 459 - "Design Audit"
Cohesion: 0.10
Nodes (19): Code Quality, Color and Surfaces, Component Patterns, Content, Design Audit, Fix Priority, How This Works, Iconography (+11 more)

### Community 460 - "Findings"
Cohesion: 0.10
...
### Community 461 - "test_minimax_bug_fixes.py"
Cohesion: 0.12
...
### Community 465 - "Docker AI Governance Audit — Final Report"
Cohesion: 0.10
...
### Community 466 - "1. Capability-by-capability"
Cohesion: 0.10
...
### Community 468 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 469 - "KnowledgeScreen.jsx"
Cohesion: 0.13
...
### Community 474 - "test_kimi_bridge_server.py"
Cohesion: 0.12
...
### Community 475 - "test_memory_guard.py"
Cohesion: 0.14
Nodes (18): _load_malloc_trim(), services/memory_guard.py — keep RSS from creeping to OOM on small dynos. The…, Parse the sweep interval, flooring it and tolerating a bad value. 180s is…, Resolve glibc ``malloc_trim``. Returns None when unavailable (non-glibc)., Run one gc sweep + malloc_trim. Returns objects collected. Never raises., _resolve_interval_sec(), trim_now(), asyncio (+10 more)

### Community 476 - "ProviderCircuit"
Cohesion: 0.15
...
### Community 477 - "PriorityTaskQueue"
Cohesion: 0.15
...
### Community 480 - "TestBrainFailoverModelUpdates"
Cohesion: 0.18
...
### Community 481 - "test_tasks_cache_ttl_env.py"
Cohesion: 0.21
...
### Community 487 - "Skill: fabric-patterns"
Cohesion: 0.11
...
### Community 488 - "Analysis & Synthesis Instructions"
Cohesion: 0.11
Nodes (18): 1. Define the Atmosphere, 2. Map the Color Palette, 3. Establish Typography Rules, 4. Define the Hero Section, 5. Describe Component Stylings, 6. Define Layout Principles, 7. Define Responsive Rules, 8. Encode Motion Philosophy (+10 more)

### Community 489 - "Production Readiness Assessment — local-llm-server"
Cohesion: 0.11
...
### Community 490 - "TestNormalizeResponseFormat"
Cohesion: 0.11
...
### Community 491 - "Skill: fabric-patterns"
Cohesion: 0.11
Nodes (18): 1. Ensure Pattern Directory Exists, 2. List Available Patterns, 3. Retrieve a Pattern, 4. Apply a Pattern with Variables, 5. Stitch Patterns Together, 6. Create New Patterns, Acceptance Checks, Directory Structure (+10 more)

### Community 492 - "db/__init__.py"
Cohesion: 0.14
...
### Community 493 - "Admin Dashboard Guide"
Cohesion: 0.11
...
### Community 494 - "Implementation Plan"
Cohesion: 0.11
...
### Community 496 - "ControlsScreen.jsx"
Cohesion: 0.16
...
### Community 497 - "Delegation Plan (agent-ready work packages)"
Cohesion: 0.11
...
### Community 498 - "test_p0_roadmap_a4_a5_b2.py"
Cohesion: 0.15
...
### Community 499 - "parse_event_stream"
Cohesion: 0.15
...
### Community 500 - "TaskHarnessAdapter"
Cohesion: 0.14
Nodes (9): Any, TaskResult, TaskSpec, Adapter for a compatible external task harness., TaskHarnessAdapter, TestTaskHarnessAdapterExecution, When task-harness is required but not present, preflight should return a…, Every preflight report must have runtime_id, ready, summary. (+1 more)

### Community 501 - "build_workflow.py"
Cohesion: 0.33
Nodes (18): _c(), _get(), _header(), main(), _make_headers(), _phase_icon(), _post(), _print_phases() (+10 more)

### Community 502 - "context_plan_gate.py"
Cohesion: 0.16
...
### Community 504 - "test_brain_patch_service_token.py"
Cohesion: 0.18
...
### Community 505 - "TestSelfHealingInfrastructureClassification"
Cohesion: 0.19
...
### Community 506 - "test_fabric_patterns.py"
Cohesion: 0.11
...
### Community 507 - "validate_session_id"
Cohesion: 0.16
...
### Community 508 - "ErrorInterceptorMiddleware"
Cohesion: 0.18
...
### Community 509 - "operational_incidents.py"
Cohesion: 0.13
...
### Community 513 - "Comprehensive Skill Index (By Category)"
Cohesion: 0.11
...
### Community 514 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 515 - "Component Map"
Cohesion: 0.11
...
### Community 516 - "render_router.py"
Cohesion: 0.14
...
### Community 517 - "Architecture Overview — local-llm-server"
Cohesion: 0.11
...
### Community 518 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
...
### Community 519 - "Platform Guide — the full tour"
Cohesion: 0.11
...
### Community 521 - "Part A — Health Report"
Cohesion: 0.11
...
### Community 525 - "sync_readme_gallery.py"
Cohesion: 0.22
...
### Community 526 - "test_p0_roadmap_b3_b4_b5.py"
Cohesion: 0.16
...
### Community 529 - "test_company_api.py"
Cohesion: 0.11
...
### Community 530 - "TestStopSlopChecker"
Cohesion: 0.11
...
### Community 531 - "test_self_heal.py"
Cohesion: 0.11
...
### Community 532 - "handle_workflow_ide_chat"
Cohesion: 0.18
...
### Community 533 - "test_contract_enforcement.py"
Cohesion: 0.17
...
### Community 539 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 540 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 541 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 542 - "cost_tracker.py"
Cohesion: 0.13
Nodes (16): clear_cost_attribution(), cost_table(), Return the active per-model cost table (USD per million tokens). Useful for…, Reset in-memory cost attribution counters. Admin-only., _build_cost_table(), clear_stats(), get_cost_table(), get_stats() (+8 more)

### Community 543 - "Section-by-Section Acceptance Criteria"
Cohesion: 0.12
...
### Community 544 - "SkillsScreen.jsx"
Cohesion: 0.12
...
### Community 545 - "provider_max_rpm"
Cohesion: 0.17
...
### Community 546 - "redact_connection_url"
Cohesion: 0.17
...
### Community 547 - "kimi_bridge_provider_config"
Cohesion: 0.18
...
### Community 548 - "agent_readiness_audit.py"
Cohesion: 0.21
...
### Community 551 - "TestAListingFailureDoesNotVetoTheAnswer"
Cohesion: 0.17
...
### Community 552 - "test_daily_automation_2026_07_11.py"
Cohesion: 0.15
...
### Community 553 - "test_frontend_deployment_guards.py"
Cohesion: 0.18
...
### Community 554 - "test_health_endpoints.py"
Cohesion: 0.17
...
### Community 555 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 556 - "test_openclaw_endpoints.py"
Cohesion: 0.12
...
### Community 558 - "test_skill_registry.py"
Cohesion: 0.13
...
### Community 559 - "test_task_service_failed_comment.py"
Cohesion: 0.18
...
### Community 560 - "hermes_prompt.py"
Cohesion: 0.19
...
### Community 562 - "MemoryMiddleware"
Cohesion: 0.17
...
### Community 563 - "Workspace"
Cohesion: 0.13
Nodes (7): Resolve *relative* inside source dir and reject traversal/symlink escapes., Open a workspace for resumption. Only READY or PAUSED workspaces may be…, Raise :exc:`WorkspaceAccessDeniedError` if *requesting_session_id* doesn't own…, Resolve *relative* within *ws*.source and reject traversal/symlink escapes.…, Remove and recreate the tmp directory for *ws*., Workspace, WorkspaceAccessDeniedError

### Community 564 - "AITellIssue"
Cohesion: 0.17
...
### Community 565 - "Skill: repowise-intelligence"
Cohesion: 0.12
...
### Community 566 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
...
### Community 567 - "_valid_login_state"
Cohesion: 0.24
...
### Community 568 - "Skill: repowise-intelligence"
Cohesion: 0.12
Nodes (15): 1. Graph Intelligence (Dependency Graph), 2. Git Intelligence, 3. Documentation Intelligence, 4. Decision Intelligence, Acceptance Checks, Directory Structure, Example Usage, Implementation Approach (+7 more)

### Community 569 - "The 10-Step Workflow"
Cohesion: 0.12
...
### Community 570 - "Contributing to local-llm-server"
Cohesion: 0.12
...
### Community 571 - "refresh_agent_built_proof.py"
Cohesion: 0.20
...
### Community 572 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 573 - "Feature Maturity / Support Matrix"
Cohesion: 0.12
...
### Community 574 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 576 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
...
### Community 577 - "test_agent_chat_integration.py"
Cohesion: 0.23
...
### Community 584 - "test_telegram_auto_approve.py"
Cohesion: 0.21
...
### Community 585 - "ManagedAgentDreams"
Cohesion: 0.22
...
### Community 586 - "_process_task_callback"
Cohesion: 0.28
...
### Community 587 - "test_agency_workflows_carry_the_failover_chain.py"
Cohesion: 0.18
...
### Community 588 - "test_autonomy_status.py"
Cohesion: 0.12
...
### Community 589 - "test_brain_failover_413.py"
Cohesion: 0.13
...
### Community 591 - "test_dockerfile_ships_root_modules.py"
Cohesion: 0.17
...
### Community 592 - "test_langfuse_agency_wide.py"
Cohesion: 0.12
...
### Community 593 - "test_local_brain_state.py"
Cohesion: 0.12
...
### Community 595 - "test_nvidia_default_model.py"
Cohesion: 0.17
...
### Community 596 - "test_phase5_doctor.py"
Cohesion: 0.12
...
### Community 597 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 598 - "test_refresh_agent_built_proof.py"
Cohesion: 0.12
...
### Community 599 - "test_telegram_diag_endpoint.py"
Cohesion: 0.12
...
### Community 602 - "Skill: agent-harness"
Cohesion: 0.13
...
### Community 603 - "Skill: checkpoint-strategy"
Cohesion: 0.13
...
### Community 605 - "Skill: local-ai-query"
Cohesion: 0.13
...
### Community 606 - "Skill: parallel-agents"
Cohesion: 0.13
...
### Community 607 - "Skill: parallel-worktrees"
Cohesion: 0.13
...
### Community 608 - "Design System: Taste Standard"
Cohesion: 0.13
...
### Community 610 - "Skill: user-research"
Cohesion: 0.13
...
### Community 612 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 616 - "_push_down_where"
Cohesion: 0.14
...
### Community 617 - "router/health.py"
Cohesion: 0.20
...
### Community 618 - "DockerAgentAdapter"
Cohesion: 0.17
...
### Community 620 - "clear_wizard_state_cache"
Cohesion: 0.21
...
### Community 621 - "e2e/test_browser.py"
Cohesion: 0.23
...
### Community 622 - "DecisionsStoreTests"
Cohesion: 0.13
...
### Community 623 - "test_dockerfile_ships_config_dir.py"
Cohesion: 0.14
...
### Community 625 - "test_scanner_live.py"
Cohesion: 0.23
...
### Community 629 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 633 - "Checks Performed"
Cohesion: 0.14
...
### Community 634 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 635 - "admin_digest_router.py"
Cohesion: 0.22
...
### Community 636 - "Skill: branch-cleanup"
Cohesion: 0.14
...
### Community 637 - "Skill: perplexity — Web Research via Perplexity API"
Cohesion: 0.14
...
### Community 640 - "Nothing is blocked on an agent. Two things need a human."
Cohesion: 0.14
...
### Community 641 - "Quick-Note Issues Processing Summary"
Cohesion: 0.14
...
### Community 642 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 644 - "Render MCP — autonomous platform debugging and environment monitoring"
Cohesion: 0.14
...
### Community 645 - "Runbook: Auto-Resume After Cooldown / Interruption"
Cohesion: 0.14
...
### Community 646 - "SEO / GEO / AIO Audit Engine"
Cohesion: 0.14
...
### Community 650 - "_parse_reset_epoch"
Cohesion: 0.21
...
### Community 652 - "is_anthropic_base_url"
Cohesion: 0.18
...
### Community 653 - "extract_failures"
Cohesion: 0.21
...
### Community 655 - "test_critical_flows.py"
Cohesion: 0.29
...
### Community 656 - "TestAnthropicToolListCaching"
Cohesion: 0.34
...
### Community 657 - "test_autonomy_pipeline_regressions.py"
Cohesion: 0.15
...
### Community 660 - "test_openclaw_gateway.py"
Cohesion: 0.14
...
### Community 661 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 662 - "test_tasks_awaiting_approval_api.py"
Cohesion: 0.37
...
### Community 663 - "test_telegram_task_callback.py"
Cohesion: 0.20
...
### Community 665 - "summarise_phases"
Cohesion: 0.15
...
### Community 667 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 670 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 671 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 674 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
...
### Community 675 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 676 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 678 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 680 - "admin_update_task_router.py"
Cohesion: 0.22
...
### Community 682 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
Nodes (12): Acceptance Checks, Claude's query protocol (use this instead of Read tool for exploration):, Graph Artifacts — What to Commit, How to Use the Graph (Token Savings Protocol), Installation (one-time per machine), Instead of reading raw files:, Key commands:, Relationship to repowise-intelligence Skill (+4 more)

### Community 683 - "Skill: platform-setup — Autonomous Agency Bootstrap"
Cohesion: 0.15
...
### Community 684 - "Device compatibility and model picks"
Cohesion: 0.15
...
### Community 685 - "Autonomy Uplift — Living Roadmap & Detailed Implementation Specs"
Cohesion: 0.15
...
### Community 689 - "ApplyReviewAgent"
Cohesion: 0.22
...
### Community 691 - "_is_bedrock_model_id"
Cohesion: 0.27
...
### Community 693 - "Agent Transparency Report"
Cohesion: 0.15
...
### Community 694 - "update_provider_policy"
Cohesion: 0.19
...
### Community 696 - "_InMemoryBackend"
Cohesion: 0.18
...
### Community 698 - "TestModelCostTableUpdates"
Cohesion: 0.26
...
### Community 699 - "TestMCPClientStructuredOutput"
Cohesion: 0.31
...
### Community 700 - "TestDecisionsBotLinks"
Cohesion: 0.21
...
### Community 701 - "test_deploy_trigger_covers_image.py"
Cohesion: 0.21
...
### Community 702 - "test_doctor_service_token_check.py"
Cohesion: 0.23
...
### Community 703 - "TestKillSwitchDurability"
Cohesion: 0.15
...
### Community 704 - "test_quick_note_engine.py"
Cohesion: 0.17
...
### Community 705 - "TestRouterIntegration"
Cohesion: 0.31
...
### Community 707 - "WorkspaceManifest"
Cohesion: 0.17
...
### Community 708 - "skill_registry.py"
Cohesion: 0.17
...
### Community 710 - "WorkspaceManager"
Cohesion: 0.21
...
### Community 711 - "AGENTS.md — Codebase Map & Operations Reference"
Cohesion: 0.17
...
### Community 716 - "Skill: system-prompt-audit"
Cohesion: 0.17
...
### Community 717 - "Skill: task-alive-updates"
Cohesion: 0.17
...
### Community 720 - "sync_catalog_route"
Cohesion: 0.18
...
### Community 721 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 724 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 726 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 727 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 728 - "Workspace Isolation Architecture"
Cohesion: 0.17
...
### Community 729 - "Quantization Internals"
Cohesion: 0.17
...
### Community 730 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 731 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 732 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 736 - "check_container_posture.py"
Cohesion: 0.26
...
### Community 737 - "test_pytest_failure_parser.py"
Cohesion: 0.23
...
### Community 738 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 739 - "test_admin_local_brain_router.py"
Cohesion: 0.29
...
### Community 740 - "test_agile_api.py"
Cohesion: 0.17
...
### Community 741 - "test_app_settings.py"
Cohesion: 0.21
...
### Community 742 - "test_brain_default_consistency.py"
Cohesion: 0.24
...
### Community 743 - "TestAuthAndTaskOwnership"
Cohesion: 0.17
...
### Community 744 - "test_providers_live_e2e.py"
Cohesion: 0.27
...
### Community 745 - "TestAnthropicPayloadStructuredOutput"
Cohesion: 0.29
...
### Community 746 - "test_task_clarification.py"
Cohesion: 0.17
...
### Community 748 - "make_isolated_workspace"
Cohesion: 0.33
...
### Community 750 - "_extractive_compress"
Cohesion: 0.18
...
### Community 752 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 755 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 756 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 758 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 761 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 762 - "Main proxy (`proxy.py`)"
Cohesion: 0.18
...
### Community 763 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 764 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 765 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 766 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 767 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 768 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 769 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 771 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 772 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 773 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 774 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 776 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 783 - "test_agent_readiness_audit.py"
Cohesion: 0.18
...
### Community 784 - "test_conftest_hermetic_env.py"
Cohesion: 0.18
...
### Community 785 - "TestAgentRunnerSafety"
Cohesion: 0.24
...
### Community 786 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 787 - "test_event_log.py"
Cohesion: 0.45
...
### Community 788 - "test_google_provider_models.py"
Cohesion: 0.18
...
### Community 789 - "TestNoNvidiaFallbackIsRetired"
Cohesion: 0.22
...
### Community 790 - "mint_access_token"
Cohesion: 0.18
...
### Community 794 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 795 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 796 - "admin_local_brain_router.py"
Cohesion: 0.22
...
### Community 798 - "_normalize_tool_choice"
Cohesion: 0.31
...
### Community 799 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 800 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 801 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 802 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 803 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 804 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 805 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 807 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 808 - "LLM Router — configuration guide"
Cohesion: 0.20
...
### Community 809 - "LLM Router — provider guide"
Cohesion: 0.20
...
### Community 813 - "TestModelsEndpointAliases"
Cohesion: 0.31
...
### Community 818 - "_resolve_push_token"
Cohesion: 0.31
...
### Community 819 - "TestExtendedThinkingRouting"
Cohesion: 0.20
...
### Community 821 - "TestPoliciesGovernanceStableClaim"
Cohesion: 0.20
...
### Community 830 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 831 - "Skill: changelog-enforcer"
Cohesion: 0.22
...
### Community 832 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 834 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 835 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 836 - "Skill: changelog-enforcer"
Cohesion: 0.22
Nodes (8): Acceptance Checks, Changelog Location, Entry Format, Examples, Hook Behaviour, Instructions, Skill: changelog-enforcer, When to Use

### Community 837 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
Nodes (8): Branch, Components, Purpose, Quick Start, Session Roles, Skill: cowork-session (Claude Cowork), Testing, When to Use

### Community 838 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 839 - "Active Task Tracker"
Cohesion: 0.22
...
### Community 841 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 842 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 843 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 844 - "Issue #1356: quick-note:https://searchengineland.com/turn-seo-backlog-into-roadmap-485713"
Cohesion: 0.22
...
### Community 845 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 846 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 847 - "Platform Controls"
Cohesion: 0.22
...
### Community 848 - "Release Procedure"
Cohesion: 0.22
...
### Community 849 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 852 - "ENGINEERING_STANDARDS.md — Patterns & Reference"
Cohesion: 0.22
...
### Community 854 - "TestTheProducersAndTheParserCannotDrift"
Cohesion: 0.25
...
### Community 855 - "_get_current_user"
Cohesion: 0.25
...
### Community 862 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 863 - "test_changelog_parity_guard.py"
Cohesion: 0.22
...
### Community 865 - "TestGithubSignalHardening"
Cohesion: 0.22
...
### Community 866 - "TestPaidPolicyDurability"
Cohesion: 0.22
...
### Community 867 - "test_scanner_deps_parity.py"
Cohesion: 0.31
...
### Community 882 - "ADR 001: Self-Hosted OpenAI-Compatible Proxy"
Cohesion: 0.25
...
### Community 884 - "AGENTS.md — AI Agent Configuration for local-llm-server"
Cohesion: 0.25
...
### Community 885 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 889 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.25
...
### Community 890 - "Issue #362: Nvidia repo setup"
Cohesion: 0.25
...
### Community 891 - "Issue #364: quick-note:https://www.marktechpost.com/2026/06/01/meet-memory-os-a-6-layer-open-source-memory-stack-built-on-top-of-hermes-agent/"
Cohesion: 0.25
...
### Community 892 - "Issue #378: quick-note:https://www.marktechpost.com/2026/06/02/tinyfish-launches-bigset-an-open-source-multi-agent-system-that-builds-structured-live-datasets-from-plain-english-descriptions/"
Cohesion: 0.25
...
### Community 893 - "Issue #379: quick-note:https://searchengineland.com/schema-markup-optimize-agentic-web-479080"
Cohesion: 0.25
...
### Community 894 - "Issue #380: quick-note:https://cursor.com/blog/cloud-agent-lessons"
Cohesion: 0.25
...
### Community 895 - "Issue #381: quick-note:https://www.xda-developers.com/claude-code-with-opus-48-is-expensive-but-i-made-it-efficient-with-my-local-ai-workflow/"
Cohesion: 0.25
...
### Community 896 - "Issue #382: quick-note:https://claude.com/blog/how-coderabbit-used-claude-to-build-an-agent-orchestration-system"
Cohesion: 0.25
...
### Community 897 - "Issue #383: quick-note:https://www.marktechpost.com/2026/05/29/hexo-labs-open-sources-sia-a-self-improving-agent-that-updates-both-the-harness-and-the-model-weights/"
Cohesion: 0.25
...
### Community 898 - "Issue #416: feat: Self-hosted Codebuff (freebuff) on free NVIDIA models + Telegram bot phone control"
Cohesion: 0.25
...
### Community 899 - "Issue #485: [Trend Digest] Week of 2026-06-08"
Cohesion: 0.25
...
### Community 900 - "Issue #488: quick-note:https://github.com/cookiy-ai/user-research-skill"
Cohesion: 0.25
...
### Community 901 - "Issue #491: Implement whatever is necessary from https://github.com/BehiSecc/awesome-claude-skills"
Cohesion: 0.25
...
### Community 902 - "Issue #493: Use the https://github.com/mvanhorn/last30days-skill skill to get the trend updated"
Cohesion: 0.25
...
### Community 903 - "Issue #495: Read https://www.anthropic.com/news/claude-fable-5-mythos-5 and understand if mythos or fable can be added to the repo"
Cohesion: 0.25
...
### Community 904 - "Issue #504: EPIC: Autonomy hardening — live-verified defects 2026-06-10"
Cohesion: 0.25
...
### Community 905 - "Issue #581: Sprint tracker: pending work after brand rename + mobile-first pass"
Cohesion: 0.25
...
### Community 907 - "Issue #657: quick-note:https://github.com/earendil-works/pi"
Cohesion: 0.25
...
### Community 908 - "Issue #659: quick-note:https://github.com/nex-agi/Nex-N2"
Cohesion: 0.25
...
### Community 909 - "Issue #660: quick-note:https://github.com/getsentry/sentry-for-ai"
Cohesion: 0.25
...
### Community 910 - "Issue #661: quick-note:https://github.com/XiaomiMiMo/MiMo-Code"
Cohesion: 0.25
...
### Community 911 - "Issue #664: quick-note:https://github.com/Grominet95/jarvis-OS"
Cohesion: 0.25
...
### Community 912 - "Issue #666: quick-note:https://github.com/porokka/jarvis-os"
Cohesion: 0.25
...
### Community 913 - "Issue #670: quick-note:https://github.com/perplexityai/bumblebee"
Cohesion: 0.25
...
### Community 914 - "Issue #672: quick-note:https://github.com/Chachamaru127/claude-code-harness"
Cohesion: 0.25
...
### Community 915 - "Issue #676: quick-note:https://github.com/WeiboAI/VibeThinker"
Cohesion: 0.25
...
### Community 916 - "Issue #820: quick-note:https://github.com/cobusgreyling/loop-engineering"
Cohesion: 0.25
...
### Community 917 - "Positional Encoding Internals"
Cohesion: 0.25
...
### Community 919 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 920 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 921 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 922 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 923 - "Prime Agent Runtime"
Cohesion: 0.25
...
### Community 927 - "run_patched_colibri.py"
Cohesion: 0.36
...
### Community 930 - "TestItIsNotBuiltForOneVendor"
Cohesion: 0.25
...
### Community 931 - "test_compose_and_coordinate_api.py"
Cohesion: 0.36
...
### Community 932 - "test_daily_automation_2026_07_09.py"
Cohesion: 0.25
...
### Community 934 - "test_local_brain_router_smoke.py"
Cohesion: 0.25
...
### Community 938 - "test_provider_models_db_outage.py"
Cohesion: 0.25
...
### Community 939 - "test_runtimes_health_endpoint.py"
Cohesion: 0.25
...
### Community 941 - "test_serve_spa_prefixes.py"
Cohesion: 0.36
...
### Community 942 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.25
...
### Community 945 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 957 - "AI Engineering Insights Skill"
Cohesion: 0.29
...
### Community 970 - "Changelog"
Cohesion: 0.29
Nodes (7): Added, Changed, Changelog, Fixed, Maintenance, Removed, Security

### Community 971 - "claude-mem Plugin — Persistent Memory for All Sessions"
Cohesion: 0.29
...
### Community 972 - "Implementation plan + TO-DO (check off as you go)"
Cohesion: 0.29
...
### Community 977 - "Workspace Issues"
Cohesion: 0.29
...
### Community 978 - "Model and Response Issues"
Cohesion: 0.29
...
### Community 986 - "e2e_smoke.py"
Cohesion: 0.57
Nodes (5): _chat(), check(), _health(), _models(), _req()

### Community 987 - "task_runner.py"
Cohesion: 0.33
...
### Community 991 - "test_daily_2026_06_14.py"
Cohesion: 0.38
...
### Community 993 - "TestGithubTokenSQLiteRegression"
Cohesion: 0.38
...
### Community 994 - "test_log_monitor_storm_guard.py"
Cohesion: 0.48
...
### Community 995 - "TestReasonsAreActionable"
Cohesion: 0.29
...
### Community 996 - "TestProvidersScreen"
Cohesion: 0.43
...
### Community 1016 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 1017 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 1018 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 1019 - "The full agent capability roster"
Cohesion: 0.33
...
### Community 1021 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 1022 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 1025 - "resolve_hermes_base_url"
Cohesion: 0.47
...
### Community 1027 - "apply_phase1_changes.py"
Cohesion: 0.33
...
### Community 1029 - "check_doc_images.py"
Cohesion: 0.60
...
### Community 1040 - "test_catalogue_probe.py"
Cohesion: 0.33
...
### Community 1058 - "Who is this for?"
Cohesion: 0.40
...
### Community 1062 - "Admin Dashboard Issues"
Cohesion: 0.40
...
### Community 1063 - "Agent API Issues"
Cohesion: 0.40
...
### Community 1064 - "Network and Tunnel Issues"
Cohesion: 0.40
...
### Community 1065 - "knowledgeGraphTab.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 1066 - "loginFlowNoTimeout.test.js"
Cohesion: 0.40
Nodes (4): apiSource, { describe, test, expect }, fs, path

### Community 1067 - "test_company_stale_id_recovery.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 1068 - "worker_no_cache.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, workerSource

### Community 1069 - "scripts/agile_ceremonies.py"
Cohesion: 0.60
Nodes (4): _load(), main(), ModuleType, _write_summary()

### Community 1070 - "governance/__init__.py"
Cohesion: 0.40
Nodes (3): __getattr__(), Any, packages/governance — agent identity, policy, approvals, audit, sandboxes. The…

### Community 1071 - "Prompt Library Changelog"
Cohesion: 0.40
Nodes (4): Added, Format, Prompt Library Changelog, [Unreleased]

### Community 1072 - "_add_colibri_shim_changelog_entry.py"
Cohesion: 0.50
...
### Community 1073 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1074 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1075 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 1076 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 1078 - "setup_colibri.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1079 - "setup_colibri.sh script"
Cohesion: 0.70
Nodes (4): setup_colibri.sh script, fail(), ok(), warn()

### Community 1080 - "status_colibri_server.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1082 - "TestMobileNavigation"
Cohesion: 0.40
Nodes (3): Mobile-specific: hamburger menu, responsive layout., Verify key pages load in mobile viewport., TestMobileNavigation

### Community 1083 - "test_v5_screens_smoke.py"
Cohesion: 0.50
...
### Community 1085 - "test_agent_runtime_wrapper.py"
Cohesion: 0.70
...
### Community 1086 - "TestNoKeyEverReachesTheLog"
Cohesion: 0.40
...
### Community 1087 - "TestTheProbeIdentifiesItself"
Cohesion: 0.40
...
### Community 1090 - "TestModelRoleSeparation"
Cohesion: 0.40
...
### Community 1091 - "worker/index.js"
Cohesion: 0.60
Nodes (4): fetch(), needsProxy(), PROXY_PREFIXES, scheduled()

### Community 1094 - "recovery.py"
Cohesion: 0.67
...
### Community 1107 - "Claude Code Specific Issues"
Cohesion: 0.50
...
### Community 1110 - "render"
Cohesion: 0.50
Nodes (3): RENDER_API_KEY, docker, render

### Community 1111 - "scripts"
Cohesion: 0.50
Nodes (4): scripts, build, start, test

### Community 1113 - "_clean_director"
Cohesion: 0.50
...
### Community 1114 - "stop_colibri_server.ps1"
Cohesion: 0.83
Nodes (3): Fail(), Ok(), W()

### Community 1116 - "start_server.sh"
Cohesion: 0.50
Nodes (3): OLLAMA_HOST, OLLAMA_MODELS, start_server.sh script

### Community 1117 - "check_services"
Cohesion: 0.67
...
### Community 1127 - "test_no_exception_detail_leaks.py"
Cohesion: 0.50
...
### Community 1128 - "test_skills_route_order.py"
Cohesion: 0.67
...
### Community 1129 - "github"
Cohesion: 0.50
Nodes (3): github, enabled, silent

### Community 1133 - "Configuration reference"
Cohesion: 0.67
Nodes (3): Configuration reference, Provider priority chain, Running the brain on local Ollama (via a tunnel)

### Community 1156 - "test_the_reserve_is_bounded_when_read_from_the_environment"
Cohesion: 0.67
...
### Community 1157 - "test_direct_adapter_does_not_bypass"
Cohesion: 0.67
...
## Knowledge Gaps
- **3428 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3423 more)
...
- **Why does `_fixture()` connect `_fixture` to `resolve_identity`, `test_governance_enforcement.py`, `reset_kv_state`, `test_llm_router_strategies.py`, `TaskStore`, `test_unit8_model_catalog.py`, `test_llm_router_queue_cache.py`, `test_catalogue_probe.py`, `ImprovementLoop`, `test_company_api.py`, `llm/router.py`, `services/seo_audit.py`, `E2BSandboxSession`, `config.py`, `SelfHealingAgent`, `services/background.py`, `cost_tracker.py`, `NotificationDispatcher`, `test_llm_router_resilience.py`, `MCPClient`, `Task`, `validate_policy_text`, `test_failover_client_shared.py`, `test_model_router.py`, `test_openclaw_endpoints.py`, `UserRole`, `test_task_service_failed_comment.py`, `ai/router.py`, `PrimeAgentAdapter`, `test_unit7_catalog_propagation.py`, `AgentSwarm`, `AgentDefinition`, `ChatHistoryStore`, `routed`, `SQLiteStore`, `TaskExecutionCoordinator`, `test_telegram_auto_approve.py`, `tasks/service.py`, `test_autonomy_status.py`, `test_brain_failover_413.py`, `ResearchTask`, `model_router.py`, `test_local_brain_state.py`, `test_ai_insights.py`, `TestClient`, `test_phase5_doctor.py`, `DetectedSystem`, `ArtifactStore`, `OutputFilter`, `test_procedural_memory.py`, `test_refresh_agent_built_proof.py`, `test_provider_router.py`, `test_agent_tool_governance.py`, `test_telegram_diag_endpoint.py`, `claim`, `_clean_director`, `AgentJobManager`, `ScheduledJob`, `sam`, `KeyStore`, `FeatureMaturity`, `e2e/test_browser.py`, `test_knowledge_sync.py`, `SeoFixer`, `run_task`, `WorkflowOrchestrator`, `test_llm_router_tpm.py`, `AgentPlan`, `test_context_rulebook.py`, `KeyPool`, `TestRuntimeControl`, `test_openclaw_gateway.py`, `test_startup_warmup.py`, `test_telegram_task_callback.py`, `test_issue_intake.py`, `_step`, `BackgroundAgent`, `BrainWatchdog`, `TestHarnessAdapter`, `persist_plan_spec`, `test_new_features_e2e.py`, `test_e2b_adapter.py`, `BudgetTracker`, `test_daily_2026_07_27.py`, `_Budget`, `_resolve_user_github_token`, `OllamaCircuitBreaker`, `test_doctor_service_token_check.py`, `_job_text`, `test_portfolio_intake.py`, `test_features_api.py`, `test_video_transcript.py`, `TrendWatcher`, `test_agent_free_brain.py`, `test_process_quick_note_workflow.py`, `apply_review.py`, `test_agile_api.py`, `test_app_settings.py`, `test_e2b_data_flow.py`, `TestAuthAndTaskOwnership`, `test_trend_watcher.py`, `test_task_clarification.py`, `WorkflowRun`, `TestEstimateTokensForMessages`, `test_llm_router_disabled.py`, `TestClient`, `ContextPruner`, `test_brain_availability_doctor.py`, `WorkflowBuildRequest`, `test_implement_agent_routing.py`, `test_brain_failover.py`, `test_persistent_memory.py`, `SecurityScanner`, `test_control_plane_api.py`, `test_llm_router_e2e.py`, `test_platform_controls.py`, `test_rate_limiter.py`, `OrchestratorQueue`, `test_nvidia_model_discovery.py`, `capture_screens.py`, `test_telegram_mutating_commands.py`, `_resolve_push_token`, `session_retro.py`, `test_purge_backlog.py`, `TestMongoGate`, `analyze_page`, `test_sam_voice.py`, `timedelta`, `test_ceo_router.py`, `test_agent_scripts_share_one_model_list.py`, `test_crispy_burn_in.py`, `test_provider_enable_disable.py`, `test_skill_registry_boot_refresh.py`, `_start_ceo_agency`, `TestSwarmRoleRouting`, `isolated_telegram_config`, `test_scheduler_hydration_bounded.py`, `platform_controls_router.py`, `_undeclared`, `test_claude_code_adapter.py`, `test_service_token.py`, `test_harness_spec.py`, `test_regression.py`, `test_agency_fix.py`, `test_webui_provider_priority.py`, `model_discovery.py`, `api_keys_for`, `test_daily_automation_2026_07_09.py`, `test_monitor_lib.py`, `test_ping.py`, `test_v4_api.py`, `test_runtimes_health_endpoint.py`, `test_task_store_fails_loud_in_production.py`, `test_dashboard_cache.py`, `.record`, `test_provider_state_durability.py`, `test_kimi_bridge_server.py`, `client`, `TestTheWorkflowIsSafeAndReadOnly`, `test_doctor_coding_brain.py`, `test_voice_pipeline.py`, `TestNormalizeResponseFormat`, `parse_event_stream`, `test_brain_patch_service_token.py`, `operational_incidents.py`?**
  _High betweenness centrality (0.103) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderRouter` to `test_implement_agent_routing.py`, `ProviderConfig`, `backend/server.py`, `test_all_providers_discovery.py`, `test_bedrock_live.py`, `is_anthropic_base_url`, `test_anthropic_router.py`, `TestFromEnvBedrock`, `kimi_bridge_provider_config`, `failover_client.py`, `settings.py`, `ai/router.py`, `TestRouterIntegration`, `TrafficDirector`, `test_bedrock_provider.py`, `test_provider_router.py`, `test_chat_mode_regressions.py`, `TestAnthropicPayloadStructuredOutput`, `NvidiaProvider`, `test_colibri_brain_shim.py`, `direct_chat.py`, `implement_agent.py`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `proxy.py`, `resolve_identity`, `agency.py`, `AgentPlan`, `FreeBuffAgent`, `backend/server.py`, `TaskSpec`, `TestAgentRunnerExecution`, `TestAgentRunnerSafety`, `test_empirical_verify.py`, `E2BSandboxSession`, `loop.py`, `test_governance_api.py`, `ContextManager`, `ReactScratchpad`, `MultiAgentSwarm`, `BackgroundAgent`, `test_daily_automation_2026_07_09.py`, `ExecutionRequest`, `MCPClient`, `test_daily_automation_2026_07_11.py`, `test_e2b_adapter.py`, `TestAgentLoopMCPIntegration`, `AdaptiveHalter`, `test_failover_client_shared.py`, `StuckDetector`, `WorkspaceTools`, `AgentSessionStore`, `test_agent_chat_integration.py`, `test_brain_failover_413.py`, `test_agent_free_brain.py`, `UserMemoryStore`, `LocalWorkspace`, `test_provider_router.py`, `test_agent_tool_governance.py`, `AgentJobManager`, `TokenBudget`, `GitHubTools`, `test_backend_server_features.py`, `CEODispatcher`, `InternalAgentAdapter`, `WorkflowOrchestrator`, `direct_chat.py`, `ContextPruner`?**
...
- **What connects `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script` to the rest of the system?**
  _3428 weakly-connected nodes found - possible documentation gaps or missing edges._