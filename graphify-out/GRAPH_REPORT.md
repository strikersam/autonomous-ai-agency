...
## Corpus Check
- 1511 files · ~2,191,363 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 54 file(s) not represented in the graph (top: (none) 16, .bat 5, .css 5)

## Summary
- 31887 nodes · 59246 edges · 1322 communities (1151 shown, 123 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 3973 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8d47e96a`
...
## Communities (1322 total, 123 thin omitted)

### Community 0 - "Specialist"
Cohesion: 0.03
Nodes (58): match_specialists(), SystemType, Match specialists to a task. Returns the best specialists for the given task…, SpecialistFamily, Find all specialists of a specific family., Find specialists that can handle a task with given capabilities., A specialist agent that can be provisioned for company-specific tasks., Check if this specialist can handle a task with given capabilities. (+50 more)

### Community 1 - "services/seo_audit.py"
Cohesion: 0.06
Nodes (39): A single occurrence of a check firing on a specific URL., Aggregated report row - Screaming Frog CSV compatible., Site-level facts discovered during the crawl., An agent-delegable remediation work package derived from the findings. Findings…, SeoDelegationTask, SeoIssueInstance, SeoIssueReportRow, SeoSiteFindings (+31 more)

### Community 2 - "backend/server.py"
Cohesion: 0.01
Nodes (251): get_skill_registry_safe(), Return the global SkillRegistry if set, else None. Used by onboarding and other…, _agent_provider_failure_response(), _agent_timeout_fallback_response(), AgentStatusEntry, AgentStatusResponse, AgentToolCallEntry, ApiKeyCreate (+243 more)
...
Cohesion: 0.02
Nodes (101): _load(), main(), ModuleType, Scheduled agile ceremonies digest. Run by `.github/workflows/agile-…, _write_summary(), Test hook — clear all usage accounting., reset(), CacheManager (+93 more)

### Community 6 - "ExecutionRequest"
Cohesion: 0.02
Nodes (142): Return orchestrator queue depth, active runs, and supervisor state (#522)., Called by APScheduler when a cron fires. Dispatches to the orchestrator. This…, _scheduler_on_fire(), workflow_orchestrator_status(), get_orchestrator_queue(), get_orchestrator_supervisor(), OrchestratorSupervisor, Any (+134 more)

### Community 7 - "proxy.py"
Cohesion: 0.03
Nodes (164): Describes a single worker's task and constraints., WorkerSpec, middleware, admin_control(), admin_delete_user(), admin_login(), admin_logout(), admin_rotate_user() (+156 more)

### Community 8 - "LLMRouter"
Cohesion: 0.03
Nodes (66): Attempt, Read the environment variables named in ``env_names`` into a key list. Order is…, resolve_keys(), LLMRouter, run(), Any, AsyncClient, BaseException (+58 more)
...
### Community 12 - "Task"
Cohesion: 0.04
Nodes (66): Task, Full task/issue document., Task, One-line human explanation of why this task needs human approval. Reads risk…, Best-effort label of who will run this task once approved. Returns…, PUBLIC_URL-anchored dashboard deep link for the task detail. Returns empty…, Best-effort Telegram heads-up that a task is parked awaiting approval. Inline…, Record the human decision on a task's **pre-execution** approval gate. A… (+58 more)

### Community 13 - "AgentJobManager"
Cohesion: 0.02
Nodes (87): PreflightReport, AgentJob, AgentJobManager, heartbeat(), make_isolated_workspace(), _now(), Any, Path (+79 more)

### Community 14 - "_StubProvider"
Cohesion: 0.08
...
Cohesion: 0.05
Nodes (81): CEODispatcher, _harvest_changed_files(), Extract the files a runtime touched. Returns ``(files, reported)``. Adapters…, Real CEO delegation: wake runtimes, fan out, and merge results., Record the goal and its sub-tasks in the ledger before any work runs. Writing…, A subtask's full history: what it is, and every attempt at it., SubtaskRecord, _base_result() (+73 more)

### Community 18 - "tasks/models.py"
Cohesion: 0.04
Nodes (60): tasks — Task/issue management system. Provides a lightweight task/issue tracker…, ApprovalCheckpoint, _coerce_ts(), ExecutionLogEntry, Any, Enum, field_validator, tasks/models.py — Pydantic models for the task/issue system. (+52 more)
...
Cohesion: 0.04
Nodes (55): AgentRunner, _check_extra_kwargs(), _enforce_signature(), Any, Path, Raise TypeError if fn's signature drifts from the locked contract (Pydantic…, Raise TypeError on unknown kwarg (runtime extra='forbid' for non-Pydantic…, Governance seam: judge the call, run it, audit the outcome. Deliberately a thin… (+47 more)

### Community 21 - "TaskSpec"
Cohesion: 0.03
Nodes (107): kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, AiderAdapter, TaskResult, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Run aider non-interactively via `--message` flag., Adapter for Aider — TIER 3 specialized git-aware code editor., ClaudeCodeAdapter (+99 more)

### Community 22 - "test_runtimes.py"
Cohesion: 0.03
Nodes (48): CircuitState, runtimes/health.py — RuntimeHealthService. Periodically polls all registered…, Reduce probe frequency for runtimes that have never come online., Any, Return health status for all registered runtimes., Return routing decision audit log (newest first)., Actively wake every sleeping/circuit-open runtime. The default health service…, True if the runtime is healthy enough for the router to select it. (+40 more)
...
### Community 25 - "AgentSessionStore"
Cohesion: 0.06
...
### Community 27 - "resolve_identity"
Cohesion: 0.03
Nodes (115): _egress_policy_reason(), agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Return why governance policy blocks *host*, or None. Runs strictly *after* the…, _load(), Import the governance layer once, recording why if it is absent., governance_enabled(), True when the governance layer should run at all. A single global off switch…, AgentIdentity (+107 more)

### Community 28 - "brain_config.py"
Cohesion: 0.03
Nodes (110): _migrate_brain_to_safe_default(), _active_primary_provider(), BrainConfig, BrainConfigPatch, BrainConfigStore, default_brain_config(), get_brain_config(), get_brain_config_store() (+102 more)
...
### Community 30 - "test_hermes_server.py"
Cohesion: 0.18
...
Cohesion: 0.02
Nodes (74): _clear_discovered_models(), _clear_response_cache(), _isolate_brain_data_layer(), _isolate_operator_provider_state(), MonkeyPatch, Path, Default all tests to legacy workflow mode (Phase 2 compatibility). Only patches…, Session-wide autouse: stub out any DB reads that go through… (+66 more)

### Community 32 - "config.py"
Cohesion: 0.03
Nodes (82): AgentPolicy, _apply_env_overrides(), _apply_key_env(), _build(), _coerce(), config_dir(), _env_key_names(), expand_env() (+74 more)

### Community 33 - "direct_chat.py"
Cohesion: 0.04
Nodes (85): DirectChatDoctor, PreflightIssue, Any, BaseModel, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, Translate technical preflight issues into a conversational assistant reply., translate_error_to_conversational(), AcceptedJob (+77 more)

### Community 34 - "_mock_provider_records"
Cohesion: 0.13
...
Cohesion: 0.04
Nodes (66): AgentConfig, build_agent_specs(), build_swarm(), build_task_specs(), coordinate_v2(), CoordinateRequestV2, CoordinateResponse, Any (+58 more)

### Community 36 - "E2BSandboxSession"
Cohesion: 0.04
Nodes (71): MCPUnavailableError, agent/mcp_client.py — Async MCP client for the mcp-server Docker container.…, Raised when the MCP server is unreachable or the circuit is open., is_e2b_sdk_importable(), Cheap probe — True when ``e2b_code_interpreter`` is importable. Used by…, E2BSandboxSession, _inject_token(), maybe_attach_e2b() (+63 more)

### Community 37 - "ImprovementLoop"
Cohesion: 0.04
Nodes (85): Agency, AgentRole, get_agency(), _parse_ceo_directives(), str, CEO-coordinated multi-agent agency for continuous codebase management. The CEO…, set_agency(), DetectedIssue (+77 more)

### Community 38 - "company_api.py"
Cohesion: 0.02
Nodes (139): ephemeral_ttl_hours(), Async read of the ephemeral TTL (hours) straight from the DB., account_lifecycle(), AccountLifecycleResponse, auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint() (+131 more)
...
Cohesion: 0.04
Nodes (68): CatalogActiveBrain, CatalogMirror, CatalogProviderEntry, get_catalog(), get_model_catalog_store(), _include_router_providers(), invalidate_catalog_cache(), ModelCatalogStore (+60 more)
...
Cohesion: 0.03
Nodes (101): Backoff policy for retryable failures., RetryConfig, BreakerState, str, _digest(), get_ring(), KeyRing, KeyState (+93 more)

### Community 44 - "TaskStatus"
Cohesion: 0.04
Nodes (103): Helpers that turn scheduler and playbook activity into real tasks., Creates tasks from scheduler and playbook runs using one workflow., TaskAutomationService, Background dispatcher for task execution., TaskStatus, Domain services for task workflow and runtime-backed execution., Owns lifecycle transitions, comment semantics, and approval rules., Executes tasks through the runtime layer using agent definitions. (+95 more)
...
Cohesion: 0.04
Nodes (65): AgentPhaseError, Exception, Raised when a named agent phase (planning, verification, etc.) fails., AgentPlan, _make_runner(), MonkeyPatch, Path, Regression for #1422 item 3: when the model never returns a JSON object, the… (+57 more)

### Community 47 - "test_ceo_dispatcher.py"
Cohesion: 0.02
Nodes (98): CEOResult, _complexity_rank(), _decompose_into_subtasks(), get_ceo_dispatcher(), _merge_changed_files(), _offload(), Any, services/ceo_dispatcher.py — Real CEO delegation layer. The CEO splits a… (+90 more)

### Community 48 - "llm/router.py"
Cohesion: 0.02
Nodes (109): _load(), main(), Scheduled portfolio intelligence sweep. Run by `.github/workflows/portfolio-…, int, get_budget(), The process-wide budget tracker., get_cache(), The process-wide cache manager. (+101 more)
...
### Community 50 - "test_self_heal_v2.py"
Cohesion: 0.07
...
### Community 51 - "timedelta"
Cohesion: 0.08
Nodes (32): PR throughput per cohort over the last `days` days., Count distinct sessions per user. A session ends when there's a gap of more…, _as_aware_utc(), _company_alive(), _company_id_for_agent(), _env_float(), datetime, services/ephemeral_reaper.py — destroy expired ephemeral companies. The… (+24 more)
...
Cohesion: 0.05
Nodes (59): _domain_list_reason(), _domain_matches(), _parse_domain_list(), Return True if *host* is *pattern* or a subdomain of it., Split a comma-separated env var into a normalised domain list., Return why the env-var domain policy blocks *host*, or None. Checks…, Zero-key internet access: pages, YouTube transcripts, search, RSS. Every public…, WebReach (+51 more)

### Community 55 - "InternalAgentAdapter"
Cohesion: 0.03
Nodes (63): Resolve the model id to force for a code-execution run, or ``None``. Returns…, resolve_coding_model_preference(), _best_cloud_primary_base(), InternalAgentAdapter, TaskResult, Built-in agent loop — Nvidia NIM primary, Ollama fallback., Return runtime dependencies required by this adapter. Returns:…, Determine availability of the internal agent runtime. Checks cloud providers in… (+55 more)
...
Cohesion: 0.02
Nodes (107): ApprovalPolicy, BusinessSystem, CompanyCreateRequest, CompanyGraph, CompanyGraphResponse, CompanyGraphSnapshot, CompanyResponse, CompanyUpdateRequest (+99 more)
...
### Community 61 - "portfolio_intelligence.py"
Cohesion: 0.07
...
### Community 62 - "HTTPException"
Cohesion: 0.03
Nodes (125): _get_current_user_thunk(), _get_optional_user_thunk(), Request, admin_seed(), clear_cost_attribution(), clear_response_cache(), create_access_token(), create_api_key() (+117 more)
...
Cohesion: 0.04
Nodes (52): Report whether the SAM realtime voice (LiveKit) transport is configured., Mint a LiveKit room token so the dashboard can talk to SAM live., sam_livekit_status_backend(), sam_livekit_token_backend(), SamLiveKitTokenRequest, auth_headers(), livekit_env(), no_livekit_env() (+44 more)

### Community 66 - "runtimes/api.py"
Cohesion: 0.05
Nodes (62): _enrich_runtimes(), get_policy(), _load_rich_policy(), PolicyUpdateBody, Any, BaseModel, post, put (+54 more)
...
Cohesion: 0.04
Nodes (50): Any, packages/ai/self_heal.py — automatic brain self-healing. When the active brain…, Background tick that runs self_heal_brain_and_unblock_tasks(). Called from the…, One-shot self-healing pass. 1. Checks if the active brain provider is in a…, self_heal_brain_and_unblock_tasks(), _self_heal_tick(), BrainWatchdog, get_watchdog() (+42 more)
...
Cohesion: 0.05
Nodes (65): BrainResolution, get_active_brain_sync(), get_provider_role_tags(), _host_is_openai_compatible(), invalidate_brain_cache(), _norm(), _pick_from_records(), _build() (+57 more)
...
Cohesion: 0.03
Nodes (78): ApprovalRequest, ApprovalStatus, ApprovalStore, Any, Enum, str, packages/governance/approvals.py — human-in-the-loop for high-risk actions. The…, Bounded, in-process store of approval requests. Uses a :class:`threading.Lock`… (+70 more)
...
### Community 90 - "seo_api.py"
Cohesion: 0.05
Nodes (60): build_seo_roadmap(), delegate_seo_findings(), list_seo_audits(), plan_seo_sprint(), BaseModel, post, SEO / GEO / AIO Audit API Router Endpoints for the world-class SEO audit engine…, Run a full SEO/GEO/AIO audit against a website and persist the evidence. (+52 more)
...
Cohesion: 0.16
Nodes (21): _api_key(), _auth_headers(), _build_digest_markdown(), get_knowledge_sync(), KnowledgeSync, _now_iso(), agent/knowledge_sync.py — Wiki + Sources knowledge ingestion pipeline. Bridges…, Render a markdown digest from a list of TrendAlert dicts. (+13 more)
...
Cohesion: 0.05
Nodes (53): Available iff config resolves AND the SDK is importable. Never raises — a…, e2b_status(), Return the E2B sandbox integration status for the ProvidersScreen badge. Does…, e2b_enabled(), E2BConfig, _env_falsy(), _env_truthy(), services/e2b_config.py — Single reader of E2B sandbox environment config.… (+45 more)
...
### Community 112 - "test_tasks_awaiting_approval_api.py"
Cohesion: 0.33
...
### Community 120 - "_get_provider_policy"
Cohesion: 0.07
...
### Community 125 - "CompanyGraphStore"
Cohesion: 0.02
Nodes (51): BusinessCategory, Company, The core company entity - root of the Company Graph., requires_db, Company, Get a company by ID. Args: company_id: Company ID Returns: Company instance or…, Update a company. Args: company_id: Company ID **kwargs: Fields to update…, List companies with optional filtering. Args: owner_id: Filter by owner ID… (+43 more)
...
### Community 130 - "Usage"
Cohesion: 0.06
Nodes (34): AlertHandler, BudgetTracker, Counter, _Dimensions, _month(), Any, packages/llm/budget.py — token and cost accounting with spend alerts. Tracks…, Register a callback fired when a spend threshold is crossed. (+26 more)
...
Cohesion: 0.06
Nodes (66): get_decisions_store(), Process-wide DecisionsStore singleton (resettable via db_path arg)., Return a Markdown-v1-safe preview string under ``max_chars``. Used by the…, sanitize_paste_for_preview(), _admin_headers(), _answer_callback(), _api_headers(), _check_rate_limit() (+58 more)
...
### Community 156 - "test_agent_readiness_audit.py"
Cohesion: 0.18
...
Cohesion: 0.05
Nodes (52): Charge sub-agent nesting depth and enforce the ``max_depth`` ceiling. Isolates…, events_from_identity(), Any, Convenience: build and record an event in one call., Extract the identity-derived audit fields from an AgentIdentity. Kept here…, record_event(), BudgetExceeded, classify() (+44 more)
...
Cohesion: 0.05
Nodes (57): Replace the process-wide store. Tests only., reset_approval_store(), AuditLog, Bounded in-memory ring buffer plus a structured log stream. The ring buffer…, Store and emit *event*. Never raises., Return the most recent events, newest first, optionally filtered., Aggregate view for the dashboard and the metrics endpoint. ``would_block`` is…, Replace the process-wide audit log. Tests only. (+49 more)
...
Cohesion: 0.06
Nodes (46): cmd_freebuff(), ensure_config_loaded(), _model_keyboard(), _parse_callback(), _parse_user_ids(), _process_callback(), process_webhook_update(), Accept / reject keyboard shown after a FreeBuff plan is generated. (+38 more)
...
Cohesion: 0.06
Nodes (48): AuditEvent, One governed action, fully described. Field order follows the…, One-line JSON, suitable for a SIEM shipper tailing the log., Replace the process-wide gate. Tests only., reset_gate(), _client(), parametrize, TestClient (+40 more)
...
Cohesion: 0.04
Nodes (84): get_improvement_loop(), _dispatch_async(), _ErrorCaptureHandler, get_log_monitor(), LogMonitor, _note_recurrence(), Any, LogRecord (+76 more)
...
Cohesion: 0.09
Nodes (28): Send a Telegram notification about the failover., NotificationDispatcher, Path, service_manager.py — Telegram & Notification Integration Extension Extends the…, Signal the bot to stop and wait for graceful shutdown., Routes background task results to configured notification channels. Currently…, # NOTE: do NOT re-escape here — services.daily_digest.format_digest_markdown, Manages the Telegram bot as a managed service alongside ollama/proxy/tunnel.… (+20 more)

### Community 201 - "WorkflowRun"
Cohesion: 0.09
Nodes (27): _fake_artifact(), _make_engine(), tests/test_crispy_workflow.py — CRISPY workflow engine hardening tests. Tests…, Create a WorkflowEngine with isolated storage., TestAbortOnFailure, _test(), _tracking_run_single(), TestPhaseSequence (+19 more)
...
Cohesion: 0.07
Nodes (52): Return the last-known health for *runtime_id* (may be stale)., Return True if the runtime is available (not circuit-open)., Return health snapshots for all known runtimes., Force an immediate health check of all runtimes and return results., Attempt to start a dead runtime subprocess before re-probing. Uses the local…, Async health polling service for all registered runtimes., Start the background polling loop with an immediate initial check., RuntimeHealthService (+44 more)
...
Cohesion: 0.08
Nodes (24): Return True when the web process should also run background services., run_background_in_web(), anyio, Unit tests for services/background.py — start_background_services wiring.…, Scheduler's on_fire handler is set to TaskAutomation.handle_scheduled_job., Calling bg.stop() twice must not raise or double-stop., RUN_BACKGROUND_IN_WEB defaults to True., The constant itself must leave real margin under Render's 5s timeout. (+16 more)
...
### Community 237 - "seo_portfolio_bridge.py"
Cohesion: 0.06
...
Cohesion: 0.03
Nodes (88): brain_providers(), Every configured provider with its health AND its on/off state. Powers the…, auto_disable(), _billing_signals(), describe(), disabled_provider_ids(), is_unfixable(), packages/llm/disabled.py — bridge to the durable provider on/off switch. The… (+80 more)

### Community 241 - "TaskDispatcher"
Cohesion: 0.09
Nodes (20): Re-queue BLOCKED tasks that have cooled down and are ready for retry., Polls for queued task work and executes it through the coordinator. Crash…, Re-queue tasks stranded by a prior crash or hard-kill., TaskDispatcher, _make_task(), asyncio, Task, tests/test_dispatcher_iso8601.py — regression test for the TaskDispatcher auto-… (+12 more)
...
### Community 250 - "test_p0_roadmap_b1_c2_a3.py"
Cohesion: 0.06
...
Cohesion: 0.05
Nodes (49): filter_output(), FilterResult, get_savings_summary(), OutputFilter, agent/output_filter.py — LLM Output Compression & Token Savings Inspired by…, Filter and compress command outputs to reduce LLM token consumption. Provides…, Compact git status output — keep only changed file paths., Compact git log — one line per commit. (+41 more)

### Community 270 - "AgentDefinition"
Cohesion: 0.05
Nodes (35): AgentDefinition, AgentStore, Any, field_validator, CRUD store for AgentDefinition objects. Uses MongoDB when a `db` client is…, Return an agent by ID. If *owner_id* is provided, enforces that the agent…, Delete an agent. Returns True on success, False if not found/unauthorised., Return all agents owned by *owner_id*, optionally including public agents. (+27 more)

### Community 271 - "tests/conftest.py"
Cohesion: 0.13
Nodes (19): Item, app_client(), client(), non_admin_client(), Config, TestClient, pytest_collection_modifyitems(), pytest_configure() (+11 more)
...
Cohesion: 0.12
Nodes (17): Path, PhaseType, WorkflowRun, Append an event to the workflow event log., Create a new WorkflowRun and begin pre-gate phase execution. The run is…, Return current WorkflowRun snapshot or None., Approve the plan — lifts the ApprovalGate and resumes execution. Raises…, Reject the plan — marks run as failed. (+9 more)
...
### Community 292 - "SeoAuditReport"
Cohesion: 0.12
Nodes (36): _expire_stale_pending_report(), get_seo_audit(), Fetch a complete stored audit report. Side-effect: an audit whose stub is still…, Auto-fail a pending SEO audit stub that is older than…, Complete result of one audit run., SeoAuditReport, Paragraph, Store a report in the bounded in-memory registry. (+28 more)
...
### Community 308 - "test_google_provider_models.py"
Cohesion: 0.18
...
### Community 318 - "get_failover_manager"
Cohesion: 0.08
...
### Community 321 - "get_runtime_manager"
Cohesion: 0.07
Nodes (47): _apply_activity_status(), create_agent(), delete_agent(), get_agent(), _get_user(), list_agents(), list_runtime_agents(), Any (+39 more)
...
Cohesion: 0.11
Nodes (19): _cached(), get_activity(), _get_activity_impl(), legacy_scheduler_list(), _produce_scheduler_jobs(), Any, Single-flight TTL cache. Concurrent callers wait for the first producer., _token_response() (+11 more)
...
### Community 352 - "probe_model_liveness"
Cohesion: 0.05
...
### Community 363 - "_valid_login_state"
Cohesion: 0.24
...
### Community 366 - "get_task_store"
Cohesion: 0.07
Nodes (39): quick_notes_submit(), _QuickNoteBody, Submit a quick-note URL or instruction from the dashboard FAB., Hand the 'connect & verify the repo' work to the agency's own agents. The task…, _seed_connect_task(), _get_workflow_engine(), WorkflowEngine, Return a lazily-created WorkflowEngine singleton. (+31 more)
...
### Community 378 - "test_render_mcp.py"
Cohesion: 0.08
...
### Community 393 - "_enforce_rate_limit"
Cohesion: 0.22
...
### Community 400 - "lifespan"
Cohesion: 0.06
Nodes (24): _keepalive_self_ping(), lifespan(), _deferred_startup_cleanup(), _maybe_boot_purge(), _purge_summary_clean(), Run the FreeBuff Telegram bot, restarting it on unexpected exit., Ping our own public URL so a free-tier web service doesn't sleep. Render free…, Start the Telegram bot (and keep-alive) inside the web process when enabled.… (+16 more)
...
### Community 436 - "compare_runtimes.py"
Cohesion: 0.06
...
### Community 442 - "autonomous_fix.py"
Cohesion: 0.10
...
### Community 460 - "_extract_pytest_failure"
Cohesion: 0.31
...
### Community 462 - "TestPoliciesGovernanceStableClaim"
Cohesion: 0.25
...
### Community 463 - "TestAdapterMetadata"
Cohesion: 0.05
...
### Community 467 - "Slice"
Cohesion: 0.11
Nodes (13): WorkflowRun, tests/test_workflow_models.py — Unit tests for workflow/models.py., TestApprovalGate, TestSlice, TestWorkflowRun, _extract_slices_from_plan(), Execute, review, and verify a single slice. Returns the updated Slice. Raises…, Extract slice definitions from a plan.md artifact. Looks for sections matching:… (+5 more)
...
### Community 471 - "all_provider_ids"
Cohesion: 0.09
Nodes (19): all_provider_ids(), _provider_ids_from_literal(), Return every provider id recognised by the brain config system. Iterates the…, Return the provider ids allowed by the ``BrainProvider`` Literal. Reads the…, tests/test_unit5_ui_provider_surface.py — UNIT 5 regression tests. Verifies…, The component must call ``providerLabel(p)`` rather than indexing a 4-entry…, The dropdown shows a [free]/[paid]/[local] tier tag so the operator can tell…, The <option> tag uses providerLabel(p), not PROVIDER_LABELS[]. (+11 more)
...
### Community 494 - "TestAgentRunnerPublicPlanMethod"
Cohesion: 0.20
...
### Community 496 - "test_llm_router_compat.py"
Cohesion: 0.11
Nodes (25): FailoverResult, _log_recovery(), A successful completion plus the accounting its callers need., Report a successful failover at INFO — recovery is not an incident. Everything…, failover_chat_completion_via_router(), openai_body_from_response(), Any, packages/llm/compat.py — backwards-compatible bridges to the legacy call paths.… (+17 more)
...
### Community 500 - "loop.py"
Cohesion: 0.13
Nodes (23): loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., # NOTE: "ollama_base" is kept for backwards compatibility; this runner only…, Feed LLM token/cost spend into the governance session budget. Kept separate…, build_compaction_prompt(), build_execution_prompt(), build_planning_prompt(), build_tool_prompt(), build_verification_prompt() (+15 more)

### Community 501 - "SeoFixer"
Cohesion: 0.15
...
### Community 506 - "_execute_skill_impl"
Cohesion: 0.10
...
### Community 517 - "TestRouterIntegration"
Cohesion: 0.21
...
### Community 536 - "get_tool_registry"
Cohesion: 0.07
Nodes (22): browse_page(), Open *url* in a real browser, return its rendered text, and close. Fail-soft:…, get_tool_registry(), Return the module-level ToolRegistry singleton. On first call, registers built-…, Register the built-in agent tools that are always available., Register the interactive-browser capability (agent/browser.py). Unlike…, Register the Web Reach capability (agent/web_reach.py): zero-key internet…, _register_browser_tools() (+14 more)
...
### Community 538 - "test_harness_spec.py"
Cohesion: 0.12
...
### Community 542 - "test_ai_insights.py"
Cohesion: 0.05
...
### Community 543 - "Initiative"
Cohesion: 0.06
Nodes (18): CapacityAllocation, Initiative, Result of fitting initiatives into a fixed capacity by WSJF priority., Total job size of initiatives that fit within capacity., Unused capacity after committing the selected initiatives., Fraction of capacity consumed (0.0–1.0)., Create and register a new initiative, returning it., Add a pre-built Initiative (e.g. from the intelligence layer). (+10 more)
...
### Community 553 - "ProviderRouter"
Cohesion: 0.06
Nodes (25): _get_director(), _normalized_provider_type(), ProviderAttempt, ProviderResult, ProviderRouter, Any, Try all models for one provider. Returns ProviderResult on success, None on…, Parse a 429/503 ``Retry-After`` header → seconds, or None. Accepts either… (+17 more)
...
### Community 563 - "model_discovery.py"
Cohesion: 0.09
...
### Community 566 - "unsafe_target_reason"
Cohesion: 0.12
...
### Community 568 - "test_agent_chat_integration.py"
Cohesion: 0.13
...
### Community 571 - "test_issue_triage.py"
Cohesion: 0.14
...
### Community 580 - "failover_client.py"
Cohesion: 0.06
...
### Community 649 - "fetch_and_store"
Cohesion: 0.14
Nodes (13): create_wiki_page(), fetch_and_store(), Any, AsyncClient, Create (or silently skip if duplicate title) a Wiki page., Ingest a URL into the Sources database so it becomes RAG-searchable. Returns…, _ingest_one(), _FakeClient (+5 more)
...
### Community 658 - "test_north_mini_code.py"
Cohesion: 0.10
...
### Community 683 - "SeoCheckDefinition"
Cohesion: 0.11
...
### Community 694 - "test_seo_audit.py"
Cohesion: 0.06
...
### Community 695 - "test_workflow_orchestrator_scoping.py"
Cohesion: 0.17
...
### Community 696 - "FeatureUnavailableError"
Cohesion: 0.15
...
### Community 697 - "weekly_digest.py"
Cohesion: 0.13
...
### Community 741 - "TestBrainFailoverModelUpdates"
Cohesion: 0.18
...
Cohesion: 0.14
Nodes (14): apply_from_db(), apply_overrides(), Write *overrides* into ``os.environ`` and refresh dependent caches. Keys that…, Re-read every ``settings`` attribute from the updated environment. Re-runs…, Load the stored overrides and apply them. Called once at startup., _refresh_settings_singleton(), is_controllable(), True when *key* may be overridden from the dashboard. The allow-list is what… (+6 more)

### Community 766 - "_Cursor"
Cohesion: 0.10
...
### Community 785 - "resolve_free_nvidia_brain"
Cohesion: 0.12
...
### Community 786 - "test_repowise_intelligence.py"
Cohesion: 0.11
...
### Community 827 - "sync_trends"
Cohesion: 0.16
Nodes (15): Push trend alerts into Sources + create a Wiki digest page. If *alerts* is…, Cron entry-point: fetch fresh trends then sync everything to Wiki+Sources., run_weekly_sync(), sync_trends(), SyncResult, asyncio, test_fetch_and_store_network_error(), test_knowledge_sync_create_page() (+7 more)
...
### Community 848 - "ai/router.py"
Cohesion: 0.07
Nodes (40): _dead_model_key(), _exponential_backoff_cooldown(), get_dead_models(), _is_model_dead(), _mark_model_dead(), _notify_watchdog(), provider_router.py — auto-generated module docstring (user-research skill scan)., Snapshot of active dead-model entries {provider_id/model: expiry_ts}. Also… (+32 more)

### Community 849 - "DreamMemory"
Cohesion: 0.13
...
### Community 854 - "test_daily_automation_2026_07_11.py"
Cohesion: 0.14
...
### Community 858 - "test_schedule_persistence.py"
Cohesion: 0.16
...
### Community 861 - "test_orchestrator_merge_decision.py"
Cohesion: 0.22
...
### Community 890 - "NvidiaProvider"
Cohesion: 0.09
Nodes (6): CerebrasProvider, NvidiaProvider, NVIDIA NIM — free LLM provider (meta/llama-3.3-70b-instruct)., RateLimit, Provider rate limit info., Return the provider's rate limits.

### Community 891 - "._resolve_path"
Cohesion: 0.15
...
### Community 917 - "is_anthropic_base_url"
Cohesion: 0.18
...
### Community 968 - "_InMemoryBackend"
Cohesion: 0.18
...
### Community 978 - "test_doctor_service_token_check.py"
Cohesion: 0.23
...
### Community 984 - "TestTheGatewayRegistryOffersOnlyLiveModels"
Cohesion: 0.22
...
### Community 992 - "test_task_brain_preflight.py"
Cohesion: 0.31
...
### Community 998 - "_is_ephemeral_user"
Cohesion: 0.27
...
### Community 1025 - "Workspace Isolation Architecture"
Cohesion: 0.17
...
### Community 1038 - "flesch_reading_ease"
Cohesion: 0.20
...
### Community 1046 - "TestAgentRunnerSafety"
Cohesion: 0.24
...
### Community 1066 - "_is_denied_path"
Cohesion: 0.33
...
### Community 1086 - "test_minimax_bug_fixes.py"
Cohesion: 0.12
...
### Community 1108 - "test_probe_base_url_override_hits_the_typed_url"
Cohesion: 0.22
...
### Community 1127 - "test_ceo_router.py"
Cohesion: 0.05
Nodes (51): Attempt, _backend(), CEOLedger, GoalRecord, _now(), Any, services/ceo_ledger.py — durable record of what the CEO is driving to closure.…, One delegation of one subtask to one tier. (+43 more)

### Community 1128 - "LoopSpec"
Cohesion: 0.29
...
### Community 1139 - "_build_curl_cffi_fetcher"
Cohesion: 0.36
...
### Community 1142 - "classify_domain"
Cohesion: 0.29
...
### Community 1144 - "Workspace Issues"
Cohesion: 0.29
...
### Community 1145 - "Model and Response Issues"
Cohesion: 0.29
...
### Community 1154 - "._run_bot"
Cohesion: 0.29
Nodes (3): Start the Telegram bot. Returns True if started successfully., Run the Telegram bot long-poll loop (inline, not subprocess)., Run the bot with stop-event awareness.

### Community 1155 - "TestSupportMatrixDocsSync"
Cohesion: 0.29
...
### Community 1160 - "test_log_monitor_storm_guard.py"
Cohesion: 0.48
...
### Community 1180 - "openclaw_mobile_ui"
Cohesion: 0.33
...
### Community 1187 - "resolve_hermes_base_url"
Cohesion: 0.47
...
### Community 1188 - "TestAgentRunnerExecution"
Cohesion: 0.33
...
### Community 1207 - "TestDirectChatAgentExecution"
Cohesion: 0.33
...
### Community 1208 - "TestWorkflowIntegration"
Cohesion: 0.33
...
### Community 1230 - "Admin Dashboard Issues"
Cohesion: 0.40
...
### Community 1302 - "Agent API Issues"
Cohesion: 0.40
...
### Community 1303 - "Network and Tunnel Issues"
Cohesion: 0.40
...
### Community 1304 - "TestTelegramNotifications"
Cohesion: 0.40
...
### Community 1307 - "Claude Code Specific Issues"
Cohesion: 0.50
...
### Community 1310 - "test_skills_route_order.py"
Cohesion: 0.67
...
### Community 1313 - "JWTUserStateMiddleware"
Cohesion: 0.67
...
### Community 1315 - "test_the_reserve_is_bounded_when_read_from_the_environment"
Cohesion: 0.67
...
- **3517 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3512 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 14277 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **123 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `_fixture()` connect `_fixture` to `Specialist`, `test_llm_router_queue_cache.py`, `parse_event_stream`, `WebsiteScanner`, `ProviderConfig`, `client`, `OrchestratorQueue`, `Task`, `test_autonomy_status.py`, `test_brain_patch_service_token.py`, `test_operational_incidents.py`, `SelfHealingAgent`, `test_llm_router_strategies.py`, `AgentRunner`, `TaskSpec`, `tasks/models.py`, `TestCountTokensEndpoint`, `test_harness_spec.py`, `resolve_identity`, `test_model_router.py`, `test_ai_insights.py`, `config.py`, `direct_chat.py`, `_mock_provider_records`, `E2BSandboxSession`, `ImprovementLoop`, `test_failover_client_shared.py`, `test_unit8_model_catalog.py`, `build_governance_router`, `test_llm_router_resilience.py`, `TaskStatus`, `get_registry`, `llm/router.py`, `CEOSupervisor`, `test_company_api.py`, `timedelta`, `model_discovery.py`, `test_monitor_lib.py`, `test_phase5_doctor.py`, `InternalAgentAdapter`, `AgentSwarm`, `test_catalogue_probe.py`, `UserRole`, `cost_tracker.py`, `test_sam_livekit.py`, `TestSwarmRoleRouting`, `claim`, `test_provider_router.py`, `e2e/test_browser.py`, `test_openclaw_endpoints.py`, `BackgroundAgent`, `TokenBudget`, `test_task_service_failed_comment.py`, `PrimeAgentAdapter`, `ResearchTask`, `seo_api.py`, `TestSelfHealingInfrastructureClassification`, `test_sam_voice.py`, `TestClient`, `ArtifactStore`, `test_knowledge_sync.py`, `test_ceo_router.py`, `test_telegram_auto_approve.py`, `TestHarnessAdapter`, `test_startup_warmup.py`, `FeatureMaturity`, `test_local_brain_state.py`, `controls_app`, `TestChatHistoryStore`, `test_refresh_agent_built_proof.py`, `test_tasks_reconciler_todo_requeue.py`, `test_procedural_memory.py`, `test_new_features_e2e.py`, `persist_plan_spec`, `test_context_rulebook.py`, `test_llm_router_e2e.py`, `test_trend_watcher.py`, `KeyStore`, `_inline_threads`, `ChatHistoryStore`, `_step`, `TestEstimateTokensForMessages`, `test_agent_tool_governance.py`, `MCPClient`, `test_brain_failover_413.py`, `services/background.py`, `test_changelog_check_workflow.py`, `test_portfolio_intake.py`, `test_openclaw_gateway.py`, `test_e2b_data_flow.py`, `test_seo_audit.py`, `test_workflow_orchestrator_scoping.py`, `OllamaCircuitBreaker`, `_job_text`, `TestAuthAndTaskOwnership`, `test_video_transcript.py`, `clear_cooldowns`, `SchedulerStore`, `NotificationDispatcher`, `test_features_api.py`, `nvidia_models.py`, `test_agent_free_brain.py`, `_Budget`, `WorkflowBuildRequest`, `TrendWatcher`, `TestRuntimeControl`, `test_telegram_task_callback.py`, `_resolve_user_github_token`, `TestClient`, `test_telegram_webhook.py`, `test_control_plane_api.py`, `brain_failover.py`, `ContextPruner`, `test_brain_failover.py`, `test_persistent_memory.py`, `test_provider_enable_disable.py`, `test_agile_api.py`, `test_app_settings.py`, `test_purge_backlog.py`, `SecurityScanner`, `test_nvidia_model_discovery.py`, `OutputFilter`, `test_task_clarification.py`, `tests/conftest.py`, `AgentDefinition`, `test_rate_limiter.py`, `TaskPriority`, `._inline_threads`, `TestNormalizeResponseFormat`, `test_platform_controls.py`, `session_retro.py`, `test_agency_fix.py`, `test_skill_registry_boot_refresh.py`, `ai/watchdog.py`, `test_scheduler_hydration_bounded.py`, `OrchestratorCheckpointStore`, `ai/router.py`, `_start_ceo_agency`, `isolated_telegram_config`, `_resolve_push_token`, `TestMongoGate`, `test_dashboard_cache.py`, `test_orchestrator_merge_decision.py`, `test_regression.py`, `test_agent_scripts_share_one_model_list.py`, `test_crispy_burn_in.py`, `test_webui_provider_priority.py`, `_Recorder`, `_undeclared`, `test_process_quick_note_workflow.py`, `traffic_director.py`, `test_service_token.py`, `test_telegram_diag_endpoint.py`, `KeyPool`, `_get`, `test_v4_api.py`, `analyze_page`, `test_gh_brain_failover.py`, `test_doctor_service_token_check.py`, `.on_task_complete`, `TestTheWorkflowIsSafeAndReadOnly`, `test_doctor_coding_brain.py`, `test_voice_pipeline.py`, `test_mcp_protocol_version.py`, `test_ping.py`, `test_runtimes_health_endpoint.py`, `test_task_brain_preflight.py`, `test_task_store_fails_loud_in_production.py`, `captured`, `SQLiteStore`, `test_kimi_bridge_server.py`, `test_llm_router_compat.py`?**
  _High betweenness centrality (0.106) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `TestAgentLoopMCPIntegration`, `ExecutionRequest`, `proxy.py`, `UserMemoryStore`, `E2BAdapter`, `test_ceo_supervision.py`, `TaskSpec`, `TestAgentRunnerSafety`, `AgentSessionStore`, `ReactScratchpad`, `resolve_identity`, `ContextManager`, `enforcement.py`, `direct_chat.py`, `MultiAgentSwarm`, `E2BSandboxSession`, `test_agent_tool_governance.py`, `ImprovementLoop`, `test_failover_client_shared.py`, `TestAgentRunnerExecution`, `agency.py`, `MCPClient`, `test_governance_api.py`, `test_agent_runner.py`, `test_ceo_dispatcher.py`, `StuckDetector`, `test_brain_failover_413.py`, `test_empirical_verify.py`, `InternalAgentAdapter`, `LocalWorkspace`, `test_agent_chat_integration.py`, `WorkspaceTools`, `test_agent_free_brain.py`, `BackgroundAgent`, `FreeBuffAgent`, `TokenBudget`, `test_daily_automation_2026_07_11.py`, `TestAgentRunnerPublicPlanMethod`, `loop.py`, `AdaptiveHalter`, `ContextPruner`, `GitHubTools`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderRouter` to `backend/server.py`, `TestRouterIntegration`, `ProviderConfig`, `test_all_providers_discovery.py`, `is_anthropic_base_url`, `test_bedrock_provider.py`, `direct_chat.py`, `test_colibri_brain_shim.py`, `implement_agent.py`, `test_bedrock_live.py`, `clear_cooldowns`, `failover_client.py`, `TestLegacyRouterCacheTTL`, `test_anthropic_refusal_fallback.py`, `kimi_bridge_provider_config`, `settings.py`, `test_provider_router.py`, `ai/router.py`, `_payload`, `TestAnthropicPayloadStructuredOutput`, `system_instruction`, `TrafficDirector`, `NvidiaProvider`?**
