# Graph Report - local-llm-server  (2026-09-04)

## Corpus Check
- 1473 files · ~2,148,724 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 30045 nodes · 55693 edges · 1245 communities (1067 shown, 123 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 2719 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `254af82a`
...
## Communities (1245 total, 123 thin omitted)

### Community 0 - "backend/server.py"
Cohesion: 0.01
Nodes (333): admin_seed(), _agent_timeout_fallback_response(), AgentStatusEntry, AgentStatusResponse, AgentToolCallEntry, ApiKeyCreate, auth_me(), AuthorizeReposBody (+325 more)

### Community 1 - "Task"
Cohesion: 0.02
Nodes (152): classify_domain(), agent/workflow.py — Persisted workflow state machine. Implements the Autonomous…, Return the best-matching domain for a task title+description., Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., tasks — Task/issue management system. Provides a lightweight task/issue tracker…, Enum, str (+144 more)

### Community 2 - "_fixture"
Cohesion: 0.01
Nodes (130): Reset the singleton (for tests)., reset_failover_manager(), base_url(), mobile_page(), proxy_url(), Config, pytest_configure(), conftest.py — pytest fixtures and configuration for the E2E test suite.… (+122 more)
...
Cohesion: 0.02
Nodes (105): get_orchestrator_checkpoint_store(), get_orchestrator_queue(), BoundContext, ClassifyOutput, ExecutionRequest, ExecutionResult, _get_ceo_dispatcher(), JudgeVerdict (+97 more)

### Community 5 - "test_llm_router_queue_cache.py"
Cohesion: 0.02
Nodes (123): CacheManager, cosine_similarity(), _Entry, LRUCache, payload_key(), Any, T, Live (unexpired) entries — used by the semantic layer's scan. (+115 more)
...
Cohesion: 0.02
Nodes (145): account_lifecycle(), AccountLifecycleResponse, auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint(), _DoctorCheck, _DoctorReport (+137 more)

### Community 8 - "resolve_active_brain"
Cohesion: 0.02
Nodes (126): _brain_provider_status(), _list_configured_provider_records(), _nvidia_nim_provider_record(), Return a provider record for Nvidia NIM if the API key is set in env., Return per-provider metadata for the GET endpoint. Iterates every provider in…, Return the discovered model list for *provider_id*, or ``[]`` if unknown., _served_models(), BrainResolution (+118 more)
...
### Community 10 - "CompanyGraphService"
Cohesion: 0.02
Nodes (92): patch, Update a company's metadata. Accepts partial updates for company fields…, Synchronize the Company Graph. Re-scans all websites and repositories, updates…, Scan a repository for technology stack and systems., scan_repo_endpoint(), sync_company_graph(), update_company(), BusinessCategory (+84 more)

### Community 11 - "TaskSpec"
Cohesion: 0.04
Nodes (82): kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, TaskResult, TaskSpec, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Run aider non-interactively via `--message` flag., runtimes/adapters/claude_code.py — Claude Code CLI adapter (FIRST CLASS).…, runtimes/adapters/docker_agent.py — Docker-based agent runtime adapter. Spawns… (+74 more)
...
Cohesion: 0.03
Nodes (102): BrainConfig, BrainConfigPatch, BrainConfigStore, default_brain_config(), get_brain_config(), invalidate_brain_config_cache(), BaseModel, Persist *cfg* to Mongo (primary) and sqlite (mirror). Either backend failing is… (+94 more)

### Community 16 - "test_llm_router_resilience.py"
Cohesion: 0.03
Nodes (90): Backoff policy for retryable failures., RetryConfig, is_unfixable(), Whether this failure needs a human rather than a retry. Two shapes qualify. A…, BreakerState, Enum, str, packages/llm/health.py — provider health tracking and circuit breaking. Two… (+82 more)

### Community 17 - "models/company_graph.py"
Cohesion: 0.03
...
### Community 18 - "Usage"
Cohesion: 0.04
Nodes (57): AsyncClient, packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, classify_error(), LLMProvider, OpenAICompatible, ABC, Any, AsyncClient (+49 more)

### Community 19 - "resolve_e2b_config"
Cohesion: 0.03
Nodes (95): agent/mcp_client.py — Async MCP client for the mcp-server Docker container.…, Available iff config resolves AND the SDK is importable. Never raises — a…, e2b_status(), Return the E2B sandbox integration status for the ProvidersScreen badge. Does…, e2b_enabled(), E2BConfig, _env_falsy(), _env_truthy() (+87 more)

### Community 20 - "PolicyEngine"
Cohesion: 0.04
Nodes (88): _egress_policy_reason(), agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Return why governance policy blocks *host*, or None. Runs strictly *after* the…, AgentIdentity, _coerce_text(), Any, packages/governance/identity.py — who is acting, and under what mandate. Docker…, The acting subject of a governed action. Immutable by construction so a… (+80 more)

### Community 21 - "settings.py"
Cohesion: 0.03
...
Cohesion: 0.04
Nodes (102): ProviderConfig, One configured endpoint. ``kind`` selects the adapter: ``openai`` (any OpenAI-…, build_provider(), ProviderConfig, Normalise a configured ``kind`` to an adapter key., Instantiate the adapter for one provider config. Unknown kinds fall back to the…, resolve_kind(), LLMRequest (+94 more)

### Community 23 - "AgentDefinition"
Cohesion: 0.04
Nodes (83): _apply_activity_status(), create_agent(), delete_agent(), get_agent(), _get_user(), list_agents(), list_runtime_agents(), Any (+75 more)

### Community 24 - "test_governance_sandbox.py"
Cohesion: 0.04
Nodes (72): build_docker_run_argv(), detect_backend(), DockerBackend, E2BBackend, load_profiles(), LocalBackend, Any, Path (+64 more)

### Community 25 - "test_ceo_micromanager.py"
Cohesion: 0.05
Nodes (99): build_subtask_brief(), _coerce_subtasks(), decompose(), _env_flag(), _env_int(), _extract_json_object(), fallback_decomposition(), MicroManagerConfig (+91 more)

### Community 26 - "enforcement.py"
Cohesion: 0.03
Nodes (83): Feed LLM token/cost spend into the governance session budget. Kept separate…, Charge sub-agent nesting depth and enforce the ``max_depth`` ceiling. Isolates…, guard(), identity_from_headers(), _load(), Any, mcp_server/governance.py — governance adapter for the MCP HTTP surface. Closes…, Build an AgentIdentity from the caller's ``X-Agent-*`` headers. Absent headers… (+75 more)

### Community 27 - "llm/router.py"
Cohesion: 0.04
Nodes (87): _load(), main(), int, get_budget(), packages/llm/budget.py — token and cost accounting with spend alerts. Tracks…, The process-wide budget tracker., Test hook — clear all usage accounting., reset() (+79 more)

### Community 28 - "PrimeAgentAdapter"
Cohesion: 0.03
...
### Community 32 - "services/seo_audit.py"
Cohesion: 0.04
Nodes (64): Run a full SEO/GEO/AIO audit against a website and persist the evidence., run_seo_audit(), BaseModel, field_validator, models/seo_audit.py - SEO / GEO / AIO Audit Contracts Typed Pydantic models for…, A single occurrence of a check firing on a specific URL., Snapshot of one crawled page with the on-page facts the checks used., Aggregated report row - Screaming Frog CSV compatible. (+56 more)
...
### Community 36 - "RenderMCPClient"
Cohesion: 0.04
Nodes (43): _as_list(), _coerce_payload(), Any, RuntimeError, packages/integrations/render_mcp.py — Render platform access over MCP. The…, One deploy, normalised from whatever shape the tool returned., Return tool output as Python data. MCP tool results arrive either as…, Normalise a tool payload into a list of dicts. Upstream tools variously return… (+35 more)

### Community 37 - "test_brain_config_api.py"
Cohesion: 0.03
...
### Community 42 - "test_mcp_registry.py"
Cohesion: 0.05
...
### Community 43 - "get_task_store"
Cohesion: 0.04
Nodes (79): quick_notes_submit(), _QuickNoteBody, The task store the background services should use, wiring it if needed.…, Submit a quick-note URL or instruction from the dashboard FAB., _task_store_for_background(), apply_from_db(), Load the stored overrides and apply them. Called once at startup., Path (+71 more)

### Community 44 - "ProviderConfig"
Cohesion: 0.05
Nodes (73): _acquire_provider_probe(), extract_openai_text(), is_commercial_provider(), _normalize_nvidia_base_url(), provider_access_tier(), _provider_field(), provider_sort_key(), ProviderConfig (+65 more)

### Community 45 - "test_governance_enforcement.py"
Cohesion: 0.05
Nodes (75): packages/governance/audit.py — the evidence trail for every governed action.…, Redact secret-shaped substrings, then truncate., Recursively strip secrets from an arbitrary argument structure. Fails…, scrub(), _scrub_inner(), _scrub_text(), _truncate(), BudgetTracker (+67 more)

### Community 46 - "TestAdapterMetadata"
Cohesion: 0.03
Nodes (37): AiderAdapter, Any, Adapter for Aider — TIER 3 specialized git-aware code editor., _env_float(), HermesAdapter, Any, AsyncClient, Response (+29 more)

### Community 47 - "validate_policy_text"
Cohesion: 0.04
Nodes (42): backend/governance_router.py — read and operate the governance layer. Mounted…, Reject non-admin callers. Mirrors the RBAC check used elsewhere in this backend…, _require_admin(), _audit_proposal(), _baseline_loosened(), _baseline_patterns(), diff_policy(), _GitHub (+34 more)
...
### Community 49 - "test_brain_availability_doctor.py"
Cohesion: 0.04
Nodes (62): brain_availability_summary(), Non-secret answer to "can the brain answer a request right now?". Three callers…, CEOSupervisor, _env_flag(), _env_int(), Any, services/ceo_supervisor.py — the CEO's 24x7 babysitting loop. Delegation alone…, What one sweep observed and did. Returned for tests and diagnostics. (+54 more)

### Community 50 - "KeyPool"
Cohesion: 0.04
...
### Community 51 - "TaskExecutionCoordinator"
Cohesion: 0.04
Nodes (60): _gate_outward_facing_enabled(), _is_brain_connection_error(), _is_outward_facing(), Any, BaseException, TaskResult, TaskSpec, One-line human explanation of why this task needs human approval. Reads risk… (+52 more)
...
### Community 53 - "AgentJobManager"
Cohesion: 0.05
Nodes (46): PreflightIssue, PreflightReport, BaseModel, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, AgentJob, AgentJobManager, _now(), Any (+38 more)

### Community 54 - "CompanyGraphStore"
Cohesion: 0.03
Nodes (38): Find a website by its URL., A company website with detected systems and stack inference., Website, requires_db, Add a website to a company. Args: company_id: Company ID url: Website URL…, CompanyGraphStore, Delete a company and all its associated data., List companies with optional filtering. (+30 more)

### Community 55 - "ImprovementLoop"
Cohesion: 0.06
...
Cohesion: 0.05
Nodes (60): CEODispatcher, CEOResult, _complexity_rank(), _decompose_into_subtasks(), get_ceo_dispatcher(), _merge_changed_files(), _offload(), Any (+52 more)

### Community 59 - "AgentScheduler"
Cohesion: 0.05
Nodes (46): Atomically delete a run-once row only while it is still unfired. Closes the…, _age_seconds(), AgentScheduler, _now(), Any, agent/scheduler.py — Scheduled Agent Jobs Cron-based job scheduler. Each job…, Reconstruct a ScheduledJob from its as_dict() output., Register, list, trigger, and delete cron-scheduled agent jobs. Usage:: sched =… (+38 more)

### Community 60 - "get_workflow_orchestrator"
Cohesion: 0.05
Nodes (40): Return orchestrator queue depth, active runs, and supervisor state (#522)., Called by APScheduler when a cron fires. Dispatches to the orchestrator. This…, _scheduler_on_fire(), workflow_orchestrator_status(), get_orchestrator_supervisor(), OrchestratorSupervisor, Any, services/orchestrator_supervisor.py — Deterministic Supervisor Issue #522: A… (+32 more)

### Community 61 - "Specialist"
Cohesion: 0.03
Nodes (45): SpecialistFamily, Find all specialists of a specific family., Find specialists that can handle a task with given capabilities., A specialist agent that can be provisioned for company-specific tasks., Check if this specialist can handle a task with given capabilities., Specialist, SpecialistFamily, SystemType (+37 more)
...
### Community 70 - "test_ceo_router.py"
Cohesion: 0.05
Nodes (50): build_ceo_router(), Any, APIRouter, Attempt, _backend(), CEOLedger, GoalRecord, _now() (+42 more)

### Community 71 - "TrafficDirector"
Cohesion: 0.06
Nodes (30): Unique identifier (e.g. 'nvidia', 'cerebras')., get_director(), provider_id_of(), Any, Extract a provider id from a ProviderConfig dataclass or a plain dict., In-process traffic distribution and budget accounting for providers., Count a request that is about to be sent to *provider_id*. Called immediately…, Record the outcome of a request started with ``record_start``. Must be called… (+22 more)

### Community 72 - "Any"
Cohesion: 0.05
Nodes (34): _check_extra_kwargs(), _enforce_signature(), Any, Path, Raise TypeError if fn's signature drifts from the locked contract (Pydantic…, Raise TypeError on unknown kwarg (runtime extra='forbid' for non-Pydantic…, Governance seam: judge the call, run it, audit the outcome. Deliberately a thin…, Append an event to the durable session log if a store is wired in. (+26 more)

### Community 73 - "TokenBudget"
Cohesion: 0.05
...
Cohesion: 0.07
Nodes (57): _governance_check(), _governance_identity(), Any, TaskResult, TaskSpec, Evaluate a runtime dispatch against policy; audit it either way. Returns…, Full record of a routing decision — audit-trail entry., Routes a TaskSpec to the best available runtime following the configured… (+49 more)
...
Cohesion: 0.05
Nodes (59): brain_providers(), Every configured provider with its health AND its on/off state. Powers the…, auto_disable(), _billing_signals(), disabled_provider_ids(), packages/llm/disabled.py — bridge to the durable provider on/off switch. The…, Provider ids currently switched off. Empty when the store is unreachable., Persist a provider as disabled, through the store that already owns it. (+51 more)
...
### Community 81 - "V5App.jsx"
Cohesion: 0.05
Nodes (40): API, getActivity(), getLoops(), V5App, HubTabs(), Spinner(), ActivationGate(), activityToAlert() (+32 more)
...
### Community 89 - "brain_config.py"
Cohesion: 0.05
Nodes (55): _active_primary_provider(), is_north_mini_code_default(), provider_api_keys(), _provider_env_value(), _provider_ids_from_literal(), provider_key_rotation_enabled(), provider_max_parallel(), provider_max_rpm() (+47 more)

### Community 90 - "telegram_bot.py"
Cohesion: 0.06
Nodes (62): Convenience: resolve all four role models for a component. Returns a dict with…, resolve_component_role_models(), get_decisions_store(), Process-wide DecisionsStore singleton (resettable via db_path arg)., Return a Markdown-v1-safe preview string under ``max_chars``. Used by the…, sanitize_paste_for_preview(), _admin_headers(), _answer_callback() (+54 more)
...
### Community 96 - "TaskWorkflowService"
Cohesion: 0.07
Nodes (41): Task, Creates tasks from scheduler and playbook runs using one workflow., TaskAutomationService, ApprovalCheckpoint, Human approval gate in a task's execution., Task, TaskStatus, Record the human decision on a task's **pre-execution** approval gate. A… (+33 more)
...
### Community 98 - "fmtErr"
Cohesion: 0.04
Nodes (43): chatSend(), createWikiPage(), delegateSeoFindings(), deleteCompany(), deleteSource(), fmtErr(), getAgentChatJob(), getCompanyGraph() (+35 more)
...
### Community 100 - "failover_client.py"
Cohesion: 0.05
...
### Community 102 - "test_user_research_skill.py"
Cohesion: 0.06
...
### Community 103 - "test_autonomous_agency_e2e.py"
Cohesion: 0.06
...
### Community 107 - "skill_bindings.py"
Cohesion: 0.05
...
### Community 113 - "test_mcp_governance.py"
Cohesion: 0.06
Nodes (54): Replace the process-wide store. Tests only., reset_approval_store(), get_audit_log(), Return the process-wide audit log, created on first use., Replace the process-wide audit log. Tests only., reset_audit_log(), Replace the process-wide engine. Tests only., reset_policy_engine() (+46 more)
...
### Community 118 - "WorkspaceManager"
Cohesion: 0.05
...
### Community 120 - "AgentSessionStore"
Cohesion: 0.07
...
### Community 124 - "LLMRouter"
Cohesion: 0.06
Nodes (29): Attempt, AgentPolicy, LLMConfig, Per-agent routing overrides (ADR-008 §"named profiles")., The fully-resolved routing configuration., describe(), The operator-facing reason string for an unfixable status., Read the environment variables named in ``env_names`` into a key list. Order is… (+21 more)

### Community 125 - "test_issue_intake.py"
Cohesion: 0.07
Nodes (51): autonomy_tick(), Execute ONE pending task synchronously. Called by the cron workflow every 2…, _capability_tags(), create_task_from_oldest_open_issue(), intake_issue(), _issue_labels(), issue_source_id(), map_issue_to_task() (+43 more)
...
### Community 127 - "ProviderRouter"
Cohesion: 0.07
Nodes (27): CommercialFallbackRequiredError, _get_director(), ProviderAttempt, ProviderFallbackError, ProviderRouter, Any, Response, RuntimeError (+19 more)

### Community 128 - "ArtifactStore"
Cohesion: 0.07
...
### Community 133 - "TaskDispatcher"
Cohesion: 0.05
Nodes (31): Re-queue BLOCKED tasks that have cooled down and are ready for retry., Polls for queued task work and executes it through the coordinator. Crash…, Re-queue tasks stranded by a prior crash or hard-kill., TaskDispatcher, Dispatcher should track first_seen times for pending tasks., Executing a task removes it from _first_seen and logs pickup time. Uses async…, TestTaskDispatcherDiagnostics, _FakeMongoStore (+23 more)
...
### Community 141 - "test_webui_provider_priority.py"
Cohesion: 0.07
...
### Community 142 - "test_kimi_bridge_server.py"
Cohesion: 0.05
...
### Community 147 - "test_render_mcp.py"
Cohesion: 0.06
...
### Community 148 - "App.js"
Cohesion: 0.06
Nodes (28): getAccountLifecycle(), getMe(), login(), logout(), App(), AppRoutes(), ProtectedRoute(), AuthContext (+20 more)

### Community 149 - "_StubProvider"
Cohesion: 0.09
...
### Community 150 - "StreamingDeltaReconstructor"
Cohesion: 0.06
...
### Community 151 - "ChatHistoryStore"
Cohesion: 0.07
...
### Community 153 - "test_startup_warmup.py"
Cohesion: 0.05
...
### Community 155 - "RuntimeCapabilityRegistry"
Cohesion: 0.07
...
### Community 156 - "test_telegram_freebuff.py"
Cohesion: 0.07
...
### Community 159 - "test_web_reach.py"
Cohesion: 0.09
...
### Community 160 - "TestHarnessAdapter"
Cohesion: 0.05
...
### Community 162 - "persist_plan_spec"
Cohesion: 0.07
...
Cohesion: 0.10
Nodes (24): admin_auth.py — auto-generated module docstring (user-research skill scan)., _fake_user_auth(), Path, test_admin_can_create_anthropic_provider_via_webui_admin_api(), test_admin_can_create_provider_via_webui_admin_api(), test_ui_providers_and_workspaces_use_app_state(), _atomic_write_json(), default_store_paths() (+16 more)
...
### Community 167 - "runtimes/manager.py"
Cohesion: 0.06
Nodes (41): OpenHandsAdapter, Any, TaskResult, TaskSpec, Create a conversation in OpenHands and poll for completion., Adapter for OpenHands — TIER 2 / EXPERIMENTAL coding agent. NOTE: OpenHands…, _build_default_manager(), _env_flag() (+33 more)
...
### Community 169 - "activation_api.py"
Cohesion: 0.09
...
### Community 174 - "tests/conftest.py"
Cohesion: 0.05
...
### Community 176 - "TaskBoardScreen.jsx"
Cohesion: 0.05
...
### Community 178 - "test_pr923_fixes.py"
Cohesion: 0.06
...
### Community 179 - "test_colibri_brain_shim.py"
Cohesion: 0.07
...
### Community 184 - "test_slop_gate.py"
Cohesion: 0.07
...
### Community 185 - "OllamaCircuitBreaker"
Cohesion: 0.08
...
### Community 187 - "PromptCacheManager"
Cohesion: 0.06
...
### Community 193 - "emit_chat_observation"
Cohesion: 0.09
...
### Community 194 - "SyntheticDataPipeline"
Cohesion: 0.07
...
### Community 196 - "test_backend_server_features.py"
Cohesion: 0.05
Nodes (30): _append_agent_session_message(), _build_auto_skill_guidance(), _build_provider_router(), _builtin_provider_records(), _chat_provider_policy(), _fallback_local_provider_record(), _in_container(), _mask_observations() (+22 more)

### Community 197 - "ai/router.py"
Cohesion: 0.06
Nodes (40): _dead_model_key(), _exponential_backoff_cooldown(), _is_model_dead(), _mark_model_dead(), _normalized_provider_type(), _notify_watchdog(), provider_router.py — auto-generated module docstring (user-research skill scan)., Notify the brain watchdog of a provider call outcome (fire-and-forget).… (+32 more)

### Community 198 - "ApprovalStore"
Cohesion: 0.07
...
### Community 199 - "test_classify_dependabot_update.py"
Cohesion: 0.08
...
### Community 202 - "test_video_transcript.py"
Cohesion: 0.05
...
Cohesion: 0.08
Nodes (36): _materialize_and_log(), Run the initiative→task materializer, logging failures loudly. Was…, map_initiative_to_task(), materialize_committed(), _portfolio_materialize_enabled(), portfolio_source_id(), Any, Task (+28 more)
...
### Community 209 - "anthropic_compat.py"
Cohesion: 0.09
...
### Community 210 - "test_p0_roadmap_b3_b4_b5.py"
Cohesion: 0.08
Nodes (18): _deep_merge(), get_guardrails(), GuardrailEngine, GuardResult, Any, Configurable safety rail engine for LLM inputs and outputs. Supports: -…, Check user input against input safety rules. Returns a GuardResult with…, Check model output against output safety rules. Returns a GuardResult with… (+10 more)

### Community 211 - "NIMConnectionPool"
Cohesion: 0.07
Nodes (23): CircuitBreakerOpenError, get_nim_pool(), NIMConnectionPool, Any, AsyncClient, Response, RuntimeError, Persistent httpx.AsyncClient pool with circuit breaker and retry logic. Manages… (+15 more)
...
### Community 214 - "test_process_quick_note_workflow.py"
Cohesion: 0.06
...
### Community 217 - "test_governance_api.py"
Cohesion: 0.08
Nodes (41): build_governance_router(), Any, APIRouter, get_approval_store(), Replace the process-wide gate. Tests only., reset_gate(), _client(), parametrize (+33 more)

### Community 218 - "_get_provider_policy"
Cohesion: 0.07
...
### Community 221 - "test_bedrock_provider.py"
Cohesion: 0.08
...
### Community 222 - "timedelta"
Cohesion: 0.07
Nodes (26): PR throughput per cohort over the last `days` days., Count distinct sessions per user. A session ends when there's a gap of more…, Store a report in the bounded in-memory registry., save_report(), demo_agent_tracking(), datetime, Temporal context graph inspired by Graphiti…, Get history of an entity between two times (+18 more)
...
### Community 227 - "Kept Rules — the 44 that survive the audit"
Cohesion: 0.05
...
### Community 231 - "NotificationDispatcher"
Cohesion: 0.08
...
### Community 232 - "test_crispy_workflow.py"
Cohesion: 0.07
...
### Community 235 - "test_one_model_catalogue.py"
Cohesion: 0.07
...
### Community 238 - "test_rbac.py"
Cohesion: 0.08
Nodes (18): get_audit_log(), is_admin(), is_power_user_or_above(), mask_dict(), mask_secret(), Any, Request, Return a short human-readable badge label for display in the UI. (+10 more)
...
### Community 241 - "test_portfolio_intelligence.py"
Cohesion: 0.06
...
### Community 242 - "DirectChatDoctor"
Cohesion: 0.09
...
### Community 243 - "analyze_quantitative"
Cohesion: 0.09
...
Cohesion: 0.10
Nodes (37): get_failover_manager(), ProviderHealth, Enum, Return the singleton BrainFailoverManager., Circuit-breaker state for a provider., _make_manager(), tests/test_brain_failover.py — Universal multi-provider brain failover tests.…, Guards the three tests below from pinning a retired id again: if the fixture… (+29 more)
...
### Community 252 - "test_operational_incidents.py"
Cohesion: 0.06
...
### Community 258 - "test_agent_tool_governance.py"
Cohesion: 0.11
...
### Community 260 - "get_tool_annotations"
Cohesion: 0.08
...
### Community 262 - "test_verification_strategies.py"
Cohesion: 0.11
...
### Community 264 - "get_user_role"
Cohesion: 0.11
Nodes (28): get_user_role(), Extract role from a user object (dict or Pydantic model)., create_secret(), delete_secret(), get_secret_metadata(), get_secrets_store(), _get_user(), list_secrets() (+20 more)

### Community 265 - "Screens"
Cohesion: 0.06
...
### Community 266 - "REWRITE_PLAN.md — Phased Migration Strategy"
Cohesion: 0.06
...
### Community 267 - "test_background_services.py"
Cohesion: 0.08
...
### Community 268 - "test_all_providers_discovery.py"
Cohesion: 0.16
...
### Community 269 - "WorkflowBuildRequest"
Cohesion: 0.08
Nodes (26): WorkflowEngine, Contract: WorkflowEngine cannot skip the gate state machine., Contract: No code path may advance past awaiting_approval unless gate.status ==…, Create a run and manually place it in awaiting_approval., Contract: Cannot approve a run in 'pending' state., Contract: Can approve a run in 'awaiting_approval' state., Contract: Rejecting a run marks it as failed., TestApprovalGateMandatory (+18 more)

### Community 270 - "test_implement_agent_routing.py"
Cohesion: 0.07
...
### Community 271 - "test_persistent_memory.py"
Cohesion: 0.06
...
### Community 275 - "report_to_markdown"
Cohesion: 0.11
...
### Community 281 - "local_controller.py"
Cohesion: 0.12
...
### Community 282 - "test_live_server.py"
Cohesion: 0.22
...
### Community 283 - "._call"
Cohesion: 0.09
Nodes (9): Any, Daily automation tests — 2026-08-16. Covers three improvements landed this…, A message list that exceeds the pruner's threshold should be trimmed., Stub out modules that require full stack deps to allow unit-testing pure logic.…, claude-opus-5 must be in the built-in alias map so routing resolves it., _stub_heavy_imports(), TestApplyReasoningBudget, TestClaude5RegistryEntries (+1 more)

### Community 284 - "ContextCompressor"
Cohesion: 0.11
...
### Community 287 - "ResourceWatchdog"
Cohesion: 0.10
...
### Community 293 - "Security Analysis — local-llm-server"
Cohesion: 0.06
...
### Community 296 - "OnboardingScreen.jsx"
Cohesion: 0.07
Nodes (26): createCompany(), deleteGithubToken(), getCompany(), getOnboardingProgress(), githubStatus(), listGithubRepos(), scanRepo(), scanWebsite() (+18 more)
...
### Community 299 - "OrchestratorQueue"
Cohesion: 0.07
...
### Community 301 - "test_nvidia_model_discovery.py"
Cohesion: 0.06
...
### Community 307 - "TestNormalizeResponseFormat"
Cohesion: 0.08
...
### Community 308 - "Quick-Note GitHub Issues Processing - Session Summary"
Cohesion: 0.06
...
### Community 309 - "probe_catalogues.py"
Cohesion: 0.11
...
### Community 313 - "OrchestratorCheckpointStore"
Cohesion: 0.09
...
### Community 315 - "test_purge_backlog.py"
Cohesion: 0.09
...
### Community 320 - "_openai_url"
Cohesion: 0.08
Nodes (20): _models_url(), Return ``(url, headers)`` for *provider*'s model-listing endpoint. Mirrors…, is_anthropic_base_url(), _openai_url(), True when ``base_url`` points at Anthropic's native Messages API. Anthropic's…, parametrize, Regression tests for the agent loop's multi-provider failover wire format.…, Registry base URLs must produce routes the provider actually serves. (+12 more)

### Community 321 - "switch_brain.py"
Cohesion: 0.16
...
### Community 323 - "test_force_cleanup_conditional_delete.py"
Cohesion: 0.10
...
### Community 328 - "SteeringInjector"
Cohesion: 0.11
...
### Community 329 - "RuntimeHealthService"
Cohesion: 0.09
...
### Community 330 - "test_claude_setup_audit.py"
Cohesion: 0.16
...
### Community 331 - "test_scheduler_hydration_bounded.py"
Cohesion: 0.09
...
### Community 332 - "test_internal_agent_did_work.py"
Cohesion: 0.12
...
### Community 333 - "test_direct_chat_async.py"
Cohesion: 0.13
Nodes (19): make_isolated_workspace(), Path, Create an isolated workspace directory under *root*. This is the legacy path…, runner(), _fake_user(), _FakeChatResult, _FakeResponse, asyncio (+11 more)

### Community 334 - "TerminalPanel"
Cohesion: 0.13
...
### Community 335 - "Python Dependencies (`requirements.txt`)"
Cohesion: 0.07
...
### Community 336 - "Technical Debt Register — local-llm-server"
Cohesion: 0.07
...
### Community 338 - "SetupWizardPage.js"
Cohesion: 0.10
...
### Community 339 - "autonomous_fix.py"
Cohesion: 0.12
...
### Community 343 - "test_agent_scripts_share_one_model_list.py"
Cohesion: 0.10
...
### Community 344 - "test_crispy_burn_in.py"
Cohesion: 0.07
...
### Community 345 - "test_provider_enable_disable.py"
Cohesion: 0.09
...
### Community 346 - "test_skill_registry_boot_refresh.py"
Cohesion: 0.12
...
### Community 347 - "loop.py"
Cohesion: 0.13
Nodes (24): loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., # NOTE: "ollama_base" is kept for backwards compatibility; this runner only…, build_compaction_prompt(), build_execution_prompt(), build_planning_prompt(), build_tool_prompt(), build_verification_prompt(), Any (+16 more)

### Community 348 - "SessionMemory"
Cohesion: 0.14
...
### Community 352 - "Deploy: FreeBuff Telegram bot (24×7)"
Cohesion: 0.07
...
### Community 353 - "Claude Code + Qwen Local Setup"
Cohesion: 0.07
...
### Community 354 - "ProviderConsole.jsx"
Cohesion: 0.08
...
### Community 355 - "test_north_mini_code.py"
Cohesion: 0.08
...
### Community 357 - "CompanyAgencyService"
Cohesion: 0.09
...
### Community 358 - "isolated_telegram_config"
Cohesion: 0.11
...
### Community 360 - "_captured_request_headers"
Cohesion: 0.13
...
### Community 361 - "TestNoNvidiaFallbackIsRetired"
Cohesion: 0.09
...
### Community 365 - "test_phase6_workflow.py"
Cohesion: 0.13
...
### Community 367 - "Performance Analysis — local-llm-server"
Cohesion: 0.08
...
### Community 368 - "platform_controls_router.py"
Cohesion: 0.10
...
### Community 371 - "output_filter.py"
Cohesion: 0.08
...
### Community 372 - "test_rate_limiter.py"
Cohesion: 0.11
...
### Community 373 - "control_registry.py"
Cohesion: 0.14
...
### Community 376 - "test_telegram_approval_e2e.py"
Cohesion: 0.12
...
### Community 377 - "test_brain_migration_writes_a_live_model.py"
Cohesion: 0.10
...
### Community 378 - "test_daily_automation_2026_08_03.py"
Cohesion: 0.11
...
### Community 379 - "TestSchedulerStore"
Cohesion: 0.08
...
### Community 380 - "test_telegram_mutating_commands.py"
Cohesion: 0.08
...
### Community 383 - "open_phase_report"
Cohesion: 0.10
...
### Community 384 - "dependencies"
Cohesion: 0.08
Nodes (25): axios, fast-uri, dependencies, axios, fast-uri, livekit-client, lucide-react, react (+17 more)

### Community 385 - "ensure_self_company"
Cohesion: 0.12
Nodes (24): autonomy_status(), Public autonomy readiness probe — no authentication required. A live deploy…, Fire-and-forget self-bootstrap; never blocks or crashes startup., _schedule_self_bootstrap(), _count_specialists(), ensure_self_company(), _find_self_company(), _find_stale_self_companies() (+16 more)

### Community 386 - "1. The Rules"
Cohesion: 0.08
...
### Community 388 - "Session Handoff — 2026-06-15"
Cohesion: 0.08
...
### Community 389 - "TASK 4 — End-to-end approval-gate test"
Cohesion: 0.08
...
### Community 390 - "generate_context.py"
Cohesion: 0.13
...
### Community 391 - "has_image_content"
Cohesion: 0.12
...
### Community 392 - "test_claude_code_adapter.py"
Cohesion: 0.14
...
### Community 395 - "TestClassifyPlainText"
Cohesion: 0.08
...
### Community 396 - "test_service_token.py"
Cohesion: 0.08
...
### Community 400 - "TestStreamableHTTPTransport"
Cohesion: 0.13
...
### Community 401 - "operational_incidents.py"
Cohesion: 0.12
Nodes (23): _diagnose_and_file(), _file_incident(), _format_incident(), gather_render_evidence(), get_operational_incident_tracker(), OperationalIncident, agent/operational_incidents.py — recurring operational failures, auto-…, One failure mode that recurred often enough to warrant diagnosis. (+15 more)

### Community 402 - "Findings"
Cohesion: 0.08
...
### Community 403 - "Local AI Stack with Docker"
Cohesion: 0.08
...
### Community 404 - "Traffic Distribution Across Providers"
Cohesion: 0.08
...
### Community 405 - "Implementation Prompt: Rich TaskBoard + Agile Sprint Integration"
Cohesion: 0.08
...
### Community 406 - "Telegram Bot Setup"
Cohesion: 0.08
...
### Community 407 - "getBackendUrl"
Cohesion: 0.18
Nodes (17): getAccessToken(), getApiUrl(), getAuthHeaders(), getBackendUrl(), getDefaultBackendUrl(), { getAccessToken, getAuthHeaders, getBackendUrl }, { getBackendUrl }, buildAgentStatusUrl() (+9 more)

### Community 408 - "implement_agent.py"
Cohesion: 0.12
...
### Community 409 - "video_transcript.py"
Cohesion: 0.12
...
### Community 410 - "test_agent_free_brain.py"
Cohesion: 0.09
...
### Community 411 - "control_overrides.py"
Cohesion: 0.12
...
### Community 415 - "test_regression.py"
Cohesion: 0.12
...
### Community 419 - "_status_snapshot"
Cohesion: 0.15
...
### Community 427 - "test_freebuff_bot.py"
Cohesion: 0.11
...
### Community 447 - "test_memory_guard.py"
Cohesion: 0.13
...
### Community 448 - "TestLegacyRouterCacheTTL"
Cohesion: 0.13
...
### Community 449 - "test_anthropic_refusal_fallback.py"
Cohesion: 0.19
...
### Community 450 - "test_telegram_diag_endpoint.py"
Cohesion: 0.09
...
### Community 453 - "WorkspaceManager"
Cohesion: 0.11
...
### Community 455 - "test_dashboard_cache.py"
Cohesion: 0.15
...
### Community 456 - "V3 API Migration Plan — LLM Relay Platform"
Cohesion: 0.10
...
### Community 460 - "test_issue_triage.py"
Cohesion: 0.17
...
### Community 462 - "run_trend_analysis"
Cohesion: 0.18
...
### Community 463 - "test_unit5_ui_provider_surface.py"
Cohesion: 0.10
...
### Community 472 - "Docker AI Governance Audit — Final Report"
Cohesion: 0.10
...
### Community 473 - "1. Capability-by-capability"
Cohesion: 0.10
...
### Community 475 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 476 - "ControlsScreen.jsx"
Cohesion: 0.15
...
### Community 481 - "DecisionsStoreTests"
Cohesion: 0.11
...
### Community 482 - "PriorityTaskQueue"
Cohesion: 0.15
...
### Community 485 - "TestBrainFailoverModelUpdates"
Cohesion: 0.18
...
### Community 493 - "Skill: fabric-patterns"
Cohesion: 0.11
...
### Community 494 - "Analysis & Synthesis Instructions"
Cohesion: 0.11
Nodes (18): 1. Define the Atmosphere, 2. Map the Color Palette, 3. Establish Typography Rules, 4. Define the Hero Section, 5. Describe Component Stylings, 6. Define Layout Principles, 7. Define Responsive Rules, 8. Encode Motion Philosophy (+10 more)

### Community 495 - "Production Readiness Assessment — local-llm-server"
Cohesion: 0.11
...
### Community 496 - "Skill: fabric-patterns"
Cohesion: 0.11
Nodes (18): 1. Ensure Pattern Directory Exists, 2. List Available Patterns, 3. Retrieve a Pattern, 4. Apply a Pattern with Variables, 5. Stitch Patterns Together, 6. Create New Patterns, Acceptance Checks, Directory Structure (+10 more)

### Community 497 - "db/__init__.py"
Cohesion: 0.14
...
### Community 498 - "Admin Dashboard Guide"
Cohesion: 0.11
...
### Community 499 - "Implementation Plan"
Cohesion: 0.11
...
### Community 500 - "resolve_free_nvidia_brain"
Cohesion: 0.12
...
### Community 501 - "model_discovery.py"
Cohesion: 0.13
Nodes (18): cached_models(), discover_models(), _fresh_entry(), _parse_ids(), Any, Ask a provider which models the configured API key may actually use.…, Return the cached list for *provider_id* without any network call. The…, Remember which of *provider_id*'s models a failed round already sent. The… (+10 more)

### Community 502 - "Delegation Plan (agent-ready work packages)"
Cohesion: 0.11
...
### Community 503 - "test_p0_roadmap_a4_a5_b2.py"
Cohesion: 0.15
...
### Community 507 - "test_task_source_id_race.py"
Cohesion: 0.17
...
### Community 508 - "test_brain_patch_service_token.py"
Cohesion: 0.18
...
### Community 509 - "TestSelfHealingInfrastructureClassification"
Cohesion: 0.19
...
### Community 510 - "test_fabric_patterns.py"
Cohesion: 0.11
...
### Community 511 - "test_repowise_intelligence.py"
Cohesion: 0.11
...
### Community 512 - "validate_session_id"
Cohesion: 0.16
...
### Community 513 - "ErrorInterceptorMiddleware"
Cohesion: 0.18
...
### Community 515 - "Comprehensive Skill Index (By Category)"
Cohesion: 0.11
...
### Community 516 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 517 - "Component Map"
Cohesion: 0.11
...
### Community 518 - "Architecture Overview — local-llm-server"
Cohesion: 0.11
...
### Community 519 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
...
### Community 528 - "test_company_api.py"
Cohesion: 0.11
...
### Community 529 - "TestStopSlopChecker"
Cohesion: 0.11
...
### Community 530 - "test_telegram_service_webhook.py"
Cohesion: 0.18
...
### Community 531 - "test_telegram_webhook.py"
Cohesion: 0.14
...
### Community 536 - "cowork_session.py"
Cohesion: 0.15
...
### Community 537 - "SKILL: Industrial Brutalism & Tactical Telemetry UI"
Cohesion: 0.12
...
### Community 538 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 539 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 540 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 542 - "redact_connection_url"
Cohesion: 0.17
...
### Community 547 - "TestAListingFailureDoesNotVetoTheAnswer"
Cohesion: 0.17
...
### Community 548 - "test_daily_automation_2026_07_11.py"
Cohesion: 0.15
...
### Community 553 - "test_orchestrator_merge_decision.py"
Cohesion: 0.24
...
### Community 555 - "test_skill_registry.py"
Cohesion: 0.13
...
### Community 564 - "Skill: repowise-intelligence"
Cohesion: 0.12
...
### Community 565 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
...
### Community 566 - "_valid_login_state"
Cohesion: 0.24
...
### Community 567 - "Skill: repowise-intelligence"
Cohesion: 0.12
Nodes (15): 1. Graph Intelligence (Dependency Graph), 2. Git Intelligence, 3. Documentation Intelligence, 4. Decision Intelligence, Acceptance Checks, Directory Structure, Example Usage, Implementation Approach (+7 more)

### Community 568 - "The 10-Step Workflow"
Cohesion: 0.12
...
### Community 569 - "Nothing is blocked on an agent. Two things need a human."
Cohesion: 0.12
...
### Community 573 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 575 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
...
### Community 576 - "RateLimitTracker"
Cohesion: 0.16
...
### Community 582 - "ManagedAgentDreams"
Cohesion: 0.22
...
### Community 583 - "_process_task_callback"
Cohesion: 0.28
...
### Community 584 - "test_agency_workflows_carry_the_failover_chain.py"
Cohesion: 0.18
...
### Community 585 - "test_autonomy_status.py"
Cohesion: 0.12
...
### Community 587 - "DailyDigestAggregatorTests"
Cohesion: 0.19
...
### Community 588 - "test_dockerfile_ships_root_modules.py"
Cohesion: 0.17
...
### Community 589 - "test_langfuse_agency_wide.py"
Cohesion: 0.12
...
### Community 590 - "test_local_brain_state.py"
Cohesion: 0.12
...
### Community 593 - "test_phase5_doctor.py"
Cohesion: 0.12
...
### Community 594 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 595 - "test_refresh_agent_built_proof.py"
Cohesion: 0.12
...
### Community 599 - "CollaborationContext"
Cohesion: 0.17
...
### Community 600 - "Skill: agent-harness"
Cohesion: 0.13
...
### Community 601 - "Skill: checkpoint-strategy"
Cohesion: 0.13
...
### Community 603 - "Skill: local-ai-query"
Cohesion: 0.13
...
### Community 604 - "Skill: parallel-agents"
Cohesion: 0.13
...
### Community 605 - "Skill: parallel-worktrees"
Cohesion: 0.13
...
### Community 606 - "Design System: Taste Standard"
Cohesion: 0.13
...
### Community 608 - "Skill: user-research"
Cohesion: 0.13
...
### Community 609 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 613 - "router/health.py"
Cohesion: 0.20
...
### Community 614 - "DockerAgentAdapter"
Cohesion: 0.17
...
### Community 617 - "TestDecisionsBotLinks"
Cohesion: 0.17
...
### Community 618 - "DecisionsStore"
Cohesion: 0.30
Nodes (3): DecisionsStore, Any, Connection

### Community 619 - "clear_wizard_state_cache"
Cohesion: 0.21
...
### Community 621 - "TestBrainConfigUpdates"
Cohesion: 0.22
...
### Community 622 - "test_dockerfile_ships_config_dir.py"
Cohesion: 0.14
...
### Community 628 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 632 - "Checks Performed"
Cohesion: 0.14
...
### Community 633 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 634 - "admin_digest_router.py"
Cohesion: 0.22
...
### Community 635 - "Skill: branch-cleanup"
Cohesion: 0.14
...
### Community 636 - "Skill: perplexity — Web Research via Perplexity API"
Cohesion: 0.14
...
### Community 639 - "Quick-Note Issues Processing Summary"
Cohesion: 0.14
...
### Community 640 - "DirectChatSession"
Cohesion: 0.15
...
### Community 641 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 643 - "Render MCP — autonomous platform debugging and environment monitoring"
Cohesion: 0.14
...
### Community 644 - "Runbook: Auto-Resume After Cooldown / Interruption"
Cohesion: 0.14
...
### Community 645 - "SEO / GEO / AIO Audit Engine"
Cohesion: 0.14
...
### Community 649 - "extract_failures"
Cohesion: 0.21
...
### Community 652 - "test_critical_flows.py"
Cohesion: 0.29
...
### Community 653 - "TestAnthropicToolListCaching"
Cohesion: 0.34
...
### Community 654 - "test_autonomy_pipeline_regressions.py"
Cohesion: 0.15
...
### Community 656 - "TestMCPToolsListCache"
Cohesion: 0.19
...
### Community 658 - "test_openclaw_gateway.py"
Cohesion: 0.14
...
### Community 659 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 660 - "test_tasks_awaiting_approval_api.py"
Cohesion: 0.37
...
### Community 663 - "register_user_research_tools"
Cohesion: 0.21
...
### Community 665 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 668 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 669 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 672 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
...
### Community 673 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 674 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 676 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 680 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
Nodes (12): Acceptance Checks, Claude's query protocol (use this instead of Read tool for exploration):, Graph Artifacts — What to Commit, How to Use the Graph (Token Savings Protocol), Installation (one-time per machine), Instead of reading raw files:, Key commands:, Relationship to repowise-intelligence Skill (+4 more)

### Community 681 - "Skill: platform-setup — Autonomous Agency Bootstrap"
Cohesion: 0.15
...
### Community 682 - "Device compatibility and model picks"
Cohesion: 0.15
...
### Community 683 - "Autonomy Uplift — Living Roadmap & Detailed Implementation Specs"
Cohesion: 0.15
...
### Community 684 - "OpenClaw — iOS Control of the Agency (Single-Service Free-Tier Deploy)"
Cohesion: 0.15
...
### Community 689 - "_is_bedrock_model_id"
Cohesion: 0.27
...
### Community 691 - "Agent Transparency Report"
Cohesion: 0.15
...
### Community 692 - "update_provider_policy"
Cohesion: 0.19
...
### Community 694 - "_InMemoryBackend"
Cohesion: 0.18
...
### Community 697 - "TestModelCostTableUpdates"
Cohesion: 0.26
...
### Community 699 - "test_deploy_trigger_covers_image.py"
Cohesion: 0.21
...
### Community 700 - "TestKillSwitchDurability"
Cohesion: 0.15
...
### Community 701 - "test_quick_note_engine.py"
Cohesion: 0.17
...
### Community 702 - "TestRouterIntegration"
Cohesion: 0.31
...
### Community 704 - "WorkspaceManifest"
Cohesion: 0.17
...
### Community 705 - "skill_registry.py"
Cohesion: 0.17
...
### Community 707 - "AGENTS.md — Codebase Map & Operations Reference"
Cohesion: 0.17
...
### Community 712 - "Skill: system-prompt-audit"
Cohesion: 0.17
...
### Community 713 - "Skill: task-alive-updates"
Cohesion: 0.17
...
### Community 716 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 719 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 721 - "Main proxy (`proxy.py`)"
Cohesion: 0.17
...
### Community 722 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 723 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 724 - "Workspace Isolation Architecture"
Cohesion: 0.17
...
### Community 725 - "Quantization Internals"
Cohesion: 0.17
...
### Community 726 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 727 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 728 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 731 - "install-agents.sh"
Cohesion: 0.39
...
### Community 732 - "check_container_posture.py"
Cohesion: 0.26
...
### Community 733 - "test_pytest_failure_parser.py"
Cohesion: 0.23
...
### Community 734 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 735 - "test_admin_local_brain_router.py"
Cohesion: 0.29
...
### Community 736 - "test_agile_api.py"
Cohesion: 0.17
...
### Community 737 - "test_app_settings.py"
Cohesion: 0.21
...
### Community 738 - "test_brain_default_consistency.py"
Cohesion: 0.24
...
### Community 742 - "test_task_clarification.py"
Cohesion: 0.17
...
### Community 746 - "_extractive_compress"
Cohesion: 0.18
...
### Community 749 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 752 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 753 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 755 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 758 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 759 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 760 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 761 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 762 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 763 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 764 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 765 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 767 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 768 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 769 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 770 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 771 - "What to clean up"
Cohesion: 0.18
...
### Community 772 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 774 - "test_bedrock_live.py"
Cohesion: 0.25
...
### Community 780 - "test_conftest_hermetic_env.py"
Cohesion: 0.18
...
### Community 781 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 782 - "test_event_log.py"
Cohesion: 0.45
...
### Community 783 - "test_google_provider_models.py"
Cohesion: 0.18
...
### Community 788 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 789 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 790 - "admin_local_brain_router.py"
Cohesion: 0.22
...
### Community 791 - "_normalize_tool_choice"
Cohesion: 0.31
...
### Community 792 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 793 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 794 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 795 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 796 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 797 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 798 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 800 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 801 - "LLM Router — configuration guide"
Cohesion: 0.20
...
### Community 802 - "LLM Router — provider guide"
Cohesion: 0.20
...
### Community 807 - "cost_tracker.py"
Cohesion: 0.24
Nodes (9): _build_cost_table(), clear_stats(), _load_env_overrides(), Per-model cost attribution for the LLM provider router. Maintains in-memory…, Record token usage for *model* (fire-and-forget, never raises). ``tag`` is a…, Reset all aggregates (intended for testing)., Parse MODEL_COST_INPUT / MODEL_COST_OUTPUT env overrides. Format:…, record_usage() (+1 more)

### Community 808 - "_parse_reset_epoch"
Cohesion: 0.33
...
### Community 812 - "_resolve_push_token"
Cohesion: 0.31
...
### Community 813 - "test_cost_attribution.py"
Cohesion: 0.20
Nodes (5): Tests for packages/ai/cost_tracker.py — per-model cost attribution. Covers: -…, A repeated key in a dict literal is silent: the later value wins. Found on…, TestClearStats, TestEnvOverrides, TestTheCostTableHasNoDuplicateKeys

### Community 814 - "TestZeroAttemptDiagnostics"
Cohesion: 0.29
...
### Community 815 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 816 - "test_model_catalog_guard.py"
Cohesion: 0.29
...
### Community 819 - "_FakePersistence"
Cohesion: 0.20
...
### Community 820 - "TestRevenuePortfolio"
Cohesion: 0.20
...
### Community 822 - "test_version_consistency.py"
Cohesion: 0.20
...
### Community 827 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 828 - "Skill: changelog-enforcer"
Cohesion: 0.22
...
### Community 829 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 833 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 834 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 836 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
Nodes (8): Branch, Components, Purpose, Quick Start, Session Roles, Skill: cowork-session (Claude Cowork), Testing, When to Use

### Community 837 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 838 - "Active Task Tracker"
Cohesion: 0.22
...
### Community 840 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 841 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 842 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 843 - "Issue #1356: quick-note:https://searchengineland.com/turn-seo-backlog-into-roadmap-485713"
Cohesion: 0.22
...
### Community 844 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 845 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 846 - "Platform Controls"
Cohesion: 0.22
...
### Community 847 - "Release Procedure"
Cohesion: 0.22
...
### Community 848 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 850 - "frontend/package.json"
Cohesion: 0.22
Nodes (8): jest, moduleNameMapper, ^react-router$, ^react-router-dom$, name, private, proxy, version

### Community 851 - "TestTheProducersAndTheParserCannotDrift"
Cohesion: 0.25
...
### Community 852 - "_get_current_user"
Cohesion: 0.25
...
### Community 853 - "SeoCheckDefinition"
Cohesion: 0.31
...
### Community 855 - "enrich_quick_note_issues.py"
Cohesion: 0.42
...
### Community 861 - "TestPaidPolicyDurability"
Cohesion: 0.22
...
### Community 870 - "quality_checker.py"
Cohesion: 0.32
...
### Community 882 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 883 - "ceo-micromanagement.md"
Cohesion: 0.25
Nodes (4): P0 behavior change, Readiness contract, Runtime model, Runtime types

### Community 884 - "Feature Maturity / Support Matrix"
Cohesion: 0.25
...
### Community 887 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.25
...
### Community 888 - "Issue #362: Nvidia repo setup"
Cohesion: 0.25
...
### Community 889 - "Issue #364: quick-note:https://www.marktechpost.com/2026/06/01/meet-memory-os-a-6-layer-open-source-memory-stack-built-on-top-of-hermes-agent/"
Cohesion: 0.25
...
### Community 890 - "Issue #378: quick-note:https://www.marktechpost.com/2026/06/02/tinyfish-launches-bigset-an-open-source-multi-agent-system-that-builds-structured-live-datasets-from-plain-english-descriptions/"
Cohesion: 0.25
...
### Community 891 - "Issue #379: quick-note:https://searchengineland.com/schema-markup-optimize-agentic-web-479080"
Cohesion: 0.25
...
### Community 892 - "Issue #380: quick-note:https://cursor.com/blog/cloud-agent-lessons"
Cohesion: 0.25
...
### Community 893 - "Issue #381: quick-note:https://www.xda-developers.com/claude-code-with-opus-48-is-expensive-but-i-made-it-efficient-with-my-local-ai-workflow/"
Cohesion: 0.25
...
### Community 894 - "Issue #382: quick-note:https://claude.com/blog/how-coderabbit-used-claude-to-build-an-agent-orchestration-system"
Cohesion: 0.25
...
### Community 895 - "Issue #383: quick-note:https://www.marktechpost.com/2026/05/29/hexo-labs-open-sources-sia-a-self-improving-agent-that-updates-both-the-harness-and-the-model-weights/"
Cohesion: 0.25
...
### Community 896 - "Issue #416: feat: Self-hosted Codebuff (freebuff) on free NVIDIA models + Telegram bot phone control"
Cohesion: 0.25
...
### Community 897 - "Issue #485: [Trend Digest] Week of 2026-06-08"
Cohesion: 0.25
...
### Community 898 - "Issue #488: quick-note:https://github.com/cookiy-ai/user-research-skill"
Cohesion: 0.25
...
### Community 899 - "Issue #491: Implement whatever is necessary from https://github.com/BehiSecc/awesome-claude-skills"
Cohesion: 0.25
...
### Community 900 - "Issue #493: Use the https://github.com/mvanhorn/last30days-skill skill to get the trend updated"
Cohesion: 0.25
...
### Community 901 - "Issue #495: Read https://www.anthropic.com/news/claude-fable-5-mythos-5 and understand if mythos or fable can be added to the repo"
Cohesion: 0.25
...
### Community 902 - "Issue #504: EPIC: Autonomy hardening — live-verified defects 2026-06-10"
Cohesion: 0.25
...
### Community 903 - "Issue #581: Sprint tracker: pending work after brand rename + mobile-first pass"
Cohesion: 0.25
...
### Community 905 - "Issue #657: quick-note:https://github.com/earendil-works/pi"
Cohesion: 0.25
...
### Community 906 - "Issue #659: quick-note:https://github.com/nex-agi/Nex-N2"
Cohesion: 0.25
...
### Community 907 - "Issue #660: quick-note:https://github.com/getsentry/sentry-for-ai"
Cohesion: 0.25
...
### Community 908 - "Issue #661: quick-note:https://github.com/XiaomiMiMo/MiMo-Code"
Cohesion: 0.25
...
### Community 909 - "Issue #664: quick-note:https://github.com/Grominet95/jarvis-OS"
Cohesion: 0.25
...
### Community 910 - "Issue #666: quick-note:https://github.com/porokka/jarvis-os"
Cohesion: 0.25
...
### Community 911 - "Issue #670: quick-note:https://github.com/perplexityai/bumblebee"
Cohesion: 0.25
...
### Community 912 - "Issue #672: quick-note:https://github.com/Chachamaru127/claude-code-harness"
Cohesion: 0.25
...
### Community 913 - "Issue #676: quick-note:https://github.com/WeiboAI/VibeThinker"
Cohesion: 0.25
...
### Community 914 - "Issue #820: quick-note:https://github.com/cobusgreyling/loop-engineering"
Cohesion: 0.25
...
### Community 915 - "Positional Encoding Internals"
Cohesion: 0.25
...
### Community 916 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 917 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 918 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 919 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 920 - "Continual Harness (`agent/harness_spec.py`)"
Cohesion: 0.25
...
### Community 921 - "Prime Agent Runtime"
Cohesion: 0.25
...
### Community 929 - "TestItIsNotBuiltForOneVendor"
Cohesion: 0.25
...
### Community 930 - "test_compose_and_coordinate_api.py"
Cohesion: 0.36
...
### Community 931 - "test_generate_context_standing_instructions.py"
Cohesion: 0.32
...
### Community 932 - "test_local_brain_router_smoke.py"
Cohesion: 0.25
...
### Community 935 - "test_provider_models_db_outage.py"
Cohesion: 0.25
...
### Community 937 - "test_runtimes_health_endpoint.py"
Cohesion: 0.25
...
### Community 939 - "test_serve_spa_prefixes.py"
Cohesion: 0.36
...
### Community 941 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 949 - "_load_local_metrics_since"
Cohesion: 0.43
...
### Community 953 - "Changelog"
Cohesion: 0.29
Nodes (7): Added, Changed, Changelog, Fixed, Maintenance, Removed, Security

### Community 954 - "AI Engineering Insights Skill"
Cohesion: 0.29
...
### Community 967 - "Changelog"
Cohesion: 0.29
Nodes (7): Added, Changed, Changelog, Fixed, Maintenance, Removed, Security

### Community 968 - "claude-mem Plugin — Persistent Memory for All Sessions"
Cohesion: 0.29
...
### Community 969 - "Implementation plan + TO-DO (check off as you go)"
Cohesion: 0.29
...
### Community 972 - "Cloudflare = the real working app"
Cohesion: 0.29
...
### Community 980 - "e2e_smoke.py"
Cohesion: 0.57
Nodes (5): _chat(), check(), _health(), _models(), _req()

### Community 981 - "BackgroundServices"
Cohesion: 0.38
...
### Community 988 - "test_daily_2026_06_14.py"
Cohesion: 0.38
...
### Community 990 - "TestSupportMatrixDocsSync"
Cohesion: 0.29
...
### Community 991 - "test_doctor_coding_brain.py"
Cohesion: 0.38
...
### Community 1019 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 1020 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 1021 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 1022 - "StatusPill.jsx"
Cohesion: 0.47
Nodes (5): C, STATUS_META, StatusPill(), TONE_BG(), TONE_BORDER()

### Community 1023 - "get_control"
Cohesion: 0.33
...
### Community 1025 - "apply_phase1_changes.py"
Cohesion: 0.33
...
### Community 1037 - "TestDirectChatAgentExecution"
Cohesion: 0.33
...
### Community 1039 - "test_catalogue_probe.py"
Cohesion: 0.33
...
### Community 1058 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 1059 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 1070 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1071 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1072 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 1073 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 1074 - "parse_pytest_failures.py"
Cohesion: 0.50
...
### Community 1086 - "TestModelRoleSeparation"
Cohesion: 0.40
...
### Community 1115 - "test_no_exception_detail_leaks.py"
Cohesion: 0.50
...
### Community 1121 - "get_stats"
Cohesion: 0.67
Nodes (3): get_stats(), Any, Return a JSON-serialisable snapshot of per-model cost attribution.

### Community 1141 - "test_the_reserve_is_bounded_when_read_from_the_environment"
Cohesion: 0.67
...
## Knowledge Gaps
- **3460 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3455 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 13236 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **123 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `_fixture()` connect `_fixture` to `Task`, `test_llm_router_queue_cache.py`, `resolve_active_brain`, `test_llm_router_strategies.py`, `SelfHealingAgent`, `test_model_router.py`, `BrainConfig`, `test_catalogue_probe.py`, `test_company_api.py`, `test_llm_router_resilience.py`, `resolve_e2b_config`, `PolicyEngine`, `models/company_graph.py`, `test_telegram_service_webhook.py`, `AgentDefinition`, `test_telegram_webhook.py`, `enforcement.py`, `llm/router.py`, `PrimeAgentAdapter`, `E2BSandboxSession`, `services/background.py`, `services/seo_audit.py`, `test_failover_client_shared.py`, `Agency`, `test_unit8_model_catalog.py`, `test_openclaw_endpoints.py`, `test_orchestrator_merge_decision.py`, `ProviderConfig`, `validate_policy_text`, `test_brain_availability_doctor.py`, `KeyPool`, `TaskExecutionCoordinator`, `AgentJobManager`, `ImprovementLoop`, `get_workflow_orchestrator`, `test_sam_livekit.py`, `AgentSwarm`, `_clean_phases`, `SQLiteStore`, `test_telegram_auto_approve.py`, `test_ceo_router.py`, `test_autonomy_status.py`, `TokenBudget`, `test_local_brain_state.py`, `brain_failover.py`, `test_llm_router_e2e.py`, `TestChatHistoryStore`, `test_phase5_doctor.py`, `config.py`, `TestClient`, `test_ai_insights.py`, `test_refresh_agent_built_proof.py`, `test_procedural_memory.py`, `sam`, `brain_config.py`, `TaskWorkflowService`, `test_knowledge_sync.py`, `e2e/test_browser.py`, `clear_cooldowns`, `test_mcp_governance.py`, `test_issue_intake.py`, `test_context_rulebook.py`, `ArtifactStore`, `BackgroundAgent`, `run_task`, `UserRole`, `KeyStore`, `test_webui_provider_priority.py`, `test_kimi_bridge_server.py`, `test_openclaw_gateway.py`, `ChatHistoryStore`, `_step`, `test_startup_warmup.py`, `test_telegram_freebuff.py`, `test_trend_watcher.py`, `TestHarnessAdapter`, `claim`, `persist_plan_spec`, `TestEstimateTokensForMessages`, `test_new_features_e2e.py`, `test_e2b_adapter.py`, `MCPClient`, `tests/conftest.py`, `FeatureMaturity`, `_Budget`, `test_colibri_brain_shim.py`, `test_e2b_task_wiring.py`, `OllamaCircuitBreaker`, `_job_text`, `emit_chat_observation`, `test_features_api.py`, `test_video_transcript.py`, `TrendWatcher`, `test_portfolio_intake.py`, `test_process_quick_note_workflow.py`, `apply_review.py`, `test_agile_api.py`, `test_app_settings.py`, `TestAgentRunnerSafety`, `SchedulerStore`, `test_task_clarification.py`, `NotificationDispatcher`, `test_crispy_workflow.py`, `TestClient`, `DirectChatDoctor`, `ContextPruner`, `test_control_plane_api.py`, `test_agent_tool_governance.py`, `rate_limiter.py`, `WorkflowBuildRequest`, `test_persistent_memory.py`, `SecurityScanner`, `OutputFilter`, `test_platform_controls.py`, `test_sam_voice.py`, `cost_tracker.py`, `capture_screens.py`, `OrchestratorQueue`, `_resolve_push_token`, `test_nvidia_model_discovery.py`, `TestMongoGate`, `TestNormalizeResponseFormat`, `OrchestratorCheckpointStore`, `session_retro.py`, `test_purge_backlog.py`, `analyze_page`, `SeoFixRequest`, `test_scheduler_hydration_bounded.py`, `test_direct_chat_async.py`, `test_agent_scripts_share_one_model_list.py`, `test_crispy_burn_in.py`, `test_provider_enable_disable.py`, `test_skill_registry_boot_refresh.py`, `isolated_telegram_config`, `platform_controls_router.py`, `_undeclared`, `test_claude_code_adapter.py`, `ResearchTask`, `test_service_token.py`, `test_harness_spec.py`, `test_agent_free_brain.py`, `test_regression.py`, `test_agency_fix.py`, `test_ping.py`, `test_runtimes_health_endpoint.py`, `test_freebuff_bot.py`, `test_monitor_lib.py`, `test_v4_api.py`, `test_telegram_diag_endpoint.py`, `.record`, `test_dashboard_cache.py`, `client`, `TestTheWorkflowIsSafeAndReadOnly`, `test_doctor_coding_brain.py`, `test_voice_pipeline.py`, `model_discovery.py`, `test_brain_patch_service_token.py`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `.execute`, `test_agent_tool_governance.py`, `GitHubTools`, `proxy.py`, `ExecutionRequest`, `_fixture`, `BackgroundAgent`, `TaskSpec`, `AgentPlan`, `TestAgentRunnerExecution`, `test_empirical_verify.py`, `ReactScratchpad`, `PolicyEngine`, `enforcement.py`, `test_agent_free_brain.py`, `ContextManager`, `E2BSandboxSession`, `test_failover_client_shared.py`, `MultiAgentSwarm`, `test_daily_automation_2026_07_11.py`, `TestAgentLoopMCPIntegration`, `test_e2b_adapter.py`, `MCPClient`, `StuckDetector`, `LocalWorkspace`, `CEODispatcher`, `WorkspaceTools`, `test_backend_server_features.py`, `Any`, `TokenBudget`, `test_direct_chat_async.py`, `test_governance_api.py`, `loop.py`, `UserMemoryStore`, `TestAgentRunnerSafety`, `direct_chat.py`, `test_autonomous_agency_e2e.py`, `test_mcp_governance.py`, `InternalAgentAdapter`, `FreeBuffAgent`, `AgentSessionStore`, `AdaptiveHalter`, `ContextPruner`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `SelfHealingAgent` connect `SelfHealingAgent` to `NotificationDispatcher`, `analyze`, `test_integration_c4_c5_c6_d3.py`, `ImprovementLoop`, `TestSelfHealingInfrastructureClassification`, `services/background.py`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Are the 215 inferred relationships involving `HTTPException` (e.g. with `activate_instance()` and `change_user_role()`) actually correct?**
  _`HTTPException` has 215 INFERRED edges - model-reasoned connections that need verification._
