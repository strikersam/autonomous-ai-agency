# Graph Report - autonomous-ai-agency  (2026-06-15)

## Corpus Check
- 913 files · ~1,060,475 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 16743 nodes · 36035 edges · 800 communities (709 shown, 91 thin omitted)
- Extraction: 79% EXTRACTED · 21% INFERRED · 0% AMBIGUOUS · INFERRED: 7689 edges (avg confidence: 0.51)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1f502341`
...
## Communities (800 total, 91 thin omitted)
...
Cohesion: 0.07
Nodes (22): get_trend_watcher(), agent/trend_watcher.py — Internet-connected AI trend intelligence.  Fetches fr, set_trend_watcher(), _FakeClient, Tests for agent/trend_watcher.py, Ensure expanded keyword set covers key new categories., test_fetch_arxiv(), test_fetch_github_trending() (+14 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (329): AgentJobRequest, AgentJobSnapshot, Complete point-in-time view of a job, safe to serialise as API response., Convenience: the canonical text response, whether success or failure., Validated input for creating a new agent job.      Passed from the API handler, DirectChatDoctor, QuickNoteQueue, Thread-safe, file-backed queue for iPhone quick-note URLs. (+321 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (177): agent/background.py — Background Agent  An always-on worker thread that proces, get_tracker(), Return the shared AutonomyTracker singleton (lazy-init)., get_skill_registry_safe(), Return the global SkillRegistry if set, else None.     Used by onboarding and ot, get_public_kpis(), Public, read-only autonomy KPIs — no authentication required.      Surfaces the, _estimate_tokens_for_messages() (+169 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (32): CompanyGraphService, Get a company by ID.                  Args:             company_id: Company ID, Update a company.                  Args:             company_id: Company ID, Delete a company and all its associated data.                  Args:, List companies with optional filtering.                  Args:             owner, Get the company graph for a company, or create one if it doesn't exist., Get the company graph for a company.          Args:             company_id: Comp, Compute the completeness score (0.0–1.0) for a company's graph.          Loads t (+24 more)

### Community 5 - "Community 5"
Cohesion: 0.07
Nodes (114): runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized).  Aider (https, Run aider non-interactively via `--message` flag., json_safe(), runtimes/adapters/claude_code.py — Claude Code CLI adapter (FIRST CLASS).  Claud, runtimes/adapters/docker_agent.py — Docker-based agent runtime adapter.  Spawns, runtimes/adapters/goose.py — Goose adapter (TIER 2).  Goose (https://github.com/, runtimes/adapters/hermes.py — Hermes Agent adapter (FIRST CLASS).  Hermes Agent, Submit task to Hermes via its /tasks endpoint. (+106 more)

### Community 6 - "Community 6"
Cohesion: 0.12
Nodes (12): is_commercial_provider(), _normalized_provider_type(), _provider_field(), provider_sort_key(), ProviderAttempt, Any, Response, Parse a 429/503 ``Retry-After`` header → seconds, or None.          Accepts eith (+4 more)

### Community 7 - "Community 7"
Cohesion: 0.06
Nodes (18): _is_bedrock_model_id(), Return True if model_id is an AWS Bedrock model or inference profile ID., _bedrock_api_response(), _bedrock_provider(), _mock_boto3(), Tests for AWS Bedrock provider support in ProviderRouter., Inject a mock boto3 module into sys.modules for the duration of the block., Verify that Bedrock model IDs bypass non-Bedrock providers. (+10 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (102): Adapter for a compatible external task harness., TaskHarnessAdapter, PreflightIssue, PreflightReport, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace, AgentJob, AgentJobManager, make_isolated_workspace() (+94 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (97): Evidence, Evidence supporting a system detection., Inferred technology stack from website/repo analysis., StackInference, main(), Returns (url, ok, summary)., _scan_one(), _content_contains_domain() (+89 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (85): _best_cloud_primary_base(), InternalAgentAdapter, _nvidia_provider_chain(), Built-in agent loop — Nvidia NIM primary, Ollama fallback., Return runtime dependencies required by this adapter.                  Returns:, Determine availability of the internal agent runtime.          Checks cloud prov, Execute a TaskSpec using the internal AgentRunner and convert the agent's outcom, Create an isolated execution context for a single task.          Tries ``git wor (+77 more)

### Community 11 - "Community 11"
Cohesion: 0.05
Nodes (109): BusinessCategory, CompanyGraphService, CompanyGraphSnapshot, ApprovalPolicy, BusinessSystem, Company, CompanyGraph, CompanyGraphSnapshot (+101 more)

### Community 12 - "Community 12"
Cohesion: 0.06
Nodes (40): ProviderManager, _atomic_write_json(), default_store_paths(), get_data_dir(), _now(), Any, Path, _normalize_base_url() (+32 more)

### Community 13 - "Community 13"
Cohesion: 0.11
Nodes (12): _NoopDB, OrchestratorCheckpointStore, Any, Restore in-flight runs at startup.          Called during backend bootstrap.  Re, Fallback in-memory store when no DB is available., Persist orchestrator runs so they survive restarts., Persist a WorkflowRun snapshot., Load a persisted run snapshot. (+4 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (106): _bullets(), generate_backlog_retro(), generate_sprint_retro(), generate_standup(), plan_next_sprint(), AgileSprint, PortfolioManager, Agentic Agile — autonomous ceremonies (standup, retro, sprint planning).  Where (+98 more)
...
Cohesion: 0.03
Nodes (77): AutonomyTracker, Singleton tracker for autonomy KPIs.      Usage::          from agent.kpi im, Path, UserMemoryStore, tools.py — WorkspaceTools: read/write/search and diff application (risky module), Return a previously saved memory value, or an empty string if absent., Persist a key/value pair to the user's profile store., Return the first *lines* lines of a file.          Just-in-time retrieval: the e (+69 more)
...
Cohesion: 0.02
Nodes (125): get_orchestrator_checkpoint_store(), services/orchestrator_checkpoint.py — Durable step-level checkpointing  Issue #5, get_orchestrator_queue(), services/orchestrator_queue.py — Async FIFO run queue with concurrency semaphore, start_orchestrator_queue(), BoundContext, ExecutionRequest, _get_ceo_dispatcher() (+117 more)

### Community 20 - "Community 20"
Cohesion: 0.05
Nodes (57): _parse_ceo_directives(), DetectedIssue, ImprovementLoop, ImprovementLoopState, IssueSeverity, _now(), Any, Path (+49 more)
...
Cohesion: 0.12
Nodes (28): _bug_scores(), _clean(), _env_github_token(), estimate_job_size(), fetch_github_signals(), fetch_research_alerts(), initiatives_from_bug_log(), initiatives_from_github() (+20 more)
...
Cohesion: 0.05
Nodes (66): _enrich_runtimes(), get_decision_log(), get_policy(), get_runtime(), list_runtimes(), _load_rich_policy(), PolicyUpdateBody, Request (+58 more)

### Community 28 - "Community 28"
Cohesion: 0.07
Nodes (30): _get_workspace_lock(), get_workspace_manager(), _hash_component(), _iso_now(), _iso_offset_hours(), _load_workspace(), _parse_iso(), Path (+22 more)
...
Cohesion: 0.05
Nodes (38): When coder == reviewer model, swarm should log a warning., Contract: WorkflowEngine cannot skip the gate state machine., Contract: Cannot approve a run in 'pending' state., tests/test_workflow_models.py — Unit tests for workflow/models.py., TestApprovalGate, TestCheckRun, TestSlice, TestWorkflowBuildRequest (+30 more)
...
Cohesion: 0.07
Nodes (135): auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint(), _DoctorCheck, _DoctorReport, generate_onboarding_questions(), get_company() (+127 more)
...
Cohesion: 0.10
Nodes (41): A single occurrence of a check firing on a specific URL., Snapshot of one crawled page with the on-page facts the checks used., Aggregated report row - Screaming Frog CSV compatible., Site-level facts discovered during the crawl., An agent-delegable remediation work package derived from the findings.      Find, SeoDelegationTask, SeoIssueInstance, SeoIssueReportRow (+33 more)
...
Cohesion: 0.11
Nodes (20): clear_cooldowns(), is_provider_on_cooldown(), mark_provider_failed(), provider_router.py — auto-generated module docstring (user-research skill scan)., # NOTE: 429 is handled specially in _try_one_provider (immediate failover +, Put provider_id on cooldown for *cooldown_seconds* (default: PROVIDER_COOLDOWN_S, Return True if provider_id is currently on cooldown., Clear all cooldown entries (useful for testing).      Delegates to shared_state. (+12 more)

### Community 57 - "Community 57"
Cohesion: 0.09
Nodes (30): _extract_slices_from_plan(), Any, CheckRun, Connection, Path, Slice, WorkflowRun, Return the AgentSwarm singleton if available, else None. (+22 more)
...
Cohesion: 0.08
Nodes (47): SliceRunRequest, approve(), build(), cancel(), _engine(), get_agent_team(), get_artifact_content(), get_events() (+39 more)
...
Cohesion: 0.04
Nodes (64): get_skill(), list_skills(), List all available skills with optional filtering.      Returns the skill catalo, Get a single skill by its ID., Recommend skills based on provided context., recommend_skills(), build_matrix(), _families() (+56 more)

### Community 73 - "Community 73"
Cohesion: 0.09
Nodes (41): Set the global agent store instance (e.g., with MongoDB on startup)., set_agent_store(), Task, TaskStore, TaskWorkflowService, Creates tasks from scheduler and playbook runs using one workflow., TaskAutomationService, TaskCreateRequest (+33 more)

### Community 74 - "Community 74"
Cohesion: 0.15
Nodes (19): _check_rate_limit(), default_keys_path(), issue_new_api_key(), load_key_store(), Path, RateLimitError, Persistent API key store: each key maps to email + department (seat) and a stabl, Generate a new plaintext API key, persist hash + metadata, return (plain_key, re (+11 more)
...
Cohesion: 0.11
Nodes (8): A user story with story points and status., UserStory, Tests for committed-scope snapshot and scope_added., Tests for UserStory dataclass., Tests for AgileSprint., TestAgileSprint, TestScopeChange, TestUserStory
...
Cohesion: 0.12
Nodes (12): TaskExecutionCoordinator, TaskStore, Re-queue BLOCKED tasks that have cooled down and are ready for retry., Polls for queued task work and executes it through the coordinator.      Crash r, Re-queue tasks stranded by a prior crash or hard-kill., TaskDispatcher, Dispatcher should track first_seen times for pending tasks., Executing a task removes it from _first_seen and logs pickup time.          Uses (+4 more)

### Community 83 - "Community 83"
Cohesion: 0.02
Nodes (105): MongoDBStore, Company, KnowledgeItem, ObjectId, Repo, Specialist, Website, Delete a company and all its associated data. (+97 more)

### Community 84 - "Community 84"
Cohesion: 0.12
Nodes (43): ApprovalRequest, BackgroundTasks, ClarifyRequest, CommentAddRequest, FollowUpRequest, TaskCreateRequest, add_comment(), approve_checkpoint() (+35 more)
...
Cohesion: 0.15
Nodes (16): IssueCategory, Any, AsyncClient, Path, Fetches AI trend signals from many public sources and surfaces relevant ones., Fetch all sources in parallel; return new alerts sorted by relevance., Automatically dispatch high-relevance alerts to Hermes Agent for action., TrendAlert (+8 more)
...
Cohesion: 0.08
Nodes (19): AgentSwarm, TestDualModelInvariant, TestSwarmPermissions, ArtifactStore, _now(), Any, Artifact, Connection (+11 more)
...
Cohesion: 0.18
Nodes (7): Task, Re-run a task. Permissive across every non-active state so the dashboard, Add a follow-up instruction to a task and re-queue it for execution.          Un, Executes tasks through the runtime layer using agent definitions., Owns lifecycle transitions, comment semantics, and approval rules., TaskExecutionCoordinator, TaskWorkflowService

### Community 96 - "Community 96"
Cohesion: 0.04
Nodes (33): ChatHistoryStore, PostProcessHook, get_chat_history(), Return the module-level ChatHistoryStore singleton., get_context_window_manager(), How to truncate messages when over the context limit., Return the module-level ContextWindowManager singleton., Result of a context window truncation operation. (+25 more)
...
Cohesion: 0.03
Nodes (118): AgentDirective, AgentRole, Close exhausted quick-note issues; dispatch Dev directives for open ones., Call the configured provider stack to perform CEO strategic assessment., ContextPruner, context_pruner.py — auto-generated module docstring (user-research skill scan)., Reset the prune timer so the next call always runs the pipeline., 3-phase context window management middleware.      Phase 1 — Truncate: Strips `` (+110 more)

### Community 99 - "Community 99"
Cohesion: 0.05
Nodes (15): Tests for agents/portfolio.py — Agentic Portfolio Management.  Uses importlib to, WSJF ranking is the heart of portfolio management., Greedy capacity allocation by WSJF., Now/Next/Later roadmap placement., Progress roll-up from linked agile sprints., Aggregate portfolio metrics., Tests for the Initiative dataclass and WSJF maths., CRUD behaviour for PortfolioManager. (+7 more)

### Community 100 - "Community 100"
Cohesion: 0.07
Nodes (10): Only expired workspaces (past retention TTL) are cleaned up., Two threads creating the same session/job should not corrupt state., TestWorkspaceLifecycle, TestWorkspaceResume, TestSymlinkAttackPrevention, First-class workspace isolation manager.      Every session/job gets its own val, Check access to a remote Git repository by querying its refs using `git ls-remot, Check whether the specified ref (branch or tag name) exists in the remote Git re (+2 more)
...
Cohesion: 0.17
Nodes (5): Any, Path, Full-text search across name, description, and content., Register an MCP-hosted skill pack entry., Skill
...
Cohesion: 0.05
Nodes (16): _normalize_anthropic_output_format(), Translate Anthropic ``output_format`` into an Ollama ``format`` field.      Modi, Daily automation tests — 2026-05-15  Covers three features implemented in this r, Integration tests for POST /v1/messages/count_tokens., Unit tests for extended thinking detection in handle_anthropic_messages., When thinking.type == enabled, routing should use agent_plan endpoint type., No thinking param → normal chat routing, not forced to reasoning., thinking_budget_tokens should appear in routing_meta when thinking is set. (+8 more)
...
Cohesion: 0.12
Nodes (18): agents/__init__.py — CRISPY multi-agent coding system., AgentProfile, _get_defaults(), load_all_profiles(), make_architect_profile(), make_coder_profile(), make_reviewer_profile(), make_scout_profile() (+10 more)

### Community 115 - "Community 115"
Cohesion: 0.11
Nodes (10): OrchestratorSupervisor, Any, Emit an alert to the activity feed and log., Deterministic supervisor for the orchestrator.      Runs as a background corouti, stop_orchestrator_supervisor(), SupervisorState, tests/test_orchestrator_supervisor.py — Tests for deterministic supervisor (#522, Supervisor startup, stall detection, and alert emission. (+2 more)

### Community 116 - "Community 116"
Cohesion: 0.09
Nodes (24): AgencyCycleResult, _build_ceo_prompt(), _build_quick_note_instruction(), _close_github_issue(), _collect_recent_git_context(), _fetch_github_quick_notes(), get_agency(), _gh_repo() (+16 more)
...
Cohesion: 0.11
Nodes (12): Task, TaskPriority, TaskStatus, List tasks for a specific user with optional filters.          ``include_system`, Admin-only: list all tasks across all users., Return tasks queued for agent execution., Return BLOCKED tasks that are candidates for auto-retry., Return task counts keyed by ``agent_id`` for the requested statuses. (+4 more)
...
Cohesion: 0.10
Nodes (18): BackgroundServices, Path, services/background.py — shared background-service startup.  Both the FastAPI we, Fire-and-forget self-bootstrap; never blocks or crashes startup., Handle returned by ``start_background_services`` — call ``stop()`` on shutdown., Start RuntimeManager, TaskDispatcher, SCHEDULER, and self-bootstrap.      Return, _schedule_self_bootstrap(), start_background_services() (+10 more)

### Community 125 - "Community 125"
Cohesion: 0.04
Nodes (83): CEODispatcher, CEOResult, _complexity_rank(), _decompose_into_subtasks(), get_ceo_dispatcher(), _merge_changed_files(), Any, services/ceo_dispatcher.py — Real CEO delegation layer.  The CEO splits a comple (+75 more)
...
Cohesion: 0.16
Nodes (24): Paragraph, compute_pressure(), loss_share_from_pressure(), Map aggregate issue pressure to an at-risk revenue share via the     diminishing, Return (per-row issue pressure, total pressure) for the revenue model.      pres, _appendix_full_findings(), _appendix_worst_pages(), _appendix_wsjf_roadmap() (+16 more)
...
Cohesion: 0.12
Nodes (21): AgentRole, ArtifactStore, Path, WorkflowBuildRequest, PhaseRunner, Artifact, ArtifactStore, CheckRun (+13 more)
...
Cohesion: 0.10
Nodes (6): PortfolioManager, Tests for agents/agile_ceremonies.py — autonomous agile ceremonies.  Loads modul, TestGenerateBacklogRetro, TestGenerateStandup, TestPlanNextSprint, TestRetrospectiveToMarkdown
...
Cohesion: 0.07
Nodes (28): Called by APScheduler when a cron fires. Dispatches to the orchestrator., List recent workflow orchestrator runs.      Non-admin users see only their own, Get a single workflow orchestrator run by ID (owner or admin only)., Cancel a single orchestrator run (removes from memory).      Admin users can can, Bulk-cancel orchestrator runs by status or explicit run_id list.      Query para, _scheduler_on_fire(), workflow_orchestrator_cancel_run(), workflow_orchestrator_cancel_runs_bulk() (+20 more)
...
Cohesion: 0.07
Nodes (24): get_specialist_bound_skills(), Get the skills bound to a specific specialist., CompanyAgencyService, _is_runtime_available_sync(), _pick_available_runtime(), Any, SpecialistFamily, services/company_agency.py — Company Agency Orchestration Service  After onboard (+16 more)

### Community 157 - "Community 157"
Cohesion: 0.14
Nodes (18): AgentProfile, AgentSwarm, Any, Artifact, CheckRun, ModelRoutingConfig, Slice, Return the agent role responsible for *phase*. (+10 more)
...
Cohesion: 0.11
Nodes (16): BackgroundAgent, background_agent(), engine(), _now(), WorkflowEngine, Contract: BackgroundAgent._process() is not a no-op stub.     When an agent_runn, When no runner is injected, _process returns a fallback note (not error)., When runner is injected but payload has no instruction, returns error. (+8 more)
...
Cohesion: 0.06
Nodes (16): AgileSprint, An agile sprint containing user stories., Add a user story to the sprint., Remove a user story from the sprint., Complete the sprint and record velocity., Calculate current sprint metrics., Total story points in the sprint., Completed story points. (+8 more)

### Community 175 - "Community 175"
Cohesion: 0.08
Nodes (24): analyze_page(), _count_syllables(), estimate_pixel_width(), flesch_reading_ease(), _host_key(), is_internal(), normalize_url(), services/seo_audit.py - World-Class SEO / GEO / AIO Audit Engine  Screaming Frog (+16 more)
...
Cohesion: 0.10
Nodes (16): Any, agent/schedule_store.py — durable persistence for scheduled agent jobs.  Fixes #, Durable schedule persistence. Mongo-backed with in-memory fallback.      All met, Return all persisted schedule docs (for boot rehydration)., Persist (insert or update) a single schedule by job_id., Delete a persisted schedule., ScheduleStore, _FakePersistence (+8 more)

### Community 180 - "Community 180"
Cohesion: 0.14
Nodes (25): _build_anthropic_response(), _emit_safely(), _finish_reason_to_stop_reason(), get_local_model(), handle_anthropic_messages(), _messages_to_openai(), _openai_choice_to_anthropic_content(), _post_anthropic_with_fallback() (+17 more)
...
Cohesion: 0.05
Nodes (36): _deep_merge(), GuardResult, Deep merge two dicts. Override values take precedence., Result of a guardrail check., CircuitBreakerOpenError, CircuitState, get_nim_pool(), NIMConnectionPool (+28 more)
...
Cohesion: 0.10
Nodes (15): AutonomyCounter, AutonomySnapshot, Any, agent/kpi.py — Autonomy KPIs: evidence capture and metrics tracking.  Tracks k, Return a point-in-time snapshot of all KPIs., Reset all counters (test helper)., Reset the singleton (test helper)., Thread-safe counter for a single KPI metric. (+7 more)
...
Cohesion: 0.09
Nodes (5): agent/scheduler.py — Scheduled Agent Jobs  Cron-based job scheduler.  Each job, set_scheduler(), tests/test_control_plane_api.py — Tests for Control Plane API endpoints.  Covers, scheduler(), test_set_and_get_scheduler()

### Community 219 - "Community 219"
Cohesion: 0.10
Nodes (12): get_guardrails(), GuardrailEngine, Any, Configurable safety rail engine for LLM inputs and outputs.      Supports:     -, Check user input against input safety rules.          Returns a GuardResult with, Check model output against output safety rules.          Returns a GuardResult w, Unified check method. direction = 'input' or 'output'., Return guardrail statistics. (+4 more)
...
Cohesion: 0.07
Nodes (126): AdminAuthManager, AdminIdentity, admin_auth.py — auto-generated module docstring (user-research skill scan)., AdminIdentity, Agency, CEO-coordinated multi-agent agency for continuous codebase management.      Th, BackgroundAgent, BackgroundTask (+118 more)
...
Cohesion: 0.10
Nodes (26): TaskStatus, Task definition schema for the evaluation harness.  Inspired by OpenHarness' s, SuccessCriterionType, TaskDifficulty, WorkspaceStatus, Categories of AI engineering tools tracked., ToolKind, Current phase of a cowork session. (+18 more)
...
Cohesion: 0.13
Nodes (6): Security-oriented tests for workspace isolation (Area C4).  Covers:   - No path, TestPathTraversalPrevention, Validate and return a job ID, or raise InvalidJobIdError., Resolve *path* and verify it stays under *base_root*.      Blocks symlink escape, _safe_resolve(), validate_job_id()
...
Cohesion: 0.19
Nodes (6): KeyRecord, KeyStore, Look up a plaintext key by its SHA-256 hash.          When *client_ip* is provid, Record a failed key lookup for *ip*., Thread-safe JSON-backed key store., _record_failed()
...
Cohesion: 0.15
Nodes (14): provider_access_tier(), Tests that verify the exact provider priority ordering., When INCLUDE_LOCAL_FALLBACK=true and no cloud keys are set, local Ollama must be, ollama-local must NOT appear when NVIDIA_API_KEY is set and INCLUDE_LOCAL_FALLBA, ollama-local must NOT appear when NVIDIA_API_KEY is set and INCLUDE_LOCAL_FALLBA, local < windows_server < free_cloud < commercial., test_access_tier_anthropic(), test_access_tier_deepseek() (+6 more)
...
Cohesion: 0.14
Nodes (6): PR throughput per cohort over the last `days` days., Background agent that periodically syncs session state across contributors., SyncAgent, Tests for agents.cowork_session — Claude Cowork., TestSyncAgent, timedelta
...
Cohesion: 0.17
Nodes (10): Exception, _classify_error(), main(), Safely insert an entry under ## [Unreleased] without touching the rest of the fi, Classify an exception from the NVIDIA NIM API.      Returns one of: '429_rate_li, _read_claude_md(), _run_baseline_pytest(), tool_add_changelog_entry() (+2 more)
...
Cohesion: 0.31
Nodes (5): Any, Walk messages backward, accumulating per-role char counts.          Returns (kep, Wrap evicted messages into ``<historical_memory_only>`` XML.          The XML bl, Apply 3-phase pruning if the context is over budget or cache expired.          R, Strip ``<think>`` blocks and truncate oversized assistant/tool outputs.

### Community 362 - "Community 362"
Cohesion: 0.05
Nodes (44): AIToolMetrics, build_report(), EngagementMetrics, PerformanceAnalytics, datetime, AI-Assisted Engineering Insights — track AI tool usage, engagement, and performa, How many distinct tools each user has touched., Compare engineering performance with vs without AI tooling.      DX report findi (+36 more)
...
Cohesion: 0.13
Nodes (6): FeatureMaturity, Feature maturity classification., Load canonical features and apply per-feature then bulk env overrides., Apply a config override string like 'stable', 'beta', 'disabled', 'enabled', 'tr, TestClassification, TestMaturityWarnings
...
Cohesion: 0.06
Nodes (45): AgentEvent, AgentSession, AgentSessionMessage, A single entry in the session's append-only event log.      Inspired by Anthro, AgentSessionStore, _now(), AgentPlan, Connection (+37 more)
...
Cohesion: 0.18
Nodes (10): Tests for agent/scheduler.py — Scheduled Agent Jobs., test_as_dict(), test_create_job(), test_delete_job(), test_delete_nonexistent(), test_get_job(), test_list_jobs(), test_trigger_fires_callback() (+2 more)
...
Cohesion: 0.17
Nodes (11): get_harness_adapter(), harness_catalog(), #522 + #505: Reliability startup — schedule hydration, orchestrator restore, que, Return the full ECC harness catalog with capabilities.      Public — no auth req, Return orchestrator queue depth, active runs, and supervisor state (#522)., _startup_reliability_hooks(), workflow_orchestrator_status(), get_orchestrator_supervisor() (+3 more)
...
Cohesion: 0.07
Nodes (20): ApprovalCheckpoint, _coerce_ts(), ExecutionLogEntry, Any, Full task/issue document., Update the updated_at timestamp., Coerce ISO-8601 datetime strings (from DB) to float timestamps., Single entry in a task's execution log. (+12 more)
...
Cohesion: 0.31
Nodes (9): Exception, _call_review_llm(), _classify_error(), get_pr_diff(), get_pr_files(), load_council_skill(), main(), Call the best available LLM for review. NVIDIA NIM is the primary engine;     Op (+1 more)
...
Cohesion: 0.06
Nodes (35): ClassifyOutput, emit_deprecation(), ExecutionResult, JudgeVerdict, Phase, PreflightReport, Log a deprecation warning when a parallel path is used., The 11 canonical phases of the Agency Core golden path. (+27 more)
...
Cohesion: 0.70
Nodes (4): ModuleType, _load(), main(), _write_summary()
...
## Knowledge Gaps
- **2755 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `Exception`, `Exception`, `Any` (+2750 more)
...
- **Why does `AgentRunner` connect `Community 98` to `Community 2`, `Community 3`, `Community 132`, `Community 5`, `Community 266`, `Community 10`, `Community 16`, `Community 19`, `Community 665`, `Community 26`, `Community 164`, `Community 425`, `Community 176`, `Community 58`, `Community 330`, `Community 338`, `Community 618`, `Community 235`, `Community 127`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Why does `AgentSessionStore` connect `Community 425` to `Community 2`, `Community 98`, `Community 3`, `Community 8`, `Community 10`, `Community 235`, `Community 618`, `Community 555`, `Community 16`, `Community 19`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `AgentScheduler` connect `Community 2` to `Community 3`, `Community 69`, `Community 102`, `Community 73`, `Community 235`, `Community 748`, `Community 430`, `Community 179`, `Community 218`, `Community 124`, `Community 253`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
