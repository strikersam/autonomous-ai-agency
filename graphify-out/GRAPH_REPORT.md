# Graph Report - haiku45  (2026-08-21)

## Corpus Check
- 1442 files · ~2,074,658 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 28700 nodes · 53625 edges · 1212 communities (1102 shown, 110 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 2637 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `00405ace`
...
## Communities (1212 total, 110 thin omitted)

### Community 0 - "backend/server.py"
Cohesion: 0.02
Nodes (192): backend/ceo_router.py — observability and manual control for the CEO. Surfaces…, Reject non-admin callers for routes that spend provider budget. Delegates to…, _require_admin(), _is_admin(), Check if a user has admin role. Works for both social_auth users (role in…, admin_seed(), AgentStatusEntry, AgentStatusResponse (+184 more)

### Community 1 - "llm/router.py"
Cohesion: 0.02
Nodes (112): Attempt, text_key(), failover_chat_completion_via_router(), openai_body_from_response(), Any, packages/llm/compat.py — backwards-compatible bridges to the legacy call paths.…, Router-backed implementation of ``packages.ai.failover_client``'s entry point.…, Whether the compat bridges should delegate to ``LLMRouter``. Reads the flag on… (+104 more)

### Community 2 - "MongoDBStore"
Cohesion: 0.02
Nodes (95): MongoDBStore, Any, Company, ObjectId, Prepare a Pydantic model for SQLite storage., Prepare a SQLite row for Pydantic model., Create a new company in SQLite., Get a company by ID from SQLite. (+87 more)
...
### Community 4 - "ImprovementLoop"
Cohesion: 0.03
Nodes (104): Agency, AgencyCycleResult, AgentDirective, AgentRole, _build_ceo_prompt(), _build_quick_note_instruction(), _close_github_issue(), _collect_recent_git_context() (+96 more)

### Community 5 - "company_api.py"
Cohesion: 0.03
Nodes (122): provision_specialist(), Company Graph API Router Provides all endpoints for managing companies, their…, Provision a new specialist for a company. Creates and provisions a specialist…, # NOTE: store.list_companies returns a plain List[Company] (no grand-total),, # NOTE: `request` MUST be annotated as `Request`. Without the annotation FastAPI, Synchronize the Company Graph. Re-scans all websites and repositories, updates…, sync_company_graph(), ApprovalPolicy (+114 more)

### Community 6 - "TaskSpec"
Cohesion: 0.04
Nodes (86): kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, AiderAdapter, Any, TaskResult, TaskSpec, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Run aider non-interactively via `--message` flag. (+78 more)

### Community 7 - "TaskWorkflowService"
Cohesion: 0.03
Nodes (92): AgentDefinition, AgentStore, Any, field_validator, CRUD store for AgentDefinition objects. Uses MongoDB when a `db` client is…, Return an agent by ID. If *owner_id* is provided, enforces that the agent…, Delete an agent. Returns True on success, False if not found/unauthorised., Return all agents owned by *owner_id*, optionally including public agents. (+84 more)

### Community 8 - "TaskStore"
Cohesion: 0.03
Nodes (113): Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., tasks — Task/issue management system. Provides a lightweight task/issue tracker…, ApprovalCheckpoint, ApprovalRequest, ClarifyRequest, ExecutionLogEntry, FollowUpRequest (+105 more)

### Community 9 - "test_llm_router_queue_cache.py"
Cohesion: 0.02
Nodes (108): int, payload_key(), Exact-match cache key over the fields that change the answer. Routing…, build_summariser(), chunk_document(), ContextManager, estimate_tokens(), FitResult (+100 more)

### Community 10 - "get_company_graph_store"
Cohesion: 0.03
Nodes (131): account_lifecycle(), AccountLifecycleResponse, auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint(), _DoctorCheck, _DoctorReport (+123 more)
...
### Community 13 - "test_operational_incidents.py"
Cohesion: 0.03
Nodes (112): _diagnose_and_file(), _format_incident(), gather_render_evidence(), _iso_from_monotonic(), normalise(), note_phase_end(), note_phase_start(), _now() (+104 more)
...
Cohesion: 0.03
Nodes (65): MergeDecision, _NoopStore, Any, Exception, Approve a run paused at the ApprovalGate. The caller must re-invoke…, Inject additional instructions into an in-flight run (no state change). Backs…, Push a Telegram approval-gate notification when a run pauses (Charter G1).…, G5: resolve how a run should land from the company's DeliveryPolicy. Returns… (+57 more)

### Community 16 - "get_runtime_manager"
Cohesion: 0.03
Nodes (93): _enrich_runtimes(), get_decision_log(), get_policy(), get_runtime(), list_runtimes(), _load_rich_policy(), PolicyUpdateBody, Any (+85 more)
...
### Community 20 - "test_autonomous_agency_e2e.py"
Cohesion: 0.03
Nodes (59): BackgroundAgent, BackgroundTask, _now(), Any, agent/background.py — Background Agent An always-on worker thread that…, Enqueue *task* for processing. Returns the task (with task_id set)., Convenience: create a task and submit it in one call., Real handler — dispatches through AgentRunner when available. HARDENED (PR… (+51 more)

### Community 21 - "Task"
Cohesion: 0.04
Nodes (71): _coerce_ts(), Any, field_validator, Full task/issue document., Update the updated_at timestamp., Coerce ISO-8601 datetime strings (from DB) to float timestamps., Dict-compatible accessor. Log entries are serialized to/from dicts in many…, Task (+63 more)
...
Cohesion: 0.04
Nodes (58): compute_savings(), compute_time_series(), get_savings(), get_usage(), get_user_savings(), _period_start(), Any, BaseModel (+50 more)

### Community 24 - "PolicyEngine"
Cohesion: 0.04
...
### Community 25 - "AgentRunner"
Cohesion: 0.04
Nodes (56): AgentRunner, Any, Path, Governance seam: judge the call, run it, audit the outcome. Deliberately a thin…, Append an event to the durable session log if a store is wired in., Summarise a long history and compact it. Asks the planner model to write a…, Send chat messages and return the assistant's text output. If an…, Call-time resolver for an agent role model id. Delegates to… (+48 more)

### Community 26 - "test_llm_router_resilience.py"
Cohesion: 0.03
Nodes (73): Backoff policy for retryable failures., RetryConfig, BreakerState, Enum, str, _digest(), get_ring(), KeyRing (+65 more)

### Community 27 - "get_db"
Cohesion: 0.03
Nodes (96): auth_me(), auto_recommend_skills(), _delete_limited_chat_session(), delete_session(), delete_source(), discover_remote_skills(), _get_activity_impl(), _get_backend_sam() (+88 more)
...
### Community 29 - "CompanyGraphService"
Cohesion: 0.03
...
### Community 30 - "Specialist"
Cohesion: 0.03
Nodes (59): SpecialistFamily, Find all specialists of a specific family., Find specialists that can handle a task with given capabilities., A specialist agent that can be provisioned for company-specific tasks., Check if this specialist can handle a task with given capabilities., Specialist, build_matrix(), _families() (+51 more)

### Community 31 - "gateway.py"
Cohesion: 0.03
Nodes (61): Catalog entries for router-configured providers missing from the YAML. Never…, get_budget(), The process-wide budget tracker., CacheManager, cosine_similarity(), _Entry, get_cache(), LRUCache (+53 more)
...
Cohesion: 0.02
Nodes (88): app_client(), _clear_discovered_models(), _clear_response_cache(), client(), _isolate_brain_data_layer(), _isolate_operator_provider_state(), non_admin_client(), MonkeyPatch (+80 more)

### Community 34 - "E2BSandboxSession"
Cohesion: 0.05
...
### Community 36 - "AgentSessionStore"
Cohesion: 0.05
...
### Community 38 - "resolve_active_brain"
Cohesion: 0.03
Nodes (81): BrainResolution, get_brain_config(), get_brain_config_store(), Return the process-wide ``BrainConfigStore`` singleton., Convenience wrapper used by the agent loop + brain resolver., get_brain_preference(), get_provider_role_tags(), _host_is_openai_compatible() (+73 more)

### Community 39 - "WorkflowEngine"
Cohesion: 0.05
Nodes (71): _make_engine(), tests/test_crispy_workflow.py — CRISPY workflow engine hardening tests. Tests…, Create a WorkflowEngine with isolated storage., TestAbortOnFailure, TestPhaseSequence, TestPhaseSequenceError, TestWorkspaceIsolation, approve() (+63 more)

### Community 40 - "CompanyGraphStore"
Cohesion: 0.03
Nodes (49): Company, The core company entity - root of the Company Graph., requires_db, CompanyGraphStore, Delete a company and all its associated data., List companies with optional filtering., Count total companies in the store., Create a new company graph. (+41 more)

### Community 41 - "BrainConfig"
Cohesion: 0.04
Nodes (73): BrainConfig, BrainConfigPatch, BrainConfigStore, default_brain_config(), BaseModel, Persist *cfg* to Mongo (primary) and sqlite (mirror). Either backend failing is…, Build a ``BrainConfig`` from a Mongo doc, dropping Mongo's ``_id``., Convenience wrapper used by the admin API endpoints. (+65 more)

### Community 42 - "WebsiteScanner"
Cohesion: 0.04
...
### Community 43 - "ProviderConfig"
Cohesion: 0.04
Nodes (75): extract_openai_text(), _normalize_nvidia_base_url(), _openai_url(), provider_access_tier(), ProviderConfig, Normalize NVIDIA base URLs to avoid double /v1 when openai_compat_url appends…, Infer an access tier from *hostname*, longest matching suffix winning. Returns…, _tier_from_hostname() (+67 more)
...
### Community 47 - "test_runtime_governance.py"
Cohesion: 0.05
Nodes (61): Return the last-known health for *runtime_id* (may be stale)., Return True if the runtime is available (not circuit-open)., Return health snapshots for all known runtimes., Force an immediate health check of all runtimes and return results., Attempt to start a dead runtime subprocess before re-probing. Uses the local…, Async health polling service for all registered runtimes., Start the background polling loop with an immediate initial check., RuntimeHealthService (+53 more)

### Community 48 - "CEODispatcher"
Cohesion: 0.04
Nodes (65): CEODispatcher, CEOResult, _complexity_rank(), _decompose_into_subtasks(), _merge_changed_files(), _offload(), Any, Semaphore (+57 more)
...
### Community 51 - "AgentJobManager"
Cohesion: 0.05
Nodes (42): AgentJob, AgentJobManager, make_isolated_workspace(), _now(), Any, Path, agent/job_manager.py — Async agent job lifecycle manager. Manages agent jobs…, Run a job using the provided runner and update the job's lifecycle, progress,… (+34 more)

### Community 52 - "settings.py"
Cohesion: 0.04
...
### Community 53 - "test_unit8_model_catalog.py"
Cohesion: 0.04
Nodes (62): all_provider_ids(), Return every provider id recognised by the brain config system. Iterates the…, CatalogActiveBrain, CatalogMirror, CatalogProviderEntry, _include_router_providers(), invalidate_catalog_cache(), ModelCatalogStore (+54 more)

### Community 54 - "TestAdapterMetadata"
Cohesion: 0.04
...
### Community 58 - "test_governance_enforcement.py"
Cohesion: 0.05
Nodes (65): BudgetTracker, GovernanceGate, Holds live session budgets, bounded so it cannot leak. Sessions end without…, The one seam through which governed actions pass., AgentIdentity, _coerce_text(), new_session_id(), Any (+57 more)

### Community 59 - "test_ceo_dispatcher.py"
Cohesion: 0.05
Nodes (67): get_ceo_fallback_stats(), PlanOutput, PLAN phase: structured execution plan., SELECT_SPECIALIST phase: which specialist(s) handle this work., Increment the named counter (silently ignores unknown reasons)., Return a snapshot of the CEO fallback counters., Zero all CEO fallback counters (useful for testing)., _record_ceo_fallback() (+59 more)

### Community 60 - "get_task_store"
Cohesion: 0.05
Nodes (69): quick_notes_submit(), _QuickNoteBody, Submit a quick-note URL or instruction from the dashboard FAB., apply_from_db(), Load the stored overrides and apply them. Called once at startup., Reset the singleton (for tests)., reset_failover_manager(), _blocked_retire_age_sec() (+61 more)
...
### Community 64 - "test_mcp_registry.py"
Cohesion: 0.05
...
### Community 75 - "test_ceo_router.py"
Cohesion: 0.05
Nodes (47): Attempt, _backend(), CEOLedger, GoalRecord, _now(), Any, services/ceo_ledger.py — durable record of what the CEO is driving to closure.…, One delegation of one subtask to one tier. (+39 more)
...
### Community 77 - "TestClient"
Cohesion: 0.10
Nodes (29): bare_repo(), _call(), _data(), git_config_env(), _is_error(), mcp_workspace_root(), Path, skipif (+21 more)

### Community 78 - "test_sam_livekit.py"
Cohesion: 0.05
Nodes (54): _normalize_dockerfile(), parametrize, tests/test_sam_livekit.py — SAM realtime voice (LiveKit) integration. Covers: -…, Empty key/secret/identity/room must raise ValueError., SAM_LLM_* env vars must override the NVIDIA defaults (Hermes/proxy routing)., Under TESTING the in-process worker must never be eligible to start., OPT-IN: defaulting to on OOM-killed the 512MB Render instance at boot…, start_in_process must be a safe no-op in the test environment (conftest sets… (+46 more)
...
### Community 84 - "CEOSupervisor"
Cohesion: 0.05
Nodes (46): build_ceo_router(), Any, APIRouter, get_ceo_dispatcher(), Return the shared CEODispatcher singleton., Reset the singleton (test helper)., reset_ceo_dispatcher(), get_ceo_ledger() (+38 more)

### Community 85 - "RenderMCPClient"
Cohesion: 0.05
...
### Community 87 - "test_startup_warmup.py"
Cohesion: 0.04
...
### Community 91 - "test_sam_voice.py"
Cohesion: 0.04
...
### Community 98 - "resolve_e2b_config"
Cohesion: 0.06
...
### Community 99 - "InternalAgentAdapter"
Cohesion: 0.04
Nodes (45): _best_cloud_primary_base(), InternalAgentAdapter, TaskResult, TaskSpec, Built-in agent loop — Nvidia NIM primary, Ollama fallback., Return runtime dependencies required by this adapter. Returns:…, Determine availability of the internal agent runtime. Checks cloud providers in…, Execute a TaskSpec using the internal AgentRunner and convert the agent's… (+37 more)

### Community 100 - "test_knowledge_sync.py"
Cohesion: 0.08
...
### Community 101 - "test_agent_runner.py"
Cohesion: 0.05
Nodes (58): AgentPhaseError, Exception, Raised when a named agent phase (planning, verification, etc.) fails., _make_runner(), MonkeyPatch, Path, The agent LLM call must use the BrainConfig budget, not a hardcoded 16384.…, Regression: a planning timeout must not surface as an empty "planning: ".… (+50 more)
...
### Community 107 - "App.js"
Cohesion: 0.05
Nodes (33): getAccountLifecycle(), getDefaultBackendUrl(), getMe(), getSetupState(), login(), logout(), App(), AppRoutes() (+25 more)

### Community 108 - "brain_config.py"
Cohesion: 0.04
Nodes (47): provider_api_key(), provider_base_url(), _provider_env_value(), _provider_ids_from_literal(), provider_key_present(), provider_key_rotation_enabled(), services/brain_config_store.py — DB-persisted, UI-switchable "brain" config.…, Async variant — refreshes the cache if stale before resolving. Used by code… (+39 more)
...
### Community 124 - "RepowiseIntelligence"
Cohesion: 0.06
...
Cohesion: 0.14
Nodes (53): ApprovalRequest, BackgroundTasks, add_comment(), approve_checkpoint(), approve_execution(), clarify_task(), create_task(), _current_user() (+45 more)

### Community 126 - "FeatureMaturity"
Cohesion: 0.06
...
Cohesion: 0.06
Nodes (49): build_governance_router(), Any, APIRouter, backend/governance_router.py — read and operate the governance layer. Mounted…, Reject non-admin callers. Mirrors the RBAC check used elsewhere in this backend…, _require_admin(), get_approval_store(), Replace the process-wide gate. Tests only. (+41 more)
...
### Community 137 - "RuntimeCapabilityRegistry"
Cohesion: 0.07
...
### Community 138 - "_resolve_brain_provider"
Cohesion: 0.06
...
### Community 139 - "TestHarnessAdapter"
Cohesion: 0.05
...
### Community 140 - "failover_client.py"
Cohesion: 0.06
...
### Community 146 - "ProvidersScreen.jsx"
Cohesion: 0.06
...
### Community 148 - "test_e2b_adapter.py"
Cohesion: 0.07
...
### Community 151 - "workflow_orchestrator.py"
Cohesion: 0.09
...
### Community 153 - "PatternConsolidation"
Cohesion: 0.08
...
### Community 156 - "OnboardingScreen.jsx"
Cohesion: 0.05
...
### Community 157 - "test_slop_gate.py"
Cohesion: 0.07
...
### Community 165 - "[Unreleased]"
Cohesion: 0.04
Nodes (46): [5.0.0], Added, Added, Added, Added, Added, Added, Added (+38 more)

### Community 166 - "test_seo_audit.py"
Cohesion: 0.06
...
### Community 168 - "BrainWatchdog"
Cohesion: 0.06
Nodes (28): BrainWatchdog, _classify_failure_cause(), Any, services/brain_watchdog.py — Brain health watchdog. Monitors the active brain…, Reset failure counter for a provider after a successful call., Persist the new provider in the brain config store (fire-and-forget). Uses the…, Send a Telegram notification about the failover., Reset the singleton (test helper). (+20 more)

### Community 169 - "ModelConfig"
Cohesion: 0.06
...
### Community 173 - "test_telegram_freebuff.py"
Cohesion: 0.07
...
### Community 174 - "_get_provider_policy"
Cohesion: 0.07
...
### Community 179 - "PromptCacheManager"
Cohesion: 0.06
...
Cohesion: 0.04
Nodes (25): Test iteration 6 features: - POST /api/tasks/ auto-assigns an available agent…, POST /api/tasks/ without agent_id should attempt auto-assignment if agents exist, Test runtime start/stop endpoints return informational payloads in remote…, Get authentication token for admin user, GET /runtimes/ should return list of runtimes, POST /runtimes/{id}/start should return non-blocking informational payload in…, POST /runtimes/stop-all should return non-blocking informational payload, PUT /runtimes/policy should work with valid auth (+17 more)

### Community 185 - "facade.py"
Cohesion: 0.07
Nodes (39): _get_current_user_thunk(), _get_optional_user_thunk(), Request, create_refresh_token(), get_current_user(), get_optional_user(), google_callback(), Get user if authenticated, otherwise return None (for public endpoints). (+31 more)

### Community 186 - "test_mcp_governance.py"
Cohesion: 0.08
Nodes (42): get_audit_log(), Return the process-wide audit log, created on first use., Replace the process-wide audit log. Tests only., reset_audit_log(), Replace the process-wide engine. Tests only., reset_policy_engine(), isolated_governance(), Give every test its own engine, audit log, and approval store. (+34 more)
...
### Community 191 - "Artifact"
Cohesion: 0.08
Nodes (23): AgentRole, _fake_artifact(), TestSlice, Artifact, Any, A durable, phase-produced document (markdown or JSON)., An independently deliverable unit of work within the execute phase. Each slice…, Return the first artifact matching *name*, or None. (+15 more)
...
### Community 194 - "emit_chat_observation"
Cohesion: 0.09
...
### Community 195 - "Part A — CodeRabbit review fixes for this PR (do first, small)"
Cohesion: 0.05
...
### Community 196 - "Docker Agent Runtimes Setup"
Cohesion: 0.05
...
### Community 198 - "anthropic_compat.py"
Cohesion: 0.09
...
### Community 199 - "test_platform_controls.py"
Cohesion: 0.07
...
### Community 201 - "NotificationDispatcher"
Cohesion: 0.07
...
### Community 202 - "TestBrainFailoverModelUpdates"
Cohesion: 0.08
...
### Community 204 - "control_overrides.py"
Cohesion: 0.07
...
### Community 205 - "get_failover_manager"
Cohesion: 0.06
...
### Community 210 - "chat_handlers.py"
Cohesion: 0.10
...
### Community 217 - "test_agent_tool_governance.py"
Cohesion: 0.09
Nodes (40): _drive(), _enforce(), governance_on(), _observations(), Any, MonkeyPatch, Path, The executor loop must not have a side door around the governance gate.… (+32 more)

### Community 218 - "test_e2b_data_flow.py"
Cohesion: 0.07
...
### Community 220 - "PortfolioManager"
Cohesion: 0.07
...
### Community 224 - "TestRecordUsageAndStats"
Cohesion: 0.05
...
### Community 225 - "TestAuthAndTaskOwnership"
Cohesion: 0.05
...
### Community 228 - "portfolio_intelligence.py"
Cohesion: 0.10
...
### Community 230 - "call_llm"
Cohesion: 0.07
Nodes (38): _agent_timeout_fallback_response(), _build_direct_chat_schedule_suggestion(), _build_direct_chat_tags(), _build_direct_chat_task_suggestion(), _build_provider_router(), call_llm(), _chat_error_detail_text(), _chat_provider_policy() (+30 more)

### Community 231 - "clear_cooldowns"
Cohesion: 0.08
Nodes (30): clear_cooldowns(), is_provider_on_cooldown(), mark_provider_failed(), Put provider_id on cooldown for *cooldown_seconds* (default:…, Return True if provider_id is currently on cooldown., Clear all cooldown entries (useful for testing). Delegates to…, clear_all_locks(), Clear all probe-lock entries (for test teardown). Companion to… (+22 more)

### Community 232 - "TaskDispatcher"
Cohesion: 0.08
...
### Community 238 - "NIMConnectionPool"
Cohesion: 0.08
...
### Community 240 - "FreeBuffAgent"
Cohesion: 0.10
Nodes (29): free_nvidia_models(), FreeBuffAgent, _nvidia_api_key(), Return the curated list of free NVIDIA NIM models FreeBuff may use., Codebuff-style coding agent pinned to free NVIDIA NIM models. FreeBuff is a…, List the free NVIDIA NIM models a user may pick (e.g. via Telegram)., True when *model* is in the curated free NVIDIA NIM set., Coerce *requested* to a free NVIDIA model. Returns *requested* when it is… (+21 more)

### Community 241 - "generate_context.py"
Cohesion: 0.08
...
### Community 242 - "seo_report_pdf.py"
Cohesion: 0.13
...
### Community 246 - "test_llm_router_disabled.py"
Cohesion: 0.10
...
### Community 249 - "WorkflowBuildRequest"
Cohesion: 0.08
...
### Community 255 - "test_agent_free_brain.py"
Cohesion: 0.06
...
### Community 256 - "output_filter.py"
Cohesion: 0.07
...
### Community 260 - "test_all_providers_discovery.py"
Cohesion: 0.16
...
### Community 265 - "test_anthropic_router.py"
Cohesion: 0.09
...
### Community 266 - "test_llm_router_e2e.py"
Cohesion: 0.14
...
### Community 273 - "test_bedrock_provider.py"
Cohesion: 0.12
...
### Community 274 - "test_render_mcp.py"
Cohesion: 0.10
...
### Community 283 - "RateLimitTracker"
Cohesion: 0.10
...
### Community 284 - "control_registry.py"
Cohesion: 0.10
...
### Community 290 - "Security Analysis — local-llm-server"
Cohesion: 0.06
...
### Community 291 - "Langfuse Observability Guide"
Cohesion: 0.06
...
### Community 294 - "AnthropicProvider"
Cohesion: 0.13
...
### Community 298 - "test_workspace_isolation.py"
Cohesion: 0.16
...
### Community 299 - "get_skill_registry_safe"
Cohesion: 0.11
Nodes (27): get_skill_registry_safe(), Return the global SkillRegistry if set, else None. Used by onboarding and other…, _DoctorCheck, _DoctorReport, get_doctor_diagnostics(), get_doctor_report(), get_public_doctor(), Public Doctor endpoint — no authentication required. Returns system-level… (+19 more)
...
### Community 303 - "LlmProviderConfig"
Cohesion: 0.16
...
### Community 304 - "TestNormalizeResponseFormat"
Cohesion: 0.08
...
### Community 307 - "test_brain_resolver.py"
Cohesion: 0.11
Nodes (30): get_active_brain_sync(), invalidate_brain_cache(), Clear the cached brain so the next read re-resolves. Called from…, Return the cached brain read by sync callers. None if never resolved., When BrainConfig.updated_at is empty (never applied), the resolver falls…, test_resolve_active_brain_falls_through_when_db_unset(), tests/test_brain_resolver.py — Tests for the single brain resolver. The agency…, When a free provider (NVIDIA NIM) is configured, the brain must NOT auto-pick… (+22 more)
...
### Community 309 - "session_retro.py"
Cohesion: 0.13
...
### Community 310 - "test_portfolio_intelligence.py"
Cohesion: 0.07
...
### Community 312 - "test_autonomy_gate.py"
Cohesion: 0.12
...
### Community 315 - "Configuration Reference"
Cohesion: 0.07
...
### Community 317 - "test_colibri_provider.py"
Cohesion: 0.12
...
### Community 320 - "_execute_skill_impl"
Cohesion: 0.09
...
### Community 322 - "test_brain_availability_doctor.py"
Cohesion: 0.13
...
### Community 325 - "test_rag_context.py"
Cohesion: 0.12
...
### Community 326 - "ProjectScaffolder"
Cohesion: 0.13
...
### Community 330 - "SteeringInjector"
Cohesion: 0.11
...
### Community 332 - "test_scheduler_hydration_bounded.py"
Cohesion: 0.09
...
### Community 333 - "test_internal_agent_did_work.py"
Cohesion: 0.12
...
Cohesion: 0.11
Nodes (22): _cached(), cost_attribution_stats(), _fast_count(), get_activity(), get_stats(), legacy_scheduler_list(), _produce_stats(), Single-flight TTL cache. Concurrent callers wait for the first producer. (+14 more)
...
### Community 353 - "test_chat_mode_regressions.py"
Cohesion: 0.13
...
### Community 357 - "validate_outbound_url"
Cohesion: 0.14
...
### Community 365 - "brain_failover.py"
Cohesion: 0.12
...
### Community 367 - "test_provider_enable_disable.py"
Cohesion: 0.10
...
### Community 369 - "test_unit7_catalog_propagation.py"
Cohesion: 0.08
...
### Community 373 - "Session Handoff — 2026-06-15"
Cohesion: 0.08
...
### Community 374 - "TASK 4 — End-to-end approval-gate test"
Cohesion: 0.08
...
### Community 375 - "autonomous_fix.py"
Cohesion: 0.14
...
### Community 378 - "test_claude_code_adapter.py"
Cohesion: 0.14
...
### Community 379 - "TemporalContextGraph"
Cohesion: 0.10
...
### Community 380 - "test_daily_automation_2026_08_03.py"
Cohesion: 0.11
...
### Community 381 - "TestClassifyPlainText"
Cohesion: 0.08
...
### Community 382 - "test_service_token.py"
Cohesion: 0.08
...
### Community 386 - "TestStreamableHTTPTransport"
Cohesion: 0.13
...
### Community 388 - "Local AI Stack with Docker"
Cohesion: 0.08
...
### Community 389 - "Traffic Distribution Across Providers"
Cohesion: 0.08
...
### Community 390 - "Implementation Prompt: Rich TaskBoard + Agile Sprint Integration"
Cohesion: 0.08
...
### Community 391 - "Telegram Bot Setup"
Cohesion: 0.08
...
### Community 392 - "video_transcript.py"
Cohesion: 0.12
...
### Community 394 - "schedules/api.py"
Cohesion: 0.13
...
### Community 396 - "test_agency_fix.py"
Cohesion: 0.08
...
### Community 401 - "Agent Governance Guide"
Cohesion: 0.09
...
### Community 402 - "The fifteen strategies"
Cohesion: 0.09
...
### Community 405 - "test_north_mini_code.py"
Cohesion: 0.09
...
### Community 407 - "TaskHarnessAdapter"
Cohesion: 0.11
Nodes (12): Any, TaskResult, TaskSpec, Adapter for a compatible external task harness., TaskHarnessAdapter, Tests for _start_local_runtime safety guards in runtimes/control.py., task_harness (no _base_url) must not spawn agent_runtime.py., If agent_runtime.py exits immediately, _base_url must NOT be set. (+4 more)

### Community 408 - "WindowsServiceManager"
Cohesion: 0.18
...
### Community 409 - "OrchestratorCheckpointStore"
Cohesion: 0.13
...
### Community 410 - "SyntheticDataPipeline"
Cohesion: 0.13
...
### Community 411 - "test_all_features.py"
Cohesion: 0.09
...
### Community 418 - "HarnessEnrichment"
Cohesion: 0.14
...
### Community 419 - "classify_direct_chat_intent"
Cohesion: 0.13
...
### Community 426 - "test_memory_guard.py"
Cohesion: 0.13
...
### Community 430 - "CollaborationContext"
Cohesion: 0.11
...
### Community 431 - "_ensure_tasks_source_id_unique_index"
Cohesion: 0.14
...
### Community 436 - ".start_onboarding"
Cohesion: 0.10
...
### Community 437 - "weekly_digest.py"
Cohesion: 0.13
...
### Community 440 - "test_provider_state_durability.py"
Cohesion: 0.12
...
### Community 441 - "run_trend_analysis"
Cohesion: 0.18
...
### Community 444 - "PersistentMemoryStore"
Cohesion: 0.24
...
### Community 445 - "Skill: modularity-review"
Cohesion: 0.10
...
### Community 448 - "render_router.py"
Cohesion: 0.13
...
### Community 452 - "Docker AI Governance Audit — Final Report"
Cohesion: 0.10
...
### Community 453 - "1. Capability-by-capability"
Cohesion: 0.10
...
### Community 455 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 456 - "FeatureUnavailableError"
Cohesion: 0.13
...
### Community 463 - "PriorityTaskQueue"
Cohesion: 0.15
...
### Community 464 - "test_freebuff_bot.py"
Cohesion: 0.12
...
### Community 468 - "test_langfuse_agency_wide.py"
Cohesion: 0.10
...
### Community 473 - "loop.py"
Cohesion: 0.16
Nodes (17): _check_extra_kwargs(), _enforce_signature(), _note_phase_end(), _note_phase_start(), loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., Raise TypeError if fn's signature drifts from the locked contract (Pydantic…, Raise TypeError on unknown kwarg (runtime extra='forbid' for non-Pydantic…, # NOTE: "ollama_base" is kept for backwards compatibility; this runner only… (+9 more)
...
### Community 487 - "Delegation Plan (agent-ready work packages)"
Cohesion: 0.11
...
### Community 488 - "test_p0_roadmap_a4_a5_b2.py"
Cohesion: 0.15
...
### Community 489 - "parse_event_stream"
Cohesion: 0.15
...
### Community 491 - "test_issue_triage.py"
Cohesion: 0.16
...
### Community 492 - "test_task_source_id_race.py"
Cohesion: 0.17
...
### Community 493 - "test_brain_patch_service_token.py"
Cohesion: 0.18
...
### Community 494 - "TestSelfHealingInfrastructureClassification"
Cohesion: 0.19
...
### Community 496 - "test_repowise_intelligence.py"
Cohesion: 0.11
...
### Community 497 - "test_schedule_persistence.py"
Cohesion: 0.15
...
### Community 498 - "validate_session_id"
Cohesion: 0.16
...
### Community 499 - "ErrorInterceptorMiddleware"
Cohesion: 0.18
...
### Community 502 - "Comprehensive Skill Index (By Category)"
Cohesion: 0.11
...
### Community 503 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 504 - "Component Map"
Cohesion: 0.11
...
### Community 505 - "Agent State — colibri GLM-5.2 deployment (resumable)"
Cohesion: 0.11
...
### Community 506 - "Architecture Overview — local-llm-server"
Cohesion: 0.11
...
### Community 507 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
...
### Community 509 - "Part A — Health Report"
Cohesion: 0.11
...
### Community 513 - "sync_readme_gallery.py"
Cohesion: 0.22
...
### Community 517 - "test_agent_tools.py"
Cohesion: 0.19
...
### Community 518 - "test_company_api.py"
Cohesion: 0.11
...
### Community 519 - "TestStopSlopChecker"
Cohesion: 0.11
...
### Community 520 - "test_telegram_service_webhook.py"
Cohesion: 0.18
...
### Community 521 - "handle_workflow_ide_chat"
Cohesion: 0.18
...
### Community 522 - "_autonomy_bg_cycle"
Cohesion: 0.15
Nodes (16): get_agency(), set_agency(), _autonomy_bg_cycle(), autonomy_tick(), Background CEO cycle + task dispatch. Runs fire-and-forget., Execute ONE pending task synchronously. Called by the cron workflow every 2…, _brain_is_configured(), Best-effort, fail-open check that *some* usable LLM brain is configured.… (+8 more)

### Community 523 - "harness_spec.py"
Cohesion: 0.19
...
### Community 526 - "SKILL: Industrial Brutalism & Tactical Telemetry UI"
Cohesion: 0.12
...
### Community 527 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 528 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 529 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 530 - "Section-by-Section Acceptance Criteria"
Cohesion: 0.12
...
### Community 535 - "kimi_bridge_provider_config"
Cohesion: 0.18
...
### Community 536 - "verify_api_key"
Cohesion: 0.12
Nodes (16): check_rate_limit(), _enforce_rate_limit(), is_rate_limit_exempt(), _rate_limit_exempt_key_ids(), Key IDs explicitly exempted from rate limiting (read fresh from env).…, True when this key is on the FreeBuff rate-limit exemption allowlist. Only…, Apply the per-key RPM limiter unless this request is FreeBuff-exempt.…, Accept both Authorization: Bearer <key> (standard) and x-api-key: <key> (Claude… (+8 more)
...
### Community 543 - "test_monitor_lib.py"
Cohesion: 0.16
...
### Community 544 - "test_openclaw_endpoints.py"
Cohesion: 0.12
...
### Community 547 - "test_task_service_failed_comment.py"
Cohesion: 0.18
...
### Community 548 - "hermes_prompt.py"
Cohesion: 0.19
...
### Community 550 - "MemoryMiddleware"
Cohesion: 0.17
...
### Community 558 - "DirectChatSession"
Cohesion: 0.13
...
### Community 559 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 560 - "Feature Maturity / Support Matrix"
Cohesion: 0.12
...
### Community 561 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 562 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
...
### Community 563 - "implement_agent.py"
Cohesion: 0.16
...
### Community 564 - "test_agent_chat_integration.py"
Cohesion: 0.23
...
### Community 570 - "test_telegram_auto_approve.py"
Cohesion: 0.21
...
### Community 571 - "ManagedAgentDreams"
Cohesion: 0.22
...
### Community 572 - "_resolve_push_token"
Cohesion: 0.17
...
### Community 575 - "test_dockerfile_ships_root_modules.py"
Cohesion: 0.17
...
### Community 576 - "test_frontend_deployment_guards.py"
Cohesion: 0.20
...
### Community 577 - "test_glm52_brain.py"
Cohesion: 0.12
...
### Community 580 - "_make_task"
Cohesion: 0.16
Nodes (16): _make_task(), asyncio, Task, TaskStatus, Tasks in TODO or DONE status are ignored by the reconciler., IN_PROGRESS tasks with pending_agent_run=True are NOT touched (already queued)., TaskDispatcher calls reconcile once before the polling loop starts., A task that is IN_PROGRESS + pending_agent_run=False + old enough → reset. (+8 more)

### Community 581 - "test_phase5_doctor.py"
Cohesion: 0.12
...
### Community 582 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 584 - "test_workflow_models.py"
Cohesion: 0.17
Nodes (8): tests/test_workflow_models.py — Unit tests for workflow/models.py., TestApprovalGate, TestCheckRun, Trigger verification for all applied-but-unverified slices., ApprovalGate, CheckRun, Hard approval gate between plan and execution. The workflow engine sets…, Structured, execution-based verification result. Verifier agents produce ONLY…

### Community 585 - "_hash_component"
Cohesion: 0.16
...
### Community 588 - "Skill: agent-harness"
Cohesion: 0.13
...
### Community 589 - "Skill: checkpoint-strategy"
Cohesion: 0.13
...
### Community 591 - "Skill: local-ai-query"
Cohesion: 0.13
...
### Community 592 - "Skill: parallel-agents"
Cohesion: 0.13
...
### Community 593 - "Skill: parallel-worktrees"
Cohesion: 0.13
...
### Community 594 - "Design System: Taste Standard"
Cohesion: 0.13
...
### Community 596 - "_check_storage_health"
Cohesion: 0.13
...
### Community 602 - "router/health.py"
Cohesion: 0.20
...
### Community 603 - "DockerAgentAdapter"
Cohesion: 0.17
...
### Community 604 - "AdminDigestRouterAuthTests"
Cohesion: 0.22
...
### Community 605 - "clear_wizard_state_cache"
Cohesion: 0.21
...
### Community 608 - "DecisionsStoreTests"
Cohesion: 0.13
...
### Community 609 - "test_dockerfile_ships_config_dir.py"
Cohesion: 0.14
...
### Community 613 - "analyze_qualitative"
Cohesion: 0.25
...
### Community 616 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 620 - "Checks Performed"
Cohesion: 0.14
...
### Community 621 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 622 - "admin_digest_router.py"
Cohesion: 0.22
...
### Community 623 - "Skill: branch-cleanup"
Cohesion: 0.14
...
### Community 624 - "Skill: perplexity — Web Research via Perplexity API"
Cohesion: 0.14
...
### Community 627 - "Quick-Note Issues Processing Summary"
Cohesion: 0.14
...
### Community 628 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 630 - "Render MCP — autonomous platform debugging and environment monitoring"
Cohesion: 0.14
...
### Community 631 - "Runbook: Auto-Resume After Cooldown / Interruption"
Cohesion: 0.14
...
### Community 632 - "SEO / GEO / AIO Audit Engine"
Cohesion: 0.14
...
### Community 636 - "_parse_reset_epoch"
Cohesion: 0.21
...
### Community 640 - "test_critical_flows.py"
Cohesion: 0.29
...
### Community 641 - "TestAnthropicToolListCaching"
Cohesion: 0.34
...
### Community 642 - "test_brain_failover_413.py"
Cohesion: 0.15
...
### Community 643 - "TestMCPToolsListCache"
Cohesion: 0.19
...
### Community 648 - "test_tasks_awaiting_approval_api.py"
Cohesion: 0.37
...
### Community 652 - "register_user_research_tools"
Cohesion: 0.21
...
### Community 668 - "admin_update_task_router.py"
Cohesion: 0.22
...
### Community 670 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
Nodes (12): Acceptance Checks, Claude's query protocol (use this instead of Read tool for exploration):, Graph Artifacts — What to Commit, How to Use the Graph (Token Savings Protocol), Installation (one-time per machine), Instead of reading raw files:, Key commands:, Relationship to repowise-intelligence Skill (+4 more)

### Community 671 - "Skill: platform-setup — Autonomous Agency Bootstrap"
Cohesion: 0.15
...
### Community 672 - "Device compatibility and model picks"
Cohesion: 0.15
...
### Community 673 - "Autonomy Uplift — Living Roadmap & Detailed Implementation Specs"
Cohesion: 0.15
...
### Community 674 - "OpenClaw — iOS Control of the Agency (Single-Service Free-Tier Deploy)"
Cohesion: 0.15
...
### Community 678 - "_is_bedrock_model_id"
Cohesion: 0.27
...
### Community 684 - ".on_task_complete"
Cohesion: 0.18
...
### Community 687 - "TestDecisionsBotLinks"
Cohesion: 0.21
...
### Community 688 - "test_deploy_trigger_covers_image.py"
Cohesion: 0.21
...
### Community 689 - "test_doctor_service_token_check.py"
Cohesion: 0.23
...
### Community 694 - "skill_registry.py"
Cohesion: 0.17
...
### Community 696 - "AGENTS.md — Codebase Map & Operations Reference"
Cohesion: 0.17
...
### Community 697 - "PortfolioIntelligence"
Cohesion: 0.18
...
### Community 706 - "delegate_seo_findings"
Cohesion: 0.20
...
### Community 720 - "check_container_posture.py"
Cohesion: 0.26
...
### Community 721 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 722 - "test_admin_local_brain_router.py"
Cohesion: 0.29
...
### Community 723 - "test_agile_api.py"
Cohesion: 0.17
...
### Community 724 - "test_app_settings.py"
Cohesion: 0.21
...
### Community 726 - "test_task_clarification.py"
Cohesion: 0.17
...
### Community 729 - "_extractive_compress"
Cohesion: 0.18
...
### Community 756 - "local_brain_provider_config"
Cohesion: 0.25
...
### Community 761 - "test_agent_readiness_audit.py"
Cohesion: 0.18
...
### Community 762 - "TestAgentRunnerSafety"
Cohesion: 0.24
...
### Community 763 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 766 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 767 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 768 - "admin_local_brain_router.py"
Cohesion: 0.22
...
### Community 769 - "_normalize_tool_choice"
Cohesion: 0.31
...
### Community 770 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 771 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 772 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 773 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 774 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 775 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 776 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 778 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 779 - "LLM Router — configuration guide"
Cohesion: 0.20
...
### Community 780 - "LLM Router — provider guide"
Cohesion: 0.20
...
### Community 781 - "CI Troubleshooting Runbook"
Cohesion: 0.20
...
### Community 788 - "_redact_for_notification"
Cohesion: 0.24
...
### Community 789 - "TestZeroAttemptDiagnostics"
Cohesion: 0.29
...
### Community 790 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 793 - "test_quick_note_engine.py"
Cohesion: 0.22
...
### Community 799 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 800 - "Skill: changelog-enforcer"
Cohesion: 0.22
...
### Community 801 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 803 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 804 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 805 - "Skill: changelog-enforcer"
Cohesion: 0.22
Nodes (8): Acceptance Checks, Changelog Location, Entry Format, Examples, Hook Behaviour, Instructions, Skill: changelog-enforcer, When to Use

### Community 806 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
Nodes (8): Branch, Components, Purpose, Quick Start, Session Roles, Skill: cowork-session (Claude Cowork), Testing, When to Use

### Community 807 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 808 - "Active Task Tracker"
Cohesion: 0.22
...
### Community 810 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 811 - "Main proxy (`proxy.py`)"
Cohesion: 0.22
...
### Community 812 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 813 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 814 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 815 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 816 - "Platform Controls"
Cohesion: 0.22
...
### Community 817 - "Release Procedure"
Cohesion: 0.22
...
### Community 818 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 821 - "ENGINEERING_STANDARDS.md — Patterns & Reference"
Cohesion: 0.22
...
### Community 830 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 832 - "test_changelog_parity_guard.py"
Cohesion: 0.22
...
### Community 834 - "TestChatFallbackAndApproval"
Cohesion: 0.22
...
### Community 846 - "_brain_provider_status"
Cohesion: 0.25
...
### Community 847 - "_parse_tool_calls_from_response"
Cohesion: 0.39
...
### Community 858 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 862 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.25
...
### Community 863 - "Issue #362: Nvidia repo setup"
Cohesion: 0.25
...
### Community 864 - "Issue #364: quick-note:https://www.marktechpost.com/2026/06/01/meet-memory-os-a-6-layer-open-source-memory-stack-built-on-top-of-hermes-agent/"
Cohesion: 0.25
...
### Community 865 - "Issue #378: quick-note:https://www.marktechpost.com/2026/06/02/tinyfish-launches-bigset-an-open-source-multi-agent-system-that-builds-structured-live-datasets-from-plain-english-descriptions/"
Cohesion: 0.25
...
### Community 866 - "Issue #379: quick-note:https://searchengineland.com/schema-markup-optimize-agentic-web-479080"
Cohesion: 0.25
...
### Community 867 - "Issue #380: quick-note:https://cursor.com/blog/cloud-agent-lessons"
Cohesion: 0.25
...
### Community 868 - "Issue #381: quick-note:https://www.xda-developers.com/claude-code-with-opus-48-is-expensive-but-i-made-it-efficient-with-my-local-ai-workflow/"
Cohesion: 0.25
...
### Community 869 - "Issue #382: quick-note:https://claude.com/blog/how-coderabbit-used-claude-to-build-an-agent-orchestration-system"
Cohesion: 0.25
...
### Community 870 - "Issue #383: quick-note:https://www.marktechpost.com/2026/05/29/hexo-labs-open-sources-sia-a-self-improving-agent-that-updates-both-the-harness-and-the-model-weights/"
Cohesion: 0.25
...
### Community 871 - "Issue #416: feat: Self-hosted Codebuff (freebuff) on free NVIDIA models + Telegram bot phone control"
Cohesion: 0.25
...
### Community 872 - "Issue #485: [Trend Digest] Week of 2026-06-08"
Cohesion: 0.25
...
### Community 873 - "Issue #488: quick-note:https://github.com/cookiy-ai/user-research-skill"
Cohesion: 0.25
...
### Community 874 - "Issue #491: Implement whatever is necessary from https://github.com/BehiSecc/awesome-claude-skills"
Cohesion: 0.25
...
### Community 875 - "Issue #493: Use the https://github.com/mvanhorn/last30days-skill skill to get the trend updated"
Cohesion: 0.25
...
### Community 876 - "Issue #495: Read https://www.anthropic.com/news/claude-fable-5-mythos-5 and understand if mythos or fable can be added to the repo"
Cohesion: 0.25
...
### Community 877 - "Issue #504: EPIC: Autonomy hardening — live-verified defects 2026-06-10"
Cohesion: 0.25
...
### Community 878 - "Issue #581: Sprint tracker: pending work after brand rename + mobile-first pass"
Cohesion: 0.25
...
### Community 880 - "Issue #657: quick-note:https://github.com/earendil-works/pi"
Cohesion: 0.25
...
### Community 881 - "Issue #659: quick-note:https://github.com/nex-agi/Nex-N2"
Cohesion: 0.25
...
### Community 882 - "Issue #660: quick-note:https://github.com/getsentry/sentry-for-ai"
Cohesion: 0.25
...
### Community 883 - "Issue #661: quick-note:https://github.com/XiaomiMiMo/MiMo-Code"
Cohesion: 0.25
...
### Community 884 - "Issue #664: quick-note:https://github.com/Grominet95/jarvis-OS"
Cohesion: 0.25
...
### Community 885 - "Issue #666: quick-note:https://github.com/porokka/jarvis-os"
Cohesion: 0.25
...
### Community 886 - "Issue #670: quick-note:https://github.com/perplexityai/bumblebee"
Cohesion: 0.25
...
### Community 887 - "Issue #672: quick-note:https://github.com/Chachamaru127/claude-code-harness"
Cohesion: 0.25
...
### Community 888 - "Issue #676: quick-note:https://github.com/WeiboAI/VibeThinker"
Cohesion: 0.25
...
### Community 889 - "Issue #820: quick-note:https://github.com/cobusgreyling/loop-engineering"
Cohesion: 0.25
...
### Community 890 - "Positional Encoding Internals"
Cohesion: 0.25
...
### Community 901 - "run_patched_colibri.py"
Cohesion: 0.36
...
### Community 904 - "test_compose_and_coordinate_api.py"
Cohesion: 0.36
...
### Community 905 - "test_generate_context_standing_instructions.py"
Cohesion: 0.32
...
### Community 906 - "test_local_brain_router_smoke.py"
Cohesion: 0.25
...
### Community 913 - "test_serve_spa_prefixes.py"
Cohesion: 0.36
...
### Community 914 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.25
...
### Community 916 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 922 - "platform_controls_router.py"
Cohesion: 0.29
...
### Community 924 - "AI Engineering Insights Skill"
Cohesion: 0.29
...
### Community 936 - "Implementation plan + TO-DO (check off as you go)"
Cohesion: 0.29
...
### Community 939 - "Cloudflare = the real working app"
Cohesion: 0.29
...
### Community 940 - "Workspace Issues"
Cohesion: 0.29
...
### Community 941 - "Model and Response Issues"
Cohesion: 0.29
...
### Community 950 - "e2e_smoke.py"
Cohesion: 0.57
Nodes (5): _chat(), check(), _health(), _models(), _req()

### Community 951 - "BackgroundServices"
Cohesion: 0.38
...
### Community 955 - "test_daily_2026_06_14.py"
Cohesion: 0.38
...
### Community 956 - "TestSupportMatrixDocsSync"
Cohesion: 0.29
...
### Community 957 - "test_doctor_coding_brain.py"
Cohesion: 0.38
...
### Community 958 - "TestGithubTokenSQLiteRegression"
Cohesion: 0.38
...
### Community 959 - "test_log_monitor_storm_guard.py"
Cohesion: 0.48
...
### Community 960 - "TestReasonsAreActionable"
Cohesion: 0.29
...
### Community 980 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 981 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 982 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 983 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 984 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 985 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 988 - "apply_phase1_changes.py"
Cohesion: 0.33
...
### Community 995 - "setup-claude-code.sh script"
Cohesion: 0.60
Nodes (5): log_error(), log_info(), log_success(), print_header(), setup-claude-code.sh script

### Community 999 - "TestAgentRunnerExecution"
Cohesion: 0.33
...
### Community 1000 - "TestDirectChatAgentExecution"
Cohesion: 0.33
...
### Community 1001 - "TestCEOAgencySystem"
Cohesion: 0.33
...
### Community 1020 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 1021 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 1023 - "Admin Dashboard Issues"
Cohesion: 0.40
...
### Community 1024 - "Agent API Issues"
Cohesion: 0.40
...
### Community 1025 - "Network and Tunnel Issues"
Cohesion: 0.40
...
### Community 1026 - "knowledgeGraphTab.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 1027 - "loginFlowNoTimeout.test.js"
Cohesion: 0.40
Nodes (4): apiSource, { describe, test, expect }, fs, path

### Community 1028 - "test_company_stale_id_recovery.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 1029 - "worker_no_cache.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, workerSource

### Community 1030 - "scripts/agile_ceremonies.py"
Cohesion: 0.60
...
### Community 1042 - "TestMobileNavigation"
Cohesion: 0.40
...
### Community 1044 - "test_agent_runtime_wrapper.py"
Cohesion: 0.70
...
### Community 1045 - "TestTelegramNotifications"
Cohesion: 0.40
...
### Community 1047 - "TestModelRoleSeparation"
Cohesion: 0.40
...
### Community 1054 - "aider_config.sh"
Cohesion: 0.50
...
### Community 1062 - "Claude Code Specific Issues"
Cohesion: 0.50
...
### Community 1084 - "mint_access_token"
Cohesion: 0.50
Nodes (4): TTL must be clamped to at most 24 hours and at least 60 seconds., test_mint_token_ttl_clamped(), mint_access_token(), Mint a LiveKit room-join access token (HS256 JWT). Args: api_key: LiveKit API…

### Community 1085 - "test_skills_route_order.py"
Cohesion: 0.67
...
- **Why does `_fixture()` connect `_fixture` to `ImprovementLoop`, `company_api.py`, `test_company_api.py`, `TaskWorkflowService`, `TaskStore`, `test_llm_router_queue_cache.py`, `test_telegram_service_webhook.py`, `test_llm_router_strategies.py`, `test_operational_incidents.py`, `WorkflowRun`, `SelfHealingAgent`, `test_autonomous_agency_e2e.py`, `Task`, `routed`, `PolicyEngine`, `test_llm_router_resilience.py`, `services/background.py`, `gateway.py`, `direct_chat.py`, `test_monitor_lib.py`, `test_openclaw_endpoints.py`, `test_task_service_failed_comment.py`, `ProviderConfig`, `test_failover_client_shared.py`, `_clear_cache`, `test_model_router.py`, `PrimeAgentAdapter`, `UserRole`, `AgentSwarm`, `AgentJobManager`, `test_unit8_model_catalog.py`, `SQLiteStore`, `test_telegram_auto_approve.py`, `_resolve_push_token`, `get_task_store`, `test_autonomy_status.py`, `ChatHistoryStore`, `test_local_brain_state.py`, `test_phase5_doctor.py`, `TokenBudget`, `test_telegram_diag_endpoint.py`, `ResearchTask`, `test_ceo_router.py`, `TestClient`, `test_ai_insights.py`, `OutputFilter`, `test_procedural_memory.py`, `CEOSupervisor`, `test_startup_warmup.py`, `test_sam_voice.py`, `e2e/test_browser.py`, `config.py`, `enforcement.py`, `test_knowledge_sync.py`, `run_task`, `ArtifactStore`, `test_context_rulebook.py`, `test_trend_scoping.py`, `FeatureMaturity`, `test_response_cache.py`, `test_brain_failover_413.py`, `test_issue_intake.py`, `KeyStore`, `test_openclaw_gateway.py`, `TestHarnessAdapter`, `claim`, `persist_plan_spec`, `TestEstimateTokensForMessages`, `test_e2b_adapter.py`, `MCPClient`, `BudgetTracker`, `test_new_features_e2e.py`, `test_daily_2026_07_27.py`, `_Budget`, `test_seo_audit.py`, `BrainWatchdog`, `OllamaCircuitBreaker`, `test_doctor_service_token_check.py`, `TestRuntimeControl`, `test_mcp_governance.py`, `test_features_api.py`, `test_video_transcript.py`, `TrendWatcher`, `test_portfolio_intake.py`, `emit_chat_observation`, `test_platform_controls.py`, `SchedulerStore`, `NotificationDispatcher`, `control_overrides.py`, `test_agile_api.py`, `test_app_settings.py`, `ApprovalStore`, `test_task_clarification.py`, `analyze_page`, `test_agent_tool_governance.py`, `test_e2b_data_flow.py`, `test_trend_watcher.py`, `TestAuthAndTaskOwnership`, `clear_cooldowns`, `TestClient`, `ContextPruner`, `api_keys_for`, `provider_max_rpm`, `test_llm_router_disabled.py`, `test_control_plane_api.py`, `WorkflowBuildRequest`, `test_persistent_memory.py`, `SecurityScanner`, `test_brain_failover.py`, `test_llm_router_e2e.py`, `capture_screens.py`, `TestMongoGate`, `test_rate_limiter.py`, `OrchestratorQueue`, `get_skill_registry_safe`, `TestNormalizeResponseFormat`, `session_retro.py`, `test_purge_backlog.py`, `_start_ceo_agency`, `TestSwarmRoleRouting`, `TestChatFallbackAndApproval`, `test_telegram_mutating_commands.py`, `timedelta`, `SeoFixRequest`, `test_scheduler_hydration_bounded.py`, `test_crispy_burn_in.py`, `test_skill_registry_boot_refresh.py`, `test_dashboard_cache.py`, `isolated_telegram_config`, `test_provider_enable_disable.py`, `test_claude_code_adapter.py`, `test_service_token.py`, `test_harness_spec.py`, `test_regression.py`, `test_agency_fix.py`, `test_ping.py`, `test_webui_provider_priority.py`, `test_runtimes_health_endpoint.py`, `test_task_store_fails_loud_in_production.py`, `OrchestratorCheckpointStore`, `test_v4_api.py`, `_FakeSandbox`, `test_provider_state_durability.py`, `client`, `test_doctor_coding_brain.py`, `test_kimi_bridge_server.py`, `test_langfuse_agency_wide.py`, `test_voice_pipeline.py`, `cost_tracker.py`, `reset_kv_state`, `test_provider_410_per_model.py`, `parse_event_stream`, `test_brain_patch_service_token.py`?**
  _High betweenness centrality (0.116) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `test_brain_failover_413.py`, `proxy.py`, `ImprovementLoop`, `ReactScratchpad`, `AdaptiveHalter`, `TaskSpec`, `TestAgentLoopMCPIntegration`, `WorkflowRun`, `ContextManager`, `test_e2b_adapter.py`, `test_autonomous_agency_e2e.py`, `workflow_orchestrator.py`, `MCPClient`, `test_daily_automation_2026_07_11.py`, `direct_chat.py`, `LocalWorkspace`, `E2BSandboxSession`, `MultiAgentSwarm`, `AgentSessionStore`, `test_failover_client_shared.py`, `StuckDetector`, `CEODispatcher`, `AgentJobManager`, `test_agent_chat_integration.py`, `WorkspaceTools`, `_resolve_push_token`, `TokenBudget`, `UserMemoryStore`, `loop.py`, `test_agent_tool_governance.py`, `test_backend_server_features.py`, `InternalAgentAdapter`, `test_agent_runner.py`, `TestAgentRunnerExecution`, `test_governance_api.py`, `ContextPruner`, `FreeBuffAgent`, `TestAgentRunnerSafety`, `GitHubTools`, `test_empirical_verify.py`, `test_agent_free_brain.py`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `get_skill_bindings()` connect `Specialist` to `_execute_skill_impl`, `HarnessEnrichment`, `company_api.py`, `get_company_graph_store`, `SpecEntry`, `WorkflowRun`, `workflow_orchestrator.py`, `loop.py`, `FeatureMaturity`, `AgentRunner`, `skill_bindings.py`?**
...
- **Should `backend/server.py` be split into smaller, more focused modules?**
  _Cohesion score 0.023949246629659002 - nodes in this community are weakly interconnected._