...
## Corpus Check
- 1446 files · ~2,082,091 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 28820 nodes · 53830 edges · 1194 communities (1079 shown, 115 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 2644 edges (avg confidence: 0.91)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f0b5901e`
...
## Communities (1194 total, 115 thin omitted)

### Community 0 - "backend/server.py"
Cohesion: 0.02
Nodes (202): get_sam(), get_harness_adapter(), AgentStatusEntry, AgentStatusResponse, AgentToolCallEntry, ApiKeyCreate, auth_me(), AuthorizeReposBody (+194 more)

### Community 1 - "company_api.py"
Cohesion: 0.02
Nodes (165): ephemeral_ttl_hours(), Async read of the ephemeral TTL (hours) straight from the DB., account_lifecycle(), AccountLifecycleResponse, auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint() (+157 more)

### Community 2 - "proxy.py"
Cohesion: 0.03
Nodes (167): get_skill_registry_safe(), Return the global SkillRegistry if set, else None. Used by onboarding and other…, middleware, admin_control(), admin_create_key(), admin_create_user(), admin_delete_user(), admin_login() (+159 more)

### Community 3 - "llm/router.py"
Cohesion: 0.03
Nodes (126): get_cache(), The process-wide cache manager., failover_chat_completion_via_router(), openai_body_from_response(), Any, packages/llm/compat.py — backwards-compatible bridges to the legacy call paths.…, Router-backed implementation of ``packages.ai.failover_client``'s entry point.…, Whether the compat bridges should delegate to ``LLMRouter``. Reads the flag on… (+118 more)

### Community 4 - "TaskStore"
Cohesion: 0.03
Nodes (123): Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., tasks — Task/issue management system. Provides a lightweight task/issue tracker…, ApprovalCheckpoint, ApprovalRequest, ClarifyRequest, ExecutionApprovalRequest, ExecutionLogEntry (+115 more)

### Community 5 - "TaskSpec"
Cohesion: 0.04
Nodes (90): agent/job_manager.py — Async agent job lifecycle manager. Manages agent jobs…, kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, TaskResult, TaskSpec, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Run aider non-interactively via `--message` flag., runtimes/adapters/claude_code.py — Claude Code CLI adapter (FIRST CLASS).… (+82 more)

### Community 6 - "test_llm_router_strategies.py"
Cohesion: 0.03
Nodes (107): count, HealthConfig, Strategy selection and degradation behaviour., Circuit breaker + health tracking thresholds., RoutingConfig, HealthTracker, _Outcome, ProviderHealth (+99 more)

### Community 7 - "test_operational_incidents.py"
Cohesion: 0.02
...
### Community 9 - "Task"
Cohesion: 0.04
Nodes (70): Full task/issue document., Update the updated_at timestamp., Task, PUBLIC_URL-anchored dashboard deep link for the task detail. Returns empty…, Best-effort Telegram heads-up that a task is parked awaiting approval. Inline…, test_coordinator_sets_bypass_for_sanctioned_execution(), asyncio, A reject + human Retry starts a NEW approval cycle → fresh notification. (+62 more)

### Community 10 - "test_governance_sandbox.py"
Cohesion: 0.03
...
Cohesion: 0.03
Nodes (79): AgentCreateRequest, AgentDefinition, AgentStore, AgentUpdateRequest, Any, BaseModel, field_validator, agents/store.py — Persistent store for user-defined agent configurations.… (+71 more)
...
Cohesion: 0.04
Nodes (108): admin_seed(), create_access_token(), create_api_key(), create_github_pr(), create_provider(), create_wiki_page(), delete_api_key(), delete_github_token() (+100 more)

### Community 19 - "models/company_graph.py"
Cohesion: 0.04
...
Cohesion: 0.04
Nodes (91): AgentPhaseError, AgentRunner, Exception, Return True when no file is touched by more than one step., Raised when a named agent phase (planning, verification, etc.) fails., GATE: Golden Path steps #7-12 — the primary agent execution loop. This is the…, Set a per-session token spend cap (★3 rollout token budget). When *cap* > 0 the…, _make_runner() (+83 more)

### Community 21 - "test_user_research_skill.py"
Cohesion: 0.04
...
### Community 23 - "CompanyGraphService"
Cohesion: 0.03
Nodes (55): BusinessCategory, CompanyGraph, SpecialistFamily, SystemType, The complete Company Graph - canonical core model for the Autonomous AI Agency.…, Find a website by its URL., Find all systems of a specific type., Find all specialists of a specific family. (+47 more)

### Community 24 - "services/background.py"
Cohesion: 0.04
...
Cohesion: 0.04
Nodes (78): _egress_policy_reason(), Return why governance policy blocks *host*, or None. Runs strictly *after* the…, _load(), Import the governance layer once, recording why if it is absent., _action_matches(), _as_list(), Decision, get_policy_engine() (+70 more)
...
### Community 29 - "test_ceo_dispatcher.py"
Cohesion: 0.04
Nodes (87): _merge_changed_files(), Collect changed_files across all specialists into a single de-duped list., ClassifyOutput, get_ceo_fallback_stats(), PlanOutput, CLASSIFY phase: domain and task type determination., PLAN phase: structured execution plan., SELECT_SPECIALIST phase: which specialist(s) handle this work. (+79 more)

### Community 30 - "loop.py"
Cohesion: 0.04
Nodes (53): _check_extra_kwargs(), _enforce_signature(), _note_phase_end(), _note_phase_start(), Any, Path, loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., Raise TypeError if fn's signature drifts from the locked contract (Pydantic… (+45 more)
...
### Community 33 - "test_runtime_governance.py"
Cohesion: 0.05
...
Cohesion: 0.04
Nodes (57): Request to provision a specialist for a company., Result of provisioning a specialist., SpecialistProvisionRequest, SpecialistProvisionResult, build_matrix(), _families(), main(), Any (+49 more)

### Community 35 - "test_unit8_model_catalog.py"
Cohesion: 0.04
Nodes (71): all_provider_ids(), provider_key_present(), Return every provider id recognised by the brain config system. Iterates the…, True when the env var for *provider*'s key is set (or it's Ollama)., CatalogActiveBrain, CatalogMirror, CatalogProviderEntry, get_catalog() (+63 more)
...
### Community 40 - "resolve_active_brain"
Cohesion: 0.03
Nodes (79): BrainResolution, get_brain_config(), get_brain_config_store(), Return the process-wide ``BrainConfigStore`` singleton., Convenience wrapper used by the agent loop + brain resolver., get_brain_preference(), get_provider_role_tags(), _host_is_openai_compatible() (+71 more)
...
### Community 42 - "ProviderConfig"
Cohesion: 0.04
Nodes (74): extract_openai_text(), _normalize_nvidia_base_url(), _openai_url(), provider_access_tier(), _provider_field(), provider_sort_key(), ProviderConfig, Release the probe lock for *provider_id*. (+66 more)
...
Cohesion: 0.04
Nodes (56): _escape_md_v1(), NotificationDispatcher, Any, Path, service_manager.py — Telegram & Notification Integration Extension Extends the…, Signal the bot to stop and wait for graceful shutdown., Routes background task results to configured notification channels. Currently…, Callback for BackgroundAgent.on_task_complete. Dispatches task result… (+48 more)

### Community 45 - "CompanyGraphStore"
Cohesion: 0.03
Nodes (41): KnowledgeItem, Find a repository by its URL., Find knowledge items matching any of the given tags., Structured knowledge about the company, systems, or processes., A company repository with detected technologies and metadata., Extract the owner from the full name., Extract the repository name from the full name., Repo (+33 more)

### Community 46 - "test_agent_tool_governance.py"
Cohesion: 0.04
Nodes (68): ApprovalRequest, ApprovalStatus, ApprovalStore, Any, Enum, str, packages/governance/approvals.py — human-in-the-loop for high-risk actions. The…, Bounded, in-process store of approval requests. Uses a :class:`threading.Lock`… (+60 more)

### Community 47 - "ExecutionRequest"
Cohesion: 0.04
Nodes (45): ExecutionRequest, Exception, Inject additional instructions into an in-flight run (no state change). Backs…, Persist first-merge consent once an operator approves a ``telegram_gate``. No-…, Determine domain and task type from the request text., Generate a structured execution plan. Uses the LLM if available; falls back to…, Select the best specialist(s) for the classified domain., Run doctor checks before execution. (+37 more)

### Community 48 - "KeyPool"
Cohesion: 0.04
...
### Community 54 - "agent/workspace.py"
Cohesion: 0.05
...
### Community 60 - "BrainConfig"
Cohesion: 0.04
Nodes (57): BrainConfig, BrainConfigStore, provider_base_url(), Persist *cfg* to Mongo (primary) and sqlite (mirror). Either backend failing is…, Build a ``BrainConfig`` from a Mongo doc, dropping Mongo's ``_id``., Synchronous call-time resolver for an agent role model id. Precedence (highest…, Async variant — refreshes the cache if stale before resolving. Used by code…, Resolve the Ollama base URL the UI controls — DB value wins over env.… (+49 more)
...
Cohesion: 0.07
Nodes (67): is_user_onboarding_allowed(), Return True if this user may run the onboarding wizard. Resolution order: 1. If…, is_activated(), Fast in-process check. Loads from disk on first call. When…, complete_wizard(), _delete_wizard_state(), detect_configured_providers(), detect_hardware_for_wizard() (+59 more)
...
### Community 68 - "test_llm_router_resilience.py"
Cohesion: 0.04
Nodes (46): BreakerState, str, _digest(), get_ring(), KeyRing, KeyState, packages/llm/keys.py — multi-key rotation with per-key health. A provider may…, Per-provider round-robin key selection with cooldowns. (+38 more)
...
### Community 70 - "test_webui_provider_priority.py"
Cohesion: 0.08
...
### Community 71 - "AgentSwarm"
Cohesion: 0.06
Nodes (43): AgentSwarm, Any, agents/swarm.py — AgentSwarm: routes workflow phases to the correct agent. The…, Return the agent role responsible for *phase*., Return the AgentProfile for the agent driving *phase*., Return a JSON-serialisable summary of all agent profiles., Run a pre-gate or report phase through the correct agent. Enforces permission…, Execute a slice via the Coder agent (write-permitted). (+35 more)

### Community 72 - "get_workflow_orchestrator"
Cohesion: 0.05
...
### Community 75 - "failover_client.py"
Cohesion: 0.04
...
### Community 82 - "test_startup_warmup.py"
Cohesion: 0.04
...
### Community 85 - "test_procedural_memory.py"
Cohesion: 0.05
...
Cohesion: 0.06
Nodes (62): Convenience: resolve all four role models for a component. Returns a dict with…, resolve_component_role_models(), get_decisions_store(), Process-wide DecisionsStore singleton (resettable via db_path arg)., Return a Markdown-v1-safe preview string under ``max_chars``. Used by the…, sanitize_paste_for_preview(), _admin_headers(), _api_headers() (+54 more)
...
### Community 90 - "AgentProfile"
Cohesion: 0.06
Nodes (47): agents/__init__.py — CRISPY multi-agent coding system., AgentProfile, _catalog_defaults(), _catalog_provider(), _get_defaults(), load_all_profiles(), make_architect_profile(), make_coder_profile() (+39 more)

### Community 91 - "get_scheduler"
Cohesion: 0.05
...
### Community 96 - "brain_failover.py"
Cohesion: 0.05
Nodes (60): auto_disable(), _billing_signals(), disabled_provider_ids(), is_unfixable(), packages/llm/disabled.py — bridge to the durable provider on/off switch. The…, Provider ids currently switched off. Empty when the store is unreachable., Persist a provider as disabled, through the store that already owns it., The one list of "you have no money" phrases, borrowed not copied. Lazy because… (+52 more)

### Community 97 - "get_registry"
Cohesion: 0.04
...
### Community 101 - "_require_admin"
Cohesion: 0.05
Nodes (58): clear_response_cache(), get_catalog_models_route(), _get_provider_policy(), get_provider_policy_route(), ProviderPolicyUpdate, Read the durable provider policy from DB, falling back to a safe default.…, Editable subset of the durable provider policy (paid-provider kill switch)., Persist the durable provider policy and return the new state. Also writes to… (+50 more)

### Community 102 - "SeoFixRequest"
Cohesion: 0.14
...
### Community 108 - "test_sam_livekit.py"
Cohesion: 0.05
...
### Community 111 - "test_trend_scoping.py"
Cohesion: 0.08
...
### Community 114 - "TestAdapterMetadata"
Cohesion: 0.05
...
### Community 117 - "test_web_reach.py"
Cohesion: 0.08
Nodes (44): Register the Web Reach capability (agent/web_reach.py): zero-key internet…, _register_web_reach_tools(), get_web_reach(), _load_script_module(), Any, ModuleType, Response, agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives… (+36 more)

### Community 118 - "probe_model_liveness"
Cohesion: 0.05
...
### Community 122 - "AgentSessionStore"
Cohesion: 0.07
...
### Community 126 - "AuditLog"
Cohesion: 0.05
Nodes (32): Resolve the JWT signing secret, with a *stable* fallback. Bug fix: the previous…, _resolve_jwt_secret(), AuditEvent, AuditLog, Any, packages/governance/audit.py — the evidence trail for every governed action.…, Redact secret-shaped substrings, then truncate., One governed action, fully described. Field order follows the… (+24 more)

### Community 127 - "fmtErr"
Cohesion: 0.06
...
### Community 130 - "resolve_component_model"
Cohesion: 0.05
Nodes (53): Resolve the model id for a component's role on a provider. Parameters…, resolve_component_model(), _build_builtin_model_map(), _default_model(), _default_reasoning_model(), _nvidia_key_present(), Dynamic model router. Central routing logic for all chat and agent requests.…, Build the built-in alias table — Nvidia NIM models when key is set, local… (+45 more)

### Community 131 - "run_task"
Cohesion: 0.05
...
### Community 133 - "test_provider_state_durability.py"
Cohesion: 0.04
...
### Community 138 - "test_backend_server_features.py"
Cohesion: 0.04
Nodes (38): backend/ceo_router.py — observability and manual control for the CEO. Surfaces…, Reject non-admin callers for routes that spend provider budget. Delegates to…, _require_admin(), _is_admin(), Check if a user has admin role. Works for both social_auth users (role in…, _actor(), ControlUpdateBody, BaseModel (+30 more)

### Community 139 - "test_governance_api.py"
Cohesion: 0.06
Nodes (50): build_governance_router(), Any, APIRouter, backend/governance_router.py — read and operate the governance layer. Mounted…, Reject non-admin callers. Mirrors the RBAC check used elsewhere in this backend…, _require_admin(), get_approval_store(), Replace the process-wide gate. Tests only. (+42 more)

### Community 140 - "Feature Guide"
Cohesion: 0.05
...
Cohesion: 0.06
Nodes (44): get_active_brain_sync(), invalidate_brain_cache(), Clear the cached brain so the next read re-resolves. Called from…, Return the cached brain read by sync callers. None if never resolved., Resolve the LLM endpoint for agent execution (module-level, #522 failover).…, _resolve_brain_provider(), When BrainConfig.updated_at is empty (never applied), the resolver falls…, test_resolve_active_brain_falls_through_when_db_unset() (+36 more)

### Community 146 - "test_mcp_registry.py"
Cohesion: 0.07
...
### Community 153 - "StreamingDeltaReconstructor"
Cohesion: 0.06
...
### Community 154 - "RuntimeCapabilityRegistry"
Cohesion: 0.07
...
### Community 155 - "ChatHistoryStore"
Cohesion: 0.07
...
### Community 156 - "test_issue_intake.py"
Cohesion: 0.08
...
### Community 163 - "test_brain_config_store.py"
Cohesion: 0.06
Nodes (47): BrainConfigPatch, default_brain_config(), invalidate_brain_config_cache(), BaseModel, Convenience wrapper used by the admin API endpoints., Clear the singleton's cache (used by tests + brain_policy invalidation)., Return ``(max_output_tokens, request_timeout_sec)`` for an agent LLM call. Same…, Return the safe-default brain (used on first boot + store errors). (+39 more)

### Community 164 - "test_phase4_runtime_resilience.py"
Cohesion: 0.05
Nodes (45): _env_flag(), Read a boolean env var. Accepts 'true'/'1'/'yes' (case-insensitive)., Re-queue BLOCKED tasks that have cooled down and are ready for retry., Polls for queued task work and executes it through the coordinator. Crash…, Re-queue tasks stranded by a prior crash or hard-kill., TaskDispatcher, _make_task(), asyncio (+37 more)
...
### Community 180 - "workflow_orchestrator.py"
Cohesion: 0.11
Nodes (32): BoundContext, ExecutionResult, JudgeVerdict, MonitorOutput, _orchestrator_bypass(), PersistOutput, Phase, PreflightReport (+24 more)

### Community 181 - "activation_api.py"
Cohesion: 0.09
...
### Community 182 - "test_slop_gate.py"
Cohesion: 0.07
...
### Community 185 - "_build_default_manager"
Cohesion: 0.06
...
### Community 188 - "test_ceo_router.py"
Cohesion: 0.08
...
### Community 189 - "SeoAuditEngine"
Cohesion: 0.07
Nodes (19): field_validator, Request to run an SEO/GEO/AIO audit against a website., SeoAuditRequest, Crawls a site and produces a complete SeoAuditReport., Pick the fetch backend for this run (http / browser / auto)., Execute the full audit: crawl, page checks, site checks, scoring., SeoAuditEngine, mock_report() (+11 more)

### Community 190 - "settings.py"
Cohesion: 0.08
...
### Community 191 - "E2BAdapter"
Cohesion: 0.06
Nodes (32): E2BAdapter, Any, Declare ``E2B_API_KEY`` as a required env dependency. The base ``preflight``…, Runtime adapter that executes tasks inside an E2B sandbox. Activation:…, Available iff config resolves AND the SDK is importable. Never raises — a…, _FakeAsyncSandboxClass, _FakeCommandResult, _FakeCommands (+24 more)

### Community 192 - "SyntheticDataPipeline"
Cohesion: 0.07
...
### Community 193 - "test_agent_free_brain.py"
Cohesion: 0.05
...
### Community 201 - "chat_handlers.py"
Cohesion: 0.09
...
### Community 207 - "test_p0_roadmap_b3_b4_b5.py"
Cohesion: 0.08
...
### Community 209 - "TestBrainFailoverModelUpdates"
Cohesion: 0.08
...
### Community 213 - "KnowledgeScreen.jsx"
Cohesion: 0.08
Nodes (31): createWikiPage(), deleteSource(), deleteWikiPage(), getCompanyGraph(), getSource(), getWikiPage(), ingestSource(), lintWiki() (+23 more)

### Community 214 - "cache.py"
Cohesion: 0.06
Nodes (29): Test hook — clear all usage accounting., reset(), CacheManager, cosine_similarity(), _Entry, LRUCache, payload_key(), Any (+21 more)
...
### Community 217 - "_scheduler_on_fire"
Cohesion: 0.50
...
### Community 221 - "test_daily_2026_06_04.py"
Cohesion: 0.08
...
### Community 222 - "ProviderRouter"
Cohesion: 0.10
Nodes (23): _get_director(), is_commercial_provider(), _normalized_provider_type(), ProviderRouter, Any, Response, Try all models for one provider. Returns ProviderResult on success, None on…, Parse a 429/503 ``Retry-After`` header → seconds, or None. Accepts either… (+15 more)
...
### Community 227 - "test_trend_watcher.py"
Cohesion: 0.08
...
### Community 229 - "PortfolioManager"
Cohesion: 0.07
...
### Community 230 - "get_failover_manager"
Cohesion: 0.07
...
### Community 234 - "test_telegram_freebuff.py"
Cohesion: 0.09
Nodes (35): _parse_callback(), _parse_user_ids(), _process_callback(), Extract numeric Telegram user IDs from a raw env value, tolerantly. Accepts…, Resolve the ALLOWED/ADMIN Telegram user-ID sets. ``TELEGRAM_CHAT_ID`` is the…, Parse callback_data of the form ``fb:<action>[:<arg>]`` (FreeBuff) or…, Accept / reject keyboard shown after a FreeBuff plan is generated., Handle an inline-button press for the FreeBuff accept/reject/model flow. (+27 more)
...
### Community 236 - "TestAuthAndTaskOwnership"
Cohesion: 0.05
...
### Community 243 - "test_crispy_workflow.py"
Cohesion: 0.08
...
### Community 244 - "test_response_cache.py"
Cohesion: 0.16
...
### Community 249 - "_build_coordinator"
Cohesion: 0.09
...
### Community 252 - "provider_max_rpm"
Cohesion: 0.07
...
### Community 253 - "test_agent_api.py"
Cohesion: 0.07
...
### Community 254 - "test_render_mcp.py"
Cohesion: 0.09
...
### Community 256 - "InternalAgentAdapter"
Cohesion: 0.07
...
### Community 261 - "agents/agile_ceremonies.py"
Cohesion: 0.08
...
### Community 264 - "test_background_services.py"
Cohesion: 0.08
...
### Community 265 - "test_brain_failover.py"
Cohesion: 0.10
...
### Community 268 - "test_persistent_memory.py"
Cohesion: 0.06
...
### Community 270 - "model_discovery.py"
Cohesion: 0.08
...
### Community 272 - "test_anthropic_router.py"
Cohesion: 0.09
...
### Community 277 - "report_to_markdown"
Cohesion: 0.11
...
### Community 280 - "clear_cooldowns"
Cohesion: 0.09
Nodes (26): clear_cooldowns(), is_provider_on_cooldown(), mark_provider_failed(), Put provider_id on cooldown for *cooldown_seconds* (default:…, Return True if provider_id is currently on cooldown., Clear all cooldown entries (useful for testing). Delegates to…, reset_cooldowns(), anyio (+18 more)
...
### Community 282 - "local_controller.py"
Cohesion: 0.12
...
### Community 286 - "call_llm"
Cohesion: 0.08
Nodes (31): agent/sam.py — SAM Voice Agent (System Autonomy Manager) SAM is the voice-…, _agent_timeout_fallback_response(), _build_provider_router(), call_llm(), _chat_error_detail_text(), _chat_provider_policy(), chat_send(), _compact_context() (+23 more)

### Community 287 - "SparkProvider"
Cohesion: 0.07
...
### Community 288 - "ResourceWatchdog"
Cohesion: 0.10
...
### Community 289 - "DashboardScreen.jsx"
Cohesion: 0.07
...
### Community 295 - "skill_bindings.py"
Cohesion: 0.09
...
### Community 296 - "test_sam_voice.py"
Cohesion: 0.07
...
### Community 300 - "Langfuse Observability Guide"
Cohesion: 0.06
...
### Community 305 - "test_workspace_isolation.py"
Cohesion: 0.16
...
### Community 306 - "test_direct_chat_evolution.py"
Cohesion: 0.11
...
### Community 313 - "test_failover_silent_exhaustion.py"
Cohesion: 0.11
...
### Community 314 - "test_mcp_governance.py"
Cohesion: 0.12
...
### Community 315 - "TaskHarnessAdapter"
Cohesion: 0.08
...
### Community 317 - "test_purge_backlog.py"
Cohesion: 0.09
...
### Community 321 - "output_filter.py"
Cohesion: 0.07
...
### Community 322 - "test_colibri_provider.py"
Cohesion: 0.12
...
### Community 328 - "test_telegram_mutating_commands.py"
Cohesion: 0.07
...
### Community 329 - "test_autonomy_gate.py"
Cohesion: 0.13
...
### Community 330 - "test_rag_context.py"
Cohesion: 0.12
...
### Community 331 - "ProjectScaffolder"
Cohesion: 0.13
...
### Community 334 - "test_llm_router_gateway.py"
Cohesion: 0.08
...
### Community 335 - "SteeringInjector"
Cohesion: 0.11
...
### Community 336 - "test_claude_setup_audit.py"
Cohesion: 0.16
...
### Community 337 - "CompanyAgencyService"
Cohesion: 0.09
...
### Community 342 - "Python Dependencies (`requirements.txt`)"
Cohesion: 0.07
...
### Community 343 - "Technical Debt Register — local-llm-server"
Cohesion: 0.07
...
### Community 353 - "Deploy: FreeBuff Telegram bot (24×7)"
Cohesion: 0.07
...
### Community 354 - "Claude Code + Qwen Local Setup"
Cohesion: 0.07
...
### Community 355 - "SetupWizardPage.js"
Cohesion: 0.11
...
### Community 358 - "test_chat_mode_regressions.py"
Cohesion: 0.13
...
### Community 371 - "LLM Router — troubleshooting"
Cohesion: 0.08
...
### Community 378 - "test_telegram_approval_e2e.py"
Cohesion: 0.12
...
### Community 379 - "test_provider_enable_disable.py"
Cohesion: 0.10
...
### Community 386 - "Session Handoff — 2026-06-15"
Cohesion: 0.08
...
### Community 387 - "TASK 4 — End-to-end approval-gate test"
Cohesion: 0.08
...
### Community 388 - "test_claude_code_adapter.py"
Cohesion: 0.14
...
### Community 394 - "test_service_token.py"
Cohesion: 0.08
...
### Community 400 - "Local AI Stack with Docker"
Cohesion: 0.08
...
### Community 401 - "Traffic Distribution Across Providers"
Cohesion: 0.08
...
### Community 402 - "Implementation Prompt: Rich TaskBoard + Agile Sprint Integration"
Cohesion: 0.08
...
### Community 403 - "Telegram Bot Setup"
Cohesion: 0.08
...
### Community 405 - "control_overrides.py"
Cohesion: 0.12
...
### Community 407 - "OrchestratorCheckpointStore"
Cohesion: 0.13
...
### Community 410 - "test_skill_registry.py"
Cohesion: 0.09
...
### Community 413 - "_status_snapshot"
Cohesion: 0.15
...
### Community 414 - "_resolve_user_github_token"
Cohesion: 0.16
...
### Community 415 - "Agent Governance Guide"
Cohesion: 0.09
...
### Community 416 - "The fifteen strategies"
Cohesion: 0.09
...
### Community 419 - "test_north_mini_code.py"
Cohesion: 0.09
...
### Community 439 - "_process_task_callback"
Cohesion: 0.18
...
### Community 440 - "test_portfolio_intelligence.py"
Cohesion: 0.10
...
### Community 443 - "CollaborationContext"
Cohesion: 0.11
...
### Community 444 - "_ensure_tasks_source_id_unique_index"
Cohesion: 0.14
...
### Community 446 - "V3 API Migration Plan — LLM Relay Platform"
Cohesion: 0.10
...
### Community 451 - "test_issue_triage.py"
Cohesion: 0.17
...
### Community 452 - "test_local_controller.py"
Cohesion: 0.17
...
### Community 453 - "run_trend_analysis"
Cohesion: 0.18
...
### Community 454 - "test_unit5_ui_provider_surface.py"
Cohesion: 0.10
...
### Community 461 - "render_router.py"
Cohesion: 0.13
...
### Community 469 - "FeatureUnavailableError"
Cohesion: 0.13
...
### Community 470 - "ControlsScreen.jsx"
Cohesion: 0.15
...
### Community 475 - "test_kimi_bridge_server.py"
Cohesion: 0.12
...
### Community 479 - "test_tasks_cache_ttl_env.py"
Cohesion: 0.21
...
### Community 480 - "test_voice_pipeline.py"
Cohesion: 0.14
...
### Community 483 - "_extract_tech_relevance"
Cohesion: 0.17
...
### Community 487 - "Analysis & Synthesis Instructions"
Cohesion: 0.11
Nodes (18): 1. Define the Atmosphere, 2. Map the Color Palette, 3. Establish Typography Rules, 4. Define the Hero Section, 5. Describe Component Stylings, 6. Define Layout Principles, 7. Define Responsive Rules, 8. Encode Motion Philosophy (+10 more)

### Community 488 - "Production Readiness Assessment — local-llm-server"
Cohesion: 0.11
...
### Community 495 - "ProviderConsole.jsx"
Cohesion: 0.11
...
### Community 501 - "TestRouterIntegration"
Cohesion: 0.18
...
### Community 502 - "test_task_source_id_race.py"
Cohesion: 0.17
...
### Community 503 - "test_brain_patch_service_token.py"
Cohesion: 0.18
...
### Community 504 - "TestSelfHealingInfrastructureClassification"
Cohesion: 0.19
...
### Community 505 - "test_fabric_patterns.py"
Cohesion: 0.11
...
### Community 506 - "test_schedule_persistence.py"
Cohesion: 0.15
...
### Community 510 - "Comprehensive Skill Index (By Category)"
Cohesion: 0.11
...
### Community 511 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 512 - "Component Map"
Cohesion: 0.11
...
### Community 513 - "Agent State — colibri GLM-5.2 deployment (resumable)"
Cohesion: 0.11
...
### Community 514 - "Architecture Overview — local-llm-server"
Cohesion: 0.11
...
### Community 515 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
...
### Community 517 - "Part A — Health Report"
Cohesion: 0.11
...
### Community 521 - "sync_readme_gallery.py"
Cohesion: 0.22
...
### Community 525 - "handle_workflow_ide_chat"
Cohesion: 0.18
...
### Community 537 - "kimi_bridge_provider_config"
Cohesion: 0.18
...
### Community 538 - "agent_readiness_audit.py"
Cohesion: 0.21
...
### Community 558 - "refresh_agent_built_proof.py"
Cohesion: 0.20
...
### Community 560 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 568 - "ManagedAgentDreams"
Cohesion: 0.22
...
### Community 571 - "test_dockerfile_ships_root_modules.py"
Cohesion: 0.17
...
### Community 573 - "test_glm52_brain.py"
Cohesion: 0.12
...
### Community 574 - "test_langfuse_agency_wide.py"
Cohesion: 0.12
...
### Community 575 - "test_llm_router_tpm.py"
Cohesion: 0.20
...
### Community 576 - "test_local_brain_state.py"
Cohesion: 0.12
...
### Community 579 - "test_phase5_doctor.py"
Cohesion: 0.12
...
### Community 580 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 581 - "test_refresh_agent_built_proof.py"
Cohesion: 0.12
...
### Community 595 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 596 - "Attention Mechanisms Internals"
Cohesion: 0.13
...
### Community 598 - "implement_agent.py"
Cohesion: 0.17
...
### Community 601 - "router/health.py"
Cohesion: 0.20
...
### Community 602 - "DockerAgentAdapter"
Cohesion: 0.17
...
### Community 603 - "AdminDigestRouterAuthTests"
Cohesion: 0.22
...
### Community 604 - "clear_wizard_state_cache"
Cohesion: 0.21
...
### Community 610 - "test_scanner_live.py"
Cohesion: 0.23
...
### Community 637 - "test_brain_failover_413.py"
Cohesion: 0.15
...
### Community 638 - "TestMCPToolsListCache"
Cohesion: 0.19
...
### Community 641 - "test_openclaw_gateway.py"
Cohesion: 0.14
...
### Community 642 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 648 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 651 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 652 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 655 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
...
### Community 656 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 657 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 659 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 661 - "admin_update_task_router.py"
Cohesion: 0.22
...
### Community 664 - "Skill: platform-setup — Autonomous Agency Bootstrap"
Cohesion: 0.15
...
### Community 665 - "Device compatibility and model picks"
Cohesion: 0.15
...
### Community 666 - "Autonomy Uplift — Living Roadmap & Detailed Implementation Specs"
Cohesion: 0.15
...
### Community 667 - "OpenClaw — iOS Control of the Agency (Single-Service Free-Tier Deploy)"
Cohesion: 0.15
...
### Community 671 - "_is_bedrock_model_id"
Cohesion: 0.27
...
### Community 672 - "verify_service_token"
Cohesion: 0.22
...
### Community 677 - "PageFetcher"
Cohesion: 0.08
Nodes (17): _count_syllables(), estimate_pixel_width(), flesch_reading_ease(), _host_key(), is_internal(), normalize_url(), AsyncBaseTransport, Fetch sitemap candidates (one index level deep) and collect page URLs. (+9 more)

### Community 678 - "_InMemoryBackend"
Cohesion: 0.18
...
### Community 679 - "TestModelCostTableUpdates"
Cohesion: 0.26
...
### Community 680 - "TestMCPClientStructuredOutput"
Cohesion: 0.31
...
### Community 681 - "TestDecisionsBotLinks"
Cohesion: 0.21
...
### Community 682 - "test_deploy_trigger_covers_image.py"
Cohesion: 0.21
...
### Community 683 - "TestRuntimeControl"
Cohesion: 0.15
...
### Community 686 - "WorkspaceManifest"
Cohesion: 0.17
...
### Community 687 - "skill_registry.py"
Cohesion: 0.17
...
### Community 694 - "Skill: system-prompt-audit"
Cohesion: 0.17
...
### Community 695 - "Skill: task-alive-updates"
Cohesion: 0.17
...
### Community 698 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 701 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 703 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 704 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 706 - "Quantization Internals"
Cohesion: 0.17
...
### Community 707 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 708 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 709 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 711 - "check_container_posture.py"
Cohesion: 0.26
...
### Community 712 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 714 - "test_admin_local_brain_router.py"
Cohesion: 0.29
...
### Community 715 - "test_agile_api.py"
Cohesion: 0.17
...
### Community 716 - "test_app_settings.py"
Cohesion: 0.21
...
### Community 718 - "TestAnthropicToolListCaching"
Cohesion: 0.34
...
### Community 720 - "test_task_clarification.py"
Cohesion: 0.17
...
### Community 726 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 729 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 730 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 732 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 735 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 736 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 737 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 738 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 739 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 740 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 741 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 742 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 744 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 745 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 746 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 747 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 748 - "What to clean up"
Cohesion: 0.18
...
### Community 749 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 752 - "test_bedrock_live.py"
Cohesion: 0.25
...
### Community 753 - "TestWorkflowIntegration"
Cohesion: 0.33
...
### Community 754 - "has_image_content"
Cohesion: 0.31
...
### Community 761 - "mint_access_token"
Cohesion: 0.18
...
### Community 767 - "._check_permissions"
Cohesion: 0.29
...
### Community 783 - "_fake_fetch_module"
Cohesion: 0.36
...
### Community 787 - "TestZeroAttemptDiagnostics"
Cohesion: 0.29
...
### Community 788 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 796 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 798 - "Skill: changelog-enforcer"
Cohesion: 0.22
...
### Community 799 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 801 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 802 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 804 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
Nodes (8): Branch, Components, Purpose, Quick Start, Session Roles, Skill: cowork-session (Claude Cowork), Testing, When to Use

### Community 805 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 806 - "Active Task Tracker"
Cohesion: 0.22
...
### Community 808 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 809 - "Main proxy (`proxy.py`)"
Cohesion: 0.22
...
### Community 810 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 811 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 812 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 813 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 814 - "Platform Controls"
Cohesion: 0.22
...
### Community 815 - "Release Procedure"
Cohesion: 0.22
...
### Community 816 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 824 - "enrich_quick_note_issues.py"
Cohesion: 0.42
...
### Community 827 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 829 - "test_changelog_parity_guard.py"
Cohesion: 0.22
...
### Community 831 - "TestGithubSignalHardening"
Cohesion: 0.22
...
### Community 832 - "test_scanner_deps_parity.py"
Cohesion: 0.31
...
### Community 836 - "agent/output_filter.py"
Cohesion: 0.32
...
### Community 840 - "quality_checker.py"
Cohesion: 0.32
...
### Community 842 - "_InMemoryErrorLogHandler"
Cohesion: 0.25
Nodes (6): clear_error_log_buffer(), _ensure_error_log_capture(), _InMemoryErrorLogHandler, LogRecord, _auth_headers(), test_activity_endpoint_includes_recent_error_logs()

### Community 843 - "Agent: Implementer (Executor)"
Cohesion: 0.25
Nodes (8): Activation, Agent: Implementer (Executor), Constraints, Handoff, Preferred Model, Responsibilities, Role, Shared State

### Community 844 - "Agent: Judge (Release / QA Gate)"
Cohesion: 0.25
Nodes (7): Activation, Agent: Judge (Release / QA Gate), Enforcement, Output, Responsibilities, Role, Verdict Meanings

### Community 845 - "Agent: Planner (Architect)"
Cohesion: 0.25
Nodes (8): Activation, Agent: Planner (Architect), Failure Behaviour, Handoff, Output Format, Preferred Model, Responsibilities, Role

### Community 846 - "Skill: browserbase-browser — Real Browser Automation"
Cohesion: 0.25
...
### Community 853 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 857 - "Free NVIDIA brain + UI-controlled provider policy + no silent spend"
Cohesion: 0.25
...
### Community 858 - "Issue #362: Nvidia repo setup"
Cohesion: 0.25
...
### Community 859 - "Issue #364: quick-note:https://www.marktechpost.com/2026/06/01/meet-memory-os-a-6-layer-open-source-memory-stack-built-on-top-of-hermes-agent/"
Cohesion: 0.25
...
### Community 860 - "Issue #378: quick-note:https://www.marktechpost.com/2026/06/02/tinyfish-launches-bigset-an-open-source-multi-agent-system-that-builds-structured-live-datasets-from-plain-english-descriptions/"
Cohesion: 0.25
...
### Community 861 - "Issue #379: quick-note:https://searchengineland.com/schema-markup-optimize-agentic-web-479080"
Cohesion: 0.25
...
### Community 862 - "Issue #380: quick-note:https://cursor.com/blog/cloud-agent-lessons"
Cohesion: 0.25
...
### Community 863 - "Issue #381: quick-note:https://www.xda-developers.com/claude-code-with-opus-48-is-expensive-but-i-made-it-efficient-with-my-local-ai-workflow/"
Cohesion: 0.25
...
### Community 864 - "Issue #382: quick-note:https://claude.com/blog/how-coderabbit-used-claude-to-build-an-agent-orchestration-system"
Cohesion: 0.25
...
### Community 865 - "Issue #383: quick-note:https://www.marktechpost.com/2026/05/29/hexo-labs-open-sources-sia-a-self-improving-agent-that-updates-both-the-harness-and-the-model-weights/"
Cohesion: 0.25
...
### Community 866 - "Issue #416: feat: Self-hosted Codebuff (freebuff) on free NVIDIA models + Telegram bot phone control"
Cohesion: 0.25
...
### Community 867 - "Issue #485: [Trend Digest] Week of 2026-06-08"
Cohesion: 0.25
...
### Community 868 - "Issue #488: quick-note:https://github.com/cookiy-ai/user-research-skill"
Cohesion: 0.25
...
### Community 869 - "Issue #491: Implement whatever is necessary from https://github.com/BehiSecc/awesome-claude-skills"
Cohesion: 0.25
...
### Community 870 - "Issue #493: Use the https://github.com/mvanhorn/last30days-skill skill to get the trend updated"
Cohesion: 0.25
...
### Community 871 - "Issue #495: Read https://www.anthropic.com/news/claude-fable-5-mythos-5 and understand if mythos or fable can be added to the repo"
Cohesion: 0.25
...
### Community 872 - "Issue #504: EPIC: Autonomy hardening — live-verified defects 2026-06-10"
Cohesion: 0.25
...
### Community 873 - "Issue #581: Sprint tracker: pending work after brand rename + mobile-first pass"
Cohesion: 0.25
...
### Community 875 - "Issue #657: quick-note:https://github.com/earendil-works/pi"
Cohesion: 0.25
...
### Community 876 - "Issue #659: quick-note:https://github.com/nex-agi/Nex-N2"
Cohesion: 0.25
...
### Community 877 - "Issue #660: quick-note:https://github.com/getsentry/sentry-for-ai"
Cohesion: 0.25
...
### Community 878 - "Issue #661: quick-note:https://github.com/XiaomiMiMo/MiMo-Code"
Cohesion: 0.25
...
### Community 879 - "Issue #664: quick-note:https://github.com/Grominet95/jarvis-OS"
Cohesion: 0.25
...
### Community 880 - "Issue #666: quick-note:https://github.com/porokka/jarvis-os"
Cohesion: 0.25
...
### Community 881 - "Issue #670: quick-note:https://github.com/perplexityai/bumblebee"
Cohesion: 0.25
...
### Community 882 - "Issue #672: quick-note:https://github.com/Chachamaru127/claude-code-harness"
Cohesion: 0.25
...
### Community 883 - "Issue #676: quick-note:https://github.com/WeiboAI/VibeThinker"
Cohesion: 0.25
...
### Community 884 - "Issue #820: quick-note:https://github.com/cobusgreyling/loop-engineering"
Cohesion: 0.25
...
### Community 885 - "Positional Encoding Internals"
Cohesion: 0.25
...
### Community 886 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 887 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 888 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 889 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 890 - "Continual Harness (`agent/harness_spec.py`)"
Cohesion: 0.25
...
### Community 891 - "Prime Agent Runtime"
Cohesion: 0.25
...
### Community 892 - "PULL_REQUEST_TEMPLATE.md"
Cohesion: 0.25
...
### Community 894 - "capture_screens.py"
Cohesion: 0.39
...
### Community 899 - "test_compose_and_coordinate_api.py"
Cohesion: 0.36
...
### Community 900 - "test_generate_context_standing_instructions.py"
Cohesion: 0.32
...
### Community 906 - "test_provider_models_db_outage.py"
Cohesion: 0.25
...
### Community 907 - "test_runtimes_health_endpoint.py"
Cohesion: 0.25
...
### Community 908 - "test_seo_audit_pending_expiry.py"
Cohesion: 0.43
...
### Community 910 - "test_serve_spa_prefixes.py"
Cohesion: 0.36
...
### Community 911 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.25
...
### Community 940 - "security_fix_agent.py"
Cohesion: 0.57
...
### Community 950 - "test_daily_2026_06_14.py"
Cohesion: 0.38
...
### Community 951 - "TestSupportMatrixDocsSync"
Cohesion: 0.29
...
### Community 952 - "test_doctor_coding_brain.py"
Cohesion: 0.38
...
### Community 953 - "TestGithubTokenSQLiteRegression"
Cohesion: 0.38
...
### Community 954 - "test_log_monitor_storm_guard.py"
Cohesion: 0.48
...
### Community 955 - "TestReasonsAreActionable"
Cohesion: 0.29
...
### Community 956 - "TestProvidersScreen"
Cohesion: 0.43
...
### Community 957 - "test_telegram_observe.py"
Cohesion: 0.48
...
### Community 974 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 975 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 976 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 977 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 978 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 979 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 983 - "apply_phase1_changes.py"
Cohesion: 0.33
...
### Community 1012 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 1013 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 1023 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1024 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1025 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 1026 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 1027 - "setup_colibri.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1028 - "setup_colibri.sh script"
Cohesion: 0.70
Nodes (4): setup_colibri.sh script, fail(), ok(), warn()

### Community 1029 - "status_colibri_server.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1030 - "._resolve_merge_decision"
Cohesion: 0.40
...
### Community 1034 - "test_agent_runtime_wrapper.py"
Cohesion: 0.70
...
### Community 1038 - "verify_pr_exists"
Cohesion: 0.50
...
### Community 1063 - "test_no_exception_detail_leaks.py"
Cohesion: 0.50
...
### Community 1064 - "test_skills_route_order.py"
Cohesion: 0.67
...
### Community 1065 - "github"
Cohesion: 0.50
Nodes (3): github, enabled, silent

### Community 1090 - "test_the_reserve_is_bounded_when_read_from_the_environment"
Cohesion: 0.67
...
### Community 1193 - "_clean_director"
Cohesion: 0.50
...
- **Why does `_fixture()` connect `_fixture` to `TaskStore`, `test_llm_router_strategies.py`, `test_operational_incidents.py`, `Task`, `test_company_api.py`, `ImprovementLoop`, `TaskWorkflowService`, `E2BSandboxSession`, `SelfHealingAgent`, `models/company_graph.py`, `AgentRunner`, `services/background.py`, `PolicyEngine`, `test_failover_client_shared.py`, `test_monitor_lib.py`, `test_openclaw_endpoints.py`, `test_task_service_failed_comment.py`, `test_unit8_model_catalog.py`, `sam`, `PrimeAgentAdapter`, `ProviderConfig`, `test_model_router.py`, `NotificationDispatcher`, `test_agent_tool_governance.py`, `ExecutionRequest`, `KeyPool`, `UserRole`, `TokenBudget`, `SQLiteStore`, `AgentJobManager`, `test_telegram_auto_approve.py`, `test_autonomy_status.py`, `BrainConfig`, `test_llm_router_tpm.py`, `test_local_brain_state.py`, `TestChatHistoryStore`, `test_phase5_doctor.py`, `test_llm_router_resilience.py`, `test_refresh_agent_built_proof.py`, `test_telegram_diag_endpoint.py`, `test_webui_provider_priority.py`, `ResearchTask`, `claim`, `config.py`, `TestClient`, `test_ai_insights.py`, `test_startup_warmup.py`, `test_procedural_memory.py`, `BackgroundAgent`, `AgentProfile`, `get_scheduler`, `ArtifactStore`, `e2e/test_browser.py`, `brain_failover.py`, `SeoFixRequest`, `test_knowledge_sync.py`, `enforcement.py`, `facade.py`, `test_brain_failover_413.py`, `TestHarnessAdapter`, `test_context_rulebook.py`, `KeyStore`, `test_openclaw_gateway.py`, `run_task`, `test_provider_state_durability.py`, `FeatureMaturity`, `test_new_features_e2e.py`, `_StubProvider`, `ChatHistoryStore`, `_Budget`, `CEOLedger`, `MCPClient`, `persist_plan_spec`, `TestEstimateTokensForMessages`, `_clean_director`, `test_daily_2026_07_27.py`, `TestRuntimeControl`, `test_task_brain_preflight.py`, `BrainWatchdog`, `OllamaCircuitBreaker`, `test_ceo_router.py`, `SeoAuditEngine`, `test_features_api.py`, `test_video_transcript.py`, `TrendWatcher`, `emit_chat_observation`, `test_agile_api.py`, `test_app_settings.py`, `SchedulerStore`, `test_task_clarification.py`, `cache.py`, `test_portfolio_intake.py`, `test_e2b_data_flow.py`, `test_iteration_6_features.py`, `test_trend_watcher.py`, `ai/router.py`, `TestAuthAndTaskOwnership`, `TestClient`, `ContextPruner`, `._check_permissions`, `test_brain_failover.py`, `WorkflowBuildRequest`, `test_persistent_memory.py`, `SecurityScanner`, `test_llm_router_e2e.py`, `OutputFilter`, `clear_cooldowns`, `test_platform_controls.py`, `test_rate_limiter.py`, `test_sam_voice.py`, `OrchestratorQueue`, `test_direct_chat_evolution.py`, `TestNormalizeResponseFormat`, `_start_ceo_agency`, `TestSwarmRoleRouting`, `session_retro.py`, `test_purge_backlog.py`, `analyze_page`, `WorkflowRun`, `test_telegram_mutating_commands.py`, `timedelta`, `test_llm_router_gateway.py`, `test_crispy_burn_in.py`, `test_skill_registry_boot_refresh.py`, `isolated_telegram_config`, `test_scheduler_hydration_bounded.py`, `test_provider_enable_disable.py`, `test_claude_code_adapter.py`, `TestHarnessRegistry`, `_get`, `test_ping.py`, `test_service_token.py`, `test_runtimes_health_endpoint.py`, `test_harness_spec.py`, `test_task_store_fails_loud_in_production.py`, `test_regression.py`, `test_agency_fix.py`, `_resolve_user_github_token`, `test_v4_api.py`, `client`, `get_ceo_dispatcher`, `test_doctor_coding_brain.py`, `cost_tracker.py`, `allow_paid`, `test_kimi_bridge_server.py`, `test_voice_pipeline.py`, `clear_override`, `test_dashboard_cache.py`, `parse_event_stream`, `TestRouterIntegration`, `test_brain_patch_service_token.py`?**
  _High betweenness centrality (0.093) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `InternalAgentAdapter`, `GitHubTools`, `proxy.py`, `TaskSpec`, `TestAgentLoopMCPIntegration`, `test_backend_server_features.py`, `test_governance_api.py`, `ImprovementLoop`, `E2BSandboxSession`, `ReactScratchpad`, `test_failover_client_shared.py`, `ContextManager`, `loop.py`, `MCPClient`, `MultiAgentSwarm`, `LocalWorkspace`, `test_agent_tool_governance.py`, `ExecutionRequest`, `TokenBudget`, `StuckDetector`, `workflow_orchestrator.py`, `get_ceo_dispatcher`, `WorkspaceTools`, `AgentJobManager`, `direct_chat.py`, `E2BAdapter`, `test_agent_free_brain.py`, `AgentPlan`, `.execute`, `BackgroundAgent`, `FreeBuffAgent`, `UserMemoryStore`, `CEODispatcher`, `AdaptiveHalter`, `test_empirical_verify.py`, `agency.py`, `AgentSessionStore`, `ContextPruner`, `test_brain_failover_413.py`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderRouter` to `backend/server.py`, `test_all_providers_discovery.py`, `model_discovery.py`, `test_anthropic_router.py`, `TestAnthropicPayloadStructuredOutput`, `clear_cooldowns`, `kimi_bridge_provider_config`, `call_llm`, `resolve_active_brain`, `ProviderConfig`, `direct_chat.py`, `TestOpenAiToBedrockConverse`, `settings.py`, `test_colibri_provider.py`, `failover_client.py`, `test_bedrock_provider.py`, `TrafficDirector`, `test_chat_mode_regressions.py`, `ai/router.py`, `test_bedrock_live.py`, `system_instruction`, `NvidiaProvider`, `TestRouterIntegration`?**
...
- **Should `backend/server.py` be split into smaller, more focused modules?**
  _Cohesion score 0.017407938785270204 - nodes in this community are weakly interconnected._