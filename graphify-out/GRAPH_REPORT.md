# Graph Report - autonomous-ai-agency  (2026-09-11)

## Corpus Check
- 1505 files · ~2,181,585 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 30508 nodes · 56973 edges · 1297 communities (1136 shown, 113 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 3339 edges (avg confidence: 0.92)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `72b79565`
...
## Communities (1297 total, 113 thin omitted)

### Community 0 - "call_llm"
Cohesion: 0.05
Nodes (39): _agent_provider_failure_response(), _agent_timeout_fallback_response(), _append_agent_session_message(), _build_auto_skill_guidance(), _build_provider_router(), _builtin_provider_records(), call_llm(), _chat_provider_policy() (+31 more)

### Community 1 - "company_api.py"
Cohesion: 0.02
Nodes (157): Reject non-admin callers for routes that spend provider budget. Delegates to…, _require_admin(), account_lifecycle(), AccountLifecycleResponse, auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint() (+149 more)
...
Cohesion: 0.02
Nodes (114): app_client(), _clear_discovered_models(), _clear_response_cache(), client(), _isolate_brain_data_layer(), _isolate_operator_provider_state(), non_admin_client(), MonkeyPatch (+106 more)
...
Cohesion: 0.03
Nodes (124): kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, AiderAdapter, Any, TaskResult, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Run aider non-interactively via `--message` flag., Adapter for Aider — TIER 3 specialized git-aware code editor. (+116 more)

### Community 6 - "proxy.py"
Cohesion: 0.03
Nodes (164): get_skill_registry_safe(), Return the global SkillRegistry if set, else None. Used by onboarding and other…, middleware, admin_control(), admin_create_key(), admin_create_user(), admin_list_users(), admin_login() (+156 more)

### Community 7 - "llm/router.py"
Cohesion: 0.05
Nodes (76): _load(), main(), Scheduled portfolio intelligence sweep. Run by `.github/workflows/portfolio-…, int, get_budget(), The process-wide budget tracker., get_cache(), packages/llm/cache.py — layered caching. Five independent layers, each with its… (+68 more)
...
### Community 9 - "TaskStatus"
Cohesion: 0.04
Nodes (73): AgentDefinition, AgentStore, Any, field_validator, agents/store.py — Persistent store for user-defined agent configurations.…, CRUD store for AgentDefinition objects. Uses MongoDB when a `db` client is…, Return an agent by ID. If *owner_id* is provided, enforces that the agent…, Delete an agent. Returns True on success, False if not found/unauthorised. (+65 more)

### Community 10 - "backend/server.py"
Cohesion: 0.02
Nodes (301): admin_seed(), AgentStatusEntry, AgentStatusResponse, AgentToolCallEntry, ApiKeyCreate, auth_me(), AuthorizeReposBody, auto_recommend_skills() (+293 more)
...
Cohesion: 0.02
Nodes (112): AlertHandler, BudgetTracker, Counter, _Dimensions, _month(), Any, packages/llm/budget.py — token and cost accounting with spend alerts. Tracks…, Register a callback fired when a spend threshold is crossed. (+104 more)

### Community 13 - "CompanyGraphService"
Cohesion: 0.03
Nodes (59): OnboardingProgress, Get the index of a phase in the workflow., Tracks the onboarding progress for a company., A company website with detected systems and stack inference., A workflow that defines a sequence of phases for completing tasks., Website, Workflow, get_company_agency_service() (+51 more)
...
### Community 15 - "test_governance_enforcement.py"
Cohesion: 0.05
...
Cohesion: 0.03
Nodes (94): _decompose_into_subtasks(), _merge_changed_files(), Decompose a request into 2-3 sub-tasks for specialist fan-out. Default…, Collect changed_files across all specialists into a single de-duped list., ClassifyOutput, get_ceo_fallback_stats(), PlanOutput, BaseModel (+86 more)
...
Cohesion: 0.11
Nodes (20): Produce a human-readable summary with evidence., In-flight state for a single golden-path execution., WorkflowRun, tests/test_orchestrator_checkpoint.py — Tests for durable checkpointing (#522)., Save, load, list, delete, and restore operations., TestOrchestratorCheckpointStore, _company(), _FakeStore (+12 more)

### Community 19 - "SelfHealingAgent"
Cohesion: 0.04
Nodes (75): FailureCategory, heal_signature(), HealingEvent, HealState, _now(), Any, Enum, str (+67 more)

### Community 20 - "ProviderRouter"
Cohesion: 0.07
Nodes (34): _acquire_provider_probe(), _dead_model_key(), _exponential_backoff_cooldown(), _get_director(), is_commercial_provider(), _mark_model_dead(), _normalized_provider_type(), _notify_watchdog() (+26 more)

### Community 21 - "LLMRequest"
Cohesion: 0.03
Nodes (109): ProviderConfig, One configured endpoint. ``kind`` selects the adapter: ``openai`` (any OpenAI-…, OpenAICompatible, Adapter for any endpoint speaking the OpenAI chat-completions shape. Adding a…, build_provider(), Normalise a configured ``kind`` to an adapter key., Instantiate the adapter for one provider config. Unknown kinds fall back to the…, resolve_kind() (+101 more)

### Community 22 - "test_agent_tool_governance.py"
Cohesion: 0.08
Nodes (40): _drive(), governance_on(), _observations(), Any, MonkeyPatch, Path, The executor loop must not have a side door around the governance gate.…, Governance must not silently swallow the calls it permits. (+32 more)
...
### Community 24 - "test_memory_guard.py"
Cohesion: 0.13
...
### Community 26 - "TaskStore"
Cohesion: 0.04
Nodes (67): Any, Fail loud in production if no persistent storage is configured. Telegram…, Create a task. Deduplicates by source_id if set (Charter G3). If a task with…, Fetch a task by ID. If owner_id is set, enforces ownership., Return the task previously created for an external ``source_id`` (e.g.…, List tasks for a specific user with optional filters. ``include_system``…, Admin-only: list all tasks across all users. ``include_log`` mirrors…, Return tasks queued for agent execution, highest-priority first. Ordered by… (+59 more)

### Community 27 - "BrainWatchdog"
Cohesion: 0.05
...
### Community 29 - "get_tool_registry"
Cohesion: 0.14
...
### Community 30 - "WorkflowOrchestrator"
Cohesion: 0.03
...
Cohesion: 0.04
Nodes (88): Charge sub-agent nesting depth and enforce the ``max_depth`` ceiling. Isolates…, _egress_policy_reason(), agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Return why governance policy blocks *host*, or None. Runs strictly *after* the…, guard(), _load(), mcp_server/governance.py — governance adapter for the MCP HTTP surface. Closes…, Evaluate *tool* before it runs. Returns ``(allowed, message, decision)``.… (+80 more)

### Community 32 - "LLMProvider"
Cohesion: 0.05
Nodes (42): packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, classify_error(), LLMProvider, ABC, Any, AsyncClient, packages/llm/providers/base.py — the provider contract and the generic adapter.…, Parse ``Retry-After`` (and common vendor variants) into seconds. (+34 more)

### Community 33 - "Agency"
Cohesion: 0.06
Nodes (39): Agency, AgencyCycleResult, AgentDirective, _build_ceo_prompt(), _build_quick_note_instruction(), _close_github_issue(), _collect_recent_git_context(), _fetch_github_quick_notes() (+31 more)

### Community 34 - "ImprovementLoop"
Cohesion: 0.04
Nodes (89): AgentRole, _parse_ceo_directives(), str, DetectedIssue, get_improvement_loop(), ImprovementLoop, ImprovementLoopState, IssueCategory (+81 more)

### Community 35 - "SeoAuditEngine"
Cohesion: 0.04
...
### Community 36 - "Task"
Cohesion: 0.03
Nodes (80): Task, Background dispatcher for task execution., Full task/issue document., Task, _gate_outward_facing_enabled(), _is_brain_connection_error(), _is_outward_facing(), Any (+72 more)

### Community 37 - "test_unit8_model_catalog.py"
Cohesion: 0.02
Nodes (110): _brain_provider_status(), Return per-provider metadata for the GET endpoint. Iterates every provider in…, all_provider_ids(), _provider_ids_from_literal(), provider_key_present(), Resolve the model id for a component's role on a provider. Parameters…, Convenience: resolve all four role models for a component. Returns a dict with…, Return every provider id recognised by the brain config system. Iterates the… (+102 more)

### Community 38 - "AnthropicProvider"
Cohesion: 0.04
...
### Community 39 - "AgentSessionStore"
Cohesion: 0.03
Nodes (105): PreflightIssue, PreflightReport, BaseModel, Agent subsystem — planner / executor / verifier loop., AgentJob, AgentJobManager, make_isolated_workspace(), _now() (+97 more)
...
Cohesion: 0.06
Nodes (64): DirectChatDoctor, Any, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, Translate technical preflight issues into a conversational assistant reply., translate_error_to_conversational(), AcceptedJob, AgentJobEnvelope, CompletedJob (+56 more)
...
Cohesion: 0.05
Nodes (36): _accumulate_usage(), _assistant_messages(), _child_env(), _kill_and_reap(), _message_text(), PrimeAgentAdapter, Any, Terminate a subprocess and wait for it, ignoring races. ``asyncio.wait_for``… (+28 more)
...
### Community 50 - "test_ceo_router.py"
Cohesion: 0.08
...
### Community 52 - "CompanyAgencyService"
Cohesion: 0.09
...
### Community 53 - "brain_config.py"
Cohesion: 0.03
Nodes (114): _active_primary_provider(), BrainConfig, BrainConfigPatch, BrainConfigStore, default_brain_config(), get_brain_config(), get_brain_config_store(), invalidate_brain_config_cache() (+106 more)
...
### Community 57 - "seo_portfolio_bridge.py"
Cohesion: 0.05
...
### Community 60 - "test_user_research_skill.py"
Cohesion: 0.06
...
### Community 62 - "test_sam_livekit.py"
Cohesion: 0.04
Nodes (62): Report whether the SAM realtime voice (LiveKit) transport is configured., sam_livekit_status_backend(), _normalize_dockerfile(), parametrize, tests/test_sam_livekit.py — SAM realtime voice (LiveKit) integration. Covers: -…, Empty key/secret/identity/room must raise ValueError., SAM_LLM_* env vars must override the NVIDIA defaults (Hermes/proxy routing)., Under TESTING the in-process worker must never be eligible to start. (+54 more)
...
### Community 65 - "CompanyGraphStore"
Cohesion: 0.03
...
Cohesion: 0.05
Nodes (53): main(), Post-deploy verification for the website scanner against the LIVE internet.…, Returns (url, ok, summary)., _scan_one(), _is_safe_url(), _looks_like_bot_challenge(), BeautifulSoup, True if the HTML is an anti-bot/CAPTCHA interstitial rather than content. Used… (+45 more)
...
### Community 69 - "test_runtime_governance.py"
Cohesion: 0.12
Nodes (40): _governance_check(), _governance_identity(), Evaluate a runtime dispatch against policy; audit it either way. Returns…, Resolve the acting identity for a runtime dispatch. Identity comes from…, _decision(), _engine(), Any, RoutingDecision (+32 more)
...
### Community 77 - "test_self_heal_v2.py"
Cohesion: 0.07
Nodes (55): Reset the singleton (for tests)., reset_failover_manager(), _blocked_retire_age_sec(), _heal_blocked_backlog(), _heal_brain_failover(), _heal_purge_backlog(), _heal_stuck_tasks(), _heal_task_duplicates() (+47 more)

### Community 78 - "RenderOpsMonitor"
Cohesion: 0.06
...
### Community 89 - "resolve_e2b_config"
Cohesion: 0.05
...
### Community 91 - "resolve_active_brain"
Cohesion: 0.06
...
### Community 94 - "test_startup_warmup.py"
Cohesion: 0.05
...
### Community 97 - "ProbeResult"
Cohesion: 0.05
Nodes (56): provider_api_key(), Return the live API key for *provider* (env-only — never persisted)., _describe_http_status(), probe_model_liveness(), _probe_ollama(), _probe_openai_compat(), ProbeResult, BaseModel (+48 more)

### Community 98 - "Artifact"
Cohesion: 0.10
...
### Community 106 - "Company"
Cohesion: 0.06
Nodes (18): Company, Any, field_validator, The core company entity - root of the Company Graph., Coerce unrecognised system_type values to 'custom' so the model never crashes…, Get a company by ID. Args: company_id: Company ID Returns: Company instance or…, Update a company. Args: company_id: Company ID **kwargs: Fields to update…, List companies with optional filtering. Args: owner_id: Filter by owner ID… (+10 more)

### Community 107 - "AgentScheduler"
Cohesion: 0.07
Nodes (34): AgentScheduler, _now(), Any, Reconstruct a ScheduledJob from its as_dict() output., Register, list, trigger, and delete cron-scheduled agent jobs. Usage:: sched =…, Register a new job. Returns the created :class:`ScheduledJob`.…, Fire a job immediately (webhook / manual trigger)., Remove a job. Returns *True* if it existed. (+26 more)

### Community 108 - "ai_runner.py"
Cohesion: 0.07
...
Cohesion: 0.05
Nodes (49): extract_openai_text(), _normalize_nvidia_base_url(), _openai_url(), Normalize NVIDIA base URLs to avoid double /v1 when openai_compat_url appends…, _nvidia_provider_chain(), ProviderConfig, Build Nvidia NIM provider config from env. Empty list when key is absent., _clear_probe_locks() (+41 more)

### Community 114 - "test_llm_router_tpm.py"
Cohesion: 0.07
...
Cohesion: 0.06
Nodes (34): Attempt, Catalog entries for router-configured providers missing from the YAML. Never…, Read the environment variables named in ``env_names`` into a key list. Order is…, resolve_keys(), LLMRouter, Any, AsyncClient, BaseException (+26 more)
...
### Community 122 - "portfolio_intelligence.py"
Cohesion: 0.07
...
### Community 126 - "SQLiteStore"
Cohesion: 0.03
Nodes (52): Create a new company in SQLite., Update a company in SQLite., Delete a company and all associated data from SQLite., List companies from SQLite., Count total companies in SQLite., Reconstruct a Website from a SQLite row, preferring the full JSON blob (which…, Create a new website in SQLite. The full model is stored in ``data`` so scan…, Get a website by ID from SQLite. (+44 more)

### Community 127 - "ArtifactStore"
Cohesion: 0.07
...
### Community 129 - "test_web_reach.py"
Cohesion: 0.09
Nodes (39): _load_script_module(), Any, ModuleType, Dynamically load a pure-stdlib helper module from .github/scripts/. Returns…, Zero-key internet access: pages, YouTube transcripts, search, RSS. Every public…, Read a web page as plain text, following the same fallback chain (direct ->…, GET *url*, re-validating every redirect hop against ``unsafe_target_reason`` —…, httpx-only fallback used when the .github/scripts helpers can't be loaded (e.g.… (+31 more)

### Community 130 - "frontend/package.json"
Cohesion: 0.04
...
### Community 132 - "failover_client.py"
Cohesion: 0.04
Nodes (71): Return the discovered model list for *provider_id*, or ``[]`` if unknown., _served_models(), _auto_disable(), _describe_registry(), _disable_unless_key_serves_other_models(), _disabled_ids(), FailoverResult, _is_billing_refusal() (+63 more)
...
### Community 134 - "RuntimeHealthService"
Cohesion: 0.10
...
### Community 138 - "RepowiseIntelligence"
Cohesion: 0.06
...
### Community 151 - "test_north_mini_code.py"
Cohesion: 0.06
...
### Community 155 - "test_governance_api.py"
Cohesion: 0.07
...
### Community 156 - "test_google_provider_models.py"
Cohesion: 0.18
...
### Community 157 - "RuntimeCapabilityRegistry"
Cohesion: 0.04
Nodes (36): Any, Return health status for all registered runtimes., Return routing decision audit log (newest first)., Actively wake every sleeping/circuit-open runtime. The default health service…, True if the runtime is healthy enough for the router to select it., Return cached health snapshot for a runtime (sync, non-blocking)., Return all registered runtimes with their cached health status., Return the active routing policy as a plain dict. (+28 more)
...
### Community 160 - "PortfolioManager"
Cohesion: 0.05
...
### Community 166 - "TestEstimateTokensForMessages"
Cohesion: 0.05
...
### Community 169 - "PatternConsolidation"
Cohesion: 0.06
...
### Community 172 - "activation_api.py"
Cohesion: 0.09
...
### Community 173 - "test_daily_2026_07_27.py"
Cohesion: 0.07
...
### Community 176 - "get_failover_manager"
Cohesion: 0.07
...
### Community 185 - "test_process_quick_note_workflow.py"
Cohesion: 0.05
...
### Community 188 - "enforcement.py"
Cohesion: 0.06
Nodes (43): events_from_identity(), Convenience: build and record an event in one call., Extract the identity-derived audit fields from an AgentIdentity. Kept here…, record_event(), BudgetExceeded, classify(), evaluate_call(), guard_tool_call() (+35 more)

### Community 189 - "OllamaCircuitBreaker"
Cohesion: 0.08
...
### Community 196 - "_get_provider_policy"
Cohesion: 0.07
...
### Community 200 - "ProvidersScreen.jsx"
Cohesion: 0.06
...
### Community 205 - "portfolio_api.py"
Cohesion: 0.08
...
### Community 207 - "report_to_markdown"
Cohesion: 0.10
...
### Community 210 - "TaskDispatcher"
Cohesion: 0.07
Nodes (26): Re-queue BLOCKED tasks that have cooled down and are ready for retry., Polls for queued task work and executes it through the coordinator. Crash…, Re-queue tasks stranded by a prior crash or hard-kill., TaskDispatcher, _make_task(), asyncio, Task, tests/test_dispatcher_iso8601.py — regression test for the TaskDispatcher auto-… (+18 more)

### Community 211 - "TestRecordUsageAndStats"
Cohesion: 0.06
Nodes (8): Tests for packages/ai/cost_tracker.py — per-model cost attribution. Covers: -…, A repeated key in a dict literal is silent: the later value wins. Found on…, TestClearStats, TestCostForTokens, TestEnvOverrides, TestGetCostTable, TestRecordUsageAndStats, TestTheCostTableHasNoDuplicateKeys
...
### Community 213 - "chat_handlers.py"
Cohesion: 0.11
...
### Community 217 - "WorkspaceManifest"
Cohesion: 0.08
...
### Community 225 - "delegate_seo_findings"
Cohesion: 0.10
...
### Community 227 - "emit_chat_observation"
Cohesion: 0.09
...
### Community 228 - "configuration-reference.md"
Cohesion: 0.08
...
### Community 234 - "TemporalContextGraph"
Cohesion: 0.10
...
### Community 236 - "skill_bindings.py"
Cohesion: 0.04
...
### Community 237 - "test_slop_gate.py"
Cohesion: 0.07
...
### Community 238 - "TestRuntimeControl"
Cohesion: 0.15
...
### Community 242 - "test_portfolio_intelligence.py"
Cohesion: 0.10
...
### Community 252 - "test_provider_render_env.py"
Cohesion: 0.09
...
### Community 253 - "TestAuthAndTaskOwnership"
Cohesion: 0.06
...
### Community 262 - "nvidia_models.py"
Cohesion: 0.07
...
### Community 269 - "settings.py"
Cohesion: 0.06
Nodes (30): CerebrasProvider, Cerebras provider adapter — free, fast LLM (qwen-3-coder-480b)., GroqProvider, Groq provider adapter — free, fast LLM (deepseek-r1-distill-llama-70b)., NVIDIA NIM provider adapter — wraps the existing provider_router logic. This is…, Ollama provider adapter — local LLM inference., packages.ai — provider abstraction, model registry, and failover manager., packages/ai/manager.py — ProviderManager. Single entry point for all LLM calls.… (+22 more)
...
### Community 271 - "brain_failover.py"
Cohesion: 0.05
...
### Community 274 - "test_control_plane_api.py"
Cohesion: 0.06
...
### Community 275 - "test_llm_router_e2e.py"
Cohesion: 0.05
Nodes (58): build_summariser(), Wrap a chat callable into a summariser for dropped turns. The summariser…, get_tracker(), The process-wide health tracker., get_ring(), The process-wide key ring., get_metrics(), The process-wide metrics registry. (+50 more)
...
### Community 282 - "test_platform_controls.py"
Cohesion: 0.08
...
### Community 285 - "test_live_server.py"
Cohesion: 0.22
...
### Community 292 - "provider_max_rpm"
Cohesion: 0.10
...
### Community 293 - "test_rate_limiter.py"
Cohesion: 0.10
...
### Community 294 - "RateLimitTracker"
Cohesion: 0.10
...
### Community 301 - "BrainFailoverManager"
Cohesion: 0.09
...
### Community 310 - "_autonomy_bg_cycle"
Cohesion: 0.07
Nodes (39): _autonomy_bg_cycle(), _DoctorCheck, _DoctorReport, get_doctor_diagnostics(), get_doctor_report(), get_public_doctor(), _in_container(), Path (+31 more)
...
### Community 315 - "test_autonomous_agency_e2e.py"
Cohesion: 0.08
...
### Community 317 - "ProviderConfig"
Cohesion: 0.06
Nodes (36): provider_access_tier(), ProviderConfig, Infer an access tier from *hostname*, longest matching suffix winning. Returns…, _tier_from_hostname(), The pieces the failover loop assembles for an Anthropic-native provider., TestAnthropicRequestShape, Tests that verify the exact provider priority ordering., When INCLUDE_LOCAL_FALLBACK=true and no cloud keys are set, local Ollama must… (+28 more)
...
### Community 319 - "isolated_telegram_config"
Cohesion: 0.11
...
### Community 321 - "test_v4_reliability_regression.py"
Cohesion: 0.06
Nodes (22): Fail preflight when the provider extension is configured but missing. Without…, Any, Structured, actionable preflight validation issue., Preflight result returned before a runtime task starts., Return runtime-specific dependency declarations for preflight., Return a best-effort tool availability report for diagnostics., Ensure the requested workspace exists and is writable., Validate task-specific prerequisites beyond runtime dependencies. (+14 more)
...
### Community 325 - "workflow_orchestrator.py"
Cohesion: 0.08
Nodes (29): BoundContext, JudgeVerdict, MonitorOutput, _orchestrator_bypass(), PersistOutput, Phase, PreflightReport, Enum (+21 more)
...
### Community 336 - "test_purge_backlog.py"
Cohesion: 0.09
...
### Community 338 - "Python Dependencies (`requirements.txt`)"
Cohesion: 0.07
...
### Community 339 - "Technical Debt Register — local-llm-server"
Cohesion: 0.07
...
### Community 340 - "SeoCheckDefinition"
Cohesion: 0.10
...
### Community 344 - "kimi_bridge_provider_config"
Cohesion: 0.11
...
### Community 345 - "webui/frontend/package.json"
Cohesion: 0.07
...
### Community 354 - "AGENTS.md — Codebase Map & Operations Reference"
Cohesion: 0.15
...
### Community 356 - "test_doctor_service_token_check.py"
Cohesion: 0.23
...
### Community 360 - "test_chat_mode_regressions.py"
Cohesion: 0.13
...
### Community 364 - "test_one_model_catalogue.py"
Cohesion: 0.10
...
### Community 367 - "classify_direct_chat_intent"
Cohesion: 0.13
...
### Community 369 - "VoiceCommandInterface"
Cohesion: 0.14
...
### Community 372 - "TestRequireAdmin"
Cohesion: 0.29
...
### Community 381 - "TestSchedulerStore"
Cohesion: 0.08
...
### Community 382 - "test_telegram_mutating_commands.py"
Cohesion: 0.06
...
Cohesion: 0.09
Nodes (25): Return why *url* must not be fetched, or None if it's a safe public target.…, unsafe_target_reason(), _connectors(), ConnectorSpec, get_connector(), list_connectors(), Any, packages/integrations/connector_registry.py — the connector catalogue. The… (+17 more)

### Community 389 - "NIMConnectionPool"
Cohesion: 0.11
...
### Community 390 - "_InMemoryBackend"
Cohesion: 0.11
...
### Community 400 - "Implementation Prompt: Rich TaskBoard + Agile Sprint Integration"
Cohesion: 0.08
...
### Community 401 - "Telegram Bot Setup"
Cohesion: 0.08
...
### Community 402 - "implement_agent.py"
Cohesion: 0.12
...
### Community 405 - "_FakeAsyncClient"
Cohesion: 0.20
...
### Community 410 - "_process_task_callback"
Cohesion: 0.18
...
### Community 411 - "test_telegram_service_webhook.py"
Cohesion: 0.18
...
### Community 414 - "test_brain_availability_doctor.py"
Cohesion: 0.13
...
### Community 415 - "test_nvidia_model_discovery.py"
Cohesion: 0.06
...
### Community 426 - "ModelConfig"
Cohesion: 0.05
Nodes (29): AgentPolicy, LLMConfig, ModelConfig, Capability and pricing metadata for one model id., Per-agent routing overrides (ADR-008 §"named profiles")., The fully-resolved routing configuration., get_registry(), ModelRegistry (+21 more)
...
### Community 432 - "OrchestratorCheckpointStore"
Cohesion: 0.14
...
### Community 435 - "test_freebuff_bot.py"
Cohesion: 0.12
...
### Community 442 - "session_retro.py"
Cohesion: 0.13
...
### Community 447 - "loop.py"
Cohesion: 0.11
Nodes (28): _check_extra_kwargs(), _enforce_signature(), _note_phase_end(), _note_phase_start(), loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., Raise TypeError if fn's signature drifts from the locked contract (Pydantic…, Raise TypeError on unknown kwarg (runtime extra='forbid' for non-Pydantic…, # NOTE: "ollama_base" is kept for backwards compatibility; this runner only… (+20 more)

### Community 448 - "CoworkSession"
Cohesion: 0.16
Nodes (3): CoworkSession, A shared AI coding session with multiple human contributors. Manages turn-…, TestCoworkSession

### Community 449 - "LocalBrainStore"
Cohesion: 0.16
...
### Community 451 - "test_brain_priority_scanner.py"
Cohesion: 0.11
...
### Community 453 - "test_phase4_runtime_resilience.py"
Cohesion: 0.12
...
### Community 454 - "TestLegacyRouterCacheTTL"
Cohesion: 0.13
...
### Community 457 - "TestStreamableHTTPTransport"
Cohesion: 0.13
...
### Community 458 - "PersistentMemoryStore"
Cohesion: 0.22
...
### Community 461 - "OrchestratorSupervisor"
Cohesion: 0.12
...
### Community 462 - "system_instruction"
Cohesion: 0.09
...
### Community 464 - "test_loop_registry.py"
Cohesion: 0.12
...
### Community 471 - "TestTelegramNotifications"
Cohesion: 0.40
...
### Community 506 - "_ensure_tasks_source_id_unique_index"
Cohesion: 0.21
...
### Community 509 - "Admin Dashboard Guide"
Cohesion: 0.11
...
### Community 510 - "Implementation Plan"
Cohesion: 0.11
...
### Community 513 - "scripts/doctor.py"
Cohesion: 0.27
...
### Community 516 - "get_skill_bindings"
Cohesion: 0.10
...
### Community 523 - "test_repowise_intelligence.py"
Cohesion: 0.11
...
### Community 527 - "Comprehensive Skill Index (By Category)"
Cohesion: 0.11
...
### Community 528 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 529 - "Component Map"
Cohesion: 0.11
...
### Community 531 - "Architecture Overview — local-llm-server"
Cohesion: 0.11
...
### Community 532 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
...
### Community 533 - "Platform Guide — the full tour"
Cohesion: 0.11
...
### Community 543 - "test_task_pre_execution_gate.py"
Cohesion: 0.24
...
### Community 544 - "services/seo_audit.py"
Cohesion: 0.12
...
### Community 545 - "test_telegram_webhook.py"
Cohesion: 0.14
...
### Community 546 - "handle_workflow_ide_chat"
Cohesion: 0.18
...
### Community 550 - "cowork_session.py"
Cohesion: 0.15
...
### Community 551 - "SKILL: Industrial Brutalism & Tactical Telemetry UI"
Cohesion: 0.12
...
### Community 552 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 553 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 554 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 564 - "tasks/models.py"
Cohesion: 0.07
Nodes (35): tasks — Task/issue management system. Provides a lightweight task/issue tracker…, ApprovalCheckpoint, ApprovalRequest, _coerce_ts(), CommentAddRequest, ExecutionApprovalRequest, ExecutionLogEntry, FollowUpRequest (+27 more)
...
### Community 579 - "agents/agile_ceremonies.py"
Cohesion: 0.08
...
### Community 595 - "AdminDigestRouterAuthTests"
Cohesion: 0.20
...
### Community 598 - "e2e/test_browser.py"
Cohesion: 0.21
...
### Community 599 - "test_agency_workflows_carry_the_failover_chain.py"
Cohesion: 0.18
...
### Community 600 - "test_agent_tools.py"
Cohesion: 0.19
...
### Community 602 - "test_brain_failover_413.py"
Cohesion: 0.15
...
### Community 605 - "test_local_brain_state.py"
Cohesion: 0.12
...
### Community 607 - "test_migrate_local_brain_env.py"
Cohesion: 0.38
...
### Community 608 - "test_nvidia_default_model.py"
Cohesion: 0.17
...
Cohesion: 0.11
Nodes (13): Request, FastAPI dependency: require any authenticated user., require_authenticated(), client(), tests/test_phase5_doctor.py Phase 5: /api/doctor endpoint tests. Coverage: -…, If RuntimeManager raises, /api/doctor still returns 200 with a warn check., If DirectChatDoctor.check_all raises, /api/doctor still returns 200., MongoStore.__getattr__ proxies any name to a Motor collection, so… (+5 more)

### Community 610 - "test_provider_410_per_model.py"
Cohesion: 0.18
...
### Community 613 - "test_tasks_reconciler_todo_requeue.py"
Cohesion: 0.20
...
### Community 615 - "test_contract_enforcement.py"
Cohesion: 0.17
...
### Community 616 - "test_issue_triage.py"
Cohesion: 0.17
...
### Community 628 - "CompanyGraph"
Cohesion: 0.04
Nodes (31): BusinessCategory, DirectChatSession, Direct chat session with Company Graph context binding., Bind a company to this chat session and load its Company Graph., Bind a repository to this chat session., Get the bound Company Graph., Get enriched context including Company Graph data., CompanyGraph (+23 more)
...
### Community 636 - "test_telegram_auto_approve.py"
Cohesion: 0.21
...
### Community 662 - "Main proxy (`proxy.py`)"
Cohesion: 0.14
...
### Community 668 - "Traffic Distribution Across Providers"
Cohesion: 0.08
...
### Community 672 - "is_anthropic_base_url"
Cohesion: 0.18
...
### Community 676 - "weekly_digest.py"
Cohesion: 0.13
...
### Community 678 - "test_minimax_bug_fixes.py"
Cohesion: 0.12
...
### Community 682 - "test_tasks_awaiting_approval_api.py"
Cohesion: 0.37
...
### Community 683 - "test_backend_runtime_bootstrap.py"
Cohesion: 0.11
...
### Community 684 - "TestBrainFailoverModelUpdates"
Cohesion: 0.18
...
### Community 685 - "test_task_brain_preflight.py"
Cohesion: 0.31
...
### Community 699 - "admin_update_task_router.py"
Cohesion: 0.22
...
### Community 700 - "platform_controls_router.py"
Cohesion: 0.29
...
### Community 703 - "Skill: platform-setup — Autonomous Agency Bootstrap"
Cohesion: 0.15
...
### Community 704 - "Device compatibility and model picks"
Cohesion: 0.15
...
### Community 705 - "Autonomy Uplift — Living Roadmap & Detailed Implementation Specs"
Cohesion: 0.15
...
### Community 706 - "OpenClaw — iOS Control of the Agency (Single-Service Free-Tier Deploy)"
Cohesion: 0.15
...
### Community 709 - "ApplyReviewAgent"
Cohesion: 0.22
...
### Community 711 - "traffic_director.py"
Cohesion: 0.11
Nodes (17): Return the configured traffic-distribution strategy (lower-cased). Reads…, routing_strategy(), Unique identifier (e.g. 'nvidia', 'cerebras')., active_strategy(), provider_id_of(), Any, Adaptive traffic distribution across LLM providers. The router…, Return the configured strategy name, falling back to ``priority``. An… (+9 more)

### Community 712 - "_parse_reset_epoch"
Cohesion: 0.23
...
### Community 713 - "_is_bedrock_model_id"
Cohesion: 0.27
...
### Community 715 - "Agent Transparency Report"
Cohesion: 0.15
...
### Community 716 - "router/health.py"
Cohesion: 0.20
...
### Community 717 - "update_provider_policy"
Cohesion: 0.19
...
### Community 720 - "TestModelCostTableUpdates"
Cohesion: 0.26
...
### Community 721 - "TestMCPClientStructuredOutput"
Cohesion: 0.31
...
### Community 722 - "TestDecisionsBotLinks"
Cohesion: 0.21
...
### Community 723 - "test_deploy_trigger_covers_image.py"
Cohesion: 0.21
...
### Community 724 - "parse_event_stream"
Cohesion: 0.15
...
### Community 725 - "TestKillSwitchDurability"
Cohesion: 0.15
...
### Community 729 - "TelegramBotManager"
Cohesion: 0.12
...
### Community 740 - "test_self_heal.py"
Cohesion: 0.11
...
### Community 741 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 744 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 746 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 747 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 748 - "Workspace Isolation Architecture"
Cohesion: 0.17
...
### Community 749 - "Quantization Internals"
Cohesion: 0.17
...
### Community 750 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 751 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 752 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 754 - "test_task_service_failed_comment.py"
Cohesion: 0.21
...
### Community 760 - "test_admin_local_brain_router.py"
Cohesion: 0.29
...
### Community 761 - "test_agile_api.py"
Cohesion: 0.17
...
### Community 762 - "test_app_settings.py"
Cohesion: 0.21
...
### Community 763 - "test_brain_default_consistency.py"
Cohesion: 0.24
...
### Community 764 - "analyze_qualitative"
Cohesion: 0.25
...
### Community 774 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 777 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 778 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 784 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 785 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 800 - "_self_heal_ready"
Cohesion: 0.15
...
### Community 801 - "test_bedrock_live.py"
Cohesion: 0.25
...
### Community 803 - "capture_screens.py"
Cohesion: 0.25
...
### Community 805 - "build_tech_db.py"
Cohesion: 0.35
...
### Community 810 - "TestNoNvidiaFallbackIsRetired"
Cohesion: 0.22
...
### Community 815 - "admin_local_brain_router.py"
Cohesion: 0.22
...
### Community 816 - "connectors_api.py"
Cohesion: 0.22
...
### Community 834 - "enrich_quick_note_issues.py"
Cohesion: 0.36
...
### Community 836 - "get_ceo_dispatcher"
Cohesion: 0.11
...
### Community 839 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 840 - "test_model_catalog_guard.py"
Cohesion: 0.29
...
### Community 842 - "TestMCPToolsListCache"
Cohesion: 0.19
...
### Community 849 - "Skill: changelog-enforcer"
Cohesion: 0.22
...
### Community 850 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 869 - "telegram_service.py"
Cohesion: 0.16
...
### Community 871 - "test_autonomy_pipeline_regressions.py"
Cohesion: 0.15
...
### Community 872 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 873 - "capability_registry.py"
Cohesion: 0.21
...
### Community 876 - "TestPolicyAuthoringUiStableClaim"
Cohesion: 0.22
...
### Community 879 - "test_serve_spa_prefixes.py"
Cohesion: 0.31
...
### Community 885 - "ExecutionRequest"
Cohesion: 0.06
Nodes (43): Called by APScheduler when a cron fires. Dispatches to the orchestrator. This…, _scheduler_on_fire(), ExecutionRequest, ExecutionResult, get_workflow_orchestrator(), Return the shared WorkflowOrchestrator singleton., Reset the singleton (test helper)., Canonical request to execute work through the golden path. This is the ONLY… (+35 more)
...
### Community 890 - "TestAuthAndTaskCreation"
Cohesion: 0.17
...
### Community 891 - "quality_checker.py"
Cohesion: 0.32
...
### Community 903 - "AGENTS.md — AI Agent Configuration for local-llm-server"
Cohesion: 0.25
...
### Community 904 - "Advisor Strategy — Local Proxy Handling"
Cohesion: 0.25
...
### Community 938 - "test_omniroute_provider.py"
Cohesion: 0.15
...
### Community 939 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 940 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 941 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 942 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 943 - "test_agent_readiness_audit.py"
Cohesion: 0.18
...
### Community 947 - "security_fix_agent.py"
Cohesion: 0.46
...
### Community 948 - "Agent Readiness Report"
Cohesion: 0.20
...
### Community 949 - "ApprovalStore"
Cohesion: 0.06
Nodes (39): ApprovalRequest, ApprovalStatus, ApprovalStore, Any, Enum, str, packages/governance/approvals.py — human-in-the-loop for high-risk actions. The…, Bounded, in-process store of approval requests. Uses a :class:`threading.Lock`… (+31 more)
...
### Community 962 - "TestPoliciesGovernanceStableClaim"
Cohesion: 0.25
...
### Community 972 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.25
...
### Community 974 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 985 - "AI Engineering Insights Skill"
Cohesion: 0.29
...
### Community 999 - "claude-mem Plugin — Persistent Memory for All Sessions"
Cohesion: 0.29
...
### Community 1000 - "Implementation plan + TO-DO (check off as you go)"
Cohesion: 0.29
...
### Community 1003 - "service_token.py"
Cohesion: 0.25
...
### Community 1016 - "test_daily_2026_06_14.py"
Cohesion: 0.38
...
### Community 1017 - "TestPaidPolicyDurability"
Cohesion: 0.22
...
### Community 1018 - "_build_direct_chat_schedule_suggestion"
Cohesion: 0.32
...
### Community 1020 - "services/background.py"
Cohesion: 0.05
Nodes (71): _dispatch_async(), _ErrorCaptureHandler, get_log_monitor(), LogMonitor, _note_recurrence(), Any, LogRecord, agent/log_monitor.py — Application Log Monitor Captures ERROR/CRITICAL log… (+63 more)

### Community 1021 - "TestReasonsAreActionable"
Cohesion: 0.29
...
### Community 1022 - "TestProvidersScreen"
Cohesion: 0.43
...
### Community 1026 - "InitiativeProgress"
Cohesion: 0.33
...
### Community 1027 - "openclaw_mobile_ui"
Cohesion: 0.33
...
### Community 1045 - "Security Policy"
Cohesion: 0.18
...
### Community 1046 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 1047 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 1048 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 1049 - "Continual Harness (`agent/harness_spec.py`)"
Cohesion: 0.25
...
### Community 1053 - "apply_phase1_changes.py"
Cohesion: 0.33
...
### Community 1065 - "TestDirectChatAgentExecution"
Cohesion: 0.33
...
### Community 1066 - "TestDisabledProvidersAreNotFalselyReportedUnreachable"
Cohesion: 0.33
...
### Community 1068 - "_load_local_metrics_since"
Cohesion: 0.43
...
### Community 1069 - "models/company_graph.py"
Cohesion: 0.04
Nodes (87): ApprovalPolicy, BusinessSystem, CompanyCreateRequest, CompanyGraphResponse, CompanyGraphSnapshot, CompanyResponse, CompanyUpdateRequest, Connector (+79 more)

### Community 1070 - "What's New"
Cohesion: 0.29
Nodes (7): 2026-06-16, 2026-06-25, 2026-06-26, 2026-07-04, 2026-07-05, 2026-07-09, What's New

### Community 1071 - "_check_storage_health"
Cohesion: 0.12
...
### Community 1076 - "test_log_monitor_storm_guard.py"
Cohesion: 0.48
...
### Community 1091 - "TestGithubSignalHardening"
Cohesion: 0.22
...
### Community 1103 - "_add_colibri_shim_changelog_entry.py"
Cohesion: 0.50
...
### Community 1104 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1105 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1106 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 1107 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 1108 - "setup_colibri.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1109 - "setup_colibri.sh script"
Cohesion: 0.70
Nodes (4): setup_colibri.sh script, fail(), ok(), warn()

### Community 1110 - "status_colibri_server.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1111 - "start_tunnel.py"
Cohesion: 0.50
...
### Community 1115 - "nvidia_live_test.py"
Cohesion: 0.40
...
### Community 1117 - "test_agent_runtime_wrapper.py"
Cohesion: 0.70
...
### Community 1118 - "_parse_tool_calls_from_response"
Cohesion: 0.39
...
### Community 1122 - "TestModelRoleSeparation"
Cohesion: 0.40
...
### Community 1123 - "worker/index.js"
Cohesion: 0.70
...
### Community 1135 - "TestOneIdCanBelongToSeveralProviders"
Cohesion: 0.39
...
### Community 1136 - "TestRunCoroSync"
Cohesion: 0.29
...
### Community 1141 - "classify_domain"
Cohesion: 0.29
...
### Community 1154 - "The full agent capability roster"
Cohesion: 0.33
...
### Community 1155 - "test_no_exception_detail_leaks.py"
Cohesion: 0.50
...
### Community 1156 - "test_doctor_coding_brain.py"
Cohesion: 0.38
...
### Community 1157 - "github"
Cohesion: 0.50
Nodes (3): github, enabled, silent

### Community 1162 - "resolve_hermes_base_url"
Cohesion: 0.47
...
### Community 1183 - "test_the_reserve_is_bounded_when_read_from_the_environment"
Cohesion: 0.67
...
### Community 1281 - "TestCEOAgencySystem"
Cohesion: 0.33
...
### Community 1283 - "test_phase6_workflow.py"
Cohesion: 0.15
...
### Community 1284 - "Who is this for?"
Cohesion: 0.40
...
### Community 1285 - "._resolve_merge_decision"
Cohesion: 0.40
...
### Community 1286 - "JWTUserStateMiddleware"
Cohesion: 0.30
Nodes (5): _classify_complexity(), JWTUserStateMiddleware, BaseHTTPMiddleware, Populate request.state.user from a valid Bearer JWT. Task and agent routers…, Return 'complex' if the message warrants multi-agent orchestration, else…

### Community 1287 - "routed"
Cohesion: 0.40
...
- **Why does `_fixture()` connect `_fixture` to `TaskSpec`, `test_brain_patch_service_token.py`, `TaskStatus`, `test_gh_brain_failover.py`, `E2BSandboxSession`, `test_llm_router_queue_cache.py`, `test_llm_router_strategies.py`, `test_operational_incidents.py`, `WorkflowRun`, `SelfHealingAgent`, `test_agent_tool_governance.py`, `TaskStore`, `BrainWatchdog`, `test_company_api.py`, `test_llm_router_resilience.py`, `WorkflowOrchestrator`, `PolicyEngine`, `test_langfuse_agency_wide.py`, `Agency`, `ImprovementLoop`, `SeoAuditEngine`, `Task`, `test_task_pre_execution_gate.py`, `test_telegram_webhook.py`, `AgentSessionStore`, `test_unit8_model_catalog.py`, `test_failover_client_shared.py`, `MCPClient`, `test_model_router.py`, `models/company_graph.py`, `PrimeAgentAdapter`, `test_ceo_router.py`, `tasks/models.py`, `CEOLedger`, `test_openclaw_endpoints.py`, `ChatHistoryStore`, `TokenBudget`, `ResearchTask`, `test_self_heal_v2.py`, `seo_api.py`, `TestClient`, `test_ai_insights.py`, `SQLiteStore`, `config.py`, `KeyStore`, `test_procedural_memory.py`, `e2e/test_browser.py`, `test_autonomy_status.py`, `test_brain_failover_413.py`, `claim`, `test_local_brain_state.py`, `test_sam_voice.py`, `test_startup_warmup.py`, `test_phase5_doctor.py`, `test_provider_410_per_model.py`, `test_refresh_agent_built_proof.py`, `test_tasks_reconciler_todo_requeue.py`, `clear_cooldowns`, `test_provider_router.py`, `test_llm_router_tpm.py`, `cost_tracker.py`, `HarnessRegistry`, `test_context_rulebook.py`, `test_telegram_auto_approve.py`, `ArtifactStore`, `test_trend_scoping.py`, `run_task`, `test_doctor_coding_brain.py`, `AuditLog`, `FeatureMaturity`, `test_new_features_e2e.py`, `UserRole`, `test_kimi_bridge_server.py`, `test_issue_intake.py`, `_step`, `test_trend_watcher.py`, `persist_plan_spec`, `TestEstimateTokensForMessages`, `test_changelog_check_workflow.py`, `test_openclaw_gateway.py`, `test_daily_2026_07_27.py`, `test_task_brain_preflight.py`, `KeyPool`, `NotificationDispatcher`, `test_process_quick_note_workflow.py`, `TestSwarmRoleRouting`, `OllamaCircuitBreaker`, `_job_text`, `_Budget`, `traffic_director.py`, `test_features_api.py`, `test_video_transcript.py`, `TrendWatcher`, `test_portfolio_intake.py`, `parse_event_stream`, `SchedulerStore`, `WorkflowBuildRequest`, `emit_chat_observation`, `AgentSwarm`, `TestRuntimeControl`, `TestClient`, `test_task_service_failed_comment.py`, `test_agile_api.py`, `ContextPruner`, `test_app_settings.py`, `test_e2b_data_flow.py`, `TestAuthAndTaskOwnership`, `test_task_clarification.py`, `test_brain_failover.py`, `OrchestratorQueue`, `nvidia_models.py`, `routed`, `test_persistent_memory.py`, `SecurityScanner`, `api_keys_for`, `brain_failover.py`, `test_control_plane_api.py`, `test_llm_router_e2e.py`, `OutputFilter`, `test_platform_controls.py`, `timedelta`, `capture_screens.py`, `test_rate_limiter.py`, `TestAgentRunnerSafety`, `_autonomy_bg_cycle`, `TestNormalizeResponseFormat`, `test_autonomous_agency_e2e.py`, `isolated_telegram_config`, `get_ceo_dispatcher`, `test_catalogue_probe.py`, `analyze_page`, `test_scheduler_hydration_bounded.py`, `test_regression.py`, `test_agent_scripts_share_one_model_list.py`, `test_crispy_burn_in.py`, `test_implement_agent_routing.py`, `test_provider_enable_disable.py`, `test_skill_registry_boot_refresh.py`, `test_doctor_service_token_check.py`, `reset_cache`, `TestHarnessAdapter`, `ExecutionRequest`, `TestAuthAndTaskCreation`, `test_telegram_mutating_commands.py`, `_undeclared`, `test_service_token.py`, `test_harness_spec.py`, `test_telegram_service_webhook.py`, `test_agency_fix.py`, `test_nvidia_model_discovery.py`, `_Recorder`, `test_webui_provider_priority.py`, `_get`, `ApprovalStore`, `test_monitor_lib.py`, `test_v4_api.py`, `session_retro.py`, `TestTheWorkflowIsSafeAndReadOnly`, `TestMongoGate`, `test_ping.py`, `test_telegram_diag_endpoint.py`, `test_runtimes_health_endpoint.py`, `test_task_store_fails_loud_in_production.py`, `test_provider_state_durability.py`, `test_dashboard_cache.py`, `test_voice_pipeline.py`, `client`, `clear_override`, `services/background.py`?**
  _High betweenness centrality (0.115) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `call_llm`, `InternalAgentAdapter`, `Any`, `TaskSpec`, `proxy.py`, `backend/server.py`, `E2BSandboxSession`, `ReactScratchpad`, `test_agent_tool_governance.py`, `E2BAdapter`, `test_governance_api.py`, `WorkflowOrchestrator`, `ContextManager`, `PolicyEngine`, `webui/router.py`, `AgentSessionStore`, `MultiAgentSwarm`, `direct_chat.py`, `test_failover_client_shared.py`, `TestAgentRunnerExecution`, `TestAgentRunnerSafety`, `test_empirical_verify.py`, `MCPClient`, `StuckDetector`, `CEODispatcher`, `test_daily_automation_2026_07_11.py`, `test_autonomous_agency_e2e.py`, `loop.py`, `WorkspaceTools`, `get_ceo_dispatcher`, `workflow_orchestrator.py`, `TestAgentLoopMCPIntegration`, `TokenBudget`, `test_agent_chat_integration.py`, `TaskDispatcher`, `LocalWorkspace`, `UserMemoryStore`, `test_brain_failover_413.py`, `AdaptiveHalter`, `GitHubTools`, `ExecutionRequest`, `FreeBuffAgent`, `ContextPruner`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderRouter` to `call_llm`, `failover_client.py`, `backend/server.py`, `settings.py`, `test_all_providers_discovery.py`, `implement_agent.py`, `is_anthropic_base_url`, `test_bedrock_live.py`, `webui/router.py`, `TrafficDirector`, `AnthropicProvider`, `direct_chat.py`, `NvidiaProvider`, `ProviderConfig`, `test_colibri_provider.py`, `TestLegacyRouterCacheTTL`, `test_anthropic_refusal_fallback.py`, `system_instruction`, `_payload`, `kimi_bridge_provider_config`, `test_bedrock_provider.py`, `get_director`, `test_implement_agent_routing.py`, `test_provider_410_per_model.py`, `test_chat_mode_regressions.py`, `clear_cooldowns`, `test_provider_router.py`, `TestAnthropicPayloadStructuredOutput`?**
