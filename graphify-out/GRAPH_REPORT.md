# Graph Report - local-llm-server  (2026-08-14)

## Corpus Check
- 1430 files · ~2,046,859 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 28323 nodes · 57042 edges · 1147 communities (1027 shown, 120 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 6298 edges (avg confidence: 0.54)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `491d11b1`
...
## Communities (1147 total, 120 thin omitted)

### Community 0 - "backend/server.py"
Cohesion: 0.01
Nodes (448): get_agency(), set_agency(), get_harness_adapter(), agents/store.py — Persistent store for user-defined agent configurations.…, Set the global agent store instance (e.g., with MongoDB on startup)., set_agent_store(), admin_seed(), _agent_provider_failure_response() (+440 more)

### Community 1 - "ProviderConfig"
Cohesion: 0.01
Nodes (239): get_tracker(), Return the process-singleton RateLimitTracker., _acquire_provider_probe(), clear_cooldowns(), _dead_model_key(), _exponential_backoff_cooldown(), extract_openai_text(), get_dead_models() (+231 more)

### Community 2 - "ExecutionRequest"
Cohesion: 0.01
Nodes (189): Execute work through the 11-phase golden path., Called by APScheduler when a cron fires. Dispatches to the orchestrator., #522 + #505: Reliability startup — schedule hydration, orchestrator restore,…, _scheduler_on_fire(), _startup_reliability_hooks(), workflow_orchestrator_execute(), get_orchestrator_checkpoint_store(), _NoopDB (+181 more)

### Community 3 - "UserMemoryStore"
Cohesion: 0.03
Nodes (169): Agency, CEO-coordinated multi-agent agency for continuous codebase management. The CEO…, AgentJobError, AgentJobRequest, AgentJobResult, AgentJobSnapshot, BaseModel, agent/contract.py — Typed public contract for the agent job lifecycle. Phase 1… (+161 more)

### Community 4 - "test_llm_router_queue_cache.py"
Cohesion: 0.02
Nodes (133): int, Test hook — clear all usage accounting., reset(), CacheManager, cosine_similarity(), _Entry, LRUCache, payload_key() (+125 more)

### Community 5 - "_fixture"
Cohesion: 0.01
Nodes (128): app_client(), _clear_discovered_models(), _clear_response_cache(), client(), _isolate_brain_data_layer(), _isolate_operator_provider_state(), non_admin_client(), MonkeyPatch (+120 more)

### Community 6 - "AgentRunner"
Cohesion: 0.02
Nodes (124): AgentPhaseError, AgentRunner, _note_phase_end(), _note_phase_start(), Any, Exception, Path, Governance seam: judge the call, run it, audit the outcome. Deliberately a thin… (+116 more)

### Community 7 - "SQLiteStore"
Cohesion: 0.02
Nodes (89): CompanyGraphSnapshot, A point-in-time snapshot of a Company Graph for history and rollback., MongoDBStore, Any, Company, ObjectId, Prepare a Pydantic model for SQLite storage., Prepare a SQLite row for Pydantic model. (+81 more)

### Community 8 - "proxy.py"
Cohesion: 0.03
Nodes (154): Any, Return recent commits with agent attribution trailers parsed out., get_tracker(), Return the shared AutonomyTracker singleton (lazy-init)., get_sam(), agent/sam.py — SAM Voice Agent (System Autonomy Manager) SAM is the voice-…, get_skill_registry_safe(), Return the global SkillRegistry if set, else None. Used by onboarding and other… (+146 more)
...
Cohesion: 0.03
Nodes (123): PreflightIssue, Any, BaseModel, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, Translate technical preflight issues into a conversational assistant reply., translate_error_to_conversational(), agent/job_manager.py — Async agent job lifecycle manager. Manages agent jobs…, ResumeRequest (+115 more)

### Community 11 - "Task"
Cohesion: 0.03
Nodes (118): Hand the 'connect & verify the repo' work to the agency's own agents. The task…, _seed_connect_task(), Helpers that turn scheduler and playbook activity into real tasks., Full task/issue document., Task, _get_workflow_engine(), WorkflowEngine, Domain services for task workflow and runtime-backed execution. (+110 more)

### Community 12 - "test_runtimes.py"
Cohesion: 0.03
...
Cohesion: 0.04
Nodes (72): packages/llm — the multi-provider LLM routing layer. Every LLM call in this…, AnthropicProvider, Any, AsyncClient, packages/llm/providers/anthropic.py — Anthropic Messages API adapter. Anthropic…, Translate OpenAI-shaped messages into Anthropic's system/turn split., OpenAI carries a tool result as role="tool" with a tool_call_id; Anthropic…, OpenAI puts a tool call alongside the assistant's text; Anthropic needs… (+64 more)
...
### Community 16 - "ImprovementLoop"
Cohesion: 0.03
Nodes (98): _parse_ceo_directives(), DetectedIssue, get_improvement_loop(), ImprovementLoop, ImprovementLoopState, _now(), Any, Path (+90 more)

### Community 17 - "FreeBuffAgent"
Cohesion: 0.08
Nodes (101): BackgroundAgent, BackgroundTask, Any, Enqueue *task* for processing. Returns the task (with task_id set)., Convenience: create a task and submit it in one call., Real handler — dispatches through AgentRunner when available. HARDENED (PR…, Always-on worker that drains a task queue on a daemon thread. GATE: Golden Path…, BrowserSession (+93 more)

### Community 18 - "test_operational_incidents.py"
Cohesion: 0.02
...
### Community 19 - "company_api.py"
Cohesion: 0.03
Nodes (125): account_lifecycle(), auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint(), generate_onboarding_questions(), get_company(), get_company_access() (+117 more)

### Community 20 - "test_brain_config_store.py"
Cohesion: 0.03
Nodes (100): Call-time resolver for an agent role model id. Delegates to…, _resolve_role_model(), emit_agency_observation(), Record an agency platform operation in Langfuse. Unlike…, get_brain_config(), get_brain_config_store(), invalidate_brain_config_cache(), Return the process-wide ``BrainConfigStore`` singleton. (+92 more)
...
### Community 23 - "failover_client.py"
Cohesion: 0.03
Nodes (87): _auto_disable(), _describe_registry(), _disable_unless_key_serves_other_models(), _is_billing_refusal(), _is_ollama(), _key_pool(), _log_exhaustion(), _log_recovery() (+79 more)

### Community 24 - "MCPUnavailableError"
Cohesion: 0.04
Nodes (82): MCPUnavailableError, agent/mcp_client.py — Async MCP client for the mcp-server Docker container.…, Raised when the MCP server is unreachable or the circuit is open., packages/integrations/render_mcp.py — Render platform access over MCP. The…, Drop the cached singleton. Used by tests and after a config change., reset_render_mcp(), TaskResult, TaskSpec (+74 more)
...
### Community 26 - "test_autonomous_agency_e2e.py"
Cohesion: 0.03
Nodes (74): AgencyCycleResult, AgentDirective, AgentRole, Any, str, Capture the FastAPI main event loop so the CEO thread can dispatch run_cycle()…, Generate directives for each onboarded company. The CEO examines each company's…, Close exhausted quick-note issues; dispatch Dev directives for open ones. (+66 more)
...
### Community 28 - "skill_bindings.py"
Cohesion: 0.03
...
Cohesion: 0.03
Nodes (94): _complexity_rank(), _decompose_into_subtasks(), get_ceo_dispatcher(), _merge_changed_files(), services/ceo_dispatcher.py — Real CEO delegation layer. The CEO splits a…, Return the shared CEODispatcher singleton., Reset the singleton (test helper)., Decompose a request into 2-3 sub-tasks for specialist fan-out. Default… (+86 more)

### Community 35 - "SelfHealingAgent"
Cohesion: 0.04
...
Cohesion: 0.05
Nodes (50): analyze_qualitative(), analyze_quantitative(), auto_register(), _classify_sentiment(), _extract_keywords(), plan_research(), Any, BaseModel (+42 more)

### Community 37 - "test_unit8_model_catalog.py"
Cohesion: 0.03
Nodes (80): all_provider_ids(), Return every provider id recognised by the brain config system. Iterates the…, CatalogActiveBrain, CatalogMirror, CatalogProviderEntry, get_catalog(), get_model_catalog_store(), _include_router_providers() (+72 more)

### Community 38 - "TrafficDirector"
Cohesion: 0.04
Nodes (51): provider_max_parallel(), provider_max_tpm(), _provider_positive_float(), provider_weight(), Shared parse/validate for the numeric per-provider traffic budgets. Returns…, Return the operator-configured tokens/min cap for *provider*. Reads…, Return the operator-configured share weight for *provider*. Reads…, Return the operator-configured in-flight request cap for *provider*. Reads… (+43 more)

### Community 39 - "SeoAuditRequest"
Cohesion: 0.04
...
### Community 42 - "test_ceo_supervision.py"
Cohesion: 0.05
Nodes (74): _harvest_changed_files(), Extract the files a runtime touched. Returns ``(files, reported)``. Adapters…, Attempt, GoalRecord, Any, One delegation of one subtask to one tier., A subtask's full history: what it is, and every attempt at it., One piece of work the CEO has taken ownership of. ``state`` is the supervisor's… (+66 more)

### Community 43 - "test_governance_enforcement.py"
Cohesion: 0.04
Nodes (79): AuditEvent, Any, packages/governance/audit.py — the evidence trail for every governed action.…, Redact secret-shaped substrings, then truncate., One governed action, fully described. Field order follows the…, One-line JSON, suitable for a SIEM shipper tailing the log., Return the most recent events, newest first, optionally filtered., Aggregate view for the dashboard and the metrics endpoint. ``would_block`` is… (+71 more)

### Community 44 - "resolve_identity"
Cohesion: 0.04
Nodes (67): AgentIdentity, new_session_id(), Any, packages/governance/identity.py — who is acting, and under what mandate. Docker…, Return a copy carrying extra execution context. Used when context arrives after…, Serialise for audit rows and API responses. Every field here is non-secret by…, Build an :class:`AgentIdentity` from whatever the caller knows. Total by design…, Return the stable ``agent:<slug>`` id for a human agent name. Deterministic and… (+59 more)

### Community 45 - "test_phase6_workflow.py"
Cohesion: 0.04
...
### Community 48 - "WorkspaceManager"
Cohesion: 0.06
Nodes (61): _fake_user_auth(), Path, test_admin_can_create_anthropic_provider_via_webui_admin_api(), test_admin_can_create_provider_via_webui_admin_api(), test_ui_providers_and_workspaces_use_app_state(), _bootstrap(), Path, ProviderManager (+53 more)

### Community 49 - "ToolRegistry"
Cohesion: 0.04
Nodes (41): get_tool_registry(), _infer_parameters_from_func(), Any, Path, Register a tool definition., Decorator to register a function as an agent tool. Usage::…, Remove a tool from the registry. Returns True if removed., Look up a tool by name. (+33 more)

### Community 50 - "KeyStore"
Cohesion: 0.04
...
### Community 52 - "AgentSwarm"
Cohesion: 0.05
Nodes (52): AgentRole, AgentSwarm, Any, Return the agent role responsible for *phase*., Return the AgentProfile for the agent driving *phase*., Return a JSON-serialisable summary of all agent profiles., Run a pre-gate or report phase through the correct agent. Enforces permission…, Execute a slice via the Coder agent (write-permitted). (+44 more)
...
Cohesion: 0.03
Nodes (41): BusinessCategory, Find a website by its URL., A company website with detected systems and stack inference., Website, CompanyGraphService, Company, SpecialistFamily, SystemType (+33 more)
...
### Community 58 - "test_mcp_registry.py"
Cohesion: 0.05
...
### Community 59 - "Surface"
Cohesion: 0.05
Nodes (58): _egress_policy_reason(), agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Return why governance policy blocks *host*, or None. Runs strictly *after* the…, _load(), Import the governance layer once, recording why if it is absent., BudgetExceeded, evaluate_call(), governance_enabled() (+50 more)

### Community 60 - "test_sam_livekit.py"
Cohesion: 0.04
...
### Community 62 - "TasksPage.js"
Cohesion: 0.04
Nodes (61): addTaskComment(), approveTaskCheckpoint(), approveTaskExecution(), clarifyTask(), createAgent(), createQuickNote(), createSprint(), createTask() (+53 more)
...
### Community 66 - "test_failover_client_shared.py"
Cohesion: 0.08
Nodes (71): failover_chat_completion(), Run one chat completion across the brain-failover chain. Tries each healthy…, _free_tier(), _hit_ids(), _many_providers(), _mixed_registry(), _openai_body(), _paid() (+63 more)
...
### Community 71 - "brain_failover.py"
Cohesion: 0.05
...
### Community 74 - "CEODispatcher"
Cohesion: 0.06
Nodes (47): CEODispatcher, CEOResult, _offload(), Any, Semaphore, Run a synchronous ledger call without blocking the event loop. ``CEOLedger`` is…, Build an agent.coordinator.TaskSpec from a CEO SpecialistTask., Aggregated output from a multi-specialist execution. (+39 more)

### Community 75 - "TestClient"
Cohesion: 0.10
Nodes (29): bare_repo(), _call(), _data(), git_config_env(), _is_error(), mcp_workspace_root(), Path, skipif (+21 more)

### Community 76 - "WebReach"
Cohesion: 0.07
...
### Community 77 - "test_ai_insights.py"
Cohesion: 0.05
...
### Community 80 - "CompanyGraphStore"
Cohesion: 0.03
...
### Community 81 - "ProceduralMemoryStore"
Cohesion: 0.05
...
### Community 83 - "TaskDispatcher"
Cohesion: 0.04
Nodes (41): Re-queue BLOCKED tasks that have cooled down and are ready for retry., Polls for queued task work and executes it through the coordinator. Crash…, Re-queue tasks stranded by a prior crash or hard-kill., TaskDispatcher, _make_task(), asyncio, Task, TaskStatus (+33 more)

### Community 84 - "Task"
Cohesion: 0.05
Nodes (36): _is_brain_connection_error(), Any, BaseException, Task, TaskResult, TaskSpec, TaskStatus, Best-effort label of who will run this task once approved. Returns… (+28 more)
...
### Community 86 - "get_self_healing_agent"
Cohesion: 0.06
...
### Community 90 - "test_runtime_governance.py"
Cohesion: 0.07
Nodes (52): _blocked_result(), _governance_check(), Any, TaskResult, TaskSpec, Evaluate a runtime dispatch against policy; audit it either way. Returns…, Full record of a routing decision — audit-trail entry., Selects a runtime for the given task, executes the task (including readiness… (+44 more)

### Community 91 - "FailureCategory"
Cohesion: 0.05
...
Cohesion: 0.06
Nodes (43): Cerebras provider adapter — free, fast LLM (qwen-3-coder-480b)., Groq provider adapter — free, fast LLM (deepseek-r1-distill-llama-70b)., NVIDIA NIM provider adapter — wraps the existing provider_router logic. This is…, Ollama provider adapter — local LLM inference., packages.ai — provider abstraction, model registry, and failover manager., ProviderManager, packages/ai/manager.py — ProviderManager. Single entry point for all LLM calls.…, Coordinates provider selection, failover, and health. (+35 more)

### Community 94 - "BrainConfig"
Cohesion: 0.05
Nodes (48): BrainConfig, BrainConfigStore, default_brain_config(), provider_base_url(), BaseModel, Persist *cfg* to Mongo (primary) and sqlite (mirror). Either backend failing is…, Build a ``BrainConfig`` from a Mongo doc, dropping Mongo's ``_id``., Resolve the Ollama base URL the UI controls — DB value wins over env.… (+40 more)

### Community 95 - "test_agent_tool_governance.py"
Cohesion: 0.06
Nodes (56): Replace the process-wide store. Tests only., reset_approval_store(), AuditLog, Bounded in-memory ring buffer plus a structured log stream. The ring buffer…, Store and emit *event*. Never raises., Replace the process-wide audit log. Tests only., reset_audit_log(), Replace the process-wide engine. Tests only. (+48 more)
...
### Community 100 - "test_governance_api.py"
Cohesion: 0.06
Nodes (56): build_governance_router(), Any, APIRouter, backend/governance_router.py — read and operate the governance layer. Mounted…, Reject non-admin callers. Mirrors the RBAC check used elsewhere in this backend…, _require_admin(), get_approval_store(), get_gate() (+48 more)

### Community 101 - "SeoFixer"
Cohesion: 0.08
Nodes (25): BaseModel, Request to remediate auto-fixable findings in a local code repository., One concrete remediation performed (or proposed) by the fixer., Result of a fixer run., SeoFixAction, SeoFixRequest, SeoFixResult, _humanize_filename() (+17 more)

### Community 102 - "gateway.py"
Cohesion: 0.06
Nodes (57): FailoverResult, A successful completion plus the accounting its callers need., get_cache(), The process-wide cache manager., failover_chat_completion_via_router(), openai_body_from_response(), Any, packages/llm/compat.py — backwards-compatible bridges to the legacy call paths.… (+49 more)
...
### Community 105 - "test_integration_c4_c5_c6_d3.py"
Cohesion: 0.06
...
### Community 109 - "tasks/api.py"
Cohesion: 0.12
Nodes (57): ApprovalRequest, BackgroundTasks, add_comment(), approve_checkpoint(), approve_execution(), clarify_task(), create_task(), _current_user() (+49 more)

### Community 110 - "LLMRouter"
Cohesion: 0.06
Nodes (31): Attempt, text_key(), Read the environment variables named in ``env_names`` into a key list. Order is…, resolve_keys(), LLMRouter, Any, AsyncClient, BaseException (+23 more)

### Community 111 - "seo_api.py"
Cohesion: 0.05
Nodes (46): delegate_seo_findings(), _expire_stale_pending_report(), export_seo_audit(), get_seo_audit(), list_seo_audits(), BaseModel, get, post (+38 more)

### Community 112 - "V5App.jsx"
Cohesion: 0.04
Nodes (34): API, getLoops(), V5App, ActivationGate(), activityToAlert(), AlertsBell(), priorityConfig, _relativeTime() (+26 more)

### Community 113 - "useSafeData"
Cohesion: 0.05
Nodes (40): createSchedule(), listSchedules(), pauseSchedule(), resumeSchedule(), triggerSchedule(), C, FREQ_OPTS, FREQ_TO_CRON (+32 more)

### Community 114 - "RenderMCPClient"
Cohesion: 0.06
...
### Community 116 - "test_sqlite_store.py"
Cohesion: 0.06
...
### Community 118 - "Initiative"
Cohesion: 0.06
Nodes (42): Initiative, _bug_scores(), _clean(), _default_repo(), _env_github_token(), estimate_job_size(), fetch_github_signals(), fetch_research_alerts() (+34 more)

### Community 119 - "ChatPage.js"
Cohesion: 0.06
Nodes (43): cancelAgentChatJob(), chatSend(), deleteSession(), getAgentChatJob(), getSession(), listProviderModels(), listProviders(), listSessions() (+35 more)
...
### Community 121 - "api_keys_for"
Cohesion: 0.05
Nodes (31): _build_request(), _provider_keys(), Every configured key for *provider*, primary first. Returns an empty list when…, Return ``(url, headers, is_anthropic_native)`` for *provider*. Anthropic's…, api_keys_for(), Per-provider API key rotation — the one lever that adds capacity. Every other…, Clear pool state (tests only)., All keys configured for *provider_id*, primary first. Thin delegate to… (+23 more)
...
Cohesion: 0.08
Nodes (31): PreflightReport, AgentJob, make_isolated_workspace(), Path, Create an isolated workspace directory under *root*. This is the legacy path…, Serialize the AgentJob to a JSON-serializable dictionary for external clients.…, _workspace_component(), Any (+23 more)
...
### Community 125 - "PortfolioManager"
Cohesion: 0.05
...
### Community 128 - "test_render_mcp.py"
Cohesion: 0.06
...
### Community 129 - "get_feature_matrix"
Cohesion: 0.05
...
### Community 133 - "test_sam_voice.py"
Cohesion: 0.04
...
Cohesion: 0.08
Nodes (52): Convenience: resolve all four role models for a component. Returns a dict with…, resolve_component_role_models(), Return a Markdown-v1-safe preview string under ``max_chars``. Used by the…, sanitize_paste_for_preview(), _admin_headers(), _api_headers(), _check_rate_limit(), cmd_control() (+44 more)

### Community 136 - "E2BAdapter"
Cohesion: 0.06
Nodes (41): E2BAdapter, Any, Declare ``E2B_API_KEY`` as a required env dependency. The base ``preflight``…, Runtime adapter that executes tasks inside an E2B sandbox. Activation:…, PolicyUpdateBody, BaseModel, RunTaskBody, _clean_e2b_env() (+33 more)

### Community 137 - "WorkflowEngine"
Cohesion: 0.08
...
Cohesion: 0.06
Nodes (41): Agent subsystem — planner / executor / verifier loop., _check_extra_kwargs(), _enforce_signature(), _nvidia_api_key(), loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., Raise TypeError if fn's signature drifts from the locked contract (Pydantic…, Raise TypeError on unknown kwarg (runtime extra='forbid' for non-Pydantic…, Coerce *requested* to a free NVIDIA model. Returns *requested* when it is… (+33 more)
...
### Community 142 - "OnboardingService"
Cohesion: 0.06
...
### Community 143 - "ChatHistoryStore"
Cohesion: 0.07
...
### Community 145 - "scanner.py"
Cohesion: 0.05
Nodes (44): _content_contains_domain(), _hostname_contains(), _hostname_matches(), _is_safe_url(), services/scanner.py - Website and Repository Scanner Service Provides scanning…, Detect the Git provider from a repository URL. Args: repo_url: Repository URL…, Check if a URL or hostname exactly matches or is a subdomain of any domain.…, Check if URL hostname exactly matches or is a subdomain of any domain. Uses… (+36 more)
...
### Community 149 - "probe_model_liveness"
Cohesion: 0.05
Nodes (39): probe_model_liveness(), _probe_ollama(), ProbeResult, BaseModel, Probe local Ollama via GET /api/tags (cheap) then a 5-token completion., Outcome of a single (provider, model) liveness probe., Probe ``(provider, model)`` for liveness. Never raises. Returns a…, tests/test_brain_config_api.py — admin endpoint contract tests. Pins the… (+31 more)
...
### Community 151 - "test_trend_scoping.py"
Cohesion: 0.10
...
### Community 152 - "PortfolioIntelligence"
Cohesion: 0.08
...
### Community 156 - "TestEstimateTokensForMessages"
Cohesion: 0.05
...
### Community 157 - "resolve_component_model"
Cohesion: 0.05
...
### Community 158 - "test_response_cache.py"
Cohesion: 0.12
...
### Community 162 - "validate_outbound_url"
Cohesion: 0.08
...
### Community 163 - "activation_api.py"
Cohesion: 0.09
...
### Community 167 - "test_platform_controls.py"
Cohesion: 0.06
...
### Community 173 - "OnboardingScreen.jsx"
Cohesion: 0.05
...
Cohesion: 0.06
Nodes (22): _digest(), get_pool(), KeyPool, _KeyState, _PoolState, Round-robin key selection with per-key rate-limit cooldowns., Return the next usable key, or None when every key is cooling. With one key…, Cool a single key after a 429 from it. Honours the provider's own ``Retry-… (+14 more)

### Community 182 - "test_rate_limiter.py"
Cohesion: 0.07
Nodes (33): pace(), _parse_reset_epoch(), _ProviderQuota, Response, Proactive rate-limit throttling for LLM providers — two complementary layers.…, Parse x-ratelimit-* headers and update per-provider quota state. Safe to call…, Rate limiter using virtual scheduling (GCRA-style): each caller atomically…, Block until this caller's reserved slot arrives, or *max_wait* elapses. Returns… (+25 more)

### Community 183 - "ApprovalStore"
Cohesion: 0.06
...
### Community 187 - "control_overrides.py"
Cohesion: 0.07
...
### Community 188 - "configuration-reference.md"
Cohesion: 0.06
...
### Community 193 - "test_workspace_isolation.py"
Cohesion: 0.17
...
### Community 194 - "test_freebuff.py"
Cohesion: 0.07
...
### Community 197 - "_ts_to_float"
Cohesion: 0.07
Nodes (28): Any, Task, TaskStatus, Create a task. Deduplicates by source_id if set (Charter G3). If a task with…, Fetch a task by ID. If owner_id is set, enforces ownership., Return the task previously created for an external ``source_id`` (e.g.…, Normalise a timestamp value to a float Unix epoch. Handles: - float / int…, List tasks for a specific user with optional filters. ``include_system``… (+20 more)

### Community 198 - "test_contracts_agency.py"
Cohesion: 0.06
Nodes (26): background_agent(), engine(), Path, WorkflowEngine, tests/test_contracts_agency.py — Contract tests for agency core autonomy…, Contract: WorkflowEngine cannot skip the gate state machine., Contract: AgentRunner._local_safety_check must catch hardcoded secrets and…, Contract: Auth code with hardcoded SECRET_KEY triggers a safety issue. The… (+18 more)

### Community 199 - ".get_workspace"
Cohesion: 0.09
...
### Community 208 - "test_crispy_workflow.py"
Cohesion: 0.07
...
### Community 209 - "test_trend_watcher.py"
Cohesion: 0.08
...
### Community 223 - "test_issue_intake.py"
Cohesion: 0.12
...
### Community 226 - "test_verification_strategies.py"
Cohesion: 0.11
...
### Community 228 - "REWRITE_PLAN.md — Phased Migration Strategy"
Cohesion: 0.06
...
### Community 234 - "NvidiaProvider"
Cohesion: 0.06
Nodes (10): CerebrasProvider, Provider, NvidiaProvider, Provider, NVIDIA NIM — free LLM provider (meta/llama-3.3-70b-instruct)., OllamaProvider, Provider, RateLimit (+2 more)

### Community 235 - "resolve_active_brain"
Cohesion: 0.11
Nodes (34): get_active_brain_sync(), invalidate_brain_cache(), Clear the cached brain so the next read re-resolves. Called from…, Return the cached brain read by sync callers. None if never resolved., Single source of truth for the active brain LLM. Resolution order (matches the…, resolve_active_brain(), When BrainConfig.updated_at is empty (never applied), the resolver falls…, test_resolve_active_brain_falls_through_when_db_unset() (+26 more)

### Community 236 - "test_colibri_brain_shim.py"
Cohesion: 0.08
...
### Community 238 - "test_anthropic_router.py"
Cohesion: 0.09
...
### Community 242 - "DashboardScreen.jsx"
Cohesion: 0.07
...
### Community 247 - "ContextCompressor"
Cohesion: 0.11
...
### Community 251 - "chat_handlers.py"
Cohesion: 0.12
...
### Community 252 - "RateLimitTracker"
Cohesion: 0.10
...
### Community 253 - "control_registry.py"
Cohesion: 0.10
...
### Community 254 - "test_mcp_governance.py"
Cohesion: 0.11
...
### Community 260 - "test_microagents.py"
Cohesion: 0.15
...
### Community 263 - ".execute"
Cohesion: 0.07
Nodes (28): seed_default_providers(), _best_cloud_primary_base(), TaskResult, TaskSpec, Execute a TaskSpec using the internal AgentRunner and convert the agent's…, Create an isolated execution context for a single task. Tries ``git worktree…, Clean up the worktree or temp copy created by ``_create_worktree``., Return the highest-priority available cloud LLM base URL. Tries free cloud… (+20 more)

### Community 264 - "Langfuse Observability Guide"
Cohesion: 0.06
...
### Community 267 - "BrainFailoverManager"
Cohesion: 0.08
...
### Community 268 - "test_failover_silent_exhaustion.py"
Cohesion: 0.10
...
### Community 272 - "test_unit7_catalog_propagation.py"
Cohesion: 0.07
...
### Community 274 - "Quick-Note GitHub Issues Processing - Session Summary"
Cohesion: 0.06
...
### Community 277 - "session_retro.py"
Cohesion: 0.13
...
### Community 278 - "test_telegram_approval_gate.py"
Cohesion: 0.09
Nodes (21): Path, Start the Telegram bot. Returns True if started successfully., Signal the bot to stop and wait for graceful shutdown., Run the Telegram bot long-poll loop (inline, not subprocess)., Run the bot with stop-event awareness., Manages the Telegram bot as a managed service alongside ollama/proxy/tunnel.…, TelegramBotManager, _clear_telegram_env() (+13 more)

### Community 279 - "test_brain_failover.py"
Cohesion: 0.11
...
### Community 282 - "test_autonomy_gate.py"
Cohesion: 0.11
...
### Community 283 - "tests/test_browser.py"
Cohesion: 0.10
...
### Community 288 - "test_colibri_provider.py"
Cohesion: 0.12
...
### Community 289 - "switch_brain.py"
Cohesion: 0.16
Nodes (29): detect_ollama_models(), dim(), fail(), get_auth_headers(), get_brain_config(), get_ngrok_tunnel_url(), header(), info() (+21 more)

### Community 290 - "CEOLedger"
Cohesion: 0.09
Nodes (21): _backend(), CEOLedger, _now(), services/ceo_ledger.py — durable record of what the CEO is driving to closure.…, Durable store for :class:`GoalRecord`s. Every method is best-effort and never…, Persist *goal*, stamping ``updated_at``., Mongo server-selection timeout, read and clamped at call time. Parsing this at…, Return the most recently updated goals regardless of state. (+13 more)

### Community 291 - "test_portfolio_intelligence.py"
Cohesion: 0.08
...
### Community 292 - "test_rag_context.py"
Cohesion: 0.12
...
### Community 293 - "ProjectScaffolder"
Cohesion: 0.13
...
### Community 296 - "PriorityTaskQueue"
Cohesion: 0.11
...
### Community 297 - "SteeringInjector"
Cohesion: 0.11
...
### Community 298 - "test_claude_setup_audit.py"
Cohesion: 0.16
...
### Community 300 - "test_internal_agent_did_work.py"
Cohesion: 0.12
...
### Community 302 - "Python Dependencies (`requirements.txt`)"
Cohesion: 0.07
...
### Community 303 - "Technical Debt Register — local-llm-server"
Cohesion: 0.07
...
### Community 304 - "test_backend_server_features.py"
Cohesion: 0.08
...
### Community 306 - "test_agent_free_brain.py"
Cohesion: 0.08
Nodes (20): allow_paid_brain(), True only when the operator explicitly opted into a paid (Anthropic) brain.…, _FakeAsyncClient, _FakeResponse, _free_env(), Free-brain policy regression tests for the agent runtime (issue #656).…, The core #656 regression: an Anthropic-shaped model must NOT hit…, Free policy + Anthropic-shaped model + NO NVIDIA key → refuse loudly, never… (+12 more)

### Community 307 - "RuntimeHealthService"
Cohesion: 0.09
...
### Community 309 - "test_crispy_burn_in.py"
Cohesion: 0.07
...
### Community 310 - "TestBrainFailoverModelUpdates"
Cohesion: 0.12
...
### Community 311 - "test_provider_enable_disable.py"
Cohesion: 0.09
...
### Community 312 - "test_skill_registry_boot_refresh.py"
Cohesion: 0.12
...
### Community 314 - "llm_providers.py"
Cohesion: 0.17
...
### Community 315 - "Deploy: FreeBuff Telegram bot (24×7)"
Cohesion: 0.07
...
### Community 316 - "Claude Code + Qwen Local Setup"
Cohesion: 0.07
...
### Community 317 - "generate_context.py"
Cohesion: 0.12
...
### Community 318 - "isolated_telegram_config"
Cohesion: 0.11
...
### Community 319 - "test_scheduler_hydration_bounded.py"
Cohesion: 0.09
...
### Community 322 - "LLM Router — troubleshooting"
Cohesion: 0.08
...
### Community 326 - "test_telegram_approval_e2e.py"
Cohesion: 0.12
...
### Community 329 - "HarnessEnrichment"
Cohesion: 0.12
...
### Community 330 - "IssueCategory"
Cohesion: 0.14
Nodes (23): IssueCategory, IssueSeverity, Enum, str, _match_family(), Any, services/issue_triage.py — inbound GitHub issue triage. Closes the intake gap…, Classify a single GitHub issue payload and return the routing decision. Pure… (+15 more)

### Community 331 - "dependencies"
Cohesion: 0.08
Nodes (25): axios, fast-uri, dependencies, axios, fast-uri, livekit-client, lucide-react, react (+17 more)

### Community 332 - "1. The Rules"
Cohesion: 0.08
...
### Community 337 - "test_north_mini_code.py"
Cohesion: 0.08
...
### Community 339 - "test_phase4_runtime_resilience.py"
Cohesion: 0.13
...
### Community 341 - "TemporalContextGraph"
Cohesion: 0.10
...
### Community 342 - "test_brain_priority_scanner.py"
Cohesion: 0.10
...
### Community 343 - "test_daily_automation_2026_08_03.py"
Cohesion: 0.11
...
### Community 344 - "TestClassifyPlainText"
Cohesion: 0.08
...
### Community 345 - "test_service_token.py"
Cohesion: 0.08
...
### Community 346 - "github_tools.py"
Cohesion: 0.20
Nodes (23): get_repo(), _get_token(), _get_user(), init_workspace(), list_branches(), list_prs(), list_repos(), BaseModel (+15 more)

### Community 347 - "timedelta"
Cohesion: 0.14
Nodes (19): PR throughput per cohort over the last `days` days., Count distinct sessions per user. A session ends when there's a gap of more…, Return True if a fetched oauth_states doc is a valid, unexpired login state., _valid_login_state(), Backdates the older row via raw SQLite UPDATE so it falls outside the cutoff…, _doc(), Regression tests for social-login (GitHub & Google) OAuth state handling. Bug…, MongoDB/motor returns naive UTC datetimes. Subtracting a naive datetime from an… (+11 more)
...
### Community 349 - "Local AI Stack with Docker"
Cohesion: 0.08
...
### Community 350 - "Traffic Distribution Across Providers"
Cohesion: 0.08
...
### Community 351 - "Implementation Prompt: Rich TaskBoard + Agile Sprint Integration"
Cohesion: 0.08
...
### Community 352 - "Telegram Bot Setup"
Cohesion: 0.08
...
### Community 353 - "video_transcript.py"
Cohesion: 0.12
...
### Community 356 - "CircuitState"
Cohesion: 0.16
Nodes (14): ProviderHealth, Circuit-breaker state for a provider., CircuitState, Regression guard: a rate-limit cooldown must survive, on every route.…, The anti-wedge valve must not fire for an ordinary 429 backoff — otherwise it…, The threshold must clear the widest backoff ANY registered provider can earn.…, A corrupted/absurd cooldown must still be recoverable., The honest reset: probe permitted, failure history kept. (+6 more)

### Community 357 - "NotificationDispatcher"
Cohesion: 0.15
Nodes (17): NotificationDispatcher, Routes background task results to configured notification channels. Currently…, test_send_approval_gate_redacts_goal_and_steps(), test_send_approval_gate_returns_false_without_config(), test_send_approval_gate_sends_message_with_approve_reject_keyboard(), test_send_approval_gate_sends_to_all_configured_chats(), _FakeResponse, _make_task() (+9 more)

### Community 358 - "test_regression.py"
Cohesion: 0.12
...
### Community 359 - "test_agency_fix.py"
Cohesion: 0.08
...
### Community 360 - "test_output_filter.py"
Cohesion: 0.08
...
### Community 361 - "test_telegram_mutating_commands.py"
Cohesion: 0.08
...
### Community 362 - "test_workspace_security.py"
Cohesion: 0.10
...
### Community 364 - "Agent Governance Guide"
Cohesion: 0.09
...
### Community 365 - "The fifteen strategies"
Cohesion: 0.09
...
### Community 369 - "WindowsServiceManager"
Cohesion: 0.18
...
### Community 371 - "SyntheticDataPipeline"
Cohesion: 0.13
...
### Community 372 - "test_all_features.py"
Cohesion: 0.09
...
### Community 377 - "test_mostly_failed_steps.py"
Cohesion: 0.12
...
### Community 380 - "classify_direct_chat_intent"
Cohesion: 0.13
...
### Community 384 - "reap_expired_companies"
Cohesion: 0.15
...
### Community 385 - "services/seo_audit.py"
Cohesion: 0.13
Nodes (14): _count_syllables(), estimate_pixel_width(), flesch_reading_ease(), _host_key(), is_internal(), normalize_url(), services/seo_audit.py - World-Class SEO / GEO / AIO Audit Engine Screaming…, Fetch sitemap candidates (one index level deep) and collect page URLs. (+6 more)

### Community 386 - "test_ceo_router.py"
Cohesion: 0.19
...
### Community 388 - "test_dashboard_cache.py"
Cohesion: 0.15
...
### Community 389 - "openclaw_gateway.py"
Cohesion: 0.15
...
### Community 390 - "_resolve_user_github_token"
Cohesion: 0.18
...
### Community 391 - "V3 API Migration Plan — LLM Relay Platform"
Cohesion: 0.10
...
### Community 395 - "system_instruction"
Cohesion: 0.16
...
### Community 397 - "NIMConnectionPool"
Cohesion: 0.13
...
### Community 398 - "weekly_digest.py"
Cohesion: 0.13
...
### Community 399 - "test_local_controller.py"
Cohesion: 0.17
...
### Community 400 - "run_trend_analysis"
Cohesion: 0.19
...
### Community 401 - "test_unit5_ui_provider_surface.py"
Cohesion: 0.10
...
### Community 403 - "test_permissions.py"
Cohesion: 0.15
...
### Community 404 - "PersistentMemoryStore"
Cohesion: 0.24
...
### Community 412 - "Docker AI Governance Audit — Final Report"
Cohesion: 0.10
...
### Community 413 - "1. Capability-by-capability"
Cohesion: 0.10
...
### Community 415 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 416 - "ControlsScreen.jsx"
Cohesion: 0.15
...
### Community 421 - "_process_task_callback"
Cohesion: 0.20
...
### Community 424 - "test_backend_runtime_bootstrap.py"
Cohesion: 0.11
...
### Community 425 - "test_tasks_cache_ttl_env.py"
Cohesion: 0.21
...
### Community 426 - "test_telegram_task_callback.py"
Cohesion: 0.13
...
### Community 427 - "test_voice_pipeline.py"
Cohesion: 0.14
...
### Community 431 - "_extract_tech_relevance"
Cohesion: 0.17
...
### Community 434 - "Analysis & Synthesis Instructions"
Cohesion: 0.11
Nodes (18): 1. Define the Atmosphere, 2. Map the Color Palette, 3. Establish Typography Rules, 4. Define the Hero Section, 5. Describe Component Stylings, 6. Define Layout Principles, 7. Define Responsive Rules, 8. Encode Motion Philosophy (+10 more)

### Community 435 - "Production Readiness Assessment — local-llm-server"
Cohesion: 0.11
...
### Community 436 - "TestNormalizeResponseFormat"
Cohesion: 0.11
...
### Community 437 - "Skill: fabric-patterns"
Cohesion: 0.11
Nodes (18): 1. Ensure Pattern Directory Exists, 2. List Available Patterns, 3. Retrieve a Pattern, 4. Apply a Pattern with Variables, 5. Stitch Patterns Together, 6. Create New Patterns, Acceptance Checks, Directory Structure (+10 more)

### Community 438 - "db/__init__.py"
Cohesion: 0.15
...
### Community 439 - "Admin Dashboard Guide"
Cohesion: 0.11
...
### Community 440 - "Implementation Plan"
Cohesion: 0.11
...
### Community 442 - "ProviderConsole.jsx"
Cohesion: 0.11
...
### Community 444 - "Delegation Plan (agent-ready work packages)"
Cohesion: 0.11
...
### Community 445 - "build_workflow.py"
Cohesion: 0.33
...
Cohesion: 0.12
Nodes (14): _embedded_run(), _fb_run(), Execute a FreeBuff task (embedded or via proxy). Shape: {result: {...}}., Run FreeBuffAgent in-process against a fresh clone, committing + opening a PR.…, Tests for the always-on FreeBuff Telegram bot: embedded vs HTTP dispatch., In orchestrator mode the embedded run must set the bypass so the agent runs., Snapshot/restore os.environ — the launcher writes env vars directly., _restore_env() (+6 more)

### Community 448 - "test_brain_patch_service_token.py"
Cohesion: 0.18
...
### Community 449 - "TestSelfHealingInfrastructureClassification"
Cohesion: 0.19
...
### Community 451 - "test_schedule_persistence.py"
Cohesion: 0.15
...
### Community 452 - "validate_session_id"
Cohesion: 0.16
...
### Community 453 - "ErrorInterceptorMiddleware"
Cohesion: 0.18
...
### Community 454 - "Comprehensive Skill Index (By Category)"
Cohesion: 0.11
...
### Community 455 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 456 - "Component Map"
Cohesion: 0.11
...
### Community 457 - "Agent State — colibri GLM-5.2 deployment (resumable)"
Cohesion: 0.11
...
### Community 458 - "Architecture Overview — local-llm-server"
Cohesion: 0.11
...
### Community 459 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
...
### Community 461 - "Part A — Health Report"
Cohesion: 0.11
...
### Community 464 - "sync_readme_gallery.py"
Cohesion: 0.22
...
### Community 465 - "CircuitBreakerOpenError"
Cohesion: 0.14
...
### Community 466 - "test_skill_executors_live.py"
Cohesion: 0.16
...
### Community 469 - "test_company_api.py"
Cohesion: 0.11
...
### Community 470 - "test_provider_policy.py"
Cohesion: 0.14
...
### Community 471 - "TestStopSlopChecker"
Cohesion: 0.11
...
### Community 472 - "handle_workflow_ide_chat"
Cohesion: 0.18
...
### Community 473 - ".from_agent_job"
Cohesion: 0.18
Nodes (7): Any, field_validator, Accept a bare string (legacy runner output) or a full dict., Build a snapshot from an ``AgentJob`` dataclass instance., model_validator, Build a minimal mock AgentJob-like object., TestAgentJobSnapshot

### Community 474 - "TestHelpers"
Cohesion: 0.15
...
### Community 476 - "SKILL: Industrial Brutalism & Tactical Telemetry UI"
Cohesion: 0.12
...
### Community 477 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 478 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 479 - "test_admin_local_brain_router.py"
Cohesion: 0.18
...
### Community 480 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 481 - "Section-by-Section Acceptance Criteria"
Cohesion: 0.12
...
### Community 485 - "redact_connection_url"
Cohesion: 0.17
...
### Community 487 - "agent_readiness_audit.py"
Cohesion: 0.21
...
### Community 490 - "test_shared_state.py"
Cohesion: 0.17
...
Cohesion: 0.18
Nodes (16): _is_duplicate_key_error(), Exception, True if *exc* is a pymongo E11000 duplicate-key error. Checked by class name…, _FakeDuplicateKeyError, _mock_mongo_db(), asyncio, Exception, tests/test_task_source_id_race.py — TaskStore.create() concurrency safety.… (+8 more)

### Community 493 - "test_activation_api.py"
Cohesion: 0.21
...
### Community 494 - "test_health_endpoints.py"
Cohesion: 0.17
...
### Community 495 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 496 - "test_openclaw_endpoints.py"
Cohesion: 0.12
...
### Community 498 - "agency.py"
Cohesion: 0.17
Nodes (14): _build_ceo_prompt(), _build_quick_note_instruction(), _close_github_issue(), _collect_recent_git_context(), _fetch_github_quick_notes(), _gh_repo(), _gh_token(), _now_str() (+6 more)
...
### Community 500 - "MemoryMiddleware"
Cohesion: 0.17
...
### Community 501 - "._fetch_flat_skill_file"
Cohesion: 0.18
...
### Community 507 - "The 10-Step Workflow"
Cohesion: 0.12
...
### Community 509 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 510 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 511 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
...
### Community 512 - "implement_agent.py"
Cohesion: 0.16
...
### Community 513 - "brain.py"
Cohesion: 0.17
Nodes (15): BrainResolution, provider_api_key(), Return the live API key for *provider* (env-only — never persisted)., get_provider_role_tags(), _host_is_openai_compatible(), _norm(), _pick_from_records(), Any (+7 more)

### Community 514 - "fabric_cli.py"
Cohesion: 0.29
Nodes (15): cmd_apply(), cmd_list(), cmd_new(), cmd_save(), cmd_show(), cmd_stitch(), _ensure_patterns_dir(), main() (+7 more)

### Community 515 - "sync_ngrok.py"
Cohesion: 0.26
Nodes (14): detect_ngrok_url(), dim(), fail(), header(), info(), main(), ok(), patch_platform_brain_via_switch_brain() (+6 more)

### Community 516 - "test_p0_roadmap_b3_b4_b5.py"
Cohesion: 0.16
...
### Community 518 - "test_telegram_auto_approve.py"
Cohesion: 0.21
...
### Community 519 - "ManagedAgentDreams"
Cohesion: 0.22
...
### Community 521 - "telegram_service.py"
Cohesion: 0.15
...
### Community 523 - "test_dockerfile_ships_root_modules.py"
Cohesion: 0.17
...
### Community 524 - "test_frontend_deployment_guards.py"
Cohesion: 0.20
...
### Community 525 - "test_glm52_brain.py"
Cohesion: 0.12
...
### Community 526 - "test_langfuse_agency_wide.py"
Cohesion: 0.12
...
### Community 527 - "test_local_brain_state.py"
Cohesion: 0.12
...
### Community 531 - "test_telegram_diag_endpoint.py"
Cohesion: 0.12
...
### Community 535 - "Skill: agent-harness"
Cohesion: 0.13
...
### Community 536 - "Skill: checkpoint-strategy"
Cohesion: 0.13
...
### Community 538 - "Skill: local-ai-query"
Cohesion: 0.13
...
### Community 539 - "Skill: parallel-agents"
Cohesion: 0.13
...
### Community 540 - "Skill: parallel-worktrees"
Cohesion: 0.13
...
### Community 541 - "Design System: Taste Standard"
Cohesion: 0.13
...
### Community 544 - "Skill: user-research"
Cohesion: 0.13
...
### Community 545 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 546 - "Attention Mechanisms Internals"
Cohesion: 0.13
...
### Community 547 - "test_daily_2026_07_24.py"
Cohesion: 0.20
...
### Community 551 - "clear_wizard_state_cache"
Cohesion: 0.21
...
### Community 552 - "e2e/test_browser.py"
Cohesion: 0.23
...
### Community 557 - "test_provider_state_durability.py"
Cohesion: 0.14
...
### Community 559 - "test_background.py"
Cohesion: 0.21
...
### Community 569 - "monitor_colibri.py"
Cohesion: 0.24
...
### Community 577 - "Render MCP — autonomous platform debugging and environment monitoring"
Cohesion: 0.14
...
### Community 581 - "overrides"
Cohesion: 0.14
Nodes (14): @tootallnate/once, overrides, bfj, css-select, http-proxy-agent, jsonpath, nth-check, postcss (+6 more)

### Community 582 - "asyncio"
Cohesion: 0.14
Nodes (7): requires_db, asyncio, Test that storage service can be initialized., Test company CRUD operations - skipped as requires specific config., Test that specialist service can be initialized., Test that onboarding service can be initialized., End-to-end against the real Mongo (CI service): the exact handler sequence…

### Community 583 - "_RedisBackend"
Cohesion: 0.22
...
### Community 585 - "test_critical_flows.py"
Cohesion: 0.29
...
### Community 588 - "test_openclaw_gateway.py"
Cohesion: 0.14
...
### Community 589 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 592 - "Skill: Brain Dump"
Cohesion: 0.15
...
### Community 595 - "Skill: duplicate-thread"
Cohesion: 0.15
...
### Community 596 - "Skill: Email Triage"
Cohesion: 0.15
...
### Community 599 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
...
### Community 600 - "Skill: prompt-library"
Cohesion: 0.15
...
### Community 601 - "Skill: prompt-transparency"
Cohesion: 0.15
...
### Community 603 - "Skill: scope-guard"
Cohesion: 0.15
...
### Community 605 - "admin_update_task_router.py"
Cohesion: 0.22
...
### Community 607 - "Skill: graphify — Knowledge Graph Token Optimization"
Cohesion: 0.15
Nodes (12): Acceptance Checks, Claude's query protocol (use this instead of Read tool for exploration):, Graph Artifacts — What to Commit, How to Use the Graph (Token Savings Protocol), Installation (one-time per machine), Instead of reading raw files:, Key commands:, Relationship to repowise-intelligence Skill (+4 more)

### Community 608 - "Skill: platform-setup — Autonomous Agency Bootstrap"
Cohesion: 0.15
...
### Community 616 - "Agent Transparency Report"
Cohesion: 0.15
...
### Community 617 - "update_provider_policy"
Cohesion: 0.19
...
### Community 618 - "scan_repo_with_user_research.py"
Cohesion: 0.22
...
### Community 620 - "_InMemoryBackend"
Cohesion: 0.18
...
### Community 621 - ".on_task_complete"
Cohesion: 0.18
...
### Community 622 - "TestModelCostTableUpdates"
Cohesion: 0.26
...
### Community 623 - "TestMCPClientStructuredOutput"
Cohesion: 0.31
...
### Community 629 - "skill_registry.py"
Cohesion: 0.17
...
### Community 632 - "AGENTS.md — Codebase Map & Operations Reference"
Cohesion: 0.17
...
### Community 642 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 645 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 648 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 649 - "Workspace Isolation Architecture"
Cohesion: 0.17
...
### Community 650 - "Quantization Internals"
Cohesion: 0.17
...
### Community 651 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 652 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 653 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 656 - "check_container_posture.py"
Cohesion: 0.26
...
### Community 657 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 658 - "test_agile_api.py"
Cohesion: 0.17
...
### Community 659 - "test_app_settings.py"
Cohesion: 0.21
...
### Community 660 - "test_providers_live_e2e.py"
Cohesion: 0.27
...
### Community 661 - "test_skill_registry.py"
Cohesion: 0.20
...
### Community 662 - "TestAnthropicPayloadStructuredOutput"
Cohesion: 0.29
...
### Community 663 - "test_task_clarification.py"
Cohesion: 0.17
...
### Community 669 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 672 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 673 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 675 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 678 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 679 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 680 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 681 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 682 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 683 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 684 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 685 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 687 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 688 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 689 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 690 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 691 - "What to clean up"
Cohesion: 0.18
...
### Community 692 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 693 - "test_bedrock_live.py"
Cohesion: 0.25
...
### Community 694 - "provider_max_rpm"
Cohesion: 0.29
...
### Community 698 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 700 - "test_google_provider_models.py"
Cohesion: 0.18
...
### Community 704 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 705 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 706 - "TestNormalizeToolChoice"
Cohesion: 0.31
...
### Community 707 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 708 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 709 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 710 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 711 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 712 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 713 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 715 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 717 - "LLM Router — provider guide"
Cohesion: 0.20
...
### Community 718 - "CI Troubleshooting Runbook"
Cohesion: 0.20
...
### Community 720 - "build_tech_db.py"
Cohesion: 0.40
...
### Community 724 - "_resolve_push_token"
Cohesion: 0.31
...
### Community 725 - "test_bootstrap_source_id_index.py"
Cohesion: 0.27
...
### Community 726 - "TestZeroAttemptDiagnostics"
Cohesion: 0.29
...
### Community 727 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 730 - "_FakePersistence"
Cohesion: 0.20
...
### Community 735 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 736 - "Skill: changelog-enforcer"
Cohesion: 0.22
...
### Community 737 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 740 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 741 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 742 - "Skill: changelog-enforcer"
Cohesion: 0.22
Nodes (8): Acceptance Checks, Changelog Location, Entry Format, Examples, Hook Behaviour, Instructions, Skill: changelog-enforcer, When to Use

### Community 743 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
Nodes (8): Branch, Components, Purpose, Quick Start, Session Roles, Skill: cowork-session (Claude Cowork), Testing, When to Use

### Community 744 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 745 - "Active Task Tracker"
Cohesion: 0.22
...
### Community 747 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 749 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 750 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 751 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 752 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 753 - "Platform Controls"
Cohesion: 0.22
...
### Community 758 - "ENGINEERING_STANDARDS.md — Patterns & Reference"
Cohesion: 0.22
...
### Community 767 - "_start_ceo_agency"
Cohesion: 0.31
...
### Community 769 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 770 - "test_changelog_parity_guard.py"
Cohesion: 0.22
...
### Community 772 - "TestGithubSignalHardening"
Cohesion: 0.22
...
### Community 773 - "TestPaidPolicyDurability"
Cohesion: 0.22
...
### Community 774 - "test_scanner_deps_parity.py"
Cohesion: 0.31
...
### Community 780 - "quality_checker.py"
Cohesion: 0.32
...
### Community 788 - "GitHub Branch Protection Settings"
Cohesion: 0.25
...
### Community 789 - "ADR 001: Self-Hosted OpenAI-Compatible Proxy"
Cohesion: 0.25
Nodes (7): ADR 001: Self-Hosted OpenAI-Compatible Proxy, Consequences, Context, Decision, Negative, Neutral, Positive

### Community 790 - "ADR 002: Dynamic Model Routing with Task Classification"
Cohesion: 0.25
...
### Community 825 - "TOP 6 — Highest-ROI Items (Validated by Opus Research Agent)"
Cohesion: 0.25
...
### Community 826 - "SECTION A — Agent Efficiency (Hermes / AOS / MYT)"
Cohesion: 0.25
...
### Community 827 - "SECTION C — Direct Chat Improvements (CBF / HRM)"
Cohesion: 0.25
...
### Community 828 - "Runbook — Instance Activation"
Cohesion: 0.25
...
### Community 829 - "Prime Agent Runtime"
Cohesion: 0.25
...
### Community 836 - "test_compose_and_coordinate_api.py"
Cohesion: 0.36
...
### Community 837 - "test_generate_context_standing_instructions.py"
Cohesion: 0.32
...
### Community 841 - "test_provider_models_db_outage.py"
Cohesion: 0.25
...
### Community 843 - "test_runtimes_health_endpoint.py"
Cohesion: 0.25
...
### Community 844 - "test_seo_audit_pending_expiry.py"
Cohesion: 0.43
...
### Community 847 - "test_task_store_fails_loud_in_production.py"
Cohesion: 0.25
...
### Community 849 - "TOOLS.md — Available Tools for AI Agents"
Cohesion: 0.25
...
### Community 857 - "AI Engineering Insights Skill"
Cohesion: 0.29
...
### Community 869 - "Implementation plan + TO-DO (check off as you go)"
Cohesion: 0.29
...
### Community 872 - "Cloudflare = the real working app"
Cohesion: 0.29
...
### Community 873 - "Workspace Issues"
Cohesion: 0.29
...
### Community 874 - "Model and Response Issues"
Cohesion: 0.29
...
### Community 881 - "CLAUDE.md — router/"
Cohesion: 0.29
...
### Community 883 - "check_changelog_parity.py"
Cohesion: 0.43
...
### Community 884 - "e2e_smoke.py"
Cohesion: 0.57
Nodes (5): _chat(), check(), _health(), _models(), _req()

### Community 885 - "BackgroundServices"
Cohesion: 0.38
...
### Community 891 - "test_doctor_coding_brain.py"
Cohesion: 0.38
...
### Community 892 - "TestGithubTokenSQLiteRegression"
Cohesion: 0.38
...
### Community 909 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 910 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 911 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 912 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 913 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 914 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 928 - "TestCitationBinding"
Cohesion: 0.47
...
### Community 948 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 949 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 952 - "Agent API Issues"
Cohesion: 0.40
...
### Community 953 - "Network and Tunnel Issues"
Cohesion: 0.40
...
### Community 954 - "knowledgeGraphTab.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 955 - "loginFlowNoTimeout.test.js"
Cohesion: 0.40
Nodes (4): apiSource, { describe, test, expect }, fs, path

### Community 956 - "test_company_stale_id_recovery.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 957 - "worker_no_cache.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, workerSource

### Community 958 - "scripts/agile_ceremonies.py"
Cohesion: 0.60
Nodes (4): _load(), main(), ModuleType, _write_summary()

### Community 959 - "governance/__init__.py"
Cohesion: 0.40
Nodes (3): __getattr__(), Any, packages/governance — agent identity, policy, approvals, audit, sandboxes. The…

### Community 960 - "Prompt Library Changelog"
Cohesion: 0.40
Nodes (4): Added, Format, Prompt Library Changelog, [Unreleased]

### Community 961 - "_add_colibri_shim_changelog_entry.py"
Cohesion: 0.50
...
### Community 962 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 963 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 964 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 965 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 966 - "setup_colibri.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 967 - "setup_colibri.sh script"
Cohesion: 0.70
Nodes (4): setup_colibri.sh script, fail(), ok(), warn()

### Community 968 - "status_colibri_server.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()
...
### Community 1008 - "test_skills_route_order.py"
Cohesion: 0.67
...
### Community 1009 - "test_feature_stores_are_wired_on_demand_not_eagerly"
Cohesion: 0.50
...
### Community 1010 - "github"
Cohesion: 0.50
Nodes (3): github, enabled, silent

### Community 1035 - "test_the_reserve_is_bounded_when_read_from_the_environment"
Cohesion: 0.67
...
### Community 1036 - "test_direct_adapter_does_not_bypass"
Cohesion: 0.67
...
- **Why does `_fixture()` connect `_fixture` to `ProviderConfig`, `ExecutionRequest`, `test_llm_router_queue_cache.py`, `test_telegram_auto_approve.py`, `test_autonomy_status.py`, `AgentSessionStore`, `Task`, `test_llm_router_strategies.py`, `ImprovementLoop`, `test_local_brain_state.py`, `test_operational_incidents.py`, `TestChatHistoryStore`, `test_brain_config_store.py`, `test_phase5_doctor.py`, `test_telegram_diag_endpoint.py`, `failover_client.py`, `MCPUnavailableError`, `test_autonomous_agency_e2e.py`, `PrimeAgentAdapter`, `test_model_router.py`, `config.py`, `SelfHealingAgent`, `test_unit8_model_catalog.py`, `TrafficDirector`, `SeoAuditRequest`, `e2e/test_browser.py`, `test_llm_router_resilience.py`, `tasks/models.py`, `resolve_identity`, `test_provider_state_durability.py`, `CEOSupervisor`, `MCPClient`, `KeyStore`, `SecretRecord`, `test_knowledge_sync.py`, `Surface`, `test_sam_livekit.py`, `test_failover_client_shared.py`, `brain_failover.py`, `_enable_filter`, `ResearchTask`, `TestHarnessAdapter`, `TestClient`, `test_ai_insights.py`, `test_openclaw_gateway.py`, `ProceduralMemoryStore`, `Task`, `get_self_healing_agent`, `test_llm_router_e2e.py`, `resolve_e2b_config`, `FailureCategory`, `test_new_features_e2e.py`, `BrainConfig`, `test_agent_tool_governance.py`, `test_self_heal_v2.py`, `cost_tracker.py`, `gateway.py`, `_Budget`, `SeoFixer`, `test_doctor_service_token_check.py`, `api_keys_for`, `test_context_rulebook.py`, `ArtifactStore`, `get_feature_matrix`, `ModelRouter`, `test_sam_voice.py`, `E2BAdapter`, `test_kimi_bridge_server.py`, `OnboardingService`, `ChatHistoryStore`, `test_agile_api.py`, `test_app_settings.py`, `TaskIn`, `test_telegram_freebuff.py`, `test_task_clarification.py`, `persist_plan_spec`, `TestEstimateTokensForMessages`, `AgentProfile`, `test_platform_controls.py`, `test_e2b_task_wiring.py`, `OllamaCircuitBreaker`, `test_rate_limiter.py`, `test_features_api.py`, `test_video_transcript.py`, `SchedulerStore`, `test_e2b_data_flow.py`, `test_contracts_agency.py`, `TrendWatcher`, `test_portfolio_intake.py`, `test_crispy_workflow.py`, `test_trend_watcher.py`, `_resolve_push_token`, `TestMongoGate`, `TestClient`, `ContextPruner`, `._check_permissions`, `test_persistent_memory.py`, `SpecEntry`, `SecurityScanner`, `resolve_active_brain`, `test_colibri_brain_shim.py`, `test_control_plane_api.py`, `test_mcp_governance.py`, `_start_ceo_agency`, `TestSwarmRoleRouting`, `test_startup_warmup.py`, `session_retro.py`, `test_telegram_approval_gate.py`, `test_purge_backlog.py`, `CEOLedger`, `OrchestratorQueue`, `test_agent_free_brain.py`, `test_crispy_burn_in.py`, `test_provider_enable_disable.py`, `test_skill_registry_boot_refresh.py`, `isolated_telegram_config`, `test_scheduler_hydration_bounded.py`, `analyze_page`, `test_ping.py`, `test_runtimes_health_endpoint.py`, `test_task_store_fails_loud_in_production.py`, `ClaudeCodeAdapter`, `test_service_token.py`, `NotificationDispatcher`, `test_regression.py`, `test_agency_fix.py`, `WorkflowBuildRequest`, `client`, `test_monitor_lib.py`, `test_v4_api.py`, `test_doctor_coding_brain.py`, `reap_expired_companies`, `test_dashboard_cache.py`, `_resolve_user_github_token`, `allow_paid`, `test_telegram_task_callback.py`, `test_voice_pipeline.py`, `TestNormalizeResponseFormat`, `test_freebuff_bot.py`, `test_brain_patch_service_token.py`, `test_company_api.py`, `SQLiteStore`, `test_shared_state.py`, `test_openclaw_endpoints.py`?**
  _High betweenness centrality (0.111) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `ExecutionRequest`, `UserMemoryStore`, `_StubManager`, `.execute`, `proxy.py`, `E2BAdapter`, `loop.py`, `AgentSessionStore`, `StuckDetector`, `TaskSpec`, `TestMCPServer`, `FreeBuffAgent`, `MCPUnavailableError`, `test_autonomous_agency_e2e.py`, `AdaptiveHalter`, `AutonomyTracker`, `test_ceo_dispatcher.py`, `Workspace`, `MCPClient`, `test_agent_free_brain.py`, `WorkspaceTools`, `MultiAgentSwarm`, `test_empirical_verify.py`, `test_failover_client_shared.py`, `test_contracts_agency.py`, `TestAgentLoopMCPIntegration`, `CEODispatcher`, `TestZeroAttemptDiagnostics`, `ContextPruner`, `test_agent_tool_governance.py`, `GitHubTools`, `test_self_heal_v2.py`, `test_governance_api.py`, `TokenBudget`, `ReactScratchpad`, `ContextManager`, `api_keys_for`, `LocalWorkspace`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderConfig` to `backend/server.py`, `test_colibri_provider.py`, `UserMemoryStore`, `CircuitState`, `_Budget`, `gateway.py`, `test_all_providers_discovery.py`, `TrafficDirector`, `NvidiaProvider`, `AgentSessionStore`, `test_colibri_brain_shim.py`, `system_instruction`, `test_anthropic_router.py`, `test_bedrock_live.py`, `TestAnthropicPayloadStructuredOutput`, `failover_client.py`, `settings.py`, `TestActiveStrategy`?**
