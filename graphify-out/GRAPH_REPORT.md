...
## Corpus Check
- 1430 files · ~2,046,363 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 28321 nodes · 57040 edges · 1149 communities (1025 shown, 124 thin omitted)
- Extraction: 89% EXTRACTED · 11% INFERRED · 0% AMBIGUOUS · INFERRED: 6298 edges (avg confidence: 0.54)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d70604d1`
...
## Communities (1149 total, 124 thin omitted)

### Community 0 - "backend/server.py"
Cohesion: 0.01
Nodes (441): get_harness_adapter(), admin_seed(), _agent_provider_failure_response(), _agent_timeout_fallback_response(), _append_agent_session_message(), auth_me(), auto_recommend_skills(), autonomy_status() (+433 more)

### Community 1 - "ProviderConfig"
Cohesion: 0.01
Nodes (221): get_tracker(), Return the process-singleton RateLimitTracker., _acquire_provider_probe(), clear_cooldowns(), _dead_model_key(), _exponential_backoff_cooldown(), extract_openai_text(), get_dead_models() (+213 more)

### Community 2 - "AgentScheduler"
Cohesion: 0.03
Nodes (162): Agency, CEO-coordinated multi-agent agency for continuous codebase management. The CEO…, AgentJobRequest, AgentJobSnapshot, Complete point-in-time view of a job, safe to serialise as API response., Convenience: the canonical text response, whether success or failure., Validated input for creating a new agent job. Passed from the API handler into…, DirectChatDoctor (+154 more)

### Community 3 - "AgentSessionStore"
Cohesion: 0.02
Nodes (153): PreflightIssue, PreflightReport, BaseModel, Agent subsystem — planner / executor / verifier loop., AgentJob, AgentJobManager, make_isolated_workspace(), _now() (+145 more)

### Community 4 - "WorkflowRun"
Cohesion: 0.02
Nodes (158): FeatureMaturity, str, Feature maturity classification., get_orchestrator_checkpoint_store(), _NoopDB, OrchestratorCheckpointStore, services/orchestrator_checkpoint.py — Durable step-level checkpointing Issue…, Fallback in-memory store when no DB is available. (+150 more)

### Community 5 - "AgentRunner"
Cohesion: 0.02
Nodes (131): AgentRunner, _check_extra_kwargs(), _enforce_signature(), _note_phase_end(), _note_phase_start(), Any, Path, Raise TypeError if fn's signature drifts from the locked contract (Pydantic… (+123 more)

### Community 6 - "company_api.py"
Cohesion: 0.05
Nodes (144): AccountLifecycleResponse, _DoctorCheck, _DoctorReport, get_public_doctor_report(), OnboardingAnswersRequest, OnboardingProgressResponse, OnboardingQuestionsRequest, provision_specialist() (+136 more)
...
Cohesion: 0.03
Nodes (149): Any, Return recent commits with agent attribution trailers parsed out., get_sam(), agent/sam.py — SAM Voice Agent (System Autonomy Manager) SAM is the voice-…, get_skill_registry_safe(), Return the global SkillRegistry if set, else None. Used by onboarding and other…, middleware, admin_control() (+141 more)

### Community 9 - "llm/router.py"
Cohesion: 0.02
Nodes (132): _load(), main(), int, get_budget(), packages/llm/budget.py — token and cost accounting with spend alerts. Tracks…, The process-wide budget tracker., Test hook — clear all usage accounting., reset() (+124 more)

### Community 10 - "test_llm_router_queue_cache.py"
Cohesion: 0.02
Nodes (101): CacheManager, cosine_similarity(), _Entry, LRUCache, payload_key(), Any, T, Live (unexpired) entries — used by the semantic layer's scan. (+93 more)

### Community 11 - "MCPUnavailableError"
Cohesion: 0.03
...
Cohesion: 0.03
Nodes (107): count, HealthConfig, Strategy selection and degradation behaviour., Circuit breaker + health tracking thresholds., RoutingConfig, BreakerState, HealthTracker, _Outcome (+99 more)
...
### Community 16 - "SeoAuditRequest"
Cohesion: 0.03
Nodes (60): field_validator, A single occurrence of a check firing on a specific URL., Aggregated report row - Screaming Frog CSV compatible., Site-level facts discovered during the crawl., Request to run an SEO/GEO/AIO audit against a website., SeoAuditRequest, SeoIssueInstance, SeoIssueReportRow (+52 more)

### Community 17 - "get_runtime_manager"
Cohesion: 0.03
Nodes (99): E2BAdapter, Any, Declare ``E2B_API_KEY`` as a required env dependency. The base ``preflight``…, Runtime adapter that executes tasks inside an E2B sandbox. Activation:…, _enrich_runtimes(), get_decision_log(), get_policy(), get_runtime() (+91 more)

### Community 18 - "TaskStore"
Cohesion: 0.04
Nodes (91): quick_notes_submit(), Submit a quick-note URL or instruction from the dashboard FAB., Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., tasks — Task/issue management system. Provides a lightweight task/issue tracker…, tasks/issue_intake.py — Auto issue → Task intake (Autonomy Charter G3) Turns…, Enum, str (+83 more)

### Community 19 - "test_governance_enforcement.py"
Cohesion: 0.03
Nodes (93): ApprovalRequest, ApprovalStatus, ApprovalStore, Any, Enum, str, packages/governance/approvals.py — human-in-the-loop for high-risk actions. The…, Bounded, in-process store of approval requests. Uses a :class:`threading.Lock`… (+85 more)
...
### Community 22 - "seo_api.py"
Cohesion: 0.03
Nodes (99): account_lifecycle(), auto_recommend_skills(), create_company(), delete_company_endpoint(), get_company(), get_company_access(), get_company_graph(), _get_current_user_thunk() (+91 more)
...
### Community 24 - "TaskSpec"
Cohesion: 0.05
Nodes (72): kimi_bridge_runtime_config(), Return Kimi bridge config for external runtimes (Hermes, Goose, Aider). Returns…, TaskResult, TaskSpec, runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized). Aider…, Run aider non-interactively via `--message` flag., runtimes/adapters/claude_code.py — Claude Code CLI adapter (FIRST CLASS).…, runtimes/adapters/docker_agent.py — Docker-based agent runtime adapter. Spawns… (+64 more)
...
Cohesion: 0.03
Nodes (85): BrainConfig, BrainConfigStore, default_brain_config(), invalidate_brain_config_cache(), _provider_env_value(), provider_key_rotation_enabled(), BaseModel, services/brain_config_store.py — DB-persisted, UI-switchable "brain" config.… (+77 more)

### Community 27 - "ProviderManager"
Cohesion: 0.06
Nodes (68): _fake_user_auth(), Path, test_admin_can_create_anthropic_provider_via_webui_admin_api(), test_admin_can_create_provider_via_webui_admin_api(), test_ui_providers_and_workspaces_use_app_state(), _bootstrap(), Path, ProviderManager (+60 more)

### Community 28 - "GovernanceGate"
Cohesion: 0.04
Nodes (73): build_governance_router(), Any, APIRouter, backend/governance_router.py — read and operate the governance layer. Mounted…, Reject non-admin callers. Mirrors the RBAC check used elsewhere in this backend…, _require_admin(), _load(), mcp_server/governance.py — governance adapter for the MCP HTTP surface. Closes… (+65 more)
...
Cohesion: 0.03
Nodes (84): get_improvement_loop(), Public snapshot of live agency state (used by the LiveKit worker tools)., Gather live agency state for SAM's situational awareness., get_self_healing_agent(), heal_signature(), HealingEvent, _now(), Any (+76 more)

### Community 32 - "FreeBuffAgent"
Cohesion: 0.12
Nodes (84): BackgroundTask, CommitAttribution, CommitTracker, Path, agent/commit_tracker.py — AI Commit Attribution Tags git commits with metadata…, Create git commits enriched with agent-session attribution trailers. Usage::…, Return ``--trailer`` arguments ready to append to a ``git commit`` call., Stage *files* and create an attributed commit. Returns the commit SHA on… (+76 more)
...
Cohesion: 0.03
Nodes (81): cancel_onboarding(), generate_onboarding_questions(), _get_fallback_questions(), match_specialists(), pause_onboarding(), patch, post, SystemType (+73 more)

### Community 35 - "Task"
Cohesion: 0.04
Nodes (58): _coerce_ts(), ExecutionLogEntry, Any, field_validator, Full task/issue document., Update the updated_at timestamp., Coerce ISO-8601 datetime strings (from DB) to float timestamps., Single entry in a task's execution log. (+50 more)
...
Cohesion: 0.04
Nodes (76): Hand the 'connect & verify the repo' work to the agency's own agents. The task…, _seed_connect_task(), ApprovalCheckpoint, Human approval gate in a task's execution., _is_brain_connection_error(), Any, BaseException, Task (+68 more)
...
### Community 39 - "resolve_identity"
Cohesion: 0.04
Nodes (68): AgentIdentity, new_session_id(), Any, packages/governance/identity.py — who is acting, and under what mandate. Docker…, Return a copy carrying extra execution context. Used when context arrives after…, Serialise for audit rows and API responses. Every field here is non-secret by…, Build an :class:`AgentIdentity` from whatever the caller knows. Total by design…, Return the stable ``agent:<slug>`` id for a human agent name. Deterministic and… (+60 more)
...
### Community 47 - "services/background.py"
Cohesion: 0.03
Nodes (72): build_ceo_router(), Any, APIRouter, backend/ceo_router.py — observability and manual control for the CEO. Surfaces…, Reject non-admin callers for routes that spend provider budget. Delegates to…, _require_admin(), _await_hermes_ready(), BackgroundServices (+64 more)
...
Cohesion: 0.05
Nodes (55): AgentRole, AgentSwarm, Any, agents/swarm.py — AgentSwarm: routes workflow phases to the correct agent. The…, Return the agent role responsible for *phase*., Return the AgentProfile for the agent driving *phase*., Return a JSON-serialisable summary of all agent profiles., Run a pre-gate or report phase through the correct agent. Enforces permission… (+47 more)

### Community 51 - "test_ceo_supervision.py"
Cohesion: 0.06
Nodes (72): _harvest_changed_files(), Extract the files a runtime touched. Returns ``(files, reported)``. Adapters…, GoalRecord, A subtask's full history: what it is, and every attempt at it., One piece of work the CEO has taken ownership of. ``state`` is the supervisor's…, Return ``(done, total)`` subtask counts., SubtaskRecord, What one sweep observed and did. Returned for tests and diagnostics. (+64 more)

### Community 52 - "AgentProfile"
Cohesion: 0.04
Nodes (52): agents/__init__.py — CRISPY multi-agent coding system., AgentProfile, _catalog_defaults(), _catalog_provider(), _get_defaults(), load_all_profiles(), make_architect_profile(), make_coder_profile() (+44 more)

### Community 53 - "SpecialistService"
Cohesion: 0.04
...
### Community 54 - "test_failover_client_shared.py"
Cohesion: 0.07
...
### Community 56 - "get_workflow_orchestrator"
Cohesion: 0.05
...
### Community 58 - "resolve_active_brain"
Cohesion: 0.05
Nodes (69): BrainResolution, provider_api_key(), provider_base_url(), Return the OpenAI-compatible base URL for *provider* (env- and UI-aware)., Return the live API key for *provider* (env-only — never persisted)., get_active_brain_sync(), get_brain_preference(), get_provider_role_tags() (+61 more)

### Community 59 - "SecretRecord"
Cohesion: 0.06
Nodes (57): _can_read(), _can_write(), create_secret(), _decrypt(), delete_secret(), _encrypt(), _get_master_key(), get_secret_metadata() (+49 more)

### Community 60 - "test_render_mcp.py"
Cohesion: 0.04
...
### Community 64 - "ToolRegistry"
Cohesion: 0.05
Nodes (38): get_tool_registry(), _infer_parameters_from_func(), Any, Path, Register a tool definition., Decorator to register a function as an agent tool. Usage::…, Remove a tool from the registry. Returns True if removed., Look up a tool by name. (+30 more)

### Community 65 - "test_mcp_registry.py"
Cohesion: 0.05
...
### Community 67 - "test_sam_livekit.py"
Cohesion: 0.04
...
### Community 68 - "DashboardLayout.js"
Cohesion: 0.04
...
### Community 71 - "CEOSupervisor"
Cohesion: 0.05
Nodes (53): brain_availability_summary(), Non-secret answer to "can the brain answer a request right now?". Three callers…, get_ceo_dispatcher(), Return the shared CEODispatcher singleton., Reset the singleton (test helper)., reset_ceo_dispatcher(), CEOSupervisor, _env_flag() (+45 more)

### Community 72 - "direct_chat.py"
Cohesion: 0.06
Nodes (65): Any, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, Translate technical preflight issues into a conversational assistant reply., translate_error_to_conversational(), ResumeRequest, AcceptedJob, AgentJobEnvelope, CompletedJob (+57 more)

### Community 73 - "RepowiseIntelligence"
Cohesion: 0.05
...
Cohesion: 0.05
Nodes (54): _backend(), CEOLedger, _now(), Any, services/ceo_ledger.py — durable record of what the CEO is driving to closure.…, Durable store for :class:`GoalRecord`s. Every method is best-effort and never…, Persist *goal*, stamping ``updated_at``., Return one goal by id, or ``None``. (+46 more)
...
### Community 77 - "PortfolioManager"
Cohesion: 0.04
Nodes (38): CapacityAllocation, InitiativeProgress, PortfolioManager, PortfolioMetrics, Enum, Agentic Portfolio Management — initiative prioritisation, capacity allocation,…, Percentage of linked sprint points completed., Result of fitting initiatives into a fixed capacity by WSJF priority. (+30 more)
...
### Community 79 - "test_runtime_governance.py"
Cohesion: 0.07
Nodes (57): _audit_dispatch(), _blocked_result(), _governance_check(), Any, TaskResult, TaskSpec, Evaluate a runtime dispatch against policy; audit it either way. Returns…, Full record of a routing decision — audit-trail entry. (+49 more)
...
### Community 82 - "TrendWatcher"
Cohesion: 0.08
Nodes (31): get_trend_watcher(), Any, AsyncClient, Path, agent/trend_watcher.py — Internet-connected AI trend intelligence. Fetches from…, Fetches AI trend signals from many public sources and surfaces relevant ones., Fetch all sources in parallel; return new alerts sorted by relevance., Fan trends out to onboarded companies whose stack matches (G4). For each… (+23 more)

### Community 83 - "portfolio_intelligence.py"
Cohesion: 0.05
Nodes (57): _bullets(), generate_backlog_retro(), generate_sprint_retro(), generate_standup(), plan_next_sprint(), Agentic Agile — autonomous ceremonies (standup, retro, sprint planning). Where…, Render a :class:`Retrospective` as a markdown section., Derive retro notes for ``sprint`` from its current metrics. Records… (+49 more)
...
### Community 89 - "brain_failover.py"
Cohesion: 0.05
...
### Community 90 - "NotificationDispatcher"
Cohesion: 0.05
Nodes (43): NotificationDispatcher, Path, service_manager.py — Telegram & Notification Integration Extension Extends the…, Start the Telegram bot. Returns True if started successfully., Signal the bot to stop and wait for graceful shutdown., Run the Telegram bot long-poll loop (inline, not subprocess)., Run the bot with stop-event awareness., Routes background task results to configured notification channels. Currently… (+35 more)

### Community 91 - "TokenBudget"
Cohesion: 0.05
...
### Community 93 - "OllamaCircuitBreaker"
Cohesion: 0.05
Nodes (54): _Circuit, _enabled(), _failure_threshold(), get_circuit_breaker(), OllamaCircuitBreaker, Per-model circuit breaker for Ollama backend health. Tracks consecutive failure…, Record a successful response; close the circuit., Record a 5xx error; open the circuit after threshold is reached. (+46 more)
...
### Community 96 - "test_repo_connection.py"
Cohesion: 0.07
...
### Community 97 - "ProceduralMemoryStore"
Cohesion: 0.05
...
### Community 100 - "CompanyGraphStore"
Cohesion: 0.03
Nodes (30): CompanyGraphStore, Delete a company and all its associated data., List companies with optional filtering., Count total companies in the store., Create a new company graph., Get the complete company graph for a company., Update a company graph., Delete a company graph. (+22 more)
...
### Community 110 - "FetchResult"
Cohesion: 0.04
Nodes (49): MockTransport, _build_curl_cffi_fetcher(), _build_pdf(), main(), _parse_args(), Namespace, Path, Render an executive-level PDF from the audit report dict. (+41 more)

### Community 111 - "StreamingDeltaReconstructor"
Cohesion: 0.06
...
### Community 114 - "Platform Guide — the full tour"
Cohesion: 0.03
...
### Community 123 - "ProvidersScreen.jsx"
Cohesion: 0.05
...
### Community 127 - "probe_model_liveness"
Cohesion: 0.05
...
### Community 128 - "test_autonomous_agency_e2e.py"
Cohesion: 0.05
Nodes (42): AgentRole, str, Enum, Agentic Agile — Sprint management with velocity tracking and burndown. Issue:…, Lifecycle status of a sprint., Qualitative health signal derived from sprint metrics., SprintHealth, SprintStatus (+34 more)
...
### Community 137 - "PatternConsolidation"
Cohesion: 0.06
...
### Community 141 - "BrainWatchdog"
Cohesion: 0.06
Nodes (33): _notify_watchdog(), Notify the brain watchdog of a provider call outcome (fire-and-forget). Called…, BrainWatchdog, get_watchdog(), Any, services/brain_watchdog.py — Brain health watchdog. Monitors the active brain…, Fail over to the next available provider., Persist the new provider in the brain config store (fire-and-forget). Uses the… (+25 more)
...
### Community 150 - "test_sam_voice.py"
Cohesion: 0.05
...
### Community 152 - "test_response_cache.py"
Cohesion: 0.12
...
### Community 153 - "PortfolioIntelligence"
Cohesion: 0.09
...
### Community 165 - "test_telegram_freebuff.py"
Cohesion: 0.07
...
### Community 166 - "agency.py"
Cohesion: 0.07
Nodes (28): AgencyCycleResult, AgentDirective, _build_quick_note_instruction(), _close_github_issue(), _fetch_github_quick_notes(), get_agency(), _gh_repo(), _gh_token() (+20 more)

### Community 167 - "control_overrides.py"
Cohesion: 0.07
Nodes (44): _actor(), build_platform_controls_router(), ControlUpdateBody, APIRouter, BaseModel, backend/platform_controls_router.py — admin API for the platform controls.…, A stable identifier for the audit trail on each write., One or more control changes, as ``{"updates": {"KEY": value}}``. (+36 more)
...
### Community 169 - "test_platform_controls.py"
Cohesion: 0.06
...
### Community 176 - "emit_chat_observation"
Cohesion: 0.09
...
### Community 179 - "SeoAuditReport"
Cohesion: 0.11
Nodes (37): BaseModel, models/seo_audit.py - SEO / GEO / AIO Audit Contracts Typed Pydantic models for…, Snapshot of one crawled page with the on-page facts the checks used., An agent-delegable remediation work package derived from the findings. Findings…, Complete result of one audit run., Lightweight listing entry for past audits., SeoAuditReport, SeoAuditSummary (+29 more)

### Community 180 - "NIMConnectionPool"
Cohesion: 0.10
...
Cohesion: 0.08
Nodes (22): Dynamic model router package. Public API:: from router import get_router,…, _default_model(), ModelRouter, Any, Resolve the default executor model via the catalog (UNIT 7). Was a hardcoded…, Central model router. Create one instance (use ``get_router()``). ``route()``…, Decide which Ollama model to use for this request. Args: requested_model: Model…, Return *model* if it is available in Ollama, else the first available fallback.… (+14 more)

### Community 183 - "test_features_api.py"
Cohesion: 0.05
...
### Community 189 - "test_self_heal_v2.py"
Cohesion: 0.08
...
### Community 193 - "test_startup_warmup.py"
Cohesion: 0.06
...
### Community 195 - "FeatureMatrix"
Cohesion: 0.07
Nodes (10): FeatureMatrix, Central support matrix — single source of truth. Loads the canonical feature…, Return a warning string for beta/experimental features, or None., Render the matrix as a Markdown table for docs., TestConfigOverrides, TestEnforcement, TestRegistryLoads, TestAdminVisibility (+2 more)
...
### Community 197 - "test_iteration_6_features.py"
Cohesion: 0.05
...
### Community 198 - "TestAuthAndTaskOwnership"
Cohesion: 0.05
...
### Community 207 - "WorkflowBuildRequest"
Cohesion: 0.14
...
### Community 208 - "._scan_github_repo"
Cohesion: 0.10
...
### Community 210 - "test_unit6_resolve_component_model.py"
Cohesion: 0.05
...
### Community 217 - "test_crispy_workflow.py"
Cohesion: 0.08
...
### Community 229 - "test_trend_watcher.py"
Cohesion: 0.08
...
### Community 231 - "test_all_providers_discovery.py"
Cohesion: 0.16
...
### Community 235 - "configuration-reference.md"
Cohesion: 0.06
...
### Community 238 - "TestAdapterMetadata"
Cohesion: 0.08
...
### Community 244 - "local_controller.py"
Cohesion: 0.12
...
### Community 245 - "test_live_server.py"
Cohesion: 0.22
...
Cohesion: 0.07
Nodes (19): _build_cost_table(), clear_stats(), cost_for_tokens(), get_stats(), _load_env_overrides(), Any, Per-model cost attribution for the LLM provider router. Maintains in-memory…, Return the USD cost for (prompt_tokens, completion_tokens) on *model*. Returns… (+11 more)
...
### Community 258 - "test_microagents.py"
Cohesion: 0.15
...
### Community 259 - "Security Analysis — local-llm-server"
Cohesion: 0.06
...
### Community 260 - "Langfuse Observability Guide"
Cohesion: 0.06
...
### Community 265 - "OrchestratorQueue"
Cohesion: 0.07
...
### Community 269 - "High-Agency Frontend Skill"
Cohesion: 0.06
Nodes (30): 10. FINAL PRE-FLIGHT CHECK, 1. ACTIVE BASELINE CONFIGURATION, 2. DEFAULT ARCHITECTURE & CONVENTIONS, 3. DESIGN ENGINEERING DIRECTIVES (Bias Correction), 4. CREATIVE PROACTIVITY (Anti-Slop Implementation), 5. PERFORMANCE GUARDRAILS, 6. TECHNICAL REFERENCE (Dial Definitions), 7. AI TELLS (Forbidden Patterns) (+22 more)

### Community 270 - "Quick-Note GitHub Issues Processing - Session Summary"
Cohesion: 0.06
...
### Community 271 - "test_rate_limiter.py"
Cohesion: 0.10
...
### Community 272 - "control_registry.py"
Cohesion: 0.11
...
### Community 273 - "test_mcp_governance.py"
Cohesion: 0.12
...
### Community 276 - "session_retro.py"
Cohesion: 0.13
...
### Community 277 - "test_purge_backlog.py"
Cohesion: 0.09
...
### Community 278 - "test_autonomy_gate.py"
Cohesion: 0.11
...
### Community 280 - "RuntimeHealthService"
Cohesion: 0.09
...
### Community 283 - "test_telegram_mutating_commands.py"
Cohesion: 0.07
...
### Community 284 - "test_rag_context.py"
Cohesion: 0.12
...
### Community 286 - "test_p0_roadmap_a4_a5_b2.py"
Cohesion: 0.12
...
### Community 287 - "test_pr923_fixes.py"
Cohesion: 0.09
...
### Community 288 - "PriorityTaskQueue"
Cohesion: 0.11
...
### Community 289 - "SteeringInjector"
Cohesion: 0.11
...
### Community 290 - "RuntimeReadinessReport"
Cohesion: 0.09
...
### Community 291 - "test_claude_setup_audit.py"
Cohesion: 0.16
...
### Community 292 - "test_internal_agent_did_work.py"
Cohesion: 0.12
...
### Community 294 - "Python Dependencies (`requirements.txt`)"
Cohesion: 0.07
...
### Community 295 - "Technical Debt Register — local-llm-server"
Cohesion: 0.07
...
### Community 296 - "test_backend_server_features.py"
Cohesion: 0.08
...
### Community 300 - "SyntheticDataPipeline"
Cohesion: 0.12
...
### Community 301 - "test_crispy_burn_in.py"
Cohesion: 0.07
...
### Community 303 - "test_skill_registry_boot_refresh.py"
Cohesion: 0.12
...
### Community 304 - "test_scaffolding.py"
Cohesion: 0.10
...
### Community 305 - "analyze_qualitative"
Cohesion: 0.12
...
### Community 307 - "llm_providers.py"
Cohesion: 0.17
...
### Community 308 - "Deploy: FreeBuff Telegram bot (24×7)"
Cohesion: 0.07
...
### Community 309 - "Claude Code + Qwen Local Setup"
Cohesion: 0.07
...
### Community 310 - "generate_context.py"
Cohesion: 0.12
...
### Community 313 - "isolated_telegram_config"
Cohesion: 0.11
...
### Community 314 - "validate_outbound_url"
Cohesion: 0.14
...
### Community 317 - "LLM Router — troubleshooting"
Cohesion: 0.08
...
### Community 321 - "test_task_clarification.py"
Cohesion: 0.08
...
### Community 322 - "test_telegram_approval_e2e.py"
Cohesion: 0.12
...
### Community 325 - "HarnessEnrichment"
Cohesion: 0.12
...
### Community 332 - "Session Handoff — 2026-06-15"
Cohesion: 0.08
...
### Community 333 - "TASK 4 — End-to-end approval-gate test"
Cohesion: 0.08
...
### Community 334 - "get_feature_matrix"
Cohesion: 0.12
...
### Community 335 - "FeatureEntry"
Cohesion: 0.09
Nodes (10): FeatureEntry, Any, BaseModel, One entry in the support matrix., Return the feature entry if available, or raise FeatureUnavailableError., Alias for check_available() — returns the entry or raises…, Convenience: check_available, but returns the entry for chaining., Return a compact list of all feature entries (for admin/status endpoints). (+2 more)

### Community 336 - "mcp_dispatch"
Cohesion: 0.12
...
### Community 339 - "ClaudeCodeAdapter"
Cohesion: 0.14
...
### Community 340 - "test_phase4_runtime_resilience.py"
Cohesion: 0.13
...
### Community 342 - "analyze_page"
Cohesion: 0.16
Nodes (8): analyze_page(), BeautifulSoup, Run every page-scoped check against one HTML document (no network). Returns a…, _visible_text(), codes(), TestNewChecks, TestSpecificChecks, The fixer's output must satisfy the audit engine's fixable checks.

### Community 343 - "TemporalContextGraph"
Cohesion: 0.10
...
### Community 345 - "test_daily_automation_2026_08_03.py"
Cohesion: 0.11
...
### Community 346 - "TestClassifyPlainText"
Cohesion: 0.08
...
### Community 347 - "test_service_token.py"
Cohesion: 0.08
...
### Community 351 - "Local AI Stack with Docker"
Cohesion: 0.08
...
### Community 352 - "Traffic Distribution Across Providers"
Cohesion: 0.08
...
### Community 353 - "Implementation Prompt: Rich TaskBoard + Agile Sprint Integration"
Cohesion: 0.08
...
### Community 354 - "Telegram Bot Setup"
Cohesion: 0.08
...
### Community 355 - "test_contracts_agency.py"
Cohesion: 0.08
Nodes (21): background_agent(), engine(), Path, WorkflowEngine, tests/test_contracts_agency.py — Contract tests for agency core autonomy…, Contract: WorkflowEngine cannot skip the gate state machine., Contract: AgentRunner._local_safety_check must catch hardcoded secrets and…, Contract: Auth code with hardcoded SECRET_KEY triggers a safety issue. The… (+13 more)

### Community 356 - "RuntimesPage.js"
Cohesion: 0.13
...
### Community 357 - "video_transcript.py"
Cohesion: 0.12
...
### Community 361 - "test_agency_fix.py"
Cohesion: 0.08
...
### Community 362 - "TestModelRegistryUpdates"
Cohesion: 0.14
...
### Community 363 - "test_output_filter.py"
Cohesion: 0.08
...
### Community 364 - "test_workspace_security.py"
Cohesion: 0.10
...
### Community 367 - "get_failover_manager"
Cohesion: 0.13
...
### Community 368 - "Agent Governance Guide"
Cohesion: 0.09
...
### Community 369 - "The fifteen strategies"
Cohesion: 0.09
...
### Community 372 - "provider_max_rpm"
Cohesion: 0.08
...
### Community 374 - "WindowsServiceManager"
Cohesion: 0.18
...
### Community 381 - "classify_direct_chat_intent"
Cohesion: 0.13
...
### Community 389 - "_process_task_callback"
Cohesion: 0.17
...
### Community 390 - "test_schedule_backlog_drain.py"
Cohesion: 0.14
Nodes (21): _one_shot(), asyncio, Why the 2026-08-01 backlog never drained, despite a fix already existing.…, A timestamp we cannot parse must not authorise a delete., The pre-existing behaviour has to survive the new branch above it., The previous failure was invisible: four digits at INFO beside two zeroes., It cleaned `db.schedules`, which on Mongo is a real but empty collection. The…, Adding it looks like a fix and is a worse bug. ``packages/storage/sqlite.py``… (+13 more)

### Community 391 - "_FakePersistence"
Cohesion: 0.11
Nodes (18): _every_minute_one_shot(), _FakePersistence, An agency-directive-shaped row: cron="* * * * *", uniquely named., 2026-08-03: the 7-day fallback let a live crash loop regrow the backlog from a…, Must not delete a same-pattern row that hasn't had time to fire yet., A "0 9 * * *" run-once row legitimately waits up to ~24h for its one scheduled…, toggle(job_id, enabled=False) pauses a job without deleting it — the fast path…, _register_aps parses cron via ``.strip().split()``, so a cron string with… (+10 more)

### Community 392 - "TestHelpers"
Cohesion: 0.15
...
### Community 395 - "_resolve_user_github_token"
Cohesion: 0.18
...
### Community 396 - "V3 API Migration Plan — LLM Relay Platform"
Cohesion: 0.10
...
### Community 400 - "system_instruction"
Cohesion: 0.16
...
### Community 401 - "test_issue_triage.py"
Cohesion: 0.17
...
### Community 402 - "weekly_digest.py"
Cohesion: 0.13
...
### Community 403 - "test_local_controller.py"
Cohesion: 0.17
...
### Community 407 - "test_permissions.py"
Cohesion: 0.15
...
### Community 408 - "PersistentMemoryStore"
Cohesion: 0.24
...
### Community 410 - "Design Audit"
Cohesion: 0.10
Nodes (19): Code Quality, Color and Surfaces, Component Patterns, Content, Design Audit, Fix Priority, How This Works, Iconography (+11 more)

### Community 411 - "Findings"
Cohesion: 0.10
...
### Community 416 - "Docker AI Governance Audit — Final Report"
Cohesion: 0.10
...
### Community 417 - "1. Capability-by-capability"
Cohesion: 0.10
...
### Community 419 - "Dynamic Model Routing"
Cohesion: 0.10
...
### Community 420 - "ControlsScreen.jsx"
Cohesion: 0.15
...
### Community 422 - "output_filter.py"
Cohesion: 0.10
...
### Community 425 - "test_kimi_bridge_server.py"
Cohesion: 0.12
...
### Community 429 - "test_backend_runtime_bootstrap.py"
Cohesion: 0.11
...
### Community 438 - "Analysis & Synthesis Instructions"
Cohesion: 0.11
Nodes (18): 1. Define the Atmosphere, 2. Map the Color Palette, 3. Establish Typography Rules, 4. Define the Hero Section, 5. Describe Component Stylings, 6. Define Layout Principles, 7. Define Responsive Rules, 8. Encode Motion Philosophy (+10 more)

### Community 439 - "Production Readiness Assessment — local-llm-server"
Cohesion: 0.11
...
### Community 440 - "TestNormalizeResponseFormat"
Cohesion: 0.11
...
### Community 441 - "Skill: fabric-patterns"
Cohesion: 0.11
Nodes (18): 1. Ensure Pattern Directory Exists, 2. List Available Patterns, 3. Retrieve a Pattern, 4. Apply a Pattern with Variables, 5. Stitch Patterns Together, 6. Create New Patterns, Acceptance Checks, Directory Structure (+10 more)

### Community 442 - "db/__init__.py"
Cohesion: 0.15
...
### Community 443 - "Admin Dashboard Guide"
Cohesion: 0.11
...
### Community 444 - "Implementation Plan"
Cohesion: 0.11
...
### Community 448 - "Delegation Plan (agent-ready work packages)"
Cohesion: 0.11
...
### Community 449 - "parse_event_stream"
Cohesion: 0.15
...
### Community 452 - ".start_onboarding"
Cohesion: 0.11
...
### Community 453 - "test_task_source_id_race.py"
Cohesion: 0.17
...
### Community 454 - "test_brain_patch_service_token.py"
Cohesion: 0.18
...
### Community 455 - "TestRuntimeControl"
Cohesion: 0.15
...
### Community 457 - "test_fabric_patterns.py"
Cohesion: 0.11
...
### Community 458 - "test_schedule_persistence.py"
Cohesion: 0.15
...
### Community 459 - "validate_session_id"
Cohesion: 0.16
...
### Community 460 - "ErrorInterceptorMiddleware"
Cohesion: 0.18
...
### Community 462 - "Comprehensive Skill Index (By Category)"
Cohesion: 0.11
...
### Community 463 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 464 - "Component Map"
Cohesion: 0.11
...
### Community 465 - "TestRenderRouter"
Cohesion: 0.14
...
### Community 466 - "Agent State — colibri GLM-5.2 deployment (resumable)"
Cohesion: 0.11
...
### Community 467 - "Architecture Overview — local-llm-server"
Cohesion: 0.11
...
### Community 468 - "Pending Activities — Implementation Playbook"
Cohesion: 0.11
...
### Community 470 - "Part A — Health Report"
Cohesion: 0.11
...
### Community 474 - "sync_readme_gallery.py"
Cohesion: 0.22
...
### Community 475 - "test_skill_executors_live.py"
Cohesion: 0.16
...
### Community 478 - "test_company_api.py"
Cohesion: 0.11
...
### Community 479 - "TestStopSlopChecker"
Cohesion: 0.11
...
### Community 480 - "test_self_heal.py"
Cohesion: 0.11
...
### Community 481 - "handle_workflow_ide_chat"
Cohesion: 0.18
...
### Community 485 - "SKILL: Industrial Brutalism & Tactical Telemetry UI"
Cohesion: 0.12
...
### Community 486 - "Skill: data-quality-audit"
Cohesion: 0.12
...
### Community 487 - "What "Slop" Looks Like"
Cohesion: 0.12
...
### Community 488 - "test_admin_local_brain_router.py"
Cohesion: 0.18
...
### Community 489 - "local_brain_router.py"
Cohesion: 0.19
...
### Community 490 - "Section-by-Section Acceptance Criteria"
Cohesion: 0.12
...
### Community 496 - "agent_readiness_audit.py"
Cohesion: 0.21
...
### Community 499 - "test_shared_state.py"
Cohesion: 0.17
...
### Community 500 - "test_activation_api.py"
Cohesion: 0.21
...
### Community 502 - "test_health_endpoints.py"
Cohesion: 0.17
...
### Community 503 - "test_keepalive.py"
Cohesion: 0.18
...
### Community 504 - "test_openclaw_endpoints.py"
Cohesion: 0.12
...
### Community 505 - "TestOrchestratorProviderFailover"
Cohesion: 0.12
Nodes (9): tests/test_orchestrator_failover.py — Provider failover, brain resolution,…, End-to-end provider failover through the WorkflowOrchestrator., First provider fails → retry picks next → llm_provenance tracks the winner., The _failed_execute key in llm_provenance records the URLs that failed., A non-retryable error (e.g. ValueError) does not trigger failover., A TimeoutError is retryable and should trigger provider failover., Phases that don't use an LLM (CLASSIFY, PERSIST, etc.) don't record provenance., phase_attempts tracks the attempt count per phase through retries. (+1 more)

### Community 506 - "test_orchestrator_merge_decision.py"
Cohesion: 0.24
...
### Community 508 - "test_task_service_failed_comment.py"
Cohesion: 0.18
...
### Community 509 - "test_tasks_reconciler_todo_requeue.py"
Cohesion: 0.18
...
### Community 510 - "hermes_prompt.py"
Cohesion: 0.19
...
### Community 511 - "MemoryMiddleware"
Cohesion: 0.17
...
### Community 513 - "Skill: repowise-intelligence"
Cohesion: 0.12
...
### Community 514 - "ARCHITECTURE.md — Target Architecture"
Cohesion: 0.12
...
### Community 515 - "admin_digest_router.py"
Cohesion: 0.19
...
### Community 517 - "The 10-Step Workflow"
Cohesion: 0.12
...
### Community 518 - "Contributing to local-llm-server"
Cohesion: 0.12
...
### Community 519 - "CEO Micro-Management"
Cohesion: 0.12
...
### Community 520 - "467 Brutal Audit — File-by-File Status"
Cohesion: 0.12
...
### Community 521 - "Runbook — Apply the Fast Free NVIDIA Brain to Render (TASK 2)"
Cohesion: 0.12
...
### Community 522 - "implement_agent.py"
Cohesion: 0.16
...
### Community 527 - "ManagedAgentDreams"
Cohesion: 0.22
...
### Community 529 - "test_autonomy_status.py"
Cohesion: 0.12
...
### Community 530 - "test_brain_failover_413.py"
Cohesion: 0.13
...
### Community 531 - "test_dockerfile_ships_root_modules.py"
Cohesion: 0.17
...
### Community 532 - "test_frontend_deployment_guards.py"
Cohesion: 0.20
...
### Community 533 - "test_glm52_brain.py"
Cohesion: 0.12
...
### Community 534 - "test_local_brain_state.py"
Cohesion: 0.12
...
### Community 537 - "test_phase5_doctor.py"
Cohesion: 0.12
...
### Community 538 - "test_provider_state_durability.py"
Cohesion: 0.13
...
### Community 539 - "TestBrainFailoverBackoff"
Cohesion: 0.23
...
### Community 540 - "test_telegram_diag_endpoint.py"
Cohesion: 0.12
...
### Community 543 - "Skill: agent-harness"
Cohesion: 0.13
...
### Community 544 - "Skill: checkpoint-strategy"
Cohesion: 0.13
...
### Community 546 - "Skill: local-ai-query"
Cohesion: 0.13
...
### Community 547 - "Skill: parallel-agents"
Cohesion: 0.13
...
### Community 548 - "Skill: parallel-worktrees"
Cohesion: 0.13
...
### Community 549 - "Design System: Taste Standard"
Cohesion: 0.13
...
### Community 552 - "Skill: user-research"
Cohesion: 0.13
...
### Community 553 - "Agency Core — Progress & Resume Log"
Cohesion: 0.13
...
### Community 554 - "Attention Mechanisms Internals"
Cohesion: 0.13
...
### Community 555 - "test_daily_2026_07_24.py"
Cohesion: 0.20
...
### Community 556 - "_push_down_where"
Cohesion: 0.14
...
### Community 558 - "AdminDigestRouterAuthTests"
Cohesion: 0.23
...
### Community 559 - "test_telegram_auto_approve.py"
Cohesion: 0.23
...
### Community 560 - "clear_wizard_state_cache"
Cohesion: 0.21
...
### Community 561 - "test_freebuff_bot.py"
Cohesion: 0.14
...
### Community 562 - "e2e/test_browser.py"
Cohesion: 0.23
...
### Community 563 - "DecisionsStoreTests"
Cohesion: 0.13
...
### Community 564 - "test_dockerfile_ships_config_dir.py"
Cohesion: 0.14
...
### Community 567 - "test_scanner_live.py"
Cohesion: 0.23
...
### Community 571 - "Skill: lr-schedule-advisor"
Cohesion: 0.14
...
### Community 575 - "Checks Performed"
Cohesion: 0.14
...
### Community 576 - "Skill: training-stability-monitor"
Cohesion: 0.14
...
### Community 577 - "monitor_colibri.py"
Cohesion: 0.24
...
### Community 578 - "Skill: branch-cleanup"
Cohesion: 0.14
...
### Community 579 - "Skill: perplexity — Web Research via Perplexity API"
Cohesion: 0.14
...
### Community 581 - "Instructions"
Cohesion: 0.14
Nodes (13): Acceptance Checks, `admin_auth.py` checklist, `agent/tools.py` checklist, Escalation, Instructions, `key_store.py` checklist, `proxy.py` auth middleware checklist, Risky Modules in This Repo (+5 more)

### Community 582 - "Quick-Note Issues Processing Summary"
Cohesion: 0.14
...
### Community 583 - "Implementation Plan — DB-persisted, UI-switchable Brain (no redeploy)"
Cohesion: 0.14
...
### Community 585 - "Render MCP — autonomous platform debugging and environment monitoring"
Cohesion: 0.14
...
### Community 586 - "Runbook: Auto-Resume After Cooldown / Interruption"
Cohesion: 0.14
...
### Community 594 - "test_critical_flows.py"
Cohesion: 0.29
...
### Community 595 - "test_autonomy_pipeline_regressions.py"
Cohesion: 0.15
...
### Community 599 - "test_openclaw_gateway.py"
Cohesion: 0.14
...
### Community 600 - "TestDisabledReasonRendering"
Cohesion: 0.14
...
### Community 601 - "CollaborationContext"
Cohesion: 0.21
...
### Community 616 - "admin_update_task_router.py"
Cohesion: 0.22
...
### Community 626 - "Agent Transparency Report"
Cohesion: 0.15
...
### Community 627 - "update_provider_policy"
Cohesion: 0.19
...
### Community 629 - "_InMemoryBackend"
Cohesion: 0.18
...
### Community 631 - "TestModelCostTableUpdates"
Cohesion: 0.26
...
### Community 633 - "test_deploy_trigger_covers_image.py"
Cohesion: 0.21
...
### Community 634 - "test_doctor_service_token_check.py"
Cohesion: 0.23
...
### Community 635 - "TestKillSwitchDurability"
Cohesion: 0.15
...
### Community 636 - "CircuitBreakerOpenError"
Cohesion: 0.14
...
### Community 637 - "WorkspaceManifest"
Cohesion: 0.17
...
### Community 640 - "._fetch_flat_skill_file"
Cohesion: 0.18
...
### Community 642 - "AGENTS.md — Codebase Map & Operations Reference"
Cohesion: 0.17
...
### Community 647 - "Skill: system-prompt-audit"
Cohesion: 0.17
...
### Community 648 - "Skill: task-alive-updates"
Cohesion: 0.17
...
### Community 659 - "Workspace Isolation Architecture"
Cohesion: 0.17
...
### Community 666 - "check_container_posture.py"
Cohesion: 0.26
...
### Community 667 - "Kimi Web-Bridge Service"
Cohesion: 0.17
...
### Community 668 - "test_agile_api.py"
Cohesion: 0.17
...
### Community 669 - "test_app_settings.py"
Cohesion: 0.21
...
### Community 670 - "test_docs_consistency.py"
Cohesion: 0.17
...
### Community 673 - "test_skill_registry.py"
Cohesion: 0.20
...
### Community 674 - "TestAnthropicPayloadStructuredOutput"
Cohesion: 0.29
...
### Community 678 - "_extractive_compress"
Cohesion: 0.18
...
### Community 680 - "Skill: pro-workflow"
Cohesion: 0.18
...
### Community 683 - "Skill: resource-panel"
Cohesion: 0.18
...
### Community 684 - "Skill: sandboxed-exec"
Cohesion: 0.18
...
### Community 686 - "ECC Harness Patterns Skill"
Cohesion: 0.18
...
### Community 689 - "Stop-Slop Quality Skill"
Cohesion: 0.18
...
### Community 690 - "Agency Core — Ruthless Architecture Audit & Migration Plan"
Cohesion: 0.18
...
### Community 691 - "AUTONOMY_CHARTER.md"
Cohesion: 0.18
...
### Community 692 - "Tailored Onboarding, Editable Companies & Dynamic Roles"
Cohesion: 0.18
...
### Community 693 - "Issue #467 — Section 1: Pulled State + PR Inventory"
Cohesion: 0.18
...
### Community 694 - "Autonomy Charter — Telegram-Gated Self-Running Agency"
Cohesion: 0.18
...
### Community 695 - "Context: Agentic Agile + Portfolio Management"
Cohesion: 0.18
...
### Community 696 - "Deploy to Google Cloud Run"
Cohesion: 0.18
...
### Community 698 - "Sampling Strategies Internals"
Cohesion: 0.18
...
### Community 699 - "LLM Router — architecture"
Cohesion: 0.18
...
### Community 700 - "Killer TODO Roadmap — local-llm-server"
Cohesion: 0.18
...
### Community 701 - "NVIDIA NIM — Free Tier Setup"
Cohesion: 0.18
...
### Community 702 - "What to clean up"
Cohesion: 0.18
...
### Community 703 - "Worker Service — Operations Runbook"
Cohesion: 0.18
...
### Community 705 - "test_bedrock_live.py"
Cohesion: 0.25
...
### Community 711 - "test_empirical_verify.py"
Cohesion: 0.49
...
### Community 712 - "test_event_log.py"
Cohesion: 0.45
...
### Community 713 - "test_google_provider_models.py"
Cohesion: 0.18
...
### Community 717 - "Protocol: Premium Utilitarian Minimalism UI Architect"
Cohesion: 0.20
...
### Community 718 - "The 5-Step Wrap-Up Ritual"
Cohesion: 0.20
...
### Community 719 - "TestNormalizeToolChoice"
Cohesion: 0.31
...
### Community 720 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 721 - "Skill: Agentic Agile"
Cohesion: 0.20
...
### Community 722 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 723 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 724 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 725 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 726 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 731 - "CI Troubleshooting Runbook"
Cohesion: 0.20
...
### Community 738 - "_resolve_push_token"
Cohesion: 0.31
...
### Community 739 - "test_bootstrap_source_id_index.py"
Cohesion: 0.27
...
### Community 740 - "TestExtendedThinkingRouting"
Cohesion: 0.20
...
### Community 741 - "TestZeroAttemptDiagnostics"
Cohesion: 0.29
...
### Community 742 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 745 - "test_quick_note_engine.py"
Cohesion: 0.22
...
### Community 750 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 751 - "Skill: changelog-enforcer"
Cohesion: 0.22
...
### Community 752 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 760 - "Active Task Tracker"
Cohesion: 0.22
...
### Community 762 - "ADR 003: Multi-Agent Orchestration with Plan-Execute-Verify Loop"
Cohesion: 0.22
...
### Community 763 - "Main proxy (`proxy.py`)"
Cohesion: 0.22
...
### Community 764 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 765 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 766 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 767 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 768 - "Platform Controls"
Cohesion: 0.22
...
### Community 769 - "Release Procedure"
Cohesion: 0.22
...
### Community 770 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 785 - "TestGithubSignalHardening"
Cohesion: 0.22
...
### Community 788 - "test_scanner_deps_parity.py"
Cohesion: 0.31
...
### Community 796 - "TestParseToolCalls"
Cohesion: 0.39
...
### Community 845 - "Prime Agent Runtime"
Cohesion: 0.25
...
### Community 846 - "PULL_REQUEST_TEMPLATE.md"
Cohesion: 0.25
...
### Community 857 - "test_generate_context_standing_instructions.py"
Cohesion: 0.32
...
### Community 862 - "test_provider_models_db_outage.py"
Cohesion: 0.25
...
### Community 863 - "test_runtimes_health_endpoint.py"
Cohesion: 0.25
...
### Community 899 - "e2e_smoke.py"
Cohesion: 0.57
Nodes (5): _chat(), check(), _health(), _models(), _req()

### Community 900 - "task_runner.py"
Cohesion: 0.33
...
### Community 903 - "test_daily_2026_06_14.py"
Cohesion: 0.38
...
### Community 904 - "TestSupportMatrixDocsSync"
Cohesion: 0.29
...
### Community 905 - "test_doctor_coding_brain.py"
Cohesion: 0.38
...
### Community 908 - "TestGithubTokenSQLiteRegression"
Cohesion: 0.38
...
### Community 911 - "TestActiveStrategy"
Cohesion: 0.29
...
### Community 927 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 928 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 929 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 935 - "resolve_hermes_base_url"
Cohesion: 0.47
...
### Community 936 - "apply_phase1_changes.py"
Cohesion: 0.33
...
### Community 970 - "knowledgeGraphTab.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 971 - "loginFlowNoTimeout.test.js"
Cohesion: 0.40
Nodes (4): apiSource, { describe, test, expect }, fs, path

### Community 972 - "test_company_stale_id_recovery.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, src

### Community 973 - "worker_no_cache.test.js"
Cohesion: 0.40
Nodes (4): { describe, test, expect }, fs, path, workerSource

### Community 974 - "scripts/agile_ceremonies.py"
Cohesion: 0.60
Nodes (4): _load(), main(), ModuleType, _write_summary()

### Community 975 - "governance/__init__.py"
Cohesion: 0.40
Nodes (3): __getattr__(), Any, packages/governance — agent identity, policy, approvals, audit, sandboxes. The…

### Community 976 - "Prompt Library Changelog"
Cohesion: 0.40
Nodes (4): Added, Format, Prompt Library Changelog, [Unreleased]

### Community 977 - "_add_colibri_shim_changelog_entry.py"
Cohesion: 0.50
...
### Community 1017 - "github"
Cohesion: 0.50
Nodes (3): github, enabled, silent

### Community 1042 - "test_the_reserve_is_bounded_when_read_from_the_environment"
Cohesion: 0.67
...
### Community 1043 - "test_direct_adapter_does_not_bypass"
Cohesion: 0.67
...
### Community 1044 - "ToolCallViewer.jsx"
Cohesion: 0.33
...
- **Why does `_fixture()` connect `_fixture` to `ProviderConfig`, `AgentScheduler`, `AgentSessionStore`, `WorkflowRun`, `llm/router.py`, `test_llm_router_queue_cache.py`, `MCPUnavailableError`, `test_llm_router_strategies.py`, `test_operational_incidents.py`, `SeoAuditRequest`, `test_autonomy_status.py`, `test_brain_failover_413.py`, `TaskStore`, `test_local_brain_state.py`, `TestChatHistoryStore`, `test_phase5_doctor.py`, `test_provider_state_durability.py`, `test_telegram_diag_endpoint.py`, `ImprovementLoop`, `SelfHealingAgent`, `Task`, `test_unit8_model_catalog.py`, `TaskWorkflowService`, `test_llm_router_resilience.py`, `resolve_identity`, `HermesAdapter`, `KeyPool`, `PrimeAgentAdapter`, `_clean_director`, `services/background.py`, `KeyStore`, `test_telegram_auto_approve.py`, `e2e/test_browser.py`, `AgentSwarm`, `AgentProfile`, `test_failover_client_shared.py`, `get_workflow_orchestrator`, `resolve_active_brain`, `SecretRecord`, `test_model_router.py`, `test_sam_livekit.py`, `DetectedSystem`, `test_ceo_router.py`, `_enable_filter`, `TrendWatcher`, `TestHarnessAdapter`, `ResearchTask`, `test_openclaw_gateway.py`, `brain_failover.py`, `NotificationDispatcher`, `TokenBudget`, `test_agent_tool_governance.py`, `OllamaCircuitBreaker`, `TestClient`, `test_ai_insights.py`, `ProceduralMemoryStore`, `test_new_features_e2e.py`, `test_colibri_brain_shim.py`, `FailureCategory`, `test_knowledge_sync.py`, `_Budget`, `test_doctor_service_token_check.py`, `SeoFixer`, `config.py`, `test_context_rulebook.py`, `ArtifactStore`, `test_trend_scoping.py`, `LogMonitor`, `BrainWatchdog`, `ChatHistoryStore`, `test_sam_voice.py`, `persist_plan_spec`, `test_agile_api.py`, `test_app_settings.py`, `test_issue_intake.py`, `test_platform_controls.py`, `emit_chat_observation`, `test_agent_free_brain.py`, `test_features_api.py`, `test_video_transcript.py`, `test_self_heal_v2.py`, `test_startup_warmup.py`, `test_portfolio_intake.py`, `test_iteration_6_features.py`, `TestAuthAndTaskOwnership`, `WorkflowBuildRequest`, `TestEstimateTokensForMessages`, `TestClient`, `ContextPruner`, `_resolve_push_token`, `test_trend_watcher.py`, `test_persistent_memory.py`, `SpecEntry`, `TestMongoGate`, `SecurityScanner`, `test_llm_router_e2e.py`, `test_control_plane_api.py`, `cost_tracker.py`, `test_brain_failover.py`, `OrchestratorQueue`, `test_rate_limiter.py`, `session_retro.py`, `test_purge_backlog.py`, `test_telegram_mutating_commands.py`, `test_crispy_burn_in.py`, `test_provider_enable_disable.py`, `test_skill_registry_boot_refresh.py`, `_MemCollection`, `isolated_telegram_config`, `test_task_clarification.py`, `ClaudeCodeAdapter`, `analyze_page`, `test_service_token.py`, `test_ping.py`, `test_runtimes_health_endpoint.py`, `test_task_store_fails_loud_in_production.py`, `test_contracts_agency.py`, `test_regression.py`, `test_agency_fix.py`, `test_monitor_lib.py`, `test_v4_api.py`, `reap_expired_companies`, `client`, `test_doctor_coding_brain.py`, `test_dashboard_cache.py`, `_resolve_user_github_token`, `TestFeaturesAPI`, `allow_paid`, `test_kimi_bridge_server.py`, `test_langfuse_agency_wide.py`, `test_voice_pipeline.py`, `TestNormalizeResponseFormat`, `model_discovery.py`, `parse_event_stream`, `test_brain_patch_service_token.py`, `TestRuntimeControl`, `test_company_api.py`, `SQLiteStore`, `test_shared_state.py`, `_get`, `test_openclaw_endpoints.py`, `TestOrchestratorProviderFailover`, `test_orchestrator_merge_decision.py`, `test_task_service_failed_comment.py`, `test_tasks_reconciler_todo_requeue.py`?**
  _High betweenness centrality (0.111) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `backend/server.py`, `test_autonomous_agency_e2e.py`, `AgentScheduler`, `AgentSessionStore`, `WorkflowRun`, `proxy.py`, `MCPUnavailableError`, `ReactScratchpad`, `StuckDetector`, `_StubManager`, `get_runtime_manager`, `test_brain_failover_413.py`, `_get_provider_policy`, `test_governance_api.py`, `TestMCPServer`, `TaskSpec`, `FreeBuffAgent`, `MCPClient`, `test_agent_free_brain.py`, `test_failover_client_shared.py`, `CEODispatcher`, `WorkspaceTools`, `BackgroundAgent`, `MultiAgentSwarm`, `test_empirical_verify.py`, `direct_chat.py`, `_build_request`, `AutonomyTracker`, `_NoopStore`, `TestWorkspace`, `resolve_e2b_config`, `TokenBudget`, `ContextPruner`, `test_agent_tool_governance.py`, `TestAgentLoopMCPIntegration`, `GitHubTools`, `test_contracts_agency.py`, `TestZeroAttemptDiagnostics`, `AdaptiveHalter`, `ContextManager`, `diagnostics.py`, `LocalWorkspace`?**
  _High betweenness centrality (0.045) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderConfig` to `backend/server.py`, `test_bedrock_live.py`, `AgentScheduler`, `TestAnthropicPayloadStructuredOutput`, `test_all_providers_discovery.py`, `direct_chat.py`, `settings.py`, `test_colibri_brain_shim.py`, `NvidiaProvider`, `test_chat_mode_regressions.py`, `_Budget`, `test_anthropic_router.py`, `system_instruction`, `TestActiveStrategy`, `TestBrainFailoverBackoff`, `TrafficDirector`, `failover_client.py`?**
