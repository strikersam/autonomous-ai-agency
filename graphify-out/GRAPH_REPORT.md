# Graph Report - openclaw-fix  (2026-09-14)

## Corpus Check
- 1508 files · ~2,185,489 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 30549 nodes · 57004 edges · 1283 communities (1122 shown, 113 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 3331 edges (avg confidence: 0.92)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7d7243cc`
...
## Communities (1283 total, 113 thin omitted)
...
Cohesion: 0.02
Nodes (211): _get_current_user_thunk(), _get_optional_user_thunk(), Request, admin_seed(), _agent_timeout_fallback_response(), AgentStatusEntry, AgentStatusResponse, AgentToolCallEntry (+203 more)

### Community 2 - "company_api.py"
Cohesion: 0.02
Nodes (178): auto_recommend_skills(), cancel_onboarding(), create_company(), _DoctorCheck, _DoctorReport, generate_onboarding_questions(), get_company(), get_company_access() (+170 more)

### Community 3 - "SQLiteStore"
Cohesion: 0.02
Nodes (97): CompanyGraph, KnowledgeItem, The complete Company Graph - canonical core model for the Autonomous AI Agency.…, Find a workflow by its name., Find knowledge items matching any of the given tags., Find connectors configured for a specific system., Structured knowledge about the company, systems, or processes., MongoDBStore (+89 more)

### Community 4 - "CompanyGraphStore"
Cohesion: 0.01
Nodes (95): BusinessCategory, Company, The core company entity - root of the Company Graph., Find a website by its URL., Find a repository by its URL., A company website with detected systems and stack inference., A company repository with detected technologies and metadata., Extract the owner from the full name. (+87 more)

### Community 5 - "proxy.py"
Cohesion: 0.03
Nodes (161): Describes a single worker's task and constraints., WorkerSpec, middleware, admin_control(), admin_delete_user(), admin_login(), admin_logout(), admin_rotate_user() (+153 more)

### Community 6 - "llm/router.py"
Cohesion: 0.03
Nodes (113): int, failover_chat_completion_via_router(), openai_body_from_response(), Any, packages/llm/compat.py — backwards-compatible bridges to the legacy call paths.…, Router-backed implementation of ``packages.ai.failover_client``'s entry point.…, Whether the compat bridges should delegate to ``LLMRouter``. Reads the flag on…, Translate an OpenAI-shaped chat payload into an ``LLMRequest``. Unknown keys… (+105 more)
...
### Community 10 - "resolve_identity"
Cohesion: 0.03
Nodes (110): Charge sub-agent nesting depth and enforce the ``max_depth`` ceiling. Isolates…, _egress_policy_reason(), agent/web_reach.py — Web Reach: zero-key internet access for agents. Gives…, Return why governance policy blocks *host*, or None. Runs strictly *after* the…, guard(), _load(), mcp_server/governance.py — governance adapter for the MCP HTTP surface. Closes…, Evaluate *tool* before it runs. Returns ``(allowed, message, decision)``.… (+102 more)
...
Cohesion: 0.04
Nodes (85): PreflightReport, Agent subsystem — planner / executor / verifier loop., AgentEvent, AgentPlan, AgentRunRequest, AgentSession, AgentSessionCreateRequest, AgentSessionMessage (+77 more)
...
Cohesion: 0.04
Nodes (108): _merge_changed_files(), Collect changed_files across all specialists into a single de-duped list., BoundContext, ClassifyOutput, ExecutionResult, get_ceo_fallback_stats(), JudgeVerdict, MonitorOutput (+100 more)
...
Cohesion: 0.04
Nodes (83): Agency, AgentRole, get_agency(), _parse_ceo_directives(), str, CEO-coordinated multi-agent agency for continuous codebase management. The CEO…, set_agency(), DetectedIssue (+75 more)

### Community 20 - "test_governance_enforcement.py"
Cohesion: 0.03
Nodes (96): Feed LLM token/cost spend into the governance session budget. Kept separate…, AuditEvent, One governed action, fully described. Field order follows the…, One-line JSON, suitable for a SIEM shipper tailing the log., BudgetExceeded, BudgetTracker, classify(), evaluate_call() (+88 more)

### Community 21 - "_fixture"
Cohesion: 0.02
Nodes (104): parse_event_stream(), ParsedRun, Structured view of one ``--mode json`` event stream., Reduce a ``--mode json`` NDJSON stream to a :class:`ParsedRun`. Kept a module-…, app_client(), _clear_discovered_models(), _clear_response_cache(), client() (+96 more)

### Community 22 - "AgentJobManager"
Cohesion: 0.03
Nodes (59): AgentJob, AgentJobManager, make_isolated_workspace(), _now(), Any, Path, agent/job_manager.py — Async agent job lifecycle manager. Manages agent jobs…, Run a job using the provided runner and update the job's lifecycle, progress,… (+51 more)
...
### Community 24 - "PrimeAgentAdapter"
Cohesion: 0.03
Nodes (64): ClaudeCodeAdapter, Any, Adapter for Claude Code CLI — FIRST CLASS autonomous coding runtime., _accumulate_usage(), _assistant_messages(), _child_env(), _iter_events(), _kill_and_reap() (+56 more)
...
Cohesion: 0.03
Nodes (85): quick_notes_submit(), _QuickNoteBody, Submit a quick-note URL or instruction from the dashboard FAB., _priority_rank(), Any, tasks/store.py — MongoDB-backed task store. Falls back to in-memory storage…, Fail loud in production if no persistent storage is configured. Telegram…, Create a task. Deduplicates by source_id if set (Charter G3). If a task with… (+77 more)

### Community 28 - "ProviderRouter"
Cohesion: 0.04
Nodes (85): extract_openai_text(), _normalize_nvidia_base_url(), _openai_url(), provider_access_tier(), _provider_field(), provider_sort_key(), ProviderConfig, ProviderRouter (+77 more)

### Community 29 - "Task"
Cohesion: 0.04
Nodes (65): tasks — Task/issue management system. Provides a lightweight task/issue tracker…, ApprovalCheckpoint, ApprovalRequest, _coerce_ts(), CommentAddRequest, ExecutionApprovalRequest, ExecutionLogEntry, FollowUpRequest (+57 more)
...
### Community 33 - "RuntimeCapabilityRegistry"
Cohesion: 0.03
...
### Community 34 - "gateway.py"
Cohesion: 0.03
Nodes (60): gateway_enabled(), Whether the OpenAI-compatible passthrough routes accept traffic. Off by…, Whether callers should route through ``LLMRouter`` (ADR-008 §8). Defaults to…, router_enabled(), _available(), build_llm_router(), ChatRequest, ProviderToggle (+52 more)

### Community 35 - "MCPClient"
Cohesion: 0.04
...
### Community 37 - "WorkflowRun"
Cohesion: 0.04
Nodes (52): MergeDecision, _NoopStore, Phase, Any, Enum, Exception, Approve a run paused at the ApprovalGate. The caller must re-invoke…, Inject additional instructions into an in-flight run (no state change). Backs… (+44 more)
...
Cohesion: 0.04
Nodes (73): delete_company_endpoint(), delete, patch, Update a company's metadata. Accepts partial updates for company fields…, Delete a company and all associated data. Access control is handled by…, update_company(), autonomy_status(), Public autonomy readiness probe — no authentication required. A live deploy… (+65 more)
...
### Community 41 - "get"
Cohesion: 0.02
Nodes (83): auth_me(), auto_recommend_skills(), _brain_provider_status(), _check_storage_health(), cost_attribution_stats(), discover_remote_skills(), doctor_health(), get_brain_policy_route() (+75 more)

### Community 42 - "ExecutionRequest"
Cohesion: 0.05
Nodes (46): Called by APScheduler when a cron fires. Dispatches to the orchestrator. This…, _scheduler_on_fire(), OrchestratorSupervisor, Any, Emit an alert to the activity feed and log., Deterministic supervisor for the orchestrator. Runs as a background coroutine.…, stop_orchestrator_supervisor(), ExecutionRequest (+38 more)
...
### Community 49 - "get_scheduler"
Cohesion: 0.03
Nodes (57): get_sam(), agent/sam.py — SAM Voice Agent (System Autonomy Manager) SAM is the voice-…, _get_backend_sam(), legacy_scheduler_delete(), legacy_scheduler_get(), Lazy-init the SAM agent for the backend deployment., Get SAM's current status., Send a voice command to SAM and get a spoken response. (+49 more)
...
### Community 51 - "TaskStatus"
Cohesion: 0.05
Nodes (60): autonomy_tick(), Execute ONE pending task synchronously. Called by the cron workflow every 2…, Task, Helpers that turn scheduler and playbook activity into real tasks., Creates tasks from scheduler and playbook runs using one workflow., TaskAutomationService, TaskStatus, Record the human decision on a task's **pre-execution** approval gate. A… (+52 more)

### Community 52 - "direct_chat.py"
Cohesion: 0.05
Nodes (70): DirectChatDoctor, PreflightIssue, Any, BaseModel, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace…, Translate technical preflight issues into a conversational assistant reply., translate_error_to_conversational(), AcceptedJob (+62 more)
...
### Community 60 - "BrainWatchdog"
Cohesion: 0.04
Nodes (53): emit_agency_observation(), Record an agency platform operation in Langfuse. Unlike…, provider_key_present(), True when the env var for *provider*'s key is set (or it's Ollama)., Any, packages/ai/self_heal.py — automatic brain self-healing. When the active brain…, One-shot self-healing pass. 1. Checks if the active brain provider is in a…, self_heal_brain_and_unblock_tasks() (+45 more)

### Community 61 - "test_agent_tool_governance.py"
Cohesion: 0.05
Nodes (63): Replace the process-wide store. Tests only., reset_approval_store(), AuditLog, Any, packages/governance/audit.py — the evidence trail for every governed action.…, Redact SSNs and Luhn-valid payment-card numbers from a string. Runs after the…, Redact secret-shaped substrings, then truncate., Bounded in-memory ring buffer plus a structured log stream. The ring buffer… (+55 more)
...
### Community 75 - "test_web_reach.py"
Cohesion: 0.06
Nodes (55): Register the Web Reach capability (agent/web_reach.py): zero-key internet…, _register_web_reach_tools(), get_web_reach(), _load_script_module(), Any, ModuleType, Dynamically load a pure-stdlib helper module from .github/scripts/. Returns…, Zero-key internet access: pages, YouTube transcripts, search, RSS. Every public… (+47 more)
...
### Community 80 - "TaskExecutionCoordinator"
Cohesion: 0.05
Nodes (48): Background dispatcher for task execution., _gate_outward_facing_enabled(), _is_brain_connection_error(), _is_outward_facing(), Any, BaseException, TaskSpec, Domain services for task workflow and runtime-backed execution. (+40 more)

### Community 81 - "_resolve_brain_provider"
Cohesion: 0.05
...
### Community 84 - "resolve_active_brain"
Cohesion: 0.06
Nodes (62): allow_paid_brain(), BrainResolution, get_active_brain_sync(), get_provider_role_tags(), _host_is_openai_compatible(), invalidate_brain_cache(), _norm(), _pick_from_records() (+54 more)

### Community 85 - "telegram_bot.py"
Cohesion: 0.06
Nodes (59): _admin_headers(), _answer_callback(), _api_headers(), _check_rate_limit(), cmd_control(), cmd_cost(), cmd_keylist(), cmd_merge() (+51 more)

### Community 86 - "KeyStore"
Cohesion: 0.06
...
### Community 104 - "CEODispatcher"
Cohesion: 0.06
Nodes (46): CEODispatcher, CEOResult, _complexity_rank(), _offload(), Any, Run a synchronous ledger call without blocking the event loop. ``CEOLedger`` is…, Build an agent.coordinator.TaskSpec from a CEO SpecialistTask., Aggregated output from a multi-specialist execution. (+38 more)
...
### Community 108 - "services/background.py"
Cohesion: 0.06
Nodes (51): get_improvement_loop(), get_skill_registry_safe(), Return the global SkillRegistry if set, else None. Used by onboarding and other…, get_trend_watcher(), agent/trend_watcher.py — Internet-connected AI trend intelligence. Fetches from…, set_trend_watcher(), _await_hermes_ready(), BackgroundServices (+43 more)
...
### Community 110 - "test_colibri_brain_shim.py"
Cohesion: 0.06
...
### Community 112 - "skill_bindings.py"
Cohesion: 0.05
...
### Community 114 - "test_sam_livekit.py"
Cohesion: 0.05
...
### Community 117 - "PortfolioManager"
Cohesion: 0.05
...
### Community 128 - "Artifact"
Cohesion: 0.07
Nodes (31): AgentRole, tests/test_workflow_models.py — Unit tests for workflow/models.py., TestCheckRun, TestSlice, workflow/artifact_store.py — Durable artifact persistence. Artifacts are stored…, _extract_slices_from_plan(), workflow/engine.py — WorkflowEngine: CRISPY phase sequencer. The engine is the…, Extract slice definitions from a plan.md artifact. Looks for sections matching:… (+23 more)
...
### Community 136 - "test_response_cache.py"
Cohesion: 0.10
...
### Community 143 - "LLMRouter"
Cohesion: 0.07
Nodes (31): Attempt, payload_key(), Exact-match cache key over the fields that change the answer. Routing…, text_key(), describe(), The operator-facing reason string for an unfixable status., Read the environment variables named in ``env_names`` into a key list. Order is…, resolve_keys() (+23 more)
...
### Community 146 - "test_governance_api.py"
Cohesion: 0.06
...
### Community 153 - "Platform Guide — the full tour"
Cohesion: 0.04
...
Cohesion: 0.06
Nodes (36): E2BAdapter, Any, TaskResult, Execute a task inside a fresh E2B sandbox. Flow: 1. Open an…, Run ``pytest`` inside the sandbox. Returns ``(output, passed)``.…, Runtime adapter that executes tasks inside an E2B sandbox. Activation:…, _FakeAsyncSandboxClass, _FakeCommandResult (+28 more)
...
### Community 161 - "portfolio_intelligence.py"
Cohesion: 0.07
...
### Community 162 - "test_ceo_router.py"
Cohesion: 0.07
...
### Community 175 - "test_bedrock_provider.py"
Cohesion: 0.08
...
### Community 181 - "test_telegram_freebuff.py"
Cohesion: 0.07
...
### Community 183 - "test_process_quick_note_workflow.py"
Cohesion: 0.05
...
### Community 199 - "provider_max_rpm"
Cohesion: 0.07
...
### Community 215 - "resolve_component_model"
Cohesion: 0.06
...
### Community 217 - "NotificationDispatcher"
Cohesion: 0.07
...
### Community 219 - "TestRuntimeControl"
Cohesion: 0.05
...
### Community 225 - "get_failover_manager"
Cohesion: 0.07
...
### Community 229 - "WorkflowBuildRequest"
Cohesion: 0.08
...
### Community 233 - "configuration-reference.md"
Cohesion: 0.07
...
### Community 240 - "test_portfolio_intelligence.py"
Cohesion: 0.06
...
### Community 243 - "test_daily_2026_06_04.py"
Cohesion: 0.08
...
### Community 244 - "TestCatalogFable51"
Cohesion: 0.09
...
### Community 245 - "TestAuthAndTaskOwnership"
Cohesion: 0.06
...
### Community 249 - "get_tool_annotations"
Cohesion: 0.08
...
### Community 253 - "nvidia_models.py"
Cohesion: 0.09
...
### Community 254 - "output_filter.py"
Cohesion: 0.07
...
### Community 261 - "loop.py"
Cohesion: 0.09
Nodes (32): _check_extra_kwargs(), _enforce_signature(), _note_phase_end(), _note_phase_start(), loop.py — AgentRunner: plan → execute → verify loop with locked tool signatures., Raise TypeError if fn's signature drifts from the locked contract (Pydantic…, Raise TypeError on unknown kwarg (runtime extra='forbid' for non-Pydantic…, # NOTE: "ollama_base" is kept for backwards compatibility; this runner only… (+24 more)
...
### Community 266 - "scrub"
Cohesion: 0.08
Nodes (21): _luhn_ok(), True when ``digits`` (bare, no separators) satisfies the Luhn checksum., Recursively strip secrets from an arbitrary argument structure. Fails…, scrub(), _truncate(), tests/test_governance_audit_pii.py — PII redaction in the audit scrubber.…, TestCardRedaction, TestLuhn (+13 more)

### Community 267 - "local_controller.py"
Cohesion: 0.12
...
### Community 278 - "test_live_server.py"
Cohesion: 0.22
...
### Community 279 - "ContextCompressor"
Cohesion: 0.11
...
### Community 283 - "LlmProviderConfig"
Cohesion: 0.15
...
### Community 284 - "autonomous_fix.py"
Cohesion: 0.10
...
### Community 285 - "test_provider_render_env.py"
Cohesion: 0.09
...
### Community 286 - "report_to_markdown"
Cohesion: 0.10
...
### Community 297 - "OrchestratorCheckpointStore"
Cohesion: 0.09
...
### Community 299 - "test_nvidia_model_discovery.py"
Cohesion: 0.06
...
Cohesion: 0.11
Nodes (24): get_skill(), list_skills(), List all available skills with optional filtering. Returns the skill catalog…, Get a single skill by its ID., build_matrix(), _families(), main(), Any (+16 more)

### Community 307 - "facade.py"
Cohesion: 0.09
...
### Community 308 - "_resolve_user_github_token"
Cohesion: 0.11
...
### Community 312 - "test_rate_limiter.py"
Cohesion: 0.10
...
### Community 333 - "OrchestratorQueue"
Cohesion: 0.08
...
### Community 345 - "telegram_inbound_handlers.py"
Cohesion: 0.12
...
### Community 356 - "RuntimeHealthService"
Cohesion: 0.11
...
### Community 359 - "test_anthropic_refusal_fallback.py"
Cohesion: 0.15
...
### Community 361 - "validate_outbound_url"
Cohesion: 0.14
...
### Community 364 - "VoiceCommandInterface"
Cohesion: 0.14
...
### Community 366 - "Performance Analysis — local-llm-server"
Cohesion: 0.08
...
### Community 367 - "platform_controls_router.py"
Cohesion: 0.10
...
### Community 368 - "LLM Router — troubleshooting"
Cohesion: 0.08
...
### Community 380 - "test_dashboard_cache.py"
Cohesion: 0.12
...
### Community 383 - "Session Handoff — 2026-06-15"
Cohesion: 0.08
...
### Community 384 - "TASK 4 — End-to-end approval-gate test"
Cohesion: 0.08
...
### Community 387 - "test_connector_registry.py"
Cohesion: 0.12
...
### Community 388 - "NIMConnectionPool"
Cohesion: 0.11
...
### Community 389 - "_InMemoryBackend"
Cohesion: 0.11
...
### Community 409 - "test_memory_guard.py"
Cohesion: 0.13
...
### Community 411 - "test_agency_fix.py"
Cohesion: 0.08
...
### Community 413 - "test_skill_registry.py"
Cohesion: 0.09
...
### Community 415 - "test_webui_provider_priority.py"
Cohesion: 0.21
...
### Community 418 - "Agent Governance Guide"
Cohesion: 0.09
...
### Community 419 - "The fifteen strategies"
Cohesion: 0.09
...
### Community 420 - "SetupWizardPage.js"
Cohesion: 0.13
...
### Community 423 - "test_north_mini_code.py"
Cohesion: 0.09
...
### Community 424 - "TestModelRegistryUpdates"
Cohesion: 0.14
...
### Community 439 - "AdaptivePermissions"
Cohesion: 0.18
...
### Community 443 - "openclaw_str_e_fix.py"
Cohesion: 0.14
...
### Community 446 - "test_phase4_runtime_resilience.py"
Cohesion: 0.15
...
### Community 447 - "get_ceo_dispatcher"
Cohesion: 0.11
...
### Community 455 - "render_router.py"
Cohesion: 0.12
...
### Community 462 - "reset_failover_manager"
Cohesion: 0.10
...
### Community 463 - "test_issue_triage.py"
Cohesion: 0.17
...
### Community 465 - "test_openclaw_str_e_fix.py"
Cohesion: 0.10
...
### Community 467 - "test_unit5_ui_provider_surface.py"
Cohesion: 0.10
...
### Community 484 - "is_anthropic_base_url"
Cohesion: 0.12
...
### Community 485 - "build_workflow.py"
Cohesion: 0.30
...
### Community 526 - "Comprehensive Skill Index (By Category)"
Cohesion: 0.11
...
### Community 527 - "Agent Skill: Principal UI/UX Architect & Motion Choreographer (Awwwards-Tier)"
Cohesion: 0.11
Nodes (17): 1. Meta Information & Core Directive, 2. THE "ABSOLUTE ZERO" DIRECTIVE (STRICT ANTI-PATTERNS), 3. THE CREATIVE VARIANCE ENGINE, 4. HAPTIC MICRO-AESTHETICS (COMPONENT MASTERY), 5. MOTION CHOREOGRAPHY (FLUID DYNAMICS), 6. PERFORMANCE GUARDRAILS, 7. EXECUTION PROTOCOL, 8. PRE-OUTPUT CHECKLIST (+9 more)

### Community 528 - "Component Map"
Cohesion: 0.11
...
### Community 529 - "test_minimax_bug_fixes.py"
Cohesion: 0.13
...
### Community 534 - "Part A — Health Report"
Cohesion: 0.11
...
### Community 542 - "_install"
Cohesion: 0.19
Nodes (10): _install(), asyncio, Exception, Remote skills are optional; a rate limit must not surface as an error., Stands in for SkillRegistry, recording whether the fetch happened., It must be fire-and-forget: this is one HTTP round trip per registry., A deployment without a skill registry must still boot cleanly., Web lifespan and worker_main can both call into one process. (+2 more)
...
### Community 559 - "redact_connection_url"
Cohesion: 0.17
...
### Community 560 - "kimi_bridge_provider_config"
Cohesion: 0.18
...
### Community 561 - "agent_readiness_audit.py"
Cohesion: 0.21
...
### Community 567 - "_StubScheduler"
Cohesion: 0.14
Nodes (11): anyio, Scheduler's on_fire handler is set to TaskAutomation.handle_scheduled_job., Calling bg.stop() twice must not raise or double-stop., A Hermes that never reports ready must not be waited on past the budget.…, start_background_services() must start the RuntimeManager., _StubDispatcher, _StubScheduler, test_hermes_readiness_wait_gives_up_within_its_budget() (+3 more)
...
### Community 582 - "_is_ephemeral_user"
Cohesion: 0.19
...
### Community 593 - "_build_default_manager"
Cohesion: 0.14
...
### Community 604 - "test_langfuse_agency_wide.py"
Cohesion: 0.12
...
### Community 629 - "test_daily_2026_07_24.py"
Cohesion: 0.20
...
### Community 632 - "check_model_catalog_consistency.py"
Cohesion: 0.22
...
### Community 634 - "telegram_service.py"
Cohesion: 0.16
...
### Community 636 - "TestBrainConfigUpdates"
Cohesion: 0.22
...
### Community 637 - "DecisionsStoreTests"
Cohesion: 0.13
...
### Community 638 - "test_dockerfile_ships_config_dir.py"
Cohesion: 0.14
...
### Community 639 - "test_task_service_failed_comment.py"
Cohesion: 0.21
...
### Community 641 - "migrate_local_brain_env.py"
Cohesion: 0.19
...
### Community 655 - "mint_access_token"
Cohesion: 0.14
...
### Community 661 - "DirectChatSession"
Cohesion: 0.15
...
### Community 672 - "test_p0_roadmap_b3_b4_b5.py"
Cohesion: 0.20
...
### Community 707 - "verify_service_token"
Cohesion: 0.22
...
### Community 712 - "test_background_services.py"
Cohesion: 0.19
...
### Community 713 - ".on_task_complete"
Cohesion: 0.18
...
### Community 719 - "test_doctor_service_token_check.py"
Cohesion: 0.23
...
### Community 720 - "TestTheGatewayRegistryOffersOnlyLiveModels"
Cohesion: 0.22
...
### Community 734 - "Skill: agent-browser — Real Chrome Browser Automation"
Cohesion: 0.17
...
### Community 737 - "Skill: dev-browser — Browser Automation via Sandboxed JS"
Cohesion: 0.17
...
### Community 739 - "Agent Orchestration Design"
Cohesion: 0.17
...
### Community 740 - "Universality: case-coverage matrix"
Cohesion: 0.17
...
### Community 742 - "Implementation — DB-persisted, UI-switchable Brain (PR #824 follow-up)"
Cohesion: 0.17
...
### Community 743 - "2. Pending ⬜ — detailed implementation specs"
Cohesion: 0.17
...
### Community 744 - "467 Public Site Truth Spec"
Cohesion: 0.17
...
### Community 747 - "install-agents.sh"
Cohesion: 0.39
...
### Community 748 - "check_container_posture.py"
Cohesion: 0.26
...
### Community 749 - "test_pytest_failure_parser.py"
Cohesion: 0.23
...
### Community 752 - "test_admin_local_brain_router.py"
Cohesion: 0.29
...
### Community 753 - "test_agile_api.py"
Cohesion: 0.17
...
### Community 754 - "test_app_settings.py"
Cohesion: 0.21
...
### Community 755 - "test_brain_default_consistency.py"
Cohesion: 0.24
...
### Community 756 - "TestAnthropicWorkspaceIdCapture"
Cohesion: 0.33
...
### Community 757 - "TestAuthAndTaskCreation"
Cohesion: 0.17
...
### Community 758 - "TestAnthropicPayloadStructuredOutput"
Cohesion: 0.29
...
### Community 759 - "test_task_clarification.py"
Cohesion: 0.17
...
### Community 808 - "_normalize_tool_choice"
Cohesion: 0.31
...
### Community 809 - "Agent: Reviewer (Verifier)"
Cohesion: 0.20
...
### Community 811 - "Skill: browserbase-ui-test — Adversarial UI Testing"
Cohesion: 0.20
...
### Community 812 - "Skill: financial-analyst (Agentic CFO)"
Cohesion: 0.20
...
### Community 813 - "Graphiti Temporal Context Skill"
Cohesion: 0.20
...
### Community 814 - "Skill: seo-audit-report"
Cohesion: 0.20
...
### Community 815 - "ADR-008: LLMRouter — the single multi-provider routing gateway"
Cohesion: 0.20
...
### Community 817 - "467 Golden Path — Locked Implementation Order"
Cohesion: 0.20
...
### Community 818 - "Competitor Analysis — Autonomous AI Agency"
Cohesion: 0.20
...
### Community 819 - "Issue #1427: quick-note:https://github.com/bingreeky/JIT"
Cohesion: 0.20
...
### Community 820 - "LLM Router — configuration guide"
Cohesion: 0.20
...
### Community 821 - "LLM Router — provider guide"
Cohesion: 0.20
...
### Community 822 - "CI Troubleshooting Runbook"
Cohesion: 0.20
...
### Community 823 - "local_brain_provider_config"
Cohesion: 0.29
...
### Community 826 - "flesch_reading_ease"
Cohesion: 0.24
...
### Community 827 - "_redact_for_notification"
Cohesion: 0.24
...
### Community 828 - "_FakeAsyncClient"
Cohesion: 0.20
...
### Community 832 - "TestSessionMemory"
Cohesion: 0.20
...
### Community 833 - "test_model_catalog_guard.py"
Cohesion: 0.29
...
### Community 837 - "test_skill_registry_boot_refresh.py"
Cohesion: 0.22
Nodes (6): clean_task(), _NullDispatcher, _NullRuntimeManager, The configured remote skill repos must be fetched without a human trigger.…, The guard against re-creating the very bug this fixes. ``refresh_remote``…, test_startup_actually_calls_it()

### Community 838 - "_Recorder"
Cohesion: 0.20
...
### Community 843 - "_extract_workflow_relevance"
Cohesion: 0.33
...
### Community 846 - "Skill: changelog-enforcer"
Cohesion: 0.22
...
### Community 847 - "Skill: learn-rule"
Cohesion: 0.22
...
### Community 849 - "prompts/README.md"
Cohesion: 0.22
Nodes (4): Command: /resume, References, Usage, What It Does

### Community 850 - "Skill: Agentic Portfolio Management"
Cohesion: 0.22
...
### Community 851 - "Skill: changelog-enforcer"
Cohesion: 0.22
Nodes (8): Acceptance Checks, Changelog Location, Entry Format, Examples, Hook Behaviour, Instructions, Skill: changelog-enforcer, When to Use

### Community 852 - "Skill: cowork-session (Claude Cowork)"
Cohesion: 0.22
Nodes (8): Branch, Components, Purpose, Quick Start, Session Roles, Skill: cowork-session (Claude Cowork), Testing, When to Use

### Community 853 - "Skill: video-context — read a video without watching it"
Cohesion: 0.22
...
### Community 854 - "Active Task Tracker"
Cohesion: 0.22
...
### Community 857 - "Autonomous SDLC Loop (Agency Core, repo-agnostic)"
Cohesion: 0.22
...
### Community 858 - "The 8-Step Golden Path"
Cohesion: 0.22
...
### Community 859 - "Issue #1356: quick-note:https://searchengineland.com/turn-seo-backlog-into-roadmap-485713"
Cohesion: 0.22
...
### Community 860 - "PR #634 Implementation Tracker"
Cohesion: 0.22
...
### Community 861 - "KV Cache Internals"
Cohesion: 0.22
...
### Community 862 - "Platform Controls"
Cohesion: 0.22
...
### Community 863 - "Release Procedure"
Cohesion: 0.22
...
### Community 864 - "V2.0 Modernization — Runbook"
Cohesion: 0.22
...
### Community 867 - "ENGINEERING_STANDARDS.md — Patterns & Reference"
Cohesion: 0.22
...
### Community 868 - "_extract_pytest_failure"
Cohesion: 0.42
...
### Community 876 - "test_backend_requirements_cover_runtime_imports.py"
Cohesion: 0.25
...
### Community 881 - "TestPaidPolicyDurability"
Cohesion: 0.22
...
### Community 882 - "test_scanner_deps_parity.py"
Cohesion: 0.31
...
### Community 883 - "test_serve_spa_prefixes.py"
Cohesion: 0.31
...
### Community 894 - "_build_direct_chat_schedule_suggestion"
Cohesion: 0.32
...
### Community 946 - "tests/conftest.py"
Cohesion: 0.29
...
### Community 957 - "TestItIsNotBuiltForOneVendor"
Cohesion: 0.25
...
### Community 958 - "test_compose_and_coordinate_api.py"
Cohesion: 0.36
...
### Community 959 - "test_generate_context_standing_instructions.py"
Cohesion: 0.32
...
### Community 960 - "test_local_brain_router_smoke.py"
Cohesion: 0.25
...
### Community 962 - "test_provider_models_db_outage.py"
Cohesion: 0.25
...
### Community 963 - "test_runtimes_health_endpoint.py"
Cohesion: 0.25
...
### Community 964 - "test_seo_audit_pending_expiry.py"
Cohesion: 0.43
...
### Community 981 - "AI Engineering Insights Skill"
Cohesion: 0.29
...
### Community 995 - "claude-mem Plugin — Persistent Memory for All Sessions"
Cohesion: 0.29
...
### Community 996 - "Implementation plan + TO-DO (check off as you go)"
Cohesion: 0.29
...
### Community 999 - "Cloudflare = the real working app"
Cohesion: 0.29
...
### Community 1000 - "Workspace Issues"
Cohesion: 0.29
...
### Community 1009 - "check_changelog_parity.py"
Cohesion: 0.43
...
### Community 1013 - "test_daily_2026_06_14.py"
Cohesion: 0.38
...
### Community 1014 - "TestSupportMatrixDocsSync"
Cohesion: 0.29
...
### Community 1015 - "test_doctor_coding_brain.py"
Cohesion: 0.38
...
### Community 1036 - "5. The five autonomous loops"
Cohesion: 0.33
...
### Community 1037 - "Master Goal Prompt — Autonomous Agency CEO"
Cohesion: 0.33
...
### Community 1038 - "Agency Core — Operational Knowledge (verified live, 2026-06-10/11)"
Cohesion: 0.33
...
### Community 1039 - "Pre-Mortem Analysis: Agency Core autonomy story (Cloudflare deployment)"
Cohesion: 0.33
...
### Community 1040 - "SECTION B — NVIDIA / Cloud Model Integration (Nemotron / NVD)"
Cohesion: 0.33
...
### Community 1041 - "SECTION D — Deployment & Infrastructure (CHM / NVD)"
Cohesion: 0.33
...
### Community 1051 - "_decompose_into_subtasks"
Cohesion: 0.33
...
### Community 1059 - "TestWorkflowIntegration"
Cohesion: 0.33
...
### Community 1082 - "SECTION E — Autonomy & Self-Healing (AOS / MYT / ECC)"
Cohesion: 0.40
...
### Community 1083 - "SECTION F — Developer Experience (CBF / ECC)"
Cohesion: 0.40
...
### Community 1086 - "Agent API Issues"
Cohesion: 0.40
...
### Community 1087 - "Network and Tunnel Issues"
Cohesion: 0.40
...
### Community 1097 - "build_llama_cpp.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1098 - "download_glm52_weights.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1099 - "download_glm52_weights.sh script"
Cohesion: 0.70
Nodes (4): download_glm52_weights.sh script, fail(), ok(), warn()

### Community 1100 - "_fetch_pytest_failures.py"
Cohesion: 0.50
...
### Community 1101 - "setup_colibri.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), Warn(), W()

### Community 1102 - "setup_colibri.sh script"
Cohesion: 0.70
Nodes (4): setup_colibri.sh script, fail(), ok(), warn()

### Community 1103 - "status_colibri_server.ps1"
Cohesion: 0.70
Nodes (4): Fail(), Ok(), W(), Warn()

### Community 1104 - "start_tunnel.py"
Cohesion: 0.50
...
### Community 1108 - "nvidia_live_test.py"
Cohesion: 0.40
...
### Community 1110 - "test_agent_runtime_wrapper.py"
Cohesion: 0.70
...
### Community 1114 - "TestModelRoleSeparation"
Cohesion: 0.40
...
### Community 1115 - "worker/index.js"
Cohesion: 0.60
...
### Community 1132 - "Claude Code Specific Issues"
Cohesion: 0.50
...
### Community 1139 - "_resolve_default_executor_model"
Cohesion: 0.50
Nodes (3): Any, Resolve the default executor model via the catalog (UNIT 7). Was hardcoded to…, _resolve_default_executor_model()

### Community 1140 - "stop_colibri_server.ps1"
Cohesion: 0.83
Nodes (3): Fail(), Ok(), W()

### Community 1141 - "test_nim_models.py"
Cohesion: 0.67
Nodes (3): main(), Quick smoke-test for NVIDIA NIM model IDs. Usage: NVIDIA_API_KEY=nvapi-...…, test_model()

### Community 1143 - "start_server.sh"
Cohesion: 0.50
...
### Community 1150 - "test_agent_loop_nosec_suppression.py"
Cohesion: 0.50
...
### Community 1152 - ".test_onboarding_service_initialization"
Cohesion: 0.50
...
- **3530 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `redact_secrets.sh script`, `docker`, `RENDER_API_KEY` (+3525 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 13495 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **113 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `_fixture()` connect `_fixture` to `company_api.py`, `test_brain_patch_service_token.py`, `llm/router.py`, `test_llm_router_queue_cache.py`, `test_gh_brain_failover.py`, `resolve_identity`, `test_llm_router_strategies.py`, `test_operational_incidents.py`, `AgentSessionStore`, `test_model_router.py`, `ImprovementLoop`, `test_governance_enforcement.py`, `AgentJobManager`, `PrimeAgentAdapter`, `SelfHealingAgent`, `config.py`, `test_company_api.py`, `TaskStore`, `Task`, `E2BSandboxSession`, `test_telegram_service_webhook.py`, `test_telegram_webhook.py`, `gateway.py`, `MCPClient`, `test_unit8_model_catalog.py`, `WorkflowRun`, `test_llm_router_resilience.py`, `SeoAuditEngine`, `cost_tracker.py`, `test_failover_client_shared.py`, `settings.py`, `get_scheduler`, `AgentSwarm`, `TaskStatus`, `test_agent_tool_governance.py`, `test_openclaw_endpoints.py`, `AgentDefinition`, `test_brain_availability_doctor.py`, `ChatHistoryStore`, `ai/router.py`, `TokenBudget`, `ResearchTask`, `TaskExecutionCoordinator`, `_resolve_brain_provider`, `TestClient`, `SQLiteStore`, `resolve_active_brain`, `e2e/test_browser.py`, `KeyStore`, `test_autonomy_status.py`, `test_procedural_memory.py`, `test_local_brain_state.py`, `OutputFilter`, `test_phase5_doctor.py`, `test_refresh_agent_built_proof.py`, `test_tasks_reconciler_todo_requeue.py`, `clear_cooldowns`, `services/background.py`, `test_knowledge_sync.py`, `_clean_director`, `BackgroundAgent`, `SeoFixer`, `ModelRouter`, `get_self_healing_agent`, `test_task_service_failed_comment.py`, `TaskPriority`, `sam`, `TestHarnessAdapter`, `test_context_rulebook.py`, `ArtifactStore`, `run_task`, `test_response_cache.py`, `test_new_features_e2e.py`, `UserRole`, `test_issue_intake.py`, `_step`, `test_trend_watcher.py`, `claim`, `test_ceo_router.py`, `persist_plan_spec`, `test_changelog_check_workflow.py`, `TestEstimateTokensForMessages`, `test_openclaw_gateway.py`, `FeatureMaturity`, `test_process_quick_note_workflow.py`, `OllamaCircuitBreaker`, `_job_text`, `_Budget`, `test_portfolio_intake.py`, `test_features_api.py`, `test_video_transcript.py`, `TrendWatcher`, `test_doctor_service_token_check.py`, `SchedulerStore`, `test_task_brain_preflight.py`, `test_e2b_data_flow.py`, `NotificationDispatcher`, `TestRuntimeControl`, `TestClient`, `test_agile_api.py`, `test_app_settings.py`, `TestAuthAndTaskCreation`, `ContextPruner`, `api_keys_for`, `TestAuthAndTaskOwnership`, `test_task_clarification.py`, `test_persistent_memory.py`, `SecurityScanner`, `test_llm_router_e2e.py`, `test_platform_controls.py`, `analyze_page`, `test_sam_voice.py`, `OrchestratorCheckpointStore`, `test_nvidia_model_discovery.py`, `_resolve_user_github_token`, `TestNormalizeResponseFormat`, `test_rate_limiter.py`, `test_llm_router_disabled.py`, `test_catalogue_probe.py`, `isolated_telegram_config`, `session_retro.py`, `TestMongoGate`, `test_skill_registry_boot_refresh.py`, `_Recorder`, `test_scheduler_hydration_bounded.py`, `test_provider_state_durability.py`, `OrchestratorQueue`, `telegram_inbound_handlers.py`, `test_regression.py`, `test_agent_scripts_share_one_model_list.py`, `test_crispy_burn_in.py`, `model_discovery.py`, `ai/watchdog.py`, `_start_ceo_agency`, `TestSwarmRoleRouting`, `platform_controls_router.py`, `test_provider_enable_disable.py`, `_undeclared`, `test_dashboard_cache.py`, `test_service_token.py`, `test_harness_spec.py`, `test_agency_fix.py`, `_Recorder`, `test_webui_provider_priority.py`, `test_monitor_lib.py`, `test_v4_api.py`, `TestTheWorkflowIsSafeAndReadOnly`, `get_ceo_dispatcher`, `test_ping.py`, `test_telegram_diag_endpoint.py`, `test_runtimes_health_endpoint.py`, `test_task_store_fails_loud_in_production.py`, `UsageEvent`, `reset_failover_manager`, `test_kimi_bridge_server.py`, `test_voice_pipeline.py`, `client`, `test_doctor_coding_brain.py`?**
  _High betweenness centrality (0.088) - this node is a cross-community bridge._
- **Why does `AgentRunner` connect `AgentRunner` to `TaskSpec`, `backend/server.py`, `loop.py`, `proxy.py`, `resolve_identity`, `FreeBuffAgent`, `AgentSessionStore`, `test_ceo_dispatcher.py`, `test_governance_api.py`, `ImprovementLoop`, `test_governance_enforcement.py`, `ReactScratchpad`, `test_ceo_micromanager.py`, `ContextManager`, `AgentJobManager`, `E2BSandboxSession`, `E2BAdapter`, `TestAgentRunnerSafety`, `test_empirical_verify.py`, `TestAgentRunnerExecution`, `test_backend_server_features.py`, `TaskDispatcher`, `WorkflowRun`, `MCPClient`, `AdaptiveHalter`, `test_failover_client_shared.py`, `MultiAgentSwarm`, `StuckDetector`, `WorkspaceTools`, `direct_chat.py`, `test_daily_automation_2026_07_11.py`, `test_agent_tool_governance.py`, `get_ceo_dispatcher`, `TokenBudget`, `reset_failover_manager`, `LocalWorkspace`, `resolve_active_brain`, `CEODispatcher`, `InternalAgentAdapter`, `GitHubTools`, `ContextPruner`, `BackgroundAgent`, `UserMemoryStore`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `ProviderRouter` connect `ProviderRouter` to `backend/server.py`, `test_all_providers_discovery.py`, `failover_client.py`, `implement_agent.py`, `test_bedrock_live.py`, `test_backend_server_features.py`, `HealthStatus`, `test_bedrock_provider.py`, `kimi_bridge_provider_config`, `direct_chat.py`, `TestFromEnvBedrock`, `Provider`, `TestLegacyRouterCacheTTL`, `ai/router.py`, `TrafficDirector`, `_payload`, `test_chat_mode_regressions.py`, `is_anthropic_base_url`, `test_anthropic_refusal_fallback.py`, `clear_cooldowns`, `TestOpenAiToBedrockConverse`, `test_colibri_brain_shim.py`, `TestAnthropicPayloadStructuredOutput`?**
