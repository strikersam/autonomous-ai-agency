...
## Corpus Check
- 909 files · ~1,054,600 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 16662 nodes · 35875 edges · 813 communities (721 shown, 92 thin omitted)
- Extraction: 79% EXTRACTED · 21% INFERRED · 0% AMBIGUOUS · INFERRED: 7665 edges (avg confidence: 0.52)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6d4b5ee4`
...
1. `AgentRunner` - 253 edges
2. `AgentSessionStore` - 207 edges
3. `TaskSpec` - 187 edges
4. `UserMemoryStore` - 143 edges
5. `RuntimeUnavailableError` - 139 edges
6. `TaskResult` - 138 edges
7. `AgentJobManager` - 136 edges
8. `RuntimeAdapter` - 136 edges
9. `AgentScheduler` - 128 edges
10. `RuntimeExecutionError` - 126 edges

## Surprising Connections (you probably didn't know these)
- `Any` --uses--> `OutputFilter`  [INFERRED]
  webui/commands.py → agent/output_filter.py
- `Path` --uses--> `OutputFilter`  [INFERRED]
  webui/commands.py → agent/output_filter.py
...
- 1-file cycle: `services/seo_audit.py -> services/seo_audit.py`
...
## Communities (813 total, 92 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.08
Nodes (33): AgentDirective, AgentPlan, AgentStep, _fake_user(), _FakeChatResult, _FakeResponse, Path, UserInfo (+25 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (256): get_harness_adapter(), Set the global agent store instance (e.g., with MongoDB on startup)., set_agent_store(), _agent_provider_failure_response(), _agent_timeout_fallback_response(), _append_agent_session_message(), auto_recommend_skills(), _build_agent_status_snapshot() (+248 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (80): AiderAdapter, Adapter for Aider — TIER 3 specialized git-aware code editor., GooseAdapter, Adapter for Goose — TIER 2 general-purpose local runtime., HermesAdapter, Adapter for Hermes Agent — FIRST CLASS autonomous runtime., JCodeAdapter, Write .jcode/mcp.json in the workspace, pointing at our proxy's MCP endpoint. (+72 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (106): MongoDBStore, Company, KnowledgeItem, ObjectId, Repo, Specialist, Website, Delete a company and all its associated data. (+98 more)

### Community 4 - "Community 4"
Cohesion: 0.10
Nodes (14): _bedrock_api_response(), _bedrock_provider(), _mock_boto3(), Tests for AWS Bedrock provider support in ProviderRouter., Inject a mock boto3 module into sys.modules for the duration of the block., Verify that Bedrock model IDs bypass non-Bedrock providers., When model is a Bedrock ID, NIM should not be attempted., When NIM is skipped, Bedrock becomes the primary provider and uses the original (+6 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (206): AgentJobRequest, AgentJobSnapshot, Complete point-in-time view of a job, safe to serialise as API response., Convenience: the canonical text response, whether success or failure., Validated input for creating a new agent job.      Passed from the API handler, DirectChatDoctor, AgentJobManager, AgentRunner (+198 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (110): Synchronize the Company Graph.          Re-scans all websites and repositories,, sync_company_graph(), BusinessCategory, CompanyGraphService, BusinessSystem, CompanyGraph, CompanyGraphSnapshot, DetectedSystem (+102 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (92): Evidence, Evidence supporting a system detection., main(), Returns (url, ok, summary)., _scan_one(), _content_contains_domain(), _hostname_contains(), _hostname_matches() (+84 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (32): _best_cloud_primary_base(), InternalAgentAdapter, _nvidia_provider_chain(), Built-in agent loop — Nvidia NIM primary, Ollama fallback., Return runtime dependencies required by this adapter.                  Returns:, Determine availability of the internal agent runtime.          Checks cloud prov, Execute a TaskSpec using the internal AgentRunner and convert the agent's outcom, Create an isolated execution context for a single task.          Tries ``git wor (+24 more)

### Community 9 - "Community 9"
Cohesion: 0.06
Nodes (131): runtimes/adapters/aider.py — Aider adapter (TIER 3 — specialized).  Aider (https, Run aider non-interactively via `--message` flag., json_safe(), runtimes/adapters/claude_code.py — Claude Code CLI adapter (FIRST CLASS).  Claud, runtimes/adapters/docker_agent.py — Docker-based agent runtime adapter.  Spawns, runtimes/adapters/goose.py — Goose adapter (TIER 2).  Goose (https://github.com/, runtimes/adapters/hermes.py — Hermes Agent adapter (FIRST CLASS).  Hermes Agent, Submit task to Hermes via its /tasks endpoint. (+123 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (214): AdminAuthManager, AdminIdentity, AdminIdentity, Agency, CEO-coordinated multi-agent agency for continuous codebase management.      Th, BackgroundTask, BrowserSession, Async Playwright browser session.      Usage::          session = BrowserSes (+206 more)

### Community 11 - "Community 11"
Cohesion: 0.11
Nodes (115): _DoctorCheck, _DoctorReport, _get_current_user_thunk(), _get_optional_user_thunk(), get_public_doctor_report(), OnboardingAnswersRequest, OnboardingProgressResponse, OnboardingQuestionsRequest (+107 more)

### Community 12 - "Community 12"
Cohesion: 0.05
Nodes (37): List recent workflow orchestrator runs.      Non-admin users see only their own, Get a single workflow orchestrator run by ID (owner or admin only)., Cancel a single orchestrator run (removes from memory).      Admin users can can, Bulk-cancel orchestrator runs by status or explicit run_id list.      Query para, workflow_orchestrator_cancel_run(), workflow_orchestrator_cancel_runs_bulk(), workflow_orchestrator_get_run(), workflow_orchestrator_list_runs() (+29 more)

### Community 13 - "Community 13"
Cohesion: 0.02
Nodes (7): downloadSeoExport(), exportSeoAudit(), getDefaultBackendUrl(), login(), refreshQueue, SEO_EXPORT_EXT, SEO_EXPORT_MIME
...
Cohesion: 0.05
Nodes (52): add_initiative(), AllocationOut, BoardOut, get_board(), get_service(), InitiativeIn, InitiativeOut, MetricsOut (+44 more)

### Community 16 - "Community 16"
Cohesion: 0.03
Nodes (66): Status of a user story within a sprint., StoryStatus, HarnessAdapter, HarnessSpec, Any, agents/harness_adapter.py — ECC Cross-Harness Adapter  Normalises API difference, Adapt harness-native requests to the local-llm-server internal format.      Each, Detect which harness sent this request from headers.          Check order: expli (+58 more)

### Community 17 - "Community 17"
Cohesion: 0.07
Nodes (40): DetectedIssue, ImprovementLoop, ImprovementLoopState, _now(), Any, Path, agent/improvement_loop.py — Continuous Improvement Engine  Background scanner, Background scanner and task dispatcher for continuous codebase improvement. (+32 more)
...
Cohesion: 0.05
Nodes (52): AdminSession, AdminSessionStore, _is_truthy(), admin_auth.py — auto-generated module docstring (user-research skill scan)., WindowsCredentialAuthenticator, ProviderManager, Path, test_admin_can_create_anthropic_provider_via_webui_admin_api() (+44 more)

### Community 20 - "Community 20"
Cohesion: 0.24
Nodes (8): BackgroundAgent, _now(), Contract: BackgroundAgent._process() is not a no-op stub.     When an agent_runn, When no runner is injected, _process returns a fallback note (not error)., When runner is injected but payload has no instruction, returns error., When runner is injected, _process invokes runner.run()., Contract: BackgroundAgent lifecycle works — submit, start, stop., TestBackgroundAgentDispatch
...
Cohesion: 0.04
Nodes (48): ContextPruner, Any, context_pruner.py — auto-generated module docstring (user-research skill scan)., Walk messages backward, accumulating per-role char counts.          Returns (kep, Wrap evicted messages into ``<historical_memory_only>`` XML.          The XML bl, Reset the prune timer so the next call always runs the pipeline., 3-phase context window management middleware.      Phase 1 — Truncate: Strips ``, Apply 3-phase pruning if the context is over budget or cache expired.          R (+40 more)

### Community 24 - "Community 24"
Cohesion: 0.13
Nodes (11): _now(), Any, Register a new job.  Returns the created :class:`ScheduledJob`., Fire a job immediately (webhook / manual trigger)., Enable or disable a job without deleting it., Attach a durable store and immediately rehydrate from it (#505).          Call, Sync entry-point for attach_persistence(); delegates to hydrate()., #505: Rehydrate persisted schedules on boot.          Returns the number of jo (+3 more)

### Community 25 - "Community 25"
Cohesion: 0.05
Nodes (48): make_isolated_workspace(), Path, agent/job_manager.py — Async agent job lifecycle manager.  Manages agent jobs, Create an isolated workspace directory under *root*.      This is the legacy p, _workspace_component(), _get_workspace_lock(), get_workspace_manager(), _hash_component() (+40 more)

### Community 26 - "Community 26"
Cohesion: 0.06
Nodes (63): classify_task(), _extract_recent_text(), Any, Task classification from request context.  Classifies an incoming request into a, Concatenate plain text from the last *last_n* messages., Return the most likely task category for this request.      Args:         messag, Tests for the dynamic model router., Short local aliases can still fall back to an installed sibling model. (+55 more)

### Community 27 - "Community 27"
Cohesion: 0.11
Nodes (21): provider_access_tier(), _provider_field(), provider_sort_key(), provider_router.py — auto-generated module docstring (user-research skill scan)., # NOTE: 429 is handled specially in _try_one_provider (immediate failover +, main(), probe_one(), ProviderRouter (+13 more)

### Community 28 - "Community 28"
Cohesion: 0.07
Nodes (43): batch_compatibility(), check_model_compatibility(), _detect_amd_gpus(), _detect_apple_silicon_gpu(), _detect_cpu(), detect_hardware(), _detect_intel_arc_gpu(), _detect_nvidia_gpus() (+35 more)

### Community 29 - "Community 29"
Cohesion: 0.12
Nodes (22): agent/workflow.py — Persisted workflow state machine.  Implements the Autonomo, Helpers that turn scheduler and playbook activity into real tasks., Background dispatcher for task execution., tasks — Task/issue management system.  Provides a lightweight task/issue tracker, ApprovalRequest, ClarifyRequest, CommentAddRequest, FollowUpRequest (+14 more)

### Community 30 - "Community 30"
Cohesion: 0.05
Nodes (67): activation_required(), ActivationResult, activate_instance(), ActivateRequest, ActivateResponse, activation_audit_log(), activation_status(), ActivationStatusResponse (+59 more)

### Community 31 - "Community 31"
Cohesion: 0.17
Nodes (9): AgentDefinition, Task, Re-run a task. Permissive across every non-active state so the dashboard, Add a follow-up instruction to a task and re-queue it for execution.          Un, Executes tasks through the runtime layer using agent definitions., Owns lifecycle transitions, comment semantics, and approval rules., TaskExecutionCoordinator, TaskWorkflowService (+1 more)

### Community 32 - "Community 32"
Cohesion: 0.06
Nodes (32): When coder == reviewer model, swarm should log a warning., background_agent(), tests/test_contracts_agency.py — Contract tests for agency core autonomy hardeni, tests/test_workflow_models.py — Unit tests for workflow/models.py., TestApprovalGate, TestCheckRun, TestSlice, workflow/artifact_store.py — Durable artifact persistence.  Artifacts are stored (+24 more)
...
Cohesion: 0.07
Nodes (28): FetchResult, MockTransport, browser_backend_available(), BrowserFetcher, FetchResult, HttpxFetcher, looks_blocked(), make_fetcher() (+20 more)
...
Cohesion: 0.09
Nodes (47): delegate_seo_findings(), export_seo_audit(), get_seo_audit(), list_seo_audits(), SeoAuditReport, SeoAuditRequest, SeoAuditSummary, SeoCheckDefinition (+39 more)

### Community 37 - "Community 37"
Cohesion: 0.09
Nodes (42): A single occurrence of a check firing on a specific URL., Snapshot of one crawled page with the on-page facts the checks used., Aggregated report row - Screaming Frog CSV compatible., Site-level facts discovered during the crawl., An agent-delegable remediation work package derived from the findings.      Find, SeoDelegationTask, SeoIssueInstance, SeoIssueReportRow (+34 more)
...
Cohesion: 0.08
Nodes (52): is_user_onboarding_allowed(), Return True if the admin has enabled onboarding for this user., audit(), Append an audit log entry.      Never logs raw secrets — only secret IDs / maske, complete_wizard(), _delete_wizard_state(), detect_configured_providers(), detect_hardware_for_wizard() (+44 more)
...
Cohesion: 0.08
Nodes (24): Request to remediate auto-fixable findings in a local code repository., One concrete remediation performed (or proposed) by the fixer., SeoFixAction, SeoFixRequest, _humanize_filename(), BeautifulSoup, Path, SeoFixRequest (+16 more)

### Community 48 - "Community 48"
Cohesion: 0.06
Nodes (37): AgentPreviewRow(), C, cls(), ControlPlanePage(), DecisionPreviewRow(), formatCompactTokens(), formatCount(), formatMoney() (+29 more)
...
Cohesion: 0.09
Nodes (10): OrchestratorQueue, Any, _QueueEntry, Async FIFO queue that limits concurrent orchestrator run executions.      ``appr, Enqueue a run for async execution.  Returns immediately.          ``fn(*args, **, Enqueue a run and return a future that resolves when it completes., stop_orchestrator_queue(), Drain loop must handle dequeue from empty queue gracefully. (+2 more)

### Community 53 - "Community 53"
Cohesion: 0.06
Nodes (46): Return True if the PR exists and is open or merged; False if 404., verify_pr_exists(), _append_transition(), classify_domain(), Drives a Task through the execution state machine with persistence.      Usage, Advance task through the full phase sequence.          Resumes from ``task.wor, Execute a single phase and advance to the next., Run the logic for ``phase`` and return the next phase.          Handles both s (+38 more)
...
Cohesion: 0.06
Nodes (29): CachedLLMClient, Any, Cached LLM Client wrapper.  Drop-in wrapper around any LLM API call that trans, Return performance metrics for this client instance., Try to extract token count from various response formats., Wraps an LLM call function with inference caching.      Usage:         from a, Execute an LLM completion, using cache when available.          Args:, CacheEntry (+21 more)

### Community 57 - "Community 57"
Cohesion: 0.06
Nodes (40): AIToolMetrics, build_report(), EngagementMetrics, PerformanceAnalytics, datetime, AI-Assisted Engineering Insights — track AI tool usage, engagement, and performa, How many distinct tools each user has touched., Compare engineering performance with vs without AI tooling.      DX report findi (+32 more)
...
Cohesion: 0.08
Nodes (33): _classify_sentiment(), _extract_keywords(), plan_research(), Any, QualAnalysis, QuantAnalysis, QuantSegment, agent/user_research_skill.py — User research skill for the agent platform.  Im (+25 more)
...
Cohesion: 0.06
Nodes (43): compute_savings(), compute_time_series(), get_savings(), get_usage(), get_user_savings(), _period_start(), Any, Request (+35 more)

### Community 65 - "Community 65"
Cohesion: 0.09
Nodes (28): _extract_slices_from_plan(), Any, CheckRun, Path, Slice, WorkflowRun, Return the AgentSwarm singleton if available, else None., Append an event to the workflow event log. (+20 more)

### Community 66 - "Community 66"
Cohesion: 0.14
Nodes (9): is_commercial_provider(), _normalized_provider_type(), Any, Response, Parse a 429/503 ``Retry-After`` header → seconds, or None.          Accepts eith, Translate an OpenAI chat/completions payload to Bedrock Converse format., Translate a Bedrock Converse API response to OpenAI chat.completion format., Try all models for one provider. Returns ProviderResult on success, None on fail (+1 more)
...
Cohesion: 0.08
Nodes (25): Any, Task, TaskPriority, TaskStatus, List tasks for a specific user with optional filters.          ``include_system`, Admin-only: list all tasks across all users., Return tasks queued for agent execution., Return BLOCKED tasks that are candidates for auto-retry. (+17 more)
...
Cohesion: 0.06
Nodes (27): AuthCallback(), DashboardLayout(), LoginPage(), AGENT_CHIPS, LoginScreen(), STEPS, useIsWide(), getMe() (+19 more)

### Community 77 - "Community 77"
Cohesion: 0.05
Nodes (56): _fetch_text(), _now(), process_note(), Any, Path, QuickNote, agent/quick_note.py — iPhone Quick Note integration.  Persistent URL queue + b, GET *url* and return plain text (HTML tags stripped, max *max_chars*). (+48 more)
...
Cohesion: 0.04
Nodes (55): auto_recommend_skills(), cancel_onboarding(), create_company(), delete_company_endpoint(), generate_onboarding_questions(), get_company(), get_company_access(), get_company_graph() (+47 more)

### Community 80 - "Community 80"
Cohesion: 0.08
Nodes (22): CompanyAgencyService, _is_runtime_available_sync(), _pick_available_runtime(), Any, SpecialistFamily, services/company_agency.py — Company Agency Orchestration Service  After onboard, Orchestrates specialist activation, runtime startup, and 24x7 scheduling     for, Return the best available runtime for a specialist family.          Checks avail (+14 more)
...
Cohesion: 0.09
Nodes (21): best_model_for(), best_vision_model(), get_registry(), ModelCapability, Model capability registry.  Defines the known local models, their strengths, a, Return model registry, extended with ROUTER_EXTRA_MODELS env entries.      ROU, Return the name of the best model for a given task category.      Falls back t, Return the name of the best registered vision-capable model, or None.      Pre (+13 more)
...
Cohesion: 0.10
Nodes (21): Agent subsystem — planner / executor / verifier loop., AgentEvent, AgentSession, AgentSessionMessage, models.py — Pydantic models for agent I/O contracts., A single entry in the session's append-only event log.      Inspired by Anthro, _now(), AgentPlan (+13 more)

### Community 87 - "Community 87"
Cohesion: 0.12
Nodes (11): _check_rate_limit(), default_keys_path(), load_key_store(), RateLimitError, Persistent API key store: each key maps to email + department (seat) and a stabl, Raised when an IP exceeds the failed-key-lookup rate limit., Raise RateLimitError if *ip* has too many recent failed lookups., Record a failed key lookup for *ip*. (+3 more)

### Community 89 - "Community 89"
Cohesion: 0.08
Nodes (40): _b64url_decode(), _b64url_encode(), change_user_role(), get_current_user(), get_user_by_email(), get_user_by_id(), github_callback(), _github_exchange_code() (+32 more)
...
Cohesion: 0.06
Nodes (26): ActivityPage(), AdminPortalPage(), apiFetch(), hdrs(), buildNavSections(), MOBILE_PRIMARY_NAV, SidebarContent(), KnowledgePage() (+18 more)
...
Cohesion: 0.03
Nodes (82): CEODispatcher, CEOResult, _complexity_rank(), _decompose_into_subtasks(), get_ceo_dispatcher(), _merge_changed_files(), services/ceo_dispatcher.py — Real CEO delegation layer.  The CEO splits a comple, Decompose a request into 2-3 sub-tasks for specialist fan-out.      Default deco (+74 more)

### Community 94 - "Community 94"
Cohesion: 0.06
Nodes (29): analyze_page(), compute_pressure(), _count_syllables(), estimate_pixel_width(), flesch_reading_ease(), _host_key(), is_internal(), loss_share_from_pressure() (+21 more)
...
Cohesion: 0.07
Nodes (35): TaskStatus, Task definition schema for the evaluation harness.  Inspired by OpenHarness' s, SuccessCriterionType, TaskDifficulty, WorkspaceStatus, Qualitative health signal derived from sprint metrics., SprintHealth, Categories of AI engineering tools tracked. (+27 more)

### Community 97 - "Community 97"
Cohesion: 0.11
Nodes (29): get_repo(), _get_token(), _get_user(), init_workspace(), list_branches(), list_prs(), list_repos(), LocalWorkspace (+21 more)

### Community 98 - "Community 98"
Cohesion: 0.12
Nodes (22): IssueCategory, IssueSeverity, FailureCategory, Classified failure types for targeted self-healing (E2)., Any, AsyncClient, Path, agent/trend_watcher.py — Internet-connected AI trend intelligence.  Fetches fr (+14 more)

### Community 99 - "Community 99"
Cohesion: 0.08
Nodes (29): get_skill(), list_skills(), List all available skills with optional filtering.      Returns the skill catalo, Get a single skill by its ID., Recommend skills based on provided context., recommend_skills(), build_matrix(), _families() (+21 more)
...
Cohesion: 0.10
Nodes (14): _now(), Any, Artifact, Connection, Path, Row, Write *content* to disk and record metadata in SQLite.          If an artifact w, Return the raw text content of an artifact, or None if missing. (+6 more)

### Community 103 - "Community 103"
Cohesion: 0.08
Nodes (14): ChatHistoryStore, get_chat_history(), Return the module-level ChatHistoryStore singleton., get_context_window_manager(), Return the module-level ContextWindowManager singleton., Result of a context window truncation operation., TruncationResult, DeltaChunk (+6 more)
...
Cohesion: 0.07
Nodes (38): ApprovalCheckpoint, Full task/issue document., Human approval gate in a task's execution., Task, TaskCreateRequest, TestTaskModel, TestTaskStore, agent_store() (+30 more)

### Community 106 - "Community 106"
Cohesion: 0.21
Nodes (6): _coerce_ts(), ExecutionLogEntry, Any, Update the updated_at timestamp., Coerce ISO-8601 datetime strings (from DB) to float timestamps., Single entry in a task's execution log.

### Community 107 - "Community 107"
Cohesion: 0.06
Nodes (10): Agent jobs created with workspace integration should         have a workspace_pa, Only expired workspaces (past retention TTL) are cleaned up., Two threads creating the same session/job should not corrupt state., TestWorkspaceLifecycle, TestWorkspaceResume, First-class workspace isolation manager.      Every session/job gets its own val, Check access to a remote Git repository by querying its refs using `git ls-remot, Check whether the specified ref (branch or tag name) exists in the remote Git re (+2 more)
...
Cohesion: 0.14
Nodes (18): How to truncate messages when over the context limit., TruncationStrategy, get_current_trace_id(), get_tracer(), langfuse_metadata_with_trace(), Portable trace context that can be passed across async boundaries., Return an OpenTelemetry tracer for the given name., Extract trace context from an incoming HTTP request.      Looks for W3C Trace Co (+10 more)
...
Cohesion: 0.16
Nodes (37): ApprovalRequest, BackgroundTasks, ClarifyRequest, CommentAddRequest, FollowUpRequest, TaskCreateRequest, add_comment(), approve_checkpoint() (+29 more)
...
Cohesion: 0.05
Nodes (36): Path, memory_store(), Tests for persistent memory system., Test auto-loading includes workspace-specific memories., Test that auto-load respects priority ordering., Test filtering memories by category., Create a temporary database for testing., Test searching memories. (+28 more)
...
Cohesion: 0.10
Nodes (20): _derive_workspace_root(), Create an isolated workspace for a session and optional job.                  Cr, Retrieve the WorkspaceManifest for a given session and optional job., List all known workspaces, optionally filtered by status., Mark a workspace as active (in-use)., Pause a workspace (e.g. between agent steps)., Mark a workspace as completed., Mark a workspace as failed. (+12 more)

### Community 118 - "Community 118"
Cohesion: 0.08
Nodes (13): AgentJobError, AgentJobResult, Any, agent/contract.py — Typed public contract for the agent job lifecycle.  Phase, Structured error payload attached to a failed job., Typed result returned by a completed agent job.      The ``response`` field is, Accept a bare string (legacy runner output) or a full dict., Build a snapshot from an ``AgentJob`` dataclass instance. (+5 more)
...
Cohesion: 0.09
Nodes (9): ContributorState, CoworkSession, Claude Cowork — shared AI coding sessions with real-time sync.  Enables multiple, A shared AI coding session with multiple human contributors.      Manages turn-t, Request editing control. Returns True if granted.          Grant rules:, Role within a cowork session., State of a single contributor within a session., SessionRole (+1 more)

### Community 121 - "Community 121"
Cohesion: 0.06
Nodes (49): AgentProfile, agents/__init__.py — CRISPY multi-agent coding system., AgentProfile, _get_defaults(), load_all_profiles(), make_architect_profile(), make_coder_profile(), make_reviewer_profile() (+41 more)

### Community 122 - "Community 122"
Cohesion: 0.03
Nodes (69): check_feature(), get_feature(), list_features(), Any, features/api.py — Admin API for the feature support matrix.  Exposes:   GET  /ad, Return the full support matrix with summary., Return a single feature entry., Check if a feature is available and return its status + any warnings. (+61 more)

### Community 123 - "Community 123"
Cohesion: 0.09
Nodes (30): FileEditor(), FileTree(), GitHubPage(), PRPanel(), RepoSelector(), C, GitHubTab(), SourcesTab() (+22 more)

### Community 124 - "Community 124"
Cohesion: 0.07
Nodes (17): PostProcessHook, create_streaming_reconstructor(), Any, Register a post-processing hook (runs before re-streaming)., Remove a post-processing hook., Feed a raw SSE line from the upstream stream., Feed raw text (e.g., from a non-streaming response) for re-emission., Apply all registered hooks to the accumulated text.          Returns the final p (+9 more)
...
Cohesion: 0.09
Nodes (17): BrowserAction, _env_true(), _not_started(), PageState, Any, agent/browser.py — Browser Automation  Controls a real browser via Playwright, Evaluate a JavaScript expression in the page context., Return a summary of the current page state. (+9 more)
...
Cohesion: 0.10
Nodes (25): _dispatch_async(), _ErrorCaptureHandler, get_log_monitor(), LogMonitor, Any, LogRecord, agent/log_monitor.py — Application Log Monitor  Captures ERROR/CRITICAL log re, Fire-and-forget: schedule a self-healing task from any thread. (+17 more)
...
Cohesion: 0.07
Nodes (40): Initiative, _bug_scores(), _clean(), _env_github_token(), estimate_job_size(), fetch_github_signals(), fetch_research_alerts(), initiatives_from_bug_log() (+32 more)

### Community 137 - "Community 137"
Cohesion: 0.07
Nodes (27): AgentCard(), AgentForm(), AgentsPage(), cls(), normalizeAgent(), RUNTIME_OPTIONS, STATUS_STYLE, TASK_TYPES (+19 more)

### Community 138 - "Community 138"
Cohesion: 0.24
Nodes (19): Paragraph, _appendix_full_findings(), _appendix_worst_pages(), _appendix_wsjf_roadmap(), _cell(), _cover_page(), _executive_summary(), _findings_table() (+11 more)
...
Cohesion: 0.11
Nodes (18): ModelRouter, Dynamic model router package.  Public API::      from router import get_router,, _build_builtin_model_map(), _default_model(), _default_reasoning_model(), ModelRouter, _nvidia_key_present(), Any (+10 more)

### Community 146 - "Community 146"
Cohesion: 0.05
Nodes (83): PreflightIssue, Any, doctor.py — Agent-side doctor diagnostics: environment, provider, and workspace, Translate technical preflight issues into a conversational assistant reply., translate_error_to_conversational(), ResumeRequest, AcceptedJob, AgentJobEnvelope (+75 more)
...
Cohesion: 0.14
Nodes (16): AgentRole, Artifact, ArtifactStore, CheckRun, ModelRoutingConfig, Path, PhaseType, Slice (+8 more)
...
Cohesion: 0.09
Nodes (31): CommercialEquivalent, estimate_commercial_equivalent_usd(), get_prices(), _load_from_env(), _parse_mapping(), Any, Map each local Ollama model name to a commercial API reference price (USD per 1M, _base_url() (+23 more)

### Community 151 - "Community 151"
Cohesion: 0.07
Nodes (7): Charts, Donut(), ExecutionTimeline(), Sparkline(), ErrorBoundary, STATUS_ALIASES, STATUS_COLORS
...
Cohesion: 0.12
Nodes (10): auto_fixable_checks(), _c(), get_check(), list_checks(), SeoCheckDefinition, services/seo_checks.py - SEO / GEO / AIO Check Catalog  The authoritative catalo, Return the catalog definition for a check code (raises KeyError if unknown)., Return all check definitions. (+2 more)

### Community 156 - "Community 156"
Cohesion: 0.06
Nodes (43): AgencyCycleResult, _build_ceo_prompt(), _build_quick_note_instruction(), _close_github_issue(), _collect_recent_git_context(), _fetch_github_quick_notes(), get_agency(), _gh_repo() (+35 more)
...
Cohesion: 0.06
Nodes (30): [5.0.0] — 2026-05-24, Added, Added, Added, Added, Added, Added, Changed (+22 more)

### Community 159 - "Community 159"
Cohesion: 0.15
Nodes (10): Contract: WorkflowEngine cannot skip the gate state machine., Contract: No code path may advance past awaiting_approval unless     gate.status, Create a run and manually place it in awaiting_approval., Contract: Cannot approve a run in 'pending' state., Contract: Can approve a run in 'awaiting_approval' state., Contract: Rejecting a run marks it as failed., TestApprovalGateMandatory, TestWorkflowBuildRequest (+2 more)
...
Cohesion: 0.11
Nodes (11): get_scheduler_store(), _MemCollection, _MemCursor, _MemDeleteResult, Any, services/scheduler_store.py — Durable scheduler persistence.  Issue #505: AgentS, Delete a persisted job., Durable store for AgentScheduler jobs.      Delegates to the shared DB (MongoDB (+3 more)
...
Cohesion: 0.13
Nodes (27): _build_anthropic_response(), _content_block_to_text(), _emit_safely(), _finish_reason_to_stop_reason(), get_local_model(), handle_anthropic_messages(), _messages_to_openai(), _openai_choice_to_anthropic_content() (+19 more)
...
Cohesion: 0.07
Nodes (20): _NoopDB, OrchestratorCheckpointStore, Any, Restore in-flight runs at startup.          Called during backend bootstrap.  Re, Fallback in-memory store when no DB is available., Persist orchestrator runs so they survive restarts., Persist a WorkflowRun snapshot., Load a persisted run snapshot. (+12 more)
...
Cohesion: 0.07
Nodes (14): AgileManager, Manages multiple agile sprints with velocity tracking., List all active sprints., Predict next sprint velocity from historical data., Number of managed sprints., CapacityAllocation, Result of fitting initiatives into a fixed capacity by WSJF priority., Total job size of initiatives that fit within capacity. (+6 more)

### Community 172 - "Community 172"
Cohesion: 0.04
Nodes (28): CompanyGraphService, Get a company by ID.                  Args:             company_id: Company ID, Update a company.                  Args:             company_id: Company ID, Delete a company and all its associated data.                  Args:, List companies with optional filtering.                  Args:             owner, Get the company graph for a company, or create one if it doesn't exist., Get the company graph for a company.          Args:             company_id: Comp, Compute the completeness score (0.0–1.0) for a company's graph.          Loads t (+20 more)
...
Cohesion: 0.17
Nodes (12): clear_cooldowns(), is_provider_on_cooldown(), mark_provider_failed(), Put provider_id on cooldown for *cooldown_seconds* (default: PROVIDER_COOLDOWN_S, Return True if provider_id is currently on cooldown., Clear all cooldown entries (useful for testing).      Delegates to shared_state., reset_cooldowns(), Ensure each test starts with no active cooldowns. (+4 more)

### Community 177 - "Community 177"
Cohesion: 0.07
Nodes (14): LOCAL_MODELS, NVIDIA_MODELS, SetupWizardPage(), STEPS, completeSetup(), createSecret(), detectHardwareForSetup(), detectModelsForSetup() (+6 more)
...
Cohesion: 0.12
Nodes (14): PersistentMemoryStore, Any, Connection, Save a memory entry with categorization and scoping., Recall a specific memory entry., Auto-load relevant memories based on context.                  Returns memorie, Get all memories in a specific category., Search memories by key or value content. (+6 more)
...
Cohesion: 0.09
Nodes (13): free_nvidia_models(), Return the curated list of free NVIDIA NIM models FreeBuff may use., List the free NVIDIA NIM models a user may pick (e.g. via Telegram)., True when *model* is in the curated free NVIDIA NIM set., _override_auth(), Tests for the FreeBuff free-NVIDIA coding agent and its control surfaces.  Cover, test_available_models_env_override(), test_falls_back_to_local_base_without_key() (+5 more)
...
Cohesion: 0.10
Nodes (22): Regression tests for: brain-skip-paid, provider-priority persistence, scanner Na, Critical failover-safety test: if every free provider's base URL is     excluded, When the ONLY configured provider is a paid one (e.g. operator set     ANTHROPIC, The PUT /api/providers/{id} endpoint did not persist priority edits     because, Priority must be an int (or None for unset) and within a sane range     so a typ, The PUT /api/providers/{id} handler does:          for k, v in body.dict(exclude, scanner.py used to end with a bare `systems` statement at module level,     whic, When AGENT_LLM_BASE_URL is set, the brain resolver must return that     endpoint (+14 more)
...
Cohesion: 0.15
Nodes (11): CircuitBreakerOpenError, CircuitState, get_nim_pool(), NIMConnectionPool, Persistent httpx.AsyncClient pool with circuit breaker and retry logic.      Man, Close the connection pool., Manually reset a provider's circuit breaker to CLOSED., Raised when a request is blocked by an open circuit breaker. (+3 more)
...
Cohesion: 0.09
Nodes (43): _admin_headers(), _answer_callback(), _api_headers(), _check_rate_limit(), cmd_control(), cmd_cost(), cmd_freebuff(), cmd_keylist() (+35 more)

### Community 214 - "Community 214"
Cohesion: 0.17
Nodes (10): agent/schedule_store.py — durable persistence for scheduled agent jobs.  Fixes #, _FakePersistence, tests/test_schedule_persistence.py — #505 schedules survive restart.  Regression, In-memory stand-in for ScheduleStore (no Mongo needed in tests)., A disabled job must be registered (paused) on rehydrate so a later     toggle(en, test_delete_and_toggle_are_persisted(), test_disabled_job_rehydrates_and_can_be_re_enabled(), test_scheduled_job_roundtrips_through_dict() (+2 more)

### Community 215 - "Community 215"
Cohesion: 0.12
Nodes (13): useSafeData(), ActivationGate(), AgentsScreen(), DashboardScreen(), CheckRow(), DoctorScreen(), statusStyle(), ActivityRow() (+5 more)

### Community 216 - "Community 216"
Cohesion: 0.11
Nodes (11): Any, AsyncClient, Response, Get or create the shared httpx.AsyncClient., Context manager for a pooled client session., Make an HTTP request through the pool with circuit breaker protection., Convenience wrapper: request with automatic retry., Get or create a circuit breaker for a provider. (+3 more)

### Community 217 - "Community 217"
Cohesion: 0.09
Nodes (12): Start the onboarding process for a company.                  Args:             c, Activate a company's 24x7 agency runtimes in the background.          Runs after, Get the current onboarding progress for a company.                  Args:, Resume onboarding from where it left off.                  Args:             com, Pause onboarding for a company (sets status to paused).          Args:, Scan a website and save the results.                  Args:             company_, Scan a repository and save the results.                  Args:             compa, Create initial workflows for a company.                  Args:             compa (+4 more)

### Community 218 - "Community 218"
Cohesion: 0.20
Nodes (20): MemoryCategory, Memory categories for semantic organization., cmd_autoload(), cmd_delete(), cmd_export(), cmd_import(), cmd_list(), cmd_recall() (+12 more)
...
Cohesion: 0.11
Nodes (10): PR throughput per cohort over the last `days` days., Background agent that periodically syncs session state across contributors., SyncAgent, A spread of events from 3 users across 3 tools over a week., sample_events(), test_engagement_record_appends(), Tests for agents.cowork_session — Claude Cowork., TestSyncAgent (+2 more)
...
Cohesion: 0.12
Nodes (14): Any, Durable schedule persistence. Mongo-backed with in-memory fallback.      All met, Return all persisted schedule docs (for boot rehydration)., Persist (insert or update) a single schedule by job_id., Delete a persisted schedule., ScheduleStore, BackgroundServices, Path (+6 more)
...
Cohesion: 0.08
Nodes (19): get_orchestrator_checkpoint_store(), services/orchestrator_checkpoint.py — Durable step-level checkpointing  Issue #5, _get_ceo_dispatcher(), _NoopStore, Any, List recent runs.          When ``owner_id`` is provided, only runs stamped with, Execute the plan via the selected specialist(s).          For medium/high-comple, Bump the named counter under the lock (best-effort, never raises). (+11 more)
...
Cohesion: 0.19
Nodes (5): _Collection, _DeleteResult, Motor-compatible async collection backed by a SQLite table.      All I/O uses pa, Minimal aggregate support: $match → $group($sum) / $sort / $limit., No-op — indexes are pre-created in schema init.
...
Cohesion: 0.11
Nodes (18): Agent runtimes, Architecture, Autonomous AI Agency, Cloud deployment (Render + GitHub Pages), Configuration reference, Development, Feature maturity — what's stable vs. beta, HITL approval gates — you stay in control (+10 more)

### Community 259 - "Community 259"
Cohesion: 0.13
Nodes (9): activityToAlert(), AlertsBell(), priorityConfig, _relativeTime(), typeIcon, GitHubScreen(), QUEUED_NOTES, QuickNotesFAB() (+1 more)
...
Cohesion: 0.16
Nodes (13): Document, MemoryTurn, Rough token estimate: 4 chars ≈ 1 token (minimum 1)., A single knowledge-base entry (wiki page, source document, etc.)., Run the full RAG pipeline and return a token-budget-respecting context., One turn in the conversation history., Select up to *top_k* highest-scoring turns that fit within *budget*., A document selected by retrieval, with its compressed excerpt. (+5 more)
...
Cohesion: 0.11
Nodes (19): quick_notes_submit(), Submit a quick-note URL or instruction from the dashboard FAB., TaskExecutionCoordinator, TaskStore, TaskWorkflowService, TaskStore, _get_workflow_engine(), Return a lazily-created WorkflowEngine singleton. (+11 more)
...
Cohesion: 0.12
Nodes (16): Checklist for Next Agent, P0 first: agent/tools.py path traversal, P1: Verify chat timeout fix, P1: Verify specialist loading, P2: key_store.py security, P3: remote-admin/ brand update, PENDING ITEM 1 — E2E Playwright Tests (Live Run + Screenshots), PENDING ITEM 2 — Pre-mortem / User Research Bug Backlog (+8 more)
...
Cohesion: 0.12
Nodes (6): Tests for the always-on FreeBuff Telegram bot: embedded vs HTTP dispatch., In orchestrator mode the embedded run must set the bypass so the agent runs., Snapshot/restore os.environ — the launcher writes env vars directly., _restore_env(), test_embedded_run_bypasses_orchestrator(), test_fb_plan_embedded_calls_agent_plan()
...
Cohesion: 0.12
Nodes (5): If a symlink inside the workspace points outside, resolve_path blocks it., TestWorkspaceManifest, TestCleanupIsolation, Path, Safely resolve a path inside a workspace's source directory.          Rejects tr

### Community 298 - "Community 298"
Cohesion: 0.11
Nodes (7): Security-oriented tests for workspace isolation (Area C4).  Covers:   - No path, TestPathTraversalPrevention, TestSymlinkAttackPrevention, Validate and return a job ID, or raise InvalidJobIdError., Resolve *path* and verify it stays under *base_root*.      Blocks symlink escape, _safe_resolve(), validate_job_id()
...
Cohesion: 0.24
Nodes (15): apply_edits(), build_prompt(), call_llm(), collect_context(), collect_source_files(), extract_failing_tests(), _is_blocked(), main() (+7 more)
...
Cohesion: 0.20
Nodes (5): The hash component should not be reversible to the original ID., Workspace root path should be fully resolved (no . or ..)., TestWorkspaceHashing, _hash_component(), Derive a stable, opaque directory name from a validated ID.      Using a truncat
...
Cohesion: 0.18
Nodes (9): MemoryMiddleware, Any, PersistentMemoryStore, Process incoming chat request and inject memories., Extract and save learnings from model responses., Middleware for automatic memory loading and injection., Detect AI coding tool from request headers., Extract workspace ID from request metadata. (+1 more)
...
Cohesion: 0.18
Nodes (5): _MemDB, tests/test_scheduler_store.py — Tests for durable scheduler store (#505)., AgentScheduler.hydrate() loads jobs from the store., Save, load, delete, and hydration of scheduled jobs., TestSchedulerStore
...
Cohesion: 0.14
Nodes (9): Connection, Top-level store — exposes collections as attributes.      Usage::          store, Create tables if they don't already exist., SQLiteStore, B608 guard: _Collection.__init__ must reject names outside _COLLECTIONS.      Pr, B608 guard: all collections in _COLLECTIONS must still be instantiable., store(), test_non_whitelisted_table_rejected() (+1 more)
...
Cohesion: 0.23
Nodes (13): do_login(), fail(), ok(), Navigate to a page and verify it loads without errors., Verify server responds to health check before running browser tests., Run full browser e2e suite., Log in and return True on success., Result (+5 more)
...
Cohesion: 0.18
Nodes (9): create_memory_middleware(), Memory middleware for automatic context injection into AI tool requests.  This, Factory function to create memory middleware instance., MemoryEntry, MemoryScope, Row, Enhanced persistent memory system with auto-loading across AI coding tools.  T, Memory scope determines when memory is auto-loaded. (+1 more)
...
Cohesion: 0.32
Nodes (10): APIRequestContext, do_login(), fail(), ok(), Result, run_tests(), test_api_endpoints(), test_new_features_browser() (+2 more)
...
Cohesion: 0.15
Nodes (12): Autonomous Agency Setup Guide, Cloudflare Workers Deployment, Enabling Workflows, Manual Trigger, Monitoring Health, Overview, Prerequisites, Required Repository Settings (+4 more)
...
Cohesion: 0.18
Nodes (12): Item, client(), Config, TestClient, pytest_collection_modifyitems(), pytest_configure(), Pytest configuration for the backend test suite.  Mongo availability -----------, TestClient for backend.server — used by backend-specific tests.      Uses the co (+4 more)
...
Cohesion: 0.15
Nodes (4): ALL_PROVIDERS, MCP_SERVERS_DEFAULT, OLLAMA_MODELS, TIER_CONFIG
...
Cohesion: 0.24
Nodes (5): ProviderCircuit, Attempt to move from OPEN to HALF_OPEN after recovery timeout., Check if a request can be made through this circuit., Per-provider circuit breaker state machine., TestProviderCircuit

### Community 401 - "Community 401"
Cohesion: 0.36
Nodes (4): MCPUnavailableError, Raised when the MCP server is unreachable or the circuit is open., Ensure _dispatch_tool routes MCP-only tools correctly., TestAgentLoopMCPIntegration
...
Cohesion: 0.21
Nodes (4): Tests for TECH_SKILL_MAP coverage and correctness., Tests for WORKFLOW_SKILL_MAP., TestTechSkillMap, TestWorkflowSkillMap
...
Cohesion: 0.31
Nodes (9): _check_auth(), _err(), _handle_tool(), mcp_dispatch(), _ok(), Any, Request, mcp_server/server.py — MCP (Model Context Protocol) server.  Exposes workspace a (+1 more)
...
Cohesion: 0.21
Nodes (7): main(), Safely insert an entry under ## [Unreleased] without touching the rest of the fi, _read_claude_md(), _run_baseline_pytest(), tool_add_changelog_entry(), tool_bash(), tool_search()
...
Cohesion: 0.08
Nodes (32): ClassifyOutput, emit_deprecation(), ExecutionResult, JudgeVerdict, Phase, PreflightReport, Log a deprecation warning when a parallel path is used., The 11 canonical phases of the Agency Core golden path. (+24 more)
...
Cohesion: 0.17
Nodes (3): auth_headers(), Tests for /api/agile/* endpoints., Get auth headers for an admin user.
...
Cohesion: 0.07
Nodes (24): ApplyReviewAgent, build_review_context(), _gh(), main(), _openai_tools_to_anthropic(), Convert OpenAI function-calling tool schemas to Anthropic tool schemas., Return (result_text, should_stop)., Run using NVIDIA NIM (OpenAI-compatible). Called as fallback. (+16 more)
...
Cohesion: 0.18
Nodes (3): _Cursor, Return a _Cursor (evaluated lazily on first await/iteration)., Async iterator wrapping a list of dicts (already decoded from JSON).
...
Cohesion: 0.22
Nodes (8): Lightweight TF-IDF index over a fixed document collection.      Sparse dict ve, _TFIDFIndex, test_tfidf_empty_corpus(), test_tfidf_empty_query(), test_tfidf_finds_relevant(), test_tfidf_scores_between_0_and_1(), test_tfidf_scores_ordered_descending(), test_tfidf_unknown_term_only()
...
Cohesion: 0.14
Nodes (14): _get_model_map(), Merge built-in defaults with MODEL_MAP env overrides (lazy, cached)., Reset the singleton and clear the cached model map (test helper)., reset_router(), _opus_model() with ANTHROPIC_API_KEY should return claude-opus-4-8., _opus_model() with Bedrock keys should return the Opus 4.8 ARN., test_opus_model_prefers_4_8_bedrock_arn(), test_opus_model_prefers_4_8_for_direct_api() (+6 more)
...
Cohesion: 0.27
Nodes (9): _configure(), _default(), main(), Set an env var only when the operator hasn't already provided one., _parse_user_ids(), Call a Telegram Bot API method and return the parsed JSON (best-effort)., Extract numeric Telegram user IDs from a raw env value, tolerantly.      Accepts, run_bot() (+1 more)
...
Cohesion: 0.28
Nodes (5): CompanyGraphSnapshot, Create a snapshot of a company graph., Create a company graph snapshot (No-op shim for SQLite)., List snapshots for a company graph (No-op shim for SQLite)., List snapshots for a company graph.
...
Cohesion: 0.28
Nodes (4): service_manager.py — Telegram & Notification Integration Extension  Extends the, Best-effort secret/email/IP redaction for outbound Telegram/webhook messages., _redact_for_notification(), TestRedactForNotification
...
Cohesion: 0.33
Nodes (9): Score each turn by exponential recency decay combined with query relevance., _score_turns(), MemoryTurn, test_score_turns_empty(), test_score_turns_importance_multiplier(), test_score_turns_recency_newer_scores_higher(), test_score_turns_relevance_boosts_score(), test_score_turns_sorted_descending() (+1 more)
...
Cohesion: 0.25
Nodes (7): Return ``(doc_index, cosine_score)`` pairs for the top-*k* matches., Return lowercase alphanumeric tokens with stop-words removed.      Numeric tok, _tokenize(), test_tokenize_empty(), test_tokenize_lowercases(), test_tokenize_numbers_kept(), test_tokenize_removes_stop_words()
...
Cohesion: 0.25
Nodes (5): mobile_page(), pytest_configure(), conftest.py — pytest fixtures and configuration for the E2E test suite.  Registe, A browser page pre-configured for mobile viewport (390×844 — iPhone 14)., Config
...
Cohesion: 0.32
Nodes (6): _before(), Guard that the quick-note engine agents use NVIDIA NIM as the primary engine (An, implement_agent.py uses NVIDIA NIM exclusively — the Anthropic/Opus     fallback, test_apply_review_nvidia_primary(), test_implement_agent_nvidia_primary(), test_review_agent_nvidia_primary()
...
Cohesion: 0.29
Nodes (6): Added, Added, Changed, Changelog, Fixed, [Unreleased]
...
Cohesion: 0.57
Nodes (6): Any, codeql_count(), dependabot_count(), main(), _repo_parts(), _request()
...
Cohesion: 0.21
Nodes (12): issue_new_api_key(), Path, Generate a new plaintext API key, persist hash + metadata, return (plain_key, re, main(), main(), _make_store(), Security regression tests for key_store: hashing, constant-time compare, rate li, test_keys_stored_as_hash_not_plaintext() (+4 more)
...
Cohesion: 0.33
Nodes (5): Key Features, Related Issues, Summary, Test Results, What's Changed
...
Cohesion: 0.40
Nodes (3): A single AI tool interaction., Record a usage event., UsageEvent
...
Cohesion: 0.60
Nodes (4): check_feature(), check_files(), main(), check_auto.py — auto-generated module docstring (user-research skill scan).
...
Cohesion: 0.40
Nodes (5): auth_headers(), client(), TestClient for the backend FastAPI app (one per module for speed)., Login once and return auth headers for the entire module., TestClient
...
Cohesion: 0.40
Nodes (5): Company Scan Results, Dashboard, Mobile (390px viewport), Screenshots, Task Board
...
Cohesion: 0.40
Nodes (4): Agent State — agency-cycle-fresh-2026-06-10, Completed steps, Next Step, Notes
...
Cohesion: 0.23
Nodes (4): KeyRecord, KeyStore, Look up a plaintext key by its SHA-256 hash.          When *client_ip* is provid, Thread-safe JSON-backed key store.
...
Cohesion: 0.20
Nodes (3): tools.py — WorkspaceTools: read/write/search and diff application (risky module), Per-user key/value memory store backed by SQLite.  Allows agents to persist an, tools()

### Community 804 - "Community 804"
Cohesion: 0.20
Nodes (6): list_models_openai(), List available models — union of live Ollama models, router registry, and Claude, Daily automation tests — 2026-05-14  Covers three features implemented in this r, list_models_openai returns object:list with data array., list_models_openai includes alias entries with owned_by=autonomous-ai-agency-ali, Each alias entry has a 'description' field showing the target.
...
Cohesion: 0.50
Nodes (3): mcp_client(), tests/test_mcp_server.py — Unit tests for the MCP server and client.  Tests:   -, TestClient for the MCP FastAPI app with workspace base patched to tmp_path.
...
## Knowledge Gaps
- **2749 isolated node(s):** `duplicate.sh script`, `heartbeat.sh script`, `Any`, `Ed25519PublicKey`, `Path` (+2744 more)
...
- **Why does `AgentRunner` connect `Community 5` to `Community 0`, `Community 1`, `Community 134`, `Community 135`, `Community 8`, `Community 9`, `Community 10`, `Community 140`, `Community 401`, `Community 146`, `Community 20`, `Community 23`, `Community 159`, `Community 32`, `Community 801`, `Community 167`, `Community 810`, `Community 43`, `Community 44`, `Community 430`, `Community 312`, `Community 60`, `Community 67`, `Community 86`, `Community 344`, `Community 605`, `Community 96`, `Community 97`, `Community 233`, `Community 247`, `Community 249`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `SkillRegistry` connect `Community 5` to `Community 320`, `Community 1`, `Community 300`, `Community 404`, `Community 248`, `Community 409`, `Community 474`, `Community 507`, `Community 508`, `Community 317`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `WebsiteScanner` connect `Community 7` to `Community 100`, `Community 6`, `Community 11`, `Community 403`, `Community 217`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Are the 169 inferred relationships involving `AgentRunner` (e.g. with `InternalAgentAdapter` and `AdminIdentity`) actually correct?**
  _`AgentRunner` has 169 INFERRED edges - model-reasoned connections that need verification._
- **Are the 141 inferred relationships involving `AgentSessionStore` (e.g. with `AdminIdentity` and `AgentPhaseError`) actually correct?**
  _`AgentSessionStore` has 141 INFERRED edges - model-reasoned connections that need verification._
- **Are the 147 inferred relationships involving `TaskSpec` (e.g. with `AiderAdapter` and `ClaudeCodeAdapter`) actually correct?**
  _`TaskSpec` has 147 INFERRED edges - model-reasoned connections that need verification._
- **Are the 115 inferred relationships involving `UserMemoryStore` (e.g. with `AdminIdentity` and `AgentPhaseError`) actually correct?**
  _`UserMemoryStore` has 115 INFERRED edges - model-reasoned connections that need verification._