...
_CANONICAL_FEATURES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "config_flags": [],
        "admin_visible": True,
        "notes": "DEMOTED per issue #467 Section I. No health guarantee when sidecar not running. Re-enable with FEATURE_SIDECAR_RUNTIMES=experimental.",
    },
    {
    ...
    },
    {
        ...
        "config_flags": [],
        "admin_visible": True,
        "notes": "DEMOTED per issue #467 Section I. Not wired to golden path, no CEO dedupe. Re-enable with FEATURE_MULTI_AGENT_SWARM=experimental.",
    },
    {
