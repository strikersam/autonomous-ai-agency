...
def print_manual_render_steps(env_key: str, value: str) -> None:
    ...
    print(f"  3. Set Key to    {env_key}")
    print(f"  4. Set Value to  {value}")
    print("  5. Save Changes -- Render triggers an automatic redeploy.")
    print("  6. Repeat for the local-llm-server-worker service (same key + value).")
    print()
