...
Write-Host "  NVIDIA_API_KEY=nvapi-...                  # free NIM tier — recommended"
Write-Host "  AGENT_EXECUTOR_MODEL=nvidia/llama-3.3-nemotron-super-49b-v1"
Write-Host "  AGENT_PLANNER_MODEL=nvidia/nemotron-3-super-120b-a12b"
Write-Host "  AGENT_VERIFIER_MODEL=nvidia/nemotron-3-super-120b-a12b"
Write-Host "  # Local-only fallback (no NIM key set):"
