...
function NonAdminGate() {
  ...
  const handleSend = () => {
    ...
    const body    = encodeURIComponent(
      `Hello Sam,\n\nI'd like to set up a company on Autonomous AI Agency.\n\nName: ${name||'(not provided)'}\nEmail: ${email||'(not provided)'}\n\nWhat I need:\n${query}\n\nPlease help me get started.`
    );
  ...
  return (
    <div style={{ animation:'fadeSlideUp 0.35s ease-out' }}>
      ...
      <p style={{ fontSize:14, color:'var(--text-tertiary)', lineHeight:1.6, marginBottom:22, maxWidth:440 }}>
        Enter your production URL. Autonomous AI Agency will inspect the site, infer your stack, and provision specialists that understand your industry automatically.
      </p>
