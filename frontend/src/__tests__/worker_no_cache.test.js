...
describe('Worker scheduled() keep-warm redundancy (PR #922)', () => {
  // PR #919 reverted the Worker to the #896 state, which left only the
  ...
  //
  // PR #922 restores a parallel GET /api/ping (unauthenticated, no DB I/O)
