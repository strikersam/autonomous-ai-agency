...
for model_id, label in models:
    ...
    try:
        ...
        elapsed = time.time() - start
        emsg = str(e)
        if "404" in emsg or "not found" in emsg.lower(): status = "404_NOT_FOUND"
        elif "429" in emsg: status = "429_RATE_LIMITED"
        elif "timeout" in emsg.lower(): status = "TIMEOUT"
        elif "422" in emsg: status = "422_UNPROCESSABLE"
