...
class SkillBindings:
    ...
    def _register_core_skills(self):
        ...
        self._register(RuntimeSkill(
            ...
            specialist_families=["agile", "portfolio", "delivery", "product", "operations"],
        ...
        self._register(RuntimeSkill(
            ...
            specialist_families=["portfolio", "delivery", "product", "operations", "analytics", "design", "ux", "marketing"],
